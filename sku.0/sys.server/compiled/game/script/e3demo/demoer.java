...
public class demoer extends script.base_script
{
    ...
    public void grantAllSkills(obj_id objPlayer, String[] strSkillList)
    {
    ...
    public void createBantha(obj_id self)
    {
    ...
    public void createDewback(obj_id self)
    {
    ...
    public void createLandSpeeder(obj_id self)
    {
        obj_id datapad = utils.getPlayerDatapad(self);
    ...
    public void createAv21(obj_id self)
    {
        obj_id datapad = utils.getPlayerDatapad(self);
    ...
    public void createJetpack(obj_id self)
    {
        obj_id datapad = utils.getPlayerDatapad(self);
    ...
    public void createInInventory(obj_id objPlayer, String[] strItems)
    {
    ...
    public void setFlightModel(obj_id objShip, String strFlightModel)
    {
    ...
    public int faceAvatar(obj_id self, dictionary params)
    {
        obj_id objShip = space_transition.getContainingShip(self);
    ...
    public int resetDemo1(obj_id self, dictionary params)
    {
        warpPlayer(self, "tatooine", 2569, 2, 4665, null, 0, 0, 0, "", false);
        messageTo(self, "setUpDemo1", null, 1.0f, true);
        return SCRIPT_CONTINUE;
    }
    public int resetDemo2(obj_id self, dictionary params)
    {
        warpPlayer(self, "tatooine", -2483.9f, 0, -4879.6f, null, 0, 0, 0, "", false);
        messageTo(self, "setUpDemo2", null, 1.0f, true);
        return SCRIPT_CONTINUE;
    }
    public int setUpDemo1(obj_id self, dictionary params)
    {
        obj_id palace1 = getObjIdObjVar(self, "palace1");
        obj_id cell = getCellId(palace1, "foyer");
        location grievousSpawn = new location(-1.2f, 0.3f, 116.9f, "thm_tato_jabbas_palace", cell);
    ...
    public int setUpDemo2(obj_id self, dictionary params)
    {
        obj_id palace2 = getObjIdObjVar(self, "palace2");
        obj_id cell = getCellId(palace2, "foyer");
        location grievousSpawn = new location(-1.2f, 0.3f, 116.9f, "thm_tato_jabbas_palace", cell);
    ...
    public int cleanoutBuilding(obj_id self, dictionary params)
    {
    ...
    public void detachScriptList(String[] strScriptList, obj_id objObject)
    {
    ...
    public int gotoSpace(obj_id self, dictionary params)
    {
