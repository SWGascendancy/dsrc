...
public class spawner_nebulon extends script.base_script
{
    ...
    public int spawnNebulon(obj_id self, dictionary params)
    {
    ...
    public int startNebulonAttack(obj_id self, dictionary params)
    {
        obj_id objFoo = null;
        obj_id objFoo2 = null;
    ...
    public int shipDestroyed(obj_id self, dictionary params)
    {
