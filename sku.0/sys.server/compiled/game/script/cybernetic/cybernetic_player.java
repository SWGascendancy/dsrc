...
public class cybernetic_player extends script.systems.combat.combat_base
{
    ...
    public int cyborgLightning(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cyborgStrengthBuff(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cyborgBurstRun(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cyborgRevive(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cyborgSureShot(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cyborgCriticalSnipe(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cyborgKickDown(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public void handleFailureSound(obj_id self)
    {
        playClientEffectObj(self, "clienteffect/cyborg_ui_cannot_use.cef", self, "");
    }
    public void executePowerSounds(obj_id self, String commandName)
    {
        dictionary parms = new dictionary();
        parms.put("commandName", commandName);
        messageTo(self, "handlePowerDownSound", parms, 2, false);
    }
    public int handlePowerDownSound(obj_id self, dictionary params)
    {
    ...
    public int handlePowerUpSound(obj_id self, dictionary params)
    {
        playClientEffectObj(self, "clienteffect/cyborg_itm_powerup.cef", self, "");
        return SCRIPT_CONTINUE;
    }
    public int handleInstallPaymentConfirmed(obj_id self, dictionary params)
    {
    ...
    public int handleInstallPaid(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            CustomerServiceLog("cyborg", "Cybernetics - Bad Params - please contact the Design Team if the issue persists");
    ...
    public void removeCyberneticInstallScriptVars(obj_id player)
    {
    ...
    public int handleCyborgRefunded(obj_id self, dictionary params)
    {
        return SCRIPT_CONTINUE;
    }
    public int handleCyborgNotRefunded(obj_id self, dictionary params)
    {
    ...
    public int handleUnInstallPaymentConfirmed(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        if (!isIdValid(player))
        {
    ...
    public int handleUnInstallPaid(obj_id self, dictionary params)
    {
        if (params.getInt(money.DICT_CODE) == money.RET_FAIL)
        {
    ...
    public int handleRepairPaymentConfirmed(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        if (!isIdValid(player))
        {
    ...
    public int handleRepairPaid(obj_id self, dictionary params)
    {
        if (params.getInt(money.DICT_CODE) == money.RET_FAIL)
        {
