...
public class combat_simulator_actor extends script.base_script
{
    ...
    public int prepareForCombat(obj_id self, dictionary params)
    {
    ...
    public int queueCommandLoop(obj_id self, dictionary params)
    {
        queueNewCommand(self);
        messageTo(self, "queueCommandLoop", null, 1.0f, false);
        return SCRIPT_CONTINUE;
    }
    public void queueNewCommand(obj_id self)
    {
    ...
    public int handleStandFromKnockedDown(obj_id self, dictionary params)
    {
