...
public class combat_simulator_master extends script.base_script
{
    ...
    public String[] getSkills(String profession)
    {
    ...
    public obj_id makePlayer(obj_id player, location here, String species, String gender, String profession)
    {
    ...
    public obj_id giveEquipment(obj_id player, obj_id reciever, String object)
    {
        if (reciever == null)
        {
            if (debug)
    ...
    public void addBuff(obj_id player, obj_id reciever, String attrib)
    {
    }
    ...
    public boolean grantSkillRecursive(obj_id player, obj_id recipient, String skill)
    {
        if (debug)
        {
    ...
    public void removeCommandList(obj_id player)
    {
    ...
    public void putCommandList(obj_id player, String[] commands)
    {
    ...
    public Vector getCommandList(obj_id player)
    {
        int commandListNumber = 0;
    ...
    public int endCombat(obj_id self, dictionary params)
    {
        if (debug)
        {
    ...
    public int runSimulation(obj_id self, dictionary params)
    {
        reset();
        String[] commands = (String[])(getCommandList(self)).toArray(new String[0]);
        if (commands == null)
    ...
    public int sendCombatInfo(obj_id self, dictionary params)
    {
        debugSpeakMsg(self, "sendCombatInfo");
        messageTo(self, "startCombat", null, 1.0f, false);
        return SCRIPT_CONTINUE;
    }
    public int startCombat(obj_id self, dictionary params)
    {
        debugSpeakMsg(self, "startCombat");
        return SCRIPT_CONTINUE;
    }
    public void addToOutputFile(String fileContents)
    {
        obj_id self = getSelf();
    ...
    public void mergeSubLabelFiles()
    {
        obj_id self = getSelf();
        String label = getStringObjVar(self, "combat_simulator.label");
