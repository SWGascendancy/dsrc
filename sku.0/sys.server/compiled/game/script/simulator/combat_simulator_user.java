...
public class combat_simulator_user extends script.base_script
{
    ...
    public void combatSimulatorMain()
    {
        obj_id self = getSelf();
    ...
    public int mainOptionsOk(obj_id self, dictionary params)
    {
    ...
    public int setLabelOk(obj_id self, dictionary params)
    {
    ...
    public int setNumberOfRoundsOk(obj_id self, dictionary params)
    {
        String label = sui.getInputBoxText(params);
        int button = sui.getIntButtonPressed(params);
        if (button == sui.BP_OK)
    ...
    public int setRangeOk(obj_id self, dictionary params)
    {
    ...
    public int customizeActorOk(obj_id self, dictionary params)
    {
        int btn = sui.getIntButtonPressed(params);
        int idx = sui.getListboxSelectedRow(params);
        if (btn == sui.BP_CANCEL || idx == -1)
    ...
    public int setRaceOk(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public int setGenderOk(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public void setStartingProfession()
    {
        obj_id self = getSelf();
        closeOldWindowPid();
        String actor = utils.getStringScriptVar(self, "combat_simulator.current_actor");
    ...
    public int setStartingProfessionOk(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public int setProfessionsOk(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public void setProfessionLevel()
    {
        obj_id self = getSelf();
        closeOldWindowPid();
        String actor = utils.getStringScriptVar(self, "combat_simulator.current_actor");
    ...
    public int setProfessionLevelOk(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public int setWeaponOk(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public int setArmorOk(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public int setBuffsOk(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public int setConsumablesOk(obj_id self, dictionary params)
    {
        String actor = utils.getStringScriptVar(self, "combat_simulator.current_actor");
        customizeActor();
        return SCRIPT_CONTINUE;
    ...
    public int setWoundsOk(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public int setWoundLevelOk(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public int setCommandQueueMessageOk(obj_id self, dictionary params)
    {
        customizeActor();
        return SCRIPT_CONTINUE;
    }
    public int setCommandQueueOk(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public int copyOtherActorOk(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public int setCreatureLetterOk(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public int setCreatureOk(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public int startSimulationMessageOk(obj_id self, dictionary params)
    {
        combatSimulatorMain();
        return SCRIPT_CONTINUE;
    }
    public int startSimulationOk(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public int destroySimulationOk(obj_id self, dictionary params)
    {
        String label = sui.getInputBoxText(params);
        int button = sui.getIntButtonPressed(params);
    ...
    public int resetOk(obj_id self, dictionary params)
    {
    ...
    public void setWindowPid(int pid)
    {
        obj_id self = getSelf();
        if (pid > -1)
        {
    ...
    public void cleanScriptVars()
    {
        obj_id self = getSelf();
        utils.removeScriptVarTree(self, "combat_simulator");
    }
    public String[] buildCommandListForActor()
    {
        obj_id self = getSelf();
    ...
    public String[] getLayerOfArray(String depth, String scriptVar)
    {
        obj_id self = getSelf();
    ...
    public String getMakePlayerCommand(String actor)
    {
        obj_id self = getSelf();
        String command = "";
        if (utils.hasScriptVar(self, "combat_simulator." + actor + ".creature"))
    ...
    public Vector getProfessionCommands(String actor)
    {
        obj_id self = getSelf();
        Vector commands = new Vector();
        if (utils.hasScriptVar(self, "combat_simulator." + actor + ".creature"))
    ...
    public Vector getWoundCommands(String actor)
    {
        obj_id self = getSelf();
        Vector commands = new Vector();
        String[] wounds = utils.getStringArrayScriptVar(self, "combat_simulator." + actor + ".wounds");
    ...
    public Vector getBuffCommands(String actor)
    {
        obj_id self = getSelf();
        Vector commands = new Vector();
        String[] buffs = utils.getStringArrayScriptVar(self, "combat_simulator." + actor + ".buffs");
    ...
    public String getWeaponCommand(String actor)
    {
        obj_id self = getSelf();
        if (utils.hasScriptVar(self, "combat_simulator." + actor + ".creature"))
        {
    ...
    public Vector getArmorCommands(String actor)
    {
        obj_id self = getSelf();
        Vector commands = new Vector();
        if (utils.hasScriptVar(self, "combat_simulator." + actor + ".creature"))
    ...
    public Vector getActionCommands(String actor)
    {
        obj_id self = getSelf();
        Vector commands = new Vector();
        if (utils.hasScriptVar(self, "combat_simulator." + actor + ".creature"))
    ...
    public void putCommandList(obj_id combatMaster, String[] commands)
    {
    ...
    public int getArmorType(String armorPiece)
    {
