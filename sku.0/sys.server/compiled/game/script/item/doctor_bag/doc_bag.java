...
public class doc_bag extends script.base_script
{
    ...
    public void displayRemoveMeds(obj_id player, obj_id self)
    {
        int count = 0;
    ...
    public int handleRemoveMed(obj_id self, dictionary params)
    {
    ...
    public void displayLabelMeds(obj_id player, obj_id self)
    {
        int count = 0;
        for (int i = 0; i < doctor_bag.MAX_MEDS; i++)
        {
    ...
    public int handleLabelMed(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        int idx = sui.getListboxSelectedRow(params);
        if (idx < 0)
    ...
    public int handleSetLabel(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
    ...
    public void displayExamineMeds(obj_id player, obj_id self)
    {
        int count = 0;
        for (int i = 0; i < doctor_bag.MAX_MEDS; i++)
        {
    ...
    public int handleExamineMed(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        int idx = sui.getListboxSelectedRow(params);
        if (idx < 0)
