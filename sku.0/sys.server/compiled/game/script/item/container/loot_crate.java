...
public class loot_crate extends script.base_script
{
    ...
    public int OnAboutToLoseItem(obj_id self, obj_id pInv, obj_id player, obj_id item)
    {
    ...
    public int OnLostItem(obj_id self, obj_id pInv, obj_id player, obj_id item)
    {
    ...
    public boolean consumeKey(obj_id player, obj_id keyCard, String planetName)
    {
    ...
    public int resetContainer(obj_id self, dictionary params)
    {
        obj_id container = getSelf();
    ...
    public int initializeLootContainer(obj_id self, dictionary params)
    {
        obj_id[] contents = getContents(self);
        if (contents != null)
        {
