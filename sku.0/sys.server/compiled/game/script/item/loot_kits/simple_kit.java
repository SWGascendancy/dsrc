...
public class simple_kit extends script.base_script
{
    ...
    public int OnAboutToReceiveItem(obj_id self, obj_id srcContainer, obj_id player, obj_id item)
    {
        if (!isIdValid(player))
        {
            return SCRIPT_CONTINUE;
    ...
    public void checkForCompletion(obj_id self, obj_id player, int x, obj_id item)
    {
        if (!isIdValid(player))
        {
            return;
    ...
    public int destroyPart(obj_id self, dictionary params)
    {
        return SCRIPT_CONTINUE;
    }
    public int OnAboutToLoseItem(obj_id self, obj_id srcContainer, obj_id player, obj_id item)
    {
        if (!utils.isNestedWithin(self, player))
        {
            return SCRIPT_OVERRIDE;
