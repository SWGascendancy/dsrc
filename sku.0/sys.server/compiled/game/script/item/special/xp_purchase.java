...
public class xp_purchase extends script.base_script
{
    ...
    public boolean isItemConfigured(obj_id item)
    {
    ...
    public String getXpType(obj_id item)
    {
    ...
    public int getXpAmount(obj_id item)
    {
    ...
    public String getGrantType(obj_id item)
    {
    ...
    public String getGrantName(obj_id item)
    {
    ...
    public boolean hasMinSkill(obj_id item)
    {
        return hasObjVar(item, "min_skill");
    }
    public String getMinSkillName(obj_id item)
    {
    ...
    public boolean canLearn(obj_id self, obj_id player, String type, String name)
    {
    ...
    public void learn(obj_id self, obj_id player)
    {
        if (hasMinSkill(self))
        {
    ...
    public int handleLearn(obj_id self, dictionary params)
    {
