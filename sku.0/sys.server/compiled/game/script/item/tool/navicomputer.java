...
public class navicomputer extends script.base_script
{
    ...
    public void initializeNavicomputer(obj_id player, obj_id navicomp)
    {
        createNavicomputerControlDevice(player, navicomp);
        return;
    }
    public void createNavicomputerControlDevice(obj_id player, obj_id navicomp)
    {
    ...
    public void initNavicompDatapad(obj_id itemControlDevice, obj_id navicomp, obj_id player)
    {
    ...
    public boolean verifyNoOtherInitializedNavicomps(obj_id player)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public boolean canBeTransferred(obj_id navicomp, obj_id newMaster, obj_id transferer)
    {
