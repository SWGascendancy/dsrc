...
public class reverse_engineering_tool extends script.base_script
{
    ...
    public boolean canPutInTool(obj_id item, obj_id transferer, obj_id self)
    {
    ...
    public boolean enhanceTool(obj_id self, obj_id player, obj_id item)
    {
    ...
    public int destroyEnhancementModule(obj_id self, dictionary params)
    {
    ...
    public void doReverseEngineering(obj_id self, obj_id player)
    {
        obj_id[] stuff = getContents(self);
        if (stuff.length == 0)
        {
    ...
    public void createSkillEnhancingAttachment(obj_id self, obj_id player)
    {
        obj_id[] stuff = getContents(self);
    ...
    public void createPowerup(obj_id self, obj_id player)
    {
        obj_id[] stuff = getContents(self);
        if (stuff.length == 2 && ((getPowerBitType(stuff[0]) > 0 && isModifierBit(stuff[1])) || (getPowerBitType(stuff[1]) > 0 && isModifierBit(stuff[0]))))
        {
    ...
    public void generatePowerBit(obj_id self, obj_id player)
    {
        obj_id[] stuff = getContents(self);
        int skillMod = 0;
        int numStats = 0;
    ...
    public void generateModifierBit(obj_id self, obj_id player)
    {
        obj_id[] stuff = getContents(self);
    ...
    public boolean isJunk(obj_id item)
    {
    ...
    public boolean isItemWithNPEMod(obj_id item)
    {
    ...
    public int getPowerBitType(obj_id item)
    {
    ...
    public boolean isEnhancementModule(obj_id item)
    {
        if (!isIdValid(item))
        {
            return false;
    ...
    public boolean isModifierBit(obj_id item)
    {
    ...
    public int getFinalAttachmentLevel(obj_id item)
    {
        int attachmentLevel = -1;
    ...
    public boolean hasReverseEngineeringSkill(obj_id player)
    {
    ...
    public boolean canUpgradeAttachment(obj_id player)
    {
    ...
    public String getGemTemplateByClass(obj_id player, int ratio, int type)
    {
        int classType = 0;
        for (int i = 0; i < SKILL_LIST.length; i++)
        {
    ...
    public void prependModNameToObject(obj_id object, String modSIDreference)
    {
