...
public class medikit extends script.base_script
{
    ...
    public int cmdDiagnosePatient(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public boolean canDiagnose(obj_id medic, obj_id target)
    {
    ...
    public boolean haveChargedMedTool(obj_id player, obj_id medikitTool)
    {
    ...
    public String getTemplateParentDirectory(obj_id target)
    {
        if (!isIdValid(target))
        {
            return null;
    ...
    public int foragedItemsMod(obj_id item)
    {
        if (!isIdValid(item))
        {
            return 0;
    ...
    public boolean isCreaturePet(obj_id npc)
    {
