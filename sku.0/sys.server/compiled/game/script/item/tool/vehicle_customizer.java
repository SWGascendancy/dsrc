...
public class vehicle_customizer extends script.base_script
{
    ...
    public int cmdCustomizeVehicle(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public void cleanupCustomizationMenu(obj_id player)
    {
        obj_id self = getSelf();
    ...
    public void cleanupCustomizationMenu()
    {
        obj_id self = getSelf();
    ...
    public void clearTrackingScriptVars(obj_id self)
    {
    ...
    public int handleSelectionSui(obj_id self, dictionary params)
    {
        obj_id player = utils.getObjIdScriptVar(self, SCRIPTVAR_PLAYER);
    ...
    public int handleColorSelection(obj_id self, dictionary params)
    {
        obj_id player = utils.getObjIdScriptVar(self, SCRIPTVAR_PLAYER);
        obj_id target = utils.getObjIdScriptVar(self, SCRIPTVAR_TARGET);
    ...
    public int customizationSuccess(obj_id self, dictionary params)
    {
    ...
    public int customizationFailed(obj_id self, dictionary params)
    {
        if (params != null && !params.isEmpty())
        {
            obj_id player = params.getObjId("player");
