...
public class new_armor extends script.base_script
{
    ...
    public String getSpeciesName(String speciesName)
    {
        String species = "";
    ...
    public int delayedEquip(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        equip(self, player);
        return SCRIPT_CONTINUE;
    }
    public int checkArmorData(obj_id self, dictionary params)
    {
    ...
    public void getProtections(obj_id self)
    {
        int armorType = getGameObjectType(self);
        if (armor.isFinalArmor(armorType))
        {
