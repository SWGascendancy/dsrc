...
public class psg extends script.base_script
{
    ...
    public int handleInitializePsg(obj_id self, dictionary params)
    {
        armor.setPsgEfficiency(self, 0);
    ...
    public int handleEfficiencyUpdate(obj_id self, dictionary params)
    {
    ...
    public void startRegeneration(obj_id self)
    {
