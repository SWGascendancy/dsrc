...
public class base extends script.base_script
{
    ...
    public int updateGeiger(obj_id self, dictionary params)
    {
    ...
    public int geigerCallback(obj_id self, dictionary params)
    {
    ...
    public void openWindow(obj_id player, obj_id geigerObj)
    {
