...
public class heroic_token extends script.base_script
{
    ...
    public void findAndUpdateTokenBox(obj_id self, obj_id player, int amount)
    {
    ...
    public int findMyId(obj_id self)
    {
        int failId = -1;
    ...
    public void updateTokenBox(int myId, obj_id tokenBox, obj_id self, obj_id player, int amount)
    {
    ...
    public void updateTokenCount(int[] currentHeroicTokens, int myId, obj_id self, obj_id tokenBox, obj_id player, int amount)
    {
    ...
    public void decrementTokenCount(obj_id self, obj_id player, int amount)
    {
