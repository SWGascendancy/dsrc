...
public class ice_cream_fail extends script.base_script
{
    ...
    public void eat(obj_id self, obj_id player)
    {
    ...
    public int removeItemFoodScript(obj_id self, dictionary params)
    {
        detachScript(self, ITEM_FOOD_SCRIPT);
        return SCRIPT_CONTINUE;
    }
    public int setUpBuff(obj_id self, dictionary params)
    {
