...
public class fryer extends script.base_script
{
    ...
    public obj_id activateFryer(obj_id fryer, obj_id objPlayer)
    {
    ...
    public double[] makeItemCRCArray()
    {
    ...
    public obj_id createEdible(obj_id fryer, obj_id player, int row)
    {
    ...
    public boolean setFourthIngredient(obj_id fryer, obj_id generatedItem, int row)
    {
    ...
    public String[] getRandomRowNumbersWithoutDuplicates(obj_id fryer)
    {
        if (!isValidId(fryer))
        {
            return null;
    ...
    public boolean burnRandomRecipes(obj_id fryer)
    {
        if (!isValidId(fryer))
        {
            return false;
    ...
    public double calcCurrentContentsCRC(obj_id fryer)
    {
        if (!isValidId(fryer))
        {
            return 0;
    ...
    public boolean decayFryer(obj_id fryer, obj_id user)
    {
        if (!isValidId(fryer))
        {
            return false;
    ...
    public boolean repairFryerPopup(obj_id fryer, obj_id repairTool, obj_id player)
    {
    ...
    public int repairFryer(obj_id self, dictionary params)
    {
        obj_id fryer = self;
    ...
    public boolean blog(String message)
    {
        return true;
    }
}
