...
public class slicing_weapon extends script.base_script
{
    ...
    public boolean applyFireRateChange(obj_id self, obj_id player, int slice_amount)
    {
    ...
    public boolean applyDamageChange(obj_id self, obj_id player, int slice_amount)
    {
        String template = getTemplateName(self);
    ...
    public boolean applyCritChance(obj_id self, obj_id player, int slice_amount)
    {
