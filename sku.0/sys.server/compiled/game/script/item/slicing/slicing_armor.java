...
public class slicing_armor extends script.base_script
{
    ...
    public int finishSlicing(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public boolean applyResilienceChange(obj_id self, obj_id player, int slice_amount)
    {
    ...
    public boolean applyDeflectChange(obj_id self, obj_id player, int slice_amount)
    {
    ...
    public boolean applyCritChange(obj_id self, obj_id player, int slice_amount)
    {
    ...
    public boolean applyArmorBreakChange(obj_id self, obj_id player, int slice_amount)
    {
