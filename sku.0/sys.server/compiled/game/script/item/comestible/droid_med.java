...
public class droid_med extends script.base_script
{
    ...
    public int healDroidDamage(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (target == null)
        {
    ...
    public int healDroidWound(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (target == null)
        {
            sendSystemMessage(self, SID_NO_TARGET);
    ...
    public boolean performDroidHealing(obj_id player, obj_id target, obj_id droid_med)
    {
