...
public class pet_med extends script.base_script
{
    ...
    public int healPetDamage(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isIdValid(target))
        {
    ...
    public boolean performPetHealDamage(obj_id player, obj_id target, obj_id pet_med)
    {
    ...
    public int healPetVitality(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isIdValid(target))
        {
            sendSystemMessage(self, SID_TARGET_NOT_CREATURE);
    ...
    public boolean performPetHealVitality(obj_id player, obj_id target, obj_id pet_med)
    {
        if (!pet_lib.isCreaturePet(target))
        {
            sendSystemMessage(player, SID_TARGET_NOT_CREATURE);
