...
public class trap_base extends script.base_script
{
    ...
    public void trapUsed(obj_id self)
    {
        if (hasObjVar(self, "droid_trap"))
        {
            droidTrapUsed(self);
    ...
    public int trapDone(obj_id self, dictionary params)
    {
        trapUsed(self);
    ...
    public int trapMiss(obj_id self, dictionary params)
    {
    ...
    public void grantTrapXP(obj_id player, obj_id target, float trapMod)
    {
        obj_id self = getSelf();
    ...
    public void assignTrapEffect(obj_id player, obj_id target, int drainhealth, int drainact, int drainmind)
    {
        drainAttributes(target, drainact, drainmind);
    }
    public void droidTrapUsed(obj_id self)
    {
