...
public class armor_base_conversion extends script.base_script
{
    ...
    public void showConfirmationWindow(obj_id player)
    {
        obj_id self = getSelf();
    ...
    public void refitArmor(obj_id player, String newItemTemplate, obj_id oldObject, int armorCategory)
    {
    ...
    public int handleConfirmationSelect(obj_id self, dictionary params)
    {
    ...
    public int handleArmorType(obj_id self, dictionary params)
    {
    ...
    public int handleAssaultSelect(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleBattleSelect(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleReconSelect(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
