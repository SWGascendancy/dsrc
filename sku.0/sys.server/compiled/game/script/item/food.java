...
public class food extends script.base_script
{
    ...
    public void comedere(obj_id self, obj_id player)
    {
    ...
    public boolean instantFoodBurstRunEffect(obj_id target, float costReduction, float cooldownReduction, float dur, float eff)
    {
    ...
    public boolean instantCurePoisonEffect(obj_id target)
    {
    ...
    public boolean instantCureDiseaseEffect(obj_id target)
    {
    ...
    public boolean instantHungryEffect(obj_id target, float eff)
    {
    ...
    public boolean isClickyCombatNerfed(String buff_name)
    {
