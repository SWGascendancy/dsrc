...
public class stage_controller extends script.terminal.base.base_terminal
{
    ...
    public void startController(obj_id player)
    {
        if (!isIdValid(player))
        {
            return;
    ...
    public boolean checkLocation(obj_id item)
    {
        if (!isIdValid(item))
        {
            return false;
    ...
    public void stageMenuStart(obj_id self, obj_id player, String prompt, String title, String[] options, String myHandler, boolean cancel, String PIDVar, String scriptVar)
    {
    ...
    public void stageMenu(obj_id self, obj_id player, String prompt, String title, String[] options, String myHandler, boolean cancel, String PIDVar, String scriptVar)
    {
        closeOldWindow(player, scriptVar);
    ...
    public void closeOldWindow(obj_id player, String scriptVar)
    {
    ...
    public void setWindowPid(obj_id player, int pid, String scriptVar)
    {
        if (pid > -1)
        {
    ...
    public int stageMenuChoice(obj_id self, dictionary params)
    {
    ...
    public int handleBackdrop(obj_id self, dictionary params)
    {
        obj_id container = getTopMostContainer(self);
    ...
    public int handleBackdropDesign(obj_id self, dictionary params)
    {
        int backdropNumber = 0;
        obj_id player = sui.getPlayerId(params);
        int btn = sui.getIntButtonPressed(params);
    ...
    public int handleSmoke(obj_id self, dictionary params)
    {
        obj_id container = getTopMostContainer(getSelf());
        obj_id player = sui.getPlayerId(params);
        int btn = sui.getIntButtonPressed(params);
    ...
    public int handlePyrotechnic(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        obj_id container = getTopMostContainer(getSelf());
        int btn = sui.getIntButtonPressed(params);
    ...
    public int handleFog(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        obj_id container = getTopMostContainer(getSelf());
        int btn = sui.getIntButtonPressed(params);
    ...
    public int handleLight(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        int btn = sui.getIntButtonPressed(params);
        if (btn == sui.BP_CANCEL)
    ...
    public int handleAllBackdropPicture(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        int btn = sui.getIntButtonPressed(params);
        if (btn == sui.BP_CANCEL)
    ...
    public boolean changeBackdrop(obj_id prop, String backdropObject, int backdropNumber)
    {
        obj_id self = getSelf();
    ...
    public boolean playSmokeEffect(obj_id prop)
    {
        if (!isIdValid(prop))
        {
            return false;
    ...
    public boolean playFireEffect(obj_id prop)
    {
        if (!isIdValid(prop))
        {
            return false;
    ...
    public boolean playLightEffect(obj_id prop)
    {
        if (!isIdValid(prop))
        {
            return false;
    ...
    public boolean startFogEffect(obj_id prop)
    {
        obj_id self = getSelf();
        if (!isIdValid(prop))
        {
