...
public class show extends script.base_script
{
    ...
    public int handleAddEventSui(obj_id self, dictionary params)
    {
    ...
    public int handleEventDataSUI(obj_id self, dictionary params)
    {
        firework.removeSUIScriptVars(self);
        return SCRIPT_CONTINUE;
    }
    public int handleRemoveEventSUI(obj_id self, dictionary params)
    {
        firework.removeSUIScriptVars(self);
        int bp = sui.getIntButtonPressed(params);
        if (bp == sui.BP_CANCEL)
    ...
    public int handleReorderEventsSUI(obj_id self, dictionary params)
    {
        firework.removeSUIScriptVars(self);
        int bp = sui.getIntButtonPressed(params);
        if (bp == sui.BP_CANCEL)
    ...
    public int handleModifyEventIndexSUI(obj_id self, dictionary params)
    {
        firework.removeSUIScriptVars(self);
        int bp = sui.getIntButtonPressed(params);
        if (bp == sui.BP_CANCEL)
    ...
    public int handleModifyEventTimeSUI(obj_id self, dictionary params)
    {
    ...
    public void addDebugRandomEvent(obj_id show)
    {
