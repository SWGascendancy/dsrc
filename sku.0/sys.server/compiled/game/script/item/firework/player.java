...
public class player extends script.base_script
{
    ...
    public int handleFireworkPrepare(obj_id self, dictionary params)
    {
    ...
    public int handleFireworkLaunch(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            firework.dud(self);
    ...
    public int handleFireworkCleanup(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            firework.dud(self);
