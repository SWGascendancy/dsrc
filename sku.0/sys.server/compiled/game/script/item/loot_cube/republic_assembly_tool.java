...
public class republic_assembly_tool extends script.base_script
{
    ...
    public obj_id activateAssemblyTool(obj_id assemblyTool, obj_id objPlayer)
    {
    ...
    public double calcCurrentContentsCRC(obj_id assemblyTool)
    {
    ...
    public void fixBrokenComponents(obj_id item)
    {
        String template = getTemplateName(item);
