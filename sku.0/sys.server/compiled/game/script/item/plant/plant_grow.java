...
public class plant_grow extends script.base_script
{
    ...
    public int msgPlantGrowPulse(obj_id self, dictionary params)
    {
    ...
    public boolean showPlantResourceSUI(obj_id player, obj_id plant, String type)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public boolean intializePlant(obj_id plant)
    {
        if (!isIdValid(plant))
        {
            return false;
    ...
    public boolean changeSize(obj_id plant, int size)
    {
        if (!isIdValid(plant))
        {
            return false;
    ...
    public int getPulseRate(obj_id plant)
    {
