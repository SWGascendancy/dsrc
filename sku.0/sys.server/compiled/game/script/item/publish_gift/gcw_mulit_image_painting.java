...
public class gcw_mulit_image_painting extends script.base_script
{
    ...
    public int handleOnAttachSetup(obj_id self, dictionary params)
    {
    ...
    public boolean canUsePainting(obj_id painting, obj_id player)
    {
    ...
    public void showControlMenu(obj_id self, obj_id player)
    {
        closeOldWindow(self);
    ...
    public void closeOldWindow(obj_id self)
    {
    ...
    public int paintingControlsHandler(obj_id self, dictionary params)
    {
    ...
    public void setupPaintingMode(obj_id self, obj_id player, int modeChoice)
    {
    ...
    public void setToRebelPaintingMode(obj_id self, obj_id player)
    {
    ...
    public void setToImperialPaintingMode(obj_id self, obj_id player)
    {
    ...
    public void setToCyclingPaintingMode(obj_id self, obj_id player)
    {
    ...
    public void setToPlanetaryControlPaintingMode(obj_id self, obj_id player)
    {
    ...
    public void setToGalacticControlPaintingMode(obj_id self, obj_id player)
    {
    ...
    public int getStartTexture(obj_id self, obj_id player)
    {
    ...
    public int getPlanetaryControlTexture(obj_id self, obj_id player)
    {
        location here = getLocation(self);
    ...
    public int getGcwControlTexture(obj_id self, obj_id player, String category)
    {
    ...
    public int cyclingPaintingHandler(obj_id self, dictionary params)
    {
        if (checkLocation(self))
        {
            int paintingMode = getIntObjVar(self, PAINTING_CUR_MODE_OBJVAR);
    ...
    public int gcwFactionControlPaintingHandler(obj_id self, dictionary params)
    {
        if (checkLocation(self))
        {
            int paintingMode = getIntObjVar(self, PAINTING_CUR_MODE_OBJVAR);
