...
public class holopet_emitter extends script.base_script
{
    ...
    public void turnOn(obj_id self, obj_id player, String type)
    {
    ...
    public dictionary getBeastHolopetData(String type, obj_id self)
    {
        String template = "";
    ...
    public dictionary getVeteranRewardHolopetData(String type)
    {
        String template = "";
        string_id name = new string_id("publish_gift/holopet", "default_name");
        float scale = 1.0f;
    ...
    public void setDefaultHolopetName(obj_id pet, string_id name, String holobeastName)
    {
    ...
    public void turnOff(obj_id self, obj_id player)
    {
    ...
    public void showNamePetSui(obj_id self, obj_id player)
    {
    ...
    public boolean isTurnedOn(obj_id self)
    {
        if (!hasObjVar(self, "holopet_active"))
        {
            return false;
    ...
    public boolean unloadDataCube(obj_id self, obj_id player, boolean verbose)
    {
        obj_id owner = getOwner(self);
        if (!isValidId(owner))
        {
    ...
    public void displayLoadDataCubeSui(obj_id self, obj_id player)
    {
    ...
    public int handleNamePet(obj_id self, dictionary params)
    {
    ...
    public int handleLoadDataCube(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
    ...
    public int handleActivateHolograms(obj_id self, dictionary params)
    {
        if (hasObjVar(self, "holopet_active") && !isTurnedOn(self))
        {
            turnOn(self, null, "");
    ...
    public int handleHologramHeartbeat(obj_id self, dictionary params)
    {
