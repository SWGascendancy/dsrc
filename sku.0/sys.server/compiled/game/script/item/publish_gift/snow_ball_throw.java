...
public class snow_ball_throw extends script.base_script
{
    ...
    public void throwMe(obj_id target, obj_id player, obj_id self)
    {
    ...
    public int snowballDelay(obj_id self, dictionary params)
    {
        if (hasObjVar(self, "snowball_pause"))
        {
    ...
    public attacker_results makeDummyAttackerResults(obj_id objAttacker)
    {
    ...
    public defender_results[] makeDummyDefenderResults(obj_id objDefender)
    {
