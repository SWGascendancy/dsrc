...
public class snow_machine extends script.base_script
{
    ...
    public void cleanUpScriptsAndSuch(obj_id snowMachine)
    {
    ...
    public void checkRefreshParticle(obj_id snowMachine)
    {
        if (hasObjVar(snowMachine, "snow_machine_on"))
        {
            stopSnowParticle(snowMachine);
    ...
    public void stopSnowParticle(obj_id snowMachine)
    {
    ...
    public void playSnowParticle(obj_id snowMachine)
    {
    ...
    public void removeStormObjVar(obj_id snowMachine)
    {
        if (hasObjVar(snowMachine, "snowMachine.storm1"))
        {
