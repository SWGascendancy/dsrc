...
public class weather_machine extends script.base_script
{
    ...
    public int handleCleanUpScriptsAndSuch(obj_id self, dictionary params)
    {
        cleanUpScriptsAndSuch(self);
        return SCRIPT_CONTINUE;
    }
    public void cleanUpScriptsAndSuch(obj_id weatherMachine)
    {
    ...
    public void checkRefreshParticle(obj_id weatherMachine)
    {
        if (hasObjVar(weatherMachine, "weather_machine_on"))
        {
            stopWeatherParticle(weatherMachine);
    ...
    public void stopWeatherParticle(obj_id weatherMachine)
    {
        if (hasObjVar(weatherMachine, "weatherParticleId"))
        {
    ...
    public void playWeatherParticle(obj_id weatherMachine)
    {
    ...
    public void removeStormObjVar(obj_id weatherMachine)
    {
        if (hasObjVar(weatherMachine, "weatherMachine.storm1"))
        {
