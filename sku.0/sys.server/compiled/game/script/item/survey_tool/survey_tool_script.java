...
public class survey_tool_script extends script.base_script
{
    ...
    public int OnObjectMenuRequest(obj_id self, obj_id player, menu_info mi)
    {
        ...
        if (resource_class.equals("") || resource_class == null)
        {
        ...
        if (baseMod.equals("") || baseMod == null)
        {
    ...
    public int OnRequestSurvey(obj_id self, obj_id player, String resource_type)
    {
        obj_id containPlayer = getTopMostContainer(player);
        if (containPlayer != player)
        {
    ...
    public int finalizeSurvey(obj_id self, dictionary params)
    {
    ...
    public void checkNewbieHandoffSurveyMission(obj_id player, String resource_type)
    {
    ...
    public int OnRequestCoreSample(obj_id self, obj_id player, String resource_type)
    {
    ...
    public int sampleLoop(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleRadioactiveConfirm(obj_id self, dictionary params)
    {
    ...
    public int samplingEffect(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int resourceHarvest(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
    ...
    public int handleSetRange(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int continueSampleLoop(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        messageTo(self, "samplingEffect", params, getSurveyToolDelay(player), false);
        messageTo(self, "resourceHarvest", params, getSurveyToolDelay(player) + 2, false);
    ...
    public int stopSampleEvent(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        resource.cleanupTool(player, self);
        queueCommand(player, (-1465754503), player, "No params.", COMMAND_PRIORITY_FRONT);
    ...
    public String pickSpecialResourceToGive(obj_id player, String resource)
    {
        String special = "";
        ...
        else 
        {
            ...
            {
                special = "object/tangible/loot/quest/rudic.iff"; // finch validate this quest loot
            }
        }
        return special;
    }
    public void setSpecialResourceObjVars(String special, obj_id resource, float efficiency)
    {
    ...
    public int getResourceValue(int average)
    {
    ...
    public int getSurveyToolDelay(obj_id player)
    {
        if (!isIdValid(player))
        {
