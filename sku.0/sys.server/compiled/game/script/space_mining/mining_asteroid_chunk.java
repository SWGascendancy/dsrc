...
public class mining_asteroid_chunk extends script.base_script
{
    ...
    public int OnShipInternalDamageOverTimeRemoved(obj_id self, int chassisSlot, float damageRate, float damageThreshold)
    {
    ...
    public boolean shipAbsorbAsteroid(obj_id asteroid, obj_id attacker, int amount)
    {
    ...
    public int OnShipWasHit(obj_id self, obj_id attacker, int weaponIndex, boolean isMissile, int missileType, int chassisSlot, boolean isPlayerAutoTurret, float hitLocationX_o, float hitLocationY_o, float hitLocationZ_o)
    {
        obj_id attackingPilot = space_utils.getPilotForRealsies(attacker);
    ...
    public obj_id grantRareAsteroid(obj_id player)
    {
    ...
    public String getResourceClassNameForAsteroid(String strAsteroidType)
    {
