...
public class terminal_medicine extends script.base_script
{
    ...
    public boolean setCanUseTerminal(obj_id terminal, boolean toggle)
    {
        if (terminal == null)
        {
            return false;
    ...
    public boolean canUseTerminal(obj_id terminal)
    {
    ...
    public int msgMedicineTerminal(obj_id self, dictionary params)
    {
        setCanUseTerminal(self, true);
        return SCRIPT_CONTINUE;
    }
