...
public class messaging extends script.base_script
{
    ...
    public int setLoginTitle(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int setLoginMessage(obj_id self, obj_id target, String params, float defaultTime)
    {
        location locTest = getLocation(self);
        obj_id objPlanetObject = getPlanetByName(locTest.area);
    ...
    public int resendLoginMessageToAll(obj_id self, obj_id target, String params, float defaultTime)
    {
        location locTest = getLocation(self);
        obj_id objPlanetObject = getPlanetByName(locTest.area);
