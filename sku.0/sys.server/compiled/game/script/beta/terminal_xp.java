...
public class terminal_xp extends script.terminal.base.terminal_add_use
{
    ...
    public void initializeXpTerminal(obj_id self)
    {
    ...
    public int handleXpSelect(obj_id self, dictionary params)
    {
    ...
    public int handleXpAmountSelect(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        int btn = sui.getIntButtonPressed(params);
    ...
    public int handleDisplayXp(obj_id self, dictionary params)
    {
