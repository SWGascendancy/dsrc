...
public class terminal_resource extends script.terminal.base.terminal_add_use
{
    ...
    public int handleSetPlanet(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            cleanScriptVars();
    ...
    public int handleResourceSelection(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            cleanScriptVars();
    ...
    public String[] buildAvailableResourceTree(location loc, String topParent)
    {
    ...
    public String[] buildAllAvailableResourceTree(String topParent)
    {
    ...
    public String[] buildSortedResourceTree(resource_density[] resources, String topParent, int branchLevel)
    {
