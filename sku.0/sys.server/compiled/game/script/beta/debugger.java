...
public class debugger extends script.base_script
{
    ...
    public void hueClothes(obj_id newClothes, int col)
    {
    ...
    public int handleSignedStructureCreation(obj_id self, dictionary params)
    {
    ...
    public int handleGrantAllSkills(obj_id self, dictionary params)
    {
