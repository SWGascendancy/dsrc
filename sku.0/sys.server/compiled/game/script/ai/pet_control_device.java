...
public class pet_control_device extends script.base_script
{
    ...
    public int handleSetMountName(obj_id self, dictionary params)
    {
    ...
    public int delayCreatePet(obj_id self, dictionary params)
    {
    ...
    public int delayMountPet(obj_id self, dictionary params)
    {
    ...
    public void destroyCurrentPet(obj_id petControlDevice)
    {
    ...
    public int handleStorePetRequest(obj_id self, dictionary params)
    {
        obj_id currentPet = callable.getCDCallable(self);
        if (!isIdValid(currentPet))
        {
    ...
    public int handleGrowthChoice(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
    ...
    public boolean isSameFaction(obj_id petControlDevice)
    {
        obj_id datapad = getContainedBy(petControlDevice);
        if (!isIdValid(datapad))
        {
    ...
    public int getLevelFromPetControlDevice(obj_id petControlDevice)
    {
        int growthStage = 10;
        if (hasObjVar(petControlDevice, "ai.petAdvance.growthStage"))
        {
    ...
    public int handlePetDeathblow(obj_id self, dictionary params)
    {
    ...
    public void setTimeStored(obj_id PCD)
    {
        setObjVar(PCD, "pet.timeStored", getGameTime());
    }
    public int handleFlagDeadCreature(obj_id self, dictionary params)
    {
        setObjVar(self, "pet.isDead", true);
        return SCRIPT_CONTINUE;
    }
    public boolean petIsDead(obj_id petControlDevice, obj_id player, int petType)
    {
    ...
    public boolean canBeTransferred(obj_id petControlDevice, obj_id newMaster, obj_id transferer)
    {
        String creatureName = getStringObjVar(petControlDevice, "pet.creatureName");
        if (creatureName == null || creatureName.equals(""))
        {
    ...
    public boolean validatePetStats(obj_id pcd, obj_id player)
    {
    ...
    public int handleValidatePet(obj_id self, dictionary params)
    {
        obj_id currentPet = callable.getCDCallable(self);
    ...
    public int removeGallop(obj_id self, dictionary params)
    {
    ...
    public int removeGallopTired(obj_id self, dictionary params)
    {
    ...
    public void listAllCommands(obj_id petControlDevice, obj_id player)
    {
        if (!hasObjVar(petControlDevice, "ai.pet.command"))
        {
            return;
    ...
    public int handleStatUpdate(obj_id self, dictionary params)
    {
    ...
    public int handleRemoveCurrentPet(obj_id self, dictionary params)
    {
    ...
    public int handlePetFixDialog(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public boolean isOnMaintRun(obj_id pet)
    {
    ...
    public boolean isVetRewardPet(String creatureName)
    {
        return creatureName.equals("ep3_mount_varactyl");
    }
    public int respawnDroid(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("master");
        obj_id currentPet = callable.getCDCallable(self);
        if (!isIdValid(currentPet))
    ...
    public int handleConvertPetSui(obj_id self, dictionary params)
    {
        int bp = sui.getIntButtonPressed(params);
        if (bp == sui.BP_CANCEL)
        {
    ...
    public int dancingDroidSoundObjectDestroyed(obj_id self, dictionary params)
    {
