...
public class trandoshan_poacher extends script.base_script
{
    ...
    public void initializeScript()
    {
        ...
        setName(self, "Trandoshan Poacher");
    }
    ...
    public void initiateDialog(obj_id talker, obj_id listener)
    {
    ...
    public int handleSocializingRecovery(obj_id self, dictionary params)
    {
    ...
    public int handleEndSocializing(obj_id self, dictionary params)
    {
        if (!utils.hasScriptVar(self, "ai.pathingToSocialize"))
        {
            return SCRIPT_CONTINUE;
    ...
    public void endSocializing(obj_id talker, obj_id listener)
    {
    ...
    public void followTusken(obj_id npc, obj_id target)
    {
    ...
    public int resumeLoitering(obj_id self, dictionary params)
    {
    ...
    public void cancelFollowing(obj_id npc)
    {
    ...
    public int stopBeingFollowed(obj_id self, dictionary params)
    {
    ...
    public void takeBantha(obj_id tusken, obj_id bantha)
    {
