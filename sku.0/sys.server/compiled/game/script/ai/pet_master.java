...
public class pet_master extends script.base_script
{
    ...
    public int failPetBuff(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdDetonateDroid(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int clearBombDroidTimer(obj_id self, dictionary params)
    {
    ...
    public boolean hasPrereq(obj_id pet, int ability)
    {
    ...
    public boolean hasPrereq(int[] abilityList, int ability)
    {
    ...
    public int[] buildPrereqList(int ability)
    {
    ...
    public int droid_follow(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int droid_follow_other(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int droid_stay(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int droid_guard(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int droid_friend(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int droid_attack(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int droid_patrol(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int droid_patrol_point(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int droid_patrol_clear(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int droid_store(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int droid_transfer(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int droid_group(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int droid_trick_1(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int droid_trick_2(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int droid_trick_3(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int droid_trick_4(obj_id self, obj_id target, String params, float defaultTime)
    {
