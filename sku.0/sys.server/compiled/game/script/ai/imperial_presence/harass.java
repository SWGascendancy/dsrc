...
public class harass extends script.base_script
{
    ...
    public String getFactionName(obj_id self)
    {
    ...
    public boolean isInFriendlyFaction(obj_id self, obj_id who)
    {
    ...
    public boolean isOnLeaveFromFriendlyFaction(obj_id self, obj_id who)
    {
    ...
    public boolean isInEnemyFaction(obj_id self, obj_id target)
    {
    ...
    public int OnTriggerVolumeEntered(obj_id self, String volName, obj_id who)
    {
    ...
    public int OnTriggerVolumeExited(obj_id self, String volName, obj_id who)
    {
        if (!isIdValid(who))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleHarassTarget(obj_id self, dictionary params)
    {
    ...
    public int handleNewHarassTarget(obj_id self, dictionary params)
    {
    ...
    public int handleCheckpointMode(obj_id self, dictionary params)
    {
        obj_id harassTarget = utils.getObjIdScriptVar(self, SCRIPTVAR_TARGET);
    ...
    public boolean enterHarassMode(obj_id self, dictionary params)
    {
        obj_id target = params.getObjId("harassTarget");
        if (target == null)
        {
    ...
    public boolean enterHarassMode(obj_id self, obj_id target)
    {
    ...
    public int followHarass(obj_id self, dictionary params)
    {
        obj_id target = utils.getObjIdScriptVar(self, SCRIPTVAR_TARGET);
        ai_lib.aiFollow(self, target);
        return SCRIPT_CONTINUE;
    }
    public void enterCheckpointMode(obj_id self)
    {
        cleanupHarassment(self);
        setMovementWalk(self);
        ai_lib.wander(self);
    }
    public void cleanupHarassment(obj_id self)
    {
        obj_id target = utils.getObjIdScriptVar(self, SCRIPTVAR_TARGET);
        if (isIdValid(target))
        {
    ...
    public void volDetainBreach(obj_id self, obj_id who)
    {
        if (!isPlayer(who))
        {
            return;
    ...
    public int handleScanComplete(obj_id self, dictionary params)
    {
        ...
        if (isEnemyJedi(self, target) && playerLevel >= 75 && rand(1, 5) == 1)
        {
    ...
    public boolean isEnemyJedi(obj_id self, obj_id target)
    {
    ...
    public int handleReturnRequest(obj_id self, dictionary params)
    {
        int status = utils.getIntScriptVar(self, SCRIPTVAR_STATUS);
        obj_id target = params.getObjId("target");
        if (!isIdValid(target))
    ...
    public void attackFactionViolator(obj_id self, obj_id target, boolean antiJedi)
    {
        if (isJedi(target))
        {
    ...
    public void invokePenaltyAction(obj_id self, obj_id target)
    {
    ...
    public void invokePenaltyAction(obj_id self, obj_id target, float rating)
    {
    ...
    public void penaltyAction(obj_id self, obj_id target, float lostFaction)
    {
    ...
    public int fineImperial(obj_id self, dictionary params)
    {
        obj_id target = params.getObjId("target");
    ...
    public void showFineSui(obj_id self, obj_id target, float rating)
    {
        if (!isIdValid(self) || !isIdValid(target))
        {
            return;
    ...
    public int handleFineSui(obj_id self, dictionary params)
    {
    ...
    public int handleJediMindTrick(obj_id self, dictionary params)
    {
        obj_id target = params.getObjId("target");
    ...
    public int handleJediMindTrickDark(obj_id self, dictionary params)
    {
        obj_id target = params.getObjId("target");
    ...
    public int handleJediMindTrickNovice(obj_id self, dictionary params)
    {
        obj_id target = params.getObjId("target");
    ...
    public void cleanupImperialFine(obj_id target)
    {
