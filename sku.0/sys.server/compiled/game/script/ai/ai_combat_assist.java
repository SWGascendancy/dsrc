...
public class ai_combat_assist extends script.base_script
{
    ...
    public static void assist(obj_id defender, obj_id target)
    {
    }
    public static boolean canCallForAssist()
    {
        final obj_id self = getSelf();
        deltadictionary dict = self.getScriptVars();
        return !dict.getBoolean("ai.combat.assist.noAssistCall");
    }
    public static boolean callForAssist()
    {
        obj_id self = getSelf();
    ...
    public static void startAssistedCombat(obj_id creature, obj_id target)
    {
