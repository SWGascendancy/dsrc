...
public class dancing_droid extends script.base_script
{
    ...
    public int clearDancingDroidScriptVar(obj_id self, dictionary params)
    {
        if (utils.hasScriptVar(self, "music.stillPlaying"))
        {
            obj_id pcd = callable.getCallableCD(self);
    ...
    public int moveDancingDroidStartLocation(obj_id self, dictionary params)
    {
        location startLocation = getLocation(self);
    ...
    public int moveDancingDroidNewLocation(obj_id self, dictionary params)
    {
        location startLocation = getLocation(self);
        if (utils.hasScriptVar(self, "dancingDroid.startLocation"))
        {
    ...
    public int destroyDancingDroidSoundObject(obj_id self, dictionary params)
    {
