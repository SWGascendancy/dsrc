...
public class pet extends script.base_script
{
    ...
    public int handleSetupPet(obj_id self, dictionary params)
    {
    ...
    public int handleLostMaster(obj_id self, dictionary params)
    {
        if (!pet_lib.findMaster(self))
        {
            destroyObject(self);
    ...
    public int doCalmerBehavior(obj_id npc, int newBehavior, int oldBehavior)
    {
        switch (newBehavior)
        {
            case BEHAVIOR_CALM:
    ...
    public int doAgitatedBehavior(obj_id npc, int newBehavior, int oldBehavior)
    {
        switch (newBehavior)
        {
            case BEHAVIOR_CALM:
    ...
    public int handlePetTargetKilled(obj_id self, dictionary params)
    {
    ...
    public int lairThreatened(obj_id self, dictionary params)
    {
        return SCRIPT_OVERRIDE;
    }
    ...
    public int handlePetIncappedDecay(obj_id self, dictionary params)
    {
    ...
    public int handlePrimaryColorize(obj_id self, dictionary params)
    {
    ...
    public int handleLearnCommandDialog(obj_id self, dictionary params)
    {
    ...
    public int handleLearnCommandUpdate(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            utils.removeScriptVarTree(self, "ai.learnCommand");
    ...
    public int OnHearSpeech(obj_id self, obj_id master, String text)
    {
        pet_lib.processSpeech(self, master, text);
        return SCRIPT_CONTINUE;
    }
    public int handleTellPet(obj_id self, dictionary params)
    {
    ...
    public int awakenPet(obj_id self, dictionary params)
    {
    ...
    public void checkForWounds(obj_id pet)
    {
    }
    public void managePowerConsumption(obj_id pet)
    {
    ...
    public int handleAbandonment(obj_id self, dictionary params)
    {
    ...
    public int consumePower(obj_id self, dictionary params)
    {
        obj_id petControlDevice = callable.getCallableCD(self);
        int powerLevel = getIntObjVar(petControlDevice, "ai.pet.powerLevel");
        powerLevel++;
    ...
    public int powerWarningText(obj_id self, dictionary params)
    {
        obj_id petControlDevice = callable.getCallableCD(self);
        int powerLevel = getIntObjVar(petControlDevice, "ai.pet.powerLevel");
        if (powerLevel < 10)
    ...
    public int resumePetTrick(obj_id self, dictionary params)
    {
        obj_id master = params.getObjId("master");
    ...
    public int handleMoveToMaster(obj_id self, dictionary params)
    {
        if (!isMob(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handlePackRequest(obj_id self, dictionary params)
    {
    ...
    public int handleAddToStomach(obj_id self, dictionary params)
    {
    ...
    public int handleSetColors(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleSetCustomization(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public boolean setColors(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return false;
    ...
    public void reallyKill(obj_id self)
    {
        if (!isMob(self))
        {
            return;
    ...
    public int OnReceivedItem(obj_id self, obj_id objSource, obj_id objTransferer, obj_id objItem)
    {
        if (isPlayer(objItem))
        {
    ...
    public int OnLostItem(obj_id self, obj_id objDestinationContainer, obj_id objTransferer, obj_id objItem)
    {
        if (isPlayer(objItem))
        {
    ...
    public int handlePetTradeInStore(obj_id self, dictionary params)
    {
    ...
    public void handleTutorialDroidSetUp(obj_id player, menu_info mi, obj_id self)
    {
        int opt_menu = 0;
        int mnu = 0;
        opt_menu = mi.addRootMenu(menu_info_types.VOTE, new string_id(MENU_FILE, "droid_options"));
