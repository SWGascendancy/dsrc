...
public class creature_combat extends script.systems.combat.combat_base
{
    ...
    public int ai_assist_check(obj_id self, dictionary params)
    {
        if (!isIdValid(self) || !exists(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public void cleanupForTether(obj_id self)
    {
        if (!isIdValid(self) || !exists(self))
        {
            return;
    ...
    public int OnAiTetherComplete(obj_id self)
    {
        ai_lib.resetAi();
        return SCRIPT_CONTINUE;
    }
    public int OnHateTargetChanged(obj_id self, obj_id target)
    {
    ...
    public int OnHateTargetAdded(obj_id self, obj_id target)
    {
        return SCRIPT_CONTINUE;
    }
    public int OnHateTargetRemoved(obj_id self, obj_id target)
    {
    ...
    public int OnAiPrimaryWeaponEquipped(obj_id self, obj_id primaryWeapon)
    {
        clearCombatActions();
        return SCRIPT_CONTINUE;
    }
    public int OnAiSecondaryWeaponEquipped(obj_id self, obj_id secondaryWeapon)
    {
        clearCombatActions();
        return SCRIPT_CONTINUE;
    }
    ...
    public obj_id getBestTarget(obj_id self)
    {
    ...
    public void move(obj_id target)
    {
        final obj_id self = getSelf();
    ...
    public void selectWeapon(obj_id target)
    {
        final obj_id self = getSelf();
        if (beast_lib.isBeast(self))
        {
    ...
    public void attack(obj_id target)
    {
        final obj_id self = getSelf();
    ...
    public boolean isNearLair(obj_id npc)
    {
    ...
    public void killPlayer(obj_id npc, obj_id target)
    {
    ...
    public int OnFleeTargetLost(obj_id self, obj_id target)
    {
        if (!ai_lib.isInCombat(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int OnFleePathNotFound(obj_id self, obj_id target)
    {
        if (!ai_lib.isInCombat(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int OnFollowMoving(obj_id self, obj_id followTarget)
    {
        if (!ai_lib.isInCombat(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int OnFollowTargetLost(obj_id self, obj_id target)
    {
        if (!ai_lib.isInCombat(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int OnMovePathNotFound(obj_id self)
    {
        if (!ai_lib.isInCombat(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleMoveRandomClear(obj_id self, dictionary params)
    {
        return SCRIPT_CONTINUE;
    }
    public int handleTaunt(obj_id self, dictionary params)
    {
        if (ai_lib.isInCombat(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int getConfusionDuration(obj_id npc, obj_id attacker)
    {
    ...
    public int handleCombatDestructionDelay(obj_id self, dictionary params)
    {
        destroyObject(self);
        return SCRIPT_CONTINUE;
    }
    public int OnDotPulse(obj_id self, dictionary params)
    {
        if (ai_lib.isInCombat(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleAggroCheck(obj_id self, dictionary params)
    {
    ...
    public int handleAggroStart(obj_id self, dictionary params)
    {
        if (beast_lib.isBeast(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleSawRecapacitation(obj_id self, dictionary params)
    {
        final obj_id player = params.getObjId("player");
        stopListeningToMessage(player, "handleSawRecapacitation");
        return SCRIPT_CONTINUE;
    }
    public void clearCombatActions()
    {
        obj_id self = getSelf();
        removeObjVar(self, "ai.combat.forcedAction");
        removeObjVar(self, "ai.combat.pendingAction");
    }
    public int checkForSpecials(obj_id self, dictionary params)
    {
        if (!verifyMessage(self, params) || !pet_lib.hasMaster(self))
        {
            return SCRIPT_CONTINUE;
        }
    ...
    public dictionary stampMessage(obj_id self)
    {
    ...
    public int getMessageSession(obj_id self)
    {
        return utils.hasScriptVar(self, "messageStamp") ? utils.getIntScriptVar(self, "messageStamp") : 0;
    }
    public boolean verifyMessage(obj_id self, dictionary params)
    {
        int messageId = params.getInt("sessionId");
        int currentId = utils.getIntScriptVar(self, "messageStamp");
        return messageId == currentId;
    }
    public void bumpSession(obj_id self)
    {
        int session = getMessageSession(self);
        session++;
        utils.setScriptVar(self, "messageStamp", session);
    }
    public int checkForBeastSpecialsTakeOne(obj_id self, dictionary params)
    {
        if (beast_lib.isBeast(self))
        {
            messageTo(self, "checkForSpecials", stampMessage(self), 1.0f, false);
    ...
    public int persist_combat(obj_id self, dictionary params)
    {
