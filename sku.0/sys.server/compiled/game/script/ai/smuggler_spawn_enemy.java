...
public class smuggler_spawn_enemy extends script.base_script
{
    ...
    public void doSnare(obj_id playerSmuggler, obj_id npc)
    {
    ...
    public void broadcastCondition(obj_id playerSmuggler, obj_id npc, int flag)
    {
    ...
    public void enemyPickFight(obj_id npc, obj_id victimNpc, obj_id playerSmuggler)
    {
        clearHateList(npc);
    ...
    public void doConfuse(obj_id playerSmuggler, obj_id npc)
    {
    ...
    public void doConfuseAttack(obj_id playerSmuggler, obj_id npc)
    {
        location here = getLocation(npc);
    ...
    public int smugglerKilled(obj_id self, dictionary params)
    {
        if (isIncapacitated(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int endConfusion(obj_id self, dictionary params)
    {
        obj_id playerSmuggler = params.getObjId("playerSmuggler");
        setMaster(self, null);
