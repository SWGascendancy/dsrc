...
public class pcd_ping_response extends script.base_script
{
    ...
    public int handlePetPing(obj_id self, dictionary params)
    {
    ...
    public dictionary createResponseDictionary(obj_id pcdId, int messageNumber)
    {
    ...
    public void sendPositiveAcknowledgement(obj_id pcdId, obj_id petId, int messageNumber)
    {
    ...
    public void sendNegativeAcknowledgement(obj_id pcdId, obj_id petId, int messageNumber, String reason)
    {
        dictionary messageData = createResponseDictionary(pcdId, messageNumber);
    ...
    public boolean isRiderOkayForPcd(obj_id pcdId, obj_id riderId)
    {
