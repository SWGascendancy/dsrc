...
public class scout extends script.base_script
{
    ...
    public int handleTargetAssignment(obj_id self, dictionary params)
    {
    ...
    public void scoutTarget(obj_id npc, obj_id target)
    {
    ...
    public void acquireNewTarget(obj_id self)
    {
        if (!isIdValid(self))
        {
            return;
    ...
    public int handleNeedTarget(obj_id self, dictionary params)
    {
        acquireNewTarget(self);
        return SCRIPT_CONTINUE;
    }
    public int callLambdaSupport(obj_id self, dictionary params)
    {
    ...
    public int handleClearSupportCall(obj_id self, dictionary params)
    {
        if (ai_lib.isDead(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int reportActivities(obj_id self, dictionary params)
    {
        if (ai_lib.isDead(self))
        {
            return SCRIPT_CONTINUE;
