...
public class spy_decoy extends script.base_script
{
    ...
    public int destroyDecoy(obj_id self, dictionary params)
    {
    ...
    public boolean isFlanking(obj_id self)
    {
    ...
    public int handleDecoyCleanup(obj_id self, dictionary params)
    {
    ...
    public int queue_ad(obj_id self, dictionary params)
    {
