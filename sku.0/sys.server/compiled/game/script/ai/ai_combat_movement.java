...
public class ai_combat_movement extends script.base_script
{
    ...
    public static boolean aiIsMovingToSee(obj_id target)
    {
    ...
    public static boolean aiIsMovingToSee()
    {
        final obj_id self = getSelf();
        final deltadictionary dict = self.getScriptVars();
        return (dict.getInt("ai.combat.moveMode") == MOVEMODE_MOVING_TO_SEE);
    }
    public static obj_id aiGetMoveToSeeTarget()
    {
        final obj_id self = getSelf();
        final deltadictionary dict = self.getScriptVars();
        return dict.getObjId("ai.combat.moveToSee.target");
    }
    public static void aiMoveToDeathBlow(obj_id target)
    {
    ...
    public static boolean aiIsMovingToDeathBlow(obj_id target)
    {
    ...
    public static boolean aiIsMovingToDeathBlow()
    {
        final obj_id self = getSelf();
        final deltadictionary dict = self.getScriptVars();
        return (dict.getInt("ai.combat.moveMode") == MOVEMODE_MOVING_TO_DEATHBLOW);
    }
    public static obj_id aiGetMoveToDeathBlowTarget()
    {
        final obj_id self = getSelf();
        final deltadictionary dict = self.getScriptVars();
        return dict.getObjId("ai.combat.moveToDeathBlow.target");
    }
    public static void aiFollow(obj_id target, float minDistance, float maxDistance)
    {
    ...
    public static void aiSwarm(obj_id target, float minDistance, float maxDistance)
    {
    ...
    public static boolean aiIsFollowing(obj_id target, float minDistance, float maxDistance)
    {
        final obj_id self = getSelf();
        final deltadictionary dict = self.getScriptVars();
    ...
    public static boolean aiIsSwarming(obj_id target, float minDistance, float maxDistance)
    {
        final obj_id self = getSelf();
        final deltadictionary dict = self.getScriptVars();
    ...
    public static float getActualEvadeChance(obj_id ai, float min, float max)
    {
        float rslt = max;
    ...
    public static boolean aiEvade(obj_id target, obj_id ai, range_info aiWeaponRanges, float minChance, float maxChance)
    {
    ...
    public static location getValidAwayLocation(obj_id mob, float minDistance, float maxDistance)
    {
    ...
    public static void aiFlee(obj_id target, float distance)
    {
    ...
    public static boolean aiIsFleeing(obj_id ai)
    {
        final deltadictionary dict = ai.getScriptVars();
        return dict.getInt("ai.combat.moveMode") == MOVEMODE_FLEE;
    }
    public static boolean aiIsFleeing(obj_id target, float distance)
    {
        final obj_id self = getSelf();
        final deltadictionary dict = self.getScriptVars();
    ...
    public static boolean isAiImmobile(obj_id subject)
    {
