...
public class ai_combat extends script.base_script
{
    ...
    public static void doAttack(obj_id ai, obj_id target)
    {
        startCombat(ai, target);
    }
    public static void attackBestTarget(obj_id ai, obj_id target)
    {
        startCombat(ai, target);
    }
    public static void equipRangedWeapon(obj_id ai)
    {
        aiEquipPrimaryWeapon(ai);
    }
    public static void equipMeleeWeapon(obj_id ai)
    {
        aiEquipPrimaryWeapon(ai);
    }
    public static boolean goodFaction(obj_id npc, obj_id target)
    {
    ...
    public static boolean isGoodTarget(obj_id npc, obj_id target)
    {
        if (!isIdValid(target))
        {
            return false;
    ...
    public static void moveRandom(obj_id npc, obj_id target)
    {
        if (isIndoors(npc))
        {
            return;
    ...
    public static void setCombatLocation(obj_id npc)
    {
        setObjVar(npc, "ai.combat.combatStartLoc", getLocation(npc));
    }
    public static location getCombatLocation(obj_id npc)
    {
        return getLocationObjVar(npc, "ai.combat.combatStartLoc");
    }
    public static boolean attackInCircleFormation(obj_id npc, obj_id target)
    {
    ...
    public static boolean hasRangedWeapon(obj_id npc)
    {
        obj_id weapon = getCurrentWeapon(npc);
        int weaponType = getWeaponType(weapon);
        int weaponCat = combat.getWeaponCategory(weaponType);
    ...
    public static void aiCombatFlee(obj_id npc, obj_id target, float minRange, float maxRange)
    {
    ...
    public static boolean switchToFormationCombat(obj_id npc, obj_id target)
    {
    ...
    public static boolean doHealing(obj_id npc, obj_id target)
    {
    ...
    public static obj_id getHealTarget(obj_id npc, obj_id[] myFriends)
    {
    ...
    public static void executeHealingMove(obj_id npc, obj_id target)
    {
    ...
    public static boolean fleeFromHouse(obj_id npc, obj_id target)
    {
    ...
    public static boolean doInteriorPathFinding(obj_id npc, obj_id target)
    {
    ...
    public static boolean isIndoors(obj_id npc)
    {
        location npcLoc = getLocation(npc);
