...
public class beast extends script.base_script
{
    ...
    public int handleSetupBeast(obj_id self, dictionary params)
    {
        if (!isMob(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int beastPing(obj_id self, dictionary params)
    {
    ...
    public int bcdPingResponse(obj_id self, dictionary params)
    {
    ...
    public int checkMovementSpeed(obj_id self, dictionary params)
    {
    ...
    public int handleBeastIncappedDecay(obj_id self, dictionary params)
    {
    ...
    public int handleSetBeastName(obj_id self, dictionary params)
    {
    ...
    public int defensiveModePing(obj_id self, dictionary params)
    {
        obj_id master = getMaster(self);
    ...
    public int doBeastFlourish(obj_id self, dictionary params)
    {
        obj_id beast = (self);
