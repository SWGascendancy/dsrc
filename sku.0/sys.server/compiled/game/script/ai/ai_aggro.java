...
public class ai_aggro extends script.base_script
{
    ...
    public static void requestAggroCheck(obj_id target)
    {
    ...
    public static void stopAttemptingAggroCheck(obj_id target)
    {
        final obj_id self = getSelf();
    ...
    public static boolean isAttemptingAggroCheck(obj_id target)
    {
        final obj_id self = getSelf();
        deltadictionary dict = self.getScriptVars();
