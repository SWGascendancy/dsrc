...
public class beast_control_device extends script.base_script
{
    ...
    public int handleBeastStuffingConfirm(obj_id self, dictionary params)
    {
    ...
    public int beastHungry(obj_id self, dictionary params)
    {
        obj_id beast = params.getObjId("beastId");
        obj_id beastOnBCD = beast_lib.getBCDBeastCalled(self);
        obj_id player = beast_lib.getBCDPlayer(self);
    ...
    public int ownerGrouped(obj_id self, dictionary params)
    {
    ...
    public int checkIfStillGrouped(obj_id self, dictionary params)
    {
        obj_id player = beast_lib.getBCDPlayer(self);
        if (group.isGrouped(player))
        {
    ...
    public int ownerEntertained(obj_id self, dictionary params)
    {
        if (!hasObjVar(self, beast_lib.PET_FAVORITES_OBJVAR))
        {
            LOG("beast_control_device", "Something is wrong. This BCD does not have the pets favorite activities stored. Setting them up now");
    ...
    public int checkIfStillEntertained(obj_id self, dictionary params)
    {
        obj_id player = beast_lib.getBCDPlayer(self);
        if (performance.checkPlayerEntertained(player, "both"))
        {
    ...
    public int beastKilledSomething(obj_id self, dictionary params)
    {
        if (!hasObjVar(self, beast_lib.PET_FAVORITES_OBJVAR))
        {
            LOG("beast_control_device", "Something is wrong. This BCD does not have the pets favorite activities stored. Setting them up now");
    ...
    public int removeKillBonus(obj_id self, dictionary params)
    {
        beast_lib.performingActivity(self, beast_lib.PET_NORMAL_ACTIVITY);
        if (utils.hasScriptVar(self, beast_lib.PET_KILL_MESSAGE_SCRIPTVAR))
        {
    ...
    public int petDoingTrick(obj_id self, dictionary params)
    {
        if (!hasObjVar(self, beast_lib.PET_FAVORITES_OBJVAR))
        {
            LOG("beast_control_device", "Something is wrong. This BCD does not have the pets favorite activities stored. Setting them up now");
    ...
    public int removeTrickBonus(obj_id self, dictionary params)
    {
        beast_lib.performingActivity(self, beast_lib.PET_NORMAL_ACTIVITY);
        return SCRIPT_CONTINUE;
    }
    public int removeHungryBlock(obj_id self, dictionary params)
    {
        if (utils.hasScriptVar(self, beast_lib.PET_HUNGRY_MESSAGE_SCRIPTVAR))
        {
    ...
    public int removeActivityBlock(obj_id self, dictionary params)
    {
        if (utils.hasScriptVar(self, beast_lib.PET_ACTIVITY_MESSAGE_SCRIPTVAR))
        {
