...
public class serving_droid extends script.base_script
{
    ...
    public int handleSecondaryColorize(obj_id self, dictionary params)
    {
        if (!isValidId(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int getUserOidSetFirstPoint(obj_id self, dictionary params)
    {
        if (!isValidId(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int pathDirectlyToStart(obj_id self, dictionary params)
    {
        if (!isValidId(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int fromLastPointGoBackToStart(obj_id self, dictionary params)
    {
        if (!isValidId(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleActivateDroid(obj_id self, dictionary params)
    {
        if (!isValidId(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleDeactivateDroid(obj_id self, dictionary params)
    {
        if (!isValidId(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int reColorDroid(obj_id self, dictionary params)
    {
        if (!isValidId(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int initializeDroidVariables(obj_id self, dictionary params)
    {
    ...
    public boolean colorPrimary(obj_id droid, obj_id terminal, int idx)
    {
        setObjVar(terminal, "color.primary", idx);
        hue.setColor(droid, "/private/index_color_1", idx);
        return true;
    }
    public boolean colorSecondary(obj_id droid, obj_id terminal, int idx)
    {
        setObjVar(terminal, "color.secondary", idx);
        hue.setColor(droid, "/private/index_color_2", idx);
        return true;
    }
    public boolean doPatrol(obj_id droid)
    {
        if (!isValidId(droid))
        {
            return false;
    ...
    public boolean doPatrol(obj_id droid, obj_id player)
    {
    ...
    public void doSetPatrolPoint(obj_id droid, obj_id player)
    {
        if (!isValidId(droid) || !isValidId(player))
        {
            return;
    ...
    public void doClearPatrolPoints(obj_id droid, obj_id player)
    {
        if (!isValidId(droid) || !isValidId(player))
        {
            return;
    ...
    public void removeLastPatrolPoint(obj_id droid, obj_id player)
    {
        if (!isValidId(droid) || !isValidId(player))
        {
            return;
    ...
    public boolean setPatrolLoop(obj_id droid, obj_id player, obj_id terminal)
    {
        if (!isValidId(droid) || !isValidId(player))
        {
            return false;
    ...
    public boolean setPatrolOnce(obj_id droid, obj_id player, obj_id terminal)
    {
        if (!hasObjVar(terminal, OBJVAR_DROID_PATROL_ONCE))
        {
    ...
    public int createHelpDialog(obj_id droid, obj_id player)
    {
        if (utils.hasScriptVar(droid, SCRIPTVAR_DROID_HELP_MENU))
        {
            return -1;
