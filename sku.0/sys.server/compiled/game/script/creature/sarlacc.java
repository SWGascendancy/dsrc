...
public class sarlacc extends script.base_script
{
    ...
    public int resetBileEject(obj_id self, dictionary params)
    {
        utils.removeScriptVar(self, "bile.eject");
        return SCRIPT_CONTINUE;
    }
    public int poisonArea(obj_id self, dictionary params)
    {
        int playerHint = 0;
        if (!utils.hasScriptVar(self, "bile.eject"))
        {
    ...
    public int resetBile(obj_id self, dictionary params)
    {
