...
public class mini_vehicle extends script.base_script
{
    ...
    public int handleActivateVehicle(obj_id self, dictionary params)
    {
        if (!isValidId(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleDeactivateVehicle(obj_id self, dictionary params)
    {
        if (!isValidId(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int initializeVehicleVariables(obj_id self, dictionary params)
    {
    ...
    public boolean doPatrol(obj_id vehicle)
    {
    ...
    public boolean doPatrol(obj_id vehicle, obj_id player)
    {
    ...
    public void doSetPatrolPoint(obj_id vehicle, obj_id player)
    {
        if (!isValidId(vehicle) || !isValidId(player))
        {
            return;
    ...
    public void doClearPatrolPoints(obj_id vehicle, obj_id player)
    {
        if (!isValidId(vehicle) || !isValidId(player))
        {
            return;
    ...
    public void removeLastPatrolPoint(obj_id vehicle, obj_id player)
    {
        if (!isValidId(vehicle) || !isValidId(player))
        {
            return;
    ...
    public boolean setPatrolLoop(obj_id vehicle, obj_id player, obj_id terminal)
    {
        if (!isValidId(vehicle) || !isValidId(player))
        {
            return false;
    ...
    public boolean setPatrolOnce(obj_id vehicle, obj_id player, obj_id terminal)
    {
        if (!hasObjVar(terminal, OBJVAR_VEHICLE_PATROL_ONCE))
        {
    ...
    public int createHelpDialog(obj_id vehicle, obj_id player)
    {
