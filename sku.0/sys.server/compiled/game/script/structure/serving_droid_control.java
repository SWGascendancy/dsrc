...
public class serving_droid_control extends script.base_script
{
    ...
    public int checkDroidId(obj_id self, dictionary params)
    {
    ...
    public int handleReceived(obj_id self, dictionary params)
    {
    ...
    public int handleLost(obj_id self, dictionary params)
    {
        if (!isValidId(self) || !exists(self))
        {
            return SCRIPT_CONTINUE;
