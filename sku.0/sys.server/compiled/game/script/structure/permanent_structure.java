...
public class permanent_structure extends script.base_script
{
    ...
    {
        messageTo(self, "validateStructureStorageOverride", null, 2, false); // finch
    ...
    public int OnLostItem(obj_id self, obj_id srcContainer, obj_id transferer, obj_id item)
    {
        int myGot = getGameObjectType(self);
    ...
    public int OnMaintenanceLoop(obj_id self, dictionary params)
    {
    ...
    public void doHouseMaintenanceHousekeeping(obj_id self)
    {
    ...
    public int handlePayment(obj_id self, dictionary params)
    {
    ...
    public int msgDestroyStructure(obj_id self, dictionary params)
    {
    ...
    public int removeResidentVar(obj_id self, dictionary params)
    {
        removeObjVar(self, player_structure.VAR_RESIDENCE_BUILDING);
        city.removeStructureFromCity(self);
        return SCRIPT_CONTINUE;
    }
    public int setNewMayor(obj_id self, dictionary params)
    {
    ...
    public int transferStructureToNewMayor(obj_id self, dictionary params)
    {
    ...
    public void updateOwnerAndAdmin(obj_id self, obj_id new_mayor)
    {
        if (!player_structure.isCivic(self))
        {
            return;
    ...
    public int handleChangeSignSui(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int cityMapRegister(obj_id self, dictionary params)
    {
    ...
    public int cityMapUnregister(obj_id self, dictionary params)
    {
        if (player_structure.isCivic(self) || player_structure.isCommercial(self))
        {
            if (hasScript(self, "planet_map.map_loc_both"))
    ...
    public int takeCityDamage(obj_id self, dictionary params)
    {
        int city_id = getCityAtLocation(getLocation(self), 0);
    ...
    public int repairCityDamage(obj_id self, dictionary params)
    {
        int city_id = getCityAtLocation(getLocation(self), 0);
        if (!cityExists(city_id))
        {
    ...
    public int createStructureObjects(obj_id self, dictionary params)
    {
    ...
    public int requestBankBalance(obj_id self, dictionary params)
    {
    ...
    public int requestName(obj_id self, dictionary params)
    {
        obj_id requestingObj = params.getObjId("requestingObj");
        String name = "";
        if (!player_structure.isInstallation(self))
    ...
    public int handleBankTransferError(obj_id self, dictionary params)
    {
    ...
    public int handleBankSuccess(obj_id self, dictionary params)
    {
        obj_id objSender = null;
        if (utils.hasScriptVar(self, "objSender"))
        {
    ...
    public int payCondemnedFees(obj_id self, dictionary params)
    {
        if (!player_structure.isStructureCondemned(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int moneyTransferredFromOwner(obj_id self, dictionary params)
    {
    ...
    public int ownerNotOnline(obj_id self, dictionary params)
    {
    ...
    public int ownerNSF(obj_id self, dictionary params)
    {
        utils.setScriptVar(self, "maint.dontCheckDB", 1);
        messageTo(self, "handleBankTransferError", params, 0, false);
        return SCRIPT_CONTINUE;
    }
    public int validateHopper(obj_id self, dictionary params)
    {
    ...
    public void updateFactoryName(obj_id factory)
    {
    ...
    public int checkAndMarkForPreAbandon(obj_id self, dictionary params)
    {
    ...
    public int checkAndMarkForAbandon(obj_id self, dictionary params)
    {
    ...
    public int logStructureInfo(obj_id self, dictionary params)
    {
        CustomerServiceLog("house_packup_info", player_structure.getStructureInfo(self));
        return SCRIPT_CONTINUE;
    }
    public int handleStructurePackupLockoutRemoval(obj_id self, dictionary params)
    {
        utils.removeScriptVarTree(self, player_structure.SCRIPTVAR_HOUSE_PACKUP_TREE_PREFIX);
        return SCRIPT_CONTINUE;
    }
    public int packAbandonedBuilding(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int moveStructureToSCD(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public int cityMoveStructureToSCD(obj_id self, dictionary params)
    {
    ...
    public int checkResidenceLinks(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
    ...
    public int houseCheck(obj_id self, dictionary params)
    {
    ...
    public int handleUnloadedCityStructureReportData(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
    ...
    public int getStructureCitizenInformation(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleSpecialSignManagementSelection(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleSpecialSignSelection(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public boolean removeSpecialSignScriptVars(obj_id player)
    {
        utils.removeScriptVarTree(player, player_structure.VAR_SPECIAL_SIGN_TREE);
        return true;
    }
    public int checkCityHousePackupStatus(obj_id self, dictionary params)
    {
    ...
    public void sendMayorInactiveCitizenMail(obj_id house, obj_id owner, obj_id city_mayor, int city_id)
    {
    ...
    public int retrieveHouseCoords(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public void sendCoordsToRequester(obj_id structure, obj_id homeOwner, obj_id requester)
    {
...
// finch start
    public int validateStructureStorageOverride(obj_id self, dictionary params)
    {
