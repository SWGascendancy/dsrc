...
public class mini_vehicle_control extends script.base_script
{
    ...
    public int checkVehicleId(obj_id self, dictionary params)
    {
    ...
    public int handlerMiniVehicleReceived(obj_id self, dictionary params)
    {
    ...
    public int handlerMiniVehicleLost(obj_id self, dictionary params)
    {
        if (!isValidId(self) && !exists(self))
        {
            return SCRIPT_CONTINUE;
