...
public class locked_container extends script.base_script
{
    ...
    public void addGuildToAccess(obj_id container, int guildId)
    {
    ...
    public void removeGuildFromAccess(obj_id container, int guildId)
    {
        if (!isIdValid(container) || !exists(container) || guildId == 0)
        {
            return;
    ...
    public void clearGuildAccess(obj_id container)
    {
    ...
    public int[] getGuildAccess(obj_id container)
    {
        if (!isIdValid(container) || !exists(container))
        {
            return null;
    ...
    public void addPlayerToAccess(obj_id container, obj_id player)
    {
    ...
    public void removePlayerFromAccess(obj_id container, obj_id player)
    {
        if (!isIdValid(container) || !exists(container) || !isIdValid(player) || !exists(player))
        {
            return;
    ...
    public void clearPlayerAccess(obj_id container)
    {
        if (!isIdValid(container) || !exists(container))
        {
            return;
    ...
    public obj_id[] getPlayerAccess(obj_id container)
    {
        if (!isIdValid(container) || !exists(container))
        {
            return null;
    ...
    public int lockAddPlayer(obj_id self, dictionary params)
    {
    ...
    public int lockRemovePlayer(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        obj_id lockedBy = getObjIdObjVar(self, "lock_owner");
        if (sui.getIntButtonPressed(params) == sui.BP_OK)
    ...
    public int lockAddGuild(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        if (sui.getIntButtonPressed(params) == sui.BP_OK)
        {
    ...
    public int lockRemoveGuild(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        if (sui.getIntButtonPressed(params) == sui.BP_OK)
        {
