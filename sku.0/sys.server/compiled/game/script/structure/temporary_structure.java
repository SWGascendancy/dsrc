...
public class temporary_structure extends script.base_script
{
    ...
    public int OnBuildingComplete(obj_id self, dictionary params)
    {
    ...
    public int statusMenuRefresh(obj_id self, dictionary params)
    {
    ...
    public int showConstructionStatus(obj_id self)
    {
        return showConstructionStatus(self, null);
    }
    public int showConstructionStatus(obj_id self, obj_id player)
    {
    ...
    public boolean restartConstruction(obj_id self)
    {
        if (!isIdValid(self))
        {
            return false;
    ...
    public int validateConstruction(obj_id self, dictionary params)
    {
        int timestamp = getIntObjVar(self, player_structure.VAR_DEED_TIMESTAMP);
        if (timestamp < 0)
        {
