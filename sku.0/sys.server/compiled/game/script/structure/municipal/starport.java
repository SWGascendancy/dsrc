...
public class starport extends script.base_script
{
    ...
    public int msgArrivalLocation(obj_id self, dictionary params)
    {
    ...
    public int retryInitializeStarport(obj_id self, dictionary params)
    {
    ...
    public void doInitializeStarport(obj_id self)
    {
        if (player_structure.isCivic(self))
        {
            return;
