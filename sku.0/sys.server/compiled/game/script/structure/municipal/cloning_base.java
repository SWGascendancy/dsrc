...
public class cloning_base extends script.base_script
{
    ...
    public int OnGetRespawnLocation(obj_id self, modifiable_int tubeIndex)
    {
    ...
    public String getCloneName(obj_id self)
    {
        String myTemplate = getTemplateName(self);
    ...
    public String getCloneName(int cloneType, String nameOverride)
    {
        obj_id self = getSelf();
    ...
    public int requestCloningData(obj_id self, dictionary params)
    {
    ...
    public int retryInitializeCloningFacility(obj_id self, dictionary params)
    {
    ...
    public boolean requestCloningFacilityRegistration(obj_id cloningFacility)
    {
