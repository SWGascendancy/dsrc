...
public class master_guild_object extends script.base_script
{
    ...
    public int onGuildUpdatePulse(obj_id self, dictionary params)
    {
    ...
    public int forceUpdateGuilds(obj_id self, dictionary params)
    {
        updateGuilds(self, true);
        return SCRIPT_CONTINUE;
    }
    public int forceUpdateGuildNameChanges(obj_id self, dictionary params)
    {
        updateGuildNameChanges(self, true);
        return SCRIPT_CONTINUE;
    }
    public int initiateGuildNameChange(obj_id self, dictionary params)
    {
    ...
    public void updateGuilds(obj_id self, boolean force)
    {
    ...
    public void updateGuildNameChanges(obj_id self, boolean force)
    {
        int currentTime = getGameTime();
        int nextTime = currentTime + getGuildUpdateInterval();
        int[] guildNamechangeIds = objvar_mangle.getMangledIntArrayObjVar(self, VAR_NAMECHANGE_IDS);
    ...
    public void clearNamechanges(obj_id self)
    {
        removeObjVar(self, VAR_NAMECHANGE);
    }
    public void handleGuildUpdate(int guildId)
    {
    ...
    public int getGuildProcessInterval()
    {
    ...
    public int getGuildUpdateInterval()
    {
