...
public class base_script extends script.base_class
{
    ...
    public int OnLocateObject(obj_id self, dictionary params)
    {
    ...
    public int OnSetWaypointActive(obj_id self, dictionary params)
    {
    ...
    public int OnSetWaypointLocation(obj_id self, dictionary params)
    {
        obj_id waypoint = params.getObjId("waypoint");
        if (waypoint != null)
        {
    ...
    public int getFirstFreeIndex(String[] array)
    {
        if (array != null)
        {
    ...
    public void dumpObjvars(obj_id s, obj_var_list objvars, String[] names, String[] attribs)
    {
    ...
    public void dumpScriptvars(String[] names, String[] attribs)
    {
    ...
    public int OnGetScriptvars(obj_id self, obj_id player, String[] names, String[] attribs)
    {
        if (player != null)
        {
    ...
    public String UploadCharacter(obj_id player)
    {
    ...
    public String DownloadCharacter(obj_id player, String packedData)
    {
