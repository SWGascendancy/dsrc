...
public class name extends script.base_script
{
    ...
    public void showNameInputUI(obj_id player, obj_id self)
    {
    ...
    public int handleNameObject(obj_id self, dictionary params)
    {
    ...
    public boolean isInPlayersHouse(obj_id self, obj_id player)
    {
