...
public class orbtest extends script.base_script
{
    ...
    public int handleSpawnMob(obj_id self, dictionary params)
    {
        if (!utils.hasScriptVar(self, "testingOn"))
        {
    ...
    public int handleKillCritter(obj_id self, dictionary params)
    {
    ...
    public int handleCreateLoot(obj_id self, dictionary params)
    {
