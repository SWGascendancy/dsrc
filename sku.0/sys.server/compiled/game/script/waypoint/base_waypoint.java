...
public class base_waypoint extends script.base_script
{
    ...
    public void clearClientPath(obj_id self)
    {
    ...
    public int OnSetWaypointRegion(obj_id self, dictionary params)
    {
    ...
    public int OnSetWaypoinVisible(obj_id self, dictionary params)
    {
