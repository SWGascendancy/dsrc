...
public class newbie_handoff extends script.base_script
{
    ...
    public int startHandoff(obj_id self, dictionary params)
    {
        playMusic(self, "sound/tut_00_holocron.snd");
        openHolocronToNewbiePage(self, "WelcomeToSWG.WhereDoIBegin");
        return SCRIPT_CONTINUE;
    }
    public int disableNewbieHandoff(obj_id self, dictionary params)
    {
        setObjVar(self, "newbie_handoff.disabled", 1);
        return SCRIPT_CONTINUE;
    }
    public int enableNewbieHandoff(obj_id self, dictionary params)
    {
        removeObjVar(self, "newbie_handoff.disabled");
        return SCRIPT_CONTINUE;
    }
    public int tourBank(obj_id self, dictionary params)
    {
    ...
    public int tourCloningCenter(obj_id self, dictionary params)
    {
    ...
    public int tourHospital(obj_id self, dictionary params)
    {
    ...
    public int tourCantina(obj_id self, dictionary params)
    {
    ...
    public int tourSkillTrainer(obj_id self, dictionary params)
    {
    ...
    public int openHolocronToProfession(obj_id self, dictionary params)
    {
    ...
    public int missionArtisanSurvey(obj_id self, dictionary params)
    {
    ...
    public int missionEntertainerDanceGig(obj_id self, dictionary params)
    {
    ...
    public int missionEntertainerMusicGig(obj_id self, dictionary params)
    {
        if (hasObjVar(self, "newbie_handoff.mission.gig"))
        {
            clearHolocronDatapadEntry(self, "mission.gig");
    ...
    public int missionMedicHeal(obj_id self, dictionary params)
    {
    ...
    public int missionBrawlerDestroy(obj_id self, dictionary params)
    {
    ...
    public int missionMarksmanDestroy(obj_id self, dictionary params)
    {
        if (hasObjVar(self, "newbie_handoff.mission.destroy"))
        {
            clearHolocronDatapadEntry(self, "mission.destroy");
    ...
    public int missionScoutHarvest(obj_id self, dictionary params)
    {
    ...
    public void commandOpenCraftingTool(obj_id player)
    {
    }
    public void prototypeCompleted()
    {
    }
    public int eventEarnedSkillBox(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (isSpaceScene())
        {
            return SCRIPT_CONTINUE;
    ...
    public int eventTrainedSkillBox(obj_id self, dictionary params)
    {
        dictionary holocronParams = new dictionary();
    ...
    public int handleHolocronEvent(obj_id self, dictionary params)
    {
        if (isSpaceScene())
        {
            return SCRIPT_CONTINUE;
    ...
    public int missionSurveyComplete(obj_id self, dictionary params)
    {
    ...
    public int missionGigComplete(obj_id self, dictionary params)
    {
    ...
    public int missionHealComplete(obj_id self, dictionary params)
    {
    ...
    public int missionDestroyComplete(obj_id self, dictionary params)
    {
    ...
    public int missionHarvestTargetDead(obj_id self, dictionary params)
    {
    ...
    public int missionHarvestComplete(obj_id self, dictionary params)
    {
    ...
    public int openHolocronAfterGigMission(obj_id self, dictionary params)
    {
    ...
    public int openHolocronAfterHealMission(obj_id self, dictionary params)
    {
    ...
    public int openHolocronAfterBrawlerMission(obj_id self, dictionary params)
    {
    ...
    public int openHolocronAfterMarksmanMission(obj_id self, dictionary params)
    {
    ...
    public int openHolocronAfterScoutMission(obj_id self, dictionary params)
    {
    ...
    public int removeDatapadEntryData(obj_id self, dictionary params)
    {
    ...
    private obj_id addHolocronDatapadWaypoint(obj_id player, String name, String display, location loc, float radius)
    {
    ...
    private obj_id addHolocronDatapadEntry(obj_id player, String name, String display)
    {
    ...
    private void clearHolocronDatapadEntry(obj_id player, String name)
    {
    ...
    private void addHolocronWaypointPath(obj_id player, obj_id waypoint)
    {
    ...
    private int findWaypointIndex(Vector idList, obj_id waypoint)
    {
    ...
    private void openHolocronToNewbiePage(obj_id player, String page)
    {
    ...
    private location findClosestStructure(obj_id player, String[] priSearchList, String[] secSearchList)
    {
    ...
    private String getStartingProfession(obj_id player)
    {
    ...
    private String getSimpleProfession(String profession)
    {
    ...
    private String getTrainerType(String profession)
    {
    ...
    private String determineDestroyTarget(obj_id player)
    {
        String planet = getCurrentSceneName();
    ...
    private String loadRandomDestroyTarget(String planet, String city)
    {
