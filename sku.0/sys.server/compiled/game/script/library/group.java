...
public class group extends script.base_script
{
    ...
    public static Vector getPCMembersInRange(obj_id actor, float range)
    {
    ...
    public static Vector getPCMembersInRange()
    {
        return getPCMembersInRange(getSelf());
    }
    public static Vector getPCMembersInRange(float range)
    {
        return getPCMembersInRange(getSelf(), range);
    }
    public static Vector getPCMembersInRange(obj_id actor)
    {
    ...
    public static boolean isDepositSafe(Vector members, int money)
    {
    ...
    public static obj_id[] getSafeMoney(Vector members, int money)
    {
    ...
    public static obj_id[] getUnsafeMoney(Vector members, int money)
    {
        Vector returnArray = new Vector();
        returnArray.setSize(0);
        for (int i = 0; i < members.size(); i++)
    ...
    public static int getSafeDifference(obj_id members, int money)
    {
