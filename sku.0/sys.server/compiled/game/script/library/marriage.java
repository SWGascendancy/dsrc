...
public class marriage extends script.base_script
{
    ...
    public static boolean isMarried(obj_id target)
    {
    ...
    public static boolean hasProposed(obj_id target)
    {
        if (!isIdValid(target) || !isPlayer(target))
        {
            return false;
    ...
    public static void propose(obj_id player, obj_id target, obj_id ring)
    {
    ...
    public static void cleanupProposal(obj_id player)
    {
        if (!isIdValid(player))
        {
            return;
    ...
    public static void cleanupProposedTo(obj_id player)
    {
        if (!isIdValid(player))
        {
            return;
    ...
    public static void cleanupAcceptance(obj_id player)
    {
        if (!isIdValid(player))
        {
            return;
    ...
    public static obj_id[] getRings(obj_id player)
    {
        if (!isIdValid(player))
        {
            return null;
    ...
    public static void wed(obj_id player, obj_id target)
    {
    ...
    public static void weddingError(obj_id player, obj_id target)
    {
    ...
    public static void weddingError(obj_id player)
    {
        obj_id target = null;
    ...
    public static void divorce(obj_id player)
    {
        if (!isIdValid(player))
        {
            return;
    ...
    public static void declineProposal(obj_id player)
    {
        if (!isIdValid(player))
        {
            return;
    ...
    public static void cannotAccept(obj_id player)
    {
        if (!isIdValid(player))
        {
            return;
    ...
    public static void endUnity(obj_id player)
    {
        if (!isIdValid(player))
        {
            return;
