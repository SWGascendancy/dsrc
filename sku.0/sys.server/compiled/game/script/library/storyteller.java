...
public class storyteller extends script.base_script
{
    ...
    public static int getTokenType(obj_id token)
    {
    ...
    public static obj_id createTheaterObject(obj_id token, boolean inBuildout, location createLoc, float yaw)
    {
    ...
    public static obj_id createPropObject(obj_id token, boolean inBuildout)
    {
    ...
    public static obj_id createPropObject(obj_id token, obj_id player, boolean inBuildout, location createLoc, float yaw)
    {
        obj_id prop = null;
    ...
    public static obj_id createPropObjectNoToken(String tokenName, obj_id player, boolean inBuildout, location createLoc, float yaw)
    {
        obj_id prop = null;
    ...
    public static obj_id createNpcAtLocation(obj_id token)
    {
        obj_id player = utils.getContainingPlayer(token);
        return createNpcAtLocation(token, player, getLocation(player), getYaw(player));
    }
    public static obj_id createNpcAtLocation(obj_id token, obj_id player, location createLoc, float yaw)
    {
        obj_id npc = null;
        if (canDeployStorytellerToken(player, createLoc, token))
        {
    ...
    public static obj_id createNpcAtLocationNoToken(String tokenName, obj_id player, location createLoc, float yaw)
    {
        return createNpcAtLocationNoToken(tokenName, player, createLoc, yaw, 0);
    }
    public static obj_id createNpcAtLocationNoToken(String tokenName, obj_id player, location createLoc, float yaw, int combatLevel)
    {
        return createNpcAtLocationNoToken(tokenName, player, createLoc, yaw, combatLevel, 0);
    }
    public static obj_id createNpcAtLocationNoToken(String tokenName, obj_id player, location createLoc, float yaw, int combatLevel, int difficulty)
    {
        obj_id npc = null;
        if (canDeployStorytellerToken(player, createLoc, tokenName))
        {
    ...
    public static boolean isStorytellerNpc(obj_id npc)
    {
        return hasObjVar(npc, "storytellerid");
    }
    public static boolean isStorytellerObject(obj_id object)
    {
        return hasObjVar(object, "storytellerid");
    }
    public static void removeStorytellerPersistedEffect(obj_id self)
    {
    ...
    public static boolean allowTokenPlacementInInteriors(obj_id token)
    {
        return allowTokenPlacementInInteriors(getStaticItemName(token));
    }
    public static boolean allowTokenPlacementInInteriors(String tokenName)
    {
        int allowInInteriors = dataTableGetInt(STORYTELLER_DATATABLE, tokenName, "allow_interior");
        return allowInInteriors == 1;
    }
    public static boolean allowTokenPlacementOnRoofs(obj_id token)
    {
        return allowTokenPlacementOnRoofs(getStaticItemName(token));
    }
    public static boolean allowTokenPlacementOnRoofs(String tokenName)
    {
        int allowOnRoofs = dataTableGetInt(STORYTELLER_DATATABLE, tokenName, "allow_roof");
        return allowOnRoofs == 1;
    }
    public static obj_id getStorytellerBeingAssisted(obj_id player)
    {
    ...
    public static location rotateLocationXZ(location locOrigin, location locPoint, float fltAngle)
    {
    ...
    public static int getTokenDailyUsageAmount(obj_id token)
    {
        return getTokenDailyUsageAmount(getStaticItemName(token));
    }
    public static int getTokenDailyUsageAmount(String tokenName)
    {
        return dataTableGetInt(STORYTELLER_DATATABLE, tokenName, "daily_uses");
    }
    public static boolean isTokenFlaggedWithDailyUsage(obj_id token)
    {
        return isTokenFlaggedWithDailyUsage(getStaticItemName(token));
    }
    public static boolean isTokenFlaggedWithDailyUsage(String tokenName)
    {
        return getTokenDailyUsageAmount(tokenName) > 0;
    }
    public static int getTokenDailyUsesAvailable(obj_id token)
    {
        int num = 0;
    ...
    public static boolean hasTokenUsesAvailable(obj_id token)
    {
        if (isTokenFlaggedWithDailyUsage(getStaticItemName(token)))
        {
    ...
    public static void handleTokenUsage(obj_id token)
    {
        int dailyUses = getTokenDailyUsageAmount(token);
        if (dailyUses == 0)
        {
    ...
    public static void resetTokenDailyCount(obj_id token)
    {
    ...
    public static void setTokenDailyCountResetTime(obj_id token)
    {
    ...
    public static boolean canDeployStorytellerToken(obj_id player, location here, obj_id token)
    {
    ...
    public static boolean canDeployStorytellerToken(obj_id player, location here, String tokenName)
    {
    ...
    public static boolean isInStorytellerBlockedRegion(location here)
    {
    ...
    public static boolean allowedToSeeStorytellerObject(obj_id object, obj_id player)
    {
    ...
    public static boolean allowedToUseStorytellerObject(obj_id object, obj_id player)
    {
        obj_id storyteller = getObjIdObjVar(object, "storytellerid");
        if (isIdValid(storyteller))
        {
    ...
    public static boolean inSameStory(obj_id target1, obj_id target2)
    {
    ...
    public static void showStorytellerEffectsInAreaToPlayer(obj_id player, obj_id storytellerPlayer)
    {
    ...
    public static void stopStorytellerEffectsInAreaToPlayer(obj_id player, obj_id storytellerPlayer)
    {
        obj_id[] storytellerObjects = getAllObjectsWithObjVar(getLocation(player), 165.0f, "storytellerid");
        if (storytellerObjects != null && storytellerObjects.length > 0)
        {
    ...
    public static String[] recordBlueprintData(obj_id blueprint, obj_id[] storytellerObjects, obj_id player)
    {
    ...
    public static location rotateSavedBlueprintDataXZ(location locOrigin, location locPoint, float fltAngle)
    {
        float dx = locPoint.x - locOrigin.x;
        float dz = locPoint.z - locOrigin.z;
        float fltRadians = (float)Math.toRadians(fltAngle);
    ...
    public static String changeBlueprintItemTokenStatus(int tokenStatus, String objectData)
    {
    ...
    public static String buildBlueprintObjectData(int tokenLoaded, String tokenName, float locX, float locY, float locZ, float yaw, int combatLevel, int difficulty, String effect)
    {
        return tokenLoaded + "~" + tokenName + "~" + locX + "~" + locY + "~" + locZ + "~" + yaw + "~" + combatLevel + "~" + difficulty + "~" + effect;
    }
    public static int getBlueprintObjectDataSize(String blueprintObjectData)
    {
        return split(blueprintObjectData, '~').length;
    }
    public static int getRequiredBlueprintDataSize()
    {
    ...
    public static boolean validateBlueprintData(String blueprintObjectData)
    {
        return getBlueprintObjectDataSize(blueprintObjectData) == getRequiredBlueprintDataSize();
    }
    public static obj_id createBlueprintObject(String objectData, obj_id blueprintController, obj_id player, location targetLoc, float targetYaw)
    {
    ...
    public static void handleBlueprintObjectElevation(obj_id blueprintObject, dictionary params)
    {
    ...
    public static location getBlueprintObjectLocation(String spawnString, location centerLoc)
    {
    ...
    public static boolean isBlueprintTokenLoaded(String spawnString)
    {
        return utils.stringToInt(split(spawnString, '~')[0]) == 1;
    }
    public static String getBlueprintItemName(String spawnString)
    {
        return split(spawnString, '~')[1];
    }
    public static float getBlueprintItemLocX(String spawnString)
    {
        return utils.stringToFloat(split(spawnString, '~')[2]);
    }
    public static float getBlueprintItemLocY(String spawnString)
    {
        return utils.stringToFloat(split(spawnString, '~')[3]);
    }
    public static float getBlueprintItemLocZ(String spawnString)
    {
        return utils.stringToFloat(split(spawnString, '~')[4]);
    }
    public static float getBlueprintItemYaw(String spawnString)
    {
        return utils.stringToFloat(split(spawnString, '~')[5]);
    }
    public static int getBlueprintItemCombatLevel(String spawnString)
    {
        return utils.stringToInt(split(spawnString, '~')[6]);
    }
    public static int getBlueprintItemDifficulty(String spawnString)
    {
        return utils.stringToInt(split(spawnString, '~')[7]);
    }
    public static String getBlueprintItemEffect(String spawnString)
    {
        return split(spawnString, '~')[8];
    }
    public static void blueprintParseConversion(obj_id blueprint)
    {
    ...
    public static boolean doIAutoDeclineStorytellerInvites(obj_id player) {
        return hasObjVar(player, storyteller.VAR_AUTODECLINE_STORY_INVITES) || utils.hasScriptVar(player, "battlefield.active");
    }
    public static int storyAssistantSui(obj_id storytellerPlayer, String storytellerName, obj_id player)
    {
    ...
    public static void storyAssistantAcepted(obj_id storytellerPlayer, String storytellerName, obj_id player)
    {
    ...
    public static void storyPlayerRemoveAssistant(obj_id storytellerPlayer, String storytellerName, obj_id player)
    {
    ...
    public static int storyInviteSui(obj_id storytellerPlayer, String storytellerName, obj_id player)
    {
    ...
    public static void storyInviteAcepted(obj_id storytellerPlayer, String storytellerName, obj_id player, obj_id storytellerAssistant)
    {
    ...
    public static void storyPlayerRemovedFromStory(obj_id storytellerPlayer, String storytellerName, obj_id player)
    {
    ...
    public static boolean storytellerCombatCheck(obj_id attacker, obj_id target)
    {
    ...
    public static boolean displayAvailableStorytellerTokenTypes(obj_id player, obj_id storytellerVendor)
    {
    ...
    public static String[] getTokenTypeNamesArray()
    {
    ...
    public static boolean displayStorytellerTokenPurchaseSUI(obj_id player, int tokenType, obj_id storytellerVendor)
    {
    ...
    public static String[] getAlphabetizedTokenList(String[] tokenReferences, int tokenType)
    {
    ...
    public static String[] getTokenNamesList(String[] tokenReferences, int tokenType, obj_id player)
    {
    ...
    public static void storytellerTokenPurchased(dictionary params, obj_id storytellerVendor)
    {
        if (params == null || params.isEmpty())
        {
            return;
    ...
    public static boolean requestNumCharges(int tokenType, String token_reference)
    {
    ...
    public static void storytellerSellTokenWithCharges(dictionary params, obj_id storytellerVendor)
    {
        obj_id player = sui.getPlayerId(params);
    ...
    public static void givePurchasedToken(obj_id storytellerVendor, obj_id player, String tokenReference, String tokenName, int cost, int numCharges)
    {
    ...
    public static void confirmCleanuptime(obj_id object)
    {
    ...
    public static void setBonusExistTime(obj_id self)
    {
    ...
    public static void calculatePropBonusExistTime(obj_id object)
    {
    ...
    public static void calculateNpcBonusExistTime(obj_id object)
    {
