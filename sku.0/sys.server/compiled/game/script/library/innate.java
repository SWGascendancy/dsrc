...
public class innate extends script.base_script
{
    ...
    public static String parseInnateCommand(String txt)
    {
    ...
    public static boolean regeneration()
    {
        obj_id self = getSelf();
    ...
    public static boolean vitalize()
    {
        obj_id self = getSelf();
    ...
    public static boolean equilibrium()
    {
        obj_id self = getSelf();
        equalizeEffect(self);
    ...
    public static void equalizeEffect(obj_id player)
    {
        if (!isIdValid(player))
        {
            return;
    ...
    public static int doAntiModCheck(obj_id target, String skill_mod)
    {
