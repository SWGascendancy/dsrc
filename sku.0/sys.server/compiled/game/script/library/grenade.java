...
public class grenade extends script.base_script
{
    ...
    public static boolean canThrowGrenade(obj_id thrower, obj_id grenade, boolean verbose)
    {
    ...
    public static boolean hasThrownGrenade(obj_id thrower, obj_id grenade)
    {
        String grenadeEffectClass = getStringObjVar(grenade, "effect_class");
        return true;
    }
    public static effect_data applyGrenadeEffects(obj_id defender, obj_id grenade, float range)
    {
    ...
    public static effect_data applyFragmentationEffects(obj_id defender, obj_id grenade, float range, effect_data resultData)
    {
        combat.combatLog(grenade, defender, "applyGrenadeEffects", "Applying fragmentation effects.");
        return resultData;
    }
    public static effect_data applyCryobanEffects(obj_id defender, obj_id grenade, float range, effect_data resultData)
    {
    ...
    public static effect_data applyGlopEffects(obj_id defender, obj_id grenade, float range, effect_data resultData)
    {
    ...
    public static effect_data applyImperialDetonatorEffects(obj_id defender, obj_id grenade, float range, effect_data resultData)
    {
    ...
    public static effect_data applyProtonEffects(obj_id defender, obj_id grenade, float range, effect_data resultData)
    {
    ...
    public static effect_data applyThermalDetonatorEffects(obj_id defender, obj_id grenade, float range, effect_data resultData)
    {
    ...
    public static effect_data applyBugBombEffects(obj_id defender, obj_id grenade, float range, effect_data resultData)
    {
