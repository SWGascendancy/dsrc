...
public class fs_quests_cc extends script.base_script
{
    ...
    public static boolean testCommunityCraftingEnabled(obj_id npc, int phase)
    {
    ...
    public static void showPlayerProjectAttribs(obj_id npc, obj_id player, int phase)
    {
    ...
    public static void showPlayerProjectStats(obj_id npc, obj_id player, int slot, boolean quality, int phase)
    {
        if (testCommunityCraftingEnabled(npc, phase))
        {
            obj_id craftingTracker = utils.getObjIdScriptVar(npc, SCRIPTVAR_CRAFTING_TRACKER);
