...
public class bio_engineer extends script.base_script
{
    ...
    public static boolean harvestCreatureDNA(obj_id player, obj_id creature)
    {
    ...
    public static boolean harvestCreatureDeedDNA(obj_id player, obj_id creatureDeed)
    {
        deltadictionary dctScriptVars = player.getScriptVars();
        if (dctScriptVars == null)
        {
    ...
    public static boolean completeHarvest(obj_id player)
    {
    ...
    public static boolean quickHarvest(obj_id player, String creatureName)
    {
    ...
    public static dictionary getCreatureStats(obj_id creature)
    {
        dictionary creatureStats = new dictionary();
    ...
    public static dictionary getCreatureDeedStats(obj_id creatureDeed)
    {
        dictionary creatureStats = new dictionary();
    ...
    public static dictionary calculateDNAAttributes(obj_id player, dictionary creatureStats, dictionary profileDict, int qualityOverride)
    {
    ...
    public static int calcDnaHardiness(int health)
    {
    ...
    public static int calcDnaFortitude(int armorBase)
    {
    ...
    public static int calcDnaDexterity(float defenseValue)
    {
    ...
    public static int calcDnaEndurance(float healthRegen)
    {
    ...
    public static int calcDnaIntellect(float scale)
    {
    ...
    public static int calcDnaCleverness(float toHit)
    {
    ...
    public static int calcDnaDependability(int level, int niche)
    {
    ...
    public static int calcDnaCourage(int level, String meat)
    {
    ...
    public static int calcDnaFierceness(int level, int niche)
    {
    ...
    public static int calcDnaPower(int avgDamage)
    {
    ...
    public static obj_id createDNAComponent(obj_id player, obj_id inventory, dictionary attributeDict)
    {
        obj_id DNA_obj = null;
    ...
    public static int grantTemplateCraftingExperience(int level)
    {
        return level * 10;
    }
    public static int calcCreatureAttrib(int attrib, int[] dnaAttributes)
    {
    ...
    public static int calcCreatureToHit(int[] dnaAttributes)
    {
        final int minToHit = 5;
        final int maxToHit = 209;
        float toHitChance = 0;
    ...
    public static float calcCreatureCritChance(int[] dnaAttributes)
    {
        float critChance = 0;
    ...
    public static float calcCreatureCritSave(int[] dnaAttributes)
    {
        float critSave = 0;
    ...
    public static float calcCreatureAggroBonus(int[] dnaAttributes)
    {
        float aggroBonus = 0;
    ...
    public static float calcCreatureStateResist(int[] dnaAttributes)
    {
        float stateResist = 0;
    ...
    public static float calcCreatureMaxScale(int[] dnaAttributes)
    {
    ...
    public static int[] calcCreatureDamage(int[] dnaAttributes)
    {
        final int minBaseDamage = 17;
        final int maxBaseDamage = 431;
        int baseDamage = 0;
    ...
    public static int calcCreatureHealthRegen(int[] dnaAttributes)
    {
    ...
    public static int calcCreatureDefenseValue(int[] dnaAttributes)
    {
        final int minDefense = 5;
        final int maxDefense = 209;
    ...
    public static int calcCreatureArmor(int[] dnaAttributes)
    {
        final int minArmorBase = 0;
        final int maxArmorBase = 6000;
        int armorBase = 0;
    ...
    public static int calcCreature(int[] dnaAttributes)
    {
        return 0;
    }
    public static int getCraftedCreatureLevel(dictionary creatureDict)
    {
    ...
    public static int getCreatureLevel(dictionary creatureDict)
    {
    ...
    public static int calcCraftedStatLevel(dictionary creatureDict)
    {
    ...
    public static int calcStatLevel(dictionary creatureDict)
    {
        int[] hitpoints = dataTableGetIntColumn("datatables/mob/stat_balance.iff", "HP");
    ...
    public static int calcDmgLevel(dictionary creatureDict)
    {
        return 1;
    }
    public static int calcRegenLevel(dictionary creatureDict)
    {
    ...
    public static int calcToHitLevel(dictionary creatureDict)
    {
    ...
    public static int calcOldToHitLevel(dictionary creatureDict)
    {
        int[] toHitList = dataTableGetIntColumn("datatables/mob/stat_balance.iff", "ToHit");
    ...
    public static int calcDefenseLevel(dictionary creatureDict)
    {
    ...
    public static int calcAttackSpeedLevel(dictionary creatureDict)
    {
        return 0;
    }
    public static int calcArmorLevel(dictionary creatureDict)
    {
    ...
    public static int calcOldArmorLevel(dictionary creatureDict)
    {
    ...
    public static int calcSpecialAttackLevel(dictionary creatureDict)
    {
        return 0;
    }
    public static int calcRangedAttackLevel(dictionary creatureDict)
    {
        return 0;
    }
    public static int getCalcLevelFromPcd(obj_id pcd)
    {
    ...
    public static void stripOldStats(obj_id pcd)
    {
    ...
    public static boolean validatePcdLevel(obj_id pcd, obj_id player)
    {
    ...
    public static int showBrokenPetDialog(obj_id pcd, obj_id player)
    {
    ...
    public static void adjustBrokenPetLevel(obj_id pcd, obj_id player)
    {
    ...
    public static void adjustBrokenPetStats(obj_id pcd, obj_id player)
    {
        int level = getIntObjVar(pcd, "creature_attribs.level");
        if (level < 1)
        {
    ...
    public static boolean validateCreatureSpecialAttack(int attack)
    {
    ...
    public static String convertSampleTypeToCreature(String sampleType)
    {
    ...
    public static String convertTemplateToCreature(String templateName)
    {
    ...
    public static int translateDnaSampleAttributes(String attribName, int attribValue, String sampleType, String templateName)
    {
    ...
    public static int convertDnaAttributes(String attribName, int attribValue, dictionary sampleCreatureDict, dictionary templateCreatureDict)
    {
