...
public class minefield_util extends script.base_script
{
    ...
    public static boolean setMarkerData(obj_id marker)
    {
        boolean isSet = false;
    ...
    public static boolean buildMineField(obj_id marker)
    {
    ...
    public static boolean explodeMine(obj_id player, int mineNumber, obj_id marker)
    {
    ...
    public static boolean dealDamage(obj_id player, obj_id marker)
    {
    ...
    public static void damageAdjuster(obj_id[] creatures, obj_id whoDoneIt, float damageRadius, int damage, obj_id owner)
    {
    ...
    public static void animatePlayerDamage(obj_id player)
    {
    ...
    public static void removeBreacherScripts(obj_id marker)
    {
    ...
    public static boolean cleanUpBlastEffects(obj_id marker)
    {
    ...
    public static int numberOfMinesDetected(obj_id player)
    {
