...
public class datatable extends script.base_script
{
    ...
    public static String getRandomTemplate(String datatable)
    {
    ...
    public static obj_id createRandomTemplateInWorld(String datatable)
    {
    ...
    public static obj_id createRandomTemplateAtTarget(String datatable, obj_id target)
    {
        String templateFilename = getRandomTemplate(datatable);
    ...
    public static obj_id createRandomTemplateAtTarget(String datatable, location loc)
    {
        String templateFilename = getRandomTemplate(datatable);
    ...
    public static boolean createDataTable(String strFileName, String[] strHeaders, String[] strHeaderTypes)
    {
        if (strFileName == null)
        {
    ...
    public static void serverDataTableAddRow(String strFileName, dictionary dctParams)
    {
        strFileName = "../../dsrc/sku.0/sys.server/compiled/game/" + strFileName;
