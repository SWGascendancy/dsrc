...
public class arena extends script.base_script
{
    ...
    public static float getArenaTimeFactorFromConfig()
    {
    ...
    public static void addRankGotChallenged(obj_id terminal, int rankC)
    {
    ...
    public static Vector getRanksWithActiveChallenges(obj_id terminal)
    {
    ...
    public static String[] getRanksWithActiveChallengesString(obj_id terminal)
    {
    ...
    public static void resolveRankChallengeResult(obj_id terminal, int rank, int timesChallenged, int timesAnswered)
    {
    ...
    public static String[] getChallengeScoreStrings(obj_id terminal)
    {
    ...
    public static void setupRankScores(obj_id terminal)
    {
    ...
    public static void initializeArena(obj_id terminal)
    {
    ...
    public static void cleanupChallengeData(obj_id terminal)
    {
        removeObjVar(terminal, VAR_CHALLENGE_DATA);
    }
    public static void checkArenaMaintenance(obj_id enclave)
    {
    ...
    public static void dishOutChallengeAnswerPointsToRanks(obj_id terminal)
    {
        if (!hasObjVar(terminal, VAR_ALL_RANKS))
        {
    ...
    public static void openArenaForChallenges(obj_id terminal)
    {
    ...
    public static void closeArenaForChallenges(obj_id terminal)
    {
    ...
    public static boolean isArenaOpenForChallenges(obj_id terminal)
    {
    ...
    public static obj_id getMyArena(obj_id terminal)
    {
    ...
    public static void notifyChallengeIssued(obj_id terminal, obj_id challenger, int rankChallenged)
    {
        obj_id enclave = getTopMostContainer(terminal);
        if (!isIdValid(enclave))
        {
    ...
    public static void notifyChallengeAccepted(obj_id terminal, obj_id challenger, obj_id defender, int rankFightingFor)
    {
        obj_id enclave = getTopMostContainer(terminal);
        if (!isIdValid(enclave))
        {
    ...
    public static void notifyChallengeConcluded(obj_id terminal, obj_id challenger, obj_id defender, boolean challengerWon, int rankFightingFor)
    {
        obj_id enclave = getTopMostContainer(terminal);
        if (!isIdValid(enclave))
        {
    ...
    public static void notifyChallengeTimedOut(obj_id terminal, obj_id challenger, int rankChallenged)
    {
        obj_id enclave = getTopMostContainer(terminal);
        if (!isIdValid(enclave))
        {
    ...
    public static Vector getChallengerIdsForRank(obj_id challengeTerminal, int rank)
    {
    ...
    public static String[] getChallengerNamesForRank(obj_id challengeTerminal, int rank)
    {
        Vector players = getChallengerIdsForRank(challengeTerminal, rank);
        return utils.makeNameList(players);
    }
    public static String[] getChallengerNamesWithTimeRemaining(obj_id challengeTerminal, int rank)
    {
        obj_id[] challengers = new obj_id[0];
        int[] ranks = new int[0];
    ...
    public static boolean addChallengeIssueData(obj_id challengeTerminal, obj_id challenger, int rank)
    {
    ...
    public static boolean addChallengeAcceptedData(obj_id challengeTerminal, obj_id challenger, obj_id defender)
    {
        obj_id enclave = getTopMostContainer(challengeTerminal);
        if (!isIdValid(enclave))
        {
    ...
    public static boolean issueChallengeAgainstRank(obj_id challengeTerminal, obj_id player, int rank)
    {
    ...
    public static boolean hasChallengeIssuedCurrently(obj_id player, obj_id challengeTerminal)
    {
        Vector challengers = new Vector();
        challengers.setSize(0);
        Vector acceptedChallengers = new Vector();
    ...
    public static boolean canPlayerIssueChallenge(obj_id player, obj_id challengeTerminal)
    {
    ...
    public static boolean isPlayerPresentInArena(obj_id arenaCell, obj_id player)
    {
    ...
    public static boolean acceptChallenge(obj_id challengeTerminal, obj_id defender, obj_id challenger)
    {
        obj_id enclave = getTopMostContainer(challengeTerminal);
        if (!isIdValid(enclave))
        {
    ...
    public static void doDefenderLostPenalties(obj_id defender, obj_id challenger, obj_id enclave, boolean forfeit)
    {
    ...
    public static void doChallengerLostPenalties(obj_id defender, obj_id challenger, obj_id enclave, boolean forfeit)
    {
    ...
    public static void duelistDied(obj_id player, obj_id opponent, obj_id enclave, boolean forfeit)
    {
    ...
    public static void leftArenaDuringDuel(obj_id player)
    {
        if (!utils.hasScriptVar(player, arena.VAR_I_AM_DUELING))
        {
    ...
    public static obj_id isEitherDuelistInADuel(obj_id challengeTerminal, obj_id duelist1, obj_id duelist2)
    {
        Vector acceptedChallengers = new Vector();
        acceptedChallengers.setSize(0);
        Vector acceptedDefenders = new Vector();
    ...
    public static boolean validateAndRemoveChallenger(obj_id terminal, obj_id challenger, obj_id defender, obj_id enclave)
    {
    ...
    public static void beginChallengeDuel(obj_id terminal, obj_id challenger, obj_id defender)
    {
    ...
    public static void teleportPlayerToRandomArenaLoc(obj_id player, obj_id arenaCell)
    {
    ...
    public static boolean isPlayerInEnclave(obj_id player)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static String[] getPlayerNamesForIssuedChallenges(obj_id challengeTerminal, int rank)
    {
        obj_id[] ids = getPlayerIdsForIssuedChallenges(challengeTerminal, rank);
        return utils.makeNameList(ids);
    }
    public static obj_id[] getPlayerIdsForIssuedChallenges(obj_id challengeTerminal, int rank)
    {
        obj_id enclave = getTopMostContainer(challengeTerminal);
        if (!isIdValid(enclave))
        {
    ...
    public static String getRealPlayerFirstNameAuth(obj_id player)
    {
        if (!player.isAuthoritative())
        {
            return null;
