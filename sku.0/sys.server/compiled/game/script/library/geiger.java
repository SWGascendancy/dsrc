...
public class geiger extends script.base_script
{
    ...
    public static boolean hasGeiger(obj_id player)
    {
        return hasObjVar(player, OBJVAR_GEIGER_OBJECT);
    }
    public static void resetGeiger(obj_id player)
    {
    ...
    public static void setGeiger(obj_id player, location loc)
    {
    ...
    public static void clearGeiger(obj_id player)
    {
        removeObjVar(player, OBJVAR_GEIGER_LOCATION);
        removeObjVar(player, OBJVAR_GEIGER_FACTOR);
    }
    public static void removeGeiger(obj_id player)
    {
    ...
    public static float calculateGeigerNumber(obj_id player)
    {
    ...
    public static void updateGeiger(obj_id player, obj_id geiger)
    {
