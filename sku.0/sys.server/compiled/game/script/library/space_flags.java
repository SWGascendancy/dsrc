...
public class space_flags extends script.base_script
{
    ...
    public static void setSpaceTrack(obj_id player, String spaceTrack)
    {
        clearSpaceTrack(player);
        setObjVar(player, SPACE_TRACK_FLAG, spaceTrack);
        setObjVar(player, spaceTrack + ".member", true);
    }
    public static String getSpaceTrack(obj_id player)
    {
        return getStringObjVar(player, SPACE_TRACK_FLAG);
    }
    public static void clearSpaceTrack(obj_id player)
    {
    ...
    public static boolean isSpaceTrack(obj_id player, String spaceTrack)
    {
    ...
    public static void setSpaceFlag(obj_id player, String flagName, int flagValue)
    {
        String currentSpaceTrack = getSpaceTrack(player);
    ...
    public static void setSpaceFlag(obj_id player, String flagName, boolean flagValue)
    {
        String currentSpaceTrack = getSpaceTrack(player);
        if (currentSpaceTrack == null)
        {
    ...
    public static boolean hasSpaceFlag(obj_id player, String flagName)
    {
        String currentSpaceTrack = getSpaceTrack(player);
        if (currentSpaceTrack == null)
        {
    ...
    public static int getIntSpaceFlag(obj_id player, String flagName)
    {
        String currentSpaceTrack = getSpaceTrack(player);
        if (currentSpaceTrack == null)
        {
    ...
    public static boolean getBooleanSpaceFlag(obj_id player, String flagName)
    {
        String currentSpaceTrack = getSpaceTrack(player);
        if (currentSpaceTrack == null)
        {
    ...
    public static void removeSpaceFlag(obj_id player, String flagName)
    {
        String currentSpaceTrack = getSpaceTrack(player);
        if (currentSpaceTrack == null)
        {
    ...
    public static boolean isRebelPilot(obj_id player)
    {
        return hasSkill(player, "pilot_rebel_navy_novice");
    }
    public static boolean isImperialPilot(obj_id player)
    {
        return hasSkill(player, "pilot_imperial_navy_novice");
    }
    public static boolean isNeutralPilot(obj_id player)
    {
        return hasSkill(player, "pilot_neutral_novice");
    }
    public static boolean hasAnyPilotSkill(obj_id player)
    {
        return (isRebelPilot(player) || isImperialPilot(player) || isNeutralPilot(player));
    }
    public static String getProfessionPrefix(obj_id player)
    {
    ...
    public static boolean isRebelHelperPilot(obj_id player)
    {
    ...
    public static boolean isImperialHelperPilot(obj_id player)
    {
        if (!isIdValid(player) && !exists(player))
        {
            return false;
    ...
    public static boolean isInTierOne(obj_id player)
    {
    ...
    public static boolean isInTierTwo(obj_id player)
    {
    ...
    public static boolean isInTierThree(obj_id player)
    {
    ...
    public static boolean isInTierFour(obj_id player)
    {
    ...
    public static int getPilotTier(obj_id player)
    {
        if (!isIdValid(player))
        {
            return 0;
    ...
    public static boolean hasOneTierOneSkill(obj_id player)
    {
        String professionPrefix = getProfessionPrefix(player);
        if (professionPrefix == null)
        {
    ...
    public static boolean hasCompletedTierOne(obj_id player)
    {
        String professionPrefix = getProfessionPrefix(player);
        if (professionPrefix == null)
        {
    ...
    public static boolean hasCompletedTierTwo(obj_id player)
    {
        String professionPrefix = getProfessionPrefix(player);
        if (professionPrefix == null)
        {
    ...
    public static boolean hasCompletedTierThree(obj_id player)
    {
        String professionPrefix = getProfessionPrefix(player);
        if (professionPrefix == null)
        {
    ...
    public static boolean hasCompletedTierFour(obj_id player)
    {
        String professionPrefix = getProfessionPrefix(player);
        if (professionPrefix == null)
        {
    ...
    public static void restoreClientPath(obj_id player)
    {
    ...
    public static void clearClientPath(obj_id player)
    {
