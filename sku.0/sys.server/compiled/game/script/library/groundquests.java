...
public class groundquests extends script.base_script
{
    ...
    public static String getStringDataEntry(String datatableName, int questId, int taskId, String columnName)
    {
        String result = null;
    ...
    public static int getIntDataEntry(String datatableName, int questId, int taskId, String columnName)
    {
        int result = -1;
        String questName = questGetQuestName(questId);
        String datatable = "datatables/" + datatableName + "/" + questName + ".iff";
    ...
    public static float getFloatDataEntry(String datatableName, int questId, int taskId, String columnName)
    {
        float result = 0.0f;
        String questName = questGetQuestName(questId);
        String datatable = "datatables/" + datatableName + "/" + questName + ".iff";
    ...
    public static boolean getBoolDataEntry(String datatableName, int questId, int taskId, String columnName, boolean defaultValue)
    {
        int result = -1;
        String questName = questGetQuestName(questId);
        String datatable = "datatables/" + datatableName + "/" + questName + ".iff";
    ...
    public static String setBaseObjVar(obj_id player, String taskType, String questName, int taskId)
    {
        String objvar = questBaseObjVar + dot + taskType + dot + questName + dot + taskId;
        setObjVar(player, objvar + dot + "inProgress", "true");
        return objvar;
    }
    public static void clearBaseObjVar(obj_id player, String taskType, String questName, int taskId)
    {
        String objvarTask = questBaseObjVar + dot + taskType + dot + questName + dot + taskId;
        removeObjVar(player, objvarTask);
    }
    public static String getBaseObjVar(obj_id player, String taskType, String questName, int taskId)
    {
        return questBaseObjVar + dot + taskType + dot + questName + dot + taskId;
    }
    public static String getTaskTypeObjVar(obj_id player, String taskType)
    {
    ...
    public static String getTaskTypeObjVar(String taskType)
    {
        return questBaseObjVar + dot + taskType;
    }
    public static void questOutputDebugInfo(obj_id player, int questCrc, int taskId, String taskType, String method, String message)
    {
    ...
    public static void questOutputDebugInfo(obj_id player, String questName, int taskId, String taskType, String method, String message)
    {
        questOutputDebugInfo(player, questGetQuestId(questName), taskId, taskType, method, message);
    }
    public static void questOutputDebugInfo(obj_id player, String taskType, String method, String message)
    {
        if (isGod(player) && questGetDebugging())
        {
    ...
    public static void questOutputDebugLog(String taskType, String method, String message)
    {
    ...
    public static void addDestroyNotification(obj_id target, obj_id player)
    {
    ...
    public static void failAllActiveTasksOfType(obj_id player, String taskType)
    {
    ...
    public static String getTaskStringDataEntry(int questId, int taskId, String columnName)
    {
        return getStringDataEntry("questtask", questId, taskId, columnName);
    }
    public static int getTaskIntDataEntry(int questId, int taskId, String columnName)
    {
        return getIntDataEntry("questtask", questId, taskId, columnName);
    }
    public static float getTaskFloatDataEntry(int questId, int taskId, String columnName)
    {
        return getFloatDataEntry("questtask", questId, taskId, columnName);
    }
    public static boolean getTaskBoolDataEntry(int questId, int taskId, String columnName, boolean defaultValue)
    {
        return getBoolDataEntry("questtask", questId, taskId, columnName, defaultValue);
    }
    public static String getQuestStringDataEntry(int questId, String columnName)
    {
        return getStringDataEntry("questlist", questId, 0, columnName);
    }
    public static int getQuestIntDataEntry(int questId, String columnName)
    {
        return getIntDataEntry("questlist", questId, 0, columnName);
    }
    public static float getQuestFloatDataEntry(int questId, String columnName)
    {
        return getFloatDataEntry("questlist", questId, 0, columnName);
    }
    public static boolean getQuestBoolDataEntry(int questId, String columnName, boolean defaultValue)
    {
        return getBoolDataEntry("questlist", questId, 0, columnName, defaultValue);
    }
    public static boolean getShowSystemMessages(int questCrc, int taskId)
    {
        return getTaskIntDataEntry(questCrc, taskId, datatableColumnShowSystemMessages) > 0;
    }
    public static void sendGroundQuestSystemMessage(string_id message, int questCrc, int taskId, obj_id player)
    {
    ...
    public static void sendTaskCompletedSystemMessage(int questCrc, int taskId, obj_id player)
    {
    ...
    public static void sendTaskFailedSystemMessage(int questCrc, int taskId, obj_id player)
    {
        if (getShowSystemMessages(questCrc, taskId))
        {
    ...
    public static void requestGrantQuest(obj_id player, String questName)
    {
        int questNum = getQuestIdFromString(questName);
        requestGrantQuest(questNum, player, player, true);
    }
    public static void requestGrantQuest(obj_id[] players, String questName)
    {
    ...
    public static void requestGrantQuest(int questCrc, obj_id player, obj_id npc)
    {
        requestGrantQuest(questCrc, player, npc, false);
    }
    public static void requestGrantQuest(obj_id player, String questName, boolean showMessage)
    {
        int questNum = getQuestIdFromString(questName);
        requestGrantQuest(questNum, player, player, showMessage);
    }
    public static void requestGrantQuest(int questCrc, obj_id player, obj_id npc, boolean showSystemMessage)
    {
    ...
    public static int grantQuest(obj_id player, String questName)
    {
        int questNum = getQuestIdFromString(questName);
        requestGrantQuest(questNum, player, player, true);
        return 1;
    }
    public static int grantQuest(int questCrc, obj_id player, obj_id npc)
    {
        requestGrantQuest(questCrc, player, npc, false);
        return 1;
    }
    public static int grantQuest(obj_id player, String questName, boolean showMessage)
    {
        int questNum = getQuestIdFromString(questName);
        requestGrantQuest(questNum, player, player, showMessage);
        return 1;
    }
    public static int grantQuest(int questCrc, obj_id player, obj_id npc, boolean showSystemMessage)
    {
        if (utils.isProfession(player, utils.TRADER) || utils.isProfession(player, utils.ENTERTAINER))
        {
            doTraderEntertainerXpWarning(questCrc, player);
    ...
    public static void doTraderEntertainerXpWarning(int questCrc, obj_id player)
    {
        String xpType = "";
        int xpAmount = -1;
    ...
    public static int grantQuestNoAcceptUI(obj_id player, String questName, boolean showSystemMessage)
    {
        int questCrc = getQuestIdFromString(questName);
        return questActivateQuest(questCrc, player, player);
    }
    public static boolean isInNamedRegion(obj_id player, String requiredRegion)
    {
    ...
    public static void sendSignal(obj_id player, String signalName)
    {
        dictionary params = new dictionary();
        params.put("signal", signalName);
        messageTo(player, "questSignal", params, 0, false);
    }
    public static void sendSignal(obj_id[] players, String signalName)
    {
        if (players == null || players.length == 0)
        {
            return;
    ...
    public static void sendSignals(obj_id player, String[] signalNames)
    {
    ...
    public static boolean isQuestDisabled(String questName)
    {
    ...
    public static int getQuestIdFromString(String questName)
    {
        if (questName.startsWith("quest/"))
        {
    ...
    public static boolean hasCompletedQuest(obj_id player, String questName)
    {
        int questNum = getQuestIdFromString(questName);
        return questIsQuestComplete(questNum, player);
    }
    public static int canActivateQuest(obj_id player, String questName)
    {
        int questNum = getQuestIdFromString(questName);
        return questCanActivateQuest(questNum, player);
    }
    public static void completeQuest(obj_id player, String questName)
    {
        int questNum = getQuestIdFromString(questName);
        requestCompleteQuest(questNum, player);
    }
    public static void clearQuest(obj_id player, String questName)
    {
        int questNum = getQuestIdFromString(questName);
        questClearQuest(questNum, player);
    }
    public static void clearQuest(obj_id[] players, String questName)
    {
        if (players == null || players.length == 0)
        {
            return;
    ...
    public static boolean isQuestActive(obj_id player, String questName)
    {
        int questNum = getQuestIdFromString(questName);
        return questIsQuestActive(questNum, player);
    }
    public static boolean isQuestActiveOrComplete(obj_id player, String questName)
    {
        int questNum = getQuestIdFromString(questName);
        return questIsQuestActive(questNum, player) || questIsQuestComplete(questNum, player);
    }
    public static boolean hasCompletedTask(obj_id player, String questName, int taskNum)
    {
        int questNum = getQuestIdFromString(questName);
        return questIsTaskComplete(questNum, taskNum, player);
    }
    public static boolean isTaskActive(obj_id player, String questName, int taskNum)
    {
        int questNum = getQuestIdFromString(questName);
        return questIsTaskActive(questNum, taskNum, player);
    }
    public static void activateTask(obj_id player, String questName, int taskNum)
    {
        int questNum = getQuestIdFromString(questName);
    ...
    public static void completeTask(obj_id player, String questName, int taskNum)
    {
        int questNum = getQuestIdFromString(questName);
        if (isValidQuestName(questName) && isValidTaskId(taskNum))
        {
    ...
    public static void failTask(obj_id player, String questName, int taskNum)
    {
        int questNum = getQuestIdFromString(questName);
        if (isValidQuestName(questName) && isValidTaskId(taskNum))
        {
    ...
    public static void clearTask(obj_id player, String questName, int taskNum)
    {
        int questNum = getQuestIdFromString(questName);
        if (isValidQuestName(questName) && isValidTaskId(taskNum))
        {
    ...
    public static boolean hasCompletedTask(obj_id player, String questName, String taskName)
    {
        int questNum = getQuestIdFromString(questName);
        int taskNum = getTaskId(questNum, taskName);
        return questIsTaskComplete(questNum, taskNum, player);
    }
    public static boolean isTaskActive(obj_id player, String questName, String taskName)
    {
        int questNum = getQuestIdFromString(questName);
        int taskNum = getTaskId(questNum, taskName);
        return questIsTaskActive(questNum, taskNum, player);
    }
    public static void activateTask(obj_id player, String questName, String taskName)
    {
        int questNum = getQuestIdFromString(questName);
        int taskNum = getTaskId(questNum, taskName);
        if (isValidQuestName(questName) && isValidTaskId(taskNum))
    ...
    public static void completeTask(obj_id player, String questName, String taskName)
    {
        int questNum = getQuestIdFromString(questName);
        int taskNum = getTaskId(questNum, taskName);
        if (isValidQuestName(questName) && isValidTaskId(taskNum))
    ...
    public static void failTask(obj_id player, String questName, String taskName)
    {
        int questNum = getQuestIdFromString(questName);
        int taskNum = getTaskId(questNum, taskName);
        if (isValidQuestName(questName) && isValidTaskId(taskNum))
    ...
    public static void clearTask(obj_id player, String questName, String taskName)
    {
        int questNum = getQuestIdFromString(questName);
        int taskNum = getTaskId(questNum, taskName);
        if (isValidQuestName(questName) && isValidTaskId(taskNum))
    ...
    public static int getTaskId(int questCrc, String taskName)
    {
    ...
    public static boolean isValidQuestName(String questName)
    {
        return getQuestIdFromString(questName) != INVALID_QUEST;
    }
    public static dictionary getActiveTasksForTaskType(obj_id player, String taskType)
    {
    ...
    public static location getRandom2DLocationAroundPlayer(obj_id player, float minimumDistance, float maximumDistance)
    {
    ...
    public static location getRandom2DLocationAroundLocation(obj_id player, float relativeOffsetX, float relativeOffsetZ, float minimumDistance, float maximumDistance)
    {
    ...
    public static boolean isValidQuestSpawnPoint(obj_id player, location newLocation, boolean onAFloor, boolean inACell)
    {
    ...
    public static location getRandom2DLocationInRing(location startLocation, float minimumRadius, float maximumRadius)
    {
    ...
    public static void setPendingStaticEscortTarget(obj_id player, obj_id newEscortTarget)
    {
        setObjVar(player, questBaseObjVar + dot + questAllObjVar + dot + questStaticEscortTargetObjVar, newEscortTarget);
    }
    public static boolean isEscortTargetReadyForStaticEscortTask(obj_id escortTarget)
    {
    ...
    public static void questStartPerforming(obj_id player, int performType)
    {
        dictionary params = new dictionary();
        params.put(PERFORM_TYPE, performType);
        messageTo(player, "startPerform", params, 1, false);
    }
    public static void questStopPerforming(obj_id player)
    {
        messageTo(player, "stopPerform", null, 1, false);
    }
    public static void questStartDance(obj_id player)
    {
        questStartPerforming(player, PERFORM_DANCE);
    }
    public static void questStartMusic(obj_id player)
    {
        questStartPerforming(player, PERFORM_MUSIC);
    }
    public static void questStartJuggle(obj_id player)
    {
        questStartPerforming(player, PERFORM_JUGGLE);
    }
    public static void sendPlacedMoreThanOneInInventorySystemMessage(obj_id player, obj_id objectPlaced, int count)
    {
    ...
    public static void sendPlacedInInventorySystemMessage(obj_id player, obj_id objectPlaced, String objectTemplate)
    {
        if (isValidId(objectPlaced))
        {
    ...
    public static void sendRemovedFromInventorySystemMessage(obj_id player, obj_id objectPlaced, String objectTemplate)
    {
        if (isValidId(objectPlaced))
        {
            prose_package pp = null;
    ...
    public static void sendRemovedFromInventorySystemMessage(obj_id player, obj_id objectPlaced)
    {
        sendRemovedFromInventorySystemMessage(player, objectPlaced, null);
    }
    public static boolean isActionAllowedForQuest(obj_id player, obj_id npc, String actionName)
    {
    ...
    public static boolean questActionCompleted(obj_id player, obj_id npc, String actionName)
    {
    ...
    public static void applyQuestPenalty(obj_id player, String factionName, int factionAmount)
    {
    ...
    public static boolean playerNeedsToRetrieveThisItem(obj_id player, obj_id item)
    {
        return playerNeedsToRetrieveThisItem(player, item, "retrieve_item");
    }
    public static boolean playerNeedsToRetrieveThisItem(obj_id player, obj_id item, String taskType)
    {
    ...
    public static String getRetrieveMenuText(obj_id player, obj_id item)
    {
        return getRetrieveMenuText(player, item, "retrieve_item");
    }
    public static String getRetrieveMenuText(obj_id player, obj_id item, String taskType)
    {
    ...
    public static int getQuestCountdownTime(obj_id player, obj_id item)
    {
        return getQuestCountdownTime(player, item, "retrieve_item");
    }
    public static int getQuestCountdownTime(obj_id player, obj_id item, String taskType)
    {
        int countdownTime = 0;
        String itemTemplateName = getTemplateName(item);
        dictionary tasks = groundquests.getActiveTasksForTaskType(player, taskType);
    ...
    public static int getQuestExperienceReward(obj_id player, int questLevel, int questTier, int experienceAmount)
    {
    ...
    public static int getQuestXpCap(obj_id player)
    {
    ...
    public static void createQuestWaypoints(int questCrc, int taskId, obj_id self)
    {
    ...
    public static void setQuestWaypointActive(obj_id waypoint, obj_id player, String baseObjVar)
    {
    ...
    public static obj_id getObjIdForWaypoint(int questCrc, int taskId, obj_id self)
    {
        String baseObjVar = groundquests.getBaseObjVar(self, taskType, questGetQuestName(questCrc), taskId);
        String baseWaypoint = baseObjVar + dot + objvarWaypoint;
        return getObjIdObjVar(self, baseWaypoint);
    }
    public static obj_id getObjIdForEntranceWaypoint(int questCrc, int taskId, obj_id self)
    {
        String baseObjVar = groundquests.getBaseObjVar(self, taskType, questGetQuestName(questCrc), taskId);
        String doorWaypoint = baseObjVar + dot + objvarEntranceWaypoint;
        return getObjIdObjVar(self, doorWaypoint);
    }
    public static void deleteQuestWaypoints(int questCrc, int taskId, boolean isForCTS, obj_id self)
    {
        String baseObjVar = groundquests.getBaseObjVar(self, taskType, questGetQuestName(questCrc), taskId);
        String baseWaypoint = baseObjVar + dot + objvarWaypoint;
        String doorWaypoint = baseObjVar + dot + objvarEntranceWaypoint;
    ...
    public static void reattachQuestScripts(obj_id self)
    {
    ...
    public static void refreshQuestWaypoints(int questCrc, int taskId, boolean isForCTS, obj_id self)
    {
        deleteQuestWaypoints(questCrc, taskId, isForCTS, self);
        createQuestWaypoints(questCrc, taskId, self);
    }
    public static void setGuaranteedSuccessTarget(obj_id player, int questCrc, int taskId, String baseObjVar)
    {
    ...
    public static boolean checkForGuaranteedSuccess(obj_id player, String baseObjVar)
    {
        String guaranteedSuccessTargetObjVar = baseObjVar + dot + objvarGuaranteedSuccess_Target;
        String guaranteedSuccessCountObjVar = baseObjVar + dot + objvarGuaranteedSuccess_Count;
    ...
    public static boolean isDoingSmugglerMission(obj_id player)
    {
    ...
    public static float getPlayerPlayedTimeWhenTimerEnds(obj_id player, int questCrc, int taskId)
    {
    ...
    public static boolean isTimeRemainingBeforeCompletion(obj_id player, int questCrc, int taskId)
    {
    ...
    public static boolean gcwActiveDutyCheck(obj_id self, obj_id player)
    {
    ...
    public static boolean completeTaskForGroupMembersInRange(obj_id questObj, obj_id player, int questCrc, int taskId)
    {
        return completeTaskForGroupMembersInRange(questObj, player, questCrc, taskId, 200.0f);
    }
    public static boolean completeTaskForGroupMembersInRange(obj_id questObj, obj_id player, int questCrc, int taskId, float range)
    {
    ...
    public static obj_id[] getGroupMembersInRange(obj_id questObj, obj_id player)
    {
        return getGroupMembersInRange(questObj, player, 200.0f);
    }
    public static obj_id[] getGroupMembersInRange(obj_id questObj, obj_id player, float range)
    {
