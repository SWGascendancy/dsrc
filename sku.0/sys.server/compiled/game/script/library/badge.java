...
public class badge extends script.base_script
{
    ...
    public static boolean grantBadge(obj_id player, String badge)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static boolean[] grantBadge(obj_id[] players, String badge)
    {
    ...
    public static boolean revokeBadge(obj_id player, String badge, boolean tellPlayer)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static boolean hasBadge(obj_id player, String badge)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static boolean notifyHasBadge(obj_id player, String badge)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static boolean checkBadgeCount(obj_id player)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static void grantMasterSkillBadge(obj_id player, String skill)
    {
    ...
    public static void grantThemeParkBadges(obj_id player)
    {
    ...
    public static void checkForCombatTargetBadge(obj_id player, String creatureType)
    {
