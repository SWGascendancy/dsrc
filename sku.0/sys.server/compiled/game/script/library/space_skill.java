...
public class space_skill extends script.base_script
{
    ...
    public static boolean hasRebelSkill(obj_id player)
    {
        return (hasSkill(player, "pilot_rebel_navy_novice"));
    }
    public static boolean hasImperialSkill(obj_id player)
    {
        return (hasSkill(player, "pilot_imperial_navy_novice"));
    }
    public static boolean hasPilotSkill(obj_id player)
    {
        return (hasSkill(player, "pilot_neutral_novice"));
    }
    public static boolean hasSpaceSkills(obj_id player)
    {
    ...
    public static void retireWarning(obj_id player, String skill)
    {
        String prompt = "";
        String wp_name = "";
    ...
    public static void revokeExperienceForRetire(obj_id player, String skill)
    {
    ...
    public static boolean isMasterPilot(obj_id player)
    {
        if (hasRebelSkill(player))
        {
