...
public class tcg extends script.base_script
{
    ...
    public static boolean isBarnRanchhand(obj_id target)
    {
        return hasScript(target, BARN_RANCHHAND_SCRIPT);
    }
    public static boolean isBarnStructure(obj_id building)
    {
        String template = getTemplateName(building);
        return template.equals(BARN_STRUCTURE_TEMPLATE);
    }
    public static void barnStoreBeastPrompt(obj_id player, obj_id ranchhand)
    {
    ...
    public static void barnSelectPlayerBeastSui(obj_id player, obj_id ranchhand, obj_id[] beastControlDevices, String[] beastNames, String promptRef, String promptExtra, String handler)
    {
    ...
    public static void barnReclaimBeastPrompt(obj_id player, obj_id barn, obj_id ranchhand)
    {
    ...
    public static void barnDisplayBeastPrompt(obj_id player, obj_id barn, obj_id ranchhand)
    {
        String[] initialStorageList = getBarnBeastStorageSlots(barn);
        if (initialStorageList == null || initialStorageList.length < 1)
        {
    ...
    public static void barnSelectStoredBeastSui(obj_id player, obj_id ranchhand, String[] beastControlSlots, String[] beastNames, String promptRef, String promptExtra, String handler)
    {
        if (utils.hasScriptVar(player, "barnRanchHand.pid"))
        {
            int oldPid = utils.getIntScriptVar(player, "barnRanchHand.pid");
    ...
    public static boolean transferBeastControlDeviceToBarn(obj_id selectedBeastControlDevice, obj_id player, obj_id barn)
    {
    ...
    public static obj_id transferBeastControlDeviceFromBarn(String selectedStorageSlot, obj_id player, obj_id barn)
    {
    ...
    public static void setBCDDataObjVars(obj_id player, obj_id target, String objvarNamePrefix, obj_var_list data)
    {
    ...
    public static String getNextAvailableBarnStorageSlot(obj_id barn, obj_id player)
    {
        String storageSlot = "";
    ...
    public static String[] getBarnBeastStorageSlots(obj_id barn)
    {
    ...
    public static int getTotalBarnStoredBeastsFromRanchhand(obj_id ranchhand)
    {
    ...
    public static int getTotalBarnStoredBeasts(obj_id barn)
    {
        int numStoredBeasts = 0;
    ...
    public static obj_id barnDisplayBeast(obj_id ranchhand, String storageSlot, obj_id barn)
    {
    ...
    public static void initializeBeastStatsFromBarn(obj_id barn, obj_id beast, String storageSlot, String beastType)
    {
        colorBeastUsingBarnData(beast, barn, storageSlot);
        int level = 1;
    ...
    public static boolean isBarnLiteDevice(obj_id object)
    {
        return hasObjVar(object, "barnLite.isBarnLite");
    }
    public static int getMaxBarnLiteBeasts(obj_id barn_lite_device)
    {
    ...
    public static boolean grantPackageContents(obj_id objectPacked, obj_id player)
    {
    ...
    public static boolean colorBeastUsingBarnData(obj_id beast, obj_id barn, String storageSlot)
    {
    ...
    public static boolean setRoamingBeastHue(obj_id beast, String palette, int hueIndex)
    {
        if (!isValidId(beast) || !exists(beast))
        {
            return false;
    ...
    public static boolean showRoamingBeasts(obj_id barn, obj_id ranchhand)
    {
        if (!isValidId(barn) || !exists(barn))
        {
            return false;
    ...
    public static boolean setupDeathStarFix(obj_id table)
    {
    ...
    public static boolean fixDeathStarScores(obj_id table, String layout, float modifier)
    {
        if (!isValidId(table) || !exists(table))
        {
            return false;
