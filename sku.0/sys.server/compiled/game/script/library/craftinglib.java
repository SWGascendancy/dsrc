...
public class craftinglib extends script.base_script
{
    ...
    public static final int STATION_TYPE_SPIRE = 393344;
    public static final int STATION_TYPE_VIP = 345152;
    public static final int STATION_TYPE_COMMANDO_BUNKER = 345156;
    public static final int STATION_TYPE_ATAT = 491584;
    public static final int STATION_TYPE_YODA = 395392;
    public static final int STATION_TYPE_HANGAR = 458816;
    public static final int STATION_TYPE_BARN = 493632;
    public static final int STATION_TYPE_CANTINA = 493636;
    public static final int STATION_TYPE_HOSPITAL = 493640;
    public static final int STATION_TYPE_MERCHANT_TENT = 428160;
    public static final int STATION_TYPE_GUILDHALL = 428168;
    ...
    public static float calcResourceQualitySkillMod(dictionary craftingValuesDictionary)
    {
    ...
    public static float calcItemComplexitySkillMod(dictionary craftingValuesDictionary)
    {
        if (craftingValuesDictionary == null)
        {
            return 0;
    ...
    public static float calcResourceMalleabilitySkillMod(dictionary craftingValuesDictionary)
    {
        if (craftingValuesDictionary == null)
        {
            return 0;
    ...
    public static float getAttributeResourceMod(float averagedAttributeSum)
    {
    ...
    public static float computeWeightedAverage(float[] resourceValues, resource_weight.weight[] weights)
    {
        float total = 0;
        int count = 0;
    ...
    public static int calcSkillDesignAssemblyCheck(obj_id player, dictionary craftingValuesDictionary, String[] skills)
    {
    ...
    public static float calcAssemblySuccessAttributeMultiplier(int assemblySuccessState, dictionary craftingValuesDictionary)
    {
        if (craftingValuesDictionary == null)
        {
            return 0;
    ...
    public static void calcCraftingDesignStageIngredientAttribAverageValues(dictionary craftingValuesDictionary, draft_schematic.slot[] ingredientSlots)
    {
    ...
    public static float getCraftingInspirationBonus(obj_id player, dictionary craftingValuesDictionary, float currentValue, float multiplier)
    {
        if (!isIdValid(player))
        {
            return 0f;
    ...
    public static void calcResourceMaxItemAttributes(dictionary craftingValuesDictionary, draft_schematic.attribute[] itemAttributes, resource_weight[] weights)
    {
        calcResourceMaxItemAttributes(null, craftingValuesDictionary, itemAttributes, weights);
    }
    public static void calcResourceMaxItemAttributes(obj_id player, dictionary craftingValuesDictionary, draft_schematic.attribute[] itemAttributes, resource_weight[] weights)
    {
    ...
    public static void calcPostAssemblyResourceSetAttribValues(dictionary craftingValuesDictionary, draft_schematic.attribute[] itemAttributes, resource_weight[] weights)
    {
        float[] averageResourceValues = craftingValuesDictionary.getFloatArray(RESOURCE_AVERAGE_DICTIONARY_NAME);
        float[][] slotResourceValues = (float[][])(craftingValuesDictionary.get(SLOT_RESOURCE_DICTIONARY_NAME));
    ...
    public static void calcPostSkillAssemblyCheckSetAttribValues(dictionary craftingValuesDictionary, draft_schematic.attribute[] itemAttributes)
    {
    ...
    public static int calcAssemblyPhaseAttributes(obj_id player, draft_schematic.slot[] itemIngredients, draft_schematic.attribute[] itemAttributes, dictionary craftingValuesDictionary, String[] playerSkillMods, resource_weight[] maxResourceAttribWeights, resource_weight[] resourceAttribWeights)
    {
    ...
    public static void calcExperimentalAttribs(draft_schematic schematic)
    {
    ...
    public static float[] convertExperimentalPointsToObjectPoints(draft_schematic schematic, string_id[] attributeNames, int[] experimentPoints)
    {
    ...
    public static int calcExperimentPoints(obj_id player, String[] skillMods)
    {
    ...
    public static void calcExpFullSinglePointValue(dictionary craftingValuesDictionary, draft_schematic.attribute[] itemAttributes)
    {
        for (int i = 0; i < itemAttributes.length; ++i)
        {
            if (itemAttributes[i] == null)
    ...
    public static void calcPerExperimentationCheckMod(obj_id player, dictionary craftingValuesDictionary, int experimentPointCount, draft_schematic.attribute[] itemAttributes, String[] skills)
    {
    ...
    public static void calcSuccessPerAttributeExperimentation(dictionary craftingValuesDictionary, float[] experimentPoints, draft_schematic.attribute[] itemAttributes, obj_id player, String[] craftingSkills)
    {
    ...
    public static void storeTissueDataAsObjvars(dictionary craftingValuesDictionary, draft_schematic.attribute[] itemAttributes, obj_id prototype, boolean includeComponents)
    {
    ...
    public static draft_schematic.custom[] standardCustomizationProcedure(obj_id player, draft_schematic.custom[] customizations, String[] customizationSkillMods)
    {
    ...
    public static String getCraftingSubskill(String[] craftingSkills)
    {
    ...
    public static String[] getDraftSchematicGroupsFromSkill(String skillName)
    {
    ...
    public static String[] getDraftSchematicGroupsFromSkills(String[] craftingSkills)
    {
    ...
    public static String[] getDraftSchematicsFromGroup(String schematicGroup)
    {
    ...
    public static String[] getDraftSchematicsFromGroups(String[] schematicGroups)
    {
    ...
    public static boolean storeSecondarySkillBonuses(obj_id prototype, draft_schematic schematic)
    {
    ...
    public static String getProtoTypeCategory(obj_id prototype)
    {
        String category = "";
    ...
    public static boolean validateReComponent(obj_id player, obj_id resource)
    {
    ...
    public static boolean validateReComponent(obj_id player, draft_schematic schematic)
    {
        if (!isIdValid(player) || !exists(player))
        {
            return false;
    ...
    public static boolean updatePermanentSchematics(obj_id player)
    {
        if (!isIdValid(player) || !exists(player))
        {
            return false;
    ...
    public static String getCraftingStationBuffName(int craftingType)
    {
        if (craftingType <= 0)
        {
            return null;
        ...
        {
            return "tcg_relaxation_pool_crafting_station";
        }
        if (craftingType == STATION_TYPE_SPIRE)
        {
            return "tcg_spires_crafting_station";
        }
        if (craftingType == STATION_TYPE_VIP)
        {
            return "tcg_vip_bunker_crafting_station";
        }
        if (craftingType == STATION_TYPE_COMMANDO_BUNKER)
        {
            return "tcg_commando_bunker_crafting_station";
        }
        if (craftingType == STATION_TYPE_ATAT)
        {
            return "tcg_atat_house_crafting_station";
        }
        if (craftingType == STATION_TYPE_YODA)
        {
            return "tcg_yodas_hutt_crafting_station";
        }
        if (craftingType == STATION_TYPE_HANGAR)
        {
            return "tcg_hangar_a_crafting_station,tcg_hangar_b_crafting_station,tcg_hangar_c_crafting_station";
        }
        if (craftingType == STATION_TYPE_BARN)
        {
            return "tcg_barn_crafting_station";
        }
        if (craftingType == STATION_TYPE_CANTINA)
        {
            return "tcg_cantina_crafting_station";
        }
        if (craftingType == STATION_TYPE_HOSPITAL)
        {
            return "tcg_hospital_crafting_station";
        }
        if (craftingType == STATION_TYPE_MERCHANT_TENT)
        {
            return "tcg_merchant_tent_crafting_station";
        }
        if (craftingType == STATION_TYPE_GUILDHALL)
        {
            return "tcg_guild_hall_crafting_station";
        }
        return null;
    }
    public static String[] getAllStationBuffNames(int craftingType)
    {
        if (craftingType < 0)
        {
            return null;
    ...
    public static void makeBestResource(obj_id player, String resource, int quantity)
    {
    ...
    public static obj_id[] getAllResourceChildren(String resourceClass)
    {
    ...
    public static obj_id findBestResourceByAverage(obj_id[] resourceTypes)
    {
        int bestIndex = 0;
        int bestAverage = 0;
    ...
    public static void makeBestResourceByAttribute(obj_id player, String resource, String attribute, int quantity)
    {
        obj_id[] resourceTypes = getAllResourceChildren(resource);
        if (resourceTypes == null || resourceTypes.length == 0)
        {
    ...
    public static obj_id findBestResourceByAttribute(obj_id[] resourceTypes, String attributeName)
    {
        int bestIndex = 0;
        int bestValue = 0;
        for (int i = 0; i < resourceTypes.length; i++)
    ...
    public static String[] getResourceAttribNames(obj_id resource)
    {
    ...
    public static String[] getAttribNamesByResourceClass(String resourceClass)
    {
        obj_id[] resources = getResourceTypes(resourceClass);
        String[] resourceChildren = getImmediateResourceChildClasses(resourceClass);
        for (int i = 0; i < resourceChildren.length; i++)
    ...
    public static boolean isTrader(obj_id who)
    {
