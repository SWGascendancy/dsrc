...
public class create extends script.base_script
{
    ...
    public static obj_id staticObject(String objectName, location spawnLocation)
    {
        if (objectName == null)
        {
    ...
    public static obj_id object(String objectName, location spawnLocation)
    {
        return object(objectName, spawnLocation, -1);
    }
    public static obj_id object(String objectName, location spawnLocation, int level)
    {
        if (objectName == null)
        {
    ...
    public static obj_id object(String objectName, location spawnLocation, boolean withAi)
    {
        return object(objectName, spawnLocation, -1, withAi);
    }
    public static obj_id object(String objectName, location spawnLocation, int level, boolean withAi)
    {
        return create.object(objectName, spawnLocation, level, withAi, false);
    }
    public static obj_id object(String objectName, location spawnLocation, boolean withAi, boolean isPet)
    {
        return object(objectName, spawnLocation, -1, withAi, isPet);
    }
    public static obj_id object(String objectName, location spawnLocation, int level, boolean withAi, boolean isPet)
    {
        if (objectName == null)
        {
            LOG("create", "create.object called with NULL objectName!");
    ...
    public static obj_id object(String objectName, obj_id objContainer, boolean withAi, boolean isPet)
    {
    ...
    public static obj_id object(String objectName, obj_id objContainer, int level, boolean withAi, boolean isPet)
    {
        if (objectName == null)
        {
            LOG("create", "create.object called with NULL objectName!");
    ...
    public static obj_id object(String objectName, float xOffset, float zOffset)
    {
        return object(objectName, xOffset, zOffset, -1);
    }
    public static obj_id object(String objectName, float xOffset, float zOffset, int level)
    {
        if (objectName == null)
        {
            LOG("create", "create.object called with NULL objectName!");
    ...
    public static obj_id themeParkObject(String objectName, float xOffset, float zOffset, String destroyHandlerName, float destroyMessageDelay)
    {
        if (objectName == null)
        {
    ...
    public static obj_id themeParkObject(String objectName, float xOffset, float zOffset)
    {
        if (objectName == null)
        {
            LOG("create", "create.themeParkObject called with NULL objectName!");
    ...
    public static obj_id createNpc(String creatureName, String templateName, location spawnLocation)
    {
        return createNpc(creatureName, templateName, spawnLocation, -1);
    }
    public static obj_id createNpc(String creatureName, String templateName, location spawnLocation, int level)
    {
    ...
    public static obj_id createNpc(String creatureName, String templateName, float xOffset, float zOffset)
    {
        return createNpc(creatureName, templateName, xOffset, zOffset, -1);
    }
    public static obj_id createNpc(String creatureName, String templateName, float xOffset, float zOffset, int level)
    {
        if (creatureName == null)
        {
            LOG("create", "create.createNpc called with NULL creatureName!");
    ...
    public static obj_id createCreature(String creatureName, location spawnLocation, boolean withAi)
    {
        return createCreature(creatureName, spawnLocation, -1, withAi);
    }
    public static obj_id createCreature(String creatureName, location spawnLocation, int level, boolean withAi)
    {
        return create.createCreature(creatureName, spawnLocation, level, withAi, false);
    }
    public static obj_id createCreature(String creatureName, location spawnLocation, boolean withAi, boolean isPet)
    {
        return createCreature(creatureName, spawnLocation, -1, withAi, isPet);
    }
    public static obj_id createCreature(String creatureName, location spawnLocation, int level, boolean withAi, boolean isPet)
    {
        if (creatureName == null)
        {
    ...
    public static obj_id createCreature(String creatureName, obj_id objContainer, boolean withAi, boolean isPet)
    {
        return createCreature(creatureName, objContainer, -1, withAi, isPet);
    }
    public static obj_id createCreature(String creatureName, obj_id objContainer, int level, boolean withAi, boolean isPet)
    {
        if (creatureName == null)
        {
            LOG("create", "create.createCreature called with NULL creatureName!");
    ...
    public static obj_id createCreature(String creatureName, String templateName, location spawnLocation, dictionary creatureDict, boolean withAi)
    {
        return createCreature(creatureName, templateName, spawnLocation, creatureDict, -1, withAi);
    }
    public static obj_id createCreature(String creatureName, String templateName, location spawnLocation, dictionary creatureDict, int level, boolean withAi)
    {
        return createCreature(creatureName, templateName, spawnLocation, creatureDict, level, withAi, false);
    }
    public static obj_id createCreature(String creatureName, String templateName, location spawnLocation, dictionary creatureDict, boolean withAi, boolean isPet)
    {
        return createCreature(creatureName, templateName, spawnLocation, creatureDict, -1, withAi, isPet);
    }
    public static obj_id createCreature(String creatureName, String templateName, location spawnLocation, dictionary creatureDict, int level, boolean withAi, boolean isPet)
    {
        if (templateName.equals("") || templateName == null)
        {
    ...
    public static obj_id createCreature(String creatureName, String templateName, obj_id objContainer, dictionary creatureDict, boolean withAi, boolean isPet)
    {
        return createCreature(creatureName, templateName, objContainer, creatureDict, -1, withAi, isPet);
    }
    public static obj_id createCreature(String creatureName, String templateName, obj_id objContainer, dictionary creatureDict, int level, boolean withAi, boolean isPet)
    {
        if (templateName.equals("") || templateName == null)
        {
            LOG("create", creatureName + " could not be made because templateName is null");
    ...
    public static void initializeCreature(obj_id creature, String creatureName, dictionary creatureDict)
    {
        initializeCreature(creature, creatureName, creatureDict, -1);
    }
    public static void initializeCreature(obj_id creature, String creatureName, dictionary creatureDict, int level)
    {
    ...
    public static int calcCreatureLevel(String creatureName)
    {
        dictionary creatureDict = utils.dataTableGetRow(CREATURE_TABLE, creatureName);
        if (creatureDict == null)
        {
    ...
    public static int calcCreatureLevel(dictionary creatureDict)
    {
        int baseLevel = creatureDict.getInt("BaseLevel");
        int dmgLevel = baseLevel + creatureDict.getInt("Damagelevelmodifier");
        int statLevel = baseLevel + creatureDict.getInt("StatLevelModifier");
    ...
    public static int calcCreatureLevel(int statLevel, int dmgLevel, int toHitLevel, int armorLevel)
    {
        int level = 0;
    ...
    public static void attachCreatureScripts(obj_id creature, String scriptList, boolean withAi)
    {
    ...
    public static boolean initializeArmor(obj_id creature, dictionary creatureDict)
    {
    ...
    public static boolean initializeArmor(obj_id creature, dictionary creatureDict, int armorRating)
    {
    ...
    public static boolean initializeArmor(obj_id creature, int[] armorData)
    {
    ...
    public static void setCreatureObjVars(obj_id creature, String objVarList)
    {
        utils.setObjVarsList(creature, objVarList);
    }
    public static String getLairDifficulty(int intMinDifficulty, int intMaxDifficulty, int intPlayerDifficulty)
    {
    ...
    public static void grantAllAbilities(obj_id npc)
    {
        return;
    }
    public static void attachCombatScripts(obj_id npc)
    {
    ...
    public static void applySkillStatisticModifiers(obj_id creature, int toHitChance, int defenseValue)
    {
    ...
    public static void applyCreatureImmunities(obj_id creature, dictionary creatureDict)
    {
    ...
    public static void addDestroyMessage(obj_id creature, String handlerName, float delay, obj_id recipient)
    {
        if (!isIdValid(creature))
        {
            return;
    ...
    public static void randomlyNameCreature(obj_id npc, String creatureName)
    {
    ...
    public static void setTitle(obj_id npc, String creatureName)
    {
        string_id nameId = new string_id(CREATURE_NAME_FILE, creatureName);
        if (nameId == null)
        {
    ...
    public static void nameStormTrooper(obj_id npc)
    {
    ...
    public static void nameImperialPilot(obj_id npc)
    {
        setName(npc, "DS-" + rand(1, 820));
    }
    public static void nameScoutTrooper(obj_id npc)
    {
        int designation = rand(1, 5);
        String StName = "TK-";
        switch (designation)
    ...
    public static void nameDarkTrooper(obj_id npc)
    {
        int designation = rand(1, 5);
        String StName = "DLX-";
        switch (designation)
    ...
    public static void nameSwampTrooper(obj_id npc)
    {
        int designation = rand(1, 5);
        String StName = "TK-";
        switch (designation)
    ...
    public static boolean setFactionRecruiter(obj_id npc, String faction)
    {
    ...
    public static void setUpFactionalEnemyAttribs(obj_id npc, String pvpFaction)
    {
        if (pvpFaction == null)
        {
            return;
    ...
    public static void cleanOffBioLink(obj_id weapon)
    {
