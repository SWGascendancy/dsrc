...
public class space_utils extends script.base_script
{
    ...
    public static final int POB_LOOT_BOX_CAPACITY = 150;
    ...
    public static boolean isShipUsable(obj_id ship, obj_id player)
    {
    ...
    public static obj_id hasUsableShip(obj_id player)
    {
        string_id failReason = null;
        obj_id[] shipControlDevices = space_transition.findShipControlDevicesForPlayer(player);
        if (shipControlDevices != null && shipControlDevices.length > 0)
    ...
    public static boolean hasShipControlDeviceCertification(obj_id player, obj_id shipControlDevice)
    {
    ...
    public static Vector getPlayersInShip(obj_id objObject)
    {
        return space_transition.getContainedPlayers(objObject, null);
    }
    public static void sendSystemMessageShip(obj_id objShip, string_id strSpam, boolean boolSendToPilot, boolean boolSendToPassengers, boolean boolSendToGunners, boolean boolSendToOperations)
    {
        if (boolSendToPilot)
        {
    ...
    public static void tauntShip(obj_id objShip, obj_id objSender, prose_package pp, boolean boolSendToPilot, boolean boolSendToPassengers, boolean boolSendToGunners, boolean boolSendToOperations)
    {
        if (boolSendToPilot)
        {
    ...
    public static void tauntShip(obj_id objShip, obj_id objSender, string_id strSpam, boolean boolSendToPilot, boolean boolSendToPassengers, boolean boolSendToGunners, boolean boolSendToOperations)
    {
        if (boolSendToPilot)
        {
    ...
    public static void tauntPlayer(obj_id objPlayer, obj_id objSender, string_id strSpam)
    {
    ...
    public static void tauntPlayerWithSound(obj_id objPlayer, obj_id objSender, string_id strSpam, String soundEffect)
    {
        prose_package proseTest = prose.getPackage(strSpam);
        String strAppearance = "";
        if (hasObjVar(objSender, "convo.appearance"))
    ...
    public static void tauntPlayer(obj_id objPlayer, obj_id objSender, prose_package pp)
    {
        String strAppearance = "";
        if (hasObjVar(objSender, "convo.appearance"))
        {
    ...
    public static void tauntPilot(obj_id objShip, obj_id objSender, string_id strSpam)
    {
        if (!isIdValid(objShip))
        {
            return;
    ...
    public static void tauntPilot(obj_id objShip, obj_id objSender, prose_package pp)
    {
        obj_id objPilot = getPilotId(objShip);
        if (isIdValid(objPilot))
        {
    ...
    public static void tauntGunners(obj_id objShip, obj_id objSender, prose_package pp)
    {
    ...
    public static void tauntGunners(obj_id objShip, obj_id objSender, string_id strSpam)
    {
        Vector objGunners = getGunnersInShip(objShip);
        if ((objGunners == null) || (objGunners.size() < 1))
        {
    ...
    public static void tauntOperations(obj_id objShip, obj_id objSender, prose_package pp)
    {
    ...
    public static void tauntOperations(obj_id objShip, obj_id objSender, string_id strSpam)
    {
        obj_id objOfficer = getOperationsOfficer(objShip);
        if (isIdValid(objOfficer))
        {
    ...
    public static void tauntPassengers(obj_id objShip, obj_id objSender, prose_package pp)
    {
        Vector objPlayers = getPassengers(objShip);
        tauntArray(objSender, objPlayers, pp);
    }
    public static void tauntPassengers(obj_id objShip, obj_id objSender, string_id strSpam)
    {
        Vector objPlayers = getPassengers(objShip);
        tauntArray(objSender, objPlayers, strSpam);
    }
    public static void sendSystemMessageShip(obj_id objShip, prose_package pp, boolean boolSendToPilot, boolean boolSendToPassengers, boolean boolSendToGunners, boolean boolSendToOperations)
    {
        if (boolSendToPilot)
        {
    ...
    public static void sendSystemMessageToGunners(obj_id objShip, string_id strSpam)
    {
        Vector objGunners = getGunnersInShip(objShip);
        sendSystemMessageToArray(objGunners, strSpam);
        return;
    }
    public static void sendSystemMessageToGunners(obj_id objShip, prose_package pp)
    {
        Vector objGunners = getGunnersInShip(objShip);
    ...
    public static void tauntArray(obj_id objSender, Vector objArray, string_id strSpam)
    {
        if ((objArray != null) && (objArray.size() > 0))
        {
            String strAppearance = "";
    ...
    public static void sendSystemMessageToPassengers(obj_id objShip, string_id strSpam)
    {
        Vector objPlayers = getPassengers(objShip);
        sendSystemMessageToArray(objPlayers, strSpam);
    }
    public static void sendSystemMessageToPassengers(obj_id objShip, prose_package pp)
    {
        Vector objPlayers = getPassengers(objShip);
        sendSystemMessageToArray(objPlayers, pp);
    }
    public static void sendSystemMessageToOperations(obj_id objShip, string_id strSpam)
    {
        obj_id objOfficer = getOperationsOfficer(objShip);
        if (isIdValid(objOfficer))
        {
    ...
    public static void sendSystemMessageToOperations(obj_id objShip, prose_package pp)
    {
        obj_id objOfficer = getOperationsOfficer(objShip);
        if (isIdValid(objOfficer))
        {
    ...
    public static Vector getGunnersInShip(obj_id objShip)
    {
    ...
    public static obj_id[] getAllPlayersInShip(obj_id ship)
    {
    ...
    public static Vector getPassengers(obj_id objShip)
    {
    ...
    public static location getRandomLocationInSphere(location locStart, float fltMin, float fltMax)
    {
    ...
    public static Vector getShipOfficers(obj_id objShip)
    {
    ...
    public static obj_id getCommandExecutor(obj_id objShip)
    {
    ...
    public static obj_id getOperationsOfficer(obj_id objShip)
    {
    ...
    public static void destroyShipControlDevices(obj_id player, boolean verbose)
    {
        obj_id[] shipControlDevices = space_transition.findShipControlDevicesForPlayer(player);
    ...
    public static obj_id createShipControlDevice(obj_id player, String shipName, boolean verbose)
    {
    ...
    public static String getProperParkingLocation(obj_id objControlDevice)
    {
    ...
    public static obj_id createObjectTrackItemCount(String strItem, obj_id objContainer)
    {
    ...
    public static void openCommChannelAfterLoad(obj_id objShip, obj_id objTarget)
    {
        obj_id objPilot = getPilotId(objShip);
        if (isIdValid(objPilot))
        {
    ...
    public static obj_id[] getSpaceGroupMemberIds(obj_id group)
    {
        return utils.getLocalGroupMemberIds(group);
    }
    public static boolean playerCanControlShipSlot(obj_id ship, obj_id player, boolean sendSystemMessage)
    {
        boolean result = true;
    ...
    public static boolean isPobType(obj_id ship)
    {
        if (!isIdValid(ship))
        {
            return false;
    ...
    public static boolean isInPobShip(obj_id player)
    {
        return isPobType(getContainedBy(player));
    }
    public static boolean isNestedWithinPobShip(obj_id item)
    {
        if (!isIdValid(item))
        {
            return false;
    ...
    public static void setNpcToPlayerSpeed(obj_id player, obj_id npc, float speedPercent)
    {
        matchEngineSpeed(player, npc, speedPercent, false);
    }
    public static void matchEngineSpeed(obj_id player, obj_id npc, float speedPercent, boolean isMission)
    {
    ...
    public static boolean isPlayerShipAttackable(obj_id player)
    {
    ...
    public static boolean isHyperspacing(obj_id player)
    {
    ...
    public static boolean isHyperspaceBlocked(obj_id player)
    {
    ...
    public static void setHyperspaceBlock(obj_id player, int durationInSeconds, boolean abortActiveHyperspace)
    {
    ...
    public static void clearHyperspaceBlock(obj_id player)
    {
        if (utils.hasScriptVar(player, "hyperspaceBlock"))
        {
    ...
    public static void setComponentDisabled(obj_id ship, int slotId, boolean disabled)
    {
    ...
    public static obj_id getPilotForRealsies(obj_id ship)
    {
        obj_id pilot = getPilotId(ship);
        if (isIdValid(pilot))
        {
    ...
    public static String getSkillRequiredForShip(obj_id deed) {
