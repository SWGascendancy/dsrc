...
public class space_quest extends script.base_script
{
    ...
    public static boolean hasQuest(obj_id player)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static boolean hasQuest(obj_id player, String questType)
    {
        return (_getQuest(player, questType) != null);
    }
    public static obj_id _getQuest(obj_id player, String questType)
    {
        if (!isIdValid(player))
        {
            return null;
    ...
    public static boolean hasQuest(obj_id player, String questType, String questName)
    {
        return (_getQuest(player, questType, questName) != null);
    }
    public static obj_id _getQuest(obj_id player, String questType, String questName)
    {
        if (!isIdValid(player))
        {
            return null;
    ...
    public static boolean grantQuest(obj_id player, String questType, String questName)
    {
        return grantQuest(player, questType, questName, false, false);
    }
    public static boolean grantQuest(obj_id player, String questType, String questName, boolean splitQuest)
    {
        return grantQuest(player, questType, questName, splitQuest, false);
    }
    public static boolean grantQuest(obj_id player, String questType, String questName, boolean splitQuest, boolean ignoreDelay)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static boolean grantGroupQuest(obj_id player, String questType, String questName)
    {
        boolean result = grantQuest(player, questType, questName);
        flagGroupQuest(player, questType, questName);
        return result;
    }
    public static void flagGroupQuest(obj_id player, String questType, String questName)
    {
        if (group.isGrouped(player))
        {
    ...
    public static boolean isOnGroupQuest(obj_id player, String questType, String questName)
    {
        return utils.hasScriptVar(player, "group_space_quest." + questType + "." + questName);
    }
    public static boolean isOnThisGroupQuest(obj_id quest, obj_id player)
    {
    ...
    public static boolean flagQuestGroup(obj_id missionObj, int flag)
    {
    ...
    public static boolean canTakeGroupQuest(obj_id player, int minGroupSize)
    {
        if (group.isGrouped(player))
        {
            obj_id gid = getGroupObject(player);
    ...
    public static boolean hasCompletedQuest(obj_id player, String questType, String questName)
    {
        return hasObjVar(player, QUEST_STATUS + "." + questType + "." + questName);
    }
    public static boolean hasCompletedQuestRecursive(obj_id player, String questType, String questName)
    {
    ...
    public static boolean hasFailedQuest(obj_id player, String questType, String questName)
    {
        return _testQuestFlag(player, questType, questName, QUEST_FAILED);
    }
    public static boolean hasFailedQuestRecursive(obj_id player, String questType, String questName)
    {
        return _recursiveFlagTest(player, questType, questName, QUEST_FAILED);
    }
    public static boolean hasWonQuest(obj_id player, String questType, String questName)
    {
        return _testQuestFlag(player, questType, questName, QUEST_WON);
    }
    public static boolean hasWonQuestRecursive(obj_id player, String questType, String questName)
    {
        return _recursiveFlagTestLast(player, questType, questName, QUEST_WON);
    }
    public static boolean hasAbortedQuest(obj_id player, String questType, String questName)
    {
        return _testQuestFlag(player, questType, questName, QUEST_ABORTED);
    }
    public static boolean hasAbortedQuestRecursive(obj_id player, String questType, String questName)
    {
        return _recursiveFlagTest(player, questType, questName, QUEST_ABORTED);
    }
    public static boolean hasReceivedReward(obj_id player, String questType, String questName)
    {
        return _testQuestFlag(player, questType, questName, QUEST_RECEIVED_REWARD);
    }
    public static boolean _recursiveFlagTest(obj_id player, String questType, String questName, int flag)
    {
        int recNum = utils.getIntScriptVar(player, "recursiveCheck");
        recNum++;
        utils.setScriptVar(player, "recursiveCheck", recNum);
    ...
    public static boolean _recursiveFlagTestLast(obj_id player, String questType, String questName, int flag)
    {
        String qTable = "datatables/spacequest/" + questType + "/" + questName + ".iff";
        dictionary questInfo = dataTableGetRow(qTable, 0);
        if (questInfo == null)
    ...
    public static boolean setQuestFailed(obj_id player, obj_id missionObj)
    {
        return setQuestFailed(player, missionObj, true);
    }
    public static boolean setQuestFailed(obj_id player, obj_id missionObj, boolean canSplit)
    {
        String questName = getStringObjVar(missionObj, QUEST_NAME);
        String questType = getStringObjVar(missionObj, QUEST_TYPE);
    ...
    public static boolean setQuestWon(obj_id player, obj_id missionObj)
    {
        return setQuestWon(player, missionObj, true);
    }
    public static boolean setQuestWon(obj_id player, obj_id missionObj, boolean wsplit)
    {
        String questName = getStringObjVar(missionObj, QUEST_NAME);
        String questType = getStringObjVar(missionObj, QUEST_TYPE);
        dictionary webster = new dictionary();
    ...
    public static boolean setQuestAborted(obj_id player, obj_id missionObj)
    {
        String questName = getStringObjVar(missionObj, QUEST_NAME);
        String questType = getStringObjVar(missionObj, QUEST_TYPE);
        dictionary webster = new dictionary();
    ...
    public static boolean setSilentQuestAborted(obj_id player, obj_id missionObj)
    {
        String questName = getStringObjVar(missionObj, QUEST_NAME);
        String questType = getStringObjVar(missionObj, QUEST_TYPE);
        dictionary webster = new dictionary();
    ...
    public static boolean setQuestRewarded(obj_id player, String questType, String questName)
    {
        string_id title = new string_id("spacequest/" + questType + "/" + questName, "title");
    ...
    public static boolean _setQuestInProgress(obj_id quest)
    {
        return _setQuestInProgress(quest, false);
    }
    public static boolean _setQuestInProgress(obj_id quest, boolean music)
    {
    ...
    public static boolean isQuestInProgress(obj_id quest)
    {
        if (hasObjVar(quest, "in_progress"))
        {
            return true;
    ...
    public static void showQuestUpdate(obj_id quest, string_id update_id)
    {
        obj_id player = getObjIdObjVar(quest, QUEST_OWNER);
        String questName = getStringObjVar(quest, QUEST_NAME);
        prose_package pp;
    ...
    public static void showQuestUpdate(obj_id quest, string_id update_id, int count)
    {
        obj_id player = getObjIdObjVar(quest, QUEST_OWNER);
        String questName = getStringObjVar(quest, QUEST_NAME);
        prose_package pp;
    ...
    public static void showQuestAlert(obj_id player, string_id update_id)
    {
        prose_package pp = prose.getPackage(SID_QUEST_ALERT_S, update_id);
        sendQuestSystemMessage(player, pp);
        _groupNotify(player, pp);
    }
    public static void showEscortUpdate(obj_id quest, string_id update_id)
    {
        obj_id player = getObjIdObjVar(quest, QUEST_OWNER);
        String questName = getStringObjVar(quest, QUEST_NAME);
    ...
    public static void giveReward(obj_id player, String questType, String questName, int credits)
    {
        giveReward(player, questType, questName, credits, null);
    }
    public static void giveReward(obj_id player, String questType, String questName, int credits, String obj)
    {
    ...
    public static void clearQuestFlags(obj_id player, String questType, String questName)
    {
    ...
    public static int _getQuestId(String questName)
    {
        return dataTableSearchColumnForString(questName, 0, "datatables/player/quests.iff");
    }
    public static boolean _setupQuest(obj_id player, String questType, String questName, String qTable, boolean duty)
    {
    ...
    public static boolean _removeQuest(obj_id player, String questType, String questName)
    {
        obj_id missionObj = _getQuest(player, questType, questName);
        _removeQuest(player, missionObj);
        return true;
    }
    public static boolean _removeQuest(obj_id player, obj_id missionObj)
    {
        _removeMissionCriticalShips(player, missionObj);
        destroyObject(missionObj);
        return true;
    }
    public static boolean _hasDutyQuest(obj_id player)
    {
        obj_id datapad = utils.getPlayerDatapad(player);
        if (isIdValid(datapad))
        {
    ...
    public static int _getQuestStatus(obj_id player, String questType, String questName)
    {
        return getIntObjVar(player, QUEST_STATUS + "." + questType + "." + questName);
    }
    public static int _setQuestStatus(obj_id player, String questType, String questName, int flags)
    {
        setObjVar(player, QUEST_STATUS + "." + questType + "." + questName, flags);
        return flags;
    }
    public static boolean _testQuestFlag(obj_id player, String questType, String questName, int flag)
    {
    ...
    public static void _setQuestFlag(obj_id player, String questType, String questName, int flag)
    {
        int questStatus = _getQuestStatus(player, questType, questName);
        questStatus |= flag;
        _setQuestStatus(player, questType, questName, questStatus);
    }
    public static void _clearQuestFlag(obj_id player, String questType, String questName, int flag)
    {
        int questStatus = _getQuestStatus(player, questType, questName);
        questStatus = questStatus & ~flag;
        _setQuestStatus(player, questType, questName, questStatus);
    }
    public static boolean hasCompletedQuestSeries(obj_id player, String questSeries)
    {
        int flags = getIntObjVar(player, QUEST_STATUS_SERIES + "." + questSeries);
        return ((flags & QUEST_SERIES_COMPLETED) != 0);
    }
    public static void setQuestSeriesFlag(obj_id player, String questSeries, int flag)
    {
        int flags = getIntObjVar(player, QUEST_STATUS_SERIES + "." + questSeries);
        flags |= flag;
        setObjVar(player, QUEST_STATUS_SERIES + "." + questSeries, flags);
    }
    public static void clearQuestSeriesFlags(obj_id player, String questSeries)
    {
        removeObjVar(player, QUEST_STATUS_SERIES + "." + questSeries);
    }
    public static final String FAMILIARITY_LIST = "familiarity.";
    public static void setFamiliarity(obj_id player, String label, int value)
    {
        if (!isPlayer(player))
        {
            return;
    ...
    public static int getFamiliarity(obj_id player, String label)
    {
        return (getIntObjVar(player, FAMILIARITY_LIST + label));
    }
    public static int adjustFamiliarity(obj_id player, String label, int value)
    {
    ...
    public static void clearFamiliarity(obj_id player, String label)
    {
        removeObjVar(player, FAMILIARITY_LIST + label);
    }
    public static boolean isPlayerQualifiedForSkill(obj_id objPlayer, String strSkill)
    {
    ...
    public static transform getRandomPositionInSphere(transform trStartPosition, float fltMinRadius, float fltMaxRadius)
    {
    ...
    public static void cleanArray(obj_id quest, String objVar, String[] array)
    {
        if (array == null)
        {
            return;
    ...
    public static void cleanArray(obj_id quest, String objVar, int[] array)
    {
        if (array == null)
        {
            return;
    ...
    public static boolean hasShip(obj_id player)
    {
    ...
    public static boolean hasCertifiedShip(obj_id player)
    {
    ...
    public static boolean hasCertifiedNonNewbieShip(obj_id player)
    {
        if (!isIdValid(player) || !isPlayer(player))
        {
            return false;
    ...
    public static boolean canGrantNewbieShip(obj_id player)
    {
    ...
    public static void grantNewbieShip(obj_id player, String faction)
    {
    ...
    public static void _groupNotify(obj_id player, string_id mid, string_id s1)
    {
        if (group.isGrouped(player))
        {
            obj_id gid = getGroupObject(player);
    ...
    public static void _groupNotify(obj_id player, prose_package pp)
    {
        if (group.isGrouped(player))
        {
            obj_id gid = getGroupObject(player);
    ...
    public static void _groupNotify(obj_id player, string_id mid)
    {
        if (group.isGrouped(player))
        {
            obj_id gid = getGroupObject(player);
    ...
    public static void sendQuestMessage(obj_id player, prose_package pp)
    {
        sendQuestSystemMessage(player, pp);
        _groupNotify(player, pp);
    }
    public static void sendQuestMessage(obj_id player, string_id mid)
    {
        sendQuestSystemMessage(player, mid);
        _groupNotify(player, mid);
    }
    public static void groupTaunt(obj_id ship, obj_id player, prose_package pp)
    {
    ...
    public static void _removeQuestJournalEntry(obj_id player, String quest)
    {
    ...
    public static void _addMissionCriticalShip(obj_id player, obj_id quest, obj_id ship)
    {
        addMissionCriticalObject(player, ship);
    }
    public static void _removeMissionCriticalShip(obj_id player, obj_id quest, obj_id ship)
    {
        removeMissionCriticalObject(player, ship);
    }
    public static boolean _isMissionCriticalShip(obj_id player, obj_id quest, obj_id ship)
    {
        return isMissionCriticalObject(player, ship);
    }
    public static void _removeMissionCriticalShips(obj_id player, obj_id quest)
    {
        clearMissionCriticalObjects(player);
    }
    public static void _tauntShip(obj_id ship, obj_id target, prose_package pp)
    {
    ...
    public static void _tauntShips(obj_id ship, obj_id[] targets, prose_package pp)
    {
    ...
    public static void notifyMissions(obj_id player, String msg, dictionary params)
    {
        obj_id datapad = utils.getPlayerDatapad(player);
        if (isIdValid(datapad))
        {
    ...
    public static void cleanupOnUnload(obj_id player)
    {
        obj_id datapad = utils.getPlayerDatapad(player);
        if (isIdValid(datapad))
        {
    ...
    public static void recoveryCleanUpShips(obj_id quest)
    {
    ...
    public static obj_id findQuestLocation(obj_id quest, obj_id player, String navName, String type)
    {
