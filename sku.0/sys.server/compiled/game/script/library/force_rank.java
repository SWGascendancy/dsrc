...
public class force_rank extends script.base_script
{
    ...
    public static boolean addToForceRankSystem(obj_id player, int council)
    {
        if (!isIdValid(player))
        {
    ...
    public static boolean removeFromForceRankSystem(obj_id player, boolean surrendered)
    {
    ...
    public static int adjustForceRankXP(obj_id player, int amt)
    {
    ...
    public static boolean addExperienceDebt(obj_id enclave, String player_name, int xp_debt)
    {
    ...
    public static int spendForceRankXP(obj_id player, int amt)
    {
        if (!isIdValid(player))
        {
    ...
    public static boolean promoteForceRank(obj_id player)
    {
        if (!isIdValid(player))
        {
    ...
    public static boolean demoteForceRank(obj_id player, int rank)
    {
        if (!isIdValid(player))
        {
    ...
    public static boolean demoteForceRank(obj_id enclave, String player_name, int rank)
    {
        if (!isIdValid(enclave))
        {
    ...
    public static boolean resetClusterData(obj_id enclave)
    {
    ...
    public static boolean renameRankMember(obj_id player, String old_name)
    {
        if (old_name == null)
        {
    ...
    public static boolean removeForceRankSkills(obj_id player, int rank)
    {
    ...
    public static boolean resyncForceRankSkills(obj_id player)
    {
        if (!isIdValid(player))
        {
            LOG("force_rank", "force_rank.removeForceRankSkills -- player is invalid.");
    ...
    public static boolean performEnclaveMaintenance(obj_id enclave)
    {
        if (!isIdValid(enclave))
        {
    ...
    public static boolean checkVotingResults(obj_id enclave)
    {
    ...
    public static boolean checkChallengeVotingResults(obj_id enclave)
    {
    ...
    public static boolean checkMissedVotes(obj_id enclave, int rank)
    {
        if (!isIdValid(enclave))
        {
    ...
    public static int getVoteStatus(obj_id enclave, int rank)
    {
        if (!isIdValid(enclave))
        {
    ...
    public static int getVoteEndTime(obj_id enclave, int rank)
    {
        if (!isIdValid(enclave))
        {
    ...
    public static boolean isVoteTimeExpired(obj_id enclave, int rank)
    {
        if (!isIdValid(enclave))
        {
    ...
    public static int getChallengeVoteStatus(obj_id terminal, String challenged)
    {
        if (!isIdValid(terminal))
        {
    ...
    public static int getChallengeVoteEndTime(obj_id terminal, String challenged)
    {
        if (!isIdValid(terminal))
        {
            LOG("force_rank", "force_rank.getVoteEndTime -- enclave is invalid.");
    ...
    public static boolean isChallengeVoteTimeExpired(obj_id terminal, String challenged)
    {
        if (!isIdValid(terminal))
        {
    ...
    public static int getChallengeVoteRank(obj_id terminal, String challenged)
    {
        if (!isIdValid(terminal))
        {
    ...
    public static int[] getChallengeVotes(obj_id terminal, String challenged)
    {
        if (!isIdValid(terminal))
        {
    ...
    public static String[] getChallengeVoteList(obj_id terminal)
    {
        if (!isIdValid(terminal))
        {
    ...
    public static int getNumChallengeVoteList(obj_id terminal)
    {
        if (!isIdValid(terminal))
        {
    ...
    public static String[] getRankPetitioners(obj_id enclave, int rank)
    {
        if (!isIdValid(enclave))
        {
    ...
    public static Vector getRankPetitionersResizeable(obj_id enclave, int rank)
    {
        if (!isIdValid(enclave))
        {
    ...
    public static int[] getRankPetitionerVotes(obj_id enclave, int rank)
    {
        if (!isIdValid(enclave))
        {
            LOG("force_rank", "force_rank.getRankPetitioners -- enclave is invalid.");
    ...
    public static Vector getRankPetitionerVotesResizeable(obj_id enclave, int rank)
    {
        if (!isIdValid(enclave))
        {
    ...
    public static int[] getTopVotes(int[] votes, int winners)
    {
        if (votes == null)
        {
    ...
    public static String[] getVoteWinners(obj_id enclave, int rank)
    {
        if (!isIdValid(enclave))
        {
    ...
    public static obj_id getVotingTerminal(obj_id enclave)
    {
        if (!isIdValid(enclave))
        {
    ...
    public static obj_id getArenaTerminal(obj_id enclave)
    {
        if (!isIdValid(enclave))
        {
    ...
    public static obj_id getChallengeVotingTerminal(obj_id enclave)
    {
        if (!isIdValid(enclave))
        {
    ...
    public static boolean resetVotingTerminal(obj_id enclave, int rank)
    {
    ...
    public static boolean deductXpMaintenance(obj_id enclave)
    {
        if (!isIdValid(enclave))
        {
    ...
    public static boolean checkExperienceDebt(obj_id enclave)
    {
        if (!isIdValid(enclave))
        {
    ...
    public static boolean requestExperienceDebt(obj_id player)
    {
        if (!isIdValid(player))
        {
    ...
    public static int getExperienceDebt(obj_id enclave, String player_name)
    {
        if (!isIdValid(enclave))
        {
    ...
    public static boolean validateFRSPlayerData(obj_id player)
    {
        if (!isIdValid(player))
        {
    ...
    public static int getForceRank(obj_id player)
    {
        if (!isIdValid(player))
        {
    ...
    public static int getForceRank(obj_id enclave, String player_name)
    {
        if (!isIdValid(enclave))
        {
    ...
    public static int getForceTier(int rank)
    {
        if (rank < 0 || rank > 11)
        {
    ...
    public static obj_id getEnclave(obj_id player)
    {
        if (!isIdValid(player))
        {
    ...
    public static int getCouncilAffiliation(obj_id object)
    {
        if (!isIdValid(object))
        {
    ...
    public static String getCouncilName(int council)
    {
    ...
    public static int getAvailableRankSlots(obj_id enclave, int rank)
    {
        if (!isIdValid(enclave))
        {
    ...
    public static String getForceRankSkill(int rank, int council)
    {
        if (council != LIGHT_COUNCIL && council != DARK_COUNCIL)
        {
    ...
    public static int getForceSkillRank(String skill, int council)
    {
        if (skill == null)
        {
    ...
    public static int getForceRankNumSlots(int rank)
    {
    ...
    public static int getForceRankMinXp(int rank)
    {
        int index = dataTableSearchColumnForInt(rank, "rank", FRS_DATATABLE);
        if (index == -1)
        {
    ...
    public static int getVotesForPlayer(obj_id player, obj_id enclave)
    {
    ...
    public static void setVotesForPlayer(obj_id player, int numVotes, obj_id enclave)
    {
    ...
    public static Vector getAllPlayerNamesInForceRank(obj_id enclave)
    {
    ...
    public static obj_id[] getAllPlayersInForceRank(obj_id enclave, int rank)
    {
    ...
    public static int getVoteWeight(int voter_rank, int promotion_rank)
    {
        if (voter_rank < 1)
        {
            return -1;
    ...
    public static int getChallengeVoteWeight(int voter_rank, int challenge_rank)
    {
        if (voter_rank < 1)
        {
            return -1;
    ...
    public static String[] getPlayersInForceRank(obj_id enclave, int rank)
    {
        if (!isIdValid(enclave))
        {
    ...
    public static Vector getPlayersInForceRankResizeable(obj_id enclave, int rank)
    {
        if (!isIdValid(enclave))
        {
            LOG("force_rank", "force_rank.getPlayersInForceRank -- enclave is invalid.");
    ...
    public static boolean getPlayersInForceRank(obj_id source, int rank, int council, String handler)
    {
        if (!isIdValid(source))
        {
    ...
    public static boolean isPlayerEligibleForPromotion(obj_id player, int rank)
    {
        if (!isIdValid(player))
        {
    ...
    public static boolean getEnclaveObjId(obj_id source, int council, String handler)
    {
        if (!isIdValid(source))
        {
    ...
    public static Vector getRankMembersFromDictionary(dictionary enclave_data, int rank)
    {
    ...
    public static String[] getPvpBoardNames(obj_id enclave)
    {
        if (!isIdValid(enclave))
        {
    ...
    public static int[] getPvpBoardRatings(obj_id enclave)
    {
        if (!isIdValid(enclave))
        {
    ...
    public static int getPvpRankingForPlayer(obj_id enclave, String player_name)
    {
        if (!isIdValid(enclave))
        {
    ...
    public static boolean getPvpBoardRatings(obj_id source, int council, String handler)
    {
        if (!isIdValid(source))
        {
            LOG("force_rank", "force_rank.getPlayersInForceRank -- source is invalid.");
    ...
    public static boolean updatePvpBoardData(obj_id player, int rating, int council, String handler)
    {
        if (!isIdValid(player))
        {
    ...
    public static dictionary adjustPvpBoardRankings(obj_id player, int player_rating, dictionary enclave_data)
    {
        if (!isIdValid(player))
        {
    ...
    public static boolean sendRankMail(obj_id enclave, int rank, string_id subject, prose_package body)
    {
    ...
    public static boolean sendVoterMail(obj_id enclave, int rank, string_id subject, prose_package body)
    {
        if (!isIdValid(enclave))
        {
    ...
    public static boolean sendChallengeVoterMail(obj_id enclave, int rank, string_id subject, prose_package body)
    {
        if (!isIdValid(enclave))
        {
    ...
    public static boolean resetEnclaveData(obj_id enclave)
    {
    ...
    public static boolean replaceEnclaveClusterData(obj_id enclave, int lock_key)
    {
    ...
    public static boolean updateEnclaveClusterData(obj_id enclave, dictionary enclave_data)
    {
    ...
    public static boolean backupEnclaveData(obj_id enclave)
    {
        if (!isIdValid(enclave))
        {
    ...
    public static boolean restoreEnclaveData(obj_id enclave)
    {
        if (!isIdValid(enclave))
        {
    ...
    public static boolean logEnclaveData(obj_id enclave)
    {
        if (!isIdValid(enclave))
        {
    ...
    public static dictionary removeExtraSlotFromRankList(dictionary enclave_data, int rank)
    {
        if (enclave_data == null)
        {
    ...
    public static boolean grantRankItems(obj_id player, boolean retroactive)
    {
        return false;
    }
    public static boolean grantRankItems(obj_id player)
    {
        return grantRankItems(player, false);
    }
    public static boolean performFRSAttack(obj_id player, obj_id defender, hit_result results, weapon_data weapondat)
    {
        if (!isIdValid(player))
        {
    ...
    public static boolean performFRSAttackEnvy(obj_id player, obj_id defender, obj_id weapon, int damage, int rating)
    {
        if (!isJedi(player))
        {
            return false;
    ...
    public static boolean performFRSAttackSuffering(obj_id player, obj_id defender, obj_id weapon, int damage, int rating)
    {
        if (isJedi(defender))
        {
    ...
    public static boolean performFRSAttackVengeance(obj_id player, obj_id defender, int damage, int rating)
    {
        playClientEffectLoc(player, "clienteffect/frs_dark_vengeance.cef", getLocation(defender), 1.5f);
        return true;
    }
    public static boolean performFRSAttackVigilance(obj_id player, obj_id defender, obj_id weapon, int damage, int rating)
    {
        if (!isJedi(player))
        {
            return false;
    ...
    public static boolean performFRSAttackWisdom(obj_id player, obj_id defender, obj_id weapon, int damage, int rating)
    {
        if (isJedi(defender))
        {
            if (getForcePower(defender) > 0)
    ...
    public static boolean performFRSAttackSerenity(obj_id player, obj_id defender, int damage, int rating)
    {
    ...
    public static void handleCondemnedPlayerDeath(obj_id darkEnclave, dictionary params)
    {
    ...
    public static void moveEnclavedPlayerToNeutralCell(obj_id player)
    {
    ...
    public static String getEnclaveAligmentString(obj_id enclave)
    {
        if (DEBUGGING)
        {
            return "test";
    ...
    public static void updateAllRoomPermissions(obj_id enclave)
    {
    ...
    public static Vector playerNamesToIds(String[] playerNames)
    {
    ...
    public static void adjustPermissionListForRoom(obj_id enclave, String cellName, int[] allowedRanks)
    {
    ...
    public static void setAllCellsPrivate(obj_id enclave)
    {
    ...
    public static void clearCellBanList(obj_id cell)
    {
    ...
    public static void clearCellAllowList(obj_id cell)
    {
    ...
    public static void setCommonsRoomsToPublic(obj_id enclave)
    {
        String alignment = getEnclaveAligmentString(enclave);
        if (alignment == null || alignment.length() < 1)
        {
    ...
    public static boolean checkCellPermission(obj_id item, obj_id cell, boolean silent)
    {
        if (isGod(item))
        {
    ...
    public static void setCellScripts(obj_id enclave)
    {
        String[] enclaveRooms = getCellNames(enclave);
        obj_id cellId = null;
        for (int i = 0; i < enclaveRooms.length; i++)
    ...
    public static void makeAllCellsPublic(obj_id enclave)
    {
        String[] enclaveRooms = getCellNames(enclave);
        obj_id cellId = null;
        for (int i = 0; i < enclaveRooms.length; i++)
    ...
    public static void refreshAllRoomPermissions(obj_id enclave)
    {
        setAllCellsPrivate(enclave);
        setCommonsRoomsToPublic(enclave);
        updateAllRoomPermissions(enclave);
    }
    public static void makePlayersPermaEnemies(obj_id player1, obj_id player2)
    {
    ...
    public static void makePlayersPermaFriends(obj_id player1, obj_id player2)
    {
    ...
    public static void makePlayerEnemyOfGroup(obj_id player, obj_id[] enemyGroup)
    {
        if (enemyGroup == null)
        {
            return;
    ...
    public static void makePlayerFriendsWithGroup(obj_id player, obj_id[] friendGroup)
    {
        if (friendGroup == null)
        {
            return;
    ...
    public static void makePlayerGroupsEnemies(obj_id[] group1, obj_id[] group2)
    {
    ...
    public static dictionary packageActionData(Vector initz, Vector victz, Vector startz)
    {
        dictionary d = new dictionary();
    ...
    public static void setPvPActionData(dictionary data, String pvpAction, obj_id darkEnclave)
    {
    ...
    public static dictionary getAndValidatePvPActionData(String pvpAction, obj_id darkEnclave)
    {
        if (getCouncilAffiliation(darkEnclave) != DARK_COUNCIL)
        {
    ...
    public static dictionary validatePvPActionData(dictionary data)
    {
        if (data == null)
        {
            return null;
    ...
    public static void deleteExpiredPvPActions(obj_id darkEnclave)
    {
        Vector initiatorz = new Vector();
        initiatorz.setSize(0);
        Vector victimz = new Vector();
    ...
    public static void demoteDeadPlayerToRankZero(obj_id player, obj_id darkEnclave)
    {
    ...
    public static boolean _clearPvPActionDataForPlayer(obj_id player, String[] whichLists, String pvpAction, obj_id darkEnclave)
    {
    ...
    public static boolean isPartOfSameVendetta(obj_id player1, obj_id player2, dictionary vendettaData)
    {
        Vector initiatorz = new Vector();
        initiatorz.setSize(0);
    ...
    public static boolean isPvPActionInitiator(obj_id player, dictionary actionData1)
    {
    ...
    public static boolean isPvPActionVictim(obj_id player, dictionary actionData2)
    {
    ...
    public static boolean isPartOfPvPAction(obj_id player, obj_id darkEnclave, dictionary actionData3)
    {
        return (isPvPActionInitiator(player, actionData3) || isPvPActionVictim(player, actionData3));
    }
    public static boolean bothArePartOfSameSuddenDeathRank(obj_id player1, obj_id player2, obj_id darkEnclave, dictionary suddenDeathData)
    {
    ...
    public static boolean _initiateCouncilPurge(obj_id darkEnclave, obj_id purger)
    {
    ...
    public static boolean startPvPAction(obj_id initiator, Vector allVictims, String pvpAction, obj_id darkEnclave)
    {
    ...
    public static void notifyPlayerOfPvPActionStart(obj_id theInitiator, String pvpAction, Vector actionTargets, Vector msgRecipients, obj_id darkEnclave)
    {
    ...
    public static void notifyPlayerOfPvPActionEnd(obj_id killer, String pvpAction, Vector peaceTargets, Vector msgRecipients, boolean actionTimedOut)
    {
    ...
    public static obj_id[] getMyVendettaEnemies(dictionary vendettaData, obj_id player)
    {
        Vector initiatorz = new Vector();
        initiatorz.setSize(0);
        Vector victimz = new Vector();
    ...
    public static obj_id[] getMySuddenDeathEnemies(dictionary suddenDeathData, obj_id player, obj_id darkEnclave)
    {
    ...
    public static obj_id[] getEnemiesForPvPAction(obj_id player, String pvpAction, obj_id darkEnclave)
    {
        dictionary data = getAndValidatePvPActionData(pvpAction, darkEnclave);
        if (data == null)
        {
    ...
    public static void requestPEFs(obj_id player)
    {
        if (!hasObjVar(player, VAR_MY_ENCLAVE_ID))
        {
            getEnclaveObjId(player, getCouncilAffiliation(player), "enclaveIdResponse");
    ...
    public static obj_id[] getCurrentDarkJediEnemies(obj_id player, obj_id enclave)
    {
        Vector enemies = new Vector();
        enemies.setSize(0);
    ...
    public static boolean isForceRanked(obj_id player)
    {
        return (getForceRank(player) >= 0);
    }
    public static boolean canForceRankedPetEnterEnclave(obj_id pet, obj_id enclave)
    {
    ...
    public static boolean isPlayersEnclave(obj_id enclave, obj_id player)
    {
    ...
    public static boolean createEnclaveTerminals(obj_id enclave)
    {
        if (!isIdValid(enclave))
        {
    ...
    public static int getPetitionInterval()
    {
    ...
    public static int getVoteInterval()
    {
    ...
    public static int getAcceptanceInterval()
    {
    ...
    public static int getDemotionInterval()
    {
    ...
    public static int getXpInterval()
    {
    ...
    public static boolean _updateForceRankData(obj_id source, int council, int data_mode, String params, String handler, boolean lock_data)
    {
        if (!isIdValid(source))
        {
