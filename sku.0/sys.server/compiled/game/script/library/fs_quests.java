...
public class fs_quests extends script.base_script
{
    ...
    public static void badgeLeadin(obj_id player)
    {
    ...
    public static void setDelay(obj_id player, int stage)
    {
    ...
    public static boolean checkDelay(obj_id player)
    {
    ...
    public static boolean isEndQuestEligible(obj_id player)
    {
        if (!isIdValid(player))
        {
    ...
    public static int getBranchesLearned(obj_id player)
    {
        if (!isIdValid(player))
        {
    ...
    public static String getBranchFromId(int id)
    {
        if (id < 0)
        {
    ...
    public static String getBranchFromSkill(String skill)
    {
        if (skill == null)
        {
    ...
    public static boolean hasUnlockedBranch(obj_id player, String branch)
    {
        if (!isIdValid(player))
        {
    ...
    public static boolean hasUnlockedBranch(obj_id player, int id)
    {
        if (!isIdValid(player))
        {
            LOG("force_sensitive", "fs_quests.hasUnlockedBranch -- player is invalid");
    ...
    public static boolean unlockBranch(obj_id player, String branch)
    {
        int branches_unlocked = 0;
        if (hasObjVar(player, VAR_BRANCHES_UNLOCKED))
        {
    ...
    public static boolean setQuestAccepted(obj_id player)
    {
        if (!isIdValid(player))
        {
    ...
    public static boolean setQuestCompleted(obj_id player, String questName)
    {
        if (!isIdValid(player))
        {
    ...
    public static boolean hasQuestCompleted(obj_id player)
    {
        if (!isIdValid(player))
        {
    ...
    public static boolean hasQuestAccepted(obj_id player)
    {
        if (!isIdValid(player))
        {
    ...
    public static boolean hasFreeUnlockBranches(obj_id player)
    {
    ...
    public static int getFreeUnlockBranches(obj_id player)
    {
        if (!isIdValid(player))
        {
    ...
    public static boolean showBranchUnlockSUI(obj_id player)
    {
        if (!isIdValid(player))
        {
    ...
    public static boolean isValidLocationForEncounter(location loc)
    {
    ...
    public static boolean canBeginEncounter(obj_id player)
    {
    ...
    public static void advanceStage(obj_id player)
    {
    ...
    public static void decreaseStage(obj_id player)
    {
        int stage = getIntObjVar(player, "fs_kickoff_stage");
        int nextStage = stage - 1;
        setObjVar(player, "fs_kickoff_stage", nextStage);
    ...
    public static void setStage(obj_id player, int stage)
    {
        setObjVar(player, "fs_kickoff_stage", stage);
        return;
    }
    public static void oldManDepart(obj_id player, obj_id npc, int flag)
    {
    ...
    public static boolean clearFSData(obj_id player)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static boolean resetFSTask(obj_id player, obj_id owner)
    {
        if (!isIdValid(player))
        {
    ...
    public static boolean unlockBranchSUI(obj_id player, obj_id owner)
    {
        if (!isIdValid(player))
        {
