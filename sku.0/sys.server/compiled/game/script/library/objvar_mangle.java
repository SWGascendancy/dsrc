...
public class objvar_mangle extends script.base_script
{
    ...
    public static int[] getMangledIntArrayObjVar(obj_id self, String varName)
    {
    ...
    public static void setMangledIntArrayObjVar(obj_id self, String varName, int[] values)
    {
    ...
    public static float[] getMangledFloatArrayObjVar(obj_id self, String varName)
    {
        if (hasObjVar(self, varName))
        {
    ...
    public static void setMangledFloatArrayObjVar(obj_id self, String varName, float[] values)
    {
        removeObjVar(self, varName);
        removeObjVar(self, varName + "_mangled.segment");
        setObjVar(self, varName + "_mangled.count", values.length);
    ...
    public static String[] getMangledStringArrayObjVar(obj_id self, String varName)
    {
        if (hasObjVar(self, varName))
        {
    ...
    public static String[] getBrokenMangledStringArrayObjVar(obj_id self, String varName)
    {
        if (hasObjVar(self, varName))
        {
            return getStringArrayObjVar(self, varName);
    ...
    public static void setMangledStringArrayObjVar(obj_id self, String varName, String[] values)
    {
        removeObjVar(self, varName);
        removeObjVar(self, varName + "_mangled.segment");
        setObjVar(self, varName + "_mangled.count", values.length);
    ...
    public static obj_id[] getMangledObjIdArrayObjVar(obj_id self, String varName)
    {
        if (hasObjVar(self, varName))
        {
    ...
    public static void setMangledObjIdArrayObjVar(obj_id self, String varName, obj_id[] values)
    {
        removeObjVar(self, varName);
        removeObjVar(self, varName + "_mangled.segment");
        setObjVar(self, varName + "_mangled.count", values.length);
