...
public class quests extends script.base_script
{
    ...
    public static void setQuestStatus(obj_id player, String questId, int questStatus)
    {
    ...
    public static boolean hasQuest(obj_id player, String QUEST_ID)
    {
        return getQuestStatus(player, QUEST_ID) == IS_ON_QUEST;
    }
    public static void removeQuestStatus(obj_id player, String questId)
    {
        removeObjVar(player, "themeparkQuestFlags." + questId);
        clearAllWaypoints(player, questId);
        removeObjVar(player, questId);
    }
    public static int getQuestStatus(obj_id player, String questId)
    {
    ...
    public static void completeQuest(obj_id player, String questId)
    {
        setQuestStatus(player, questId, quests.COMPLETED_QUEST);
    }
    public static boolean hasCompletedQuest(obj_id player, String questId)
    {
        return (getQuestStatus(player, questId) == quests.COMPLETED_QUEST);
    }
    public static void setQuestFlag(obj_id player, String questId, String flagname, int value)
    {
        setObjVar(player, questId + ".Flags." + flagname, value);
    }
    public static int getQuestFlag(obj_id player, String questId, String flagname)
    {
    ...
    public static void removeQuestFlag(obj_id player, String questId, String flagname)
    {
    ...
    public static boolean canInfiltrate(obj_id player, String questId)
    {
        return hasObjVar(player, "themeparkQuestFlags.INFILTRATION." + questId);
    }
    public static void setInfiltrateFlag(obj_id player, String questId, int canInfiltrate)
    {
    ...
    public static void removeInfiltrateFlag(obj_id player, String questId)
    {
        removeObjVar(player, "themeparkQuestFlags.INFILTRATION." + questId);
    }
    public static int getInfiltrateFlag(obj_id player, String questId)
    {
        return getIntObjVar(player, "themeparkQuestFlags.INFILTRATION." + questId);
    }
    public static obj_id addQuestLocationTarget(obj_id player, String questId, String name, location loc, float radius)
    {
    ...
    public static obj_id addThemeParkWaypoint(obj_id player, String questId, String name, location loc, float radius, String display, String file, String entry)
    {
        addLocationTarget(name, loc, radius);
        obj_id waypoint = createWaypointInDatapad(player, loc);
        setWaypointActive(waypoint, true);
    ...
    public static void clearQuestLocationTarget(obj_id player, String questId, String name)
    {
    ...
    public static void clearAllWaypoints(obj_id player, String questId)
    {
    ...
    public static obj_id spawnAttacker(String msgHandlerName, String template, location loc, obj_id target)
    {
    ...
    public static obj_id spawnAttacker(String template, location loc, obj_id target)
    {
        return createObject(template, loc);
    }
    public static obj_id[] spawnAttackers(String msgHandlerName, int number, String template, location loc, obj_id target)
    {
    ...
    public static obj_id[] spawnAttackers(int number, String template, location loc, obj_id target)
    {
        obj_id[] attackers = new obj_id[number];
        location newloc;
        for (int i = 0; i < number; i++)
    ...
    public static location chooseNearbyLocation(obj_id self)
    {
    ...
    public static location getTargetLocation(obj_id self)
    {
    ...
    public static String getConvoType(obj_id self)
    {
        String convoType;
    ...
    public static String getDataTableName(obj_id self)
    {
        String datatable;
        String type = "businessman";
        if (!checkForSerendipity(self))
    ...
    public static String getType(obj_id self)
    {
        String type = "businessman";
        if (!checkForSerendipity(self))
        {
    ...
    public static boolean checkForSerendipity(obj_id self)
    {
    ...
    public static boolean checkForItem(obj_id inv)
    {
    ...
    public static location getThemeParkLocation(obj_id self)
    {
        location target = null;
    ...
    public static void giveThemeParkReward(obj_id self, obj_id player, int questNum)
    {
    ...
    public static int getQuestId(String questName)
    {
        return dataTableSearchColumnForString(questName, 0, "datatables/player/quests.iff");
    }
    public static String getParentQuestName(String questName)
    {
    ...
    public static boolean isComplete(String questName, obj_id player)
    {
        return isQuestComplete(player, getQuestId(questName));
    }
    public static boolean canActivate(String questName, obj_id player)
    {
    ...
    public static boolean isActive(String questName, obj_id player)
    {
        boolean result = false;
        int questRow = getQuestId(questName);
        if (questRow > -1)
    ...
    public static void activate(String questName, obj_id player, obj_id questGiver)
    {
        if (questName == null)
        {
            return;
    ...
    public static void complete(String questName, obj_id player, boolean succeeded)
    {
    ...
    public static void deactivate(String questName, obj_id player)
    {
        String datatable = "datatables/player/quests.iff";
        int questRow = getQuestId(questName);
        if (questRow > -1)
    ...
    public static String[] getActiveQuestsWithScript(String scriptName, obj_id player)
    {
    ...
    public static String getDataEntry(String questName, String columnName)
    {
        String result = null;
        int questRow = getQuestId(questName);
        if (questRow > -1)
    ...
    public static String getDataEntry(int questId, String columnName)
    {
        String result = null;
        if (questId > -1)
        {
    ...
    public static location getTheaterLocationTarget(obj_id self, int questRow)
    {
    ...
    public static location getLocationTarget(obj_id self, int questRow)
    {
        location result = null;
        String questName = quests.getDataEntry(questRow, "NAME");
    ...
    public static boolean isMyQuest(int questRow, String scriptName)
    {
        boolean result = false;
    ...
    public static obj_id getTargetForQuest(obj_id self, String questName)
    {
    ...
    public static int getQuestIdForTarget(obj_id self, obj_id target)
    {
        int result = -1;
    ...
    public static boolean doEncounterSpawn(obj_id self, int questRow)
    {
    ...
    public static obj_id createSpawner(String spawner, location loc, String datatable)
    {
        return createSpawner(spawner, loc, datatable, null);
    }
    public static obj_id createSpawner(String spawner, location loc, String datatable, obj_id parent)
    {
    ...
    public static obj_id getQuestGiver(String questName, obj_id player)
    {
        obj_id result = null;
        String objvarname = "questlib." + questName + ".quest_giver";
        if (hasObjVar(player, objvarname))
    ...
    public static obj_id getQuestGiver(int questRow, obj_id player)
    {
        return getQuestGiver(getDataEntry(questRow, "NAME"), player);
    }
    public static boolean safeHasObjVar(obj_id self, String objvarName)
    {
