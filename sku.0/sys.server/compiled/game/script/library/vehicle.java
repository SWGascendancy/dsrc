...
public class vehicle extends script.base_script
{
    ...
    public static int setValue(obj_id vehicle, float value, int var_index)
    {
    ...
    public static float getValue(obj_id vehicle, int var_index)
    {
        String vi_name = s_varInfoNames[var_index];
        float vi_conversion = s_varInfoConversions[var_index];
    ...
    public static void setMinimumSpeed(obj_id vehicle, float value)
    {
        setValue(vehicle, value, VAR_SPEED_MIN);
    }
    public static void setMaximumSpeed(obj_id vehicle, float value)
    {
        setValue(vehicle, value, VAR_SPEED_MAX);
    }
    public static void setTurnRateMin(obj_id vehicle, float value)
    {
        setValue(vehicle, value, VAR_TURN_RATE_MIN);
    }
    public static void setTurnRateMax(obj_id vehicle, float value)
    {
        setValue(vehicle, value, VAR_TURN_RATE_MAX);
    }
    public static void setAccelMin(obj_id vehicle, float value)
    {
        setValue(vehicle, value, VAR_ACCEL_MIN);
    }
    public static void setAccelMax(obj_id vehicle, float value)
    {
        setValue(vehicle, value, VAR_ACCEL_MAX);
    }
    public static void setDecel(obj_id vehicle, float value)
    {
        setValue(vehicle, value, VAR_DECEL);
    }
    public static void setDampingRoll(obj_id vehicle, float value)
    {
        setValue(vehicle, value, VAR_DAMP_ROLL);
    }
    public static void setDampingPitch(obj_id vehicle, float value)
    {
        setValue(vehicle, value, VAR_DAMP_PITCH);
    }
    public static void setDampingHeight(obj_id vehicle, float value)
    {
        setValue(vehicle, value, VAR_DAMP_HEIGHT);
    }
    public static void setGlide(obj_id vehicle, float value)
    {
        setValue(vehicle, value, VAR_GLIDE);
    }
    public static void setBankingAngle(obj_id vehicle, float value)
    {
        setValue(vehicle, value, VAR_BANKING);
    }
    public static void setHoverHeight(obj_id vehicle, float value)
    {
        setValue(vehicle, value, VAR_HOVER_HEIGHT);
    }
    public static void setAutoLevelling(obj_id vehicle, float value)
    {
        setValue(vehicle, value, VAR_AUTO_LEVEL);
    }
    public static void setStrafe(obj_id vehicle, boolean canStrafe)
    {
        float value = canStrafe ? 1.0f : 0.0f;
        setValue(vehicle, value, VAR_STRAFE);
    }
    public static float getMinimumSpeed(obj_id vehicle)
    {
        return getValue(vehicle, VAR_SPEED_MIN);
    }
    public static float getMaximumSpeed(obj_id vehicle)
    {
        return getValue(vehicle, VAR_SPEED_MAX);
    }
    public static float getTurnRateMin(obj_id vehicle)
    {
        return getValue(vehicle, VAR_TURN_RATE_MIN);
    }
    public static float getTurnRateMax(obj_id vehicle)
    {
        return getValue(vehicle, VAR_TURN_RATE_MAX);
    }
    public static float getAccelMin(obj_id vehicle)
    {
        return getValue(vehicle, VAR_ACCEL_MIN);
    }
    public static float getAccelMax(obj_id vehicle)
    {
        return getValue(vehicle, VAR_ACCEL_MAX);
    }
    public static float getDecel(obj_id vehicle)
    {
        return getValue(vehicle, VAR_DECEL);
    }
    public static float getDampingRoll(obj_id vehicle)
    {
        return getValue(vehicle, VAR_DAMP_ROLL);
    }
    public static float getDampingPitch(obj_id vehicle)
    {
        return getValue(vehicle, VAR_DAMP_PITCH);
    }
    public static float getDampingHeight(obj_id vehicle)
    {
        return getValue(vehicle, VAR_DAMP_HEIGHT);
    }
    public static float getGlide(obj_id vehicle)
    {
        return getValue(vehicle, VAR_GLIDE);
    }
    public static float getBankingAngle(obj_id vehicle)
    {
        return getValue(vehicle, VAR_BANKING);
    }
    public static float getHoverHeight(obj_id vehicle)
    {
        return getValue(vehicle, VAR_HOVER_HEIGHT);
    }
    public static float getAutoLevelling(obj_id vehicle)
    {
        return getValue(vehicle, VAR_AUTO_LEVEL);
    }
    public static boolean getStrafe(obj_id vehicle)
    {
        return getValue(vehicle, VAR_STRAFE) > 0.0f;
    }
    public static boolean isRidingVehicle(obj_id objPlayer) {
        if (!isMob(objPlayer)) {
            return false;
        }
    ...
    public static boolean isRidingBattlefieldVehicle(obj_id objPlayer) {
        obj_id objMount = getMountId(objPlayer);
        return isIdValid(objMount) && isBattlefieldVehicle(objMount);
    }
    public static boolean isDriveableVehicle(obj_id objThing)
    {
        return hasScript(objThing, "systems.vehicle_system.vehicle_base");
    }
    public static boolean isVehicle(obj_id obj)
    {
        return isGameObjectTypeOf(getGameObjectType(obj), GOT_vehicle);
    }
    public static boolean isBattlefieldVehicle(obj_id obj)
    {
    ...
    public static void doTempMaxSpeedReduction(obj_id vehicle, float factor, float duration)
    {
    ...
    public static boolean repairVehicle(obj_id player, obj_id vehicle)
    {
    ...
    public static int getVehicleRepairCost(obj_id vehicle)
    {
    ...
    public static float getVehicleRepairRate(obj_id vehicle)
    {
        if (!isIdValid(vehicle))
        {
            return -1f;
    ...
    public static void decayVehicle(obj_id vehicle)
    {
        if (!isIdValid(vehicle))
        {
            return;
    ...
    public static float getVehicleDecayRate(obj_id vehicle)
    {
        if (!isIdValid(vehicle))
        {
            return -1f;
    ...
    public static boolean isInValidCallState(obj_id player)
    {
    ...
    public static boolean storeVehicle(obj_id vehicleControlDevice, obj_id player)
    {
        return storeVehicle(vehicleControlDevice, player, true);
    }
    public static boolean storeVehicle(obj_id vehicleControlDevice, obj_id player, boolean checkCombat)
    {
    ...
    public static void setTimeStored(obj_id PCD)
    {
        setObjVar(PCD, "pet.timeStored", getGameTime());
    }
    public static void storeAllVehicles(obj_id master)
    {
    ...
    public static boolean hasMaxStoredVehicles(obj_id player)
    {
        return callable.hasMaxStoredRideables(player);
    }
    public static void reHueVehicle(obj_id vehicleControlDevice, obj_id vehicle)
    {
    ...
    public static void saveVehicleInfo(obj_id vehicleControlDevice, obj_id vehicle)
    {
    ...
    public static void restoreCustomization(obj_id vehicle, obj_id vehicleControlDevice)
    {
    ...
    public static void storeDamage(obj_id vcd, int currentHP, int penalty)
    {
        if (!isIdValid(vcd))
        {
            return;
    ...
    public static void initializeVehicle(obj_id vehicle)
    {
        initializeVehicle(vehicle, null);
    }
    public static void initializeVehicle(obj_id vehicle, obj_id player)
    {
        if (!isIdValid(player))
        {
            player = vehicle;
    ...
    public static boolean mountPermissionCheck(obj_id vehicle, obj_id rider, boolean verbose)
    {
    ...
    public static void restoreVehicle(obj_id player, obj_id vehicle)
    {
    ...
    public static boolean isJetPack(obj_id vehicleControlDevice)
    {
    ...
    public static boolean isJetPackVehicle(obj_id vehicle)
    {
    ...
    public static boolean isJetPackTemplate(String template)
    {
    ...
    public static void applyVehicleBuffs(obj_id player, obj_id vehicle)
    {
    ...
    public static boolean canRepairDisabledVehicle(obj_id controlDevice)
    {
        String ref = getVehicleReference(controlDevice);
        if (ref == null || ref.equals(""))
        {
    ...
    public static boolean checkForMountAndDismountPlayer(obj_id player)
    {
    ...
    public static boolean turnVehicleIntoSchem(obj_id player, obj_id vehiclePCD)
    {
    ...
    public static obj_id[] findVehicleControlDevicesForPlayer(obj_id player)
    {
        return findVehicleControlDevicesForPlayer(player, false);
    }
    public static obj_id[] findVehicleControlDevicesForPlayer(obj_id player, boolean includeHangerSlot)
    {
    ...
    public static obj_id[] findVehicleControlDevicesInHangarSlot(obj_id player)
    {
