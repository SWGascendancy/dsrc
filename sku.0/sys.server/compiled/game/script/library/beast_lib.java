...
public class beast_lib extends script.base_script
{
    ...
    public static boolean isBeast(obj_id beast)
    {
    ...
    public static boolean isBeastMaster(obj_id player)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static boolean isValidBeast(obj_id beast)
    {
        if (!isIdValid(beast) || !exists(beast))
        {
            return false;
    ...
    public static boolean isValidBCD(obj_id bcd)
    {
    ...
    public static boolean isValidPlayer(obj_id player)
    {
    ...
    public static float getBeastScaleByLevel(obj_id beast)
    {
        if (!isIdValid(beast))
        {
            return 1.0f;
    ...
    public static obj_id getBCDPlayer(obj_id bcd)
    {
    ...
    public static void setBCDBeastCalled(obj_id bcd, obj_id beast)
    {
        if (!isValidBCD(bcd))
        {
            return;
    ...
    public static obj_id getBCDBeastCalled(obj_id bcd)
    {
        if (!isValidBCD(bcd))
        {
            return null;
    ...
    public static void setBeastOnPlayer(obj_id player, obj_id beast)
    {
        if (!isIdValid(player))
        {
            return;
    ...
    public static obj_id getBeastOnPlayer(obj_id player)
    {
        if (!isIdValid(player))
        {
            return null;
    ...
    public static boolean hasActiveBeast(obj_id player)
    {
    ...
    public static void setBCDBeastTimeStored(obj_id bcd, int time)
    {
        if (!isIdValid(bcd))
        {
            return;
    ...
    public static int getBCDBeastTimeStored(obj_id bcd)
    {
        if (!isIdValid(bcd))
        {
            return 0;
    ...
    public static void setBCDBeastCalledTime(obj_id bcd, int time)
    {
        if (!isIdValid(bcd))
        {
            return;
    ...
    public static int getBCDBeastCalledTime(obj_id bcd)
    {
        if (!isIdValid(bcd))
        {
            return 0;
    ...
    public static String getBeastLocalizedName(obj_id bcd)
    {
    ...
    public static void setBCDBeastName(obj_id bcd, String beastName)
    {
    ...
    public static boolean hasBCDBeastName(obj_id bcd)
    {
    ...
    public static String getBCDBeastName(obj_id bcd)
    {
    ...
    public static void setBeastName(obj_id beast, String beastName)
    {
    ...
    public static boolean hasBeastName(obj_id beast)
    {
        if (!isValidBeast(beast))
        {
            return false;
    ...
    public static String getBeastName(obj_id beast)
    {
        if (!isValidBeast(beast))
        {
            return null;
    ...
    public static void setBCDBeastType(obj_id bcd, String beastType)
    {
        if (!isIdValid(bcd))
        {
            return;
    ...
    public static String getBCDBeastType(obj_id bcd)
    {
        String beastType = "";
        if (hasObjVar(bcd, OBJVAR_BEAST_TYPE))
        {
    ...
    public static void setBeastType(obj_id beast, String template)
    {
    ...
    public static String getBeastType(obj_id beast)
    {
        if (!isIdValid(beast))
        {
            return "";
    ...
    public static void setBeastBCD(obj_id beast, obj_id bcd)
    {
        if (!isIdValid(beast))
        {
            return;
    ...
    public static obj_id getBeastBCD(obj_id beast)
    {
        if (!isIdValid(beast))
        {
            return null;
    ...
    public static void setBCDBeastLevel(obj_id bcd, int level)
    {
    ...
    public static int getBCDBeastLevel(obj_id bcd)
    {
        if (!isIdValid(bcd))
        {
            return -1;
    ...
    public static void setBeastLevel(obj_id beast, int level)
    {
    ...
    public static int getBeastLevel(obj_id beast)
    {
        if (!isIdValid(beast))
        {
            return -1;
    ...
    public static void setBCDBeastExperience(obj_id bcd, int exp)
    {
    ...
    public static int getBCDBeastExperience(obj_id bcd)
    {
        if (!isIdValid(bcd))
        {
            return -1;
    ...
    public static void setBeastExperience(obj_id beast, int exp)
    {
    ...
    public static int getBeastExperience(obj_id beast)
    {
        if (!isIdValid(beast))
        {
            return -1;
    ...
    public static void setBCDBeastHealth(obj_id bcd, int health)
    {
    ...
    public static int getBCDBeastHealth(obj_id bcd)
    {
        if (!isIdValid(bcd))
        {
            return -1;
    ...
    public static void setBCDBeastCanLevel(obj_id bcd, boolean canLevel)
    {
        if (!isIdValid(bcd))
        {
            return;
    ...
    public static boolean getBCDBeastCanLevel(obj_id bcd)
    {
        if (!isValidBCD(bcd))
        {
            return false;
    ...
    public static void setBeastCanLevel(obj_id beast, boolean canLevel)
    {
        if (!isIdValid(beast))
        {
            return;
    ...
    public static boolean getBeastCanLevel(obj_id beast)
    {
        if (!isValidBeast(beast))
        {
            return false;
    ...
    public static void setBCDBeastIsDead(obj_id bcd, boolean beastIsDead)
    {
        if (!isValidBCD(bcd))
        {
            return;
    ...
    public static boolean getBCDBeastIsDead(obj_id bcd)
    {
        if (!isIdValid(bcd))
        {
            return true;
    ...
    public static void setBCDBeastDefensive(obj_id bcd, obj_id player, boolean beastIsDefensive)
    {
        if (!isValidBCD(bcd))
        {
            return;
    ...
    public static boolean getBCDBeastDefensive(obj_id bcd)
    {
        if (!isValidBCD(bcd))
        {
            return false;
    ...
    public static void setBeastDefensive(obj_id beast, obj_id player, boolean beastIsDefensive)
    {
        if (!isValidBeast(beast))
        {
            return;
    ...
    public static boolean getBeastDefensive(obj_id beast)
    {
        if (!isValidBeast(beast))
        {
            return false;
    ...
    public static obj_id[] getDatapadBCDs(obj_id player)
    {
    ...
    public static int getTotalBeastControlDevices(obj_id player)
    {
        Vector datapadBCDs = new Vector();
        datapadBCDs.setSize(0);
        if (!isIdValid(player) || !exists(player))
    ...
    public static int getTotalBeastsCalled(obj_id player)
    {
        if (!isIdValid(player))
        {
            return 0;
    ...
    public static int getBCDBeastHappiness(obj_id bcd)
    {
        if (!isValidBCD(bcd))
        {
            return 0;
    ...
    public static void setBCDBeastHappiness(obj_id bcd, int happiness)
    {
        if (!isValidBCD(bcd))
        {
            return;
    ...
    public static boolean hasBCDBeastHappiness(obj_id bcd)
    {
        if (!isValidBCD(bcd))
        {
            return false;
    ...
    public static int getBeastHappiness(obj_id beast)
    {
        if (!isValidBeast(beast))
        {
            return 0;
    ...
    public static void setBeastHappiness(obj_id beast, int happiness)
    {
        if (!isValidBeast(beast))
        {
            return;
    ...
    public static float getBCDBeastLoyalty(obj_id bcd)
    {
        if (!isValidBCD(bcd))
        {
            return 0;
    ...
    public static void setBCDBeastLoyalty(obj_id bcd, float newLoyalty)
    {
        if (!isValidBCD(bcd))
        {
            return;
    ...
    public static boolean hasBCDBeastLoyalty(obj_id bcd)
    {
        if (!isValidBCD(bcd))
        {
            return false;
    ...
    public static float getBeastLoyalty(obj_id beast)
    {
        if (!isValidBeast(beast))
        {
            return 0;
    ...
    public static void setBeastLoyalty(obj_id beast, float newLoyalty)
    {
        if (!isValidBeast(beast))
        {
            return;
    ...
    public static int getBeastLoyaltyToNextLevelPercentage(obj_id beast)
    {
    ...
    public static void incrementBeastLoyalty(obj_id bcd)
    {
        if (!isValidBCD(bcd))
        {
            return;
    ...
    public static void decrementBeastLoyalty(obj_id bcd, float loyaltyDecrement)
    {
        if (!isValidBCD(bcd))
        {
            return;
    ...
    public static int getBCDBeastLoyaltyLevel(obj_id bcd)
    {
        if (!isValidBCD(bcd))
        {
            return 0;
    ...
    public static void setBCDBeastLoyaltyLevel(obj_id bcd, int newLevel)
    {
        if (!isValidBCD(bcd))
        {
            return;
    ...
    public static boolean hasBCDBeastLoyaltyLevel(obj_id bcd)
    {
        if (!isValidBCD(bcd))
        {
            return false;
    ...
    public static int getBeastLoyaltyLevel(obj_id beast)
    {
        if (!isValidBeast(beast))
        {
            return 0;
    ...
    public static void setBeastLoyaltyLevel(obj_id beast, int newLevel)
    {
        if (!isValidBeast(beast))
        {
            return;
    ...
    public static void incrementBeastLoyaltyLevel(obj_id bcd)
    {
        if (!isValidBCD(bcd))
        {
            return;
    ...
    public static void decrementBeastLoyaltyLevel(obj_id bcd)
    {
        if (!isValidBCD(bcd))
        {
            return;
    ...
    public static int[] getBCDBeastFood(obj_id bcd)
    {
        if (!isValidBCD(bcd))
        {
            return null;
    ...
    public static void setBCDBeastFood(obj_id bcd, int[] newFood)
    {
        if (!isValidBCD(bcd))
        {
            return;
    ...
    public static boolean hasBCDBeastFood(obj_id bcd)
    {
        if (!isValidBCD(bcd))
        {
            return false;
    ...
    public static int[] getBeastFood(obj_id beast)
    {
        if (!isValidBeast(beast))
        {
            return null;
    ...
    public static void setBeastFood(obj_id beast, int[] newFood)
    {
        if (!isValidBeast(beast))
        {
            return;
    ...
    public static int getBCDBeastLastFedTime(obj_id bcd)
    {
    ...
    public static void updateBeastHappiness(obj_id bcd, obj_id beast)
    {
    ...
    public static void setBeastLinks(obj_id player, obj_id bcd, obj_id beast)
    {
    ...
    public static void removeBeastLinks(obj_id player, obj_id bcd, obj_id beast)
    {
        if (!isIdValid(player) || !isIdValid(bcd) || !isIdValid(beast))
        {
            return;
    ...
    public static obj_id createBCDFromEgg(obj_id player, obj_id egg)
    {
        if (!isIdValid(player))
        {
            return null;
    ...
    public static String stripBmFromType(String beastType)
    {
    ...
    public static obj_id createBasicBeastFromObject(obj_id source)
    {
        location spawnLocation = getLocation(source);
        return createBasicBeastFromObject(source, spawnLocation);
    }
    public static obj_id createBasicBeastFromObject(obj_id source, location spawnLocation)
    {
        if (!isIdValid(source))
        {
            return null;
    ...
    public static obj_id createBasicBeastFromPlayer(obj_id player, obj_id bcd)
    {
        if (!isIdValid(player))
        {
            return null;
    ...
    public static obj_id createBeastFromBCD(obj_id player, obj_id bcd)
    {
    ...
    public static void initializeBeastScripts(obj_id beast)
    {
    ...
    public static void initializeBeastStats(obj_id bcd, obj_id beast)
    {
        if (!isValidBCD(bcd) || !isValidBeast(beast))
        {
            return;
    ...
    public static void storeBeast(obj_id bcd)
    {
        if (!isIdValid(bcd))
        {
            return;
    ...
    public static void storeBeastStats(obj_id bcd, obj_id beast)
    {
    ...
    public static void storeBeasts(obj_id player)
    {
        if (!isIdValid(player))
        {
            return;
    ...
    public static void killBeast(obj_id beast, obj_id killer)
    {
        if (!isValidBeast(beast))
        {
            return;
    ...
    public static void playerDeathStoreBeast(obj_id bcd)
    {
        if (!isIdValid(bcd))
        {
            return;
    ...
    public static void incrementBeastExperience(obj_id beast)
    {
        if (!isValidBeast(beast))
        {
            return;
		...
		if (buff.hasBuff(beast, "veteranPlayerBuff3"))
        {
            percentageBonuses += 0.01f * 100;
        }
        ...
        if (isValidPlayer(master))
        {
            ...
            int multiplier = utils.stringToInt(getConfigSetting("GameServer", "xpBeastMultiplier"));
            if (multiplier > 1)
            {
    ...
    public static void incrementBeastLevel(obj_id beast)
    {
        if (!isValidBeast(beast))
        {
            return;
    ...
    public static boolean canBeastLevelUp(obj_id beast)
    {
        if (!isValidBeast(beast))
        {
            return false;
    ...
    public static void grantBeastExperience(obj_id beast)
    {
    ...
    public static float scaleDistanceByLevel(obj_id beast, float distance)
    {
        int level = getLevel(beast);
        distance += (level / 45);
        return distance;
    }
    public static void validateFollowTarget(obj_id beast, obj_id target)
    {
    ...
    public static void doConfusedEmote(obj_id beast)
    {
        if (!isIdValid(beast))
        {
            return;
    ...
    public static void doStayCommand(obj_id beast, obj_id master)
    {
    ...
    public static void doFollowCommand(obj_id beast, obj_id master)
    {
        if (!isIdValid(beast) || !isIdValid(master))
        {
            return;
    ...
    public static void beastFollowTarget(obj_id beast, obj_id target)
    {
        follow(beast, target, scaleDistanceByLevel(beast, 0.1f), scaleDistanceByLevel(beast, 0.2f));
        setMovementRun(beast);
    }
    public static void doAttackCommand(obj_id beast, obj_id master)
    {
        if (!isIdValid(master))
        {
            return;
    ...
    public static void doTrickCommand(obj_id beast, int trickNumber)
    {
        int myPosture = getPosture(beast);
    ...
    public static void setupHappinessLoyalty(obj_id beastBCD)
    {
        if (!isIdValid(beastBCD))
        {
            return;
    ...
    public static boolean feedBeastUsingAutoFeeder(obj_id beast, obj_id player, String autoFeederBuffName)
    {
    ...
    public static String getBeastBuffItemVar(String buffName)
    {
        return "beastBuffItem." + buffName;
    }
    public static obj_id checkAutoFeederForBeastFood(obj_id autofeeder)
    {
    ...
    public static void applyFoodEffect(obj_id food, obj_id beast, obj_id player)
    {
        obj_id beastBCD = getBeastBCD(beast);
    ...
    public static void checkForFavoriteLocation(obj_id beastBCD)
    {
    ...
    public static int getSingleSkillMaxTrainingPoints(obj_id pet)
    {
    ...
    public static int getSingleSkillMaxTrainingPoints(obj_id bcd, int level)
    {
        int loyaltyLevel = getBCDBeastLoyaltyLevel(bcd);
        return loyaltyLevel * level;
    }
    public static int getMaxTrainingPoints(obj_id pet)
    {
        return getSingleSkillMaxTrainingPoints(pet) * 4;
    }
    public static int getAvailableTrainingPoints(obj_id pet)
    {
        return getAvailableTrainingPoints(pet, null);
    }
    public static int getAvailableTrainingPoints(obj_id pet, String passedAbility)
    {
        int spent = calculateTrainingPointsSpent(pet, passedAbility);
        int maximum = getMaxTrainingPoints(pet);
        return maximum - spent;
    }
    public static boolean hasSufficientTrainingPoints(obj_id pet, String ability)
    {
        int available = getAvailableTrainingPoints(pet, ability);
        return (getAbilityCost(ability) <= available);
    }
    public static boolean isValidForSingleSkillMaxCost(obj_id pet, String ability)
    {
    ...
    public static String[] getTrainedSkills(obj_id bcd)
    {
        if (!isIdValid(bcd) || !exists(bcd))
        {
            return null;
    ...
    public static String[] getAutoRepeatAbilityList(obj_id bcd)
    {
        if (isBeast(bcd))
        {
    ...
    public static void clearAutoRepeatAbiltiyList(obj_id bcd)
    {
        if (isBeast(bcd))
        {
            bcd = getBeastBCD(bcd);
    ...
    public static boolean isAbilityAutoRepeat(obj_id bcd, String abilityName)
    {
        if (isBeast(bcd))
        {
    ...
    public static String[] setAbilityAutoRepeat(obj_id bcd, String abilityName)
    {
        if (isBeast(bcd))
        {
    ...
    public static String[] unsetAbilityAutoRepeat(obj_id bcd, String abilityName)
    {
        if (isBeast(bcd))
        {
    ...
    public static String getBestAutoRepeatAbility(obj_id beast)
    {
    ...
    public static void setTrainedPetSkills(obj_id pet, String[] abilityList)
    {
    ...
    public static String[] correctNullSkills(String[] abilityList)
    {
        for (int i = 0; i < abilityList.length; i++)
        {
            if (abilityList[i].equals(""))
    ...
    public static void clearTrainedSkills(obj_id pet)
    {
        obj_id bcd = getBeastBCD(pet);
        String[] emptyList = 
        {
    ...
    public static boolean canPerformCommand(obj_id player, obj_id pet, String command)
    {
    ...
    public static int getAvailableTrainingSlots(obj_id pet, String abilityName)
    {
    ...
    public static boolean isValidBeastSkillForCreature(obj_id pet, String skill)
    {
        obj_id bcd = getBeastBCD(pet);
    ...
    public static int calculateTrainingPointsSpent(obj_id pet)
    {
        return calculateTrainingPointsSpent(pet, null);
    }
    public static int calculateTrainingPointsSpent(obj_id pet, String passedAbility)
    {
    ...
    public static boolean isSkillAlreadyTrained(obj_id pet, String ability)
    {
        String[] knownSkills = getTrainedSkills(pet);
        for (int i = 0; i < knownSkills.length; i++)
        {
    ...
    public static boolean isSkillUpgrade(obj_id pet, String ability)
    {
        String[] knownSkills = getTrainedSkills(pet);
    ...
    public static boolean canLearnSkill(obj_id pet, String abilityName)
    {
    ...
    public static int getTrainingSuccessCode(obj_id pet, String abilityName)
    {
    ...
    public static void updatePetAbilityList(obj_id bcd)
    {
    ...
    public static void updatePetAbilityList(obj_id bcd, obj_id pet)
    {
    ...
    public static boolean canTrainPet(obj_id player, obj_id pet)
    {
        if (!beast_lib.isBeastMaster(player))
        {
    ...
    public static int getSkillCrcByName(String abilityName)
    {
        return dataTableGetInt(BEASTS_SPECIALS, abilityName, "abilityCrc");
    }
    public static String[] playerLearnBeastMasterSkill(obj_id player, String newSkill)
    {
    ...
    public static boolean isLearnableBeastMasterSkill(String skillName)
    {
    ...
    public static int getBeastMasterSpecialType(String skillName)
    {
        int row = dataTableSearchColumnForString(skillName, "ability_name", BEASTS_SPECIALS);
        if (row == -1)
        {
    ...
    public static boolean hasBeastMasterSkill(obj_id player, String beastAbility)
    {
        if (isIdValid(player))
        {
    ...
    public static void sendCreatureAbilitySkillLearnSpam(obj_id player, String newSkill)
    {
    ...
    public static String[] getKnownSkills(obj_id player)
    {
    ...
    public static Vector getKnownSkillsCrc(obj_id player)
    {
    ...
    public static void trainPetAbility(obj_id pet, String abilityName)
    {
    ...
    public static void sendPetTrainNotification(obj_id pet, String abilityName)
    {
    ...
    public static int getExpertiseStat(int baseStat, int expertiseMod, float nerfPercent)
    {
    ...
    public static float getExpertiseSpeed(float baseStat, int expertiseMod)
    {
        float expertisePercent = (float)expertiseMod / 100;
        float expertiseSpeed = baseStat + (baseStat * (1.0f - expertisePercent));
        return expertiseSpeed;
    }
    public static boolean isPreparedToLearnCreatureAbility(obj_id player)
    {
        return buff.hasBuff(player, "bm_creature_knowledge");
    }
    public static float getCreatureKnowledgeLevel(obj_id player)
    {
    ...
    public static boolean makeAbilityLearnSkillCheck(obj_id player, String ability)
    {
    ...
    public static int getDifficultyToLearnAbility(String ability)
    {
        return dataTableGetInt(BEASTS_SPECIALS, ability, "level_to_learn");
    }
    public static boolean checkForSkillAcquisition(obj_id attacker, obj_id defender, String actionName)
    {
        if (isBeast(defender))
        {
    ...
    public static boolean isLearnableCreatureAbility(obj_id player, String actionName)
    {
    ...
    public static void doBmProvokeCommand(obj_id self, obj_id target, int provokeLevel)
    {
    ...
    public static void performingActivity(obj_id beastBCD, int activity)
    {
        obj_id player = getBCDPlayer(beastBCD);
    ...
    public static void verifyAndUpdateCalledBeastStats(obj_id player)
    {
        obj_id beast = getBeastOnPlayer(player);
        if (!isIdValid(beast) || !exists(beast))
        {
    ...
    public static void removeAttentionPenaltyDebuff(obj_id player)
    {
        for (int i = 1; i < 6; i++)
        {
    ...
    public static int[] fillIncubationArray(obj_id egg, obj_id beastControlDevice)
    {
        int[] incubationBonuses = new int[ARRAY_BEAST_INCUBATION_STATS.length];
        for (int i = 0; i < ARRAY_BEAST_INCUBATION_STATS.length; ++i)
        {
    ...
    public static string_id convertHappinessString(obj_id beastBCD)
    {
    ...
    public static string_id convertHappinessString(int currentHappiness)
    {
    ...
    public static void applyHappinessBuffIcon(obj_id beast)
    {
        obj_id beastBCD = getBeastBCD(beast);
        if (!isValidBCD(beastBCD))
        {
    ...
    public static string_id convertLoyaltyString(obj_id beastBCD)
    {
    ...
    public static string_id convertLoyaltyString(int currentLoyalty)
    {
    ...
    public static obj_id generateTypeThreeEnzyme(obj_id player, float enzymeValue)
    {
        return generateTypeThreeEnzyme(player, null, enzymeValue, enzymeValue, "none");
    }
    public static obj_id generateTypeThreeEnzyme(obj_id player, float enzymePurity, float enzymeMutagen)
    {
    ...
    public static int getEnzymeExtractionReturnCode(obj_id player, obj_id creatureCorpse)
    {
        if (!isBeastMaster(player))
        {
    ...
    public static Vector getExtractionList(obj_id corpse)
    {
    ...
    public static void addToExtractionList(obj_id player, obj_id corpse)
    {
    ...
    public static float distributedRand(float min, float max, int level)
    {
    ...
    public static String[] getBeastmasterPetBarData(obj_id pet)
    {
        return getBeastmasterPetBarData(getMaster(pet), pet);
    }
    public static String[] getBeastmasterPetBarData(obj_id player, obj_id pet)
    {
    ...
    public static boolean isChargeAttack(String actionName)
    {
    ...
    public static boolean setBCDBeastHueFromEgg(obj_id bcd, obj_id egg)
    {
    ...
    public static void setBCDBeastHuePrimary(obj_id bcd, String palette, int hueIndex)
    {
    ...
    public static void setBeastHuePrimary(obj_id beast, String palette, int hueIndex)
    {
        obj_id bcd = getBeastBCD(beast);
        if (!isIdValid(bcd) || !exists(bcd) || palette == null || palette.length() <= 0 || hueIndex < 0)
        {
    ...
    public static String getBCDPalettePrimary(obj_id bcd)
    {
    ...
    public static int getBCDHuePrimary(obj_id bcd)
    {
    ...
    public static String getBeastPalettePrimary(obj_id beast)
    {
        if (!isIdValid(beast) || !exists(beast))
        {
            return "";
    ...
    public static int getBeastHuePrimary(obj_id beast)
    {
        if (!isIdValid(beast) || !exists(beast))
        {
            return -1;
    ...
    public static void setBCDBeastHueSecondary(obj_id bcd, String palette, int hueIndex)
    {
        if (!isIdValid(bcd) || !exists(bcd) || palette == null || palette.length() <= 0 || hueIndex < 0)
        {
            return;
    ...
    public static void setBeastHueSecondary(obj_id beast, String palette, int hueIndex)
    {
        obj_id bcd = getBeastBCD(beast);
        if (!isIdValid(bcd) || !exists(bcd) || palette == null || palette.length() <= 0 || hueIndex < 0)
        {
    ...
    public static String getBCDPaletteSecondary(obj_id bcd)
    {
    ...
    public static int getBCDHueSecondary(obj_id bcd)
    {
    ...
    public static String getBeastPaletteSecondary(obj_id beast)
    {
        if (!isIdValid(beast) || !exists(beast))
        {
            return "";
    ...
    public static int getBeastHueSecondary(obj_id beast)
    {
        if (!isIdValid(beast) || !exists(beast))
        {
            return -1;
    ...
    public static void setBCDBeastHueThird(obj_id bcd, String palette, int hueIndex)
    {
        if (!isIdValid(bcd) || !exists(bcd) || palette == null || palette.length() <= 0 || hueIndex < 0)
        {
            return;
    ...
    public static void setBeastHueThird(obj_id beast, String palette, int hueIndex)
    {
        obj_id bcd = getBeastBCD(beast);
        if (!isIdValid(bcd) || !exists(bcd) || palette == null || palette.length() <= 0 || hueIndex < 0)
        {
    ...
    public static String getBCDPaletteThird(obj_id bcd)
    {
    ...
    public static int getBCDHueThird(obj_id bcd)
    {
    ...
    public static String getBeastPaletteThird(obj_id beast)
    {
        if (!isIdValid(beast) || !exists(beast))
        {
            return "";
    ...
    public static int getBeastHueThird(obj_id beast)
    {
        if (!isIdValid(beast) || !exists(beast))
        {
            return -1;
    ...
    public static void clearBeastColor(obj_id beast)
    {
        obj_id bcd = getBeastBCD(beast);
        if (!isIdValid(bcd) || !exists(bcd))
        {
    ...
    public static void initializeBeastColor(obj_id beast)
    {
        obj_id bcd = getBeastBCD(beast);
        if (!isIdValid(bcd) || !exists(bcd))
        {
    ...
    public static boolean addInnateBeastBonuses(obj_id beast, String beastType)
    {
    ...
    public static dictionary getBeastMasterExamineInfo(obj_id player, obj_id creature, String[] names, String[] attribs, int idx)
    {
    ...
    public static String getBestBeastMasterSkill(obj_id player, String skillName)
    {
    ...
    public static String getNextSkillInLine(String skillName)
    {
    ...
    public static int getSkillBeastmasterSkillComparison(String querySkill, String skillToCompare)
    {
    ...
    public static String getSkillLine(String skillName)
    {
        return dataTableGetString(BEASTS_SPECIALS, skillName, "skill_line");
    }
    public static int getSkillRank(String skillName)
    {
        return dataTableGetInt(BEASTS_SPECIALS, skillName, "skill_rank");
    }
    public static void updateBeastStats(obj_id bcd, obj_id beast)
    {
        if (!isValidBCD(bcd) || !isValidBeast(beast))
        {
            return;
    ...
    public static void setBCDIncubationStats(obj_id bcd, obj_id egg)
    {
    ...
    public static void setBeastSkillBonuses(obj_id beast)
    {
    ...
    public static boolean setBeastCritChance(obj_id beast)
    {
        if (!isIdValid(beast) || !exists(beast))
        {
            return false;
    ...
    public static float getBeastCritChance(obj_id attacker)
    {
    ...
    public static boolean setBeastStrikethroughChance(obj_id beast)
    {
        if (!isIdValid(beast) || !exists(beast))
        {
            return false;
    ...
    public static float getBeastStrikethroughChance(obj_id attacker)
    {
        if (isPlayer(attacker))
        {
            obj_id beast = getBeastOnPlayer(attacker);
    ...
    public static boolean setBeastStrikethroughValue(obj_id beast)
    {
        if (!isIdValid(beast) || !exists(beast))
        {
            return false;
    ...
    public static float getBeastStrikethroughValue(obj_id attacker)
    {
        if (isPlayer(attacker))
        {
            obj_id beast = getBeastOnPlayer(attacker);
    ...
    public static float getBeastHitChance(obj_id attacker)
    {
        if (isPlayer(attacker))
        {
            obj_id beast = getBeastOnPlayer(attacker);
    ...
    public static boolean setBeastBlockChance(obj_id beast)
    {
        if (!isIdValid(beast) || !exists(beast))
        {
            return false;
    ...
    public static float getBeastBlockChance(obj_id attacker)
    {
        if (isPlayer(attacker))
        {
            obj_id beast = getBeastOnPlayer(attacker);
    ...
    public static float getBeastGlanceChance(obj_id beast)
    {
        if (!isIdValid(beast) || !exists(beast))
        {
            return 0.0f;
    ...
    public static boolean setBeastBlockValue(obj_id beast)
    {
        if (!isIdValid(beast) || !exists(beast))
        {
            return false;
    ...
    public static int getBeastBlockValue(obj_id attacker)
    {
        if (isPlayer(attacker))
        {
            obj_id beast = getBeastOnPlayer(attacker);
    ...
    public static boolean setBeastDodgeChance(obj_id beast)
    {
        if (!isIdValid(beast) || !exists(beast))
        {
            return false;
    ...
    public static float getBeastDodgeChance(obj_id attacker)
    {
        if (isPlayer(attacker))
        {
            obj_id beast = getBeastOnPlayer(attacker);
    ...
    public static boolean setBeastParryChance(obj_id beast)
    {
        if (!isIdValid(beast) || !exists(beast))
        {
            return false;
    ...
    public static float getBeastParryChance(obj_id attacker)
    {
        if (isPlayer(attacker))
        {
            obj_id beast = getBeastOnPlayer(attacker);
    ...
    public static boolean setBeastEvadeChance(obj_id beast)
    {
        if (!isIdValid(beast) || !exists(beast))
        {
            return false;
    ...
    public static float getBeastEvadeChance(obj_id attacker)
    {
        if (isPlayer(attacker))
        {
            obj_id beast = getBeastOnPlayer(attacker);
    ...
    public static boolean setBeastEvadeValue(obj_id beast)
    {
        if (!isIdValid(beast) || !exists(beast))
        {
            return false;
    ...
    public static float getBeastEvadeValue(obj_id attacker)
    {
        if (isPlayer(attacker))
        {
            obj_id beast = getBeastOnPlayer(attacker);
    ...
    public static float getBeastLearnBonus(obj_id beast)
    {
        if (isPlayer(beast))
        {
    ...
    public static float getBeastCunningRating(obj_id beast)
    {
        if (!isIdValid(beast) || !exists(beast))
        {
            return 0.0f;
    ...
    public static float getBeastModDamageBonus(obj_id attacker)
    {
        if (isPlayer(attacker))
        {
            obj_id beast = getBeastOnPlayer(attacker);
    ...
    public static float getBeastModGlancingReduction(obj_id attacker)
    {
        if (isPlayer(attacker))
        {
            obj_id beast = getBeastOnPlayer(attacker);
    ...
    public static float getBeastModDamageReduction(obj_id defender)
    {
    ...
    public static float getBeastModPunishingReduction(obj_id defender)
    {
        if (isPlayer(defender))
        {
            obj_id beast = getBeastOnPlayer(defender);
    ...
    public static float getBeastCustomMod(obj_id beast, int type)
    {
        if (isPlayer(beast))
        {
            beast = getBeastOnPlayer(beast);
    ...
    public static boolean setToggledCommands(obj_id player, obj_id bcd)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static String getBeastTrait(obj_id player, obj_id target)
    {
        return "none";
    }
    public static boolean canBeastGetLevelBasedXP(obj_id beast, obj_id npc)
    {
    ...
    public static int useBeastInjector(obj_id player, obj_id injector, obj_id beast, String beastFamily, String[] injectorFamilies, int mark)
    {
    ...
    public static boolean convertBcdIntoBeastItem(obj_id player, obj_id bcd)
    {
    ...
    public static obj_id createHolopetCubeFromEgg(obj_id player, obj_id egg)
    {
    ...
    public static obj_id createBeastHolopet(obj_id player, obj_id source, String beastType)
    {
    ...
    public static String localizedHoloBeastBaseName(String beastType)
    {
