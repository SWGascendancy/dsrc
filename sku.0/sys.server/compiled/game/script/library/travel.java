...
public class travel extends script.base_script
{
    ...
    public static boolean initializeStarport(obj_id structure, String travel_point, int travel_cost, boolean civic)
    {
    ...
    public static String getTravelPointName(obj_id structure)
    {
        if (structure == null || structure == obj_id.NULL_ID)
        {
            return null;
    ...
    public static location getArrivalLocation(obj_id structure)
    {
        if (structure == null || structure == obj_id.NULL_ID)
        {
            return null;
    ...
    public static int getTravelCost(obj_id structure)
    {
        if (structure == null || structure == obj_id.NULL_ID)
        {
            return -1;
    ...
    public static int getGroundTime(obj_id structure)
    {
        if (structure == null || structure == obj_id.NULL_ID)
        {
            return -1;
    ...
    public static int getAirTime(obj_id structure)
    {
        if (structure == null || structure == obj_id.NULL_ID)
        {
            return -1;
    ...
    public static int getShuttleTimestamp(obj_id structure)
    {
        if (structure == null || structure == obj_id.NULL_ID)
        {
            return -1;
    ...
    public static obj_id[] getBaseObjects(obj_id structure)
    {
        if (structure == null || structure == obj_id.NULL_ID)
        {
            return null;
    ...
    public static String getTicketDeparturePlanet(obj_id ticket)
    {
    ...
    public static String getTicketDeparturePoint(obj_id ticket)
    {
        if (ticket == null || ticket == obj_id.NULL_ID)
        {
            return null;
    ...
    public static String getTicketArrivalPlanet(obj_id ticket)
    {
        if (ticket == null || ticket == obj_id.NULL_ID)
        {
            return null;
    ...
    public static String getTicketArrivalPoint(obj_id ticket)
    {
        if (ticket == null || ticket == obj_id.NULL_ID)
        {
            return null;
    ...
    public static int getStarportVersion(obj_id starport)
    {
    ...
    public static int getStarportTableIndex(String template)
    {
        int idx = -1;
    ...
    public static boolean isTravelTicketValid(obj_id object, String depart_planet, String depart_point)
    {
    ...
    public static boolean isShuttlePort(obj_id structure)
    {
        if (structure == null || structure == obj_id.NULL_ID)
        {
            return false;
    ...
    public static boolean isTravelShuttle(obj_id object)
    {
        if (object == null || object == obj_id.NULL_ID)
        {
            return false;
    ...
    public static boolean isTravelShuttlePilot(obj_id object)
    {
        if (object == null || object == obj_id.NULL_ID)
        {
            return false;
    ...
    public static boolean isShuttleAvailable(obj_id starport)
    {
        if (starport == null || starport == obj_id.NULL_ID)
        {
            return false;
    ...
    public static boolean qualifiesForGcwTravelPerks(obj_id player)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static boolean restrictedByGcwTravelRestrictions(obj_id player)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static int getGcwTravelRestrictionsSurcharge(obj_id player, String departPlanet, String arrivePlanet)
    {
        if (!isIdValid(player))
        {
            return 0;
    ...
    public static String getGcwTravelRestrictionsAvailableStarport(obj_id player, String planet)
    {
        if (!isIdValid(player))
        {
            return null;
    ...
    public static obj_id getTravelShuttle(obj_id player)
    {
    ...
    public static boolean isInShuttleBoardingRange(obj_id player, obj_id shuttle)
    {
        if (player == null || player == obj_id.NULL_ID)
        {
            return false;
    ...
    public static boolean isValidRoute(String planet1, String point1, String planet2, String point2)
    {
    ...
    public static obj_id getStarportFromTerminal(obj_id terminal)
    {
    ...
    public static obj_id getShuttleFromStarport(obj_id starport)
    {
    ...
    public static boolean setShuttleAvailability(obj_id starport)
    {
        if (starport == null || starport == obj_id.NULL_ID)
        {
            return false;
    ...
    public static boolean setStarportTravelPoint(obj_id structure, String travel_point, location arrival_loc, int travel_cost, boolean civic)
    {
        String planet = getCurrentSceneName();
        if (structure == null || structure == obj_id.NULL_ID)
        {
    ...
    public static boolean removeTravelPoint(obj_id structure)
    {
        if (structure == null || structure == obj_id.NULL_ID)
        {
            return false;
    ...
    public static boolean purchaseTicket(obj_id player, String planet1, String point1, String planet2, String point2, boolean roundtrip, obj_id starport)
    {
    ...
    public static void showTravelVoucherSui()
    {
    }
    public static obj_id[] createTicket(obj_id player, String planet1, String point1, String planet2, String point2, boolean roundtrip)
    {
        if (player == null || player == obj_id.NULL_ID)
        {
            return null;
    ...
    public static boolean movePlayerToDestination(obj_id player, String planet, String point)
    {
        return movePlayerToDestination(player, planet, point, false);
    }
    public static boolean movePlayerToDestination(obj_id player, String planet, String point, boolean groupPickupPointTravel)
    {
        if (!isIdValid(player))
        {
    ...
    public static float[] transformDeltaWorldYaw(obj_id object, float x, float z)
    {
        if (!isIdValid(object))
        {
            return null;
    ...
    public static boolean testBoardShuttle(obj_id player, obj_id shuttle)
    {
        String planet = getCurrentSceneName();
    ...
    public static Vector getFilteredPortLocationsForPlanet(String planet, boolean isStarport)
    {
    ...
    public static String[] getStarportsForPlanet(String planet)
    {
        return utils.toStaticStringArray(getFilteredPortLocationsForPlanet(planet, true));
    }
    public static String[] getStarportsForPlanet()
    {
        return getStarportsForPlanet(getCurrentSceneName());
    }
    public static String[] getShuttleportsForPlanet(String planet)
    {
        return utils.toStaticStringArray(getFilteredPortLocationsForPlanet(planet, false));
    }
    public static String[] getShuttleportsForPlanet()
    {
        return getShuttleportsForPlanet(getCurrentSceneName());
    }
    public static boolean instantTravel(obj_id player, String planet1, String point1, String planet2, String point2, boolean roundtrip, obj_id starport)
    {
    ...
    public static boolean isTravelBlocked(obj_id player, boolean isLaunch)
    {
    ...
    public static void setTravelBlock(obj_id player, boolean allowLaunch)
    {
        int travelBlockValue = allowLaunch ? TRAVEL_BLOCK_ALLOW_LAUNCH : 0;
        utils.setScriptVar(player, "travelBlock", travelBlockValue);
    }
    public static void clearTravelBlock(obj_id player)
    {
        if (utils.hasScriptVar(player, "travelBlock"))
        {
