...
public class pgc_quests extends script.base_script
{
    ...
    public static boolean activateQuestHolocron(obj_id questHolocron, obj_id player)
    {
    ...
    public static boolean clearQuestHolocron(obj_id questControlDevice, obj_id player)
    {
    ...
    public static boolean isPgcQuestObject(obj_id object)
    {
    ...
    public static boolean isPgcRelicObject(obj_id object)
    {
        int gameObjectType = getGameObjectType(object);
    ...
    public static boolean isSharedPlayerQuestObject(obj_id questHolocron)
    {
        return hasObjVar(questHolocron, PCG_QUEST_SHARED_HOLOCRON_OBJVAR);
    }
    public static obj_id getQuestHolocronFromQCD(obj_id questControlDevice)
    {
    ...
    public static boolean canSharePgcQuest(obj_id questHolocron)
    {
    ...
    public static dictionary recreateSharedTaskDictionary(obj_id questHolocron)
    {
        dictionary webster = recreateQuestTaskDictionary(questHolocron);
        webster.put("isShared", true);
        return webster;
    }
    public static dictionary recreateQuestTaskDictionary(obj_id questHolocron)
    {
    ...
    public static boolean handleChroniclesRelicCosts(obj_id player, dictionary taskDictionary)
    {
    ...
    public static boolean canCoverAllChroniclesRelicCosts(obj_id player, dictionary relicNames, int numTasks)
    {
        boolean result = true;
        java.util.Enumeration keys = relicNames.keys();
        while (keys.hasMoreElements())
    ...
    public static dictionary getRelicCount(dictionary taskDictionary, int numTasks)
    {
    ...
    public static String getQuestName(obj_id questHolocron)
    {
        return getPlayerQuestTitle(questHolocron);
    }
    public static String getQuestDescription(obj_id questHolocron)
    {
        return getPlayerQuestDescription(questHolocron);
    }
    public static String getTaskName(obj_id questHolocron, int phaseNum, int taskNum)
    {
    ...
    public static String getTaskName(obj_id questHolocron, String phaseString, String taskString)
    {
        int taskIndex = getIntObjVarTaskData(questHolocron, getPgcBaseObjVar(phaseString, taskString), "task_index");
        return getPlayerQuestTaskTitle(questHolocron, taskIndex);
    }
    public static String getTaskDescription(obj_id questHolocron, int phaseNum, int taskNum)
    {
        String phaseString = getPhaseObjVarString(phaseNum);
        String taskString = getTaskObjVarString(taskNum);
        int taskIndex = getIntObjVarTaskData(questHolocron, getPgcBaseObjVar(phaseString, taskString), "task_index");
    ...
    public static String getTaskDescription(obj_id questHolocron, String phaseString, String taskString)
    {
        int taskIndex = getIntObjVarTaskData(questHolocron, getPgcBaseObjVar(phaseString, taskString), "task_index");
        return getPlayerQuestTaskDescription(questHolocron, taskIndex);
    }
    public static String getTaskType(obj_id questHolocron, int phaseNum, int taskNum)
    {
        String phaseString = getPhaseObjVarString(phaseNum);
        String taskString = getTaskObjVarString(taskNum);
        return getStringObjVarTaskData(questHolocron, getPgcBaseObjVar(phaseString, taskString), "task_type");
    }
    public static String getTaskType(obj_id questHolocron, String phaseString, String taskString)
    {
        return getStringObjVarTaskData(questHolocron, getPgcBaseObjVar(phaseString, taskString), "task_type");
    }
    public static String getRelicName(obj_id questHolocron, String phaseString, String taskString)
    {
        return getStringObjVarTaskData(questHolocron, getPgcBaseObjVar(phaseString, taskString), "task_relic");
    }
    public static String useFilteredQuestText(String text)
    {
    ...
    public static int getMaxChronicleQuestTasks(obj_id player)
    {
    ...
    public static boolean passedQuestHolocronProfanityCheck(obj_id player, obj_id questHolocron, String text)
    {
        return true;
    }
    public static int getTaskLevel(String[] relicData)
    {
        int level = 1;
    ...
    public static String getTaskGroupSetting(String[] relicData)
    {
    ...
    public static int getTaskDifficultySetting(String[] relicData)
    {
    ...
    public static boolean getTaskKashyyykSetting(String[] relicData)
    {
    ...
    public static boolean getTaskMustafarSetting(String[] relicData)
    {
    ...
    public static obj_id getQuestPlayer(obj_id questHolocron)
    {
        return utils.getContainingPlayer(questHolocron);
    }
    public static int getNumActiveQuests(obj_id player)
    {
    ...
    public static boolean hasMaxActivatedQuests(obj_id player)
    {
        return getNumActiveQuests(player) >= PGC_QUEST_MAX_NUM_QUESTS;
    }
    public static obj_id[] getActivateQuestHolocrons(obj_id player)
    {
    ...
    public static String getTaskObjVarString(int taskNum)
    {
    ...
    public static String getPgcBaseObjVar(String phaseString, String taskString)
    {
        return phaseString + "." + taskString;
    }
    public static boolean phaseHasActiveTaskOfType(obj_id questHolocron, String taskType, String phaseString)
    {
    ...
    public static boolean phaseHasActiveTask(obj_id questHolocron, String phaseString)
    {
        for (int i = 0; i < PGC_QUEST_MAX_NUM_TASKS_PER_PHASE; i++)
        {
            String taskString = getTaskObjVarString(i);
    ...
    public static String getActiveTaskTaskType(obj_id questHolocron, String phaseString, String taskString)
    {
        String taskType = "";
    ...
    public static int incrementTaskCounter(obj_id questHolocron, String baseObjVar)
    {
        int currentCount = 1;
    ...
    public static boolean isTaskComplete(obj_id questHolocron, String phaseString, String taskString)
    {
        String baseObjVar = getPgcBaseObjVar(phaseString, taskString);
        return hasObjVar(questHolocron, baseObjVar + ".task_complete");
    }
    public static int getActivePhaseNum(obj_id questHolocron)
    {
        int phaseNum = 0;
    ...
    public static String getPhaseObjVarString(int phaseNum)
    {
    ...
    public static String getActivePhaseObjVarString(obj_id questHolocron)
    {
        int phaseNum = getActivePhaseNum(questHolocron);
        String phaseString = getPhaseObjVarString(phaseNum);
        return phaseString;
    }
    public static void setTaskComplete(obj_id questHolocron, String phaseString, String taskString)
    {
    ...
    public static void removePlayerQuestWaypoint(obj_id questHolocron, String baseObjVar)
    {
    ...
    public static void activatePlayerQuestWaypointFromHolocron(obj_id questHolocron, String baseObjVar)
    {
        String activeWaypointObjVar = baseObjVar + ".waypointActive";
        if (hasObjVar(questHolocron, activeWaypointObjVar))
        {
    ...
    public static void activatePlayerQuestWaypoint(obj_id player, obj_id waypoint)
    {
        if (isIdValid(waypoint) && isIdValid(player))
        {
    ...
    public static int incrementActivePhaseNum(obj_id questHolocron)
    {
    ...
    public static void checkForPhaseComplete(obj_id questHolocron, String phaseString)
    {
        if (!phaseHasActiveTask(questHolocron, phaseString))
        {
            int phaseNum = incrementActivePhaseNum(questHolocron);
    ...
    public static void handlePhaseActived(obj_id questHolocron, int phaseNum)
    {
        String phaseString = getPhaseObjVarString(phaseNum);
        for (int i = 0; i < PGC_QUEST_MAX_NUM_TASKS_PER_PHASE; i++)
        {
    ...
    public static void handleTaskActived(obj_id questHolocron, int phaseNum, int taskNum)
    {
        String phaseString = getPhaseObjVarString(phaseNum);
        String taskString = getTaskObjVarString(taskNum);
        obj_id player = getQuestPlayer(questHolocron);
    ...
    public static float getDestroyTaskWeight(int taskLevel, int taskDifficulty, int taskCounterMax)
    {
        float weight = 1.0f;
    ...
    public static float getDestroyLootTaskWeight(int taskLevel, int taskDifficulty, int taskCounterMax, int dropRate)
    {
        float weight = 1.0f;
        int levelMod = taskLevel / 20 + 2;
        if (levelMod > 5)
    ...
    public static float getPerformTaskWeight(int taskLevel)
    {
        float weight = 1.0f;
        int levelMod = taskLevel / 20 + 2;
        if (levelMod > 5)
    ...
    public static float getCraftingTaskWeight(int taskLevel, int taskCounterMax)
    {
        float weight = 1.0f;
        int levelMod = taskLevel / 20 + 2;
        if (levelMod > 5)
    ...
    public static float getCommTaskWeight(int taskLevel)
    {
        float weight = 0.0f;
        return weight;
    }
    public static float getGoToTaskWeight(int taskLevel)
    {
        float weight = 0.5f;
        return weight;
    }
    public static float getRetrieveTaskWeight(int taskLevel, int taskCounterMax)
    {
        float weight = 1.0f;
        int levelMod = taskLevel / 20 + 2;
        if (levelMod > 5)
    ...
    public static float getPvpTaskWeight(int taskLevel, int taskCounterMax)
    {
        float weight = 1.0f;
        int levelMod = taskLevel / 20 + 2;
        if (levelMod > 5)
    ...
    public static float calculateQuestWeight(float[] taskWeightArray)
    {
    ...
    public static float calculateTaskTypeDiversity(dictionary taskTypes, int numTasks)
    {
    ...
    public static float calculateRelicDiversity(dictionary relicNames, int numTasks)
    {
    ...
    public static int calculateHolocronCreationChroniclesXp(float questWeight, float questRelicDiversity, float questTaskTypeDiversity)
    {
        if (questWeight < 1.0f)
        {
            questWeight = 1.0f;
    ...
    public static int calculateHolocronQuestCompletedChroniclesXp(obj_id questHolocron, int rating)
    {
    ...
    public static int grantChronicleXp(obj_id player, int xpAmount)
    {
    ...
    public static int getConfigModifiedChroniclesXPAmount(int xpAmount)
    {
    ...
    public static void checkForGainedChroniclesLevel(obj_id player)
    {
        String[] chronicleSkills = skill_template.getSkillTemplateSkillsByTemplateName(pgc_quests.PGC_CHRONICLES_XP_TYPE);
        if (chronicleSkills != null && chronicleSkills.length > 0)
        {
    ...
    public static void reportChronicleXPRequiredForNextSkill(obj_id player, String skillName)
    {
    ...
    public static boolean grantChroniclesRoadmapItem(obj_id player, String skillName, int skillIndex)
    {
    ...
    public static void setQuestComplete(obj_id questHolocron)
    {
    ...
    public static void grantPgcNonChroniclesQuestXp(obj_id player, obj_id questHolocron)
    {
    ...
    public static void grantPgcNonChroniclesQuestXp(obj_id player, int questLevel, float questWeight, obj_id questCreatorObjId, int questCreatorStationId)
    {
    ...
    public static void showPgcXpGrantedMessage(obj_id player, String xpType, int xpAmount)
    {
        float grpMod = 1f;
    ...
    public static int getNumQuestCompleteChroniclerRewardTokens(obj_id questHolocron)
    {
        obj_id questCreatorObjId = getObjIdObjVar(questHolocron, PCG_QUEST_CREATOR_ID_OBJVAR);
        int questCreatorStationId = getIntObjVar(questHolocron, PCG_QUEST_CREATOR_STATIONID_OBJVAR);
        float questWeight = getFloatObjVar(questHolocron, PCG_QUEST_WEIGHT_OBJVAR);
    ...
    public static int getNumQuestCompleteQuestorRewardTokens(obj_id player, obj_id questHolocron)
    {
    ...
    public static obj_id grantSilverChroniclesRewardTokens(obj_id player, int count)
    {
        return grantChroniclesRewardTokens(player, count, PGC_CHRONICLES_SILVER_TOKEN);
    }
    public static obj_id grantGoldChroniclesRewardTokens(obj_id player, int count)
    {
        return grantChroniclesRewardTokens(player, count, PGC_CHRONICLES_GOLD_TOKEN);
    }
    public static obj_id grantChroniclesRewardTokens(obj_id player, int count, String tokenType)
    {
    ...
    public static boolean isCompletingYourOwnChronicleQuest(obj_id player, obj_id questHolocron)
    {
        int questCreatorStationId = getIntObjVar(questHolocron, PCG_QUEST_CREATOR_STATIONID_OBJVAR);
        int playerStationId = getPlayerStationId(player);
        if (playerStationId == questCreatorStationId)
    ...
    public static void sendPlacedInInventorySystemMessage(obj_id player, obj_id objectPlaced, int count)
    {
    ...
    public static void sendPlacedInInventorySystemMessage(obj_id player, obj_id objectPlaced)
    {
        if (isValidId(objectPlaced))
        {
    ...
    public static void showQuestRatingUI(obj_id questHolocron, obj_id player)
    {
        String questName = getQuestName(questHolocron);
    ...
    public static float getCurrentPgcRating(int ratingTotal, int ratingCount)
    {
        return getCurrentPgcRating((float)ratingTotal, (float)ratingCount);
    }
    public static float getCurrentPgcRating(float ratingTotal, float ratingCount)
    {
    ...
    public static void showChroniclerRatingTable(obj_id player, String name, obj_id[] chroniclers)
    {
    ...
    public static boolean isEligiblePgcReward(obj_id rewardItem)
    {
    ...
    public static void setQuestAbandoned(obj_id questControlDevice, obj_id player)
    {
    ...
    public static void initializeQuestTasksStatus(obj_id questHolocron, int numTasks)
    {
    ...
    public static void resetQuestHolocron(obj_id questHolocron, obj_id player)
    {
    ...
    public static void addRelicToQuestBuilder(obj_id player, obj_id relic, boolean addEntireStack)
    {
    ...
    public static boolean canUseRelic(obj_id player, obj_id relic, String slotName, String collectionName, boolean isVerbose)
    {
    ...
    public static String getStringPgcTaskData(obj_id questHolocron, String baseObjVar, String category, String[] relicData)
    {
    ...
    public static String getStringObjVarTaskData(obj_id questHolocron, String baseObjVar, String category)
    {
        String taskData = "";
    ...
    public static String getStringRelicData(String category, String[] relicData)
    {
        return parseRelicData(category, relicData);
    }
    public static int getIntPgcTaskData(obj_id questHolocron, String baseObjVar, String category, String[] relicData)
    {
    ...
    public static int getIntObjVarTaskData(obj_id questHolocron, String baseObjVar, String category)
    {
        int taskData = -1;
        String dataObjVar = baseObjVar + "." + category;
        if (hasObjVar(questHolocron, dataObjVar))
    ...
    public static int getIntRelicData(String category, String[] relicData)
    {
        return utils.stringToInt(parseRelicData(category, relicData));
    }
    public static dictionary getWaypointObjVarTaskData(obj_id questHolocron, String baseObjVar, String category)
    {
    ...
    public static dictionary getWaypointRelicData(String category, String[] relicData)
    {
        if (relicData != null && relicData.length > 0)
        {
            for (int i = 0; i < relicData.length; i++)
    ...
    public static obj_id getObjIdRelicData(String category, String[] relicData)
    {
        return utils.stringToObjId(parseRelicData(category, relicData));
    }
    public static string_id getStringIdRelicData(String category, String[] relicData)
    {
        String stringData = parseRelicData(category, relicData);
        String[] parse = split(stringData, ',');
        return new string_id(parse[0], parse[1]);
    }
    public static String parseRelicData(String category, String[] relicData)
    {
        String data = "";
        if (relicData != null && relicData.length > 0)
        {
    ...
    public static void checkForKillTaskCredit(obj_id questHolocron, String taskType, String phaseString, String taskString, dictionary params)
    {
        obj_id player = getQuestPlayer(questHolocron);
        if (!isIdValid(player))
        {
    ...
    public static void handleDestroyMultipleKill(obj_id questHolocron, String phaseString, String taskString, int targetCount)
    {
        String baseObjVar = getPgcBaseObjVar(phaseString, taskString);
    ...
    public static void handleDestroyMultipleLootKill(obj_id questHolocron, String phaseString, String taskString, int targetCount, String[] relicData)
    {
        obj_id player = getQuestPlayer(questHolocron);
        if (isIdValid(player))
        {
    ...
    public static void handlePvpPlayerKillCredit(obj_id questHolocron, String taskType, String phaseString, String taskString, dictionary params)
    {
        obj_id player = getQuestPlayer(questHolocron);
        if (!isIdValid(player))
        {
    ...
    public static void handleCommMessageTaskActivated(obj_id questHolocron, String phaseString, String taskString)
    {
        obj_id player = getQuestPlayer(questHolocron);
        if (isIdValid(player))
        {
    ...
    public static void showChroniclesMessageBox(obj_id player, obj_id questHolocron, prose_package pp, String phaseString, String taskString)
    {
    ...
    public static String getPhaseStringVarName(int pageId, String taskType)
    {
        return taskType + ".phaseString." + pageId;
    }
    public static String getTaskStringVarName(int pageId, String taskType)
    {
        return taskType + ".taskString." + pageId;
    }
    public static void handleGoToLocationTaskActivated(obj_id questHolocron, String phaseString, String taskString, location targetLoc)
    {
        obj_id player = getQuestPlayer(questHolocron);
        if (isIdValid(player))
        {
    ...
    public static void log(obj_id player, obj_id questHolocron, String category, String text)
    {
    ...
    public static void logProgression(obj_id player, obj_id questHolocron, String text)
    {
        log(player, questHolocron, "chronicles_progression", text);
    }
    public static void logReward(obj_id player, obj_id questHolocron, String text)
    {
        log(player, questHolocron, "chronicles_reward", text);
    }
    public static void logQuest(obj_id player, obj_id questHolocron, String text)
    {
        log(player, questHolocron, "chronicles_quest", text);
    }
    public static void logRelic(obj_id player, obj_id questHolocron, String text)
    {
        log(player, questHolocron, "chronicles_relic", text);
    }
    public static void logRating(obj_id player, obj_id questHolocron, String text)
    {
