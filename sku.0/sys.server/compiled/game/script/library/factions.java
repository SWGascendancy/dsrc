...
public class factions extends script.base_script
{
    ...
    public static void goCovertWithDelay(obj_id objPlayer, float fltDelay)
    {
    ...
    public static void goCovert(obj_id objPlayer)
    {
    ...
    public static void goOvert(obj_id objPlayer)
    {
        if (!hasObjVar(objPlayer, "intChangingFactionStatus"))
        {
            return;
    ...
    public static void goOnLeaveWithDelay(obj_id objPlayer, float fltDelay)
    {
    ...
    public static void goOnLeave(obj_id objPlayer)
    {
        if (!hasObjVar(objPlayer, "intChangingFactionStatus"))
        {
            return;
    ...
    public static String getFaction(obj_id target)
    {
        if (isPlayer(target))
        {
    ...
    public static int getFactionFlag(obj_id target)
    {
        if (isRebel(target))
        {
    ...
    public static boolean isRebelorRebelHelper(obj_id target)
    {
        if (!isIdValid(target) || !exists(target))
        {
            return false;
    ...
    public static boolean isImperialorImperialHelper(obj_id target)
    {
        if (!isIdValid(target) || !exists(target))
        {
            return false;
    ...
    public static boolean isSameFactionorFactionHelper(obj_id target, obj_id target2)
    {
    ...
    public static float getFactionStanding(obj_id target, int intFaction)
    {
        return getFactionStanding(target, getFactionNameByHashCode(intFaction));
    }
    public static float getFactionStanding(obj_id target, String factionName)
    {
        if (!exists(target))
        {
            return 0.0f;
    ...
    public static float getFactionMax(obj_id target, int intFactionId)
    {
    ...
    public static void validateFactionStanding(obj_id player, String factionName)
    {
    ...
    public static String getRankName(int rank, String faction)
    {
        return utils.packStringId(getRankNameStringId(rank, faction));
    }
    public static string_id getRankNameStringId(int rank, String faction)
    {
    ...
    public static int getAvailableFactionPoints(obj_id target, String factionName)
    {
    ...
    public static int getAvailableFactionPoints(obj_id target, int faction)
    {
    ...
    public static void delegateFactionPoints(obj_id self, obj_id target, String params)
    {
        if (!isIdValid(target))
        {
    ...
    public static void resignFromFaction(obj_id player, int intFaction)
    {
    ...
    public static boolean addFactionStanding(obj_id target, int intFaction, float value)
    {
        return addFactionStanding(target, getFactionNameByHashCode(intFaction), value);
    }
    public static boolean addFactionStanding(obj_id target, String factionName, float value)
    {
        if (!isIdValid(target))
        {
            return false;
    ...
    public static float getFactionStoryReward(obj_id target, String factionName, float value)
    {
        float bonus = 0;
    ...
    public static void setFactionStanding(obj_id target, String factionName, float value)
    {
    ...
    public static void setFaction(obj_id target, String factionName)
    {
        if (factionName == null || factionName.equals(""))
        {
            return;
    ...
    public static void setFaction(obj_id target, String factionName, int pvpOnly)
    {
        setFaction(target, factionName, true, pvpOnly);
    }
    public static void setFaction(obj_id target, String factionName, boolean isAggro)
    {
        setFaction(target, factionName, isAggro, 0);
    }
    public static void setFaction(obj_id target, String factionName, boolean isAggro, int pvpOnly)
    {
        if (factionName == null || factionName.equals(""))
        {
            return;
    ...
    public static int getFactionStatus(obj_id ai, obj_id target)
    {
    ...
    public static int getFactionReaction(obj_id npc, obj_id target)
    {
    ...
    public static String getDeclaredFaction(obj_id target)
    {
    ...
    public static boolean isAggro(obj_id npc)
    {
    ...
    public static boolean awardFactionStanding(obj_id player, String factionName, int value)
    {
    ...
    public static void grantCombatFaction(obj_id killer, obj_id target, double percentDamage)
    {
    ...
    public static void adjustSocialStanding(obj_id target, String faction, int amount)
    {
        if (!isPlayer(target))
        {
            return;
    ...
    public static boolean setTemporaryEnemyFlag(obj_id player, obj_id target)
    {
    ...
    public static boolean areFactionsOpposed(String faction1, String faction2)
    {
    ...
    public static void changeFactionPoints(String strFaction, int intPoints)
    {
    ...
    public static int getFactionPointStanding(String strFaction)
    {
        obj_id objParent = getFactionParentObject();
        int intPoints = getIntObjVar(objParent, strFaction);
        return intPoints;
    }
    public static void shiftPointsTo(String strFaction, int intPoints)
    {
    ...
    public static boolean isFactionWinning(String strFaction)
    {
        obj_id objParent = getFactionParentObject();
        String strRebel = FACTION_REBEL;
        String strImperial = FACTION_IMPERIAL;
    ...
    public static boolean releaseFactionHirelings(obj_id player)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static boolean isNewlyDeclared(obj_id player)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static boolean canUseFactionItem(obj_id player, obj_id item)
    {
    ...
    public static void awardKashyyykFaction(obj_id player, int ammount)
    {
        if (!isPlayer(player))
        {
            return;
    ...
    public static void awardHsskorFaction(obj_id player, int ammount)
    {
        if (!isPlayer(player))
        {
            return;
    ...
    public static void validateBalance(obj_id player, String faction)
    {
    ...
    public static boolean isUnaligned(obj_id player)
    {
    ...
    public static boolean isAlignedKashyyyk(obj_id player)
    {
    ...
    public static boolean isAlignedHsskor(obj_id player)
    {
        if (isUnaligned(player))
        {
            return false;
    ...
    public static boolean isActiveImperial(obj_id objPlayer)
    {
        return (isImperial(objPlayer) && !isOnLeave(objPlayer));
    }
    public static boolean isActiveRebel(obj_id objPlayer)
    {
    ...
    public static boolean canJoinFaction(obj_id player, int faction_id)
    {
        if (!isIdValid(player))
        {
    ...
    public static boolean qualifiesForPromotion(obj_id objPlayer, int intFaction)
    {
        int intPlayerFaction = pvpGetAlignedFaction(objPlayer);
    ...
    public static void applyPromotion(obj_id objPlayer, int intFaction)
    {
    ...
    public static boolean canBuyFaction(obj_id objPlayer, obj_id objNPC)
    {
    ...
    public static void buyFaction(obj_id objPlayer, obj_id objNPC, int intAmount)
    {
        dictionary outp = new dictionary();
        money.requestPayment(objPlayer, objNPC, intAmount, "payBribe", outp, true);
        return;
    }
    public static boolean leaveFaction(obj_id player, int faction_id)
    {
        if (!isIdValid(player))
        {
            LOG("LOG_CHANNEL", "faction_recruiter::joinFaction -- player is null");
    ...
    public static boolean pvpDoAllowedAttackCheck(obj_id objPlayer, obj_id objTarget)
    {
    ...
    public static void doTransitionSui(obj_id objPlayer, obj_id objTarget, float fltDelay)
    {
        if (hasObjVar(objPlayer, "intChangingFactionStatus"))
        {
            return;
    ...
    public static boolean pvpDoAllowedHelpCheck(obj_id objPlayer, obj_id objTarget)
    {
        if (!isPlayer(objPlayer))
        {
            LOG("combat", "return 1");
    ...
    public static boolean canGoOnLeave(obj_id objPlayer)
    {
    ...
    public static boolean canGoCovert(obj_id objPlayer)
    {
        if (isInAdhocPvpArea(objPlayer))
        {
            return false;
    ...
    public static prose_package getFactionProsePackage(String factionName, int actualValue)
    {
    ...
    public static boolean ignorePlayer(obj_id attacker, obj_id target)
    {
    ...
    public static void setIgnorePlayer(obj_id npc)
    {
        utils.setScriptVar(npc, IGNORE_PLAYER, true);
    }
    public static boolean isInAdhocPvpArea(obj_id player)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static boolean isPlayerSameGcwFactionAsSchedulerObject(obj_id player, obj_id object)
    {
    ...
    public static boolean neutralMercenaryStatusMenu(obj_id player)
    {
        if (!isValidId(player) || !exists(player))
        {
            return false;
