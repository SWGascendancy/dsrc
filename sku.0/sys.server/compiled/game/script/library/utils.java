...
public class utils extends script.base_script
{
    ...
    public static final String EMPIRE_DAY_RECEIVED = "gift.empire18"; // finch
    ...
    public static float getDistance2D(obj_id hereTarget, obj_id thereTarget)
    {
    ...
    public static attrib_mod[] addMindAttribToStim(int power)
    {
    ...
    public static int unequipAndNotifyUncerted(obj_id player)
    {
    ...
    public static Vector addElement(Vector array, boolean element)
    {
        return addElement(array, Boolean.valueOf(element));
    }
    public static Vector addElement(Vector array, int element)
    {
        return addElement(array, new Integer(element));
    }
    public static Vector addElement(Vector array, float element)
    {
    ...
    public static boolean isLocSufficientDistanceFromObjects(location loc, obj_id[] items, float dist)
    {
    ...
    public static Vector concatArrays(Vector array1, int[] array2)
    {
        if (array2 == null)
        {
            return array1;
    ...
    public static Vector concatArrays(Vector array1, float[] array2)
    {
        if (array2 == null)
        {
            return array1;
    ...
    public static Vector concatArrays(Vector array1, boolean[] array2)
    {
        if (array2 == null)
        {
            return array1;
    ...
    public static String[] makeNameListFromPlayerObjIdList(obj_id[] players)
    {
        if (players == null)
        {
            return null;
    ...
    public static String[] makeNameList(obj_id[] targets)
    {
        if (targets == null)
        {
            return null;
    ...
    public static String[] makeNameList(Vector targets)
    {
    ...
    public static boolean isCoOwner(obj_id target, obj_id player)
    {
    ...
    public static obj_id[] getContents(obj_id container, boolean recurse, Vector excludedNodes)
    {
    ...
    public static obj_id[] getContents(obj_id container, boolean recurse)
    {
    ...
    public static Vector getResizeableContents(obj_id container, boolean recurse, Vector excludedNodes)
    {
    ...
    public static Vector getResizeableContents(obj_id container, boolean recurse)
    {
        return getResizeableContents(container, recurse, null);
    }
    public static obj_id[] getNonBankPlayerContents(obj_id player)
    {
        if (!isIdValid(player))
        {
            return null;
    ...
    public static obj_id[] getFilteredPlayerContents(obj_id player)
    {
        if (!isIdValid(player))
        {
            return null;
    ...
    public static obj_id[] getAllContentsOwnedByPlayer(obj_id container, obj_id player)
    {
    ...
    public static boolean isNestedWithinAPlayer(obj_id item)
    {
        return isNestedWithinAPlayer(item, true);
    }
    public static boolean isNestedWithinAPlayer(obj_id item, boolean searchBank)
    {
        if (!isIdValid(item))
        {
            return false;
    ...
    public static boolean isNestedWithinANpcCreature(obj_id item)
    {
        if (!isIdValid(item))
        {
            return false;
    ...
    public static boolean playerHasItemByTemplate(obj_id objPlayer, String strTemplate)
    {
    ...
    public static boolean playerHasItemByTemplateInDataPad(obj_id objPlayer, String strTemplate)
    {
    ...
    public static int playerHasHowManyItemByTemplateInDataPad(obj_id objPlayer, String strTemplate, boolean recurse)
    {
        int count = 0;
        obj_id pDataPad = getPlayerDatapad(objPlayer);
        if (isIdValid(pDataPad))
    ...
    public static boolean playerHasItemByTemplateInBank(obj_id objPlayer, String strTemplate)
    {
    ...
    public static boolean playerHasItemByTemplateInBankOrInventory(obj_id objPlayer, String strTemplate)
    {
    ...
    public static boolean playerHasStaticItemInBankOrInventory(obj_id player, String staticItem)
    {
        return (isIdValid(getStaticItemInBankOrInventory(player, staticItem)));
    }
    public static obj_id getStaticItemInBankOrInventory(obj_id player, String staticItem)
    {
        obj_id[] contents = getInventoryAndEquipment(player);
        String itemName;
    ...
    public static boolean playerHasStaticItemInAppearanceInventory(obj_id player, String staticItem)
    {
    ...
    public static obj_id[] getAllStaticItemsInPlayerInventory(obj_id player, String staticItem)
    {
    ...
    public static int countOfStackedItemsInArray(obj_id[] items)
    {
        int totalCount = 0;

        for (obj_id item : items) {
            testAbortScript(); // finch might remove this functionality
            totalCount += getCount(item);
        }
        return totalCount;
    }
    public static obj_id getItemPlayerHasByTemplate(obj_id objPlayer, String strTemplate)
    {
        obj_id objInventory = getInventoryContainer(objPlayer);
        if (isIdValid(objInventory))
        {
    ...
    public static obj_id getItemPlayerHasByTemplateInDatapad(obj_id objPlayer, String strTemplate)
    {
        obj_id pDataPad = getPlayerDatapad(objPlayer);
        if (isIdValid(pDataPad))
        {
    ...
    public static obj_id getItemPlayerHasByTemplateInBank(obj_id objPlayer, String strTemplate)
    {
        obj_id objBank = getPlayerBank(objPlayer);
        if (isIdValid(objBank))
        {
    ...
    public static obj_id getItemPlayerHasByTemplateInBankOrInventory(obj_id objPlayer, String strTemplate)
    {
    ...
    public static obj_id[] getAllItemsPlayerHasByTemplate(obj_id objPlayer, String strTemplate)
    {
        obj_id objInventory = getInventoryContainer(objPlayer);
        if (isIdValid(objInventory))
        {
    ...
    public static obj_id[] getAllItemsPlayerHasByTemplateInBank(obj_id objPlayer, String strTemplate)
    {
        obj_id objBank = getPlayerBank(objPlayer);
        if (isIdValid(objBank))
        {
    ...
    public static obj_id[] getAllItemsInContainerByTemplate(obj_id container, String template, boolean recurse)
    {
        return getAllItemsInContainerByTemplate(container, template, recurse, true);
    }
    public static obj_id[] getAllItemsInContainerByTemplate(obj_id container, String template, boolean recurse, boolean allowEquipped)
    {
        Vector objectList = new Vector();
    ...
    public static obj_id[] getAllItemsPlayerHasByTemplateStartsWith(obj_id objPlayer, String strTemplate)
    {
        obj_id objInventory = getInventoryContainer(objPlayer);
        if (isIdValid(objInventory))
        {
    ...
    public static obj_id[] getAllItemsPlayerHasByTemplateInBankStartsWith(obj_id objPlayer, String strTemplate)
    {
        obj_id objBank = getPlayerBank(objPlayer);
        if (isIdValid(objBank))
        {
    ...
    public static obj_id[] getAllItemsInContainerByTemplateStartsWith(obj_id container, String template, boolean recurse)
    {
        Vector objectList = new Vector();
        if (isIdValid(container))
        {
    ...
    public static obj_id[] getAllItemsPlayerHasByTemplateInBankAndInventory(obj_id objPlayer, String strTemplate)
    {
        Vector objectList = new Vector();
        obj_id objInventory = getInventoryContainer(objPlayer);
        if (isIdValid(objInventory))
    ...
    public static obj_id[] getAllItemsInBankAndInventory(obj_id objPlayer)
    {
        Vector objectList = new Vector();
    ...
    public static location getRandomLocationInRing(location locOrigin, float fltMinDistance, float fltMaxDistance)
    {
    ...
    public static location rotatePointXZ(location locOrigin, float fltDistance, float fltAngle)
    {
    ...
    public static location findLocInFrontOfTarget(obj_id target, float distance)
    {
    ...
    public static dictionary parseKeyPairList(String keyPairList, char delim)
    {
    ...
    public static dictionary parseKeyPairList(String keyPairList)
    {
    ...
    public static obj_id getDroidInventoryContainer(obj_id droid)
    {
        if (!isIdValid(droid))
        {
            return null;
    ...
    public static obj_id[] getBuildingsInObjIdList(obj_id[] items)
    {
    ...
    public static obj_id[] getContainedGOTObjects(obj_id container, int got, boolean recurse, boolean allowDerived)
    {
    ...
    public static obj_id[] getContainedGOTObjects(obj_id container, int got, boolean recurse)
    {
        return getContainedGOTObjects(container, got, recurse, false);
    }
    public static obj_id[] getContainedGOTObjects(obj_id container, int got)
    {
        return getContainedGOTObjects(container, got, false);
    }
    public static obj_id[] getContainedObjectsWithObjVar(obj_id container, String var, boolean recurse)
    {
        if (!isIdValid(container))
        {
            return null;
    ...
    public static obj_id[] getContainedObjectsWithObjVar(obj_id container, String var)
    {
        return getContainedObjectsWithObjVar(container, var, false);
    }
    public static obj_id[] getContainedObjectsWithScript(obj_id container, String script, boolean recurse)
    {
        if (!isIdValid(container))
        {
            return null;
    ...
    public static obj_id[] getContainedObjectsWithScript(obj_id container, String script)
    {
    ...
    public static void sendSystemMessagePob(obj_id pob, string_id message)
    {
    ...
    public static void sendSystemMessageProsePob(obj_id pob, prose_package message)
    {
        obj_id[] players = trial.getPlayersInDungeon(pob);
        if (players != null && players.length > 0)
        {
    ...
    public static void messagePlayer(obj_id source, obj_id player, string_id message)
    {
    ...
    public static void messagePlayer(obj_id source, obj_id[] players, string_id message)
    {
    ...
    public static boolean emptyContainerExceptStorytellerLoot(obj_id target)
    {
        if ((target == null) || (target == obj_id.NULL_ID))
        {
            return false;
    ...
    public static location getLocationInArc(obj_id objPlayer, float fltStartAngle, float fltArcSize, float fltDistance)
    {
    ...
    public static float getHeadingDegrees(obj_id objTarget)
    {
    ...
    public static float thetaDegrees(location start, location end)
    {
    ...
    public static dictionary addObjVarToDictionary(obj_var ov, dictionary d)
    {
        return addObjVarToDictionary(ov, d, null);
    }
    public static dictionary addObjVarListToDictionary(obj_var_list ovl, dictionary d, String basePath)
    {
        if (ovl == null || d == null)
        {
            return d;
    ...
    public static dictionary addObjVarListToDictionary(obj_var_list ovl, dictionary d)
    {
        return addObjVarListToDictionary(ovl, d, null);
    }
    public static obj_id cloneObject(obj_id template, obj_id container)
    {
    ...
    public static obj_id cloneObject(obj_id template, location loc)
    {
    ...
    public static boolean setBatchObjVar(obj_id target, String base_path, Object[] array)
    {
    ...
    public static boolean setBatchObjVar(obj_id target, String base_path, int[] array)
    {
        if (!isIdValid(target) || (base_path == null) || (base_path.equals("")) || (array == null) || (array.length == 0))
        {
            return false;
    ...
    public static boolean setResizeableBatchObjVar(obj_id target, String base_path, Vector vector)
    {
    ...
    public static String[] getStringBatchObjVar(obj_id target, String base_path)
    {
        if (!isIdValid(target) || (base_path == null) || (base_path.equals("")) || !hasObjVar(target, base_path))
        {
            return null;
    ...
    public static Vector getResizeableStringBatchObjVar(obj_id target, String base_path)
    {
        if (!isIdValid(target) || (base_path == null) || (base_path.equals("")) || !hasObjVar(target, base_path))
        {
            return null;
    ...
    public static string_id[] getStringIdBatchObjVar(obj_id target, String base_path)
    {
        if (!isIdValid(target))
        {
            return null;
    ...
    public static obj_id[] getObjIdBatchObjVar(obj_id target, String base_path)
    {
        if (!isIdValid(target))
        {
            return null;
    ...
    public static Vector getResizeableObjIdBatchObjVar(obj_id target, String base_path)
    {
        if (!isIdValid(target))
        {
            return null;
    ...
    public static int[] getIntBatchObjVar(obj_id target, String base_path)
    {
        if (!isIdValid(target))
        {
            return null;
    ...
    public static Vector getResizeableIntBatchObjVar(obj_id target, String base_path)
    {
        if (!isIdValid(target))
        {
            return null;
    ...
    public static attrib_mod[] getAttribModBatchObjVar(obj_id target, String base_path)
    {
        if (!isIdValid(target))
        {
            return null;
    ...
    public static location[] getLocationBatchObjVar(obj_id target, String base_path)
    {
        if (!isIdValid(target))
        {
            return null;
    ...
    public static boolean hasStringBatchObjVar(obj_id target, String base_path)
    {
        return getStringBatchObjVar(target, base_path) != null;
    }
    public static boolean hasResizeableStringBatchObjVar(obj_id target, String base_path)
    {
        return getResizeableStringBatchObjVar(target, base_path) != null;
    }
    public static boolean hasStringIdBatchObjVar(obj_id target, String base_path)
    {
        return getStringIdBatchObjVar(target, base_path) != null;
    }
    public static boolean hasObjIdBatchObjVar(obj_id target, String base_path)
    {
        return getObjIdBatchObjVar(target, base_path) != null;
    }
    public static boolean hasResizeableObjIdBatchObjVar(obj_id target, String base_path)
    {
        return getResizeableObjIdBatchObjVar(target, base_path) != null;
    }
    public static boolean hasIntBatchObjVar(obj_id target, String base_path)
    {
        return getIntBatchObjVar(target, base_path) != null;
    }
    public static boolean hasResizeableIntBatchObjVar(obj_id target, String base_path)
    {
        return getResizeableIntBatchObjVar(target, base_path) != null;
    }
    public static boolean hasAttribModBatchObjVar(obj_id target, String base_path)
    {
        return getAttribModBatchObjVar(target, base_path) != null;
    }
    public static boolean hasLocationBatchObjVar(obj_id target, String base_path)
    {
    ...
    public static boolean setBatchScriptVar(obj_id target, String base_path, obj_id[] array)
    {
        if ((array == null) || (array.length == 0))
        {
            return false;
    ...
    public static boolean setBatchScriptVar(obj_id target, String base_path, String[] array)
    {
        if ((array == null) || (array.length == 0))
        {
            return false;
    ...
    public static boolean setBatchScriptVar(obj_id target, String base_path, string_id[] array)
    {
        if ((array == null) || (array.length == 0))
        {
            return false;
    ...
    public static boolean setBatchScriptVar(obj_id target, String base_path, location[] array)
    {
        if ((array == null) || (array.length == 0))
        {
            return false;
    ...
    public static Vector getResizeableObjIdBatchScriptVar(obj_id target, String base_path)
    {
        if (!isIdValid(target))
        {
            return null;
    ...
    public static obj_id[] getObjIdBatchScriptVar(obj_id target, String base_path)
    {
    ...
    public static Vector getResizeableStringBatchScriptVar(obj_id target, String base_path)
    {
        if (!isIdValid(target))
        {
            return null;
    ...
    public static String[] getStringBatchScriptVar(obj_id target, String base_path)
    {
    ...
    public static Vector getResizeableLocationBatchScriptVar(obj_id target, String base_path)
    {
        if (!isIdValid(target))
        {
            return null;
    ...
    public static Vector getResizeableIntBatchScriptVar(obj_id target, String base_path)
    {
        if (!isIdValid(target))
        {
            return null;
    ...
    public static location[] getLocationBatchScriptVar(obj_id target, String base_path)
    {
    ...
    public static int[] getIntBatchScriptVar(obj_id target, String base_path)
    {
    ...
    public static void removeBatchScriptVar(obj_id target, String base_path)
    {
        if (!isIdValid(target))
        {
            return;
    ...
    public static boolean hasResizeableObjIdBatchScriptVar(obj_id target, String base_path)
    {
        return getResizeableObjIdBatchScriptVar(target, base_path) != null;
    }
    public static boolean hasObjIdBatchScriptVar(obj_id target, String base_path)
    {
        return getObjIdBatchScriptVar(target, base_path) != null;
    }
    public static boolean hasResizeableStringBatchScriptVar(obj_id target, String base_path)
    {
        return getResizeableStringBatchScriptVar(target, base_path) != null;
    }
    public static boolean hasStringBatchScriptVar(obj_id target, String base_path)
    {
        return getStringBatchScriptVar(target, base_path) != null;
    }
    public static boolean hasResizeableLocationBatchScriptVar(obj_id target, String base_path)
    {
        return getResizeableLocationBatchScriptVar(target, base_path) != null;
    }
    public static boolean hasResizeableIntBatchScriptVar(obj_id target, String base_path)
    {
        return getResizeableIntBatchScriptVar(target, base_path) != null;
    }
    public static boolean hasLocationBatchScriptVar(obj_id target, String base_path)
    {
        return getLocationBatchScriptVar(target, base_path) != null;
    }
    public static boolean hasIntBatchScriptVar(obj_id target, String base_path)
    {
    ...
    public static boolean checkServerSpawnLimits()
    {
    ...
    public static String formatTimeVerboseNoSpaces(int seconds)
    {
        if (seconds < 1)
        {
            return "";
    ...
    public static Vector alphabetizeStringArray(Vector array)
    {
        if ((array == null) || (array.size() == 0))
        {
            return null;
    ...
    public static int getTheaterSize(String strLairType)
    {
    ...
    public static boolean setNonProfaneName(obj_id target, String name)
    {
    ...
    public static boolean setFilteredName(obj_id target, String name) {
        if (!isIdValid(target) || name == null || name.equals("")) {
            return false;
        }
    ...
    public static String getStringName(obj_id target)
    {
        if (!isIdValid(target))
        {
            return null;
    ...
    public static string_id getCardinalDirectionForPoints(location locTest1, location locTest2)
    {
    ...
    public static String getStringCardinalDirection(location locTest1, location locTest2, boolean abbreviated)
    {
    ...
    public static String getStringCardinalDirection(location locTest1, location locTest2)
    {
    ...
    public static obj_id unequipWeaponHand(obj_id player)
    {
        return unequipSlot(player, "hold_r");
    }
    public static obj_id unequipOffHand(obj_id player)
    {
        return unequipSlot(player, "hold_l");
    }
    public static obj_id unequipSlot(obj_id player, String slot)
    {
    ...
    public static obj_id[] getAttackableTargetsInRadius(obj_id attacker, int radius, boolean player_targets)
    {
    ...
    public static obj_id getTrapDroidId(obj_id player)
    {
    ...
    public static int getTimeLeft(obj_id player, String toCheckFor, int timePenalty)
    {
        int timeCalled = utils.getIntScriptVar(player, toCheckFor);
        return timeCalled < 1 ? -1 : timeCalled + timePenalty - getGameTime();
    }
    public static int getTimeLeft(obj_id player, String toCheckFor, String modifiedTime)
    {
        int timeCalled = utils.getIntScriptVar(player, toCheckFor);
    ...
    public static void notifyObject(obj_id objTarget, String strNotificationName, dictionary dctParams)
    {
        if (!isIdValid(objTarget))
        {
    ...
    public static void callTrigger(String strTrigger, Object[] params)
    {
        try
        {
    ...
    public static void dismountRiderJetpackCheck(obj_id rider)
    {
        if (!isIdValid(rider))
        {
            return;
    ...
    public static int addClassRequirementAttributes(obj_id player, obj_id item, String[] names, String[] attribs, int firstFree, String prefix)
    {
    ...
    public static boolean testItemClassRequirements(obj_id player, String requiredClasses, boolean silent)
    {
    ...
    public static boolean testItemClassRequirements(obj_id player, obj_id thing, boolean silent, String prefix) {
    ...
    public static boolean testItemLevelRequirements(obj_id player, obj_id thing, boolean silent, String prefix)
    {
    ...
    public static boolean testItemAbilityRequirements(obj_id player, obj_id thing, boolean silent, String prefix)
    {
    ...
    public static boolean testItemSkillRequirements(obj_id player, obj_id thing, boolean silent, String prefix)
    {
    ...
    public static obj_id findNoTradeItem(obj_id[] items, boolean testPlayers)
    {
        return findNoTradeItem(items, testPlayers, false);
    }
    public static obj_id findNoTradeItem(obj_id[] items, boolean testPlayers, boolean novendor)
    {
        if (items != null)
        {
            obj_id result;
    ...
    public static obj_id findNoTradeItemNotVendor(obj_id[] items, boolean testPlayers)
    {
    ...
    public static boolean validItemForAntiDecay(obj_id item)
    {
        if (isIdValid(item))
        {
    ...
    public static obj_id[] getLocalGroupMemberIds(obj_id group)
    {
        if (!isIdValid(group))
        {
            return null;
    ...
    public static void emoteWookieeConfusion(obj_id player, obj_id npc)
    {
    ...
    public static void setObjVarsList(obj_id object, String objVarList)
    {
    ...
    public static void setObjVarsListUsingSemiColon(obj_id object, String objVarList)
    {
        if (objVarList == null || objVarList.equals(""))
        {
            return;
    ...
    public static String assembleTimeRemainToUse(int time)
    {
    ...
    public static boolean replaceSnowflakeItem(obj_id oldItem, String newTemplateName)
    {
    ...
    public static void checkInventoryForSnowflakeItemSwaps(obj_id self)
    {
    ...
    public static void housePackingDecreaseIncrease(obj_id objPlayer, int change)
    {
        int[] housePacking;
        if (change > 0)
        {
    ...
    public static boolean isInHouseCellSpace(obj_id object)
    {
        if (isIdValid(object))
        {
    ...
    public static boolean hasResourceInInventory(obj_id player, String resource)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static obj_id[] validateObjIdArray(obj_id[] objIds)
    {
    ...
    public static obj_id[] getPlayersInBuildoutRow(obj_id player)
    {
        return getPlayersInBuildoutRow(getLocation(player).area, locations.getBuildoutAreaRow(player));
    }
    public static obj_id[] getPlayersInBuildoutDimensions(String scene, float x1, float x2, float z1, float z2)
    {
    ...
    public static obj_id[] getPlayersInBuildoutRow(String scene, int buildout_row)
    {
    ...
    public static obj_id[] getPlayersInBuildoutArea(String scene, String buildout_area)
    {
    ...
    public static obj_id[] getAllObjectsInBuildoutArea(obj_id baseObject)
    {
        return getAllObjectsInBuildoutArea(getLocation(baseObject).area, locations.getBuildoutAreaRow(baseObject));
    }
    public static obj_id[] getAllObjectsInBuildoutArea(String scene, int buildout_row)
    {
        dictionary data = dataTableGetRow("datatables/buildout/areas_" + scene + ".iff", buildout_row);
    ...
    public static Vector shuffleArray(Vector list)
    {
    ...
    public static boolean grantGift(obj_id player)
    {
    ...
    public static void fullExpertiseReset(obj_id player, boolean storeBeast)
    {
        if (storeBeast)
        {
    ...
    public static obj_id[] getAllRidersInVehicle(obj_id player, obj_id vehicle)
    {
    ...
    public static void updateCTSObjVars(obj_id player)
    {
        if (!isIdValid(player) || !exists(player))
        {
            return;
    ...
    public static void updateRespecCTSObjvars(obj_id player, dictionary[] ctsOjbvars)
    {
        if (!isIdValid(player) || !exists(player))
        {
            return;
    ...
    public static void updateBeastMasterCTSObjvars(obj_id player, dictionary[] ctsOjbvars)
    {
        if (!isIdValid(player) || !exists(player))
        {
            return;
    ...
    public static String getOnlineOfflineStatus(obj_id player)
    {
        String returnData = "";
        if (!isPlayer(player))
        {
    ...
    public static boolean colorizeItemFromWidget(obj_id player, obj_id item, String params)
    {
