...
public class magic_item extends script.base_script
{
    ...
    public static boolean convertToMagicItem(obj_id item, int mobLevel)
    {
    ...
    public static int getBuyPoints(int mobLevel)
    {
        if (mobLevel < 1)
        {
            return -1;
    ...
    public static int getNumMods(int pivot)
    {
        if (pivot < 20)
        {
            return 1;
    ...
    public static int getMagicModCost(String modName)
    {
    ...
    public static Vector getAppearanceMagicMods(String tbl, String apr)
    {
    ...
    public static obj_id makeGem(obj_id targetContainer, String gemType, int mobLevel)
    {
    ...
    public static obj_id makeGem(obj_id targetContainer, int mobLevel)
    {
        return makeGem(targetContainer, "default", mobLevel);
    }
    public static String[] getGemMods(String gemType)
    {
