...
public class planetary_map extends script.base_script
{
    ...
    public static boolean addMapLocation(obj_id self)
    {
        if (!isIdValid(self))
        {
            return false;
    ...
    public static String getCityRegionName(location here)
    {
        if (here == null)
        {
            return null;
    ...
    public static void removeMapLocation(obj_id self)
    {
        if (!isIdValid(self))
        {
            return;
    ...
    public static boolean addCreatureLocation(obj_id self)
    {
        if (!isIdValid(self))
        {
            return false;
    ...
    public static boolean addTerminalLocation(obj_id self)
    {
        if (!isIdValid(self))
        {
            return false;
    ...
    public static map_location findClosestLocation(obj_id target, map_location[] map_locs)
    {
    ...
    public static map_location findClosestLocation(location here, map_location[] map_locs)
    {
    ...
    public static map_location findClosestLocation(obj_id target, String category, String subcategory)
    {
        if (!isIdValid(target))
        {
            return null;
    ...
    public static map_location findClosestLocation(location here, String category, String subcategory)
    {
    ...
    public static void closeFindSui()
    {
        obj_id self = getSelf();
    ...
    public static void cleanupFindSui()
    {
        obj_id self = getSelf();
        utils.removeScriptVar(self, SCRIPTVAR_FIND_SUI);
        utils.removeBatchScriptVar(self, SCRIPTVAR_FIND_PARAMS);
    }
    public static String[] getUniquePlanetaryMapCategories(String category)
    {
    ...
    public static boolean updateFacilityActive(obj_id facility, boolean isActive)
    {
