...
public class veteran_deprecated extends script.base_script
{
    ...
    public static final int DAYS_PER_MILESTONE = 7;
    public static final int REWARD_FLAGS_SIZE = 40 / 32 + 1;
    ...
    public static void updateVeteranTime(obj_id player)
    {
        utils.setScriptVar(player, SCRIPTVAR_VETERAN_LOGGED_IN, true);
        int daysOld = getCurrentBirthDate() - getPlayerBirthDate(player);
    ...
    public static boolean canGetReward(obj_id player)
    {
        int[] milestones = getVeteranRewardMilestones(player);
        return (milestones != null && milestones.length >= 1);
    }
    public static boolean requestVeteranRewards(obj_id player)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static boolean requestVeteranRewards(obj_id player, int milestone)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static int[] getVeteranRewardMilestones(obj_id player)
    {
        int veteranTime = getIntObjVar(player, OBJVAR_TIME_ACTIVE);
        if (veteranTime <= 0)
        {
    ...
    public static int givePlayerReward(obj_id player, int rewardIndex, boolean checkMilestoneMismatch)
    {
        if (!isIdValid(player))
        {
    ...
    public static void cleanupPlayerData(obj_id player)
    {
        if (!isIdValid(player))
        {
            return;
    ...
    public static String getRewardNameAtIndex(int index)
    {
        String name = null;
    ...
    public static int canGetRewardAtIndex(obj_id player, int index, int milestone)
    {
        int templateCrc = dataTableGetInt(REWARDS_DATATABLE, index, REWARDS_COLUMN_TEMPLATE);
    ...
    public static boolean checkVeteranMilestone(obj_id player, int milestone)
    {
    ...
    public static boolean checkMilestoneNotified(obj_id player, int milestone)
    {
        if (milestone < 1 || milestone > MAX_MILESTONE)
        {
            return false;
    ...
    public static void setVeteranMilestone(obj_id player, int milestone)
    {
        if (milestone < 1 || milestone > MAX_MILESTONE)
        {
            return;
    ...
    public static void setMilestoneNotified(obj_id player, int milestone)
    {
        if (milestone < 1 || milestone > MAX_MILESTONE)
        {
            return;
    ...
    public static void clearVeteranMilestone(obj_id player, int milestone)
    {
        if (milestone < 1 || milestone > MAX_MILESTONE)
        {
            return;
    ...
    public static void clearMilestoneNotified(obj_id player, int milestone)
    {
        if (milestone < 1 || milestone > MAX_MILESTONE)
        {
            return;
    ...
    public static boolean checkVeteranTarget(obj_id target)
    {
    ...
    public static void giveOneYearAnniversaryReward(obj_id player)
    {
    ...
    public static boolean checkFlashSpeederReward(obj_id player)
    {
        if (!isIdValid(player))
        {
