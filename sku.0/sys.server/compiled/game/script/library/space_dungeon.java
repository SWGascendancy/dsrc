...
public class space_dungeon extends script.base_script
{
    ...
    public static boolean intializeSpaceDungeon(obj_id dungeon)
    {
    ...
    public static boolean isSpaceDungeon(obj_id structure)
    {
    ...
    public static int getDungeonMaxPlayers(obj_id dungeon)
    {
        if (!isIdValid(dungeon))
        {
    ...
    public static location getDungeonExitLocation(obj_id dungeon)
    {
        if (!isIdValid(dungeon))
        {
    ...
    public static String getDungeonName(obj_id dungeon)
    {
        if (!isIdValid(dungeon))
        {
    ...
    public static string_id getDungeonNameStringId(String name)
    {
    ...
    public static String getDungeonInstanceName(obj_id dungeon)
    {
        if (!isIdValid(dungeon))
        {
    ...
    public static String getDungeonPlayerScript(obj_id dungeon)
    {
        if (!isIdValid(dungeon))
        {
    ...
    public static obj_id getDungeonTraveler(obj_id ticket_collector, int request_id)
    {
    ...
    public static boolean removeDungeonTraveler(obj_id ticket_collector, int request_id)
    {
        if (!isIdValid(ticket_collector))
        {
    ...
    public static int getDungeonSessionId(obj_id item)
    {
        if (!isIdValid(item))
        {
    ...
    public static obj_id getDungeonIdForPlayer(obj_id player)
    {
    ...
    public static obj_id createTicket(obj_id player, String start_planet, String start_point, String dungeon)
    {
        return createTicket(player, start_planet, start_point, dungeon, TEMPLATE_TICKET);
    }
    public static obj_id createTicket(obj_id player, String start_planet, String start_point, String dungeon, String ticket_template)
    {
        if (!isIdValid(player))
        {
    ...
    public static String getTicketDungeonName(obj_id ticket)
    {
        if (!isIdValid(ticket))
        {
    ...
    public static String getTicketPointName(obj_id ticket)
    {
        if (!isIdValid(ticket))
        {
    ...
    public static String getTicketPlanetName(obj_id ticket)
    {
        if (!isIdValid(ticket))
        {
    ...
    public static obj_id[] findValidDungeonTickets(obj_id player, obj_id ticket_collector)
    {
        if (!isIdValid(player))
        {
    ...
    public static obj_id getDungeonTicketCollector(obj_id player, String point_name)
    {
        if (!isIdValid(player))
        {
    ...
    public static boolean selectDungeonTicket(obj_id ticket_collector, obj_id player)
    {
    ...
    public static boolean activateDungeonTicket(obj_id player, obj_id ticket, obj_id ticket_collector)
    {
        if (!isIdValid(player))
        {
    ...
    public static boolean sendGroupToDungeonWithoutTicket(obj_id player, String dungeon_name, String point_name, String planet_name, String quest_type, obj_id ticket_collector)
    {
        if (!isIdValid(player))
        {
            LOG("space_dungeon", "space_dungeon.activateDungeonTicket --  player is null.");
    ...
    public static boolean sendGroupToDungeonWithoutTicketCollector(obj_id player, String dungeon_name, String quest_type)
    {
        if (!isIdValid(player))
        {
    ...
    public static void cleanupPlayerDungeonObjvars(obj_id player)
    {
    ...
    public static void cleanupPlayerTicketObjvars(obj_id player)
    {
    ...
    public static boolean movePlayerGroupToDungeon(obj_id player, obj_id dungeon, String dungeon_name, location dungeon_position)
    {
        return movePlayerGroupToDungeon(player, dungeon, dungeon_name, dungeon_position, true);
    }
    public static boolean movePlayerGroupToDungeon(obj_id player, obj_id dungeon, String dungeon_name, location dungeon_position, boolean checkLockoutTimer)
    {
    ...
    public static void moveSinglePlayerIntoDungeon(obj_id player, obj_id dungeon, String dungeon_name, location dungeon_position)
    {
        if (!isDungeonLockoutTimerExpired(player, dungeon_name))
        {
            displayDungeonLockoutTimerSUI(player, dungeon_name);
    ...
    public static boolean ejectPlayerFromDungeon(obj_id player)
    {
    ...
    public static boolean performEmergencyEject(obj_id player)
    {
        location playerLoc = getLocation(player);
        String playerScene = playerLoc.area;
    ...
    public static boolean preCheckEjectStatus(obj_id player, boolean allowGod)
    {
        if (!isIdValid(player))
        {
    ...
    public static boolean leaveKashyyykArena(obj_id player)
    {
        warpPlayer(player, "kashyyyk_dead_forest", -302, 38, -208, null, 0, 0, 0);
        return true;
    }
    public static obj_id findValidDungeonForEject(obj_id player)
    {
    ...
    public static boolean deValidatePlayerForDungeon(obj_id player, obj_id dungeon)
    {
    ...
    public static boolean removePlayerScriptsForDungeon(obj_id player, obj_id dungeon)
    {
        return removePlayerScriptsForDungeon(player);
    }
    public static boolean removePlayerScriptsForDungeon(obj_id player)
    {
    ...
    public static boolean decrementDungeonParticipantCounter(obj_id dungeon, obj_id player)
    {
    ...
    public static void incrementDungeonParticipantCounter(obj_id dungeon, obj_id player)
    {
        if (null == player)
        {
    ...
    public static void setDungeonTimeObjVars(obj_id controllerId)
    {
    ...
    public static boolean isDungeonFull(obj_id dungeon)
    {
        Vector participantIdVector = getResizeableObjIdArrayObjVar(dungeon, VAR_PARTICIPANT_IDS);
    ...
    public static void handlePilotPassengerEject(obj_id player)
    {
    ...
    public static boolean handlePilotLaunch(obj_id player, obj_id dungeon)
    {
    ...
    public static boolean launchPlayerFromDungeon(obj_id player)
    {
    ...
    public static boolean endDungeonSession(obj_id dungeon)
    {
        if (!isIdValid(dungeon))
        {
    ...
    public static boolean verifyPlayerSession(obj_id dungeon, obj_id player)
    {
        return verifyPlayerSession(player);
    }
    public static boolean verifyPlayerSession(obj_id player)
    {
    ...
    public static boolean isInSpaceDungeon(obj_id subject)
    {
        String area_name = locations.getBuildoutAreaName(getLocation(subject));
        int dungeon_row = dataTableSearchColumnForString(area_name, "dungeon_area", space_dungeon_data.DUNGEON_DATATABLE);
        return dungeon_row > -1;
    }
    public static void registerObjectWithDungeon(obj_id dungeon, obj_id registeringObject)
    {
    ...
    public static obj_id[] getRegisteredObjects(obj_id dungeon)
    {
        Vector registered = utils.getResizeableObjIdArrayScriptVar(dungeon, VAR_REGISTERED_OBJECTS);
        if (null == registered)
        {
    ...
    public static obj_id[] getParticipantIds(obj_id dungeon)
    {
    ...
    public static int calculateNextMessage(obj_id dungeon)
    {
    ...
    public static void setInstanceControllerIdOnPlayer(obj_id player, obj_id controllerObject)
    {
        setObjVar(player, INSTANCE_ID, controllerObject);
    }
    public static void removeInstanceControllerId(obj_id player)
    {
        if (hasObjVar(player, INSTANCE_ID))
        {
            removeObjVar(player, INSTANCE_ID);
    ...
    public static obj_id getInstanceControllerId(obj_id player)
    {
        if (hasObjVar(player, INSTANCE_ID))
        {
    ...
    public static boolean validateInstanceControllerId(obj_id player)
    {
        if (!hasObjVar(player, INSTANCE_ID))
        {
    ...
    public static boolean isCloningInstance(obj_id player)
    {
    ...
    public static boolean isInValidInstance(obj_id player)
    {
        return validateInstanceControllerId(player);
    }
    public static void handleInstanceClone(obj_id player)
    {
        String dataTable = cloninglib.DATATABLE_CLONE_SPAWN;
        if (!hasObjVar(player, INSTANCE_ID))
        {
    ...
    public static int pollZoneOccupantsForInstancePopulation(obj_id controller)
    {
    ...
    public static obj_id[] getPlayersInInstance(obj_id controller)
    {
    ...
    public static void setDungeonLockoutTimer(obj_id player, obj_id dungeon, int lockoutTime)
    {
        String dungeonName = getDungeonName(dungeon);
        setDungeonLockoutTimer(player, dungeonName, lockoutTime);
    }
    public static void setDungeonLockoutTimer(obj_id player, String dungeonName, int lockoutTime)
    {
    ...
    public static void setDungeonLockoutTimer(obj_id player, obj_id dungeon)
    {
        String dungeonName = getDungeonName(dungeon);
    ...
    public static void setDungeonLockoutTimer(obj_id[] players, obj_id dungeon)
    {
    ...
    public static void setDungeonLockoutTimer(obj_id[] players, obj_id dungeon, int time)
    {
        if (players == null || players.length == 0 || !isIdValid(dungeon))
        {
            return;
    ...
    public static void setDungeonLockoutTimer(obj_id dungeon)
    {
        if (!isIdValid(dungeon))
        {
            return;
    ...
    public static void setDungeonLockoutTimer(obj_id dungeon, int time)
    {
        if (!isIdValid(dungeon))
        {
            return;
    ...
    public static void addToDungeonLockoutTimer(obj_id player, obj_id dungeon, int time)
    {
        String dungeonName = getDungeonName(dungeon);
        addToDungeonLockoutTimer(player, dungeonName, time);
    }
    public static void addToDungeonLockoutTimer(obj_id player, String dungeonName, int time)
    {
    ...
    public static void addToDungeonLockoutTimer(obj_id[] players, obj_id dungeon, int time)
    {
        if (players == null || players.length == 0)
        {
            return;
    ...
    public static boolean validateInstanceTimerForPlayer(obj_id player, String dungeonName)
    {
        if (!hasObjVar(player, LIST_DUNGEON_LOCKOUT + dungeonName))
        {
            return true;
    ...
    public static boolean isDungeonLockoutTimerExpired(obj_id player, obj_id dungeon)
    {
    ...
    public static boolean isDungeonLockoutTimerExpired(obj_id player, String dungeonName)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static boolean isDungeonLockoutTimerExpired(obj_id players[], String dungeonName)
    {
        if (players == null || players.length == 0)
        {
            return false;
    ...
    public static boolean isDungeonLockoutTimerExpired(obj_id players[], obj_id dungeon)
    {
        if (players == null || players.length == 0 || !isIdValid(dungeon))
        {
            return false;
    ...
    public static int getDungeonLockoutTime(obj_id player, obj_id dungeon)
    {
        String dungeonName = getDungeonName(dungeon);
        return getDungeonLockoutTime(player, dungeonName);
    }
    public static int getDungeonLockoutTime(obj_id player, String dungeonName)
    {
        if (hasObjVar(player, LIST_DUNGEON_LOCKOUT + dungeonName))
        {
    ...
    public static void clearDungeonLockoutTimer(obj_id player, String dungeonName)
    {
        if (!isIdValid(player))
        {
            return;
    ...
    public static void clearDungeonLockoutTimer(obj_id player, obj_id dungeon)
    {
        if (!isIdValid(player) || !isIdValid(dungeon))
        {
            return;
    ...
    public static void clearAllDungeonLockoutTimers(obj_id player)
    {
        if (!isIdValid(player))
        {
            return;
    ...
    public static void clearAllDungeonLockoutTimers(obj_id[] players)
    {
        if (players == null || players.length == 0)
        {
            return;
    ...
    public static void displayDungeonLockoutTimerSUI(obj_id player, String dungeonName)
    {
        obj_id groupId = getGroupObject(player);
        if (!isIdValid(groupId))
        {
    ...
    public static void displayDungeonLockoutTimerSUI(obj_id player, obj_id dungeon)
    {
        if (!isIdValid(player) || !isIdValid(dungeon))
        {
            return;
    ...
    public static void displayDungeonLockoutTimerSUI(obj_id[] players, String dungeonName)
    {
        if (players == null || players.length == 0)
        {
            return;
    ...
    public static String[] getTimeLockedPlayers(obj_id[] players, String dungeonName)
    {
        if (players == null || players.length == 0)
        {
            return null;
    ...
    public static void displayAllDungeonLockoutTimers(obj_id player)
    {
