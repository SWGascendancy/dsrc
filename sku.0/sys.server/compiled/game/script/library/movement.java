...
public class movement extends script.base_script
{
    ...
    public static boolean refresh(obj_id target)
    {
    ...
    public static boolean canApplyMovementModifier(obj_id target, String name)
    {
        if (!isIdValid(target))
        {
            return false;
    ...
    public static boolean applyMovementModifier(obj_id target, String name)
    {
        return applyMovementModifier(target, name, -1.0f);
    }
    public static boolean applyMovementModifier(obj_id target, String name, float strength)
    {
        if (!isIdValid(target))
        {
            return false;
    ...
    public static boolean removeMovementModifier(obj_id target, String name, boolean recalculate)
    {
        if (!isIdValid(target))
        {
            return false;
    ...
    public static boolean removeAllModifiers(obj_id target)
    {
    ...
    public static boolean removeAllModifiersOfType(obj_id target, int type) {
        String[] mods = getAllModifiers(target);
        if (mods == null || mods.length == 0) {
            return false;
        }
    ...
    public static boolean hasMovementModifier(obj_id target)
    {
    ...
    public static boolean hasMovementModifier(obj_id target, String name)
    {
    ...
    public static int getType(int nameCrc)
    {
    ...
    public static float getStrength(String name)
    {
        return getStrength(getStringCrc(name.toLowerCase()));
    }
    public static float getStrength(int nameCrc)
    {
        int row = dataTableSearchColumnForInt(nameCrc, "name", MOVEMENT_TABLE);
        if (row >= 0)
        {
    ...
    public static float getCurrentStrength(obj_id target, String name)
    {
    ...
    public static boolean isValidModifier(int nameCrc)
    {
    ...
    public static boolean isRoot(int nameCrc) {
        int row = dataTableSearchColumnForInt(nameCrc, "name", MOVEMENT_TABLE);
        return row >= 0 && (dataTableGetInt(MOVEMENT_TABLE, row, "type") == MT_ROOT);
    }
    public static boolean isSnare(String name)
    {
        return isSnare(getStringCrc(name.toLowerCase()));
    }
    public static boolean isSnare(int nameCrc)
    {
        int row = dataTableSearchColumnForInt(nameCrc, "name", MOVEMENT_TABLE);
        if (row >= 0)
        {
    ...
    public static String[] getAllStunEffects(obj_id target)
    {
        String[] movementMods = getAllModifiers(target);
        if (movementMods == null || movementMods.length == 0)
        {
    ...
    public static String[] getAllModifiers(obj_id target)
    {
    ...
    public static float _getMovementPercentageAdjustment(obj_id target, String name)
    {
    ...
    public static float _recalculateMovementModifiers(obj_id target)
    {
        String[] mods = getAllModifiers(target);
    ...
    public static boolean checkForMovementImmunity(obj_id target, String name)
    {
    ...
    public static boolean testStunEffects(obj_id target)
    {
        boolean isStunned = hasStunEffect(target);
        setState(target, STATE_STUNNED, isStunned);
        return isStunned;
    }
    public static void updateMovementImmunity(obj_id target)
    {
    ...
    public static void performWalk(obj_id actor)
    {
        removeObjVar(actor, "run");
        setMovementPercent(actor, 1.0f);
        setMovementWalk(actor);
    }
    public static void performRun(obj_id actor, String speed)
    {
        removeObjVar(actor, "run");
    ...
    public static void performRun(obj_id actor, float rate)
    {
        removeObjVar(actor, "run");
        setObjVar(actor, "run", rate);
        setMovementPercent(actor, rate);
