...
public class healing extends script.base_script
{
    ...
    public static boolean performHealDamage(attacker_data attackerData, defender_data[] defenderData, combat_data action_data)
    {
    ...
    public static boolean applyDefenderHealBuffs(obj_id medic, obj_id defender, combat_data actionData)
    {
    ...
    public static boolean applyMedicHealBuffs(obj_id medic, combat_data actionData)
    {
        String actionName = actionData.actionName;
    ...
    public static boolean performHealOverTime(attacker_data attackerData, defender_data[] defenderData, combat_data action_data)
    {
        obj_id medic = attackerData.id;
    ...
    public static int getExpertiseModifiedHealing(obj_id medic, int toHeal, combat_data action_data)
    {
        String specialLine = action_data.specialLine;
    ...
    public static int getHealingAfterReductions(obj_id medic, obj_id target, int toHeal)
    {
    ...
    public static int getTargetHealingBonus(obj_id medic, obj_id target, int toHeal)
    {
    ...
    public static boolean canUseAbility(obj_id medic, combat_data actionData)
    {
        return true;
    }
    public static boolean useHealDamageItem(obj_id user, obj_id item)
    {
        return useHealDamageItem(user, user, item);
    }
    public static boolean useHealDamageItem(obj_id user, obj_id item, int attrib)
    {
        return useHealDamageItem(user, user, item, attrib);
    }
    public static boolean useHealDamageItem(obj_id user, obj_id target, obj_id item)
    {
        return useHealDamageItem(user, target, item, HEALTH);
    }
    public static boolean useHealDamageItem(obj_id user, obj_id target, obj_id item, int attrib)
    {
    ...
    public static boolean useChannelHealItem(obj_id user, obj_id item)
    {
    ...
    public static boolean useHealPetItem(obj_id user, obj_id pet, obj_id item)
    {
        if (!isIdValid(user))
        {
            return false;
    ...
    public static boolean canDoBeastHeal(obj_id user, obj_id pet)
    {
    ...
    public static boolean doBeastHeal(obj_id user, obj_id pet, int toHeal)
    {
    ...
    public static boolean performRevivePlayer(attacker_data attackerData, defender_data[] defenderData, combat_data actionData, boolean weak)
    {
        obj_id medic = attackerData.id;
    ...
    public static boolean _performRevivePlayer(obj_id medic, obj_id[] targets, obj_id enhancer, combat_data action_data, boolean weak)
    {
    ...
    public static void _addMedicalHate(obj_id medic, obj_id target, int hate)
    {
        _addMedicalHate(medic, target, hate, 1.0f);
    }
    public static void _addMedicalHate(obj_id medic, obj_id target, int hate, float hateMod)
    {
        ...
        {
            if (!isIdValid(hateList[i]) || !isTangible(hateList[i]) || !isTangible(medic))
            {
                continue;
            }
            if (medic == hateList[i])
    ...
    public static float _getEnhancerModifier(obj_id enhancer, float cap)
    {
    ...
    public static float _getSkillModModifier(obj_id medic, String skill_mod, float coeff)
    {
        if (coeff <= 0.0f)
        {
            coeff = 1.0f;
    ...
    public static float _getMedicalDroidModifier(obj_id medic)
    {
        float droidMod = 0.0f;
    ...
    public static float _getShockWoundModifier(obj_id target)
    {
        return 1.0f;
    }
    public static void _healingActionFollowUp(obj_id medic, obj_id target, int delta, int type)
    {
    ...
    public static Vector getCombatStates(obj_id target)
    {
        Vector vStates = new Vector();
        return vStates;
    }
    public static boolean isDotted(obj_id target, String dot_type)
    {
    ...
    public static void startHealOverTime(obj_id target, float duration, float tick, int healPerTick)
    {
        startHealOverTime(obj_id.NULL_ID, target, "", duration, tick, healPerTick, false);
    }
    public static void startHealOverTime(obj_id medic, obj_id target, String actionName, float duration, float tick, int healPerTick, boolean combatFollowUp)
    {
        if (!isIdValid(target))
        {
            return;
    ...
    public static boolean isAwake(obj_id target)
    {
    ...
    public static boolean fullHeal(obj_id player)
    {
    ...
    public static boolean fullHealEveryone(obj_id creature)
    {
    ...
    public static boolean healDamage(obj_id player, int amt)
    {
        return healDamage(player, HEALTH, amt);
    }
    public static boolean healDamage(obj_id player, int attrib, int amt)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static boolean healClone(obj_id player, boolean woundPlayer)
    {
        if (!isIdValid(player) || (!isPlayer(player)))
        {
            return false;
    ...
    public static boolean healClone(obj_id player)
    {
        return healClone(player, true);
    }
    public static void sendMedicalSpam(obj_id medic, string_id message, int spam_type)
    {
        sendCombatSpamMessage(medic, message, spam_type);
    }
    public static void sendMedicalSpam(obj_id medic, obj_id target, string_id message, boolean to_attacker, boolean to_defender, boolean to_others, int spam_type)
    {
        if (medic == target)
        {
    ...
    public static void sendMedicalSpam(obj_id medic, prose_package pp, int spam_type)
    {
        sendCombatSpamMessageProse(medic, pp, spam_type);
    }
    public static void sendMedicalSpam(obj_id medic, obj_id target, prose_package pp, boolean to_attacker, boolean to_defender, boolean to_others, int spam_type)
    {
        if (medic == target)
        {
    ...
    public static String[] assembleHealingMessage(int attrib, int delta, obj_id doctor, obj_id target, int heal_type)
    {
    ...
    public static String[] assembleHealingMessage(int[] attribsArray, int[] deltaArray, obj_id doctor, obj_id target, obj_id medicine)
    {
        return assembleHealingMessage(attribsArray, deltaArray, doctor, target, medicine, 1);
    }
    public static String[] assembleHealingMessage(int[] attribsArray, int[] deltaArray, obj_id doctor, obj_id target, obj_id medicine, int heal_type)
    {
    ...
    public static boolean grantHealingExperience(int[] healed_damage, obj_id player, String heal_type)
    {
        return grantHealingExperience(healed_damage, player, null, heal_type);
    }
    public static boolean grantHealingExperience(int[] healed_damage, obj_id player, obj_id target, String heal_type)
    {
    ...
    public static boolean assignHealingCombatCredit(obj_id player, obj_id target, String xp_type, int amount)
    {
    ...
    public static boolean isDamaged(obj_id player)
    {
        return isDamaged(player, HEALTH);
    }
    public static boolean isDamaged(obj_id player, int attrib)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static boolean isWounded(obj_id player, int wound_type)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static boolean performDotRemoval(obj_id medic, obj_id target, String heal_type, obj_id med_obj)
    {
        if (!isIdValid(medic))
        {
            return false;
    ...
    public static boolean performFirstAid(obj_id medic, obj_id target)
    {
        return performDotRemoval(medic, target, HEAL_TYPE_MEDICAL_FIRSTAID, null);
    }
    public static boolean performCurePoison(obj_id medic, obj_id target, obj_id med_obj)
    {
        return performDotRemoval(medic, target, HEAL_TYPE_MEDICAL_CURE_POISON, med_obj);
    }
    public static boolean performCureFire(obj_id medic, obj_id target, obj_id med_obj)
    {
        return performDotRemoval(medic, target, HEAL_TYPE_MEDICAL_CURE_FIRE, med_obj);
    }
    public static boolean performCureDisease(obj_id medic, obj_id target, obj_id med_obj)
    {
        return performDotRemoval(medic, target, HEAL_TYPE_MEDICAL_CURE_DISEASE, med_obj);
    }
    public static boolean performApplyPosion(obj_id medic, obj_id target, obj_id med_obj)
    {
        return performDotApplication(medic, target, HEAL_TYPE_MEDICAL_APPLY_POISON, med_obj);
    }
    public static boolean performApplyDisease(obj_id medic, obj_id target, obj_id med_obj)
    {
        return performDotApplication(medic, target, HEAL_TYPE_MEDICAL_APPLY_DISEASE, med_obj);
    }
    public static obj_id getRevivePack(obj_id medic)
    {
        if (!isIdValid(medic))
        {
            return null;
    ...
    public static boolean isRevivePack(obj_id pack)
    {
        return isRevivePack(pack, "");
    }
    public static boolean isRevivePack(obj_id pack, String prefix)
    {
        if (!isIdValid(pack))
        {
            return false;
    ...
    public static boolean resuscitatePlayer(obj_id medic, obj_id target, obj_id pack)
    {
    ...
    public static boolean resuscitatePlayer(obj_id medic, obj_id target)
    {
        return resuscitatePlayer(medic, target, null);
    }
    public static float getDragPlayerRange(obj_id medic)
    {
        if (!isIdValid(medic))
        {
            return -1f;
    ...
    public static boolean playRangedAnimation(obj_id medic, obj_id target, obj_id med_obj, String[] animation)
    {
        if (!isIdValid(medic))
        {
            return false;
    ...
    public static void playHealDamageEffect(location loc)
    {
        if (loc == null)
        {
            return;
    ...
    public static void playHealWoundEffect(location loc)
    {
        if (loc == null)
        {
            return;
    ...
    public static void playHealStateEffect(location loc)
    {
        if (loc == null)
        {
            return;
    ...
    public static void playHealEnhanceEffect(location loc)
    {
        if (loc == null)
        {
            return;
    ...
    public static void playApplyPoisonEffect(location loc)
    {
        if (loc == null)
        {
            return;
    ...
    public static void playApplyAreaPoisonEffect(location loc)
    {
        if (loc == null)
        {
            return;
    ...
    public static void playApplyDiseaseEffect(location loc)
    {
        if (loc == null)
        {
            return;
    ...
    public static void playApplyAreaDiseaseEffect(location loc)
    {
        if (loc == null)
        {
            return;
    ...
    public static boolean canDiagnose(obj_id medic, obj_id target)
    {
        if (!isIdValid(target))
        {
            return false;
    ...
    public static void addHealingKillCredit(obj_id medic, obj_id target, int[] delta)
    {
        if (!isIdValid(medic))
        {
            return;
    ...
    public static obj_id findDroidWoundMed(obj_id player)
    {
        if (!isIdValid(player))
        {
            return null;
    ...
    public static obj_id findDroidDamageMed(obj_id player)
    {
        if (!isIdValid(player))
        {
            return null;
    ...
    public static int[] distributeHAMWoundHealingPoints(obj_id patient, int total)
    {
    ...
    public static int[] distributeHAMDamageHealingPoints(obj_id patient, int total)
    {
        int[] toHeal = new int[3];
        toHeal[0] = total;
        toHeal[1] = 0;
    ...
    public static boolean isDroidWounded(obj_id patient)
    {
    ...
    public static boolean isDroidDamaged(obj_id patient)
    {
    ...
    public static boolean performDroidRepair(obj_id medic, obj_id target, obj_id med_obj, boolean pay_cost)
    {
        if (!isIdValid(medic))
        {
            return false;
    ...
    public static obj_id findStimpackDispensorDroid(obj_id player)
    {
        if (!isIdValid(player))
        {
            return null;
    ...
    public static boolean isMedicine(obj_id object)
    {
        return isMedicine(object, "");
    }
    public static boolean isMedicine(obj_id object, String prefix)
    {
        if (!isIdValid(object))
        {
            return false;
    ...
    public static boolean isRangedMedicine(obj_id object)
    {
        return isRangedMedicine(object, "", false);
    }
    public static boolean isRangedMedicine(obj_id object, String prefix, boolean inDocBag)
    {
        if (!isIdValid(object))
        {
            return false;
    ...
    public static boolean isAreaMedicine(obj_id object)
    {
        if (!isIdValid(object))
        {
            return false;
    ...
    public static boolean isHealDamageMedicine(obj_id medicine)
    {
        return isHealDamageMedicine(medicine, "");
    }
    public static boolean isHealDamageMedicine(obj_id medicine, String prefix)
    {
        if (!isIdValid(medicine))
        {
            return false;
    ...
    public static boolean isHealStateMedicine(obj_id medicine)
    {
        return isHealStateMedicine(medicine, "");
    }
    public static boolean isHealStateMedicine(obj_id medicine, String prefix)
    {
        if (!isIdValid(medicine))
        {
            return false;
    ...
    public static boolean isBuffMedicine(obj_id medicine)
    {
        return isBuffMedicine(medicine, "");
    }
    public static boolean isBuffMedicine(obj_id medicine, String prefix)
    {
        if (!isIdValid(medicine))
        {
            return false;
    ...
    public static boolean isCureDotMedicine(obj_id medicine)
    {
        if (!isIdValid(medicine))
        {
            return false;
    ...
    public static boolean isApplyDotMedicine(obj_id medicine)
    {
        if (!isIdValid(medicine))
        {
            return false;
    ...
    public static boolean isCurePoisonMedicine(obj_id medicine)
    {
        if (!isIdValid(medicine))
        {
            return false;
    ...
    public static boolean isCureFireMedicine(obj_id medicine)
    {
        if (!isIdValid(medicine))
        {
            return false;
    ...
    public static boolean isCureDiseaseMedicine(obj_id medicine)
    {
        if (!isIdValid(medicine))
        {
            return false;
    ...
    public static boolean isApplyPoisonMedicine(obj_id medicine)
    {
        if (!isIdValid(medicine))
        {
            return false;
    ...
    public static boolean isApplyDiseaseMedicine(obj_id medicine)
    {
        if (!isIdValid(medicine))
        {
            return false;
    ...
    public static int getHealingRange(obj_id medicine)
    {
        if (!isIdValid(medicine))
        {
            return 0;
    ...
    public static int getHealingArea(obj_id medicine)
    {
        if (!isIdValid(medicine))
        {
            return 0;
    ...
    public static String getHealingState(obj_id medicine)
    {
        return getHealingState(medicine, "");
    }
    public static String getHealingState(obj_id medicine, String prefix)
    {
        if (!isIdValid(medicine))
        {
            return null;
    ...
    public static String getCureDot(obj_id medicine)
    {
        return getCureDot(medicine, "");
    }
    public static String getCureDot(obj_id medicine, String prefix)
    {
        if (!isIdValid(medicine))
        {
            return null;
    ...
    public static String getApplyDot(obj_id medicine)
    {
        return getApplyDot(medicine, "");
    }
    public static String getApplyDot(obj_id medicine, String prefix)
    {
        if (!isIdValid(medicine))
        {
            return null;
    ...
    public static int getDotPower(obj_id medicine)
    {
        if (!isIdValid(medicine))
        {
            return -1;
    ...
    public static int getDotPotency(obj_id medicine)
    {
        if (!isIdValid(medicine))
        {
            return -1;
    ...
    public static String getDotId(obj_id medicine)
    {
        if (!isIdValid(medicine))
        {
            return null;
    ...
    public static int getDotAttribute(obj_id medicine)
    {
        if (!isIdValid(medicine))
        {
            return -1;
    ...
    public static int getDotDuration(obj_id medicine)
    {
        if (!isIdValid(medicine))
        {
            return -1;
    ...
    public static float getHealingMultiplier(obj_id player, obj_id item, String type)
    {
    ...
    public static float getHealingMultiplier(obj_id player, obj_id item)
    {
    ...
    public static boolean hasEnhancement(obj_id player, int attribute)
    {
        if (!isIdValid(player))
        {
            return true;
    ...
    public static int getHealEnhanceValue(obj_id player, int attribute)
    {
        if (!isIdValid(player))
        {
            return -1;
    ...
    public static float applyShockWoundModifier(float multiplier, obj_id player)
    {
    ...
    public static attrib_mod[] modifyMedicineAttributes(attrib_mod[] am, float multiplier)
    {
    ...
    public static boolean canHealDamage(obj_id player, boolean verbose)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static boolean canHealDamage(obj_id player)
    {
        return canHealDamage(player, true);
    }
    public static boolean canHealWound(obj_id player, boolean verbose)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static boolean canHealWound(obj_id player)
    {
        return canHealWound(player, true);
    }
    public static boolean canPayHealingCost(obj_id player, String heal_type, float modifier)
    {
    ...
    public static float setCanHealDamage(obj_id player, int roundtime)
    {
        if (!isIdValid(player))
        {
            return -1f;
    ...
    public static boolean setCanHealWound(obj_id player, int roundtime)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static obj_id findHealDamageMedicine(obj_id player, obj_id target)
    {
        obj_id med_obj = null;
        if (!isIdValid(player))
        {
    ...
    public static obj_id findHealDamageMedicine(obj_id player)
    {
        return findHealDamageMedicine(player, null);
    }
    public static obj_id findHealWoundMedicine(obj_id player, int wound_type)
    {
        obj_id med_obj = null;
        if (!isIdValid(player))
        {
    ...
    public static obj_id findHealStateMedicine(obj_id player, int state_type)
    {
        obj_id med_obj = null;
    ...
    public static obj_id findBuffMedicine(obj_id player, int buff_type)
    {
        if (player == null || player == obj_id.NULL_ID)
        {
            return null;
    ...
    public static obj_id findCureDotMedicine(obj_id player, String dot_type)
    {
        obj_id med_obj = null;
        if (!isIdValid(player))
        {
    ...
    public static obj_id findApplyDotMedicine(obj_id player, String dot_type)
    {
        obj_id med_obj = null;
        if (!isIdValid(player))
        {
    ...
    public static boolean hasCombatState(obj_id player, int state_type)
    {
        return false;
    }
    public static int findLargestWoundHeal(obj_id patient, obj_id doctor)
    {
        return -1;
    }
    public static int findLargestTendWound(obj_id patient)
    {
        return -1;
    }
    public static int findWorstState(obj_id patient, obj_id doctor)
    {
        return -1;
    }
    public static int stringToAttribute(String attribute_str)
    {
        int attribute_int = -1;
    ...
    public static String attributeToString(int attribute_int)
    {
    ...
    public static int stringToState(String state_str)
    {
    ...
    public static String stateTypeToString(int state_type)
    {
        if ((state_type < 12) || (state_type > 15))
        {
            return null;
    ...
    public static boolean performMedicalHealDamage(obj_id medic, obj_id target, obj_id med_obj, boolean pay_cost)
    {
        if (!isIdValid(medic))
        {
            return false;
    ...
    public static boolean performMedicalHealDamage(obj_id medic, obj_id target, obj_id med_obj)
    {
        return performMedicalHealDamage(medic, target, med_obj, true);
    }
    public static obj_id[] getHealableTargetsInArea(obj_id medic, location loc, int radius)
    {
        if (loc == null)
        {
            return null;
    ...
    public static obj_id[] getAttackableTargetsInArea(obj_id medic, location loc, int radius)
    {
        if (loc == null)
        {
            return null;
    ...
    public static boolean applyHealingCost(obj_id player, String heal_type, float modifier)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static boolean performHealState(obj_id medic, obj_id target, obj_id med_obj)
    {
        return false;
    }
    public static boolean performHealEnhance(obj_id medic, obj_id target, obj_id med_obj)
    {
    ...
    public static boolean addHealingBuffIcon(obj_id target, int attribute, float duration)
    {
        if (!isIdValid(target))
        {
            return false;
    ...
    public static obj_id findPetDamageMed(obj_id player)
    {
        if (!isIdValid(player))
        {
            return null;
    ...
    public static obj_id findPetVitalityMed(obj_id player)
    {
        if (!isIdValid(player))
        {
            return null;
    ...
    public static boolean performTendWoundsFromTool(obj_id medic, obj_id target, int attribute, obj_id medikit)
    {
        if (!isIdValid(medic))
        {
            return false;
    ...
    public static boolean performQuickHealTool(obj_id medic, obj_id target, boolean tend_damage, obj_id medikit)
    {
        if (!isIdValid(medic))
        {
            return false;
    ...
    public static boolean isAdvancedTool(obj_id target)
    {
        if (!isIdValid(target))
        {
            return false;
    ...
    public static boolean hasCertification(obj_id objPlayer, obj_id objMedikit)
    {
    ...
    public static boolean isMedikit(obj_id object)
    {
        if (!isIdValid(object))
        {
            return false;
    ...
    public static obj_id findMedikit(obj_id player)
    {
        if (!isIdValid(player))
        {
            return null;
    ...
    public static void doHealingAnimationAndEffect(obj_id user, obj_id target)
    {
        if (user == target)
        {
    ...
    public static boolean isValidHealTarget(obj_id target)
    {
    ...
    public static boolean isValidHealTarget(obj_id healer, obj_id target)
    {
    ...
    public static void applyLifeSiphonHeal(obj_id attacker, obj_id defender, int damage, float percentToHeal, String actionName)
    {
        applyLifeSiphonHeal(attacker, defender, damage, percentToHeal, actionName, false);
    }
    public static void applyLifeSiphonHeal(obj_id attacker, obj_id defender, int damage, float percentToHeal, String actionName, boolean healMaster)
    {
        if (percentToHeal > 0)
        {
    ...
    public static int doDiminishingReturns(int toHeal, obj_id medic)
    {
