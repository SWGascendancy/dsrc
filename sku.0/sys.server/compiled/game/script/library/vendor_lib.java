...
public class vendor_lib extends script.base_script
{
    ...
    public static boolean payMaintenance(obj_id player, obj_id vendor, int amt)
    {
    ...
    public static boolean withdrawMaintenance(obj_id player, obj_id vendor, int amt)
    {
        if (player == null || player == obj_id.NULL_ID)
        {
            return false;
    ...
    public static int decrementMaintenancePool(obj_id vendor, int amt)
    {
        if (vendor == null || vendor == obj_id.NULL_ID)
        {
            return -1;
    ...
    public static int damageVendor(obj_id vendor, int amt)
    {
        if (vendor == null || vendor == obj_id.NULL_ID)
        {
            return -1;
    ...
    public static int repairVendor(obj_id vendor, int amt)
    {
        if (vendor == null || vendor == obj_id.NULL_ID)
        {
            return -1;
    ...
    public static int getMaintenanceRate(obj_id vendor)
    {
        return getIntObjVar(vendor, VAR_MAINTENANCE_RATE);
    }
    public static int getMaintenancePool(obj_id vendor)
    {
        return getBankBalance(vendor);
    }
    public static int getDecayRate(obj_id vendor)
    {
        return getIntObjVar(vendor, VAR_DECAY_RATE);
    }
    public static int getVendorCondition(obj_id vendor)
    {
        return getIntObjVar(vendor, VAR_CONDITION);
    }
    public static int getMaxCondition(obj_id vendor)
    {
        return getIntObjVar(vendor, VAR_MAX_CONDITION);
    }
    public static void finalizePackUp(obj_id player, obj_id vendor, obj_id packer, boolean isAbandoned)
    {
        obj_id vcd;
        obj_id datapad;
    ...
    public static boolean isVendorPackUpEnabled()
    {
        return true;
    }
    public static obj_id getAuctionContainer(obj_id vendor)
    {
    ...
    public static boolean isNpcVendor(obj_id vendor)
    {
        return getAuctionContainer(vendor) != vendor;
    }
    public static String[] getAllGreeterDatatableColumnNames(obj_id object, String datatablePath)
    {
    ...
    public static boolean buildNpcInPlayerStructure(obj_id controller, obj_id player, String npcType, boolean newGreeter)
    {
    ...
    public static boolean buildNpcInPlayerStructure(obj_id controller, obj_id owner, String npcType, location where, boolean newGreeter)
    {
        if (!isValidId(controller) || !exists(controller))
        {
            blog("vendor_lib.buildNpcInPlayerStructure: Unable to create a nonvendor: deed invalid.");
    ...
    public static boolean validateNpcPlacementInStructure(obj_id player)
    {
        if (!isValidId(player) || !exists(player))
        {
            return false;
    ...
    public static boolean validateNonVendorInStructure(obj_id nonVendor)
    {
    ...
    public static String getGreeterNonVendorCreatureType(obj_id object, String greeterOrNonVendorType)
    {
    ...
    public static boolean isSpecialVendor(obj_id object)
    {
        if (!isValidId(object) || !exists(object))
        {
            return false;
    ...
    public static obj_id setObjectOwner(obj_id controller)
    {
        if (!isValidId(controller) || !exists(controller))
        {
            return null;
    ...
    public static obj_id getObjectOwner(obj_id controller)
    {
        if (!isValidId(controller) || !exists(controller))
        {
            return null;
    ...
    public static boolean isControllerOrChildInValidLocation(obj_id controller)
    {
        if (!isValidId(controller) || !exists(controller))
        {
            return false;
    ...
    public static boolean isObjectInSameCellAsController(obj_id controller, obj_id object)
    {
        if (!isValidId(controller) || !exists(controller))
        {
            return false;
    ...
    public static boolean recreateObject(obj_id controller, obj_id player)
    {
    ...
    public static boolean recreateObjectAtLocation(obj_id controller, obj_id owner, location loc)
    {
    ...
    public static boolean removeObjectFromController(obj_id controller, obj_id greeter)
    {
        if (!isValidId(controller) || !exists(controller))
        {
            return false;
    ...
    public static boolean updateGreeterFunctionality(obj_id greeter)
    {
    ...
    public static boolean colorizeGreeterFromWidget(obj_id player, obj_id greeter, String params)
    {
        if (!isValidId(player) || !exists(player))
        {
            return false;
    ...
    public static boolean colorizeGreeterFromController(obj_id controller, obj_id greeter)
    {
        if (!isValidId(controller) || !exists(controller))
        {
            return false;
