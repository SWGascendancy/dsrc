...
public class pvp extends script.base_script
{
    ...
    public static obj_var[] _packageCombatWinners(obj_id victim)
    {
        if (!isIdValid(victim))
        {
    ...
    public static prose_package getPvPRatedProsePackage(obj_id winner, obj_id loser, boolean winnerPackage)
    {
        String[] phrases;
        obj_id actor;
        obj_id target;
    ...
    public static prose_package getPvPThrottleProsePackage(obj_id winner, obj_id loser, boolean winnerPackage)
    {
        String stringId;
        obj_id actor;
        obj_id target;
    ...
    public static prose_package getPvPRatingFloorProsePackage(obj_id winner, obj_id loser, boolean winnerPackage)
    {
        String stringId;
        obj_id actor;
        obj_id target;
    ...
    public static void adjustPvPPoints(obj_id victim)
    {
    ...
    public static boolean canAffectForceRankXPChange(obj_id victim, obj_id winner)
    {
    ...
    public static int getRawForceRankXPDelta(obj_id player, boolean playerWon, obj_id opponent)
    {
    ...
    public static int getAdjustedForceRankXPDelta(obj_id victim, obj_id killer, double percentContribution, boolean gettingVictimsDelta)
    {
    ...
    public static int getAdjustedPvPRatingDelta(obj_id loser, obj_id winner, double percentInvolvement, boolean gettingVictimsDelta)
    {
    ...
    public static int getCurrentPvPRating(obj_id player)
    {
        if (!isIdValid(player))
        {
    ...
    public static boolean setCurrentPvPRating(obj_id player, int rating)
    {
        if (!isIdValid(player))
        {
    ...
    public static int _massageDeltaWithRules(int delta, boolean wonFight)
    {
    ...
    public static int getPvPRatingDelta(int oldRating, int opponentRating, boolean wonFight)
    {
        int score = 1;
        if (!wonFight)
        {
    ...
    public static void updateDamageContributorList(obj_id target, obj_id attackr, int dam)
    {
    ...
    public static boolean hasKilledVictimRecently(obj_id attacker, obj_id victim)
    {
        boolean rslt = true;
    ...
    public static void registerPlayerKill(obj_id attacker, obj_id victim)
    {
    ...
    public static boolean cleanupCreditForPvPKills(obj_id whichPlayer)
    {
    ...
    public static void updatePvPDamageTimeStamp(obj_id player)
    {
        setupClearPvPDamageCallback(player);
        utils.setScriptVar(player, VAR_LAST_PVP_DAMAGE_TIME, getGameTime());
    }
    public static void setupClearPvPDamageCallback(obj_id player)
    {
    ...
    public static boolean isBountyHunter(obj_id player)
    {
        return hasSkill(player, "class_bountyhunter_phase2_novice");
    }
    public static boolean isPadawan(obj_id player)
    {
        return hasSkill(player, "force_title_jedi_rank_02");
    }
    public static boolean isInOpposingPvPFactions(obj_id player1, obj_id player2)
    {
    ...
    public static boolean updatePlayerDamageTracking(obj_id player, obj_id attacker, obj_id wpn, int[] damage)
    {
    ...
    public static boolean isPvpDamageSource(obj_id player, obj_id attacker)
    {
    ...
    public static void validatePlayerDamageTracking(obj_id player)
    {
        if (!isIdValid(player))
        {
            return;
    ...
    public static void clearPlayerDamageTracking(obj_id player)
    {
        if (!isIdValid(player))
        {
            return;
    ...
    public static boolean isPvpDeath(obj_id player)
    {
    ...
    public static void incrementPlayerDeathBounty(obj_id killer, obj_id victim)
    {
    ...
    public static void battlefieldWarp(obj_id player, location loc)
    {
    ...
    public static void bfActivePlayersAnnounce(obj_id controller, string_id announcement)
    {
    ...
    public static void bfMessagePlayers(obj_id controller, String faction, String message, dictionary params)
    {
        Vector players = new Vector();
        players.setSize(0);
    ...
    public static void bfMessagePlayersOnBattlefield(obj_id controller, String faction, String message, dictionary params)
    {
        Vector players = new Vector();
        players.setSize(0);
        if (utils.hasResizeableStringBatchScriptVar(controller, faction))
    ...
    public static Vector bfActiveAppendStatistics(obj_id controller, String scriptVar, Vector battlefieldTeams)
    {
    ...
    public static Vector bfActiveGetStatistics(obj_id controller)
    {
        if (!isIdValid(controller) || !exists(controller))
        {
            return null;
    ...
    public static String[][] bfStatisticsToArray(Vector battlefieldPlayers, boolean colored)
    {
    ...
    public static boolean bfIsValidAndEngaged(obj_id player)
    {
        if (!isIdValid(player) || !exists(player))
        {
            return false;
    ...
    public static void bfCreditForDamage(obj_id attacker, int damage)
    {
    ...
    public static void bfCreditForHealing(obj_id healer, int healed)
    {
    ...
    public static void bfCreditForKill(obj_id who)
    {
    ...
    public static void bfCreditForDeath(obj_id who, obj_id killer)
    {
        if (!bfIsValidAndEngaged(who))
        {
            return;
    ...
    public static void bfCreditForAssist(obj_id who)
    {
        if (!bfIsValidAndEngaged(who))
        {
            return;
    ...
    public static void bfCreditForCapture(obj_id who, int captureValue)
    {
        if (!bfIsValidAndEngaged(who))
        {
            return;
    ...
    public static boolean bfTerminalIsRegistered(obj_id controller, obj_id terminal)
    {
    ...
    public static void bfTerminalRegister(obj_id controller, obj_id terminal)
    {
    ...
    public static Vector bfTerminalsGetRegistered(obj_id controller)
    {
        if (!isIdValid(controller) || !exists(controller))
        {
            return null;
    ...
    public static boolean bfTerminalsReset(obj_id controller)
    {
        if (!isIdValid(controller) || !exists(controller))
        {
            return false;
    ...
    public static int bfGetBattlefieldType(obj_id controller)
    {
        if (!isIdValid(controller) || !exists(controller))
        {
    ...
    public static obj_id bfGetRunner(obj_id controller)
    {
        if (!isIdValid(controller) || !exists(controller))
        {
            return null;
    ...
    public static void bfSetRunner(obj_id controller, obj_id runner)
    {
    ...
    public static void bfClearRunner(obj_id controller)
    {
        if (!isIdValid(controller) || !exists(controller))
        {
            return;
    ...
    public static boolean bfHasRunner(obj_id controller)
    {
        if (!isIdValid(controller) || !exists(controller))
        {
            return false;
    ...
    public static void bfActiveWarpPlayerToStart(obj_id controller, obj_id player)
    {
        if (!isIdValid(controller) || !exists(controller))
        {
            return;
    ...
    public static void bfLog(obj_id controller, String text)
    {
        if (!isIdValid(controller))
        {
            return;
