...
public class instance extends script.base_script
{
    ...
    public static void registerInstance(obj_id instance_id)
    {
        registerInstance(instance_id, getInstanceName(instance_id));
    }
    public static void registerInstance(obj_id instance_id, String instanceName)
    {
        getClusterWideData("instance_manager-" + instanceName, instanceName + "_" + instance_id, true, instance_id);
    }
    public static boolean isInstanceActive(obj_id instance_id)
    {
        return false;
    }
    public static boolean isInInstanceArea(obj_id subject)
    {
    ...
    public static String getInstanceName(obj_id instance_id)
    {
        return getStringObjVar(instance_id, "instance_name");
    }
    public static int getInstancePlayerCap(obj_id instance_id)
    {
        return getInstancePlayerCap(getInstanceName(instance_id));
    }
    public static int getInstancePlayerCap(String instance_name)
    {
        return dataTableGetInt(INSTANCE_DATATABLE, instance_name, "max_players");
    }
    public static int getMinPlayers(obj_id instance_id)
    {
        return getMinPlayers(getInstanceName(instance_id));
    }
    public static int getMinPlayers(String instance_name)
    {
        return dataTableGetInt(INSTANCE_DATATABLE, instance_name, "min_players");
    }
    public static obj_id getInstanceOwner(obj_id instance_id)
    {
        return utils.hasScriptVar(instance_id, INSTANCE_OWNER) ? utils.getObjIdScriptVar(instance_id, INSTANCE_OWNER) : instance_id;
    }
    public static String getPlayerList(obj_id instance_id)
    {
        return getPlayerList(instance_id, 1);
    }
    public static String getPlayerList(obj_id instance_id, int groupNumber)
    {
    ...
    public static obj_id[] getPlayersInInstanceArea(obj_id instance_id)
    {
    ...
    public static obj_id[] getPlayersInInstanceArea(String area, int row)
    {
        return utils.getPlayersInBuildoutRow(area, row);
    }
    public static obj_id[] getPlayersByTeamList(obj_id[] allPlayers, String groupList)
    {
    ...
    public static boolean testNextPlayerInstanceCap(obj_id instance_id)
    {
        return testNextPlayerInstanceCap(instance_id, 1);
    }
    public static boolean testNextPlayerInstanceCap(obj_id instance_id, int team)
    {
    ...
    public static boolean isFlaggedForInstance(obj_id player, dictionary data)
    {
    ...
    public static boolean isFlaggedForInstance(obj_id player, String instance_key)
    {
    ...
    public static void flagPlayerForInstance(obj_id player, String instance_key)
    {
        setObjVar(player, PLAYER_INSTANCE_PROTECTED + "." + instance_key, 1);
    }
    public static void removePlayerFlagForInstance(obj_id player, String instance_key)
    {
        utils.removeObjVar(player, PLAYER_INSTANCE_PROTECTED + "." + instance_key);
    }
    public static boolean requestInstanceMovement(obj_id player, String instanceName)
    {
        return requestInstanceMovement(player, instanceName, 1, "default");
    }
    public static boolean requestInstanceMovement(obj_id player, String instanceName, String defaultTrigger)
    {
        return requestInstanceMovement(player, instanceName, 1, defaultTrigger);
    }
    public static boolean requestInstanceMovement(obj_id player, String instanceName, int team, String defaultTrigger)
    {
    ...
    public static int getInstanceRequestType(obj_id player)
    {
        return utils.hasScriptVar(player, REQUEST_TYPE) ? utils.getIntScriptVar(player, REQUEST_TYPE) : REQUEST_INVALID;
    }
    public static int getInstanceRequestTeam(obj_id player)
    {
        return utils.hasScriptVar(player, REQUEST_TEAM) ? utils.getIntScriptVar(player, REQUEST_TEAM) : REQUEST_INVALID;
    }
    public static boolean isPlayerOwnerGroupList(obj_id player, obj_id owner, obj_id instance_id, String groupList, int team, int instance_team)
    {
    ...
    public static void movePlayerToInstance(obj_id player, obj_id dungeon, String instance_name, obj_id owner, boolean startInstance)
    {
        movePlayerToInstance(player, dungeon, instance_name, owner, startInstance, 1);
    }
    public static void movePlayerToInstance(obj_id player, obj_id instance_id, String instance_name, obj_id owner, boolean startInstance, int team)
    {
    ...
    public static void addToPlayerList(obj_id instance, obj_id player)
    {
        addToPlayerList(instance, player, 1);
    }
    public static void addToPlayerList(obj_id instance, obj_id player, int group)
    {
    ...
    public static void removeFromPlayerList(obj_id instance_id, obj_id player)
    {
        removeFromPlayerList(instance_id, player, 1);
    }
    public static void removeFromPlayerList(obj_id instance_id, obj_id player, int group)
    {
    ...
    public static boolean isPlayerInPlayerList(obj_id player, String groupList)
    {
    ...
    public static obj_id[] getPlayersInPlayerList(String groupList)
    {
    ...
    public static void sendToEnterOne(obj_id player, obj_id instanceId, location instanceLoc, dictionary data)
    {
        playerEnterInstance(player, instanceId, instanceLoc, data, "enter_one");
    }
    public static void sendToEnterTwo(obj_id player, obj_id instanceId, location instanceLoc, dictionary data)
    {
        playerEnterInstance(player, instanceId, instanceLoc, data, "enter_two");
    }
    public static void playerEnterInstance(obj_id player, obj_id instanceId, location instanceLoc, dictionary data, String enterString)
    {
    ...
    public static void requestExitPlayer(obj_id instance, obj_id[] players, int team)
    {
        if (players == null || players.length == 0)
        {
            return;
    ...
    public static void requestExitPlayer(obj_id instance_id, obj_id player, int team)
    {
        String instance_name = instance.getInstanceName(instance_id);
        requestExitPlayer(instance_name, player, team);
    }
    public static void requestExitPlayer(String instance_name, obj_id player)
    {
        requestExitPlayer(instance_name, player, 1);
    }
    public static void requestExitPlayer(String instance_name, obj_id player, int team)
    {
    ...
    public static boolean inSameInstanceType(String instance_name, obj_id player)
    {
    ...
    public static void sendToExitOne(obj_id player, dictionary data)
    {
    ...
    public static void sendToExitTwo(obj_id player, dictionary data)
    {
    ...
    public static void startInstanceTimer(obj_id instance_id)
    {
        messageTo(instance_id, "startClock", null, 0.0f, false);
    }
    public static void closeOwnedInstance(obj_id player, String instanceName)
    {
    ...
    public static void closeInstance(obj_id owner, dictionary data)
    {
        obj_id instance_id = data.getObjId("instance_id");
        messageTo(instance_id, "endInstanceSession", data, 0.0f, false);
    }
    public static void closeInstance(obj_id instance_id)
    {
        messageTo(instance_id, "endInstanceSession", null, 0.0f, false);
    }
    public static int getInstanceDuration(obj_id instance_id)
    {
        String instance_name = getInstanceName(instance_id);
        return getInstanceDuration(instance_name);
    }
    public static int getInstanceDuration(String instance_name)
    {
        dictionary data = dataTableGetRow(instance.INSTANCE_DATATABLE, instance_name);
        return data.getInt("time_limit");
    }
    public static void validateDungeonParticipants(obj_id instance_id)
    {
    ...
    public static dictionary getNextClockTic(int time)
    {
        dictionary dict = new dictionary();
    ...
    public static void sendSoonToCloseWarining(obj_id instance_id, int timeLeft)
    {
        obj_id[] players = getPlayersInInstanceArea(instance_id);
        sendSoonToCloseWarining(instance_id, timeLeft, players);
    }
    public static void sendSoonToCloseWarining(obj_id instance, int timeLeft, obj_id[] players)
    {
        prose_package pp = prose.getPackage(SID_UNDER_FIVE_MINUTE_WARNING, timeLeft);
        utils.sendSystemMessageProse(players, pp);
    }
    public static void setClock(obj_id instance_id, int seconds)
    {
    ...
    public static boolean isExclusiveInstance(String instance_name)
    {
    ...
    public static void setResetDataOnPlayer(obj_id player, obj_id instance_id, obj_id owner, String instance_name, int start_time)
    {
        dictionary dict = dataTableGetRow(INSTANCE_DATATABLE, instance_name);
        if (dict == null || dict.isEmpty())
        {
    ...
    public static boolean isValidatedByLockoutData(obj_id player, obj_id instance_id, obj_id owner, String instance_name)
    {
    ...
    public static dictionary getLockoutData(obj_id player, String instance_name)
    {
    ...
    public static dictionary[] getAllLockoutData(obj_id player)
    {
    ...
    public static void attachInstanceScriptsOnPlayer(obj_id player, dictionary data)
    {
        if (data == null || data.isEmpty())
        {
    ...
    public static void removeInstanceScriptFromPlayer(obj_id player, dictionary data)
    {
        String scriptList = data.getString("player_script");
        if (scriptList.equals("none"))
        {
    ...
    public static void validateInstanceScriptsOnPlayer(obj_id player)
    {
    ...
    public static obj_id getAreaInstanceController(obj_id base_object)
    {
    ...
    public static boolean[] requestInstancePobGroup(obj_id[] players, String instance_name)
    {
    ...
    public static boolean vehicleAllowedInInstance(obj_id instance_id)
    {
        return vehicleAllowedInInstance(getInstanceName(instance_id));
    }
    public static boolean vehicleAllowedInInstance(String instance_name)
    {
        return dataTableGetInt(INSTANCE_DATATABLE, instance_name, "vehicle_allowed") == 1;
    }
    public static obj_id[] addToPlayerIdList(obj_id instance_id, obj_id player)
    {
    ...
    public static obj_id[] removeFromPlayerIdList(obj_id instance_id, obj_id player)
    {
        Vector playerList = new Vector();
        playerList.setSize(0);
        if (utils.hasScriptVar(instance_id, PLAYER_ID_LIST))
    ...
    public static obj_id[] getPlayerIdList(obj_id instance_id)
    {
    ...
    public static Vector getResizeablePlayerIdList(obj_id instance_id)
    {
    ...
    public static boolean isPlayerInPlayerList(obj_id instance_id, obj_id player)
    {
        Vector playerList = getResizeablePlayerIdList(instance_id);
        return playerList.contains(player);
    }
    public static void setRequestPending(obj_id player)
    {
        buff.applyBuff(player, REQUEST_BUFF);
    }
    public static void setRequestResolved(obj_id player)
    {
        buff.removeBuff(player, REQUEST_BUFF);
    }
    public static boolean isRequestPending(obj_id player)
    {
