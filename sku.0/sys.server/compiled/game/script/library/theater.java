...
public class theater extends script.base_script
{
    ...
    public static boolean canSpawnTheaterAtLocation(location loc)
    {
    ...
    public static boolean spawn(obj_id target)
    {
    ...
    public static obj_id[] spawnRadial(obj_id target)
    {
        float fltSize = 0;
        if ((target == null) || (target == obj_id.NULL_ID))
        {
    ...
    public static obj_id[] spawnDatatableOffset(obj_id target)
    {
        float fltSize = 0;
        if ((target == null) || (target == obj_id.NULL_ID))
        {
    ...
    public static void spawnDatatableOffsetQueued(obj_id target, int intIndex)
    {
        if ((target == null) || (target == obj_id.NULL_ID))
        {
            return;
    ...
    public static boolean shouldSpawn(String tpf)
    {
        switch (tpf) {
            case "object/tangible/poi/theater/poi_mob_spawner.iff":
            case "object/tangible/poi/theater/poi_objective_spawner.iff":
    ...
    public static boolean cleanup(obj_id target)
    {
