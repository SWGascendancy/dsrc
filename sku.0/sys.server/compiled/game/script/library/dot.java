...
public class dot extends script.base_script
{
    ...
    public static boolean canApplyDotType(obj_id target, String type)
    {
    ...
    public static boolean applyDotEffect(obj_id target, String type, String dot_id, int strength, int duration)
    {
        return applyDotEffect(target, null, type, dot_id, HEALTH, 100, strength, duration, true, null);
    }
    public static boolean applyDotEffect(obj_id target, String type, String dot_id, int attribute, int potency, int strength, int duration, boolean verbose)
    {
        return applyDotEffect(target, null, type, dot_id, attribute, potency, strength, duration, verbose, null);
    }
    public static boolean applyDotEffect(obj_id target, String type, String dot_id, int attribute, int potency, int strength, int duration)
    {
        return applyDotEffect(target, null, type, dot_id, attribute, potency, strength, duration, true, null);
    }
    public static boolean applyBleedingEffect(obj_id target, String dot_id, int attribute, int strength, int duration)
    {
        if (!isPlayer(target))
        {
    ...
    public static boolean applyFireEffect(obj_id target, String dot_id, int strength, int duration)
    {
        return applyDotEffect(target, null, DOT_FIRE, dot_id, HEALTH, 150, strength, duration, true, "bleedingStopped");
    }
    public static boolean applyDotEffect(obj_id target, obj_id attacker, String type, String dot_id, int attribute, int potency, int strength, int duration)
    {
        return applyDotEffect(target, attacker, type, dot_id, attribute, potency, strength, duration, true, null);
    }
    public static boolean applyBleedingEffect(obj_id target, obj_id attacker, String dot_id, int attribute, int strength, int duration)
    {
        if (!isPlayer(target))
        {
            if ((ai_lib.aiGetNiche(target) == NICHE_DROID) || ai_lib.isAndroid(target) || (ai_lib.aiGetNiche(target) == NICHE_VEHICLE) || (vehicle.isDriveableVehicle(target)))
    ...
    public static boolean applyFireEffect(obj_id target, obj_id attacker, String dot_id, int strength, int duration)
    {
        return applyDotEffect(target, attacker, DOT_FIRE, dot_id, HEALTH, 150, strength, duration, true, "bleedingStopped");
    }
    public static boolean removeDotEffect(obj_id target, String dot_id, boolean verbose)
    {
        if (!isIdValid(target))
        {
            return false;
    ...
    public static boolean removeDotEffect(obj_id target, String dot_id)
    {
        return removeDotEffect(target, dot_id, true);
    }
    public static boolean removeAllDots(obj_id target)
    {
        if (!isIdValid(target))
        {
            return false;
    ...
    public static boolean removeDotsOfType(obj_id target, String type)
    {
        if (!isIdValid(target))
        {
            return false;
    ...
    public static boolean _applyDiseaseDamage(obj_id target, String dot_id)
    {
    ...
    public static boolean applyCombatDots(obj_id attacker, obj_id defender, hit_result results, weapon_data weapon, float bleeding_mult)
    {
        if (!isIdValid(attacker))
        {
            return false;
    ...
    public static boolean modifyDotEffectStrength(obj_id target, String dot_id, int strength, boolean verbose)
    {
        if (!isIdValid(target))
        {
            return false;
    ...
    public static int reduceDotTypeStrength(obj_id target, String type, int strength)
    {
        if (!isIdValid(target))
        {
            return -1;
    ...
    public static boolean hasDotId(obj_id target, String dot_id)
    {
        if (!isIdValid(target))
        {
            return false;
    ...
    public static String getDotScriptVarName(String dot_id)
    {
        return VAR_DOT_ROOT + dot_id;
    }
    public static String[] getAllDots(obj_id target)
    {
        if (!isIdValid(target))
        {
            return null;
    ...
    public static String[] getAllDotsType(obj_id target, String type)
    {
        if (!isIdValid(target))
        {
            return null;
    ...
    public static String[] getAllDotsOwner(obj_id owner, obj_id target)
    {
        if (!isIdValid(target))
        {
            return null;
    ...
    public static void removeAllDotsOwner(obj_id owner, obj_id target)
    {
    ...
    public static boolean isBleeding(obj_id target)
    {
        if (!isIdValid(target))
        {
            return false;
    ...
    public static boolean isPoisoned(obj_id target)
    {
        if (!isIdValid(target))
        {
            return false;
    ...
    public static boolean isDiseased(obj_id target)
    {
        if (!isIdValid(target))
        {
            return false;
    ...
    public static boolean isOnFire(obj_id target)
    {
        if (!isIdValid(target))
        {
            return false;
    ...
    public static boolean isAcid(obj_id target)
    {
        if (!isIdValid(target))
        {
            return false;
    ...
    public static boolean isEnergy(obj_id target)
    {
        if (!isIdValid(target))
        {
            return false;
    ...
    public static String getDotType(obj_id target, String dot_id)
    {
        if (!isIdValid(target))
        {
            return null;
    ...
    public static int getDotAttribute(obj_id target, String dot_id)
    {
        if (!isIdValid(target))
        {
            return -1;
    ...
    public static int getDotPotency(obj_id source, String dot_id)
    {
        if (!isIdValid(source))
        {
            return -1;
    ...
    public static int getDotStrength(obj_id target, String dot_id)
    {
        if (!isIdValid(target))
        {
            return -1;
    ...
    public static int getDotDuration(obj_id target, String dot_id)
    {
        if (!isIdValid(target))
        {
            return -1;
    ...
    public static int getDotStartTime(obj_id target, String dot_id)
    {
        if (!isIdValid(target))
        {
            return -1;
    ...
    public static int getDotLastPulse(obj_id target, String dot_id)
    {
        if (!isIdValid(target))
        {
            return -1;
    ...
    public static String getDotHandler(obj_id target, String dot_id)
    {
        if (!isIdValid(target))
        {
            return null;
    ...
    public static obj_id getDotAttacker(obj_id target, String dot_id)
    {
        if (!isIdValid(target))
        {
            return null;
    ...
    public static int getDotPulse(obj_id target, String dot_id)
    {
        if (!isIdValid(target))
        {
            return -1;
    ...
    public static int getDotUses(obj_id source, String dot_id)
    {
        if (!isIdValid(source))
        {
            return -1;
    ...
    public static boolean addDotAttackToItem(obj_id item, String type, String dot_id, int attribute, int potency, int strength, int duration, boolean stackable, int uses)
    {
        if (!isIdValid(item))
        {
            return false;
    ...
    public static boolean decrementDotUses(obj_id item, String dot_id)
    {
        if (!isIdValid(item))
        {
            return false;
    ...
    public static void displayBleedingEffect(location loc)
    {
        if (loc == null)
        {
            return;
    ...
    public static void displayPoisonEffect(location loc)
    {
        if (loc == null)
        {
            return;
    ...
    public static void displayDiseaseEffect(location loc)
    {
        if (loc == null)
        {
            return;
    ...
    public static void displayFireEffect(location loc)
    {
        if (loc == null)
        {
            return;
    ...
    public static void displayAcidEffect(location loc)
    {
        if (loc == null)
        {
            return;
    ...
    public static void displayEnergyEffect(location loc)
    {
        if (loc == null)
        {
            return;
    ...
    public static int getElementalGroupResist(obj_id target, String type)
    {
    ...
    public static int getNaturalGroupResist(obj_id target, String type)
    {
    ...
    public static void capDots(obj_id attacker, obj_id target, int strength)
    {
    ...
    public static int getDotResistanceMod(String type, obj_id target)
    {
    ...
    public static boolean applyBuffDotEffect(obj_id target, obj_id attacker, String type, String dot_id, long stack, int attribute, int potency, int strength, int duration, boolean verbose, String buffName)
    {
        if (!isIdValid(attacker))
        {
            attacker = getSelf();
    ...
    public static boolean removeBuffDotEffect(obj_id target, String type, boolean verbose)
    {
        if (!isIdValid(target))
        {
            return false;
