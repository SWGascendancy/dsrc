...
public class permissions extends script.base_script
{
    ...
    public static boolean createPermissionsGroup(obj_id target, String group_name)
    {
        if (!isIdValid(target))
        {
    ...
    public static boolean deletePermissionsGroup(obj_id target, String group_name)
    {
        if (!isIdValid(target))
        {
    ...
    public static boolean addUserToPermissionsGroup(obj_id target, obj_id player, String player_name, String group_name)
    {
        if (!isIdValid(target))
        {
    ...
    public static boolean addUserToPermissionsGroup(obj_id target, obj_id player, String group_name)
    {
        return addUserToPermissionsGroup(target, player, getName(player), group_name);
    }
    public static boolean deleteUserFromPermissionsGroup(obj_id target, obj_id player, String group_name)
    {
        if (!isIdValid(target))
        {
    ...
    public static boolean addUserToBanned(obj_id target, obj_id player, String player_name)
    {
        if (!isIdValid(target))
        {
    ...
    public static boolean addUserToBanned(obj_id target, obj_id player)
    {
        return addUserToBanned(target, player, getName(player));
    }
    public static boolean deleteUserFromBanned(obj_id target, obj_id player)
    {
        if (!isIdValid(target))
        {
            debugServerConsoleMsg(target, "deleteUserFromPermissionsGroup: target passed as null");
    ...
    public static int[] getGroupPermissions(obj_id target, String group_name)
    {
        if (!isIdValid(target))
        {
    ...
    public static int[] getUserPermissions(obj_id target, obj_id player)
    {
        if (!isIdValid(target))
        {
    ...
    public static boolean grantGroupPermission(obj_id target, String group_name, int idx)
    {
        if (!isIdValid(target))
        {
    ...
    public static boolean revokeGroupPermission(obj_id target, String group_name, int idx)
    {
        if (!isIdValid(target))
        {
    ...
    public static boolean checkGroupPermissionIndex(obj_id target, String group_name, int idx)
    {
        if (!isIdValid(target))
        {
    ...
    public static boolean checkUserPermissionIndex(obj_id target, obj_id player, int idx)
    {
        if (!isIdValid(target))
        {
    ...
    public static boolean hasPermission(obj_id target, String groupName, int idx)
    {
        return checkGroupPermissionIndex(target, groupName, idx);
    }
    public static boolean hasPermission(obj_id target, obj_id player, int idx)
    {
    ...
    public static boolean addToUserTally(obj_id target, obj_id player, String group_name)
    {
        if (!isIdValid(target))
        {
    ...
    public static boolean updateUserTally(obj_id target, obj_id player)
    {
    ...
    public static boolean isBanned(obj_id target, obj_id player)
    {
        if (!isIdValid(target))
        {
    ...
    public static String[] listGroupMemberNames(obj_id target, String group_name)
    {
        if (!isIdValid(target))
        {
    ...
    public static String[] listGroupMemberIds(obj_id target, String group_name)
    {
        if (!isIdValid(target))
        {
    ...
    public static String[] listBannedIds(obj_id target)
    {
        if (!isIdValid(target))
        {
    ...
    public static int groupMemberCount(obj_id target, String group_name)
    {
        if (!isIdValid(target))
        {
    ...
    public static boolean initializePermissions(obj_id target)
    {
        if (!isIdValid(target))
        {
