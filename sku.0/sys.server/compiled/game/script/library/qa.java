...
public class qa extends script.base_script
{
    ...
    public static void qaToolMainMenu(obj_id player)
    {
        qa.refreshMenu(player, QATOOL_PROMPT, QATOOL_TITLE, QATOOL_MAIN_MENU, "toolMainMenu", true, "qatool.pid");
    }
    public static void refreshMenu(obj_id player, String prompt, String title, String[] options, String myHandler, boolean cancel, String PIDVar)
    {
        obj_id self = getSelf();
    ...
    public static void refreshMenu(obj_id player, String prompt, String title, String[] options, String myHandler, boolean cancel, String PIDVar, String scriptVar)
    {
    ...
    public static void refreshMenu(obj_id player, String prompt, String title, String[] options, String myHandler, String scriptVar, int btnConfig)
    {
        closeOldWindow(player, scriptVar);
    ...
    public static void refreshMenu(obj_id player, String prompt, String title, String[] options, String myHandler, String PIDVar, String scriptVar, int btnConfig)
    {
        closeOldWindow(player, scriptVar);
        int pid = sui.listbox(player, player, prompt, btnConfig, title, options, myHandler, false, false);
        sui.listboxUseOtherButton(pid, "Back");
    ...
    public static void showConfirmationSui(obj_id self, String titleText, String confirmationMessage, String handler)
    {
        int pid = sui.msgbox(self, self, confirmationMessage, sui.YES_NO, titleText, handler);
    }
    public static void checkParams(dictionary params, String scriptVar)
    {
    ...
    public static void checkParams(dictionary params, String scriptVar, boolean chkIndex)
    {
        obj_id player = sui.getPlayerId(params);
        if ((params == null) || (params.isEmpty()))
        {
    ...
    public static void closeOldWindow(obj_id player, String scriptVar)
    {
    ...
    public static void setWindowPid(obj_id player, int pid, String scriptVar)
    {
        if (pid > -1)
        {
    ...
    public static String[] populateArray(obj_id player, String datatableName, String choice, String column1, String column2)
    {
    ...
    public static String[] populateArray(obj_id player, String col, String datatableName)
    {
    ...
    public static String[] populateArray(obj_id player, String col, String datatableName, String noNeed)
    {
        String[] errorZeroLengthArray = 
        {
            "The Array was empty, could be that you passed the wrong type"
    ...
    public static String[] populateArrayDoNotSort(obj_id player, String col, String datatableName)
    {
    ...
    public static void removeScriptVars(obj_id player, String scriptVar)
    {
        utils.removeScriptVarTree(player, "qatool");
        utils.removeScriptVarTree(player, scriptVar);
    }
    public static void removePlayer(obj_id player, String SCRIPTVAR, String err)
    {
        sendSystemMessageTestingOnly(player, err);
        qa.removeScriptVars(player, SCRIPTVAR);
        utils.removeScriptVarTree(player, SCRIPTVAR);
    }
    public static void createInputBox(obj_id player, String prompt, String title, String myHandler, String scriptVar)
    {
    ...
    public static void createMsgBox(obj_id player, String prompt, String title, String myHandler, String scriptVar)
    {
        qa.closeOldWindow(player, scriptVar);
    ...
    public static void spawnStaticItemInInventory(obj_id self, String staticItemString, String altMessage)
    {
    ...
    public static obj_id spawnStaticItemInInventory(obj_id self, String staticItemString, String altMessage, boolean silent)
    {
        String messageString = "";
        if (!altMessage.equals("none"))
        {
    ...
    public static obj_id findTarget(obj_id self)
    {
    ...
    public static String getObjectVariables(obj_id self, obj_id item)
    {
        String objvariable = "";
    ...
    public static String qaTargetDump(obj_id self, obj_id objTarget, boolean colorFlag)
    {
        String strTest = "";
        strTest += "OBJECT ID: \t\t\t";
        strTest += objTarget + "\r\n";
    ...
    public static void createCustomUI(obj_id self, String combinedString)
    {
    ...
    public static void findOrCreateAndEquipQABag(obj_id self, obj_id testerInventoryId, boolean moveContents)
    {
    ...
    public static obj_id[] getAllValidWaypoints(obj_id tester)
    {
    ...
    public static String[] getMenuList(obj_id tester, obj_id objList[], String objectType)
    {
        if (objList.length > -1)
        {
    ...
    public static location[] getLocationList(obj_id tester, obj_id waypointList[])
    {
    ...
    public static void templateObjectSpawner(obj_id player, String templateData)
    {
    ...
    public static obj_id templateObjectSpawner(obj_id player, String templateData, boolean silent)
    {
        obj_id inventoryContainer = utils.getInventoryContainer(player);
        if (getVolumeFree(inventoryContainer) <= 0)
        {
    ...
    public static void revokeAllSkills(obj_id player)
    {
    ...
    public static void revokePilotingSkills(obj_id player)
    {
    ...
    public static boolean revokeAndGrantPilot(obj_id self, String factionType)
    {
    ...
    public static void grantPilotingSkills(obj_id self, String factionToggle)
    {
    ...
    public static String getClientBuffName(obj_id self, String buffCommand)
    {
    ...
    public static void applyBuffOption(obj_id self, String buffArg, String buffName)
    {
        if (!buffName.equals(""))
        {
    ...
    public static void stopCreatureCombat(obj_id self, obj_id tester)
    {
        stopCombat(self);
    ...
    public static void followTester(obj_id self, obj_id tester)
    {
    ...
    public static void damageMobTool(obj_id self)
    {
    ...
    public static void healMobTool(obj_id self)
    {
        obj_id finalTarget = findTarget(self);
        if (!isIdNull(finalTarget))
        {
    ...
    public static boolean checkGodLevel(obj_id tester)
    {
    ...
    public static String[] getAllQuests(obj_id player)
    {
        if (!isIdNull(player))
        {
    ...
    public static String[] getAllActiveQuests(obj_id player)
    {
    ...
    public static String[] getAllCompletedQuests(obj_id player)
    {
    ...
    public static String getGroundQuestStringAndTitle(obj_id player, String questString)
    {
    ...
    public static String getSpaceQuestStringAndTitle(obj_id self, String questString)
    {
        String questTitle = localize(new string_id(questString, "title"));
        return questString + " - " + questTitle;
    }
    public static void grantGroundQuest(obj_id self, String questString)
    {
        groundquests.requestGrantQuest(self, questString, true);
    }
    public static boolean grantSpaceQuest(obj_id self, String questType, String questName)
    {
        boolean questSuccess = space_quest.grantQuest(self, questType, questName);
        return questSuccess;
    }
    public static String getSpaceQuestType(obj_id self, String questString)
    {
    ...
    public static String getSpaceQuestName(obj_id self, String questString)
    {
        if (questString.indexOf("spacequest/") == 0)
        {
    ...
    public static boolean checkQuestType(obj_id self, String questType)
    {
        if (!questType.equals(""))
        {
    ...
    public static boolean completeActiveQuest(obj_id self, String questString)
    {
        if (questString.indexOf("spacequest/") == 0)
        {
    ...
    public static boolean clearQuest(obj_id self, String questString)
    {
        if (questString.indexOf("spacequest/") == 0)
        {
            if (space_quest.hasQuest(self))
    ...
    public static boolean evalSpaceQuestThenGrant(obj_id self, String spaceString)
    {
        String questType = "";
        String questName = "";
    ...
    public static boolean blowOutObjVars(obj_id self, String objVar)
    {
    ...
    public static boolean grantPilotSkill(obj_id self, String skillStringData)
    {
    ...
    public static boolean grantOrClearSpaceQuest(obj_id self, String questData, String fateSwitch)
    {
    ...
    public static boolean createAQaWaypointInDataPad(obj_id self, location waypointData, String waypointName)
    {
    ...
    public static void forceEggSpawn(obj_id self)
    {
    ...
    public static void createSpawnerMobNow(obj_id self, String strId, obj_id objLocationObject, location locLocation, float fltRadius, obj_id lookAtTarget)
    {
    ...
    public static float getClosestSize(float fltOriginalSize)
    {
