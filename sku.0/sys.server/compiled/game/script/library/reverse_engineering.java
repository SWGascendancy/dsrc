...
public class reverse_engineering extends script.base_script
{
    ...
    public static void checkPowerUpReApply(obj_id player)
    {
        if (isIdValid(player))
        {
    ...
    public static void applyPowerupItem(obj_id player, obj_id powerup, int powerupType)
    {
        if (powerupType < 0)
        {
    ...
    public static void applyPowerupItemEquipped(obj_id player, obj_id itemWithPowerUp)
    {
    ...
    public static boolean isPoweredUpItem(obj_id item)
    {
        return hasScript(item, POWERUP_SCRIPT);
    }
    public static int getPowerupType(obj_id item)
    {
        int powerupType = -1;
        String staticName;
    ...
    public static float getDieTime(float lifeSpan, obj_id tempObject)
    {
    ...
    public static String getMyEquippedSlot(obj_id itemWithPowerUp)
    {
    ...
    public static String getMyBuffIconInt(obj_id powerUp)
    {
    ...
    public static String getMyBuffIconString(obj_id itemWithPowerUp)
    {
    ...
    public static void applyBuffIcon(obj_id player, obj_id itemWithPowerUp)
    {
        applyBuffIcon(player, obj_id.NULL_ID, itemWithPowerUp);
    }
    public static void applyBuffIcon(obj_id player, obj_id powerUp, obj_id itemWithPowerUp)
    {
        String buffName;
        float expiration;
    ...
    public static void removeBuffIcon(obj_id player, obj_id itemWithPowerUp)
    {
    ...
    public static void recalcPoolsIfNeeded(obj_id player, String mod)
    {
    ...
    public static void addModsAndScript(obj_id player, obj_id powerUp, obj_id itemToPowerUp)
    {
        addModsAndScript(player, powerUp, itemToPowerUp, 0f);
    }
    public static void addModsAndScript(obj_id player, obj_id powerUp, obj_id itemToPowerUp, float remainingTime)
    {
    ...
    public static void removeModsAndScript(obj_id player, obj_id itemWithPowerUp)
    {
    ...
    public static void removePlayerPowerUpMods(obj_id player, obj_id itemWithPowerUp)
    {
    ...
    public static boolean canMakePowerUp(String mod)
    {
        return dataTableGetInt(SPECIAL_MOD_TABLE, mod, "no_pup") <= 0;
    }
    public static boolean canStaticItemBeReversedEngineered(obj_id item)
    {
