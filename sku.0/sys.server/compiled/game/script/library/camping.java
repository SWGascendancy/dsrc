...
public class camping extends script.base_script
{
    ...
    public static obj_id createCamp(obj_id creator)
    {
        return createCamp(creator, 1);
    }
    public static obj_id createCamp(obj_id creator, int campPower)
    {
    ...
    public static obj_id createCampTheater(location here, int campPower)
    {
        if (here == null)
        {
            return null;
    ...
    public static boolean canPlaceCampHere(obj_id creator, location here, int campPower)
    {
    ...
    public static boolean nukeCamp(obj_id master)
    {
    ...
    public static obj_id getCurrentCamp(obj_id target)
    {
        if (!isIdValid(target))
        {
            return null;
    ...
    public static boolean setCurrentCamp(obj_id target, obj_id master)
    {
    ...
    public static boolean clearCurrentCamp(obj_id target)
    {
        if (!isIdValid(target))
        {
            return false;
    ...
    public static float getCampSize(obj_id master)
    {
    ...
    public static boolean isTooCloseToAnotherCamp(location here, obj_id creator)
    {
    ...
    public static obj_id getCampOwner(obj_id master)
    {
        if (!isIdValid(master))
        {
            return null;
    ...
    public static boolean setCampOwner(obj_id master, obj_id newOwner)
    {
    ...
    public static boolean clearCampOwner(obj_id master)
    {
        if (!isIdValid(master))
        {
            return false;
    ...
    public static boolean updateCampOwner(obj_id master, obj_id newOwner)
    {
        setCampOwner(master, newOwner);
        return setStatus(master, STATUS_MAINTAIN);
    }
    public static boolean campAbandoned(obj_id master)
    {
        obj_id owner = getCampOwner(master);
        if (isIdValid(owner))
        {
    ...
    public static int getStatus(obj_id master)
    {
        if (!isIdValid(master))
        {
    ...
    public static boolean setStatus(obj_id master, int newStatus)
    {
        if (!isIdValid(master))
        {
            return false;
    ...
    public static boolean isOwnerInVicinity(obj_id master)
    {
        return getBooleanObjVar(master, VAR_OWNER_NEAR);
    }
    public static void sendCampCreationHeartbeat(obj_id master)
    {
        messageTo(master, HANDLER_CAMP_CREATE, null, HEARTBEAT_CREATION, false);
    }
    public static void sendCampCreationComplete(obj_id master)
    {
        messageTo(master, HANDLER_CAMP_COMPLETE, null, HEARTBEAT_CREATION, false);
    }
    public static void sendCampMaintenanceHeartbeat(obj_id master)
    {
        messageTo(master, HANDLER_CAMP_MAINTAIN, null, HEARTBEAT_MAINTAIN, false);
    }
    public static void sendCampRestoreHeartbeat(obj_id master)
    {
        messageTo(master, HANDLER_CAMP_RESTORE, null, HEARTBEAT_RESTORE, false);
    }
    public static int campingSkillCheck(obj_id owner)
    {
        int roll = rand(0, 100);
    ...
    public static void setCampMasterName(obj_id master)
    {
        if (isIdValid(master))
        {
            setName(master, "");
    ...
    public static int getCampRepelValue(obj_id target)
    {
        if (isIdValid(target))
        {
            return -1;
    ...
    public static boolean repelledByCamp(obj_id npc, obj_id player)
    {
        if (!isIdValid(npc))
        {
            return false;
    ...
    public static float getCampHealModifier(obj_id master)
    {
    ...
    public static boolean isRecruiterModule(String module_template)
    {
    ...
    public static boolean validateRecruiter(obj_id player, String module_template, int recruitersPlaced)
    {
    ...
    public static void initializeAdvancedCamp(obj_id deed, obj_id camp, obj_id player, location loc)
    {
    ...
    public static float getAdvancedCampRadius(obj_id camp)
    {
        String filename = utils.getTemplateFilenameNoPath(camp);
        return dataTableGetFloat(CAMP_DATATABLE, filename, "radius");
    }
    public static int getAdvancedCampNumberOfNodes(obj_id camp)
    {
        String filename = utils.getTemplateFilenameNoPath(camp);
        return dataTableGetInt(CAMP_DATATABLE, filename, "nodes");
    }
    public static int getAdvancedCampNodeYaw(obj_id camp, int node)
    {
        String filename = utils.getTemplateFilenameNoPath(camp);
        String yawCol = "yaw" + node;
        return dataTableGetInt(CAMP_DATATABLE, filename, yawCol);
    }
    public static location getAdvancedCampNodeLocation(obj_id camp, location loc, int node)
    {
        String filename = utils.getTemplateFilenameNoPath(camp);
        String xCol = "x" + node;
        String zCol = "z" + node;
    ...
    public static obj_id getCurrentAdvancedCamp(obj_id player)
    {
    ...
    public static boolean isInEntertainmentCamp(obj_id player)
    {
        return isInEntertainmentCamp(player, obj_id.NULL_ID);
    }
    public static boolean isInEntertainmentCamp(obj_id player, obj_id camp)
    {
        if (!isIdValid(camp))
        {
