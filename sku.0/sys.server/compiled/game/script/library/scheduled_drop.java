...
public class scheduled_drop extends script.base_script
{
    ...
    public static void testingSpam(obj_id self, String str)
    {
    ...
    public static int getRandomStaticItem(dictionary[] promotionList)
    {
        if (promotionList == null || promotionList.length <= 0)
        {
            return -1;
    ...
    public static dictionary[] getStaticItemsForAllPromotions(String[] promotionNames)
    {
    ...
    public static int getPromotionMaxDrop(String promotion)
    {
        return modifyPromotionCountByServer(dataTableGetInt(DATATABLE_SCHEDULE, promotion, DATATABLE_SCHEDULE_PROMO_MAX_DROPS));
    }
    public static dictionary[] getPromotionMaxDrops(String[] promotions)
    {
        obj_id self = getSelf();
    ...
    public static int modifyPromotionCountByServer(int promotionCount)
    {
    ...
    public static int getLastClusterUpdateTime()
    {
        return getIntObjVar(getPlanetByName("tatooine"), CLUSTER_OBJVAR_LAST_UPDATE);
    }
    public static void setLastClusterUpdateTime(int date)
    {
        setObjVar(getPlanetByName("tatooine"), CLUSTER_OBJVAR_LAST_UPDATE, date);
    }
    public static void removeLastClusterUpdateTime()
    {
    ...
    public static void removeClusterPromotions()
    {
        obj_id planet = getPlanetByName("tatooine");
        String[] promotions = getSchedulerPromotions();
        for (String promotion : promotions) {
    ...
    public static void setClusterPromotions(dictionary[] promotionsWithMaxDrops)
    {
        obj_id planet = getPlanetByName("tatooine");
    ...
    public static void instantiatePromotionsOnCluster()
    {
    ...
    public static String[] validatePromotionsVersusCluster(String[] promotionNames)
    {
        obj_id planet = getPlanetByName("tatooine");
    ...
    public static int cardDelay(int systemToDrop)
    {
        switch (systemToDrop)
        {
    ...
    public static boolean hasCardDelay(obj_id player, int systemToDrop)
    {
    ...
    public static boolean canDropCard(int systemToDrop)
    {
        switch (systemToDrop)
        {
            case SYSTEM_COMBAT_NORMAL:
    ...
    public static obj_id dropCard(int systemToDrop, obj_id container)
    {
        obj_id self = getSelf();
