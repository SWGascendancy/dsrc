...
public class money extends script.base_script
{
    ...
    public static boolean deposit(obj_id player, int amt)
    {
    ...
    public static boolean withdraw(obj_id player, int amt)
    {
        dictionary d = new dictionary();
        d.put(DICT_PLAYER_ID, player);
        d.put(DICT_AMOUNT, amt);
    ...
    public static boolean cashTo(obj_id player, obj_id target, int amt)
    {
        dictionary d = new dictionary();
        d.put(DICT_PLAYER_ID, player);
    ...
    public static boolean bankTo(obj_id player, obj_id target, int amt)
    {
        dictionary d = new dictionary();
        d.put(DICT_PLAYER_ID, player);
        d.put(DICT_TARGET_ID, target);
    ...
    public static boolean bankTo(String acct, obj_id target, int amt)
    {
        dictionary d = new dictionary();
        d.put(DICT_TARGET_ID, target);
    ...
    public static boolean bankTo(obj_id player, String acct, int amt)
    {
        dictionary d = new dictionary();
        d.put(DICT_PLAYER_ID, player);
        d.put(DICT_ACCT_NAME, acct);
    ...
    public static boolean bankTo(obj_id player, String acct, int amt, dictionary dctParams)
    {
    ...
    public static boolean hasFunds(obj_id player, int type, int amt)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static boolean covertDeposit(obj_id player, int amt, String returnHandler, dictionary oldparams)
    {
    ...
    public static boolean requestPayment(obj_id payer, obj_id target, int amt, String returnHandler, dictionary oldparams, boolean notifySuccess)
    {
    ...
    public static boolean requestPayment(obj_id payer, obj_id target, int amt, String returnHandler, dictionary params)
    {
        return requestPayment(payer, target, amt, returnHandler, params, true);
    }
    public static boolean requestPayment(obj_id payer, String acct, int amt, String returnHandler, dictionary oldparams, boolean notifySuccess)
    {
    ...
    public static boolean requestPayment(obj_id payer, String acct, int amt, String returnHandler, dictionary params)
    {
        return requestPayment(payer, acct, amt, returnHandler, params, true);
    }
    public static boolean pay(obj_id self, obj_id target, int amt, String returnHandler, dictionary oldparams, boolean notifySuccess)
    {
    ...
    public static boolean pay(obj_id self, obj_id target, int amt, String returnHandler, dictionary params)
    {
        return pay(self, target, amt, returnHandler, params, true);
    }
    public static boolean pay(obj_id self, String acct, int amt, String returnHandler, dictionary oldparams, boolean notifySuccess)
    {
    ...
    public static boolean pay(obj_id self, String acct, int amt, String returnHandler, dictionary params)
    {
        return pay(self, acct, amt, returnHandler, params, true);
    }
    public static void incrementPayTally(obj_id self, int amt)
    {
    ...
    public static void decrementPayTally(obj_id self, dictionary params)
    {
    ...
    public static boolean systemPayout(String acct, obj_id target, int amt, String returnHandler, dictionary oldparams)
    {
    ...
    public static boolean bankSuccess(obj_id player, dictionary params)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static boolean bankSuccess(obj_id player)
    {
        return bankSuccess(player, null);
    }
    public static boolean bankError(obj_id player)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static boolean bankWithdrawError(obj_id player)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static boolean bankDepositError(obj_id player)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static boolean bankTransferError(obj_id player)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static boolean cashTransferError(obj_id player)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static boolean nullTransactionError(obj_id player)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static boolean requestLootAdd(obj_id creature, int amt)
    {
    ...
    public static boolean addCreatureLoot(obj_id creature, int amt)
    {
    ...
    public static int getReturnCode(dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return -1;
    ...
    public static void clearTotalPlayerCredits(obj_id player, String acct)
    {
