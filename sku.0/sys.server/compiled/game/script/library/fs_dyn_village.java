...
public class fs_dyn_village extends script.base_script
{
    ...
    public static Vector getCityDestructionCoords(String id)
    {
    ...
    public static location[] getVillageLocs(String id)
    {
    ...
    public static void checkPhaseExpiration(obj_id master)
    {
    ...
    public static int getPhaseDuration(int phase)
    {
    ...
    public static int getStartupPhaseFromConfig()
    {
    ...
    public static void destroySpawnersNpc(obj_id spawner)
    {
    ...
    public static boolean spawnNpcAuth(obj_id spawner, boolean createIfExists, boolean destroyOldIfExists)
    {
        if (!isIdValid(spawner) || !exists(spawner))
        {
    ...
    public static void spawnTurrets(obj_id master)
    {
    ...
    public static void doEnemySpawn(obj_id struct_master, float minDistance, float maxDistance, String[] spawnWaves)
    {
    ...
    public static int getNecessarySpawnLevel(obj_id master)
    {
    ...
    public static int numPlayersInVillage(obj_id struct_master)
    {
        int num = 0;
    ...
    public static void spawnNpcAsynch(obj_id spawner, boolean createIfExists, boolean destroyOldIfExists)
    {
    ...
    public static void notifySpawnerOfDeath(obj_id deadNpc)
    {
    ...
    public static void setNextPhaseAuth(obj_id village_master, int value)
    {
    ...
    public static int getPhaseFromVersionUid(int uid)
    {
        String suid = "" + uid;
    ...
    public static int getVersionFromVersionUid(int uid)
    {
        String suid = "" + uid;
        int ver = utils.stringToInt(suid.substring(1));
        return ver;
    }
    public static int getCurrentVersionAuth(obj_id village_master)
    {
        int curVersion = 0;
        if (!isIdValid(village_master) || !exists(village_master))
        {
    ...
    public static int getCurrentPhaseAuth(obj_id village_master)
    {
        if (!isIdValid(village_master) || !exists(village_master))
        {
    ...
    public static int getCurrentUidAuth(obj_id village_master)
    {
        if (!isIdValid(village_master) || !exists(village_master))
        {
    ...
    public static void doEnemySpawnPulse(obj_id master, String msgHandler)
    {
    ...
    public static void spawnVillageVictims()
    {
    ...
    public static void doPostPhaseInitTasks(obj_id master)
    {
    ...
    public static void destroyPhase3Camps(obj_id villageMaster)
    {
    ...
    public static void doPrePhaseShiftCleanup(int oldPhase, int newPhase, obj_id villageMaster)
    {
    ...
    public static boolean pushAndInitPhase(obj_id master)
    {
    ...
    public static boolean createPhaseObjects(obj_id master_object, int tableRowIdxStart)
    {
    ...
    public static void initFsClusterData()
    {
        replaceClusterWideData(DYNVILLAGE_CLUSTER_NAME, CLUSTER_SET_FS, new dictionary(), false, -1);
        return;
    }
    public static boolean registerObjIdInClusterWideData(obj_id id, String key, String msgHandler, obj_id source)
    {
        return _updateClusterData(source, DATAMODE_ADD_OBJID, key + "|" + id.toString(), msgHandler, true);
    }
    public static boolean getRegisteredObjIdFromClusterWideData(String key, String msgHandler, obj_id source)
    {
        return _updateClusterData(source, DATAMODE_GET_OBJID, key, msgHandler, false);
    }
    public static boolean registerIntegerInClusterWideData(int value, String key, String msgHandler, obj_id source)
    {
        return _updateClusterData(source, DATAMODE_ADD_INT, key + "|" + value, msgHandler, true);
    }
    public static boolean getRegisteredIntegerFromClusterWideData(String key, String msgHandler, obj_id source)
    {
        return _updateClusterData(source, DATAMODE_GET_INT, key, msgHandler, false);
    }
    public static boolean _updateClusterData(obj_id source, int data_mode, String params, String handler, boolean lock_data)
    {
        if (!isIdValid(source))
        {
    ...
    public static int getRowIndexForPhase(int phase)
    {
        if (phase < 1)
        {
            return -1;
    ...
    public static void destroyDynamicVillage(obj_id villageMaster)
    {
        destroyDynamicVillageObjects(villageMaster);
        destroyDynamicVillageSpawners(villageMaster);
        return;
    }
    public static void destroyDynamicVillageObjects(obj_id villageMaster)
    {
    ...
    public static void destroyDynamicVillageSpawners(obj_id villageMaster)
    {
        obj_id[] objs = new obj_id[0];
