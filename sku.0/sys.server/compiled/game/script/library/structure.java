...
public class structure extends script.base_script
{
    ...
    public static obj_id getContainingBuilding(obj_id target)
    {
        if (target == null)
        {
            return null;
    ...
    public static boolean isInside(obj_id target)
    {
        if (target == null)
        {
            return false;
    ...
    public static String getRandomCell(obj_id structure)
    {
    ...
    public static obj_id getRandomCellId(obj_id structure)
    {
        if ((structure == null) || (structure == obj_id.NULL_ID))
        {
            return null;
    ...
    public static location getRandomLocationInStructure(obj_id structure)
    {
        if ((structure == null) || (structure == obj_id.NULL_ID))
        {
            return null;
    ...
    public static int getFacilityVersion(obj_id facility, String scriptName, String columnName)
    {
    ...
    public static int getFacilityTerminalVersion(obj_id facility, String scriptName)
    {
    ...
    public static int getFacilitySpawnVersion(obj_id facility, String scriptName)
    {
        if ((facility == null) || (scriptName.equals("")))
        {
            return -1;
    ...
    public static boolean isCurrentTerminalVersion(obj_id facility, String scriptName)
    {
        if ((facility == null) || (scriptName.equals("")))
        {
            return false;
    ...
    public static boolean isCurrentSpawnVersion(obj_id facility, String scriptName)
    {
        if ((facility == null) || (scriptName.equals("")))
        {
            return false;
    ...
    public static obj_id[] getPlayersInStructure(obj_id facility)
    {
        if (facility == null)
        {
            return null;
    ...
    public static boolean addStructureCoOwner(obj_id structure, obj_id owner, obj_id player)
    {
    ...
    public static boolean removeStructureCoOwner(obj_id structure, obj_id owner, obj_id player)
    {
        if ((structure == null) || (owner == null) || (player == null))
        {
            return false;
    ...
    public static obj_id packStructureToDeed(obj_id owner, obj_id building)
    {
    ...
    public static obj_id unpackStructureFromDeed(obj_id owner, obj_id deed)
    {
    ...
    public static boolean createStructureTerminals(obj_id facility, String scriptName, String datatable)
    {
    ...
    public static obj_id[] createStructureTerminals(obj_id facility, String datatable)
    {
        if (!isIdValid(facility) || datatable == null || datatable.equals(""))
        {
            return null;
    ...
    public static boolean destroyStructureTerminals(obj_id facility)
    {
        if (facility == null)
        {
            return false;
    ...
    public static boolean initializeStructureInteriorSpawn(obj_id facility)
    {
        if (facility == null)
        {
            return false;
    ...
    public static int getSpawnSwitchState(obj_id facility, int idx)
    {
        if (facility != null)
        {
    ...
    public static boolean setSpawnSwitchState(obj_id facility, int idx, boolean setActive)
    {
        if (facility != null)
        {
            if (hasObjVar(facility, VAR_SPAWN_SWITCHES_CURRENT))
    ...
    public static boolean resetFillerSpawns(obj_id building)
    {
        if (building == null)
        {
            return false;
    ...
    public static boolean cleanupFillerSpawns(obj_id building)
    {
        if (building == null)
        {
            return false;
    ...
    public static dictionary getFillerEggTemplate(obj_id building, int spawnIdx, int eggIdx)
    {
    ...
    public static dictionary getRandomFillerEggTemplate(obj_id building)
    {
        if (building == null)
        {
            return null;
    ...
    public static dictionary getNextFillerEggTemplate(obj_id building)
    {
        if (building == null)
        {
            return null;
    ...
    public static boolean spawnNextFillerEggTemplate(obj_id building)
    {
        if (building == null)
        {
            return false;
    ...
    public static boolean spawnFillerEgg(obj_id building, dictionary params)
    {
