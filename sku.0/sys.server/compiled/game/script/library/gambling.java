...
public class gambling extends script.base_script
{
    ...
    public static boolean initializeTable(obj_id table, String gameType)
    {
    ...
    public static void addTablePlayer(obj_id table, obj_id player, String params)
    {
    ...
    public static void removeTablePlayer(obj_id table, obj_id player, String params)
    {
        if (!isIdValid(table) || !isIdValid(player))
        {
            return;
    ...
    public static boolean isTablePlayer(obj_id table, obj_id player)
    {
        if (!isIdValid(table) || !isIdValid(player))
        {
            return false;
    ...
    public static void placeBet(obj_id table, obj_id player, String params)
    {
    ...
    public static void refundAbortedGame(obj_id table)
    {
        if (!isIdValid(table))
        {
            return;
    ...
    public static int parsePaySchedule(obj_id table, obj_id player, int[] results, int amt, String tbl)
    {
    ...
    public static int getPayoutValue(String tbl, int idx, int amt)
    {
    ...
    public static Vector calculateReelOdds(obj_id table)
    {
        if (!isIdValid(table))
        {
            return null;
    ...
    public static int getGamePlayerIndex(obj_id table, obj_id player)
    {
        if (!isIdValid(table) || !isIdValid(player))
        {
            return -1;
