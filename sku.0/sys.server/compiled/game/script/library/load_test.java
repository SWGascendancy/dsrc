...
public class load_test extends script.base_script
{
    ...
    public static boolean loadClientSupportEnabled()
    {
    ...
    public static void handleLoadClientSetup(obj_id clientCreature, String optionsString)
    {
    ...
    public static void revokeSkills(obj_id creature, String[] skills)
    {
