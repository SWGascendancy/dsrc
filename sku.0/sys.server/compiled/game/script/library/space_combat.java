...
public class space_combat extends script.base_script
{
    ...
    public static final float SPACE_XP_PERCENT = 2.0f;
    ...
    private static final int rareLootChance = 3;
    private static final int exceptionalLootChance = 3;
    private static final int legendaryLootChance = 3;
    public static final String CHEST_BASE = "rare_loot_chest_quality_";
    private static final String RLS_SOUND = "sound/rare_loot_chest.snd";

    public static void addToCombatDamage(obj_id objAttacker, obj_id objDefender, int intDamage)
    {
    ...
    public static void targetDestroyed(obj_id objTarget)
    {
        dictionary dctParams = new dictionary();
        space_utils.notifyObject(objTarget, "objectDestroyed", dctParams);
        return;
    }
    public static void normalizeAllComponents(obj_id objShip)
    {
    ...
    public static void unrestrictedDroidCommand(obj_id objShip, String strCommand)
    {
    ...
    public static void performDroidCommands(obj_id objPlayer, String strCommand)
    {
    ...
    public static boolean doDroidPreCheck(obj_id objPlayer, obj_id objShip, String strCommand)
    {
    ...
    public static boolean droidHasAbility(obj_id objControlDevice, String strCommand)
    {
    ...
    public static float getCommandEfficacy(obj_id objDroid, String strCategory, float fltEfficacy)
    {
        return 1.0f;
    }
    public static void registerDamageDoneToShip(obj_id objAttacker, obj_id objDefender, float fltDamage)
    {
        if (fltDamage == 0)
        {
            return;
    ...
    public static void doFactionPointGrant(obj_id objPlayer, int intImperialFactionPoints, int intRebelFactionPoints)
    {
    ...
    public static void grantRewardsAndCreditForKills(obj_id objDefender)
    {
                ...
                if (fltPercentages[intI] > MINIMUM_DAMAGE_THRESHOLD)
                {
                    ...
                    if ((objPlayers != null) && (objPlayers.size() > 0))
                    {
                        ...
                        for (int intJ = 0; intJ < objPlayers.size(); intJ++)
                        {
                            ...
                            {
                                float fltSpaceXp = intAmount * SPACE_XP_PERCENT;
                                int intSpaceXp = (int)fltSpaceXp;
                                xp.grant(((obj_id)objPlayers.get(intJ)), xp.SPACE_COMBAT_GENERAL, intSpaceXp, true);
    ...
    public static String getPlayerTierString(obj_id player)
    {
    ...
    public static void sendCreditNotification(obj_id objShip, int intCredits)
    {
    ...
    public static void sendItemNotification(obj_id objShip, obj_id objItem)
    {
        Vector objPlayers = space_transition.getContainedPlayers(objShip);
        if (space_utils.isShipWithInterior(objShip))
        {
    ...
    public static void createLoot(obj_id objDefender, obj_id objAttacker)
    {
        ...
        if (isIdValid(objPilot))
        {
            if (isPlayerActive(objPilot))
            {
                int intDifficulty = space_pilot_command.targetTierDetect(objDefender);
                int rareLootRoll = rand(0, 350);
                int lootType = 0;
                if ((intDifficulty == 1 || intDifficulty == 2) && (rareLootRoll <= rareLootChance))
                {
                    lootType = 4;
                    playClientEffectLoc(objDefender, RLS_SOUND, getLocation(objDefender), 1f);
                }
                if ((intDifficulty == 3 || intDifficulty == 4) && (rareLootRoll <= exceptionalLootChance))
                {
                    lootType = 5;
                    playClientEffectLoc(objDefender, RLS_SOUND, getLocation(objDefender), 1f);
                }
                if (intDifficulty >= 5 && intDifficulty <= 10 && (rareLootRoll <= legendaryLootChance))
                {
                    lootType = 6;
                    playClientEffectLoc(objDefender, RLS_SOUND, getLocation(objDefender), 1f);
                }
                obj_id chest = static_item.createNewItemFunction(CHEST_BASE + lootType, objContainer);
                setObjVar(chest, RareLootSystem.RARITY_OBJVAR, lootType);
            }
        }
    ...
    public static void grantLootPermission(obj_id objWinner, obj_id objContainer)
    {
    ...
    public static void notifyAttacker(obj_id objAttacker, obj_id objDefender, float fltPercentage)
    {
        dictionary dctParams = new dictionary();
    ...
    public static void notifyAttackerDisabled(obj_id objAttacker, obj_id objDefender, dictionary dctParams)
    {
        dctParams.put("ship", objDefender);
        String strShipType = getStringObjVar(objDefender, "ship.shipName");
        if (strShipType != null)
    ...
    public static dictionary getKillPercentages(obj_id objDefender)
    {
        Vector objAttackers = new Vector();
        objAttackers.setSize(0);
    ...
    public static void setEfficiencyModifier(int intSlot, obj_id objShip, float fltGeneralModifier, float fltEnergyModifier)
    {
    ...
    public static void clearEfficiencyModifier(int intSlot, obj_id objShip)
    {
        String strName = ship_chassis_slot_type.names[intSlot];
    ...
    public static boolean isEfficiencyModified(int intSlot, obj_id objShip)
    {
        String strName = ship_chassis_slot_type.names[intSlot];
    ...
    public static void recalculateEfficiency(int intSlot, obj_id objShip, float fltRawEfficiency)
    {
    ...
    public static void recalculateEfficiencyGeneral(int intSlot, obj_id objShip)
    {
        recalculateEfficiencyGeneral(intSlot, objShip, getRawEfficiency(intSlot, objShip));
    }
    public static void recalculateEfficiencyGeneral(int intSlot, obj_id objShip, float fltRawEfficiency)
    {
        if (fltRawEfficiency == 0)
        {
            return;
    ...
    public static void recalculateEfficiency(int intSlot, obj_id objShip)
    {
        float fltRawEfficiency = getRawEfficiency(intSlot, objShip);
        recalculateEfficiency(intSlot, objShip, fltRawEfficiency);
    }
    public static void setEfficiencyGeneral(int intSlot, obj_id objShip, float fltGeneralModifier)
    {
    ...
    public static void setEfficiencies(int intSlot, obj_id objShip, float fltGeneralModifier, float fltEnergyModifier)
    {
    ...
    public static void zeroEfficienciesClearPowerups(int intSlot, obj_id objShip)
    {
        String strName = ship_chassis_slot_type.names[intSlot];
        utils.removeLocalVar(objShip, strName + "Efficiency");
        utils.removeLocalVar(objShip, strName + "EfficiencyGeneral");
    ...
    public static float getRawEfficiency(int intSlot, obj_id objShip)
    {
    ...
    public static void recalculateEfficiencies(obj_id objComponent)
    {
    ...
    public static void setEfficiencies(obj_id objComponent, float fltGeneralModifier, float fltEnergyModifier)
    {
        if (fltEnergyModifier < MINIMUM_EFFICIENCY)
        {
            fltEnergyModifier = MINIMUM_EFFICIENCY;
    ...
    public static boolean drainEnergyFromCapacitor(obj_id objShip, float fltEnergy, boolean boolOverride)
    {
    ...
    public static boolean drainEnergyFromShield(obj_id objShip, int intSide, float fltEnergy, boolean boolOverride)
    {
        if (intSide == FRONT)
        {
    ...
    public static boolean addEnergyToCapacitor(obj_id objShip, int intWeaponCapacitor, float fltEnergy, boolean boolOverride)
    {
        float fltCurrentEnergy = getShipCapacitorEnergyCurrent(objShip);
    ...
    public static boolean addEnergyToShield(obj_id objShip, int intSide, float fltEnergy, boolean boolOverride)
    {
        if (intSide == FRONT)
        {
            float fltCurrentEnergy = getShipShieldHitpointsFrontCurrent(objShip);
    ...
    public static boolean transferFrontShieldToBack(obj_id objShip, float fltPercentage)
    {
        float fltCurrentEnergy = getShipShieldHitpointsFrontCurrent(objShip);
    ...
    public static boolean transferBackShieldToFront(obj_id objShip, float fltPercentage)
    {
        float fltCurrentEnergy = getShipShieldHitpointsBackCurrent(objShip);
        float fltEnergy = fltCurrentEnergy * fltPercentage;
    ...
    public static boolean reinforceShieldsFromCapacitor(obj_id objShip, float fltPercentage)
    {
        float fltCurrentEnergy = getShipCapacitorEnergyCurrent(objShip);
        float fltEnergy = fltCurrentEnergy * fltPercentage;
    ...
    public static boolean isComponentMandatory(obj_id objShip, int intSlot)
    {
    ...
    public static boolean isShipDisabled(obj_id objShip, int intSlot)
    {
    ...
    public static boolean isShipDisabled(obj_id objShip)
    {
        for (int intI = 0; intI < MANDATORY_COMPONENTS.length; intI++)
        {
    ...
    public static void killSpacePlayer(obj_id objShip)
    {
    ...
    public static obj_id getClosestSpaceStation(obj_id objShip)
    {
    ...
    public static void initializeCommandTimer(obj_id pilot, int commandDelay)
    {
    ...
    public static boolean commandTimePassed(obj_id pilot)
    {
        int intCurrentTime = getGameTime();
    ...
    public static boolean doReactorPumpPulse(obj_id pilot, obj_id ship)
    {
    ...
    public static boolean doesReactorScram(obj_id pilot, obj_id ship, String difficultyOfCommand)
    {
    ...
    public static void scramReactor(obj_id pilot, obj_id ship)
    {
    ...
    public static int getPlayerCommandSkill(obj_id pilot)
    {
        int playerSkill = 0;
    ...
    public static int getAttackerSkill(obj_id targetShip)
    {
    ...
    public static boolean doIffScramble(obj_id pilot, obj_id ship)
    {
    ...
    public static void disableWeaponry(obj_id ship, boolean disable)
    {
    ...
    public static String[] getProgrammedDroidCommands(obj_id objPlayer)
    {
        obj_id objShip = space_transition.getContainingShip(objPlayer);
        if (!isIdValid(objShip))
        {
    ...
    public static String[] getDroidCommands(obj_id objPlayer)
    {
    ...
    public static void grantCapitalShipSequenceRewardsAndCreditForKills(obj_id objDefender)
    {
        dictionary dctParams = getKillPercentages(objDefender);
        if (dctParams == null)
        {
    ...
    public static void flightDroidVocalize(obj_id ship, int vocalizePriority)
    {
        flightDroidVocalize(ship, vocalizePriority, null);
    }
    public static void flightDroidVocalize(obj_id ship, int vocalizePriority, prose_package pp)
    {
    ...
    public static int rndDroidVocalizeDelay()
    {
        int currentTime = getGameTime();
    ...
    public static void vocalizeSpaceDroid(obj_id droidPcd, obj_id player, obj_id ship, int vocalizePriority)
    {
    ...
    public static String targetHardpointForCefPlayback(obj_id ship)
    {
    ...
    public static void createFlightDroidFromData(obj_id petControlDevice, obj_id objContainer)
    {
    ...
    public static boolean removeFlightDroidFromShip(obj_id droidControlDevice, obj_id droid)
    {
    ...
    public static void openFlightComputerDatapad(obj_id navicompControlDevice, obj_id owner)
    {
    ...
    public static boolean isAnInitializedNavicomp(obj_id navicomp)
    {
    ...
    public static boolean readyForEmergencyPower(obj_id ship)
    {
        if (!isIdValid(ship))
        {
            return false;
    ...
    public static int[] getInstalledMissileWeapons(obj_id objShip)
    {
    ...
    public static void emergencyCmdDamageToShipsSystems(obj_id pilot, obj_id ship, float percentToDamageTo, String clientEffect, int primaryComponent)
    {
        if (!isIdValid(ship))
        {
            return;
    ...
    public static void vampiricTypeShipsSystemsRepair(obj_id pilot, obj_id ship, int successLevel)
    {
        if (!isIdValid(ship))
        {
            return;
    ...
    public static int getShipsPilotCommandSkillCheckMods(obj_id ship)
    {
        int mods = 0;
        int currentTime = getGameTime();
    ...
    public static int doPilotCommandSkillCheck(obj_id player, String difficultyOfCommand)
    {
    ...
    public static boolean readyForBomberStrike(obj_id ship, obj_id commander)
    {
    ...
    public static boolean executeLightBomberStrike(obj_id ship, obj_id commander, obj_id target, int CMD_LIGHT_STRIKE_DELAY)
    {
    ...
    public static boolean executeMediumBomberStrike(obj_id ship, obj_id commander, obj_id target, int CMD_LIGHT_STRIKE_DELAY)
    {
    ...
    public static boolean executeHeavyBomberStrike(obj_id ship, obj_id commander, obj_id target, int CMD_LIGHT_STRIKE_DELAY)
    {
    ...
    public static transform playerCommandSpawnerLocGetter(obj_id ship, boolean flip)
    {
    ...
    public static boolean spawnStrikeBombers(obj_id ship, obj_id commander, String packageType, String attack_type, obj_id target)
    {
    ...
    public static boolean setupStrikePackageEscort(int bomberSquadId, String packageType, obj_id commander, String targetDifficultyTier)
    {
    ...
    public static void strikePackageEvac(obj_id commander, int bomberSquadId, int fighterSquadId)
    {
    ...
    public static void initializeTargetTracking(obj_id commander, int bomberSquadId, int targetSquadId)
    {
    ...
    public static void strikeBomberCleanup(obj_id commander)
    {
        if (utils.hasLocalVar(commander, "cmd.bmb.bmbrSquadId"))
        {
    ...
    public static boolean readyForPirateRaid(obj_id ship, obj_id commander)
    {
    ...
    public static boolean executePirateRaidOne(obj_id ship, obj_id commander, obj_id target, int CMD_PIRATE_LURE_DELAY)
    {
    ...
    public static boolean executePirateRaidTwo(obj_id ship, obj_id commander, obj_id target, int CMD_PIRATE_LURE_DELAY)
    {
        debugServerConsoleMsg(null, "SPACE_COMBAT.executePirateRaidOne");
        String packageType = "light";
        String attackType = "many";
    ...
    public static boolean spawnPirateRaiders(obj_id ship, obj_id commander, String level, String attack_type, obj_id target)
    {
    ...
    public static void piratePackageEvac(obj_id commander, int pirateSquadId)
    {
    ...
    public static float getShipWeaponDamage(obj_id objAttacker, obj_id objDefender, int intWeaponSlot)
    {
        return getShipWeaponDamage(objAttacker, objDefender, intWeaponSlot, false);
    }
    public static float getShipWeaponDamage(obj_id objAttacker, obj_id objDefender, int intWeaponSlot, boolean isMissile)
    {
    ...
    public static float doShieldDamage(obj_id objAttacker, obj_id objDefender, int intWeaponSlot, float fltDamage, int intSide)
    {
        fltDamage = damageShield(objAttacker, objDefender, intWeaponSlot, fltDamage, intSide);
        return fltDamage;
    }
    public static float doArmorDamage(obj_id objAttacker, obj_id objDefender, int intWeaponSlot, float fltDamage, int intSide)
    {
        fltDamage = damageArmor(objAttacker, objDefender, intWeaponSlot, fltDamage, intSide);
        return fltDamage;
    }
    public static float doChassisDamage(obj_id objAttacker, obj_id objDefender, int intWeaponSlot, float fltDamage)
    {
    ...
    public static float getShieldHitPoints(obj_id objDefender, int intSide)
    {
    ...
    public static float getShieldHitPointsMaximum(obj_id objDefender, int intSide)
    {
        if (isShipSlotInstalled(objDefender, ship_chassis_slot_type.SCST_shield_0))
        {
            if (intSide == space_combat.FRONT)
    ...
    public static float getArmorHitPoints(obj_id objDefender, int intSide)
    {
        if (intSide == space_combat.FRONT)
        {
    ...
    public static float getArmorHitPointsMaximum(obj_id objDefender, int intSide)
    {
        if (intSide == space_combat.FRONT)
        {
            int intSlot = ship_chassis_slot_type.SCST_armor_0;
    ...
    public static void setShieldHitPoints(obj_id objDefender, int intSide, float fltHitPoints)
    {
        if (isShipSlotInstalled(objDefender, ship_chassis_slot_type.SCST_shield_0))
        {
            if (intSide == space_combat.FRONT)
    ...
    public static void setArmorHitPoints(obj_id objDefender, int intSide, float fltHitPoints)
    {
        if (intSide == space_combat.FRONT)
        {
            int intSlot = ship_chassis_slot_type.SCST_armor_0;
    ...
    public static float damageShield(obj_id objAttacker, obj_id objDefender, int intWeaponSlot, float fltDamage, int intSide)
    {
    ...
    public static float damageArmor(obj_id objAttacker, obj_id objDefender, int intWeaponSlot, float fltDamage, int intSide)
    {
    ...
    public static float doComponentDamage(obj_id objAttacker, obj_id objDefender, int intWeaponSlot, int intTargetedComponent, float fltDamage, int intSide)
    {
    ...
    public static dictionary getComponentWeightings(obj_id objDefender, int intTargetedComponent)
    {
        if (intTargetedComponent != space_combat.SHIP)
        {
            if (!isShipSlotInstalled(objDefender, intTargetedComponent))
    ...
    public static int getComponentToDamage(obj_id objAttacker, obj_id objDefender, int intTargetedComponent, int intSide)
    {
    ...
    public static float damageComponent(obj_id objAttacker, obj_id objDefender, int intWeaponSlot, int intComponent, float fltDamage, int intSide, boolean boolTrackDisabled)
    {
        int intDamage = (int)fltDamage;
        fltDamage = (float)intDamage;
    ...
    public static String getSideName(int intSide)
    {
        if (intSide == space_combat.FRONT)
        {
            return "Front";
    ...
    public static void doShieldDamageSpam(obj_id objAttacker, obj_id objDefender, int intSide, float fltDamage, float fltRemainingHitPoints)
    {
    ...
    public static void doArmorDamageSpam(obj_id objAttacker, obj_id objDefender, int intSide, float fltDamage, float fltRemainingHitPoints)
    {
        if (!space_utils.isShip(objAttacker) || (!space_utils.isShip(objDefender)))
        {
            return;
    ...
    public static void doComponentDamageSpam(obj_id objAttacker, obj_id objDefender, int intComponent, float fltDamage)
    {
        if (!space_utils.isShip(objAttacker) || (!space_utils.isShip(objDefender)))
        {
            return;
    ...
    public static void doChassisDamageSpam(obj_id objAttacker, obj_id objDefender, float fltDamage, float fltRemainingHitPoints)
    {
        if (!space_utils.isShip(objAttacker) || !space_utils.isShip(objDefender))
        {
            return;
    ...
    public static void doInteriorDamageNotification(obj_id objShip, int intDamageType, float fltCurrentHitpoints, float fltMaximumHitpoints)
    {
        if (hasScript(objShip, "space.ship.ship_interior"))
        {
            dictionary dctParams = new dictionary();
    ...
    public static void checkAndPerformCombatTaunts(obj_id objTaunter, obj_id objTauntee, String strLocalVar, String strType, float fltRange)
    {
    ...
    public static void setupCapitalShipFromTurretDefinition(obj_id objShip, String strDefinition)
    {
    ...
    public static void playCombatTauntSound(obj_id objPlayer)
    {
        String[] strSounds = 
        {
    ...
    public static transform getClosestStationRespawnLocation(obj_id objShip)
    {
        obj_id objClosestStation = getClosestSpaceStation(objShip);
        if (!isIdValid(objClosestStation) || !exists(objClosestStation))
        {
    ...
    public static location getClosestStationLocation(obj_id objShip)
    {
        obj_id objClosestStation = getClosestSpaceStation(objShip);
        if (!isIdValid(objClosestStation) || !exists(objClosestStation))
        {
    ...
    public static void sendDestructionNotification(obj_id objShip, obj_id objAttacker)
    {
    ...
    public static void clearHyperspace(obj_id objShip)
    {
    ...
    public static void doDeathCleanup(obj_id self)
    {
    ...
    public static void setDeathFlags(obj_id objShip)
    {
        utils.setScriptVar(objShip, "intDestroyed", getGameTime());
        return;
    }
    public static void clearDeathFlags(obj_id objShip)
    {
        utils.removeScriptVar(objShip, "intDestroyed");
        utils.removeScriptVar(objShip, "intPVPKill");
        return;
    }
    public static boolean hasDeathFlags(obj_id objShip)
    {
    ...
    public static void addModuleToDatapad(obj_id objModule, obj_id objDatapad)
    {
    ...
    public static void addModuleToDatapad(String strDroidCommand, obj_id objDatapad)
    {
        int programSize = space_pilot_command.getDroidProgramSize(strDroidCommand, null);
        addModuleToDatapad(strDroidCommand, objDatapad, programSize);
        return;
    }
    public static void addModuleToDatapad(String strDroidCommand, obj_id objDatapad, int intProgramSize)
    {
    ...
    public static void doBattlefieldRepairCheck(obj_id objShip)
    {
        location locTest = getLocation(objShip);
    ...
    public static void simpleShieldRatioRebalance(obj_id ship)
    {
    ...
    public static boolean isCapShip(obj_id ship)
    {
        return (dataTableGetInt("datatables/space_mobile/space_mobile.iff", getStringObjVar(ship, "ship.shipName"), "shipClass") == 2);
    }
    public static boolean getCollectionLoot(obj_id objAttacker, obj_id objPilot, obj_id objContainer, String collectionLoot)
    {
        if (!isIdValid(objAttacker))
        {
            return false;
    ...
    public static boolean attemptToGrantLootItem(String lootItem, obj_id objAttacker, obj_id objContainer)
    {
        if (!isIdValid(objAttacker))
        {
            return false;
