...
public class spawning extends script.base_script
{
    ...
    public static void activateSpawnerHack(obj_id objPlayer)
    {
    ...
    public static location getRandomLocationInCircle(location locTest, float fltSize)
    {
        locTest.x = locTest.x + rand(-1 * fltSize, fltSize);
        locTest.z = locTest.z + rand(-1 * fltSize, fltSize);
        return locTest;
    }
    public static location getRandomLocationAtDistance(location locTest, float fltSize)
    {
        int position = 1;
        if (rand(0, 1) == 0)
        {
    ...
    public static boolean checkSpawnCount(obj_id self)
    {
    ...
    public static void incrementSpawnCount(obj_id self)
    {
        int intCurrentSpawnCount = utils.getIntScriptVar(self, "intCurrentSpawnCount");
        int intSpawnCount = getIntObjVar(self, "intSpawnCount");
    ...
    public static void addToSpawnDebugList(obj_id self, obj_id spawned)
    {
    ...
    public static Vector getAllObjectsWithObjVar(location locTest, String strObjVarName)
    {
        Vector objArray = new Vector();
        objArray.setSize(0);
        return objArray;
    }
    public static Vector getObjectsWithObjVar(obj_id objParent, String strObjVarName, Vector objArray)
    {
    ...
    public static obj_id[] getAllContents(obj_id objObject)
    {
    ...
    public static void planetSpawnersCreatureDied(obj_id spawner, obj_id deadGuy)
    {
    ...
    public static obj_id createSpawnInLegacyCell(obj_id dungeon, location creatureLocation, String creatureName)
    {
    ...
    public static boolean spawnObjectsInDungeonFromTable(obj_id dungeon, String planet, String table)
    {
        if (!isValidId(dungeon))
        {
            return false;
