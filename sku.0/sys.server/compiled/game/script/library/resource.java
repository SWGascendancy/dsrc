...
public class resource extends script.base_script
{
    ...
    public static boolean isResourceDerivedFrom(String resource_type, String parent_class)
    {
    ...
    public static obj_id[] create(obj_id resourceId, int amt, obj_id targetContainer, obj_id playerId)
    {
        if ((resourceId == null) || (resourceId == obj_id.NULL_ID))
        {
            return null;
    ...
    public static obj_id[] create(obj_id resourceId, int amt, obj_id targetContainer)
    {
        return create(resourceId, amt, targetContainer, obj_id.NULL_ID);
    }
    public static obj_id[] createRandom(String resourceClass, int amt, location loc, obj_id targetContainer, obj_id playerId, int min)
    {
    ...
    public static obj_id[] createRandom(String resourceClass, int amt, location loc, obj_id targetContainer, obj_id playerId)
    {
        return createRandom(resourceClass, amt, loc, targetContainer, playerId, 1);
    }
    public static obj_id[] createRandom(String resourceClass, int amt, location loc, obj_id targetContainer)
    {
        return createRandom(resourceClass, amt, loc, targetContainer, obj_id.NULL_ID, 1);
    }
    public static boolean setToolClass(obj_id tool, int resource_class)
    {
        if (tool == null)
        {
            return false;
    ...
    public static boolean requestSetToolRatio(obj_id user, obj_id tool)
    {
    ...
    public static boolean showToolProperties(obj_id target, obj_id tool)
    {
    ...
    public static String getSkillModForClass(String resource_class)
    {
    ...
    public static boolean isEnergyGeoThermal(String resource_class)
    {
        if (resource_class.equals(""))
        {
            return false;
    ...
    public static boolean isOrganic(String resource_class)
    {
        if (resource_class.equals(""))
        {
            return false;
    ...
    public static boolean isInorganic(String resource_class)
    {
        if (resource_class.equals(""))
        {
            return false;
    ...
    public static boolean isSolid(String resource_class)
    {
        if (resource_class.equals(""))
        {
            return false;
    ...
    public static boolean isGas(String resource_class)
    {
        if (resource_class.equals(""))
        {
            return false;
    ...
    public static boolean isLiquid(String resource_class)
    {
        if (resource_class.equals(""))
        {
            return false;
    ...
    public static boolean isCreatureResource(String resource_class)
    {
        if (resource_class.equals(""))
        {
            return false;
    ...
    public static boolean isFloraResource(String resource_class)
    {
        if (resource_class.equals(""))
        {
            return false;
    ...
    public static boolean isFloraFoodResource(String resource_class)
    {
        if (resource_class.equals(""))
        {
            return false;
    ...
    public static boolean isFloraStructuralResource(String resource_class)
    {
        if (resource_class.equals(""))
        {
            return false;
    ...
    public static boolean isEnergyWindResource(String resource_class)
    {
        if (resource_class.equals(""))
        {
            return false;
    ...
    public static boolean isEnergySolarResource(String resource_class)
    {
        if (resource_class.equals(""))
        {
            return false;
    ...
    public static String getResourceName(String resource_class)
    {
    ...
    public static int getEnergyTotalOnTarget(obj_id target)
    {
        if (!isIdValid(target))
        {
            return -1;
    ...
    public static int getPotentialEnergyValue(obj_id crate)
    {
        if (!isIdValid(crate))
        {
            return 0;
    ...
    public static float getEnergyPowerRatio(obj_id rType)
    {
    ...
    public static int getResourceAttribute(String resourceName, String attribName)
    {
    ...
    public static dictionary getGeoThermalEnergyInformationOnTarget(obj_id target)
    {
        if (!isIdValid(target))
        {
            return null;
    ...
    public static void cleanupTool(obj_id player, obj_id tool)
    {
        if (isIdValid(player))
        {
    ...
    public static boolean consumeResource(obj_id player, String resource, int quantity)
    {
    ...
    public static boolean hasResource(obj_id player, String resource, int quantity)
    {
        obj_id[] contents = getInventoryAndEquipment(player);
        if (contents == null || contents.length < 1)
        {
