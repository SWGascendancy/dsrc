...
public class guild extends script.base_script
{
    ...
    public static final int GUILD_PERMISSION_MEMBER = 1;
    ...
    public static final int GUILD_PERMISSION_WAR_INCLUSION_GROUND = (1 << 21);
    public static final int GUILD_PERMISSION_WAR_EXCLUSION_GROUND = (1 << 22);
    public static final int GUILD_PERMISSION_WAR_INCLUSION_SPACE = (1 << 23);
    public static final int GUILD_PERMISSION_WAR_EXCLUSION_SPACE = (1 << 24);
    public static final int GUILD_PERMISSION_ONLINE_STATUS = (1 << 25);
    public static final int GUILD_PERMISSIONS_ALL_PERSONAL = (GUILD_PERMISSION_WAR_EXCLUSION_GROUND | GUILD_PERMISSION_ONLINE_STATUS);
    ...
    public static final string_id SID_GUILD_PERMISSION_WAR_EXCLUDE_GROUND = new string_id("guild", "war_exclude_ground");
    public static final string_id SID_GUILD_PERMISSION_WAR_INCLUDE_GROUND = new string_id("guild", "war_include_ground");
    public static final string_id SID_GUILD_PERMISSION_WAR_EXCLUDE_SPACE = new string_id("guild", "war_exclude_space");
    public static final string_id SID_GUILD_PERMISSION_WAR_INCLUDE_SPACE = new string_id("guild", "war_include_space");
    ...
    public static final int[] PERMISSION_INTERFACE_FLAGS = 
    {
        ...
        GUILD_PERMISSION_WAR_EXCLUSION_GROUND,
        GUILD_PERMISSION_WAR_INCLUSION_GROUND,
        GUILD_PERMISSION_WAR_EXCLUSION_SPACE,
        GUILD_PERMISSION_WAR_INCLUSION_SPACE
    };
    ...
    public static String resolveGuildName(int guildId)
    {
        if (guildId != 0)
        {
    ...
    public static String resolveMemberName(int guildId, obj_id who)
    {
        if (isIdValid(who))
        {
    ...
    public static void GuildLog(int guildId, String command, obj_id actor, obj_id target, String description)
    {
    ...
    public static String buildFakeLocalizedProse(String rawText, String substitute1, String substitute2)
    {
    ...
    public static boolean hasGuildPermission(int guildId, obj_id who, int permission)
    {
        if (guildId == 0)
        {
            return false;
    ...
    public static boolean hasDeclaredWarAgainst(int guildId, int enemyId)
    {
    ...
    public static int create(obj_id actor, String guildName, String guildAbbrev)
    {
    ...
    public static void changeLeader(int guildId, obj_id newLeader)
    {
    ...
    public static void disbandForNotEnoughMembers(int guildId)
    {
    ...
    public static void disband(int guildId, obj_id actor)
    {
    ...
    public static void sponsor(int guildId, obj_id actor, String who)
    {
    ...
    public static void accept(int guildId, obj_id actor, String who)
    {
        if (!isIdValid(actor))
        {
            return;
    ...
    public static void leave(obj_id actor)
    {
    ...
    public static void kick(int guildId, obj_id actor, String who)
    {
        if (guildId == 0)
        {
            return;
    ...
    public static void title(int guildId, obj_id actor, String who, String title)
    {
    ...
    public static void handleGuildNameChange(int guildId, String newName, String newAbbrev, obj_id changerId)
    {
    ...
    public static void nameChange(int guildId, obj_id actor, String newName, String newAbbrev)
    {
    ...
    public static void war(int guildId, obj_id actor, String who)
    {
    ...
    public static void war(int guildId, obj_id actor, int enemyId)
    {
    ...
    public static void peace(int guildId, obj_id actor, String who)
    {
        peace(guildId, actor, findGuild(who));
    }
    public static void peace(int guildId, obj_id actor, int enemyId)
    {
        if (enemyId != 0 && enemyId != guildId)
        {
            if (!hasGuildPermission(guildId, actor, GUILD_PERMISSION_WAR))
    ...
    public static void togglePersonalPermission(int guildId, obj_id actor, String who, int permBit)
    {
        obj_id memberId = findMemberIdByName(guildId, who, false, true);
    ...
    public static void togglePermission(int guildId, obj_id actor, String who, int permBit)
    {
    ...
    public static void dumpInfo(int guildId, obj_id actor)
    {
    ...
    public static obj_id findMemberIdByName(int guildId, String name, boolean fromSponsored, boolean fromMembers)
    {
    ...
    public static boolean hasSponsoredMembers(int guildId)
    {
        obj_id[] members = guildGetMemberIds(guildId);
        if (members != null)
        {
    ...
    public static obj_id[] getMemberIds(int guildId, boolean fromSponsored, boolean fromMembers)
    {
        if (guildId == 0)
        {
            return null;
    ...
    public static String[] getMemberNames(int guildId, boolean fromSponsored, boolean fromMembers)
    {
        obj_id[] members = getMemberIds(guildId, fromSponsored, fromMembers);
        int count = 0;
        if (members != null)
    ...
    public static String[] getMemberNamesAndTitles(int guildId)
    {
    ...
    public static String[] getEnemyNamesAndAbbrevs(int guildId)
    {
    ...
    public static int[] getEnemyIds(int guildId)
    {
        int[] enemies_A_to_B = guildGetEnemies(guildId);
        int[] enemies_B_to_A = getGuildsAtWarWith(guildId);
        int count = 0;
    ...
    public static void mailToGuild(int guildId, String subject, string_id textId, String substitute1, String substitute2, String substitute3)
    {
        obj_id[] members = getMemberIds(guildId, false, true);
        if (members != null)
        {
    ...
    public static void mailToGuild(int guildId, String subject, string_id textId, String substitute1, String substitute2)
    {
        mailToGuild(guildId, subject, textId, substitute1, substitute2, "");
    }
    public static void mailToGuild(int guildId, String subject, string_id textId, String substitute1)
    {
        mailToGuild(guildId, subject, textId, substitute1, "", "");
    }
    public static void mailToGuild(int guildId, String subject, string_id textId)
    {
        mailToGuild(guildId, subject, textId, "", "", "");
    }
    public static void mailToPerson(int guildId, String toName, String subject, string_id textId, String substitute1, String substitute2, String substitute3)
    {
        prose_package pp = new prose_package();
        pp.stringId = textId;
    ...
    public static void mailToPerson(int guildId, String toName, String subject, string_id textId, String substitute1, String substitute2)
    {
        mailToPerson(guildId, toName, subject, textId, substitute1, substitute2, "");
    }
    public static void mailToPerson(int guildId, String toName, String subject, string_id textId, String substitute1)
    {
        mailToPerson(guildId, toName, subject, textId, substitute1, "", "");
    }
    public static void mailToPerson(int guildId, String toName, String subject, string_id textId)
    {
        mailToPerson(guildId, toName, subject, textId, "", "", "");
    }
    public static void mailToGuildMember(int guildId, obj_id memberId, String subject, string_id textId, String substitute1, String substitute2, String substitute3)
    {
        mailToPerson(guildId, guildGetMemberName(guildId, memberId), subject, textId, substitute1, substitute2, substitute3);
    }
    public static void mailToGuildMember(int guildId, obj_id memberId, String subject, string_id textId, String substitute1, String substitute2)
    {
        mailToGuildMember(guildId, memberId, subject, textId, substitute1, substitute2, "");
    }
    public static void mailToGuildMember(int guildId, obj_id memberId, String subject, string_id textId, String substitute1)
    {
        mailToGuildMember(guildId, memberId, subject, textId, substitute1, "", "");
    }
    public static void mailToGuildMember(int guildId, obj_id memberId, String subject, string_id textId)
    {
        mailToGuildMember(guildId, memberId, subject, textId, "", "", "");
    }
    public static int findIntTableOffset(int[] from, int find)
    {
        if (from != null)
        {
    ...
    public static int findObjIdTableOffset(obj_id[] from, obj_id find)
    {
        if (from != null)
        {
            for (int i = 0; i < from.length; ++i)
    ...
    public static void selectPermissions(obj_id self, obj_id player, String name, int guildId)
    {
    ...
    public static void selectRank(obj_id self, obj_id player, String name, int guildId)
    {
    ...
    public static void showGuildMembers(obj_id terminal, obj_id player, int firstMember, int permission, String title, String name)
    {
    ...
    public static void setWindowPid(obj_id player, int pid)
    {
        if (pid > -1)
        {
    ...
    public static int getWindowPid(obj_id player)
    {
        return utils.getIntScriptVar(player, "guild.pid");
    }
    public static boolean hasWindowPid(obj_id player)
    {
        return utils.hasScriptVar(player, "guild.pid");
    }
    public static void removeWindowPid(obj_id player)
    {
        utils.removeScriptVar(player, "guild.pid");
    }
    public static obj_id getGuildRemoteDevice(obj_id player)
    {
    ...
    public static String[] getAvailableMemberOptions(obj_id self, obj_id player)
    {
        int guildId = getGuildId(player);
    ...
    public static void toggleWarExclusion(obj_id player, int guildId, String name)
    {
        ...
        GuildLog(guildId, "togglePermission", player, target, "bit " + GUILD_PERMISSION_WAR_EXCLUSION_GROUND);
        guildSetMemberPermission(guildId, target, guildGetMemberPermissions(guildId, target) ^ GUILD_PERMISSION_WAR_EXCLUSION_GROUND);
        prose_package pp = new prose_package();
        pp.target.set(name);
        pp.stringId = SID_GUILD_WAR_EXCLUSION_TOGGLED;
        sendSystemMessageProse(player, pp);
    }
    public static void toggleWarInclusion(obj_id player, int guildId, String name)
    {
        if (!isIdValid(player) || !exists(player) || guildId <= 0 || name == null || name.length() < 1)
        {
            return;
        ...
        GuildLog(guildId, "togglePermission", player, target, "bit " + GUILD_PERMISSION_WAR_INCLUSION_GROUND);
        guildSetMemberPermission(guildId, target, guildGetMemberPermissions(guildId, target) ^ GUILD_PERMISSION_WAR_INCLUSION_GROUND);
        prose_package pp = new prose_package();
        pp.target.set(name);
        pp.stringId = SID_GUILD_WAR_INCLUSION_TOGGLED;
        sendSystemMessageProse(player, pp);
    }
    public static void chooseTitle(obj_id self, obj_id player, String name)
    {
    ...
    public static void setMenuContextString(obj_id self, obj_id player, String varName, String value)
    {
        deltadictionary dd = self.getScriptVars();
        dd.put("guildMenu." + player + "." + varName, value);
    }
    public static void confirmKick(obj_id self, obj_id player, String name)
    {
    ...
    public static void setMenuContextIntArray(obj_id self, obj_id player, String varName, int[] value)
    {
        deltadictionary dd = self.getScriptVars();
        dd.put("guildMenu." + player + "." + varName, value);
    }
    public static String getMenuContextString(obj_id self, obj_id player, String varName)
    {
        deltadictionary dd = self.getScriptVars();
        return dd.getString("guildMenu." + player + "." + varName);
    }
    public static void removeMenuContextVar(obj_id self, obj_id player, String varName)
    {
        deltadictionary dd = self.getScriptVars();
        dd.remove("guildMenu." + player + "." + varName);
    }
    public static void showPermissionList(obj_id player, int guildId)
    {
        if (!isIdValid(player))
        {
            return;
    ...
    public static void showTitleList(obj_id player, int guildId)
    {
        if (!isIdValid(player))
        {
            return;
    ...
    public static String[] getGuildTitles(int guildId)
    {
        if (guildId == 0)
        {
            return null;
    ...
    public static boolean memberHasTitle(int guildId, obj_id memberId, String title)
    {
        String memberTitle = guildGetMemberTitle(guildId, memberId);
        return (toLower(memberTitle)).equals(toLower(title));
    }
    public static String[] getMemberNamesByPermission(int guildId, int permission)
    {
    ...
    public static String[] getMemberNamesByTitle(int guildId, String title)
    {
        obj_id[] members = getMemberIds(guildId, false, true);
        Vector filteredNamesAndTitles = new Vector();
        filteredNamesAndTitles.setSize(0);
    ...
    public static String[] getMemberNamesByName(int guildId, String name)
    {
    ...
    public static void showGuildInfo(obj_id player)
    {
    ...
    public static void showGuildEnemies(obj_id player)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        messageTo(player, "showGuildEnemiesMessage", params, 2, false);
    }
    public static int[] getMenuContextIntArray(obj_id self, obj_id player, String varName)
    {
        deltadictionary dd = self.getScriptVars();
        return dd.getIntArray("guildMenu." + player + "." + varName);
    }
    public static void showGuildSponsored(obj_id player)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        messageTo(player, "showGuildSponsoredMessage", params, 3, false);
    }
    public static boolean loadCartridge(obj_id player, obj_id cartridge)
    {
    ...
    public static int getVotingTime(int guildId)
    {
        return guildGetElectionNextEndTime(guildId);
    }
    public static int getGracePeriodTime(int guildId)
    {
        return guildGetElectionPreviousEndTime(guildId);
    }
    public static boolean isVotingEnabled(int guildId)
    {
    ...
    public static boolean isVotingGracePeriod(int guildId)
    {
    ...
    public static boolean hasElectionEnded(obj_id player)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static obj_id[] getCandidates(int guildId)
    {
        if (guildId <= 0)
        {
            return null;
    ...
    public static String[] getGuildMemberNamesByArray(int guildId, obj_id[] memberIds)
    {
    ...
    public static boolean isCandidate(int guildId, obj_id memberId)
    {
    ...
    public static void makeCandidate(int guildId, obj_id memberId)
    {
        if (guildId <= 0 || !isIdValid(memberId))
        {
            return;
    ...
    public static void removeCandidate(int guildId, obj_id memberId)
    {
        if (guildId <= 0 || !isIdValid(memberId))
        {
            return;
    ...
    public static void resetCandidates(int guildId, obj_id[] excluded)
    {
        if (guildId <= 0)
        {
            return;
    ...
    public static obj_id getGuildMemberVote(int guildId, obj_id memberId)
    {
        if (guildId <= 0 || !isIdValid(memberId))
        {
            return null;
    ...
    public static obj_id[] getGuildMemberVotes(int guildId)
    {
        if (guildId <= 0)
        {
            return null;
    ...
    public static int[] getTalliedVotes(int guildId, obj_id[] candidates)
    {
        if (guildId <= 0)
        {
            return null;
    ...
    public static void allegiance(obj_id actor, String who)
    {
        int guildId = getGuildId(actor);
        if (!isIdValid(actor))
        {
    ...
    public static void stopElection(obj_id player)
    {
        if (!isIdValid(player))
        {
            return;
    ...
    public static obj_id determineLeaderByAllegiance(int guildId)
    {
        if (guildId == 0)
        {
            return null;
    ...
    public static void showStandings(obj_id self, obj_id player)
    {
    ...
    public static void showMasterGuildWarTableDictionary(obj_id player)
    {
        if (!isIdValid(player) || !exists(player))
        {
            return;
    ...
    public static void closedMasterGuildWarTableDictionary(obj_id player)
    {
        if (!isIdValid(player) || !exists(player))
        {
            return;
    ...
    public static void showInactiveGuildWarTableDictionary(obj_id player)
    {
        if (!isIdValid(player) || !exists(player))
        {
            return;
    ...
    public static void closedInactiveGuildWarTableDictionary(obj_id player)
    {
        if (!isIdValid(player) || !exists(player))
        {
            return;
    ...
    public static void showRankSummary(obj_id self, obj_id player)
    {
        if (!isIdValid(player) || !exists(player))
        {
            return;
    ...
    public static void showRankList(obj_id self, obj_id player)
    {
        if (!isIdValid(player) || !exists(player))
        {
            return;
    ...
    public static void showPermissionSummary(obj_id self, obj_id player)
    {
        if (!isIdValid(player) || !exists(player))
        {
            return;
    ...
    public static void statusNotification(int guildId, obj_id who, boolean login)
    {
        if (guildId <= 0)
        {
            return;
    ...
    public static boolean inSameGuild(obj_id target1, obj_id target2)
    {
