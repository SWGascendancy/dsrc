...
public class hq extends script.base_script
{
    ...
    public static void loadHqTheater(obj_id hq)
    {
    ...
    public static void cleanupHqTheater(obj_id hq)
    {
    ...
    public static void loadHqTerminals(obj_id hq)
    {
    ...
    public static void loadTurretTerminals(obj_id hq)
    {
    ...
    public static void loadHqSpawns(obj_id hq)
    {
        LOG("hq", "loadHqSpawns entered...");
        loadInteriorHqSpawns(hq);
        loadExteriorHqSpawns(hq);
    }
    public static void loadInteriorHqSpawns(obj_id hq)
    {
    ...
    public static obj_id[] spawnInterior(obj_id hq, String tbl)
    {
    ...
    public static obj_id createInteriorEgg(obj_id hq, location there, String myFac, float yaw)
    {
    ...
    public static void loadExteriorHqSpawns(obj_id hq)
    {
    ...
    public static obj_id[] spawnExterior(obj_id hq, String tbl)
    {
    ...
    public static location parseExteriorLocation(location home, String delta)
    {
    ...
    public static void cleanupHqSpawns(obj_id hq)
    {
    ...
    public static void prepareHqDefenses(obj_id hq)
    {
    ...
    public static void cleanupHqDefenses(obj_id hq)
    {
        if (!hasObjVar(hq, VAR_DEFENSE_BASE))
        {
            return;
    ...
    public static void disableHqTerminals(obj_id hq)
    {
    ...
    public static void enableHqTerminals(obj_id hq)
    {
    ...
    public static void loadVulnerability(obj_id hq)
    {
    ...
    public static obj_id[] loadObjectives(obj_id hq)
    {
        String filename = utils.getTemplateFilenameNoPath(hq);
        if (filename == null || filename.equals(""))
        {
    ...
    public static int overdueStampReplacer(int stamp, int currentTime)
    {
    ...
    public static int farFutureStampReplacer(int stamp, int currentTime)
    {
    ...
    public static void unloadVulnerabilityForObjectReInit(obj_id hq)
    {
    ...
    public static void unloadVulnerability(obj_id hq)
    {
        obj_id[] objectives = getObjIdArrayObjVar(hq, VAR_OBJECTIVE_ID);
        dictionary mapParams = new dictionary();
        int newStatus = 0;
    ...
    public static int getCurrentTimeInSecsNormalized()
    {
    ...
    public static boolean canDisableObjective(obj_id hq, obj_id objective)
    {
    ...
    public static obj_id getNextObjective(obj_id hq)
    {
        obj_id[] objectives = getObjIdArrayObjVar(hq, VAR_OBJECTIVE_ID);
        if (objectives == null || objectives.length == 0)
        {
    ...
    public static obj_id getPriorObjective(obj_id hq, obj_id objective)
    {
        obj_id[] objectives = getObjIdArrayObjVar(hq, VAR_OBJECTIVE_ID);
        if (objectives == null || objectives.length == 0)
        {
    ...
    public static void disableObjective(obj_id hq, obj_id objective)
    {
    ...
    public static void disableObjective(obj_id objective)
    {
        obj_id hq = null;
    ...
    public static void detonateHq(obj_id hq)
    {
    ...
    public static void validateDefenseTracking(obj_id hq)
    {
        if (!isIdValid(hq))
        {
            return;
    ...
    public static void sealEntrance(obj_id hq)
    {
        if (!isIdValid(hq))
        {
            return;
    ...
    public static void ejectEnemyFactionOnLogin(obj_id player)
    {
    ...
    public static void loadFullTimeVulnerability(obj_id hq)
    {
        if (hasObjVar(hq, VAR_OBJECTIVE_ID))
        {
    ...
    public static void planetMapVulnerabilityStatusChange(obj_id hq, int newStatus)
    {
    ...
    public static void refundFactionBaseLots(obj_id base)
    {
        ...
        int base_lot_refund = player_structure.getRequiredLots(getTemplateName(base));
    ...
    public static void refundBaseUnit(obj_id base)
    {
        obj_id baseOwner = getOwner(base);
        messageTo(baseOwner, "factionBaseUnitRefund", null, 1f, true);
        return;
    }
    public static boolean isPvpFactionBase(obj_id base)
    {
    ...
    public static void removeCovertDetector(obj_id base)
    {
    ...
    public static void loadAlarmUnits(obj_id hq)
    {
    ...
    public static void spawnAlarmUnits(obj_id hq)
    {
    ...
    public static void activateHackAlarms(obj_id hq, boolean activate)
    {
    ...
    public static void activateDestructAlarms(obj_id hq, boolean activate)
    {
    ...
    public static void cleanupBaseAlarmUnits(obj_id hq)
    {
        if (hasObjVar(hq, "hq.alarm.hack"))
        {
    ...
    public static void spawnRovingSecurityTeam(obj_id hq)
    {
    ...
    public static String guardKeyPicker(obj_id hq)
    {
    ...
    public static void cleanupHqSecurityTeam(obj_id hq)
    {
    ...
    public static void loadReinforcementSpawn(obj_id hq)
    {
        if (utils.hasScriptVar(hq, SCRIPTVAR_SPAWN_REINFORCEMENT))
        {
            return;
    ...
    public static obj_id spawnReinforcements(obj_id hq, String tbl)
    {
        if (!isIdValid(hq) || tbl == null || tbl.equals(""))
        {
            return null;
    ...
    public static void createMinefield(obj_id hq)
    {
        String filename = utils.getTemplateFilenameNoPath(hq);
    ...
    public static int getTotalMines(obj_id hq)
    {
        if (!hasObjVar(hq, "mines"))
        {
            return 0;
    ...
    public static float getMinefieldRadius(obj_id hq)
    {
        String filename = utils.getTemplateFilenameNoPath(hq);
        String table = TBL_DEFENSE_PATH + "minefield.iff";
        return dataTableGetFloat(table, filename, "radius");
    }
    public static int getMaxMines(obj_id hq)
    {
        String filename = utils.getTemplateFilenameNoPath(hq);
        String table = TBL_DEFENSE_PATH + "minefield.iff";
        return dataTableGetInt(table, filename, "max");
    }
    public static int getRandomMineType(obj_id hq)
    {
        if (!hasObjVar(hq, "mines"))
        {
            return -1;
    ...
    public static void clearMinefield(obj_id hq)
    {
        if (!hasObjVar(hq, "mines"))
        {
            return;
    ...
    public static boolean reportHackAlarmToPlanet(obj_id hq)
    {
        if (!isValidId(hq))
        {
            return false;
    ...
    public static boolean cleanUpHackAlarms(obj_id hq)
    {
        if (!isValidId(hq))
        {
            return false;
