...
public class fs_quests_sad extends script.base_script
{
    ...
    public static boolean hasTask(obj_id player)
    {
        for (int i = 0; i < 8; i++)
        {
    ...
    public static boolean hasTask2(obj_id player)
    {
        for (int i = 0; i < 8; i++)
        {
    ...
    public static boolean hasExceededTaskLimit(obj_id player)
    {
    ...
    public static void recordTookTask(obj_id player)
    {
    ...
    public static void recordTaskSuccess(obj_id player)
    {
        LOG("newquests", "recordTaskSuccess");
        return;
    }
    public static void recordTaskFailure(obj_id player)
    {
        LOG("newquests", "recordTaskFailure");
        return;
    }
    public static boolean hasCompletedAllTasks(obj_id player)
    {
        LOG("newquests", "hasCompletedAllTasks");
        return (quests.isComplete("fs_quests_sad_finish", player));
    }
    public static boolean hasCompletedAllTasks2(obj_id player)
    {
        LOG("newquests", "hasCompletedAllTasks");
        return (quests.isComplete("fs_quests_sad2_finish", player));
    }
    public static int getNumberTasksCompleted(obj_id player)
    {
    ...
    public static int getNumberTasksCompleted2(obj_id player)
    {
        LOG("newquests", "getNumberTasksCompleted");
    ...
    public static void performEndOfQuest(obj_id player)
    {
        cleanup(player);
    ...
    public static void performEndOfQuest2(obj_id player)
    {
        cleanup(player);
    ...
    public static void cleanup(obj_id player)
    {
        int x = 0;
        for (x = 1; x < 9; x++)
        {
