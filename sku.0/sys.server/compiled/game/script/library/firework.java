...
public class firework extends script.base_script
{
    ...
    public static boolean launch(obj_id target, obj_id firework)
    {
    ...
    public static void launchShow(obj_id target, obj_id show)
    {
    ...
    public static boolean addShowEvent(obj_id target, obj_id show, obj_id firework)
    {
    ...
    public static void removeShowEvent(obj_id target, obj_id show, int idx)
    {
    ...
    public static void setShowEventDelay(obj_id target, obj_id show, int idx, float delay)
    {
        if (!isIdValid(target) || !isIdValid(show) || idx < 0)
        {
            return;
    ...
    public static void showEventDataSUI(obj_id player, obj_id show)
    {
    ...
    public static void showRemoveEventSUI(obj_id player, obj_id show)
    {
        if (!isIdValid(player) || !isIdValid(show))
        {
            return;
    ...
    public static void showReorderEventsSUI(obj_id player, obj_id show)
    {
        if (!isIdValid(player) || !isIdValid(show))
        {
            return;
    ...
    public static void showModifyEventIndexSUI(obj_id player, obj_id show)
    {
        if (!isIdValid(player) || !isIdValid(show))
        {
            return;
    ...
    public static void showModifyEventTimeSUI(obj_id player, obj_id show, int idx)
    {
    ...
    public static void setSUIScriptVars(obj_id show, int pid, obj_id player)
    {
        utils.setScriptVar(show, "firework.pid", pid);
        utils.setScriptVar(show, "firework.player", player);
    }
    public static void setSUIScriptVars(obj_id show, int pid, obj_id player, int idx)
    {
        utils.setScriptVar(show, "firework.pid", pid);
        utils.setScriptVar(show, "firework.player", player);
        utils.setScriptVar(show, "firework.idx", idx);
    }
    public static void removeSUIScriptVars(obj_id show)
    {
        utils.removeScriptVar(show, "firework.pid");
        utils.removeScriptVar(show, "firework.player");
        utils.removeScriptVar(show, "firework.idx");
    }
    public static void cleanupSUIScriptVars(obj_id show)
    {
    ...
    public static Vector getShowListEntries(obj_id show)
    {
        Vector show_fx = getResizeableStringArrayObjVar(show, VAR_SHOW_FX);
        Vector show_delay = getResizeableFloatArrayObjVar(show, VAR_SHOW_DELAY);
        if (show_fx == null || show_fx.size() == 0 || show_delay == null || show_delay.size() == 0)
    ...
    public static void swapEvents(obj_id player, obj_id show, int idx1, int idx2)
    {
        if (!isIdValid(player) || !isIdValid(show))
        {
            return;
    ...
    public static void setEventDelay(obj_id player, obj_id show, int idx, float delay)
    {
        if (!isIdValid(player) || !isIdValid(show))
        {
            return;
    ...
    public static void setEffect(obj_id firework, String fx, color pColor)
    {
    ...
    public static void makeRandomEffect(obj_id firework)
    {
    ...
    public static String getRandomFireworkEffect()
    {
    ...
    public static void dud(obj_id target)
    {
        sendSystemMessage(target, SID_DUD_FIREWORK);
        decrementFireworkCount(target);
    }
    public static void decrementFireworkCount(obj_id target)
    {
    ...
    public static void useCharge(obj_id firework)
    {
