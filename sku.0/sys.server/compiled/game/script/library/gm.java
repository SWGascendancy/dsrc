...
public class gm extends script.base_script
{
    ...
    public static String removeKeyword(String params, String keyword)
    {
    ...
    public static dictionary parseTarget(String params, obj_id target, String cmd)
    {
        obj_id self = getSelf();
    ...
    public static dictionary parseObjId(String params)
    {
        dictionary ret = new dictionary();
    ...
    public static void attachHandlerScript(obj_id player)
    {
    ...
    public static void decrementMessageCount(obj_id player)
    {
        if (!isIdValid(player) || !isPlayer(player) || !isGod(player))
        {
            return;
    ...
    public static void showSetHueVarUI(obj_id player, obj_id target, dictionary palColData)
    {
    ...
    public static void showSetHueColorUI(obj_id player, obj_id target, String varPath)
    {
    ...
    public static void cleanupSetHueScriptVars(obj_id player)
    {
    ...
    public static void showMoneyStatus(obj_id player, obj_id target)
    {
    ...
    public static boolean setBalance(obj_id player, int type, String sAmt)
    {
    ...
    public static void showFactionInformation(obj_id player, obj_id target)
    {
        if (!isIdValid(player) || !isIdValid(target))
        {
            return;
    ...
    public static void showSetPlayerStateUI(obj_id player)
    {
        obj_id self = getSelf();
    ...
    public static String[] getPlayerState(obj_id player)
    {
    ...
    public static void cmdResetJedi(obj_id player)
    {
        if (isIdNull(player))
        {
    ...
    public static String[] getRoadmapList()
    {
        String[] roadmapList = 
        {
            "smuggler_1a",
    ...
    public static String[] convertRoadmapNames(String[] list)
    {
    ...
    public static String[] convertSkillListNames(String[] skillList)
    {
    ...
    public static void createCustomUI(obj_id self, String uiTitle, String combinedString)
    {
    ...
    public static void createDumpTargetUI(obj_id self, String combinedString)
    {
    ...
    public static void forceClearQuest(obj_id player, String questName)
    {
    ...
    public static void forceGrantQuest(obj_id player, String questName)
    {
        if (!groundquests.isQuestActive(player, questName) && !groundquests.hasCompletedQuest(player, questName))
        {
            groundquests.requestGrantQuest(player, questName, true);
            sendSystemMessageTestingOnly(player, "Grant Quest function completed.");
        }
        else 
        {
            sendSystemMessageTestingOnly(player, "Either the player already has this quest or the quest string was incorrect. Space Quests cannot be granted using this command.");
        }
    }
    public static void forceRegrantQuest(obj_id player, String questName)
    {
        if (groundquests.isQuestActive(player, questName) || groundquests.hasCompletedQuest(player, questName))
        {
            groundquests.clearQuest(player, questName);
    ...
    public static String getSpaceQuestStringAndTitle(obj_id player, String questString)
    {
    ...
    public static boolean isInstanceAuthorized(obj_id subject)
    {
