...
public class player_version extends script.base_script
{
    ...
    public static boolean updateSkills(obj_id player)
    {
        return !(!isIdValid(player) || (!isPlayer(player)));
    }
    public static void zeroPlayerSkillData(obj_id player)
    {
        if (!isIdValid(player))
        {
            return;
    ...
    public static String[] orderSkillListForRevoke(String[] skillList)
    {
