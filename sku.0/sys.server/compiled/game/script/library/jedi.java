...
public class jedi extends script.base_script
{
    ...
    public static int getJediActionVisibilityValue(obj_id objPlayer, int intActionVisibility, int intActionRange)
    {
    ...
    public static void jediActionPerformed(obj_id objPlayer, int intActionVisibility, int intActionRadius)
    {
        return;
    }
    public static void setJediVisibilityTimeStamp(obj_id self)
    {
    ...
    public static void checkJediPenalties(obj_id objPlayer, int intVisiblity)
    {
    ...
    public static void doJediTEF(obj_id objPlayer)
    {
    ...
    public static void clearJediBounties(obj_id objPlayer)
    {
    ...
    public static boolean hasForcePower(obj_id objPlayer, int intForcePowerCost)
    {
    ...
    public static boolean drainForcePower(obj_id objPlayer, int intForcePowerCost)
    {
        return drainForcePower(objPlayer, intForcePowerCost, true);
    }
    public static boolean drainForcePower(obj_id objPlayer, int intForcePowerCost, boolean verbose)
    {
    ...
    public static void grantJediXP(obj_id objPlayer, int intForcePowerCost)
    {
    ...
    public static void doJediNonCombatAnimation(obj_id objPlayer, obj_id objTarget, dictionary dctJediInfo)
    {
        
    }
    public static boolean isJediTrainerForPlayer(obj_id objPlayer, obj_id objNPC)
    {
        if (!isJedi(objPlayer))
        {
            return false;
    ...
    public static boolean isLightsaber(obj_id objWeapon)
    {
        return isLightsaber(getWeaponType(objWeapon));
    }
    public static boolean isLightsaber(int intWeaponType)
    {
    ...
    public static int getJediAlignment(obj_id objJedi)
    {
        return getSkillStatisticModifier(objJedi, "private_jedi_alignment");
    }
    public static float getJediAlignmentModifier(obj_id objPlayer, dictionary dctJediInfo)
    {
        return 1.0f;
    }
    public static int modifyForcePower(obj_id objPlayer, int intForcePowerToDrain, dictionary dctJediInfo)
    {
    ...
    public static float getJediActionTime(obj_id player, dictionary actionData)
    {
    ...
    public static float getJediDamageModifier(obj_id player, dictionary actionData)
    {
    ...
    public static void recalculateForcePower(obj_id player)
    {
    ...
    public static boolean postponeGrantJedi()
    {
    ...
    public static boolean doNonCombatActionPrecheck(obj_id player, obj_id target, dictionary actionData)
    {
    ...
    public static obj_id getCorrectFriendlyTarget(obj_id player, obj_id target, dictionary actionData)
    {
        float range = actionData.getFloat("fltRange");
        if (range < 0)
        {
    ...
    public static void playJediActionEffect(obj_id objPlayer, obj_id objTarget, dictionary actionData)
    {
        playJediActionEffect(objPlayer, objTarget, actionData, false);
    }
    public static void playJediActionEffect(obj_id objPlayer, obj_id objTarget, dictionary actionData, boolean labelEffect)
    {
    ...
    public static boolean performJediBuffCommand(obj_id player, obj_id target, dictionary actionData)
    {
    ...
    public static boolean doBuffAction(obj_id self, obj_id target, String actionName)
    {
    ...
    public static boolean doForceRun(obj_id self, obj_id target, String actionName)
    {
        int armorCount = utils.getIntScriptVar(self, armor.SCRIPTVAR_ARMOR_COUNT);
        if (armorCount > 0)
        {
    ...
    public static boolean regainConsciousness(obj_id self, obj_id target, String actionName)
    {
        actionName = combat.getBestAction(self, actionName);
        dictionary actionData = dataTableGetRow(JEDI_ACTIONS_FILE, actionName);
        if (actionData == null)
    ...
    public static boolean transferForce(obj_id self, obj_id target, String actionName)
    {
        int armorCount = utils.getIntScriptVar(self, armor.SCRIPTVAR_ARMOR_COUNT);
        if (armorCount > 0)
        {
    ...
    public static boolean channelForce(obj_id self, obj_id target, String actionName)
    {
        int armorCount = utils.getIntScriptVar(self, armor.SCRIPTVAR_ARMOR_COUNT);
        if (armorCount > 0)
        {
    ...
    public static boolean forceMeditate(obj_id self, String actionName)
    {
        int armorCount = utils.getIntScriptVar(self, armor.SCRIPTVAR_ARMOR_COUNT);
        if (armorCount > 0)
        {
    ...
    public static void stopForceMeditate(obj_id self)
    {
        if (getState(self, STATE_MEDITATE) == 1)
        {
    ...
    public static void applyFeedbackDamage(obj_id player, obj_id target, float damage)
    {
    ...
    public static int applyForceShield(obj_id defender, int damage)
    {
    ...
    public static int applyForceArmor(obj_id defender, int damage)
    {
        int armorCount = utils.getIntScriptVar(defender, armor.SCRIPTVAR_ARMOR_COUNT);
        if (armorCount > 0)
        {
    ...
    public static void performJediReactiveDefense(obj_id attacker, obj_id defender, weapon_data weaponData, hit_result hitData, dictionary actionData)
    {
    ...
    public static boolean isAvoidIncap(obj_id player)
    {
    ...
    public static int getModifiedForceCost(obj_id self, int baseForce, String actionName)
    {
    ...
    public static int getModifiedMinDamage(obj_id self, int baseDamage, String actionName)
    {
        int row = dataTableSearchColumnForString(actionName, 0, JEDI_RANK_DATA);
        if (row != -1)
        {
    ...
    public static int getModifiedMaxDamage(obj_id self, int baseDamage, String actionName)
    {
        int row = dataTableSearchColumnForString(actionName, 0, JEDI_RANK_DATA);
        if (row != -1)
        {
    ...
    public static float getModifiedActionSpeed(obj_id self, float baseSpeed, String actionName)
    {
        int row = dataTableSearchColumnForString(actionName, 0, JEDI_RANK_DATA);
        if (row != -1)
        {
    ...
    public static float getModifiedExtraForceCost(obj_id self, float baseForce, String actionName)
    {
        int row = dataTableSearchColumnForString(actionName, 0, JEDI_RANK_DATA);
        if (row != -1)
        {
    ...
    public static int getModifiedBuffAmount(obj_id self, int baseAmount, int modNum, String actionName)
    {
        int row = dataTableSearchColumnForString(actionName, 0, JEDI_RANK_DATA);
        if (row != -1)
        {
    ...
    public static void jediSaberPearlRestore(obj_id player)
    {
    }
    public static int getMaxJediDeaths(obj_id objPlayer)
    {
    ...
    public static void jediDeathExperienceLoss(obj_id player)
    {
        jediDeathExperienceLoss(player, 1f);
    }
    public static void jediDeathExperienceLoss(obj_id player, float modifier)
    {
    ...
    public static float getSaberForceCost(obj_id saber)
    {
        float forceCost = 0;
    ...
    public static boolean isCrystalTuned(obj_id crystal)
    {
    ...
    public static boolean isCrystalOwner(obj_id player, obj_id crystal)
    {
    ...
    public static boolean doesCrystalMatchSaber(obj_id saber, obj_id crystal)
    {
        if (!isCrystalTuned(crystal))
        {
            return false;
    ...
    public static void resetSaberStats(obj_id saber)
    {
    ...
    public static void initSaberBaseStats(obj_id saber)
    {
    ...
    public static void setSaberColorCrystalDamage(obj_id saber)
    {
    ...
    public static void setSaberColor(obj_id saber, int color, int shader)
    {
    ...
    public static void addCrystalStats(obj_id saber, obj_id crystal)
    {
    ...
    public static void removeCrystalStats(obj_id saber, obj_id crystal)
    {
        obj_var_list ovl = getObjVarList(crystal, VAR_CRYSTAL_STATS);
        if (ovl != null)
        {
    ...
    public static boolean isColorCrystal(obj_id crystal)
    {
        return (hasObjVar(crystal, VAR_CRYSTAL_STATS + "." + VAR_COLOR));
    }
    public static boolean hasColorCrystal(obj_id saber)
    {
        return (hasObjVar(saber, VAR_SABER_BASE + "." + VAR_COLOR));
    }
    public static boolean validateCrystalCount(obj_id saber)
    {
        obj_id inv = getObjectInSlot(saber, "saber_inv");
        obj_id[] contents = getContents(inv);
        return (contents.length <= MAX_CRYSTAL_COUNT);
    }
    public static int getCrystalQuality(int level)
    {
        if (level < 40)
        {
            return CRYSTAL_POOR;
    ...
    public static int getStaticCrystalQuality(int level)
    {
        switch (level)
        {
            case 0:
    ...
    public static boolean forceCreateColorCrystal(obj_id player, int color)
    {
    ...
    public static boolean createColorCrystal(obj_id inventory, int color)
    {
        obj_id crystal = static_item.createNewItemFunction(mapOldColorToNewColor(color), inventory);
        return isIdValid(crystal);
    }
    public static boolean createPowerCrystal(obj_id inventory, int level)
    {
        obj_id crystal = static_item.createNewItemFunction(mapOldPowerCrystalLevelToNew(level), inventory);
        return isIdValid(crystal);
    }
    public static void setAsColorCrystal(obj_id crystal, int color, int hp, int hpMax)
    {
    ...
    public static void setAsColorCrystal(obj_id crystal, int color)
    {
        if (isIdValid(crystal))
        {
    ...
    public static void setAsPowerCrystal(obj_id crystal, int level, int hp, int hpMax)
    {
        if (isIdValid(crystal))
        {
    ...
    public static void setAsPowerCrystal(obj_id crystal, int level)
    {
        if (isIdValid(crystal))
        {
            custom_var myVar = getCustomVarByName(crystal, "private/index_color_1");
    ...
    public static boolean checkRobePermission(obj_id player)
    {
    ...
    public static void setupJediTrainer(obj_id self)
    {
    ...
    public static void clickyCombatPearlFix(obj_id item)
    {
        float damage = 0.0f;
    ...
    public static void jediComponentStatSetter(obj_id owner, obj_id item, String itemName)
    {
    ...
    public static String mapOldColorToNewColor(obj_id item)
    {
        return mapOldColorToNewColor(getIntObjVar(item, VAR_CRYSTAL_STATS + "." + VAR_COLOR));
    }
    public static String mapOldColorToNewColor(int color)
    {
        String colorMap[] = 
        {
            ...
            "item_crystal_allyas_exile_01",
            "item_crystal_allyas_redemption_01"
        };
        return colorMap[color];
    }
    public static String mapOldPowerCrystalLevelToNew(int level)
    {
        if (level < 40)
        {
    ...
    public static void initializeCrystal(obj_id crystal, int level)
    {
