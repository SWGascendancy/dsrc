...
public class armor extends script.base_script
{
    ...
    public static void clearCachedData(obj_id armor)
    {
        if (isIdValid(armor))
        {
    ...
    public static boolean isArmorComponent(obj_id target)
    {
    ...
    public static boolean isArmorLayer(obj_id target)
    {
        return isGameObjectTypeOf(getGameObjectType(target), GOT_armor_layer);
    }
    public static boolean isFinalArmor(obj_id target)
    {
        return isFinalArmor(getGameObjectType(target));
    }
    public static boolean isFinalArmor(int armorGOT)
    {
    ...
    public static boolean isPsg(obj_id target)
    {
        return isPsg(getGameObjectType(target));
    }
    public static boolean isPsg(int armorGOT)
    {
        return armorGOT == GOT_armor_psg;
    }
    public static int getArmorDatatableRow(obj_id armor)
    {
    ...
    public static String getArmorBaseObjvar(obj_id armor)
    {
        return getArmorBaseObjvar(getGameObjectType(armor));
    }
    public static String getArmorBaseObjvar(int armorGOT)
    {
    ...
    public static float getAbsoluteArmorAttribute(float value, int row, String column)
    {
    ...
    public static dictionary getAbsoluteArmorSpecialProtection(obj_id armor, String layerName, float value, int row)
    {
    ...
    public static float[] getArmorPenalties(int armorLevel, int armorCategory)
    {
    ...
    public static float[] getScaledArmorPenalties(obj_id armor, float generalProtection, int armorRow, int armorLevel, int armorCategory)
    {
        float[] penalties;
        if (isIdValid(armor))
        {
    ...
    public static float[] reduceCertifiedArmorPenalties(obj_id player, int armorCategory, float[] penalties)
    {
    ...
    public static void calculateArmorHinderances(obj_id player)
    {
        float movePenalty = 0;
    ...
    public static void calculateWornArmor(obj_id player)
    {
        obj_id[] wornItems = metrics.getWornItems(player);
        int armorCount = 0;
        if (wornItems != null)
    ...
    public static float[] getFinalArmorPenalties(obj_id player, obj_id armorPiece)
    {
    ...
    public static boolean isArmorCertified(obj_id player, obj_id armorPiece)
    {
    ...
    public static float convertArmorData(float value, int fromRow, int toRow, String column)
    {
        int columnIndex = dataTableFindColumnNumber(DATATABLE_ARMOR, column);
        if (columnIndex == -1)
        {
    ...
    public static void rescaleComponentData(obj_id schematic, obj_var_list componentData, int fromRow, int toRow)
    {
    ...
    public static float rescaleArmorData(String attrib, int fromRow, int toRow, float value)
    {
    ...
    public static void updateItemAttributes(obj_id schematic, draft_schematic.attribute[] itemAttributes, int armorRow)
    {
        float resourceScale;
        float value;
    ...
    public static void saveScaledDataToPrototype(obj_id schematic, obj_id prototype, draft_schematic.attribute[] itemAttributes, String objvarBase)
    {
    ...
    public static boolean isValidArmor(obj_id target)
    {
        if (!isValidId(target))
        {
            return false;
    ...
    public static int getArmorLevel(obj_id armor)
    {
    ...
    public static int getArmorCategory(obj_id armor)
    {
    ...
    public static int getCombatArmorGeneralProtection(obj_id objTarget)
    {
        return utils.getIntScriptVar(objTarget, SCRIPTVAR_CACHED_GENERAL_PROTECTION);
    }
    public static int getArmorGeneralProtection(obj_id armor)
    {
    ...
    public static dictionary getCombatArmorSpecialProtections(obj_id objTarget)
    {
        return utils.getDictionaryScriptVar(objTarget, SCRIPTVAR_CACHED_SPECIAL_PROTECTIONS);
    }
    public static dictionary getArmorSpecialProtections(obj_id armor)
    {
        return _getArmorSpecialProtections(armor, getArmorDatatableRow(armor));
    }
    public static dictionary getPsgSpecialProtections(obj_id armor)
    {
        return _getPsgSpecialProtections(armor, getArmorDatatableRow(armor));
    }
    public static float getPsgEfficiency(obj_id psg)
    {
        if (isPsg(psg))
        {
    ...
    public static void setPsgEfficiency(obj_id psg, float efficiency)
    {
        if (isPsg(psg))
        {
            if (efficiency > 1.0f)
    ...
    public static boolean initializeArmor(obj_id target, int armorLevel, int armorCategory)
    {
        if (!isValidId(target))
        {
    ...
    public static boolean initializePsg(obj_id target, float rechargeRate, int protection, int condition)
    {
        if (!isPsg(target))
        {
            return false;
    ...
    public static int getTemplateRowFromMasterTable(String template)
    {
    ...
    public static int getArmorCategoryByTemplate(String template)
    {
    ...
    public static boolean setArmorDataPercent(obj_id target, int armorLevel, int armorCategory, float generalProtection, float condition) {
        return initializeArmor(target, armorLevel, armorCategory) && _setArmorDataPercent(target, generalProtection, condition, false);
    }
    public static boolean setArmorDataPercent(obj_id target, float generalProtection, float condition)
    {
        return _setArmorDataPercent(target, generalProtection, condition, true);
    }
    public static boolean setAbsoluteArmorData(obj_id target, int armorLevel, int armorCategory, int generalProtection, int condition) {
        return initializeArmor(target, armorLevel, armorCategory) && setAbsoluteArmorData(target, generalProtection, condition);
    }
    public static boolean setAbsoluteArmorData(obj_id target, int generalProtection, int condition)
    {
        clearCachedData(target);
    ...
    public static void removeAllArmorData(obj_id target)
    {
    ...
    public static boolean setAbsoluteArmorSpecialProtection(obj_id target, int specialLayer, int protection)
    {
        if (!isValidArmor(target))
        {
    ...
    public static boolean setArmorSpecialProtectionPercent(obj_id target, int specialLayer, float protection)
    {
        if (!isValidArmor(target))
        {
    ...
    public static boolean removeArmorSpecialProtection(obj_id target, int specialLayer)
    {
        if (!isValidArmor(target))
        {
    ...
    public static int _getArmorGeneralProtection(obj_id armor, int row)
    {
        if (!isValidArmor(armor))
        {
    ...
    public static dictionary _getArmorSpecialProtections(obj_id armor, int row)
    {
        if (!isValidArmor(armor))
        {
    ...
    public static dictionary _getPsgSpecialProtections(obj_id armor, int row)
    {
    ...
    public static boolean _setArmorDataPercent(obj_id target, float generalProtection, float condition, boolean testForValidArmor)
    {
        int armorLevelRow = getArmorDatatableRow(target);
        if (armorLevelRow < 0)
        {
    ...
    public static boolean _setArmorDataPercent(obj_id target, float generalProtection, float condition, int armorLevelRow, boolean testForValidArmor)
    {
    ...
    public static void recalculateArmorForPlayer(obj_id objPlayer)
    {
    ...
    public static void recalculatePseudoArmorForPlayer(obj_id objPlayer, obj_id item, boolean applyArmor)
    {
    ...
    public static String getPseudoArmorLevel(int pseudoLevel)
    {
        if (pseudoLevel < 2000)
        {
            return POWER_1;
    ...
    public static boolean hasExpertiseArmorSetBonus(obj_id wearer)
    {
        if (!isPlayer(wearer))
        {
            return false;
    ...
    public static int getExpertiseArmorSetId(obj_id wearer)
    {
        if (utils.hasScriptVar(wearer, "armor.armor_set_worn"))
        {
    ...
    public static boolean turnArmorIntoSchem(obj_id player, obj_id armor)
    {
