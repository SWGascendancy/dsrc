...
public class doctor_bag extends script.base_script
{
    ...
    public static boolean isDoctorBag(obj_id object)
    {
        return hasObjVar(object, "doctor_bag");
    }
    public static boolean hasDoctorBag(obj_id player)
    {
        return (null != getDoctorBag(player));
    }
    public static obj_id getDoctorBag(obj_id player)
    {
    ...
    public static boolean addMedicine(obj_id player, obj_id bag, obj_id medicine)
    {
    ...
    public static boolean removeMedicine(obj_id player, obj_id bag, int med)
    {
    ...
    public static boolean setSurrogateState(obj_id bag, String prefix)
    {
    ...
    public static boolean clearSurrogateState(obj_id bag)
    {
    ...
    public static void decrementSurrogateCharge(obj_id bag)
    {
