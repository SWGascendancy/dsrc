...
public class weapons extends script.base_script
{
    ...
    public static int _GetTableValue(String col, String searchArg, int VIA_what)
    {
    ...
    public static int getMinDamageLow(dictionary dic)
    {
    ...
    public static int getMinDamageLow(String weaponName, int VIA_what)
    {
        return _GetTableValue(COL_MIN_DMG_LOW, weaponName, VIA_what);
    }
    public static int getMinDamageHigh(dictionary dic)
    {
    ...
    public static int getMinDamageHighCap(dictionary dic)
    {
    ...
    public static int getMinDamageLowCap(dictionary dic)
    {
    ...
    public static int getMinDamageHigh(String name, int VIA_what)
    {
        return _GetTableValue(COL_MIN_DMG_HIGH, name, VIA_what);
    }
    public static int getMinDamageHighCap(String name, int VIA_what)
    {
        return _GetTableValue(COL_MIN_DMG_HIGH_CAP, name, VIA_what);
    }
    public static int getMaxDamageLow(dictionary dic)
    {
    ...
    public static int getMaxDamageLow(String name, int VIA_what)
    {
        return _GetTableValue(COL_MAX_DMG_LOW, name, VIA_what);
    }
    public static int getMaxDamageHigh(dictionary dic)
    {
    ...
    public static int getMaxDamageHighCap(dictionary dic)
    {
    ...
    public static int getMaxDamageLowCap(dictionary dic)
    {
    ...
    public static int getMaxDamageHigh(String name, int VIA_what)
    {
        return _GetTableValue(COL_MAX_DMG_HIGH, name, VIA_what);
    }
    public static int getMaxDamageHighCap(String name, int VIA_what)
    {
        return _GetTableValue(COL_MAX_DMG_HIGH_CAP, name, VIA_what);
    }
    public static int getSpeedLow(dictionary dic)
    {
    ...
    public static int getSpeedLow(String name, int VIA_what)
    {
        return _GetTableValue(COL_SPEED_LOW, name, VIA_what);
    }
    public static int getSpeedHigh(dictionary dic)
    {
    ...
    public static int getSpeedHigh(String name, int VIA_what)
    {
        return _GetTableValue(COL_SPEED_HIGH, name, VIA_what);
    }
    public static int getWoundChanceLow(dictionary dic)
    {
    ...
    public static int getWoundChanceLow(String name, int VIA_what)
    {
        return _GetTableValue(COL_WOUND_CHANCE_LOW, name, VIA_what);
    }
    public static int getWoundChanceHigh(dictionary dic)
    {
    ...
    public static int getWoundChanceHigh(String name, int VIA_what)
    {
        return _GetTableValue(COL_WOUND_CHANCE_HIGH, name, VIA_what);
    }
    public static int getHPLow(dictionary dic)
    {
    ...
    public static int getHPLow(String name, int VIA_what)
    {
        return _GetTableValue(COL_HP_LOW, name, VIA_what);
    }
    public static int getHPHigh(dictionary dic)
    {
    ...
    public static int getHPHigh(String name, int VIA_what)
    {
        return _GetTableValue(COL_HP_HIGH, name, VIA_what);
    }
    public static int getAccuracyLow(dictionary dic)
    {
    ...
    public static int getAccuracyLow(String name, int VIA_what)
    {
        return _GetTableValue(COL_ACCURACY_LOW, name, VIA_what);
    }
    public static int getAccuracyHigh(dictionary dic)
    {
    ...
    public static int getAccuracyHigh(String name, int VIA_what)
    {
        return _GetTableValue(COL_ACCURACY_HIGH, name, VIA_what);
    }
    public static int getMinRangeDistance(dictionary dic)
    {
    ...
    public static int getMinRangeDistance(String name, int VIA_what)
    {
        return _GetTableValue(COL_MIN_RANGE_DISTANCE, name, VIA_what);
    }
    public static int getMaxRangeDistance(dictionary dic)
    {
    ...
    public static int getMaxRangeDistance(String name, int VIA_what)
    {
        return _GetTableValue(COL_MAX_RANGE_DISTANCE, name, VIA_what);
    }
    public static int getAttackCostLow(dictionary dic)
    {
    ...
    public static int getAttackCostLow(String name, int VIA_what)
    {
        return _GetTableValue(COL_ATTACK_COST_LOW, name, VIA_what);
    }
    public static int getAttackCostHigh(dictionary dic)
    {
    ...
    public static int getAttackCostHigh(String name, int VIA_what)
    {
        return _GetTableValue(COL_ATTACK_COST_HIGH, name, VIA_what);
    }
    public static int getDamageType(dictionary dic)
    {
    ...
    public static int getDamageType(String name, int VIA_what)
    {
        return _GetTableValue(COL_DAMAGE_TYPE, name, VIA_what);
    }
    public static int getElementalType(dictionary dic)
    {
    ...
    public static int getElementalType(String name, int VIA_what)
    {
        return _GetTableValue(COL_ELEMENTAL_TYPE, name, VIA_what);
    }
    public static int getElementalValueLow(dictionary dic)
    {
    ...
    public static int getElementalValueLow(String name, int VIA_what)
    {
        return _GetTableValue(COL_ELEMENTAL_VALUE_LOW, name, VIA_what);
    }
    public static int getElementalValueHigh(dictionary dic)
    {
    ...
    public static int getElementalValueHigh(String name, int VIA_what)
    {
        return _GetTableValue(COL_ELEMENTAL_VALUE_HIGH, name, VIA_what);
    }
    public static obj_id _createFromDictionary(dictionary dat, obj_id container, float speed, float damage, float effeciency, float elementalVal)
    {
        return _createFromDictionary(dat, container, speed, damage, effeciency, elementalVal, false);
    }
    public static obj_id _createFromDictionary(dictionary dat, obj_id container, float speed, float damage, float effeciency, float elementalVal, boolean overloadInv)
    {
        obj_id obj;
    ...
    public static obj_id _createFromDictionary(dictionary dat, obj_id container, float percentOfMax)
    {
        return _createFromDictionary(dat, container, percentOfMax, percentOfMax, percentOfMax, percentOfMax);
    }
    public static void setWeaponAttributes(obj_id weapon, dictionary dat, float speedPercent, float damagePercent, float effeciencyPercent, float elementalValPercent)
    {
    ...
    public static void setWeaponAttributes(obj_id weapon, dictionary dat, float percentOfMax)
    {
        setWeaponAttributes(weapon, dat, percentOfMax, percentOfMax, percentOfMax, percentOfMax);
    }
    public static dictionary getWeaponDat(String weapon)
    {
    ...
    public static dictionary getWeaponDat(obj_id weapon)
    {
        String template = getTemplateName(weapon);
        return getWeaponDat(template);
    }
    public static dictionary getWeaponCoreData(int coreLevel)
    {
    ...
    public static obj_id createPossibleWeapon(String name, obj_id container, float percentOfMax)
    {
        return createPossibleWeapon(name, container, percentOfMax, percentOfMax, percentOfMax, percentOfMax);
    }
    public static obj_id createPossibleWeapon(String name, obj_id container, float speed, float damage, float effeciency, float elementalVal)
    {
        obj_id thing = null;
    ...
    public static obj_id createWeapon(String name, obj_id container, float percentOfMax)
    {
        return createWeapon(name, container, VIA_TEMPLATE, percentOfMax);
    }
    public static obj_id createWeapon(String name, obj_id container, float speed, float damage, float effeciency, float elementalVal)
    {
        return createWeapon(name, container, VIA_TEMPLATE, speed, damage, effeciency, elementalVal);
    }
    public static obj_id createWeapon(String name, obj_id container, int VIA_what, float speed, float damage, float effeciency, float elementalVal)
    {
        return createWeapon(name, container, VIA_what, speed, damage, effeciency, elementalVal, false);
    }
    public static obj_id createWeaponOverloaded(String name, obj_id container, float speed, float damage, float effeciency, float elementalVal)
    {
        return createWeapon(name, container, VIA_TEMPLATE, speed, damage, effeciency, elementalVal, true);
    }
    public static obj_id createWeapon(String name, obj_id container, int VIA_what, float speed, float damage, float effeciency, float elementalVal, boolean overloadInv)
    {
    ...
    public static obj_id createWeapon(String name, obj_id container, int VIA_what, float percentOfMax)
    {
        return createWeapon(name, container, VIA_what, percentOfMax, percentOfMax, percentOfMax, percentOfMax);
    }
    public static Vector getWeaponIdsForType(String fragment)
    {
    ...
    public static int createOneOfEach(String nameFragment, obj_id container, int VIA_what, float percentOfMax)
    {
        String col = COL_SCHEMATIC_NAME;
        if (VIA_what == VIA_TEMPLATE)
        {
    ...
    public static void grantOrDenyAllWeaponSchematics(String nameFragment, obj_id player, int VIA_what, boolean grant)
    {
        String col = COL_SCHEMATIC_NAME;
        if (VIA_what == VIA_TEMPLATE)
        {
    ...
    public static obj_id createLimitedUseSchematic(String name, int numUses, obj_id container, String schematicNameKey)
    {
        return createLimitedUseSchematic(name, VIA_TEMPLATE, numUses, container, schematicNameKey);
    }
    public static obj_id createLimitedUseSchematic(String name, int VIA_what, int numUses, obj_id container, String schematicNameKey)
    {
        return createLimitedUseSchematic(name, VIA_what, numUses, container, schematicNameKey, "class_munitions_phase4_master");
    }
    public static obj_id createLimitedUseSchematic(String name, int VIA_what, int numUses, obj_id container, String schematicNameKey, String skillRequired)
    {
    ...
    public static float setHeavyWeaponAoeSplashPercent(obj_id weapon)
    {
    ...
    public static void clickCombatWeaponConversion(obj_id weapon)
    {
    ...
    public static boolean coredWeaponConversion(obj_id weapon)
    {
    ...
    public static void staticDynamicWeaponConversion(obj_id weapon)
    {
        int level = 1;
    ...
    public static void validateWeaponData(obj_id weapon, dictionary weaponDat)
    {
    ...
    public static void validateLightsaberData(obj_id saber, dictionary weaponDat)
    {
    ...
    public static void validateWeaponRange(obj_id weapon)
    {
    ...
    public static void validateWeaponRange(obj_id weapon, dictionary weaponDat)
    {
        if (weaponDat == null)
        {
            return;
    ...
    public static void validateWeaponFacoryCrateRange(obj_id crate, dictionary weaponDat)
    {
    ...
    public static boolean isVersionCurrent(obj_id object)
    {
        int currentVersion = getConversionId(object);
        int masterVersion = CONVERSION_VERSION;
        return currentVersion == masterVersion;
    }
    public static void validateWeaponFactoryCrateFromSchematic(obj_id crate)
    {
    ...
    public static void initalizeWeaponFactoryCrateManufacturingSchematics(obj_id self)
    {
    ...
    public static weapon_data getNewWeaponData(obj_id objWeapon)
    {
    ...
    public static weapon_data fillWeaponData(obj_id weapon, combat_data dat)
    {
    ...
    public static weapon_data fillWeaponData(obj_id objWeapon, dictionary dctWeaponStats)
    {
        weapon_data weaponData = new weapon_data();
    ...
    public static void setWeaponData(obj_id objWeapon)
    {
    ...
    public static void setWeaponData(obj_id objWeapon, int intMinDamage, int intMaxDamage, float fltMaxRange, int intWeaponType, int intDamageType, int intElementalType, int intElementalValue, float fltAttackSpeed, float fltDamageRadius)
    {
        dictionary dctWeaponStats = new dictionary();
        dctWeaponStats.put("id", objWeapon);
    ...
    public static void validateWeaponDamageType(obj_id weapon)
    {
        if (hasObjVar(weapon, OBJVAR_NEW_WP))
        {
    ...
    public static void validateWeaponDamageType(obj_id weapon, dictionary weaponDat)
    {
        if (weaponDat == null)
        {
            return;
    ...
    public static int getCoreLevel(obj_id prototype)
    {
    ...
    public static float getWeaponCoreQualityMin(obj_id prototype)
    {
        return getFloatObjVar(prototype, OBJVAR_WP_CORE_QUALITY_MIN);
    }
    public static float getWeaponCoreQualityMax(obj_id prototype)
    {
        return getFloatObjVar(prototype, OBJVAR_WP_CORE_QUALITY_MAX);
    }
    public static float getNewWeaponElementalType(obj_id prototype)
    {
    ...
    public static float getNewWeaponElementalValue(obj_id prototype)
    {
        return getFloatObjVar(prototype, OBJVAR_ELEMENTAL_VALUE);
    }
    public static float getWeaponGasQualityMin(obj_id prototype)
    {
        return getFloatObjVar(prototype, OBJVAR_MODIFIER_GAS_QUALITY_MIN);
    }
    public static float getWeaponGasQualityMax(obj_id prototype)
    {
        return getFloatObjVar(prototype, OBJVAR_MODIFIER_GAS_QUALITY_MAX);
    }
    public static int getElementalAppearanceBonus(obj_id prototype)
    {
    ...
    public static int getCoreMinDamage(obj_id prototype, dictionary weaponDat)
    {
        if (!isIdValid(prototype) || !exists(prototype))
        {
            return -1;
    ...
    public static int getCoreMaxDamage(obj_id prototype, dictionary weaponDat)
    {
        if (!isIdValid(prototype) || !exists(prototype))
        {
            return -1;
    ...
    public static int getWeaponSpeed(obj_id prototype)
    {
        if (!isIdValid(prototype) || !exists(prototype))
        {
            return 1;
    ...
    public static int getNewWeaponWoundChance(obj_id prototype)
    {
        if (!isIdValid(prototype) || !exists(prototype))
        {
            return 0;
    ...
    public static int getNewWeaponAttackCost(obj_id prototype)
    {
        if (!isIdValid(prototype) || !exists(prototype))
        {
            return 0;
    ...
    public static int getNewWeaponAccuracy(obj_id prototype)
    {
        if (!isIdValid(prototype) || !exists(prototype))
        {
            return 0;
    ...
    public static int getNewWeaponTableElementType(obj_id prototype)
    {
        if (!isIdValid(prototype) || !exists(prototype))
        {
            return -1;
    ...
    public static int getNewWeaponTableElementalValue(obj_id prototype, dictionary weaponDat)
    {
        if (!isIdValid(prototype) || !exists(prototype))
        {
            return -1;
    ...
    public static int getNewWeaponDamageType(obj_id prototype)
    {
        if (!isIdValid(prototype) || !exists(prototype))
        {
            return -1;
    ...
    public static int getNewWeaponMaxRange(obj_id prototype)
    {
        if (!isIdValid(prototype) || !exists(prototype))
        {
            return -1;
    ...
    public static int getNewWeaponMinRange(obj_id prototype)
    {
        if (!isIdValid(prototype) || !exists(prototype))
        {
            return -1;
    ...
    public static boolean performSocketing(obj_id prototype, String[] expMods)
    {
        if (!isIdValid(prototype) || !exists(prototype))
        {
            return false;
    ...
    public static String getDamageTypeString(int type)
    {
        int next = 0;
    ...
    public static boolean storeWeaponCraftingValues(obj_id prototype, obj_id schematicId, draft_schematic schematic)
    {
    ...
    public static boolean setComponentObjVars(obj_id prototype, draft_schematic.attribute[] itemAttributes)
    {
        if (!isIdValid(prototype) || !exists(prototype))
        {
            return false;
    ...
    public static boolean isCoredWeapon(obj_id weapon) {
        return !(!isIdValid(weapon) || !exists(weapon)) && hasObjVar(weapon, OBJVAR_NEW_WP_WEAPON);
    }
    public static float getWeaponComponentBonusesMinDamage(obj_id weapon)
    {
    ...
    public static float getWeaponComponentBonusesMaxDamage(obj_id weapon)
    {
        if (!isIdValid(weapon) || !exists(weapon))
        {
            return 0.0f;
    ...
    public static boolean isRangedCore(obj_id core)
    {
    ...
    public static boolean isHeavyCore(obj_id core)
    {
        if (!isIdValid(core) || !exists(core))
        {
            return false;
    ...
    public static boolean isMeleeCore(obj_id core)
    {
        if (!isIdValid(core) || !exists(core))
        {
            return false;
    ...
    public static float verifyDamageRangeMin(obj_id weapon, float currentDamage, dictionary coreData)
    {
        if (!isIdValid(weapon) || !exists(weapon))
        {
            return 0.0f;
    ...
    public static float verifyDamageRangeMax(obj_id weapon, float currentDamage, dictionary coreData)
    {
        if (!isIdValid(weapon) || !exists(weapon))
        {
            return 0.0f;
    ...
    public static boolean isProfWheelSchemWeapon(obj_id weapon)
    {
        if (!isIdValid(weapon) || !exists(weapon))
        {
    ...
    public static boolean turnWeaponIntoSchem(obj_id player, obj_id weapon)
    {
        if (!isIdValid(weapon) || !exists(weapon))
        {
            return false;
    ...
    public static boolean validateDamage(obj_id player, obj_id item)
    {
    ...
    public static boolean setSchematicVariablesFromSchematic(obj_id schematic, obj_id prototype)
    {
    ...
    public static boolean setSchematicVariablesFromProtoType(obj_id schematic, obj_id prototype)
    {
        boolean objvarsCopied = false;
    ...
    public static boolean checkForIllegalStorytellerWeapon(obj_id player, obj_id weapon)
    {
    ...
    public static void handleIllegalStorytellerWeapon(obj_id player, obj_id weapon, String source)
    {
        if (isIdValid(player) && isIdValid(weapon))
        {
    ...
    public static String logWeaponStats(obj_id weapon)
    {
