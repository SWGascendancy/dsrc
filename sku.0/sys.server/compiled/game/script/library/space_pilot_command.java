...
public class space_pilot_command extends script.base_script
{
    ...
    public static int targetTierDetect(obj_id target)
    {
    ...
    public static boolean readyForEnergyPulse(obj_id ship, obj_id commander)
    {
    ...
    public static boolean executeEnergyPulse(obj_id commander, obj_id ship, String cmdLevel)
    {
    ...
    public static int randomComponentSelector(obj_id targetShip)
    {
    ...
    public static void doRandomSubSystemDamage(obj_id shipDamaged, int numComponentsDamaged, float damageAmount)
    {
    ...
    public static void doRandomSubSystemStun(obj_id shipDamaged, int numComponentsStunned)
    {
    ...
    public static void doSubSystemStun(obj_id targetShip, int component, int duration)
    {
    ...
    public static void doNormalDamage(obj_id objAttacker, obj_id shipDamaged, float damageAmount)
    {
    ...
    public static boolean readyForVampiricRepairOther(obj_id ship, obj_id commander, obj_id target)
    {
    ...
    public static float sumShipComponentHitpointsCurrent(obj_id shipId)
    {
        return sumShipComponentHitpointsCurrent(shipId, 100.0f);
    }
    public static float sumShipComponentHitpointsCurrent(obj_id shipId, float percentage)
    {
    ...
    public static float sumShipComponentHitpointsMaximum(obj_id shipId)
    {
        float hitpointsSum = 0.0f;
        int[] installedSlots = space_crafting.getShipInstalledSlots(shipId);
        for (int i = 0; i < installedSlots.length; i++)
    ...
    public static float calcShipPercentDamaged(obj_id shipId)
    {
    ...
    public static float calcShipComponentPercentDamaged(obj_id shipId, int chassisSlot)
    {
    ...
    public static int findMostDamagedShipComponent(obj_id shipId)
    {
    ...
    public static float damageAllShipComponents(obj_id shipId, float percentToDamage)
    {
        float totalDamage = 0;
        int[] installedSlots = space_crafting.getShipInstalledSlots(shipId);
        for (int i = 0; i < installedSlots.length; i++)
    ...
    public static void vampiricOtherTypeShipsSystemsRepair(obj_id donorPilot, obj_id donorShip, obj_id recipientShip, int successLevel)
    {
    ...
    public static String randomWeldingCEFPicker()
    {
    ...
    public static boolean readyForNebulaBlast(obj_id ship, obj_id commander)
    {
    ...
    public static void doNebulaBlast(obj_id commander, obj_id firingShip)
    {
    ...
    public static void nblastDamageTarget(obj_id firingShip, obj_id victim, float blastNominalYield, float distanceToBlast)
    {
    ...
    public static boolean readyForJumpStart(obj_id ship, obj_id commander, obj_id target, String commandLevel)
    {
    ...
    public static boolean executeJstart(obj_id commander, obj_id ship, obj_id target, String cmdLevel)
    {
    ...
    public static boolean prepInSpaceRepair(obj_id commander, obj_id ship, String command_type)
    {
    ...
    public static void confirmRepairs(obj_id commander, obj_id ship, String command_type)
    {
    ...
    public static boolean shipissafe(obj_id ship, obj_id pilot)
    {
    ...
    public static obj_id getClosestStation(obj_id commander, obj_id ship)
    {
    ...
    public static boolean spawnrepairship(obj_id pilot, obj_id ship, String command_type, obj_id closestStation)
    {
    ...
    public static boolean inSpaceRepairComponentsEstimate(obj_id ship, obj_id commander, obj_id closestStation)
    {
    ...
    public static boolean inSpaceReloadLaunchersEstimate(obj_id ship, obj_id commander, obj_id closestStation)
    {
    ...
    public static boolean inSpaceRepairReloadComponentsEstimate(obj_id ship, obj_id commander, obj_id closestStation)
    {
    ...
    public static int getStationReloadCost(obj_id ship, obj_id commander, obj_id closestStation)
    {
    ...
    public static void doRepair(obj_id commander, obj_id ship, obj_id repairShip, obj_id closestStation)
    {
    ...
    public static void doReload(obj_id commander, obj_id ship, obj_id repairShip, obj_id closestStation)
    {
    ...
    public static void doRepairAndReload(obj_id commander, obj_id ship, obj_id repairShip, obj_id closestStation)
    {
        debugServerConsoleMsg(null, "SPACE_PILOT_COMMAND.doReload  ---- Just Entered");
        ship_ai.unitDock(repairShip, ship, 30.0f);
        dictionary outparams = new dictionary();
    ...
    public static void doStationToShipReload(obj_id commander, obj_id closestStation)
    {
    ...
    public static boolean weaponLauncherSpaceReload(obj_id ship, obj_id commander, int currentSlot)
    {
    ...
    public static boolean countermeasureLauncherSpaceReload(obj_id ship, obj_id commander, int currentSlot)
    {
    ...
    public static void repairEvac(obj_id repairship)
    {
    ...
    public static void repairCompleteDepart(obj_id repairship)
    {
    ...
    public static void allPurposeShipComponentReset(obj_id ship)
    {
        if (isIdValid(ship))
        {
            int[] slots = space_crafting.getShipInstalledSlots(ship);
    ...
    public static int getDroidProgramSize(String programName, obj_id programObject)
    {
    ...
    public static int getCurrentlyUsedProgramMemory(obj_id[] programs)
    {
    ...
    public static boolean hasDuplicateProgram(obj_id[] programs, String newProgramName)
    {
        int currentlyUsedProgramMemory = 0;
        for (int i = 0; i < programs.length; i++)
        {
    ...
    public static void updateControlDevice(obj_id programObject, obj_id dataPad)
    {
    ...
    public static boolean isStation(obj_id station)
    {
