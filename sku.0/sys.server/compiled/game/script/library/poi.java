...
public class poi extends script.base_script
{
    ...
    public static obj_id createObject(obj_id poiObject, String template, float x, float z)
    {
        return createObject(poiObject, template, x, z, -1);
    }
    public static obj_id createObject(obj_id poiObject, String template, float x, float z, int level)
    {
    ...
    public static obj_id createObject(String template, float x, float z)
    {
        return createObject(template, x, z, -1);
    }
    public static obj_id createObject(String template, float x, float z, int level)
    {
        return createObject(getSelf(), template, x, z, level);
    }
    public static obj_id createObject(obj_id poiObject, String name, String template, float x, float y)
    {
        return createObject(poiObject, name, template, x, y, -1);
    }
    public static obj_id createObject(obj_id poiObject, String name, String template, float x, float y, int level)
    {
        obj_id element = createObject(poiObject, template, x, y, level);
        addToStringList(element, name);
        return element;
    }
    public static obj_id createObject(String name, String template, float x, float y)
    {
        return createObject(name, template, x, y, -1);
    }
    public static obj_id createObject(String name, String template, float x, float y, int level)
    {
        return createObject(getSelf(), name, template, x, y, level);
    }
    public static obj_id createObject(obj_id poiObject, String strName, location locCenter)
    {
        return createObject(poiObject, strName, locCenter, -1);
    }
    public static obj_id createObject(obj_id poiObject, String strName, location locCenter, int level)
    {
    ...
    public static obj_id createNpc(obj_id poiObject, String type, float x, float z)
    {
        return createNpc(poiObject, type, x, z, -1);
    }
    public static obj_id createNpc(obj_id poiObject, String type, float x, float z, int level)
    {
        obj_id poiBaseObject = getBaseObject(poiObject);
        if (poiBaseObject == null || poiBaseObject == obj_id.NULL_ID)
        {
    ...
    public static obj_id createNpc(String type, float x, float z)
    {
        return createNpc(type, x, z, -1);
    }
    public static obj_id createNpc(String type, float x, float z, int level)
    {
        return createNpc(getSelf(), type, x, z, level);
    }
    public static obj_id createNpc(obj_id poiObject, String ident, String type, float x, float z)
    {
        return createNpc(poiObject, ident, type, x, z, -1);
    }
    public static obj_id createNpc(obj_id poiObject, String ident, String type, float x, float z, int level)
    {
        obj_id poiNpc = createNpc(poiObject, type, x, z, level);
        addToStringList(poiNpc, ident);
        return poiNpc;
    }
    public static obj_id createNpc(obj_id poiObject, String ident, String type, location loc)
    {
        return createNpc(poiObject, ident, type, loc, -1);
    }
    public static obj_id createNpc(obj_id poiObject, String ident, String type, location loc, int level)
    {
        obj_id poiBaseObject = getBaseObject(poiObject);
        if (poiBaseObject == null || poiBaseObject == obj_id.NULL_ID)
        {
    ...
    public static obj_id createNpcInStructure(obj_id poiObject, String ident, String type, obj_id structureId, String cellName)
    {
        return createNpcInStructure(poiObject, ident, type, structureId, cellName, -1);
    }
    public static obj_id createNpcInStructure(obj_id poiObject, String ident, String type, obj_id structureId, String cellName, int level)
    {
        obj_id poiBaseObject = getBaseObject(poiObject);
        if (poiBaseObject == null || poiBaseObject == obj_id.NULL_ID)
        {
    ...
    public static obj_id createNpcInStructure(obj_id poiObject, String ident, String type, obj_id structureId)
    {
        return createNpcInStructure(poiObject, ident, type, structureId, -1);
    }
    public static obj_id createNpcInStructure(obj_id poiObject, String ident, String type, obj_id structureId, int level)
    {
    ...
    public static obj_id createNpc(String ident, String type, float x, float z)
    {
        return createNpc(ident, type, x, z, -1);
    }
    public static obj_id createNpc(String ident, String type, float x, float z, int level)
    {
        return createNpc(getSelf(), ident, type, x, z, level);
    }
    public static obj_id findObject(obj_id poiObject, String name)
    {
        obj_id poiBaseObject = getBaseObject(poiObject);
        if (poiBaseObject == null || poiBaseObject == obj_id.NULL_ID)
        {
    ...
    public static obj_id findObject(String name)
    {
        return findObject(getSelf(), name);
    }
    public static String findObjectName(obj_id poiObject)
    {
        return getStringObjVar(poiObject, POI_STRING_LIST_INDEXNAME);
    }
    public static String findObjectName()
    {
        return findObjectName(getSelf());
    }
    public static void setDestroyMessage(obj_id poiObject, String name, String messageHandlerName, int delay)
    {
    ...
    public static void setDestroyMessage(obj_id poiObject, String name, String messageHandlerName)
    {
        setDestroyMessage(poiObject, name, messageHandlerName, 0);
    }
    public static void setDestroyMessage(String name, String messageHandlerName, int delay)
    {
        obj_id poiObject = getSelf();
        setDestroyMessage(poiObject, name, messageHandlerName, delay);
    }
    public static void setDestroyMessage(String name, String messageHandlerName)
    {
        setDestroyMessage(getSelf(), name, messageHandlerName, 0);
    }
    public static void setDestroyMessage(obj_id poiObject, String messageHandlerName, int delay)
    {
    ...
    public static void setDestroyMessage(obj_id poiObject, String messageHandlerName)
    {
        setObjVar(poiObject, POI_DESTROY_MESSAGE, messageHandlerName);
    }
    public static void setDestroyMessage(String messageHandlerName, int delay)
    {
        setDestroyMessage(getSelf(), messageHandlerName, delay);
    }
    public static void setDestroyMessage(String messageHandlerName)
    {
        setDestroyMessage(getSelf(), messageHandlerName, 0);
    }
    public static void grantCredit(obj_id poiObject, obj_id player)
    {
        obj_id poiBaseObject = getBaseObject(poiObject);
        if (poiBaseObject == null || poiBaseObject == obj_id.NULL_ID)
        {
    ...
    public static void grantCredit(obj_id player)
    {
        grantCredit(getSelf(), player);
    }
    public static void removeCredit(obj_id poiObject, obj_id player)
    {
        obj_id poiBaseObject = getBaseObject(poiObject);
        if (poiBaseObject == null || poiBaseObject == obj_id.NULL_ID)
        {
    ...
    public static void removeCredit(obj_id player)
    {
        removeCredit(getSelf(), player);
    }
    public static void denyCredit(obj_id poiObject, obj_id player)
    {
    ...
    public static void denyCredit(obj_id player)
    {
        denyCredit(getSelf(), player);
    }
    public static boolean isGrantedCredit(obj_id poiObject, obj_id player) {
        obj_id poiBaseObject = getBaseObject(poiObject);
        return !(poiBaseObject == null || poiBaseObject == obj_id.NULL_ID) && isGrantedCredit(poiBaseObject, player.toString());
    }
    public static boolean isGrantedCredit(obj_id player)
    {
        return isGrantedCredit(getSelf(), player);
    }
    public static boolean isGrantedCredit(obj_id poiBaseObject, String objVarName)
    {
        return hasObjVar(poiBaseObject, POI_CREDIT_LIST + "." + objVarName);
    }
    public static boolean isDeniedCredit(obj_id poiObject, obj_id player) {
        obj_id poiBaseObject = getBaseObject(poiObject);
        return !(poiBaseObject == null || poiBaseObject == obj_id.NULL_ID) && isDeniedCredit(poiBaseObject, player.toString());
    }
    public static boolean isDeniedCredit(obj_id player)
    {
        return isDeniedCredit(getSelf(), player);
    }
    public static boolean isDeniedCredit(obj_id poiBaseObject, String objVarName)
    {
        return hasObjVar(poiBaseObject, POI_DENY_LIST + "." + objVarName);
    }
    public static void addToStringList(obj_id element, String name)
    {
    ...
    public static void addToStringList(String name)
    {
        addToStringList(getSelf(), name);
    }
    public static void removeFromStringList(obj_id element)
    {
    ...
    public static void removeFromStringList()
    {
        removeFromStringList(getSelf());
    }
    public static void removeFromStringList(obj_id poiObject, String name)
    {
        obj_id poiBaseObject = getBaseObject(poiObject);
        if (poiBaseObject == null || poiBaseObject == obj_id.NULL_ID)
        {
    ...
    public static void removeFromStringList(String name)
    {
        removeFromStringList(getSelf(), name);
    }
    public static void addToMasterList(obj_id poiBaseObject, obj_id elementToAdd)
    {
    }
    public static void removeFromMasterList(obj_id poiBaseObject, obj_id elementToRemove)
    {
    }
    public static boolean isInMasterList(obj_id poiBaseObject, obj_id element)
    {
        return false;
    }
    public static boolean isInPersistedList(obj_id poiBaseObject, obj_id element)
    {
        return false;
    }
    public static obj_id getBaseObject(obj_id poiObject)
    {
    ...
    public static obj_id getBaseObject()
    {
        return getBaseObject(getSelf());
    }
    public static void baseObjectDestroyed(obj_id poiBaseObject)
    {
    ...
    public static void objectDestroyed(obj_id element)
    {
    ...
    public static String getDifficulty(obj_id poiObject)
    {
        obj_id poiBaseObject = getBaseObject(poiObject);
        if (poiBaseObject == null || poiBaseObject == obj_id.NULL_ID)
        {
    ...
    public static int getIntDifficulty()
    {
    ...
    public static String getFaction(obj_id poiObject)
    {
        obj_id poiBaseObject = getBaseObject(poiObject);
        if (poiBaseObject == null || poiBaseObject == obj_id.NULL_ID)
        {
    ...
    public static float getFactionValue(obj_id poiObject)
    {
        obj_id poiBaseObject = getBaseObject(poiObject);
        if (poiBaseObject == null || poiBaseObject == obj_id.NULL_ID)
        {
    ...
    public static float getFactionValue()
    {
        return getFactionValue(getSelf());
    }
    public static String getObjective(obj_id poiObject)
    {
        obj_id poiBaseObject = getBaseObject(poiObject);
        if (poiBaseObject == null || poiBaseObject == obj_id.NULL_ID)
        {
    ...
    public static void setFaction(obj_id poiObject, String faction)
    {
        obj_id poiBaseObject = getBaseObject(poiObject);
        if (poiBaseObject == null || poiBaseObject == obj_id.NULL_ID)
        {
    ...
    public static void setFactionValue(obj_id poiObject, float factionValue)
    {
        obj_id poiBaseObject = getBaseObject(poiObject);
        if (poiBaseObject == null || poiBaseObject == obj_id.NULL_ID)
        {
    ...
    public static void setFactionValue(float factionValue)
    {
        setFactionValue(getSelf(), factionValue);
    }
    public static void complete(obj_id poiObject, int status)
    {
        obj_id poiBaseObject = getBaseObject(poiObject);
        if (poiBaseObject == null || poiBaseObject == obj_id.NULL_ID)
        {
    ...
    public static void complete(int status)
    {
        complete(getSelf(), status);
    }
    public static void complete(obj_id poiObject)
    {
        obj_id poiBaseObject = getBaseObject(poiObject);
        if (poiBaseObject == null || poiBaseObject == obj_id.NULL_ID)
        {
    ...
    public static void awardFactionStanding(obj_id poiBaseObject)
    {
    ...
    public static void sendMissionStatus(obj_id poiBaseObject, int status)
    {
    ...
    public static void baseObjectRemovedFromWorld(obj_id poiBaseObject)
    {
        if (isComplete(poiBaseObject))
        {
    ...
    public static boolean isComplete(obj_id poiObject)
    {
        obj_id poiBaseObject = getBaseObject(poiObject);
    ...
    public static boolean setTitle(obj_id npc, String title)
    {
    ...
    public static boolean isNpcTagged(obj_id npc, String tag) {
        obj_id found = findObject(tag);
        return !((found == null) || (found == obj_id.NULL_ID)) && found == npc;
    }
    public static boolean quickSay(obj_id npc, String speech)
    {
        obj_id poiBaseObject = getBaseObject(npc);
    ...
    public static boolean quickSay(obj_id npc, String chatType, String moodType, String speech)
    {
        obj_id poiBaseObject = getBaseObject(npc);
        if ((poiBaseObject == null) || (poiBaseObject == obj_id.NULL_ID))
        {
    ...
    public static obj_id getRandomMediator(obj_id poiobj)
    {
    ...
    public static obj_id getRandomAntagonist(obj_id poiobj)
    {
        obj_id poiBaseObject = getBaseObject(poiobj);
        if ((poiBaseObject == null) || (poiBaseObject == obj_id.NULL_ID))
        {
