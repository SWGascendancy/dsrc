...
public class city extends script.base_script
{
    ...
    public static final int CP_MILITIA = 1;
    public static final int CP_ABSENT_WEEK_1 = 2;
    public static final int CP_ABSENT_WEEK_2 = 4;
    public static final int CP_ABSENT_WEEK_3 = 8;
    public static final int CP_ABSENT_WEEK_4 = 16;
    public static final int CP_ABSENT_WEEK_5 = 32;
    public static final int CP_INACTIVE_PROTECTED = 64;
    ...
    public static int canBuildCityHere(obj_id player, location loc)
    {
    ...
    public static boolean isInCity(obj_id obj)
    {
        return isInCity(getLocation(obj));
    }
    public static boolean isInCity(location loc)
    {
        int city_id = 0;
    ...
    public static boolean isPartOfCity(obj_id structure, int city_id)
    {
    ...
    public static boolean isAMayor(obj_id player)
    {
    ...
    public static boolean isTheCityMayor(obj_id player, int city_id)
    {
        obj_id mayor = cityGetLeader(city_id);
        return mayor == player;
    }
    public static int getCityRank(int city_id)
    {
        if (!cityExists(city_id))
        {
            return 0;
    ...
    public static boolean addStructureToCity(obj_id structure)
    {
        if (!isIdValid(structure))
        {
            return false;
    ...
    public static boolean addStructureToCity(obj_id structure, int city_id)
    {
    ...
    public static boolean removeStructureFromCity(obj_id structure)
    {
        if (!isIdValid(structure))
        {
            return false;
    ...
    public static boolean removeStructureFromCity(int city_id, obj_id structure)
    {
        if (isPartOfCity(structure, city_id))
        {
    ...
    public static void validateCityStructure(obj_id structure)
    {
        if (!isIdValid(structure))
        {
            return;
    ...
    public static boolean validateSpecialStructure(obj_id structure)
    {
        if (!isIdValid(structure))
        {
            return false;
    ...
    public static boolean isCitizenOfCity(obj_id player, int city_id)
    {
        if (!cityExists(city_id))
        {
            return false;
    ...
    public static boolean isMilitiaOfCity(obj_id player, int city_id)
    {
        if (!cityExists(city_id))
        {
            return false;
    ...
    public static boolean hasMilitiaFlag(obj_id player, int city_id)
    {
        if (!cityExists(city_id))
        {
            return false;
    ...
    public static void addCitizen(obj_id citizen, obj_id residence)
    {
    ...
    public static void removeCitizen(obj_id citizen, obj_id residence)
    {
        if (!isIdValid(residence))
        {
            return;
    ...
    public static void removeCitizen(obj_id citizen, int city_id, obj_id residence)
    {
        if (!cityExists(city_id))
        {
            return;
    ...
    public static void addMilitia(int city_id, obj_id citizen)
    {
        obj_id mayor = cityGetLeader(city_id);
    ...
    public static void removeMilitia(int city_id, obj_id citizen)
    {
        obj_id mayor = cityGetLeader(city_id);
        int flags = cityGetCitizenPermissions(city_id, citizen);
        flags = flags & ~CP_MILITIA;
    ...
    public static void setCityResidence(obj_id citizen, obj_id newresidence)
    {
    ...
    public static void setMayor(int city_id, obj_id new_mayor)
    {
        citySetLeader(city_id, new_mayor);
    }
    public static void setRadius(int city_id, int new_radius)
    {
        citySetRadius(city_id, new_radius);
    }
    public static void setName(int city_id, String new_name)
    {
        citySetName(city_id, new_name);
    }
    public static void setCitizenAllegiance(int city_id, obj_id citizen, obj_id new_allegiance)
    {
    ...
    public static boolean addStarport(obj_id shuttleport, location cityTravelLoc, int cityTravelCost, boolean cityTravelIntp)
    {
    ...
    public static boolean removeStarport(obj_id shuttleport)
    {
    ...
    public static boolean removeStarport(obj_id shuttleport, int city_id)
    {
        String city_name = cityGetName(city_id);
        obj_id city_hall = cityGetCityHall(city_id);
    ...
    public static boolean addGarage(String template)
    {
        return true;
    }
    public static void removeGarage(obj_id structure)
    {
        return;
    }
    public static boolean isUniqueCityName(String newName)
    {
    ...
    public static boolean isCityBanned(obj_id player, int city_id)
    {
        if (!cityExists(city_id))
        {
            return false;
    ...
    public static boolean isCityBanned(obj_id player, obj_id structure)
    {
        int city_id = getCityAtLocation(getLocation(structure), 0);
        return isCityBanned(player, city_id);
    }
    public static boolean removeBan(obj_id player, int city_id)
    {
        if (!cityExists(city_id))
        {
            return false;
    ...
    public static void removeTaxesSetRadius(int city_id, int new_radius)
    {
    ...
    public static void removeTaxes(int city_id)
    {
        removeTaxesSetRadius(city_id, cityGetRadius(city_id));
    }
    public static void setIncomeTax(int city_id, int new_tax)
    {
        String city_name = cityGetName(city_id);
        obj_id city_hall = cityGetCityHall(city_id);
    ...
    public static void setPropertyTax(int city_id, int new_tax)
    {
        String city_name = cityGetName(city_id);
        obj_id city_hall = cityGetCityHall(city_id);
    ...
    public static void setSalesTax(int city_id, int new_tax)
    {
        String city_name = cityGetName(city_id);
        obj_id city_hall = cityGetCityHall(city_id);
    ...
    public static void setTravelFee(int city_id, int new_fee)
    {
    ...
    public static void setGarageFee(int city_id, int new_fee)
    {
    ...
    public static void setCloneInfo(int city_id, location cityCloneLoc, location cityCloneRespawn, obj_id cityCloneId)
    {
        String city_name = cityGetName(city_id);
        obj_id city_hall = cityGetCityHall(city_id);
    ...
    public static void updateLocation(int city_id, location new_loc)
    {
        obj_id cityHall = cityGetCityHall(city_id);
        location cityLoc = (location)new_loc.clone();
        citySetLocation(city_id, new_loc);
    }
    public static int getPropertyTax(obj_id structure)
    {
        int city_id = getCityAtLocation(getLocation(structure), 0);
        if (cityExists(city_id))
        {
    ...
    public static obj_id getCityHall(obj_id structure)
    {
        int city_id = getCityAtLocation(getLocation(structure), 0);
        if (cityExists(city_id))
        {
    ...
    public static void setStructureType(int city_id, obj_id structure, int structureType)
    {
    ...
    public static void setStructureValid(int city_id, obj_id structure, boolean structureValid)
    {
        int structureType = cityGetStructureType(city_id, structure);
        citySetStructureInfo(city_id, structure, structureType, structureValid);
    }
    public static boolean isCityRegistered(int city_id)
    {
        if (!cityExists(city_id))
        {
            return false;
    ...
    public static void registerCity(int city_id)
    {
        if (!cityExists(city_id))
        {
            return;
    ...
    public static void unregisterCity(int city_id)
    {
        if (!cityExists(city_id))
        {
            return;
    ...
    public static void updateRegistrationScript(int city_id, obj_id structure)
    {
        if (!cityExists(city_id))
        {
            return;
    ...
    public static boolean checkStructureValid(int city_id, obj_id structure)
    {
        return checkStructureValid(city_id, structure, getCityRank(city_id));
    }
    public static boolean checkStructureValid(int city_id, obj_id structure, int city_rank)
    {
        if (!isNormalStructure(city_id, structure))
        {
    ...
    public static boolean checkSpecialValid(int city_id, obj_id structure)
    {
        return checkSpecialValid(city_id, structure, getCityRank(city_id));
    }
    public static boolean checkSpecialValid(int city_id, obj_id structure, int rank)
    {
        obj_id mayor = cityGetLeader(city_id);
        String mayor_name = cityGetCitizenName(city_id, mayor);
        String structure_name = localize(getNameStringId(structure));
    ...
    public static int getStructureCost(int city_id, obj_id structure)
    {
        if (!cityExists(city_id))
        {
            return 0;
    ...
    public static void initCitizen(obj_id citizen)
    {
    ...
    public static int getCivicCount(int city_id)
    {
        int count = 0;
        obj_id[] structures = cityGetStructureIds(city_id);
        for (int i = 0; i < structures.length; i++)
    ...
    public static int getMaxCivicCount(int city_id)
    {
        return getMaxCivicCount(city_id, getCityRank(city_id));
    }
    public static int getMaxCivicCount(int city_id, int rank)
    {
    ...
    public static int getMTCount(int city_id)
    {
        int count = 0;
        obj_id[] structures = cityGetStructureIds(city_id);
        for (int i = 0; i < structures.length; i++)
    ...
    public static int getMaxMTCount(int city_id)
    {
        return getMaxMTCount(city_id, getCityRank(city_id));
    }
    public static int getMaxMTCount(int city_id, int rank)
    {
        return rank * 3;
    }
    public static void addMissionTerminal(int city_id, obj_id player, String template)
    {
        if (!cityExists(city_id))
        {
            return;
    ...
    public static void removeMissionTerminal(obj_id terminal)
    {
    ...
    public static int getTrainerCount(int city_id)
    {
        int count = 0;
        obj_id[] structures = cityGetStructureIds(city_id);
        for (int i = 0; i < structures.length; i++)
    ...
    public static int getMaxTrainerCount(int city_id)
    {
        return getMaxTrainerCount(city_id, getCityRank(city_id));
    }
    public static int getMaxTrainerCount(int city_id, int rank)
    {
        return 0;
    }
    public static void addSkillTrainer(int city_id, obj_id player, String template)
    {
        if (!cityExists(city_id))
        {
            return;
    ...
    public static void removeSkillTrainer(obj_id trainer)
    {
    ...
    public static int getDecorationCount(int city_id)
    {
        int count = 0;
        obj_id[] structures = cityGetStructureIds(city_id);
        for (int i = 0; i < structures.length; i++)
    ...
    public static int getMaxDecorationCount(int city_id)
    {
        return getMaxDecorationCount(city_id, getCityRank(city_id));
    }
    public static int getMaxDecorationCount(int city_id, int rank)
    {
    ...
    public static void addDecoration(int city_id, obj_id player, obj_id deco)
    {
        if (!cityExists(city_id))
        {
            return;
    ...
    public static void removeDecoration(obj_id deco)
    {
    ...
    public static void setSpecialization(int city_id, String spec)
    {
    ...
    public static boolean cityHasSpec(int city_id, int spec_bit)
    {
        if (city_id <= 0)
        {
            return false;
    ...
    public static int cityGetSpec(int city_id)
    {
        obj_id city_hall = cityGetCityHall(city_id);
        int flags = cityGetStructureType(city_id, city_hall);
        return flags & SPEC_MASK;
    }
    public static String cityGetSpecString(int city_id)
    {
    ...
    public static int cityGetSpecCost(int city_id)
    {
        int spec = cityGetSpec(city_id);
        int[] bits = dataTableGetIntColumn(CITY_SPECS, "BIT");
        for (int i = 0; i < bits.length; i++)
    ...
    public static boolean isCityZoned(int city_id)
    {
        obj_id city_hall = cityGetCityHall(city_id);
        int flags = cityGetStructureType(city_id, city_hall);
        return (0 != (flags & SF_REQUIRE_ZONE_RIGHTS));
    }
    public static void setCityZoned(int city_id, boolean zoned)
    {
        obj_id city_hall = cityGetCityHall(city_id);
        int flags = cityGetStructureType(city_id, city_hall);
        if (zoned)
    ...
    public static int checkCity(obj_id self, boolean notify)
    {
    ...
    public static int checkMayorCity(obj_id self, boolean notify)
    {
    ...
    public static boolean isNormalStructure(int city_id, obj_id structure)
    {
        int flags = cityGetStructureType(city_id, structure);
    ...
    public static boolean isPayStructure(int city_id, obj_id structure)
    {
        int flags = cityGetStructureType(city_id, structure);
    ...
    public static boolean isMissionTerminal(int city_id, obj_id structure)
    {
        int flags = cityGetStructureType(city_id, structure);
        if (0 != (flags & SF_MISSION_TERMINAL))
        {
    ...
    public static boolean isSkillTrainer(int city_id, obj_id structure)
    {
        int flags = cityGetStructureType(city_id, structure);
        if (0 != (flags & SF_SKILL_TRAINER))
        {
    ...
    public static boolean isDecoration(int city_id, obj_id structure)
    {
        int flags = cityGetStructureType(city_id, structure);
        if (0 != (flags & SF_DECORATION))
        {
    ...
    public static int setStructureCityId(obj_id structure, int city_id)
    {
    ...
    public static int getStructureCityId(obj_id structure)
    {
        if (player_structure.isBuilding(structure))
        {
    ...
    public static void clearAbsenceFlags(obj_id citizen, int city_id)
    {
    ...
    public static void doMayoralStructureTransfer(obj_id new_mayor, obj_id ousted_mayor, int city_id)
    {
    ...
    public static void moveNoTradeItemsInStructureToOwner(obj_id building, obj_id ousted_mayor, int city_id)
    {
    ...
    public static void checkItemsForNoTradeTransfer(obj_id container, obj_id player, int city_id)
    {
    ...
    public static boolean hasZoningRights(obj_id player, int city_id)
    {
    ...
    public static boolean hasStorytellerZoningRights(obj_id player, int city_id)
    {
        if (!isIdValid(player) || city_id <= 0)
        {
            return false;
    ...
    public static boolean hasMayorProtectionFlag(obj_id player, int city_id)
    {
        if (!cityExists(city_id))
        {
            return false;
    ...
    public static int getMaxSafeHouseCount(int city_id)
    {
    ...
    public static int getCurrentSafeHouseCount(int city_id)
    {
        obj_id[] citizens = cityGetCitizenIds(city_id);
        int tracker = 0;
    ...
    public static void addSafeHouseCitizen(int city_id, obj_id citizen)
    {
        obj_id mayor = cityGetLeader(city_id);
        int flags = cityGetCitizenPermissions(city_id, citizen);
    ...
    public static void removeSafeHouseCitizen(int city_id, obj_id citizen)
    {
        obj_id mayor = cityGetLeader(city_id);
        int flags = cityGetCitizenPermissions(city_id, citizen);
        flags = flags & ~CP_INACTIVE_PROTECTED;
    ...
    public static obj_id[] getCitySafeHouseCitizenList(int city_id)
    {
