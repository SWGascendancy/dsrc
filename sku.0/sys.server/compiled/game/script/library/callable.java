...
public class callable extends script.base_script
{
    ...
    public static int getControlDeviceType(obj_id cd)
    {
    ...
    public static int getCallableType(obj_id objCallable)
    {
    ...
    public static String getCallableTypeObjVar(int type)
    {
        switch (type)
        {
    ...
    public static obj_id getCallable(obj_id master, int objCallableType)
    {
    ...
    public static obj_id[] getCallables(obj_id master)
    {
        int[] callableTypes = 
        {
    ...
    public static obj_id[] getDatapadCallablesByType(obj_id master, int callableType)
    {
        Vector callables = new Vector();
        callables.setSize(0);
    ...
    public static boolean hasCallable(obj_id master, int objCallableType)
    {
        return hasCallable(master, objCallableType, obj_id.NULL_ID);
    }
    public static boolean hasCallable(obj_id master, int objCallableType, obj_id beast)
    {
        if (!beast_lib.isValidPlayer(master))
        {
            return true;
    ...
    public static boolean hasAnyCallable(obj_id master)
    {
    ...
    public static boolean setCallable(obj_id master, obj_id objCallable, int objCallableType)
    {
        if (!beast_lib.isValidPlayer(master))
        {
            return false;
    ...
    public static obj_id getCDCallable(obj_id cd)
    {
    ...
    public static boolean hasCDCallable(obj_id cd)
    {
        if (!isIdValid(cd) || !exists(cd))
        {
            return false;
    ...
    public static boolean setCDCallable(obj_id cd, obj_id objCallable)
    {
        if (!isIdValid(cd) || !exists(cd))
        {
            return false;
    ...
    public static obj_id getCallableCD(obj_id objCallable)
    {
        if (!isIdValid(objCallable) || !exists(objCallable))
        {
            return null;
    ...
    public static boolean hasCallableCD(obj_id objCallable)
    {
        if (!isIdValid(objCallable) || !exists(objCallable))
        {
            return false;
    ...
    public static boolean setCallableCD(obj_id objCallable, obj_id cd)
    {
    ...
    public static void setCallableLinks(obj_id master, obj_id cd, obj_id objCallable)
    {
    ...
    public static void storeCallable(obj_id master, obj_id objCallable)
    {
        if (!isIdValid(objCallable) || !exists(objCallable))
        {
            return;
    ...
    public static void storeCallables(obj_id master)
    {
    ...
    public static void restoreCallable(obj_id master)
    {
    ...
    public static void killCallable(obj_id objCallable, obj_id killer)
    {
        if (!isIdValid(objCallable) || !exists(objCallable))
        {
            return;
    ...
    public static void killCallables(obj_id master, obj_id killer)
    {
        if (!isIdValid(master) || !exists(master) || !hasAnyCallable(master))
        {
            return;
    ...
    public static int getNumStoredCDByType(obj_id master, int CDType)
    {
    ...
    public static int getMaxAllowedStoredRideables(obj_id player)
    {
    ...
    public static int getAddonMaxAllowedStoredRideables(obj_id player)
    {
        int addonAmount = 0;
    ...
    public static boolean hasMaxStoredRideables(obj_id player)
    {
    ...
    public static boolean increaseAddonMaxStoredRideables(obj_id player, int amountIncreased)
    {
        return increaseAddonMaxStoredRideables(player, amountIncreased, obj_id.NULL_ID);
    }
    public static boolean increaseAddonMaxStoredRideables(obj_id player, int amountIncreased, obj_id source)
    {
    ...
    public static boolean hasMaxStoredCombatPets(obj_id master)
    {
