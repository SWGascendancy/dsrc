...
public class scout extends script.base_script
{
    ...
    public static boolean isScentMasked(obj_id player, obj_id npc)
    {
    ...
    public static void breakScentMask(obj_id player, boolean combat)
    {
    ...
    public static boolean isScentMaskedCheck(obj_id player)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static boolean isSnared(obj_id npc)
    {
        return hasAttribModifier(npc, "movement.snare");
    }
    public static void conceal(obj_id self, obj_id target)
    {
