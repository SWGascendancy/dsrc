...
public class transition extends script.base_script
{
    ...
    public static string_id getZoneTransitionString(obj_id gate)
    {
    ...
    public static void zonePlayer(obj_id gate, obj_id player)
    {
        if (!hasObjVar(gate, "zoneLine"))
        {
    ...
    public static void zonePlayerNoGate(String transit, obj_id player, boolean forceLoadScreen)
    {
        if (!hasPermissionForZone(player, transit, "initialRequiredFlag"))
        {
            notifyPlayerOfInvalidPermission(player, transit);
    ...
    public static void doZoneToWorld(obj_id player, String[] locationParse)
    {
    ...
    public static void doZoneToWorldForceLoadScreen(obj_id player, String[] locationParse, boolean loadScreen)
    {
        float locX = utils.stringToFloat(locationParse[1]);
        float locY = utils.stringToFloat(locationParse[2]);
        float locZ = utils.stringToFloat(locationParse[3]);
    ...
    public static void doPublicInstanceZone(obj_id player, String instance)
    {
    ...
    public static boolean hasPermissionForZone(obj_id player, String zone, String flagType) {
    ...
    public static void notifyPlayerOfInvalidPermission(obj_id player, String zone)
    {
    ...
    public static void cleanupTempAccessFlag(obj_id player)
    {
