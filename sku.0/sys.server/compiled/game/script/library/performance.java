...
public class performance extends script.base_script
{
    ...
    public static void stopInspiration(obj_id actor)
    {
    ...
    public static void stopListen(obj_id actor)
    {
    ...
    public static void listen(obj_id actor, obj_id target)
    {
    ...
    public static void stopWatch(obj_id actor)
    {
        obj_id watchTarget = getPerformanceWatchTarget(actor);
        obj_id listenTarget = getPerformanceListenTarget(actor);
    ...
    public static void watch(obj_id actor, obj_id target)
    {
        session.logActivity(actor, session.ACTIVITY_BEEN_ENTERTAINED);
    ...
    public static void covercharge(obj_id actor, int amount)
    {
    ...
    public static void startEntertainingPlayer(obj_id actor)
    {
    ...
    public static void stopEntertainingPlayer(obj_id actor)
    {
        setAnimationMood(actor, "default");
        detachScript(actor, PERFORMANCE_ENTERTAINED_SCRIPT);
    }
    public static boolean checkPlayerEntertained(obj_id actor, String performanceCheck)
    {
    ...
    public static int lookupPerformanceIndex(int typeHash, String performanceName, int instrumentNumber)
    {
    ...
    public static boolean checkPerformanceType(int typeHash, int performanceIndex)
    {
        int rowTypeHash = dataTableGetInt(DATATABLE_PERFORMANCE, performanceIndex - 1, "type");
        return (rowTypeHash == typeHash);
    }
    public static int findMatchingPerformanceIndex(int leaderPerformanceType, int instrumentNumber)
    {
    ...
    public static int findMatchingDroidPerformanceIndex(int leaderType, obj_id droid)
    {
    ...
    public static int getInstrumentFromPerformanceType(int type)
    {
        type--;
        int instrument = dataTableGetInt(DATATABLE_PERFORMANCE, type, "instrumentAudioId");
        return instrument;
    }
    public static boolean isHologramPerformer(obj_id who)
    {
        if (isPlayer(who))
        {
            return false;
    ...
    public static obj_id[] getDanceMembers(obj_id who)
    {
    ...
    public static obj_id[] getBandMembers(obj_id who)
    {
        obj_id group = getGroupObject(who);
        if (isIdValid(group))
        {
    ...
    public static void startPlaying(obj_id actor, int performanceIndex, int performanceStartTime, int instrumentNumber)
    {
        dictionary params;
    ...
    public static void stopPlaying(obj_id actor)
    {
    ...
    public static void startMusic(obj_id actor, String songName, int instrumentNumber)
    {
    ...
    public static void startMusic(obj_id actor, String songName)
    {
        startMusic(actor, songName, 0);
    }
    public static void startBand(obj_id actor, String songName, int instrumentNumber)
    {
        if (!pet_lib.isDroidPet(actor))
        {
            instrumentNumber = getInstrumentAudioId(actor);
    ...
    public static void startBand(obj_id actor, String songName)
    {
        startBand(actor, songName, 0);
    }
    public static void startTroupe(obj_id actor, String danceName)
    {
    ...
    public static void stopMusic(obj_id actor)
    {
    ...
    public static void stopMusicNow(obj_id actor)
    {
    ...
    public static void stopBand(obj_id actor)
    {
        obj_id[] bandMembers = getBandMembers(actor);
        if (bandMembers != null)
        {
    ...
    public static void changeMusic(obj_id actor, String songName, int instrumentNumber)
    {
        if (!hasScript(actor, MUSIC_HEARTBEAT_SCRIPT))
        {
    ...
    public static void changeMusic(obj_id actor, String songName)
    {
        changeMusic(actor, songName, 0);
    }
    public static void changeBandMusic(obj_id actor, String songName, int instrumentNumber)
    {
        if (!hasScript(actor, MUSIC_HEARTBEAT_SCRIPT))
        {
            performanceMessageToSelf(actor, null, SID_MUSIC_MUST_BE_PERFORMING_SELF);
    ...
    public static void changeBandMusic(obj_id actor, String songName)
    {
        changeBandMusic(actor, songName, 0);
    }
    public static void startDance(obj_id actor, String danceName)
    {
        startDance(actor, danceName, true);
    }
    public static void startDance(obj_id actor, String danceName, boolean displayDances)
    {
        session.logActivity(actor, session.ACTIVITY_ENTERTAINED);
    ...
    public static void stopDance(obj_id actor)
    {
        int type = getPerformanceType(actor);
        if (type != 0)
        {
    ...
    public static void makeOthersStopWatching(obj_id actor)
    {
    ...
    public static void makeOthersStopListening(obj_id actor)
    {
    ...
    public static void changeDance(obj_id actor, String danceName)
    {
        changeDance(actor, danceName, true);
    }
    public static void changeDance(obj_id actor, String danceName, boolean displayDances)
    {
        if (danceName.length() < 1)
        {
            if (displayDances)
    ...
    public static void joinBand(obj_id actor)
    {
        if (getPerformanceType(actor) == 0)
        {
            return;
    ...
    public static void sendNpcsEntertainmentMessage(obj_id actor, String message, String perf_type)
    {
        int count = 0;
    ...
    public static void flourish(obj_id actor, int index)
    {
        if (getPerformanceType(actor) == 0)
        {
    ...
    public static void specialFlourish(obj_id actor, int index)
    {
        if (getPerformanceType(actor) == 0)
        {
            return;
    ...
    public static void bandFlourish(obj_id actor, int index, String instrument)
    {
        if (getPerformanceType(actor) == 0)
        {
            performanceMessageToSelf(actor, null, SID_FLOURISH_NOT_PERFORMING);
    ...
    public static int lookupInstrumentNumber(obj_id actor, String instrument)
    {
    ...
    public static void effect(obj_id actor, int effectId, int effectLevel)
    {
        if (effectLevel < 1)
        {
            effectLevel = 3;
    ...
    public static void playEffectTarget(obj_id self, obj_id target, String effectName, string_id effectString)
    {
        performanceMessageToSelf(self, null, effectString);
        playClientEffectObj(self, effectName, target, "");
    }
    public static void playEffectLoc(obj_id self, location loc, String effectName, string_id effectString)
    {
        performanceMessageToSelf(self, null, effectString);
        playClientEffectLoc(self, effectName, loc, 0.0f);
    }
    public static int getEffectIndex(int effectId, int effectLevel)
    {
        return ((effectId - 1) * 3) + (effectLevel - 1);
    }
    public static boolean getEffectPerformReq(int effectId, int effectLevel)
    {
    ...
    public static void performanceMessageToPerson(obj_id person, obj_id actor, obj_id target, string_id message)
    {
        prose_package pp = new prose_package();
        pp.stringId = message;
        if (isIdValid(actor))
    ...
    public static void performanceMessageToMaster(obj_id actor, obj_id target, string_id message)
    {
        if (!pet_lib.isDroidPet(actor))
        {
            return;
    ...
    public static void performanceMessageToSelf(obj_id actor, obj_id target, string_id message)
    {
        performanceMessageToPerson(actor, actor, target, message);
    }
    public static void performanceMessageToArray(obj_id[] people, obj_id actor, obj_id target, string_id message)
    {
        if (people != null)
        {
    ...
    public static void performanceMessageToBand(obj_id actor, obj_id target, string_id message)
    {
        obj_id[] members = getBandMembers(actor);
        performanceMessageToArray(members, actor, target, message);
    }
    public static void performanceMessageToBandListeners(obj_id actor, obj_id target, string_id message)
    {
        obj_id[] members = getBandMembers(actor);
        if (members != null)
        {
    ...
    public static void performanceMessageToListeners(obj_id actor, obj_id target, string_id message)
    {
        performanceMessageToArray(getPerformanceListenersInRange(actor, PERFORMANCE_HEAL_RANGE), actor, target, message);
    }
    public static void performanceMessageToWatchers(obj_id actor, obj_id target, string_id message)
    {
        performanceMessageToArray(getPerformanceWatchersInRange(actor, PERFORMANCE_HEAL_RANGE), actor, target, message);
    }
    public static int getPerformanceHealWoundMod(int perf_index)
    {
        if (perf_index == 0)
        {
            return 0;
    ...
    public static int getPerformanceHealShockMod(int perf_index)
    {
        if (perf_index == 0)
        {
            return 0;
    ...
    public static int getPerformanceActionCost(int perf_index)
    {
        if (perf_index == 0)
        {
            return 0;
    ...
    public static float getPerformanceLoopDuration(int perf_index)
    {
        if (perf_index == 0)
        {
            return 0;
    ...
    public static int getPerformanceBaseXp(int perf_index)
    {
        if (perf_index == 0)
        {
            return 0;
    ...
    public static int getFlourishXpMod(int perf_index)
    {
        if (perf_index == 0)
        {
            return 0;
    ...
    public static boolean performanceHeal(obj_id actor, String perf_type, float modifier)
    {
        if (!isIdValid(actor))
        {
            return false;
    ...
    public static float inspireGetMaxDuration(obj_id actor)
    {
        int can_heal = canPerformanceHeal(actor);
    ...
    public static boolean inspire(obj_id actor, String perf_type)
    {
        ...
        for (int i = 0; i < audience.length; i++)
        {
            ...
            else 
            {
                ...
                pp.other.set(getFormattedInspirationDuration(inspirationScriptVarVal));
    ...
    public static boolean performanceTargetedBuffFlourish(obj_id actor, String perf_type, float modifier)
    {
        return true;
    }
    public static boolean performanceSetPerformanceBuffTarget(obj_id actor, String target)
    {
    ...
    public static boolean performanceSetPerformanceBuffTarget(obj_id actor, obj_id target)
    {
        if (!isIdValid(target))
        {
            performanceMessageToSelf(actor, null, SID_BUFF_INVALID_TARGET_SELF);
    ...
    public static boolean applyPerformanceActionCost(obj_id actor, float modifier)
    {
        return true;
    }
    public static float getPerformanceMistakeChance(obj_id actor)
    {
        return 0f;
    }
    public static boolean hasInspirationInstrumentUseBuff(obj_id actor, String instrument)
    {
        int col = 0;
    ...
    public static boolean hasInspirationDancePropUseBuff(obj_id actor, String prop)
    {
        int col = 0;
    ...
    public static boolean notShapechanged(obj_id actor)
    {
    ...
    public static boolean canDoPerformance(obj_id actor, int perf_index)
    {
        if (perf_index == 0)
        {
            return false;
    ...
    public static boolean canUseInstrument(obj_id actor, int perf_index)
    {
        if (perf_index == 0)
        {
            return false;
    ...
    public static boolean canPerformSong(obj_id actor, int perf_index)
    {
        if (perf_index == 0)
        {
            return false;
    ...
    public static boolean canPerformDance(obj_id actor, int perf_index)
    {
        if (perf_index == 0)
        {
            return false;
    ...
    public static boolean canPerformJuggle(obj_id actor, int perf_index)
    {
        if (perf_index == 0)
        {
            return false;
    ...
    public static boolean isValidDanceProp(obj_id object)
    {
        if (!isValidId(object))
        {
            return false;
    ...
    public static boolean isDancePropCertified(obj_id player, obj_id object)
    {
    ...
    public static int calcPerformanceXp(obj_id actor)
    {
        if (!isIdValid(actor))
        {
            return 0;
    ...
    public static obj_id[] getBandAudienceInRange(obj_id[] band_members, int band_size, float range)
    {
    ...
    public static void denyService(obj_id player, obj_id target)
    {
    ...
    public static void addDenyService(obj_id player, obj_id target)
    {
    ...
    public static void removeDenyService(obj_id player, obj_id target)
    {
        Vector denyServiceList = utils.getResizeableObjIdBatchScriptVar(player, "performance.denyService");
        if (denyServiceList == null)
        {
    ...
    public static boolean checkDenyService(obj_id player, obj_id target)
    {
        Vector denyServiceList = utils.getResizeableObjIdBatchScriptVar(player, "performance.denyService");
        if (denyServiceList == null)
        {
    ...
    public static boolean displayAvailableMusic(obj_id actor, boolean band, boolean changeMusic)
    {
        if (!isIdValid(actor))
        {
            return false;
    ...
    public static boolean displayAvailableDances(obj_id actor, boolean changeDance)
    {
        if (!isIdValid(actor))
        {
            return false;
    ...
    public static boolean displayAvailableJuggles(obj_id actor, boolean changeJuggle)
    {
        if (!isIdValid(actor))
        {
            return false;
    ...
    public static int canPerformanceHeal(obj_id actor)
    {
        if (pet_lib.isDroidPet(actor) || isHologramPerformer(actor))
        {
            return 0;
    ...
    public static boolean isInRightBuilding(obj_id objPlayer, obj_id objBuilding)
    {
    ...
    public static void checkAndIncrementEntertainerMissions(obj_id objPlayer, String strType)
    {
    ...
    public static void stopEntertainerMissionTracking(obj_id objPlayer, String strType)
    {
        if (hasObjVar(objPlayer, "newbie_handoff.mission.gig"))
        {
    ...
    public static void incrementNewbieHandoffEntertainerMissions(obj_id player, String type)
    {
    ...
    public static void stopNewbieHandoffEntertainerMissionTracking(obj_id player, String type)
    {
        if (hasObjVar(player, "newbie_handoff.mission.gig.start"))
        {
    ...
    public static void startJuggling(obj_id actor, String juggleName)
    {
    ...
    public static void stopJuggling(obj_id actor)
    {
    ...
    public static void changeJuggle(obj_id actor, String juggleName)
    {
        if (juggleName == null || juggleName.length() < 1)
        {
    ...
    public static void openInspireMenu(obj_id self, obj_id target)
    {
    ...
    public static boolean hasMaxHolo(obj_id actor)
    {
        if (!isIdValid(actor))
        {
            return true;
    ...
    public static void holographicCleanup(obj_id actor)
    {
    ...
    public static boolean createHolographicBackup(obj_id actor)
    {
        if (!isIdValid(actor))
        {
            return false;
