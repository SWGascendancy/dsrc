...
public class uberlair extends script.base_script
{
    ...
    public static void spawnBossMobiles(obj_id poiBaseObject, obj_id[] objLargeMobSpawners)
    {
    ...
    public static void spawnNpcLairMobiles(obj_id poiBaseObject, obj_id[] objMobSpawners)
    {
    ...
    public static void respawnMobile(obj_id poiBaseObject, location locSpawnLocation, String strMobToSpawn, String strScript)
    {
    ...
    public static void createFormations(obj_id objParent)
    {
    ...
    public static location[] getPatrolOffsets(location locParentLocation, float fltDistance)
    {
