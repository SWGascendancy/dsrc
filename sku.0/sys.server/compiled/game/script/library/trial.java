...
public class trial extends script.base_script
{
    ...
    public static final String[] HEROIC_TOKENS =
    {
        ...
        "item_wod_token_4",
        "item_wod_token_5",
        "item_vet_reward_token_01_01",
        "item_imperial_station_token_01_01",
        "item_rebel_station_token_01_01",
        "item_ascd_token_01",
        "item_black_market_token_01"
        };
    public static final int NUM_HEROIC_TOKEN_TYPES = 30;
    ...
    public static final String ASCENDANCY_TOKEN = "item_ascd_token_01";
    public static final String BLACK_MARKET_TOKEN = "item_black_market_token_01";
    public static void initializeBox(obj_id self)
    {
    ...
    public static void verifyBox(obj_id self)
    {
    ...
    public static String generateNewKeyCode(obj_id dungeon)
    {
    ...
    public static String initializeCode(obj_id dungeon)
    {
        int code = 0;
        String stringCode = Integer.toString(code);
        int endTime = 0;
    ...
    public static String getKeyCode(obj_id dungeon)
    {
    ...
    public static int getResetTime(obj_id dungeon)
    {
        dungeon = getTop(dungeon);
    ...
    public static void doCountdownTimerFlyText(obj_id terminal, int timer)
    {
    ...
    public static boolean isTrapActive(obj_id dungeon)
    {
        dungeon = getTop(dungeon);
    ...
    public static boolean isTrapPrimed(obj_id dungeon)
    {
        dungeon = getTop(dungeon);
    ...
    public static boolean isSensorActive(obj_id sensor)
    {
    ...
    public static void setTrapState(obj_id dungeon, boolean state)
    {
        dungeon = getTop(dungeon);
        utils.setScriptVar(dungeon, TRAP_STATE, state);
    }
    public static void setFireCellState(obj_id dungeon, boolean state)
    {
        dungeon = getTop(dungeon);
        utils.setScriptVar(dungeon, FIRE_CELL_STATE, state);
    }
    public static boolean isPowerCoreOn(obj_id dungeon)
    {
        dungeon = getTop(dungeon);
    ...
    public static void setPowerCoreState(obj_id dungeon, boolean state)
    {
        dungeon = getTop(dungeon);
        utils.setScriptVar(dungeon, POWER_CORE_STATE, state);
    }
    public static void setGuardianLockState(obj_id dungeon, boolean state)
    {
        dungeon = getTop(dungeon);
        utils.setScriptVar(dungeon, GUARDIAN_LOCK_STATE, state);
    }
    public static boolean isGuardianLockInPlace(obj_id dungeon)
    {
        dungeon = getTop(dungeon);
    ...
    public static boolean isDecrepitDefeated(obj_id dungeon)
    {
        dungeon = getTop(dungeon);
    ...
    public static void setDecrepitTrialState(obj_id dungeon, boolean state)
    {
        dungeon = getTop(dungeon);
        utils.setScriptVar(dungeon, DECREPIT_VICTORY_STATE, state);
    }
    public static void setAurekKilled(obj_id dungeon, boolean state)
    {
        dungeon = getTop(dungeon);
        utils.setScriptVar(dungeon, WORKING_AUREK_KILLED, state);
    }
    public static void setBeshKilled(obj_id dungeon, boolean state)
    {
        dungeon = getTop(dungeon);
        utils.setScriptVar(dungeon, WORKING_BESH_KILLED, state);
    }
    public static void setDevistatorKilled(obj_id dungeon, boolean state)
    {
        dungeon = getTop(dungeon);
        utils.setScriptVar(dungeon, WORKING_DEVISTATOR_KILLED, state);
    }
    public static void setMdeKilled(obj_id dungeon, boolean state)
    {
        dungeon = getTop(dungeon);
        utils.setScriptVar(dungeon, WORKING_MDE_KILLED, state);
    }
    public static void setPowerCoreDeactivated(obj_id dungeon, boolean state)
    {
        dungeon = getTop(dungeon);
        utils.setScriptVar(dungeon, WORKING_POWER_SHUT_DOWN, state);
    }
    public static void setDoomBringerKilled(obj_id dungeon, boolean state)
    {
        dungeon = getTop(dungeon);
        utils.setScriptVar(dungeon, WORKING_DOOM_BRINGER_KILLED, state);
    }
    public static void setAurekBeshEngaged(obj_id dungeon, boolean state)
    {
        dungeon = getTop(dungeon);
        utils.setScriptVar(dungeon, WORKING_AUREK_BESH_ENGAGED, state);
    }
    public static boolean isAurekBeshEngaged(obj_id dungeon)
    {
        dungeon = getTop(dungeon);
    ...
    public static void setAurekBeshKillTime(obj_id dungeon)
    {
        dungeon = getTop(dungeon);
        int time = getGameTime();
        utils.setScriptVar(dungeon, WORKING_AUREKBESH_KILL_TIME, time);
    }
    public static int getAurekBeshKillTime(obj_id dungeon)
    {
        dungeon = getTop(dungeon);
    ...
    public static void clearAurekBeshKillTime(obj_id dungeon)
    {
        if (utils.hasScriptVar(dungeon, WORKING_AUREKBESH_KILL_TIME))
        {
    ...
    public static boolean isAurekKilled(obj_id dungeon)
    {
        dungeon = getTop(dungeon);
    ...
    public static boolean isBeshKilled(obj_id dungeon)
    {
        dungeon = getTop(dungeon);
    ...
    public static boolean isAurekBeshKilled(obj_id dungeon)
    {
        return (isAurekKilled(dungeon) && isBeshKilled(dungeon));
    }
    public static boolean isDevistatorKilled(obj_id dungeon)
    {
        dungeon = getTop(dungeon);
    ...
    public static boolean isMdeKilled(obj_id dungeon)
    {
        dungeon = getTop(dungeon);
    ...
    public static boolean isPowerCoreDeactivated(obj_id dungeon)
    {
        dungeon = getTop(dungeon);
    ...
    public static boolean isDoomBringerKilled(obj_id dungeon)
    {
        dungeon = getTop(dungeon);
    ...
    public static void setRruDeactivated(obj_id dungeon, boolean state)
    {
        dungeon = getTop(dungeon);
        utils.setScriptVar(dungeon, WORKING_RRU_STATE, state);
    }
    public static boolean isRruDeactivated(obj_id dungeon)
    {
        dungeon = getTop(dungeon);
    ...
    public static void setDevistatorEngaged(obj_id dungeon, boolean state)
    {
        dungeon = getTop(dungeon);
        utils.setScriptVar(dungeon, WORKING_DEVISTATOR_ENGAGED, state);
    }
    public static boolean isDevistatorEngaged(obj_id dungeon)
    {
        dungeon = getTop(dungeon);
    ...
    public static boolean isMdeEngaged(obj_id dungeon)
    {
        dungeon = getTop(dungeon);
    ...
    public static void setMdeEngaged(obj_id dungeon, boolean state)
    {
        dungeon = getTop(dungeon);
        utils.setScriptVar(dungeon, WORKING_MDE_ENGAGED, state);
    }
    public static void healAssemblyUnit(obj_id dungeon)
    {
        dungeon = getTop(dungeon);
    ...
    public static void clearMdeArea(obj_id dungeon)
    {
    ...
    public static void resetAssemblyStage(obj_id dungeon)
    {
        dungeon = getTop(dungeon);
        obj_id[] assemblyUnits = getObjectsInDungeonWithScript(dungeon, "theme_park.dungeon.mustafar_trials.working_droid_factory.rapid_assembly_unit");
        if (assemblyUnits == null || assemblyUnits.length == 0)
    ...
    public static boolean isActiveHand(obj_id unit)
    {
    ...
    public static boolean isPrimaryHand(obj_id unit)
    {
    ...
    public static void setActiveHand(obj_id unit, boolean state)
    {
        utils.setScriptVar(unit, WORKING_ACTIVE_HOD, state);
    }
    public static void setPrimaryHand(obj_id unit, boolean state)
    {
        utils.setScriptVar(unit, WORKING_PRIMARY_HAND, state);
    }
    public static boolean isHkSpawned(obj_id unit)
    {
    ...
    public static boolean isHkDetonated(obj_id unit)
    {
    ...
    public static void setHkSpawned(obj_id unit, boolean state)
    {
        utils.setScriptVar(unit, WORKING_HK_SPAWNED, state);
    }
    public static void setHkDetonated(obj_id unit, boolean state)
    {
        utils.setScriptVar(unit, WORKING_HK_BOMB, state);
    }
    public static void setUplinkVictoryState(obj_id dungeon, boolean state)
    {
        dungeon = getTop(dungeon);
        utils.setScriptVar(dungeon, UPLINK_VICTORY_STATE, state);
    }
    public static boolean isUplinkDefeated(obj_id dungeon)
    {
        dungeon = getTop(dungeon);
    ...
    public static boolean isUplinkActive(obj_id dungeon)
    {
        dungeon = getTop(dungeon);
        boolean result = false;
    ...
    public static void setUplinkActiveState(obj_id dungeon, boolean state)
    {
        dungeon = getTop(dungeon);
        utils.setScriptVar(dungeon, UPLINK_ACTIVE, state);
    }
    public static void setIsDroidArmyDefeated(obj_id dungeon, boolean state)
    {
        utils.setScriptVar(dungeon, BATTLEFIELD_VICTORY_STATE, state);
    }
    public static boolean isDroidArmyDefeated(obj_id dungeon)
    {
    ...
    public static void setIsCommanderKilled(obj_id dungeon, boolean state)
    {
        utils.setScriptVar(dungeon, BATTLEFIELD_COMMANDER_KILLED, state);
    }
    public static boolean isCommanderKilled(obj_id dungeon)
    {
    ...
    public static void setIsGeneratorDestroyed(obj_id dungeon, boolean state)
    {
        utils.setScriptVar(dungeon, BATTLEFIELD_GENERATOR_DESTROYED, state);
    }
    public static boolean isGeneratorDestroyed(obj_id dungeon)
    {
    ...
    public static void markAsDroidArmy(obj_id npc)
    {
        utils.setScriptVar(npc, BATTLEFIELD_DROID_ARMY, true);
    }
    public static void markAsMiner(obj_id npc)
    {
        utils.setScriptVar(npc, BATTLEFIELD_MINER, true);
    }
    public static void markAsDroidCorpse(obj_id npc)
    {
        utils.setScriptVar(npc, BATTLEFIELD_DROID_CORPSE, true);
    }
    public static void markAsVolcanoCommander(obj_id npc)
    {
        utils.setScriptVar(npc, VOLCANO_THREE_IS_BOSS, true);
    }
    public static boolean isVolcanoCommander(obj_id npc)
    {
    ...
    public static void markAsVolcanoCorpse(obj_id npc)
    {
        utils.setScriptVar(npc, VOLCANO_THREE_IS_CORPSE, true);
    }
    public static boolean isVolcanoCorpse(obj_id npc)
    {
    ...
    public static void markAsVolcanoBeetle(obj_id npc)
    {
        utils.setScriptVar(npc, VOLCANO_FOUR_IS_BEETLE, true);
    }
    public static boolean isVolcanoBeetle(obj_id npc)
    {
    ...
    public static void markAsHkCorpse(obj_id npc)
    {
        utils.setScriptVar(npc, VOLCANO_FINAL_IS_CORPSE, true);
    }
    public static boolean isHkCorpse(obj_id npc)
    {
    ...
    public static dictionary getSessionDict(obj_id subject)
    {
        dictionary dict = new dictionary();
    ...
    public static dictionary getSessionDict(obj_id subject, String uniqueId)
    {
        dictionary dict = new dictionary();
    ...
    public static int getSession(obj_id subject)
    {
    ...
    public static int getSession(obj_id subject, String uniqueId)
    {
        if (!isIdValid(subject) || !exists(subject))
        {
            return -1;
    ...
    public static boolean verifySession(obj_id subject, dictionary dict)
    {
        int passed = dict.getInt(MESSAGE_SESSION);
        int current = getSession(subject);
        return (current == passed);
    }
    public static boolean verifySession(obj_id subject, dictionary dict, String uniqueId)
    {
    ...
    public static void bumpSession(obj_id subject)
    {
        int session = 0;
        if (utils.hasScriptVar(subject, MESSAGE_SESSION))
        {
    ...
    public static void bumpSession(obj_id subject, String uniqueId)
    {
        String uniqueSession = MESSAGE_SESSION + "." + uniqueId;
        int session = 0;
        if (utils.hasScriptVar(subject, uniqueSession))
    ...
    public static boolean isCellPublic(obj_id dungeon, String cellName)
    {
        dungeon = getTop(dungeon);
    ...
    public static void makeCellPublic(obj_id dungeon, String cellName)
    {
        dungeon = getTop(dungeon);
        obj_id cellId = getCellId(dungeon, cellName);
        if (!isIdValid(cellId))
    ...
    public static void makeCellPrivate(obj_id dungeon, String cellName)
    {
        dungeon = getTop(dungeon);
        obj_id cellId = getCellId(dungeon, cellName);
        if (!isIdValid(cellId))
    ...
    public static obj_id getTop(obj_id item)
    {
        if (!isIdValid(item))
        {
            return null;
    ...
    public static obj_id[] getPlayersInDungeon(obj_id dungeon)
    {
        dungeon = getTop(dungeon);
    ...
    public static obj_id[] getValidTargetsInDungeon(obj_id dungeon)
    {
    ...
    public static obj_id[] getValidTargetsInCell(obj_id dungeon, String cell)
    {
        return getNonStealthedTargetsInCell(dungeon, cell);
    }
    public static obj_id[] getNonStealthedTargetsInCell(obj_id dungeon, String cell)
    {
    ...
    public static obj_id[] getPlayersInCell(obj_id dungeon, String cell)
    {
        dungeon = getTop(dungeon);
    ...
    public static obj_id[] getPlayersInCell(obj_id dungeon, obj_id cell)
    {
    ...
    public static obj_id[] getPlayersInCellList(obj_id dungeon, String[] cells)
    {
        dungeon = getTop(dungeon);
    ...
    public static obj_id[] getObjectsInDungeonWithScript(obj_id dungeon, String script)
    {
        dungeon = getTop(dungeon);
    ...
    public static obj_id[] getAllObjectsInDungeon(obj_id dungeon)
    {
        dungeon = getTop(dungeon);
        if (!isIdValid(dungeon))
        {
    ...
    public static obj_id[] getObjectsInDungeonWithObjVar(obj_id dungeon, String objvar)
    {
        dungeon = getTop(dungeon);
        if (!isIdValid(dungeon))
        {
    ...
    public static obj_id[] getObjectsInCellWithObjVar(obj_id dungeon, String cellName, String objvar)
    {
        dungeon = getTop(dungeon);
        if (!isIdValid(dungeon))
        {
    ...
    public static obj_id[] getObjectsInDungeonWithScriptVar(obj_id dungeon, String scriptVar)
    {
        dungeon = getTop(dungeon);
        if (!isIdValid(dungeon))
        {
    ...
    public static obj_id[] getValidTargetsInRadius(obj_id center, float range)
    {
    ...
    public static obj_id[] getValidTargetsInRadiusIgnoreLOS(obj_id center, float range)
    {
        obj_id[] pets = getNPCsInRange(center, range);
        obj_id[] players = getPlayerCreaturesInRange(center, range);
        Vector targets = new Vector();
    ...
    public static obj_id[] getValidTargetsInCone(obj_id self, obj_id target, float range, float cone)
    {
    ...
    public static obj_id[] getValidPlayersInRadius(obj_id self, float range)
    {
    ...
    public static void setDungeonCleanOutTimer(obj_id dungeon_controller)
    {
        setDungeonCleanOutTimer(dungeon_controller, 300);
    }
    public static void setDungeonCleanOutTimer(obj_id dungeon_controller, int timeAddition)
    {
    ...
    public static void setInterest(obj_id npc)
    {
        if (!isIdValid(npc))
        {
            return;
    ...
    public static void sendCompletionSignal(obj_id dungeon, String signalName)
    {
        obj_id[] players = instance.getPlayersInInstanceArea(dungeon);
        groundquests.sendSignal(players, signalName);
    }
    public static void cleanupNpc(obj_id npc)
    {
        if (!isIdValid(npc))
        {
            return;
    ...
    public static void cleanupObject(obj_id object)
    {
        if (!isIdValid(object))
        {
            return;
    ...
    public static void cleanupObject(obj_id[] objects)
    {
        if (objects == null || objects.length == 0)
        {
            return;
    ...
    public static void setHp(obj_id target, int ammount)
    {
        if (!isIdValid(target))
        {
            return;
    ...
    public static void setParent(obj_id parent, obj_id child, boolean permenant)
    {
    ...
    public static void addToChildArray(obj_id parent, obj_id child)
    {
    ...
    public static obj_id[] getChildArray(obj_id parent)
    {
        if (!utils.hasScriptVar(parent, ARRAY_CHILDREN))
        {
            return null;
    ...
    public static obj_id getParent(obj_id object)
    {
    ...
    public static boolean isChild(obj_id parent, obj_id child)
    {
    ...
    public static obj_id[] getAllChildrenInDungeon(obj_id dungeon, obj_id parent)
    {
    ...
    public static obj_id[] getChildrenInRange(obj_id baseObject, obj_id parent, float range)
    {
    ...
    public static obj_id[] getChildrenInRange(location baseLoc, obj_id parent, float range)
    {
        if (!isIdValid(parent))
        {
            return null;
    ...
    public static obj_id[] getObjectsInRangeWithScriptVar(obj_id baseObj, String scriptVar, float range)
    {
    ...
    public static obj_id[] getObjectsInRangeWithScriptVar(location baseLoc, String scriptVar, float range)
    {
        if (scriptVar.equals(""))
        {
            return null;
    ...
    public static void prepareCorpse(obj_id corpse)
    {
        detachScript(corpse, "ai.ai");
    }
    public static void playMusicInInstance(obj_id dungeon, String sound)
    {
        space_dungeon.playMusicInInstance(dungeon, sound);
    }
    public static void sendInstanceSystemMessage(obj_id dungeon, string_id message)
    {
        space_dungeon.sendInstanceSystemMessage(dungeon, message);
    }
    public static obj_id getClosestValidTarget(obj_id base, obj_id[] targets)
    {
        return getClosest(base, targets);
    }
    public static obj_id getClosest(obj_id base, obj_id[] targets)
    {
    ...
    public static obj_id getSecondClosest(obj_id base, obj_id[] targets)
    {
        obj_id prefered = obj_id.NULL_ID;
    ...
    public static obj_id getClosestObject(obj_id base, obj_id[] targets)
    {
    ...
    public static void markAsTempObject(obj_id object, boolean permenant)
    {
        if (permenant)
        {
    ...
    public static boolean isTempObject(obj_id object)
    {
    ...
    public static obj_id[] getTempObjectsInDungeon(obj_id dungeon)
    {
    ...
    public static obj_id[] getTempObjectsInBuildoutArea(obj_id baseObject)
    {
    ...
    public static String getNearestPatrolPoint(obj_id actor, String[] patrolPointList)
    {
        int idx = getNearestPatrolPointIndex(actor, patrolPointList);
        return patrolPointList[idx];
    }
    public static int getNearestPatrolPointIndex(obj_id actor, String[] patrolPointList)
    {
    ...
    public static location[] convertPatrolPointNameToLoc(obj_id actor, String[] patrolPointList)
    {
    ...
    public static obj_id[] getObjectsInListWithObjVar(obj_id[] list, String objvar)
    {
    ...
    public static location[] shuffleByIndex(String type, location[] ppl, int idx)
    {
    ...
    public static obj_id[] getSpawnedChildren(obj_id object)
    {
    ...
    public static obj_id[] getObjectsInInstanceBySpawnId(obj_id baseObject, String spawn_id)
    {
    ...
    public static obj_id[] getObjectsInInstanceBySpawnId(obj_id baseObject, String[] idList)
    {
        dictionary spawnList = utils.getDictionaryScriptVar(trial.getParent(baseObject), PROT_CHILD_ARRAY);
    ...
    public static obj_id[] getObjectsInInstanceByObjVar(obj_id baseObject, String obj_var)
    {
        obj_id[] allChildren = getSpawnedChildren(trial.getParent(baseObject));
        return getObjectsInListWithObjVar(allChildren, obj_var);
    }
    public static obj_id[] getObjectsInInstanceByObjVar(obj_id baseObject, String[] idList)
    {
    ...
    public static void sendSequenceTrigger(String sequence_trigger)
    {
    ...
    public static boolean registerObjectWithSequencer(obj_id object)
    {
    ...
    public static boolean registerObjectWithSequencer(obj_id sequencer, obj_id object)
    {
    ...
    public static boolean unregisterObjectWithSequencer(obj_id object)
    {
        obj_id instance_id = instance.getAreaInstanceController(object);
        if (!isIdValid(instance_id))
        {
    ...
    public static boolean unregisterObjectWithSequencer(obj_id sequencer, obj_id object)
    {
    ...
    public static void storeSpawnedChild(obj_id self, obj_id child, String spawn_id)
    {
    ...
    public static void setFullPathData(obj_id object)
    {
    ...
    public static String[] getFullPathData(obj_id parent)
    {
    ...
    public static void doLogging(String section, String message)
    {
        if (LOGGING)
        {
    ...
    public static obj_id createSchedulerNPC(obj_id parent, obj_id patrolPoint, String npcName)
    {
        location loc = getLocation(parent);
        obj_id npc = createSchedulerNPC(parent, patrolPoint, npcName, loc);
        return npc;
    }
    public static obj_id createSchedulerNPC(obj_id parent, obj_id patrolPoint, String npcName, location loc)
    {
        if (!isIdValid(parent) || !exists(parent))
        {
            return null;
    ...
    public static boolean addNonInstanceFactionParticipant(obj_id who, obj_id target)
    {
    ...
    public static boolean removeNonInstanceFactionParticipant(obj_id who, obj_id target)
    {
        if (!isIdValid(who) || !exists(who) || !isPlayer(who) || !isIdValid(target) || !exists(target))
        {
            return false;
    ...
    public static boolean isNonInstanceFactionParticipant(obj_id who, obj_id target)
    {
        if (!isIdValid(who) || !exists(who) || !isPlayer(who) || !isIdValid(target) || !exists(target))
        {
            return false;
    ...
    public static Vector getNonInstanceFactionParticipants(obj_id sequencer, int faction)
    {
    ...
    public static void clearNonInstanceFactionParticipants(obj_id sequencer)
    {
        if (!isIdValid(sequencer) || !exists(sequencer))
        {
    ...
    public static boolean purchaseTokenItem(obj_id player, int price, String tokenName)
    {
    ...
    public static int getSpaceDutyTokenPrice(int level)
    {
        int price = level * 10;
        return price;
    }
    public static int getTokenTotal(obj_id player, String token)
    {
        int tokenCount = 0;
