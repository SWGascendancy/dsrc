...
public class bounty_hunter extends script.base_script
{
    ...
    public static void debugLogging(String section, String message)
    {
    ...
    public static boolean isSpammingBountyCheck(obj_id player, boolean sayProse)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static boolean checkForPresenceOfBounty(obj_id player)
    {
        return checkForPresenceOfBounty(player, obj_id.NULL_ID);
    }
    public static boolean checkForPresenceOfBounty(obj_id player, obj_id target)
    {
    ...
    public static void spawnFugitive(obj_id player, location spawnLoc)
    {
    ...
    public static void createFugitive(obj_id player, obj_id spawnedFugitive)
    {
    ...
    public static void payBountyCheckReward(obj_id killer, obj_id target)
    {
    ...
    public static boolean initiatePlayerBountyCollection(obj_id player, obj_id target, int amount)
    {
        return true;
    }
    public static boolean offerCommandCheckBounty(obj_id player, obj_id target, int amount)
    {
        return true;
    }
    public static void awardBounty(obj_id player, String creatureName, int amount)
    {
    ...
    public static void showSetBountySUI(obj_id player, obj_id killer)
    {
    ...
    public static void endBountySession(obj_id hunter, obj_id target, boolean hunterWon)
    {
    }
    public static void winBountyMission(obj_id hunter, obj_id target)
    {
        int bountyValue = 0;
    ...
    public static void loseBountyMission(obj_id hunter, obj_id target)
    {
        prose_package pp = new prose_package();
    ...
    public static obj_id getBountyMission(obj_id player)
    {
        return getBountyMission(player, obj_id.NULL_ID);
    }
    public static obj_id getBountyMission(obj_id player, obj_id target)
    {
    ...
    public static boolean hasMaxBountyMissionsOnTarget(obj_id target)
    {
        obj_id[] hunters = getJediBounties(target);
        if (hunters == null || hunters.length == 0)
        {
    ...
    public static float getBountyFactionPointAdjustment(obj_id hunter, obj_id target)
    {
    ...
    public static void probeDroidTrackTarget(obj_id player, obj_id droid)
    {
        ...
        {
			sendSystemMessageTestingOnly(player, "You do not have droid_track command");
            return;
        }
    ...
    public static boolean callProbot(obj_id player, obj_id droid, obj_id objMission)
    {
