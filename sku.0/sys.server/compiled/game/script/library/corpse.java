...
public class corpse extends script.base_script
{
    ...
    public static obj_id spawnPlayerCorpse(obj_id player)
    {
    ...
    public static boolean initializeCorpsePermissions(obj_id corpse, dictionary params)
    {
        if (!isIdValid(corpse))
        {
            return false;
    ...
    public static boolean grantCorpseConsent(obj_id corpse, obj_id player)
    {
    ...
    public static boolean grantCorpseConsent(obj_id[] corpses, obj_id player)
    {
    ...
    public static boolean revokeCorpseConsent(obj_id corpse, obj_id player)
    {
        if (!isIdValid(corpse) || !isIdValid(player))
        {
            return false;
    ...
    public static boolean revokeCorpseConsent(obj_id[] corpses, obj_id player)
    {
        if ((corpses == null) || (corpses.length == 0) || !isIdValid(player))
        {
            return false;
    ...
    public static boolean revokeAllCorpseConsent(obj_id owner)
    {
        if (!isIdValid(owner))
        {
            return false;
    ...
    public static boolean cleanUpPlayerCorpse(obj_id corpse)
    {
        return cleanUpPlayerCorpse(corpse, true);
    }
    public static boolean cleanUpPlayerCorpse(obj_id corpse, boolean withDestroyMessage)
    {
    ...
    public static boolean dragPlayerCorpse(obj_id player, obj_id corpse, boolean giveFeedback)
    {
    ...
    public static boolean dragPlayerCorpse(obj_id player, obj_id corpse)
    {
        return dragPlayerCorpse(player, corpse, true);
    }
    public static obj_id[] dragPlayerCorpse(obj_id player, obj_id[] corpses)
    {
    ...
    public static boolean isPlayerCorpse(obj_id objectInQuestion)
    {
    ...
    public static obj_id[] getDraggableCorpsesInRange(obj_id player, boolean feedback)
    {
    ...
    public static boolean canDragPlayerCorpse(obj_id player, obj_id corpse, boolean giveFeedback)
    {
        if ((player == null) || (corpse == null))
        {
            return false;
    ...
    public static boolean updateCorpseOwnerWaypoint(obj_id player, obj_id corpse)
    {
        if ((player == null) || (corpse == null))
        {
            return false;
    ...
    public static boolean lootCorpseCoins(obj_id player, obj_id corpse)
    {
    ...
    public static boolean openPlayerCorpse(obj_id player, obj_id corpse)
    {
    ...
    public static boolean lootPlayerCorpse(obj_id player, obj_id corpse)
    {
        if (!isIdValid(player) || !isIdValid(corpse))
        {
            return false;
    ...
    public static boolean openAICorpse(obj_id player, obj_id corpse)
    {
    ...
    public static boolean lootAICorpse(obj_id player, obj_id corpse)
    {
        if (!isIdValid(player) || !isIdValid(corpse))
        {
            return false;
    ...
    public static boolean lootAICorpseContents(obj_id player, obj_id corpse)
    {
    ...
    public static obj_id[] getValidLootContents(obj_id[] corpseContents)
    {
        if (corpseContents == null || corpseContents.length == 0)
        {
            return null;
    ...
    public static int[] hasResource(String mobType)
    {
    ...
    public static boolean hasResource(obj_id corpse)
    {
        if (corpse == null)
        {
            return false;
    ...
    public static boolean harvestCreatureCorpse(obj_id player, obj_id corpse, String restype)
    {
        obj_id pInv = utils.getInventoryContainer(player);
        obj_id cInv = utils.getInventoryContainer(corpse);
    ...
    public static void setCreatureHarvestXp(obj_id corpse, obj_id player)
    {
    }
    public static dictionary getHarvestCorpseResources(obj_id player, obj_id corpse, String restype)
    {
        if ((player == null) || (corpse == null))
        {
            return null;
    ...
    public static dictionary getRandomHarvestCorpseResources(obj_id player, obj_id corpse, int maxTypes)
    {
    ...
    public static dictionary getRandomHarvestCorpseResources(obj_id player, obj_id corpse)
    {
        return getRandomHarvestCorpseResources(player, corpse, 1);
    }
    public static int extractCorpseResource(String resourceClass, int amt, location loc, obj_id pInv, obj_id cInv, int min)
    {
    ...
    public static boolean isCorpseEmpty(obj_id objCorpse)
    {
    ...
    public static boolean hasLootPermissions(obj_id corpse, obj_id player)
    {
    ...
    public static void showLootMeParticle(obj_id corpse)
    {
        obj_id killCredit = getObjIdObjVar(corpse, xp.VAR_TOP_GROUP);
        obj_id[] killList;
        if (group.isGroupObject(killCredit))
    ...
    public static void clearLootMeParticle(obj_id corpse)
    {
        obj_id killCredit = getObjIdObjVar(corpse, xp.VAR_TOP_GROUP);
        obj_id[] killList;
        if (group.isGroupObject(killCredit))
