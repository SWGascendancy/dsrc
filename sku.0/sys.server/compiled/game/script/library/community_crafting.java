...
public class community_crafting extends script.base_script
{
    ...
    public static boolean setMasterSchematic(obj_id craftingTracker, String schematic, boolean trackQuantity, boolean trackQuality, boolean trackSlots, String prizeTable)
    {
    ...
    public static boolean setMinimumQuantity(obj_id craftingTracker, int minQuantity)
    {
        if (!isIdValid(craftingTracker))
        {
    ...
    public static boolean setMinimumQuality(obj_id craftingTracker, float minQuality)
    {
        if (!isIdValid(craftingTracker))
        {
    ...
    public static boolean grantSchematicToPlayer(obj_id craftingTracker, obj_id player)
    {
        if (!isIdValid(craftingTracker))
        {
    ...
    public static boolean grantSchematicToPlayer(obj_id craftingTracker, obj_id player, String schematic)
    {
        return grantSchematicToPlayer(craftingTracker, player, getStringCrc(schematic));
    }
    public static boolean grantSchematicToPlayer(obj_id craftingTracker, obj_id player, int schematicCrc)
    {
        if (!isIdValid(craftingTracker))
        {
    ...
    public static boolean addIngredient(obj_id craftingTracker, obj_id player, obj_id ingredient)
    {
        if (!isIdValid(craftingTracker))
        {
    ...
    public static boolean finalizeItem(obj_id craftingTracker, boolean informAllPlayers)
    {
        if (!isIdValid(craftingTracker))
        {
    ...
    public static boolean createItem(obj_id craftingTracker, location pos)
    {
        return false;
    }
    public static boolean cleanup(obj_id craftingTracker)
    {
        if (!isIdValid(craftingTracker))
        {
    ...
    public static boolean isSessionActive(obj_id craftingTracker)
    {
        if (!isIdValid(craftingTracker))
        {
    ...
    public static int getSchematic(obj_id craftingTracker)
    {
        if (!isIdValid(craftingTracker))
        {
            CustomerServiceLog("community_crafting", "WARNING community_crafting.scriptlib: getSchematic called " + "with invalid craftingTracker");
    ...
    public static String[] getSchematicScripts(obj_id craftingTracker)
    {
        if (!isIdValid(craftingTracker))
        {
    ...
    public static boolean isPlayerCrafting(obj_id player)
    {
        if (!isIdValid(player))
        {
    ...
    public static boolean isPlayerCrafting(obj_id craftingTracker, obj_id player)
    {
        if (!isIdValid(craftingTracker))
        {
    ...
    public static int getNumPlayersCrafting(obj_id craftingTracker)
    {
        if (!isIdValid(craftingTracker))
        {
            CustomerServiceLog("community_crafting", "WARNING community_crafting.scriptlib: isPlayerCrafting called " + "with invalid craftingTracker");
    ...
    public static int getMaxPlayersPerProject()
    {
    ...
    public static int getNumIngredientsNeededByPlayer(obj_id craftingTracker, obj_id player)
    {
        if (!isIdValid(craftingTracker))
        {
    ...
    public static boolean getIsTrackingQuality(obj_id craftingTracker)
    {
        if (!isIdValid(craftingTracker))
        {
            return false;
    ...
    public static boolean getIsTrackingQuantity(obj_id craftingTracker)
    {
        if (!isIdValid(craftingTracker))
        {
            return false;
    ...
    public static boolean getIsTrackingSlots(obj_id craftingTracker)
    {
        if (!isIdValid(craftingTracker))
        {
            return false;
    ...
    public static int getNumSlots(obj_id craftingTracker)
    {
        if (!isIdValid(craftingTracker))
        {
            return 0;
    ...
    public static boolean getProjectAttributes(obj_id craftingTracker, Vector names, Vector values)
    {
        if (!isIdValid(craftingTracker))
        {
    ...
    public static boolean getPlayerRanking(obj_id craftingTracker, Vector playerIds, Vector playerNames, Vector values, boolean quantity, int slot)
    {
        if (!isIdValid(craftingTracker))
        {
    ...
    public static boolean isInitializedForCC(obj_id craftingTracker)
    {
        if (!isIdValid(craftingTracker))
        {
    ...
    public static boolean getSchematics(Vector schematics, String schematic)
    {
        draft_schematic schematicData = getSchematicData(schematic);
        if (schematicData == null)
        {
    ...
    public static float getMinimumQuality(obj_id craftingTracker)
    {
        if (!isIdValid(craftingTracker))
        {
            return 0;
    ...
    public static int getMinimumQuantity(obj_id craftingTracker)
    {
        if (!isIdValid(craftingTracker))
        {
            return 1;
    ...
    public static boolean addPlayerToSystem(obj_id craftingTracker, obj_id player)
    {
        if (!isIdValid(craftingTracker))
        {
    ...
    public static int getCraftingPlayerIndex(obj_id craftingTracker, obj_id player)
    {
        if (!isIdValid(craftingTracker))
        {
            CustomerServiceLog("community_crafting", "WARNING community_crafting.scriptlib: isPlayerCrafting called " + "with invalid craftingTracker");
    ...
    public static float computeResourceAttributeQuality(resource_attribute[] resourceAttribs, draft_schematic schematicData, resource_weight[] resourceWeights, float[] objectAttributes)
    {
        if (resourceAttribs == null)
        {
    ...
    public static float computeComponentAttributeQuality(obj_id component, draft_schematic schematicData, float[] objectAttributes)
    {
    ...
    public static resource_weight[] getResourceWeightsFromScripts(obj_id object)
    {
    ...
    public static void doubleSort(int[] values, obj_id[] ids)
    {
        quickSort(values, ids, 0, values.length - 1);
        insertionSort(values, ids, 0, values.length - 1);
    }
    public static void doubleSort(float[] values, obj_id[] ids)
    {
        quickSort(values, ids, 0, values.length - 1);
        insertionSort(values, ids, 0, values.length - 1);
    }
    public static void quickSort(int[] values, obj_id[] ids, int lo, int hi)
    {
        final int M = 4;
        if (hi - lo > M)
        {
    ...
    public static void insertionSort(int[] values, obj_id[] ids, int lo, int hi)
    {
    ...
    public static void swap(int[] values, obj_id[] ids, int i, int j)
    {
        int T = values[i];
        values[i] = values[j];
        values[j] = T;
    ...
    public static void quickSort(float[] values, obj_id[] ids, int lo, int hi)
    {
        final int M = 4;
        if (hi - lo > M)
        {
    ...
    public static void insertionSort(float[] values, obj_id[] ids, int lo, int hi)
    {
        for (int i = lo + 1; i <= hi; i++)
        {
            float v = values[i];
    ...
    public static void swap(float[] values, obj_id[] ids, int i, int j)
    {
        float T = values[i];
        values[i] = values[j];
        values[j] = T;
