...
public class npe extends script.base_script
{
    ...
    public static final int LEVEL_CAP = 15; // finch adjusting level cap to 15
    public static void setResetDungeonObjvar(obj_id player)
    {
    ...
    public static void randomizeLocation(location loc)
    {
        loc.x += ((-1.0f + (2.0f * random.rand())) * PLAYER_PLACEMENT_RANGE);
        loc.z += ((-1.0f + (2.0f * random.rand())) * PLAYER_PLACEMENT_RANGE);
    }
    public static void randomizeSpaceLocation(location loc)
    {
    ...
    public static boolean performTransitionFromClusterWideData(obj_id player, dictionary[] stations, String station)
    {
        dictionary info;
    ...
    public static dictionary getNpeInstanceInfo(String row)
    {
    ...
    public static int getMinInstancePopulation()
    {
        return utils.stringToInt(getConfigSetting("GameServer", "npeMinInstancePopulation"));
    }
    public static int getMaxInstancePopulation()
    {
        return utils.stringToInt(getConfigSetting("GameServer", "npeMaxInstancePopulation"));
    }
    public static int getBestStationInstanceIndex(obj_id player, dictionary[] stations)
    {
    ...
    public static int getBestDungeonInstanceIndex(obj_id player, dictionary[] dungeons)
    {
    ...
    public static boolean isSecondInstanceBetter(int pop, int new_pop)
    {
    ...
    public static dictionary getBestOrdSpaceStation(obj_id player, dictionary[] stations, String ord_scene)
    {
        if (stations == null || stations.length == 0)
        {
    ...
    public static int getNumberOfOrdSpaceScenes()
    {
        if (!isIdValid(getPlanetByName(SCENE_SPACE_ORD_MANTELL)))
        {
            return 0;
    ...
    public static String getOpenOrdMantellSpaceZone()
    {
    ...
    public static obj_id setupLaunchToSpace(obj_id player)
    {
    ...
    public static void resetPlayerForNpe(obj_id player)
    {
        detachScript(player, SCRIPT_SPACE_TRAVEL);
        detachScript(player, SCRIPT_PUBLIC_TRAVEL);
    }
    public static boolean movePlayerFromHangarToFalcon(obj_id player)
    {
    ...
    public static boolean movePlayerFromFalconToSharedStation(obj_id player)
    {
    ...
    public static boolean movePlayerFromInstanceToInstance(obj_id player, obj_id desired_station, location world_location, String instance_name, int cluster_wide_index)
    {
    ...
    public static boolean movePlayerFromSharedStationToOrdMantellSpace(obj_id player, location new_loc)
    {
        detachScript(player, SCRIPT_SPACE_TRAVEL);
        attachScript(player, SCRIPT_PUBLIC_TRAVEL);
    ...
    public static boolean movePlayerFromOrdMantellSpaceToSharedStation(obj_id player)
    {
        detachScript(player, SCRIPT_SPACE_TRAVEL);
        attachScript(player, SCRIPT_PUBLIC_TRAVEL);
    ...
    public static boolean movePlayerFromSharedStationToOrdMantellDungeon(obj_id player)
    {
        detachScript(player, SCRIPT_SPACE_TRAVEL);
        attachScript(player, SCRIPT_PUBLIC_TRAVEL);
        getClusterWideData(DUNGEON_PUBLIC_MANAGER_NAME, DUNGEON_ORD_SPACE_STATION + "*", false, player);
    ...
    public static boolean movePlayerFromOrdMantellDungeonToSharedStation(obj_id player)
    {
        detachScript(player, SCRIPT_SPACE_TRAVEL);
        attachScript(player, SCRIPT_PUBLIC_TRAVEL);
        utils.setScriptVar(player, SCRIPT_VAR_FROM_ORD_SPACE, 1);
    ...
    public static boolean movePlayerFromOrdMantellSpaceToOrdMantellDungeon(obj_id player)
    {
        detachScript(player, SCRIPT_SPACE_TRAVEL);
        attachScript(player, SCRIPT_PUBLIC_TRAVEL);
        getClusterWideData(DUNGEON_PUBLIC_MANAGER_NAME, DUNGEON_ORD_SPACE_STATION + "*", false, player);
    ...
    public static boolean movePlayerFromOrdMantellDungeonToOrdMantellSpace(obj_id player, location new_loc)
    {
        return transferPlayerToOrdMantellSpace(player, new_loc);
    }

    private static boolean transferPlayerToOrdMantellSpace(obj_id player, location new_loc)
    {
    ...
    public static boolean movePlayerFromSharedStationToFinishLocation(obj_id player)
    {
    ...
    public static boolean teleportPlayerToLaunchLoc(obj_id player, boolean hyperspace)
    {
    ...
    public static obj_id[] grantNewbArmor(obj_id player)
    {
    ...
    public static obj_id grantNpeResourceStack(obj_id player, String strResourceType, int intAmount)
    {
    ...
    public static int harvestNpeResourceStack(obj_id player, String strResourceType, int intAmount)
    {
        obj_id[] objResourceIds = getResourceTypes(strResourceType);
        obj_id objResourceId = null;
        if ((objResourceIds != null) && (objResourceIds.length > 0))
    ...
    public static obj_id getResourceStack(obj_id objContainer, obj_id objResource)
    {
    ...
    public static boolean giveCreditPopUp(obj_id player, obj_id npc)
    {
    ...
    public static boolean giveAutoPopUp(obj_id player, obj_id npc)
    {
        return utils.getIntScriptVar(player, "npe.pop_auto") == 0;
    }
    public static boolean giveEquipPopUp(obj_id player, obj_id npc)
    {
    ...
    public static boolean giveInvPopUp(obj_id player, obj_id npc)
    {
    ...
    public static boolean giveAttackPopUp(obj_id player, obj_id npc)
    {
    ...
    public static boolean giveTargetPopUp(obj_id player, obj_id npc)
    {
    ...
    public static boolean giveMapPopUp(obj_id player, obj_id npc)
    {
    ...
    public static boolean giveJournPopUp(obj_id player)
    {
    ...
    public static boolean giveQuestHelperPopUp(obj_id player)
    {
    ...
    public static boolean giveQuestHelperPopUp2(obj_id player)
    {
        utils.setScriptVar(player, "npe.quest_helper", 1);
        return true;
    }
    public static boolean giveCraftPopUp(obj_id player, obj_id npc)
    {
    ...
    public static boolean givePistolPopUp(obj_id player, obj_id npc)
    {
    ...
    public static boolean giveCarbinePopUp(obj_id player, obj_id npc)
    {
    ...
    public static boolean giveRiflePopUp(obj_id player, obj_id npc)
    {
    ...
    public static boolean give1hPopUp(obj_id player, obj_id npc)
    {
    ...
    public static boolean give2hPopUp(obj_id player, obj_id npc)
    {
    ...
    public static boolean givePolePopUp(obj_id player, obj_id npc)
    {
    ...
    public static boolean giveUnarmPopUp(obj_id player, obj_id npc)
    {
    ...
    public static boolean giveHealPopUp(obj_id player, obj_id npc)
    {
    ...
    public static boolean givePerformPopUp(obj_id player, obj_id npc)
    {
    ...
    public static boolean giveGrenadePopUp(obj_id player, obj_id npc)
    {
    ...
    public static boolean giveChatPopUp(obj_id player)
    {
    ...
    public static boolean giveGroupPopUp1(obj_id player)
    {
    ...
    public static boolean giveGroupPopUp2(obj_id player)
    {
    ...
    public static boolean giveEscPopUp(obj_id player)
    {
    ...
    public static boolean giveEntXpPopUp(obj_id player)
    {
    ...
    public static boolean giveTraderXpPopUp(obj_id player)
    {
    ...
    public static boolean giveStationWaypoint(obj_id player)
    {
    ...
    public static boolean giveHarvestPopUp(obj_id player, obj_id npc)
    {
    ...
    public static void npeNpcVendor(obj_id player, obj_id npc)
    {
    ...
    public static void giveTemplatePointer(obj_id player)
    {
    ...
    public static void commTutorialPlayer(obj_id owner, obj_id player, float duration, string_id text, String sfx, String appearance)
    {
        commPlayers(owner, appearance, sfx, duration, player, prose.getPackage(text));
    }
    public static void sendDelayed3poPopup(obj_id player, int timeDelay, int duration, String soundFile, String strFile, String strMessage, String scriptVarName)
    {
    ...
    public static void removeAllQuests(obj_id player)
    {
        for (int quest : questGetAllActiveQuestIds(player)) {
            questClearQuest(quest, player);
        }
    }
    public static obj_id[] giveProfessionWeapon(obj_id player)
    {
        obj_id pInv = utils.getInventoryContainer(player);
        HashSet theSet = new HashSet();
    ...
    public static void reGrantReWorkedQuests(obj_id player)
    {
    ...
    public static void clearActiveSpaceQuests(obj_id player)
    {
    ...
    public static boolean hasReachedMaxTutorialLevel(obj_id player)
    {
