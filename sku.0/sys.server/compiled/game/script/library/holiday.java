...
public class holiday extends script.base_script
{
    ...
    public static final String EMPIRE_DAY_RECEIVED = "gift.empire18";
    ...
    public static final String IMPERIAL_AND_REBEL_EVENT_GIFT = "item_empire_day_2011_station_model";
    public static final String IMPERIAL_EMPIRE_DAY_GIFT = "item_empire_day_2011_painting_imperial";
    public static final String REBEL_REMEMBRANCE_DAY_GIFT = "item_empire_day_2011_painting_rebel";
    ...
    public static boolean hasLovedayRomanceSeekerCompanion(obj_id player)
    {
        return isIdValid(getLovedayRomanceSeekerCompanionControlDevice(player));
    }
    public static obj_id getLovedayRomanceSeekerCompanionControlDevice(obj_id player)
    {
    ...
    public static boolean grantLovedayRomanceSeekerCompanion(obj_id player)
    {
    ...
    public static void checkForAndGrantLovedayMatchmakingSlot(obj_id player, String companionType)
    {
        if (!isIdValid(player))
        {
            return;
    ...
    public static int getNumRomanticTraitsSets()
    {
        int numRows = dataTableGetNumRows(ROMANCE_TRAITS_TABLE);
        return numRows;
    }
    public static int getRomanticTraitsSet()
    {
        int numSets = getNumRomanticTraitsSets();
        int chosenSet = rand(0, numSets - 1);
        return chosenSet;
    }
    public static void setRomanticTraits(obj_id npc, int chosenSet)
    {
    ...
    public static boolean playEmpireDayFireWorksAndFlyBys(obj_id masterObject, int faction)
    {
    ...
    public static String getEmpireDayEligibility(obj_id player, int faction)
    {
    ...
    public static boolean isEmpireDayPlayerEligible(obj_id player, int faction)
    {
        if (!isValidId(player) || !exists(player))
        {
            return false;
    ...
    public static obj_id[] getEmpireDayWinningPlayers(obj_id holidayObject, Vector eligiblePlayers)
    {
    ...
    public static String currentYearObjVar()
    {
        return EMPIRE_DAY_RECEIVED;
    }
    public static boolean grantEmpireDayGift(obj_id player, int faction)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static int getEmoteBeligerence(String emote)
    {
    ...
    public static obj_id getEmpireDayWaypointObjectObjId(obj_id object, String waypoint, float range)
    {
    ...
    public static obj_id masterObjectObjId(obj_id self)
    {
    ...
    public static boolean giveCeremonyAreaMobsHate(obj_id player, float range)
    {
    ...
    public static boolean grantEmperorDayBadge(obj_id player, obj_id celeb, obj_id[] listOfWinners, int faction)
    {
    ...
    public static boolean slapPlayerDownForBeingRude(obj_id npcObject, obj_id playerToBeIncapped)
    {
    ...
    public static boolean replaceEventObject(obj_id eventObject, obj_id player, String objectTemplate)
    {
    ...
    public static boolean rewardEmpireDayPlayer(obj_id player, int playerFaction, String parentBuffName, String childBuffName, String collectionSlot, String eventName)
    {
    ...
    public static boolean setEventLockOutTimeStamp(obj_id player, String eventLockOut)
    {
        if (!isValidId(player) || !exists(player))
        {
            return false;
    ...
    public static boolean checkEventLockOutRemoval(obj_id player, String eventLockTimer, String eventLockFlag)
    {
        if (!isValidId(player) || !exists(player))
        {
            return false;
    ...
    public static String getTimeRemainingBeforeLockoutRemoved(obj_id player, String eventLockOut)
    {
        if (!isValidId(player) || !exists(player))
        {
            return null;
    ...
    public static boolean getEventTokens(obj_id player, String tokenStaticItem, int amount)
    {
        if (!isValidId(player) || !exists(player))
        {
            return false;
    ...
    public static int getEmpireDayLockoutDelay()
    {
        return secondsUntilNextDailyTime(DAILY_TIME, 0, 0);
    }
    public static boolean createEventLeaderBoardUI(obj_id player, String title, String combinedString)
    {
    ...
    public static void closeOldWindow(obj_id player)
    {
    ...
    public static String getEventHighScores(obj_id planet, String scoreObjVar, boolean faction)
    {
    ...
    public static boolean setEmpireDayLeaderScores(obj_id planet, obj_id player, String scoreObjVar, int newScore, String playerName, int faction)
    {
    ...
    public static boolean removeAllCompletedQuestsForDeathTroopers(obj_id player)
    {
