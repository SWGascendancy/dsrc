...
public class xp extends script.base_script
{
    ...
    public static int grant(obj_id target, String xp_type, int amt)
    {
        return grant(target, xp_type, amt, true, null, null, null);
    }
    public static int grant(obj_id target, String xp_type, int amt, String callback)
    {
        return grant(target, xp_type, amt, true, callback, new dictionary(), getSelf());
    }
    public static int grant(obj_id target, String xp_type, int amt, String callback, dictionary callbackData)
    {
        return grant(target, xp_type, amt, true, callback, callbackData, getSelf());
    }
    public static int grant(obj_id target, String xp_type, int amt, String callback, dictionary callbackData, obj_id callbackId)
    {
        return grant(target, xp_type, amt, true, callback, callbackData, callbackId);
    }
    public static int grant(obj_id target, String xp_type, int amt, boolean verbose)
    {
        return grant(target, xp_type, amt, verbose, null, null, null);
    }
    public static int grant(obj_id target, String xp_type, int amt, boolean verbose, String callback, dictionary callbackData)
    {
        return grant(target, xp_type, amt, verbose, callback, callbackData, getSelf());
    }
    public static int grant(obj_id target, String xp_type, int amt, boolean verbose, String callback, dictionary callbackData, obj_id callbackId)
    {
    ...
    public static boolean grantUnmodifiedExperience(obj_id target, String xp_type, int amt)
    {
    ...
    public static boolean grantUnmodifiedExperience(obj_id target, String xp_type, int amt, String callback)
    {
        return grantUnmodifiedExperience(target, xp_type, amt, true, callback, new dictionary(), getSelf());
    }
    public static boolean grantUnmodifiedExperience(obj_id target, String xp_type, int amt, String callback, dictionary callbackData)
    {
        return grantUnmodifiedExperience(target, xp_type, amt, true, callback, callbackData, getSelf());
    }
    public static boolean grantUnmodifiedExperience(obj_id target, String xp_type, int amt, String callback, dictionary callbackData, obj_id callbackId)
    {
        return grantUnmodifiedExperience(target, xp_type, amt, true, callback, callbackData, callbackId);
    }
    public static boolean grantUnmodifiedExperience(obj_id target, String xp_type, int amt, boolean verbose, String callback, dictionary callbackData, obj_id callbackId)
    {
        if (!isIdValid(target) || (xp_type == null) || (xp_type.equals("")))
        {
            return false;
    ...
    public static boolean _grantUnmodifiedExperience(obj_id target, String xp_type, int amt, String callback, dictionary callbackData, obj_id callbackId)
    {
        int delta = 0;
    ...
    public static boolean grantCraftingXpChance(obj_id item, obj_id user, int chance)
    {
        if (!isIdValid(item))
        {
            return false;
    ...
    public static int applySpeciesXpModifier(obj_id target, String xp_type, int amt)
    {
    ...
    public static int applyGroupXpModifier(obj_id target, int amt)
    {
        float mod = 1f;
        int modAmt = amt;
        if (amt > 0)
    ...
    public static int applyInspirationBuffXpModifier(obj_id target, String xp_type, int amt)
    {
        if (amt > 0)
        {
    ...
    public static float getGroupXpModifier(obj_id target, int activeGroupSize)
    {
        float bonusMod = 1f;
    ...
    public static float getSpeciesXpModifier(obj_id target, String xp_type)
    {
        if (!isIdValid(target) || xp_type == null || xp_type.equals(""))
        {
            return 1f;
    ...
    public static float getInspirationBuffXpModifier(obj_id target, String xp_type)
    {
        float mod = 1f;
    ...
    public static void grantSquadLeaderXp(obj_id player, int amt)
    {
    ...
    public static void grantSquadLeaderXpResult(obj_id player, int granted, int amt)
    {
        if (granted > 0)
        {
    ...
    public static void notifySquadLeaderXp(obj_id player)
    {
    ...
    public static int getRawCombatXP(obj_id player, obj_id npc)
    {
    ...
    public static int getActiveGroupSize(obj_id gid)
    {
    ...
    public static String getWeaponXpType(int weapon_type)
    {
        String xp_type;
        switch (weapon_type)
        {
    ...
    public static String getWeaponStringFromXPType(String strXPType)
    {
        switch (strXPType) {
    ...
    public static boolean setupCreditForKills()
    {
        return true;
    }
    public static boolean cleanupCreditForKills()
    {
        utils.removeScriptVarTree(getSelf(), VAR_CREDIT_FOR_KILLS);
        return true;
    }
    public static void updateCombatXpList(obj_id target, obj_id attacker, obj_id wpn, int dam)
    {
    ...
    public static void updateCombatXpList(obj_id target, obj_id attacker, String xp_type, int dam)
    {
    ...
    public static void removeXpListCombatant(obj_id target, obj_id combatant)
    {
    ...
    public static void assessCombatResults(obj_id target)
    {
        if (!isIdValid(target))
        {
            return;
    ...
    public static obj_id[] getPlayersFromKillerList(obj_id[] killerList)
    {
    ...
    public static void grantQuestKillCredit(obj_id winner, obj_id target)
    {
        obj_id[] killList;
        if (group.isGroupObject(winner))
        {
    ...
    public static int updateGroupDamageDictionary(dictionary groupDamage, obj_id attacker, int attackerDamage, obj_id target)
    {
    ...
    public static obj_var[] grantCombatXp(obj_id target, obj_var[] killers)
    {
    ...
    public static void grantCombatXpPerAttackType(obj_id player, obj_id target, int totalXp)
    {
    ...
    public static int grantSocialStyleXp(obj_id player, String xpType, int amount)
    {
    ...
    public static int grantCraftingQuestXp(obj_id player, int amount)
    {
        String templateXp = skill_template.getTemplateSkillXpType(player, false);
        if (templateXp != null)
        {
    ...
    public static int grantCraftingStyleXp(obj_id player, String xpType, int amount)
    {
    ...
    public static int grantCombatStyleXp(obj_id player, String xpType, int amount)
    {
        float xpRatio = skill_template.NON_TEMPLATE_XP_RATIO;
    ...
    public static void displayXpMsg(obj_id player, String xpType, int amt)
    {
        if (xpType == null)
        {
    ...
    public static void displayXpFlyText(obj_id player, obj_id target, int amount)
    {
        if (amount == 0)
        {
            return;
    ...
    public static float getGroupXpModifierPercentageOfMax(float groupMod)
    {
        float groupModPct;
    ...
    public static float getCombatXpFlyScale(float groupModPct)
    {
    ...
    public static color getCombatXpFlyColor(float groupModPct)
    {
    ...
    public static boolean isCombatXpType(String xpType)
    {
        switch (xpType) {
            case COMBAT_GENERAL:
            case COMBAT_RANGEDSPECIALIZE_RIFLE:
    ...
    public static boolean isSocialXpType(String xpType)
    {
        switch (xpType) {
            case MUSIC:
            case DANCE:
    ...
    public static boolean isCraftingXpType(String xpType)
    {
        switch (xpType) {
    ...
    public static String[] getXpTypes(obj_id self)
    {
    ...
    public static void checkAndUpdateHuntingMissions(obj_id objPlayer, obj_id objCreature)
    {
    ...
    public static obj_id[] getTopIndividualAttacker(obj_var[] killers)
    {
    ...
    public static boolean displayForceSensitiveXP(obj_id player, String type)
    {
        if (!isIdValid(player))
        {
    ...
    public static prose_package getXpProsePackage(String xpType, int xpAmt)
    {
        return getXpProsePackage(xpType, xpAmt, 1f, 1f);
    }
    public static prose_package getXpProsePackage(String xpType, int xpAmt, float grpMod, float inspMod)
    {
    ...
    public static int grantXpByTemplate(obj_id player, int amount)
    {
    ...
    public static int grantUnmodifiedXpByTemplate(obj_id player, int amount)
    {
        String template = getSkillTemplate(player);
        String xpType;
        if (!isIdValid(player) || template == null)
    ...
    public static int grantUnmodifiedXPPercentageOfLevel(obj_id player, float percentage)
    {
    ...
    public static void applyHealingCredit(obj_id self)
    {
    ...
    public static void grantMissionXp(obj_id player, int missionLevel)
    {
    ...
    public static int getMissionXpAmount(obj_id player, int missionLevel)
    {
        int xpToGrant = 0;
        int playerLevel = getLevel(player);
    ...
    public static int grantCollectionXP(obj_id player, String collectionName)
    {
        float xpToGrant;
        int playerLevel = getLevel(player);
        if (playerLevel == 90)
    ...
    public static int grantCollectionSpaceXP(obj_id player, String collectionName)
    {
        if (!isValidId(player))
        {
            return 0;
    ...
    public static float repeatCollectionXpModifier(obj_id player, long repeatSlotValue)
    {
