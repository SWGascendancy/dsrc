...
public class dressup extends script.base_script
{
    ...
    public static void dressNpc(obj_id npc, String clothesTable)
    {
        dressNpc(npc, clothesTable, false);
    }
    public static void dressNpc(obj_id npc, String clothesTable, boolean override)
    {
    ...
    public static void equipNpcWeapon(obj_id npc, String weaponTable)
    {
    ...
    public static String chooseRandomWeapon(String weaponTable, int columnNumber)
    {
    ...
    public static void setSpecificHue(obj_id newClothes, int col, int row, String datatable)
    {
    ...
    public static void setWeaponDamage(obj_id npc, obj_id weapon)
    {
        if (npc == null)
        {
            return;
    ...
    public static boolean isClothesWearing(obj_id npc)
    {
    ...
    public static void giveHair(obj_id npc)
    {
