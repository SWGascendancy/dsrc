...
public class pclib extends script.base_script
{
    ...
    public static int getCloningSicknessCureCost(obj_id player)
    {
    ...
    public static boolean canAffordCloningSicknessCure(obj_id player)
    {
        return getCloningSicknessCureCost(player) <= getTotalMoney(player);
    }
    public static void cureCloningSickness(obj_id player)
    {
    ...
    public static obj_id grantWayPoint(obj_id player, obj_id target)
    {
    ...
    public static boolean giveTip(obj_id player, obj_id target, String targetName, int amt, boolean useCash)
    {
    ...
    public static int showTipSui(obj_id player, obj_id target, String targetName, int amt)
    {
    ...
    public static void cleanupTipSui(obj_id player)
    {
        if (!isIdValid(player))
        {
            return;
    ...
    public static void doTipLogging(obj_id player, obj_id target, int amt)
    {
        int trackTipNumIn = 0;
        int trackTipAmtIn = 0;
    ...
    public static boolean consent(obj_id player, obj_id target)
    {
    ...
    public static boolean unconsent(obj_id player, obj_id target)
    {
        if (!isIdValid(player) || !isIdValid(target))
        {
            return false;
    ...
    public static boolean hasConsent(obj_id player, obj_id target, boolean verbose)
    {
        if (!isIdValid(player) || !isIdValid(target))
        {
            return false;
    ...
    public static boolean hasConsent(obj_id player, obj_id target)
    {
        return hasConsent(player, target, false);
    }
    public static boolean relinquishConsents(obj_id player)
    {
    ...
    public static location getEffectiveDeathLocation(obj_id player)
    {
    ...
    public static void killPlayer(obj_id player, obj_id killer)
    {
        killPlayer(player, killer, true);
    }
    public static void killPlayer(obj_id player, obj_id killer, boolean usePVPRules)
    {
    ...
    public static void coupDeGrace(obj_id victim, obj_id killer, boolean playAnim)
    {
    ...
    public static void playDeathBlowAnimation(obj_id victim, obj_id killer)
    {
        if (!isIdValid(victim) || !isIdValid(killer))
        {
            return;
    ...
    public static boolean playerDeath(obj_id player, obj_id killer, boolean dueling)
    {
    ...
    public static void clearAllHate(obj_id self)
    {
    ...
    public static boolean playerRevive(obj_id player)
    {
        return playerRevive(player, getWorldLocation(player), getLocation(player), 0);
    }
    public static boolean playerRevive(obj_id player, location reviveLoc, location spawnLoc, int damage)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static boolean equipClone(obj_id player)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static boolean autoInsureItem(obj_id item) {
        return isIdValid(item) && setAutoInsured(item);
    }
    public static boolean resurrectPlayer(obj_id target)
    {
        return resurrectPlayer(target, false);
    }
    public static boolean resurrectPlayer(obj_id target, boolean playCloneAnimation)
    {
    ...
    public static boolean clearCombatData(obj_id target)
    {
        queueCommand(target, (-1465754503), target, "", COMMAND_PRIORITY_IMMEDIATE);
    ...
    public static boolean clearBuffData(obj_id target)
    {
        return buff.removeAllBuffs(target);
    }
    public static void trimLastKiller(obj_id self)
    {
    ...
    public static boolean checkCovertRespawn(obj_id player)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static void covertRespawn(obj_id player, String faction)
    {
        if (!isIdValid(player))
        {
            return;
    ...
    public static void destroyPlayerEquipment(obj_id player)
    {
        if (!isIdValid(player))
        {
            return;
    ...
    public static void destroyPlayerInventory(obj_id player)
    {
        if (!isIdValid(player))
        {
            return;
    ...
    public static void destroyPlayerBank(obj_id player)
    {
        if (!isIdValid(player))
        {
            return;
    ...
    public static void damageAndDecayItem(obj_id item, float percent)
    {
    }
    public static void damageAndDecayItem(obj_id item, int amount)
    {
    }
    public static boolean sendToCloneSpawn(obj_id player, String callback, location world, location spawn)
    {
    ...
    public static boolean sendToAnyLocation(obj_id player, location world, location interior)
    {
        if (player == null || world == null || !isPlayer(player))
        {
            return false;
    ...
    public static boolean sendToAnyLocation(obj_id player, String callback, location world, location interior)
    {
        if ((player == null) || (world == null) || (!isPlayer(player)))
        {
            return false;
    ...
    public static boolean sendToAnyLocation(obj_id player, location world, location interior, String interiorCell)
    {
        if ((player == null) || (world == null) || (!isPlayer(player)))
        {
            return false;
    ...
    public static boolean sendToAnyLocation(obj_id player, String callback, location world, location interior, String interiorCell)
    {
        if (player == null || world == null || !isPlayer(player))
        {
            return false;
    ...
    public static boolean clearEffectsForDeath(obj_id player)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static boolean isContainedByPlayer(obj_id player, obj_id item)
    {
    ...
    public static boolean msgAttachScript(obj_id player, String scriptName)
    {
    ...
    public static boolean msgDetachScript(obj_id player, String scriptName)
    {
        if ((player == null) || (scriptName.equals("")))
        {
            return false;
    ...
    public static boolean msgRemoveObjVar(obj_id player, String objVarName)
    {
    ...
    public static boolean msgGrantXP(obj_id player, String xpType, int xpAmount)
    {
    ...
    public static boolean notifyGM(obj_id player, int nc)
    {
        if (player == null)
        {
            return false;
    ...
    public static void requestWaypointDestroy(obj_id target, obj_id wp)
    {
    ...
    public static void requestWaypointRename(obj_id target, obj_id wp, String name)
    {
    ...
    public static void requestWaypointRename(obj_id target, obj_id wp, string_id sid_name)
    {
    ...
    public static String[] buildSortedResourceList(obj_id[] resources, String resourceClass, int branchLevel)
    {
    ...
    public static String createResourcePlanetReport(String[] resourceList, String planet, String resourceClass)
    {
