...
public class skill extends script.base_script
{
    ...
    public static boolean grant(obj_id target, String skillName)
    {
    ...
    public static boolean grantSkillToPlayer(obj_id player, String skillName)
    {
    ...
    public static boolean purchaseSkill(obj_id player, String skillName)
    {
        if (!isIdValid(player) || (!isPlayer(player)) || skillName == null || skillName.equals(""))
        {
            return false;
    ...
    public static boolean hasRequiredSkillsForSkillPurchase(obj_id player, String skillName) {
        if (!isIdValid(player) || (!isPlayer(player)) || skillName == null || skillName.equals("")) {
            return false;
        }
    ...
    public static boolean hasRequiredXpForSkillPurchase(obj_id player, String skillName)
    {
        if (!isIdValid(player) || (!isPlayer(player)) || skillName == null || skillName.equals(""))
        {
            return false;
    ...
    public static boolean deductXpCostForSkillPurchase(obj_id player, String skillName)
    {
        if (!isIdValid(player) || (!isPlayer(player)) || skillName == null || skillName.equals(""))
        {
            return false;
    ...
    public static String[] getAllRequiredSkills(String skillName)
    {
    ...
    public static boolean assignSkillTemplate(obj_id target, String template)
    {
    ...
    public static boolean revokeAllSkills(obj_id target)
    {
    ...
    public static void revokeAllProfessionSkills(obj_id player)
    {
    ...
    public static String[] getTeachableSkills(obj_id target, obj_id teacher)
    {
        return null;
    }
    public static String[] getQualifiedTeachableSkills(obj_id target, obj_id teacher)
    {
    ...
    public static String[] deltaTeacherSkills(obj_id target, obj_id teacher)
    {
    ...
    public static String[] getTeacherSkills(obj_id teacher, obj_id target)
    {
    ...
    public static String[] deltaPlayerTeacherSkills(obj_id target, obj_id teacher)
    {
        if (!isIdValid(target) || !isIdValid(teacher))
        {
            return null;
    ...
    public static int check(obj_id target, String skillmod, String scale)
    {
    ...
    public static dictionary skillModCheck(obj_id target, String skillmod, String scale)
    {
    ...
    public static int getGroupLevel(obj_id objPlayer)
    {
    ...
    public static void checkForJediAbility(obj_id objPlayer, String strSkill, int intDelay)
    {
    ...
    public static void updateJediSkillRequirements(obj_id player, Vector skillsNeeded)
    {
    ...
    public static void setJediSkills(obj_id objPlayer)
    {
    ...
    public static void fixTerrainNegotiationMods(obj_id player)
    {
    ...
    public static boolean noisyGrantSkill(obj_id player, String skillName)
    {
    ...
    public static void doPlayerLeveling(obj_id objPlayer, int intOldLevel, int intNewLevel)
    {
    ...
    public static void setPlayerStatsForLevel(obj_id objPlayer, int intLevel)
    {
        if (intLevel < 1)
        {
    ...
    public static int getPlayerStatForLevel(obj_id player, int intLevel, String statString)
    {
        int intStat = 0;
    ...
    public static void sendlevelUpStatChangeSystemMessages(obj_id player, int oldCombatLevel, int newCombatLevel)
    {
        if (!isPlayer(player))
        {
            return;
    ...
    public static String getProfessionName(String strTemplate)
    {
    ...
    public static void recalcPlayerPools(obj_id objPlayer, boolean boolHealEverything)
    {
    ...
    public static void grantAllPoliticianSkills(obj_id player)
    {
        String[] skillNames =
        {
    ...
    public static int getProfessionPhase(obj_id player)
    {
