...
public class ai_lib extends script.base_script
{
    ...
    public static boolean isWithinLeash(obj_id ai)
    {
    ...
    public static void resetCombatTriggerVolumes()
    {
        final obj_id self = getSelf();
    ...
    public static boolean isInCombat(obj_id ai)
    {
        return (getState(ai, STATE_COMBAT) == 1);
    }
    public static void setAttackable(obj_id npc, boolean val)
    {
        if (val)
        {
    ...
    public static boolean isAttackable(obj_id npc)
    {
        return hasObjVar(npc, OBJVAR_ATTACKABLE_OVERRIDE);
    }
    public static void setMood(obj_id npc, String mood)
    {
        if (getSelf() != npc)
        {
    ...
    public static void doAction(obj_id npc, String anim)
    {
        if (getSelf() != npc)
        {
            dictionary parms = new dictionary();
    ...
    public static void setPatrolPath(obj_id npc, String[] waypoints)
    {
        setPatrolPath(npc, waypoints, 0);
    }
    public static void setPatrolPath(obj_id npc, String[] waypoints, int startPoint)
    {
    ...
    public static void setPatrolOncePath(obj_id npc, String[] waypoints)
    {
        setPatrolOncePath(npc, waypoints, 0);
    }
    public static void setPatrolOncePath(obj_id npc, String[] waypoints, int startPoint)
    {
        if (isIdValid(npc) && waypoints != null)
        {
            location[] patrolLocs = parseWaypoints(npc, waypoints);
    ...
    public static void setPatrolRandomPath(obj_id npc, String[] waypoints)
    {
        if (isIdValid(npc) && waypoints != null)
        {
            location[] patrolLocs = parseWaypoints(npc, waypoints);
    ...
    public static void setPatrolRandomOncePath(obj_id npc, String[] waypoints)
    {
        if (isIdValid(npc) && waypoints != null)
        {
            location[] patrolLocs = parseWaypoints(npc, waypoints);
    ...
    public static void setPatrolFlipPath(obj_id npc, String[] waypoints)
    {
        setPatrolFlipPath(npc, waypoints, 0);
    }
    public static void setPatrolFlipPath(obj_id npc, String[] waypoints, int startPoint)
    {
        if (isIdValid(npc) && waypoints != null)
        {
            location[] patrolLocs = parseWaypoints(npc, waypoints);
    ...
    public static void setPatrolFlipOncePath(obj_id npc, String[] waypoints)
    {
        setPatrolFlipOncePath(npc, waypoints, 0);
    }
    public static void setPatrolFlipOncePath(obj_id npc, String[] waypoints, int startPoint)
    {
        if (isIdValid(npc) && waypoints != null)
        {
            location[] patrolLocs = parseWaypoints(npc, waypoints);
    ...
    public static void setPatrolPath(obj_id npc, location[] patrolLoc)
    {
        setPatrolPath(npc, patrolLoc, 0);
    }
    public static void setPatrolPath(obj_id npc, location[] patrolLoc, int startPoint)
    {
    ...
    public static void setPatrolOncePath(obj_id npc, location[] patrolLoc)
    {
        setPatrolOncePath(npc, patrolLoc, 0);
    }
    public static void setPatrolOncePath(obj_id npc, location[] patrolLoc, int startPoint)
    {
    ...
    public static void setPatrolRandomPath(obj_id npc, location[] patrolLoc)
    {
        if (isIdValid(npc) && patrolLoc != null)
        {
            utils.setScriptVar(npc, SCRIPTVAR_CACHED_PATROL_PATH, patrolLoc);
    ...
    public static void setPatrolRandomOncePath(obj_id npc, location[] patrolLoc)
    {
        if (isIdValid(npc) && patrolLoc != null)
        {
            utils.setScriptVar(npc, SCRIPTVAR_CACHED_PATROL_PATH, patrolLoc);
    ...
    public static void setPatrolFlipPath(obj_id npc, location[] patrolLoc)
    {
        setPatrolFlipPath(npc, patrolLoc, 0);
    }
    public static void setPatrolFlipPath(obj_id npc, location[] patrolLoc, int startPoint)
    {
        if (isIdValid(npc) && patrolLoc != null)
        {
            utils.setScriptVar(npc, SCRIPTVAR_CACHED_PATROL_PATH, patrolLoc);
    ...
    public static void setPatrolFlipOncePath(obj_id npc, location[] patrolLoc)
    {
        setPatrolFlipOncePath(npc, patrolLoc, 0);
    }
    public static void setPatrolFlipOncePath(obj_id npc, location[] patrolLoc, int startPoint)
    {
        if (isIdValid(npc) && patrolLoc != null)
        {
            utils.setScriptVar(npc, SCRIPTVAR_CACHED_PATROL_PATH, patrolLoc);
    ...
    public static void setPatrolNamedPath(obj_id npc, String[] patrolLoc)
    {
        setPatrolNamedPath(npc, patrolLoc, 0);
    }
    public static void setPatrolNamedPath(obj_id npc, String[] patrolLoc, int startPoint)
    {
        if (isIdValid(npc) && patrolLoc != null)
        {
    ...
    public static void setPatrolOnceNamedPath(obj_id npc, String[] patrolLoc)
    {
        setPatrolOnceNamedPath(npc, patrolLoc, 0);
    }
    public static void setPatrolOnceNamedPath(obj_id npc, String[] patrolLoc, int startPoint)
    {
        if (isIdValid(npc) && patrolLoc != null)
        {
            utils.setScriptVar(npc, SCRIPTVAR_CACHED_PATROL_NAMED_PATH, patrolLoc);
    ...
    public static void setPatrolRandomNamedPath(obj_id npc, String[] patrolLoc)
    {
        if (isIdValid(npc) && patrolLoc != null)
        {
            if (!exists(npc))
    ...
    public static void setPatrolRandomOnceNamedPath(obj_id npc, String[] patrolLoc)
    {
        if (isIdValid(npc) && patrolLoc != null)
        {
            utils.setScriptVar(npc, SCRIPTVAR_CACHED_PATROL_NAMED_PATH, patrolLoc);
    ...
    public static void setPatrolFlipNamedPath(obj_id npc, String[] patrolLoc)
    {
        setPatrolFlipNamedPath(npc, patrolLoc, 0);
    }
    public static void setPatrolFlipNamedPath(obj_id npc, String[] patrolLoc, int startPoint)
    {
        if (isIdValid(npc) && patrolLoc != null)
        {
            utils.setScriptVar(npc, SCRIPTVAR_CACHED_PATROL_NAMED_PATH, patrolLoc);
    ...
    public static void setPatrolFlipOnceNamedPath(obj_id npc, String[] patrolLoc)
    {
        setPatrolFlipOnceNamedPath(npc, patrolLoc, 0);
    }
    public static void setPatrolFlipOnceNamedPath(obj_id npc, String[] patrolLoc, int startPoint)
    {
        if (isIdValid(npc) && patrolLoc != null)
        {
            utils.setScriptVar(npc, SCRIPTVAR_CACHED_PATROL_NAMED_PATH, patrolLoc);
    ...
    public static void clearPatrolPath(obj_id npc)
    {
        if (isIdValid(npc))
        {
    ...
    public static void resumePatrol(obj_id npc)
    {
    ...
    public static boolean canPatrol(obj_id npc) {
        return isIdValid(npc) && utils.hasScriptVar(npc, SCRIPTVAR_CACHED_PATROL_TYPE);
    }
    public static location[] parseWaypoints(obj_id npc, String[] waypoints)
    {
        if (!isIdValid(npc) || waypoints == null)
        {
            return null;
    ...
    public static float[] parseWaypoints(String text)
    {
    ...
    public static void setIgnoreCombat(obj_id npc)
    {
        setWantSawAttackTriggers(npc, false);
    }
    public static void barkString(obj_id npc, String text)
    {
    ...
    public static boolean isAnimal(obj_id npc)
    {
        return isMonster(npc);
    }
    public static boolean isMonster(obj_id npc)
    {
    ...
    public static boolean isDroid(obj_id npc)
    {
        return aiGetNiche(npc) == NICHE_DROID;
    }
    public static boolean isPredator(obj_id npc)
    {
        return aiGetNiche(npc) == NICHE_PREDATOR;
    }
    public static boolean isCarnivore(obj_id npc)
    {
        return aiGetNiche(npc) == NICHE_CARNIVORE;
    }
    public static boolean isHerbivore(obj_id npc)
    {
        return aiGetNiche(npc) == NICHE_HERBIVORE;
    }
    public static boolean isVehicle(obj_id npc)
    {
        return aiGetNiche(npc) == NICHE_VEHICLE;
    }
    public static boolean isAndroid(obj_id npc)
    {
        return aiGetNiche(npc) == NICHE_ANDROID;
    }
    public static boolean isHumanoid(obj_id target)
    {
        int niche = aiGetNiche(target);
        return isPlayer(target) || niche == NICHE_NPC || niche == NICHE_ANDROID;
    }
    public static boolean isNpc(obj_id npc)
    {
        return (aiGetNiche(npc) == NICHE_NPC);
    }
    public static boolean isTurret(obj_id npc)
    {
        return isGameObjectTypeOf(getGameObjectType(npc), GOT_installation_turret);
    }
    public static void setIgnoreCombat(obj_id npc, boolean b)
    {
        setWantSawAttackTriggers(npc, b);
    }
    public static void setDefaultCalmBehavior(obj_id npc, int behavior)
    {
    ...
    public static void greet(obj_id ai, obj_id player)
    {
    ...
    public static void dismiss(obj_id ai, obj_id player)
    {
    ...
    public static boolean aiIsDead(obj_id npc)
    {
        return isAiDead(npc);
    }
    public static boolean isAiDead(obj_id npc) {
        if (!isMob(npc)) {
            return (isDisabled(npc));
        }
        return isIncapacitated(npc) || isDead(npc);
    }
    public static void aiFollow(obj_id npc, obj_id target)
    {
        aiFollow(npc, target, DEFAULT_FOLLOW_MIN, DEFAULT_FOLLOW_MAX);
    }
    public static void aiFollow(obj_id npc, obj_id target, float min_dist, float max_dist)
    {
        if (target == npc)
        {
    ...
    public static boolean isFollowing(obj_id npc) {
        return isIdValid(npc) && hasObjVar(npc, "ai.persistantFollowing");
    }
    public static obj_id getFollowTarget(obj_id npc)
    {
        if (!isIdValid(npc))
        {
            return null;
    ...
    public static void resumeFollow(obj_id npc)
    {
        if (!isIdValid(npc))
        {
            return;
    ...
    public static void aiStopFollowing(obj_id npc)
    {
        stop(npc);
    ...
    public static String getMood(obj_id npc)
    {
    ...
    public static void pathNear(obj_id npc, location dest, float range)
    {
    ...
    public static void followInFormation(obj_id npc, obj_id leader, int formationType, int position)
    {
        if (npc == leader)
        {
    ...
    public static void resumeFormationFollowing(obj_id npc)
    {
        if (isInCombat(npc))
        {
            return;
    ...
    public static void followInWedgeFormation(obj_id npc, obj_id leader, int position)
    {
        if (npc == leader)
        {
    ...
    public static void followInBoxFormation(obj_id npc, obj_id leader, int position)
    {
        if (npc == leader)
        {
    ...
    public static void followInLineFormation(obj_id npc, obj_id leader, int position)
    {
        if (npc == leader)
        {
            debugServerConsoleMsg(npc, npc + " was told to followInLineFormation itself");
    ...
    public static void followInColumnFormation(obj_id npc, obj_id leader, int position)
    {
        if (npc == leader)
        {
    ...
    public static void pathAwayFrom(obj_id npc, obj_id target)
    {
    ...
    public static void setLoiterRanges(obj_id npc, float minRange, float maxRange)
    {
        setObjVar(npc, "ai.loiterMinRange", minRange);
        setObjVar(npc, "ai.loiterMaxRange", maxRange);
    }
    public static int aiGetSpecies(obj_id npc)
    {
        return getSpecies(npc);
    }
    public static void setCustomIdleAnimation(obj_id npc, String animationString)
    {
        setDefaultCalmMood(npc, animationString);
    }
    public static void setDefaultCalmMood(obj_id npc, String mood)
    {
    ...
    public static int getDefaultCalmBehavior(obj_id ai)
    {
    ...
    public static void aiPathTo(obj_id npc, location pathLoc)
    {
    ...
    public static int aiGetNiche(obj_id npc)
    {
        if (isPlayer(npc))
        {
            return NICHE_PC;
    ...
    public static int aiGetNiche(String creatureName)
    {
    ...
    public static String getSocialGroup(obj_id npc)
    {
        String creatureName = getCreatureName(npc);
    ...
    public static boolean isSameSocialGroup(obj_id npc, obj_id target)
    {
    ...
    public static boolean isHerdingCreature(obj_id npc) {
    ...
    public static boolean isStalkingCreature(obj_id ai) {
    ...
    public static boolean isAggroToward(obj_id npc, obj_id threat)
    {
    ...
    public static boolean isAggro(obj_id ai)
    {
        if (isPlayer(ai))
        {
            return false;
    ...
    public static boolean isHealingNpc(obj_id npc) {
        if (isPlayer(npc)) {
            return false;
        }
    ...
    public static boolean incapacitateMob(obj_id target)
    {
    ...
    public static boolean isHumanSkeleton(obj_id npc) {
        if (isPlayer(npc)) {
            return true;
        }
    ...
    public static String getSkeleton(int speciesNum)
    {
        if (speciesNum == -1)
        {
            return null;
    ...
    public static String getSkeleton(obj_id npc)
    {
        int speciesNum = ai_lib.aiGetSpecies(npc);
    ...
    public static void doThreatenAnimation(obj_id npc)
    {
    ...
    public static void doVictoryDance(obj_id npc)
    {
        if (ai_lib.isMonster(npc))
        {
            if (rand(1, 500) == 1)
    ...
    public static obj_id getLair(obj_id npc)
    {
        if (isPlayer(npc))
        {
            return null;
    ...
    public static int aiGetApproachTriggerRange(obj_id npc)
    {
        return (int)aiGetAggroRadius(npc);
    }
    public static void aiSetPosture(obj_id npc, int newPosture)
    {
    ...
    public static String getAttackString(int hash)
    {
        if (hash == 0)
        {
    ...
    public static String getMilkType(obj_id npc)
    {
        String creatureName = getCreatureName(npc);
        if (creatureName == null)
        {
    ...
    public static boolean checkForSmuggler(obj_id player)
    {
    ...
    public static boolean checkForJedi(obj_id player)
    {
    ...
    public static boolean setupNpc(obj_id npc, boolean conversable, boolean invulnerable)
    {
        return setupNpc(npc, null, conversable, invulnerable);
    }
    public static boolean setupNpc(obj_id npc, String name, boolean conversable, boolean invulnerable)
    {
    ...
    public static void establishAgroLink(obj_id subject, float range)
    {
    ...
    public static void establishAgroLink(obj_id subject, obj_id[] allies)
    {
    ...
    public static void triggerAgroLinks(obj_id subject, obj_id attacker)
    {
    ...
    public static void creatureLevelUp(obj_id creature, obj_id victim)
    {
    ...
    public static boolean mindTrick(obj_id player, obj_id target)
    {
        int niche = aiGetNiche(target);
    ...
    public static boolean isTauntable(obj_id creature)
    {
        return !utils.hasScriptVar(creature, "combat.immune.taunt");
    }
    public static void establishSharedHealth(Vector allies)
    {
    ...
    public static int triggerSharedHealthLink(obj_id self, int totalDamage)
    {
    ...
    public static int getDifficultyClass(obj_id target)
    {
    ...
    public static boolean isVehicleMine(obj_id self)
    {
