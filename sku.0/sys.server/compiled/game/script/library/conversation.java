...
public class conversation extends script.base_script
{
    ...
    public static void echoToGroup(obj_id player, obj_id actor, obj_id target, string_id sid)
    {
    ...
    public static void echoToGroup(obj_id player, obj_id actor, obj_id target, prose_package pp)
    {
        if (!group.isGrouped(player))
        {
            return;
