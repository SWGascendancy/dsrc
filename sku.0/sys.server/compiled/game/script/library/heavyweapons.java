...
public class heavyweapons extends script.base_script
{
    ...
    public static int getHeavyWeaponType(obj_id weapon)
    {
    ...
    public static boolean fillHeavyWeaponData(weapon_data dat)
    {
    ...
    public static boolean canFireHeavyWeapon(obj_id player, weapon_data weapon)
    {
    ...
    public static float getDemolitionShotDamageMod(obj_id attacker, obj_id defender, String actionName)
    {
        float mult = 1.05f;
    ...
    public static obj_id[] getAllHeavyWeaponTargets(obj_id attacker, obj_id defender, weapon_data weapon, dictionary actionData)
    {
    ...
    public static void finalizeHeavyWeaponAttack(attacker_data attacker, defender_data[] defenders, weapon_data weapon)
    {
    ...
    public static effect_data doHeavyWeaponDefenderEffect(attacker_data attacker, defender_data defender, weapon_data weapon)
    {
    ...
    public static effect_data _doLauncherPistolAttack(attacker_data attacker, defender_data defender, weapon_data weapon)
    {
        return new effect_data();
    }
    public static effect_data _doLavaCannonAttack(attacker_data attacker, defender_data defender, weapon_data weapon)
    {
        return new effect_data();
    }
    public static effect_data _doRocketLauncherAttack(attacker_data attacker, defender_data defender, weapon_data weapon)
    {
        effect_data dat = new effect_data();
        dat.posture = POSTURE_KNOCKED_DOWN;
        return dat;
    }
    public static effect_data _doFlameThrowerAttack(attacker_data attacker, defender_data defender, weapon_data weapon)
    {
    ...
    public static effect_data _doHeavyParticleBeamAttack(attacker_data attacker, defender_data defender, weapon_data weapon)
    {
        return new effect_data();
    }
    public static effect_data _doAcidRifleAttack(attacker_data attacker, defender_data defender, weapon_data weapon)
    {
        effect_data dat = new effect_data();
        dat.states = new int[]
        {
    ...
    public static effect_data _doHeavyAcidBeamAttack(attacker_data attacker, defender_data defender, weapon_data weapon)
    {
        effect_data dat = new effect_data();
        dat.states = new int[]
        {
    ...
    public static effect_data _doLightningBeamCanonAttack(attacker_data attacker, defender_data defender, weapon_data weapon)
    {
    ...
    public static void _applyHealthStatFireDot(attacker_data attacker, defender_data defender, weapon_data weapon)
    {
        int duration = 0;
        int potency = 0;
        int strength = 0;
    ...
    public static String getHeavyWeaponDotName(obj_id player, obj_id weapon, boolean singleTarget)
    {
    ...
    public static String getHeavyWeaponDotName(obj_id player, weapon_data weaponData, boolean singleTarget)
    {
