...
public class cts extends script.base_script
{
    ...
    public static boolean grantPackagedPainting(obj_id sponsorGiftBox, obj_id anyPlayer)
    {
    ...
    public static String getCtsInscription(obj_id object)
    {
    ...
    public static boolean initializeCtsObject(obj_id object)
    {
    ...
    public static void initiateCtsFromItem(obj_id player, obj_id item)
    {
