...
public class gcw extends script.base_script
{
    ...
    public static void assignScanInterests(obj_id npc)
    {
    ...
    public static float scan(obj_id scanner, obj_id target)
    {
    ...
    public static boolean isContrabandItem(obj_id item)
    {
        if (!isIdValid(item))
        {
            return false;
    ...
    public static float getContrabandRating(obj_id target, int interests)
    {
    ...
    public static float getContrabandRating(obj_id target)
    {
        obj_id self = getSelf();
        int interests = utils.getIntScriptVar(self, SCRIPTVAR_SCAN_INTEREST);
        return getContrabandRating(target, interests);
    }
    public static boolean isSpice(obj_id target)
    {
        if (!isIdValid(target))
        {
            return false;
    ...
    public static boolean isSlicedEquipment(obj_id target)
    {
        if (!isIdValid(target))
        {
            return false;
    ...
    public static boolean isNonImperialFactionItem(obj_id target)
    {
        if (!isIdValid(target))
        {
            return false;
    ...
    public static void harass(obj_id npc, obj_id target)
    {
        if (!isIdValid(npc))
        {
            return;
    ...
    public static boolean spawnViaLambda(location loc, String tbl, String column, dictionary params)
    {
    ...
    public static boolean spawnViaLambda(location loc, String tbl, int col, dictionary params)
    {
    ...
    public static boolean createLambdaDropship(location loc, String[] spawnNames, dictionary params)
    {
    ...
    public static boolean spawnViaLambdaPerGeo(location loc, dictionary params)
    {
        if (loc == null)
        {
            return false;
    ...
    public static String[] getGeoSpawnNames(location loc, boolean allowHeavy)
    {
        if (loc == null)
        {
            return null;
    ...
    public static String[] getGeoSpawnNames(location loc)
    {
        return getGeoSpawnNames(loc, false);
    }
    public static obj_id getGCWMasterObject(obj_id objObject)
    {
    ...
    public static void changeGCWScore(location locTest, int intValue, String strFaction)
    {
    ...
    public static void incrementGCWScore(obj_id objObject)
    {
    ...
    public static void decrementGCWScore(obj_id objObject)
    {
        location locTest = getLocation(objObject);
        int intScoreChange = faction_perk.grabFactionBasePointValue(objObject);
    ...
    public static boolean canPlaceFactionBaseByPlanet(obj_id player, obj_id deed, String planet)
    {
    ...
    public static boolean canPlaceFactionBaseByScore(obj_id player, obj_id deed, String planet)
    {
        return (getCurrentPlanetaryFactionBaseCountPlanet(planet) < getCurrentPlanetaryFactionBaseMaxPlanet(planet));
    }
    public static int getCurrentPlanetaryFactionBaseCountPlanet(String planet)
    {
    ...
    public static int getCurrentPlanetaryFactionBaseMaxPlanet(String planet)
    {
        obj_id planetId = getPlanetByName(planet);
        if (!isIdValid(planetId))
        {
    ...
    public static boolean isGcwRestrictedSceneName(String scene)
    {
    ...
    public static dictionary getGCWDictionary(obj_id self)
    {
    ...
    public static float getImperialRatio(obj_id objNPC)
    {
    ...
    public static float getRebelRatio(obj_id objNPC)
    {
        float fltImperialControlScore = (float)getIntObjVar(objNPC, "Imperial.controlScore");
        float fltRebelControlScore = (float)getIntObjVar(objNPC, "Rebel.controlScore");
        if ((fltImperialControlScore == 0) && (fltRebelControlScore == 0))
    ...
    public static void incrementGCWStanding(obj_id killer, obj_id target)
    {
        obj_id self = killer;
    ...
    public static void checkAndUpdateGCWStanding(obj_id self, int intAddedPoints)
    {
    ...
    public static void setPub30StaticBaseTimeSinceLastCapture(obj_id subject, int time)
    {
        obj_id controller = getPub30StaticBaseControllerId(subject);
    ...
    public static int getPub30StaticBaseCapturePhase(obj_id subject)
    {
    ...
    public static int getPub30TimeToNextPhaseInt(obj_id subject)
    {
        int lastCapture = getPub30StaticBaseTimeSinceLastCapture(subject);
    ...
    public static String getPub30TimeToNextPhaseString(obj_id subject)
    {
        int timeToNext = getPub30TimeToNextPhaseInt(subject);
        return utils.formatTimeVerbose(timeToNext);
    }
    public static int advancePub30StaticBaseCapturePhase(obj_id subject)
    {
    ...
    public static int regressPub30StaticBaseCapturePhase(obj_id subject)
    {
        int currentPhase = getPub30StaticBaseCapturePhase(subject);
        if (currentPhase == 1)
        {
    ...
    public static int findAttackerInArray(Vector attackList, obj_id attacker)
    {
    ...
    public static int getDamageFromAttacker(Vector attackList, obj_id attacker)
    {
        if (attackList == null || attackList.size() == 0)
        {
            return 0;
    ...
    public static void notifyPvpRegionWatcherOfDeath(obj_id player)
    {
    ...
    public static boolean isAlreadyInArray(String[] orderedList, String attackerEntry)
    {
    ...
    public static int distributeIndividualContribution(obj_id victim, String playerString, int totalDamage, int point_type)
    {
    ...
    public static int distributeIndividualContribution(obj_id victim, obj_id enemy, int totalDamage, int point_type)
    {
    ...
    public static int addToDailyGcwPointAllotment(obj_id victim, obj_id killer, int gcwPoint)
    {
    ...
    public static void removeDayOldEntries(obj_id player)
    {
    ...
    public static String packKillerDailyPoints(obj_id player, int gcwPoint, int time)
    {
        return ("" + player + "-" + gcwPoint + "-" + time);
    }
    public static int getTimeOfFirstAward(String killRecord)
    {
        String[] parse = split(killRecord, '-');
        return utils.stringToInt(parse[2]);
    }
    public static int getAccruedPoints(Vector attackList, obj_id attacker)
    {
        if (attackList == null || attackList.size() == 0)
        {
            return 0;
    ...
    public static int getAccruedPoints(String killRecord)
    {
        String[] parse = split(killRecord, '-');
        return utils.stringToInt(parse[1]);
    }
    public static void grantModifiedGcwPoints(obj_id victim, obj_id[] attackers, boolean pvpKill, int point_type, String information)
    {
        if (!isIdValid(victim))
        {
            return;
    ...
    public static void grantModifiedGcwPoints(obj_id attacker, int pointValue, int point_type, String information)
    {
    ...
    public static void grantModifiedGcwPoints(obj_id victim, obj_id attacker, boolean pvpKill, int point_type, String information)
    {
    ...
    public static void grantModifiedGcwPoints(obj_id victim, obj_id attacker, int pointValue, boolean pvpKill, int point_type, String information)
    {
        pointValue = getModifiedGcwPointValue(attacker, pointValue);
        _grantGcwPoints(victim, attacker, pointValue, pvpKill, point_type, information);
    }
    public static void grantUnmodifiedGcwPoints(obj_id attacker, int pointValue)
    {
        _grantGcwPoints(null, attacker, pointValue, false, -1, "");
    }
    public static void _grantGcwPoints(obj_id victim, obj_id attacker, int pointValue, boolean pvpKill, int pointType, String information)
    {
    ...
    public static void doGcwPointCsLogging(obj_id player, int pointValue, int pointType, String information)
    {
        switch (pointType)
        {
    ...
    public static String getGcwCategory(int pointType)
    {
    ...
    public static String getGcwRegion(obj_id target)
    {
    ...
    public static void grantGcwPointsToRegion(obj_id player, int pointValue, int pointType)
    {
    ...
    public static int getImperialPercentileByRegion(obj_id target)
    {
        if (!isIdValid(target) || !exists(target))
        {
            return 50;
    ...
    public static int getRebelPercentileByRegion(obj_id target)
    {
        return 100 - getImperialPercentileByRegion(target);
    }
    public static String getRegionFactionOwner(obj_id target)
    {
        String category = getGcwRegion(target);
        if (category == null || category.length() <= 0)
        {
    ...
    public static boolean verifyPvpRegionStatus(obj_id player)
    {
    ...
    public static int getNpcKillCredit(obj_id npc, obj_id player)
    {
    ...
    public static int getModifiedGcwPointValue(obj_id player, int passedValue)
    {
        float mod = 1.0f;
    ...
    public static void registerPvpRegionControllerWithPlanet(obj_id controlObject, String regionName)
    {
    ...
    public static obj_id getPvpRegionControllerIdByName(obj_id player, String regionName)
    {
    ...
    public static obj_id getPvpRegionControllerIdByPlayer(obj_id player)
    {
    ...
    public static void notifyPvpRegionControllerOfPlayerEnter(obj_id controllerId, obj_id player)
    {
        dictionary dict = new dictionary();
        dict.put("player", player);
    ...
    public static void makeBattlefieldRegion(obj_id controller)
    {
    ...
    public static void makePushbackRegion(obj_id controller)
    {
        if (!isIdValid(controller))
        {
    ...
    public static obj_id getPushbackControllerByPlayer(obj_id player)
    {
        return getPvpRegionControllerIdByPlayer(player);
    }
    public static void grantSpacePvpKillCredit(obj_id defender, obj_id[] attackers)
    {
    ...
    public static boolean validateSpaceTier(obj_id defender, obj_id attacker)
    {
    ...
    public static void grantBaseDestructionPoints(obj_id base)
    {
    ...
    public static int getGcwGroundQuestAward(obj_id player, int quest_tier)
    {
    ...
    public static float getGroundQuestTierBonus(int quest_tier)
    {
    ...
    public static region getPvPRegion(obj_id controller)
    {
    ...
    public static void getRegionToRegister(obj_id controller)
    {
        if (!isIdValid(controller))
        {
            return;
    ...
    public static boolean isPlayerValidOnBattlefield(obj_id player, obj_id controller)
    {
        return true;
    }
    public static String getBattlefieldRegionName(obj_id controller)
    {
        if (!isIdValid(controller))
        {
            return null;
    ...
    public static String getPushbackRegionName(obj_id controller)
    {
        if (!isIdValid(controller))
        {
            return null;
    ...
    public static boolean canEntertainGcwNonPlayingCharacter(obj_id player, obj_id npc)
    {
    ...
    public static boolean setEntertainGcwNonPlayerCharacter(obj_id player, obj_id npc)
    {
        if (!isValidId(player) || !exists(player))
        {
            return false;
    ...
    public static boolean canGcwObjectBeRepaired(obj_id object)
    {
    ...
    public static boolean useGcwObjectForQuest(obj_id player, obj_id gcwObject, String questName)
    {
    ...
    public static boolean repairGcwObject(obj_id object, obj_id player, int resourceCount)
    {
        if (!isValidId(object) || !exists(object))
        {
            return false;
    ...
    public static void playQuestIconParticle(obj_id self)
    {
    ...
    public static void playQuestIconHandler(obj_id self, dictionary params)
    {
    ...
    public static boolean signalAllParticipantsForDamage(obj_id victimObject, String questName, String signalHasName, String signalSendName)
    {
    ...
    public static boolean hasConstructionOrRepairTool(obj_id player, obj_id object)
    {
    ...
    public static boolean useConstructionOrRepairTool(obj_id player, obj_id object)
    {
        if (!isValidId(player) || !exists(player))
        {
            return false;
    ...
    public static int getGcwCityInvasionPhase(obj_id childObject)
    {
    ...
    public static boolean playerSystemMessageResourceNeeded(obj_id player, obj_id object, boolean construction)
    {
        if (!isValidId(player) || !exists(player))
        {
            return false;
    ...
    public static int getFatigueTimerMod(obj_id player)
    {
    ...
    public static obj_id getInvasionSequencerNearby(obj_id target)
    {
        if (!isIdValid(target) || !exists(target))
        {
            return null;
    ...
    public static String getCityFromTable(obj_id self)
    {
        String cityName = "";
    ...
    public static boolean awardGcwInvasionParticipants(Vector participantList, int factionFlag, int gcwTokenAmt, int gcwPointAmt, dictionary finalAnnouncementParams)
    {
    ...
    public static boolean invasionIsValidAndEngaged()
    {
        obj_id self = getSelf();
    ...
    public static void gcwSetCredits(obj_id who, int playerGCW, int playerPvpKills, int playerKills, int playerAssists, int playerCraftedItems, int playerDestroyedItems)
    {
    ...
    public static void gcwInvasionCreditForGCW(obj_id who, int gcw)
    {
    ...
    public static void gcwInvasionCreditForPVPKill(obj_id who)
    {
        if (!invasionIsValidAndEngaged())
        {
            return;
    ...
    public static void gcwInvasionCreditForKill(obj_id who)
    {
        if (!invasionIsValidAndEngaged())
        {
            return;
    ...
    public static void gcwInvasionCreditForAssist(obj_id who)
    {
        if (!invasionIsValidAndEngaged())
        {
            return;
    ...
    public static void gcwInvasionCreditForCrafting(obj_id who)
    {
        if (!invasionIsValidAndEngaged())
        {
            return;
    ...
    public static void gcwInvasionCreditForDestroy(obj_id who)
    {
        if (!invasionIsValidAndEngaged())
        {
            return;
    ...
    public static String getFormattedInvasionTime(obj_id self, int phase)
    {
    ...
    public static int gcwGetInvasionMaximumRunning()
    {
    ...
    public static boolean gcwIsInvasionCityOn(String city)
    {
    ...
    public static int gcwGetNextInvasionHour(String cityName)
    {
    ...
    public static boolean gcwHasInvasionInCycle(String cityName, int cycle)
    {
    ...
    public static String[] gcwGetActiveCities()
    {
    ...
    public static int gcwGetActiveCityCount()
    {
        return gcwGetActiveCities().length;
    }
    public static int gcwCalculateInvasionCycle()
    {
    ...
    public static int gcwGetNextInvasionTime(String cityName)
    {
    ...
    public static boolean gcwTutorialCheck(obj_id player)
    {
        if (!isValidId(player) || !exists(player))
        {
            return false;
    ...
    public static boolean gcwCityHelpText(obj_id player)
    {
        if (!isValidId(player) || !exists(player))
        {
            return false;
