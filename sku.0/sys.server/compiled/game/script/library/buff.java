...
public class buff extends script.base_script
{
    ...
    public static boolean isParalyzed(obj_id target)
    {
    ...
    public static boolean canApplyBuff(obj_id target, String name)
    {
        return canApplyBuff(target, null, getStringCrc(name.toLowerCase()));
    }
    public static boolean canApplyBuff(obj_id target, obj_id owner, String name)
    {
        return canApplyBuff(target, owner, getStringCrc(name.toLowerCase()));
    }
    public static boolean canApplyBuff(obj_id target, int nameCrc)
    {
    ...
    public static boolean applyBuff(obj_id target, obj_id owner, String name)
    {
        return applyBuff(target, owner, getStringCrc(name.toLowerCase()), 0.0f, 0.0f);
    }
    public static boolean[] applyBuff(obj_id[] targets, String name)
    {
    ...
    public static boolean[] applyBuff(obj_id target, String[] buffList)
    {
    ...
    public static boolean[][] applyBuff(obj_id[] targets, String[] buffList)
    {
    ...
    public static boolean[] applyBuff(obj_id[] targets, obj_id caster, String buffName)
    {
        boolean[] results = new boolean[targets.length];
        for (int i = 0; i < targets.length; i++)
        {
    ...
    public static boolean applyBuff(obj_id target, int[] nameCrcs)
    {
    ...
    public static boolean applyBuff(obj_id target, int nameCrc)
    {
        return applyBuff(target, null, nameCrc, 0.0f, 0.0f);
    }
    public static boolean applyBuff(obj_id target, obj_id owner, int nameCrc)
    {
        return applyBuff(target, owner, nameCrc, 0.0f, 0.0f);
    }
    public static boolean applyBuffWithStackCount(obj_id target, String name, int stack)
    {
        return applyBuff(target, null, getStringCrc(name.toLowerCase()), 0.0f, 0.0f, stack);
    }
    public static boolean applyBuffWithStackCount(obj_id target, obj_id owner, String name, int stack)
    {
        return applyBuff(target, owner, getStringCrc(name.toLowerCase()), 0.0f, 0.0f, stack);
    }
    public static boolean applyBuff(obj_id target, String name, float duration)
    {
        return applyBuff(target, null, getStringCrc(name.toLowerCase()), duration, 0.0f);
    }
    public static boolean applyBuff(obj_id target, obj_id owner, String name, float duration)
    {
        return applyBuff(target, owner, getStringCrc(name.toLowerCase()), duration, 0.0f);
    }
    public static boolean applyBuff(obj_id target, int nameCrc, float duration)
    {
        return applyBuff(target, null, nameCrc, duration, 0.0f);
    }
    public static boolean applyBuff(obj_id target, obj_id owner, int nameCrc, float duration)
    {
        return applyBuff(target, owner, nameCrc, duration, 0.0f);
    }
    public static boolean applyBuff(obj_id target, String name, float duration, float customValue)
    {
        return applyBuff(target, null, getStringCrc(name.toLowerCase()), duration, customValue);
    }
    public static boolean applyBuff(obj_id target, obj_id owner, String name, float duration, float customValue)
    {
        return applyBuff(target, owner, getStringCrc(name.toLowerCase()), duration, customValue);
    }
    public static boolean applyBuff(obj_id target, int nameCrc, float duration, float customValue)
    {
        return applyBuff(target, null, nameCrc, duration, customValue);
    }
    public static boolean applyBuff(obj_id target, obj_id owner, int nameCrc, float duration, float customValue)
    {
        return applyBuff(target, owner, nameCrc, duration, customValue, 1);
    }
    public static boolean applyBuff(obj_id target, obj_id owner, int nameCrc, float duration, float customValue, int stack)
    {
    ...
    public static boolean removeBuff(obj_id target, String name)
    {
        return removeBuff(target, getStringCrc(name.toLowerCase()));
    }
    public static boolean removeBuffs(obj_id target, Vector names)
    {
    ...
    public static boolean removeBuffs(obj_id target, String[] names)
    {
        boolean success = true;
    ...
    public static boolean removeBuff(obj_id target, int nameCrc)
    {
        if (!isIdValid(target))
        {
            return false;
    ...
    public static boolean removeAllBuffs(obj_id target)
    {
        return removeAllBuffs(target, false);
    }
    public static boolean removeAllBuffs(obj_id target, boolean fromDeath)
    {
        return removeAllBuffs(target, fromDeath, false);
    }
    public static boolean removeAllBuffs(obj_id target, boolean fromDeath, boolean fromRespec)
    {
        if (!isIdValid(target))
        {
            return false;
    ...
    public static boolean removeAllDebuffsByOwner(obj_id target, obj_id owner)
    {
    ...
    public static int[] getAllBuffsByEffect(obj_id target, String effect)
    {
    ...
    public static int[] getAllBuffs(obj_id target)
    {
        if (!isIdValid(target))
        {
            return null;
    ...
    public static boolean hasBuff(obj_id target)
    {
        int[] buffCRCs = _getAllBuffs(target);
        if (buffCRCs == null || buffCRCs.length == 0)
        {
    ...
    public static boolean hasBuff(obj_id target, String name)
    {
        return _hasBuff(target, getStringCrc(name.toLowerCase()));
    }
    public static boolean hasBuff(obj_id target, int nameCrc)
    {
        return _hasBuff(target, nameCrc);
    }
    public static boolean hasAnyBuffInList(obj_id target, String buffList)
    {
    ...
    public static boolean refreshAllBuffs(obj_id target)
    {
    ...
    public static String getBuffNameFromCrc(int nameCrc)
    {
        buff_data bdata = combat_engine.getBuffData(nameCrc);
        if (bdata == null)
        {
    ...
    public static int getGroupOne(String name)
    {
        return getGroupOne(getStringCrc(name.toLowerCase()));
    }
    public static int getGroupOne(int nameCrc)
    {
        buff_data bdata = combat_engine.getBuffData(nameCrc);
        if (bdata == null)
        {
    ...
    public static int getGroupTwo(String name)
    {
        return getGroupTwo(getStringCrc(name.toLowerCase()));
    }
    public static int getGroupTwo(int nameCrc)
    {
        buff_data bdata = combat_engine.getBuffData(nameCrc);
        if (bdata == null)
        {
    ...
    public static String getStringGroupTwo(String name)
    {
        return getStringGroupTwo(getStringCrc(name.toLowerCase()));
    }
    public static String getStringGroupTwo(int nameCrc)
    {
        buff_data bdata = combat_engine.getBuffData(nameCrc);
        if (bdata == null)
        {
    ...
    public static int getBlockGroup(String name)
    {
        return getBlockGroup(getStringCrc(name.toLowerCase()));
    }
    public static int getBlockGroup(int nameCrc)
    {
        buff_data bdata = combat_engine.getBuffData(nameCrc);
        if (bdata == null)
        {
    ...
    public static int[] getGroups(buff_data bdata)
    {
        if (bdata == null)
        {
            return null;
    ...
    public static int[] getGroups(String name)
    {
        return getGroups(getStringCrc(name.toLowerCase()));
    }
    public static int[] getGroups(int nameCrc)
    {
        buff_data bdata = combat_engine.getBuffData(nameCrc);
        return getGroups(bdata);
    }
    public static int getBuffOnTargetFromGroup(obj_id target, String group)
    {
        return getBuffOnTargetFromGroup(target, getStringCrc(group));
    }
    public static int getBuffOnTargetFromGroup(obj_id target, int groupCrc)
    {
        int[] buffs = getAllBuffs(target);
        if (buffs == null || buffs.length == 0)
        {
    ...
    public static int[] getGroup2BuffsOnTarget(obj_id target, String groupName)
    {
        int[] buffs = getAllBuffs(target);
        if (buffs == null || buffs.length == 0)
        {
    ...
    public static int getPriority(int nameCrc)
    {
        buff_data bdata = combat_engine.getBuffData(nameCrc);
        if (bdata == null)
        {
    ...
    public static float getDuration(int nameCrc)
    {
        buff_data bdata = combat_engine.getBuffData(nameCrc);
        if (bdata == null)
        {
    ...
    public static int getState(int nameCrc)
    {
        buff_data bdata = combat_engine.getBuffData(nameCrc);
        if (bdata == null)
        {
    ...
    public static String getCallback(String name)
    {
        return getCallback(getStringCrc(name.toLowerCase()));
    }
    public static String getCallback(int nameCrc)
    {
        buff_data bdata = combat_engine.getBuffData(nameCrc);
        if (bdata == null)
        {
    ...
    public static String getParticle(String name)
    {
        return getParticle(getStringCrc(name.toLowerCase()));
    }
    public static String getParticle(int nameCrc)
    {
        buff_data bdata = combat_engine.getBuffData(nameCrc);
        if (bdata == null)
        {
    ...
    public static String getParticleHardpoint(String name)
    {
        return getParticle(getStringCrc(name.toLowerCase()));
    }
    public static String getParticleHardpoint(int nameCrc)
    {
        buff_data bdata = combat_engine.getBuffData(nameCrc);
        if (bdata == null)
        {
    ...
    public static String getEffectParam(String name, int effNum)
    {
        return getEffectParam(getStringCrc(name.toLowerCase()), effNum);
    }
    public static String getEffectParam(int nameCrc, int effNum)
    {
        buff_data bdata = combat_engine.getBuffData(nameCrc);
        if (bdata == null)
        {
    ...
    public static String getEffectParam(buff_data bdata, int effNum)
    {
    ...
    public static float getEffectValue(String name, int effNum)
    {
        return getEffectValue(getStringCrc(name.toLowerCase()), effNum);
    }
    public static float getEffectValue(int nameCrc, int effNum)
    {
        if (effNum <= 0 || effNum > MAX_EFFECTS)
        {
    ...
    public static boolean isDebuff(int nameCrc)
    {
        buff_data bdata = combat_engine.getBuffData(nameCrc);
        if (bdata == null)
        {
    ...
    public static boolean canBeDispelled(String name)
    {
        return canBeDispelled(getStringCrc(name.toLowerCase()));
    }
    public static boolean canBeDispelled(int nameCrc)
    {
        buff_data bdata = combat_engine.getBuffData(nameCrc);
        if (bdata == null)
        {
    ...
    public static boolean isGroupBuff(String name)
    {
        return isGroupBuff(getStringCrc(name.toLowerCase()));
    }
    public static boolean isGroupBuff(int nameCrc)
    {
        String effect;
    ...
    public static boolean isAuraBuff(String name)
    {
        return isAuraBuff(getStringCrc(name.toLowerCase()));
    }
    public static boolean isAuraBuff(int nameCrc)
    {
        String groupTwo = getStringGroupTwo(nameCrc);
        return groupTwo.contains("aura");
    }
    public static boolean isOwnedBuff(String name)
    {
        return isOwnedBuff(getStringCrc(name.toLowerCase()));
    }
    public static boolean isOwnedBuff(int nameCrc)
    {
        obj_id self = getSelf();
    ...
    public static boolean isValidBuff(String name)
    {
        return isValidBuff(getStringCrc(name.toLowerCase()));
    }
    public static boolean isValidBuff(int nameCrc)
    {
        return (combat_engine.getBuffData(nameCrc) != null);
    }
    public static int[] _getDiscardedBuffs(obj_id target, int nameCrc)
    {
        return _getDiscardedBuffs(target, null, nameCrc);
    }
    public static int[] _getDiscardedBuffs(obj_id target, obj_id owner, int nameCrc)
    {
        buff_data bdata = combat_engine.getBuffData(nameCrc);
        if (bdata == null)
        {
    ...
    public static int[] _getDiscardedBuffs(obj_id target, obj_id owner, buff_data bdata)
    {
        if (bdata == null)
        {
            return null;
    ...
    public static obj_id getBuffOwner(obj_id target, String name)
    {
        return getBuffOwner(target, getStringCrc(name.toLowerCase()));
    }
    public static obj_id getBuffOwner(obj_id target, int nameCrc)
    {
        if (!isGroupBuff(nameCrc))
        {
            return target;
    ...
    public static void addGroupBuffEffect(obj_id target, obj_id owner, int[] buffList, float[] strList, float[] durList)
    {
    ...
    public static void removeGroupBuffEffect(obj_id target, int[] buffList)
    {
        if (!isIdValid(target))
        {
            return;
    ...
    public static int[] getOwnedGroupBuffs(obj_id target)
    {
        if (!isIdValid(target))
        {
            return null;
    ...
    public static int[] getGroupBuffEffects(obj_id target)
    {
        if (!isIdValid(target))
        {
            return null;
    ...
    public static float[] getGroupBuffDuration(obj_id player, int[] buffList)
    {
    ...
    public static float[] getGroupBuffStrength(obj_id player, int[] buffList)
    {
        if (buffList == null || buffList.length == 0)
        {
            return null;
    ...
    public static boolean checkForStateImmunity(obj_id target, buff_data bdata)
    {
    ...
    public static boolean removeAllBuffsOfStateType(obj_id target, int stateType)
    {
    ...
    public static boolean toggleStance(obj_id player, String attemptedBuff)
    {
    ...
    public static boolean playStanceVisual(obj_id target, String effectName)
    {
    ...
    public static boolean isDotIconOnlyBuff(String name)
    {
    ...
    public static long getBuffStackCount(obj_id target, int nameCrc)
    {
        return _getBuffStackCount(target, nameCrc);
    }
    public static long getBuffStackCount(obj_id target, String nameCrc)
    {
        return _getBuffStackCount(target, getStringCrc(nameCrc.toLowerCase()));
    }
    public static boolean decrementBuffStack(obj_id target, int nameCrc, int stacksToRemove)
    {
        return _decrementBuffStack(target, nameCrc, stacksToRemove);
    }
    public static boolean decrementBuffStack(obj_id target, String nameCrc, int stacksToRemove)
    {
        return _decrementBuffStack(target, getStringCrc(nameCrc.toLowerCase()), stacksToRemove);
    }
    public static boolean decrementBuffStack(obj_id target, int nameCrc)
    {
        return _decrementBuffStack(target, nameCrc, 1);
    }
    public static boolean decrementBuffStack(obj_id target, String nameCrc)
    {
        return _decrementBuffStack(target, getStringCrc(nameCrc.toLowerCase()), 1);
    }
    public static obj_id getBuffCaster(obj_id target, int nameCrc)
    {
        return obj_id.getObjId(_getBuffCaster(target, nameCrc));
    }
    public static obj_id getBuffCaster(obj_id target, String nameCrc)
    {
        return obj_id.getObjId(_getBuffCaster(target, getStringCrc(nameCrc.toLowerCase())));
    }
    public static float getBuffTimeRemaining(obj_id target, int nameCrc)
    {
        return _getBuffTimeRemaining(target, nameCrc);
    }
    public static float getBuffTimeRemaining(obj_id target, String nameCrc)
    {
        return _getBuffTimeRemaining(target, getStringCrc(nameCrc.toLowerCase()));
    }
    public static int[] getAllDotBuffsOfType(obj_id target, String type)
    {
    ...
    public static boolean performBuffDotImmunity(obj_id target, String dotType)
    {
    ...
    public static boolean isBuffDot(String buffName)
    {
        return buff.getEffectParam(buffName, 2).equals("dot");
    }
    public static void reduceBuffDotStackCount(obj_id target, String dotType, int count)
    {
    ...
    public static void divideBuffDotStackCount(obj_id target, String dotType, int reduction)
    {
        int[] allBuffsOfType = buff.getAllDotBuffsOfType(target, dotType);
        if (allBuffsOfType == null || allBuffsOfType.length == 0)
        {
    ...
    public static boolean removeAllAuraBuffs(obj_id player)
    {
    ...
    public static int getBuffWithEffect(obj_id player, String effect)
    {
        if (!isIdValid(player) || !exists(player))
        {
            return -1;
    ...
    public static void partyBuff(obj_id caster, String buffName)
    {
    ...
    public static boolean decayBuff(obj_id target, String buffName)
    {
        return decayBuff(target, getStringCrc(buffName.toLowerCase()), 0.10f);
    }
    public static boolean decayBuff(obj_id target, String buffName, float percent)
    {
        return decayBuff(target, getStringCrc(buffName.toLowerCase()), percent);
    }
    public static boolean decayBuff(obj_id target, int buffCrc, float percent)
    {
        if (!isIdValid(target) || !exists(target))
        {
            return false;
    ...
    public static boolean decayAllBuffsFromPvpDeath(obj_id target)
    {
        return decayAllBuffsFromPvpDeath(target, 0.10f);
    }
    public static boolean decayAllBuffsFromPvpDeath(obj_id target, float percent)
    {
        if (!isIdValid(target))
        {
            return false;
