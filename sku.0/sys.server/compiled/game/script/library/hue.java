...
public class hue extends script.base_script
{
    ...
    public static boolean setColor(obj_id target, int varIdx, color c)
    {
    ...
    public static boolean setColor(obj_id target, String varPathName, color c)
    {
    ...
    public static boolean setColor(obj_id target, int varIdx, int paletteIdx)
    {
    ...
    public static boolean setColor(obj_id target, String varPathName, int paletteIdx)
    {
    ...
    public static int getVarColorIndex(obj_id target, String varPathName)
    {
    ...
    public static void setPalcolorCustomVarClosestColor(obj_id target, String varPathName, color c)
    {
        if (varPathName.startsWith("/"))
        {
            varPathName = varPathName.substring(1);
    ...
    public static ranged_int_custom_var[] getPalcolorVars(obj_id target)
    {
        if (!isIdValid(target))
        {
            return null;
    ...
    public static dictionary getPalcolorData(obj_id target)
    {
        if (!isIdValid(target))
        {
            return null;
    ...
    public static void setPalcolorData(obj_id target, dictionary colorData)
    {
        if (!isIdValid(target))
        {
            return;
    ...
    public static void hueObject(obj_id target)
    {
    ...
    public static void hueObject(obj_id target, int color)
    {
    ...
    public static ranged_int_custom_var[] getRangedIntVars(obj_id target)
    {
        if (!isIdValid(target))
        {
            return null;
    ...
    public static void reshapeObject(obj_id target)
    {
    ...
    public static void randomizeObject(obj_id target)
    {
        reshapeObject(target);
        hueObject(target);
    }
    public static boolean setRangedIntCustomVar(obj_id target, String cvar_name, int idx)
    {
    ...
    public static boolean setTexture(obj_id target, int idx, int value)
    {
