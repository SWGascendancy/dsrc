...
public class scenario extends script.base_script
{
    ...
    public static boolean initScenario(obj_id master, String tbl)
    {
    ...
    public static boolean createTeam(obj_id master, String team_name, String team_faction)
    {
        if (!isIdValid(master))
        {
            return false;
    ...
    public static boolean setTeamFaction(obj_id master, String team_name, String team_faction)
    {
        if (!isIdValid(master))
        {
            return false;
    ...
    public static String getTeamFaction(obj_id master, String team_name)
    {
        if (!isIdValid(master))
        {
            return null;
    ...
    public static obj_id createTeamNpc(obj_id master, String team_name, String type, String ident, location here)
    {
    ...
    public static String getTeamName(obj_id actor)
    {
        if (!isIdValid(actor))
        {
            return null;
    ...
    public static boolean isActorAlive(obj_id actor)
    {
        if (!isIdValid(actor))
        {
            return false;
    ...
    public static boolean setActorDead(obj_id actor, obj_id[] killers)
    {
        if (!isIdValid(actor))
        {
            return false;
    ...
    public static boolean setActorDead(obj_id actor)
    {
        return setActorDead(actor, null);
    }
    public static obj_id[] getTeamMembers(obj_id master, String team_name)
    {
    ...
    public static obj_id[] getTeamMembers(String team_name)
    {
        return getTeamMembers(poi.getBaseObject(getSelf()), team_name);
    }
    public static obj_id[] getAliveTeamMembers(obj_id master, String team_name)
    {
        if (!isIdValid(master) || team_name == null || team_name.equals(""))
        {
            return null;
    ...
    public static obj_id[] getDeadTeamMembers(obj_id master, String team_name)
    {
        if (!isIdValid(master) || team_name == null || team_name.equals(""))
        {
            return null;
    ...
    public static int getAliveTeamMemberCount(obj_id master, String team_name)
    {
    ...
    public static int getDeadTeamMemberCount(obj_id master, String team_name)
    {
    ...
    public static obj_id getRandomTeamMember(obj_id master, String team_name)
    {
        if (!isIdValid(master) || team_name == null || team_name.equals(""))
        {
            return null;
    ...
    public static obj_id getRandomAliveTeamMember(obj_id master, String team_name)
    {
        if (!isIdValid(master) || team_name == null || team_name.equals(""))
        {
            return null;
    ...
    public static int getTeamCount(obj_id master, String team_name)
    {
        if (!isIdValid(master) || team_name == null || team_name.equals(""))
        {
            return -1;
    ...
    public static int findTeamMember(Vector team, obj_id member)
    {
    ...
    public static boolean grantKillCredit(obj_id master, String team_name, obj_id[] killers)
    {
        if ((master == null) || (master == obj_id.NULL_ID))
        {
            return false;
    ...
    public static boolean hasKillCredit(obj_id master, String team_name, obj_id killer)
    {
        if ((master == null) || (master == obj_id.NULL_ID))
        {
            return false;
    ...
    public static boolean say(obj_id npc, String convo, String base_id, boolean doAct)
    {
    ...
    public static boolean say(obj_id npc, String convo, String base_id)
    {
        return say(npc, convo, base_id, true);
    }
    public static boolean sayNoAct(obj_id npc, String convo, String base_id)
    {
        return say(npc, convo, base_id, false);
    }
    public static boolean brainfart(obj_id npc)
    {
        return say(npc, DEFAULT_CONVO, "brainfart_" + rand(1, 10));
    }
    public static boolean complete(obj_id poiMaster)
    {
        if (poiMaster == null)
        {
            return false;
    ...
    public static boolean isComplete(obj_id poiMaster) {
    ...
    public static boolean setPlayerProgress(obj_id player, int progress)
    {
    ...
    public static boolean clearPlayerProgress(obj_id player)
    {
        if ((player == null) || (!isPlayer(player)))
        {
            return false;
    ...
    public static int getPlayerProgress(obj_id player)
    {
        if ((player == null) || (!isPlayer(player)))
        {
            return -1;
    ...
    public static obj_id[] getActorsWithNamePrefix(obj_id poiMaster, String prefix)
    {
    ...
    public static boolean cleanup(obj_id poiMaster)
    {
        if (poiMaster == null)
        {
            return false;
    ...
    public static dictionary getRandomScenario(String tbl)
    {
        if (tbl.equals(""))
        {
            return null;
    ...
    public static boolean requestAddTargetLocation(obj_id target, String locName, location pathLoc, float r)
    {
    ...
    public static boolean actorIncapacitated(obj_id self)
    {
        if (!isIdValid(self))
        {
            return false;
    ...
    public static void groupAttack(obj_id self, obj_id target)
    {
        startCombat(self, target);
    }
    public static void groupFace(obj_id self, obj_id target, String prefix)
    {
        obj_id poiMaster = poi.getBaseObject(self);
        if (isIdValid(poiMaster))
        {
    ...
    public static void groupFollow(obj_id leader, obj_id formTarget, String prefix)
    {
