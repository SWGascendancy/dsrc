...
public class smuggler extends script.base_script
{
    ...
    public static obj_id[] getAllJunkItems(obj_id player)
    {
        return getAllJunkItems(player, false);
    }
    public static obj_id[] getAllJunkItems(obj_id player, boolean getFlaggedNoSale)
    {
        if (!isIdValid(player))
        {
            return null;
    ...
    public static void showSellJunkSui(obj_id player, obj_id salesman, boolean fence, boolean showCommWindow)
    {
    ...
    public static void cleanupSellJunkSui(obj_id player)
    {
    ...
    public static void sellJunkItem(obj_id player, obj_id item)
    {
        sellJunkItem(player, item, false);
    }
    public static void sellJunkItem(obj_id player, obj_id item, boolean reshowUi)
    {
        sellJunkItem(player, item, false, reshowUi);
    }
    public static int getPrice(obj_id item)
    {
        int price = 0;
    ...
    public static boolean checkInventory(obj_id player, obj_id npc)
    {
        String item = "";
        String itemTemplate = "";
    ...
    public static boolean hasItemsInContainer(obj_id item)
    {
    ...
    public static boolean validateItemsBeingSold(obj_id player, obj_id item)
    {
    ...
    public static boolean canSlyLie(obj_id playerSmuggler)
    {
    ...
    public static boolean doSlyLie(obj_id playerSmuggler)
    {
        location here = getLocation(playerSmuggler);
        obj_id[] objects = getObjectsInRange(here, 25);
        for (int i = 0; i < objects.length; i++)
    ...
    public static boolean canFastTalk(obj_id playerSmuggler, obj_id target)
    {
    ...
    public static boolean doFastTalk(obj_id playerSmuggler, obj_id target)
    {
        if (!hasScript(target, "ai.smuggler_spawn_enemy"))
        {
            return false;
    ...
    public static int getSmugglerRank(float underworldFaction)
    {
    ...
    public static int getSmuggleTier(float underworldFaction)
    {
        if (underworldFaction < 1000.0f)
        {
            return 1;
    ...
    public static boolean hasIllicitContraband(obj_id player)
    {
    ...
    public static boolean hasIllicitMissionContraband(obj_id player)
    {
        String contrabandName = "item_smuggler_contraband_0";
        obj_id[] contents = getInventoryAndEquipment(player);
        if (contents != null && contents.length > 0)
    ...
    public static int getIllicitContrabandTier(String itemName)
    {
    ...
    public static String getIllicitMissionContrabandSmugglerTier(obj_id player, int smugglerTier)
    {
        String contrabandName = "item_smuggler_contraband_0";
    ...
    public static boolean hasMissionContrabandForTransaction(obj_id player, int brokerTier)
    {
        String contrabandName = "item_smuggler_contraband_0";
        obj_id[] contents = getInventoryAndEquipment(player);
        if (contents != null && contents.length > 0)
    ...
    public static String getMissionContrabandForTransactionName(obj_id player, int brokerTier)
    {
        String contrabandName = "item_smuggler_contraband_0";
        obj_id[] contents = getInventoryAndEquipment(player);
        if (contents != null && contents.length > 0)
    ...
    public static int getMissionCotrabandPointerTier(obj_id player)
    {
        String contrabandName = "item_smuggler_contraband_0";
        obj_id[] contents = getInventoryAndEquipment(player);
        if (contents != null && contents.length > 0)
    ...
    public static void createRandomContrabandTier(obj_id player, int dropTier)
    {
    ...
    public static void inspectCorpseForContraband(obj_id player, obj_id target)
    {
        if (!isIdValid(target))
        {
            return;
    ...
    public static void removeFromBountyTerminal(obj_id self, int questCrc, boolean failed)
    {
    ...
    public static void checkSmugglerMissionBountyFailure(obj_id player, obj_id killer)
    {
    ...
    public static void checkSmugglerTitleGrants(obj_id player, float value)
    {
        if (value >= 1000.0f)
        {
    ...
    public static void checkBountyTitleGrants(obj_id player, float value)
    {
        if (value <= -1000.0f)
        {
    ...
    public static void checkRewardQuestGrants(obj_id target, float value)
    {
        if (value >= 1000.0f)
        {
    ...
    public static boolean moveBuyBackObjectIntoContainer(obj_id player, obj_id object, int credits)
    {
    ...
    public static boolean moveBuyBackObjectIntoInventory(obj_id player, obj_id object)
    {
        if (!isValidId(player) || !exists(player))
        {
            return false;
    ...
    public static obj_id[] getBuyBackItemsInContainer(obj_id player)
    {
        if (!isValidId(player) || !exists(player))
        {
            return null;
    ...
    public static boolean hasBuyBackContainer(obj_id player)
    {
        if (!isValidId(player) || !exists(player))
        {
            return false;
    ...
    public static obj_id createBuyBackControlDeviceOnPlayer(obj_id player)
    {
        if (!isValidId(player) || !exists(player))
        {
            return null;
    ...
    public static void setBuyBackContainerObjVar(obj_id player, obj_id buyBackControlDevice)
    {
    ...
    public static obj_id getBuyBackContainerObjVar(obj_id player)
    {
        if (hasObjVar(player, BUYBACK_CONTAINER_VAR))
        {
    ...
    public static boolean hasBuyBackItems(obj_id player)
    {
        if (!isValidId(player))
        {
            return false;
    ...
    public static boolean showBuyBackSui(obj_id player, obj_id target)
    {
    ...
    public static boolean buyBackJunkItem(obj_id player, obj_id junkDealer, obj_id item, boolean reshowSui)
    {
    ...
    public static void flagJunkSaleSui(obj_id player, obj_id salesman)
    {
        if (!isIdValid(player) || !isValidId(salesman))
        {
            return;
    ...
    public static boolean blog(String txt)
    {
        if (LOGGING_ON)
        {
            LOG(LOGNAME, txt);
