...
public class advanced_turret extends script.base_script
{
    ...
    public static obj_id createTurret(location loc, float yaw, int minDamage, int maxDamage, float attackSpeed, float range)
    {
        return createTurret(loc, yaw, TYPE_BLOCK, SIZE_SMALL, DAMAGE_ENERGY, minDamage, maxDamage, range, attackSpeed, "");
    }
    public static obj_id createTurret(location loc, float yaw, int type, int size, int damageType, int minDamage, int maxDamage, float range, float attackSpeed, String faction)
    {
        return createTurret(loc, yaw, TYPE_BLOCK, SIZE_SMALL, DAMAGE_ENERGY, minDamage, maxDamage, 10000, range, attackSpeed, "");
    }
    public static obj_id createTurret(location loc, float yaw, int type, int size, int damageType, int minDamage, int maxDamage, int hitpoints, float range, float attackSpeed, String faction)
    {
        return createTurret(null, loc, yaw, type, size, damageType, minDamage, maxDamage, hitpoints, range, attackSpeed, faction);
    }
    public static obj_id createTurret(obj_id owner, location loc, float yaw, int type, int size, int damageType, int minDamage, int maxDamage, int hitpoints, float range, float attackSpeed, String faction)
    {
    ...
    public static void activateTurret(obj_id turret)
    {
    ...
    public static void deactivateTurret(obj_id turret)
    {
    ...
    public static boolean isActive(obj_id turret)
    {
        if (!isIdValid(turret))
        {
            return false;
    ...
    public static void startTrackingTarget(obj_id turret, obj_id target)
    {
    ...
    public static void stopTrackingTarget(obj_id turret)
    {
    ...
    public static boolean isEngaged(obj_id turret)
    {
        if (!isIdValid(turret))
        {
            return false;
    ...
    public static obj_id getCurrentTarget(obj_id turret)
    {
        if (!isEngaged(turret))
        {
            return null;
    ...
    public static obj_id getTurretWeapon(obj_id turret)
    {
    ...
    public static void initTurret(obj_id turret, String faction, int damageType, float range, int minDamage, int maxDamage, int hitpoints, float attackSpeed)
    {
    ...
    public static boolean isValidTarget(obj_id turret, obj_id target)
    {
    ...
    public static String getBaseFaction(obj_id turret)
    {
    ...
    public static void addTarget(obj_id turret, obj_id target)
    {
    ...
    public static void addTargets(obj_id turret, obj_id[] newTargets)
    {
        Vector targets = null;
        if (!utils.hasScriptVar(turret, TARGETS))
        {
    ...
    public static void removeTarget(obj_id turret, obj_id target)
    {
        if (!isIdValid(turret) || !isIdValid(target))
        {
    ...
    public static boolean handleTurretDamage(obj_id turret, obj_id attacker, obj_id weapon, int dmgAmount)
    {
    ...
    public static boolean validateAttacker(obj_id turret, obj_id attacker)
    {
        obj_id master = getObjIdObjVar(turret, "turret_master");
    ...
    public static void explodeTurret(obj_id turret, obj_id killer)
    {
        location death = getLocation(turret);
    ...
    public static obj_id getGoodTurretTarget(obj_id turret)
    {
    ...
    public static void attackPulse(obj_id turret)
    {
        if (!isActive(turret))
        {
            return;
    ...
    public static void executeAttackAction(obj_id turret, obj_id target)
    {
