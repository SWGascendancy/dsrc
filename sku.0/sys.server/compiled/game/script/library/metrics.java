...
public class metrics extends script.base_script
{
    ...
    public static boolean checkConfigSetting(String configString)
    {
    ...
    public static void logBuffStatus(obj_id target)
    {
    ...
    public static void logWeaponStatus(obj_id player, obj_id weapon)
    {
    ...
    public static void logArmorStatus(obj_id player)
    {
        if (!isIdValid(player) || !isPlayer(player))
        {
            return;
    ...
    public static void logArmorPiece(obj_id player, obj_id object)
    {
        if (!isIdValid(object))
        {
            return;
    ...
    public static obj_id[] getWornItems(obj_id player)
    {
    ...
    public static void doKillMetrics(obj_id killCredit, obj_id target)
    {
        String killLog = "";
    ...
    public static void doXpRateMetrics(obj_id player, String xpType, int xpAmount)
    {
        int curTime = getGameTime();
    ...
    public static void doQuestMetrics(obj_id player, int questId, int level, int tier, String xpType, int xpAmount)
    {
        int curTime = getGameTime();
        String playerName = getEncodedName(player);
        int playerLevel = getLevel(player);
