...
public class space_battlefield extends script.base_script
{
    ...
    public static void battlefieldCompleted(obj_id objManager, int intCompletionId)
    {
    ...
    public static void resetSpaceBattlefield(obj_id objManager)
    {
        LOG("space", "RESETTING");
    ...
    public static void doBattleFieldTransition(obj_id objShip, obj_id objStation)
    {
    ...
    public static void doBattleFieldTransition(obj_id objShip, obj_id objStation, String strOverloadName)
    {
    ...
    public static void doKesselTransition(obj_id objShip, obj_id objStation)
    {
    ...
    public static void doBattleFieldCommandTransition(obj_id objShip, obj_id player, String zone, String factionEntry)
    {
        String strX = "fltX";
        String strY = "fltY";
        String strZ = "fltZ";
    ...
    public static boolean isInBattlefield(obj_id objShip)
    {
        return isSpaceBattlefieldZone();
    }
    public static void cleanupBattlefieldMember(obj_id objShip)
    {
    ...
    public static boolean canTransitionToBattlefield(obj_id objShip, obj_id objStation)
    {
        if (space_utils.isBasicShip(objShip))
        {
            string_id strSpam = new string_id("space/space_interaction", "no_basics");
    ...
    public static boolean isCorrectFactionForStation(obj_id objShip, obj_id objStation)
    {
        return true;
    }
    public static int canAffordPrestigePointCost(obj_id objShip, obj_id objStation, String strType)
    {
        String strName = getStringObjVar(objStation, "strName");
        dictionary dctStationInfo = dataTableGetRow("datatables/space_content/battlefields/entry_stations.iff", strName);
        int intPointCost = dctStationInfo.getInt("intPointCost");
    ...
    public static int canAffordPrestigePointCost(obj_id objShip, obj_id objStation)
    {
        String strName = getStringObjVar(objStation, "strName");
        dictionary dctStationInfo = dataTableGetRow("datatables/space_content/battlefields/entry_stations.iff", strName);
        String strType = dctStationInfo.getString("strPrestigeType");
    ...
    public static int getPrestigeCostForTransition(obj_id objPlayer, obj_id objStation)
    {
    ...
    public static int getPrestigeCostForTransition(obj_id objShip, obj_id objStation, int intPointCost)
    {
        return intPointCost;
    }
    public static boolean isInRebelShip(obj_id objPlayer)
    {
    ...
    public static boolean isInNeutralShip(obj_id objPlayer)
    {
    ...
    public static boolean isInImperialShip(obj_id objPlayer)
    {
        obj_id objShip = space_transition.getContainingShip(objPlayer);
        if (!isIdValid(objShip))
        {
    ...
    public static obj_id getManagerObject()
    {
        return getNamedObject("content_manager");
    }
    public static void sendNextPhaseNotification(obj_id self)
    {
    ...
    public static void doDestroyerPhase(obj_id objManager)
    {
