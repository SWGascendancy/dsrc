...
public class house_pet extends script.base_script
{
    ...
    public static boolean setObjectOwner(obj_id controller)
    {
    ...
    public static obj_id recreateSarlaccObjectAtLocationFromObjVar(obj_id controller)
    {
        if (!isValidId(controller) || !exists(controller))
        {
            return null;
    ...
    public static boolean recreateObjectFromObjVar(obj_id controller)
    {
        if (!isValidId(controller) || !exists(controller))
        {
            return false;
    ...
    public static boolean buildHousePetInPlayerStructure(obj_id controller, String mobileTemplate, location spawnLoc)
    {
        if (!isValidId(controller) || !exists(controller))
        {
            return false;
    ...
    public static boolean validateNpcPlacementInStructure(obj_id object)
    {
        return validateNpcPlacementInStructure(object, obj_id.NULL_ID);
    }
    public static boolean validateNpcPlacementInStructure(obj_id object, obj_id operator)
    {
    ...
    public static boolean cleanUpHousePet(obj_id housePet)
    {
        return cleanUpHousePet(obj_id.NULL_ID, housePet);
    }
    public static boolean cleanUpHousePet(obj_id controller, obj_id housePet)
    {
    ...
    public static int getUpdateWeekly(obj_id controller)
    {
    ...
    public static int getUpdateDaily(obj_id controller)
    {
        if (hasObjVar(controller, house_pet.SARLACC_FAST_UPDATE_RATE))
        {
    ...
    public static boolean stopPlayingMusic(obj_id self)
    {
    ...
    public static boolean isInAPlayerHouse(obj_id device)
    {
