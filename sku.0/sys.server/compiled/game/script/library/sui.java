...
public class sui extends script.base_script
{
    ...
    public static int msgbox(obj_id target, string_id sid_prompt, dictionary params)
    {
        if (!isIdValid(target))
        {
            return -1;
    ...
    public static int msgbox(obj_id target, string_id sid_prompt)
    {
        return msgbox(target, sid_prompt, null);
    }
    public static int countdownTimerSUI(obj_id owner, obj_id target, String type, string_id sid_prompt, int current_time, int total_time, String suiHandler)
    {
    ...
    public static int smartCountdownTimerSUI(obj_id owner, obj_id target, String type, string_id sid_prompt, int current_time, int total_time, String suiHandler, float range, int flags)
    {
        if (!isIdValid(owner) || !isIdValid(target))
        {
            return -1;
    ...
    public static boolean updateCountdownTimerSUI(int pid, string_id sid_prompt, int current_time, int total_time)
    {
        if (sid_prompt == null)
        {
            return false;
    ...
    public static boolean setPageProperties(int pid, dictionary params)
    {
    ...
    public static boolean setPageTitle(int pid, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return false;
    ...
    public static boolean setPageButtons(int pid, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return false;
    ...
    public static void setButtonStyle(int pid, int btns)
    {
        switch (btns)
        {
            case OK_ONLY:
    ...
    public static boolean trackSUI(obj_id target, int pid, obj_id owner, String handler)
    {
    ...
    public static int msgbox(obj_id owner, obj_id target, String prompt, int buttons, String box_title, int style, String suiHandler)
    {
        if (!isIdValid(owner) || !isIdValid(target))
        {
            return -1;
    ...
    public static void msgboxButtonSetup(int pid, int buttons)
    {
        switch (buttons)
        {
            case OK_CANCEL:
    ...
    public static void msgboxHideBtnLeft(int pid)
    {
        setSUIProperty(pid, MSGBOX_BTN_REVERT, "Enabled", "False");
        setSUIProperty(pid, MSGBOX_BTN_REVERT, "Visible", "False");
    }
    public static void msgboxHideBtnMiddle(int pid)
    {
        setSUIProperty(pid, MSGBOX_BTN_CANCEL, "Enabled", "False");
        setSUIProperty(pid, MSGBOX_BTN_CANCEL, "Visible", "False");
    }
    public static int msgbox(obj_id owner, obj_id target, String prompt, String suiHandler)
    {
        return msgbox(owner, target, prompt, OK_ONLY, DEFAULT_TITLE, MSG_NORMAL, suiHandler);
    }
    public static int msgbox(obj_id owner, String prompt, String suiHandler)
    {
        return msgbox(owner, owner, prompt, OK_ONLY, DEFAULT_TITLE, MSG_NORMAL, suiHandler);
    }
    public static int msgbox(obj_id owner, obj_id target, String prompt)
    {
        return msgbox(owner, target, prompt, OK_ONLY, DEFAULT_TITLE, MSG_NORMAL, "noHandler");
    }
    public static int msgbox(obj_id owner, String prompt)
    {
        return msgbox(owner, owner, prompt, OK_ONLY, DEFAULT_TITLE, MSG_NORMAL, "noHandler");
    }
    public static int msgbox(obj_id owner, obj_id target, String prompt, int buttons, String suiHandler)
    {
        return msgbox(owner, target, prompt, buttons, DEFAULT_TITLE, MSG_NORMAL, suiHandler);
    }
    public static int msgbox(obj_id owner, obj_id target, String prompt, int buttons, String box_title, String suiHandler)
    {
        return msgbox(owner, target, prompt, buttons, box_title, MSG_NORMAL, suiHandler);
    }
    public static int msgbox(obj_id owner, obj_id target, prose_package prompt, int buttons, String box_title, int style, String suiHandler)
    {
        return msgbox(owner, target, "\0" + packOutOfBandProsePackage(null, prompt), buttons, box_title, style, suiHandler);
    }
    public static int msgbox(obj_id owner, obj_id target, prose_package prompt, String suiHandler)
    {
        return msgbox(owner, target, prompt, OK_ONLY, DEFAULT_TITLE, MSG_NORMAL, suiHandler);
    }
    public static int msgbox(obj_id owner, prose_package prompt, String suiHandler)
    {
        return msgbox(owner, owner, prompt, OK_ONLY, DEFAULT_TITLE, MSG_NORMAL, suiHandler);
    }
    public static int msgbox(obj_id owner, obj_id target, prose_package prompt)
    {
        return msgbox(owner, target, prompt, OK_ONLY, DEFAULT_TITLE, MSG_NORMAL, "noHandler");
    }
    public static int msgbox(obj_id owner, prose_package prompt)
    {
        return msgbox(owner, owner, prompt, OK_ONLY, DEFAULT_TITLE, MSG_NORMAL, "noHandler");
    }
    public static int msgbox(obj_id owner, obj_id target, prose_package prompt, int buttons, String suiHandler)
    {
        return msgbox(owner, target, prompt, buttons, DEFAULT_TITLE, MSG_NORMAL, suiHandler);
    }
    public static int msgbox(obj_id owner, obj_id target, prose_package prompt, int buttons, String box_title, String suiHandler)
    {
        return msgbox(owner, target, prompt, buttons, box_title, MSG_NORMAL, suiHandler);
    }
    public static int inputbox(obj_id owner, obj_id target, String prompt, int buttons, String box_title, int style, String[] dsrc, String suiHandler, dictionary params)
    {
        if (dsrc == null)
        {
    ...
    public static int inputbox(obj_id owner, obj_id target, String prompt, String box_title, String suiHandler, int maxLength, boolean filtered, String defaultText)
    {
        if (!isIdValid(owner) || !isIdValid(target))
        {
            return -1;
    ...
    public static int inputbox(obj_id owner, obj_id target, String prompt, String box_title, String suiHandler, String defaultText)
    {
        return inputbox(owner, target, prompt, box_title, suiHandler, 32, true, defaultText);
    }
    public static int filteredInputbox(obj_id owner, obj_id target, String prompt, String box_title, String suiHandler, String defaultText)
    {
        return inputbox(owner, target, prompt, box_title, suiHandler, defaultText);
    }
    public static void trackFilteredInputbox(obj_id owner, obj_id player, int pid, String suiHandler, String defaultText)
    {
    ...
    public static void cleanupFilteredInputbox(obj_id owner, obj_id player)
    {
        if (!isIdValid(owner) || !isIdValid(player))
        {
            return;
    ...
    public static String getInputBoxText(dictionary params)
    {
        return params.getString(INPUTBOX_INPUT + "." + PROP_LOCALTEXT);
    }
    public static String getInputBoxTitle(dictionary params)
    {
        return params.getString(INPUTBOX_TITLE + "." + PROP_TEXT);
    }
    public static String getInputBoxPrompt(dictionary params)
    {
        return params.getString(INPUTBOX_PROMPT + "." + PROP_TEXT);
    }
    public static int getInputBoxMaxLength(dictionary params)
    {
        return utils.stringToInt(params.getString(INPUTBOX_INPUT + ".MaxLength"));
    }
    public static String getComboBoxText(dictionary params)
    {
        return params.getString(INPUTBOX_COMBO + "." + PROP_SELECTEDTEXT);
    }
    public static void inputboxButtonSetup(int pid, int buttons)
    {
        switch (buttons)
        {
            case OK_CANCEL:
    ...
    public static int inputbox(obj_id owner, obj_id target, String prompt, int buttons, String box_title, int style, String[] dsrc, String suiHandler)
    {
        return inputbox(owner, target, prompt, buttons, box_title, style, dsrc, suiHandler, null);
    }
    public static int inputbox(obj_id owner, obj_id target, String prompt, String suiHandler)
    {
        return inputbox(owner, target, prompt, OK_ONLY, DEFAULT_TITLE, INPUT_NORMAL, null, suiHandler);
    }
    public static int inputbox(obj_id owner, String prompt, String suiHandler)
    {
        return inputbox(owner, owner, prompt, OK_ONLY, DEFAULT_TITLE, INPUT_NORMAL, null, suiHandler);
    }
    public static int inputbox(obj_id owner, obj_id target, String prompt)
    {
        return inputbox(owner, target, prompt, OK_ONLY, DEFAULT_TITLE, INPUT_NORMAL, null, "noHandler");
    }
    public static int inputbox(obj_id owner, String prompt)
    {
        return inputbox(owner, owner, prompt, OK_ONLY, DEFAULT_TITLE, INPUT_NORMAL, null, "noHandler");
    }
    public static int inputbox(obj_id owner, obj_id target, String prompt, String[] dsrc, String suiHandler)
    {
        return inputbox(owner, target, prompt, OK_ONLY, DEFAULT_TITLE, INPUT_COMBO, dsrc, suiHandler);
    }
    public static int combobox(obj_id owner, obj_id target, String prompt, String[] dsrc, String suiHandler)
    {
        return inputbox(owner, target, prompt, OK_ONLY, DEFAULT_TITLE, INPUT_COMBO, dsrc, suiHandler);
    }
    public static int combobox(obj_id owner, String prompt, String[] dsrc, String suiHandler)
    {
        return inputbox(owner, owner, prompt, OK_ONLY, DEFAULT_TITLE, INPUT_COMBO, dsrc, suiHandler);
    }
    public static int listbox(obj_id owner, obj_id target, String prompt, int buttons, String box_title, prose_package[] dsrc, String suiHandler, boolean show, boolean truncate)
    {
    ...
    public static int listbox(obj_id owner, obj_id target, String prompt, int buttons, String box_title, String[] dsrc, String suiHandler, boolean show, boolean truncate)
    {
        if (!isIdValid(owner) || !isIdValid(target) || suiHandler == null || suiHandler.equals("") || dsrc == null || dsrc.length == 0)
        {
            if (!isIdValid(owner))
    ...
    public static int emptylistbox(obj_id owner, obj_id target, String prompt, int buttons, String box_title, String suiHandler, boolean show)
    {
    ...
    public static int getListboxSelectedRow(dictionary params)
    {
        return utils.stringToInt(params.getString(LISTBOX_LIST + "." + PROP_SELECTEDROW));
    }
    public static String getListboxTitle(dictionary params)
    {
        return params.getString(LISTBOX_TITLE + "." + PROP_TEXT);
    }
    public static void listboxButtonSetup(int pid, int buttons)
    {
        switch (buttons)
        {
            case OK_CANCEL:
    ...
    public static void listboxHideBtnMiddle(int pid)
    {
        setSUIProperty(pid, LISTBOX_BTN_CANCEL, "Enabled", "False");
        setSUIProperty(pid, LISTBOX_BTN_CANCEL, "Visible", "False");
    }
    public static void listboxUseOtherButton(int pid, String caption)
    {
    ...
    public static boolean getListboxOtherButtonPressed(dictionary params)
    {
        return Boolean.valueOf(params.getString("this." + LISTBOX_PROP_OTHER_PRESSED));
    }
    public static int listbox(obj_id owner, obj_id target, String prompt, int buttons, String box_title, String[] dsrc, String suiHandler, boolean show)
    {
        return listbox(owner, target, prompt, buttons, box_title, dsrc, suiHandler, show, true);
    }
    public static int listbox(obj_id owner, obj_id target, String prompt, int buttons, String box_title, Vector dsrc, String suiHandler, boolean show)
    {
        if (dsrc == null)
        {
            return -1;
    ...
    public static int listbox(obj_id owner, obj_id target, String prompt, int buttons, String box_title, Vector dsrc, String suiHandler, boolean show, boolean truncate)
    {
        if (dsrc == null)
        {
            return -1;
    ...
    public static int listbox(obj_id owner, obj_id target, String prompt, int buttons, String box_title, String[] dsrc, String suiHandler)
    {
        return listbox(owner, target, prompt, buttons, box_title, dsrc, suiHandler, true, true);
    }
    public static int listbox(obj_id owner, obj_id target, String prompt, int buttons, String box_title, Vector dsrc, String suiHandler)
    {
        if (dsrc == null)
        {
            return -1;
    ...
    public static int listbox(obj_id owner, obj_id target, String prompt, String[] dsrc, String suiHandler)
    {
        return listbox(owner, target, prompt, OK_ONLY, "", dsrc, suiHandler);
    }
    public static int listbox(obj_id owner, obj_id target, String prompt, Vector dsrc, String suiHandler)
    {
        if (dsrc == null)
        {
            return -1;
    ...
    public static int listbox(obj_id owner, String prompt, String[] dsrc, String suiHandler)
    {
        return listbox(owner, owner, prompt, OK_ONLY, "", dsrc, suiHandler);
    }
    public static int listbox(obj_id owner, String prompt, Vector dsrc, String suiHandler)
    {
        if (dsrc == null)
        {
            return -1;
    ...
    public static int listbox(obj_id owner, obj_id target, String prompt, String[] dsrc)
    {
        return listbox(owner, target, prompt, OK_ONLY, "", dsrc, "noHandler");
    }
    public static int listbox(obj_id owner, obj_id target, String prompt, Vector dsrc)
    {
        if (dsrc == null)
        {
            return -1;
    ...
    public static int listbox(obj_id owner, String prompt, String[] dsrc)
    {
        return listbox(owner, owner, prompt, OK_ONLY, "", dsrc, "noHandler");
    }
    public static int listbox(obj_id owner, String prompt, Vector dsrc)
    {
        if (dsrc == null)
        {
            return -1;
    ...
    public static int listbox(obj_id owner, obj_id target, String prompt, String title, String[] dsrc, String suiHandler)
    {
        return listbox(owner, target, prompt, OK_ONLY, title, dsrc, suiHandler);
    }
    public static int listbox(obj_id owner, obj_id target, String prompt, String title, Vector dsrc, String suiHandler)
    {
        if (dsrc == null)
        {
            return -1;
    ...
    public static int listbox(obj_id owner, String prompt, String title, String[] dsrc, String suiHandler)
    {
        return listbox(owner, owner, prompt, OK_ONLY, title, dsrc, suiHandler);
    }
    public static int listbox(obj_id owner, String prompt, String title, Vector dsrc, String suiHandler)
    {
        if (dsrc == null)
        {
            return -1;
    ...
    public static int listbox(obj_id owner, obj_id target, String prompt, String title, String[] dsrc)
    {
        return listbox(owner, target, prompt, OK_ONLY, title, dsrc, "noHandler");
    }
    public static int listbox(obj_id owner, obj_id target, String prompt, String title, Vector dsrc)
    {
        if (dsrc == null)
        {
            return -1;
    ...
    public static int listbox(obj_id owner, String prompt, String title, String[] dsrc)
    {
        return listbox(owner, owner, prompt, OK_ONLY, title, dsrc, "noHandler");
    }
    public static int listbox(obj_id owner, String prompt, String title, Vector dsrc)
    {
        if (dsrc == null)
        {
            return -1;
    ...
    public static int listbox(obj_id owner, String prompt, String title, int btn, String[] dsrc)
    {
        return listbox(owner, owner, prompt, btn, title, dsrc, "noHandler");
    }
    public static int listbox(obj_id owner, String prompt, String title, int btn, Vector dsrc)
    {
        if (dsrc == null)
        {
            return -1;
    ...
    public static int transfer(obj_id owner, obj_id target, String prompt, String box_title, String lblFrom, int inputFrom, String lblTo, int inputTo, String suiHandler, int conversionFrom, int conversionTo)
    {
    ...
    public static int transfer(obj_id owner, obj_id target, String prompt, String box_title, String lblFrom, int inputFrom, String lblTo, int inputTo, String suiHandler)
    {
        return transfer(owner, target, prompt, box_title, lblFrom, inputFrom, lblTo, inputTo, suiHandler, 1, 1);
    }
    public static int getTransferInputTo(dictionary params)
    {
        return utils.stringToInt(params.getString(TRANSFER_INPUT_TO + "." + PROP_TEXT));
    }
    public static int getTransferInputFrom(dictionary params)
    {
        return utils.stringToInt(params.getString(TRANSFER_INPUT_FROM + "." + PROP_TEXT));
    }
    public static int bank(obj_id player)
    {
        if (player == null)
        {
            return -1;
    ...
    public static int colorize(obj_id owner, obj_id player, obj_id target, String customizationVar, String handler)
    {
    ...
    public static int getColorPickerIndex(dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return -1;
    ...
    public static String getButtonPressed(dictionary params)
    {
        return params.getString(PROP_BUTTONPRESSED);
    }
    public static int getIntButtonPressed(dictionary params)
    {
    ...
    public static obj_id getPlayerId(dictionary params)
    {
        return params.getObjId("player");
    }
    public static boolean setSUIObjVars(obj_id target, int pid, dictionary params)
    {
        java.util.Enumeration keys = params.keys();
        Object key;
        Object value;
    ...
    public static void clearSUIObjVar(obj_id target, int pid)
    {
        removeObjVar(target, "sui." + pid);
    }
    public static void closeSUI(obj_id target, int pid)
    {
        if (!isIdValid(target))
        {
            return;
    ...
    public static void setAssociateRange(obj_id player, int pid, obj_id target, float range)
    {
        if (!isIdValid(player))
        {
    ...
    public static void setAssociateRange(obj_id player, int pid, obj_id target)
    {
        setAssociateRange(player, pid, target, 16f);
    }
    public static void setAssociateRange(obj_id player, int pid, obj_id target, String key)
    {
        float range = 16f;
    ...
    public static void setAutosaveProperty(int pid, boolean autosave)
    {
        setSUIProperty(pid, THIS, PROP_AUTOSAVE, autosave ? "true" : "false");
    }
    public static void setSizeProperty(int pid, int width, int height)
    {
        if (width < 0)
        {
    ...
    public static void setLocationProperty(int pid, int x, int y)
    {
        setSUIProperty(pid, THIS, PROP_LOCATION, x + "," + y);
    }
    public static void setSoundProperty(int pid, String sound)
    {
        setSUIProperty(pid, THIS, PROP_SOUND, sound == null ? "" : sound);
    }
    public static boolean hasPid(obj_id player, String pidName) {
        if (!isIdValid(player) || !exists(player)) {
            return false;
        }
        return !(pidName == null || pidName.equals("")) && utils.hasScriptVar(player, "pid." + pidName);
    }
    public static void setPid(obj_id player, int pid, String pidName)
    {
        if (!isIdValid(player) || !exists(player))
        {
            return;
    ...
    public static void removePid(obj_id player, String pidName)
    {
        if (!isIdValid(player) || !exists(player))
        {
            return;
    ...
    public static int getPid(obj_id player, String pidName)
    {
        if (!isIdValid(player) || !exists(player))
        {
            return 0;
    ...
    public static boolean outOfRange(obj_id object, obj_id player, float range, boolean message)
    {
        if (!isIdValid(object))
        {
            return false;
    ...
    public static int table(obj_id owner, obj_id target, int buttons, String box_title, String suiHandler, String prompt, String[] columnNames, String[] columnTypes, String[][] tableData, boolean rowMajor, boolean allowExport)
    {
        if (!isIdValid(owner) || !isIdValid(target))
        {
            return -1;
    ...
    public static int tableColumnMajor(obj_id owner, obj_id target, int buttons, String box_title, String suiHandler, String prompt, String[] columnNames, String[] columnTypes, String[][] tableData)
    {
        return table(owner, target, buttons, box_title, suiHandler, prompt, columnNames, columnTypes, tableData, false, false);
    }
    public static int tableColumnMajor(obj_id owner, obj_id target, int buttons, String box_title, String suiHandler, String prompt, String[] columnNames, String[] columnTypes, String[][] tableData, boolean allowExport)
    {
        return table(owner, target, buttons, box_title, suiHandler, prompt, columnNames, columnTypes, tableData, false, allowExport);
    }
    public static int tableRowMajor(obj_id owner, obj_id target, int buttons, String box_title, String suiHandler, String prompt, String[] columnNames, String[] columnTypes, String[][] tableData)
    {
        return table(owner, target, buttons, box_title, suiHandler, prompt, columnNames, columnTypes, tableData, true, false);
    }
    public static int tableRowMajor(obj_id owner, obj_id target, int buttons, String box_title, String suiHandler, String prompt, String[] columnNames, String[] columnTypes, String[][] tableData, boolean allowExport)
    {
        return table(owner, target, buttons, box_title, suiHandler, prompt, columnNames, columnTypes, tableData, true, allowExport);
    }
    public static void tableButtonSetup(int pid, int buttons)
    {
        switch (buttons)
        {
            case OK_CANCEL:
    ...
    public static void TableHideBtnMiddle(int pid)
    {
        setSUIProperty(pid, TABLE_BTN_CANCEL, "Enabled", "False");
        setSUIProperty(pid, TABLE_BTN_CANCEL, "Visible", "False");
    }
    public static void TableUseOtherButton(int pid, String caption)
    {
    ...
    public static void TableAllowExport(int pid, boolean allow)
    {
        if (allow)
        {
    ...
    public static int getTableSelectedRow(dictionary params)
    {
        return utils.stringToInt(params.getString(TABLE_TABLE + "." + PROP_SELECTEDROW));
    }
    public static int getTableLogicalIndex(dictionary params)
    {
        return utils.stringToInt(params.getString(TABLE_TABLE + "." + PROP_LOGICALINDEX));
    }
    public static String getEventType(dictionary params)
    {
        return params.getString("eventType");
    }
    public static void cancelCountdownTimer(obj_id self, int event)
    {
    ...
    public static boolean hasEventFlag(obj_id self, int flag)
    {
