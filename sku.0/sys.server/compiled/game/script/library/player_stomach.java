...
public class player_stomach extends script.base_script
{
    ...
    public static boolean resetStomachs(obj_id player)
    {
    ...
    public static boolean canAddToStomach(obj_id player, int stomach, int vol)
    {
        return true;
    }
    public static boolean canAddToStomach(obj_id player, int[] vol)
    {
        return true;
    }
    public static boolean addToStomach(obj_id player, int stomach, int vol)
    {
        return true;
    }
    public static boolean addToStomach(obj_id player, obj_id target, int stomach, int vol)
    {
        return true;
    }
    public static boolean addToStomach(obj_id player, obj_id target, int[] vol)
    {
        return true;
    }
    public static boolean addToStomach(obj_id player, int[] vol)
    {
        return addToStomach(player, player, vol);
    }
    public static int getStomach(obj_id player, int stomach)
    {
        if (player == null)
        {
            return -1;
    ...
    public static boolean digestAll(obj_id player)
    {
        boolean litmus = true;
        for (int i = 0; i < STOMACH_MAX; i++)
        {
    ...
    public static boolean isStomachFull(obj_id player, int stomach)
    {
        return false;
    }
    public static boolean deactivateStomachs(obj_id player)
    {
        if (player == null)
        {
            return false;
    ...
    public static String[] getStomachName()
    {
        return dataTableGetStringColumn(DATATABLE_STOMACH, COL_NAME);
    }
    public static String getStomachName(int idx)
    {
    ...
    public static int[] getStomachMaxSize()
    {
        return dataTableGetIntColumn(DATATABLE_STOMACH, COL_MAX_VALUE);
    }
    public static int getStomachMaxSize(int idx)
    {
    ...
    public static int[] getStomachDigestRate()
    {
        return dataTableGetIntColumn(DATATABLE_STOMACH, COL_DIGEST_RATE);
    }
    public static int getStomachDigestRate(int idx)
    {
    ...
    public static int[] getStomachDigestValue()
    {
        return dataTableGetIntColumn(DATATABLE_STOMACH, COL_DIGEST_VALUE);
    }
    public static int getStomachDigestValue(int idx)
    {
