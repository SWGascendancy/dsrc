...
public class combat extends script.base_script
{
    ...
    public static void sendCombatSpam(obj_id attacker, obj_id defender, obj_id weapon, combat_engine.hit_result result, string_id attackName, boolean sendToAttacker, boolean sendToDefender, boolean sendToBystanders)
    {
    ...
    public static void sendCombatSpam(obj_id attacker, obj_id defender, string_id weapon, combat_engine.hit_result result, string_id attackName, boolean sendToAttacker, boolean sendToDefender, boolean sendToBystanders)
    {
        sendCombatSpam(attacker, defender, weapon, result, attackName, sendToAttacker, sendToDefender, sendToBystanders, COMBAT_RESULT_GENERIC);
    }
    public static void sendCombatSpamMessage(obj_id player, string_id message)
    {
        sendCombatSpamMessage(player, message, COMBAT_RESULT_GENERIC);
    }
    public static void sendCombatSpamMessage(obj_id attacker, obj_id defender, string_id message, boolean sendToAttacker, boolean sendToDefender, boolean sendToBystanders)
    {
        sendCombatSpamMessage(attacker, defender, message, sendToAttacker, sendToDefender, sendToBystanders, COMBAT_RESULT_GENERIC);
    }
    public static void sendCombatSpamMessageProse(obj_id player, prose_package pp)
    {
        sendCombatSpamMessageProse(player, pp, COMBAT_RESULT_GENERIC);
    }
    public static void sendCombatSpamMessageProse(obj_id attacker, obj_id defender, prose_package pp, boolean sendToAttacker, boolean sendToDefender, boolean sendToBystanders)
    {
        sendCombatSpamMessageProse(attacker, defender, pp, sendToAttacker, sendToDefender, sendToBystanders, COMBAT_RESULT_GENERIC);
    }
    public static void doBasicCombatSpam(String attackName, attacker_results attackerResults, defender_results[] defenderResults, hit_result[] hitData)
    {
    ...
    public static void doBasicCombatSpam(string_id attackId, string_id weaponId, obj_id weapon, attacker_results attackerResults, defender_results[] defenderResults, hit_result[] hitData)
    {
        if (isIdValid(weapon))
        {
    ...
    public static boolean isAreaAttack(int attackType)
    {
    ...
    public static boolean breakMez(obj_id defender)
    {
    ...
    public static float getConBalanceScalar(int levelDiff)
    {
        float scale = (Math.abs(levelDiff) + AI_CON_SCALE_MULT) / (10f + AI_CON_SCALE_MULT);
        return scale;
    }
    public static int getWeaponDamage(obj_id objAttacker, obj_id objDefender, weapon_data cbtWeaponData, int intAttackerRoll, int intDefenderRoll)
    {
    ...
    public static int getAiDamage(obj_id attacker, obj_id defender, float minDamage, float maxDamage)
    {
        if (!isPlayer(attacker))
        {
    ...
    public static void assignDamageCredit(obj_id attacker, obj_id defender, weapon_data weaponData, int damage)
    {
    ...
    public static boolean expertiseRandomBuffChance(obj_id attacker, combat_data actionData)
    {
    ...
    public static boolean applyDefenderCombatBuffs(obj_id attacker, obj_id defender, weapon_data weaponData, combat_data actionData)
    {
    ...
    public static boolean applyAttackerCombatBuffs(obj_id attacker, combat_data actionData)
    {
        String actionName = actionData.actionName;
    ...
    public static float getExpertiseBuffDurationMods(obj_id buffCaster, combat_data actionData, String buffName, float buffDuration)
    {
    ...
    public static boolean applyCombatMovementModifier(obj_id attacker, obj_id defender, String actionName)
    {
    ...
    public static void removeCombatMovementModifierEffect(obj_id self, String buffName)
    {
        if (buffName == null || buffName.equals(""))
        {
            return;
    ...
    public static void removeCombatBuffEffect(obj_id self, String buffName)
    {
    ...
    public static boolean gainCombatActionAttribute(obj_id self, int action)
    {
    ...
    public static boolean drainCombatActionAttributes(obj_id self, int[] actionCost)
    {
    ...
    public static boolean canDrainCombatActionAttributes(obj_id self, int actionCost)
    {
        int[] tempArray = 
        {
            0,
    ...
    public static int canPerformAction(String actionName, obj_id self)
    {
    ...
    public static boolean isCommandoBonus(obj_id self, weapon_data weaponData, int commandType)
    {
    ...
    public static int getForceCost(obj_id self, weapon_data weaponData, dictionary actionData)
    {
        return 0;
    }
    public static int getForceCost(obj_id self, weapon_data weaponData, combat_data actionData)
    {
        return 0;
    }
    public static boolean validateTarget(obj_id target, int targetCheck)
    {
        obj_id self = getSelf();
    ...
    public static String getCreatureAnimationName(obj_id self, String playbackName, hit_result hitData, weapon_data weaponData)
    {
        String animName = "";
    ...
    public static boolean checkWeaponCerts(obj_id player, weapon_data weaponData)
    {
        return checkWeaponCerts(player, weaponData, true);
    }
    public static boolean checkWeaponCerts(obj_id player, weapon_data weaponData, boolean verbose)
    {
        if (!isPlayer(player))
        {
            return true;
    ...
    public static int applyArmorProtection(obj_id attacker, obj_id defender, weapon_data weaponData, hit_result hitData, float bypassArmor)
    {
        return applyArmorProtection(attacker, defender, weaponData, hitData, bypassArmor, 0f);
    }
    public static int applyArmorProtection(obj_id attacker, obj_id defender, weapon_data weaponData, hit_result hitData, float bypassArmor, float expertiseDamageBonus)
    {
    ...
    public static float scalePsgProtectionByBaseProtection(float basePsgProtection, float baseProtection)
    {
    ...
    public static obj_id getArmorPieceHit(obj_id defender, int hitLocation)
    {
    ...
    public static obj_id getPsgArmor(obj_id defender)
    {
    ...
    public static float getNpcArmorProtection(obj_id defender, int damageType)
    {
    ...
    public static float getArmorProtection(obj_id defender, obj_id armorPiece, obj_id psg, int damageType, float[] psgProtectionResult)
    {
        return getArmorProtection(defender, armorPiece, psg, damageType, psgProtectionResult, obj_id.NULL_ID);
    }
    public static float getArmorProtection(obj_id defender, obj_id armorPiece, obj_id psg, int damageType, float[] psgProtectionResult, obj_id attacker)
    {
        int generalProtection = 0;
    ...
    public static float getTerasKasiProtection(obj_id defender)
    {
    ...
    public static float convertProtectionToPercent(float protection)
    {
    ...
    public static float getArmorDecayPercentage(obj_id armorPiece)
    {
    ...
    public static float reduceArmorProtectionFromDecay(obj_id armorPiece, float value)
    {
        float ARMOR_REDUCTION_THRESHOLD = 0.5f;
        float hp = getHitpoints(armorPiece);
        float maxhp = getMaxHitpoints(armorPiece);
    ...
    public static void decayArmorPiece(obj_id armorPiece, float newDamage)
    {
    ...
    public static boolean getGrenadeData(obj_id player, weapon_data weaponData, String params, boolean verbose)
    {
        Long lngId;
        try
        {
    ...
    public static boolean canPaintTarget(obj_id squadLeader, obj_id target)
    {
        if (!isValidId(target))
        {
            return false;
    ...
    public static void doPaintTarget(obj_id squadLeader, obj_id target)
    {
        obj_id groupId = getGroupObject(squadLeader);
        obj_id[] groupMembers = getGroupMemberIds(groupId);
    ...
    public static boolean canUseWeaponWithAbility(obj_id self, weapon_data weaponData, combat_data actionData, boolean verbose)
    {
    ...
    public static boolean canUseWeaponWithAbility(obj_id self, weapon_data weaponData, String actionName, boolean verbose)
    {
    ...
    public static boolean cachedIsRidingVehicle(obj_id attacker)
    {
    ...
    public static boolean cachedIsGalloping(obj_id attacker)
    {
    ...
    public static boolean cachedIsDead(obj_id attacker)
    {
    ...
    public static boolean cachedIsIncapacitated(obj_id attacker)
    {
    ...
    public static int cachedGetLocomotion(obj_id attacker)
    {
    ...
    public static float cachedGetMovementSpeed(obj_id attacker)
    {
    ...
    public static float cachedGetRunSpeed(obj_id attacker)
    {
    ...
    public static float cachedGetDistance(obj_id attacker, obj_id defender)
    {
    ...
    public static float cachedGetSpeedAdjustMin(obj_id attacker, obj_id defender)
    {
    ...
    public static float cachedGetSpeedAdjustMax(obj_id attacker, obj_id defender)
    {
    ...
    public static boolean cachedCanSee(obj_id attacker, obj_id defender)
    {
        return canSee(attacker, defender);
    }
    public static boolean cachedPvpCanAttack(obj_id attacker, obj_id defender)
    {
    ...
    public static boolean cachedIsSameSocialGroup(obj_id attacker, obj_id defender)
    {
    ...
    public static boolean isCachedServerFrame(obj_id attacker)
    {
    ...
    public static void setCachedServerFrame(obj_id attacker)
    {
    ...
    public static boolean hasCachedCombatValue(obj_id attacker, String cacheId)
    {
        if (isCachedServerFrame(attacker))
        {
    ...
    public static int getCachedCombatValueInt(obj_id attacker, String cacheId)
    {
        if (isCachedServerFrame(attacker))
        {
    ...
    public static float getCachedCombatValueFloat(obj_id attacker, String cacheId)
    {
        if (isCachedServerFrame(attacker))
        {
    ...
    public static boolean getCachedCombatValueBool(obj_id attacker, String cacheId)
    {
        if (isCachedServerFrame(attacker))
        {
    ...
    public static void setCachedCombatValue(obj_id attacker, String cacheId, int value)
    {
        setCachedServerFrame(attacker);
        utils.setScriptVar(attacker, "combat.cache." + cacheId, value);
    }
    public static void setCachedCombatValue(obj_id attacker, String cacheId, float value)
    {
        setCachedServerFrame(attacker);
        utils.setScriptVar(attacker, "combat.cache." + cacheId, value);
    }
    public static void setCachedCombatValue(obj_id attacker, String cacheId, boolean value)
    {
        setCachedServerFrame(attacker);
        utils.setScriptVar(attacker, "combat.cache." + cacheId, value);
    }
    public static void combatLog(obj_id attacker, obj_id defender, String logName, String logMsg)
    {
        
    }
    public static int getWeaponCategory(String weaponType)
    {
    ...
    public static int getWeaponCategory(int weaponType)
    {
    ...
    public static String getWeaponStringCategory(int weaponType)
    {
    ...
    public static String getWeaponStringCategory(String weaponType)
    {
        int weaponCategory = getWeaponCategory(weaponType);
        if (weaponCategory == RANGED_WEAPON)
        {
    ...
    public static int getWeaponType(String weaponType)
    {
        if (weaponType.equals("rifle"))
        {
    ...
    public static int getCorrectedWeaponType(int passedType)
    {
        switch (passedType)
        {
            case WEAPON_TYPE_GROUND_TARGETTING:
    ...
    public static String getWeaponStringType(int weaponType)
    {
        switch (weaponType)
        {
            case WEAPON_TYPE_RIFLE:
    ...
    public static boolean isMeleeWeapon(obj_id weapon)
    {
        int weaponType = getWeaponType(weapon);
        return isMeleeWeapon(weaponType);
    }
    public static boolean isMeleeWeapon(int weaponType)
    {
        return hasBit(weaponType, B_MELEE);
    }
    public static boolean isRangedWeapon(obj_id weapon)
    {
        int weaponType = getWeaponType(weapon);
        return isRangedWeapon(weaponType);
    }
    public static boolean isHeavyWeapon(int weaponType)
    {
        return hasBit(weaponType, B_HEAVY);
    }
    public static boolean isHeavyWeapon(obj_id weapon)
    {
        int weaponType = getWeaponType(weapon);
        return hasBit(weaponType, B_HEAVY);
    }
    public static boolean isRangedWeapon(int weaponType)
    {
        return hasBit(weaponType, B_RANGED);
    }
    public static boolean isLightsaberWeapon(obj_id weapon)
    {
        int weaponType = getWeaponType(weapon);
        return isLightsaberWeapon(weaponType);
    }
    public static boolean isLightsaberWeapon(int weaponType)
    {
        return hasBit(weaponType, B_ALL_LIGHTSABERS);
    }
    public static boolean isGrenade(weapon_data weaponData)
    {
        return hasBit(weaponData.weaponType, B_THROWN);
    }
    public static boolean isHeavyWeapon(weapon_data weaponData)
    {
        return hasBit(weaponData.weaponType, B_HEAVY);
    }
    public static boolean canApplyCombatEffect(obj_id objPlayer)
    {
    ...
    public static boolean hasCertification(obj_id objPlayer, obj_id objWeapon)
    {
    ...
    public static void applyCombatSpeedDelay(obj_id target, float delay, int duration)
    {
    ...
    public static void doCombatDebuffs(obj_id self)
    {
    ...
    public static boolean clearCombatDebuffs(obj_id self)
    {
    ...
    public static boolean isInCombat(obj_id objTarget)
    {
        return getState(objTarget, STATE_COMBAT) > 0 ? true : false;
    }
    public static String getAttackName(obj_id self)
    {
    ...
    public static String getBestAction(obj_id player, String actionName)
    {
        for (int i = 2; i > 0; i--)
        {
    ...
    public static String getActionAnimation(combat_data actionData, String weaponType)
    {
        String animation = "";
        if (weaponType.equals("unarmed"))
        {
    ...
    public static String getCreatureAnimationName(String playbackName)
    {
        obj_id self = getSelf();
        String animName = "";
        int niche = ai_lib.aiGetNiche(self);
    ...
    public static obj_id makeTrackerEgg(obj_id objPlayer, location locTest, combat_data actionData)
    {
    ...
    public static int makeBit(int bit)
    {
        return (1 << (bit - 1));
    }
    public static boolean hasBit(int weaponType, int bitValue)
    {
        if (weaponType == -1)
        {
            return false;
    ...
    public static color getCriticalColor(int hitDataCritDamage)
    {
    ...
    public static float getMissChance(attacker_data attackerData, defender_data defenderData, combat_data actionData, boolean autoAim)
    {
    ...
    public static float getAttackerMissChance(attacker_data attackerData, combat_data actionData, boolean autoAim)
    {
    ...
    public static float getDefenderMissChance(defender_data defenderData, combat_data actionData, boolean autoAim)
    {
    ...
    public static float getGlancingBlowChance(attacker_data attackerData, defender_data defenderData, combat_data actionData)
    {
        obj_id attacker = attackerData.id;
        obj_id defender = defenderData.id;
    ...
    public static float getDefenderGlancingBlowChance(obj_id defender)
    {
        float glancingChance = 0.0f;
        boolean isRangedDefender = isRangedWeapon(getCurrentWeapon(defender));
        if (!isRangedDefender)
    ...
    public static float getAttackerGlancingReduction(obj_id attacker)
    {
    ...
    public static float getPunishingBlowChance(attacker_data attackerData, defender_data defenderData)
    {
        obj_id attacker = attackerData.id;
        obj_id defender = defenderData.id;
    ...
    public static float getDefenderPunishingBlowReduction(obj_id defender)
    {
        float punishingChance = 0.0f;
    ...
    public static float getDodgeChance(attacker_data attackerData, defender_data defenderData, combat_data actionData)
    {
        obj_id attacker = attackerData.id;
        obj_id defender = defenderData.id;
    ...
    public static float getAttackerDodgeReduction(obj_id attacker)
    {
    ...
    public static float getParryChance(attacker_data attackerData, defender_data defenderData, combat_data actionData)
    {
    ...
    public static float getAttackerParryReduction(obj_id attacker)
    {
    ...
    public static float getBlockChance(attacker_data attackerData, defender_data defenderData, combat_data actionData)
    {
    ...
    public static float getAttackerBlockReduction(obj_id attacker)
    {
    ...
    public static float getEvasionChance(attacker_data attackerData, defender_data defenderData)
    {
    ...
    public static float getAttackerEvasionReduction(obj_id attacker)
    {
        return 0.0f;
    }
    public static float getHitReductionChance(obj_id player)
    {
        return getEnhancedSkillStatisticModifierUncapped(player, "expertise_critical_hit_reduction");
    }
    public static float getPvPHitReductionChance(obj_id player)
    {
        return getEnhancedSkillStatisticModifierUncapped(player, "expertise_critical_hit_pvp_reduction");
    }
    public static float getEvasionRoll(obj_id player)
    {
    ...
    public static float getCriticalHitChance(attacker_data attackerData, defender_data defenderData, combat_data actionData, boolean autoAiming)
    {
        obj_id attacker = attackerData.id;
        obj_id defender = defenderData.id;
    ...
    public static float getDefenderCriticalChance(obj_id defender)
    {
    ...
    public static float getStrikethroughChance(attacker_data attackerData, defender_data defenderData, combat_data actionData)
    {
    ...
    public static float getDefenderStrikethroughReduction(obj_id player)
    {
        float strikethroughChance = 0.0f;
        strikethroughChance -= (float)getEnhancedSkillStatisticModifierUncapped(player, "strikethrough_vulnerable");
        return strikethroughChance;
    }
    public static float getStrikethroughValue(obj_id attacker, obj_id defender)
    {
        return getAttackerStrikethroughValue(attacker);
    }
    public static float getAttackerStrikethroughValue(obj_id player)
    {
    ...
    public static float getToHitBonus(obj_id player)
    {
        float hitBonus = 0.0f;
    ...
    public static float getDefenderHitReduction(obj_id player)
    {
        float increaseMiss = 0.0f;
        return increaseMiss;
    }
    public static attacker_data fillAttackerCombatAttributes(attacker_data attackerData)
    {
    ...
    public static defender_data fillDefenderCombatAttributes(defender_data defenderData)
    {
    ...
    public static void cacheCombatData(obj_id self)
    {
        cacheAttackerData(self);
        cacheDefenderData(self);
    }
    public static void clearCachedCombatData(obj_id self)
    {
        utils.removeScriptVarTree(self, ATTACKER_DATA);
        utils.removeScriptVarTree(self, DEFENDER_DATA);
    }
    public static void cacheAttackerData(obj_id attacker)
    {
    ...
    public static void cacheDefenderData(obj_id defender)
    {
    ...
    public static obj_id getRandomHateTarget(obj_id self)
    {
    ...
    public static boolean doBhTaunt(obj_id player, obj_id target)
    {
    ...
    public static boolean dsFsTaunt(obj_id player, obj_id target)
    {
    ...
    public static boolean isStunned(obj_id target)
    {
        return utils.hasScriptVar(target, TEMP_COMBAT_BLOCK);
    }
    public static int[] getSuccessBasedSingleTargetActionCost(hit_result hitData, combat_data actionData, obj_id attacker, weapon_data weaponData)
    {
    ...
    public static void setPersistCombatMode(obj_id target, boolean state)
    {
        if (!isMob(target))
        {
            return;
    ...
    public static boolean isPersistCombatMode(obj_id self)
    {
        return utils.hasScriptVar(self, combat.PERSIST_COMBAT);
    }
    public static boolean isValidPersistCombat(obj_id self)
    {
    ...
    public static boolean isDamageImmune(obj_id attacker, obj_id defender, combat_data actionData)
    {
    ...
    public static float getDiminishedReturnValue(float value, int modType)
    {
        if (value < 0.0f)
        {
            return value;
    ...
    public static void mirrorArmor(obj_id commando)
    {
    ...
    public static boolean setKillMeter(obj_id player, int value)
    {
    ...
    public static boolean modifyKillMeter(obj_id player, int value)
    {
        int current = getKillMeter(player);
    ...
    public static boolean canDrainKillMeter(obj_id player, int value)
    {
        if (!isPlayer(player))
        {
            return true;
    ...
    public static boolean drainKillMeter(obj_id player, int value)
    {
        if (!isPlayer(player))
        {
            return true;
    ...
    public static location getCommandGroundTargetLocation(String params)
    {
    ...
    public static float getDevastationChance(obj_id attacker)
    {
    ...
    public static float getElementalPenetration(obj_id attacker, String damageString)
    {
    ...
    public static boolean hasPrescience(obj_id attacker, obj_id defender, combat_data actionData)
    {
