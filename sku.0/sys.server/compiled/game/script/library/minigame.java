...
public class minigame extends script.base_script
{
    ...
    public static boolean startFishing(obj_id target)
    {
    ...
    public static void stopFishing(obj_id target, boolean animate)
    {
    ...
    public static void stopFishing(obj_id target)
    {
        stopFishing(target, true);
    }
    public static boolean isPoleInUse(obj_id pole)
    {
        if (!isIdValid(pole))
        {
            return false;
    ...
    public static void playCastSplash(obj_id target, dictionary params)
    {
    ...
    public static void initializeFishingData(obj_id target, obj_id pole, location castLoc)
    {
    ...
    public static void cleanupFishing(obj_id target)
    {
        if (!isIdValid(target))
        {
            return;
    ...
    public static boolean isFishing(obj_id target)
    {
        if (!isIdValid(target))
        {
            return false;
    ...
    public static boolean isFishingPole(obj_id target)
    {
        if (!isIdValid(target))
        {
            return false;
    ...
    public static void updateBaitStatus(obj_id target)
    {
    ...
    public static void cleanupBait(obj_id target, obj_id pole)
    {
    ...
    public static boolean isFishingPoleBaited(obj_id pole)
    {
        if (!isIdValid(pole))
        {
            return false;
    ...
    public static obj_id getBait(obj_id pole)
    {
        if (!isIdValid(pole))
        {
            return null;
    ...
    public static int getBaitStatus(obj_id target)
    {
        if (!isIdValid(target))
        {
            return -1;
    ...
    public static String getEncodedBaitStatus(int status)
    {
    ...
    public static location getFishingCastLocation(obj_id target)
    {
        if (!isIdValid(target))
        {
            return null;
    ...
    public static float getFishingCastTime(float range)
    {
        if (range < 0f)
        {
            return -1f;
    ...
    public static boolean isLocationFishable(location loc)
    {
        if (loc != null)
        {
    ...
    public static int showFishingSui(obj_id target)
    {
    ...
    public static String getStars(float eff)
    {
        if (eff < 0.16f)
        {
            return "";
    ...
    public static void closeFishingSui(obj_id target)
    {
    ...
    public static void defaultFishingUpdate(obj_id target, int action)
    {
        if (!isIdValid(target))
        {
            return;
    ...
    public static void updateFishingLocation(obj_id target, int action, boolean caught)
    {
    ...
    public static void updateFishingLocation(obj_id target, int action)
    {
        updateFishingLocation(target, action, false);
    }
    public static void setFishingState(obj_id target, int state)
    {
    ...
    public static void updateFishingWaitState(obj_id target)
    {
        if (!isIdValid(target))
        {
            return;
    ...
    public static boolean checkForNibble(obj_id target)
    {
        if (!isIdValid(target))
        {
            return false;
    ...
    public static boolean checkForBite(obj_id target, float superBonus)
    {
        if (!isIdValid(target))
        {
            return false;
    ...
    public static boolean checkForBite(obj_id target)
    {
        return checkForBite(target, 0f);
    }
    public static boolean checkForCatch(obj_id target, float superBonus)
    {
        if (!isIdValid(target))
        {
            return false;
    ...
    public static boolean checkForCatch(obj_id target)
    {
        return checkForCatch(target, 0f);
    }
    public static boolean checkForSnag(obj_id target, location loc)
    {
    ...
    public static float getFishEfficiency(location loc)
    {
        if (loc == null)
        {
            return -1f;
    ...
    public static float getVegetationSnagFactor(location loc)
    {
        if (loc == null)
        {
            return -1f;
    ...
    public static void freeSnaggedLine(obj_id target)
    {
        if (!isIdValid(target))
        {
            return;
    ...
    public static void snapFishingLine(obj_id target)
    {
        if (!isIdValid(target))
        {
            return;
    ...
    public static void spoolFishingLine(obj_id target)
    {
        if (!isIdValid(target))
        {
            return;
    ...
    public static void caughtLoot(obj_id target)
    {
        if (!isIdValid(target))
        {
            return;
    ...
    public static void lostBait(obj_id target)
    {
        if (!isIdValid(target))
        {
            return;
    ...
    public static void decrementBait(obj_id target)
    {
        if (!isIdValid(target))
        {
            return;
    ...
    public static int[] getGoodActions()
    {
    ...
    public static void confirmReelIn(obj_id target, location castLoc)
    {
    ...
    public static void loseCatch(obj_id target)
    {
        if (!isIdValid(target))
        {
            return;
    ...
    public static void markerFlyText(obj_id target, string_id sid, color textColor)
    {
        if (!isIdValid(target))
        {
            return;
    ...
    public static float getPoleBonus(obj_id target)
    {
        if (!isIdValid(target))
        {
            return 0f;
    ...
    public static obj_id spawnFishingFish(obj_id target, location castLoc)
    {
    ...
    public static dictionary getFishData(obj_id target, location castLoc)
    {
        if (!isIdValid(target))
        {
            return null;
    ...
    public static boolean setFishData(obj_id fish, dictionary params, obj_id player, location castLoc)
    {
    ...
    public static boolean filetFish(obj_id target, obj_id fish)
    {
    ...
    public static boolean trophyFish(obj_id target, obj_id fish)
    {
        if (!isIdValid(target) || !isIdValid(fish))
        {
            return false;
    ...
    public static void createVegetation(obj_id target, obj_id inv, location castLoc)
    {
    ...
    public static obj_id[] spawnFishingLoot(obj_id target, location castLoc)
    {
        if (!isIdValid(target) || castLoc == null)
        {
            return null;
