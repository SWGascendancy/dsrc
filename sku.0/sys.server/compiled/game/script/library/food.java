...
public class food extends script.base_script
{
    ...
    public static void applyInstantEffect(obj_id target, obj_id item)
    {
    ...
    public static void petEatFood(obj_id self, obj_id master, obj_id item, obj_id player)
    {
    ...
    public static void instantBurstRun(obj_id target, obj_id item, int v1, int v2)
    {
    ...
    public static void instantWookieeRoar(obj_id target, obj_id item, int v1, int v2)
    {
        utils.setScriptVar(target, "food.wookiee_roar.v1", v1);
        queueCommand(target, (-1223315403), null, "", COMMAND_PRIORITY_IMMEDIATE);
    }
    public static void instantSlowDot(obj_id target, obj_id item, int v1, int v2)
    {
    ...
    public static void instantCureFire(obj_id target, obj_id item, int v1, int v2)
    {
    ...
    public static void instantEnhancedRegen(obj_id target, obj_id item, int v1, int v2)
    {
        utils.setScriptVar(target, "food.enhanced_regen.v1", v1);
        queueCommand(target, (1397846664), null, "", COMMAND_PRIORITY_IMMEDIATE);
    }
    public static void instantFoodReduce(obj_id target, obj_id item, int v1, int v2)
    {
