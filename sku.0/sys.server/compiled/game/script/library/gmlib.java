...
public class gmlib extends script.base_script
{
    ...
    public static String freezePlayer(long playerId)
    {
    ...
    public static void unFreezePlayer(long playerId)
    {
        obj_id target = obj_id.getObjId(playerId);
        if (!isIdValid(target))
        {
    ...
    public static void generateStaticItem(obj_id targetid, String item_name)
    {
