...
public class space_content extends script.base_script
{
    ...
    public static void landPlayer(obj_id objPlayer, obj_id objStation, String strDestination)
    {
    ...
    public static String getPlanetForLaunchLocation(String pointName)
    {
    ...
    public static void notifySpawner(obj_id objObject)
    {
    ...
    public static void landPlayerHoming(obj_id objPlayer, obj_id objStation)
    {
        float fltDistance = getDistance(objStation, space_transition.getContainingShip(objPlayer));
        if (fltDistance > space_transition.STATION_COMM_MAX_DISTANCE)
        {
