...
public class faction_perk extends script.base_script
{
    ...
    public static int prejudicePerkCost(obj_id player, String faction, int base_cost)
    {
    ...
    public static float getFactionPrejudice(int species, String faction)
    {
    ...
    public static boolean canDeployFactionalDeed(obj_id player, obj_id deed)
    {
    ...
    public static void decloakCovertFactionMember(obj_id detector, obj_id player)
    {
    ...
    public static boolean displayAvailableFactionItemRanks(obj_id player, obj_id npc, int playerGcwRank, String playerGcwFaction)
    {
        if (playerGcwRank > 0)
        {
    ...
    public static boolean displayItemPurchaseSUI(obj_id player, int rank, String faction, obj_id objNPC)
    {
        return displayItemPurchaseSUI(player, rank, faction, 1.0f, objNPC);
    }
    public static boolean displayItemPurchaseSUI(obj_id player, int rank, String faction)
    {
        return displayItemPurchaseSUI(player, rank, faction, 1.0f);
    }
    public static boolean displayItemPurchaseSUI(obj_id player, int rank, String faction, float systemMultiplier)
    {
        return displayItemPurchaseSUI(player, rank, faction, systemMultiplier, null);
    }
    public static boolean displayItemPurchaseSUI(obj_id player, int rank, String faction, float systemMultiplier, obj_id objRecruiter)
    {
        obj_id self = getSelf();
    ...
    public static float getModifiedGCWCost(float fltCost, obj_id objNPC, String strFaction)
    {
    ...
    public static void factionItemPurchased(dictionary params)
    {
    ...
    public static void applyFactionCostObjvarFromSchematic(obj_id craftedObject, obj_id manfSchematic)
    {
    ...
    public static boolean isValidReconTarget(obj_id player, obj_id target)
    {
    ...
    public static String[] getReconReport(obj_id player, obj_id target)
    {
        if (!isIdValid(player) || !isIdValid(target))
        {
            return null;
    ...
    public static void giveBonusBaseDeeds(obj_id player, obj_id inv, String item_template, String faction, int declared)
    {
        int level = 1;
    ...
    public static int grabFactionBasePointValue(obj_id base)
    {
    ...
    public static boolean executeComlinkReinforcements(obj_id player)
    {
    ...
    public static obj_id getPlayerComlink(obj_id player)
    {
    ...
    public static boolean spawnTroopers(obj_id player)
    {
