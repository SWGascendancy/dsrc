...
public class slicing extends script.base_script
{
    ...
    public static void startSlicing(obj_id player, obj_id item, String callback, String type)
    {
    ...
    public static void clearSlicing(obj_id player)
    {
    ...
    public static void slicingQuery(obj_id player, obj_id item, String query)
    {
    ...
    public static void handleSlicingCategory(obj_id player, int idx)
    {
    ...
    public static void handleSlicingSelect(obj_id player, int idx)
    {
    ...
    public static void handleApplySlice(obj_id player, int idx)
    {
    ...
    public static void successSlicing(obj_id player, obj_id item, int row)
    {
    ...
    public static void failSlicing(obj_id player, obj_id item)
    {
        String callback = utils.getStringScriptVar(player, "slicing.callback");
        dictionary outp = new dictionary();
        outp.put("success", 0);
    ...
    public static void consumeComponent(obj_id item)
    {
