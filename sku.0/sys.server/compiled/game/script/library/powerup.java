...
public class powerup extends script.base_script
{
    ...
    public static void getWeaponAttributes(obj_id player, obj_id weapon, String[] names, String[] attribs, boolean forWeapon)
    {
    ...
    public static boolean hasPowerUpInstalled(obj_id weapon)
    {
        return hasObjVar(weapon, VAR_POWERUP_BASE);
    }
    public static boolean powerUpDecay(obj_id weapon)
    {
    ...
    public static boolean applyPowerup(obj_id player, obj_id powerup, obj_id target)
    {
    ...
    public static boolean cleanupWeaponPowerup(obj_id weapon)
    {
    ...
    public static void decrementUseCounter(obj_id target)
    {
        if (!isIdValid(target))
        {
            return;
