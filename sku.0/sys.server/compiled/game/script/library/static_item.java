...
public class static_item extends script.base_script
{
    ...
    public static obj_id createNewItemFunction(String itemName, obj_id container)
    {
        return createNewItemFunction(itemName, container, null, 0);
    }
    public static obj_id createNewItemFunction(String itemName, obj_id container, int charges)
    {
        return createNewItemFunction(itemName, container, null, charges);
    }
    public static obj_id createNewItemFunction(String itemName, obj_id container, location pos)
    {
        return createNewItemFunction(itemName, container, pos, 0);
    }
    public static obj_id createNewItemFunction(String itemName, obj_id container, location pos, int charges)
    {
    ...
    public static void initializeObject(obj_id object, dictionary itemData)
    {
    ...
    public static boolean initializeArmor(obj_id object, String itemName)
    {
    ...
    public static boolean initializeWeapon(obj_id object, String itemName)
    {
    ...
    public static boolean initializeItem(obj_id object, String itemName)
    {
    ...
    public static boolean initializeStorytellerObject(obj_id newObject, String itemName)
    {
    ...
    public static void setObjVarString(obj_id object, String objVarString)
    {
        setObjVarString(object, objVarString, -1);
    }
    public static void setObjVarString(obj_id object, String objVarString, int type)
    {
    ...
    public static void setScriptString(obj_id object, String scriptString)
    {
        setScriptString(object, scriptString, -1);
    }
    public static void setScriptString(obj_id object, String scriptString, int type)
    {
        switch (type)
        {
    ...
    public static boolean validateLevelRequired(obj_id player, obj_id item)
    {
    ...
    public static boolean validateLevelRequiredForWornEffect(obj_id player, obj_id item)
    {
        int playerLevel = getLevel(player);
    ...
    public static void decrementStaticItem(obj_id item)
    {
        if (!isIdValid(item))
        {
            return;
    ...
    public static void decrementStaticItemAmount(obj_id item, int amount)
    {
        if (!isIdValid(item))
        {
            return;
    ...
    public static void decrementUnstackedStaticItemAmount(obj_id[] items, int amount)
    {
    ...
    public static dictionary getMasterItemDictionary(String itemName)
    {
        if (itemName == null || itemName.equals(""))
        {
    ...
    public static dictionary getMasterItemDictionary(obj_id item)
    {
        if (isIdValid(item))
        {
            String itemName = getStaticItemName(item);
    ...
    public static boolean isStaticItem(obj_id item)
    {
        String itemName = getStaticItemName(item);
        return !(itemName == null || itemName.equals(""));
    }
    public static boolean isStaticItem(String itemName)
    {
        int rowNum = dataTableSearchColumnForString(itemName, 0, MASTER_ITEM_TABLE);
        return rowNum != -1;
    }
    public static int getStaticObjectType(String itemName)
    {
        return dataTableGetInt(MASTER_ITEM_TABLE, itemName, "type");
    }
    public static int getStaticObjectValue(String itemName)
    {
        return dataTableGetInt(MASTER_ITEM_TABLE, itemName, "value");
    }
    public static dictionary getStaticObjectTypeDictionary(String itemName)
    {
        if (itemName == null || itemName.equals(""))
        {
    ...
    public static dictionary getStaticItemWeaponDictionary(String itemName)
    {
        if (itemName == null || itemName.equals(""))
        {
            LOG("create", " Itemname is Bad " + itemName);
    ...
    public static dictionary getStaticItemWeaponDictionary(obj_id item)
    {
        if (isIdValid(item))
        {
            String itemName = getStaticItemName(item);
    ...
    public static dictionary getStaticItemDictionary(String itemName)
    {
        if (itemName == null || itemName.equals(""))
        {
            LOG("create", " Itemname is Bad " + itemName);
    ...
    public static dictionary getStaticItemDictionary(obj_id item)
    {
        if (isIdValid(item))
        {
            String itemName = getStaticItemName(item);
    ...
    public static dictionary getStaticArmorDictionary(String itemName)
    {
        if (itemName == null || itemName.equals(""))
        {
            LOG("create", " Itemname is Bad " + itemName);
    ...
    public static dictionary getStaticArmorDictionary(obj_id item)
    {
        if (isIdValid(item))
        {
            String itemName = getStaticItemName(item);
    ...
    public static void versionUpdate(obj_id self, dictionary itemData)
    {
    ...
    public static void validateWornEffects(obj_id player)
    {
    ...
    public static void applyWornBuffs(obj_id self, obj_id player)
    {
    ...
    public static void removeWornBuffs(obj_id self, obj_id player)
    {
        String itemName = getStaticItemName(self);
        if (itemName == null || itemName.equals(""))
        {
    ...
    public static void checkForAddSetBonus(obj_id item, obj_id player)
    {
    ...
    public static void checkForRemoveSetBonus(obj_id item, obj_id player)
    {
        if (!isSetBonusItem(item))
        {
            return;
    ...
    public static boolean isSetBonusItem(obj_id item)
    {
        return hasObjVar(item, "item.set.set_id");
    }
    public static int getSetBonusIndex(obj_id item)
    {
        int setBonusIndex = -1;
        if (!isIdValid(item))
        {
    ...
    public static int getNumSetItems(obj_id player, obj_id item, int setBonusIndex)
    {
        int numSetItems = 0;
        if (setBonusIndex == -1)
        {
    ...
    public static String getSetBonusBuffName(obj_id item, int setBonusIndex, int numberOfSetItems)
    {
    ...
    public static dictionary getMergedItemDictionary(String itemName)
    {
    ...
    public static void getAttributes(obj_id player, String staticItemName, String[] names, String[] attribs)
    {
    ...
    public static void getStaticWeaponObjectAttributes(obj_id player, String staticItemName, String[] names, String[] attribs)
    {
    ...
    public static void getStaticArmorObjectAttributes(obj_id player, String staticItemName, String[] names, String[] attribs)
    {
        String at = "@obj_attr_n:";
        int free = 0;
        dictionary itemData = static_item.getMergedItemDictionary(staticItemName);
    ...
    public static final String[] EXCEPTIONAL_LOOT = dataTableGetStringColumn("datatables/loot/loot_items/rls/exceptional_loot.iff", "strItemType");
    public static final String[] LEGENDARY_LOOT = dataTableGetStringColumn("datatables/loot/loot_items/rls/legendary_loot.iff", "strItemType");
    public static final String[] RARE_LOOT = dataTableGetStringColumn("datatables/loot/loot_items/rls/rare_loot.iff", "strItemType");
    public static final String[][] LOOT = { EXCEPTIONAL_LOOT, LEGENDARY_LOOT, RARE_LOOT };

    public static void getStaticItemObjectAttributes(obj_id player, String item_name, String[] names, String[] attribs)
    {
        String at = "@obj_attr_n:";
        int free = 0;
    ...
    public static dictionary parseSkillModifiers(obj_id player, String skillMods)
    {
        dictionary dict = new dictionary();
    ...
    public static obj_id makeDynamicObject(String strName, obj_id objContainer, int intLevel)
    {
        int whatRow = -1;
        if (intLevel > 90)
        {
    ...
    public static obj_id setupDynamicArmor(obj_id objArmor, int intLevel)
    {
        return setupDynamicArmor(objArmor, intLevel, null, false);
    }
    public static obj_id setupDynamicArmor(obj_id objArmor, int intLevel, dictionary dctItemInfo, boolean boolSetupData)
    {
    ...
    public static float getDynamicWeaponRange(obj_id weapon)
    {
    ...
    public static obj_id setupDynamicWeapon(obj_id objWeapon, String itemName, int intLevel, dictionary dctWeaponStats, dictionary dctItemInfo, boolean boolSetupData)
    {
    ...
    public static void generateItemStatBonuses(obj_id item, int level, dictionary dctItemInfo)
    {
    ...
    public static int generateStatMod(int level)
    {
    ...
    public static String getArmorNameSuffix(obj_id item)
    {
    ...
    public static void setupJunkDealerPrice(obj_id objObject, int intMinValue, int intMaxValue, float fltRange)
    {
        if (fltRange != 0)
        {
    ...
    public static dictionary applyWeaponItemModifers(obj_id objWeapon, String strModifier, int intMinDamage, int intMaxDamage, dictionary dctItemNames)
    {
    ...
    public static void setupDynamicItemName(obj_id objItem, dictionary dctNames)
    {
    ...
    public static boolean isDynamicItem(obj_id objItem)
    {
        return hasObjVar(objItem, "dynamic_item");
    }
    public static boolean isUniqueStaticItem(obj_id item)
    {
    ...
    public static boolean isUniqueStaticItem(String item)
    {
    ...
    public static boolean canCreateUniqueStaticItem(obj_id container, String itemName) {
        return !isPlayer(getOwner(container)) || (!utils.playerHasStaticItemInBankOrInventory(getOwner(container), itemName));
    }
    public static boolean canEquip(obj_id player, obj_id item)
    {
    ...
    public static void origOwnerCheckStamp(obj_id object, obj_id player)
    {
    ...
    public static boolean userIsOrigOwner(obj_id object, obj_id player)
    {
    ...
    public static string_id getStaticItemStringIdName(obj_id object)
    {
