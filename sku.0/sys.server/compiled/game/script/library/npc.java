...
public class npc extends script.base_script
{
    ...
    public static obj_id createNpc(String type, obj_id box, float x, float z)
    {
    ...
    public static String chooseName(int number)
    {
        debugServerConsoleMsg(getSelf(), "WARNING: SOMETHING IS STILL USING NPC.SCRIPTLIB chooseName( int number )");
        return null;
    }
    public static void dressUp(obj_id npc, String type, String gender)
    {
    ...
    public static void dressHair(obj_id npc, String name, String gender)
    {
    ...
    public static obj_id makeStormtrooperInside(obj_id bldg, String cellName)
    {
