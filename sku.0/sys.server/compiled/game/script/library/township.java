...
public class township extends script.base_script
{
    ...
    public static boolean isTownshipEligible(obj_id player)
    {
        if (!isIdValid(player))
        {
    ...
    public static boolean giveTravelListFromAurilia(obj_id player, obj_id npc)
    {
    ...
    public static boolean displayTravelListBySub(obj_id player, obj_id npc, String sub)
    {
        if (!isIdValid(player) || !exists(player))
        {
            return false;
    ...
    public static int getMidlitheCrystalCount(obj_id player)
    {
        if (!isIdValid(player) || !exists(player))
        {
            return 0;
    ...
    public static void clearAllNovaOrionQuestStatus(obj_id player)
    {
    ...
    public static string_id getNovaOrionRumor(obj_id player)
    {
