...
public class list extends script.base_script
{
    ...
    public static obj_var[] sortToArray(obj_var_list ovl)
    {
    ...
    public static obj_var[] quickSort(int left, int right, obj_var[] listArray)
    {
        if (right - left <= 0)
        {
            return listArray;
    ...
    public static int partitionIntArray(int left, int right, int pivot, obj_var[] listArray)
    {
        int leftPtr = left - 1;
        int rightPtr = right;
        while (true)
    ...
    public static int partitionFloatArray(int left, int right, float pivot, obj_var[] listArray)
    {
        int leftPtr = left - 1;
        int rightPtr = right;
        while (true)
    ...
    public static void swap(int dex1, int dex2, obj_var[] listArray)
    {
        obj_var temp = listArray[dex1];
        listArray[dex1] = listArray[dex2];
        listArray[dex2] = temp;
    }
    public static obj_var[] listToArray(obj_var_list ovl)
    {
    ...
    public static obj_var_list[] listToListArray(obj_var_list ovl)
    {
        int cnt = ovl.getNumItems();
