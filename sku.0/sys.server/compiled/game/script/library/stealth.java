...
public class stealth extends script.base_script
{
    ...
    public static void setBioProbeData(obj_id trap, obj_id target, String targetName)
    {
    }
    public static void setTriggerData(obj_id trap, int triggerType, int accuracy, int param)
    {
    ...
    public static void createRangerLoot(int level, String object, obj_id container, int count)
    {
    ...
    public static void createRangerLoot(obj_id mob, int level, String object, obj_id container)
    {
        createRangerLoot(level, object, container, -1);
    }
    public static int getNumLootItems(int level, obj_id destContainer)
    {
    ...
    public static int getPowerLevel(int level, boolean includeVariance)
    {
        if (includeVariance)
        {
    ...
    public static obj_id createHEPObject(obj_id container, int power, int count)
    {
    ...
    public static obj_id createTrackingBeaconObject(obj_id container, float power, int count)
    {
    ...
    public static obj_id createBioProbeObject(obj_id container, float power, int count)
    {
    ...
    public static obj_id createMotionSensorObject(obj_id container, float batteryPower, int count)
    {
    ...
    public static obj_id createChaffFlareObject(obj_id container, int power, int count)
    {
    ...
    public static obj_id createTrapObject(obj_id container, int power, int trapType, int count, int triggerType, int triggerAccuracy, int triggerParam)
    {
        String template;
        switch (trapType)
        {
    ...
    public static boolean canPlaceMotionSensor(obj_id player, obj_id sensor)
    {
    ...
    public static void placeMotionSensor(obj_id player, obj_id sensor)
    {
    ...
    public static void tripMotionSensor(obj_id sensor, obj_id breacher, boolean wasFiltered)
    {
    ...
    public static void cleanComponentFromContainer(obj_id component, obj_id container)
    {
    ...
    public static boolean canActivateTrackingBeacon(obj_id player, obj_id beacon, boolean silent)
    {
    ...
    public static void startTrackingBeacon(obj_id player, obj_id beacon)
    {
    ...
    public static void stopTrackingBeacon(obj_id beacon, obj_id player)
    {
        if (hasObjVar(beacon, BEACON_MSG_DISPATCHED))
        {
    ...
    public static void updateTrackingBeaconDisplay(obj_id beacon)
    {
    ...
    public static void updateTrackingBeaconData(obj_id beacon, obj_id target, location targetLoc, String targetName)
    {
    ...
    public static obj_id getBioProbeTarget(obj_id thing)
    {
        obj_id target = null;
    ...
    public static boolean canBioProbe(obj_id player, obj_id probe, obj_id target)
    {
        if (!isIdValid(target))
        {
    ...
    public static void bioProbe(obj_id player, obj_id probe, obj_id target)
    {
    ...
    public static void doChaffFlareEffect(obj_id player, obj_id flare)
    {
    ...
    public static boolean canDisarmTrap(obj_id player, obj_id trap)
    {
    ...
    public static void disarmTrap(obj_id player, obj_id trap)
    {
    ...
    public static boolean canDetectCamouflage(obj_id player)
    {
        return true;
    }
    public static void detectCamouflage(obj_id player, boolean findMobiles, boolean findInanimate, float distance, float baseChanceToDetect)
    {
    ...
    public static boolean canConcealDevice(obj_id player, obj_id target)
    {
    ...
    public static void concealDevice(obj_id player, obj_id target)
    {
    ...
    public static void unconcealDevice(obj_id player, obj_id target)
    {
    ...
    public static boolean canSetTrap(obj_id player, obj_id trap)
    {
    ...
    public static boolean inTrapRestrictedRegion(obj_id player)
    {
    ...
    public static void onGetTrapAttributes(obj_id self, obj_id player, String[] names, String[] attribs, int free)
    {
        if (free == -1)
        {
            return;
    ...
    public static boolean tryDetonateTrap(obj_id trap, obj_id target)
    {
    ...
    public static Vector getTrapTargets(obj_id trap, int trapType)
    {
    ...
    public static void doTrapDetonateEffect(obj_id trap, int trapType, Vector targets, float percentMod, obj_id breacher)
    {
        if (targets.size() > 0)
        {
            switch (trapType)
    ...
    public static void doTrapDetonateEffect(obj_id trap, int trapType, Vector targets)
    {
        doTrapDetonateEffect(trap, trapType, targets, 0);
    }
    public static void doTrapDetonateEffect(obj_id trap, int trapType, Vector targets, float percentMod)
    {
        doTrapDetonateEffect(trap, trapType, targets, 0, null);
    }
    public static void doKaminoDartDetonate(obj_id trap, Vector targets)
    {
        doKaminoDartDetonate(trap, targets, 0);
    }
    public static void doKaminoDartDetonate(obj_id trap, Vector targets, float percentMod)
    {
    ...
    public static void doCaltropDetonate(obj_id trap, Vector targets)
    {
        doCaltropDetonate(trap, targets, 0);
    }
    public static void doCaltropDetonate(obj_id trap, Vector targets, float percentMod)
    {
        float trapPower = getIntObjVar(trap, TRAP_POWER);
    ...
    public static void doFlashBangDetonate(obj_id trap, Vector targets)
    {
        doFlashBangDetonate(trap, targets, 0);
    }
    public static void doFlashBangDetonate(obj_id trap, Vector targets, float percentMod)
    {
        float trapPower = getIntObjVar(trap, TRAP_POWER);
    ...
    public static boolean safePvPCanAttack(obj_id trap, obj_id target)
    {
    ...
    public static boolean validateTrapTarget(obj_id trap, obj_id target)
    {
    ...
    public static obj_id getTrigger(obj_id trap)
    {
    ...
    public static boolean doTheftLoot(obj_id thief, obj_id mark)
    {
    ...
    public static boolean hasStealingLootTableEntry(obj_id mark)
    {
    ...
    public static String getStealableTemplateFromTable(obj_id mark)
    {
    ...
    public static void flagItemAsStealable(obj_id item)
    {
        setObjVar(item, STEAL_ITEM_IS_STEALABLE, 1);
    }
    public static boolean isItemStealable(obj_id item)
    {
        return hasObjVar(item, STEAL_ITEM_IS_STEALABLE);
    }
    public static void unflagItemAsStealable(obj_id item)
    {
        removeObjVar(item, STEAL_ITEM_IS_STEALABLE);
    }
    public static void addStealableTemplate(obj_id mark, String template)
    {
        Vector itms = getStealableTemplates(mark);
        itms.add(template);
        utils.setResizeableBatchObjVar(mark, STEAL_TEMPLATE_ITEMS, itms);
    }
    public static Vector getStealableTemplates(obj_id mark)
    {
        return utils.getResizeableStringBatchObjVar(mark, STEAL_TEMPLATE_ITEMS);
    }
    public static int getNpcCash(obj_id mark)
    {
    ...
    public static boolean canSteal(obj_id thief, obj_id mark)
    {
    ...
    public static boolean steal(obj_id thief, obj_id mark)
    {
    ...
    public static boolean isCoughtWhileStealing(obj_id thief, obj_id mark)
    {
        return passiveDetectHiddenTarget(thief, mark, PASSIVE_BREACH_NEAR);
    }
    public static boolean witnessModifiedSkillCheck(obj_id player, String skillMod, float distance, int witnessPenalty, int skillModMod)
    {
    ...
    public static void invisBuffRemoved(obj_id player, String sbuff)
    {
    ...
    public static void OnLocomotionChange(obj_id player, int oldLoco, int newLoco)
    {
    ...
    public static void OnPostureChanged(obj_id player, int before, int after)
    {
        String invis = getInvisBuff(player);
        if (invis == null)
        {
    ...
    public static int getApplicableInvisSkillMod(obj_id thing, String buffName)
    {
    ...
    public static int getApplicableInvisSkillMod(obj_id thing)
    {
        int mod = 0;
        if (isPlayer(thing))
        {
    ...
    public static float getDetectChance(obj_id target, obj_id detector, float baseChanceToDetect)
    {
    ...
    public static float getDetectChanceWithDetailedOutput(obj_id target, obj_id detector, float baseChanceToDetect, obj_id objectToReceiveDetailedOutput)
    {
        String invis = getInvisBuff(target);
        if (invis != null && invis.length() > 0)
        {
    ...
    public static boolean activeDetectHiddenTarget(obj_id target, obj_id detector, float baseChanceToDetect)
    {
    ...
    public static boolean passiveDetectHiddenTarget(obj_id target, obj_id detector, int volume)
    {
        if (isPlayer(detector))
        {
    ...
    public static boolean passiveDetectHiddenTargetWithDetailedOutput(obj_id target, obj_id detector, int volume, obj_id objectToReceiveDetailedOutput)
    {
    ...
    public static boolean testBubbleBreached(obj_id bubbleHolder, obj_id breacher, int volume)
    {
    ...
    public static void testUseAction(obj_id player, obj_id object, int menuItem)
    {
        String invis = getInvisBuff(player);
        if (invis != null && invis.length() > 0)
        {
    ...
    public static void testInvisNonCombatAction(obj_id player, obj_id target)
    {
        testInvisCombatAction(player, target, -1);
    }
    public static void testInvisNonCombatAction(obj_id player, obj_id target, combat_data combatData)
    {
    ...
    public static void testInvisNonCombatAction(obj_id player, obj_id target, int minInvisRequiredForAction)
    {
    ...
    public static void testInvisCombatAction(obj_id player, obj_id target)
    {
        testInvisCombatAction(player, target, -1);
    }
    public static void testInvisCombatAction(obj_id player, obj_id target, combat_data combatData)
    {
        if (!combatData.specialLine.equals("no_proc"))
        {
            testInvisCombatAction(player, target, combatData.minInvisLevelRequired);
    ...
    public static void testInvisCombatAction(obj_id player, obj_id target, int minInvisRequiredForAction)
    {
        if (isIdValid(player) && exists(player) && beast_lib.isBeast(player))
        {
            player = getMaster(player);
    ...
    public static void reinstateInvisFromCombat(obj_id player)
    {
    ...
    public static void clearPreviousInvis(obj_id player)
    {
        if (!isPlayer(player))
        {
            return;
    ...
    public static float calcBreachDistanceForSkill(obj_id player, String skillMod)
    {
    ...
    public static void cleanupHate(obj_id player)
    {
    ...
    public static obj_id makeBeastInvisible(obj_id player, String clientEffect)
    {
    ...
    public static boolean canBeastStealth(obj_id beast)
    {
    ...
    public static void makeCreatureVisible(obj_id creature)
    {
    ...
    public static void makeBeastVisible(obj_id player)
    {
        if (!isIdValid(player) || !exists(player) || !beast_lib.isBeastMaster(player))
        {
            return;
    ...
    public static void makePassiveRevealed(obj_id target)
    {
        obj_id beast = null;
    ...
    public static void _makeInvisible(obj_id player, string_id flyText, String clientEffect, string_id msg, float breachDistance)
    {
    ...
    public static void _makeVisible(obj_id player, string_id flyText, string_id msg)
    {
    ...
    public static boolean checkRevealRecourse(obj_id player)
    {
        return buff.hasBuff(player, "sp_sneak_recourse");
    }
    public static boolean checkAttackRevealRecourse(obj_id player)
    {
        return buff.hasBuff(player, "sp_attack_invis_recourse");
    }
    public static boolean canPerformForceCloak(obj_id player)
    {
    ...
    public static boolean canPerformHide(obj_id player)
    {
        return canPerformStationaryInvis(player);
    }
    public static void forceCloak(obj_id player)
    {
    ...
    public static boolean canPerformWithoutTrace(obj_id player)
    {
        if (isDead(player) || isIncapacitated(player))
        {
            sendSystemMessage(player, new string_id("spam", "cant_do_it_state"));
    ...
    public static boolean canPerformStationaryInvis(obj_id player)
    {
        if (isDead(player) || isIncapacitated(player))
        {
            sendSystemMessage(player, new string_id("spam", "cant_do_it_state"));
    ...
    public static void smokeGrenade(obj_id player)
    {
    ...
    public static void bothanInnate(obj_id player)
    {
        _makeInvisible(player, new string_id("spam", "fly_bothan_ability_1"), "appearance/pt_smoke_puff.prt", null, -1);
    }
    public static boolean canPerformStealth(obj_id player)
    {
        if (isDead(player) || isIncapacitated(player))
        {
            sendSystemMessage(player, new string_id("spam", "cant_do_it_state"));
    ...
    public static void stealth(obj_id player)
    {
    ...
    public static void withoutTrace(obj_id player)
    {
    ...
    public static void decoyStealth(obj_id player)
    {
        _makeInvisible(player, new string_id("spam", "decoy_stealth"), "", null, -1);
        buff.applyBuff(player, BUFF_NO_BREAK_INVIS);
    }
    public static void invisBuffAdded(obj_id mobile, String effectName)
    {
    ...
    public static boolean canPerformCamouflageSelf(obj_id player)
    {
        if (isDead(player) || isIncapacitated(player))
        {
            sendSystemMessage(player, new string_id("spam", "cant_do_it_state"));
    ...
    public static void camouflageSelf(obj_id player)
    {
    ...
    public static boolean canPerformCamouflageAlly(obj_id player, obj_id target)
    {
        if (!isIdValid(target))
        {
    ...
    public static boolean canPerformUrbanStealth(obj_id player, obj_id possibleHep)
    {
    ...
    public static void urbanStealth(obj_id player)
    {
    ...
    public static boolean canPerformWildernessStealth(obj_id player)
    {
        if (buff.hasBuff(player, "forceRun") || buff.hasBuff(player, "forceRun_1") || buff.hasBuff(player, "forceRun_2"))
        {
            sendSystemMessage(player, new string_id("spam", "cant_fc_run"));
    ...
    public static void wildernessStealth(obj_id player)
    {
        obj_id kit = utils.getObjIdScriptVar(player, CAMO_KIT_ID);
        int penalty = 0;
        if (!hasInvisibleBuff(player))
    ...
    public static boolean canPerformCover(obj_id player)
    {
        if (isDead(player) || isIncapacitated(player))
        {
            sendSystemMessage(player, new string_id("spam", "cant_do_it_state"));
    ...
    public static void cover(obj_id player)
    {
    ...
    public static void disableHep(obj_id hep, obj_id player)
    {
    ...
    public static boolean testAndDoHepUpkeep(obj_id hep, obj_id player, boolean silent)
    {
        int power = getCount(hep);
        if (power < HEP_UPKEEP_COST)
        {
    ...
    public static boolean checkSpyStealthUpkeep(obj_id player)
    {
    ...
    public static boolean checkUrbanStealthUpkeep(obj_id player)
    {
        if (!isInUrban(player))
        {
            sendSystemMessage(player, new string_id("spam", "cant_urban_stealth_environment"));
    ...
    public static boolean checkWildernessStealthUpkeep(obj_id player)
    {
    ...
    public static boolean checkForceCloakUpkeep(obj_id player)
    {
    ...
    public static boolean checkForAndMakeVisible(obj_id player)
    {
    ...
    public static boolean checkForAndMakeVisibleNoRecourse(obj_id player)
    {
        String ibuff = getInvisBuff(player);
        if (ibuff == null || ibuff.length() < 1)
        {
    ...
    public static boolean hasInvisibleBuff(obj_id object)
    {
        return getInvisBuff(object) != null || (isMob(object) && !getCreatureCoverVisibility(object));
    }
    public static String getInvisBuff(obj_id player)
    {
    ...
    public static boolean hasServerCoverState(obj_id player)
    {
        return getState(player, STATE_COVER) > 0;
    }
    public static obj_id getHEPObj(obj_id player, obj_id possibleHep)
    {
        int power = 0;
    ...
    public static obj_id getCamoKitForCurrentPlanet(obj_id player)
    {
    ...
    public static void consumeCamoKit(obj_id kit)
    {
    ...
    public static boolean isInWilderness(obj_id player)
    {
    ...
    public static boolean isInUrban(obj_id player)
    {
    ...
    public static boolean isPvPTrap(obj_id trap)
    {
        return getIntObjVar(trap, TRIGGER_TYPE) == TRIGGER_TYPE_PROXIMITY;
    }
    public static obj_id createDecoy(obj_id spy)
    {
    ...
    public static boolean isDecoy(obj_id object)
    {
