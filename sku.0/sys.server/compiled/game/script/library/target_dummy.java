...
public class target_dummy extends script.base_script
{
    ...
    public static String addLineBreaks(int num)
    {
        String lineBreaks = "";
        for (int i = 1; i <= num; i++)
        {
    ...
    public static boolean isTargetDummy(obj_id target)
    {
        return hasObjVar(target, "isTargetDummy");
    }
    public static obj_id createTargetDummy(obj_id controller, obj_id player)
    {
        ...
        if (creature.equals("tcg_target_dummy") || creature.equals("target_dummy_blacksun") || creature.equals("target_dummy_rebel_trooper") || creature.equals("target_dummy_stormtrooper"))
        {
    ...
    public static obj_id recreateTargetDummy(obj_id controller, obj_id player)
    {
    ...
    public static obj_id createTargetDummyAtLocation(obj_id controller, obj_id player, location createLoc)
    {
    ...
    public static void cleanupTargetDummy(obj_id controller, obj_id targetDummy)
    {
    ...
    public static void removeTargetDummyFromPermissions(obj_id targetDummy)
    {
    ...
    public static void removeTargetDummyFromPermissionsViaController(obj_id controller, obj_id targetDummy)
    {
        obj_id structure = getTopMostContainer(controller);
        if (isIdValid(structure))
        {
    ...
    public static obj_id setTargetDummyOwner(obj_id controller)
    {
    ...
    public static obj_id getTargetDummyOwnerFromController(obj_id controller)
    {
        return getOwner(controller);
    }
    public static obj_id getTargetDummyController(obj_id targetDummy)
    {
    ...
    public static obj_id getTargetDummyId(obj_id controller)
    {
    ...
    public static String getTargetDummyCreatureType(obj_id controller)
    {
    ...
    public static boolean permittedToCallTargetDummy(obj_id player, location here)
    {
    ...
    public static boolean controllerContainmentCheck(obj_id controller)
    {
    ...
    public static boolean initializeTargetDummy(obj_id targetDummy, int combatLevel, int difficulty)
    {
    ...
    public static int getTargetDummyDifficulty(obj_id targetDummy)
    {
        int difficulty = 0;
    ...
    public static int getTargetDummyCombatLevel(obj_id targetDummy)
    {
        int level = 50;
    ...
    public static void promptForCombatLevel(obj_id targetDummy, obj_id player)
    {
    ...
    public static void promptForCombatDifficulty(obj_id targetDummy, obj_id player)
    {
    ...
    public static void showTargetDummyDefenseListSui(obj_id targetDummy, obj_id player)
    {
    ...
    public static String[] getTargetDummySkillModsOptions(obj_id targetDummy)
    {
    ...
    public static void promptForDefensiveValue(obj_id targetDummy, obj_id player, int skill_mod_selected)
    {
    ...
    public static void setTargetDummyDefensiveValue(obj_id targetDummy, obj_id player, int value)
    {
    ...
    public static void setTargetDummyDefensiveValue(obj_id targetDummy, obj_id player, int value, String skillModName)
    {
    ...
    public static void confirmClearYourCombatData(obj_id targetDummy, obj_id player)
    {
    ...
    public static void confirmClearAllCombatData(obj_id targetDummy, obj_id player)
    {
    ...
    public static void buildConfirmClearCombatDataSui(obj_id targetDummy, obj_id player, String title, String prompt, String handler)
    {
    ...
    public static void clearYourCombatData(obj_id targetDummy, obj_id player)
    {
        obj_id controller = getTargetDummyController(targetDummy);
    ...
    public static void clearAllCombatData(obj_id targetDummy, obj_id player)
    {
        obj_id controller = getTargetDummyController(targetDummy);
    ...
    public static void sendTargetDummyCombatData(obj_id attacker, obj_id defender, combat_data actionData, hit_result hitData)
    {
    ...
    public static void recoredCombatResultViaController(obj_id attacker, obj_id targetDummy, combat_data actionData, hit_result hitData)
    {
        obj_id controller = getTargetDummyController(targetDummy);
        if (isIdValid(controller))
        {
    ...
    public static void recoredCombatResult(obj_id attacker, obj_id controller, combat_data actionData, hit_result hitData)
    {
    ...
    public static void storeCumulativeCombatData(int[] dataArray, int index, int newData)
    {
        dataArray[index] = dataArray[index] + newData;
    }
    public static void storeComparisonCombatData(int[] dataArray, int newData)
    {
    ...
    public static boolean recordAsNormalHit(hit_result hitData)
    {
        return !hitData.critical && !hitData.strikethrough;
    }
    public static void reportCombatData(obj_id player, obj_id targetDummy)
    {
        reportCombatDataViaController(player, targetDummy, obj_id.NULL_ID);
    }
    public static void reportCombatDataViaController(obj_id player, obj_id targetDummy, obj_id controller)
    {
    ...
    public static String getCombatDataReportString(obj_id reportDataObject, obj_id player)
    {
        String report;
        String baseAttackerVar = BASE_TARGET_DUMMY_VAR + "." + player;
        if (utils.hasScriptVarTree(reportDataObject, baseAttackerVar))
    ...
    public static void showRawCombatDataViaController(obj_id player, obj_id targetDummy)
    {
        if (isGod(player))
        {
            obj_id controller = target_dummy.getTargetDummyController(targetDummy);
    ...
    public static void showRawCombatData(obj_id player, obj_id controller)
    {
        if (isGod(player))
        {
            String report;
    ...
    public static float getPercentage(float num, float total)
    {
        float answer = num * 10000 / total;
        int truncated = (int)answer;
        return (float)truncated / 100;
    }
    public static void removeCombatAi(obj_id targetDummy)
    {
    ...
    public static void removeAttackerFromCombat(obj_id targetDummy, obj_id player)
    {
        removeHateTarget(targetDummy, player);
        removeHateTarget(player, targetDummy);
        stopCombat(player);
    }
    public static void enterIntoCombat(obj_id targetDummy, obj_id player)
    {
    ...
    public static boolean hasTargetDummyExtras(obj_id targetDummy)
    {
        String testExtra;
    ...
    public static void doTargetDummyAnimation(obj_id targetDummy, String animName)
    {
    ...
    public static String getTargetDummyExtrasData(obj_id targetDummy, String column)
    {
        String result = "";
    ...
    public static boolean blog(String msg)
    {
