...
public class pet_lib extends script.base_script
{
    ...
    public static void petFollow(obj_id pet, obj_id master)
    {
        final float collisionRadius = getObjectCollisionRadius(pet) * 2.0f;
        ai_lib.aiFollow(pet, master, collisionRadius, collisionRadius);
        setMovementRun(pet);
    }
    public static void setUpPetControlDevice(obj_id petControlDevice, obj_id pet)
    {
    ...
    public static obj_id makeControlDevice(obj_id master, obj_id pet)
    {
    ...
    public static void makePet(obj_id pet, obj_id master)
    {
    ...
    public static boolean hasMaster(obj_id pet)
    {
    ...
    public static void removeFromPetList(obj_id pet)
    {
    ...
    public static void releasePet(obj_id pet)
    {
        dictionary params = new dictionary();
        params.put("pet", pet);
    ...
    public static int getMaxPets(obj_id master, int petType)
    {
    ...
    public static int countPetsOfType(obj_id master, int petType)
    {
        int petCount = 0;
    ...
    public static boolean hasMaxPets(obj_id master, int petType)
    {
        return hasMaxPets(master, petType, obj_id.NULL_ID);
    }
    public static boolean hasMaxPets(obj_id master, int petType, obj_id pet)
    {
    ...
    public static void initializePetCommandList(obj_id pet, obj_id pcd)
    {
    ...
    public static int getDroidModuleCommandLevel(obj_id player, int modulePotency)
    {
    ...
    public static void learnCommand(obj_id pet, int commandNum, String text, obj_id master)
    {
    ...
    public static int getCommandNum(obj_id pet, String text)
    {
    ...
    public static void doCommand(obj_id pet, String text, obj_id master)
    {
    ...
    public static boolean doCommandNum(obj_id master, int commandNum)
    {
    ...
    public static void doCommandNum(obj_id pet, int commandNum, obj_id master)
    {
        doPetCommand(pet, commandNum, master);
    }
    public static boolean doPetCommand(obj_id pet, int commandNum, obj_id master)
    {
    ...
    public static void prepToLearn(obj_id pet, int commandNum)
    {
    ...
    public static String createLearnCommandListHeader(string_id header)
    {
    ...
    public static String createLearnCommandListEntry(string_id entry, String command)
    {
        prose_package pp = new prose_package();
    ...
    public static String getCommandString(obj_id pcd, int command)
    {
        return getCommandString(getObjVarList(pcd, "ai.pet.command"), command);
    }
    public static String getCommandString(obj_var_list commandList, int command)
    {
    ...
    public static boolean getLearnableCommandList(obj_id pet)
    {
        obj_id master = getMaster(pet);
        if (!isIdValid(master))
        {
    ...
    public static void learnPetCommand(obj_id pet, int command)
    {
        obj_id master = getMaster(pet);
        if (!isIdValid(master))
        {
    ...
    public static void doTriggeredPetAbility(obj_id pet, obj_id master, int commandNum)
    {
    ...
    public static void doFollowCommand(obj_id pet, obj_id master)
    {
        if (ai_lib.isInCombat(pet))
        {
    ...
    public static void doFollowOtherCommand(obj_id pet, obj_id master)
    {
    ...
    public static void doStayCommand(obj_id pet, obj_id master)
    {
        ai_lib.clearPatrolPath(pet);
        removeObjVar(pet, "ai.inFormation");
        removeObjVar(pet, "ai.formationType");
    ...
    public static void doGuardCommand(obj_id pet, obj_id master)
    {
    ...
    public static boolean isGuarding(obj_id pet, obj_id target)
    {
    ...
    public static void doFriendCommand(obj_id pet, obj_id master)
    {
        obj_id target = getIntendedTarget(master);
    ...
    public static boolean isFriend(obj_id pet, obj_id target)
    {
        obj_id master = getMaster(pet);
        if (!isIdValid(master))
        {
    ...
    public static void doConfusedEmote(obj_id pet)
    {
        if (!pet_lib.isSpeakingPet(pet))
        {
    ...
    public static void doAttackCommand(obj_id pet, obj_id master)
    {
        if (!isIdValid(master))
        {
            return;
    ...
    public static void doPatrol(obj_id pet, obj_id master)
    {
    ...
    public static void doSetPatrolPoint(obj_id pet, obj_id master)
    {
        location[] patrolLoc = getLocationArrayObjVar(pet, OBJVAR_PET_PATROL_POINTS);
        if (patrolLoc == null)
        {
    ...
    public static void doClearPatrolPoints(obj_id pet, obj_id master)
    {
        if (hasObjVar(pet, OBJVAR_PET_PATROL_POINTS))
        {
    ...
    public static void doPetFormation(obj_id pet, obj_id master, int formationType)
    {
        int position = 0;
    ...
    public static void doPetRelease(obj_id pet)
    {
        obj_id master = getMaster(pet);
    ...
    public static void doPetTransfer(obj_id pet, obj_id master)
    {
        obj_id target = getIntendedTarget(master);
    ...
    public static void doStupidPetTrick(obj_id pet, obj_id master, int trickNum)
    {
    ...
    public static void rechargeOtherDroid(obj_id pet, obj_id master)
    {
        obj_id target = getIntendedTarget(master);
    ...
    public static void repairOtherDroid(obj_id pet, obj_id master)
    {
        obj_id target = getIntendedTarget(master);
        if (isIdValid(target) == false || !isDroidPet(target))
        {
    ...
    public static void solicitTipsForMaster(obj_id pet, obj_id master)
    {
    }
    public static void doPetGroup(obj_id pet, obj_id master)
    {
    ...
    public static void checkForName(obj_id pet, obj_id pcd)
    {
    ...
    public static void feedPet(obj_id pet, obj_id master)
    {
        if (isDroidPet(pet))
        {
    ...
    public static boolean isWounded(obj_id pet)
    {
    ...
    public static boolean eatFood(obj_id master)
    {
    ...
    public static boolean eatBattery(obj_id master)
    {
        obj_id inv = utils.getInventoryContainer(master);
        if (!isIdValid(inv) || !exists(inv))
        {
    ...
    public static void storePet(obj_id pet)
    {
        storePet(pet, null);
    }
    public static void storePet(obj_id pet, obj_id master)
    {
        if (!isIdValid(pet) || !exists(pet))
        {
            return;
    ...
    public static boolean hasMaxStoredPetsOfType(obj_id player, int petType)
    {
        if (!isIdValid(player))
        {
            return true;
    ...
    public static int getNumStoredPetsOfType(obj_id player, int petType)
    {
    ...
    public static int getMaxStoredPetsOfType(obj_id master, int petType)
    {
        if (!isIdValid(master) || !exists(master))
        {
            return 0;
    ...
    public static int getMaxStoredPets(obj_id pet)
    {
        obj_id master = getMaster(pet);
        if (!isIdValid(master))
        {
    ...
    public static boolean isPet(obj_id npc)
    {
    ...
    public static boolean isCreaturePet(obj_id npc)
    {
        return (ai_lib.isMonster(npc) && hasObjVar(npc, "ai.pet"));
    }
    public static boolean isNpcPet(obj_id npc)
    {
    ...
    public static boolean isVehiclePet(obj_id npc)
    {
        int niche = ai_lib.aiGetNiche(npc);
        return (niche == NICHE_VEHICLE && hasObjVar(npc, "ai.pet"));
    }
    public static boolean isMyPet(obj_id npc, obj_id player)
    {
    ...
    public static boolean isDroidPet(obj_id npc)
    {
    ...
    public static boolean isSpeakingPet(obj_id npc)
    {
    ...
    public static boolean hasContainer(obj_id pet)
    {
        if (isDroidPet(pet))
        {
    ...
    public static boolean hasDatapad(obj_id pet)
    {
        if (isDroidPet(pet))
        {
    ...
    public static boolean isCombatDroid(obj_id npc)
    {
    ...
    public static boolean isCombatDroidPCD(obj_id petControlDevice)
    {
        if (!isIdValid(petControlDevice))
        {
            return false;
    ...
    public static void openPetContainer(obj_id pet, obj_id master)
    {
        stop(pet);
        obj_id petControlDevice = callable.getCallableCD(pet);
    ...
    public static void openPetDatapad(obj_id pet, obj_id master)
    {
        stop(pet);
        obj_id petControlDevice = callable.getCallableCD(pet);
    ...
    public static boolean isLowOnPower(obj_id pet)
    {
        obj_id petControlDevice = callable.getCallableCD(pet);
        int powerLevel = getIntObjVar(petControlDevice, "ai.pet.powerLevel");
    ...
    public static boolean findMaster(obj_id pet)
    {
    ...
    public static void removeFromList(obj_id master, obj_id pet)
    {
    ...
    public static void addToPetList(obj_id master, obj_id pet)
    {
        if (!isIdValid(master) || !exists(master) || !isIdValid(pet) || !exists(pet))
        {
            return;
    ...
    public static void storeAllPets(obj_id master)
    {
        callable.storeCallables(master);
    }
    public static boolean isNearMedicalDroid(obj_id master, float range)
    {
    ...
    public static float getMedicalDroidMod(obj_id master, float range)
    {
        float medMod = 1.0f;
        obj_id[] critters = getCreaturesInRange(getLocation(master), range);
        if (critters == null || critters.length <= 0)
    ...
    public static void setupDefaultCommands(obj_id pet)
    {
        if (utils.hasScriptVar(pet, "ai.pet.commandList"))
        {
            return;
    ...
    public static void setupOfficerPetCommands(obj_id pet)
    {
        obj_id petControlDevice = callable.getCallableCD(pet);
        dictionary petCommandList = utils.getDictionaryScriptVar(pet, "ai.pet.commandList");
        if (petCommandList == null)
    ...
    public static void markExpansionPets(obj_id petControlDevice, obj_id pet)
    {
    ...
    public static boolean isExpansionPet(obj_id petControlDevice)
    {
    ...
    public static boolean isMountPcd(obj_id pcd)
    {
    ...
    public static boolean isPetType(obj_id pcd, int petType)
    {
    ...
    public static int getPcdPetType(obj_id pcd)
    {
    ...
    public static int getPetType(obj_id pet)
    {
        return getPetType(pet, obj_id.NULL_ID);
    }
    public static int getPetType(obj_id pet, obj_id pcd)
    {
    ...
    public static int getPetType(String pet)
    {
    ...
    public static boolean isFamiliarPetType(obj_id pet)
    {
    ...
    public static boolean isFamiliarPetTypeByCreatureName(String creatureName)
    {
        if (creatureName != null && creatureName.length() > 0)
        {
    ...
    public static obj_id generatePetOfTypeFamiliar(String creatureName, obj_id player)
    {
    ...
    public static boolean isRepairDroid(obj_id pet)
    {
        return (hasObjVar(pet, "ai.pet.isRepairDroid"));
    }
    public static boolean hasTamingMenuOption(obj_id pet, obj_id player)
    {
    ...
    public static boolean isInValidUnpackLocation(obj_id master)
    {
    ...
    public static boolean isInRestrictedScene(obj_id master)
    {
    ...
    public static boolean canQuickUnpack(obj_id master)
    {
        if (isGod(master))
        {
    ...
    public static int getChanceToTame(obj_id pet, obj_id player)
    {
    ...
    public static int getChanceToTame(String petName, obj_id player)
    {
    ...
    public static int getChanceToTame(int level, int petType, obj_id player)
    {
        int tamingSkillMod = 0;
        if (petType == pet_lib.PET_TYPE_AGGRO)
        {
    ...
    public static int getChanceToTame(int level, int skillMod, int tameLevelSkillMod)
    {
    ...
    public static void setControllerName(obj_id petControlDevice, obj_id pet)
    {
    ...
    public static void grantPetGrowthXp(obj_id pet, int xpTotal)
    {
        obj_id pcd = callable.getCallableCD(pet);
        int growthStage = 10;
    ...
    public static int getPetXpForNextLevel(obj_id pet)
    {
        int level = getLevel(pet);
        return getXpForNextLevel(level);
    }
    public static int getPcdXpForNextLevel(obj_id pcd)
    {
    ...
    public static int getMaxAbilitySlots(int level)
    {
        return (int)((level + 25) / 8f + 0.5f);
    }
    public static void earnPetTrainingAbility(obj_id pet)
    {
        obj_id pcd = callable.getCallableCD(pet);
    ...
    public static void earnPetTrainingPoints(obj_id pet)
    {
        obj_id pcd = callable.getCallableCD(pet);
        int available = getIntObjVar(pcd, "ai.petAbility.available");
        int toBeEarned = getIntObjVar(pcd, "ai.petAbility.toBeEarned");
    ...
    public static void learnPetAbility(obj_id pet)
    {
        obj_id pcd = callable.getCallableCD(pet);
        obj_id master = getMaster(pet);
    ...
    public static void initializeWildPetAbility(obj_id pet)
    {
        String creatureName = ai_lib.getCreatureName(pet);
        if (creatureName == null || creatureName.equals(""))
        {
    ...
    public static void validateFollowTarget(obj_id pet, obj_id target)
    {
        obj_id master = getMaster(pet);
        if (target == master)
        {
    ...
    public static void trainPetAbility(obj_id pet, int ability)
    {
        if (!isIdValid(pet) || !exists(pet))
        {
    ...
    public static String getPetAbilityFromCrc(int ability)
    {
        int row = dataTableSearchColumnForInt(ability, "abilityCrc", PET_ABILITY_TABLE);
        if (row == -1)
        {
    ...
    public static void initializeTrainedPetAbilities(obj_id pcd, obj_id pet)
    {
        obj_id master = getMaster(pet);
        int[] abilityList = getIntArrayObjVar(pcd, "ai.petAbility.abilityList");
        if (abilityList == null)
    ...
    public static void addInnateAbilityStatBonus(obj_id pet, dictionary abilityData)
    {
    ...
    public static void addInnateScriptVar(obj_id pet, dictionary abilityData)
    {
    ...
    public static void addInnateBuff(obj_id pet, dictionary abilityData)
    {
    ...
    public static void addTriggeredAbility(obj_id pet, dictionary abilityData)
    {
        String actionName = abilityData.getString("actionName");
    ...
    public static void addActionAbility(obj_id pet, dictionary abilityData)
    {
        String actionName = abilityData.getString("actionName");
        if (actionName != null && !actionName.equals(""))
        {
    ...
    public static int getPetAbilityHealthBonus(obj_id pcd, int baseHealth)
    {
        int healthBonus = 0;
        int[] abilityList = getIntArrayObjVar(pcd, "ai.petAbility.abilityList");
        if (abilityList != null && abilityList.length > 0)
    ...
    public static int getPetAbilityRegenBonus(obj_id pcd, int baseRegen)
    {
        int regenBonus = 0;
        int[] abilityList = getIntArrayObjVar(pcd, "ai.petAbility.abilityList");
        if (abilityList != null && abilityList.length > 0)
    ...
    public static int[] getPetAbilityDamageBonus(obj_id pcd, int baseMinDamage, int baseMaxDamage)
    {
        int[] damageBonus = 
        {
            0,
    ...
    public static float getPetAbilityAttackSpdBonus(obj_id pcd, float baseSpeed)
    {
        float speedBonus = 0f;
    ...
    public static boolean isPetFrenzied(obj_id pet)
    {
    ...
    public static float getPetFrenzyAmount(obj_id pet)
    {
    ...
    public static boolean isPetDefenseStance(obj_id pet)
    {
    ...
    public static float getPetDefenseStanceAmount(obj_id pet)
    {
    ...
    public static obj_id getShieldingPet(obj_id player)
    {
    ...
    public static boolean isPetShielding(obj_id pet)
    {
    ...
    public static float getPetShieldAmount(obj_id pet)
    {
    ...
    public static void setPetStatsByGrowth(obj_id pet, int growthStage)
    {
    }
    public static void setCraftedPetStatsByGrowth(obj_id petControlDevice, obj_id pet, int growthStage)
    {
    ...
    public static void fixMinRegenStats(obj_id pet)
    {
        int healthAttrib = 0;
        if (!ai_lib.isDroid(pet) && !ai_lib.isAndroid(pet))
        {
    ...
    public static int calcRegenStat(int poolStat)
    {
    ...
    public static boolean isNearResidence(obj_id master)
    {
    ...
    public static boolean wasInCombatRecently(obj_id currentPet, obj_id master, boolean systemMessage)
    {
    ...
    public static boolean wasInCombat(obj_id player)
    {
    ...
    public static int modifyCallTime(obj_id player, String combatEnded, int callDelay, int combatDelay)
    {
    ...
    public static int getCurrentPetLevels(obj_id master)
    {
        if (!isIdValid(master))
        {
            return 0;
    ...
    public static boolean canControlPetsOfLevel(obj_id player, int petType, int petLevel, String creatureName)
    {
        if (!hasSkill(player, "outdoors_creaturehandler_novice"))
        {
            return true;
    ...
    public static int getMaxTameLevel(obj_id player)
    {
    ...
    public static int getModifiedAttribDamage(obj_id target, int attrib)
    {
    ...
    public static void storeDamage(obj_id pet, obj_id petControlDevice)
    {
    ...
    public static void restoreDamage(obj_id pet, obj_id petControlDevice)
    {
        if (!isIdValid(pet) || !isIdValid(petControlDevice))
        {
            return;
    ...
    public static void killPet(obj_id pet)
    {
        obj_id petControlDevice = callable.getCallableCD(pet);
        if (isIdValid(petControlDevice))
        {
    ...
    public static void reduceStatsForVitality(obj_id pet, obj_id petControlDevice)
    {
    ...
    public static int getReducedStatValue(int oldValue, int vitality)
    {
        if (vitality == 100)
        {
            return oldValue;
    ...
    public static boolean performVitalityHeal(obj_id player, obj_id pet, obj_id petControlDevice, obj_id pet_med)
    {
    ...
    public static void savePetInfo(obj_id pet, obj_id petControlDevice)
    {
        if (!isIdValid(pet) || !isIdValid(petControlDevice))
        {
            return;
    ...
    public static void processSpeech(obj_id pet, obj_id master, String text)
    {
        if (!isIdValid(pet))
        {
            return;
    ...
    public static int getAdultLevel(obj_id pet)
    {
        String creatureName = getCreatureName(pet);
        if (creatureName != null)
        {
    ...
    public static int getAdultLevel(String creatureName)
    {
        if (creatureName != null)
        {
            int level = create.calcCreatureLevel(creatureName);
    ...
    public static boolean canTrainAsMount(obj_id pet, obj_id player)
    {
        if (!isIdValid(pet))
        {
    ...
    public static boolean trainMount(obj_id pet, obj_id player)
    {
        if (!isIdValid(pet))
        {
            return false;
    ...
    public static boolean makePetAMount(obj_id pet, obj_id player)
    {
        if (!isIdValid(pet))
        {
            return false;
    ...
    public static boolean mountablePetInit(obj_id pet, obj_id player)
    {
    ...
    public static boolean isMount(obj_id pet)
    {
        if (!isIdValid(pet) || !exists(pet))
        {
            return false;
    ...
    public static boolean canMount(obj_id pet, obj_id player)
    {
        if (!isIdValid(pet))
        {
    ...
    public static boolean isMountedOnCreatureQueried(obj_id pet, obj_id player)
    {
    ...
    public static boolean isSameFaction(obj_id pet, obj_id master)
    {
        String creatureName = getCreatureName(pet);
        if (creatureName == null || creatureName.equals(""))
        {
    ...
    public static boolean cancelAttackDueToFactionalRestrictions(obj_id pet, obj_id target)
    {
        obj_id master = getMaster(pet);
        if (!isIdValid(master) || !exists(master) || !master.isLoaded())
        {
    ...
    public static int showGrowthChoiceSui(obj_id owner, obj_id target, String targetName)
    {
    ...
    public static int doMountOutOfScaleCheck(obj_id petControlDevice, String creatureName)
    {
        if (creatureName == null)
        {
    ...
    public static dictionary getMountMovementInfo(obj_id objMount)
    {
    ...
    public static void setMountedMovementRate(obj_id objPlayer, obj_id objTarget)
    {
    ...
    public static void setUnmountedMovementRate(obj_id self, obj_id objTarget)
    {
        dictionary dctMountInfo = getMountMovementInfo(objTarget);
        if (dctMountInfo != null)
        {
    ...
    public static void setMountBurstRunMovementRate(obj_id objPlayer, obj_id objTarget)
    {
        dictionary dctMountInfo = getMountMovementInfo(objTarget);
    ...
    public static void setMountCombatMoveSpeed(obj_id objRider, obj_id objMount)
    {
    ...
    public static boolean isGalloping(obj_id objCreature)
    {
    ...
    public static boolean isTameable(obj_id objCreature)
    {
    ...
    public static void doPetSpecialAttack(obj_id pet, obj_id master, int attackNum)
    {
    ...
    public static boolean hasRangedAttack(obj_id pet)
    {
    ...
    public static void packAllCurrentPets(obj_id player, string_id optionalMsg)
    {
    ...
    public static boolean doDismountNow(obj_id riderId, boolean notify)
    {
    ...
    public static boolean doDismountNow(obj_id player)
    {
        return doDismountNow(player, true);
    }
    public static void initPCDCraftedStats(obj_id device, obj_id deed)
    {
    ...
    public static void createPetFromData(obj_id petControlDevice)
    {
    ...
    public static void customizationFadeToWhite(obj_id pet, float percent)
    {
    ...
    public static int modifyPaletteIndex(int idx)
    {
    ...
    public static void initDroidCraftedInventoryDroid(obj_id pet, obj_id petControlDevice)
    {
    ...
    public static void initDroidCraftedDatapadDroid(obj_id pet, obj_id petControlDevice)
    {
    ...
    public static void initDroidPersonality(obj_id pet, obj_id petControlDevice)
    {
    ...
    public static void initDroidMedicalPower(obj_id pet, obj_id petControlDevice)
    {
    ...
    public static void initDroidCraftingPower(obj_id pet, obj_id petControlDevice, obj_id master)
    {
    ...
    public static void initDroidRepairPower(obj_id pet, obj_id petControlDevice)
    {
    ...
    public static void restoreCustomization(obj_id pet, obj_id petControlDevice)
    {
    ...
    public static void doTargetHarvest(obj_id pet, obj_id master)
    {
        dictionary parms = new dictionary();
        parms.put("droid", pet);
    ...
    public static void doPetThrowTrap(obj_id pet, obj_id master, int commandNum)
    {
        dictionary params = new dictionary();
    ...
    public static boolean isNewPlayerHelperDroid(obj_id pet)
    {
        if (isIdValid(pet))
        {
    ...
    public static String[] getLightingEffects(obj_id droid)
    {
        if (!isIdValid(droid))
        {
            return null;
    ...
    public static int calculateMaxTrapLoad(obj_id objItem)
    {
    ...
    public static void cleanOldDroidDeed(obj_id deed)
    {
    ...
    public static int getDroidCapLevel(obj_id who, int level)
    {
    ...
    public static void initDroidDefaultStats(obj_id deed)
    {
    ...
    public static void initDroidCombatStats(obj_id deed, dictionary droidCombatStats)
    {
    ...
    public static void writeOutNewDroidDeedAttribs(obj_id deed, dictionary droidDeedStats)
    {
    ...
    public static void reviseCombatDroidPCD(obj_id petControlDevice, obj_id master, obj_id pet)
    {
    ...
    public static void openLearnCommandSui(obj_id pet, obj_id player)
    {
    ...
    public static boolean hasPetControlDevice(obj_id pet)
    {
    ...
    public static obj_id getPetControlDevice(obj_id pet)
    {
    ...
    public static void destroyOfficerPets(obj_id player)
    {
        obj_id datapad = utils.getPlayerDatapad(player);
    ...
    public static void addToHarvestDroidArray(obj_id target, obj_id[] players)
    {
    ...
    public static boolean hasMountName(obj_id pcd)
    {
        if (!isIdValid(pcd) || !exists(pcd))
        {
            return true;
    ...
    public static void setMountName(obj_id pcd, String mountName)
    {
        if (!isIdValid(pcd) || !exists(pcd))
        {
            return;
    ...
    public static String getMountName(obj_id pcd)
    {
        if (hasObjVar(pcd, "pet.mountName"))
        {
    ...
    public static boolean isMounted(obj_id player)
    {
        if (isIdValid(player))
        {
    ...
    public static obj_id[] getPcdsForType(obj_id master, int type)
    {
    ...
    public static obj_id validateDroidCommand(obj_id player)
    {
