...
public class trace extends script.base_script
{
    ...
    public static void log(String channel, String message, obj_id logAbout)
    {
    ...
    public static void log(String channelOrLogFile, String message, obj_id logAbout, int traceLevelMask)
    {
    ...
    public static boolean pipeDebugToCsLog()
    {
