...
public class collection extends script.base_script
{
    ...
    public static boolean grantCollectionReward(obj_id player, String collectionName, boolean canResetCollection)
    {
    ...
    public static boolean updateCraftingSlot(obj_id player, String template)
    {
        if (!isIdValid(player) || !exists(player))
        {
            return false;
    ...
    public static boolean checkState(obj_id player)
    {
    ...
    public static boolean checkDistance(obj_id clickObj, obj_id player, int maxDist)
    {
        if (!isIdValid(player) || !exists(player))
        {
            return false;
    ...
    public static boolean giveAreaMobsHate(obj_id collectible, obj_id player)
    {
    ...
    public static void showNpcCollections(obj_id player, obj_id npc, String columnName)
    {
    ...
    public static void findAndGrantSlot(obj_id player, obj_id npc, String selectedCollection)
    {
    ...
    public static boolean checkMaxActive(obj_id player, obj_id npc, String columnName)
    {
        HashSet active_collection = new HashSet();
    ...
    public static boolean npcHasMoreCollections(obj_id player, obj_id npc, String columnName)
    {
        if (!isIdValid(player) || !exists(player))
        {
            return false;
    ...
    public static String[] getAllCollectionsForItem(obj_id collectible)
    {
        if (!isIdValid(collectible) || !exists(collectible))
        {
            return null;
    ...
    public static String[] getAllSlotsForItem(obj_id collectible)
    {
        if (!isIdValid(collectible) || !exists(collectible))
        {
            return null;
    ...
    public static String[] getAllAvailableCollectionsForItem(obj_id player, obj_id collectible)
    {
        if (!isIdValid(collectible) || !exists(collectible))
        {
            return null;
    ...
    public static String[] getAllAvailableSlotsForItem(obj_id player, obj_id collectible)
    {
        if (!isIdValid(collectible) || !exists(collectible))
        {
            return null;
    ...
    public static boolean removeCollectionForRealsies(obj_id player, String collectionName)
    {
        if (!isIdValid(player) || !exists(player))
        {
            return false;
    ...
    public static boolean revokeThenGrantCollection(obj_id player, String collectionName)
    {
        if (!isIdValid(player) || !exists(player))
        {
            return false;
    ...
    public static boolean removeCollection(obj_id player, String collectionName)
    {
        if (!isIdValid(player) || !exists(player))
        {
            return false;
    ...
    public static boolean removeCompletedCollection(obj_id player, String collectionName)
    {
        if (!isIdValid(player) || !exists(player))
        {
            return false;
    ...
    public static void showNpcCollectionsRemoval(obj_id player, obj_id npc, String columnName)
    {
        if (sui.hasPid(player, COL_NPC_PID))
        {
            int pid = sui.getPid(player, COL_NPC_PID);
    ...
    public static boolean npcHasCollectionsToRemove(obj_id player, obj_id npc, String columnName)
    {
        if (!isIdValid(player) || !exists(player))
        {
            return false;
    ...
    public static boolean spaceGetCreditForKills(obj_id player, String[] slotNames)
    {
        if (slotNames == null || slotNames.length <= 0)
        {
            return false;
    ...
    public static boolean logQuestError(obj_id player, String quest, int result)
    {
        if (!isIdValid(player) || !exists(player))
        {
            return false;
    ...
    public static boolean entertainerBuffCollection(obj_id buffedPlayerId, obj_id bufferId, float duration)
    {
    ...
    public static boolean pilotSmuggleTimeCheck(obj_id pilot, obj_id groupMember, obj_id ship, String strChassisType)
    {
    ...
    public static boolean collectionResource(obj_id player, String restype)
    {
        return collectionResource(player, restype, 0);
    }
    public static boolean collectionResource(obj_id player, String restype, int modifier)
    {
    ...
    public static boolean getRandomCollectionItemShowLootBox(obj_id player, obj_id container, String loot_table, String loot_column)
    {
    ...
    public static boolean getRandomCollectionItem(obj_id player, obj_id container, String loot_table, String loot_column)
    {
        if (!isIdValid(container) || !isIdValid(player))
        {
            return false;
    ...
    public static obj_id grantRandomCollectionItem(obj_id player, String loot_table, String loot_column)
    {
    ...
    public static boolean gcwBaseControlCheck(obj_id factionObject, obj_id player)
    {
    ...
    public static boolean canCollectCollectible(obj_id player, obj_id collectible)
    {
    ...
    public static boolean rewardPlayerCollectionSlot(obj_id player, obj_id collectible)
    {
        if (!isValidId(collectible) || !isValidId(player))
        {
            return false;
    ...
    public static obj_id getRandomItem(obj_id player, String[] items, String collectionName, prose_package pp)
    {
    ...
    public static obj_id getWeightedRandomItem(obj_id player, String[] items, String collectionName, prose_package pp)
    {
        int randomChoice = 0;
    ...
    public static obj_id createStaticItemWithMessage(obj_id player, String staticItem, String collectionName, prose_package pp)
    {
    ...
    public static obj_id createTemplateItemWithMessage(obj_id player, String templateItem, String collectionName, prose_package pp)
    {
    ...
    public static void giveNewbieCommWindow(obj_id player, obj_id object)
    {
    ...
    public static void grantQuestBasedCollections(String questString, obj_id player)
    {
