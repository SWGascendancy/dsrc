...
public class consumable extends script.base_script
{
    ...
    public static boolean consumeItem(obj_id player, obj_id target, obj_id item)
    {
        return consumeItem(player, target, item, true);
    }
    public static boolean consumeItem(obj_id player, obj_id target, obj_id item, boolean checkPvpStatus)
    {
    ...
    public static boolean consumeItem(obj_id player, obj_id item)
    {
        return consumeItem(player, player, item);
    }
    public static attrib_mod[] modifyConsumableMods(obj_id player, obj_id target, obj_id item, attrib_mod[] am)
    {
        if (!isIdValid(player) || !isIdValid(target) || !isIdValid(item))
        {
            return null;
    ...
    public static attrib_mod[] modifyBuffMods(obj_id player, obj_id target, obj_id item, attrib_mod[] am)
    {
        if (!isIdValid(player) || !isIdValid(target) || !isIdValid(item))
        {
            return null;
    ...
    public static boolean createConsumable(obj_id item, attrib_mod[] am, int[] stomach, dictionary skillReq)
    {
    ...
    public static boolean decrementSpecificObjectRecursive(obj_id player, String template, String objvar)
    {
    ...
    public static boolean decrementObjectInventoryOrEquipped(obj_id player, String template, String objvar)
    {
        obj_id inventory = utils.getInventoryContainer(player);
    ...
    public static boolean decrementSpecificObject(obj_id player, String template, String objvar)
    {
        obj_id inventory = utils.getInventoryContainer(player);
    ...
    public static attrib_mod[] getForagedFoodMods(obj_id item)
    {
        int mod_time = 0;
        int health_mod = 0;
        int action_mod = 0;
    ...
    public static boolean canEatFood(obj_id target, obj_id item)
    {
    ...
    public static void applyFoodEffects(obj_id target, obj_id item, attrib_mod[] am)
    {
