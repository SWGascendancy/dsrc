...
public class player_structure extends script.base_script
{
    ...
    public static int getRequiredLots(String template)
    {
        return getRequiredLots(getStructureTableIndex(template));
    }
    public static int getRequiredLots(int index)
    {
        return (index != -1 ? dataTableGetInt(PLAYER_STRUCTURE_DATATABLE, index, DATATABLE_COL_LOT_REDUCTION) : 0);
    }
    public static obj_id createPlayerStructure(String template, obj_id owner, location loc, int rotation, dictionary deed_info)
    {
        if (template == null)
        {
            return null;
    ...
    public static obj_id createTemporaryStructure(obj_id deed, obj_id owner, location loc, int rot, float placementHeight)
    {
    ...
    public static boolean createStructureObjects(obj_id structure, int rotation)
    {
    ...
    public static boolean initializeStructure(obj_id structure, obj_id owner, dictionary deed_info)
    {
        if (structure == obj_id.NULL_ID)
        {
            return false;
    ...
    public static float getBasePowerRate(obj_id structure)
    {
    ...
    public static boolean addStructure(obj_id structure, String template, String structure_name, location structure_location, obj_id player, String player_name, boolean struct_loaded, boolean player_loaded)
    {
        if (structure == null || structure == obj_id.NULL_ID)
        {
            return false;
        ...
        if (player_loaded)
        {
            int struct_lots = getRequiredLots(template);
            if (struct_lots > 0)
            {
    ...
    public static boolean addStructure(obj_id structure, obj_id player)
    {
        return addStructure(
                structure,
    ...
    public static boolean removeStructure(obj_id structure, String template, obj_id player, String player_name, boolean struct_loaded, boolean player_loaded)
    {
        if (structure == null || structure == obj_id.NULL_ID)
        {
            return false;
    ...
    public static boolean removeStructure(obj_id structure, obj_id player)
    {
        return removeStructure(structure, getTemplateName(structure), player, getPlayerName(player), true, true);
    }
    public static boolean updateStructureVersion(obj_id structure)
    {
        if (!isIdValid(structure))
        {
            return false;
    ...
    public static boolean updateStructureData(obj_id structure)
    {
        if (!isIdValid(structure))
        {
            return false;
    ...
    public static boolean canPlaceStructure(obj_id player, String template, location loc, obj_id deed)
    {
        ...
        if (template_idx == -1)
        {
            LOG("LOG_CHANNEL", "player_structure::OnObjectMenuSelect -- Unable to find template in datatable.");
            return false;
        }
    ...
    public static boolean canPlaceStructure(obj_id player, String template)
    {
        return canPlaceStructure(player, template, getLocation(player), null);
    }
    public static boolean canOwnStructure(String template, obj_id player, boolean allowOverLotLimitIfPlayerHouse)
    {
        if (player == null || player == obj_id.NULL_ID)
        {
            return false;
        ...
        int idx = getStructureTableIndex(template);
        int lots_needed = getRequiredLots(idx);
        if (lots_needed > 0)
        {
    ...
    public static boolean canOwnStructure(obj_id structure, obj_id player)
    {
        if (structure == null || structure == obj_id.NULL_ID)
        {
            return false;
    ...
    public static String getFootprintTemplate(String template)
    {
    ...
    public static boolean canPlaceObject(obj_id structure, obj_id player)
    {
        if (structure == null || structure == obj_id.NULL_ID)
        {
            return false;
    ...
    public static boolean isInAdminRange(obj_id structure, obj_id player)
    {
        if (structure == null || structure == obj_id.NULL_ID)
        {
            return false;
    ...
    public static float getInstallationRange(obj_id structure)
    {
        if (isCivic(structure))
        {
    ...
    public static String getDeedTemplate(obj_id deed)
    {
    ...
    public static int getDeedTemplateCrc(obj_id deed)
    {
        return getIntObjVar(deed, VAR_DEED_TEMPLATE_CRC);
    }
    public static boolean setDeedTemplate(obj_id deed, String template)
    {
    ...
    public static int getDeedBuildTime(obj_id deed)
    {
    ...
    public static String getDeedScene(obj_id deed)
    {
        if (!hasObjVar(deed, VAR_DEED_SCENE))
        {
            return null;
    ...
    public static int getDeedMaxExtraction(obj_id deed)
    {
        if (!hasObjVar(deed, VAR_DEED_MAX_EXTRACTION))
        {
            return -1;
    ...
    public static int getDeedCurrentExtraction(obj_id deed)
    {
        if (!hasObjVar(deed, VAR_DEED_CURRENT_EXTRACTION))
        {
            return -1;
    ...
    public static int getDeedMaxHopper(obj_id deed)
    {
        if (!hasObjVar(deed, VAR_DEED_MAX_HOPPER))
        {
            return -1;
    ...
    public static String getStructureOwner(obj_id structure)
    {
        return getPlayerName(getOwner(structure));
    }
    public static obj_id getStructureOwnerObjId(obj_id structure)
    {
        return getOwner(structure);
    }
    public static int getMaintenanceRate(obj_id structure)
    {
    ...
    public static int getBaseMaintenanceRate(obj_id structure)
    {
    ...
    public static int getRedeedCost(obj_id structure)
    {
    ...
    public static float getMaintenanceMerchantMod(obj_id structure)
    {
        if (!isIdValid(structure))
        {
            return 0f;
    ...
    public static float getMaintenanceFactoryMod(obj_id structure)
    {
        if (!isIdValid(structure))
        {
            return 0f;
    ...
    public static float getMaintenanceHarvesterMod(obj_id structure)
    {
        if (!isIdValid(structure))
        {
            return 0f;
    ...
    public static int getMaintenancePropertyTax(obj_id structure)
    {
        if (!isIdValid(structure))
        {
            return -1;
    ...
    public static int getMaintenancePool(obj_id structure)
    {
        return getBankBalance(structure);
    }
    public static int getDecayRate(obj_id structure)
    {
        return getIntObjVar(structure, VAR_DECAY_RATE);
    }
    public static int getStructureCondition(obj_id structure)
    {
        return getHitpoints(structure);
    }
    public static int getMaxCondition(obj_id structure)
    {
        return getMaxHitpoints(structure);
    }
    public static int getMaxExtraction(obj_id structure)
    {
    ...
    public static int getCurrentExtraction(obj_id structure)
    {
    ...
    public static int getMaxHopper(obj_id structure)
    {
    ...
    public static int getStructureVersion(obj_id structure)
    {
        return getIntObjVar(structure, VAR_VERSION);
    }
    public static obj_id getResidence(obj_id player)
    {
        if (player == null || player == obj_id.NULL_ID)
        {
            return null;
    ...
    public static int getStructureNumItems(obj_id structure)
    {
        if (structure == null || structure == obj_id.NULL_ID)
        {
            return -1;
    ...
    public static obj_id[] getStructureBaseObjects(obj_id structure)
    {
        if (structure == null || structure == obj_id.NULL_ID)
        {
            return null;
    ...
    public static String[] getEntryList(obj_id structure)
    {
        if (!isIdValid(structure))
        {
            return null;
    ...
    public static String[] getCompleteEntryList(obj_id structure)
    {
        if (!isIdValid(structure))
        {
            return null;
    ...
    public static boolean isNameOnEntryList(obj_id structure, String player_or_guild_name)
    {
    ...
    public static String[] getBanList(obj_id structure)
    {
        if (!isIdValid(structure))
        {
            return null;
    ...
    public static boolean isNameOnBanList(obj_id structure, String player_or_guild_name)
    {
    ...
    public static String[] getAdminListRaw(obj_id structure)
    {
        if (!isIdValid(structure))
        {
            return null;
    ...
    public static String[] getAdminListNames(obj_id structure)
    {
        return convertRawListToNames(getAdminListRaw(structure));
    }
    public static boolean isNameOnAdminList(obj_id structure, String player_or_guild_name)
    {
    ...
    public static boolean adminListAddName(obj_id structure, String nameToAdd)
    {
        if (isIdValid(structure))
        {
    ...
    public static boolean adminListRemoveName(obj_id structure, String nameToRemove)
    {
        if (isIdValid(structure))
        {
            Vector adminList = getResizeableStringArrayObjVar(structure, VAR_ADMIN_LIST);
    ...
    public static String[] getVendorList(obj_id structure)
    {
        if (!isIdValid(structure))
        {
            return null;
    ...
    public static String[] getHopperListRaw(obj_id structure)
    {
        if (!isIdValid(structure))
        {
            return null;
    ...
    public static String[] getHopperListNames(obj_id structure)
    {
        return convertRawListToNames(getHopperListRaw(structure));
    }
    public static boolean isNameOnHopperList(obj_id structure, String player_or_guild_name)
    {
    ...
    public static boolean hopperListAddName(obj_id structure, String nameToAdd)
    {
        if (isIdValid(structure))
        {
    ...
    public static boolean hopperListRemoveName(obj_id structure, String nameToRemove)
    {
        if (isIdValid(structure))
        {
            Vector hopperList = getResizeableStringArrayObjVar(structure, VAR_HOPPER_LIST);
    ...
    public static obj_id getStructure(obj_id object)
    {
    ...
    public static obj_id[] getObjectsInBuilding(obj_id structure)
    {
        if (structure == null || structure == obj_id.NULL_ID)
        {
            return null;
    ...
    public static obj_id[] getPlayersInBuilding(obj_id structure)
    {
        if (structure == null || structure == obj_id.NULL_ID)
        {
            return null;
    ...
    public static obj_id[] getPlayersNearInstallation(obj_id structure)
    {
        if (structure == null || structure == obj_id.NULL_ID)
        {
            return null;
    ...
    public static void confirmNoReclaimPlacement(obj_id deedOrScd, obj_id player, String template)
    {
    ...
    public static boolean tryQueueStructurePlacement(obj_id deedOrScd, obj_id player)
    {
    ...
    public static boolean tryEnterPlacementMode(obj_id deedOrScd, obj_id player)
    {
        ...
        if (!canPlaceStructure(player, template, here, deedOrScd))
        {
            return false;
        }
        enterClientStructurePlacementMode(player, deedOrScd, template);
        return true;
    }
    public static boolean canPackBuilding(obj_id player, obj_id structure)
    {
        return !isCivic(structure) && !isHarvester(structure) && !isGenerator(structure) && isOwner(structure, player);
    }
    public static void packBuilding(obj_id player, obj_id structure)
    {
    ...
    public static void finalizePackUp(obj_id player, obj_id structure)
    {
    ...
    public static void finalizeAbandonedStructurePackUp(obj_id player, obj_id structure)
    {
        final boolean isAbandoned = isAbandoned(structure);
        if (!isAbandoned)
        {
    ...
    public static void confirmCityAbandonedAndPack(obj_id structure, obj_id player)
    {
        if (!isIdValid(player))
        {
    ...
    public static void finalizeCityPackUp(obj_id player, obj_id structure)
    {
    ...
    public static int getPlayerPackUpMeritPoints(obj_id player)
    {
        int noMerit = 0;
    ...
    public static boolean housePackingPointDecrease(obj_id player)
    {
        return housePackingPointDecrease(player, 1);
    }
    public static boolean housePackingPointDecrease(obj_id player, int changeAmount)
    {
        if (!isValidId(player) || !exists(player))
        {
            return false;
    ...
    public static boolean housePackingPointIncrease(obj_id player)
    {
        return housePackingPointIncrease(player, 1);
    }
    public static boolean housePackingPointIncrease(obj_id player, int changeAmount)
    {
        if (!isValidId(player) || !exists(player))
        {
            return false;
    ...
    public static boolean hasBeenDeclaredResidence(obj_id structure)
    {
        return hasObjVar(structure, VAR_RESIDENCE_BUILDING);
    }
    public static obj_id getResidentPlayer(obj_id structure)
    {
        if (!hasBeenDeclaredResidence(structure))
        {
            return null;
    ...
    public static boolean replacePackedStructure(obj_id scd, obj_id owner, location loc, int rot, float placementHeight)
    {
    ...
    public static boolean hasVendors(obj_id structure)
    {
        String[] cells = getCellNames(structure);
        if (cells != null)
        {
    ...
    public static void removeCityAbandoned(obj_id object)
    {
        if (!isIdValid(object))
        {
            return;
    ...
    public static boolean isCityPackupAuthoritative(obj_id player, obj_id structure) {
        return !(!player.isLoaded() || !player.isAuthoritative()) && !(!structure.isLoaded() || !structure.isAuthoritative());
    }
    public static void removeCityAbandonedTagFromHouse(obj_id structure)
    {
    ...
    public static void updateCityAbandonedFactoryName(obj_id factory)
    {
    ...
    public static boolean isCommercial(obj_id object) {
        return isIdValid(object) && !isCivic(object) && getStructureCityRank(object) > 0;
    }
    public static int getStructureCityRank(obj_id object)
    {
        if (!isIdValid(object))
        {
            return 0;
    ...
    public static int getStructureCityCost(obj_id object)
    {
        if (!isIdValid(object))
        {
            return 0;
    ...
    public static boolean isCivicTemplate(String template)
    {
    ...
    public static boolean isShuttleportTemplate(String template)
    {
        String[] structures = dataTableGetStringColumn(PLAYER_STRUCTURE_DATATABLE, "STRUCTURE");
        for (int i = 0; i < structures.length; i++)
        {
    ...
    public static boolean isCloneTemplate(String template)
    {
        String[] structures = dataTableGetStringColumn(PLAYER_STRUCTURE_DATATABLE, "STRUCTURE");
        for (int i = 0; i < structures.length; i++)
        {
    ...
    public static boolean isGarageTemplate(String template)
    {
    ...
    public static boolean isAdmin(obj_id structure, obj_id player)
    {
        if (!isIdValid(structure))
        {
            return false;
    ...
    public static boolean isVendor(obj_id structure, String player_name)
    {
        if (structure == null || structure == obj_id.NULL_ID)
        {
            return false;
    ...
    public static boolean isVendor(obj_id structure, obj_id player) {
        return isIdValid(player) && isVendor(structure, getPlayerName(player));
    }
    public static boolean canEnter(obj_id structure, String player_or_guild_name)
    {
        if (!isIdValid(structure))
        {
            return false;
    ...
    public static boolean canEnter(obj_id structure, obj_id player) {
        return isIdValid(player) && canEnter(structure, getPlayerName(player));
    }
    public static boolean canHopper(obj_id structure, String player_or_guild_name)
    {
        if (!isIdValid(structure))
        {
            return false;
    ...
    public static boolean canHopper(obj_id structure, obj_id player) {
        return isIdValid(player) && canHopper(structure, getPlayerName(player));
    }
    public static boolean isBanned(obj_id structure, String player_or_guild_name)
    {
        if (!isIdValid(structure))
        {
            return false;
    ...
    public static boolean removeManagementMods(obj_id structure)
    {
        return true;
    }
    public static boolean isGuildIdOnRawList(String[] nameList, int guildId) {
        return (nameList != null) && (guildId != 0) && (utils.getElementPositionInArray(nameList, "guild:" + guildId) != -1);
    }
    public static boolean isGuildNameOnRawList(String[] nameList, String guildNameToFind) {
        return guildNameToFind != null && isGuildIdOnRawList(nameList, findGuild((guildNameToFind.trim()).toLowerCase()));
    }
    public static boolean isPlayerObjIdOnRawList(String[] nameList, obj_id playerObjId) {
        return (nameList != null) && isIdValid(playerObjId) && (utils.getElementPositionInArray(nameList, playerObjId.toString()) != -1);
    }
    public static boolean isPlayerNameOnRawList(String[] nameList, String playerNameToFind) {
        return playerNameToFind != null && isPlayerObjIdOnRawList(nameList, getPlayerIdFromFirstName((playerNameToFind.trim()).toLowerCase()));
    }
    public static boolean isNameOnRawList(String[] nameList, String nameToFind)
    {
        if (nameToFind != null)
        {
    ...
    public static boolean isNameOnPermissionList(String[] permissionList, String nameToFind)
    {
    ...
    public static boolean addGuildIdToRawList(Vector nameList, int guildId)
    {
        if (guildId != 0)
        {
            if (nameList == null)
    ...
    public static boolean addGuildNameToRawList(Vector nameList, String guildNameToAdd) {
        return guildNameToAdd != null && addGuildIdToRawList(nameList, findGuild((guildNameToAdd.trim()).toLowerCase()));
    }
    public static boolean addPlayerObjIdToRawList(Vector nameList, obj_id playerObjId)
    {
    ...
    public static boolean addPlayerNameToRawList(Vector nameList, String playerNameToAdd) {
        return playerNameToAdd != null && addPlayerObjIdToRawList(nameList, getPlayerIdFromFirstName((playerNameToAdd.trim()).toLowerCase()));
    }
    public static boolean addNameToRawList(Vector nameList, String nameToAdd)
    {
        if (nameToAdd != null)
        {
    ...
    public static boolean removeGuildIdFromRawList(Vector nameList, int guildId)
    {
    ...
    public static boolean removeGuildNameFromRawList(Vector nameList, String guildNameToRemove) {
        return guildNameToRemove != null && removeGuildIdFromRawList(nameList, findGuild((guildNameToRemove.trim()).toLowerCase()));
    }
    public static boolean removePlayerObjIdFromRawList(Vector nameList, obj_id playerObjId)
    {
    ...
    public static boolean removePlayerNameFromRawList(Vector nameList, String playerNameToRemove) {
    ...
    public static boolean removeNameFromRawList(Vector nameList, String nameToRemove)
    {
    ...
    public static String[] convertRawListToNames(String[] nameListToConvert)
    {
    ...
    public static boolean modifyList(obj_id structure, String player_or_guild_name, obj_id admin, String objvar, boolean verbose)
    {
        if (!isIdValid(structure))
        {
            return false;
    ...
    public static boolean modifyEntryList(obj_id structure, obj_id player, obj_id admin) {
        return isIdValid(player) && modifyEntryList(structure, getPlayerName(player), admin);
    }
    public static boolean modifyEntryList(obj_id structure, String player_or_guild_name, obj_id admin)
    {
        if (!isBuilding(structure))
        {
    ...
    public static boolean modifyBanList(obj_id structure, String player_or_guild_name, obj_id admin)
    {
        if (!isBuilding(structure))
        {
            sendSystemMessage(admin, new string_id(STF_FILE, "no_banned"));
    ...
    public static boolean modifyBanList(obj_id structure, obj_id player, obj_id admin)
    {
        if (isIdValid(player))
        {
    ...
    public static boolean modifyAdminList(obj_id structure, obj_id player, obj_id admin)
    {
        return modifyAdminList(structure, getPlayerName(player), admin);
    }
    public static boolean modifyAdminList(obj_id structure, String player_or_guild_name, obj_id admin)
    {
    ...
    public static boolean modifyVendorList(obj_id structure, String player_name, obj_id admin)
    {
        return false;
    }
    public static boolean modifyVendorList(obj_id structure, obj_id player, obj_id admin)
    {
        return modifyVendorList(structure, getPlayerName(player), admin);
    }
    public static boolean modifyHopperList(obj_id structure, obj_id player, obj_id admin)
    {
        return modifyHopperList(structure, getPlayerName(player), admin);
    }
    public static boolean modifyHopperList(obj_id structure, String player_or_guild_name, obj_id admin)
    {
        if (!isInstallation(structure))
        {
    ...
    public static int getStructureTableIndex(String object)
    {
        return dataTableSearchColumnForString(object, DATATABLE_COL_STRUCTURE, PLAYER_STRUCTURE_DATATABLE);
    }
    public static obj_id addStructureWaypoint(obj_id player, location loc, String name, obj_id structure)
    {
    ...
    public static boolean payMaintenance(obj_id player, obj_id structure, int amt)
    {
    ...
    public static boolean withdrawMaintenance(obj_id player, obj_id structure, int amt)
    {
        if (!isIdValid(player) || !isIdValid(structure))
        {
            return false;
    ...
    public static int decrementMaintenancePool(obj_id structure, int amt)
    {
        if (!isIdValid(structure))
        {
            return -1;
    ...
    public static int damageStructure(obj_id structure, int amt, boolean boolCondemn)
    {
        if (structure == null || structure == obj_id.NULL_ID || amt < 1 || amt > 6 || getBankBalance(structure) > getBaseMaintenanceRate(structure))
        {
            return -1;
        }
    ...
    public static int damageStructure(obj_id structure, int amt)
    {
        return damageStructure(structure, amt, false);
    }
    public static int repairStructure(obj_id structure, int amt)
    {
        if (structure == null || structure == obj_id.NULL_ID)
        {
    ...
    public static boolean initiateRepairCheck(obj_id structure)
    {
        if (!isIdValid(structure))
        {
            return false;
    ...
    public static boolean sendMaintenanceMail(obj_id structure)
    {
        if (!isIdValid(structure))
        {
            return false;
    ...
    public static int destroyStructure(obj_id structure, obj_id containerForDeed, boolean reclaim, boolean overloaded)
    {
        ...
        if (reclaim)
        {
            ...
            // All but Harvesters are handled here due to Harvester double redeed cost
            if (!isHarvester(structure))
            {
                ...
                if (surplus > 0)
                {
                    if (isGod(self))
                    {
                        sendSystemMessageTestingOnly(self, "GOD MESSAGE: SURPLUS WAS " + surplus + " CREDITS");
                    }
            ...
            // Harvesters broken into separate category to resolve double cost
            if (isHarvester(structure))
            {
                int reclaimCost = getRedeedCost(structure) / 2;
                transferBankCreditsToNamedAccount(structure, money.ACCT_DEED_RECLAIM, reclaimCost, "noHandler", "noHandler", new dictionary());
                int surplus = getBankBalance(structure) - reclaimCost;
                if (surplus > 0)
                {
    ...
    public static boolean destroyStructure(obj_id structure, boolean reclaim)
    {
        return destroyStructure(structure, reclaim, false);
    }
    public static boolean destroyStructure(obj_id structure, boolean reclaim, boolean overrideOwner)
    {
    ...
    public static boolean destroyStructure(obj_id structure)
    {
        return destroyStructure(structure, false);
    }
    public static boolean destroyBaseObjects(obj_id structure)
    {
        if (structure == null || structure == obj_id.NULL_ID)
        {
            return false;
    ...
    public static boolean validateBaseObjects(obj_id structure)
    {
        if (!isIdValid(structure))
        {
            return false;
    ...
    public static int[] convertSecondsTime(int time)
    {
        if (time < 1)
        {
            return null;
    ...
    public static String assembleTimeRemaining(int[] time_values)
    {
    ...
    public static boolean convertPermissionsLists(obj_id structure)
    {
        if (!isIdValid(structure))
        {
    ...
    public static String[] convertObjIdPermissionList(obj_id[] objId_list)
    {
    ...
    public static String[] convertStringPermissionList(String[] name_list)
    {
    ...
    public static float[] transformDeltaWorldCoord(float X, float Z, int rotation)
    {
        float x = X;
        float z = Z;
        switch (rotation)
    ...
    public static location transformDeltaWorldCoord(location here, float dx, float dz, float yaw)
    {
        yaw = yaw % 360f;
        if (yaw < 0)
        {
    ...
    public static boolean hasSign(obj_id structure) {
        return isIdValid(structure) && hasObjVar(structure, VAR_SIGN_ID);
    }
    public static boolean isPackedUp(obj_id structure) {
    ...
    public static obj_id createStructureSign(obj_id structure, float sYaw)
    {
        if (!isIdValid(structure))
        {
            return null;
            ...
            if ((params != null) && (!params.isEmpty()))
            {
                ...
                if (hasObjVar(structure, MODIFIED_HOUSE_SIGN))
                {
                    ...
                    switch (structureTemplate) {
                        case "object/building/player/player_house_mustafar_lg.iff":
                            if (signTemplate.startsWith("object/tangible/sign/player/house_address") && !signTemplate.equals("object/tangible/sign/player/house_address_corellia.iff")) {
                                if (signTemplate.equals("object/tangible/sign/player/house_address_halloween_sign.iff")) {
                                    heading += 90;
                                }
                                there.z -= 0.4f;
                                z -= 0.4f;
                            ...
                            break;
                        case "object/building/player/player_house_generic_large_style_01.iff":
                            if (signTemplate.startsWith("object/tangible/sign/player/shop_sign_") && !signTemplate.equals("object/tangible/sign/player/shop_sign_s0.iff")) {
                                there.z += 0.8f;
                                z += 0.8f;
                            }
                            break;
                        case "object/building/player/city/cantina_naboo.iff":
                            if (signTemplate.startsWith("object/tangible/sign/player/house_address") && !signTemplate.startsWith("object/tangible/sign/municipal/municipal_sign_hanging_cantina")) {
                                there.z += 0.3f;
                                z += 0.3f;
                            }
                            break;
                        case "object/building/player/city/cantina_corellia.iff":
                            if (signTemplate.startsWith("object/tangible/sign/player/house_address") && !signTemplate.equals("object/tangible/sign/municipal/municipal_sign_hanging_cantina.iff")) {
                                there.z += 0.1f;
                                z += 0.1f;
                            }
                            break;
                ...
                else if (hasObjVar(structure, SPECIAL_SIGN))
                {
                    ...
                    switch (signTemplate) {
                        case "object/tangible/tcg/series5/house_sign_tcg_hanging.iff":
                            there.y += 1.5f;
                            y += 1.5f;
                            break;
                    case "object/tangible/sign/player/pgc_sign_hanging.iff":
                        there.x -= 0.45f;
                        x -= 0.45f;
                        switch (structureTemplate) {
                            case "object/building/player/player_house_naboo_small_style_02.iff":
                                there.x += 0.5f;
                                x += 0.5f;
                                break;
                            case "object/building/player/player_house_corellia_large_style_01.iff":
                                heading += 90;
                                there.z -= 0.5f;
                                z -= 0.5f;
                                break;
                            case "object/building/player/player_house_corellia_large_style_02.iff":
                            case "object/building/player/player_house_corellia_small_style_02.iff":
                            case "object/building/player/player_house_corellia_small_style_02_floorplan_02.iff":
                                heading += 90;
                                there.z -= 0.1f;
                                z -= 0.1f;
                                break;
                            case "object/building/player/player_house_corellia_medium_style_01.iff":
                                heading += 90;
                                break;
                            case "object/building/player/player_house_corellia_small_style_01.iff":
                            case "object/building/player/player_house_corellia_small_style_01_floorplan_02.iff":
                                heading += 90;
                                there.x += 0.5f;
                                x += 0.5f;
                                break;
                            case "object/building/player/player_merchant_tent_style_01.iff":
                            case "object/building/player/player_merchant_tent_style_02.iff":
                            case "object/building/player/player_merchant_tent_style_03.iff":
                            case "object/building/player/player_pgc_merchant_tent_s01.iff":
                                heading += 100;
                                there.z -= 0.1f;
                                z -= 0.1f;
                                break;
                            case "object/building/player/player_house_tatooine_large_style_01.iff":
                                there.z -= 0.1f;
                                z -= 0.1f;
                                break;
                            case "object/building/player/player_house_mustafar_lg.iff":
                                ...
                                break;
                            case "object/building/player/player_house_generic_large_style_01.iff":
                            case "object/building/player/player_house_generic_large_style_02.iff":
                            case "object/building/player/player_house_generic_medium_style_02.iff":
                            case "object/building/player/player_house_generic_small_style_02.iff":
                                there.z += 0.2f;
                                z += 0.2f;
                                break;
                            case "object/building/player/player_house_generic_medium_windowed_s02.iff":
                                there.z -= 0.2f;
                                z -= 0.2f;
                                break;
                            case "object/building/player/player_house_generic_small_style_01.iff":
                                there.z += 0.2f;
                                there.x += 0.7f;
                                z += 0.2f;
                                x += 0.7f;
                                break;
                            case "object/building/player/player_house_naboo_small_style_01.iff":
                                heading -= 10;
                                there.x += 0.4f;
                                x += 0.4f;
                                break;
                            case "object/building/player/player_house_generic_small_windowed.iff":
                                there.x += 0.5f;
                                x += 0.5f;
                                break;
                            case "object/building/player/player_house_generic_small_window_style_03.iff":
                                there.x += 1.0f;
                                there.z -= 0.2f;
                                x += 1.0f;
                                z -= 0.2f;
                                break;
                            case "object/building/player/player_house_naboo_small_window_style_01.iff":
                                heading -= 12;
                                there.x += 0.6f;
                                x += 0.6f;
                                break;
                    ...
                    switch (structureTemplate) {
                        case "object/building/player/player_house_mustafar_lg.iff":
                            switch (signTemplate) {
                                case "object/tangible/tcg/series3/house_sign_tcg_s01.iff":
                                    there.z -= 0.4f;
                                    z -= 0.4f;
                                    break;
                                case "object/tangible/sign/player/imperial_empire_day_2009_sign_hanging.iff":
                                case "object/tangible/sign/player/rebel_remembrance_day_2009_sign_hanging.iff":
                                    there.z -= 0.4f;
                                    z -= 0.4f;
                                    break;
                                case "object/tangible/tcg/series5/house_sign_tcg_hanging.iff":
                            ...
                            break;
                        case "object/building/player/city/theater_corellia.iff":
                            switch (signTemplate) {
                            case "object/tangible/tcg/series5/house_sign_tcg_hanging.iff":
                                there.x -= 0.4f;
                                x -= 0.4f;
                        ...
                        break;
                        case "object/building/player/player_guildhall_corellia.iff":
                             switch (signTemplate) {
                                case "object/tangible/tcg/series5/house_sign_tcg_hanging.iff":
                                    there.z -= 0.4f;
                                    there.y -= 0.1f;
                            ...
                            break;
                    case "object/building/player/city/theater_tatooine.iff":
                        switch (signTemplate) {
                            case "object/tangible/sign/player/imperial_empire_day_2009_sign_hanging.iff":
                            case "object/tangible/sign/player/rebel_remembrance_day_2009_sign_hanging.iff":
                                there.x -= 0.4f;
                        ...
                        break;
                    case "object/building/player/player_guildhall_tatooine.iff":
                        switch (signTemplate) {
                            case "object/tangible/sign/player/rebel_remembrance_day_2009_sign_hanging.iff":
                            case "object/tangible/sign/player/imperial_empire_day_2009_sign_hanging.iff":
                                there.z -= 0.1f;
                    ...
                    case "object/building/player/player_house_corellia_large_style_01.iff":
                        switch (signTemplate) {
                            case "object/tangible/tcg/series5/house_sign_tcg_standing.iff":
                                there.z += 1.2f;
                                z += 1.2f;
                                break;
                            case "object/tangible/sign/player/rebel_remembrance_day_2009_sign_standing.iff":
                            case "object/tangible/sign/player/imperial_empire_day_2009_sign_standing.iff":
                                there.z += 0.6f;
                                z += 0.6f;
                                break;
                            case "object/tangible/sign/player/rebel_remembrance_day_2009_sign_hanging.iff":
                        ...
                        break;
                        case "object/building/player/player_merchant_tent.iff":
                            if (signTemplate.startsWith("object/tangible/tcg/") && !signTemplate.equals("object/tangible/tcg/series3/house_sign_tcg_s02.iff")) {
                                there.x -= 0.4f;
                                there.z -= 0.4f;
                                x -= 0.4f;
                                z -= 0.4f;
                                ...
                                switch (signTemplate) {
                                    case "object/tangible/tcg/series3/house_sign_tcg_s02.iff":
                                        there.x += 0.6f;
                                        there.z += 0.1f;
                                        x += 0.6f;
                                        z += 0.1f;
                                        break;
                                    case "object/tangible/sign/player/house_address_halloween_sign.iff":
                                        there.x -= 0.2f;
                                        there.z -= 0.2f;
                                        x -= 0.2f;
                                        z -= 0.2f;
                        ...
                        case "object/building/player/player_house_corellia_small_style_02_floorplan_02.iff":
                        case "object/building/player/player_house_corellia_small_style_02.iff":
                        case "object/building/player/player_house_tatooine_small_style_02.iff":
                        case "object/building/player/player_house_tatooine_large_style_01.iff":
                            switch (signTemplate) {
                                case "object/tangible/sign/player/rebel_remembrance_day_2009_sign_hanging.iff":
                                case "object/tangible/sign/player/imperial_empire_day_2009_sign_hanging.iff":
                            ...
                            break;
                        case "object/building/player/player_house_naboo_large_style_01.iff":
                            switch (signTemplate) {
                                case "object/tangible/sign/player/rebel_remembrance_day_2009_sign_hanging.iff":
                                case "object/tangible/sign/player/imperial_empire_day_2009_sign_hanging.iff":
                                    there.z += 0.1f;
                            ...
                            break;
                        case "object/building/player/player_house_tcg_vehicle_garage.iff":
                            switch (signTemplate) {
                                case "object/tangible/tcg/series3/house_sign_tcg_s01.iff":
                                case "object/tangible/sign/player/house_address_halloween_sign.iff":
                                case "object/tangible/sign/player/imperial_empire_day_2009_sign_hanging.iff":
                            ...
                            break;
                        case "object/building/player/player_house_tcg_vip_bunker.iff":
                            switch (signTemplate) {
                                case "object/tangible/tcg/series3/house_sign_tcg_s01.iff":
                                case "object/tangible/sign/player/house_address_halloween_sign.iff":
                                case "object/tangible/sign/player/imperial_empire_day_2009_sign_hanging.iff":
                            ...
                            break;
                        case "object/building/player/player_house_tcg_commando_bunker.iff":
                            switch (signTemplate) {
                                case "object/tangible/tcg/series3/house_sign_tcg_s01.iff":
                                case "object/tangible/sign/player/house_address_halloween_sign.iff":
                                case "object/tangible/sign/player/imperial_empire_day_2009_sign_hanging.iff":
    ...
    public static obj_id createStructureSign(obj_id structure)
    {
        if (!isIdValid(structure))
        {
            return null;
    ...
    public static void destroyStructureSign(obj_id structure)
    {
        if (!isIdValid(structure))
        {
            return;
    ...
    public static float powerInstallation(obj_id bldg, obj_id energon)
    {
    ...
    public static float powerInstallation(obj_id bldg, int amt)
    {
    ...
    public static void validateHarvestedResources(obj_id structure)
    {
        if (!isIdValid(structure))
        {
            return;
    ...
    public static String getHarvesterMasterResource(obj_id structure)
    {
        if (!isIdValid(structure))
        {
            return null;
    ...
    public static boolean canReclaimDeed(obj_id structure) {
        return isIdValid(structure) && canReclaimDeed(getTemplateName(structure));
    }
    public static boolean canReclaimDeed(String structureTemplate) {
    ...
    public static void showChangeSignSui(obj_id structure, obj_id player)
    {
    ...
    public static String getStructureName(obj_id structure)
    {
        if (!isIdValid(structure))
        {
            return null;
    ...
    public static boolean canPlaceGarage(location loc, float range, String template)
    {
    ...
    public static boolean hasMaintenanceDroid(obj_id player)
    {
    ...
    public static obj_id[] getMaintenanceDroids(obj_id player)
    {
    ...
    public static void flagConverted(String template, obj_id structure)
    {
    ...
    public static int convertLotCosts(obj_id structure, String template, int struct_lots)
    {
    ...
    public static void doOldToNewLotConversion(obj_id player, obj_id structure)
    {
        if (!isOwner(structure, player))
        {
            return;
    ...
    public static void adjustLotsForOfflinePlayer(obj_id owner, obj_id structure)
    {
        dictionary params = new dictionary();
        if (!hasObjVar(structure, "newBuilding"))
        {
    ...
    public static void doCondemnedSui(obj_id objStructure, obj_id objItem)
    {
    ...
    public static int getStructureRepairCost(obj_id structure)
    {
        int damage = getMaxCondition(structure) - getStructureCondition(structure);
        float per_point_cost = getBaseMaintenanceRate(structure) / 3.0f;
        return (int)(damage * per_point_cost);
    }
    public static boolean isStructureCondemned(obj_id objStructure)
    {
        return hasObjVar(objStructure, "player_structure.condemned");
    }
    public static void sendCondemnedMail(obj_id objStructure)
    {
    ...
    public static int getMaintenanceHeartbeat()
    {
    ...
    public static void sendOutOfMaintenanceMail(obj_id objStructure)
    {
        location loc = getLocation(objStructure);
        String loc_str = "(" + loc.x + ", " + loc.z + "  " + loc.area + ")";
    ...
    public static boolean isFactionPerkBase(String objectTemplateName)
    {
        return objectTemplateName.contains("object/building/faction_perk/hq/");
    }
    public static boolean isFactionPerkBaseDeed(obj_id objDeed)
    {
        return isFactionPerkBaseDeed(getTemplateName(objDeed));
    }
    public static boolean isFactionPerkBaseDeed(String deedObjectTemplateName)
    {
        return deedObjectTemplateName.contains("object/tangible/deed/faction_perk/hq/");
    }
    public static boolean canPlaceFactionPerkDeed(obj_id objDeed, obj_id objPlayer)
    {
    ...
    public static int validateHopperSize(obj_id structureObject)
    {
    ...
    public static boolean doesUnmarkedStructureQualifyForHousePackup(obj_id structure)
    {
    ...
    public static boolean needsPreAbandonCheck(obj_id structure)
    {
        if (!isIdValid(structure))
        {
            return false;
    ...
    public static boolean needsAbandonCheck(obj_id structure)
    {
        if (!isIdValid(structure))
        {
            return false;
    ...
    public static boolean needsCityAbandonCheck(obj_id structure)
    {
        if (!isIdValid(structure))
        {
    ...
    public static String getStructureInfo(obj_id structure)
    {
        final String yes = "Y|";
        final String no = "N|";
        final String blank = "|";
    ...
    public static boolean isEliteHarvester(obj_id structure)
    {
        if (isIdValid(structure))
        {
            String templateName = getTemplateName(structure);
    ...
    public static boolean canShowPackOption(obj_id player, obj_id structure)
    {
        if (!isIdValid(structure) || !isIdValid(player))
        {
            return false;
    ...
    public static boolean canPlayerPackAbandonedStructure(obj_id player, obj_id structure)
    {
    ...
    public static boolean canPackStructureWithVendors(obj_id player, obj_id structure)
    {
    ...
    public static void packAbandonedBuilding(obj_id player, obj_id structure, dictionary params)
    {
    ...
    public static boolean canPackMoreToday(obj_id player)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static boolean isPlayerGatedFromHousePackUp(obj_id player)
    {
        if (!isValidId(player) || !exists(player))
        {
            return true;
    ...
    public static boolean isPlayerLockedOutOfHousePackup(obj_id player)
    {
        if (!isValidId(player) || !exists(player))
        {
            return true;
    ...
    public static int getTotalIncreasedStorageAmountStructure(obj_id structure)
    {
        if (isIdValid(structure))
        {
    ...
    public static boolean validSafeStorageRemoval(obj_id structure, int decreaseAmount)
    {
    ...
    public static boolean incrementStorageAmount(obj_id player, obj_id structure, obj_id deed, int increaseAmount)
    {
    ...
    public static boolean decrementStorageAmount(obj_id player, obj_id structure, obj_id terminal, int selectedRedeedTypeIndex)
    {
    ...
    public static boolean isNonGenericLootItem(obj_id deed)
    {
        return hasObjVar(deed, "nonGenericStorageItem");
    }
    public static boolean alreadyHasNonGenericStorageIncreaseOfType(obj_id structure, obj_id deed)
    {
        return hasObjVar(structure, NON_GENERIC_STORAGE_ITEM_OBJVAR + "." + getStaticItemName(deed));
    }
    public static void setNonGenericStorageIncreaseOfTypeObjVar(obj_id structure, obj_id deed, int increaseAmount)
    {
        setObjVar(structure, NON_GENERIC_STORAGE_ITEM_OBJVAR + "." + getStaticItemName(deed), increaseAmount);
    }
    public static void removeNonGenericStorageIncreaseOfTypeObjVar(obj_id structure, String type)
    {
    ...
    public static void displayAvailableNonGenericStorageTypes(obj_id player, obj_id terminal, obj_id structure)
    {
    ...
    public static String[] getStorageTypeNamesArray(obj_id structure)
    {
    ...
    public static boolean handleStorageReclaimConfirmation(obj_id player, obj_id terminal)
    {
        sui.msgbox(
                terminal,
                player,
    ...
    public static boolean canRotateFurnitureInPitchRollAxes(obj_id player) {
        return isIdValid(player) && hasCompletedCollection(player, "force_shui_tier_02");
    }
    public static boolean isPlayerStructure(obj_id target)
    {
    ...
    public static boolean hasSpecialSignSkillMod(obj_id player, obj_id structure)
    {
        if (!isValidId(player) || !exists(player))
        {
            return false;
    ...
    public static boolean getSpecialSignList(obj_id player, obj_id structure)
    {
        if (!isValidId(player) || !exists(player))
        {
            return false;
    ...
    public static boolean removeSpecialSign(obj_id player, obj_id structure, boolean revertMessage)
    {
    ...
    public static void revertCustomSign(obj_id player, obj_id structure)
    {
    ...
    public static void initializeFindAllItemsInHouse(obj_id self, obj_id player)
    {
        cleanupFindItemScriptVars(player);
        cleanupFindItemScriptVars(self);
        showFindItemsListboxPage(self, player, 0);
    }
    public static void initializeItemSearchInHouse(obj_id self, obj_id player)
    {
    ...
    public static void showFindItemsListboxPage(obj_id self, obj_id player, int startingIndex)
    {
        cleanupFindItemScriptVars(player);
        cleanupFindItemScriptVars(self);
    ...
    public static void repeatFindItemsListboxPage(obj_id self, obj_id player, int startingIndex, int totalNumItems, obj_id[] itemsPageList)
    {
        cleanupFindItemScriptVars(player);
        cleanupFindItemScriptVars(self);
    ...
    public static void showFindItemsListboxSui(obj_id self, obj_id player, int startingIndex, int totalNumItems, obj_id[] itemsPageList, String[] itemsPageNamesList)
    {
    ...
    public static Vector getMyItemsInBuilding(obj_id player)
    {
    ...
    public static void addPlayerItemsFromContainerToList(obj_id container, obj_id player, Vector myItemsInBuilding)
    {
    ...
    public static boolean moveItemInBuildingToPlayer(obj_id player, obj_id selectedItem)
    {
        location here = getLocation(player);
        obj_id myCell = here.cell;
        if (isIdValid(myCell))
    ...
    public static obj_id getTopNonCellContainer(obj_id item)
    {
    ...
    public static void cleanupFindItemScriptVars(obj_id target)
    {
        utils.removeScriptVarTree(target, "findItems");
    }
    public static void handleFindItemsListResponse(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return;
    ...
    public static void handleFindItemsChangePageResponse(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return;
    ...
    public static void handleSearchItemsGetKeyword(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return;
    ...
    public static void repeatSearchItemsKeywordList(obj_id self, obj_id player, obj_id[] matchingItemsList)
    {
        cleanupFindItemScriptVars(player);
        cleanupFindItemScriptVars(self);
    ...
    public static void showSearchItemsListboxSui(obj_id self, obj_id player, obj_id[] matchingItemsList, String[] matchingItemsNamesList, String prompt)
    {
        int pid = sui.listbox(
                self,
                player,
    ...
    public static void handleSearchItemsSelectedResponse(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return;
    ...
    public static void removeStructureFromMaintenance(obj_id droid, obj_id pcd, int indexOfStructure)
    {
        if (!isIdValid(pcd))
        {
            return;
