...
public class dump extends script.base_script
{
    ...
    public static String getTargetInfoStringByLong(long lTarget)
    {
    ...
    public static String getTargetInfoString(obj_id objTarget)
    {
    ...
    public static String getReadableObjVars(obj_id objTarget)
    {
    ...
    public static String getReadableScripts(obj_id objTarget)
    {
    ...
    public static String getReadableScriptVars(obj_id objTarget)
    {
        deltadictionary dctScriptVars = objTarget.getScriptVars();
        return dctScriptVars.toString();
    }
    public static String getReadableLocalVars(obj_id objTarget)
    {
        dictionary dd = objTarget.getScriptDictionary();
        return dd.toString();
    }
    public static String getReadableContainmentTree(obj_id objTarget)
    {
    ...
    public static String getReadableContainer(obj_id container)
    {
    ...
    public static String getReadableEnemyFlags(obj_id objTarget)
    {
    ...
    public static String getReadableBountyMissions(obj_id objTarget)
    {
    ...
    public static String getReadableBounties(obj_id objTarget)
    {
    ...
    public static String getReadableBountyHunters(obj_id objTarget)
    {
    ...
    public static String getReadableFsQuests(obj_id objTarget)
    {
    ...
    public static String getReadableFsQuestChildren(dictionary questMap, String questName, int indentLevel)
    {
    ...
    public static String getReadableFsQuest(dictionary questMap, String questName, int indentLevel)
    {
    ...
    public static String getReadableFsBranchesUnlocked(obj_id objTarget)
    {
        String branch_list = "";
        for (int i = 0; i < 16; i++)
        {
    ...
    public static String getReadableSpaceQuests(obj_id objTarget)
    {
    ...
    public static String getReadableSpaceQuest(obj_id player, String questType, String questName)
    {
    ...
    public static String csTargetDump(obj_id self, obj_id objTarget, boolean colorFlag)
    {
        String strTest = "";
        strTest += "OBJECT ID: \t\t\t";
        strTest += objTarget + "\r\n";
    ...
    public static obj_id findDumpTarget(obj_id self)
    {
    ...
    public static String getAllCompletedCollections(obj_id player, String[] collectionBooks)
    {
    ...
    public static String getAllIncompleteCollections(obj_id player, String[] collectionBooks)
    {
        if (!isValidId(player) || !exists(player))
        {
            return null;
