...
public class content extends script.base_script
{
    ...
    public static boolean isCrafter(obj_id player)
    {
    ...
    public static boolean isEntertainer(obj_id player)
    {
        String profession = getSkillTemplate(player);
    ...
    public static void grantRsfSecurityClearance(obj_id player)
    {
    ...
    public static void grantAllRsfSecurityClearance(obj_id player)
    {
