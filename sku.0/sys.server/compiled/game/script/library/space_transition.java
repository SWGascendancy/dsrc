...
public class space_transition extends script.base_script
{
    ...
    public static final int SHIP_LIMIT_MAX = 6;
    public static final float STATION_COMM_MAX_DISTANCE = 950.0f;
    ...
    public static void handlePotentialSceneChange(obj_id player)
    {
    ...
    public static void handleLogout(obj_id player)
    {
        obj_id containingShip = getContainingShip(player);
        if (isIdValid(containingShip))
        {
    ...
    public static boolean shouldSendToGroundOnLogout()
    {
    ...
    public static void setLaunchInfo(obj_id player, obj_id ship, int startLocationIndex, location groundLoc)
    {
    ...
    public static obj_id getContainingShip(obj_id obj)
    {
    ...
    public static obj_id[] findShipControlDevicesForPlayer(obj_id player)
    {
        return findShipControlDevicesForPlayer(player, false);
    }
    public static obj_id[] findShipControlDevicesForPlayer(obj_id player, boolean checkHangar)
    {
    ...
    public static obj_id[] findShipControlDevicesInHangarSlot(obj_id player)
    {
    ...
    public static obj_id findEmptyShipControlDeviceForShip(obj_id player, obj_id ship)
    {
    ...
    public static obj_id findEmptyShipControlDeviceForPlayer(obj_id player)
    {
    ...
    public static obj_id getShipFromShipControlDevice(obj_id shipControlDevice)
    {
    ...
    public static int countShipControlDevicesForPlayer(obj_id player)
    {
        int count = -1;
        obj_id datapad = utils.getDatapad(player);
        if (isIdValid(datapad))
    ...
    public static boolean isPlayerBelowShipLimit(obj_id player, obj_id destinationContainer)
    {
    ...
    public static boolean isPlayerBelowShipLimit(obj_id player)
    {
    ...
    public static obj_id findPilotSlotObjectForShip(obj_id pilot, obj_id ship)
    {
    ...
    public static Vector getContainedPlayers(obj_id obj)
    {
        return getContainedPlayers(obj, null);
    }
    public static Vector getContainedPlayers(obj_id obj, Vector players)
    {
        if (isPlayer(obj))
        {
    ...
    public static void packShip(obj_id ship)
    {
    ...
    public static obj_id[] getAllObjectsInPob(obj_id pob)
    {
    ...
    public static void setShipName(obj_id ship, obj_id player, obj_id shipControlDevice)
    {
    ...
    public static boolean unpackShipForPlayer(obj_id player, obj_id ship)
    {
    ...
    public static boolean inNovaOrionBattle(obj_id player)
    {
    ...
    public static int getPreOverridePlayerSpaceFaction(obj_id player)
    {
    ...
    public static int getPlayerSpaceFaction(obj_id player)
    {
        obj_id ship = getContainingShip(player);
        if (!isIdValid(ship))
        {
    ...
    public static void grantDroidCommands(obj_id objPlayer)
    {
    ...
    public static void revokeDroidCommands(obj_id objPlayer)
    {
        String[] strDroidCommands = space_combat.getProgrammedDroidCommands(objPlayer);
        if (strDroidCommands != null && strDroidCommands.length > 0)
        {
    ...
    public static void teleportPlayerToLaunchLoc(obj_id player)
    {
        teleportPlayerToLaunchLoc(player, false);
    }
    public static void teleportPlayerToLaunchLoc(obj_id player, boolean hyperspace)
    {
    ...
    public static location getShipBoardingDestination(obj_id objShip)
    {
    ...
    public static boolean isShipBoardable(obj_id objPlayer, obj_id objShip)
    {
    ...
    public static Vector getShipStartLocations(obj_id ship)
    {
    ...
    public static void updateLaunchWaypoint(obj_id objPlayer, location locTest, String strName)
    {
    ...
    public static void updateShipFaction(obj_id ship, obj_id player)
    {
        int spaceFaction = 0;
    ...
    public static void setPlayerOvert(long player)
    {
    ...
    public static void setPlayerOvert(obj_id player)
    {
    ...
    public static void setPlayerOvert(obj_id player, int overrideFaction)
    {
        obj_id ship = getContainingShip(player);
    ...
    public static void clearOvertStatus(long objShip)
    {
    ...
    public static void clearOvertStatus(obj_id objShip)
    {
        if (isIdValid(objShip))
        {
    ...
    public static void updatePVPStatus(obj_id objShip)
    {
    ...
    public static void doAIImmunityCheck(obj_id objShip)
    {
    ...
    public static void adjustShipTeleportFixupInSpaceScene(obj_id ship)
    {
    ...
    public static int getNextStartIndex(Vector shipStartLocations, int lastStartIndex)
    {
    ...
    public static void launch(obj_id player, obj_id ship, obj_id[] passengers, location warpLocation, location groundLoc)
    {
    ...
    public static void exitCapitalShip(obj_id objPlayer, transform trTest)
    {
    ...
    public static void enterCapitalShip(obj_id objPlayer, transform trTest, obj_id objCell)
    {
