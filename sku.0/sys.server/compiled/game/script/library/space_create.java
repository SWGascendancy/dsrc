...
public class space_create extends script.base_script
{
    ...
    public static obj_id createShip(String strShipType, transform locTransform)
    {
        return createShip(strShipType, locTransform, null);
    }
    public static obj_id createShip(String strShipType, transform locTransform, obj_id objCell)
    {
        return _createShip(strShipType, locTransform, objCell, false);
    }
    public static obj_id createShipHyperspace(String strShipType, transform locTransform)
    {
        return _createShip(strShipType, locTransform, null, true);
    }
    public static obj_id createShipHyperspace(String strShipType, transform locTransform, obj_id objCell)
    {
        return _createShip(strShipType, locTransform, objCell, true);
    }
    public static obj_id _createShip(String strShipType, transform locTransform, obj_id objCell, boolean hyperspace)
    {
    ...
    public static obj_id makeCreditChip(obj_id objContainer, int intCredits)
    {
    ...
    public static obj_id getCreditChip(obj_id objContainer)
    {
        if (!isIdValid(objContainer))
        {
            return null;
    ...
    public static Vector createSquad(obj_id objParent, String strSquad, transform trSpawnLocation, float fltDistance, obj_id objCell)
    {
        return _createSquad(objParent, strSquad, trSpawnLocation, fltDistance, objCell, false);
    }
    public static Vector createSquadHyperspace(obj_id objParent, String strSquad, transform trSpawnLocation, float fltDistance, obj_id objCell)
    {
        return _createSquad(objParent, strSquad, trSpawnLocation, fltDistance, objCell, true);
    }
    public static Vector _createSquad(obj_id objParent, String strSquad, transform trSpawnLocation, float fltDistance, obj_id objCell, boolean hyperspace)
    {
    ...
    public static obj_id setupShipFromObjVars(obj_id objShip)
    {
    ...
    public static void setupAIFlightModeling(obj_id objShip, String strPilotType)
    {
