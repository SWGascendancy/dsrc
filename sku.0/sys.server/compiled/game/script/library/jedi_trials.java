...
public class jedi_trials extends script.base_script
{
    ...
    public static boolean isEligibleForJediPadawanTrials(obj_id player)
    {
        if (isIdValid(player))
        {
    ...
    public static void initializePadawanTrials(obj_id player)
    {
    ...
    public static void doPadawanTrialsSetup(obj_id player)
    {
        if (isIdValid(player))
        {
    ...
    public static boolean isEligibleForJediKnightTrials(obj_id player)
    {
    ...
    public static int isEligibleForJediKnightTrialsPointsRemaining(obj_id player)
    {
        if (isIdValid(player))
        {
    ...
    public static void initializeKnightTrials(obj_id player)
    {
    ...
    public static void doJediTrialsCleanup(obj_id player)
    {
        removeObjVar(player, JEDI_TRIALS_BASE_OBJVAR);
    ...
    public static int getJediTrialRow(obj_id player)
    {
    ...
    public static String getJediTrialName(obj_id player)
    {
    ...
    public static location getRandomForceShrineLocation(obj_id player)
    {
        String shrinePlanet = chooseRandomPlanet(player);
        location shrineLoc = chooseForceShrineOnPlanet(shrinePlanet);
        return shrineLoc;
    }
    public static String chooseRandomPlanet(obj_id player)
    {
        String planet = "";
        String[] allPlanets = 
        {
    ...
    public static String chooseRandomCivilizedPlanet(obj_id player)
    {
        String planet = "";
        String[] allPlanets = 
        {
    ...
    public static String chooseRandomAdventurePlanet(obj_id player)
    {
        String planet = "";
        String[] allPlanets = 
        {
    ...
    public static void setClosestForceShrineWaypoint(obj_id player)
    {
    ...
    public static location getclosetForceShrineLocation(obj_id player)
    {
        location here = getLocation(player);
    ...
    public static location chooseForceShrineOnPlanet(String planet)
    {
    ...
    public static int getPlanetForceShrineDatatableIndex(String planet)
    {
    ...
    public static boolean isValidShrineLocObjVar(obj_id player)
    {
    ...
    public static int[] getQuestOrderFromDatatable(String datatable)
    {
    ...
    public static String getJediTrialsQuestListAsString(obj_id player, int[] questList)
    {
    ...
    public static String getJediTrialsDatatableString(obj_id player, String column)
    {
    ...
    public static int getJediTrialsDatatableInt(obj_id player, String column)
    {
    ...
    public static void giveGenericForceShrineMessage(obj_id player)
    {
    ...
    public static boolean checkForGroupCombatQuestKill(obj_id player, dictionary params, String datatableColumn)
    {
    ...
    public static boolean checkForIndividualCombatQuestKill(obj_id player, dictionary params, String datatableColumn)
    {
        obj_id creature = params.getObjId("target");
        if (isIdValid(creature))
        {
    ...
    public static String[] getValidQuestTargets(obj_id player, String datatableColumn)
    {
    ...
    public static int oneButtonMsgBox(obj_id controller, obj_id player, String handler, string_id title, string_id textMsg, string_id okButton)
    {
        String newTextMsg = utils.packStringId(textMsg);
        return oneButtonMsgBox(controller, player, handler, title, newTextMsg, okButton);
    }
    public static int oneButtonMsgBox(obj_id controller, obj_id player, String handler, string_id title, String textMsg, string_id okButton)
    {
    ...
    public static int twoButtonMsgBox(obj_id controller, obj_id player, String handler, string_id title, String textMsg, string_id okButton, string_id cancelButton)
    {
        if (utils.hasScriptVar(player, "jedi_trials.openSui"))
        {
            int oldSui = utils.getIntScriptVar(player, "jedi_trials.openSui");
    ...
    public static int threeButtonMsgBox(obj_id controller, obj_id player, String handler, string_id title, string_id textMsg, string_id okButton, string_id cancelButton, string_id revertButton)
    {
    ...
    public static int threeButtonMsgBox(obj_id controller, obj_id player, String handler, string_id title, String textMsg, string_id okButton, string_id cancelButton, string_id revertButton)
    {
        if (utils.hasScriptVar(player, "jedi_trials.openSui"))
        {
            int oldSui = utils.getIntScriptVar(player, "jedi_trials.openSui");
