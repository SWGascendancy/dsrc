...
public class expertise extends script.base_script
{
    ...
    public static void displayIntroductionToExpertise(obj_id player)
    {
    ...
    public static boolean hasExpertiseAllocated(obj_id player)
    {
    ...
    public static String[] getExpertiseAllocation(obj_id player)
    {
