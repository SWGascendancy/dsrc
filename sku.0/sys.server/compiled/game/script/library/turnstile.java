...
public class turnstile extends script.base_script
{
    ...
    public static boolean addTurnstile(obj_id building, int fee, int time)
    {
        if (building == null)
        {
            return false;
    ...
    public static boolean canAddTurnstile(obj_id player, obj_id building)
    {
    ...
    public static int getFee(obj_id building)
    {
        if (building == null)
        {
            return 0;
    ...
    public static int getTime(obj_id building)
    {
        if (building == null)
        {
            return 0;
    ...
    public static boolean hasTurnstile(obj_id building) {
        return building != null && hasObjVar(building, VAR_TURNSTILE_BASE);
    }
    public static boolean removeTurnstile(obj_id building)
    {
        if (building == null)
        {
            return false;
    ...
    public static boolean addPatron(obj_id building, obj_id player)
    {
    ...
    public static boolean removePatron(obj_id building, obj_id player)
    {
        if ((building == null) || (player == null))
        {
            return false;
    ...
    public static boolean isPatron(obj_id building, obj_id player)
    {
        if ((building == null) || (player == null))
        {
            return false;
    ...
    public static boolean hasExpired(obj_id building, obj_id player)
    {
        if ((building == null) || (player == null))
        {
            return false;
    ...
    public static boolean cleanupExpiredPatrons(obj_id building)
    {
        if (building == null)
        {
            return false;
    ...
    public static boolean expirePatron(obj_id building, obj_id player)
    {
        if ((building == null) || (player == null))
        {
            return false;
