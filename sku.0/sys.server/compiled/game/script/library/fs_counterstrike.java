...
public class fs_counterstrike extends script.base_script
{
    ...
    public static void doCampLootSpawn(obj_id camp)
    {
    ...
    public static void resetPlayer(obj_id player)
    {
    ...
    public static void resetPlayerToStart(obj_id player, obj_id questGiver)
    {
        String[] possibleSteps = new String[]
        {
            "fs_cs_intro",
    ...
    public static void destroyCommanderRescueWaypoint(obj_id player)
    {
        if (hasObjVar(player, "fs_cs.returnCommanderWaypoint"))
        {
            destroyWaypointInDatapad(getObjIdObjVar(player, "fs_cs.returnCommanderWaypoint"), player);
    ...
    public static boolean isShortCommanderRescue()
    {
    ...
    public static float getCampResetTime()
    {
    ...
    public static float getCampBossDeathTime()
    {
    ...
    public static void markPhaseItemCreated(obj_id item)
    {
        setObjVar(item, OBJVAR_BORN_ON, getGameTime());
        return;
    }
    public static void checkPhaseItemDisable(obj_id item, int phase)
    {
    ...
    public static int getPhaseItemPercentDecay(obj_id item, int phase)
    {
    ...
    public static Vector getAllCampHintsFromDT()
    {
    ...
    public static int getMaxCampsPerCycle()
    {
    ...
    public static boolean isOnCsQuest(obj_id player)
    {
    ...
    public static void pickAndWriteCycleNamesAndLocs(obj_id villageMaster)
    {
    ...
    public static void initializeEnemyCamps(obj_id villageMaster)
    {
    ...
    public static void _createEnemyCamps(obj_id villageMaster)
    {
    ...
    public static void theatreDestroyed(obj_id villageMaster, obj_id destroyedCamp)
    {
        return;
    }
    public static String setLocForCamp(obj_id villageMaster, obj_id campId, location loc, String campName)
    {
        String rslt = "";
    ...
    public static void failQuestForCampers(obj_id campId)
    {
    ...
    public static void resetCamp(obj_id campId, boolean recreate)
    {
    ...
    public static boolean antennaExists(obj_id campId)
    {
        boolean rslt = false;
    ...
    public static String[] getSpawnWaves(obj_id campId)
    {
        int numPlayers = 1;
    ...
    public static void doCampDefenseSpawn(obj_id campId, boolean scheduleNext)
    {
    ...
    public static void erectShield()
    {
        obj_id me = getSelf();
    ...
    public static boolean arePlayersInSameGroup(obj_id player1, obj_id player2)
    {
    ...
    public static boolean attemptPowerDownShield(obj_id player, String remoteId)
    {
    ...
    public static boolean allowedToPowerDownShield(obj_id player)
    {
    ...
    public static obj_id createCommander(obj_id campId)
    {
        obj_id commander = null;
        if (hasObjVar(campId, OBJVAR_CAMP_COMMANDER))
        {
    ...
    public static obj_id getCurrentQuestGiver(obj_id player, String questName)
    {
        obj_id questGiver = null;
    ...
    public static void powerDownShield()
    {
        obj_id me = getSelf();
        if (!hasScript(me, "systems.fs_quest.fs_outpost_master"))
        {
    ...
    public static void spawnSurveillanceDroids(obj_id campMaster)
    {
    ...
    public static obj_id _createSingleDroid(obj_id campMaster, location here)
    {
    ...
    public static void droidDied(obj_id campMaster, obj_id deadDroid)
    {
        Vector existingDroids = new Vector();
        if (hasObjVar(campMaster, OBJVAR_CAMP_DROIDS))
        {
    ...
    public static void registerCampObjIds(obj_id campMaster)
    {
    ...
    public static void setupCamp(obj_id campMaster, boolean registerLocs)
    {
    ...
    public static obj_id getMyOutpostId(obj_id outpostObject)
    {
