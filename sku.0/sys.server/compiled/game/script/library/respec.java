...
public class respec extends script.base_script
{
    ...
    public static void startClickRespec(obj_id player)
    {
        ...
        if (level > 0 && !hasCommand(player, "veteranPlayerBuff2"))
        {
    ...
    public static void startNpcRespec(obj_id player, obj_id npcGrantingRespec)
    {
        startNpcRespec(player, npcGrantingRespec, false);
    }
    public static void startNpcRespec(obj_id player, obj_id npcGrantingRespec, boolean isFree)
    {
    ...
    public static void handleNpcRespec(obj_id player, String skillTemplateName)
    {
    ...
    public static void earnProfessionSkillsViaNpc(obj_id player, String skillTemplateName, boolean withItems, int level)
    {
        ...
        if (utils.isProfession(player, utils.TRADER))
        {
            ...
            messageTo(player, "handleSurveyToolbarSetup", null, 5, false);
        }
    ...
    public static int getRespecCost(obj_id player)
    {
        int numBought = 0;
        if (hasObjVar(player, "respecsBought"))
        {
    ...
    public static int[] getProfessionLevelArray(obj_id player)
    {
    ...
    public static int getCombatLevel(obj_id player)
    {
        if (!hasObjVar(player, PROF_LEVEL_ARRAY))
        {
            return -1;
    ...
    public static int getEntertainerLevel(obj_id player)
    {
        if (!hasObjVar(player, PROF_LEVEL_ARRAY))
        {
            return -1;
    ...
    public static int getTraderLevel(obj_id player)
    {
        if (!hasObjVar(player, PROF_LEVEL_ARRAY))
        {
            return -1;
    ...
    public static void setProfessionLevel(obj_id player, int profType, int level)
    {
    ...
    public static void setProfessionLevelArray(obj_id player, int[] profLevelArray)
    {
        setObjVar(player, PROF_LEVEL_ARRAY, profLevelArray);
    }
    public static void handleNpcRealloc(obj_id player)
    {
    ...
    public static int getReallocationCost(obj_id player)
    {
    ...
    public static boolean hasFreeReallocation(obj_id player)
    {
        return 0 <= numFreeAllocations(player);
    }
    public static int numFreeAllocations(obj_id player)
    {
        int numBought = 0;
        if (hasObjVar(player, "expertise_reset"))
        {
    ...
    public static int getOldCombatLevel(obj_id player)
    {
    ...
    public static void logCharacterSkills(obj_id player)
    {
    ...
    public static boolean autoLevelPlayer(obj_id player, int level, boolean withItems)
    {
    ...
    public static int getSkillXpCost(obj_id player, String skillName)
    {
    ...
    public static int getCurrentXpTotal(obj_id player)
    {
        int totalXp = 0;
        String template = getSkillTemplate(player);
        if (template == null || template.isEmpty())
    ...
    public static void earnProfessionSkills(obj_id player, String skillTemplateName, boolean withItems)
    {
    ...
    public static void grantProfessionSkills(obj_id player, String skillTemplateName, String workingSkill, boolean withItems)
    {
    ...
    public static void revokeAllSkillsAndExperience(obj_id player)
    {
        int curXp = 0;
        String[] xpTypes = 
        {
    ...
    public static void contentPathHandoff(obj_id self)
    {
    ...
    public static float getPercentageCompletion(obj_id self, String template)
    {
        if (template == null || template.isEmpty())
        {
            return 0.0f;
    ...
    public static boolean setPercentageCompletion(obj_id self, String skillTemplateName, float pct, boolean withItems)
    {
    ...
    public static boolean isHigherWorkingSkill(String newSkill, String oldSkill, String skillTemplate)
    {
    ...
    public static String getHigherWorkingSkill(String newSkill, String oldSkill, String skillTemplate)
    {
        if (newSkill == null || newSkill.equals(""))
        {
            return oldSkill;
    ...
    public static boolean setRespecVersion(obj_id player)
    {
    ...
    public static int getRespecVersion(obj_id player)
    {
        String skillTemplate = getSkillTemplate(player);
        String profession = skill.getProfessionName(skillTemplate);
        if (profession == null || profession.isEmpty() || skillTemplate == null || skillTemplate.isEmpty())
    ...
    public static boolean checkRespecDecay(obj_id player)
    {
    ...
    public static boolean setRespecDecayObjVar(obj_id player)
    {
        if (!isIdValid(player) || !exists(player))
        {
            return false;
