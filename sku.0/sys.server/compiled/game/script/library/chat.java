...
public class chat extends script.base_script
{
    ...
    public static void chat(obj_id npc, String chatType, String moodType, string_id messageId)
    {
        _chat(npc, null, chatType, moodType, null, messageId, null);
    }
    public static void chat(obj_id npc, String chatType, string_id messageId)
    {
    ...
    public static void think(obj_id npc, String text)
    {
        _chat(npc, null, CHAT_EMOTE, null, text, null, null);
    }
    public static void thinkTo(obj_id npc, obj_id target, String text)
    {
        _chat(npc, target, CHAT_EMOTE, null, chat.ChatFlag_targetOnly, text, null, null);
    }
    public static void think(obj_id npc, string_id textId)
    {
        _chat(npc, null, CHAT_EMOTE, null, null, textId, null);
    }
    public static void thinkTo(obj_id npc, obj_id target, string_id messageId)
    {
        _chat(npc, target, CHAT_EMOTE, null, chat.ChatFlag_targetOnly, null, messageId, null);
    }
    public static void chat(obj_id npc, string_id messageId)
    {
        String moodType = getChatMood(npc);
        if (moodType.equals("none"))
        {
    ...
    public static void chat(obj_id npc, obj_id target, string_id messageId, int flags)
    {
        String moodType = getChatMood(npc);
        if (moodType.equals("none"))
        {
    ...
    public static void chat(obj_id npc, obj_id target, prose_package pp, int flags)
    {
        String moodType = getChatMood(npc);
        if (moodType.equals("none"))
        {
    ...
    public static void chat(obj_id npc, obj_id target, string_id messageId)
    {
    ...
    public static void publicChat(obj_id npc, obj_id target, string_id messageId)
    {
        if (hasObjVar(npc, "convo.appearance"))
        {
            space_utils.tauntPlayer(target, npc, messageId);
    ...
    public static void chat(obj_id npc, String message)
    {
        String moodType = getChatMood(npc);
        if (moodType.equals("none"))
        {
    ...
    public static void chat(obj_id npc, obj_id target, String chatType, String moodType, prose_package pp)
    {
        if (hasObjVar(npc, "convo.appearance"))
        {
    ...
    public static void publicChat(obj_id npc, obj_id target, String chatType, String moodType, prose_package pp)
    {
        if (hasObjVar(npc, "convo.appearance"))
        {
            space_utils.tauntPlayer(target, npc, pp);
    ...
    public static void chat(obj_id npc, obj_id target, prose_package pp)
    {
        if (hasObjVar(npc, "convo.appearance"))
        {
            space_utils.tauntPlayer(target, npc, pp);
    ...
    public static void chat(obj_id npc, obj_id target, String chatType, string_id blah, int chatFlag)
    {
        _chat(npc, target, chatType, null, chatFlag, null, blah, null);
    }
    public static void chat(obj_id npc, obj_id target, String text, int flags)
    {
        String moodType = getChatMood(npc);
        if (moodType.equals("none"))
        {
    ...
    public static void chat(obj_id npc, obj_id target, String chatType, String moodType, int flags, prose_package pp)
    {
        String oob = packOutOfBandProsePackage(null, -1, pp);
        _chat(npc, target, chatType, moodType, flags, null, null, oob);
    }
    ...
    public static void _chat(obj_id npc, obj_id target, String chatType, String moodType, String text, string_id textId, String oob)
    {
        _chat(npc, target, chatType, moodType, 0, text, textId, oob);
    }
    public static void _chat(obj_id npc, obj_id target, String chatType, String moodType, int flags, String text, string_id textId, String oob)
    {
    ...
    public static void setChatMood(obj_id npc, String chatMood)
    {
    ...
    public static String getChatMood(obj_id npc)
    {
    ...
    public static void setChatType(obj_id npc, String chatType)
    {
        if (canHaveChatMood(npc))
        {
    ...
    public static String getChatType(obj_id npc)
    {
    ...
    public static void setBadMood(obj_id npc)
    {
        if (!canHaveChatMood(npc))
        {
            return;
    ...
    public static void setGoodMood(obj_id npc)
    {
        if (!canHaveChatMood(npc))
        {
            return;
    ...
    public static void setAngryMood(obj_id npc)
    {
        if (!canHaveChatMood(npc))
        {
            return;
    ...
    public static void setNeutralMood(obj_id npc)
    {
        if (!canHaveChatMood(npc))
        {
            return;
    ...
    public static boolean canHaveChatMood(obj_id npc)
    {
    ...
    public static void setTempAnimationMood(obj_id target, String mood)
    {
        if (!isIdValid(target))
        {
            return;
    ...
    public static void resetTempAnimationMood(obj_id target)
    {
        if (!isIdValid(target))
        {
            return;
