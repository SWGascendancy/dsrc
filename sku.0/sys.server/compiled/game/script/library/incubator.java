...
public class incubator extends script.base_script
{
    ...
    public static final int POWER_PER_SESSION = 5000;
    ...
    public static int getIntEnzymeType(obj_id enzyme)
    {
    ...
    public static String getStringEnzymeType(obj_id enzyme)
    {
        if (!hasObjVar(enzyme, ENZYME_TYPE_OBJVAR))
        {
            return "";
    ...
    public static boolean isQualityEnzyme(obj_id enzyme)
    {
    ...
    public static boolean isStatEnzyme(obj_id enzyme)
    {
        if (exists(enzyme))
        {
    ...
    public static boolean isSkillEnzyme(obj_id enzyme)
    {
    ...
    public static int getEnzymeRandomStats(obj_id enzyme)
    {
    ...
    public static String getEnzymeFreeStat(obj_id enzyme)
    {
    ...
    public static float getEnzymeSkillPoints(obj_id enzyme)
    {
        return getFloatObjVar(enzyme, ENZYME_PURITY_OBJVAR);
    }
    public static float getEnzymeQuality(obj_id enzyme)
    {
    ...
    public static int getEnzyemColor(obj_id enzyme)
    {
        return getIntObjVar(enzyme, ENZYME_COLOR_OBJVAR);
    }
    public static float getEnzyemMutagen(obj_id enzyme)
    {
        float mutagen = 0.0f;
    ...
    public static String getEnzyemTrait(obj_id enzyme)
    {
        String trait = "";
    ...
    public static boolean hasEnzymeColor(obj_id enzyme)
    {
    ...
    public static boolean hasDnaQuality(obj_id dnaContainer)
    {
    ...
    public static boolean hasDnaTemplate(obj_id dnaContainer)
    {
    ...
    public static boolean hasDnaParentCreature(obj_id dnaContainer)
    {
    ...
    public static float getDnaQuality(obj_id dnaContainer)
    {
        return getFloatObjVar(dnaContainer, DNA_QUALITY_OBJVAR);
    }
    public static int getDnaCreatureTemplate(obj_id dnaContainer)
    {
        return getIntObjVar(dnaContainer, DNA_TEMPLATE_OBJVAR);
    }
    public static String getDnaParentCreature(obj_id dnaContainer)
    {
        return getStringObjVar(dnaContainer, DNA_PARENT_TEMPLATE);
    }
    public static void setUpEnzymeWithDummyData(obj_id enzyme)
    {
        if (hasObjVar(enzyme, ENZYME_TYPE_OBJVAR))
        {
    ...
    public static void initializeEnzymes(obj_id enzyme)
    {
    ...
    public static boolean hasActiveUser(obj_id station)
    {
    ...
    public static obj_id getIncubatorActiveUser(obj_id station)
    {
        return (utils.getObjIdObjVar(station, ACTIVE_INCUBATOR, obj_id.NULL_ID));
    }
    public static boolean hasActiveIncubator(obj_id player)
    {
    ...
    public static obj_id getActiveIncubator(obj_id player)
    {
        return (utils.getObjIdObjVar(player, ACTIVE_INCUBATOR, obj_id.NULL_ID));
    }
    public static boolean setActiveUser(obj_id station, obj_id player)
    {
    ...
    public static boolean setNextSessionTime(obj_id station, obj_id player)
    {
        if (isIdValid(player) && isIdValid(station))
        {
    ...
    public static boolean isSessionEligible(obj_id player)
    {
        if (isIdValid(player))
        {
            int currentTime = getGameTime();
    ...
    public static boolean isIncubationComplete(obj_id station, obj_id player)
    {
    ...
    public static obj_id extractDna(obj_id player, obj_id target)
    {
    ...
    public static void setUpDnaWithDummyData(obj_id dnaContainer, obj_id player)
    {
    ...
    public static void initializeDna(obj_id dna, obj_id player)
    {
    ...
    public static void clearMiniGameCooldown(obj_id player)
    {
    ...
    public static boolean removeActiveUser(obj_id station, obj_id player)
    {
        if (isIdValid(player) && isIdValid(station))
        {
    ...
    public static void forceRemoveIncubatorFromUser(obj_id station, obj_id player)
    {
    ...
    public static boolean validateActiveUser(obj_id station, obj_id player)
    {
        if (isIdValid(player) && isIdValid(station))
        {
            obj_id stationOwner = getIncubatorActiveUser(station);
    ...
    public static void checkIncubatorForMismatch(obj_id station, obj_id player)
    {
        if (isIdValid(player) && isIdValid(station))
        {
            obj_id stationOwner = getIncubatorActiveUser(station);
    ...
    public static boolean incubatorTotalCleanse(obj_id station)
    {
        if (isIdValid(station))
        {
    ...
    public static boolean isSessionActive(obj_id station)
    {
        if (isIdValid(station))
        {
    ...
    public static int getCurrentSessionNumber(obj_id station)
    {
        if (isIdValid(station))
        {
            int sessionNumber = getIntObjVar(station, ACTIVE_SESSION);
    ...
    public static int getIntBonusLastSession(obj_id station, int sessionNumber, String bonusItem)
    {
    ...
    public static float getFloatBonusLastSession(obj_id station, int sessionNumber, String bonusItem)
    {
        String objVarNeeded = POINTS_ALLOCATED + "." + bonusItem;
        blog("INCUBATOR", "objVarNeededs = " + objVarNeeded);
        if (hasObjVar(station, objVarNeeded))
    ...
    public static String getTemplateLastSession(obj_id station, int sessionNumber)
    {
    ...
    public static int getIncubatorCreatureTemplate(obj_id station)
    {
    ...
    public static boolean getMutationChance(String template, int slotOneColor, int slotTwoColor, int slotThreeColor, obj_id station, obj_id player)
    {
    ...
    public static float getIncubatorQuality(obj_id station)
    {
    ...
    public static float getIncubatorFunctionality(obj_id station)
    {
    ...
    public static int getLastSessionMutated(obj_id station)
    {
    ...
    public static String getMutatedTemplate(String template, int session, obj_id station, obj_id player)
    {
    ...
    public static boolean updateSessionVariables(obj_id station, dictionary values)
    {
    ...
    public static obj_id getStationDnaInInventory(obj_id station)
    {
        obj_id[] stationContents = utils.getContents(station, false);
    ...
    public static boolean stationHasDnaInInventory(obj_id station)
    {
    ...
    public static boolean canOpenInventory(obj_id station)
    {
        boolean ready = false;
    ...
    public static boolean isReadyToRetrieveEgg(obj_id station)
    {
    ...
    public static boolean stationHasDnaStored(obj_id station)
    {
    ...
    public static boolean startSession(obj_id station, obj_id player)
    {
        if (!validateActiveUser(station, player))
        {
    ...
    public static int getTemperatureGaugePosition(obj_id station, int session)
    {
    ...
    public static int getNutrientGaugePosition(obj_id station, int session)
    {
    ...
    public static int getCreatureHueIndex(obj_id station, int session)
    {
    ...
    public static int getAggressionPointsAllocated(obj_id station)
    {
    ...
    public static int getBeastialResiliencePointsAllocated(obj_id station)
    {
    ...
    public static int getHuntersInstinctPointsAllocated(obj_id station)
    {
    ...
    public static int getIntelligencePointsAllocated(obj_id station)
    {
    ...
    public static int getSurvivalPointsAllocated(obj_id station)
    {
    ...
    public static int getCunningPointsAllocated(obj_id station)
    {
    ...
    public static obj_id convertDnaToEgg(obj_id station, obj_id player)
    {
        if (!validateActiveUser(station, player))
        {
            sendSystemMessage(player, SID_NOT_YOUR_INCUBATOR);
    ...
    public static void setUpEggWithDummyData(obj_id player, obj_id egg, int beastType)
    {
    ...
    public static void initializeEgg(obj_id egg)
    {
    ...
    public static String cleanAppearanceOfHueTag(String appearance)
    {
    ...
    public static boolean hasPower(obj_id station)
    {
    ...
    public static String getStationPowerName(obj_id station)
    {
        return (getStringObjVar(station, RESOURCE_POWER_NAME));
    }
    public static int getStationPowerAmount(obj_id station)
    {
        return (getIntObjVar(station, RESOURCE_POWER_AMOUNT));
    }
    public static int getStationPowerQuality(obj_id station)
    {
        return (getIntObjVar(station, RESOURCE_POWER_QUALITY));
    }
    public static boolean addPowerIncubator(obj_id station, obj_id player, int amount, int quality, String resourceName)
    {
    ...
    public static boolean removeAllPowerIncubator(obj_id station, obj_id player)
    {
        if (isIdValid(station) && isIdValid(player))
        {
    ...
    public static boolean hasPowerForSession(obj_id station)
    {
        if (isIdValid(station))
        {
    ...
    public static boolean decrementPowerForSession(obj_id station)
    {
        if (isIdValid(station))
        {
            if (!hasPowerForSession(station))
    ...
    public static boolean addPowerPreCheck(obj_id station, obj_id player, int amount, String resourceName)
    {
        if (isIdValid(station) && isIdValid(player))
        {
    ...
    public static float getIncubatorDnaQuality(obj_id station)
    {
    ...
    public static boolean convertPcdIntoPetItem(obj_id player, obj_id pcd)
    {
        obj_id pInv = utils.getInventoryContainer(player);
    ...
    public static boolean convertDeedIntoPetItem(obj_id player, obj_id deed)
    {
        obj_id pInv = utils.getInventoryContainer(player);
    ...
    public static boolean convertPetItemToDna(obj_id player, obj_id petItem)
    {
    ...
    public static String convertHashTemplateToString(int hashTemplate, obj_id station)
    {
        if (hashTemplate == 0)
        {
    ...
    public static int convertStringTemplateToCrC(String strTemplate)
    {
    ...
    public static int getHashType(String beastType)
    {
        int hashType = 0;
    ...
    public static String convertHashTypeToString(int hashType)
    {
        if (hashType == 0)
        {
    ...
    public static void blog(String identifier, String text)
    {
        if (LOGGING_ENABLED)
        {
            LOG(identifier, text);
    ...
    public static boolean isEggMountType(obj_id egg)
    {
        int hashBeastType = 0;
    ...
    public static String getMountTemplate(obj_id egg, obj_id player)
    {
        int hashBeastType = 0;
        if (hasObjVar(egg, beast_lib.OBJVAR_BEAST_TYPE))
        {
    ...
    public static boolean stampEggAsMount(obj_id egg, obj_id player)
    {
    ...
    public static obj_id convertEggToMount(obj_id egg, obj_id player)
    {
    ...
    public static void setUpPetControlDevice(obj_id petControlDevice, String petType, obj_id egg)
    {
    ...
    public static boolean setBeastTypeToName(obj_id egg, obj_id pcd)
    {
        if (hasObjVar(egg, beast_lib.OBJVAR_BEAST_TYPE))
        {
    ...
    public static boolean giveMutationAttributeBonus(obj_id station, obj_id player, float[] attributesUpdateAmount, String[] attributes)
    {
        if (!isValidId(station) || !exists(station))
        {
            return false;
    ...
    public static String getCreatureTypeFromHashTemplate(obj_id station)
    {
        if (!isValidId(station) || !exists(station))
        {
            return "";
    ...
    public static boolean isConvertedPet(obj_id item)
    {
    ...
    public static boolean fixDnaData(obj_id dna, obj_id player)
    {
    ...
    public static String getCurrentSessionParticleLabelName(obj_id station)
    {
    ...
    public static String advanceParticleLabelName(String labelName)
    {
    ...
    public static String getCurrentSessionParticle(obj_id station)
    {
        int currentSession = getCurrentSessionNumber(station);
    ...
    public static String getCurrentSessionParticle(String labelName)
    {
    ...
    public static String getCurrentParticleHardpoint(String sessionParticle)
    {
    ...
    public static void advanceSessionParticle(obj_id station)
    {
    ...
    public static void stopAllSessionParticles(obj_id station)
    {
    ...
    public static boolean isEggMountFlagged(obj_id egg)
    {
        if (!isIdValid(egg) || !exists(egg))
        {
            return false;
    ...
    public static boolean giveMutationSkillBonus(obj_id station, obj_id player, int[] skillArray, String newTemplate)
    {
    ...
    public static boolean setEggHue(obj_id egg)
    {
        return setEggHue(egg, obj_id.NULL_ID);
    }
    public static boolean setEggHue(obj_id egg, obj_id player)
    {
    ...
    public static String getCreatureTypeFromHashTemplateDna(obj_id dna, int hashTemplate)
    {
        ...
        blog("INCUBATOR", "creatureTemplate = " + creatureTemplate);
        String[] splitCreatureTemplate = split(creatureTemplate, '.');
        if (splitCreatureTemplate.length < 2) {
            CustomerServiceLog("INCUBATOR", "Tried to getCreatureTypeFromHashTemplateDna but has less than length of 2: " + (splitCreatureTemplate.length == 1 ? splitCreatureTemplate[0] : "NULL"));
            return "";
        }
        blog("INCUBATOR", "splitCreatureTemplate[0] = " + splitCreatureTemplate[0] + " splitCreatureTemplate[1] = " + splitCreatureTemplate[1]);
        String[] finalCreatureTemplate = split(splitCreatureTemplate[0], '/');
    ...
    public static String convertHashTemplateToStringDna(int hashTemplate, obj_id dna)
    {
        if (hashTemplate == 0)
        {
            blog("INCUBATOR", "convertHashTemplateToString hashTemplate == 0");
    ...
    public static void awardEnzymeCollection(obj_id enzyme)
    {
