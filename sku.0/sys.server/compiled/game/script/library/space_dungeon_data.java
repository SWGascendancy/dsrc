...
public class space_dungeon_data extends script.base_script
{
    ...
    public static string_id getDungeonSuccessString(String name)
    {
        if (name == null)
        {
    ...
    public static string_id getDungeonFailureString(String name)
    {
        if (name == null)
        {
    ...
    public static int getDungeonMaxPlayers(String name)
    {
        if (name == null)
        {
            LOG("space_dungeon", "space_dungeon.getDungeonFailureString -- name is null");
    ...
    public static location getDungeonStartLocation(String name)
    {
        if (name == null)
        {
    ...
    public static float getDungeonStartLocationRadius(String name)
    {
        if (name == null)
        {
    ...
    public static location getDungeonStartLocationRandomized(String name)
    {
    ...
    public static location getDungeonExitLocation(String name)
    {
        if (name == null)
        {
    ...
    public static float getDungeonExitLocationRadius(String name)
    {
        if (name == null)
        {
            LOG("space_dungeon", "space_dungeon.getDungeonExitLocation -- name is null");
    ...
    public static location getDungeonExitLocationRandomized(String name)
    {
    ...
    public static String getDungeonStartCellName(String name)
    {
        if (name == null)
        {
    ...
    public static String getDungeonPlayerScript(String name)
    {
        if (name == null)
        {
    ...
    public static boolean isValidDungeon(String name)
    {
        int idx = dataTableSearchColumnForString(name, "dungeon", space_dungeon_data.DUNGEON_DATATABLE);
        if (idx == -1)
        {
    ...
    public static int getMaxDungeonSesssionTime(String name)
    {
        int idx = dataTableSearchColumnForString(name, "dungeon", space_dungeon_data.DUNGEON_DATATABLE);
        if (idx > -1)
        {
