...
public class districts extends script.base_script
{
    ...
    public static int calculateDistrictNumber(location loc)
    {
        if (loc == null)
        {
            return -1;
    ...
    public static location calculateDistrictCoordinate(location loc)
    {
        if (loc == null)
        {
            return null;
    ...
    public static location calculateDistrictCoordinate(int districtId)
    {
        if (districtId < 0)
        {
            return null;
    ...
    public static boolean registerDistrictWithPlanet(region district)
    {
        return true;
    }
}
