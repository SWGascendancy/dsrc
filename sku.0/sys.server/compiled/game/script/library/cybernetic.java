...
public class cybernetic extends script.base_script
{
    ...
    public static void installCybernetics(obj_id player, obj_id npc)
    {
    ...
    public static void installCyberneticItem(obj_id player, obj_id npc, obj_id item)
    {
    ...
    public static void unInstallCybernetics(obj_id player, obj_id npc)
    {
        if (!hasScript(player, "cybernetic.cybernetic_player"))
        {
            attachScript(player, "cybernetic.cybernetic_player");
    ...
    public static void unInstallCyberneticItem(obj_id player, obj_id npc, obj_id item)
    {
        int amt = dataTableGetInt(CYBORG_TABLE, getTemplateName(item), "removeCost");
        verifyUnInstallPayment(npc, player, amt, item);
    }
    public static void repairCybernetics(obj_id player, obj_id npc)
    {
        if (sui.hasPid(player, cybernetic.PID_VAR))
        {
            int pid = sui.getPid(player, cybernetic.PID_VAR);
    ...
    public static void repairCyberneticItem(obj_id player, obj_id npc, obj_id item)
    {
    ...
    public static boolean hasMaxInstalled(obj_id player)
    {
        return false;
    }
    public static boolean oldHasMaxInstalled(obj_id player)
    {
    ...
    public static int getPlayerInstalledCyberneticCount(obj_id player)
    {
    ...
    public static int getCyberneticPointValue(obj_id object)
    {
        int value = 0;
    ...
    public static void applyDeathCybernetic(obj_id player)
    {
    ...
    public static boolean hasCyberneticItem(obj_id player)
    {
        obj_id[] allSlots = getAllWornItems(player, false);
        HashSet duplicateEater = new HashSet();
        for (int i = 0; i < allSlots.length; i++)
    ...
    public static boolean hasCyberneticItemInInventory(obj_id player)
    {
        obj_id inv = utils.getInventoryContainer(player);
        if (!isIdValid(inv))
        {
    ...
    public static boolean hasCyberneticsToRepair(obj_id player)
    {
        return (hasCyberneticItem(player) || hasCyberneticItemInInventory(player));
    }
    public static obj_id[] getInstalledCybernetics(obj_id player)
    {
        obj_id[] allSlots = getAllWornItems(player, false);
        HashSet duplicateEater = new HashSet();
        for (int i = 0; i < allSlots.length; i++)
    ...
    public static void applyCyberneticMods(obj_id player, obj_id cyberneticItem)
    {
    ...
    public static void removeCyberneticMods(obj_id player, obj_id cyberneticItem)
    {
        String templateName = getTemplateName(cyberneticItem);
        if (dataTableSearchColumnForString(templateName, 0, CYBORG_TABLE) == -1)
        {
    ...
    public static void setupArmorValues(obj_id cyberneticItem)
    {
        String templateName = getTemplateName(cyberneticItem);
    ...
    public static void applyRunBoostMod(obj_id player, String templateName)
    {
    ...
    public static void removeRunBoostMod(obj_id player, String templateName)
    {
        String moveBuff = dataTableGetString(CYBORG_TABLE, templateName, "moveRateBuff");
        if (moveBuff == null || moveBuff.equals(""))
        {
    ...
    public static void grantSpecialCommands(obj_id player, String templateName)
    {
    ...
    public static void revokeSpecialCommands(obj_id player, String templateName)
    {
        String specialCommands = dataTableGetString(CYBORG_TABLE, templateName, "specialCommand");
        if (specialCommands == null || specialCommands.equals(""))
        {
    ...
    public static void setHueColor(obj_id cyberneticItem)
    {
        String templateName = getTemplateName(cyberneticItem);
    ...
    public static float getThrowRangeMod(obj_id player, float maxRange)
    {
    ...
    public static float getRangedRangeMod(obj_id player, float maxRange)
    {
    ...
    public static float getCyberneticHealingMod(obj_id player, float maxHealMod)
    {
    ...
    public static float getCyberneticRangedAccuracyMod(obj_id player, float baseAccuracy)
    {
    ...
    public static float getCyberneticMeleeAccuracyMod(obj_id player, float baseAccuracy)
    {
    ...
    public static float getCyberneticMeleeDefenseMod(obj_id player, float baseDefense)
    {
    ...
    public static boolean hasCommandoLegs(obj_id player)
    {
        return (getSkillStatMod(player, "cybernetic_heavy_weapon_legs") != 0);
    }
    public static void grantCyberneticSkillMods(obj_id player, obj_id cyberneticItem)
    {
        String templateName = getTemplateName(cyberneticItem);
    ...
    public static void revokeCyberneticSkillMods(obj_id player, obj_id cyberneticItem)
    {
        String templateName = getTemplateName(cyberneticItem);
        dictionary item = dataTableGetRow(CYBORG_TABLE, templateName);
        if (item == null)
    ...
    public static void validateSkillMods(obj_id player)
    {
    ...
    public static void revokeAllOccurancesOfCommand(obj_id player, String commandName)
    {
        revokeCommand(player, commandName);
        while (hasCommand(player, commandName))revokeCommand(player, commandName);
    }
    public static boolean doCyborgRevive(obj_id player, obj_id target)
    {
    ...
    public static obj_id getSpecificCybernetic(obj_id player, String commandName)
    {
    ...
    public static boolean hasUndamagedCybernetic(obj_id player, String commandName)
    {
    ...
    public static void verifyInstallPayment(obj_id npc, obj_id player, int amt, obj_id item)
    {
    ...
    public static void verifyUnInstallPayment(obj_id npc, obj_id player, int amt, obj_id item)
    {
        prose_package prompt = new prose_package();
    ...
    public static void verifyRepairPayment(obj_id npc, obj_id player, int amt, obj_id item)
    {
        prose_package prompt = new prose_package();
    ...
    public static boolean canInstallSelectedCybernetic(obj_id player, obj_id cybernetic)
    {
