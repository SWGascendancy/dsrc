...
public class temp_schematic extends script.base_script
{
    ...
    public static boolean grant(obj_id player, String schematic, int useCount)
    {
        return grant(player, obj_id.NULL_ID, schematic, useCount);
    }
    public static boolean grant(obj_id player, obj_id bioLink, String schematic, int useCount)
    {
    ...
    public static boolean grant(obj_id player, int schematic, int useCount)
    {
        return grant(player, obj_id.NULL_ID, schematic, useCount);
    }
    public static boolean grant(obj_id player, obj_id bioLink, int schematic, int useCount)
    {
    ...
    public static boolean grant(obj_id player, String schematic)
    {
        return grant(player, schematic, DEFAULT_USE_COUNT);
    }
    public static boolean grant(obj_id player, int schematic)
    {
        return grant(player, schematic, DEFAULT_USE_COUNT);
    }
    public static boolean revoke(obj_id player, String schematic)
    {
        if (!isIdValid(player) || !isPlayer(player) || schematic == null || schematic.equals(""))
        {
            return false;
    ...
    public static boolean revoke(obj_id player, int schematic)
    {
        if (!isIdValid(player) || !isPlayer(player) || schematic == 0)
        {
            return false;
    ...
    public static boolean decrement(obj_id player, String schematic)
    {
        if (!isIdValid(player) || !isPlayer(player) || schematic == null || schematic.equals(""))
        {
            return false;
    ...
    public static boolean decrement(obj_id player, int schematic)
    {
        if (!isIdValid(player) || !isPlayer(player) || schematic == 0)
        {
            return false;
    ...
    public static boolean decrement(obj_id player, obj_id manufacturingSchematic)
    {
    ...
    public static obj_id getBioLinkSchematicId(obj_id player, int schematic)
    {
