...
public class mustafar extends script.base_script
{
    ...
    public static boolean canCallObiwan(obj_id player)
    {
        return canCallObiwan(player, null, false);
    }
    public static boolean canCallObiwan(obj_id player, obj_id recallObject)
    {
        return canCallObiwan(player, recallObject, false);
    }
    public static boolean canCallObiwan(obj_id player, obj_id recallObject, boolean giveFailureFeedback)
    {
    ...
    public static boolean obiwanAlreadyPresent(obj_id player, boolean giveFailureFeedback)
    {
    ...
    public static obj_id callObiwan(obj_id player)
    {
        return callObiwan(player, null, false, 0);
    }
    public static obj_id callObiwan(obj_id player, boolean timeout)
    {
        return callObiwan(player, null, timeout, 0);
    }
    public static obj_id callObiwan(obj_id player, boolean timeout, int appearanceComment)
    {
        return callObiwan(player, null, timeout, appearanceComment);
    }
    public static obj_id callObiwan(obj_id player, obj_id landmark)
    {
        return callObiwan(player, landmark, false, 0);
    }
    public static obj_id callObiwan(obj_id player, obj_id landmark, boolean timeout)
    {
        return callObiwan(player, landmark, timeout, 0);
    }
    public static obj_id callObiwan(obj_id player, obj_id landmark, boolean timeout, int appearanceComment)
    {
    ...
    public static void spawnContents(obj_id dungeon, String spawnType, int numberOfCopies)
    {
    ...
    public static boolean moveBossAround(String moveTargetName, obj_id boss, obj_id dungeon)
    {
    ...
    public static boolean hasCompletedTrials(obj_id player)
    {
    ...
    public static boolean stillWithinDungeonCheck(obj_id player, obj_id dungeon)
    {
    ...
    public static void activateQuestAcceptSUI(obj_id player, obj_id self)
    {
