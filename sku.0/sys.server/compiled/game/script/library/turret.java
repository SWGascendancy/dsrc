...
public class turret extends script.base_script
{
    ...
    public static void engageTarget(obj_id turret, obj_id target)
    {
    ...
    public static void disengage(obj_id turret)
    {
        if (!isIdValid(turret))
        {
            return;
    ...
    public static boolean createWeapon(obj_id turret) {
        if (!isIdValid(turret)) {
            return false;
        }
        if (hasObjVar(turret, "objWeapon")) {
    ...
    public static boolean isValidTargetGeneric(obj_id turret, obj_id target) {
        if (!isIdValid(turret) || !isIdValid(target)) {
            return false;
        }
        if (target == turret) {
    ...
    public static boolean isGenericTurret(obj_id turret)
    {
        return hasObjVar(turret, VAR_IS_GENERIC);
    }
    public static boolean canGenericTurretAttackTarget(obj_id target)
    {
    ...
    public static void addTargets(obj_id turret, obj_id[] target)
    {
