...
public class debug extends script.base_script
{
    ...
    public static void debugAllMsg(String channelName, obj_id self, String message)
    {
    ...
    public static void barkContents(obj_id self, obj_id[] contents)
    {
    ...
    public static void barkBug(Object script, obj_id self, String msgText)
    {
        String msg = "in file: ";
    ...
    public static String getDebugName(obj_id id)
    {
        if (id == null)
        {
    ...
    public static boolean fullHeal(obj_id target)
    {
    ...
    public static boolean damageMob(obj_id target, int attrib, int amt)
    {
        if ((target == null) || (!isMob(target)))
        {
            return false;
    ...
    public static boolean heal(obj_id target, int attrib, int amt)
    {
        if ((target == null) || (!isMob(target)))
        {
            return false;
    ...
    public static boolean woundMob(obj_id target, int attrib, int amt)
    {
        if ((target == null) || (!isMob(target)))
        {
            return false;
    ...
    public static boolean healWounds(obj_id target)
    {
        if ((target == null) || (!isMob(target)))
        {
            return false;
    ...
    public static boolean getShock(obj_id target)
    {
        if ((target == null) || (!isMob(target)))
        {
            return false;
    ...
    public static boolean addShock(obj_id target, int amt)
    {
        if ((target == null) || (!isMob(target)))
        {
            return false;
    ...
    public static boolean healShock(obj_id target, int amt)
    {
        if ((target == null) || (!isMob(target)))
        {
            return false;
    ...
    public static boolean zeroShock(obj_id target)
    {
        if ((target == null) || (!isMob(target)))
        {
            return false;
    ...
    public static boolean killCreature(obj_id target)
    {
    ...
    public static void forceSuicide(obj_id target)
    {
    ...
    public static void suicide(obj_id self)
    {
