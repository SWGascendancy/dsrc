...
public class squad_leader extends script.base_script
{
    ...
    public static void sendSquadLeaderCommand(obj_id squadLeader, String command)
    {
    ...
    public static boolean sendSquadWaypoint(obj_id officer, location wayLoc)
    {
    ...
    public static void displayCommand(obj_id squadLeader, obj_id groupMember, String command)
    {
        if (groupMember != null)
        {
    ...
    public static boolean hasSkillsToSendCommand(obj_id squadLeader, int groupSize)
    {
    ...
    public static obj_id[] getSquadTargets(obj_id self, String requiredSkill)
    {
    ...
    public static boolean setSquadCommandText(String command, String params)
    {
        obj_id self = getSelf();
    ...
    public static String getSquadCommandText(String command)
    {
        obj_id self = getSelf();
        String varName = "combat." + command + "String";
        return getStringObjVar(self, varName);
    }
    public static void barkSquadCommand(String command, String defaultText)
    {
    }
    public static obj_id[] getValidGroupMembers(obj_id self)
    {
    ...
    public static void validateRallyPoint(obj_id player)
    {
    ...
    public static void clearRallyPoint(obj_id player)
    {
        if (!hasObjVar(player, "sl.rallyPoint"))
        {
            return;
    ...
    public static int getCalledShotAccuracyBonus(obj_id attacker, obj_id defender)
    {
    ...
    public static int getCalledShotDamageBonus(obj_id attacker, obj_id defender)
    {
        obj_id gid = getGroupObject(attacker);
        if (!group.isGroupObject(gid))
        {
    ...
    public static void clearCalledShotEffect(obj_id attacker, obj_id defender)
    {
        obj_id gid = getGroupObject(attacker);
        if (!group.isGroupObject(gid))
        {
    ...
    public static float getLeadershipMod(obj_id player)
    {
