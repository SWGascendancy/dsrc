...
public class skill_template extends script.base_script
{
    ...
    public static String[] getSkillTemplateSkillsByTemplateName(String templateName)
    {
    ...
    public static String[] getSkillTemplateSkills(obj_id player)
    {
        if (!isIdValid(player))
        {
            return null;
    ...
    public static boolean isValidWorkingSkill(String skillName)
    {
        return !(skillName == null || skillName.equals(""));
    }
    public static String getNextWorkingSkill(obj_id player)
    {
        if (!isIdValid(player))
        {
            return null;
    ...
    public static String getTemplateSkillXpType(obj_id player, boolean verbose)
    {
        if (!isIdValid(player))
        {
            return null;
    ...
    public static String getSkillExperienceType(String skillName)
    {
    ...
    public static boolean isQualifiedForWorkingSkill(obj_id player)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static boolean earnWorkingSkill(obj_id player)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public static void validateWorkingSkill(obj_id player)
    {
    ...
    public static boolean grantRoadmapItem(obj_id player)
    {
        String skillName = getWorkingSkill(player);
        if (!isValidWorkingSkill(skillName))
        {
    ...
    public static String getRoadmapItemDesc(String skillTemplate, String workingSkill)
    {
    ...
    public static String getRoadmapItem(obj_id player, String skillTemplate, String workingSkill)
    {
        int row = dataTableSearchColumnForString(skillTemplate, 0, ITEM_REWARD_TABLE);
        if (row < 0)
        {
