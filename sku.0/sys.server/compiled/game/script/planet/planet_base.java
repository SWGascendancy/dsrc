...
public class planet_base extends script.base_script
{
    ...
    public int OnUniverseComplete(obj_id self)
    {
    ...
    public int doSpawnSetup(obj_id self, dictionary params)
    {
        String strPlanet = getNameForPlanetObject(self);
        if (strPlanet == null)
        {
            System.out.println("Not Good. Your scenename is null. Go get development!");
            return SCRIPT_CONTINUE;
        }
    ...
    public int registerCloningFacility(obj_id self, dictionary params)
    {
    ...
    public int unregisterCloningFacility(obj_id self, dictionary params)
    {
        obj_id facilityId = params.getObjId("id");
        Vector idList = utils.getResizeableObjIdArrayScriptVar(self, cloninglib.VAR_PLANET_CLONE_ID);
        Vector nameList = utils.getResizeableStringArrayScriptVar(self, cloninglib.VAR_PLANET_CLONE_NAME);
    ...
    public void gcwInvasionMessage(obj_id self, obj_id citySequencer, String city)
    {
    ...
    public int gcwInvasionTracker(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int gcwGetInvasionObject(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
