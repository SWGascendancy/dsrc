...
public class junk_dealer_generic extends script.base_script
{
    ...
    public static final String c_stringFile = "conversation/junk_dealer_generic";
    public boolean junk_dealer_generic_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean junk_dealer_generic_condition_check_inv(obj_id player, obj_id npc)
    {
        return smuggler.checkInventory(player, npc);
    }
    public boolean junk_dealer_generic_condition_hasNoInv(obj_id player, obj_id npc)
    {
    ...
    public boolean junk_dealer_generic_condition_checkForKit(obj_id player, obj_id npc)
    {
    ...
    public boolean junk_dealer_generic_condition_checkForKitToo(obj_id player, obj_id npc)
    {
        obj_id[] objContents = utils.getContents(player, true);
        if (objContents != null)
        {
    ...
    public boolean junk_dealer_generic_condition_hasBuyBackItems(obj_id player, obj_id npc)
    {
        obj_id[] listOfBuyBacks = smuggler.getBuyBackItemsInContainer(player);
        return listOfBuyBacks != null && listOfBuyBacks.length > 0;
    }
    public boolean junk_dealer_generic_condition_checkBuyBackContainer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public void junk_dealer_generic_action_start_dealing(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        messageTo(npc, "startDealing", params, 0.0f, false);
    }
    public void junk_dealer_generic_action_face_to(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void junk_dealer_generic_action_giveOrange(obj_id player, obj_id npc)
    {
    ...
    public void junk_dealer_generic_action_giveBlue(obj_id player, obj_id npc)
    {
        obj_id playerInv = getObjectInSlot(player, "inventory");
        if (isIdValid(playerInv))
        {
    ...
    public void junk_dealer_generic_action_giveGong(obj_id player, obj_id npc)
    {
        obj_id playerInv = getObjectInSlot(player, "inventory");
        if (isIdValid(playerInv))
        {
    ...
    public void junk_dealer_generic_action_giveSculpture(obj_id player, obj_id npc)
    {
        obj_id playerInv = getObjectInSlot(player, "inventory");
        if (isIdValid(playerInv))
        {
    ...
    public void junk_dealer_generic_action_giveTable(obj_id player, obj_id npc)
    {
        obj_id playerInv = getObjectInSlot(player, "inventory");
        if (isIdValid(playerInv))
        {
    ...
    public void junk_dealer_generic_action_startBuyBack(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        messageTo(npc, "startBuyBack", params, 0.0f, false);
    }
    public void junk_dealer_generic_action_createBuyBackContainer(obj_id player, obj_id npc)
    {
    ...
    public void junk_dealer_generic_action_startFlagNoSale(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        messageTo(npc, "startFlaggingItemsNoSale", params, 0.0f, false);
    }
    public int junk_dealer_generic_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int junk_dealer_generic_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int junk_dealer_generic_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int junk_dealer_generic_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int junk_dealer_generic_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int junk_dealer_generic_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int OnStartNpcConversation(obj_id self, obj_id player)
    {
        ...
        if (junk_dealer_generic_condition_checkBuyBackContainer(player, npc))
        {
            ...
            boolean hasResponse = false;
            boolean hasResponse0 = false;
// buy back feature has an exploit need to rewrite this so splitting and selling stacks can be bought back at half cost
/*
