...
public class restuss_imperial_ground_destroy_3 extends script.base_script
{
    ...
    public boolean restuss_imperial_ground_destroy_3_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean restuss_imperial_ground_destroy_3_condition_stage3ready(obj_id player, obj_id npc)
    {
    ...
    public boolean restuss_imperial_ground_destroy_3_condition_mission1Active(obj_id player, obj_id npc)
    {
    ...
    public boolean restuss_imperial_ground_destroy_3_condition_mission1Success(obj_id player, obj_id npc)
    {
    ...
    public boolean restuss_imperial_ground_destroy_3_condition_completedMission1(obj_id player, obj_id npc)
    {
    ...
    public boolean restuss_imperial_ground_destroy_3_condition_mission2Active(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "restuss_imperial_st3_destroy_boss");
    }
    public boolean restuss_imperial_ground_destroy_3_condition_mission2Success(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "restuss_imperial_st3_destroy_boss", "returnOkto2");
    }
    public boolean restuss_imperial_ground_destroy_3_condition_notCommando(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean restuss_imperial_ground_destroy_3_condition_commando(obj_id player, obj_id npc)
    {
        return false;
    }
    public boolean restuss_imperial_ground_destroy_3_condition_completedMission2(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "restuss_imperial_st3_destroy_boss");
    }
    public boolean restuss_imperial_ground_destroy_3_condition_playerImperial(obj_id player, obj_id npc)
    {
    ...
    public boolean restuss_imperial_ground_destroy_3_condition_isPlayerRebel(obj_id player, obj_id npc)
    {
        return factions.isRebel(player);
    }
    public void restuss_imperial_ground_destroy_3_action_giveAntenna(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "restuss_imperial_st3_destroy_installation_1");
    }
    public void restuss_imperial_ground_destroy_3_action_reward1(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "returnedOkto1");
    }
    public void restuss_imperial_ground_destroy_3_action_giveKillBoss(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "restuss_imperial_st3_destroy_boss");
    }
    public void restuss_imperial_ground_destroy_3_action_reward2(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "returnedOkto2");
    }
    public void restuss_imperial_ground_destroy_3_action_giveAntennaCommando(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "restuss_imperial_st3_destroy_installation_1_commando");
    }
    public void restuss_imperial_ground_destroy_3_action_eject(obj_id player, obj_id npc)
    {
        expelFromBuilding(player);
    }
    public int restuss_imperial_ground_destroy_3_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int restuss_imperial_ground_destroy_3_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int restuss_imperial_ground_destroy_3_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int restuss_imperial_ground_destroy_3_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int restuss_imperial_ground_destroy_3_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
