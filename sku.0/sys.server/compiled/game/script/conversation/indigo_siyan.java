...
public class indigo_siyan extends script.base_script
{
    ...
    public boolean indigo_siyan_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean indigo_siyan_condition_Campaign(obj_id player, obj_id npc)
    {
    ...
    public boolean indigo_siyan_condition_Negative(obj_id player, obj_id npc)
    {
        if (hasObjVar(npc, "bestine.electionStarted"))
        {
            int electionNum = getIntObjVar(npc, "bestine.electionStarted");
    ...
    public boolean indigo_siyan_condition_nonoffice(obj_id player, obj_id npc)
    {
        return hasObjVar(npc, "bestine.electionEnded");
    }
    public void indigo_siyan_action__defaultAction(obj_id player, obj_id npc)
    {
    }
