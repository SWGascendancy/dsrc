...
public class event_ls_informant_2 extends script.base_script
{
    ...
    public boolean event_ls_informant_2_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public int event_ls_informant_2_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_ls_informant_2_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_5"))
        {
            if (event_ls_informant_2_condition__defaultCondition(player, npc))
    ...
    public int event_ls_informant_2_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_ls_informant_2_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_ls_informant_2_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_ls_informant_2_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_ls_informant_2_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_ls_informant_2_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_5"))
        {
            if (event_ls_informant_2_condition__defaultCondition(player, npc))
    ...
    public int event_ls_informant_2_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_5"))
        {
            if (event_ls_informant_2_condition__defaultCondition(player, npc))
    ...
    public int event_ls_informant_2_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_5"))
        {
            if (event_ls_informant_2_condition__defaultCondition(player, npc))
    ...
    public int event_ls_informant_2_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_5"))
        {
            if (event_ls_informant_2_condition__defaultCondition(player, npc))
