...
public class biogenic_scientist_geonosian extends script.base_script
{
    ...
    public boolean biogenic_scientist_geonosian_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean biogenic_scientist_geonosian_condition_get_tracker_1(obj_id player, obj_id npc)
    {
    ...
    public void biogenic_scientist_geonosian_action__defaultAction(obj_id player, obj_id npc)
    {
    }
    public void biogenic_scientist_geonosian_action_give_schematic(obj_id player, obj_id npc)
    {
        setObjVar(player, "biogenic.scientist_geonosian_convo", 1);
    }
    public void biogenic_scientist_geonosian_action_face_to(obj_id player, obj_id npc)
    {
