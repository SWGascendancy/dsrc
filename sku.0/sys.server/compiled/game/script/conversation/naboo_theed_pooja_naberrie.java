...
public class naboo_theed_pooja_naberrie extends script.base_script
{
    ...
    public boolean naboo_theed_pooja_naberrie_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean naboo_theed_pooja_naberrie_condition_readyForPooja(obj_id player, obj_id npc)
    {
        return badge.hasBadge(player, "bdg_content_rsf_clearance_4");
    }
    public boolean naboo_theed_pooja_naberrie_condition_needsHugoQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_theed_pooja_naberrie_condition_completedTerroristAndHugo(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_theed_pooja_naberrie_condition_hasTheedQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_theed_pooja_naberrie_condition_needsTerroristQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_theed_pooja_naberrie_condition_finishedTheed(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_theed_pooja_naberrie_condition_hasMeanwhileQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_theed_pooja_naberrie_condition_returningTerroristQuest(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "naboo_theed_terrorist_terrorize", "theed_terrorist_terrorize_10");
    }
    public boolean naboo_theed_pooja_naberrie_condition_returningHugoQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_theed_pooja_naberrie_condition_completedHugoQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_theed_pooja_naberrie_condition_completedTerroristQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "naboo_theed_terrorist_terrorize");
    }
    public boolean naboo_theed_pooja_naberrie_condition_returningMeanwhileQuest(obj_id player, obj_id npc)
    {
    ...
    public void naboo_theed_pooja_naberrie_action_grantHugoQuest(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "naboo_theed_goto_hugo");
    }
    public void naboo_theed_pooja_naberrie_action_grantTerroristQuest(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "naboo_theed_goto_franchels");
    }
    public void naboo_theed_pooja_naberrie_action_grantMeanwhileQuest(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "naboo_theed_goto_khartoor");
    }
    public void naboo_theed_pooja_naberrie_action_endGotoPooja(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "theed_goto_pooja");
    }
    public void naboo_theed_pooja_naberrie_action_endTerroristQuest(obj_id player, obj_id npc)
    {
        content.grantRsfSecurityClearance(player);
        groundquests.sendSignal(player, "theed_terrorist_terrorize_10");
    }
    public void naboo_theed_pooja_naberrie_action_endHugoQuest(obj_id player, obj_id npc)
    {
        content.grantRsfSecurityClearance(player);
        groundquests.sendSignal(player, "theed_hugo_rescue_08");
    }
    public void naboo_theed_pooja_naberrie_action_endMeanwhileQuest(obj_id player, obj_id npc)
    {
        content.grantAllRsfSecurityClearance(player);
        groundquests.sendSignal(player, "theed_meanwhile_ranch_06");
    }
    public void naboo_theed_pooja_naberrie_action_sendToMainframe(obj_id player, obj_id npc)
    {
    ...
    public void naboo_theed_pooja_naberrie_action_checkRSFBadges(obj_id player, obj_id npc)
    {
    ...
    public int naboo_theed_pooja_naberrie_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_pooja_naberrie_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_pooja_naberrie_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_pooja_naberrie_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_pooja_naberrie_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_pooja_naberrie_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_pooja_naberrie_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_59"))
        {
            if (naboo_theed_pooja_naberrie_condition__defaultCondition(player, npc))
    ...
    public int naboo_theed_pooja_naberrie_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_pooja_naberrie_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_pooja_naberrie_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_59"))
        {
            if (naboo_theed_pooja_naberrie_condition__defaultCondition(player, npc))
    ...
    public int naboo_theed_pooja_naberrie_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_pooja_naberrie_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_pooja_naberrie_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_pooja_naberrie_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_pooja_naberrie_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
