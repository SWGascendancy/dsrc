...
public class eisley_thranta_medical_terminal extends script.base_script
{
    ...
    public boolean eisley_thranta_medical_terminal_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean eisley_thranta_medical_terminal_condition_onMedicalDownload(obj_id player, obj_id npc)
    {
    ...
    public void eisley_thranta_medical_terminal_action_signalDownload(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tat_eisley_infection_e4");
    }
    public int eisley_thranta_medical_terminal_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int eisley_thranta_medical_terminal_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int eisley_thranta_medical_terminal_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int eisley_thranta_medical_terminal_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int eisley_thranta_medical_terminal_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int eisley_thranta_medical_terminal_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int eisley_thranta_medical_terminal_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int eisley_thranta_medical_terminal_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int eisley_thranta_medical_terminal_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int eisley_thranta_medical_terminal_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int eisley_thranta_medical_terminal_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
