...
public class c_newbie_associate extends script.base_script
{
    ...
    public boolean c_newbie_associate_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_newbie_associate_condition_onAssociateStep(obj_id player, obj_id npc)
    {
    ...
    public void c_newbie_associate_action_faceplayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void c_newbie_associate_action_forwardquest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "c_newbie_associatestep");
    }
    public int c_newbie_associate_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_newbie_associate_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_newbie_associate_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_newbie_associate_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
