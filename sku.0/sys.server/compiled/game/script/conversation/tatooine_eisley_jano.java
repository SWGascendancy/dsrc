...
public class tatooine_eisley_jano extends script.base_script
{
    ...
    public boolean tatooine_eisley_jano_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tatooine_eisley_jano_condition_tdcOnTask3(obj_id player, obj_id npc)
    {
    ...
    public boolean tatooine_eisley_jano_condition_tdcOnTask4(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_eisley_tdc");
    ...
    public boolean tatooine_eisley_jano_condition_tdcQuestComplete(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_eisley_tdc");
        boolean OnTask = (questIsQuestComplete(questId1, player));
        return OnTask;
    }
    public void tatooine_eisley_jano_action_signalJanoDelivered1(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tat_eisley_tdc_e5");
    }
    public void tatooine_eisley_jano_action_signalJanoDelivered2(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tat_eisley_tdc_e7");
    }
    public void tatooine_eisley_jano_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int tatooine_eisley_jano_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_jano_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_jano_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
