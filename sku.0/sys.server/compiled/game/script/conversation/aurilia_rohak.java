...
public class aurilia_rohak extends script.conversation.base.conversation_base
{
    ...
    private void aurilia_rohak_action_giveTokenBoxQuest(obj_id player)
    {
        groundquests.grantQuest(player, "rohak_token_box");
    }
    private int aurilia_rohak_handleBranch1(obj_id player, string_id response)
    {
    ...
    private int aurilia_rohak_handleBranch3(obj_id player, string_id response)
    {
    ...
    private int aurilia_rohak_handleBranch4(obj_id player, string_id response)
    {
    ...
    private int aurilia_rohak_handleBranch5(obj_id player, string_id response)
    {
    ...
    private int aurilia_rohak_handleBranch7(obj_id player, string_id response)
    {
    ...
    private int aurilia_rohak_handleBranch10(obj_id player, string_id response)
    {
    ...
    private int aurilia_rohak_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
