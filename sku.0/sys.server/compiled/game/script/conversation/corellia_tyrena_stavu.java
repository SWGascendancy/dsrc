...
public class corellia_tyrena_stavu extends script.base_script
{
    ...
    public boolean corellia_tyrena_stavu_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_tyrena_stavu_condition_completeSlaverAccess(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "corellia_tyrena_slaver_access");
    }
    public boolean corellia_tyrena_stavu_condition_onSlaverAccess(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_tyrena_stavu_condition_talkStavu(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_tyrena_slaver_access", "talk_to_slave_3");
    }
    public void corellia_tyrena_stavu_action_signalStavu(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talk_to_slave_3");
    }
    public int corellia_tyrena_stavu_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_stavu_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_stavu_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_stavu_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_stavu_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_stavu_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
