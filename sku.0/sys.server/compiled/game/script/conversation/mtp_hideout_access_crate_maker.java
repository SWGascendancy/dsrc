...
public class mtp_hideout_access_crate_maker extends script.base_script
{
    ...
    public boolean mtp_hideout_access_crate_maker_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean mtp_hideout_access_crate_maker_condition_mtpHideout01_01(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_hideout_access_crate_maker_condition_mtpHideout01_02(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_hideout_access_crate_maker_condition_mtpHideout01_04(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_hideout_access_crate_maker_condition_mtpHideout01_06(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_hideout_access_crate_maker_condition_mtpHideout01_complete(obj_id player, obj_id npc)
    {
    ...
    public void mtp_hideout_access_crate_maker_action_signal_mtpHideout01_01(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "mtp_hideout_access_01_01");
    }
    public int mtp_hideout_access_crate_maker_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_access_crate_maker_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_access_crate_maker_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
