...
public class talus_nashal_smuggler extends script.base_script
{
    ...
    public boolean talus_nashal_smuggler_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean talus_nashal_smuggler_condition_onTalkSmuggler(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "talus_nashal_gather_missing", "selonian_talk_smuggler");
    }
    public boolean talus_nashal_smuggler_condition_onPostTalk(obj_id player, obj_id npc)
    {
    ...
    public boolean talus_nashal_smuggler_condition_completeGather(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "talus_nashal_gather_missing");
    }
    public void talus_nashal_smuggler_action_signalTalkSmuggler(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "selonian_talk_smuggler");
    }
    public int talus_nashal_smuggler_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_smuggler_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_smuggler_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_smuggler_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_smuggler_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
