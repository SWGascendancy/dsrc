...
public class legacy_naboo_officer_nok extends script.base_script
{
    ...
    public boolean legacy_naboo_officer_nok_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean legacy_naboo_officer_nok_condition_isOnTyphoQuest(obj_id player, obj_id npc)
    {
    ...
    public void legacy_naboo_officer_nok_action_doogalSignal(obj_id player, obj_id npc)
    {
