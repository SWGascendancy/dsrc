...
public class greeter_dantooine_brother_imperial extends script.base_script
{
    ...
    public boolean greeter_dantooine_brother_imperial_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean greeter_dantooine_brother_imperial_condition_isAnImperialPilot(obj_id player, obj_id npc)
    {
        return space_flags.isImperialPilot(player);
    }
    public boolean greeter_dantooine_brother_imperial_condition_isARebelPilot(obj_id player, obj_id npc)
    {
        return space_flags.isRebelPilot(player);
    }
    public boolean greeter_dantooine_brother_imperial_condition_isPrivateerPilot(obj_id player, obj_id npc)
    {
        return space_flags.isNeutralPilot(player);
    }
    public boolean greeter_dantooine_brother_imperial_condition_hasSpaceExpansion(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean greeter_dantooine_brother_imperial_condition_hasSpaceShip(obj_id player, obj_id npc)
    {
        return (space_quest.hasShip(player));
    }
    public void greeter_dantooine_brother_imperial_action_spokeWithFern(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "spokeWithFernYarrow", true);
    }
    public int greeter_dantooine_brother_imperial_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int greeter_dantooine_brother_imperial_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int greeter_dantooine_brother_imperial_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
