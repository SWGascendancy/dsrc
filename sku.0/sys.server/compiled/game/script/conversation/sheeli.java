...
public class sheeli extends script.base_script
{
    ...
    public boolean sheeli_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean sheeli_condition_isRescuer(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "u16_nym_themepark_rescue_sheeli", "rescueSheeli");
    }
    public boolean sheeli_condition_hasArrived(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "u16_nym_themepark_rescue_sheeli", "waitingForShuttle");
    }
    public boolean sheeli_condition_isTraveling(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public void sheeli_action_startEscort(obj_id player, obj_id npc)
    {
    ...
    public void sheeli_action_walkFaster(obj_id player, obj_id npc)
    {
        setMovementRun(npc);
        setBaseRunSpeed(npc, (getBaseRunSpeed(npc) - 8));
        ai_lib.aiFollow(npc, player, 1.0f, 3.0f);
    }
    public int sheeli_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int startFollowingOwner(obj_id self, dictionary params)
    {
        if (!hasObjVar(self, "quest.owner"))
        {
