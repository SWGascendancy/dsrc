...
public class outbreak_defense_mika_horn_alpha extends script.base_script
{
    ...
    public boolean outbreak_defense_mika_horn_alpha_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean outbreak_defense_mika_horn_alpha_condition_hasCompletedDefenseQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean outbreak_defense_mika_horn_alpha_condition_isWaitingForRewardSignal(obj_id player, obj_id npc)
    {
    ...
    public boolean outbreak_defense_mika_horn_alpha_condition_hasNeverSpoken(obj_id player, obj_id npc)
    {
    ...
    public boolean outbreak_defense_mika_horn_alpha_condition_isGodPlayerTester(obj_id player, obj_id npc)
    {
        return isGod(player);
    }
    public boolean outbreak_defense_mika_horn_alpha_condition_levelTooHigh(obj_id player, obj_id npc)
    {
        return getLevel(player) >= 15;
    }
    public boolean outbreak_defense_mika_horn_alpha_condition_hasDefenseQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean outbreak_defense_mika_horn_alpha_condition_noAntiVirus(obj_id player, obj_id npc)
    {
    ...
    public boolean outbreak_defense_mika_horn_alpha_condition_hasAvailableGuardPosts(obj_id player, obj_id npc)
    {
    ...
    public void outbreak_defense_mika_horn_alpha_action_giveQuest(obj_id player, obj_id npc)
    {
    ...
    public void outbreak_defense_mika_horn_alpha_action_sendQuestSignal(obj_id player, obj_id npc)
    {
    ...
    public void outbreak_defense_mika_horn_alpha_action_action0001(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "camp_alpha_defense");
    }
    public void outbreak_defense_mika_horn_alpha_action_action0002(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "camp_alpha_defense_02");
    }
    public void outbreak_defense_mika_horn_alpha_action_action0003(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "camp_alpha_defense_03");
    }
    public void outbreak_defense_mika_horn_alpha_action_action0004(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "camp_alpha_defense_04");
    }
    public int outbreak_defense_mika_horn_alpha_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_defense_mika_horn_alpha_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_defense_mika_horn_alpha_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_defense_mika_horn_alpha_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_defense_mika_horn_alpha_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_defense_mika_horn_alpha_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
