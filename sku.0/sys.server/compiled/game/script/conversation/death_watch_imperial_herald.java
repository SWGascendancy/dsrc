...
public class death_watch_imperial_herald extends script.base_script
{
    ...
    public boolean death_watch_imperial_herald_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean death_watch_imperial_herald_condition_ImperialCheck(obj_id player, obj_id npc)
    {
    ...
    public boolean death_watch_imperial_herald_condition_BloodCheck(obj_id player, obj_id npc)
    {
    ...
    public boolean death_watch_imperial_herald_condition_RewardCheck(obj_id player, obj_id npc)
    {
    ...
    public boolean death_watch_imperial_herald_condition_dungeonInactive(obj_id player, obj_id npc)
    {
        return false;
    }
    public boolean death_watch_imperial_herald_condition_QuestComplete(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "death_watch_herald.imperialfinish"))
        {
            return true;
    ...
    public boolean death_watch_imperial_herald_condition_ReturnCheck(obj_id player, obj_id npc)
    {
    ...
    public boolean death_watch_imperial_herald_condition_notImperial(obj_id player, obj_id npc)
    {
        String playerFaction = factions.getFaction(player);
    ...
    public void death_watch_imperial_herald_action_RewardGive(obj_id player, obj_id npc)
    {
        if (!hasObjVar(player, "death_watch_herald.imperialfinish"))
        {
            if (isIdValid(player))
    ...
    public void death_watch_imperial_herald_action_Questaccept(obj_id player, obj_id npc)
    {
        setObjVar(player, "death_watch_herald.imperialquest", true);
        setObjVar(player, "death_watch_herald.destroy", true);
    }
    public void death_watch_imperial_herald_action_QuestRemove(obj_id player, obj_id npc)
    {
