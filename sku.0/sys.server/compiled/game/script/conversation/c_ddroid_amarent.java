...
public class c_ddroid_amarent extends script.base_script
{
    ...
    public boolean c_ddroid_amarent_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_ddroid_amarent_condition_isImperialOfc(obj_id player, obj_id npc)
    {
    ...
    public boolean c_ddroid_amarent_condition_playeronquest(obj_id player, obj_id npc)
    {
    ...
    public boolean c_ddroid_amarent_condition_playerlostwaypoint(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/c_darndroid1");
        return questIsTaskActive(questId, 4, player);
    }
    public boolean c_ddroid_amarent_condition_queststuck(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/c_darndroid1");
    ...
    public boolean c_ddroid_amarent_condition_hasBribeFunds(obj_id player, obj_id npc)
    {
        return money.hasFunds(player, money.MT_TOTAL, 1000);
    }
    public void c_ddroid_amarent_action_intimidateAmarent(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "c_darndroid1_intimidate");
    }
    public void c_ddroid_amarent_action_bribeAmarent(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "c_darndroid1_bribe");
        money.requestPayment(player, npc, 1000, "pass_fail", null, true);
    }
    public void c_ddroid_amarent_action_amarentGivesInfo(obj_id player, obj_id npc)
    {
    ...
    public void c_ddroid_amarent_action_givewaypoint(obj_id player, obj_id npc)
    {
    ...
    public void c_ddroid_amarent_action_faceplayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void c_ddroid_amarent_action_completequestFix(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/c_darndroid1");
    ...
    public int c_ddroid_amarent_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_ddroid_amarent_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_ddroid_amarent_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_ddroid_amarent_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_ddroid_amarent_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_ddroid_amarent_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
