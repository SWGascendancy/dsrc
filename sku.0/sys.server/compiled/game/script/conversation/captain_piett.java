...
public class captain_piett extends script.base_script
{
    ...
    public boolean captain_piett_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean captain_piett_condition_hasNotStartedQuestLine(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean captain_piett_condition_hasFirstQuestImperial(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isQuestActive(player, "outbreak_quest_01_imperial");
    }
    public boolean captain_piett_condition_hasSecondQuestImperial(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isQuestActive(player, "outbreak_quest_02_imperial");
    }
    public boolean captain_piett_condition_hasFoundStormtroopers(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.hasCompletedQuest(player, "outbreak_quest_02_imperial");
    }
    public boolean captain_piett_condition_hasCompletedMissions(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "outbreak_quest_facility_05_imperial", "speakPietteDebrief");
    }
    public boolean captain_piett_condition_hasCompletedAll(obj_id player, obj_id npc)
    {
    ...
    public boolean captain_piett_condition_isLiveConversion(obj_id player, obj_id npc)
    {
    ...
    public boolean captain_piett_condition_isPlayerNeutral(obj_id player, obj_id npc)
    {
        return captain_piett_condition_isLiveConversion(player, npc) && !factions.isImperial(player) && !factions.isRebel(player);
    }
    public boolean captain_piett_condition_isPlayerRebel(obj_id player, obj_id npc)
    {
        return captain_piett_condition_isLiveConversion(player, npc) && factions.isRebel(player);
    }
    public boolean captain_piett_condition_hasDeletedLiveConversion(obj_id player, obj_id npc)
    {
    ...
    public void captain_piett_action_grantMissionOne(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        groundquests.grantQuest(player, "quest/outbreak_quest_01_imperial");
    }
    public void captain_piett_action_completeQuest5(obj_id player, obj_id npc)
    {
    ...
    public void captain_piett_action_clearLiveConversion(obj_id player, obj_id npc)
    {
    ...
    public void captain_piett_action_revokeImpGrantReb(obj_id player, obj_id npc)
    {
    ...
    public void captain_piett_action_revokeImpGrantNeut(obj_id player, obj_id npc)
    {
        if (groundquests.isQuestActiveOrComplete(player, "outbreak_live_conversion_imperial"))
        {
            groundquests.clearQuest(player, "outbreak_live_conversion_imperial");
    ...
    public void captain_piett_action_revokeEntireImpQuestLine(obj_id player, obj_id npc)
    {
        holiday.removeAllCompletedQuestsForDeathTroopers(player);
    }
    public void captain_piett_action_grantRebQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "outbreak_switch_to_rebel");
    }
    public void captain_piett_action_grantImpQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "outbreak_switch_to_imperial");
    }
    public void captain_piett_action_grantNeutQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "outbreak_switch_to_neutral");
    }
    public int captain_piett_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int captain_piett_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int captain_piett_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int captain_piett_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int captain_piett_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int captain_piett_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int captain_piett_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int captain_piett_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int captain_piett_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int captain_piett_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int captain_piett_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int captain_piett_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int captain_piett_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int captain_piett_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int captain_piett_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int captain_piett_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_51"))
        {
            if (captain_piett_condition__defaultCondition(player, npc))
    ...
    public int captain_piett_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_51"))
        {
            if (captain_piett_condition__defaultCondition(player, npc))
    ...
    public int captain_piett_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int captain_piett_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int captain_piett_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int captain_piett_handleBranch30(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int captain_piett_handleBranch31(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int captain_piett_handleBranch32(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int captain_piett_handleBranch33(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int captain_piett_handleBranch34(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int captain_piett_handleBranch35(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int captain_piett_handleBranch36(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int captain_piett_handleBranch37(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int captain_piett_handleBranch38(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int captain_piett_handleBranch39(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int captain_piett_handleBranch41(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int captain_piett_handleBranch42(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int captain_piett_handleBranch43(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int captain_piett_handleBranch44(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int captain_piett_handleBranch45(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int captain_piett_handleBranch46(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int captain_piett_handleBranch48(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int captain_piett_handleBranch49(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int captain_piett_handleBranch50(obj_id player, obj_id npc, string_id response)
    {
