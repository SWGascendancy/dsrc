...
public class station_talus extends script.base_script
{
    ...
    public boolean station_talus_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean station_talus_condition_canAfford50(obj_id player, obj_id npc)
    {
        return space_crafting.canAffordShipRepairs(player, npc, .50f);
    }
    public boolean station_talus_condition_canAfford25(obj_id player, obj_id npc)
    {
        return (space_crafting.canAffordShipRepairs(player, npc, .25f) && space_crafting.isDamaged(player));
    }
    public boolean station_talus_condition_canAfford75(obj_id player, obj_id npc)
    {
        return space_crafting.canAffordShipRepairs(player, npc, .75f);
    }
    public boolean station_talus_condition_canAfford100(obj_id player, obj_id npc)
    {
        return space_crafting.canAffordShipRepairs(player, npc, 1.0f);
    }
    public boolean station_talus_condition_needRepairs(obj_id player, obj_id npc)
    {
    ...
    public boolean station_talus_condition_isTooFar(obj_id player, obj_id npc)
    {
        space_combat.playCombatTauntSound(player);
        obj_id containingShip = space_transition.getContainingShip(player);
        return (getDistance(npc, containingShip) > space_transition.STATION_COMM_MAX_DISTANCE);
    }
    public boolean station_talus_condition_isSmuggler(obj_id player, obj_id npc)
    {
        return hasSkill(player, "combat_smuggler_underworld_01");
    }
    public boolean station_talus_condition_isSmugglerTooFar(obj_id player, obj_id npc)
    {
        return (station_talus_condition_isSmuggler(player, npc) && station_talus_condition_isTooFar(player, npc));
    }
    public boolean station_talus_condition_isTalusSmuggler(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "talus_station.smuggler");
    }
    public boolean station_talus_condition_isTier1CorelliaImperial(obj_id player, obj_id npc)
    {
        return (space_flags.isInTierOne(player) && space_flags.isSpaceTrack(player, space_flags.IMPERIAL_CORELLIA));
    }
    public boolean station_talus_condition_isImperialCondition(obj_id player, obj_id npc)
    {
        return space_flags.isImperialPilot(player);
    }
    public boolean station_talus_condition_failedStoryQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean station_talus_condition_wonStoryQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean station_talus_condition_readyForRun(obj_id player, obj_id npc)
    {
    ...
    public boolean station_talus_condition_hasAQuest(obj_id player, obj_id npc)
    {
        return space_quest.hasQuest(player);
    }
    public boolean station_talus_condition_canLandAtHouse(obj_id player, obj_id npc)
    {
    ...
    public boolean station_talus_condition_canTakeQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean station_talus_condition_canAttackImperial(obj_id player, obj_id npc)
    {
    ...
    public boolean station_talus_condition_canAttackRebel(obj_id player, obj_id npc)
    {
    ...
    public boolean station_talus_condition_canTakeTier5ImperialDuty(obj_id player, obj_id npc)
    {
    ...
    public boolean station_talus_condition_canTakeTier5RebelDuty(obj_id player, obj_id npc)
    {
        if (!space_skill.isMasterPilot(player))
        {
            return false;
    ...
    public void station_talus_action_landStation3(obj_id player, obj_id npc)
    {
        space_content.landPlayer(player, npc, "Daoba Guerfel Starport");
    }
    public void station_talus_action_fix25(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, .25f);
    }
    public void station_talus_action_fix50(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, .50f);
    }
    public void station_talus_action_fix75(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, .75f);
    }
    public void station_talus_action_fix100(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, 1.0f);
    }
    public void station_talus_action_landStation1(obj_id player, obj_id npc)
    {
        space_content.landPlayer(player, npc, "Dearic Starport");
    }
    public void station_talus_action_landStation2(obj_id player, obj_id npc)
    {
        space_content.landPlayer(player, npc, "Nashal Starport");
    }
    public void station_talus_action_landStation4(obj_id player, obj_id npc)
    {
        space_content.landPlayer(player, npc, "Talus Imperial Outpost");
    }
    public void station_talus_action_flagTalusSmuggler(obj_id player, obj_id npc)
    {
        setObjVar(player, "talus_station.smuggler", true);
    }
    public void station_talus_action_grantStoryQuest(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "delivery", "talus_station_mission1_1");
        space_flags.setSpaceFlag(player, "talus_station", 1);
    }
    public void station_talus_action_giveStoryReward(obj_id player, obj_id npc)
    {
        space_flags.setSpaceFlag(player, "talus_station", 2);
    }
    public void station_talus_action_grantTuskCatRun(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "delivery", "talus_station_mission5_1");
    }
    public void station_talus_action_landHoming(obj_id player, obj_id npc)
    {
        space_content.landPlayerHoming(player, npc);
    }
    public void station_talus_action_grantImperialDuty1(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "corellia_imperial_tier1");
    }
    public void station_talus_action_grantImperialDuty2(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "corellia_imperial_tier2");
    }
    public void station_talus_action_grantRebelDuty1(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "corellia_rebel_tier1");
    }
    public void station_talus_action_grantRebelDuty2(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "corellia_rebel_tier2");
    }
    public void station_talus_action_grantBlackSunDuty1(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "corellia_blacksun_tier1");
    }
    public void station_talus_action_grantBlackSunDuty2(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "corellia_blacksun_tier2");
    }
    public void station_talus_action_grantRebelDuty5(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "corellia_rebel_tier5");
    }
    public void station_talus_action_grantImperialDuty5(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "corellia_imperial_tier5");
    }
    public String station_talus_tokenTO_tokenTO0001(obj_id player, obj_id npc)
    {
        return new String();
    }
    public int station_talus_tokenDI_getStationRepairCost25(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, .25f);
    }
    public int station_talus_tokenDI_getStationRepairCost50(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, .50f);
    }
    public int station_talus_tokenDI_getStationRepairCost75(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, .75f);
    }
    public int station_talus_tokenDI_getStationRepairCost100(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, 1.0f);
    }
    public int station_talus_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_talus_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_talus_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_talus_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_talus_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_talus_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_talus_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_talus_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_talus_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_talus_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_talus_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_talus_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_talus_handleBranch30(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_talus_handleBranch33(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_talus_handleBranch38(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_talus_handleBranch40(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_talus_handleBranch41(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_talus_handleBranch45(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_talus_handleBranch48(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_talus_handleBranch49(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_talus_handleBranch50(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_talus_handleBranch51(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_talus_handleBranch53(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_talus_handleBranch55(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_talus_handleBranch56(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_talus_handleBranch57(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_talus_handleBranch60(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_talus_handleBranch63(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_talus_handleBranch66(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_talus_handleBranch69(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_talus_handleBranch72(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_talus_handleBranch73(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_talus_handleBranch76(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_talus_handleBranch79(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_talus_handleBranch82(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_talus_handleBranch86(obj_id player, obj_id npc, string_id response)
    {
