...
public class tusken_giver extends script.base_script
{
    ...
    public boolean tusken_giver_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tusken_giver_condition_startQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "found_tusken_encounter");
    }
    public boolean tusken_giver_condition_onQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean tusken_giver_condition_lastLeg(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "feeder_tusken_01", "feeder_tusken_wait_01");
    }
    public boolean tusken_giver_condition_doneQuest(obj_id player, obj_id npc)
    {
    ...
    public void tusken_giver_action_giveQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "feeder_tusken_01");
    }
    public void tusken_giver_action_giveEventQuest(obj_id player, obj_id npc)
    {
    }
    public void tusken_giver_action_finishPointer(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "found_tusken_encounter_signal_01");
    }
    public void tusken_giver_action_finishQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "feeder_tusken_signal_01");
    }
    public int tusken_giver_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tusken_giver_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tusken_giver_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tusken_giver_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tusken_giver_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tusken_giver_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tusken_giver_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tusken_giver_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
