...
public class vet_reward_vendor extends script.base_script
{
    ...
    public boolean vet_reward_vendor_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }

    public void vet_reward_vendor_action_showTokenVendorUI(obj_id player, obj_id npc)
    {
