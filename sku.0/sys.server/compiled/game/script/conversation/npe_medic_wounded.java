...
public class npe_medic_wounded extends script.base_script
{
    ...
    public boolean npe_medic_wounded_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_medic_wounded_condition_isFirstToHeal(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_medic_wounded_condition_wasHealed1(obj_id player, obj_id npc)
    {
    ...
    public void npe_medic_wounded_action_sendSignalHealed(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_medic_heal_worker_1");
        return;
    }
    public void npe_medic_wounded_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void npe_medic_wounded_action_giveComm(obj_id player, obj_id npc)
    {
        utils.removeScriptVar(player, "npe.heal");
        npe.giveHealPopUp(player, npc);
    }
    public int npe_medic_wounded_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_medic_wounded_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
