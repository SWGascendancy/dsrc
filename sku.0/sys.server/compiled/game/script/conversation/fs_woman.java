...
public class fs_woman extends script.base_script
{
    ...
    public boolean fs_woman_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean fs_woman_condition_questOwner(obj_id player, obj_id npc)
    {
        obj_id owner = null;
    ...
    public void fs_woman_action_completeQuest(obj_id player, obj_id npc)
    {
