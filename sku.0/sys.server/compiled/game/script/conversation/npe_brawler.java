...
public class npe_brawler extends script.base_script
{
    ...
    public boolean npe_brawler_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_brawler_condition_isTaskActiveAny(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_brawler_condition_isTaskCompleteUnarmed(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_brawler_unarmed", "wait");
    }
    public boolean npe_brawler_condition_isTaskComplete1hand(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_brawler_1hand", "wait");
    }
    public boolean npe_brawler_condition_isTaskComplete2hand(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_brawler_2hand", "wait");
    }
    public boolean npe_brawler_condition_isTaskCompletePolearm(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_brawler_polearm", "wait");
    }
    public boolean npe_brawler_condition_isTaskActiveStory1(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_brawler_condition_hasCompletedTaskStory1(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_brawler_1", "return");
    }
    public boolean npe_brawler_condition_hasCompletedStory1(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_brawler_1");
    }
    public boolean npe_brawler_condition_isTaskActiveStory2(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_brawler_condition_hasCompletedTaskSmugglers(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_brawler_2", "npe_smuggler_finish");
    }
    public boolean npe_brawler_condition_hasCompletedStory2(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_brawler_2");
    }
    public boolean npe_brawler_condition_isTaskActiveStory4(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_brawler_condition_hasCompletedTaskStory4(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_brawler_4a", "npe_brawler4_2h_finish");
    }
    public boolean npe_brawler_condition_hasCompletedStory4(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_brawler_4a");
    }
    public boolean npe_brawler_condition_isTaskActiveSmuggler(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "npe_brawler_2", "elev_down") || groundquests.isTaskActive(player, "npe_brawler_2", "waiting"));
    }
    public boolean npe_brawler_condition_hasCompletedAll(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_brawler_condition_cantHelp(obj_id player, obj_id npc)
    {
        return !npe_brawler_condition_hasCompletedTemplate(player, npc);
    }
    public boolean npe_brawler_condition_hasCompletedTemplate(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "npe.finishedTemplate");
    }
    public boolean npe_brawler_condition_hasFinishedUnarmed(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_brawler_unarmed");
    }
    public boolean npe_brawler_condition_hasFinishedPolearm(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_brawler_polearm");
    }
    public boolean npe_brawler_condition_hasFinished1Hand(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_brawler_1hand");
    }
    public boolean npe_brawler_condition_hasFinished2Hand(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_brawler_2hand");
    }
    public void npe_brawler_action_givePolearmQuest(obj_id player, obj_id npc)
    {
    ...
    public void npe_brawler_action_giveUnarmedQuest(obj_id player, obj_id npc)
    {
    ...
    public void npe_brawler_action_give1handquest(obj_id player, obj_id npc)
    {
    ...
    public void npe_brawler_action_give2handquest(obj_id player, obj_id npc)
    {
    ...
    public void npe_brawler_action_giveStory1(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "npe_brawler_1");
    }
    public void npe_brawler_action_giveSingalUnarmed(obj_id player, obj_id npc)
    {
    ...
    public void npe_brawler_action_giveSignal1hand(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_brawler_1hand");
        groundquests.sendSignal(player, "finished_rydel");
        npe.sendDelayed3poPopup(player, 3, 11, "sound/c3po_29.snd", "npe", "pop_credits", "npe.credits");
    }
    public void npe_brawler_action_giveSignal2hand(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_brawler_2hand");
        groundquests.sendSignal(player, "finished_rydel");
        npe.sendDelayed3poPopup(player, 3, 11, "sound/c3po_29.snd", "npe", "pop_credits", "npe.credits");
    }
    public void npe_brawler_action_giveSignalPolearm(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_brawler_polearm");
        groundquests.sendSignal(player, "finished_rydel");
        npe.sendDelayed3poPopup(player, 3, 11, "sound/c3po_29.snd", "npe", "pop_credits", "npe.credits");
    }
    public void npe_brawler_action_giveSignalStory1(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_brawler_killstuff");
        npe.sendDelayed3poPopup(player, 3, 11, "sound/c3po_29.snd", "npe", "pop_credits", "npe.credits");
    }
    public void npe_brawler_action_giveStory2(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "npe_brawler_2");
    }
    public void npe_brawler_action_grantStory4(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "npe_brawler_4a");
    }
    public void npe_brawler_action_giveSignalSmuggs(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_brawler_smugglers");
        npe.sendDelayed3poPopup(player, 3, 11, "sound/c3po_29.snd", "npe", "pop_credits", "npe.credits");
    }
    public void npe_brawler_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void npe_brawler_action_giveSignalStory4(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_brawler4a_done");
        npe.sendDelayed3poPopup(player, 3, 11, "sound/c3po_29.snd", "npe", "pop_credits", "npe.credits");
    }
    public int npe_brawler_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brawler_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brawler_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brawler_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brawler_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brawler_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brawler_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brawler_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brawler_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brawler_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brawler_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brawler_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brawler_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brawler_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brawler_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brawler_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brawler_handleBranch31(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brawler_handleBranch33(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brawler_handleBranch34(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brawler_handleBranch36(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brawler_handleBranch37(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brawler_handleBranch39(obj_id player, obj_id npc, string_id response)
    {
