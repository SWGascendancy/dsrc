...
public class ep3_cpg_ace extends script.base_script
{
    ...
    public boolean ep3_cpg_ace_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_cpg_ace_condition_canAfford50(obj_id player, obj_id npc)
    {
        return space_crafting.canAffordShipRepairs(player, npc, .50f);
    }
    public boolean ep3_cpg_ace_condition_canAfford25(obj_id player, obj_id npc)
    {
        return (space_crafting.canAffordShipRepairs(player, npc, .25f) && space_crafting.isDamaged(player));
    }
    public boolean ep3_cpg_ace_condition_canAfford75(obj_id player, obj_id npc)
    {
        return space_crafting.canAffordShipRepairs(player, npc, .75f);
    }
    public boolean ep3_cpg_ace_condition_canAfford100(obj_id player, obj_id npc)
    {
        return space_crafting.canAffordShipRepairs(player, npc, 1.0f);
    }
    public boolean ep3_cpg_ace_condition_hasWonQuest_01(obj_id player, obj_id npc)
    {
        return (space_quest.hasWonQuest(player, "escort", "ep3_kash_station_escort_alpha"));
    }
    public boolean ep3_cpg_ace_condition_hasWonQuest_02(obj_id player, obj_id npc)
    {
        return (space_quest.hasWonQuest(player, "escort", "ep3_kash_station_escort_bravo"));
    }
    public boolean ep3_cpg_ace_condition_hasWonQuest_03(obj_id player, obj_id npc)
    {
        return (space_quest.hasWonQuest(player, "rescue", "ep3_kash_station_rescue_alpha"));
    }
    public boolean ep3_cpg_ace_condition_hasWonQuest_04(obj_id player, obj_id npc)
    {
        return (space_quest.hasWonQuest(player, "rescue", "ep3_kash_station_rescue_bravo"));
    }
    public boolean ep3_cpg_ace_condition_isOnQuest_escort_alpha(obj_id player, obj_id npc)
    {
        return (space_quest.hasQuest(player, "escort", "ep3_kash_station_escort_alpha"));
    }
    public boolean ep3_cpg_ace_condition_hasFailedQuest_01(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_cpg_ace_condition_hasBeenRewarded_01(obj_id player, obj_id npc)
    {
        return space_quest.hasReceivedReward(player, "escort", "ep3_kash_station_escort_alpha");
    }
    public boolean ep3_cpg_ace_condition_hasFailedQuest_02(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_cpg_ace_condition_hasBeenRewarded_02(obj_id player, obj_id npc)
    {
        return space_quest.hasReceivedReward(player, "escort", "ep3_kash_station_escort_bravo");
    }
    public boolean ep3_cpg_ace_condition_hasWon01_not02yet(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_cpg_ace_condition_hasWon02_not03yet(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_cpg_ace_condition_hasWon03_not04yet(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_cpg_ace_condition_hasDoneGround_01(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedQuest(player, "ep3_kash_station_contact_eyma_01"));
    }
    public boolean ep3_cpg_ace_condition_hasWon_assassinations(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_cpg_ace_condition_isOnQuest_ground_01(obj_id player, obj_id npc)
    {
        return (groundquests.isQuestActive(player, "ep3_kash_station_contact_eyma_01"));
    }
    public boolean ep3_cpg_ace_condition_isOnQuest_AMBUSH(obj_id player, obj_id npc)
    {
        return (space_quest.hasQuest(player, "destroy_surpriseattack", "ep3_kash_station_ghrag_ambush"));
    }
    public boolean ep3_cpg_ace_condition_hasFailedQuest_03(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_cpg_ace_condition_isOnQuest_ground_00(obj_id player, obj_id npc)
    {
        return (groundquests.isQuestActive(player, "ep3_kash_station_contact_eyma_00"));
    }
    public boolean ep3_cpg_ace_condition_isOnQuest_rescue_alpha(obj_id player, obj_id npc)
    {
        return (space_quest.hasQuest(player, "rescue", "ep3_kash_station_rescue_alpha"));
    }
    public boolean ep3_cpg_ace_condition_isOnQuest_escort_bravo(obj_id player, obj_id npc)
    {
        return (space_quest.hasQuest(player, "escort", "ep3_kash_station_escort_bravo"));
    }
    public boolean ep3_cpg_ace_condition_isTooFar(obj_id player, obj_id npc)
    {
        space_combat.playCombatTauntSound(player);
        obj_id containingShip = space_transition.getContainingShip(player);
        return (getDistance(npc, containingShip) > space_transition.STATION_COMM_MAX_DISTANCE);
    }
    public boolean ep3_cpg_ace_condition_hasBadge_visited_Kachirho(obj_id player, obj_id npc)
    {
        return badge.hasBadge(player, "exp_kash_kachirho_found");
    }
    public boolean ep3_cpg_ace_condition_isAttacking(obj_id player, obj_id npc)
    {
        return _spaceUnitIsAttacking(npc);
    }
    public void ep3_cpg_ace_action_land_kashyyyk(obj_id player, obj_id npc)
    {
        space_content.landPlayer(player, npc, "Kachirho Starport");
    }
    public void ep3_cpg_ace_action_fix25(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, .25f);
    }
    public void ep3_cpg_ace_action_fix50(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, .50f);
    }
    public void ep3_cpg_ace_action_fix75(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, .75f);
    }
    public void ep3_cpg_ace_action_fix100(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, 1.0f);
    }
    public void ep3_cpg_ace_action_grantQuest_01(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "escort", "ep3_kash_station_escort_alpha");
    }
    public void ep3_cpg_ace_action_grantQuest_02(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "escort", "ep3_kash_station_escort_bravo");
    }
    public void ep3_cpg_ace_action_grantQuest_03(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "rescue", "ep3_kash_station_rescue_alpha");
    }
    public void ep3_cpg_ace_action_grantQuest_04(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "rescue", "ep3_kash_station_rescue_bravo");
    }
    public void ep3_cpg_ace_action_rewardQuest_01(obj_id player, obj_id npc)
    {
    ...
    public void ep3_cpg_ace_action_rewardQuest_02(obj_id player, obj_id npc)
    {
    ...
    public void ep3_cpg_ace_action_grantDuty_escort(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "escort_duty", "ep3_kash_station_escort_duty");
    }
    public void ep3_cpg_ace_action_giveGroundQuest_01(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_kash_station_contact_eyma_01");
    }
    public void ep3_cpg_ace_action_grantDuty_destroy(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "ep3_kash_station_destroy_duty_neutral");
    }
    public void ep3_cpg_ace_action_giveGroundQuest_00(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_kash_station_contact_eyma_00");
    }
    public void ep3_cpg_ace_action_Land_and_GrantBadge_visited_Kachirho(obj_id player, obj_id npc)
    {
        badge.grantBadge(player, "exp_kash_kachirho_found");
        space_content.landPlayer(player, npc, "Kachirho Starport");
    }
    public int ep3_cpg_ace_tokenDI_getStationRepairCost25(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, .25f);
    }
    public int ep3_cpg_ace_tokenDI_getStationRepairCost50(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, .50f);
    }
    public int ep3_cpg_ace_tokenDI_getStationRepairCost75(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, .75f);
    }
    public int ep3_cpg_ace_tokenDI_getStationRepairCost100(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, 1.0f);
    }
    public int ep3_cpg_ace_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_cpg_ace_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_cpg_ace_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_cpg_ace_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
