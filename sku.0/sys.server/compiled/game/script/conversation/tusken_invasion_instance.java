...
public class tusken_invasion_instance extends script.base_script
{
    ...
    public boolean tusken_invasion_instance_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tusken_invasion_instance_condition_readyForInstance(obj_id player, obj_id npc)
    {
    ...
    public void tusken_invasion_instance_action_sendToInstance(obj_id player, obj_id npc)
    {
        instance.requestInstanceMovement(player, "heroic_tusken_army");
    }
    public void tusken_invasion_instance_action_sendQuestSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "feeder_tusken_signal_02");
        instance.flagPlayerForInstance(player, "heroic_tusken_army");
    }
    public int tusken_invasion_instance_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tusken_invasion_instance_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
