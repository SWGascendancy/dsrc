...
public class naboo_vana_sage extends script.base_script
{
    ...
    public boolean naboo_vana_sage_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean naboo_vana_sage_condition_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return true;
    }
    public int naboo_vana_sage_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
