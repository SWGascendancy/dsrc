...
public class mtp_corellia_times_contact extends script.base_script
{
    ...
    public boolean mtp_corellia_times_contact_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean mtp_corellia_times_contact_condition_isVaniPointerActive(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "mtp_hideout_pointer");
    }
    public boolean mtp_corellia_times_contact_condition_allMeatlumpCollectionsComplete(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_corellia_times_contact_condition_isMeatlumpSafeCollectionComplete(obj_id player, obj_id npc)
    {
        return hasCompletedCollection(player, "col_meatlump_safe_01");
    }
    public boolean mtp_corellia_times_contact_condition_isMeatlumpContainerCollectionComplete(obj_id player, obj_id npc)
    {
        return hasCompletedCollection(player, "col_meatlump_container_01");
    }
    public boolean mtp_corellia_times_contact_condition_isMeatlumpMapCollectionComplete(obj_id player, obj_id npc)
    {
        return hasCompletedCollection(player, "col_meatlump_map_01");
    }
    public boolean mtp_corellia_times_contact_condition_isMeatlumpBombCollectionComplete(obj_id player, obj_id npc)
    {
        return hasCompletedCollection(player, "col_meatlump_bomb_sabotage_01");
    }
    public boolean mtp_corellia_times_contact_condition_isMeatlumpWeaponCollectionComplete(obj_id player, obj_id npc)
    {
        return hasCompletedCollection(player, "col_meatlump_weapon_sabotage_01");
    }
    public boolean mtp_corellia_times_contact_condition_isMeatlumpFoodCollectionComplete(obj_id player, obj_id npc)
    {
        return hasCompletedCollection(player, "col_meatlump_food_sabotage_01");
    }
    public boolean mtp_corellia_times_contact_condition_mealtumpCollectionCompleteQuestActive(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_corellia_times_contact_condition_repeatMeatlumpQuestComplete(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_corellia_times_contact_condition_meatlumpCollectionCompleteQuestComplete(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_corellia_times_contact_condition_hasSafeDeviceStack(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_corellia_times_contact_condition_hasContainerDeviceStack(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_corellia_times_contact_condition_hasMapDeviceStack(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_corellia_times_contact_condition_hasWeaponDeviceStack(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_corellia_times_contact_condition_hasFoodDeviceStack(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_corellia_times_contact_condition_hasBombDeviceStack(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_corellia_times_contact_condition_hasAllDevices(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_corellia_times_contact_condition_hasCollectionQuestActive(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "mtp_collection_tracking");
    }
    public boolean mtp_corellia_times_contact_condition_hasQuestButNotAllDevices(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_corellia_times_contact_condition_isReadyForCollectionQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_corellia_times_contact_condition_hasCompletedPrerequisites(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_corellia_times_contact_condition_isSomehowBroken(obj_id player, obj_id npc)
    {
    ...
    public void mtp_corellia_times_contact_action_sendVaniPointerSignal(obj_id player, obj_id npc)
    {
    ...
    public void mtp_corellia_times_contact_action_removeAndReactivateMeatlumpCollectionsAndQuest(obj_id player, obj_id npc)
    {
    ...
    public void mtp_corellia_times_contact_action_grantMeatlumpCollectionAndQuest(obj_id player, obj_id npc)
    {
        mtp_corellia_times_contact_action_activateMeatlumpCollections(player, npc);
        mtp_corellia_times_contact_action_grantCollectionQuest(player, npc);
    }
    public void mtp_corellia_times_contact_action_activateMeatlumpCollections(obj_id player, obj_id npc)
    {
    ...
    public void mtp_corellia_times_contact_action_removeMeatlumpCollections(obj_id player, obj_id npc)
    {
    ...
    public void mtp_corellia_times_contact_action_completeCollectionQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "returnToHaldenWes");
    }
    public void mtp_corellia_times_contact_action_giveSafeDevices(obj_id player, obj_id npc)
    {
    ...
    public void mtp_corellia_times_contact_action_giveContainerDevices(obj_id player, obj_id npc)
    {
        obj_id inv = utils.getInventoryContainer(player);
        if (!isIdValid(inv) || !exists(inv))
        {
    ...
    public void mtp_corellia_times_contact_action_giveMapDevices(obj_id player, obj_id npc)
    {
        obj_id inv = utils.getInventoryContainer(player);
        if (!isIdValid(inv) || !exists(inv))
        {
    ...
    public void mtp_corellia_times_contact_action_giveBombDevices(obj_id player, obj_id npc)
    {
        obj_id inv = utils.getInventoryContainer(player);
        if (!isIdValid(inv) || !exists(inv))
        {
    ...
    public void mtp_corellia_times_contact_action_giveWeaponDevices(obj_id player, obj_id npc)
    {
        obj_id inv = utils.getInventoryContainer(player);
        if (!isIdValid(inv) || !exists(inv))
        {
    ...
    public void mtp_corellia_times_contact_action_giveFoodDevices(obj_id player, obj_id npc)
    {
        obj_id inv = utils.getInventoryContainer(player);
        if (!isIdValid(inv) || !exists(inv))
        {
    ...
    public void mtp_corellia_times_contact_action_giveAllDevices(obj_id player, obj_id npc)
    {
    ...
    public void mtp_corellia_times_contact_action_grantCollectionQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "mtp_collection_tracking");
    }
    public int mtp_corellia_times_contact_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_corellia_times_contact_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_corellia_times_contact_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_corellia_times_contact_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_corellia_times_contact_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_corellia_times_contact_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_corellia_times_contact_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_corellia_times_contact_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_corellia_times_contact_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_corellia_times_contact_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
