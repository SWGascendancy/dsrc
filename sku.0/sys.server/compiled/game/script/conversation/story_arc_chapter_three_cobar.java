...
public class story_arc_chapter_three_cobar extends script.base_script
{
    ...
    public boolean story_arc_chapter_three_cobar_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean story_arc_chapter_three_cobar_condition_collectOverride(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "som_story_arc_chapter_three_02", "mustafar_droid_factory_slicing");
    }
    public void story_arc_chapter_three_cobar_action_grantTool(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "mustafar_droid_factory_tool_recieved");
    }
    public int story_arc_chapter_three_cobar_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int story_arc_chapter_three_cobar_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
