...
public class loveday_disillusion_herald extends script.base_script
{
    ...
    public boolean loveday_disillusion_herald_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean loveday_disillusion_herald_condition_quest_pet_lover_Active(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "loveday_disillusion_pet_lover_v2");
    }
    public boolean loveday_disillusion_herald_condition_questComplete(obj_id player, obj_id npc)
    {
        return hasCompletedCollectionSlot(player, "loveday_2010_disillusion_quest");
    }
    public boolean loveday_disillusion_herald_condition_quest_love_note_Active(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "loveday_disillusion_love_note_v2");
    }
    public boolean loveday_disillusion_herald_condition_quest_mr_hate_Active(obj_id player, obj_id npc)
    {
    ...
    public void loveday_disillusion_herald_action_grantquest(obj_id player, obj_id npc)
    {
    ...
    public int loveday_disillusion_herald_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int loveday_disillusion_herald_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
