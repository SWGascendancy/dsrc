...
public class ep3_ghrag_traitor extends script.base_script
{
    ...
    public boolean ep3_ghrag_traitor_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_ghrag_traitor_condition_isTooFar(obj_id player, obj_id npc)
    {
        space_combat.playCombatTauntSound(player);
        obj_id containingShip = space_transition.getContainingShip(player);
        return (getDistance(npc, containingShip) > space_transition.STATION_COMM_MAX_DISTANCE);
    }
    public void ep3_ghrag_traitor_action_playCommSound(obj_id player, obj_id npc)
    {
        space_combat.playCombatTauntSound(player);
    }
    public int ep3_ghrag_traitor_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_ghrag_traitor_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_ghrag_traitor_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_ghrag_traitor_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_ghrag_traitor_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
