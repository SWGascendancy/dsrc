...
public class tusken_hotel extends script.base_script
{
    ...
    public boolean tusken_hotel_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tusken_hotel_condition_inside(obj_id player, obj_id npc)
    {
        return getIntObjVar(npc, "phase") == 1;
    }
    public boolean tusken_hotel_condition_start_two(obj_id player, obj_id npc)
    {
