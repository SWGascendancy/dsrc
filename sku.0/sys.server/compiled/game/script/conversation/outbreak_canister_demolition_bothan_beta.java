...
public class outbreak_canister_demolition_bothan_beta extends script.base_script
{
    ...
    public boolean outbreak_canister_demolition_bothan_beta_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean outbreak_canister_demolition_bothan_beta_condition_hasBetaQuestIncomplete(obj_id player, obj_id npc)
    {
    ...
    public boolean outbreak_canister_demolition_bothan_beta_condition_hasFinishedQuota(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "camp_beta_canister_demo", "collectRewardBeta");
    }
    public boolean outbreak_canister_demolition_bothan_beta_condition_hasNeverSpoken(obj_id player, obj_id npc)
    {
    ...
    public boolean outbreak_canister_demolition_bothan_beta_condition_hasCompletedBetaQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "camp_beta_canister_demo");
    }
    public boolean outbreak_canister_demolition_bothan_beta_condition_hasCompletedRadioQuests(obj_id player, obj_id npc)
    {
    ...
    public boolean outbreak_canister_demolition_bothan_beta_condition_hasFoundOtherCamps(obj_id player, obj_id npc)
    {
    ...
    public boolean outbreak_canister_demolition_bothan_beta_condition_noAntiVirus(obj_id player, obj_id npc)
    {
    ...
    public boolean outbreak_canister_demolition_bothan_beta_condition_hasCompletedAllCamps(obj_id player, obj_id npc)
    {
    ...
    public boolean outbreak_canister_demolition_bothan_beta_condition_hasFinishedQuotaAlpha(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "camp_alpha_canister_demo", "collectRewardAlpha");
    }
    public boolean outbreak_canister_demolition_bothan_beta_condition_hasAnotherCampIncomplete(obj_id player, obj_id npc)
    {
    ...
    public boolean outbreak_canister_demolition_bothan_beta_condition_hasAnotherCampCompleted(obj_id player, obj_id npc)
    {
    ...
    public boolean outbreak_canister_demolition_bothan_beta_condition_hasFinishedQuotaDelta(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "camp_delta_canister_demo", "collectRewardDelta");
    }
    public boolean outbreak_canister_demolition_bothan_beta_condition_hasFinishedQuotaGamma(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "camp_gamma_canister_demo", "collectRewardGamma");
    }
    public void outbreak_canister_demolition_bothan_beta_action_grantNextQuestAndCollection(obj_id player, obj_id npc)
    {
    ...
    public void outbreak_canister_demolition_bothan_beta_action_completeQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "hasCompletedBeta");
    }
    public int outbreak_canister_demolition_bothan_beta_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_canister_demolition_bothan_beta_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_canister_demolition_bothan_beta_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_canister_demolition_bothan_beta_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_canister_demolition_bothan_beta_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_canister_demolition_bothan_beta_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_canister_demolition_bothan_beta_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_canister_demolition_bothan_beta_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_canister_demolition_bothan_beta_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
