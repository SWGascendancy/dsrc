...
public class miner_madness_chief_drono extends script.base_script
{
    ...
    public boolean miner_madness_chief_drono_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean miner_madness_chief_drono_condition_isOnMission(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "som_poison_miners");
    }
    public boolean miner_madness_chief_drono_condition_isOnTask(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "som_poison_miners", "mustafar_poison_miners_five");
    }
    public boolean miner_madness_chief_drono_condition_hasWonMission(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "som_poison_miners");
    }
    public void miner_madness_chief_drono_action_startMission(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "som_poison_miners");
    }
    public void miner_madness_chief_drono_action_regrantMission(obj_id player, obj_id npc)
    {
        groundquests.clearQuest(player, "som_poison_miners");
    }
    public void miner_madness_chief_drono_action_grantReward(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "mustafar_poison_miners_reward");
    }
    public int miner_madness_chief_drono_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int miner_madness_chief_drono_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int miner_madness_chief_drono_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int miner_madness_chief_drono_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int miner_madness_chief_drono_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int miner_madness_chief_drono_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int miner_madness_chief_drono_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int miner_madness_chief_drono_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
