...
public class npe_main_security extends script.base_script
{
    ...
    public boolean npe_main_security_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_main_security_condition_onSideQuest5(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "npe_side5");
    }
    public boolean npe_main_security_condition_SideQuest5ReadyForReward(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_side5", "returnsignal");
    }
    public boolean npe_main_security_condition_completedMainQuest(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "npe.finishedTemplate");
    }
    public boolean npe_main_security_condition_Side5Complete(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_side5");
    }
    public void npe_main_security_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void npe_main_security_action_giveSideQuest5(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "npe_side5");
    }
    public void npe_main_security_action_rewardSide5(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_side5_givereward");
    }
    public int npe_main_security_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_main_security_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_main_security_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_main_security_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
