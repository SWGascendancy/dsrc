...
public class privateer_broker_retired_pilot extends script.base_script
{
    ...
    public boolean privateer_broker_retired_pilot_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean privateer_broker_retired_pilot_condition_isImperialPilot(obj_id player, obj_id npc)
    {
        return (hasSkill(player, "pilot_imperial_navy_novice"));
    }
    public boolean privateer_broker_retired_pilot_condition_isRebelPilot(obj_id player, obj_id npc)
    {
        return (hasSkill(player, "pilot_rebel_navy_novice"));
    }
    public boolean privateer_broker_retired_pilot_condition_isPrivateerPilot(obj_id player, obj_id npc)
    {
        return hasSkill(player, "pilot_neutral_novice");
    }
    public int privateer_broker_retired_pilot_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int privateer_broker_retired_pilot_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int privateer_broker_retired_pilot_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int privateer_broker_retired_pilot_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int privateer_broker_retired_pilot_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int privateer_broker_retired_pilot_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_c4682ea6"))
        {
            if (privateer_broker_retired_pilot_condition__defaultCondition(player, npc))
    ...
    public int privateer_broker_retired_pilot_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int privateer_broker_retired_pilot_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_c4682ea6"))
        {
            if (privateer_broker_retired_pilot_condition__defaultCondition(player, npc))
    ...
    public int privateer_broker_retired_pilot_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int privateer_broker_retired_pilot_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int privateer_broker_retired_pilot_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int privateer_broker_retired_pilot_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int privateer_broker_retired_pilot_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int privateer_broker_retired_pilot_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int privateer_broker_retired_pilot_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_811a5ea0"))
        {
            if (privateer_broker_retired_pilot_condition__defaultCondition(player, npc))
    ...
    public int privateer_broker_retired_pilot_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_1bc3ac43"))
        {
            if (privateer_broker_retired_pilot_condition__defaultCondition(player, npc))
    ...
    public int privateer_broker_retired_pilot_handleBranch32(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int privateer_broker_retired_pilot_handleBranch34(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int privateer_broker_retired_pilot_handleBranch36(obj_id player, obj_id npc, string_id response)
    {
