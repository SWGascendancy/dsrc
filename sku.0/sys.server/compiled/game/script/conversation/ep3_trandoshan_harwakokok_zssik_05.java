...
public class ep3_trandoshan_harwakokok_zssik_05 extends script.base_script
{
    ...
    public boolean ep3_trandoshan_harwakokok_zssik_05_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_trandoshan_harwakokok_zssik_05_condition_isOnTask01(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_trando_orooroo_zssik_08", "talkToHarwakokok");
    }
    public boolean ep3_trandoshan_harwakokok_zssik_05_condition_isOnQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_trando_harwakokok_zssik_09");
    }
    public boolean ep3_trandoshan_harwakokok_zssik_05_condition_isOnTask02(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_trando_harwakokok_zssik_09", "killedScratch");
    }
    public boolean ep3_trandoshan_harwakokok_zssik_05_condition_hasCompletedQuest01(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_trando_harwakokok_zssik_09");
    }
    public boolean ep3_trandoshan_harwakokok_zssik_05_condition_cannotSpeakWookiee(obj_id player, obj_id npc)
    {
    ...
    public void ep3_trandoshan_harwakokok_zssik_05_action_giveMission(obj_id player, obj_id npc)
    {
    ...
    public void ep3_trandoshan_harwakokok_zssik_05_action_doSignal01(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "completedHarwakokok");
    }
    public void ep3_trandoshan_harwakokok_zssik_05_action_doSignal02(obj_id player, obj_id npc)
    {
        playClientEffectObj(npc, "clienteffect/voc_wookiee_med_4sec.cef", player, "");
        groundquests.sendSignal(player, "returnToOrooroo");
    }
    public void ep3_trandoshan_harwakokok_zssik_05_action_vocalizeMed(obj_id player, obj_id npc)
    {
        playClientEffectObj(npc, "clienteffect/voc_wookiee_med_4sec.cef", player, "");
    }
    public void ep3_trandoshan_harwakokok_zssik_05_action_vocalizeLong(obj_id player, obj_id npc)
    {
        playClientEffectObj(npc, "clienteffect/voc_wookiee_med_6sec.cef", player, "");
    }
    public void ep3_trandoshan_harwakokok_zssik_05_action_vocalizeShort(obj_id player, obj_id npc)
    {
        playClientEffectObj(npc, "clienteffect/voc_wookiee_med_2sec.cef", player, "");
    }
    public int ep3_trandoshan_harwakokok_zssik_05_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_harwakokok_zssik_05_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_harwakokok_zssik_05_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_harwakokok_zssik_05_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_harwakokok_zssik_05_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_harwakokok_zssik_05_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_harwakokok_zssik_05_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_harwakokok_zssik_05_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
