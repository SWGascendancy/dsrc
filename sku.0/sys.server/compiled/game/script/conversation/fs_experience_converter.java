...
public class fs_experience_converter extends script.base_script
{
    ...
    public boolean fs_experience_converter_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean fs_experience_converter_condition_canConvertXP(obj_id player, obj_id npc)
    {
        return fs_quests.isVillageEligible(player);
    }
    public boolean fs_experience_converter_condition_isConvertEligible(obj_id player, obj_id npc)
    {
        return fs_quests.hasFreeUnlockBranches(player);
    }
    public void fs_experience_converter_action_showSUICrafting(obj_id player, obj_id npc)
    {
        xp.displayForceSensitiveXP(player, "crafting");
    }
    public void fs_experience_converter_action_showSUICombat(obj_id player, obj_id npc)
    {
        xp.displayForceSensitiveXP(player, "combat");
    }
    public void fs_experience_converter_action_showSUISenses(obj_id player, obj_id npc)
    {
        xp.displayForceSensitiveXP(player, "senses");
    }
    public void fs_experience_converter_action_showSUIReflexes(obj_id player, obj_id npc)
    {
        xp.displayForceSensitiveXP(player, "reflex");
    }
    public void fs_experience_converter_action_closeConversionSUI(obj_id player, obj_id npc)
    {
    ...
    public void fs_experience_converter_action_showSUIUnlock(obj_id player, obj_id npc)
    {
        fs_quests.showBranchUnlockSUI(player);
    }
    public String fs_experience_converter_tokenTO_branchList(obj_id player, obj_id npc)
    {
        String branch_list = "\nNothing";
