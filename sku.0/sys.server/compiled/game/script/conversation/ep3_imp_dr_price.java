...
public class ep3_imp_dr_price extends script.base_script
{
    ...
    public boolean ep3_imp_dr_price_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_imp_dr_price_condition_hasCompletedQuest01(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_imp_drprice");
    }
    public boolean ep3_imp_dr_price_condition_hasCompletedQuest02(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_imp_cmd_richards");
    }
    public boolean ep3_imp_dr_price_condition_isReadyForDrPrice(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_imp_dr_price_condition_isOnQuest01(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_imp_drprice");
    }
    public boolean ep3_imp_dr_price_condition_isOnTask01(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_imp_drprice", 2);
    }
    public boolean ep3_imp_dr_price_condition_isOnQuest02(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_imp_cmd_richards");
    }
    public boolean ep3_imp_dr_price_condition_isOnTask02(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_imp_cmd_richards", 4);
    }
    public void ep3_imp_dr_price_action_grantQuest01(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_imp_drprice");
    }
    public void ep3_imp_dr_price_action_sendSignal01(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "completedDrPrice");
    }
    public void ep3_imp_dr_price_action_sendSignal02(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "rewardDrPrice");
    }
    public void ep3_imp_dr_price_action_grantQuest02(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_imp_cmd_richards");
    }
    public int ep3_imp_dr_price_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_imp_dr_price_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_imp_dr_price_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_imp_dr_price_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_imp_dr_price_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_imp_dr_price_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_imp_dr_price_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_imp_dr_price_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_imp_dr_price_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_imp_dr_price_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_imp_dr_price_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_imp_dr_price_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_imp_dr_price_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_imp_dr_price_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_305"))
        {
            if (ep3_imp_dr_price_condition__defaultCondition(player, npc))
