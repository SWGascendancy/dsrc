...
public class station_endor extends script.base_script
{
    ...
    public boolean station_endor_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean station_endor_condition_canAfford50(obj_id player, obj_id npc)
    {
        return space_crafting.canAffordShipRepairs(player, npc, .50f);
    }
    public boolean station_endor_condition_canAfford25(obj_id player, obj_id npc)
    {
        return (space_crafting.canAffordShipRepairs(player, npc, .25f) && space_crafting.isDamaged(player));
    }
    public boolean station_endor_condition_canAfford75(obj_id player, obj_id npc)
    {
        return space_crafting.canAffordShipRepairs(player, npc, .75f);
    }
    public boolean station_endor_condition_canAfford100(obj_id player, obj_id npc)
    {
        return space_crafting.canAffordShipRepairs(player, npc, 1.0f);
    }
    public boolean station_endor_condition_needRepairs(obj_id player, obj_id npc)
    {
    ...
    public boolean station_endor_condition_isTooFar(obj_id player, obj_id npc)
    {
        space_combat.playCombatTauntSound(player);
        obj_id containingShip = space_transition.getContainingShip(player);
        return (getDistance(npc, containingShip) > space_transition.STATION_COMM_MAX_DISTANCE);
    }
    public boolean station_endor_condition_hasCompletedHalfTier3(obj_id player, obj_id npc)
    {
        int skillCount = 0;
    ...
    public boolean station_endor_condition_readyForStoryOne(obj_id player, obj_id npc)
    {
    ...
    public boolean station_endor_condition_hasCompletedFirstSeries(obj_id player, obj_id npc)
    {
    ...
    public boolean station_endor_condition_readyForStoryTwo(obj_id player, obj_id npc)
    {
    ...
    public boolean station_endor_condition_hasCompletedSecondSeries(obj_id player, obj_id npc)
    {
    ...
    public boolean station_endor_condition_readyForStoryThree(obj_id player, obj_id npc)
    {
        if (station_endor_condition_readyForStoryOne(player, npc))
        {
            return false;
    ...
    public boolean station_endor_condition_hasCompletedThirdSeries(obj_id player, obj_id npc)
    {
    ...
    public boolean station_endor_condition_isReadyForDutyMissions(obj_id player, obj_id npc)
    {
        if (space_quest.hasQuest(player))
        {
            return false;
    ...
    public boolean station_endor_condition_canTakeQuest(obj_id player, obj_id npc)
    {
        if (space_quest.hasQuest(player))
        {
            return false;
    ...
    public boolean station_endor_condition_canAttackImperial(obj_id player, obj_id npc)
    {
    ...
    public boolean station_endor_condition_canAttackRebel(obj_id player, obj_id npc)
    {
    ...
    public boolean station_endor_condition_canHandleTier4(obj_id player, obj_id npc)
    {
        return space_flags.hasCompletedTierThree(player);
    }
    public void station_endor_action_landStation3(obj_id player, obj_id npc)
    {
        space_content.landPlayer(player, npc, "Mos Espa Starport");
    }
    public void station_endor_action_fix25(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, .25f);
    }
    public void station_endor_action_fix50(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, .50f);
    }
    public void station_endor_action_fix75(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, .75f);
    }
    public void station_endor_action_fix100(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, 1.0f);
    }
    public void station_endor_action_landStation1(obj_id player, obj_id npc)
    {
        space_content.landPlayer(player, npc, "Research Outpost");
    }
    public void station_endor_action_landStation2(obj_id player, obj_id npc)
    {
        space_content.landPlayer(player, npc, "Smuggler Outpost");
    }
    public void station_endor_action_grantMissionOne(obj_id player, obj_id npc)
    {
    ...
    public void station_endor_action_grantMissionTwo(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "escort", "stn_endor_irs_imp_tier3_2a");
    }
    public void station_endor_action_grantMissionThree(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "patrol", "stn_endor_irs_imp_tier3_3a");
    }
    public void station_endor_action_grantDestroyDutyMission(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "stn_endor_irs_imp_tier4_1");
    }
    public void station_endor_action_grantEscortDutyMission(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "escort_duty", "stn_endor_irs_imp_tier4_1");
    }
    public void station_endor_action_grantImperialDuty4(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "endor_imperial_tier4");
    }
    public void station_endor_action_grantImperialDuty5(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "kessel_imperial_tier5");
    }
    public void station_endor_action_grantRebelDuty4(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "endor_rebel_tier4");
    }
    public void station_endor_action_grantRebelDuty5(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "kessel_rebel_tier5");
    }
    public void station_endor_action_grantBlackSunDuty4(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "endor_blacksun_tier4");
    }
    public void station_endor_action_grantBlackSunDuty5(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "endor_blacksun_tier5");
    }
    public void station_endor_action_grantImperialDuty5_2(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "endor_imperial_tier5");
    }
    public void station_endor_action_grantRebelDuty5_2(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "endor_rebel_tier5");
    }
    public String station_endor_tokenTO_tokenTO0001(obj_id player, obj_id npc)
    {
        return new String();
    }
    public int station_endor_tokenDI_getStationRepairCost25(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, .25f);
    }
    public int station_endor_tokenDI_getStationRepairCost50(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, .50f);
    }
    public int station_endor_tokenDI_getStationRepairCost75(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, .75f);
    }
    public int station_endor_tokenDI_getStationRepairCost100(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, 1.0f);
    }
    public int station_endor_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_endor_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_endor_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_endor_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_endor_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_endor_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_endor_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_endor_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_endor_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_endor_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_endor_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_25759913"))
        {
            if (station_endor_condition__defaultCondition(player, npc))
    ...
    public int station_endor_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_endor_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_25759913"))
        {
            if (station_endor_condition__defaultCondition(player, npc))
    ...
    public int station_endor_handleBranch30(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_endor_handleBranch32(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_25759913"))
        {
            if (station_endor_condition__defaultCondition(player, npc))
    ...
    public int station_endor_handleBranch33(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_endor_handleBranch35(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_endor_handleBranch38(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_84")) //finch
        {
            if (station_endor_condition__defaultCondition(player, npc))
            {
