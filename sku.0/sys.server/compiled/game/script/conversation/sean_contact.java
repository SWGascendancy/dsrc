...
public class sean_contact extends script.base_script
{
    ...
    public boolean sean_contact_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean sean_contact_condition_hasItem(obj_id player, obj_id npc)
    {
    ...
    public boolean sean_contact_condition_notInoffice(obj_id player, obj_id npc)
    {
        if (hasObjVar(npc, "bestine.electionWinner"))
        {
            String winner = getStringObjVar(npc, "bestine.electionWinner");
    ...
    public void sean_contact_action__defaultAction(obj_id player, obj_id npc)
    {
    }
    public void sean_contact_action_Destroyed(obj_id player, obj_id npc)
    {
    ...
    public void sean_contact_action_cleanUpObjVars(obj_id player, obj_id npc)
    {
        if (!utils.playerHasItemByTemplate(player, "object/tangible/loot/quest/sean_history_disk.iff"))
        {
