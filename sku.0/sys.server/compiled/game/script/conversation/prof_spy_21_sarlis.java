...
public class prof_spy_21_sarlis extends script.base_script
{
    ...
    public boolean prof_spy_21_sarlis_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean prof_spy_21_sarlis_condition_onGotoQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean prof_spy_21_sarlis_condition_GotoComplete(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/prof_spy_21");
        boolean OnTask = (questIsQuestComplete(questId1, player));
        return OnTask;
    }
    public boolean prof_spy_21_sarlis_condition_mission21Reward(obj_id player, obj_id npc)
    {
    ...
    public boolean prof_spy_21_sarlis_condition_mission21Complete(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/prof_spy_21a");
        boolean OnTask = (questIsQuestComplete(questId1, player));
        return OnTask;
    }
    public void prof_spy_21_sarlis_action_grantMission21(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/prof_spy_21a");
        groundquests.grantQuest(questId, player, npc, true);
    }
    public void prof_spy_21_sarlis_action_signalGoto(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "prof_spy_21_goto_e2");
    }
    public void prof_spy_21_sarlis_action_signalMissionReward(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "spy_mission_2_e6");
    }
    public int prof_spy_21_sarlis_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int prof_spy_21_sarlis_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int prof_spy_21_sarlis_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int prof_spy_21_sarlis_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int prof_spy_21_sarlis_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int prof_spy_21_sarlis_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int prof_spy_21_sarlis_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int prof_spy_21_sarlis_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
