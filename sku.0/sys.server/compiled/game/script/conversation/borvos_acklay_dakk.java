...
public class borvos_acklay_dakk extends script.base_script
{
    ...
    public boolean borvos_acklay_dakk_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean borvos_acklay_dakk_condition_hasArmorQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean borvos_acklay_dakk_condition_onOrFinishedHelmet(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "borvo_acklay_helmet");
    }
    public boolean borvos_acklay_dakk_condition_onOrFinishedChest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "borvo_acklay_chest_plate");
    }
    public boolean borvos_acklay_dakk_condition_onOrFinishedLeggings(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "borvo_acklay_leggings");
    }
    public boolean borvos_acklay_dakk_condition_onOrFinishedBootsGolves(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "borvo_acklay_boots_gloves");
    }
    public boolean borvos_acklay_dakk_condition_onOrFinishedBracers(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "borvo_acklay_bracers");
    }
    public boolean borvos_acklay_dakk_condition_onOrFinishedBiceps(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "borvo_acklay_biceps");
    }
    public boolean borvos_acklay_dakk_condition_isOnQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean borvos_acklay_dakk_condition_backFromHunting(obj_id player, obj_id npc)
    {
    ...
    public boolean borvos_acklay_dakk_condition_deletedQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean borvos_acklay_dakk_condition_hasAllArmor(obj_id player, obj_id npc)
    {
    ...
    public boolean borvos_acklay_dakk_condition_hasFinishedSomeArmor(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedQuest(player, "borvo_acklay_bracers") || groundquests.hasCompletedQuest(player, "borvo_acklay_biceps") || groundquests.hasCompletedQuest(player, "borvo_acklay_leggings") || groundquests.hasCompletedQuest(player, "borvo_acklay_helmet") || groundquests.hasCompletedQuest(player, "borvo_acklay_chest_plate") || groundquests.hasCompletedQuest(player, "borvo_acklay_boots_gloves"));
    }
    public void borvos_acklay_dakk_action_grantChest(obj_id player, obj_id npc)
    {
    ...
    public void borvos_acklay_dakk_action_grantLeggings(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "borvo_acklay_leggings");
        setObjVar(player, "borvo_acklay", "leggings");
        groundquests.sendSignal(player, "acklay_armorer_found");
    }
    public void borvos_acklay_dakk_action_grantBootsGloves(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "borvo_acklay_boots_gloves");
        setObjVar(player, "borvo_acklay", "boots");
        groundquests.sendSignal(player, "acklay_armorer_found");
    }
    public void borvos_acklay_dakk_action_grantBiceps(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "borvo_acklay_biceps");
        setObjVar(player, "borvo_acklay", "biceps");
        groundquests.sendSignal(player, "acklay_armorer_found");
    }
    public void borvos_acklay_dakk_action_grantBracers(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "borvo_acklay_bracers");
        setObjVar(player, "borvo_acklay", "bracers");
        groundquests.sendSignal(player, "acklay_armorer_found");
    }
    public void borvos_acklay_dakk_action_grantHelmet(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "borvo_acklay_helmet");
        setObjVar(player, "borvo_acklay", "helmet");
        groundquests.sendSignal(player, "acklay_armorer_found");
    }
    public void borvos_acklay_dakk_action_sendSignalCraft(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "acklay_return");
        removeObjVar(player, "borvo_acklay");
    }
    public void borvos_acklay_dakk_action_regrantQuest(obj_id player, obj_id npc)
    {
    ...
    public void borvos_acklay_dakk_action_signalFoundArmorer(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "acklay_armorer_found");
    }
    public int borvos_acklay_dakk_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int borvos_acklay_dakk_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int borvos_acklay_dakk_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int borvos_acklay_dakk_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int borvos_acklay_dakk_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int borvos_acklay_dakk_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int borvos_acklay_dakk_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int borvos_acklay_dakk_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int borvos_acklay_dakk_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int borvos_acklay_dakk_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_52"))
        {
            if (borvos_acklay_dakk_condition__defaultCondition(player, npc))
