...
public class naboo_privateer_trainer_3 extends script.base_script
{
    ...
    public boolean naboo_privateer_trainer_3_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean naboo_privateer_trainer_3_condition_remembersPlayer(obj_id player, obj_id npc)
    {
        return (utils.hasScriptVar(player, "metRsfTrainer"));
    }
    public boolean naboo_privateer_trainer_3_condition_hasNoviceSkillBox(obj_id player, obj_id npc)
    {
        return (space_quest.hasSkill(player, "pilot_neutral_novice"));
    }
    public boolean naboo_privateer_trainer_3_condition_alreadyHasAQuest(obj_id player, obj_id npc)
    {
        return (space_quest.hasQuest(player));
    }
    public boolean naboo_privateer_trainer_3_condition_isImperialPilot(obj_id player, obj_id npc)
    {
        return (hasSkill(player, "pilot_imperial_navy_novice"));
    }
    public boolean naboo_privateer_trainer_3_condition_isRebelPilot(obj_id player, obj_id npc)
    {
        return (hasSkill(player, "pilot_rebel_navy_novice"));
    }
    public boolean naboo_privateer_trainer_3_condition_isPilotButNotRsfMember(obj_id player, obj_id npc)
    {
        return (hasSkill(player, "pilot_neutral_novice") && (!hasObjVar(player, "rsfMember")));
    }
    public boolean naboo_privateer_trainer_3_condition_hasCompletedQuestOne(obj_id player, obj_id npc)
    {
        return (space_quest.hasCompletedQuest(player, "destroy_surpriseattack", "naboo_privateer_1"));
    }
    public boolean naboo_privateer_trainer_3_condition_hasCompletedQuestTwo(obj_id player, obj_id npc)
    {
        return (space_quest.hasCompletedQuest(player, "destroy", "naboo_privateer_2"));
    }
    public boolean naboo_privateer_trainer_3_condition_hasCompletedQuestThree(obj_id player, obj_id npc)
    {
        return (space_quest.hasCompletedQuest(player, "patrol", "naboo_privateer_3"));
    }
    public boolean naboo_privateer_trainer_3_condition_hasCompletedQuestFour(obj_id player, obj_id npc)
    {
        return (space_quest.hasCompletedQuest(player, "destroy", "naboo_privateer_4"));
    }
    public boolean naboo_privateer_trainer_3_condition_missionOneFailed(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_privateer_trainer_3_condition_isReadyForFirstTraining(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_privateer_trainer_3_condition_isReadyForMoreTraining(obj_id player, obj_id npc)
    {
        return (space_quest.isPlayerQualifiedForSkill(player, "pilot_neutral_starships_01"));
    }
    public boolean naboo_privateer_trainer_3_condition_hasAllTierOneSkills(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_privateer_trainer_3_condition_missionTwoFailed(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_privateer_trainer_3_condition_beenRewardedForQuestOne(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_privateer_trainer_3_condition_beenRewardedForQuestTwo(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_privateer_trainer_3_condition_beenRewardedForQuestThree(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_privateer_trainer_3_condition_beenRewardedForQuestFour(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_privateer_trainer_3_condition_missionThreeFailed(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_privateer_trainer_3_condition_missionFourFailed(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_privateer_trainer_3_condition_hasStarshipSkill1(obj_id player, obj_id npc)
    {
        return (hasSkill(player, "pilot_neutral_starships_01"));
    }
    public boolean naboo_privateer_trainer_3_condition_hasDroidSkill1(obj_id player, obj_id npc)
    {
        return (hasSkill(player, "pilot_neutral_droid_01"));
    }
    public boolean naboo_privateer_trainer_3_condition_hasProceduresSkill1(obj_id player, obj_id npc)
    {
        return (hasSkill(player, "pilot_neutral_procedures_01"));
    }
    public boolean naboo_privateer_trainer_3_condition_hasWeaponsSkill1(obj_id player, obj_id npc)
    {
        return (hasSkill(player, "pilot_neutral_weapons_01"));
    }
    public boolean naboo_privateer_trainer_3_condition_has_goMeetLordUnset(obj_id player, obj_id npc)
    {
        return ((utils.hasScriptVar(player, "goMeetLordUnset")) && !(space_quest.hasQuest(player)));
    }
    public boolean naboo_privateer_trainer_3_condition_FAILED_mission_1(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_privateer_trainer_3_condition_WON_mission_1(obj_id player, obj_id npc)
    {
        return (space_quest.hasCompletedQuest(player, "inspect", "privateer_inspection_1"));
    }
    public boolean naboo_privateer_trainer_3_condition_isGenderMale(obj_id player, obj_id npc)
    {
        return (getGender(player) == GENDER_MALE);
    }
    public boolean naboo_privateer_trainer_3_condition_has_goBackToKyatt(obj_id player, obj_id npc)
    {
        return ((utils.hasScriptVar(player, "goBackToKyatt")) && !(space_quest.hasQuest(player)));
    }
    public boolean naboo_privateer_trainer_3_condition_WON_mission_2(obj_id player, obj_id npc)
    {
        return (space_quest.hasCompletedQuest(player, "patrol", "naboo_privateer_8"));
    }
    public boolean naboo_privateer_trainer_3_condition_FAILED_mission_2(obj_id player, obj_id npc)
    {
    ...
    public void naboo_privateer_trainer_3_action_rememberPlayer(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "metRsfTrainer", true);
    }
    public void naboo_privateer_trainer_3_action_grantNoviceSkillBox(obj_id player, obj_id npc)
    {
    ...
    public void naboo_privateer_trainer_3_action_signUpForRsf(obj_id player, obj_id npc)
    {
        playMusic(player, "sound/music_themequest_acc_general.snd");
        setObjVar(player, "rsfMember", true);
    }
    public void naboo_privateer_trainer_3_action_grantMissionOne(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "patrol", "naboo_privateer_1");
    }
    public void naboo_privateer_trainer_3_action_grantMissionTwo(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy", "naboo_privateer_2");
    }
    public void naboo_privateer_trainer_3_action_grantMissionThree(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "patrol", "naboo_privateer_3");
    }
    public void naboo_privateer_trainer_3_action_grantMissionFour(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy", "naboo_privateer_4");
    }
    public void naboo_privateer_trainer_3_action_rewardForQuestOne(obj_id player, obj_id npc)
    {
        space_quest.giveReward(player, "patrol", "naboo_privateer_1", 500);
    }
    public void naboo_privateer_trainer_3_action_rewardForQuestTwo(obj_id player, obj_id npc)
    {
        space_quest.giveReward(player, "destroy", "naboo_privateer_2", 800);
    }
    public void naboo_privateer_trainer_3_action_rewardForQuestThree(obj_id player, obj_id npc)
    {
        space_quest.giveReward(player, "patrol", "naboo_privateer_3", 1000);
    }
    public void naboo_privateer_trainer_3_action_rewardForQuestFour(obj_id player, obj_id npc)
    {
        space_quest.giveReward(player, "destroy", "naboo_privateer_4", 2000);
    }
    public void naboo_privateer_trainer_3_action_grantDroidSkill(obj_id player, obj_id npc)
    {
        grantSkill(player, "pilot_neutral_droid_01");
        playMusic(player, "sound/music_themequest_acc_general.snd");
    }
    public void naboo_privateer_trainer_3_action_grantStarshipSkill(obj_id player, obj_id npc)
    {
        grantSkill(player, "pilot_neutral_starships_01");
        playMusic(player, "sound/music_themequest_acc_general.snd");
    }
    public void naboo_privateer_trainer_3_action_grantProceduresSkill(obj_id player, obj_id npc)
    {
        grantSkill(player, "pilot_neutral_procedures_01");
        playMusic(player, "sound/music_themequest_acc_general.snd");
    }
    public void naboo_privateer_trainer_3_action_grantWeaponsSkill(obj_id player, obj_id npc)
    {
        grantSkill(player, "pilot_neutral_weapons_01");
        playMusic(player, "sound/music_themequest_acc_general.snd");
    }
    public void naboo_privateer_trainer_3_action_buyWeaponsSkill1(obj_id player, obj_id npc)
    {
        skill.purchaseSkill(player, "pilot_neutral_weapons_01");
        playMusic(player, "sound/music_themequest_acc_general.snd");
    }
    public void naboo_privateer_trainer_3_action_buyDroidSkill1(obj_id player, obj_id npc)
    {
        skill.purchaseSkill(player, "pilot_neutral_droid_01");
        playMusic(player, "sound/music_themequest_acc_general.snd");
    }
    public void naboo_privateer_trainer_3_action_buyProcedureSkill1(obj_id player, obj_id npc)
    {
        skill.purchaseSkill(player, "pilot_neutral_procedures_01");
        playMusic(player, "sound/music_themequest_acc_general.snd");
    }
    public void naboo_privateer_trainer_3_action_buyStarshipSkill1(obj_id player, obj_id npc)
    {
        skill.purchaseSkill(player, "pilot_neutral_starships_01");
        playMusic(player, "sound/music_themequest_acc_general.snd");
    }
    public void naboo_privateer_trainer_3_action_grantPatrolDutyMission(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "patrol_duty", "naboo_privateer_5");
    }
    public void naboo_privateer_trainer_3_action_grantDestroyDutyMission(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "naboo_privateer_6");
    }
    public void naboo_privateer_trainer_3_action_grantEscortDutyMission(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "escort_duty", "naboo_privateer_7");
    }
    public void naboo_privateer_trainer_3_action_grantQuestEight(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy", "naboo_privateer_8");
    }
    public void naboo_privateer_trainer_3_action_set_goMeetLordUnset(obj_id player, obj_id npc)
    {
        playMusic(player, "sound/music_themequest_acc_general.snd");
        utils.setScriptVar(player, "goMeetLordUnset", true);
    }
    public void naboo_privateer_trainer_3_action_give_Mission_1(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "inspect", "privateer_inspection_1");
    }
    public void naboo_privateer_trainer_3_action_set_goBackToKyatt(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "goBackToKyatt", true);
    }
    public void naboo_privateer_trainer_3_action_give_Mission_3(obj_id player, obj_id npc)
    {
