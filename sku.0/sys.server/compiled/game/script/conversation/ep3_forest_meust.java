...
public class ep3_forest_meust extends script.base_script
{
    ...
    public boolean ep3_forest_meust_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_forest_meust_condition_isGoodGuy(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_forest_meust_condition_isBadGuy(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_forest_meust_condition_isTaskOneActive(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_forest_meust_condition_hasCompletedTaskOne(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_forest_meust_condition_hasCompletedQuestOne(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_forest_meust_quest_1");
    }
    public boolean ep3_forest_meust_condition_isTaskTwoActive(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_forest_meust_condition_hasCompletedTaskTwo(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_forest_meust_condition_hasCompletedQuestTwo(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_forest_meust_quest_2");
    }
    public boolean ep3_forest_meust_condition_isTaskThreeActive(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_forest_meust_condition_hasCompletedTaskThree(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_forest_meust_condition_hasCompletedQuestThree(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_forest_meust_quest_3");
    }
    public boolean ep3_forest_meust_condition_hasLanguage(obj_id player, obj_id npc)
    {
        return utils.canSpeakWookiee(player, npc);
    }
    public void ep3_forest_meust_action_giveQuestOne(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_forest_meust_quest_1");
    }
    public void ep3_forest_meust_action_giveQuestTwo(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_forest_meust_quest_2");
    }
    public void ep3_forest_meust_action_giveSignalOne(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "mouf");
    }
    public void ep3_forest_meust_action_giveSignalTwo(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "steelhoof");
    }
    public void ep3_forest_meust_action_giveSignalThree(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "sayormi");
    }
    public void ep3_forest_meust_action_giveQuestThree(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_forest_meust_quest_3");
    }
    public void ep3_forest_meust_action_Language(obj_id player, obj_id npc)
    {
        utils.emoteWookieeConfusion(player, npc);
    }
    public int ep3_forest_meust_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_meust_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_meust_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_meust_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_meust_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_meust_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_meust_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_meust_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_meust_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_meust_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_meust_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_meust_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_meust_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_meust_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_meust_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_meust_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_meust_handleBranch30(obj_id player, obj_id npc, string_id response)
    {
