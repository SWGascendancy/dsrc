...
public class prof_medic_11_reward extends script.base_script
{
    ...
    public boolean prof_medic_11_reward_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean prof_medic_11_reward_condition_playerOnCorrectStep(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "profession_medic_11", "getreward");
    }
    public boolean prof_medic_11_reward_condition_playercompletedTask(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "profession_medic_11", "getreward");
    }
    public void prof_medic_11_reward_action_givePassSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "profession_medic_11_reward");
    }
    public void prof_medic_11_reward_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int prof_medic_11_reward_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
