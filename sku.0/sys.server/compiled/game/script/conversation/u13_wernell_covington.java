...
public class u13_wernell_covington extends script.base_script
{
    ...
    public boolean u13_wernell_covington_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean u13_wernell_covington_condition_active_u13_vengeance_01(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "u13_vengeance_01");
    }
    public boolean u13_wernell_covington_condition_returning_u13_vengeance_01(obj_id player, obj_id npc)
    {
    ...
    public boolean u13_wernell_covington_condition_active_u13_vengeance_02(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "u13_vengeance_02");
    }
    public boolean u13_wernell_covington_condition_active_u13_vengeance_pointer(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "u13_vengeance_pointer");
    }
    public boolean u13_wernell_covington_condition_returning_u13_vengeance_02(obj_id player, obj_id npc)
    {
    ...
    public boolean u13_wernell_covington_condition_needs_u13_ponda_pointer(obj_id player, obj_id npc)
    {
        return !groundquests.isQuestActiveOrComplete(player, "u13_ponda_pointer");
    }
    public void u13_wernell_covington_action_signal_u13_vengeance_pointer(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "u13_vengeance_pointer");
    }
    public void u13_wernell_covington_action_grant_u13_vengeance_01(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "u13_vengeance_01");
    }
    public void u13_wernell_covington_action_signal_u13_vengeance_01(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "u13_vengeance_01_06");
    }
    public void u13_wernell_covington_action_grant_u13_vengeance_02(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "u13_vengeance_02");
    }
    public void u13_wernell_covington_action_grant_u13_ponda_pointer(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "u13_ponda_pointer");
    }
    public void u13_wernell_covington_action_signal_u13_vengeance_02(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "u13_vengeance_02_04");
    }
    public int u13_wernell_covington_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int u13_wernell_covington_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int u13_wernell_covington_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int u13_wernell_covington_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int u13_wernell_covington_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int u13_wernell_covington_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
