...
public class ep3_rodian_guard_male extends script.base_script
{
    ...
    public boolean ep3_rodian_guard_male_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_rodian_guard_male_condition_hasFinishedQuest1(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/ep3_rodian_hunter_1");
        return questIsQuestComplete(questId, player);
    }
    public boolean ep3_rodian_guard_male_condition_hasFinishedQuest2(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/ep3_rodian_hunter_2");
        return questIsQuestComplete(questId, player);
    }
    public boolean ep3_rodian_guard_male_condition_hasFinishedQuest3(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/ep3_rodian_hunter_3");
        return questIsQuestComplete(questId, player);
    }
    public boolean ep3_rodian_guard_male_condition_isOnQuest1(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/ep3_rodian_hunter_1");
        return questIsQuestActive(questId, player);
    }
    public boolean ep3_rodian_guard_male_condition_isOnQuest2(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/ep3_rodian_hunter_2");
        return questIsQuestActive(questId, player);
    }
    public boolean ep3_rodian_guard_male_condition_hasFinished_WOOKIEE_quest2(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/ep3_wookiee_benefactor_2");
        return questIsQuestComplete(questId, player);
    }
    public void ep3_rodian_guard_male_action_giveQuestOne(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/ep3_rodian_hunter_1");
    ...
    public void ep3_rodian_guard_male_action_giveQuestTwo(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/ep3_rodian_hunter_2");
        questActivateQuest(questId, player, npc);
        playClientEffectLoc(player, "clienteffect/voc_npc_cnv_rodian_medium.cef", getLocation(npc), 0f);
    }
    public void ep3_rodian_guard_male_action_clearQuests(obj_id player, obj_id npc)
    {
    ...
    public void ep3_rodian_guard_male_action_speak_SHORT(obj_id player, obj_id npc)
    {
        playClientEffectLoc(player, "clienteffect/voc_npc_cnv_rodian_short.cef", getLocation(npc), 0f);
    }
    public void ep3_rodian_guard_male_action_speak_MEDIUM(obj_id player, obj_id npc)
    {
        playClientEffectLoc(player, "clienteffect/voc_npc_cnv_rodian_medium.cef", getLocation(npc), 0f);
    }
    public void ep3_rodian_guard_male_action_speak_LONG(obj_id player, obj_id npc)
    {
        playClientEffectLoc(player, "clienteffect/voc_npc_cnv_rodian_long.cef", getLocation(npc), 0f);
    }
    public void ep3_rodian_guard_male_action_giveQuestThree(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/ep3_rodian_hunter_3");
        questActivateQuest(questId, player, npc);
        playClientEffectLoc(player, "clienteffect/voc_npc_cnv_rodian_short.cef", getLocation(npc), 0f);
    }
    public void ep3_rodian_guard_male_action_speak_MALE(obj_id player, obj_id npc)
    {
        playClientEffectLoc(player, "clienteffect/voc_npc_cnv_rodian_guard_male.cef", getLocation(npc), 0f);
    }
    public int ep3_rodian_guard_male_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_rodian_guard_male_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_rodian_guard_male_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_rodian_guard_male_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
