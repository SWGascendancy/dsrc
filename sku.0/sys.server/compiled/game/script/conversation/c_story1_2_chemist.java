...
public class c_story1_2_chemist extends script.base_script
{
    ...
    public boolean c_story1_2_chemist_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_story1_2_chemist_condition_atChemistStep(obj_id player, obj_id npc)
    {
    ...
    public void c_story1_2_chemist_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void c_story1_2_chemist_action_forwardQuest(obj_id player, obj_id npc)
    {
    ...
    public int c_story1_2_chemist_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_2_chemist_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_2_chemist_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_2_chemist_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_2_chemist_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
