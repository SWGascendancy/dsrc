...
public class greeter_dantooine_brother_rebel extends script.base_script
{
    ...
    public boolean greeter_dantooine_brother_rebel_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean greeter_dantooine_brother_rebel_condition_remembersPlayer(obj_id player, obj_id npc)
    {
        return (utils.hasScriptVar(player, "metNewbiePilot"));
    }
    public boolean greeter_dantooine_brother_rebel_condition_spokeWithFern(obj_id player, obj_id npc)
    {
        return utils.hasScriptVar(player, "spokeWithFernYarrow");
    }
    public boolean greeter_dantooine_brother_rebel_condition_isAnImperialPilot(obj_id player, obj_id npc)
    {
        return space_flags.isImperialPilot(player);
    }
    public boolean greeter_dantooine_brother_rebel_condition_isARebelPilot(obj_id player, obj_id npc)
    {
        return space_flags.isRebelPilot(player);
    }
    public boolean greeter_dantooine_brother_rebel_condition_isPrivateerPilot(obj_id player, obj_id npc)
    {
        return space_flags.isNeutralPilot(player);
    }
    public boolean greeter_dantooine_brother_rebel_condition_hasSpaceExpansion(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean greeter_dantooine_brother_rebel_condition_hasSpaceShip(obj_id player, obj_id npc)
    {
        return (space_quest.hasShip(player));
    }
    public void greeter_dantooine_brother_rebel_action_rememberPlayer(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "metNewbiePilot", true);
    }
    public void greeter_dantooine_brother_rebel_action_grantQuestOne(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "delivery", "tatooine_newbie_1");
        space_quest.grantNewbieShip(player, "rebel");
    }
    public int greeter_dantooine_brother_rebel_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int greeter_dantooine_brother_rebel_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int greeter_dantooine_brother_rebel_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int greeter_dantooine_brother_rebel_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_f2356ea5"))
        {
            if (greeter_dantooine_brother_rebel_condition__defaultCondition(player, npc))
    ...
    public int greeter_dantooine_brother_rebel_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int greeter_dantooine_brother_rebel_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int greeter_dantooine_brother_rebel_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_93511893"))
        {
            if (greeter_dantooine_brother_rebel_condition__defaultCondition(player, npc))
    ...
    public int greeter_dantooine_brother_rebel_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_f2356ea5"))
        {
            if (greeter_dantooine_brother_rebel_condition__defaultCondition(player, npc))
