...
public class racing_agrilat extends script.base_script
{
    ...
    public boolean racing_agrilat_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean racing_agrilat_condition_hasRaced(obj_id player, obj_id npc)
    {
        return (hasObjVar(player, "racing.bestTime.agrilat"));
    }
    public boolean racing_agrilat_condition_isRacing(obj_id player, obj_id npc)
    {
        return (getIntObjVar(player, "racing.agrilat.isRacing") == 1);
    }
    public boolean racing_agrilat_condition_hasLastTime(obj_id player, obj_id npc)
    {
        return (hasObjVar(player, "racing.lastTime.agrilat"));
    }
    public void racing_agrilat_action_registerPersonalBest(obj_id player, obj_id npc)
    {
    ...
    public void racing_agrilat_action_startRace(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        params.put("npc", npc);
    ...
    public void racing_agrilat_action_displayCurrentLeader(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        params.put("npc", npc);
    ...
    public void racing_agrilat_action_whatsMyBestTime(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        params.put("npc", npc);
    ...
    public void racing_agrilat_action_showBestTime(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        params.put("npc", npc);
    ...
    public void racing_agrilat_action_erasePersonalBest(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        params.put("npc", npc);
    ...
    public void racing_agrilat_action_abortRace(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
