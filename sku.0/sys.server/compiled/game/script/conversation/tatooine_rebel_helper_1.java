...
public class tatooine_rebel_helper_1 extends script.base_script
{
    ...
    public boolean tatooine_rebel_helper_1_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public int tatooine_rebel_helper_1_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
