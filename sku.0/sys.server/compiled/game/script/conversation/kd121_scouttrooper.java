...
public class kd121_scouttrooper extends script.base_script
{
    ...
    public boolean kd121_scouttrooper_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean kd121_scouttrooper_condition_gotShuttleParts(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "outbreak_quest_shuttle_parts");
    }
    public boolean kd121_scouttrooper_condition_rescuedAllSurvivors(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "outbreak_quest_rescue_04");
    }
    public boolean kd121_scouttrooper_condition_isNew(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean kd121_scouttrooper_condition_isRescuing(obj_id player, obj_id npc)
    {
    ...
    public boolean kd121_scouttrooper_condition_isShuttleParts(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "outbreak_quest_shuttle_parts");
    }
    public boolean kd121_scouttrooper_condition_hasRadio(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "outbreak_radio_delivery_03", "findEpsilonContact");
    }
    public int kd121_scouttrooper_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int kd121_scouttrooper_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int kd121_scouttrooper_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int kd121_scouttrooper_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int kd121_scouttrooper_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
