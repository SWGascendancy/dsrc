...
public class nova_orion_garrick_orion extends script.base_script
{
    ...
    public boolean nova_orion_garrick_orion_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean nova_orion_garrick_orion_condition_qualifiesForRank4Quests(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "nova_orion_rank1_03") && hasCompletedCollectionSlot(player, "orion_rank_01_04");
    }
    public boolean nova_orion_garrick_orion_condition_returnRank4_01(obj_id player, obj_id npc)
    {
    ...
    public boolean nova_orion_garrick_orion_condition_returnRank4_02(obj_id player, obj_id npc)
    {
    ...
    public boolean nova_orion_garrick_orion_condition_returnRank4_03(obj_id player, obj_id npc)
    {
    ...
    public boolean nova_orion_garrick_orion_condition_hasKatiarasToy(obj_id player, obj_id npc)
    {
    ...
    public boolean nova_orion_garrick_orion_condition_onRank4_01(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "no_rank4_orion_01");
    }
    public boolean nova_orion_garrick_orion_condition_onRank4_02(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "no_rank4_orion_02");
    }
    public boolean nova_orion_garrick_orion_condition_onRank4_03(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "no_rank4_orion_03");
    }
    public boolean nova_orion_garrick_orion_condition_qualifiesForRank5Quests(obj_id player, obj_id npc)
    {
    ...
    public boolean nova_orion_garrick_orion_condition_onRank5_01(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "no_rank5_01_orion");
    }
    public boolean nova_orion_garrick_orion_condition_onRank5_02(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "no_rank5_02_orion");
    }
    public boolean nova_orion_garrick_orion_condition_returnRank5_01(obj_id player, obj_id npc)
    {
    ...
    public boolean nova_orion_garrick_orion_condition_returnRank5_02(obj_id player, obj_id npc)
    {
    ...
    public boolean nova_orion_garrick_orion_condition_gaveKatiarasToy(obj_id player, obj_id npc)
    {
    ...
    public boolean nova_orion_garrick_orion_condition_gaveKatiarasToyNoRank(obj_id player, obj_id npc)
    {
        boolean result = false;
        if (!groundquests.isQuestActive(player, "orion_rank3_01") && !hasCompletedCollectionSlot(player, "orion_rank_01_03"))
        {
    ...
    public boolean nova_orion_garrick_orion_condition_preRank4GarrickBlurb(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "nova_rank3_01") && !hasCompletedCollectionSlot(player, "nova_rank_01_04");
    }
    public boolean nova_orion_garrick_orion_condition_onRank5Jonas_01(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "no_rank5_01");
    }
    public boolean nova_orion_garrick_orion_condition_onRank5Jonas_02(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "no_rank5_02");
    }
    public boolean nova_orion_garrick_orion_condition_completedRank5Jonas(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "no_rank5_02", "no_rank5_02_02") || groundquests.hasCompletedQuest(player, "no_rank5_02");
    }
    public boolean nova_orion_garrick_orion_condition_eligilbeForRank6Finale(obj_id player, obj_id npc)
    {
    ...
    public void nova_orion_garrick_orion_action_grantRank4_01(obj_id player, obj_id npc)
    {
    ...
    public void nova_orion_garrick_orion_action_grantRank4_02(obj_id player, obj_id npc)
    {
    ...
    public void nova_orion_garrick_orion_action_grantRank4_03(obj_id player, obj_id npc)
    {
    ...
    public void nova_orion_garrick_orion_action_sendRank4_03Signal(obj_id player, obj_id npc)
    {
    ...
    public void nova_orion_garrick_orion_action_sendRank4_02Signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "no_rank4_orion_02_02");
    }
    public void nova_orion_garrick_orion_action_sendRank4_01Signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "no_rank4_orion_01_02");
    }
    public void nova_orion_garrick_orion_action_grantRank5_01(obj_id player, obj_id npc)
    {
    ...
    public void nova_orion_garrick_orion_action_grantRank5_02(obj_id player, obj_id npc)
    {
    ...
    public void nova_orion_garrick_orion_action_sendRank5_01Signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "no_rank5_01_02");
    }
    public void nova_orion_garrick_orion_action_sendRank5_02Signal(obj_id player, obj_id npc)
    {
    ...
    public void nova_orion_garrick_orion_action_sendRank2_04Signal(obj_id player, obj_id npc)
    {
    ...
    public void nova_orion_garrick_orion_action_grantRank6Finale(obj_id player, obj_id npc)
    {
    ...
    public int nova_orion_garrick_orion_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nova_orion_garrick_orion_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nova_orion_garrick_orion_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nova_orion_garrick_orion_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nova_orion_garrick_orion_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nova_orion_garrick_orion_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nova_orion_garrick_orion_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
