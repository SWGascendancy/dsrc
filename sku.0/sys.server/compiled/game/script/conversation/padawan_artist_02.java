...
public class padawan_artist_02 extends script.base_script
{
    ...
    public boolean padawan_artist_02_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean padawan_artist_02_condition_isTrialPlayer(obj_id player, obj_id npc)
    {
    ...
    public void padawan_artist_02_action_setSpokeToNpc(obj_id player, obj_id npc)
    {
