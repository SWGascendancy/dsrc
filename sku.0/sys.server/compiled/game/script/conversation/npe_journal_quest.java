...
public class npe_journal_quest extends script.base_script
{
    ...
    public boolean npe_journal_quest_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_journal_quest_condition_isJournalActive(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "npe_journal_quest", "fight") && !groundquests.hasCompletedQuest(player, "npe_journal_quest"));
    }
    public boolean npe_journal_quest_condition_hasCompletedJournal(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_journal_quest");
    }
    public void npe_journal_quest_action_attack(obj_id player, obj_id npc)
    {
        setInvulnerable(npc, false);
        addHate(npc, player, 0.0f);
    }
    public int npe_journal_quest_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_journal_quest_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_journal_quest_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
