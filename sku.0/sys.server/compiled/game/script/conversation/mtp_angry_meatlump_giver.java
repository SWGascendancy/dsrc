...
public class mtp_angry_meatlump_giver extends script.base_script
{
    ...
    public boolean mtp_angry_meatlump_giver_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean mtp_angry_meatlump_giver_condition_alreadyHasQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "mtp_angry_meatlumps");
    }
    public boolean mtp_angry_meatlump_giver_condition_returningCompleteQuest(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "mtp_angry_meatlumps", "angry_meatlumps_02");
    }
    public boolean mtp_angry_meatlump_giver_condition_notYetReadyForAnother(obj_id player, obj_id npc)
    {
    ...
    public void mtp_angry_meatlump_giver_action_grantAngryQuest(obj_id player, obj_id npc)
    {
    ...
    public void mtp_angry_meatlump_giver_action_sendAngrySignal(obj_id player, obj_id npc)
    {
    ...
    public int mtp_angry_meatlump_giver_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
