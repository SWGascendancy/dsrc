...
public class nym_themepark_smuggler extends script.base_script
{
    ...
    public boolean nym_themepark_smuggler_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean nym_themepark_smuggler_condition_isReadyToGetChems(obj_id player, obj_id npc)
    {
    ...
    public boolean nym_themepark_smuggler_condition_hasChems(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "u16_nym_themepark_gather_chemicals", "goSeeSmuggler");
    }
    public boolean nym_themepark_smuggler_condition_deletedFixQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean nym_themepark_smuggler_condition_hasChemsQuestNotComplete(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "u16_nym_themepark_gather_chemicals", "needsToGatherChemical");
    }
    public void nym_themepark_smuggler_action_giveChemQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "u16_nym_themepark_gather_chemicals");
    }
    public void nym_themepark_smuggler_action_finishUpchem(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "hasSeenSmuggler");
    }
    public void nym_themepark_smuggler_action_finishUpJumper(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "hasFoundSmuggler");
    }
    public void nym_themepark_smuggler_action_giveFixQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "u16_nym_themepark_repair_mixing_chamber");
    }
    public int nym_themepark_smuggler_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_themepark_smuggler_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_themepark_smuggler_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_themepark_smuggler_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_themepark_smuggler_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_themepark_smuggler_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_themepark_smuggler_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_themepark_smuggler_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
