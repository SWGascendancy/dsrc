...
public class story_arc_chapter_three_scout extends script.base_script
{
    ...
    public boolean story_arc_chapter_three_scout_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean story_arc_chapter_three_scout_condition_readyToEnterOne(obj_id player, obj_id npc)
    {
    ...
    public boolean story_arc_chapter_three_scout_condition_readyToEnterAgain(obj_id player, obj_id npc)
    {
        if (instance.isFlaggedForInstance(player, "mustafar_droid_army"))
        {
            return true;
    ...
    public boolean story_arc_chapter_three_scout_condition_godModeWalkAround(obj_id player, obj_id npc)
    {
        return isGod(player);
    }
    public void story_arc_chapter_three_scout_action_sendGroupToBattlefield(obj_id player, obj_id npc)
    {
        instance.requestInstanceMovement(player, "mustafar_droid_army");
    }
    public int story_arc_chapter_three_scout_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int story_arc_chapter_three_scout_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int story_arc_chapter_three_scout_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
