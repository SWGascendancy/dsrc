...
public class som_diskret_stahn extends script.base_script
{
    ...
    public boolean som_diskret_stahn_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean som_diskret_stahn_condition_isEntertainer(obj_id player, obj_id npc)
    {
        return utils.isProfession(player, utils.ENTERTAINER);
    }
    public boolean som_diskret_stahn_condition_isMusician(obj_id player, obj_id npc)
    {
        return hasSkill(player, "social_musician_novice");
    }
    public boolean som_diskret_stahn_condition_hasSong(obj_id player, obj_id npc)
    {
        return hasCommand(player, "startMusic+calypso");
    }
    public void som_diskret_stahn_action_grantSong(obj_id player, obj_id npc)
    {
        sendSystemMessage(player, new string_id("som/som_quest", "grant_song"));
        grantCommand(player, "startMusic+calypso");
    }
    public int som_diskret_stahn_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_diskret_stahn_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_diskret_stahn_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_diskret_stahn_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_diskret_stahn_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_25"))
        {
            if (som_diskret_stahn_condition__defaultCondition(player, npc))
    ...
    public int som_diskret_stahn_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_diskret_stahn_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_diskret_stahn_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_diskret_stahn_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_diskret_stahn_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
