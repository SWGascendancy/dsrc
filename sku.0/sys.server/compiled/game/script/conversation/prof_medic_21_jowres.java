...
public class prof_medic_21_jowres extends script.base_script
{
    ...
    public boolean prof_medic_21_jowres_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean prof_medic_21_jowres_condition_playerOnCorrectStep(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "prof_medic_21", "talktojowres");
    }
    public boolean prof_medic_21_jowres_condition_playercompletedTask(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "prof_medic_21", "talktojowres");
    }
    public void prof_medic_21_jowres_action_givePassSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "prof_medic_21_jowres");
    }
    public void prof_medic_21_jowres_action_healnpc(obj_id player, obj_id npc)
    {
        playClientEffectObj(player, "clienteffect/prof_medic_21_heal2.cef", npc, "");
    }
    public int prof_medic_21_jowres_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int prof_medic_21_jowres_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int prof_medic_21_jowres_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
