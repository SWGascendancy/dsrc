...
public class ep3_kachirho_varactyl_egg extends script.base_script
{
    ...
    public boolean ep3_kachirho_varactyl_egg_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_kachirho_varactyl_egg_condition_hasMission(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_kachirho_varactyl_egg_condition_completedMission(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_kachirho_varactyl_egg");
    }
    public boolean ep3_kachirho_varactyl_egg_condition_isPreOrder(obj_id player, obj_id npc)
    {
        if (hasSkill(player, "outdoors_creaturehandler_master"))
        {
            return true;
        }
        return false;
    }
    public void ep3_kachirho_varactyl_egg_action_grantMission(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_kachirho_varactyl_egg");
    }
    public int ep3_kachirho_varactyl_egg_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_varactyl_egg_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_varactyl_egg_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_varactyl_egg_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_varactyl_egg_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
