...
public class camp_gamma_leader extends script.base_script
{
    ...
    public boolean camp_gamma_leader_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean camp_gamma_leader_condition_hasRadio(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "outbreak_radio_delivery_02", "findBossInCharge");
    }
    public boolean camp_gamma_leader_condition_hasCamera(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "outbreak_scout_camera_hidden_content", "hasCamera");
    }
    public void camp_gamma_leader_action_deliverRadioSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "hasFoundBossCampGamma");
    }
    public void camp_gamma_leader_action_hasDeliveredCamera(obj_id player, obj_id npc)
    {
    ...
    public int camp_gamma_leader_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int camp_gamma_leader_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int camp_gamma_leader_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int camp_gamma_leader_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int camp_gamma_leader_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int camp_gamma_leader_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int camp_gamma_leader_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int camp_gamma_leader_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int camp_gamma_leader_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
