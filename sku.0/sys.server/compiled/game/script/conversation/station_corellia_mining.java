...
public class station_corellia_mining extends script.base_script
{
    ...
    public boolean station_corellia_mining_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public void station_corellia_mining_action_sellResources(obj_id player, obj_id npc)
    {
        space_crafting.sellResourcesToSpaceStation(player, npc);
    }
    public int station_corellia_mining_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
