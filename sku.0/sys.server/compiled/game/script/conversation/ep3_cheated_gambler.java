...
public class ep3_cheated_gambler extends script.base_script
{
    ...
    public boolean ep3_cheated_gambler_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_cheated_gambler_condition_hasKilledJessk(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_stren_jessk_bounty");
    }
    public boolean ep3_cheated_gambler_condition_readyForJesskTip(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_stren_jessk_bounty", "speakWithCheated");
    }
    public boolean ep3_cheated_gambler_condition_hasJesskQuest(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_stren_jessk_bounty", "jesskTimer");
    }
    public void ep3_cheated_gambler_action_sendJesskSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "gotJesskDirections");
    }
    public int ep3_cheated_gambler_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_cheated_gambler_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_cheated_gambler_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_cheated_gambler_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_cheated_gambler_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_cheated_gambler_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_cheated_gambler_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_cheated_gambler_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_cheated_gambler_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
