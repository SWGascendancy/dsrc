...
public class victor_questp_hospital extends script.base_script
{
    ...
    public boolean victor_questp_hospital_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean victor_questp_hospital_condition_CampObjCheck(obj_id player, obj_id npc)
    {
    ...
    public boolean victor_questp_hospital_condition_alreadyHasEvidence(obj_id player, obj_id npc)
    {
        return utils.playerHasItemByTemplate(player, "object/tangible/loot/quest/victor_questp_receipt.iff");
    }
    public boolean victor_questp_hospital_condition_hasNoroomObjvar(obj_id player, obj_id npc)
    {
        if (hasObjVar(npc, "bestine.electionStarted"))
        {
            int electionNum = getIntObjVar(npc, "bestine.electionStarted");
    ...
    public boolean victor_questp_hospital_condition_nonoffice(obj_id player, obj_id npc)
    {
        return hasObjVar(npc, "bestine.electionEnded");
    }
    public boolean victor_questp_hospital_condition_noInventorySpace(obj_id player, obj_id npc)
    {
    ...
    public void victor_questp_hospital_action__defaultAction(obj_id player, obj_id npc)
    {
    }
    public void victor_questp_hospital_action_Noroom(obj_id player, obj_id npc)
    {
        setObjVar(player, "bestine.victor_hospital_noroom", true);
    }
    public void victor_questp_hospital_action_giveReceipt(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "bestine.victor_hospital_noroom"))
        {
