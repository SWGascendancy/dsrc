...
public class fs_medic_puzzle_head_medic extends script.base_script
{
    ...
    public boolean fs_medic_puzzle_head_medic_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean fs_medic_puzzle_head_medic_condition_ableToDoMedicQuest(obj_id player, obj_id npc)
    {
        return fs_quests.hasQuestAccepted(player);
    }
    public boolean fs_medic_puzzle_head_medic_condition_CanTalkToVillagers(obj_id player, obj_id npc)
    {
        return fs_quests.isVillageEligible(player);
    }
    public boolean fs_medic_puzzle_head_medic_condition_hasCompleted1(obj_id player, obj_id npc)
    {
    ...
    public boolean fs_medic_puzzle_head_medic_condition_hasCompleted2(obj_id player, obj_id npc)
    {
    ...
    public boolean fs_medic_puzzle_head_medic_condition_Finished(obj_id player, obj_id npc)
    {
        return quests.isComplete("fs_medic_puzzle_quest_finish", player);
    }
    public boolean fs_medic_puzzle_head_medic_condition_inProgress(obj_id player, obj_id npc)
    {
    ...
    public boolean fs_medic_puzzle_head_medic_condition_healedFirstSet(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "fs.numberHealed"))
        {
    ...
    public boolean fs_medic_puzzle_head_medic_condition_healedSecondSet(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "fs.numberHealed"))
        {
    ...
    public boolean fs_medic_puzzle_head_medic_condition_healedThirdSet(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "fs.numberHealed"))
        {
    ...
    public boolean fs_medic_puzzle_head_medic_condition_InventoryCheck(obj_id player, obj_id npc)
    {
    ...
    public boolean fs_medic_puzzle_head_medic_condition_haveMedicSkill(obj_id player, obj_id npc)
    {
        return hasSkill(player, "science_medic_master");
    }
    public void fs_medic_puzzle_head_medic_action_GiveQuest1(obj_id player, obj_id npc)
    {
    ...
    public void fs_medic_puzzle_head_medic_action_GiveDraftSchematic(obj_id player, obj_id npc)
    {
        grantSchematic(player, "object/draft_schematic/item/quest_item/fs_medic_puzzle_heal_pack.iff");
    }
    public void fs_medic_puzzle_head_medic_action_Complete1(obj_id player, obj_id npc)
    {
    ...
    public void fs_medic_puzzle_head_medic_action_Complete2(obj_id player, obj_id npc)
    {
    ...
    public void fs_medic_puzzle_head_medic_action_Complete3(obj_id player, obj_id npc)
    {
        obj_id playerInventory = utils.getInventoryContainer(player);
    ...
    public void fs_medic_puzzle_head_medic_action_GiveQuest2(obj_id player, obj_id npc)
    {
        quests.activate(MEDIC_QUEST_NAME_TWO, player, npc);
    }
    public void fs_medic_puzzle_head_medic_action_GiveQuest3(obj_id player, obj_id npc)
    {
        quests.activate(MEDIC_QUEST_NAME_THREE, player, npc);
    }
    public String fs_medic_puzzle_head_medic_tokenTO_NumberLeftToHeal(obj_id player, obj_id npc)
    {
        int peopleHealed = 0;
