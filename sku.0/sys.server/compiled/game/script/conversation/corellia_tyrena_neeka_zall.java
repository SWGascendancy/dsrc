...
public class corellia_tyrena_neeka_zall extends script.base_script
{
    ...
    public boolean corellia_tyrena_neeka_zall_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_tyrena_neeka_zall_condition_onTalkNeeka(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_tyrena_forgotten_child", "forgotten_talk_neeka");
    }
    public boolean corellia_tyrena_neeka_zall_condition_afterTalkNeeka(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "corellia_tyrena_forgotten_child", "forgotten_talk_neeka");
    }
    public void corellia_tyrena_neeka_zall_action_signalRescueNeeka(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "forgotten_talk_neeka");
    }
    public int corellia_tyrena_neeka_zall_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_neeka_zall_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
