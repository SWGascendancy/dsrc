...
public class crafting_contractor extends script.base_script
{
    ...
    public boolean crafting_contractor_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean crafting_contractor_condition_is_artisan(obj_id player, obj_id npc)
    {
        return hasSkill(player, "crafting_artisan_novice");
    }
    public boolean crafting_contractor_condition_is_armorsmith(obj_id player, obj_id npc)
    {
        return hasSkill(player, "crafting_armorsmith_novice");
    }
    public boolean crafting_contractor_condition_is_weaponsmith(obj_id player, obj_id npc)
    {
        return hasSkill(player, "crafting_weaponsmith_novice");
    }
    public boolean crafting_contractor_condition_is_chef(obj_id player, obj_id npc)
    {
        return hasSkill(player, "crafting_chef_novice");
    }
    public boolean crafting_contractor_condition_is_tailor(obj_id player, obj_id npc)
    {
        return hasSkill(player, "crafting_tailor_novice");
    }
    public boolean crafting_contractor_condition_is_architect(obj_id player, obj_id npc)
    {
        return hasSkill(player, "crafting_architect_novice");
    }
    public boolean crafting_contractor_condition_is_droidengineer(obj_id player, obj_id npc)
    {
        return hasSkill(player, "crafting_droidengineer_novice");
    }
    public boolean crafting_contractor_condition_can_do_med(obj_id player, obj_id npc)
    {
    ...
    public boolean crafting_contractor_condition_can_do_hard(obj_id player, obj_id npc)
    {
        String prof = utils.getStringScriptVar(player, "contract.profession");
        if (prof == null || prof.equals(""))
        {
    ...
    public boolean crafting_contractor_condition_is_inv_full(obj_id player, obj_id npc)
    {
    ...
    public boolean crafting_contractor_condition_has_box(obj_id player, obj_id npc)
    {
    ...
    public boolean crafting_contractor_condition_has_full_box(obj_id player, obj_id npc)
    {
        obj_id objInventory = utils.getInventoryContainer(player);
        if (isIdValid(objInventory))
        {
    ...
    public boolean crafting_contractor_condition_not_time_yet(obj_id player, obj_id npc)
    {
    ...
    public boolean crafting_contractor_condition_can_find_job(obj_id player, obj_id npc)
    {
    ...
    public void crafting_contractor_action_set_architect_var(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "contract.profession", "architect");
    }
    public void crafting_contractor_action_set_armorsmith_var(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "contract.profession", "armorsmith");
    }
    public void crafting_contractor_action_set_artisan_var(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "contract.profession", "artisan");
    }
    public void crafting_contractor_action_set_chef_var(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "contract.profession", "chef");
    }
    public void crafting_contractor_action_set_droidengineer_var(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "contract.profession", "droidengineer");
    }
    public void crafting_contractor_action_set_tailor_var(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "contract.profession", "tailor");
    }
    public void crafting_contractor_action_set_weaponsmith_var(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "contract.profession", "weaponsmith");
    }
    public void crafting_contractor_action_cleanup_vars(obj_id player, obj_id npc)
    {
    ...
    public void crafting_contractor_action_set_easy_var(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "contract.difficulty", "easy");
    }
    public void crafting_contractor_action_set_med_var(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "contract.difficulty", "medium");
    }
    public void crafting_contractor_action_set_hard_var(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "contract.difficulty", "hard");
    }
    public void crafting_contractor_action_cleanup_decline(obj_id player, obj_id npc)
    {
        utils.removeScriptVar(player, "contract.profession");
        utils.removeScriptVar(player, "contract.difficulty");
        utils.removeScriptVar(player, "contract.number");
    ...
    public void crafting_contractor_action_set_decline(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "contract.decline", getGameTime());
    }
    public void crafting_contractor_action_give_crate(obj_id player, obj_id npc)
    {
    ...
    public void crafting_contractor_action_take_box_quit(obj_id player, obj_id npc)
    {
        obj_id objInventory = utils.getInventoryContainer(player);
        if (isIdValid(objInventory))
        {
    ...
    public void crafting_contractor_action_job_done(obj_id player, obj_id npc)
    {
        obj_id objInventory = utils.getInventoryContainer(player);
        if (isIdValid(objInventory))
        {
    ...
    public String crafting_contractor_tokenTO_to_item(obj_id player, obj_id npc)
    {
        String itemName = utils.getStringScriptVar(player, "contract.item_name");
        utils.removeScriptVar(player, "contract.item_name");
        return itemName;
    }
    public int crafting_contractor_tokenDI_di_number(obj_id player, obj_id npc)
    {
        int r = rand(5, 10);
        utils.setScriptVar(player, "contract.number", r);
        return r;
    }
    public int crafting_contractor_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int crafting_contractor_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int crafting_contractor_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int crafting_contractor_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int crafting_contractor_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
