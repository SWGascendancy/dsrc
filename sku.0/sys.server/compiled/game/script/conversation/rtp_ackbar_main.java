...
public class rtp_ackbar_main extends script.base_script
{
    ...
    public boolean rtp_ackbar_main_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean rtp_ackbar_main_condition_rtp_ackbar_01_active(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "rtp_ackbar_01");
    }
    public boolean rtp_ackbar_main_condition_rtp_ackbar_01_complete(obj_id player, obj_id npc)
    {
    ...
    public boolean rtp_ackbar_main_condition_rtp_ackbar_02_active(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "rtp_ackbar_02");
    }
    public boolean rtp_ackbar_main_condition_rtp_ackbar_02_completed(obj_id player, obj_id npc)
    {
    ...
    public boolean rtp_ackbar_main_condition_completedHanSolo(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "rtp_han_solo_02");
    }
    public boolean rtp_ackbar_main_condition_notRebel(obj_id player, obj_id npc)
    {
    ...
    public boolean rtp_ackbar_main_condition_rebel_isOnLeave(obj_id player, obj_id npc)
    {
        return factions.isOnLeave(player);
    }
    public void rtp_ackbar_main_action_rtp_ackbar_01_granted(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "rtp_ackbar_01");
    }
    public void rtp_ackbar_main_action_rtp_ackbar_01_signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "rtp_ackbar_01_02");
    }
    public void rtp_ackbar_main_action_rtp_ackbar_02_signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "rtp_ackbar_02_02");
    }
    public void rtp_ackbar_main_action_rtp_ackbar_02_granted(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "rtp_ackbar_02");
    }
    public int rtp_ackbar_main_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rtp_ackbar_main_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
