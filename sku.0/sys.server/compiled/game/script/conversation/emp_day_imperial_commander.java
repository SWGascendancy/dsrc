...
public class emp_day_imperial_commander extends script.base_script
{
    ...
    public boolean emp_day_imperial_commander_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean emp_day_imperial_commander_condition_isRebel(obj_id player, obj_id npc)
    {
    ...
    public boolean emp_day_imperial_commander_condition_notReadyForYou(obj_id player, obj_id npc)
    {
    ...
    public boolean emp_day_imperial_commander_condition_questCompleted(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/emp_day_imperial");
        return questIsQuestComplete(questId, player);
    }
    public boolean emp_day_imperial_commander_condition_hasTask6(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/emp_day_imperial");
    ...
    public boolean emp_day_imperial_commander_condition_isNeutral(obj_id player, obj_id npc)
    {
        int factionHashCode = factions.pvpGetAlignedFaction(player);
        String whichFaction = factions.getFactionNameByHashCode(factionHashCode);
        if (whichFaction == null)
    ...
    public boolean emp_day_imperial_commander_condition_hasTask8(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/emp_day_imperial");
        int task8 = groundquests.getTaskId(questId, "empDayComplete");
        return questIsTaskActive(questId, task8, player);
    }
    public boolean emp_day_imperial_commander_condition_isImperial(obj_id player, obj_id npc)
    {
        int factionHashCode = factions.pvpGetAlignedFaction(player);
        String whichFaction = factions.getFactionNameByHashCode(factionHashCode);
        if (whichFaction == null)
    ...
    public boolean emp_day_imperial_commander_condition_hasTask7(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/emp_day_imperial");
        int task7 = groundquests.getTaskId(questId, "toVader");
        int factionHashCode = factions.pvpGetAlignedFaction(player);
    ...
    public boolean emp_day_imperial_commander_condition_noPrisonAccess(obj_id player, obj_id npc)
    {
        return (!hasObjVar(player, "event.emp_day.prisoner"));
    }
    public void emp_day_imperial_commander_action_rewardAndEndNow(obj_id player, obj_id npc)
    {
    ...
    public void emp_day_imperial_commander_action_givePrisonerAccess(obj_id player, obj_id npc)
    {
        setObjVar(player, "event.emp_day.prisoner", 0);
    }
    public void emp_day_imperial_commander_action_signal6(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "to_commander");
    }
    public int emp_day_imperial_commander_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_imperial_commander_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_imperial_commander_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_imperial_commander_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_imperial_commander_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_imperial_commander_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_imperial_commander_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_imperial_commander_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_imperial_commander_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_403"))
        {
            if (emp_day_imperial_commander_condition__defaultCondition(player, npc))
    ...
    public int emp_day_imperial_commander_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_imperial_commander_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_389"))
        {
            if (emp_day_imperial_commander_condition_isImperial(player, npc))
    ...
    public int emp_day_imperial_commander_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
