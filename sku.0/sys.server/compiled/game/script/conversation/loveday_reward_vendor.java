...
public class loveday_reward_vendor extends script.base_script
{
    ...
    public boolean loveday_reward_vendor_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public void loveday_reward_vendor_action_showResourceVendorUI(obj_id player, obj_id npc)
    {
    ...
    public String loveday_reward_vendor_tokenTO_tokenTO0001(obj_id player, obj_id npc)
    {
        return new String();
    }
