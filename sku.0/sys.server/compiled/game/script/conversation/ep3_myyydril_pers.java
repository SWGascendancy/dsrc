...
public class ep3_myyydril_pers extends script.base_script
{
    ...
    public boolean ep3_myyydril_pers_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_myyydril_pers_condition_hasSkillSmug(obj_id player, obj_id npc)
    {
        return hasSkill(player, "class_smuggler_phase1_novice");
    }
    public boolean ep3_myyydril_pers_condition_isTaskActiveOne(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_myyydril_pers_condition_isTaskCompleteOne(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_myyydril_pers_condition_hasCompletedQuestOne(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_myyydril_pers_retrieve_4");
    }
    public void ep3_myyydril_pers_action_giveQuestOne(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_myyydril_pers_retrieve_4");
    }
    public void ep3_myyydril_pers_action_giveSignalOne(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "giveLewtSmug");
    }
    public int ep3_myyydril_pers_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_pers_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_pers_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_pers_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_pers_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_pers_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_pers_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_pers_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_pers_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_pers_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
