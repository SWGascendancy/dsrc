...
public class ep3_quest_template extends script.base_script
{
    ...
    public boolean ep3_quest_template_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_quest_template_condition_hasCompletedAllQuests(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_quest_template_condition_hasCompletedQuestOne(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedQuest(player, "ep3_neutral_sera_collect_wrhisch_liver"));
    }
    public boolean ep3_quest_template_condition_hasCompletedQuestTwo(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedQuest(player, "ep3_neutral_sera_kill_10_wookiee"));
    }
    public boolean ep3_quest_template_condition_isOnQuestOne(obj_id player, obj_id npc)
    {
        return (groundquests.isQuestActive(player, "ep3_neutral_sera_collect_wrhisch_liver"));
    }
    public boolean ep3_quest_template_condition_isOnQuestTwo(obj_id player, obj_id npc)
    {
        return (groundquests.isQuestActive(player, "ep3_neutral_sera_kill_10_wookiee"));
    }
    public void ep3_quest_template_action_grantQuestOne(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_neutral_sera_collect_wrhisch_liver");
    }
    public void ep3_quest_template_action_grantQuestTwo(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_neutral_sera_kill_10_wookiee");
    }
    public int ep3_quest_template_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_quest_template_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_quest_template_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_quest_template_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
