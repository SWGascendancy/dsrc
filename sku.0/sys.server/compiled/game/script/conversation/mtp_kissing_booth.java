...
public class mtp_kissing_booth extends script.base_script
{
    ...
    public boolean mtp_kissing_booth_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean mtp_kissing_booth_condition_hasBuffAlready(obj_id player, obj_id npc)
    {
    ...
    public int mtp_kissing_booth_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_kissing_booth_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_kissing_booth_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_kissing_booth_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
