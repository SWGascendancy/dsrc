...
public class talus_nashal_tika extends script.base_script
{
    ...
    public boolean talus_nashal_tika_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean talus_nashal_tika_condition_onGatherMissions(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "talus_nashal_find_weakness", "selonian_gather_missions");
    }
    public boolean talus_nashal_tika_condition_onExploit(obj_id player, obj_id npc)
    {
    ...
    public boolean talus_nashal_tika_condition_onReturnTika(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "talus_nashal_exploit_weakness", "selonian_return_tika");
    }
    public boolean talus_nashal_tika_condition_completeExploit(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "talus_nashal_exploit_weakness");
    }
    public void talus_nashal_tika_action_grantExploit(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "talus_nashal_exploit_weakness");
    }
    public void talus_nashal_tika_action_signalCompleteExploit(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "selonian_return_tika");
    }
    public int talus_nashal_tika_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_tika_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_tika_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_tika_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_tika_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
