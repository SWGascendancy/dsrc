...
public class quest_hero_of_tatooine_bounty_hunter extends script.base_script
{
    ...
    public boolean quest_hero_of_tatooine_bounty_hunter_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean quest_hero_of_tatooine_bounty_hunter_condition_complete(obj_id player, obj_id npc)
    {
    ...
    public boolean quest_hero_of_tatooine_bounty_hunter_condition_failed(obj_id player, obj_id npc)
    {
    ...
    public boolean quest_hero_of_tatooine_bounty_hunter_condition_in_progress(obj_id player, obj_id npc)
    {
    ...
    public boolean quest_hero_of_tatooine_bounty_hunter_condition_quest_done(obj_id player, obj_id npc)
    {
    ...
    public void quest_hero_of_tatooine_bounty_hunter_action_set_help(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "quest.hero_of_tatooine.intellect.in_progress", 1);
    }
    public void quest_hero_of_tatooine_bounty_hunter_action_point_him_out(obj_id player, obj_id npc)
    {
    ...
    public String quest_hero_of_tatooine_bounty_hunter_tokenTO_smuggler_leader(obj_id player, obj_id npc)
    {
        obj_id control = getObjIdObjVar(npc, "quest.hero_of_tatooine.intellect.spawner.controller");
    ...
    public int quest_hero_of_tatooine_bounty_hunter_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_hero_of_tatooine_bounty_hunter_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_hero_of_tatooine_bounty_hunter_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_hero_of_tatooine_bounty_hunter_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_hero_of_tatooine_bounty_hunter_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_hero_of_tatooine_bounty_hunter_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_hero_of_tatooine_bounty_hunter_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_hero_of_tatooine_bounty_hunter_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_hero_of_tatooine_bounty_hunter_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_hero_of_tatooine_bounty_hunter_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_hero_of_tatooine_bounty_hunter_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_hero_of_tatooine_bounty_hunter_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_df981c5e"))
        {
            if (quest_hero_of_tatooine_bounty_hunter_condition__defaultCondition(player, npc))
    ...
    public int quest_hero_of_tatooine_bounty_hunter_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_b8f4813d"))
        {
            if (quest_hero_of_tatooine_bounty_hunter_condition__defaultCondition(player, npc))
