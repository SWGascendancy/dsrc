...
public class ep3_clone_relics_queen_wookie_informant_1 extends script.base_script
{
    ...
    public boolean ep3_clone_relics_queen_wookie_informant_1_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_clone_relics_queen_wookie_informant_1_condition_isWookie(obj_id player, obj_id npc)
    {
        return (getSpecies(player) == SPECIES_WOOKIEE);
    }
    public boolean ep3_clone_relics_queen_wookie_informant_1_condition_onQuestOne(obj_id player, obj_id npc)
    {
        return (groundquests.isQuestActive(player, "ep3_clone_relics_queen_1"));
    }
    public boolean ep3_clone_relics_queen_wookie_informant_1_condition_completedQuestOne(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedQuest(player, "ep3_clone_relics_queen_1"));
    }
    public boolean ep3_clone_relics_queen_wookie_informant_1_condition_knowWookie(obj_id player, obj_id npc)
    {
        return utils.canSpeakWookiee(player, npc);
    }
    public boolean ep3_clone_relics_queen_wookie_informant_1_condition_escortTaskActive(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "ep3_clone_relics_queen_1", "escortWookie"));
    }
    public void ep3_clone_relics_queen_wookie_informant_1_action_signalTalked(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedToWookie");
    }
    public void ep3_clone_relics_queen_wookie_informant_1_action_cantUnderstand(obj_id player, obj_id npc)
    {
        utils.emoteWookieeConfusion(player, npc);
    }
    public int ep3_clone_relics_queen_wookie_informant_1_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_queen_wookie_informant_1_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_queen_wookie_informant_1_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_queen_wookie_informant_1_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_queen_wookie_informant_1_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_queen_wookie_informant_1_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_queen_wookie_informant_1_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_queen_wookie_informant_1_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
