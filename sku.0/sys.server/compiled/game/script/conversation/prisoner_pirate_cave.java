...
public class prisoner_pirate_cave extends script.base_script
{
    ...
    public boolean prisoner_pirate_cave_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean prisoner_pirate_cave_condition_hasRescueTask(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean prisoner_pirate_cave_condition_isTravelingWithOwner(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean prisoner_pirate_cave_condition_hasArrived(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean prisoner_pirate_cave_condition_isTraveling(obj_id player, obj_id npc)
    {
        return getIntObjVar(npc, "traveling") == 1;
    }
    public void prisoner_pirate_cave_action_startEscort(obj_id player, obj_id npc)
    {
    ...
    public void prisoner_pirate_cave_action_walkFaster(obj_id player, obj_id npc)
    {
        setMovementRun(npc);
        setBaseRunSpeed(npc, (getBaseRunSpeed(npc) - 8));
        ai_lib.aiFollow(npc, player, 1.0f, 3.0f);
    }
    public int prisoner_pirate_cave_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int prisoner_pirate_cave_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int handleUpdatePrisonerRescueQuest(obj_id self, dictionary params)
    {
        if (!isValidId(self))
        {
    ...
    public int checkArrivalLoopHandler(obj_id self, dictionary params)
    {
        setMovementRun(self);
    ...
    public boolean callShuttle(obj_id self, obj_id player)
    {
    ...
    public boolean tellMomIDied(obj_id self)
    {
        if (!isValidId(self))
        {
            return false;
    ...
    public boolean failRescueQuest(obj_id self)
    {
        obj_id player = getObjIdObjVar(self, "playerOwner");
        if (!isValidId(player))
        {
