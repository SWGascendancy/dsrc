...
public class refugee_biologist extends script.base_script
{
    ...
    public boolean refugee_biologist_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean refugee_biologist_condition_isProlog(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "quest_08_dathomir_outpost_final");
    }
    public void refugee_biologist_action_updateProlog(obj_id player, obj_id npc)
    {
    ...
    public int refugee_biologist_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int refugee_biologist_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
