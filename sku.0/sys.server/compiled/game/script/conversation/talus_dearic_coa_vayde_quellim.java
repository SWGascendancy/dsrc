...
public class talus_dearic_coa_vayde_quellim extends script.base_script
{
    ...
    public boolean talus_dearic_coa_vayde_quellim_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean talus_dearic_coa_vayde_quellim_condition_supplies_deliverable(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "talus_dearic_coa_rebel_view_end", "talus_dearic_coa_med_supplies_delivered_wfs");
    }
    public boolean talus_dearic_coa_vayde_quellim_condition_rebel_quest_accepted(obj_id player, obj_id npc)
    {
    ...
    public boolean talus_dearic_coa_vayde_quellim_condition_rebel_quest_complete(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "talus_dearic_coa_rebel_view_end");
    }
    public boolean talus_dearic_coa_vayde_quellim_condition_rebel_tasks_complete(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "talus_dearic_coa_rebel_view_end", "talus_dearic_coa_rebel_gratitude_wfs");
    }
    public boolean talus_dearic_coa_vayde_quellim_condition_main_quest_accepted(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "talus_dearic_crisis_of_allegiance");
    }
    public void talus_dearic_coa_vayde_quellim_action_accept_rebel_quest(obj_id player, obj_id npc)
    {
    ...
    public void talus_dearic_coa_vayde_quellim_action_deliver_supplies(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talus_dearic_coa_med_supplies_delivered");
    }
    public void talus_dearic_coa_vayde_quellim_action_complete_rebel_quests(obj_id player, obj_id npc)
    {
    ...
    public int talus_dearic_coa_vayde_quellim_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_coa_vayde_quellim_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_coa_vayde_quellim_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_coa_vayde_quellim_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_coa_vayde_quellim_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_coa_vayde_quellim_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_coa_vayde_quellim_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_coa_vayde_quellim_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_coa_vayde_quellim_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_coa_vayde_quellim_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_coa_vayde_quellim_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_coa_vayde_quellim_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_coa_vayde_quellim_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_68"))
        {
            doAnimationAction(player, "explain");
