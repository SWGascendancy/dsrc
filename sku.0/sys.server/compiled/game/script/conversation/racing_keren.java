...
public class racing_keren extends script.base_script
{
    ...
    public boolean racing_keren_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean racing_keren_condition_hasRaced(obj_id player, obj_id npc)
    {
        return (hasObjVar(player, "racing.bestTime.keren"));
    }
    public boolean racing_keren_condition_isRacing(obj_id player, obj_id npc)
    {
        return (getIntObjVar(player, "racing.keren.isRacing") == 1);
    }
    public boolean racing_keren_condition_hasLastTime(obj_id player, obj_id npc)
    {
        return (hasObjVar(player, "racing.lastTime.keren"));
    }
    public void racing_keren_action_registerPersonalBest(obj_id player, obj_id npc)
    {
    ...
    public void racing_keren_action_startRace(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        params.put("npc", npc);
    ...
    public void racing_keren_action_displayCurrentLeader(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        params.put("npc", npc);
    ...
    public void racing_keren_action_whatsMyBestTime(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        params.put("npc", npc);
    ...
    public void racing_keren_action_showBestTime(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        params.put("npc", npc);
    ...
    public void racing_keren_action_erasePersonalBest(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        params.put("npc", npc);
    ...
    public void racing_keren_action_abortRace(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
