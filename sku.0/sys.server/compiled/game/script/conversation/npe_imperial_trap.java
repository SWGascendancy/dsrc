...
public class npe_imperial_trap extends script.base_script
{
    ...
    public boolean npe_imperial_trap_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_imperial_trap_condition_hasSmugglerQuest(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_smuggler_try", "rightChoice");
    }
    public boolean npe_imperial_trap_condition_onDarkForceStep(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_force_dark", "stormtrooper");
    }
    public void npe_imperial_trap_action_giveTrapsignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "goodOne");
    }
    public void npe_imperial_trap_action_giveMyselfsignal(obj_id player, obj_id npc)
    {
        messageTo(npc, "help", null, 1, false);
    }
    public void npe_imperial_trap_action_incap4tw(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "goodOne");
        doAnimationAction(npc, "cough_heavy");
        messageTo(npc, "help", null, 1, false);
    }
    public void npe_imperial_trap_action_animPunch(obj_id player, obj_id npc)
    {
        doAnimationAction(player, "cbt_unarmed_prone_punch");
    }
    public void npe_imperial_trap_action_completeDarkForceQuest(obj_id player, obj_id npc)
    {
        setObjVar(player, "npe.finishedTemplate", 1);
        groundquests.sendSignal(player, "npe_force_done_signal");
    }
    public int npe_imperial_trap_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_imperial_trap_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_imperial_trap_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_imperial_trap_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_imperial_trap_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_imperial_trap_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_imperial_trap_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_imperial_trap_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_imperial_trap_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_imperial_trap_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
