...
public class naboo_boss_nass extends script.base_script
{
    ...
    public boolean naboo_boss_nass_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean naboo_boss_nass_condition_onArtifactMauler(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "naboo_boss_nass_artifacts_mauler");
    }
    public boolean naboo_boss_nass_condition_sentToBossNass(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_boss_nass_condition_finishedArtifactMauler(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_boss_nass_condition_onArtifactSkaak(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "naboo_boss_nass_artifacts_skaak");
    }
    public boolean naboo_boss_nass_condition_finishedArtifactSkaak(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_boss_nass_condition_onArtifactMuskeg(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "naboo_boss_nass_artifacts_muskeg");
    }
    public boolean naboo_boss_nass_condition_finishedArtifactMuskeg(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_boss_nass_condition_onArtifactDarkwalker(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "naboo_boss_nass_artifacts_darkwalker");
    }
    public boolean naboo_boss_nass_condition_finishedArtifactDarkwalker(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_boss_nass_condition_onArtifactScattered(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "naboo_boss_nass_artifacts_scattered");
    }
    public boolean naboo_boss_nass_condition_finishedArtifactScattered(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_boss_nass_condition_onPasscodeRecon(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "naboo_boss_nass_password_recon");
    }
    public boolean naboo_boss_nass_condition_finishedPasscodeRecon(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_boss_nass_condition_finishedPasscodeCode(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_boss_nass_condition_onPasscodeCode(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "naboo_boss_nass_password_code");
    }
    public boolean naboo_boss_nass_condition_gettingDroidPart(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "legacy_naboo_droid_module_4", "findDroidPart4_03");
    }
    public boolean naboo_boss_nass_condition_hasDroidPart(obj_id player, obj_id npc)
    {
    ...
    public void naboo_boss_nass_action_grantArtifactMauler(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "findDroidPart4_01");
        groundquests.requestGrantQuest(player, "naboo_boss_nass_artifacts_mauler");
    }
    public void naboo_boss_nass_action_grantArtifactSkaak(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "naboo_boss_nass_artifacts_skaak");
    }
    public void naboo_boss_nass_action_grantArtifactMuskeg(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "naboo_boss_nass_artifacts_muskeg");
    }
    public void naboo_boss_nass_action_grantArtifactDarkwalker(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "naboo_boss_nass_artifacts_darkwalker");
    }
    public void naboo_boss_nass_action_grantArtifactScattered(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "naboo_boss_nass_artifacts_scattered");
    }
    public void naboo_boss_nass_action_signal_scattered_02(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "boss_nass_artifacts_scattered_02");
        groundquests.sendSignal(player, "findDroidPart4_01");
    }
    public void naboo_boss_nass_action_endArtifactDarkwalker(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "boss_nass_artifacts_darkwalker_04");
        groundquests.sendSignal(player, "findDroidPart4_01");
    }
    public void naboo_boss_nass_action_endArtifactMuskeg(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "boss_nass_artifacts_muskeg_05");
        groundquests.sendSignal(player, "findDroidPart4_01");
    }
    public void naboo_boss_nass_action_endArtifactSkaak(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "boss_nass_artifacts_skaak_07");
        groundquests.sendSignal(player, "findDroidPart4_01");
    }
    public void naboo_boss_nass_action_endArtifactMauler(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "boss_nass_mauler_06");
        groundquests.sendSignal(player, "findDroidPart4_01");
    }
    public void naboo_boss_nass_action_grantPasscodeRecon(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "naboo_boss_nass_password_recon");
    }
    public void naboo_boss_nass_action_endPasscodeRecon(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "boss_nass_password_recon_04");
        groundquests.sendSignal(player, "findDroidPart4_01");
    }
    public void naboo_boss_nass_action_grantPasscodeCode(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "naboo_boss_nass_password_code");
    }
    public void naboo_boss_nass_action_endPasscodeCode(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "boss_nass_password_code_06");
        groundquests.sendSignal(player, "findDroidPart4_01");
    }
    public void naboo_boss_nass_action_codeForDroidPart(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "findDroidPart4_02");
    }
    public int naboo_boss_nass_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_boss_nass_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_boss_nass_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_boss_nass_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_boss_nass_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_boss_nass_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_boss_nass_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_boss_nass_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_boss_nass_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_boss_nass_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_boss_nass_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
