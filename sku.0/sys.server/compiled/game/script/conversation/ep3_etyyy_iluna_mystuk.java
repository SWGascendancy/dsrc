...
public class ep3_etyyy_iluna_mystuk extends script.base_script
{
    ...
    public boolean ep3_etyyy_iluna_mystuk_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_etyyy_iluna_mystuk_condition_killedGreyclimberPlusAll(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_etyyy_iluna_mystuk_condition_killedGreyclimber(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_hunt_loot_greyclimber_killed");
    }
    public boolean ep3_etyyy_iluna_mystuk_condition_doesNotHaveBrodyQuest(obj_id player, obj_id npc)
    {
    ...
    public void ep3_etyyy_iluna_mystuk_action_greyclimberReward(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "lootQuest_defeatedGreyclimber");
    }
    public void ep3_etyyy_iluna_mystuk_action_greyclimberRewardPlusAll(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "lootQuest_defeatedGreyclimber");
        groundquests.grantQuest(player, "ep3_hunt_loot_completed_all");
    }
    public void ep3_etyyy_iluna_mystuk_action_sendToArconaCamp(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_hunt_iluna_goto_arcona_camp");
    }
    public int ep3_etyyy_iluna_mystuk_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_iluna_mystuk_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
