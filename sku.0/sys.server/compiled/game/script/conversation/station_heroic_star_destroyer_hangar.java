...
public class station_heroic_star_destroyer_hangar extends script.base_script
{
    ...
    public boolean station_heroic_star_destroyer_hangar_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean station_heroic_star_destroyer_hangar_condition_tooFar(obj_id player, obj_id npc)
    {
    ...
    public void station_heroic_star_destroyer_hangar_action_moveToSD(obj_id player, obj_id npc)
    {
    ...
    public int station_heroic_star_destroyer_hangar_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
