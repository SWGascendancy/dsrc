...
public class mtp_meatlump_king extends script.base_script
{
    ...
    public boolean mtp_meatlump_king_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean mtp_meatlump_king_condition_readyforAct2Story(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_meatlump_king_condition_blurb01(obj_id player, obj_id npc)
    {
        return utils.getIntScriptVar(player, "mtp_meatlumpKingBlurb") == 1;
    }
    public boolean mtp_meatlump_king_condition_blurb02(obj_id player, obj_id npc)
    {
        return utils.getIntScriptVar(player, "mtp_meatlumpKingBlurb") == 2;
    }
    public boolean mtp_meatlump_king_condition_blurb03(obj_id player, obj_id npc)
    {
        return utils.getIntScriptVar(player, "mtp_meatlumpKingBlurb") == 3;
    }
    public boolean mtp_meatlump_king_condition_blurb04(obj_id player, obj_id npc)
    {
        return utils.getIntScriptVar(player, "mtp_meatlumpKingBlurb") == 4;
    }
    public boolean mtp_meatlump_king_condition_blurb05(obj_id player, obj_id npc)
    {
        return utils.getIntScriptVar(player, "mtp_meatlumpKingBlurb") == 5;
    }
    public boolean mtp_meatlump_king_condition_blurb06(obj_id player, obj_id npc)
    {
        return utils.getIntScriptVar(player, "mtp_meatlumpKingBlurb") == 6;
    }
    public boolean mtp_meatlump_king_condition_blurb07(obj_id player, obj_id npc)
    {
        return utils.getIntScriptVar(player, "mtp_meatlumpKingBlurb") == 7;
    }
    public boolean mtp_meatlump_king_condition_blurb08(obj_id player, obj_id npc)
    {
        return utils.getIntScriptVar(player, "mtp_meatlumpKingBlurb") == 8;
    }
    public boolean mtp_meatlump_king_condition_blurb09(obj_id player, obj_id npc)
    {
        return utils.getIntScriptVar(player, "mtp_meatlumpKingBlurb") == 9;
    }
    public boolean mtp_meatlump_king_condition_blurb10(obj_id player, obj_id npc)
    {
        return utils.getIntScriptVar(player, "mtp_meatlumpKingBlurb") == 10;
    }
    public boolean mtp_meatlump_king_condition_blurb11(obj_id player, obj_id npc)
    {
        return utils.getIntScriptVar(player, "mtp_meatlumpKingBlurb") == 11;
    }
    public boolean mtp_meatlump_king_condition_blurb12(obj_id player, obj_id npc)
    {
        return utils.getIntScriptVar(player, "mtp_meatlumpKingBlurb") == 12;
    }
    public boolean mtp_meatlump_king_condition_blurb_rare(obj_id player, obj_id npc)
    {
        return utils.getIntScriptVar(player, "mtp_meatlumpKingBlurb") == 9999;
    }
    public void mtp_meatlump_king_action_grantAct2Story(obj_id player, obj_id npc)
    {
    ...
    public void mtp_meatlump_king_action_setEmperorAppearance(obj_id player, obj_id npc)
    {
    ...
    public int mtp_meatlump_king_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_meatlump_king_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int handlePointToSelf(obj_id self, dictionary params)
    {
        doAnimationAction(self, "point_to_self");
        return SCRIPT_CONTINUE;
    }
    public int handleResetMeatlumpKingAppearance(obj_id self, dictionary params)
    {
