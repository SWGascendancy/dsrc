...
public class itp_kaja_main extends script.base_script
{
    ...
    public boolean itp_kaja_main_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean itp_kaja_main_condition_itp_kaja_01_active(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "itp_kaja_01");
    }
    public boolean itp_kaja_main_condition_itp_kaja_01_complete(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "itp_kaja_01", "itp_kaja_01_04") || groundquests.hasCompletedQuest(player, "itp_kaja_01");
    }
    public boolean itp_kaja_main_condition_itp_kaja_02_active(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "itp_kaja_02");
    }
    public boolean itp_kaja_main_condition_playerLevelCheck(obj_id player, obj_id npc)
    {
        return (getLevel(player) < 80);
    }
    public boolean itp_kaja_main_condition_itp_kaja_02_complete(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "itp_kaja_02", "itp_kaja_02_03") || groundquests.hasCompletedQuest(player, "itp_kaja_02");
    }
    public boolean itp_kaja_main_condition_notImperial(obj_id player, obj_id npc)
    {
    ...
    public boolean itp_kaja_main_condition_imperial_isOnLeave(obj_id player, obj_id npc)
    {
        return factions.isOnLeave(player);
    }
    public void itp_kaja_main_action_itp_kaja_01_granted(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "itp_kaja_01");
    }
    public void itp_kaja_main_action_itp_kaja_01_signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "itp_kaja_01_04");
    }
    public void itp_kaja_main_action_itp_kaja_02_signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "itp_kaja_02_03");
    }
    public void itp_kaja_main_action_itp_kaja_02_granted(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "itp_kaja_02");
    }
    public int itp_kaja_main_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int itp_kaja_main_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
