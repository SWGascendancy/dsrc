...
public class heraldnaboo extends script.base_script
{
    ...
    public boolean heraldnaboo_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public void heraldnaboo_action_waypoint1(obj_id player, obj_id npc)
    {
    ...
    public void heraldnaboo_action_waypoint2(obj_id player, obj_id npc)
    {
    ...
    public void heraldnaboo_action_waypoint3(obj_id player, obj_id npc)
    {
    ...
    public void heraldnaboo_action_no(obj_id player, obj_id npc)
    {
        doAnimationAction(npc, "shake_head_no");
    }
    public void heraldnaboo_action_nod(obj_id player, obj_id npc)
    {
        doAnimationAction(npc, "nod_head_once");
    }
    public void heraldnaboo_action_implore(obj_id player, obj_id npc)
    {
        doAnimationAction(npc, "implore");
    }
    public void heraldnaboo_action_wave(obj_id player, obj_id npc)
    {
        doAnimationAction(npc, "wave1");
    }
    public void heraldnaboo_action_curtsey(obj_id player, obj_id npc)
    {
        doAnimationAction(npc, "curtsey1");
    }
    public void heraldnaboo_action_dismiss(obj_id player, obj_id npc)
    {
        doAnimationAction(npc, "wave_on_dismissing");
    }
    public void heraldnaboo_action_shush(obj_id player, obj_id npc)
    {
        doAnimationAction(npc, "shush");
    }
    public int heraldnaboo_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int heraldnaboo_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int heraldnaboo_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int heraldnaboo_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int heraldnaboo_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int heraldnaboo_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int heraldnaboo_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int heraldnaboo_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int heraldnaboo_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int heraldnaboo_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int heraldnaboo_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
