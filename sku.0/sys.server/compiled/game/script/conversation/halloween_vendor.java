...
public class halloween_vendor extends script.base_script
{
    ...
    public boolean halloween_vendor_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean halloween_vendor_condition_costumeLockout(obj_id player, obj_id npc)
    {
    ...
    public boolean halloween_vendor_condition_costumeAlready(obj_id player, obj_id npc)
    {
    ...
    public boolean halloween_vendor_condition_godMode(obj_id player, obj_id npc)
    {
        return (isGod(player));
    }
    public boolean halloween_vendor_condition_doesntHaveThree(obj_id player, obj_id npc)
    {
    ...
    public boolean halloween_vendor_condition_canBuyThree(obj_id player, obj_id npc)
    {
    ...
    public boolean halloween_vendor_condition_hasDevice(obj_id player, obj_id npc)
    {
    ...
    public boolean halloween_vendor_condition_noBadge(obj_id player, obj_id npc)
    {
    ...
    public boolean halloween_vendor_condition_canBuyBadge(obj_id player, obj_id npc)
    {
        obj_id[] coins = utils.getAllStaticItemsInPlayerInventory(player, "item_event_halloween_coin");
        if (coins != null && coins.length > 0)
        {
    ...
    public boolean halloween_vendor_condition_playerStealthed(obj_id player, obj_id npc)
    {
    ...
    public boolean halloween_vendor_condition_outOfRange(obj_id player, obj_id npc)
    {
    ...
    public void halloween_vendor_action_showTokenVendorUI(obj_id player, obj_id npc)
    {
    ...
    public void halloween_vendor_action_applyCostume(obj_id player, obj_id npc)
    {
        obj_id inventory = utils.getInventoryContainer(player);
    ...
    public void halloween_vendor_action_removeLockout(obj_id player, obj_id npc)
    {
    ...
    public void halloween_vendor_action_grantProjectorThree(obj_id player, obj_id npc)
    {
    ...
    public void halloween_vendor_action_grantCoins(obj_id player, obj_id npc)
    {
    ...
    public void halloween_vendor_action_removeProjectorLockout(obj_id player, obj_id npc)
    {
        if (hasCompletedCollectionSlot(player, "received_halloween_reward"))
        {
            modifyCollectionSlotValue(player, "received_halloween_reward", -1);
    ...
    public void halloween_vendor_action_badgePurchased(obj_id player, obj_id npc)
    {
        obj_id inventory = utils.getInventoryContainer(player);
        obj_id[] inventoryContents = getInventoryAndEquipment(player);
    ...
    public void halloween_vendor_action_removeDailyLimit(obj_id player, obj_id npc)
    {
    ...
    public int halloween_vendor_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int halloween_vendor_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int halloween_vendor_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int halloween_vendor_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int halloween_vendor_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
