...
public class ep3_trandoshan_dakar_zssik_02 extends script.base_script
{
    ...
    public boolean ep3_trandoshan_dakar_zssik_02_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_trandoshan_dakar_zssik_02_condition_hasCompletedQuest01(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_trando_dakar_zssik_03");
    }
    public boolean ep3_trandoshan_dakar_zssik_02_condition_isOnQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_trando_dakar_zssik_03");
    }
    public boolean ep3_trandoshan_dakar_zssik_02_condition_isReadyForDakar(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_trando_boshaz_transfer");
    }
    public boolean ep3_trandoshan_dakar_zssik_02_condition_hasCompletedTask01(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_trando_dakar_zssik_03", "taggedWookieesKilled");
    }
    public boolean ep3_trandoshan_dakar_zssik_02_condition_dakarReady(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_trando_boshaz_zssik_02");
    }
    public void ep3_trandoshan_dakar_zssik_02_action_doSignal01(obj_id player, obj_id npc)
    {
    ...
    public void ep3_trandoshan_dakar_zssik_02_action_doSignal02(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "rewardDakar");
        groundquests.grantQuest(player, "ep3_trando_mololium_zssik_goto");
    }
    public int ep3_trandoshan_dakar_zssik_02_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_dakar_zssik_02_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_dakar_zssik_02_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_dakar_zssik_02_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_dakar_zssik_02_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_dakar_zssik_02_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_dakar_zssik_02_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_814"))
        {
            if (ep3_trandoshan_dakar_zssik_02_condition__defaultCondition(player, npc))
