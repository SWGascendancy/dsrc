...
public class huffs_guard extends script.base_script
{
    ...
    public boolean huffs_guard_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean huffs_guard_condition_lookingForRifle(obj_id player, obj_id npc)
    {
    ...
    public boolean huffs_guard_condition_alreadyBroughtRifle(obj_id player, obj_id npc)
    {
    ...
    public void huffs_guard_action_grantHuffQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest/huffs_guard_rifle");
    }
    public int huffs_guard_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int huffs_guard_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int huffs_guard_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int huffs_guard_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int huffs_guard_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int huffs_guard_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
