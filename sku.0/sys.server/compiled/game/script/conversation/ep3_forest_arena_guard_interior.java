...
public class ep3_forest_arena_guard_interior extends script.base_script
{
    ...
    public boolean ep3_forest_arena_guard_interior_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_forest_arena_guard_interior_condition_TooMany(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_forest_kerritamba_epic_6", 0);
    }
    public boolean ep3_forest_arena_guard_interior_condition_EnoughPeople(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_forest_kerritamba_epic_6", 0);
    }
    public boolean ep3_forest_arena_guard_interior_condition_AAlwaysTrue(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_forest_arena_guard_interior_condition_notDone(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_forest_wirartu_epic_1");
    }
    public void ep3_forest_arena_guard_interior_action_exitDungeon(obj_id player, obj_id npc)
    {
        space_dungeon.ejectPlayerFromDungeon(player);
    }
    public void ep3_forest_arena_guard_interior_action_clearChallenge(obj_id player, obj_id npc)
    {
        groundquests.clearQuest(player, "ep3_forest_wirartu_epic_1");
    }
    public int ep3_forest_arena_guard_interior_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_arena_guard_interior_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
