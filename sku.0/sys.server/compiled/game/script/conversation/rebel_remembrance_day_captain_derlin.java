...
public class rebel_remembrance_day_captain_derlin extends script.base_script
{
    ...
    public boolean rebel_remembrance_day_captain_derlin_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean rebel_remembrance_day_captain_derlin_condition_alreadyDoingResistance(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_captain_derlin_condition_hasCompletedOneOrMoreCollections(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_captain_derlin_condition_isSpecialForcesRebel(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (factions.isDeclared(player) && factions.isRebel(player));
    }
    public boolean rebel_remembrance_day_captain_derlin_condition_hasResistanceCollectionPrerequisite(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return hasCompletedCollectionSlotPrereq(player, holiday.REBEL_RESISTANCE_COUNTER_SLOT);
    }
    public boolean rebel_remembrance_day_captain_derlin_condition_alreadyDoingVandal(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_captain_derlin_condition_alreadyKnowsDerlin(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_captain_derlin_condition_hasVandalCollectionPrerequisite(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return hasCompletedCollectionSlotPrereq(player, holiday.REBEL_VANDAL_COUNTER_SLOT);
    }
    public boolean rebel_remembrance_day_captain_derlin_condition_hasRemembranceDayBadge(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return hasCompletedCollectionSlot(player, holiday.REMEMBRANCE_DAY_CHAMPION_BADGE);
    }
    public boolean rebel_remembrance_day_captain_derlin_condition_isQualifiedResistanceSpecialForces(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_captain_derlin_condition_isQualifiedVandalSpecialForces(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_captain_derlin_condition_isImperialPlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (factions.isImperial(player));
    }
    public boolean rebel_remembrance_day_captain_derlin_condition_isNeutralPlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (!factions.isImperial(player) && !factions.isRebel(player));
    }
    public boolean rebel_remembrance_day_captain_derlin_condition_isQualifiedResistanceCombatant(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (!rebel_remembrance_day_captain_derlin_condition_isSpecialForcesRebel(player, npc) && !rebel_remembrance_day_captain_derlin_condition_alreadyDoingResistance(player, npc));
    }
    public boolean rebel_remembrance_day_captain_derlin_condition_isQualifiedVandalCombatant(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (!rebel_remembrance_day_captain_derlin_condition_isSpecialForcesRebel(player, npc) && !rebel_remembrance_day_captain_derlin_condition_alreadyDoingVandal(player, npc));
    }
    public boolean rebel_remembrance_day_captain_derlin_condition_hasCompletedResistanceCollection(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return hasCompletedCollection(player, holiday.REBEL_RESISTANCE_COLLECTION);
    }
    public boolean rebel_remembrance_day_captain_derlin_condition_hasCompletedVandalCollection(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return hasCompletedCollection(player, holiday.REBEL_VANDAL_COLLECTION);
    }
    public boolean rebel_remembrance_day_captain_derlin_condition_isLockedOutOfEvents(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_captain_derlin_condition_hasNotCompletedBothCollections(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (!rebel_remembrance_day_captain_derlin_condition_hasCompletedVandalCollection(player, npc) && !rebel_remembrance_day_captain_derlin_condition_hasCompletedResistanceCollection(player, npc));
    }
    public boolean rebel_remembrance_day_captain_derlin_condition_alreadyDoingBothVandalResistance(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_captain_derlin_condition_isChampionDoesntKnowDerlin(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_captain_derlin_condition_isChampionKnowsDerlin(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (rebel_remembrance_day_captain_derlin_condition_hasRemembranceDayBadge(player, npc) && rebel_remembrance_day_captain_derlin_condition_alreadyKnowsDerlin(player, npc));
    }
    public boolean rebel_remembrance_day_captain_derlin_condition_hasCollectionsButNotCompleted(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_captain_derlin_condition_isLockedOutOfVandal(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return hasObjVar(player, holiday.EMPIRE_DAY_VANDAL_LOCKED_OUT);
    }
    public boolean rebel_remembrance_day_captain_derlin_condition_isLockedOutOfResistance(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return hasObjVar(player, holiday.EMPIRE_DAY_RESISTANCE_LOCKED_OUT);
    }
    public boolean rebel_remembrance_day_captain_derlin_condition_canDoVandalEvent(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_captain_derlin_condition_canDoResistanceEvent(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_captain_derlin_condition_canDoAtLeastOneEvent(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_captain_derlin_condition_isTrader(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return utils.isProfession(player, utils.TRADER);
    }
    public boolean rebel_remembrance_day_captain_derlin_condition_isEntertainer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return utils.isProfession(player, utils.ENTERTAINER);
    }
    public boolean rebel_remembrance_day_captain_derlin_condition_isTraderOrEntertainer(obj_id player, obj_id npc)
    {
    ...
    public boolean rebel_remembrance_day_captain_derlin_condition_hasCompletedBothCollections(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (rebel_remembrance_day_captain_derlin_condition_hasCompletedVandalCollection(player, npc) && rebel_remembrance_day_captain_derlin_condition_hasCompletedResistanceCollection(player, npc));
    }
    public boolean rebel_remembrance_day_captain_derlin_condition_hasScore(obj_id player, obj_id npc)
    {
        return hasObjVar(player, holiday.PLAYER_EMPIRE_DAY_SCORE);
    }
    public boolean rebel_remembrance_day_captain_derlin_condition_isNeutralImperial(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_captain_derlin_condition_isNewNeutralPlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_captain_derlin_condition_isNeutralImperialButRebel(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_captain_derlin_condition_isNeutralAlignedIncompleteCollections(obj_id player, obj_id npc)
    {
    ...
    public boolean rebel_remembrance_day_captain_derlin_condition_hasBothImpAndRebKioskCollections(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_captain_derlin_condition_isNotTraderEntertainerNeutral(obj_id player, obj_id npc)
    {
    ...
    public void rebel_remembrance_day_captain_derlin_action_setSFResistanceEventOnPlayer(obj_id player, obj_id npc)
    {
    ...
    public void rebel_remembrance_day_captain_derlin_action_resetBothCollections(obj_id player, obj_id npc)
    {
    ...
    public void rebel_remembrance_day_captain_derlin_action_getLeaderBoardSui(obj_id player, obj_id npc)
    {
    ...
    public void rebel_remembrance_day_captain_derlin_action_setSFVandalEventOnPlayer(obj_id player, obj_id npc)
    {
    ...
    public void rebel_remembrance_day_captain_derlin_action_giveWedgeAntillesWaypoint(obj_id player, obj_id npc)
    {
    ...
    public void rebel_remembrance_day_captain_derlin_action_spawnTroopers(obj_id player, obj_id npc)
    {
        for (int i = 0; i < 3; i++)
        {
    ...
    public void rebel_remembrance_day_captain_derlin_action_setLeaderBoardScore(obj_id player, obj_id npc)
    {
    ...
    public void rebel_remembrance_day_captain_derlin_action_setResistanceCollectionStarterSlot(obj_id player, obj_id npc)
    {
        modifyCollectionSlotValue(player, holiday.REBEL_RESISTANCE_START_SLOT, 1);
    }
    public void rebel_remembrance_day_captain_derlin_action_setVandalCollectionStarterSlot(obj_id player, obj_id npc)
    {
        modifyCollectionSlotValue(player, holiday.REBEL_VANDAL_START_SLOT, 1);
    }
    public void rebel_remembrance_day_captain_derlin_action_setCombatantResistanceEventOnPlayer(obj_id player, obj_id npc)
    {
        if (getCollectionSlotValue(player, holiday.REBEL_RESISTANCE_START_SLOT) <= 0)
        {
            rebel_remembrance_day_captain_derlin_action_setResistanceCollectionStarterSlot(player, npc);
    ...
    public void rebel_remembrance_day_captain_derlin_action_setCombatantVandalEventOnPlayer(obj_id player, obj_id npc)
    {
        if (getCollectionSlotValue(player, holiday.REBEL_VANDAL_START_SLOT) <= 0)
        {
            rebel_remembrance_day_captain_derlin_action_setVandalCollectionStarterSlot(player, npc);
    ...
    public void rebel_remembrance_day_captain_derlin_action_makeNeutralRebel(obj_id player, obj_id npc)
    {
    ...
    public void rebel_remembrance_day_captain_derlin_action_checkHolidayTimeStampOnPlayer(obj_id player, obj_id npc)
    {
    ...
    public void rebel_remembrance_day_captain_derlin_action_removeNeutralImperial(obj_id player, obj_id npc)
    {
        removeObjVar(player, holiday.PLAYER_EMPIRE_DAY_NEUTRAL + holiday.PLANET_VAR_PLAYER_FACTION_IMP);
    }
    public void rebel_remembrance_day_captain_derlin_action_removeImpCollections(obj_id player, obj_id npc)
    {
        String playerName = getPlayerFullName(player);
    ...
    public String rebel_remembrance_day_captain_derlin_tokenTO_timeLeftVandal(obj_id player, obj_id npc)
    {
    ...
    public String rebel_remembrance_day_captain_derlin_tokenTO_timeLeftResistance(obj_id player, obj_id npc)
    {
    ...
    public String rebel_remembrance_day_captain_derlin_tokenTO_currentScore(obj_id player, obj_id npc)
    {
        if (!hasObjVar(player, holiday.PLAYER_EMPIRE_DAY_SCORE))
        {
    ...
    public int rebel_remembrance_day_captain_derlin_tokenDI_notUsed(obj_id player, obj_id npc)
    {
        return 0;
    }
    public int rebel_remembrance_day_captain_derlin_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_captain_derlin_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_captain_derlin_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_captain_derlin_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_173"))
        {
            if (rebel_remembrance_day_captain_derlin_condition_hasCompletedBothCollections(player, npc))
    ...
    public int rebel_remembrance_day_captain_derlin_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_captain_derlin_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_captain_derlin_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_captain_derlin_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_captain_derlin_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_captain_derlin_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_captain_derlin_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_captain_derlin_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_97"))
        {
            if (rebel_remembrance_day_captain_derlin_condition__defaultCondition(player, npc))
    ...
    public int rebel_remembrance_day_captain_derlin_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_captain_derlin_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_captain_derlin_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_captain_derlin_handleBranch31(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_captain_derlin_handleBranch32(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_captain_derlin_handleBranch33(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_97"))
        {
            if (rebel_remembrance_day_captain_derlin_condition__defaultCondition(player, npc))
    ...
    public int rebel_remembrance_day_captain_derlin_handleBranch35(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_70"))
        {
            if (rebel_remembrance_day_captain_derlin_condition__defaultCondition(player, npc))
    ...
    public int rebel_remembrance_day_captain_derlin_handleBranch36(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_captain_derlin_handleBranch37(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_97"))
        {
            if (rebel_remembrance_day_captain_derlin_condition__defaultCondition(player, npc))
    ...
    public int rebel_remembrance_day_captain_derlin_handleBranch38(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_captain_derlin_handleBranch39(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_captain_derlin_handleBranch40(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_97"))
        {
            if (rebel_remembrance_day_captain_derlin_condition__defaultCondition(player, npc))
    ...
    public int rebel_remembrance_day_captain_derlin_handleBranch42(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_captain_derlin_handleBranch43(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_captain_derlin_handleBranch44(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_97"))
        {
            if (rebel_remembrance_day_captain_derlin_condition__defaultCondition(player, npc))
    ...
    public int rebel_remembrance_day_captain_derlin_handleBranch46(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_captain_derlin_handleBranch47(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_97"))
        {
            if (rebel_remembrance_day_captain_derlin_condition__defaultCondition(player, npc))
    ...
    public int rebel_remembrance_day_captain_derlin_handleBranch49(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_captain_derlin_handleBranch50(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_captain_derlin_handleBranch53(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_captain_derlin_handleBranch54(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_captain_derlin_handleBranch55(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_97"))
        {
            if (rebel_remembrance_day_captain_derlin_condition__defaultCondition(player, npc))
    ...
    public int rebel_remembrance_day_captain_derlin_handleBranch57(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_captain_derlin_handleBranch58(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_97"))
        {
            if (rebel_remembrance_day_captain_derlin_condition__defaultCondition(player, npc))
