...
public class corellia_tyrena_harkog_gerr extends script.base_script
{
    ...
    public boolean corellia_tyrena_harkog_gerr_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public int corellia_tyrena_harkog_gerr_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_harkog_gerr_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_harkog_gerr_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_harkog_gerr_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_harkog_gerr_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_harkog_gerr_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_harkog_gerr_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
