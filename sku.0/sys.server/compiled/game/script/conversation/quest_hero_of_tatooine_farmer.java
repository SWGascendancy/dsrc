...
public class quest_hero_of_tatooine_farmer extends script.base_script
{
    ...
    public boolean quest_hero_of_tatooine_farmer_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean quest_hero_of_tatooine_farmer_condition_has_credits(obj_id player, obj_id npc)
    {
    ...
    public boolean quest_hero_of_tatooine_farmer_condition_already_helped(obj_id player, obj_id npc)
    {
    ...
    public boolean quest_hero_of_tatooine_farmer_condition_quest_complete(obj_id player, obj_id npc)
    {
    ...
    public boolean quest_hero_of_tatooine_farmer_condition_lost_waypoint(obj_id player, obj_id npc)
    {
        location loc;
    ...
    public boolean quest_hero_of_tatooine_farmer_condition_on_quest(obj_id player, obj_id npc)
    {
    ...
    public boolean quest_hero_of_tatooine_farmer_condition_already_helped_player(obj_id player, obj_id npc)
    {
        if (utils.hasScriptVar(npc, "already_been_helped"))
        {
    ...
    public boolean quest_hero_of_tatooine_farmer_condition_quest_stuck(obj_id player, obj_id npc)
    {
    ...
    public void quest_hero_of_tatooine_farmer_action_paid_ransom(obj_id player, obj_id npc)
    {
        if (!money.hasFunds(player, money.MT_CASH, 10000))
        {
            return;
    ...
    public void quest_hero_of_tatooine_farmer_action_will_help(obj_id player, obj_id npc)
    {
    ...
    public void quest_hero_of_tatooine_farmer_action_been_helped(obj_id player, obj_id npc)
    {
    ...
    public void quest_hero_of_tatooine_farmer_action_give_waypoint(obj_id player, obj_id npc)
    {
        location cave = new location(6522, 0, -1350);
        obj_id waypoint = createWaypointInDatapad(player, cave);
        setWaypointName(waypoint, "Kidnapped Family");
    ...
    public void quest_hero_of_tatooine_farmer_action_reset_quest(obj_id player, obj_id npc)
    {
    ...
    public int quest_hero_of_tatooine_farmer_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_hero_of_tatooine_farmer_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_hero_of_tatooine_farmer_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_hero_of_tatooine_farmer_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_hero_of_tatooine_farmer_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_hero_of_tatooine_farmer_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_hero_of_tatooine_farmer_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_hero_of_tatooine_farmer_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_hero_of_tatooine_farmer_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_hero_of_tatooine_farmer_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_hero_of_tatooine_farmer_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_hero_of_tatooine_farmer_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_hero_of_tatooine_farmer_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_hero_of_tatooine_farmer_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_hero_of_tatooine_farmer_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
