...
public class herald_dathomir_nightsister_rancor_cave_01 extends script.base_script
{
    ...
    public boolean herald_dathomir_nightsister_rancor_cave_01_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean herald_dathomir_nightsister_rancor_cave_01_condition_hasWayPoint(obj_id player, obj_id npc)
    {
        location loc;
    ...
    public void herald_dathomir_nightsister_rancor_cave_01_action__defaultAction(obj_id player, obj_id npc)
    {
    }
    public void herald_dathomir_nightsister_rancor_cave_01_action_grantWayPoint(obj_id player, obj_id npc)
    {
    ...
    public void herald_dathomir_nightsister_rancor_cave_01_action_faceto(obj_id player, obj_id npc)
    {
