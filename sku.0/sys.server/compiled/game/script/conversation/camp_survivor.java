...
public class camp_survivor extends script.base_script
{
    ...
    public boolean camp_survivor_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean camp_survivor_condition_isOwner(obj_id player, obj_id npc)
    {
        return hasObjVar(npc, "myEscort") && player == getObjIdObjVar(npc, "myEscort");
    }
    public boolean camp_survivor_condition_isCloseToCamp(obj_id player, obj_id npc)
    {
    ...
    public boolean camp_survivor_condition_isUnclaimedSpawner(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (!hasObjVar(npc, "myEscort"));
    }
    public void camp_survivor_action_startDestroyTimer(obj_id player, obj_id npc)
    {
        messageTo(npc, "cleanUpWhileConversing", null, 90, false);
    }
    public void camp_survivor_action_claimSpawner(obj_id player, obj_id npc)
    {
    ...
    public int camp_survivor_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int cleanUpWhileConversing(obj_id self, dictionary params)
    {
    ...
    public int cleanUpCampNpcAndParent(obj_id self, dictionary params)
    {
    ...
    public int checkOwnerValidity(obj_id self, dictionary params)
    {
        if (!hasObjVar(self, "myEscort"))
        {
            return SCRIPT_CONTINUE;
