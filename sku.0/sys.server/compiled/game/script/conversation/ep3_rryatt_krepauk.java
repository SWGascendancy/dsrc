...
public class ep3_rryatt_krepauk extends script.base_script
{
    ...
    public boolean ep3_rryatt_krepauk_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_rryatt_krepauk_condition_finishedKatarnHunt(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_rryatt_krepauk_condition_finishedEliteMinstygarHunt(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_rryatt_krepauk_condition_finishedFeralWookieeHunt(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_rryatt_krepauk_condition_finishedExJediHunt(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_rryatt_krepauk_condition_finishedWallugaHunt(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_rryatt_krepauk_condition_onKatarnHunt(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_rryatt_krepauk_defeat_katarn", "krepauk_huntKatarn");
    }
    public boolean ep3_rryatt_krepauk_condition_onEliteMinstyngarHunt(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_rryatt_krepauk_kill_elite_minstyngar", "krepauk_huntEliteMinstyngar");
    }
    public boolean ep3_rryatt_krepauk_condition_onFeralWookieeHunt(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_rryatt_krepauk_cleanse_feral_wookiees", "krepauk_killFeralWookiees");
    }
    public boolean ep3_rryatt_krepauk_condition_onExJediHunt(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_rryatt_krepauk_defeat_exjedi", "krepauk_defeatExJedi");
    }
    public boolean ep3_rryatt_krepauk_condition_onWallugaHunt(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_rryatt_krepauk_kill_walluga_smashers", "krepauk_huntWallugaSmashers");
    }
    public boolean ep3_rryatt_krepauk_condition_cannotSpeakWookiee(obj_id player, obj_id npc)
    {
        return utils.canSpeakWookiee(player, npc);
    }
    public void ep3_rryatt_krepauk_action_cleanseFeralWookiees(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_rryatt_krepauk_cleanse_feral_wookiees");
    }
    public void ep3_rryatt_krepauk_action_killEliteMinstyngar(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_rryatt_krepauk_kill_elite_minstyngar");
    }
    public void ep3_rryatt_krepauk_action_killWallugas(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_rryatt_krepauk_kill_walluga_smashers");
    }
    public void ep3_rryatt_krepauk_action_defeatExJedi(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_rryatt_krepauk_defeat_exjedi");
    }
    public void ep3_rryatt_krepauk_action_defeatKatarn(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_rryatt_krepauk_defeat_katarn");
    }
    public void ep3_rryatt_krepauk_action_doneWallugas(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "krepauk_completedWallugaHunt");
    }
    public void ep3_rryatt_krepauk_action_doneExJedi(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "krepauk_exJediDefeated");
    }
    public void ep3_rryatt_krepauk_action_doneFeralWookiees(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "krepauk_feralWookieesCleansed");
    }
    public void ep3_rryatt_krepauk_action_doneEliteMinstyngar(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "krepauk_eliteMinstyngarHuntCompleted");
    }
    public void ep3_rryatt_krepauk_action_doneKatarn(obj_id player, obj_id npc)
    {
    ...
    public void ep3_rryatt_krepauk_action_thinkWookieeConfusion(obj_id player, obj_id npc)
    {
        utils.emoteWookieeConfusion(player, npc);
    }
    public int ep3_rryatt_krepauk_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_rryatt_krepauk_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_rryatt_krepauk_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_rryatt_krepauk_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_rryatt_krepauk_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_rryatt_krepauk_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
