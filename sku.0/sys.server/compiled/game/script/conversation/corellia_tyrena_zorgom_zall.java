...
public class corellia_tyrena_zorgom_zall extends script.base_script
{
    ...
    public boolean corellia_tyrena_zorgom_zall_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_tyrena_zorgom_zall_condition_completeMissing(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "corellia_tyrena_missing_persons");
    }
    public boolean corellia_tyrena_zorgom_zall_condition_completeForgotten(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "corellia_tyrena_forgotten_child");
    }
    public boolean corellia_tyrena_zorgom_zall_condition_onForgottenReturn(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_tyrena_forgotten_child", "forgotten_return_zorgom");
    }
    public boolean corellia_tyrena_zorgom_zall_condition_onForgotten(obj_id player, obj_id npc)
    {
    ...
    public void corellia_tyrena_zorgom_zall_action_signalForgottenReturn(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "forgotten_return_zorgom");
    }
    public void corellia_tyrena_zorgom_zall_action_grantForgotten(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "corellia_tyrena_forgotten_child");
    }
    public int corellia_tyrena_zorgom_zall_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_zorgom_zall_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_zorgom_zall_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_zorgom_zall_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_zorgom_zall_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
