...
public class village_quharek extends script.base_script
{
    ...
    public boolean village_quharek_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean village_quharek_condition_phase1_givequest(obj_id player, obj_id npc)
    {
    ...
    public boolean village_quharek_condition_phase1_inprogress(obj_id player, obj_id npc)
    {
        obj_id master = getObjIdObjVar(npc, "village_master");
        if (!isIdValid(master))
        {
    ...
    public boolean village_quharek_condition_phase1_complete(obj_id player, obj_id npc)
    {
        obj_id master = getObjIdObjVar(npc, "village_master");
        if (!isIdValid(master))
        {
    ...
    public boolean village_quharek_condition_accepted_quest(obj_id player, obj_id npc)
    {
        if (fs_quests.hasQuestAccepted(player))
        {
            return true;
    ...
    public boolean village_quharek_condition_not_eligible(obj_id player, obj_id npc)
    {
        if (!fs_quests.isVillageEligible(player))
        {
            return true;
    ...
    public boolean village_quharek_condition_wrong_phase(obj_id player, obj_id npc)
    {
        obj_id master = getObjIdObjVar(npc, "village_master");
        if (!isIdValid(master))
        {
    ...
    public boolean village_quharek_condition_completed_quest(obj_id player, obj_id npc)
    {
    ...
    public void village_quharek_action_phase1_activate(obj_id player, obj_id npc)
    {
        obj_id master = getObjIdObjVar(npc, "village_master");
        if (isIdValid(master))
        {
