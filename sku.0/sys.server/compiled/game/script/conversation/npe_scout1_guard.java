...
public class npe_scout1_guard extends script.base_script
{
    ...
    public boolean npe_scout1_guard_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_scout1_guard_condition_playerOnQuestStep(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_scout_1", "talktoguard");
    }
    public boolean npe_scout1_guard_condition_playerCompletedQuestStep(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "npe_scout_1", "talktoguard");
    }
    public boolean npe_scout1_guard_condition_playerCompletedQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_scout_1");
    }
    public void npe_scout1_guard_action_signalScout1Ambush(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_scout1_signalattack");
    }
    public int npe_scout1_guard_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_scout1_guard_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_scout1_guard_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_scout1_guard_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
