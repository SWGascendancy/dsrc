...
public class station_rebel_outpost extends script.base_script
{
    ...
    public boolean station_rebel_outpost_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean station_rebel_outpost_condition_hasFailed_rebel_escort_alpha(obj_id player, obj_id npc)
    {
        return (space_quest.hasFailedQuest(player, "escort", "ep3_kash_station_rebel_escort_alpha"));
    }
    public boolean station_rebel_outpost_condition_isPlayerImperial(obj_id player, obj_id npc)
    {
        return (space_battlefield.isInImperialShip(player) || pvpGetAlignedFaction(player) == (-615855020));
    }
    public boolean station_rebel_outpost_condition_isRebelFactionWithMission(obj_id player, obj_id npc)
    {
    ...
    public boolean station_rebel_outpost_condition_isInYacht(obj_id player, obj_id npc)
    {
    ...
    public boolean station_rebel_outpost_condition_isPlayerNeutral(obj_id player, obj_id npc)
    {
        if (space_battlefield.isInNeutralShip(player))
        {
    ...
    public boolean station_rebel_outpost_condition_isTooFar(obj_id player, obj_id npc)
    {
        obj_id containingShip = space_transition.getContainingShip(player);
        return (getDistance(npc, containingShip) > space_transition.STATION_COMM_MAX_DISTANCE);
    }
    public boolean station_rebel_outpost_condition_hasWon_rebel_escort_alpha(obj_id player, obj_id npc)
    {
        return (space_quest.hasWonQuest(player, "escort", "ep3_kash_station_rebel_escort_alpha"));
    }
    public boolean station_rebel_outpost_condition_hasBeenRewarded_rebel_escort_alpha(obj_id player, obj_id npc)
    {
        return (space_quest.hasReceivedReward(player, "escort", "ep3_kash_station_rebel_escort_alpha"));
    }
    public boolean station_rebel_outpost_condition_isReady_for_escort_alpha(obj_id player, obj_id npc)
    {
    ...
    public boolean station_rebel_outpost_condition_hasBeenRewarded_heavy_xwing(obj_id player, obj_id npc)
    {
        return (space_quest.hasReceivedReward(player, "recovery", "ep3_heavy_xwing_recovery"));
    }
    public boolean station_rebel_outpost_condition_hasWon_heavy_xwing_recovery(obj_id player, obj_id npc)
    {
    ...
    public void station_rebel_outpost_action_grant_duty_destroy(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "ep3_kash_station_destroy_duty_rebel");
    }
    public void station_rebel_outpost_action_grant_duty_escort(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "escort_duty", "ep3_kash_station_escort_duty_rebel");
    }
    public void station_rebel_outpost_action_grant_escort_alpha(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "escort", "ep3_kash_station_rebel_escort_alpha");
    }
    public void station_rebel_outpost_action_setPlayerToOvertStatus(obj_id player, obj_id npc)
    {
        space_transition.setPlayerOvert(player, (370444368));
    }
    public void station_rebel_outpost_action_giveReward_rebel_hologram(obj_id player, obj_id npc)
    {
    ...
    public void station_rebel_outpost_action_grantMission_heavy_xwing_recovery(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "recovery", "ep3_heavy_xwing_recovery");
    }
    public void station_rebel_outpost_action_giveReward_heavy_xwing(obj_id player, obj_id npc)
    {
    ...
    public int station_rebel_outpost_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rebel_outpost_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rebel_outpost_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rebel_outpost_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rebel_outpost_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rebel_outpost_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rebel_outpost_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rebel_outpost_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rebel_outpost_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rebel_outpost_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rebel_outpost_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rebel_outpost_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rebel_outpost_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rebel_outpost_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rebel_outpost_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rebel_outpost_handleBranch30(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_797"))
        {
            if (station_rebel_outpost_condition__defaultCondition(player, npc))
    ...
    public int station_rebel_outpost_handleBranch31(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_797"))
        {
            if (station_rebel_outpost_condition__defaultCondition(player, npc))
    ...
    public int station_rebel_outpost_handleBranch33(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rebel_outpost_handleBranch35(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rebel_outpost_handleBranch38(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rebel_outpost_handleBranch39(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rebel_outpost_handleBranch40(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_829"))
        {
            if (station_rebel_outpost_condition__defaultCondition(player, npc))
