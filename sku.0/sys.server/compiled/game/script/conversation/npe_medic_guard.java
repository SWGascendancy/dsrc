...
public class npe_medic_guard extends script.base_script
{
    ...
    public boolean npe_medic_guard_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_medic_guard_condition_isOnQuest(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_medic2", "npe_medic2_heal");
    }
    public boolean npe_medic_guard_condition_hasHealed(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "npe_medic2", "npe_medic2_heal");
    }
    public boolean npe_medic_guard_condition_hasFullyHealed(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "npe_medic2", "return_technician") || groundquests.hasCompletedQuest(player, "npe_medic2"));
    }
    public void npe_medic_guard_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int npe_medic_guard_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_medic_guard_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
