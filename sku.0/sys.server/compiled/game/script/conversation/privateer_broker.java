...
public class privateer_broker extends script.base_script
{
    ...
    public boolean privateer_broker_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean privateer_broker_condition_isNeutralPilot(obj_id player, obj_id npc)
    {
        return space_skill.hasPilotSkill(player);
    }
    public boolean privateer_broker_condition_isPilot(obj_id player, obj_id npc)
    {
        return space_skill.hasSpaceSkills(player);
    }
    public boolean privateer_broker_condition_hasSpaceExp(obj_id player, obj_id npc)
    {
        return true;
    }
    public void privateer_broker_action_addImperialBrokerWaypoint(obj_id player, obj_id npc)
    {
    ...
    public void privateer_broker_action_addCorSecTrainerWaypoint(obj_id player, obj_id npc)
    {
        trainerlocs.getTrainerLocationWaypoint(player, "privateer", "corellia");
    }
    public void privateer_broker_action_addRSFTrainerWaypoint(obj_id player, obj_id npc)
    {
        trainerlocs.getTrainerLocationWaypoint(player, "privateer", "naboo");
    }
    public void privateer_broker_action_addSmugglerAllianceWaypoint(obj_id player, obj_id npc)
    {
        trainerlocs.getTrainerLocationWaypoint(player, "privateer", "tatooine");
    }
    public void privateer_broker_action_addRebelBrokerWaypoint(obj_id player, obj_id npc)
    {
        location targetLoc = new location();
    ...
    public void privateer_broker_action_retireNeutral(obj_id player, obj_id npc)
    {
        space_skill.retire(player, space_skill.NEUTRAL);
    }
    public int privateer_broker_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int privateer_broker_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int privateer_broker_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int privateer_broker_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int privateer_broker_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int privateer_broker_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int privateer_broker_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_ce87b83e"))
        {
            doAnimationAction(player, "rub_chin_thoughtful");
    ...
    public int privateer_broker_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_ce87b83e"))
        {
            doAnimationAction(player, "rub_chin_thoughtful");
    ...
    public int privateer_broker_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int privateer_broker_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int privateer_broker_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int privateer_broker_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int privateer_broker_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int privateer_broker_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int privateer_broker_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int privateer_broker_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int privateer_broker_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int privateer_broker_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_da0b2f54"))
        {
            doAnimationAction(player, "shake_head_no");
    ...
    public int privateer_broker_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int privateer_broker_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int privateer_broker_handleBranch30(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int privateer_broker_handleBranch32(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_fd3512f0"))
        {
            if (privateer_broker_condition__defaultCondition(player, npc))
    ...
    public int privateer_broker_handleBranch33(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_159911f5"))
        {
            if (privateer_broker_condition__defaultCondition(player, npc))
    ...
    public int privateer_broker_handleBranch34(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_e4c89252"))
        {
            if (privateer_broker_condition__defaultCondition(player, npc))
    ...
    public int privateer_broker_handleBranch36(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_fd3512f0"))
        {
            if (privateer_broker_condition__defaultCondition(player, npc))
    ...
    public int privateer_broker_handleBranch37(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_159911f5"))
        {
            if (privateer_broker_condition__defaultCondition(player, npc))
    ...
    public int privateer_broker_handleBranch38(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_e4c89252"))
        {
            if (privateer_broker_condition__defaultCondition(player, npc))
    ...
    public int privateer_broker_handleBranch40(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_fd3512f0"))
        {
            if (privateer_broker_condition__defaultCondition(player, npc))
    ...
    public int privateer_broker_handleBranch41(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_159911f5"))
        {
            if (privateer_broker_condition__defaultCondition(player, npc))
    ...
    public int privateer_broker_handleBranch42(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_e4c89252"))
        {
            if (privateer_broker_condition__defaultCondition(player, npc))
    ...
    public int privateer_broker_handleBranch44(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_fd3512f0"))
        {
            if (privateer_broker_condition__defaultCondition(player, npc))
