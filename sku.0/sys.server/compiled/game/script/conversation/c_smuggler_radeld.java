...
public class c_smuggler_radeld extends script.base_script
{
    ...
    public boolean c_smuggler_radeld_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_smuggler_radeld_condition_isTaskActiveLink(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "c_smuggler_han_link");
    }
    public boolean c_smuggler_radeld_condition_isTaskActiveSteal1(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "c_smuggler_steal_1", "dostuff"));
    }
    public boolean c_smuggler_radeld_condition_hasCompletedTaskSteal1(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "c_smuggler_steal_1", "imdone");
    }
    public boolean c_smuggler_radeld_condition_hasCompletedQuestsSteal(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedQuest(player, "c_smuggler_steal_1") || groundquests.hasCompletedQuest(player, "c_smuggler_steal_2"));
    }
    public void c_smuggler_radeld_action_sendLinkSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "newguy");
    }
    public void c_smuggler_radeld_action_grantSteal1(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "c_smuggler_steal_1");
    }
    public void c_smuggler_radeld_action_grantSteal2(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "imdone");
    }
    public void c_smuggler_radeld_action_sendDoneSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "radeld");
    }
    public int c_smuggler_radeld_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_smuggler_radeld_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_smuggler_radeld_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_smuggler_radeld_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_smuggler_radeld_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_smuggler_radeld_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_smuggler_radeld_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_smuggler_radeld_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_smuggler_radeld_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
