...
public class ep3_forest_perusta extends script.base_script
{
    ...
    public boolean ep3_forest_perusta_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_forest_perusta_condition_isGoodGuy(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_forest_perusta_condition_isBadGuy(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_forest_perusta_condition_isTaskOneActive(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_forest_perusta_condition_hasCompletedTaskOne(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_forest_perusta_condition_hasCompletedQuestOne(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_forest_perusta_quest_1");
    }
    public boolean ep3_forest_perusta_condition_isTaskActiveTwo(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_forest_perusta_condition_hasCompletedTaskTwo(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_forest_perusta_condition_hasCompletedQuestTwo(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_forest_perusta_quest_2");
    }
    public boolean ep3_forest_perusta_condition_hasLanguage(obj_id player, obj_id npc)
    {
        return utils.canSpeakWookiee(player, npc);
    }
    public void ep3_forest_perusta_action_giveQuestOne(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_forest_perusta_quest_1");
    }
    public void ep3_forest_perusta_action_giveSignalOne(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "moss");
    }
    public void ep3_forest_perusta_action_giveQuestTwo(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_forest_perusta_quest_2");
    }
    public void ep3_forest_perusta_action_giveSignalTwo(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "mysess");
    }
    public void ep3_forest_perusta_action_Language(obj_id player, obj_id npc)
    {
        utils.emoteWookieeConfusion(player, npc);
    }
    public int ep3_forest_perusta_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_perusta_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_perusta_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_perusta_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_perusta_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_perusta_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_perusta_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_perusta_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_perusta_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_perusta_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_perusta_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
