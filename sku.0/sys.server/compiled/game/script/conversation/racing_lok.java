...
public class racing_lok extends script.base_script
{
    ...
    public boolean racing_lok_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean racing_lok_condition_hasRaced(obj_id player, obj_id npc)
    {
        return (hasObjVar(player, "racing.bestTime.lok"));
    }
    public boolean racing_lok_condition_isRacing(obj_id player, obj_id npc)
    {
        return (getIntObjVar(player, "racing.lok.isRacing") == 1);
    }
    public boolean racing_lok_condition_hasLastTime(obj_id player, obj_id npc)
    {
        return (hasObjVar(player, "racing.lastTime.lok"));
    }
    public void racing_lok_action_registerPersonalBest(obj_id player, obj_id npc)
    {
    ...
    public void racing_lok_action_startRace(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        params.put("npc", npc);
    ...
    public void racing_lok_action_displayCurrentLeader(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        params.put("npc", npc);
    ...
    public void racing_lok_action_whatsMyBestTime(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        params.put("npc", npc);
    ...
    public void racing_lok_action_showBestTime(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        params.put("npc", npc);
    ...
    public void racing_lok_action_erasePersonalBest(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        params.put("npc", npc);
    ...
    public void racing_lok_action_abortRace(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
