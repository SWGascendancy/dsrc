...
public class npe_scout2_hostages extends script.base_script
{
    ...
    public boolean npe_scout2_hostages_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_scout2_hostages_condition_playerOnHostageStep1(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_scout_2", "firsthostagetalk");
    }
    public boolean npe_scout2_hostages_condition_playerOnHostageStep2(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_scout_2", "secondhostagetalk");
    }
    public boolean npe_scout2_hostages_condition_playerOnHostageStep3(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_scout_2", "thirdhostagetalk");
    }
    public boolean npe_scout2_hostages_condition_playerOnHostageStep4(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_scout_2", "fourthhostagetalk");
    }
    public boolean npe_scout2_hostages_condition_playerDoneWithHostages(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "npe_scout_2", "fourthhostagetalk");
    }
    public void npe_scout2_hostages_action_forwardQuestHostage1(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_scout_2_hostage_1");
    }
    public void npe_scout2_hostages_action_forwardQuestHostage2(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_scout_2_hostage_2");
    }
    public void npe_scout2_hostages_action_forwardQuestHostage3(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_scout_2_hostage_3");
    }
    public void npe_scout2_hostages_action_forwardQuestHostage4(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_scout_2_hostage_4");
    }
    public int npe_scout2_hostages_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_scout2_hostages_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_scout2_hostages_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_scout2_hostages_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_scout2_hostages_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_scout2_hostages_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_scout2_hostages_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_scout2_hostages_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_scout2_hostages_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_scout2_hostages_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_scout2_hostages_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
