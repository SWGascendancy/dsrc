...
public class murmur_side_security_director extends script.base_script
{
    ...
    public boolean murmur_side_security_director_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean murmur_side_security_director_condition_onQuest(obj_id player, obj_id npc)
    {
        return (groundquests.isQuestActive(player, "coronet_murmurs_side_1") || groundquests.isQuestActive(player, "coronet_murmurs_side_2"));
    }
    public boolean murmur_side_security_director_condition_needs2ndQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean murmur_side_security_director_condition_hasCompletedAll(obj_id player, obj_id npc)
    {
    ...
    public void murmur_side_security_director_action_grantSideQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "coronet_murmurs_side_1");
    }
    public void murmur_side_security_director_action_regrant2ndQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "coronet_murmurs_side_2");
    }
    public void murmur_side_security_director_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int murmur_side_security_director_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int murmur_side_security_director_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int murmur_side_security_director_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
