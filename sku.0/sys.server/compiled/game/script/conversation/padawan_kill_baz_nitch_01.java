...
public class padawan_kill_baz_nitch_01 extends script.base_script
{
    ...
    public boolean padawan_kill_baz_nitch_01_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean padawan_kill_baz_nitch_01_condition_isTrialPlayer(obj_id player, obj_id npc)
    {
    ...
    public boolean padawan_kill_baz_nitch_01_condition_acceptedQuest(obj_id player, obj_id npc)
    {
        obj_id trialPlayer = getObjIdObjVar(npc, jedi_trials.PADAWAN_TRIAL_PLAYER_OBJVAR);
        if (player == trialPlayer)
        {
    ...
    public boolean padawan_kill_baz_nitch_01_condition_killedRequiredAmt(obj_id player, obj_id npc)
    {
        obj_id trialPlayer = getObjIdObjVar(npc, jedi_trials.PADAWAN_TRIAL_PLAYER_OBJVAR);
        if (player == trialPlayer)
        {
    ...
    public boolean padawan_kill_baz_nitch_01_condition_completedSuccess(obj_id player, obj_id npc)
    {
        obj_id trialPlayer = getObjIdObjVar(npc, jedi_trials.PADAWAN_TRIAL_PLAYER_OBJVAR);
        if (player == trialPlayer)
        {
    ...
    public void padawan_kill_baz_nitch_01_action_questSuccess(obj_id player, obj_id npc)
    {
    ...
    public void padawan_kill_baz_nitch_01_action_acceptQuest(obj_id player, obj_id npc)
    {
    ...
    public int padawan_kill_baz_nitch_01_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int padawan_kill_baz_nitch_01_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
