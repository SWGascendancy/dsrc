...
public class ep3_etyyy_jerrol_chupapa extends script.base_script
{
    ...
    public boolean ep3_etyyy_jerrol_chupapa_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_etyyy_jerrol_chupapa_condition_doesNotHaveBrodyQuest(obj_id player, obj_id npc)
    {
    ...
    public int ep3_etyyy_jerrol_chupapa_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
