...
public class imperial_empire_day_major_tantor extends script.base_script
{
    ...
    public boolean imperial_empire_day_major_tantor_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean imperial_empire_day_major_tantor_condition_alreadyDoingRecruitment(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean imperial_empire_day_major_tantor_condition_hasCompletedBothCollections(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean imperial_empire_day_major_tantor_condition_isSpecialForcesImperial(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (factions.isDeclared(player) && factions.isImperial(player));
    }
    public boolean imperial_empire_day_major_tantor_condition_hasRecruitmentCollectionPrerequisite(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return hasCompletedCollectionSlotPrereq(player, holiday.IMPERIAL_RECRUITING_COUNTER_SLOT);
    }
    public boolean imperial_empire_day_major_tantor_condition_alreadyDoingPropaganda(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean imperial_empire_day_major_tantor_condition_alreadyKnowsTantor(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean imperial_empire_day_major_tantor_condition_hasPropagandaCollectionPrerequisite(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return hasCompletedCollectionSlotPrereq(player, holiday.IMPERIAL_ANTIPROP_COUNTER_SLOT);
    }
    public boolean imperial_empire_day_major_tantor_condition_hasEmpireDayBadge(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return hasCompletedCollectionSlot(player, holiday.EMPIRE_DAY_CHAMPION_BADGE);
    }
    public boolean imperial_empire_day_major_tantor_condition_isQualifiedRecruitmentSpecialForces(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean imperial_empire_day_major_tantor_condition_isQualifiedPropagandaSpecialForces(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean imperial_empire_day_major_tantor_condition_isRebelPlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (factions.isRebel(player));
    }
    public boolean imperial_empire_day_major_tantor_condition_isNeutralPlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (!factions.isImperial(player) && !factions.isRebel(player));
    }
    public boolean imperial_empire_day_major_tantor_condition_isQualifiedRecruitmentCombatant(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (!imperial_empire_day_major_tantor_condition_isSpecialForcesImperial(player, npc) && !imperial_empire_day_major_tantor_condition_alreadyDoingRecruitment(player, npc));
    }
    public boolean imperial_empire_day_major_tantor_condition_isQualifiedPropagandaCombatant(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (!imperial_empire_day_major_tantor_condition_isSpecialForcesImperial(player, npc) && !imperial_empire_day_major_tantor_condition_alreadyDoingPropaganda(player, npc));
    }
    public boolean imperial_empire_day_major_tantor_condition_hasCompletedRecruitmentCollection(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return hasCompletedCollection(player, holiday.IMPERIAL_RECRUITING_COLLECTION);
    }
    public boolean imperial_empire_day_major_tantor_condition_hasCompletedPropagandaCollection(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return hasCompletedCollection(player, holiday.IMPERIAL_ANTIPROP_COLLECTION);
    }
    public boolean imperial_empire_day_major_tantor_condition_isLockedOutOfEvents(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean imperial_empire_day_major_tantor_condition_hasNotCompletedBothCollections(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (!imperial_empire_day_major_tantor_condition_hasCompletedPropagandaCollection(player, npc) && !imperial_empire_day_major_tantor_condition_hasCompletedRecruitmentCollection(player, npc));
    }
    public boolean imperial_empire_day_major_tantor_condition_alreadyDoingBothPropagandaRecruitment(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean imperial_empire_day_major_tantor_condition_isChampionDoesntKnowTantor(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean imperial_empire_day_major_tantor_condition_isChampionKnowsTantor(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (imperial_empire_day_major_tantor_condition_hasEmpireDayBadge(player, npc) && imperial_empire_day_major_tantor_condition_alreadyKnowsTantor(player, npc));
    }
    public boolean imperial_empire_day_major_tantor_condition_hasCollectionsButNotCompleted(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean imperial_empire_day_major_tantor_condition_isLockedOutOfPropaganda(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return hasObjVar(player, holiday.EMPIRE_DAY_PROPAGANDA_LOCKED_OUT);
    }
    public boolean imperial_empire_day_major_tantor_condition_isLockedOutOfRecruitment(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return hasObjVar(player, holiday.EMPIRE_DAY_RECRUITMENT_LOCKED_OUT);
    }
    public boolean imperial_empire_day_major_tantor_condition_canDoPropagandaEvent(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean imperial_empire_day_major_tantor_condition_canDoRecruitmentEvent(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean imperial_empire_day_major_tantor_condition_canDoAtLeastOneEvent(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean imperial_empire_day_major_tantor_condition_isTrader(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return utils.isProfession(player, utils.TRADER);
    }
    public boolean imperial_empire_day_major_tantor_condition_isEntertainer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return utils.isProfession(player, utils.ENTERTAINER);
    }
    public boolean imperial_empire_day_major_tantor_condition_isTraderOrEntertainer(obj_id player, obj_id npc)
    {
    ...
    public boolean imperial_empire_day_major_tantor_condition_canCheckLeaderBoard(obj_id player, obj_id npc)
    {
    ...
    public boolean imperial_empire_day_major_tantor_condition_hasScore(obj_id player, obj_id npc)
    {
        return hasObjVar(player, holiday.PLAYER_EMPIRE_DAY_SCORE);
    }
    public boolean imperial_empire_day_major_tantor_condition_isNeutralRebel(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean imperial_empire_day_major_tantor_condition_isNewNeutralPlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean imperial_empire_day_major_tantor_condition_isNeutralRebelButImperial(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean imperial_empire_day_major_tantor_condition_isNeutralAlignedIncompletedCollections(obj_id player, obj_id npc)
    {
    ...
    public boolean imperial_empire_day_major_tantor_condition_isNeutralAligned(obj_id player, obj_id npc)
    {
        return ((getCollectionSlotValue(player, holiday.IMPERIAL_ANTIPROP_START_SLOT) > 0) || (getCollectionSlotValue(player, holiday.IMPERIAL_RECRUITING_START_SLOT) > 0));
    }
    public boolean imperial_empire_day_major_tantor_condition_hasBothRebAndImpKioskCollections(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public void imperial_empire_day_major_tantor_action_setSFRecruitmentEventOnPlayer(obj_id player, obj_id npc)
    {
    ...
    public void imperial_empire_day_major_tantor_action_resetPropagandaAndRecruitmentCollections(obj_id player, obj_id npc)
    {
    ...
    public void imperial_empire_day_major_tantor_action_setRecruitmentTimeStampOnPlayer(obj_id player, obj_id npc)
    {
        holiday.setEventLockOutTimeStamp(player, holiday.EMPIRE_DAY_RECRUITMENT_TIMESTAMP);
    }
    public void imperial_empire_day_major_tantor_action_setSFPropagandaEventOnPlayer(obj_id player, obj_id npc)
    {
    ...
    public void imperial_empire_day_major_tantor_action_giveMaraKaythreeWaypoint(obj_id player, obj_id npc)
    {
    ...
    public void imperial_empire_day_major_tantor_action_spawnTroopers(obj_id player, obj_id npc)
    {
        for (int i = 0; i < 3; i++)
        {
    ...
    public void imperial_empire_day_major_tantor_action_getLeaderBoardSui(obj_id player, obj_id npc)
    {
        obj_id tatooine = getPlanetByName("tatooine");
        if (!isIdValid(tatooine) || !exists(tatooine))
        {
    ...
    public void imperial_empire_day_major_tantor_action_setRecruitmentCollectionStarterSlot(obj_id player, obj_id npc)
    {
        modifyCollectionSlotValue(player, holiday.IMPERIAL_RECRUITING_START_SLOT, 1);
    }
    public void imperial_empire_day_major_tantor_action_setPropagandaCollectionStarterSlot(obj_id player, obj_id npc)
    {
        modifyCollectionSlotValue(player, holiday.IMPERIAL_ANTIPROP_START_SLOT, 1);
    }
    public void imperial_empire_day_major_tantor_action_setCombatantRecruitmentEventOnPlayer(obj_id player, obj_id npc)
    {
        if (getCollectionSlotValue(player, holiday.IMPERIAL_RECRUITING_START_SLOT) <= 0)
        {
            imperial_empire_day_major_tantor_action_setRecruitmentCollectionStarterSlot(player, npc);
    ...
    public void imperial_empire_day_major_tantor_action_setCombatantPropagandaEventOnPlayer(obj_id player, obj_id npc)
    {
        if (getCollectionSlotValue(player, holiday.IMPERIAL_ANTIPROP_START_SLOT) <= 0)
        {
            imperial_empire_day_major_tantor_action_setPropagandaCollectionStarterSlot(player, npc);
    ...
    public void imperial_empire_day_major_tantor_action_setPropagandaTimeStampOnPlayer(obj_id player, obj_id npc)
    {
        holiday.setEventLockOutTimeStamp(player, holiday.EMPIRE_DAY_PROPAGANDA_TIMESTAMP);
    }
    public void imperial_empire_day_major_tantor_action_checkHolidayTimeStampOnPlayer(obj_id player, obj_id npc)
    {
    ...
    public void imperial_empire_day_major_tantor_action_setLeaderBoardScore(obj_id player, obj_id npc)
    {
        if (!hasObjVar(player, holiday.PLAYER_EMPIRE_DAY_SCORE))
        {
            return;
    ...
    public void imperial_empire_day_major_tantor_action_makeNeutralImperial(obj_id player, obj_id npc)
    {
    ...
    public void imperial_empire_day_major_tantor_action_removeNeutralRebel(obj_id player, obj_id npc)
    {
        removeObjVar(player, holiday.PLAYER_EMPIRE_DAY_NEUTRAL + holiday.PLANET_VAR_PLAYER_FACTION_REB);
    }
    public void imperial_empire_day_major_tantor_action_removeFactionalObjVars(obj_id player, obj_id npc)
    {
    ...
    public void imperial_empire_day_major_tantor_action_removeRebCollections(obj_id player, obj_id npc)
    {
        String playerName = getPlayerFullName(player);
    ...
    public String imperial_empire_day_major_tantor_tokenTO_timeLeftRecruitment(obj_id player, obj_id npc)
    {
    ...
    public String imperial_empire_day_major_tantor_tokenTO_timeLeftPropaganda(obj_id player, obj_id npc)
    {
    ...
    public String imperial_empire_day_major_tantor_tokenTO_currentScore(obj_id player, obj_id npc)
    {
        if (!hasObjVar(player, holiday.PLAYER_EMPIRE_DAY_SCORE))
        {
    ...
    public int imperial_empire_day_major_tantor_tokenDI_notUsed(obj_id player, obj_id npc)
    {
        return 0;
    }
    public int imperial_empire_day_major_tantor_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_empire_day_major_tantor_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_empire_day_major_tantor_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_empire_day_major_tantor_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_173"))
        {
            if (imperial_empire_day_major_tantor_condition_hasCompletedBothCollections(player, npc))
    ...
    public int imperial_empire_day_major_tantor_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_empire_day_major_tantor_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_empire_day_major_tantor_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_empire_day_major_tantor_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_empire_day_major_tantor_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_empire_day_major_tantor_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_empire_day_major_tantor_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_empire_day_major_tantor_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_250"))
        {
            if (imperial_empire_day_major_tantor_condition__defaultCondition(player, npc))
    ...
    public int imperial_empire_day_major_tantor_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_empire_day_major_tantor_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_empire_day_major_tantor_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_empire_day_major_tantor_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_empire_day_major_tantor_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_empire_day_major_tantor_handleBranch31(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_empire_day_major_tantor_handleBranch32(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_empire_day_major_tantor_handleBranch33(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_250"))
        {
            if (imperial_empire_day_major_tantor_condition__defaultCondition(player, npc))
    ...
    public int imperial_empire_day_major_tantor_handleBranch35(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_74"))
        {
            if (imperial_empire_day_major_tantor_condition__defaultCondition(player, npc))
    ...
    public int imperial_empire_day_major_tantor_handleBranch36(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_empire_day_major_tantor_handleBranch37(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_250"))
        {
            if (imperial_empire_day_major_tantor_condition__defaultCondition(player, npc))
    ...
    public int imperial_empire_day_major_tantor_handleBranch38(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_empire_day_major_tantor_handleBranch39(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_empire_day_major_tantor_handleBranch40(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_250"))
        {
            if (imperial_empire_day_major_tantor_condition__defaultCondition(player, npc))
    ...
    public int imperial_empire_day_major_tantor_handleBranch42(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_empire_day_major_tantor_handleBranch43(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_empire_day_major_tantor_handleBranch44(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_250"))
        {
            if (imperial_empire_day_major_tantor_condition__defaultCondition(player, npc))
    ...
    public int imperial_empire_day_major_tantor_handleBranch46(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_empire_day_major_tantor_handleBranch47(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_250"))
        {
            if (imperial_empire_day_major_tantor_condition__defaultCondition(player, npc))
    ...
    public int imperial_empire_day_major_tantor_handleBranch49(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_empire_day_major_tantor_handleBranch50(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_empire_day_major_tantor_handleBranch51(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_250"))
        {
            if (imperial_empire_day_major_tantor_condition__defaultCondition(player, npc))
    ...
    public int imperial_empire_day_major_tantor_handleBranch53(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_empire_day_major_tantor_handleBranch54(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_empire_day_major_tantor_handleBranch55(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_250"))
        {
            if (imperial_empire_day_major_tantor_condition__defaultCondition(player, npc))
    ...
    public int imperial_empire_day_major_tantor_handleBranch57(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_empire_day_major_tantor_handleBranch58(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_250"))
        {
            if (imperial_empire_day_major_tantor_condition__defaultCondition(player, npc))
    ...
    public int imperial_empire_day_major_tantor_handleBranch60(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_empire_day_major_tantor_handleBranch62(obj_id player, obj_id npc, string_id response)
    {
