...
public class ep3_forest_sertild extends script.base_script
{
    ...
    public boolean ep3_forest_sertild_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_forest_sertild_condition_isTaskActiveOne(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "ep3_forest_dahlia_epic_3");
    }
    public boolean ep3_forest_sertild_condition_hasCompletedQuestOne(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "ep3_forest_dahlia_epic_4");
    }
    public void ep3_forest_sertild_action_giveSignalOne(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "start");
        groundquests.grantQuest(player, "ep3_forest_dahlia_epic_4");
    }
    public int ep3_forest_sertild_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_sertild_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
