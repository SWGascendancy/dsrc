...
public class npe_han_solo_falcon extends script.base_script
{
    ...
    public boolean npe_han_solo_falcon_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public void npe_han_solo_falcon_action_talkedToHan(obj_id player, obj_id npc)
    {
    ...
    public int npe_han_solo_falcon_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
