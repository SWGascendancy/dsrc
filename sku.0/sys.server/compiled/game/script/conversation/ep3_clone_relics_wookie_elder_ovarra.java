...
public class ep3_clone_relics_wookie_elder_ovarra extends script.base_script
{
    ...
    public boolean ep3_clone_relics_wookie_elder_ovarra_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_clone_relics_wookie_elder_ovarra_condition_knowWookiee(obj_id player, obj_id npc)
    {
        return utils.canSpeakWookiee(player, npc);
    }
    public boolean ep3_clone_relics_wookie_elder_ovarra_condition_onQuest2(obj_id player, obj_id npc)
    {
        return (groundquests.isQuestActive(player, "ep3_clone_relics_imprisoned_geonosian_2"));
    }
    public void ep3_clone_relics_wookie_elder_ovarra_action_giveReturnSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedToOvarra");
    }
    public void ep3_clone_relics_wookie_elder_ovarra_action_dontUnderstand(obj_id player, obj_id npc)
    {
        utils.emoteWookieeConfusion(player, npc);
    }
    public int ep3_clone_relics_wookie_elder_ovarra_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_wookie_elder_ovarra_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_wookie_elder_ovarra_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_wookie_elder_ovarra_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_wookie_elder_ovarra_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_wookie_elder_ovarra_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_wookie_elder_ovarra_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_wookie_elder_ovarra_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
