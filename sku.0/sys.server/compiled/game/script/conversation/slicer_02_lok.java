...
public class slicer_02_lok extends script.base_script
{
    ...
    public boolean slicer_02_lok_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean slicer_02_lok_condition_isGoingToDungeon(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "quest_06_conspire_cale", "GoToLabratory");
    }
    public boolean slicer_02_lok_condition_isGoingToDathomir(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "quest_08_dathomir_outpost", "travelDathomir");
    }
    public boolean slicer_02_lok_condition_isReadyForDungeon(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "quest_06_conspire_cale", "TravelToLokOutpost");
    }
    public boolean slicer_02_lok_condition_hasCompletedlokDungeon(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "quest_07_descend_into_labratory", "TakeDataPadCale");
    }
    public boolean slicer_02_lok_condition_canceledQuest06(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean slicer_02_lok_condition_canceledQuest07(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean slicer_02_lok_condition_canceledQuest08(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public void slicer_02_lok_action_sendSignalLokDungeon(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        groundquests.sendSignal(player, "TravelToLokOutpostComplete");
    }
    public void slicer_02_lok_action_grantQuest07WithWaypoint(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        groundquests.grantQuest(player, "quest_07_descend_into_labratory");
        slicer_02_lok_action_giveDungeonWaypoint(player, npc);
    }
    public void slicer_02_lok_action_sendDathomirSignal(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        groundquests.sendSignal(player, "TookDataPadCale");
    }
    public void slicer_02_lok_action_giveDungeonWaypoint(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public void slicer_02_lok_action_giveQuest08(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest_08_dathomir_outpost_final");
    }
    public int slicer_02_lok_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_02_lok_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_02_lok_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_02_lok_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_02_lok_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_02_lok_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_02_lok_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_02_lok_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_02_lok_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_02_lok_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_02_lok_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_02_lok_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
