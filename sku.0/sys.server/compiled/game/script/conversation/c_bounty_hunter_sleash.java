...
public class c_bounty_hunter_sleash extends script.base_script
{
    ...
    public boolean c_bounty_hunter_sleash_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_bounty_hunter_sleash_condition_isTaskActiveBounty1(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "c_bounty_hunter_kill_1", "bounty_hunter_kill_1_e9");
    }
    public boolean c_bounty_hunter_sleash_condition_hasCompletedQuestBounty1(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedQuest(player, "c_bounty_hunter_kill_1"));
    }
    public boolean c_bounty_hunter_sleash_condition_onGiveDrug(obj_id player, obj_id npc)
    {
    ...
    public boolean c_bounty_hunter_sleash_condition_gotDrug(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/c_bounty_hunter_kill_1");
    ...
    public void c_bounty_hunter_sleash_action_giveSignalTalk(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "bounty_hunter_kill_1_launch_e10");
    }
    public void c_bounty_hunter_sleash_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int c_bounty_hunter_sleash_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_bounty_hunter_sleash_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_bounty_hunter_sleash_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_bounty_hunter_sleash_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_bounty_hunter_sleash_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
