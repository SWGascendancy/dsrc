...
public class emp_day_reb_colonel extends script.base_script
{
    ...
    public boolean emp_day_reb_colonel_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean emp_day_reb_colonel_condition_isRebel(obj_id player, obj_id npc)
    {
    ...
    public boolean emp_day_reb_colonel_condition_notReadyForYou(obj_id player, obj_id npc)
    {
    ...
    public boolean emp_day_reb_colonel_condition_questCompleted(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/emp_day_rebel");
        return questIsQuestComplete(questId, player);
    }
    public boolean emp_day_reb_colonel_condition_hasTask6(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/emp_day_rebel");
    ...
    public boolean emp_day_reb_colonel_condition_isNeutral(obj_id player, obj_id npc)
    {
        int factionHashCode = factions.pvpGetAlignedFaction(player);
        String whichFaction = factions.getFactionNameByHashCode(factionHashCode);
        if (whichFaction == null)
    ...
    public boolean emp_day_reb_colonel_condition_hasTask8(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/emp_day_rebel");
        int task8 = groundquests.getTaskId(questId, "empDayComplete");
        return questIsTaskActive(questId, task8, player);
    }
    public boolean emp_day_reb_colonel_condition_isImperial(obj_id player, obj_id npc)
    {
        int factionHashCode = factions.pvpGetAlignedFaction(player);
        String whichFaction = factions.getFactionNameByHashCode(factionHashCode);
        if (whichFaction == null)
    ...
    public boolean emp_day_reb_colonel_condition_hasTask7(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/emp_day_rebel");
        int task7 = groundquests.getTaskId(questId, "toSolo");
        int factionHashCode = factions.pvpGetAlignedFaction(player);
    ...
    public boolean emp_day_reb_colonel_condition_convertOfficer(obj_id player, obj_id npc)
    {
        return (getIntObjVar(player, "event.emp_day.converted_officer") == 1);
    }
    public void emp_day_reb_colonel_action_rewardAndEndNow(obj_id player, obj_id npc)
    {
    ...
    public void emp_day_reb_colonel_action_giveSoloAccess(obj_id player, obj_id npc)
    {
        setObjVar(player, "event.emp_day.han_access", 0);
        groundquests.sendSignal(player, "to_rebel_colonel");
    }
    public void emp_day_reb_colonel_action_signal6(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "to_rebel_colonel");
    }
    public void emp_day_reb_colonel_action_rewardAndTwoBanners(obj_id player, obj_id npc)
    {
        obj_id playerInventory = utils.getInventoryContainer(player);
        obj_id createdObject = createObject("object/tangible/furniture/all/frn_all_banner_rebel.iff", playerInventory, "");
    ...
    public int emp_day_reb_colonel_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_reb_colonel_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_reb_colonel_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_reb_colonel_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_reb_colonel_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
