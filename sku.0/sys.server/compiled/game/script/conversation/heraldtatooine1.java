...
public class heraldtatooine1 extends script.base_script
{
    ...
    public boolean heraldtatooine1_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public void heraldtatooine1_action__defaultAction(obj_id player, obj_id npc)
    {
    }
    public void heraldtatooine1_action_waypoint1(obj_id player, obj_id npc)
    {
    ...
    public void heraldtatooine1_action_waypoint2(obj_id player, obj_id npc)
    {
    ...
    public void heraldtatooine1_action_shake(obj_id player, obj_id npc)
    {
