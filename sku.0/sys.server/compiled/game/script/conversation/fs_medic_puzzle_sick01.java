...
public class fs_medic_puzzle_sick01 extends script.base_script
{
    ...
    public boolean fs_medic_puzzle_sick01_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean fs_medic_puzzle_sick01_condition_onHealingQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean fs_medic_puzzle_sick01_condition_hasSymptoms(obj_id player, obj_id npc)
    {
    ...
    public boolean fs_medic_puzzle_sick01_condition_onCombatHealingQuest(obj_id player, obj_id npc)
    {
        boolean result = false;
        if (quests.isActive("fs_combat_healing_1", player) || quests.isActive("fs_combat_healing_2", player))
        {
    ...
    public void fs_medic_puzzle_sick01_action_giveSymptoms(obj_id player, obj_id npc)
    {
        if (!isIdValid(player))
        {
    ...
    public String fs_medic_puzzle_sick01_tokenTO_getSymptoms(obj_id player, obj_id npc)
    {
        if (!isIdValid(player))
        {
            LOG("fs_quest", "Medic Puzzle -- player is invalid.");
    ...
    public String fs_medic_puzzle_sick01_tokenTO_numberHealed(obj_id player, obj_id npc)
    {
        int totalhealed = 0;
