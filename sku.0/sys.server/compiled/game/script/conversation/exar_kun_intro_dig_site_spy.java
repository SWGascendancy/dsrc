...
public class exar_kun_intro_dig_site_spy extends script.base_script
{
    ...
    public boolean exar_kun_intro_dig_site_spy_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean exar_kun_intro_dig_site_spy_condition_exar_kun_02_02_active(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "exar_kun_intro_02", "exar_kun_intro_02_02");
    }
    public void exar_kun_intro_dig_site_spy_action_exar_kun_02_02_signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "exar_kun_intro_02_02");
    }
    public int exar_kun_intro_dig_site_spy_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int exar_kun_intro_dig_site_spy_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
