...
public class naboo_theed_sgt_brunser extends script.base_script
{
    ...
    public boolean naboo_theed_sgt_brunser_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean naboo_theed_sgt_brunser_condition_startBoosterQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_theed_sgt_brunser_condition_onBoosterQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "naboo_theed_terrorist_terrorize");
    }
    public boolean naboo_theed_sgt_brunser_condition_completedBoosterQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "naboo_theed_terrorist_terrorize");
    }
    public boolean naboo_theed_sgt_brunser_condition_lastStepBoosterQuest(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "naboo_theed_terrorist_terrorize", "theed_terrorist_terrorize_09");
    }
    public void naboo_theed_sgt_brunser_action_grantTerrorize(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "naboo_theed_terrorist_terrorize");
    }
    public void naboo_theed_sgt_brunser_action_signal_booster_09(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "theed_terrorist_terrorize_09");
    }
    public void naboo_theed_sgt_brunser_action_endGotoBrunser(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "theed_goto_brunser");
    }
    public int naboo_theed_sgt_brunser_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_sgt_brunser_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_sgt_brunser_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
