...
public class corellia_38_jaylon_geissler extends script.base_script
{
    ...
    public boolean corellia_38_jaylon_geissler_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_38_jaylon_geissler_condition_taskOneActive(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_38_corsec_files_04", "corsec_files_04_02");
    }
    public boolean corellia_38_jaylon_geissler_condition_taskTwoActive(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_38_jaylon_geissler_condition_questComplete(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "corellia_38_corsec_files_04", "corsec_files_04_03");
    }
    public void corellia_38_jaylon_geissler_action_taskOneCompletedSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "corsec_files_04_02");
    }
    public int corellia_38_jaylon_geissler_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
