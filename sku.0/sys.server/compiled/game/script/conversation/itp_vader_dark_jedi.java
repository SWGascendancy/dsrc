...
public class itp_vader_dark_jedi extends script.base_script
{
    ...
    public boolean itp_vader_dark_jedi_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean itp_vader_dark_jedi_condition_vaderTaskActive(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "itp_vader_02", "itp_vader_02_03");
    }
    public boolean itp_vader_dark_jedi_condition_vaderKillJediActive(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "itp_vader_02", "itp_vader_02_04");
    }
    public void itp_vader_dark_jedi_action_vaderSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "itp_vader_02_03");
    }
    public void itp_vader_dark_jedi_action_attack(obj_id player, obj_id npc)
    {
    ...
    public int itp_vader_dark_jedi_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int itp_vader_dark_jedi_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
