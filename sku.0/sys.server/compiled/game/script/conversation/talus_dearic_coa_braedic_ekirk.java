...
public class talus_dearic_coa_braedic_ekirk extends script.base_script
{
    ...
    public boolean talus_dearic_coa_braedic_ekirk_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean talus_dearic_coa_braedic_ekirk_condition_main_quest_accepted(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "talus_dearic_crisis_of_allegiance");
    }
    public boolean talus_dearic_coa_braedic_ekirk_condition_imperial_quest_accepted(obj_id player, obj_id npc)
    {
    ...
    public boolean talus_dearic_coa_braedic_ekirk_condition_imperial_tasks_complete(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "talus_dearic_coa_imperial_view_end", "talus_dearic_coa_imperial_gratitude_wfs");
    }
    public boolean talus_dearic_coa_braedic_ekirk_condition_imperial_quest_complete(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "talus_dearic_coa_imperial_view_end");
    }
    public void talus_dearic_coa_braedic_ekirk_action_accept_imperial_quest(obj_id player, obj_id npc)
    {
    ...
    public void talus_dearic_coa_braedic_ekirk_action_complete_imperial_quest(obj_id player, obj_id npc)
    {
    ...
    public int talus_dearic_coa_braedic_ekirk_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_coa_braedic_ekirk_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_coa_braedic_ekirk_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_coa_braedic_ekirk_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_coa_braedic_ekirk_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_coa_braedic_ekirk_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_coa_braedic_ekirk_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_coa_braedic_ekirk_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
