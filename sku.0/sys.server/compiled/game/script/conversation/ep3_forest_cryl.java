...
public class ep3_forest_cryl extends script.base_script
{
    ...
    public boolean ep3_forest_cryl_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_forest_cryl_condition_isGoodGuy(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_forest_cryl_condition_isBadGuy(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_forest_cryl_condition_hasCompleteInitial(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_forest_aveso_quest_2");
    }
    public boolean ep3_forest_cryl_condition_isTaskActiveOne(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_forest_cryl_condition_hasCompletedTaskOne(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_forest_cryl_condition_hasCompletedQuestOne(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_forest_cryl_quest_1");
    }
    public boolean ep3_forest_cryl_condition_isTaskActiveTwo(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_forest_cryl_condition_hasCompletedTaskTwo(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_forest_cryl_condition_hasCompletedQuestTwo(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_forest_cryl_quest_2");
    }
    public void ep3_forest_cryl_action_giveQuestOne(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_forest_cryl_quest_1");
    }
    public void ep3_forest_cryl_action_giveSignalOne(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "mix");
    }
    public void ep3_forest_cryl_action_giveQuestTwo(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_forest_cryl_quest_2");
    }
    public void ep3_forest_cryl_action_giveSignalTwo(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "finish");
    }
    public int ep3_forest_cryl_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_cryl_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_cryl_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_cryl_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_cryl_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_cryl_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_cryl_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_cryl_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_cryl_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
