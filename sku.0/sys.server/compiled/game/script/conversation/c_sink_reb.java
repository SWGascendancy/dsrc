...
public class c_sink_reb extends script.base_script
{
    ...
    public boolean c_sink_reb_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_sink_reb_condition_IsRebel1(obj_id player, obj_id npc)
    {
    ...
    public boolean c_sink_reb_condition_IsImperial(obj_id player, obj_id npc)
    {
    ...
    public boolean c_sink_reb_condition_isNeutral(obj_id player, obj_id npc)
    {
    ...
    public boolean c_sink_reb_condition_broughtPilotBack(obj_id player, obj_id npc)
    {
    ...
    public boolean c_sink_reb_condition_firstStepofQuest(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/c_sink_reb");
    ...
    public boolean c_sink_reb_condition_gangKillStepDone(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/c_sink_reb");
    ...
    public boolean c_sink_reb_condition_gangKillStepNotDone(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/c_sink_reb");
        int spacesignal = groundquests.getTaskId(questId, "spacesignal");
        int killloot = groundquests.getTaskId(questId, "killloot");
    ...
    public boolean c_sink_reb_condition_gangKillStepActive(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/c_sink_reb");
        int spacesignal = groundquests.getTaskId(questId, "spacesignal");
        return questIsTaskActive(questId, spacesignal, player);
    }
    public boolean c_sink_reb_condition_noGangsKilledYet(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/c_sink_reb");
        int spacesignal = groundquests.getTaskId(questId, "spacesignal");
        int killloot = groundquests.getTaskId(questId, "killloot");
    ...
    public boolean c_sink_reb_condition_hasJTL(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_sink_reb_condition_spaceWon(obj_id player, obj_id npc)
    {
    ...
    public boolean c_sink_reb_condition_spaceLost(obj_id player, obj_id npc)
    {
    ...
    public boolean c_sink_reb_condition_spaceStepActive(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/c_sink_reb");
        int spaceactive = groundquests.getTaskId(questId, "spaceactive");
        return questIsTaskActive(questId, spaceactive, player);
    }
    public void c_sink_reb_action_giveQuest(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/c_sink_reb");
    ...
    public void c_sink_reb_action_faceplayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void c_sink_reb_action_forwardQuestAfterEscort(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/c_sink_reb");
    ...
    public void c_sink_reb_action_giveWaypoint(obj_id player, obj_id npc)
    {
        obj_id waypoint2 = getObjIdObjVar(player, "quest.general.quest/c_sink_reb.pilot");
        if (waypoint2 != null)
        {
    ...
    public void c_sink_reb_action_rewardSignal(obj_id player, obj_id npc)
    {
    ...
    public void c_sink_reb_action_giveSpace(obj_id player, obj_id npc)
    {
    ...
    public int c_sink_reb_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_sink_reb_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_sink_reb_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_sink_reb_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_sink_reb_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_sink_reb_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_sink_reb_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_sink_reb_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_sink_reb_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_sink_reb_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_sink_reb_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_sink_reb_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_sink_reb_handleBranch30(obj_id player, obj_id npc, string_id response)
    {
