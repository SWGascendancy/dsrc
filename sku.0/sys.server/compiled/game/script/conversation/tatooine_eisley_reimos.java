...
public class tatooine_eisley_reimos extends script.base_script
{
    ...
    public boolean tatooine_eisley_reimos_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tatooine_eisley_reimos_condition_sdQuestComplete(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_eisley_special_delivery");
        boolean OnTask = (questIsQuestComplete(questId1, player));
        return OnTask;
    }
    public boolean tatooine_eisley_reimos_condition_nikoQuestComplete(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_eisley_nikos_coins");
        boolean OnTask = (questIsQuestComplete(questId1, player));
        return OnTask;
    }
    public boolean tatooine_eisley_reimos_condition_diQuestComplete(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_eisley_digital_infection");
        boolean OnTask = (questIsQuestComplete(questId1, player));
        return OnTask;
    }
    public boolean tatooine_eisley_reimos_condition_dpOnTask(obj_id player, obj_id npc)
    {
    ...
    public boolean tatooine_eisley_reimos_condition_diOnTask(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_eisley_digital_infection");
    ...
    public boolean tatooine_eisley_reimos_condition_diTaskComplete(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_eisley_digital_infection");
    ...
    public boolean tatooine_eisley_reimos_condition_dpQuestComplete(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_eisley_data_purge");
        boolean OnTask = (questIsQuestComplete(questId1, player));
        return OnTask;
    }
    public boolean tatooine_eisley_reimos_condition_hiddenQuestComplete(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_eisley_hidden_agenda");
        boolean OnTask = (questIsQuestComplete(questId1, player));
        return OnTask;
    }
    public boolean tatooine_eisley_reimos_condition_hiddenOnTask(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_eisley_hidden_agenda");
    ...
    public boolean tatooine_eisley_reimos_condition_hiddenTaskComplete(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_eisley_hidden_agenda");
    ...
    public boolean tatooine_eisley_reimos_condition_epiQuestComplete(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_eisley_epidemic");
        boolean OnTask = (questIsQuestComplete(questId1, player));
        return OnTask;
    }
    public boolean tatooine_eisley_reimos_condition_heirQuestComlete(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_eisley_heirloom");
        boolean OnTask = (questIsQuestComplete(questId1, player));
        return OnTask;
    }
    public boolean tatooine_eisley_reimos_condition_foeQuestComplete(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_eisley_faceevil");
        boolean OnTask = (questIsQuestComplete(questId1, player));
        return OnTask;
    }
    public boolean tatooine_eisley_reimos_condition_dbOnTask(obj_id player, obj_id npc)
    {
    ...
    public boolean tatooine_eisley_reimos_condition_dpTaskComplete(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_eisley_data_purge");
    ...
    public boolean tatooine_eisley_reimos_condition_blocker(obj_id player, obj_id npc)
    {
        return groundquests.isQuestDisabled("tatooine_eisley_digital_infection");
    }
    public boolean tatooine_eisley_reimos_condition_boneQuestComplete(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_eisley_bone_gnasher");
        boolean OnTask = (questIsQuestComplete(questId1, player));
        return OnTask;
    }
    public boolean tatooine_eisley_reimos_condition_gotoReimosDIComplete(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_eisley_gotoreimos");
        boolean OnTask = (questIsQuestComplete(questId1, player));
        return OnTask;
    }
    public boolean tatooine_eisley_reimos_condition_returnReimosComplete(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_eisley_returnreimos");
        boolean OnTask = (questIsQuestComplete(questId1, player));
        return OnTask;
    }
    public boolean tatooine_eisley_reimos_condition_answersComplete(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_eisley_answers");
        boolean OnTask = (questIsQuestComplete(questId1, player));
        return OnTask;
    }
    public boolean tatooine_eisley_reimos_condition_dbQuestComplete(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_eisley_drensbounty");
        boolean OnTask = (questIsQuestComplete(questId1, player));
        return OnTask;
    }
    public boolean tatooine_eisley_reimos_condition_answersActive(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "quest/tatooine_eisley_answers");
    }
    public void tatooine_eisley_reimos_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void tatooine_eisley_reimos_action_grantDBQuest(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/tatooine_eisley_drensbounty");
        groundquests.grantQuest(questId, player, npc, true);
    }
    public void tatooine_eisley_reimos_action_grantDIQuest(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/tatooine_eisley_digital_infection");
        groundquests.grantQuest(questId, player, npc, true);
    }
    public void tatooine_eisley_reimos_action_grantHAQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tat_eisley_infection_e2");
        int questId = questGetQuestId("quest/tatooine_eisley_hidden_agenda");
        groundquests.grantQuest(questId, player, npc, true);
    }
    public void tatooine_eisley_reimos_action_grantDELQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tat_eisley_hidden_e2");
        int questId = questGetQuestId("quest/tatooine_eisley_data_purge");
        groundquests.grantQuest(questId, player, npc, true);
    }
    public void tatooine_eisley_reimos_action_signalLegacyUpdateAigorn(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tat_eisley_legacy_e2");
    }
    public void tatooine_eisley_reimos_action_signalLegacyUpdateKashi(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tat_eisley_legacy_e4");
    }
    public void tatooine_eisley_reimos_action_signalDIReward(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        groundquests.sendSignal(player, "tat_eisley_infection_e2");
    }
    public void tatooine_eisley_reimos_action_signalHAReward(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        groundquests.sendSignal(player, "tat_eisley_hidden_e2");
    }
    public void tatooine_eisley_reimos_action_signalDPReward(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        groundquests.sendSignal(player, "tat_eisley_datapurge_e2");
    }
    public void tatooine_eisley_reimos_action_grantGotoTori(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/tatooine_eisley_gototori");
        groundquests.grantQuest(questId, player, npc, true);
    }
    public void tatooine_eisley_reimos_action_signalGotoReimos(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        groundquests.sendSignal(player, "tat_dunir_reimos_e1");
    }
    public void tatooine_eisley_reimos_action_signalReturnReimos(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        groundquests.sendSignal(player, "tat_tori_reimos_e1");
    }
    public void tatooine_eisley_reimos_action_grantAnswers(obj_id player, obj_id npc)
    {
    ...
    public void tatooine_eisley_reimos_action_grantFaceofEvil(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/tatooine_eisley_faceevil");
        groundquests.grantQuest(questId, player, npc, true);
    }
    public void tatooine_eisley_reimos_action_action0001(obj_id player, obj_id npc)
    {
    }
    public int tatooine_eisley_reimos_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_262"))
        {
            if (tatooine_eisley_reimos_condition__defaultCondition(player, npc))
    ...
    public int tatooine_eisley_reimos_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_442"))
        {
            if (tatooine_eisley_reimos_condition__defaultCondition(player, npc))
    ...
    public int tatooine_eisley_reimos_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch31(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch32(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch33(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch34(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch35(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch37(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch38(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch40(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch41(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch42(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch43(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_358"))
        {
            if (tatooine_eisley_reimos_condition__defaultCondition(player, npc))
    ...
    public int tatooine_eisley_reimos_handleBranch44(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch45(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch46(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch48(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch49(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch50(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch51(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch54(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch55(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch57(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch58(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch60(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch61(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch62(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch63(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch64(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_280"))
        {
            if (tatooine_eisley_reimos_condition__defaultCondition(player, npc))
    ...
    public int tatooine_eisley_reimos_handleBranch65(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch67(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch68(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch69(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_handleBranch70(obj_id player, obj_id npc, string_id response)
    {
