...
public class imperial_empire_day_supply_officer extends script.base_script
{
    ...
    public boolean imperial_empire_day_supply_officer_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean imperial_empire_day_supply_officer_condition_hasNotCraftedSupplies(obj_id player, obj_id npc)
    {
    ...
    public boolean imperial_empire_day_supply_officer_condition_hasCompletedFirstMission(obj_id player, obj_id npc)
    {
    ...
    public boolean imperial_empire_day_supply_officer_condition_hasImperialMissionActiveWithTask(obj_id player, obj_id npc)
    {
        for (int i = 0; i < holiday.ALL_IMPERIAL_QUESTS.length; i++)
        {
    ...
    public void imperial_empire_day_supply_officer_action_activateDeliverySignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "spokeToSupplyOfficer");
    }
    public int imperial_empire_day_supply_officer_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_empire_day_supply_officer_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
