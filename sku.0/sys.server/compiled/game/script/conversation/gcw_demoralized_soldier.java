...
public class gcw_demoralized_soldier extends script.base_script
{
    ...
    public boolean gcw_demoralized_soldier_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean gcw_demoralized_soldier_condition_isReadyToTalkImperial(obj_id player, obj_id npc)
    {
    ...
    public boolean gcw_demoralized_soldier_condition_isReadyToTalkRebel(obj_id player, obj_id npc)
    {
    ...
    public void gcw_demoralized_soldier_action_convinced(obj_id player, obj_id npc)
    {
    ...
    public void gcw_demoralized_soldier_action_notConvinced(obj_id player, obj_id npc)
    {
        messageTo(npc, "notConvinced", null, 0f, false);
    }
    public int gcw_demoralized_soldier_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int gcw_demoralized_soldier_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int gcw_demoralized_soldier_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int gcw_demoralized_soldier_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int gcw_demoralized_soldier_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int gcw_demoralized_soldier_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int gcw_demoralized_soldier_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int gcw_demoralized_soldier_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
