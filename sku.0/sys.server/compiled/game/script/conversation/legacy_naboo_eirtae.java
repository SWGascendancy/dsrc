...
public class legacy_naboo_eirtae extends script.base_script
{
    ...
    public boolean legacy_naboo_eirtae_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean legacy_naboo_eirtae_condition_completedEirtaesQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean legacy_naboo_eirtae_condition_isOnEirtaesQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean legacy_naboo_eirtae_condition_killingTuskCats(obj_id player, obj_id npc)
    {
    ...
    public void legacy_naboo_eirtae_action_startEirtaesQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "startEirtaeQuest");
    }
    public int legacy_naboo_eirtae_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_naboo_eirtae_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_naboo_eirtae_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_naboo_eirtae_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_naboo_eirtae_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
