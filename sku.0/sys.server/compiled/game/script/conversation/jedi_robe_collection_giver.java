...
public class jedi_robe_collection_giver extends script.base_script
{
    ...
    public boolean jedi_robe_collection_giver_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean jedi_robe_collection_giver_condition_isEligible_JediRobeCollection(obj_id player, obj_id npc)
    {
    ...
    public boolean jedi_robe_collection_giver_condition_isActive_jediRobeCollection(obj_id player, obj_id npc)
    {
        return hasCompletedCollectionSlot(player, "jedi_robe_01_01");
    }
    public boolean jedi_robe_collection_giver_condition_ineligibleJedi(obj_id player, obj_id npc)
    {
        if (utils.isProfession(player, utils.FORCE_SENSITIVE))
        {
            if (getLevel(player) < 85)
    ...
    public boolean jedi_robe_collection_giver_condition_isComplete_jediRobeCollection(obj_id player, obj_id npc)
    {
        return hasCompletedCollection(player, "jedi_robe_01");
    }
    public void jedi_robe_collection_giver_action_activateJediRobeCollection(obj_id player, obj_id npc)
    {
        if (!hasCompletedCollectionSlot(player, "jedi_robe_01_01"))
        {
    ...
    public int jedi_robe_collection_giver_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
