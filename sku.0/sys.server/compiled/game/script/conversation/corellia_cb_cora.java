...
public class corellia_cb_cora extends script.base_script
{
    ...
    public boolean corellia_cb_cora_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_cb_cora_condition_offerQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_cb_cora_condition_onQuest1(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_cb_cora_condition_cb2_finish(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_cb_cora_condition_offerQuest3(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_cb_cora_condition_onQuest3(obj_id player, obj_id npc)
    {
        if (groundquests.isQuestActive(player, "quest/corellia_cb_3"))
        {
            return true;
    ...
    public boolean corellia_cb_cora_condition_cb3_finish(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_cb_cora_condition_offerPointer4(obj_id player, obj_id npc)
    {
        if (groundquests.hasCompletedQuest(player, "quest/corellia_cb_3"))
        {
    ...
    public boolean corellia_cb_cora_condition_cb_finished(obj_id player, obj_id npc)
    {
        if (groundquests.hasCompletedQuest(player, "quest/corellia_cb_3"))
        {
            return true;
    ...
    public boolean corellia_cb_cora_condition_offerSideQuest(obj_id player, obj_id npc)
    {
    ...
    public void corellia_cb_cora_action_sendPointerSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "cb_2_cora");
        return;
    }
    public void corellia_cb_cora_action_grantSecondQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest/corellia_cb_2");
        return;
    }
    public void corellia_cb_cora_action_sendFinishSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "cb_2_cora_complete");
        return;
    }
    public void corellia_cb_cora_action_grantThirdQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest/corellia_cb_3");
        return;
    }
    public void corellia_cb_cora_action_sendFinish3Signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "cb_3_finish");
        return;
    }
    public void corellia_cb_cora_action_grantPointerQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest/corellia_cb_4_pointer");
        return;
    }
    public void corellia_cb_cora_action_grantSideQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest/corellia_cb_side_1");
    }
    public int corellia_cb_cora_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_cb_cora_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_cb_cora_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_cb_cora_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_cb_cora_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_cb_cora_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_cb_cora_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_cb_cora_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_cb_cora_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_cb_cora_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_cb_cora_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_cb_cora_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_cb_cora_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_cb_cora_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_72"))
        {
            corellia_cb_cora_action_grantPointerQuest(player, npc);
    ...
    public int corellia_cb_cora_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_cb_cora_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
