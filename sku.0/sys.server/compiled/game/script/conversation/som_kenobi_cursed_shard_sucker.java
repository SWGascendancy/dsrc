...
public class som_kenobi_cursed_shard_sucker extends script.base_script
{
    ...
    public boolean som_kenobi_cursed_shard_sucker_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean som_kenobi_cursed_shard_sucker_condition_givingAwayCrystal(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "som_kenobi_cursed_shard_2", "givingUpShard");
    }
    public boolean som_kenobi_cursed_shard_sucker_condition_playerJedi(obj_id player, obj_id npc)
    {
        return jedi.isForceSensitive(player);
    }
    public void som_kenobi_cursed_shard_sucker_action_signalGivenCrystal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "gaveAwayShard");
    }
    public int som_kenobi_cursed_shard_sucker_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_cursed_shard_sucker_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_cursed_shard_sucker_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_cursed_shard_sucker_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_cursed_shard_sucker_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_cursed_shard_sucker_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_cursed_shard_sucker_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
