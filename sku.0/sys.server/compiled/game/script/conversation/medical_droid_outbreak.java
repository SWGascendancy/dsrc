...
public class medical_droid_outbreak extends script.base_script
{
    ...
    public boolean medical_droid_outbreak_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean medical_droid_outbreak_condition_hasSpokenToCody(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public void medical_droid_outbreak_action_giveAntiVirus(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "outbreak.innoculated", 1);
        buff.applyBuff(player, "death_troopers_inoculation");
    }
    public int medical_droid_outbreak_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
