...
public class corellia_tyrena_akkus extends script.base_script
{
    ...
    public boolean corellia_tyrena_akkus_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_tyrena_akkus_condition_talkAkkus(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_tyrena_slaver_access", "talk_to_akkus_3a");
    }
    public boolean corellia_tyrena_akkus_condition_onSlaverAccess(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_tyrena_akkus_condition_completeSlaverAccess(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "corellia_tyrena_slaver_access");
    }
    public void corellia_tyrena_akkus_action_signalAkkus(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talk_to_akkus_3a");
    }
    public int corellia_tyrena_akkus_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_akkus_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_akkus_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_akkus_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_akkus_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_akkus_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
