...
public class npe_rebel_questgiver extends script.base_script
{
    ...
    public boolean npe_rebel_questgiver_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_rebel_questgiver_condition_isTask1Done(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_rebel_1", "wait");
    }
    public boolean npe_rebel_questgiver_condition_hasFinishedTemplate(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "npe.finishedTemplate");
    }
    public boolean npe_rebel_questgiver_condition_impQuestActiveOrComplete(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "npe_imperial_1");
    }
    public boolean npe_rebel_questgiver_condition_finishedQuest1(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedQuest(player, "npe_rebel_1") && !groundquests.hasCompletedQuest(player, "npe_rebel_2"));
    }
    public boolean npe_rebel_questgiver_condition_finishedAll(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedQuest(player, "npe_rebel_1") && groundquests.hasCompletedQuest(player, "npe_rebel_2"));
    }
    public boolean npe_rebel_questgiver_condition_isTask2Done(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_rebel_2", "return");
    }
    public boolean npe_rebel_questgiver_condition_isGetInfoTaskActive(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "npe_rebel_2", "slicing") || groundquests.isTaskActive(player, "npe_rebel_2", "accessSpace"));
    }
    public void npe_rebel_questgiver_action_grantQuest1(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_rebel_1");
    }
    public void npe_rebel_questgiver_action_sendQuest1Signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_rebel_1_wait");
    }
    public void npe_rebel_questgiver_action_giveQuest2(obj_id player, obj_id npc)
    {
    ...
    public void npe_rebel_questgiver_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void npe_rebel_questgiver_action_sendQuest2Signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_rebel_2_complete");
    }
    public void npe_rebel_questgiver_action_groupPopUp(obj_id player, obj_id npc)
    {
        messageTo(player, "groupPopUp1", null, 0, false);
        messageTo(player, "groupPopUp2", null, 5, false);
    }
    public int npe_rebel_questgiver_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_rebel_questgiver_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_rebel_questgiver_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_rebel_questgiver_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_rebel_questgiver_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_rebel_questgiver_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_rebel_questgiver_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_rebel_questgiver_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_rebel_questgiver_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_rebel_questgiver_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_20"))
        {
            if (npe_rebel_questgiver_condition__defaultCondition(player, npc))
    ...
    public int npe_rebel_questgiver_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_rebel_questgiver_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_rebel_questgiver_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
