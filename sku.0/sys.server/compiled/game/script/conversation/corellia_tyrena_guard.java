...
public class corellia_tyrena_guard extends script.base_script
{
    ...
    public boolean corellia_tyrena_guard_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_tyrena_guard_condition_talkGuard(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_tyrena_lost_love", "lost_helpful_guard");
    }
    public boolean corellia_tyrena_guard_condition_completeLost(obj_id player, obj_id npc)
    {
    ...
    public void corellia_tyrena_guard_action_signalGuard(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "lost_helpful_guard");
    }
    public int corellia_tyrena_guard_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_guard_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_guard_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
