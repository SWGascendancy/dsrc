...
public class talus_dearic_coa_galiir_ac_yandar extends script.base_script
{
    ...
    public boolean talus_dearic_coa_galiir_ac_yandar_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean talus_dearic_coa_galiir_ac_yandar_condition_speak_galiir(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "talus_dearic_coa_imperial_view", "talus_dearic_coa_speak_galiir_wfs");
    }
    public boolean talus_dearic_coa_galiir_ac_yandar_condition_on_nsh_tasks(obj_id player, obj_id npc)
    {
    ...
    public boolean talus_dearic_coa_galiir_ac_yandar_condition_nsh_tasks_complete(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "talus_dearic_coa_imperial_view_end", "talus_dearic_coa_lag_tasks_reported_wfs");
    }
    public boolean talus_dearic_coa_galiir_ac_yandar_condition_nsh_tasks_reported(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "talus_dearic_coa_imperial_view_end", "talus_dearic_coa_lag_tasks_reported_wfs");
    }
    public boolean talus_dearic_coa_galiir_ac_yandar_condition_abandoned_deep_cover(obj_id player, obj_id npc)
    {
    ...
    public void talus_dearic_coa_galiir_ac_yandar_action_accept_nsh_tasks(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talus_dearic_coa_lag_tasks_accepted");
    }
    public void talus_dearic_coa_galiir_ac_yandar_action_complete_nsh_tasks(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talus_dearic_coa_lag_tasks_reported");
    }
    public void talus_dearic_coa_galiir_ac_yandar_action_grant_deep_cover_qst(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "talus_dearic_coa_deep_cover");
    }
    public int talus_dearic_coa_galiir_ac_yandar_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_coa_galiir_ac_yandar_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_coa_galiir_ac_yandar_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_coa_galiir_ac_yandar_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_coa_galiir_ac_yandar_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_coa_galiir_ac_yandar_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_coa_galiir_ac_yandar_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_coa_galiir_ac_yandar_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_coa_galiir_ac_yandar_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_coa_galiir_ac_yandar_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_coa_galiir_ac_yandar_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_coa_galiir_ac_yandar_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
