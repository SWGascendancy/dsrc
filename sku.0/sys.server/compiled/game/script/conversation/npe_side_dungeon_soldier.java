...
public class npe_side_dungeon_soldier extends script.base_script
{
    ...
    public boolean npe_side_dungeon_soldier_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_side_dungeon_soldier_condition_hasFinishedTemplate(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "npe.finishedTemplate");
    }
    public boolean npe_side_dungeon_soldier_condition_stillOnTask(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_side_dungeon_soldier", "kill_soldier");
    }
    public boolean npe_side_dungeon_soldier_condition_taskComplete(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_side_dungeon_soldier_condition_canTakeQuest(obj_id player, obj_id npc)
    {
        return !groundquests.isQuestActiveOrComplete(player, "npe_side_dungeon_soldier");
    }
    public void npe_side_dungeon_soldier_action_giveQuest(obj_id player, obj_id npc)
    {
    ...
    public void npe_side_dungeon_soldier_action_singalEnd(obj_id player, obj_id npc)
    {
    ...
    public void npe_side_dungeon_soldier_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int npe_side_dungeon_soldier_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_side_dungeon_soldier_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_side_dungeon_soldier_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_side_dungeon_soldier_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_side_dungeon_soldier_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_side_dungeon_soldier_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_side_dungeon_soldier_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
