...
public class stap_quest_master_1 extends script.base_script
{
    ...
    public boolean stap_quest_master_1_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean stap_quest_master_1_condition_stapQuestActive(obj_id player, obj_id npc)
    {
    ...
    public void stap_quest_master_1_action_finishTask(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedShipping");
    }
    public int stap_quest_master_1_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
