...
public class corellia_droid_factory_sergeant_mener extends script.base_script
{
    ...
    public boolean corellia_droid_factory_sergeant_mener_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_droid_factory_sergeant_mener_condition_isBDNotActiveOrComplete(obj_id player, obj_id npc)
    {
        return !groundquests.isQuestActiveOrComplete(player, "corellia_droid_bunker_destroy_battle_droid");
    }
    public boolean corellia_droid_factory_sergeant_mener_condition_isBDFinishTaskActive(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_droid_bunker_destroy_battle_droid", "returnTenBD");
    }
    public boolean corellia_droid_factory_sergeant_mener_condition_isSBDFinishTaskActive(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_droid_bunker_destroy_super_battle_droid", "returnTenSBD");
    }
    public boolean corellia_droid_factory_sergeant_mener_condition_isDroidekaFinishTaskActive(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_droid_bunker_destroy_droideka", "returnFiveDroideka");
    }
    public boolean corellia_droid_factory_sergeant_mener_condition_isBossDroidFinishTaskActive(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_droid_bunker_destroy_boss_droid", "returnBossDroid");
    }
    public boolean corellia_droid_factory_sergeant_mener_condition_isBossDroidActive(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "corellia_droid_bunker_destroy_boss_droid");
    }
    public boolean corellia_droid_factory_sergeant_mener_condition_isDroidekaFinished(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "corellia_droid_bunker_destroy_droideka");
    }
    public boolean corellia_droid_factory_sergeant_mener_condition_isDroidekaActive(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "corellia_droid_bunker_destroy_droideka");
    }
    public boolean corellia_droid_factory_sergeant_mener_condition_isBossDroidFinished(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "corellia_droid_bunker_destroy_boss_droid");
    }
    public boolean corellia_droid_factory_sergeant_mener_condition_isSBDFinished(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "corellia_droid_bunker_destroy_super_battle_droid");
    }
    public boolean corellia_droid_factory_sergeant_mener_condition_isSBDActive(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "corellia_droid_bunker_destroy_super_battle_droid");
    }
    public boolean corellia_droid_factory_sergeant_mener_condition_isBDFinished(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "corellia_droid_bunker_destroy_battle_droid");
    }
    public boolean corellia_droid_factory_sergeant_mener_condition_isBDActive(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "corellia_droid_bunker_destroy_battle_droid");
    }
    public void corellia_droid_factory_sergeant_mener_action_signalToFinishBD(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "returnTenBD");
    }
    public void corellia_droid_factory_sergeant_mener_action_signalToFinishSBD(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "returnTenSBD");
    }
    public void corellia_droid_factory_sergeant_mener_action_signalToFinishDroideka(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "returnFiveDroideka");
    }
    public void corellia_droid_factory_sergeant_mener_action_signalToFinishBossDroid(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "returnBossDroid");
    }
    public void corellia_droid_factory_sergeant_mener_action_grantBDQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "corellia_droid_bunker_destroy_battle_droid");
    }
    public void corellia_droid_factory_sergeant_mener_action_grantSBDQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "corellia_droid_bunker_destroy_super_battle_droid");
    }
    public void corellia_droid_factory_sergeant_mener_action_grantDroidekaQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "corellia_droid_bunker_destroy_droideka");
    }
    public void corellia_droid_factory_sergeant_mener_action_grantBossDroidQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "corellia_droid_bunker_destroy_boss_droid");
    }
    public int corellia_droid_factory_sergeant_mener_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_droid_factory_sergeant_mener_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_droid_factory_sergeant_mener_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_droid_factory_sergeant_mener_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_droid_factory_sergeant_mener_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_droid_factory_sergeant_mener_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_droid_factory_sergeant_mener_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_droid_factory_sergeant_mener_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
