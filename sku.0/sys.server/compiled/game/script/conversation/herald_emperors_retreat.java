...
public class herald_emperors_retreat extends script.base_script
{
    ...
    public boolean herald_emperors_retreat_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public void herald_emperors_retreat_action__defaultAction(obj_id player, obj_id npc)
    {
    }
    public void herald_emperors_retreat_action_waypoint1(obj_id player, obj_id npc)
    {
