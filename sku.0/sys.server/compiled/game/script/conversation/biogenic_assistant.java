...
public class biogenic_assistant extends script.base_script
{
    ...
    public boolean biogenic_assistant_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean biogenic_assistant_condition_get_tracker_1(obj_id player, obj_id npc)
    {
    ...
    public boolean biogenic_assistant_condition_get_tracker_2(obj_id player, obj_id npc)
    {
        int tracker = getIntObjVar(player, "biogenic.assistant_convo");
        if (tracker >= 2)
        {
    ...
    public boolean biogenic_assistant_condition_get_construct_tracker_3(obj_id player, obj_id npc)
    {
    ...
    public boolean biogenic_assistant_condition_get_engineer_tracker_2(obj_id player, obj_id npc)
    {
    ...
    public boolean biogenic_assistant_condition_get_engineer_tracker_3(obj_id player, obj_id npc)
    {
        int tracker = getIntObjVar(player, "biogenic.engineer_convo");
        if (tracker == 3)
        {
    ...
    public boolean biogenic_assistant_condition_get_multi_tracker(obj_id player, obj_id npc)
    {
    ...
    public void biogenic_assistant_action__defaultAction(obj_id player, obj_id npc)
    {
    }
    public void biogenic_assistant_action_give_datapad(obj_id player, obj_id npc)
    {
    ...
    public void biogenic_assistant_action_set_tracker_1(obj_id player, obj_id npc)
    {
        setObjVar(player, "biogenic.assistant_convo", 1);
    }
    public void biogenic_assistant_action_face_to(obj_id player, obj_id npc)
    {
        faceToBehavior(npc, player);
    }
    public void biogenic_assistant_action_give_datapad_3(obj_id player, obj_id npc)
    {
        obj_id playerInv = utils.getInventoryContainer(player);
        obj_id datapad = createObject("object/tangible/loot/dungeon/geonosian_mad_bunker/engineering_datapad.iff", playerInv, "");
