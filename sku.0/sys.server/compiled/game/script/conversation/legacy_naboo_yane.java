...
public class legacy_naboo_yane extends script.base_script
{
    ...
    public boolean legacy_naboo_yane_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean legacy_naboo_yane_condition_finishedYaneQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean legacy_naboo_yane_condition_onYaneQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean legacy_naboo_yane_condition_gatheredIngredients(obj_id player, obj_id npc)
    {
    ...
    public boolean legacy_naboo_yane_condition_doingYaneQuest(obj_id player, obj_id npc)
    {
    ...
    public void legacy_naboo_yane_action_startGatheringforYane(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "startYaneGatheringQuest");
    }
    public void legacy_naboo_yane_action_sendSignalAboutIngredients(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "doneHelpingYane");
    }
    public int legacy_naboo_yane_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_naboo_yane_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_naboo_yane_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_naboo_yane_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
