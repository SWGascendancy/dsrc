...
public class ep3_etyyy_kara_corlon extends script.base_script
{
    ...
    public boolean ep3_etyyy_kara_corlon_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_etyyy_kara_corlon_condition_completedFirstDelivery(obj_id player, obj_id npc)
    {
        return space_quest.hasWonQuest(player, "delivery_no_pickup", "ep3_hunting_kara_poacher_delivery_01");
    }
    public boolean ep3_etyyy_kara_corlon_condition_completedThirdDelivery(obj_id player, obj_id npc)
    {
        return space_quest.hasWonQuest(player, "delivery_no_pickup", "ep3_hunting_kara_poacher_delivery_03");
    }
    public boolean ep3_etyyy_kara_corlon_condition_completedSecondDelivery(obj_id player, obj_id npc)
    {
        return space_quest.hasWonQuest(player, "delivery_no_pickup", "ep3_hunting_kara_poacher_delivery_02");
    }
    public boolean ep3_etyyy_kara_corlon_condition_talkToKara(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_hunt_johnson_help_kara", "johnson_talkToKara");
    }
    public boolean ep3_etyyy_kara_corlon_condition_karaKnowsYou(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "ep3_hunt_johnson_help_kara", "johnson_talkToKara");
    }
    public boolean ep3_etyyy_kara_corlon_condition_workingOnDeliveries(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_hunt_johnson_help_kara", "johnson_karaDeliveries");
    }
    public boolean ep3_etyyy_kara_corlon_condition_alreadyHasSpaceQuest(obj_id player, obj_id npc)
    {
        return space_quest.hasQuest(player);
    }
    public void ep3_etyyy_kara_corlon_action_giveThirdDelivery(obj_id player, obj_id npc)
    {
    ...
    public void ep3_etyyy_kara_corlon_action_deliveriesDone(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "johnson_karaDeliveries");
    }
    public void ep3_etyyy_kara_corlon_action_giveSecondDelivery(obj_id player, obj_id npc)
    {
    ...
    public void ep3_etyyy_kara_corlon_action_giveFirstDelivery(obj_id player, obj_id npc)
    {
    ...
    public int ep3_etyyy_kara_corlon_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_kara_corlon_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_kara_corlon_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_kara_corlon_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_kara_corlon_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_kara_corlon_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
