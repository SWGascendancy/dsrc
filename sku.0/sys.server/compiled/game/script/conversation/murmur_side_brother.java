...
public class murmur_side_brother extends script.base_script
{
    ...
    public boolean murmur_side_brother_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean murmur_side_brother_condition_notFoundRemains(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "coronet_murmurs_side_4", "murmur_side_missing_brother");
    }
    public boolean murmur_side_brother_condition_avengedJenson(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "coronet_murmurs_side_4", "murmur_side_return_jeridel");
    }
    public boolean murmur_side_brother_condition_finishedQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "coronet_murmurs_side_4");
    }
    public boolean murmur_side_brother_condition_foundRemains(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "coronet_murmurs_side_4", "murmur_side_missing_brother");
    }
    public void murmur_side_brother_action_grantSideQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "coronet_murmurs_side_4");
    }
    public void murmur_side_brother_action_completeSideQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "murmur_side_return");
    }
    public void murmur_side_brother_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int murmur_side_brother_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int murmur_side_brother_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int murmur_side_brother_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int murmur_side_brother_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int murmur_side_brother_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int murmur_side_brother_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
