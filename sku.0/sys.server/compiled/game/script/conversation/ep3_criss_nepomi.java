...
public class ep3_criss_nepomi extends script.base_script
{
    ...
    public boolean ep3_criss_nepomi_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public int ep3_criss_nepomi_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
