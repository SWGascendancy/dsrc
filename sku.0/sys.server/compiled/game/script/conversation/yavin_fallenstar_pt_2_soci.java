...
public class yavin_fallenstar_pt_2_soci extends script.base_script
{
    ...
    public boolean yavin_fallenstar_pt_2_soci_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean yavin_fallenstar_pt_2_soci_condition_opcaCrewKilled(obj_id player, obj_id npc)
    {
    ...
    public boolean yavin_fallenstar_pt_2_soci_condition_fallenstar_pt2_complete(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/yavin_fallenstar_pt2");
        boolean OnTask = questIsQuestComplete(questId1, player);
        return OnTask;
    }
    public void yavin_fallenstar_pt_2_soci_action_launchSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "yavin_fallenstar_launch_e14");
    }
    public void yavin_fallenstar_pt_2_soci_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int yavin_fallenstar_pt_2_soci_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int yavin_fallenstar_pt_2_soci_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int yavin_fallenstar_pt_2_soci_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
