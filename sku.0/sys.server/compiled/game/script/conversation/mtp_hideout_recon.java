...
public class mtp_hideout_recon extends script.base_script
{
    ...
    public boolean mtp_hideout_recon_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean mtp_hideout_recon_condition_collectionComplete(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_hideout_recon_condition_collectionStillActive(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_hideout_recon_condition_returnNoCamera(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_hideout_recon_condition_planetsNotComplete(obj_id player, obj_id npc)
    {
    ...
    public void mtp_hideout_recon_action_grantMeatlumpCamera(obj_id player, obj_id npc)
    {
    ...
    public void mtp_hideout_recon_action_returnTheCamera(obj_id player, obj_id npc)
    {
        obj_id camera = utils.getStaticItemInInventory(player, "meatlump_camera_02_01");
        if (!isIdValid(camera))
        {
    ...
    public int mtp_hideout_recon_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_recon_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_recon_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_recon_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
