...
public class corellia_tyrena_akers extends script.base_script
{
    ...
    public boolean corellia_tyrena_akers_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_tyrena_akers_condition_onTalkAkers1(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_tyrena_petty_resolve", "petty_talk_akers");
    }
    public boolean corellia_tyrena_akers_condition_onTalkAkers2(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_tyrena_petty_resolve", "petty_return_akers");
    }
    public boolean corellia_tyrena_akers_condition_onMedical(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_tyrena_akers_condition_onGotoVermon(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_tyrena_petty_resolve", "petty_return_vermon");
    }
    public boolean corellia_tyrena_akers_condition_completedPetty(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "corellia_tyrena_petty_resolve");
    }
    public void corellia_tyrena_akers_action_signalTalkAkers1(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "petty_talk_akers");
    }
    public void corellia_tyrena_akers_action_signalTalkAkers2(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "petty_return_akers");
    }
    public int corellia_tyrena_akers_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_akers_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_akers_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_akers_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_akers_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_akers_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_akers_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_akers_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_akers_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_akers_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_akers_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
