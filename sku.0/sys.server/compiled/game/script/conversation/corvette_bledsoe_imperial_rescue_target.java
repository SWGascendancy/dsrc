...
public class corvette_bledsoe_imperial_rescue_target extends script.base_script
{
    ...
    public boolean corvette_bledsoe_imperial_rescue_target_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corvette_bledsoe_imperial_rescue_target_condition_alreadyRescued(obj_id player, obj_id npc)
    {
        return hasObjVar(npc, "corl_corvette.alreadyRescued");
    }
    public void corvette_bledsoe_imperial_rescue_target_action__defaultAction(obj_id player, obj_id npc)
    {
    }
    public void corvette_bledsoe_imperial_rescue_target_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void corvette_bledsoe_imperial_rescue_target_action_FactionSuccess(obj_id player, obj_id npc)
    {
    ...
    public void corvette_bledsoe_imperial_rescue_target_action_FactionSuccessLesser(obj_id player, obj_id npc)
    {
        if (!hasObjVar(npc, "corl_corvette.alreadyRescued"))
        {
            setObjVar(npc, "corl_corvette.alreadyRescued", 1);
