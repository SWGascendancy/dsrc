...
public class nym_themepark_quatermaster extends script.base_script
{
    ...
    public boolean nym_themepark_quatermaster_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean nym_themepark_quatermaster_condition_isOnFirstQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean nym_themepark_quatermaster_condition_isOnSecondQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean nym_themepark_quatermaster_condition_isOnThridQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean nym_themepark_quatermaster_condition_isAlmostDone(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean nym_themepark_quatermaster_condition_hasFailedDelivery(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "u16_nym_themepark_save_agent_fail", "returnRaliaFail");
    }
    public boolean nym_themepark_quatermaster_condition_hasSmugglerQuestNotComplete(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isQuestActive(player, "u16_nym_themepark_smuggler_01");
    }
    public boolean nym_themepark_quatermaster_condition_hasAgentQuestNotComplete(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isQuestActive(player, "u16_nym_themepark_save_agent");
    }
    public boolean nym_themepark_quatermaster_condition_hasPressureQuestNotComplete(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isQuestActive(player, "u16_nym_themepark_under_pressure");
    }
    public void nym_themepark_quatermaster_action_signalFirstJumperQuestDone(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "hasFoundQuartermaster");
    }
    public void nym_themepark_quatermaster_action_signalSecondJumperQuestDone(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "hasGoneQuartermaster");
    }
    public void nym_themepark_quatermaster_action_signalAgentSafe(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "hasGoneBackQuartermaster");
    }
    public void nym_themepark_quatermaster_action_grantSmugglerQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "u16_nym_themepark_smuggler_01");
    }
    public void nym_themepark_quatermaster_action_grantAgentQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "u16_nym_themepark_save_agent");
    }
    public void nym_themepark_quatermaster_action_grantPressureQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "u16_nym_themepark_under_pressure");
    }
    public void nym_themepark_quatermaster_action_sendPlayerToFixChamber(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "u16_nym_themepark_repair_flocculation_chamber");
    }
    public void nym_themepark_quatermaster_action_clearDeliveryFailQuest(obj_id player, obj_id npc)
    {
    ...
    public void nym_themepark_quatermaster_action_signalThirdJumperQuestDone(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "hasGoneQuartermasterAgain");
    }
    public int nym_themepark_quatermaster_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_themepark_quatermaster_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_themepark_quatermaster_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_themepark_quatermaster_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_themepark_quatermaster_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_themepark_quatermaster_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_themepark_quatermaster_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_themepark_quatermaster_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_themepark_quatermaster_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_themepark_quatermaster_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_themepark_quatermaster_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_themepark_quatermaster_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_themepark_quatermaster_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_themepark_quatermaster_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_themepark_quatermaster_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_themepark_quatermaster_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
