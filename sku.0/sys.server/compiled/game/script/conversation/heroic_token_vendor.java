...
public class heroic_token_vendor extends script.base_script
{
    ...
    public boolean heroic_token_vendor_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public void heroic_token_vendor_action_showTokenVendorUI(obj_id player, obj_id npc)
    {
