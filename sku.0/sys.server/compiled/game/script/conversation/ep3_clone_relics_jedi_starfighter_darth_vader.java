...
public class ep3_clone_relics_jedi_starfighter_darth_vader extends script.base_script
{
    ...
    public boolean ep3_clone_relics_jedi_starfighter_darth_vader_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_clone_relics_jedi_starfighter_darth_vader_condition_failedSpaceMission(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_clone_relics_jedi_starfighter_darth_vader_condition_completedSpaceMission(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_clone_relics_jedi_starfighter_darth_vader_condition_onSpaceMission(obj_id player, obj_id npc)
    {
        return (space_quest.hasQuest(player, "space_battle", "ep3_clone_relics_jedi_starfighter_4"));
    }
    public boolean ep3_clone_relics_jedi_starfighter_darth_vader_condition_finished(obj_id player, obj_id npc)
    {
        return (space_quest.hasWonQuest(player, "space_battle", "ep3_clone_relics_jedi_starfighter_5"));
    }
    public boolean ep3_clone_relics_jedi_starfighter_darth_vader_condition_onQuestFour(obj_id player, obj_id npc)
    {
        return (groundquests.isQuestActive(player, "ep3_clone_relics_jedi_starfighter_4"));
    }
    public void ep3_clone_relics_jedi_starfighter_darth_vader_action_signalTalkedOne(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedToVader1");
    }
    public void ep3_clone_relics_jedi_starfighter_darth_vader_action_grantRewardTwo(obj_id player, obj_id npc)
    {
    ...
    public void ep3_clone_relics_jedi_starfighter_darth_vader_action_performKillPlayer(obj_id player, obj_id npc)
    {
    ...
    public int playerKnockedOut(obj_id self, dictionary params)
    {
    ...
    public int playerDies(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        obj_id npc = params.getObjId("npc");
    ...
    public void ep3_clone_relics_jedi_starfighter_darth_vader_action_grantLimitedPass(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "limitedVaderPass", 1);
    }
    public void ep3_clone_relics_jedi_starfighter_darth_vader_action_grantSpaceMission(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "space_battle", "ep3_clone_relics_jedi_starfighter_4");
    }
    public int ep3_clone_relics_jedi_starfighter_darth_vader_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_jedi_starfighter_darth_vader_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_jedi_starfighter_darth_vader_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_jedi_starfighter_darth_vader_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_jedi_starfighter_darth_vader_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_jedi_starfighter_darth_vader_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
