...
public class ep3_forest_arena_guard extends script.base_script
{
    ...
    public boolean ep3_forest_arena_guard_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_forest_arena_guard_condition_TooMany(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_forest_kerritamba_epic_6", 0);
    }
    public boolean ep3_forest_arena_guard_condition_hasArenaQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_arena_challenge");
    }
    public void ep3_forest_arena_guard_action_selectTicketAndSend(obj_id player, obj_id npc)
    {
    ...
    public int ep3_forest_arena_guard_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
