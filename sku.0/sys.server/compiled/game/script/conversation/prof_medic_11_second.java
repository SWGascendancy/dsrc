...
public class prof_medic_11_second extends script.base_script
{
    ...
    public boolean prof_medic_11_second_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean prof_medic_11_second_condition_playerOnCorrectStep(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "profession_medic_11", "talktosecond");
    }
    public boolean prof_medic_11_second_condition_playercompletedTask(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "profession_medic_11", "talktosecond");
    }
    public void prof_medic_11_second_action_givePassSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "profession_medic_11_second_victim");
    }
    public void prof_medic_11_second_action_healnpc(obj_id player, obj_id npc)
    {
        playClientEffectObj(player, "clienteffect/prof_medic_21_heal2.cef", npc, "");
    }
    public int prof_medic_11_second_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int prof_medic_11_second_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int prof_medic_11_second_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
