...
public class mtp_corsec_intelligence_officer extends script.base_script
{
    ...
    public boolean mtp_corsec_intelligence_officer_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public int mtp_corsec_intelligence_officer_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_corsec_intelligence_officer_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_corsec_intelligence_officer_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_corsec_intelligence_officer_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_corsec_intelligence_officer_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_corsec_intelligence_officer_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_corsec_intelligence_officer_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_corsec_intelligence_officer_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_corsec_intelligence_officer_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_corsec_intelligence_officer_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
