...
public class tatooine_wald_firstquest extends script.base_script
{
    ...
    public boolean tatooine_wald_firstquest_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tatooine_wald_firstquest_condition_task1_active(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "tatooine_wald_firstquest", "tatooine_wald_firstquest_kill_greatermynock");
    }
    public boolean tatooine_wald_firstquest_condition_task1_complete(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "tatooine_wald_firstquest", "tatooine_wald_firstquest_returntowald1");
    }
    public boolean tatooine_wald_firstquest_condition_task2_3_active(obj_id player, obj_id npc)
    {
    ...
    public boolean tatooine_wald_firstquest_condition_task2_3_complete(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "tatooine_wald_firstquest", "tatooine_wald_firstquest_returntowald2");
    }
    public boolean tatooine_wald_firstquest_condition_quest_complete(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "tatooine_wald_firstquest");
    }
    public void tatooine_wald_firstquest_action_grant_quest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "tatooine_wald_firstquest");
    }
    public void tatooine_wald_firstquest_action_task1_complete_signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tatooine_wald_firstquest_finished_task1");
    }
    public void tatooine_wald_firstquest_action_task2_3_complete_signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tatooine_wald_firstquest_finished_task2_and_3");
    }
    public int tatooine_wald_firstquest_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_wald_firstquest_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_wald_firstquest_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_wald_firstquest_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_wald_firstquest_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_wald_firstquest_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_wald_firstquest_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_wald_firstquest_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_wald_firstquest_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_wald_firstquest_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_wald_firstquest_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
