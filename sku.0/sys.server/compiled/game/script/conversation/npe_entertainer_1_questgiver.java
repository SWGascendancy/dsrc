...
public class npe_entertainer_1_questgiver extends script.base_script
{
    ...
    public boolean npe_entertainer_1_questgiver_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_entertainer_1_questgiver_condition_playerCompletedQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_entertainer_1");
    }
    public boolean npe_entertainer_1_questgiver_condition_playerStartedQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "npe_entertainer_1");
    }
    public boolean npe_entertainer_1_questgiver_condition_playerFinishedMainTask(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_entertainer_1", "talktoqg2");
    }
    public boolean npe_entertainer_1_questgiver_condition_playerOnOtherTraining(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_entertainer_1_questgiver_condition_notEntertainer(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_entertainer_1_questgiver_condition_startingconversation(obj_id player, obj_id npc)
    {
        String pTemplate = getSkillTemplate(player);
        if (pTemplate.indexOf("entertainer") > -1)
        {
    ...
    public void npe_entertainer_1_questgiver_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void npe_entertainer_1_questgiver_action_signalReward(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_ent1_reward");
        groundquests.grantQuest(player, "npe_han_comm_entertainer", false);
    }
    public void npe_entertainer_1_questgiver_action_giveQuest(obj_id player, obj_id npc)
    {
        String pTemplate = getSkillTemplate(player);
    ...
    public int npe_entertainer_1_questgiver_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_entertainer_1_questgiver_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_entertainer_1_questgiver_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_entertainer_1_questgiver_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
