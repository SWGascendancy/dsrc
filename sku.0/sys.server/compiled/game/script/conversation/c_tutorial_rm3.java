...
public class c_tutorial_rm3 extends script.base_script
{
    ...
    public boolean c_tutorial_rm3_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_tutorial_rm3_condition_playerOnQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean c_tutorial_rm3_condition_TaskComplete(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/c_newbie_hall_01");
        int explainQuestJournal = groundquests.getTaskId(questId, "explainQuestJournal");
    ...
    public boolean c_tutorial_rm3_condition_playerOnQuestStep02(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/c_newbie_hall_01");
        int explainInventory = groundquests.getTaskId(questId, "explainInventory");
    ...
    public void c_tutorial_rm3_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void c_tutorial_rm3_action_actionSendSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "explainQuestJournal");
    }
    public int c_tutorial_rm3_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_tutorial_rm3_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_tutorial_rm3_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_tutorial_rm3_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_tutorial_rm3_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
