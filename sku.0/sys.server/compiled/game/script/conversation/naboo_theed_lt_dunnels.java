...
public class naboo_theed_lt_dunnels extends script.base_script
{
    ...
    public boolean naboo_theed_lt_dunnels_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean naboo_theed_lt_dunnels_condition_startBoosterQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_theed_lt_dunnels_condition_onBoosterQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "naboo_theed_terrorist_booster");
    }
    public boolean naboo_theed_lt_dunnels_condition_completedBoosterQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "naboo_theed_terrorist_booster");
    }
    public boolean naboo_theed_lt_dunnels_condition_lastStepBoosterQuest(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "naboo_theed_terrorist_booster", "theed_terrorist_booster_08");
    }
    public boolean naboo_theed_lt_dunnels_condition_needsTerrorizeQuest(obj_id player, obj_id npc)
    {
    ...
    public void naboo_theed_lt_dunnels_action_grantBooster(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "naboo_theed_terrorist_booster");
    }
    public void naboo_theed_lt_dunnels_action_sendToSgtBrunser(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "naboo_theed_goto_brunser");
    }
    public void naboo_theed_lt_dunnels_action_endBoosterQuest(obj_id player, obj_id npc)
    {
    ...
    public void naboo_theed_lt_dunnels_action_endGotoDunnels(obj_id player, obj_id npc)
    {
    ...
    public int naboo_theed_lt_dunnels_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_lt_dunnels_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_lt_dunnels_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_lt_dunnels_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_lt_dunnels_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
