...
public class delivery_sickle extends script.base_script
{
    ...
    public boolean delivery_sickle_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean delivery_sickle_condition_noAntivirus(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean delivery_sickle_condition_hasNotFoundBeta(obj_id player, obj_id npc)
    {
        return !hasCompletedCollectionSlot(player, "exp_icon_deathtroopers_camp_delta");
    }
    public boolean delivery_sickle_condition_neverDelivered(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (!groundquests.isQuestActiveOrComplete(player, "camp_gamma_delivery_01"));
    }
    public boolean delivery_sickle_condition_hasMeetingTask(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "camp_gamma_delivery_01", "getBeastGamma");
    }
    public boolean delivery_sickle_condition_hasEscortTask(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "camp_gamma_delivery_01", "escortTaskGamma");
    }
    public boolean delivery_sickle_condition_hasDeliveredBefore(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "camp_gamma_delivery_01");
    }
    public boolean delivery_sickle_condition_tooLowLevel(obj_id player, obj_id npc)
    {
        return getLevel(player) < 40;
    }
    public void delivery_sickle_action_giveQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public void delivery_sickle_action_clearDeliveryQuest(obj_id player, obj_id npc)
    {
        groundquests.clearQuest(player, "camp_gamma_delivery_01");
    }
    public int delivery_sickle_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int delivery_sickle_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int delivery_sickle_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int delivery_sickle_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int delivery_sickle_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int delivery_sickle_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
