...
public class ep3_trando_pressk extends script.base_script
{
    ...
    public boolean ep3_trando_pressk_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_trando_pressk_condition_isOnTask01(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_trando_ssiksik", "talkToPressk");
    }
    public boolean ep3_trando_pressk_condition_isOnTask02(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_trando_ssiksik", "reportPressk");
    }
    public boolean ep3_trando_pressk_condition_hasCompletedQuest01(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_trando_ssiksik");
    }
    public boolean ep3_trando_pressk_condition_hasCompletedTask01(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "ep3_trando_ssiksik", "talkToPressk");
    }
    public void ep3_trando_pressk_action_doSignal01(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "startWookieeAttack");
    }
    public void ep3_trando_pressk_action_doSignal02(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "rewardSlaverLeader");
    }
    public int ep3_trando_pressk_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trando_pressk_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
