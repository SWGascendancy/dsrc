...
public class lifeday04d extends script.base_script
{
    ...
    public boolean lifeday04d_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean lifeday04d_condition_notSpokeWithElder(obj_id player, obj_id npc)
    {
    ...
    public boolean lifeday04d_condition_hasBeenRewarded(obj_id player, obj_id npc)
    {
    ...
    public void lifeday04d_action_setTalkedToYou(obj_id player, obj_id npc)
    {
        int convTracker = getIntObjVar(player, "lifeday04.convTracker");
    ...
    public int lifeday04d_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int lifeday04d_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int lifeday04d_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int lifeday04d_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int lifeday04d_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_edb238bc"))
        {
            if (lifeday04d_condition__defaultCondition(player, npc))
    ...
    public int lifeday04d_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_775904c7"))
        {
            if (lifeday04d_condition__defaultCondition(player, npc))
    ...
    public int lifeday04d_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_dc4149ee"))
        {
