...
public class npe_job_pointer extends script.base_script
{
    ...
    public boolean npe_job_pointer_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_job_pointer_condition_finishedAllStation(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_job_pointer_condition_needsAnvar(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "npe_entertainer_1");
    }
    public boolean npe_job_pointer_condition_finishedBartender(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "npe_new_artisan_quest");
    }
    public boolean npe_job_pointer_condition_needsLoche(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_job_pointer_condition_needsRydel(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_job_pointer_condition_needsLaetin(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_job_pointer_condition_needsDartas(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_job_pointer_condition_needsAleas(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_job_pointer_condition_needsRaylen(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "npe_scout_1");
    }
    public boolean npe_job_pointer_condition_needsTarand(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "npe_side_smuggle");
    }
    public boolean npe_job_pointer_condition_needsWyle(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "npe_side4");
    }
    public boolean npe_job_pointer_condition_needsDaevyn(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "npe_side2");
    }
    public boolean npe_job_pointer_condition_needsDroidEngineer(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedQuest(player, "npe_marksman") && !groundquests.isQuestActiveOrComplete(player, "npe_side3"));
    }
    public boolean npe_job_pointer_condition_needsSecurityDirector(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "npe_side5");
    }
    public boolean npe_job_pointer_condition_hasTemplate(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "npe.finishedTemplate");
    }
    public boolean npe_job_pointer_condition_needsFalrey(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_job_pointer_condition_needsYsanna(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "npe_side_dungeon_soldier");
    }
    public boolean npe_job_pointer_condition_finishedCantina(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_job_pointer_condition_needsSerissu(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_job_pointer_condition_finishedHangar1(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_job_pointer_condition_finishedCombatTraining(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_job_pointer_condition_needsAja(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "npe_side_dungeon_dna");
    }
    public boolean npe_job_pointer_condition_needsFrelka(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_job_pointer_condition_finishedHan(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "npe_new_main_quest");
    }
    public boolean npe_job_pointer_condition_needsJolka(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "npe_side_jolka");
    }
    public boolean npe_job_pointer_condition_finishedHangar2(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "npe_side_jolka");
    }
    public boolean npe_job_pointer_condition_needsInaldra(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "npe_inaldra_quest");
    }
    public boolean npe_job_pointer_condition_needsGarek(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_job_pointer_condition_finishedStationMasterOffice(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_job_pointer_condition_anAssignmentActive(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_job_pointer_condition_isBH(obj_id player, obj_id npc)
    {
        return utils.isProfession(player, utils.BOUNTY_HUNTER);
    }
    public boolean npe_job_pointer_condition_finishedAllGamma(obj_id player, obj_id npc)
    {
    ...
    public void npe_job_pointer_action_giveJobPointerAja(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_job_pointer_aja");
    }
    public void npe_job_pointer_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void npe_job_pointer_action_giveJobPointerBartender(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_job_pointer_bartender");
    }
    public void npe_job_pointer_action_giveJobPointerAnvar(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_job_pointer_anvar");
    }
    public void npe_job_pointer_action_giveJobPointerTarand(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_job_pointer_tarand");
    }
    public void npe_job_pointer_action_giveJobPointerWyle(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_job_pointer_wyle");
    }
    public void npe_job_pointer_action_giveJobPointerFalrey(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_job_pointer_falrey");
    }
    public void npe_job_pointer_action_giveJobPointerYsanna(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_job_pointer_ysanna");
    }
    public void npe_job_pointer_action_giveJobPointerSerissu(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_job_pointer_serissu");
    }
    public void npe_job_pointer_action_giveJobPointerLaetin(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_job_pointer_laetin");
    }
    public void npe_job_pointer_action_giveJobPointerDartas(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_job_pointer_dartas");
    }
    public void npe_job_pointer_action_giveJobPointerAleas(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_job_pointer_aleas");
    }
    public void npe_job_pointer_action_giveJobPointerDaevyn(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_job_pointer_deavyn");
    }
    public void npe_job_pointer_action_giveJobPointerSecurityDirector(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_job_pointer_security_director");
    }
    public void npe_job_pointer_action_giveJobPointerDroidEngineer(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_job_pointer_droid_engineer");
    }
    public void npe_job_pointer_action_giveJobPointerRaylen(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_job_pointer_raylen");
    }
    public void npe_job_pointer_action_giveJobPointerLoche(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_job_pointer_loche");
    }
    public void npe_job_pointer_action_giveJobPointerRydel(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_job_pointer_rydel");
    }
    public void npe_job_pointer_action_giveJobPointerHan(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_job_pointer_han");
    }
    public void npe_job_pointer_action_giveJobPointerJolka(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_job_pointer_jolka");
    }
    public void npe_job_pointer_action_giveJobPointerInaldra(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_job_pointer_inaldra");
    }
    public void npe_job_pointer_action_signalMyPointer(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talked_to_secretary");
    }
    public void npe_job_pointer_action_giveJobPointerGarek(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_job_pointer_garek");
    }
    public void npe_job_pointer_action_giveBobaPointer(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_pointer_boba");
    }
    public void npe_job_pointer_action_givePointerFrelka(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "npe_pointer_gamma");
    }
    public int npe_job_pointer_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_job_pointer_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_job_pointer_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_job_pointer_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_job_pointer_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_job_pointer_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_job_pointer_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_job_pointer_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_47"))
        {
            if (npe_job_pointer_condition__defaultCondition(player, npc))
    ...
    public int npe_job_pointer_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_47"))
        {
            if (npe_job_pointer_condition__defaultCondition(player, npc))
    ...
    public int npe_job_pointer_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_47"))
        {
            if (npe_job_pointer_condition__defaultCondition(player, npc))
    ...
    public int npe_job_pointer_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_job_pointer_handleBranch34(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_job_pointer_handleBranch36(obj_id player, obj_id npc, string_id response)
    {
