...
public class tusken_watto extends script.base_script
{
    ...
    public boolean tusken_watto_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tusken_watto_condition_staffed(obj_id player, obj_id npc)
    {
