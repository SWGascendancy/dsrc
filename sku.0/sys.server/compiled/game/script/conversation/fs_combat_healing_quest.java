...
public class fs_combat_healing_quest extends script.base_script
{
    ...
    public boolean fs_combat_healing_quest_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean fs_combat_healing_quest_condition_canTalkToVillagers(obj_id player, obj_id npc)
    {
        return fs_quests.isVillageEligible(player);
    }
    public boolean fs_combat_healing_quest_condition_Finished(obj_id player, obj_id npc)
    {
        return quests.isComplete("fs_combat_healing_finish", player);
    }
    public boolean fs_combat_healing_quest_condition_inProgress(obj_id player, obj_id npc)
    {
    ...
    public boolean fs_combat_healing_quest_condition_hasCompletedFirstSet(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "quest.fs_combat_healing.totalhealed"))
        {
            int totalhealed = getIntObjVar(player, "quest.fs_combat_healing.totalhealed");
    ...
    public boolean fs_combat_healing_quest_condition_intentroyCheck(obj_id player, obj_id npc)
    {
    ...
    public boolean fs_combat_healing_quest_condition_hasCompletedSecondSet(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "quest.fs_combat_healing.totalhealed"))
        {
            int totalhealed = getIntObjVar(player, "quest.fs_combat_healing.totalhealed");
    ...
    public boolean fs_combat_healing_quest_condition_ableToDoQuest(obj_id player, obj_id npc)
    {
        return fs_quests.hasQuestAccepted(player);
    }
    public boolean fs_combat_healing_quest_condition_doneFirstSet(obj_id player, obj_id npc)
    {
    ...
    public boolean fs_combat_healing_quest_condition_hasMedicSkill(obj_id player, obj_id npc)
    {
        return hasSkill(player, "science_medic_novice");
    }
    public void fs_combat_healing_quest_action_giveQuest1(obj_id player, obj_id npc)
    {
    ...
    public void fs_combat_healing_quest_action_giveQuest2(obj_id player, obj_id npc)
    {
        quests.activate("fs_combat_healing_2", player, npc);
    }
    public void fs_combat_healing_quest_action_giveReward(obj_id player, obj_id npc)
    {
    ...
    public void fs_combat_healing_quest_action_unlockMedicBranch(obj_id player, obj_id npc)
    {
        fs_quests.unlockBranch(player, "force_sensitive_heightened_senses_healing");
        quests.complete("fs_combat_healing_1", player, true);
    }
    public String fs_combat_healing_quest_tokenTO_numberHealed(obj_id player, obj_id npc)
    {
        int totalhealed = -1;
        if (hasObjVar(player, "quest.fs_combat_healing.totalhealed"))
        {
