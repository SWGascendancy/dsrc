...
public class mtp_hideout_access_old_meatlump extends script.base_script
{
    ...
    public boolean mtp_hideout_access_old_meatlump_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean mtp_hideout_access_old_meatlump_condition_mtpHideout05_01(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "mtp_hideout_access_05", "mtp_hideout_access_05_01");
    }
    public boolean mtp_hideout_access_old_meatlump_condition_mtpHideout05_01_done(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "mtp_hideout_access_05", "mtp_hideout_access_05_01");
    }
    public void mtp_hideout_access_old_meatlump_action_signal_mtpHideout05_01(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "mtp_hideout_access_05_01");
    }
    public int mtp_hideout_access_old_meatlump_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_access_old_meatlump_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_access_old_meatlump_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
