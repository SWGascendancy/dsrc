...
public class naboo_theed_ados_jarkey extends script.base_script
{
    ...
    public boolean naboo_theed_ados_jarkey_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean naboo_theed_ados_jarkey_condition_giveCorellianAle(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "naboo_theed_meanwhile_associates", "theed_meanwhile_associates_06");
    }
    public boolean naboo_theed_ados_jarkey_condition_afterCorellianAle(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "naboo_theed_meanwhile_associates", "theed_meanwhile_associates_06");
    }
    public void naboo_theed_ados_jarkey_action_signal_associates_06(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "theed_meanwhile_associates_06");
    }
    public int naboo_theed_ados_jarkey_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_ados_jarkey_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
