...
public class vana_sage extends script.base_script
{
    ...
    public boolean vana_sage_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean vana_sage_condition_hasInitialQuestTask(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean vana_sage_condition_hasntSpokenChosterHasQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean vana_sage_condition_hasNotCompletedChoster(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isQuestActive(player, "u16_nym_themepark_interview_choster");
    }
    public boolean vana_sage_condition_playerIsHighLvl(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return getLevel(player) >= 56;
    }
    public boolean vana_sage_condition_hasMetChoster(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "u16_nym_themepark_interview_choster", "tellVanaChosterMsg");
    }
    public boolean vana_sage_condition_metChosterNoPirateQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean vana_sage_condition_hasntCompletedPirate(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isQuestActive(player, "u16_nym_themepark_pirate_hideout");
    }
    public boolean vana_sage_condition_hasReturnedWithDroid(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "u16_nym_themepark_pirate_hideout", "returnPirateComplete");
    }
    public boolean vana_sage_condition_hasCompletedPirate(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.hasCompletedQuest(player, "u16_nym_themepark_pirate_hideout");
    }
    public boolean vana_sage_condition_allQuestsComplete(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.hasCompletedQuest(player, "u16_nym_themepark_vana_to_jinkins");
    }
    public boolean vana_sage_condition_hasCompletedThemePark(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.hasCompletedQuest(player, "u16_nym_themepark_shuttle_ambush");
    }
    public void vana_sage_action_giveChosterQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "u16_nym_themepark_interview_choster");
    }
    public void vana_sage_action_finishInitialQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "hasFoundVanaSage");
    }
    public void vana_sage_action_givePirateQuest(obj_id player, obj_id npc)
    {
    ...
    public void vana_sage_action_finishChoster(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "hasToldVanaChosterMsg");
    }
    public void vana_sage_action_finishPirateQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "hasCompletedPirate");
    }
    public void vana_sage_action_gotoJinkins(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "u16_nym_themepark_vana_to_jinkins");
    }
    public int vana_sage_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int vana_sage_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int vana_sage_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int vana_sage_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int vana_sage_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int vana_sage_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int vana_sage_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int vana_sage_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int vana_sage_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_26"))
        {
            if (vana_sage_condition__defaultCondition(player, npc))
    ...
    public int vana_sage_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int vana_sage_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int vana_sage_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int vana_sage_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int vana_sage_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int vana_sage_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int vana_sage_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_58"))
        {
            doAnimationAction(player, "nod");
    ...
    public int vana_sage_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_26"))
        {
            if (vana_sage_condition__defaultCondition(player, npc))
    ...
    public int vana_sage_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int vana_sage_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int vana_sage_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_42"))
        {
            if (vana_sage_condition__defaultCondition(player, npc))
