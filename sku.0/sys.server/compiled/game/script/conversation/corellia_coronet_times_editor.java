...
public class corellia_coronet_times_editor extends script.base_script
{
    ...
    public boolean corellia_coronet_times_editor_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_coronet_times_editor_condition_hasViewScreenQuest(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_coronet_meatlump_act1_begin", "meatlumpsAct1_timesEditor");
    }
    public boolean corellia_coronet_times_editor_condition_starportVandalsEnd(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_coronet_capitol_problems_starport_vandals", "starport_vandals_4");
    }
    public boolean corellia_coronet_times_editor_condition_starportVandalsActive(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_coronet_capitol_problems_starport_vandals", "starport_vandals_3");
    }
    public boolean corellia_coronet_times_editor_condition_starportVandalsBegin(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_coronet_capitol_problems_starport_vandals", "starport_vandals_2");
    }
    public boolean corellia_coronet_times_editor_condition_deletedVandals2(obj_id player, obj_id npc)
    {
    ...
    public void corellia_coronet_times_editor_action_sendToVaniKorr(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "meatlumpsAct1_timesEditor");
    }
    public void corellia_coronet_times_editor_action_starportVandalsMeatlumps(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "starport_vandals_2");
    }
    public void corellia_coronet_times_editor_action_starportVandalsDemmiWot(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "starport_vandals_4");
    }
    public void corellia_coronet_times_editor_action_giveVandals2(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "corellia_coronet_capitol_problems_starport_vandals_2");
    }
    public int corellia_coronet_times_editor_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_times_editor_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_times_editor_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_times_editor_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_times_editor_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_times_editor_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
