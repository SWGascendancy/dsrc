...
public class corellia_coronet_starport_master extends script.base_script
{
    ...
    public boolean corellia_coronet_starport_master_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_coronet_starport_master_condition_needsShippingSchedule(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_coronet_starport_master_condition_active_starportVandalsQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_coronet_starport_master_condition_begin_starportVandalsQuest(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_coronet_capitol_problems_starport_vandals", "starport_vandals_1");
    }
    public boolean corellia_coronet_starport_master_condition_end_starportVandalsQuest(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_coronet_capitol_problems_starport_vandals_2", "starport_vandals_7");
    }
    public void corellia_coronet_starport_master_action_giveShippingSchedule(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "ralMundi_getSchedule");
    }
    public void corellia_coronet_starport_master_action_sendToFinnShallo(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "starport_vandals_1");
    }
    public void corellia_coronet_starport_master_action_endStarportVandalsQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "starport_vandals_7");
    }
    public int corellia_coronet_starport_master_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_starport_master_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_starport_master_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_starport_master_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_starport_master_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
