...
public class emp_day_disk_guy_3 extends script.base_script
{
    ...
    public boolean emp_day_disk_guy_3_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean emp_day_disk_guy_3_condition_hasTask3c(obj_id player, obj_id npc)
    {
    ...
    public void emp_day_disk_guy_3_action_triggerAndWp(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "disk_guy_3");
        sendSystemMessage(player, new string_id("event/empire_day", "sys_msg_all_disks"));
    }
    public int emp_day_disk_guy_3_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
