...
public class ep3_forest_wirartu_attack extends script.base_script
{
    ...
    public boolean ep3_forest_wirartu_attack_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_forest_wirartu_attack_condition_isEpicTaskActiveOne(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_forest_wirartu_epic_3", 0);
    }
    public boolean ep3_forest_wirartu_attack_condition_isOnHold(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_forest_on_hold", 0);
    }
    public void ep3_forest_wirartu_attack_action_giveSignalOne(obj_id player, obj_id npc)
    {
        groundquests.completeQuest(player, "ep3_forest_wirartu_epic_1");
    }
    public void ep3_forest_wirartu_attack_action_IncapMe(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_forest_wirartu_epic_2");
        kill(npc);
        messageTo(npc, "cleanMeUp", null, 10, false);
    }
    public void ep3_forest_wirartu_attack_action_giveQuestOne(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_forest_wirartu_epic_3");
        messageTo(npc, "cleanMeUp", null, 20, false);
    }
    public int ep3_forest_wirartu_attack_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
