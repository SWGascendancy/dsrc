...
public class som_kenobi_epo_qetora extends script.base_script
{
    ...
    public boolean som_kenobi_epo_qetora_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean som_kenobi_epo_qetora_condition_onQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean som_kenobi_epo_qetora_condition_isSmuggler(obj_id player, obj_id npc)
    {
        return hasSkill(player, "class_smuggler_phase1_novice");
    }
    public boolean som_kenobi_epo_qetora_condition_haveDisk(obj_id player, obj_id npc)
    {
    ...
    public boolean som_kenobi_epo_qetora_condition_finishedQuestAll(obj_id player, obj_id npc)
    {
    ...
    public boolean som_kenobi_epo_qetora_condition_finishedQuest1(obj_id player, obj_id npc)
    {
        if (groundquests.hasCompletedQuest(player, "som_kenobi_historian_1") || groundquests.hasCompletedQuest(player, "som_kenobi_historian_smuggler"))
        {
            return true;
    ...
    public boolean som_kenobi_epo_qetora_condition_onQuest2(obj_id player, obj_id npc)
    {
        return (groundquests.isQuestActive(player, "som_kenobi_historian_2"));
    }
    public boolean som_kenobi_epo_qetora_condition_rewardQuest2(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "som_kenobi_historian_2", "retrievedPieces");
    }
    public void som_kenobi_epo_qetora_action_giveQuestSmuggler(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "som_kenobi_historian_smuggler");
    }
    public void som_kenobi_epo_qetora_action_giveQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "som_kenobi_historian_1");
    }
    public void som_kenobi_epo_qetora_action_reward(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "successDone");
    }
    public void som_kenobi_epo_qetora_action_giveQuest2(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "som_kenobi_historian_2");
    }
    public void som_kenobi_epo_qetora_action_reward2(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "piecesRetrieved");
    }
    public void som_kenobi_epo_qetora_action_rewardBattle(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "battlePicked");
    }
    public void som_kenobi_epo_qetora_action_rewardRecon(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "reconPicked");
    }
    public void som_kenobi_epo_qetora_action_rewardAssault(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "assaultPicked");
    }
    public void som_kenobi_epo_qetora_action_rewardRifle(obj_id player, obj_id npc)
    {
    ...
    public void som_kenobi_epo_qetora_action_rewardCarbine(obj_id player, obj_id npc)
    {
    ...
    public void som_kenobi_epo_qetora_action_rewardPistol(obj_id player, obj_id npc)
    {
    ...
    public void som_kenobi_epo_qetora_action_finishQuest1(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "completed");
    }
    public int som_kenobi_epo_qetora_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_epo_qetora_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_epo_qetora_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_epo_qetora_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_epo_qetora_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_epo_qetora_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_epo_qetora_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_epo_qetora_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_epo_qetora_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_epo_qetora_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_epo_qetora_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_epo_qetora_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_epo_qetora_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_epo_qetora_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_epo_qetora_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_epo_qetora_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_epo_qetora_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_epo_qetora_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_epo_qetora_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_epo_qetora_handleBranch34(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_epo_qetora_handleBranch35(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_epo_qetora_handleBranch36(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_epo_qetora_handleBranch37(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_epo_qetora_handleBranch39(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_epo_qetora_handleBranch41(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_epo_qetora_handleBranch43(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_epo_qetora_handleBranch44(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_epo_qetora_handleBranch45(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_epo_qetora_handleBranch47(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_epo_qetora_handleBranch49(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_epo_qetora_handleBranch51(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_epo_qetora_handleBranch53(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_epo_qetora_handleBranch54(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_epo_qetora_handleBranch55(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_epo_qetora_handleBranch56(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_epo_qetora_handleBranch58(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_epo_qetora_handleBranch61(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_epo_qetora_handleBranch62(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_epo_qetora_handleBranch63(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_epo_qetora_handleBranch65(obj_id player, obj_id npc, string_id response)
    {
