...
public class rtp_luke_woolamander_ghost extends script.base_script
{
    ...
    public boolean rtp_luke_woolamander_ghost_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean rtp_luke_woolamander_ghost_condition_lukeTaskActive(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "rtp_luke_02", "rtp_luke_02_01");
    }
    public void rtp_luke_woolamander_ghost_action_walkAway(obj_id player, obj_id npc)
    {
    ...
    public int ghostWalkAwayThenDisappear(obj_id self, dictionary params)
    {
