...
public class ep3_trandoshan_tempal_buncho extends script.base_script
{
    ...
    public boolean ep3_trandoshan_tempal_buncho_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_trandoshan_tempal_buncho_condition_hasCompletedTask01(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_trando_tempal_buncho", "wookieeKilled");
    }
    public boolean ep3_trandoshan_tempal_buncho_condition_isOnQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_trando_tempal_buncho");
    }
    public boolean ep3_trandoshan_tempal_buncho_condition_hasCompletedQuest01(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_trando_tempal_buncho");
    }
    public void ep3_trandoshan_tempal_buncho_action_giveQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_trando_tempal_buncho");
    }
    public void ep3_trandoshan_tempal_buncho_action_doSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "rewardTempal");
    }
    public int ep3_trandoshan_tempal_buncho_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_tempal_buncho_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_tempal_buncho_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_tempal_buncho_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_tempal_buncho_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_tempal_buncho_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_tempal_buncho_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
