...
public class coa3wcoolguy extends script.base_script
{
    ...
    public boolean coa3wcoolguy_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean coa3wcoolguy_condition_spokeCoordinatorLast(obj_id player, obj_id npc)
    {
        return (getIntObjVar(player, "coa3.convTracker") == -401);
    }
    public boolean coa3wcoolguy_condition_finalMissionActive(obj_id player, obj_id npc)
    {
        return (getIntObjVar(player, "coa3.convTracker") == -402);
    }
    public boolean coa3wcoolguy_condition_hasWonStory(obj_id player, obj_id npc)
    {
        return (badge.hasBadge(player, "event_coa3_rebel"));
    }
    public boolean coa3wcoolguy_condition_isCorrectFaction(obj_id player, obj_id npc)
    {
    ...
    public void coa3wcoolguy_action_getFinalMission(obj_id player, obj_id npc)
    {
    ...
    public void coa3wcoolguy_action_refreshFinalMission(obj_id player, obj_id npc)
    {
        setObjVar(player, "coa3.convTracker", -402);
        dictionary params = new dictionary();
        params.put("player", player);
    ...
    public void coa3wcoolguy_action_abortFinalMission(obj_id player, obj_id npc)
    {
    ...
    public int coa3wcoolguy_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int coa3wcoolguy_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int coa3wcoolguy_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
