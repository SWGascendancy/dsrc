...
public class rebel_pvp_bf_vendor extends script.base_script
{
    ...
    public boolean rebel_pvp_bf_vendor_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public void rebel_pvp_bf_vendor_action_showTokenVendorUI(obj_id player, obj_id npc)
    {
