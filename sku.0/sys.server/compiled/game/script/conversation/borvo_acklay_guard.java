...
public class borvo_acklay_guard extends script.base_script
{
    ...
    public boolean borvo_acklay_guard_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean borvo_acklay_guard_condition_onTrick(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "borvo_acklay_find_armorer", "trick");
    }
    public boolean borvo_acklay_guard_condition_onVault(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "legacy_naboo_borvos_vault");
    }
    public void borvo_acklay_guard_action_signalTricked(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "acklay_tricked");
    }
    public int borvo_acklay_guard_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int borvo_acklay_guard_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int borvo_acklay_guard_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
