...
public class fs_phase4_chief_engineer extends script.base_script
{
    ...
    public boolean fs_phase4_chief_engineer_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean fs_phase4_chief_engineer_condition_onQuestStep01(obj_id player, obj_id npc)
    {
        return quests.isActive("fs_crafting4_quest_01", player);
    }
    public boolean fs_phase4_chief_engineer_condition_onQuestStep02(obj_id player, obj_id npc)
    {
        return quests.isActive("fs_crafting4_quest_02", player);
    }
    public boolean fs_phase4_chief_engineer_condition_onQuestStep03(obj_id player, obj_id npc)
    {
        return quests.isActive("fs_crafting4_quest_03", player);
    }
    public boolean fs_phase4_chief_engineer_condition_onQuestStep04(obj_id player, obj_id npc)
    {
        return quests.isActive("fs_crafting4_quest_04", player);
    }
    public boolean fs_phase4_chief_engineer_condition_onQuestStep05(obj_id player, obj_id npc)
    {
        return quests.isActive("fs_crafting4_quest_05", player);
    }
    public boolean fs_phase4_chief_engineer_condition_onQuestStep06(obj_id player, obj_id npc)
    {
    ...
    public boolean fs_phase4_chief_engineer_condition_noInventorySpace(obj_id player, obj_id npc)
    {
    ...
    public boolean fs_phase4_chief_engineer_condition_hasAlreadyUnlockedBranch(obj_id player, obj_id npc)
    {
        return fs_quests.hasUnlockedBranch(player, "force_sensitive_crafting_mastery_repair");
    }
    public boolean fs_phase4_chief_engineer_condition_alreadyHasOtherQuest(obj_id player, obj_id npc)
    {
        if (fs_quests.hasQuestAccepted(player))
        {
    ...
    public boolean fs_phase4_chief_engineer_condition_onQuestStep07(obj_id player, obj_id npc)
    {
        return quests.isActive("fs_crafting4_quest_07", player);
    }
    public boolean fs_phase4_chief_engineer_condition_isNotOnCrafting4Quest(obj_id player, obj_id npc)
    {
    ...
    public boolean fs_phase4_chief_engineer_condition_isBeginQuestEligible(obj_id player, obj_id npc)
    {
        if (fs_phase4_chief_engineer_condition_isNotOnCrafting4Quest(player, npc))
        {
            return true;
    ...
    public boolean fs_phase4_chief_engineer_condition_hasCoreObject(obj_id player, obj_id npc)
    {
    ...
    public boolean fs_phase4_chief_engineer_condition_isNotVillageEligible(obj_id player, obj_id npc)
    {
        return !fs_quests.isVillageEligible(player);
    }
    public boolean fs_phase4_chief_engineer_condition_isOnQuest01to05(obj_id player, obj_id npc)
    {
        if (fs_quests.hasQuestAccepted(player))
        {
            fs_phase4_chief_engineer_action_getCrafting4ActiveQuestNum(player, npc);
    ...
    public boolean fs_phase4_chief_engineer_condition_isContinuingQuest(obj_id player, obj_id npc)
    {
        if (!fs_quests.hasQuestAccepted(player))
        {
            fs_phase4_chief_engineer_action_getCrafting4ActiveQuestNum(player, npc);
    ...
    public void fs_phase4_chief_engineer_action_giveStatueSection(obj_id player, obj_id npc)
    {
    ...
    public void fs_phase4_chief_engineer_action_setQuestStep07(obj_id player, obj_id npc)
    {
        if (quests.isActive("fs_crafting4_quest_06", player))
        {
    ...
    public void fs_phase4_chief_engineer_action_giveKerenWaypoint(obj_id player, obj_id npc)
    {
    ...
    public void fs_phase4_chief_engineer_action_giveCoronetWaypoint(obj_id player, obj_id npc)
    {
    ...
    public void fs_phase4_chief_engineer_action_giveMosEnthaWaypoint(obj_id player, obj_id npc)
    {
    ...
    public void fs_phase4_chief_engineer_action_activateQuest(obj_id player, obj_id npc)
    {
    ...
    public void fs_phase4_chief_engineer_action_openSkillBranch(obj_id player, obj_id npc)
    {
        String coreTemplate = "object/tangible/item/quest/force_sensitive/fs_crafting4_computer_core.iff";
    ...
    public void fs_phase4_chief_engineer_action_getCrafting4ActiveQuestNum(obj_id player, obj_id npc)
    {
        int questNum = -1;
    ...
    public void fs_phase4_chief_engineer_action_setFSQuestAccepted(obj_id player, obj_id npc)
    {
        fs_quests.setQuestAccepted(player);
        return;
    }
    public void fs_phase4_chief_engineer_action_getCrafting4LastCompleteQuest(obj_id player, obj_id npc)
    {
        int questNum = -1;
