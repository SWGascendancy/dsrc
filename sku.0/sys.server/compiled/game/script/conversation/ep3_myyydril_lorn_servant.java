...
public class ep3_myyydril_lorn_servant extends script.base_script
{
    ...
    public boolean ep3_myyydril_lorn_servant_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_myyydril_lorn_servant_condition_isTaskOneActive(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_myyydril_lorn_retrieve_6", "taskRetrieveCrystal");
    }
    public boolean ep3_myyydril_lorn_servant_condition_hasCompletedTaskOne(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_myyydril_lorn_retrieve_6", "lornRetrieveCompleted");
    }
    public boolean ep3_myyydril_lorn_servant_condition_hasBadge(obj_id player, obj_id npc)
    {
        return false;
    }
    public boolean ep3_myyydril_lorn_servant_condition_isValidforEncounter(obj_id player, obj_id npc)
    {
        if (isGod(player))
        {
            return true;
    ...
    public boolean ep3_myyydril_lorn_servant_condition_IfisGod(obj_id player, obj_id npc)
    {
        return isGod(player);
    }
    public void ep3_myyydril_lorn_servant_action_grantQuestOne(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_myyydril_lorn_retrieve_6");
    }
    public void ep3_myyydril_lorn_servant_action_grantQuestTwo(obj_id player, obj_id npc)
    {
    ...
    public int ep3_myyydril_lorn_servant_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_lorn_servant_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_lorn_servant_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_lorn_servant_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_lorn_servant_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
