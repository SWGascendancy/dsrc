...
public class delivery_hassel extends script.base_script
{
    ...
    public boolean delivery_hassel_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean delivery_hassel_condition_noAntivirus(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean delivery_hassel_condition_hasNotFoundNextCamp(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean delivery_hassel_condition_neverDelivered(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        if (!hasObjVar(npc, "questName"))
        {
    ...
    public boolean delivery_hassel_condition_hasDeliveredBefore(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        if (!hasObjVar(npc, "questName"))
        {
    ...
    public boolean delivery_hassel_condition_hasQuestCompleted(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        if (!hasObjVar(npc, "questName"))
        {
    ...
    public void delivery_hassel_action_giveQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        if (!hasObjVar(npc, "questName"))
        {
    ...
    public void delivery_hassel_action_clearDeliveryQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        if (!hasObjVar(npc, "questName"))
        {
    ...
    public int delivery_hassel_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int delivery_hassel_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int delivery_hassel_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int delivery_hassel_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int delivery_hassel_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
