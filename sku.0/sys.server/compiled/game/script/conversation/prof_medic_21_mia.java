...
public class prof_medic_21_mia extends script.base_script
{
    ...
    public boolean prof_medic_21_mia_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean prof_medic_21_mia_condition_playerOnCorrectStep(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "prof_medic_21", "talktomia");
    }
    public boolean prof_medic_21_mia_condition_playercompletedTask(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "prof_medic_21", "talktomia");
    }
    public boolean prof_medic_21_mia_condition_playerOnFirstStep(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "prof_medic_21", "mia1");
    }
    public void prof_medic_21_mia_action_givePassSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "prof_medic_21_mia");
    }
    public void prof_medic_21_mia_action_giveFirstSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_medic_21_mia_failed");
    }
    public void prof_medic_21_mia_action_healParticles1(obj_id player, obj_id npc)
    {
        playClientEffectObj(player, "clienteffect/prof_medic_21_heal1.cef", npc, "");
    }
    public void prof_medic_21_mia_action_healParticles2(obj_id player, obj_id npc)
    {
        playClientEffectObj(player, "clienteffect/prof_medic_21_heal2.cef", npc, "");
    }
    public int prof_medic_21_mia_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int prof_medic_21_mia_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int prof_medic_21_mia_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int prof_medic_21_mia_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int prof_medic_21_mia_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int prof_medic_21_mia_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
