...
public class restuss_imperial_space_destroy extends script.base_script
{
    ...
    public boolean restuss_imperial_space_destroy_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean restuss_imperial_space_destroy_condition_completedKill1(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "restuss_imperial_space_destroy_1", "returnWulf");
    }
    public boolean restuss_imperial_space_destroy_condition_killActive1(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "restuss_imperial_space_destroy_1");
    }
    public boolean restuss_imperial_space_destroy_condition_completedKill2(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "restuss_imperial_space_destroy_2", "returnWulf2");
    }
    public boolean restuss_imperial_space_destroy_condition_killActive2(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "restuss_imperial_space_destroy_2");
    }
    public boolean restuss_imperial_space_destroy_condition_inPhase2(obj_id player, obj_id npc)
    {
    ...
    public boolean restuss_imperial_space_destroy_condition_inPhase1(obj_id player, obj_id npc)
    {
    ...
    public boolean restuss_imperial_space_destroy_condition_enoughKills(obj_id player, obj_id npc)
    {
        obj_id object = trial.getParent(npc);
    ...
    public boolean restuss_imperial_space_destroy_condition_ifFailedOne(obj_id player, obj_id npc)
    {
    ...
    public boolean restuss_imperial_space_destroy_condition_ifFailedTwo(obj_id player, obj_id npc)
    {
    ...
    public boolean restuss_imperial_space_destroy_condition_isRebelPlayer(obj_id player, obj_id npc)
    {
        return factions.isRebel(player);
    }
    public void restuss_imperial_space_destroy_action_givekill1(obj_id player, obj_id npc)
    {
    ...
    public void restuss_imperial_space_destroy_action_signalDone(obj_id player, obj_id npc)
    {
    ...
    public void restuss_imperial_space_destroy_action_givekill2(obj_id player, obj_id npc)
    {
    ...
    public void restuss_imperial_space_destroy_action_signalDone2(obj_id player, obj_id npc)
    {
    ...
    public void restuss_imperial_space_destroy_action_eject(obj_id player, obj_id npc)
    {
        expelFromBuilding(player);
    }
    public int restuss_imperial_space_destroy_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int restuss_imperial_space_destroy_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int restuss_imperial_space_destroy_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int restuss_imperial_space_destroy_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_30"))
        {
            doAnimationAction(player, "salute2");
    ...
    public int restuss_imperial_space_destroy_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_26"))
        {
            doAnimationAction(player, "salute2");
