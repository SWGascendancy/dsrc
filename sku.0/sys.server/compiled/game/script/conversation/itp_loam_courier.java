...
public class itp_loam_courier extends script.base_script
{
    ...
    public boolean itp_loam_courier_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean itp_loam_courier_condition_loamTaskActive(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "itp_loam_02", "itp_loam_02_02");
    }
    public void itp_loam_courier_action_loamSignal(obj_id player, obj_id npc)
    {
