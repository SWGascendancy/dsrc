...
public class rtp_leia_bothan_spynet extends script.base_script
{
    ...
    public boolean rtp_leia_bothan_spynet_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean rtp_leia_bothan_spynet_condition_leia02TaskActive(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "rtp_leia_02", "rtp_leia_02_01");
    }
    public void rtp_leia_bothan_spynet_action_leia02Signal(obj_id player, obj_id npc)
    {
