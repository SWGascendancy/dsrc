...
public class corvette_tallon_rebel1 extends script.base_script
{
    ...
    public boolean corvette_tallon_rebel1_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corvette_tallon_rebel1_condition_knowsLocation3(obj_id player, obj_id npc)
    {
        return utils.hasScriptVar(player, "corl_corvette.heardLocation3");
    }
    public boolean corvette_tallon_rebel1_condition_knowsLocation2(obj_id player, obj_id npc)
    {
        return utils.hasScriptVar(player, "corl_corvette.heardLocation2");
    }
    public boolean corvette_tallon_rebel1_condition_knowsLocation1(obj_id player, obj_id npc)
    {
        return utils.hasScriptVar(player, "corl_corvette.heardLocation1");
    }
    public boolean corvette_tallon_rebel1_condition_knowsAllLocations(obj_id player, obj_id npc)
    {
    ...
    public boolean corvette_tallon_rebel1_condition_hasStuff(obj_id player, obj_id npc)
    {
    ...
    public boolean corvette_tallon_rebel1_condition_hasTravelTicket(obj_id player, obj_id npc)
    {
    ...
    public boolean corvette_tallon_rebel1_condition_hasNoObjectsAndNoTicket(obj_id player, obj_id npc)
    {
        return ((!corvette_tallon_rebel1_condition_hasTravelTicket(player, npc)) && (!corvette_tallon_rebel1_condition_hasStuff(player, npc)));
    }
    public boolean corvette_tallon_rebel1_condition_isOnQuest(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "corl_corvette.rebel_rescue");
    }
    public boolean corvette_tallon_rebel1_condition_onDifferentCorvetteQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean corvette_tallon_rebel1_condition_earnedCorvetteReward(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "corvette.rebel_rescue.finished");
    }
    public boolean corvette_tallon_rebel1_condition_hasInventorySpace(obj_id player, obj_id npc)
    {
    ...
    public void corvette_tallon_rebel1_action__defaultAction(obj_id player, obj_id npc)
    {
    }
    public void corvette_tallon_rebel1_action_heardLocation1(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "corl_corvette.heardLocation1", 1);
        return;
    }
    public void corvette_tallon_rebel1_action_heardLocation2(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "corl_corvette.heardLocation2", 1);
        return;
    }
    public void corvette_tallon_rebel1_action_heardLocation3(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "corl_corvette.heardLocation3", 1);
        return;
    }
    public void corvette_tallon_rebel1_action_acceptsQuest(obj_id player, obj_id npc)
    {
    ...
    public void corvette_tallon_rebel1_action_clearLocations(obj_id player, obj_id npc)
    {
    ...
    public void corvette_tallon_rebel1_action_giveTicket(obj_id player, obj_id npc)
    {
    ...
    public void corvette_tallon_rebel1_action_quitCorvetteQuest(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "corl_corvette"))
        {
    ...
    public void corvette_tallon_rebel1_action_takeObject2(obj_id player, obj_id npc)
    {
    ...
    public void corvette_tallon_rebel1_action_takeObject3(obj_id player, obj_id npc)
    {
    ...
    public void corvette_tallon_rebel1_action_removeTicket(obj_id player, obj_id npc)
    {
    ...
    public void corvette_tallon_rebel1_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return;
    }
    public void corvette_tallon_rebel1_action_giveCorvetteReward(obj_id player, obj_id npc)
    {
