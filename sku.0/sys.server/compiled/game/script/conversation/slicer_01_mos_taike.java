...
public class slicer_01_mos_taike extends script.base_script
{
    ...
    public boolean slicer_01_mos_taike_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean slicer_01_mos_taike_condition_shouldBeOnLok(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean slicer_01_mos_taike_condition_hasInitialQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isQuestActive(player, "quest_04_meet_cale_herron");
    }
    public boolean slicer_01_mos_taike_condition_shouldBeLadyValerian(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "quest_05_frame_valarians", "gotoLuckyDespot");
    }
    public boolean slicer_01_mos_taike_condition_hasCompletedInitQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "quest_04_meet_cale_herron", "speakCaleCompleteQuest");
    }
    public boolean slicer_01_mos_taike_condition_hasCompletedValarian(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean slicer_01_mos_taike_condition_failedToDefeatAssassin(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean slicer_01_mos_taike_condition_successDefeatAssassin(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean slicer_01_mos_taike_condition_hasCompletedDathomir(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean slicer_01_mos_taike_condition_isRebelCheck(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (factions.isRebel(player));
    }
    public boolean slicer_01_mos_taike_condition_isNeutralCheck(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (!factions.isImperial(player) && !factions.isRebel(player));
    }
    public boolean slicer_01_mos_taike_condition_isImperialCheck(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (factions.isImperial(player));
    }
    public boolean slicer_01_mos_taike_condition_isRebelOrNeutral(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return slicer_01_mos_taike_condition_isNeutralCheck(player, npc) || slicer_01_mos_taike_condition_isRebelCheck(player, npc);
    }
    public boolean slicer_01_mos_taike_condition_hasCompletedProlog(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "quest_08_dathomir_outpost_final");
    }
    public boolean slicer_01_mos_taike_condition_canceledQuest06(obj_id player, obj_id npc)
    {
    ...
    public boolean slicer_01_mos_taike_condition_isCheckingWithBib(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean slicer_01_mos_taike_condition_completedQuest04Deleted05(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public void slicer_01_mos_taike_action_sendSignalSpokeCale(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "playerSpokeToCaleHerron");
    }
    public void slicer_01_mos_taike_action_startCommunication(obj_id player, obj_id npc)
    {
    ...
    public void slicer_01_mos_taike_action_grantFrameValarainQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest_05_frame_valarians");
    }
    public void slicer_01_mos_taike_action_sendSignalGoLok(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "metWithCaleHerron");
    }
    public void slicer_01_mos_taike_action_finishPrologGetRewards(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "PlayerFinishedUp");
        slicer_01_mos_taike_action_grantOutbreakQuest(player, npc);
    }
    public void slicer_01_mos_taike_action_grantQuest06(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest_06_conspire_cale");
    }
    public void slicer_01_mos_taike_action_sendSignalCompleteQuest04(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "spokenCale");
    }
    public void slicer_01_mos_taike_action_grantOutbreakQuest(obj_id player, obj_id npc)
    {
    ...
    public int slicer_01_mos_taike_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_01_mos_taike_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_01_mos_taike_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_01_mos_taike_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_01_mos_taike_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_01_mos_taike_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_01_mos_taike_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_75"))
        {
            if (slicer_01_mos_taike_condition__defaultCondition(player, npc))
    ...
    public int slicer_01_mos_taike_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_01_mos_taike_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_01_mos_taike_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_01_mos_taike_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_01_mos_taike_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_01_mos_taike_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_01_mos_taike_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_01_mos_taike_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_01_mos_taike_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_01_mos_taike_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_01_mos_taike_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_01_mos_taike_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_01_mos_taike_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_01_mos_taike_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_01_mos_taike_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_01_mos_taike_handleBranch30(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_01_mos_taike_handleBranch31(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_01_mos_taike_handleBranch32(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_01_mos_taike_handleBranch33(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_01_mos_taike_handleBranch34(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_01_mos_taike_handleBranch35(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_01_mos_taike_handleBranch38(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_01_mos_taike_handleBranch39(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_01_mos_taike_handleBranch40(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_01_mos_taike_handleBranch41(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_01_mos_taike_handleBranch42(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_01_mos_taike_handleBranch43(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_01_mos_taike_handleBranch44(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int slicer_01_mos_taike_handleBranch45(obj_id player, obj_id npc, string_id response)
    {
