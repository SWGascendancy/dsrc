...
public class corellia_38_teilo_monnro extends script.base_script
{
    ...
    public boolean corellia_38_teilo_monnro_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_38_teilo_monnro_condition_taskOneActive(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "corellia_38_sidequest_03");
    }
    public boolean corellia_38_teilo_monnro_condition_taskOneComplete(obj_id player, obj_id npc)
    {
    ...
    public void corellia_38_teilo_monnro_action_questGranted(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "corellia_38_sidequest_03");
    }
    public void corellia_38_teilo_monnro_action_taskOneCompletedSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "corellia_38_sidequest_03_02");
    }
    public int corellia_38_teilo_monnro_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
