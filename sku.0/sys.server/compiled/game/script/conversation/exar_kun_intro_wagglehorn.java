...
public class exar_kun_intro_wagglehorn extends script.base_script
{
    ...
    public boolean exar_kun_intro_wagglehorn_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean exar_kun_intro_wagglehorn_condition_exar_kun_01_01_active(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "exar_kun_intro_01", "exar_kun_intro_01_01");
    }
    public boolean exar_kun_intro_wagglehorn_condition_exar_kun_01_10_active(obj_id player, obj_id npc)
    {
    ...
    public boolean exar_kun_intro_wagglehorn_condition_exar_kun_02_04_active(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "exar_kun_intro_02", "exar_kun_intro_02_04");
    }
    public boolean exar_kun_intro_wagglehorn_condition_completed_exar_kun_intro(obj_id player, obj_id npc)
    {
    ...
    public boolean exar_kun_intro_wagglehorn_condition_exar_kun_01_01_next(obj_id player, obj_id npc)
    {
    ...
    public boolean exar_kun_intro_wagglehorn_condition_exar_kun_01_complete(obj_id player, obj_id npc)
    {
    ...
    public void exar_kun_intro_wagglehorn_action_exar_kun_01_01_signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "exar_kun_intro_01_01");
    }
    public void exar_kun_intro_wagglehorn_action_exar_kun_01_10_signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "exar_kun_intro_01_10");
    }
    public void exar_kun_intro_wagglehorn_action_exar_kun_02_04_signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "exar_kun_intro_02_04");
    }
    public void exar_kun_intro_wagglehorn_action_exar_kun_02_grant(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "exar_kun_intro_02");
    }
    public int exar_kun_intro_wagglehorn_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int exar_kun_intro_wagglehorn_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int exar_kun_intro_wagglehorn_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
