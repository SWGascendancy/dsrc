...
public class coronet_sheelya_husband extends script.base_script
{
    ...
    public boolean coronet_sheelya_husband_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean coronet_sheelya_husband_condition_finishedDiktat(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "quest/corellia_coronet_capitol_problems_thankful_diktat");
    }
    public boolean coronet_sheelya_husband_condition_onKeyQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "quest/coronet_sheelya_keys");
    }
    public boolean coronet_sheelya_husband_condition_finishedKeyQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean coronet_sheelya_husband_condition_onCOquest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "quest/coronet_sheelya_commanding_officer");
    }
    public boolean coronet_sheelya_husband_condition_finishedCOquest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "quest/coronet_sheelya_commanding_officer");
    }
    public void coronet_sheelya_husband_action_sendKeySignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "keysReturned");
    }
    public void coronet_sheelya_husband_action_sendCOsignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "spokeWithCO");
    }
    public void coronet_sheelya_husband_action_grantKeyQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest/coronet_sheelya_keys");
    }
    public void coronet_sheelya_husband_action_grantCOquest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest/coronet_sheelya_commanding_officer");
    }
    public int coronet_sheelya_husband_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int coronet_sheelya_husband_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int coronet_sheelya_husband_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int coronet_sheelya_husband_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int coronet_sheelya_husband_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
