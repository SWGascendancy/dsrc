...
public class prof_spy_21_eyan extends script.base_script
{
    ...
    public boolean prof_spy_21_eyan_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean prof_spy_21_eyan_condition_spyOnTask(obj_id player, obj_id npc)
    {
    ...
    public boolean prof_spy_21_eyan_condition_spyOnSteal(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/prof_spy_21a");
    ...
    public boolean prof_spy_21_eyan_condition_spyQuestComplete(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/prof_spy_21a");
        boolean OnTask = (questIsQuestComplete(questId, player));
        return OnTask;
    }
    public void prof_spy_21_eyan_action_signalSpyMission(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "spy_mission_2_e3");
    }
    public int prof_spy_21_eyan_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int prof_spy_21_eyan_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int prof_spy_21_eyan_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int prof_spy_21_eyan_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int prof_spy_21_eyan_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int prof_spy_21_eyan_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int prof_spy_21_eyan_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int prof_spy_21_eyan_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int prof_spy_21_eyan_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int prof_spy_21_eyan_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
