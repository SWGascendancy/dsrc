...
public class ep3_etyyy_ryoo_finn extends script.base_script
{
    ...
    public boolean ep3_etyyy_ryoo_finn_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_etyyy_ryoo_finn_condition_hasCompletedRyooQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_hunt_johnson_retrieve_ryoos_stash");
    }
    public boolean ep3_etyyy_ryoo_finn_condition_foundRyoosSalt(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_hunt_johnson_retrieve_ryoos_stash", "johnson_ryoosSalt");
    }
    public boolean ep3_etyyy_ryoo_finn_condition_isRetrievingRyoosSalt(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_hunt_johnson_retrieve_ryoos_stash", "johnson_findRyoosStash");
    }
    public boolean ep3_etyyy_ryoo_finn_condition_speakWithRyoo(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_hunt_johnson_retrieve_ryoos_stash", "johnson_talkToRyoo");
    }
    public void ep3_etyyy_ryoo_finn_action_retrieveRyoosStash(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "johnson_talkToRyoo");
    }
    public int ep3_etyyy_ryoo_finn_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_ryoo_finn_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_ryoo_finn_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
