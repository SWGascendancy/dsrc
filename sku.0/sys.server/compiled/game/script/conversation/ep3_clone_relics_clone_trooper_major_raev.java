...
public class ep3_clone_relics_clone_trooper_major_raev extends script.base_script
{
    ...
    public boolean ep3_clone_relics_clone_trooper_major_raev_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_clone_relics_clone_trooper_major_raev_condition_onTaskTalkOfficer(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "ep3_clone_relics_clone_trooper_mort_imperial", "talkToOfficer"));
    }
    public boolean ep3_clone_relics_clone_trooper_major_raev_condition_onTaskReturningDatapad(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "ep3_clone_relics_clone_trooper_mort_imperial", "returnDatapad"));
    }
    public boolean ep3_clone_relics_clone_trooper_major_raev_condition_onTaskWait(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "ep3_clone_relics_clone_trooper_mort_imperial", "waitForIt"));
    }
    public boolean ep3_clone_relics_clone_trooper_major_raev_condition_onTaskTalkOfficerAgain(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "ep3_clone_relics_clone_trooper_mort_imperial", "talkToOfficerAgain"));
    }
    public boolean ep3_clone_relics_clone_trooper_major_raev_condition_hasTalkedToEmperor(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedTask(player, "ep3_clone_relics_clone_trooper_mort_imperial", "talkToEmperor"));
    }
    public boolean ep3_clone_relics_clone_trooper_major_raev_condition_doneWithImperialPart(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedTask(player, "ep3_clone_relics_clone_trooper_mort_imperial", "imperialReward"));
    }
    public void ep3_clone_relics_clone_trooper_major_raev_action_officer1(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedToOfficer");
    }
    public void ep3_clone_relics_clone_trooper_major_raev_action_officer2(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedToOfficer2");
    }
    public void ep3_clone_relics_clone_trooper_major_raev_action_datapadTurnedIn(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "datapadReturned");
    }
    public int ep3_clone_relics_clone_trooper_major_raev_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_major_raev_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_major_raev_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_major_raev_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
