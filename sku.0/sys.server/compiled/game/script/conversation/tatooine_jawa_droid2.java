...
public class tatooine_jawa_droid2 extends script.base_script
{
    ...
    public boolean tatooine_jawa_droid2_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public int tatooine_jawa_droid2_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
