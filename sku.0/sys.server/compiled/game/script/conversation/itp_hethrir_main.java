...
public class itp_hethrir_main extends script.base_script
{
    ...
    public boolean itp_hethrir_main_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean itp_hethrir_main_condition_itp_hethrir_01_active(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "itp_hethrir_01");
    }
    public boolean itp_hethrir_main_condition_itp_hethrir_01_complete(obj_id player, obj_id npc)
    {
    ...
    public boolean itp_hethrir_main_condition_completedLoam(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "itp_loam_02");
    }
    public boolean itp_hethrir_main_condition_notImperial(obj_id player, obj_id npc)
    {
    ...
    public boolean itp_hethrir_main_condition_imperial_isOnLeave(obj_id player, obj_id npc)
    {
        return factions.isOnLeave(player);
    }
    public void itp_hethrir_main_action_itp_hethrir_01_granted(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "itp_hethrir_01");
    }
    public void itp_hethrir_main_action_itp_hethrir_01_signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "itp_hethrir_01_05");
    }
    public int itp_hethrir_main_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
