...
public class npe_main_cargo extends script.base_script
{
    ...
    public boolean npe_main_cargo_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_main_cargo_condition_onCorrectStep(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_new_main_quest", "getparts");
    }
    public boolean npe_main_cargo_condition_completedMainLineQuestStep(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "npe_main_quest", "talktocargo");
    }
    public boolean npe_main_cargo_condition_completedbothAssignments(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_medic");
    }
    public boolean npe_main_cargo_condition_completedneitherAssignment(obj_id player, obj_id npc)
    {
        return (groundquests.isQuestActive(player, "npe_medic") || groundquests.isQuestActive(player, "npe_pointer_medic"));
    }
    public void npe_main_cargo_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void npe_main_cargo_action_signalMainLineStepComplete(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_new_main_quest_mech");
    }
    public int npe_main_cargo_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_main_cargo_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_main_cargo_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
