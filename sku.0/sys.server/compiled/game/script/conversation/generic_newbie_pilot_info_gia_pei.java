...
public class generic_newbie_pilot_info_gia_pei extends script.base_script
{
    ...
    public boolean generic_newbie_pilot_info_gia_pei_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean generic_newbie_pilot_info_gia_pei_condition_remembersPlayer(obj_id player, obj_id npc)
    {
        return (utils.hasScriptVar(player, "metNewbiePilot"));
    }
    public boolean generic_newbie_pilot_info_gia_pei_condition_isImperialPilot(obj_id player, obj_id npc)
    {
        return (hasSkill(player, "pilot_imperial_navy_novice"));
    }
    public boolean generic_newbie_pilot_info_gia_pei_condition_isRebelPilot(obj_id player, obj_id npc)
    {
        return (hasSkill(player, "pilot_rebel_navy_novice"));
    }
    public boolean generic_newbie_pilot_info_gia_pei_condition_isPrivateerPilot(obj_id player, obj_id npc)
    {
        return hasSkill(player, "pilot_neutral_novice");
    }
    public boolean generic_newbie_pilot_info_gia_pei_condition_hasSpaceExpansion(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean generic_newbie_pilot_info_gia_pei_condition_hasSpaceShip(obj_id player, obj_id npc)
    {
        return (space_quest.hasShip(player));
    }
    public void generic_newbie_pilot_info_gia_pei_action_rememberPlayer(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "metNewbiePilot", true);
    }
    public void generic_newbie_pilot_info_gia_pei_action_grantQuestOne(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "delivery", "tatooine_newbie_1");
        space_quest.grantNewbieShip(player, "rebel");
    }
    public int generic_newbie_pilot_info_gia_pei_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int generic_newbie_pilot_info_gia_pei_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
