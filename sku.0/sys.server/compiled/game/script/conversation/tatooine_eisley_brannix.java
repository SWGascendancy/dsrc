...
public class tatooine_eisley_brannix extends script.base_script
{
    ...
    public boolean tatooine_eisley_brannix_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tatooine_eisley_brannix_condition_cultQuestComplete(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_eisley_krayt_cult");
        boolean OnTask = (questIsQuestComplete(questId1, player));
        return OnTask;
    }
    public boolean tatooine_eisley_brannix_condition_cultTaskComplete(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_eisley_krayt_cult");
    ...
    public boolean tatooine_eisley_brannix_condition_cultOnTask(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_eisley_krayt_cult");
    ...
    public boolean tatooine_eisley_brannix_condition_blocker(obj_id player, obj_id npc)
    {
        return groundquests.isQuestDisabled("tatooine_eisley_krayt_cult");
    }
    public void tatooine_eisley_brannix_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void tatooine_eisley_brannix_action_grantCultQuest(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/tatooine_eisley_krayt_cult");
        groundquests.grantQuest(questId, player, npc, true);
    }
    public void tatooine_eisley_brannix_action_signalCultReward(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tat_eisley_krayt_cult_e2");
    }
    public int tatooine_eisley_brannix_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_brannix_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_brannix_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_brannix_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_brannix_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_brannix_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_brannix_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_brannix_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_brannix_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_brannix_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_brannix_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_brannix_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_brannix_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
