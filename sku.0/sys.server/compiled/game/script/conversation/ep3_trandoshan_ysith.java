...
public class ep3_trandoshan_ysith extends script.base_script
{
    ...
    public boolean ep3_trandoshan_ysith_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_trandoshan_ysith_condition_taskActive(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_trando_ysith", "myssithKilled");
    }
    public boolean ep3_trandoshan_ysith_condition_isOnQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_trando_ysith");
    }
    public boolean ep3_trandoshan_ysith_condition_hasCompletedMission(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_trando_ysith");
    }
    public void ep3_trandoshan_ysith_action_giveQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_trando_ysith");
    }
    public void ep3_trandoshan_ysith_action_doSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "giveYsithReward");
    }
    public int ep3_trandoshan_ysith_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_ysith_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_ysith_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_ysith_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_ysith_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_ysith_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_ysith_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
