...
public class trig_longo extends script.base_script
{
    ...
    public boolean trig_longo_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean trig_longo_condition_isNotImmunized(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean trig_longo_condition_hasTrigTask(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean trig_longo_condition_hasDeletedQuest2(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean trig_longo_condition_hasCompletedQuestLine(obj_id player, obj_id npc)
    {
    ...
    public boolean trig_longo_condition_hasDeliveredRadioEpsilon(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.hasCompletedQuest(player, "outbreak_radio_delivery_03");
    }
    public boolean trig_longo_condition_hasCompletedQuest2(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean trig_longo_condition_isNeutral(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.hasCompletedQuest(player, "outbreak_quest_01_neutral");
    }
    public boolean trig_longo_condition_isRebel(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.hasCompletedQuest(player, "outbreak_quest_01_rebel");
    }
    public void trig_longo_action_updatedQuestWaypoint(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        groundquests.sendSignal(player, "spokenToTrigQuest01");
    }
    public void trig_longo_action_giveQuest2(obj_id player, obj_id npc)
    {
    ...
    public int trig_longo_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int trig_longo_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int trig_longo_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int trig_longo_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int trig_longo_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int trig_longo_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int trig_longo_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_79"))
        {
            if (trig_longo_condition__defaultCondition(player, npc))
    ...
    public int trig_longo_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int trig_longo_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
