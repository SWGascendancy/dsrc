...
public class borvo_the_hutt extends script.base_script
{
    ...
    public boolean borvo_the_hutt_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean borvo_the_hutt_condition_isOnContentPath(obj_id player, obj_id npc)
    {
    ...
    public boolean borvo_the_hutt_condition_isOnDarklighterPath(obj_id player, obj_id npc)
    {
    ...
    public boolean borvo_the_hutt_condition_canTalkToBorvo(obj_id player, obj_id npc)
    {
    ...
    public boolean borvo_the_hutt_condition_killingBountyHunter(obj_id player, obj_id npc)
    {
    ...
    public boolean borvo_the_hutt_condition_killingExPartner(obj_id player, obj_id npc)
    {
    ...
    public boolean borvo_the_hutt_condition_deadBountyHunter(obj_id player, obj_id npc)
    {
    ...
    public boolean borvo_the_hutt_condition_deadExPartner(obj_id player, obj_id npc)
    {
    ...
    public boolean borvo_the_hutt_condition_acquiredDroidAI(obj_id player, obj_id npc)
    {
    ...
    public boolean borvo_the_hutt_condition_doneAll(obj_id player, obj_id npc)
    {
    ...
    public boolean borvo_the_hutt_condition_onVaultQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean borvo_the_hutt_condition_OnBorvoQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean borvo_the_hutt_condition_needsHuffsRifle(obj_id player, obj_id npc)
    {
    ...
    public void borvo_the_hutt_action_grantBorvoVaultQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "goToVault");
    }
    public void borvo_the_hutt_action_grantBorvoBountyQuest(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "quest/borvo_bounty_hunter");
    }
    public void borvo_the_hutt_action_grantBorvoPartnerQuest(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "quest/borvo_ex_partner");
    }
    public void borvo_the_hutt_action_sendBountySignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "finishedBounty");
    }
    public void borvo_the_hutt_action_sendPartnerSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "finishedPartner");
    }
    public void borvo_the_hutt_action_sendGotAiSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "gotAI");
    }
    public void borvo_the_hutt_action_giveHuffsRifle(obj_id player, obj_id npc)
    {
        String rifle = "object/tangible/loot/quest/rifle_quest_tusken.iff";
        createObjectInInventoryAllowOverload(rifle, player);
        return;
    }
    public int borvo_the_hutt_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int borvo_the_hutt_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int borvo_the_hutt_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int borvo_the_hutt_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int borvo_the_hutt_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int borvo_the_hutt_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int borvo_the_hutt_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int borvo_the_hutt_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int borvo_the_hutt_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int borvo_the_hutt_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int borvo_the_hutt_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
