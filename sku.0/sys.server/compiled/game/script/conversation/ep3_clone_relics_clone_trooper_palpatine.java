...
public class ep3_clone_relics_clone_trooper_palpatine extends script.base_script
{
    ...
    public boolean ep3_clone_relics_clone_trooper_palpatine_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_clone_relics_clone_trooper_palpatine_condition_onTaskTalkEmperor(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "ep3_clone_relics_clone_trooper_mort_imperial", "talkToEmperor"));
    }
    public boolean ep3_clone_relics_clone_trooper_palpatine_condition_onTaskMorkov(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "ep3_clone_relics_clone_trooper_mort_imperial", "killMorkov"));
    }
    public void ep3_clone_relics_clone_trooper_palpatine_action_emperorDone(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedToEmperor");
        setObjVar(player, "doneWithEmperor", 1);
    }
    public void ep3_clone_relics_clone_trooper_palpatine_action_deathOfPlayer(obj_id player, obj_id npc)
    {
    ...
    public int ep3_clone_relics_clone_trooper_palpatine_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_palpatine_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_palpatine_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_palpatine_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_palpatine_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_palpatine_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_palpatine_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
