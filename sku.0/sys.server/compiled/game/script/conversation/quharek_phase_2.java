...
public class quharek_phase_2 extends script.base_script
{
    ...
    public boolean quharek_phase_2_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean quharek_phase_2_condition_isPlayerCommunityCrafting(obj_id player, obj_id npc)
    {
    ...
    public boolean quharek_phase_2_condition_isCommunityCraftingEnabled(obj_id player, obj_id npc)
    {
        return fs_quests_cc.testCommunityCraftingEnabled(npc, 2);
    }
    public boolean quharek_phase_2_condition_canAddPlayer(obj_id player, obj_id npc)
    {
        obj_id craftingTracker = utils.getObjIdScriptVar(npc, fs_quests_cc.SCRIPTVAR_CRAFTING_TRACKER);
        if (isIdValid(craftingTracker))
        {
    ...
    public boolean quharek_phase_2_condition_isTrackingQuality(obj_id player, obj_id npc)
    {
        return utils.getBooleanScriptVar(npc, fs_quests_cc.SCRIPTVAR_TRACKING_QUALITY);
    }
    public boolean quharek_phase_2_condition_isTrackingQuantity(obj_id player, obj_id npc)
    {
        return utils.getBooleanScriptVar(npc, fs_quests_cc.SCRIPTVAR_TRACKING_QUANTITY);
    }
    public boolean quharek_phase_2_condition_isTrackingSlots(obj_id player, obj_id npc)
    {
        return utils.getBooleanScriptVar(npc, fs_quests_cc.SCRIPTVAR_TRACKING_SLOTS);
    }
    public boolean quharek_phase_2_condition_isPlayerCraftingOrQuesting(obj_id player, obj_id npc)
    {
    ...
    public boolean quharek_phase_2_condition_isPlayerSkilled(obj_id player, obj_id npc)
    {
        return hasSkill(player, "crafting_artisan_novice");
    }
    public boolean quharek_phase_2_condition_canAddPlayerAndIsSkilled(obj_id player, obj_id npc)
    {
        return quharek_phase_2_condition_canAddPlayer(player, npc) && quharek_phase_2_condition_isPlayerSkilled(player, npc);
    }
    public boolean quharek_phase_2_condition_hasPlayerFinishedQuestAndNotCrafting(obj_id player, obj_id npc)
    {
    ...
    public boolean quharek_phase_2_condition_hasPlayerFinishedQuestAndIsCrafting(obj_id player, obj_id npc)
    {
        return isQuestComplete(player, quests.getQuestId(QUEST_STEP_02)) && quharek_phase_2_condition_isPlayerCommunityCrafting(player, npc);
    }
    public void quharek_phase_2_action_showPlayerSlot1Quality(obj_id player, obj_id npc)
    {
        fs_quests_cc.showPlayerProjectStats(npc, player, 1, true, 2);
    }
    public void quharek_phase_2_action_showPlayerProjectAttributes(obj_id player, obj_id npc)
    {
        fs_quests_cc.showPlayerProjectAttribs(npc, player, 2);
    }
    public void quharek_phase_2_action_showPlayerSlot2Quality(obj_id player, obj_id npc)
    {
        fs_quests_cc.showPlayerProjectStats(npc, player, 2, true, 2);
    }
    public void quharek_phase_2_action_showPlayerSlot4Quality(obj_id player, obj_id npc)
    {
        fs_quests_cc.showPlayerProjectStats(npc, player, 4, true, 2);
    }
    public void quharek_phase_2_action_showPlayerSlot5Quality(obj_id player, obj_id npc)
    {
        fs_quests_cc.showPlayerProjectStats(npc, player, 5, true, 2);
    }
    public void quharek_phase_2_action_showPlayerProjectQuality(obj_id player, obj_id npc)
    {
        fs_quests_cc.showPlayerProjectStats(npc, player, 0, true, 2);
    }
    public void quharek_phase_2_action_showPlayerSlot3Quality(obj_id player, obj_id npc)
    {
        fs_quests_cc.showPlayerProjectStats(npc, player, 3, true, 2);
    }
    public void quharek_phase_2_action_showPlayerSlot1Quantity(obj_id player, obj_id npc)
    {
        fs_quests_cc.showPlayerProjectStats(npc, player, 1, false, 2);
    }
    public void quharek_phase_2_action_showPlayerSlot2Quantity(obj_id player, obj_id npc)
    {
        fs_quests_cc.showPlayerProjectStats(npc, player, 2, false, 2);
    }
    public void quharek_phase_2_action_showPlayerSlot4Quantity(obj_id player, obj_id npc)
    {
        fs_quests_cc.showPlayerProjectStats(npc, player, 4, false, 2);
    }
    public void quharek_phase_2_action_showPlayerSlot5Quantity(obj_id player, obj_id npc)
    {
        fs_quests_cc.showPlayerProjectStats(npc, player, 5, false, 2);
    }
    public void quharek_phase_2_action_showPlayerProjectQuantity(obj_id player, obj_id npc)
    {
        fs_quests_cc.showPlayerProjectStats(npc, player, 0, false, 2);
    }
    public void quharek_phase_2_action_showPlayerSlot3Quantity(obj_id player, obj_id npc)
    {
        fs_quests_cc.showPlayerProjectStats(npc, player, 3, false, 2);
    }
    public void quharek_phase_2_action_grantPlayerQuest(obj_id player, obj_id npc)
    {
    ...
    public int quharek_phase_2_tokenDI_minIngredientsRequired(obj_id player, obj_id npc)
    {
