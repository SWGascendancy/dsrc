...
public class fs_quests_sad_conv extends script.base_script
{
    ...
    public boolean fs_quests_sad_conv_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean fs_quests_sad_conv_condition_hasCompletedAllTasksCond(obj_id player, obj_id npc)
    {
        return fs_quests_sad.hasCompletedAllTasks(player);
    }
    public boolean fs_quests_sad_conv_condition_hasExceededTaskLimitCond(obj_id player, obj_id npc)
    {
        return fs_quests_sad.hasExceededTaskLimit(player);
    }
    public boolean fs_quests_sad_conv_condition_hasTaskCond(obj_id player, obj_id npc)
    {
        return fs_quests_sad.hasTask(player);
    }
    public boolean fs_quests_sad_conv_condition_isVillageEligibleCond(obj_id player, obj_id npc)
    {
        return fs_quests.isVillageEligible(player);
    }
    public boolean fs_quests_sad_conv_condition_readyForTaskCond(obj_id player, obj_id npc)
    {
    ...
    public boolean fs_quests_sad_conv_condition_hasTheaterAssignedCond(obj_id player, obj_id npc)
    {
        return hasTheaterAssigned(player);
    }
    public boolean fs_quests_sad_conv_condition_hasNotCompletedAnyTasksCond(obj_id player, obj_id npc)
    {
        return !quests.isComplete("fs_quests_sad_task1", player);
    }
    public boolean fs_quests_sad_conv_condition_tooLowLevelCond(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean fs_quests_sad_conv_condition_hasFullInventoryCond(obj_id player, obj_id npc)
    {
    ...
    public boolean fs_quests_sad_conv_condition_completedOtherPhaseQuestCond(obj_id player, obj_id npc)
    {
        return fs_quests.hasQuestCompleted(player);
    }
    public void fs_quests_sad_conv_action_grantTask(obj_id player, obj_id npc)
    {
    ...
    public void fs_quests_sad_conv_action_giveGeiger(obj_id player, obj_id npc)
    {
        geiger.resetGeiger(player);
    }
    public void fs_quests_sad_conv_action_clearWaypoint(obj_id player, obj_id npc)
    {
    ...
    public String fs_quests_sad_conv_tokenTO_greetString(obj_id player, obj_id npc)
    {
        return getFirstName(player);
    }
    public float fs_quests_sad_conv_tokenDF_tokenDF0001(obj_id player, obj_id npc)
    {
        return 0.f;
    }
