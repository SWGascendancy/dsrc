...
public class npe_side_dungeon_meat extends script.base_script
{
    ...
    public boolean npe_side_dungeon_meat_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_side_dungeon_meat_condition_isOnDungeonMain(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "npe_dungeon_main");
    }
    public boolean npe_side_dungeon_meat_condition_hasFinished(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_side_dungeon_meat");
    }
    public boolean npe_side_dungeon_meat_condition_isTaskActiveAny(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_side_dungeon_meat_condition_isTaskActiveFirst(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_side_dungeon_meat", "npe_side_dungeon_meat_return");
    }
    public boolean npe_side_dungeon_meat_condition_isTaksActiveLast(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_side_dungeon_meat", "npe_side_dungeon_meat_more_signal");
    }
    public boolean npe_side_dungeon_meat_condition_hasTemplate(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "npe.finishedTemplate");
    }
    public void npe_side_dungeon_meat_action_giveQuest(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "npe_side_dungeon_meat");
        setObjVar(player, "npe.talkedToFiask", 1);
    }
    public void npe_side_dungeon_meat_action_sendSignalStack(obj_id player, obj_id npc)
    {
    ...
    public int npe_side_dungeon_meat_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_side_dungeon_meat_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_side_dungeon_meat_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_side_dungeon_meat_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_side_dungeon_meat_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_side_dungeon_meat_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_side_dungeon_meat_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_side_dungeon_meat_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_36"))
        {
            if (npe_side_dungeon_meat_condition__defaultCondition(player, npc))
