...
public class loveday_ewok_cupid extends script.base_script
{
    ...
    public boolean loveday_ewok_cupid_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean loveday_ewok_cupid_condition_alreadyHasBadge(obj_id player, obj_id npc)
    {
        return badge.hasBadge(player, "loveday_cupid_badge_10");
    }
    public boolean loveday_ewok_cupid_condition_hasCardBundle(obj_id player, obj_id npc)
    {
    ...
    public boolean loveday_ewok_cupid_condition_hasChakHearts(obj_id player, obj_id npc)
    {
    ...
    public boolean loveday_ewok_cupid_condition_preparingToLeave(obj_id player, obj_id npc)
    {
        return hasObjVar(npc, "preparingForDespawn");
    }
    public boolean loveday_ewok_cupid_condition_preparingToLeave_hasBadge(obj_id player, obj_id npc)
    {
        return hasObjVar(npc, "preparingForDespawn") && badge.hasBadge(player, "loveday_cupid_badge_10");
    }
    public void loveday_ewok_cupid_action_hearts_grantCupidBadge(obj_id player, obj_id npc)
    {
    ...
    public void loveday_ewok_cupid_action_cards_grantCupidBadge(obj_id player, obj_id npc)
    {
        obj_id lovedayCardBundle = utils.getStaticItemInInventory(player, "item_event_loveday_card_stack");
        if (isIdValid(lovedayCardBundle))
        {
    ...
    public void loveday_ewok_cupid_action_grant_collectionSlot(obj_id player, obj_id npc)
    {
        if (!hasCompletedCollectionSlot(player, "loveday_2010_found_kyoopid"))
        {
            modifyCollectionSlotValue(player, "loveday_2010_found_kyoopid", 1);
    ...
    public int loveday_ewok_cupid_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int loveday_ewok_cupid_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int prepareForDespawn(obj_id self, dictionary params)
    {
        setObjVar(self, "preparingForDespawn", true);
        messageTo(self, "handleMyDespawn", null, 180, false);
        return SCRIPT_CONTINUE;
    }
    public int handleMyDespawn(obj_id self, dictionary params)
    {
    ...
    public int handleDestroySelf(obj_id self, dictionary params)
    {
