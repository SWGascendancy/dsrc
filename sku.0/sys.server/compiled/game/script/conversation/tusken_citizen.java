...
public class tusken_citizen extends script.base_script
{
    ...
    public boolean tusken_citizen_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tusken_citizen_condition_staffed(obj_id player, obj_id npc)
    {
        return getIntObjVar(npc, "phase") == 1;
    }
    public void tusken_citizen_action_goToHotel(obj_id player, obj_id npc)
    {
