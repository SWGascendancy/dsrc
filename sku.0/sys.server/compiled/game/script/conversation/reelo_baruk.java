...
public class reelo_baruk extends script.base_script
{
    ...
    public boolean reelo_baruk_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean reelo_baruk_condition_completedReelosQuests(obj_id player, obj_id npc)
    {
    ...
    public boolean reelo_baruk_condition_AlkharanQuest_active(obj_id player, obj_id npc)
    {
    ...
    public boolean reelo_baruk_condition_AlkharanQuest_finished(obj_id player, obj_id npc)
    {
    ...
    public boolean reelo_baruk_condition_ValarianSoldiers_active(obj_id player, obj_id npc)
    {
    ...
    public boolean reelo_baruk_condition_ValariansSoldiers_finished(obj_id player, obj_id npc)
    {
    ...
    public boolean reelo_baruk_condition_DebtCollection_active(obj_id player, obj_id npc)
    {
    ...
    public boolean reelo_baruk_condition_DebtCollection_finished(obj_id player, obj_id npc)
    {
    ...
    public boolean reelo_baruk_condition_reeloQuestActive(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "quest/jabba_reelo_baruk");
    }
    public void reelo_baruk_action_grantReeloQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest/jabba_reelo_baruk");
        return;
    }
    public void reelo_baruk_action_sendDoneSignal(obj_id player, obj_id npc)
    {
    ...
    public void reelo_baruk_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int reelo_baruk_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int reelo_baruk_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int reelo_baruk_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int reelo_baruk_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int reelo_baruk_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int reelo_baruk_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int reelo_baruk_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
