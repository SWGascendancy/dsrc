...
public class corellia_coronet_demmi_wot extends script.base_script
{
    ...
    public boolean corellia_coronet_demmi_wot_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_coronet_demmi_wot_condition_starportVandalsBegin(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_coronet_capitol_problems_starport_vandals_2", "starport_vandals_5");
    }
    public boolean corellia_coronet_demmi_wot_condition_alreadyHasSpaceMission(obj_id player, obj_id npc)
    {
        return space_quest.hasQuest(player);
    }
    public boolean corellia_coronet_demmi_wot_condition_onFirstRagtagSquad(obj_id player, obj_id npc)
    {
        return space_quest.hasQuest(player, "assassinate", "corellia_coronet_starport_vandals_a");
    }
    public boolean corellia_coronet_demmi_wot_condition_playerHasShip(obj_id player, obj_id npc)
    {
        return space_utils.hasShip(player);
    }
    public boolean corellia_coronet_demmi_wot_condition_wonSecondRagtagSquad(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_coronet_capitol_problems_starport_vandals_2", "starport_vandals_6");
    }
    public boolean corellia_coronet_demmi_wot_condition_onSecondRagtagSquad(obj_id player, obj_id npc)
    {
        return space_quest.hasQuest(player, "assassinate", "corellia_coronet_starport_vandals_b");
    }
    public boolean corellia_coronet_demmi_wot_condition_starportVandalsCompleted(obj_id player, obj_id npc)
    {
    ...
    public void corellia_coronet_demmi_wot_action_giveFirstRagtagSquad(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "starport_vandals_5");
    }
    public void corellia_coronet_demmi_wot_action_giveShip(obj_id player, obj_id npc)
    {
        space_quest.grantNewbieShip(player, "neutral");
    }
    public void corellia_coronet_demmi_wot_action_starportVandalsEnded(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "starport_vandals_6");
    }
    public int corellia_coronet_demmi_wot_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_demmi_wot_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_demmi_wot_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
