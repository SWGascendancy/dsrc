...
public class mechanic extends script.base_script
{
    ...
    public boolean mechanic_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean mechanic_condition_deliveringParts(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "outbreak_quest_shuttle_parts", "deliverMechanic");
    }
    public void mechanic_action_sendSignalHx138(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        groundquests.sendSignal(player, "deliveredPartsMechanic");
    }
    public int mechanic_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
