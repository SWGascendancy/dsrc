...
public class tatooine_tosche_sorna extends script.base_script
{
    ...
    public boolean tatooine_tosche_sorna_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tatooine_tosche_sorna_condition_completedFlowers(obj_id player, obj_id npc)
    {
    ...
    public boolean tatooine_tosche_sorna_condition_onPlaceFlowers(obj_id player, obj_id npc)
    {
    ...
    public boolean tatooine_tosche_sorna_condition_onTalkSorna(obj_id player, obj_id npc)
    {
    ...
    public void tatooine_tosche_sorna_action_grantFlowers(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "tatooine_tosche_shmi_flowers_side");
    }
    public void tatooine_tosche_sorna_action_signalFlowers(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tat_tosche_nessa_e1");
    }
    public int tatooine_tosche_sorna_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_tosche_sorna_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_tosche_sorna_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_tosche_sorna_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_tosche_sorna_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_tosche_sorna_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_tosche_sorna_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
