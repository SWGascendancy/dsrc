...
public class lifeday_vendor extends script.base_script
{
    ...
    public boolean lifeday_vendor_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean lifeday_vendor_condition_questNotCompleted(obj_id player, obj_id npc)
    {
    ...
    public boolean lifeday_vendor_condition_questReturned(obj_id player, obj_id npc)
    {
    ...
    public boolean lifeday_vendor_condition_questCompleted(obj_id player, obj_id npc)
    {
        if (groundquests.hasCompletedQuest(player, "lifeday_stap_1"))
        {
            return true;
    ...
    public void lifeday_vendor_action_showTokenVendorUI(obj_id player, obj_id npc)
    {
    ...
    public void lifeday_vendor_action_giveQuest(obj_id player, obj_id npc)
    {
        if (groundquests.hasCompletedQuest(player, "lifeday_stap_1"))
        {
    ...
    public void lifeday_vendor_action_finishQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedSaun");
    }
    public int lifeday_vendor_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int lifeday_vendor_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int lifeday_vendor_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int lifeday_vendor_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int lifeday_vendor_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int lifeday_vendor_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int lifeday_vendor_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int lifeday_vendor_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int lifeday_vendor_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
