...
public class ep3_forest_outcast_dealer extends script.base_script
{
    ...
    public boolean ep3_forest_outcast_dealer_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_forest_outcast_dealer_condition_check_inv(obj_id player, obj_id npc)
    {
    ...
    public void ep3_forest_outcast_dealer_action_start_dealing(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        messageTo(npc, "startDealing", params, 1.0f, false);
    }
    public int ep3_forest_outcast_dealer_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_outcast_dealer_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
