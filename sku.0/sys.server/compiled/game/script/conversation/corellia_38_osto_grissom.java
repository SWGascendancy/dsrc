...
public class corellia_38_osto_grissom extends script.base_script
{
    ...
    public boolean corellia_38_osto_grissom_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_38_osto_grissom_condition_assaultActive(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_38_osto_grissom_condition_assaultFirstActive(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_38_corsec_files_02", "corsec_files_02_01");
    }
    public boolean corellia_38_osto_grissom_condition_questComplete(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "corellia_38_corsec_files_02", "corsec_files_02_04");
    }
    public void corellia_38_osto_grissom_action_questGranted(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest_name");
    }
    public void corellia_38_osto_grissom_action_assaultFirstSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "corsec_files_02_01");
    }
    public int corellia_38_osto_grissom_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_38_osto_grissom_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
