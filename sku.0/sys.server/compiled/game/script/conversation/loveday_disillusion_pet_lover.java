...
public class loveday_disillusion_pet_lover extends script.base_script
{
    ...
    public boolean loveday_disillusion_pet_lover_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean loveday_disillusion_pet_lover_condition_speakWithHim(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "loveday_disillusion_pet_lover_v2", "loveday_disillusion_pet_lover_03");
    }
    public boolean loveday_disillusion_pet_lover_condition_petSearch(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "loveday_disillusion_pet_lover_v2", "loveday_disillusion_pet_lover_04");
    }
    public boolean loveday_disillusion_pet_lover_condition_petFound(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "loveday_disillusion_pet_lover_v2", "loveday_disillusion_pet_lover_04");
    }
    public void loveday_disillusion_pet_lover_action_spokeWithHimSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "loveday_disillusion_pet_lover_03");
    }
    public int loveday_disillusion_pet_lover_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int loveday_disillusion_pet_lover_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
