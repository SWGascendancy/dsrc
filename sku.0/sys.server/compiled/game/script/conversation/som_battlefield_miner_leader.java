...
public class som_battlefield_miner_leader extends script.base_script
{
    ...
    public boolean som_battlefield_miner_leader_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean som_battlefield_miner_leader_condition_isMinerFollowing(obj_id player, obj_id npc)
    {
        return (ai_lib.isFollowing(npc) && !utils.hasScriptVar(npc, "deployed"));
    }
    public boolean som_battlefield_miner_leader_condition_isNotFollowing(obj_id player, obj_id npc)
    {
        return (!ai_lib.isFollowing(npc) && !utils.hasScriptVar(npc, "deployed"));
    }
    public boolean som_battlefield_miner_leader_condition_isDeployed(obj_id player, obj_id npc)
    {
        return utils.hasScriptVar(npc, "deployed");
    }
    public boolean som_battlefield_miner_leader_condition_isNotDeployed(obj_id player, obj_id npc)
    {
        return (!utils.hasScriptVar(npc, "deployed"));
    }
    public void som_battlefield_miner_leader_action_deployForces(obj_id player, obj_id npc)
    {
    ...
    public void som_battlefield_miner_leader_action_startFollowing(obj_id player, obj_id npc)
    {
        ai_lib.aiFollow(npc, player);
        setMovementRun(npc);
    }
    public void som_battlefield_miner_leader_action_stopFollowing(obj_id player, obj_id npc)
    {
        ai_lib.aiStopFollowing(npc);
        location here = getLocation(npc);
        aiSetHomeLocation(npc, here);
    ...
    public void som_battlefield_miner_leader_action_undeployAndFollow(obj_id player, obj_id npc)
    {
        messageTo(npc, "unDeployForces", null, 0, false);
        ai_lib.aiFollow(npc, player);
    }
    public int som_battlefield_miner_leader_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
