...
public class faction_recruiter_imperial extends script.base_script
{
    ...
    public static final String c_stringFile = "conversation/faction_recruiter_imperial";
    public boolean faction_recruiter_imperial_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean faction_recruiter_imperial_condition_isInFaction(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean faction_recruiter_imperial_condition_isEnemyFaction(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (factions.isInEnemyFaction(player, npc) && (!factions.isPVPStatusChanging(player)));
    }
    public boolean faction_recruiter_imperial_condition_isBlockedByJoinTimer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean faction_recruiter_imperial_condition_playerQualifiesForPromotion(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (factions.qualifiesForPromotion(player, pvpGetAlignedFaction(npc)) && (!factions.isPVPStatusChanging(player)));
    }
    public boolean faction_recruiter_imperial_condition_isChangingFaction(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return factions.isPVPStatusChanging(player);
    }
    public boolean faction_recruiter_imperial_condition_onLeaveFromFriendlyFaction(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (factions.isOnLeaveFromFriendlyFaction(player, npc) && (!factions.isPVPStatusChanging(player)));
    }
    public boolean faction_recruiter_imperial_condition_onLeaveFromEnemyFaction(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (factions.isOnLeaveFromEnemyFaction(player, npc) && (!factions.isPVPStatusChanging(player)));
    }
    public boolean faction_recruiter_imperial_condition_isCovert(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (pvpGetType(player) == PVPTYPE_COVERT) && (!factions.isPVPStatusChanging(player));
    }
    public boolean faction_recruiter_imperial_condition_isOvert(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return ((pvpGetType(player) == PVPTYPE_DECLARED) && (!factions.isPVPStatusChanging(player)));
    }
    public boolean faction_recruiter_imperial_condition_playerCanBuyFaction(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (factions.isSmuggler(player) && (factions.canBuyFaction(player, npc)) && (!factions.isPVPStatusChanging(player)));
    }
    public boolean faction_recruiter_imperial_condition_isAllowedToJoinFaction(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return factions.canJoinFaction(player, pvpGetAlignedFaction(npc));
    }
    public boolean faction_recruiter_imperial_condition_isImperialMercForGcw(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return factions.isImperialHelper(player);
    }
    public boolean faction_recruiter_imperial_condition_canChangeStatus(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return factions.canGoOnLeave(player);
    }
    public boolean faction_recruiter_imperial_condition_canBeMerc(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean faction_recruiter_imperial_condition_isRebMercForGcw(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return factions.isRebelHelper(player);
    }
    public boolean faction_recruiter_imperial_condition_isRebOrImpMerc(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean faction_recruiter_imperial_condition_isInvulnerableRecuiter(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return isInvulnerable(npc) && hasScript(npc, "npc.vendor.vendor");
    }
    public boolean faction_recruiter_imperial_condition_isInvulnerableNoScript(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return isInvulnerable(npc) && !hasScript(npc, "npc.vendor.vendor");
    }
    public void faction_recruiter_imperial_action_showFactionGcwRewardUi(obj_id player, obj_id npc)
    {
        dictionary d = new dictionary();
        d.put("player", player);
        messageTo(npc, "showInventorySUI", d, 0, false);
    }
    public void faction_recruiter_imperial_action_enablePVPTimer(obj_id player, obj_id npc)
    {
        factions.goOvertWithDelay(player, 30);
    }
    public void faction_recruiter_imperial_action_playerJoinFaction(obj_id player, obj_id npc)
    {
        factions.joinFaction(player, pvpGetAlignedFaction(npc));
    }
    public void faction_recruiter_imperial_action_playerGoOnLeaveTimer(obj_id player, obj_id npc)
    {
        factions.goOnLeaveWithDelay(player, 60);
    }
    public void faction_recruiter_imperial_action_makeImpMercCombatant(obj_id player, obj_id npc)
    {
        factions.setNeturalMercenaryCovert(player, factions.FACTION_FLAG_IMPERIAL);
    }
    public void faction_recruiter_imperial_action_maekImpMercSF(obj_id player, obj_id npc)
    {
        factions.setNeturalMercenaryOvert(player, factions.FACTION_FLAG_IMPERIAL);
    }
    public void faction_recruiter_imperial_action_playerGoCovertTimer(obj_id player, obj_id npc)
    {
        factions.goCovertWithDelay(player, 300);
    }
    public void faction_recruiter_imperial_action_grantPromotion(obj_id player, obj_id npc)
    {
        factions.applyPromotion(player, pvpGetAlignedFaction(npc));
    }
    public void faction_recruiter_imperial_action_buy1250FactionPoints(obj_id player, obj_id npc)
    {
        factions.buyFaction(player, npc, 100000);
    }
    public void faction_recruiter_imperial_action_buy250FactionPoints(obj_id player, obj_id npc)
    {
        factions.buyFaction(player, npc, 20000);
    }
    public void faction_recruiter_imperial_action_completelyResign(obj_id player, obj_id npc)
    {
        factions.leaveFaction(player, pvpGetAlignedFaction(npc));
    }
    public void faction_recruiter_imperial_action_goCovertShortTimer(obj_id player, obj_id npc)
    {
        factions.goCovertWithDelay(player, 30);
    }
    public void faction_recruiter_imperial_action_showGcwRewardsList(obj_id player, obj_id npc)
    {
    ...
    public String faction_recruiter_imperial_tokenTO_getFactionRankName(obj_id player, obj_id npc)
    {
    ...
    public String faction_recruiter_imperial_tokenTO_getFactionNextRankName(obj_id player, obj_id npc)
    {
        int current_rank = pvpGetCurrentGcwRank(player);
        String faction = factions.getFaction(player);
        if (current_rank > factions.MAXIMUM_RANK)
    ...
    public String faction_recruiter_imperial_tokenTO_getRebelScoreString(obj_id player, obj_id npc)
    {
        int intTest = getIntObjVar(npc, "Rebel.controlScore");
        return "" + intTest;
    }
    public int faction_recruiter_imperial_tokenDI_getImperialScore(obj_id player, obj_id npc)
    {
        return getIntObjVar(npc, "Imperial.controlScore");
    }
    public int faction_recruiter_imperial_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int faction_recruiter_imperial_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int faction_recruiter_imperial_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int faction_recruiter_imperial_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int faction_recruiter_imperial_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int faction_recruiter_imperial_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_71"))
        {
            if (faction_recruiter_imperial_condition_isInvulnerableRecuiter(player, npc))
    ...
    public int faction_recruiter_imperial_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int faction_recruiter_imperial_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_71"))
        {
            if (faction_recruiter_imperial_condition_isInvulnerableRecuiter(player, npc))
    ...
    public int faction_recruiter_imperial_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int faction_recruiter_imperial_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_71"))
        {
            if (faction_recruiter_imperial_condition_isInvulnerableRecuiter(player, npc))
    ...
    public int faction_recruiter_imperial_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int faction_recruiter_imperial_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_71"))
        {
            if (faction_recruiter_imperial_condition_isInvulnerableRecuiter(player, npc))
    ...
    public int faction_recruiter_imperial_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_71"))
        {
            if (faction_recruiter_imperial_condition_isInvulnerableRecuiter(player, npc))
    ...
    public int faction_recruiter_imperial_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int faction_recruiter_imperial_handleBranch30(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int faction_recruiter_imperial_handleBranch31(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int faction_recruiter_imperial_handleBranch37(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int faction_recruiter_imperial_handleBranch38(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int faction_recruiter_imperial_handleBranch39(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int faction_recruiter_imperial_handleBranch40(obj_id player, obj_id npc, string_id response)
    {
