...
public class talus_dearic_droid extends script.base_script
{
    ...
    public boolean talus_dearic_droid_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean talus_dearic_droid_condition_onDroidPassword(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "talus_dearic_better_genetics", "better_genetics_retrieve_01_03i");
    }
    public boolean talus_dearic_droid_condition_passwordCompleted(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "talus_dearic_better_genetics", "better_genetics_retrieve_01_03i");
    }
    public void talus_dearic_droid_action_signalDroidPassword(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "better_genetics_retrieve_01_03i");
    }
    public int talus_dearic_droid_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_droid_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_droid_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_droid_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_droid_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_droid_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
