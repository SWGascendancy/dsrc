...
public class aurilia_junk_dealer extends script.conversation.base.conversation_base
{
    ...
    private boolean aurilia_junk_dealer_condition_check_inv(obj_id player, obj_id npc)
    {
        return smuggler.checkInventory(player, npc);
    }
    private void aurilia_junk_dealer_action_start_dealing(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        messageTo(npc, "startDealing", params, 1.0f, false);
    }
    private int aurilia_junk_dealer_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
