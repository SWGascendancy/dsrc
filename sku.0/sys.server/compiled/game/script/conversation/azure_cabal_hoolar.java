...
public class azure_cabal_hoolar extends script.conversation.base.conversation_base
{
    ...
    public void azure_cabal_hoolar_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    ...
    public String azure_cabal_hoolar_tokenTO_playerFirstName(obj_id player)
    {
        return getFirstName(player);
    }
    public String azure_cabal_hoolar_tokenTO_playersProfession()
    {
        return "";
    }
    private int azure_cabal_hoolar_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch9(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch11(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch12(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch13(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch14(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch15(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch16(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch17(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch18(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch19(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch20(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch21(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch22(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch23(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch24(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch25(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch26(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch27(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch28(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch29(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch31(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch32(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch34(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch35(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch36(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch37(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch38(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch39(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch40(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch44(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch45(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch46(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch47(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch48(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch49(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch50(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch51(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch52(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch53(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch54(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch55(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch56(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch57(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch58(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch59(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch60(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch61(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch62(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch63(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch64(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch65(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_hoolar_handleBranch66(obj_id player, string_id response)
    {
