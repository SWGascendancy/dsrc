...
public class c_story1_2_mole extends script.base_script
{
    ...
    public boolean c_story1_2_mole_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_story1_2_mole_condition_atKailaStep(obj_id player, obj_id npc)
    {
    ...
    public void c_story1_2_mole_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void c_story1_2_mole_action_forwardQuest(obj_id player, obj_id npc)
    {
    ...
    public int c_story1_2_mole_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
