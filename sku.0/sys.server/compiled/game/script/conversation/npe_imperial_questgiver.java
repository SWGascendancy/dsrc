...
public class npe_imperial_questgiver extends script.base_script
{
    ...
    public boolean npe_imperial_questgiver_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_imperial_questgiver_condition_ImpQuestActive(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "npe_imperial_1");
    }
    public boolean npe_imperial_questgiver_condition_ImpQuestComplete(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_imperial_1");
    }
    public boolean npe_imperial_questgiver_condition_RebQuestActiveorComplete(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "npe_rebel_1");
    }
    public boolean npe_imperial_questgiver_condition_onCorrectStep(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "npe_imperial_1", "getdata");
    }
    public boolean npe_imperial_questgiver_condition_hasTemplate(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "npe.finishedTemplate");
    }
    public void npe_imperial_questgiver_action_giveImperialQuest(obj_id player, obj_id npc)
    {
    ...
    public void npe_imperial_questgiver_action_faceplayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void npe_imperial_questgiver_action_completeImperialQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_imperial_1_complete");
    }
    public void npe_imperial_questgiver_action_groupPopUp(obj_id player, obj_id npc)
    {
        messageTo(player, "groupPopUp1", null, 0, false);
        messageTo(player, "groupPopUp2", null, 5, false);
    }
    public int npe_imperial_questgiver_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_imperial_questgiver_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_imperial_questgiver_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_imperial_questgiver_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_imperial_questgiver_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
