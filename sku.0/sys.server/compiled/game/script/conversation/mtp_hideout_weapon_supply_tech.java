...
public class mtp_hideout_weapon_supply_tech extends script.base_script
{
    ...
    public boolean mtp_hideout_weapon_supply_tech_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean mtp_hideout_weapon_supply_tech_condition_questNotActiveComplete(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_hideout_weapon_supply_tech_condition_hasCompletedOrActiveNabooCamp(obj_id player, obj_id npc)
    {
        return (groundquests.isQuestActiveOrComplete(player, "quest/mtp_camp_quest_naboo"));
    }
    public boolean mtp_hideout_weapon_supply_tech_condition_hasCompletedOrActiveRetrievalQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "quest/mtp_hideout_retrieve_delivery");
    }
    public boolean mtp_hideout_weapon_supply_tech_condition_retrieveQuestActive(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "quest/mtp_hideout_retrieve_delivery");
    }
    public boolean mtp_hideout_weapon_supply_tech_condition_retrieveTaskComplete(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "quest/mtp_hideout_retrieve_delivery", "speakSmuggler");
    }
    public boolean mtp_hideout_weapon_supply_tech_condition_waitingForArmorerSignal(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "quest/mtp_hideout_retrieve_delivery", "seeArmorer");
    }
    public boolean mtp_hideout_weapon_supply_tech_condition_playerDelieveredPackageAndReturned(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_hideout_weapon_supply_tech_condition_playerWaitingForNabooCoords(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_hideout_weapon_supply_tech_condition_hasCompletedRetrievalQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "quest/mtp_hideout_retrieve_delivery");
    }
    public boolean mtp_hideout_weapon_supply_tech_condition_hasCompletedNabooCamp(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedQuest(player, "quest/mtp_camp_quest_naboo"));
    }
    public boolean mtp_hideout_weapon_supply_tech_condition_hasComlinkNotActiveCompleteQuest(obj_id player, obj_id npc)
    {
    ...
    public void mtp_hideout_weapon_supply_tech_action_giveQuestComlink(obj_id player, obj_id npc)
    {
    ...
    public void mtp_hideout_weapon_supply_tech_action_sendCompletionSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "spokenToArmorer");
    }
    public void mtp_hideout_weapon_supply_tech_action_giveNabooCoordsQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest/mtp_camp_quest_naboo");
    }
    public void mtp_hideout_weapon_supply_tech_action_deleteComlink(obj_id player, obj_id npc)
    {
    ...
    public int mtp_hideout_weapon_supply_tech_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_weapon_supply_tech_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_weapon_supply_tech_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_weapon_supply_tech_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_weapon_supply_tech_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_weapon_supply_tech_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_weapon_supply_tech_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_weapon_supply_tech_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
