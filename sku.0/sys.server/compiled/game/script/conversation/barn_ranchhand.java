...
public class barn_ranchhand extends script.conversation.base.conversation_base
{
    ...
    private int barn_ranchhand_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    private int barn_ranchhand_handleBranch8(obj_id player, string_id response)
    {
