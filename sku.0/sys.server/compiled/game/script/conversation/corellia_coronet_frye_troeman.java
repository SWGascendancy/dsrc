...
public class corellia_coronet_frye_troeman extends script.base_script
{
    ...
    public boolean corellia_coronet_frye_troeman_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_coronet_frye_troeman_condition_goGoGadgetCollect1(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_coronet_capitol_problems_go_go_gadget", "go_go_gadget_2");
    }
    public boolean corellia_coronet_frye_troeman_condition_goGoGadgetCollect2(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_coronet_capitol_problems_go_go_gadget", "go_go_gadget_4");
    }
    public void corellia_coronet_frye_troeman_action_refusePayment(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "go_go_gadget_2");
    }
    public void corellia_coronet_frye_troeman_action_givePayment(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "go_go_gadget_4");
    }
    public int corellia_coronet_frye_troeman_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_frye_troeman_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_frye_troeman_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
