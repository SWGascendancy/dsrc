...
public class naboo_theed_sgt_bragg extends script.base_script
{
    ...
    public boolean naboo_theed_sgt_bragg_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean naboo_theed_sgt_bragg_condition_startResponsibleQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_theed_sgt_bragg_condition_onResponsibleQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "naboo_theed_terrorist_responsible");
    }
    public boolean naboo_theed_sgt_bragg_condition_completedResponsibleQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "naboo_theed_terrorist_responsible");
    }
    public boolean naboo_theed_sgt_bragg_condition_lastStepResponsibleQuest(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "naboo_theed_terrorist_responsible", "theed_terrorist_responsible_12");
    }
    public boolean naboo_theed_sgt_bragg_condition_needsBoosterQuest(obj_id player, obj_id npc)
    {
    ...
    public void naboo_theed_sgt_bragg_action_grantResponsible(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "naboo_theed_terrorist_responsible");
    }
    public void naboo_theed_sgt_bragg_action_sendToLtDunnels(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "naboo_theed_goto_dunnels");
    }
    public void naboo_theed_sgt_bragg_action_signal_gotobragg(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "theed_goto_bragg");
    }
    public void naboo_theed_sgt_bragg_action_endResponsibleQuest(obj_id player, obj_id npc)
    {
    ...
    public int naboo_theed_sgt_bragg_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_sgt_bragg_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_sgt_bragg_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_sgt_bragg_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_sgt_bragg_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_sgt_bragg_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_sgt_bragg_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
