...
public class ep3_etyyy_tuwezz_vol extends script.base_script
{
    ...
    public boolean ep3_etyyy_tuwezz_vol_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_etyyy_tuwezz_vol_condition_hasCompletedTuwezzQuests(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedQuest(player, "ep3_hunt_tuwezz_collect_uller_horns"));
    }
    public boolean ep3_etyyy_tuwezz_vol_condition_killedSpiketop(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_hunt_loot_spiketop_killed");
    }
    public boolean ep3_etyyy_tuwezz_vol_condition_finishedHuntingDiseasedUller(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_etyyy_tuwezz_vol_condition_isHuntingDiseasedUller(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "ep3_hunt_tuwezz_kill_diseased_ullers", "tuwezz_huntingDiseasedUllers"));
    }
    public boolean ep3_etyyy_tuwezz_vol_condition_isCollectingUllerHorns(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "ep3_hunt_tuwezz_collect_uller_horns", "tuwezz_collectUllerHorns"));
    }
    public boolean ep3_etyyy_tuwezz_vol_condition_hasToSpeakToTuwezz(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "ep3_hunt_tuwezz_kill_diseased_ullers", "tuwezz_talkToTuwezz"));
    }
    public boolean ep3_etyyy_tuwezz_vol_condition_finishedCollectingUllerHorns(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "ep3_hunt_tuwezz_collect_uller_horns", "tuwezz_elderUllerHorns"));
    }
    public boolean ep3_etyyy_tuwezz_vol_condition_killedSpiketopPlusAll(obj_id player, obj_id npc)
    {
    ...
    public void ep3_etyyy_tuwezz_vol_action_spiketopReward(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "lootQuest_defeatedSpiketop");
    }
    public void ep3_etyyy_tuwezz_vol_action_doneHuntingDiseasedUller(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tuwezz_diseasedUllersDone");
    }
    public void ep3_etyyy_tuwezz_vol_action_huntDiseasedUller(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tuwezz_talkToTuwezz");
    }
    public void ep3_etyyy_tuwezz_vol_action_collectUllerHorns(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_hunt_tuwezz_collect_uller_horns");
    }
    public void ep3_etyyy_tuwezz_vol_action_speakWithSordaan(obj_id player, obj_id npc)
    {
    ...
    public void ep3_etyyy_tuwezz_vol_action_spiketopRewardPlusAll(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "lootQuest_defeatedSpiketop");
        groundquests.grantQuest(player, "ep3_hunt_loot_completed_all");
    }
    public int ep3_etyyy_tuwezz_vol_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_tuwezz_vol_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_tuwezz_vol_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_tuwezz_vol_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_tuwezz_vol_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_tuwezz_vol_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_tuwezz_vol_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_tuwezz_vol_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_tuwezz_vol_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
