...
public class ree_yees extends script.base_script
{
    ...
    public boolean ree_yees_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ree_yees_condition_completedReeYees(obj_id player, obj_id npc)
    {
    ...
    public boolean ree_yees_condition_collectingBell(obj_id player, obj_id npc)
    {
    ...
    public boolean ree_yees_condition_readyToFinish(obj_id player, obj_id npc)
    {
    ...
    public boolean ree_yees_condition_collectingBook(obj_id player, obj_id npc)
    {
    ...
    public boolean ree_yees_condition_collectingCandle(obj_id player, obj_id npc)
    {
    ...
    public boolean ree_yees_condition_completedReelo(obj_id player, obj_id npc)
    {
    ...
    public void ree_yees_action_grantReeYeesQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest/jabba_ree_yees_v2");
        return;
    }
    public void ree_yees_action_sendCompletedSignal(obj_id player, obj_id npc)
    {
    ...
    public void ree_yees_action_clearPointer(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "found_ree_yees");
        faceTo(npc, player);
    }
    public void ree_yees_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int ree_yees_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ree_yees_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ree_yees_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ree_yees_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
