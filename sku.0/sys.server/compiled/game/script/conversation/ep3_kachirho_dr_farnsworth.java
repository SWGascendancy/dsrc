...
public class ep3_kachirho_dr_farnsworth extends script.base_script
{
    ...
    public boolean ep3_kachirho_dr_farnsworth_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_kachirho_dr_farnsworth_condition_isOnMission(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_kachirho_survey_data");
    }
    public boolean ep3_kachirho_dr_farnsworth_condition_taskCompleted(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_kachirho_survey_data", "dataCollected");
    }
    public boolean ep3_kachirho_dr_farnsworth_condition_missionCompleted(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_kachirho_survey_data");
    }
    public void ep3_kachirho_dr_farnsworth_action_grantMission(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_kachirho_survey_data");
    }
    public void ep3_kachirho_dr_farnsworth_action_doSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "dataReward");
    }
    public int ep3_kachirho_dr_farnsworth_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_dr_farnsworth_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_dr_farnsworth_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_dr_farnsworth_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_dr_farnsworth_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_dr_farnsworth_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
