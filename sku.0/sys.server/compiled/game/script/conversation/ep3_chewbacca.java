...
public class ep3_chewbacca extends script.base_script
{
    ...
    public boolean ep3_chewbacca_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_chewbacca_condition_doesnt_know_Shiryyywook(obj_id player, obj_id npc)
    {
        return utils.canSpeakWookiee(player, npc);
    }
    public void ep3_chewbacca_action_grantSkill_Shiryyywook(obj_id player, obj_id npc)
    {
        playMusic(player, "sound/music_acq_academic.snd");
        grantSkill(player, "social_language_wookiee_comprehend");
    }
    public int ep3_chewbacca_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_chewbacca_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_chewbacca_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_chewbacca_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_chewbacca_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_chewbacca_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_404"))
        {
            if (ep3_chewbacca_condition__defaultCondition(player, npc))
