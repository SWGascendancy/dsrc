...
public class gt643_stormtrooper extends script.base_script
{
    ...
    public boolean gt643_stormtrooper_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean gt643_stormtrooper_condition_gotShuttleParts(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "outbreak_quest_shuttle_parts");
    }
    public boolean gt643_stormtrooper_condition_rescuedAllSurvivors(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "outbreak_quest_rescue_04");
    }
    public boolean gt643_stormtrooper_condition_isNew(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean gt643_stormtrooper_condition_isShuttleParts(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "outbreak_quest_shuttle_parts");
    }
    public boolean gt643_stormtrooper_condition_isRescuing(obj_id player, obj_id npc)
    {
    ...
    public boolean gt643_stormtrooper_condition_hasRadio(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "outbreak_radio_delivery_03", "findEpsilonContact");
    }
    public int gt643_stormtrooper_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int gt643_stormtrooper_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int gt643_stormtrooper_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int gt643_stormtrooper_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int gt643_stormtrooper_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int gt643_stormtrooper_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int gt643_stormtrooper_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int gt643_stormtrooper_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
