...
public class c_story1_5 extends script.base_script
{
    ...
    public boolean c_story1_5_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_story1_5_condition_finishedQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean c_story1_5_condition_isOnQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean c_story1_5_condition_isQualified(obj_id player, obj_id npc)
    {
    ...
    public boolean c_story1_5_condition_isThisDisabled(obj_id player, obj_id npc)
    {
        return groundquests.isQuestDisabled("c_syren5");
    }
    public void c_story1_5_action_grantSyren5Quest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest/c_syren5");
        return;
    }
    public int c_story1_5_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_5_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_5_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_5_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_5_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_5_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_5_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_5_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_5_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_5_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_5_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_5_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_5_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_5_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_5_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
