...
public class c_smuggler_lorusku extends script.base_script
{
    ...
    public boolean c_smuggler_lorusku_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_smuggler_lorusku_condition_isTaskActiveSteal2(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "c_smuggler_steal_2", "bigwig"));
    }
    public void c_smuggler_lorusku_action_giveQuestSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "bigwig");
    }
    public int c_smuggler_lorusku_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_smuggler_lorusku_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_smuggler_lorusku_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
