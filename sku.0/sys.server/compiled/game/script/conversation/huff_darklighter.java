...
public class huff_darklighter extends script.base_script
{
    ...
    public boolean huff_darklighter_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean huff_darklighter_condition_startWithHuff(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "huffs_guard_rifle");
    }
    public boolean huff_darklighter_condition_workingOnHuffDera(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "huff_darklighter_dera");
    }
    public boolean huff_darklighter_condition_returningFromDera(obj_id player, obj_id npc)
    {
    ...
    public boolean huff_darklighter_condition_workingOnHuffSennex(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "huff_darklighter_sennex");
    }
    public boolean huff_darklighter_condition_returningFromSennex(obj_id player, obj_id npc)
    {
    ...
    public void huff_darklighter_action_quest_HuffDera(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "huff_darklighter_dera");
    }
    public void huff_darklighter_action_signal_endHuffDera(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "finishedDera");
    }
    public void huff_darklighter_action_grant_HuffSennex(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "huff_darklighter_sennex");
    }
    public void huff_darklighter_action_signal_endHuffSennex(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "finishedSennex");
    }
    public int huff_darklighter_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int huff_darklighter_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
