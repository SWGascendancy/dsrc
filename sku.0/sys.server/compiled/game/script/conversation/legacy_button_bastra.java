...
public class legacy_button_bastra extends script.base_script
{
    ...
    public boolean legacy_button_bastra_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean legacy_button_bastra_condition_onButtonImp(obj_id player, obj_id npc)
    {
        boolean OnTask = hasObjVar(player, "legacy.faction.imperialPath");
        return OnTask;
    }
    public boolean legacy_button_bastra_condition_onButtonReb(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "legacy.faction.rebelPath");
    }
    public boolean legacy_button_bastra_condition_failedTosche(obj_id player, obj_id npc)
    {
    ...
    public boolean legacy_button_bastra_condition_failedValarian(obj_id player, obj_id npc)
    {
    ...
    public boolean legacy_button_bastra_condition_onButtonCompleteReb(obj_id player, obj_id npc)
    {
        int questId2 = questGetQuestId("quest/legacy_button_reb_pt2");
        boolean OnTask = questIsQuestComplete(questId2, player);
        return OnTask;
    }
    public boolean legacy_button_bastra_condition_failedDarklighter(obj_id player, obj_id npc)
    {
    ...
    public boolean legacy_button_bastra_condition_failedSlicer(obj_id player, obj_id npc)
    {
    ...
    public boolean legacy_button_bastra_condition_finishTogether(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedQuest(player, "legacy_together") || groundquests.hasCompletedQuest(player, "legacy_together_2"));
    }
    public boolean legacy_button_bastra_condition_FailedKickReb(obj_id player, obj_id npc)
    {
    ...
    public boolean legacy_button_bastra_condition_failedWatto(obj_id player, obj_id npc)
    {
    ...
    public boolean legacy_button_bastra_condition_onButtonStart(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "quest/legacy_button_start");
    }
    public void legacy_button_bastra_action_signalRebelButton(obj_id player, obj_id npc)
    {
        setObjVar(player, "legacy.faction.rebelPath", 1);
        groundquests.grantQuest(player, "legacy_button_jawatracks_reb");
    }
    public void legacy_button_bastra_action_grantValarian(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "legacy_button_reb_valarian_v2");
    }
    public void legacy_button_bastra_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void legacy_button_bastra_action_grantDarklighter(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "legacy_button_reb_darklighter");
    }
    public void legacy_button_bastra_action_grantTosche(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "legacy_button_jawatracks_reb");
    }
    public void legacy_button_bastra_action_grantSlicer(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "legacy_button_reb_pt2");
    }
    public void legacy_button_bastra_action_reGrantKickReb(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "legacy_naboo_kick_reb");
    }
    public void legacy_button_bastra_action_grantWatto(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "legacy_watto_pointer");
    }
    public void legacy_button_bastra_action_signalGoToComplete(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "legacy_button_start_launch_e3");
    }
    public int legacy_button_bastra_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_button_bastra_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_button_bastra_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_button_bastra_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_button_bastra_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_button_bastra_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_button_bastra_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_button_bastra_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_button_bastra_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
