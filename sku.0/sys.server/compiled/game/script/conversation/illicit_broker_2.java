...
public class illicit_broker_2 extends script.base_script
{
    ...
    public boolean illicit_broker_2_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean illicit_broker_2_condition_isNonSmuggler(obj_id player, obj_id npc)
    {
    ...
    public boolean illicit_broker_2_condition_isDoingMission(obj_id player, obj_id npc)
    {
    ...
    public boolean illicit_broker_2_condition_smugglerAboveMissionTier(obj_id player, obj_id npc)
    {
    ...
    public boolean illicit_broker_2_condition_hasMissionContrabandBusiness(obj_id player, obj_id npc)
    {
        int brokerTier = 2;
    ...
    public boolean illicit_broker_2_condition_hasSomeContraband(obj_id player, obj_id npc)
    {
    ...
    public boolean illicit_broker_2_condition_hasMissionContraband(obj_id player, obj_id npc)
    {
    ...
    public boolean illicit_broker_2_condition_hasMissionContrabandToDeliver(obj_id player, obj_id npc)
    {
        float underworldFaction = factions.getFactionStanding(player, "underworld");
        int brokerTier = 2;
        if (smuggler.getSmuggleTier(underworldFaction) == brokerTier)
    ...
    public void illicit_broker_2_action_startGiveQuest(obj_id player, obj_id npc)
    {
    ...
    public void illicit_broker_2_action_giveIllicitPointerQuest(obj_id player, obj_id npc)
    {
    ...
    public void illicit_broker_2_action_sellContraband(obj_id player, obj_id npc)
    {
        String illicit_broker_2_tokenTO_contrabandName = utils.getStringScriptVar(player, "illicitContrabandTrade");
        obj_id pInv = utils.getInventoryContainer(player);
    ...
    public String illicit_broker_2_tokenTO_contrabandName(obj_id player, obj_id npc)
    {
        int brokerTier = 2;
    ...
    public int illicit_broker_2_tokenDI_cashValue(obj_id player, obj_id npc)
    {
        return (smuggler.TIER_2_ILLICIT_SELL_VALUE);
    }
    public float illicit_broker_2_tokenDF_tokenDF0001(obj_id player, obj_id npc)
    {
        return 0.f;
    }
    public int illicit_broker_2_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int illicit_broker_2_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int illicit_broker_2_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int illicit_broker_2_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_52"))
        {
            if (illicit_broker_2_condition__defaultCondition(player, npc))
    ...
    public int illicit_broker_2_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_52"))
        {
            if (illicit_broker_2_condition__defaultCondition(player, npc))
    ...
    public int illicit_broker_2_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
