...
public class corellia_tyrena_vermon_skeetz extends script.base_script
{
    ...
    public boolean corellia_tyrena_vermon_skeetz_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_tyrena_vermon_skeetz_condition_onPetty(obj_id player, obj_id npc)
    {
        return false;
    }
    public boolean corellia_tyrena_vermon_skeetz_condition_completeMissing(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "corellia_tyrena_missing_persons");
    }
    public boolean corellia_tyrena_vermon_skeetz_condition_completePetty(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "corellia_tyrena_petty_resolve");
    }
    public boolean corellia_tyrena_vermon_skeetz_condition_onPettyReturn(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_tyrena_petty_resolve", "petty_return_vermon");
    }
    public void corellia_tyrena_vermon_skeetz_action_grantPetty(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "corellia_tyrena_petty_resolve");
    }
    public void corellia_tyrena_vermon_skeetz_action_signalPetty(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "petty_return_vermon");
    }
    public int corellia_tyrena_vermon_skeetz_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_vermon_skeetz_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_vermon_skeetz_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_vermon_skeetz_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_vermon_skeetz_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_vermon_skeetz_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_vermon_skeetz_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_vermon_skeetz_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_vermon_skeetz_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_vermon_skeetz_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_vermon_skeetz_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_vermon_skeetz_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_vermon_skeetz_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_vermon_skeetz_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_vermon_skeetz_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
