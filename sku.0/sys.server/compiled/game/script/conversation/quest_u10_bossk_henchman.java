...
public class quest_u10_bossk_henchman extends script.base_script
{
    ...
    public boolean quest_u10_bossk_henchman_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean quest_u10_bossk_henchman_condition_quest_u10_03_02_active(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "quest_u10_03", "quest_u10_03_02");
    }
    public boolean quest_u10_bossk_henchman_condition_quest_u10_03_04_active(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "quest_u10_03", "quest_u10_03_04");
    }
    public boolean quest_u10_bossk_henchman_condition_quest_u10_03_complete(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "quest_u10_03");
    }
    public boolean quest_u10_bossk_henchman_condition_quest_u10_03_01_active(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "quest_u10_03", "quest_u10_03_01");
    }
    public boolean quest_u10_bossk_henchman_condition_quest_u10_03_05_active(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "quest_u10_03", "quest_u10_03_05");
    }
    public boolean quest_u10_bossk_henchman_condition_quest_u10_complete_deleted_u16(obj_id player, obj_id npc)
    {
    ...
    public void quest_u10_bossk_henchman_action_quest_u10_03_01_signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "quest_u10_03_01");
    }
    public void quest_u10_bossk_henchman_action_attack(obj_id player, obj_id npc)
    {
    ...
    public void quest_u10_bossk_henchman_action_grant_u16_quest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "u16_nym_themepark_pointer_02");
    }
    public void quest_u10_bossk_henchman_action_quest_u10_03_05_signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "quest_u10_03_05");
    }
    public int quest_u10_bossk_henchman_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
