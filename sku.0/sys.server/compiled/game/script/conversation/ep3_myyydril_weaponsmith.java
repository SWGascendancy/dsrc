...
public class ep3_myyydril_weaponsmith extends script.base_script
{
    ...
    public boolean ep3_myyydril_weaponsmith_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_myyydril_weaponsmith_condition_hasSkillWeapon(obj_id player, obj_id npc)
    {
        return hasSkill(player, "class_munitions_phase1_novice");
    }
    public boolean ep3_myyydril_weaponsmith_condition_isTaskOneActive(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_myyydril_weaponsmith_condition_isTaskCompleted(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_myyydril_weaponsmith_condition_hasCompletedQuestOne(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_myyydril_treesh_craft_1");
    }
    public boolean ep3_myyydril_weaponsmith_condition_isTaskActiveTwo(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_myyydril_weaponsmith_condition_hasCompletedQuestTwo(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_myyydril_treesh_gather_2");
    }
    public boolean ep3_myyydril_weaponsmith_condition_questCompleteNoSchem(obj_id player, obj_id npc)
    {
    ...
    public void ep3_myyydril_weaponsmith_action_giveQuestOne(obj_id player, obj_id npc)
    {
    ...
    public void ep3_myyydril_weaponsmith_action_grantSchemetic(obj_id player, obj_id npc)
    {
    ...
    public void ep3_myyydril_weaponsmith_action_giveSignal1(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "giveSwords");
    }
    public void ep3_myyydril_weaponsmith_action_giveQuestTwo(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_myyydril_treesh_gather_2");
    }
    public int ep3_myyydril_weaponsmith_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_weaponsmith_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_weaponsmith_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_weaponsmith_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_weaponsmith_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_weaponsmith_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_weaponsmith_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_weaponsmith_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_weaponsmith_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_weaponsmith_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_weaponsmith_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_weaponsmith_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
