...
public class ep3_forest_athnalu extends script.base_script
{
    ...
    public boolean ep3_forest_athnalu_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_forest_athnalu_condition_isGoodGuy(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_forest_athnalu_condition_isBadGuy(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_forest_athnalu_condition_isTaskOneActive(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_forest_athnalu_quest_1", "dolls");
    }
    public boolean ep3_forest_athnalu_condition_hasCompletedTaskOne(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_forest_athnalu_quest_1", "return");
    }
    public boolean ep3_forest_athnalu_condition_hasCompletedQuestOne(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_forest_athnalu_quest_1");
    }
    public boolean ep3_forest_athnalu_condition_isTaskActiveTwo(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_forest_athnalu_quest_2", "collecting");
    }
    public boolean ep3_forest_athnalu_condition_hasCompletedTaskTwo(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_forest_athnalu_quest_2", "return");
    }
    public boolean ep3_forest_athnalu_condition_hasCompletedQuestTwo(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_forest_athnalu_quest_2");
    }
    public boolean ep3_forest_athnalu_condition_hasLanguage(obj_id player, obj_id npc)
    {
        return utils.canSpeakWookiee(player, npc);
    }
    public void ep3_forest_athnalu_action_giveSignalOne(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "dolls");
    }
    public void ep3_forest_athnalu_action_grantQuestOne(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_forest_athnalu_quest_1");
    }
    public void ep3_forest_athnalu_action_grantQuestTwo(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_forest_athnalu_quest_2");
    }
    public void ep3_forest_athnalu_action_giveSignalTwo(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "snakes");
    }
    public void ep3_forest_athnalu_action_Language(obj_id player, obj_id npc)
    {
        utils.emoteWookieeConfusion(player, npc);
    }
    public int ep3_forest_athnalu_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_athnalu_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_athnalu_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_athnalu_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_athnalu_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_athnalu_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_athnalu_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_athnalu_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_athnalu_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_athnalu_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
