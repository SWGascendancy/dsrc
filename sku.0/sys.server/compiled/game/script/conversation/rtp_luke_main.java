...
public class rtp_luke_main extends script.base_script
{
    ...
    public boolean rtp_luke_main_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean rtp_luke_main_condition_rtp_luke_01_active(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "rtp_luke_01");
    }
    public boolean rtp_luke_main_condition_rtp_luke_01_complete(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "rtp_luke_01", "rtp_luke_01_02") || groundquests.hasCompletedQuest(player, "rtp_luke_01");
    }
    public boolean rtp_luke_main_condition_rtp_luke_02_active(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "rtp_luke_02");
    }
    public boolean rtp_luke_main_condition_rtp_luke_03_complete(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "rtp_luke_03", "rtp_luke_03_02") || groundquests.hasCompletedQuest(player, "rtp_luke_03");
    }
    public boolean rtp_luke_main_condition_rtp_luke_03_active(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "rtp_luke_03");
    }
    public boolean rtp_luke_main_condition_rtp_luke_02_complete(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "rtp_luke_02", "rtp_luke_02_02") || groundquests.hasCompletedQuest(player, "rtp_luke_02");
    }
    public boolean rtp_luke_main_condition_completedDodonna(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "rtp_dodonna_03");
    }
    public boolean rtp_luke_main_condition_notRebel(obj_id player, obj_id npc)
    {
    ...
    public void rtp_luke_main_action_rtp_luke_01_granted(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "rtp_luke_01");
    }
    public void rtp_luke_main_action_rtp_luke_01_signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "rtp_luke_01_02");
    }
    public void rtp_luke_main_action_rtp_luke_03_signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "rtp_luke_03_02");
    }
    public void rtp_luke_main_action_rtp_luke_02_signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "rtp_luke_02_02");
    }
    public void rtp_luke_main_action_rtp_luke_02_granted(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "rtp_luke_02");
    }
    public void rtp_luke_main_action_rtp_luke_03_granted(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "rtp_luke_03");
    }
    public int rtp_luke_main_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rtp_luke_main_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rtp_luke_main_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
