...
public class ep3_achonnko extends script.base_script
{
    ...
    public boolean ep3_achonnko_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_achonnko_condition_firstTimeUser(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_achonnko_condition_hasLevelOne(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_achonnko_condition_hasLevelTwo(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_achonnko_condition_hasLevelThree(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_achonnko_condition_hasLevelFour(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_achonnko_condition_wookieeNoob(obj_id player, obj_id npc)
    {
        return utils.canSpeakWookiee(player, npc);
    }
    public boolean ep3_achonnko_condition_canTakeCamoKitQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_achonnko_condition_canCompleteCamoKitQuest(obj_id player, obj_id npc)
    {
    ...
    public void ep3_achonnko_action_grantMasteryQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest/ep3_rryatt_trail_mastery");
    }
    public void ep3_achonnko_action_warpLevelTwo(obj_id player, obj_id npc)
    {
    ...
    public void ep3_achonnko_action_warpLevelThree(obj_id player, obj_id npc)
    {
    ...
    public void ep3_achonnko_action_warpLevelFour(obj_id player, obj_id npc)
    {
    ...
    public void ep3_achonnko_action_warpLevelFive(obj_id player, obj_id npc)
    {
    ...
    public void ep3_achonnko_action_doWookieeJibberJabber(obj_id player, obj_id npc)
    {
        utils.emoteWookieeConfusion(player, npc);
    }
    public void ep3_achonnko_action_grantKashyyykCamoKit(obj_id player, obj_id npc)
    {
    ...
    public void ep3_achonnko_action_grantCamoKitQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_achonnko_camo_kit");
    }
    public int ep3_achonnko_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_achonnko_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_achonnko_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_achonnko_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_achonnko_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_achonnko_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_achonnko_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
