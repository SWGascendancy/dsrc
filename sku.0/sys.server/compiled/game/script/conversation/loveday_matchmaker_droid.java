...
public class loveday_matchmaker_droid extends script.base_script
{
    ...
    public boolean loveday_matchmaker_droid_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean loveday_matchmaker_droid_condition_returningMatchIncomplete(obj_id player, obj_id npc)
    {
    ...
    public boolean loveday_matchmaker_droid_condition_returningMatchComplete(obj_id player, obj_id npc)
    {
    ...
    public boolean loveday_matchmaker_droid_condition_notYetReadyForAnother(obj_id player, obj_id npc)
    {
    ...
    public void loveday_matchmaker_droid_action_grantLovedayQuest(obj_id player, obj_id npc)
    {
    ...
    public void loveday_matchmaker_droid_action_sendCompletionSignal(obj_id player, obj_id npc)
    {
    ...
    public int loveday_matchmaker_droid_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int loveday_matchmaker_droid_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int loveday_matchmaker_droid_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int loveday_matchmaker_droid_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
