...
public class shuttle_control_terminal extends script.base_script
{
    ...
    public boolean shuttle_control_terminal_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean shuttle_control_terminal_condition_hasQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "outbreak_undead_rancor_boss_fight");
    }
    public boolean shuttle_control_terminal_condition_hasGroup(obj_id player, obj_id npc)
    {
    ...
    public boolean shuttle_control_terminal_condition_grantPermissionLandTask(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "u16_nym_themepark_shuttle_ambush", "grantPermissionToLand");
    }
    public boolean shuttle_control_terminal_condition_hasQuestAndGroup(obj_id player, obj_id npc)
    {
    ...
    public boolean shuttle_control_terminal_condition_wave_event_active(obj_id player, obj_id npc)
    {
    ...
    public void shuttle_control_terminal_action_createShuttleSendSignal(obj_id player, obj_id npc)
    {
    ...
    public void shuttle_control_terminal_action_unauthorizedUse(obj_id player, obj_id npc)
    {
        string_id barkString = new string_id("theme_park_nym/messages", "terminal_unauthorized");
        chat.chat(npc, barkString);
    }
    public void shuttle_control_terminal_action_busyWithOtherPlayer(obj_id player, obj_id npc)
    {
        string_id barkString = new string_id("theme_park_nym/messages", "terminal_busy");
        chat.chat(npc, barkString);
    }
    public int shuttle_control_terminal_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int shuttle_control_terminal_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int signalPlayerEnvoy(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int spawnHeroes(obj_id self, dictionary params)
    {
    ...
    public int removeTerminalLock(obj_id self, dictionary params)
    {
