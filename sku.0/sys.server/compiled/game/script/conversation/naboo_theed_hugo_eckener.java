...
public class naboo_theed_hugo_eckener extends script.base_script
{
    ...
    public boolean naboo_theed_hugo_eckener_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean naboo_theed_hugo_eckener_condition_readyForHugo(obj_id player, obj_id npc)
    {
        return badge.hasBadge(player, "bdg_content_rsf_clearance_4");
    }
    public boolean naboo_theed_hugo_eckener_condition_needsSkaakQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_theed_hugo_eckener_condition_completedSkaakAndDarkwalker(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_theed_hugo_eckener_condition_hasSkaakOrDarkwalkerQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_theed_hugo_eckener_condition_needsDarkwalkerQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_theed_hugo_eckener_condition_finishedHugo(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_theed_hugo_eckener_condition_isOnBorvoQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "naboo_theed_hugo_borvo");
    }
    public boolean naboo_theed_hugo_eckener_condition_lastStepBorvoQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_theed_hugo_eckener_condition_lastStepRescueQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_theed_hugo_eckener_condition_onRescueQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_theed_hugo_eckener_condition_offerSkaakLoc(obj_id player, obj_id npc)
    {
        return !groundquests.isQuestActive(player, "naboo_theed_hugo_goto_skaak");
    }
    public boolean naboo_theed_hugo_eckener_condition_offerDarkwalkerLoc(obj_id player, obj_id npc)
    {
        return !groundquests.isQuestActive(player, "naboo_theed_hugo_goto_darkwalker");
    }
    public void naboo_theed_hugo_eckener_action_grantDarkwalkerQuest(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "naboo_theed_goto_jorgellansel");
    }
    public void naboo_theed_hugo_eckener_action_grantRescueQuest_skaak(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "naboo_theed_hugo_rescue_skaak");
    }
    public void naboo_theed_hugo_eckener_action_grantSkaakQuest(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "naboo_theed_goto_toff");
    }
    public void naboo_theed_hugo_eckener_action_grantHugoBorvo(obj_id player, obj_id npc)
    {
    ...
    public void naboo_theed_hugo_eckener_action_signal_rescue_07(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "theed_hugo_rescue_07");
    }
    public void naboo_theed_hugo_eckener_action_endGotoHugo(obj_id player, obj_id npc)
    {
    ...
    public void naboo_theed_hugo_eckener_action_endHugoBorvoQuest(obj_id player, obj_id npc)
    {
    ...
    public void naboo_theed_hugo_eckener_action_endReturnToHugo(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "theed_hugo_return");
    }
    public void naboo_theed_hugo_eckener_action_grantDarkwalkerLoc(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "naboo_theed_hugo_goto_darkwalker");
    }
    public void naboo_theed_hugo_eckener_action_grantSkaakLoc(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "naboo_theed_hugo_goto_skaak");
    }
    public void naboo_theed_hugo_eckener_action_grantRescueQuest_darkwalker(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "naboo_theed_hugo_rescue_darkwalker");
    }
    public int naboo_theed_hugo_eckener_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_hugo_eckener_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_hugo_eckener_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_hugo_eckener_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_hugo_eckener_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_hugo_eckener_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_hugo_eckener_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_hugo_eckener_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_hugo_eckener_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_hugo_eckener_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_hugo_eckener_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_hugo_eckener_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_hugo_eckener_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_hugo_eckener_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_hugo_eckener_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
