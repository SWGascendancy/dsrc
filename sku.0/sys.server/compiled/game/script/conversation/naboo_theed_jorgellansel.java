...
public class naboo_theed_jorgellansel extends script.base_script
{
    ...
    public boolean naboo_theed_jorgellansel_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean naboo_theed_jorgellansel_condition_startDarkwalkerQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_theed_jorgellansel_condition_onDarkwalkerQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "naboo_theed_hugo_darkwalker");
    }
    public boolean naboo_theed_jorgellansel_condition_completedDarkwalkerQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "naboo_theed_hugo_darkwalker");
    }
    public boolean naboo_theed_jorgellansel_condition_lastStepDarkwalkerQuest(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "naboo_theed_hugo_darkwalker", "theed_hugo_darkwalker_05");
    }
    public boolean naboo_theed_jorgellansel_condition_reGiveHugoPointer(obj_id player, obj_id npc)
    {
    ...
    public void naboo_theed_jorgellansel_action_grantDarkwalker(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "naboo_theed_hugo_darkwalker");
    }
    public void naboo_theed_jorgellansel_action_signal_darkwalker_05(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "theed_hugo_darkwalker_05");
    }
    public void naboo_theed_jorgellansel_action_endGotoJorgellansel(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "theed_goto_jorgellansel");
    }
    public void naboo_theed_jorgellansel_action_sendBackToHugo(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "naboo_theed_hugo_return");
        return;
    }
    public int naboo_theed_jorgellansel_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_jorgellansel_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_jorgellansel_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_jorgellansel_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
