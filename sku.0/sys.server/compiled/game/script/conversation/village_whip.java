...
public class village_whip extends script.base_script
{
    ...
    public boolean village_whip_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean village_whip_condition_phase1_inprogress(obj_id player, obj_id npc)
    {
    ...
    public boolean village_whip_condition_phase1_givequest(obj_id player, obj_id npc)
    {
        obj_id master = getObjIdObjVar(npc, "village_master");
        if (!isIdValid(master))
        {
    ...
    public boolean village_whip_condition_phase1_continue(obj_id player, obj_id npc)
    {
        obj_id master = getObjIdObjVar(npc, "village_master");
        if (!isIdValid(master))
        {
    ...
    public boolean village_whip_condition_phase1_failed(obj_id player, obj_id npc)
    {
        obj_id master = getObjIdObjVar(npc, "village_master");
        if (!isIdValid(master))
        {
    ...
    public boolean village_whip_condition_phase1_complete(obj_id player, obj_id npc)
    {
        obj_id master = getObjIdObjVar(npc, "village_master");
        if (!isIdValid(master))
        {
    ...
    public boolean village_whip_condition_phase2_complete(obj_id player, obj_id npc)
    {
        obj_id master = getObjIdObjVar(npc, "village_master");
        if (!isIdValid(master))
        {
    ...
    public boolean village_whip_condition_phase2_continue(obj_id player, obj_id npc)
    {
        obj_id master = getObjIdObjVar(npc, "village_master");
        if (!isIdValid(master))
        {
    ...
    public boolean village_whip_condition_phase2_failed(obj_id player, obj_id npc)
    {
        obj_id master = getObjIdObjVar(npc, "village_master");
        if (!isIdValid(master))
        {
    ...
    public boolean village_whip_condition_phase2_givequest(obj_id player, obj_id npc)
    {
        obj_id master = getObjIdObjVar(npc, "village_master");
        if (!isIdValid(master))
        {
    ...
    public boolean village_whip_condition_phase2_inprogress(obj_id player, obj_id npc)
    {
        obj_id master = getObjIdObjVar(npc, "village_master");
        if (!isIdValid(master))
        {
    ...
    public boolean village_whip_condition_phase2_aborted(obj_id player, obj_id npc)
    {
        obj_id master = getObjIdObjVar(npc, "village_master");
        if (!isIdValid(master))
        {
    ...
    public boolean village_whip_condition_not_eligible(obj_id player, obj_id npc)
    {
        if (!fs_quests.isVillageEligible(player))
        {
            return true;
    ...
    public boolean village_whip_condition_phase3(obj_id player, obj_id npc)
    {
        obj_id master = getObjIdObjVar(npc, "village_master");
        if (!isIdValid(master))
        {
    ...
    public boolean village_whip_condition_phase1_aborted(obj_id player, obj_id npc)
    {
        obj_id master = getObjIdObjVar(npc, "village_master");
        if (!isIdValid(master))
        {
    ...
    public boolean village_whip_condition_quest_accepted(obj_id player, obj_id npc)
    {
        if (fs_quests.hasQuestAccepted(player))
        {
            return true;
    ...
    public boolean village_whip_condition_quest_completed(obj_id player, obj_id npc)
    {
    ...
    public boolean village_whip_condition_phase4(obj_id player, obj_id npc)
    {
        obj_id master = getObjIdObjVar(npc, "village_master");
        if (!isIdValid(master))
        {
    ...
    public void village_whip_action_phase1_activate_quest(obj_id player, obj_id npc)
    {
        obj_id master = getObjIdObjVar(npc, "village_master");
        if (isIdValid(master))
        {
    ...
    public void village_whip_action_phase1_continue_quest(obj_id player, obj_id npc)
    {
    ...
    public void village_whip_action_phase2_activate_quest(obj_id player, obj_id npc)
    {
        obj_id master = getObjIdObjVar(npc, "village_master");
        if (isIdValid(master))
        {
    ...
    public void village_whip_action_phase2_continue_quest(obj_id player, obj_id npc)
    {
    ...
    public void village_whip_action_phase2_abort_in_convo(obj_id player, obj_id npc)
    {
    ...
    public int village_whip_tokenDI_villagers_left(obj_id player, obj_id npc)
    {
    ...
    public int village_whip_tokenDI_supplies_left(obj_id player, obj_id npc)
    {
    ...
    public int village_whip_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int village_whip_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int village_whip_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int village_whip_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int village_whip_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int village_whip_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int village_whip_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int village_whip_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int village_whip_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int village_whip_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int village_whip_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int village_whip_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int village_whip_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int village_whip_handleBranch30(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int village_whip_handleBranch31(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int village_whip_handleBranch35(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int village_whip_handleBranch38(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int handleMasterIdResponse(obj_id self, dictionary params)
    {
    ...
    public int handleMasterIdRequestRetry(obj_id self, dictionary params)
    {
        if (!fs_dyn_village.getRegisteredObjIdFromClusterWideData(fs_dyn_village.CLUSTER_OBJID_KEY_MASTER, "handleMasterIdResponse", self))
        {
            messageTo(self, "handleMasterIdRequestRetry", null, 120.0f, false);
