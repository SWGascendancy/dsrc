...
public class npe_force_sensitive extends script.base_script
{
    ...
    public boolean npe_force_sensitive_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_force_sensitive_condition_needstotalktoRydel(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "npe_pointer_brawler");
    }
    public boolean npe_force_sensitive_condition_fromBrawler(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_force_tracker", "rydel");
    }
    public boolean npe_force_sensitive_condition_ondroids(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_force_sensitive", "killdroids");
    }
    public boolean npe_force_sensitive_condition_wantsFS(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_force_sensitive_condition_finishedDark(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "npe_force_dark");
    }
    public boolean npe_force_sensitive_condition_busy(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_force_sensitive_condition_OnTancQueen(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_force_sensitive", "tanc_queen");
    }
    public boolean npe_force_sensitive_condition_finishedLastTask(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_force_sensitive", "final_signal");
    }
    public boolean npe_force_sensitive_condition_onAnger(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_force_sensitive", "anger_manage");
    }
    public boolean npe_force_sensitive_condition_onTancOne(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_force_sensitive", "tanc1");
    }
    public boolean npe_force_sensitive_condition_isFSTemplate(obj_id player, obj_id npc)
    {
    ...
    public void npe_force_sensitive_action_giveFSQuest(obj_id player, obj_id npc)
    {
    ...
    public void npe_force_sensitive_action_giveReward(obj_id player, obj_id npc)
    {
        setObjVar(player, "npe.finishedTemplate", 1);
        groundquests.sendSignal(player, "npe_force_done_signal");
    }
    public void npe_force_sensitive_action_giveRydelPointer(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "found_force_sensitive");
        groundquests.grantQuest(player, "npe_pointer_brawler");
        groundquests.grantQuest(player, "npe_force_tracker", false);
    }
    public void npe_force_sensitive_action_giveSecretaryPointer(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_pointer_secretary");
    }
    public void npe_force_sensitive_action_giveHanPointer(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_job_pointer_han");
    }
    public void npe_force_sensitive_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int npe_force_sensitive_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_force_sensitive_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_force_sensitive_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_force_sensitive_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_force_sensitive_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_force_sensitive_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_force_sensitive_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_force_sensitive_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_force_sensitive_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_force_sensitive_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
