...
public class generic_broker_5 extends script.base_script
{
    ...
    public boolean generic_broker_5_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean generic_broker_5_condition_isNonSmuggler(obj_id player, obj_id npc)
    {
    ...
    public boolean generic_broker_5_condition_isDoingMission(obj_id player, obj_id npc)
    {
    ...
    public boolean generic_broker_5_condition_missionTierRequirement(obj_id player, obj_id npc)
    {
    ...
    public boolean generic_broker_5_condition_hasMissionFunds(obj_id player, obj_id npc)
    {
    ...
    public boolean generic_broker_5_condition_hasSomeContraband(obj_id player, obj_id npc)
    {
    ...
    public boolean generic_broker_5_condition_hasMissionContraband(obj_id player, obj_id npc)
    {
    ...
    public boolean generic_broker_5_condition_hasPvpMissionFunds(obj_id player, obj_id npc)
    {
    ...
    public void generic_broker_5_action_startGiveQuest(obj_id player, obj_id npc)
    {
    ...
    public void generic_broker_5_action_givePointerQuest(obj_id player, obj_id npc)
    {
        float underworldFaction = factions.getFactionStanding(player, "underworld");
    ...
    public void generic_broker_5_action_giveIllicitPointerQuest(obj_id player, obj_id npc)
    {
        float underworldFaction = factions.getFactionStanding(player, "underworld");
    ...
    public void generic_broker_5_action_startGivePvpQuest(obj_id player, obj_id npc)
    {
        if (money.hasFunds(player, money.MT_TOTAL, smuggler.TIER_5_GENERIC_PVP_FRONT_COST))
        {
    ...
    public int generic_broker_5_tokenDI_frontMoney(obj_id player, obj_id npc)
    {
        return (smuggler.TIER_5_GENERIC_FRONT_COST);
    }
    public int generic_broker_5_tokenDI_pvpFrontMoney(obj_id player, obj_id npc)
    {
        return (smuggler.TIER_5_GENERIC_PVP_FRONT_COST);
    }
    public int generic_broker_5_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int generic_broker_5_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int generic_broker_5_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int generic_broker_5_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int generic_broker_5_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
