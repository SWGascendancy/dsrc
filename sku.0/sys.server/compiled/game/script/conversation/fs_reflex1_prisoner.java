...
public class fs_reflex1_prisoner extends script.base_script
{
    ...
    public boolean fs_reflex1_prisoner_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean fs_reflex1_prisoner_condition_combatNotReady(obj_id player, obj_id npc)
    {
    ...
    public boolean fs_reflex1_prisoner_condition_notCorrectPlayer(obj_id player, obj_id npc)
    {
        if (hasObjVar(npc, "player"))
        {
    ...
    public boolean fs_reflex1_prisoner_condition_isSafe(obj_id player, obj_id npc)
    {
    ...
    public boolean fs_reflex1_prisoner_condition_isInProgress(obj_id player, obj_id npc)
    {
    ...
    public boolean fs_reflex1_prisoner_condition_hasFailed(obj_id player, obj_id npc)
    {
    ...
    public void fs_reflex1_prisoner_action_complete_quest(obj_id player, obj_id npc)
    {
    ...
    public int handleTaskDestroyOnArrival(obj_id self, dictionary params)
    {
        destroyObject(self);
        return SCRIPT_CONTINUE;
    }
    public int handleTaskArrived(obj_id self, dictionary params)
    {
        setObjVar(self, "safe", 1);
        return SCRIPT_CONTINUE;
    }
    public int handleSetupPrisoner(obj_id self, dictionary params)
    {
