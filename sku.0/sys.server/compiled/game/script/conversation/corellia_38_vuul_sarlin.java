...
public class corellia_38_vuul_sarlin extends script.base_script
{
    ...
    public boolean corellia_38_vuul_sarlin_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_38_vuul_sarlin_condition_taskOneActive(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_38_corsec_files_04", "corsec_files_04_05");
    }
    public boolean corellia_38_vuul_sarlin_condition_sidequestActive(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "corellia_38_sidequest_06");
    }
    public boolean corellia_38_vuul_sarlin_condition_sidequestComplete(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_38_sidequest_06", "corellia_38_sidequest_06_02");
    }
    public boolean corellia_38_vuul_sarlin_condition_AllDone(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "corellia_38_sidequest_06");
    }
    public boolean corellia_38_vuul_sarlin_condition_ryllComplete(obj_id player, obj_id npc)
    {
    ...
    public void corellia_38_vuul_sarlin_action_sidequestGrant(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "corellia_38_sidequest_06");
    }
    public void corellia_38_vuul_sarlin_action_ryllCompleteSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "corsec_files_04_05");
    }
    public void corellia_38_vuul_sarlin_action_sidequestSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "corellia_38_sidequest_06_02");
    }
    public int corellia_38_vuul_sarlin_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_38_vuul_sarlin_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_38_vuul_sarlin_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_38_vuul_sarlin_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_48"))
        {
            if (corellia_38_vuul_sarlin_condition__defaultCondition(player, npc))
