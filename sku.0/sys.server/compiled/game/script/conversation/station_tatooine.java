...
public class station_tatooine extends script.base_script
{
    ...
    public boolean station_tatooine_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean station_tatooine_condition_canAfford50(obj_id player, obj_id npc)
    {
        return space_crafting.canAffordShipRepairs(player, npc, .50f);
    }
    public boolean station_tatooine_condition_canAfford25(obj_id player, obj_id npc)
    {
        return (space_crafting.canAffordShipRepairs(player, npc, .25f) && space_crafting.isDamaged(player));
    }
    public boolean station_tatooine_condition_canAfford75(obj_id player, obj_id npc)
    {
        return space_crafting.canAffordShipRepairs(player, npc, .75f);
    }
    public boolean station_tatooine_condition_canAfford100(obj_id player, obj_id npc)
    {
        return space_crafting.canAffordShipRepairs(player, npc, 1.0f);
    }
    public boolean station_tatooine_condition_needRepairs(obj_id player, obj_id npc)
    {
    ...
    public boolean station_tatooine_condition_isTooFar(obj_id player, obj_id npc)
    {
        space_combat.playCombatTauntSound(player);
        obj_id containingShip = space_transition.getContainingShip(player);
        return (getDistance(npc, containingShip) > space_transition.STATION_COMM_MAX_DISTANCE);
    }
    public boolean station_tatooine_condition_isFirstTierTatooinePrivateer(obj_id player, obj_id npc)
    {
        return (space_flags.isInTierOne(player) && space_flags.isSpaceTrack(player, space_flags.PRIVATEER_TATOOINE));
    }
    public boolean station_tatooine_condition_isFirstTierTatooineRebel(obj_id player, obj_id npc)
    {
        return (space_flags.isInTierOne(player) && space_flags.isSpaceTrack(player, space_flags.REBEL_TATOOINE));
    }
    public boolean station_tatooine_condition_isFirstTierTatooineImperial(obj_id player, obj_id npc)
    {
        return (space_flags.isInTierOne(player) && space_flags.isSpaceTrack(player, space_flags.IMPERIAL_TATOOINE));
    }
    public boolean station_tatooine_condition_canDoJabbaAccess(obj_id player, obj_id npc)
    {
    ...
    public boolean station_tatooine_condition_canGetTier1RecoveryDuty(obj_id player, obj_id npc)
    {
    ...
    public boolean station_tatooine_condition_canLandAtJabbas(obj_id player, obj_id npc)
    {
    ...
    public boolean station_tatooine_condition_canLandAtHouse(obj_id player, obj_id npc)
    {
    ...
    public boolean station_tatooine_condition_canTakeQuest(obj_id player, obj_id npc)
    {
        if (space_quest.hasQuest(player))
        {
            return false;
    ...
    public boolean station_tatooine_condition_canAttackImperial(obj_id player, obj_id npc)
    {
    ...
    public boolean station_tatooine_condition_canAttackRebel(obj_id player, obj_id npc)
    {
    ...
    public boolean station_tatooine_condition_canTakeTier5ImperialDuty(obj_id player, obj_id npc)
    {
    ...
    public boolean station_tatooine_condition_canTakeTier5RebelDuty(obj_id player, obj_id npc)
    {
        if (!space_skill.isMasterPilot(player))
        {
            return false;
    ...
    public void station_tatooine_action_landStation3(obj_id player, obj_id npc)
    {
        space_content.landPlayer(player, npc, "Mos Espa Starport");
    }
    public void station_tatooine_action_fix25(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, .25f);
    }
    public void station_tatooine_action_fix50(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, .50f);
    }
    public void station_tatooine_action_fix75(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, .75f);
    }
    public void station_tatooine_action_fix100(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, 1.0f);
    }
    public void station_tatooine_action_landStation1(obj_id player, obj_id npc)
    {
        space_content.landPlayer(player, npc, "Bestine Starport");
    }
    public void station_tatooine_action_landStation2(obj_id player, obj_id npc)
    {
        space_content.landPlayer(player, npc, "Mos Eisley Starport");
    }
    public void station_tatooine_action_landStation4(obj_id player, obj_id npc)
    {
        space_content.landPlayer(player, npc, "Mos Entha Spaceport");
    }
    public void station_tatooine_action_giveJabbaAccessQuest(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "rescue", "tatooine_station_hutt_palace_access_quest_1");
    }
    public void station_tatooine_action_grantTier1RecoveryDuty(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "recovery_duty", "tatooine_station_hutt_recovery_duty_tier1_1");
    }
    public void station_tatooine_action_landJabba(obj_id player, obj_id npc)
    {
        space_content.landPlayer(player, npc, "Jabba's Palace");
    }
    public void station_tatooine_action_landHoming(obj_id player, obj_id npc)
    {
        space_content.landPlayerHoming(player, npc);
    }
    public void station_tatooine_action_grantImperialDuty1(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "tatooine_imperial_tier1");
    }
    public void station_tatooine_action_grantImperialDuty2(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "tatooine_imperial_tier2");
    }
    public void station_tatooine_action_grantRebelDuty1(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "tatooine_rebel_tier1");
    }
    public void station_tatooine_action_grantRebelDuty2(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "tatooine_rebel_tier2");
    }
    public void station_tatooine_action_grantHiddenDaggerDuty2(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "tatooine_hidden_dagger_tier2");
    }
    public void station_tatooine_action_grantHiddenDaggerDuty1(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "tatooine_hidden_dagger_tier1");
    }
    public void station_tatooine_action_grantImperialDuty5(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "tatooine_imperial_tier5");
    }
    public void station_tatooine_action_grantRebelDuty5(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "tatooine_rebel_tier5");
    }
    public String station_tatooine_tokenTO_tokenTO0001(obj_id player, obj_id npc)
    {
        return new String();
    }
    public int station_tatooine_tokenDI_getStationRepairCost25(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, .25f);
    }
    public int station_tatooine_tokenDI_getStationRepairCost50(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, .50f);
    }
    public int station_tatooine_tokenDI_getStationRepairCost75(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, .75f);
    }
    public int station_tatooine_tokenDI_getStationRepairCost100(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, 1.0f);
    }
    public int station_tatooine_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_tatooine_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_tatooine_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_tatooine_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_tatooine_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_tatooine_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_tatooine_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_tatooine_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_tatooine_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_tatooine_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_tatooine_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_tatooine_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_tatooine_handleBranch31(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_tatooine_handleBranch34(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_tatooine_handleBranch37(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_tatooine_handleBranch38(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_tatooine_handleBranch41(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_tatooine_handleBranch44(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_tatooine_handleBranch47(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_tatooine_handleBranch51(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_tatooine_handleBranch53(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_tatooine_handleBranch56(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_tatooine_handleBranch58(obj_id player, obj_id npc, string_id response)
    {
