...
public class bestine_stone_merchant extends script.base_script
{
    ...
    public boolean bestine_stone_merchant_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean bestine_stone_merchant_condition_SearchForStones(obj_id player, obj_id npc)
    {
    ...
    public boolean bestine_stone_merchant_condition_SearchforSmooth(obj_id player, obj_id npc)
    {
        if (utils.playerHasItemByTemplate(player, "object/tangible/loot/quest/smooth_stone.iff"))
        {
            return true;
    ...
    public boolean bestine_stone_merchant_condition_SearchforCarved(obj_id player, obj_id npc)
    {
        if (utils.playerHasItemByTemplate(player, "object/tangible/loot/quest/carved_stone.iff"))
        {
            return true;
    ...
    public boolean bestine_stone_merchant_condition_SearchforStoneObjs(obj_id player, obj_id npc)
    {
    ...
    public void bestine_stone_merchant_action__defaultAction(obj_id player, obj_id npc)
    {
    }
    public void bestine_stone_merchant_action_GiveCarvedStoneReward(obj_id player, obj_id npc)
    {
    ...
    public void bestine_stone_merchant_action_GiveSmoothStoneReward(obj_id player, obj_id npc)
    {
