...
public class legacy_naboo_sache extends script.base_script
{
    ...
    public boolean legacy_naboo_sache_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean legacy_naboo_sache_condition_isOnCorrectTask(obj_id player, obj_id npc)
    {
    ...
    public void legacy_naboo_sache_action_sendSignalAboutSache(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "SacheHasToldMeHerPlan");
    }
    public int legacy_naboo_sache_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_naboo_sache_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
