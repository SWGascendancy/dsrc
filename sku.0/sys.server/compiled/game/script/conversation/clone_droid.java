...
public class clone_droid extends script.base_script
{
    ...
    public boolean clone_droid_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean clone_droid_condition_isSick(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return buff.hasBuff(player, "cloning_sickness");
    }
    public boolean clone_droid_condition_canAffordCure(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return pclib.canAffordCloningSicknessCure(player);
    }
    public void clone_droid_action_payForCure(obj_id player, obj_id npc)
    {
        pclib.cureCloningSickness(player);
    }
    public int clone_droid_tokenDI_cureCost(obj_id player, obj_id npc)
    {
        return pclib.getCloningSicknessCureCost(player);
    }
    public int clone_droid_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
