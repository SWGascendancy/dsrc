...
public class boss_terminal_research_barnet extends script.base_script
{
    ...
    public boolean boss_terminal_research_barnet_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean boss_terminal_research_barnet_condition_hasQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "outbreak_undead_rancor_boss_fight");
    }
    public boolean boss_terminal_research_barnet_condition_hasGroup(obj_id player, obj_id npc)
    {
    ...
    public boolean boss_terminal_research_barnet_condition_hasBossTask(obj_id player, obj_id npc)
    {
    ...
    public boolean boss_terminal_research_barnet_condition_hasQuestAndGroup(obj_id player, obj_id npc)
    {
    ...
    public boolean boss_terminal_research_barnet_condition_wave_event_active(obj_id player, obj_id npc)
    {
        int wave = utils.getIntScriptVar(npc, "waveEventCurrentWave");
        return wave > 0;
    }
    public void boss_terminal_research_barnet_action_startEvent(obj_id player, obj_id npc)
    {
    ...
    public void boss_terminal_research_barnet_action_foundTerminal(obj_id player, obj_id npc)
    {
    ...
    public void boss_terminal_research_barnet_action_unauthorizedUse(obj_id player, obj_id npc)
    {
        string_id barkString = new string_id("theme_park_nym/messages", "terminal_unauthorized");
        chat.chat(npc, barkString);
    }
    public void boss_terminal_research_barnet_action_busyWithOtherPlayer(obj_id player, obj_id npc)
    {
        string_id barkString = new string_id("theme_park_nym/messages", "terminal_busy");
        chat.chat(npc, barkString);
    }
    public int boss_terminal_research_barnet_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int boss_terminal_research_barnet_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int boss_terminal_research_barnet_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
