...
public class ep3_etyyy_manfred_carter extends script.base_script
{
    ...
    public boolean ep3_etyyy_manfred_carter_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_etyyy_manfred_carter_condition_hasCompletedManfredQuests(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_hunt_manfred_kill_chiss_leader");
    }
    public boolean ep3_etyyy_manfred_carter_condition_finishedCollectChissChemicals(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_etyyy_manfred_carter_condition_finishedStealChissGoods(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_etyyy_manfred_carter_condition_isCollectingChissChemicals(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_hunt_manfred_collect_enhancements", "manfred_collectChemicals");
    }
    public boolean ep3_etyyy_manfred_carter_condition_isStealingChissGoods(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_hunt_manfred_steal_chiss_goods", "manfred_stealChissGoods");
    }
    public boolean ep3_etyyy_manfred_carter_condition_isKillingChissLeader(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_hunt_manfred_kill_chiss_leader", "manfred_killingChissLeader");
    }
    public boolean ep3_etyyy_manfred_carter_condition_finishedKillChissLeader(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_hunt_manfred_kill_chiss_leader", "manfred_killedChissLeader");
    }
    public boolean ep3_etyyy_manfred_carter_condition_isDeliveringToKerssoc(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_hunt_manfred_steal_chiss_goods", "manfred_deliverToKerssoc");
    }
    public boolean ep3_etyyy_manfred_carter_condition_hasToTalkToManfred(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_hunt_manfred_steal_chiss_goods", "manfred_talkToManfred");
    }
    public void ep3_etyyy_manfred_carter_action_killChissLeader(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_hunt_manfred_kill_chiss_leader");
    }
    public void ep3_etyyy_manfred_carter_action_speakWithTripp(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "manfred_killedChissLeader");
        groundquests.grantQuest(player, "ep3_hunt_tripp_collect_mouf_pelts");
    }
    public void ep3_etyyy_manfred_carter_action_stealChissGoods(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "manfred_talkToManfred");
    }
    public void ep3_etyyy_manfred_carter_action_collectChissChemicals(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_hunt_manfred_collect_enhancements");
    }
    public void ep3_etyyy_manfred_carter_action_doneStealChissGoods(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "manfred_backToManfred");
    }
    public void ep3_etyyy_manfred_carter_action_doneCollectChemicals(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "manfred_chissChemicals");
    }
    public int ep3_etyyy_manfred_carter_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_manfred_carter_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_manfred_carter_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_manfred_carter_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
