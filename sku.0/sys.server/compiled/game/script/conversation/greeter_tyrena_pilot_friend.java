...
public class greeter_tyrena_pilot_friend extends script.base_script
{
    ...
    public boolean greeter_tyrena_pilot_friend_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean greeter_tyrena_pilot_friend_condition_remembersPlayer(obj_id player, obj_id npc)
    {
        return (utils.hasScriptVar(player, "metNewbiePilot"));
    }
    public boolean greeter_tyrena_pilot_friend_condition_spokeWithUlaire(obj_id player, obj_id npc)
    {
        return utils.hasScriptVar(player, "spokeWithUlaireRoye");
    }
    public boolean greeter_tyrena_pilot_friend_condition_isAnImperialPilot(obj_id player, obj_id npc)
    {
        return space_flags.isImperialPilot(player);
    }
    public boolean greeter_tyrena_pilot_friend_condition_isARebelPilot(obj_id player, obj_id npc)
    {
        return space_flags.isRebelPilot(player);
    }
    public boolean greeter_tyrena_pilot_friend_condition_isPrivateerPilot(obj_id player, obj_id npc)
    {
        return space_flags.isNeutralPilot(player);
    }
    public boolean greeter_tyrena_pilot_friend_condition_hasSpaceExpansion(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean greeter_tyrena_pilot_friend_condition_hasSpaceShip(obj_id player, obj_id npc)
    {
        return (space_quest.hasShip(player));
    }
    public void greeter_tyrena_pilot_friend_action_rememberPlayer(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "metNewbiePilot", true);
    }
    public void greeter_tyrena_pilot_friend_action_grantQuestOne(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "delivery", "tatooine_newbie_1");
        space_quest.grantNewbieShip(player, "rebel");
    }
    public int greeter_tyrena_pilot_friend_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int greeter_tyrena_pilot_friend_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int greeter_tyrena_pilot_friend_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int greeter_tyrena_pilot_friend_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
