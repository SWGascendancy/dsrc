...
public class corellia_39_lilith_laughlin extends script.base_script
{
    ...
    public boolean corellia_39_lilith_laughlin_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_39_lilith_laughlin_condition_seekCouncilOne(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_39_chirq_council_01", "chirq_council_01_01");
    }
    public boolean corellia_39_lilith_laughlin_condition_seekCouncilOneProgress(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "corellia_39_chirq_council_01", "chirq_council_01_01");
    }
    public boolean corellia_39_lilith_laughlin_condition_sekCouncilTwoProgress(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "corellia_39_chirq_council_01", "chirq_council_01_02");
    }
    public boolean corellia_39_lilith_laughlin_condition_seekCouncilThreeProgress(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "corellia_39_chirq_council_01", "chirq_council_01_04");
    }
    public boolean corellia_39_lilith_laughlin_condition_seekCouncilComplete(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "corellia_39_chirq_council_01");
    }
    public boolean corellia_39_lilith_laughlin_condition_movingUp(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_39_chirq_council_03", "chirq_council_03_05");
    }
    public boolean corellia_39_lilith_laughlin_condition_movingUpProgress(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "corellia_39_chirq_council_03", "chirq_council_03_05");
    }
    public boolean corellia_39_lilith_laughlin_condition_movingUpComplete(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "corellia_39_chirq_council_03b", "chirq_council_03_09");
    }
    public void corellia_39_lilith_laughlin_action_signal_seekCouncilOne(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "chirq_council_01_01");
    }
    public void corellia_39_lilith_laughlin_action_signal_movingUp(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "chirq_council_03_05");
    }
    public int corellia_39_lilith_laughlin_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_39_lilith_laughlin_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
