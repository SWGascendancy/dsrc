...
public class npe_profession_entertainer_officer extends script.base_script
{
    ...
    public boolean npe_profession_entertainer_officer_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_profession_entertainer_officer_condition_playerOnFirstQuestStep(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_prof_entertainer1", "talktoofficer");
    }
    public boolean npe_profession_entertainer_officer_condition_playerCompletedQuestStep(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "npe_prof_entertainer1", "getinformation");
    }
    public boolean npe_profession_entertainer_officer_condition_playerCompletedQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_scout_1");
    }
    public boolean npe_profession_entertainer_officer_condition_playerOnDanceStep(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_prof_entertainer1", "dance");
    }
    public boolean npe_profession_entertainer_officer_condition_playerOnSecondInfoStep(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_prof_entertainer1", "getinformation");
    }
    public void npe_profession_entertainer_officer_action_firstSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_prof_entertainer1_officer");
    }
    public void npe_profession_entertainer_officer_action_secondSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_prof_entertainer1_information");
    }
    public int npe_profession_entertainer_officer_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_profession_entertainer_officer_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_profession_entertainer_officer_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_profession_entertainer_officer_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_profession_entertainer_officer_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_profession_entertainer_officer_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
