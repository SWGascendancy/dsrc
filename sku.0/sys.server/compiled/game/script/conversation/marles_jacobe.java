...
public class marles_jacobe extends script.base_script
{
    ...
    public boolean marles_jacobe_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public int marles_jacobe_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int marles_jacobe_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int marles_jacobe_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int marles_jacobe_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
