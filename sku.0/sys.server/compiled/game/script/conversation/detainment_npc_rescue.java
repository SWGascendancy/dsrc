...
public class detainment_npc_rescue extends script.base_script
{
    ...
    public boolean detainment_npc_rescue_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean detainment_npc_rescue_condition_hasTheMisionActiveAndIsMyRescuer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean detainment_npc_rescue_condition_isNotMyRescuer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        if (!hasObjVar(npc, "rescuer") || !hasObjVar(npc, "rescuerQuest"))
        {
    ...
    public void detainment_npc_rescue_action_changeIntoDisguiseIncrCollection(obj_id player, obj_id npc)
    {
    ...
    public String detainment_npc_rescue_tokenTO_timeLeftRecruitment(obj_id player, obj_id npc)
    {
    ...
    public String detainment_npc_rescue_tokenTO_timeLeftPropaganda(obj_id player, obj_id npc)
    {
    ...
    public int detainment_npc_rescue_tokenDI_notUsed(obj_id player, obj_id npc)
    {
        return 0;
    }
    public int detainment_npc_rescue_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int detainment_npc_rescue_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
