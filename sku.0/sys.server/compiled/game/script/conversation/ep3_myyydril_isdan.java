...
public class ep3_myyydril_isdan extends script.base_script
{
    ...
    public boolean ep3_myyydril_isdan_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_myyydril_isdan_condition_isTaskActiveOne(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_myyydril_isdan_condition_isTaskCompletedOne(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_myyydril_isdan_condition_hasCompletedQuestOne(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_myyydril_isdan_retrieve_5");
    }
    public void ep3_myyydril_isdan_action_giveQuestOne(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_myyydril_isdan_retrieve_5");
    }
    public void ep3_myyydril_isdan_action_giveSignal1(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "giveNeat");
        sendSystemMessage(player, new string_id("dungeon/myyydril", "reward_isdan_quest_1"));
    }
    public int ep3_myyydril_isdan_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_isdan_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_isdan_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_isdan_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_isdan_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_isdan_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_isdan_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_isdan_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
