...
public class npe_han_solo_falcon2 extends script.base_script
{
    ...
    public boolean npe_han_solo_falcon2_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public void npe_han_solo_falcon2_action_talkedToHan(obj_id player, obj_id npc)
    {
    ...
    public int npe_han_solo_falcon2_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
