...
public class bestine_capitol03 extends script.base_script
{
    ...
    public boolean bestine_capitol03_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean bestine_capitol03_condition_nonoffice(obj_id player, obj_id npc)
    {
        return hasObjVar(npc, "bestine.electionEnded");
    }
    public void bestine_capitol03_action__defaultAction(obj_id player, obj_id npc)
    {
    }
