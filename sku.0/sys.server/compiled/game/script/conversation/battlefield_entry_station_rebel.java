...
public class battlefield_entry_station_rebel extends script.base_script
{
    ...
    public boolean battlefield_entry_station_rebel_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean battlefield_entry_station_rebel_condition_isPlayerRebel(obj_id player, obj_id npc)
    {
        return space_battlefield.isInRebelShip(player);
    }
    public boolean battlefield_entry_station_rebel_condition_isPlayerImperial(obj_id player, obj_id npc)
    {
        return space_battlefield.isInImperialShip(player);
    }
    public boolean battlefield_entry_station_rebel_condition_canAffordEntry(obj_id player, obj_id npc)
    {
    ...
    public boolean battlefield_entry_station_rebel_condition_isFactionCorrectForEntry(obj_id player, obj_id npc)
    {
    ...
    public boolean battlefield_entry_station_rebel_condition_isPlayerNeutral(obj_id player, obj_id npc)
    {
        return space_battlefield.isInNeutralShip(player);
    }
    public boolean battlefield_entry_station_rebel_condition_isTooFar(obj_id player, obj_id npc)
    {
        space_combat.playCombatTauntSound(player);
        obj_id containingShip = space_transition.getContainingShip(player);
        return (getDistance(npc, containingShip) > space_transition.STATION_COMM_MAX_DISTANCE);
    }
    public boolean battlefield_entry_station_rebel_condition_isInYacht(obj_id player, obj_id npc)
    {
    ...
    public void battlefield_entry_station_rebel_action_goToBattlefield(obj_id player, obj_id npc)
    {
        obj_id ship = space_transition.getContainingShip(player);
    ...
    public void battlefield_entry_station_rebel_action_goToKessel(obj_id player, obj_id npc)
    {
        space_battlefield.doKesselTransition(space_transition.getContainingShip(player), npc);
    }
    public int battlefield_entry_station_rebel_tokenDI_prestigeCost(obj_id player, obj_id npc)
    {
        return space_battlefield.getPrestigeCostForTransition(player, npc);
    }
    public int battlefield_entry_station_rebel_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
