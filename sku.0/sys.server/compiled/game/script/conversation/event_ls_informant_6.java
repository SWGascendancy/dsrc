...
public class event_ls_informant_6 extends script.base_script
{
    ...
    public boolean event_ls_informant_6_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public int event_ls_informant_6_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_ls_informant_6_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_5"))
        {
            if (event_ls_informant_6_condition__defaultCondition(player, npc))
    ...
    public int event_ls_informant_6_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_ls_informant_6_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_ls_informant_6_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_ls_informant_6_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_ls_informant_6_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_ls_informant_6_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_5"))
        {
            if (event_ls_informant_6_condition__defaultCondition(player, npc))
    ...
    public int event_ls_informant_6_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_5"))
        {
            if (event_ls_informant_6_condition__defaultCondition(player, npc))
    ...
    public int event_ls_informant_6_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_5"))
        {
            if (event_ls_informant_6_condition__defaultCondition(player, npc))
    ...
    public int event_ls_informant_6_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_5"))
        {
            if (event_ls_informant_6_condition__defaultCondition(player, npc))
