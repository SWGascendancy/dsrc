...
public class npe_main_trace extends script.base_script
{
    ...
    public boolean npe_main_trace_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_main_trace_condition_onCorrectStep(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_new_main_quest", "bounty");
    }
    public boolean npe_main_trace_condition_finishedCorrectStep(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "npe_new_main_quest", "bounty");
    }
    public void npe_main_trace_action_forwardquest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_new_main_quest_bounty");
    }
    public void npe_main_trace_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int npe_main_trace_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_main_trace_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_main_trace_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
