...
public class prof_officer_11 extends script.base_script
{
    ...
    public boolean prof_officer_11_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean prof_officer_11_condition_isDoingOfficerQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean prof_officer_11_condition_finishingOfficer(obj_id player, obj_id npc)
    {
    ...
    public boolean prof_officer_11_condition_doneWithOfficerQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean prof_officer_11_condition_notOnQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean prof_officer_11_condition_notOfficer(obj_id player, obj_id npc)
    {
    ...
    public void prof_officer_11_action_sendOfficerSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "chatWithEllis");
    }
    public void prof_officer_11_action_sendFinishSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "completedOfficer11");
    }
    public int prof_officer_11_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int prof_officer_11_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int prof_officer_11_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int prof_officer_11_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
