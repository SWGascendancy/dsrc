...
public class bestine_artist02 extends script.base_script
{
    ...
    public boolean bestine_artist02_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean bestine_artist02_condition_hasFeaturedArt(obj_id player, obj_id npc)
    {
    ...
    public boolean bestine_artist02_condition_isActiveInEvent(obj_id player, obj_id npc)
    {
    ...
    public boolean bestine_artist02_condition_hasFeaturedArt_EventActive(obj_id player, obj_id npc)
    {
        return ((bestine_artist02_condition_isActiveInEvent(player, npc)) && (bestine_artist02_condition_hasFeaturedArt(player, npc)));
    }
    public boolean bestine_artist02_condition_hasAlreadyVoted(obj_id player, obj_id npc)
    {
        if (hasObjVar(npc, "bestine.museumEventStarted"))
        {
    ...
    public boolean bestine_artist02_condition_hasSpokenTo(obj_id player, obj_id npc)
    {
        if (hasObjVar(npc, "bestine.museumEventStarted"))
        {
    ...
    public void bestine_artist02_action_setHasSpokenTo(obj_id player, obj_id npc)
    {
        if (hasObjVar(npc, "bestine.museumEventStarted"))
        {
    ...
    public int bestine_artist02_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int bestine_artist02_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
