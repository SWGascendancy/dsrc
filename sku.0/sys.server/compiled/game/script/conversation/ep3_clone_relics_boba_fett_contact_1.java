...
public class ep3_clone_relics_boba_fett_contact_1 extends script.base_script
{
    ...
    public boolean ep3_clone_relics_boba_fett_contact_1_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_clone_relics_boba_fett_contact_1_condition_hasCompletedQuestOne(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedQuest(player, "ep3_clone_relics_boba_fett_1"));
    }
    public boolean ep3_clone_relics_boba_fett_contact_1_condition_onSpaceMission(obj_id player, obj_id npc)
    {
        return (space_quest.hasQuest(player, "recovery", "ep3_clone_relics_boba_fett_2"));
    }
    public boolean ep3_clone_relics_boba_fett_contact_1_condition_hasCompletedQuestThree(obj_id player, obj_id npc)
    {
        return (space_quest.hasWonQuest(player, "destroy_surpriseattack", "ep3_clone_relics_boba_fett_3"));
    }
    public boolean ep3_clone_relics_boba_fett_contact_1_condition_onQuestOne(obj_id player, obj_id npc)
    {
        return (groundquests.isQuestActive(player, "ep3_clone_relics_boba_fett_1"));
    }
    public void ep3_clone_relics_boba_fett_contact_1_action_giveDeliverySignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "deliveredPackage");
    }
    public void ep3_clone_relics_boba_fett_contact_1_action_grantSpaceMissionRecovery(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "recovery", "ep3_clone_relics_boba_fett_2");
    }
    public int ep3_clone_relics_boba_fett_contact_1_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_boba_fett_contact_1_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_boba_fett_contact_1_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_boba_fett_contact_1_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_boba_fett_contact_1_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_boba_fett_contact_1_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_boba_fett_contact_1_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_boba_fett_contact_1_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_boba_fett_contact_1_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_boba_fett_contact_1_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_boba_fett_contact_1_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
