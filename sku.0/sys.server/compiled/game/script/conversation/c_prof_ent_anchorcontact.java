...
public class c_prof_ent_anchorcontact extends script.base_script
{
    ...
    public boolean c_prof_ent_anchorcontact_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_prof_ent_anchorcontact_condition_playeronquest(obj_id player, obj_id npc)
    {
    ...
    public void c_prof_ent_anchorcontact_action_faceandmood(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        ai_lib.setMood(npc, chat.MOOD_SCARED);
    }
    public void c_prof_ent_anchorcontact_action_forwardquest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "c_prof_ent_anchor");
    }
    public int c_prof_ent_anchorcontact_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_prof_ent_anchorcontact_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_prof_ent_anchorcontact_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
