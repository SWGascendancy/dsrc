...
public class talus_nashal_lika extends script.base_script
{
    ...
    public boolean talus_nashal_lika_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean talus_nashal_lika_condition_completeGather(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "talus_nashal_gather_missing");
    }
    public boolean talus_nashal_lika_condition_onGather(obj_id player, obj_id npc)
    {
    ...
    public boolean talus_nashal_lika_condition_onGatherMissions(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "talus_nashal_find_weakness", "selonian_gather_missions");
    }
    public boolean talus_nashal_lika_condition_onReturnLika(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "talus_nashal_gather_missing", "selonian_return_lika");
    }
    public void talus_nashal_lika_action_grantGather(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "talus_nashal_gather_missing");
    }
    public void talus_nashal_lika_action_signalCompleteGather(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "selonian_return_lika");
    }
    public int talus_nashal_lika_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_lika_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_lika_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_lika_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
