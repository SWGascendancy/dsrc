...
public class ig88_bothan_02 extends script.base_script
{
    ...
    public boolean ig88_bothan_02_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ig88_bothan_02_condition_finishedQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "feeder_ig88_02");
    }
    public boolean ig88_bothan_02_condition_onQuest(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "feeder_ig88_01", "feeder_ig88_wait_02");
    }
    public boolean ig88_bothan_02_condition_needsQuest(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "feeder_ig88_01", "feeder_singal_ig88_04");
    }
    public boolean ig88_bothan_02_condition_endQuest(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "feeder_ig88_02", "feeder_ig88_02_signal_02");
    }
    public boolean ig88_bothan_02_condition_onTask(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "feeder_ig88_02", "feeder_ig88_02_wait_01");
    }
    public void ig88_bothan_02_action_grantQuest02(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "feeder_ig88_02");
        groundquests.sendSignal(player, "feeder_signal_ig88_01_04");
    }
    public void ig88_bothan_02_action_completeQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "feeder_signal_ig88_02_02");
    }
    public int ig88_bothan_02_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ig88_bothan_02_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ig88_bothan_02_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ig88_bothan_02_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ig88_bothan_02_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ig88_bothan_02_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ig88_bothan_02_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
