...
public class ep3_trandoshan_olima_grunc extends script.base_script
{
    ...
    public boolean ep3_trandoshan_olima_grunc_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_trandoshan_olima_grunc_condition_hasCompletedQuest01(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_trando_olima_grunc");
    }
    public boolean ep3_trandoshan_olima_grunc_condition_isOnQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_trando_olima_grunc");
    }
    public boolean ep3_trandoshan_olima_grunc_condition_hasCompletedTask01(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_trando_olima_grunc", "killedUller");
    }
    public void ep3_trandoshan_olima_grunc_action_giveQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_trando_olima_grunc");
    }
    public void ep3_trandoshan_olima_grunc_action_doSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "rewardOlima");
    }
    public void ep3_trandoshan_olima_grunc_action_removeQuest(obj_id player, obj_id npc)
    {
        groundquests.clearQuest(player, "ep3_trando_olima_grunc");
    }
    public int ep3_trandoshan_olima_grunc_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_olima_grunc_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_olima_grunc_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_olima_grunc_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_olima_grunc_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_olima_grunc_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_olima_grunc_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_olima_grunc_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_olima_grunc_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_olima_grunc_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_olima_grunc_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
