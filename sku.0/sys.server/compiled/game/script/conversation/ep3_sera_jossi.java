...
public class ep3_sera_jossi extends script.base_script
{
    ...
    public boolean ep3_sera_jossi_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_sera_jossi_condition_hasCompletedInitialQuests(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_sera_jossi_condition_hasCompleted10WookieeTeeth(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_sera_10_wookiee_teeth") && !groundquests.hasCompletedQuest(player, "ep3_sera_wrhisch_liver");
    }
    public boolean ep3_sera_jossi_condition_isOnMyQuests(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_sera_jossi_condition_isRroowDeliveryActive(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_rroow_sera_package_deliver");
    }
    public void ep3_sera_jossi_action_GrantKill10Wookiee(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_sera_10_wookiee_teeth");
    }
    public void ep3_sera_jossi_action_GrantCollectWrhischLiver(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_sera_wrhisch_liver");
    }
    public void ep3_sera_jossi_action_sendDeliverComplete(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "signalRroowSeraDeliver");
    }
    public int ep3_sera_jossi_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_sera_jossi_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_sera_jossi_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_sera_jossi_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_sera_jossi_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_sera_jossi_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_sera_jossi_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_sera_jossi_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_sera_jossi_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_sera_jossi_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_sera_jossi_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_sera_jossi_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_sera_jossi_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_sera_jossi_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_sera_jossi_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_sera_jossi_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_sera_jossi_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_sera_jossi_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
