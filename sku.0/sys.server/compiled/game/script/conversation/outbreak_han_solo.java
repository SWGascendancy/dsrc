...
public class outbreak_han_solo extends script.base_script
{
    ...
    public boolean outbreak_han_solo_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean outbreak_han_solo_condition_hasNotStartedQuestLine(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean outbreak_han_solo_condition_hasFirstQuestImperial(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isQuestActive(player, "outbreak_quest_01_rebel");
    }
    public boolean outbreak_han_solo_condition_hasSecondQuestImperial(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isQuestActive(player, "outbreak_quest_02_rebel");
    }
    public boolean outbreak_han_solo_condition_hasFoundStormtroopers(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.hasCompletedQuest(player, "outbreak_quest_02_rebel");
    }
    public boolean outbreak_han_solo_condition_hasCompletedMissions(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "outbreak_quest_facility_05_rebel", "speakPietteDebrief");
    }
    public boolean outbreak_han_solo_condition_hasCompletedAll(obj_id player, obj_id npc)
    {
    ...
    public boolean outbreak_han_solo_condition_isLiveConversation(obj_id player, obj_id npc)
    {
    ...
    public boolean outbreak_han_solo_condition_isPlayerImperial(obj_id player, obj_id npc)
    {
        return outbreak_han_solo_condition_isLiveConversation(player, npc) && factions.isImperial(player);
    }
    public boolean outbreak_han_solo_condition_isPlayerNeutral(obj_id player, obj_id npc)
    {
        return outbreak_han_solo_condition_isLiveConversation(player, npc) && !factions.isImperial(player) && !factions.isRebel(player);
    }
    public boolean outbreak_han_solo_condition_hasDeletedLiveConversion(obj_id player, obj_id npc)
    {
    ...
    public void outbreak_han_solo_action_grantMissionOne(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        groundquests.grantQuest(player, "quest/outbreak_quest_01_rebel");
        outbreak_han_solo_action_makeChewieGoodLuck(player, npc);
    }
    public void outbreak_han_solo_action_completeQuest5(obj_id player, obj_id npc)
    {
    ...
    public void outbreak_han_solo_action_makeChewieSayRight(obj_id player, obj_id npc)
    {
    ...
    public void outbreak_han_solo_action_makeChewieCheer(obj_id player, obj_id npc)
    {
        if (!hasObjVar(npc, "myChewie"))
        {
            CustomerServiceLog("outbreak_themepark", "outbreak_han_solo conversation: Han has no Chewie objvar. Self: " + npc);
    ...
    public void outbreak_han_solo_action_makeChewieImplore(obj_id player, obj_id npc)
    {
        if (!hasObjVar(npc, "myChewie"))
        {
            CustomerServiceLog("outbreak_themepark", "outbreak_han_solo conversation: Han has no Chewie objvar. Self: " + npc);
    ...
    public void outbreak_han_solo_action_makeChewieGoodLuck(obj_id player, obj_id npc)
    {
        if (!hasObjVar(npc, "myChewie"))
        {
            CustomerServiceLog("outbreak_themepark", "outbreak_han_solo conversation: Han has no Chewie objvar. Self: " + npc);
    ...
    public void outbreak_han_solo_action_makeChewieCheer2(obj_id player, obj_id npc)
    {
        if (!hasObjVar(npc, "myChewie"))
        {
            CustomerServiceLog("outbreak_themepark", "outbreak_han_solo conversation: Han has no Chewie objvar. Self: " + npc);
    ...
    public void outbreak_han_solo_action_makeChewieSalute(obj_id player, obj_id npc)
    {
        if (!hasObjVar(npc, "myChewie"))
        {
            CustomerServiceLog("outbreak_themepark", "outbreak_han_solo conversation: Han has no Chewie objvar. Self: " + npc);
    ...
    public void outbreak_han_solo_action_makeChewieWave(obj_id player, obj_id npc)
    {
        if (!hasObjVar(npc, "myChewie"))
        {
            CustomerServiceLog("outbreak_themepark", "outbreak_han_solo conversation: Han has no Chewie objvar. Self: " + npc);
    ...
    public void outbreak_han_solo_action_makeChewieDirect(obj_id player, obj_id npc)
    {
        if (!hasObjVar(npc, "myChewie"))
        {
            CustomerServiceLog("outbreak_themepark", "outbreak_han_solo conversation: Han has no Chewie objvar. Self: " + npc);
    ...
    public void outbreak_han_solo_action_clearLiveConversion(obj_id player, obj_id npc)
    {
    ...
    public void outbreak_han_solo_action_revokeRebGrantNeu(obj_id player, obj_id npc)
    {
    ...
    public void outbreak_han_solo_action_revokeRebGrantImp(obj_id player, obj_id npc)
    {
        if (groundquests.isQuestActiveOrComplete(player, "outbreak_live_conversion_rebel"))
        {
            groundquests.clearQuest(player, "outbreak_live_conversion_rebel");
    ...
    public void outbreak_han_solo_action_revokeEntireRebQuestLine(obj_id player, obj_id npc)
    {
        holiday.removeAllCompletedQuestsForDeathTroopers(player);
    }
    public void outbreak_han_solo_action_grantRebQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "outbreak_switch_to_rebel");
    }
    public void outbreak_han_solo_action_grantImpQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "outbreak_switch_to_imperial");
    }
    public void outbreak_han_solo_action_grantNeutQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "outbreak_switch_to_neutral");
    }
    public int outbreak_han_solo_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_han_solo_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_han_solo_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_han_solo_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_han_solo_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_han_solo_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_han_solo_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_han_solo_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_han_solo_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_han_solo_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_han_solo_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_han_solo_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_han_solo_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_han_solo_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_han_solo_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_han_solo_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_49"))
        {
            if (outbreak_han_solo_condition__defaultCondition(player, npc))
    ...
    public int outbreak_han_solo_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_49"))
        {
            if (outbreak_han_solo_condition__defaultCondition(player, npc))
    ...
    public int outbreak_han_solo_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_han_solo_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_han_solo_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_han_solo_handleBranch30(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_han_solo_handleBranch31(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_han_solo_handleBranch32(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_han_solo_handleBranch33(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_han_solo_handleBranch34(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_han_solo_handleBranch35(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_han_solo_handleBranch36(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_han_solo_handleBranch37(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_han_solo_handleBranch38(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_han_solo_handleBranch39(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_han_solo_handleBranch40(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_han_solo_handleBranch41(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_han_solo_handleBranch42(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_han_solo_handleBranch43(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_han_solo_handleBranch44(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_147"))
        {
            if (outbreak_han_solo_condition__defaultCondition(player, npc))
    ...
    public int outbreak_han_solo_handleBranch45(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_147"))
        {
            if (outbreak_han_solo_condition__defaultCondition(player, npc))
    ...
    public int outbreak_han_solo_handleBranch47(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int findChewie(obj_id self, dictionary params)
    {
