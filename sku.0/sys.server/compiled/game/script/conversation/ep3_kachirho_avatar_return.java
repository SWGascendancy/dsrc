...
public class ep3_kachirho_avatar_return extends script.base_script
{
    ...
    public boolean ep3_kachirho_avatar_return_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_kachirho_avatar_return_condition_isOnMission(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_avatar_return");
    }
    public boolean ep3_kachirho_avatar_return_condition_isTaskCompleted01(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_avatar_return", "returnToValmont");
    }
    public boolean ep3_kachirho_avatar_return_condition_hasDestroyedAvatar(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_trando_hssissk_zssik_10");
    }
    public boolean ep3_kachirho_avatar_return_condition_hasCollectedStuff(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_avatar_return");
    }
    public void ep3_kachirho_avatar_return_action_grantMission(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_avatar_return");
    }
    public void ep3_kachirho_avatar_return_action_sendSignal01(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "rewardValmont");
    }
    public void ep3_kachirho_avatar_return_action_clearMission(obj_id player, obj_id npc)
    {
        groundquests.clearQuest(player, "ep3_avatar_return");
    }
    public int ep3_kachirho_avatar_return_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_avatar_return_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_avatar_return_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_avatar_return_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_avatar_return_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_avatar_return_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_avatar_return_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
