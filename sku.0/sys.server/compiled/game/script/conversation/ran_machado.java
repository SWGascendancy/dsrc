...
public class ran_machado extends script.base_script
{
    ...
    public boolean ran_machado_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ran_machado_condition_isElligibleFirstTime(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return !groundquests.isQuestActiveOrComplete(player, "u16_nym_themepark_weed_pulling_ver2");
    }
    public boolean ran_machado_condition_hasCompletedReq(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "u16_nym_themepark_weed_pulling_ver2", "returnForPay");
    }
    public boolean ran_machado_condition_isElligibleSecondTime(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean ran_machado_condition_hasQuestActive(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isQuestActive(player, "u16_nym_themepark_weed_pulling_ver2");
    }
    public boolean ran_machado_condition_hasFailQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "u16_nym_themepark_weed_pulling_fail");
    }
    public void ran_machado_action_giveQuest(obj_id player, obj_id npc)
    {
    ...
    public void ran_machado_action_rewardPlayer(obj_id player, obj_id npc)
    {
    ...
    public void ran_machado_action_clearFail(obj_id player, obj_id npc)
    {
        groundquests.clearQuest(player, "u16_nym_themepark_weed_pulling_fail");
    }
    public int ran_machado_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ran_machado_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ran_machado_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ran_machado_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ran_machado_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ran_machado_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
