...
public class corellia_coronet_the_informant extends script.base_script
{
    ...
    public boolean corellia_coronet_the_informant_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_coronet_the_informant_condition_theInformantQuest(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_coronet_capitol_problems_the_informant", "the_informant_1");
    }
    public void corellia_coronet_the_informant_action_theInformantQuestMovesOn(obj_id player, obj_id npc)
    {
