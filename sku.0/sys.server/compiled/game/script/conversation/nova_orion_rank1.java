...
public class nova_orion_rank1 extends script.base_script
{
    ...
    public boolean nova_orion_rank1_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean nova_orion_rank1_condition_onQuest_01(obj_id player, obj_id npc)
    {
    ...
    public boolean nova_orion_rank1_condition_returnWin_01(obj_id player, obj_id npc)
    {
    ...
    public boolean nova_orion_rank1_condition_onQuest_02(obj_id player, obj_id npc)
    {
        return (groundquests.isQuestActive(player, "nova_orion_rank1_02") && !groundquests.isTaskActive(player, "nova_orion_rank1_02", "wait"));
    }
    public boolean nova_orion_rank1_condition_returnWin_02(obj_id player, obj_id npc)
    {
    ...
    public boolean nova_orion_rank1_condition_onQuest_03(obj_id player, obj_id npc)
    {
        return (groundquests.isQuestActive(player, "nova_orion_rank1_03") && !groundquests.isTaskActive(player, "nova_orion_rank1_02", "wait"));
    }
    public boolean nova_orion_rank1_condition_returnWin_03(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "nova_orion_rank1_03", "wait");
    }
    public boolean nova_orion_rank1_condition_finishedAll(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "nova_orion_rank1_03");
    }
    public boolean nova_orion_rank1_condition_isRank1(obj_id player, obj_id npc)
    {
        return hasCompletedCollectionSlot(player, "nova_orion_rank_01");
    }
    public void nova_orion_rank1_action_grantQuest_01(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "nova_orion_rank1_01");
    }
    public void nova_orion_rank1_action_clearAndRegrant_01(obj_id player, obj_id npc)
    {
        groundquests.clearQuest(player, "nova_orion_rank1_01");
        space_quest.clearQuestFlags(player, "delivery", "nova_orion_rank1_01");
        groundquests.grantQuest(player, "nova_orion_rank1_01");
    }
    public void nova_orion_rank1_action_sendFinishSignal_01(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "nova_orion_rank1_01");
    }
    public void nova_orion_rank1_action_grantQuest_02(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "nova_orion_rank1_02");
    }
    public void nova_orion_rank1_action_clearAndRegrant_02(obj_id player, obj_id npc)
    {
    ...
    public void nova_orion_rank1_action_grantQuest_03(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "nova_orion_rank1_03");
    }
    public void nova_orion_rank1_action_clearAndRegrant_03(obj_id player, obj_id npc)
    {
    ...
    public void nova_orion_rank1_action_sendFinishSignal_02(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "nova_orion_rank1_02");
    }
    public void nova_orion_rank1_action_sendFinishSignal_03(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "nova_orion_rank1_03");
    }
    public int nova_orion_rank1_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nova_orion_rank1_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nova_orion_rank1_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nova_orion_rank1_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nova_orion_rank1_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nova_orion_rank1_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nova_orion_rank1_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nova_orion_rank1_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nova_orion_rank1_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nova_orion_rank1_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
