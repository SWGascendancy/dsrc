...
public class maneater_ulon extends script.base_script
{
    ...
    public boolean maneater_ulon_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean maneater_ulon_condition_isOnTask(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "som_maneater");
    }
    public boolean maneater_ulon_condition_failedEncounter(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "som_maneater", "mustafar_maneater_four");
    }
    public boolean maneater_ulon_condition_wonTask(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "som_maneater", "mustafar_maneater_five");
    }
    public boolean maneater_ulon_condition_hasWonMission(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "som_maneater");
    }
    public void maneater_ulon_action_startMission(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "som_maneater");
    }
    public void maneater_ulon_action_clearMission(obj_id player, obj_id npc)
    {
        groundquests.clearQuest(player, "som_maneater");
    }
    public void maneater_ulon_action_rewardTime(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "mustafar_maneater_reward");
    }
    public int maneater_ulon_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int maneater_ulon_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int maneater_ulon_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
