...
public class bounty_check_reset extends script.base_script
{
    ...
    public boolean bounty_check_reset_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean bounty_check_reset_condition_bountyHunter(obj_id player, obj_id npc)
    {
        return utils.isProfession(player, utils.BOUNTY_HUNTER);
    }
    public boolean bounty_check_reset_condition_completedCollection(obj_id player, obj_id npc)
    {
        return hasCompletedCollection(player, "bounty_check_kill");
    }
    public void bounty_check_reset_action_resetCollection(obj_id player, obj_id npc)
    {
        collection.removeCompletedCollection(player, "bounty_check_kill");
    }
    public int bounty_check_reset_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int bounty_check_reset_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int bounty_check_reset_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int bounty_check_reset_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
