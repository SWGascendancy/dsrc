...
public class corellia_tyrena_dulor extends script.base_script
{
    ...
    public boolean corellia_tyrena_dulor_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_tyrena_dulor_condition_onTalkDulor(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_tyrena_petty_resolve", "petty_ask_akers");
    }
    public boolean corellia_tyrena_dulor_condition_afterTalkDulor(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "corellia_tyrena_petty_resolve", "petty_ask_akers");
    }
    public void corellia_tyrena_dulor_action_signalDulor(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "petty_ask_akers");
    }
    public int corellia_tyrena_dulor_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_dulor_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_dulor_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_dulor_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
