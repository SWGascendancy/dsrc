...
public class ep3_seljin_kuric extends script.base_script
{
    ...
    public boolean ep3_seljin_kuric_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_seljin_kuric_condition_hasWonZhailautRadio(obj_id player, obj_id npc)
    {
