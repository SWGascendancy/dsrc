...
public class corellia_cb_sinis extends script.base_script
{
    ...
    public boolean corellia_cb_sinis_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_cb_sinis_condition_offerQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_cb_sinis_condition_rewardStage(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_cb_sinis_condition_questActive(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_cb_sinis_condition_onSecondQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_cb_sinis_condition_offerPart2(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_cb_sinis_condition_questCompleted(obj_id player, obj_id npc)
    {
    ...
    public void corellia_cb_sinis_action_sendPointerSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "cb_pointer_sinis");
        return;
    }
    public void corellia_cb_sinis_action_grantMainQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest/corellia_cb_1");
        return;
    }
    public void corellia_cb_sinis_action_sendFinishSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "cb_1_sinis_complete");
        return;
    }
    public void corellia_cb_sinis_action_grantSecondQuestPointer(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest/corellia_cb_2_pointer");
        return;
    }
    public int corellia_cb_sinis_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_cb_sinis_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_cb_sinis_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_cb_sinis_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_cb_sinis_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_cb_sinis_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_48"))
        {
            corellia_cb_sinis_action_grantSecondQuestPointer(player, npc);
