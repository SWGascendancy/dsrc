...
public class restuss_rebel_space_destroy extends script.base_script
{
    ...
    public boolean restuss_rebel_space_destroy_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean restuss_rebel_space_destroy_condition_completedKill1(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "restuss_rebel_space_destroy_1", "returnGrollo");
    }
    public boolean restuss_rebel_space_destroy_condition_killActive1(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "restuss_rebel_space_destroy_1");
    }
    public boolean restuss_rebel_space_destroy_condition_completedKill2(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "restuss_rebel_space_destroy_2", "returnGrollo2");
    }
    public boolean restuss_rebel_space_destroy_condition_killActive2(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "restuss_rebel_space_destroy_2");
    }
    public boolean restuss_rebel_space_destroy_condition_inPhase2(obj_id player, obj_id npc)
    {
    ...
    public boolean restuss_rebel_space_destroy_condition_inPhase1(obj_id player, obj_id npc)
    {
    ...
    public boolean restuss_rebel_space_destroy_condition_enoughKills(obj_id player, obj_id npc)
    {
        obj_id object = trial.getParent(npc);
    ...
    public boolean restuss_rebel_space_destroy_condition_isRSFPilot(obj_id player, obj_id npc)
    {
        return space_flags.isSpaceTrack(player, space_flags.PRIVATEER_NABOO);
    }
    public boolean restuss_rebel_space_destroy_condition_isFailedTwo(obj_id player, obj_id npc)
    {
    ...
    public boolean restuss_rebel_space_destroy_condition_isFailedOne(obj_id player, obj_id npc)
    {
    ...
    public boolean restuss_rebel_space_destroy_condition_isImperialPlayer(obj_id player, obj_id npc)
    {
        return factions.isImperial(player);
    }
    public void restuss_rebel_space_destroy_action_givekill1(obj_id player, obj_id npc)
    {
    ...
    public void restuss_rebel_space_destroy_action_signalDone(obj_id player, obj_id npc)
    {
    ...
    public void restuss_rebel_space_destroy_action_givekill2(obj_id player, obj_id npc)
    {
    ...
    public void restuss_rebel_space_destroy_action_signalDone2(obj_id player, obj_id npc)
    {
    ...
    public void restuss_rebel_space_destroy_action_eject(obj_id player, obj_id npc)
    {
        expelFromBuilding(player);
    }
    public int restuss_rebel_space_destroy_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int restuss_rebel_space_destroy_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int restuss_rebel_space_destroy_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int restuss_rebel_space_destroy_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_30"))
        {
            doAnimationAction(player, "salute1");
    ...
    public int restuss_rebel_space_destroy_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_27"))
        {
            doAnimationAction(player, "salute1");
