...
public class corellia_disappearances_questgiver extends script.base_script
{
    ...
    public boolean corellia_disappearances_questgiver_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_disappearances_questgiver_condition_playerCompletedInitialStep(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "corellia_disappearances_1_discovery");
    }
    public boolean corellia_disappearances_questgiver_condition_playerOnAngelaStep(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_disappearances_1_discovery", "disappear_1_angela");
    }
    public boolean corellia_disappearances_questgiver_condition_playerDeletedQ2(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_disappearances_questgiver_condition_playerDeletedQ3(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_disappearances_questgiver_condition_finishedAll(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "corellia_disappearances_6_boss");
    }
    public boolean corellia_disappearances_questgiver_condition_playerDeletedQ4(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_disappearances_questgiver_condition_playerDeletedQ5(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_disappearances_questgiver_condition_playerDeletedQ6(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_disappearances_questgiver_condition_playerOnFinalStep(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_disappearances_6_boss", "returntotalte");
    }
    public void corellia_disappearances_questgiver_action_giveFirstQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "corellia_disappearances_1_discovery");
    }
    public void corellia_disappearances_questgiver_action_giveSecondQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "corellia_disappearances_2_hermit");
    }
    public void corellia_disappearances_questgiver_action_giveThirdQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "corellia_disappearances_3_trial");
    }
    public void corellia_disappearances_questgiver_action_giveFourthQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "corellia_disappearances_4_cave");
    }
    public void corellia_disappearances_questgiver_action_signalThirdQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "corellia_disappearances_3_talte");
    }
    public void corellia_disappearances_questgiver_action_giveFifthQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "corellia_disappearances_5_rescue");
    }
    public void corellia_disappearances_questgiver_action_giveSixthQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "corellia_disappearances_6_boss");
    }
    public void corellia_disappearances_questgiver_action_signalSixthQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "disappear_complete_quest");
    }
    public void corellia_disappearances_questgiver_action_signalgoto(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talktotalte");
    }
    public int corellia_disappearances_questgiver_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_disappearances_questgiver_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_disappearances_questgiver_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_disappearances_questgiver_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
