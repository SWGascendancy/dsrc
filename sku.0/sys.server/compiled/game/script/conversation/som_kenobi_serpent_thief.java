...
public class som_kenobi_serpent_thief extends script.base_script
{
    ...
    public boolean som_kenobi_serpent_thief_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean som_kenobi_serpent_thief_condition_playerJedi(obj_id player, obj_id npc)
    {
        return jedi.isForceSensitive(player);
    }
    public boolean som_kenobi_serpent_thief_condition_thief(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "som_kenobi_serpent_shard_1", "talkThief");
    }
    public void som_kenobi_serpent_thief_action_talked(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedThief");
        setInvulnerable(npc, false);
    }
    public void som_kenobi_serpent_thief_action_attack(obj_id player, obj_id npc)
    {
        startCombat(npc, player);
        clearCondition(npc, CONDITION_CONVERSABLE);
    }
    public int som_kenobi_serpent_thief_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_serpent_thief_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_serpent_thief_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_serpent_thief_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_serpent_thief_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_serpent_thief_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_serpent_thief_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_serpent_thief_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_serpent_thief_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_serpent_thief_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_serpent_thief_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_serpent_thief_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_serpent_thief_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_serpent_thief_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_serpent_thief_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
