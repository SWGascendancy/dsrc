...
public class tutorial_imperial_broker extends script.base_script
{
    ...
    public boolean tutorial_imperial_broker_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tutorial_imperial_broker_condition_isImperialFaction(obj_id player, obj_id npc)
    {
    ...
    public boolean tutorial_imperial_broker_condition_isMaleImperialFaction(obj_id player, obj_id npc)
    {
        return (tutorial_imperial_broker_condition_isImperialFaction(player, npc) && (getGender(player) == GENDER_MALE));
    }
    public boolean tutorial_imperial_broker_condition_isMalePlayer(obj_id player, obj_id npc)
    {
        return (getGender(player) == GENDER_MALE);
    }
    public boolean tutorial_imperial_broker_condition_justSpokeToPlayer(obj_id player, obj_id npc)
    {
        return (utils.hasScriptVar(player, "justTalkedToImpBroker"));
    }
    public boolean tutorial_imperial_broker_condition_justSpokeToMalePlayer(obj_id player, obj_id npc)
    {
    ...
    public boolean tutorial_imperial_broker_condition_isRebelFaction(obj_id player, obj_id npc)
    {
        String factionName = factions.getFaction(player);
        if (factionName == null || factionName.equals(""))
        {
    ...
    public boolean tutorial_imperial_broker_condition_isWookieePlayer(obj_id player, obj_id npc)
    {
        return (getSpecies(player) == SPECIES_WOOKIEE);
    }
    public boolean tutorial_imperial_broker_condition_wasDismissedRebel(obj_id player, obj_id npc)
    {
        return (utils.getIntScriptVar(player, "brokerDismissed") == 3);
    }
    public boolean tutorial_imperial_broker_condition_wasDismissedWookiee(obj_id player, obj_id npc)
    {
        return (utils.getIntScriptVar(player, "brokerDismissed") == 2);
    }
    public boolean tutorial_imperial_broker_condition_wasDismissedWoman(obj_id player, obj_id npc)
    {
        return (utils.getIntScriptVar(player, "brokerDismissed") == 1);
    }
    public boolean tutorial_imperial_broker_condition_isImperialPilot(obj_id player, obj_id npc)
    {
        return space_skill.hasImperialSkill(player);
    }
    public boolean tutorial_imperial_broker_condition_isPilot(obj_id player, obj_id npc)
    {
        return space_skill.hasSpaceSkills(player);
    }
    public boolean tutorial_imperial_broker_condition_hasSpace(obj_id player, obj_id npc)
    {
        return true;
    }
    public void tutorial_imperial_broker_action_addCorelliaImpWaypoint(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "justTalkedToImpBroker", true);
        trainerlocs.getTrainerLocationWaypoint(player, "imperial", "corellia");
    }
    public void tutorial_imperial_broker_action_addTatooineImpWaypoint(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "justTalkedToImpBroker", true);
        trainerlocs.getTrainerLocationWaypoint(player, "imperial", "tatooine");
    }
    public void tutorial_imperial_broker_action_addNabooImpWaypoint(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "justTalkedToImpBroker", true);
        trainerlocs.getTrainerLocationWaypoint(player, "imperial", "naboo");
    }
    public void tutorial_imperial_broker_action_dismissWoman(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "brokerDismissed", 1);
    }
    public void tutorial_imperial_broker_action_dismissWookiee(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "brokerDismissed", 2);
    }
    public void tutorial_imperial_broker_action_dismissRebel(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "brokerDismissed", 3);
    }
    public void tutorial_imperial_broker_action_retireImperial(obj_id player, obj_id npc)
    {
        space_skill.retire(player, space_skill.IMPERIAL);
    }
    public int tutorial_imperial_broker_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tutorial_imperial_broker_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tutorial_imperial_broker_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tutorial_imperial_broker_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_1b2086de"))
        {
            if (tutorial_imperial_broker_condition__defaultCondition(player, npc))
    ...
    public int tutorial_imperial_broker_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tutorial_imperial_broker_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tutorial_imperial_broker_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_1b2086de"))
        {
            if (tutorial_imperial_broker_condition__defaultCondition(player, npc))
    ...
    public int tutorial_imperial_broker_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tutorial_imperial_broker_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_1b2086de"))
        {
            if (tutorial_imperial_broker_condition__defaultCondition(player, npc))
    ...
    public int tutorial_imperial_broker_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_70f18874"))
        {
            if (tutorial_imperial_broker_condition__defaultCondition(player, npc))
    ...
    public int tutorial_imperial_broker_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_1b2086de"))
        {
            if (tutorial_imperial_broker_condition__defaultCondition(player, npc))
    ...
    public int tutorial_imperial_broker_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_70f18874"))
        {
            if (tutorial_imperial_broker_condition__defaultCondition(player, npc))
    ...
    public int tutorial_imperial_broker_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_1b2086de"))
        {
            if (tutorial_imperial_broker_condition__defaultCondition(player, npc))
    ...
    public int tutorial_imperial_broker_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_4b0c16d2"))
        {
            if (tutorial_imperial_broker_condition__defaultCondition(player, npc))
    ...
    public int tutorial_imperial_broker_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_8ed93c34"))
        {
            if (tutorial_imperial_broker_condition__defaultCondition(player, npc))
    ...
    public int tutorial_imperial_broker_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_1b2086de"))
        {
            if (tutorial_imperial_broker_condition__defaultCondition(player, npc))
    ...
    public int tutorial_imperial_broker_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_70f18874"))
        {
            if (tutorial_imperial_broker_condition__defaultCondition(player, npc))
    ...
    public int tutorial_imperial_broker_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_1b2086de"))
        {
            if (tutorial_imperial_broker_condition__defaultCondition(player, npc))
    ...
    public int tutorial_imperial_broker_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_70f18874"))
        {
            if (tutorial_imperial_broker_condition__defaultCondition(player, npc))
    ...
    public int tutorial_imperial_broker_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_1b2086de"))
        {
            if (tutorial_imperial_broker_condition__defaultCondition(player, npc))
    ...
    public int tutorial_imperial_broker_handleBranch31(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_70f18874"))
        {
            if (tutorial_imperial_broker_condition__defaultCondition(player, npc))
    ...
    public int tutorial_imperial_broker_handleBranch32(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_1b2086de"))
        {
            if (tutorial_imperial_broker_condition__defaultCondition(player, npc))
    ...
    public int tutorial_imperial_broker_handleBranch35(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tutorial_imperial_broker_handleBranch36(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tutorial_imperial_broker_handleBranch37(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_70f18874"))
        {
            if (tutorial_imperial_broker_condition__defaultCondition(player, npc))
    ...
    public int tutorial_imperial_broker_handleBranch38(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_ee369d68"))
        {
            if (tutorial_imperial_broker_condition__defaultCondition(player, npc))
    ...
    public int tutorial_imperial_broker_handleBranch39(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tutorial_imperial_broker_handleBranch41(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_70f18874"))
        {
            if (tutorial_imperial_broker_condition__defaultCondition(player, npc))
    ...
    public int tutorial_imperial_broker_handleBranch42(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_1b2086de"))
        {
            if (tutorial_imperial_broker_condition__defaultCondition(player, npc))
    ...
    public int tutorial_imperial_broker_handleBranch43(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_987445c9"))
        {
            doAnimationAction(player, "salute2");
    ...
    public int tutorial_imperial_broker_handleBranch45(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_70f18874"))
        {
            if (tutorial_imperial_broker_condition__defaultCondition(player, npc))
    ...
    public int tutorial_imperial_broker_handleBranch46(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_1b2086de"))
        {
            if (tutorial_imperial_broker_condition__defaultCondition(player, npc))
    ...
    public int tutorial_imperial_broker_handleBranch47(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_987445c9"))
        {
            doAnimationAction(player, "salute2");
