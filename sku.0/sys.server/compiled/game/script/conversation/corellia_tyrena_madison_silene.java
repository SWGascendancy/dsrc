...
public class corellia_tyrena_madison_silene extends script.base_script
{
    ...
    public boolean corellia_tyrena_madison_silene_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_tyrena_madison_silene_condition_startSlaverArc(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_tyrena_madison_silene_condition_completedMissingPersons(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "corellia_tyrena_missing_persons");
    }
    public boolean corellia_tyrena_madison_silene_condition_completedSlaverArc(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "corellia_tyrena_slaver_access");
    }
    public boolean corellia_tyrena_madison_silene_condition_onMissingPersons(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "corellia_tyrena_missing_persons");
    }
    public void corellia_tyrena_madison_silene_action_grantMissingPersons(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "corellia_tyrena_missing_persons");
    }
    public void corellia_tyrena_madison_silene_action_grantSlaverAccess(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "corellia_tyrena_slaver_access");
    }
    public void corellia_tyrena_madison_silene_action_signalMeetMadison(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "meet_madison");
    }
    public int corellia_tyrena_madison_silene_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_madison_silene_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_madison_silene_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_madison_silene_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_madison_silene_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_madison_silene_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
