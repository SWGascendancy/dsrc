...
public class quest_u10_lucien_bender extends script.base_script
{
    ...
    public boolean quest_u10_lucien_bender_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean quest_u10_lucien_bender_condition_isInGodMode(obj_id player, obj_id npc)
    {
        return isGod(player);
    }
    public boolean quest_u10_lucien_bender_condition_quest_u10_02_03b_active(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "quest_u10_02", "quest_u10_02_03b");
    }
    public void quest_u10_lucien_bender_action_attack(obj_id player, obj_id npc)
    {
    ...
    public void quest_u10_lucien_bender_action_makeVulnerable(obj_id player, obj_id npc)
    {
        setInvulnerable(npc, false);
        clearCondition(npc, CONDITION_CONVERSABLE);
        if (hasScript(npc, "conversation.quest_u10_lucien_bender"))
    ...
    public int quest_u10_lucien_bender_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_u10_lucien_bender_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_u10_lucien_bender_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
