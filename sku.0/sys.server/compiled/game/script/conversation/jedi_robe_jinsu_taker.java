...
public class jedi_robe_jinsu_taker extends script.base_script
{
    ...
    public boolean jedi_robe_jinsu_taker_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean jedi_robe_jinsu_taker_condition_readyToHandOverJinsu(obj_id player, obj_id npc)
    {
    ...
    public boolean jedi_robe_jinsu_taker_condition_alreadyGaveJinsu(obj_id player, obj_id npc)
    {
        return hasCompletedCollectionSlot(player, "col_lightsaber_1h_01_02");
    }
    public boolean jedi_robe_jinsu_taker_condition_takeJinsu(obj_id player, obj_id npc)
    {
    ...
    public boolean jedi_robe_jinsu_taker_condition_canReceive5GenPvP(obj_id player, obj_id npc)
    {
    ...
    public boolean jedi_robe_jinsu_taker_condition_canTrade1Hand(obj_id player, obj_id npc)
    {
        return isIdValid(utils.getStaticItemInInventory(player, "item_schematic_pvp_bf_saber_03_01"));
    }
    public boolean jedi_robe_jinsu_taker_condition_canTrade2Hand(obj_id player, obj_id npc)
    {
        return isIdValid(utils.getStaticItemInInventory(player, "item_schematic_pvp_bf_saber_03_02"));
    }
    public boolean jedi_robe_jinsu_taker_condition_canTradeStaff(obj_id player, obj_id npc)
    {
        return isIdValid(utils.getStaticItemInInventory(player, "item_schematic_pvp_bf_saber_03_03"));
    }
    public boolean jedi_robe_jinsu_taker_condition_canReceive5thGenSaber(obj_id player, obj_id npc)
    {
    ...
    public boolean jedi_robe_jinsu_taker_condition_canReceive5GenGCW(obj_id player, obj_id npc)
    {
    ...
    public boolean jedi_robe_jinsu_taker_condition_canTradeGcw1Hand(obj_id player, obj_id npc)
    {
        return isIdValid(utils.getStaticItemInInventory(player, "item_schematic_pvp_gcw_saber_1h_gen4"));
    }
    public boolean jedi_robe_jinsu_taker_condition_canTradeGcw2Hand(obj_id player, obj_id npc)
    {
        return isIdValid(utils.getStaticItemInInventory(player, "item_schematic_pvp_gcw_saber_2h_gen4"));
    }
    public void jedi_robe_jinsu_taker_action_upgrade1HandPvP(obj_id player, obj_id npc)
    {
    ...
    public void jedi_robe_jinsu_taker_action_upgrade2HandPvP(obj_id player, obj_id npc)
    {
    ...
    public void jedi_robe_jinsu_taker_action_upgradeStaffPvP(obj_id player, obj_id npc)
    {
    ...
    public void jedi_robe_jinsu_taker_action_upgradeGcw1Handed(obj_id player, obj_id npc)
    {
    ...
    public void jedi_robe_jinsu_taker_action_upgradeGcw2Handed(obj_id player, obj_id npc)
    {
    ...
    public int jedi_robe_jinsu_taker_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int jedi_robe_jinsu_taker_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int jedi_robe_jinsu_taker_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int jedi_robe_jinsu_taker_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_42"))
        {
            if (jedi_robe_jinsu_taker_condition__defaultCondition(player, npc))
    ...
    public int jedi_robe_jinsu_taker_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_42"))
        {
            if (jedi_robe_jinsu_taker_condition__defaultCondition(player, npc))
    ...
    public int jedi_robe_jinsu_taker_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int jedi_robe_jinsu_taker_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
