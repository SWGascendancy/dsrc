...
public class defend_the_village extends script.base_script
{
    ...
    public boolean defend_the_village_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean defend_the_village_condition_percentComplete50(obj_id player, obj_id npc)
    {
    ...
    public boolean defend_the_village_condition_canAcceptEitherQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean defend_the_village_condition_isOnRangedSpeedQuest(obj_id player, obj_id npc)
    {
        boolean result = false;
    ...
    public boolean defend_the_village_condition_isOnEitherQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean defend_the_village_condition_isOnMeleeDefenseQuest(obj_id player, obj_id npc)
    {
        boolean result = false;
    ...
    public boolean defend_the_village_condition_hasCompletedQuest(obj_id player, obj_id npc)
    {
        boolean result = false;
    ...
    public boolean defend_the_village_condition_canAcceptMeleeDefenseQuest(obj_id player, obj_id npc)
    {
        boolean result = false;
    ...
    public boolean defend_the_village_condition_canAcceptRangedSpeedQuest(obj_id player, obj_id npc)
    {
        boolean result = false;
    ...
    public void defend_the_village_action_assignDefendTheVillage1(obj_id player, obj_id npc)
    {
    ...
    public void defend_the_village_action_assignDefendTheVillage2(obj_id player, obj_id npc)
    {
        attachScript(player, "quest.force_sensitive.fs_defend_01_cleanup");
        quests.activate("fs_defend_set_faction_02", player, npc);
        fs_quests.setQuestAccepted(player);
    }
    public String defend_the_village_tokenTO_delete_me(obj_id player, obj_id npc)
    {
        return new String();
    }
    public int defend_the_village_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int defend_the_village_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int defend_the_village_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int defend_the_village_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int defend_the_village_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int defend_the_village_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int defend_the_village_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public float getPercentComplete(obj_id self, String questName)
    {
        float result = 0.0f;
