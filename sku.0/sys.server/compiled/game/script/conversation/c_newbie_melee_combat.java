...
public class c_newbie_melee_combat extends script.base_script
{
    ...
    public boolean c_newbie_melee_combat_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_newbie_melee_combat_condition_sentByMayor(obj_id player, obj_id npc)
    {
    ...
    public boolean c_newbie_melee_combat_condition_completedPeawpQuests(obj_id player, obj_id npc)
    {
    ...
    public boolean c_newbie_melee_combat_condition_returningViagonShinn(obj_id player, obj_id npc)
    {
    ...
    public boolean c_newbie_melee_combat_condition_onSwoopers(obj_id player, obj_id npc)
    {
    ...
    public boolean c_newbie_melee_combat_condition_returningSwoopers(obj_id player, obj_id npc)
    {
    ...
    public boolean c_newbie_melee_combat_condition_onScavengers(obj_id player, obj_id npc)
    {
    ...
    public boolean c_newbie_melee_combat_condition_returningWaterThief(obj_id player, obj_id npc)
    {
    ...
    public boolean c_newbie_melee_combat_condition_onWaterThief(obj_id player, obj_id npc)
    {
    ...
    public boolean c_newbie_melee_combat_condition_returningGunrunners(obj_id player, obj_id npc)
    {
    ...
    public boolean c_newbie_melee_combat_condition_onGunrunners(obj_id player, obj_id npc)
    {
    ...
    public boolean c_newbie_melee_combat_condition_onDroids(obj_id player, obj_id npc)
    {
    ...
    public boolean c_newbie_melee_combat_condition_returningCriminals(obj_id player, obj_id npc)
    {
    ...
    public boolean c_newbie_melee_combat_condition_onCriminals(obj_id player, obj_id npc)
    {
    ...
    public boolean c_newbie_melee_combat_condition_returningMuggers(obj_id player, obj_id npc)
    {
    ...
    public boolean c_newbie_melee_combat_condition_onMuggers(obj_id player, obj_id npc)
    {
    ...
    public boolean c_newbie_melee_combat_condition_onVaigonShinn(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "newbie_mayor_vaigon_shinn");
    }
    public void c_newbie_melee_combat_action_sendToMayor(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "mayor_vaigon_shinn_02");
    }
    public void c_newbie_melee_combat_action_signal_pickingPocket(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "peawpsPocketPicked");
    }
    public void c_newbie_melee_combat_action_grantSwoopers(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "newbie_mayor_hooligans_swoopers_2");
    }
    public void c_newbie_melee_combat_action_grantScavengers(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "newbie_mayor_hooligans_scavengers");
    }
    public void c_newbie_melee_combat_action_grantWaterThief(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "newbie_mayor_hooligans_water_thief_2");
    }
    public void c_newbie_melee_combat_action_grantGunrunners(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "newbie_mayor_hooligans_gunrunners_2");
    }
    public void c_newbie_melee_combat_action_grantCriminals(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "newbie_mayor_hooligans_criminals_2");
    }
    public void c_newbie_melee_combat_action_grantMuggers(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "newbie_mayor_shinn_muggers_2");
    }
    public void c_newbie_melee_combat_action_grantVaigonShin(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "newbie_mayor_vaigon_shinn");
    }
    public void c_newbie_melee_combat_action_endSwoopers(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "mayor_hooligans_swoopers_02");
    }
    public void c_newbie_melee_combat_action_endWaterThief(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "mayor_water_thief_02");
    }
    public void c_newbie_melee_combat_action_endGunrunners(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "mayor_gunrunner_02");
    }
    public void c_newbie_melee_combat_action_endCriminals(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "mayor_criminals_02");
    }
    public void c_newbie_melee_combat_action_endMuggers(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "mayor_shinn_mugger_02");
    }
    public void c_newbie_melee_combat_action_endFromMayor(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "newbie_goto_peawp_02");
    }
    public int c_newbie_melee_combat_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_newbie_melee_combat_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_newbie_melee_combat_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_newbie_melee_combat_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_newbie_melee_combat_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_newbie_melee_combat_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_newbie_melee_combat_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_newbie_melee_combat_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_newbie_melee_combat_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_newbie_melee_combat_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_newbie_melee_combat_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
