...
public class corellia_coronet_vani_korr extends script.base_script
{
    ...
    public boolean corellia_coronet_vani_korr_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_coronet_vani_korr_condition_act1_hasViewScreen(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_coronet_meatlump_act1_begin", "meatlumpsAct1_vaniKorr");
    }
    public boolean corellia_coronet_vani_korr_condition_act1_gettingDatapads(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_coronet_meatlump_act1_part2", "meatlumpsAct1_collectDatapads");
    }
    public boolean corellia_coronet_vani_korr_condition_act1_refusedDatpads(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_coronet_meatlump_act1_begin", "meatlumpsAct1_refusedDatapads");
    }
    public boolean corellia_coronet_vani_korr_condition_act1_finishedDatapads(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_coronet_meatlump_act1_part2", "meatlumpsAct1_datapadsToVani");
    }
    public boolean corellia_coronet_vani_korr_condition_act1_refusedPassword(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_coronet_meatlump_act1_part2", "meatlumpsAct1_refusedPassword");
    }
    public boolean corellia_coronet_vani_korr_condition_act1_gettingPassword(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "corellia_coronet_meatlump_act1_part3");
    }
    public boolean corellia_coronet_vani_korr_condition_act1_failedPassword(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_coronet_meatlump_act1_part3", "meatlumpsAct1_failedPassword");
    }
    public boolean corellia_coronet_vani_korr_condition_act1_gotPassword(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "corellia_coronet_meatlump_act1_end");
    }
    public boolean corellia_coronet_vani_korr_condition_act1_completedAct1(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "corellia_coronet_meatlump_act1_end") && getLevel(player) < 55;
    }
    public boolean corellia_coronet_vani_korr_condition_isLevelForMtp(obj_id player, obj_id npc)
    {
        return getLevel(player) >= 55;
    }
    public boolean corellia_coronet_vani_korr_condition_returning_mtpHideout02(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_coronet_vani_korr_condition_readyForMtpHideout(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "corellia_coronet_meatlump_act1_end") && getLevel(player) >= 55;
    }
    public boolean corellia_coronet_vani_korr_condition_active_mtpHideout01(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_coronet_vani_korr_condition_returning_mtpHideout01(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_coronet_vani_korr_condition_active_mtpHideout02(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "mtp_hideout_access_02");
    }
    public boolean corellia_coronet_vani_korr_condition_active_mtpHideout03(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_coronet_vani_korr_condition_active_mtpHideout04(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_coronet_vani_korr_condition_returning_mtpHideout04(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_coronet_vani_korr_condition_active_mtpHideout05(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "mtp_hideout_access_05");
    }
    public boolean corellia_coronet_vani_korr_condition_active_mtpHideout06(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_coronet_vani_korr_condition_active_mtpHideout07(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_coronet_vani_korr_condition_returning_mtpHideout07(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_coronet_vani_korr_condition_hasHideoutPointer(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "mtp_hideout_pointer");
    }
    public boolean corellia_coronet_vani_korr_condition_needs_mtpHideout04(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_coronet_vani_korr_condition_hasAct2StoryQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "mtp_meatlump_king_story");
    }
    public boolean corellia_coronet_vani_korr_condition_completedAct2StoryQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "mtp_meatlump_king_story");
    }
    public void corellia_coronet_vani_korr_action_act1_getDatapads(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "meatlumpsAct1_vaniKorr");
    }
    public void corellia_coronet_vani_korr_action_act1_theyRefuseDatapads(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "meatlumpsAct1_refused");
    }
    public void corellia_coronet_vani_korr_action_act1_getPassword(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "meatlumpsAct1_datapadsToVani");
    }
    public void corellia_coronet_vani_korr_action_act1_theyRefusePassword(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "meatlumpsAct1_refusedAgain");
    }
    public void corellia_coronet_vani_korr_action_act1_regrantPasswordQuest(obj_id player, obj_id npc)
    {
    ...
    public void corellia_coronet_vani_korr_action_act1_Complete(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "meatlumpsAct1_gotPassword");
    }
    public void corellia_coronet_vani_korr_action_grant_mtpHideout01(obj_id player, obj_id npc)
    {
    ...
    public void corellia_coronet_vani_korr_action_signal_mtpHideout01(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "mtp_hideout_access_01_07");
    }
    public void corellia_coronet_vani_korr_action_grant_mtpHideout02(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "mtp_hideout_access_02");
        return;
    }
    public void corellia_coronet_vani_korr_action_grant_mtpHideout03(obj_id player, obj_id npc)
    {
        if (getLevel(player) >= 82)
        {
    ...
    public void corellia_coronet_vani_korr_action_signal_mtpHideout02(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "mtp_hideout_access_02_04");
    }
    public void corellia_coronet_vani_korr_action_grant_mtpHideout05(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "mtp_hideout_access_05");
        return;
    }
    public void corellia_coronet_vani_korr_action_signal_mtpHideout07(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "mtp_hideout_access_07_04");
    }
    public void corellia_coronet_vani_korr_action_signal_mtpHideout04(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "mtp_hideout_access_04_04");
    }
    public void corellia_coronet_vani_korr_action_grantHideoutPointer(obj_id player, obj_id npc)
    {
    ...
    public void corellia_coronet_vani_korr_action_grant_mtpHideout04Pointer(obj_id player, obj_id npc)
    {
    ...
    public void corellia_coronet_vani_korr_action_act2_storySignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "mtp_king_story");
    }
    public void corellia_coronet_vani_korr_action_signal_pointer(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "corellia_coronet_meatlump_act2_pointer");
    }
    public int corellia_coronet_vani_korr_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_vani_korr_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_vani_korr_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_vani_korr_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_vani_korr_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_vani_korr_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_vani_korr_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_vani_korr_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_vani_korr_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_vani_korr_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_vani_korr_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_vani_korr_handleBranch30(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_vani_korr_handleBranch34(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_vani_korr_handleBranch37(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_vani_korr_handleBranch40(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_vani_korr_handleBranch41(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_73"))
        {
            if (corellia_coronet_vani_korr_condition__defaultCondition(player, npc))
    ...
    public int corellia_coronet_vani_korr_handleBranch42(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_vani_korr_handleBranch43(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_vani_korr_handleBranch47(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_vani_korr_handleBranch48(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_vani_korr_handleBranch49(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_vani_korr_handleBranch50(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_vani_korr_handleBranch51(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_116"))
        {
            if (corellia_coronet_vani_korr_condition__defaultCondition(player, npc))
    ...
    public int corellia_coronet_vani_korr_handleBranch52(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_vani_korr_handleBranch53(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_vani_korr_handleBranch54(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_vani_korr_handleBranch55(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_vani_korr_handleBranch56(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_vani_korr_handleBranch58(obj_id player, obj_id npc, string_id response)
    {
