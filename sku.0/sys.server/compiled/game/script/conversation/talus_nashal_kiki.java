...
public class talus_nashal_kiki extends script.base_script
{
    ...
    public boolean talus_nashal_kiki_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean talus_nashal_kiki_condition_completeGotoKiki(obj_id player, obj_id npc)
    {
    ...
    public boolean talus_nashal_kiki_condition_onFindRecon(obj_id player, obj_id npc)
    {
    ...
    public boolean talus_nashal_kiki_condition_onReturnKiki1(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "talus_nashal_find_weakness", "selonian_return_kiki_1");
    }
    public boolean talus_nashal_kiki_condition_onFindFlight(obj_id player, obj_id npc)
    {
    ...
    public boolean talus_nashal_kiki_condition_onReturnKiki2(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "talus_nashal_find_weakness", "selonian_return_kiki_2");
    }
    public boolean talus_nashal_kiki_condition_completeFindWeakness(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "talus_nashal_find_weakness");
    }
    public boolean talus_nashal_kiki_condition_completeGotoMother(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "talus_nashal_goto_mother");
    }
    public void talus_nashal_kiki_action_grantFindWeakness(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "talus_nashal_find_weakness");
    }
    public void talus_nashal_kiki_action_signalFindFlight(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "selonian_return_kiki_1");
    }
    public void talus_nashal_kiki_action_signalCompleteFindWeakness(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "selonian_return_kiki_2");
    }
    public void talus_nashal_kiki_action_grantGotoMother(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "talus_nashal_goto_mother");
    }
    public void talus_nashal_kiki_action_signalTalkKiki(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "selonian_goto_kiki");
    }
    public int talus_nashal_kiki_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_kiki_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_kiki_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_kiki_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_kiki_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_kiki_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_kiki_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_kiki_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_kiki_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_kiki_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
