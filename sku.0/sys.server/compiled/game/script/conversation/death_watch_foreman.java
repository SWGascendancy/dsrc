...
public class death_watch_foreman extends script.base_script
{
    ...
    public boolean death_watch_foreman_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean death_watch_foreman_condition_startMission(obj_id player, obj_id npc)
    {
    ...
    public boolean death_watch_foreman_condition_notCompleted(obj_id player, obj_id npc)
    {
    ...
    public boolean death_watch_foreman_condition_helpedHaldo(obj_id player, obj_id npc)
    {
    ...
    public boolean death_watch_foreman_condition_alreadyBeingHelped(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "death_watch.drill_completed") || hasObjVar(player, "death_watch.drill_kill"))
        {
            return false;
    ...
    public boolean death_watch_foreman_condition_killedHaldo(obj_id player, obj_id npc)
    {
    ...
    public boolean death_watch_foreman_condition_notCompletedBattery(obj_id player, obj_id npc)
    {
    ...
    public boolean death_watch_foreman_condition_batteryCleaned(obj_id player, obj_id npc)
    {
        obj_id structure = getTopMostContainer(npc);
    ...
    public boolean death_watch_foreman_condition_waterPressureStartnoKill(obj_id player, obj_id npc)
    {
        obj_id structure = getTopMostContainer(npc);
        if (hasObjVar(structure, "death_watch.water_pressure_mission"))
        {
    ...
    public boolean death_watch_foreman_condition_waterPressureStartKill(obj_id player, obj_id npc)
    {
        obj_id structure = getTopMostContainer(npc);
        if (hasObjVar(structure, "death_watch.water_pressure_mission"))
        {
    ...
    public boolean death_watch_foreman_condition_batteryCleanedKill(obj_id player, obj_id npc)
    {
        if (!hasObjVar(player, "death_watch.drill_02"))
        {
            return false;
    ...
    public boolean death_watch_foreman_condition_notCompletedWater(obj_id player, obj_id npc)
    {
        obj_id structure = getTopMostContainer(npc);
    ...
    public boolean death_watch_foreman_condition_waterPressureSuccess(obj_id player, obj_id npc)
    {
        if (!hasObjVar(player, "death_watch.drill_03"))
        {
            return false;
    ...
    public boolean death_watch_foreman_condition_waterPressureSuccessKill(obj_id player, obj_id npc)
    {
        if (!hasObjVar(player, "death_watch.drill_03"))
        {
            return false;
    ...
    public boolean death_watch_foreman_condition_getMoreOreNotReady(obj_id player, obj_id npc)
    {
    ...
    public boolean death_watch_foreman_condition_getMoreOreReady(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "death_watch.drill_completed"))
        {
            int comTime = getIntObjVar(player, "death_watch.drill_completed");
    ...
    public boolean death_watch_foreman_condition_waterPressureFail(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "death_watch.drill_completed") || hasObjVar(player, "death_watch.drill_kill"))
        {
            return false;
    ...
    public boolean death_watch_foreman_condition_waterPressureBusy(obj_id player, obj_id npc)
    {
        obj_id structure = getTopMostContainer(npc);
        if (hasObjVar(structure, "death_watch.water_pressure_mission"))
        {
    ...
    public boolean death_watch_foreman_condition_haldoFailed(obj_id player, obj_id npc)
    {
        obj_id structure = getTopMostContainer(npc);
        if (hasObjVar(player, "death_watch.drill_01"))
        {
    ...
    public boolean death_watch_foreman_condition_noInvRoom(obj_id player, obj_id npc)
    {
    ...
    public void death_watch_foreman_action_helpHaldo(obj_id player, obj_id npc)
    {
    ...
    public void death_watch_foreman_action_cleanBattery(obj_id player, obj_id npc)
    {
        removeObjVar(player, "death_watch.drill_01");
        setObjVar(player, "death_watch.drill_02", 1);
        return;
    }
    public void death_watch_foreman_action_takeBattery(obj_id player, obj_id npc)
    {
        obj_id[] objContents = utils.getContents(player, true);
        if (objContents != null)
        {
    ...
    public void death_watch_foreman_action_startWaterPressure(obj_id player, obj_id npc)
    {
    ...
    public void death_watch_foreman_action_finishMission(obj_id player, obj_id npc)
    {
    ...
    public void death_watch_foreman_action_giveReward(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "death_watch.drill_completed"))
        {
            int curTime = getGameTime();
    ...
    public void death_watch_foreman_action_declineHaldo(obj_id player, obj_id npc)
    {
        obj_id structure = getTopMostContainer(npc);
    ...
    public void death_watch_foreman_action_declineWater(obj_id player, obj_id npc)
    {
        obj_id structure = getTopMostContainer(npc);
    ...
    public void death_watch_foreman_action_cleanOldPlayers(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "death_watch.water_pressure"))
        {
            removeObjVar(player, "death_watch.water_pressure");
    ...
    public int death_watch_foreman_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_foreman_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_foreman_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_foreman_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_foreman_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_foreman_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_foreman_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_foreman_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_foreman_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_foreman_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_foreman_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_foreman_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_foreman_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_foreman_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_foreman_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_foreman_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_foreman_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_foreman_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_foreman_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_foreman_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_foreman_handleBranch30(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_foreman_handleBranch33(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_foreman_handleBranch34(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_foreman_handleBranch35(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_foreman_handleBranch37(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_foreman_handleBranch39(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_foreman_handleBranch40(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_foreman_handleBranch41(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_foreman_handleBranch42(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_foreman_handleBranch46(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_foreman_handleBranch50(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_foreman_handleBranch51(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_foreman_handleBranch52(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_foreman_handleBranch55(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_foreman_handleBranch56(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_foreman_handleBranch59(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_foreman_handleBranch60(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_foreman_handleBranch64(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_foreman_handleBranch68(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_foreman_handleBranch72(obj_id player, obj_id npc, string_id response)
    {
