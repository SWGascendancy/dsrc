...
public class tusken_cloning extends script.base_script
{
    ...
    public boolean tusken_cloning_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tusken_cloning_condition_staffed(obj_id player, obj_id npc)
    {
