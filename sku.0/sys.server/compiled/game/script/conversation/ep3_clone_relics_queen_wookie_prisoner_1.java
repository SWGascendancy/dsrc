...
public class ep3_clone_relics_queen_wookie_prisoner_1 extends script.base_script
{
    ...
    public boolean ep3_clone_relics_queen_wookie_prisoner_1_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_clone_relics_queen_wookie_prisoner_1_condition_isWookie(obj_id player, obj_id npc)
    {
        return (getSpecies(player) == SPECIES_WOOKIEE);
    }
    public boolean ep3_clone_relics_queen_wookie_prisoner_1_condition_knowWookiee(obj_id player, obj_id npc)
    {
        return utils.canSpeakWookiee(player, npc);
    }
    public boolean ep3_clone_relics_queen_wookie_prisoner_1_condition_talkPrisonersActive(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "ep3_clone_relics_queen_2", "talkedPrisoners"));
    }
    public void ep3_clone_relics_queen_wookie_prisoner_1_action_signalTalked(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedToPrisoners");
    }
    public void ep3_clone_relics_queen_wookie_prisoner_1_action_cantUnderstand(obj_id player, obj_id npc)
    {
        utils.emoteWookieeConfusion(player, npc);
    }
    public int ep3_clone_relics_queen_wookie_prisoner_1_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_queen_wookie_prisoner_1_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_queen_wookie_prisoner_1_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
