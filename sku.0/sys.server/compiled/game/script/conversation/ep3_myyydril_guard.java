...
public class ep3_myyydril_guard extends script.base_script
{
    ...
    public boolean ep3_myyydril_guard_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_myyydril_guard_condition_hasLnguage(obj_id player, obj_id npc)
    {
        return utils.canSpeakWookiee(player, npc);
    }
    public void ep3_myyydril_guard_action_Language(obj_id player, obj_id npc)
    {
        utils.emoteWookieeConfusion(player, npc);
    }
    public int ep3_myyydril_guard_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_guard_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_guard_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_guard_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_462"))
        {
            if (ep3_myyydril_guard_condition__defaultCondition(player, npc))
    ...
    public int ep3_myyydril_guard_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_guard_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_462"))
        {
            if (ep3_myyydril_guard_condition__defaultCondition(player, npc))
