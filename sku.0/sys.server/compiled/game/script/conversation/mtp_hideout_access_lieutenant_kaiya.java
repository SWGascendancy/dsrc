...
public class mtp_hideout_access_lieutenant_kaiya extends script.base_script
{
    ...
    public boolean mtp_hideout_access_lieutenant_kaiya_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean mtp_hideout_access_lieutenant_kaiya_condition_mtpHideout05_02(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_hideout_access_lieutenant_kaiya_condition_active_mtpHideout06(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_hideout_access_lieutenant_kaiya_condition_return_mtpHideout06(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_hideout_access_lieutenant_kaiya_condition_active_mtpHideout07(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_hideout_access_lieutenant_kaiya_condition_return_mtpHideout07(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_hideout_access_lieutenant_kaiya_condition_doneWithKaiya(obj_id player, obj_id npc)
    {
    ...
    public void mtp_hideout_access_lieutenant_kaiya_action_signal_mtpHideout05_02(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "mtp_hideout_access_05_02");
    }
    public void mtp_hideout_access_lieutenant_kaiya_action_grant_mtpHideout06(obj_id player, obj_id npc)
    {
    ...
    public void mtp_hideout_access_lieutenant_kaiya_action_signal_mtpHideout06(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "mtp_hideout_access_06_02");
    }
    public void mtp_hideout_access_lieutenant_kaiya_action_grant_mtpHideout07(obj_id player, obj_id npc)
    {
        if (getLevel(player) >= 82)
        {
    ...
    public void mtp_hideout_access_lieutenant_kaiya_action_signal_mtpHideout07(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "mtp_hideout_access_07_03");
    }
    public int mtp_hideout_access_lieutenant_kaiya_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_access_lieutenant_kaiya_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_access_lieutenant_kaiya_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_access_lieutenant_kaiya_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_access_lieutenant_kaiya_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_access_lieutenant_kaiya_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_access_lieutenant_kaiya_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_access_lieutenant_kaiya_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
