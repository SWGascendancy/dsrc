...
public class som_glyph_hunt extends script.base_script
{
    ...
    public boolean som_glyph_hunt_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean som_glyph_hunt_condition_onFirstTask(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "som_glyph_hunt", "glyph_hunt_four");
    }
    public boolean som_glyph_hunt_condition_completedFirstTask(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "som_glyph_hunt", "glyph_hunt_five");
    }
    public boolean som_glyph_hunt_condition_onSecondTask(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "som_glyph_hunt", "glyph_hunt_eight");
    }
    public boolean som_glyph_hunt_condition_completedSecondTask(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "som_glyph_hunt", "glyph_hunt_nine");
    }
    public boolean som_glyph_hunt_condition_completedMission(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "som_glyph_hunt");
    }
    public void som_glyph_hunt_action_grantMission(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "som_glyph_hunt");
    }
    public void som_glyph_hunt_action_sendFirstSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "glyph_hunt_found");
    }
    public void som_glyph_hunt_action_sendLastSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "glyph_hunt_finish");
    }
    public int som_glyph_hunt_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_glyph_hunt_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_glyph_hunt_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_glyph_hunt_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_glyph_hunt_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_glyph_hunt_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_glyph_hunt_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_glyph_hunt_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_glyph_hunt_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_glyph_hunt_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_glyph_hunt_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_glyph_hunt_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_glyph_hunt_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_glyph_hunt_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_glyph_hunt_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
