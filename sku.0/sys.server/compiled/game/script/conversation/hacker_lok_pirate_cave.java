...
public class hacker_lok_pirate_cave extends script.base_script
{
    ...
    public boolean hacker_lok_pirate_cave_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean hacker_lok_pirate_cave_condition_hasCompletedPirate(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.hasCompletedQuest(player, "u16_nym_themepark_pirate_hideout");
    }
    public boolean hacker_lok_pirate_cave_condition_hasHackTask(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean hacker_lok_pirate_cave_condition_hasReturnTask(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "u16_nym_themepark_pirate_hideout", "returnPirateComplete");
    }
    public boolean hacker_lok_pirate_cave_condition_hasColorWheelTaskActive(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "u16_nym_themepark_pirate_hideout", "colorWheel");
    }
    public boolean hacker_lok_pirate_cave_condition_hasJokeTaskActive(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "u16_nym_themepark_pirate_hideout", "joke");
    }
    public boolean hacker_lok_pirate_cave_condition_hasNumberTaskActive(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "u16_nym_themepark_pirate_hideout", "number");
    }
    public boolean hacker_lok_pirate_cave_condition_hasSlicedTheSystem(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "u16_nym_themepark_pirate_hideout", "findDroidDisk");
    }
    public void hacker_lok_pirate_cave_action_colorWheelDone(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "colorWheelDone");
    }
    public void hacker_lok_pirate_cave_action_foundSecuritySys(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "hasFoundSecuritySystem");
    }
    public void hacker_lok_pirate_cave_action_numbersDone(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "numberDone");
    }
    public void hacker_lok_pirate_cave_action_jokeDone(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "jokeDone");
    }
    public int hacker_lok_pirate_cave_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int hacker_lok_pirate_cave_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int hacker_lok_pirate_cave_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int hacker_lok_pirate_cave_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int hacker_lok_pirate_cave_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int hacker_lok_pirate_cave_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_112"))
        {
            if (hacker_lok_pirate_cave_condition__defaultCondition(player, npc))
    ...
    public int hacker_lok_pirate_cave_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_112"))
        {
            if (hacker_lok_pirate_cave_condition__defaultCondition(player, npc))
    ...
    public int hacker_lok_pirate_cave_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int hacker_lok_pirate_cave_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int hacker_lok_pirate_cave_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int hacker_lok_pirate_cave_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_112"))
        {
            if (hacker_lok_pirate_cave_condition__defaultCondition(player, npc))
    ...
    public int hacker_lok_pirate_cave_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_112"))
        {
            if (hacker_lok_pirate_cave_condition__defaultCondition(player, npc))
    ...
    public int hacker_lok_pirate_cave_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int hacker_lok_pirate_cave_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int hacker_lok_pirate_cave_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_112"))
        {
            if (hacker_lok_pirate_cave_condition__defaultCondition(player, npc))
    ...
    public int hacker_lok_pirate_cave_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_112"))
        {
            if (hacker_lok_pirate_cave_condition__defaultCondition(player, npc))
