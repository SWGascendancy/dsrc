...
public class tatooine_knives_parry_moa extends script.base_script
{
    ...
    public boolean tatooine_knives_parry_moa_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tatooine_knives_parry_moa_condition_facePlayer2(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return true;
    }
    public boolean tatooine_knives_parry_moa_condition_onPistolTask(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean tatooine_knives_parry_moa_condition_questComplete(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean tatooine_knives_parry_moa_condition_firstContact(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        int questId1 = questGetQuestId("quest/tatooine_knives_parry");
    ...
    public boolean tatooine_knives_parry_moa_condition_onPistolComplete(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        int questId1 = questGetQuestId("quest/tatooine_knives_parry");
    ...
    public void tatooine_knives_parry_moa_action_signalWeapon(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tatoonie_knives_parry_launch_e3");
    }
    public void tatooine_knives_parry_moa_action_signalWeaponComplete(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tatooine_knives_parry_launch_e97");
    }
    public void tatooine_knives_parry_moa_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int tatooine_knives_parry_moa_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_knives_parry_moa_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
