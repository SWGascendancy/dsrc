...
public class community_painting_handout_2008 extends script.base_script
{
    ...
    public boolean community_painting_handout_2008_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean community_painting_handout_2008_condition_hasReceivedRebelPainting(obj_id player, obj_id npc)
    {
    ...
    public boolean community_painting_handout_2008_condition_hasReceivedImpPainting(obj_id player, obj_id npc)
    {
    ...
    public boolean community_painting_handout_2008_condition_hasReceivedBothPaintings(obj_id player, obj_id npc)
    {
    ...
    public boolean community_painting_handout_2008_condition_received_one(obj_id player, obj_id npc)
    {
    ...
    public boolean community_painting_handout_2008_condition_not_old_enough(obj_id player, obj_id npc)
    {
        int myAge = getCurrentBirthDate() - getPlayerBirthDate(player);
        if (myAge < 15)
        {
    ...
    public boolean community_painting_handout_2008_condition_hasReceivedBoth_2(obj_id player, obj_id npc)
    {
    ...
    public void community_painting_handout_2008_action_grantRebelPainting(obj_id player, obj_id npc)
    {
    ...
    public void community_painting_handout_2008_action_grantImperialPainting(obj_id player, obj_id npc)
    {
    ...
    public void community_painting_handout_2008_action_grantBothPaintings(obj_id player, obj_id npc)
    {
        if (!isIdValid(player) || !isIdValid(npc))
        {
            return;
    ...
    public int community_painting_handout_2008_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int community_painting_handout_2008_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int community_painting_handout_2008_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
