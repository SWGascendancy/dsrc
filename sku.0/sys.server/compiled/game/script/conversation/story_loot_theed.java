...
public class story_loot_theed extends script.base_script
{
    ...
    public boolean story_loot_theed_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean story_loot_theed_condition_checkAll(obj_id player, obj_id npc)
    {
    ...
    public boolean story_loot_theed_condition_checkTatooine(obj_id player, obj_id npc)
    {
        if (utils.hasScriptVar(player, "story_loot.planet"))
        {
            String planet = utils.getStringScriptVar(player, "story_loot.planet");
    ...
    public boolean story_loot_theed_condition_checkNaboo(obj_id player, obj_id npc)
    {
        if (utils.hasScriptVar(player, "story_loot.planet"))
        {
            String planet = utils.getStringScriptVar(player, "story_loot.planet");
    ...
    public boolean story_loot_theed_condition_checkCorellia(obj_id player, obj_id npc)
    {
        if (utils.hasScriptVar(player, "story_loot.planet"))
        {
            String planet = utils.getStringScriptVar(player, "story_loot.planet");
    ...
    public boolean story_loot_theed_condition_checkLok(obj_id player, obj_id npc)
    {
        if (utils.hasScriptVar(player, "story_loot.planet"))
        {
            String planet = utils.getStringScriptVar(player, "story_loot.planet");
    ...
    public boolean story_loot_theed_condition_checkDantooine(obj_id player, obj_id npc)
    {
        if (utils.hasScriptVar(player, "story_loot.planet"))
        {
            String planet = utils.getStringScriptVar(player, "story_loot.planet");
    ...
    public boolean story_loot_theed_condition_checkYavin4(obj_id player, obj_id npc)
    {
        if (utils.hasScriptVar(player, "story_loot.planet"))
        {
            String planet = utils.getStringScriptVar(player, "story_loot.planet");
    ...
    public boolean story_loot_theed_condition_checkEndor(obj_id player, obj_id npc)
    {
        if (utils.hasScriptVar(player, "story_loot.planet"))
        {
            String planet = utils.getStringScriptVar(player, "story_loot.planet");
    ...
    public boolean story_loot_theed_condition_checkDathomir(obj_id player, obj_id npc)
    {
        if (utils.hasScriptVar(player, "story_loot.planet"))
        {
            String planet = utils.getStringScriptVar(player, "story_loot.planet");
    ...
    public boolean story_loot_theed_condition_hasSpaceExp(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean story_loot_theed_condition_checkRem(obj_id player, obj_id npc)
    {
    ...
    public void story_loot_theed_action_Tatooine(obj_id player, obj_id npc)
    {
    ...
    public void story_loot_theed_action_Naboo(obj_id player, obj_id npc)
    {
        obj_id item = utils.getObjIdScriptVar(player, "story_loot.item");
        if (!isIdValid(item))
        {
    ...
    public void story_loot_theed_action_Corellia(obj_id player, obj_id npc)
    {
        obj_id item = utils.getObjIdScriptVar(player, "story_loot.item");
        if (!isIdValid(item))
        {
    ...
    public void story_loot_theed_action_Dantooine(obj_id player, obj_id npc)
    {
        obj_id item = utils.getObjIdScriptVar(player, "story_loot.item");
        if (!isIdValid(item))
        {
    ...
    public void story_loot_theed_action_Lok(obj_id player, obj_id npc)
    {
        obj_id item = utils.getObjIdScriptVar(player, "story_loot.item");
        if (!isIdValid(item))
        {
    ...
    public void story_loot_theed_action_Yavin4(obj_id player, obj_id npc)
    {
        obj_id item = utils.getObjIdScriptVar(player, "story_loot.item");
        if (!isIdValid(item))
        {
    ...
    public void story_loot_theed_action_Endor(obj_id player, obj_id npc)
    {
        obj_id item = utils.getObjIdScriptVar(player, "story_loot.item");
        if (!isIdValid(item))
        {
    ...
    public void story_loot_theed_action_Dathomir(obj_id player, obj_id npc)
    {
        obj_id item = utils.getObjIdScriptVar(player, "story_loot.item");
        if (!isIdValid(item))
        {
    ...
    public void story_loot_theed_action_All(obj_id player, obj_id npc)
    {
        obj_id item = utils.getObjIdScriptVar(player, "story_loot.item");
        if (!isIdValid(item))
        {
    ...
    public void story_loot_theed_action_animBow(obj_id player, obj_id npc)
    {
        doAnimationAction(npc, "bow");
    }
    public void story_loot_theed_action_storyLoot(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "story_loot.rem", true);
    }
    public String story_loot_theed_tokenTO_species(obj_id player, obj_id npc)
    {
