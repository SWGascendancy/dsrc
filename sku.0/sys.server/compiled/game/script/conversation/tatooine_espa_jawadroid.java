...
public class tatooine_espa_jawadroid extends script.base_script
{
    ...
    public boolean tatooine_espa_jawadroid_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tatooine_espa_jawadroid_condition_onJawaTask(obj_id player, obj_id npc)
    {
    ...
    public void tatooine_espa_jawadroid_action_signalJawaTask(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tat_espa_body_building_e2");
    }
    public void tatooine_espa_jawadroid_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int tatooine_espa_jawadroid_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_espa_jawadroid_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_espa_jawadroid_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_espa_jawadroid_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_espa_jawadroid_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_espa_jawadroid_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_espa_jawadroid_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_espa_jawadroid_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
