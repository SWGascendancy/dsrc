...
public class biogenic_herald_03 extends script.base_script
{
    ...
    public boolean biogenic_herald_03_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean biogenic_herald_03_condition_not_rebel(obj_id player, obj_id npc)
    {
    ...
    public void biogenic_herald_03_action__defaultAction(obj_id player, obj_id npc)
    {
    }
    public void biogenic_herald_03_action_face_to(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
