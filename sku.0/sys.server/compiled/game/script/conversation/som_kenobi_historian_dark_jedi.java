...
public class som_kenobi_historian_dark_jedi extends script.base_script
{
    ...
    public boolean som_kenobi_historian_dark_jedi_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean som_kenobi_historian_dark_jedi_condition_playerJedi(obj_id player, obj_id npc)
    {
        return jedi.isForceSensitive(player);
    }
    public void som_kenobi_historian_dark_jedi_action_attack(obj_id player, obj_id npc)
    {
