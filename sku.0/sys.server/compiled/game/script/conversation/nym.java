...
public class nym extends script.base_script
{
    ...
    public boolean nym_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean nym_condition_hasCompletedFacility(obj_id player, obj_id npc)
    {
    ...
    public boolean nym_condition_hasNotCompletedArena(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "u16_nym_themepark_nym_arena");
    }
    public boolean nym_condition_hasCompletedArenaTask(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "u16_nym_themepark_nym_arena", "hasCompletedArenaForNym");
    }
    public boolean nym_condition_isReadyForQuestAfterArena(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "u16_nym_themepark_nym_arena");
    }
    public boolean nym_condition_hasCompletedShuttleTask(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "u16_nym_themepark_shuttle_ambush", "hasCompletedShuttleForNym");
    }
    public boolean nym_condition_isReadyForFinale(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "u16_nym_themepark_negotiate_peace");
    }
    public boolean nym_condition_hasFinishedTownsPeople(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "u16_nym_return_townsperson", "nymTownpersonDone");
    }
    public boolean nym_condition_isReadyPeaceMission(obj_id player, obj_id npc)
    {
    ...
    public boolean nym_condition_hasCompletedPeaceMission(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "u16_nym_themepark_negotiate_peace", "returnToNymSheeli");
    }
    public boolean nym_condition_isDoneThemePark(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "u16_nym_themepark_shuttle_ambush");
    }
    public boolean nym_condition_hasPeaceMission(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "u16_nym_themepark_negotiate_peace");
    }
    public boolean nym_condition_hasShuttleQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "u16_nym_themepark_shuttle_ambush");
    }
    public void nym_action_grantArenaQuest(obj_id player, obj_id npc)
    {
    ...
    public void nym_action_completeArenaQuest(obj_id player, obj_id npc)
    {
    ...
    public void nym_action_grantShuttleQuest(obj_id player, obj_id npc)
    {
    ...
    public void nym_action_completeShuttleQuest(obj_id player, obj_id npc)
    {
    ...
    public void nym_action_hasFoundNym(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "hasFoundNym");
    }
    public void nym_action_grantTownspersonQuest(obj_id player, obj_id npc)
    {
    ...
    public void nym_action_finishTownsPeople(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "hasCompletedTownPersonQuest");
    }
    public void nym_action_givePeaceMission(obj_id player, obj_id npc)
    {
    ...
    public void nym_action_finishPeaceMission(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "hasReturnedToNymSheeli");
    }
    public void nym_action_validateAllNymRewards(obj_id player, obj_id npc)
    {
        nym_action_completeArenaQuest(player, npc);
        nym_action_completeShuttleQuest(player, npc);
    }
    public int nym_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_handleBranch30(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_handleBranch31(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_handleBranch32(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_handleBranch33(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_handleBranch34(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_handleBranch36(obj_id player, obj_id npc, string_id response)
    {
