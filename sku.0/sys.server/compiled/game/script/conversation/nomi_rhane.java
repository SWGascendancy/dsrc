...
public class nomi_rhane extends script.base_script
{
    ...
    public boolean nomi_rhane_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean nomi_rhane_condition_isEnrouteToSurvivors(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "outbreak_quest_facility_04", "speakNomi");
    }
    public boolean nomi_rhane_condition_hasntLeft(obj_id player, obj_id npc)
    {
    ...
    public boolean nomi_rhane_condition_hasCompleted4Del5(obj_id player, obj_id npc)
    {
        return (!groundquests.isQuestActive(player, "outbreak_quest_facility_05_imperial") && !groundquests.isQuestActive(player, "outbreak_quest_facility_05_rebel") && !groundquests.isQuestActive(player, "outbreak_quest_facility_05_neutral") && groundquests.hasCompletedQuest(player, "outbreak_quest_facility_04"));
    }
    public void nomi_rhane_action_spokenNomi(obj_id player, obj_id npc)
    {
    ...
    public int nomi_rhane_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nomi_rhane_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nomi_rhane_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nomi_rhane_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
