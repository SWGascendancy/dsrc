...
public class striking_miners_nurfa extends script.base_script
{
    ...
    public boolean striking_miners_nurfa_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean striking_miners_nurfa_condition_isOnTask(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "som_striking_miners", "mustafar_striking_miners_one");
    }
    public boolean striking_miners_nurfa_condition_isOnTaskTwo(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "som_striking_miners", "mustafar_striking_miners_two");
    }
    public boolean striking_miners_nurfa_condition_taskCompleted(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "som_striking_miners", "mustafar_striking_miners_three");
    }
    public boolean striking_miners_nurfa_condition_hasCompletedMission(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "som_striking_miners");
    }
    public void striking_miners_nurfa_action_sendFirstSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "mustafar_striking_miners_nurfa");
    }
    public void striking_miners_nurfa_action_rewardTime(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "mustafar_striking_miners_win");
    }
    public int striking_miners_nurfa_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int striking_miners_nurfa_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int striking_miners_nurfa_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int striking_miners_nurfa_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int striking_miners_nurfa_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int striking_miners_nurfa_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int striking_miners_nurfa_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int striking_miners_nurfa_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
