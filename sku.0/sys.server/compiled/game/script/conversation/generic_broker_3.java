...
public class generic_broker_3 extends script.base_script
{
    ...
    public boolean generic_broker_3_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean generic_broker_3_condition_isNonSmuggler(obj_id player, obj_id npc)
    {
    ...
    public boolean generic_broker_3_condition_isDoingMission(obj_id player, obj_id npc)
    {
    ...
    public boolean generic_broker_3_condition_missionTierRequirement(obj_id player, obj_id npc)
    {
    ...
    public boolean generic_broker_3_condition_hasMissionFunds(obj_id player, obj_id npc)
    {
    ...
    public boolean generic_broker_3_condition_hasSomeContraband(obj_id player, obj_id npc)
    {
    ...
    public boolean generic_broker_3_condition_hasMissionContraband(obj_id player, obj_id npc)
    {
    ...
    public void generic_broker_3_action_startGiveQuest(obj_id player, obj_id npc)
    {
    ...
    public void generic_broker_3_action_givePointerQuest(obj_id player, obj_id npc)
    {
        float underworldFaction = factions.getFactionStanding(player, "underworld");
    ...
    public void generic_broker_3_action_giveIllicitPointerQuest(obj_id player, obj_id npc)
    {
        float underworldFaction = factions.getFactionStanding(player, "underworld");
    ...
    public int generic_broker_3_tokenDI_frontMoney(obj_id player, obj_id npc)
    {
        return (smuggler.TIER_3_GENERIC_FRONT_COST);
    }
    public int generic_broker_3_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int generic_broker_3_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int generic_broker_3_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int generic_broker_3_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
