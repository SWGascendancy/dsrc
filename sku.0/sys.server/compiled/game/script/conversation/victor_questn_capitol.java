...
public class victor_questn_capitol extends script.base_script
{
    ...
    public boolean victor_questn_capitol_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean victor_questn_capitol_condition_NegaObj(obj_id player, obj_id npc)
    {
    ...
    public boolean victor_questn_capitol_condition_alreadyHasEvidence(obj_id player, obj_id npc)
    {
        return utils.playerHasItemByTemplate(player, "object/tangible/loot/quest/victor_questn_hlist.iff");
    }
    public boolean victor_questn_capitol_condition_hasNoroomObjvar(obj_id player, obj_id npc)
    {
        if (hasObjVar(npc, "bestine.electionStarted"))
        {
            int electionNum = getIntObjVar(npc, "bestine.electionStarted");
    ...
    public boolean victor_questn_capitol_condition_nonoffice(obj_id player, obj_id npc)
    {
        return hasObjVar(npc, "bestine.electionEnded");
    }
    public boolean victor_questn_capitol_condition_noInventorySpace(obj_id player, obj_id npc)
    {
    ...
    public void victor_questn_capitol_action_noroom(obj_id player, obj_id npc)
    {
        setObjVar(player, "bestine.victor_capitol_noroom", true);
    }
    public void victor_questn_capitol_action_giveList(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "bestine.victor_capitol_noroom"))
        {
    ...
    public int victor_questn_capitol_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int victor_questn_capitol_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int victor_questn_capitol_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
