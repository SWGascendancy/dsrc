...
public class heraldlok2 extends script.base_script
{
    ...
    public boolean heraldlok2_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public void heraldlok2_action_waypoint1(obj_id player, obj_id npc)
    {
    ...
    public void heraldlok2_action_waypoint2(obj_id player, obj_id npc)
    {
    ...
    public void heraldlok2_action_laugh(obj_id player, obj_id npc)
    {
        doAnimationAction(npc, "laugh_cackle");
    }
    public void heraldlok2_action_thoutful(obj_id player, obj_id npc)
    {
        doAnimationAction(npc, "rub_chin_thoughtful");
    }
    public void heraldlok2_action_dismiss(obj_id player, obj_id npc)
    {
        doAnimationAction(npc, "wave_on_dismissing");
    }
    public void heraldlok2_action_check(obj_id player, obj_id npc)
    {
        doAnimationAction(npc, "check_wrist_device");
    }
    public int heraldlok2_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int heraldlok2_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int heraldlok2_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int heraldlok2_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int heraldlok2_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int heraldlok2_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int heraldlok2_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
