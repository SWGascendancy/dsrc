...
public class menagerie_terminal_test extends script.base_script
{
    ...
    public boolean menagerie_terminal_test_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean menagerie_terminal_test_condition_CondFalse(obj_id player, obj_id npc)
    {
        return false;
    }
    public int menagerie_terminal_test_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
