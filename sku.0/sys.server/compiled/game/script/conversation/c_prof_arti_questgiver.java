...
public class c_prof_arti_questgiver extends script.base_script
{
    ...
    public boolean c_prof_arti_questgiver_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_prof_arti_questgiver_condition_playerOnQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean c_prof_arti_questgiver_condition_playerCompletedQuest(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/c_prof_arti");
        return questIsQuestComplete(questId1, player);
    }
    public boolean c_prof_arti_questgiver_condition_playerCompletedSolar(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/c_prof_arti");
        int solartool = groundquests.getTaskId(questId1, "solartool");
        return questIsTaskComplete(questId1, solartool, player);
    }
    public boolean c_prof_arti_questgiver_condition_playerCompletedGas(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/c_prof_arti");
        int gastool = groundquests.getTaskId(questId1, "gastool");
        return questIsTaskComplete(questId1, gastool, player);
    }
    public boolean c_prof_arti_questgiver_condition_playerCompletedChem(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/c_prof_arti");
        int chemicaltool = groundquests.getTaskId(questId1, "chemicaltool");
        return questIsTaskComplete(questId1, chemicaltool, player);
    }
    public boolean c_prof_arti_questgiver_condition_playerCompletedMineral(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/c_prof_arti");
        int mineraltool = groundquests.getTaskId(questId1, "mineraltool");
        return questIsTaskComplete(questId1, mineraltool, player);
    }
    public boolean c_prof_arti_questgiver_condition_playerCompletedWater(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/c_prof_arti");
        int watertool = groundquests.getTaskId(questId1, "watertool");
        return questIsTaskComplete(questId1, watertool, player);
    }
    public boolean c_prof_arti_questgiver_condition_playerCompletedFlora(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/c_prof_arti");
        int floratool = groundquests.getTaskId(questId1, "floratool");
        return questIsTaskComplete(questId1, floratool, player);
    }
    public boolean c_prof_arti_questgiver_condition_playerCompletedWind(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/c_prof_arti");
        int windtool = groundquests.getTaskId(questId1, "windtool");
        return questIsTaskComplete(questId1, windtool, player);
    }
    public boolean c_prof_arti_questgiver_condition_playerCompletedAll(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/c_prof_arti");
        int chemicaltool = groundquests.getTaskId(questId1, "chemicaltool");
        int windtool = groundquests.getTaskId(questId1, "windtool");
    ...
    public boolean c_prof_arti_questgiver_condition_playerhasArtisan(obj_id player, obj_id npc)
    {
    ...
    public void c_prof_arti_questgiver_action_faceplayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void c_prof_arti_questgiver_action_giveQuest(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/c_prof_arti");
        groundquests.grantQuest(questId, player, npc, true);
    }
    public void c_prof_arti_questgiver_action_completeQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "c_prof_arti_finished");
    }
    public int c_prof_arti_questgiver_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_prof_arti_questgiver_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_prof_arti_questgiver_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_prof_arti_questgiver_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_prof_arti_questgiver_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_prof_arti_questgiver_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_prof_arti_questgiver_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_prof_arti_questgiver_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_prof_arti_questgiver_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_prof_arti_questgiver_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_prof_arti_questgiver_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_prof_arti_questgiver_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_prof_arti_questgiver_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_171"))
        {
            if (c_prof_arti_questgiver_condition__defaultCondition(player, npc))
    ...
    public int c_prof_arti_questgiver_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_171"))
        {
            if (c_prof_arti_questgiver_condition__defaultCondition(player, npc))
    ...
    public int c_prof_arti_questgiver_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
