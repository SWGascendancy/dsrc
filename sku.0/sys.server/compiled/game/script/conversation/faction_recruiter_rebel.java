...
public class faction_recruiter_rebel extends script.base_script
{
    ...
    public boolean faction_recruiter_rebel_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean faction_recruiter_rebel_condition_isInFaction(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean faction_recruiter_rebel_condition_isEnemyFaction(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (factions.isInEnemyFaction(player, npc) && (!factions.isPVPStatusChanging(player)));
    }
    public boolean faction_recruiter_rebel_condition_isBlockedByJoinTimer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean faction_recruiter_rebel_condition_playerQualifiesForPromotion(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (factions.qualifiesForPromotion(player, pvpGetAlignedFaction(npc)) && (!factions.isPVPStatusChanging(player)));
    }
    public boolean faction_recruiter_rebel_condition_isChangingFaction(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return factions.isPVPStatusChanging(player);
    }
    public boolean faction_recruiter_rebel_condition_onLeaveFromFriendlyFaction(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (factions.isOnLeaveFromFriendlyFaction(player, npc) && (!factions.isPVPStatusChanging(player)));
    }
    public boolean faction_recruiter_rebel_condition_onLeaveFromEnemyFaction(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (factions.isOnLeaveFromEnemyFaction(player, npc) && (!factions.isPVPStatusChanging(player)));
    }
    public boolean faction_recruiter_rebel_condition_isCovert(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (pvpGetType(player) == PVPTYPE_COVERT) && (!factions.isPVPStatusChanging(player));
    }
    public boolean faction_recruiter_rebel_condition_isOvert(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return ((pvpGetType(player) == PVPTYPE_DECLARED) && (!factions.isPVPStatusChanging(player)));
    }
    public boolean faction_recruiter_rebel_condition_playerCanBuyFaction(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (factions.isSmuggler(player) && (factions.canBuyFaction(player, npc)) && (!factions.isPVPStatusChanging(player)));
    }
    public boolean faction_recruiter_rebel_condition_isAllowedToJoinFaction(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return factions.canJoinFaction(player, pvpGetAlignedFaction(npc));
    }
    public boolean faction_recruiter_rebel_condition_isRebelMercForGcw(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return factions.isRebelHelper(player);
    }
    public boolean faction_recruiter_rebel_condition_canChangeStatus(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return factions.canGoOnLeave(player);
    }
    public boolean faction_recruiter_rebel_condition_canBeMerc(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean faction_recruiter_rebel_condition_isRebOrImpMerc(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean faction_recruiter_rebel_condition_isImpMercForGcw(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return factions.isImperialHelper(player);
    }
    public boolean faction_recruiter_rebel_condition_isInvulnerableRecruiter(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return isInvulnerable(npc);
    }
    public void faction_recruiter_rebel_action_showFactionGcwRewardUi(obj_id player, obj_id npc)
    {
        dictionary d = new dictionary();
        d.put("player", player);
        messageTo(npc, "showInventorySUI", d, 0, false);
    }
    public void faction_recruiter_rebel_action_enablePVPTimer(obj_id player, obj_id npc)
    {
        factions.goOvertWithDelay(player, 30);
    }
    public void faction_recruiter_rebel_action_playerJoinFaction(obj_id player, obj_id npc)
    {
        factions.joinFaction(player, pvpGetAlignedFaction(npc));
    }
    public void faction_recruiter_rebel_action_playerGoOnLeaveTimer(obj_id player, obj_id npc)
    {
        factions.goOnLeaveWithDelay(player, 60);
    }
    public void faction_recruiter_rebel_action_makeRebMercSF(obj_id player, obj_id npc)
    {
        factions.setNeturalMercenaryOvert(player, factions.FACTION_FLAG_REBEL);
    }
    public void faction_recruiter_rebel_action_makeRebMercCombatant(obj_id player, obj_id npc)
    {
        factions.setNeturalMercenaryCovert(player, factions.FACTION_FLAG_REBEL);
    }
    public void faction_recruiter_rebel_action_playerGoCovertTimer(obj_id player, obj_id npc)
    {
        factions.goCovertWithDelay(player, 300);
    }
    public void faction_recruiter_rebel_action_grantPromotion(obj_id player, obj_id npc)
    {
        factions.applyPromotion(player, pvpGetAlignedFaction(npc));
    }
    public void faction_recruiter_rebel_action_buy1250FactionPoints(obj_id player, obj_id npc)
    {
        factions.buyFaction(player, npc, 100000);
    }
    public void faction_recruiter_rebel_action_buy250FactionPoints(obj_id player, obj_id npc)
    {
        factions.buyFaction(player, npc, 20000);
    }
    public void faction_recruiter_rebel_action_completelyResign(obj_id player, obj_id npc)
    {
        factions.leaveFaction(player, pvpGetAlignedFaction(npc));
    }
    public void faction_recruiter_rebel_action_goCovertShortTimer(obj_id player, obj_id npc)
    {
        factions.goCovertWithDelay(player, 30);
    }
    public void faction_recruiter_rebel_action_showGcwRewardsList(obj_id player, obj_id npc)
    {
    ...
    public String faction_recruiter_rebel_tokenTO_getFactionRankName(obj_id player, obj_id npc)
    {
    ...
    public String faction_recruiter_rebel_tokenTO_getRebelScoreString(obj_id player, obj_id npc)
    {
        return "" + getIntObjVar(npc, "Rebel.controlScore");
    }
    public int faction_recruiter_rebel_tokenDI_getImperialScore(obj_id player, obj_id npc)
    {
        return getIntObjVar(npc, "Imperial.controlScore");
    }
    public int faction_recruiter_rebel_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int faction_recruiter_rebel_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int faction_recruiter_rebel_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int faction_recruiter_rebel_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int faction_recruiter_rebel_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int faction_recruiter_rebel_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_73"))
        {
            if (faction_recruiter_rebel_condition_isInvulnerableRecruiter(player, npc))
    ...
    public int faction_recruiter_rebel_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int faction_recruiter_rebel_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_73"))
        {
            if (faction_recruiter_rebel_condition_isInvulnerableRecruiter(player, npc))
    ...
    public int faction_recruiter_rebel_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int faction_recruiter_rebel_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_73"))
        {
            if (faction_recruiter_rebel_condition_isInvulnerableRecruiter(player, npc))
    ...
    public int faction_recruiter_rebel_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int faction_recruiter_rebel_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_73"))
        {
            if (faction_recruiter_rebel_condition_isInvulnerableRecruiter(player, npc))
    ...
    public int faction_recruiter_rebel_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_73"))
        {
            if (faction_recruiter_rebel_condition_isInvulnerableRecruiter(player, npc))
    ...
    public int faction_recruiter_rebel_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int faction_recruiter_rebel_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int faction_recruiter_rebel_handleBranch30(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int faction_recruiter_rebel_handleBranch36(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int faction_recruiter_rebel_handleBranch37(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int faction_recruiter_rebel_handleBranch38(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int faction_recruiter_rebel_handleBranch39(obj_id player, obj_id npc, string_id response)
    {
