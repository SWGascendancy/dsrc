...
public class camp_delta_leader extends script.base_script
{
    ...
    public boolean camp_delta_leader_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean camp_delta_leader_condition_hasRadio(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "outbreak_radio_delivery_03", "findBossInCharge");
    }
    public boolean camp_delta_leader_condition_hasBaton(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "outbreak_stun_baton_hidden_content", "hasBaton");
    }
    public void camp_delta_leader_action_deliverRadioSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "hasFoundBossCampDelta");
    }
    public void camp_delta_leader_action_hasDeliveredBaton(obj_id player, obj_id npc)
    {
    ...
    public int camp_delta_leader_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int camp_delta_leader_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int camp_delta_leader_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int camp_delta_leader_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int camp_delta_leader_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int camp_delta_leader_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int camp_delta_leader_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int camp_delta_leader_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
