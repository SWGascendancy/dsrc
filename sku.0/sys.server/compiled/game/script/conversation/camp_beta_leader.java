...
public class camp_beta_leader extends script.base_script
{
    ...
    public boolean camp_beta_leader_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean camp_beta_leader_condition_hasRadio(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "outbreak_radio_delivery_01", "findBossInCharge");
    }
    public boolean camp_beta_leader_condition_hasBetsy(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "outbreak_betsy_hidden_content", "hasBetsy");
    }
    public void camp_beta_leader_action_deliverRadioSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "hasFoundBoss");
    }
    public void camp_beta_leader_action_hasDeliveredBetsy(obj_id player, obj_id npc)
    {
    ...
    public int camp_beta_leader_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int camp_beta_leader_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int camp_beta_leader_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int camp_beta_leader_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int camp_beta_leader_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int camp_beta_leader_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int camp_beta_leader_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int camp_beta_leader_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
