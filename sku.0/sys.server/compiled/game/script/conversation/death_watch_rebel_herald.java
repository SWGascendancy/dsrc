...
public class death_watch_rebel_herald extends script.base_script
{
    ...
    public boolean death_watch_rebel_herald_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean death_watch_rebel_herald_condition_NonRebelCheck(obj_id player, obj_id npc)
    {
    ...
    public boolean death_watch_rebel_herald_condition_RebelCheck(obj_id player, obj_id npc)
    {
        String playerFaction = factions.getFaction(player);
    ...
    public boolean death_watch_rebel_herald_condition_ReturnCheck(obj_id player, obj_id npc)
    {
    ...
    public boolean death_watch_rebel_herald_condition_RescueObjvar(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "death_watch_herald.rebelquest"))
        {
    ...
    public boolean death_watch_rebel_herald_condition_RewardCheck(obj_id player, obj_id npc)
    {
    ...
    public boolean death_watch_rebel_herald_condition_Questcomplete(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "death_watch_herald.rebelfinish"))
        {
            return true;
    ...
    public boolean death_watch_rebel_herald_condition_dungeonInactive(obj_id player, obj_id npc)
    {
        return false;
    }
    public void death_watch_rebel_herald_action_RescueandReward(obj_id player, obj_id npc)
    {
        if (!hasObjVar(player, "death_watch_herald.rebelfinish"))
        {
    ...
    public void death_watch_rebel_herald_action_QuestRemove(obj_id player, obj_id npc)
    {
        removeObjVar(player, "death_watch_herald.rebelquest");
        removeObjVar(player, "death_watch_herald.rebelrescue");
    }
    public void death_watch_rebel_herald_action_QuestAccept(obj_id player, obj_id npc)
    {
