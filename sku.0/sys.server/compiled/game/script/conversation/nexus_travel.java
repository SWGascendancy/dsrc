...
public class nexus_travel extends script.base_script
{
    ...
    public boolean nexus_travel_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean nexus_travel_condition_isEligible(obj_id player, obj_id npc)
    {
        return township.isTownshipEligible(player);
    }
    public boolean nexus_travel_condition_hasMet(obj_id player, obj_id npc)
    {
    ...
    public boolean nexus_travel_condition_hasFoundAurillia(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "travel_found");
    }
    public boolean nexus_travel_condition_canAffordPay(obj_id player, obj_id npc)
    {
        return money.hasFunds(player, money.MT_TOTAL, township.TRAVEL_COST);
    }
    public void nexus_travel_action_travelAurillia(obj_id player, obj_id npc)
    {
    ...
    public void nexus_travel_action_setMet(obj_id player, obj_id npc)
    {
        setObjVar(player, "towship.metTravel", true);
    }
    public int nexus_travel_tokenDI_travelCost(obj_id player, obj_id npc)
    {
        return township.TRAVEL_COST;
    }
    public int nexus_travel_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nexus_travel_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nexus_travel_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nexus_travel_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nexusTravelAurillia(obj_id self, dictionary params)
    {
    ...
    public int handleTransaction(obj_id self, dictionary params)
    {
