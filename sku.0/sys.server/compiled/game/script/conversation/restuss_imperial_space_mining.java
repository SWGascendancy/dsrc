...
public class restuss_imperial_space_mining extends script.base_script
{
    ...
    public boolean restuss_imperial_space_mining_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean restuss_imperial_space_mining_condition_completedSpaceMine1(obj_id player, obj_id npc)
    {
    ...
    public boolean restuss_imperial_space_mining_condition_spaceMineActive1(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "restuss_imperial_space_mining_1");
    }
    public boolean restuss_imperial_space_mining_condition_completedSpaceMine2(obj_id player, obj_id npc)
    {
    ...
    public boolean restuss_imperial_space_mining_condition_spaceMineActive2(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "restuss_imperial_space_mining_2");
    }
    public boolean restuss_imperial_space_mining_condition_inPhase2(obj_id player, obj_id npc)
    {
    ...
    public boolean restuss_imperial_space_mining_condition_inPhase1(obj_id player, obj_id npc)
    {
    ...
    public boolean restuss_imperial_space_mining_condition_enoughOre(obj_id player, obj_id npc)
    {
        obj_id object = trial.getParent(npc);
    ...
    public boolean restuss_imperial_space_mining_condition_isRebelPlayer(obj_id player, obj_id npc)
    {
        return factions.isRebel(player);
    }
    public void restuss_imperial_space_mining_action_giveSpaceMine1(obj_id player, obj_id npc)
    {
    ...
    public void restuss_imperial_space_mining_action_signalDone(obj_id player, obj_id npc)
    {
        obj_id[] boxes = utils.getAllItemsPlayerHasByTemplate(player, "object/resource_container/space/metal.iff");
        obj_id currentBox = null;
        obj_id currentBoxResource = null;
    ...
    public void restuss_imperial_space_mining_action_giveSpaceMine2(obj_id player, obj_id npc)
    {
    ...
    public void restuss_imperial_space_mining_action_signalDone2(obj_id player, obj_id npc)
    {
        obj_id[] boxes = utils.getAllItemsPlayerHasByTemplate(player, "object/resource_container/space/gas.iff");
        obj_id currentBox = null;
        obj_id currentBoxResource = null;
    ...
    public void restuss_imperial_space_mining_action_eject(obj_id player, obj_id npc)
    {
        expelFromBuilding(player);
    }
    public int restuss_imperial_space_mining_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int restuss_imperial_space_mining_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int restuss_imperial_space_mining_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
