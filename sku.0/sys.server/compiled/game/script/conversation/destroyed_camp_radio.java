...
public class destroyed_camp_radio extends script.base_script
{
    ...
    public boolean destroyed_camp_radio_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean destroyed_camp_radio_condition_isOnTask01(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_kachirho_destroyed_camp", "reportLisum");
    }
    public boolean destroyed_camp_radio_condition_isOnTask02(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_kachirho_destroyed_camp", "foundItems");
    }
    public boolean destroyed_camp_radio_condition_isOnTask03(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_kachirho_destroyed_camp", "canopyDead");
    }
    public boolean destroyed_camp_radio_condition_isOnMission(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_kachirho_destroyed_camp");
    }
    public boolean destroyed_camp_radio_condition_hasCompletedSeries(obj_id player, obj_id npc)
    {
    ...
    public void destroyed_camp_radio_action_doSignal01(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "huntResearchers");
    }
    public void destroyed_camp_radio_action_doSignal02(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "huntCanopy");
    }
    public void destroyed_camp_radio_action_doSignal03(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "codeReceived");
    }
    public void destroyed_camp_radio_action_grantMission(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_kachirho_destroyed_camp");
    }
    public void destroyed_camp_radio_action_sendStatic(obj_id player, obj_id npc)
    {
        playClientEffectLoc(player, "clienteffect/ep3_radio_static.cef.cef", getLocation(npc), 0.0f);
    }
    public int destroyed_camp_radio_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int destroyed_camp_radio_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int destroyed_camp_radio_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int destroyed_camp_radio_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int destroyed_camp_radio_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int destroyed_camp_radio_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int destroyed_camp_radio_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int destroyed_camp_radio_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int destroyed_camp_radio_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int destroyed_camp_radio_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int destroyed_camp_radio_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int destroyed_camp_radio_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int destroyed_camp_radio_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int destroyed_camp_radio_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
