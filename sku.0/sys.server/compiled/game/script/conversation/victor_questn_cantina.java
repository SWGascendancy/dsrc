...
public class victor_questn_cantina extends script.base_script
{
    ...
    public boolean victor_questn_cantina_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean victor_questn_cantina_condition_NegQCheck(obj_id player, obj_id npc)
    {
    ...
    public boolean victor_questn_cantina_condition_hasEnoughMoney(obj_id player, obj_id npc)
    {
        return money.hasFunds(player, money.MT_TOTAL, 200);
    }
    public boolean victor_questn_cantina_condition_hasNoroomObjVar(obj_id player, obj_id npc)
    {
        if (hasObjVar(npc, "bestine.electionStarted"))
        {
            int electionNum = getIntObjVar(npc, "bestine.electionStarted");
    ...
    public boolean victor_questn_cantina_condition_nonoffice(obj_id player, obj_id npc)
    {
        return hasObjVar(npc, "bestine.electionEnded");
    }
    public boolean victor_questn_cantina_condition_noInventorySpace(obj_id player, obj_id npc)
    {
    ...
    public boolean victor_questn_cantina_condition_alreadyHasEvidence(obj_id player, obj_id npc)
    {
        return utils.playerHasItemByTemplate(player, "object/tangible/loot/quest/victor_questn_dseal.iff");
    }
    public void victor_questn_cantina_action__defaultAction(obj_id player, obj_id npc)
    {
    }
    public void victor_questn_cantina_action_Noroom(obj_id player, obj_id npc)
    {
        setObjVar(player, "bestine.victor_cantina_noroom", true);
    }
    public void victor_questn_cantina_action_givePaper(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "bestine.victor_cantina_noroom"))
        {
