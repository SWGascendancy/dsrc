...
public class corellia_tyrena_gordo_zek extends script.base_script
{
    ...
    public boolean corellia_tyrena_gordo_zek_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_tyrena_gordo_zek_condition_talkGordo(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_tyrena_forgotten_child", "forgotten_child_talk_gordo");
    }
    public boolean corellia_tyrena_gordo_zek_condition_completeForgotten(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "corellia_tyrena_forgotten_child");
    }
    public boolean corellia_tyrena_gordo_zek_condition_onForgotten(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_tyrena_forgotten_child", "forgotten_child_slice_admin_term");
    }
    public boolean corellia_tyrena_gordo_zek_condition_returnGordo(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_tyrena_forgotten_child", "forgotten_return_to_gordo");
    }
    public void corellia_tyrena_gordo_zek_action_signalGordo(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "forgotten_child_talk_gordo");
    }
    public void corellia_tyrena_gordo_zek_action_signalReturnGordo(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "forgotten_return_to_gordo");
    }
    public int corellia_tyrena_gordo_zek_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_gordo_zek_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_gordo_zek_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_gordo_zek_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_gordo_zek_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_gordo_zek_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_gordo_zek_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_gordo_zek_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
