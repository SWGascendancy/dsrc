...
public class npe_side_robbery_thief extends script.base_script
{
    ...
    public boolean npe_side_robbery_thief_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_side_robbery_thief_condition_playerOnQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "npe_side_robbery");
    }
    public boolean npe_side_robbery_thief_condition_playerDoneWithQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_side_robbery");
    }
    public boolean npe_side_robbery_thief_condition_playerdecided(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "npe_side_robbery", "temptation");
    }
    public boolean npe_side_robbery_thief_condition_playertookbribe(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_side_robbery", "hasfake");
    }
    public boolean npe_side_robbery_thief_condition_gimmeproto(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_side_robbery", "gimmeproto");
    }
    public void npe_side_robbery_thief_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void npe_side_robbery_thief_action_signalfind(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_side1_found_thief");
    }
    public void npe_side_robbery_thief_action_takebribe(obj_id player, obj_id npc)
    {
        groundquests.failTask(player, "npe_side_robbery", "temptation");
    }
    public void npe_side_robbery_thief_action_nobribe(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_side1_bribe");
    }
    public void npe_side_robbery_thief_action_signalprototaken(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_side1_gimme_proto");
    }
    public int npe_side_robbery_thief_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_side_robbery_thief_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_side_robbery_thief_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_side_robbery_thief_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_side_robbery_thief_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_side_robbery_thief_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
