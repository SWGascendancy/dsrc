...
public class rebel_defensive_supply_terminal extends script.base_script
{
    ...
    public boolean rebel_defensive_supply_terminal_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean rebel_defensive_supply_terminal_condition_isTrader(obj_id player, obj_id npc)
    {
    ...
    public boolean rebel_defensive_supply_terminal_condition_isRebelPlayer(obj_id player, obj_id npc)
    {
    ...
    public boolean rebel_defensive_supply_terminal_condition_isImperialPlayer(obj_id player, obj_id npc)
    {
        return (factions.isImperialorImperialHelper(player));
    }
    public boolean rebel_defensive_supply_terminal_condition_isSliced(obj_id player, obj_id npc)
    {
    ...
    public boolean rebel_defensive_supply_terminal_condition_canGetCband(obj_id player, obj_id npc)
    {
    ...
    public boolean rebel_defensive_supply_terminal_condition_isGodCheck(obj_id player, obj_id npc)
    {
        return isGod(player);
    }
    public boolean rebel_defensive_supply_terminal_condition_isMaxScanLevel(obj_id player, obj_id npc)
    {
    ...
    public boolean rebel_defensive_supply_terminal_condition_isSlicing(obj_id player, obj_id npc)
    {
        if (groundquests.isQuestActive(player, gcw.GCW_SMUGGLER_SLICING))
        {
            return true;
    ...
    public boolean rebel_defensive_supply_terminal_condition_missingSequence(obj_id player, obj_id npc)
    {
    ...
    public boolean rebel_defensive_supply_terminal_condition_noSlicingQuest(obj_id player, obj_id npc)
    {
        if (!groundquests.isQuestActive(player, gcw.GCW_SMUGGLER_SLICING))
        {
            return true;
    ...
    public boolean rebel_defensive_supply_terminal_condition_slicePipeline(obj_id player, obj_id npc)
    {
        int scanTier = 0;
        if (utils.hasScriptVar(player, "gcw.terminalScanTier"))
        {
    ...
    public boolean rebel_defensive_supply_terminal_condition_sliceInstruction(obj_id player, obj_id npc)
    {
        int scanTier = 0;
        if (utils.hasScriptVar(player, "gcw.terminalScanTier"))
        {
    ...
    public boolean rebel_defensive_supply_terminal_condition_sliceOpCore(obj_id player, obj_id npc)
    {
        int scanTier = 0;
        if (utils.hasScriptVar(player, "gcw.terminalScanTier"))
        {
    ...
    public boolean rebel_defensive_supply_terminal_condition_maxScanLevel(obj_id player, obj_id npc)
    {
        if (!groundquests.isQuestActive(player, gcw.GCW_SMUGGLER_SLICING))
        {
            return false;
    ...
    public boolean rebel_defensive_supply_terminal_condition_isSmuggler(obj_id player, obj_id npc)
    {
        return utils.isProfession(player, utils.SMUGGLER);
    }
    public boolean rebel_defensive_supply_terminal_condition_notMissingCombination(obj_id player, obj_id npc)
    {
        if (utils.hasScriptVar(player, "gcw.sliceSequence"))
        {
            return true;
    ...
    public void rebel_defensive_supply_terminal_action_giveBarricadeItems(obj_id player, obj_id npc)
    {
    ...
    public void rebel_defensive_supply_terminal_action_giveTowerItems(obj_id player, obj_id npc)
    {
        obj_id pInv = utils.getInventoryContainer(player);
    ...
    public void rebel_defensive_supply_terminal_action_giveReinforcementItems(obj_id player, obj_id npc)
    {
        obj_id pInv = utils.getInventoryContainer(player);
    ...
    public void rebel_defensive_supply_terminal_action_giveTurretItems(obj_id player, obj_id npc)
    {
        obj_id pInv = utils.getInventoryContainer(player);
    ...
    public void rebel_defensive_supply_terminal_action_startSlicing(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        messageTo(npc, "startSlicing", params, 1.0f, false);
    }
    public void rebel_defensive_supply_terminal_action_closeSliceSUI(obj_id player, obj_id npc)
    {
        int pid = utils.getIntScriptVar(player, "PIDvar");
        sui.closeSUI(player, pid);
    }
    public void rebel_defensive_supply_terminal_action_increaseCharge(obj_id player, obj_id npc)
    {
        int charges;
    ...
    public void rebel_defensive_supply_terminal_action_resetCharges(obj_id player, obj_id npc)
    {
        int charges = 0;
        setObjVar(npc, "gcw.contraband", charges);
    }
    public void rebel_defensive_supply_terminal_action_giveContraband(obj_id player, obj_id npc)
    {
        obj_id pInv = utils.getInventoryContainer(player);
        if (hasObjVar(npc, "gcw.contraband"))
        {
    ...
    public void rebel_defensive_supply_terminal_action_correctSlice(obj_id player, obj_id npc)
    {
        if (!utils.hasScriptVar(player, "gcw.terminalScanTier"))
        {
    ...
    public void rebel_defensive_supply_terminal_action_incorrectSlice(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "gcw.terminalScanTier", 0);
    }
    public void rebel_defensive_supply_terminal_action_grantSlicingQuest(obj_id player, obj_id npc)
    {
    ...
    public int rebel_defensive_supply_terminal_tokenDI_sliceTier(obj_id player, obj_id npc)
    {
        int tier = 0;
        if (utils.hasScriptVar(player, "gcw.terminalScanTier"))
        {
    ...
    public int rebel_defensive_supply_terminal_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_defensive_supply_terminal_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_defensive_supply_terminal_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_defensive_supply_terminal_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_defensive_supply_terminal_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_defensive_supply_terminal_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_defensive_supply_terminal_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_defensive_supply_terminal_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_defensive_supply_terminal_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_defensive_supply_terminal_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_defensive_supply_terminal_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_defensive_supply_terminal_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_defensive_supply_terminal_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_defensive_supply_terminal_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_defensive_supply_terminal_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_defensive_supply_terminal_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_defensive_supply_terminal_handleBranch32(obj_id player, obj_id npc, string_id response)
    {
