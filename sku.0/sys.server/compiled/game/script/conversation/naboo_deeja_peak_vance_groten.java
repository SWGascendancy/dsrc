...
public class naboo_deeja_peak_vance_groten extends script.base_script
{
    ...
    public boolean naboo_deeja_peak_vance_groten_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean naboo_deeja_peak_vance_groten_condition_startBeaconQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_deeja_peak_vance_groten_condition_onSafetyQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "naboo_deeja_peak_beacon_safety");
    }
    public boolean naboo_deeja_peak_vance_groten_condition_finishedSafetyQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_deeja_peak_vance_groten_condition_onDarknessQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "naboo_deeja_peak_beacon_darkness");
    }
    public boolean naboo_deeja_peak_vance_groten_condition_finishedDarknessQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_deeja_peak_vance_groten_condition_onFavorQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "naboo_deeja_peak_beacon_favor");
    }
    public boolean naboo_deeja_peak_vance_groten_condition_finishedFavorQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_deeja_peak_vance_groten_condition_completedBeaconQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_deeja_peak_vance_groten_condition_onMercsQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "naboo_deeja_peak_beacon_mercs");
    }
    public boolean naboo_deeja_peak_vance_groten_condition_finishedMercQuest(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "naboo_deeja_peak_beacon_mercs", "deeja_peak_beacon_mercs_05");
    }
    public boolean naboo_deeja_peak_vance_groten_condition_noLuckWithKippy(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "naboo_deeja_peak_beacon_darkness", "deeja_peak_beacon_darkness_04");
    }
    public void naboo_deeja_peak_vance_groten_action_grantSafetyQuest(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "naboo_deeja_peak_beacon_safety");
    }
    public void naboo_deeja_peak_vance_groten_action_grantDarknessQuest(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "naboo_deeja_peak_beacon_darkness");
    }
    public void naboo_deeja_peak_vance_groten_action_grantFavorQuest(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "naboo_deeja_peak_beacon_favor");
    }
    public void naboo_deeja_peak_vance_groten_action_grantMercsQuest(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "naboo_deeja_peak_beacon_mercs");
    }
    public void naboo_deeja_peak_vance_groten_action_signel_mercs_05(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "deeja_peak_beacon_mercs_05");
    }
    public void naboo_deeja_peak_vance_groten_action_signal_darkness_04(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "deeja_peak_beacon_darkness_04");
    }
    public void naboo_deeja_peak_vance_groten_action_endFavorQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "deeja_peak_beacon_favor_05");
    }
    public void naboo_deeja_peak_vance_groten_action_endDarknessQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "deeja_peak_beacon_darkness_10");
    }
    public void naboo_deeja_peak_vance_groten_action_endSafetyQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "deeja_peak_beacon_safety_05");
    }
    public void naboo_deeja_peak_vance_groten_action_endGotoVance(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "deeja_peak_goto_vance");
    }
    public int naboo_deeja_peak_vance_groten_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_deeja_peak_vance_groten_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_deeja_peak_vance_groten_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_deeja_peak_vance_groten_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_deeja_peak_vance_groten_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_deeja_peak_vance_groten_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_deeja_peak_vance_groten_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_deeja_peak_vance_groten_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_deeja_peak_vance_groten_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_deeja_peak_vance_groten_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_deeja_peak_vance_groten_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_deeja_peak_vance_groten_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_deeja_peak_vance_groten_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_deeja_peak_vance_groten_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
