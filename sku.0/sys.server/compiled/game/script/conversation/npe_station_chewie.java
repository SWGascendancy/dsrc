...
public class npe_station_chewie extends script.base_script
{
    ...
    public boolean npe_station_chewie_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_station_chewie_condition_isWookiee(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_station_chewie_condition_isWookieeFinishedQuest(obj_id player, obj_id npc)
    {
        return (npe_station_chewie_condition_isWookiee(player, npc) && groundquests.hasCompletedQuest(player, "npe_side_jolka"));
    }
    public void npe_station_chewie_action_playRoar(obj_id player, obj_id npc)
    {
