...
public class ep3_myyydril_greeter_mystic_1 extends script.base_script
{
    ...
    public boolean ep3_myyydril_greeter_mystic_1_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_myyydril_greeter_mystic_1_condition_Kallaarac(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_myyydril_kivvaaa_talkto_1", 0);
    }
    public boolean ep3_myyydril_greeter_mystic_1_condition_Helping(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_myyydril_kivvaaa_talkto_1");
    }
    public boolean ep3_myyydril_greeter_mystic_1_condition_Caverns(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_myyydril_nawika_talkto_5");
    }
    public boolean ep3_myyydril_greeter_mystic_1_condition_Hero(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_myyydril_kallaarac_destroy_3");
    }
    public boolean ep3_myyydril_greeter_mystic_1_condition_Doctor(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_myyydril_yraka_talkto_6", 0);
    }
    public boolean ep3_myyydril_greeter_mystic_1_condition_Lorn(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_myyydril_kinesworthy_epic_3", 0);
    }
    public boolean ep3_myyydril_greeter_mystic_1_condition_End(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_myyydril_kinesworthy_epic_3");
    }
    public boolean ep3_myyydril_greeter_mystic_1_condition_hasLanguage(obj_id player, obj_id npc)
    {
        return utils.canSpeakWookiee(player, npc);
    }
    public void ep3_myyydril_greeter_mystic_1_action_Language(obj_id player, obj_id npc)
    {
        utils.emoteWookieeConfusion(player, npc);
    }
    public int ep3_myyydril_greeter_mystic_1_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_greeter_mystic_1_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_greeter_mystic_1_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_greeter_mystic_1_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_greeter_mystic_1_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_greeter_mystic_1_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_greeter_mystic_1_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_greeter_mystic_1_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_greeter_mystic_1_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_greeter_mystic_1_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_greeter_mystic_1_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_greeter_mystic_1_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
