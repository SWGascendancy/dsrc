...
public class kole extends script.base_script
{
    ...
    public boolean kole_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean kole_condition_hasCompletedMine(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean kole_condition_hasCompletedMoore(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "u16_nym_themepark_second_interview_moore", "tellKoleMoore");
    }
    public boolean kole_condition_hasMooreQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isQuestActive(player, "u16_nym_themepark_second_interview_moore");
    }
    public boolean kole_condition_hasMooreNotResearch(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean kole_condition_hasDoneResearchFacility(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "u16_nym_themepark_research_facility", "returnResearchFacilityComplete");
    }
    public boolean kole_condition_hasCompletedResearchFacilityDoesntHaveArena(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean kole_condition_hasResearchQuestOrNeedsQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean kole_condition_hasCompletedThemepark(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.hasCompletedQuest(player, "u16_nym_themepark_shuttle_ambush");
    }
    public void kole_action_grantInterviewMoore(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        groundquests.grantQuest(player, "u16_nym_themepark_second_interview_moore");
    }
    public void kole_action_grantFacilityQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public void kole_action_finishMooreQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        groundquests.sendSignal(player, "hasToldKoleMoore");
    }
    public void kole_action_completeResearchFacility(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        groundquests.sendSignal(player, "hasCompletedResearchFacility");
    }
    public void kole_action_hasFoundKole(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "hasFoundKole");
    }
    public void kole_action_gotoNym(obj_id player, obj_id npc)
    {
    ...
    public int kole_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int kole_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int kole_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int kole_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int kole_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int kole_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int kole_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int kole_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int kole_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int kole_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int kole_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int kole_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int kole_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int kole_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
