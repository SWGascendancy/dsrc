...
public class loveday_romance_target extends script.base_script
{
    ...
    public boolean loveday_romance_target_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean loveday_romance_target_condition_hasQuest(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "loveday_playing_cupid", "loveday_playing_cupid_01");
    }
    public boolean loveday_romance_target_condition_companionNotOut(obj_id player, obj_id npc)
    {
    ...
    public boolean loveday_romance_target_condition_wrongGender(obj_id player, obj_id npc)
    {
        obj_id controlDevice = holiday.getLovedayRomanceSeekerCompanionControlDevice(player);
        if (isIdValid(controlDevice))
        {
    ...
    public boolean loveday_romance_target_condition_hasNoCompanion(obj_id player, obj_id npc)
    {
        if (groundquests.isTaskActive(player, "loveday_playing_cupid", "loveday_playing_cupid_01"))
        {
            obj_id controlDevice = holiday.getLovedayRomanceSeekerCompanionControlDevice(player);
    ...
    public boolean loveday_romance_target_condition_goodMatch(obj_id player, obj_id npc)
    {
    ...
    public boolean loveday_romance_target_condition_alreadyMatched(obj_id player, obj_id npc)
    {
    ...
    public boolean loveday_romance_target_condition_wasRejected(obj_id player, obj_id npc)
    {
        return buff.hasBuff(player, "loveday_rejected");
    }
    public void loveday_romance_target_action_completeMatch(obj_id player, obj_id npc)
    {
    ...
    public void loveday_romance_target_action_rejected(obj_id player, obj_id npc)
    {
        buff.applyBuff(player, npc, "loveday_rejected");
    }
    public String loveday_romance_target_tokenTO_trait_00(obj_id player, obj_id npc)
    {
    ...
    public String loveday_romance_target_tokenTO_trait_04(obj_id player, obj_id npc)
    {
        String file = "event/love_day";
        Vector randomOrder = utils.getResizeableIntArrayScriptVar(player, "traits_randomOrder");
    ...
    public String loveday_romance_target_tokenTO_trait_03(obj_id player, obj_id npc)
    {
        String file = "event/love_day";
        Vector randomOrder = utils.getResizeableIntArrayScriptVar(player, "traits_randomOrder");
    ...
    public String loveday_romance_target_tokenTO_trait_02(obj_id player, obj_id npc)
    {
        String file = "event/love_day";
        Vector randomOrder = utils.getResizeableIntArrayScriptVar(player, "traits_randomOrder");
    ...
    public String loveday_romance_target_tokenTO_trait_01(obj_id player, obj_id npc)
    {
        String file = "event/love_day";
        Vector randomOrder = utils.getResizeableIntArrayScriptVar(player, "traits_randomOrder");
    ...
    public String loveday_romance_target_tokenTO_companionName(obj_id player, obj_id npc)
    {
        obj_id controlDevice = holiday.getLovedayRomanceSeekerCompanionControlDevice(player);
        if (isIdValid(controlDevice))
        {
    ...
    public int loveday_romance_target_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int loveday_romance_target_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int loveday_romance_target_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int loveday_romance_target_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int loveday_romance_target_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int loveday_romance_target_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int loveday_romance_target_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_30"))
        {
            if (loveday_romance_target_condition__defaultCondition(player, npc))
    ...
    public int loveday_romance_target_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_30"))
        {
            if (loveday_romance_target_condition__defaultCondition(player, npc))
    ...
    public int loveday_romance_target_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_30"))
        {
            if (loveday_romance_target_condition__defaultCondition(player, npc))
    ...
    public int loveday_romance_target_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_30"))
        {
            if (loveday_romance_target_condition__defaultCondition(player, npc))
    ...
    public int loveday_romance_target_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_30"))
        {
            if (loveday_romance_target_condition__defaultCondition(player, npc))
    ...
    public int loveday_romance_target_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
