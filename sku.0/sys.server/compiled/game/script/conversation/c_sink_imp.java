...
public class c_sink_imp extends script.base_script
{
    ...
    public boolean c_sink_imp_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_sink_imp_condition_IsImperial(obj_id player, obj_id npc)
    {
    ...
    public boolean c_sink_imp_condition_IsRebel(obj_id player, obj_id npc)
    {
    ...
    public boolean c_sink_imp_condition_isNeutral(obj_id player, obj_id npc)
    {
    ...
    public boolean c_sink_imp_condition_broughtPilotBack(obj_id player, obj_id npc)
    {
    ...
    public boolean c_sink_imp_condition_firstStepofQuest(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/c_sink_imp_v2");
    ...
    public boolean c_sink_imp_condition_gangKillStepDone(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/c_sink_imp_v2");
    ...
    public boolean c_sink_imp_condition_gangKillStepNotDone(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/c_sink_imp_v2");
        int spacesignal = groundquests.getTaskId(questId, "spacesignal");
        int killloot = groundquests.getTaskId(questId, "killloot");
    ...
    public boolean c_sink_imp_condition_gangKillStepActive(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/c_sink_imp_v2");
        int spacesignal = groundquests.getTaskId(questId, "spacesignal");
        return questIsTaskActive(questId, spacesignal, player);
    }
    public boolean c_sink_imp_condition_noGangsKilledYet(obj_id player, obj_id npc)
    {
    ...
    public boolean c_sink_imp_condition_hasJTL(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_sink_imp_condition_spaceWon(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "c_sink_imp_pt2", "c_sink_imp_kill_binyare_success_wfs");
    }
    public boolean c_sink_imp_condition_spaceLost(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "c_sink_imp_pt2", "c_sink_imp_kill_binyare_failed_wfs");
    }
    public boolean c_sink_imp_condition_spaceStepActive(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "c_sink_imp_pt2");
    }
    public boolean c_sink_imp_condition_spaceTaskActive(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "c_sink_imp_pt2", "c_sink_imp_kill_banyare_gsq");
    }
    public boolean c_sink_imp_condition_spaceNotActiveOrCmplt(obj_id player, obj_id npc)
    {
    ...
    public void c_sink_imp_action_giveQuest(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/c_sink_imp_v2");
    ...
    public void c_sink_imp_action_faceplayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void c_sink_imp_action_forwardQuestAfterEscort(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/c_sink_imp_v2");
    ...
    public void c_sink_imp_action_giveWaypoint(obj_id player, obj_id npc)
    {
        obj_id waypoint2 = getObjIdObjVar(player, "quest.general.quest/c_sink_imp_v2.pilot");
        if (waypoint2 != null)
        {
    ...
    public void c_sink_imp_action_rewardSignal(obj_id player, obj_id npc)
    {
    ...
    public void c_sink_imp_action_giveSpace(obj_id player, obj_id npc)
    {
    ...
    public void c_sink_imp_action_complete_quest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "c_sink_imp_gospace");
    }
    public void c_sink_imp_action_clearSpaceQuest(obj_id player, obj_id npc)
    {
        groundquests.clearQuest(player, "c_sink_imp_pt2");
    }
    public int c_sink_imp_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_sink_imp_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_sink_imp_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_sink_imp_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_sink_imp_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_sink_imp_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_sink_imp_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_sink_imp_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_sink_imp_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_sink_imp_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_sink_imp_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_sink_imp_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_sink_imp_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_sink_imp_handleBranch32(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_sink_imp_handleBranch34(obj_id player, obj_id npc, string_id response)
    {
