...
public class bounty_probot extends script.base_script
{
    ...
    public boolean bounty_probot_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean bounty_probot_condition_notMyHunter(obj_id player, obj_id npc)
    {
    ...
    public boolean bounty_probot_condition_noBioSig(obj_id player, obj_id npc)
    {
        obj_id objMission = getObjIdObjVar(npc, "objMission");
    ...
    public boolean bounty_probot_condition_readyToTrack(obj_id player, obj_id npc)
    {
        obj_id objPlayer = getObjIdObjVar(npc, "objPlayer");
        if (player == objPlayer)
        {
    ...
    public void bounty_probot_action_takeOff(obj_id player, obj_id npc)
    {
    ...
    public int bounty_probot_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
