...
public class rebel_remembrance_day_wedge_antilles extends script.base_script
{
    ...
    public boolean rebel_remembrance_day_wedge_antilles_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean rebel_remembrance_day_wedge_antilles_condition_isBelow60thLevelOrTraderEntertainer(obj_id player, obj_id npc)
    {
    ...
    public boolean rebel_remembrance_day_wedge_antilles_condition_isEntertainer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return utils.isProfession(player, utils.ENTERTAINER);
    }
    public boolean rebel_remembrance_day_wedge_antilles_condition_isTrader(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return utils.isProfession(player, utils.TRADER);
    }
    public boolean rebel_remembrance_day_wedge_antilles_condition_isBelow60thLevel(obj_id player, obj_id npc)
    {
        return (60 > getLevel(player));
    }
    public boolean rebel_remembrance_day_wedge_antilles_condition_hasAMisionActive(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_wedge_antilles_condition_hasAnIncompleteCombatMission(obj_id player, obj_id npc)
    {
    ...
    public boolean rebel_remembrance_day_wedge_antilles_condition_hasNotStartedSecondMission(obj_id player, obj_id npc)
    {
    ...
    public boolean rebel_remembrance_day_wedge_antilles_condition_isChampion(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return hasCompletedCollectionSlot(player, holiday.REMEMBRANCE_DAY_CHAMPION_BADGE);
    }
    public boolean rebel_remembrance_day_wedge_antilles_condition_completed7thQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, holiday.EMPIREDAYQUEST_REB_COMBAT_07);
    }
    public boolean rebel_remembrance_day_wedge_antilles_condition_completed7thQuestNoAutograph(obj_id player, obj_id npc)
    {
    ...
    public boolean rebel_remembrance_day_wedge_antilles_condition_isImperialPlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (factions.isImperial(player));
    }
    public boolean rebel_remembrance_day_wedge_antilles_condition_isNeutralPlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (!factions.isImperial(player) && !factions.isRebel(player));
    }
    public boolean rebel_remembrance_day_wedge_antilles_condition_completed7thQuestHasAutograph(obj_id player, obj_id npc)
    {
        return rebel_remembrance_day_wedge_antilles_condition_completed7thQuest(player, npc) && groundquests.isQuestActiveOrComplete(player, holiday.EMPIREDAYQUEST_REB_COMBAT_AUTOGRAPH);
    }
    public boolean rebel_remembrance_day_wedge_antilles_condition_hasCompleted7thMission(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (groundquests.hasCompletedQuest(player, holiday.EMPIREDAYQUEST_REB_COMBAT_07));
    }
    public boolean rebel_remembrance_day_wedge_antilles_condition_hasNotCompletedMission1(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_wedge_antilles_condition_hasCompleted1stMissionNot2nd(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_wedge_antilles_condition_hasCompleted2ndMissionNot3rd(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_wedge_antilles_condition_hasCompleted3rdMissionNot4th(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_wedge_antilles_condition_hasCompleted4thMissionNot5th(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_wedge_antilles_condition_hasCompleted5thMissionNot6th(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_wedge_antilles_condition_hasCompleted6thMissionNot7th(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public void rebel_remembrance_day_wedge_antilles_action_grantMissionOne(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, holiday.EMPIREDAYQUEST_REB_COMBAT_01);
    }
    public void rebel_remembrance_day_wedge_antilles_action_grantMissionTwo(obj_id player, obj_id npc)
    {
    ...
    public void rebel_remembrance_day_wedge_antilles_action_revokeMission2Regrant(obj_id player, obj_id npc)
    {
    ...
    public void rebel_remembrance_day_wedge_antilles_action_revokeMission3Regrant(obj_id player, obj_id npc)
    {
    ...
    public void rebel_remembrance_day_wedge_antilles_action_revokeMission4Regrant(obj_id player, obj_id npc)
    {
    ...
    public void rebel_remembrance_day_wedge_antilles_action_spawnTroopers(obj_id player, obj_id npc)
    {
        for (int i = 0; i < 3; i++)
        {
    ...
    public void rebel_remembrance_day_wedge_antilles_action_revokeMission5Regrant(obj_id player, obj_id npc)
    {
    ...
    public void rebel_remembrance_day_wedge_antilles_action_revokeMission6Regrant(obj_id player, obj_id npc)
    {
    ...
    public void rebel_remembrance_day_wedge_antilles_action_revokeMission7Regrant(obj_id player, obj_id npc)
    {
    ...
    public void rebel_remembrance_day_wedge_antilles_action_grantAutograph(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, holiday.EMPIREDAYQUEST_REB_COMBAT_AUTOGRAPH);
    }
    public void rebel_remembrance_day_wedge_antilles_action_giveWaypoint(obj_id player, obj_id npc)
    {
    ...
    public void rebel_remembrance_day_wedge_antilles_action_sendSignalToSpeak(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "hasSpokenToRecoveryQuestNpc");
    }
    public String rebel_remembrance_day_wedge_antilles_tokenTO_timeLeftRecruitment(obj_id player, obj_id npc)
    {
    ...
    public String rebel_remembrance_day_wedge_antilles_tokenTO_timeLeftPropaganda(obj_id player, obj_id npc)
    {
    ...
    public int rebel_remembrance_day_wedge_antilles_tokenDI_notUsed(obj_id player, obj_id npc)
    {
        return 0;
    }
    public int rebel_remembrance_day_wedge_antilles_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_wedge_antilles_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_wedge_antilles_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_wedge_antilles_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_wedge_antilles_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_wedge_antilles_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_wedge_antilles_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_wedge_antilles_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_wedge_antilles_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_wedge_antilles_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_wedge_antilles_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_wedge_antilles_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_wedge_antilles_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_wedge_antilles_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_wedge_antilles_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_wedge_antilles_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_wedge_antilles_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_wedge_antilles_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_wedge_antilles_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_wedge_antilles_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_wedge_antilles_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_wedge_antilles_handleBranch30(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_wedge_antilles_handleBranch31(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_86"))
        {
            if (rebel_remembrance_day_wedge_antilles_condition__defaultCondition(player, npc))
    ...
    public int rebel_remembrance_day_wedge_antilles_handleBranch32(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_wedge_antilles_handleBranch33(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_wedge_antilles_handleBranch34(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_wedge_antilles_handleBranch35(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_wedge_antilles_handleBranch36(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_wedge_antilles_handleBranch39(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_wedge_antilles_handleBranch40(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_wedge_antilles_handleBranch41(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_wedge_antilles_handleBranch42(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_wedge_antilles_handleBranch43(obj_id player, obj_id npc, string_id response)
    {
