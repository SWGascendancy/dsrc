...
public class tatooine_entha_ankwee extends script.base_script
{
    ...
    public boolean tatooine_entha_ankwee_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tatooine_entha_ankwee_condition_onMeetAnkwee(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "tatooine_espa_pod_retrieval_v2", "tat_espa_pod_retrieval_e1");
    }
    public boolean tatooine_entha_ankwee_condition_completedQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "tatooine_espa_pod_retrieval_v2");
    }
    public boolean tatooine_entha_ankwee_condition_onGotoDraknus(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "tatooine_espa_pod_retrieval_v2", "tat_espa_pod_retrieval_e1");
    }
    public boolean tatooine_entha_ankwee_condition_onRacing(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "tatooine_espa_pod_retrieval_v2", "tat_espa_pod_retrieval_e2");
    }
    public boolean tatooine_entha_ankwee_condition_onReturnAnKwee(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "tatooine_espa_pod_retrieval_v2", "tat_espa_pod_retrieval_e3");
    }
    public boolean tatooine_entha_ankwee_condition_onTalkAnKwee(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "tatooine_espa_pod_retrieval_v2", "tat_espa_pod_retrieval_e3");
    }
    public void tatooine_entha_ankwee_action_grantGotoDraknus(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "tatooine_entha_goto_draknus");
    }
    public void tatooine_entha_ankwee_action_signalPod(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tat_espa_pod_retrieval_e3");
    }
    public void tatooine_entha_ankwee_action_signalTalkAnKwee(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tat_espa_pod_retrieval_e1");
    }
    public int tatooine_entha_ankwee_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_entha_ankwee_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_entha_ankwee_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_entha_ankwee_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_entha_ankwee_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_entha_ankwee_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_entha_ankwee_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_entha_ankwee_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_entha_ankwee_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_entha_ankwee_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_entha_ankwee_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
