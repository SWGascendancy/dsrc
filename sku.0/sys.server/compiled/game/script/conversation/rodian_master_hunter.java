...
public class rodian_master_hunter extends script.base_script
{
    ...
    public boolean rodian_master_hunter_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean rodian_master_hunter_condition_isGenderMale(obj_id player, obj_id npc)
    {
        return (getGender(player) == GENDER_MALE);
    }
    public boolean rodian_master_hunter_condition_isSpeciesRodian(obj_id player, obj_id npc)
    {
        return (getSpecies(player) == SPECIES_RODIAN);
    }
    public void rodian_master_hunter_action_givequest_1(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/ep3_rodian_hunt_1");
        questActivateQuest(questId, player, npc);
    }
    public void rodian_master_hunter_action_givequest_2(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/ep3_rodian_hunt_2");
        questActivateQuest(questId, player, npc);
    }
    public void rodian_master_hunter_action_givequest_3(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/ep3_rodian_hunt_3");
        questActivateQuest(questId, player, npc);
    }
    public void rodian_master_hunter_action_clearQuests(obj_id player, obj_id npc)
    {
    ...
    public int rodian_master_hunter_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rodian_master_hunter_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rodian_master_hunter_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rodian_master_hunter_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rodian_master_hunter_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rodian_master_hunter_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rodian_master_hunter_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rodian_master_hunter_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rodian_master_hunter_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rodian_master_hunter_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rodian_master_hunter_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rodian_master_hunter_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rodian_master_hunter_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
