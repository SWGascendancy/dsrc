...
public class emp_day_data_officer extends script.base_script
{
    ...
    public boolean emp_day_data_officer_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean emp_day_data_officer_condition_isRebel(obj_id player, obj_id npc)
    {
    ...
    public boolean emp_day_data_officer_condition_notReadyForYou(obj_id player, obj_id npc)
    {
    ...
    public boolean emp_day_data_officer_condition_hasTask5(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/emp_day_imperial");
        int task5 = groundquests.getTaskId(questId, "toDataOfficer");
        return questIsTaskActive(questId, task5, player);
    }
    public boolean emp_day_data_officer_condition_hasTask6(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/emp_day_imperial");
        int task6 = groundquests.getTaskId(questId, "toCommander");
        return questIsTaskActive(questId, task6, player);
    }
    public void emp_day_data_officer_action_wpToCommander(obj_id player, obj_id npc)
    {
    ...
    public void emp_day_data_officer_action_signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "to_data_officer");
    }
    public int emp_day_data_officer_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_data_officer_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_data_officer_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_data_officer_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_data_officer_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
