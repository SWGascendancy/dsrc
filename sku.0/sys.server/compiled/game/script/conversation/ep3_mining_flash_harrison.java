...
public class ep3_mining_flash_harrison extends script.base_script
{
    ...
    public boolean ep3_mining_flash_harrison_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_mining_flash_harrison_condition_hasCompletedAllQuests(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedQuest(player, "ep3_mining_quest_1"));
    }
    public boolean ep3_mining_flash_harrison_condition_hasCompletedQuestOne(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedQuest(player, "ep3_mining_quest_1"));
    }
    public boolean ep3_mining_flash_harrison_condition_isOnQuestOne(obj_id player, obj_id npc)
    {
        return (groundquests.isQuestActive(player, "ep3_mining_quest_1"));
    }
    public void ep3_mining_flash_harrison_action_grantQuestOne(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_mining_quest_1");
    }
    public int ep3_mining_flash_harrison_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_mining_flash_harrison_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_mining_flash_harrison_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_mining_flash_harrison_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
