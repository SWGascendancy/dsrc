...
public class pvp_station_imperial extends script.base_script
{
    ...
    public boolean pvp_station_imperial_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean pvp_station_imperial_condition_isPlayerRebel(obj_id player, obj_id npc)
    {
        return (space_battlefield.isInRebelShip(player) || pvpGetAlignedFaction(player) == (370444368));
    }
    public boolean pvp_station_imperial_condition_isPlayerImperial(obj_id player, obj_id npc)
    {
        return space_battlefield.isInImperialShip(player);
    }
    public boolean pvp_station_imperial_condition_isImperialFactionWithMission(obj_id player, obj_id npc)
    {
    ...
    public boolean pvp_station_imperial_condition_isInYacht(obj_id player, obj_id npc)
    {
    ...
    public boolean pvp_station_imperial_condition_isPlayerNeutral(obj_id player, obj_id npc)
    {
        if (space_battlefield.isInNeutralShip(player))
        {
    ...
    public boolean pvp_station_imperial_condition_isTooFar(obj_id player, obj_id npc)
    {
        obj_id containingShip = space_transition.getContainingShip(player);
        return (getDistance(npc, containingShip) > space_transition.STATION_COMM_MAX_DISTANCE);
    }
    public void pvp_station_imperial_action_setPlayerToOvertStatus(obj_id player, obj_id npc)
    {
        space_transition.setPlayerOvert(player, (-615855020));
    }
    public int pvp_station_imperial_tokenDI_prestigeCost(obj_id player, obj_id npc)
    {
        return space_battlefield.getPrestigeCostForTransition(player, npc);
    }
    public int pvp_station_imperial_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int pvp_station_imperial_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int pvp_station_imperial_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int pvp_station_imperial_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_370822d1"))
        {
            if (pvp_station_imperial_condition__defaultCondition(player, npc))
