...
public class npe_station_kardde extends script.base_script
{
    ...
    public boolean npe_station_kardde_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public void npe_station_kardde_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
