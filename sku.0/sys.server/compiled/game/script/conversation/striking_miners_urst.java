...
public class striking_miners_urst extends script.base_script
{
    ...
    public boolean striking_miners_urst_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean striking_miners_urst_condition_onMission(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "som_striking_miners");
    }
    public boolean striking_miners_urst_condition_taskCompleted(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "som_striking_miners", "mustafar_striking_miners_five");
    }
    public boolean striking_miners_urst_condition_missionCompleted(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "som_striking_miners");
    }
    public void striking_miners_urst_action_grantMission(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "som_striking_miners");
    }
    public void striking_miners_urst_action_grantreward(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "mustafar_striking_miners_reward");
    }
    public int striking_miners_urst_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int striking_miners_urst_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int striking_miners_urst_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int striking_miners_urst_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int striking_miners_urst_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int striking_miners_urst_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
