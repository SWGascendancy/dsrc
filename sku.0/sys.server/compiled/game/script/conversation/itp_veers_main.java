...
public class itp_veers_main extends script.base_script
{
    ...
    public boolean itp_veers_main_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean itp_veers_main_condition_itp_veers_01_active(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "itp_veers_01");
    }
    public boolean itp_veers_main_condition_itp_veers_01_complete(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "itp_veers_01", "itp_veers_01_03") || groundquests.hasCompletedQuest(player, "itp_veers_01");
    }
    public boolean itp_veers_main_condition_itp_veers_02_active(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "itp_veers_02");
    }
    public boolean itp_veers_main_condition_itp_veers_02_failed(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "itp_veers_02", "itp_veers_02_04_fail");
    }
    public boolean itp_veers_main_condition_itp_veers_02_complete(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "itp_veers_02", "itp_veers_02_04") || groundquests.hasCompletedQuest(player, "itp_veers_02");
    }
    public boolean itp_veers_main_condition_completedThrawn(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "itp_thrawn_02");
    }
    public boolean itp_veers_main_condition_notImperial(obj_id player, obj_id npc)
    {
    ...
    public boolean itp_veers_main_condition_imperial_isOnLeave(obj_id player, obj_id npc)
    {
        return factions.isOnLeave(player);
    }
    public void itp_veers_main_action_itp_veers_01_granted(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "itp_veers_01");
    }
    public void itp_veers_main_action_itp_veers_01_signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "itp_veers_01_03");
    }
    public void itp_veers_main_action_itp_veers_02_signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "itp_veers_02_04");
    }
    public void itp_veers_main_action_itp_veers_02_granted(obj_id player, obj_id npc)
    {
    ...
    public int itp_veers_main_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int itp_veers_main_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int itp_veers_main_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
