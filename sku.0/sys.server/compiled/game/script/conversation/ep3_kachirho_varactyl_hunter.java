...
public class ep3_kachirho_varactyl_hunter extends script.base_script
{
    ...
    public boolean ep3_kachirho_varactyl_hunter_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_kachirho_varactyl_hunter_condition_isOnTask(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_kachirho_varactyl_hunt");
    }
    public boolean ep3_kachirho_varactyl_hunter_condition_hasCompletedTask01(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_kachirho_varactyl_hunt", "varactylKilled");
    }
    public boolean ep3_kachirho_varactyl_hunter_condition_hasCompletedMission(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_kachirho_varactyl_hunt");
    }
    public void ep3_kachirho_varactyl_hunter_action_grantMission(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_kachirho_varactyl_hunt");
    }
    public void ep3_kachirho_varactyl_hunter_action_sendSignal01(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "varactylReward");
    }
    public void ep3_kachirho_varactyl_hunter_action_clearMission(obj_id player, obj_id npc)
    {
        groundquests.clearQuest(player, "ep3_kachirho_varactyl_hunt");
    }
    public int ep3_kachirho_varactyl_hunter_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_varactyl_hunter_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_varactyl_hunter_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_varactyl_hunter_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_varactyl_hunter_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_varactyl_hunter_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_varactyl_hunter_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
