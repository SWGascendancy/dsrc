...
public class mtp_hideout_bomb_tech extends script.base_script
{
    ...
    public boolean mtp_hideout_bomb_tech_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean mtp_hideout_bomb_tech_condition_isElligibleForBombQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_hideout_bomb_tech_condition_hasCompletedOrActiveBombQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "quest/mtp_hideout_collect_bomb_items");
    }
    public boolean mtp_hideout_bomb_tech_condition_hasCompletedOrActiveLokCampQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "quest/mtp_camp_quest_lok");
    }
    public boolean mtp_hideout_bomb_tech_condition_hasCompletedLokCamp(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "quest/mtp_camp_quest_lok");
    }
    public boolean mtp_hideout_bomb_tech_condition_hasCompletedBombQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "quest/mtp_hideout_collect_bomb_items");
    }
    public boolean mtp_hideout_bomb_tech_condition_hasCompletedBothLokAndBomb(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_hideout_bomb_tech_condition_hasCompletedBombNotLok(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_hideout_bomb_tech_condition_hasBombActiveSignalWaiting(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_hideout_bomb_tech_condition_hasCompletedBombLokActive(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_hideout_bomb_tech_condition_bombQuestActiveButNotComplete(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "quest/mtp_hideout_collect_bomb_items");
    }
    public void mtp_hideout_bomb_tech_action_grantBombPartQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest/mtp_hideout_collect_bomb_items");
    }
    public void mtp_hideout_bomb_tech_action_sendSignalBombCompletion(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "spokeToTechnician");
    }
    public void mtp_hideout_bomb_tech_action_grantLokCampQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest/mtp_camp_quest_lok");
    }
    public void mtp_hideout_bomb_tech_action_clearBombAndRegrant(obj_id player, obj_id npc)
    {
        groundquests.clearQuest(player, "quest/mtp_hideout_collect_bomb_items");
        groundquests.grantQuest(player, "quest/mtp_hideout_collect_bomb_items");
    }
    public void mtp_hideout_bomb_tech_action_clearLokAndRegrant(obj_id player, obj_id npc)
    {
        groundquests.clearQuest(player, "quest/mtp_camp_quest_lok");
        groundquests.grantQuest(player, "quest/mtp_camp_quest_lok");
    }
    public int mtp_hideout_bomb_tech_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_bomb_tech_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_bomb_tech_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_bomb_tech_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_bomb_tech_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_bomb_tech_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_bomb_tech_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_bomb_tech_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_bomb_tech_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_bomb_tech_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_bomb_tech_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_bomb_tech_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_bomb_tech_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_bomb_tech_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_bomb_tech_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_bomb_tech_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_76"))
        {
            if (mtp_hideout_bomb_tech_condition__defaultCondition(player, npc))
    ...
    public int mtp_hideout_bomb_tech_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_bomb_tech_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_bomb_tech_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_bomb_tech_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
