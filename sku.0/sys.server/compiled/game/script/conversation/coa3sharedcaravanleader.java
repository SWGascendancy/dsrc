...
public class coa3sharedcaravanleader extends script.base_script
{
    ...
    public boolean coa3sharedcaravanleader_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean coa3sharedcaravanleader_condition_hasMissionFromLookout(obj_id player, obj_id npc)
    {
    ...
    public boolean coa3sharedcaravanleader_condition_brokenPartNotRepaired(obj_id player, obj_id npc)
    {
        if ((getObjIdObjVar(player, "coa3.imperial.missionNpcId") != npc) && (getObjIdObjVar(player, "coa3.rebel.missionNpcId") != npc))
        {
            return false;
    ...
    public boolean coa3sharedcaravanleader_condition_brokenPartRepaired(obj_id player, obj_id npc)
    {
        if ((getObjIdObjVar(player, "coa3.imperial.missionNpcId") != npc) && (getObjIdObjVar(player, "coa3.rebel.missionNpcId") != npc))
        {
            return false;
    ...
    public boolean coa3sharedcaravanleader_condition_hasGottenDisk(obj_id player, obj_id npc)
    {
        if ((getObjIdObjVar(player, "coa3.imperial.missionNpcId") != npc) && (getObjIdObjVar(player, "coa3.rebel.missionNpcId") != npc))
        {
            return false;
    ...
    public void coa3sharedcaravanleader_action__defaultAction(obj_id player, obj_id npc)
    {
    }
    public void coa3sharedcaravanleader_action_giveBrokenAntiGravUnit(obj_id player, obj_id npc)
    {
    ...
    public void coa3sharedcaravanleader_action_getDiskFromCaravanLeader(obj_id player, obj_id npc)
    {
