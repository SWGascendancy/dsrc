...
public class npe_brochure extends script.base_script
{
    ...
    public boolean npe_brochure_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_brochure_condition_has100(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_brochure_condition_has50(obj_id player, obj_id npc)
    {
        int cash = getTotalMoney(player);
        if (cash >= 50)
        {
    ...
    public boolean npe_brochure_condition_hasBought(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "npe.boughtBrochure");
    }
    public void npe_brochure_action_payNPC50(obj_id player, obj_id npc)
    {
        int cash = getTotalMoney(player);
        if (cash >= 50)
        {
    ...
    public void npe_brochure_action_payNPC100(obj_id player, obj_id npc)
    {
        int cash = getTotalMoney(player);
        if (cash >= 100)
        {
    ...
    public void npe_brochure_action_giveWaypointStation(obj_id player, obj_id npc)
    {
    ...
    public void npe_brochure_action_faceToNoob(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int npe_brochure_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brochure_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brochure_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brochure_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brochure_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brochure_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brochure_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brochure_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brochure_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brochure_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brochure_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brochure_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brochure_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brochure_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brochure_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brochure_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brochure_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brochure_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brochure_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
