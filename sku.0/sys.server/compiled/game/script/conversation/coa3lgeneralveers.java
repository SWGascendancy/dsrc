...
public class coa3lgeneralveers extends script.base_script
{
    ...
    public boolean coa3lgeneralveers_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean coa3lgeneralveers_condition_spokeCoordinatorLast(obj_id player, obj_id npc)
    {
        return getIntObjVar(player, "coa3.convTracker") == 401;
    }
    public boolean coa3lgeneralveers_condition_finalMissionActive(obj_id player, obj_id npc)
    {
        return getIntObjVar(player, "coa3.convTracker") == 402;
    }
    public boolean coa3lgeneralveers_condition_hasFinishedStory(obj_id player, obj_id npc)
    {
        return (badge.hasBadge(player, "event_coa3_imperial"));
    }
    public void coa3lgeneralveers_action__defaultAction(obj_id player, obj_id npc)
    {
    }
    public void coa3lgeneralveers_action_getFinalMission(obj_id player, obj_id npc)
    {
    ...
    public void coa3lgeneralveers_action_refreshFinalMission(obj_id player, obj_id npc)
    {
        setObjVar(player, "coa3.convTracker", 402);
        dictionary params = new dictionary();
        params.put("player", player);
    ...
    public void coa3lgeneralveers_action_abortFinalMission(obj_id player, obj_id npc)
    {
