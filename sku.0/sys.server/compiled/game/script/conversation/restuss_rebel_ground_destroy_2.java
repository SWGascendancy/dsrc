...
public class restuss_rebel_ground_destroy_2 extends script.base_script
{
    ...
    public boolean restuss_rebel_ground_destroy_2_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean restuss_rebel_ground_destroy_2_condition_stage3ready(obj_id player, obj_id npc)
    {
    ...
    public boolean restuss_rebel_ground_destroy_2_condition_mission1Active(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "restuss_rebel_st3_destroy_generic");
    }
    public boolean restuss_rebel_ground_destroy_2_condition_mission1Success(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "restuss_rebel_st3_destroy_generic", "returnRedding1");
    }
    public boolean restuss_rebel_ground_destroy_2_condition_completedMission1(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "restuss_rebel_st3_destroy_generic");
    }
    public boolean restuss_rebel_ground_destroy_2_condition_mission2Active(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "restuss_rebel_st3_destroy_elite");
    }
    public boolean restuss_rebel_ground_destroy_2_condition_mission2Success(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "restuss_rebel_st3_destroy_elite", "returnRedding2");
    }
    public boolean restuss_rebel_ground_destroy_2_condition_playerRebel(obj_id player, obj_id npc)
    {
    ...
    public boolean restuss_rebel_ground_destroy_2_condition_isImperialPlayer(obj_id player, obj_id npc)
    {
        return factions.isImperial(player);
    }
    public void restuss_rebel_ground_destroy_2_action_giveKillGeneric(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "restuss_rebel_st3_destroy_generic");
    }
    public void restuss_rebel_ground_destroy_2_action_reward1(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "returnedRedding1");
    }
    public void restuss_rebel_ground_destroy_2_action_giveKillElite(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "restuss_rebel_st3_destroy_elite");
    }
    public void restuss_rebel_ground_destroy_2_action_reward2(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "returnedRedding2");
    }
    public void restuss_rebel_ground_destroy_2_action_eject(obj_id player, obj_id npc)
    {
        expelFromBuilding(player);
    }
    public int restuss_rebel_ground_destroy_2_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int restuss_rebel_ground_destroy_2_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int restuss_rebel_ground_destroy_2_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int restuss_rebel_ground_destroy_2_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int restuss_rebel_ground_destroy_2_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
