...
public class static_quests_record_keeper_dantooine extends script.base_script
{
    ...
    public boolean static_quests_record_keeper_dantooine_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean static_quests_record_keeper_dantooine_condition_static_quests_on_player(obj_id player, obj_id npc)
    {
    ...
    public boolean static_quests_record_keeper_dantooine_condition_already_reset(obj_id player, obj_id npc)
    {
    ...
    public void static_quests_record_keeper_dantooine_action_reset_gating(obj_id player, obj_id npc)
    {
    ...
    public void static_quests_record_keeper_dantooine_action_set_redo(obj_id player, obj_id npc)
    {
        setObjVar(player, "static_quests_reset.dantooine", true);
    ...
    public void static_quests_record_keeper_dantooine_action_face_to(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int static_quests_record_keeper_dantooine_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int static_quests_record_keeper_dantooine_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int static_quests_record_keeper_dantooine_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int static_quests_record_keeper_dantooine_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int static_quests_record_keeper_dantooine_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int static_quests_record_keeper_dantooine_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int static_quests_record_keeper_dantooine_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int static_quests_record_keeper_dantooine_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int static_quests_record_keeper_dantooine_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_b1f6ba02"))
        {
            if (static_quests_record_keeper_dantooine_condition__defaultCondition(player, npc))
    ...
    public int static_quests_record_keeper_dantooine_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int static_quests_record_keeper_dantooine_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_b1f6ba02"))
        {
            if (static_quests_record_keeper_dantooine_condition__defaultCondition(player, npc))
