...
public class ep3_clone_relics_boba_fett_claw_boss_imbrimi extends script.base_script
{
    ...
    public boolean ep3_clone_relics_boba_fett_claw_boss_imbrimi_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_clone_relics_boba_fett_claw_boss_imbrimi_condition_onQuestSevenTaskTwo(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "ep3_clone_relics_boba_fett_7", "imbrimi"));
    }
    public void ep3_clone_relics_boba_fett_claw_boss_imbrimi_action_signalTalked(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedToImbrimi");
    }
    public int ep3_clone_relics_boba_fett_claw_boss_imbrimi_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_boba_fett_claw_boss_imbrimi_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_boba_fett_claw_boss_imbrimi_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_boba_fett_claw_boss_imbrimi_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_boba_fett_claw_boss_imbrimi_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_boba_fett_claw_boss_imbrimi_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_boba_fett_claw_boss_imbrimi_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_boba_fett_claw_boss_imbrimi_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_boba_fett_claw_boss_imbrimi_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_boba_fett_claw_boss_imbrimi_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_boba_fett_claw_boss_imbrimi_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
