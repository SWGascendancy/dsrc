...
public class tatooine_knives_parry_larit extends script.base_script
{
    ...
    public boolean tatooine_knives_parry_larit_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tatooine_knives_parry_larit_condition_facePlayer2(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return true;
    }
    public boolean tatooine_knives_parry_larit_condition_onJacketTask(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean tatooine_knives_parry_larit_condition_questComplete(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean tatooine_knives_parry_larit_condition_firstContact(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        int questId1 = questGetQuestId("quest/tatooine_knives_parry");
    ...
    public boolean tatooine_knives_parry_larit_condition_onJacketComplete(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        int questId1 = questGetQuestId("quest/tatooine_knives_parry");
    ...
    public void tatooine_knives_parry_larit_action_signalJacket(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tatoonie_knives_parry_launch_e5");
    }
    public void tatooine_knives_parry_larit_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void tatooine_knives_parry_larit_action_signalJacketComplete(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tatooine_knives_parry_launch_e96");
    }
    public int tatooine_knives_parry_larit_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_knives_parry_larit_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
