...
public class hutt_informant extends script.base_script
{
    ...
    public boolean hutt_informant_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean hutt_informant_condition_HasItem(obj_id player, obj_id npc)
    {
    ...
    public void hutt_informant_action__defaultAction(obj_id player, obj_id npc)
    {
    }
    public void hutt_informant_action_destroyDisk(obj_id player, obj_id npc)
    {
        if (isIdValid(player))
        {
