...
public class disgruntled_leader extends script.base_script
{
    ...
    public boolean disgruntled_leader_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean disgruntled_leader_condition_hasQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "u16_nym_meet_townspeople", "findTownsPeople");
    }
    public boolean disgruntled_leader_condition_hasFinishedQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "u16_nym_return_townsperson", "returnToTownsPerson");
    }
    public boolean disgruntled_leader_condition_isWorkingOnIt(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public void disgruntled_leader_action_signalToGoToNym(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "hasFoundTownsPeopleAgain");
    }
    public void disgruntled_leader_action_hasMetTownsPeople(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "hasFoundTownsPeople");
    }
    public int disgruntled_leader_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int disgruntled_leader_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int disgruntled_leader_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int disgruntled_leader_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int disgruntled_leader_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
