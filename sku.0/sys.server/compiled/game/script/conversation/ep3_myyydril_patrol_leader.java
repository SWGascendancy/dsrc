...
public class ep3_myyydril_patrol_leader extends script.base_script
{
    ...
    public boolean ep3_myyydril_patrol_leader_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_myyydril_patrol_leader_condition_isActiveTaskOne(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_myyydril_patrol_leader_condition_hasFinishedQuestOne(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_myyydril_kivvaaa_talkto_1");
    }
    public boolean ep3_myyydril_patrol_leader_condition_hasNotLanguage(obj_id player, obj_id npc)
    {
        return utils.canSpeakWookiee(player, npc);
    }
    public void ep3_myyydril_patrol_leader_action_giveQuestOne(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_myyydril_kivvaaa_talkto_1");
    }
    public void ep3_myyydril_patrol_leader_action_Language(obj_id player, obj_id npc)
    {
        utils.emoteWookieeConfusion(player, npc);
    }
    public int ep3_myyydril_patrol_leader_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_patrol_leader_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_patrol_leader_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_patrol_leader_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_patrol_leader_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_patrol_leader_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_patrol_leader_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_patrol_leader_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_patrol_leader_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_patrol_leader_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_patrol_leader_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
