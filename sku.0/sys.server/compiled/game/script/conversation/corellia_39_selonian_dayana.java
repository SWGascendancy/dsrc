...
public class corellia_39_selonian_dayana extends script.base_script
{
    ...
    public boolean corellia_39_selonian_dayana_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_39_selonian_dayana_condition_taskOneActive(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "corellia_39_sidequest_01");
    }
    public boolean corellia_39_selonian_dayana_condition_taskOneComplete(obj_id player, obj_id npc)
    {
    ...
    public void corellia_39_selonian_dayana_action_questGranted(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "corellia_39_sidequest_01");
    }
    public void corellia_39_selonian_dayana_action_taskOneCompletedSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "corellia_39_sidequest_01_02");
    }
    public int corellia_39_selonian_dayana_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
