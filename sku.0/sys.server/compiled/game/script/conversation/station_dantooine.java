...
public class station_dantooine extends script.base_script
{
    ...
    public boolean station_dantooine_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean station_dantooine_condition_canAfford50(obj_id player, obj_id npc)
    {
        return space_crafting.canAffordShipRepairs(player, npc, .50f);
    }
    public boolean station_dantooine_condition_canAfford25(obj_id player, obj_id npc)
    {
        return (space_crafting.canAffordShipRepairs(player, npc, .25f) && space_crafting.isDamaged(player));
    }
    public boolean station_dantooine_condition_canAfford75(obj_id player, obj_id npc)
    {
        return space_crafting.canAffordShipRepairs(player, npc, .75f);
    }
    public boolean station_dantooine_condition_canAfford100(obj_id player, obj_id npc)
    {
        return space_crafting.canAffordShipRepairs(player, npc, 1.0f);
    }
    public boolean station_dantooine_condition_needRepairs(obj_id player, obj_id npc)
    {
    ...
    public boolean station_dantooine_condition_isTooFar(obj_id player, obj_id npc)
    {
        space_combat.playCombatTauntSound(player);
        obj_id containingShip = space_transition.getContainingShip(player);
        return (getDistance(npc, containingShip) > space_transition.STATION_COMM_MAX_DISTANCE);
    }
    public boolean station_dantooine_condition_hasRecentlyRepaired(obj_id player, obj_id npc)
    {
    ...
    public boolean station_dantooine_condition_canTakeMissions(obj_id player, obj_id npc)
    {
    ...
    public boolean station_dantooine_condition_isSmuggler(obj_id player, obj_id npc)
    {
        if (!space_flags.hasCompletedTierOne(player))
        {
            return false;
    ...
    public boolean station_dantooine_condition_completedLokDelivery(obj_id player, obj_id npc)
    {
    ...
    public boolean station_dantooine_condition_completedNabooDelivery(obj_id player, obj_id npc)
    {
    ...
    public boolean station_dantooine_condition_completedTatooineDelivery(obj_id player, obj_id npc)
    {
    ...
    public boolean station_dantooine_condition_completedCorelliaDelivery(obj_id player, obj_id npc)
    {
    ...
    public boolean station_dantooine_condition_receivedRewardLok(obj_id player, obj_id npc)
    {
    ...
    public boolean station_dantooine_condition_receivedRewardCorellia(obj_id player, obj_id npc)
    {
    ...
    public boolean station_dantooine_condition_receivedRewardNaboo(obj_id player, obj_id npc)
    {
    ...
    public boolean station_dantooine_condition_receivedRewardTat(obj_id player, obj_id npc)
    {
    ...
    public boolean station_dantooine_condition_hasDeliveredAll(obj_id player, obj_id npc)
    {
    ...
    public boolean station_dantooine_condition_rebelLanding(obj_id player, obj_id npc)
    {
    ...
    public boolean station_dantooine_condition_failedLandingMission(obj_id player, obj_id npc)
    {
    ...
    public boolean station_dantooine_condition_wonLandingMission(obj_id player, obj_id npc)
    {
        if (space_quest.hasReceivedReward(player, "recovery", "stn_dantooine_owner_rebel_landing_tier2_1"))
        {
            return false;
    ...
    public boolean station_dantooine_condition_rebelBase(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "space.dantooine_landing_permission"))
        {
            return true;
    ...
    public boolean station_dantooine_condition_failedSmuggler(obj_id player, obj_id npc)
    {
    ...
    public boolean station_dantooine_condition_wonSmuggler(obj_id player, obj_id npc)
    {
        if (space_quest.hasReceivedReward(player, "inspect", "stn_dantooine_owner_smuggler_inspect01_tier2_1"))
        {
            return false;
    ...
    public boolean station_dantooine_condition_hasMission(obj_id player, obj_id npc)
    {
    ...
    public boolean station_dantooine_condition_canRepairFull(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "space_quests.dantooine_station.fullRepair"))
        {
            return true;
    ...
    public boolean station_dantooine_condition_hasFailedRepair(obj_id player, obj_id npc)
    {
    ...
    public boolean station_dantooine_condition_hasWonRepair(obj_id player, obj_id npc)
    {
    ...
    public boolean station_dantooine_condition_failedLokDelivery(obj_id player, obj_id npc)
    {
    ...
    public boolean station_dantooine_condition_failedCorelliaDelivery(obj_id player, obj_id npc)
    {
    ...
    public boolean station_dantooine_condition_failedNabooDelivery(obj_id player, obj_id npc)
    {
    ...
    public boolean station_dantooine_condition_failedTatooineDelivery(obj_id player, obj_id npc)
    {
    ...
    public boolean station_dantooine_condition_canTakeSmuggler(obj_id player, obj_id npc)
    {
        if (space_quest.hasReceivedReward(player, "inspect", "stn_dantooine_owner_smuggler_inspect01_tier2_1"))
        {
            return false;
    ...
    public boolean station_dantooine_condition_canLandAtHouse(obj_id player, obj_id npc)
    {
    ...
    public boolean station_dantooine_condition_canHandleTier4(obj_id player, obj_id npc)
    {
        return space_flags.hasCompletedTierThree(player);
    }
    public boolean station_dantooine_condition_canHandleTier2(obj_id player, obj_id npc)
    {
        return space_flags.hasCompletedTierThree(player);
    }
    public boolean station_dantooine_condition_canAttackImperial(obj_id player, obj_id npc)
    {
    ...
    public boolean station_dantooine_condition_canAttackRebel(obj_id player, obj_id npc)
    {
    ...
    public void station_dantooine_action_landStation3(obj_id player, obj_id npc)
    {
        space_content.landPlayer(player, npc, "Dantooine Imperial Outpost");
    }
    public void station_dantooine_action_fix25(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, .25f);
    }
    public void station_dantooine_action_fix50(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, .50f);
    }
    public void station_dantooine_action_fix75(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, .75f);
    }
    public void station_dantooine_action_fix100(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, 1.0f);
    }
    public void station_dantooine_action_landStation1(obj_id player, obj_id npc)
    {
        space_content.landPlayer(player, npc, "Dantooine Mining Outpost");
    }
    public void station_dantooine_action_landStation2(obj_id player, obj_id npc)
    {
        space_content.landPlayer(player, npc, "Dantooine Agro Outpost");
    }
    public void station_dantooine_action_flagRecentlyRepaired(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "stationDantooineLastRepairs", getGameTime());
    }
    public void station_dantooine_action_grantDestroyDuty(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "stn_dantooine_owner_all_raiderdestroy_tier2_1");
    }
    public void station_dantooine_action_grantLokPickup(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "delivery_no_pickup", "stan_dantooine_owner_all_lokdelivery_tier2_1");
    }
    public void station_dantooine_action_grantTatooinePickup(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "delivery_no_pickup", "stn_dantooine_owner_all_tatooinedelivery_tier2_1");
    }
    public void station_dantooine_action_grantNabooPickup(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "delivery_no_pickup", "stn_dantooine_owner_all_naboodelivery_tier2_1");
    }
    public void station_dantooine_action_grantCorelliaPickup(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "delivery_no_pickup", "stn_dantooine_owner_all_corelliapickup_tier2_1");
    }
    public void station_dantooine_action_grantEscortDuty(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "escort_duty", "stn_dantooine_owner_all_escortduty_tier2_1");
    }
    public void station_dantooine_action_grantRecoveryDuty(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "recovery_duty", "stn_dantooine_owner_smuggler_recoveryduty_tier2_1");
    }
    public void station_dantooine_action_rewardLokPickup(obj_id player, obj_id npc)
    {
    ...
    public void station_dantooine_action_rewardCorelliaPickup(obj_id player, obj_id npc)
    {
    ...
    public void station_dantooine_action_rewardNabooPickup(obj_id player, obj_id npc)
    {
        space_quest.giveReward(player, "delivery_no_pickup", "stn_dantooine_owner_all_naboodelivery_tier2_1", 10000);
        grantExperiencePoints(player, "space_combat_general", 1000);
    }
    public void station_dantooine_action_rewardTatPickup(obj_id player, obj_id npc)
    {
        space_quest.giveReward(player, "delivery_no_pickup", "stn_dantooine_owner_all_tatooinedelivery_tier2_1", 10000);
        grantExperiencePoints(player, "space_combat_general", 1000);
    }
    public void station_dantooine_action_grantLandingMission(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "recovery", "stn_dantooine_owner_rebel_landing_tier2_1");
    }
    public void station_dantooine_action_regrantLandingMission(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "recovery", "stn_dantooine_owner_rebel_landing_tier2_1");
    }
    public void station_dantooine_action_clearLandingMission(obj_id player, obj_id npc)
    {
    ...
    public void station_dantooine_action_rewardLanding(obj_id player, obj_id npc)
    {
    ...
    public void station_dantooine_action_landStation4(obj_id player, obj_id npc)
    {
        space_content.landPlayer(player, npc, "Abandoned Rebel Base");
    }
    public void station_dantooine_action_grantSmugglerMission(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "inspect", "stn_dantooine_owner_smuggler_inspect01_tier2_1");
    }
    public void station_dantooine_action_grantSmugglerAgain(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "inspect", "stn_dantooine_owner_smuggler_inspect01_tier2_1");
    }
    public void station_dantooine_action_clearSmugglerMission(obj_id player, obj_id npc)
    {
    ...
    public void station_dantooine_action_rewardSmuggler(obj_id player, obj_id npc)
    {
    ...
    public void station_dantooine_action_grantRepairMission(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "delivery_no_pickup", "stn_dantooine_owner_all_mircropickup_tier2_01");
    }
    public void station_dantooine_action_clearRepairMission(obj_id player, obj_id npc)
    {
    ...
    public void station_dantooine_action_rewardRepair(obj_id player, obj_id npc)
    {
    ...
    public void station_dantooine_action_clearLokDelivery(obj_id player, obj_id npc)
    {
        space_quest.clearQuestFlags(player, "delivery_no_pickup", "stan_dantooine_owner_all_lokdelivery_tier2_1");
    }
    public void station_dantooine_action_clearNabooDelivery(obj_id player, obj_id npc)
    {
        space_quest.clearQuestFlags(player, "delivery_no_pickup", "stn_dantooine_owner_all_naboodelivery_tier2_1");
    }
    public void station_dantooine_action_clearTatooineDelivery(obj_id player, obj_id npc)
    {
        space_quest.clearQuestFlags(player, "delivery_no_pickup", "stn_dantooine_owner_all_tatooinedelivery_tier2_1");
    }
    public void station_dantooine_action_clearCorelliaDelivery(obj_id player, obj_id npc)
    {
        space_quest.clearQuestFlags(player, "delivery_no_pickup", "stn_dantooine_owner_all_corelliapickup_tier2_1");
    }
    public void station_dantooine_action_landHoming(obj_id player, obj_id npc)
    {
        space_content.landPlayerHoming(player, npc);
    }
    public void station_dantooine_action_grantImperialDuty4(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "dantooine_imperial_tier4");
    }
    public void station_dantooine_action_grantImperialDuty5(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "kessel_imperial_tier5");
    }
    public void station_dantooine_action_grantRebelDuty4(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "dantooine_rebel_tier4");
    }
    public void station_dantooine_action_grantRebelDuty5(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "kessel_rebel_tier5");
    }
    public void station_dantooine_action_grantDroidDuty5(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "dantooine_rogue_droid_tier5");
    }
    public void station_dantooine_action_grantDroidDuty4(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "dantooine_rogue_droid_tier4");
    }
    public void station_dantooine_action_grantVoidDuty5(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "dantooine_void_wing_tier5");
    }
    public void station_dantooine_action_grantVoidDuty4(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "dantooine_void_wing_tier4");
    }
    public void station_dantooine_action_grantImperialDuty5_2(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "dantooine_imperial_tier5");
    }
    public void station_dantooine_action_grantRebelDuty5_2(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "dantooine_rebel_tier5");
    }
    public String station_dantooine_tokenTO_tokenTO0001(obj_id player, obj_id npc)
    {
        return new String();
    }
    public int station_dantooine_tokenDI_getStationRepairCost25(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, .25f);
    }
    public int station_dantooine_tokenDI_getStationRepairCost50(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, .50f);
    }
    public int station_dantooine_tokenDI_getStationRepairCost75(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, .75f);
    }
    public int station_dantooine_tokenDI_getStationRepairCost100(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, 1.0f);
    }
    public int station_dantooine_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dantooine_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dantooine_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dantooine_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_93"))
        {
            if (station_dantooine_condition__defaultCondition(player, npc))
    ...
    public int station_dantooine_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dantooine_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_93"))
        {
            if (station_dantooine_condition__defaultCondition(player, npc))
    ...
    public int station_dantooine_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dantooine_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_93"))
        {
            if (station_dantooine_condition__defaultCondition(player, npc))
    ...
    public int station_dantooine_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dantooine_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_93"))
        {
            if (station_dantooine_condition__defaultCondition(player, npc))
    ...
    public int station_dantooine_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dantooine_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_93"))
        {
            if (station_dantooine_condition__defaultCondition(player, npc))
    ...
    public int station_dantooine_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dantooine_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_93"))
        {
            if (station_dantooine_condition__defaultCondition(player, npc))
    ...
    public int station_dantooine_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_93"))
        {
            if (station_dantooine_condition__defaultCondition(player, npc))
    ...
    public int station_dantooine_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_93"))
        {
            if (station_dantooine_condition__defaultCondition(player, npc))
    ...
    public int station_dantooine_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_93"))
        {
            if (station_dantooine_condition__defaultCondition(player, npc))
    ...
    public int station_dantooine_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_93"))
        {
            if (station_dantooine_condition__defaultCondition(player, npc))
    ...
    public int station_dantooine_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dantooine_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_93"))
        {
            if (station_dantooine_condition__defaultCondition(player, npc))
    ...
    public int station_dantooine_handleBranch30(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dantooine_handleBranch31(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_93"))
        {
            if (station_dantooine_condition__defaultCondition(player, npc))
    ...
    public int station_dantooine_handleBranch32(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_93"))
        {
            if (station_dantooine_condition__defaultCondition(player, npc))
    ...
    public int station_dantooine_handleBranch33(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dantooine_handleBranch34(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dantooine_handleBranch35(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dantooine_handleBranch38(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dantooine_handleBranch41(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dantooine_handleBranch45(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dantooine_handleBranch48(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dantooine_handleBranch49(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dantooine_handleBranch51(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dantooine_handleBranch53(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dantooine_handleBranch54(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dantooine_handleBranch57(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dantooine_handleBranch60(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dantooine_handleBranch63(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dantooine_handleBranch65(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dantooine_handleBranch67(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dantooine_handleBranch71(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dantooine_handleBranch72(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dantooine_handleBranch85(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dantooine_handleBranch87(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_93"))
        {
            if (station_dantooine_condition__defaultCondition(player, npc))
    ...
    public int station_dantooine_handleBranch88(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dantooine_handleBranch94(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dantooine_handleBranch98(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dantooine_handleBranch99(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dantooine_handleBranch100(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dantooine_handleBranch105(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dantooine_handleBranch106(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dantooine_handleBranch107(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dantooine_handleBranch108(obj_id player, obj_id npc, string_id response)
    {
