...
public class som_kenobi_ikt extends script.base_script
{
    ...
    public boolean som_kenobi_ikt_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean som_kenobi_ikt_condition_playerJedi(obj_id player, obj_id npc)
    {
        return jedi.isForceSensitive(player);
    }
    public boolean som_kenobi_ikt_condition_haveShard(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "som_kenobi_serpent_shard_1", "gotShard");
    }
    public boolean som_kenobi_ikt_condition_done(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "som_kenobi_serpent_shard_1");
    }
    public boolean som_kenobi_ikt_condition_onQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "som_kenobi_serpent_shard_1");
    }
    public void som_kenobi_ikt_action_giveQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "som_kenobi_serpent_shard_1");
    }
    public void som_kenobi_ikt_action_removeQuest(obj_id player, obj_id npc)
    {
        groundquests.clearQuest(player, "som_kenobi_serpent_shard_1");
    }
    public void som_kenobi_ikt_action_reward(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "givenShard");
    }
    public int som_kenobi_ikt_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_ikt_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_ikt_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_ikt_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_ikt_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_ikt_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_ikt_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_ikt_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_ikt_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_ikt_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_ikt_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_ikt_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_ikt_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_ikt_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_ikt_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_ikt_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_ikt_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_ikt_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_ikt_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
