...
public class nym_technician_1 extends script.base_script
{
    ...
    public boolean nym_technician_1_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean nym_technician_1_condition_isOnMission(obj_id player, obj_id npc)
    {
        return space_flags.hasSpaceFlag(player, "ss.findingAgent");
    }
    public boolean nym_technician_1_condition_isHuntingShip(obj_id player, obj_id npc)
    {
        return space_flags.hasSpaceFlag(player, "ss.huntingShip");
    }
    public boolean nym_technician_1_condition_hasCompletedMission(obj_id player, obj_id npc)
    {
        return space_quest.hasWonQuest(player, "assassinate", "imperial_ss_3");
    }
    public boolean nym_technician_1_condition_hasReceivedReward2(obj_id player, obj_id npc)
    {
        return space_quest.hasReceivedReward(player, "assassinate", "imperial_ss_3");
    }
    public boolean nym_technician_1_condition_hasFailedKimogilaClaw(obj_id player, obj_id npc)
    {
    ...
    public void nym_technician_1_action_setHuntingShip(obj_id player, obj_id npc)
    {
        space_flags.removeSpaceFlag(player, "ss.findingAgent");
        space_flags.setSpaceFlag(player, "ss.huntingShip", 1);
    }
    public void nym_technician_1_action_setAssassinateMission(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "assassinate", "imperial_ss_3");
    }
    public int nym_technician_1_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_technician_1_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_technician_1_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_technician_1_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_technician_1_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_technician_1_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_67a590c3"))
        {
            if (nym_technician_1_condition__defaultCondition(player, npc))
    ...
    public int nym_technician_1_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_technician_1_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_technician_1_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_technician_1_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_technician_1_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_technician_1_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_technician_1_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_technician_1_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
