...
public class tatooine_entha_race_droid2 extends script.base_script
{
    ...
    public boolean tatooine_entha_race_droid2_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tatooine_entha_race_droid2_condition_onStartRace2(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "tatooine_entha_podracers_race2", "tatooine_espa_podracers_race2_e1");
    }
    public boolean tatooine_entha_race_droid2_condition_onRace2(obj_id player, obj_id npc)
    {
    ...
    public boolean tatooine_entha_race_droid2_condition_completedRace2(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "tatooine_entha_podracers_race2", "tatooine_espa_podracers_race2_e7");
    }
    public void tatooine_entha_race_droid2_action_signalStart(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tatooine_espa_podracers_race2_e1");
    }
    public void tatooine_entha_race_droid2_action_clearRace2(obj_id player, obj_id npc)
    {
        groundquests.clearQuest(player, "tatooine_entha_podracers_race2");
    }
    public void tatooine_entha_race_droid2_action_grantRace2(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "tatooine_entha_podracers_race2");
    }
    public void tatooine_entha_race_droid2_action_signalFinish(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tatooine_espa_podracers_race2_e7");
    }
    public void tatooine_entha_race_droid2_action_grantReturnDraknus(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "tatooine_entha_return_draknus");
    }
    public int tatooine_entha_race_droid2_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_entha_race_droid2_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_entha_race_droid2_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_entha_race_droid2_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
