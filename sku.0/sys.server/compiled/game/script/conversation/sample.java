...
public class sample extends script.base_script
{
    ...
    public boolean sample_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean sample_condition_knowsPlayer(obj_id player, obj_id npc)
    {
        return getIntObjVar(player, "asommers_test.playerLevel") == 0;
    }
    public boolean sample_condition_likesPlayer(obj_id player, obj_id npc)
    {
        return getIntObjVar(player, "asommers_test.playerLevel") == 1;
    }
    public boolean sample_condition_dislikesPlayer(obj_id player, obj_id npc)
    {
        return getIntObjVar(player, "asommers_test.playerLevel") == 2;
    }
    public void sample_action__defaultAction(obj_id player, obj_id npc)
    {
    }
    public void sample_action_cheer(obj_id player, obj_id npc)
    {
        setObjVar(player, "asommers_test.playerLevel", 1);
        doAnimationAction(npc, anims.PLAYER_APPLAUSE_POLITE);
    }
    public void sample_action_greet(obj_id player, obj_id npc)
    {
        doAnimationAction(npc, anims.PLAYER_BOW2);
    }
    public void sample_action_clear(obj_id player, obj_id npc)
    {
        setObjVar(player, "asommers_test.playerLevel", 0);
    }
    public void sample_action_impress(obj_id player, obj_id npc)
    {
        setObjVar(player, "asommers_test.playerLevel", 1);
    ...
    public void sample_action_shakeFist(obj_id player, obj_id npc)
    {
        doAnimationAction(npc, anims.PLAYER_GESTICULATE_WILDLY);
    }
    public void sample_action_scratchHead(obj_id player, obj_id npc)
    {
