...
public class racing_narmle extends script.base_script
{
    ...
    public boolean racing_narmle_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean racing_narmle_condition_hasRaced(obj_id player, obj_id npc)
    {
        return (hasObjVar(player, "racing.bestTime.narmle"));
    }
    public boolean racing_narmle_condition_isRacing(obj_id player, obj_id npc)
    {
        return (getIntObjVar(player, "racing.narmle.isRacing") == 1);
    }
    public boolean racing_narmle_condition_hasLastTime(obj_id player, obj_id npc)
    {
        return (hasObjVar(player, "racing.lastTime.narmle"));
    }
    public void racing_narmle_action_registerPersonalBest(obj_id player, obj_id npc)
    {
    ...
    public void racing_narmle_action_startRace(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        params.put("npc", npc);
    ...
    public void racing_narmle_action_displayCurrentLeader(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        params.put("npc", npc);
    ...
    public void racing_narmle_action_whatsMyBestTime(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        params.put("npc", npc);
    ...
    public void racing_narmle_action_showBestTime(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        params.put("npc", npc);
    ...
    public void racing_narmle_action_erasePersonalBest(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        params.put("npc", npc);
    ...
    public void racing_narmle_action_abortRace(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
