...
public class heroic_echo_collector extends script.base_script
{
    ...
    public boolean heroic_echo_collector_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean heroic_echo_collector_condition_RebelCheck(obj_id player, obj_id npc)
    {
    ...
    public boolean heroic_echo_collector_condition_ImperialCheck(obj_id player, obj_id npc)
    {
    ...
    public boolean heroic_echo_collector_condition_activeNotComplete(obj_id player, obj_id npc)
    {
    ...
    public boolean heroic_echo_collector_condition_activeAndComplete(obj_id player, obj_id npc)
    {
    ...
    public boolean heroic_echo_collector_condition_readyForComplete(obj_id player, obj_id npc)
    {
    ...
    public void heroic_echo_collector_action_activateWampaKillCollection(obj_id player, obj_id npc)
    {
        if (!hasCompletedCollection(player, "kill_hoth_wampa_01") && !hasCompletedCollectionSlot(player, "kill_wampa_activation"))
        {
    ...
    public void heroic_echo_collector_action_completeWampaCollection(obj_id player, obj_id npc)
    {
        if (hasCompletedCollectionSlot(player, "kill_wampa_activation") && hasCompletedCollectionSlot(player, "kill_wampa_01") && hasCompletedCollectionSlot(player, "kill_wampa_02") && hasCompletedCollectionSlot(player, "kill_wampa_03") && hasCompletedCollectionSlot(player, "kill_wampa_04") && hasCompletedCollectionSlot(player, "kill_wampa_05") && !hasCompletedCollectionSlot(player, "kill_wampa_complete"))
        {
    ...
    public int heroic_echo_collector_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int heroic_echo_collector_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int heroic_echo_collector_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int heroic_echo_collector_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int heroic_echo_collector_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int heroic_echo_collector_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int heroic_echo_collector_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int heroic_echo_collector_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int heroic_echo_collector_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
