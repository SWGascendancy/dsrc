...
public class coa3lcoordinator extends script.base_script
{
    ...
    public boolean coa3lcoordinator_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean coa3lcoordinator_condition_hasSpokeCoordinatorOnce(obj_id player, obj_id npc)
    {
        return (getIntObjVar(player, "coa3.convTracker") == 101);
    }
    public boolean coa3lcoordinator_condition_hasSpokeInfoOfficer(obj_id player, obj_id npc)
    {
        return (getIntObjVar(player, "coa3.convTracker") == 102);
    }
    public boolean coa3lcoordinator_condition_sentToTactOfficer(obj_id player, obj_id npc)
    {
        return (getIntObjVar(player, "coa3.convTracker") == 301 || getIntObjVar(player, "coa3.convTracker") == 302);
    }
    public boolean coa3lcoordinator_condition_completedFloraStoryMission(obj_id player, obj_id npc)
    {
        return (getIntObjVar(player, "coa3.convTracker") == 303);
    }
    public boolean coa3lcoordinator_condition_hasOffworldWaypoint(obj_id player, obj_id npc)
    {
        return (getIntObjVar(player, "coa3.convTracker") > 400);
    }
    public boolean coa3lcoordinator_condition_playerHasDisk(obj_id player, obj_id npc)
    {
    ...
    public boolean coa3lcoordinator_condition_lookoutMissionActive(obj_id player, obj_id npc)
    {
        return ((getIntObjVar(player, "coa3.convTracker") > 199) && (getIntObjVar(player, "coa3.convTracker") < 209) && (hasObjVar(player, "coa3.imperial")));
    }
    public boolean coa3lcoordinator_condition_hasFinishedStory(obj_id player, obj_id npc)
    {
        return (badge.hasBadge(player, "event_coa3_imperial"));
    }
    public boolean coa3lcoordinator_condition_hasCOA2Badge(obj_id player, obj_id npc)
    {
        return (badge.hasBadge(player, "event_coa2_imperial"));
    }
    public boolean coa3lcoordinator_condition_isNotEnemyFaction(obj_id player, obj_id npc)
    {
        String pvpFaction = factions.getFaction(player);
        return (pvpFaction == null || !pvpFaction.equals("Rebel"));
    }
    public void coa3lcoordinator_action_getLookoutMission(obj_id player, obj_id npc)
    {
    ...
    public void coa3lcoordinator_action_getOffworldWaypoint(obj_id player, obj_id npc)
    {
    ...
    public void coa3lcoordinator_action_refreshOffworldWaypoint(obj_id player, obj_id npc)
    {
        setObjVar(player, "coa3.convTracker", 401);
        dictionary params = new dictionary();
        params.put("player", player);
    ...
    public void coa3lcoordinator_action_abortOffworldWaypoint(obj_id player, obj_id npc)
    {
    ...
    public void coa3lcoordinator_action_diskToCoordinator(obj_id player, obj_id npc)
    {
        setObjVar(player, "coa3.convTracker", 301);
        removeObjVar(player, "coa3.lookoutLikeMeter");
    }
    public void coa3lcoordinator_action_refreshLookoutMission(obj_id player, obj_id npc)
    {
        setObjVar(player, "coa3.convTracker", 200);
        removeObjVar(player, "coa3.lookoutLikeMeter");
        dictionary params = new dictionary();
    ...
    public void coa3lcoordinator_action_abortLookoutMission(obj_id player, obj_id npc)
    {
        setObjVar(player, "coa3.convTracker", 200);
        removeObjVar(player, "coa3.lookoutLikeMeter");
        dictionary params = new dictionary();
    ...
    public void coa3lcoordinator_action_spokeCoordinatorOnce(obj_id player, obj_id npc)
    {
        setObjVar(player, "coa3.convTracker", 101);
    }
    public int coa3lcoordinator_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int coa3lcoordinator_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int coa3lcoordinator_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int coa3lcoordinator_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int coa3lcoordinator_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int coa3lcoordinator_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int coa3lcoordinator_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int coa3lcoordinator_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int coa3lcoordinator_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int coa3lcoordinator_handleBranch30(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int coa3lcoordinator_handleBranch31(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int coa3lcoordinator_handleBranch32(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int coa3lcoordinator_handleBranch37(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int coa3lcoordinator_handleBranch38(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int coa3lcoordinator_handleBranch41(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int coa3lcoordinator_handleBranch42(obj_id player, obj_id npc, string_id response)
    {
