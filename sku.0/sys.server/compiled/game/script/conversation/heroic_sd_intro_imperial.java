...
public class heroic_sd_intro_imperial extends script.base_script
{
    ...
    public boolean heroic_sd_intro_imperial_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean heroic_sd_intro_imperial_condition_notImperialFaction(obj_id player, obj_id npc)
    {
        return !factions.isImperial(player);
    }
    public boolean heroic_sd_intro_imperial_condition_onQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "star_destroyer_intro_imperial");
    }
    public boolean heroic_sd_intro_imperial_condition_returningQuest(obj_id player, obj_id npc)
    {
    ...
    public void heroic_sd_intro_imperial_action_grantIntroQuest(obj_id player, obj_id npc)
    {
    ...
    public void heroic_sd_intro_imperial_action_sendIntroSignal(obj_id player, obj_id npc)
    {
    ...
    public int heroic_sd_intro_imperial_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
