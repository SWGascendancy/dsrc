...
public class station_dathomir extends script.base_script
{
    ...
    public boolean station_dathomir_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean station_dathomir_condition_canAfford50(obj_id player, obj_id npc)
    {
        return space_crafting.canAffordShipRepairs(player, npc, .50f);
    }
    public boolean station_dathomir_condition_canAfford25(obj_id player, obj_id npc)
    {
        return space_crafting.canAffordShipRepairs(player, npc, .25f);
    }
    public boolean station_dathomir_condition_canAfford75(obj_id player, obj_id npc)
    {
        return space_crafting.canAffordShipRepairs(player, npc, .75f);
    }
    public boolean station_dathomir_condition_canAfford100(obj_id player, obj_id npc)
    {
        return space_crafting.canAffordShipRepairs(player, npc, 1.0f);
    }
    public boolean station_dathomir_condition_needRepairs(obj_id player, obj_id npc)
    {
    ...
    public boolean station_dathomir_condition_isRebelPilotDath(obj_id player, obj_id npc)
    {
        return (hasSkill(player, "pilot_rebel_navy_novice") && !utils.hasScriptVar(player, "AuthorizedForDath"));
    }
    public boolean station_dathomir_condition_isTooFar(obj_id player, obj_id npc)
    {
        space_combat.playCombatTauntSound(player);
        obj_id containingShip = space_transition.getContainingShip(player);
        return (getDistance(npc, containingShip) > space_transition.STATION_COMM_MAX_DISTANCE);
    }
    public boolean station_dathomir_condition_gatedByTimer(obj_id player, obj_id npc)
    {
    ...
    public boolean station_dathomir_condition_WaitingButStillGated(obj_id player, obj_id npc)
    {
    ...
    public boolean station_dathomir_condition_waitingAndNowUngated(obj_id player, obj_id npc)
    {
        if (!utils.hasScriptVar(player, "waitingAtDathStation"))
        {
            return false;
    ...
    public boolean station_dathomir_condition_eligibleForPrivateerlQuests(obj_id player, obj_id npc)
    {
    ...
    public boolean station_dathomir_condition_eligibleForImperialQuests(obj_id player, obj_id npc)
    {
    ...
    public boolean station_dathomir_condition_canDoImperialStoryQuest(obj_id player, obj_id npc)
    {
        return !space_quest.hasWonQuest(player, "assassinate", "dathomir_station_imp_storyquest_01_e");
    }
    public boolean station_dathomir_condition_canDoPrivateerStoryQuest(obj_id player, obj_id npc)
    {
        return !space_quest.hasWonQuest(player, "assassinate", "dathomir_station_priv_storyquest_01_d");
    }
    public boolean station_dathomir_condition_wonPrivStoryQuest_a(obj_id player, obj_id npc)
    {
        return space_quest.hasWonQuest(player, "delivery", "dathomir_station_priv_storyquest_01_a");
    }
    public boolean station_dathomir_condition_wonPrivStoryQuest_b(obj_id player, obj_id npc)
    {
        return space_quest.hasWonQuest(player, "recovery", "dathomir_station_priv_storyquest_01_b");
    }
    public boolean station_dathomir_condition_canTakeQuest(obj_id player, obj_id npc)
    {
        if (space_quest.hasQuest(player))
        {
            return false;
    ...
    public boolean station_dathomir_condition_wonPrivStoryQuest_c(obj_id player, obj_id npc)
    {
        return space_quest.hasWonQuest(player, "escort", "dathomir_station_priv_storyquest_01_c");
    }
    public boolean station_dathomir_condition_wonImpStoryQuest_d(obj_id player, obj_id npc)
    {
        return space_quest.hasWonQuest(player, "recovery", "dathomir_station_imp_storyquest_01_d");
    }
    public boolean station_dathomir_condition_wonImpStoryQuest_c(obj_id player, obj_id npc)
    {
        return space_quest.hasWonQuest(player, "assassinate", "dathomir_station_imp_storyquest_01_c");
    }
    public boolean station_dathomir_condition_wonImpStoryQuest_b(obj_id player, obj_id npc)
    {
        return space_quest.hasWonQuest(player, "assassinate", "dathomir_station_imp_storyquest_01_b");
    }
    public boolean station_dathomir_condition_wonImpStoryQuest_a(obj_id player, obj_id npc)
    {
        return space_quest.hasWonQuest(player, "recovery", "dathomir_station_imp_storyquest_01_a");
    }
    public boolean station_dathomir_condition_canAttackImperial(obj_id player, obj_id npc)
    {
    ...
    public boolean station_dathomir_condition_canReceiveFullRepair(obj_id player, obj_id npc)
    {
    ...
    public boolean station_dathomir_condition_isOnPrivStoryQuest_01(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "station_dathomir.isOnPrivStoryQuest_01");
    }
    public boolean station_dathomir_condition_isOnImpStoryQuest_01(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "station_dathomir.isOnImpStoryQuest_01");
    }
    public boolean station_dathomir_condition_alreadyHasAQuest(obj_id player, obj_id npc)
    {
        return space_quest.hasQuest(player);
    }
    public boolean station_dathomir_condition_canAttackRebel(obj_id player, obj_id npc)
    {
    ...
    public boolean station_dathomir_condition_canHandleTier4(obj_id player, obj_id npc)
    {
        return space_flags.hasCompletedTierThree(player);
    }
    public void station_dathomir_action_landStation3(obj_id player, obj_id npc)
    {
        space_content.landPlayer(player, npc, "Dathomir Quarantine Zone");
    }
    public void station_dathomir_action_fix25(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, .25f);
    }
    public void station_dathomir_action_fix50(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, .50f);
    }
    public void station_dathomir_action_fix75(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, .75f);
    }
    public void station_dathomir_action_fix100(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, 1.0f);
    }
    public void station_dathomir_action_landStation1(obj_id player, obj_id npc)
    {
        space_content.landPlayer(player, npc, "Dathomir Outpost");
    }
    public void station_dathomir_action_landStation2(obj_id player, obj_id npc)
    {
        space_content.landPlayer(player, npc, "Science Outpost");
    }
    public void station_dathomir_action_flagPlayerClearedForLanding(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "AuthorizedForDath", true);
    }
    public void station_dathomir_action_timeStampRepairs(obj_id player, obj_id npc)
    {
        int timeStamp = getGameTime() + 360;
        utils.setScriptVar(player, "lastDathomirRepair", (timeStamp));
    }
    public void station_dathomir_action_flagPlayerAsWaiting(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "waitingAtDathStation", true);
    }
    public void station_dathomir_action_grantImperialDestroyDuty(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "dathomir_station_imp_destroy_duty_tier3");
    }
    public void station_dathomir_action_grantImperialEscortDuty(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "escort_duty", "dathomir_station_imp_escort_duty_tier3");
    }
    public void station_dathomir_action_grantPrivateerEscortDuty(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "escort_duty", "dathomir_station_priv_escort_duty_tier3");
    }
    public void station_dathomir_action_grantPrivateerDestroyDuty(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "dathomir_station_priv_destroy_duty_tier3");
    }
    public void station_dathomir_action_startImpStoryQuest_01(obj_id player, obj_id npc)
    {
    ...
    public void station_dathomir_action_startPrivStoryQuest_01(obj_id player, obj_id npc)
    {
    ...
    public void station_dathomir_action_grantImpStoryQuest_01_b(obj_id player, obj_id npc)
    {
    ...
    public void station_dathomir_action_grantImpStoryQuest_01_c(obj_id player, obj_id npc)
    {
    ...
    public void station_dathomir_action_grantImpStoryQuest_01_d(obj_id player, obj_id npc)
    {
    ...
    public void station_dathomir_action_grantImpStoryQuest_01_e(obj_id player, obj_id npc)
    {
    ...
    public void station_dathomir_action_grantPrivStoryQuest_01_b(obj_id player, obj_id npc)
    {
    ...
    public void station_dathomir_action_grantPrivStoryQuest_01_c(obj_id player, obj_id npc)
    {
    ...
    public void station_dathomir_action_grantPrivStoryQuest_01_d(obj_id player, obj_id npc)
    {
    ...
    public void station_dathomir_action_grantImperialDuty4(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "dathomir_imperial_tier4");
    }
    public void station_dathomir_action_grantImperialDuty5(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "kessel_imperial_tier5");
    }
    public void station_dathomir_action_grantRebelDuty4(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "dathomir_rebel_tier4");
    }
    public void station_dathomir_action_grantRebelDuty5(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "kessel_rebel_tier5");
    }
    public void station_dathomir_action_grantHiddenDaggerDuty4(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "dathomir_hidden_dagger_tier4");
    }
    public void station_dathomir_action_grantHiddenDaggerDuty5(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "dathomir_hidden_dagger_tier5");
    }
    public void station_dathomir_action_grantKesselPirateTier6(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "kessel_pirate_tier6");
    }
    public String station_dathomir_tokenTO_tokenTO0001(obj_id player, obj_id npc)
    {
        return new String();
    }
    public int station_dathomir_tokenDI_getStationRepairCost25(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, .25f);
    }
    public int station_dathomir_tokenDI_getStationRepairCost50(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, .50f);
    }
    public int station_dathomir_tokenDI_getStationRepairCost75(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, .75f);
    }
    public int station_dathomir_tokenDI_getStationRepairCost100(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, 1.0f);
    }
    public int station_dathomir_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dathomir_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dathomir_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dathomir_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dathomir_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dathomir_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_578"))
        {
            if (station_dathomir_condition__defaultCondition(player, npc))
    ...
    public int station_dathomir_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_769"))
        {
            if (station_dathomir_condition__defaultCondition(player, npc))
    ...
    public int station_dathomir_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_769"))
        {
            if (station_dathomir_condition__defaultCondition(player, npc))
    ...
    public int station_dathomir_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dathomir_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dathomir_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dathomir_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dathomir_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dathomir_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dathomir_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dathomir_handleBranch31(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dathomir_handleBranch32(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dathomir_handleBranch34(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dathomir_handleBranch37(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dathomir_handleBranch40(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dathomir_handleBranch43(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dathomir_handleBranch47(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dathomir_handleBranch48(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_769"))
        {
            if (station_dathomir_condition__defaultCondition(player, npc))
    ...
    public int station_dathomir_handleBranch49(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dathomir_handleBranch50(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dathomir_handleBranch53(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dathomir_handleBranch56(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dathomir_handleBranch59(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dathomir_handleBranch61(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dathomir_handleBranch63(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dathomir_handleBranch64(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dathomir_handleBranch65(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dathomir_handleBranch69(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dathomir_handleBranch70(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dathomir_handleBranch72(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dathomir_handleBranch74(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dathomir_handleBranch76(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dathomir_handleBranch78(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dathomir_handleBranch80(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dathomir_handleBranch82(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dathomir_handleBranch86(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_769"))
        {
            if (station_dathomir_condition__defaultCondition(player, npc))
    ...
    public int station_dathomir_handleBranch87(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_921"))
        {
            if (station_dathomir_condition__defaultCondition(player, npc))
    ...
    public int station_dathomir_handleBranch88(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_769"))
        {
            if (station_dathomir_condition__defaultCondition(player, npc))
    ...
    public int station_dathomir_handleBranch89(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dathomir_handleBranch92(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_dathomir_handleBranch94(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_769"))
        {
            if (station_dathomir_condition__defaultCondition(player, npc))
    ...
    public int station_dathomir_handleBranch95(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_769"))
        {
            if (station_dathomir_condition__defaultCondition(player, npc))
    ...
    public int station_dathomir_handleBranch96(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_959"))
        {
            if (station_dathomir_condition__defaultCondition(player, npc))
    ...
    public int station_dathomir_handleBranch97(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_769"))
        {
            if (station_dathomir_condition__defaultCondition(player, npc))
    ...
    public int station_dathomir_handleBranch98(obj_id player, obj_id npc, string_id response)
    {
