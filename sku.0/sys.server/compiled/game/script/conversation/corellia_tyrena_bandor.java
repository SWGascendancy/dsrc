...
public class corellia_tyrena_bandor extends script.base_script
{
    ...
    public boolean corellia_tyrena_bandor_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_tyrena_bandor_condition_onBandorTask(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_tyrena_missing_persons", "talk_bandor");
    }
    public boolean corellia_tyrena_bandor_condition_onFayeTask(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_tyrena_missing_persons", "defeat_faye");
    }
    public boolean corellia_tyrena_bandor_condition_onReturnBandor(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_tyrena_missing_persons", "confront_bandor");
    }
    public boolean corellia_tyrena_bandor_condition_completedMissingPersons(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "corellia_tyrena_missing_persons");
    }
    public void corellia_tyrena_bandor_action_signalBandorTask(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talk_bandor");
    }
    public void corellia_tyrena_bandor_action_signalGotoKyran(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "confront_bandor");
    }
    public int corellia_tyrena_bandor_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_bandor_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_bandor_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_bandor_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_bandor_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_bandor_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_bandor_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_bandor_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_bandor_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_bandor_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
