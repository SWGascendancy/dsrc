...
public class quest_hero_of_tatooine_pirate_leader extends script.base_script
{
    ...
    public boolean quest_hero_of_tatooine_pirate_leader_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean quest_hero_of_tatooine_pirate_leader_condition_quest(obj_id player, obj_id npc)
    {
    ...
    public void quest_hero_of_tatooine_pirate_leader_action_Attackplayer(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        messageTo(npc, "attackPlayer", params, 1, false);
    }
    public void quest_hero_of_tatooine_pirate_leader_action_QuestAccepted(obj_id player, obj_id npc)
    {
    ...
    public int quest_hero_of_tatooine_pirate_leader_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_hero_of_tatooine_pirate_leader_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_hero_of_tatooine_pirate_leader_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
