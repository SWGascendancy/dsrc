...
public class neutral_title_grant extends script.base_script
{
    ...
    public boolean neutral_title_grant_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean neutral_title_grant_condition_hasMillionCredits(obj_id player, obj_id npc)
    {
        return money.hasFunds(player, money.MT_TOTAL, money.MILLION);
    }
    public boolean neutral_title_grant_condition_hasTitles(obj_id player, obj_id npc)
    {
        return hasCompletedCollectionSlot(player, "neut_million_title") && hasCompletedCollectionSlot(player, "neut_billion_title");
    }
    public boolean neutral_title_grant_condition_hasMillionTitle(obj_id player, obj_id npc)
    {
        return hasCompletedCollectionSlot(player, "neut_million_title");
    }
    public boolean neutral_title_grant_condition_hasBillionTitle(obj_id player, obj_id npc)
    {
        return hasCompletedCollectionSlot(player, "neut_billion_title");
    }
    public boolean neutral_title_grant_condition_hasHundredMillionCredits(obj_id player, obj_id npc)
    {
        return money.hasFunds(player, money.MT_TOTAL, money.HUNDRED_MILLION);
    }
    public void neutral_title_grant_action_grantMillionTitle(obj_id player, obj_id npc)
    {
    ...
    public void neutral_title_grant_action_transferHundredMillion(obj_id player, obj_id npc)
    {
    ...
    public int neutral_title_grant_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int neutral_title_grant_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int neutral_title_grant_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int neutral_title_grant_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int neutral_title_grant_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
