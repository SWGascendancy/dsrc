...
public class c_story1_5_rebel extends script.base_script
{
    ...
    public boolean c_story1_5_rebel_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_story1_5_rebel_condition_isQualified(obj_id player, obj_id npc)
    {
    ...
    public boolean c_story1_5_rebel_condition_finishedQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean c_story1_5_rebel_condition_isOnQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean c_story1_5_rebel_condition_RemoveMe(obj_id player, obj_id npc)
    {
        return false;
    }
    public void c_story1_5_rebel_action_grantRebelQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest/c_syren5_rebel");
        return;
    }
    public int c_story1_5_rebel_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_5_rebel_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_5_rebel_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_5_rebel_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_5_rebel_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_5_rebel_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_5_rebel_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_5_rebel_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_5_rebel_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_5_rebel_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_5_rebel_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
