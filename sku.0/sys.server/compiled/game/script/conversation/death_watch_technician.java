...
public class death_watch_technician extends script.base_script
{
    ...
    public boolean death_watch_technician_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean death_watch_technician_condition_ventOff(obj_id player, obj_id npc)
    {
    ...
    public boolean death_watch_technician_condition_ventOn(obj_id player, obj_id npc)
    {
        obj_id structure = getTopMostContainer(npc);
        if (!isIdValid(structure))
        {
    ...
    public boolean death_watch_technician_condition_ventOffCompleted(obj_id player, obj_id npc)
    {
        obj_id structure = getTopMostContainer(npc);
        if (!isIdValid(structure))
        {
    ...
    public boolean death_watch_technician_condition_ventOffNewPlayer(obj_id player, obj_id npc)
    {
        obj_id structure = getTopMostContainer(npc);
        if (!isIdValid(structure))
        {
    ...
    public boolean death_watch_technician_condition_ventFailure(obj_id player, obj_id npc)
    {
        obj_id structure = getTopMostContainer(npc);
        if (!isIdValid(structure))
        {
    ...
    public boolean death_watch_technician_condition_ventOnOldPlayer(obj_id player, obj_id npc)
    {
        obj_id structure = getTopMostContainer(npc);
        if (!isIdValid(structure))
        {
    ...
    public boolean death_watch_technician_condition_toSoon(obj_id player, obj_id npc)
    {
    ...
    public boolean death_watch_technician_condition_readyToGoAgain(obj_id player, obj_id npc)
    {
        int oldTime = getIntObjVar(player, "death_watch.air_vent_fail");
        int refreshTime = oldTime + 1800;
        int curTime = getGameTime();
    ...
    public boolean death_watch_technician_condition_goProtectDroid(obj_id player, obj_id npc)
    {
        obj_id structure = getTopMostContainer(npc);
        if (!isIdValid(structure))
        {
    ...
    public void death_watch_technician_action_startEvent(obj_id player, obj_id npc)
    {
        obj_id structure = getTopMostContainer(npc);
        if (!isIdValid(structure))
        {
    ...
    public int death_watch_technician_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_technician_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_technician_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_technician_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_technician_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_technician_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_technician_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_technician_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_technician_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
