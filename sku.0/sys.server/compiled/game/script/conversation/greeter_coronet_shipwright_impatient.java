...
public class greeter_coronet_shipwright_impatient extends script.base_script
{
    ...
    public boolean greeter_coronet_shipwright_impatient_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean greeter_coronet_shipwright_impatient_condition_missingShipmentFound(obj_id player, obj_id npc)
    {
    ...
    public int greeter_coronet_shipwright_impatient_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int greeter_coronet_shipwright_impatient_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
