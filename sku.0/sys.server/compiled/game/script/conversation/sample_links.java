...
public class sample_links extends script.base_script
{
    ...
    public boolean sample_links_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean sample_links_condition_condition0001(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean sample_links_condition_condition0002(obj_id player, obj_id npc)
    {
        return true;
    }
    public void sample_links_action__defaultAction(obj_id player, obj_id npc)
    {
    }
    public void sample_links_action_action0001(obj_id player, obj_id npc)
    {
    }
