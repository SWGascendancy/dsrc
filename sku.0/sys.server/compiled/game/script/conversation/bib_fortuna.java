...
public class bib_fortuna extends script.base_script
{
    ...
    public boolean bib_fortuna_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean bib_fortuna_condition_completedBib(obj_id player, obj_id npc)
    {
    ...
    public boolean bib_fortuna_condition_killedRomoVax(obj_id player, obj_id npc)
    {
    ...
    public boolean bib_fortuna_condition_killingRomoVax(obj_id player, obj_id npc)
    {
    ...
    public boolean bib_fortuna_condition_takeDisksToBib(obj_id player, obj_id npc)
    {
    ...
    public boolean bib_fortuna_condition_dealingWithRomo(obj_id player, obj_id npc)
    {
    ...
    public boolean bib_fortuna_condition_completedBarada(obj_id player, obj_id npc)
    {
    ...
    public void bib_fortuna_action_grantBibsQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest/jabba_bib_fortuna_v2");
    }
    public void bib_fortuna_action_sendGotDisksSignal(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        groundquests.sendSignal(player, "romosDisksDelivered");
    }
    public void bib_fortuna_action_sendKilledRomoSignal(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        groundquests.sendSignal(player, "romoVaxKilled");
        groundquests.grantQuest(player, "pointer_jabba");
    }
    public void bib_fortuna_action_clearPointer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        groundquests.sendSignal(player, "found_bib");
    }
    public void bib_fortuna_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int bib_fortuna_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int bib_fortuna_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int bib_fortuna_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int bib_fortuna_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int bib_fortuna_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int bib_fortuna_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int bib_fortuna_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int bib_fortuna_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int bib_fortuna_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int bib_fortuna_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
