...
public class ep3_etyyy_johnson_smith extends script.base_script
{
    ...
    public boolean ep3_etyyy_johnson_smith_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_etyyy_johnson_smith_condition_sentByJerrol(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_etyyy_johnson_smith_condition_lookingForRyoo(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_hunt_johnson_retrieve_ryoos_stash", "johnson_talkToRyoo");
    }
    public boolean ep3_etyyy_johnson_smith_condition_finishedHelpingRyoo(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_hunt_johnson_retrieve_ryoos_stash", "johnson_ryoosSalt");
    }
    public boolean ep3_etyyy_johnson_smith_condition_sentByChrilooc(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_etyyy_johnson_smith_condition_doesNotHaveBrodyQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_etyyy_johnson_smith_condition_hasPendant(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_hunt_johnson_brody_johnson", "johnson_foundPendant");
    }
    public boolean ep3_etyyy_johnson_smith_condition_lookingForBrodyCamp(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_hunt_johnson_brody_johnson", "johnson_searchCampsite");
    }
    public boolean ep3_etyyy_johnson_smith_condition_speakingToMada(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_hunt_johnson_brody_johnson", "johnson_talkToMada");
    }
    public boolean ep3_etyyy_johnson_smith_condition_returningFromMada(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_hunt_johnson_brody_johnson", "johnson_returnToSmith");
    }
    public boolean ep3_etyyy_johnson_smith_condition_doingSmithQuests(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_etyyy_johnson_smith_condition_helpingRyoo(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_hunt_johnson_retrieve_ryoos_stash");
    }
    public boolean ep3_etyyy_johnson_smith_condition_findingBrody(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_hunt_johnson_brody_johnson");
    }
    public boolean ep3_etyyy_johnson_smith_condition_completedSmithQuests(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_etyyy_johnson_smith_condition_helpingKara(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_hunt_johnson_help_kara");
    }
    public boolean ep3_etyyy_johnson_smith_condition_finishedKaraQuest(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_hunt_johnson_help_kara", "johnson_deliveriesMade");
    }
    public boolean ep3_etyyy_johnson_smith_condition_sentToKint(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_hunt_johnson_seek_kint");
    }
    public boolean ep3_etyyy_johnson_smith_condition_notStartedRyoo(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_etyyy_johnson_smith_condition_karaDeliveries(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_hunt_johnson_help_kara", "johnson_karaDeliveries");
    }
    public boolean ep3_etyyy_johnson_smith_condition_lookingForKara(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_hunt_johnson_help_kara", "johnson_talkToKara");
    }
    public boolean ep3_etyyy_johnson_smith_condition_needsKint(obj_id player, obj_id npc)
    {
    ...
    public void ep3_etyyy_johnson_smith_action_endBrodyQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "johnson_returnToSmith");
        groundquests.grantQuest(player, "ep3_hunt_vritol_reward_mount");
    }
    public void ep3_etyyy_johnson_smith_action_giveRyooQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_hunt_johnson_retrieve_ryoos_stash");
    }
    public void ep3_etyyy_johnson_smith_action_grantBrodyQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_hunt_johnson_brody_johnson");
    }
    public void ep3_etyyy_johnson_smith_action_sendToMada(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "johnson_foundPendant");
    }
    public void ep3_etyyy_johnson_smith_action_endRyooQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "johnson_ryoosSalt");
    }
    public void ep3_etyyy_johnson_smith_action_giveKaraQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_hunt_johnson_help_kara");
    }
    public void ep3_etyyy_johnson_smith_action_endKaraQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "johnson_deliveriesMade");
    }
    public void ep3_etyyy_johnson_smith_action_speakWithKint(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_hunt_johnson_seek_kint");
    }
    public void ep3_etyyy_johnson_smith_action_spokeWithJohnson(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "chrilooc_seekJohnsonSmith");
    }
    public int ep3_etyyy_johnson_smith_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_johnson_smith_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_johnson_smith_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_johnson_smith_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_122"))
        {
            if (ep3_etyyy_johnson_smith_condition__defaultCondition(player, npc))
    ...
    public int ep3_etyyy_johnson_smith_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_johnson_smith_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_johnson_smith_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_johnson_smith_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_johnson_smith_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_johnson_smith_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_johnson_smith_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_johnson_smith_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_johnson_smith_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_johnson_smith_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_johnson_smith_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_johnson_smith_handleBranch30(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_johnson_smith_handleBranch32(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_johnson_smith_handleBranch37(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_johnson_smith_handleBranch38(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_johnson_smith_handleBranch39(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_johnson_smith_handleBranch40(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_johnson_smith_handleBranch43(obj_id player, obj_id npc, string_id response)
    {
