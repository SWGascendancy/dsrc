...
public class tatooine_bestinejobs_jasha extends script.base_script
{
    ...
    public boolean tatooine_bestinejobs_jasha_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tatooine_bestinejobs_jasha_condition_questBestineComplete(obj_id player, obj_id npc)
    {
    ...
    public boolean tatooine_bestinejobs_jasha_condition_questBlocker(obj_id player, obj_id npc)
    {
        return groundquests.isQuestDisabled("tatooine_bestinejobs_bantha");
    }
    public boolean tatooine_bestinejobs_jasha_condition_questBanthaComplete(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "tatooine_bestinejobs_bantha");
    }
    public boolean tatooine_bestinejobs_jasha_condition_questXwingComplete(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "tatooine_bestinejobs_xwing");
    }
    public boolean tatooine_bestinejobs_jasha_condition_questRebSympComplete(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "tatooine_bestinejobs_rebsymp");
    }
    public boolean tatooine_bestinejobs_jasha_condition_onQuest(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_bestinejobs_bantha");
        int questId2 = questGetQuestId("quest/tatooine_bestinejobs_rebsymp");
        int questId3 = questGetQuestId("quest/tatooine_bestinejobs_xwing");
    ...
    public void tatooine_bestinejobs_jasha_action_questXwingGranted(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "tatooine_bestinejobs_xwing");
    }
    public void tatooine_bestinejobs_jasha_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void tatooine_bestinejobs_jasha_action_questRebSympGranted(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "tatooine_bestinejobs_rebsymp");
    }
    public void tatooine_bestinejobs_jasha_action_questBanthaGranted(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "tatooine_bestinejobs_bantha");
    }
    public int tatooine_bestinejobs_jasha_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_bestinejobs_jasha_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_bestinejobs_jasha_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_bestinejobs_jasha_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_bestinejobs_jasha_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_bestinejobs_jasha_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_bestinejobs_jasha_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_bestinejobs_jasha_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
