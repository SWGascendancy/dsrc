...
public class coronet_captain_dool extends script.base_script
{
    ...
    public boolean coronet_captain_dool_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean coronet_captain_dool_condition_justCameFromSheelya(obj_id player, obj_id npc)
    {
    ...
    public boolean coronet_captain_dool_condition_doingDoolsQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "quest/coronet_captain_dool");
    }
    public boolean coronet_captain_dool_condition_readyToFinishDoolsQueset(obj_id player, obj_id npc)
    {
    ...
    public boolean coronet_captain_dool_condition_giveGoToLymanZavalaAgain(obj_id player, obj_id npc)
    {
    ...
    public boolean coronet_captain_dool_condition_workingForLyman(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "quest/tyrena_goto_lyman_zavala");
    }
    public void coronet_captain_dool_action_grantDoolQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest/coronet_captain_dool");
    }
    public void coronet_captain_dool_action_completeGoToDoolQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "spokeWithCO");
    }
    public void coronet_captain_dool_action_completeDoolsQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "doneWithDool");
    }
    public void coronet_captain_dool_action_giveLymanGoTo(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest/tyrena_goto_lyman_zavala");
    }
    public void coronet_captain_dool_action_sendGreckMissionCompleteSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "finishedDoolsGreckMission");
    }
    public int coronet_captain_dool_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int coronet_captain_dool_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int coronet_captain_dool_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
