...
public class death_watch_rescue_scientist extends script.base_script
{
    ...
    public boolean death_watch_rescue_scientist_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean death_watch_rescue_scientist_condition_RebelCheck(obj_id player, obj_id npc)
    {
    ...
    public boolean death_watch_rescue_scientist_condition_ImperialCheck(obj_id player, obj_id npc)
    {
        String playerFaction = factions.getFaction(player);
        if (playerFaction == null)
        {
    ...
    public boolean death_watch_rescue_scientist_condition_NeutralCheck(obj_id player, obj_id npc)
    {
        String playerFaction = factions.getFaction(player);
        if (playerFaction == null)
        {
    ...
    public boolean death_watch_rescue_scientist_condition_AlreadyRescuedCheck(obj_id player, obj_id npc)
    {
    ...
    public void death_watch_rescue_scientist_action__defaultAction(obj_id player, obj_id npc)
    {
    }
    public void death_watch_rescue_scientist_action_RewardRebel(obj_id player, obj_id npc)
    {
    ...
    public void death_watch_rescue_scientist_action_RewardImperial(obj_id player, obj_id npc)
    {
        if (!hasObjVar(player, "death_watch_herald.imperialrescue"))
        {
    ...
    public void death_watch_rescue_scientist_action_RewardNeutral(obj_id player, obj_id npc)
    {
        if (!hasObjVar(player, "death_watch_herald.neutralrescue"))
        {
            int credits = 487;
