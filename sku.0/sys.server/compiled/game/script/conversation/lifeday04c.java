...
public class lifeday04c extends script.base_script
{
    ...
    public boolean lifeday04c_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean lifeday04c_condition_notSpokeWithElder(obj_id player, obj_id npc)
    {
    ...
    public boolean lifeday04c_condition_isanImp(obj_id player, obj_id npc)
    {
        String pvpFaction = factions.getFaction(player);
        return pvpFaction.equals("Imperial");
    }
    public boolean lifeday04c_condition_noFaction(obj_id player, obj_id npc)
    {
        String pvpFaction = factions.getFaction(player);
        if (pvpFaction == null)
        {
    ...
    public boolean lifeday04c_condition_hasBeenReward(obj_id player, obj_id npc)
    {
    ...
    public void lifeday04c_action_setTalkedToYou(obj_id player, obj_id npc)
    {
        int convTracker = getIntObjVar(player, "lifeday04.convTracker");
    ...
    public int lifeday04c_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int lifeday04c_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int lifeday04c_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int lifeday04c_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int lifeday04c_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int lifeday04c_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int lifeday04c_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_9103b44a"))
        {
            lifeday04c_action_setTalkedToYou(player, npc);
    ...
    public int lifeday04c_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_8e0ee46c"))
        {
            if (lifeday04c_condition__defaultCondition(player, npc))
    ...
    public int lifeday04c_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_959f717"))
        {
            if (lifeday04c_condition__defaultCondition(player, npc))
    ...
    public int lifeday04c_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_b8b7ef2b"))
        {
            if (lifeday04c_condition_noFaction(player, npc))
    ...
    public int lifeday04c_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_9103b44a"))
        {
            lifeday04c_action_setTalkedToYou(player, npc);
    ...
    public int lifeday04c_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_bd5e746e"))
        {
            lifeday04c_action_setTalkedToYou(player, npc);
    ...
    public int lifeday04c_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_9103b44a"))
        {
            lifeday04c_action_setTalkedToYou(player, npc);
