...
public class community_tcg_photo_contest_painting_handout extends script.base_script
{
    ...
    public boolean community_tcg_photo_contest_painting_handout_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean community_tcg_photo_contest_painting_handout_condition_hasReceivedPainting02(obj_id player, obj_id npc)
    {
    ...
    public boolean community_tcg_photo_contest_painting_handout_condition_hasReceivedPainting01(obj_id player, obj_id npc)
    {
    ...
    public boolean community_tcg_photo_contest_painting_handout_condition_canReceivePaintings(obj_id player, obj_id npc)
    {
    ...
    public boolean community_tcg_photo_contest_painting_handout_condition_hasNone(obj_id player, obj_id npc)
    {
    ...
    public boolean community_tcg_photo_contest_painting_handout_condition_not_old_enough(obj_id player, obj_id npc)
    {
        int myAge = getCurrentBirthDate() - getPlayerBirthDate(player);
        if (myAge < 10)
        {
    ...
    public boolean community_tcg_photo_contest_painting_handout_condition_hasReceivedAllPaintings(obj_id player, obj_id npc)
    {
    ...
    public boolean community_tcg_photo_contest_painting_handout_condition_hasReceivedPainting03(obj_id player, obj_id npc)
    {
    ...
    public void community_tcg_photo_contest_painting_handout_action_grantPainting03(obj_id player, obj_id npc)
    {
    ...
    public void community_tcg_photo_contest_painting_handout_action_grantPainting02(obj_id player, obj_id npc)
    {
        if (!isValidId(player) || !isValidId(npc))
        {
            return;
    ...
    public void community_tcg_photo_contest_painting_handout_action_grantAllPaintings(obj_id player, obj_id npc)
    {
    ...
    public void community_tcg_photo_contest_painting_handout_action_grantPainting01(obj_id player, obj_id npc)
    {
        if (!isValidId(player) || !isValidId(npc))
        {
            return;
    ...
    public int community_tcg_photo_contest_painting_handout_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int community_tcg_photo_contest_painting_handout_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int community_tcg_photo_contest_painting_handout_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
