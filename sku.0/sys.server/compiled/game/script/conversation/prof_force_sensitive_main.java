...
public class prof_force_sensitive_main extends script.base_script
{
    ...
    public boolean prof_force_sensitive_main_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean prof_force_sensitive_main_condition_playerOnFS11Reward(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "prof_force_sensitive_11", "getreward");
    }
    public boolean prof_force_sensitive_main_condition_playerfinishedFS11Quest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "prof_force_sensitive_11");
    }
    public boolean prof_force_sensitive_main_condition_playeronFS21(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "prof_force_sensitive_21_1");
    }
    public boolean prof_force_sensitive_main_condition_playerOnFS21Reward(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "prof_force_sensitive_21_1", "getreward");
    }
    public void prof_force_sensitive_main_action_giveRewardSignal_11(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "prof_force_sensitive_11_reward");
    }
    public void prof_force_sensitive_main_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void prof_force_sensitive_main_action_giveRewardSignal_21(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "prof_force_sensitive_21_3_reward");
    }
    public int prof_force_sensitive_main_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int prof_force_sensitive_main_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
