...
public class corvette_rebel_pilot extends script.base_script
{
    ...
    public boolean corvette_rebel_pilot_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corvette_rebel_pilot_condition_hasRebelTicket(obj_id player, obj_id npc)
    {
    ...
    public boolean corvette_rebel_pilot_condition_tooManyInGroup(obj_id player, obj_id npc)
    {
    ...
    public boolean corvette_rebel_pilot_condition_tooManyAndNotAllRebel(obj_id player, obj_id npc)
    {
        return (corvette_rebel_pilot_condition_tooManyInGroup(player, npc) && corvette_rebel_pilot_condition_notAllRebel(player, npc));
    }
    public boolean corvette_rebel_pilot_condition_notAllRebel(obj_id player, obj_id npc)
    {
        if (group.isGrouped(player))
        {
            obj_id groupObj = getGroupObject(player);
    ...
    public void corvette_rebel_pilot_action__defaultAction(obj_id player, obj_id npc)
    {
    }
    public void corvette_rebel_pilot_action_sendToDungeon(obj_id player, obj_id npc)
    {
        space_dungeon.selectDungeonTicket(npc, player);
        return;
    }
    public void corvette_rebel_pilot_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return;
    }
