...
public class npe_pilot_easy extends script.base_script
{
    ...
    public boolean npe_pilot_easy_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_pilot_easy_condition_hasFailedEasyMission1(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_pilot_easy_1", "failedEasy1");
    }
    public boolean npe_pilot_easy_condition_isOnMission(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_pilot_easy_condition_hasWonEasyMission1(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedQuest(player, "npe_pilot_easy_1") || groundquests.isTaskActive(player, "npe_pilot_easy_1", "report"));
    }
    public boolean npe_pilot_easy_condition_startedMedium(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "npe_pilot_medium_1");
    }
    public boolean npe_pilot_easy_condition_hasFailedEasyMission2(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_pilot_easy_2", "failedEasy2");
    }
    public boolean npe_pilot_easy_condition_hasWonEasyMission2(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedQuest(player, "npe_pilot_easy_2") || groundquests.isTaskActive(player, "npe_pilot_easy_2", "report"));
    }
    public boolean npe_pilot_easy_condition_hasFailedEasyMission3(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_pilot_easy_3", "failedEasy3");
    }
    public boolean npe_pilot_easy_condition_hasWonEasyMission3(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedQuest(player, "npe_pilot_easy_3") || groundquests.isTaskActive(player, "npe_pilot_easy_3", "report"));
    }
    public boolean npe_pilot_easy_condition_hasFailedEasyMission4(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_pilot_easy_4", "failedEasy4");
    }
    public boolean npe_pilot_easy_condition_hasWonEasyMission4(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedQuest(player, "npe_pilot_easy_4") || groundquests.isTaskActive(player, "npe_pilot_easy_4", "report"));
    }
    public boolean npe_pilot_easy_condition_hasFinishedTraining(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_pilot_training_3");
    }
    public void npe_pilot_easy_action_grantEasyMission1(obj_id player, obj_id npc)
    {
    ...
    public void npe_pilot_easy_action_grantEasyMission2(obj_id player, obj_id npc)
    {
    ...
    public void npe_pilot_easy_action_grantEasyMission3(obj_id player, obj_id npc)
    {
    ...
    public void npe_pilot_easy_action_grantEasyMission4(obj_id player, obj_id npc)
    {
    ...
    public void npe_pilot_easy_action_grantReward1(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "reported");
    }
    public void npe_pilot_easy_action_grantReward2(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "reported");
    }
    public void npe_pilot_easy_action_grantReward3(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "reported");
    }
    public void npe_pilot_easy_action_grantReward4(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "reported");
    }
    public void npe_pilot_easy_action_sendToAleas(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_pilot_aleas");
    }
    public void npe_pilot_easy_action_signalFoundLaetin(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talktome");
    }
    public void npe_pilot_easy_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int npe_pilot_easy_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_easy_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_easy_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_easy_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_easy_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_easy_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_easy_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_easy_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_easy_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_easy_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_easy_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_easy_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_easy_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_easy_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_easy_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_easy_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_easy_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_easy_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_easy_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_easy_handleBranch31(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_easy_handleBranch32(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_easy_handleBranch34(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_easy_handleBranch35(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_easy_handleBranch36(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_easy_handleBranch38(obj_id player, obj_id npc, string_id response)
    {
