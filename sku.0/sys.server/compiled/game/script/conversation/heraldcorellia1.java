...
public class heraldcorellia1 extends script.base_script
{
    ...
    public boolean heraldcorellia1_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public void heraldcorellia1_action__defaultAction(obj_id player, obj_id npc)
    {
    }
    public void heraldcorellia1_action_waypoint1(obj_id player, obj_id npc)
    {
    ...
    public void heraldcorellia1_action_waypoint2(obj_id player, obj_id npc)
    {
    ...
    public void heraldcorellia1_action_waypoint3(obj_id player, obj_id npc)
    {
    ...
    public void heraldcorellia1_action_abovehead(obj_id player, obj_id npc)
    {
        doAnimationAction(npc, "hands_above_head");
    }
    public void heraldcorellia1_action_shush(obj_id player, obj_id npc)
    {
        doAnimationAction(npc, "shush");
    }
    public void heraldcorellia1_action_thoughtful(obj_id player, obj_id npc)
    {
        doAnimationAction(npc, "rub_chin_thoughtful");
    }
    public void heraldcorellia1_action_dismiss(obj_id player, obj_id npc)
    {
