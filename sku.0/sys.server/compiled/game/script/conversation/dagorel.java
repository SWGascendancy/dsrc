...
public class dagorel extends script.base_script
{
    ...
    public boolean dagorel_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean dagorel_condition_onBorvosGuardQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean dagorel_condition_finishedBorvosGuardQuest(obj_id player, obj_id npc)
    {
    ...
    public void dagorel_action_broughtMeMedicine(obj_id player, obj_id npc)
    {
