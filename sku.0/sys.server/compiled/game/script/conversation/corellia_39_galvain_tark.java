...
public class corellia_39_galvain_tark extends script.base_script
{
    ...
    public boolean corellia_39_galvain_tark_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_39_galvain_tark_condition_taskOneActive(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "corellia_39_sidequest_01");
    }
    public boolean corellia_39_galvain_tark_condition_taskOneComplete(obj_id player, obj_id npc)
    {
    ...
    public void corellia_39_galvain_tark_action_questGranted(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "corellia_39_sidequest_03");
    }
    public void corellia_39_galvain_tark_action_taskOneCompletedSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "corellia_39_sidequest_03_02");
    }
    public int corellia_39_galvain_tark_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
