...
public class tatooine_eisley_purvis extends script.base_script
{
    ...
    public boolean tatooine_eisley_purvis_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tatooine_eisley_purvis_condition_completedRecon(obj_id player, obj_id npc)
    {
    ...
    public boolean tatooine_eisley_purvis_condition_completedCombatQuests(obj_id player, obj_id npc)
    {
    ...
    public boolean tatooine_eisley_purvis_condition_isReadyForPurvis(obj_id player, obj_id npc)
    {
    ...
    public boolean tatooine_eisley_purvis_condition_isOnCombatQuests(obj_id player, obj_id npc)
    {
    ...
    public boolean tatooine_eisley_purvis_condition_goSeeMayor(obj_id player, obj_id npc)
    {
    ...
    public boolean tatooine_eisley_purvis_condition_needsACombatQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean tatooine_eisley_purvis_condition_pickingPurvisPocket(obj_id player, obj_id npc)
    {
    ...
    public boolean tatooine_eisley_purvis_condition_completedOneRecon(obj_id player, obj_id npc)
    {
    ...
    public boolean tatooine_eisley_purvis_condition_senByMayor(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "c_ranged_combat_trainer");
    }
    public void tatooine_eisley_purvis_action_grantReconQuest1(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "quest/purvis_recon_one");
    }
    public void tatooine_eisley_purvis_action_grantCombatQuest(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "quest/purvis_kill_zealots");
    }
    public void tatooine_eisley_purvis_action_startTaskThree(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "start_task_three");
    }
    public void tatooine_eisley_purvis_action_sendPocketPickSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "purvisPocketPicked");
    }
    public void tatooine_eisley_purvis_action_checkReconQuestStatus(obj_id player, obj_id npc)
    {
    ...
    public void tatooine_eisley_purvis_action_endFromMayor(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "newbie_speak_purvis");
    }
    public void tatooine_eisley_purvis_action_sendCompleteReconSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "purvis_return");
    }
    public int tatooine_eisley_purvis_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_purvis_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_purvis_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_purvis_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_purvis_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_purvis_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_purvis_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_purvis_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_purvis_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_purvis_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_purvis_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_purvis_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
