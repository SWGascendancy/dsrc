...
public class rodian_apprentice_hunter extends script.base_script
{
    ...
    public boolean rodian_apprentice_hunter_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public int rodian_apprentice_hunter_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
