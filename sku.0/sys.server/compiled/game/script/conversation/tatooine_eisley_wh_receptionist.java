...
public class tatooine_eisley_wh_receptionist extends script.base_script
{
    ...
    public boolean tatooine_eisley_wh_receptionist_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tatooine_eisley_wh_receptionist_condition_cargoDelivery2(obj_id player, obj_id npc)
    {
    ...
    public void tatooine_eisley_wh_receptionist_action_sdDelivery2(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tat_eisley_special_delivery_e4");
    }
    public int tatooine_eisley_wh_receptionist_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_wh_receptionist_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
