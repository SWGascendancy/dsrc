...
public class rebel_pilot_rescue extends script.base_script
{
    ...
    public boolean rebel_pilot_rescue_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean rebel_pilot_rescue_condition_hasTheMisionActiveAndIsMyRescuer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_pilot_rescue_condition_isNotMyRescuer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        if (!hasObjVar(npc, "rescuer") || !hasObjVar(npc, "rescuerQuest"))
        {
    ...
    public void rebel_pilot_rescue_action_changeIntoDisguise(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, holiday.EMPIREDAYQUEST_REB_COMBAT_01);
    }
    public String rebel_pilot_rescue_tokenTO_timeLeftRecruitment(obj_id player, obj_id npc)
    {
    ...
    public String rebel_pilot_rescue_tokenTO_timeLeftPropaganda(obj_id player, obj_id npc)
    {
    ...
    public int rebel_pilot_rescue_tokenDI_notUsed(obj_id player, obj_id npc)
    {
        return 0;
    }
    public int rebel_pilot_rescue_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
