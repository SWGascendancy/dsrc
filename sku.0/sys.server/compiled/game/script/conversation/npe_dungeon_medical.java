...
public class npe_dungeon_medical extends script.base_script
{
    ...
    public boolean npe_dungeon_medical_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_dungeon_medical_condition_isQuestFrelkaActive(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_dungeon_medical_condition_isAphoticActive(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_frelka_quest", "killDie");
    }
    public boolean npe_dungeon_medical_condition_hasCompletedQuestAphotic(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_frelka_quest", "done");
    }
    public boolean npe_dungeon_medical_condition_hasCompletedFrelka(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "npe_frelka_quest", "done");
    }
    public boolean npe_dungeon_medical_condition_hasTemplate(obj_id player, obj_id npc)
    {
        return (hasObjVar(player, "npe.finishedTemplate") && !groundquests.isQuestActiveOrComplete(player, "npe_frelka_quest"));
    }
    public boolean npe_dungeon_medical_condition_hasFrelkaDungeonQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "npe_frelka_quest");
    }
    public void npe_dungeon_medical_action_faceToNoob(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void npe_dungeon_medical_action_giveSignalNoob(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkdroid");
    }
    public void npe_dungeon_medical_action_grantFrelkaQuest(obj_id player, obj_id npc)
    {
    ...
    public void npe_dungeon_medical_action_grantFrelkaReturn(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_pointer_gamma");
    }
    public void npe_dungeon_medical_action_sendSignalNoob2(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "return");
    }
    public int npe_dungeon_medical_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_dungeon_medical_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_dungeon_medical_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_dungeon_medical_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_dungeon_medical_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_dungeon_medical_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_88"))
        {
            if (npe_dungeon_medical_condition__defaultCondition(player, npc))
    ...
    public int npe_dungeon_medical_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_88"))
        {
            if (npe_dungeon_medical_condition__defaultCondition(player, npc))
    ...
    public int npe_dungeon_medical_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_88"))
        {
            if (npe_dungeon_medical_condition__defaultCondition(player, npc))
    ...
    public int npe_dungeon_medical_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_88"))
        {
            if (npe_dungeon_medical_condition__defaultCondition(player, npc))
    ...
    public int npe_dungeon_medical_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_dungeon_medical_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_88"))
        {
            if (npe_dungeon_medical_condition__defaultCondition(player, npc))
    ...
    public int npe_dungeon_medical_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_dungeon_medical_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_dungeon_medical_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_dungeon_medical_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_dungeon_medical_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_dungeon_medical_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_88"))
        {
            if (npe_dungeon_medical_condition__defaultCondition(player, npc))
    ...
    public int npe_dungeon_medical_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_88"))
        {
            if (npe_dungeon_medical_condition__defaultCondition(player, npc))
    ...
    public int npe_dungeon_medical_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_88"))
        {
            if (npe_dungeon_medical_condition__defaultCondition(player, npc))
    ...
    public int npe_dungeon_medical_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_88"))
        {
            if (npe_dungeon_medical_condition__defaultCondition(player, npc))
    ...
    public int npe_dungeon_medical_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_88"))
        {
            if (npe_dungeon_medical_condition__defaultCondition(player, npc))
    ...
    public int npe_dungeon_medical_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_88"))
        {
            if (npe_dungeon_medical_condition__defaultCondition(player, npc))
    ...
    public int npe_dungeon_medical_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_dungeon_medical_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_dungeon_medical_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_dungeon_medical_handleBranch30(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_dungeon_medical_handleBranch31(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_88"))
        {
            if (npe_dungeon_medical_condition__defaultCondition(player, npc))
    ...
    public int npe_dungeon_medical_handleBranch32(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_88"))
        {
            if (npe_dungeon_medical_condition__defaultCondition(player, npc))
    ...
    public int npe_dungeon_medical_handleBranch33(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_88"))
        {
            if (npe_dungeon_medical_condition__defaultCondition(player, npc))
    ...
    public int npe_dungeon_medical_handleBranch34(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_88"))
        {
            if (npe_dungeon_medical_condition__defaultCondition(player, npc))
    ...
    public int npe_dungeon_medical_handleBranch35(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_88"))
        {
            if (npe_dungeon_medical_condition__defaultCondition(player, npc))
    ...
    public int npe_dungeon_medical_handleBranch37(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_dungeon_medical_handleBranch38(obj_id player, obj_id npc, string_id response)
    {
