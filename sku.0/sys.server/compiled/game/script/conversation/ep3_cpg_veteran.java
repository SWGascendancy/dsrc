...
public class ep3_cpg_veteran extends script.base_script
{
    ...
    public boolean ep3_cpg_veteran_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_cpg_veteran_condition_isOnQuest_escort_alpha(obj_id player, obj_id npc)
    {
        return (space_quest.hasQuest(player, "escort", "ep3_kash_station_escort_alpha"));
    }
    public boolean ep3_cpg_veteran_condition_hasFailedQuest_02(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_cpg_veteran_condition_hasWon_assassinations(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_cpg_veteran_condition_isOnQuest_AMBUSH(obj_id player, obj_id npc)
    {
        return (space_quest.hasQuest(player, "destroy_surpriseattack", "ep3_kash_station_ghrag_ambush"));
    }
    public boolean ep3_cpg_veteran_condition_hasFailedQuest_03(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_cpg_veteran_condition_isOnQuest_rescue_alpha(obj_id player, obj_id npc)
    {
        return (space_quest.hasQuest(player, "rescue", "ep3_kash_station_rescue_alpha"));
    }
    public boolean ep3_cpg_veteran_condition_isOnQuest_escort_bravo(obj_id player, obj_id npc)
    {
        return (space_quest.hasQuest(player, "escort", "ep3_kash_station_escort_bravo"));
    }
    public boolean ep3_cpg_veteran_condition_isTooFar(obj_id player, obj_id npc)
    {
        space_combat.playCombatTauntSound(player);
        obj_id containingShip = space_transition.getContainingShip(player);
        return (getDistance(npc, containingShip) > space_transition.STATION_COMM_MAX_DISTANCE);
    }
    public boolean ep3_cpg_veteran_condition_hasBadge_visited_Kachirho(obj_id player, obj_id npc)
    {
        return badge.hasBadge(player, "exp_kash_kachirho_found");
    }
    public boolean ep3_cpg_veteran_condition_isAttacking(obj_id player, obj_id npc)
    {
        return _spaceUnitIsAttacking(npc);
    }
    public boolean ep3_cpg_veteran_condition_isOnQuest(obj_id player, obj_id npc)
    {
        return space_quest.hasQuest(player);
    }
    public void ep3_cpg_veteran_action_grantDuty_destroy(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "ep3_kash_station_destroy_duty_veteran");
    }
    public int ep3_cpg_veteran_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_cpg_veteran_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_cpg_veteran_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_cpg_veteran_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_cpg_veteran_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_cpg_veteran_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_cpg_veteran_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_cpg_veteran_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_cpg_veteran_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_cpg_veteran_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_cpg_veteran_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_cpg_veteran_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
