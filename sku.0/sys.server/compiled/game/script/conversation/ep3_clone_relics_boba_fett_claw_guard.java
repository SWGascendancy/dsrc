...
public class ep3_clone_relics_boba_fett_claw_guard extends script.base_script
{
    ...
    public boolean ep3_clone_relics_boba_fett_claw_guard_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_clone_relics_boba_fett_claw_guard_condition_guardsDefeated(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "ep3_clone_relics_boba_fett_7", "defeatedGuards");
    }
    public boolean ep3_clone_relics_boba_fett_claw_guard_condition_onQuestSevenTaskOne(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "ep3_clone_relics_boba_fett_7", "bodyguard"));
    }
    public void ep3_clone_relics_boba_fett_claw_guard_action_signalTalked(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedToGuard");
    }
    public int ep3_clone_relics_boba_fett_claw_guard_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_boba_fett_claw_guard_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_boba_fett_claw_guard_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_boba_fett_claw_guard_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_boba_fett_claw_guard_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
