...
public class tier3convotemplate extends script.base_script
{
    ...
    public boolean tier3convotemplate_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tier3convotemplate_condition_isCorrectFaction(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tier3convotemplate_condition_isReadyForTier3(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tier3convotemplate_condition_isOnQuest(obj_id player, obj_id npc)
    {
        return (space_quest.hasQuest(player));
    }
    public boolean tier3convotemplate_condition_failedQuestOne(obj_id player, obj_id npc)
    {
        return false;
    }
    public boolean tier3convotemplate_condition_failedQuestTwo(obj_id player, obj_id npc)
    {
        return false;
    }
    public boolean tier3convotemplate_condition_failedQuestThree(obj_id player, obj_id npc)
    {
        return false;
    }
    public boolean tier3convotemplate_condition_FailedQuestFour(obj_id player, obj_id npc)
    {
        return false;
    }
    public boolean tier3convotemplate_condition_FailedQuestFive(obj_id player, obj_id npc)
    {
        return false;
    }
    public boolean tier3convotemplate_condition_FailedQuestSix(obj_id player, obj_id npc)
    {
        return false;
    }
    public boolean tier3convotemplate_condition_collectingQuestOneReward(obj_id player, obj_id npc)
    {
        return false;
    }
    public boolean tier3convotemplate_condition_collectingQuestTwoReward(obj_id player, obj_id npc)
    {
        return false;
    }
    public boolean tier3convotemplate_condition_collectingQuestThreeReward(obj_id player, obj_id npc)
    {
        return false;
    }
    public boolean tier3convotemplate_condition_collectingQuestFourReward(obj_id player, obj_id npc)
    {
        return false;
    }
    public boolean tier3convotemplate_condition_collectingQuestFiveReward(obj_id player, obj_id npc)
    {
        return false;
    }
    public boolean tier3convotemplate_condition_collectingQuestSixReward(obj_id player, obj_id npc)
    {
        return false;
    }
    public boolean tier3convotemplate_condition_hasCompletedQuestOne(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tier3convotemplate_condition_hasCompletedQuestTwo(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tier3convotemplate_condition_hasCompletedQuestThree(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tier3convotemplate_condition_hasCompletedQuestFour(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tier3convotemplate_condition_hasCompletedQuestFive(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tier3convotemplate_condition_hasCompletedQuestSix(obj_id player, obj_id npc)
    {
        return true;
    }
    public void tier3convotemplate_action_grantQuestOne(obj_id player, obj_id npc)
    {
    }
    public void tier3convotemplate_action_grantQuestTwo(obj_id player, obj_id npc)
    {
    }
    public void tier3convotemplate_action_grantQuestThree(obj_id player, obj_id npc)
    {
    }
    public void tier3convotemplate_action_grantQuestFour(obj_id player, obj_id npc)
    {
    }
    public void tier3convotemplate_action_grantQuestFive(obj_id player, obj_id npc)
    {
    }
    public void tier3convotemplate_action_grantQuestSix(obj_id player, obj_id npc)
    {
    }
    public void tier3convotemplate_action_rewardForQuestOne(obj_id player, obj_id npc)
    {
    }
    public void tier3convotemplate_action_rewardForQuesTwo(obj_id player, obj_id npc)
    {
    }
    public void tier3convotemplate_action_rewardForQuestThree(obj_id player, obj_id npc)
    {
    }
    public void tier3convotemplate_action_rewardForQuestFour(obj_id player, obj_id npc)
    {
    }
    public void tier3convotemplate_action_rewardForQuestFive(obj_id player, obj_id npc)
    {
    }
    public void tier3convotemplate_action_rewardForQuestSix(obj_id player, obj_id npc)
    {
    }
