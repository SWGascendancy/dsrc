...
public class npe_side2_questgiver extends script.base_script
{
    ...
    public boolean npe_side2_questgiver_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_side2_questgiver_condition_playerOnQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "npe_side2");
    }
    public boolean npe_side2_questgiver_condition_playerCompletedQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_side2");
    }
    public boolean npe_side2_questgiver_condition_playerReadyForReward(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_side2", "reward_signal");
    }
    public boolean npe_side2_questgiver_condition_playerCompletedMainQuest(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "npe.finishedTemplate");
    }
    public void npe_side2_questgiver_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void npe_side2_questgiver_action_giveQuest(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "npe_side2");
    }
    public void npe_side2_questgiver_action_giveReward(obj_id player, obj_id npc)
    {
    ...
    public int npe_side2_questgiver_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_side2_questgiver_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_side2_questgiver_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_side2_questgiver_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_side2_questgiver_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
