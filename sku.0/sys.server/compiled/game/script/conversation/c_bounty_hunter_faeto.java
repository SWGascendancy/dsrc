...
public class c_bounty_hunter_faeto extends script.base_script
{
    ...
    public boolean c_bounty_hunter_faeto_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_bounty_hunter_faeto_condition_isTaskActiveBobaLink(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "c_bounty_hunter_kill_1", "bounty_hunter_kill_1_e100");
    }
    public boolean c_bounty_hunter_faeto_condition_isTaskActiveBounty1(obj_id player, obj_id npc)
    {
    ...
    public boolean c_bounty_hunter_faeto_condition_hasCompletedTaskBounty1(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "c_bounty_hunter_kill_1", "bounty_hunter_kill_1_e13");
    }
    public boolean c_bounty_hunter_faeto_condition_hasCompletedQuestAll(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedQuest(player, "c_bounty_hunter_kill_1"));
    }
    public void c_bounty_hunter_faeto_action_grantBounty1(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "bounty_hunter_kill_1_launch_e0");
    }
    public void c_bounty_hunter_faeto_action_grantRewardBounty1(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "bounty_hunter_kill_1_launch_e14");
    }
    public void c_bounty_hunter_faeto_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int c_bounty_hunter_faeto_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_bounty_hunter_faeto_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_bounty_hunter_faeto_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_bounty_hunter_faeto_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_bounty_hunter_faeto_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_bounty_hunter_faeto_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_bounty_hunter_faeto_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_bounty_hunter_faeto_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_bounty_hunter_faeto_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
