...
public class emp_day_reb_disk_guy extends script.base_script
{
    ...
    public boolean emp_day_reb_disk_guy_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean emp_day_reb_disk_guy_condition_hasTask3(obj_id player, obj_id npc)
    {
    ...
    public void emp_day_reb_disk_guy_action_triggerAndWp(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "disk_guy_1");
        sendSystemMessage(player, new string_id("event/empire_day", "sys_msg_reb_disk"));
    }
    public int emp_day_reb_disk_guy_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
