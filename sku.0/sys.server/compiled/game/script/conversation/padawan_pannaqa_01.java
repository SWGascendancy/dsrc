...
public class padawan_pannaqa_01 extends script.base_script
{
    ...
    public boolean padawan_pannaqa_01_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean padawan_pannaqa_01_condition_acceptedQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean padawan_pannaqa_01_condition_isTrialPlayer(obj_id player, obj_id npc)
    {
        String trialName = jedi_trials.getJediTrialName(player);
        if (trialName != null && trialName.equals("pannaqa"))
        {
    ...
    public boolean padawan_pannaqa_01_condition_spokeToTarget01(obj_id player, obj_id npc)
    {
        String trialName = jedi_trials.getJediTrialName(player);
        if (trialName != null && trialName.equals("pannaqa"))
        {
    ...
    public boolean padawan_pannaqa_01_condition_spokeToTarget02(obj_id player, obj_id npc)
    {
        String trialName = jedi_trials.getJediTrialName(player);
        if (trialName != null && trialName.equals("pannaqa"))
        {
    ...
    public boolean padawan_pannaqa_01_condition_completedSuccess(obj_id player, obj_id npc)
    {
        String trialName = jedi_trials.getJediTrialName(player);
        if (trialName != null && !trialName.equals("pannaqa"))
        {
    ...
    public void padawan_pannaqa_01_action_sendToSecondNpc(obj_id player, obj_id npc)
    {
    ...
    public void padawan_pannaqa_01_action_questFailure(obj_id player, obj_id npc)
    {
        setObjVar(player, "jedi_trials.padawan_trials.pannaqa.failed", true);
        messageTo(player, "handleQuestFailure", null, 1, false);
        return;
    }
    public void padawan_pannaqa_01_action_questSuccess(obj_id player, obj_id npc)
    {
    ...
    public int padawan_pannaqa_01_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int padawan_pannaqa_01_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int padawan_pannaqa_01_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int padawan_pannaqa_01_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int padawan_pannaqa_01_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int padawan_pannaqa_01_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
