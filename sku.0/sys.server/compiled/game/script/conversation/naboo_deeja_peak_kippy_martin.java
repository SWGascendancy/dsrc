...
public class naboo_deeja_peak_kippy_martin extends script.base_script
{
    ...
    public boolean naboo_deeja_peak_kippy_martin_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean naboo_deeja_peak_kippy_martin_condition_speakToKippy_01(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "naboo_deeja_peak_beacon_darkness", "deeja_peak_beacon_darkness_01");
    }
    public boolean naboo_deeja_peak_kippy_martin_condition_speakToKippy_03(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "naboo_deeja_peak_beacon_darkness", "deeja_peak_beacon_darkness_03");
    }
    public boolean naboo_deeja_peak_kippy_martin_condition_killFlewts(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "naboo_deeja_peak_beacon_darkness", "deeja_peak_beacon_darkness_02");
    }
    public boolean naboo_deeja_peak_kippy_martin_condition_doneWithKippy(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "naboo_deeja_peak_beacon_darkness", "deeja_peak_beacon_darkness_03");
    }
    public void naboo_deeja_peak_kippy_martin_action_signal_darkness_01(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "deeja_peak_beacon_darkness_01");
    }
    public void naboo_deeja_peak_kippy_martin_action_signal_darkness_03(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "deeja_peak_beacon_darkness_03");
    }
    public int naboo_deeja_peak_kippy_martin_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_deeja_peak_kippy_martin_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
