...
public class quest_u10_hraykken_bender extends script.base_script
{
    ...
    public boolean quest_u10_hraykken_bender_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean quest_u10_hraykken_bender_condition_questDisabled(obj_id player, obj_id npc)
    {
        return !isGod(player) && !hasObjVar(player, "quest_u10_testing");
    }
    public boolean quest_u10_hraykken_bender_condition_quest_u10_01_active(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "quest_u10_01");
    }
    public void quest_u10_hraykken_bender_action_quest_u10_01_grant(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "quest_u10_01");
    }
    public int quest_u10_hraykken_bender_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
