...
public class som_mustafar_junk_dealer extends script.base_script
{
    ...
    public boolean som_mustafar_junk_dealer_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean som_mustafar_junk_dealer_condition_check_inv(obj_id player, obj_id npc)
    {
    ...
    public void som_mustafar_junk_dealer_action_start_dealing(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        messageTo(npc, "startDealing", params, 1.0f, false);
    }
    public int som_mustafar_junk_dealer_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
