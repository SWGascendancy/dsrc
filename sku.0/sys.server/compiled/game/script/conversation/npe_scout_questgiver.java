...
public class npe_scout_questgiver extends script.base_script
{
    ...
    public boolean npe_scout_questgiver_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_scout_questgiver_condition_playerCompletedScout1(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_scout_1");
    }
    public boolean npe_scout_questgiver_condition_playerOnScout1(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "npe_scout_1");
    }
    public boolean npe_scout_questgiver_condition_playerKilledCats(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "npe_scout_1", "encounter");
    }
    public boolean npe_scout_questgiver_condition_playerOnScout1aWithHide(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_scout_questgiver_condition_playerOnScout1aWithoutHide(obj_id player, obj_id npc)
    {
        obj_id hide = utils.getItemPlayerHasByTemplate(player, "object/resource_container/organic_leathery_hide.iff");
        return (groundquests.isQuestActive(player, "npe_scout_1a") && (hide == null));
    }
    public boolean npe_scout_questgiver_condition_hasPointer(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "npe.finishedTemplate");
    }
    public void npe_scout_questgiver_action_faceplayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void npe_scout_questgiver_action_giveScout1Quest(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "npe_scout_1");
        groundquests.sendSignal(player, "talked_to_raylen");
    }
    public void npe_scout_questgiver_action_signalScout1Reward(obj_id player, obj_id npc)
    {
    ...
    public void npe_scout_questgiver_action_SignalScout1RewardAndCompleteS1a(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_scout1_reward");
        groundquests.clearQuest(player, "npe_scout_1a");
    }
    public int npe_scout_questgiver_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_scout_questgiver_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_scout_questgiver_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_scout_questgiver_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_scout_questgiver_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_scout_questgiver_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_scout_questgiver_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_scout_questgiver_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
