...
public class rebel_general extends script.base_script
{
    ...
    public boolean rebel_general_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean rebel_general_condition_isEntertainerPlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return utils.isProfession(player, utils.ENTERTAINER);
    }
    public boolean rebel_general_condition_isPlayerImperial(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (factions.isImperial(player) || factions.isPlayerSameGcwFactionAsSchedulerObject(player, npc));
    }
    public boolean rebel_general_condition_isPlayerRebel(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (factions.isRebel(player) || factions.isPlayerSameGcwFactionAsSchedulerObject(player, npc));
    }
    public boolean rebel_general_condition_isPlayerNeutral(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (!factions.isImperial(player) && !factions.isRebel(player) && pvpNeutralGetMercenaryFaction(player) == 0);
    }
    public boolean rebel_general_condition_isTraderPlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return utils.isProfession(player, utils.TRADER);
    }
    public boolean rebel_general_condition_isForceSensitivePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return utils.isProfession(player, utils.FORCE_SENSITIVE);
    }
    public boolean rebel_general_condition_isSmugglerPlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return utils.isProfession(player, utils.SMUGGLER);
    }
    public boolean rebel_general_condition_isMedicPlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return utils.isProfession(player, utils.MEDIC);
    }
    public boolean rebel_general_condition_isOfficerPlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return utils.isProfession(player, utils.OFFICER);
    }
    public boolean rebel_general_condition_isSpyPlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return utils.isProfession(player, utils.SPY);
    }
    public boolean rebel_general_condition_isBountyHunterPlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return utils.isProfession(player, utils.BOUNTY_HUNTER);
    }
    public boolean rebel_general_condition_isCommandoPlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return utils.isProfession(player, utils.COMMANDO);
    }
    public boolean rebel_general_condition_generalIsOffensive(obj_id player, obj_id npc)
    {
        return (hasObjVar(npc, "offense") && getIntObjVar(npc, "offense") == 1);
    }
    public boolean rebel_general_condition_generalIsImperial(obj_id player, obj_id npc)
    {
        return (hasObjVar(npc, "factionFlag") && getIntObjVar(npc, "factionFlag") == factions.FACTION_FLAG_IMPERIAL);
    }
    public boolean rebel_general_condition_generalIsDefensive(obj_id player, obj_id npc)
    {
        return (hasObjVar(npc, "offense") && getIntObjVar(npc, "offense") == 0);
    }
    public boolean rebel_general_condition_generalIsRebel(obj_id player, obj_id npc)
    {
        return (hasObjVar(npc, "factionFlag") && getIntObjVar(npc, "factionFlag") == factions.FACTION_FLAG_REBEL);
    }
    public boolean rebel_general_condition_isGeneralRebAndOffense(obj_id player, obj_id npc)
    {
    ...
    public boolean rebel_general_condition_isCombatPhase(obj_id player, obj_id npc)
    {
        return (gcw.getGcwCityInvasionPhase(npc) == gcw.GCW_CITY_PHASE_COMBAT);
    }
    public boolean rebel_general_condition_isConstructionPhase(obj_id player, obj_id npc)
    {
        return (gcw.getGcwCityInvasionPhase(npc) == gcw.GCW_CITY_PHASE_CONSTRUCTION);
    }
    public boolean rebel_general_condition_isGeneralRebAndDefense(obj_id player, obj_id npc)
    {
    ...
    public boolean rebel_general_condition_isGeneralImpAndOffense(obj_id player, obj_id npc)
    {
    ...
    public boolean rebel_general_condition_isGeneralImpAndDefense(obj_id player, obj_id npc)
    {
    ...
    public boolean rebel_general_condition_hasRebelQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean rebel_general_condition_hasSpyDestroyPatrolQuestNeedsExplosives(obj_id player, obj_id npc)
    {
    ...
    public boolean rebel_general_condition_hasSpyScoutPatrolQuest(obj_id player, obj_id npc)
    {
        return rebel_general_condition_isSpyPlayer(player, npc) && groundquests.isQuestActive(player, gcw.GCW_SPY_PATROL_SCOUT_QUEST);
    }
    public boolean rebel_general_condition_hasSpyDestroyPatrolQuest(obj_id player, obj_id npc)
    {
        return rebel_general_condition_isSpyPlayer(player, npc) && groundquests.isQuestActive(player, gcw.GCW_SPY_PATROL_DESTROY_QUEST);
    }
    public boolean rebel_general_condition_hasDestroyTurretQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, gcw.GCW_DESTROY_TURRET);
    }
    public boolean rebel_general_condition_hasDestroyBarricadeQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, gcw.GCW_DESTROY_BARRICADE);
    }
    public boolean rebel_general_condition_hasDestroyQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean rebel_general_condition_hasEntertainRallyQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, gcw.GCW_ENTERTAIN_RALLY);
    }
    public boolean rebel_general_condition_enemyPatrolPointsExist(obj_id player, obj_id npc)
    {
    ...
    public boolean rebel_general_condition_enemyPatrolsExistAndIsCombatPhase(obj_id player, obj_id npc)
    {
        return (rebel_general_condition_enemyPatrolPointsExist(player, npc) && rebel_general_condition_isCombatPhase(player, npc));
    }
    public boolean rebel_general_condition_enemyPatrolPointsDestroyed(obj_id player, obj_id npc)
    {
        return (rebel_general_condition_isCombatPhase(player, npc) && !rebel_general_condition_enemyPatrolPointsExist(player, npc));
    }
    public boolean rebel_general_condition_canCommandoQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean rebel_general_condition_canEntertainerQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean rebel_general_condition_canBeMerc(obj_id player, obj_id npc)
    {
    ...
    public boolean rebel_general_condition_patrolPointsExistNoScoutQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean rebel_general_condition_patrolPointsExistNoDestroyQuest(obj_id player, obj_id npc)
    {
    ...
    public void rebel_general_action_spawnGuards(obj_id player, obj_id npc)
    {
        for (int i = 0; i < 3; i++)
        {
    ...
    public void rebel_general_action_grantSpyDestroyPatrol(obj_id player, obj_id npc)
    {
    ...
    public void rebel_general_action_grantSpyScoutPatrol(obj_id player, obj_id npc)
    {
    ...
    public void rebel_general_action_grantMoreSpyDestroyPatrolExplosives(obj_id player, obj_id npc)
    {
        buff.applyBuffWithStackCount(player, gcw.BUFF_SPY_EXPLOSIVES, 5);
    }
    public void rebel_general_action_grantCombatDestroyBarricade(obj_id player, obj_id npc)
    {
    }
    public void rebel_general_action_grantCombatDestroyTurret(obj_id player, obj_id npc)
    {
    ...
    public void rebel_general_action_grantEntertainRallyQuest(obj_id player, obj_id npc)
    {
    ...
    public void rebel_general_action_grantEntertainFatigueQuest(obj_id player, obj_id npc)
    {
    ...
    public void rebel_general_action_grantEntertainerQuests(obj_id player, obj_id npc)
    {
        if (!groundquests.isQuestActive(player, gcw.GCW_ENTERTAIN_FATIGUE))
        {
            if (groundquests.hasCompletedQuest(player, gcw.GCW_ENTERTAIN_FATIGUE))
    ...
    public void rebel_general_action_grantCombatQuests(obj_id player, obj_id npc)
    {
    ...
    public void rebel_general_action_makeRebMercCombatant(obj_id player, obj_id npc)
    {
        factions.setNeturalMercenaryCovert(player, factions.FACTION_FLAG_REBEL);
    }
    public void rebel_general_action_makeRebMercSF(obj_id player, obj_id npc)
    {
        factions.setNeturalMercenaryOvert(player, factions.FACTION_FLAG_REBEL);
    }
    public void rebel_general_action_grantCombatSpyQuests(obj_id player, obj_id npc)
    {
        if (!groundquests.isQuestActive(player, gcw.GCW_DESTROY_BARRICADE))
        {
            if (groundquests.hasCompletedQuest(player, gcw.GCW_DESTROY_BARRICADE))
    ...
    public void rebel_general_action_grantDefensiveSpyQuests(obj_id player, obj_id npc)
    {
        if (!groundquests.isQuestActive(player, gcw.GCW_ELIMINATE_IMPERIALS))
        {
            if (groundquests.hasCompletedQuest(player, gcw.GCW_ELIMINATE_IMPERIALS))
    ...
    public int rebel_general_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_general_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_general_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_general_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_general_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_general_handleBranch38(obj_id player, obj_id npc, string_id response)
    {
