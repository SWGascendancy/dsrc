...
public class ep3_rryatt_tressk extends script.base_script
{
    ...
    public boolean ep3_rryatt_tressk_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_rryatt_tressk_condition_finishedLostRodianHunters(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_rryatt_tressk_condition_finishedDeepWoodsPoachers(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_rryatt_tressk_condition_finishedGotalHunters(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "ep3_rryatt_tressk_kill_gotal_hunters", "tressk_chooseJuntiMace"));
    }
    public boolean ep3_rryatt_tressk_condition_onLostRodianHunters(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_rryatt_tressk_kill_lost_rodian_hunters", "tressk_findLostRodianHunters");
    }
    public boolean ep3_rryatt_tressk_condition_onDeepWoodsPoachers(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_rryatt_tressk_kill_deep_woods_poachers", "tressk_stopDeepWoodsPoachers");
    }
    public boolean ep3_rryatt_tressk_condition_onGotalHunters(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_rryatt_tressk_kill_gotal_hunters", "tressk_defeatGotalHunters");
    }
    public boolean ep3_rryatt_tressk_condition_completelyFinished(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_rryatt_tressk_kill_gotal_hunters");
    }
    public void ep3_rryatt_tressk_action_doneLostRodianHunters(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tressk_lostRodianHuntersCompleted");
    }
    public void ep3_rryatt_tressk_action_doneDeepWoodsPoachers(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tressk_deepWoodsPoachersCompleted");
    }
    public void ep3_rryatt_tressk_action_doneGotalHunters_Mace(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tressk_chooseJuntiMace");
    }
    public void ep3_rryatt_tressk_action_killLostRodianHunters(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_rryatt_tressk_kill_lost_rodian_hunters");
    }
    public void ep3_rryatt_tressk_action_killDeepWoodsPoachers(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_rryatt_tressk_kill_deep_woods_poachers");
    }
    public void ep3_rryatt_tressk_action_killGotalHunters(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_rryatt_tressk_kill_gotal_hunters");
    }
    public void ep3_rryatt_tressk_action_doneGotalHunters_Pistol(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tressk_chooseFlechettePistol");
    }
    public int ep3_rryatt_tressk_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_rryatt_tressk_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_rryatt_tressk_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_rryatt_tressk_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_rryatt_tressk_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
