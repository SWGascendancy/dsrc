...
public class ep3_tien_wallub extends script.base_script
{
    ...
    public boolean ep3_tien_wallub_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_tien_wallub_condition_readyForJesskSignal(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_tien_wallub_condition_isJesskQuestActive(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_stren_jessk_bounty");
    }
    public boolean ep3_tien_wallub_condition_bountyDiscussion(obj_id player, obj_id npc)
    {
        return false;
    }
    public boolean ep3_tien_wallub_condition_canLearnAboutJessk(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_tien_wallub_condition_canGetJesskBountyInfo(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_stren_jessk_bounty_tien", "speakWithTien");
    }
    public void ep3_tien_wallub_action_grantJesskBounty(obj_id player, obj_id npc)
    {
    ...
    public void ep3_tien_wallub_action_sendJesskSpokeWithTien(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "signalJesskSpeakWithTien");
    }
    public void ep3_tien_wallub_action_signalSpeakWithTienEnd(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "signalJesskSpeakWithTien");
    }
    public int ep3_tien_wallub_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_tien_wallub_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_tien_wallub_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_tien_wallub_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_tien_wallub_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_tien_wallub_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
