...
public class ep3_etyyy_ehartt_brihnt extends script.base_script
{
    ...
    public boolean ep3_etyyy_ehartt_brihnt_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_etyyy_ehartt_brihnt_condition_hasCompletedAllQuests(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedQuest(player, "ep3_hunt_ehartt_collect_walluga_claws"));
    }
    public boolean ep3_etyyy_ehartt_brihnt_condition_finishedCollectingClaws(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "ep3_hunt_ehartt_collect_walluga_claws", "ehartt_wallugaClaws"));
    }
    public boolean ep3_etyyy_ehartt_brihnt_condition_speakToEhartt(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "ep3_hunt_ehartt_collect_walluga_claws", "ehartt_talkToEhartt"));
    }
    public boolean ep3_etyyy_ehartt_brihnt_condition_isCollectingWallugaClaws(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "ep3_hunt_ehartt_collect_walluga_claws", "ehartt_collectingWallugaClaws"));
    }
    public boolean ep3_etyyy_ehartt_brihnt_condition_killedStoneleg(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_hunt_loot_stoneleg_killed");
    }
    public boolean ep3_etyyy_ehartt_brihnt_condition_killedStonelegPlusAll(obj_id player, obj_id npc)
    {
    ...
    public void ep3_etyyy_ehartt_brihnt_action_speakWithSordaan(obj_id player, obj_id npc)
    {
    ...
    public void ep3_etyyy_ehartt_brihnt_action_stonelegReward(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "lootQuest_defeatedStoneleg");
    }
    public void ep3_etyyy_ehartt_brihnt_action_collectWallugaClaws(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "ehartt_speakWithEhartt");
    }
    public void ep3_etyyy_ehartt_brihnt_action_stonelegRewardPlusAll(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "lootQuest_defeatedStoneleg");
        groundquests.grantQuest(player, "ep3_hunt_loot_completed_all");
    }
    public int ep3_etyyy_ehartt_brihnt_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_ehartt_brihnt_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_ehartt_brihnt_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_ehartt_brihnt_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_ehartt_brihnt_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_ehartt_brihnt_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_ehartt_brihnt_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
