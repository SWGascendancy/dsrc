...
public class happer_mos_eisley extends script.base_script
{
    ...
    public boolean happer_mos_eisley_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean happer_mos_eisley_condition_hasInvestigateQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isQuestActive(player, "quest_02_investigate_murder");
    }
    public boolean happer_mos_eisley_condition_hasCompletedInvestigate(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.hasCompletedQuest(player, "quest_02_investigate_murder");
    }
    public boolean happer_mos_eisley_condition_hasGatheredTheClue(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public void happer_mos_eisley_action_sendSignalClueUpdate(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "getCluesHapper");
    }
    public void happer_mos_eisley_action_sendSignalIdentifyBody(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "happerIdentifyBody");
    }
    public void happer_mos_eisley_action_sendSignalTalkHapper(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "speakWithHapper");
    }
    public int happer_mos_eisley_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int happer_mos_eisley_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int happer_mos_eisley_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int happer_mos_eisley_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int happer_mos_eisley_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int happer_mos_eisley_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
