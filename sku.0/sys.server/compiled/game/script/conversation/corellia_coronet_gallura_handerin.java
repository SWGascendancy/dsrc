...
public class corellia_coronet_gallura_handerin extends script.base_script
{
    ...
    public boolean corellia_coronet_gallura_handerin_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_coronet_gallura_handerin_condition_governemtWorkBegin(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_coronet_capitol_problems_government_work", "government_work_1");
    }
    public boolean corellia_coronet_gallura_handerin_condition_dropBoxesActive(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_coronet_capitol_problems_government_work", "government_work_2");
    }
    public boolean corellia_coronet_gallura_handerin_condition_dropBoxesComplete(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_coronet_capitol_problems_government_work", "government_work_3");
    }
    public boolean corellia_coronet_gallura_handerin_condition_stolenArmorComplete(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_coronet_capitol_problems_government_work", "government_work_5");
    }
    public boolean corellia_coronet_gallura_handerin_condition_stolenArmorActive(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_coronet_capitol_problems_government_work", "government_work_4");
    }
    public boolean corellia_coronet_gallura_handerin_condition_missingCourierSuccess(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_coronet_capitol_problems_government_work", "government_work_9");
    }
    public boolean corellia_coronet_gallura_handerin_condition_missingCourierActive(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_coronet_gallura_handerin_condition_governmentWorkComplete(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "corellia_coronet_capitol_problems_government_work");
    }
    public boolean corellia_coronet_gallura_handerin_condition_thankfulDiktatComplete(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_coronet_gallura_handerin_condition_missionCourierFailed(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_coronet_capitol_problems_government_work_b", "government_work_9b");
    }
    public boolean corellia_coronet_gallura_handerin_condition_onInformant(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "corellia_coronet_capitol_problems_the_informant");
    }
    public void corellia_coronet_gallura_handerin_action_dropBoxesStarted(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "government_work_1");
    }
    public void corellia_coronet_gallura_handerin_action_stolenArmorStarted(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "government_work_3");
    }
    public void corellia_coronet_gallura_handerin_action_missingCourierStarted(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "government_work_5");
    }
    public void corellia_coronet_gallura_handerin_action_goSeeBrantlee(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "corellia_coronet_capitol_problems_the_informant");
        return;
    }
    public void corellia_coronet_gallura_handerin_action_endGovernmentWork(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "government_work_9");
    }
    public int corellia_coronet_gallura_handerin_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_gallura_handerin_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_gallura_handerin_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_gallura_handerin_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_gallura_handerin_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
