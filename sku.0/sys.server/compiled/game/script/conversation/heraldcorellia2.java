...
public class heraldcorellia2 extends script.base_script
{
    ...
    public boolean heraldcorellia2_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public void heraldcorellia2_action_waypoint1(obj_id player, obj_id npc)
    {
    ...
    public void heraldcorellia2_action_waypoint2(obj_id player, obj_id npc)
    {
    ...
    public void heraldcorellia2_action_snap2(obj_id player, obj_id npc)
    {
        doAnimationAction(npc, "snap_finger2");
    }
    public void heraldcorellia2_action_dismiss(obj_id player, obj_id npc)
    {
        doAnimationAction(npc, "wave_on_dismissing");
    }
    public void heraldcorellia2_action_check(obj_id player, obj_id npc)
    {
        doAnimationAction(npc, "check_wrist_device");
    }
    public void heraldcorellia2_action_shrug(obj_id player, obj_id npc)
    {
        doAnimationAction(npc, "shrug_shoulders");
    }
    public void heraldcorellia2_action_hair(obj_id player, obj_id npc)
    {
        doAnimationAction(npc, "hair_flip");
    }
    public int heraldcorellia2_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int heraldcorellia2_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int heraldcorellia2_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int heraldcorellia2_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
