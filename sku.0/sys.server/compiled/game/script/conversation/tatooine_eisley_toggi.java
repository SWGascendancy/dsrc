...
public class tatooine_eisley_toggi extends script.base_script
{
    ...
    public boolean tatooine_eisley_toggi_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tatooine_eisley_toggi_condition_cargoDelivery(obj_id player, obj_id npc)
    {
    ...
    public void tatooine_eisley_toggi_action_sdDelivery1(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tat_eisley_special_delivery_e1");
    }
    public int tatooine_eisley_toggi_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_toggi_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
