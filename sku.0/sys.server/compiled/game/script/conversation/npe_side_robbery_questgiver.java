...
public class npe_side_robbery_questgiver extends script.base_script
{
    ...
    public boolean npe_side_robbery_questgiver_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_side_robbery_questgiver_condition_playerOnQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "npe_side_robbery");
    }
    public boolean npe_side_robbery_questgiver_condition_playerDoneWithQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_side_robbery");
    }
    public boolean npe_side_robbery_questgiver_condition_playerHasPrototype(obj_id player, obj_id npc)
    {
    ...
    public void npe_side_robbery_questgiver_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void npe_side_robbery_questgiver_action_giveQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_side_robbery");
    }
    public void npe_side_robbery_questgiver_action_signalreward(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_side1_real");
        groundquests.sendSignal(player, "npe_side1_fake");
    }
    public int npe_side_robbery_questgiver_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_side_robbery_questgiver_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_side_robbery_questgiver_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_side_robbery_questgiver_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
