...
public class c_tutorial_rm6 extends script.base_script
{
    ...
    public boolean c_tutorial_rm6_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_tutorial_rm6_condition_playerOnQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean c_tutorial_rm6_condition_taskComplete(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/c_newbie_hall_range01");
        int explainWeapons = groundquests.getTaskId(questId, "explainWeapons");
    ...
    public boolean c_tutorial_rm6_condition_playerOnQuestStep0502(obj_id player, obj_id npc)
    {
    ...
    public boolean c_tutorial_rm6_condition_playerOnQuestStep05(obj_id player, obj_id npc)
    {
    ...
    public void c_tutorial_rm6_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void c_tutorial_rm6_action_actionSendSignal(obj_id player, obj_id npc)
    {
    ...
    public void c_tutorial_rm6_action_Repeat(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/c_newbie_hall_range02");
        groundquests.grantQuest(questId, player, npc, true);
    }
    public int c_tutorial_rm6_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_tutorial_rm6_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_tutorial_rm6_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_tutorial_rm6_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_tutorial_rm6_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_tutorial_rm6_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_tutorial_rm6_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
