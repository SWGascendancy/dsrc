...
public class c_tutorial_rm4 extends script.base_script
{
    ...
    public boolean c_tutorial_rm4_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_tutorial_rm4_condition_playerOnQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean c_tutorial_rm4_condition_TaskComplete(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/c_newbie_hall_01");
        int explainRadar = groundquests.getTaskId(questId, "explainRadar");
    ...
    public boolean c_tutorial_rm4_condition_playerOnQuestStep03(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/c_newbie_hall_01");
        int explainQuestJournal = groundquests.getTaskId(questId, "explainQuestJournal");
    ...
    public void c_tutorial_rm4_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void c_tutorial_rm4_action_actionSendSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "explainRadar");
    }
    public int c_tutorial_rm4_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_tutorial_rm4_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_tutorial_rm4_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_tutorial_rm4_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_tutorial_rm4_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_tutorial_rm4_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_tutorial_rm4_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
