...
public class collections_fixbrokenspacekillcollections extends script.base_script
{
    ...
    public boolean collections_fixbrokenspacekillcollections_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean collections_fixbrokenspacekillcollections_condition_isRebelKillCollectionTier1Broken(obj_id player, obj_id npc)
    {
    ...
    public boolean collections_fixbrokenspacekillcollections_condition_isImperialKillCollectionTier1Broken(obj_id player, obj_id npc)
    {
    ...
    public boolean collections_fixbrokenspacekillcollections_condition_isBlackSunKillCollectionTier1Broken(obj_id player, obj_id npc)
    {
    ...
    public boolean collections_fixbrokenspacekillcollections_condition_isDroidKillCollectionTier1Broken(obj_id player, obj_id npc)
    {
    ...
    public boolean collections_fixbrokenspacekillcollections_condition_isHiddenDaggersKillCollectionTier1Broken(obj_id player, obj_id npc)
    {
    ...
    public boolean collections_fixbrokenspacekillcollections_condition_isVoidWingKillCollectionTier1Broken(obj_id player, obj_id npc)
    {
        return (hasCompletedCollection(player, "kill_space_void_tier_01") && getCollectionSlotValue(player, "kill_space_void_icon_tier1") == 0);
    }
    public boolean collections_fixbrokenspacekillcollections_condition_isBlackSunKillCollectionTier2Broken(obj_id player, obj_id npc)
    {
    ...
    public boolean collections_fixbrokenspacekillcollections_condition_isBlackSunKillCollectionTier3Broken(obj_id player, obj_id npc)
    {
    ...
    public boolean collections_fixbrokenspacekillcollections_condition_isBlackSunKillCollectionTier4Broken(obj_id player, obj_id npc)
    {
    ...
    public boolean collections_fixbrokenspacekillcollections_condition_isBlackSunKillCollectionTier5Broken(obj_id player, obj_id npc)
    {
    ...
    public boolean collections_fixbrokenspacekillcollections_condition_isDroidKillCollectionTier2Broken(obj_id player, obj_id npc)
    {
    ...
    public boolean collections_fixbrokenspacekillcollections_condition_isDroidKillCollectionTier3Broken(obj_id player, obj_id npc)
    {
    ...
    public boolean collections_fixbrokenspacekillcollections_condition_isDroidKillCollectionTier4Broken(obj_id player, obj_id npc)
    {
    ...
    public boolean collections_fixbrokenspacekillcollections_condition_isDroidKillCollectionTier5Broken(obj_id player, obj_id npc)
    {
    ...
    public boolean collections_fixbrokenspacekillcollections_condition_isHiddenDaggersKillCollectionTier2Broken(obj_id player, obj_id npc)
    {
    ...
    public boolean collections_fixbrokenspacekillcollections_condition_isHiddenDaggersKillCollectionTier3Broken(obj_id player, obj_id npc)
    {
    ...
    public boolean collections_fixbrokenspacekillcollections_condition_isHiddenDaggersKillCollectionTier4Broken(obj_id player, obj_id npc)
    {
    ...
    public boolean collections_fixbrokenspacekillcollections_condition_isHiddenDaggersKillCollectionTier5Broken(obj_id player, obj_id npc)
    {
    ...
    public boolean collections_fixbrokenspacekillcollections_condition_isVoidWingKillCollectionTier2Broken(obj_id player, obj_id npc)
    {
        return (hasCompletedCollection(player, "kill_space_void_tier_02") && getCollectionSlotValue(player, "kill_space_void_icon_tier2") == 0);
    }
    public boolean collections_fixbrokenspacekillcollections_condition_isVoidWingKillCollectionTier3Broken(obj_id player, obj_id npc)
    {
        return (hasCompletedCollection(player, "kill_space_void_tier_03") && getCollectionSlotValue(player, "kill_space_void_icon_tier3") == 0);
    }
    public boolean collections_fixbrokenspacekillcollections_condition_isVoidWingKillCollectionTier4Broken(obj_id player, obj_id npc)
    {
        return (hasCompletedCollection(player, "kill_space_void_tier_04") && getCollectionSlotValue(player, "kill_space_void_icon_tier4") == 0);
    }
    public boolean collections_fixbrokenspacekillcollections_condition_isVoidWingKillCollectionTier5Broken(obj_id player, obj_id npc)
    {
        return (hasCompletedCollection(player, "kill_space_void_tier_05") && getCollectionSlotValue(player, "kill_space_void_icon_tier5") == 0);
    }
    public boolean collections_fixbrokenspacekillcollections_condition_isRebelKillCollectionTier2Broken(obj_id player, obj_id npc)
    {
    ...
    public boolean collections_fixbrokenspacekillcollections_condition_isRebelKillCollectionTier3Broken(obj_id player, obj_id npc)
    {
    ...
    public boolean collections_fixbrokenspacekillcollections_condition_isRebelKillCollectionTier4Broken(obj_id player, obj_id npc)
    {
    ...
    public boolean collections_fixbrokenspacekillcollections_condition_isRebelKillCollectionTier5Broken(obj_id player, obj_id npc)
    {
    ...
    public boolean collections_fixbrokenspacekillcollections_condition_isImperialKillCollectionTier2Broken(obj_id player, obj_id npc)
    {
    ...
    public boolean collections_fixbrokenspacekillcollections_condition_isImperialKillCollectionTier3Broken(obj_id player, obj_id npc)
    {
    ...
    public boolean collections_fixbrokenspacekillcollections_condition_isImperialKillCollectionTier4Broken(obj_id player, obj_id npc)
    {
    ...
    public boolean collections_fixbrokenspacekillcollections_condition_isImperialKillCollectionTier5Broken(obj_id player, obj_id npc)
    {
    ...
    public boolean collections_fixbrokenspacekillcollections_condition_isBlackSunBroken(obj_id player, obj_id npc)
    {
    ...
    public boolean collections_fixbrokenspacekillcollections_condition_isRebelBroken(obj_id player, obj_id npc)
    {
    ...
    public boolean collections_fixbrokenspacekillcollections_condition_isImperialBroken(obj_id player, obj_id npc)
    {
    ...
    public boolean collections_fixbrokenspacekillcollections_condition_isDroidBroken(obj_id player, obj_id npc)
    {
    ...
    public boolean collections_fixbrokenspacekillcollections_condition_isPirateBroken(obj_id player, obj_id npc)
    {
    ...
    public boolean collections_fixbrokenspacekillcollections_condition_isVoidBroken(obj_id player, obj_id npc)
    {
    ...
    public boolean collections_fixbrokenspacekillcollections_condition_nothingIsBroken(obj_id player, obj_id npc)
    {
    ...
    public void collections_fixbrokenspacekillcollections_action_fixBlackSunTier1Collection(obj_id player, obj_id npc)
    {
        collection.revokeThenGrantCollection(player, "kill_space_blacksun_tier_01");
    }
    public void collections_fixbrokenspacekillcollections_action_fixBlackSunTier2Collection(obj_id player, obj_id npc)
    {
        collection.revokeThenGrantCollection(player, "kill_space_blacksun_tier_02");
    }
    public void collections_fixbrokenspacekillcollections_action_fixBlackSunTier3Collection(obj_id player, obj_id npc)
    {
        collection.revokeThenGrantCollection(player, "kill_space_blacksun_tier_03");
    }
    public void collections_fixbrokenspacekillcollections_action_fixBlackSunTier4Collection(obj_id player, obj_id npc)
    {
        collection.revokeThenGrantCollection(player, "kill_space_blacksun_tier_04");
    }
    public void collections_fixbrokenspacekillcollections_action_fixBlackSunTier5Collection(obj_id player, obj_id npc)
    {
        collection.revokeThenGrantCollection(player, "kill_space_blacksun_tier_05");
    }
    public void collections_fixbrokenspacekillcollections_action_fixDroidTier1Collection(obj_id player, obj_id npc)
    {
        collection.revokeThenGrantCollection(player, "kill_space_droid_tier_01");
    }
    public void collections_fixbrokenspacekillcollections_action_fixDroidTier2Collection(obj_id player, obj_id npc)
    {
        collection.revokeThenGrantCollection(player, "kill_space_droid_tier_02");
    }
    public void collections_fixbrokenspacekillcollections_action_fixDroidTier3Collection(obj_id player, obj_id npc)
    {
        collection.revokeThenGrantCollection(player, "kill_space_droid_tier_03");
    }
    public void collections_fixbrokenspacekillcollections_action_fixDroidTier4Collection(obj_id player, obj_id npc)
    {
        collection.revokeThenGrantCollection(player, "kill_space_droid_tier_04");
    }
    public void collections_fixbrokenspacekillcollections_action_fixDroidTier5Collection(obj_id player, obj_id npc)
    {
        collection.revokeThenGrantCollection(player, "kill_space_droid_tier_05");
    }
    public void collections_fixbrokenspacekillcollections_action_fixHiddenDaggersTier1Collection(obj_id player, obj_id npc)
    {
        collection.revokeThenGrantCollection(player, "kill_space_pirate_tier_01");
    }
    public void collections_fixbrokenspacekillcollections_action_fixHiddenDaggersTier2Collection(obj_id player, obj_id npc)
    {
        collection.revokeThenGrantCollection(player, "kill_space_pirate_tier_02");
    }
    public void collections_fixbrokenspacekillcollections_action_fixHiddenDaggersTier3Collection(obj_id player, obj_id npc)
    {
        collection.revokeThenGrantCollection(player, "kill_space_pirate_tier_03");
    }
    public void collections_fixbrokenspacekillcollections_action_fixHiddenDaggersTier4Collection(obj_id player, obj_id npc)
    {
        collection.revokeThenGrantCollection(player, "kill_space_pirate_tier_04");
    }
    public void collections_fixbrokenspacekillcollections_action_fixHiddenDaggersTier5Collection(obj_id player, obj_id npc)
    {
        collection.revokeThenGrantCollection(player, "kill_space_pirate_tier_05");
    }
    public void collections_fixbrokenspacekillcollections_action_fixImperialTier1Collection(obj_id player, obj_id npc)
    {
        collection.revokeThenGrantCollection(player, "kill_space_imperial_tier_01");
    }
    public void collections_fixbrokenspacekillcollections_action_fixImperialTier2Collection(obj_id player, obj_id npc)
    {
        collection.revokeThenGrantCollection(player, "kill_space_imperial_tier_02");
    }
    public void collections_fixbrokenspacekillcollections_action_fixImperialTier3Collection(obj_id player, obj_id npc)
    {
        collection.revokeThenGrantCollection(player, "kill_space_imperial_tier_03");
    }
    public void collections_fixbrokenspacekillcollections_action_fixImperialTier4Collection(obj_id player, obj_id npc)
    {
        collection.revokeThenGrantCollection(player, "kill_space_imperial_tier_04");
    }
    public void collections_fixbrokenspacekillcollections_action_fixImperialTier5Collection(obj_id player, obj_id npc)
    {
        collection.revokeThenGrantCollection(player, "kill_space_imperial_tier_05");
    }
    public void collections_fixbrokenspacekillcollections_action_fixRebelTier1Collection(obj_id player, obj_id npc)
    {
        collection.revokeThenGrantCollection(player, "kill_space_rebel_tier_01");
    }
    public void collections_fixbrokenspacekillcollections_action_fixRebelTier2Collection(obj_id player, obj_id npc)
    {
        collection.revokeThenGrantCollection(player, "kill_space_rebel_tier_02");
    }
    public void collections_fixbrokenspacekillcollections_action_fixRebelTier3Collection(obj_id player, obj_id npc)
    {
        collection.revokeThenGrantCollection(player, "kill_space_rebel_tier_03");
    }
    public void collections_fixbrokenspacekillcollections_action_fixRebelTier4Collection(obj_id player, obj_id npc)
    {
        collection.revokeThenGrantCollection(player, "kill_space_rebel_tier_04");
    }
    public void collections_fixbrokenspacekillcollections_action_fixRebelTier5Collection(obj_id player, obj_id npc)
    {
        collection.revokeThenGrantCollection(player, "kill_space_rebel_tier_05");
    }
    public void collections_fixbrokenspacekillcollections_action_fixVoidWingTier1Collection(obj_id player, obj_id npc)
    {
        collection.revokeThenGrantCollection(player, "kill_space_void_tier_01");
    }
    public void collections_fixbrokenspacekillcollections_action_fixVoidWingTier2Collection(obj_id player, obj_id npc)
    {
        collection.revokeThenGrantCollection(player, "kill_space_void_tier_02");
    }
    public void collections_fixbrokenspacekillcollections_action_fixVoidWingTier3Collection(obj_id player, obj_id npc)
    {
        collection.revokeThenGrantCollection(player, "kill_space_void_tier_03");
    }
    public void collections_fixbrokenspacekillcollections_action_fixVoidWingTier4Collection(obj_id player, obj_id npc)
    {
        collection.revokeThenGrantCollection(player, "kill_space_void_tier_04");
    }
    public void collections_fixbrokenspacekillcollections_action_fixVoidWingTier5Collection(obj_id player, obj_id npc)
    {
        collection.revokeThenGrantCollection(player, "kill_space_void_tier_05");
    }
    public int collections_fixbrokenspacekillcollections_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int collections_fixbrokenspacekillcollections_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int collections_fixbrokenspacekillcollections_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int collections_fixbrokenspacekillcollections_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int collections_fixbrokenspacekillcollections_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int collections_fixbrokenspacekillcollections_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int collections_fixbrokenspacekillcollections_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int collections_fixbrokenspacekillcollections_handleBranch33(obj_id player, obj_id npc, string_id response)
    {
