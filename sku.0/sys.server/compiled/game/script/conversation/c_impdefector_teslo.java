...
public class c_impdefector_teslo extends script.base_script
{
    ...
    public boolean c_impdefector_teslo_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_impdefector_teslo_condition_playeronquest(obj_id player, obj_id npc)
    {
    ...
    public void c_impdefector_teslo_action_forwardquest(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/c_impdefector");
    ...
    public void c_impdefector_teslo_action_faceplayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int c_impdefector_teslo_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_impdefector_teslo_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_impdefector_teslo_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
