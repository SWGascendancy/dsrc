...
public class loveday_disillusion_mr_love extends script.base_script
{
    ...
    public boolean loveday_disillusion_mr_love_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean loveday_disillusion_mr_love_condition_petLoverSpeak(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "loveday_disillusion_pet_lover_v2", "loveday_disillusion_pet_lover_02");
    }
    public boolean loveday_disillusion_mr_love_condition_loveNoteActive(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "loveday_disillusion_love_note_v2");
    }
    public boolean loveday_disillusion_mr_love_condition_petLoverActive(obj_id player, obj_id npc)
    {
    ...
    public boolean loveday_disillusion_mr_love_condition_mrHateSpeak(obj_id player, obj_id npc)
    {
    ...
    public boolean loveday_disillusion_mr_love_condition_mrHateActive(obj_id player, obj_id npc)
    {
    ...
    public boolean loveday_disillusion_mr_love_condition_mrHateComplete(obj_id player, obj_id npc)
    {
    ...
    public boolean loveday_disillusion_mr_love_condition_questComplete(obj_id player, obj_id npc)
    {
        return hasCompletedCollectionSlot(player, "loveday_2010_disillusion_quest");
    }
    public void loveday_disillusion_mr_love_action_petLoverSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "loveday_disillusion_pet_lover_02");
    }
    public void loveday_disillusion_mr_love_action_mrHateSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "loveday_disillusion_mr_hate_01");
    }
    public int loveday_disillusion_mr_love_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int loveday_disillusion_mr_love_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int loveday_disillusion_mr_love_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int loveday_disillusion_mr_love_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int loveday_disillusion_mr_love_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int loveday_disillusion_mr_love_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
