...
public class tatooine_knives_parry_ind extends script.base_script
{
    ...
    public boolean tatooine_knives_parry_ind_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tatooine_knives_parry_ind_condition_onQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean tatooine_knives_parry_ind_condition_onTask(obj_id player, obj_id npc)
    {
    ...
    public boolean tatooine_knives_parry_ind_condition_questComplete(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_knives_parry_pt2");
        boolean OnTask = (questIsQuestComplete(questId1, player));
        return OnTask;
    }
    public boolean tatooine_knives_parry_ind_condition_questBlocked(obj_id player, obj_id npc)
    {
        return groundquests.isQuestDisabled("tatooine_knives_parry");
    }
    public boolean tatooine_knives_parry_ind_condition_isThisDisabled(obj_id player, obj_id npc)
    {
    ...
    public void tatooine_knives_parry_ind_action_signalReward(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tatoonie_knives_parry_launch_e97");
    }
    public void tatooine_knives_parry_ind_action_giveQuest(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/tatooine_knives_parry");
        groundquests.grantQuest(questId, player, npc, true);
    }
    public void tatooine_knives_parry_ind_action_facePlayer(obj_id player, obj_id npc)
    {
    }
    public int tatooine_knives_parry_ind_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_knives_parry_ind_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_knives_parry_ind_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_knives_parry_ind_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_knives_parry_ind_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_knives_parry_ind_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_knives_parry_ind_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_knives_parry_ind_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_knives_parry_ind_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_knives_parry_ind_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
