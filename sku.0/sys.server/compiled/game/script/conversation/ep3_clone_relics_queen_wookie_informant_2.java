...
public class ep3_clone_relics_queen_wookie_informant_2 extends script.base_script
{
    ...
    public boolean ep3_clone_relics_queen_wookie_informant_2_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_clone_relics_queen_wookie_informant_2_condition_isWookie(obj_id player, obj_id npc)
    {
        return (getSpecies(player) == SPECIES_WOOKIEE);
    }
    public boolean ep3_clone_relics_queen_wookie_informant_2_condition_onQuestTwo(obj_id player, obj_id npc)
    {
        return (groundquests.isQuestActive(player, "ep3_clone_relics_queen_2"));
    }
    public boolean ep3_clone_relics_queen_wookie_informant_2_condition_atOutpost(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "ep3_clone_relics_queen_2", "atMiningOutpost"));
    }
    public boolean ep3_clone_relics_queen_wookie_informant_2_condition_onSpaceMission(obj_id player, obj_id npc)
    {
        return (space_quest.hasQuest(player, "space_battle", "ep3_clone_relics_queen_3"));
    }
    public boolean ep3_clone_relics_queen_wookie_informant_2_condition_knowWookie(obj_id player, obj_id npc)
    {
        return utils.canSpeakWookiee(player, npc);
    }
    public boolean ep3_clone_relics_queen_wookie_informant_2_condition_foundInformants(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "ep3_clone_relics_queen_2", "foundInformants"));
    }
    public void ep3_clone_relics_queen_wookie_informant_2_action_signalTalked(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedToPrisonWookie");
    }
    public void ep3_clone_relics_queen_wookie_informant_2_action_grantSpaceMission(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "space_battle", "ep3_clone_relics_queen_3");
        groundquests.sendSignal(player, "gotSpaceMission");
    }
    public void ep3_clone_relics_queen_wookie_informant_2_action_cantUnderstand(obj_id player, obj_id npc)
    {
        utils.emoteWookieeConfusion(player, npc);
    }
    public int ep3_clone_relics_queen_wookie_informant_2_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_queen_wookie_informant_2_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_queen_wookie_informant_2_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_queen_wookie_informant_2_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_queen_wookie_informant_2_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_queen_wookie_informant_2_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
