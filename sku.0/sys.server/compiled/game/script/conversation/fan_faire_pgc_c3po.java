...
public class fan_faire_pgc_c3po extends script.base_script
{
    ...
    public boolean fan_faire_pgc_c3po_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean fan_faire_pgc_c3po_condition_needsProfession(obj_id player, obj_id npc)
    {
        return !hasSkill(player, "class_chronicles_novice");
    }
    public boolean fan_faire_pgc_c3po_condition_relicEnabled(obj_id player, obj_id npc)
    {
        return false;
    }
    public void fan_faire_pgc_c3po_action_grantProfession(obj_id player, obj_id npc)
    {
        grantSkill(player, "class_chronicles_novice");
        sendSystemMessage(player, "You are now a Chronicle Apprentice.", "");
        return;
    }
    public int fan_faire_pgc_c3po_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int fan_faire_pgc_c3po_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_28"))
        {
            if (fan_faire_pgc_c3po_condition__defaultCondition(player, npc))
    ...
    public int fan_faire_pgc_c3po_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_28"))
        {
            if (fan_faire_pgc_c3po_condition__defaultCondition(player, npc))
    ...
    public int fan_faire_pgc_c3po_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int fan_faire_pgc_c3po_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_47"))
        {
            if (fan_faire_pgc_c3po_condition__defaultCondition(player, npc))
    ...
    public int fan_faire_pgc_c3po_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_47"))
        {
            if (fan_faire_pgc_c3po_condition__defaultCondition(player, npc))
    ...
    public int fan_faire_pgc_c3po_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_47"))
        {
            if (fan_faire_pgc_c3po_condition__defaultCondition(player, npc))
    ...
    public int fan_faire_pgc_c3po_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_47"))
        {
            if (fan_faire_pgc_c3po_condition__defaultCondition(player, npc))
    ...
    public int fan_faire_pgc_c3po_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_47"))
        {
            if (fan_faire_pgc_c3po_condition__defaultCondition(player, npc))
    ...
    public int fan_faire_pgc_c3po_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_47"))
        {
            if (fan_faire_pgc_c3po_condition__defaultCondition(player, npc))
    ...
    public int fan_faire_pgc_c3po_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_47"))
        {
            if (fan_faire_pgc_c3po_condition__defaultCondition(player, npc))
    ...
    public int fan_faire_pgc_c3po_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_28"))
        {
            if (fan_faire_pgc_c3po_condition__defaultCondition(player, npc))
    ...
    public int fan_faire_pgc_c3po_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_28"))
        {
            if (fan_faire_pgc_c3po_condition__defaultCondition(player, npc))
    ...
    public int fan_faire_pgc_c3po_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_28"))
        {
            if (fan_faire_pgc_c3po_condition__defaultCondition(player, npc))
    ...
    public int fan_faire_pgc_c3po_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_28"))
        {
            if (fan_faire_pgc_c3po_condition__defaultCondition(player, npc))
    ...
    public int fan_faire_pgc_c3po_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_28"))
        {
            if (fan_faire_pgc_c3po_condition__defaultCondition(player, npc))
    ...
    public int fan_faire_pgc_c3po_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_28"))
        {
            if (fan_faire_pgc_c3po_condition__defaultCondition(player, npc))
    ...
    public int handleFanFairec3poSetup(obj_id self, dictionary params)
    {
