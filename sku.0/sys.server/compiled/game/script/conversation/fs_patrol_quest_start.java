...
public class fs_patrol_quest_start extends script.base_script
{
    ...
    public boolean fs_patrol_quest_start_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean fs_patrol_quest_start_condition_canTalkToVillagers(obj_id player, obj_id npc)
    {
        return fs_quests.isVillageEligible(player);
    }
    public boolean fs_patrol_quest_start_condition_ableToDoQuest(obj_id player, obj_id npc)
    {
        return fs_quests.hasQuestAccepted(player);
    }
    public boolean fs_patrol_quest_start_condition_finished(obj_id player, obj_id npc)
    {
        return quests.isComplete("fs_patrol_quest_finish", player);
    }
    public boolean fs_patrol_quest_start_condition_Complete9andQualifiesToComplete10(obj_id player, obj_id npc)
    {
    ...
    public boolean fs_patrol_quest_start_condition_Complete19andQualifiesToComplete20(obj_id player, obj_id npc)
    {
    ...
    public boolean fs_patrol_quest_start_condition_CheckIfElevenIsGiven(obj_id player, obj_id npc)
    {
    ...
    public boolean fs_patrol_quest_start_condition_CheckIfOneIsGiven(obj_id player, obj_id npc)
    {
    ...
    public boolean fs_patrol_quest_start_condition_CheckIfTenIsComplete(obj_id player, obj_id npc)
    {
        return quests.isComplete("fs_patrol_quest_10", player);
    }
    public boolean fs_patrol_quest_start_condition_FindCurrentCheckIfQualifyToComplete(obj_id player, obj_id npc)
    {
    ...
    public boolean fs_patrol_quest_start_condition_inventoryCheck(obj_id player, obj_id npc)
    {
    ...
    public void fs_patrol_quest_start_action_GiveQuestOne(obj_id player, obj_id npc)
    {
    ...
    public void fs_patrol_quest_start_action_GiveNextQuest(obj_id player, obj_id npc)
    {
        String questName = "fs_patrol_quest_";
    ...
    public void fs_patrol_quest_start_action_GiveQuestEleven(obj_id player, obj_id npc)
    {
        quests.activate("fs_patrol_quest_11", player, npc);
        setObjVar(player, "quest.fs_patrol.current_patrol", true);
        setObjVar(player, "quest.fs_patrol.current_patrol_point", true);
    }
    public void fs_patrol_quest_start_action_UnlockFSBranch(obj_id player, obj_id npc)
    {
    ...
    public void fs_patrol_quest_start_action_GiveReward(obj_id player, obj_id npc)
    {
    ...
    public void fs_patrol_quest_start_action_resetCurrentPatrol(obj_id player, obj_id npc)
    {
        String questName = "fs_patrol_quest_";
        for (int j = 1; j < 21; j++)
        {
