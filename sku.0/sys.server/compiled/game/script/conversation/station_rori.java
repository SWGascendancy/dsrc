...
public class station_rori extends script.base_script
{
    ...
    public boolean station_rori_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean station_rori_condition_canAfford50(obj_id player, obj_id npc)
    {
        return space_crafting.canAffordShipRepairs(player, npc, .50f);
    }
    public boolean station_rori_condition_canAfford25(obj_id player, obj_id npc)
    {
        return (space_crafting.canAffordShipRepairs(player, npc, .25f) && space_crafting.isDamaged(player));
    }
    public boolean station_rori_condition_canAfford75(obj_id player, obj_id npc)
    {
        return space_crafting.canAffordShipRepairs(player, npc, .75f);
    }
    public boolean station_rori_condition_canAfford100(obj_id player, obj_id npc)
    {
        return space_crafting.canAffordShipRepairs(player, npc, 1.0f);
    }
    public boolean station_rori_condition_needRepairs(obj_id player, obj_id npc)
    {
    ...
    public boolean station_rori_condition_canLandAtRebelBase(obj_id player, obj_id npc)
    {
    ...
    public boolean station_rori_condition_isTooFar(obj_id player, obj_id npc)
    {
        space_combat.playCombatTauntSound(player);
        obj_id containingShip = space_transition.getContainingShip(player);
        return (getDistance(npc, containingShip) > space_transition.STATION_COMM_MAX_DISTANCE);
    }
    public boolean station_rori_condition_isMeanPlayer(obj_id player, obj_id npc)
    {
        return (hasObjVar(player, "roriStationMeanie"));
    }
    public boolean station_rori_condition_eligibleForImpQuests(obj_id player, obj_id npc)
    {
    ...
    public boolean station_rori_condition_eligibleForRsfQuests(obj_id player, obj_id npc)
    {
    ...
    public boolean station_rori_condition_eligibleForRebQuests(obj_id player, obj_id npc)
    {
    ...
    public boolean station_rori_condition_isOnRebStoryQuest_01(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "station_rori.isOnRebelStoryQuest_01");
    }
    public boolean station_rori_condition_alreadyHasAQuest(obj_id player, obj_id npc)
    {
        return space_quest.hasQuest(player);
    }
    public boolean station_rori_condition_wonRebStoryQuest_01_a(obj_id player, obj_id npc)
    {
        return space_quest.hasWonQuest(player, "escort", "rori_station_reb_storyquest_01_a");
    }
    public boolean station_rori_condition_wonRebStoryQuest_01_b(obj_id player, obj_id npc)
    {
        return space_quest.hasWonQuest(player, "recovery", "rori_station_reb_storyquest_01_b");
    }
    public boolean station_rori_condition_wonRebStoryQuest_01_c(obj_id player, obj_id npc)
    {
        return space_quest.hasWonQuest(player, "assassinate", "rori_station_reb_storyquest_01_c");
    }
    public boolean station_rori_condition_wonRebStoryQuest_01_d(obj_id player, obj_id npc)
    {
        return space_quest.hasWonQuest(player, "assassinate", "rori_station_reb_storyquest_01_d");
    }
    public boolean station_rori_condition_wonRebStoryQuest_01_e(obj_id player, obj_id npc)
    {
        return space_quest.hasWonQuest(player, "assassinate", "rori_station_reb_storyquest_01_e");
    }
    public boolean station_rori_condition_canLandAtHouse(obj_id player, obj_id npc)
    {
    ...
    public boolean station_rori_condition_canTakeQuest(obj_id player, obj_id npc)
    {
        if (space_quest.hasQuest(player))
        {
            return false;
    ...
    public boolean station_rori_condition_canAttackImperial(obj_id player, obj_id npc)
    {
    ...
    public boolean station_rori_condition_canAttackRebel(obj_id player, obj_id npc)
    {
    ...
    public boolean station_rori_condition_canTakeTier5RebelDuty(obj_id player, obj_id npc)
    {
    ...
    public boolean station_rori_condition_canTakeTier5ImperialDuty(obj_id player, obj_id npc)
    {
        if (!space_skill.isMasterPilot(player))
        {
            return false;
    ...
    public void station_rori_action_landAtRebelOutpos(obj_id player, obj_id npc)
    {
        space_content.landPlayer(player, npc, "Rebel Outpost");
    }
    public void station_rori_action_fix25(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, .25f);
    }
    public void station_rori_action_fix50(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, .50f);
    }
    public void station_rori_action_fix75(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, .75f);
    }
    public void station_rori_action_fix100(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, 1.0f);
    }
    public void station_rori_action_landAtNarmle(obj_id player, obj_id npc)
    {
        space_content.landPlayer(player, npc, "Narmle Starport");
    }
    public void station_rori_action_landAtRestuss(obj_id player, obj_id npc)
    {
        space_content.landPlayer(player, npc, "Restuss Starport");
    }
    public void station_rori_action_flagMeanPlayer(obj_id player, obj_id npc)
    {
        setObjVar(player, "roriStationMeanie", true);
    }
    public void station_rori_action_unflagMeanPlayer(obj_id player, obj_id npc)
    {
        removeObjVar(player, "roriStationMeanie");
    }
    public void station_rori_action_grantImpEscortDuty(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "escort_duty", "rori_station_imp_escort_duty_tier3");
    }
    public void station_rori_action_grantImpDestroyDuty(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "rori_station_imp_destroy_duty_tier3");
    }
    public void station_rori_action_grantRsfEscortDuty(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "escort_duty", "rori_station_rsf_escort_duty_tier3");
    }
    public void station_rori_action_grantRsfDestroyDuty(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "rori_station_rsf_destroy_duty_tier3");
    }
    public void station_rori_action_grantRebelEscortDuty(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "escort_duty", "rori_station_reb_escort_duty_tier3");
    }
    public void station_rori_action_grantRebelDestroyDuty(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "rori_station_reb_destroy_duty_tier3");
    }
    public void station_rori_action_startRebStoryQuest_01(obj_id player, obj_id npc)
    {
    ...
    public void station_rori_action_grantRebStoryQuest_01_b(obj_id player, obj_id npc)
    {
    ...
    public void station_rori_action_grantRebStoryQuest_01_c(obj_id player, obj_id npc)
    {
    ...
    public void station_rori_action_grantRebStoryQuest_01_d(obj_id player, obj_id npc)
    {
    ...
    public void station_rori_action_grantRebStoryQuest_01_e(obj_id player, obj_id npc)
    {
    ...
    public void station_rori_action_grantRebStoryQuest_01_f(obj_id player, obj_id npc)
    {
    ...
    public void station_rori_action_landHoming(obj_id player, obj_id npc)
    {
        space_content.landPlayerHoming(player, npc);
    }
    public void station_rori_action_grantImperialDuty1(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "naboo_imperial_tier1");
    }
    public void station_rori_action_grantImperialDuty2(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "naboo_imperial_tier2");
    }
    public void station_rori_action_grantRebelDuty1(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "naboo_rebel_tier1");
    }
    public void station_rori_action_grantRebelDuty2(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "naboo_rebel_tier2");
    }
    public void station_rori_action_grantDroidDuty1(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "naboo_rogue_droid_tier1");
    }
    public void station_rori_action_grantDroidDuty2(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "naboo_rogue_droid_tier2");
    }
    public void station_rori_action_grantVoidDuty1(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "naboo_void_wing_tier1");
    }
    public void station_rori_action_grantVoidDuty2(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "naboo_void_wing_tier2");
    }
    public void station_rori_action_grantImperialDuty5(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "naboo_imperial_tier5");
    }
    public void station_rori_action_grantRebelDuty5(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "naboo_rebel_tier5");
    }
    public String station_rori_tokenTO_tokenTO0001(obj_id player, obj_id npc)
    {
        return new String();
    }
    public int station_rori_tokenDI_getStationRepairCost25(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, .25f);
    }
    public int station_rori_tokenDI_getStationRepairCost50(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, .50f);
    }
    public int station_rori_tokenDI_getStationRepairCost75(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, .75f);
    }
    public int station_rori_tokenDI_getStationRepairCost100(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, 1.0f);
    }
    public int station_rori_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rori_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rori_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rori_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rori_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rori_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rori_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rori_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rori_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_333"))
        {
            if (station_rori_condition__defaultCondition(player, npc))
    ...
    public int station_rori_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rori_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rori_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rori_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rori_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rori_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rori_handleBranch32(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rori_handleBranch35(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_333"))
        {
            if (station_rori_condition__defaultCondition(player, npc))
    ...
    public int station_rori_handleBranch36(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rori_handleBranch37(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rori_handleBranch40(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rori_handleBranch43(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rori_handleBranch46(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rori_handleBranch49(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rori_handleBranch50(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rori_handleBranch53(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rori_handleBranch56(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rori_handleBranch59(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rori_handleBranch63(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rori_handleBranch64(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_377"))
        {
            if (station_rori_condition__defaultCondition(player, npc))
    ...
    public int station_rori_handleBranch66(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rori_handleBranch70(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rori_handleBranch74(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rori_handleBranch78(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rori_handleBranch79(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rori_handleBranch80(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rori_handleBranch84(obj_id player, obj_id npc, string_id response)
    {
