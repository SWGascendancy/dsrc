...
public class respecseller extends script.base_script
{
    ...
    public boolean respecseller_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean respecseller_condition_hasBoughtRespecsBefore(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "respecsBought");
    }
    public boolean respecseller_condition_hasInventorySpace(obj_id player, obj_id npc)
    {
    ...
    public boolean respecseller_condition_repeatCustomerHasInventorySpace(obj_id player, obj_id npc)
    {
    ...
    public boolean respecseller_condition_firstTimeCustomerHasInventorySpace(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "respecsBought"))
        {
            return false;
    ...
    public boolean respecseller_condition_hasCashToCoverRespec(obj_id player, obj_id npc)
    {
        int cost = respec.getRespecCost(player);
        int balance = getTotalMoney(player);
        return cost <= balance;
    }
    public boolean respecseller_condition_hasCashToCoverReallocation(obj_id player, obj_id npc)
    {
        int cost = respec.getReallocationCost(player);
        int balance = getTotalMoney(player);
        return cost <= balance;
    }
    public boolean respecseller_condition_hasExpertiseSkill(obj_id player, obj_id npc)
    {
    ...
    public boolean respecseller_condition_hasExpertiseAllocated(obj_id player, obj_id npc)
    {
        return hasSkill(player, "internal_expertise_autoallocated");
    }
    public boolean respecseller_condition_hasFreeReallocations(obj_id player, obj_id npc)
    {
        return respec.hasFreeReallocation(player);
    }
    public boolean respecseller_condition_hasTwoOrMoreFreeRealloc(obj_id player, obj_id npc)
    {
    ...
    public boolean respecseller_condition_hasNoMoreFreeRealloc(obj_id player, obj_id npc)
    {
    ...
    public boolean respecseller_condition_hasCloningSickness(obj_id player, obj_id npc)
    {
        return buff.hasBuff(player, "cloning_sickness");
    }
    public void respecseller_action_buyRespecToken(obj_id player, obj_id npc)
    {
        respec.startNpcRespec(player, npc);
    }
    public void respecseller_action_removeAutoExpertise(obj_id player, obj_id npc)
    {
    ...
    public void respecseller_action_buyReallocation(obj_id player, obj_id npc)
    {
        respec.handleNpcRealloc(player);
    }
    public String respecseller_tokenTO_tokenTO0001(obj_id player, obj_id npc)
    {
        return new String();
    }
    public int respecseller_tokenDI_respecCost(obj_id player, obj_id npc)
    {
        return respec.getRespecCost(player);
    }
    public int respecseller_tokenDI_reallocCost(obj_id player, obj_id npc)
    {
        return respec.getReallocationCost(player);
    }
    public int respecseller_tokenDI_numFreeAlloc(obj_id player, obj_id npc)
    {
        return respec.numFreeAllocations(player);
    }
    public int respecseller_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int respecseller_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int respecseller_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int respecseller_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int respecseller_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int respecseller_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int respecseller_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int respecseller_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int respecseller_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
