...
public class ep3_trandoshan_jessokk extends script.base_script
{
    ...
    public boolean ep3_trandoshan_jessokk_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public int ep3_trandoshan_jessokk_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
