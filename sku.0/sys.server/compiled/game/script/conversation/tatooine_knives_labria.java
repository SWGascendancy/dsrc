...
public class tatooine_knives_labria extends script.base_script
{
    ...
    public boolean tatooine_knives_labria_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tatooine_knives_labria_condition_onQuest(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_knives_thrust");
        boolean OnTask = (questIsQuestActive(questId1, player));
        return OnTask;
    }
    public boolean tatooine_knives_labria_condition_onTaskSnitch(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_knives_thrust");
    ...
    public boolean tatooine_knives_labria_condition_questComplete(obj_id player, obj_id npc)
    {
    ...
    public void tatooine_knives_labria_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void tatooine_knives_labria_action_signalMouse(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tatooine_knives_thrust_launch_e5");
    }
    public int tatooine_knives_labria_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_knives_labria_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
