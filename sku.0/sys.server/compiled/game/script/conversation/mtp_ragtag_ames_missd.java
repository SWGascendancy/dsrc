...
public class mtp_ragtag_ames_missd extends script.base_script
{
    ...
    public boolean mtp_ragtag_ames_missd_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean mtp_ragtag_ames_missd_condition_canSpeak(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_ragtag_ames_missd_condition_beatAnita(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "quest/mtp_hideout_ragtag", "speakAmesAnitaDone");
    }
    public boolean mtp_ragtag_ames_missd_condition_beatBox(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "quest/mtp_hideout_ragtag", "speakAmesBoxDone");
    }
    public boolean mtp_ragtag_ames_missd_condition_waveEventUnderway(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_ragtag_ames_missd_condition_doneWithAmes(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "quest/mtp_hideout_ragtag", "speakAmesBoxDone");
    }
    public void mtp_ragtag_ames_missd_action_rumbleFish(obj_id player, obj_id npc)
    {
    ...
    public void mtp_ragtag_ames_missd_action_spawnAnita(obj_id player, obj_id npc)
    {
    ...
    public void mtp_ragtag_ames_missd_action_spawnBox(obj_id player, obj_id npc)
    {
    ...
    public void mtp_ragtag_ames_missd_action_sendCompletion(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "spokenAmes");
    }
    public int mtp_ragtag_ames_missd_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_ragtag_ames_missd_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_ragtag_ames_missd_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_ragtag_ames_missd_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_ragtag_ames_missd_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_ragtag_ames_missd_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_ragtag_ames_missd_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_ragtag_ames_missd_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_ragtag_ames_missd_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_ragtag_ames_missd_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_ragtag_ames_missd_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_ragtag_ames_missd_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
