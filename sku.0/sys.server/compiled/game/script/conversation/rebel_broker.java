...
public class rebel_broker extends script.base_script
{
    ...
    public boolean rebel_broker_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean rebel_broker_condition_isImperialFaction(obj_id player, obj_id npc)
    {
    ...
    public boolean rebel_broker_condition_wasBrushedOff(obj_id player, obj_id npc)
    {
        return utils.hasScriptVar(player, "rebelBroker.brushoff");
    }
    public boolean rebel_broker_condition_isRebelPilot(obj_id player, obj_id npc)
    {
        return space_skill.hasRebelSkill(player);
    }
    public boolean rebel_broker_condition_isPilot(obj_id player, obj_id npc)
    {
        return space_skill.hasSpaceSkills(player);
    }
    public boolean rebel_broker_condition_hasSpaceExp(obj_id player, obj_id npc)
    {
        return true;
    }
    public void rebel_broker_action_brushedOffImp(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "rebelBroker.brushoff", true);
    }
    public void rebel_broker_action_addNabooWaypoint(obj_id player, obj_id npc)
    {
        trainerlocs.getTrainerLocationWaypoint(player, "rebel", "naboo");
    }
    public void rebel_broker_action_addCorellianWaypoint(obj_id player, obj_id npc)
    {
        trainerlocs.getTrainerLocationWaypoint(player, "rebel", "corellia");
    }
    public void rebel_broker_action_addTatooineWaypoint(obj_id player, obj_id npc)
    {
        trainerlocs.getTrainerLocationWaypoint(player, "rebel", "tatooine");
    }
    public void rebel_broker_action_retireSkill(obj_id player, obj_id npc)
    {
        space_skill.retire(player, space_skill.REBEL);
    }
    public int rebel_broker_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_broker_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_broker_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_broker_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_broker_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_broker_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_broker_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_broker_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_broker_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_broker_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_broker_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_broker_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_broker_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_63cd6ccb"))
        {
            if (rebel_broker_condition__defaultCondition(player, npc))
    ...
    public int rebel_broker_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_159911f5"))
        {
            if (rebel_broker_condition__defaultCondition(player, npc))
    ...
    public int rebel_broker_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_63cd6ccb"))
        {
            if (rebel_broker_condition__defaultCondition(player, npc))
    ...
    public int rebel_broker_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_159911f5"))
        {
            if (rebel_broker_condition__defaultCondition(player, npc))
    ...
    public int rebel_broker_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_63cd6ccb"))
        {
            if (rebel_broker_condition__defaultCondition(player, npc))
