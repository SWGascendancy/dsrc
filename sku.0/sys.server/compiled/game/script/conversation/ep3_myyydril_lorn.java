...
public class ep3_myyydril_lorn extends script.base_script
{
    ...
    public boolean ep3_myyydril_lorn_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_myyydril_lorn_condition_completedTalkToLorn(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_myyydril_lorn_talkto");
    }
    public boolean ep3_myyydril_lorn_condition_canTalkToLorn(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_myyydril_lorn_talkto");
    }
    public void ep3_myyydril_lorn_action_giveQuestOne(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_myyydril_lorn_retrieve_6");
    }
    public void ep3_myyydril_lorn_action_giveSignalOne(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "lorn");
    }
    public void ep3_myyydril_lorn_action_spawnGrievous(obj_id player, obj_id npc)
    {
    ...
    public int ep3_myyydril_lorn_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_lorn_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_lorn_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
