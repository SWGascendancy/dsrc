...
public class corellia_38_deel_draav extends script.base_script
{
    ...
    public boolean corellia_38_deel_draav_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_38_deel_draav_condition_LuckyMayorActive(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_38_corsec_files_03", "corsec_files_03_02");
    }
    public boolean corellia_38_deel_draav_condition_luckyMayorInProgress(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_38_deel_draav_condition_questComplete(obj_id player, obj_id npc)
    {
    ...
    public void corellia_38_deel_draav_action_questGranted(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest_name");
    }
    public void corellia_38_deel_draav_action_taskOneCompletedSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "corsec_files_03_02");
    }
    public int corellia_38_deel_draav_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_38_deel_draav_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
