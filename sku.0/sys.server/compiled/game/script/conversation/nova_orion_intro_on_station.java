...
public class nova_orion_intro_on_station extends script.base_script
{
    ...
    public boolean nova_orion_intro_on_station_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean nova_orion_intro_on_station_condition_onquest(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "nova_orion_intro_01", "hidden_signal");
    }
    public boolean nova_orion_intro_on_station_condition_lastStep(obj_id player, obj_id npc)
    {
    ...
    public boolean nova_orion_intro_on_station_condition_questFinished(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "nova_orion_intro_01");
    }
    public boolean nova_orion_intro_on_station_condition_canTakeMission(obj_id player, obj_id npc)
    {
        return space_skill.isMasterPilot(player);
    }
    public void nova_orion_intro_on_station_action_giveQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "nova_orion_intro_01");
    }
    public void nova_orion_intro_on_station_action_clearAndRegrant(obj_id player, obj_id npc)
    {
    ...
    public void nova_orion_intro_on_station_action_finalSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "nova_orion_intro_return_success");
    }
    public int nova_orion_intro_on_station_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nova_orion_intro_on_station_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nova_orion_intro_on_station_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
