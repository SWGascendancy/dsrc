...
public class emp_day_reb_technician extends script.base_script
{
    ...
    public boolean emp_day_reb_technician_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean emp_day_reb_technician_condition_isRebel(obj_id player, obj_id npc)
    {
    ...
    public boolean emp_day_reb_technician_condition_notReadyForYou(obj_id player, obj_id npc)
    {
    ...
    public boolean emp_day_reb_technician_condition_hasTask5(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/emp_day_rebel");
        int task5 = groundquests.getTaskId(questId, "toRebelSpy");
        return questIsTaskActive(questId, task5, player);
    }
    public boolean emp_day_reb_technician_condition_hasTask6(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/emp_day_rebel");
        int task6 = groundquests.getTaskId(questId, "toRebelColonel");
        return questIsTaskActive(questId, task6, player);
    }
    public boolean emp_day_reb_technician_condition_pastMyTasks(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/emp_day_rebel");
        int task6 = groundquests.getTaskId(questId, "toRebelColonel");
        return (questIsTaskComplete(questId, task6, player) || questIsQuestComplete(questId, player));
    }
    public void emp_day_reb_technician_action_wpToCommander(obj_id player, obj_id npc)
    {
    ...
    public void emp_day_reb_technician_action_signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "to_rebel_spy");
    }
    public void emp_day_reb_technician_action_allowConvert(obj_id player, obj_id npc)
    {
    ...
    public int emp_day_reb_technician_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_reb_technician_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_reb_technician_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_reb_technician_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_reb_technician_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_reb_technician_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
