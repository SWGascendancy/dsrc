...
public class aurilia_chief_engineer extends script.conversation.base.conversation_base
{
    ...
    private boolean aurilia_chief_engineer_condition_axkva_min_intro_01(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "axkva_min_intro", "axkva_min_intro_01");
    }
    private int aurilia_chief_engineer_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
