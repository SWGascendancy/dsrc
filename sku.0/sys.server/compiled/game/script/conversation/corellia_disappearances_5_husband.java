...
public class corellia_disappearances_5_husband extends script.base_script
{
    ...
    public boolean corellia_disappearances_5_husband_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_disappearances_5_husband_condition_talktohusband(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_disappearances_5_rescue", "talktohusband");
    }
    public boolean corellia_disappearances_5_husband_condition_finishedRescue(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "corellia_disappearances_5_rescue", "talktohusband");
    }
    public void corellia_disappearances_5_husband_action_signalCage(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "corellia_disappear_final_hostage");
    }
    public int corellia_disappearances_5_husband_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_disappearances_5_husband_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
