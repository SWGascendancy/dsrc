...
public class ep3_wke_spirit_healer extends script.base_script
{
    ...
    public boolean ep3_wke_spirit_healer_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_wke_spirit_healer_condition_isSick(obj_id player, obj_id npc)
    {
        return buff.hasBuff(player, "cloning_sickness");
    }
    public boolean ep3_wke_spirit_healer_condition_canAffordCure(obj_id player, obj_id npc)
    {
        return pclib.canAffordCloningSicknessCure(player);
    }
    public void ep3_wke_spirit_healer_action_queueInsure(obj_id player, obj_id npc)
    {
        queueCommand(player, (-650958312), npc, "", COMMAND_PRIORITY_DEFAULT);
    }
    public void ep3_wke_spirit_healer_action_insureAll(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        messageTo(npc, "handleConfirmInsureAll", params, 1, false);
    }
    public void ep3_wke_spirit_healer_action_payForCure(obj_id player, obj_id npc)
    {
        pclib.cureCloningSickness(player);
    }
    public int ep3_wke_spirit_healer_tokenDI_cureCost(obj_id player, obj_id npc)
    {
        return pclib.getCloningSicknessCureCost(player);
    }
    public int ep3_wke_spirit_healer_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_wke_spirit_healer_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_wke_spirit_healer_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
