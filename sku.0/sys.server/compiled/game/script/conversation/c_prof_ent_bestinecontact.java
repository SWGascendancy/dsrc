...
public class c_prof_ent_bestinecontact extends script.base_script
{
    ...
    public boolean c_prof_ent_bestinecontact_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_prof_ent_bestinecontact_condition_playerOnTask(obj_id player, obj_id npc)
    {
    ...
    public void c_prof_ent_bestinecontact_action_FaceAndMood(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        ai_lib.setMood(npc, chat.MOOD_DRUNK);
    }
    public void c_prof_ent_bestinecontact_action_forwardquest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "c_prof_ent_bestine");
    }
    public int c_prof_ent_bestinecontact_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_prof_ent_bestinecontact_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_prof_ent_bestinecontact_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_prof_ent_bestinecontact_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
