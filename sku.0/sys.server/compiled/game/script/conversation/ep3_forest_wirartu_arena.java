...
public class ep3_forest_wirartu_arena extends script.base_script
{
    ...
    public boolean ep3_forest_wirartu_arena_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_forest_wirartu_arena_condition_isEpicTaskActiveOne(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_forest_kerritamba_epic_6", "taskArenaStart");
    }
    public void ep3_forest_wirartu_arena_action_grantQuestOne(obj_id player, obj_id npc)
    {
    ...
    public int ep3_forest_wirartu_arena_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_wirartu_arena_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
