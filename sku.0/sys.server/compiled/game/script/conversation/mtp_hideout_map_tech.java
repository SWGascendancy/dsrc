...
public class mtp_hideout_map_tech extends script.base_script
{
    ...
    public boolean mtp_hideout_map_tech_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean mtp_hideout_map_tech_condition_hasMeatlumpFood(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_hideout_map_tech_condition_corelliaQuestActiveComplete(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "quest/mtp_camp_quest_corellia");
    }
    public boolean mtp_hideout_map_tech_condition_lunchQuestActiveComplete(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "quest/mtp_hideout_get_lunch");
    }
    public boolean mtp_hideout_map_tech_condition_lunchQuestComplete(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "quest/mtp_hideout_get_lunch");
    }
    public boolean mtp_hideout_map_tech_condition_corelliaQuestComplete(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "quest/mtp_camp_quest_corellia");
    }
    public boolean mtp_hideout_map_tech_condition_isElligibleForLunchQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_hideout_map_tech_condition_isLunchActiveButNotCorellia(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_hideout_map_tech_condition_hasCompletedLunchAndCorellia(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_hideout_map_tech_condition_abortedCorelliaQuest(obj_id player, obj_id npc)
    {
    ...
    public void mtp_hideout_map_tech_action_grantQuestCorellia(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest/mtp_camp_quest_corellia");
    }
    public void mtp_hideout_map_tech_action_grantLunchQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest/mtp_hideout_get_lunch");
    }
    public void mtp_hideout_map_tech_action_sendLunchSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "foundMeatlumps");
        mtp_hideout_map_tech_action_deleteObjectInPlayer(player, npc);
    }
    public void mtp_hideout_map_tech_action_deleteObjectInPlayer(obj_id player, obj_id npc)
    {
    ...
    public int mtp_hideout_map_tech_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_map_tech_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_map_tech_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_map_tech_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_map_tech_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_map_tech_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_map_tech_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_map_tech_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
