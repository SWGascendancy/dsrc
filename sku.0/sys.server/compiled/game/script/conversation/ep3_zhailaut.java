...
public class ep3_zhailaut extends script.base_script
{
    ...
    public boolean ep3_zhailaut_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_zhailaut_condition_hasWonSurrogate(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_zhailaut_condition_isReadyForRadioReward(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_zhailaut_recover_trando_radio", "hasRetrievedRadio");
    }
    public boolean ep3_zhailaut_condition_isRadioQuestActive(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_zhailaut_recover_trando_radio");
    }
    public boolean ep3_zhailaut_condition_dunnoWookiee(obj_id player, obj_id npc)
    {
        return utils.canSpeakWookiee(player, npc);
    }
    public boolean ep3_zhailaut_condition_shouldSpeakWithKymayrr(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_zhailaut_recover_trando_radio");
    }
    public void ep3_zhailaut_action_grantRadioRecovery(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_zhailaut_recover_trando_radio");
    }
    public void ep3_zhailaut_action_giveRadioRecoverReward(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "giveTrandoRadioReward");
    }
    public void ep3_zhailaut_action_doWookieeNub(obj_id player, obj_id npc)
    {
        utils.emoteWookieeConfusion(player, npc);
    }
    public int ep3_zhailaut_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_zhailaut_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_zhailaut_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_zhailaut_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
