...
public class nexus_tusken_starter extends script.base_script
{
    ...
    public boolean nexus_tusken_starter_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean nexus_tusken_starter_condition_needsQuest(obj_id player, obj_id npc)
    {
        return !groundquests.isQuestActiveOrComplete(player, "found_tusken_encounter");
    }
    public boolean nexus_tusken_starter_condition_onQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "feeder_tusken_01");
    }
    public boolean nexus_tusken_starter_condition_finishedQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "feeder_tusken_01");
    }
    public void nexus_tusken_starter_action_giveQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "found_tusken_encounter");
    }
    public int nexus_tusken_starter_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nexus_tusken_starter_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
