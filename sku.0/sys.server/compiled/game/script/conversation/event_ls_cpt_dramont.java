...
public class event_ls_cpt_dramont extends script.base_script
{
    ...
    public boolean event_ls_cpt_dramont_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean event_ls_cpt_dramont_condition_hasSixCores(obj_id player, obj_id npc)
    {
    ...
    public boolean event_ls_cpt_dramont_condition_outOfRewards(obj_id player, obj_id npc)
    {
    ...
    public boolean event_ls_cpt_dramont_condition_hasMin1core(obj_id player, obj_id npc)
    {
        obj_id[] playerItems = getInventoryAndEquipment(player);
        for (int i = 0; i < playerItems.length; i++)
        {
    ...
    public void event_ls_cpt_dramont_action_giveBoobiePrize(obj_id player, obj_id npc)
    {
        obj_id[] playerItems = getInventoryAndEquipment(player);
        obj_id mom = getObjIdObjVar(npc, "mom");
        for (int i = 0; i < playerItems.length; i++)
    ...
    public void event_ls_cpt_dramont_action_giveXWingReward(obj_id player, obj_id npc)
    {
        obj_id[] playerItems = getInventoryAndEquipment(player);
        obj_id mom = getObjIdObjVar(npc, "mom");
        for (int i = 0; i < playerItems.length; i++)
    ...
    public void event_ls_cpt_dramont_action_giveTBomberReward(obj_id player, obj_id npc)
    {
        obj_id[] playerItems = getInventoryAndEquipment(player);
        obj_id mom = getObjIdObjVar(npc, "mom");
        for (int i = 0; i < playerItems.length; i++)
    ...
    public int event_ls_cpt_dramont_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_ls_cpt_dramont_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_ls_cpt_dramont_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_ls_cpt_dramont_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_ls_cpt_dramont_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_ls_cpt_dramont_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_ls_cpt_dramont_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_34"))
        {
            if (event_ls_cpt_dramont_condition__defaultCondition(player, npc))
    ...
    public int event_ls_cpt_dramont_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_ls_cpt_dramont_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_34"))
        {
            if (event_ls_cpt_dramont_condition__defaultCondition(player, npc))
