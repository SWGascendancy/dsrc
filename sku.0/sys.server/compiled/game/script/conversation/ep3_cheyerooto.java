...
public class ep3_cheyerooto extends script.base_script
{
    ...
    public boolean ep3_cheyerooto_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_cheyerooto_condition_isReadyToCompleteWrhisch(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_sera_wrhisch_liver", "wrhischReadyToComplete");
    }
    public boolean ep3_cheyerooto_condition_hasCompletedWrhischQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_sera_wrhisch_liver");
    }
    public boolean ep3_cheyerooto_condition_isRootQuestActive(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_cheyerooto_5_rrwii_root");
    }
    public boolean ep3_cheyerooto_condition_readyToCompleteRrwii(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_cheyerooto_5_rrwii_root", "cheyerootoRrwiiComplete");
    }
    public boolean ep3_cheyerooto_condition_hasCompletedRrwiiQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_cheyerooto_5_rrwii_root");
    }
    public boolean ep3_cheyerooto_condition_isWookieeNub(obj_id player, obj_id npc)
    {
        return utils.canSpeakWookiee(player, npc);
    }
    public void ep3_cheyerooto_action_grantRootGather(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_cheyerooto_5_rrwii_root");
    }
    public void ep3_cheyerooto_action_giveWrhischReward(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "giveWrhischReward");
    }
    public void ep3_cheyerooto_action_giveRrwiiReward(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "rrwiiGiveReward");
    }
    public void ep3_cheyerooto_action_schoolWookieeNub(obj_id player, obj_id npc)
    {
        utils.emoteWookieeConfusion(player, npc);
    }
    public int ep3_cheyerooto_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_cheyerooto_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_cheyerooto_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_cheyerooto_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_cheyerooto_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_cheyerooto_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
