...
public class ep3_clone_relics_boba_fett_yavin_bartender_1 extends script.base_script
{
    ...
    public boolean ep3_clone_relics_boba_fett_yavin_bartender_1_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_clone_relics_boba_fett_yavin_bartender_1_condition_canTakeQuest(obj_id player, obj_id npc)
    {
    ...
    public void ep3_clone_relics_boba_fett_yavin_bartender_1_action_grantQuestFour(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_clone_relics_boba_fett_4");
    }
    public int ep3_clone_relics_boba_fett_yavin_bartender_1_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_boba_fett_yavin_bartender_1_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_boba_fett_yavin_bartender_1_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_boba_fett_yavin_bartender_1_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
