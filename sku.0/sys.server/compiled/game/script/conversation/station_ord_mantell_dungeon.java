...
public class station_ord_mantell_dungeon extends script.base_script
{
    ...
    public boolean station_ord_mantell_dungeon_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean station_ord_mantell_dungeon_condition_isTooFar(obj_id player, obj_id npc)
    {
    ...
    public boolean station_ord_mantell_dungeon_condition_canAfford100(obj_id player, obj_id npc)
    {
        return space_crafting.canAffordShipRepairs(player, npc, 1.0f);
    }
    public boolean station_ord_mantell_dungeon_condition_canAfford25(obj_id player, obj_id npc)
    {
        return (space_crafting.canAffordShipRepairs(player, npc, .25f) && space_crafting.isDamaged(player));
    }
    public boolean station_ord_mantell_dungeon_condition_needsRepairs(obj_id player, obj_id npc)
    {
        return space_crafting.isDamaged(player);
    }
    public void station_ord_mantell_dungeon_action_land(obj_id player, obj_id npc)
    {
        location stationLoc = getLocation(npc);
        location playerLoc = getLocation(space_transition.getContainingShip(player));
    ...
    public void station_ord_mantell_dungeon_action_fix100(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, 1.0f);
    }
    public void station_ord_mantell_dungeon_action_fix25(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, .25f);
    }
    public int station_ord_mantell_dungeon_tokenDI_get100FixCost(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, 1.0f);
    }
    public int station_ord_mantell_dungeon_tokenDI_get25FixCost(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, .25f);
    }
    public int station_ord_mantell_dungeon_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_ord_mantell_dungeon_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_ord_mantell_dungeon_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_ord_mantell_dungeon_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
