...
public class ig88_bothan_01 extends script.base_script
{
    ...
    public boolean ig88_bothan_01_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ig88_bothan_01_condition_onTask(obj_id player, obj_id npc)
    {
    ...
    public boolean ig88_bothan_01_condition_endQuest(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "feeder_ig88_03", "feeder_signal_ig88_02");
    }
    public boolean ig88_bothan_01_condition_needsQuest(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "feeder_ig88_01", "feeder_singal_ig88_03");
    }
    public boolean ig88_bothan_01_condition_onQuest(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "feeder_ig88_01", "feeder_ig88_wait_02");
    }
    public boolean ig88_bothan_01_condition_finishedQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "feeder_ig88_03");
    }
    public void ig88_bothan_01_action_completeQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "feeder_signal_ig88_03_02");
    }
    public void ig88_bothan_01_action_grantQuest03(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "feeder_ig88_03");
        groundquests.sendSignal(player, "feeder_signal_ig88_01_03");
    }
    public int ig88_bothan_01_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ig88_bothan_01_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ig88_bothan_01_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ig88_bothan_01_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ig88_bothan_01_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ig88_bothan_01_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ig88_bothan_01_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ig88_bothan_01_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ig88_bothan_01_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
