...
public class naboo_legacy_lt_maximilian_vox extends script.base_script
{
    ...
    public boolean naboo_legacy_lt_maximilian_vox_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean naboo_legacy_lt_maximilian_vox_condition_kickQuestActive_Imp(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_legacy_lt_maximilian_vox_condition_kickQuestActive_Rebel(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_legacy_lt_maximilian_vox_condition_seekingDroidParts_Imp(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_legacy_lt_maximilian_vox_condition_seekingRSFComputerAccess(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_legacy_lt_maximilian_vox_condition_hasAllDroidParts_Imp(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_legacy_lt_maximilian_vox_condition_seekingDroidParts_Rebel(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_legacy_lt_maximilian_vox_condition_hasAllDroidParts_Rebel(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_legacy_lt_maximilian_vox_condition_onPanakaQuest_Rebel(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_legacy_lt_maximilian_vox_condition_onPanakaQuest_Imp(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_legacy_lt_maximilian_vox_condition_completedNaboo_Imp(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "legacy_naboo_imperial_final_reward");
    }
    public boolean naboo_legacy_lt_maximilian_vox_condition_completedNaboo_Rebel(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "legacy_naboo_rebel_final_reward");
    }
    public void naboo_legacy_lt_maximilian_vox_action_grantKadaaraQuest(obj_id player, obj_id npc)
    {
    ...
    public void naboo_legacy_lt_maximilian_vox_action_givePointerToCorellia(obj_id player, obj_id npc)
    {
    ...
    public void naboo_legacy_lt_maximilian_vox_action_grantFinalReward_Imp(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, content.REBEL_PATH_OBJVAR_NAME))
        {
            removeObjVar(player, content.REBEL_PATH_OBJVAR_NAME);
    ...
    public void naboo_legacy_lt_maximilian_vox_action_endFindDroidParts(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "returnToImperilOrRebelContact");
    }
    public void naboo_legacy_lt_maximilian_vox_action_endGotoKadaara(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "naboo_from_tatooine_kick");
    }
    public int naboo_legacy_lt_maximilian_vox_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_legacy_lt_maximilian_vox_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_legacy_lt_maximilian_vox_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_legacy_lt_maximilian_vox_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_legacy_lt_maximilian_vox_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_59"))
        {
            if (naboo_legacy_lt_maximilian_vox_condition__defaultCondition(player, npc))
    ...
    public int naboo_legacy_lt_maximilian_vox_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_legacy_lt_maximilian_vox_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_legacy_lt_maximilian_vox_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_legacy_lt_maximilian_vox_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_legacy_lt_maximilian_vox_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
