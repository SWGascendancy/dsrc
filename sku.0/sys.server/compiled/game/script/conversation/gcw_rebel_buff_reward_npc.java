...
public class gcw_rebel_buff_reward_npc extends script.base_script
{
    ...
    public boolean gcw_rebel_buff_reward_npc_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean gcw_rebel_buff_reward_npc_condition_playerRebel(obj_id player, obj_id npc)
    {
    ...
    public int gcw_rebel_buff_reward_npc_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
