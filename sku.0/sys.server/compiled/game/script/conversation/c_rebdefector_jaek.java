...
public class c_rebdefector_jaek extends script.base_script
{
    ...
    public boolean c_rebdefector_jaek_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_rebdefector_jaek_condition_isEnemyFaction(obj_id player, obj_id npc)
    {
    ...
    public boolean c_rebdefector_jaek_condition_isFriendlyFaction(obj_id player, obj_id npc)
    {
    ...
    public boolean c_rebdefector_jaek_condition_isNeutralFaction(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/c_rebdefector");
        boolean onQuest = questIsQuestActive(questId1, player) || questIsQuestComplete(questId1, player);
    ...
    public boolean c_rebdefector_jaek_condition_questIsComplete(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/c_rebdefector");
        boolean doneQuest = questIsQuestComplete(questId1, player);
        return doneQuest;
    }
    public boolean c_rebdefector_jaek_condition_questIsActive(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/c_rebdefector");
        boolean onQuest = questIsQuestActive(questId1, player);
        return onQuest;
    }
    public void c_rebdefector_jaek_action_givequest(obj_id player, obj_id npc)
    {
    ...
    public void c_rebdefector_jaek_action_faceplayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int c_rebdefector_jaek_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_rebdefector_jaek_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_rebdefector_jaek_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_rebdefector_jaek_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_rebdefector_jaek_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
