...
public class hx_138 extends script.base_script
{
    ...
    public boolean hx_138_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean hx_138_condition_firstMeeting(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean hx_138_condition_hasRescueQuestActive(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean hx_138_condition_failedRescueOne(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isQuestActive(player, "outbreak_quest_rescue_01_fail");
    }
    public boolean hx_138_condition_failedRescueTwo(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isQuestActive(player, "outbreak_quest_rescue_02_fail");
    }
    public boolean hx_138_condition_failedRescueThree(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isQuestActive(player, "outbreak_quest_rescue_03_fail");
    }
    public boolean hx_138_condition_failedRescueFour(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isQuestActive(player, "outbreak_quest_rescue_04_fail");
    }
    public boolean hx_138_condition_successRescueOne(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isQuestActive(player, "outbreak_quest_rescue_01_success");
    }
    public boolean hx_138_condition_successRescueTwo(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isQuestActive(player, "outbreak_quest_rescue_02_success");
    }
    public boolean hx_138_condition_successRescueThree(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isQuestActive(player, "outbreak_quest_rescue_03_success");
    }
    public boolean hx_138_condition_successRescueFour(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isQuestActive(player, "outbreak_quest_rescue_04_success");
    }
    public boolean hx_138_condition_hasShuttlePartQuestActive(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isQuestActive(player, "outbreak_quest_shuttle_parts");
    }
    public boolean hx_138_condition_isStuckRescuing(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean hx_138_condition_finishedRescueCanceledShuttle(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean hx_138_condition_hasShuttlePartsNotMechanic(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "outbreak_quest_shuttle_parts", "deliverMechanic");
    }
    public boolean hx_138_condition_isImperialQuestPlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.hasCompletedQuest(player, "outbreak_quest_02_imperial");
    }
    public boolean hx_138_condition_isRebelQuestPlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.hasCompletedQuest(player, "outbreak_quest_02_rebel");
    }
    public boolean hx_138_condition_isNeutralQuestPlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.hasCompletedQuest(player, "outbreak_quest_02_neutral");
    }
    public boolean hx_138_condition_hasGivenPartsMechanic(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "outbreak_quest_shuttle_parts", "seeHX138");
    }
    public boolean hx_138_condition_readyFirstRescue(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean hx_138_condition_hasFinishedShuttleParts(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.hasCompletedQuest(player, "outbreak_quest_shuttle_parts");
    }
    public boolean hx_138_condition_isPlayerGodMode(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return isGod(player);
    }
    public boolean hx_138_condition_hasCompletedRescue3Del4(obj_id player, obj_id npc)
    {
    ...
    public boolean hx_138_condition_hasCompletedRescue2Del3(obj_id player, obj_id npc)
    {
    ...
    public boolean hx_138_condition_hasCompletedRescue1Del2(obj_id player, obj_id npc)
    {
    ...
    public boolean hx_138_condition_isOnDungeonMissions(obj_id player, obj_id npc)
    {
        String faction = "";
    ...
    public boolean hx_138_condition_shuttleEscape(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean hx_138_condition_hasCompletedRescue4DelShuttle(obj_id player, obj_id npc)
    {
    ...
    public boolean hx_138_condition_hasRadio(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "outbreak_radio_delivery_03", "findEpsilonContact");
    }
    public void hx_138_action_sendSignalMetHX138(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        groundquests.sendSignal(player, "playerFoundStormtroopers");
    }
    public void hx_138_action_resetRescueOne(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public void hx_138_action_giveSecondSurvivorQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public void hx_138_action_giveThirdSurvivorQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public void hx_138_action_giveFourthSurvivorQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public void hx_138_action_resetRescueTwo(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public void hx_138_action_resetRescueThree(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public void hx_138_action_resetRescueFour(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public void hx_138_action_fixPlayerRescueQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public void hx_138_action_finishRescueGiveShuttleQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        groundquests.clearQuest(player, "outbreak_quest_rescue_04_success");
        hx_138_action_giveShuttleQuest(player, npc);
    }
    public void hx_138_action_giveShuttleQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        groundquests.grantQuest(player, "outbreak_quest_shuttle_parts");
    }
    public void hx_138_action_finishShuttleParts(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        groundquests.sendSignal(player, "deliveredShuttleSupplies");
    }
    public void hx_138_action_giveFirstSurvivorQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        int randNum = rand(1, 4);
        if (randNum <= 0 || randNum > 4)
    ...
    public void hx_138_action_giveRandomInquisitorQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public void hx_138_action_giveInquisitorQuestOne(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        if (groundquests.hasCompletedQuest(player, "outbreak_quest_02_imperial"))
        {
    ...
    public void hx_138_action_giveInquisitorQuestTwo(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        if (groundquests.hasCompletedQuest(player, "outbreak_quest_02_imperial"))
        {
    ...
    public void hx_138_action_giveInquisitorQuestFive(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        if (groundquests.hasCompletedQuest(player, "outbreak_quest_02_imperial"))
        {
    ...
    public void hx_138_action_giveInquisitorQuestFour(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        if (groundquests.hasCompletedQuest(player, "outbreak_quest_02_imperial"))
        {
    ...
    public void hx_138_action_giveInquisitorQuestThree(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        if (groundquests.hasCompletedQuest(player, "outbreak_quest_02_imperial"))
        {
    ...
    public void hx_138_action_fixRescueGates(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        for (int i = 1; i <= 5; i++)
        {
    ...
    public void hx_138_action_godModeRescue01a(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "outbreak_quest_rescue_01");
    }
    public void hx_138_action_godModeRescue01d(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "outbreak_quest_rescue_07");
    }
    public void hx_138_action_godModeRescue01c(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "outbreak_quest_rescue_06");
    }
    public void hx_138_action_godModeRescue01b(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "outbreak_quest_rescue_05");
    }
    public void hx_138_action_godModeRescue02a(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "outbreak_quest_rescue_02");
    }
    public void hx_138_action_godModeRescue02d(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "outbreak_quest_rescue_010");
    }
    public void hx_138_action_godModeRescue02c(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "outbreak_quest_rescue_09");
    }
    public void hx_138_action_godModeRescue02b(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "outbreak_quest_rescue_08");
    }
    public void hx_138_action_godModeRescue03d(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "outbreak_quest_rescue_013");
    }
    public void hx_138_action_godModeRescue03c(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "outbreak_quest_rescue_012");
    }
    public void hx_138_action_godModeRescue03b(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "outbreak_quest_rescue_011");
    }
    public void hx_138_action_godModeRescue03a(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "outbreak_quest_rescue_03");
    }
    public void hx_138_action_godModeRescue04d(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "outbreak_quest_rescue_016");
    }
    public void hx_138_action_godModeRescue04c(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "outbreak_quest_rescue_015");
    }
    public void hx_138_action_godModeRescue04b(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "outbreak_quest_rescue_014");
    }
    public void hx_138_action_godModeRescue04a(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "outbreak_quest_rescue_04");
    }
    public int hx_138_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int hx_138_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int hx_138_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int hx_138_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int hx_138_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int hx_138_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int hx_138_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int hx_138_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int hx_138_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int hx_138_handleBranch32(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int hx_138_handleBranch34(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int hx_138_handleBranch35(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int hx_138_handleBranch36(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int hx_138_handleBranch37(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int hx_138_handleBranch38(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int hx_138_handleBranch40(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int hx_138_handleBranch42(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int hx_138_handleBranch43(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int hx_138_handleBranch46(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int hx_138_handleBranch51(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int hx_138_handleBranch53(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int hx_138_handleBranch54(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int hx_138_handleBranch56(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int hx_138_handleBranch61(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int hx_138_handleBranch63(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int hx_138_handleBranch65(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int hx_138_handleBranch70(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int hx_138_handleBranch77(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int hx_138_handleBranch78(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int hx_138_handleBranch80(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int hx_138_handleBranch85(obj_id player, obj_id npc, string_id response)
    {
