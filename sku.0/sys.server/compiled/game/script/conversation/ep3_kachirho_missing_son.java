...
public class ep3_kachirho_missing_son extends script.base_script
{
    ...
    public boolean ep3_kachirho_missing_son_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_kachirho_missing_son_condition_isOnQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_kachirho_missing_son");
    }
    public boolean ep3_kachirho_missing_son_condition_hasCompletedMission(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_kachirho_missing_son");
    }
    public boolean ep3_kachirho_missing_son_condition_hasTask01(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_kachirho_missing_son", "tellChatook");
    }
    public boolean ep3_kachirho_missing_son_condition_cannotSpeakWookiee(obj_id player, obj_id npc)
    {
    ...
    public void ep3_kachirho_missing_son_action_grantMission(obj_id player, obj_id npc)
    {
    ...
    public void ep3_kachirho_missing_son_action_doSignal(obj_id player, obj_id npc)
    {
        playClientEffectObj(npc, "clienteffect/voc_wookiee_med_6sec.cef", player, "");
        groundquests.sendSignal(player, "tellSadTaleChatook");
    }
    public void ep3_kachirho_missing_son_action_vocalizeLong(obj_id player, obj_id npc)
    {
        playClientEffectObj(npc, "clienteffect/voc_wookiee_med_6sec.cef", player, "");
    }
    public void ep3_kachirho_missing_son_action_vocalizeMed(obj_id player, obj_id npc)
    {
        playClientEffectObj(npc, "clienteffect/voc_wookiee_med_4sec.cef", player, "");
    }
    public void ep3_kachirho_missing_son_action_vocalizeShort(obj_id player, obj_id npc)
    {
        playClientEffectObj(npc, "clienteffect/voc_wookiee_med_2sec.cef", player, "");
    }
    public void ep3_kachirho_missing_son_action_emoteConfusion(obj_id player, obj_id npc)
    {
        playClientEffectObj(npc, "clienteffect/voc_wookiee_med_4sec.cef", player, "");
        chat.thinkTo(player, player, new string_id("ep3/sidequests", "wke_convo_failure"));
    }
    public int ep3_kachirho_missing_son_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_missing_son_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_missing_son_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_missing_son_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_missing_son_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_missing_son_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_missing_son_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_missing_son_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
