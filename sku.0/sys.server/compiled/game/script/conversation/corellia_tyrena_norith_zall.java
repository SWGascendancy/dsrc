...
public class corellia_tyrena_norith_zall extends script.base_script
{
    ...
    public boolean corellia_tyrena_norith_zall_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_tyrena_norith_zall_condition_completeForgotten(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "corellia_tyrena_forgotten_child");
    }
    public boolean corellia_tyrena_norith_zall_condition_completeMissing(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "corellia_tyrena_missing_persons");
    }
    public boolean corellia_tyrena_norith_zall_condition_onForgotten(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_tyrena_norith_zall_condition_onForgottenReturn(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_tyrena_forgotten_child", "forgotten_return_zorgom");
    }
    public int corellia_tyrena_norith_zall_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_norith_zall_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
