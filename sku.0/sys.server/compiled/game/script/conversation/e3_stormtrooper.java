...
public class e3_stormtrooper extends script.base_script
{
    ...
    public boolean e3_stormtrooper_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public void e3_stormtrooper_action_leaveStarDestroyer(obj_id player, obj_id npc)
    {
