...
public class greeter_coronet_shipwright_indifferent extends script.base_script
{
    ...
    public boolean greeter_coronet_shipwright_indifferent_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean greeter_coronet_shipwright_indifferent_condition_missingShipmentFound(obj_id player, obj_id npc)
    {
    ...
    public int greeter_coronet_shipwright_indifferent_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int greeter_coronet_shipwright_indifferent_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
