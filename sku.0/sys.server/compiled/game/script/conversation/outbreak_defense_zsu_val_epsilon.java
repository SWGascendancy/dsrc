...
public class outbreak_defense_zsu_val_epsilon extends script.base_script
{
    ...
    public boolean outbreak_defense_zsu_val_epsilon_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean outbreak_defense_zsu_val_epsilon_condition_hasCompletedDefenseQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean outbreak_defense_zsu_val_epsilon_condition_isWaitingForRewardSignal(obj_id player, obj_id npc)
    {
    ...
    public boolean outbreak_defense_zsu_val_epsilon_condition_hasNeverSpoken(obj_id player, obj_id npc)
    {
    ...
    public boolean outbreak_defense_zsu_val_epsilon_condition_isGodPlayerTester(obj_id player, obj_id npc)
    {
        return isGod(player);
    }
    public boolean outbreak_defense_zsu_val_epsilon_condition_hasAvailableGuardPosts(obj_id player, obj_id npc)
    {
    ...
    public boolean outbreak_defense_zsu_val_epsilon_condition_levelTooLow(obj_id player, obj_id npc)
    {
        return getLevel(player) < 80;
    }
    public boolean outbreak_defense_zsu_val_epsilon_condition_noAntiVirus(obj_id player, obj_id npc)
    {
    ...
    public boolean outbreak_defense_zsu_val_epsilon_condition_hasDefenseQuest(obj_id player, obj_id npc)
    {
    ...
    public void outbreak_defense_zsu_val_epsilon_action_giveQuest(obj_id player, obj_id npc)
    {
    ...
    public void outbreak_defense_zsu_val_epsilon_action_sendQuestSignal(obj_id player, obj_id npc)
    {
    ...
    public void outbreak_defense_zsu_val_epsilon_action_action0001(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "camp_epsilon_defense_01");
    }
    public void outbreak_defense_zsu_val_epsilon_action_action0002(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "camp_epsilon_defense_02");
    }
    public void outbreak_defense_zsu_val_epsilon_action_action0003(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "camp_epsilon_defense_03");
    }
    public void outbreak_defense_zsu_val_epsilon_action_action0004(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "camp_epsilon_defense_04");
    }
    public int outbreak_defense_zsu_val_epsilon_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_defense_zsu_val_epsilon_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_defense_zsu_val_epsilon_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_defense_zsu_val_epsilon_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_defense_zsu_val_epsilon_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_defense_zsu_val_epsilon_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_defense_zsu_val_epsilon_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
