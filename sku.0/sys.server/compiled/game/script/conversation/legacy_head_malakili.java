...
public class legacy_head_malakili extends script.base_script
{
    ...
    public boolean legacy_head_malakili_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean legacy_head_malakili_condition_onRod(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/legacy_head_rod");
        boolean OnTask = (questIsQuestActive(questId1, player));
        return OnTask;
    }
    public boolean legacy_head_malakili_condition_onThreeTasks(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/legacy_head_rod");
    ...
    public boolean legacy_head_malakili_condition_abandoned(obj_id player, obj_id npc)
    {
    ...
    public boolean legacy_head_malakili_condition_rodCompleted(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/legacy_head_rod");
        boolean OnTask = (questIsQuestComplete(questId1, player));
        return OnTask;
    }
    public void legacy_head_malakili_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void legacy_head_malakili_action_grantRod(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "legacy_head_rod");
    }
    public void legacy_head_malakili_action_signalQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "legacy_head_rod_launch_e2");
    }
    public int legacy_head_malakili_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_head_malakili_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_head_malakili_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_head_malakili_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_head_malakili_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_head_malakili_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_head_malakili_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_head_malakili_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_head_malakili_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_head_malakili_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_head_malakili_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_head_malakili_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
