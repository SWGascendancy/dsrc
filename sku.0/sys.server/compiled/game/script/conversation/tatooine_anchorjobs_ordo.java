...
public class tatooine_anchorjobs_ordo extends script.base_script
{
    ...
    public boolean tatooine_anchorjobs_ordo_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tatooine_anchorjobs_ordo_condition_questAnchorComplete(obj_id player, obj_id npc)
    {
    ...
    public boolean tatooine_anchorjobs_ordo_condition_questBlocked(obj_id player, obj_id npc)
    {
        return groundquests.isQuestDisabled("tatooine_anchorjobs_impcodes");
    }
    public boolean tatooine_anchorjobs_ordo_condition_areSmallDone(obj_id player, obj_id npc)
    {
    ...
    public boolean tatooine_anchorjobs_ordo_condition_legReturn(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "quest/tatooine_anchorjobs_legplus", "tatooine_anchorjobs_legplus_e4");
    }
    public boolean tatooine_anchorjobs_ordo_condition_questBanthaComplete(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "tatooine_anchorjobs_bantha");
    }
    public boolean tatooine_anchorjobs_ordo_condition_questLegComplete(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "tatooine_anchorjobs_leg");
    }
    public boolean tatooine_anchorjobs_ordo_condition_questImpCodesComplete(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "tatooine_anchorjobs_impcodes");
    }
    public boolean tatooine_anchorjobs_ordo_condition_onQuest(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_anchorjobs_bantha");
        int questId2 = questGetQuestId("quest/tatooine_anchorjobs_impcodes");
    ...
    public void tatooine_anchorjobs_ordo_action_questLegGranted(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "tatooine_anchorjobs_leg");
    }
    public void tatooine_anchorjobs_ordo_action_signalLegPlus(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tatooine_anchorjobs_legplus_e4");
    }
    public void tatooine_anchorjobs_ordo_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void tatooine_anchorjobs_ordo_action_questImpcodesGranted(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "tatooine_anchorjobs_impcodes");
    }
    public void tatooine_anchorjobs_ordo_action_questBanthaGranted(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "tatooine_anchorjobs_bantha");
    }
    public int tatooine_anchorjobs_ordo_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_anchorjobs_ordo_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_anchorjobs_ordo_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_anchorjobs_ordo_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_anchorjobs_ordo_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_anchorjobs_ordo_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_anchorjobs_ordo_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_anchorjobs_ordo_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_anchorjobs_ordo_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_anchorjobs_ordo_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_anchorjobs_ordo_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
