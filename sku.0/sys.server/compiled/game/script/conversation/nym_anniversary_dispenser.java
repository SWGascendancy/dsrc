...
public class nym_anniversary_dispenser extends script.base_script
{
    ...
    public boolean nym_anniversary_dispenser_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean nym_anniversary_dispenser_condition_notEligable(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean nym_anniversary_dispenser_condition_newRewardEligable(obj_id player, obj_id npc)
    {
    ...
    public boolean nym_anniversary_dispenser_condition_firstRewardEligable(obj_id player, obj_id npc)
    {
        if (!hasObjVar(player, "event.last_timed_reward"))
        {
            return true;
    ...
    public void nym_anniversary_dispenser_action_randomReward(obj_id player, obj_id npc)
    {
        String[] itemList = 
        {
    ...
    public int nym_anniversary_dispenser_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_anniversary_dispenser_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_anniversary_dispenser_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
