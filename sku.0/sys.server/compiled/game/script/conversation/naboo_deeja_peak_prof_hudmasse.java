...
public class naboo_deeja_peak_prof_hudmasse extends script.base_script
{
    ...
    public boolean naboo_deeja_peak_prof_hudmasse_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean naboo_deeja_peak_prof_hudmasse_condition_sentToProfHudmasse(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_deeja_peak_prof_hudmasse_condition_needsSequencerQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_deeja_peak_prof_hudmasse_condition_completedBeaconAndSequencer(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_deeja_peak_prof_hudmasse_condition_hasDeejaPeakQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_deeja_peak_prof_hudmasse_condition_needsBeaconQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_deeja_peak_prof_hudmasse_condition_hasSequencer(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "naboo_deeja_peak_sequencer_scanner");
    }
    public boolean naboo_deeja_peak_prof_hudmasse_condition_hasBeacon(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "naboo_deeja_peak_beacon_mercs");
    }
    public boolean naboo_deeja_peak_prof_hudmasse_condition_returningWithBeacon(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "naboo_deeja_peak_beacon_mercs", "deeja_peak_beacon_mercs_06");
    }
    public boolean naboo_deeja_peak_prof_hudmasse_condition_returningWithSequencer(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "naboo_deeja_peak_sequencer_scanner", "deeja_peak_sequencer_scanner_07");
    }
    public boolean naboo_deeja_peak_prof_hudmasse_condition_needsModulePt2(obj_id player, obj_id npc)
    {
    ...
    public void naboo_deeja_peak_prof_hudmasse_action_sendToTanoa(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "naboo_deeja_peak_goto_tanoa");
    }
    public void naboo_deeja_peak_prof_hudmasse_action_sendToVance(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "naboo_deeja_peak_goto_vance");
    }
    public void naboo_deeja_peak_prof_hudmasse_action_endGotoProfHudmasse(obj_id player, obj_id npc)
    {
    ...
    public void naboo_deeja_peak_prof_hudmasse_action_endBeacon(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "deeja_peak_beacon_mercs_06");
    }
    public void naboo_deeja_peak_prof_hudmasse_action_endSequencer(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "deeja_peak_sequencer_scanner_07");
    }
    public void naboo_deeja_peak_prof_hudmasse_action_sendToStonewall(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "legacy_naboo_droid_module_3_pt2");
    }
    public int naboo_deeja_peak_prof_hudmasse_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_deeja_peak_prof_hudmasse_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_deeja_peak_prof_hudmasse_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_deeja_peak_prof_hudmasse_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_deeja_peak_prof_hudmasse_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_deeja_peak_prof_hudmasse_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_deeja_peak_prof_hudmasse_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_deeja_peak_prof_hudmasse_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_deeja_peak_prof_hudmasse_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_deeja_peak_prof_hudmasse_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_deeja_peak_prof_hudmasse_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_deeja_peak_prof_hudmasse_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_deeja_peak_prof_hudmasse_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_deeja_peak_prof_hudmasse_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_deeja_peak_prof_hudmasse_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
