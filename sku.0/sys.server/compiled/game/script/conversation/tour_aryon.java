...
public class tour_aryon extends script.base_script
{
    ...
    public boolean tour_aryon_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tour_aryon_condition_electionEnded(obj_id player, obj_id npc)
    {
        return hasObjVar(npc, "bestine.electionEnded");
    }
    public boolean tour_aryon_condition_alreadyVoted(obj_id player, obj_id npc)
    {
    ...
    public boolean tour_aryon_condition_canVoteForVictor(obj_id player, obj_id npc)
    {
    ...
    public boolean tour_aryon_condition_canVoteForSean(obj_id player, obj_id npc)
    {
    ...
    public boolean tour_aryon_condition_canVote(obj_id player, obj_id npc)
    {
    ...
    public boolean tour_aryon_condition_electionStarted(obj_id player, obj_id npc)
    {
        return hasObjVar(npc, "bestine.electionStarted");
    }
    public boolean tour_aryon_condition_seanWon(obj_id player, obj_id npc)
    {
    ...
    public boolean tour_aryon_condition_victorWon(obj_id player, obj_id npc)
    {
        if (hasObjVar(npc, "bestine.electionWinner"))
        {
            String winner = getStringObjVar(npc, "bestine.electionWinner");
    ...
    public boolean tour_aryon_condition_allowTimeLeftRequest(obj_id player, obj_id npc)
    {
    ...
    public boolean tour_aryon_condition_moreThanAWeek(obj_id player, obj_id npc)
    {
        if (hasObjVar(npc, "bestine.electionEnded"))
        {
            if (hasObjVar(npc, "bestine.timeNextElectionStarts"))
    ...
    public boolean tour_aryon_condition_lessThanAWeek(obj_id player, obj_id npc)
    {
        if (hasObjVar(npc, "bestine.electionEnded"))
        {
            if (hasObjVar(npc, "bestine.timeNextElectionStarts"))
    ...
    public boolean tour_aryon_condition_justAFewDays(obj_id player, obj_id npc)
    {
        if (hasObjVar(npc, "bestine.electionEnded"))
        {
            if (hasObjVar(npc, "bestine.timeNextElectionStarts"))
    ...
    public boolean tour_aryon_condition_lessThanADay(obj_id player, obj_id npc)
    {
        if (hasObjVar(npc, "bestine.electionEnded"))
        {
            if (hasObjVar(npc, "bestine.timeNextElectionStarts"))
    ...
    public boolean tour_aryon_condition_moreThan2Weeks(obj_id player, obj_id npc)
    {
        if (hasObjVar(npc, "bestine.electionEnded"))
        {
            if (hasObjVar(npc, "bestine.timeNextElectionStarts"))
    ...
    public boolean tour_aryon_condition_justAFewHours(obj_id player, obj_id npc)
    {
        if (hasObjVar(npc, "bestine.electionEnded"))
        {
            if (hasObjVar(npc, "bestine.timeNextElectionStarts"))
    ...
    public boolean tour_aryon_condition_withinTheHour(obj_id player, obj_id npc)
    {
        if (hasObjVar(npc, "bestine.electionEnded"))
        {
            if (hasObjVar(npc, "bestine.timeNextElectionStarts"))
    ...
    public boolean tour_aryon_condition_moreThanADay(obj_id player, obj_id npc)
    {
        if (hasObjVar(npc, "bestine.electionEnded"))
        {
            if (hasObjVar(npc, "bestine.timeNextElectionStarts"))
    ...
    public void tour_aryon_action_removeSeanEvidence(obj_id player, obj_id npc)
    {
    ...
    public void tour_aryon_action_votedSean(obj_id player, obj_id npc)
    {
        int electionNum = getIntObjVar(npc, "bestine.electionStarted");
    ...
    public void tour_aryon_action_votedVictor(obj_id player, obj_id npc)
    {
        int electionNum = getIntObjVar(npc, "bestine.electionStarted");
    ...
    public void tour_aryon_action_removeVictorEvidence(obj_id player, obj_id npc)
    {
    ...
    public void tour_aryon_action_removeElectionObjVars(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "bestine.campaign"))
        {
    ...
    public int tour_aryon_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tour_aryon_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tour_aryon_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tour_aryon_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tour_aryon_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tour_aryon_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tour_aryon_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tour_aryon_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tour_aryon_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tour_aryon_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tour_aryon_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tour_aryon_handleBranch30(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tour_aryon_handleBranch31(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tour_aryon_handleBranch33(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tour_aryon_handleBranch34(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tour_aryon_handleBranch37(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tour_aryon_handleBranch38(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tour_aryon_handleBranch39(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tour_aryon_handleBranch40(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tour_aryon_handleBranch42(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tour_aryon_handleBranch43(obj_id player, obj_id npc, string_id response)
    {
