...
public class nova_orion_skyron_waurie extends script.base_script
{
    ...
    public boolean nova_orion_skyron_waurie_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean nova_orion_skyron_waurie_condition_qualifiesForSkyronQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "no_rank2_03");
    }
    public boolean nova_orion_skyron_waurie_condition_returnRank2_04(obj_id player, obj_id npc)
    {
    ...
    public boolean nova_orion_skyron_waurie_condition_doneWithSkyron(obj_id player, obj_id npc)
    {
    ...
    public boolean nova_orion_skyron_waurie_condition_onRank2_04(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "no_rank2_04");
    }
    public void nova_orion_skyron_waurie_action_grantRank2_04(obj_id player, obj_id npc)
    {
    ...
    public int nova_orion_skyron_waurie_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nova_orion_skyron_waurie_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
