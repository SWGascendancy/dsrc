...
public class murmur_side_corporate extends script.base_script
{
    ...
    public boolean murmur_side_corporate_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean murmur_side_corporate_condition_onQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "coronet_murmurs_side_3");
    }
    public boolean murmur_side_corporate_condition_completedQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "coronet_murmurs_side_3");
    }
    public boolean murmur_side_corporate_condition_onMurmursMainQuest(obj_id player, obj_id npc)
    {
    ...
    public void murmur_side_corporate_action_grantSideQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "coronet_murmurs_side_3");
    }
    public void murmur_side_corporate_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int murmur_side_corporate_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int murmur_side_corporate_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int murmur_side_corporate_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int murmur_side_corporate_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
