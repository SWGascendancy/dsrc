...
public class ep3_myyydril_refugee extends script.base_script
{
    ...
    public boolean ep3_myyydril_refugee_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_myyydril_refugee_condition_isTaskActiveOne(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_myyydril_refugee_condition_Questdone(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_myyydril_rensalla_1");
    }
    public void ep3_myyydril_refugee_action_giveSignal2(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "finddagger");
    }
    public int ep3_myyydril_refugee_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_refugee_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_refugee_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_refugee_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_refugee_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
