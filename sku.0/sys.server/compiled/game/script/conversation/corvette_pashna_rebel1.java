...
public class corvette_pashna_rebel1 extends script.base_script
{
    ...
    public boolean corvette_pashna_rebel1_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corvette_pashna_rebel1_condition_knowsLocation3(obj_id player, obj_id npc)
    {
        return utils.hasScriptVar(player, "corl_corvette.heardLocation3");
    }
    public boolean corvette_pashna_rebel1_condition_knowsLocation2(obj_id player, obj_id npc)
    {
        return utils.hasScriptVar(player, "corl_corvette.heardLocation2");
    }
    public boolean corvette_pashna_rebel1_condition_knowsLocation1(obj_id player, obj_id npc)
    {
        return utils.hasScriptVar(player, "corl_corvette.heardLocation1");
    }
    public boolean corvette_pashna_rebel1_condition_knowsAllLocations(obj_id player, obj_id npc)
    {
    ...
    public boolean corvette_pashna_rebel1_condition_hasStuff(obj_id player, obj_id npc)
    {
    ...
    public boolean corvette_pashna_rebel1_condition_hasTravelTicket(obj_id player, obj_id npc)
    {
    ...
    public boolean corvette_pashna_rebel1_condition_hasNoObjectsAndNoTicket(obj_id player, obj_id npc)
    {
        return ((!corvette_pashna_rebel1_condition_hasTravelTicket(player, npc)) && (!corvette_pashna_rebel1_condition_hasStuff(player, npc)));
    }
    public boolean corvette_pashna_rebel1_condition_isOnQuest(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "corl_corvette.rebel_assassin");
    }
    public boolean corvette_pashna_rebel1_condition_onDifferentCorvetteQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean corvette_pashna_rebel1_condition_earnedCorvetteReward(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "corvette.rebel_assassin.finished");
    }
    public boolean corvette_pashna_rebel1_condition_hasInventorySpace(obj_id player, obj_id npc)
    {
    ...
    public void corvette_pashna_rebel1_action_heardLocation1(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "corl_corvette.heardLocation1", 1);
        return;
    }
    public void corvette_pashna_rebel1_action_heardLocation2(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "corl_corvette.heardLocation2", 1);
        return;
    }
    public void corvette_pashna_rebel1_action_heardLocation3(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "corl_corvette.heardLocation3", 1);
        return;
    }
    public void corvette_pashna_rebel1_action_acceptsQuest(obj_id player, obj_id npc)
    {
        if (!hasObjVar(player, "corl_corvette.rebel_assassin"))
        {
    ...
    public void corvette_pashna_rebel1_action_clearLocations(obj_id player, obj_id npc)
    {
    ...
    public void corvette_pashna_rebel1_action_giveTicket(obj_id player, obj_id npc)
    {
    ...
    public void corvette_pashna_rebel1_action_takeObject2(obj_id player, obj_id npc)
    {
    ...
    public void corvette_pashna_rebel1_action_takeObject3(obj_id player, obj_id npc)
    {
    ...
    public void corvette_pashna_rebel1_action_removeTicket(obj_id player, obj_id npc)
    {
    ...
    public void corvette_pashna_rebel1_action_quitCorvetteQuest(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "corl_corvette"))
        {
    ...
    public void corvette_pashna_rebel1_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return;
    }
    public void corvette_pashna_rebel1_action_giveCorvetteReward(obj_id player, obj_id npc)
    {
    ...
    public int corvette_pashna_rebel1_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corvette_pashna_rebel1_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corvette_pashna_rebel1_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corvette_pashna_rebel1_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corvette_pashna_rebel1_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corvette_pashna_rebel1_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_bb2081d2"))
        {
            if (corvette_pashna_rebel1_condition__defaultCondition(player, npc))
    ...
    public int corvette_pashna_rebel1_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_bb2081d2"))
        {
            if (corvette_pashna_rebel1_condition__defaultCondition(player, npc))
    ...
    public int corvette_pashna_rebel1_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_bb2081d2"))
        {
            if (corvette_pashna_rebel1_condition__defaultCondition(player, npc))
    ...
    public int corvette_pashna_rebel1_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_bb2081d2"))
        {
            if (corvette_pashna_rebel1_condition__defaultCondition(player, npc))
    ...
    public int corvette_pashna_rebel1_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corvette_pashna_rebel1_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corvette_pashna_rebel1_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corvette_pashna_rebel1_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corvette_pashna_rebel1_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_26d40ca6"))
        {
            if (corvette_pashna_rebel1_condition__defaultCondition(player, npc))
    ...
    public int corvette_pashna_rebel1_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_26d40ca6"))
        {
            if (corvette_pashna_rebel1_condition__defaultCondition(player, npc))
    ...
    public int corvette_pashna_rebel1_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_26d40ca6"))
        {
            if (corvette_pashna_rebel1_condition__defaultCondition(player, npc))
    ...
    public int corvette_pashna_rebel1_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_26d40ca6"))
        {
            if (corvette_pashna_rebel1_condition__defaultCondition(player, npc))
