...
public class npe_officer extends script.base_script
{
    ...
    public boolean npe_officer_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_officer_condition_wantsOff(obj_id player, obj_id npc)
    {
        return npe_officer_condition_isOffTemplate(player, npc);
    }
    public boolean npe_officer_condition_busy(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_officer_condition_completedFirstQuest(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedQuest(player, "npe_officer_try") && !groundquests.hasCompletedQuest(player, "npe_officer_try_2"));
    }
    public boolean npe_officer_condition_quest2Active(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "npe_officer_try_2");
    }
    public boolean npe_officer_condition_isActiveOffQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_officer_condition_finishedOffTask(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_officer_try", "returnAntom");
    }
    public boolean npe_officer_condition_isOffTemplate(obj_id player, obj_id npc)
    {
        return utils.isProfession(player, utils.OFFICER);
    }
    public boolean npe_officer_condition_completedQuest2(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_officer_try_2", "returnFiles");
    }
    public boolean npe_officer_condition_completedAllQuests(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_officer_try_2");
    }
    public void npe_officer_action_giveOffQuest(obj_id player, obj_id npc)
    {
    ...
    public void npe_officer_action_finishQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "returnedAntom");
    }
    public void npe_officer_action_grantPointer(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_pointer_officer_template");
    }
    public void npe_officer_action_grantQuest2(obj_id player, obj_id npc)
    {
    ...
    public void npe_officer_action_foundOfficer(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "found_officer");
    }
    public void npe_officer_action_giveDoneSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "donedone");
        groundquests.sendSignal(player, "found_officer");
    }
    public void npe_officer_action_giveAssistantPointer(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_job_pointer_han");
        setObjVar(player, "npe.finishedTemplate", 1);
    }
    public void npe_officer_action_grantReward2(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "returnedFiles");
    }
    public int npe_officer_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_officer_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_officer_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_officer_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_officer_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_officer_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_officer_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_officer_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_officer_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_officer_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_officer_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_officer_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_officer_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_officer_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
