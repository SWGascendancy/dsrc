...
public class emp_day_pr_officer extends script.base_script
{
    ...
    public boolean emp_day_pr_officer_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean emp_day_pr_officer_condition_isRebel(obj_id player, obj_id npc)
    {
    ...
    public boolean emp_day_pr_officer_condition_onMyTask(obj_id player, obj_id npc)
    {
    ...
    public boolean emp_day_pr_officer_condition_pastMyTask(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/emp_day_imperial");
        int task1 = groundquests.getTaskId(questId, "converseHistorian");
        return questIsQuestComplete(questId, player) || (!questIsTaskActive(questId, task1, player) && questIsQuestActive(questId, player));
    }
    public void emp_day_pr_officer_action_giveQuest(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/emp_day_imperial");
    ...
    public void emp_day_pr_officer_action_giveWaypoint(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "empire_day.waypoint"))
        {
            obj_id oldWaypoint = getObjIdObjVar(player, "empire_day.waypoint");
    ...
    public int emp_day_pr_officer_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_pr_officer_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_pr_officer_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_pr_officer_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_pr_officer_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_pr_officer_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_pr_officer_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
