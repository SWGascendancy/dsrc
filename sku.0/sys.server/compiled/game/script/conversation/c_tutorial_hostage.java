...
public class c_tutorial_hostage extends script.base_script
{
    ...
    public boolean c_tutorial_hostage_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public void c_tutorial_hostage_action_mood(obj_id player, obj_id npc)
    {
