...
public class npe_brawler_bully extends script.base_script
{
    ...
    public boolean npe_brawler_bully_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_brawler_bully_condition_isTaskActiveBully(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_brawler_2", "killdude");
    }
    public boolean npe_brawler_bully_condition_hasCompletedTaskBully(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "npe_brawler_2", "killdude");
    }
    public void npe_brawler_bully_action_giveSignalBully(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_brawler1_bully_signal");
    }
    public void npe_brawler_bully_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int npe_brawler_bully_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brawler_bully_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brawler_bully_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
