...
public class mtp_hideout_col_recruit extends script.base_script
{
    ...
    public boolean mtp_hideout_col_recruit_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean mtp_hideout_col_recruit_condition_collectionNotComplete(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_hideout_col_recruit_condition_checkNeedMoreBooks(obj_id player, obj_id npc)
    {
    ...
    public void mtp_hideout_col_recruit_action_grantBooks(obj_id player, obj_id npc)
    {
    ...
    public void mtp_hideout_col_recruit_action_giveMoreBooks(obj_id player, obj_id npc)
    {
        int itemCount = 0;
        long maxSlotValue = 20;
        obj_id pInv = utils.getInventoryContainer(player);
    ...
    public int mtp_hideout_col_recruit_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_col_recruit_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_col_recruit_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_col_recruit_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_col_recruit_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_col_recruit_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_col_recruit_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_col_recruit_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
