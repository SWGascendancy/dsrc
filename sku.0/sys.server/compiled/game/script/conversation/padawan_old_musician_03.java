...
public class padawan_old_musician_03 extends script.base_script
{
    ...
    public boolean padawan_old_musician_03_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean padawan_old_musician_03_condition_isTrialPlayer(obj_id player, obj_id npc)
    {
    ...
    public void padawan_old_musician_03_action_sendBackToBeginning(obj_id player, obj_id npc)
    {
