...
public class death_watch_insane_miner extends script.base_script
{
    ...
    public boolean death_watch_insane_miner_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean death_watch_insane_miner_condition_startMission(obj_id player, obj_id npc)
    {
    ...
    public boolean death_watch_insane_miner_condition_checkMedicine(obj_id player, obj_id npc)
    {
    ...
    public boolean death_watch_insane_miner_condition_alreadyAccepted(obj_id player, obj_id npc)
    {
    ...
    public boolean death_watch_insane_miner_condition_noMedicine(obj_id player, obj_id npc)
    {
        obj_id objInventory = utils.getInventoryContainer(player);
        if (isIdValid(objInventory))
        {
    ...
    public boolean death_watch_insane_miner_condition_noQuest(obj_id player, obj_id npc)
    {
        if (!hasObjVar(player, "death_watch.drill_01") && !hasObjVar(player, "death_watch.medicine"))
        {
            return true;
    ...
    public void death_watch_insane_miner_action_getMedicine(obj_id player, obj_id npc)
    {
        setObjVar(player, "death_watch.medicine", 1);
        messageTo(npc, "handleCrazedCleanup", null, 1800f, false);
        return;
    }
    public void death_watch_insane_miner_action_removeMedicine(obj_id player, obj_id npc)
    {
        obj_id objInventory = utils.getInventoryContainer(player);
        if (isIdValid(objInventory))
        {
    ...
    public void death_watch_insane_miner_action_giveBattery(obj_id player, obj_id npc)
    {
        obj_id objInventory = utils.getInventoryContainer(player);
        if (isIdValid(objInventory))
        {
    ...
    public void death_watch_insane_miner_action_attackSpeaker(obj_id player, obj_id npc)
    {
    ...
    public int death_watch_insane_miner_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_insane_miner_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_insane_miner_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int death_watch_insane_miner_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
