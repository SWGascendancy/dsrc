...
public class c_rebdefector_allard extends script.base_script
{
    ...
    public boolean c_rebdefector_allard_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_rebdefector_allard_condition_playeronquest(obj_id player, obj_id npc)
    {
    ...
    public void c_rebdefector_allard_action_forwardquest(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/c_rebdefector");
    ...
    public void c_rebdefector_allard_action_faceplayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int c_rebdefector_allard_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_rebdefector_allard_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_rebdefector_allard_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
