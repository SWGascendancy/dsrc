...
public class npe_pilot_training extends script.base_script
{
    ...
    public boolean npe_pilot_training_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_pilot_training_condition_hasFailedTrainMission1(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_pilot_training_condition_isOnMission(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_pilot_training_condition_hasWonTrainMission1(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_pilot_training_condition_startedEasy(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "npe_pilot_easy_1");
    }
    public boolean npe_pilot_training_condition_hasFailedTrainMission2(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_pilot_training_2", "failedTraining_2");
    }
    public boolean npe_pilot_training_condition_hasWonTrainMission2(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_pilot_training_condition_hasFailedTrainMission3(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_pilot_training_3", "failedTraining3");
    }
    public boolean npe_pilot_training_condition_hasWonTrainMission3(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_pilot_training_condition_noShip(obj_id player, obj_id npc)
    {
        return (!space_utils.hasShip(player) && groundquests.isQuestActiveOrComplete(player, "npe_pilot_first_mission_no_ground"));
    }
    public boolean npe_pilot_training_condition_onFirstQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_pilot_training_condition_canTakeQuest(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "npe.finishedTemplate");
    }
    public void npe_pilot_training_action_grantTrainMission1(obj_id player, obj_id npc)
    {
    ...
    public void npe_pilot_training_action_grantTrainMission2(obj_id player, obj_id npc)
    {
    ...
    public void npe_pilot_training_action_grantTrainMission3(obj_id player, obj_id npc)
    {
    ...
    public void npe_pilot_training_action_grantTrainMissionNoGround(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_pilot_first_mission_no_ground");
        if (!hasObjVar(player, npe.QUEST_REWORK_VAR))
        {
    ...
    public void npe_pilot_training_action_grantReward1(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "reported");
    }
    public void npe_pilot_training_action_grantReward2(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "reported");
    }
    public void npe_pilot_training_action_grantReward3(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "reported");
    }
    public void npe_pilot_training_action_grantTalktoLaetin(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_pilot_laetin2");
    }
    public void npe_pilot_training_action_giveShip(obj_id player, obj_id npc)
    {
    ...
    public void npe_pilot_training_action_grantNoviceSkill(obj_id player, obj_id npc)
    {
    ...
    public void npe_pilot_training_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int npe_pilot_training_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_training_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_training_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_training_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_training_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_training_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_training_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_training_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_training_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_training_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_training_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_training_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_training_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_training_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_training_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_training_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
