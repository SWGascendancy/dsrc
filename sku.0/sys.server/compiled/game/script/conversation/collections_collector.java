...
public class collections_collector extends script.base_script
{
    ...
    public boolean collections_collector_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean collections_collector_condition_cantGetMore(obj_id player, obj_id npc)
    {
    ...
    public boolean collections_collector_condition_noMoreCollections(obj_id player, obj_id npc)
    {
        if (hasObjVar(npc, "collection.columnName"))
        {
            String columnName = getStringObjVar(npc, "collection.columnName");
    ...
    public boolean collections_collector_condition_hasCollectionsToRemove(obj_id player, obj_id npc)
    {
        if (hasObjVar(npc, "collection.columnName"))
        {
            String columnName = getStringObjVar(npc, "collection.columnName");
    ...
    public boolean collections_collector_condition_collectorHintEndor(obj_id player, obj_id npc)
    {
    ...
    public boolean collections_collector_condition_collectorHintTatooine(obj_id player, obj_id npc)
    {
        String planetName = getCurrentSceneName();
    ...
    public boolean collections_collector_condition_collectorHintYavin4(obj_id player, obj_id npc)
    {
        String planetName = getCurrentSceneName();
    ...
    public boolean collections_collector_condition_collectorHintAurilia(obj_id player, obj_id npc)
    {
        String planetName = getCurrentSceneName();
    ...
    public boolean collections_collector_condition_durniPhotoConvoStart(obj_id player, obj_id npc)
    {
        return !hasCompletedCollectionSlot(player, "photo_durni_activation");
    }
    public boolean collections_collector_condition_durniPhotoActive(obj_id player, obj_id npc)
    {
    ...
    public boolean collections_collector_condition_completedSlots_hasCamera(obj_id player, obj_id npc)
    {
    ...
    public boolean collections_collector_condition_completedSlots_noCamera(obj_id player, obj_id npc)
    {
        obj_id camera = utils.getStaticItemInInventory(player, "col_photo_camera_02_01");
        if (hasCompletedCollectionSlot(player, "photo_durni_vehement_warrior_01") && hasCompletedCollectionSlot(player, "photo_durni_01") && hasCompletedCollectionSlot(player, "photo_durni_fiendish_01") && hasCompletedCollectionSlot(player, "photo_crazed_durni_01") && !isIdValid(camera))
        {
    ...
    public void collections_collector_action_showRemovalSui(obj_id player, obj_id npc)
    {
        if (hasObjVar(npc, "collection.columnName"))
        {
            String columnName = getStringObjVar(npc, "collection.columnName");
    ...
    public void collections_collector_action_showCollectionSui(obj_id player, obj_id npc)
    {
        if (hasObjVar(npc, "collection.columnName"))
        {
            String columnName = getStringObjVar(npc, "collection.columnName");
    ...
    public void collections_collector_action_grantDurniCamera(obj_id player, obj_id npc)
    {
    ...
    public void collections_collector_action_completeDurniCollection(obj_id player, obj_id npc)
    {
        obj_id camera = utils.getStaticItemInInventory(player, "col_photo_camera_02_01");
        if (hasCompletedCollectionSlot(player, "photo_durni_vehement_warrior_01") && hasCompletedCollectionSlot(player, "photo_durni_01") && hasCompletedCollectionSlot(player, "photo_durni_fiendish_01") && hasCompletedCollectionSlot(player, "photo_crazed_durni_01") && isIdValid(camera))
        {
    ...
    public int collections_collector_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int collections_collector_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int collections_collector_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int collections_collector_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int collections_collector_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int collections_collector_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int collections_collector_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int collections_collector_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
