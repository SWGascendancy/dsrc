...
public class c_ddroid_selan extends script.base_script
{
    ...
    public boolean c_ddroid_selan_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_ddroid_selan_condition_selanStepReady(obj_id player, obj_id npc)
    {
    ...
    public void c_ddroid_selan_action_passalong(obj_id player, obj_id npc)
    {
    ...
    public void c_ddroid_selan_action_faceplayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int c_ddroid_selan_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_ddroid_selan_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_ddroid_selan_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
