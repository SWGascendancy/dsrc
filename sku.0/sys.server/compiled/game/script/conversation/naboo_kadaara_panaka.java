...
public class naboo_kadaara_panaka extends script.base_script
{
    ...
    public boolean naboo_kadaara_panaka_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean naboo_kadaara_panaka_condition_skaak_tipping__3(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "naboo_kadaraa_tipping_the_balance_1", "skaak_tipping_3");
    }
    public boolean naboo_kadaara_panaka_condition_skaak_tipping_10(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_kadaara_panaka_condition_skaak_tipping_4_to_9(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_kadaara_panaka_condition_skaak_tipping_11_to_12(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_kadaara_panaka_condition_shaak_tipping_13(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "naboo_kadaraa_tipping_the_balance_2", "skaak_tipping_13");
    }
    public boolean naboo_kadaara_panaka_condition_needsTypho(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_kadaara_panaka_condition_finishedKadaara(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "naboo_kadaraa_tipping_the_balance_2");
    }
    public void naboo_kadaara_panaka_action_signal_skaak_tipping_10(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "naboo_kadaraa_tipping_the_balance_2");
    }
    public void naboo_kadaara_panaka_action_signal_skaak_tipping_3(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "skaak_tipping_3");
    }
    public void naboo_kadaara_panaka_action_send_to_typho(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "naboo_keren_goto_typho");
        return;
    }
    public void naboo_kadaara_panaka_action_complete_skaak_tipping(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "skaak_tipping_13");
        content.grantRsfSecurityClearance(player);
    }
    public void naboo_kadaara_panaka_action_endTippingPart1(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "skaak_tipping_10");
    }
    public String naboo_kadaara_panaka_tokenTO_playerName(obj_id player, obj_id npc)
    {
        String surname = "";
    ...
    public int naboo_kadaara_panaka_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_kadaara_panaka_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_kadaara_panaka_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_kadaara_panaka_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_kadaara_panaka_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_kadaara_panaka_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_kadaara_panaka_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_kadaara_panaka_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_kadaara_panaka_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_kadaara_panaka_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_kadaara_panaka_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_kadaara_panaka_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_kadaara_panaka_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_kadaara_panaka_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_kadaara_panaka_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
