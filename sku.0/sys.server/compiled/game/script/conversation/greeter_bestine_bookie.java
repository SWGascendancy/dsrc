...
public class greeter_bestine_bookie extends script.base_script
{
    ...
    public boolean greeter_bestine_bookie_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean greeter_bestine_bookie_condition_hasSpaceExpansion(obj_id player, obj_id npc)
    {
        return true;
    }
    public int greeter_bestine_bookie_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
