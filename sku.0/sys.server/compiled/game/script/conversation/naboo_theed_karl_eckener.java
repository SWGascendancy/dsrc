...
public class naboo_theed_karl_eckener extends script.base_script
{
    ...
    public boolean naboo_theed_karl_eckener_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean naboo_theed_karl_eckener_condition_talkToKarl(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_theed_karl_eckener_condition_onRescueQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_theed_karl_eckener_condition_completedDarkwalkerQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_theed_karl_eckener_condition_lastStepRescueQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_theed_karl_eckener_condition_prisonerControlPanelTask(obj_id player, obj_id npc)
    {
    ...
    public void naboo_theed_karl_eckener_action_signal_rescue_01(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "theed_hugo_rescue_01");
    }
    public void naboo_theed_karl_eckener_action_signal_rescue_06(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "theed_hugo_rescue_06");
    }
    public int naboo_theed_karl_eckener_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_karl_eckener_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_karl_eckener_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_karl_eckener_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_karl_eckener_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
