...
public class stap_quest_master_2 extends script.base_script
{
    ...
    public boolean stap_quest_master_2_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean stap_quest_master_2_condition_stapQuestActive(obj_id player, obj_id npc)
    {
    ...
    public void stap_quest_master_2_action_finishTask(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedShipping2");
    }
    public int stap_quest_master_2_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int stap_quest_master_2_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
