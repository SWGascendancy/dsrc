...
public class corellia_tyrena_bannoc_gnoc extends script.base_script
{
    ...
    public boolean corellia_tyrena_bannoc_gnoc_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_tyrena_bannoc_gnoc_condition_onLostReturn(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_tyrena_lost_love", "lost_return_bannoc");
    }
    public boolean corellia_tyrena_bannoc_gnoc_condition_completeMissing(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "corellia_tyrena_missing_persons");
    }
    public boolean corellia_tyrena_bannoc_gnoc_condition_completeLost(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "corellia_tyrena_lost_love");
    }
    public boolean corellia_tyrena_bannoc_gnoc_condition_onLost(obj_id player, obj_id npc)
    {
    ...
    public void corellia_tyrena_bannoc_gnoc_action_signalLostReturn(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "lost_return_bannoc");
    }
    public void corellia_tyrena_bannoc_gnoc_action_grantLost(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "corellia_tyrena_lost_love");
    }
    public int corellia_tyrena_bannoc_gnoc_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_bannoc_gnoc_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_bannoc_gnoc_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_bannoc_gnoc_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_bannoc_gnoc_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_bannoc_gnoc_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_bannoc_gnoc_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_bannoc_gnoc_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_bannoc_gnoc_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_bannoc_gnoc_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_bannoc_gnoc_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_bannoc_gnoc_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_bannoc_gnoc_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
