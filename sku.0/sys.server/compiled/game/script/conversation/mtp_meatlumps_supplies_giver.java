...
public class mtp_meatlumps_supplies_giver extends script.base_script
{
    ...
    public boolean mtp_meatlumps_supplies_giver_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean mtp_meatlumps_supplies_giver_condition_alreadyHasQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "mtp_hideout_instance_recover_supplies");
    }
    public boolean mtp_meatlumps_supplies_giver_condition_returningQuestSuccess(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "mtp_hideout_instance_recover_supplies_success");
    }
    public boolean mtp_meatlumps_supplies_giver_condition_notYetReadyForAnother(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_meatlumps_supplies_giver_condition_returningQuestFailure(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "mtp_hideout_instance_recover_supplies_fail");
    }
    public void mtp_meatlumps_supplies_giver_action_grantSuppliesQuest(obj_id player, obj_id npc)
    {
    ...
    public void mtp_meatlumps_supplies_giver_action_sendSuppliesSuccessSignal(obj_id player, obj_id npc)
    {
    ...
    public void mtp_meatlumps_supplies_giver_action_sendSuppliesFailureSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "mtp_recover_supplies_failed");
    }
    public int mtp_meatlumps_supplies_giver_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
