...
public class quest_hero_of_tatooine_wife extends script.base_script
{
    ...
    public boolean quest_hero_of_tatooine_wife_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean quest_hero_of_tatooine_wife_condition_Quest(obj_id player, obj_id npc)
    {
    ...
    public boolean quest_hero_of_tatooine_wife_condition_AcknowledgeObj(obj_id player, obj_id npc)
    {
        if (!hasObjVar(player, "quest.hero_of_tatooine.honor"))
        {
    ...
    public boolean quest_hero_of_tatooine_wife_condition_DistractWife(obj_id player, obj_id npc)
    {
        if (!hasObjVar(player, "quest.hero_of_tatooine.honor"))
        {
    ...
    public boolean quest_hero_of_tatooine_wife_condition_inProgress(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "quest.hero_of_tatooine.rancherquest"))
        {
    ...
    public boolean quest_hero_of_tatooine_wife_condition_IntercomObj(obj_id player, obj_id npc)
    {
    ...
    public void quest_hero_of_tatooine_wife_action_Acknowledge(obj_id player, obj_id npc)
    {
        setObjVar(player, "quest.hero_of_tatooine.acknowledge", true);
    }
    public void quest_hero_of_tatooine_wife_action_Intercom(obj_id player, obj_id npc)
    {
        setObjVar(player, "quest.hero_of_tatooine.intercom", true);
    }
    public void quest_hero_of_tatooine_wife_action_MessagePirates(obj_id player, obj_id npc)
    {
    ...
    public void quest_hero_of_tatooine_wife_action_Badge(obj_id player, obj_id npc)
    {
    ...
    public int quest_hero_of_tatooine_wife_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_hero_of_tatooine_wife_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_hero_of_tatooine_wife_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_hero_of_tatooine_wife_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_hero_of_tatooine_wife_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_hero_of_tatooine_wife_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
