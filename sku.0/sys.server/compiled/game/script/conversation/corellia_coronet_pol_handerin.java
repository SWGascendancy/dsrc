...
public class corellia_coronet_pol_handerin extends script.base_script
{
    ...
    public boolean corellia_coronet_pol_handerin_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_coronet_pol_handerin_condition_farmAidQuestBegin(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_coronet_capitol_problems_farm_aid", "farm_aid_1");
    }
    public boolean corellia_coronet_pol_handerin_condition_carrionSpatsAllDefeated(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_coronet_capitol_problems_farm_aid", "farm_aid_3");
    }
    public boolean corellia_coronet_pol_handerin_condition_carrionSpatsActive(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_coronet_pol_handerin_condition_gravefeatherActive(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_coronet_pol_handerin_condition_spatsAndGravefeatherActive(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_coronet_pol_handerin_condition_allThreeBanditTasks(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_coronet_pol_handerin_condition_grainAndTrae(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_coronet_pol_handerin_condition_TraeAndBandits(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_coronet_pol_handerin_condition_grainAndBandits(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_coronet_pol_handerin_condition_justGrain(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_coronet_pol_handerin_condition_justTrae(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_coronet_pol_handerin_condition_justBandits(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_coronet_pol_handerin_condition_allBanditTasksComplete(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_coronet_capitol_problems_farm_aid", "farm_aid_5");
    }
    public void corellia_coronet_pol_handerin_action_sendAfterSpats(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "farm_aid_1");
    }
    public void corellia_coronet_pol_handerin_action_sendAfterBandits(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "farm_aid_3");
    }
    public void corellia_coronet_pol_handerin_action_endFarmAid(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "farm_aid_5");
    }
    public int corellia_coronet_pol_handerin_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_pol_handerin_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_pol_handerin_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
