...
public class death_watch_treadwell extends script.base_script
{
    ...
    public boolean death_watch_treadwell_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean death_watch_treadwell_condition_hasBattery(obj_id player, obj_id npc)
    {
    ...
    public void death_watch_treadwell_action__defaultAction(obj_id player, obj_id npc)
    {
    }
    public void death_watch_treadwell_action_fixBattery(obj_id player, obj_id npc)
    {
    ...
    public void death_watch_treadwell_action_vocalize_01(obj_id player, obj_id npc)
    {
        playClientEffectLoc(player, "clienteffect/treadwell_chatter_01.cef", getLocation(npc), 0f);
        return;
    }
    public void death_watch_treadwell_action_vocalize_02(obj_id player, obj_id npc)
    {
        playClientEffectLoc(player, "clienteffect/treadwell_chatter_02.cef", getLocation(npc), 0f);
        return;
    }
