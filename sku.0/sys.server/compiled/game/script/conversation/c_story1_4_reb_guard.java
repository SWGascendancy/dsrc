...
public class c_story1_4_reb_guard extends script.base_script
{
    ...
    public boolean c_story1_4_reb_guard_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_story1_4_reb_guard_condition_onQuestBeforeAttack(obj_id player, obj_id npc)
    {
    ...
    public boolean c_story1_4_reb_guard_condition_onQuestAfterAttack(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/c_story1_4b_rebel");
    ...
    public boolean c_story1_4_reb_guard_condition_doneWithGuard(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/c_story1_4b_rebel");
        int rebel_headguard2 = groundquests.getTaskId(questId1, "rebel_headguard2");
        return questIsTaskComplete(questId1, rebel_headguard2, player);
    }
    public void c_story1_4_reb_guard_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void c_story1_4_reb_guard_action_signalStartAttack(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "c_story1_4b_rebel_guard1");
    }
    public void c_story1_4_reb_guard_action_signalGuardDone(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "c_story1_4b_rebel_guard2");
    }
    public int c_story1_4_reb_guard_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_4_reb_guard_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_4_reb_guard_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_4_reb_guard_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_4_reb_guard_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_4_reb_guard_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_26"))
        {
            if (c_story1_4_reb_guard_condition__defaultCondition(player, npc))
