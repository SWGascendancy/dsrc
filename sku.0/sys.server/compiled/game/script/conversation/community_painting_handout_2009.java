...
public class community_painting_handout_2009 extends script.base_script
{
    ...
    public boolean community_painting_handout_2009_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean community_painting_handout_2009_condition_hasReceivedRebelPainting(obj_id player, obj_id npc)
    {
    ...
    public boolean community_painting_handout_2009_condition_hasReceivedImpPainting(obj_id player, obj_id npc)
    {
    ...
    public boolean community_painting_handout_2009_condition_canReceivePaintings(obj_id player, obj_id npc)
    {
    ...
    public boolean community_painting_handout_2009_condition_hasNone(obj_id player, obj_id npc)
    {
    ...
    public boolean community_painting_handout_2009_condition_not_old_enough(obj_id player, obj_id npc)
    {
        int myAge = getCurrentBirthDate() - getPlayerBirthDate(player);
        if (myAge < 10)
        {
    ...
    public boolean community_painting_handout_2009_condition_hasReceivedBothCommunity(obj_id player, obj_id npc)
    {
    ...
    public void community_painting_handout_2009_action_grantRebelCommunityPainting(obj_id player, obj_id npc)
    {
    ...
    public void community_painting_handout_2009_action_grantImpCommunitylPainting(obj_id player, obj_id npc)
    {
    ...
    public void community_painting_handout_2009_action_grantBothCommunityPaintings(obj_id player, obj_id npc)
    {
        if (!isIdValid(player) || !isIdValid(npc))
        {
            return;
    ...
    public int community_painting_handout_2009_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int community_painting_handout_2009_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int community_painting_handout_2009_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
