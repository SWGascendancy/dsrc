...
public class talus_nashal_agent extends script.base_script
{
    ...
    public boolean talus_nashal_agent_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean talus_nashal_agent_condition_completePreviousArc(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "corellia_39_chirq_council_04");
    }
    public boolean talus_nashal_agent_condition_onFindWeakness(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "talus_nashal_find_weakness");
    }
    public boolean talus_nashal_agent_condition_completeMother(obj_id player, obj_id npc)
    {
    ...
    public boolean talus_nashal_agent_condition_onTalkAgent(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "talus_nashal_rescue_operation", "rescue_op_signal_01_02");
    }
    public boolean talus_nashal_agent_condition_completeRescue(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "talus_nashal_rescue_operation");
    }
    public boolean talus_nashal_agent_condition_onGrimReturn(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "talus_nashal_grim_discovery", "grim_discovery_signal_02_10");
    }
    public boolean talus_nashal_agent_condition_completedGenocideGate(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "talus_dearic_genocide", "genocide_retrieve_01_02");
    }
    public boolean talus_nashal_agent_condition_onGenocideReturn(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "talus_dearic_genocide", "genocide_signal_01_08");
    }
    public boolean talus_nashal_agent_condition_completeGenocide(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "talus_dearic_genocide");
    }
    public boolean talus_nashal_agent_condition_afterTalkAgent(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "talus_nashal_rescue_operation", "rescue_op_signal_01_02");
    }
    public boolean talus_nashal_agent_condition_completeGrimNeedGeno(obj_id player, obj_id npc)
    {
    ...
    public boolean talus_nashal_agent_condition_onGenocide(obj_id player, obj_id npc)
    {
    ...
    public boolean talus_nashal_agent_condition_onDroidBunkerGoto(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "corellia_droid_bunker_legacy_goto");
    }
    public void talus_nashal_agent_action_grantGotoKiki(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "talus_nashal_goto_kiki");
    }
    public void talus_nashal_agent_action_pointerSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "selonian_talk_agent");
    }
    public void talus_nashal_agent_action_grantGotoDathnaeya(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "talus_dearic_goto_dathnaeya");
    }
    public void talus_nashal_agent_action_signalTalkAgent(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "rescue_op_signal_01_02");
    }
    public void talus_nashal_agent_action_grantDeletedQuest(obj_id player, obj_id npc)
    {
    ...
    public void talus_nashal_agent_action_grimSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "grim_discovery_signal_02_10");
    }
    public void talus_nashal_agent_action_grantGenocide(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "talus_dearic_genocide");
    }
    public void talus_nashal_agent_action_grantBetterGenetics(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "talus_dearic_better_genetics");
    }
    public void talus_nashal_agent_action_grantPleaPity(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "talus_dearic_plea_pity");
    }
    public void talus_nashal_agent_action_grantFindSource(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "talus_dearic_find_source");
    }
    public void talus_nashal_agent_action_signalGenocideReward(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "genocide_signal_01_08");
    }
    public void talus_nashal_agent_action_grantDroidBunkerQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "corellia_droid_bunker_legacy_goto");
    }
    public int talus_nashal_agent_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_agent_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_agent_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_agent_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_agent_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_agent_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_agent_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_agent_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_agent_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_agent_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_296"))
        {
            if (talus_nashal_agent_condition__defaultCondition(player, npc))
    ...
    public int talus_nashal_agent_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_agent_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_296"))
        {
            if (talus_nashal_agent_condition__defaultCondition(player, npc))
    ...
    public int talus_nashal_agent_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_agent_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_296"))
        {
            if (talus_nashal_agent_condition__defaultCondition(player, npc))
    ...
    public int talus_nashal_agent_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_agent_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_agent_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_agent_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_agent_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_agent_handleBranch31(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_agent_handleBranch35(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_agent_handleBranch36(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_agent_handleBranch37(obj_id player, obj_id npc, string_id response)
    {
