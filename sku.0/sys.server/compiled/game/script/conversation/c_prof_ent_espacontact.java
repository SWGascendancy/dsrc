...
public class c_prof_ent_espacontact extends script.base_script
{
    ...
    public boolean c_prof_ent_espacontact_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_prof_ent_espacontact_condition_onQuestTaskMale(obj_id player, obj_id npc)
    {
    ...
    public boolean c_prof_ent_espacontact_condition_onQuestTaskFemale(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/c_prof_entertainer");
        int espaContact = groundquests.getTaskId(questId1, "espaContact");
        int gender = getGender(player);
    ...
    public boolean c_prof_ent_espacontact_condition_taskDoneFemale(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/c_prof_entertainer");
        int espaContact = groundquests.getTaskId(questId1, "espaContact");
        int gender = getGender(player);
    ...
    public boolean c_prof_ent_espacontact_condition_taskDoneMale(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/c_prof_entertainer");
        int espaContact = groundquests.getTaskId(questId1, "espaContact");
        int gender = getGender(player);
    ...
    public void c_prof_ent_espacontact_action_forwardquest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "c_prof_ent_espa");
    }
    public void c_prof_ent_espacontact_action_faceplayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void c_prof_ent_espacontact_action_setMoodInterested(obj_id player, obj_id npc)
    {
        ai_lib.setMood(npc, chat.MOOD_INTERESTED);
    }
    public void c_prof_ent_espacontact_action_setMoodFriendly(obj_id player, obj_id npc)
    {
        ai_lib.setMood(npc, chat.MOOD_FRIENDLY);
    }
    public void c_prof_ent_espacontact_action_setMoodFirm(obj_id player, obj_id npc)
    {
        ai_lib.setMood(npc, chat.MOOD_FIRM);
    }
    public int c_prof_ent_espacontact_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_prof_ent_espacontact_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_prof_ent_espacontact_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_prof_ent_espacontact_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_prof_ent_espacontact_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_prof_ent_espacontact_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_prof_ent_espacontact_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_prof_ent_espacontact_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_prof_ent_espacontact_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_prof_ent_espacontact_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_prof_ent_espacontact_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_prof_ent_espacontact_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_prof_ent_espacontact_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_prof_ent_espacontact_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
