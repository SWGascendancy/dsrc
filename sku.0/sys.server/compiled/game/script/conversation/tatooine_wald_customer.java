...
public class tatooine_wald_customer extends script.base_script
{
    ...
    public boolean tatooine_wald_customer_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tatooine_wald_customer_condition_task_2_3_active(obj_id player, obj_id npc)
    {
    ...
    public boolean tatooine_wald_customer_condition_task2_active(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "tatooine_wald_firstquest", "tatooine_wald_firstquest_laserflits_DML");
    }
    public boolean tatooine_wald_customer_condition_del_swp_pts_active(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "tatooine_wald_firstquest", "tatooine_wald_firstquest_deliver_swoop_parts_WFS");
    }
    public boolean tatooine_wald_customer_condition_task3_active(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "tatooine_wald_firstquest", "tatooine_wald_firstquest_engineparts_WFS");
    }
    public boolean tatooine_wald_customer_condition_quest_complete(obj_id player, obj_id npc)
    {
    ...
    public void tatooine_wald_customer_action_send_signal_3(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tatooine_wald_firstquest_engineparts_aquired");
    }
    public void tatooine_wald_customer_action_send_signal_2(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tatooine_wald_firstquest_engineparts_aquired");
    }
    public void tatooine_wald_customer_action_send_signal_4(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "swoop_parts_delivered");
    }
    public int tatooine_wald_customer_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_wald_customer_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_wald_customer_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_wald_customer_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_wald_customer_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
