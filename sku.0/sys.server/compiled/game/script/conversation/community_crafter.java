...
public class community_crafter extends script.base_script
{
    ...
    public boolean community_crafter_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean community_crafter_condition_isPlayerCommunityCrafting(obj_id player, obj_id npc)
    {
    ...
    public boolean community_crafter_condition_isCommunityCraftingEnabled(obj_id player, obj_id npc)
    {
        obj_id craftingTracker = getObjIdObjVar(npc, OBJVAR_CRAFTING_TRACKER);
        if (isIdValid(craftingTracker))
        {
    ...
    public boolean community_crafter_condition_canAddPlayer(obj_id player, obj_id npc)
    {
        obj_id craftingTracker = getObjIdObjVar(npc, OBJVAR_CRAFTING_TRACKER);
        if (isIdValid(craftingTracker))
        {
    ...
    public boolean community_crafter_condition_isTrackingQuality(obj_id player, obj_id npc)
    {
        return utils.getBooleanScriptVar(npc, SCRIPTVAR_TRACKING_QUALITY);
    }
    public boolean community_crafter_condition_isTrackingQuantity(obj_id player, obj_id npc)
    {
        return utils.getBooleanScriptVar(npc, SCRIPTVAR_TRACKING_QUANTITY);
    }
    public boolean community_crafter_condition_isTrackingSlots(obj_id player, obj_id npc)
    {
        return utils.getBooleanScriptVar(npc, SCRIPTVAR_TRACKING_SLOTS);
    }
    public boolean community_crafter_condition_hasSlot1(obj_id player, obj_id npc)
    {
        return getNumSlots(npc) >= 1;
    }
    public boolean community_crafter_condition_hasSlot2(obj_id player, obj_id npc)
    {
        return getNumSlots(npc) >= 2;
    }
    public boolean community_crafter_condition_hasSlot3(obj_id player, obj_id npc)
    {
        return getNumSlots(npc) >= 3;
    }
    public boolean community_crafter_condition_hasSlot4(obj_id player, obj_id npc)
    {
        return getNumSlots(npc) >= 4;
    }
    public boolean community_crafter_condition_hasSlot5(obj_id player, obj_id npc)
    {
        return getNumSlots(npc) >= 5;
    }
    public boolean community_crafter_condition_hasSlot6(obj_id player, obj_id npc)
    {
        return getNumSlots(npc) >= 6;
    }
    public boolean community_crafter_condition_hasSlot7(obj_id player, obj_id npc)
    {
        return getNumSlots(npc) >= 7;
    }
    public boolean community_crafter_condition_hasSlot8(obj_id player, obj_id npc)
    {
        return getNumSlots(npc) >= 8;
    }
    public boolean community_crafter_condition_hasSlot9(obj_id player, obj_id npc)
    {
        return getNumSlots(npc) >= 9;
    }
    public boolean community_crafter_condition_hasSlot10(obj_id player, obj_id npc)
    {
        return getNumSlots(npc) >= 10;
    }
    public void community_crafter_action_addPlayerToProject(obj_id player, obj_id npc)
    {
        obj_id craftingTracker = getObjIdObjVar(npc, OBJVAR_CRAFTING_TRACKER);
        if (isIdValid(craftingTracker))
        {
    ...
    public void community_crafter_action_openMyInventoryToPlayer(obj_id player, obj_id npc)
    {
    ...
    public void community_crafter_action_showPlayerSlot1Quality(obj_id player, obj_id npc)
    {
        showPlayerProjectStats(npc, player, 1, true);
    }
    public void community_crafter_action_showPlayerProjectAttributes(obj_id player, obj_id npc)
    {
        showPlayerProjectAttribs(npc, player);
    }
    public void community_crafter_action_showPlayerSlot2Quality(obj_id player, obj_id npc)
    {
        showPlayerProjectStats(npc, player, 2, true);
    }
    public void community_crafter_action_showPlayerSlot4Quality(obj_id player, obj_id npc)
    {
        showPlayerProjectStats(npc, player, 4, true);
    }
    public void community_crafter_action_showPlayerSlot5Quality(obj_id player, obj_id npc)
    {
        showPlayerProjectStats(npc, player, 5, true);
    }
    public void community_crafter_action_showPlayerSlot6Quality(obj_id player, obj_id npc)
    {
        showPlayerProjectStats(npc, player, 6, true);
    }
    public void community_crafter_action_showPlayerSlot7Quality(obj_id player, obj_id npc)
    {
        showPlayerProjectStats(npc, player, 7, true);
    }
    public void community_crafter_action_showPlayerSlot8Quality(obj_id player, obj_id npc)
    {
        showPlayerProjectStats(npc, player, 8, true);
    }
    public void community_crafter_action_showPlayerSlot9Quality(obj_id player, obj_id npc)
    {
        showPlayerProjectStats(npc, player, 9, true);
    }
    public void community_crafter_action_showPlayerSlot10Quality(obj_id player, obj_id npc)
    {
        showPlayerProjectStats(npc, player, 10, true);
    }
    public void community_crafter_action_showPlayerProjectQuality(obj_id player, obj_id npc)
    {
        showPlayerProjectStats(npc, player, 0, true);
    }
    public void community_crafter_action_showPlayerSlot3Quality(obj_id player, obj_id npc)
    {
        showPlayerProjectStats(npc, player, 3, true);
    }
    public void community_crafter_action_showPlayerSlot1Quantity(obj_id player, obj_id npc)
    {
        showPlayerProjectStats(npc, player, 1, false);
    }
    public void community_crafter_action_showPlayerSlot2Quantity(obj_id player, obj_id npc)
    {
        showPlayerProjectStats(npc, player, 2, false);
    }
    public void community_crafter_action_showPlayerSlot4Quantity(obj_id player, obj_id npc)
    {
        showPlayerProjectStats(npc, player, 4, false);
    }
    public void community_crafter_action_showPlayerSlot5Quantity(obj_id player, obj_id npc)
    {
        showPlayerProjectStats(npc, player, 5, false);
    }
    public void community_crafter_action_showPlayerSlot6Quantity(obj_id player, obj_id npc)
    {
        showPlayerProjectStats(npc, player, 6, false);
    }
    public void community_crafter_action_showPlayerSlot7Quantity(obj_id player, obj_id npc)
    {
        showPlayerProjectStats(npc, player, 7, false);
    }
    public void community_crafter_action_showPlayerSlot8Quantity(obj_id player, obj_id npc)
    {
        showPlayerProjectStats(npc, player, 8, false);
    }
    public void community_crafter_action_showPlayerSlot9Quantity(obj_id player, obj_id npc)
    {
        showPlayerProjectStats(npc, player, 9, false);
    }
    public void community_crafter_action_showPlayerSlot10Quantity(obj_id player, obj_id npc)
    {
        showPlayerProjectStats(npc, player, 10, false);
    }
    public void community_crafter_action_showPlayerProjectQuantity(obj_id player, obj_id npc)
    {
        showPlayerProjectStats(npc, player, 0, false);
    }
    public void community_crafter_action_showPlayerSlot3Quantity(obj_id player, obj_id npc)
    {
    ...
    public void initializeMe(obj_id self)
    {
    ...
    public void cacheProjectData(obj_id self)
    {
    ...
    public int getNumSlots(obj_id self)
    {
        return utils.getIntScriptVar(self, SCRIPTVAR_TRACKING_NUM_SLOTS);
    }
    public void showPlayerProjectAttribs(obj_id self, obj_id player)
    {
        if (community_crafter_condition_isCommunityCraftingEnabled(obj_id.NULL_ID, self))
        {
            obj_id craftingTracker = getObjIdObjVar(self, OBJVAR_CRAFTING_TRACKER);
    ...
    public void showPlayerProjectStats(obj_id self, obj_id player, int slot, boolean quality)
    {
        if (community_crafter_condition_isCommunityCraftingEnabled(obj_id.NULL_ID, self))
        {
            obj_id craftingTracker = getObjIdObjVar(self, OBJVAR_CRAFTING_TRACKER);
