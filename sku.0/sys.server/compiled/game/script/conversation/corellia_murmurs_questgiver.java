...
public class corellia_murmurs_questgiver extends script.base_script
{
    ...
    public boolean corellia_murmurs_questgiver_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_murmurs_questgiver_condition_playerCompletedInitialStep(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "coronet_murmurs_1_smuggler");
    }
    public boolean corellia_murmurs_questgiver_condition_hasPointer(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "corellia_cb_1_pointer") || groundquests.isQuestActiveOrComplete(player, "corellia_cb_1");
    }
    public boolean corellia_murmurs_questgiver_condition_playerDeletedQ2(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_murmurs_questgiver_condition_playerDeletedQ3(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_murmurs_questgiver_condition_finishedAll(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "coronet_murmurs_7_reward");
    }
    public boolean corellia_murmurs_questgiver_condition_playerDeletedQ4(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_murmurs_questgiver_condition_playerDeletedQ5(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_murmurs_questgiver_condition_playerDeletedQ6(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_murmurs_questgiver_condition_playerOnFinalStep(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "coronet_murmurs_7_reward", "returntojoth");
    }
    public boolean corellia_murmurs_questgiver_condition_playerDeletedQ7(obj_id player, obj_id npc)
    {
    ...
    public void corellia_murmurs_questgiver_action_giveFirstQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "coronet_murmurs_1_smuggler");
    }
    public void corellia_murmurs_questgiver_action_giveSecondQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "coronet_murmurs_2_gatherinfo");
    }
    public void corellia_murmurs_questgiver_action_giveThirdQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "coronet_murmurs_3_miniboss");
    }
    public void corellia_murmurs_questgiver_action_giveFourthQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "coronet_murmurs_4_lab");
    }
    public void corellia_murmurs_questgiver_action_giveNextSeriesPointer(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "corellia_cb_1_pointer");
    }
    public void corellia_murmurs_questgiver_action_giveFifthQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "coronet_murmurs_5_gas");
    }
    public void corellia_murmurs_questgiver_action_giveSixthQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "coronet_murmurs_6_zoo");
    }
    public void corellia_murmurs_questgiver_action_signalRewardQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "coronet_murmurs_7_reward_signal");
    }
    public void corellia_murmurs_questgiver_action_giveSeventhQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "coronet_murmurs_7_reward");
    }
    public void corellia_murmurs_questgiver_action_signalGotoQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "goto_talktojoth");
    }
    public int corellia_murmurs_questgiver_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_murmurs_questgiver_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_murmurs_questgiver_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_28"))
        {
            if (corellia_murmurs_questgiver_condition__defaultCondition(player, npc))
    ...
    public int corellia_murmurs_questgiver_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_murmurs_questgiver_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_murmurs_questgiver_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
