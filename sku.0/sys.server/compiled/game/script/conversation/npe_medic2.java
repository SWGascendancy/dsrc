...
public class npe_medic2 extends script.base_script
{
    ...
    public boolean npe_medic2_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_medic2_condition_needsNewPack(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_medic2_condition_onEntQuest(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_prof_entertainer2", "play");
    }
    public boolean npe_medic2_condition_hasPilot(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "npe.hasMetSerissu");
    }
    public boolean npe_medic2_condition_wantsMedic(obj_id player, obj_id npc)
    {
        return (npe_medic2_condition_isMedTemplate(player, npc) && !groundquests.isQuestActiveOrComplete(player, "npe_medic2"));
    }
    public boolean npe_medic2_condition_hasPack(obj_id player, obj_id npc)
    {
        obj_id[] playerStuff = getInventoryAndEquipment(player);
        for (int i = 0; i < playerStuff.length; i++)
        {
    ...
    public boolean npe_medic2_condition_busy(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_medic2_condition_finishedGather(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_medic2", "return2");
    }
    public boolean npe_medic2_condition_finishedLastTask(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_medic2", "final_return");
    }
    public boolean npe_medic2_condition_fromMedic(obj_id player, obj_id npc)
    {
        return (groundquests.isQuestActive(player, "npe_pointer_med_template") && groundquests.hasCompletedQuest(player, "npe_medic"));
    }
    public boolean npe_medic2_condition_finishedMedTask(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_medic2", "return1");
    }
    public boolean npe_medic2_condition_isMedTemplate(obj_id player, obj_id npc)
    {
    ...
    public void npe_medic2_action_giveMedQuest(obj_id player, obj_id npc)
    {
    ...
    public void npe_medic2_action_giveReward(obj_id player, obj_id npc)
    {
    ...
    public void npe_medic2_action_giveAjaPointer(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_pointer_medic");
        groundquests.sendSignal(player, "found_medic");
    }
    public void npe_medic2_action_giveFirstSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_return_billingsly1");
    }
    public void npe_medic2_action_giveNewPack(obj_id player, obj_id npc)
    {
    ...
    public void npe_medic2_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void npe_medic2_action_giveComm(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_medic_comm", false);
        npe_medic2_action_facePlayer(player, npc);
    }
    public void npe_medic2_action_GiveMedQuestAndPack(obj_id player, obj_id npc)
    {
    ...
    public void npe_medic2_action_give2ndSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_return_billingsly2");
    }
    public int npe_medic2_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_medic2_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_medic2_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_medic2_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_medic2_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_medic2_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_medic2_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_medic2_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_medic2_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_medic2_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_medic2_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_medic2_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_medic2_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_medic2_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_medic2_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
