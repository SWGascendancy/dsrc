...
public class tatooine_entha_draknus extends script.base_script
{
    ...
    public boolean tatooine_entha_draknus_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tatooine_entha_draknus_condition_onTalkedAnKwee(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "tatooine_espa_pod_retrieval_v2", "tat_espa_pod_retrieval_e2");
    }
    public boolean tatooine_entha_draknus_condition_completedQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "talus_nashal_rescue_operation");
    }
    public boolean tatooine_entha_draknus_condition_onRace1(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "tatooine_entha_podracers_race1");
    }
    public boolean tatooine_entha_draknus_condition_completedRace1(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "tatooine_entha_podracers_race1");
    }
    public boolean tatooine_entha_draknus_condition_completedRace2(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "tatooine_entha_podracers_race2");
    }
    public boolean tatooine_entha_draknus_condition_completedRace3(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "tatooine_entha_podracers_race3");
    }
    public boolean tatooine_entha_draknus_condition_onRace2(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "tatooine_entha_podracers_race2");
    }
    public boolean tatooine_entha_draknus_condition_onRace3(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "tatooine_entha_podracers_race3");
    }
    public boolean tatooine_entha_draknus_condition_completedPod(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "tatooine_espa_pod_retrieval_v2");
    }
    public boolean tatooine_entha_draknus_condition_skip3(obj_id player, obj_id npc)
    {
        return false;
    }
    public boolean tatooine_entha_draknus_condition_skip2(obj_id player, obj_id npc)
    {
        return false;
    }
    public boolean tatooine_entha_draknus_condition_skip1(obj_id player, obj_id npc)
    {
        return false;
    }
    public void tatooine_entha_draknus_action_grantRace1(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "tatooine_entha_podracers_race1");
    }
    public void tatooine_entha_draknus_action_grantRace2(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "tatooine_entha_podracers_race2");
    }
    public void tatooine_entha_draknus_action_grantRace3(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "tatooine_entha_podracers_race3");
    }
    public void tatooine_entha_draknus_action_clearRace1(obj_id player, obj_id npc)
    {
        groundquests.clearQuest(player, "tatooine_entha_podracers_race1");
    }
    public void tatooine_entha_draknus_action_clearRace2(obj_id player, obj_id npc)
    {
        groundquests.clearQuest(player, "tatooine_entha_podracers_race2");
    }
    public void tatooine_entha_draknus_action_clearRace3(obj_id player, obj_id npc)
    {
        groundquests.clearQuest(player, "tatooine_entha_podracers_race3");
    }
    public void tatooine_entha_draknus_action_signalGotoDraknus(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tat_entha_goto_draknus_e1");
    }
    public void tatooine_entha_draknus_action_signalReturnDraknus(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tatooine_entha_return_draknus_e1");
    }
    public int tatooine_entha_draknus_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_entha_draknus_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_entha_draknus_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_entha_draknus_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_entha_draknus_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_entha_draknus_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_entha_draknus_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_entha_draknus_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_entha_draknus_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_entha_draknus_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_entha_draknus_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_entha_draknus_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_entha_draknus_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_entha_draknus_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_entha_draknus_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_entha_draknus_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_entha_draknus_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_entha_draknus_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_entha_draknus_handleBranch30(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_entha_draknus_handleBranch32(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_entha_draknus_handleBranch33(obj_id player, obj_id npc, string_id response)
    {
