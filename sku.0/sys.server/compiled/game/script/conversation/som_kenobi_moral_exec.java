...
public class som_kenobi_moral_exec extends script.base_script
{
    ...
    public boolean som_kenobi_moral_exec_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean som_kenobi_moral_exec_condition_defected(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "som_kenobi_moral_choice_1", "switchedSides");
    }
    public boolean som_kenobi_moral_exec_condition_haveCore(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "som_kenobi_moral_choice_1", "gotCore");
    }
    public boolean som_kenobi_moral_exec_condition_done(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "som_kenobi_moral_choice_1");
    }
    public boolean som_kenobi_moral_exec_condition_levelTooLow(obj_id player, obj_id npc)
    {
    ...
    public boolean som_kenobi_moral_exec_condition_onQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "som_kenobi_moral_choice_1");
    }
    public void som_kenobi_moral_exec_action_giveQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "som_kenobi_moral_choice_1");
    }
    public void som_kenobi_moral_exec_action_reward(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "givenCore");
    }
    public int som_kenobi_moral_exec_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_moral_exec_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_moral_exec_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_moral_exec_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_moral_exec_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_moral_exec_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_moral_exec_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_moral_exec_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_moral_exec_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_moral_exec_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_moral_exec_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_moral_exec_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_moral_exec_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
