...
public class tyrena_lyman_zavala extends script.base_script
{
    ...
    public boolean tyrena_lyman_zavala_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tyrena_lyman_zavala_condition_finishedDoolQuests(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "quest/coronet_captain_dool");
    }
    public boolean tyrena_lyman_zavala_condition_doingLymanQuests(obj_id player, obj_id npc)
    {
    ...
    public boolean tyrena_lyman_zavala_condition_waitingForLymanFinish(obj_id player, obj_id npc)
    {
    ...
    public boolean tyrena_lyman_zavala_condition_needTakouhliWaypoint(obj_id player, obj_id npc)
    {
    ...
    public boolean tyrena_lyman_zavala_condition_startedTakouhi(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "quest/tyrena_meet_the_meatlumps");
    }
    public boolean tyrena_lyman_zavala_condition_doingOlagQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean tyrena_lyman_zavala_condition_finishingOlagQuest(obj_id player, obj_id npc)
    {
    ...
    public void tyrena_lyman_zavala_action_grantLymanQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest/tyrena_lyman_evidence");
    }
    public void tyrena_lyman_zavala_action_grantGoToTakouhi(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest/tyrena_goto_takouhi");
    }
    public void tyrena_lyman_zavala_action_completeLymanQuests(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "finishLymanQuest");
    }
    public void tyrena_lyman_zavala_action_sendDoolGotoSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "cameFromDool");
    }
    public void tyrena_lyman_zavala_action_sendOlagDeadSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "olagIsDead");
    }
    public void tyrena_lyman_zavala_action_grantKillOlagQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest/tyrena_lyman_olag_greck");
    }
    public int tyrena_lyman_zavala_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tyrena_lyman_zavala_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tyrena_lyman_zavala_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tyrena_lyman_zavala_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
