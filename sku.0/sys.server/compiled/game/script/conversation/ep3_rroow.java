...
public class ep3_rroow extends script.base_script
{
    ...
    public boolean ep3_rroow_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_rroow_condition_canTakeSeraDeliverQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_rroow_condition_hasSeraDeliverquest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_rroow_sera_package_deliver");
    }
    public boolean ep3_rroow_condition_wookieeNub(obj_id player, obj_id npc)
    {
        return utils.canSpeakWookiee(player, npc);
    }
    public void ep3_rroow_action_grantSeraDeliverQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_rroow_sera_package_deliver");
    }
    public void ep3_rroow_action_doWookieeNub(obj_id player, obj_id npc)
    {
        utils.emoteWookieeConfusion(player, npc);
    }
    public int ep3_rroow_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_rroow_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_rroow_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
