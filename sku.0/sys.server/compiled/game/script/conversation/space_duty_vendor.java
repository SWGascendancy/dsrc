...
public class space_duty_vendor extends script.base_script
{
    ...
    public boolean space_duty_vendor_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean space_duty_vendor_condition_canAffordComp(obj_id player, obj_id npc)
    {
    ...
    public boolean space_duty_vendor_condition_canAffortSchematic(obj_id player, obj_id npc)
    {
    ...
    public void space_duty_vendor_action_setLevel1(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "dutyVendor.level", 1);
    }
    public void space_duty_vendor_action_setLevel2(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "dutyVendor.level", 2);
    }
    public void space_duty_vendor_action_setLevel3(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "dutyVendor.level", 3);
    }
    public void space_duty_vendor_action_setLevel4(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "dutyVendor.level", 4);
    }
    public void space_duty_vendor_action_buyArmor(obj_id player, obj_id npc)
    {
        int level = utils.getIntScriptVar(player, "dutyVendor.level");
    ...
    public void space_duty_vendor_action_setLevel5(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "dutyVendor.level", 5);
    }
    public void space_duty_vendor_action_setLevel6(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "dutyVendor.level", 6);
    }
    public void space_duty_vendor_action_setLevel7(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "dutyVendor.level", 7);
    }
    public void space_duty_vendor_action_setLevel8(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "dutyVendor.level", 8);
    }
    public void space_duty_vendor_action_setLevel9(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "dutyVendor.level", 9);
    }
    public void space_duty_vendor_action_setLevel10(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "dutyVendor.level", 10);
    }
    public void space_duty_vendor_action_buyBooster(obj_id player, obj_id npc)
    {
        int level = utils.getIntScriptVar(player, "dutyVendor.level");
        dictionary params = new dictionary();
        params.put("level", level);
    ...
    public void space_duty_vendor_action_buyWeapCap(obj_id player, obj_id npc)
    {
        int level = utils.getIntScriptVar(player, "dutyVendor.level");
        dictionary params = new dictionary();
        params.put("level", level);
    ...
    public void space_duty_vendor_action_buyWeapon(obj_id player, obj_id npc)
    {
        int level = utils.getIntScriptVar(player, "dutyVendor.level");
        dictionary params = new dictionary();
        params.put("level", level);
    ...
    public void space_duty_vendor_action_buyShield(obj_id player, obj_id npc)
    {
        int level = utils.getIntScriptVar(player, "dutyVendor.level");
        dictionary params = new dictionary();
        params.put("level", level);
    ...
    public void space_duty_vendor_action_buyReactor(obj_id player, obj_id npc)
    {
        int level = utils.getIntScriptVar(player, "dutyVendor.level");
        dictionary params = new dictionary();
        params.put("level", level);
    ...
    public void space_duty_vendor_action_buyEngine(obj_id player, obj_id npc)
    {
        int level = utils.getIntScriptVar(player, "dutyVendor.level");
        dictionary params = new dictionary();
        params.put("level", level);
    ...
    public void space_duty_vendor_action_buyDroidInterface(obj_id player, obj_id npc)
    {
        int level = utils.getIntScriptVar(player, "dutyVendor.level");
        dictionary params = new dictionary();
        params.put("level", level);
    ...
    public void space_duty_vendor_action_buyInterdictionGenerator(obj_id player, obj_id npc)
    {
    ...
    public void space_duty_vendor_action_buyInterfaceScanner(obj_id player, obj_id npc)
    {
        obj_id inventory = utils.getInventoryContainer(player);
    ...
    public String space_duty_vendor_tokenTO_certLevel(obj_id player, obj_id npc)
    {
        String cert = "Certification Level " + (utils.getIntScriptVar(player, "dutyVendor.level"));
        return cert;
    }
    public int space_duty_vendor_tokenDI_DiPrice(obj_id player, obj_id npc)
    {
        int level = utils.getIntScriptVar(player, "dutyVendor.level");
        int price = trial.getSpaceDutyTokenPrice(level);
        return price;
    }
    public int space_duty_vendor_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int space_duty_vendor_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int space_duty_vendor_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int space_duty_vendor_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int space_duty_vendor_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int space_duty_vendor_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int space_duty_vendor_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int space_duty_vendor_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int space_duty_vendor_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int space_duty_vendor_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int space_duty_vendor_handleBranch32(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int space_duty_vendor_handleBranch37(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int space_duty_vendor_handleBranch39(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int space_duty_vendor_handleBranch42(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int space_duty_vendor_handleBranch44(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int space_duty_vendor_handleBranch45(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_176"))
        {
            if (space_duty_vendor_condition__defaultCondition(player, npc))
    ...
    public int space_duty_vendor_handleBranch46(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_176"))
        {
            if (space_duty_vendor_condition__defaultCondition(player, npc))
