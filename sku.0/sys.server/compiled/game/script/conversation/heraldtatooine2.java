...
public class heraldtatooine2 extends script.base_script
{
    ...
    public boolean heraldtatooine2_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean heraldtatooine2_condition_cashyes50(obj_id player, obj_id npc)
    {
    ...
    public boolean heraldtatooine2_condition_cashyes30(obj_id player, obj_id npc)
    {
        int cash = getTotalMoney(player);
        if (cash >= 30)
        {
    ...
    public boolean heraldtatooine2_condition_cashyes15(obj_id player, obj_id npc)
    {
        int cash = getTotalMoney(player);
        if (cash >= 15)
        {
    ...
    public boolean heraldtatooine2_condition_cashyes60(obj_id player, obj_id npc)
    {
        int cash = getTotalMoney(player);
        if (cash >= 60)
        {
    ...
    public void heraldtatooine2_action_getcash50(obj_id player, obj_id npc)
    {
    ...
    public void heraldtatooine2_action_getcash30(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
    ...
    public void heraldtatooine2_action_getcash30a(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
    ...
    public void heraldtatooine2_action_getcash60(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
    ...
    public void heraldtatooine2_action_beckon(obj_id player, obj_id npc)
    {
        doAnimationAction(npc, "beckon");
    }
    public void heraldtatooine2_action_dismiss(obj_id player, obj_id npc)
    {
        doAnimationAction(npc, "wave_on_dismissing");
    }
    public int heraldtatooine2_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int heraldtatooine2_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int heraldtatooine2_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int heraldtatooine2_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int heraldtatooine2_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int heraldtatooine2_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int heraldtatooine2_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int heraldtatooine2_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int heraldtatooine2_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int heraldtatooine2_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
