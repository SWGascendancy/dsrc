...
public class racing_mosespa extends script.base_script
{
    ...
    public boolean racing_mosespa_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean racing_mosespa_condition_hasRaced(obj_id player, obj_id npc)
    {
        return (hasObjVar(player, "racing.bestTime.mosespa"));
    }
    public boolean racing_mosespa_condition_isRacing(obj_id player, obj_id npc)
    {
        return (getIntObjVar(player, "racing.mosespa.isRacing") == 1);
    }
    public boolean racing_mosespa_condition_hasLastTime(obj_id player, obj_id npc)
    {
        return (hasObjVar(player, "racing.lastTime.mosespa"));
    }
    public void racing_mosespa_action_registerPersonalBest(obj_id player, obj_id npc)
    {
    ...
    public void racing_mosespa_action_startRace(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        params.put("npc", npc);
    ...
    public void racing_mosespa_action_displayCurrentLeader(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        params.put("npc", npc);
    ...
    public void racing_mosespa_action_whatsMyBestTime(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        params.put("npc", npc);
    ...
    public void racing_mosespa_action_showBestTime(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        params.put("npc", npc);
    ...
    public void racing_mosespa_action_erasePersonalBest(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        params.put("npc", npc);
    ...
    public void racing_mosespa_action_abortRace(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
