...
public class mtp_hideout_access_droid_farmer extends script.base_script
{
    ...
    public boolean mtp_hideout_access_droid_farmer_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean mtp_hideout_access_droid_farmer_condition_mtpHideout02_01(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "mtp_hideout_access_02", "mtp_hideout_access_02_01");
    }
    public boolean mtp_hideout_access_droid_farmer_condition_mtpHideout02_03(obj_id player, obj_id npc)
    {
    ...
    public void mtp_hideout_access_droid_farmer_action_signal_mtpHideout02_01(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "mtp_hideout_access_02_01");
    }
    public void mtp_hideout_access_droid_farmer_action_signal_mtpHideout02_03(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "mtp_hideout_access_02_03");
    }
    public int mtp_hideout_access_droid_farmer_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_access_droid_farmer_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_access_droid_farmer_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_access_droid_farmer_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_access_droid_farmer_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
