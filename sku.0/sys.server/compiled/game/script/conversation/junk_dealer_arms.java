...
public class junk_dealer_arms extends script.base_script
{
    ...
    public boolean junk_dealer_arms_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean junk_dealer_arms_condition_check_inv(obj_id player, obj_id npc)
    {
        return smuggler.checkInventory(player, npc);
    }
    public void junk_dealer_arms_action_start_dealing(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        messageTo(npc, "startDealing", params, 1.0f, false);
    }
    public void junk_dealer_arms_action_face_to(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int junk_dealer_arms_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
