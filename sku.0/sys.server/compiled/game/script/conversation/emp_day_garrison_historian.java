...
public class emp_day_garrison_historian extends script.base_script
{
    ...
    public boolean emp_day_garrison_historian_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean emp_day_garrison_historian_condition_hasTask2or3(obj_id player, obj_id npc)
    {
    ...
    public boolean emp_day_garrison_historian_condition_pastMyTasks(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/emp_day_imperial");
    ...
    public boolean emp_day_garrison_historian_condition_hasDisks(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/emp_day_imperial");
        int task2 = groundquests.getTaskId(questId, "killRebels");
        int task3a = groundquests.getTaskId(questId, "diskGuy1");
    ...
    public boolean emp_day_garrison_historian_condition_hasStartingTask(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/emp_day_imperial");
        return questIsTaskActive(questId, 0, player);
    }
    public boolean emp_day_garrison_historian_condition_hasTask2(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/emp_day_imperial");
        int task2 = groundquests.getTaskId(questId, "killRebels");
        return questIsTaskActive(questId, task2, player);
    }
    public boolean emp_day_garrison_historian_condition_hasTask3a(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/emp_day_imperial");
        int task3a = groundquests.getTaskId(questId, "diskGuy1");
        return questIsTaskActive(questId, task3a, player);
    }
    public boolean emp_day_garrison_historian_condition_hasTask3b(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/emp_day_imperial");
        int task3b = groundquests.getTaskId(questId, "diskGuy2");
        return questIsTaskActive(questId, task3b, player);
    }
    public boolean emp_day_garrison_historian_condition_hasTask3c(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/emp_day_imperial");
        int task3c = groundquests.getTaskId(questId, "diskGuy3");
        return questIsTaskActive(questId, task3c, player);
    }
    public boolean emp_day_garrison_historian_condition_isNeutral(obj_id player, obj_id npc)
    {
    ...
    public void emp_day_garrison_historian_action_historianConversed(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "historian_conversed");
    }
    public void emp_day_garrison_historian_action_diskGuy1Wp(obj_id player, obj_id npc)
    {
    ...
    public void emp_day_garrison_historian_action_dataUplinkWp(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "empire_day.waypoint"))
        {
            obj_id oldWaypoint = getObjIdObjVar(player, "empire_day.waypoint");
    ...
    public void emp_day_garrison_historian_action_diskGuy3Wp(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "empire_day.waypoint"))
        {
            obj_id oldWaypoint = getObjIdObjVar(player, "empire_day.waypoint");
    ...
    public void emp_day_garrison_historian_action_diskGuy2Wp(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "empire_day.waypoint"))
        {
            obj_id oldWaypoint = getObjIdObjVar(player, "empire_day.waypoint");
    ...
    public void emp_day_garrison_historian_action_disksToHistorian(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/emp_day_imperial");
        int task2 = groundquests.getTaskId(questId, "killRebels");
        int task3a = groundquests.getTaskId(questId, "diskGuy1");
    ...
    public void emp_day_garrison_historian_action_dataOfficerWp(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "empire_day.waypoint"))
        {
            obj_id oldWaypoint = getObjIdObjVar(player, "empire_day.waypoint");
    ...
    public int emp_day_garrison_historian_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_garrison_historian_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_garrison_historian_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_garrison_historian_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_garrison_historian_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_garrison_historian_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_garrison_historian_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_garrison_historian_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_136"))
        {
            emp_day_garrison_historian_action_historianConversed(player, npc);
    ...
    public int emp_day_garrison_historian_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_garrison_historian_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
