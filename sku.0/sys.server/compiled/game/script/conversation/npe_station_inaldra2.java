...
public class npe_station_inaldra2 extends script.base_script
{
    ...
    public boolean npe_station_inaldra2_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_station_inaldra2_condition_finishedInaldraQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_station_inaldra2_condition_finishedMainQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_new_main_quest");
    }
    public boolean npe_station_inaldra2_condition_onRewardStep(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_inaldra_quest", "inaldrasignal");
    }
    public boolean npe_station_inaldra2_condition_onInaldraQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "npe_inaldra_quest");
    }
    public boolean npe_station_inaldra2_condition_getOffStationNow(obj_id player, obj_id npc)
    {
        return (groundquests.isQuestActive(player, "npe_pointer_inaldra") && !groundquests.hasCompletedQuest(player, "npe_new_main_quest"));
    }
    public boolean npe_station_inaldra2_condition_isBH(obj_id player, obj_id npc)
    {
    ...
    public void npe_station_inaldra2_action_forwardInaldraQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_inaldra_quest_reward");
        groundquests.grantQuest(player, "npe_pointer_secretary");
    }
    public void npe_station_inaldra2_action_giveInaldraQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_new_main_inaldra");
        groundquests.requestGrantQuest(player, "npe_inaldra_quest");
    }
    public void npe_station_inaldra2_action_completePointerQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_new_main_inaldra");
    }
    public void npe_station_inaldra2_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int npe_station_inaldra2_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_inaldra2_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_inaldra2_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_inaldra2_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_inaldra2_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_inaldra2_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_inaldra2_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_inaldra2_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_56"))
        {
            if (npe_station_inaldra2_condition__defaultCondition(player, npc))
    ...
    public int npe_station_inaldra2_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_56"))
        {
            if (npe_station_inaldra2_condition__defaultCondition(player, npc))
