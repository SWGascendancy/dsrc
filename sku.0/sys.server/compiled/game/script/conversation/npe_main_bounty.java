...
public class npe_main_bounty extends script.base_script
{
    ...
    public boolean npe_main_bounty_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_main_bounty_condition_onCorrectStep(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "npe_new_main_quest", "bounty");
    }
    public int npe_main_bounty_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_main_bounty_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_main_bounty_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
