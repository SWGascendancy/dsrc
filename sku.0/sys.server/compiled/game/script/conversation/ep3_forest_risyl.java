...
public class ep3_forest_risyl extends script.base_script
{
    ...
    public boolean ep3_forest_risyl_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_forest_risyl_condition_isTaskActiveOne(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_forest_cryl_quest_1", 0);
    }
    public boolean ep3_forest_risyl_condition_hasCompletedQuestOne(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_forest_cryl_quest_1");
    }
    public void ep3_forest_risyl_action_giveSignalOne(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "bile");
    }
    public int ep3_forest_risyl_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_risyl_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_risyl_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_forest_risyl_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
