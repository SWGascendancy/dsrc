...
public class rtp_c3po_main extends script.base_script
{
    ...
    public boolean rtp_c3po_main_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean rtp_c3po_main_condition_rtp_c3po_01_active(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "rtp_c3po_01");
    }
    public boolean rtp_c3po_main_condition_rtp_c3po_01_complete(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "rtp_c3po_01", "rtp_c3po_01_03") || groundquests.hasCompletedQuest(player, "rtp_c3po_01");
    }
    public boolean rtp_c3po_main_condition_rtp_c3po_02_active(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "rtp_c3po_02");
    }
    public boolean rtp_c3po_main_condition_rtp_c3po_02_completed(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "rtp_c3po_02", "rtp_c3po_02_03");
    }
    public boolean rtp_c3po_main_condition_playerLevelCheck(obj_id player, obj_id npc)
    {
        return (getLevel(player) < 80);
    }
    public boolean rtp_c3po_main_condition_questComplete(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "rtp_c3po_02");
    }
    public boolean rtp_c3po_main_condition_notRebel(obj_id player, obj_id npc)
    {
    ...
    public boolean rtp_c3po_main_condition_rebel_isOnLeave(obj_id player, obj_id npc)
    {
        return factions.isOnLeave(player);
    }
    public void rtp_c3po_main_action_rtp_c3po_01_granted(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "rtp_c3po_01");
    }
    public void rtp_c3po_main_action_rtp_c3po_01_signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "rtp_c3po_01_03");
    }
    public void rtp_c3po_main_action_rtp_c3po_02_signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "rtp_c3po_02_03");
    }
    public void rtp_c3po_main_action_rtp_c3po_02_granted(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "rtp_c3po_02");
    }
    public int rtp_c3po_main_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rtp_c3po_main_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
