...
public class u13_horace_korr extends script.base_script
{
    ...
    public boolean u13_horace_korr_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean u13_horace_korr_condition_active_u13_vengeance_01_01(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "u13_vengeance_01", "u13_vengeance_01_01");
    }
    public boolean u13_horace_korr_condition_inprogress_u13_vengeance_01(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "u13_vengeance_01", "u13_vengeance_01_01");
    }
    public boolean u13_horace_korr_condition_active_u13_vengeance_01_05(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "u13_vengeance_01", "u13_vengeance_01_05");
    }
    public boolean u13_horace_korr_condition_completed_u13_vengeance_01_05(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "u13_vengeance_01", "u13_vengeance_01_05");
    }
    public void u13_horace_korr_action_signal_u13_vengeance_01_01(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "u13_vengeance_01_01");
    }
    public void u13_horace_korr_action_signal_u13_vengeance_01_05(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "u13_vengeance_01_05");
    }
    public int u13_horace_korr_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int u13_horace_korr_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
