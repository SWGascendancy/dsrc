...
public class npe_falcon_c3po extends script.base_script
{
    ...
    public boolean npe_falcon_c3po_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public void npe_falcon_c3po_action_sound1(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/c3po_106.snd");
        faceTo(npc, player);
    }
    public void npe_falcon_c3po_action_sound2(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/c3po_107.snd");
    }
    public int npe_falcon_c3po_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
