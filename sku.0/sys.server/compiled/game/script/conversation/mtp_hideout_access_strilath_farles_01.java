...
public class mtp_hideout_access_strilath_farles_01 extends script.base_script
{
    ...
    public boolean mtp_hideout_access_strilath_farles_01_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean mtp_hideout_access_strilath_farles_01_condition_mtpHideout03_04(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_hideout_access_strilath_farles_01_condition_active_mtpHideout04(obj_id player, obj_id npc)
    {
    ...
    public void mtp_hideout_access_strilath_farles_01_action_signal_mtpHideout03_04(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "mtp_hideout_access_03_04");
    }
    public void mtp_hideout_access_strilath_farles_01_action_grant_mtpHideout04(obj_id player, obj_id npc)
    {
    ...
    public void mtp_hideout_access_strilath_farles_01_action_regrant_mtpHideout04(obj_id player, obj_id npc)
    {
        if (getLevel(player) >= 82)
        {
    ...
    public int mtp_hideout_access_strilath_farles_01_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_access_strilath_farles_01_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_access_strilath_farles_01_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
