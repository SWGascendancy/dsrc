...
public class ep3_trandoshan_negal_teklon extends script.base_script
{
    ...
    public boolean ep3_trandoshan_negal_teklon_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_trandoshan_negal_teklon_condition_hasCompletedTask01(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_trando_borantok_01", "talktoNegal");
    }
    public boolean ep3_trandoshan_negal_teklon_condition_isOnMission(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_trando_borantok_01");
    }
    public boolean ep3_trandoshan_negal_teklon_condition_hasCompletedTasks(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "ep3_trando_borantok_01", "talktoNegal");
    }
    public void ep3_trandoshan_negal_teklon_action_doSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "hideBodies");
        groundquests.grantQuest(player, "ep3_trando_borantok_02");
    }
    public int ep3_trandoshan_negal_teklon_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_negal_teklon_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_negal_teklon_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_negal_teklon_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
