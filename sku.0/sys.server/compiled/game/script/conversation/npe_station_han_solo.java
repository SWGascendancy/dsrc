...
public class npe_station_han_solo extends script.base_script
{
    ...
    public boolean npe_station_han_solo_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_station_han_solo_condition_playerOnQuest(obj_id player, obj_id npc)
    {
        return (groundquests.isQuestActive(player, "npe_main_quest") && !groundquests.isTaskActive(player, "npe_main_quest", "talktohan1"));
    }
    public boolean npe_station_han_solo_condition_playerOnLastHanStep(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_main_quest", "talktohan2");
    }
    public boolean npe_station_han_solo_condition_playerCompletedQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_main_quest");
    }
    public boolean npe_station_han_solo_condition_playeronFirstHanStep(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_main_quest", "talktohan1");
    }
    public boolean npe_station_han_solo_condition_playerOnQuest_2(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "npe_main_quest_2");
    }
    public boolean npe_station_han_solo_condition_Main2onInaldrastep(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_main_quest_2", "inaldra1");
    }
    public boolean npe_station_han_solo_condition_Main2onHanStep1(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_main_quest_2", "han1");
    }
    public boolean npe_station_han_solo_condition_Main2onInfoStep(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_main_quest_2", "getinfo");
    }
    public boolean npe_station_han_solo_condition_Main2onPerformStep(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_main_quest_2", "perform");
    }
    public boolean npe_station_han_solo_condition_Main2onTarandQuest(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_main_quest_2", "tarand") || groundquests.isQuestActive(player, "npe_side_smuggle");
    }
    public boolean npe_station_han_solo_condition_Main2FinishedTarandQuest(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "npe_main_quest_2", "han2") && groundquests.hasCompletedQuest(player, "npe_side_smuggle"));
    }
    public boolean npe_station_han_solo_condition_Main2Complete(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_main_quest_2");
    }
    public void npe_station_han_solo_action_signalHan1(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_main_han1");
    }
    public void npe_station_han_solo_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void npe_station_han_solo_action_signalHan2(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_main_han2");
    }
    public void npe_station_han_solo_action_giveMainQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_main_quest");
    }
    public void npe_station_han_solo_action_giveMainQuest_2(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_main_quest_2");
    }
    public void npe_station_han_solo_action_signalMain2Han1(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_main2_han_reply");
    }
    public void npe_station_han_solo_action_signalMain2Han2(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_main2_han_final");
    }
    public int npe_station_han_solo_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
