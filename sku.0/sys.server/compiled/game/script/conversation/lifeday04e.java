...
public class lifeday04e extends script.base_script
{
    ...
    public boolean lifeday04e_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean lifeday04e_condition_notSpokeWithElder(obj_id player, obj_id npc)
    {
    ...
    public boolean lifeday04e_condition_hasBeenRewarded(obj_id player, obj_id npc)
    {
    ...
    public void lifeday04e_action_setTalkedToYou(obj_id player, obj_id npc)
    {
        int convTracker = getIntObjVar(player, "lifeday04.convTracker");
    ...
    public int lifeday04e_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int lifeday04e_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int lifeday04e_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int lifeday04e_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int lifeday04e_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int lifeday04e_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_77e48d5b"))
        {
            if (lifeday04e_condition__defaultCondition(player, npc))
    ...
    public int lifeday04e_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_533ce9b7"))
        {
            if (lifeday04e_condition__defaultCondition(player, npc))
    ...
    public int lifeday04e_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_b84f1c5d"))
        {
            if (lifeday04e_condition__defaultCondition(player, npc))
    ...
    public int lifeday04e_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_f9a62733"))
        {
