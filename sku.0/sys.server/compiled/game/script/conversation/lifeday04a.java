...
public class lifeday04a extends script.base_script
{
    ...
    public boolean lifeday04a_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean lifeday04a_condition_hasBeenRewarded(obj_id player, obj_id npc)
    {
    ...
    public boolean lifeday04a_condition_hasSpokenOnce(obj_id player, obj_id npc)
    {
    ...
    public boolean lifeday04a_condition_isaWookiee(obj_id player, obj_id npc)
    {
    ...
    public void lifeday04a_action_giveWaypoint(obj_id player, obj_id npc)
    {
        int[] coordinates = 
        {
            -2579,
    ...
    public void lifeday04a_action_finishedConversation(obj_id player, obj_id npc)
    {
    ...
    public int lifeday04a_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int lifeday04a_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int lifeday04a_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int lifeday04a_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
