...
public class romo_vax extends script.base_script
{
    ...
    public boolean romo_vax_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean romo_vax_condition_isOnBibsQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean romo_vax_condition_completedRomosQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean romo_vax_condition_gettingRomosDisks(obj_id player, obj_id npc)
    {
    ...
    public boolean romo_vax_condition_doneWithRomo(obj_id player, obj_id npc)
    {
    ...
    public boolean romo_vax_condition_doingRomosQuest(obj_id player, obj_id npc)
    {
    ...
    public void romo_vax_action_grantRomoQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "spokenToRomo");
    }
    public void romo_vax_action_sendBiddingSignal(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        groundquests.sendSignal(player, "completedRomosQuest");
    }
    public void romo_vax_action_sendDiskSignal(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        groundquests.sendSignal(player, "romosDisksReturned");
    }
    public void romo_vax_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int romo_vax_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int romo_vax_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int romo_vax_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int romo_vax_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int romo_vax_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int romo_vax_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int romo_vax_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
