...
public class ep3_etyyy_wrelaac extends script.base_script
{
    ...
    public boolean ep3_etyyy_wrelaac_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_etyyy_wrelaac_condition_hasCompletedMadaQuests(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_etyyy_wrelaac_condition_spokeToChrilooc(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedQuest(player, "ep3_hunt_wrelaac_to_chrilooc"));
    }
    public boolean ep3_etyyy_wrelaac_condition_hasProof(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "ep3_hunt_wrelaac_proof_of_mada", "wrelaac_presentProofToWrelaac"));
    }
    public boolean ep3_etyyy_wrelaac_condition_talkToChrilooc(obj_id player, obj_id npc)
    {
        return (groundquests.isQuestActive(player, "ep3_hunt_wrelaac_to_chrilooc"));
    }
    public boolean ep3_etyyy_wrelaac_condition_needsProof(obj_id player, obj_id npc)
    {
        return (groundquests.isQuestActive(player, "ep3_hunt_wrelaac_proof_of_mada"));
    }
    public boolean ep3_etyyy_wrelaac_condition_guessedWrong(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "ep3Hunt.guessedWrong");
    }
    public boolean ep3_etyyy_wrelaac_condition_onMadasQuest(obj_id player, obj_id npc)
    {
        return (groundquests.isQuestActive(player, "ep3_hunt_mada_johnson_to_wrelaac"));
    }
    public boolean ep3_etyyy_wrelaac_condition_completedBrodyQuest(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedQuest(player, "ep3_hunt_johnson_brody_johnson"));
    }
    public boolean ep3_etyyy_wrelaac_condition_cannotSpeakWookiee(obj_id player, obj_id npc)
    {
        return utils.canSpeakWookiee(player, npc);
    }
    public boolean ep3_etyyy_wrelaac_condition_suppliedProof(obj_id player, obj_id npc)
    {
    ...
    public void ep3_etyyy_wrelaac_action_wrongGuess(obj_id player, obj_id npc)
    {
        setObjVar(player, "ep3Hunt.guessedWrong", true);
    }
    public void ep3_etyyy_wrelaac_action_foundProof(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "wrelaac_presentProofToWrelaac");
    }
    public void ep3_etyyy_wrelaac_action_goTalkToChrilooc(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "mada_talkToWrelaac");
        groundquests.grantQuest(player, "ep3_hunt_wrelaac_to_chrilooc");
    }
    public void ep3_etyyy_wrelaac_action_goGetProof(obj_id player, obj_id npc)
    {
    ...
    public void ep3_etyyy_wrelaac_action_thinkWookieeConfusion(obj_id player, obj_id npc)
    {
        utils.emoteWookieeConfusion(player, npc);
    }
    public int ep3_etyyy_wrelaac_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_wrelaac_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_wrelaac_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_wrelaac_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_72"))
        {
            if (ep3_etyyy_wrelaac_condition__defaultCondition(player, npc))
    ...
    public int ep3_etyyy_wrelaac_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_wrelaac_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_wrelaac_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_72"))
        {
            if (ep3_etyyy_wrelaac_condition__defaultCondition(player, npc))
    ...
    public int ep3_etyyy_wrelaac_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_wrelaac_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
