...
public class jabba extends script.base_script
{
    ...
    public boolean jabba_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean jabba_condition_finishedBibsQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean jabba_condition_killingDelrice(obj_id player, obj_id npc)
    {
    ...
    public boolean jabba_condition_killingTyrok(obj_id player, obj_id npc)
    {
    ...
    public boolean jabba_condition_killingAssaultTeam(obj_id player, obj_id npc)
    {
    ...
    public boolean jabba_condition_returningToJabba(obj_id player, obj_id npc)
    {
    ...
    public boolean jabba_condition_finishedJabbasQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean jabba_condition_onHeadStartJabba(obj_id player, obj_id npc)
    {
    ...
    public void jabba_action_grantJabbasQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest/jabba_the_hutt_v2");
    }
    public void jabba_action_sendCompletedJabbaSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "finishedKilling");
    }
    public void jabba_action_grantEV9D9(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "legacy_head_start_launch_e11");
    }
    public void jabba_action_clearPointer(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "found_jabba");
    }
    public int jabba_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int jabba_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int jabba_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int jabba_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
