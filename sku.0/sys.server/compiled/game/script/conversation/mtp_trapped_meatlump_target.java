...
public class mtp_trapped_meatlump_target extends script.base_script
{
    ...
    public boolean mtp_trapped_meatlump_target_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean mtp_trapped_meatlump_target_condition_isMeatlumpFollowing(obj_id player, obj_id npc)
    {
        return ai_lib.isFollowing(npc);
    }
    public boolean mtp_trapped_meatlump_target_condition_isCowering(obj_id player, obj_id npc)
    {
        return utils.hasScriptVar(npc, "mtp_isCowering");
    }
    public boolean mtp_trapped_meatlump_target_condition_isCoweringCombat(obj_id player, obj_id npc)
    {
        return utils.hasScriptVar(npc, "mtp_isCowering") && ai_lib.isInCombat(player);
    }
    public boolean mtp_trapped_meatlump_target_condition_isSafe(obj_id player, obj_id npc)
    {
        return utils.hasScriptVar(npc, "mtp_isSafe");
    }
    public void mtp_trapped_meatlump_target_action_followPlayer(obj_id player, obj_id npc)
    {
    ...
    public void mtp_trapped_meatlump_target_action_moveToPlayer(obj_id player, obj_id npc)
    {
    ...
    public int mtp_trapped_meatlump_target_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_trapped_meatlump_target_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_trapped_meatlump_target_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_handleRescuerAttacked(obj_id self, dictionary params)
    {
    ...
    public int handlePathToFearLoc(obj_id self, dictionary params)
    {
        obj_id player = utils.getObjIdScriptVar(self, "mtp_rescuingPlayer");
