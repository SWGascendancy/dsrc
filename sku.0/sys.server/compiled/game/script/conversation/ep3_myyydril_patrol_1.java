...
public class ep3_myyydril_patrol_1 extends script.base_script
{
    ...
    public boolean ep3_myyydril_patrol_1_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_myyydril_patrol_1_condition_hasCompletedQuestOther(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_myyydril_patrol_1_condition_isActiveTaskOne(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_myyydril_patrol_1_condition_hasCompletedTaskOne(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_myyydril_patrol_1_condition_hasCompletedAllQuests(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_myyydril_patrol_1_condition_hasCompletedQuestOne(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_myyydril_talaoree_destroy_1");
    }
    public boolean ep3_myyydril_patrol_1_condition_isTaskActiveTwo(obj_id player, obj_id npc)
    {
    ...
    public void ep3_myyydril_patrol_1_action_grantQuestOne(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talktotalaoree");
        groundquests.grantQuest(player, "ep3_myyydril_talaoree_destroy_1");
    }
    public void ep3_myyydril_patrol_1_action_grantQuestTwo(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_myyydril_talaoree_talkto_3");
    }
    public void ep3_myyydril_patrol_1_action_giveSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "giveReward");
    }
    public int ep3_myyydril_patrol_1_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_patrol_1_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_patrol_1_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_patrol_1_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_patrol_1_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_patrol_1_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
