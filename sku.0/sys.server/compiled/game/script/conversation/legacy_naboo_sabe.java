...
public class legacy_naboo_sabe extends script.base_script
{
    ...
    public boolean legacy_naboo_sabe_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean legacy_naboo_sabe_condition_hasDonePanakasQuest(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean legacy_naboo_sabe_condition_isStillDoingQuests(obj_id player, obj_id npc)
    {
    ...
    public boolean legacy_naboo_sabe_condition_completedEirtaesQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean legacy_naboo_sabe_condition_foundSache(obj_id player, obj_id npc)
    {
    ...
    public void legacy_naboo_sabe_action_sendKidnappingSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "SpokenToSabeAboutKidnapping");
        return;
    }
    public void legacy_naboo_sabe_action_finishHandMaidenQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "completedHandmaidenQuestsForSabe");
    }
    public void legacy_naboo_sabe_action_startHandmaidenQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest/legacy_naboo_helping_the_handmaidens");
    }
    public int legacy_naboo_sabe_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_naboo_sabe_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_naboo_sabe_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_naboo_sabe_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_naboo_sabe_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_naboo_sabe_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_naboo_sabe_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_naboo_sabe_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_naboo_sabe_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
