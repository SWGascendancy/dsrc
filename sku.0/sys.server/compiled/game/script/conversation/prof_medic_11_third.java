...
public class prof_medic_11_third extends script.base_script
{
    ...
    public boolean prof_medic_11_third_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean prof_medic_11_third_condition_playerOnCorrectStep(obj_id player, obj_id npc)
    {
        return false;
    }
    public boolean prof_medic_11_third_condition_playercompletedTask(obj_id player, obj_id npc)
    {
        return false;
    }
    public void prof_medic_11_third_action_givePassSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "profession_medic_11_third_victim");
    }
    public int prof_medic_11_third_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
