...
public class mtp_hideout_weapon_supply_smuggler extends script.base_script
{
    ...
    public boolean mtp_hideout_weapon_supply_smuggler_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean mtp_hideout_weapon_supply_smuggler_condition_hasTaskActive(obj_id player, obj_id npc)
    {
        return true;
    }
    public void mtp_hideout_weapon_supply_smuggler_action_sendDeliverySignal(obj_id player, obj_id npc)
    {
    ...
    public int mtp_hideout_weapon_supply_smuggler_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_weapon_supply_smuggler_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_weapon_supply_smuggler_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_weapon_supply_smuggler_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_weapon_supply_smuggler_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_weapon_supply_smuggler_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_weapon_supply_smuggler_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
