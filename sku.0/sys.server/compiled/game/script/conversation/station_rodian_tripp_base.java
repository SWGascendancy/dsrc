...
public class station_rodian_tripp_base extends script.base_script
{
    ...
    public boolean station_rodian_tripp_base_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean station_rodian_tripp_base_condition_hasWon_assassinations(obj_id player, obj_id npc)
    {
    ...
    public boolean station_rodian_tripp_base_condition_isTooFar(obj_id player, obj_id npc)
    {
        space_combat.playCombatTauntSound(player);
        obj_id containingShip = space_transition.getContainingShip(player);
        return (getDistance(npc, containingShip) > space_transition.STATION_COMM_MAX_DISTANCE);
    }
    public void station_rodian_tripp_base_action_grantDuty_destroy(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "ep3_kash_station_destroy_duty_rodian_tripp");
    }
    public int station_rodian_tripp_base_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rodian_tripp_base_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rodian_tripp_base_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rodian_tripp_base_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rodian_tripp_base_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rodian_tripp_base_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rodian_tripp_base_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_rodian_tripp_base_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
