...
public class ep3_trandoshan_hssissk_zssik_06 extends script.base_script
{
    ...
    public boolean ep3_trandoshan_hssissk_zssik_06_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_trandoshan_hssissk_zssik_06_condition_isOnTask01(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_trando_orooroo_transfer");
    }
    public boolean ep3_trandoshan_hssissk_zssik_06_condition_isOnTask02(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_trando_hssissk_zssik_10", "wonAvatarPlatform");
    }
    public boolean ep3_trandoshan_hssissk_zssik_06_condition_isOnQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_trandoshan_hssissk_zssik_06_condition_hasCompletedQuest01(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_trando_hssissk_zssik_10");
    }
    public boolean ep3_trandoshan_hssissk_zssik_06_condition_hssisskReady(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_trando_orooroo_zssik_08");
    }
    public void ep3_trandoshan_hssissk_zssik_06_action_doSignal01(obj_id player, obj_id npc)
    {
    ...
    public void ep3_trandoshan_hssissk_zssik_06_action_doSignal02(obj_id player, obj_id npc)
    {
    ...
    public int ep3_trandoshan_hssissk_zssik_06_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_hssissk_zssik_06_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_hssissk_zssik_06_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_hssissk_zssik_06_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_hssissk_zssik_06_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_hssissk_zssik_06_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_hssissk_zssik_06_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_hssissk_zssik_06_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_hssissk_zssik_06_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_946"))
        {
            if (ep3_trandoshan_hssissk_zssik_06_condition__defaultCondition(player, npc))
