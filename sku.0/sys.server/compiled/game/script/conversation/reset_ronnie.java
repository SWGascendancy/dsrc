...
public class reset_ronnie extends script.base_script
{
    ...
    public boolean reset_ronnie_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public void reset_ronnie_action_clearQuests(obj_id player, obj_id npc)
    {
        String[] questList = 
        {
            "rtp_c3po_01",
    ...
    public int reset_ronnie_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
