...
public class npe_runequest extends script.base_script
{
    ...
    public boolean npe_runequest_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_runequest_condition_isTaskActiveRune(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "npe_runequest", "runes") && !groundquests.hasCompletedQuest(player, "npe_runequest"));
    }
    public boolean npe_runequest_condition_hasCompletedRuneTask(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedTask(player, "npe_runequest", "runes") && !groundquests.hasCompletedQuest(player, "npe_runequest"));
    }
    public boolean npe_runequest_condition_hasCompletedQuestRune(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_runequest");
    }
    public boolean npe_runequest_condition_hasTemplate(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "npe.finishedTemplate");
    }
    public void npe_runequest_action_grantRuneQuest(obj_id player, obj_id npc)
    {
    ...
    public void npe_runequest_action_giveRuneSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "runesignal");
    }
    public void npe_runequest_action_groupPopUp(obj_id player, obj_id npc)
    {
        messageTo(player, "groupPopUp1", null, 0, false);
        messageTo(player, "groupPopUp2", null, 5, false);
    }
    public int npe_runequest_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_runequest_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_runequest_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_runequest_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_runequest_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_runequest_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
