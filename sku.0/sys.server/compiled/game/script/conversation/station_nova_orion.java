...
public class station_nova_orion extends script.base_script
{
    ...
    public boolean station_nova_orion_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean station_nova_orion_condition_isTooFar(obj_id player, obj_id npc)
    {
    ...
    public boolean station_nova_orion_condition_canAfford100(obj_id player, obj_id npc)
    {
        return space_crafting.canAffordShipRepairs(player, npc, 1.0f);
    }
    public boolean station_nova_orion_condition_canAfford25(obj_id player, obj_id npc)
    {
        return (space_crafting.canAffordShipRepairs(player, npc, .25f) && space_crafting.isDamaged(player));
    }
    public boolean station_nova_orion_condition_canAfford50(obj_id player, obj_id npc)
    {
        return space_crafting.canAffordShipRepairs(player, npc, .50f);
    }
    public boolean station_nova_orion_condition_canAfford75(obj_id player, obj_id npc)
    {
        return space_crafting.canAffordShipRepairs(player, npc, .75f);
    }
    public void station_nova_orion_action_land(obj_id player, obj_id npc)
    {
        location stationLoc = getLocation(npc);
        location playerLoc = getLocation(space_transition.getContainingShip(player));
    ...
    public void station_nova_orion_action_fix100(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, 1.0f);
    }
    public void station_nova_orion_action_fix25(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, .25f);
    }
    public void station_nova_orion_action_fix50(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, .50f);
    }
    public void station_nova_orion_action_fix75(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, .75f);
    }
    public int station_nova_orion_tokenDI_getStationCost100(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, 1.0f);
    }
    public int station_nova_orion_tokenDI_getStationCost25(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, .25f);
    }
    public int station_nova_orion_tokenDI_getStationCost50(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, .50f);
    }
    public int station_nova_orion_tokenDI_getStationCost75(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, .75f);
    }
    public int station_nova_orion_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_nova_orion_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_nova_orion_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_nova_orion_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_nova_orion_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_nova_orion_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
