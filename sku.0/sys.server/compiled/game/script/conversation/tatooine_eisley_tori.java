...
public class tatooine_eisley_tori extends script.base_script
{
    ...
    public boolean tatooine_eisley_tori_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tatooine_eisley_tori_condition_boneOnTask(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean tatooine_eisley_tori_condition_boneQuestComplete(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.hasCompletedQuest(player, "quest/tatooine_eisley_bone_gnasher");
    }
    public boolean tatooine_eisley_tori_condition_boneTaskComplete(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        int questId1 = questGetQuestId("quest/tatooine_eisley_bone_gnasher");
    ...
    public boolean tatooine_eisley_tori_condition_diQuestComplete(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_eisley_digital_infection");
        boolean OnTask = (questIsQuestComplete(questId1, player));
        return OnTask;
    }
    public boolean tatooine_eisley_tori_condition_gotoToriOnTask(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean tatooine_eisley_tori_condition_gotoToriComplete(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        int questId1 = questGetQuestId("quest/tatooine_eisley_gototori");
        boolean OnTask = (questIsQuestComplete(questId1, player));
    ...
    public boolean tatooine_eisley_tori_condition_facePlayer2(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return true;
    }
    public void tatooine_eisley_tori_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void tatooine_eisley_tori_action_grantBoneQuest(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/tatooine_eisley_bone_gnasher");
        groundquests.grantQuest(questId, player, npc, true);
    }
    public void tatooine_eisley_tori_action_signalBoneReward(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tat_eisley_bone_gnasher_e2");
    }
    public void tatooine_eisley_tori_action_signalGotoTori(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tat_reimos_tori_e1");
    }
    public void tatooine_eisley_tori_action_grantGotoReimos(obj_id player, obj_id npc)
    {
    ...
    public int tatooine_eisley_tori_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_tori_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_tori_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_tori_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_tori_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_tori_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_tori_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_tori_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_tori_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_tori_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_tori_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_tori_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_tori_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_tori_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_75"))
        {
            if (tatooine_eisley_tori_condition__defaultCondition(player, npc))
    ...
    public int tatooine_eisley_tori_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_tori_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_tori_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_tori_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_tori_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
