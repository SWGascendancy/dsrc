...
public class tatooine_eisley_reimos_v2 extends script.base_script
{
    ...
    public boolean tatooine_eisley_reimos_v2_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tatooine_eisley_reimos_v2_condition_onDIv2(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "tatooine_eisley_digital_infection_v2");
    }
    public boolean tatooine_eisley_reimos_v2_condition_completedDelivery(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "tatooine_eisley_special_delivery");
    }
    public boolean tatooine_eisley_reimos_v2_condition_onShippingOut(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "tatooine_eisley_drensbounty_v2");
    }
    public boolean tatooine_eisley_reimos_v2_condition_lostShippingOut(obj_id player, obj_id npc)
    {
    ...
    public boolean tatooine_eisley_reimos_v2_condition_completedShippingOut(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "tatooine_eisley_drensbounty_v2");
    }
    public boolean tatooine_eisley_reimos_v2_condition_lostButton(obj_id player, obj_id npc)
    {
    ...
    public void tatooine_eisley_reimos_v2_action_grantDigitalInfection(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "tatooine_eisley_digital_infection_v2");
    }
    public void tatooine_eisley_reimos_v2_action_grantShippingOut(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "tatooine_eisley_drensbounty_v2");
    }
    public void tatooine_eisley_reimos_v2_action_grantButton(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "legacy_button_start");
    }
    public void tatooine_eisley_reimos_v2_action_signalFindReimos(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tat_dunir_reimos_e1");
    }
    public int tatooine_eisley_reimos_v2_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_v2_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_v2_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_v2_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_v2_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_v2_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_v2_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_v2_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_v2_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_v2_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_v2_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_v2_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_reimos_v2_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
