...
public class event_bossk_jawa extends script.base_script
{
    ...
    public boolean event_bossk_jawa_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean event_bossk_jawa_condition_readyToTalk(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "quest/event_cantina_bossk_2", "talkToJawa"));
    }
    public void event_bossk_jawa_action_jawaConversed(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkToJawa");
    }
    public int event_bossk_jawa_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_bossk_jawa_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_bossk_jawa_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_bossk_jawa_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
