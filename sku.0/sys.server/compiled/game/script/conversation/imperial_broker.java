...
public class imperial_broker extends script.base_script
{
    ...
    public boolean imperial_broker_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean imperial_broker_condition_isImperialFaction(obj_id player, obj_id npc)
    {
    ...
    public boolean imperial_broker_condition_isMaleImperialFaction(obj_id player, obj_id npc)
    {
        return (imperial_broker_condition_isImperialFaction(player, npc) && (getGender(player) == GENDER_MALE));
    }
    public boolean imperial_broker_condition_isMalePlayer(obj_id player, obj_id npc)
    {
        return (getGender(player) == GENDER_MALE);
    }
    public boolean imperial_broker_condition_justSpokeToPlayer(obj_id player, obj_id npc)
    {
        return (utils.hasScriptVar(player, "justTalkedToImpBroker"));
    }
    public boolean imperial_broker_condition_justSpokeToMalePlayer(obj_id player, obj_id npc)
    {
        return (imperial_broker_condition_isMalePlayer(player, npc) && imperial_broker_condition_justSpokeToPlayer(player, npc));
    }
    public boolean imperial_broker_condition_isRebelFaction(obj_id player, obj_id npc)
    {
        String factionName = factions.getFaction(player);
        if (factionName == null || factionName.equals(""))
        {
    ...
    public boolean imperial_broker_condition_isWookieePlayer(obj_id player, obj_id npc)
    {
        return (getSpecies(player) == SPECIES_WOOKIEE);
    }
    public boolean imperial_broker_condition_wasDismissedRebel(obj_id player, obj_id npc)
    {
        return (utils.getIntScriptVar(player, "brokerDismissed") == 3);
    }
    public boolean imperial_broker_condition_wasDismissedWookiee(obj_id player, obj_id npc)
    {
        return (utils.getIntScriptVar(player, "brokerDismissed") == 2);
    }
    public boolean imperial_broker_condition_wasDismissedWoman(obj_id player, obj_id npc)
    {
        return (utils.getIntScriptVar(player, "brokerDismissed") == 1);
    }
    public boolean imperial_broker_condition_isImperialPilot(obj_id player, obj_id npc)
    {
        return space_skill.hasImperialSkill(player);
    }
    public boolean imperial_broker_condition_isPilot(obj_id player, obj_id npc)
    {
        return space_skill.hasSpaceSkills(player);
    }
    public boolean imperial_broker_condition_hasSpaceExp(obj_id player, obj_id npc)
    {
        return true;
    }
    public void imperial_broker_action_addCorelliaImpWaypoint(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "justTalkedToImpBroker", true);
        trainerlocs.getTrainerLocationWaypoint(player, "imperial", "corellia");
    }
    public void imperial_broker_action_addTatooineImpWaypoint(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "justTalkedToImpBroker", true);
        trainerlocs.getTrainerLocationWaypoint(player, "imperial", "tatooine");
    }
    public void imperial_broker_action_addNabooImpWaypoint(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "justTalkedToImpBroker", true);
        trainerlocs.getTrainerLocationWaypoint(player, "imperial", "naboo");
    }
    public void imperial_broker_action_dismissWoman(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "brokerDismissed", 1);
    }
    public void imperial_broker_action_dismissWookiee(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "brokerDismissed", 2);
    }
    public void imperial_broker_action_dismissRebel(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "brokerDismissed", 3);
    }
    public void imperial_broker_action_retireImperial(obj_id player, obj_id npc)
    {
        space_skill.retire(player, space_skill.IMPERIAL);
    }
    public int imperial_broker_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_broker_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_broker_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_broker_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_broker_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_broker_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_broker_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_broker_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_1b2086de"))
        {
            if (imperial_broker_condition__defaultCondition(player, npc))
    ...
    public int imperial_broker_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_broker_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_1b2086de"))
        {
            if (imperial_broker_condition__defaultCondition(player, npc))
    ...
    public int imperial_broker_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_broker_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_1b2086de"))
        {
            if (imperial_broker_condition__defaultCondition(player, npc))
    ...
    public int imperial_broker_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_broker_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_1b2086de"))
        {
            if (imperial_broker_condition__defaultCondition(player, npc))
    ...
    public int imperial_broker_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_broker_handleBranch30(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_broker_handleBranch32(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_66"))
        {
            if (imperial_broker_condition__defaultCondition(player, npc))
    ...
    public int imperial_broker_handleBranch33(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_broker_handleBranch34(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_66"))
        {
            if (imperial_broker_condition__defaultCondition(player, npc))
    ...
    public int imperial_broker_handleBranch36(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_broker_handleBranch37(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_66"))
        {
            if (imperial_broker_condition__defaultCondition(player, npc))
    ...
    public int imperial_broker_handleBranch39(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_broker_handleBranch40(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_66"))
        {
            if (imperial_broker_condition__defaultCondition(player, npc))
    ...
    public int imperial_broker_handleBranch43(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_broker_handleBranch48(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_broker_handleBranch49(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_broker_handleBranch51(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_broker_handleBranch52(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_broker_handleBranch53(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_115"))
        {
            if (imperial_broker_condition__defaultCondition(player, npc))
    ...
    public int imperial_broker_handleBranch55(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_broker_handleBranch56(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_1b2086de"))
        {
            if (imperial_broker_condition__defaultCondition(player, npc))
    ...
    public int imperial_broker_handleBranch58(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_broker_handleBranch59(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_1b2086de"))
        {
            if (imperial_broker_condition__defaultCondition(player, npc))
