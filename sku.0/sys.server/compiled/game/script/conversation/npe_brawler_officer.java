...
public class npe_brawler_officer extends script.base_script
{
    ...
    public boolean npe_brawler_officer_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_brawler_officer_condition_isTaskActiveStory3(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedTask(player, "npe_brawler_3", "signal") && !groundquests.hasCompletedQuest(player, "npe_brawler_3"));
    }
    public boolean npe_brawler_officer_condition_isTaskActiveBoxes(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedTask(player, "npe_brawler_3", "boxes") && !groundquests.hasCompletedQuest(player, "npe_brawler_3"));
    }
    public boolean npe_brawler_officer_condition_hasCompletedTaskBoxes(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedTask(player, "npe_brawler_3", "boxes") && !groundquests.hasCompletedQuest(player, "npe_brawler_3"));
    }
    public boolean npe_brawler_officer_condition_hasCompletedBoxes(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_brawler_3");
    }
    public void npe_brawler_officer_action_giveSignalBoxes(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "signal");
    }
    public void npe_brawler_officer_action_giveSignalReward(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "officerreward");
    }
    public int npe_brawler_officer_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brawler_officer_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brawler_officer_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
