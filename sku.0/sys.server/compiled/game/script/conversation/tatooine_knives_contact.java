...
public class tatooine_knives_contact extends script.base_script
{
    ...
    public boolean tatooine_knives_contact_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tatooine_knives_contact_condition_onQuest(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_knives_thrust");
        boolean OnTask = (questIsQuestActive(questId1, player));
        return OnTask;
    }
    public boolean tatooine_knives_contact_condition_onTask(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_knives_thrust");
    ...
    public boolean tatooine_knives_contact_condition_questComplete(obj_id player, obj_id npc)
    {
    ...
    public boolean tatooine_knives_contact_condition_onTorP(obj_id player, obj_id npc)
    {
    ...
    public boolean tatooine_knives_contact_condition_isDisabled(obj_id player, obj_id npc)
    {
    ...
    public void tatooine_knives_contact_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void tatooine_knives_contact_action_giveQuest(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/yavin_meganjobs_hyperdrive");
        groundquests.grantQuest(questId, player, npc, true);
    }
    public void tatooine_knives_contact_action_signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "yavin_meganjobs_launch_e14");
    }
    public int tatooine_knives_contact_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_knives_contact_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_knives_contact_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_knives_contact_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_knives_contact_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_knives_contact_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_knives_contact_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
