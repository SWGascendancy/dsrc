...
public class loveday_ewok_cardless_child extends script.base_script
{
    ...
    public boolean loveday_ewok_cardless_child_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean loveday_ewok_cardless_child_condition_returningQuestIncomplete(obj_id player, obj_id npc)
    {
    ...
    public boolean loveday_ewok_cardless_child_condition_returningQuestComplete(obj_id player, obj_id npc)
    {
        if (groundquests.isQuestActive(player, "loveday_ewok_bundle_of_cards"))
        {
            obj_id lovedayCardBundle = utils.getStaticItemInInventory(player, "item_event_loveday_card_stack");
    ...
    public boolean loveday_ewok_cardless_child_condition_notYetReadyForAnother(obj_id player, obj_id npc)
    {
    ...
    public void loveday_ewok_cardless_child_action_grantLovedayQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean loveday_ewok_cardless_child_action_sendCompletionSignal(obj_id player, obj_id npc)
    {
        obj_id lovedayCardBundle = utils.getStaticItemInInventory(player, "item_event_loveday_card_stack");
        if (isIdValid(lovedayCardBundle))
        {
    ...
    public int loveday_ewok_cardless_child_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int loveday_ewok_cardless_child_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
