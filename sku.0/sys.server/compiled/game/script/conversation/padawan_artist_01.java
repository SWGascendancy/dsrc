...
public class padawan_artist_01 extends script.base_script
{
    ...
    public boolean padawan_artist_01_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean padawan_artist_01_condition_isTrialPlayer(obj_id player, obj_id npc)
    {
    ...
    public boolean padawan_artist_01_condition_spokeToTarget(obj_id player, obj_id npc)
    {
        obj_id trialPlayer = getObjIdObjVar(npc, jedi_trials.PADAWAN_TRIAL_PLAYER_OBJVAR);
        if (player == trialPlayer)
        {
    ...
    public boolean padawan_artist_01_condition_acceptedQuest(obj_id player, obj_id npc)
    {
        obj_id trialPlayer = getObjIdObjVar(npc, jedi_trials.PADAWAN_TRIAL_PLAYER_OBJVAR);
        if (player == trialPlayer)
        {
    ...
    public boolean padawan_artist_01_condition_completedSuccess(obj_id player, obj_id npc)
    {
        obj_id trialPlayer = getObjIdObjVar(npc, jedi_trials.PADAWAN_TRIAL_PLAYER_OBJVAR);
        if (player == trialPlayer)
        {
    ...
    public void padawan_artist_01_action_questFailure(obj_id player, obj_id npc)
    {
        setObjVar(npc, "padawan_trials.playerFailed", true);
        messageTo(player, "handleQuestFailure", null, 1, false);
        return;
    }
    public void padawan_artist_01_action_questSuccess(obj_id player, obj_id npc)
    {
        setObjVar(npc, "padawan_trials.playerSucceeded", true);
        messageTo(player, "handleTrialComplete", null, 1, false);
        return;
    }
    public void padawan_artist_01_action_sendToNextNpc(obj_id player, obj_id npc)
    {
    ...
    public int padawan_artist_01_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int padawan_artist_01_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int padawan_artist_01_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int padawan_artist_01_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int padawan_artist_01_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int padawan_artist_01_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
