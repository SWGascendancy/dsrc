...
public class c_newbie_doctor extends script.base_script
{
    ...
    public boolean c_newbie_doctor_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_newbie_doctor_condition_onMedCenterStep(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean c_newbie_doctor_condition_hasScreen(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public void c_newbie_doctor_action_forwardQuest(obj_id player, obj_id npc)
    {
    ...
    public void c_newbie_doctor_action_faceplayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int c_newbie_doctor_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_newbie_doctor_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_newbie_doctor_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_newbie_doctor_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_newbie_doctor_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_415"))
        {
            if (c_newbie_doctor_condition__defaultCondition(player, npc))
