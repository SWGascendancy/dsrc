...
public class echo_base_launch extends script.base_script
{
    ...
    public boolean echo_base_launch_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean echo_base_launch_condition_bothRebel(obj_id player, obj_id npc)
    {
        return (factions.isRebel(npc) && factions.isRebel(player));
    }
    public boolean echo_base_launch_condition_bothImperial(obj_id player, obj_id npc)
    {
        return (factions.isImperial(npc) && factions.isImperial(player));
    }
    public boolean echo_base_launch_condition_npcRebelPlayerImperial(obj_id player, obj_id npc)
    {
        return (factions.isRebel(npc) && factions.isImperial(player));
    }
    public boolean echo_base_launch_condition_npcImperialPlayerRebel(obj_id player, obj_id npc)
    {
        return (factions.isImperial(npc) && factions.isRebel(player));
    }
    public boolean echo_base_launch_condition_disableRebel(obj_id player, obj_id npc)
    {
        return false;
    }
    public boolean echo_base_launch_condition_disableImperial(obj_id player, obj_id npc)
    {
        return false;
    }
    public boolean echo_base_launch_condition_Rebel_awaitingInstance(obj_id player, obj_id npc)
    {
        return buff.hasBuff(player, "instance_launching") && factions.isRebel(npc) && factions.isRebel(player);
    }
    public boolean echo_base_launch_condition_Imperial_awaitingInstance(obj_id player, obj_id npc)
    {
        return buff.hasBuff(player, "instance_launching") && factions.isImperial(npc) && factions.isImperial(player);
    }
    public boolean echo_base_launch_condition_tooSmallGroup(obj_id player, obj_id npc)
    {
    ...
    public boolean echo_base_launch_condition_isNotCorrectLevel(obj_id player, obj_id npc)
    {
        return getLevel(player) < township.MIN_LEVEL;
    }
    public void echo_base_launch_action_launchRebel(obj_id player, obj_id npc)
    {
    ...
    public void echo_base_launch_action_launchImperial(obj_id player, obj_id npc)
    {
        if (!instance.isFlaggedForInstance(player, "echo_base"))
        {
            instance.flagPlayerForInstance(player, "echo_base");
    ...
    public void echo_base_launch_action_showEchoBaseVendorSui(obj_id player, obj_id npc)
    {
    ...
    public int echo_base_launch_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int echo_base_launch_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int echo_base_launch_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int echo_base_launch_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
