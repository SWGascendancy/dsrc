...
public class ep3_wookiee_slave extends script.base_script
{
    ...
    public boolean ep3_wookiee_slave_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_wookiee_slave_condition_hasFinishedQuest1(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/ep3_wookiee_benefactor_1");
        return questIsQuestComplete(questId, player);
    }
    public boolean ep3_wookiee_slave_condition_hasFinishedQuest2(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/ep3_wookiee_benefactor_2");
        return questIsQuestComplete(questId, player);
    }
    public boolean ep3_wookiee_slave_condition_hasFinishedQuest3(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/ep3_wookiee_benefactor_3");
        return questIsQuestComplete(questId, player);
    }
    public boolean ep3_wookiee_slave_condition_isOnQuest1(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/ep3_wookiee_benefactor_1");
        return questIsQuestActive(questId, player);
    }
    public boolean ep3_wookiee_slave_condition_isOnQuest2(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/ep3_wookiee_benefactor_2");
        return questIsQuestActive(questId, player);
    }
    public boolean ep3_wookiee_slave_condition_hasFinishedRodianQuest1(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/ep3_rodian_hunter_1");
        return questIsQuestComplete(questId, player);
    }
    public void ep3_wookiee_slave_action_giveQuestOne(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/ep3_wookiee_benefactor_1");
        questActivateQuest(questId, player, npc);
    }
    public void ep3_wookiee_slave_action_giveQuestTwo(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/ep3_wookiee_benefactor_2");
        questActivateQuest(questId, player, npc);
    }
    public void ep3_wookiee_slave_action_clearQuests(obj_id player, obj_id npc)
    {
    ...
    public void ep3_wookiee_slave_action_speak_SHORT(obj_id player, obj_id npc)
    {
        playClientEffectLoc(player, "clienteffect/voc_npc_cnv_rodian_short.cef", getLocation(npc), 0f);
    }
    public void ep3_wookiee_slave_action_speak_MEDIUM(obj_id player, obj_id npc)
    {
        playClientEffectLoc(player, "clienteffect/voc_npc_cnv_rodian_medium.cef", getLocation(npc), 0f);
    }
    public void ep3_wookiee_slave_action_speak_LONG(obj_id player, obj_id npc)
    {
        playClientEffectLoc(player, "clienteffect/voc_npc_cnv_rodian_long.cef", getLocation(npc), 0f);
    }
    public void ep3_wookiee_slave_action_giveQuestThree(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/ep3_rodian_hunter_3");
        questActivateQuest(questId, player, npc);
    }
    public int ep3_wookiee_slave_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
