...
public class emp_day_vader extends script.base_script
{
    ...
    public boolean emp_day_vader_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean emp_day_vader_condition_hasTask7(obj_id player, obj_id npc)
    {
    ...
    public void emp_day_vader_action_signal7(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "to_vader");
        sendSystemMessage(player, new string_id("event/empire_day", "sys_msg_return"));
    }
    public int emp_day_vader_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_vader_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_vader_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
