...
public class corellia_disappearances_2_hermit extends script.base_script
{
    ...
    public boolean corellia_disappearances_2_hermit_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_disappearances_2_hermit_condition_playerFinishedWithFirstHermit(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "corellia_disappearances_2_hermit", "talktohermit");
    }
    public boolean corellia_disappearances_2_hermit_condition_playerOnHermitStep(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_disappearances_2_hermit", "talktohermit");
    }
    public boolean corellia_disappearances_2_hermit_condition_playerOn3rdHermit(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_disappearances_3_trial", "hermit2");
    }
    public boolean corellia_disappearances_2_hermit_condition_playerOn2ndHermit(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_disappearances_3_trial", "hermit1");
    }
    public void corellia_disappearances_2_hermit_action_signalFirstQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "corellia_disappearances_2_hermit_1");
    }
    public void corellia_disappearances_2_hermit_action_signalSecondQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "corellia_disappearances_3_hermit");
    }
    public void corellia_disappearances_2_hermit_action_signalThirdQuestHermit1(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "corellia_disappearances_3_hermit1");
    }
    public void corellia_disappearances_2_hermit_action_signalThirdQuestHermit2(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "corellia_disappearances_3_hermit2");
    }
    public int corellia_disappearances_2_hermit_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_disappearances_2_hermit_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_disappearances_2_hermit_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_disappearances_2_hermit_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_disappearances_2_hermit_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_disappearances_2_hermit_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_disappearances_2_hermit_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_disappearances_2_hermit_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_disappearances_2_hermit_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_disappearances_2_hermit_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
