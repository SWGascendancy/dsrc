...
public class ep3_mining_thom_steele extends script.base_script
{
    ...
    public boolean ep3_mining_thom_steele_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_mining_thom_steele_condition_hasCompletedQuestOne(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedQuest(player, "ep3_mining_quest_1"));
    }
    public boolean ep3_mining_thom_steele_condition_isQuestOneActive(obj_id player, obj_id npc)
    {
        return (groundquests.isQuestActive(player, "ep3_mining_quest_1"));
    }
    public boolean ep3_mining_thom_steele_condition_isQuestTwoActive(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_mining_thom_steele_condition_canTakeQuestTwo(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_mining_thom_steele_condition_canTakeQuestThree(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_mining_thom_steele_condition_isQuestThreeActive(obj_id player, obj_id npc)
    {
        return space_quest.hasQuest(player, "space_mining_destroy", "corellia_mining_quest_3");
    }
    public boolean ep3_mining_thom_steele_condition_hasCompletedQuestTwo(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_mining_thom_steele_condition_hasBeenRewardedForQuestTwo(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_mining_thom_steele_condition_hasCompletedQuestThree(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_mining_thom_steele_condition_completedAll(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_mining_thom_steele_condition_canTakeQuestFour(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_mining_thom_steele_condition_isQuestFourActive(obj_id player, obj_id npc)
    {
        return (groundquests.isQuestActive(player, "ep3_mining_quest_4"));
    }
    public boolean ep3_mining_thom_steele_condition_hasFailedQuestTwo(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_mining_thom_steele_condition_hasFailedQuestThree(obj_id player, obj_id npc)
    {
    ...
    public void ep3_mining_thom_steele_action_sendSignalToPlayer(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedToThom");
    }
    public void ep3_mining_thom_steele_action_grantQuest2(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "patrol", "corellia_mining_quest_2");
        space_flags.restoreClientPath(player);
    }
    public void ep3_mining_thom_steele_action_grantQuest3(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "space_mining_destroy", "corellia_mining_quest_3");
    }
    public void ep3_mining_thom_steele_action_giveReward2(obj_id player, obj_id npc)
    {
    ...
    public void ep3_mining_thom_steele_action_giveReward3(obj_id player, obj_id npc)
    {
    ...
    public void ep3_mining_thom_steele_action_grantQuest4(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_mining_quest_4");
    }
    public int ep3_mining_thom_steele_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_mining_thom_steele_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_mining_thom_steele_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_mining_thom_steele_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_mining_thom_steele_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_mining_thom_steele_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_mining_thom_steele_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_mining_thom_steele_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_mining_thom_steele_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_mining_thom_steele_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_mining_thom_steele_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_mining_thom_steele_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_mining_thom_steele_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_mining_thom_steele_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_mining_thom_steele_handleBranch30(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_mining_thom_steele_handleBranch31(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_mining_thom_steele_handleBranch32(obj_id player, obj_id npc, string_id response)
    {
