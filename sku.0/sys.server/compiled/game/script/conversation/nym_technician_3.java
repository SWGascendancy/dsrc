...
public class nym_technician_3 extends script.base_script
{
    ...
    public boolean nym_technician_3_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean nym_technician_3_condition_isOnStormSquadronQuest(obj_id player, obj_id npc)
    {
        return space_flags.hasSpaceFlag(player, "ss.findingAgent");
    }
    public boolean nym_technician_3_condition_isHuntingShip(obj_id player, obj_id npc)
    {
        return space_flags.hasSpaceFlag(player, "ss.huntingShip");
    }
    public boolean nym_technician_3_condition_isOnQuest(obj_id player, obj_id npc)
    {
        return space_quest.hasQuest(player, "assassinate", "imperial_ss_3");
    }
    public boolean nym_technician_3_condition_questDone(obj_id player, obj_id npc)
    {
        return space_quest.hasCompletedQuest(player, "assassinate", "imperial_ss_3");
    }
    public boolean nym_technician_3_condition_failedQuest(obj_id player, obj_id npc)
    {
    ...
    public void nym_technician_3_action_grantAssassinateMission(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "assassinate", "imperial_ss_3");
    }
    public int nym_technician_3_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_technician_3_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_technician_3_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_technician_3_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_technician_3_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_technician_3_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_technician_3_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_technician_3_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
