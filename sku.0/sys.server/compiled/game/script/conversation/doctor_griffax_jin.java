...
public class doctor_griffax_jin extends script.base_script
{
    ...
    public boolean doctor_griffax_jin_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean doctor_griffax_jin_condition_hasTask(obj_id player, obj_id npc)
    {
    ...
    public void doctor_griffax_jin_action_transformMonster(obj_id player, obj_id npc)
    {
    ...
    public int doctor_griffax_jin_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int doctor_griffax_jin_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int doctor_griffax_jin_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int doctor_griffax_jin_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int doctor_griffax_jin_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int transformIntoMonster(obj_id self, dictionary params)
    {
