...
public class ep3_kachirho_trando_rifle extends script.base_script
{
    ...
    public boolean ep3_kachirho_trando_rifle_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_kachirho_trando_rifle_condition_hasBowcaster(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_kachirho_trando_rifle", "returnKressik");
    }
    public boolean ep3_kachirho_trando_rifle_condition_isMasterWeaponSmith(obj_id player, obj_id npc)
    {
        return hasSkill(player, "crafting_weaponsmith_master");
    }
    public boolean ep3_kachirho_trando_rifle_condition_hasRifleSchematic(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_kachirho_trando_rifle");
    }
    public boolean ep3_kachirho_trando_rifle_condition_isOnMission(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_kachirho_trando_rifle");
    }
    public void ep3_kachirho_trando_rifle_action_grantRifleSchematic(obj_id player, obj_id npc)
    {
    ...
    public void ep3_kachirho_trando_rifle_action_grantMission(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_kachirho_trando_rifle");
    }
    public int ep3_kachirho_trando_rifle_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_trando_rifle_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_trando_rifle_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_trando_rifle_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_trando_rifle_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_trando_rifle_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_trando_rifle_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_trando_rifle_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_trando_rifle_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_trando_rifle_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
