...
public class biogenic_scientist_human extends script.base_script
{
    ...
    public boolean biogenic_scientist_human_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean biogenic_scientist_human_condition_get_tracker_2(obj_id player, obj_id npc)
    {
    ...
    public boolean biogenic_scientist_human_condition_get_tracker_1(obj_id player, obj_id npc)
    {
        int tracker = getIntObjVar(player, "biogenic.scientist_human_convo");
        if (tracker == 1)
        {
    ...
    public boolean biogenic_scientist_human_condition_get_tracker_3(obj_id player, obj_id npc)
    {
        int tracker = getIntObjVar(player, "biogenic.scientist_human_convo");
        if (tracker == 3)
        {
    ...
    public void biogenic_scientist_human_action_give_schematic(obj_id player, obj_id npc)
    {
    ...
    public void biogenic_scientist_human_action_set_tracker_1(obj_id player, obj_id npc)
    {
        setObjVar(player, "biogenic.scientist_human_convo", 1);
    }
    public void biogenic_scientist_human_action_face_to(obj_id player, obj_id npc)
    {
        faceToBehavior(npc, player);
    }
    public void biogenic_scientist_human_action_set_tracker_3(obj_id player, obj_id npc)
    {
        faceToBehavior(npc, player);
        setObjVar(player, "biogenic.scientist_human_convo", 3);
    }
    public int biogenic_scientist_human_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int biogenic_scientist_human_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int biogenic_scientist_human_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int biogenic_scientist_human_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_4136c2df"))
        {
            if (biogenic_scientist_human_condition__defaultCondition(player, npc))
    ...
    public int biogenic_scientist_human_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int biogenic_scientist_human_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int biogenic_scientist_human_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_4136c2df"))
        {
            if (biogenic_scientist_human_condition__defaultCondition(player, npc))
    ...
    public int biogenic_scientist_human_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_259e4732"))
        {
            if (biogenic_scientist_human_condition__defaultCondition(player, npc))
    ...
    public int biogenic_scientist_human_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_259e4732"))
        {
            if (biogenic_scientist_human_condition__defaultCondition(player, npc))
    ...
    public int biogenic_scientist_human_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_4136c2df"))
        {
            if (biogenic_scientist_human_condition__defaultCondition(player, npc))
    ...
    public int biogenic_scientist_human_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int biogenic_scientist_human_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_4136c2df"))
        {
            if (biogenic_scientist_human_condition__defaultCondition(player, npc))
    ...
    public int biogenic_scientist_human_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_4136c2df"))
        {
            if (biogenic_scientist_human_condition__defaultCondition(player, npc))
    ...
    public int biogenic_scientist_human_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int biogenic_scientist_human_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_4136c2df"))
        {
            if (biogenic_scientist_human_condition__defaultCondition(player, npc))
    ...
    public int biogenic_scientist_human_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_4136c2df"))
        {
            if (biogenic_scientist_human_condition__defaultCondition(player, npc))
