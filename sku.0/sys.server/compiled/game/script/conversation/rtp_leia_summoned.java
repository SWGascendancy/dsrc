...
public class rtp_leia_summoned extends script.base_script
{
    ...
    public boolean rtp_leia_summoned_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean rtp_leia_summoned_condition_leia02TaskActive(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "rtp_leia_02", "rtp_leia_02_03");
    }
    public boolean rtp_leia_summoned_condition_leia02TaskComplete(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "rtp_leia_02");
    }
    public void rtp_leia_summoned_action_leia02Signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "rtp_leia_02_03");
    }
    public void rtp_leia_summoned_action_leia03Granted(obj_id player, obj_id npc)
    {
    ...
    public int rtp_leia_summoned_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int leiaWalkThenDisappear(obj_id self, dictionary params)
    {
    ...
    public int leiaMakeSureLeiaDespawns(obj_id self, dictionary params)
    {
        destroyObject(self);
        return SCRIPT_CONTINUE;
    }
