...
public class som_kenobi_pwwoz_pwwa extends script.base_script
{
    ...
    public boolean som_kenobi_pwwoz_pwwa_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean som_kenobi_pwwoz_pwwa_condition_playerJedi(obj_id player, obj_id npc)
    {
        return jedi.isForceSensitive(player);
    }
    public boolean som_kenobi_pwwoz_pwwa_condition_foundCrystal(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "som_kenobi_samaritan_1", "returnPwwoz");
    }
    public boolean som_kenobi_pwwoz_pwwa_condition_onQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "som_kenobi_samaritan_1");
    }
    public boolean som_kenobi_pwwoz_pwwa_condition_keptCrystal(obj_id player, obj_id npc)
    {
    ...
    public boolean som_kenobi_pwwoz_pwwa_condition_gaveCrystal(obj_id player, obj_id npc)
    {
    ...
    public boolean som_kenobi_pwwoz_pwwa_condition_killPwwoz(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "som_kenobi_samaritan_1", "killIthorian");
    }
    public void som_kenobi_pwwoz_pwwa_action_giveQuest1(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "som_kenobi_samaritan_1");
    }
    public void som_kenobi_pwwoz_pwwa_action_removeInvuln(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "giveCrystal");
        setInvulnerable(npc, false);
        clearCondition(npc, CONDITION_INTERESTING);
    }
    public void som_kenobi_pwwoz_pwwa_action_attack(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "giveCrystal");
        startCombat(npc, player);
        clearCondition(npc, CONDITION_CONVERSABLE);
    }
    public void som_kenobi_pwwoz_pwwa_action_signalKeep(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "keepCrystal");
    }
    public void som_kenobi_pwwoz_pwwa_action_secondAttack(obj_id player, obj_id npc)
    {
        clearCondition(npc, CONDITION_CONVERSABLE);
        startCombat(npc, player);
    }
    public void som_kenobi_pwwoz_pwwa_action_removeInvuln2(obj_id player, obj_id npc)
    {
        setInvulnerable(npc, false);
        clearCondition(npc, CONDITION_INTERESTING);
    }
    public int som_kenobi_pwwoz_pwwa_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_pwwoz_pwwa_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_pwwoz_pwwa_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_pwwoz_pwwa_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_pwwoz_pwwa_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_pwwoz_pwwa_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_pwwoz_pwwa_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_pwwoz_pwwa_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_pwwoz_pwwa_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_pwwoz_pwwa_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_pwwoz_pwwa_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_pwwoz_pwwa_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_pwwoz_pwwa_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_pwwoz_pwwa_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_pwwoz_pwwa_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_pwwoz_pwwa_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_pwwoz_pwwa_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_pwwoz_pwwa_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_pwwoz_pwwa_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_pwwoz_pwwa_handleBranch32(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_pwwoz_pwwa_handleBranch33(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_pwwoz_pwwa_handleBranch34(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_pwwoz_pwwa_handleBranch35(obj_id player, obj_id npc, string_id response)
    {
