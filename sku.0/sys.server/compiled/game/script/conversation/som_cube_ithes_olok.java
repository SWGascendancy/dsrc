...
public class som_cube_ithes_olok extends script.base_script
{
    ...
    public boolean som_cube_ithes_olok_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean som_cube_ithes_olok_condition_isOnQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "som_jenha_tar_cube");
    }
    public boolean som_cube_ithes_olok_condition_hasNotes(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "som_jenha_tar_cube", "take_notes");
    }
    public boolean som_cube_ithes_olok_condition_completedQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "som_jenha_tar_cube");
    }
    public boolean som_cube_ithes_olok_condition_lostCube(obj_id player, obj_id npc)
    {
    ...
    public void som_cube_ithes_olok_action_grantCubeQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "som_jenha_tar_cube");
    }
    public void som_cube_ithes_olok_action_sendCompleteSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "somCubeSuccess");
    }
    public void som_cube_ithes_olok_action_giveAnotherCube(obj_id player, obj_id npc)
    {
        createObjectInInventoryAllowOverload("object/tangible/container/loot/som_cube.iff", player);
    }
    public int som_cube_ithes_olok_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_cube_ithes_olok_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_cube_ithes_olok_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_cube_ithes_olok_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_cube_ithes_olok_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_127"))
        {
            if (som_cube_ithes_olok_condition__defaultCondition(player, npc))
    ...
    public int som_cube_ithes_olok_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_cube_ithes_olok_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_cube_ithes_olok_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_127"))
        {
            if (som_cube_ithes_olok_condition__defaultCondition(player, npc))
    ...
    public int som_cube_ithes_olok_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_cube_ithes_olok_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_cube_ithes_olok_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_cube_ithes_olok_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_cube_ithes_olok_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_cube_ithes_olok_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_cube_ithes_olok_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_cube_ithes_olok_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_cube_ithes_olok_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_cube_ithes_olok_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_cube_ithes_olok_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_cube_ithes_olok_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_cube_ithes_olok_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_cube_ithes_olok_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_cube_ithes_olok_handleBranch30(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_cube_ithes_olok_handleBranch31(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_cube_ithes_olok_handleBranch32(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_cube_ithes_olok_handleBranch33(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_cube_ithes_olok_handleBranch45(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_61"))
        {
            if (som_cube_ithes_olok_condition__defaultCondition(player, npc))
    ...
    public int som_cube_ithes_olok_handleBranch48(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_56"))
        {
            if (som_cube_ithes_olok_condition__defaultCondition(player, npc))
    ...
    public int som_cube_ithes_olok_handleBranch51(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_cube_ithes_olok_handleBranch52(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_48"))
        {
            if (som_cube_ithes_olok_condition__defaultCondition(player, npc))
