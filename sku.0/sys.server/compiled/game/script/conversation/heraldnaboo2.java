...
public class heraldnaboo2 extends script.base_script
{
    ...
    public boolean heraldnaboo2_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public void heraldnaboo2_action_waypoint1(obj_id player, obj_id npc)
    {
    ...
    public void heraldnaboo2_action_waypoint2(obj_id player, obj_id npc)
    {
    ...
    public void heraldnaboo2_action_check(obj_id player, obj_id npc)
    {
        doAnimationAction(npc, "check_wrist_device");
    }
    public int heraldnaboo2_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int heraldnaboo2_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int heraldnaboo2_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int heraldnaboo2_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
