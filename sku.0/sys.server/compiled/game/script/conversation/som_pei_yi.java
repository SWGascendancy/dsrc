...
public class som_pei_yi extends script.base_script
{
    ...
    public boolean som_pei_yi_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean som_pei_yi_condition_isEntertainer(obj_id player, obj_id npc)
    {
        int level = getLevel(player);
        return (utils.isProfession(player, utils.ENTERTAINER) && level >= 46);
    }
    public boolean som_pei_yi_condition_isDancer(obj_id player, obj_id npc)
    {
        return hasSkill(player, "social_dancer_novice");
    }
    public boolean som_pei_yi_condition_hasDance(obj_id player, obj_id npc)
    {
        return hasCommand(player, "startDance+peiyi");
    }
    public void som_pei_yi_action_grantDance(obj_id player, obj_id npc)
    {
        sendSystemMessage(player, new string_id("som/som_quest", "grant_dance"));
        grantCommand(player, "startDance+peiyi");
    }
    public int som_pei_yi_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_pei_yi_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_pei_yi_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_pei_yi_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_pei_yi_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_pei_yi_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_33"))
        {
            if (som_pei_yi_condition__defaultCondition(player, npc))
    ...
    public int som_pei_yi_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_pei_yi_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_pei_yi_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_pei_yi_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
