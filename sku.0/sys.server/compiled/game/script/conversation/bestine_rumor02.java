...
public class bestine_rumor02 extends script.base_script
{
    ...
    public boolean bestine_rumor02_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean bestine_rumor02_condition_nonoffice(obj_id player, obj_id npc)
    {
        return hasObjVar(npc, "bestine.electionEnded");
    }
    public void bestine_rumor02_action__defaultAction(obj_id player, obj_id npc)
    {
    }
