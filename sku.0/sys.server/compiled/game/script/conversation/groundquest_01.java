...
public class groundquest_01 extends script.base_script
{
    ...
    public boolean groundquest_01_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean groundquest_01_condition_hasQuest_kill_3_valarian_assassins(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/kill_3_valarian_assassins");
        return questIsQuestActive(questId, player);
    }
    public boolean groundquest_01_condition_wonQuest_kill_3_valarian_assassins(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/kill_3_valarian_assassins");
        return questIsQuestComplete(questId, player);
    }
    public void groundquest_01_action_grantQuest_kill_2_womprats(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/kill_2_womprats");
        questActivateQuest(questId, player, npc);
    }
    public void groundquest_01_action_grantQuest_kill_3_womprats(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/kill_3_womprats");
        questActivateQuest(questId, player, npc);
    }
    public void groundquest_01_action_grantQuest_kill_3_valarian_assassins(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/kill_3_valarian_assassins");
        questActivateQuest(questId, player, npc);
    }
    public void groundquest_01_action_clearQuest_kill_3_valarian_assassins(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/kill_3_valarian_assassins");
        questClearQuest(questId, player);
    }
    public int groundquest_01_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int groundquest_01_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int groundquest_01_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int groundquest_01_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
