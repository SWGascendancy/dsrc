...
public class padawan_pannaqa_03 extends script.base_script
{
    ...
    public boolean padawan_pannaqa_03_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean padawan_pannaqa_03_condition_isTrialPlayer(obj_id player, obj_id npc)
    {
    ...
    public void padawan_pannaqa_03_action_sendBackBeginning(obj_id player, obj_id npc)
    {
