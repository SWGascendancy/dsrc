...
public class ep3_clone_relics_clone_trooper_jabba extends script.base_script
{
    ...
    public boolean ep3_clone_relics_clone_trooper_jabba_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_clone_relics_clone_trooper_jabba_condition_talkToJabba2(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "ep3_clone_relics_clone_trooper_mort_neutral", "datapadToJabba"));
    }
    public boolean ep3_clone_relics_clone_trooper_jabba_condition_talkToJabba1(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "ep3_clone_relics_clone_trooper_mort_neutral", "jabbaMeeting1"));
    }
    public void ep3_clone_relics_clone_trooper_jabba_action_spokenToJabba1(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedJabba1");
    }
    public void ep3_clone_relics_clone_trooper_jabba_action_spokenToJabba2(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "datapadReturned");
    }
    public int ep3_clone_relics_clone_trooper_jabba_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_jabba_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_jabba_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_jabba_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_jabba_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_jabba_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
