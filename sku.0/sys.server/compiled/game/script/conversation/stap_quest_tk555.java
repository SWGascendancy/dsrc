...
public class stap_quest_tk555 extends script.base_script
{
    ...
    public boolean stap_quest_tk555_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean stap_quest_tk555_condition_stapQuestActive(obj_id player, obj_id npc)
    {
    ...
    public boolean stap_quest_tk555_condition_alreadyHasStap(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "boughtStap");
    }
    public void stap_quest_tk555_action_moveAlong(obj_id player, obj_id npc)
    {
        playMusic(player, "sound/voice_stormtrooper_move_along.snd");
    }
    public void stap_quest_tk555_action_finishTask_hasStap(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedTK");
        groundquests.sendSignal(player, "hasStap");
    }
    public void stap_quest_tk555_action_finishTask_needsStap(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedTK");
        groundquests.sendSignal(player, "needsStap");
    }
    public int stap_quest_tk555_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int stap_quest_tk555_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int stap_quest_tk555_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int stap_quest_tk555_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int stap_quest_tk555_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int stap_quest_tk555_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
