...
public class ep3_clone_relics_clone_trooper_morkov_courier extends script.base_script
{
    ...
    public boolean ep3_clone_relics_clone_trooper_morkov_courier_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_clone_relics_clone_trooper_morkov_courier_condition_courierChat(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "ep3_clone_relics_clone_trooper_mort_1", "meetingCourier"));
    }
    public void ep3_clone_relics_clone_trooper_morkov_courier_action_fight(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedToCourier");
        setInvulnerable(npc, false);
        clearCondition(npc, CONDITION_CONVERSABLE);
    }
    public int ep3_clone_relics_clone_trooper_morkov_courier_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_morkov_courier_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
