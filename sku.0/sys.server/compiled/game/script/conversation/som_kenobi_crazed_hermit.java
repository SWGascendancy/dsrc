...
public class som_kenobi_crazed_hermit extends script.base_script
{
    ...
    public boolean som_kenobi_crazed_hermit_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean som_kenobi_crazed_hermit_condition_playerJedi(obj_id player, obj_id npc)
    {
        return jedi.isForceSensitive(player);
    }
    public boolean som_kenobi_crazed_hermit_condition_hermitChat2(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "som_kenobi_main_quest_1", "talkHermit2");
    }
    public boolean som_kenobi_crazed_hermit_condition_hermitChat1(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "som_kenobi_main_quest_1", "talkHermit1");
    }
    public boolean som_kenobi_crazed_hermit_condition_underAttack(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "som_kenobi_main_quest_1", "attacked");
    }
    public void som_kenobi_crazed_hermit_action_signalTalked1(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedHermit1");
    }
    public void som_kenobi_crazed_hermit_action_removeInvuln(obj_id player, obj_id npc)
    {
        setInvulnerable(npc, false);
    }
    public void som_kenobi_crazed_hermit_action_attack(obj_id player, obj_id npc)
    {
        startCombat(npc, player);
        clearCondition(npc, CONDITION_CONVERSABLE);
    }
    public void som_kenobi_crazed_hermit_action_signalTalked2(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedHermit2");
    }
    public int som_kenobi_crazed_hermit_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_crazed_hermit_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_crazed_hermit_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_crazed_hermit_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_crazed_hermit_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_crazed_hermit_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_crazed_hermit_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_crazed_hermit_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_crazed_hermit_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_crazed_hermit_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_crazed_hermit_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_crazed_hermit_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_crazed_hermit_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_crazed_hermit_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_crazed_hermit_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
