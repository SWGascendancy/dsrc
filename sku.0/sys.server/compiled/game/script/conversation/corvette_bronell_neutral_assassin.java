...
public class corvette_bronell_neutral_assassin extends script.base_script
{
    ...
    public boolean corvette_bronell_neutral_assassin_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corvette_bronell_neutral_assassin_condition_knowsLocation3(obj_id player, obj_id npc)
    {
        return utils.hasScriptVar(player, "corl_corvette.heardLocation3");
    }
    public boolean corvette_bronell_neutral_assassin_condition_knowsLocation2(obj_id player, obj_id npc)
    {
        return utils.hasScriptVar(player, "corl_corvette.heardLocation2");
    }
    public boolean corvette_bronell_neutral_assassin_condition_knowsLocation1(obj_id player, obj_id npc)
    {
        return utils.hasScriptVar(player, "corl_corvette.heardLocation1");
    }
    public boolean corvette_bronell_neutral_assassin_condition_knowsAllLocations(obj_id player, obj_id npc)
    {
    ...
    public boolean corvette_bronell_neutral_assassin_condition_hasStuff(obj_id player, obj_id npc)
    {
    ...
    public boolean corvette_bronell_neutral_assassin_condition_hasObject01(obj_id player, obj_id npc)
    {
        return utils.playerHasItemByTemplate(player, "object/tangible/loot/dungeon/corellian_corvette/neutral_assassin_intel.iff");
    }
    public boolean corvette_bronell_neutral_assassin_condition_hasObject02(obj_id player, obj_id npc)
    {
    ...
    public boolean corvette_bronell_neutral_assassin_condition_hasObject03(obj_id player, obj_id npc)
    {
    ...
    public boolean corvette_bronell_neutral_assassin_condition_isGm(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "gm");
    }
    public boolean corvette_bronell_neutral_assassin_condition_hasTravelTicket(obj_id player, obj_id npc)
    {
    ...
    public boolean corvette_bronell_neutral_assassin_condition_hasNoObjectsAndNoTicket(obj_id player, obj_id npc)
    {
    ...
    public boolean corvette_bronell_neutral_assassin_condition_isOnQuest(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "corl_corvette.neutral_assassin");
    }
    public boolean corvette_bronell_neutral_assassin_condition_onDifferentCorvetteQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean corvette_bronell_neutral_assassin_condition_earnedCorvetteReward(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "corvette.neutral_assassin.finished");
    }
    public boolean corvette_bronell_neutral_assassin_condition_hasInventorySpace(obj_id player, obj_id npc)
    {
    ...
    public void corvette_bronell_neutral_assassin_action__defaultAction(obj_id player, obj_id npc)
    {
    }
    public void corvette_bronell_neutral_assassin_action_heardLocation1(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "corl_corvette.heardLocation1", 1);
        return;
    }
    public void corvette_bronell_neutral_assassin_action_heardLocation2(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "corl_corvette.heardLocation2", 1);
        return;
    }
    public void corvette_bronell_neutral_assassin_action_heardLocation3(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "corl_corvette.heardLocation3", 1);
        return;
    }
    public void corvette_bronell_neutral_assassin_action_acceptsQuest(obj_id player, obj_id npc)
    {
    ...
    public void corvette_bronell_neutral_assassin_action_clearLocations(obj_id player, obj_id npc)
    {
    ...
    public void corvette_bronell_neutral_assassin_action_giveTicket(obj_id player, obj_id npc)
    {
    ...
    public void corvette_bronell_neutral_assassin_action_giveDocuments(obj_id player, obj_id npc)
    {
        obj_id playerInv = utils.getInventoryContainer(player);
    ...
    public void corvette_bronell_neutral_assassin_action_quitCorvetteQuest(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "corl_corvette"))
        {
    ...
    public void corvette_bronell_neutral_assassin_action_removeTicket(obj_id player, obj_id npc)
    {
    ...
    public void corvette_bronell_neutral_assassin_action_takeDoc2(obj_id player, obj_id npc)
    {
    ...
    public void corvette_bronell_neutral_assassin_action_takeDoc1(obj_id player, obj_id npc)
    {
    ...
    public void corvette_bronell_neutral_assassin_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return;
    }
    public void corvette_bronell_neutral_assassin_action_giveCorvetteReward(obj_id player, obj_id npc)
    {
