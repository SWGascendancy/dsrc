...
public class quest_u10_draykken_bender extends script.base_script
{
    ...
    public boolean quest_u10_draykken_bender_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean quest_u10_draykken_bender_condition_quest_u10_01_02_active(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "quest_u10_01", "quest_u10_01_02");
    }
    public boolean quest_u10_draykken_bender_condition_quest_u10_01_03_active(obj_id player, obj_id npc)
    {
    ...
    public boolean quest_u10_draykken_bender_condition_quest_u10_02_needed(obj_id player, obj_id npc)
    {
        return !groundquests.isQuestActiveOrComplete(player, "quest_u10_02");
    }
    public boolean quest_u10_draykken_bender_condition_quest_u10_01_01_active(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "quest_u10_01", "quest_u10_01_01");
    }
    public void quest_u10_draykken_bender_action_quest_u10_01_01_signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "quest_u10_01_01");
    }
    public void quest_u10_draykken_bender_action_quest_u10_02_grant(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "quest_u10_02");
    }
    public void quest_u10_draykken_bender_action_quest_u10_01_03_signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "quest_u10_01_03");
    }
    public int quest_u10_draykken_bender_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_u10_draykken_bender_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
