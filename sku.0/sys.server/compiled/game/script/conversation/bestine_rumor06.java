...
public class bestine_rumor06 extends script.base_script
{
    ...
    public boolean bestine_rumor06_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean bestine_rumor06_condition_nonoffice(obj_id player, obj_id npc)
    {
        return hasObjVar(npc, "bestine.electionEnded");
    }
    public void bestine_rumor06_action__defaultAction(obj_id player, obj_id npc)
    {
    }
