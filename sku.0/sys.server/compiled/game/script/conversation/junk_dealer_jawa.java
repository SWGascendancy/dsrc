...
public class junk_dealer_jawa extends script.base_script
{
    ...
    public boolean junk_dealer_jawa_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean junk_dealer_jawa_condition_hasNoInv(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean junk_dealer_jawa_condition_hasBuyBackItems(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        obj_id[] listOfBuyBacks = smuggler.getBuyBackItemsInContainer(player);
        return listOfBuyBacks != null && listOfBuyBacks.length > 0;
    }
    public boolean junk_dealer_jawa_condition_checkBuyBackContainer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public void junk_dealer_jawa_action_start_dealing(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        messageTo(npc, "startDealing", params, 0.0f, false);
    }
    public void junk_dealer_jawa_action_face_to(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void junk_dealer_jawa_action_startBuyBack(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        messageTo(npc, "startBuyBack", params, 0.0f, false);
    }
    public void junk_dealer_jawa_action_createBuyBackContainer(obj_id player, obj_id npc)
    {
    ...
    public void junk_dealer_jawa_action_startFlagNoSale(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        messageTo(npc, "startFlaggingItemsNoSale", params, 0.0f, false);
    }
    public int junk_dealer_jawa_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int junk_dealer_jawa_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
