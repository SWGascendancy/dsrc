...
public class npe_entertainer_side_i_questgiver extends script.base_script
{
    ...
    public boolean npe_entertainer_side_i_questgiver_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_entertainer_side_i_questgiver_condition_playerOnQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "npe_entertainer_side_i");
    }
    public boolean npe_entertainer_side_i_questgiver_condition_playerDoneWithQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_entertainer_side_i");
    }
    public boolean npe_entertainer_side_i_questgiver_condition_playerOnInaldraTask(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_entertainer_side_i", "inaldrasignal");
    }
    public void npe_entertainer_side_i_questgiver_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void npe_entertainer_side_i_questgiver_action_giveQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_entertainer_side_i");
    }
    public int npe_entertainer_side_i_questgiver_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_entertainer_side_i_questgiver_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_entertainer_side_i_questgiver_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_entertainer_side_i_questgiver_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
