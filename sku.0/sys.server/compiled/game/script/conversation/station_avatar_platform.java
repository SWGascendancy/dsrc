...
public class station_avatar_platform extends script.base_script
{
    ...
    public boolean station_avatar_platform_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean station_avatar_platform_condition_hasAuthorization(obj_id player, obj_id npc)
    {
    ...
    public boolean station_avatar_platform_condition_returnToAvatar(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_avatar_return");
    }
    public boolean station_avatar_platform_condition_isTooFar(obj_id player, obj_id npc)
    {
        space_combat.playCombatTauntSound(player);
        obj_id containingShip = space_transition.getContainingShip(player);
        return (getDistance(npc, containingShip) > space_transition.STATION_COMM_MAX_DISTANCE);
    }
    public void station_avatar_platform_action_launchAttack(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_surpriseattack", "ep3_avatar_defensive_attack");
    }
    public void station_avatar_platform_action_land(obj_id player, obj_id npc)
    {
        String planet = getCurrentSceneName();
        space_dungeon.sendGroupToDungeonWithoutTicket(player, "avatar_platform", planet, planet, "quest_type", npc);
    }
    public int station_avatar_platform_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_avatar_platform_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_avatar_platform_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
