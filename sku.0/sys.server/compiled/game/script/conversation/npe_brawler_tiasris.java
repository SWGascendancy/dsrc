...
public class npe_brawler_tiasris extends script.base_script
{
    ...
    public boolean npe_brawler_tiasris_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_brawler_tiasris_condition_isTaskActiveStory2(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "npe_brawler_2", 0) && !groundquests.hasCompletedQuest(player, "npe_brawler_2"));
    }
    public boolean npe_brawler_tiasris_condition_isTaskActiveBully(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "npe_brawler_2", "killdude") && !groundquests.hasCompletedQuest(player, "npe_brawler_2"));
    }
    public boolean npe_brawler_tiasris_condition_hasCompletedTaskBully(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedTask(player, "npe_brawler_2", "killdude") && !groundquests.hasCompletedQuest(player, "npe_brawler_2"));
    }
    public boolean npe_brawler_tiasris_condition_hasCompletedStory2(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_brawler_2");
    }
    public void npe_brawler_tiasris_action_giveSignalBully(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_brawler_tiasris");
    }
    public void npe_brawler_tiasris_action_giveSignalDone(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_brawler2_done");
    }
    public void npe_brawler_tiasris_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int npe_brawler_tiasris_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brawler_tiasris_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brawler_tiasris_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brawler_tiasris_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_brawler_tiasris_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
