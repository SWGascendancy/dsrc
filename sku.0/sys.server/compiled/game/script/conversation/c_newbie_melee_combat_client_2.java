...
public class c_newbie_melee_combat_client_2 extends script.base_script
{
    ...
    public boolean c_newbie_melee_combat_client_2_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_newbie_melee_combat_client_2_condition_onTaskTalk(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "c_newbie_melee_quest_2", "talkCourier1"));
    }
    public boolean c_newbie_melee_combat_client_2_condition_onTaskEscort(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "c_newbie_melee_quest_2", "escort"));
    }
    public boolean c_newbie_melee_combat_client_2_condition_completedEscort(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "c_newbie_melee_quest_2", "talkCourier2"));
    }
    public void c_newbie_melee_combat_client_2_action_signalTalked(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedCourier1");
    }
    public void c_newbie_melee_combat_client_2_action_signalTalked2(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedCourier2");
        groundquests.completeTask(player, "c_newbie_melee_quest_2", "escortTask");
    }
    public int c_newbie_melee_combat_client_2_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
