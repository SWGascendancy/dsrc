...
public class combat_quest_p3 extends script.base_script
{
    ...
    public boolean combat_quest_p3_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean combat_quest_p3_condition_canTurnInFrequencyDp(obj_id player, obj_id npc)
    {
    ...
    public boolean combat_quest_p3_condition_isOnQuest(obj_id player, obj_id npc)
    {
        return fs_counterstrike.isOnCsQuest(player);
    }
    public boolean combat_quest_p3_condition_canTurnInWaypoint(obj_id player, obj_id npc)
    {
    ...
    public boolean combat_quest_p3_condition_canTalkToNpc(obj_id player, obj_id npc)
    {
    ...
    public boolean combat_quest_p3_condition_hasCompeletedQuest(obj_id player, obj_id npc)
    {
        return fs_quests.hasQuestCompleted(player);
    }
    public boolean combat_quest_p3_condition_hasAcceptedNonCSQuest(obj_id player, obj_id npc)
    {
    ...
    public void combat_quest_p3_action_GiveQuest(obj_id player, obj_id npc)
    {
    ...
    public void combat_quest_p3_action_giveRemote(obj_id player, obj_id npc)
    {
    ...
    public void combat_quest_p3_action_giveWaypoint(obj_id player, obj_id npc)
    {
