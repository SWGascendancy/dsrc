...
public class corellia_38_civius_bain extends script.base_script
{
    ...
    public boolean corellia_38_civius_bain_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_38_civius_bain_condition_taskOneActive(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_38_sidequest_05", "corellia_38_sidequest_05_01");
    }
    public boolean corellia_38_civius_bain_condition_taskOneComplete(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_38_sidequest_05", "corellia_38_sidequest_05_02");
    }
    public boolean corellia_38_civius_bain_condition_questComplete(obj_id player, obj_id npc)
    {
    ...
    public void corellia_38_civius_bain_action_taskOneCompletedSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "corellia_38_sidequest_05_01");
    }
    public int corellia_38_civius_bain_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_38_civius_bain_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
