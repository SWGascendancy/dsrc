...
public class legacy_button_damar extends script.base_script
{
    ...
    public boolean legacy_button_damar_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean legacy_button_damar_condition_onButtonImp(obj_id player, obj_id npc)
    {
    ...
    public boolean legacy_button_damar_condition_onButtonReb(obj_id player, obj_id npc)
    {
    ...
    public boolean legacy_button_damar_condition_questButtonComplete(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/legacy_button_imp_pt2");
    ...
    public void legacy_button_damar_action_signalRebComplete(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "legacy_button_reb_launch_e4");
    }
    public void legacy_button_damar_action_signalImpComplete(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "legacy_button_imp_launch_e4");
        groundquests.sendSignal(player, "legacy_button_reb_launch_e4");
    }
    public void legacy_button_damar_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int legacy_button_damar_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_button_damar_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_button_damar_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_button_damar_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_button_damar_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_button_damar_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_button_damar_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_button_damar_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
