...
public class dera_darklighter extends script.base_script
{
    ...
    public boolean dera_darklighter_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean dera_darklighter_condition_startWithDera(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "huff_darklighter_dera", "speakToDera");
    }
    public boolean dera_darklighter_condition_workingWithDera(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "huff_darklighter_dera", "eliminateVileTuskens");
    }
    public boolean dera_darklighter_condition_returningToDera(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "huff_darklighter_dera", "returnToDera");
    }
    public boolean dera_darklighter_condition_doneWithDera(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "huff_darklighter_dera", "returnToDera");
    }
    public void dera_darklighter_action_signal_startDera(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "speakToDera");
    }
    public void dera_darklighter_action_signal_endDera(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "returnToDera");
    }
    public int dera_darklighter_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
