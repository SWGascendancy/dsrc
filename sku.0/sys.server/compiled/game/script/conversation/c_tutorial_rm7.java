...
public class c_tutorial_rm7 extends script.base_script
{
    ...
    public boolean c_tutorial_rm7_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_tutorial_rm7_condition_playerOnQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean c_tutorial_rm7_condition_taskComplete(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/c_newbie_hall_03");
        int killPirate = groundquests.getTaskId(questId, "killPirate");
    ...
    public boolean c_tutorial_rm7_condition_playerOnQuestStep0602(obj_id player, obj_id npc)
    {
    ...
    public boolean c_tutorial_rm7_condition_playerOnQuestStep0603(obj_id player, obj_id npc)
    {
    ...
    public boolean c_tutorial_rm7_condition_playerOnQuestStep06(obj_id player, obj_id npc)
    {
    ...
    public void c_tutorial_rm7_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void c_tutorial_rm7_action_actionSendSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "explainFight");
    }
    public int c_tutorial_rm7_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_tutorial_rm7_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_tutorial_rm7_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_tutorial_rm7_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_tutorial_rm7_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_tutorial_rm7_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
