...
public class restuss_rebel_ground_destroy_3 extends script.base_script
{
    ...
    public boolean restuss_rebel_ground_destroy_3_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean restuss_rebel_ground_destroy_3_condition_stage3ready(obj_id player, obj_id npc)
    {
    ...
    public boolean restuss_rebel_ground_destroy_3_condition_mission1Active(obj_id player, obj_id npc)
    {
    ...
    public boolean restuss_rebel_ground_destroy_3_condition_mission1Success(obj_id player, obj_id npc)
    {
    ...
    public boolean restuss_rebel_ground_destroy_3_condition_completedMission1(obj_id player, obj_id npc)
    {
    ...
    public boolean restuss_rebel_ground_destroy_3_condition_mission2Active(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "restuss_rebel_st3_destroy_boss");
    }
    public boolean restuss_rebel_ground_destroy_3_condition_mission2Success(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "restuss_rebel_st3_destroy_boss", "returnVoldez2");
    }
    public boolean restuss_rebel_ground_destroy_3_condition_notCommando(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean restuss_rebel_ground_destroy_3_condition_commando(obj_id player, obj_id npc)
    {
        return false;
    }
    public boolean restuss_rebel_ground_destroy_3_condition_completedMission2(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "restuss_rebel_st3_destroy_boss");
    }
    public boolean restuss_rebel_ground_destroy_3_condition_playerRebel(obj_id player, obj_id npc)
    {
    ...
    public boolean restuss_rebel_ground_destroy_3_condition_isPlayerImperial(obj_id player, obj_id npc)
    {
        return factions.isImperial(player);
    }
    public void restuss_rebel_ground_destroy_3_action_giveAntenna(obj_id player, obj_id npc)
    {
    ...
    public void restuss_rebel_ground_destroy_3_action_reward1(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "returnedVoldez1");
    }
    public void restuss_rebel_ground_destroy_3_action_giveKillBoss(obj_id player, obj_id npc)
    {
        if (!groundquests.isQuestActive(player, "restuss_rebel_st3_destroy_installation_1") || !groundquests.isQuestActive(player, "restuss_rebel_st3_destroy_installation_1_commando"))
        {
    ...
    public void restuss_rebel_ground_destroy_3_action_reward2(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "returnedVoldez2");
    }
    public void restuss_rebel_ground_destroy_3_action_giveAntennaCommando(obj_id player, obj_id npc)
    {
        if (!groundquests.isQuestActive(player, "restuss_rebel_st3_destroy_boss"))
        {
    ...
    public void restuss_rebel_ground_destroy_3_action_eject(obj_id player, obj_id npc)
    {
        expelFromBuilding(player);
    }
    public int restuss_rebel_ground_destroy_3_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int restuss_rebel_ground_destroy_3_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int restuss_rebel_ground_destroy_3_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int restuss_rebel_ground_destroy_3_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int restuss_rebel_ground_destroy_3_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
