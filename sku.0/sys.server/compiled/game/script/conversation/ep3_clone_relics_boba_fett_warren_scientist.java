...
public class ep3_clone_relics_boba_fett_warren_scientist extends script.base_script
{
    ...
    public boolean ep3_clone_relics_boba_fett_warren_scientist_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_clone_relics_boba_fett_warren_scientist_condition_hasCompletedTaskTwo(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "ep3_clone_relics_boba_fett_5", "needToTalkScientist"));
    }
    public boolean ep3_clone_relics_boba_fett_warren_scientist_condition_hasCompletedEscort(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedTask(player, "ep3_clone_relics_boba_fett_5", "goToMiningOutpost"));
    }
    public boolean ep3_clone_relics_boba_fett_warren_scientist_condition_hasCompletedQuestFive(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedQuest(player, "ep3_clone_relics_boba_fett_5"));
    }
    public boolean ep3_clone_relics_boba_fett_warren_scientist_condition_onQuestFive(obj_id player, obj_id npc)
    {
    ...
    public void ep3_clone_relics_boba_fett_warren_scientist_action_signalTalked(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedToScientist");
    }
    public void ep3_clone_relics_boba_fett_warren_scientist_action_talkedAgain(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedScientistAgain");
    }
    public void ep3_clone_relics_boba_fett_warren_scientist_action_grantQuestSix(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_clone_relics_boba_fett_6");
    }
    public int ep3_clone_relics_boba_fett_warren_scientist_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_boba_fett_warren_scientist_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_boba_fett_warren_scientist_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_boba_fett_warren_scientist_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_boba_fett_warren_scientist_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_boba_fett_warren_scientist_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_boba_fett_warren_scientist_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_boba_fett_warren_scientist_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_boba_fett_warren_scientist_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_boba_fett_warren_scientist_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_boba_fett_warren_scientist_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_boba_fett_warren_scientist_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
