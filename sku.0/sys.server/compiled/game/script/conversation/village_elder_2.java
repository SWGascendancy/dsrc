...
public class village_elder_2 extends script.base_script
{
    ...
    public boolean village_elder_2_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean village_elder_2_condition_needCrystal(obj_id player, obj_id npc)
    {
    ...
    public void village_elder_2_action_giveCrystal(obj_id player, obj_id npc)
    {
