...
public class jinkins extends script.base_script
{
    ...
    public boolean jinkins_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean jinkins_condition_hasCompletedPirate(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean jinkins_condition_hasReturnedFromMoore(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean jinkins_condition_hasMineQuestIncomplete(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "u16_nym_themepark_mine");
    }
    public boolean jinkins_condition_hasMineFilter(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "u16_nym_themepark_mine", "returnMineComplete");
    }
    public boolean jinkins_condition_isDoneMineQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "u16_nym_themepark_mine");
    }
    public boolean jinkins_condition_allQuestsComplete(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "u16_nym_themepark_jinkins_kole");
    }
    public boolean jinkins_condition_hasCompletedThemePark(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.hasCompletedQuest(player, "u16_nym_themepark_shuttle_ambush");
    }
    public boolean jinkins_condition_hasNotCompletedPirate(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public void jinkins_action_giveMooreQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "u16_nym_themepark_interview_moore");
    }
    public void jinkins_action_grantMineQuest(obj_id player, obj_id npc)
    {
    ...
    public void jinkins_action_completeMooreQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        groundquests.sendSignal(player, "hasToldJinkinsMoore");
    }
    public void jinkins_action_completeMineQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        groundquests.sendSignal(player, "hasCompletedMine");
    }
    public void jinkins_action_hasFoundJinkins(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "hasFoundJinkins");
    }
    public void jinkins_action_gotoKole(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "u16_nym_themepark_jinkins_kole");
    }
    public int jinkins_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int jinkins_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int jinkins_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int jinkins_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int jinkins_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int jinkins_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int jinkins_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int jinkins_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int jinkins_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int jinkins_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int jinkins_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int jinkins_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int jinkins_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int jinkins_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int jinkins_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int jinkins_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
