...
public class rtp_han_solo_main extends script.base_script
{
    ...
    public boolean rtp_han_solo_main_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean rtp_han_solo_main_condition_rtp_han_solo_01_active(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "rtp_han_solo_01");
    }
    public boolean rtp_han_solo_main_condition_rtp_han_solo_01_complete(obj_id player, obj_id npc)
    {
    ...
    public boolean rtp_han_solo_main_condition_rtp_han_solo_02_active(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "rtp_han_solo_02");
    }
    public boolean rtp_han_solo_main_condition_rtp_han_solo_02_completed(obj_id player, obj_id npc)
    {
    ...
    public boolean rtp_han_solo_main_condition_completedNienNunb(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "rtp_nien_nunb_01");
    }
    public boolean rtp_han_solo_main_condition_notRebel(obj_id player, obj_id npc)
    {
    ...
    public boolean rtp_han_solo_main_condition_rebel_isOnLeave(obj_id player, obj_id npc)
    {
        return factions.isOnLeave(player);
    }
    public void rtp_han_solo_main_action_rtp_han_solo_01_granted(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "rtp_han_solo_01");
    }
    public void rtp_han_solo_main_action_rtp_han_solo_01_signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "rtp_han_solo_01_03");
    }
    public void rtp_han_solo_main_action_rtp_han_solo_02_signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "rtp_han_solo_02_02");
    }
    public void rtp_han_solo_main_action_rtp_han_solo_02_granted(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "rtp_han_solo_02");
    }
    public int rtp_han_solo_main_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rtp_han_solo_main_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
