...
public class npe_profession_entertainer extends script.base_script
{
    ...
    public boolean npe_profession_entertainer_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_profession_entertainer_condition_onTrainingQuest(obj_id player, obj_id npc)
    {
        return (groundquests.isQuestActive(player, "npe_pointer_entertainer") || groundquests.isQuestActive(player, "npe_entertainer_1"));
    }
    public boolean npe_profession_entertainer_condition_finishedTrainingQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_entertainer_1");
    }
    public boolean npe_profession_entertainer_condition_isEntertainer(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_profession_entertainer_condition_onEntertainer1quest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "npe_prof_entertainer1");
    }
    public boolean npe_profession_entertainer_condition_finishedEntertainer1Quest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_prof_entertainer1");
    }
    public boolean npe_profession_entertainer_condition_onEntertainer1Task(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_prof_entertainer1", "returntomira");
    }
    public boolean npe_profession_entertainer_condition_onEntertainer2Task(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_prof_entertainer2", "returntomira");
    }
    public boolean npe_profession_entertainer_condition_onEntertainer2quest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "npe_prof_entertainer2");
    }
    public boolean npe_profession_entertainer_condition_finishedEntertainer2Quest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_prof_entertainer2");
    }
    public boolean npe_profession_entertainer_condition_onOrCompletedEnt2Quest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "npe_prof_entertainer2");
    }
    public boolean npe_profession_entertainer_condition_needsHorn(obj_id player, obj_id npc)
    {
    ...
    public void npe_profession_entertainer_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void npe_profession_entertainer_action_dance(obj_id player, obj_id npc)
    {
    ...
    public void npe_profession_entertainer_action_givePointerAnvar(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_pointer_entertainer");
        groundquests.sendSignal(player, "found_entertainer");
    }
    public void npe_profession_entertainer_action_signalEnt1Quest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_prof_entertainer1_return");
    }
    public void npe_profession_entertainer_action_giveEntertainerQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_prof_entertainer1");
        npe.giveEntXpPopUp(player);
    }
    public void npe_profession_entertainer_action_giveSecretaryPointer(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_pointer_secretary");
    }
    public void npe_profession_entertainer_action_giveHanPointer(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_job_pointer_han");
    }
    public void npe_profession_entertainer_action_signalEnt2Quest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_prof_entertainer2_done");
        setObjVar(player, "npe.finishedTemplate", 1);
    }
    public void npe_profession_entertainer_action_giveEntertainer2Quest(obj_id player, obj_id npc)
    {
    ...
    public void npe_profession_entertainer_action_giveNewHorn(obj_id player, obj_id npc)
    {
    ...
    public int npe_profession_entertainer_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_profession_entertainer_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_profession_entertainer_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_profession_entertainer_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_profession_entertainer_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_44"))
        {
            if (npe_profession_entertainer_condition__defaultCondition(player, npc))
    ...
    public int npe_profession_entertainer_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_profession_entertainer_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_profession_entertainer_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_profession_entertainer_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_profession_entertainer_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_profession_entertainer_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_44"))
        {
            if (npe_profession_entertainer_condition__defaultCondition(player, npc))
    ...
    public int npe_profession_entertainer_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_profession_entertainer_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_profession_entertainer_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_profession_entertainer_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_profession_entertainer_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_profession_entertainer_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int stopDancing(obj_id self, dictionary params)
    {
