...
public class som_kenobi_obi_wan extends script.base_script
{
    ...
    public boolean som_kenobi_obi_wan_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean som_kenobi_obi_wan_condition_startFirstQuest(obj_id player, obj_id npc)
    {
        if (isGod(player))
        {
            return true;
    ...
    public boolean som_kenobi_obi_wan_condition_finishedQuestKilled(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "som_kenobi_main_quest_killed", "talkKenobi1");
    }
    public boolean som_kenobi_obi_wan_condition_finishedQuestSpared(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "som_kenobi_main_quest_spared", "talkKenobi1");
    }
    public boolean som_kenobi_obi_wan_condition_finishedQuest1(obj_id player, obj_id npc)
    {
    ...
    public boolean som_kenobi_obi_wan_condition_atTheEntrance(obj_id player, obj_id npc)
    {
    ...
    public boolean som_kenobi_obi_wan_condition_onQuests(obj_id player, obj_id npc)
    {
    ...
    public boolean som_kenobi_obi_wan_condition_finishedQuestKilled2(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "som_kenobi_main_quest_3_b_visible", "talkKenobi2");
    }
    public boolean som_kenobi_obi_wan_condition_finishedQuestSpared2(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "som_kenobi_main_quest_3_visible", "talkKenobi2");
    }
    public boolean som_kenobi_obi_wan_condition_atTheEntranceFailed(obj_id player, obj_id npc)
    {
    ...
    public boolean som_kenobi_obi_wan_condition_abandonedQuest3(obj_id player, obj_id npc)
    {
    ...
    public boolean som_kenobi_obi_wan_condition_completedAll(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "didMustafarCrystalLair");
    }
    public boolean som_kenobi_obi_wan_condition_failedQuest1(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "som_kenobi_main_quest_1");
    }
    public void som_kenobi_obi_wan_action_signalTalked1Spared(obj_id player, obj_id npc)
    {
    ...
    public void som_kenobi_obi_wan_action_signalTalked2Spared(obj_id player, obj_id npc)
    {
    ...
    public void som_kenobi_obi_wan_action_signalTalked2Killed(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedKenobi2");
        groundquests.completeQuest(player, "som_kenobi_main_quest_killed");
        groundquests.completeQuest(player, "som_kenobi_main_quest_spared");
    ...
    public void som_kenobi_obi_wan_action_giveQuest1(obj_id player, obj_id npc)
    {
    ...
    public void som_kenobi_obi_wan_action_signalTalked3(obj_id player, obj_id npc)
    {
    ...
    public void som_kenobi_obi_wan_action_finalScriptVar(obj_id player, obj_id npc)
    {
        setObjVar(player, "sawObiwanAtLauncher", 1);
    }
    public void som_kenobi_obi_wan_action_signalTalked1Killed(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedKenobi1");
        groundquests.grantQuest(player, "som_kenobi_main_quest_3_b");
        removeObjVar(player, "waitingOnObiwan");
    }
    public void som_kenobi_obi_wan_action_regiveQuest3(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "som_kenobi_main_quest_3_visible");
        removeObjVar(player, "waitingOnObiwan");
    }
    public void som_kenobi_obi_wan_action_talkNumber2(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedKenobi2");
        removeObjVar(player, "waitingOnObiwan");
    }
    public void som_kenobi_obi_wan_action_clearQuest1(obj_id player, obj_id npc)
    {
        groundquests.clearQuest(player, "som_kenobi_main_quest_1");
    }
    public void som_kenobi_obi_wan_action_grantQuest1(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "som_kenobi_main_quest_1");
    }
    public int som_kenobi_obi_wan_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch30(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch31(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch32(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch34(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch35(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch36(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch37(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch38(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch40(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch41(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch42(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch43(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch45(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch48(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch49(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch50(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch51(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch52(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch53(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch54(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch55(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch56(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch57(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch58(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch59(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch60(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch61(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch62(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch63(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch64(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch65(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch66(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch68(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch69(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch70(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch71(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch72(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch73(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch74(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch75(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch76(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch77(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch78(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch79(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch80(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch81(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch82(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch83(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch84(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch85(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch87(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch88(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_obi_wan_handleBranch89(obj_id player, obj_id npc, string_id response)
    {
