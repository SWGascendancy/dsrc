...
public class novicecollector extends script.base_script
{
    ...
    public boolean novicecollector_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean novicecollector_condition_hasPublishGiftToken(obj_id player, obj_id npc)
    {
        return (hasCompletedCollectionSlotPrereq(player, "publish_chapter7_click_activation_03"));
    }
    public boolean novicecollector_condition_hasFoundClickCollection(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "chapter7_beginning_click_collection", "publishClickCollectionReturnToCollectionNPC");
    }
    public boolean novicecollector_condition_hasCompletedClickCollection(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "chapter7_beginning_click_collection");
    }
    public boolean novicecollector_condition_hasFoundInventoryCollection(obj_id player, obj_id npc)
    {
    ...
    public boolean novicecollector_condition_hasCompletedClickInventoryCollection(obj_id player, obj_id npc)
    {
    ...
    public boolean novicecollector_condition_hasFulfilledCounterQuota(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "chapter7_beginning_counter_collection", "publishCounterReturn");
    }
    public boolean novicecollector_condition_allCollectionsComplete(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "chapter7_beginning_counter_collection");
    }
    public boolean novicecollector_condition_clickCollectionActive(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "chapter7_beginning_click_collection");
    }
    public boolean novicecollector_condition_inventoryCollectionActive(obj_id player, obj_id npc)
    {
    ...
    public boolean novicecollector_condition_counterCollectionActive(obj_id player, obj_id npc)
    {
        return (groundquests.isQuestActive(player, "chapter7_beginning_counter_collection"));
    }
    public boolean novicecollector_condition_noMoreCollections(obj_id player, obj_id npc)
    {
    ...
    public boolean novicecollector_condition_cantGetMore(obj_id player, obj_id npc)
    {
        if (hasObjVar(npc, "collection.columnName"))
        {
            String columnName = getStringObjVar(npc, "collection.columnName");
    ...
    public boolean novicecollector_condition_isSomehowBroken(obj_id player, obj_id npc)
    {
    ...
    public boolean novicecollector_condition_foundUnusedComlink(obj_id player, obj_id npc)
    {
    ...
    public boolean novicecollector_condition_hasActivatedOne(obj_id player, obj_id npc)
    {
        return (getCollectionSlotValue(player, "publish_chapter7_click_activation_01") == 1);
    }
    public boolean novicecollector_condition_hasCollectionsToRemove(obj_id player, obj_id npc)
    {
        if (hasObjVar(npc, "collection.columnName"))
        {
            String columnName = getStringObjVar(npc, "collection.columnName");
    ...
    public boolean novicecollector_condition_collectorHintEndor(obj_id player, obj_id npc)
    {
    ...
    public boolean novicecollector_condition_hasFinishedInventoryOutOfOrder(obj_id player, obj_id npc)
    {
    ...
    public boolean novicecollector_condition_collectorHintTatooine(obj_id player, obj_id npc)
    {
        String planetName = getCurrentSceneName();
        sendSystemMessageTestingOnly(player, planetName);
    ...
    public boolean novicecollector_condition_collectorHintYavin4(obj_id player, obj_id npc)
    {
        String planetName = getCurrentSceneName();
        sendSystemMessageTestingOnly(player, planetName);
    ...
    public boolean novicecollector_condition_collectorHintAurilia(obj_id player, obj_id npc)
    {
        String planetName = getCurrentSceneName();
    ...
    public void novicecollector_action_grantCollectionQuest(obj_id player, obj_id npc)
    {
    ...
    public void novicecollector_action_completeClickCollection(obj_id player, obj_id npc)
    {
    ...
    public void novicecollector_action_grantInventoryQuest(obj_id player, obj_id npc)
    {
    ...
    public void novicecollector_action_completeInventoryCollection(obj_id player, obj_id npc)
    {
    ...
    public void novicecollector_action_grantCounterQuest(obj_id player, obj_id npc)
    {
    ...
    public void novicecollector_action_completeCounterCollection(obj_id player, obj_id npc)
    {
        modifyCollectionSlotValue(player, "kill_tusken_complete", 1);
        groundquests.sendSignal(player, "publishCounterReturn");
    }
    public void novicecollector_action_sendActivationSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "publishClickCollectionActivation");
    }
    public void novicecollector_action_showCollectionSui(obj_id player, obj_id npc)
    {
        if (hasObjVar(npc, "collection.columnName"))
        {
            String columnName = getStringObjVar(npc, "collection.columnName");
    ...
    public void novicecollector_action_fixPlayer(obj_id player, obj_id npc)
    {
    ...
    public void novicecollector_action_tutorialNoGifts(obj_id player, obj_id npc)
    {
        modifyCollectionSlotValue(player, "publish_chapter7_click_activation_01", 1);
        modifyCollectionSlotValue(player, "publish_chapter7_click_activation_02", 1);
        modifyCollectionSlotValue(player, "publish_chapter7_click_activation_03", 1);
    ...
    public void novicecollector_action_showRemovalSui(obj_id player, obj_id npc)
    {
        if (hasObjVar(npc, "collection.columnName"))
        {
            String columnName = getStringObjVar(npc, "collection.columnName");
    ...
    public void novicecollector_action_collectionQuestSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "grantCollectionRewardSignal");
    }
    public int novicecollector_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int novicecollector_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int novicecollector_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int novicecollector_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int novicecollector_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int novicecollector_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int novicecollector_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int novicecollector_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int novicecollector_handleBranch33(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int novicecollector_handleBranch34(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int novicecollector_handleBranch39(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int novicecollector_handleBranch40(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int handleCollectionNpc(obj_id self, dictionary params)
    {
    ...
    public int handleCollectionRemoval(obj_id self, dictionary params)
    {
        int btn = sui.getIntButtonPressed(params);
        int idx = sui.getListboxSelectedRow(params);
        obj_id player = sui.getPlayerId(params);
    ...
    public int handlePlayerConfirmedCollectionDelete(obj_id self, dictionary params)
    {
        int btn = sui.getIntButtonPressed(params);
        obj_id player = sui.getPlayerId(params);
