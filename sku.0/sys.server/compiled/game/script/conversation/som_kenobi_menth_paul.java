...
public class som_kenobi_menth_paul extends script.base_script
{
    ...
    public boolean som_kenobi_menth_paul_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean som_kenobi_menth_paul_condition_playerJedi(obj_id player, obj_id npc)
    {
        return jedi.isForceSensitive(player);
    }
    public boolean som_kenobi_menth_paul_condition_hermitChat2(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "som_kenobi_main_quest_1", "talkHermit2");
    }
    public boolean som_kenobi_menth_paul_condition_dontHave500(obj_id player, obj_id npc)
    {
        return !money.hasFunds(player, money.MT_TOTAL, 500);
    }
    public boolean som_kenobi_menth_paul_condition_doneTalking(obj_id player, obj_id npc)
    {
    ...
    public boolean som_kenobi_menth_paul_condition_abortedQuest2(obj_id player, obj_id npc)
    {
    ...
    public boolean som_kenobi_menth_paul_condition_tryingReturnShard(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "som_kenobi_cursed_shard_2", "givingUpShard");
    }
    public boolean som_kenobi_menth_paul_condition_dontHave1000(obj_id player, obj_id npc)
    {
        return !money.hasFunds(player, money.MT_TOTAL, 1000);
    }
    public boolean som_kenobi_menth_paul_condition_levelTooLow(obj_id player, obj_id npc)
    {
    ...
    public void som_kenobi_menth_paul_action_giveQuest1000(obj_id player, obj_id npc)
    {
        money.pay(player, npc, 1000, "", null, true);
        groundquests.grantQuest(player, "som_kenobi_cursed_shard_1");
    }
    public void som_kenobi_menth_paul_action_pay500(obj_id player, obj_id npc)
    {
        money.pay(player, npc, 500, "", null, false);
    }
    public void som_kenobi_menth_paul_action_pay1000(obj_id player, obj_id npc)
    {
        money.pay(player, npc, 1000, "", null, true);
    }
    public void som_kenobi_menth_paul_action_giveQuestFree(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "som_kenobi_cursed_shard_1");
    }
    public void som_kenobi_menth_paul_action_giveQuest500(obj_id player, obj_id npc)
    {
        money.pay(player, npc, 500, "", null, true);
        groundquests.grantQuest(player, "som_kenobi_cursed_shard_1");
    }
    public int som_kenobi_menth_paul_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_menth_paul_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_menth_paul_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_111"))
        {
            doAnimationAction(player, "shrug_hands");
    ...
    public int som_kenobi_menth_paul_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_menth_paul_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_menth_paul_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_menth_paul_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_menth_paul_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_menth_paul_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_menth_paul_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_menth_paul_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_menth_paul_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_menth_paul_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_menth_paul_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_menth_paul_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_menth_paul_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_menth_paul_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_menth_paul_handleBranch30(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_menth_paul_handleBranch31(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_menth_paul_handleBranch32(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_menth_paul_handleBranch36(obj_id player, obj_id npc, string_id response)
    {
