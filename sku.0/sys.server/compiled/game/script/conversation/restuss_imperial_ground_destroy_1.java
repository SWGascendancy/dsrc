...
public class restuss_imperial_ground_destroy_1 extends script.base_script
{
    ...
    public boolean restuss_imperial_ground_destroy_1_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean restuss_imperial_ground_destroy_1_condition_completedKill1(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "restuss_imperial_soldier_1", "returnGregor");
    }
    public boolean restuss_imperial_ground_destroy_1_condition_killActive1(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "restuss_imperial_soldier_1");
    }
    public boolean restuss_imperial_ground_destroy_1_condition_completedKill2(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "restuss_imperial_soldier_2", "returnGregor2");
    }
    public boolean restuss_imperial_ground_destroy_1_condition_killActive2(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "restuss_imperial_soldier_2");
    }
    public boolean restuss_imperial_ground_destroy_1_condition_inPhase2(obj_id player, obj_id npc)
    {
    ...
    public boolean restuss_imperial_ground_destroy_1_condition_inPhase1(obj_id player, obj_id npc)
    {
    ...
    public boolean restuss_imperial_ground_destroy_1_condition_enoughKills(obj_id player, obj_id npc)
    {
        obj_id object = trial.getParent(npc);
    ...
    public boolean restuss_imperial_ground_destroy_1_condition_isRebelPlayer(obj_id player, obj_id npc)
    {
        return factions.isRebel(player);
    }
    public void restuss_imperial_ground_destroy_1_action_givekill1(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "restuss_imperial_soldier_1");
    }
    public void restuss_imperial_ground_destroy_1_action_signalDone(obj_id player, obj_id npc)
    {
    ...
    public void restuss_imperial_ground_destroy_1_action_givekill2(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "restuss_imperial_soldier_2");
    }
    public void restuss_imperial_ground_destroy_1_action_signalDone2(obj_id player, obj_id npc)
    {
    ...
    public void restuss_imperial_ground_destroy_1_action_eject(obj_id player, obj_id npc)
    {
        expelFromBuilding(player);
    }
    public int restuss_imperial_ground_destroy_1_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int restuss_imperial_ground_destroy_1_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int restuss_imperial_ground_destroy_1_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
