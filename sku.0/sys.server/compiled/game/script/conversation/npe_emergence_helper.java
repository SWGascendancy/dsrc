...
public class npe_emergence_helper extends script.base_script
{
    ...
    public boolean npe_emergence_helper_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_emergence_helper_condition_isTaskActiveQuest(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_frelka_quest", "reward4tw");
    }
    public boolean npe_emergence_helper_condition_hasCompletedQuestFrelka(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedQuest(player, "npe_frelka_quest"));
    }
    public boolean npe_emergence_helper_condition_hasObvarcrap(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "npe.finishedTemplate");
    }
    public boolean npe_emergence_helper_condition_isOfficerOrSmuggler(obj_id player, obj_id npc)
    {
        return (utils.isProfession(player, utils.SMUGGLER) || utils.isProfession(player, utils.OFFICER));
    }
    public void npe_emergence_helper_action_facePlayerNoob(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void npe_emergence_helper_action_sendFrelkaSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talk_to_frelka");
    }
    public void npe_emergence_helper_action_giveSignalPlz(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "rewardplz");
        groundquests.sendSignal(player, "talk_to_frelka");
    }
    public void npe_emergence_helper_action_giveFrelkaQuest(obj_id player, obj_id npc)
    {
    ...
    public void npe_emergence_helper_action_giveFrelkaQuestOfcSmug(obj_id player, obj_id npc)
    {
    ...
    public int npe_emergence_helper_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_emergence_helper_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_emergence_helper_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_emergence_helper_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_emergence_helper_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_emergence_helper_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_emergence_helper_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_emergence_helper_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_emergence_helper_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_emergence_helper_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_emergence_helper_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
