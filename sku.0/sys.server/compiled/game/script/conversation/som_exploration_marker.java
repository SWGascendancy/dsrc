...
public class som_exploration_marker extends script.base_script
{
    ...
    public boolean som_exploration_marker_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean som_exploration_marker_condition_miningFacility(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "som_exploration_mining");
    }
    public boolean som_exploration_marker_condition_crystalFlats(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "som_exploration_crystal");
    }
    public boolean som_exploration_marker_condition_smokingForest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "som_exploration_smoking");
    }
    public boolean som_exploration_marker_condition_centralVolcano(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "som_exploration_volcano");
    }
    public boolean som_exploration_marker_condition_burningPlains(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "som_exploration_burning");
    }
    public boolean som_exploration_marker_condition_berkensFlow(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "som_exploration_berken");
    }
    public boolean som_exploration_marker_condition_tulrusNesting(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "som_exploration_tulrus");
    }
    public boolean som_exploration_marker_condition_completeAll(obj_id player, obj_id npc)
    {
    ...
    public boolean som_exploration_marker_condition_completedReward(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "mustafar.tanray_heart");
    }
    public boolean som_exploration_marker_condition_hasAcceptedOne(obj_id player, obj_id npc)
    {
    ...
    public void som_exploration_marker_action_grantCentral(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "som_exploration_volcano");
    }
    public void som_exploration_marker_action_grantBurning(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "som_exploration_burning");
    }
    public void som_exploration_marker_action_grantBerken(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "som_exploration_berken");
    }
    public void som_exploration_marker_action_grantTulrus(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "som_exploration_tulrus");
    }
    public void som_exploration_marker_action_grantSmoking(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "som_exploration_smoking");
    }
    public void som_exploration_marker_action_grantCrystal(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "som_exploration_crystal");
    }
    public void som_exploration_marker_action_grantMining(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "som_exploration_mining");
    }
    public void som_exploration_marker_action_grantReward(obj_id player, obj_id npc)
    {
    ...
    public int som_exploration_marker_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_exploration_marker_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_exploration_marker_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_exploration_marker_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_exploration_marker_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_exploration_marker_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_exploration_marker_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_exploration_marker_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_exploration_marker_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_exploration_marker_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_46"))
        {
            if (som_exploration_marker_condition__defaultCondition(player, npc))
