...
public class aurilia_nightsister_prisoner extends script.conversation.base.conversation_base
{
    ...
    private boolean aurilia_nightsister_prisoner_condition_onAxkvaMinQuest(obj_id player)
    {
        return groundquests.isTaskActive(player, "axkva_min_intro", "axkva_min_intro_01");
    }
    private void aurilia_nightsister_prisoner_action_axkvaMinSignal(obj_id player)
    {
        groundquests.sendSignal(player, "axkva_min_intro_01");
    }
    private int aurilia_nightsister_prisoner_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
