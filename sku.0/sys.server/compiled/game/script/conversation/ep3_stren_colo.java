...
public class ep3_stren_colo extends script.base_script
{
    ...
    public boolean ep3_stren_colo_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_stren_colo_condition_hasCompleted10WookieeQuest(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "ep3_sera_10_wookiee_teeth", "isReadyForReward"));
    }
    public boolean ep3_stren_colo_condition_bountyCollect(obj_id player, obj_id npc)
    {
        return false;
    }
    public boolean ep3_stren_colo_condition_bountyOffer(obj_id player, obj_id npc)
    {
        return false;
    }
    public boolean ep3_stren_colo_condition_hasJesskBounty(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_stren_colo_condition_isReadyForJesskReward(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_stren_jessk_bounty", "hasKilledJessk");
    }
    public boolean ep3_stren_colo_condition_hasDornBounty(obj_id player, obj_id npc)
    {
        return (space_quest.hasQuest(player) || space_quest.hasWonQuestRecursive(player, "assassinate", "ep3_stren_dorn_lackey"));
    }
    public boolean ep3_stren_colo_condition_isReadyForDornReward(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_stren_colo_condition_isClinetRebel(obj_id player, obj_id npc)
    {
    ...
    public void ep3_stren_colo_action_giveReward10Wookieequest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "give10TeethReward");
    }
    public void ep3_stren_colo_action_giveJesskBounty(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_stren_jessk_bounty");
    }
    public void ep3_stren_colo_action_giveJesskReward(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "collectJeskReward");
    }
    public void ep3_stren_colo_action_giveJesskTien(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_stren_jessk_bounty_tien");
    }
    public void ep3_stren_colo_action_giveDornBelga(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_stren_dorn_bounty_belga");
    }
    public void ep3_stren_colo_action_giveDornReward(obj_id player, obj_id npc)
    {
        space_quest.giveReward(player, "destroy_surpriseattack", "ep3_stren_dorn_bounty", 10000);
    }
    public int ep3_stren_colo_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_stren_colo_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_stren_colo_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_stren_colo_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_stren_colo_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_stren_colo_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_stren_colo_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_stren_colo_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_stren_colo_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_stren_colo_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_stren_colo_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_stren_colo_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_stren_colo_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_stren_colo_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
