...
public class som_obi_wan_kenobi extends script.base_script
{
    ...
    public boolean som_obi_wan_kenobi_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean som_obi_wan_kenobi_condition_canTakeQuest1(obj_id player, obj_id npc)
    {
    ...
    public boolean som_obi_wan_kenobi_condition_isQuest1Active(obj_id player, obj_id npc)
    {
    ...
    public boolean som_obi_wan_kenobi_condition_hasCompletedQuest1(obj_id player, obj_id npc)
    {
    ...
    public void som_obi_wan_kenobi_action_grantQuest1(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "som_obi_wan_signal_1");
    }
    public void som_obi_wan_kenobi_action_sendSignal2(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "returnToObiWan");
    }
    public int som_obi_wan_kenobi_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_obi_wan_kenobi_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_obi_wan_kenobi_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_obi_wan_kenobi_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_obi_wan_kenobi_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
