...
public class ep3_imp_cmd_richards extends script.base_script
{
    ...
    public boolean ep3_imp_cmd_richards_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_imp_cmd_richards_condition_isOnTask02(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_imp_cmd_richards", 3);
    }
    public boolean ep3_imp_cmd_richards_condition_hasCompletedQuest01(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_imp_cmd_richards");
    }
    public boolean ep3_imp_cmd_richards_condition_isOnQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "ep3_imp_cmd_richards", 0);
    }
    public boolean ep3_imp_cmd_richards_condition_isOnTask01(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_imp_cmd_richards", 0);
    }
    public void ep3_imp_cmd_richards_action_doSignal02(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "reportToRichards");
    }
    public void ep3_imp_cmd_richards_action_doSignal01(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "readyForRichards");
    }
    public int ep3_imp_cmd_richards_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_imp_cmd_richards_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_imp_cmd_richards_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_imp_cmd_richards_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_imp_cmd_richards_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
