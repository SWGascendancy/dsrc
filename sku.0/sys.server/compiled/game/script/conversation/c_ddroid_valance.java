...
public class c_ddroid_valance extends script.base_script
{
    ...
    public boolean c_ddroid_valance_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_ddroid_valance_condition_hasSpaceExpansion(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_ddroid_valance_condition_playeronquest1(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/c_darndroid1");
        return questIsQuestActive(questId, player);
    }
    public boolean c_ddroid_valance_condition_playeronquest2part1(obj_id player, obj_id npc)
    {
    ...
    public boolean c_ddroid_valance_condition_completedq2p2(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/c_darndroid2");
    ...
    public boolean c_ddroid_valance_condition_readyforquest2(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/c_darndroid1");
    ...
    public boolean c_ddroid_valance_condition_failedSpace(obj_id player, obj_id npc)
    {
    ...
    public boolean c_ddroid_valance_condition_completedspace(obj_id player, obj_id npc)
    {
    ...
    public boolean c_ddroid_valance_condition_completedAll(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/c_darndroid1");
        int questId2 = questGetQuestId("quest/c_darndroid2");
        return questIsQuestComplete(questId, player) && questIsQuestComplete(questId2, player);
    }
    public void c_ddroid_valance_action_giveddroidquest2(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/c_darndroid2");
    ...
    public void c_ddroid_valance_action_nojtlCompleteQuest(obj_id player, obj_id npc)
    {
    ...
    public void c_ddroid_valance_action_giveSpaceQuest(obj_id player, obj_id npc)
    {
    ...
    public void c_ddroid_valance_action_completespace(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "c_darndroid2_spacedone");
        obj_id top = getTopMostContainer(player);
        location loc = getLocation(top);
    ...
    public void c_ddroid_valance_action_completequest1(obj_id player, obj_id npc)
    {
    ...
    public void c_ddroid_valance_action_faceplayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int c_ddroid_valance_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_ddroid_valance_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_ddroid_valance_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_ddroid_valance_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_ddroid_valance_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_ddroid_valance_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_ddroid_valance_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_ddroid_valance_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_ddroid_valance_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_ddroid_valance_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_ddroid_valance_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_ddroid_valance_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
