...
public class nova_orion_katiara_orion extends script.base_script
{
    ...
    public boolean nova_orion_katiara_orion_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean nova_orion_katiara_orion_condition_isMyPlayer(obj_id player, obj_id npc)
    {
    ...
    public void nova_orion_katiara_orion_action_finalReward(obj_id player, obj_id npc)
    {
    ...
    public int nova_orion_katiara_orion_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emergencySelfCleanUp(obj_id self, dictionary params)
    {
        destroyObject(self);
        return SCRIPT_CONTINUE;
    }
