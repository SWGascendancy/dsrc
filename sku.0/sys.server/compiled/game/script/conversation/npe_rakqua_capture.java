...
public class npe_rakqua_capture extends script.base_script
{
    ...
    public boolean npe_rakqua_capture_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_rakqua_capture_condition_isTaskActiveQuest(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_officer_try", "freeNeina");
    }
    public boolean npe_rakqua_capture_condition_isHuntActive(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_officer_try", "hunt");
    }
    public boolean npe_rakqua_capture_condition_isReturnActive(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_officer_try", "returnRak");
    }
    public boolean npe_rakqua_capture_condition_haveFiles(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_officer_try_2", "findRak");
    }
    public void npe_rakqua_capture_action_giveHuntSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "freeNeina");
    }
    public void npe_rakqua_capture_action_talkedRak(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "killComplete");
    }
    public void npe_rakqua_capture_action_gaveFiles(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "giveFiles");
    }
    public int npe_rakqua_capture_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_rakqua_capture_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_rakqua_capture_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_rakqua_capture_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_rakqua_capture_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_rakqua_capture_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_rakqua_capture_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_rakqua_capture_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_rakqua_capture_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_rakqua_capture_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
