...
public class c_bounty_hunter_oldksam extends script.base_script
{
    ...
    public boolean c_bounty_hunter_oldksam_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_bounty_hunter_oldksam_condition_isTaskActiveBounty1(obj_id player, obj_id npc)
    {
    ...
    public boolean c_bounty_hunter_oldksam_condition_hasCompletedQuestBounty1(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedQuest(player, "c_bounty_hunter_kill_1"));
    }
    public boolean c_bounty_hunter_oldksam_condition_onGiveFlower(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/c_bounty_hunter_kill_1");
    ...
    public boolean c_bounty_hunter_oldksam_condition_completedConversation(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/c_bounty_hunter_kill_1");
        int ground = groundquests.getTaskId(questId1, "bounty_hunter_kill_1_e5");
    ...
    public void c_bounty_hunter_oldksam_action_giveSignalTalk(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "bounty_hunter_kill_1_launch_e6");
    }
    public void c_bounty_hunter_oldksam_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int c_bounty_hunter_oldksam_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_bounty_hunter_oldksam_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_bounty_hunter_oldksam_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_bounty_hunter_oldksam_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_bounty_hunter_oldksam_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
