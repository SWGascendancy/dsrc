...
public class npe_main_bartender extends script.base_script
{
    ...
    public boolean npe_main_bartender_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_main_bartender_condition_onPointerQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_main_bartender_condition_completedAssignment(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_new_artisan_quest", "readyforreward");
    }
    public boolean npe_main_bartender_condition_isArtisanQuestActive(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "npe_new_artisan_quest");
    }
    public boolean npe_main_bartender_condition_completedArtisanQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_new_artisan_quest");
    }
    public boolean npe_main_bartender_condition_onTraderTask(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_prof_artisan1", "talktobartender");
    }
    public boolean npe_main_bartender_condition_ifBHPointed(obj_id player, obj_id npc)
    {
        String pTemplate = getSkillTemplate(player);
    ...
    public void npe_main_bartender_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void npe_main_bartender_action_signalMainLineStepComplete(obj_id player, obj_id npc)
    {
    ...
    public void npe_main_bartender_action_signalTraderTask(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_prof_artisan1_bartender");
    }
    public void npe_main_bartender_action_giveQuest(obj_id player, obj_id npc)
    {
    ...
    public void npe_main_bartender_action_giveBHPointer(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talked_to_bartender");
        groundquests.grantQuest(player, "npe_pointer_bounty_template");
    }
    public int npe_main_bartender_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_main_bartender_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_main_bartender_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_main_bartender_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_main_bartender_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_main_bartender_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_main_bartender_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_main_bartender_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_main_bartender_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_main_bartender_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_main_bartender_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
