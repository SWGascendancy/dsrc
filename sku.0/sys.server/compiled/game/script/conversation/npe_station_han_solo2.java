...
public class npe_station_han_solo2 extends script.base_script
{
    ...
    public boolean npe_station_han_solo2_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_station_han_solo2_condition_firstConversation(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "npe_solo_profession");
    }
    public boolean npe_station_han_solo2_condition_secondConversation(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_solo_profession", "talktosolo2");
    }
    public boolean npe_station_han_solo2_condition_finishedClassQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_smuggler_try");
    }
    public boolean npe_station_han_solo2_condition_ClassQuestActive(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "npe_smuggler_try", "talktojake");
    }
    public boolean npe_station_han_solo2_condition_isTraining(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "npe_smuggler_try");
    }
    public boolean npe_station_han_solo2_condition_onLastSmugglerStep(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_smuggler_try_2", "talktohan");
    }
    public boolean npe_station_han_solo2_condition_isBH(obj_id player, obj_id npc)
    {
        return utils.isProfession(player, utils.BOUNTY_HUNTER);
    }
    public boolean npe_station_han_solo2_condition_choseProfessionTrainer(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_solo_profession_2");
    }
    public boolean npe_station_han_solo2_condition_onMainQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "npe_new_main_quest");
    }
    public boolean npe_station_han_solo2_condition_onCantinaStep(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "npe_new_main_quest", "getparts");
    }
    public boolean npe_station_han_solo2_condition_onCollectStep(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "npe_new_main_quest", "bounty");
    }
    public boolean npe_station_han_solo2_condition_onlastHanstep(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_new_main_quest", "return");
    }
    public boolean npe_station_han_solo2_condition_onInaldraQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "npe_inaldra_quest");
    }
    public boolean npe_station_han_solo2_condition_finishedInaldraQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_inaldra_quest");
    }
    public boolean npe_station_han_solo2_condition_completedMainQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_new_main_quest");
    }
    public boolean npe_station_han_solo2_condition_playerisSpy(obj_id player, obj_id npc)
    {
        return utils.isProfession(player, utils.SPY);
    }
    public boolean npe_station_han_solo2_condition_isSmugglerToTrain(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_station_han_solo2_condition_playerisTrader(obj_id player, obj_id npc)
    {
        return utils.isProfession(player, utils.TRADER);
    }
    public boolean npe_station_han_solo2_condition_playerisForceSensitive(obj_id player, obj_id npc)
    {
        return utils.isProfession(player, utils.FORCE_SENSITIVE);
    }
    public boolean npe_station_han_solo2_condition_playerisEntertainer(obj_id player, obj_id npc)
    {
        return utils.isProfession(player, utils.ENTERTAINER);
    }
    public boolean npe_station_han_solo2_condition_playerisMedic(obj_id player, obj_id npc)
    {
        return utils.isProfession(player, utils.MEDIC);
    }
    public boolean npe_station_han_solo2_condition_playerisOfficer(obj_id player, obj_id npc)
    {
        return utils.isProfession(player, utils.OFFICER);
    }
    public boolean npe_station_han_solo2_condition_playerisSmuggler(obj_id player, obj_id npc)
    {
        return utils.isProfession(player, utils.SMUGGLER);
    }
    public boolean npe_station_han_solo2_condition_playerisCommando(obj_id player, obj_id npc)
    {
        return utils.isProfession(player, utils.COMMANDO);
    }
    public boolean npe_station_han_solo2_condition_playerisBountyHunter(obj_id player, obj_id npc)
    {
        return utils.isProfession(player, utils.BOUNTY_HUNTER);
    }
    public boolean npe_station_han_solo2_condition_finishedProfessionTrainer(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "npe.finishedTemplate");
    }
    public boolean npe_station_han_solo2_condition_finishedTraining(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_station_han_solo2_condition_isAtLeastLevel5(obj_id player, obj_id npc)
    {
    ...
    public void npe_station_han_solo2_action_giveContactPointer(obj_id player, obj_id npc)
    {
    ...
    public void npe_station_han_solo2_action_signaSmugglerQuestComplete(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "donedone");
        groundquests.sendSignal(player, "found_smuggler");
    }
    public void npe_station_han_solo2_action_giveSecretaryPointer(obj_id player, obj_id npc)
    {
    ...
    public void npe_station_han_solo2_action_giveSmugglerQuestSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_smuggler_try_2_han");
        setObjVar(player, "npe.finishedTemplate", 1);
        play2dNonLoopingSound(player, "sound/vo_han_solo_33c.snd");
    }
    public void npe_station_han_solo2_action_giveFirstReward(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public void npe_station_han_solo2_action_giveAnothersignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "found_smuggler");
    }
    public void npe_station_han_solo2_action_sound1(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_11c.snd");
    }
    public void npe_station_han_solo2_action_sound2(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_12c.snd");
        faceTo(npc, player);
    }
    public void npe_station_han_solo2_action_signalMainQuestComplete(obj_id player, obj_id npc)
    {
    ...
    public void npe_station_han_solo2_action_giveMainQuest(obj_id player, obj_id npc)
    {
    ...
    public void npe_station_han_solo2_action_faceplayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void npe_station_han_solo2_action_sound3(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_13c.snd");
    }
    public void npe_station_han_solo2_action_giveProfessionPointer(obj_id player, obj_id npc)
    {
        npe.giveTemplatePointer(player);
        play2dNonLoopingSound(player, "sound/vo_han_solo_14c.snd");
    }
    public void npe_station_han_solo2_action_leaveStation(obj_id player, obj_id npc)
    {
    ...
    public void npe_station_han_solo2_action_signalMQCompleteNoInaldra(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_new_main_quest_han");
        groundquests.grantQuest(player, "npe_job_pointer_han");
        play2dNonLoopingSound(player, "sound/vo_han_solo_51c.snd");
    }
    public void npe_station_han_solo2_action_sound4(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_15c.snd");
    }
    public void npe_station_han_solo2_action_sound5(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_16c.snd");
    }
    public void npe_station_han_solo2_action_sound6(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_17c.snd");
    }
    public void npe_station_han_solo2_action_sound7(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_18c.snd");
    }
    public void npe_station_han_solo2_action_sound8(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_19c.snd");
    }
    public void npe_station_han_solo2_action_sound9(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_20c.snd");
    }
    public void npe_station_han_solo2_action_sound10(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_21c.snd");
    }
    public void npe_station_han_solo2_action_sound11(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_22c.snd");
        npe.giveTemplatePointer(player);
    }
    public void npe_station_han_solo2_action_sound12(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_25c.snd");
        faceTo(npc, player);
    }
    public void npe_station_han_solo2_action_sound13(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_26c.snd");
        faceTo(npc, player);
    }
    public void npe_station_han_solo2_action_sound14(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_27c.snd");
    }
    public void npe_station_han_solo2_action_sound15(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_29c.snd");
        faceTo(npc, player);
    }
    public void npe_station_han_solo2_action_sound16(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_30c.snd");
        faceTo(npc, player);
    }
    public void npe_station_han_solo2_action_sound17(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_31c.snd");
        faceTo(npc, player);
    }
    public void npe_station_han_solo2_action_sound18(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_32c.snd");
    }
    public void npe_station_han_solo2_action_sound19(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_35c.snd");
    }
    public void npe_station_han_solo2_action_sound20(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_36c.snd");
        faceTo(npc, player);
    }
    public void npe_station_han_solo2_action_sound21(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_37c.snd");
    }
    public void npe_station_han_solo2_action_sound22(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_38c.snd");
    }
    public void npe_station_han_solo2_action_sound23(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_40c.snd");
    }
    public void npe_station_han_solo2_action_sound24(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_41c.snd");
    }
    public void npe_station_han_solo2_action_sound25(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_34c.snd");
    }
    public void npe_station_han_solo2_action_sound26(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_43c.snd");
        faceTo(npc, player);
    }
    public void npe_station_han_solo2_action_sound27(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_44c.snd");
        faceTo(npc, player);
    }
    public void npe_station_han_solo2_action_sound28(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_45c.snd");
    }
    public void npe_station_han_solo2_action_sound29(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_46c.snd");
        faceTo(npc, player);
    }
    public void npe_station_han_solo2_action_sound30(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_47c.snd");
    }
    public void npe_station_han_solo2_action_sound31(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_48c.snd");
    }
    public void npe_station_han_solo2_action_sound32(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_49c.snd");
        faceTo(npc, player);
    }
    public void npe_station_han_solo2_action_sound33(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_50c.snd");
    }
    public void npe_station_han_solo2_action_sound34(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_53c.snd");
        faceTo(npc, player);
    }
    public void npe_station_han_solo2_action_sound35(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_54c.snd");
    }
    public void npe_station_han_solo2_action_sound36(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_55c.snd");
    }
    public void npe_station_han_solo2_action_sound37(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_56c.snd");
    }
    public void npe_station_han_solo2_action_sound38(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_57c.snd");
    }
    public void npe_station_han_solo2_action_sound39(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_58c.snd");
    }
    public void npe_station_han_solo2_action_sound40(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_59c.snd");
    }
    public void npe_station_han_solo2_action_sound41(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_60c.snd");
    }
    public void npe_station_han_solo2_action_sound42(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_61c.snd");
    }
    public void npe_station_han_solo2_action_sound43(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_62c.snd");
    }
    public void npe_station_han_solo2_action_sound44(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_63c.snd");
    }
    public void npe_station_han_solo2_action_sound45(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_65c.snd");
    }
    public void npe_station_han_solo2_action_sound46(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_66c.snd");
        faceTo(npc, player);
    }
    public void npe_station_han_solo2_action_sound2ca(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_12ca.snd");
    }
    public void npe_station_han_solo2_action_sound47(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_xtra3.snd");
    }
    public void npe_station_han_solo2_action_sound48(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/vo_han_solo_xtra4.snd");
        npe_station_han_solo2_action_giveSecretaryPointer(player, npc);
    }
    public void npe_station_han_solo2_action_sendMainSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_new_main_quest_han");
    }
    public int npe_station_han_solo2_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo2_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo2_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo2_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo2_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo2_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo2_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo2_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo2_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo2_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo2_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo2_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo2_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo2_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo2_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo2_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo2_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo2_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo2_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo2_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo2_handleBranch31(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo2_handleBranch32(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo2_handleBranch33(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo2_handleBranch35(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo2_handleBranch36(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo2_handleBranch37(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo2_handleBranch38(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_95"))
        {
            if (npe_station_han_solo2_condition__defaultCondition(player, npc))
    ...
    public int npe_station_han_solo2_handleBranch41(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo2_handleBranch42(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo2_handleBranch45(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo2_handleBranch46(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo2_handleBranch47(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo2_handleBranch48(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo2_handleBranch49(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_han_solo2_handleBranch51(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_146"))
        {
            if (npe_station_han_solo2_condition__defaultCondition(player, npc))
    ...
    public int npe_station_han_solo2_handleBranch52(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_146"))
        {
            if (npe_station_han_solo2_condition__defaultCondition(player, npc))
    ...
    public int npe_station_han_solo2_handleBranch53(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_146"))
        {
            if (npe_station_han_solo2_condition__defaultCondition(player, npc))
    ...
    public int npe_station_han_solo2_handleBranch54(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_146"))
        {
            if (npe_station_han_solo2_condition__defaultCondition(player, npc))
    ...
    public int npe_station_han_solo2_handleBranch55(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_146"))
        {
            if (npe_station_han_solo2_condition__defaultCondition(player, npc))
    ...
    public int npe_station_han_solo2_handleBranch56(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_146"))
        {
            if (npe_station_han_solo2_condition__defaultCondition(player, npc))
    ...
    public int npe_station_han_solo2_handleBranch57(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_146"))
        {
            if (npe_station_han_solo2_condition__defaultCondition(player, npc))
    ...
    public int npe_station_han_solo2_handleBranch58(obj_id player, obj_id npc, string_id response)
    {
