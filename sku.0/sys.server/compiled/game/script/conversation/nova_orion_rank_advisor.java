...
public class nova_orion_rank_advisor extends script.base_script
{
    ...
    public boolean nova_orion_rank_advisor_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean nova_orion_rank_advisor_condition_isRank4(obj_id player, obj_id npc)
    {
        return (hasCompletedCollectionSlot(player, "nova_rank_01_04") || hasCompletedCollectionSlot(player, "orion_rank_01_04"));
    }
    public boolean nova_orion_rank_advisor_condition_isRank2Orion(obj_id player, obj_id npc)
    {
    ...
    public boolean nova_orion_rank_advisor_condition_hasEnoughCrystalsRank3(obj_id player, obj_id npc)
    {
        int count = township.getMidlitheCrystalCount(player);
        return count >= township.RANK_THREE_AMOUNT;
    }
    public boolean nova_orion_rank_advisor_condition_readyRank3(obj_id player, obj_id npc)
    {
    ...
    public boolean nova_orion_rank_advisor_condition_isRank2Nova(obj_id player, obj_id npc)
    {
        if (!hasObjVar(player, township.OBJVAR_NOVA_ORION_FACTION))
        {
            return false;
    ...
    public boolean nova_orion_rank_advisor_condition_orionReadyRank4(obj_id player, obj_id npc)
    {
        if (!hasObjVar(player, township.OBJVAR_NOVA_ORION_FACTION))
        {
            return false;
    ...
    public boolean nova_orion_rank_advisor_condition_readyRank2(obj_id player, obj_id npc)
    {
    ...
    public boolean nova_orion_rank_advisor_condition_novaReadyRank4(obj_id player, obj_id npc)
    {
        if (!hasObjVar(player, township.OBJVAR_NOVA_ORION_FACTION))
        {
            return false;
    ...
    public boolean nova_orion_rank_advisor_condition_notReadyRank4Nova(obj_id player, obj_id npc)
    {
        if (!hasObjVar(player, township.OBJVAR_NOVA_ORION_FACTION))
        {
            return false;
    ...
    public boolean nova_orion_rank_advisor_condition_needsRank1(obj_id player, obj_id npc)
    {
        return (!hasCompletedCollectionSlot(player, "nova_orion_rank_01") && groundquests.hasCompletedQuest(player, "nova_orion_intro_01"));
    }
    public boolean nova_orion_rank_advisor_condition_hasLarnedAboutCrystals(obj_id player, obj_id npc)
    {
        return hasObjVar(player, township.OBJVAR_KNOWS_CRYSTAL);
    }
    public boolean nova_orion_rank_advisor_condition_notReadyRank4Orion(obj_id player, obj_id npc)
    {
        if (!hasObjVar(player, township.OBJVAR_NOVA_ORION_FACTION))
        {
            return false;
    ...
    public boolean nova_orion_rank_advisor_condition_hasEnoughCrystalsRank2(obj_id player, obj_id npc)
    {
        int count = township.getMidlitheCrystalCount(player);
        return count >= township.RANK_TWO_AMOUNT;
    }
    public boolean nova_orion_rank_advisor_condition_hasEnoughCrystalsRank4(obj_id player, obj_id npc)
    {
        int count = township.getMidlitheCrystalCount(player);
        return count >= township.RANK_FOUR_AMOUNT;
    }
    public boolean nova_orion_rank_advisor_condition_notReadyRank3(obj_id player, obj_id npc)
    {
        return (!groundquests.hasCompletedQuest(player, "no_rank2_04") && hasCompletedCollectionSlot(player, "nova_orion_rank_02"));
    }
    public boolean nova_orion_rank_advisor_condition_notReadyRank2(obj_id player, obj_id npc)
    {
        return (!groundquests.hasCompletedQuest(player, "nova_orion_rank1_03") && hasCompletedCollectionSlot(player, "nova_orion_rank_01"));
    }
    public boolean nova_orion_rank_advisor_condition_needsToLearnCrystals(obj_id player, obj_id npc)
    {
        return (!hasObjVar(player, township.OBJVAR_KNOWS_CRYSTAL) && groundquests.hasCompletedQuest(player, "nova_orion_rank1_03"));
    }
    public void nova_orion_rank_advisor_action_grantRank1(obj_id player, obj_id npc)
    {
        modifyCollectionSlotValue(player, "nova_orion_rank_01", 1);
    }
    public void nova_orion_rank_advisor_action_setLearnedCrystals(obj_id player, obj_id npc)
    {
        setObjVar(player, township.OBJVAR_KNOWS_CRYSTAL, true);
    }
    public void nova_orion_rank_advisor_action_grantRank2(obj_id player, obj_id npc)
    {
        int count = township.getMidlitheCrystalCount(player);
    ...
    public void nova_orion_rank_advisor_action_grantRank3Orion(obj_id player, obj_id npc)
    {
        int count = township.getMidlitheCrystalCount(player);
        obj_id crystal = utils.getStaticItemInInventory(player, township.MIDLITHE_CRYSTAL);
    ...
    public void nova_orion_rank_advisor_action_grantRank3Nova(obj_id player, obj_id npc)
    {
        int count = township.getMidlitheCrystalCount(player);
        obj_id crystal = utils.getStaticItemInInventory(player, township.MIDLITHE_CRYSTAL);
        count -= township.RANK_THREE_AMOUNT;
    ...
    public void nova_orion_rank_advisor_action_grantRank4Nova(obj_id player, obj_id npc)
    {
        int count = township.getMidlitheCrystalCount(player);
        obj_id crystal = utils.getStaticItemInInventory(player, township.MIDLITHE_CRYSTAL);
    ...
    public void nova_orion_rank_advisor_action_grantRank4Orion(obj_id player, obj_id npc)
    {
        int count = township.getMidlitheCrystalCount(player);
        obj_id crystal = utils.getStaticItemInInventory(player, township.MIDLITHE_CRYSTAL);
        count -= township.RANK_FOUR_AMOUNT;
    ...
    public String nova_orion_rank_advisor_tokenTO_rank3JobTitle(obj_id player, obj_id npc)
    {
    ...
    public int nova_orion_rank_advisor_tokenDI_rank2Amount(obj_id player, obj_id npc)
    {
        return township.RANK_TWO_AMOUNT;
    }
    public int nova_orion_rank_advisor_tokenDI_rank2Short(obj_id player, obj_id npc)
    {
        int count = township.getMidlitheCrystalCount(player);
        return township.RANK_TWO_AMOUNT - count;
    }
    public int nova_orion_rank_advisor_tokenDI_rank3Amount(obj_id player, obj_id npc)
    {
        return township.RANK_THREE_AMOUNT;
    }
    public int nova_orion_rank_advisor_tokenDI_rank3Short(obj_id player, obj_id npc)
    {
        int count = township.getMidlitheCrystalCount(player);
        return township.RANK_THREE_AMOUNT - count;
    }
    public int nova_orion_rank_advisor_tokenDI_rank4Amount(obj_id player, obj_id npc)
    {
        return township.RANK_FOUR_AMOUNT;
    }
    public int nova_orion_rank_advisor_tokenDI_rank4Short(obj_id player, obj_id npc)
    {
        int count = township.getMidlitheCrystalCount(player);
        return township.RANK_FOUR_AMOUNT - count;
    }
    public int nova_orion_rank_advisor_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nova_orion_rank_advisor_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nova_orion_rank_advisor_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nova_orion_rank_advisor_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nova_orion_rank_advisor_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nova_orion_rank_advisor_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nova_orion_rank_advisor_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nova_orion_rank_advisor_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nova_orion_rank_advisor_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nova_orion_rank_advisor_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nova_orion_rank_advisor_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nova_orion_rank_advisor_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nova_orion_rank_advisor_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nova_orion_rank_advisor_handleBranch30(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nova_orion_rank_advisor_handleBranch33(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nova_orion_rank_advisor_handleBranch34(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nova_orion_rank_advisor_handleBranch35(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nova_orion_rank_advisor_handleBranch36(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nova_orion_rank_advisor_handleBranch37(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nova_orion_rank_advisor_handleBranch38(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nova_orion_rank_advisor_handleBranch40(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nova_orion_rank_advisor_handleBranch41(obj_id player, obj_id npc, string_id response)
    {
