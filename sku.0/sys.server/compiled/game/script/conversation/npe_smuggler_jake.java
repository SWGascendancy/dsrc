...
public class npe_smuggler_jake extends script.base_script
{
    ...
    public boolean npe_smuggler_jake_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_smuggler_jake_condition_onFirstStep(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_smuggler_try", "talktojake");
    }
    public boolean npe_smuggler_jake_condition_onRewardStep(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_smuggler_try", "imDone");
    }
    public boolean npe_smuggler_jake_condition_finishedFirstStep(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "npe_smuggler_try", "talktojake");
    }
    public boolean npe_smuggler_jake_condition_playerNeedsHanQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_smuggler_jake_condition_playerFinishedQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_smuggler_try");
    }
    public void npe_smuggler_jake_action_sendJobTaken(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_smuggler_try_take_work");
    }
    public void npe_smuggler_jake_action_sendFinishedJob(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "reward");
        groundquests.grantQuest(player, "npe_smuggler_try_2");
    }
    public void npe_smuggler_jake_action_giveHanQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_smuggler_try_2");
    }
    public int npe_smuggler_jake_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_smuggler_jake_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_smuggler_jake_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_smuggler_jake_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_smuggler_jake_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_26"))
        {
            npe_smuggler_jake_action_sendJobTaken(player, npc);
