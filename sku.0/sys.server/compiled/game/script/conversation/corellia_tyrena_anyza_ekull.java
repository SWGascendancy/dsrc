...
public class corellia_tyrena_anyza_ekull extends script.base_script
{
    ...
    public boolean corellia_tyrena_anyza_ekull_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_tyrena_anyza_ekull_condition_completeMissing(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "corellia_tyrena_missing_persons");
    }
    public boolean corellia_tyrena_anyza_ekull_condition_completeSlavemaster(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "corellia_tyrena_slavemaster");
    }
    public boolean corellia_tyrena_anyza_ekull_condition_onSlavemaster(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_tyrena_slavemaster", "slavemaster_kill_slavemaster");
    }
    public boolean corellia_tyrena_anyza_ekull_condition_onReturnAnyza(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_tyrena_slavemaster", "slavemaster_return_anyza");
    }
    public void corellia_tyrena_anyza_ekull_action_grantSlavemaster(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "corellia_tyrena_slavemaster");
    }
    public void corellia_tyrena_anyza_ekull_action_signalReturnAnyza(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "slavemaster_return_anyza");
    }
    public int corellia_tyrena_anyza_ekull_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_anyza_ekull_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_anyza_ekull_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_anyza_ekull_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_anyza_ekull_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_anyza_ekull_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_anyza_ekull_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_anyza_ekull_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_anyza_ekull_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_anyza_ekull_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
