...
public class nym_themepark_disgruntled extends script.base_script
{
    ...
    public boolean nym_themepark_disgruntled_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean nym_themepark_disgruntled_condition_needsToSpeakWithLeader(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "u16_nym_meet_townspeople", "findTownsPeople");
    }
    public boolean nym_themepark_disgruntled_condition_notOnQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return !groundquests.isTaskActive(player, "u16_nym_meet_townspeople", "findTownsPeople");
    }
    public int nym_themepark_disgruntled_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
