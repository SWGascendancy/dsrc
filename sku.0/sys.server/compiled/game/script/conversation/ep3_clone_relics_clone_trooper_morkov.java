...
public class ep3_clone_relics_clone_trooper_morkov extends script.base_script
{
    ...
    public boolean ep3_clone_relics_clone_trooper_morkov_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_clone_relics_clone_trooper_morkov_condition_onTaskTalkToMorkov(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "ep3_clone_relics_clone_trooper_mort_1", "talkToMorkov"));
    }
    public boolean ep3_clone_relics_clone_trooper_morkov_condition_goToNaboo(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedTask(player, "ep3_clone_relics_clone_trooper_mort_1", "talkToMorkov"));
    }
    public boolean ep3_clone_relics_clone_trooper_morkov_condition_playerWantToKillMorkov(obj_id player, obj_id npc)
    {
    ...
    public void ep3_clone_relics_clone_trooper_morkov_action_signalMorkov(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedToMorkov");
    }
    public void ep3_clone_relics_clone_trooper_morkov_action_attackPlayer(obj_id player, obj_id npc)
    {
        setInvulnerable(npc, false);
        clearCondition(npc, CONDITION_CONVERSABLE);
        startCombat(npc, player);
    }
    public int ep3_clone_relics_clone_trooper_morkov_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_morkov_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_morkov_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_morkov_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_morkov_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_morkov_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_morkov_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_morkov_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_49"))
        {
            doAnimationAction(player, "shrug_hands");
    ...
    public int ep3_clone_relics_clone_trooper_morkov_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_morkov_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_morkov_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_morkov_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_49"))
        {
            doAnimationAction(player, "shrug_hands");
    ...
    public int ep3_clone_relics_clone_trooper_morkov_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_morkov_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_34"))
        {
            if (ep3_clone_relics_clone_trooper_morkov_condition__defaultCondition(player, npc))
    ...
    public int ep3_clone_relics_clone_trooper_morkov_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_morkov_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_morkov_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_morkov_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
