...
public class rtp_leia_main extends script.base_script
{
    ...
    public boolean rtp_leia_main_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean rtp_leia_main_condition_rtp_leia_01_active(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "rtp_leia_01");
    }
    public boolean rtp_leia_main_condition_rtp_leia_01_complete(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "rtp_leia_01", "rtp_leia_01_02") || groundquests.hasCompletedQuest(player, "rtp_leia_01");
    }
    public boolean rtp_leia_main_condition_rtp_leia_02_active(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "rtp_leia_02");
    }
    public boolean rtp_leia_main_condition_rtp_leia_03_complete(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "rtp_leia_03", "rtp_leia_03_02") || groundquests.hasCompletedQuest(player, "rtp_leia_03");
    }
    public boolean rtp_leia_main_condition_rtp_leia_03_active(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "rtp_leia_03");
    }
    public boolean rtp_leia_main_condition_rtp_leia_02_complete(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "rtp_leia_02", "rtp_leia_02_03") || groundquests.hasCompletedQuest(player, "rtp_leia_02");
    }
    public boolean rtp_leia_main_condition_completedWedge(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "rtp_wedge_01");
    }
    public boolean rtp_leia_main_condition_notRebel(obj_id player, obj_id npc)
    {
    ...
    public boolean rtp_leia_main_condition_rebel_isOnLeave(obj_id player, obj_id npc)
    {
        return factions.isOnLeave(player);
    }
    public void rtp_leia_main_action_rtp_leia_01_granted(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "rtp_leia_01");
    }
    public void rtp_leia_main_action_rtp_leia_01_signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "rtp_leia_01_02");
    }
    public void rtp_leia_main_action_rtp_leia_03_signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "rtp_leia_03_02");
    }
    public void rtp_leia_main_action_rtp_leia_02_signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "rtp_leia_02_03");
    }
    public void rtp_leia_main_action_rtp_leia_02_granted(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "rtp_leia_02");
    }
    public void rtp_leia_main_action_rtp_leia_03_granted(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "rtp_leia_03");
    }
    public int rtp_leia_main_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rtp_leia_main_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rtp_leia_main_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
