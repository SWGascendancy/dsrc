...
public class imperial_life_day_vendor extends script.base_script
{
    ...
    public boolean imperial_life_day_vendor_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean imperial_life_day_vendor_condition_alreadyWorking(obj_id player, obj_id npc)
    {
    ...
    public boolean imperial_life_day_vendor_condition_lockedOut(obj_id player, obj_id npc)
    {
    ...
    public boolean imperial_life_day_vendor_condition_godMode(obj_id player, obj_id npc)
    {
        return (isGod(player));
    }
    public boolean imperial_life_day_vendor_condition_scoreBoardNotEmpty(obj_id player, obj_id npc)
    {
    ...
    public boolean imperial_life_day_vendor_condition_alreadyWorking_2(obj_id player, obj_id npc)
    {
    ...
    public boolean imperial_life_day_vendor_condition_rebelPlayer(obj_id player, obj_id npc)
    {
    ...
    public boolean imperial_life_day_vendor_condition_neutral(obj_id player, obj_id npc)
    {
    ...
    public boolean imperial_life_day_vendor_condition_wookiee(obj_id player, obj_id npc)
    {
    ...
    public void imperial_life_day_vendor_action_showTokenVendorUI(obj_id player, obj_id npc)
    {
    ...
    public void imperial_life_day_vendor_action_addCasualBuff(obj_id player, obj_id npc)
    {
        int lifeDayBuff = buff.getBuffOnTargetFromGroup(player, "lifeday_tracker");
        if (lifeDayBuff == 0)
        {
    ...
    public void imperial_life_day_vendor_action_addCompetitiveBuff(obj_id player, obj_id npc)
    {
        int lifeDayBuff = buff.getBuffOnTargetFromGroup(player, "lifeday_tracker");
        if (lifeDayBuff == 0)
        {
    ...
    public void imperial_life_day_vendor_action_barkLeaders(obj_id player, obj_id npc)
    {
    ...
    public void imperial_life_day_vendor_action_barkLeadersSilent(obj_id player, obj_id npc)
    {
        obj_id tatooine = getPlanetByName("tatooine");
        if (!isIdValid(tatooine))
        {
    ...
    public int imperial_life_day_vendor_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_life_day_vendor_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_life_day_vendor_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_life_day_vendor_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_life_day_vendor_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_life_day_vendor_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_life_day_vendor_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_71"))
        {
            doAnimationAction(player, "salute2");
    ...
    public int imperial_life_day_vendor_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int imperial_life_day_vendor_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_71"))
        {
            doAnimationAction(player, "salute2");
