...
public class fs_gadget_specialist extends script.base_script
{
    ...
    public boolean fs_gadget_specialist_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean fs_gadget_specialist_condition_onQuestStep01(obj_id player, obj_id npc)
    {
    ...
    public boolean fs_gadget_specialist_condition_onQuestStep02(obj_id player, obj_id npc)
    {
        if (hasScript(player, "quest.force_sensitive.fs_crafting4_player"))
        {
    ...
    public boolean fs_gadget_specialist_condition_onQuestStep03(obj_id player, obj_id npc)
    {
        if (hasScript(player, "quest.force_sensitive.fs_crafting4_player"))
        {
    ...
    public boolean fs_gadget_specialist_condition_onQuestStep04(obj_id player, obj_id npc)
    {
        if (hasScript(player, "quest.force_sensitive.fs_crafting4_player"))
        {
    ...
    public boolean fs_gadget_specialist_condition_onQuestStep05(obj_id player, obj_id npc)
    {
        if (hasScript(player, "quest.force_sensitive.fs_crafting4_player"))
        {
    ...
    public boolean fs_gadget_specialist_condition_onQuestStep06(obj_id player, obj_id npc)
    {
        if (hasScript(player, "quest.force_sensitive.fs_crafting4_player"))
        {
    ...
    public boolean fs_gadget_specialist_condition_noInventorySpace(obj_id player, obj_id npc)
    {
    ...
    public boolean fs_gadget_specialist_condition_notEnoughCredits(obj_id player, obj_id npc)
    {
        return (!money.hasFunds(player, money.MT_TOTAL, 530));
    }
    public boolean fs_gadget_specialist_condition_returningForKit(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "fs_crafting4.gadget.returnForKit");
    }
    public boolean fs_gadget_specialist_condition_onGoGoGadgetQuest(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_coronet_capitol_problems_go_go_gadget", "go_go_gadget_1");
    }
    public boolean fs_gadget_specialist_condition_goGoGadgetFavorDone(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_coronet_capitol_problems_go_go_gadget", "go_go_gadget_5");
    }
    public void fs_gadget_specialist_action_giveTrackingDeviceKit(obj_id player, obj_id npc)
    {
    ...
    public void fs_gadget_specialist_action_setReturningForKit(obj_id player, obj_id npc)
    {
        setObjVar(player, "fs_crafting4.gadget.returnForKit", 1);
        return;
    }
    public void fs_gadget_specialist_action_goGoGadgetFavor(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "go_go_gadget_1");
    }
    public void fs_gadget_specialist_action_goGoGadgetEnd(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "go_go_gadget_5");
    }
    public int fs_gadget_specialist_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int fs_gadget_specialist_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int fs_gadget_specialist_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int fs_gadget_specialist_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int fs_gadget_specialist_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int fs_gadget_specialist_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int fs_gadget_specialist_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int fs_gadget_specialist_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int fs_gadget_specialist_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int fs_gadget_specialist_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int fs_gadget_specialist_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_a8749106"))
        {
            if (fs_gadget_specialist_condition_notEnoughCredits(player, npc))
