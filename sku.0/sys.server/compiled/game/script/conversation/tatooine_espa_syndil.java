...
public class tatooine_espa_syndil extends script.base_script
{
    ...
    public boolean tatooine_espa_syndil_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tatooine_espa_syndil_condition_legOnTask(obj_id player, obj_id npc)
    {
    ...
    public boolean tatooine_espa_syndil_condition_legPastTask(obj_id player, obj_id npc)
    {
    ...
    public void tatooine_espa_syndil_action_grantLegQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tat_espa_leg_work_e1");
    }
    public void tatooine_espa_syndil_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int tatooine_espa_syndil_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_espa_syndil_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_espa_syndil_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_espa_syndil_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_espa_syndil_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_espa_syndil_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_espa_syndil_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_espa_syndil_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_espa_syndil_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_espa_syndil_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_espa_syndil_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
