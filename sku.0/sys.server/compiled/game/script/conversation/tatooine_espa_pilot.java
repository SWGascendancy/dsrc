...
public class tatooine_espa_pilot extends script.base_script
{
    ...
    public boolean tatooine_espa_pilot_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tatooine_espa_pilot_condition_pilotOnTask(obj_id player, obj_id npc)
    {
    ...
    public boolean tatooine_espa_pilot_condition_pilotPastTask(obj_id player, obj_id npc)
    {
    ...
    public void tatooine_espa_pilot_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void tatooine_espa_pilot_action_signalPilotTask(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tat_espa_leg_work_e2");
    }
    public int tatooine_espa_pilot_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_espa_pilot_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_espa_pilot_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_espa_pilot_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_espa_pilot_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_espa_pilot_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_espa_pilot_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_espa_pilot_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_espa_pilot_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_espa_pilot_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_espa_pilot_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_espa_pilot_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_espa_pilot_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_espa_pilot_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
