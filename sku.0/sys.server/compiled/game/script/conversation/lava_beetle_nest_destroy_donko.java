...
public class lava_beetle_nest_destroy_donko extends script.base_script
{
    ...
    public boolean lava_beetle_nest_destroy_donko_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean lava_beetle_nest_destroy_donko_condition_isMissionActive(obj_id player, obj_id npc)
    {
    ...
    public boolean lava_beetle_nest_destroy_donko_condition_isOnTask(obj_id player, obj_id npc)
    {
    ...
    public boolean lava_beetle_nest_destroy_donko_condition_isMissionComplete(obj_id player, obj_id npc)
    {
    ...
    public boolean lava_beetle_nest_destroy_donko_condition_failedMission(obj_id player, obj_id npc)
    {
    ...
    public void lava_beetle_nest_destroy_donko_action_grantMission(obj_id player, obj_id npc)
    {
    ...
    public void lava_beetle_nest_destroy_donko_action_grantReward(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "mustafar_lava_beetle_nest_reward");
    }
    public void lava_beetle_nest_destroy_donko_action_regrantMission(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "som_lava_beetle_nest_destroy_2");
    }
    public void lava_beetle_nest_destroy_donko_action_clearMission(obj_id player, obj_id npc)
    {
    ...
    public int lava_beetle_nest_destroy_donko_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int lava_beetle_nest_destroy_donko_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int lava_beetle_nest_destroy_donko_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int lava_beetle_nest_destroy_donko_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int lava_beetle_nest_destroy_donko_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int lava_beetle_nest_destroy_donko_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int lava_beetle_nest_destroy_donko_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
