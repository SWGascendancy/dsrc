...
public class npe_medic_wounded2 extends script.base_script
{
    ...
    public boolean npe_medic_wounded2_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_medic_wounded2_condition_hasNotHealed(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_medic2", "npe_medic2_heal");
    }
    public boolean npe_medic_wounded2_condition_isBackWithToxin(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_medic2", "return_technician");
    }
    public boolean npe_medic_wounded2_condition_allHealed(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_medic_wounded2_condition_wasHealed1(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_medic2", "talk_technician");
    }
    public void npe_medic_wounded2_action_sendSignalHealed(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_medic_heal_worker_1");
        return;
    }
    public void npe_medic_wounded2_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void npe_medic_wounded2_action_sendSignalGoBack(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_technician1");
    }
    public void npe_medic_wounded2_action_sendSignalToxinDone(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_technician2");
    }
    public int npe_medic_wounded2_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_medic_wounded2_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_medic_wounded2_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_medic_wounded2_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_medic_wounded2_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_medic_wounded2_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
