...
public class barada extends script.conversation.base.conversation_base
{
    ...
    private int barada_handleBranch5(obj_id player, string_id response)
    {
    ...
    private int barada_handleBranch6(obj_id player, string_id response)
    {
    ...
    private int barada_handleBranch7(obj_id player, string_id response)
    {
    ...
    private int barada_handleBranch8(obj_id player, string_id response)
    {
