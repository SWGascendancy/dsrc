...
public class ep3_vryyyr extends script.base_script
{
    ...
    public boolean ep3_vryyyr_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_vryyyr_condition_knows_Shiryyywook(obj_id player, obj_id npc)
    {
        return utils.canSpeakWookiee(player, npc);
    }
    public boolean ep3_vryyyr_condition_is_Trandoshan(obj_id player, obj_id npc)
    {
        int plrSpecies = getSpecies(player);
        return (plrSpecies == SPECIES_TRANDOSHAN);
    }
    public void ep3_vryyyr_action_growl(obj_id player, obj_id npc)
    {
        playClientEffectObj(npc, "clienteffect/voc_wookiee_loud_6sec.cef", player, "");
    }
    public void ep3_vryyyr_action_medium_talk(obj_id player, obj_id npc)
    {
        playClientEffectObj(npc, "clienteffect/voc_wookiee_loud_2sec.cef", player, "");
    }
    public int ep3_vryyyr_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_vryyyr_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_vryyyr_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_vryyyr_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_vryyyr_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
