...
public class itp_emperor_imp_tech extends script.base_script
{
    ...
    public boolean itp_emperor_imp_tech_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean itp_emperor_imp_tech_condition_emperorTaskActive(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "itp_emperor_01", "itp_emperor_01_03");
    }
    public void itp_emperor_imp_tech_action_emperorSignal(obj_id player, obj_id npc)
    {
