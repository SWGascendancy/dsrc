...
public class nova_orion_vendor extends script.base_script
{
    ...
    public boolean nova_orion_vendor_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean nova_orion_vendor_condition_isANovaOrionEmployee(obj_id player, obj_id npc)
    {
        return hasCompletedCollectionSlot(player, "nova_orion_rank_01");
    }
    public void nova_orion_vendor_action_showResourceVendorUI(obj_id player, obj_id npc)
    {
