...
public class ep3_kymayrr extends script.base_script
{
    ...
    public boolean ep3_kymayrr_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_kymayrr_condition_hasWonTrandoRadio(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_zhailaut_recover_trando_radio");
    }
    public boolean ep3_kymayrr_condition_hasWonAdjutantRecovery(obj_id player, obj_id npc)
    {
        return space_quest.hasWonQuest(player, "recovery", "ep3_slaver_rhosk_recovery");
    }
    public boolean ep3_kymayrr_condition_hasRescuedRroot(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_kymayrr_rescue_rroot", "taskReturnToKymayrr");
    }
    public boolean ep3_kymayrr_condition_hasCompletedRescue(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_kymayrr_rescue_rroot");
    }
    public boolean ep3_kymayrr_condition_hasSlainHsskas(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_gursan_slay_hsskas");
    }
    public boolean ep3_kymayrr_condition_hasCysscSignalQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_kymayrr_send_cyssc_signal");
    }
    public boolean ep3_kymayrr_condition_canCompleteSignalQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_kymayrr_condition_hasDefeatedCysscSpace(obj_id player, obj_id npc)
    {
        return space_quest.hasWonQuest(player, "assassinate", "ep3_slaver_lord_cyssc_final");
    }
    public boolean ep3_kymayrr_condition_isWookieeHero(obj_id player, obj_id npc)
    {
        return badge.hasBadge(player, "bdg_kash_wookiee_rage");
    }
    public boolean ep3_kymayrr_condition_canDoWookieeJabba(obj_id player, obj_id npc)
    {
        return utils.canSpeakWookiee(player, npc);
    }
    public void ep3_kymayrr_action_grantAdjutantRhoskMission(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "space_battle", "ep3_slaver_rhosk_space_battle");
    }
    public void ep3_kymayrr_action_grantRescueRrootMission(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_kymayrr_rescue_rroot");
    }
    public void ep3_kymayrr_action_rewardRrootRescue(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "signalReturnToKymayrr");
    }
    public void ep3_kymayrr_action_grantSendCysscSignalQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_kymayrr_send_cyssc_signal");
    }
    public void ep3_kymayrr_action_giveWookieeRageMedal(obj_id player, obj_id npc)
    {
    ...
    public void ep3_kymayrr_action_doDunnoEmote(obj_id player, obj_id npc)
    {
        utils.emoteWookieeConfusion(player, npc);
    }
    public int ep3_kymayrr_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kymayrr_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kymayrr_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kymayrr_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kymayrr_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kymayrr_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kymayrr_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kymayrr_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kymayrr_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kymayrr_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kymayrr_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kymayrr_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kymayrr_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kymayrr_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kymayrr_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kymayrr_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kymayrr_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kymayrr_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kymayrr_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
