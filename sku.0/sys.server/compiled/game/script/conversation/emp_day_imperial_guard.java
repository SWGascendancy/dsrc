...
public class emp_day_imperial_guard extends script.base_script
{
    ...
    public boolean emp_day_imperial_guard_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean emp_day_imperial_guard_condition_isRebel(obj_id player, obj_id npc)
    {
    ...
    public boolean emp_day_imperial_guard_condition_allowed(obj_id player, obj_id npc)
    {
    ...
    public boolean emp_day_imperial_guard_condition_winner(obj_id player, obj_id npc)
    {
        if (!hasObjVar(player, "event.emp_day.prisoner"))
        {
            return false;
    ...
    public boolean emp_day_imperial_guard_condition_loser(obj_id player, obj_id npc)
    {
        if (!hasObjVar(player, "event.emp_day.prisoner"))
        {
            return false;
    ...
    public boolean emp_day_imperial_guard_condition_rewarded(obj_id player, obj_id npc)
    {
        if (!hasObjVar(player, "event.emp_day.prisoner"))
        {
            return false;
    ...
    public void emp_day_imperial_guard_action_winReward(obj_id player, obj_id npc)
    {
    ...
    public void emp_day_imperial_guard_action_loseReward(obj_id player, obj_id npc)
    {
        setObjVar(player, "event.emp_day.prisoner", 3);
        factions.addFactionStanding(player, "Imperial", 1000);
    }
    public int emp_day_imperial_guard_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
