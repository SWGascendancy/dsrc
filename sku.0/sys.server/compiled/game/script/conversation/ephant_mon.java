...
public class ephant_mon extends script.base_script
{
    ...
    public boolean ephant_mon_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ephant_mon_condition_finishedReeYees(obj_id player, obj_id npc)
    {
    ...
    public boolean ephant_mon_condition_killingTheSennex(obj_id player, obj_id npc)
    {
    ...
    public boolean ephant_mon_condition_killingTheSlaveMasters(obj_id player, obj_id npc)
    {
    ...
    public boolean ephant_mon_condition_collectingKeyChips(obj_id player, obj_id npc)
    {
    ...
    public boolean ephant_mon_condition_wipingTheDatabank(obj_id player, obj_id npc)
    {
    ...
    public boolean ephant_mon_condition_returnToEphantMon(obj_id player, obj_id npc)
    {
    ...
    public boolean ephant_mon_condition_finishedEphantMon(obj_id player, obj_id npc)
    {
    ...
    public void ephant_mon_action_grantEphantMonQuest(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "quest/jabba_ephant_mon");
    }
    public void ephant_mon_action_endEphantMonQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        groundquests.sendSignal(player, "ephantMonSignal");
        groundquests.grantQuest(player, "pointer_porcellus");
    }
    public void ephant_mon_action_clearPointer(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "found_ephant");
        faceTo(npc, player);
    }
    public void ephant_mon_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int ephant_mon_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ephant_mon_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ephant_mon_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ephant_mon_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ephant_mon_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ephant_mon_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ephant_mon_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
