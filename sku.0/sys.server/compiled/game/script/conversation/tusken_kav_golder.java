...
public class tusken_kav_golder extends script.base_script
{
    ...
    public boolean tusken_kav_golder_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tusken_kav_golder_condition_inside(obj_id player, obj_id npc)
    {
        return getIntObjVar(npc, "phase") == 1;
    }
    public boolean tusken_kav_golder_condition_start_two(obj_id player, obj_id npc)
    {
        return getIntObjVar(npc, "phase") == 2;
    }
    public void tusken_kav_golder_action_exitInstance(obj_id player, obj_id npc)
    {
        instance.requestExitPlayer("heroic_tusken_army", player);
    }
    public int tusken_kav_golder_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tusken_kav_golder_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tusken_kav_golder_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tusken_kav_golder_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
