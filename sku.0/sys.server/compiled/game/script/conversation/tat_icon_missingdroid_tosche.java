...
public class tat_icon_missingdroid_tosche extends script.base_script
{
    ...
    public boolean tat_icon_missingdroid_tosche_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tat_icon_missingdroid_tosche_condition_fixingJawa_e5_lyrissa2Tosche(obj_id player, obj_id npc)
    {
    ...
    public boolean tat_icon_missingdroid_tosche_condition_fixingJawa_e6_tosche2Lyrissa(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tat_icon_fixingjawa_1");
    ...
    public void tat_icon_missingdroid_tosche_action_signal_gotoLyrissa_e5(obj_id player, obj_id npc)
    {
