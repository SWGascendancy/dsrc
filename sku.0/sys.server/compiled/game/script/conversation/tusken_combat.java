...
public class tusken_combat extends script.base_script
{
    ...
    public boolean tusken_combat_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tusken_combat_condition_staffed(obj_id player, obj_id npc)
    {
