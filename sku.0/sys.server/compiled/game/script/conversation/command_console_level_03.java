...
public class command_console_level_03 extends script.base_script
{
    ...
    public boolean command_console_level_03_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean command_console_level_03_condition_tracingCall(obj_id player, obj_id npc)
    {
    ...
    public boolean command_console_level_03_condition_openingHatch(obj_id player, obj_id npc)
    {
    ...
    public boolean command_console_level_03_condition_answeringCall(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "outbreak_quest_facility_03", "goToNextConsole"));
    }
    public boolean command_console_level_03_condition_hasQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean command_console_level_03_condition_playerDeletedQuest(obj_id player, obj_id npc)
    {
    ...
    public void command_console_level_03_action_answerCall(obj_id player, obj_id npc)
    {
    ...
    public void command_console_level_03_action_openHatch(obj_id player, obj_id npc)
    {
    ...
    public void command_console_level_03_action_tracedCall(obj_id player, obj_id npc)
    {
    ...
    public void command_console_level_03_action_getRancorPoint(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "outbreak_undead_rancor_boss_fight");
    }
    public void command_console_level_03_action_fixDeletedQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "outbreak_quest_facility_04");
    }
    public int command_console_level_03_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int command_console_level_03_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int command_console_level_03_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int command_console_level_03_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int command_console_level_03_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int command_console_level_03_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int command_console_level_03_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
