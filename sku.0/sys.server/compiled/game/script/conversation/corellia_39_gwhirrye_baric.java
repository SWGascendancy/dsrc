...
public class corellia_39_gwhirrye_baric extends script.base_script
{
    ...
    public boolean corellia_39_gwhirrye_baric_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_39_gwhirrye_baric_condition_seekCouncilActive(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_39_gwhirrye_baric_condition_seekCouncilLast(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_39_gwhirrye_baric_condition_questComplete(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "corellia_39_chirq_council_01");
    }
    public boolean corellia_39_gwhirrye_baric_condition_seekCouncilFirst(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_39_chirq_council_01", "chirq_council_01_05");
    }
    public void corellia_39_gwhirrye_baric_action_seekCouncilFirstSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "chirq_council_01_05");
    }
    public int corellia_39_gwhirrye_baric_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_39_gwhirrye_baric_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
