...
public class npe_side_smuggle_buyer extends script.base_script
{
    ...
    public boolean npe_side_smuggle_buyer_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_side_smuggle_buyer_condition_hasTaskActive(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_side_smuggle", "npe_side_smuggle_buyer_signal");
    }
    public boolean npe_side_smuggle_buyer_condition_failedSpace(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_side_smuggle_buyer_condition_hasFinishedTask(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "npe_side_smuggle", "npe_side_smuggle_buyer_signal");
    }
    public void npe_side_smuggle_buyer_action_sendSignalComplete(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_side_smuggle_buyer");
    }
    public void npe_side_smuggle_buyer_action_sendSignalFailedStart(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "smuggle_failed");
    }
    public void npe_side_smuggle_buyer_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int npe_side_smuggle_buyer_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_side_smuggle_buyer_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_side_smuggle_buyer_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_side_smuggle_buyer_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
