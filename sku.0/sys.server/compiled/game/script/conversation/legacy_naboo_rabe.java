...
public class legacy_naboo_rabe extends script.base_script
{
    ...
    public boolean legacy_naboo_rabe_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean legacy_naboo_rabe_condition_isOnRabeQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean legacy_naboo_rabe_condition_completedRabeQuest(obj_id player, obj_id npc)
    {
    ...
    public void legacy_naboo_rabe_action_sendStartSignalForVineyard(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "rabeAskedToCleanVineyard");
    }
    public int legacy_naboo_rabe_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_naboo_rabe_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_naboo_rabe_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_naboo_rabe_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_naboo_rabe_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_naboo_rabe_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_naboo_rabe_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
