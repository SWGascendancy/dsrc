...
public class ep3_clone_relics_clone_trooper_leia extends script.base_script
{
    ...
    public boolean ep3_clone_relics_clone_trooper_leia_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_clone_relics_clone_trooper_leia_condition_talkToLeia2(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "ep3_clone_relics_clone_trooper_mort_rebel", "datapadToLeia"));
    }
    public boolean ep3_clone_relics_clone_trooper_leia_condition_talkToLeia1(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "ep3_clone_relics_clone_trooper_mort_rebel", "talkLeia1"));
    }
    public void ep3_clone_relics_clone_trooper_leia_action_spokenToLeia1(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedLeia1");
    }
    public void ep3_clone_relics_clone_trooper_leia_action_spokenToLeia2(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "datapadReturned");
    }
    public int ep3_clone_relics_clone_trooper_leia_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_leia_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_leia_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_leia_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_leia_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_leia_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_leia_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
