...
public class npe_side_jolka extends script.base_script
{
    ...
    public boolean npe_side_jolka_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_side_jolka_condition_hasFinishedTemplate(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "npe.finishedTemplate");
    }
    public boolean npe_side_jolka_condition_finishedQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_side_jolka");
    }
    public boolean npe_side_jolka_condition_stillOnQuest(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_side_jolka", "gathering");
    }
    public boolean npe_side_jolka_condition_hasFinishedTask(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_side_jolka", "return");
    }
    public void npe_side_jolka_action_giveJolkaQuest(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "npe_side_jolka");
    }
    public void npe_side_jolka_action_signalEndQuest(obj_id player, obj_id npc)
    {
    ...
    public int npe_side_jolka_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_side_jolka_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_side_jolka_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_side_jolka_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_side_jolka_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_side_jolka_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
