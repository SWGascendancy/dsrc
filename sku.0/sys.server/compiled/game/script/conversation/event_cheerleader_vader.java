...
public class event_cheerleader_vader extends script.base_script
{
    ...
    public boolean event_cheerleader_vader_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean event_cheerleader_vader_condition_isRebel(obj_id player, obj_id npc)
    {
    ...
    public boolean event_cheerleader_vader_condition_isNeutral(obj_id player, obj_id npc)
    {
        int factionHashCode = factions.pvpGetAlignedFaction(player);
        String whichFaction = factions.getFactionNameByHashCode(factionHashCode);
        if (whichFaction == null)
    ...
    public boolean event_cheerleader_vader_condition_hasMaxQuests(obj_id player, obj_id npc)
    {
    ...
    public boolean event_cheerleader_vader_condition_completedAll(obj_id player, obj_id npc)
    {
        int killReb5 = questGetQuestId("quest/event_gcwcheerleader_sfreb5");
        int killReb10 = questGetQuestId("quest/event_gcwcheerleader_sfreb10");
        int killReb20 = questGetQuestId("quest/event_gcwcheerleader_sfreb20");
    ...
    public boolean event_cheerleader_vader_condition_noMissionsComplete(obj_id player, obj_id npc)
    {
        int killReb5 = questGetQuestId("quest/event_gcwcheerleader_sfreb5");
        int cmImp1 = questGetQuestId("quest/event_gcwcheerleader_cmimp1");
    ...
    public boolean event_cheerleader_vader_condition_pvp1Ready(obj_id player, obj_id npc)
    {
        int killReb20 = questGetQuestId("quest/event_gcwcheerleader_sfreb20");
        int killReb10 = questGetQuestId("quest/event_gcwcheerleader_sfreb10");
        int killReb5 = questGetQuestId("quest/event_gcwcheerleader_sfreb5");
    ...
    public boolean event_cheerleader_vader_condition_pve1Ready(obj_id player, obj_id npc)
    {
        int cmImp3 = questGetQuestId("quest/event_gcwcheerleader_cmimp3");
        int cmImp2 = questGetQuestId("quest/event_gcwcheerleader_cmimp2");
        int cmImp1 = questGetQuestId("quest/event_gcwcheerleader_cmimp1");
    ...
    public boolean event_cheerleader_vader_condition_pve2Ready(obj_id player, obj_id npc)
    {
        int cmImp3 = questGetQuestId("quest/event_gcwcheerleader_cmimp3");
        int cmImp2 = questGetQuestId("quest/event_gcwcheerleader_cmimp2");
        int cmImp1 = questGetQuestId("quest/event_gcwcheerleader_cmimp1");
    ...
    public boolean event_cheerleader_vader_condition_pvp2Ready(obj_id player, obj_id npc)
    {
        int killReb20 = questGetQuestId("quest/event_gcwcheerleader_sfreb20");
        int killReb10 = questGetQuestId("quest/event_gcwcheerleader_sfreb10");
        int killReb5 = questGetQuestId("quest/event_gcwcheerleader_sfreb5");
    ...
    public boolean event_cheerleader_vader_condition_pve3Ready(obj_id player, obj_id npc)
    {
        int cmImp3 = questGetQuestId("quest/event_gcwcheerleader_cmimp3");
        int cmImp2 = questGetQuestId("quest/event_gcwcheerleader_cmimp2");
        int cmImp1 = questGetQuestId("quest/event_gcwcheerleader_cmimp1");
    ...
    public boolean event_cheerleader_vader_condition_pvp3Ready(obj_id player, obj_id npc)
    {
        int killReb20 = questGetQuestId("quest/event_gcwcheerleader_sfreb20");
        int killReb10 = questGetQuestId("quest/event_gcwcheerleader_sfreb10");
        int killReb5 = questGetQuestId("quest/event_gcwcheerleader_sfreb5");
    ...
    public boolean event_cheerleader_vader_condition_pvp4Ready(obj_id player, obj_id npc)
    {
        int killReb50 = questGetQuestId("quest/event_gcwcheerleader_sfreb50");
        int killReb20 = questGetQuestId("quest/event_gcwcheerleader_sfreb20");
        int killReb10 = questGetQuestId("quest/event_gcwcheerleader_sfreb10");
    ...
    public boolean event_cheerleader_vader_condition_pve4Ready(obj_id player, obj_id npc)
    {
        int cmImp4 = questGetQuestId("quest/event_gcwcheerleader_cmimp4");
        int cmImp3 = questGetQuestId("quest/event_gcwcheerleader_cmimp3");
        int cmImp2 = questGetQuestId("quest/event_gcwcheerleader_cmimp2");
    ...
    public boolean event_cheerleader_vader_condition_hasMinOne(obj_id player, obj_id npc)
    {
        int killReb5 = questGetQuestId("quest/event_gcwcheerleader_sfreb5");
        int cmImp1 = questGetQuestId("quest/event_gcwcheerleader_cmimp1");
        return (questIsQuestComplete(killReb5, player) || questIsQuestComplete(cmImp1, player) || questIsQuestActive(killReb5, player) || questIsQuestActive(cmImp1, player));
    }
    public void event_cheerleader_vader_action_pvp1mission(obj_id player, obj_id npc)
    {
    ...
    public void event_cheerleader_vader_action_pve1mission(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/event_gcwcheerleader_cmimp1");
        groundquests.grantQuest(questId, player, npc, true);
    }
    public void event_cheerleader_vader_action_pvp2mission(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/event_gcwcheerleader_sfreb10");
        groundquests.grantQuest(questId, player, npc, true);
        attachScript(player, "event.gcwraids.spec_force_killer");
    }
    public void event_cheerleader_vader_action_pve2mission(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/event_gcwcheerleader_cmimp2");
        groundquests.grantQuest(questId, player, npc, true);
    }
    public void event_cheerleader_vader_action_pvp3mission(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/event_gcwcheerleader_sfreb20");
        groundquests.grantQuest(questId, player, npc, true);
        attachScript(player, "event.gcwraids.spec_force_killer");
    }
    public void event_cheerleader_vader_action_pve3mission(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/event_gcwcheerleader_cmimp3");
        groundquests.grantQuest(questId, player, npc, true);
    }
    public void event_cheerleader_vader_action_pvp4mission(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/event_gcwcheerleader_sfreb50");
        groundquests.grantQuest(questId, player, npc, true);
        attachScript(player, "event.gcwraids.spec_force_killer");
    }
    public void event_cheerleader_vader_action_pve4mission(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/event_gcwcheerleader_cmimp4");
        groundquests.grantQuest(questId, player, npc, true);
        attachScript(player, "event.gcwraids.pve_badge");
    }
    public int event_cheerleader_vader_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_cheerleader_vader_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_cheerleader_vader_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_cheerleader_vader_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_cheerleader_vader_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_cheerleader_vader_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_cheerleader_vader_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_cheerleader_vader_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_cheerleader_vader_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_cheerleader_vader_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_cheerleader_vader_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_cheerleader_vader_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_cheerleader_vader_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
