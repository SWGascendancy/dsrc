...
public class mtp_hideout_safe_tech extends script.base_script
{
    ...
    public boolean mtp_hideout_safe_tech_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean mtp_hideout_safe_tech_condition_isEligible(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_hideout_safe_tech_condition_hasCompleted(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_hideout_safe_tech_condition_isActive(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_hideout_safe_tech_condition_isReturningSuccess(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_hideout_safe_tech_condition_abortedRoriTalus(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_hideout_safe_tech_condition_roriTalusActiveComplete(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "quest/mtp_camp_quest_rori_talus");
    }
    public void mtp_hideout_safe_tech_action_giveQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest/mtp_find_infiltrator_" + rand(1, 5));
    }
    public void mtp_hideout_safe_tech_action_completeTask(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "returnedToMeatlumpLocksmith");
    }
    public void mtp_hideout_safe_tech_action_giveLocations(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest/mtp_camp_quest_rori_talus");
    }
    public int mtp_hideout_safe_tech_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_safe_tech_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_safe_tech_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_safe_tech_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_safe_tech_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_safe_tech_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_safe_tech_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_safe_tech_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_safe_tech_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_safe_tech_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
