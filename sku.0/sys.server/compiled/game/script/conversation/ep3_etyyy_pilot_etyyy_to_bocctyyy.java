...
public class ep3_etyyy_pilot_etyyy_to_bocctyyy extends script.base_script
{
    ...
    public boolean ep3_etyyy_pilot_etyyy_to_bocctyyy_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_etyyy_pilot_etyyy_to_bocctyyy_condition_canGoToBocctyyy(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_etyyy_pilot_etyyy_to_bocctyyy_condition_hasBocctyyyTicket(obj_id player, obj_id npc)
    {
        obj_id[] tickets = space_dungeon.findValidDungeonTickets(player, npc);
        if (tickets != null && tickets.length > 0)
        {
    ...
    public boolean ep3_etyyy_pilot_etyyy_to_bocctyyy_condition_isFemaleCharacter(obj_id player, obj_id npc)
    {
        return getGender(player) == GENDER_FEMALE;
    }
    public boolean ep3_etyyy_pilot_etyyy_to_bocctyyy_condition_tooManyInGroup(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_etyyy_pilot_etyyy_to_bocctyyy_condition_isInGodeMode(obj_id player, obj_id npc)
    {
        return isGod(player);
    }
    public void ep3_etyyy_pilot_etyyy_to_bocctyyy_action_sendToBocctyyy(obj_id player, obj_id npc)
    {
        space_dungeon.selectDungeonTicket(npc, player);
        return;
    }
    public void ep3_etyyy_pilot_etyyy_to_bocctyyy_action_godModeEntry(obj_id player, obj_id npc)
    {
        if (isGod(player))
        {
    ...
    public int ep3_etyyy_pilot_etyyy_to_bocctyyy_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
