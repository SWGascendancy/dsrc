...
public class sd_chief_olum extends script.base_script
{
    ...
    public boolean sd_chief_olum_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean sd_chief_olum_condition_hasTalked(obj_id player, obj_id npc)
    {
        return hasObjVar(npc, "talked");
    }
    public void sd_chief_olum_action_setFaceToPlayer(obj_id player, obj_id npc)
    {
    ...
    public void sd_chief_olum_action_kickoffSdEvent(obj_id player, obj_id npc)
    {
    ...
    public void sd_chief_olum_action_playerPosition(obj_id player, obj_id npc)
    {
        obj_id[] players = trial.getPlayersInDungeon(trial.getTop(npc));
        prose_package pp = new prose_package();
        pp.target.set(player);
    ...
    public void sd_chief_olum_action_olumQuiteRight(obj_id player, obj_id npc)
    {
        obj_id[] players = trial.getPlayersInDungeon(trial.getTop(npc));
        prose_package pp = new prose_package();
        pp.target.set(player);
    ...
    public void sd_chief_olum_action_playerTurnAgainst(obj_id player, obj_id npc)
    {
        obj_id[] players = trial.getPlayersInDungeon(trial.getTop(npc));
        prose_package pp = new prose_package();
        pp.target.set(player);
    ...
    public void sd_chief_olum_action_olumNotProblem(obj_id player, obj_id npc)
    {
        obj_id[] players = trial.getPlayersInDungeon(trial.getTop(npc));
        prose_package pp = new prose_package();
        pp.target.set(player);
    ...
    public void sd_chief_olum_action_playerLeadWay(obj_id player, obj_id npc)
    {
        obj_id[] players = trial.getPlayersInDungeon(trial.getTop(npc));
        prose_package pp = new prose_package();
        pp.target.set(player);
    ...
    public int sd_chief_olum_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int sd_chief_olum_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int sd_chief_olum_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
