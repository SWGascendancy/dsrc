...
public class corellia_38_menchi_lerann extends script.base_script
{
    ...
    public boolean corellia_38_menchi_lerann_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_38_menchi_lerann_condition_taskOneActive(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_38_corsec_files_04", "corsec_files_04_01");
    }
    public boolean corellia_38_menchi_lerann_condition_taskOneComplete(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "quest_name", "wait_for_signal_1_task_name");
    }
    public boolean corellia_38_menchi_lerann_condition_questComplete(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "corellia_38_corsec_files_04", "corsec_files_04_01");
    }
    public void corellia_38_menchi_lerann_action_taskOneCompletedSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "corsec_files_04_01");
    }
    public int corellia_38_menchi_lerann_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
