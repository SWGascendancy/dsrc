...
public class tat_icon_missingdroid_droid extends script.base_script
{
    ...
    public boolean tat_icon_missingdroid_droid_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tat_icon_missingdroid_droid_condition_fixingJawa_e2_jawa2Droid(obj_id player, obj_id npc)
    {
    ...
    public boolean tat_icon_missingdroid_droid_condition_fixingJawa_e7_lyrissa2Droid(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tat_icon_fixingjawa_1");
    ...
    public void tat_icon_missingdroid_droid_action_signal_gotoDren_e2(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tat_icon_fixingjawa_jawa_to_droid_e2");
    }
    public void tat_icon_missingdroid_droid_action_signal_gotoDren_e7(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tat_icon_fixingjawa_lyrissa_to_droid_e7");
    }
    public int tat_icon_missingdroid_droid_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tat_icon_missingdroid_droid_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tat_icon_missingdroid_droid_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tat_icon_missingdroid_droid_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tat_icon_missingdroid_droid_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tat_icon_missingdroid_droid_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tat_icon_missingdroid_droid_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
