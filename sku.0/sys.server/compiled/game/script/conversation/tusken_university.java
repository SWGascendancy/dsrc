...
public class tusken_university extends script.base_script
{
    ...
    public boolean tusken_university_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tusken_university_condition_staffed(obj_id player, obj_id npc)
    {
