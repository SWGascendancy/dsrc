...
public class naboo_theed_lt_khartoor extends script.base_script
{
    ...
    public boolean naboo_theed_lt_khartoor_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean naboo_theed_lt_khartoor_condition_startMeanwhileQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_theed_lt_khartoor_condition_onAssociatesQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "naboo_theed_meanwhile_associates");
    }
    public boolean naboo_theed_lt_khartoor_condition_finishedAssociatesQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_theed_lt_khartoor_condition_onChaseQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "naboo_theed_meanwhile_chase");
    }
    public boolean naboo_theed_lt_khartoor_condition_finishedChaseQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_theed_lt_khartoor_condition_onRanchQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "naboo_theed_meanwhile_ranch");
    }
    public boolean naboo_theed_lt_khartoor_condition_lastStepRanchQuest(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "naboo_theed_meanwhile_ranch", "theed_meanwhile_ranch_05");
    }
    public boolean naboo_theed_lt_khartoor_condition_completedMeanwhileQuest(obj_id player, obj_id npc)
    {
    ...
    public void naboo_theed_lt_khartoor_action_grantAssociatesQuest(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "naboo_theed_meanwhile_associates");
    }
    public void naboo_theed_lt_khartoor_action_grantChaseQuest(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "naboo_theed_meanwhile_chase");
    }
    public void naboo_theed_lt_khartoor_action_grantRanchQuest(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "naboo_theed_meanwhile_ranch");
    }
    public void naboo_theed_lt_khartoor_action_signal_ranch_05(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "theed_meanwhile_ranch_05");
    }
    public void naboo_theed_lt_khartoor_action_endGotoKhartoor(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "theed_goto_khartoor");
    }
    public void naboo_theed_lt_khartoor_action_endAssociatesQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "theed_meanwhile_associates_07");
    }
    public void naboo_theed_lt_khartoor_action_endChaseQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "theed_meanwhile_chase_09");
    }
    public int naboo_theed_lt_khartoor_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_lt_khartoor_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_lt_khartoor_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_lt_khartoor_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
