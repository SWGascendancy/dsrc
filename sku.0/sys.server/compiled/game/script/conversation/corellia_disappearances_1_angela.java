...
public class corellia_disappearances_1_angela extends script.base_script
{
    ...
    public boolean corellia_disappearances_1_angela_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_disappearances_1_angela_condition_playerCompletedArc(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "corellia_disappearances_6_boss");
    }
    public boolean corellia_disappearances_1_angela_condition_playerOnAngelaStep(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_disappearances_1_discovery", "disappear_1_angela");
    }
    public void corellia_disappearances_1_angela_action_signalFirstQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "corellia_disappearances_1_angela");
    }
    public int corellia_disappearances_1_angela_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_disappearances_1_angela_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_disappearances_1_angela_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_disappearances_1_angela_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
