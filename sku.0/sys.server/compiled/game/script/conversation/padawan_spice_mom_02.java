...
public class padawan_spice_mom_02 extends script.base_script
{
    ...
    public boolean padawan_spice_mom_02_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean padawan_spice_mom_02_condition_isTrialPlayer(obj_id player, obj_id npc)
    {
    ...
    public void padawan_spice_mom_02_action_spokeToNpc(obj_id player, obj_id npc)
    {
