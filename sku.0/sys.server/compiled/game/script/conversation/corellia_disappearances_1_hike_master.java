...
public class corellia_disappearances_1_hike_master extends script.base_script
{
    ...
    public boolean corellia_disappearances_1_hike_master_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_disappearances_1_hike_master_condition_playerFinishedWithRanger(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "corellia_disappearances_1_discovery", "disappear_1_hike_master");
    }
    public boolean corellia_disappearances_1_hike_master_condition_playerOnAngelaStep(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_disappearances_1_discovery", "disappear_1_hike_master");
    }
    public boolean corellia_disappearances_1_hike_master_condition_finishedAll(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "corellia_disappearances_6_boss");
    }
    public void corellia_disappearances_1_hike_master_action_signalFirstQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "corellia_disappearances_1_hike_master");
    }
    public int corellia_disappearances_1_hike_master_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_disappearances_1_hike_master_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_disappearances_1_hike_master_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
