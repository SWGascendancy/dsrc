...
public class talus_dearic_coa_mark_hieks extends script.base_script
{
    ...
    public boolean talus_dearic_coa_mark_hieks_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean talus_dearic_coa_mark_hieks_condition_imperial_faction(obj_id player, obj_id npc)
    {
    ...
    public boolean talus_dearic_coa_mark_hieks_condition_accepted_nsh_quest(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "talus_dearic_coa_deep_cover", "talus_dearic_coa_mark_hieks_wfs");
    }
    public boolean talus_dearic_coa_mark_hieks_condition_accepted_deep_cover_quest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "talus_dearic_coa_deep_cover", "talus_dearic_coa_mark_hieks_wfs");
    }
    public boolean talus_dearic_coa_mark_hieks_condition_completed_deep_cover_quest(obj_id player, obj_id npc)
    {
    ...
    public boolean talus_dearic_coa_mark_hieks_condition_imp_opt_quest_active(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "talus_dearic_coa_opt_imperial_quest", "talus_dearic_coa_inspector_elimination_dsm");
    }
    public boolean talus_dearic_coa_mark_hieks_condition_deep_cover_tasks_complete(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "talus_dearic_coa_deep_cover", "talus_dearic_coa_report_back_wfs");
    }
    public boolean talus_dearic_coa_mark_hieks_condition_imp_opt_quest_complete(obj_id player, obj_id npc)
    {
    ...
    public boolean talus_dearic_coa_mark_hieks_condition_imp_opt_quest_unaccepted(obj_id player, obj_id npc)
    {
    ...
    public void talus_dearic_coa_mark_hieks_action_accept_deep_cover_quest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talus_dearic_coa_accepted_deep_cover_assignment");
    }
    public void talus_dearic_coa_mark_hieks_action_complete_deep_cover_quest(obj_id player, obj_id npc)
    {
    ...
    public void talus_dearic_coa_mark_hieks_action_complete_opt_imp_quest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talus_dearic_coa_report_rebels_eliminated");
    }
    public void talus_dearic_coa_mark_hieks_action_accept_opt_imp_quest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "talus_dearic_coa_opt_imperial_quest");
    }
    public void talus_dearic_coa_mark_hieks_action_grant_return_quest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talus_dearic_coa_spoke_with_mark");
        groundquests.grantQuest(player, "talus_dearic_coa_imperial_view_end");
    }
    public void talus_dearic_coa_mark_hieks_action_grant_return_qst2(obj_id player, obj_id npc)
    {
    ...
    public int talus_dearic_coa_mark_hieks_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_coa_mark_hieks_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_coa_mark_hieks_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_coa_mark_hieks_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_coa_mark_hieks_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_coa_mark_hieks_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_coa_mark_hieks_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_coa_mark_hieks_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_coa_mark_hieks_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_coa_mark_hieks_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_36"))
        {
            doAnimationAction(player, "bow5");
    ...
    public int talus_dearic_coa_mark_hieks_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_coa_mark_hieks_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_coa_mark_hieks_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_dearic_coa_mark_hieks_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
