...
public class mtp_hideout_food_supply_tech extends script.base_script
{
    ...
    public boolean mtp_hideout_food_supply_tech_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean mtp_hideout_food_supply_tech_condition_hasDefeatedRagtag(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "quest/mtp_hideout_ragtag", "goToClerk");
    }
    public boolean mtp_hideout_food_supply_tech_condition_questNotActiveCompleted(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_hideout_food_supply_tech_condition_hasCompletedRagtagNoCoords(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_hideout_food_supply_tech_condition_hasCompletedRagTagHasCoords(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "quest/mtp_camp_quest_tatooine") && groundquests.hasCompletedQuest(player, "quest/mtp_hideout_ragtag");
    }
    public boolean mtp_hideout_food_supply_tech_condition_hasFailQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "quest/mtp_hideout_ragtag_fail");
    }
    public void mtp_hideout_food_supply_tech_action_giveTatooineCoords(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest/mtp_camp_quest_tatooine");
    }
    public void mtp_hideout_food_supply_tech_action_giveRagtagQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest/mtp_hideout_ragtag");
    }
    public void mtp_hideout_food_supply_tech_action_sendClerkSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "spokeToClerk");
    }
    public void mtp_hideout_food_supply_tech_action_removeFailRegrantQuest(obj_id player, obj_id npc)
    {
        groundquests.clearQuest(player, "quest/mtp_hideout_ragtag_fail");
        groundquests.grantQuest(player, "quest/mtp_hideout_ragtag");
    }
    public int mtp_hideout_food_supply_tech_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_food_supply_tech_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_food_supply_tech_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_food_supply_tech_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_food_supply_tech_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_food_supply_tech_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_food_supply_tech_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_food_supply_tech_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_food_supply_tech_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_food_supply_tech_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_food_supply_tech_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
