...
public class ep3_trandoshan_fezrik_bendledon extends script.base_script
{
    ...
    public boolean ep3_trandoshan_fezrik_bendledon_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_trandoshan_fezrik_bendledon_condition_hasFailedMission(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_trandoshan_fezrik_bendledon_condition_hasWonMission(obj_id player, obj_id npc)
    {
        return (space_quest.hasWonQuestRecursive(player, "delivery_no_pickup", "ep3_trando_fezrik_01"));
    }
    public boolean ep3_trandoshan_fezrik_bendledon_condition_hasRecievedReward(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_trandoshan_fezrik_bendledon_condition_isOnMission(obj_id player, obj_id npc)
    {
        return (space_quest.hasQuest(player));
    }
    public boolean ep3_trandoshan_fezrik_bendledon_condition_canTakeSpaceMission(obj_id player, obj_id npc)
    {
    ...
    public void ep3_trandoshan_fezrik_bendledon_action_grantMission(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "delivery_no_pickup", "ep3_trando_fezrik_01");
    }
    public void ep3_trandoshan_fezrik_bendledon_action_grantReward(obj_id player, obj_id npc)
    {
        space_quest.giveReward(player, "delivery_no_pickup", "ep3_trando_fezrik_01", 10000);
    }
    public int ep3_trandoshan_fezrik_bendledon_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_fezrik_bendledon_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_fezrik_bendledon_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_fezrik_bendledon_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_fezrik_bendledon_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_fezrik_bendledon_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
