...
public class prof_medic_21_larence extends script.base_script
{
    ...
    public boolean prof_medic_21_larence_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean prof_medic_21_larence_condition_playerOnFirstStep(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "prof_medic_21", "talktolarence");
    }
    public boolean prof_medic_21_larence_condition_playercompletedTask(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "prof_medic_21", "talktolarence");
    }
    public boolean prof_medic_21_larence_condition_playerOnLastStep(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "prof_medic_21", "getreward");
    }
    public boolean prof_medic_21_larence_condition_playerGotReward(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "prof_medic_21", "getreward");
    }
    public void prof_medic_21_larence_action_giveFirstSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "prof_medic_21_larence");
    }
    public void prof_medic_21_larence_action_giveRewardSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "prof_medic_21_reward");
    }
    public void prof_medic_21_larence_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int prof_medic_21_larence_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int prof_medic_21_larence_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int prof_medic_21_larence_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int prof_medic_21_larence_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
