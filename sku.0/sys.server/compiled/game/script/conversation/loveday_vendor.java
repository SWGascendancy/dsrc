...
public class loveday_vendor extends script.base_script
{
    ...
    public boolean loveday_vendor_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public void loveday_vendor_action_showTokenVendorUI(obj_id player, obj_id npc)
    {
