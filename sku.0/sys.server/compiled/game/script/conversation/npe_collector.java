...
public class npe_collector extends script.base_script
{
    ...
    public boolean npe_collector_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_collector_condition_DustDurniStarted(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_collector_condition_DustDurniComplete(obj_id player, obj_id npc)
    {
        if (hasCompletedCollection(player, "col_dust_durni_01"))
        {
            return true;
    ...
    public boolean npe_collector_condition_showStartDialog(obj_id player, obj_id npc)
    {
    ...
    public int npe_collector_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_collector_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_collector_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_collector_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_collector_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_collector_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_collector_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_collector_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
