...
public class npe_bounty_strong_arm extends script.base_script
{
    ...
    public boolean npe_bounty_strong_arm_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_bounty_strong_arm_condition_isOnQuest(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_boba", "ratheb");
    }
    public boolean npe_bounty_strong_arm_condition_hasRattedOut(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "npe_boba", "ratheb");
    }
    public void npe_bounty_strong_arm_action_giveSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "strong_arm");
    }
    public void npe_bounty_strong_arm_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int npe_bounty_strong_arm_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_bounty_strong_arm_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_bounty_strong_arm_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_bounty_strong_arm_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_bounty_strong_arm_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
