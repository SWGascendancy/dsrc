...
public class ep3_trandoshan_unluto_bartender extends script.base_script
{
    ...
    public boolean ep3_trandoshan_unluto_bartender_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_trandoshan_unluto_bartender_condition_hasTaskActive(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_trando_borantok_02", "waitForSignal02");
    }
    public void ep3_trandoshan_unluto_bartender_action_doSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "threatenBartender");
    }
    public int ep3_trandoshan_unluto_bartender_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_unluto_bartender_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_unluto_bartender_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_unluto_bartender_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_unluto_bartender_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_unluto_bartender_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_unluto_bartender_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_unluto_bartender_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_unluto_bartender_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_unluto_bartender_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_unluto_bartender_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
