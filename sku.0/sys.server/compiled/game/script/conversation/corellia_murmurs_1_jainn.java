...
public class corellia_murmurs_1_jainn extends script.base_script
{
    ...
    public boolean corellia_murmurs_1_jainn_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_murmurs_1_jainn_condition_playerCompletedArc(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "coronet_murmurs_1_smuggler", "talktojainn");
    }
    public boolean corellia_murmurs_1_jainn_condition_playerOnAngelaStep(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "coronet_murmurs_1_smuggler", "talktojainn");
    }
    public void corellia_murmurs_1_jainn_action_signalFirstQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "coronet_murmur_2_jainn");
    }
    public int corellia_murmurs_1_jainn_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_murmurs_1_jainn_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_murmurs_1_jainn_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
