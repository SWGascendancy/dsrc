...
public class sean_trenwell extends script.base_script
{
    ...
    public boolean sean_trenwell_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean sean_trenwell_condition_RivalObj(obj_id player, obj_id npc)
    {
    ...
    public boolean sean_trenwell_condition_NoRoom(obj_id player, obj_id npc)
    {
        if (hasObjVar(npc, "bestine.electionStarted"))
        {
            int electionNum = getIntObjVar(npc, "bestine.electionStarted");
    ...
    public boolean sean_trenwell_condition_inOffice_newElection(obj_id player, obj_id npc)
    {
        if (hasObjVar(npc, "bestine.electionStarted"))
        {
    ...
    public boolean sean_trenwell_condition_checkForVoteReward(obj_id player, obj_id npc)
    {
        int electionNum = 1;
    ...
    public boolean sean_trenwell_condition_Campaign(obj_id player, obj_id npc)
    {
        if (sean_trenwell_condition_votedSeanCurrentElection(player, npc))
        {
            return false;
    ...
    public boolean sean_trenwell_condition_NegquestsObj(obj_id player, obj_id npc)
    {
        if (sean_trenwell_condition_votedSeanCurrentElection(player, npc))
        {
            return false;
    ...
    public boolean sean_trenwell_condition_Evidence1(obj_id player, obj_id npc)
    {
    ...
    public boolean sean_trenwell_condition_Itemfound(obj_id player, obj_id npc)
    {
    ...
    public boolean sean_trenwell_condition_Diskdestroyed(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "bestine.destroyed");
    }
    public boolean sean_trenwell_condition_Hutt(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "bestine.hutt");
    }
    public boolean sean_trenwell_condition_Mess1(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "bestine.mess");
    }
    public boolean sean_trenwell_condition_find1(obj_id player, obj_id npc)
    {
    ...
    public boolean sean_trenwell_condition_hquestObj(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "bestine.hquest");
    }
    public boolean sean_trenwell_condition_notInOffice_noElection(obj_id player, obj_id npc)
    {
        if (hasObjVar(npc, "bestine.electionEnded"))
        {
            if (hasObjVar(npc, "bestine.electionWinner"))
    ...
    public boolean sean_trenwell_condition_inOffice(obj_id player, obj_id npc)
    {
        if (hasObjVar(npc, "bestine.electionWinner"))
        {
            String winner = getStringObjVar(npc, "bestine.electionWinner");
    ...
    public boolean sean_trenwell_condition_noInventorySpace(obj_id player, obj_id npc)
    {
    ...
    public boolean sean_trenwell_condition_CheckRewardGiven(obj_id player, obj_id npc)
    {
        int electionNum = 1;
        if (hasObjVar(npc, "bestine.electionEnded"))
        {
    ...
    public boolean sean_trenwell_condition_hasEvidence(obj_id player, obj_id npc)
    {
    ...
    public boolean sean_trenwell_condition_hasNoRoomHistoryReward(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "bestine.sean_historyreward_noroom");
    }
    public boolean sean_trenwell_condition_votedSeanCurrentElection(obj_id player, obj_id npc)
    {
        if (hasObjVar(npc, "bestine.electionStarted"))
        {
            int electionNum = getIntObjVar(npc, "bestine.electionStarted");
    ...
    public boolean sean_trenwell_condition_tellAboutHistoryQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean sean_trenwell_condition_votedVictorCurrentElection(obj_id player, obj_id npc)
    {
        if (hasObjVar(npc, "bestine.electionStarted"))
        {
            int electionNum = getIntObjVar(npc, "bestine.electionStarted");
    ...
    public void sean_trenwell_action__defaultAction(obj_id player, obj_id npc)
    {
    }
    public void sean_trenwell_action_giveDiskandJoinCampaign(obj_id player, obj_id npc)
    {
        int electionNum = getIntObjVar(npc, "bestine.electionStarted");
    ...
    public void sean_trenwell_action_NQuests(obj_id player, obj_id npc)
    {
        int electionNum = getIntObjVar(npc, "bestine.electionStarted");
    ...
    public void sean_trenwell_action_NoRoomObj(obj_id player, obj_id npc)
    {
        int electionNum = getIntObjVar(npc, "bestine.electionStarted");
        setObjVar(player, "bestine.sean_noroom", electionNum);
    }
    public void sean_trenwell_action_noRoomForHistoryReward(obj_id player, obj_id npc)
    {
        setObjVar(player, "bestine.sean_historyreward_noroom", 1);
        removeObjVar(player, "bestine.destroyed");
    }
    public void sean_trenwell_action_GiveMainReward(obj_id player, obj_id npc)
    {
        int electionNum = 1;
        if (hasObjVar(npc, "bestine.electionStarted"))
        {
    ...
    public void sean_trenwell_action_Hquest(obj_id player, obj_id npc)
    {
    ...
    public void sean_trenwell_action_mess(obj_id player, obj_id npc)
    {
    ...
    public void sean_trenwell_action_GiveHistoryReward(obj_id player, obj_id npc)
    {
    ...
    public void sean_trenwell_action_removeNoroomObjVar(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "bestine.sean_noroom"))
        {
            removeObjVar(player, "bestine.sean_noroom");
    ...
    public void sean_trenwell_action_resetMessWaypoint(obj_id player, obj_id npc)
    {
    ...
    public void sean_trenwell_action_removeHquest(obj_id player, obj_id npc)
    {
