...
public class rtp_c3po_guard_captain extends script.base_script
{
    ...
    public boolean rtp_c3po_guard_captain_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean rtp_c3po_guard_captain_condition_c3poTaskActive(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "rtp_c3po_01", "rtp_c3po_01_02a");
    }
    public void rtp_c3po_guard_captain_action_sendc3poSignal(obj_id player, obj_id npc)
    {
