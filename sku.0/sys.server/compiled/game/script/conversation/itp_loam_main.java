...
public class itp_loam_main extends script.base_script
{
    ...
    public boolean itp_loam_main_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean itp_loam_main_condition_itp_loam_01_active(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "itp_loam_01");
    }
    public boolean itp_loam_main_condition_itp_loam_01_complete(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "itp_loam_01", "itp_loam_01_04") || groundquests.hasCompletedQuest(player, "itp_loam_01");
    }
    public boolean itp_loam_main_condition_itp_loam_02_active(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "itp_loam_02");
    }
    public boolean itp_loam_main_condition_itp_loam_02_complete(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "itp_loam_02", "itp_loam_02_04") || groundquests.hasCompletedQuest(player, "itp_loam_02");
    }
    public boolean itp_loam_main_condition_completedKaja(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "itp_kaja_02");
    }
    public boolean itp_loam_main_condition_notImperial(obj_id player, obj_id npc)
    {
    ...
    public boolean itp_loam_main_condition_imperial_isOnLeave(obj_id player, obj_id npc)
    {
        return factions.isOnLeave(player);
    }
    public void itp_loam_main_action_itp_loam_01_granted(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "itp_loam_01");
    }
    public void itp_loam_main_action_itp_loam_01_signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "itp_loam_01_04");
    }
    public void itp_loam_main_action_itp_loam_02_signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "itp_loam_02_04");
    }
    public void itp_loam_main_action_itp_loam_02_granted(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "itp_loam_02");
    }
    public int itp_loam_main_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int itp_loam_main_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
