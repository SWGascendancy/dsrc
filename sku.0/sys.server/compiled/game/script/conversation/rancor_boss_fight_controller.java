...
public class rancor_boss_fight_controller extends script.base_script
{
    ...
    public boolean rancor_boss_fight_controller_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean rancor_boss_fight_controller_condition_hasQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "outbreak_undead_rancor_boss_fight");
    }
    public boolean rancor_boss_fight_controller_condition_hasGroup(obj_id player, obj_id npc)
    {
    ...
    public boolean rancor_boss_fight_controller_condition_hasCompleted(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "outbreak_undead_rancor_boss_fight");
    }
    public boolean rancor_boss_fight_controller_condition_hasQuestAndGroup(obj_id player, obj_id npc)
    {
    ...
    public boolean rancor_boss_fight_controller_condition_wave_event_active(obj_id player, obj_id npc)
    {
        int wave = utils.getIntScriptVar(npc, "waveEventCurrentWave");
        return wave > 0;
    }
    public void rancor_boss_fight_controller_action_giveWaypoint(obj_id player, obj_id npc)
    {
    ...
    public void rancor_boss_fight_controller_action_bringRancorOut(obj_id player, obj_id npc)
    {
        obj_id groupid = getGroupObject(player);
        if (!isValidId(groupid))
        {
    ...
    public void rancor_boss_fight_controller_action_getQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "outbreak_undead_rancor_boss_fight");
    }
    public void rancor_boss_fight_controller_action_removeQuest(obj_id player, obj_id npc)
    {
        groundquests.clearQuest(player, "outbreak_undead_rancor_boss_fight");
    }
    public int rancor_boss_fight_controller_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rancor_boss_fight_controller_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rancor_boss_fight_controller_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rancor_boss_fight_controller_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rancor_boss_fight_controller_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rancor_boss_fight_controller_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rancor_boss_fight_controller_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
