...
public class kusak extends script.base_script
{
    ...
    public boolean kusak_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean kusak_condition_hasWeed(obj_id player, obj_id npc)
    {
    ...
    public boolean kusak_condition_hasWeedType1(obj_id player, obj_id npc)
    {
    ...
    public boolean kusak_condition_hasWeedType10(obj_id player, obj_id npc)
    {
    ...
    public boolean kusak_condition_hasWeedType9(obj_id player, obj_id npc)
    {
    ...
    public boolean kusak_condition_hasWeedType8(obj_id player, obj_id npc)
    {
    ...
    public boolean kusak_condition_hasWeedType7(obj_id player, obj_id npc)
    {
    ...
    public boolean kusak_condition_hasWeedType6(obj_id player, obj_id npc)
    {
    ...
    public boolean kusak_condition_hasWeedType4(obj_id player, obj_id npc)
    {
    ...
    public boolean kusak_condition_hasWeedType3(obj_id player, obj_id npc)
    {
    ...
    public boolean kusak_condition_hasWeedType2(obj_id player, obj_id npc)
    {
    ...
    public boolean kusak_condition_hasWeedType5(obj_id player, obj_id npc)
    {
    ...
    public void kusak_action_validateWeedOne(obj_id player, obj_id npc)
    {
    ...
    public void kusak_action_validateWeedTen(obj_id player, obj_id npc)
    {
    ...
    public void kusak_action_validateWeedNine(obj_id player, obj_id npc)
    {
    ...
    public void kusak_action_validateWeedEight(obj_id player, obj_id npc)
    {
    ...
    public void kusak_action_validateWeedSeven(obj_id player, obj_id npc)
    {
    ...
    public void kusak_action_validateWeedSix(obj_id player, obj_id npc)
    {
    ...
    public void kusak_action_validateWeedFive(obj_id player, obj_id npc)
    {
    ...
    public void kusak_action_validateWeedFour(obj_id player, obj_id npc)
    {
    ...
    public void kusak_action_validateWeedThree(obj_id player, obj_id npc)
    {
    ...
    public void kusak_action_validateWeedTwo(obj_id player, obj_id npc)
    {
    ...
    public void kusak_action_awardPlayer(obj_id player, obj_id npc)
    {
        if (!hasObjVar(npc, "kusak"))
        {
            return;
    ...
    public int kusak_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int kusak_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int setupWeedVar(obj_id self, dictionary params)
    {
