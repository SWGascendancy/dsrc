...
public class loveday_romance_seeker extends script.base_script
{
    ...
    public boolean loveday_romance_seeker_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean loveday_romance_seeker_condition_matchIncomplete(obj_id player, obj_id npc)
    {
    ...
    public boolean loveday_romance_seeker_condition_matchComplete(obj_id player, obj_id npc)
    {
        if (getMaster(npc) != player)
        {
            return false;
    ...
    public boolean loveday_romance_seeker_condition_doesntHaveQuest(obj_id player, obj_id npc)
    {
        if (getMaster(npc) != player)
        {
            return false;
    ...
    public boolean loveday_romance_seeker_condition_wasRejected(obj_id player, obj_id npc)
    {
        return buff.hasBuff(player, "loveday_rejected");
    }
    public void loveday_romance_seeker_action_grantLovedayQuest(obj_id player, obj_id npc)
    {
    ...
    public void loveday_romance_seeker_action_sendCompletionSignal(obj_id player, obj_id npc)
    {
        obj_id romanceSeekerCompanionControlDevice = holiday.getLovedayRomanceSeekerCompanionControlDevice(player);
        if (isIdValid(romanceSeekerCompanionControlDevice))
        {
    ...
    public String loveday_romance_seeker_tokenTO_trait_01(obj_id player, obj_id npc)
    {
    ...
    public String loveday_romance_seeker_tokenTO_trait_05(obj_id player, obj_id npc)
    {
        String file = "event/love_day";
        obj_id controlDevice = callable.getCallableCD(npc);
    ...
    public String loveday_romance_seeker_tokenTO_trait_04(obj_id player, obj_id npc)
    {
        String file = "event/love_day";
        obj_id controlDevice = callable.getCallableCD(npc);
    ...
    public String loveday_romance_seeker_tokenTO_trait_03(obj_id player, obj_id npc)
    {
        String file = "event/love_day";
        obj_id controlDevice = callable.getCallableCD(npc);
    ...
    public String loveday_romance_seeker_tokenTO_trait_02(obj_id player, obj_id npc)
    {
        String file = "event/love_day";
        obj_id controlDevice = callable.getCallableCD(npc);
    ...
    public int loveday_romance_seeker_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int loveday_romance_seeker_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int loveday_romance_seeker_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int loveday_romance_seeker_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int loveday_romance_seeker_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int loveday_romance_seeker_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
