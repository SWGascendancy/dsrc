...
public class theme_park_record_keeper_rebel extends script.base_script
{
    ...
    public boolean theme_park_record_keeper_rebel_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean theme_park_record_keeper_rebel_condition_theme_park_complete(obj_id player, obj_id npc)
    {
    ...
    public boolean theme_park_record_keeper_rebel_condition_theme_park_in_progress(obj_id player, obj_id npc)
    {
        if (!hasObjVar(player, "theme_park_reset.rebel"))
        {
            if (hasObjVar(player, "theme_park_rebel"))
    ...
    public boolean theme_park_record_keeper_rebel_condition_already_reset(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "theme_park_reset.rebel"))
        {
            return true;
    ...
    public boolean theme_park_record_keeper_rebel_condition_not_rebel(obj_id player, obj_id npc)
    {
    ...
    public void theme_park_record_keeper_rebel_action__defaultAction(obj_id player, obj_id npc)
    {
    }
    public void theme_park_record_keeper_rebel_action_reset_gating(obj_id player, obj_id npc)
    {
    ...
    public void theme_park_record_keeper_rebel_action_set_redo(obj_id player, obj_id npc)
    {
        setObjVar(player, "theme_park_reset.rebel", true);
    ...
    public void theme_park_record_keeper_rebel_action_face_to(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
