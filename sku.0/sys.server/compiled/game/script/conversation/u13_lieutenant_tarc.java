...
public class u13_lieutenant_tarc extends script.base_script
{
    ...
    public boolean u13_lieutenant_tarc_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean u13_lieutenant_tarc_condition_active_ponda_pointer(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "u13_ponda_pointer");
    }
    public boolean u13_lieutenant_tarc_condition_active_ponda_01(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "u13_ponda_01");
    }
    public boolean u13_lieutenant_tarc_condition_returning_ponda_01(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "u13_ponda_01", "u13_ponda_01_03") || groundquests.hasCompletedQuest(player, "u13_ponda_01");
    }
    public boolean u13_lieutenant_tarc_condition_active_ponda_02(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "u13_ponda_02");
    }
    public boolean u13_lieutenant_tarc_condition_returning_ponda_02(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "u13_ponda_02", "u13_ponda_02_06") || groundquests.hasCompletedQuest(player, "u13_ponda_02");
    }
    public boolean u13_lieutenant_tarc_condition_active_ponda_03(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "u13_ponda_03");
    }
    public boolean u13_lieutenant_tarc_condition_returning_ponda_03(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "u13_ponda_03", "u13_ponda_03_04") || groundquests.hasCompletedQuest(player, "u13_ponda_03");
    }
    public boolean u13_lieutenant_tarc_condition_alreadyDoneMeatlumpQuests(obj_id player, obj_id npc)
    {
    ...
    public boolean u13_lieutenant_tarc_condition_needsMeatlumpPointer(obj_id player, obj_id npc)
    {
    ...
    public void u13_lieutenant_tarc_action_signal_ponda_pointer(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "u13_ponda_pointer");
    }
    public void u13_lieutenant_tarc_action_grant_ponda_01(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "u13_ponda_01");
    }
    public void u13_lieutenant_tarc_action_signal_ponda_01_03(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "u13_ponda_01_03");
    }
    public void u13_lieutenant_tarc_action_grant_ponda_02(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "u13_ponda_02");
    }
    public void u13_lieutenant_tarc_action_signal_ponda_02_06(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "u13_ponda_02_06");
    }
    public void u13_lieutenant_tarc_action_grant_ponda_03(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "u13_ponda_03");
    }
    public void u13_lieutenant_tarc_action_signal_ponda_03_04(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "u13_ponda_03_04");
    }
    public void u13_lieutenant_tarc_action_meatlumps_pointer(obj_id player, obj_id npc)
    {
    ...
    public int u13_lieutenant_tarc_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int u13_lieutenant_tarc_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int u13_lieutenant_tarc_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int u13_lieutenant_tarc_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int u13_lieutenant_tarc_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int u13_lieutenant_tarc_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
