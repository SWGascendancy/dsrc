...
public class ep3_clone_relics_boba_fett_talus_bartender_1 extends script.base_script
{
    ...
    public boolean ep3_clone_relics_boba_fett_talus_bartender_1_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_clone_relics_boba_fett_talus_bartender_1_condition_onQuestFour(obj_id player, obj_id npc)
    {
        return (groundquests.isQuestActive(player, "ep3_clone_relics_boba_fett_4"));
    }
    public void ep3_clone_relics_boba_fett_talus_bartender_1_action_sendSignalBartender(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedToBartender");
    }
    public int ep3_clone_relics_boba_fett_talus_bartender_1_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_boba_fett_talus_bartender_1_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_boba_fett_talus_bartender_1_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
