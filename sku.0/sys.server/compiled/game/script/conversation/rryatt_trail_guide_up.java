...
public class rryatt_trail_guide_up extends script.base_script
{
    ...
    public boolean rryatt_trail_guide_up_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public void rryatt_trail_guide_up_action_zoneToNextLevel(obj_id player, obj_id npc)
    {
    ...
    public void rryatt_trail_guide_up_action_returnToZoneIn(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
    ...
    public int rryatt_trail_guide_up_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int removeRryattTrailGuideAiScripts(obj_id self, dictionary params)
    {
        String[] aiScripts = 
        {
            "ai.ai",
