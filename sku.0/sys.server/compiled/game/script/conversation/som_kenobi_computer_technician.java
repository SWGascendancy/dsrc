...
public class som_kenobi_computer_technician extends script.base_script
{
    ...
    public boolean som_kenobi_computer_technician_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean som_kenobi_computer_technician_condition_playerJedi(obj_id player, obj_id npc)
    {
        return jedi.isForceSensitive(player);
    }
    public boolean som_kenobi_computer_technician_condition_have350(obj_id player, obj_id npc)
    {
        return !money.hasFunds(player, money.MT_CASH, 350);
    }
    public boolean som_kenobi_computer_technician_condition_kenobiMain1(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "som_kenobi_main_quest_1", "accessMainframe");
    }
    public boolean som_kenobi_computer_technician_condition_have500(obj_id player, obj_id npc)
    {
        return !money.hasFunds(player, money.MT_CASH, 500);
    }
    public void som_kenobi_computer_technician_action_signalAccess(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedToTechnician");
    }
    public void som_kenobi_computer_technician_action_signalAccessPay350(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedToTechnician");
        money.cashTo(player, npc, 350);
    }
    public void som_kenobi_computer_technician_action_signalAccessPay500(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedToTechnician");
        money.cashTo(player, npc, 500);
    }
    public int som_kenobi_computer_technician_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_computer_technician_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_computer_technician_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_computer_technician_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_computer_technician_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_computer_technician_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_computer_technician_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_computer_technician_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_computer_technician_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int som_kenobi_computer_technician_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
