...
public class c_story1_3_wire extends script.base_script
{
    ...
    public boolean c_story1_3_wire_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_story1_3_wire_condition_needTalkWire1(obj_id player, obj_id npc)
    {
    ...
    public boolean c_story1_3_wire_condition_onSpaceMission(obj_id player, obj_id npc)
    {
        return (space_quest.hasQuest(player, "escort", "c_story1_3_space"));
    }
    public boolean c_story1_3_wire_condition_wonSpaceMission(obj_id player, obj_id npc)
    {
    ...
    public boolean c_story1_3_wire_condition_finished(obj_id player, obj_id npc)
    {
        return (space_quest.hasWonQuest(player, "escort", "c_story1_3_space"));
    }
    public boolean c_story1_3_wire_condition_failedSpaceMission(obj_id player, obj_id npc)
    {
        return (space_quest.hasFailedQuest(player, "escort", "c_story1_3_space"));
    }
    public void c_story1_3_wire_action_signalTalked1(obj_id player, obj_id npc)
    {
    ...
    public void c_story1_3_wire_action_signalTalked2(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedWire2");
        space_quest.giveReward(player, "escort", "c_story1_3_space", 0, "");
    }
    public void c_story1_3_wire_action_quitQuest3(obj_id player, obj_id npc)
    {
    ...
    public int c_story1_3_wire_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_3_wire_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_3_wire_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_3_wire_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_3_wire_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_3_wire_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_3_wire_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_3_wire_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_3_wire_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_3_wire_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_3_wire_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_3_wire_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_3_wire_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_3_wire_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
