...
public class heraldlok extends script.base_script
{
    ...
    public boolean heraldlok_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean heraldlok_condition_hasKimogilaTownWaypoint(obj_id player, obj_id npc)
    {
    ...
    public boolean heraldlok_condition_hasCanyonCorsairWaypoint(obj_id player, obj_id npc)
    {
    ...
    public boolean heraldlok_condition_hasBothWaypoints(obj_id player, obj_id npc)
    {
        return (heraldlok_condition_hasKimogilaTownWaypoint(player, npc) && heraldlok_condition_hasCanyonCorsairWaypoint(player, npc));
    }
    public void heraldlok_action_waypoint1(obj_id player, obj_id npc)
    {
    ...
    public void heraldlok_action_waypoint2(obj_id player, obj_id npc)
    {
    ...
    public void heraldlok_action_waypoint3(obj_id player, obj_id npc)
    {
    ...
    public void heraldlok_action_waypoint4(obj_id player, obj_id npc)
    {
    ...
    public int heraldlok_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int heraldlok_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int heraldlok_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int heraldlok_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
