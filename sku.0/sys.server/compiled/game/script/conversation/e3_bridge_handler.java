...
public class e3_bridge_handler extends script.base_script
{
    ...
    public boolean e3_bridge_handler_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public void e3_bridge_handler_action_goOutside(obj_id player, obj_id npc)
    {
    ...
    public int e3_bridge_handler_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
