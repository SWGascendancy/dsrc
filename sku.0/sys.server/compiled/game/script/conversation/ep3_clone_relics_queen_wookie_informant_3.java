...
public class ep3_clone_relics_queen_wookie_informant_3 extends script.base_script
{
    ...
    public boolean ep3_clone_relics_queen_wookie_informant_3_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_clone_relics_queen_wookie_informant_3_condition_isWookie(obj_id player, obj_id npc)
    {
        return (getSpecies(player) == SPECIES_WOOKIEE);
    }
    public boolean ep3_clone_relics_queen_wookie_informant_3_condition_onQuestTwo(obj_id player, obj_id npc)
    {
        return (groundquests.isQuestActive(player, "ep3_clone_relics_queen_2"));
    }
    public boolean ep3_clone_relics_queen_wookie_informant_3_condition_onSpaceMission(obj_id player, obj_id npc)
    {
        return (space_quest.hasQuest(player, "space_battle", "ep3_clone_relics_queen_3"));
    }
    public boolean ep3_clone_relics_queen_wookie_informant_3_condition_knowWookie(obj_id player, obj_id npc)
    {
        return utils.canSpeakWookiee(player, npc);
    }
    public boolean ep3_clone_relics_queen_wookie_informant_3_condition_foundInformants(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "ep3_clone_relics_queen_2", "foundInformants"));
    }
    public void ep3_clone_relics_queen_wookie_informant_3_action_signalTalked(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedToPrisonWookie");
    }
    public void ep3_clone_relics_queen_wookie_informant_3_action_dontUnderstand(obj_id player, obj_id npc)
    {
        utils.emoteWookieeConfusion(player, npc);
    }
    public int ep3_clone_relics_queen_wookie_informant_3_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_queen_wookie_informant_3_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_queen_wookie_informant_3_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_queen_wookie_informant_3_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
