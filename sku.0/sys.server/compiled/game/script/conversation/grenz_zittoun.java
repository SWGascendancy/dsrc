...
public class grenz_zittoun extends script.base_script
{
    ...
    public boolean grenz_zittoun_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean grenz_zittoun_condition_isElligibleHideoutBoss(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean grenz_zittoun_condition_hasReturnedHideoutBoss(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "u16_nym_themepark_pirate_boss_1", "returnKillHideoutBossComplete");
    }
    public boolean grenz_zittoun_condition_hasHideoutBossNotComplete(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isQuestActive(player, "u16_nym_themepark_pirate_boss_1");
    }
    public boolean grenz_zittoun_condition_isElligibleMineBoss(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean grenz_zittoun_condition_isElligibleLabBoss(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean grenz_zittoun_condition_hasReturnedMineBoss(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "u16_nym_themepark_mine_boss", "returnKillMineBossComplete");
    }
    public boolean grenz_zittoun_condition_hasReturnedLabBoss(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "u16_nym_themepark_lab_boss", "returnKillLabBossComplete");
    }
    public boolean grenz_zittoun_condition_hasMineBossNotComplete(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isQuestActive(player, "u16_nym_themepark_mine_boss");
    }
    public boolean grenz_zittoun_condition_hasLabBossNotComplete(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isQuestActive(player, "u16_nym_themepark_lab_boss");
    }
    public boolean grenz_zittoun_condition_hasntDoneHideout(obj_id player, obj_id npc)
    {
        return !groundquests.isQuestActiveOrComplete(player, "u16_nym_themepark_pirate_hideout");
    }
    public boolean grenz_zittoun_condition_hasntDoneMine(obj_id player, obj_id npc)
    {
    ...
    public boolean grenz_zittoun_condition_hasntDoneLab(obj_id player, obj_id npc)
    {
    ...
    public boolean grenz_zittoun_condition_hasCompletedPirateBossCollection(obj_id player, obj_id npc)
    {
    ...
    public boolean grenz_zittoun_condition_hasCompletedMinerBossCollection(obj_id player, obj_id npc)
    {
    ...
    public boolean grenz_zittoun_condition_hasCompletedLabBossCollection(obj_id player, obj_id npc)
    {
    ...
    public boolean grenz_zittoun_condition_hasCompletedAll(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "u16_nym_themepark_lab_boss");
    }
    public boolean grenz_zittoun_condition_hasIncompletePirateBossCollection(obj_id player, obj_id npc)
    {
    ...
    public boolean grenz_zittoun_condition_hasIncompleteMinerBossCollection(obj_id player, obj_id npc)
    {
    ...
    public boolean grenz_zittoun_condition_hasIncompleteLabBossCollection(obj_id player, obj_id npc)
    {
    ...
    public void grenz_zittoun_action_grantHideoutBossQuest(obj_id player, obj_id npc)
    {
    ...
    public void grenz_zittoun_action_completeHideoutBossQuest(obj_id player, obj_id npc)
    {
    ...
    public void grenz_zittoun_action_grantMineBossQuest(obj_id player, obj_id npc)
    {
    ...
    public void grenz_zittoun_action_completeMineBossQuest(obj_id player, obj_id npc)
    {
    ...
    public void grenz_zittoun_action_grantLabBossQuest(obj_id player, obj_id npc)
    {
    ...
    public void grenz_zittoun_action_completeLabBoss(obj_id player, obj_id npc)
    {
    ...
    public void grenz_zittoun_action_BruteForceCompletePirateBoss(obj_id player, obj_id npc)
    {
    ...
    public void grenz_zittoun_action_BruteForceCompleteMineBoss(obj_id player, obj_id npc)
    {
    ...
    public void grenz_zittoun_action_BruteForceCompleteLabBoss(obj_id player, obj_id npc)
    {
    ...
    public void grenz_zittoun_action_verifyAndCorrectErrors(obj_id player, obj_id npc)
    {
        if (grenz_zittoun_condition_hasCompletedLabBossCollection(player, npc))
        {
    ...
    public void grenz_zittoun_action_BruteForceCompleteLabBossCollection(obj_id player, obj_id npc)
    {
        if (hasCompletedCollectionSlot(player, "kill_nyms_themepark_boss_lab_activate"))
        {
    ...
    public void grenz_zittoun_action_BruteForceCompleteMineBossCollection(obj_id player, obj_id npc)
    {
        if (hasCompletedCollectionSlot(player, "kill_nyms_themepark_boss_mine_activate"))
        {
    ...
    public void grenz_zittoun_action_BruteForceCompletePirateBossCollection(obj_id player, obj_id npc)
    {
        if (hasCompletedCollectionSlot(player, "kill_nyms_themepark_boss_hideout_activate"))
        {
            modifyCollectionSlotValue(player, "kill_nyms_themepark_boss_1", 1);
    ...
    public String grenz_zittoun_tokenTO_firstName(obj_id player, obj_id npc)
    {
        return new String(getFirstName(player));
    }
    public int grenz_zittoun_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int grenz_zittoun_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int grenz_zittoun_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int grenz_zittoun_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int grenz_zittoun_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int grenz_zittoun_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int grenz_zittoun_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int grenz_zittoun_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int grenz_zittoun_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int grenz_zittoun_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int grenz_zittoun_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int grenz_zittoun_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int grenz_zittoun_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int grenz_zittoun_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int grenz_zittoun_handleBranch32(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int grenz_zittoun_handleBranch35(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int grenz_zittoun_handleBranch37(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int grenz_zittoun_handleBranch38(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int grenz_zittoun_handleBranch39(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int grenz_zittoun_handleBranch40(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int grenz_zittoun_handleBranch41(obj_id player, obj_id npc, string_id response)
    {
