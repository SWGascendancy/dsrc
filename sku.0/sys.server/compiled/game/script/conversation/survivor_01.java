...
public class survivor_01 extends script.base_script
{
    ...
    public boolean survivor_01_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean survivor_01_condition_condition0001(obj_id player, obj_id npc)
    {
        return getIntObjVar(npc, "randNum") == 1;
    }
    public boolean survivor_01_condition_condition0002(obj_id player, obj_id npc)
    {
        return getIntObjVar(npc, "randNum") == 2;
    }
    public boolean survivor_01_condition_isMySpawner(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (getObjIdObjVar(npc, "myEscort") == player);
    }
    public boolean survivor_01_condition_condition0003(obj_id player, obj_id npc)
    {
        return getIntObjVar(npc, "randNum") == 3;
    }
    public boolean survivor_01_condition_condition0004(obj_id player, obj_id npc)
    {
        return getIntObjVar(npc, "randNum") == 4;
    }
    public boolean survivor_01_condition_condition0005(obj_id player, obj_id npc)
    {
        return getIntObjVar(npc, "randNum") == 5;
    }
    public void survivor_01_action_runforit(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        survivor_01_action_randomBlurb(player, npc);
        messageTo(npc, "startSurvivorPathing", null, 0.0f, false);
    }
    public void survivor_01_action_randomBlurb(obj_id player, obj_id npc)
    {
    ...
    public void survivor_01_action_removeNeverSpoken(obj_id player, obj_id npc)
    {
        removeObjVar(npc, "neverSpokenTo");
    }
    public int survivor_01_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
