...
public class ig88_slicer extends script.base_script
{
    ...
    public boolean ig88_slicer_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ig88_slicer_condition_isImp(obj_id player, obj_id npc)
    {
        return factions.isImperial(player);
    }
    public boolean ig88_slicer_condition_isReb(obj_id player, obj_id npc)
    {
        return factions.isRebel(player);
    }
    public boolean ig88_slicer_condition_isNeutral(obj_id player, obj_id npc)
    {
        return (!factions.isRebel(player) && !factions.isImperial(player));
    }
    public boolean ig88_slicer_condition_hasQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "feeder_ig88_01");
    }
    public boolean ig88_slicer_condition_onQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean ig88_slicer_condition_lastLeg(obj_id player, obj_id npc)
    {
    ...
    public boolean ig88_slicer_condition_lostQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean ig88_slicer_condition_allDone(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "found_ig88_encounter");
    }
    public void ig88_slicer_action_updateQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "feeder_signal_ig88_01_01");
    }
    public void ig88_slicer_action_grantLostQuest(obj_id player, obj_id npc)
    {
    ...
    public void ig88_slicer_action_completeQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "feeder_signal_ig88_01_02");
    }
    public void ig88_slicer_action_grantGoToQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "found_ig88_encounter");
        instance.flagPlayerForInstance(player, "heroic_ig88");
    }
    public int ig88_slicer_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ig88_slicer_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ig88_slicer_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ig88_slicer_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ig88_slicer_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ig88_slicer_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ig88_slicer_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ig88_slicer_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ig88_slicer_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_37"))
        {
            if (ig88_slicer_condition__defaultCondition(player, npc))
    ...
    public int ig88_slicer_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_37"))
        {
            if (ig88_slicer_condition__defaultCondition(player, npc))
