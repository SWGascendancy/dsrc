...
public class ep3_rryatt_vritol extends script.base_script
{
    ...
    public boolean ep3_rryatt_vritol_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_rryatt_vritol_condition_cannotSpeakWookiee(obj_id player, obj_id npc)
    {
        return utils.canSpeakWookiee(player, npc);
    }
    public boolean ep3_rryatt_vritol_condition_sentByBrody(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_hunt_vritol_reward_mount");
    }
    public void ep3_rryatt_vritol_action_thinkWookieeConfusion(obj_id player, obj_id npc)
    {
        utils.emoteWookieeConfusion(player, npc);
    }
    public void ep3_rryatt_vritol_action_grantKashBanthaMount(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "vritol_speakToVritol");
    }
    public int ep3_rryatt_vritol_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
