...
public class ep3_trandoshan_ssiksik extends script.base_script
{
    ...
    public boolean ep3_trandoshan_ssiksik_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_trandoshan_ssiksik_condition_isOnQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_trando_ssiksik");
    }
    public boolean ep3_trandoshan_ssiksik_condition_hasCompletedQuest01(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_trando_ssiksik");
    }
    public void ep3_trandoshan_ssiksik_action_giveQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_trando_ssiksik");
    }
    public void ep3_trandoshan_ssiksik_action_clearMission(obj_id player, obj_id npc)
    {
        groundquests.clearQuest(player, "ep3_trando_ssiksik");
    }
    public void ep3_trandoshan_ssiksik_action_regrantMission(obj_id player, obj_id npc)
    {
        groundquests.clearQuest(player, "ep3_trando_ssiksik");
        groundquests.grantQuest(player, "ep3_trando_ssiksik");
    }
    public int ep3_trandoshan_ssiksik_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_ssiksik_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_ssiksik_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_ssiksik_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_ssiksik_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
