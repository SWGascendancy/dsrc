...
public class quest_hero_of_tatooine_mother extends script.base_script
{
    ...
    public boolean quest_hero_of_tatooine_mother_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean quest_hero_of_tatooine_mother_condition_notOnQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean quest_hero_of_tatooine_mother_condition_acceptedFollow(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "quest.hero_of_tatooine.altruism"))
        {
    ...
    public boolean quest_hero_of_tatooine_mother_condition_isFollowing(obj_id player, obj_id npc)
    {
    ...
    public void quest_hero_of_tatooine_mother_action_setFollowAccept(obj_id player, obj_id npc)
    {
        setObjVar(player, "quest.hero_of_tatooine.altruism", 2);
    }
    public void quest_hero_of_tatooine_mother_action_startFollowing(obj_id player, obj_id npc)
    {
    ...
    public int quest_hero_of_tatooine_mother_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_hero_of_tatooine_mother_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_hero_of_tatooine_mother_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_hero_of_tatooine_mother_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
