...
public class mtp_hideout_access_strilath_farles_02 extends script.base_script
{
    ...
    public boolean mtp_hideout_access_strilath_farles_02_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean mtp_hideout_access_strilath_farles_02_condition_mtpHideout04_03(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_hideout_access_strilath_farles_02_condition_active_mtpHideout04(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_hideout_access_strilath_farles_02_condition_needs_mtpHideout04(obj_id player, obj_id npc)
    {
    ...
    public void mtp_hideout_access_strilath_farles_02_action_signal_mtpHideout03_04(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "mtp_hideout_access_04_03");
    }
    public void mtp_hideout_access_strilath_farles_02_action_fakeSmoke(obj_id player, obj_id npc)
    {
    ...
    public void mtp_hideout_access_strilath_farles_02_action_actualSmoke(obj_id player, obj_id npc)
    {
        messageTo(npc, "makeNpcDisappear", null, 1, false);
    }
    public void mtp_hideout_access_strilath_farles_02_action_regrant_mtpHideout04(obj_id player, obj_id npc)
    {
    ...
    public int mtp_hideout_access_strilath_farles_02_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_access_strilath_farles_02_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_access_strilath_farles_02_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_access_strilath_farles_02_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
