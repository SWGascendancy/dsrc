...
public class coa3wvacca extends script.base_script
{
    ...
    public boolean coa3wvacca_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean coa3wvacca_condition_hasCOA2Badge(obj_id player, obj_id npc)
    {
        return (getIntObjVar(player, "coa3.convTracker") < -400 && badge.hasBadge(player, "event_coa2_rebel"));
    }
    public boolean coa3wvacca_condition_notReadyToTalk(obj_id player, obj_id npc)
    {
        return (getIntObjVar(player, "coa3.convTracker") > -400);
    }
    public boolean coa3wvacca_condition_isReadyToTalk(obj_id player, obj_id npc)
    {
        return (getIntObjVar(player, "coa3.convTracker") < -400);
    }
    public void coa3wvacca_action__defaultAction(obj_id player, obj_id npc)
    {
    }
