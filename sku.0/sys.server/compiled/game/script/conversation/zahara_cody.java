...
public class zahara_cody extends script.base_script
{
    ...
    public boolean zahara_cody_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean zahara_cody_condition_isImperialNotImmunized(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean zahara_cody_condition_hasTrigTask(obj_id player, obj_id npc)
    {
    ...
    public boolean zahara_cody_condition_hasFoundEpsilon(obj_id player, obj_id npc)
    {
    ...
    public boolean zahara_cody_condition_hasDeliveredRadioEpsilon(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "outbreak_radio_delivery_03");
    }
    public boolean zahara_cody_condition_hasCompletedQuest01(obj_id player, obj_id npc)
    {
    ...
    public boolean zahara_cody_condition_hasCompletedQuestLine(obj_id player, obj_id npc)
    {
    ...
    public boolean zahara_cody_condition_hasDeletedQuest01b(obj_id player, obj_id npc)
    {
    ...
    public boolean zahara_cody_condition_doesNotHaveAntiVirus(obj_id player, obj_id npc)
    {
        return !buff.hasBuff(player, "death_troopers_inoculation");
    }
    public void zahara_cody_action_giveAntiVirus(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public void zahara_cody_action_makeTrigWave(obj_id player, obj_id npc)
    {
    ...
    public void zahara_cody_action_giveQuest1b(obj_id player, obj_id npc)
    {
    ...
    public int zahara_cody_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int zahara_cody_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int zahara_cody_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int zahara_cody_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int zahara_cody_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int zahara_cody_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int zahara_cody_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int zahara_cody_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int zahara_cody_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int zahara_cody_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int zahara_cody_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int zahara_cody_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int zahara_cody_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int zahara_cody_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int zahara_cody_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_77"))
        {
            if (zahara_cody_condition__defaultCondition(player, npc))
    ...
    public int zahara_cody_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int zahara_cody_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_77"))
        {
            if (zahara_cody_condition__defaultCondition(player, npc))
    ...
    public int zahara_cody_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int zahara_cody_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int zahara_cody_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_77"))
        {
            if (zahara_cody_condition__defaultCondition(player, npc))
    ...
    public int zahara_cody_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int zahara_cody_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_77"))
        {
            if (zahara_cody_condition__defaultCondition(player, npc))
    ...
    public int findNpc(obj_id self, dictionary params)
    {
