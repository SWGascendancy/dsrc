...
public class c_newbie_melee_combat_client_3 extends script.base_script
{
    ...
    public boolean c_newbie_melee_combat_client_3_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_newbie_melee_combat_client_3_condition_onTaskTalk(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "c_newbie_melee_quest_3", "talkClient1"));
    }
    public boolean c_newbie_melee_combat_client_3_condition_onTaskEscort(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "c_newbie_melee_quest_3", "onEscort1"));
    }
    public boolean c_newbie_melee_combat_client_3_condition_completedEscort(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedTask(player, "c_newbie_melee_quest_3", "onEscort1"));
    }
    public boolean c_newbie_melee_combat_client_3_condition_defeatedFirstEncounter(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedTask(player, "c_newbie_melee_quest_3", "timer1"));
    }
    public boolean c_newbie_melee_combat_client_3_condition_defeatedSecondEncounter(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedTask(player, "c_newbie_melee_quest_3", "encounter2"));
    }
    public boolean c_newbie_melee_combat_client_3_condition_onTaskEscortTwo(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "c_newbie_melee_quest_3", "onEscort2"));
    }
    public boolean c_newbie_melee_combat_client_3_condition_completedTaskEscortTwo(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedTask(player, "c_newbie_melee_quest_3", "onEscort2"));
    }
    public void c_newbie_melee_combat_client_3_action_signalTalked(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedClient1");
    }
    public void c_newbie_melee_combat_client_3_action_signalTalkedTwo(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedClient2");
    }
    public void c_newbie_melee_combat_client_3_action_signalTalkedThree(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedClient3");
    }
    public void c_newbie_melee_combat_client_3_action_signalEndEscort(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "escortComplete");
        groundquests.completeTask(player, "c_newbie_melee_quest_3", "escortTask");
    }
    public int c_newbie_melee_combat_client_3_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_newbie_melee_combat_client_3_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_newbie_melee_combat_client_3_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
