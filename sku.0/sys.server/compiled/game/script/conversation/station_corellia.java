...
public class station_corellia extends script.base_script
{
    ...
    public boolean station_corellia_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean station_corellia_condition_canAfford50(obj_id player, obj_id npc)
    {
        return space_crafting.canAffordShipRepairs(player, npc, .50f);
    }
    public boolean station_corellia_condition_canAfford25(obj_id player, obj_id npc)
    {
        return (space_crafting.canAffordShipRepairs(player, npc, .25f) && space_crafting.isDamaged(player));
    }
    public boolean station_corellia_condition_canAfford75(obj_id player, obj_id npc)
    {
        return space_crafting.canAffordShipRepairs(player, npc, .75f);
    }
    public boolean station_corellia_condition_canAfford100(obj_id player, obj_id npc)
    {
        return space_crafting.canAffordShipRepairs(player, npc, 1.0f);
    }
    public boolean station_corellia_condition_needRepairs(obj_id player, obj_id npc)
    {
    ...
    public boolean station_corellia_condition_isTooFar(obj_id player, obj_id npc)
    {
        space_combat.playCombatTauntSound(player);
        obj_id containingShip = space_transition.getContainingShip(player);
        return (getDistance(npc, containingShip) > space_transition.STATION_COMM_MAX_DISTANCE);
    }
    public boolean station_corellia_condition_isCorelliaTier1Rebel(obj_id player, obj_id npc)
    {
        return (space_flags.isInTierOne(player) && space_flags.isSpaceTrack(player, space_flags.REBEL_CORELLIA));
    }
    public boolean station_corellia_condition_isCorelliaTier1Privateer(obj_id player, obj_id npc)
    {
        return (space_flags.isInTierOne(player) && space_flags.isSpaceTrack(player, space_flags.PRIVATEER_CORELLIA));
    }
    public boolean station_corellia_condition_isCorSec(obj_id player, obj_id npc)
    {
    ...
    public boolean station_corellia_condition_hasWonMission1(obj_id player, obj_id npc)
    {
    ...
    public boolean station_corellia_condition_hasWonMission2(obj_id player, obj_id npc)
    {
    ...
    public boolean station_corellia_condition_hasWonMission3(obj_id player, obj_id npc)
    {
    ...
    public boolean station_corellia_condition_hasWonMission4a(obj_id player, obj_id npc)
    {
    ...
    public boolean station_corellia_condition_hasWonMission4b(obj_id player, obj_id npc)
    {
    ...
    public boolean station_corellia_condition_hasWonMission5a(obj_id player, obj_id npc)
    {
    ...
    public boolean station_corellia_condition_hasWonMission5b(obj_id player, obj_id npc)
    {
    ...
    public boolean station_corellia_condition_readyForMission2(obj_id player, obj_id npc)
    {
    ...
    public boolean station_corellia_condition_readyForMission3(obj_id player, obj_id npc)
    {
        if (space_flags.hasSpaceFlag(player, "readyForCorelliaStationMission"))
        {
            int flag = space_flags.getIntSpaceFlag(player, "readyForCorelliaStationMission");
    ...
    public boolean station_corellia_condition_readyForMission4(obj_id player, obj_id npc)
    {
        if (!space_flags.isSpaceTrack(player, space_flags.PRIVATEER_CORELLIA))
        {
            return false;
    ...
    public boolean station_corellia_condition_readyForMission5a(obj_id player, obj_id npc)
    {
        if (space_flags.hasSpaceFlag(player, "readyForCorelliaStationMission"))
        {
            int flag = space_flags.getIntSpaceFlag(player, "readyForCorelliaStationMission");
    ...
    public boolean station_corellia_condition_readyForMission5b(obj_id player, obj_id npc)
    {
        if (!space_flags.isSpaceTrack(player, space_flags.PRIVATEER_CORELLIA))
        {
            return false;
    ...
    public boolean station_corellia_condition_hasFailedMission(obj_id player, obj_id npc)
    {
    ...
    public boolean station_corellia_condition_isWaiting(obj_id player, obj_id npc)
    {
        if (space_flags.hasSpaceFlag(player, "waitingForCorelliaStationMission"))
        {
            return true;
    ...
    public boolean station_corellia_condition_hasFailedMission1(obj_id player, obj_id npc)
    {
    ...
    public boolean station_corellia_condition_hasFailedMission2(obj_id player, obj_id npc)
    {
    ...
    public boolean station_corellia_condition_hasFailedMission3(obj_id player, obj_id npc)
    {
    ...
    public boolean station_corellia_condition_hasFailedMission4(obj_id player, obj_id npc)
    {
    ...
    public boolean station_corellia_condition_hasFailedMission5a(obj_id player, obj_id npc)
    {
    ...
    public boolean station_corellia_condition_hasFailedMission5b(obj_id player, obj_id npc)
    {
    ...
    public boolean station_corellia_condition_canDoDuty(obj_id player, obj_id npc)
    {
    ...
    public boolean station_corellia_condition_canDoTier1Duty(obj_id player, obj_id npc)
    {
    ...
    public boolean station_corellia_condition_canLandAtHouse(obj_id player, obj_id npc)
    {
    ...
    public boolean station_corellia_condition_canAttackRebel(obj_id player, obj_id npc)
    {
    ...
    public boolean station_corellia_condition_canAttackImperial(obj_id player, obj_id npc)
    {
    ...
    public boolean station_corellia_condition_canTakeQuest(obj_id player, obj_id npc)
    {
        if (space_quest.hasQuest(player))
        {
            return false;
    ...
    public boolean station_corellia_condition_canTakeImperialTier5(obj_id player, obj_id npc)
    {
    ...
    public boolean station_corellia_condition_canTakeRebelTier5(obj_id player, obj_id npc)
    {
        if (!space_skill.isMasterPilot(player))
        {
            return false;
    ...
    public void station_corellia_action_landStation3(obj_id player, obj_id npc)
    {
        space_content.landPlayer(player, npc, "Doaba Guerfel Starport");
    }
    public void station_corellia_action_fix25(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, .25f);
    }
    public void station_corellia_action_fix50(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, .50f);
    }
    public void station_corellia_action_fix75(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, .75f);
    }
    public void station_corellia_action_fix100(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, 1.0f);
    }
    public void station_corellia_action_landStation1(obj_id player, obj_id npc)
    {
        space_content.landPlayer(player, npc, "Coronet Starport");
    }
    public void station_corellia_action_landStation2(obj_id player, obj_id npc)
    {
        space_content.landPlayer(player, npc, "Kor Vella Starport");
    }
    public void station_corellia_action_landStation4(obj_id player, obj_id npc)
    {
        space_content.landPlayer(player, npc, "Tyrena Starport");
    }
    public void station_corellia_action_grantMission1(obj_id player, obj_id npc)
    {
    ...
    public void station_corellia_action_removeMissionFlag(obj_id player, obj_id npc)
    {
        space_flags.removeSpaceFlag(player, "isOnCorelliaStationMission");
    }
    public void station_corellia_action_grantReward1(obj_id player, obj_id npc)
    {
    ...
    public void station_corellia_action_grantReward2(obj_id player, obj_id npc)
    {
    ...
    public void station_corellia_action_grantMission2(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "recovery", "corellia_station_mission2_1");
        space_flags.setSpaceFlag(player, "isOnCorelliaStationMission", 1);
    }
    public void station_corellia_action_grantMission3(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "assassinate", "corellia_station_mission3_1");
        space_flags.setSpaceFlag(player, "isOnCorelliaStationMission", 1);
    }
    public void station_corellia_action_grantReward3(obj_id player, obj_id npc)
    {
    ...
    public void station_corellia_action_grantMission4(obj_id player, obj_id npc)
    {
    ...
    public void station_corellia_action_grantReward4a(obj_id player, obj_id npc)
    {
    ...
    public void station_corellia_action_grantReward4b(obj_id player, obj_id npc)
    {
    ...
    public void station_corellia_action_grantMission5a(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "recovery", "corellia_station_mission5a_1");
        space_flags.setSpaceFlag(player, "isOnCorelliaStationMission", 1);
    }
    public void station_corellia_action_grantMission5b(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "escort", "corellia_station_mission5b_1");
        space_flags.setSpaceFlag(player, "isOnCorelliaStationMission", 1);
        space_flags.removeSpaceFlag(player, "waitingForCorelliaStationMission");
    }
    public void station_corellia_action_grantReward5a(obj_id player, obj_id npc)
    {
        space_quest.giveReward(player, "destroy_surpriseattack", "corellia_station_mission5a_2", 5000);
        space_flags.removeSpaceFlag(player, "isOnCorelliaStationMission");
    }
    public void station_corellia_action_grantReward5b(obj_id player, obj_id npc)
    {
        space_quest.giveReward(player, "assassinate", "corellia_station_mission5a_3", 7000);
        space_flags.removeSpaceFlag(player, "isOnCorelliaStationMission");
    }
    public void station_corellia_action_grantDuty1(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "corellia_station_duty1");
    }
    public void station_corellia_action_grantDuty2(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "corellia_station_duty4");
    }
    public void station_corellia_action_landHoming(obj_id player, obj_id npc)
    {
        space_content.landPlayerHoming(player, npc);
    }
    public void station_corellia_action_grantBlackSun1Duty(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "corellia_blacksun_tier1");
    }
    public void station_corellia_action_grantBlackSun2Duty(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "corellia_blacksun_tier2");
    }
    public void station_corellia_action_grantImperialDuty1(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "corellia_imperial_tier1");
    }
    public void station_corellia_action_grantImperialDuty2(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "corellia_imperial_tier2");
    }
    public void station_corellia_action_grantRebelDuty1(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "corellia_rebel_tier1");
    }
    public void station_corellia_action_grantRebelDuty2(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "corellia_rebel_tier2");
    }
    public void station_corellia_action_grantRebelDuty5(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "corellia_rebel_tier5");
    }
    public void station_corellia_action_grantImperialDuty5(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "corellia_imperial_tier5");
    }
    public String station_corellia_tokenTO_tokenTO0001(obj_id player, obj_id npc)
    {
        return new String();
    }
    public int station_corellia_tokenDI_getStationRepairCost25(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, .25f);
    }
    public int station_corellia_tokenDI_getStationRepairCost50(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, .50f);
    }
    public int station_corellia_tokenDI_getStationRepairCost75(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, .75f);
    }
    public int station_corellia_tokenDI_getStationRepairCost100(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, 1.0f);
    }
    public int station_corellia_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_corellia_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_corellia_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_corellia_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_corellia_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_corellia_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_corellia_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_corellia_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_corellia_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_corellia_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_corellia_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_corellia_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_corellia_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_corellia_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_corellia_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_corellia_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_corellia_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_corellia_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_corellia_handleBranch30(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_corellia_handleBranch33(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_corellia_handleBranch34(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_corellia_handleBranch37(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_corellia_handleBranch40(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_corellia_handleBranch43(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_corellia_handleBranch44(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_corellia_handleBranch45(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_corellia_handleBranch48(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_corellia_handleBranch51(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_corellia_handleBranch54(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_corellia_handleBranch57(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_corellia_handleBranch60(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_corellia_handleBranch63(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_corellia_handleBranch66(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_corellia_handleBranch67(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_corellia_handleBranch70(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_corellia_handleBranch73(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_corellia_handleBranch76(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_corellia_handleBranch80(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_corellia_handleBranch83(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_corellia_handleBranch86(obj_id player, obj_id npc, string_id response)
    {
