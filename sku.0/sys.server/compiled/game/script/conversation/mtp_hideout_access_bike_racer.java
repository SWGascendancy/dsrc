...
public class mtp_hideout_access_bike_racer extends script.base_script
{
    ...
    public boolean mtp_hideout_access_bike_racer_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean mtp_hideout_access_bike_racer_condition_mtpHideout03_01(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_hideout_access_bike_racer_condition_mtpHideout03_01_done(obj_id player, obj_id npc)
    {
    ...
    public void mtp_hideout_access_bike_racer_action_signal_mtpHideout03_01(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "mtp_hideout_access_03_01");
    }
    public int mtp_hideout_access_bike_racer_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
