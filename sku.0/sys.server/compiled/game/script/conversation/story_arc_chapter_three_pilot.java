...
public class story_arc_chapter_three_pilot extends script.base_script
{
    ...
    public boolean story_arc_chapter_three_pilot_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean story_arc_chapter_three_pilot_condition_travelToVolcano(obj_id player, obj_id npc)
    {
    ...
    public boolean story_arc_chapter_three_pilot_condition_travelToVolcanoTwo(obj_id player, obj_id npc)
    {
    ...
    public void story_arc_chapter_three_pilot_action_sendFirstSignal(obj_id player, obj_id npc)
    {
    ...
    public void story_arc_chapter_three_pilot_action_sendGroupToVolcano(obj_id player, obj_id npc)
    {
        instance.requestInstanceMovement(player, "mustafar_volcano");
    }
    public int story_arc_chapter_three_pilot_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int story_arc_chapter_three_pilot_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int story_arc_chapter_three_pilot_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int story_arc_chapter_three_pilot_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int story_arc_chapter_three_pilot_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int OnClusterWideDataResponse(obj_id self, String manage_name, String dungeon_type, int request_id, String[] element_name_list, dictionary[] dungeon_data, int lock_key)
    {
    ...
    public int msgStartDungeonTravel(obj_id self, dictionary params)
    {
