...
public class cale_serasai extends script.base_script
{
    ...
    public boolean cale_serasai_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean cale_serasai_condition_isAmbassador(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "u16_nym_themepark_negotiate_peace", "speakToAmbassador");
    }
    public boolean cale_serasai_condition_deliverMessage(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "u16_nym_themepark_negotiate_peace", "deliverMessage");
    }
    public boolean cale_serasai_condition_moveThroughKill(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "u16_nym_themepark_negotiate_peace", "killTheHenchmen");
    }
    public boolean cale_serasai_condition_speakLastTime(obj_id player, obj_id npc)
    {
    ...
    public boolean cale_serasai_condition_hasNotCompletedWave(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "u16_nym_themepark_negotiate_peace", "killTheHenchmen");
    }
    public boolean cale_serasai_condition_failedExtraction(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "u16_nym_themepark_rescue_sheeli_fail", "failedExtraction");
    }
    public void cale_serasai_action_signalMessageReceived(obj_id player, obj_id npc)
    {
    ...
    public void cale_serasai_action_giveRescueMission(obj_id player, obj_id npc)
    {
    }
    public void cale_serasai_action_signalAmbassador(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "hasSpokenToAmbassador");
    }
    public void cale_serasai_action_signalKill(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "hasKilledTheHenchmen");
    }
    public void cale_serasai_action_signalSpokenLastTime(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "hasSpokenToAmbassadorTwo");
    }
    public void cale_serasai_action_clearFail(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "hasSpokenCaleRemoveFail");
        cale_serasai_action_giveRescueMission(player, npc);
    }
    public int cale_serasai_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int cale_serasai_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int cale_serasai_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int cale_serasai_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int cale_serasai_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int cale_serasai_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int cale_serasai_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int cale_serasai_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
