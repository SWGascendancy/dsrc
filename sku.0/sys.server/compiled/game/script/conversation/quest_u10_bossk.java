...
public class quest_u10_bossk extends script.base_script
{
    ...
    public boolean quest_u10_bossk_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean quest_u10_bossk_condition_quest_u10_02_03_active(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "quest_u10_02", "quest_u10_02_03");
    }
    public boolean quest_u10_bossk_condition_quest_u10_01_04_active(obj_id player, obj_id npc)
    {
    ...
    public boolean quest_u10_bossk_condition_quest_u10_03_needed(obj_id player, obj_id npc)
    {
        return !groundquests.isQuestActiveOrComplete(player, "quest_u10_03");
    }
    public boolean quest_u10_bossk_condition_quest_u10_02_02_active(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "quest_u10_02", "quest_u10_02_02");
    }
    public void quest_u10_bossk_action_quest_u10_02_02_signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "quest_u10_02_02");
    }
    public void quest_u10_bossk_action_quest_u10_03_grant(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "quest_u10_03");
    }
    public void quest_u10_bossk_action_quest_u10_02_04_signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "quest_u10_02_04");
    }
    public int quest_u10_bossk_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_u10_bossk_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_u10_bossk_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
