...
public class ep3_etyyy_chrilooc extends script.base_script
{
    ...
    public boolean ep3_etyyy_chrilooc_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_etyyy_chrilooc_condition_hasCompletedSmithQuest(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedQuest(player, "ep3_hunt_chrilooc_seek_johnson"));
    }
    public boolean ep3_etyyy_chrilooc_condition_hasCompletedMedicalQuest(obj_id player, obj_id npc)
    {
        return (space_quest.hasWonQuest(player, "recovery", "ep3_hunting_chrilooc_medical_supplies"));
    }
    public boolean ep3_etyyy_chrilooc_condition_hasCompletedKerssocQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_etyyy_chrilooc_condition_isGettingMedicalSupplies(obj_id player, obj_id npc)
    {
        return (space_quest.hasQuest(player, "recovery", "ep3_hunting_chrilooc_medical_supplies"));
    }
    public boolean ep3_etyyy_chrilooc_condition_isSpeakingWithKerssoc(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_etyyy_chrilooc_condition_fromWrelaac(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_hunt_wrelaac_to_chrilooc");
    }
    public boolean ep3_etyyy_chrilooc_condition_foundBrodyJohnson(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_hunt_johnson_brody_johnson");
    }
    public boolean ep3_etyyy_chrilooc_condition_alreadyOnKerssocQuests(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_etyyy_chrilooc_condition_hasEtyyyAccess(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_etyyy_chrilooc_condition_failedGettingMedSupplies(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_etyyy_chrilooc_condition_cannotSpeakWookiee(obj_id player, obj_id npc)
    {
        return utils.canSpeakWookiee(player, npc);
    }
    public boolean ep3_etyyy_chrilooc_condition_alreadyHasSpaceMission(obj_id player, obj_id npc)
    {
        return space_quest.hasQuest(player);
    }
    public void ep3_etyyy_chrilooc_action_speakWithSmith(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "chrilooc_talkToChrilooc");
        groundquests.grantQuest(player, "ep3_hunt_chrilooc_seek_johnson");
    }
    public void ep3_etyyy_chrilooc_action_continueWithKerssoc(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_hunt_chrilooc_seek_rodians_02");
    }
    public void ep3_etyyy_chrilooc_action_getMedicalSupplies(obj_id player, obj_id npc)
    {
    ...
    public void ep3_etyyy_chrilooc_action_speakWithKerssoc(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_hunt_chrilooc_seek_rodians");
    }
    public void ep3_etyyy_chrilooc_action_thinkWookieeConfusion(obj_id player, obj_id npc)
    {
        utils.emoteWookieeConfusion(player, npc);
    }
    public int ep3_etyyy_chrilooc_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_chrilooc_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_chrilooc_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_chrilooc_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_chrilooc_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_chrilooc_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_372"))
        {
            if (ep3_etyyy_chrilooc_condition__defaultCondition(player, npc))
    ...
    public int ep3_etyyy_chrilooc_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_chrilooc_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_chrilooc_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_chrilooc_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_chrilooc_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
