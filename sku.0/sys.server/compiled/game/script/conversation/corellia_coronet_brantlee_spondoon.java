...
public class corellia_coronet_brantlee_spondoon extends script.base_script
{
    ...
    public boolean corellia_coronet_brantlee_spondoon_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_coronet_brantlee_spondoon_condition_summonedToBrantlee(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_coronet_capitol_problems_the_informant", "the_informant_0");
    }
    public boolean corellia_coronet_brantlee_spondoon_condition_informantActive(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_coronet_brantlee_spondoon_condition_informantComplete(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_coronet_brantlee_spondoon_condition_thankfulDiktat(obj_id player, obj_id npc)
    {
    ...
    public void corellia_coronet_brantlee_spondoon_action_giveInformantQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "the_informant_0");
        return;
    }
    public void corellia_coronet_brantlee_spondoon_action_endInformantQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "the_informant_8");
        return;
    }
    public int corellia_coronet_brantlee_spondoon_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
