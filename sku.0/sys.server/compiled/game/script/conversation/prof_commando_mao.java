...
public class prof_commando_mao extends script.base_script
{
    ...
    public boolean prof_commando_mao_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean prof_commando_mao_condition_playerOnCOM11Reward(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "prof_commando_11", "talktomao");
    }
    public boolean prof_commando_mao_condition_playerfinishedCOM11Quest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "prof_commando_11");
    }
    public boolean prof_commando_mao_condition_playerStartingCOM11quest(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "prof_commando_11", "giveassignment");
    }
    public boolean prof_commando_mao_condition_questStarted(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "prof_commando_11", "giveassignment");
    }
    public void prof_commando_mao_action_giveRewardSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "prof_commando_11_reward");
    }
    public void prof_commando_mao_action_giveAssignmentSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "prof_commando_11_1_giveassignment");
    }
    public void prof_commando_mao_action_faceplayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void prof_commando_mao_action_givequestDEBUG(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "prof_commando_11");
    }
    public int prof_commando_mao_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int prof_commando_mao_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int prof_commando_mao_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int prof_commando_mao_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
