...
public class event_cheerleader_luke extends script.base_script
{
    ...
    public boolean event_cheerleader_luke_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean event_cheerleader_luke_condition_isImperial(obj_id player, obj_id npc)
    {
    ...
    public boolean event_cheerleader_luke_condition_isNeutral(obj_id player, obj_id npc)
    {
        int factionHashCode = factions.pvpGetAlignedFaction(player);
        String whichFaction = factions.getFactionNameByHashCode(factionHashCode);
        if (whichFaction == null)
    ...
    public boolean event_cheerleader_luke_condition_hasMaxQuests(obj_id player, obj_id npc)
    {
    ...
    public boolean event_cheerleader_luke_condition_completedAll(obj_id player, obj_id npc)
    {
        int killImp5 = questGetQuestId("quest/event_gcwcheerleader_sfimp5");
        int killImp10 = questGetQuestId("quest/event_gcwcheerleader_sfimp10");
        int killImp20 = questGetQuestId("quest/event_gcwcheerleader_sfimp20");
    ...
    public boolean event_cheerleader_luke_condition_noMissionsComplete(obj_id player, obj_id npc)
    {
        int killImp5 = questGetQuestId("quest/event_gcwcheerleader_sfimp5");
        int cmReb1 = questGetQuestId("quest/event_gcwcheerleader_cmreb1");
    ...
    public boolean event_cheerleader_luke_condition_pvp1Ready(obj_id player, obj_id npc)
    {
        int killImp20 = questGetQuestId("quest/event_gcwcheerleader_sfimp20");
        int killImp10 = questGetQuestId("quest/event_gcwcheerleader_sfimp10");
        int killImp5 = questGetQuestId("quest/event_gcwcheerleader_sfimp5");
    ...
    public boolean event_cheerleader_luke_condition_pve1Ready(obj_id player, obj_id npc)
    {
        int cmReb3 = questGetQuestId("quest/event_gcwcheerleader_cmreb3");
        int cmReb2 = questGetQuestId("quest/event_gcwcheerleader_cmreb2");
        int cmReb1 = questGetQuestId("quest/event_gcwcheerleader_cmreb1");
    ...
    public boolean event_cheerleader_luke_condition_pve2Ready(obj_id player, obj_id npc)
    {
        int cmReb3 = questGetQuestId("quest/event_gcwcheerleader_cmreb3");
        int cmReb2 = questGetQuestId("quest/event_gcwcheerleader_cmreb2");
        int cmReb1 = questGetQuestId("quest/event_gcwcheerleader_cmreb1");
    ...
    public boolean event_cheerleader_luke_condition_pvp2Ready(obj_id player, obj_id npc)
    {
        int killImp20 = questGetQuestId("quest/event_gcwcheerleader_sfimp20");
        int killImp10 = questGetQuestId("quest/event_gcwcheerleader_sfimp10");
        int killImp5 = questGetQuestId("quest/event_gcwcheerleader_sfimp5");
    ...
    public boolean event_cheerleader_luke_condition_pve3Ready(obj_id player, obj_id npc)
    {
        int cmReb3 = questGetQuestId("quest/event_gcwcheerleader_cmreb3");
        int cmReb2 = questGetQuestId("quest/event_gcwcheerleader_cmreb2");
        int cmReb1 = questGetQuestId("quest/event_gcwcheerleader_cmreb1");
    ...
    public boolean event_cheerleader_luke_condition_pvp3Ready(obj_id player, obj_id npc)
    {
        int killImp20 = questGetQuestId("quest/event_gcwcheerleader_sfimp20");
        int killImp10 = questGetQuestId("quest/event_gcwcheerleader_sfimp10");
        int killImp5 = questGetQuestId("quest/event_gcwcheerleader_sfimp5");
    ...
    public boolean event_cheerleader_luke_condition_pvp4Ready(obj_id player, obj_id npc)
    {
        int killImp50 = questGetQuestId("quest/event_gcwcheerleader_sfimp50");
        int killImp20 = questGetQuestId("quest/event_gcwcheerleader_sfimp20");
        int killImp10 = questGetQuestId("quest/event_gcwcheerleader_sfimp10");
    ...
    public boolean event_cheerleader_luke_condition_pve4Ready(obj_id player, obj_id npc)
    {
        int cmReb4 = questGetQuestId("quest/event_gcwcheerleader_cmreb4");
        int cmReb3 = questGetQuestId("quest/event_gcwcheerleader_cmreb3");
        int cmReb2 = questGetQuestId("quest/event_gcwcheerleader_cmreb2");
    ...
    public boolean event_cheerleader_luke_condition_hasMinOne(obj_id player, obj_id npc)
    {
        int killImp5 = questGetQuestId("quest/event_gcwcheerleader_sfimp5");
        int cmReb1 = questGetQuestId("quest/event_gcwcheerleader_cmreb1");
        return (questIsQuestComplete(killImp5, player) || questIsQuestComplete(cmReb1, player) || questIsQuestActive(killImp5, player) || questIsQuestActive(cmReb1, player));
    }
    public void event_cheerleader_luke_action_pvp1mission(obj_id player, obj_id npc)
    {
    ...
    public void event_cheerleader_luke_action_pve1mission(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/event_gcwcheerleader_cmreb1");
        groundquests.grantQuest(questId, player, npc, true);
    }
    public void event_cheerleader_luke_action_pvp2mission(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/event_gcwcheerleader_sfimp10");
        groundquests.grantQuest(questId, player, npc, true);
        attachScript(player, "event.gcwraids.spec_force_killer");
    }
    public void event_cheerleader_luke_action_pve2mission(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/event_gcwcheerleader_cmreb2");
        groundquests.grantQuest(questId, player, npc, true);
    }
    public void event_cheerleader_luke_action_pvp3mission(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/event_gcwcheerleader_sfimp20");
        groundquests.grantQuest(questId, player, npc, true);
        attachScript(player, "event.gcwraids.spec_force_killer");
    }
    public void event_cheerleader_luke_action_pve3mission(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/event_gcwcheerleader_cmreb3");
        groundquests.grantQuest(questId, player, npc, true);
    }
    public void event_cheerleader_luke_action_pvp4mission(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/event_gcwcheerleader_sfimp50");
        groundquests.grantQuest(questId, player, npc, true);
        attachScript(player, "event.gcwraids.spec_force_killer");
    }
    public void event_cheerleader_luke_action_pve4mission(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/event_gcwcheerleader_cmreb4");
        groundquests.grantQuest(questId, player, npc, true);
        attachScript(player, "event.gcwraids.pve_badge");
    }
    public int event_cheerleader_luke_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_cheerleader_luke_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_cheerleader_luke_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_cheerleader_luke_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_cheerleader_luke_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_cheerleader_luke_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_cheerleader_luke_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_cheerleader_luke_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_cheerleader_luke_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_cheerleader_luke_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_cheerleader_luke_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_cheerleader_luke_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_cheerleader_luke_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
