...
public class itp_emperor_main extends script.base_script
{
    ...
    public boolean itp_emperor_main_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean itp_emperor_main_condition_itp_emp_01_active(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "itp_emperor_01");
    }
    public boolean itp_emperor_main_condition_itp_emp_01_complete(obj_id player, obj_id npc)
    {
    ...
    public boolean itp_emperor_main_condition_itp_emp_02_active(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "itp_emperor_02");
    }
    public boolean itp_emperor_main_condition_itp_emp_03_complete(obj_id player, obj_id npc)
    {
    ...
    public boolean itp_emperor_main_condition_itp_emp_03_active(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "itp_emperor_03");
    }
    public boolean itp_emperor_main_condition_itp_emp_02_complete(obj_id player, obj_id npc)
    {
    ...
    public boolean itp_emperor_main_condition_completedVeers(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "itp_veers_02");
    }
    public boolean itp_emperor_main_condition_notImperial(obj_id player, obj_id npc)
    {
    ...
    public boolean itp_emperor_main_condition_imperial_isOnLeave(obj_id player, obj_id npc)
    {
        return factions.isOnLeave(player);
    }
    public void itp_emperor_main_action_itp_emp_01_granted(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "itp_emperor_01");
    }
    public void itp_emperor_main_action_itp_emp_01_signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "itp_emperor_01_05");
    }
    public void itp_emperor_main_action_itp_emp_03_signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "itp_emperor_03_04");
    }
    public void itp_emperor_main_action_itp_emp_02_signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "itp_emperor_02_03");
    }
    public void itp_emperor_main_action_itp_emp_02_granted(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "itp_emperor_02");
    }
    public void itp_emperor_main_action_itp_emp_03_granted(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "itp_emperor_03");
    }
    public int itp_emperor_main_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int itp_emperor_main_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int itp_emperor_main_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
