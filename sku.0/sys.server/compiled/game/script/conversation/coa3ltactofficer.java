...
public class coa3ltactofficer extends script.base_script
{
    ...
    public boolean coa3ltactofficer_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean coa3ltactofficer_condition_extraFloraMissionActive(obj_id player, obj_id npc)
    {
        return (getIntObjVar(player, "coa3.extraFlora") == 1);
    }
    public boolean coa3ltactofficer_condition_hasWonStory(obj_id player, obj_id npc)
    {
        return (badge.hasBadge(player, "event_coa3_imperial"));
    }
    public boolean coa3ltactofficer_condition_storyFloraMissionComplete(obj_id player, obj_id npc)
    {
        return (getIntObjVar(player, "coa3.convTracker") > 302);
    }
    public boolean coa3ltactofficer_condition_talkedToCoordinator(obj_id player, obj_id npc)
    {
        return (getIntObjVar(player, "coa3.convTracker") == 301);
    }
    public boolean coa3ltactofficer_condition_storyFloraMissionActive(obj_id player, obj_id npc)
    {
        return (getIntObjVar(player, "coa3.convTracker") == 302);
    }
    public boolean coa3ltactofficer_condition_temp(obj_id player, obj_id npc)
    {
        return false;
    }
    public void coa3ltactofficer_action__defaultAction(obj_id player, obj_id npc)
    {
    }
    public void coa3ltactofficer_action_refreshExtraFloraMission(obj_id player, obj_id npc)
    {
    ...
    public void coa3ltactofficer_action_abortExtraFloraMission(obj_id player, obj_id npc)
    {
    ...
    public void coa3ltactofficer_action_getExtraFloraMission(obj_id player, obj_id npc)
    {
    ...
    public void coa3ltactofficer_action_getStoryFloraMission(obj_id player, obj_id npc)
    {
    ...
    public void coa3ltactofficer_action_refreshStoryFloraMission(obj_id player, obj_id npc)
    {
        setObjVar(player, "coa3.convTracker", 302);
        dictionary params = new dictionary();
        params.put("player", player);
    ...
    public void coa3ltactofficer_action_abortStoryFloraMission(obj_id player, obj_id npc)
    {
