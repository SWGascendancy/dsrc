...
public class corellia_droid_factory_druno_kener extends script.base_script
{
    ...
    public boolean corellia_droid_factory_druno_kener_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_droid_factory_druno_kener_condition_finishedLastQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "coreallia_droid_factory_bunker_destroy_factory");
    }
    public boolean corellia_droid_factory_druno_kener_condition_finishedTerminalQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "corellia_droid_bunker_activate_terminals");
    }
    public boolean corellia_droid_factory_druno_kener_condition_readyToCompleteTerminalQuest(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_droid_bunker_activate_terminals", "activateTerminalReturnToKener");
    }
    public boolean corellia_droid_factory_druno_kener_condition_terminalQuestActive(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "corellia_droid_bunker_activate_terminals");
    }
    public boolean corellia_droid_factory_druno_kener_condition_readyForTerminalQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_droid_factory_druno_kener_condition_readyForAntennaQuest(obj_id player, obj_id npc)
    {
        return !groundquests.isQuestActiveOrComplete(player, "corellia_droid_bunker_activate_antenna");
    }
    public boolean corellia_droid_factory_druno_kener_condition_readyToCompleteAntennaQuest(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_droid_bunker_activate_antenna", "returnAntenna");
    }
    public boolean corellia_droid_factory_druno_kener_condition_isAntennaActive(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "corellia_droid_bunker_activate_antenna");
    }
    public void corellia_droid_factory_druno_kener_action_sendTerminalFinishedSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "activateTerminalReturnToKener");
    }
    public void corellia_droid_factory_druno_kener_action_grantTerminalQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "corellia_droid_bunker_activate_terminals");
    }
    public void corellia_droid_factory_druno_kener_action_grantAntennaQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "corellia_droid_bunker_activate_antenna");
    }
    public void corellia_droid_factory_druno_kener_action_sendAntennaFinishedSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "returnAntenna");
    }
    public int corellia_droid_factory_druno_kener_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_droid_factory_druno_kener_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_droid_factory_druno_kener_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_droid_factory_druno_kener_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_droid_factory_druno_kener_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_droid_factory_druno_kener_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
