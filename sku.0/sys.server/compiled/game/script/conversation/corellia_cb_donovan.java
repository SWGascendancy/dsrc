...
public class corellia_cb_donovan extends script.base_script
{
    ...
    public boolean corellia_cb_donovan_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_cb_donovan_condition_findDonovan(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_cb_donovan_condition_donovanFree(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_cb_donovan_condition_onQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_cb_donovan_condition_shackleComplete(obj_id player, obj_id npc)
    {
    ...
    public void corellia_cb_donovan_action_sendPointerSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "cb_2_talkto_donovan");
        return;
    }
    public void corellia_cb_donovan_action_sendFinishSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "cb_2_donovan_escape");
        return;
    }
    public int corellia_cb_donovan_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_cb_donovan_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_cb_donovan_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
