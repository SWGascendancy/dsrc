...
public class corellia_coronet_daclif_gallamby extends script.base_script
{
    ...
    public boolean corellia_coronet_daclif_gallamby_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_coronet_daclif_gallamby_condition_presentSearchWrits(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_coronet_capitol_problems_diktat_search", "diktat_search_1");
    }
    public boolean corellia_coronet_daclif_gallamby_condition_diktatSearchActive(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_coronet_daclif_gallamby_condition_diktatSearchComplete(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_coronet_capitol_problems_diktat_search", "diktat_search_5");
    }
    public boolean corellia_coronet_daclif_gallamby_condition_thankfulDiktatActive(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_coronet_capitol_problems_thankful_diktat", "thankful_diktat_1");
    }
    public boolean corellia_coronet_daclif_gallamby_condition_thankfulDiktatComplete(obj_id player, obj_id npc)
    {
    ...
    public void corellia_coronet_daclif_gallamby_action_diktatSearchBegin(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "diktat_search_1");
    }
    public void corellia_coronet_daclif_gallamby_action_thankfulDiktatReward(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "thankful_diktat_1");
    }
    public void corellia_coronet_daclif_gallamby_action_diktatSearchEnd(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "diktat_search_5");
    }
    public int corellia_coronet_daclif_gallamby_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_daclif_gallamby_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_daclif_gallamby_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
