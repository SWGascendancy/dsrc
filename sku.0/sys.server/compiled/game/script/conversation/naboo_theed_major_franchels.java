...
public class naboo_theed_major_franchels extends script.base_script
{
    ...
    public boolean naboo_theed_major_franchels_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean naboo_theed_major_franchels_condition_completedAftermathQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "naboo_theed_terrorist_aftermath");
    }
    public boolean naboo_theed_major_franchels_condition_onAftermathQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "naboo_theed_terrorist_aftermath");
    }
    public boolean naboo_theed_major_franchels_condition_lastStepAftermathQuest(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "naboo_theed_terrorist_aftermath", "theed_terrorist_aftermath_07");
    }
    public boolean naboo_theed_major_franchels_condition_needsResponsibleQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_theed_major_franchels_condition_readyForAftermathQuest(obj_id player, obj_id npc)
    {
        return badge.hasBadge(player, "bdg_content_rsf_clearance_4");
    }
    public void naboo_theed_major_franchels_action_grantAftermath(obj_id player, obj_id npc)
    {
    ...
    public void naboo_theed_major_franchels_action_sendToSgtBragg(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "naboo_theed_goto_bragg");
    }
    public void naboo_theed_major_franchels_action_endGotoFranchels(obj_id player, obj_id npc)
    {
    ...
    public void naboo_theed_major_franchels_action_endAftermath(obj_id player, obj_id npc)
    {
    ...
    public int naboo_theed_major_franchels_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_major_franchels_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_major_franchels_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
