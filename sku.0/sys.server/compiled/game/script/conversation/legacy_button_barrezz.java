...
public class legacy_button_barrezz extends script.base_script
{
    ...
    public boolean legacy_button_barrezz_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean legacy_button_barrezz_condition_onButtonImp(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/legacy_button_imp_pt2");
        boolean OnTask = hasObjVar(player, "legacy.faction.imperialPath");
        return OnTask;
    }
    public boolean legacy_button_barrezz_condition_onButtonReb(obj_id player, obj_id npc)
    {
        boolean OnTask = hasObjVar(player, "legacy.faction.rebelPath");
        return OnTask;
    }
    public boolean legacy_button_barrezz_condition_failKickImp(obj_id player, obj_id npc)
    {
    ...
    public boolean legacy_button_barrezz_condition_failValarian(obj_id player, obj_id npc)
    {
    ...
    public boolean legacy_button_barrezz_condition_questButtonComplete(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/legacy_button_imp_pt2");
        boolean OnTask = questIsQuestComplete(questId1, player);
        return OnTask;
    }
    public boolean legacy_button_barrezz_condition_failTosche(obj_id player, obj_id npc)
    {
    ...
    public boolean legacy_button_barrezz_condition_failDarklighter(obj_id player, obj_id npc)
    {
    ...
    public boolean legacy_button_barrezz_condition_failSlicer(obj_id player, obj_id npc)
    {
    ...
    public boolean legacy_button_barrezz_condition_finishTogether(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedQuest(player, "legacy_together") || groundquests.hasCompletedQuest(player, "legacy_together_2"));
    }
    public boolean legacy_button_barrezz_condition_failWatto(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/legacy_button_imp_pt2");
    ...
    public boolean legacy_button_barrezz_condition_onButtonStart(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "quest/legacy_button_start");
    }
    public void legacy_button_barrezz_action_reGrantDarklighter(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "legacy_button_darklighter");
    }
    public void legacy_button_barrezz_action_reGrantKick(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "legacy_naboo_kick_imp");
    }
    public void legacy_button_barrezz_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void legacy_button_barrezz_action_grantSlicer(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "legacy_button_imp_pt2");
    }
    public void legacy_button_barrezz_action_signalTosche(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "legacy_button_jawatracks");
        setObjVar(player, "legacy.faction.imperialPath", 1);
    }
    public void legacy_button_barrezz_action_grantWatto(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "legacy_watto_pointer");
    }
    public void legacy_button_barrezz_action_signalGotoComplete(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "legacy_button_start_launch_e3");
    }
    public void legacy_button_barrezz_action_regrantTocshe(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "legacy_button_jawatracks");
    }
    public void legacy_button_barrezz_action_reGrantValarian(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "legacy_button_valarian_v2");
    }
    public int legacy_button_barrezz_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_button_barrezz_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_button_barrezz_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_button_barrezz_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_button_barrezz_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_button_barrezz_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_button_barrezz_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_button_barrezz_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_button_barrezz_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_button_barrezz_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_button_barrezz_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_button_barrezz_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
