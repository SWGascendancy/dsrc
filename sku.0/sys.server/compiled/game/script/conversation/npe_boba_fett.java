...
public class npe_boba_fett extends script.base_script
{
    ...
    public boolean npe_boba_fett_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_boba_fett_condition_isAtLeastLevel5(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_boba_fett_condition_wantsBH(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "npe_pointer_bounty_template");
    }
    public boolean npe_boba_fett_condition_questComplete(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_boba");
    }
    public boolean npe_boba_fett_condition_busy(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "npe_boba", 0) && npe_boba_fett_condition_isBHTemplate(player, npc));
    }
    public boolean npe_boba_fett_condition_finishedFinalTask(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_boba", "return");
    }
    public boolean npe_boba_fett_condition_isBHTemplate(obj_id player, obj_id npc)
    {
        return utils.isProfession(player, utils.BOUNTY_HUNTER);
    }
    public void npe_boba_fett_action_giveBHQuest(obj_id player, obj_id npc)
    {
    ...
    public void npe_boba_fett_action_giveReward(obj_id player, obj_id npc)
    {
    ...
    public void npe_boba_fett_action_giveSecretaryPointer(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_pointer_secretary");
    }
    public void npe_boba_fett_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void npe_boba_fett_action_leaveStation(obj_id player, obj_id npc)
    {
    ...
    public int npe_boba_fett_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_boba_fett_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_boba_fett_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_boba_fett_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_boba_fett_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_boba_fett_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_boba_fett_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_boba_fett_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_boba_fett_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_boba_fett_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
