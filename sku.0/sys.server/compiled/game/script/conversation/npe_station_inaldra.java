...
public class npe_station_inaldra extends script.base_script
{
    ...
    public boolean npe_station_inaldra_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_station_inaldra_condition_playerOnQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_station_inaldra_condition_playerOnSecondInaldraStep(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_main_quest", "talktoinaldra2");
    }
    public boolean npe_station_inaldra_condition_playerCompletedFirstQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "npe_main_quest", "talktoinaldra2");
    }
    public boolean npe_station_inaldra_condition_playeronFirstInaldraStep(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_main_quest", "talktoinaldra1");
    }
    public boolean npe_station_inaldra_condition_playerOnHanStep(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_main_quest", "talktohan1");
    }
    public boolean npe_station_inaldra_condition_main2Inaldra1(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_main_quest_2", "inaldra1");
    }
    public boolean npe_station_inaldra_condition_main2Inaldra2(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_main_quest_2", "inaldra2");
    }
    public boolean npe_station_inaldra_condition_playerOnMainQuest2(obj_id player, obj_id npc)
    {
        return (groundquests.isQuestActive(player, "npe_main_quest_2") && groundquests.hasCompletedTask(player, "npe_main_quest_2", "inaldra1"));
    }
    public boolean npe_station_inaldra_condition_playerCompletedSecondQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_main_quest_2");
    }
    public void npe_station_inaldra_action_signalInaldra1(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_main_inaldra1");
    }
    public void npe_station_inaldra_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void npe_station_inaldra_action_signalInaldra2(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_main_inaldra2");
    }
    public void npe_station_inaldra_action_signaMain2Inaldra1(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_main2_inaldra_open");
    }
    public void npe_station_inaldra_action_signaMain2Inaldra2(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_main2_inaldra_final");
    }
    public int npe_station_inaldra_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_inaldra_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_inaldra_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_inaldra_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_inaldra_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_inaldra_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_inaldra_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_inaldra_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_inaldra_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_inaldra_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_inaldra_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_inaldra_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_inaldra_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_inaldra_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_inaldra_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_inaldra_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_inaldra_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_inaldra_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_station_inaldra_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
