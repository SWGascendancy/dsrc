...
public class ep3_trandoshan_lesnorr extends script.base_script
{
    ...
    public boolean ep3_trandoshan_lesnorr_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_trandoshan_lesnorr_condition_canTakeSpaceMission(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_trandoshan_lesnorr_condition_hasFailedMission(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_trandoshan_lesnorr_condition_hasRecievedReward(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_trandoshan_lesnorr_condition_hasWonMission(obj_id player, obj_id npc)
    {
        return (space_quest.hasWonQuestRecursive(player, "convoy", "ep3_trando_lesnorr"));
    }
    public boolean ep3_trandoshan_lesnorr_condition_isOnMission(obj_id player, obj_id npc)
    {
        return (space_quest.hasQuest(player));
    }
    public void ep3_trandoshan_lesnorr_action_grantMission(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "convoy", "ep3_trando_lesnorr");
    }
    public void ep3_trandoshan_lesnorr_action_grantReward(obj_id player, obj_id npc)
    {
        space_quest.giveReward(player, "convoy", "ep3_trando_lesnorr", 10000);
    }
    public int ep3_trandoshan_lesnorr_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_lesnorr_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_lesnorr_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_lesnorr_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_lesnorr_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
