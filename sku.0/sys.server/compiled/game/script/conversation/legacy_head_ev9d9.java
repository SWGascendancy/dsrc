...
public class legacy_head_ev9d9 extends script.base_script
{
    ...
    public boolean legacy_head_ev9d9_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean legacy_head_ev9d9_condition_failedRunaways(obj_id player, obj_id npc)
    {
    ...
    public boolean legacy_head_ev9d9_condition_failedRod(obj_id player, obj_id npc)
    {
    ...
    public boolean legacy_head_ev9d9_condition_failedRemodel(obj_id player, obj_id npc)
    {
    ...
    public boolean legacy_head_ev9d9_condition_onRunawayGround(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "legacy_head_runaway");
    }
    public boolean legacy_head_ev9d9_condition_onRods(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/legacy_head_rod");
        boolean OnTask = (questIsQuestActive(questId1, player));
        return OnTask;
    }
    public boolean legacy_head_ev9d9_condition_onRemodel(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/legacy_head_remodel");
        boolean OnTask = (questIsQuestActive(questId1, player));
        return OnTask;
    }
    public boolean legacy_head_ev9d9_condition_failedReward(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/legacy_head_remodel");
    ...
    public boolean legacy_head_ev9d9_condition_onStartEV(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/legacy_head_start");
    ...
    public boolean legacy_head_ev9d9_condition_hasPilotSkill(obj_id player, obj_id npc)
    {
    ...
    public boolean legacy_head_ev9d9_condition_onRemodelReward(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/legacy_head_remodel");
    ...
    public boolean legacy_head_ev9d9_condition_failedR3Space(obj_id player, obj_id npc)
    {
    ...
    public boolean legacy_head_ev9d9_condition_onSpaceQuests(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/legacy_head_space");
        boolean OnTask = (questIsQuestActive(questId1, player));
        return OnTask;
    }
    public boolean legacy_head_ev9d9_condition_hasHead(obj_id player, obj_id npc)
    {
    ...
    public boolean legacy_head_ev9d9_condition_remodelComplete(obj_id player, obj_id npc)
    {
    ...
    public boolean legacy_head_ev9d9_condition_winR3Space(obj_id player, obj_id npc)
    {
    ...
    public boolean legacy_head_ev9d9_condition_endEV9D9(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "legacy_together_2");
    }
    public boolean legacy_head_ev9d9_condition_QuestComplete(obj_id player, obj_id npc)
    {
    ...
    public boolean legacy_head_ev9d9_condition_rewardQuestground(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "legacy_head_runaway", "legacy_head_runaway_e91");
    }
    public void legacy_head_ev9d9_action_spaceQuestGranted(obj_id player, obj_id npc)
    {
    ...
    public void legacy_head_ev9d9_action_r3SpaceCompletedSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "legacy_head_space_launch_e3");
    }
    public void legacy_head_ev9d9_action_grantR3(obj_id player, obj_id npc)
    {
    ...
    public void legacy_head_ev9d9_action_regrantGround(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "legacy_head_runaway");
        return;
    }
    public void legacy_head_ev9d9_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void legacy_head_ev9d9_action_regrantSpace(obj_id player, obj_id npc)
    {
        groundquests.clearQuest(player, "legacy_head_space");
        space_quest.clearQuestFlags(player, "assassinate", "tatooine_legacy_head_runaway1_space");
        space_quest.clearQuestFlags(player, "assassinate", "tatooine_legacy_head_runaway2_space");
    ...
    public void legacy_head_ev9d9_action_grantReward(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "legacy_head_ground");
    }
    public void legacy_head_ev9d9_action_rewardRemodel(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        groundquests.sendSignal(player, "legacy_head_remodel_launch_e8");
    }
    public void legacy_head_ev9d9_action_foundev9d9(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "legacy_head_start_launch_e2");
    }
    public void legacy_head_ev9d9_action_regrantTogether(obj_id player, obj_id npc)
    {
    ...
    public void legacy_head_ev9d9_action_regrantTogetherWithNewHead(obj_id player, obj_id npc)
    {
        groundquests.clearQuest(player, "legacy_together");
        groundquests.clearQuest(player, "legacy_together_2");
        groundquests.grantQuest(player, "legacy_together_2");
    ...
    public void legacy_head_ev9d9_action_grantTogetherQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "legacy_together_2");
    }
    public void legacy_head_ev9d9_action_spaceRewardSignal(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        groundquests.sendSignal(player, "legacy_head_ground_launch_e92");
    }
    public void legacy_head_ev9d9_action_grantRunawayGround(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "legacy_head_runaway");
        return;
    }
    public void legacy_head_ev9d9_action_grantShock(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "legacy_head_rod");
    }
    public void legacy_head_ev9d9_action_grantRemodel(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "legacy_head_remodel");
    }
    public void legacy_head_ev9d9_action_cleanOldQuests(obj_id player, obj_id npc)
    {
    ...
    public void legacy_head_ev9d9_action_givePainBolts(obj_id player, obj_id npc)
    {
    ...
    public int legacy_head_ev9d9_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_head_ev9d9_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_head_ev9d9_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_head_ev9d9_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_head_ev9d9_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_head_ev9d9_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_head_ev9d9_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_head_ev9d9_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_head_ev9d9_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_head_ev9d9_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_head_ev9d9_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_head_ev9d9_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_head_ev9d9_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_139"))
        {
            if (legacy_head_ev9d9_condition_hasPilotSkill(player, npc))
    ...
    public int legacy_head_ev9d9_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_head_ev9d9_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_head_ev9d9_handleBranch30(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_head_ev9d9_handleBranch32(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_head_ev9d9_handleBranch34(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_head_ev9d9_handleBranch36(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_head_ev9d9_handleBranch37(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_head_ev9d9_handleBranch39(obj_id player, obj_id npc, string_id response)
    {
