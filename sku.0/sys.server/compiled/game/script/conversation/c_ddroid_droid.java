...
public class c_ddroid_droid extends script.base_script
{
    ...
    public boolean c_ddroid_droid_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_ddroid_droid_condition_playernotdoneQ2(obj_id player, obj_id npc)
    {
    ...
    public boolean c_ddroid_droid_condition_quest2complete(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/c_darndroid2");
        return questIsTaskActive(questId, 6, player);
    }
    public boolean c_ddroid_droid_condition_memwiped(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/c_darndroid2");
        return questIsQuestComplete(questId, player);
    }
    public boolean c_ddroid_droid_condition_playerhasquest(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/c_darndroid1");
        boolean onQuest = questIsQuestActive(questId1, player) || questIsQuestComplete(questId1, player);
        return onQuest;
    }
    public void c_ddroid_droid_action_givequest1(obj_id player, obj_id npc)
    {
    ...
    public void c_ddroid_droid_action_faceplayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void c_ddroid_droid_action_memwipedroid(obj_id player, obj_id npc)
    {
    ...
    public int c_ddroid_droid_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_ddroid_droid_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_ddroid_droid_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_ddroid_droid_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_ddroid_droid_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_ddroid_droid_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_ddroid_droid_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_ddroid_droid_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_ddroid_droid_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_ddroid_droid_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_ddroid_droid_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
