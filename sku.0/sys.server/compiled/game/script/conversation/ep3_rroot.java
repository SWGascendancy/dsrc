...
public class ep3_rroot extends script.base_script
{
    ...
    public boolean ep3_rroot_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_rroot_condition_wasSentByKymayrr(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_kymayrr_rescue_rroot", "taskFindRroot");
    }
    public boolean ep3_rroot_condition_hasTheCode(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_kymayrr_rescue_rroot", "taskReturnToRroot");
    }
    public boolean ep3_rroot_condition_isWookieeNub(obj_id player, obj_id npc)
    {
        return utils.canSpeakWookiee(player, npc);
    }
    public void ep3_rroot_action_goGetCodeSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "signalFindRroot");
    }
    public void ep3_rroot_action_sendPatrolSignal(obj_id player, obj_id npc)
    {
    ...
    public void ep3_rroot_action_SchoolWookieeNub(obj_id player, obj_id npc)
    {
        utils.emoteWookieeConfusion(player, npc);
    }
    public int ep3_rroot_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_rroot_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_rroot_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_rroot_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
