...
public class bestine_rumor08 extends script.base_script
{
    ...
    public boolean bestine_rumor08_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean bestine_rumor08_condition_nonoffice(obj_id player, obj_id npc)
    {
        return hasObjVar(npc, "bestine.electionEnded");
    }
    public void bestine_rumor08_action__defaultAction(obj_id player, obj_id npc)
    {
    }
