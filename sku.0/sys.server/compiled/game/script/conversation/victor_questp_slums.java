...
public class victor_questp_slums extends script.base_script
{
    ...
    public boolean victor_questp_slums_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean victor_questp_slums_condition_CampObjCheck(obj_id player, obj_id npc)
    {
    ...
    public boolean victor_questp_slums_condition_alreadyHasEvidence(obj_id player, obj_id npc)
    {
        return utils.playerHasItemByTemplate(player, "object/tangible/loot/quest/victor_questp_testimony.iff");
    }
    public boolean victor_questp_slums_condition_hasNoRoomObjvar(obj_id player, obj_id npc)
    {
        if (hasObjVar(npc, "bestine.electionStarted"))
        {
            int electionNum = getIntObjVar(npc, "bestine.electionStarted");
    ...
    public boolean victor_questp_slums_condition_nonoffice(obj_id player, obj_id npc)
    {
        return hasObjVar(npc, "bestine.electionEnded");
    }
    public boolean victor_questp_slums_condition_noIventorySpace(obj_id player, obj_id npc)
    {
    ...
    public void victor_questp_slums_action__defaultAction(obj_id player, obj_id npc)
    {
    }
    public void victor_questp_slums_action_Noroom7(obj_id player, obj_id npc)
    {
        setObjVar(player, "bestine.noroom7", true);
    }
    public void victor_questp_slums_action_giveTestimony(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "bestine.victor_slums_noroom"))
        {
