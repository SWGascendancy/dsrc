...
public class padawan_the_ring_01 extends script.base_script
{
    ...
    public boolean padawan_the_ring_01_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean padawan_the_ring_01_condition_acceptedQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean padawan_the_ring_01_condition_targetWasEliminated(obj_id player, obj_id npc)
    {
        obj_id trialPlayer = getObjIdObjVar(npc, jedi_trials.PADAWAN_TRIAL_PLAYER_OBJVAR);
        if (player == trialPlayer)
        {
    ...
    public boolean padawan_the_ring_01_condition_targetWasSpokenTo(obj_id player, obj_id npc)
    {
        obj_id trialPlayer = getObjIdObjVar(npc, jedi_trials.PADAWAN_TRIAL_PLAYER_OBJVAR);
        if (player == trialPlayer)
        {
    ...
    public boolean padawan_the_ring_01_condition_isTrialPlayer(obj_id player, obj_id npc)
    {
        obj_id trialPlayer = getObjIdObjVar(npc, jedi_trials.PADAWAN_TRIAL_PLAYER_OBJVAR);
        if (player == trialPlayer)
        {
    ...
    public boolean padawan_the_ring_01_condition_completedSuccess(obj_id player, obj_id npc)
    {
        obj_id trialPlayer = getObjIdObjVar(npc, jedi_trials.PADAWAN_TRIAL_PLAYER_OBJVAR);
        if (player == trialPlayer)
        {
    ...
    public void padawan_the_ring_01_action_questFailure(obj_id player, obj_id npc)
    {
        setObjVar(npc, "padawan_trials.playerFailed", true);
        messageTo(player, "handleQuestFailure", null, 1, false);
        return;
    }
    public void padawan_the_ring_01_action_questSuccess(obj_id player, obj_id npc)
    {
        setObjVar(npc, "padawan_trials.playerSucceeded", true);
        messageTo(player, "handleTrialComplete", null, 1, false);
        return;
    }
    public void padawan_the_ring_01_action_sendToNextNpc(obj_id player, obj_id npc)
    {
    ...
    public int padawan_the_ring_01_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int padawan_the_ring_01_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int padawan_the_ring_01_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int padawan_the_ring_01_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int padawan_the_ring_01_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int padawan_the_ring_01_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int padawan_the_ring_01_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int padawan_the_ring_01_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int padawan_the_ring_01_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int padawan_the_ring_01_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int padawan_the_ring_01_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int padawan_the_ring_01_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int padawan_the_ring_01_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int padawan_the_ring_01_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int padawan_the_ring_01_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int padawan_the_ring_01_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int padawan_the_ring_01_handleBranch30(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int padawan_the_ring_01_handleBranch31(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int padawan_the_ring_01_handleBranch32(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int padawan_the_ring_01_handleBranch35(obj_id player, obj_id npc, string_id response)
    {
