...
public class nym_arena_referee extends script.base_script
{
    ...
    public boolean nym_arena_referee_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean nym_arena_referee_condition_hasFirstArenaTask(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "u16_nym_themepark_nym_arena", "hasFirstArenaFight");
    }
    public boolean nym_arena_referee_condition_hasSecondArenaTask(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "u16_nym_themepark_nym_arena", "hasSecondArenaFight");
    }
    public boolean nym_arena_referee_condition_hasThirdArenaTask(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "u16_nym_themepark_nym_arena", "hasThirdArenaFight");
    }
    public boolean nym_arena_referee_condition_hasFourthArenaTask(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "u16_nym_themepark_nym_arena", "hasFourthArenaFight");
    }
    public boolean nym_arena_referee_condition_hasFifthAreanaTask(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "u16_nym_themepark_nym_arena", "hasFifthArenaFight");
    }
    public boolean nym_arena_referee_condition_hasCompletedArenaTask(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean nym_arena_referee_condition_wave_event_active(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        int wave = utils.getIntScriptVar(npc, "waveEventCurrentWave");
        return wave > 0;
    }
    public void nym_arena_referee_action_spawnOpponent(obj_id player, obj_id npc)
    {
        dictionary webster = new dictionary();
        webster.put("player", player);
        messageTo(npc, "waveEventControllerNPCStart", webster, 0, false);
    }
    public int nym_arena_referee_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_arena_referee_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_arena_referee_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_arena_referee_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_arena_referee_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
