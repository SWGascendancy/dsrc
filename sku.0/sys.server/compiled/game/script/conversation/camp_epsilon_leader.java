...
public class camp_epsilon_leader extends script.base_script
{
    ...
    public boolean camp_epsilon_leader_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean camp_epsilon_leader_condition_hasRadio(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "outbreak_radio_delivery_03", "findEpsilonContact");
    }
    public boolean camp_epsilon_leader_condition_hasPerfume(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "outbreak_perfume_hidden_content", "hasPerfume");
    }
    public void camp_epsilon_leader_action_deliverRadioSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "hasFoundEpsilonContact");
    }
    public void camp_epsilon_leader_action_hasDeliveredPerfume(obj_id player, obj_id npc)
    {
    ...
    public int camp_epsilon_leader_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int camp_epsilon_leader_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int camp_epsilon_leader_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int camp_epsilon_leader_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int camp_epsilon_leader_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
