...
public class emp_day_reb_bartender extends script.base_script
{
    ...
    public boolean emp_day_reb_bartender_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean emp_day_reb_bartender_condition_isReb(obj_id player, obj_id npc)
    {
    ...
    public boolean emp_day_reb_bartender_condition_isImp(obj_id player, obj_id npc)
    {
    ...
    public boolean emp_day_reb_bartender_condition_pastTask1(obj_id player, obj_id npc)
    {
    ...
    public void emp_day_reb_bartender_action_giveQuest(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/emp_day_rebel");
        int task1 = groundquests.getTaskId(questId, "converseContact");
    ...
    public int emp_day_reb_bartender_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_reb_bartender_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_reb_bartender_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_reb_bartender_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_reb_bartender_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_reb_bartender_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_reb_bartender_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_reb_bartender_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_reb_bartender_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_249"))
        {
            if (emp_day_reb_bartender_condition__defaultCondition(player, npc))
    ...
    public int emp_day_reb_bartender_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
