...
public class tatooine_eisley_nogri extends script.base_script
{
    ...
    public boolean tatooine_eisley_nogri_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tatooine_eisley_nogri_condition_tdcOnTask2(obj_id player, obj_id npc)
    {
    ...
    public boolean tatooine_eisley_nogri_condition_tdcQuestComplete(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_eisley_tdc");
        boolean OnTask = (questIsQuestComplete(questId1, player));
        return OnTask;
    }
    public void tatooine_eisley_nogri_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void tatooine_eisley_nogri_action_signalNogriDelivered(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tat_eisley_tdc_e3");
    }
    public int tatooine_eisley_nogri_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_nogri_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_nogri_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_nogri_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_nogri_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_23"))
        {
            if (tatooine_eisley_nogri_condition__defaultCondition(player, npc))
    ...
    public int tatooine_eisley_nogri_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_nogri_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_nogri_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_nogri_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
