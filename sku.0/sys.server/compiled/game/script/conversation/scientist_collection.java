...
public class scientist_collection extends script.base_script
{
    ...
    public boolean scientist_collection_condition_ifNothing(obj_id player, obj_id npc)
    {
    ...
    public boolean scientist_collection_condition_playerAlreadyQuestioned(obj_id player, obj_id npc)
    {
    ...
    public void scientist_collection_action_awardSlotOne(obj_id player, obj_id npc)
    {
    ...
    public void scientist_collection_action_awardSlotTwo(obj_id player, obj_id npc)
    {
    ...
    public void scientist_collection_action_awardSlotThree(obj_id player, obj_id npc)
    {
    ...
    public void scientist_collection_action_awardSlotFour(obj_id player, obj_id npc)
    {
    ...
    public void scientist_collection_action_awardSlotFive(obj_id player, obj_id npc)
    {
    ...
    public void scientist_collection_action_awardSlotSix(obj_id player, obj_id npc)
    {
    ...
    public void scientist_collection_action_awardSlotSeven(obj_id player, obj_id npc)
    {
    ...
    public void scientist_collection_action_awardSlotEight(obj_id player, obj_id npc)
    {
    ...
    public void scientist_collection_action_awardSlotNine(obj_id player, obj_id npc)
    {
    ...
    public void scientist_collection_action_awardSlotTen(obj_id player, obj_id npc)
    {
    ...
    public int scientist_collection_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int scientist_collection_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int scientist_collection_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
