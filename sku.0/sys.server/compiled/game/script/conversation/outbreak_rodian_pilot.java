...
public class outbreak_rodian_pilot extends script.base_script
{
    ...
    public boolean outbreak_rodian_pilot_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean outbreak_rodian_pilot_condition_hasCollectionSlotAlpha(obj_id player, obj_id npc)
    {
        return hasCompletedCollectionSlot(player, "exp_icon_deathtroopers_camp_alpha");
    }
    public boolean outbreak_rodian_pilot_condition_has100Credits(obj_id player, obj_id npc)
    {
        return money.hasFunds(player, money.MT_TOTAL, 100);
    }
    public boolean outbreak_rodian_pilot_condition_hasCollectionSlotEpsilon(obj_id player, obj_id npc)
    {
        return hasCompletedCollectionSlot(player, "exp_icon_deathtroopers_camp_epsilon");
    }
    public boolean outbreak_rodian_pilot_condition_hasCollectionSlotDelta(obj_id player, obj_id npc)
    {
        return hasCompletedCollectionSlot(player, "exp_icon_deathtroopers_camp_delta");
    }
    public boolean outbreak_rodian_pilot_condition_hasCollectionSlotBeta(obj_id player, obj_id npc)
    {
        return hasCompletedCollectionSlot(player, "exp_icon_deathtroopers_camp_beta");
    }
    public boolean outbreak_rodian_pilot_condition_hasCollectionSlotGamma(obj_id player, obj_id npc)
    {
        return hasCompletedCollectionSlot(player, "exp_icon_deathtroopers_camp_gamma");
    }
    public boolean outbreak_rodian_pilot_condition_has500Credits(obj_id player, obj_id npc)
    {
        return money.hasFunds(player, money.MT_TOTAL, 500);
    }
    public boolean outbreak_rodian_pilot_condition_has1000Credits(obj_id player, obj_id npc)
    {
        return money.hasFunds(player, money.MT_TOTAL, 1000);
    }
    public boolean outbreak_rodian_pilot_condition_has1500Credits(obj_id player, obj_id npc)
    {
        return money.hasFunds(player, money.MT_TOTAL, 1500);
    }
    public boolean outbreak_rodian_pilot_condition_has2000Credits(obj_id player, obj_id npc)
    {
        return money.hasFunds(player, money.MT_TOTAL, 2000);
    }
    public boolean outbreak_rodian_pilot_condition_hasFrequentFlyerBadge(obj_id player, obj_id npc)
    {
        return hasCompletedCollection(player, "deathtrooper_rodian_frequent_flyer");
    }
    public boolean outbreak_rodian_pilot_condition_isEligibleForTrans(obj_id player, obj_id npc)
    {
    ...
    public void outbreak_rodian_pilot_action_dropOffAlphaForCredits(obj_id player, obj_id npc)
    {
    ...
    public void outbreak_rodian_pilot_action_dropOffBetaForCredits(obj_id player, obj_id npc)
    {
    ...
    public void outbreak_rodian_pilot_action_dropOffGammaForCredits(obj_id player, obj_id npc)
    {
    ...
    public void outbreak_rodian_pilot_action_dropOffDeltaForCredits(obj_id player, obj_id npc)
    {
    ...
    public void outbreak_rodian_pilot_action_dropOffEpsilonForCredits(obj_id player, obj_id npc)
    {
    ...
    public void outbreak_rodian_pilot_action_AlphaFree(obj_id player, obj_id npc)
    {
        outbreak_rodian_pilot_action_applyBuffs(player, npc);
        warpPlayer(player, "dathomir", -5925, 559, -6667, null, -5925, 559, -6667, null, true);
    }
    public void outbreak_rodian_pilot_action_EpsilonFree(obj_id player, obj_id npc)
    {
        outbreak_rodian_pilot_action_applyBuffs(player, npc);
        warpPlayer(player, "dathomir", -7448, 570, -7342, null, -7448, 570, -7342, null, true);
    }
    public void outbreak_rodian_pilot_action_DeltaFree(obj_id player, obj_id npc)
    {
        outbreak_rodian_pilot_action_applyBuffs(player, npc);
        warpPlayer(player, "dathomir", -7145, 562, -6922, null, -7145, 562, -6922, null, true);
    }
    public void outbreak_rodian_pilot_action_GammaFree(obj_id player, obj_id npc)
    {
        outbreak_rodian_pilot_action_applyBuffs(player, npc);
        warpPlayer(player, "dathomir", -6824, 553, -6456, null, -6824, 553, -6456, null, true);
    }
    public void outbreak_rodian_pilot_action_BetaFree(obj_id player, obj_id npc)
    {
        outbreak_rodian_pilot_action_applyBuffs(player, npc);
        warpPlayer(player, "dathomir", -6283, 561, -7521, null, -6283, 561, -7521, null, true);
    }
    public void outbreak_rodian_pilot_action_applyBuffs(obj_id player, obj_id npc)
    {
    ...
    public int outbreak_rodian_pilot_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_rodian_pilot_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_rodian_pilot_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_rodian_pilot_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_rodian_pilot_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_rodian_pilot_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_rodian_pilot_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_rodian_pilot_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_rodian_pilot_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
