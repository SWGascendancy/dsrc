...
public class coa3wtactofficer extends script.base_script
{
    ...
    public boolean coa3wtactofficer_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean coa3wtactofficer_condition_extraFloraMissionActive(obj_id player, obj_id npc)
    {
        return (getIntObjVar(player, "coa3.extraFlora") == -1);
    }
    public boolean coa3wtactofficer_condition_hasWonStory(obj_id player, obj_id npc)
    {
        return (badge.hasBadge(player, "event_coa3_rebel"));
    }
    public boolean coa3wtactofficer_condition_storyFloraMissionComplete(obj_id player, obj_id npc)
    {
        return (getIntObjVar(player, "coa3.convTracker") < -302);
    }
    public boolean coa3wtactofficer_condition_talkedToCoordinator(obj_id player, obj_id npc)
    {
        return (getIntObjVar(player, "coa3.convTracker") == -301);
    }
    public boolean coa3wtactofficer_condition_storyFloraMissionActive(obj_id player, obj_id npc)
    {
        return (getIntObjVar(player, "coa3.convTracker") == -302);
    }
    public void coa3wtactofficer_action_refreshExtraFloraMission(obj_id player, obj_id npc)
    {
    ...
    public void coa3wtactofficer_action_abortExtraFloraMission(obj_id player, obj_id npc)
    {
    ...
    public void coa3wtactofficer_action_getExtraFloraMission(obj_id player, obj_id npc)
    {
    ...
    public void coa3wtactofficer_action_getStoryFloraMission(obj_id player, obj_id npc)
    {
    ...
    public void coa3wtactofficer_action_refreshStoryFloraMission(obj_id player, obj_id npc)
    {
        setObjVar(player, "coa3.convTracker", -302);
        dictionary params = new dictionary();
        params.put("player", player);
    ...
    public void coa3wtactofficer_action_abortStoryFloraMission(obj_id player, obj_id npc)
    {
    ...
    public int coa3wtactofficer_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int coa3wtactofficer_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int coa3wtactofficer_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int coa3wtactofficer_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int coa3wtactofficer_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
