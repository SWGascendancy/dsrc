...
public class menagerie_bioll extends script.base_script
{
    ...
    public boolean menagerie_bioll_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean menagerie_bioll_condition_hasVarBiollQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean menagerie_bioll_condition_needsNewQuestVar(obj_id player, obj_id npc)
    {
        if (utils.hasScriptVar(player, "varMenagerieQuestNum"))
        {
            return false;
    ...
    public boolean menagerie_bioll_condition_hasVarNonBiollQuest(obj_id player, obj_id npc)
    {
        if (utils.hasScriptVar(player, "varMenagerieQuestNum"))
        {
            int menagerieQuestNum = utils.getIntScriptVar(player, "varMenagerieQuestNum");
    ...
    public void menagerie_bioll_action_FaceToAndAssignQuestVar(obj_id player, obj_id npc)
    {
        int menagerieQuestNum = rand(1, 56);
        utils.setScriptVar(player, "varMenagerieQuestNum", menagerieQuestNum);
    }
    public void menagerie_bioll_action_faceTo(obj_id player, obj_id npc)
    {
    }
    public int menagerie_bioll_tokenDI_varMenagerieQuest(obj_id player, obj_id npc)
    {
    ...
    public int menagerie_bioll_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int menagerie_bioll_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int menagerie_bioll_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
