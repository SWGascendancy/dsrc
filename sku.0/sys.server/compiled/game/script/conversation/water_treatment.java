...
public class water_treatment extends script.base_script
{
    ...
    public boolean water_treatment_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean water_treatment_condition_hasInitialQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean water_treatment_condition_isFinishingFirstQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean water_treatment_condition_isFinishingSecondQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean water_treatment_condition_isFinishingThirdQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean water_treatment_condition_hasFinishedAllQuests(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isQuestActiveOrComplete(player, "u16_nym_return_townsperson");
    }
    public boolean water_treatment_condition_hasFirstQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean water_treatment_condition_hasSecondQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean water_treatment_condition_hasThirdQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean water_treatment_condition_hasNotFixedMixer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "u16_nym_themepark_repair_mixing_chamber", "fixMixingChamber");
    }
    public boolean water_treatment_condition_hasNotFixedSediment(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "u16_nym_themepark_under_pressure", "fixSedimentation");
    }
    public boolean water_treatment_condition_hasNotFixedFlocculation(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "u16_nym_themepark_repair_flocculation_chamber", "fixFlocculation");
    }
    public void water_treatment_action_signalMeetingFirstTime(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "hasFoundFiltrationGuy");
    }
    public void water_treatment_action_giveFirstQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "u16_nym_themepark_parts_1");
    }
    public void water_treatment_action_giveSecondQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "u16_nym_themepark_parts_2");
    }
    public void water_treatment_action_giveThirdQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "u16_nym_themepark_parts_3");
    }
    public void water_treatment_action_finishUpMixingChamber(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "hasReturnedChemical");
    }
    public void water_treatment_action_grantReturnTownPerson(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "u16_nym_return_townsperson");
    }
    public void water_treatment_action_finishUpFloc(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "hasReturnedRegulator");
    }
    public void water_treatment_action_finishUpPressure(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "hasReturnedValves");
    }
    public int water_treatment_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int water_treatment_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int water_treatment_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int water_treatment_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int water_treatment_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int water_treatment_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int water_treatment_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int water_treatment_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int water_treatment_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int water_treatment_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int water_treatment_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int water_treatment_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
