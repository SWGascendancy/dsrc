...
public class collections_ice_cream_part_one extends script.base_script
{
    ...
    public boolean collections_ice_cream_part_one_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean collections_ice_cream_part_one_condition_hasActiveTask(obj_id player, obj_id npc)
    {
    ...
    public void collections_ice_cream_part_one_action_signalNextTask(obj_id player, obj_id npc)
    {
        modifyCollectionSlotValue(player, "col_fried_icecream_part_01", 1);
        groundquests.sendSignal(player, "meet_hunde_decan");
    }
    public int collections_ice_cream_part_one_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int collections_ice_cream_part_one_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int collections_ice_cream_part_one_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
