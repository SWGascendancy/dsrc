...
public class nexus_travel_away extends script.base_script
{
    ...
    public boolean nexus_travel_away_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean nexus_travel_away_condition_hasFoundAurilia(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "travel_found");
    }
    public boolean nexus_travel_away_condition_canAffordPay(obj_id player, obj_id npc)
    {
        return money.hasFunds(player, money.MT_TOTAL, township.TRAVEL_COST);
    }
    public void nexus_travel_away_action_travelFromAurilia(obj_id player, obj_id npc)
    {
        township.giveTravelListFromAurilia(player, npc);
    }
    public void nexus_travel_away_action_grantFoundAurilia(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "travel_found");
    }
    public int nexus_travel_away_tokenDI_travelCost(obj_id player, obj_id npc)
    {
        return township.TRAVEL_COST;
    }
    public int nexus_travel_away_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nexus_travel_away_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nexus_travel_away_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nexus_travel_away_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nexusTravelFromAurilliaSub(obj_id self, dictionary params)
    {
    ...
    public int nexusTravelFromAurillia(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
