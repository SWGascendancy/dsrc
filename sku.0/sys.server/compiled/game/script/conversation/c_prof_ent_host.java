...
public class c_prof_ent_host extends script.base_script
{
    ...
    public boolean c_prof_ent_host_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_prof_ent_host_condition_playeronquest(obj_id player, obj_id npc)
    {
    ...
    public void c_prof_ent_host_action_faceAndMood(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        ai_lib.setMood(npc, chat.MOOD_WARM);
    }
    public int c_prof_ent_host_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
