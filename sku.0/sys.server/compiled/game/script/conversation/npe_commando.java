...
public class npe_commando extends script.base_script
{
    ...
    public boolean npe_commando_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_commando_condition_wantsCommando(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_commando_condition_isCommandoTemplate(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_commando_condition_fromBrawler(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_commando_tracker", "done");
    }
    public boolean npe_commando_condition_finishFinalTask(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_commando", "final_return");
    }
    public boolean npe_commando_condition_finishedFirstTask(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_commando", "return1");
    }
    public boolean npe_commando_condition_finishedSecondTask(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_commando", "return2");
    }
    public boolean npe_commando_condition_isOnTask(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_commando_condition_defusedBomb(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_commando_condition_finishedAll(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_commando");
    }
    public boolean npe_commando_condition_hasFinishedInaldraLt(obj_id player, obj_id npc)
    {
    ...
    public void npe_commando_action_giveInaldraPointer(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_pointer_secretary");
    }
    public void npe_commando_action_giveCommandoQuest(obj_id player, obj_id npc)
    {
    ...
    public void npe_commando_action_giveFirstSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_grenade_done");
    }
    public void npe_commando_action_giveSecondSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_datapad_done");
    }
    public void npe_commando_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void npe_commando_action_giveReward(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "final_return");
        setObjVar(player, "npe.finishedTemplate", 1);
    }
    public void npe_commando_action_giveHanPointer(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_job_pointer_han");
    }
    public int npe_commando_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_commando_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_commando_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_commando_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_commando_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_commando_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_commando_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_commando_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_commando_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_commando_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
