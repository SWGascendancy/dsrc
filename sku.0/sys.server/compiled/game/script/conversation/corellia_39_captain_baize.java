...
public class corellia_39_captain_baize extends script.base_script
{
    ...
    public boolean corellia_39_captain_baize_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_39_captain_baize_condition_assumedIdentityContinuedA(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_39_captain_baize_condition_assumedIdentityComplete(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_39_captain_baize_condition_assumedIdentityFailed(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "corellia_39_chirq_council_02_failed");
    }
    public boolean corellia_39_captain_baize_condition_assumedIdentityContinuedB(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "corellia_39_chirq_council_02");
    }
    public boolean corellia_39_captain_baize_condition_movingUpSpiceActive(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_39_captain_baize_condition_movingUpSpiceComplete(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_39_chirq_council_03", "chirq_council_03_03");
    }
    public boolean corellia_39_captain_baize_condition_readyFor39(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_39_captain_baize_condition_movingUpCoverUpA(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_39_captain_baize_condition_movingUpCoverUpB(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "corellia_39_chirq_council_03");
    }
    public boolean corellia_39_captain_baize_condition_movingUpCorsecTerminal(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_39_chirq_council_03", "chirq_council_03_08");
    }
    public boolean corellia_39_captain_baize_condition_AllCompleted(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "corellia_39_chirq_council_04");
    }
    public boolean corellia_39_captain_baize_condition_seekCouncilActive(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "corellia_39_chirq_council_01");
    }
    public boolean corellia_39_captain_baize_condition_seekCouncilComplete(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_39_captain_baize_condition_assumedIdentityTrinsActive(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_39_captain_baize_condition_assumedIdentityTrinsComplete(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_39_chirq_council_02", "chirq_council_02_03");
    }
    public boolean corellia_39_captain_baize_condition_movingUpComplete(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_39_captain_baize_condition_eliteCouncilActive(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "corellia_39_chirq_council_04");
    }
    public boolean corellia_39_captain_baize_condition_eliteCouncilComplete(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_39_chirq_council_04", "chirq_council_04_03");
    }
    public boolean corellia_39_captain_baize_condition_needs40Pointer(obj_id player, obj_id npc)
    {
    ...
    public void corellia_39_captain_baize_action_regrant_assumedIdentityB(obj_id player, obj_id npc)
    {
    ...
    public void corellia_39_captain_baize_action_signal_assumedIdentityFailed(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "chirq_council_02_failed");
        groundquests.grantQuest(player, "corellia_39_chirq_council_02b");
    }
    public void corellia_39_captain_baize_action_signal_assumedIdentityComplete(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "chirq_council_02_07");
    }
    public void corellia_39_captain_baize_action_grant_movingUp(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "corellia_39_chirq_council_03");
    }
    public void corellia_39_captain_baize_action_signal_movingUpSpice(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "chirq_council_03_03");
    }
    public void corellia_39_captain_baize_action_regrant_movingUpB(obj_id player, obj_id npc)
    {
    ...
    public void corellia_39_captain_baize_action_signal_movingUpComplete(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "chirq_council_03_11");
    }
    public void corellia_39_captain_baize_action_signal_39Pointer(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "corellia_39_pointer_01");
    }
    public void corellia_39_captain_baize_action_grant_seekCouncil(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "corellia_39_chirq_council_01");
    }
    public void corellia_39_captain_baize_action_signal_seekCouncilComplete(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "chirq_council_01_08");
    }
    public void corellia_39_captain_baize_action_grant_assumedIdentity(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "corellia_39_chirq_council_02");
    }
    public void corellia_39_captain_baize_action_signal_assumedIdentityTrins(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "chirq_council_02_03");
    }
    public void corellia_39_captain_baize_action_gant_eliteCouncil(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "corellia_39_chirq_council_04");
    }
    public void corellia_39_captain_baize_action_signal_eliteCouncilComplete(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "chirq_council_04_03");
    }
    public void corellia_39_captain_baize_action_grant_40Pointer(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "talus_nashal_goto_agent");
    }
    public String corellia_39_captain_baize_tokenTO_playersName(obj_id player, obj_id npc)
    {
    ...
    public int corellia_39_captain_baize_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_39_captain_baize_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_39_captain_baize_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_39_captain_baize_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_39_captain_baize_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_39_captain_baize_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_39_captain_baize_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_39_captain_baize_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_39_captain_baize_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_39_captain_baize_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_39_captain_baize_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_39_captain_baize_handleBranch30(obj_id player, obj_id npc, string_id response)
    {
