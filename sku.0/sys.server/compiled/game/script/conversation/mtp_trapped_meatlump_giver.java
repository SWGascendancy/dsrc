...
public class mtp_trapped_meatlump_giver extends script.base_script
{
    ...
    public boolean mtp_trapped_meatlump_giver_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean mtp_trapped_meatlump_giver_condition_alreadyHasQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "mtp_hideout_instance_escort_trapped_meatlump");
    }
    public boolean mtp_trapped_meatlump_giver_condition_returningQuestSuccess(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "mtp_hideout_instance_escort_trapped_meatlump_success");
    }
    public boolean mtp_trapped_meatlump_giver_condition_notYetReadyForAnother(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_trapped_meatlump_giver_condition_returningQuestFailure(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "mtp_hideout_instance_escort_trapped_meatlump_fail");
    }
    public void mtp_trapped_meatlump_giver_action_grantDroidQuest(obj_id player, obj_id npc)
    {
    ...
    public void mtp_trapped_meatlump_giver_action_sendDroidSuccessSignal(obj_id player, obj_id npc)
    {
    ...
    public void mtp_trapped_meatlump_giver_action_sendDroidFailureSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "mtp_rescue_lost_meatlump_failed");
    }
    public int mtp_trapped_meatlump_giver_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
