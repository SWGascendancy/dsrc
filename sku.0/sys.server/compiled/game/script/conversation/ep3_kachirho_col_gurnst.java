...
public class ep3_kachirho_col_gurnst extends script.base_script
{
    ...
    public boolean ep3_kachirho_col_gurnst_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_kachirho_col_gurnst_condition_isOnQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_kachirho_kill_wke");
    }
    public boolean ep3_kachirho_col_gurnst_condition_taskCompleted(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_kachirho_kill_wke", "wookieeKilled");
    }
    public boolean ep3_kachirho_col_gurnst_condition_hasCompletedMission(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_kachirho_kill_wke");
    }
    public void ep3_kachirho_col_gurnst_action_grantMission(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_kachirho_kill_wke");
    }
    public void ep3_kachirho_col_gurnst_action_doSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "gurnstReward");
    }
    public void ep3_kachirho_col_gurnst_action_clearMission(obj_id player, obj_id npc)
    {
        groundquests.clearQuest(player, "ep3_kachirho_kill_wke");
    }
    public int ep3_kachirho_col_gurnst_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_col_gurnst_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_col_gurnst_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_col_gurnst_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_col_gurnst_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_col_gurnst_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_col_gurnst_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_col_gurnst_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_col_gurnst_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
