...
public class biogenic_construction extends script.base_script
{
    ...
    public boolean biogenic_construction_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean biogenic_construction_condition_get_tracker_1(obj_id player, obj_id npc)
    {
    ...
    public boolean biogenic_construction_condition_get_tracker_2(obj_id player, obj_id npc)
    {
        int tracker = getIntObjVar(player, "biogenic.construction_convo");
        if (tracker >= 2)
        {
    ...
    public boolean biogenic_construction_condition_get_ass_tracker_3(obj_id player, obj_id npc)
    {
    ...
    public boolean biogenic_construction_condition_get_multi_tracker(obj_id player, obj_id npc)
    {
    ...
    public void biogenic_construction_action__defaultAction(obj_id player, obj_id npc)
    {
    }
    public void biogenic_construction_action_face_to(obj_id player, obj_id npc)
    {
        faceToBehavior(npc, player);
    }
    public void biogenic_construction_action_give_drill(obj_id player, obj_id npc)
    {
    }
    public void biogenic_construction_action_set_tracker_2(obj_id player, obj_id npc)
    {
        faceToBehavior(npc, player);
        setObjVar(player, "biogenic.construction_convo", 2);
    }
    public void biogenic_construction_action_set_tracker_3(obj_id player, obj_id npc)
    {
        faceToBehavior(npc, player);
