...
public class greeter_moenia_undercover_rebel extends script.base_script
{
    ...
    public boolean greeter_moenia_undercover_rebel_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean greeter_moenia_undercover_rebel_condition_remembersPlayer(obj_id player, obj_id npc)
    {
        return (utils.hasScriptVar(player, "metNewbiePilot"));
    }
    public boolean greeter_moenia_undercover_rebel_condition_danceEnabled(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean greeter_moenia_undercover_rebel_condition_isDancing(obj_id player, obj_id npc)
    {
        return utils.hasScriptVar(npc, "isDancing");
    }
    public boolean greeter_moenia_undercover_rebel_condition_isAnImperialPilot(obj_id player, obj_id npc)
    {
        return space_flags.isImperialPilot(player);
    }
    public boolean greeter_moenia_undercover_rebel_condition_isARebelPilot(obj_id player, obj_id npc)
    {
        return space_flags.isRebelPilot(player);
    }
    public boolean greeter_moenia_undercover_rebel_condition_rtp_c3po_02_active(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "rtp_c3po_02", "rtp_c3po_02_02");
    }
    public boolean greeter_moenia_undercover_rebel_condition_isPrivateerPilot(obj_id player, obj_id npc)
    {
        return space_flags.isNeutralPilot(player);
    }
    public boolean greeter_moenia_undercover_rebel_condition_hasSpaceExpansion(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean greeter_moenia_undercover_rebel_condition_hasSpaceShip(obj_id player, obj_id npc)
    {
        return (space_quest.hasShip(player));
    }
    public void greeter_moenia_undercover_rebel_action_rememberPlayer(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "metNewbiePilot", true);
    }
    public void greeter_moenia_undercover_rebel_action_startDancing(obj_id player, obj_id npc)
    {
    ...
    public void greeter_moenia_undercover_rebel_action_rtp_c3po_02_signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "rtp_c3po_02_02");
    }
    public int greeter_moenia_undercover_rebel_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int greeter_moenia_undercover_rebel_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int greeter_moenia_undercover_rebel_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int greeter_moenia_undercover_rebel_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
