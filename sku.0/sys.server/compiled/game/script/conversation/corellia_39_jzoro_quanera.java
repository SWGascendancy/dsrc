...
public class corellia_39_jzoro_quanera extends script.base_script
{
    ...
    public boolean corellia_39_jzoro_quanera_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_39_jzoro_quanera_condition_movingUpOne(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_39_chirq_council_03", "chirq_council_03_01");
    }
    public boolean corellia_39_jzoro_quanera_condition_movingUpComplete(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_39_jzoro_quanera_condition_movingUpTwo(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_39_chirq_council_03", "chirq_council_03_04");
    }
    public boolean corellia_39_jzoro_quanera_condition_movingUpThree(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_39_chirq_council_03b", "chirq_council_03_09");
    }
    public boolean corellia_39_jzoro_quanera_condition_movingUpOneInProgress(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_39_jzoro_quanera_condition_movingUpTwoInProgress(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_39_jzoro_quanera_condition_allComplete(obj_id player, obj_id npc)
    {
    ...
    public void corellia_39_jzoro_quanera_action_signal_movingUpThree(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "chirq_council_03_09");
    }
    public void corellia_39_jzoro_quanera_action_signal_movingUpTwo(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "chirq_council_03_04");
    }
    public void corellia_39_jzoro_quanera_action_signal_movingUpOne(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "chirq_council_03_01");
    }
    public int corellia_39_jzoro_quanera_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_39_jzoro_quanera_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_39_jzoro_quanera_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_39_jzoro_quanera_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_39_jzoro_quanera_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_39_jzoro_quanera_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_39_jzoro_quanera_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
