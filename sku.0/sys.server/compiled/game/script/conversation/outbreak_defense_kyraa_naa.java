...
public class outbreak_defense_kyraa_naa extends script.base_script
{
    ...
    public boolean outbreak_defense_kyraa_naa_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean outbreak_defense_kyraa_naa_condition_hasCompletedDefenseQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean outbreak_defense_kyraa_naa_condition_isWaitingForRewardSignal(obj_id player, obj_id npc)
    {
    ...
    public boolean outbreak_defense_kyraa_naa_condition_hasNeverSpoken(obj_id player, obj_id npc)
    {
    ...
    public boolean outbreak_defense_kyraa_naa_condition_isGodPlayerTester(obj_id player, obj_id npc)
    {
        return isGod(player);
    }
    public boolean outbreak_defense_kyraa_naa_condition_levelTooHigh(obj_id player, obj_id npc)
    {
        return getLevel(player) >= 60;
    }
    public boolean outbreak_defense_kyraa_naa_condition_levelTooLow(obj_id player, obj_id npc)
    {
        return getLevel(player) < 40;
    }
    public boolean outbreak_defense_kyraa_naa_condition_noAntiVirus(obj_id player, obj_id npc)
    {
    ...
    public boolean outbreak_defense_kyraa_naa_condition_hasDefenseQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean outbreak_defense_kyraa_naa_condition_hasAvailableGuardPosts(obj_id player, obj_id npc)
    {
    ...
    public void outbreak_defense_kyraa_naa_action_giveQuest(obj_id player, obj_id npc)
    {
    ...
    public void outbreak_defense_kyraa_naa_action_sendQuestSignal(obj_id player, obj_id npc)
    {
    ...
    public void outbreak_defense_kyraa_naa_action_action0001(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "camp_gamma_defense_01");
    }
    public void outbreak_defense_kyraa_naa_action_action0002(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "camp_gamma_defense_02");
    }
    public void outbreak_defense_kyraa_naa_action_action0003(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "camp_gamma_defense_03");
    }
    public void outbreak_defense_kyraa_naa_action_action0004(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "camp_gamma_defense_04");
    }
    public int outbreak_defense_kyraa_naa_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_defense_kyraa_naa_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_defense_kyraa_naa_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_defense_kyraa_naa_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_defense_kyraa_naa_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_defense_kyraa_naa_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_defense_kyraa_naa_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_defense_kyraa_naa_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
