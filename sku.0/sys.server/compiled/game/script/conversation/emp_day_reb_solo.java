...
public class emp_day_reb_solo extends script.base_script
{
    ...
    public boolean emp_day_reb_solo_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean emp_day_reb_solo_condition_hasTask7(obj_id player, obj_id npc)
    {
    ...
    public void emp_day_reb_solo_action_signal7(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "to_solo");
        sendSystemMessage(player, new string_id("event/empire_day", "sys_msg_return"));
    }
    public int emp_day_reb_solo_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_reb_solo_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_reb_solo_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_reb_solo_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_reb_solo_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_reb_solo_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_reb_solo_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_reb_solo_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_reb_solo_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_reb_solo_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
