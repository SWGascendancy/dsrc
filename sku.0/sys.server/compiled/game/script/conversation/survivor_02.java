...
public class survivor_02 extends script.base_script
{
    ...
    public boolean survivor_02_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean survivor_02_condition_isMySpawner(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (getObjIdObjVar(npc, "myEscort") == player);
    }
    public void survivor_02_action_creditPlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        messageTo(npc, "creditPlayerRescue", null, 0.0f, false);
    }
    public int survivor_02_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
