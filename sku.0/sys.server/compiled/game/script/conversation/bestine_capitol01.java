...
public class bestine_capitol01 extends script.base_script
{
    ...
    public boolean bestine_capitol01_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean bestine_capitol01_condition_nonoffice(obj_id player, obj_id npc)
    {
        return hasObjVar(npc, "bestine.electionEnded");
    }
    public void bestine_capitol01_action__defaultAction(obj_id player, obj_id npc)
    {
    }
