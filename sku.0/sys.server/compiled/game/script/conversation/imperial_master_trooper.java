...
public class imperial_master_trooper extends script.base_script
{
    ...
    public boolean imperial_master_trooper_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean imperial_master_trooper_condition_remembersPlayer(obj_id player, obj_id npc)
    {
        return (utils.hasScriptVar(player, "metNewbiePilot"));
    }
    public boolean imperial_master_trooper_condition_isImperialPilot(obj_id player, obj_id npc)
    {
        return (hasSkill(player, "pilot_imperial_navy_novice"));
    }
    public boolean imperial_master_trooper_condition_isRebelPilot(obj_id player, obj_id npc)
    {
        return (hasSkill(player, "pilot_rebel_navy_novice"));
    }
    public boolean imperial_master_trooper_condition_isPrivateerPilot(obj_id player, obj_id npc)
    {
        return hasSkill(player, "pilot_neutral_novice");
    }
    public boolean imperial_master_trooper_condition_hasSpaceExpansion(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean imperial_master_trooper_condition_hasSpaceShip(obj_id player, obj_id npc)
    {
        return (space_quest.hasShip(player));
    }
    public void imperial_master_trooper_action_rememberPlayer(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "metNewbiePilot", true);
    }
    public void imperial_master_trooper_action_grantQuestOne(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "delivery", "tatooine_newbie_1");
        space_quest.grantNewbieShip(player, "rebel");
    }
    public int imperial_master_trooper_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
