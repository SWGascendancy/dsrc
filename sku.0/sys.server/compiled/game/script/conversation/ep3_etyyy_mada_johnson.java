...
public class ep3_etyyy_mada_johnson extends script.base_script
{
    ...
    public boolean ep3_etyyy_mada_johnson_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_etyyy_mada_johnson_condition_hasCompletedBrodyQuest(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedQuest(player, "ep3_hunt_johnson_brody_johnson"));
    }
    public boolean ep3_etyyy_mada_johnson_condition_hasCompletedWrelaac(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_etyyy_mada_johnson_condition_isShownPendant(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_etyyy_mada_johnson_condition_seekingWrelaac(obj_id player, obj_id npc)
    {
        return (groundquests.isQuestActive(player, "ep3_hunt_mada_johnson_to_wrelaac"));
    }
    public boolean ep3_etyyy_mada_johnson_condition_needsProofForWrelaac(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "ep3_hunt_wrelaac_proof_of_mada", "wrelaac_getProofFromMada"));
    }
    public boolean ep3_etyyy_mada_johnson_condition_hasProof(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_hunt_wrelaac_proof_of_mada", "wrelaac_presentProofToWrelaac");
    }
    public boolean ep3_etyyy_mada_johnson_condition_returnToJohnsonSmith(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_hunt_johnson_brody_johnson", "johnson_returnToSmith");
    }
    public void ep3_etyyy_mada_johnson_action_proofForWrelaac(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "wrelaac_getProofFromMada");
    }
    public void ep3_etyyy_mada_johnson_action_sendBackToSmith(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "johnson_talkToMada");
    }
    public void ep3_etyyy_mada_johnson_action_grantMadaQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_hunt_mada_johnson_to_wrelaac");
    }
    public int ep3_etyyy_mada_johnson_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_mada_johnson_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_mada_johnson_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_mada_johnson_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_mada_johnson_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_mada_johnson_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
