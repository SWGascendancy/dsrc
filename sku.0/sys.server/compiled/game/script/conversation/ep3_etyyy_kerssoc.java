...
public class ep3_etyyy_kerssoc extends script.base_script
{
    ...
    public boolean ep3_etyyy_kerssoc_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_etyyy_kerssoc_condition_hasCompletedAllQuests(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_etyyy_kerssoc_condition_hasCompletedDeliverQuest(obj_id player, obj_id npc)
    {
        return (space_quest.hasWonQuest(player, "deliver_no_pickup", "ep3_hunting_kerssoc_smuggle_goods"));
    }
    public boolean ep3_etyyy_kerssoc_condition_hasCompletedEscortQuest(obj_id player, obj_id npc)
    {
        return (space_quest.hasWonQuest(player, "escort", "ep3_hunting_kerssoc_supplies"));
    }
    public boolean ep3_etyyy_kerssoc_condition_isHuntingBantha(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "ep3_hunt_kerssoc_bantha_pelts", "kerssoc_huntingBantha"));
    }
    public boolean ep3_etyyy_kerssoc_condition_isOnDeliverQuest(obj_id player, obj_id npc)
    {
        return (space_quest.hasQuest(player, "deliver_no_pickup", "ep3_hunting_kerssoc_smuggle_goods"));
    }
    public boolean ep3_etyyy_kerssoc_condition_fromChrilooc(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "ep3_hunt_chrilooc_seek_rodians", "chrilooc_talkToKerssoc"));
    }
    public boolean ep3_etyyy_kerssoc_condition_finishedHuntingBantha(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_etyyy_kerssoc_condition_hasCompletedDestroyWeaponsQuest(obj_id player, obj_id npc)
    {
        return (space_quest.hasWonQuest(player, "assassinate", "ep3_hunting_kerssoc_destroy_chiss_weapons"));
    }
    public boolean ep3_etyyy_kerssoc_condition_attackingChissCamp(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "ep3_hunt_kerssoc_kill_chiss_poachers", "kerssoc_killingChissPoachers"));
    }
    public boolean ep3_etyyy_kerssoc_condition_finishedAttackingChissCamp(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_etyyy_kerssoc_condition_hasManfredsDelivery(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_hunt_manfred_steal_chiss_goods", "manfred_deliverToKerssoc");
    }
    public boolean ep3_etyyy_kerssoc_condition_alreadyHasSpaceMission(obj_id player, obj_id npc)
    {
        return space_quest.hasQuest(player);
    }
    public void ep3_etyyy_kerssoc_action_spokeToKerssoc(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "chrilooc_talkToKerssoc");
    }
    public void ep3_etyyy_kerssoc_action_finishedHuntBantha(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "kerssoc_kashyyykBanthaPelts");
    }
    public void ep3_etyyy_kerssoc_action_huntKashBantha(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_hunt_kerssoc_bantha_pelts");
    }
    public void ep3_etyyy_kerssoc_action_deliverBanthaHides(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "delivery_no_pickup", "ep3_hunting_kerssoc_smuggle_goods");
    }
    public void ep3_etyyy_kerssoc_action_destroyChissWeapons(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "assassinate", "ep3_hunting_kerssoc_destroy_chiss_weapons");
    }
    public void ep3_etyyy_kerssoc_action_escortSupplies(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "escort", "ep3_hunting_kerssoc_supplies");
    }
    public void ep3_etyyy_kerssoc_action_attackChissCamp(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_hunt_kerssoc_kill_chiss_poachers");
    }
    public void ep3_etyyy_kerssoc_action_finishedAttackChissCamp(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "kerssoc_attackChissPoachers");
    }
    public void ep3_etyyy_kerssoc_action_enterEtyyy(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "chrilooc_gainEtyyyEntry");
        groundquests.grantQuest(player, "ep3_hunt_kerssoc_enter_etyyy");
    }
    public void ep3_etyyy_kerssoc_action_manfredsDeliverMade(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "manfred_deliverToKerssoc");
    }
    public int ep3_etyyy_kerssoc_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_kerssoc_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_kerssoc_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_kerssoc_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_kerssoc_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_kerssoc_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_kerssoc_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_kerssoc_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_kerssoc_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_kerssoc_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_kerssoc_handleBranch32(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_kerssoc_handleBranch33(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_kerssoc_handleBranch34(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_kerssoc_handleBranch35(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_1130"))
        {
            if (ep3_etyyy_kerssoc_condition__defaultCondition(player, npc))
