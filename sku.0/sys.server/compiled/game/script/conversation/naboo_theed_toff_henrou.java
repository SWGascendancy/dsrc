...
public class naboo_theed_toff_henrou extends script.base_script
{
    ...
    public boolean naboo_theed_toff_henrou_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean naboo_theed_toff_henrou_condition_startSkaakQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_theed_toff_henrou_condition_onSkaakQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "naboo_theed_hugo_skaak");
    }
    public boolean naboo_theed_toff_henrou_condition_completedSkaakQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "naboo_theed_hugo_skaak");
    }
    public boolean naboo_theed_toff_henrou_condition_lastStepSkaakQuest(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "naboo_theed_hugo_skaak", "theed_hugo_skaak_05");
    }
    public boolean naboo_theed_toff_henrou_condition_reGiveHugoPointer(obj_id player, obj_id npc)
    {
    ...
    public void naboo_theed_toff_henrou_action_grantSkaak(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "naboo_theed_hugo_skaak");
    }
    public void naboo_theed_toff_henrou_action_signal_skaak_05(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "theed_hugo_skaak_05");
    }
    public void naboo_theed_toff_henrou_action_endGotoToff(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "theed_goto_toff");
    }
    public void naboo_theed_toff_henrou_action_sendBackToHugo(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "naboo_theed_hugo_return");
    }
    public int naboo_theed_toff_henrou_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_toff_henrou_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_toff_henrou_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_theed_toff_henrou_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
