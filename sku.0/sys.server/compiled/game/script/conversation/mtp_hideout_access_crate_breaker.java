...
public class mtp_hideout_access_crate_breaker extends script.base_script
{
    ...
    public boolean mtp_hideout_access_crate_breaker_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean mtp_hideout_access_crate_breaker_condition_mtpHideout01_06(obj_id player, obj_id npc)
    {
    ...
    public void mtp_hideout_access_crate_breaker_action_attack(obj_id player, obj_id npc)
    {
    ...
    public int mtp_hideout_access_crate_breaker_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_access_crate_breaker_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_access_crate_breaker_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_access_crate_breaker_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_access_crate_breaker_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int handleEndConversation(obj_id self, dictionary params)
    {
