...
public class nova_orion_human_resources_advisor extends script.base_script
{
    ...
    public boolean nova_orion_human_resources_advisor_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean nova_orion_human_resources_advisor_condition_isANovaOrionEmployee(obj_id player, obj_id npc)
    {
        return hasCompletedCollectionSlot(player, "nova_orion_rank_01");
    }
    public void nova_orion_human_resources_advisor_action_revokeNovaOrionEmployment(obj_id player, obj_id npc)
    {
        township.clearAllNovaOrionQuestStatus(player);
        return;
    }
    public String nova_orion_human_resources_advisor_tokenTO_getEmployeeName(obj_id player, obj_id npc)
    {
        String name = getName(player);
        return name;
    }
    public int nova_orion_human_resources_advisor_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nova_orion_human_resources_advisor_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nova_orion_human_resources_advisor_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
