...
public class inquisitor_admin extends script.base_script
{
    ...
    public boolean inquisitor_admin_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean inquisitor_admin_condition_isNeutQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.hasCompletedQuest(player, "outbreak_quest_02_neutral");
    }
    public boolean inquisitor_admin_condition_isRebQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.hasCompletedQuest(player, "outbreak_quest_02_rebel");
    }
    public boolean inquisitor_admin_condition_hasQuestForInq(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean inquisitor_admin_condition_hasPreviousQuests(obj_id player, obj_id npc)
    {
    ...
    public boolean inquisitor_admin_condition_isPlayerGodMode(obj_id player, obj_id npc)
    {
        return isGod(player);
    }
    public boolean inquisitor_admin_condition_hasARandomInquisitorQuest(obj_id player, obj_id npc)
    {
        String faction = "";
    ...
    public boolean inquisitor_admin_condition_hasKey(obj_id player, obj_id npc)
    {
        String faction = "";
        if (inquisitor_admin_condition_isImpQuest(player, npc))
        {
    ...
    public boolean inquisitor_admin_condition_isNeutralOrRebelQuest(obj_id player, obj_id npc)
    {
        return inquisitor_admin_condition_isRebQuest(player, npc) || inquisitor_admin_condition_isNeutQuest(player, npc);
    }
    public boolean inquisitor_admin_condition_hasCompletedKeyDeletedDungeon(obj_id player, obj_id npc)
    {
        String faction = "";
        if (inquisitor_admin_condition_isImpQuest(player, npc))
        {
    ...
    public boolean inquisitor_admin_condition_isImpQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.hasCompletedQuest(player, "outbreak_quest_02_imperial");
    }
    public boolean inquisitor_admin_condition_hasFindKeyTaskActive(obj_id player, obj_id npc)
    {
        String faction = "";
        if (inquisitor_admin_condition_isImpQuest(player, npc))
        {
    ...
    public boolean inquisitor_admin_condition_hasRadio(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "outbreak_radio_delivery_03", "findEpsilonContact");
    }
    public void inquisitor_admin_action_sendSignalGoAdminBuilding(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        groundquests.sendSignal(player, "hasSpokenInquisitor");
    }
    public void inquisitor_admin_action_grantDungeonQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "outbreak_quest_facility_01");
        utils.removeScriptVarTree(player, "consoleMiniGame");
    }
    public void inquisitor_admin_action_sendSignalReturnedInquisitor(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "hasReturnedInquisitor");
        inquisitor_admin_action_grantDungeonQuest(player, npc);
    }
    public int inquisitor_admin_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int inquisitor_admin_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int inquisitor_admin_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int inquisitor_admin_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int inquisitor_admin_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int inquisitor_admin_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int inquisitor_admin_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int inquisitor_admin_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int inquisitor_admin_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int inquisitor_admin_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int inquisitor_admin_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int inquisitor_admin_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
