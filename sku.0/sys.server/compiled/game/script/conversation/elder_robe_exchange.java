...
public class elder_robe_exchange extends script.base_script
{
    ...
    public boolean elder_robe_exchange_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean elder_robe_exchange_condition_hasElderRobe(obj_id player, obj_id npc)
    {
    ...
    public boolean elder_robe_exchange_condition_isOnRobeQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "jedi_gift_exchange");
    }
    public boolean elder_robe_exchange_condition_turnInRobeQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "jedi_gift_exchange", "GatherRelics");
    }
    public boolean elder_robe_exchange_condition_completeRobeQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "jedi_gift_exchange");
    }
    public boolean elder_robe_exchange_condition_hasGivenRobe(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "jedi_gift_exchange", "TalkAgainLight"));
    }
    public void elder_robe_exchange_action_grantRobeQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "jedi_gift_exchange");
    }
    public void elder_robe_exchange_action_sendSignalComplete(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "elder_robe_exchange_signal");
    }
    public String elder_robe_exchange_tokenTO_tokenTO0001(obj_id player, obj_id npc)
    {
        return getPlayerName(player);
    }
    public int elder_robe_exchange_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int elder_robe_exchange_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int elder_robe_exchange_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_14"))
        {
            if (elder_robe_exchange_condition__defaultCondition(player, npc))
    ...
    public int elder_robe_exchange_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int elder_robe_exchange_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
