...
public class padawan_chef_02 extends script.base_script
{
    ...
    public boolean padawan_chef_02_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean padawan_chef_02_condition_isTrialPlayer(obj_id player, obj_id npc)
    {
    ...
    public void padawan_chef_02_action_spokeToNpc(obj_id player, obj_id npc)
    {
    ...
    public void padawan_chef_02_action_npcAttacks(obj_id player, obj_id npc)
    {
    ...
    public int padawan_chef_02_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int padawan_chef_02_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
