...
public class c_bounty_hunter_taibela extends script.base_script
{
    ...
    public boolean c_bounty_hunter_taibela_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_bounty_hunter_taibela_condition_isTaskActiveBounty1(obj_id player, obj_id npc)
    {
    ...
    public boolean c_bounty_hunter_taibela_condition_hasCompletedQuestBounty1(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/c_bounty_hunter_kill_1");
    ...
    public void c_bounty_hunter_taibela_action_giveSignalTalk(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "bounty_hunter_kill_1_launch_e2");
    }
    public int c_bounty_hunter_taibela_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_bounty_hunter_taibela_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_bounty_hunter_taibela_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_bounty_hunter_taibela_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_bounty_hunter_taibela_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
