...
public class cyborg_install_tatooine extends script.base_script
{
    ...
    public boolean cyborg_install_tatooine_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean cyborg_install_tatooine_condition_tooManyInstalled(obj_id player, obj_id npc)
    {
        return cybernetic.hasMaxInstalled(player);
    }
    public boolean cyborg_install_tatooine_condition_hasCyberneticOnHand(obj_id player, obj_id npc)
    {
        return cybernetic.hasCyberneticItemInInventory(player);
    }
    public boolean cyborg_install_tatooine_condition_hasCyberneticInstalled(obj_id player, obj_id npc)
    {
        return cybernetic.hasCyberneticItem(player);
    }
    public boolean cyborg_install_tatooine_condition_canGetRepairs(obj_id player, obj_id npc)
    {
        return cybernetic.hasCyberneticsToRepair(player);
    }
    public void cyborg_install_tatooine_action_listCyberneticsToInstall(obj_id player, obj_id npc)
    {
    ...
    public void cyborg_install_tatooine_action_listCyberneticsToRemove(obj_id player, obj_id npc)
    {
    ...
    public void cyborg_install_tatooine_action_listCyberneticsToRepair(obj_id player, obj_id npc)
    {
    ...
    public void cyborg_install_tatooine_action_trackAppearanceTabCyb(obj_id player, obj_id npc)
    {
    ...
    public void cyborg_install_tatooine_action_resetAppearanceTabTracker(obj_id player, obj_id npc)
    {
    ...
    public int cyborg_install_tatooine_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int cyborg_install_tatooine_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int cyborg_install_tatooine_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int cyborg_install_tatooine_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int cyborg_install_tatooine_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int cyborg_install_tatooine_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int cyborg_install_tatooine_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int cyborg_install_tatooine_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
