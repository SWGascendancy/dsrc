...
public class npe_vendor_rallen extends script.base_script
{
    ...
    public boolean npe_vendor_rallen_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_vendor_rallen_condition_hasBeenBefore(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "npe.rallen");
    }
    public void npe_vendor_rallen_action_startShop(obj_id player, obj_id npc)
    {
    ...
    public void npe_vendor_rallen_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int npe_vendor_rallen_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_vendor_rallen_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_vendor_rallen_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
