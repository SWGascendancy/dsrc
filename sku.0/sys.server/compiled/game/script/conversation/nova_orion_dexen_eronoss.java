...
public class nova_orion_dexen_eronoss extends script.base_script
{
    ...
    public boolean nova_orion_dexen_eronoss_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean nova_orion_dexen_eronoss_condition_qualifiesForRank2Quests(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "nova_orion_rank1_03") && hasCompletedCollectionSlot(player, "nova_orion_rank_02");
    }
    public boolean nova_orion_dexen_eronoss_condition_returnRank2_01(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "no_rank2_01", "no_rank2_01_02") || groundquests.hasCompletedQuest(player, "no_rank2_01");
    }
    public boolean nova_orion_dexen_eronoss_condition_returnRank2_02(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "no_rank2_02", "no_rank2_02_02") || groundquests.hasCompletedQuest(player, "no_rank2_02");
    }
    public boolean nova_orion_dexen_eronoss_condition_returnRank2_03(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "no_rank2_03", "no_rank2_03_02") || groundquests.hasCompletedQuest(player, "no_rank2_03");
    }
    public boolean nova_orion_dexen_eronoss_condition_doneWithDexen(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "no_rank2_04");
    }
    public boolean nova_orion_dexen_eronoss_condition_onRank2_01(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "no_rank2_01");
    }
    public boolean nova_orion_dexen_eronoss_condition_onRank2_02(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "no_rank2_02");
    }
    public boolean nova_orion_dexen_eronoss_condition_onRank2_03(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "no_rank2_03");
    }
    public void nova_orion_dexen_eronoss_action_grantRank2_01(obj_id player, obj_id npc)
    {
    ...
    public void nova_orion_dexen_eronoss_action_grantRank2_02(obj_id player, obj_id npc)
    {
    ...
    public void nova_orion_dexen_eronoss_action_grantRank2_03(obj_id player, obj_id npc)
    {
    ...
    public void nova_orion_dexen_eronoss_action_sendRank2_03Signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "no_rank2_03_02");
    }
    public void nova_orion_dexen_eronoss_action_sendRank2_02Signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "no_rank2_02_02");
    }
    public void nova_orion_dexen_eronoss_action_sendRank2_01Signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "no_rank2_01_02");
    }
    public int nova_orion_dexen_eronoss_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nova_orion_dexen_eronoss_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nova_orion_dexen_eronoss_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
