...
public class bib_fortuna_mos_eisley extends script.base_script
{
    ...
    public boolean bib_fortuna_mos_eisley_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean bib_fortuna_mos_eisley_condition_hasComlinkQuest01Neut(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isQuestActive(player, "quest_01_comlink_call_to_adventure_neut_faction");
    }
    public boolean bib_fortuna_mos_eisley_condition_hasComlinkQuest01Pos(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isQuestActive(player, "quest_01_comlink_call_to_adventure_pos_faction");
    }
    public boolean bib_fortuna_mos_eisley_condition_hasComlinkQuest01Neg(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isQuestActive(player, "quest_01_comlink_call_to_adventure_neg_faction");
    }
    public boolean bib_fortuna_mos_eisley_condition_hasTheBiolabClue(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean bib_fortuna_mos_eisley_condition_hasBiolabQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean bib_fortuna_mos_eisley_condition_hasCompletedBiolabQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean bib_fortuna_mos_eisley_condition_needsToGatherClues(obj_id player, obj_id npc)
    {
    ...
    public boolean bib_fortuna_mos_eisley_condition_hasQuestOneNotQuestTwo(obj_id player, obj_id npc)
    {
    ...
    public boolean bib_fortuna_mos_eisley_condition_hasCompletedBiolabButCancelHerron(obj_id player, obj_id npc)
    {
    ...
    public boolean bib_fortuna_mos_eisley_condition_hasCompletedInvestigationCancelBiolab(obj_id player, obj_id npc)
    {
    ...
    public void bib_fortuna_mos_eisley_action_comlinkQuestOnceSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "bibWaitingForPlayer");
    }
    public void bib_fortuna_mos_eisley_action_grantQuest02Investigate(obj_id player, obj_id npc)
    {
    ...
    public void bib_fortuna_mos_eisley_action_sendSignalAndGrantQuest03Biolab(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "quest02PlayerHasClues");
    }
    public void bib_fortuna_mos_eisley_action_grantQuest03(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest_03_investigate_biolab");
    }
    public void bib_fortuna_mos_eisley_action_clearQuest03(obj_id player, obj_id npc)
    {
        groundquests.clearQuest(player, "quest_03_investigate_biolab");
    }
    public void bib_fortuna_mos_eisley_action_clearThenGrantQuest03(obj_id player, obj_id npc)
    {
        bib_fortuna_mos_eisley_action_clearQuest03(player, npc);
        bib_fortuna_mos_eisley_action_grantQuest03(player, npc);
    }
    public int bib_fortuna_mos_eisley_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int bib_fortuna_mos_eisley_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int bib_fortuna_mos_eisley_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int bib_fortuna_mos_eisley_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int bib_fortuna_mos_eisley_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int bib_fortuna_mos_eisley_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_30"))
        {
            if (bib_fortuna_mos_eisley_condition__defaultCondition(player, npc))
    ...
    public int bib_fortuna_mos_eisley_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_30"))
        {
            if (bib_fortuna_mos_eisley_condition__defaultCondition(player, npc))
    ...
    public int bib_fortuna_mos_eisley_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int bib_fortuna_mos_eisley_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int bib_fortuna_mos_eisley_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_39"))
        {
            if (bib_fortuna_mos_eisley_condition__defaultCondition(player, npc))
