...
public class ep3_clone_relics_nym_starmap_han_solo extends script.base_script
{
    ...
    public boolean ep3_clone_relics_nym_starmap_han_solo_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_clone_relics_nym_starmap_han_solo_condition_talkToSolo1(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "ep3_clone_relics_nym_starmap_4", "talkToSolo1"));
    }
    public boolean ep3_clone_relics_nym_starmap_han_solo_condition_talkToSolo2(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "ep3_clone_relics_nym_starmap_4", "haveMoney"));
    }
    public void ep3_clone_relics_nym_starmap_han_solo_action_sendSignalTalked1(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedToSolo1");
    }
    public void ep3_clone_relics_nym_starmap_han_solo_action_sendSignalTalked2(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "soloPaid");
        setObjVar(player, "doneWithSolo", 1);
    }
    public int ep3_clone_relics_nym_starmap_han_solo_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_nym_starmap_han_solo_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_nym_starmap_han_solo_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_nym_starmap_han_solo_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_nym_starmap_han_solo_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_nym_starmap_han_solo_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_nym_starmap_han_solo_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_nym_starmap_han_solo_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_nym_starmap_han_solo_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_nym_starmap_han_solo_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_nym_starmap_han_solo_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_nym_starmap_han_solo_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_nym_starmap_han_solo_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_319"))
        {
            doAnimationAction(player, "gesticulate_wildly");
