...
public class c_story1_4_lando extends script.base_script
{
    ...
    public boolean c_story1_4_lando_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_story1_4_lando_condition_playeronTask(obj_id player, obj_id npc)
    {
    ...
    public boolean c_story1_4_lando_condition_playerCompletedQuest(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/c_story1_4a");
        return questIsQuestComplete(questId1, player);
    }
    public boolean c_story1_4_lando_condition_playerafterTask(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/c_story1_4a");
        int talktolando = groundquests.getTaskId(questId1, "talktolando");
        return questIsTaskComplete(questId1, talktolando, player);
    }
    public void c_story1_4_lando_action_sendLandoSig(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "c_story1_4_lando");
    }
    public void c_story1_4_lando_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int c_story1_4_lando_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_4_lando_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_4_lando_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_4_lando_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_4_lando_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_18"))
        {
            if (c_story1_4_lando_condition__defaultCondition(player, npc))
    ...
    public int c_story1_4_lando_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_18"))
        {
            if (c_story1_4_lando_condition__defaultCondition(player, npc))
    ...
    public int c_story1_4_lando_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_4_lando_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_4_lando_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_4_lando_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_4_lando_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_4_lando_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_6"))
        {
            if (c_story1_4_lando_condition__defaultCondition(player, npc))
