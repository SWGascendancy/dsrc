...
public class rebel_life_day_vendor extends script.base_script
{
    ...
    public boolean rebel_life_day_vendor_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean rebel_life_day_vendor_condition_alreadyWorking(obj_id player, obj_id npc)
    {
    ...
    public boolean rebel_life_day_vendor_condition_lockedOut(obj_id player, obj_id npc)
    {
    ...
    public boolean rebel_life_day_vendor_condition_godMode(obj_id player, obj_id npc)
    {
        return (isGod(player));
    }
    public boolean rebel_life_day_vendor_condition_scoreBoardNotEmpty(obj_id player, obj_id npc)
    {
    ...
    public boolean rebel_life_day_vendor_condition_alreadyWorking_2(obj_id player, obj_id npc)
    {
    ...
    public boolean rebel_life_day_vendor_condition_imperialPlayer(obj_id player, obj_id npc)
    {
    ...
    public boolean rebel_life_day_vendor_condition_neutral(obj_id player, obj_id npc)
    {
    ...
    public void rebel_life_day_vendor_action_showTokenVendorUI(obj_id player, obj_id npc)
    {
    ...
    public void rebel_life_day_vendor_action_addCasualBuff(obj_id player, obj_id npc)
    {
        int lifeDayBuff = buff.getBuffOnTargetFromGroup(player, "lifeday_tracker");
        if (lifeDayBuff == 0)
        {
    ...
    public void rebel_life_day_vendor_action_addCompetitiveBuff(obj_id player, obj_id npc)
    {
        int lifeDayBuff = buff.getBuffOnTargetFromGroup(player, "lifeday_tracker");
        if (lifeDayBuff == 0)
        {
    ...
    public void rebel_life_day_vendor_action_barkLeaders(obj_id player, obj_id npc)
    {
    ...
    public void rebel_life_day_vendor_action_barkLeardersSilent(obj_id player, obj_id npc)
    {
        obj_id tatooine = getPlanetByName("tatooine");
        if (!isIdValid(tatooine))
        {
    ...
    public int rebel_life_day_vendor_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_life_day_vendor_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_life_day_vendor_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_life_day_vendor_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_life_day_vendor_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_60"))
        {
            if (rebel_life_day_vendor_condition__defaultCondition(player, npc))
    ...
    public int rebel_life_day_vendor_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
