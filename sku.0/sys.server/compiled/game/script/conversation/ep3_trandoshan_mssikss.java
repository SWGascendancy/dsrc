...
public class ep3_trandoshan_mssikss extends script.base_script
{
    ...
    public boolean ep3_trandoshan_mssikss_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_trandoshan_mssikss_condition_canTakeSpaceMission(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_trandoshan_mssikss_condition_hasFailedMission(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_trandoshan_mssikss_condition_receivedReward(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_trandoshan_mssikss_condition_hasWonMission(obj_id player, obj_id npc)
    {
        return (space_quest.hasWonQuestRecursive(player, "recovery", "ep3_trando_mssikss"));
    }
    public boolean ep3_trandoshan_mssikss_condition_isOnMission(obj_id player, obj_id npc)
    {
        return (space_quest.hasQuest(player));
    }
    public void ep3_trandoshan_mssikss_action_grantMission(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "recovery", "ep3_trando_mssikss");
    }
    public void ep3_trandoshan_mssikss_action_grantReward(obj_id player, obj_id npc)
    {
    ...
    public int ep3_trandoshan_mssikss_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_mssikss_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_mssikss_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_mssikss_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_mssikss_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_mssikss_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
