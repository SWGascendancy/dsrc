...
public class coa3winfoofficer extends script.base_script
{
    ...
    public boolean coa3winfoofficer_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean coa3winfoofficer_condition_hasTalkToCoordinator(obj_id player, obj_id npc)
    {
        return (getIntObjVar(player, "coa3.convTracker") <= -101);
    }
    public void coa3winfoofficer_action_infoOfficerDone(obj_id player, obj_id npc)
    {
    ...
    public int coa3winfoofficer_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int coa3winfoofficer_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int coa3winfoofficer_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int coa3winfoofficer_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int coa3winfoofficer_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int coa3winfoofficer_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
