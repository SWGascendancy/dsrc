...
public class npe_tutorial_droid_1 extends script.base_script
{
    ...
    public boolean npe_tutorial_droid_1_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public void npe_tutorial_droid_1_action_continueTable(obj_id player, obj_id npc)
    {
    ...
    public void npe_tutorial_droid_1_action_sound1(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/meddroid_1.snd");
    }
    public void npe_tutorial_droid_1_action_sound2(obj_id player, obj_id npc)
    {
        play2dNonLoopingSound(player, "sound/meddroid_2.snd");
    }
    public int npe_tutorial_droid_1_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
