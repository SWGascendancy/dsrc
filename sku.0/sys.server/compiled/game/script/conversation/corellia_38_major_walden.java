...
public class corellia_38_major_walden extends script.base_script
{
    ...
    public boolean corellia_38_major_walden_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_38_major_walden_condition_stolenMedalActive(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_38_major_walden_condition_stolenMedalComplete(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_38_major_walden_condition_assaultActive(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_38_major_walden_condition_assaultComplete(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_38_major_walden_condition_allComplete(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_38_major_walden_condition_qualifiesForQuests(obj_id player, obj_id npc)
    {
    ...
    public void corellia_38_major_walden_action_stolenMedalGranted(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "corellia_38_corsec_files_01");
    }
    public void corellia_38_major_walden_action_stolenMedalCompletedSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "corsec_files_01_09");
    }
    public void corellia_38_major_walden_action_assaultCompletedSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "corsec_files_02_05");
    }
    public void corellia_38_major_walden_action_luckyMayorGranted(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "corellia_38_corsec_files_03");
    }
    public void corellia_38_major_walden_action_pointerSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "corellia_38_pointer_03");
    }
    public void corellia_38_major_walden_action_assaultGranted(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "corellia_38_corsec_files_02");
    }
    public int corellia_38_major_walden_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_38_major_walden_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_38_major_walden_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_38_major_walden_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_38_major_walden_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
