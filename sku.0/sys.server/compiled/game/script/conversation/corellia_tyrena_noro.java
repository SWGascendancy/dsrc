...
public class corellia_tyrena_noro extends script.base_script
{
    ...
    public boolean corellia_tyrena_noro_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_tyrena_noro_condition_talkNoro(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_tyrena_slaver_access", "talk_to_slave_2");
    }
    public boolean corellia_tyrena_noro_condition_completeSlaverAccess(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "corellia_tyrena_slaver_access");
    }
    public boolean corellia_tyrena_noro_condition_onSpike(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_tyrena_slaver_access", "hack_term_2b");
    }
    public boolean corellia_tyrena_noro_condition_onAdminComp(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_tyrena_slaver_access", "hack_term_2a");
    }
    public boolean corellia_tyrena_noro_condition_onAdminComp2(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_tyrena_slaver_access", "hack_term_2c");
    }
    public boolean corellia_tyrena_noro_condition_onSlaverAccess(obj_id player, obj_id npc)
    {
    ...
    public void corellia_tyrena_noro_action_signalNoro(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talk_to_slave_2");
    }
    public int corellia_tyrena_noro_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_noro_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_noro_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_noro_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_noro_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_noro_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_noro_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_noro_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_noro_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_noro_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
