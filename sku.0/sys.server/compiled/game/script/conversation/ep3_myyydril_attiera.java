...
public class ep3_myyydril_attiera extends script.base_script
{
    ...
    public boolean ep3_myyydril_attiera_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_myyydril_attiera_condition_hasCompletedInitial(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_myyydril_nawika_talkto_5");
    }
    public boolean ep3_myyydril_attiera_condition_isActiveTaskOne(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_myyydril_attiera_escort_2", 0);
    }
    public boolean ep3_myyydril_attiera_condition_hasCompletedTaskOne(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_myyydril_attiera_condition_hasCompletedQuestOne(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_myyydril_attiera_escort_2");
    }
    public void ep3_myyydril_attiera_action_giveQuestOne(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_myyydril_attiera_escort_2");
    }
    public void ep3_myyydril_attiera_action_giveSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "giveLoot");
    }
    public int ep3_myyydril_attiera_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_attiera_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_attiera_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_attiera_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_attiera_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
