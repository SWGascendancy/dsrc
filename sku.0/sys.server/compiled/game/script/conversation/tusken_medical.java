...
public class tusken_medical extends script.base_script
{
    ...
    public boolean tusken_medical_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tusken_medical_condition_staffed(obj_id player, obj_id npc)
    {
