...
public class corellia_38_edbr_yamagh extends script.base_script
{
    ...
    public boolean corellia_38_edbr_yamagh_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_38_edbr_yamagh_condition_stolenMedalActive(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_38_edbr_yamagh_condition_questComplete(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_38_edbr_yamagh_condition_stolenMedalFirst(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_38_corsec_files_01", "corsec_files_01_02");
    }
    public void corellia_38_edbr_yamagh_action_stolenMedalFirstSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "corsec_files_01_02");
    }
    public int corellia_38_edbr_yamagh_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_38_edbr_yamagh_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_38_edbr_yamagh_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
