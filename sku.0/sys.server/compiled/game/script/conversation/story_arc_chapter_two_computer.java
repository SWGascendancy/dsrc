...
public class story_arc_chapter_two_computer extends script.base_script
{
    ...
    public boolean story_arc_chapter_two_computer_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean story_arc_chapter_two_computer_condition_isReadyForChapTwo(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "som_story_arc_chapter_one_03", "mustafar_uplink_four");
    }
    public boolean story_arc_chapter_two_computer_condition_isFixingFactory(obj_id player, obj_id npc)
    {
    ...
    public boolean story_arc_chapter_two_computer_condition_factoryIsRepaired(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "som_story_arc_chapter_two_01", "mustafar_factory_three");
    }
    public boolean story_arc_chapter_two_computer_condition_completedTransfer(obj_id player, obj_id npc)
    {
    ...
    public boolean story_arc_chapter_two_computer_condition_hasCompleteChapterOne(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "som_story_arc_chapter_one_03");
    }
    public boolean story_arc_chapter_two_computer_condition_isNotFinalStep(obj_id player, obj_id npc)
    {
        return getIntObjVar(trial.getTop(npc), "status") < 11;
    }
    public void story_arc_chapter_two_computer_action_completeChapterOne(obj_id player, obj_id npc)
    {
    ...
    public void story_arc_chapter_two_computer_action_hkShowsUp(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "mustafar_factory_transfer");
    }
    public void story_arc_chapter_two_computer_action_grantMission(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "som_story_arc_chapter_two_01");
    }
    public int story_arc_chapter_two_computer_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int story_arc_chapter_two_computer_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int story_arc_chapter_two_computer_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int story_arc_chapter_two_computer_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int story_arc_chapter_two_computer_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int story_arc_chapter_two_computer_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int story_arc_chapter_two_computer_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int story_arc_chapter_two_computer_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int story_arc_chapter_two_computer_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int story_arc_chapter_two_computer_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int story_arc_chapter_two_computer_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int story_arc_chapter_two_computer_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int story_arc_chapter_two_computer_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int story_arc_chapter_two_computer_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int story_arc_chapter_two_computer_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int story_arc_chapter_two_computer_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
