...
public class emp_day_disk_guy_2 extends script.base_script
{
    ...
    public boolean emp_day_disk_guy_2_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean emp_day_disk_guy_2_condition_hasTask3b(obj_id player, obj_id npc)
    {
    ...
    public void emp_day_disk_guy_2_action_triggerAndWp(obj_id player, obj_id npc)
    {
    ...
    public int emp_day_disk_guy_2_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
