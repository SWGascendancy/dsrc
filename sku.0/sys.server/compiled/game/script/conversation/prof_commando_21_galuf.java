...
public class prof_commando_21_galuf extends script.base_script
{
    ...
    public boolean prof_commando_21_galuf_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean prof_commando_21_galuf_condition_playerOnCOM21Reward(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "prof_commando_21", "getreward");
    }
    public boolean prof_commando_21_galuf_condition_playerfinishedCOM21Quest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "prof_commando_21");
    }
    public boolean prof_commando_21_galuf_condition_questStarted(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "prof_commando_21", "firstcomm");
    }
    public void prof_commando_21_galuf_action_giveRewardSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "prof_commando_21_reward");
    }
    public void prof_commando_21_galuf_action_giveAssignmentSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "prof_commando_11_1_giveassignment");
    }
    public void prof_commando_21_galuf_action_faceplayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void prof_commando_21_galuf_action_givequestDEBUG(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "prof_commando_11");
    }
    public int prof_commando_21_galuf_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
