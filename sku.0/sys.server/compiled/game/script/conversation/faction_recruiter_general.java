...
public class faction_recruiter_general extends script.base_script
{
    ...
    public boolean faction_recruiter_general_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean faction_recruiter_general_condition_isInFaction(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean faction_recruiter_general_condition_isEnemyFaction(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (factions.isInEnemyFaction(player, npc) && (!factions.isPVPStatusChanging(player)));
    }
    public boolean faction_recruiter_general_condition_playerQualifiesForPromotion(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (factions.qualifiesForPromotion(player, pvpGetAlignedFaction(npc)) && (!factions.isPVPStatusChanging(player)));
    }
    public boolean faction_recruiter_general_condition_isChangingFaction(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return factions.isPVPStatusChanging(player);
    }
    public boolean faction_recruiter_general_condition_onLeaveFromFriendlyFaction(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (factions.isOnLeaveFromFriendlyFaction(player, npc) && (!factions.isPVPStatusChanging(player)));
    }
    public boolean faction_recruiter_general_condition_onLeaveFromEnemyFaction(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (factions.isOnLeaveFromEnemyFaction(player, npc) && (!factions.isPVPStatusChanging(player)));
    }
    public boolean faction_recruiter_general_condition_isCovert(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (pvpGetType(player) == PVPTYPE_COVERT) && (!factions.isPVPStatusChanging(player));
    }
    public boolean faction_recruiter_general_condition_isOvert(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return ((pvpGetType(player) == PVPTYPE_DECLARED) && (!factions.isPVPStatusChanging(player)));
    }
    public boolean faction_recruiter_general_condition_playerCanBuyFaction(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (factions.isSmuggler(player) && (factions.canBuyFaction(player, npc)) && (!factions.isPVPStatusChanging(player)));
    }
    public boolean faction_recruiter_general_condition_isAllowedToJoinFaction(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return factions.canJoinFaction(player, pvpGetAlignedFaction(npc));
    }
    public void faction_recruiter_general_action_enablePVPTimer(obj_id player, obj_id npc)
    {
        factions.goOvertWithDelay(player, 30);
    }
    public void faction_recruiter_general_action_playerJoinFaction(obj_id player, obj_id npc)
    {
        factions.joinFaction(player, pvpGetAlignedFaction(npc));
    }
    public void faction_recruiter_general_action_playerGoOnLeaveTimer(obj_id player, obj_id npc)
    {
        factions.goOnLeaveWithDelay(player, 60);
    }
    public void faction_recruiter_general_action_playerGoCovertTimer(obj_id player, obj_id npc)
    {
        factions.goCovertWithDelay(player, 300);
    }
    public void faction_recruiter_general_action_grantPromotion(obj_id player, obj_id npc)
    {
        factions.applyPromotion(player, pvpGetAlignedFaction(npc));
    }
    public void faction_recruiter_general_action_buy1250FactionPoints(obj_id player, obj_id npc)
    {
        factions.buyFaction(player, npc, 100000);
    }
    public void faction_recruiter_general_action_buy250FactionPoints(obj_id player, obj_id npc)
    {
        factions.buyFaction(player, npc, 20000);
    }
    public void faction_recruiter_general_action_completelyResign(obj_id player, obj_id npc)
    {
        factions.leaveFaction(player, pvpGetAlignedFaction(npc));
    }
    public void faction_recruiter_general_action_goCovertShortTimer(obj_id player, obj_id npc)
    {
        factions.goCovertWithDelay(player, 30);
    }
    public void faction_recruiter_general_action_showGcwRewardsList(obj_id player, obj_id npc)
    {
    ...
    public String faction_recruiter_general_tokenTO_getFactionRankName(obj_id player, obj_id npc)
    {
    ...
    public int faction_recruiter_general_tokenDI_getImperialScore(obj_id player, obj_id npc)
    {
        return getIntObjVar(npc, "Imperial.controlScore");
    }
    public float faction_recruiter_general_tokenDF_getRebelScore(obj_id player, obj_id npc)
    {
        return (float)getIntObjVar(npc, "Rebel.controlScore");
    }
    public int faction_recruiter_general_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int faction_recruiter_general_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int faction_recruiter_general_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int faction_recruiter_general_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int faction_recruiter_general_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_29"))
        {
            if (faction_recruiter_general_condition__defaultCondition(player, npc))
    ...
    public int faction_recruiter_general_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int faction_recruiter_general_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_29"))
        {
            if (faction_recruiter_general_condition__defaultCondition(player, npc))
    ...
    public int faction_recruiter_general_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int faction_recruiter_general_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_29"))
        {
            if (faction_recruiter_general_condition__defaultCondition(player, npc))
    ...
    public int faction_recruiter_general_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_29"))
        {
            if (faction_recruiter_general_condition__defaultCondition(player, npc))
    ...
    public int faction_recruiter_general_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int faction_recruiter_general_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int faction_recruiter_general_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int faction_recruiter_general_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
