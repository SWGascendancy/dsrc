...
public class junk_lila_borvo extends script.base_script
{
    ...
    public boolean junk_lila_borvo_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean junk_lila_borvo_condition_check_inv(obj_id player, obj_id npc)
    {
        return smuggler.checkInventory(player, npc);
    }
    public void junk_lila_borvo_action_start_dealing(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        messageTo(npc, "startDealing", params, 1.0f, false);
    }
    public void junk_lila_borvo_action_face_to(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int junk_lila_borvo_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int junk_lila_borvo_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
