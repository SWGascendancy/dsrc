...
public class loveday_disillusion_mr_hate extends script.base_script
{
    ...
    public boolean loveday_disillusion_mr_hate_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean loveday_disillusion_mr_hate_condition_taskActive(obj_id player, obj_id npc)
    {
    ...
    public boolean loveday_disillusion_mr_hate_condition_taskComplete(obj_id player, obj_id npc)
    {
    ...
    public void loveday_disillusion_mr_hate_action_taskSignal(obj_id player, obj_id npc)
    {
    ...
    public String loveday_disillusion_mr_hate_tokenTO_misterOrMiss(obj_id player, obj_id npc)
    {
        String title = "Mister";
    ...
    public int loveday_disillusion_mr_hate_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
