...
public class ep3_gursan_bryes extends script.base_script
{
    ...
    public boolean ep3_gursan_bryes_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_gursan_bryes_condition_hasWonHsskasSpaceQuest(obj_id player, obj_id npc)
    {
        return space_quest.hasWonQuest(player, "space_battle", "ep3_slaver_hsskas_space_battle");
    }
    public boolean ep3_gursan_bryes_condition_isReadyForHsskasReward(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_gursan_slay_hsskas", "taskReturnHsskasVictorious");
    }
    public boolean ep3_gursan_bryes_condition_hasCompletedHsskasQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_gursan_slay_hsskas");
    }
    public boolean ep3_gursan_bryes_condition_isSignalQuestActive(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_kymayrr_send_cyssc_signal");
    }
    public boolean ep3_gursan_bryes_condition_readyForSlaveCamp(obj_id player, obj_id npc)
    {
        return (groundquests.isQuestActive(player, "ep3_talk_to_gursan"));
    }
    public boolean ep3_gursan_bryes_condition_hasRescuedRroot(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_kymayrr_rescue_rroot");
    }
    public boolean ep3_gursan_bryes_condition_canCompleteSignalQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_gursan_bryes_condition_hasCysscSpaceSeries(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_gursan_bryes_condition_hasDefeatedCysscSpace(obj_id player, obj_id npc)
    {
        return space_quest.hasWonQuest(player, "assassinate", "ep3_slaver_lord_cyssc_final");
    }
    public boolean ep3_gursan_bryes_condition_canRepeatCyssc(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_gursan_bryes_condition_haveRepatCysscQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_gursan_bryes_condition_haveWonRepeatCyssc(obj_id player, obj_id npc)
    {
        return space_quest.hasWonQuest(player, "assassinate", "ep3_slaver_lord_cyssc_alt");
    }
    public boolean ep3_gursan_bryes_condition_cysscTimerActive(obj_id player, obj_id npc)
    {
        int currentTime = getCalendarTime();
        int cysscTimer = getIntObjVar(player, "ep3.cysscTimer");
        if (cysscTimer > currentTime)
    ...
    public void ep3_gursan_bryes_action_grantSequencerQuestAndTicket(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_gursan_capture_sequencer_codes");
    }
    public void ep3_gursan_bryes_action_grantTrandoFighterQuest(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "assassinate", "ep3_slaver_trando_reinforcement_intercept");
    }
    public void ep3_gursan_bryes_action_grantSlayHsskasQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_gursan_slay_hsskas");
    }
    public void ep3_gursan_bryes_action_grantSlayHsskasReward(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "signalReturnHsskasVictorious");
    }
    public void ep3_gursan_bryes_action_grantKymayrrBrief(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_gursan_kyamyrr_brief");
    }
    public void ep3_gursan_bryes_action_grantEntryQuest(obj_id player, obj_id npc)
    {
    ...
    public void ep3_gursan_bryes_action_finishSignalQeust(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "signalReturnToGursan");
    }
    public void ep3_gursan_bryes_action_grantCysscSpaceSeries(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "space_battle", "ep3_slaver_khrask_space_battle");
    }
    public void ep3_gursan_bryes_action_grantRepeatCyssc(obj_id player, obj_id npc)
    {
    ...
    public void ep3_gursan_bryes_action_giveRepeatCysscReward(obj_id player, obj_id npc)
    {
    ...
    public String ep3_gursan_bryes_tokenTO_timeLeft(obj_id player, obj_id npc)
    {
        int cysscTimer = getIntObjVar(player, "ep3.cysscTimer");
        int currentTime = getCalendarTime();
    ...
    public int ep3_gursan_bryes_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_gursan_bryes_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_gursan_bryes_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_gursan_bryes_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_gursan_bryes_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_gursan_bryes_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_gursan_bryes_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_gursan_bryes_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_gursan_bryes_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_gursan_bryes_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_gursan_bryes_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_gursan_bryes_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_gursan_bryes_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_gursan_bryes_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_gursan_bryes_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_gursan_bryes_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
