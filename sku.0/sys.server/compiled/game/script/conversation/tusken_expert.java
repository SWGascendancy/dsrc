...
public class tusken_expert extends script.base_script
{
    ...
    public boolean tusken_expert_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tusken_expert_condition_starportNeedsCrew(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "heroic_tusken_tracking_02", "heroic_tusken_starport_crew");
    }
    public boolean tusken_expert_condition_wattoNeedsCrew(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "heroic_tusken_tracking_02", "heroic_tusken_watto_crew");
    }
    public boolean tusken_expert_condition_medcenterNeedsCrew(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "heroic_tusken_tracking_02", "heroic_tusken_medcenter_crew");
    }
    public boolean tusken_expert_condition_universityNeedsCrew(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "heroic_tusken_tracking_02", "heroic_tusken_university_crew");
    }
    public boolean tusken_expert_condition_clonecenterNeedsCrew(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "heroic_tusken_tracking_02", "heroic_tusken_cloning_crew");
    }
    public boolean tusken_expert_condition_combathallNeedsCrew(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "heroic_tusken_tracking_02", "heroic_tusken_combat_crew");
    }
    public boolean tusken_expert_condition_allBuildingsHaveCrews(obj_id player, obj_id npc)
    {
    ...
    public void tusken_expert_action_goToStarport(obj_id player, obj_id npc)
    {
    ...
    public void tusken_expert_action_goToUniversity(obj_id player, obj_id npc)
    {
        dictionary dict = new dictionary();
        dict.put("pathAction", "patrol_path");
    ...
    public void tusken_expert_action_goToMedicalCenter(obj_id player, obj_id npc)
    {
        dictionary dict = new dictionary();
        dict.put("pathAction", "patrol_path");
    ...
    public void tusken_expert_action_goToCommerce(obj_id player, obj_id npc)
    {
        dictionary dict = new dictionary();
        dict.put("pathAction", "patrol_path");
    ...
    public void tusken_expert_action_goToCloning(obj_id player, obj_id npc)
    {
        dictionary dict = new dictionary();
        dict.put("pathAction", "patrol_path");
    ...
    public void tusken_expert_action_goToCombat(obj_id player, obj_id npc)
    {
        dictionary dict = new dictionary();
        dict.put("pathAction", "patrol_path");
    ...
    public void tusken_expert_action_goToWatto(obj_id player, obj_id npc)
    {
        dictionary dict = new dictionary();
        dict.put("pathAction", "patrol_path");
    ...
    public int tusken_expert_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public void setTriggerVolume(obj_id self)
    {
