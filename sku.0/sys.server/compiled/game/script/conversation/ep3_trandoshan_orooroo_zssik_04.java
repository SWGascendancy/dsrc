...
public class ep3_trandoshan_orooroo_zssik_04 extends script.base_script
{
    ...
    public boolean ep3_trandoshan_orooroo_zssik_04_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_trandoshan_orooroo_zssik_04_condition_isOnTask01(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_trando_mosolium_transfer");
    }
    public boolean ep3_trandoshan_orooroo_zssik_04_condition_isOnMission(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_trando_orooroo_zssik_08");
    }
    public boolean ep3_trandoshan_orooroo_zssik_04_condition_isOnTask02(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_trando_orooroo_zssik_08", "returnToOrooroo");
    }
    public boolean ep3_trandoshan_orooroo_zssik_04_condition_hasCompletedQuest01(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_trando_orooroo_zssik_08");
    }
    public boolean ep3_trandoshan_orooroo_zssik_04_condition_oroorooReady(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_trando_mosolium_zssik_05");
    }
    public boolean ep3_trandoshan_orooroo_zssik_04_condition_cannotSpeakWookiee(obj_id player, obj_id npc)
    {
    ...
    public void ep3_trandoshan_orooroo_zssik_04_action_doSignal01(obj_id player, obj_id npc)
    {
    ...
    public void ep3_trandoshan_orooroo_zssik_04_action_doSignal02(obj_id player, obj_id npc)
    {
    ...
    public void ep3_trandoshan_orooroo_zssik_04_action_vocalizeLong(obj_id player, obj_id npc)
    {
        playClientEffectObj(npc, "clienteffect/voc_wookiee_med_6sec.cef", player, "");
    }
    public void ep3_trandoshan_orooroo_zssik_04_action_vocalizeShort(obj_id player, obj_id npc)
    {
        playClientEffectObj(npc, "clienteffect/voc_wookiee_med_2sec.cef", player, "");
    }
    public void ep3_trandoshan_orooroo_zssik_04_action_vocalizeMed(obj_id player, obj_id npc)
    {
        playClientEffectObj(npc, "clienteffect/voc_wookiee_med_4sec.cef", player, "");
    }
    public int ep3_trandoshan_orooroo_zssik_04_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_orooroo_zssik_04_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_orooroo_zssik_04_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_orooroo_zssik_04_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_orooroo_zssik_04_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_orooroo_zssik_04_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_orooroo_zssik_04_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_orooroo_zssik_04_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_orooroo_zssik_04_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_170"))
        {
            if (ep3_trandoshan_orooroo_zssik_04_condition__defaultCondition(player, npc))
