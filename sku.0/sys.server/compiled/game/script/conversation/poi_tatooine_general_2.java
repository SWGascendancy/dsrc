...
public class poi_tatooine_general_2 extends script.base_script
{
    ...
    public boolean poi_tatooine_general_2_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean poi_tatooine_general_2_condition_failedQuestOne(obj_id player, obj_id npc)
    {
    ...
    public boolean poi_tatooine_general_2_condition_failedQuestTwo(obj_id player, obj_id npc)
    {
    ...
    public boolean poi_tatooine_general_2_condition_failedQuestThree(obj_id player, obj_id npc)
    {
    ...
    public boolean poi_tatooine_general_2_condition_hasCompletedQuestOne(obj_id player, obj_id npc)
    {
    ...
    public boolean poi_tatooine_general_2_condition_hasCompletedQuestTwo(obj_id player, obj_id npc)
    {
    ...
    public boolean poi_tatooine_general_2_condition_hasCompletedQuestThree(obj_id player, obj_id npc)
    {
    ...
    public boolean poi_tatooine_general_2_condition_collectingQuestOneReward(obj_id player, obj_id npc)
    {
    ...
    public boolean poi_tatooine_general_2_condition_collectingQuestTwoReward(obj_id player, obj_id npc)
    {
    ...
    public boolean poi_tatooine_general_2_condition_collectingQuestThreeReward(obj_id player, obj_id npc)
    {
    ...
    public boolean poi_tatooine_general_2_condition_isCorrectFaction(obj_id player, obj_id npc)
    {
        return (hasSkill(player, "pilot_neutral_novice"));
    }
    public boolean poi_tatooine_general_2_condition_isNegativeFaction(obj_id player, obj_id npc)
    {
        return (factions.getFactionStanding(player, "jabba") < 0.0f);
    }
    public boolean poi_tatooine_general_2_condition_hasAnyQuest(obj_id player, obj_id npc)
    {
        return space_quest.hasQuest(player);
    }
    public boolean poi_tatooine_general_2_condition_isTooFar(obj_id player, obj_id npc)
    {
        space_combat.playCombatTauntSound(player);
        obj_id containingShip = space_transition.getContainingShip(player);
        return (getDistance(npc, containingShip) > space_transition.STATION_COMM_MAX_DISTANCE);
    }
    public void poi_tatooine_general_2_action_grantQuestOne(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "escort", "poi_tatooine_general2_1");
    }
    public void poi_tatooine_general_2_action_grantQuestTwo(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy", "poi_tatooine_general2_2");
    }
    public void poi_tatooine_general_2_action_grantQuestThree(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "recovery", "poi_tatooine_general2_3");
    }
    public void poi_tatooine_general_2_action_rewardForQuestOne(obj_id player, obj_id npc)
    {
    ...
    public void poi_tatooine_general_2_action_rewardForQuestTwo(obj_id player, obj_id npc)
    {
    ...
    public void poi_tatooine_general_2_action_rewardForQuestThree(obj_id player, obj_id npc)
    {
    ...
    public int poi_tatooine_general_2_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int poi_tatooine_general_2_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int poi_tatooine_general_2_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int poi_tatooine_general_2_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int poi_tatooine_general_2_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int poi_tatooine_general_2_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int poi_tatooine_general_2_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int poi_tatooine_general_2_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int poi_tatooine_general_2_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int poi_tatooine_general_2_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int poi_tatooine_general_2_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int poi_tatooine_general_2_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int poi_tatooine_general_2_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int poi_tatooine_general_2_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int poi_tatooine_general_2_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int poi_tatooine_general_2_handleBranch30(obj_id player, obj_id npc, string_id response)
    {
