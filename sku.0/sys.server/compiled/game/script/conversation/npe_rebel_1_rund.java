...
public class npe_rebel_1_rund extends script.base_script
{
    ...
    public boolean npe_rebel_1_rund_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_rebel_1_rund_condition_hasRebQuest(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_rebel_1", "rund");
    }
    public void npe_rebel_1_rund_action_signalReb(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_rebel_1_rund");
    }
    public void npe_rebel_1_rund_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int npe_rebel_1_rund_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_rebel_1_rund_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
