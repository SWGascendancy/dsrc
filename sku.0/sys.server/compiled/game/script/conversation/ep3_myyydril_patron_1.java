...
public class ep3_myyydril_patron_1 extends script.base_script
{
    ...
    public boolean ep3_myyydril_patron_1_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_myyydril_patron_1_condition_hasCompletedQuestOther(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_myyydril_patron_1_condition_hasCompletedTaskOne(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_myyydril_patron_1_condition_isActiveTaskOne(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_myyydril_patron_1_condition_isActiveQuestTwo(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_myyydril_patron_1_condition_hasCompletedQuestOne(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_myyydril_patron_1_condition_hasCompletedQuestTwo(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_myyydril_nawika_talkto_5");
    }
    public boolean ep3_myyydril_patron_1_condition_hasLanguage(obj_id player, obj_id npc)
    {
        return utils.canSpeakWookiee(player, npc);
    }
    public void ep3_myyydril_patron_1_action_giveQuestOne(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talktonawika");
        groundquests.grantQuest(player, "ep3_myyydril_nawika_escort_1");
    }
    public void ep3_myyydril_patron_1_action_giveQuestTwo(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "giveReward");
        groundquests.grantQuest(player, "ep3_myyydril_nawika_talkto_5");
    }
    public void ep3_myyydril_patron_1_action_Language(obj_id player, obj_id npc)
    {
        utils.emoteWookieeConfusion(player, npc);
    }
    public int ep3_myyydril_patron_1_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_patron_1_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_patron_1_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_patron_1_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_patron_1_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_patron_1_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_patron_1_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_patron_1_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_myyydril_patron_1_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
