...
public class station_imperial_base extends script.base_script
{
    ...
    public boolean station_imperial_base_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean station_imperial_base_condition_isPlayerRebel(obj_id player, obj_id npc)
    {
        return (space_battlefield.isInRebelShip(player) || pvpGetAlignedFaction(player) == (370444368));
    }
    public boolean station_imperial_base_condition_hasReceivedReward_recovery_red_tie(obj_id player, obj_id npc)
    {
        return space_quest.hasReceivedReward(player, "recovery", "ep3_red_tie_recovery");
    }
    public boolean station_imperial_base_condition_isImperialFactionWithMission(obj_id player, obj_id npc)
    {
    ...
    public boolean station_imperial_base_condition_isInYacht(obj_id player, obj_id npc)
    {
    ...
    public boolean station_imperial_base_condition_isPlayerNeutral(obj_id player, obj_id npc)
    {
        if (space_battlefield.isInNeutralShip(player))
        {
    ...
    public boolean station_imperial_base_condition_isTooFar(obj_id player, obj_id npc)
    {
        obj_id containingShip = space_transition.getContainingShip(player);
        return (getDistance(npc, containingShip) > space_transition.STATION_COMM_MAX_DISTANCE);
    }
    public boolean station_imperial_base_condition_hasFailed_recovery_red_tie(obj_id player, obj_id npc)
    {
    ...
    public boolean station_imperial_base_condition_hasFailed_escort_alpha(obj_id player, obj_id npc)
    {
        return space_quest.hasFailedQuest(player, "escort", "ep3_kash_station_imperial_escort_alpha");
    }
    public boolean station_imperial_base_condition_isOnQuest_escort(obj_id player, obj_id npc)
    {
        return space_quest.hasQuest(player, "escort", "ep3_kash_station_imperial_escort_alpha");
    }
    public boolean station_imperial_base_condition_hasReceivedReward_escort_apha(obj_id player, obj_id npc)
    {
        return space_quest.hasReceivedReward(player, "escort", "ep3_kash_station_imperial_escort_alpha");
    }
    public boolean station_imperial_base_condition_isReadyfor_escort_alpha(obj_id player, obj_id npc)
    {
    ...
    public boolean station_imperial_base_condition_isOnQuest_recovery(obj_id player, obj_id npc)
    {
        return space_quest.hasQuest(player, "recovery", "ep3_red_tie_recovery");
    }
    public boolean station_imperial_base_condition_hasWon_recovery_red_tie(obj_id player, obj_id npc)
    {
    ...
    public boolean station_imperial_base_condition_hasWon_escort_alpha(obj_id player, obj_id npc)
    {
        return (space_quest.hasWonQuest(player, "escort", "ep3_kash_station_imperial_escort_alpha"));
    }
    public boolean station_imperial_base_condition_isIn_Red_TIE_Interceptor(obj_id player, obj_id npc)
    {
    ...
    public void station_imperial_base_action_grantDuty_destroy(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "ep3_kash_station_destroy_duty_imperial");
    }
    public void station_imperial_base_action_grantDuty_escort(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "escort_duty", "ep3_kash_station_escort_duty_imperial");
    }
    public void station_imperial_base_action_grantMission_escort_alpha(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "escort", "ep3_kash_station_imperial_escort_alpha");
    }
    public void station_imperial_base_action_setPlayerToOvertStatus(obj_id player, obj_id npc)
    {
        space_transition.setPlayerOvert(player, (-615855020));
    }
    public void station_imperial_base_action_giveReward_escort_alpha(obj_id player, obj_id npc)
    {
    ...
    public void station_imperial_base_action_grantMission_recovery_red_tie(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "recovery", "ep3_red_tie_recovery");
    }
    public void station_imperial_base_action_giveReward_red_tie(obj_id player, obj_id npc)
    {
    ...
    public int station_imperial_base_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_imperial_base_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_imperial_base_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_imperial_base_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_imperial_base_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_imperial_base_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_imperial_base_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_imperial_base_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_imperial_base_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_imperial_base_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_imperial_base_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_imperial_base_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_imperial_base_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_imperial_base_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_imperial_base_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_imperial_base_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_imperial_base_handleBranch30(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_imperial_base_handleBranch32(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_imperial_base_handleBranch34(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_imperial_base_handleBranch37(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_imperial_base_handleBranch38(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_imperial_base_handleBranch39(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_370822d1"))
        {
            if (station_imperial_base_condition__defaultCondition(player, npc))
