...
public class trial_foreman_koseyet extends script.base_script
{
    ...
    public boolean trial_foreman_koseyet_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean trial_foreman_koseyet_condition_isArmyActive(obj_id player, obj_id npc)
    {
        obj_id top = trial.getParent(npc);
        return (trial.isDroidArmyDefeated(top) == false);
    }
    public boolean trial_foreman_koseyet_condition_isArmyDefeated(obj_id player, obj_id npc)
    {
        obj_id top = trial.getParent(npc);
        return (trial.isDroidArmyDefeated(top) == true);
    }
    public void trial_foreman_koseyet_action_ejectFromInstance(obj_id player, obj_id npc)
    {
        instance.requestExitPlayer("mustafar_droid_army", player);
    }
    public void trial_foreman_koseyet_action_faceLowerCamp(obj_id player, obj_id npc)
    {
        obj_id parent = trial.getParent(npc);
        faceTo(npc, parent);
    }
    public int trial_foreman_koseyet_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int trial_foreman_koseyet_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int trial_foreman_koseyet_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int trial_foreman_koseyet_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int trial_foreman_koseyet_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
