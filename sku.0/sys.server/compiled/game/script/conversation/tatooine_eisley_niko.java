...
public class tatooine_eisley_niko extends script.base_script
{
    ...
    public boolean tatooine_eisley_niko_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tatooine_eisley_niko_condition_nikoQuestComplete(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_eisley_nikos_coins");
        boolean OnTask = (questIsQuestComplete(questId1, player));
        return OnTask;
    }
    public boolean tatooine_eisley_niko_condition_nikoTaskComplete(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_eisley_nikos_coins");
    ...
    public boolean tatooine_eisley_niko_condition_nikoOnTask(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_eisley_nikos_coins");
    ...
    public boolean tatooine_eisley_niko_condition_blocker(obj_id player, obj_id npc)
    {
        return groundquests.isQuestDisabled("tatooine_eisley_nikos_coins");
    }
    public boolean tatooine_eisley_niko_condition_legacyOnTask(obj_id player, obj_id npc)
    {
    ...
    public boolean tatooine_eisley_niko_condition_OnNPEHandoff(obj_id player, obj_id npc)
    {
    ...
    public boolean tatooine_eisley_niko_condition_NPEHandoffAbandon(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_eisley_gotoniko");
    ...
    public boolean tatooine_eisley_niko_condition_alreadyOnNiko(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "tatooine_eisley_nikos_coins");
    }
    public void tatooine_eisley_niko_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void tatooine_eisley_niko_action_grantNikoQuest(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/tatooine_eisley_nikos_coins");
        groundquests.grantQuest(questId, player, npc, true);
    }
    public void tatooine_eisley_niko_action_signalNikoReward(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tat_eisley_nikos_coins_e2");
    }
    public void tatooine_eisley_niko_action_signalTalkNiko(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tat_eisley_gotoniko_e3");
        groundquests.sendSignal(player, "tat_eisley_gotoniko_postmayor_e1");
        faceTo(npc, player);
    }
    public void tatooine_eisley_niko_action_grantGotoDunir(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/tatooine_eisley_gotodunir");
        groundquests.grantQuest(questId, player, npc, true);
    }
    public int tatooine_eisley_niko_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_niko_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_niko_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_niko_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_niko_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_niko_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_niko_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_niko_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_29"))
        {
            if (tatooine_eisley_niko_condition__defaultCondition(player, npc))
    ...
    public int tatooine_eisley_niko_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_niko_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_niko_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
