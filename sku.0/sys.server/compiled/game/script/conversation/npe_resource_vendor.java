...
public class npe_resource_vendor extends script.base_script
{
    ...
    public boolean npe_resource_vendor_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_resource_vendor_condition_has100credits(obj_id player, obj_id npc)
    {
    ...
    public void npe_resource_vendor_action_sellMetal(obj_id player, obj_id npc)
    {
    ...
    public void npe_resource_vendor_action_sellFlowers(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        money.requestPayment(player, npc, 100, "pass_fail", params, true);
        obj_id[] myResources = new obj_id[1];
    ...
    public void npe_resource_vendor_action_sellFiberplast(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        money.requestPayment(player, npc, 100, "pass_fail", params, true);
        obj_id[] myResources = new obj_id[1];
    ...
    public void npe_resource_vendor_action_sellGemstones(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        money.requestPayment(player, npc, 100, "pass_fail", params, true);
        obj_id[] myResources = new obj_id[1];
    ...
    public void npe_resource_vendor_action_sellWater(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        money.requestPayment(player, npc, 100, "pass_fail", params, true);
        obj_id[] myResources = new obj_id[1];
    ...
    public void npe_resource_vendor_action_sellCereal(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        money.requestPayment(player, npc, 100, "pass_fail", params, true);
        obj_id[] myResources = new obj_id[1];
    ...
    public void npe_resource_vendor_action_sellCraftingTool(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        money.requestPayment(player, npc, 100, "pass_fail", params, true);
    ...
    public int npe_resource_vendor_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_resource_vendor_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_resource_vendor_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_resource_vendor_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_resource_vendor_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_resource_vendor_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_resource_vendor_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_resource_vendor_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_resource_vendor_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
