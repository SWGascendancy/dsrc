...
public class npe_artisan_questgiver extends script.base_script
{
    ...
    public boolean npe_artisan_questgiver_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_artisan_questgiver_condition_playerOnFirstQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "npe_artisan_1");
    }
    public boolean npe_artisan_questgiver_condition_playerOnFirstQuestRewardStep(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_artisan_1", "returnSignal");
    }
    public boolean npe_artisan_questgiver_condition_playerFinishedFirstQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_artisan_1");
    }
    public boolean npe_artisan_questgiver_condition_playeronSecondQuest(obj_id player, obj_id npc)
    {
        return (groundquests.isQuestActive(player, "npe_artisan_2a") || groundquests.isQuestActive(player, "npe_artisan_2b"));
    }
    public boolean npe_artisan_questgiver_condition_playerCompletedSecondQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_artisan_2b");
    }
    public boolean npe_artisan_questgiver_condition_playerfailed2b(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedQuest(player, "npe_artisan_2a") && !groundquests.isQuestActive(player, "npe_artisan_2b"));
    }
    public void npe_artisan_questgiver_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void npe_artisan_questgiver_action_givePlayerArtisan1(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_artisan_1");
    }
    public void npe_artisan_questgiver_action_givePlayerArtisan2a(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_artisan_2a");
    }
    public void npe_artisan_questgiver_action_givePlayerArtisan2b(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_artisan_2b");
    }
    public void npe_artisan_questgiver_action_SignalQ1Reward(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_artisan_1_reward");
    }
    public void npe_artisan_questgiver_action_SignalQ2bReward(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_artisan_2b_reward");
    }
    public int npe_artisan_questgiver_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_artisan_questgiver_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_artisan_questgiver_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_artisan_questgiver_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_artisan_questgiver_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_artisan_questgiver_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_artisan_questgiver_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_41"))
        {
            if (npe_artisan_questgiver_condition__defaultCondition(player, npc))
    ...
    public int npe_artisan_questgiver_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_artisan_questgiver_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_41"))
        {
            if (npe_artisan_questgiver_condition__defaultCondition(player, npc))
    ...
    public int npe_artisan_questgiver_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_artisan_questgiver_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_artisan_questgiver_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_artisan_questgiver_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_artisan_questgiver_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_artisan_questgiver_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
