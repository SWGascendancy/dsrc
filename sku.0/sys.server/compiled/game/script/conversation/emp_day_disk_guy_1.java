...
public class emp_day_disk_guy_1 extends script.base_script
{
    ...
    public boolean emp_day_disk_guy_1_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean emp_day_disk_guy_1_condition_hasTask3a(obj_id player, obj_id npc)
    {
    ...
    public void emp_day_disk_guy_1_action_triggerAndWp(obj_id player, obj_id npc)
    {
    ...
    public int emp_day_disk_guy_1_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
