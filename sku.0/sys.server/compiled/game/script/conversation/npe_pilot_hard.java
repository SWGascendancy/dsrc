...
public class npe_pilot_hard extends script.base_script
{
    ...
    public boolean npe_pilot_hard_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_pilot_hard_condition_isOnMission(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_pilot_hard_condition_hasCompletedMed(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_pilot_medium_4");
    }
    public boolean npe_pilot_hard_condition_doneWithPilot(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_pilot_hard_3");
    }
    public boolean npe_pilot_hard_condition_hasFailedHardMission1(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_pilot_hard_1", "failedHard1");
    }
    public boolean npe_pilot_hard_condition_hasWonHardMission1(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedQuest(player, "npe_pilot_hard_1") || groundquests.isTaskActive(player, "npe_pilot_hard_1", "report"));
    }
    public boolean npe_pilot_hard_condition_hasFailedHardMission2(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_pilot_hard_2", "failedHard2");
    }
    public boolean npe_pilot_hard_condition_hasWonHardMission2(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_pilot_hard_2", "report");
    }
    public boolean npe_pilot_hard_condition_hasFailedHardMission3(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_pilot_hard_3", "failedHard3");
    }
    public boolean npe_pilot_hard_condition_hasWonHardMission3(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedQuest(player, "npe_pilot_hard_3") || groundquests.isTaskActive(player, "npe_pilot_hard_3", "report"));
    }
    public void npe_pilot_hard_action_grantReward(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "reported");
    }
    public void npe_pilot_hard_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void npe_pilot_hard_action_removeDartas3(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talktome");
        removeObjVar(player, "dartas3");
    }
    public void npe_pilot_hard_action_grantHardMission2(obj_id player, obj_id npc)
    {
    ...
    public void npe_pilot_hard_action_grantHardMission1(obj_id player, obj_id npc)
    {
    ...
    public void npe_pilot_hard_action_grantHardMission3(obj_id player, obj_id npc)
    {
    ...
    public void npe_pilot_hard_action_signalFoundDartas(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talktome");
    }
    public int npe_pilot_hard_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_hard_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_hard_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_hard_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_hard_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_hard_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_hard_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_hard_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_hard_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_hard_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_hard_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_hard_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_hard_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_hard_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_hard_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_hard_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_hard_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_pilot_hard_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
