...
public class ep3_etyyy_sordaan_xris extends script.base_script
{
    ...
    public boolean ep3_etyyy_sordaan_xris_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_etyyy_sordaan_xris_condition_eligibleForABet(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_hunt_tuwezz_collect_uller_horns");
    }
    public boolean ep3_etyyy_sordaan_xris_condition_lostWallugaBet(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_hunt_sordaan_walluga_bet_lost");
    }
    public boolean ep3_etyyy_sordaan_xris_condition_wonWallugaBet(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_hunt_sordaan_walluga_bet_won");
    }
    public boolean ep3_etyyy_sordaan_xris_condition_lostMoufBet(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_hunt_sordaan_mouf_bet_lost");
    }
    public boolean ep3_etyyy_sordaan_xris_condition_sentByKerssoc(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "ep3_hunt_kerssoc_enter_etyyy", "etyyy_talkToSordaan"));
    }
    public boolean ep3_etyyy_sordaan_xris_condition_speakWithSordaan(obj_id player, obj_id npc)
    {
        return (groundquests.isQuestActive(player, "ep3_hunt_sordaan_seek_sordaan"));
    }
    public boolean ep3_etyyy_sordaan_xris_condition_sentToZivenFirst(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "ep3_hunt_kerssoc_enter_etyyy", "etyyy_talkToZiven"));
    }
    public boolean ep3_etyyy_sordaan_xris_condition_finishedTuwezz(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "ep3_hunt_sordaan_seek_sordaan", "sordaan_tuwezzSendsYou");
    }
    public boolean ep3_etyyy_sordaan_xris_condition_finishedEhartt(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "ep3_hunt_sordaan_seek_sordaan", "sordaan_eharttSendsYou");
    }
    public boolean ep3_etyyy_sordaan_xris_condition_finishedTripp(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "ep3_hunt_sordaan_seek_sordaan", "sordaan_trippSendsYou");
    }
    public boolean ep3_etyyy_sordaan_xris_condition_finishedZiven(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "ep3_hunt_sordaan_seek_sordaan", "sordaan_zivenSendsYou");
    }
    public boolean ep3_etyyy_sordaan_xris_condition_betAlreadyActive(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_etyyy_sordaan_xris_condition_eligibleForWallugaBet(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_etyyy_sordaan_xris_condition_eligibleForMoufBet(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_etyyy_sordaan_xris_condition_eligibleForWebweaverBet(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_etyyy_sordaan_xris_condition_eligibleForAnyBet(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "ep3Etyyy.sordaanBetLevel"))
        {
    ...
    public boolean ep3_etyyy_sordaan_xris_condition_canAffordWebweaverBet(obj_id player, obj_id npc)
    {
        return money.hasFunds(player, money.MT_TOTAL, 25000);
    }
    public boolean ep3_etyyy_sordaan_xris_condition_canAffordMoufBet(obj_id player, obj_id npc)
    {
        return money.hasFunds(player, money.MT_TOTAL, 10000);
    }
    public boolean ep3_etyyy_sordaan_xris_condition_canAffordWallugaBet(obj_id player, obj_id npc)
    {
        return money.hasFunds(player, money.MT_TOTAL, 5000);
    }
    public boolean ep3_etyyy_sordaan_xris_condition_canAffordUllerBet(obj_id player, obj_id npc)
    {
        return money.hasFunds(player, money.MT_TOTAL, 2000);
    }
    public boolean ep3_etyyy_sordaan_xris_condition_lostUllerBet(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_hunt_sordaan_uller_bet_lost");
    }
    public boolean ep3_etyyy_sordaan_xris_condition_wonUllerBet(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_hunt_sordaan_uller_bet_won");
    }
    public boolean ep3_etyyy_sordaan_xris_condition_wonMoufBet(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_hunt_sordaan_mouf_bet_won");
    }
    public boolean ep3_etyyy_sordaan_xris_condition_lostWebweaverBet(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_hunt_sordaan_webweaver_bet_lost");
    }
    public boolean ep3_etyyy_sordaan_xris_condition_wonWebweaverBet(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_hunt_sordaan_webweaver_bet_won");
    }
    public boolean ep3_etyyy_sordaan_xris_condition_betWonByPlayer(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_etyyy_sordaan_xris_condition_betLostByPlayer(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_etyyy_sordaan_xris_condition_hasNotSeenHarroom(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_hunt_sordaan_seek_harroom");
    }
    public boolean ep3_etyyy_sordaan_xris_condition_notGottenUllerReward(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_etyyy_sordaan_xris_condition_notGottenWallugaReward(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_etyyy_sordaan_xris_condition_notGottenMoufReward(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_etyyy_sordaan_xris_condition_notGottenWebweaverReward(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_etyyy_sordaan_xris_condition_killedEtyyyNamedCreatures(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_hunt_loot_completed_all");
    }
    public boolean ep3_etyyy_sordaan_xris_condition_destroyedBocctyyyTicket(obj_id player, obj_id npc)
    {
    ...
    public void ep3_etyyy_sordaan_xris_action_sendToManfred(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "sordaan_talkToSordaan");
        groundquests.grantQuest(player, "ep3_hunt_manfred_steal_chiss_goods");
    }
    public void ep3_etyyy_sordaan_xris_action_sendToZiven(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "sordaan_talkToSordaan");
        groundquests.grantQuest(player, "ep3_hunt_ziven_collect_webweaver_fangs");
    }
    public void ep3_etyyy_sordaan_xris_action_firstToZiven(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "etyyy_talkToSordaan");
    }
    public void ep3_etyyy_sordaan_xris_action_sendToEhartt(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "sordaan_talkToSordaan");
        groundquests.grantQuest(player, "ep3_hunt_ehartt_collect_walluga_claws");
    }
    public void ep3_etyyy_sordaan_xris_action_giveWebweaverBet(obj_id player, obj_id npc)
    {
        String ticketTemplate = "object/tangible/travel/travel_ticket/bocctyyy_path_ticket.iff";
    ...
    public void ep3_etyyy_sordaan_xris_action_giveMoufBet(obj_id player, obj_id npc)
    {
        String ticketTemplate = "object/tangible/travel/travel_ticket/bocctyyy_path_ticket.iff";
        obj_id ticket = space_dungeon.createTicket(player, "kashyyyk_hunting", "kashyyyk_hunting", space_dungeon.KASH_THE_BET, ticketTemplate);
        if (isIdValid(ticket))
    ...
    public void ep3_etyyy_sordaan_xris_action_giveUllerBet(obj_id player, obj_id npc)
    {
        String ticketTemplate = "object/tangible/travel/travel_ticket/bocctyyy_path_ticket.iff";
        obj_id ticket = space_dungeon.createTicket(player, "kashyyyk_hunting", "kashyyyk_hunting", space_dungeon.KASH_THE_BET, ticketTemplate);
        if (isIdValid(ticket))
    ...
    public void ep3_etyyy_sordaan_xris_action_giveWallugaBet(obj_id player, obj_id npc)
    {
        String ticketTemplate = "object/tangible/travel/travel_ticket/bocctyyy_path_ticket.iff";
        obj_id ticket = space_dungeon.createTicket(player, "kashyyyk_hunting", "kashyyyk_hunting", space_dungeon.KASH_THE_BET, ticketTemplate);
        if (isIdValid(ticket))
    ...
    public void ep3_etyyy_sordaan_xris_action_playerUllerWin(obj_id player, obj_id npc)
    {
        int WALLUGA_BET_LEVEL = 1;
        if (hasObjVar(player, "ep3Etyyy.sordaanBetLevel"))
        {
    ...
    public void ep3_etyyy_sordaan_xris_action_playerWallugaWin(obj_id player, obj_id npc)
    {
        int MOUF_BET_LEVEL = 2;
        if (hasObjVar(player, "ep3Etyyy.sordaanBetLevel"))
        {
    ...
    public void ep3_etyyy_sordaan_xris_action_playerMoufWin(obj_id player, obj_id npc)
    {
        int WEBWEAVER_BET_LEVEL = 3;
        if (hasObjVar(player, "ep3Etyyy.sordaanBetLevel"))
        {
    ...
    public void ep3_etyyy_sordaan_xris_action_playerWebweaverWin(obj_id player, obj_id npc)
    {
        int ALL_BETS_BET_LEVEL = 4;
    ...
    public void ep3_etyyy_sordaan_xris_action_playerWebweaverLost(obj_id player, obj_id npc)
    {
    ...
    public void ep3_etyyy_sordaan_xris_action_playerMoufLost(obj_id player, obj_id npc)
    {
    ...
    public void ep3_etyyy_sordaan_xris_action_playerWallugaLost(obj_id player, obj_id npc)
    {
    ...
    public void ep3_etyyy_sordaan_xris_action_playerUllerLost(obj_id player, obj_id npc)
    {
    ...
    public void ep3_etyyy_sordaan_xris_action_fromZivenHunt(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "sordaan_talkToSordaan");
    }
    public void ep3_etyyy_sordaan_xris_action_giveUllerReward(obj_id player, obj_id npc)
    {
    ...
    public void ep3_etyyy_sordaan_xris_action_giveWallugaReward(obj_id player, obj_id npc)
    {
        ep3_etyyy_sordaan_xris_action_playerWallugaWin(player, npc);
        groundquests.grantQuest(player, "ep3_hunt_sordaan_seek_harroom", false);
        groundquests.sendSignal(player, "sordaan_wallugaBetReward");
    }
    public void ep3_etyyy_sordaan_xris_action_giveMoufReward(obj_id player, obj_id npc)
    {
        ep3_etyyy_sordaan_xris_action_playerMoufWin(player, npc);
        groundquests.grantQuest(player, "ep3_hunt_sordaan_seek_harroom", false);
        groundquests.sendSignal(player, "sordaan_moufBetReward");
    }
    public void ep3_etyyy_sordaan_xris_action_giveWebweaverReward(obj_id player, obj_id npc)
    {
    ...
    public void ep3_etyyy_sordaan_xris_action_giveEtyyyNamedCreaturesReward(obj_id player, obj_id npc)
    {
    ...
    public void ep3_etyyy_sordaan_xris_action_giveReplacementTicket(obj_id player, obj_id npc)
    {
        String ticketTemplate = "object/tangible/travel/travel_ticket/bocctyyy_path_ticket.iff";
        obj_id ticket = space_dungeon.createTicket(player, "kashyyyk_hunting", "kashyyyk_hunting", space_dungeon.KASH_THE_BET, ticketTemplate);
        if (isIdValid(ticket))
    ...
    public String ep3_etyyy_sordaan_xris_tokenTO_playerName(obj_id player, obj_id npc)
    {
        return getFirstName(player);
    }
    public int ep3_etyyy_sordaan_xris_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_sordaan_xris_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_sordaan_xris_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_sordaan_xris_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_sordaan_xris_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_sordaan_xris_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_sordaan_xris_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_sordaan_xris_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_sordaan_xris_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_sordaan_xris_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_sordaan_xris_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_sordaan_xris_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_sordaan_xris_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_sordaan_xris_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_sordaan_xris_handleBranch30(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_sordaan_xris_handleBranch32(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_sordaan_xris_handleBranch36(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_sordaan_xris_handleBranch42(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_sordaan_xris_handleBranch44(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_1192"))
        {
            if (ep3_etyyy_sordaan_xris_condition_notGottenUllerReward(player, npc))
    ...
    public int ep3_etyyy_sordaan_xris_handleBranch45(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_1270"))
        {
            if (ep3_etyyy_sordaan_xris_condition__defaultCondition(player, npc))
    ...
    public int ep3_etyyy_sordaan_xris_handleBranch46(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_sordaan_xris_handleBranch49(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_sordaan_xris_handleBranch50(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_sordaan_xris_handleBranch51(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_sordaan_xris_handleBranch52(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_sordaan_xris_handleBranch53(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_1414"))
        {
            if (!ep3_etyyy_sordaan_xris_condition_canAffordUllerBet(player, npc))
    ...
    public int ep3_etyyy_sordaan_xris_handleBranch55(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_sordaan_xris_handleBranch56(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_1334"))
        {
            if (!ep3_etyyy_sordaan_xris_condition_canAffordWebweaverBet(player, npc))
    ...
    public int ep3_etyyy_sordaan_xris_handleBranch60(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_1366"))
        {
            if (!ep3_etyyy_sordaan_xris_condition_canAffordMoufBet(player, npc))
    ...
    public int ep3_etyyy_sordaan_xris_handleBranch61(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_1394"))
        {
            if (!ep3_etyyy_sordaan_xris_condition_canAffordWallugaBet(player, npc))
    ...
    public int ep3_etyyy_sordaan_xris_handleBranch62(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_1414"))
        {
            if (!ep3_etyyy_sordaan_xris_condition_canAffordUllerBet(player, npc))
    ...
    public int ep3_etyyy_sordaan_xris_handleBranch64(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_sordaan_xris_handleBranch65(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_1366"))
        {
            if (!ep3_etyyy_sordaan_xris_condition_canAffordMoufBet(player, npc))
    ...
    public int ep3_etyyy_sordaan_xris_handleBranch69(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_1394"))
        {
            if (!ep3_etyyy_sordaan_xris_condition_canAffordWallugaBet(player, npc))
    ...
    public int ep3_etyyy_sordaan_xris_handleBranch70(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_1414"))
        {
            if (!ep3_etyyy_sordaan_xris_condition_canAffordUllerBet(player, npc))
    ...
    public int ep3_etyyy_sordaan_xris_handleBranch72(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_sordaan_xris_handleBranch73(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_1394"))
        {
            if (!ep3_etyyy_sordaan_xris_condition_canAffordWallugaBet(player, npc))
    ...
    public int ep3_etyyy_sordaan_xris_handleBranch77(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_1414"))
        {
            if (!ep3_etyyy_sordaan_xris_condition_canAffordUllerBet(player, npc))
    ...
    public int ep3_etyyy_sordaan_xris_handleBranch79(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_1414"))
        {
            if (!ep3_etyyy_sordaan_xris_condition_canAffordUllerBet(player, npc))
    ...
    public int ep3_etyyy_sordaan_xris_handleBranch84(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_sordaan_xris_handleBranch85(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_sordaan_xris_handleBranch86(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_sordaan_xris_handleBranch87(obj_id player, obj_id npc, string_id response)
    {
