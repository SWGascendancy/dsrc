...
public class corellia_38_ubbal_fenn extends script.base_script
{
    ...
    public boolean corellia_38_ubbal_fenn_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_38_ubbal_fenn_condition_taskOneActive(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_38_corsec_files_02", "corsec_files_02_04");
    }
    public boolean corellia_38_ubbal_fenn_condition_questComplete(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "corellia_38_corsec_files_02", "corsec_files_02_04");
    }
    public void corellia_38_ubbal_fenn_action_taskOneCompletedSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "corsec_files_02_04");
    }
    public int corellia_38_ubbal_fenn_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_38_ubbal_fenn_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
