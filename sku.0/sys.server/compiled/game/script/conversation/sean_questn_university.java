...
public class sean_questn_university extends script.base_script
{
    ...
    public boolean sean_questn_university_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean sean_questn_university_condition_NegQObj(obj_id player, obj_id npc)
    {
    ...
    public boolean sean_questn_university_condition_alreadyHasEvidence(obj_id player, obj_id npc)
    {
        return utils.playerHasItemByTemplate(player, "object/tangible/loot/quest/sean_questn_gpapers.iff");
    }
    public boolean sean_questn_university_condition_NoRoom1Obj(obj_id player, obj_id npc)
    {
        if (hasObjVar(npc, "bestine.electionStarted"))
        {
            int electionNum = getIntObjVar(npc, "bestine.electionStarted");
    ...
    public boolean sean_questn_university_condition_nonoffice(obj_id player, obj_id npc)
    {
        return hasObjVar(npc, "bestine.electionEnded");
    }
    public boolean sean_questn_university_condition_noInventorySpace(obj_id player, obj_id npc)
    {
    ...
    public void sean_questn_university_action__defaultAction(obj_id player, obj_id npc)
    {
    }
    public void sean_questn_university_action_NoRoom1(obj_id player, obj_id npc)
    {
        int electionNum = getIntObjVar(npc, "bestine.electionStarted");
        setObjVar(player, "bestine.sean_university_noroom", electionNum);
    }
    public void sean_questn_university_action_givePapers(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "bestine.sean_university_noroom"))
        {
