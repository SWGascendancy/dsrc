...
public class disable_sidequest extends script.base_script
{
    ...
    public boolean disable_sidequest_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean disable_sidequest_condition_hasReward(obj_id player, obj_id npc)
    {
    ...
    public boolean disable_sidequest_condition_hasWonMission1(obj_id player, obj_id npc)
    {
    ...
    public boolean disable_sidequest_condition_readyForMission2(obj_id player, obj_id npc)
    {
    ...
    public void disable_sidequest_action_grantMission1(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        space_quest.grantQuest(player, "inspect", "robot_sidequest");
    }
    public void disable_sidequest_action_animExplain(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        doAnimationAction(npc, "explain");
    }
    public void disable_sidequest_action_giveRewardMission1(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        if (!space_quest.hasReceivedReward(player, "inspect", "robot_sidequest"))
        {
    ...
    public void disable_sidequest_action_animNodHead(obj_id player, obj_id npc)
    {
        setName(npc, "CSSD-7");
    ...
    public void disable_sidequest_action_animConverse(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        doAnimationAction(npc, "conversation_1");
    }
    public void disable_sidequest_action_animStop(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        doAnimationAction(npc, "stop");
    }
    public void disable_sidequest_action_animSalute(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        doAnimationAction(npc, "salute1");
    }
    public void disable_sidequest_action_animBye(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        doAnimationAction(npc, "goodbye");
    }
    public void disable_sidequest_action_animBothSalute(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        doAnimationAction(npc, "salute1");
        doAnimationAction(player, "salute1");
    }
    public void disable_sidequest_action_animDisgust(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        doAnimationAction(npc, "shake_head_disgust");
    }
    public void disable_sidequest_action_animGestureWild(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        doAnimationAction(npc, "gesticulate_wildly");
    }
    public void disable_sidequest_action_animPointAway(obj_id player, obj_id npc)
    {
        doAnimationAction(npc, "point_away");
    }
    public void disable_sidequest_action_animPoundFist(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        doAnimationAction(npc, "pound_fist_palm");
    }
    public void disable_sidequest_action_animRubChin(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        doAnimationAction(npc, "rub_chin_thoughtful");
    }
    public void disable_sidequest_action_animPoliteApplause(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        doAnimationAction(player, "salute1");
        doAnimationAction(npc, "applause_polite");
    }
    public void disable_sidequest_action_animWaveFinger(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        doAnimationAction(npc, "wave_finger_warning");
    }
    public void disable_sidequest_action_animRaiseFist(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        doAnimationAction(npc, "standing_raise_fist");
    }
    public int disable_sidequest_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int disable_sidequest_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int disable_sidequest_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int disable_sidequest_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int disable_sidequest_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int disable_sidequest_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int disable_sidequest_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int disable_sidequest_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int disable_sidequest_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int disable_sidequest_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int disable_sidequest_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int disable_sidequest_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int disable_sidequest_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int disable_sidequest_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int disable_sidequest_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int disable_sidequest_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int disable_sidequest_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int disable_sidequest_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int disable_sidequest_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int disable_sidequest_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int disable_sidequest_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int disable_sidequest_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
