...
public class sean_questp_house extends script.base_script
{
    ...
    public boolean sean_questp_house_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean sean_questp_house_condition_CampObj(obj_id player, obj_id npc)
    {
    ...
    public boolean sean_questp_house_condition_HouseTesti(obj_id player, obj_id npc)
    {
    ...
    public boolean sean_questp_house_condition_noroomObjVar(obj_id player, obj_id npc)
    {
        if (hasObjVar(npc, "bestine.electionStarted"))
        {
            int electionNum = getIntObjVar(npc, "bestine.electionStarted");
    ...
    public boolean sean_questp_house_condition_nonoffice(obj_id player, obj_id npc)
    {
        return hasObjVar(npc, "bestine.electionEnded");
    }
    public boolean sean_questp_house_condition_noInventorySpace(obj_id player, obj_id npc)
    {
    ...
    public boolean sean_questp_house_condition_alreadyHasEvidence(obj_id player, obj_id npc)
    {
        return utils.playerHasItemByTemplate(player, "object/tangible/loot/quest/sean_questp_htestimony.iff");
    }
    public void sean_questp_house_action__defaultAction(obj_id player, obj_id npc)
    {
    }
    public void sean_questp_house_action_NoRoom(obj_id player, obj_id npc)
    {
        int electionNum = getIntObjVar(npc, "bestine.electionStarted");
        setObjVar(player, "bestine.bestine.sean_house_noroom", electionNum);
    }
    public void sean_questp_house_action_giveTestimony(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "bestine.sean_house_noroom"))
        {
