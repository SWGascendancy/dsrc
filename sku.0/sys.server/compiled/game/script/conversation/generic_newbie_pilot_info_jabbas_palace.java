...
public class generic_newbie_pilot_info_jabbas_palace extends script.base_script
{
    ...
    public boolean generic_newbie_pilot_info_jabbas_palace_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean generic_newbie_pilot_info_jabbas_palace_condition_remembersPlayer(obj_id player, obj_id npc)
    {
        return (utils.hasScriptVar(player, "metNewbiePilot"));
    }
    public boolean generic_newbie_pilot_info_jabbas_palace_condition_hasAccessDocuments(obj_id player, obj_id npc)
    {
    ...
    public boolean generic_newbie_pilot_info_jabbas_palace_condition_hasIncorrectDocuments(obj_id player, obj_id npc)
    {
    ...
    public boolean generic_newbie_pilot_info_jabbas_palace_condition_isImperialPilot(obj_id player, obj_id npc)
    {
        return (hasSkill(player, "pilot_imperial_navy_novice"));
    }
    public boolean generic_newbie_pilot_info_jabbas_palace_condition_isRebelPilot(obj_id player, obj_id npc)
    {
        return (hasSkill(player, "pilot_rebel_navy_novice"));
    }
    public boolean generic_newbie_pilot_info_jabbas_palace_condition_hasUnsignedDocuments(obj_id player, obj_id npc)
    {
        obj_id auth = utils.getObjIdScriptVar(player, "auth");
        if (!isIdValid(auth))
        {
    ...
    public boolean generic_newbie_pilot_info_jabbas_palace_condition_notCorrectPilot(obj_id player, obj_id npc)
    {
    ...
    public boolean generic_newbie_pilot_info_jabbas_palace_condition_isPrivateerPilot(obj_id player, obj_id npc)
    {
        return hasSkill(player, "pilot_neutral_novice");
    }
    public boolean generic_newbie_pilot_info_jabbas_palace_condition_hasSpaceExpansion(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean generic_newbie_pilot_info_jabbas_palace_condition_hasSpaceShip(obj_id player, obj_id npc)
    {
        return (space_quest.hasShip(player));
    }
    public void generic_newbie_pilot_info_jabbas_palace_action_rememberPlayer(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "metNewbiePilot", true);
    }
    public void generic_newbie_pilot_info_jabbas_palace_action_removeAccessDocuments(obj_id player, obj_id npc)
    {
        obj_id pInv = utils.getInventoryContainer(player);
        if (pInv == null)
        {
    ...
    public void generic_newbie_pilot_info_jabbas_palace_action_grantQuestOne(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "delivery", "tatooine_newbie_1");
        space_quest.grantNewbieShip(player, "rebel");
    }
    public int generic_newbie_pilot_info_jabbas_palace_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int generic_newbie_pilot_info_jabbas_palace_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int generic_newbie_pilot_info_jabbas_palace_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int generic_newbie_pilot_info_jabbas_palace_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int generic_newbie_pilot_info_jabbas_palace_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int generic_newbie_pilot_info_jabbas_palace_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_2c017871"))
        {
            if (generic_newbie_pilot_info_jabbas_palace_condition__defaultCondition(player, npc))
    ...
    public int generic_newbie_pilot_info_jabbas_palace_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_2c017871"))
        {
            if (generic_newbie_pilot_info_jabbas_palace_condition__defaultCondition(player, npc))
    ...
    public int generic_newbie_pilot_info_jabbas_palace_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int generic_newbie_pilot_info_jabbas_palace_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int generic_newbie_pilot_info_jabbas_palace_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int generic_newbie_pilot_info_jabbas_palace_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_daa8544b"))
        {
            if (generic_newbie_pilot_info_jabbas_palace_condition__defaultCondition(player, npc))
    ...
    public int generic_newbie_pilot_info_jabbas_palace_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_5c484c74"))
        {
            if (generic_newbie_pilot_info_jabbas_palace_condition__defaultCondition(player, npc))
    ...
    public int generic_newbie_pilot_info_jabbas_palace_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_a9e4fd02"))
        {
            if (generic_newbie_pilot_info_jabbas_palace_condition__defaultCondition(player, npc))
    ...
    public int generic_newbie_pilot_info_jabbas_palace_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_cba77fff"))
        {
            if (generic_newbie_pilot_info_jabbas_palace_condition__defaultCondition(player, npc))
    ...
    public int generic_newbie_pilot_info_jabbas_palace_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_d038a005"))
        {
            if (generic_newbie_pilot_info_jabbas_palace_condition__defaultCondition(player, npc))
    ...
    public int generic_newbie_pilot_info_jabbas_palace_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_2c017871"))
        {
            if (generic_newbie_pilot_info_jabbas_palace_condition__defaultCondition(player, npc))
    ...
    public int generic_newbie_pilot_info_jabbas_palace_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_2c017871"))
        {
            if (generic_newbie_pilot_info_jabbas_palace_condition__defaultCondition(player, npc))
