...
public class padawan_pannaqa_02 extends script.base_script
{
    ...
    public boolean padawan_pannaqa_02_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean padawan_pannaqa_02_condition_isTrialPlayer(obj_id player, obj_id npc)
    {
    ...
    public void padawan_pannaqa_02_action_sendToThirdNpc(obj_id player, obj_id npc)
    {
