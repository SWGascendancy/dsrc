...
public class collections_ice_cream_part_eight extends script.base_script
{
    ...
    public boolean collections_ice_cream_part_eight_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean collections_ice_cream_part_eight_condition_hasActiveTask(obj_id player, obj_id npc)
    {
    ...
    public void collections_ice_cream_part_eight_action_signalNextTask(obj_id player, obj_id npc)
    {
        modifyCollectionSlotValue(player, "col_fried_icecream_part_08", 1);
        groundquests.sendSignal(player, "meet_nore_brrea");
    }
    public int collections_ice_cream_part_eight_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int collections_ice_cream_part_eight_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int collections_ice_cream_part_eight_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int collections_ice_cream_part_eight_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int collections_ice_cream_part_eight_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int collections_ice_cream_part_eight_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
