...
public class gcw_imperial_buff_reward_npc extends script.base_script
{
    ...
    public boolean gcw_imperial_buff_reward_npc_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean gcw_imperial_buff_reward_npc_condition_playerImperial(obj_id player, obj_id npc)
    {
    ...
    public int gcw_imperial_buff_reward_npc_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
