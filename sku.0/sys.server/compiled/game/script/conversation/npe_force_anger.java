...
public class npe_force_anger extends script.base_script
{
    ...
    public boolean npe_force_anger_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_force_anger_condition_isOnQuest(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_force_sensitive", "anger_manage");
    }
    public boolean npe_force_anger_condition_hasCompleted(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "npe_force_sensitive", "anger_manage");
    }
    public void npe_force_anger_action_sendAngerSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_anger_managed");
    }
    public void npe_force_anger_action_playDarkside(obj_id player, obj_id npc)
    {
        groundquests.clearQuest(player, "npe_force_sensitive");
        groundquests.grantQuest(player, "npe_force_dark");
    }
    public int npe_force_anger_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_force_anger_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_force_anger_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_force_anger_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_force_anger_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_force_anger_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_force_anger_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
