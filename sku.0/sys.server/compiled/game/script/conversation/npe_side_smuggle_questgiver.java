...
public class npe_side_smuggle_questgiver extends script.base_script
{
    ...
    public boolean npe_side_smuggle_questgiver_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_side_smuggle_questgiver_condition_canTakeQuest(obj_id player, obj_id npc)
    {
        return space_utils.hasShip(player);
    }
    public boolean npe_side_smuggle_questgiver_condition_hasFinishedTemplate(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "npe.finishedTemplate");
    }
    public boolean npe_side_smuggle_questgiver_condition_stillOnTasks(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_side_smuggle_questgiver_condition_hasReturned(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_side_smuggle_questgiver_condition_finishedQuest(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedQuest(player, "npe_side_smuggle") || groundquests.hasCompletedQuest(player, "npe_side_smuggle_2"));
    }
    public void npe_side_smuggle_questgiver_action_giveQuest(obj_id player, obj_id npc)
    {
    ...
    public void npe_side_smuggle_questgiver_action_sendSignalDone(obj_id player, obj_id npc)
    {
    ...
    public void npe_side_smuggle_questgiver_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void npe_side_smuggle_questgiver_action_pilotPointer(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_job_pointer_serissu");
    }
    public int npe_side_smuggle_questgiver_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_side_smuggle_questgiver_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_side_smuggle_questgiver_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_side_smuggle_questgiver_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_side_smuggle_questgiver_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_side_smuggle_questgiver_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
