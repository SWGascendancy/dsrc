...
public class heroic_sd_intro_neutral extends script.base_script
{
    ...
    public boolean heroic_sd_intro_neutral_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean heroic_sd_intro_neutral_condition_notNeutralFaction(obj_id player, obj_id npc)
    {
        return factions.isImperial(player) || factions.isRebel(player);
    }
    public boolean heroic_sd_intro_neutral_condition_onQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "star_destroyer_intro_neutral");
    }
    public boolean heroic_sd_intro_neutral_condition_returningQuest(obj_id player, obj_id npc)
    {
    ...
    public void heroic_sd_intro_neutral_action_grantIntroQuest(obj_id player, obj_id npc)
    {
    ...
    public void heroic_sd_intro_neutral_action_sendIntroSignal(obj_id player, obj_id npc)
    {
    ...
    public int heroic_sd_intro_neutral_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
