...
public class npe_spy extends script.base_script
{
    ...
    public boolean npe_spy_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_spy_condition_reward1(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "npe_spy_try", "spy"));
    }
    public boolean npe_spy_condition_onQuest2(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "npe_spy_try_2");
    }
    public boolean npe_spy_condition_rewardQuest2(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_spy_condition_wantsSY(obj_id player, obj_id npc)
    {
        return npe_spy_condition_isSYTemplate(player, npc);
    }
    public boolean npe_spy_condition_completedQuest2(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedQuest(player, "npe_spy_try_2"));
    }
    public boolean npe_spy_condition_busy(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_spy_condition_isActiveSYQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "npe_spy_try");
    }
    public boolean npe_spy_condition_completedQuest1(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedQuest(player, "npe_spy_try"));
    }
    public boolean npe_spy_condition_isSYTemplate(obj_id player, obj_id npc)
    {
    ...
    public void npe_spy_action_giveSpyQuest(obj_id player, obj_id npc)
    {
    ...
    public void npe_spy_action_grantQuest2(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_spy_try_2");
    }
    public void npe_spy_action_giveReward2(obj_id player, obj_id npc)
    {
        groundquests.completeQuest(player, "npe_spy_try_2");
    }
    public void npe_spy_action_grantJobPointer(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_job_pointer_han");
        setObjVar(player, "npe.finishedTemplate", 1);
    }
    public void npe_spy_action_giveLostSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "clearQuest");
        faceTo(npc, player);
    }
    public void npe_spy_action_grantCommQuest(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "npe_spy_comm");
    }
    public void npe_spy_action_giveFoundSpy(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "found_spy");
        faceTo(npc, player);
    }
    public void npe_spy_action_giveAssistantPointer(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_pointer_secretary");
    }
    public void npe_spy_action_faceToNoob(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void npe_spy_action_giveReward1(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "reward1");
        groundquests.grantQuest(player, "npe_pointer_spy_template");
    }
    public int npe_spy_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_spy_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_spy_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_spy_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_spy_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_spy_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_spy_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_spy_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_spy_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_spy_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_spy_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_spy_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_spy_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_spy_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_spy_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
