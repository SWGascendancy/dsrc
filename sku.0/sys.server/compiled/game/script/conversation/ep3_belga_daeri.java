...
public class ep3_belga_daeri extends script.base_script
{
    ...
    public boolean ep3_belga_daeri_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_belga_daeri_condition_canTakeDornQuest(obj_id player, obj_id npc)
    {
    ...
    public void ep3_belga_daeri_action_sendStrenBelgaSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "signalSpeakWithBelga");
    }
    public void ep3_belga_daeri_action_grantDornQuest(obj_id player, obj_id npc)
    {
    ...
    public int ep3_belga_daeri_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_belga_daeri_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_belga_daeri_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_belga_daeri_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_belga_daeri_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
