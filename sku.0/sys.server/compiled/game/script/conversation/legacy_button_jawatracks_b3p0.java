...
public class legacy_button_jawatracks_b3p0 extends script.base_script
{
    ...
    public boolean legacy_button_jawatracks_b3p0_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean legacy_button_jawatracks_b3p0_condition_keysBack(obj_id player, obj_id npc)
    {
    ...
    public boolean legacy_button_jawatracks_b3p0_condition_onDataRetrival(obj_id player, obj_id npc)
    {
    ...
    public boolean legacy_button_jawatracks_b3p0_condition_onsaveJawas(obj_id player, obj_id npc)
    {
    ...
    public boolean legacy_button_jawatracks_b3p0_condition_questTracks3Complete(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/legacy_button_jawatracks_pt3");
        int questId2 = questGetQuestId("quest/legacy_button_jawatracks_reb_pt3");
    ...
    public boolean legacy_button_jawatracks_b3p0_condition_raidersDead(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/legacy_button_jawatracks_pt3");
    ...
    public boolean legacy_button_jawatracks_b3p0_condition_onRaiders(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/legacy_button_jawatracks_pt3");
    ...
    public void legacy_button_jawatracks_b3p0_action_giveDataPad(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "legacy_button_jawatracks_launch_e28");
    }
    public void legacy_button_jawatracks_b3p0_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void legacy_button_jawatracks_b3p0_action_signalKeys(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "legacy_button_jawatracks_launch_e23");
    }
    public void legacy_button_jawatracks_b3p0_action_signalCounterattack(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "legacy_button_jawatracks_launch_e23");
    }
    public int legacy_button_jawatracks_b3p0_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_button_jawatracks_b3p0_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_button_jawatracks_b3p0_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_button_jawatracks_b3p0_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_button_jawatracks_b3p0_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_button_jawatracks_b3p0_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_button_jawatracks_b3p0_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_button_jawatracks_b3p0_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_button_jawatracks_b3p0_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int legacy_button_jawatracks_b3p0_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
