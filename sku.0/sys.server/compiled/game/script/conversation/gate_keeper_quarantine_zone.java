...
public class gate_keeper_quarantine_zone extends script.base_script
{
    ...
    public boolean gate_keeper_quarantine_zone_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean gate_keeper_quarantine_zone_condition_hasQuestOne(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean gate_keeper_quarantine_zone_condition_hasCompletedQuestOne(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean gate_keeper_quarantine_zone_condition_hasQuestTwo(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean gate_keeper_quarantine_zone_condition_hasFoundContingent(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public void gate_keeper_quarantine_zone_action_warpPlayerIn(obj_id player, obj_id npc)
    {
    ...
    public int gate_keeper_quarantine_zone_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int gate_keeper_quarantine_zone_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int gate_keeper_quarantine_zone_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int gate_keeper_quarantine_zone_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int gate_keeper_quarantine_zone_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int gate_keeper_quarantine_zone_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
