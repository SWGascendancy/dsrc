...
public class mtp_hideout_col_eavesdrop extends script.base_script
{
    ...
    public boolean mtp_hideout_col_eavesdrop_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean mtp_hideout_col_eavesdrop_condition_activeOrCompleteCollection(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_hideout_col_eavesdrop_condition_collectionActive(obj_id player, obj_id npc)
    {
        if (!hasCompletedCollection(player, "col_meatlump_eavesdrop") && hasCompletedCollectionSlotPrereq(player, "eavesdrop_location_1"))
        {
            return true;
    ...
    public boolean mtp_hideout_col_eavesdrop_condition_readyForTurnIn(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_hideout_col_eavesdrop_condition_collectionComplete(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_hideout_col_eavesdrop_condition_hasLockoutBuff(obj_id player, obj_id npc)
    {
    ...
    public void mtp_hideout_col_eavesdrop_action_grantBugJar(obj_id player, obj_id npc)
    {
    ...
    public void mtp_hideout_col_eavesdrop_action_returnBugJar(obj_id player, obj_id npc)
    {
        obj_id bug_jar = utils.getStaticItemInInventory(player, "col_listening_device_02_01");
        if (!isIdValid(bug_jar))
        {
    ...
    public void mtp_hideout_col_eavesdrop_action_clearCollectionGrantNew(obj_id player, obj_id npc)
    {
    ...
    public int mtp_hideout_col_eavesdrop_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_col_eavesdrop_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_col_eavesdrop_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_col_eavesdrop_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_col_eavesdrop_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_col_eavesdrop_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_hideout_col_eavesdrop_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
