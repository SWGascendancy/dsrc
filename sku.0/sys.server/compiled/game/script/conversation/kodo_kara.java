...
public class kodo_kara extends script.base_script
{
    ...
    public boolean kodo_kara_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public void kodo_kara_action_exitSd(obj_id player, obj_id npc)
    {
        instance.requestExitPlayer("heroic_star_destroyer", player);
    }
    public int kodo_kara_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
