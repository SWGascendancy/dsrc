...
public class storyteller_vendor extends script.base_script
{
    ...
    public boolean storyteller_vendor_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean storyteller_vendor_condition_checkFromToken(obj_id player, obj_id npc)
    {
    ...
    public void storyteller_vendor_action_showStorytellerVendorSui(obj_id player, obj_id npc)
    {
        storyteller.displayAvailableStorytellerTokenTypes(player, npc);
        return;
    }
    public int storyteller_vendor_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
