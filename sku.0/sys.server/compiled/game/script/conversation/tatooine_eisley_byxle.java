...
public class tatooine_eisley_byxle extends script.base_script
{
    ...
    public boolean tatooine_eisley_byxle_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tatooine_eisley_byxle_condition_tdcOnTask1(obj_id player, obj_id npc)
    {
    ...
    public boolean tatooine_eisley_byxle_condition_tdcOnTask2(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_eisley_tdc");
    ...
    public boolean tatooine_eisley_byxle_condition_tdcOnTask3(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_eisley_tdc");
    ...
    public boolean tatooine_eisley_byxle_condition_tdcOnTask4(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_eisley_tdc");
    ...
    public boolean tatooine_eisley_byxle_condition_tdcTaskComplete(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_eisley_tdc");
    ...
    public boolean tatooine_eisley_byxle_condition_tdcQuestComplete(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_eisley_tdc");
        boolean OnTask = (questIsQuestComplete(questId1, player));
        return OnTask;
    }
    public boolean tatooine_eisley_byxle_condition_blocker(obj_id player, obj_id npc)
    {
        return groundquests.isQuestDisabled("tatooine_eisley_tdc");
    }
    public void tatooine_eisley_byxle_action_grantTDCQuest(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/tatooine_eisley_tdc");
        groundquests.grantQuest(questId, player, npc, true);
    }
    public void tatooine_eisley_byxle_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void tatooine_eisley_byxle_action_signalTDCReward(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tat_eisley_tdc_e9");
    }
    public int tatooine_eisley_byxle_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_byxle_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_byxle_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_byxle_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_byxle_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_byxle_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_byxle_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_byxle_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_byxle_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_byxle_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_byxle_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_byxle_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_byxle_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_byxle_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
