...
public class trainer_beast_master extends script.base_script
{
    ...
    public boolean trainer_beast_master_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean trainer_beast_master_condition_canLearnNextProvoke(obj_id player, obj_id npc)
    {
    ...
    public boolean trainer_beast_master_condition_hasActiveBeast(obj_id player, obj_id npc)
    {
    ...
    public boolean trainer_beast_master_condition_canPayFee(obj_id player, obj_id npc)
    {
        int balance = getTotalMoney(player);
        return 5000 <= balance;
    }
    public boolean trainer_beast_master_condition_knowsProvoke(obj_id player, obj_id npc)
    {
    ...
    public boolean trainer_beast_master_condition_hasSkillsToUnlearn(obj_id player, obj_id npc)
    {
        obj_id activePet = beast_lib.getBeastOnPlayer(player);
    ...
    public void trainer_beast_master_action_clearPetSkills(obj_id player, obj_id npc)
    {
    ...
    public void trainer_beast_master_action_teachNextProvoke(obj_id player, obj_id npc)
    {
    ...
    public void trainer_beast_master_action_teachFirstProvoke(obj_id player, obj_id npc)
    {
        beast_lib.playerLearnBeastMasterSkill(player, "bm_provoke_1");
    }
    public int trainer_beast_master_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int trainer_beast_master_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int trainer_beast_master_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
