...
public class corellia_38_pech_seki extends script.base_script
{
    ...
    public boolean corellia_38_pech_seki_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_38_pech_seki_condition_taskOneActive(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "corellia_38_sidequest_02");
    }
    public boolean corellia_38_pech_seki_condition_taskOneComplete(obj_id player, obj_id npc)
    {
    ...
    public void corellia_38_pech_seki_action_questGranted(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "corellia_38_sidequest_02");
    }
    public void corellia_38_pech_seki_action_taskOneCompletedSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "corellia_38_sidequest_02_02");
    }
    public int corellia_38_pech_seki_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
