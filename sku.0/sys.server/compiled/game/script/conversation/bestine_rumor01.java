...
public class bestine_rumor01 extends script.base_script
{
    ...
    public boolean bestine_rumor01_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean bestine_rumor01_condition_nonoffice(obj_id player, obj_id npc)
    {
        return hasObjVar(npc, "bestine.electionEnded");
    }
    public void bestine_rumor01_action__defaultAction(obj_id player, obj_id npc)
    {
    }
