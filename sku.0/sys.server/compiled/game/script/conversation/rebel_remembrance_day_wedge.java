...
public class rebel_remembrance_day_wedge extends script.base_script
{
    ...
    public boolean rebel_remembrance_day_wedge_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean rebel_remembrance_day_wedge_condition_isImperialPlayer(obj_id player, obj_id npc)
    {
        rebel_remembrance_day_wedge_action_faceTo(npc, player);
        return (factions.isImperial(player));
    }
    public boolean rebel_remembrance_day_wedge_condition_isNeutralPlayer(obj_id player, obj_id npc)
    {
        return (!factions.isImperial(player) && !factions.isRebel(player));
    }
    public void rebel_remembrance_day_wedge_action_faceTo(obj_id player, obj_id npc)
    {
        rebel_remembrance_day_wedge_action_faceTo(npc, player);
    }
    public void rebel_remembrance_day_wedge_action_spawnTroopers(obj_id player, obj_id npc)
    {
        for (int i = 0; i < 3; i++)
        {
    ...
    public void rebel_remembrance_day_wedge_action_grantFirstMission(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, holiday.EMPIREDAYQUEST_REB_COMBAT_01);
    }
    public int rebel_remembrance_day_wedge_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_wedge_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_wedge_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_wedge_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_wedge_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
