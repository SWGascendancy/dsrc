...
public class ep3_trandoshan_chawroo_zssik_01a extends script.base_script
{
    ...
    public boolean ep3_trandoshan_chawroo_zssik_01a_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_trandoshan_chawroo_zssik_01a_condition_isOnTask01(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_trando_boshaz_zssik_02", "blackscaleAmbush");
    }
    public boolean ep3_trandoshan_chawroo_zssik_01a_condition_isOnTask02(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_trando_boshaz_zssik_02", "talkToChawroo");
    }
    public boolean ep3_trandoshan_chawroo_zssik_01a_condition_hasCompletedTask01(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "ep3_trando_boshaz_zssik_02", "talkToChawroo");
    }
    public boolean ep3_trandoshan_chawroo_zssik_01a_condition_cannotSpeakWookiee(obj_id player, obj_id npc)
    {
    ...
    public void ep3_trandoshan_chawroo_zssik_01a_action_doSignal01(obj_id player, obj_id npc)
    {
        playClientEffectObj(npc, "clienteffect/voc_wookiee_med_2sec.cef", player, "");
        groundquests.sendSignal(player, "chawrooLifeDebt");
    }
    public void ep3_trandoshan_chawroo_zssik_01a_action_emoteConfusion(obj_id player, obj_id npc)
    {
    ...
    public void ep3_trandoshan_chawroo_zssik_01a_action_vocalizeShort(obj_id player, obj_id npc)
    {
        playClientEffectObj(npc, "clienteffect/voc_wookiee_med_2sec.cef", player, "");
    }
    public void ep3_trandoshan_chawroo_zssik_01a_action_vocalizeLong(obj_id player, obj_id npc)
    {
        playClientEffectObj(npc, "clienteffect/voc_wookiee_med_6sec.cef", player, "");
    }
    public void ep3_trandoshan_chawroo_zssik_01a_action_vocalizeMed(obj_id player, obj_id npc)
    {
        playClientEffectObj(npc, "clienteffect/voc_wookiee_med_4sec.cef", player, "");
    }
    public int ep3_trandoshan_chawroo_zssik_01a_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_chawroo_zssik_01a_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_chawroo_zssik_01a_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_chawroo_zssik_01a_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_chawroo_zssik_01a_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_chawroo_zssik_01a_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_chawroo_zssik_01a_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_chawroo_zssik_01a_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trandoshan_chawroo_zssik_01a_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
