...
public class ep3_kachirho_lolo extends script.base_script
{
    ...
    public boolean ep3_kachirho_lolo_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_kachirho_lolo_condition_isReadyForLolo(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_kachirho_trando_rifle", "talkToLolo");
    }
    public boolean ep3_kachirho_lolo_condition_hasBowcasterPieces(obj_id player, obj_id npc)
    {
        return space_quest.hasWonQuest(player, "inspect", "ep3_wke_bowcaster_crafting");
    }
    public boolean ep3_kachirho_lolo_condition_isOnMission(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_kachirho_trando_rifle");
    }
    public boolean ep3_kachirho_lolo_condition_hasFailedSpaceMission(obj_id player, obj_id npc)
    {
        return space_quest.hasFailedQuest(player, "inspect", "ep3_wke_bowcaster_crafting");
    }
    public boolean ep3_kachirho_lolo_condition_hasMadeBowcaster(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "ep3_kachirho_trando_rifle", "craftBowcaster");
    }
    public boolean ep3_kachirho_lolo_condition_cannotSpeakWke(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_kachirho_lolo_condition_hasCompletedSpace(obj_id player, obj_id npc)
    {
        return space_quest.hasCompletedQuest(player, "inspect", "ep3_wke_bowcaster_crafting");
    }
    public void ep3_kachirho_lolo_action_grantSpaceMission(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "inspect", "ep3_wke_bowcaster_crafting");
    }
    public void ep3_kachirho_lolo_action_grantBarrelSchematic(obj_id player, obj_id npc)
    {
    ...
    public void ep3_kachirho_lolo_action_vocalizeMed(obj_id player, obj_id npc)
    {
        playClientEffectObj(npc, "clienteffect/voc_wookiee_med_4sec.cef", player, "");
    }
    public void ep3_kachirho_lolo_action_grantCraftingComponent(obj_id player, obj_id npc)
    {
    ...
    public int ep3_kachirho_lolo_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_lolo_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_lolo_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_lolo_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_lolo_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_lolo_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_lolo_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_lolo_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_lolo_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_lolo_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_lolo_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_lolo_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_kachirho_lolo_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
