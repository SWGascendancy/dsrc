...
public class refugee_stormtrooper extends script.base_script
{
    ...
    public boolean refugee_stormtrooper_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean refugee_stormtrooper_condition_isProlog(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "quest_08_dathomir_outpost_final");
    }
    public int refugee_stormtrooper_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int refugee_stormtrooper_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int refugee_stormtrooper_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
