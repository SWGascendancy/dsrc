...
public class tatooine_knives_fencing_keela extends script.base_script
{
    ...
    public boolean tatooine_knives_fencing_keela_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tatooine_knives_fencing_keela_condition_onTaskSnitch(obj_id player, obj_id npc)
    {
    ...
    public boolean tatooine_knives_fencing_keela_condition_questComplete(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_knives_fencing");
        boolean OnTask = (questIsQuestComplete(questId1, player));
        return OnTask;
    }
    public void tatooine_knives_fencing_keela_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void tatooine_knives_fencing_keela_action_signalKeelaOver(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tatooine_knives_fencing_launch_e7");
    }
    public int tatooine_knives_fencing_keela_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_knives_fencing_keela_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
