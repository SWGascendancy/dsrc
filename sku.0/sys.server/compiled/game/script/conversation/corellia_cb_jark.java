...
public class corellia_cb_jark extends script.base_script
{
    ...
    public boolean corellia_cb_jark_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_cb_jark_condition_offerQuest4(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_cb_jark_condition_onQuest4(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_cb_jark_condition_cb4_finish(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_cb_jark_condition_cb_4_done(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_cb_jark_condition_offerSideQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_cb_jark_condition_offerNextQuest(obj_id player, obj_id npc)
    {
    ...
    public void corellia_cb_jark_action_sendPointerSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "cb_jark");
        return;
    }
    public void corellia_cb_jark_action_grantfourthQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest/corellia_cb_4");
        return;
    }
    public void corellia_cb_jark_action_sendFinalSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "cb_4_end");
        return;
    }
    public void corellia_cb_jark_action_grantSideQuest2(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest/corellia_cb_side_2");
        return;
    }
    public void corellia_cb_jark_action_grantNextQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest/corellia_disappearances_goto_questgiver");
        return;
    }
    public void corellia_cb_jark_action_sendSideSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "cb_4_jark_done");
        return;
    }
    public int corellia_cb_jark_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_cb_jark_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_cb_jark_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_cb_jark_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_cb_jark_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_cb_jark_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_cb_jark_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
