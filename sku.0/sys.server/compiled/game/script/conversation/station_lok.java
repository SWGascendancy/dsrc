...
public class station_lok extends script.base_script
{
    ...
    public boolean station_lok_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean station_lok_condition_canAfford50(obj_id player, obj_id npc)
    {
        return space_crafting.canAffordShipRepairs(player, npc, .50f);
    }
    public boolean station_lok_condition_canAfford25(obj_id player, obj_id npc)
    {
        return (space_crafting.canAffordShipRepairs(player, npc, .25f) && space_crafting.isDamaged(player));
    }
    public boolean station_lok_condition_canAfford75(obj_id player, obj_id npc)
    {
        return space_crafting.canAffordShipRepairs(player, npc, .75f);
    }
    public boolean station_lok_condition_canAfford100(obj_id player, obj_id npc)
    {
        return space_crafting.canAffordShipRepairs(player, npc, 1.0f);
    }
    public boolean station_lok_condition_needRepairs(obj_id player, obj_id npc)
    {
    ...
    public boolean station_lok_condition_isTooFar(obj_id player, obj_id npc)
    {
        space_combat.playCombatTauntSound(player);
        obj_id containingShip = space_transition.getContainingShip(player);
        return (getDistance(npc, containingShip) > space_transition.STATION_COMM_MAX_DISTANCE);
    }
    public boolean station_lok_condition_canDoWorkForNym(obj_id player, obj_id npc)
    {
    ...
    public boolean station_lok_condition_isReadyForMissionOne(obj_id player, obj_id npc)
    {
    ...
    public boolean station_lok_condition_hasCompletedMissionOne(obj_id player, obj_id npc)
    {
        return (space_quest.hasCompletedQuest(player, "recovery", "stn_lok_nym_reb_tier2_1a"));
    }
    public boolean station_lok_condition_hasCompletedMissionTwo(obj_id player, obj_id npc)
    {
        return (space_quest.hasCompletedQuest(player, "escort", "stn_lok_nym_reb_tier2_2a"));
    }
    public boolean station_lok_condition_isReadyForMissionTwo(obj_id player, obj_id npc)
    {
        if (!station_lok_condition_canDoWorkForNym(player, npc))
        {
            return false;
    ...
    public boolean station_lok_condition_isReadyForMissionThree(obj_id player, obj_id npc)
    {
        if (!station_lok_condition_canDoWorkForNym(player, npc))
        {
            return false;
    ...
    public boolean station_lok_condition_hasCompletedMissionThree(obj_id player, obj_id npc)
    {
        return (space_quest.hasCompletedQuest(player, "assassinate", "stn_lok_nym_reb_tier2_3a"));
    }
    public boolean station_lok_condition_canLandAtHouse(obj_id player, obj_id npc)
    {
    ...
    public boolean station_lok_condition_canTakeQuest(obj_id player, obj_id npc)
    {
        if (space_quest.hasQuest(player))
        {
            return false;
    ...
    public boolean station_lok_condition_canHandleTier3(obj_id player, obj_id npc)
    {
        return space_flags.hasCompletedTierTwo(player);
    }
    public boolean station_lok_condition_canAttackImperial(obj_id player, obj_id npc)
    {
    ...
    public boolean station_lok_condition_canAttackRebel(obj_id player, obj_id npc)
    {
    ...
    public boolean station_lok_condition_canTakeRebel5Duty(obj_id player, obj_id npc)
    {
    ...
    public boolean station_lok_condition_canTakeImperial5Duty(obj_id player, obj_id npc)
    {
        if (!space_skill.isMasterPilot(player))
        {
            return false;
    ...
    public void station_lok_action_landStation3(obj_id player, obj_id npc)
    {
        space_content.landPlayer(player, npc, "Mos Espa Starport");
    }
    public void station_lok_action_fix25(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, .25f);
    }
    public void station_lok_action_fix50(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, .50f);
    }
    public void station_lok_action_fix75(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, .75f);
    }
    public void station_lok_action_fix100(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, 1.0f);
    }
    public void station_lok_action_landStation1(obj_id player, obj_id npc)
    {
        space_content.landPlayer(player, npc, "Nym's Stronghold");
    }
    public void station_lok_action_landStation2(obj_id player, obj_id npc)
    {
        space_content.landPlayer(player, npc, "Mos Eisley Starport");
    }
    public void station_lok_action_grantDestroyDutyMission(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "stn_lok_nym_reb_tier2_1");
    }
    public void station_lok_action_grantEscortDutyMission(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "escort_duty", "stn_lok_nym_reb_tier2_1");
    }
    public void station_lok_action_grantMissionOne(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "recovery", "stn_lok_nym_reb_tier2_1a");
    }
    public void station_lok_action_grantMissionTwo(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "escort", "stn_lok_nym_reb_tier2_2a");
    }
    public void station_lok_action_grantMissionThree(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "assassinate", "stn_lok_nym_reb_tier2_3a");
    }
    public void station_lok_action_landHoming(obj_id player, obj_id npc)
    {
        space_content.landPlayerHoming(player, npc);
    }
    public void station_lok_action_grantImperialDuty3(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "lok_imperial_tier3");
    }
    public void station_lok_action_grantRebelDuty3(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "lok_rebel_tier3");
    }
    public void station_lok_action_grantHiddenDaggerDuty3(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "lok_hidden_dagger_tier3");
    }
    public void station_lok_action_grantDroidDuty3(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "lok_rogue_droid_tier3");
    }
    public void station_lok_action_grantImperialDuty5(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "lok_imperial_tier5");
    }
    public void station_lok_action_grantRebelDuty5(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "lok_rebel_tier5");
    }
    public String station_lok_tokenTO_tokenTO0001(obj_id player, obj_id npc)
    {
        return new String();
    }
    public int station_lok_tokenDI_getStationRepairCost25(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, .25f);
    }
    public int station_lok_tokenDI_getStationRepairCost50(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, .50f);
    }
    public int station_lok_tokenDI_getStationRepairCost75(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, .75f);
    }
    public int station_lok_tokenDI_getStationRepairCost100(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, 1.0f);
    }
    public int station_lok_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_lok_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_lok_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_lok_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_lok_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_lok_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_lok_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_lok_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_lok_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_lok_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_lok_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_lok_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_lok_handleBranch30(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_lok_handleBranch31(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_lok_handleBranch32(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_lok_handleBranch33(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_lok_handleBranch37(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_lok_handleBranch38(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_lok_handleBranch39(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_lok_handleBranch40(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_lok_handleBranch44(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_lok_handleBranch47(obj_id player, obj_id npc, string_id response)
    {
