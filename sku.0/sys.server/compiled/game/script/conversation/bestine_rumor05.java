...
public class bestine_rumor05 extends script.base_script
{
    ...
    public boolean bestine_rumor05_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean bestine_rumor05_condition_nonoffice(obj_id player, obj_id npc)
    {
        return hasObjVar(npc, "bestine.electionEnded");
    }
    public void bestine_rumor05_action__defaultAction(obj_id player, obj_id npc)
    {
    }
