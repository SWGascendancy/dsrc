...
public class azure_cabal_camdoen extends script.conversation.base.conversation_base
{
    ...
    public String azure_cabal_camdoen_tokenTO_playerFirstName(obj_id player)
    {
        return getFirstName(player);
    }
    public String azure_cabal_camdoen_tokenTO_playersProfession()
    {
        return "";
    }
    private int azure_cabal_camdoen_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch9(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch11(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch12(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch13(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch14(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch15(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch16(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch17(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch18(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch19(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch20(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch21(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch22(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch23(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch24(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch25(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch26(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch27(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch29(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch30(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch32(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch33(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch34(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch35(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch36(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch37(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch38(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch40(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch41(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch42(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch43(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch44(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch45(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch46(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch48(obj_id player, obj_id npc, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch52(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch53(obj_id player, obj_id npc, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch54(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch55(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch56(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch57(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch58(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch59(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch60(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch61(obj_id player, obj_id npc, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch62(obj_id player, obj_id npc, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch63(obj_id player, obj_id npc, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch64(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch65(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch66(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch67(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch68(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch69(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch70(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch71(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch72(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch73(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch74(obj_id player, string_id response)
    {
    ...
    private int azure_cabal_camdoen_handleBranch75(obj_id player, string_id response)
    {
