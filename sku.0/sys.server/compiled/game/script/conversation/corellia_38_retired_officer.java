...
public class corellia_38_retired_officer extends script.base_script
{
    ...
    public boolean corellia_38_retired_officer_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_38_retired_officer_condition_stolenMedalActive(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_38_retired_officer_condition_stolenMedalLast(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_38_corsec_files_01", "corsec_files_01_08");
    }
    public boolean corellia_38_retired_officer_condition_questComplete(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "corellia_38_corsec_files_01", "corsec_files_01_08");
    }
    public boolean corellia_38_retired_officer_condition_stolenMedalFirst(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_38_corsec_files_01", "corsec_files_01_01");
    }
    public void corellia_38_retired_officer_action_stolenMedalFirstSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "corsec_files_01_01");
    }
    public void corellia_38_retired_officer_action_stolenmedalLastSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "corsec_files_01_08");
    }
    public int corellia_38_retired_officer_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_38_retired_officer_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_38_retired_officer_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_38_retired_officer_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
