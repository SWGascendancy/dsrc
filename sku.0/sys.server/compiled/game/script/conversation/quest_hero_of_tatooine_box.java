...
public class quest_hero_of_tatooine_box extends script.base_script
{
    ...
    public boolean quest_hero_of_tatooine_box_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean quest_hero_of_tatooine_box_condition_Noquest(obj_id player, obj_id npc)
    {
    ...
    public boolean quest_hero_of_tatooine_box_condition_Intercom(obj_id player, obj_id npc)
    {
    ...
    public boolean quest_hero_of_tatooine_box_condition_DistractObj(obj_id player, obj_id npc)
    {
    ...
    public void quest_hero_of_tatooine_box_action_Distract(obj_id player, obj_id npc)
    {
