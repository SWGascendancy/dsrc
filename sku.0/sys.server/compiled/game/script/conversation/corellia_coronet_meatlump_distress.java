...
public class corellia_coronet_meatlump_distress extends script.base_script
{
    ...
    public boolean corellia_coronet_meatlump_distress_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_coronet_meatlump_distress_condition_meatlumpLieutenant(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_coronet_meatlump_distress_condition_gotPassword(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_coronet_meatlump_act1_end", "meatlumpsAct1_gotPassword");
    }
    public boolean corellia_coronet_meatlump_distress_condition_code1(obj_id player, obj_id npc)
    {
        return utils.getIntScriptVar(player, "meatlumpAct1.codeNumber") == 1;
    }
    public boolean corellia_coronet_meatlump_distress_condition_code2(obj_id player, obj_id npc)
    {
        return utils.getIntScriptVar(player, "meatlumpAct1.codeNumber") == 2;
    }
    public boolean corellia_coronet_meatlump_distress_condition_code3(obj_id player, obj_id npc)
    {
        return utils.getIntScriptVar(player, "meatlumpAct1.codeNumber") == 3;
    }
    public boolean corellia_coronet_meatlump_distress_condition_code4(obj_id player, obj_id npc)
    {
        return utils.getIntScriptVar(player, "meatlumpAct1.codeNumber") == 4;
    }
    public boolean corellia_coronet_meatlump_distress_condition_code5(obj_id player, obj_id npc)
    {
        return utils.getIntScriptVar(player, "meatlumpAct1.codeNumber") == 5;
    }
    public boolean corellia_coronet_meatlump_distress_condition_code6(obj_id player, obj_id npc)
    {
        return utils.getIntScriptVar(player, "meatlumpAct1.codeNumber") == 6;
    }
    public void corellia_coronet_meatlump_distress_action_pickCorrectCode(obj_id player, obj_id npc)
    {
    ...
    public void corellia_coronet_meatlump_distress_action_attack(obj_id player, obj_id npc)
    {
    ...
    public void corellia_coronet_meatlump_distress_action_givePassword(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "meatlumpsAct1_spokenPassword");
    }
    public int corellia_coronet_meatlump_distress_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_meatlump_distress_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
