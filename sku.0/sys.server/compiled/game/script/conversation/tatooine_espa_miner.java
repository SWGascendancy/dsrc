...
public class tatooine_espa_miner extends script.base_script
{
    ...
    public boolean tatooine_espa_miner_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tatooine_espa_miner_condition_onMinerTask(obj_id player, obj_id npc)
    {
    ...
    public void tatooine_espa_miner_action_signalMinerTask(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tat_espa_body_building_e3");
    }
    public int tatooine_espa_miner_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_espa_miner_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_espa_miner_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
