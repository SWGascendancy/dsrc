...
public class corvette_neutral_pilot extends script.base_script
{
    ...
    public boolean corvette_neutral_pilot_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corvette_neutral_pilot_condition_hasNeutralTicket(obj_id player, obj_id npc)
    {
    ...
    public boolean corvette_neutral_pilot_condition_tooManyInGroup(obj_id player, obj_id npc)
    {
    ...
    public void corvette_neutral_pilot_action__defaultAction(obj_id player, obj_id npc)
    {
    }
    public void corvette_neutral_pilot_action_sendToDungeon(obj_id player, obj_id npc)
    {
        space_dungeon.selectDungeonTicket(npc, player);
        return;
    }
    public void corvette_neutral_pilot_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return;
    }
