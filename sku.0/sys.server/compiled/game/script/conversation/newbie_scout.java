...
public class newbie_scout extends script.base_script
{
    ...
    public boolean newbie_scout_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean newbie_scout_condition_completedCensus(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/newbie_scout_v2");
        boolean OnTask = (questIsQuestComplete(questId1, player));
        return OnTask;
    }
    public boolean newbie_scout_condition_completedRills(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/newbie_scout_pt5");
        boolean OnTask = (questIsQuestComplete(questId1, player));
        return OnTask;
    }
    public boolean newbie_scout_condition_completedMites(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/newbie_scout_pt6");
        boolean OnTask = (questIsQuestComplete(questId1, player));
        return OnTask;
    }
    public boolean newbie_scout_condition_onCensus(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/newbie_scout_v2");
        boolean OnTask = (questIsQuestActive(questId1, player));
        return OnTask;
    }
    public boolean newbie_scout_condition_onMites(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/newbie_scout_pt6");
        boolean OnTask = (questIsQuestActive(questId1, player));
        return OnTask;
    }
    public boolean newbie_scout_condition_onMitesReward(obj_id player, obj_id npc)
    {
    ...
    public boolean newbie_scout_condition_mayorSent(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "c_scout_trainer");
    }
    public boolean newbie_scout_condition_onCensusReward(obj_id player, obj_id npc)
    {
    ...
    public boolean newbie_scout_condition_onWomp(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/newbie_scout_pt2");
        boolean OnTask = (questIsQuestActive(questId1, player));
        return OnTask;
    }
    public boolean newbie_scout_condition_onWompReward(obj_id player, obj_id npc)
    {
    ...
    public boolean newbie_scout_condition_completedWomp(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/newbie_scout_pt2");
        boolean OnTask = (questIsQuestComplete(questId1, player));
        return OnTask;
    }
    public boolean newbie_scout_condition_onKreetle(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/newbie_scout_pt3");
        boolean OnTask = (questIsQuestActive(questId1, player));
        return OnTask;
    }
    public boolean newbie_scout_condition_onKreetleReward(obj_id player, obj_id npc)
    {
    ...
    public boolean newbie_scout_condition_completedKreetle(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/newbie_scout_pt3");
        boolean OnTask = (questIsQuestComplete(questId1, player));
        return OnTask;
    }
    public boolean newbie_scout_condition_onWorrt(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/newbie_scout_pt4");
        boolean OnTask = (questIsQuestActive(questId1, player));
        return OnTask;
    }
    public boolean newbie_scout_condition_onWorrtReward(obj_id player, obj_id npc)
    {
    ...
    public boolean newbie_scout_condition_completeWorrts(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/newbie_scout_pt4");
        boolean OnTask = (questIsQuestComplete(questId1, player));
        return OnTask;
    }
    public boolean newbie_scout_condition_onRills(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/newbie_scout_pt5");
        boolean OnTask = (questIsQuestActive(questId1, player));
        return OnTask;
    }
    public boolean newbie_scout_condition_onRillsReward(obj_id player, obj_id npc)
    {
    ...
    public void newbie_scout_action_startCensus(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest/newbie_scout_v2");
    }
    public void newbie_scout_action_startKreetle(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest/newbie_scout_pt3");
    }
    public void newbie_scout_action_startMites(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest/newbie_scout_pt6");
    }
    public void newbie_scout_action_sendRillSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "newbie_scout_trap_rills");
    }
    public void newbie_scout_action_endFromMayor(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "newbie_speak_entha");
    }
    public void newbie_scout_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void newbie_scout_action_signalCensusReward(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "newbie_scout_launch_e9");
    }
    public void newbie_scout_action_startWomp(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest/newbie_scout_pt2");
    }
    public void newbie_scout_action_signalWompReward(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "newbie_scout_launch_e24");
    }
    public void newbie_scout_action_signalKreetleReward(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "newbie_scout_launch_e34");
    }
    public void newbie_scout_action_startWorrts(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest/newbie_scout_pt4");
    }
    public void newbie_scout_action_signalWorrtReward(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "newbie_scout_launch_e44");
    }
    public void newbie_scout_action_startRills(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest/newbie_scout_pt5");
    }
    public void newbie_scout_action_signalRillsReward(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "newbie_scout_launch_e53");
    }
    public int newbie_scout_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int newbie_scout_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int newbie_scout_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int newbie_scout_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int newbie_scout_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int newbie_scout_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int newbie_scout_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int newbie_scout_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int newbie_scout_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int newbie_scout_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int newbie_scout_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_112"))
        {
            if (newbie_scout_condition__defaultCondition(player, npc))
    ...
    public int newbie_scout_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int newbie_scout_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int newbie_scout_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int newbie_scout_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int newbie_scout_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int newbie_scout_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int newbie_scout_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int newbie_scout_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int newbie_scout_handleBranch31(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int newbie_scout_handleBranch32(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int newbie_scout_handleBranch33(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int newbie_scout_handleBranch35(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int newbie_scout_handleBranch37(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int newbie_scout_handleBranch39(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int newbie_scout_handleBranch40(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int newbie_scout_handleBranch41(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_86"))
        {
            if (newbie_scout_condition__defaultCondition(player, npc))
    ...
    public int newbie_scout_handleBranch43(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int newbie_scout_handleBranch44(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int newbie_scout_handleBranch46(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int newbie_scout_handleBranch47(obj_id player, obj_id npc, string_id response)
    {
