...
public class outbreak_canister_demolition_bothan extends script.base_script
{
    ...
    public boolean outbreak_canister_demolition_bothan_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean outbreak_canister_demolition_bothan_condition_hasAlphaQuestIncomplete(obj_id player, obj_id npc)
    {
    ...
    public boolean outbreak_canister_demolition_bothan_condition_hasFinishedQuota(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "camp_alpha_canister_demo", "collectRewardAlpha");
    }
    public boolean outbreak_canister_demolition_bothan_condition_hasNeverSpoken(obj_id player, obj_id npc)
    {
    ...
    public boolean outbreak_canister_demolition_bothan_condition_hasCompletedAlphaQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "camp_alpha_canister_demo");
    }
    public boolean outbreak_canister_demolition_bothan_condition_hasCompletedRadioQuests(obj_id player, obj_id npc)
    {
    ...
    public boolean outbreak_canister_demolition_bothan_condition_hasFoundOtherCamps(obj_id player, obj_id npc)
    {
    ...
    public boolean outbreak_canister_demolition_bothan_condition_noAntiVirus(obj_id player, obj_id npc)
    {
    ...
    public boolean outbreak_canister_demolition_bothan_condition_hasAnotherCampCompleted(obj_id player, obj_id npc)
    {
    ...
    public boolean outbreak_canister_demolition_bothan_condition_hasAnotherCampIncomplete(obj_id player, obj_id npc)
    {
    ...
    public boolean outbreak_canister_demolition_bothan_condition_hasCompletedAllCamps(obj_id player, obj_id npc)
    {
    ...
    public boolean outbreak_canister_demolition_bothan_condition_hasFinishedQuotaDelta(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "camp_delta_canister_demo", "collectRewardDelta");
    }
    public boolean outbreak_canister_demolition_bothan_condition_hasFinishedQuotaGamma(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "camp_gamma_canister_demo", "collectRewardGamma");
    }
    public boolean outbreak_canister_demolition_bothan_condition_hasFinishedQuotaBeta(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "camp_beta_canister_demo", "collectRewardBeta");
    }
    public void outbreak_canister_demolition_bothan_action_grantFirstQuestAndCollection(obj_id player, obj_id npc)
    {
    ...
    public void outbreak_canister_demolition_bothan_action_completeQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "hasCompletedAlpha");
    }
    public int outbreak_canister_demolition_bothan_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_canister_demolition_bothan_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_canister_demolition_bothan_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_canister_demolition_bothan_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_canister_demolition_bothan_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_canister_demolition_bothan_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_canister_demolition_bothan_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_canister_demolition_bothan_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int outbreak_canister_demolition_bothan_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
