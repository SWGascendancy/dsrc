...
public class ep3_clone_relics_boba_fett_durge_1 extends script.base_script
{
    ...
    public boolean ep3_clone_relics_boba_fett_durge_1_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_clone_relics_boba_fett_durge_1_condition_hasCompletedTaskTalkDurge(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedTask(player, "ep3_clone_relics_boba_fett_4", "talkedDurge"));
    }
    public boolean ep3_clone_relics_boba_fett_durge_1_condition_onQuestFour(obj_id player, obj_id npc)
    {
        return (groundquests.isQuestActive(player, "ep3_clone_relics_boba_fett_4"));
    }
    public void ep3_clone_relics_boba_fett_durge_1_action_sendSignalDurge(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedToDurge");
    }
    public void ep3_clone_relics_boba_fett_durge_1_action_sendSignalTalkBartender(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedToBartender");
    }
    public int ep3_clone_relics_boba_fett_durge_1_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_boba_fett_durge_1_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_boba_fett_durge_1_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
