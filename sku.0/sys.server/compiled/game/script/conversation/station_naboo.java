...
public class station_naboo extends script.base_script
{
    ...
    public boolean station_naboo_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean station_naboo_condition_canAfford50(obj_id player, obj_id npc)
    {
        return space_crafting.canAffordShipRepairs(player, npc, .50f);
    }
    public boolean station_naboo_condition_canAfford25(obj_id player, obj_id npc)
    {
        return (space_crafting.canAffordShipRepairs(player, npc, .25f) && space_crafting.isDamaged(player));
    }
    public boolean station_naboo_condition_canAfford75(obj_id player, obj_id npc)
    {
        return space_crafting.canAffordShipRepairs(player, npc, .75f);
    }
    public boolean station_naboo_condition_canAfford100(obj_id player, obj_id npc)
    {
        return space_crafting.canAffordShipRepairs(player, npc, 1.0f);
    }
    public boolean station_naboo_condition_needRepairs(obj_id player, obj_id npc)
    {
    ...
    public boolean station_naboo_condition_isTooFar(obj_id player, obj_id npc)
    {
        space_combat.playCombatTauntSound(player);
        obj_id containingShip = space_transition.getContainingShip(player);
        return (getDistance(npc, containingShip) > space_transition.STATION_COMM_MAX_DISTANCE);
    }
    public boolean station_naboo_condition_isTier1NabooRebel(obj_id player, obj_id npc)
    {
        return (space_flags.isInTierOne(player) && space_flags.isSpaceTrack(player, space_flags.REBEL_NABOO));
    }
    public boolean station_naboo_condition_isTier1NabooImperial(obj_id player, obj_id npc)
    {
        return (space_flags.isInTierOne(player) && space_flags.isSpaceTrack(player, space_flags.IMPERIAL_NABOO));
    }
    public boolean station_naboo_condition_isTier1NabooPrivateer(obj_id player, obj_id npc)
    {
        return (space_flags.isInTierOne(player) && space_flags.isSpaceTrack(player, space_flags.PRIVATEER_NABOO));
    }
    public boolean station_naboo_condition_canDoImperialAccess(obj_id player, obj_id npc)
    {
    ...
    public boolean station_naboo_condition_canLandAtRetreat(obj_id player, obj_id npc)
    {
    ...
    public boolean station_naboo_condition_canGetTier2DestroyDuty(obj_id player, obj_id npc)
    {
        if (!space_flags.hasCompletedTierOne(player))
        {
            return false;
    ...
    public boolean station_naboo_condition_canLandAtHouse(obj_id player, obj_id npc)
    {
    ...
    public boolean station_naboo_condition_canAttackImperial(obj_id player, obj_id npc)
    {
    ...
    public boolean station_naboo_condition_canAttackRebel(obj_id player, obj_id npc)
    {
    ...
    public boolean station_naboo_condition_canTakeQuest(obj_id player, obj_id npc)
    {
        if (space_quest.hasQuest(player))
        {
            return false;
    ...
    public boolean station_naboo_condition_canDoRebelTier5Duty(obj_id player, obj_id npc)
    {
    ...
    public boolean station_naboo_condition_canDoRebelTier7Duty(obj_id player, obj_id npc)
    {
        if (!space_skill.isMasterPilot(player))
        {
            return false;
    ...
    public boolean station_naboo_condition_canDoImperialTier5Duty(obj_id player, obj_id npc)
    {
        if (!space_skill.isMasterPilot(player))
        {
            return false;
    ...
    public boolean station_naboo_condition_canDoImperialTier7Duty(obj_id player, obj_id npc)
    {
        if (!space_skill.isMasterPilot(player))
        {
            return false;
    ...
    public void station_naboo_action_landStation3(obj_id player, obj_id npc)
    {
        space_content.landPlayer(player, npc, "Keren Starport");
    }
    public void station_naboo_action_fix25(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, .25f);
    }
    public void station_naboo_action_fix50(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, .50f);
    }
    public void station_naboo_action_fix75(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, .75f);
    }
    public void station_naboo_action_fix100(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, 1.0f);
    }
    public void station_naboo_action_landStation1(obj_id player, obj_id npc)
    {
        space_content.landPlayer(player, npc, "Theed Spaceport");
    }
    public void station_naboo_action_landStation2(obj_id player, obj_id npc)
    {
        space_content.landPlayer(player, npc, "Kaadara Starport");
    }
    public void station_naboo_action_landStation4(obj_id player, obj_id npc)
    {
        space_content.landPlayer(player, npc, "Moenia");
    }
    public void station_naboo_action_landEmperor(obj_id player, obj_id npc)
    {
        space_content.landPlayer(player, npc, "The Emperor's Retreat");
    }
    public void station_naboo_action_giveEmperorAccessQuest(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "space_battle", "naboo_station_emperors_access_quest_1");
    }
    public void station_naboo_action_grantImperialDestroyDutyTier2(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "naboo_station_imperial_destroy_duty_tier2_1");
    }
    public void station_naboo_action_landHoming(obj_id player, obj_id npc)
    {
        space_content.landPlayerHoming(player, npc);
    }
    public void station_naboo_action_grantImperialDuty1(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "naboo_imperial_tier1");
    }
    public void station_naboo_action_grantImperialDuty2(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "naboo_imperial_tier2");
    }
    public void station_naboo_action_grantRebelDuty1(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "naboo_rebel_tier1");
    }
    public void station_naboo_action_grantRebelDuty2(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "naboo_rebel_tier2");
    }
    public void station_naboo_action_grantDroidDuty1(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "naboo_rogue_droid_tier1");
    }
    public void station_naboo_action_grantDroidDuty2(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "naboo_rogue_droid_tier2");
    }
    public void station_naboo_action_grantVoidDuty1(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "naboo_void_wing_tier1");
    }
    public void station_naboo_action_grantVoidDuty2(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "naboo_void_wing_tier2");
    }
    public void station_naboo_action_grantImperialDuty5(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "naboo_imperial_tier5");
    }
    public void station_naboo_action_grantRebelDuty5(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "naboo_rebel_tier5");
    }
    public void station_naboo_action_grantImperialDuty7(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "naboo_imperial_tier7");
    }
    public void station_naboo_action_grantRebelDuty7(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "naboo_rebel_tier7");
    }
    public String station_naboo_tokenTO_tokenTO0001(obj_id player, obj_id npc)
    {
        return new String();
    }
    public int station_naboo_tokenDI_getStationRepairCost25(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, .25f);
    }
    public int station_naboo_tokenDI_getStationRepairCost50(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, .50f);
    }
    public int station_naboo_tokenDI_getStationRepairCost75(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, .75f);
    }
    public int station_naboo_tokenDI_getStationRepairCost100(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, 1.0f);
    }
    public int station_naboo_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_naboo_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
        ...
        if (response.equals("s_3466611d"))
        {
            if (station_naboo_condition__defaultCondition(player, npc))
            {
                ...
                boolean hasResponse3 = false;
                if (station_naboo_condition_canDoImperialTier7Duty(player, npc))
                {
                    ++numberOfResponses;
                    hasResponse = true;
                    hasResponse3 = true;
                ...
                boolean hasResponse7 = false;
                if (station_naboo_condition_canDoRebelTier7Duty(player, npc))
                {
                    ++numberOfResponses;
                    hasResponse = true;
                    hasResponse7 = true;
    ...
    public int station_naboo_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_naboo_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_naboo_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_naboo_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_naboo_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_naboo_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_naboo_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_naboo_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_naboo_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_naboo_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_naboo_handleBranch31(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_naboo_handleBranch34(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_naboo_handleBranch35(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_naboo_handleBranch38(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_naboo_handleBranch41(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_naboo_handleBranch44(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_naboo_handleBranch48(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_naboo_handleBranch50(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_naboo_handleBranch52(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_naboo_handleBranch54(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_naboo_handleBranch58(obj_id player, obj_id npc, string_id response)
    {
        ...
        if (response.equals("s_203"))
        {
            if (station_naboo_condition__defaultCondition(player, npc))
            {
                station_naboo_action_grantRebelDuty7(player, npc);
        ...
        if (response.equals("s_202"))
        {
            if (station_naboo_condition__defaultCondition(player, npc))
            {
                station_naboo_action_grantImperialDuty7(player, npc);
