...
public class npe_marksman_questgiver extends script.base_script
{
    ...
    public boolean npe_marksman_questgiver_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_marksman_questgiver_condition_hasCompletedCarbine(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "npe_marksman_carbine");
    }
    public boolean npe_marksman_questgiver_condition_isTaskCompeteMain(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_marksman", "npe_marksman_wait");
    }
    public boolean npe_marksman_questgiver_condition_hasCompletedPistol(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "npe_marksman_pistol");
    }
    public boolean npe_marksman_questgiver_condition_hasCompletedRifle(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "npe_marksman_rifle");
    }
    public boolean npe_marksman_questgiver_condition_isTaskActiveAny(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_marksman_questgiver_condition_hasCompletedAll(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_marksman_questgiver_condition_hasCompletedAnyTraining(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_marksman_questgiver_condition_isTaskCompletePistol(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_marksman_pistol", "npe_marksman_pistol_wait");
    }
    public boolean npe_marksman_questgiver_condition_hasCompletedMyDroid(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedQuest(player, "npe_marksman") && !groundquests.hasCompletedQuest(player, "npe_side3"));
    }
    public boolean npe_marksman_questgiver_condition_isTaskCompleteRifle(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_marksman_rifle", "npe_marksman_rifle_wait");
    }
    public boolean npe_marksman_questgiver_condition_isTaskCompleteCarbine(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_marksman_carbine", "npe_marksman_carbine_wait");
    }
    public boolean npe_marksman_questgiver_condition_hasTakenAnyQuests(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_marksman_questgiver_condition_hasCompletedTemplate(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "npe.finishedTemplate");
    }
    public boolean npe_marksman_questgiver_condition_canStillTrain(obj_id player, obj_id npc)
    {
        return !npe_marksman_questgiver_condition_hasCompletedAll(player, npc);
    }
    public boolean npe_marksman_questgiver_condition_hasCompletedDroidEng(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_side3") && !groundquests.isQuestActiveOrComplete(player, "npe_side_hutt_slicers");
    }
    public boolean npe_marksman_questgiver_condition_isTaskCompleteSlice(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_side_hutt_slicers", "npe_side_hutt_slicer_return");
    }
    public boolean npe_marksman_questgiver_condition_cantHelp(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_marksman_questgiver_condition_pointedToHere(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "npe_pointer_marksman");
    }
    public boolean npe_marksman_questgiver_condition_hasFinishedAllQuests(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_side_hutt_slicers");
    }
    public void npe_marksman_questgiver_action_giveRifleQuest(obj_id player, obj_id npc)
    {
    ...
    public void npe_marksman_questgiver_action_giveSignalDroidPistol(obj_id player, obj_id npc)
    {
    ...
    public void npe_marksman_questgiver_action_giveCarbineQuest(obj_id player, obj_id npc)
    {
    ...
    public void npe_marksman_questgiver_action_givePistolQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_marksman_pistol");
        groundquests.sendSignal(player, "talked_to_loche");
        npe.giveAutoPopUp(player, npc);
    }
    public void npe_marksman_questgiver_action_giveDroidQuest(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "npe_marksman");
    }
    public void npe_marksman_questgiver_action_giveSingalPistol(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_marksman_pistol");
        groundquests.sendSignal(player, "finished_loche");
        npe.sendDelayed3poPopup(player, 3, 11, "sound/c3po_29.snd", "npe", "pop_credits", "npe.credits");
    }
    public void npe_marksman_questgiver_action_giveSignalRifle(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_marksman_rifle");
        groundquests.sendSignal(player, "finished_loche");
        npe.sendDelayed3poPopup(player, 3, 11, "sound/c3po_29.snd", "npe", "pop_credits", "npe.credits");
    }
    public void npe_marksman_questgiver_action_giveSignalCarbine(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_marksman_carbine");
        npe.sendDelayed3poPopup(player, 3, 11, "sound/c3po_29.snd", "npe", "pop_credits", "npe.credits");
        groundquests.sendSignal(player, "finished_loche");
    }
    public void npe_marksman_questgiver_action_pointDroidEng(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "npe_job_pointer_droid_engineer");
    }
    public void npe_marksman_questgiver_action_giveSlicerQuest(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "npe_side_hutt_slicers");
    }
    public void npe_marksman_questgiver_action_giveSignalSliceComplete(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_side_hutt_slicer_return");
        npe.sendDelayed3poPopup(player, 3, 11, "sound/c3po_29.snd", "npe", "pop_credits", "npe.credits");
    }
    public void npe_marksman_questgiver_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int npe_marksman_questgiver_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_marksman_questgiver_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_marksman_questgiver_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_marksman_questgiver_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_marksman_questgiver_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_marksman_questgiver_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_marksman_questgiver_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_marksman_questgiver_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_marksman_questgiver_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_marksman_questgiver_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_marksman_questgiver_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_marksman_questgiver_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_marksman_questgiver_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_marksman_questgiver_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_marksman_questgiver_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_marksman_questgiver_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_marksman_questgiver_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_marksman_questgiver_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_194"))
        {
            if (npe_marksman_questgiver_condition__defaultCondition(player, npc))
    ...
    public int npe_marksman_questgiver_handleBranch30(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_marksman_questgiver_handleBranch31(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_marksman_questgiver_handleBranch33(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_marksman_questgiver_handleBranch35(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_marksman_questgiver_handleBranch37(obj_id player, obj_id npc, string_id response)
    {
