...
public class corellia_imperial_dark_trooper extends script.base_script
{
    ...
    public boolean corellia_imperial_dark_trooper_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public int corellia_imperial_dark_trooper_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
