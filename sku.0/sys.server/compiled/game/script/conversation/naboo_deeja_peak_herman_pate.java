...
public class naboo_deeja_peak_herman_pate extends script.base_script
{
    ...
    public boolean naboo_deeja_peak_herman_pate_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean naboo_deeja_peak_herman_pate_condition_speakToHerman_01(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "naboo_deeja_peak_beacon_favor", "deeja_peak_beacon_favor_01");
    }
    public boolean naboo_deeja_peak_herman_pate_condition_doneWithHerman(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "naboo_deeja_peak_beacon_favor", "deeja_peak_beacon_favor_01");
    }
    public void naboo_deeja_peak_herman_pate_action_signal_favor_01(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "deeja_peak_beacon_favor_01");
    }
    public int naboo_deeja_peak_herman_pate_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_deeja_peak_herman_pate_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_deeja_peak_herman_pate_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_deeja_peak_herman_pate_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_deeja_peak_herman_pate_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
