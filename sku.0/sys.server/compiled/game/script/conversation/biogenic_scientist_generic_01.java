...
public class biogenic_scientist_generic_01 extends script.base_script
{
    ...
    public boolean biogenic_scientist_generic_01_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean biogenic_scientist_generic_01_condition_get_tracker_1(obj_id player, obj_id npc)
    {
    ...
    public boolean biogenic_scientist_generic_01_condition_get_tracker_2(obj_id player, obj_id npc)
    {
        int tracker = getIntObjVar(player, "biogenic.scientist_generic_one_convo");
        if (tracker == 2)
        {
    ...
    public void biogenic_scientist_generic_01_action__defaultAction(obj_id player, obj_id npc)
    {
    }
    public void biogenic_scientist_generic_01_action_face_to(obj_id player, obj_id npc)
    {
        faceToBehavior(npc, player);
    }
    public void biogenic_scientist_generic_01_action_set_tracker_1(obj_id player, obj_id npc)
    {
        setObjVar(player, "biogenic.scientist_generic_one_convo", 1);
    }
    public void biogenic_scientist_generic_01_action_set_tracker_2(obj_id player, obj_id npc)
    {
