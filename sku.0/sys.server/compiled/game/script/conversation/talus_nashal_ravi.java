...
public class talus_nashal_ravi extends script.base_script
{
    ...
    public boolean talus_nashal_ravi_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean talus_nashal_ravi_condition_onGatherMissions(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "talus_nashal_find_weakness", "selonian_gather_missions");
    }
    public boolean talus_nashal_ravi_condition_onThumb(obj_id player, obj_id npc)
    {
    ...
    public boolean talus_nashal_ravi_condition_onReturnRavi(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "talus_nashal_under_thumb", "selonian_return_ravi");
    }
    public boolean talus_nashal_ravi_condition_completeThumb(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "talus_nashal_under_thumb");
    }
    public void talus_nashal_ravi_action_grantThumb(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "talus_nashal_under_thumb");
    }
    public void talus_nashal_ravi_action_signalThumb(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "selonian_return_ravi");
    }
    public int talus_nashal_ravi_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_ravi_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_ravi_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_ravi_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_ravi_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
