...
public class eisley_thranta_payroll_terminal extends script.base_script
{
    ...
    public boolean eisley_thranta_payroll_terminal_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean eisley_thranta_payroll_terminal_condition_onPayroll(obj_id player, obj_id npc)
    {
    ...
    public boolean eisley_thranta_payroll_terminal_condition_canStealFunds(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "tatooine_eisley_drensbounty_v2", "tat_eisley_drensbounty_e2a");
    }
    public void eisley_thranta_payroll_terminal_action_grantAppFunds(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "tatooine_eisley_appropriating_funds");
    }
    public void eisley_thranta_payroll_terminal_action_signalPayroll(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tat_eisley_drensbounty_e2");
    }
    public int eisley_thranta_payroll_terminal_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int eisley_thranta_payroll_terminal_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int eisley_thranta_payroll_terminal_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int eisley_thranta_payroll_terminal_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int eisley_thranta_payroll_terminal_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int eisley_thranta_payroll_terminal_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int eisley_thranta_payroll_terminal_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
