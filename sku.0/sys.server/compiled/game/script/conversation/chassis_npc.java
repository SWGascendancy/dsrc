...
public class chassis_npc extends script.base_script
{
    ...
    public boolean chassis_npc_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean chassis_npc_condition_hasLoot(obj_id player, obj_id npc)
    {
        return space_crafting.hasLootToSell(player);
    }
    public void chassis_npc_action_showComponentList(obj_id player, obj_id npc)
    {
        space_crafting.purchaseChassisFromBroker(player, npc);
    }
    public int handleCheckShip(obj_id self, dictionary params)
    {
    ...
    public int handleBuyShip(obj_id self, dictionary params)
    {
        final String TBL = "datatables/space_crafting/chassis_npc.iff";
        final String STF = "chassis_npc";
        obj_id player = sui.getPlayerId(params);
    ...
    public int handleChassisTransaction(obj_id self, dictionary params)
    {
        final String STF = "chassis_npc";
    ...
    public void cleanUpScriptVars(obj_id player)
    {
    ...
    public void chassis_npc_action_sellComponents(obj_id player, obj_id npc)
    {
        space_crafting.sellComponentsToBroker(player, npc);
    }
    public int sellLootComponents(obj_id self, dictionary params)
    {
    ...
    public String chassis_npc_tokenTO_tokenTO0001(obj_id player, obj_id npc)
    {
        return new String();
    }
    public int chassis_npc_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
