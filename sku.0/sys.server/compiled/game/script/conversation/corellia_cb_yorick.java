...
public class corellia_cb_yorick extends script.base_script
{
    ...
    public boolean corellia_cb_yorick_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_cb_yorick_condition_flightRecorderStep(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_cb_yorick_condition_completedFlightRecorder(obj_id player, obj_id npc)
    {
    ...
    public void corellia_cb_yorick_action_sendTalkSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "cb_yorick_pointer");
        return;
    }
    public int corellia_cb_yorick_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
