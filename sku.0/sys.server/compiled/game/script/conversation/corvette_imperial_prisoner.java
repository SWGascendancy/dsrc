...
public class corvette_imperial_prisoner extends script.base_script
{
    ...
    public boolean corvette_imperial_prisoner_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corvette_imperial_prisoner_condition_rescued(obj_id player, obj_id npc)
    {
        return hasObjVar(npc, "corl_corvette.alreadyRescued");
    }
    public void corvette_imperial_prisoner_action__defaultAction(obj_id player, obj_id npc)
    {
    }
    public void corvette_imperial_prisoner_action_factionReward(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public void corvette_imperial_prisoner_action_face_player(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return;
    }
