...
public class greeter_dantooine_brother_neutral extends script.base_script
{
    ...
    public boolean greeter_dantooine_brother_neutral_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean greeter_dantooine_brother_neutral_condition_isAnyPilot(obj_id player, obj_id npc)
    {
        return (space_flags.hasAnyPilotSkill(player));
    }
    public boolean greeter_dantooine_brother_neutral_condition_hasSpaceExpansion(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean greeter_dantooine_brother_neutral_condition_hasSpaceShip(obj_id player, obj_id npc)
    {
        return (space_quest.hasShip(player));
    }
    public int greeter_dantooine_brother_neutral_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int greeter_dantooine_brother_neutral_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int greeter_dantooine_brother_neutral_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
