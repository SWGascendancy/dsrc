...
public class station_kashyyyk extends script.base_script
{
    ...
    public boolean station_kashyyyk_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean station_kashyyyk_condition_canAfford50(obj_id player, obj_id npc)
    {
        return space_crafting.canAffordShipRepairs(player, npc, .50f);
    }
    public boolean station_kashyyyk_condition_canAfford25(obj_id player, obj_id npc)
    {
        return (space_crafting.canAffordShipRepairs(player, npc, .25f) && space_crafting.isDamaged(player));
    }
    public boolean station_kashyyyk_condition_canAfford75(obj_id player, obj_id npc)
    {
        return space_crafting.canAffordShipRepairs(player, npc, .75f);
    }
    public boolean station_kashyyyk_condition_canAfford100(obj_id player, obj_id npc)
    {
        return space_crafting.canAffordShipRepairs(player, npc, 1.0f);
    }
    public boolean station_kashyyyk_condition_hasWonQuest_01(obj_id player, obj_id npc)
    {
        return (space_quest.hasWonQuest(player, "escort", "ep3_kash_station_escort_alpha"));
    }
    public boolean station_kashyyyk_condition_hasWonQuest_02(obj_id player, obj_id npc)
    {
        return (space_quest.hasWonQuest(player, "escort", "ep3_kash_station_escort_bravo"));
    }
    public boolean station_kashyyyk_condition_hasWonQuest_03(obj_id player, obj_id npc)
    {
        return (space_quest.hasWonQuest(player, "rescue", "ep3_kash_station_rescue_alpha"));
    }
    public boolean station_kashyyyk_condition_hasWonQuest_04(obj_id player, obj_id npc)
    {
        return (space_quest.hasWonQuest(player, "rescue", "ep3_kash_station_rescue_bravo"));
    }
    public boolean station_kashyyyk_condition_isOnQuest_escort_alpha(obj_id player, obj_id npc)
    {
        return (space_quest.hasQuest(player, "escort", "ep3_kash_station_escort_alpha"));
    }
    public boolean station_kashyyyk_condition_hasFailedQuest_01(obj_id player, obj_id npc)
    {
    ...
    public boolean station_kashyyyk_condition_hasBeenRewarded_01(obj_id player, obj_id npc)
    {
        return space_quest.hasReceivedReward(player, "escort", "ep3_kash_station_escort_alpha");
    }
    public boolean station_kashyyyk_condition_hasFailedQuest_02(obj_id player, obj_id npc)
    {
    ...
    public boolean station_kashyyyk_condition_hasBeenRewarded_02(obj_id player, obj_id npc)
    {
        return space_quest.hasReceivedReward(player, "escort", "ep3_kash_station_escort_bravo");
    }
    public boolean station_kashyyyk_condition_hasWon01_not02yet(obj_id player, obj_id npc)
    {
    ...
    public boolean station_kashyyyk_condition_hasWon02_not03yet(obj_id player, obj_id npc)
    {
    ...
    public boolean station_kashyyyk_condition_hasWon03_not04yet(obj_id player, obj_id npc)
    {
    ...
    public boolean station_kashyyyk_condition_hasDoneGround_01(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedQuest(player, "ep3_kash_station_contact_eyma_01"));
    }
    public boolean station_kashyyyk_condition_hasWon_assassinations(obj_id player, obj_id npc)
    {
    ...
    public boolean station_kashyyyk_condition_isOnQuest_ground_01(obj_id player, obj_id npc)
    {
        return (groundquests.isQuestActive(player, "ep3_kash_station_contact_eyma_01"));
    }
    public boolean station_kashyyyk_condition_isOnQuest_AMBUSH(obj_id player, obj_id npc)
    {
    ...
    public boolean station_kashyyyk_condition_hasFailedQuest_03(obj_id player, obj_id npc)
    {
    ...
    public boolean station_kashyyyk_condition_isOnQuest_ground_00(obj_id player, obj_id npc)
    {
        return (groundquests.isQuestActive(player, "ep3_kash_station_contact_eyma_00"));
    }
    public boolean station_kashyyyk_condition_isOnQuest_rescue_alpha(obj_id player, obj_id npc)
    {
        return (space_quest.hasQuest(player, "rescue", "ep3_kash_station_rescue_alpha"));
    }
    public boolean station_kashyyyk_condition_isOnQuest_escort_bravo(obj_id player, obj_id npc)
    {
        return (space_quest.hasQuest(player, "escort", "ep3_kash_station_escort_bravo"));
    }
    public boolean station_kashyyyk_condition_isTooFar(obj_id player, obj_id npc)
    {
        space_combat.playCombatTauntSound(player);
        obj_id containingShip = space_transition.getContainingShip(player);
        return (getDistance(npc, containingShip) > space_transition.STATION_COMM_MAX_DISTANCE);
    }
    public boolean station_kashyyyk_condition_hasBadge_visited_Kachirho(obj_id player, obj_id npc)
    {
        return badge.hasBadge(player, "exp_kash_kachirho_found");
    }
    public boolean station_kashyyyk_condition_hasBeenRewarded_blacksun_heavy(obj_id player, obj_id npc)
    {
        return space_quest.hasReceivedReward(player, "recovery", "ep3_blacksun_heavy_recovery");
    }
    public boolean station_kashyyyk_condition_hasWon_blacksun_heavy_recovery(obj_id player, obj_id npc)
    {
    ...
    public boolean station_kashyyyk_condition_isNeutralPilot(obj_id player, obj_id npc)
    {
        return (space_battlefield.isInNeutralShip(player) || pvpGetAlignedFaction(player) == (534523985));
    }
    public void station_kashyyyk_action_land_kashyyyk(obj_id player, obj_id npc)
    {
        space_content.landPlayer(player, npc, "Kachirho Starport");
    }
    public void station_kashyyyk_action_fix25(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, .25f);
    }
    public void station_kashyyyk_action_fix50(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, .50f);
    }
    public void station_kashyyyk_action_fix75(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, .75f);
    }
    public void station_kashyyyk_action_fix100(obj_id player, obj_id npc)
    {
        space_crafting.doStationToShipRepairs(player, npc, 1.0f);
    }
    public void station_kashyyyk_action_grantQuest_01(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "escort", "ep3_kash_station_escort_alpha");
    }
    public void station_kashyyyk_action_grantQuest_02(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "escort", "ep3_kash_station_escort_bravo");
    }
    public void station_kashyyyk_action_grantQuest_03(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "rescue", "ep3_kash_station_rescue_alpha");
    }
    public void station_kashyyyk_action_grantQuest_04(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "rescue", "ep3_kash_station_rescue_bravo");
    }
    public void station_kashyyyk_action_rewardQuest_01(obj_id player, obj_id npc)
    {
    ...
    public void station_kashyyyk_action_rewardQuest_02(obj_id player, obj_id npc)
    {
    ...
    public void station_kashyyyk_action_grantDuty_escort(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "escort_duty", "ep3_kash_station_escort_duty");
    }
    public void station_kashyyyk_action_giveGroundQuest_01(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_kash_station_contact_eyma_01");
    }
    public void station_kashyyyk_action_grantDuty_destroy(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "ep3_kash_station_destroy_duty_neutral");
    }
    public void station_kashyyyk_action_giveGroundQuest_00(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_kash_station_contact_eyma_00");
    }
    public void station_kashyyyk_action_Land_and_GrantBadge_visited_Kachirho(obj_id player, obj_id npc)
    {
        badge.grantBadge(player, "exp_kash_kachirho_found");
        space_content.landPlayer(player, npc, "Kachirho Starport");
    }
    public void station_kashyyyk_action_grantQuest_blacksun_heavy_recovery(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "recovery", "ep3_blacksun_heavy_recovery");
    }
    public void station_kashyyyk_action_giveReward_blacksun_heavy(obj_id player, obj_id npc)
    {
    ...
    public int station_kashyyyk_tokenDI_getStationRepairCost25(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, .25f);
    }
    public int station_kashyyyk_tokenDI_getStationRepairCost50(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, .50f);
    }
    public int station_kashyyyk_tokenDI_getStationRepairCost75(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, .75f);
    }
    public int station_kashyyyk_tokenDI_getStationRepairCost100(obj_id player, obj_id npc)
    {
        return space_crafting.getStationRepairCost(player, npc, 1.0f);
    }
    public int station_kashyyyk_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_kashyyyk_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_kashyyyk_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_kashyyyk_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_kashyyyk_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_kashyyyk_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_kashyyyk_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_kashyyyk_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_kashyyyk_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_kashyyyk_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_kashyyyk_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_kashyyyk_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_kashyyyk_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_kashyyyk_handleBranch30(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_450"))
        {
            if (station_kashyyyk_condition__defaultCondition(player, npc))
    ...
    public int station_kashyyyk_handleBranch31(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_450"))
        {
            if (station_kashyyyk_condition__defaultCondition(player, npc))
    ...
    public int station_kashyyyk_handleBranch32(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_kashyyyk_handleBranch34(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_kashyyyk_handleBranch35(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_kashyyyk_handleBranch36(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_kashyyyk_handleBranch38(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_288"))
        {
            if (station_kashyyyk_condition__defaultCondition(player, npc))
    ...
    public int station_kashyyyk_handleBranch39(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_288"))
        {
            if (station_kashyyyk_condition__defaultCondition(player, npc))
    ...
    public int station_kashyyyk_handleBranch40(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_288"))
        {
            if (station_kashyyyk_condition__defaultCondition(player, npc))
    ...
    public int station_kashyyyk_handleBranch42(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_kashyyyk_handleBranch43(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_kashyyyk_handleBranch45(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_kashyyyk_handleBranch47(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_kashyyyk_handleBranch49(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_kashyyyk_handleBranch50(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_kashyyyk_handleBranch53(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_kashyyyk_handleBranch55(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_kashyyyk_handleBranch56(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_kashyyyk_handleBranch57(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_kashyyyk_handleBranch59(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_kashyyyk_handleBranch60(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_kashyyyk_handleBranch62(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_kashyyyk_handleBranch67(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_kashyyyk_handleBranch68(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_kashyyyk_handleBranch71(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_kashyyyk_handleBranch74(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_kashyyyk_handleBranch77(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_kashyyyk_handleBranch81(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_kashyyyk_handleBranch82(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_kashyyyk_handleBranch83(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_kashyyyk_handleBranch86(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_kashyyyk_handleBranch88(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_kashyyyk_handleBranch89(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_kashyyyk_handleBranch92(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_kashyyyk_handleBranch94(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_kashyyyk_handleBranch96(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_732"))
        {
            if (station_kashyyyk_condition__defaultCondition(player, npc))
    ...
    public int station_kashyyyk_handleBranch97(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_732"))
        {
            if (station_kashyyyk_condition__defaultCondition(player, npc))
