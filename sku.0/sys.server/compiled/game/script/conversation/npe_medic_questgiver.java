...
public class npe_medic_questgiver extends script.base_script
{
    ...
    public boolean npe_medic_questgiver_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean npe_medic_questgiver_condition_isTaskCompleteBacta(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_medic", "npe_medic_return");
    }
    public boolean npe_medic_questgiver_condition_canTakeDna(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_medic_questgiver_condition_isTaskCompleteDna(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_side_dungeon_dna", "npe_side_dungeon_dna_signal");
    }
    public boolean npe_medic_questgiver_condition_isMedicTaskActive(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_medic", "npe_medic_heal_1");
    }
    public boolean npe_medic_questgiver_condition_hasCompletedMedicQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_medic");
    }
    public boolean npe_medic_questgiver_condition_isDnaTaskActive(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "npe_side_dungeon_dna", "npe_side_dungeon_dna_wait");
    }
    public boolean npe_medic_questgiver_condition_isAnyTaskActive(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_medic_questgiver_condition_needsPack(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_medic_questgiver_condition_hasCompletedSolo(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "npe_solo_profession");
    }
    public boolean npe_medic_questgiver_condition_needsToFinishTraining(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_medic_questgiver_condition_pointedToHere(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "npe_pointer_medic");
    }
    public boolean npe_medic_questgiver_condition_cantHelp(obj_id player, obj_id npc)
    {
    ...
    public boolean npe_medic_questgiver_condition_hasCompletedTemplate(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "npe.finishedTemplate");
    }
    public void npe_medic_questgiver_action_giveMedicQuest(obj_id player, obj_id npc)
    {
    ...
    public void npe_medic_questgiver_action_giveSignalHealDone(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_medic_done_healing");
        groundquests.sendSignal(player, "finished_aja");
    }
    public void npe_medic_questgiver_action_giveNewPack(obj_id player, obj_id npc)
    {
        obj_id bactaPack = static_item.createNewItemFunction("item_bactapack_01_01", player);
        obj_id[] items = new obj_id[1];
        items[0] = bactaPack;
    ...
    public void npe_medic_questgiver_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void npe_medic_questgiver_action_giveDnaQuest(obj_id player, obj_id npc)
    {
    ...
    public void npe_medic_questgiver_action_giveSignalDna(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "npe_side_dungeon_dna_signal");
    }
    public int npe_medic_questgiver_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_medic_questgiver_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_medic_questgiver_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_medic_questgiver_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_medic_questgiver_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_medic_questgiver_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_medic_questgiver_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_medic_questgiver_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_medic_questgiver_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_medic_questgiver_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int npe_medic_questgiver_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
