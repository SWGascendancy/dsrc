...
public class seans_historian extends script.base_script
{
    ...
    public boolean seans_historian_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean seans_historian_condition_historyQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean seans_historian_condition_hasFind(obj_id player, obj_id npc)
    {
    ...
    public boolean seans_historian_condition_hasItem(obj_id player, obj_id npc)
    {
    ...
    public boolean seans_historian_condition_inoffice(obj_id player, obj_id npc)
    {
        if (hasObjVar(npc, "bestine.electionWinner"))
        {
            String winner = getStringObjVar(npc, "bestine.electionWinner");
    ...
    public void seans_historian_action__defaultAction(obj_id player, obj_id npc)
    {
    }
    public void seans_historian_action_setFind(obj_id player, obj_id npc)
    {
    ...
    public void seans_historian_action_ItemfoundObj(obj_id player, obj_id npc)
    {
    ...
    public void seans_historian_action_cleanUpOldVars(obj_id player, obj_id npc)
    {
        if (!utils.playerHasItemByTemplate(player, "object/tangible/loot/quest/sean_history_disk.iff"))
        {
