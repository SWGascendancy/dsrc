...
public class fs_intro_oldman_initial extends script.base_script
{
    ...
    public boolean fs_intro_oldman_initial_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean fs_intro_oldman_initial_condition_Intro(obj_id player, obj_id npc)
    {
        obj_id owner = null;
    ...
    public boolean fs_intro_oldman_initial_condition_Exit(obj_id player, obj_id npc)
    {
        obj_id owner = null;
        if (hasObjVar(npc, "old_man_initial.holder"))
        {
    ...
    public boolean fs_intro_oldman_initial_condition_None(obj_id player, obj_id npc)
    {
        int stage = 0;
    ...
    public void fs_intro_oldman_initial_action_action0001(obj_id player, obj_id npc)
    {
    ...
    public void fs_intro_oldman_initial_action_action0002(obj_id player, obj_id npc)
    {
        fs_quests.setStage(player, 0);
        fs_quests.setDelay(player, 0);
        fs_quests.oldManDepart(player, npc, 1);
    ...
    public void fs_intro_oldman_initial_action_action0003(obj_id player, obj_id npc)
    {
    ...
    public void fs_intro_oldman_initial_action_action0004(obj_id player, obj_id npc)
    {
    ...
    public void fs_intro_oldman_initial_action_action0005(obj_id player, obj_id npc)
    {
