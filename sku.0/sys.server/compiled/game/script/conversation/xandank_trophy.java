...
public class xandank_trophy extends script.base_script
{
    ...
    public boolean xandank_trophy_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean xandank_trophy_condition_isOnTask(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "som_xandank_trophey");
    }
    public boolean xandank_trophy_condition_hasFinishedTask(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "som_xandank_trophey", "xandank_trophy_nine");
    }
    public boolean xandank_trophy_condition_hasFinishedQuest(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "som_xandank_trophey");
    }
    public void xandank_trophy_action_startMission(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "som_xandank_trophey");
    }
    public void xandank_trophy_action_giveReward(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "xandank_trophy_signal_three");
    }
    public int xandank_trophy_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int xandank_trophy_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int xandank_trophy_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int xandank_trophy_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int xandank_trophy_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int xandank_trophy_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
