...
public class exar_kun_intro_giver extends script.base_script
{
    ...
    public boolean exar_kun_intro_giver_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean exar_kun_intro_giver_condition_exar_kun_02_active(obj_id player, obj_id npc)
    {
    ...
    public boolean exar_kun_intro_giver_condition_exar_kun_02_05_active(obj_id player, obj_id npc)
    {
    ...
    public boolean exar_kun_intro_giver_condition_exar_kun_01_active(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "exar_kun_intro_01");
    }
    public void exar_kun_intro_giver_action_exar_kun_01_grant(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "exar_kun_intro_01");
    }
    public void exar_kun_intro_giver_action_exar_kun_02_05_signal(obj_id player, obj_id npc)
    {
    ...
    public int exar_kun_intro_giver_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int exar_kun_intro_giver_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
