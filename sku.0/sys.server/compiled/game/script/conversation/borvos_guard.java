...
public class borvos_guard extends script.base_script
{
    ...
    public boolean borvos_guard_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean borvos_guard_condition_finishedJobONe(obj_id player, obj_id npc)
    {
    ...
    public boolean borvos_guard_condition_finishedJobTwo(obj_id player, obj_id npc)
    {
    ...
    public boolean borvos_guard_condition_onJobOne(obj_id player, obj_id npc)
    {
    ...
    public boolean borvos_guard_condition_onJobTwo(obj_id player, obj_id npc)
    {
    ...
    public boolean borvos_guard_condition_onJobThree(obj_id player, obj_id npc)
    {
    ...
    public boolean borvos_guard_condition_finishedJobThree(obj_id player, obj_id npc)
    {
    ...
    public boolean borvos_guard_condition_workingForBorvo(obj_id player, obj_id npc)
    {
    ...
    public boolean borvos_guard_condition_isOnHuffQuest(obj_id player, obj_id npc)
    {
    ...
    public void borvos_guard_action_giveJobOne(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest/borvos_guard_dagorel");
    }
    public void borvos_guard_action_giveJobTwo(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest/borvos_guard_frangee");
    }
    public void borvos_guard_action_giveJobThree(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "quest/borvos_guard_corellia");
    }
    public void borvos_guard_action_signalJobOneDone(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "finishedJobOne");
    }
    public void borvos_guard_action_signalJobTwoDone(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "finishedJobTwo");
    }
    public void borvos_guard_action_signalJobThreeDone(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "finishedJobThree");
    }
    public int borvos_guard_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int borvos_guard_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int borvos_guard_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int borvos_guard_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int borvos_guard_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int borvos_guard_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int handleSetConversable(obj_id self, dictionary params)
    {
