...
public class collections_ice_cream_part_two extends script.base_script
{
    ...
    public boolean collections_ice_cream_part_two_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean collections_ice_cream_part_two_condition_hasActiveTask(obj_id player, obj_id npc)
    {
    ...
    public void collections_ice_cream_part_two_action_signalNextTask(obj_id player, obj_id npc)
    {
        modifyCollectionSlotValue(player, "col_fried_icecream_part_02", 1);
        groundquests.sendSignal(player, "meet_amyva_vanew");
    }
    public int collections_ice_cream_part_two_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int collections_ice_cream_part_two_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int collections_ice_cream_part_two_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int collections_ice_cream_part_two_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int collections_ice_cream_part_two_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
