...
public class tatooine_espa_pah extends script.base_script
{
    ...
    public boolean tatooine_espa_pah_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tatooine_espa_pah_condition_repoOnTask(obj_id player, obj_id npc)
    {
    ...
    public void tatooine_espa_pah_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void tatooine_espa_pah_action_signalRepoAttack(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tat_espa_repo_man_e1");
    }
    public int tatooine_espa_pah_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_espa_pah_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
