...
public class exar_kun_intro_grenz extends script.base_script
{
    ...
    public boolean exar_kun_intro_grenz_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean exar_kun_intro_grenz_condition_exar_kun_01_07_active(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "exar_kun_intro_01", "exar_kun_intro_01_07");
    }
    public boolean exar_kun_intro_grenz_condition_exar_kun_01_08_active(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "exar_kun_intro_01", "exar_kun_intro_01_08");
    }
    public boolean exar_kun_intro_grenz_condition_wave_event_active(obj_id player, obj_id npc)
    {
        int wave = utils.getIntScriptVar(npc, "waveEventCurrentWave");
        return wave > 0;
    }
    public void exar_kun_intro_grenz_action_exar_kun_01_wave(obj_id player, obj_id npc)
    {
        dictionary webster = new dictionary();
        webster.put("player", player);
        messageTo(npc, "waveEventControllerNPCStart", webster, 0, false);
    }
    public void exar_kun_intro_grenz_action_exar_kun_01_08(obj_id player, obj_id npc)
    {
