...
public class choster_lok_cantina extends script.base_script
{
    ...
    public boolean choster_lok_cantina_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean choster_lok_cantina_condition_hasChosterTask(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "u16_nym_themepark_interview_choster", "findChoster");
    }
    public boolean choster_lok_cantina_condition_hasCompletedPirate(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.hasCompletedQuest(player, "u16_nym_themepark_pirate_hideout");
    }
    public boolean choster_lok_cantina_condition_hasCompletedChoster(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean choster_lok_cantina_condition_hasSavedSheeli(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.hasCompletedQuest(player, "u16_nym_themepark_negotiate_peace");
    }
    public void choster_lok_cantina_action_finishChosterInterview(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "hasSpokenChoster");
    }
    public int choster_lok_cantina_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int choster_lok_cantina_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int choster_lok_cantina_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int choster_lok_cantina_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int choster_lok_cantina_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int choster_lok_cantina_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int choster_lok_cantina_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int choster_lok_cantina_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int choster_lok_cantina_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int choster_lok_cantina_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_83"))
        {
            if (choster_lok_cantina_condition__defaultCondition(player, npc))
    ...
    public int choster_lok_cantina_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_83"))
        {
            if (choster_lok_cantina_condition__defaultCondition(player, npc))
    ...
    public int choster_lok_cantina_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_83"))
        {
            if (choster_lok_cantina_condition__defaultCondition(player, npc))
    ...
    public int choster_lok_cantina_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int choster_lok_cantina_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int choster_lok_cantina_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
