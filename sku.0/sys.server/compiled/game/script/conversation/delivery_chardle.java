...
public class delivery_chardle extends script.base_script
{
    ...
    public boolean delivery_chardle_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean delivery_chardle_condition_noAntivirus(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean delivery_chardle_condition_hasNotFoundBeta(obj_id player, obj_id npc)
    {
        return !hasCompletedCollectionSlot(player, "exp_icon_deathtroopers_camp_epsilon");
    }
    public boolean delivery_chardle_condition_neverDelivered(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (!groundquests.isQuestActiveOrComplete(player, "camp_delta_delivery_01"));
    }
    public boolean delivery_chardle_condition_hasMeetingTask(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "camp_delta_delivery_01", "getBeastDelta");
    }
    public boolean delivery_chardle_condition_hasEscortTask(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "camp_delta_delivery_01", "escortTaskDelta");
    }
    public boolean delivery_chardle_condition_hasDeliveredBefore(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "camp_delta_delivery_01");
    }
    public boolean delivery_chardle_condition_tooLowLevel(obj_id player, obj_id npc)
    {
        return getLevel(player) < 60;
    }
    public void delivery_chardle_action_giveQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public void delivery_chardle_action_clearDeliveryQuest(obj_id player, obj_id npc)
    {
        groundquests.clearQuest(player, "camp_delta_delivery_01");
    }
    public int delivery_chardle_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int delivery_chardle_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int delivery_chardle_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int delivery_chardle_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int delivery_chardle_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int delivery_chardle_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
