...
public class tatooine_privateer_trainer_2 extends script.base_script
{
    ...
    public boolean tatooine_privateer_trainer_2_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tatooine_privateer_trainer_2_condition_hasCompletedTransition(obj_id player, obj_id npc)
    {
    ...
    public boolean tatooine_privateer_trainer_2_condition_hasAllTierOneSkills(obj_id player, obj_id npc)
    {
        return space_flags.hasCompletedTierOne(player);
    }
    public boolean tatooine_privateer_trainer_2_condition_isSmugglerAllianceMember(obj_id player, obj_id npc)
    {
        return space_flags.isSpaceTrack(player, space_flags.PRIVATEER_TATOOINE);
    }
    public boolean tatooine_privateer_trainer_2_condition_isOnTransQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean tatooine_privateer_trainer_2_condition_gettingTransQuestReward(obj_id player, obj_id npc)
    {
        if (!space_quest.hasWonQuestRecursive(player, "patrol", "tat_priv_quest_trans"))
        {
            return false;
    ...
    public boolean tatooine_privateer_trainer_2_condition_failedTransQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean tatooine_privateer_trainer_2_condition_hasCompletedSeries(obj_id player, obj_id npc)
    {
    ...
    public boolean tatooine_privateer_trainer_2_condition_doneWithTier3(obj_id player, obj_id npc)
    {
        return space_flags.hasCompletedTierThree(player);
    }
    public boolean tatooine_privateer_trainer_2_condition_doneWithTier4(obj_id player, obj_id npc)
    {
        return space_flags.hasCompletedTierFour(player);
    }
    public void tatooine_privateer_trainer_2_action_grantTransQuest(obj_id player, obj_id npc)
    {
