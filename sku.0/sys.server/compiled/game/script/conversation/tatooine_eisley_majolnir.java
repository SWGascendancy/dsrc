...
public class tatooine_eisley_majolnir extends script.base_script
{
    ...
    public boolean tatooine_eisley_majolnir_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tatooine_eisley_majolnir_condition_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return true;
    }
    public boolean tatooine_eisley_majolnir_condition_readyForKit(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean tatooine_eisley_majolnir_condition_doneWithMe(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public void tatooine_eisley_majolnir_action_sendKitSignal(obj_id player, obj_id npc)
    {
