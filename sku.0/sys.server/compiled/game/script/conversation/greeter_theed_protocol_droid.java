...
public class greeter_theed_protocol_droid extends script.base_script
{
    ...
    public boolean greeter_theed_protocol_droid_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean greeter_theed_protocol_droid_condition_remembersPlayer(obj_id player, obj_id npc)
    {
        return (utils.hasScriptVar(player, "metNewbiePilot"));
    }
    public boolean greeter_theed_protocol_droid_condition_speaksMonCal(obj_id player, obj_id npc)
    {
        return hasSkill(player, "language_mon_cal");
    }
    public boolean greeter_theed_protocol_droid_condition_isAnyPilot(obj_id player, obj_id npc)
    {
    ...
    public boolean greeter_theed_protocol_droid_condition_isAnImperialPilot(obj_id player, obj_id npc)
    {
        return space_flags.isImperialPilot(player);
    }
    public boolean greeter_theed_protocol_droid_condition_isARebelPilot(obj_id player, obj_id npc)
    {
        return space_flags.isRebelPilot(player);
    }
    public boolean greeter_theed_protocol_droid_condition_isPrivateerPilot(obj_id player, obj_id npc)
    {
        return space_flags.isNeutralPilot(player);
    }
    public boolean greeter_theed_protocol_droid_condition_hasSpaceExpansion(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean greeter_theed_protocol_droid_condition_hasSpaceShip(obj_id player, obj_id npc)
    {
        return (space_quest.hasShip(player));
    }
    public void greeter_theed_protocol_droid_action_rememberPlayer(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "metNewbiePilot", true);
    }
    public void greeter_theed_protocol_droid_action_grantQuestOne(obj_id player, obj_id npc)
    {
