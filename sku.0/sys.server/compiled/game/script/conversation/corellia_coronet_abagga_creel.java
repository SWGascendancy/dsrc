...
public class corellia_coronet_abagga_creel extends script.base_script
{
    ...
    public boolean corellia_coronet_abagga_creel_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_coronet_abagga_creel_condition_needsInvoice(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_coronet_find_missing_shipment", "ralMundi_getInvoice");
    }
    public boolean corellia_coronet_abagga_creel_condition_isCraftingTool(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_coronet_find_missing_shipment", "ralMundi_craftTool");
    }
    public boolean corellia_coronet_abagga_creel_condition_craftedTool(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_coronet_find_missing_shipment", "ralMundi_craftedTool");
    }
    public boolean corellia_coronet_abagga_creel_condition_finishedWithAbagga(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_coronet_abagga_creel_condition_finishedMissingShipment(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_coronet_abagga_creel_condition_craftCraftingTool(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_coronet_find_missing_shipment", "ralMundi_getInvoice");
    }
    public boolean corellia_coronet_abagga_creel_condition_newIntroBranch(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_coronet_capitol_problems_missing_shipment_intro", "ralMundi_gaveTool");
    }
    public void corellia_coronet_abagga_creel_action_sendForTool(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "ralMundi_getInvoice");
    }
    public void corellia_coronet_abagga_creel_action_giveInvoiceCrafted(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "ralMundi_craftedTool");
    }
    public void corellia_coronet_abagga_creel_action_giveInvoiceGiven(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "ralMundi_gaveTool");
    }
    public int corellia_coronet_abagga_creel_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_abagga_creel_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_abagga_creel_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_abagga_creel_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
