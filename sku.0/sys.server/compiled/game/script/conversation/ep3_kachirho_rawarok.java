...
public class ep3_kachirho_rawarok extends script.base_script
{
    ...
    public boolean ep3_kachirho_rawarok_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_kachirho_rawarok_condition_cannotSpeakWookiee(obj_id player, obj_id npc)
    {
        return utils.canSpeakWookiee(player, npc);
    }
    public void ep3_kachirho_rawarok_action_vocalizeWookiee(obj_id player, obj_id npc)
    {
        utils.emoteWookieeConfusion(player, npc);
    }
    public void ep3_kachirho_rawarok_action_vocalizeShort(obj_id player, obj_id npc)
    {
