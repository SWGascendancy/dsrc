...
public class meatlump_vendor extends script.base_script
{
    ...
    public boolean meatlump_vendor_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean meatlump_vendor_condition_canPurchase(obj_id player, obj_id npc)
    {
        return true;
    }
    public void meatlump_vendor_action_showResourceVendorUI(obj_id player, obj_id npc)
    {
