...
public class loveday_disillusion_blaire extends script.base_script
{
    ...
    public boolean loveday_disillusion_blaire_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean loveday_disillusion_blaire_condition_petLoverActive(obj_id player, obj_id npc)
    {
    ...
    public boolean loveday_disillusion_blaire_condition_questStart(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "loveday_disillusion_pet_lover_v2", "loveday_disillusion_pet_lover_01");
    }
    public boolean loveday_disillusion_blaire_condition_petLoverReturn(obj_id player, obj_id npc)
    {
    ...
    public boolean loveday_disillusion_blaire_condition_loveNoteActive(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "loveday_disillusion_love_note_v2");
    }
    public boolean loveday_disillusion_blaire_condition_loveNoteReturn(obj_id player, obj_id npc)
    {
    ...
    public boolean loveday_disillusion_blaire_condition_mrHateActive(obj_id player, obj_id npc)
    {
    ...
    public boolean loveday_disillusion_blaire_condition_mrHateReturn(obj_id player, obj_id npc)
    {
    ...
    public boolean loveday_disillusion_blaire_condition_questComplete(obj_id player, obj_id npc)
    {
        return hasCompletedCollectionSlot(player, "loveday_2010_disillusion_quest");
    }
    public boolean loveday_disillusion_blaire_condition_undisillusioned(obj_id player, obj_id npc)
    {
        return utils.hasScriptVar(npc, "unDisillusioned");
    }
    public void loveday_disillusion_blaire_action_grantLoveNote(obj_id player, obj_id npc)
    {
        if (groundquests.isQuestActive(player, "loveday_disillusion_love_note_v2"))
        {
    ...
    public void loveday_disillusion_blaire_action_grantMrHate(obj_id player, obj_id npc)
    {
    ...
    public void loveday_disillusion_blaire_action_signalPetLover(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "loveday_disillusion_pet_lover_complete");
    }
    public void loveday_disillusion_blaire_action_signalStart(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "loveday_disillusion_pet_lover_01");
    }
    public void loveday_disillusion_blaire_action_signalLoveNote(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "loveday_disillusion_love_note_complete");
    }
    public void loveday_disillusion_blaire_action_signalMrHate(obj_id player, obj_id npc)
    {
    ...
    public void loveday_disillusion_blaire_action_grantCollectionSlot(obj_id player, obj_id npc)
    {
        if (!hasCompletedCollectionSlot(player, "loveday_2010_disillusion_quest"))
        {
            modifyCollectionSlotValue(player, "loveday_2010_disillusion_quest", 1);
    ...
    public int loveday_disillusion_blaire_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int loveday_disillusion_blaire_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int loveday_disillusion_blaire_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int loveday_disillusion_blaire_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int loveday_disillusion_blaire_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int loveday_disillusion_blaire_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int loveday_disillusion_blaire_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int handleResetDisillusionAppearance(obj_id self, dictionary params)
    {
