...
public class nym_technician_2 extends script.base_script
{
    ...
    public boolean nym_technician_2_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean nym_technician_2_condition_isOnStormSquadronQuest(obj_id player, obj_id npc)
    {
        return space_flags.hasSpaceFlag(player, "ss.findingAgent");
    }
    public int nym_technician_2_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_technician_2_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int nym_technician_2_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_62f865dd"))
        {
            if (nym_technician_2_condition__defaultCondition(player, npc))
    ...
    public int nym_technician_2_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
