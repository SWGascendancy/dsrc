...
public class ep3_clone_relics_clone_trooper_walda extends script.base_script
{
    ...
    public boolean ep3_clone_relics_clone_trooper_walda_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_clone_relics_clone_trooper_walda_condition_onQuestNeutral(obj_id player, obj_id npc)
    {
        return (groundquests.isQuestActive(player, "ep3_clone_relics_clone_trooper_neutral"));
    }
    public boolean ep3_clone_relics_clone_trooper_walda_condition_needHuttese(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "ep3_clone_relics_clone_trooper_mort_neutral", "talkToTeacher"));
    }
    public void ep3_clone_relics_clone_trooper_walda_action_doneWithTeacher(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedToTeacher");
        skill.grantSkillToPlayer(player, "social_language_hutt");
    }
    public int ep3_clone_relics_clone_trooper_walda_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_walda_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_walda_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_walda_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_walda_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
