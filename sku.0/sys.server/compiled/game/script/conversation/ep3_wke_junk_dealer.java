...
public class ep3_wke_junk_dealer extends script.base_script
{
    ...
    public boolean ep3_wke_junk_dealer_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_wke_junk_dealer_condition_check_inv(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_wke_junk_dealer_condition_cannotSpeakWookiee(obj_id player, obj_id npc)
    {
    ...
    public void ep3_wke_junk_dealer_action_start_dealing(obj_id player, obj_id npc)
    {
    ...
    public void ep3_wke_junk_dealer_action_vocalizeMed(obj_id player, obj_id npc)
    {
        playClientEffectObj(npc, "clienteffect/voc_wookiee_med_4sec.cef", player, "");
    }
    public int ep3_wke_junk_dealer_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
