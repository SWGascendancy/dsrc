...
public class rebel_title_grant extends script.base_script
{
    ...
    public boolean rebel_title_grant_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean rebel_title_grant_condition_isImperialPlayer(obj_id player, obj_id npc)
    {
        return factions.isImperial(player);
    }
    public boolean rebel_title_grant_condition_isRebelPlayer(obj_id player, obj_id npc)
    {
        return factions.isRebel(player);
    }
    public boolean rebel_title_grant_condition_hasMillionCredits(obj_id player, obj_id npc)
    {
        return money.hasFunds(player, money.MT_TOTAL, money.MILLION);
    }
    public boolean rebel_title_grant_condition_hasTitle(obj_id player, obj_id npc)
    {
        return hasCompletedCollectionSlot(player, "reb_million_title");
    }
    public void rebel_title_grant_action_grantTitle(obj_id player, obj_id npc)
    {
    ...
    public int rebel_title_grant_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_title_grant_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_title_grant_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_title_grant_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
