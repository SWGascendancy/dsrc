...
public class junk_dealer_smuggler extends script.base_script
{
    ...
    public boolean junk_dealer_smuggler_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean junk_dealer_smuggler_condition_check_inv(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return smuggler.checkInventory(player, npc);
    }
    public boolean junk_dealer_smuggler_condition_hasNoInv(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean junk_dealer_smuggler_condition_check_master(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean junk_dealer_smuggler_condition_isInParty(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        obj_id master = utils.getObjIdScriptVar(npc, "smugglerMaster");
        if (player == master)
    ...
    public boolean junk_dealer_smuggler_condition_canGetPistolQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean junk_dealer_smuggler_condition_canGetPistolQuestComplete(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        obj_id module = utils.getStaticItemInInventory(player, "item_reward_modify_pistol_01_01");
    ...
    public boolean junk_dealer_smuggler_condition_hasBuyBackItems(obj_id player, obj_id npc)
    {
        obj_id[] listOfBuyBacks = smuggler.getBuyBackItemsInContainer(player);
        return listOfBuyBacks != null && listOfBuyBacks.length > 0;
    }
    public boolean junk_dealer_smuggler_condition_isInPartyWithBuyBack(obj_id player, obj_id npc)
    {
        return junk_dealer_smuggler_condition_isInParty(player, npc) && junk_dealer_smuggler_condition_hasBuyBackItems(player, npc);
    }
    public boolean junk_dealer_smuggler_condition_checkBuyBackContainer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public void junk_dealer_smuggler_action_start_dealing(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        messageTo(npc, "startDealing", params, 0.0f, false);
    }
    public void junk_dealer_smuggler_action_face_to(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void junk_dealer_smuggler_action_grant_pistol_quest(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "quest/smuggler_modules_for_pistol", true);
    }
    public void junk_dealer_smuggler_action_complete_pistol_quest(obj_id player, obj_id npc)
    {
        obj_id module = utils.getStaticItemInInventory(player, "item_reward_modify_pistol_01_01");
        if (!isIdValid(module) || getCount(module) < 100)
        {
    ...
    public void junk_dealer_smuggler_action_startBuyBack(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        messageTo(npc, "startBuyBack", params, 0.0f, false);
    }
    public void junk_dealer_smuggler_action_createBuyBackContainer(obj_id player, obj_id npc)
    {
    ...
    public void junk_dealer_smuggler_action_dismiss(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        messageTo(npc, "dismissDealer", params, 1.0f, false);
    }
    public void junk_dealer_smuggler_action_startFlagNoSale(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        messageTo(npc, "startFlaggingItemsNoSale", params, 0.0f, false);
    }
    public int junk_dealer_smuggler_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
