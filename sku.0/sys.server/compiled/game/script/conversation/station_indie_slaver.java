...
public class station_indie_slaver extends script.base_script
{
    ...
    public boolean station_indie_slaver_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean station_indie_slaver_condition_hasWon_assassinations(obj_id player, obj_id npc)
    {
    ...
    public boolean station_indie_slaver_condition_isTooFar(obj_id player, obj_id npc)
    {
        space_combat.playCombatTauntSound(player);
        obj_id containingShip = space_transition.getContainingShip(player);
        return (getDistance(npc, containingShip) > space_transition.STATION_COMM_MAX_DISTANCE);
    }
    public void station_indie_slaver_action_grantduty_recovery(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "recovery_duty", "ep3_indie_slavers_recovery");
    }
    public int station_indie_slaver_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_indie_slaver_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_indie_slaver_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_indie_slaver_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_indie_slaver_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_indie_slaver_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_indie_slaver_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int station_indie_slaver_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
