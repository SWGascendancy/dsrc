...
public class u13_boba_fett extends script.base_script
{
    ...
    public boolean u13_boba_fett_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean u13_boba_fett_condition_sidequest_active(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "u13_vengeance_sidequest");
    }
    public boolean u13_boba_fett_condition_returning_sidequest(obj_id player, obj_id npc)
    {
    ...
    public void u13_boba_fett_action_grant_u13_vengeance_sidequest(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "u13_vengeance_sidequest");
    }
    public void u13_boba_fett_action_signal_u13_vengeance_sidequest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "u13_vengeance_sidequest_02");
    }
    public int u13_boba_fett_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
