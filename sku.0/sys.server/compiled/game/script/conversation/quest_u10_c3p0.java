...
public class quest_u10_c3p0 extends script.base_script
{
    ...
    public boolean quest_u10_c3p0_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean quest_u10_c3p0_condition_quest_u10_01_side_02_active(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "quest_u10_01_side", "quest_u10_01_side_02");
    }
    public boolean quest_u10_c3p0_condition_quest_u10_01_side_complete(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "quest_u10_01_side");
    }
    public boolean quest_u10_c3p0_condition_quest_u10_01_side_active(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "quest_u10_01_side");
    }
    public void quest_u10_c3p0_action_quest_u10_01_side_grant(obj_id player, obj_id npc)
    {
        groundquests.requestGrantQuest(player, "quest_u10_01_side");
    }
    public void quest_u10_c3p0_action_quest_u10_01_side_signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "quest_u10_01_side_02");
    }
    public int quest_u10_c3p0_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
