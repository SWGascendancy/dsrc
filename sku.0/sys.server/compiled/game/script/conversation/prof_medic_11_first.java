...
public class prof_medic_11_first extends script.base_script
{
    ...
    public boolean prof_medic_11_first_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean prof_medic_11_first_condition_playerOnCorrectStep(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isTaskActive(player, "profession_medic_11", "talktofirst");
    }
    public boolean prof_medic_11_first_condition_playercompletedTask(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.hasCompletedTask(player, "profession_medic_11", "talktofirst");
    }
    public void prof_medic_11_first_action_givePassSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "profession_medic_11_first_victim");
    }
    public void prof_medic_11_first_action_healnpc(obj_id player, obj_id npc)
    {
        playClientEffectObj(player, "clienteffect/prof_medic_21_heal2.cef", npc, "");
    }
    public int prof_medic_11_first_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int prof_medic_11_first_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int prof_medic_11_first_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
