...
public class rebel_remembrance_day_rieekan extends script.base_script
{
    ...
    public boolean rebel_remembrance_day_rieekan_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean rebel_remembrance_day_rieekan_condition_isEntertainerOrTrader(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_rieekan_condition_isNotFirstSupplyDropMission(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_rieekan_condition_isEntertainerOrTraderAndNeverMetNotChampion(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_rieekan_condition_hasNotCraftedSupplies(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_rieekan_condition_hasAMisionActive(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        for (int i = 0; i < holiday.ALL_REBEL_QUESTS.length; i++)
        {
    ...
    public boolean rebel_remembrance_day_rieekan_condition_alreadyKnowsRieekan(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_rieekan_condition_isEntertainerAndIsWaitingForSignal(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_rieekan_condition_isChampion(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return hasCompletedCollectionSlot(player, holiday.REMEMBRANCE_DAY_CHAMPION_BADGE);
    }
    public boolean rebel_remembrance_day_rieekan_condition_hasEntertainerMissionWithTask(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_rieekan_condition_hasCompletedEntertainerOneNotTwo(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_rieekan_condition_isImperialPlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (factions.isImperial(player));
    }
    public boolean rebel_remembrance_day_rieekan_condition_isNeutralPlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (!factions.isImperial(player) && !factions.isRebel(player));
    }
    public boolean rebel_remembrance_day_rieekan_condition_hasCompletedEntertainerTwoNotThree(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_rieekan_condition_hasCompletedEntertainerThreeNotFour(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_rieekan_condition_hasCompletedEntertainerFourNotFive(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_rieekan_condition_hasCompeletedEntertainerFiveNotSix(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_rieekan_condition_isLockedOutOfRecoveryEvent(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return false;
    }
    public boolean rebel_remembrance_day_rieekan_condition_hasCompleted1stMissionNot2nd(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_rieekan_condition_hasCompleted2ndMissionNot3rd(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_rieekan_condition_isEnterainerOrTraderAndNeverMetRiekanIsChampion(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_rieekan_condition_isChampionKnowsKaythree(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_rieekan_condition_isImperialOnLeave(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return (factions.isImperial(player) && factions.isOnLeave(player));
    }
    public boolean rebel_remembrance_day_rieekan_condition_hasCompleted3rdMissionNot4th(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_rieekan_condition_hasCompleted4thMissionNot5th(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_rieekan_condition_hasCompleted5thMissionNot6th(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_rieekan_condition_hasCompleted6thMission(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_rieekan_condition_isReadyForFirstSupplyDrop(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_rieekan_condition_isEntertainer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return utils.isProfession(player, utils.ENTERTAINER);
    }
    public boolean rebel_remembrance_day_rieekan_condition_isTrader(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return utils.isProfession(player, utils.TRADER);
    }
    public boolean rebel_remembrance_day_rieekan_condition_isStructuresTrader(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return hasSkill(player, "class_structures_phase1_novice");
    }
    public boolean rebel_remembrance_day_rieekan_condition_isEngineeringTrader(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return hasSkill(player, "class_engineering_phase1_novice");
    }
    public boolean rebel_remembrance_day_rieekan_condition_isMunitionsTrader(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return hasSkill(player, "class_munitions_phase1_novice");
    }
    public boolean rebel_remembrance_day_rieekan_condition_isDomesticsTrader(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return hasSkill(player, "class_domestics_phase1_novice");
    }
    public boolean rebel_remembrance_day_rieekan_condition_hasCompletedFirstMission(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean rebel_remembrance_day_rieekan_condition_hasSupplyDropMissionWithTask(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        for (int i = 0; i < holiday.ALL_REBEL_QUESTS.length; i++)
        {
    ...
    public boolean rebel_remembrance_day_rieekan_condition_isNeutralWorkingForImperial(obj_id player, obj_id npc)
    {
    ...
    public void rebel_remembrance_day_rieekan_action_grantDomesticsMissionOne(obj_id player, obj_id npc)
    {
    ...
    public void rebel_remembrance_day_rieekan_action_grantDomesticsMissionTwo(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, holiday.EMPIREDAYQUEST_REB_CRASHSITE_02_DOMESTICS);
    }
    public void rebel_remembrance_day_rieekan_action_grantDomesticsMissionThree(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, holiday.EMPIREDAYQUEST_REB_CRASHSITE_03_DOMESTICS);
    }
    public void rebel_remembrance_day_rieekan_action_grantDomesticsMissionFour(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, holiday.EMPIREDAYQUEST_REB_CRASHSITE_04_DOMESTICS);
    }
    public void rebel_remembrance_day_rieekan_action_grantDomesticsMissionFive(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, holiday.EMPIREDAYQUEST_REB_CRASHSITE_05_DOMESTICS);
    }
    public void rebel_remembrance_day_rieekan_action_grantDomesticsMissionSix(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, holiday.EMPIREDAYQUEST_REB_CRASHSITE_06_DOMESTICS);
    }
    public void rebel_remembrance_day_rieekan_action_grantEntertainerMissionOne(obj_id player, obj_id npc)
    {
    ...
    public void rebel_remembrance_day_rieekan_action_grantEntertainerMissionTwo(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, holiday.EMPIREDAYQUEST_REB_ENTERTAINER_02);
    }
    public void rebel_remembrance_day_rieekan_action_checkHolidayTimeStampOnPlayer(obj_id player, obj_id npc)
    {
    }
    public void rebel_remembrance_day_rieekan_action_grantEngineeringCollectionStart(obj_id player, obj_id npc)
    {
        if (getCollectionSlotValue(player, holiday.REBEL_ENGINEERING_START_SLOT) <= 0)
        {
    ...
    public void rebel_remembrance_day_rieekan_action_grantEngineeringMissionOne(obj_id player, obj_id npc)
    {
    ...
    public void rebel_remembrance_day_rieekan_action_grantEngineeringMissionTwo(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, holiday.EMPIREDAYQUEST_REB_CRASHSITE_02_ENG);
    }
    public void rebel_remembrance_day_rieekan_action_grantEngineeringMissionThree(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, holiday.EMPIREDAYQUEST_REB_CRASHSITE_03_ENG);
    }
    public void rebel_remembrance_day_rieekan_action_grantEngineeringMissionFour(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, holiday.EMPIREDAYQUEST_REB_CRASHSITE_04_ENG);
    }
    public void rebel_remembrance_day_rieekan_action_grantEngineeringMissionFive(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, holiday.EMPIREDAYQUEST_REB_CRASHSITE_05_ENG);
    }
    public void rebel_remembrance_day_rieekan_action_grantEnigineeringMissionSix(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, holiday.EMPIREDAYQUEST_REB_CRASHSITE_06_ENG);
    }
    public void rebel_remembrance_day_rieekan_action_grantMunitionsMissionOne(obj_id player, obj_id npc)
    {
    ...
    public void rebel_remembrance_day_rieekan_action_grantMunitionsMissionTwo(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, holiday.EMPIREDAYQUEST_REB_CRASHSITE_02_MUNITIONS);
    }
    public void rebel_remembrance_day_rieekan_action_grantMunitionsMissionThree(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, holiday.EMPIREDAYQUEST_REB_CRASHSITE_03_MUNITIONS);
    }
    public void rebel_remembrance_day_rieekan_action_grantMunitionsMissionFour(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, holiday.EMPIREDAYQUEST_REB_CRASHSITE_04_MUNITIONS);
    }
    public void rebel_remembrance_day_rieekan_action_grantMunitionsMissionFive(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, holiday.EMPIREDAYQUEST_REB_CRASHSITE_05_MUNITIONS);
    }
    public void rebel_remembrance_day_rieekan_action_grantMunitionsMissionSix(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, holiday.EMPIREDAYQUEST_REB_CRASHSITE_06_MUNITIONS);
    }
    public void rebel_remembrance_day_rieekan_action_grantStructuresMissionOne(obj_id player, obj_id npc)
    {
    ...
    public void rebel_remembrance_day_rieekan_action_grantStructuresMissionTwo(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, holiday.EMPIREDAYQUEST_REB_CRASHSITE_02_STRUC);
    }
    public void rebel_remembrance_day_rieekan_action_grantStructuresMissionThree(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, holiday.EMPIREDAYQUEST_REB_CRASHSITE_03_STRUC);
    }
    public void rebel_remembrance_day_rieekan_action_grantStructuresMissionFour(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, holiday.EMPIREDAYQUEST_REB_CRASHSITE_04_STRUC);
    }
    public void rebel_remembrance_day_rieekan_action_grantStructuresMissionFive(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, holiday.EMPIREDAYQUEST_REB_CRASHSITE_05_STRUC);
    }
    public void rebel_remembrance_day_rieekan_action_grantStructuresMissionSix(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, holiday.EMPIREDAYQUEST_REB_CRASHSITE_06_STRUC);
    }
    public void rebel_remembrance_day_rieekan_action_activateDeliverySignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "spokeToSupplyOfficer");
    }
    public void rebel_remembrance_day_rieekan_action_grantEntertainerMissionThree(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, holiday.EMPIREDAYQUEST_REB_ENTERTAINER_03);
    }
    public void rebel_remembrance_day_rieekan_action_grantEntertainerMissionFour(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, holiday.EMPIREDAYQUEST_REB_ENTERTAINER_04);
    }
    public void rebel_remembrance_day_rieekan_action_grantEntertainerMissionFive(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, holiday.EMPIREDAYQUEST_REB_ENTERTAINER_05);
    }
    public void rebel_remembrance_day_rieekan_action_grantEntertainerMissionSix(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, holiday.EMPIREDAYQUEST_REB_ENTERTAINER_06);
    }
    public void rebel_remembrance_day_rieekan_action_entertainerSignalIncrementCollection(obj_id player, obj_id npc)
    {
    ...
    public String rebel_remembrance_day_rieekan_tokenTO_timeLeftRecruitment(obj_id player, obj_id npc)
    {
    ...
    public String rebel_remembrance_day_rieekan_tokenTO_timeLeftPropaganda(obj_id player, obj_id npc)
    {
    ...
    public int rebel_remembrance_day_rieekan_tokenDI_notUsed(obj_id player, obj_id npc)
    {
        return 0;
    }
    public int rebel_remembrance_day_rieekan_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_rieekan_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_rieekan_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_rieekan_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_91"))
        {
            if (rebel_remembrance_day_rieekan_condition_hasCompletedEntertainerOneNotTwo(player, npc))
    ...
    public int rebel_remembrance_day_rieekan_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_rieekan_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_rieekan_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_rieekan_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_rieekan_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_rieekan_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_rieekan_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_rieekan_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_rieekan_handleBranch30(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_rieekan_handleBranch35(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_rieekan_handleBranch36(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_rieekan_handleBranch37(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_rieekan_handleBranch42(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_rieekan_handleBranch47(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_rieekan_handleBranch48(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_rieekan_handleBranch54(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_rieekan_handleBranch55(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_rieekan_handleBranch56(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_149"))
        {
            if (rebel_remembrance_day_rieekan_condition_isEntertainer(player, npc))
    ...
    public int rebel_remembrance_day_rieekan_handleBranch57(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_rieekan_handleBranch58(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_149"))
        {
            if (rebel_remembrance_day_rieekan_condition_isEntertainer(player, npc))
    ...
    public int rebel_remembrance_day_rieekan_handleBranch59(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_149"))
        {
            if (rebel_remembrance_day_rieekan_condition_isEntertainer(player, npc))
    ...
    public int rebel_remembrance_day_rieekan_handleBranch60(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_rieekan_handleBranch62(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_rieekan_handleBranch64(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int rebel_remembrance_day_rieekan_handleBranch65(obj_id player, obj_id npc, string_id response)
    {
