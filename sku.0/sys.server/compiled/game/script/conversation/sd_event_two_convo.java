...
public class sd_event_two_convo extends script.base_script
{
    ...
    public boolean sd_event_two_convo_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean sd_event_two_convo_condition_hasTalked(obj_id player, obj_id npc)
    {
        return hasObjVar(npc, "talked");
    }
    public void sd_event_two_convo_action_sendOpeningSpam(obj_id player, obj_id npc)
    {
    ...
    public void sd_event_two_convo_action_kickoffSdEvent(obj_id player, obj_id npc)
    {
    ...
    public void sd_event_two_convo_action_playerProjector(obj_id player, obj_id npc)
    {
        obj_id[] players = trial.getPlayersInDungeon(trial.getTop(npc));
        prose_package pp = new prose_package();
        pp.target.set(player);
    ...
    public void sd_event_two_convo_action_kkdestination(obj_id player, obj_id npc)
    {
        obj_id[] players = trial.getPlayersInDungeon(trial.getTop(npc));
        prose_package pp = new prose_package();
        pp.target.set(player);
    ...
    public void sd_event_two_convo_action_playerFodder(obj_id player, obj_id npc)
    {
        obj_id[] players = trial.getPlayersInDungeon(trial.getTop(npc));
        prose_package pp = new prose_package();
        pp.target.set(player);
    ...
    public int sd_event_two_convo_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int sd_event_two_convo_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
