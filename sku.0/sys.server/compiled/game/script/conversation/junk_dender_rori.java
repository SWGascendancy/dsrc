...
public class junk_dender_rori extends script.base_script
{
    ...
    public boolean junk_dender_rori_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean junk_dender_rori_condition_check_inv(obj_id player, obj_id npc)
    {
        return smuggler.checkInventory(player, npc);
    }
    public void junk_dender_rori_action_start_dealing(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        messageTo(npc, "startDealing", params, 1.0f, false);
    }
    public void junk_dender_rori_action_face_to(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int junk_dender_rori_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int junk_dender_rori_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int junk_dender_rori_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int junk_dender_rori_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
