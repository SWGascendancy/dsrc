...
public class ep3_carl_mosik extends script.base_script
{
    ...
    public boolean ep3_carl_mosik_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_carl_mosik_condition_hasNotDoneSurrogateHunter(obj_id player, obj_id npc)
    {
        return !groundquests.isQuestActiveOrComplete(player, "ep3_carl_surrogate_hunter_v2");
    }
    public boolean ep3_carl_mosik_condition_ready4SurrogateReward(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_carl_mosik_condition_hasCompletedSurrogate(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_carl_surrogate_hunter_v2");
    }
    public boolean ep3_carl_mosik_condition_hasNotKilledMinstyngarYet(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "ep3_carl_surrogate_hunter_v2");
    }
    public void ep3_carl_mosik_action_grantCarlHuntingQuest(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "ep3_carl_surrogate_hunter_v2");
    }
    public void ep3_carl_mosik_action_giveRifleReward(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "signalCarlRewardRifle");
    }
    public int ep3_carl_mosik_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_carl_mosik_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_carl_mosik_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_carl_mosik_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_carl_mosik_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_carl_mosik_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_carl_mosik_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_carl_mosik_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
