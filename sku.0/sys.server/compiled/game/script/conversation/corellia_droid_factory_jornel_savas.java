...
public class corellia_droid_factory_jornel_savas extends script.base_script
{
    ...
    public boolean corellia_droid_factory_jornel_savas_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_droid_factory_jornel_savas_condition_gotoFromLegacyActive(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "corellia_droid_bunker_legacy_goto");
    }
    public boolean corellia_droid_factory_jornel_savas_condition_levelCheck(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_droid_factory_jornel_savas_condition_gotOrCompletedGotoVarias(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActiveOrComplete(player, "corellia_droid_bunker_cornel_goto");
    }
    public void corellia_droid_factory_jornel_savas_action_grantGotoVarias(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "corellia_droid_bunker_cornel_goto");
    }
    public void corellia_droid_factory_jornel_savas_action_completeLegacyGoto(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "contactCornel");
    }
    public int corellia_droid_factory_jornel_savas_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_droid_factory_jornel_savas_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_droid_factory_jornel_savas_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_droid_factory_jornel_savas_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
