...
public class greeter_coronet_merchant extends script.base_script
{
    ...
    public boolean greeter_coronet_merchant_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean greeter_coronet_merchant_condition_getInvoiceAndSchedule(obj_id player, obj_id npc)
    {
    ...
    public boolean greeter_coronet_merchant_condition_getSchedule(obj_id player, obj_id npc)
    {
    ...
    public boolean greeter_coronet_merchant_condition_getInvoice(obj_id player, obj_id npc)
    {
    ...
    public boolean greeter_coronet_merchant_condition_faliedSpaceQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean greeter_coronet_merchant_condition_playerHasShip(obj_id player, obj_id npc)
    {
        return space_utils.hasShip(player);
    }
    public boolean greeter_coronet_merchant_condition_gotBothInvoiceAndSchedule(obj_id player, obj_id npc)
    {
    ...
    public boolean greeter_coronet_merchant_condition_sawRagtagFighters(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_coronet_capitol_problems_missing_shipment", "ralMundi_traceTransportRoute");
    }
    public boolean greeter_coronet_merchant_condition_failedSpacePatrol(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_coronet_capitol_problems_missing_shipment", "ralMundi_failed_patrol");
    }
    public boolean greeter_coronet_merchant_condition_foundTomiBunker(obj_id player, obj_id npc)
    {
    ...
    public boolean greeter_coronet_merchant_condition_intimidateRagtags(obj_id player, obj_id npc)
    {
    ...
    public boolean greeter_coronet_merchant_condition_goGetShipment(obj_id player, obj_id npc)
    {
    ...
    public boolean greeter_coronet_merchant_condition_foundShipment(obj_id player, obj_id npc)
    {
    ...
    public boolean greeter_coronet_merchant_condition_questComplete(obj_id player, obj_id npc)
    {
    ...
    public boolean greeter_coronet_merchant_condition_hasSpacePatrol(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_coronet_capitol_problems_missing_shipment", "givespacequest");
    }
    public boolean greeter_coronet_merchant_condition_hasOtherSpaceMission(obj_id player, obj_id npc)
    {
        return space_quest.hasQuest(player);
    }
    public boolean greeter_coronet_merchant_condition_notOnMissingShipment(obj_id player, obj_id npc)
    {
    ...
    public void greeter_coronet_merchant_action_beginMissingShipment(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "ralMundi_begin");
    }
    public void greeter_coronet_merchant_action_givePatrolMission(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "corellia_coronet_capitol_problems_missing_shipment");
    }
    public void greeter_coronet_merchant_action_goAfterRagtags(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "ralMundi_traceTransportRoute");
    }
    public void greeter_coronet_merchant_action_endQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "ralMundi_shipmentFound");
    }
    public void greeter_coronet_merchant_action_signalPatrolMission(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "ralMundi_gotScheduleAndInvoice");
    }
    public void greeter_coronet_merchant_action_giveShip(obj_id player, obj_id npc)
    {
        space_quest.grantNewbieShip(player, "neutral");
    }
    public void greeter_coronet_merchant_action_clearFailedPatrol(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "failed_ral");
    }
    public int greeter_coronet_merchant_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int greeter_coronet_merchant_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int greeter_coronet_merchant_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int greeter_coronet_merchant_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int greeter_coronet_merchant_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int greeter_coronet_merchant_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int greeter_coronet_merchant_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int greeter_coronet_merchant_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int greeter_coronet_merchant_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int greeter_coronet_merchant_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int greeter_coronet_merchant_handleBranch30(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int greeter_coronet_merchant_handleBranch31(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int greeter_coronet_merchant_handleBranch32(obj_id player, obj_id npc, string_id response)
    {
