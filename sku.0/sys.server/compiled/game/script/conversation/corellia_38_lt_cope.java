...
public class corellia_38_lt_cope extends script.base_script
{
    ...
    public boolean corellia_38_lt_cope_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_38_lt_cope_condition_luckyMayorActive(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_38_corsec_files_03", "corsec_files_03_01");
    }
    public boolean corellia_38_lt_cope_condition_luckyMayorComplete(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_38_lt_cope_condition_luckyMayorInProgress(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_38_lt_cope_condition_ryllInProgress(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_38_lt_cope_condition_ryllComplete(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_38_lt_cope_condition_unluckyMayorInProgress(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_38_lt_cope_condition_redCircleBasePrompt(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_38_corsec_files_05", "corsec_files_05_03");
    }
    public boolean corellia_38_lt_cope_condition_redCircleInProgress(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_38_lt_cope_condition_redCircleComplete(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_38_lt_cope_condition_AllCompleted(obj_id player, obj_id npc)
    {
    ...
    public void corellia_38_lt_cope_action_ryllGranted(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "corellia_38_corsec_files_04");
    }
    public void corellia_38_lt_cope_action_luckyMayorContinueSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "corsec_files_03_01");
    }
    public void corellia_38_lt_cope_action_ryllCompletedSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "corsec_files_04_08");
    }
    public void corellia_38_lt_cope_action_luckyMayorCompletedSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "corsec_files_03_08");
    }
    public void corellia_38_lt_cope_action_unluckyMayorGranted(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "corellia_38_corsec_files_05");
    }
    public void corellia_38_lt_cope_action_redCircleContinueSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "corsec_files_05_03");
    }
    public void corellia_38_lt_cope_action_redCircleCompleteSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "corsec_files_05_08");
    }
    public void corellia_38_lt_cope_action_grant39Pointer(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "corellia_39_pointer");
    }
    public int corellia_38_lt_cope_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_38_lt_cope_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_38_lt_cope_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_38_lt_cope_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_38_lt_cope_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_38_lt_cope_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_38_lt_cope_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_38_lt_cope_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_38_lt_cope_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
