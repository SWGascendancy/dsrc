...
public class loveday_disillusion_love_note extends script.base_script
{
    ...
    public boolean loveday_disillusion_love_note_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean loveday_disillusion_love_note_condition_speakWithHim(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "loveday_disillusion_love_note_v2", "loveday_disillusion_love_note_02");
    }
    public boolean loveday_disillusion_love_note_condition_loveNoteUnderway(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "loveday_disillusion_love_note_v2", "loveday_disillusion_love_note_03");
    }
    public boolean loveday_disillusion_love_note_condition_loveNoteComplete(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "loveday_disillusion_love_note_v2", "loveday_disillusion_love_note_03");
    }
    public void loveday_disillusion_love_note_action_spokeWithHimSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "loveday_disillusion_love_note_02");
    }
    public void loveday_disillusion_love_note_action_startLoveNote(obj_id player, obj_id npc)
    {
        dictionary webster = new dictionary();
        webster.put("player", player);
        messageTo(npc, "msgLoveNoteSuggestionStart", webster, 0.25f, false);
    }
    public int loveday_disillusion_love_note_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int loveday_disillusion_love_note_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int loveday_disillusion_love_note_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
