...
public class tatooine_knives_parry_kcur extends script.base_script
{
    ...
    public boolean tatooine_knives_parry_kcur_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tatooine_knives_parry_kcur_condition_onQuest(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_knives_parry");
        boolean OnTask = (questIsQuestActive(questId1, player));
        return OnTask;
    }
    public boolean tatooine_knives_parry_kcur_condition_onDewTask(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_knives_parry");
    ...
    public boolean tatooine_knives_parry_kcur_condition_questComplete(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_knives_parry_pt2");
        boolean OnTask = (questIsQuestComplete(questId1, player));
        return OnTask;
    }
    public boolean tatooine_knives_parry_kcur_condition_firstContact(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_knives_parry");
    ...
    public boolean tatooine_knives_parry_kcur_condition_onDewComplete(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_knives_parry");
    ...
    public boolean tatooine_knives_parry_kcur_condition_onSmugglerTask(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/tatooine_knives_parry_pt2");
    ...
    public void tatooine_knives_parry_kcur_action_signalDew(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tatooine_knives_parry_launch_e10");
    }
    public void tatooine_knives_parry_kcur_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void tatooine_knives_parry_kcur_action_signalsmuggler(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tatooine_knives_parry_launch_e12");
    }
    public int tatooine_knives_parry_kcur_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_knives_parry_kcur_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_knives_parry_kcur_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_knives_parry_kcur_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_knives_parry_kcur_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
