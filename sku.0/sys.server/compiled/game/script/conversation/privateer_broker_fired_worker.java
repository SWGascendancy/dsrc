...
public class privateer_broker_fired_worker extends script.base_script
{
    ...
    public boolean privateer_broker_fired_worker_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public int privateer_broker_fired_worker_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
