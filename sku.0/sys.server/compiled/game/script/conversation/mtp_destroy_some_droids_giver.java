...
public class mtp_destroy_some_droids_giver extends script.base_script
{
    ...
    public boolean mtp_destroy_some_droids_giver_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean mtp_destroy_some_droids_giver_condition_alreadyHasQuest(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "mtp_hideout_instance_kill_specific_droids");
    }
    public boolean mtp_destroy_some_droids_giver_condition_returningQuestSuccess(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "mtp_hideout_instance_kill_specific_droids_success");
    }
    public boolean mtp_destroy_some_droids_giver_condition_notYetReadyForAnother(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_destroy_some_droids_giver_condition_returningQuestFailure(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "mtp_hideout_instance_kill_specific_droids_fail");
    }
    public void mtp_destroy_some_droids_giver_action_grantDroidQuest(obj_id player, obj_id npc)
    {
    ...
    public void mtp_destroy_some_droids_giver_action_sendDroidSuccessSignal(obj_id player, obj_id npc)
    {
    ...
    public void mtp_destroy_some_droids_giver_action_sendDroidFailureSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "mtp_kill_specific_droids_failed");
    }
    public int mtp_destroy_some_droids_giver_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
