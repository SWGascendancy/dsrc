...
public class c_talus_grave_robbers_omkoo extends script.base_script
{
    ...
    public boolean c_talus_grave_robbers_omkoo_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_talus_grave_robbers_omkoo_condition_needTalkWire1(obj_id player, obj_id npc)
    {
    ...
    public boolean c_talus_grave_robbers_omkoo_condition_onQuest(obj_id player, obj_id npc)
    {
        return (groundquests.isQuestActive(player, "c_talus_grave_robbers_1"));
    }
    public boolean c_talus_grave_robbers_omkoo_condition_wonQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean c_talus_grave_robbers_omkoo_condition_finished(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedQuest(player, "c_talus_grave_robbers_1"));
    }
    public boolean c_talus_grave_robbers_omkoo_condition_gotKey(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedTask(player, "c_talus_grave_robbers_1", "retrieve1"));
    }
    public boolean c_talus_grave_robbers_omkoo_condition_gotDocument(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedTask(player, "c_talus_grave_robbers_1", "retrieve2"));
    }
    public void c_talus_grave_robbers_omkoo_action_grantReward(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "giveRewardGraveRobbers");
    }
    public void c_talus_grave_robbers_omkoo_action_quitQuest(obj_id player, obj_id npc)
    {
        groundquests.clearQuest(player, "c_talus_grave_robbers_1");
    }
    public void c_talus_grave_robbers_omkoo_action_giveQuest1(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "c_talus_grave_robbers_1");
    }
    public int c_talus_grave_robbers_omkoo_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_talus_grave_robbers_omkoo_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_talus_grave_robbers_omkoo_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_talus_grave_robbers_omkoo_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_talus_grave_robbers_omkoo_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_talus_grave_robbers_omkoo_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_talus_grave_robbers_omkoo_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_talus_grave_robbers_omkoo_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_talus_grave_robbers_omkoo_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_talus_grave_robbers_omkoo_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_talus_grave_robbers_omkoo_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
