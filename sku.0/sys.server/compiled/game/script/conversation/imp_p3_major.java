...
public class imp_p3_major extends script.base_script
{
    ...
    public boolean imp_p3_major_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public void imp_p3_major_action_start_p3(obj_id player, obj_id npc)
    {
        trial.sendSequenceTrigger("trigger_p3_march");
    }
    public int imp_p3_major_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int start_p3(obj_id self, dictionary params)
    {
