...
public class c_rebdefector_def extends script.base_script
{
    ...
    public boolean c_rebdefector_def_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_rebdefector_def_condition_isOnQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean c_rebdefector_def_condition_isonStepofQuest(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/c_rebdefector");
        int takephrase = groundquests.getTaskId(questId1, "takephrase");
    ...
    public void c_rebdefector_def_action_forwardQuest(obj_id player, obj_id npc)
    {
    ...
    public void c_rebdefector_def_action_faceplayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int c_rebdefector_def_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_rebdefector_def_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
