...
public class c_tutorial_rm1 extends script.base_script
{
    ...
    public boolean c_tutorial_rm1_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_tutorial_rm1_condition_playerOnQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean c_tutorial_rm1_condition_taskComplete(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "quest/c_newbie_hall_01", "explainRibbon");
    }
    public void c_tutorial_rm1_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public void c_tutorial_rm1_action_actionSendSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "explainRibbon");
    }
    public int c_tutorial_rm1_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_tutorial_rm1_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_tutorial_rm1_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_tutorial_rm1_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_tutorial_rm1_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_tutorial_rm1_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_tutorial_rm1_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_tutorial_rm1_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_tutorial_rm1_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_tutorial_rm1_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
