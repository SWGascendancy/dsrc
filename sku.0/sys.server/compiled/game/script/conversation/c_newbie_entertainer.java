...
public class c_newbie_entertainer extends script.base_script
{
    ...
    public boolean c_newbie_entertainer_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_newbie_entertainer_condition_onCantinaStep(obj_id player, obj_id npc)
    {
    ...
    public boolean c_newbie_entertainer_condition_afterPerform(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/c_newbie_quest3");
        int cantinareturn = groundquests.getTaskId(questId1, "cantinareturn");
        return questIsTaskActive(questId1, cantinareturn, player);
    }
    public void c_newbie_entertainer_action_forwardQuest(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "c_newbie_cantinastep");
    }
    public void c_newbie_entertainer_action_dance(obj_id player, obj_id npc)
    {
    ...
    public void c_newbie_entertainer_action_faceplayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int c_newbie_entertainer_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_newbie_entertainer_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_newbie_entertainer_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_newbie_entertainer_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_newbie_entertainer_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_newbie_entertainer_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_newbie_entertainer_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_newbie_entertainer_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_500"))
        {
            if (c_newbie_entertainer_condition__defaultCondition(player, npc))
    ...
    public int c_newbie_entertainer_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
