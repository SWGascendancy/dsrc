...
public class ep3_clone_relics_clone_trooper_jawl extends script.base_script
{
    ...
    public boolean ep3_clone_relics_clone_trooper_jawl_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_clone_relics_clone_trooper_jawl_condition_courierChat(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "ep3_clone_relics_clone_trooper_mort_neutral", "talkJawl1"));
    }
    public boolean ep3_clone_relics_clone_trooper_jawl_condition_onQuestNeutral(obj_id player, obj_id npc)
    {
        return (groundquests.isQuestActive(player, "ep3_clone_relics_clone_trooper_neutral"));
    }
    public boolean ep3_clone_relics_clone_trooper_jawl_condition_talkJawlAgain(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "ep3_clone_relics_clone_trooper_mort_neutral", "talkJawl2"));
    }
    public boolean ep3_clone_relics_clone_trooper_jawl_condition_completedJawlAgain(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedTask(player, "ep3_clone_relics_clone_trooper_mort_neutral", "talkJawl2"));
    }
    public void ep3_clone_relics_clone_trooper_jawl_action_talkedOnceJawl(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedJawl1");
    }
    public void ep3_clone_relics_clone_trooper_jawl_action_talkedTwiceJawl(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedJawl2");
        setObjVar(player, "space_access_jabba", 30);
    }
    public int ep3_clone_relics_clone_trooper_jawl_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_jawl_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_jawl_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_jawl_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_jawl_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_jawl_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_jawl_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_jawl_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_jawl_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_jawl_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_jawl_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_jawl_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_clone_relics_clone_trooper_jawl_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_1246"))
        {
            doAnimationAction(player, "shrug_shoulders");
