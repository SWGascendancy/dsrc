...
public class mtp_meatlump_wine extends script.base_script
{
    ...
    public boolean mtp_meatlump_wine_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean mtp_meatlump_wine_condition_hasLockoutBuff(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_meatlump_wine_condition_readyForTurnIn(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_meatlump_wine_condition_wineCollectionComplete_01(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_meatlump_wine_condition_wineCollectionComplete_02(obj_id player, obj_id npc)
    {
        if (hasCompletedCollection(player, "col_meatlump_wine_01"))
        {
            return true;
    ...
    public void mtp_meatlump_wine_action_grantWineCollection(obj_id player, obj_id npc)
    {
    ...
    public void mtp_meatlump_wine_action_resetWineCollection(obj_id player, obj_id npc)
    {
        if (hasCompletedCollection(player, "col_meatlump_wine_01"))
        {
    ...
    public void mtp_meatlump_wine_action_finishWineCollection(obj_id player, obj_id npc)
    {
    ...
    public int mtp_meatlump_wine_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_meatlump_wine_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_meatlump_wine_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_meatlump_wine_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_meatlump_wine_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_meatlump_wine_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_meatlump_wine_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_meatlump_wine_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_meatlump_wine_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_meatlump_wine_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
