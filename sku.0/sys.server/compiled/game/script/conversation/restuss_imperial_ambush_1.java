...
public class restuss_imperial_ambush_1 extends script.base_script
{
    ...
    public boolean restuss_imperial_ambush_1_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean restuss_imperial_ambush_1_condition_stage3ready(obj_id player, obj_id npc)
    {
    ...
    public boolean restuss_imperial_ambush_1_condition_mission1Active(obj_id player, obj_id npc)
    {
    ...
    public boolean restuss_imperial_ambush_1_condition_mission1Success(obj_id player, obj_id npc)
    {
    ...
    public boolean restuss_imperial_ambush_1_condition_completedMission1(obj_id player, obj_id npc)
    {
    ...
    public boolean restuss_imperial_ambush_1_condition_mission2Active(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "restuss_imperial_st3_ambush_1");
    }
    public boolean restuss_imperial_ambush_1_condition_mission2Success(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "restuss_imperial_st3_ambush_1", "returnExov2");
    }
    public boolean restuss_imperial_ambush_1_condition_notSpy(obj_id player, obj_id npc)
    {
    ...
    public boolean restuss_imperial_ambush_1_condition_spy(obj_id player, obj_id npc)
    {
        if (utils.isProfession(player, utils.SPY) || utils.isProfession(player, utils.SMUGGLER))
        {
            return true;
    ...
    public boolean restuss_imperial_ambush_1_condition_completedMission2(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "restuss_imperial_st3_ambush_1");
    }
    public boolean restuss_imperial_ambush_1_condition_playerImperial(obj_id player, obj_id npc)
    {
    ...
    public boolean restuss_imperial_ambush_1_condition_isRebelPlayer(obj_id player, obj_id npc)
    {
        return factions.isRebel(player);
    }
    public void restuss_imperial_ambush_1_action_giveCapture(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "restuss_imperial_st3_comm_array");
    }
    public void restuss_imperial_ambush_1_action_reward1(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "returnedExov1");
    }
    public void restuss_imperial_ambush_1_action_giveAmbush(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "restuss_imperial_st3_ambush_1");
    }
    public void restuss_imperial_ambush_1_action_reward2(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "returnedExov2");
    }
    public void restuss_imperial_ambush_1_action_giveCaptureSpy(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "restuss_imperial_st3_comm_array_spy");
    }
    public void restuss_imperial_ambush_1_action_eject(obj_id player, obj_id npc)
    {
        expelFromBuilding(player);
    }
    public int restuss_imperial_ambush_1_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int restuss_imperial_ambush_1_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int restuss_imperial_ambush_1_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int restuss_imperial_ambush_1_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
