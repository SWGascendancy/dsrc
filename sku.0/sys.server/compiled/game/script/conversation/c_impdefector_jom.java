...
public class c_impdefector_jom extends script.base_script
{
    ...
    public boolean c_impdefector_jom_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_impdefector_jom_condition_isEnemyFaction(obj_id player, obj_id npc)
    {
    ...
    public boolean c_impdefector_jom_condition_isFriendlyFaction(obj_id player, obj_id npc)
    {
    ...
    public boolean c_impdefector_jom_condition_isNeutralFaction(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/c_impdefector");
        boolean onQuest = questIsQuestActive(questId1, player) || questIsQuestComplete(questId1, player);
    ...
    public boolean c_impdefector_jom_condition_questIsComplete(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/c_impdefector");
        boolean doneQuest = questIsQuestComplete(questId1, player);
        return doneQuest;
    }
    public boolean c_impdefector_jom_condition_questIsActive(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/c_impdefector");
        boolean onQuest = questIsQuestActive(questId1, player);
        return onQuest;
    }
    public void c_impdefector_jom_action_givequest(obj_id player, obj_id npc)
    {
    ...
    public void c_impdefector_jom_action_faceplayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int c_impdefector_jom_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_impdefector_jom_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_impdefector_jom_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_impdefector_jom_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_impdefector_jom_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
