...
public class lifeday04b extends script.base_script
{
    ...
    public boolean lifeday04b_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean lifeday04b_condition_hasNotStarted(obj_id player, obj_id npc)
    {
    ...
    public boolean lifeday04b_condition_hasBeenRewarded(obj_id player, obj_id npc)
    {
    ...
    public boolean lifeday04b_condition_hasTalkedToCityGuy(obj_id player, obj_id npc)
    {
    ...
    public boolean lifeday04b_condition_spokeWithEveryone(obj_id player, obj_id npc)
    {
        int convTracker = getIntObjVar(player, "lifeday04.convTracker");
        if (convTracker == 15)
        {
    ...
    public boolean lifeday04b_condition_isOldEnoughNotaWookiee(obj_id player, obj_id npc)
    {
    ...
    public boolean lifeday04b_condition_isOldEnoughIsaWookiee(obj_id player, obj_id npc)
    {
        int timeData = getPlayerBirthDate(player);
        int rightNow = getCurrentBirthDate();
        int delta = rightNow - timeData;
    ...
    public void lifeday04b_action_giveRandomGift(obj_id player, obj_id npc)
    {
    ...
    public void lifeday04b_action_giveLifeDayRobe(obj_id player, obj_id npc)
    {
        obj_id playerInventory = utils.getInventoryContainer(player);
    ...
    public void lifeday04b_action_setSpokeWithElder(obj_id player, obj_id npc)
    {
        int convTracker = getIntObjVar(player, "lifeday04.convTracker");
        if (convTracker == 0)
        {
    ...
    public void lifeday04b_action_notOldEnoughBoned(obj_id player, obj_id npc)
    {
        setObjVar(player, "lifeday04.rewarded", 1);
        removeObjVar(player, "lifeday04.convTracker");
    }
    public int lifeday04b_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int lifeday04b_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int lifeday04b_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int lifeday04b_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
