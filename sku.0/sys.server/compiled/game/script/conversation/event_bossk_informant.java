...
public class event_bossk_informant extends script.base_script
{
    ...
    public boolean event_bossk_informant_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean event_bossk_informant_condition_readyQ4(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "quest/event_cantina_bossk_4", "talkToInformant"));
    }
    public boolean event_bossk_informant_condition_readyQ3P1(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "quest/event_cantina_bossk_3", "talkToCourier"));
    }
    public boolean event_bossk_informant_condition_readyQ3P2(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "quest/event_cantina_bossk_3", "talkToCourierAgain"));
    }
    public boolean event_bossk_informant_condition_completedAll(obj_id player, obj_id npc)
    {
    ...
    public boolean event_bossk_informant_condition_neverGotCarbine(obj_id player, obj_id npc)
    {
    ...
    public boolean event_bossk_informant_condition_hasBrokenGloves(obj_id player, obj_id npc)
    {
    ...
    public void event_bossk_informant_action_signalQ3P2(obj_id player, obj_id npc)
    {
    ...
    public void event_bossk_informant_action_signalQ3P1(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkToCourier");
    }
    public void event_bossk_informant_action_signalQ4(obj_id player, obj_id npc)
    {
    ...
    public void event_bossk_informant_action_giveNewCarbine(obj_id player, obj_id npc)
    {
        obj_id playerInv = utils.getInventoryContainer(player);
        obj_id reward = static_item.createNewItemFunction("weapon_event_hairtrigger_carbine_03_01", playerInv);
        setObjVar(player, "event.bossk.gotCarbine", 1);
    }
    public void event_bossk_informant_action_fixGloves(obj_id player, obj_id npc)
    {
        obj_id inv[] = utils.getAllItemsInBankAndInventory(player);
        for (int i = 0; i < inv.length; i++)
        {
    ...
    public int event_bossk_informant_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_bossk_informant_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_bossk_informant_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_bossk_informant_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_bossk_informant_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_bossk_informant_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_bossk_informant_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_bossk_informant_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_bossk_informant_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
