...
public class fence extends script.base_script
{
    ...
    public boolean fence_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean fence_condition_hasContrabandToGive(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean fence_condition_inCombat(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        if (ai_lib.isInCombat(player))
        {
    ...
    public boolean fence_condition_pvpTimer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        String questName = getStringObjVar(npc, "quest_name");
        String taskName = getStringObjVar(npc, "task_name");
    ...
    public boolean fence_condition_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return true;
    }
