...
public class c_tutorial_rm5 extends script.base_script
{
    ...
    public boolean c_tutorial_rm5_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_tutorial_rm5_condition_playerOnQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean c_tutorial_rm5_condition_TaskComplete(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/c_newbie_hall_02");
        int explainWaypoint = groundquests.getTaskId(questId, "explainWaypoint");
    ...
    public boolean c_tutorial_rm5_condition_playerOnQuestStep04(obj_id player, obj_id npc)
    {
    ...
    public void c_tutorial_rm5_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void c_tutorial_rm5_action_actionSendSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "explainWaypoint");
    }
    public int c_tutorial_rm5_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_tutorial_rm5_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_tutorial_rm5_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_tutorial_rm5_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_tutorial_rm5_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
