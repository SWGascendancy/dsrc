...
public class corvette_imperial_pilot extends script.base_script
{
    ...
    public boolean corvette_imperial_pilot_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corvette_imperial_pilot_condition_hasImperialTicket(obj_id player, obj_id npc)
    {
    ...
    public boolean corvette_imperial_pilot_condition_tooManyInGroup(obj_id player, obj_id npc)
    {
    ...
    public boolean corvette_imperial_pilot_condition_tooManyAndNotAllImperial(obj_id player, obj_id npc)
    {
    ...
    public boolean corvette_imperial_pilot_condition_notAllImperial(obj_id player, obj_id npc)
    {
        if (group.isGrouped(player))
        {
            obj_id groupObj = getGroupObject(player);
    ...
    public boolean corvette_imperial_pilot_condition_itp_kaja_01_active(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "itp_kaja_01", "itp_kaja_01_01a");
    }
    public void corvette_imperial_pilot_action_sendToDungeon(obj_id player, obj_id npc)
    {
        space_dungeon.selectDungeonTicket(npc, player);
        return;
    }
    public void corvette_imperial_pilot_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return;
    }
    public void corvette_imperial_pilot_action_itp_kaja_signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "itp_kaja_01_01a");
    }
    public int corvette_imperial_pilot_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corvette_imperial_pilot_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corvette_imperial_pilot_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
