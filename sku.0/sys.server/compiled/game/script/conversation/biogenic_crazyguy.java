...
public class biogenic_crazyguy extends script.base_script
{
    ...
    public boolean biogenic_crazyguy_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean biogenic_crazyguy_condition_get_tracker_1(obj_id player, obj_id npc)
    {
    ...
    public boolean biogenic_crazyguy_condition_get_tracker_2(obj_id player, obj_id npc)
    {
        int convo_tracker = getIntObjVar(player, "biogenic.crazy_convo");
        if (convo_tracker >= 2)
        {
    ...
    public void biogenic_crazyguy_action__defaultAction(obj_id player, obj_id npc)
    {
    }
    public void biogenic_crazyguy_action_set_tracker_1(obj_id player, obj_id npc)
    {
        setObjVar(player, "biogenic.crazy_convo", 1);
    }
    public void biogenic_crazyguy_action_set_tracker_2(obj_id player, obj_id npc)
    {
        setObjVar(player, "biogenic.crazy_convo", 2);
    }
    public void biogenic_crazyguy_action_set_mood(obj_id player, obj_id npc)
    {
        setAnimationMood(npc, chat.MOOD_NERVOUS);
        faceToBehavior(npc, player);
    }
    public void biogenic_crazyguy_action_face_to(obj_id player, obj_id npc)
    {
        faceToBehavior(npc, player);
    }
