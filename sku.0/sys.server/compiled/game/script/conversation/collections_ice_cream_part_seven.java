...
public class collections_ice_cream_part_seven extends script.base_script
{
    ...
    public boolean collections_ice_cream_part_seven_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean collections_ice_cream_part_seven_condition_hasActiveTask(obj_id player, obj_id npc)
    {
    ...
    public void collections_ice_cream_part_seven_action_signalNextTask(obj_id player, obj_id npc)
    {
        modifyCollectionSlotValue(player, "col_fried_icecream_part_07", 1);
        groundquests.sendSignal(player, "meet_lepwalk_chan");
    }
    public int collections_ice_cream_part_seven_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int collections_ice_cream_part_seven_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int collections_ice_cream_part_seven_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int collections_ice_cream_part_seven_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int collections_ice_cream_part_seven_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
