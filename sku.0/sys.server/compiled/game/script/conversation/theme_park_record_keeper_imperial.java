...
public class theme_park_record_keeper_imperial extends script.base_script
{
    ...
    public boolean theme_park_record_keeper_imperial_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean theme_park_record_keeper_imperial_condition_theme_park_complete(obj_id player, obj_id npc)
    {
    ...
    public boolean theme_park_record_keeper_imperial_condition_theme_park_in_progress(obj_id player, obj_id npc)
    {
        if (!hasObjVar(player, "theme_park_reset.imperial"))
        {
            if (hasObjVar(player, "theme_park_imperial"))
    ...
    public boolean theme_park_record_keeper_imperial_condition_already_reset(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "theme_park_reset.imperial"))
        {
            return true;
    ...
    public boolean theme_park_record_keeper_imperial_condition_not_imperial(obj_id player, obj_id npc)
    {
    ...
    public void theme_park_record_keeper_imperial_action__defaultAction(obj_id player, obj_id npc)
    {
    }
    public void theme_park_record_keeper_imperial_action_reset_gating(obj_id player, obj_id npc)
    {
    ...
    public void theme_park_record_keeper_imperial_action_set_redo(obj_id player, obj_id npc)
    {
        setObjVar(player, "theme_park_reset.imperial", true);
    ...
    public void theme_park_record_keeper_imperial_action_face_to(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
