...
public class naboo_deeja_peak_walker_luskeske extends script.base_script
{
    ...
    public boolean naboo_deeja_peak_walker_luskeske_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean naboo_deeja_peak_walker_luskeske_condition_speakToWalker_05(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "naboo_deeja_peak_beacon_darkness", "deeja_peak_beacon_darkness_05");
    }
    public boolean naboo_deeja_peak_walker_luskeske_condition_speakToWalker_09(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "naboo_deeja_peak_beacon_darkness", "deeja_peak_beacon_darkness_09");
    }
    public boolean naboo_deeja_peak_walker_luskeske_condition_hunting(obj_id player, obj_id npc)
    {
    ...
    public boolean naboo_deeja_peak_walker_luskeske_condition_doneWithWalker(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "naboo_deeja_peak_beacon_darkness", "deeja_peak_beacon_darkness_09");
    }
    public void naboo_deeja_peak_walker_luskeske_action_signal_darkness_05(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "deeja_peak_beacon_darkness_05");
    }
    public void naboo_deeja_peak_walker_luskeske_action_signal_darkness_09(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "deeja_peak_beacon_darkness_09");
    }
    public int naboo_deeja_peak_walker_luskeske_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_deeja_peak_walker_luskeske_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_deeja_peak_walker_luskeske_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_deeja_peak_walker_luskeske_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_deeja_peak_walker_luskeske_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int naboo_deeja_peak_walker_luskeske_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
