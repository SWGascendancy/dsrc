...
public class refugee_civilian extends script.base_script
{
    ...
    public boolean refugee_civilian_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean refugee_civilian_condition_isProlog(obj_id player, obj_id npc)
    {
        return groundquests.isQuestActive(player, "quest_08_dathomir_outpost_final");
    }
    public int refugee_civilian_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
