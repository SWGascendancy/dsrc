...
public class corellia_coronet_jonset extends script.base_script
{
    ...
    public boolean corellia_coronet_jonset_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_coronet_jonset_condition_theMeetingBegins(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_coronet_capitol_problems_the_meeting", "the_meeting_1");
    }
    public boolean corellia_coronet_jonset_condition_theMeetingMovesOn(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "corellia_coronet_capitol_problems_the_meeting", "the_meeting_1");
    }
    public void corellia_coronet_jonset_action_theMeetingContinues(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "the_meeting_1");
    }
    public int corellia_coronet_jonset_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_coronet_jonset_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
