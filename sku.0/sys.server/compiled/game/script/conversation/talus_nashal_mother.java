...
public class talus_nashal_mother extends script.base_script
{
    ...
    public boolean talus_nashal_mother_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean talus_nashal_mother_condition_onTalkMother(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "talus_nashal_goto_mother", "selonian_talk_mother");
    }
    public boolean talus_nashal_mother_condition_completeTalkMother(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "talus_nashal_goto_mother");
    }
    public void talus_nashal_mother_action_signalTalkMother(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "selonian_talk_mother");
    }
    public void talus_nashal_mother_action_grant_handoff_41(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "talus_dearic_goto_dathnaeya");
    }
    public int talus_nashal_mother_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_mother_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_mother_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_mother_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_mother_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
