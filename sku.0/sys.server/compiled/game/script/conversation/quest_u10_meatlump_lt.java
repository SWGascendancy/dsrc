...
public class quest_u10_meatlump_lt extends script.base_script
{
    ...
    public boolean quest_u10_meatlump_lt_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean quest_u10_meatlump_lt_condition_quest_u10_02_01_complete(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "quest_u10_02", "quest_u10_02_01");
    }
    public boolean quest_u10_meatlump_lt_condition_quest_u10_02_01_active(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "quest_u10_02", "quest_u10_02_01");
    }
    public void quest_u10_meatlump_lt_action_quest_u10_02_01_signal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "quest_u10_02_01");
    }
    public int quest_u10_meatlump_lt_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_u10_meatlump_lt_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_u10_meatlump_lt_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_u10_meatlump_lt_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_u10_meatlump_lt_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_u10_meatlump_lt_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_u10_meatlump_lt_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
