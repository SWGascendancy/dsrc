...
public class ep3_etyyy_kint_zsam extends script.base_script
{
    ...
    public boolean ep3_etyyy_kint_zsam_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_etyyy_kint_zsam_condition_hasHraccaTicket(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_etyyy_kint_zsam_condition_knowsKint(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedQuest(player, "ep3_hunt_johnson_seek_kint"));
    }
    public boolean ep3_etyyy_kint_zsam_condition_canEnterHracca(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_etyyy_kint_zsam_condition_sentBySmith(obj_id player, obj_id npc)
    {
        return (groundquests.isQuestActive(player, "ep3_hunt_johnson_seek_kint"));
    }
    public boolean ep3_etyyy_kint_zsam_condition_hasKilledKkorrwrot(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "ep3_hunt_hracca_kkorrwrot_hunt", "hracca_kkorrwrotKilled");
    }
    public boolean ep3_etyyy_kint_zsam_condition_needsATicket(obj_id player, obj_id npc)
    {
        if (groundquests.isTaskActive(player, "ep3_hunt_hracca_kkorrwrot_hunt", "hracca_huntKkorrwrot"))
        {
            if (!ep3_etyyy_kint_zsam_condition_hasHraccaTicket(player, npc))
    ...
    public boolean ep3_etyyy_kint_zsam_condition_canRepeatHunt(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedQuest(player, "ep3_hunt_hracca_kkorrwrot_hunt"));
    }
    public boolean ep3_etyyy_kint_zsam_condition_tooManyInGroup(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_etyyy_kint_zsam_condition_isInGodMode(obj_id player, obj_id npc)
    {
        return isGod(player);
    }
    public boolean ep3_etyyy_kint_zsam_condition_killedKkorrwrotNoBadge(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "ep3_hunt_hracca_kkorrwrot_hunt") && !badge.hasBadge(player, "bdg_kash_kkorrwrot");
    }
    public void ep3_etyyy_kint_zsam_action_giveHraccaGatePass(obj_id player, obj_id npc)
    {
        if (!ep3_etyyy_kint_zsam_condition_hasHraccaTicket(player, npc))
        {
    ...
    public void ep3_etyyy_kint_zsam_action_endSuccessfulHunt(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "hracca_kkorrwrotKilled");
        return;
    }
    public void ep3_etyyy_kint_zsam_action_sendToHracca(obj_id player, obj_id npc)
    {
        space_dungeon.selectDungeonTicket(npc, player);
        return;
    }
    public void ep3_etyyy_kint_zsam_action_giveKkorrwrotQuest(obj_id player, obj_id npc)
    {
    ...
    public void ep3_etyyy_kint_zsam_action_godModeEntry(obj_id player, obj_id npc)
    {
        if (isGod(player))
        {
            String ticketTemplate = "object/tangible/travel/travel_ticket/hracca_glade_ticket.iff";
    ...
    public void ep3_etyyy_kint_zsam_action_giveKkorrwrotBadge(obj_id player, obj_id npc)
    {
    ...
    public void ep3_etyyy_kint_zsam_action_revokeKkorrwrotBadge(obj_id player, obj_id npc)
    {
        if (badge.hasBadge(player, "bdg_kash_kkorrwrot"))
        {
    ...
    public String ep3_etyyy_kint_zsam_tokenTO_getNameOfPlayer(obj_id player, obj_id npc)
    {
        return getFirstName(player);
    }
    public int ep3_etyyy_kint_zsam_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_kint_zsam_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_kint_zsam_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_kint_zsam_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_kint_zsam_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_kint_zsam_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_kint_zsam_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_kint_zsam_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_kint_zsam_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_kint_zsam_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_kint_zsam_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_kint_zsam_handleBranch30(obj_id player, obj_id npc, string_id response)
    {
