...
public class qtqc_phase_3 extends script.base_script
{
    ...
    public boolean qtqc_phase_3_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean qtqc_phase_3_condition_isPlayerCommunityCrafting(obj_id player, obj_id npc)
    {
    ...
    public boolean qtqc_phase_3_condition_isCommunityCraftingEnabled(obj_id player, obj_id npc)
    {
        return fs_quests_cc.testCommunityCraftingEnabled(npc, 3);
    }
    public boolean qtqc_phase_3_condition_canAddPlayer(obj_id player, obj_id npc)
    {
        obj_id craftingTracker = utils.getObjIdScriptVar(npc, fs_quests_cc.SCRIPTVAR_CRAFTING_TRACKER);
        if (isIdValid(craftingTracker))
        {
    ...
    public boolean qtqc_phase_3_condition_isTrackingQuality(obj_id player, obj_id npc)
    {
        return utils.getBooleanScriptVar(npc, fs_quests_cc.SCRIPTVAR_TRACKING_QUALITY);
    }
    public boolean qtqc_phase_3_condition_isTrackingQuantity(obj_id player, obj_id npc)
    {
        return utils.getBooleanScriptVar(npc, fs_quests_cc.SCRIPTVAR_TRACKING_QUANTITY);
    }
    public boolean qtqc_phase_3_condition_isTrackingSlots(obj_id player, obj_id npc)
    {
        return utils.getBooleanScriptVar(npc, fs_quests_cc.SCRIPTVAR_TRACKING_SLOTS);
    }
    public boolean qtqc_phase_3_condition_playerNeedsSchematics(obj_id player, obj_id npc)
    {
        obj_id craftingTracker = utils.getObjIdScriptVar(npc, fs_quests_cc.SCRIPTVAR_CRAFTING_TRACKER);
        if (isIdValid(craftingTracker))
        {
    ...
    public boolean qtqc_phase_3_condition_needsMoreThanOneItem(obj_id player, obj_id npc)
    {
        return qtqc_phase_3_tokenDI_ingredientsNeeded(player, npc) > 1;
    }
    public boolean qtqc_phase_3_condition_needsNoMoreItems(obj_id player, obj_id npc)
    {
        return qtqc_phase_3_tokenDI_ingredientsNeeded(player, npc) < 1;
    }
    public boolean qtqc_phase_3_condition_needsOneMoreItem(obj_id player, obj_id npc)
    {
        return qtqc_phase_3_tokenDI_ingredientsNeeded(player, npc) == 1;
    }
    public void qtqc_phase_3_action_addPlayerToProject(obj_id player, obj_id npc)
    {
        obj_id craftingTracker = utils.getObjIdScriptVar(npc, fs_quests_cc.SCRIPTVAR_CRAFTING_TRACKER);
        if (isIdValid(craftingTracker))
        {
    ...
    public void qtqc_phase_3_action_openMyInventoryToPlayer(obj_id player, obj_id npc)
    {
    ...
    public void qtqc_phase_3_action_showPlayerSlot1Quality(obj_id player, obj_id npc)
    {
        fs_quests_cc.showPlayerProjectStats(npc, player, 1, true, 3);
    }
    public void qtqc_phase_3_action_showPlayerProjectAttributes(obj_id player, obj_id npc)
    {
        fs_quests_cc.showPlayerProjectAttribs(npc, player, 3);
    }
    public void qtqc_phase_3_action_showPlayerSlot2Quality(obj_id player, obj_id npc)
    {
        fs_quests_cc.showPlayerProjectStats(npc, player, 2, true, 3);
    }
    public void qtqc_phase_3_action_showPlayerSlot4Quality(obj_id player, obj_id npc)
    {
        fs_quests_cc.showPlayerProjectStats(npc, player, 4, true, 3);
    }
    public void qtqc_phase_3_action_showPlayerSlot5Quality(obj_id player, obj_id npc)
    {
        fs_quests_cc.showPlayerProjectStats(npc, player, 5, true, 3);
    }
    public void qtqc_phase_3_action_showPlayerSlot6Quality(obj_id player, obj_id npc)
    {
        fs_quests_cc.showPlayerProjectStats(npc, player, 6, true, 3);
    }
    public void qtqc_phase_3_action_showPlayerSlot7Quality(obj_id player, obj_id npc)
    {
        fs_quests_cc.showPlayerProjectStats(npc, player, 7, true, 3);
    }
    public void qtqc_phase_3_action_showPlayerProjectQuality(obj_id player, obj_id npc)
    {
        fs_quests_cc.showPlayerProjectStats(npc, player, 0, true, 3);
    }
    public void qtqc_phase_3_action_showPlayerSlot3Quality(obj_id player, obj_id npc)
    {
        fs_quests_cc.showPlayerProjectStats(npc, player, 3, true, 3);
    }
    public void qtqc_phase_3_action_showPlayerSlot1Quantity(obj_id player, obj_id npc)
    {
        fs_quests_cc.showPlayerProjectStats(npc, player, 1, false, 3);
    }
    public void qtqc_phase_3_action_showPlayerSlot2Quantity(obj_id player, obj_id npc)
    {
        fs_quests_cc.showPlayerProjectStats(npc, player, 2, false, 3);
    }
    public void qtqc_phase_3_action_showPlayerSlot4Quantity(obj_id player, obj_id npc)
    {
        fs_quests_cc.showPlayerProjectStats(npc, player, 4, false, 3);
    }
    public void qtqc_phase_3_action_showPlayerSlot5Quantity(obj_id player, obj_id npc)
    {
        fs_quests_cc.showPlayerProjectStats(npc, player, 5, false, 3);
    }
    public void qtqc_phase_3_action_showPlayerSlot6Quantity(obj_id player, obj_id npc)
    {
        fs_quests_cc.showPlayerProjectStats(npc, player, 6, false, 3);
    }
    public void qtqc_phase_3_action_showPlayerSlot7Quantity(obj_id player, obj_id npc)
    {
        fs_quests_cc.showPlayerProjectStats(npc, player, 7, false, 3);
    }
    public void qtqc_phase_3_action_showPlayerProjectQuantity(obj_id player, obj_id npc)
    {
        fs_quests_cc.showPlayerProjectStats(npc, player, 0, false, 3);
    }
    public void qtqc_phase_3_action_showPlayerSlot3Quantity(obj_id player, obj_id npc)
    {
        fs_quests_cc.showPlayerProjectStats(npc, player, 3, false, 3);
    }
    public int qtqc_phase_3_tokenDI_ingredientsNeeded(obj_id player, obj_id npc)
    {
        obj_id craftingTracker = utils.getObjIdScriptVar(npc, fs_quests_cc.SCRIPTVAR_CRAFTING_TRACKER);
        if (isIdValid(craftingTracker))
        {
