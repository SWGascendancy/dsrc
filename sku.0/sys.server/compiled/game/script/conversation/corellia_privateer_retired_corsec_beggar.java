...
public class corellia_privateer_retired_corsec_beggar extends script.base_script
{
    ...
    public boolean corellia_privateer_retired_corsec_beggar_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_privateer_retired_corsec_beggar_condition_remembersPlayer(obj_id player, obj_id npc)
    {
        return (utils.hasScriptVar(player, "metWyron"));
    }
    public boolean corellia_privateer_retired_corsec_beggar_condition_hasNoviceSkillBox(obj_id player, obj_id npc)
    {
        return (hasSkill(player, "pilot_rebel_navy_novice"));
    }
    public boolean corellia_privateer_retired_corsec_beggar_condition_hasRebelQuest(obj_id player, obj_id npc)
    {
        return (space_quest.hasQuest(player) && corellia_privateer_retired_corsec_beggar_condition_hasNoviceSkillBox(player, npc));
    }
    public boolean corellia_privateer_retired_corsec_beggar_condition_isImperialPilot(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_privateer_retired_corsec_beggar_condition_isRebelPilot(obj_id player, obj_id npc)
    {
        return (hasSkill(player, "pilot_rebel_navy_novice"));
    }
    public boolean corellia_privateer_retired_corsec_beggar_condition_isGenderMale(obj_id player, obj_id npc)
    {
        return (getGender(player) == GENDER_MALE);
    }
    public boolean corellia_privateer_retired_corsec_beggar_condition_hasCompletedQuestOne(obj_id player, obj_id npc)
    {
        return (space_quest.hasCompletedQuest(player, "destroy_surpriseattack", "naboo_rebel_1"));
    }
    public boolean corellia_privateer_retired_corsec_beggar_condition_hasCompletedQuestTwo(obj_id player, obj_id npc)
    {
        return (space_quest.hasCompletedQuest(player, "destroy", "naboo_rebel_2"));
    }
    public boolean corellia_privateer_retired_corsec_beggar_condition_hasCompletedQuestThree(obj_id player, obj_id npc)
    {
        return (space_quest.hasCompletedQuest(player, "escort", "naboo_rebel_3"));
    }
    public boolean corellia_privateer_retired_corsec_beggar_condition_hasCompletedQuestFour(obj_id player, obj_id npc)
    {
        return (space_quest.hasCompletedQuest(player, "destroy", "naboo_rebel_4"));
    }
    public boolean corellia_privateer_retired_corsec_beggar_condition_hasFailedQuestOne(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_privateer_retired_corsec_beggar_condition_isReadyForFirstTraining(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_privateer_retired_corsec_beggar_condition_isReadyForMoreTraining(obj_id player, obj_id npc)
    {
        return (space_quest.isPlayerQualifiedForSkill(player, "pilot_rebel_navy_starships_01"));
    }
    public boolean corellia_privateer_retired_corsec_beggar_condition_hasAllTierOneSkills(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_privateer_retired_corsec_beggar_condition_hasFailedQuestTwo(obj_id player, obj_id npc)
    {
        return (space_quest.hasFailedQuest(player, "destroy", "naboo_rebel_2") || space_quest.hasAbortedQuest(player, "destroy", "naboo_rebel_2"));
    }
    public boolean corellia_privateer_retired_corsec_beggar_condition_beenRewardedForQuestOne(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_privateer_retired_corsec_beggar_condition_beenRewardedForQuestTwo(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_privateer_retired_corsec_beggar_condition_beenRewardedForQuestThree(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_privateer_retired_corsec_beggar_condition_beenRewardedForQuestFour(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_privateer_retired_corsec_beggar_condition_hasFailedQuestThree(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_privateer_retired_corsec_beggar_condition_hasFailedQuestFour(obj_id player, obj_id npc)
    {
        return (space_quest.hasFailedQuest(player, "destroy", "naboo_rebel_4") || space_quest.hasAbortedQuest(player, "destroy", "naboo_rebel_4"));
    }
    public boolean corellia_privateer_retired_corsec_beggar_condition_isPrivateerPilot(obj_id player, obj_id npc)
    {
        return hasSkill(player, "pilot_neutral_novice");
    }
    public boolean corellia_privateer_retired_corsec_beggar_condition_readyForSecondSkill(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_privateer_retired_corsec_beggar_condition_hasSTARSHIPS1(obj_id player, obj_id npc)
    {
        return (hasSkill(player, "pilot_rebel_navy_starships_01"));
    }
    public boolean corellia_privateer_retired_corsec_beggar_condition_hasWEAPONS1(obj_id player, obj_id npc)
    {
        return (hasSkill(player, "pilot_rebel_navy_weapons_01"));
    }
    public boolean corellia_privateer_retired_corsec_beggar_condition_hasPROCEDURES1(obj_id player, obj_id npc)
    {
        return (hasSkill(player, "pilot_rebel_navy_procedures_01"));
    }
    public boolean corellia_privateer_retired_corsec_beggar_condition_hasDROIDS1(obj_id player, obj_id npc)
    {
        return (hasSkill(player, "pilot_rebel_navy_droid_01"));
    }
    public boolean corellia_privateer_retired_corsec_beggar_condition_hasSpaceExpansion(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_privateer_retired_corsec_beggar_condition_hasSpaceShip(obj_id player, obj_id npc)
    {
        return (space_quest.hasShip(player));
    }
    public boolean corellia_privateer_retired_corsec_beggar_condition_has_GRADUATED_goto_DANTOOINE(obj_id player, obj_id npc)
    {
        return (hasObjVar(player, "vortexPilot"));
    }
    public boolean corellia_privateer_retired_corsec_beggar_condition_hasVeryFirstQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean corellia_privateer_retired_corsec_beggar_condition_imp_isasking(obj_id player, obj_id npc)
    {
        return (utils.hasScriptVar(player, "imp_isasking"));
    }
    public boolean corellia_privateer_retired_corsec_beggar_condition_q1_has_discussed(obj_id player, obj_id npc)
    {
        return (utils.hasScriptVar(player, "q1_discussed"));
    }
    public void corellia_privateer_retired_corsec_beggar_action_rememberPlayer(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "metWyron", true);
    }
    public void corellia_privateer_retired_corsec_beggar_action_grantNoviceSkillBox(obj_id player, obj_id npc)
    {
    ...
    public void corellia_privateer_retired_corsec_beggar_action_grantQuestOne(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "patrol", "naboo_rebel_1");
    }
    public void corellia_privateer_retired_corsec_beggar_action_grantQuestTwo(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy", "naboo_rebel_2");
    }
    public void corellia_privateer_retired_corsec_beggar_action_grantQuestThree(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "patrol", "naboo_rebel_3");
    }
    public void corellia_privateer_retired_corsec_beggar_action_grantQuestFour(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy", "naboo_rebel_4");
    }
    public void corellia_privateer_retired_corsec_beggar_action_anim_salute(obj_id player, obj_id npc)
    {
        doAnimationAction(npc, "salute");
    }
    public void corellia_privateer_retired_corsec_beggar_action_anim_greet(obj_id player, obj_id npc)
    {
        doAnimationAction(npc, "greet");
    }
    public void corellia_privateer_retired_corsec_beggar_action_anim_poundFist(obj_id player, obj_id npc)
    {
        doAnimationAction(npc, "pound_fist_palm");
    }
    public void corellia_privateer_retired_corsec_beggar_action_anim_explode(obj_id player, obj_id npc)
    {
        playClientEffectLoc(player, "clienteffect/lair_damage_light.cef", getLocation(npc), 1.52f);
    }
    public void corellia_privateer_retired_corsec_beggar_action_grantSkill1(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public void corellia_privateer_retired_corsec_beggar_action_grantSkill2(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        doAnimationAction(npc, "salute1");
        if (corellia_privateer_retired_corsec_beggar_condition_readyForSecondSkill(player, npc))
    ...
    public void corellia_privateer_retired_corsec_beggar_action_grantSkill3(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        doAnimationAction(npc, "salute1");
        if (corellia_privateer_retired_corsec_beggar_condition_readyForSecondSkill(player, npc))
    ...
    public void corellia_privateer_retired_corsec_beggar_action_grantSkill4(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        doAnimationAction(npc, "salute1");
        if (corellia_privateer_retired_corsec_beggar_condition_readyForSecondSkill(player, npc))
    ...
    public void corellia_privateer_retired_corsec_beggar_action_grantDUTY_Destroy1(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy_duty", "naboo_rebel_6");
    }
    public void corellia_privateer_retired_corsec_beggar_action_grantDUTY_Escort1(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "escort_duty", "naboo_rebel_7");
    }
    public void corellia_privateer_retired_corsec_beggar_action_reward_quest_1(obj_id player, obj_id npc)
    {
        space_quest.giveReward(player, "destroy_surpriseattack", "naboo_rebel_1", 500);
    }
    public void corellia_privateer_retired_corsec_beggar_action_reward_quest_2(obj_id player, obj_id npc)
    {
        space_quest.giveReward(player, "destroy", "naboo_rebel_2", 750);
    }
    public void corellia_privateer_retired_corsec_beggar_action_reward_quest_3(obj_id player, obj_id npc)
    {
        space_quest.giveReward(player, "escort", "naboo_rebel_3", 1000);
    }
    public void corellia_privateer_retired_corsec_beggar_action_reward_quest_4(obj_id player, obj_id npc)
    {
        space_quest.giveReward(player, "destroy", "naboo_rebel_4", 1500);
    }
    public void corellia_privateer_retired_corsec_beggar_action_grantSpaceShip(obj_id player, obj_id npc)
    {
        space_quest.grantNewbieShip(player, "rebel");
    }
    public void corellia_privateer_retired_corsec_beggar_action_set_GRADUATED_goto_DANTOOINE(obj_id player, obj_id npc)
    {
        setObjVar(player, "vortexPilot", true);
    }
    public void corellia_privateer_retired_corsec_beggar_action_an_imp_is_asking(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "imp_isasking", true);
    }
    public void corellia_privateer_retired_corsec_beggar_action_action0001(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "q1_premission", true);
    }
    public void corellia_privateer_retired_corsec_beggar_action_q1_set_discussed(obj_id player, obj_id npc)
    {
        utils.setScriptVar(player, "q1_discussed", true);
    }
    public int corellia_privateer_retired_corsec_beggar_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_privateer_retired_corsec_beggar_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_privateer_retired_corsec_beggar_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_privateer_retired_corsec_beggar_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_privateer_retired_corsec_beggar_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_privateer_retired_corsec_beggar_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_privateer_retired_corsec_beggar_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_privateer_retired_corsec_beggar_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_privateer_retired_corsec_beggar_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_privateer_retired_corsec_beggar_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_privateer_retired_corsec_beggar_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_privateer_retired_corsec_beggar_handleBranch24(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_privateer_retired_corsec_beggar_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_privateer_retired_corsec_beggar_handleBranch26(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_privateer_retired_corsec_beggar_handleBranch30(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_privateer_retired_corsec_beggar_handleBranch31(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_958a863c"))
        {
            if (corellia_privateer_retired_corsec_beggar_condition__defaultCondition(player, npc))
    ...
    public int corellia_privateer_retired_corsec_beggar_handleBranch32(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_3e8d294c"))
        {
            if (corellia_privateer_retired_corsec_beggar_condition__defaultCondition(player, npc))
    ...
    public int corellia_privateer_retired_corsec_beggar_handleBranch36(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_e28320c1"))
        {
            if (corellia_privateer_retired_corsec_beggar_condition__defaultCondition(player, npc))
    ...
    public int corellia_privateer_retired_corsec_beggar_handleBranch39(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_privateer_retired_corsec_beggar_handleBranch40(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_privateer_retired_corsec_beggar_handleBranch43(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_958a863c"))
        {
            if (corellia_privateer_retired_corsec_beggar_condition__defaultCondition(player, npc))
    ...
    public int corellia_privateer_retired_corsec_beggar_handleBranch44(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_3e8d294c"))
        {
            if (corellia_privateer_retired_corsec_beggar_condition__defaultCondition(player, npc))
    ...
    public int corellia_privateer_retired_corsec_beggar_handleBranch48(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_privateer_retired_corsec_beggar_handleBranch50(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_privateer_retired_corsec_beggar_handleBranch53(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_privateer_retired_corsec_beggar_handleBranch56(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_privateer_retired_corsec_beggar_handleBranch57(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_3e8d294c"))
        {
            if (corellia_privateer_retired_corsec_beggar_condition__defaultCondition(player, npc))
    ...
    public int corellia_privateer_retired_corsec_beggar_handleBranch60(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_privateer_retired_corsec_beggar_handleBranch61(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_privateer_retired_corsec_beggar_handleBranch62(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_privateer_retired_corsec_beggar_handleBranch63(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_privateer_retired_corsec_beggar_handleBranch64(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_privateer_retired_corsec_beggar_handleBranch69(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_e529f302"))
        {
            if (corellia_privateer_retired_corsec_beggar_condition__defaultCondition(player, npc))
    ...
    public int corellia_privateer_retired_corsec_beggar_handleBranch70(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_47744716"))
        {
            if (corellia_privateer_retired_corsec_beggar_condition__defaultCondition(player, npc))
