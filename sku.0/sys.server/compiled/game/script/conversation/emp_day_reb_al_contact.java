...
public class emp_day_reb_al_contact extends script.base_script
{
    ...
    public boolean emp_day_reb_al_contact_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean emp_day_reb_al_contact_condition_hasTask2or3(obj_id player, obj_id npc)
    {
    ...
    public boolean emp_day_reb_al_contact_condition_pastMyTasks(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/emp_day_rebel");
    ...
    public boolean emp_day_reb_al_contact_condition_hasDisks(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/emp_day_rebel");
        int task2 = groundquests.getTaskId(questId, "killImperials");
        int task3 = groundquests.getTaskId(questId, "diskGuy1");
    ...
    public boolean emp_day_reb_al_contact_condition_hasStartingTask(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/emp_day_rebel");
        return questIsTaskActive(questId, 0, player);
    }
    public boolean emp_day_reb_al_contact_condition_hasTask2(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/emp_day_rebel");
        int task2 = groundquests.getTaskId(questId, "killImperials");
        return questIsTaskActive(questId, task2, player);
    }
    public boolean emp_day_reb_al_contact_condition_hasTask3a(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/emp_day_rebel");
        int task3 = groundquests.getTaskId(questId, "diskGuy1");
        return questIsTaskActive(questId, task3, player);
    }
    public boolean emp_day_reb_al_contact_condition_isNeutral(obj_id player, obj_id npc)
    {
    ...
    public boolean emp_day_reb_al_contact_condition_isAnImp(obj_id player, obj_id npc)
    {
    ...
    public void emp_day_reb_al_contact_action_historianConversed(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "converse_contact");
    }
    public void emp_day_reb_al_contact_action_diskGuy1Wp(obj_id player, obj_id npc)
    {
    }
    public void emp_day_reb_al_contact_action_disksToHistorian(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/emp_day_rebel");
        int task2 = groundquests.getTaskId(questId, "killImperials");
        int task3 = groundquests.getTaskId(questId, "diskGuy1");
    ...
    public void emp_day_reb_al_contact_action_impTechWp(obj_id player, obj_id npc)
    {
    }
    public int emp_day_reb_al_contact_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_reb_al_contact_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_reb_al_contact_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_reb_al_contact_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_reb_al_contact_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_reb_al_contact_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_reb_al_contact_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_214"))
        {
            if (emp_day_reb_al_contact_condition__defaultCondition(player, npc))
    ...
    public int emp_day_reb_al_contact_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_reb_al_contact_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_214"))
        {
            if (emp_day_reb_al_contact_condition__defaultCondition(player, npc))
    ...
    public int emp_day_reb_al_contact_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int emp_day_reb_al_contact_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
