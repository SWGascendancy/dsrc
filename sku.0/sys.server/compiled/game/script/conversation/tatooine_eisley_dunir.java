...
public class tatooine_eisley_dunir extends script.base_script
{
    ...
    public boolean tatooine_eisley_dunir_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean tatooine_eisley_dunir_condition_sdQuestComplete(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean tatooine_eisley_dunir_condition_sdTaskCompleted(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        int questId1 = questGetQuestId("quest/tatooine_eisley_special_delivery");
    ...
    public boolean tatooine_eisley_dunir_condition_sdOnTask1(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        int questId1 = questGetQuestId("quest/tatooine_eisley_special_delivery");
    ...
    public boolean tatooine_eisley_dunir_condition_sdOnTask2(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        int questId1 = questGetQuestId("quest/tatooine_eisley_special_delivery");
    ...
    public boolean tatooine_eisley_dunir_condition_blocker(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isQuestDisabled("tatooine_eisley_special_delivery");
    }
    public boolean tatooine_eisley_dunir_condition_nikoQuestComplete(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean tatooine_eisley_dunir_condition_diOnQuest(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return groundquests.isQuestActive(player, "tatooine_eisley_digital_infection");
    }
    public boolean tatooine_eisley_dunir_condition_diQuestComplete(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean tatooine_eisley_dunir_condition_gotoDunirComplete(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean tatooine_eisley_dunir_condition_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        return true;
    }
    public void tatooine_eisley_dunir_action_signalSDReward(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tat_eisley_special_delivery_e7");
    }
    public void tatooine_eisley_dunir_action_grantSDQuest(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/tatooine_eisley_special_delivery");
        groundquests.grantQuest(questId, player, npc, true);
    }
    public void tatooine_eisley_dunir_action_signalGotoDunir(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tat_niko_dunir_e1");
    }
    public void tatooine_eisley_dunir_action_grantGotoReimos(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/tatooine_eisley_gotoreimos");
        groundquests.grantQuest(questId, player, npc, true);
    }
    public int tatooine_eisley_dunir_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_dunir_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_dunir_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_dunir_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_dunir_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_dunir_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_dunir_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_dunir_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_dunir_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_dunir_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_dunir_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_dunir_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_50"))
        {
            if (tatooine_eisley_dunir_condition__defaultCondition(player, npc))
    ...
    public int tatooine_eisley_dunir_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int tatooine_eisley_dunir_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
