...
public class talus_nashal_droid_head extends script.base_script
{
    ...
    public boolean talus_nashal_droid_head_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean talus_nashal_droid_head_condition_onPassword(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "talus_nashal_tracking_crew", "tracking_crew_signal_01_07");
    }
    public boolean talus_nashal_droid_head_condition_passwordCompleted(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "talus_nashal_tracking_crew", "tracking_crew_signal_01_07");
    }
    public void talus_nashal_droid_head_action_signalPassword(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "tracking_crew_signal_01_07");
    }
    public String talus_nashal_droid_head_tokenTO_tokenGenderTitle(obj_id player, obj_id npc)
    {
    ...
    public int talus_nashal_droid_head_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_droid_head_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_droid_head_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_droid_head_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int talus_nashal_droid_head_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
