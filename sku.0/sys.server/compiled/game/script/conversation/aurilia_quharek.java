...
public class aurilia_quharek extends script.conversation.base.conversation_base
{
    ...
    private boolean aurilia_quharek_condition__defaultCondition()
    {
        return true;
    }
    private boolean aurilia_quharek_condition_axkva_min_intro_01(obj_id player)
    {
        return groundquests.isTaskActive(player, "axkva_min_intro", "axkva_min_intro_01");
    }
    private int aurilia_quharek_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
