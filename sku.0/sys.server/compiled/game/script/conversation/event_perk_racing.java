...
public class event_perk_racing extends script.base_script
{
    ...
    public boolean event_perk_racing_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean event_perk_racing_condition_partOfStory(obj_id player, obj_id npc)
    {
    ...
    public boolean event_perk_racing_condition_isRacing(obj_id player, obj_id npc)
    {
        return hasScript(player, "systems.event_perk.race_droid_player") && hasObjVar(player, "event_perk.racing.isRacing");
    }
    public boolean event_perk_racing_condition_hasLastTime(obj_id player, obj_id npc)
    {
        return hasScript(player, "systems.event_perk.race_droid_player");
    }
    public void event_perk_racing_action_startRace(obj_id player, obj_id npc)
    {
    ...
    public void event_perk_racing_action_displayCurrentLeader(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        params.put("npc", npc);
    ...
    public void event_perk_racing_action_abortRace(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
    ...
    public String event_perk_racing_tokenTO_storytellerName(obj_id player, obj_id npc)
    {
        return getStringObjVar(npc, "storytellerName");
    }
    public int event_perk_racing_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_perk_racing_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_perk_racing_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_perk_racing_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_perk_racing_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_e460e3d3"))
        {
            if (event_perk_racing_condition__defaultCondition(player, npc))
    ...
    public int event_perk_racing_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int event_perk_racing_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_e460e3d3"))
        {
            if (event_perk_racing_condition__defaultCondition(player, npc))
