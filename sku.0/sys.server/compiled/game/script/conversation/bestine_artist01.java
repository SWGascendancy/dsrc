...
public class bestine_artist01 extends script.base_script
{
    ...
    public boolean bestine_artist01_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean bestine_artist01_condition_hasFeaturedArt_inEvent(obj_id player, obj_id npc)
    {
        return ((bestine_artist01_condition_isActiveInEvent(player, npc)) && (bestine_artist01_condition_hasFeaturedArt(player, npc)));
    }
    public boolean bestine_artist01_condition_isActiveInEvent(obj_id player, obj_id npc)
    {
    ...
    public boolean bestine_artist01_condition_hasFeaturedArt(obj_id player, obj_id npc)
    {
    ...
    public boolean bestine_artist01_condition_hasAlreadyVoted(obj_id player, obj_id npc)
    {
        if (hasObjVar(npc, "bestine.museumEventStarted"))
        {
    ...
    public boolean bestine_artist01_condition_alreadySpokenTo(obj_id player, obj_id npc)
    {
        if (hasObjVar(npc, "bestine.museumEventStarted"))
        {
    ...
    public void bestine_artist01_action_setHasSpokenTo(obj_id player, obj_id npc)
    {
        if (hasObjVar(npc, "bestine.museumEventStarted"))
        {
    ...
    public int bestine_artist01_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int bestine_artist01_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
