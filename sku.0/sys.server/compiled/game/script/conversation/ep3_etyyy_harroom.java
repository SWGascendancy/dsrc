...
public class ep3_etyyy_harroom extends script.base_script
{
    ...
    public boolean ep3_etyyy_harroom_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_etyyy_harroom_condition_needsUllerReward(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "ep3_hunt_sordaan_seek_harroom", "sordaan_ullerBetReward");
    }
    public boolean ep3_etyyy_harroom_condition_needsWallugaReward(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "ep3_hunt_sordaan_seek_harroom", "sordaan_wallugaBetReward");
    }
    public boolean ep3_etyyy_harroom_condition_needsMoufReward(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "ep3_hunt_sordaan_seek_harroom", "sordaan_moufBetReward");
    }
    public boolean ep3_etyyy_harroom_condition_needsWebweaverReward(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedTask(player, "ep3_hunt_sordaan_seek_harroom", "sordaan_webweaverBetReward");
    }
    public void ep3_etyyy_harroom_action_giveUllerReward(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "sordaan_talkToHarroom");
        groundquests.grantQuest(player, "ep3_hunt_harroom_uller_reward", false);
    }
    public void ep3_etyyy_harroom_action_giveWallugaReward(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "sordaan_talkToHarroom");
        groundquests.grantQuest(player, "ep3_hunt_harroom_walluga_reward", false);
    }
    public void ep3_etyyy_harroom_action_giveMoufReward(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "sordaan_talkToHarroom");
        groundquests.grantQuest(player, "ep3_hunt_harroom_mouf_reward", false);
    }
    public void ep3_etyyy_harroom_action_giveWebweaverReward(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "sordaan_talkToHarroom");
