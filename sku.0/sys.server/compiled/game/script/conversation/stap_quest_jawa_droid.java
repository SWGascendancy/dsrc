...
public class stap_quest_jawa_droid extends script.base_script
{
    ...
    public boolean stap_quest_jawa_droid_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean stap_quest_jawa_droid_condition_stapQuestActive(obj_id player, obj_id npc)
    {
    ...
    public void stap_quest_jawa_droid_action_spawnJawa(obj_id player, obj_id npc)
    {
    ...
    public int cleanupjawa(obj_id self, dictionary params)
    {
    ...
    public void stap_quest_jawa_droid_action_finishTask(obj_id player, obj_id npc)
    {
    ...
    public int stap_quest_jawa_droid_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int stap_quest_jawa_droid_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int stap_quest_jawa_droid_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int stap_quest_jawa_droid_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int stap_quest_jawa_droid_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
