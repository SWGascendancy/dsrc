...
public class lf_killmite extends script.base_script
{
    ...
    public boolean lf_killmite_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean lf_killmite_condition_ifquestiscompleted(obj_id player, obj_id npc)
    {
    ...
    public boolean lf_killmite_condition_ifquestinprogress(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/lf_deadmite");
        return questIsQuestActive(questId, player);
    }
    public boolean lf_killmite_condition_questtaken(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/lf_deadmite");
        return questIsQuestActive(questId, player) || questIsQuestComplete(questId, player);
    }
    public boolean lf_killmite_condition_questrewarded(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/lf_deadmite");
        return questIsQuestComplete(questId, player);
    }
    public void lf_killmite_action_givequest(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/lf_deadmite");
    ...
    public void lf_killmite_action_faceplayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void lf_killmite_action_giverewardcraft(obj_id player, obj_id npc)
    {
    ...
    public void lf_killmite_action_giverewardcombat(obj_id player, obj_id npc)
    {
        obj_id waypoint = getObjIdObjVar(player, "quest.general.quest/lf_deadmite.waypoint");
        if (waypoint != null)
        {
    ...
    public void lf_killmite_action_givewaypoint(obj_id player, obj_id npc)
    {
        obj_id waypoint = getObjIdObjVar(player, "quest.general.quest/lf_deadmite.waypoint");
        if (waypoint != null)
        {
    ...
    public int lf_killmite_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int lf_killmite_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int lf_killmite_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_161"))
        {
            if (lf_killmite_condition__defaultCondition(player, npc))
    ...
    public int lf_killmite_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int lf_killmite_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
