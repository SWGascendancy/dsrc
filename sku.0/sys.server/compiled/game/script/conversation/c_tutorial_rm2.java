...
public class c_tutorial_rm2 extends script.base_script
{
    ...
    public boolean c_tutorial_rm2_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_tutorial_rm2_condition_playerOnQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean c_tutorial_rm2_condition_taskComplete(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/c_newbie_hall_01");
        int explainInventory = groundquests.getTaskId(questId, "explainInventory");
    ...
    public boolean c_tutorial_rm2_condition_playerOnQuestStep01(obj_id player, obj_id npc)
    {
        int questId = questGetQuestId("quest/c_newbie_hall_01");
        int explainRibbon = groundquests.getTaskId(questId, "explainRibbon");
    ...
    public void c_tutorial_rm2_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public void c_tutorial_rm2_action_actionSendSignal(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "explainInventory");
    }
    public int c_tutorial_rm2_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_tutorial_rm2_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_tutorial_rm2_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_tutorial_rm2_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_tutorial_rm2_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_tutorial_rm2_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_tutorial_rm2_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
