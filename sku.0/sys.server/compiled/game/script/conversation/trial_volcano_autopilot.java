...
public class trial_volcano_autopilot extends script.base_script
{
    ...
    public boolean trial_volcano_autopilot_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public void trial_volcano_autopilot_action_ejectPlayer(obj_id player, obj_id npc)
    {
        instance.requestExitPlayer("mustafar_volcano", player);
    }
    public int trial_volcano_autopilot_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
