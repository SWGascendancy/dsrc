...
public class c_smuggler_nyradi extends script.base_script
{
    ...
    public boolean c_smuggler_nyradi_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_smuggler_nyradi_condition_isTaskActiveSteal2(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "c_smuggler_steal_2", "person3"));
    }
    public void c_smuggler_nyradi_action_giveSignalSteal2(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "person3");
    }
    public int c_smuggler_nyradi_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
