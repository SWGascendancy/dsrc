...
public class destroysample extends script.base_script
{
    ...
    public boolean destroysample_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean destroysample_condition_completedQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean destroysample_condition_onQuest(obj_id player, obj_id npc)
    {
    ...
    public boolean destroysample_condition_alreadyRewarded(obj_id player, obj_id npc)
    {
        return space_quest.hasReceivedReward(player, "destroy", "sampleDestroy");
    }
    public void destroysample_action__defaultAction(obj_id player, obj_id npc)
    {
    }
    public void destroysample_action_anim_greet(obj_id player, obj_id npc)
    {
        faceToBehavior(npc, player);
        doAnimationAction(npc, "greet");
    }
    public void destroysample_action_anim_converse(obj_id player, obj_id npc)
    {
        doAnimationAction(npc, "conversation_1");
    }
    public void destroysample_action_anim_checkwatch(obj_id player, obj_id npc)
    {
        doAnimationAction(npc, "check_wrist_device");
    }
    public void destroysample_action_giveQuest(obj_id player, obj_id npc)
    {
        space_quest.grantQuest(player, "destroy", "sampleDestroy");
        doAnimationAction(npc, "standing_raise_fist");
    }
    public void destroysample_action_rewardPlayer(obj_id player, obj_id npc)
    {
        doAnimationAction(npc, "celebrate");
        money.bankTo(money.ACCT_REBEL, player, 3000);
        space_quest.setQuestRewarded(player, "destroy", "sampleDestroy");
    }
    public void destroysample_action_anim_shakeheaddisgust(obj_id player, obj_id npc)
    {
        doAnimationAction(npc, "shake_head_disgust");
    }
    public void destroysample_action_anim_wave(obj_id player, obj_id npc)
    {
        doAnimationAction(npc, "wave1");
    }
    public void destroysample_action_anim_rubchin(obj_id player, obj_id npc)
    {
