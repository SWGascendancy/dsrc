...
public class c_newbie_melee_combat_client_1 extends script.base_script
{
    ...
    public boolean c_newbie_melee_combat_client_1_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_newbie_melee_combat_client_1_condition_onTaskTalk(obj_id player, obj_id npc)
    {
        return (groundquests.isTaskActive(player, "c_newbie_melee_quest_1", "talkOtwi1"));
    }
    public boolean c_newbie_melee_combat_client_1_condition_completedTalk(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedTask(player, "c_newbie_melee_quest_1", "talkOtwi1"));
    }
    public boolean c_newbie_melee_combat_client_1_condition_completedEncounter(obj_id player, obj_id npc)
    {
        return (groundquests.hasCompletedTask(player, "c_newbie_melee_quest_1", "thugAttack"));
    }
    public void c_newbie_melee_combat_client_1_action_signalTalkedOne(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedOtwi1");
    }
    public void c_newbie_melee_combat_client_1_action_signalTalkedTwo(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "talkedOtwi2");
    }
    public int c_newbie_melee_combat_client_1_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
