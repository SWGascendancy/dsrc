...
public class corellia_tyrena_kyran_silene extends script.base_script
{
    ...
    public boolean corellia_tyrena_kyran_silene_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean corellia_tyrena_kyran_silene_condition_onTalkKyran(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_tyrena_missing_persons", "find_kyran");
    }
    public boolean corellia_tyrena_kyran_silene_condition_completedMissingPersons(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "corellia_tyrena_missing_persons");
    }
    public boolean corellia_tyrena_kyran_silene_condition_completedSlaverArc(obj_id player, obj_id npc)
    {
        return groundquests.hasCompletedQuest(player, "corellia_tyrena_return_kyran");
    }
    public boolean corellia_tyrena_kyran_silene_condition_onReturnKyran(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "corellia_tyrena_return_kyran", "slaver_return_kyran");
    }
    public void corellia_tyrena_kyran_silene_action_grantSlaverAccess(obj_id player, obj_id npc)
    {
        groundquests.grantQuest(player, "corellia_tyrena_slaver_access");
    }
    public void corellia_tyrena_kyran_silene_action_signalFindKyran(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "find_kyran");
    }
    public void corellia_tyrena_kyran_silene_action_signalReturnKyran(obj_id player, obj_id npc)
    {
        groundquests.sendSignal(player, "slaver_return_kyran");
    }
    public void corellia_tyrena_kyran_silene_action_grant38Pointer(obj_id player, obj_id npc)
    {
    ...
    public int corellia_tyrena_kyran_silene_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_kyran_silene_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_kyran_silene_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_kyran_silene_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_kyran_silene_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_kyran_silene_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_kyran_silene_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_kyran_silene_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_kyran_silene_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_kyran_silene_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_kyran_silene_handleBranch15(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_kyran_silene_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_kyran_silene_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_kyran_silene_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int corellia_tyrena_kyran_silene_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
