...
public class stormtrooper_leader_quarantine_zone extends script.base_script
{
    ...
    public boolean stormtrooper_leader_quarantine_zone_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean stormtrooper_leader_quarantine_zone_condition_hasQuestTwo(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean stormtrooper_leader_quarantine_zone_condition_hasCompletedQuestOne(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean stormtrooper_leader_quarantine_zone_condition_hasQuestOne(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public boolean stormtrooper_leader_quarantine_zone_condition_hasFoundContingent(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    ...
    public void stormtrooper_leader_quarantine_zone_action_moveAlongSound(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
        play2dNonLoopingMusic(player, "sound/voice_stormtrooper_move_along.snd");
    }
    public void stormtrooper_leader_quarantine_zone_action_warpPlayerOut(obj_id player, obj_id npc)
    {
    ...
    public int stormtrooper_leader_quarantine_zone_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int stormtrooper_leader_quarantine_zone_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int stormtrooper_leader_quarantine_zone_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int stormtrooper_leader_quarantine_zone_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int stormtrooper_leader_quarantine_zone_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int stormtrooper_leader_quarantine_zone_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int stormtrooper_leader_quarantine_zone_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int stormtrooper_leader_quarantine_zone_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
