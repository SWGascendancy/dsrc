...
public class sean_questp_market extends script.base_script
{
    ...
    public boolean sean_questp_market_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean sean_questp_market_condition_Campaign(obj_id player, obj_id npc)
    {
    ...
    public boolean sean_questp_market_condition_alreadyHasEvidence(obj_id player, obj_id npc)
    {
        return utils.playerHasItemByTemplate(player, "object/tangible/loot/quest/sean_questp_mdisk.iff");
    }
    public boolean sean_questp_market_condition_noroomObjVar(obj_id player, obj_id npc)
    {
        if (hasObjVar(npc, "bestine.electionStarted"))
        {
            int electionNum = getIntObjVar(npc, "bestine.electionStarted");
    ...
    public boolean sean_questp_market_condition_nonoffice(obj_id player, obj_id npc)
    {
        return hasObjVar(npc, "bestine.electionEnded");
    }
    public boolean sean_questp_market_condition_noInventorySpace(obj_id player, obj_id npc)
    {
    ...
    public void sean_questp_market_action_noroom(obj_id player, obj_id npc)
    {
        int electionNum = getIntObjVar(npc, "bestine.electionStarted");
        setObjVar(player, "bestine.sean_market_noroom", electionNum);
    }
    public void sean_questp_market_action_giveDisk(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "bestine.sean_market_noroom"))
        {
    ...
    public int sean_questp_market_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int sean_questp_market_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int sean_questp_market_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int sean_questp_market_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int sean_questp_market_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
