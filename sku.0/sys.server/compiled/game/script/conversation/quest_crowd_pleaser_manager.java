package script.conversation; // finch using prose.getPackage may change this later
...
public class quest_crowd_pleaser_manager extends script.base_script
{
    ...
    public boolean quest_crowd_pleaser_manager_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean quest_crowd_pleaser_manager_condition_has_entertainer(obj_id player, obj_id npc)
    {
        return utils.isProfession(player, utils.ENTERTAINER);
    }
    public boolean quest_crowd_pleaser_manager_condition_has_status_1(obj_id player, obj_id npc)
    {
    ...
    public boolean quest_crowd_pleaser_manager_condition_event_in_progress(obj_id player, obj_id npc)
    {
        return utils.hasScriptVar(npc, "quest.crowd_pleaser.performance.control");
    }
    public boolean quest_crowd_pleaser_manager_condition_has_dance_skill(obj_id player, obj_id npc)
    {
        return hasSkill(player, "class_entertainer_phase1_master");
    }
    public boolean quest_crowd_pleaser_manager_condition_has_music_skill(obj_id player, obj_id npc)
    {
        return hasSkill(player, "class_entertainer_phase1_master");
    }
    public boolean quest_crowd_pleaser_manager_condition_has_status_4(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "quest.crowd_pleaser.status"))
        {
            int status = getIntObjVar(player, "quest.crowd_pleaser.status");
    ...
    public boolean quest_crowd_pleaser_manager_condition_has_status_3(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "quest.crowd_pleaser.status"))
        {
            int status = getIntObjVar(player, "quest.crowd_pleaser.status");
    ...
    public boolean quest_crowd_pleaser_manager_condition_has_status_5(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "quest.crowd_pleaser.status"))
        {
            int status = getIntObjVar(player, "quest.crowd_pleaser.status");
    ...
    public boolean quest_crowd_pleaser_manager_condition_has_status_6(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "quest.crowd_pleaser.status"))
        {
            int status = getIntObjVar(player, "quest.crowd_pleaser.status");
    ...
    public boolean quest_crowd_pleaser_manager_condition_has_status_7(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "quest.crowd_pleaser.status"))
        {
            int status = getIntObjVar(player, "quest.crowd_pleaser.status");
    ...
    public boolean quest_crowd_pleaser_manager_condition_has_status_9(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "quest.crowd_pleaser.status"))
        {
            int status = getIntObjVar(player, "quest.crowd_pleaser.status");
    ...
    public boolean quest_crowd_pleaser_manager_condition_has_status_10(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "quest.crowd_pleaser.status"))
        {
            int status = getIntObjVar(player, "quest.crowd_pleaser.status");
    ...
    public boolean quest_crowd_pleaser_manager_condition_has_status_11(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "quest.crowd_pleaser.status"))
        {
            int status = getIntObjVar(player, "quest.crowd_pleaser.status");
    ...
    public boolean quest_crowd_pleaser_manager_condition_has_status_12(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "quest.crowd_pleaser.status"))
        {
            int status = getIntObjVar(player, "quest.crowd_pleaser.status");
    ...
    public boolean quest_crowd_pleaser_manager_condition_has_status_13(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "quest.crowd_pleaser.status"))
        {
            int status = getIntObjVar(player, "quest.crowd_pleaser.status");
    ...
    public boolean quest_crowd_pleaser_manager_condition_has_status_15(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "quest.crowd_pleaser.status"))
        {
            int status = getIntObjVar(player, "quest.crowd_pleaser.status");
    ...
    public boolean quest_crowd_pleaser_manager_condition_has_status_16(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "quest.crowd_pleaser.status"))
        {
            int status = getIntObjVar(player, "quest.crowd_pleaser.status");
    ...
    public boolean quest_crowd_pleaser_manager_condition_has_status_17(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "quest.crowd_pleaser.status"))
        {
            int status = getIntObjVar(player, "quest.crowd_pleaser.status");
    ...
    public boolean quest_crowd_pleaser_manager_condition_has_status_18(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "quest.crowd_pleaser.status"))
        {
            int status = getIntObjVar(player, "quest.crowd_pleaser.status");
    ...
    public boolean quest_crowd_pleaser_manager_condition_has_status_19(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "quest.crowd_pleaser.status"))
        {
            int status = getIntObjVar(player, "quest.crowd_pleaser.status");
    ...
    public boolean quest_crowd_pleaser_manager_condition_has_status_21(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "quest.crowd_pleaser.status"))
        {
            int status = getIntObjVar(player, "quest.crowd_pleaser.status");
    ...
    public boolean quest_crowd_pleaser_manager_condition_has_failed_recently(obj_id player, obj_id npc)
    {
    ...
    public boolean quest_crowd_pleaser_manager_condition_has_failed_audition(obj_id player, obj_id npc)
    {
    ...
    public boolean quest_crowd_pleaser_manager_condition_has_completed_both(obj_id player, obj_id npc)
    {
    ...
    public boolean quest_crowd_pleaser_manager_condition_has_completed_one(obj_id player, obj_id npc)
    {
        if (hasObjVar(player, "quest.crowd_pleaser.complete"))
        {
            return true;
    ...
    public boolean quest_crowd_pleaser_manager_condition_has_completed_music(obj_id player, obj_id npc)
    {
        if (!hasObjVar(player, "quest.crowd_pleaser.complete"))
        {
            return false;
    ...
    public boolean quest_crowd_pleaser_manager_condition_has_completed_dance(obj_id player, obj_id npc)
    {
        if (!hasObjVar(player, "quest.crowd_pleaser.complete"))
        {
            return false;
    ...
    public void quest_crowd_pleaser_manager_action_set_status_1(obj_id player, obj_id npc)
    {
        setObjVar(player, "quest.crowd_pleaser.status", 1);
    }
    public void quest_crowd_pleaser_manager_action_set_status_2(obj_id player, obj_id npc)
    {
    ...
    public void quest_crowd_pleaser_manager_action_set_music(obj_id player, obj_id npc)
    {
        setObjVar(player, "quest.crowd_pleaser.audition.type", "music");
    }
    public void quest_crowd_pleaser_manager_action_set_dance(obj_id player, obj_id npc)
    {
        setObjVar(player, "quest.crowd_pleaser.audition.type", "dance");
    }
    public void quest_crowd_pleaser_manager_action_set_status_4(obj_id player, obj_id npc)
    {
        final int PAY = 500;
    ...
    public void quest_crowd_pleaser_manager_action_set_status_5(obj_id player, obj_id npc)
    {
    ...
    public void quest_crowd_pleaser_manager_action_set_status_7(obj_id player, obj_id npc)
    {
        setObjVar(player, "quest.crowd_pleaser.status", 7);
    }
    public void quest_crowd_pleaser_manager_action_set_status_8(obj_id player, obj_id npc)
    {
        obj_id building = getTopMostContainer(npc);
        if (!isIdValid(building))
        {
    ...
    public void quest_crowd_pleaser_manager_action_set_status_10(obj_id player, obj_id npc)
    {
        final int PAY = 1000;
    ...
    public void quest_crowd_pleaser_manager_action_set_status_11(obj_id player, obj_id npc)
    {
    ...
    public void quest_crowd_pleaser_manager_action_set_status_13(obj_id player, obj_id npc)
    {
        setObjVar(player, "quest.crowd_pleaser.status", 13);
    }
    public void quest_crowd_pleaser_manager_action_set_status_14(obj_id player, obj_id npc)
    {
        obj_id building = getTopMostContainer(npc);
        if (!isIdValid(building))
        {
    ...
    public void quest_crowd_pleaser_manager_action_set_status_16(obj_id player, obj_id npc)
    {
        final int PAY = 1500;
    ...
    public void quest_crowd_pleaser_manager_action_set_status_17(obj_id player, obj_id npc)
    {
    ...
    public void quest_crowd_pleaser_manager_action_set_status_19(obj_id player, obj_id npc)
    {
        setObjVar(player, "quest.crowd_pleaser.status", 19);
    }
    public void quest_crowd_pleaser_manager_action_set_status_20(obj_id player, obj_id npc)
    {
        obj_id building = getTopMostContainer(npc);
        if (!isIdValid(building))
        {
    ...
    public void quest_crowd_pleaser_manager_action_set_completion(obj_id player, obj_id npc)
    {
        final int PAY = 2000;
        money.systemPayout(money.ACCT_CROWD_PLEASER, player, PAY, null, null);
        prose_package pp = prose.getPackage(new string_id("quest/crowd_pleaser/system_messages", "payout"), PAY);
    ...
    public void quest_crowd_pleaser_manager_action_giveMissingRewards(obj_id player, obj_id npc)
    {
    ...
    public int quest_crowd_pleaser_manager_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_crowd_pleaser_manager_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_crowd_pleaser_manager_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_crowd_pleaser_manager_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_crowd_pleaser_manager_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_crowd_pleaser_manager_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_crowd_pleaser_manager_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_crowd_pleaser_manager_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_crowd_pleaser_manager_handleBranch29(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_crowd_pleaser_manager_handleBranch30(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_crowd_pleaser_manager_handleBranch35(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_crowd_pleaser_manager_handleBranch38(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_crowd_pleaser_manager_handleBranch39(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_crowd_pleaser_manager_handleBranch40(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_crowd_pleaser_manager_handleBranch46(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_crowd_pleaser_manager_handleBranch49(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_crowd_pleaser_manager_handleBranch54(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_crowd_pleaser_manager_handleBranch55(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_crowd_pleaser_manager_handleBranch56(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_crowd_pleaser_manager_handleBranch57(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_crowd_pleaser_manager_handleBranch64(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_crowd_pleaser_manager_handleBranch65(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_crowd_pleaser_manager_handleBranch74(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_crowd_pleaser_manager_handleBranch75(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_crowd_pleaser_manager_handleBranch76(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_crowd_pleaser_manager_handleBranch80(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_39aa9593"))
        {
            if (quest_crowd_pleaser_manager_condition__defaultCondition(player, npc))
    ...
    public int quest_crowd_pleaser_manager_handleBranch83(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_crowd_pleaser_manager_handleBranch84(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_crowd_pleaser_manager_handleBranch85(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int quest_crowd_pleaser_manager_handleBranch88(obj_id player, obj_id npc, string_id response)
    {
    ...
    public String getRandomPerformanceName(obj_id player, String type)
    {
        String name = "";
        int c = 0;
        if (type == null || type.equals(""))
