...
public class coa3sharedlookout extends script.base_script
{
    ...
    public boolean coa3sharedlookout_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean coa3sharedlookout_condition_lookoutTrial1(obj_id player, obj_id npc)
    {
    ...
    public boolean coa3sharedlookout_condition_lookoutTrial2(obj_id player, obj_id npc)
    {
        if ((getObjIdObjVar(player, "coa3.imperial.missionNpcId") != npc) && (getObjIdObjVar(player, "coa3.rebel.missionNpcId") != npc))
        {
            return false;
    ...
    public boolean coa3sharedlookout_condition_lookoutTrial3(obj_id player, obj_id npc)
    {
        if ((getObjIdObjVar(player, "coa3.imperial.missionNpcId") != npc) && (getObjIdObjVar(player, "coa3.rebel.missionNpcId") != npc))
        {
            return false;
    ...
    public boolean coa3sharedlookout_condition_lookoutTrialPass(obj_id player, obj_id npc)
    {
        if ((getObjIdObjVar(player, "coa3.imperial.missionNpcId") != npc) && (getObjIdObjVar(player, "coa3.rebel.missionNpcId") != npc))
        {
            return false;
    ...
    public boolean coa3sharedlookout_condition_lookoutTrialFail(obj_id player, obj_id npc)
    {
        if ((getObjIdObjVar(player, "coa3.imperial.missionNpcId") != npc) && (getObjIdObjVar(player, "coa3.rebel.missionNpcId") != npc))
        {
            return false;
    ...
    public boolean coa3sharedlookout_condition_lookoutMissionWait(obj_id player, obj_id npc)
    {
        if ((getObjIdObjVar(player, "coa3.imperial.missionNpcId") != npc) && (getObjIdObjVar(player, "coa3.rebel.missionNpcId") != npc))
        {
            return false;
    ...
    public boolean coa3sharedlookout_condition_lookoutMissionActive(obj_id player, obj_id npc)
    {
        if ((getObjIdObjVar(player, "coa3.imperial.missionNpcId") != npc) && (getObjIdObjVar(player, "coa3.rebel.missionNpcId") != npc))
        {
            return false;
    ...
    public void coa3sharedlookout_action__defaultAction(obj_id player, obj_id npc)
    {
    }
    public void coa3sharedlookout_action_StartLikeMeterNeg(obj_id player, obj_id npc)
    {
        setObjVar(player, "coa3.lookoutLikeMeter", -1);
        setObjVar(player, "coa3.convTracker", 201);
    }
    public void coa3sharedlookout_action_StartLikeMeterPos(obj_id player, obj_id npc)
    {
        setObjVar(player, "coa3.lookoutLikeMeter", 1);
        setObjVar(player, "coa3.convTracker", 201);
    }
    public void coa3sharedlookout_action_StartLikeMeterNeut(obj_id player, obj_id npc)
    {
        setObjVar(player, "coa3.lookoutLikeMeter", 0);
        setObjVar(player, "coa3.convTracker", 201);
    }
    public void coa3sharedlookout_action_decLikeMeterTrial2(obj_id player, obj_id npc)
    {
    ...
    public void coa3sharedlookout_action_incLikeMeterTrial2(obj_id player, obj_id npc)
    {
        int likeMeter = getIntObjVar(player, "coa3.lookoutLikeMeter");
        setObjVar(player, "coa3.lookoutLikeMeter", (likeMeter + 1));
        setObjVar(player, "coa3.convTracker", 202);
    }
    public void coa3sharedlookout_action_likeMeterTrialBonus(obj_id player, obj_id npc)
    {
        int likeMeter = getIntObjVar(player, "coa3.lookoutLikeMeter");
        setObjVar(player, "coa3.lookoutLikeMeter", (likeMeter + 1));
    }
    public void coa3sharedlookout_action_neutLikeMeterTrial3(obj_id player, obj_id npc)
    {
        setObjVar(player, "coa3.convTracker", 203);
    }
    public void coa3sharedlookout_action_decLikeMeterTrial3(obj_id player, obj_id npc)
    {
        int likeMeter = getIntObjVar(player, "coa3.lookoutLikeMeter");
        setObjVar(player, "coa3.lookoutLikeMeter", (likeMeter - 1));
        setObjVar(player, "coa3.convTracker", 203);
    }
    public void coa3sharedlookout_action_incLikeMeterTrial3(obj_id player, obj_id npc)
    {
        int likeMeter = getIntObjVar(player, "coa3.lookoutLikeMeter");
        setObjVar(player, "coa3.lookoutLikeMeter", (likeMeter + 1));
        setObjVar(player, "coa3.convTracker", 203);
    }
    public void coa3sharedlookout_action_passLookoutTrial(obj_id player, obj_id npc)
    {
        removeObjVar(player, "coa3.lookoutLikeMeter");
        setObjVar(player, "coa3.convTracker", 204);
    }
    public void coa3sharedlookout_action_failLookoutTrial(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        messageTo(npc, "handleAttackPlayer", params, 0, false);
    }
    public void coa3sharedlookout_action_lookoutAcceptMission(obj_id player, obj_id npc)
    {
    ...
    public void coa3sharedlookout_action_lookoutWaitMissionAccept(obj_id player, obj_id npc)
    {
        setObjVar(player, "coa3.convTracker", 205);
    }
    public void coa3sharedlookout_action_lookoutRefreshMission(obj_id player, obj_id npc)
    {
        dictionary params = new dictionary();
        params.put("player", player);
        params.put("npc", npc);
    ...
    public void coa3sharedlookout_action_lookoutAbortMission(obj_id player, obj_id npc)
    {
        setObjVar(player, "coa3.convTracker", 205);
        dictionary params = new dictionary();
        params.put("player", player);
