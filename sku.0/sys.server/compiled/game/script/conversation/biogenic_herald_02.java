...
public class biogenic_herald_02 extends script.base_script
{
    ...
    public boolean biogenic_herald_02_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean biogenic_herald_02_condition_not_imperial(obj_id player, obj_id npc)
    {
    ...
    public void biogenic_herald_02_action__defaultAction(obj_id player, obj_id npc)
    {
    }
    public void biogenic_herald_02_action_face_to(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
