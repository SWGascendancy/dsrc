...
public class death_watch_medical_droid extends script.base_script
{
    ...
    public boolean death_watch_medical_droid_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean death_watch_medical_droid_condition_hasObjVarMedicine(obj_id player, obj_id npc)
    {
    ...
    public boolean death_watch_medical_droid_condition_noInvSpace(obj_id player, obj_id npc)
    {
    ...
    public void death_watch_medical_droid_action__defaultAction(obj_id player, obj_id npc)
    {
    }
    public void death_watch_medical_droid_action_giveMedicine(obj_id player, obj_id npc)
    {
        obj_id[] objContents = utils.getContents(player, true);
        if (objContents != null)
        {
