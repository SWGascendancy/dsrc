...
public class ep3_disabled_transport_bravo extends script.base_script
{
    ...
    public boolean ep3_disabled_transport_bravo_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_disabled_transport_bravo_condition_isTooFar(obj_id player, obj_id npc)
    {
        obj_id containingShip = space_transition.getContainingShip(player);
        return (getDistance(npc, containingShip) > space_transition.STATION_COMM_MAX_DISTANCE);
    }
    public void ep3_disabled_transport_bravo_action_playCommSound(obj_id player, obj_id npc)
    {
        space_combat.playCombatTauntSound(player);
    }
    public int ep3_disabled_transport_bravo_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_disabled_transport_bravo_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_disabled_transport_bravo_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_disabled_transport_bravo_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_disabled_transport_bravo_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_disabled_transport_bravo_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_disabled_transport_bravo_handleBranch9(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_760"))
        {
            if (ep3_disabled_transport_bravo_condition__defaultCondition(player, npc))
    ...
    public int ep3_disabled_transport_bravo_handleBranch10(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_760"))
        {
            if (ep3_disabled_transport_bravo_condition__defaultCondition(player, npc))
    ...
    public int ep3_disabled_transport_bravo_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_disabled_transport_bravo_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_744"))
        {
            if (ep3_disabled_transport_bravo_condition__defaultCondition(player, npc))
    ...
    public int ep3_disabled_transport_bravo_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_744"))
        {
            if (ep3_disabled_transport_bravo_condition__defaultCondition(player, npc))
    ...
    public int ep3_disabled_transport_bravo_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_disabled_transport_bravo_handleBranch19(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_disabled_transport_bravo_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_744"))
        {
            if (ep3_disabled_transport_bravo_condition__defaultCondition(player, npc))
    ...
    public int ep3_disabled_transport_bravo_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_disabled_transport_bravo_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_744"))
        {
            if (ep3_disabled_transport_bravo_condition__defaultCondition(player, npc))
