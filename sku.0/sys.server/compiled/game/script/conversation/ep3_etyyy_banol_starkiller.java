...
public class ep3_etyyy_banol_starkiller extends script.base_script
{
    ...
    public boolean ep3_etyyy_banol_starkiller_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_etyyy_banol_starkiller_condition_completedQuestTwo(obj_id player, obj_id npc)
    {
        return space_quest.hasWonQuest(player, "recovery", "ep3_hunting_banol_capture_fordan");
    }
    public boolean ep3_etyyy_banol_starkiller_condition_completedQuestOne(obj_id player, obj_id npc)
    {
        return space_quest.hasWonQuest(player, "assassinate", "ep3_hunting_banol_destroy_tripps_goods");
    }
    public boolean ep3_etyyy_banol_starkiller_condition_canDoBanolQuests(obj_id player, obj_id npc)
    {
        return hasObjVar(player, "ep3Etyyy.canDoBanolQuests");
    }
    public boolean ep3_etyyy_banol_starkiller_condition_isOnQuestOne(obj_id player, obj_id npc)
    {
        return space_quest.hasQuest(player, "assassinate", "ep3_hunting_banol_destroy_tripps_goods");
    }
    public boolean ep3_etyyy_banol_starkiller_condition_isOnQuestTwo(obj_id player, obj_id npc)
    {
        return space_quest.hasQuest(player, "recovery", "ep3_hunting_banol_capture_fordan");
    }
    public boolean ep3_etyyy_banol_starkiller_condition_completedBothQuests(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_etyyy_banol_starkiller_condition_failedQuestOne(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_etyyy_banol_starkiller_condition_failedQuestTwo(obj_id player, obj_id npc)
    {
    ...
    public boolean ep3_etyyy_banol_starkiller_condition_alreadyHasSpaceQuest(obj_id player, obj_id npc)
    {
        return space_quest.hasQuest(player);
    }
    public void ep3_etyyy_banol_starkiller_action_grantQuestOne(obj_id player, obj_id npc)
    {
    ...
    public void ep3_etyyy_banol_starkiller_action_grantQuestTwo(obj_id player, obj_id npc)
    {
        space_quest.clearQuestFlags(player, "assassinate", "ep3_hunting_banol_destroy_tripps_goods");
    ...
    public int ep3_etyyy_banol_starkiller_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_banol_starkiller_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_banol_starkiller_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_banol_starkiller_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_banol_starkiller_handleBranch11(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_banol_starkiller_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_banol_starkiller_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_banol_starkiller_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_etyyy_banol_starkiller_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
