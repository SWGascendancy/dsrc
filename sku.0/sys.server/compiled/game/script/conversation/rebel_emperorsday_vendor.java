...
public class rebel_emperorsday_vendor extends script.base_script
{
    ...
    public boolean rebel_emperorsday_vendor_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean rebel_emperorsday_vendor_condition_imperial(obj_id player, obj_id npc)
    {
        return factions.isImperial(player);
    }
    public void rebel_emperorsday_vendor_action_showTokenVendorUI(obj_id player, obj_id npc)
    {
