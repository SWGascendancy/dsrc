...
public class rtp_ackbar_rebel_sympathizer extends script.base_script
{
    ...
    public boolean rtp_ackbar_rebel_sympathizer_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean rtp_ackbar_rebel_sympathizer_condition_ackbarTaskActive(obj_id player, obj_id npc)
    {
        return groundquests.isTaskActive(player, "rtp_ackbar_01", "rtp_ackbar_01_01");
    }
    public void rtp_ackbar_rebel_sympathizer_action_attack(obj_id player, obj_id npc)
    {
    ...
    public int rtp_ackbar_rebel_sympathizer_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
