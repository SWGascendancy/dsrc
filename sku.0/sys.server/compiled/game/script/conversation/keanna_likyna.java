...
public class keanna_likyna extends script.base_script
{
    ...
    public boolean keanna_likyna_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean keanna_likyna_condition_Camp(obj_id player, obj_id npc)
    {
    ...
    public boolean keanna_likyna_condition_NegQ(obj_id player, obj_id npc)
    {
        if (hasObjVar(npc, "bestine.electionStarted"))
        {
            int electionNum = getIntObjVar(npc, "bestine.electionStarted");
    ...
    public boolean keanna_likyna_condition_nonoffice(obj_id player, obj_id npc)
    {
        return hasObjVar(npc, "bestine.electionEnded");
    }
    public void keanna_likyna_action__defaultAction(obj_id player, obj_id npc)
    {
    }
