...
public class static_quests_record_keeper_tatooine extends script.base_script
{
    ...
    public boolean static_quests_record_keeper_tatooine_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean static_quests_record_keeper_tatooine_condition_static_quests_on_player(obj_id player, obj_id npc)
    {
    ...
    public boolean static_quests_record_keeper_tatooine_condition_already_reset(obj_id player, obj_id npc)
    {
    ...
    public void static_quests_record_keeper_tatooine_action__defaultAction(obj_id player, obj_id npc)
    {
    }
    public void static_quests_record_keeper_tatooine_action_reset_gating(obj_id player, obj_id npc)
    {
    ...
    public void static_quests_record_keeper_tatooine_action_set_redo(obj_id player, obj_id npc)
    {
        setObjVar(player, "static_quests_reset.tatooine", true);
    ...
    public void static_quests_record_keeper_tatooine_action_face_to(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
