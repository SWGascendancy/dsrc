...
public class ep3_trando_herald extends script.base_script
{
    ...
    public boolean ep3_trando_herald_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean ep3_trando_herald_condition_isOnQuest(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/ep3_trando_herald");
        boolean onQuest = questIsQuestActive(questId1, player);
        return onQuest;
    }
    public boolean ep3_trando_herald_condition_questOver(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/ep3_trando_herald");
        boolean onQuest = questIsQuestComplete(questId1, player);
        return onQuest;
    }
    public void ep3_trando_herald_action_giveQuest(obj_id player, obj_id npc)
    {
    ...
    public void ep3_trando_herald_action_giveAnotherWp(obj_id player, obj_id npc)
    {
        if (!hasScript(player, "event.ep3_trando_herald"))
        {
            attachScript(player, "event.ep3_trando_herald");
    ...
    public int ep3_trando_herald_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trando_herald_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trando_herald_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trando_herald_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trando_herald_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trando_herald_handleBranch12(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trando_herald_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int ep3_trando_herald_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
