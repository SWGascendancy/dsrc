...
public class padawan_old_musician_02 extends script.base_script
{
    ...
    public boolean padawan_old_musician_02_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean padawan_old_musician_02_condition_isTrialPlayer(obj_id player, obj_id npc)
    {
    ...
    public void padawan_old_musician_02_action_questFailure(obj_id player, obj_id npc)
    {
        messageTo(player, "handleQuestFailure", null, 1, false);
        return;
    }
    public void padawan_old_musician_02_action_sendToThirdNpc(obj_id player, obj_id npc)
    {
        setObjVar(player, "jedi_trials.padawan_trials.temp.spokeToTarget_01", true);
        messageTo(player, "handleSetThirdLoc", null, 1, false);
        return;
    }
    public void padawan_old_musician_02_action_facePlayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int padawan_old_musician_02_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int padawan_old_musician_02_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int padawan_old_musician_02_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int padawan_old_musician_02_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int padawan_old_musician_02_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int padawan_old_musician_02_handleBranch8(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int padawan_old_musician_02_handleBranch13(obj_id player, obj_id npc, string_id response)
    {
