...
public class mtp_complaint_department extends script.base_script
{
    ...
    public boolean mtp_complaint_department_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean mtp_complaint_department_condition_hasMeatlumpMono(obj_id player, obj_id npc)
    {
    ...
    public boolean mtp_complaint_department_condition_noMeatlumpMono(obj_id player, obj_id npc)
    {
        if (!buff.hasBuff(player, "mtp_meatlump_kiss_debuff"))
        {
            return true;
    ...
    public void mtp_complaint_department_action_LumpAndMonoRebate(obj_id player, obj_id npc)
    {
    ...
    public int mtp_complaint_department_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_complaint_department_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_complaint_department_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_complaint_department_handleBranch7(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_complaint_department_handleBranch14(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_complaint_department_handleBranch16(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_complaint_department_handleBranch17(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_complaint_department_handleBranch18(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_6"))
        {
            if (mtp_complaint_department_condition__defaultCondition(player, npc))
    ...
    public int mtp_complaint_department_handleBranch20(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_complaint_department_handleBranch21(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_6"))
        {
            if (mtp_complaint_department_condition__defaultCondition(player, npc))
    ...
    public int mtp_complaint_department_handleBranch22(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_complaint_department_handleBranch23(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_complaint_department_handleBranch25(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_complaint_department_handleBranch27(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_complaint_department_handleBranch28(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int mtp_complaint_department_handleBranch32(obj_id player, obj_id npc, string_id response)
    {
        if (response.equals("s_6"))
        {
            if (mtp_complaint_department_condition__defaultCondition(player, npc))
    ...
    public int mtp_complaint_department_handleBranch33(obj_id player, obj_id npc, string_id response)
    {
