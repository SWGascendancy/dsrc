...
public class c_story1_1_doc extends script.base_script
{
    ...
    public boolean c_story1_1_doc_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean c_story1_1_doc_condition_atDocStep(obj_id player, obj_id npc)
    {
    ...
    public boolean c_story1_1_doc_condition_afterDoctorStep(obj_id player, obj_id npc)
    {
        int questId1 = questGetQuestId("quest/c_story1_1_reb");
        int questId2 = questGetQuestId("quest/c_story1_1_neu");
        int questId3 = questGetQuestId("quest/c_story1_1_imp");
    ...
    public void c_story1_1_doc_action_forwardquest(obj_id player, obj_id npc)
    {
    ...
    public void c_story1_1_doc_action_faceplayer(obj_id player, obj_id npc)
    {
        faceTo(npc, player);
    }
    public int c_story1_1_doc_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_1_doc_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_1_doc_handleBranch3(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int c_story1_1_doc_handleBranch5(obj_id player, obj_id npc, string_id response)
    {
