...
public class spawn_generation_tool extends script.base_script
{
    ...
    public int showSpawnManagerSui(obj_id self, dictionary params)
    {
        createSpawnGenerationSui(self);
        return SCRIPT_CONTINUE;
    }
    public int handleMasterListSelection(obj_id self, dictionary params)
    {
    ...
    public int handleSpawnGenerationSuiUpdate(obj_id self, dictionary params)
    {
        return SCRIPT_CONTINUE;
    }
    public int handleSetMso(obj_id self, dictionary params)
    {
    ...
    public int handleAstChoice(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
    ...
    public int handleNameNewTable(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
    ...
    public void createSpawnGenerationSui(obj_id player)
    {
        obj_id mso = null;
    ...
    public void setMasterSpawnObject(obj_id player)
    {
        String prompt = getMsoAndAstDisplayData(player);
    ...
    public void setAssociatedSpawnTable(obj_id player)
    {
        String prompt = getMsoAndAstDisplayData(player);
    ...
    public void loadExistingSpawnData(obj_id player)
    {
    }
    public void showStandardSpawnCreationSUI(obj_id player)
    {
    }
    public void showCleanSlateSpawnCreationSUI(obj_id player)
    {
    }
    public void presentNewAstSUI(obj_id player)
    {
        String prompt = getMsoAndAstDisplayData(player);
    ...
    public void presentExistingTableSui(obj_id player)
    {
    }
    public boolean createNewAssociatedSpawnTable(obj_id player, String tableName)
    {
        return true;
    }
    public obj_id[] sortAllObjectsByMasterSpawnScript(obj_id[] allObjects)
    {
    ...
    public String[] formatMsoSelectionSortedObjectList(obj_id[] allObjects)
    {
    ...
    public String getMsoAndAstDisplayData(obj_id player)
    {
        obj_id mso = null;
        String ast = NOT_ASSIGNED;
        String template = "";
