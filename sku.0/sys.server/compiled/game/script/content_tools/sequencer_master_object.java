...
public class sequencer_master_object extends script.base_script
{
    ...
    public int doEvents(obj_id self, dictionary params)
    {
    ...
    public int interruptSequence(obj_id self, dictionary params)
    {
        utils.setScriptVar(self, "intSequenceStopped", 1);
        stopSequence(self);
        return SCRIPT_CONTINUE;
    }
    public void stopSequence(obj_id self)
    {
        String strTable = "";
        String strIndexScriptVar = "";
        if (utils.hasScriptVar(self, "strSecondaryTable"))
    ...
    public float runSequenceEvents(obj_id self)
    {
        String strIndexScriptVar = "";
        String strTable = "";
        if (utils.hasScriptVar(self, "strSecondaryTable"))
    ...
    public int processEvents(dictionary dctEventToRun, int intIndex)
    {
        obj_id self = getSelf();
    ...
    public int continueMainTable(obj_id self, dictionary params)
    {
