...
public class group_member extends script.base_script
{
    ...
    public int volleyTargetDone(obj_id self, dictionary params)
    {
    ...
    public int cmdSplitCreditsWithGroup(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int handleRequestSplitShare(obj_id self, dictionary params)
    {
        if (params != null && !params.equals(""))
        {
    ...
    public int handleRequestPayoutShare(obj_id self, dictionary params)
    {
        if (params != null && !params.equals(""))
        {
            obj_id target = params.getObjId("target");
    ...
    public int handlePayoutRequest(obj_id self, dictionary params)
    {
    ...
    public int handlePayoutComplete(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleSplitSuccess(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleSplitFailure(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleSquadLeaderXpNotify(obj_id self, dictionary params)
    {
        xp.notifySquadLeaderXp(self);
        return SCRIPT_CONTINUE;
    }
    public int updateGroupWaypoint(obj_id self, dictionary params)
    {
        if (params != null)
        {
    ...
    public int missionWaypointUpdated(obj_id self, dictionary params)
    {
        if (params != null)
        {
    ...
    public int waitForMissionObjectDestruction(obj_id self, dictionary params)
    {
        if (params != null)
        {
            obj_id missionObject = params.getObjId("missionId");
    ...
    public int missionObjectDestroyed(obj_id self, dictionary params)
    {
        if (params != null)
        {
    ...
    public int destroyGroupWaypoint(obj_id self, dictionary params)
    {
        group.destroyGroupWaypoint(self);
        return SCRIPT_CONTINUE;
    }
    public int cmdGroupLootSet(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    private int groupLootSui(obj_id self)
    {
    ...
    public int handleLootOptionSelected(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public int groupLootChangedSui(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public int lootTypeReset(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
