...
public class group_object extends script.base_script
{
    ...
    public int addGroupMember(obj_id self, dictionary params)
    {
        if (params != null)
        {
    ...
    public int removeGroupMember(obj_id self, dictionary params)
    {
        if (params != null)
        {
    ...
    private location calculateNearestGroupMission(obj_id self)
    {
        location result;
        deltadictionary scriptVars = self.getScriptVars();
        if (scriptVars != null)
    ...
    public int missionLocationResponse(obj_id self, dictionary params)
    {
    ...
    private void tellMembersAboutNearestGroupMission(obj_id self, location nearestGroupMission)
    {
        if (nearestGroupMission != null)
        {
            deltadictionary scriptVars = self.getScriptVars();
    ...
    private void selectNearestGroupMission(obj_id self)
    {
        deltadictionary scriptVars = self.getScriptVars();
        if (scriptVars != null)
        {
    ...
    public int recaclulateNearestGroupWaypoint(obj_id self, dictionary params)
    {
        selectNearestGroupMission(self);
        return SCRIPT_CONTINUE;
    }
    public int removeMissionLocation(obj_id self, dictionary params)
    {
        selectNearestGroupMission(self);
        return SCRIPT_CONTINUE;
    }
