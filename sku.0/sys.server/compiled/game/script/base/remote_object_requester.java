...
public class remote_object_requester extends script.base.remote_object
{
    ...
    public int OnClusterWideDataResponse(obj_id self, String managerName, String elementNameExp, int requestId, String[] elementNameList, dictionary[] dictionaryList, int lockKey)
    {
        if (logsEnabled())
        {
    ...
    public void remoteCreate(String sceneName, String objectName, float x, float y, float z)
    {
        obj_id self = getSelf();
    ...
    public void remoteCreate(String sceneName, String objectName)
    {
        obj_id self = getSelf();
        int requestId = getClusterWideData(REMOTE_OBJECT_MANAGER, sceneName, false, self);
        utils.setScriptVar(self, getSceneNameVarName(requestId), sceneName);
    ...
    public int remoteCreate()
    {
        obj_id self = getSelf();
        return getClusterWideData(REMOTE_OBJECT_MANAGER, "*", false, self);
    }
    public String getSceneNameVarName(int requestId)
    {
        return SCENE_NAME + "." + requestId;
    }
    public String getSceneName(obj_id self, int requestId)
    {
        return utils.getStringScriptVar(self, getSceneNameVarName(requestId));
    }
    public String getObjectNameVarName(int requestId)
    {
        return OBJECT_NAME + "." + requestId;
    }
    public String getObjectName(obj_id self, int requestId)
    {
        return utils.getStringScriptVar(self, getObjectNameVarName(requestId));
    }
    public String getXVarName(int requestId)
    {
        return X + "." + requestId;
    }
    public float getX(obj_id self, int requestId)
    {
        return utils.getFloatScriptVar(self, getXVarName(requestId));
    }
    public String getYVarName(int requestId)
    {
        return Y + "." + requestId;
    }
    public float getY(obj_id self, int requestId)
    {
        return utils.getFloatScriptVar(self, getYVarName(requestId));
    }
    public String getZVarName(int requestId)
    {
        return Z + "." + requestId;
    }
    public float getZ(obj_id self, int requestId)
    {
        return utils.getFloatScriptVar(self, getZVarName(requestId));
    }
    public String getUseRandomLocationVarName(int requestId)
    {
        return USE_RANDOM_LOCATION + "." + requestId;
    }
    public boolean getUseRandomLocationVarName(obj_id self, int requestId)
    {
