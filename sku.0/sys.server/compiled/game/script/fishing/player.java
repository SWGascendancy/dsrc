...
public class player extends script.base_script
{
    ...
    public int handleFishingSui(obj_id self, dictionary params)
    {
    ...
    public int handleReelIn(obj_id self, dictionary params)
    {
    ...
    public int handleCaughtSomething(obj_id self, dictionary params)
    {
    ...
    public int handleCleanupSplash(obj_id self, dictionary params)
    {
