...
public class city_pathing_npc extends script.base_script
{
    ...
    public void executeAction(obj_id npc, int lastAction)
    {
    ...
    public int handleNextAction(obj_id self, dictionary params)
    {
        int nextAction = params.getInt("nextAction");
        executeAction(self, nextAction);
        return SCRIPT_CONTINUE;
    }
    public void doFacingAction(obj_id npc, obj_id currentStop)
    {
    ...
    public void executeAnimation(obj_id npc, obj_id currentStop)
    {
    ...
    public void pathToNext(obj_id npc, obj_id currentStop)
    {
    ...
    public void checkForFeetGluedToFloor(obj_id self)
    {
