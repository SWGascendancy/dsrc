...
public class base_wander extends script.base_script
{
	...
	public int pathRandom(obj_id self, dictionary params)
	{
	...
	public int killIt(obj_id self, dictionary params)
	{
		destroyObject(self);
		return SCRIPT_CONTINUE;
	}
	public int cleanUpChecks(obj_id self, dictionary params)
	{
