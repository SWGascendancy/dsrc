...
public class politician_event_master extends script.base_script
{
    ...
    public int getElectionDuration()
    {
    ...
    public int beginBestineElection(obj_id self, dictionary params)
    {
        int electionNum = 1;
    ...
    public int endBestineElection(obj_id self, dictionary params)
    {
        int electionNum = 1;
