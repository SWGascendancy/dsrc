...
public class politician_event_grandparent extends script.base_script
{
    ...
    public int bootStrap(obj_id self, dictionary params)
    {
    ...
    public int spawnMissingNpc(obj_id self, dictionary params)
    {
    ...
    public void updatePoliticianEventStatus(obj_id self)
    {
        deltadictionary dctScriptVars = self.getScriptVars();
    ...
    public int handlePoliticianEventStateChange(obj_id self, dictionary params)
    {
        updatePoliticianEventStatus(self);
    ...
    public int handleSetElectionWinner(obj_id self, dictionary params)
    {
    ...
    public int handleGovernorSetupRequest(obj_id self, dictionary params)
    {
    ...
    public int processGovernorDataStorageRequest(obj_id self, dictionary params)
    {
    ...
    public int handlePoliticianEventStatusRequest(obj_id self, dictionary params)
    {
        obj_id objRequester = params.getObjId("objRequester");
        deltadictionary dctScriptVars = self.getScriptVars();
        dictionary dctParams = new dictionary();
