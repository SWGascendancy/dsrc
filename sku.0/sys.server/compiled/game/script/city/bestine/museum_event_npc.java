...
public class museum_event_npc extends script.base_script
{
    ...
    public int handleCuratorSetup(obj_id self, dictionary params)
    {
    ...
    public int handleCuratorSetupResponse(obj_id self, dictionary params)
    {
    ...
    public int handleCuratorDataStorage(obj_id self, dictionary params)
    {
    ...
    public int handleMuseumEventStateChangeCuratorAlert(obj_id self, dictionary params)
    {
        clearMuseumEventObjvars(self);
        String museumEventStatus = params.getString(VARNAME_MUSEUM_STATUS);
        String museumEventWinner = params.getString(VARNAME_MUSEUM_WINNER);
    ...
    public int handleMuseumEventNpcSetup(obj_id self, dictionary params)
    {
    ...
    public int checkForMuseumBuilding(obj_id self, dictionary params)
    {
    ...
    public int handleMuseumEventStatusResponse(obj_id self, dictionary params)
    {
        clearMuseumEventObjvars(self);
        String museumEventStatus = params.getString(VARNAME_MUSEUM_STATUS);
    ...
    public void clearMuseumEventObjvars(obj_id self)
    {
        if (hasObjVar(self, "bestine.museumEventStarted"))
        {
