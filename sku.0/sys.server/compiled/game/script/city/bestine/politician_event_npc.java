...
public class politician_event_npc extends script.base_script
{
    ...
    public int handleGovernorSetup(obj_id self, dictionary params)
    {
        if (!isMob(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleGovernorSetupResponse(obj_id self, dictionary params)
    {
    ...
    public int handleGovernorDataStorage(obj_id self, dictionary params)
    {
    ...
    public int handleElectionStateChangeGovernorAlert(obj_id self, dictionary params)
    {
        clearElectionObjvars(self);
        String electionStatus = params.getString(VARNAME_ELECTION_STATUS);
    ...
    public int handlePoliticianEventNpcSetup(obj_id self, dictionary params)
    {
    ...
    public int checkForCapitolBuilding(obj_id self, dictionary params)
    {
    ...
    public int handlePoliticianEventStatusResponse(obj_id self, dictionary params)
    {
        clearElectionObjvars(self);
        String electionStatus = params.getString(VARNAME_ELECTION_STATUS);
        String electionStatusObjvar = "bestine." + electionStatus;
    ...
    public void clearElectionObjvars(obj_id self)
    {
        if (hasObjVar(self, "bestine.electionStarted"))
        {
