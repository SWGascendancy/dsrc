...
public class marketplace_spawner extends script.base_script
{
    ...
    public int spawnMarketplaceNpcs(obj_id self, dictionary params)
    {
        if (hasObjVar(self, "marketplaceSpawned"))
        {
            return SCRIPT_CONTINUE;
    ...
    private obj_id createMerchant(obj_id self, String type, location loc, int yaw, string_id merchantName){
