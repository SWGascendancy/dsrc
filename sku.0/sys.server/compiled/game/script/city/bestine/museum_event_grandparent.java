...
public class museum_event_grandparent extends script.base_script
{
    ...
    public void updateMuseumEventStatus(obj_id self)
    {
        deltadictionary dctScriptVars = self.getScriptVars();
    ...
    public int handleMuseumEventStateChange(obj_id self, dictionary params)
    {
        updateMuseumEventStatus(self);
    ...
    public int handleSetMuseumEventWinner(obj_id self, dictionary params)
    {
    ...
    public int handleCuratorSetupRequest(obj_id self, dictionary params)
    {
    ...
    public int processCuratorDataStorageRequest(obj_id self, dictionary params)
    {
    ...
    public int handleMuseumEventStatusRequest(obj_id self, dictionary params)
    {
        obj_id objRequester = params.getObjId("objRequester");
