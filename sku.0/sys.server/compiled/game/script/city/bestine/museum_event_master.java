...
public class museum_event_master extends script.base_script
{
    ...
    public int beginBestineMuseumEvent(obj_id self, dictionary params)
    {
    ...
    public int endBestineMuseumEvent(obj_id self, dictionary params)
    {
        int museumEventNum = 1;
    ...
    public void pickArtistsForEvent(obj_id self)
    {
