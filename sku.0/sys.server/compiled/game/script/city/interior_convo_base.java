...
public class interior_convo_base extends script.base_script
{
    ...
    public void spawnGuy(obj_id baseObject, String name)
    {
        switch(name){
            case "guy1":
    ...
    public void spawnConvoNpc(obj_id baseObject, float xOffset, float zOffset, String deathMsg, String objvarName)
    {
    ...
    public String getInteriorConvoArea()
    {
    ...
    public int handleGuyKilled(obj_id self, dictionary params)
    {
