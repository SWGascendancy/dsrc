...
public class st_static extends script.base_script
{
    ...
    public int OnTriggerVolumeEntered(obj_id self, String volumeName, obj_id player)
    {
    ...
    public int OnArrivedAtLocation(obj_id self, String loc)
    {
    ...
    public int rebelBreach(obj_id self, dictionary params)
    {
        if (!ai_lib.isInCombat(self))
        {
    ...
    public int playerFollow(obj_id self, dictionary params)
    {
        if (!ai_lib.isInCombat(self))
        {
    ...
    public int stopPersuit(obj_id self, dictionary params)
    {
        location homeLoc = getHomeLocation(self);
        removeObjVar(self, "ai.persistantFollowing");
        if (!ai_lib.isInCombat(self))
    ...
    public int amIStuck(obj_id self, dictionary params)
    {
    ...
    public int playerBark(obj_id self, dictionary params)
    {
        if (!ai_lib.isInCombat(self))
        {
    ...
    public int playerLoiter(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
    ...
    public int officerBreach(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
    ...
    public int removeEvent(obj_id self, dictionary params)
    {
        utils.removeScriptVar(self, "event");
        return SCRIPT_CONTINUE;
    }
