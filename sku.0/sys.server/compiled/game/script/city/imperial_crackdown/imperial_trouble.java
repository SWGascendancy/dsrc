...
public class imperial_trouble extends script.base_script
{
    ...
    public int startMoving(obj_id self, dictionary params)
    {
    ...
    public int startTrouble(obj_id self, dictionary params)
    {
    ...
    public int harassPlayer(obj_id self, dictionary params)
    {
    ...
    public int moveOver(obj_id self, dictionary params)
    {
    ...
    public int continueTrouble(obj_id self, dictionary params)
    {
    ...
    public string_id getSomethingToSay(obj_id self)
    {
        int which = rand(1, 15);
        utils.setScriptVar(self, "lastSaid", which);
        return new string_id(CONVO, "harass_" + which + "_" + getFactionName(self));
    }
    public int finishTrouble(obj_id self, dictionary params)
    {
    ...
    public int leaveCantina(obj_id self, dictionary params)
    {
        if (ai_lib.isInCombat(self))
        {
    ...
    public int handleBadLeaving(obj_id self, dictionary params)
    {
    ...
    public boolean checkForFinalFight(obj_id self)
    {
        location here = getLocation(self);
        obj_id[] players = getAllPlayers(here, 20);
        if (players == null)
    ...
    public boolean checkForPercentage(obj_id player)
    {
        boolean yesNo = true;
    ...
    public int getSmugglerPercentage(obj_id thisMember)
    {
        int chance = 90;
