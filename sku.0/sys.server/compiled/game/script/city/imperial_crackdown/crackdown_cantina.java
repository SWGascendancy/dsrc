...
public class crackdown_cantina extends script.base_script
{
    ...
    public int resetCrackDown(obj_id self, dictionary params)
    {
    ...
    public int doTroubleCheck(obj_id self, dictionary params)
    {
        removeObjVar(self, "crackdownHappened");
        if (hasObjVar(self, "crackdownHappened"))
        {
    ...
    public int createTrouble(obj_id self, dictionary params)
    {
    ...
    public int createFight(obj_id self, dictionary params)
    {
        obj_id foyer = getCellId(self, "foyer1");
    ...
    public int sendBackup(obj_id self, dictionary params)
    {
