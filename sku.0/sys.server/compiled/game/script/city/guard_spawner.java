...
public class guard_spawner extends script.base_script
{
    ...
    public int checkForStart(obj_id self, dictionary params)
    {
    ...
    public int guardSpawnerRespawnNpc(obj_id self, dictionary params)
    {
        doSpawn(self, true);
        return SCRIPT_CONTINUE;
    }
    public void doSpawn(obj_id self, boolean onlySpawnOne)
    {
    ...
    public int cityMobKilled(obj_id self, dictionary params)
    {
