...
public class live_conversions extends script.base_script
{
    ...
    public void runOncePerSessionConversions(obj_id player)
    {
    ...
    public void runOncePerTravelConversions(obj_id player)
    {
    ...
    public void setConversionFlag(obj_id player, int flag)
    {
    ...
    public boolean hasConversionFlag(obj_id player, int flag)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public void clearConversionFlag(obj_id player, int flag)
    {
        if ((!isIdValid(player)) || (flag < 0) || (flag > FLAG_MAX_BITS))
        {
            return;
    ...
    public int[] getFlags(obj_id player)
    {
    ...
    public void setFlags(obj_id player, int[] flags)
    {
    ...
    public void grantFemaleMasterPilotMedals(obj_id player)
    {
    ...
    public void createFemaleMasterMedal(obj_id player, int type)
    {
        switch (type)
        {
            case NEUTRAL:
    ...
    public void clearDotEffectObjvars(obj_id player)
    {
        removeObjVar(player, dot.VAR_DOT_ROOT);
        removeObjVar(player, "slowDotTime");
    }
    public void fixConsentList(obj_id player)
    {
    ...
    public void setUnarmedDamageRanges(obj_id player)
    {
    ...
    public void doPoliticianSkillConversion(obj_id player)
    {
    ...
    public void grantElderBuff(obj_id player)
    {
    ...
    public int handleBirthDateCallBack(obj_id self, dictionary params)
    {
        obj_id player = self;
        int myBirthDate = getPlayerBirthDate(player);
        if (myBirthDate == -1)
    ...
    public void validateSkills(obj_id player)
    {
    ...
    public void correctMasterBadges(obj_id player)
    {
    ...
    public void correctEv9D9Quest(obj_id player)
    {
    ...
    public void correctSyrenQuests(obj_id player)
    {
    ...
    public void checkForContentPathContinuation(obj_id player)
    {
    ...
    public int handleContentPathContinuation(obj_id self, dictionary params)
    {
    ...
    public void updateBountyHunterMissions(obj_id player)
    {
        messageTo(player, "informantComm", null, 10.0f, false);
        return;
    }
    public void updateChangedQuests(obj_id player)
    {
    ...
    public void correctNabooKickQuests(obj_id player)
    {
        if (isIdValid(player))
        {
            if (isPlayer(player))
    ...
    public void grantNextTraderAndEntertainerSkill(obj_id player)
    {
    ...
    public void addPlayerScripts(obj_id player)
    {
    ...
    public void updateResidencyLinks(obj_id player)
    {
    ...
    public void updateLotOverLimitStructureLocation(obj_id player)
    {
    ...
    public void updateGuildTerminals(obj_id player)
    {
    ...
    public void validateExpertises(obj_id player)
    {
        skill.validateExpertise(player);
        return;
    }
    public boolean expertiseRespecCheck(obj_id player)
    {
    ...
    public boolean updatePermanentSchematics(obj_id player)
    {
        return craftinglib.updatePermanentSchematics(player);
    }
    public int fullExpertiseReset(obj_id self, dictionary params)
    {
        utils.fullExpertiseReset(self, false);
        return SCRIPT_CONTINUE;
    }
    public void updateCollectionSlots(obj_id player)
    {
    ...
    public void updateHothFlawless(obj_id player)
    {
        if (!isIdValid(player) && !exists(player))
        {
            return;
    ...
    public void updateRenameCharacterComplete(obj_id player)
    {
        if (!isIdValid(player) || !exists(player))
        {
            return;
    ...
    public void forceRespecBasedOnConfig(obj_id player)
    {
    ...
    public boolean givePlayersDeathTroopersOutbreakQuest(obj_id player)
    {
    ...
    public boolean givePlayersDeathTroopersPrologQuestComlink(obj_id player)
    {
    ...
    public boolean removeDeprecatedQuests(obj_id player)
    {
