...
public class veteran_rewards extends script.base_script
{
    ...
    public int DoCreateVeteranReward(obj_id self, String[] rewardItemName)
    {
        utils.removeScriptVar(self, SCRIPTVAR_EVENT);
        utils.removeScriptVar(self, SCRIPTVAR_ALL_EVENTS);
        utils.removeScriptVar(self, SCRIPTVAR_ITEM);
    ...
    public int cmdClaimVeteranReward(obj_id self, obj_id target, String params, float defaultTime)
    {
        utils.removeScriptVar(self, SCRIPTVAR_EVENT);
        utils.removeScriptVar(self, SCRIPTVAR_ALL_EVENTS);
        utils.removeScriptVar(self, SCRIPTVAR_ITEM);
    ...
    public int veteranAccountFeatureIdResponse(obj_id self, dictionary params)
    {
    ...
    public boolean checkForVeteranRewards(obj_id self)
    {
        utils.removeScriptVar(self, SCRIPTVAR_EVENT);
        utils.removeScriptVar(self, SCRIPTVAR_ALL_EVENTS);
        utils.removeScriptVar(self, SCRIPTVAR_ITEM);
    ...
    public boolean isVeteranRewardsPromptTime(obj_id self)
    {
    ...
    public int handleRewardAnnouncement(obj_id self, dictionary params)
    {
    ...
    public void chooseRewardForEvent(obj_id self, String event)
    {
        utils.removeScriptVar(self, SCRIPTVAR_EVENT);
        utils.removeScriptVar(self, SCRIPTVAR_ALL_EVENTS);
        utils.removeScriptVar(self, SCRIPTVAR_ITEM);
    ...
    public int rewardSelectHandler(obj_id self, dictionary params)
    {
    ...
    public void checkForUniquenessAndClaim(obj_id self, String event, String item)
    {
        utils.removeScriptVar(self, SCRIPTVAR_EVENT);
        utils.removeScriptVar(self, SCRIPTVAR_ALL_EVENTS);
        utils.removeScriptVar(self, SCRIPTVAR_ITEM);
    ...
    public int handleUniqueConfirmation(obj_id self, dictionary params)
    {
        String event = utils.getStringScriptVar(self, SCRIPTVAR_EVENT);
    ...
    public int veteranItemGrantSucceeded(obj_id self, dictionary params)
    {
        utils.removeScriptVar(self, SCRIPTVAR_EVENT);
        utils.removeScriptVar(self, SCRIPTVAR_ALL_EVENTS);
        utils.removeScriptVar(self, SCRIPTVAR_ITEM);
    ...
    public int veteranItemGrantFailed(obj_id self, dictionary params)
    {
        utils.removeScriptVar(self, SCRIPTVAR_EVENT);
        utils.removeScriptVar(self, SCRIPTVAR_ALL_EVENTS);
        utils.removeScriptVar(self, SCRIPTVAR_ITEM);
    ...
    public int handleGrantAcknowledged(obj_id self, dictionary params)
    {
        utils.removeScriptVar(self, SCRIPTVAR_EVENT);
        utils.removeScriptVar(self, SCRIPTVAR_ALL_EVENTS);
        utils.removeScriptVar(self, SCRIPTVAR_ITEM);
    ...
    public void lockAndClaim(obj_id self, String event, String item)
    {
        utils.removeScriptVar(self, SCRIPTVAR_EVENT);
        utils.removeScriptVar(self, SCRIPTVAR_ALL_EVENTS);
        utils.removeScriptVar(self, SCRIPTVAR_ITEM);
    ...
    public boolean shouldGetVeteranRewardsMessage(obj_id player)
    {
    ...
    public void setClaimInProgress(obj_id player)
    {
    ...
    public boolean hasClaimInProgress(obj_id player)
    {
    ...
    public void clearClaimInProgress(obj_id player)
    {
        if (isIdValid(player) && exists(player))
        {
    ...
    public void setAccountFeatureIdRequestInProgress(obj_id player)
    {
        if (isIdValid(player) && exists(player))
        {
    ...
    public boolean hasAccountFeatureIdRequestInProgress(obj_id player)
    {
    ...
    public void clearAccountFeatureIdRequestInProgress(obj_id player)
    {
        if (isIdValid(player) && exists(player))
        {
    ...
    public boolean isFreeCtsPromptTime(obj_id self)
    {
    ...
    public boolean checkForFreeCts(obj_id self)
    {
    ...
    public int cmdFreeCts(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int handleFreeCtsAnnouncement(obj_id self, dictionary params)
    {
    ...
    public boolean isValidLocationForCts(obj_id self, boolean freeCts)
    {
    ...
    public int handleFreeCtsLegal(obj_id self, dictionary params)
    {
        if (!verifyFreeCtsSuiId(self, params.getInt("pageId")))
        {
            return SCRIPT_CONTINUE;
    ...
    public void freeCtsDisplayDestGalaxyChoice(obj_id self, String messageHeader)
    {
        if (!isIdValid(self) || !exists(self))
        {
            return;
    ...
    public int handleFreeCtsDestinationGalaxyChoice(obj_id self, dictionary params)
    {
        if (!verifyFreeCtsSuiId(self, params.getInt("pageId")))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleFreeCtsValidateFailCannotCreateCharacter(obj_id self, dictionary params)
    {
    ...
    public int handleFreeCtsValidateFailDestGalaxyUnavailable(obj_id self, dictionary params)
    {
        String destinationGalaxy = params.getString("destinationGalaxy");
        if ((destinationGalaxy != null) && (destinationGalaxy.length() > 0))
        {
    ...
    public int handleFreeCtsValidateFailNameValidation(obj_id self, dictionary params)
    {
        String destinationGalaxy = params.getString("destinationGalaxy");
    ...
    public void freeCtsDisplayDestCharacterNameInput(obj_id self, String destinationGalaxy, String destinationCharacterName, String reason)
    {
        if (!isIdValid(self) || !exists(self))
        {
            return;
    ...
    public int handleFreeCtsDestinationCharacerNameInput(obj_id self, dictionary params)
    {
        if (!verifyFreeCtsSuiId(self, params.getInt("pageId")))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleFreeCtsValidateSuccess(obj_id self, dictionary params)
    {
        String destinationGalaxy = params.getString("destinationGalaxy");
        String destinationCharacterName = params.getString("destinationCharacterName");
        if ((destinationGalaxy != null) && (destinationGalaxy.length() > 0) && (destinationCharacterName != null) && (destinationCharacterName.length() > 0))
    ...
    public int handleFreeCtsAreYouSure(obj_id self, dictionary params)
    {
        if (!verifyFreeCtsSuiId(self, params.getInt("pageId")))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleFreeCtsConfirmation(obj_id self, dictionary params)
    {
        if (!verifyFreeCtsSuiId(self, params.getInt("pageId")))
        {
            return SCRIPT_CONTINUE;
    ...
    public boolean verifyFreeCtsSuiId(obj_id self, int pageId)
    {
        if (!isIdValid(self) || !exists(self))
        {
            return false;
    ...
    public void setFreeCtsSuiId(obj_id self, int pageId)
    {
        if (!isIdValid(self) || !exists(self))
        {
            return;
    ...
    public int getSecondsUntilCanMakeAnotherFreeCtsRequest(obj_id self)
    {
        if (!isIdValid(self) || !exists(self))
        {
            return 0;
    ...
    public int handleRewardTradeInConfirmation(obj_id self, dictionary params)
    {
    ...
    public int initiateCtsFromItem(obj_id self, dictionary params)
    {
    ...
    public int handleCtsLegal(obj_id self, dictionary params)
    {
    ...
    public void ctsDisplayDestGalaxyChoice(obj_id self, obj_id item, String messageHeader)
    {
    ...
    public int handleCtsDestinationGalaxyChoice(obj_id self, dictionary params)
    {
        final obj_id item = verifyCtsSuiId(self, params.getInt("pageId"));
        if (!isValidId(item))
        {
    ...
    public int handleCtsValidateFailCannotCreateCharacter(obj_id self, dictionary params)
    {
    ...
    public int handleCtsValidateFailDestGalaxyUnavailable(obj_id self, dictionary params)
    {
        if (!utils.hasScriptVar(self, cts.SCRIPTVAR_CTS_ITEM_ID))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleCtsValidateFailNameValidation(obj_id self, dictionary params)
    {
        if (!utils.hasScriptVar(self, cts.SCRIPTVAR_CTS_ITEM_ID))
        {
            return SCRIPT_CONTINUE;
    ...
    public void ctsDisplayDestCharacterNameInput(obj_id self, obj_id item, String destinationGalaxy, String destinationCharacterName, String reason)
    {
        if (!isIdValid(self) || !exists(self) || !isIdValid(item) || !exists(item))
        {
            return;
    ...
    public int handleCtsDestinationCharacerNameInput(obj_id self, dictionary params)
    {
        final obj_id item = verifyCtsSuiId(self, params.getInt("pageId"));
        if (!isValidId(item))
        {
    ...
    public int handleCtsValidateSuccess(obj_id self, dictionary params)
    {
        if (!utils.hasScriptVar(self, cts.SCRIPTVAR_CTS_ITEM_ID))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleCtsAreYouSure(obj_id self, dictionary params)
    {
        final obj_id item = verifyCtsSuiId(self, params.getInt("pageId"));
        if (!isValidId(item))
        {
    ...
    public int handleCtsConfirmation(obj_id self, dictionary params)
    {
        final obj_id item = verifyCtsSuiId(self, params.getInt("pageId"));
        if (!isValidId(item))
        {
    ...
    public boolean verifyItemForCts(obj_id player, obj_id item)
    {
        if (!isValidId(player))
        {
            return false;
    ...
    public void setCtsSuiId(obj_id self, obj_id item, int pageId)
    {
        if (!isIdValid(self) || !exists(self) || !isIdValid(item) || !exists(item))
        {
            return;
    ...
    public obj_id verifyCtsSuiId(obj_id self, int pageId)
    {
        if (!isIdValid(self) || !exists(self))
        {
            return null;
    ...
    public int getSecondsUntilCanMakeAnotherCtsRequest(obj_id self)
    {
        if (!isIdValid(self) || !exists(self))
        {
            return 0;
