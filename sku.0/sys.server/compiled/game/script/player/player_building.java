...
public class player_building extends script.base_script
{
    ...
    public int OnPermissionListModify(obj_id self, obj_id player, String name, String listName, String action)
    {
    ...
    public int OnContentsLoadedForBuildingToBePacked(obj_id self, obj_id structure)
    {
    ...
    public int OnPlayerVendorCountReply(obj_id self, int count)
    {
        if (count < 0)
        {
    ...
    public int rotateFurniture(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int moveFurniture(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (hasScript(self, performance.MUSIC_HEARTBEAT_SCRIPT))
        {
            string_id message = new string_id("player_structure", "cant_move_while_entertaining");
    ...
    public int DoRestoreItemDecorationLayout(obj_id self, obj_id item, obj_id cell, location loc, boolean restoreRotation, float qw, float qx, float qy, float qz)
    {
    ...
    public int DoRestoreItemDecorationLayoutRotationOnly(obj_id self, obj_id item, float qw, float qx, float qy, float qz)
    {
    ...
    public int nameStructure(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id structure = player_structure.getStructure(self);
        if (!isIdValid(structure))
        {
    ...
    public int paWithdraw(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id structure = player_structure.getStructure(self);
    ...
    public int itemRotateRight(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int itemRotateLeft(obj_id self, obj_id target, String params, float defaultTime)
    {
        int rotateDegrees = getFurnitureRotationDegree(self);
        queueCommand(self, (-1460986552), target, "yaw " + rotateDegrees + " " + target, COMMAND_PRIORITY_DEFAULT);
        return SCRIPT_CONTINUE;
    }
    public int itemRotateForward(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int itemRotateBackward(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (player_structure.canRotateFurnitureInPitchRollAxes(self) || isGod(self))
        {
            int rotateDegrees = getFurnitureRotationDegree(self);
    ...
    public int itemRotateClockwise(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (player_structure.canRotateFurnitureInPitchRollAxes(self) || isGod(self))
        {
            int rotateDegrees = getFurnitureRotationDegree(self);
    ...
    public int itemRotateCounterclockwise(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (player_structure.canRotateFurnitureInPitchRollAxes(self) || isGod(self))
        {
            int rotateDegrees = getFurnitureRotationDegree(self);
    ...
    public int itemRotateRandom(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (player_structure.canRotateFurnitureInPitchRollAxes(self) || isGod(self))
        {
    ...
    public int itemRotateRandomYaw(obj_id self, obj_id target, String params, float defaultTime)
    {
        queueCommand(self, (-1460986552), target, "yaw random " + target, COMMAND_PRIORITY_DEFAULT);
        return SCRIPT_CONTINUE;
    }
    public int itemRotateRandomPitch(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (player_structure.canRotateFurnitureInPitchRollAxes(self) || isGod(self))
        {
    ...
    public int itemRotateRandomRoll(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (player_structure.canRotateFurnitureInPitchRollAxes(self) || isGod(self))
        {
    ...
    public int itemRotateReset(obj_id self, obj_id target, String params, float defaultTime)
    {
        queueCommand(self, (-1460986552), target, "reset " + target, COMMAND_PRIORITY_DEFAULT);
        return SCRIPT_CONTINUE;
    }
    public int itemRotateCopy(obj_id self, obj_id target, String params, float defaultTime)
    {
        queueCommand(self, (-1460986552), target, "copy " + target, COMMAND_PRIORITY_DEFAULT);
        return SCRIPT_CONTINUE;
    }
    public int itemMoveForward(obj_id self, obj_id target, String params, float defaultTime)
    {
        queueCommand(self, (1265935363), target, "forward 10 " + target, COMMAND_PRIORITY_DEFAULT);
        return SCRIPT_CONTINUE;
    }
    public int itemMoveBack(obj_id self, obj_id target, String params, float defaultTime)
    {
        queueCommand(self, (1265935363), target, "back 10 " + target, COMMAND_PRIORITY_DEFAULT);
        return SCRIPT_CONTINUE;
    }
    public int itemMoveLeft(obj_id self, obj_id target, String params, float defaultTime)
    {
        queueCommand(self, (1265935363), target, "left 10 " + target, COMMAND_PRIORITY_DEFAULT);
        return SCRIPT_CONTINUE;
    }
    public int itemMoveRight(obj_id self, obj_id target, String params, float defaultTime)
    {
        queueCommand(self, (1265935363), target, "right 10 " + target, COMMAND_PRIORITY_DEFAULT);
        return SCRIPT_CONTINUE;
    }
    public int itemMoveUp(obj_id self, obj_id target, String params, float defaultTime)
    {
        queueCommand(self, (1265935363), target, "up 1 " + target, COMMAND_PRIORITY_DEFAULT);
        return SCRIPT_CONTINUE;
    }
    public int itemMoveDown(obj_id self, obj_id target, String params, float defaultTime)
    {
        queueCommand(self, (1265935363), target, "down 1 " + target, COMMAND_PRIORITY_DEFAULT);
        return SCRIPT_CONTINUE;
    }
    public int itemMoveCopyLocation(obj_id self, obj_id target, String params, float defaultTime)
    {
        queueCommand(self, (1265935363), target, "copy location " + target, COMMAND_PRIORITY_DEFAULT);
        return SCRIPT_CONTINUE;
    }
    public int itemMoveCopyHeight(obj_id self, obj_id target, String params, float defaultTime)
    {
        queueCommand(self, (1265935363), target, "copy height " + target, COMMAND_PRIORITY_DEFAULT);
        return SCRIPT_CONTINUE;
    }
    public int cmdAddPower(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int assignDroid(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id structure = player_structure.getStructure(self);
        if (!isIdValid(structure))
        {
    ...
    public int cmdDepositPowerIncubator(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id player = self;
    ...
    public int cmdRemovePowerIncubator(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id player = self;
        obj_id station = target;
        if (!incubator.validateActiveUser(station, player))
    ...
    public int placeStructureMode(obj_id self, obj_id target, String params, float defaultTime)
    {
        player_structure.tryEnterPlacementMode(target, self);
        return SCRIPT_CONTINUE;
    }
    public int failPlaceStructureMode(obj_id self, obj_id target, String params, float defaultTime)
    {
        LOG("LOG_CHANNEL", "player_building::failPlaceStructureMode");
        sendSystemMessage(self, SID_WRONG_STATE);
        return SCRIPT_CONTINUE;
    }
    public int setPermission(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int structureStatus(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int payMaintenance(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id structure = null;
        if (isIdValid(target))
        {
        ...
        {
            LOG("LOG_CHANNEL", "The amount must be between 1 and " + MAX_DEPOSIT);
    ...
    public int declareResidence(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id structure = player_structure.getStructure(self);
        if (!isIdValid(structure))
        {
    ...
    public int transferStructure(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id structure = player_structure.getStructure(self);
        if (!isIdValid(structure))
        {
    ...
    public int destroyStructure(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int createVendor(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int handleSaveDecorationLayout(obj_id self, dictionary params)
    {
    ...
    public int handleSelectSaveDecorationLayout(obj_id self, dictionary params)
    {
        if (!utils.hasScriptVar(self, SCRIPTVAR_SAVE_RESTORE_DECORATION_SUI_ID))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleConfirmOverwriteSaveDecorationLayout(obj_id self, dictionary params)
    {
        if (!utils.hasScriptVar(self, SCRIPTVAR_SAVE_RESTORE_DECORATION_SUI_ID))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleSaveDecorationLayoutEnterDescription(obj_id self, dictionary params)
    {
        if (!utils.hasScriptVar(self, SCRIPTVAR_SAVE_RESTORE_DECORATION_SUI_ID))
        {
            return SCRIPT_CONTINUE;
    ...
    public void displayRestoreDecorationRoomMapping(obj_id player, String[] savedRooms, String[] targetRooms, int saveSlotId)
    {
    ...
    public int handleRestoreDecorationLayout(obj_id self, dictionary params)
    {
        if (utils.hasScriptVar(self, SCRIPTVAR_SAVE_RESTORE_DECORATION_SUI_ID))
        {
            int savedPageId = utils.getIntScriptVar(self, SCRIPTVAR_SAVE_RESTORE_DECORATION_SUI_ID);
    ...
    public int handleSelectRestoreDecorationLayout(obj_id self, dictionary params)
    {
        if (!utils.hasScriptVar(self, SCRIPTVAR_SAVE_RESTORE_DECORATION_SUI_ID))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleSelectRestoreDecorationRoomMapping(obj_id self, dictionary params)
    {
        if (!utils.hasScriptVar(self, SCRIPTVAR_SAVE_RESTORE_DECORATION_SUI_ID))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleRestoreDecorationReturnToRoomMapping(obj_id self, dictionary params)
    {
        if (!utils.hasScriptVar(self, SCRIPTVAR_SAVE_RESTORE_DECORATION_SUI_ID))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleSelectRestoreDecorationTargetRoom(obj_id self, dictionary params)
    {
        if (!utils.hasScriptVar(self, SCRIPTVAR_SAVE_RESTORE_DECORATION_SUI_ID))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleVendorTypeSelect(obj_id self, dictionary params)
    {
    ...
    public int handleTerminalDesignSelect(obj_id self, dictionary params)
    {
        int idx = sui.getListboxSelectedRow(params);
        if (idx < 0)
        {
    ...
    public int handleDroidModelSelect(obj_id self, dictionary params)
    {
        int idx = sui.getListboxSelectedRow(params);
        if (idx < 0)
        {
    ...
    public int handleVendorRaceSelect(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            removeVendorVars(self);
    ...
    public int handleVendorGenderSelect(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            removeVendorVars(self);
    ...
    public int handleSetVendorName(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            removeVendorVars(self);
    ...
    public int buildVendor(obj_id self, dictionary params)
    {
        obj_id player = self;
    ...
    public int msgAssignDroid(obj_id self, dictionary params)
    {
    ...
    public int turnstileExpire(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int msgEnterPermissions(obj_id self, dictionary params)
    {
    ...
    public int msgBanPermissions(obj_id self, dictionary params)
    {
    ...
    public int msgAdminPermissions(obj_id self, dictionary params)
    {
    ...
    public int msgVendorPermissions(obj_id self, dictionary params)
    {
    ...
    public int msgHopperPermissions(obj_id self, dictionary params)
    {
    ...
    public int msgPayMaintenance(obj_id self, dictionary params)
    {
    ...
    public int msgAddPower(obj_id self, dictionary params)
    {
    ...
    public int msgDepositPowerIncubator(obj_id self, dictionary params)
    {
    ...
    public int msgWithdrawMaintenance(obj_id self, dictionary params)
    {
    ...
    public int msgNameStructure(obj_id self, dictionary params)
    {
    ...
    public int OnAddStructure(obj_id self, dictionary params)
    {
    ...
    public int OnRemoveStructure(obj_id self, dictionary params)
    {
    ...
    public int handleAdjustLotCount(obj_id self, dictionary params)
    {
        int numLots = params.getInt("lotAdjust");
        adjustLotCount(getPlayerObject(self), numLots);
        return SCRIPT_CONTINUE;
    }
    public int OnClearConfirmDestroy(obj_id self, dictionary params)
    {
    ...
    public int OnConstructionComplete(obj_id self, dictionary params)
    {
    ...
    public int msgPAWithdrawSuccess(obj_id self, dictionary params)
    {
        if (params != null)
        {
    ...
    public int msgPAWithdrawFail(obj_id self, dictionary params)
    {
        sendSystemMessage(self, new string_id(STF, "withdrawal_failed"));
        return SCRIPT_CONTINUE;
    }
    public int handleStatusUi(obj_id self, dictionary params)
    {
    ...
    public int handleDestroyUi(obj_id self, dictionary params)
    {
    ...
    public int handleDestroyConfirm(obj_id self, dictionary params)
    {
        utils.removeScriptVar(self, "player_structure.destroy.pid");
        int bp = sui.getIntButtonPressed(params);
    ...
    public int handleDestroyBarnAndBeastsConfirm(obj_id self, dictionary params)
    {
        return SCRIPT_CONTINUE;
    }
    public int handlePlayerStructurePackupLockout(obj_id self, dictionary params)
    {
    ...
    public int handlePlayerStructurePackupLockoutRemoval(obj_id self, dictionary params)
    {
        utils.removeScriptVarTree(self, player_structure.SCRIPTVAR_HOUSE_PACKUP_TREE_PREFIX);
        return SCRIPT_CONTINUE;
    }
    public int handleFailedStructurePackup(obj_id self, dictionary params)
    {
    ...
    public int callAirStrikePackAbandonedStructure(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            messageTo(self, "handlePlayerStructurePackupLockoutRemoval", null, 0, false);
    ...
    public int msgConfirmHousePackup(obj_id self, dictionary params)
    {
    ...
    public int msgFinalizePackup(obj_id self, dictionary params)
    {
        obj_id structure = params.getObjId("structure");
        if (!isIdValid(structure))
        {
    ...
    public int packUpCityAbandonedStructure(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public int msgConfirmVendorPackup(obj_id self, dictionary params)
    {
    ...
    public int getVendorInfoForPlayerRsp(obj_id self, dictionary params)
    {
    ...
    public boolean isMoveCommandValid(obj_id player, obj_id target)
    {
    ...
    public String getCellName(obj_id building, obj_id cell)
    {
    ...
    public boolean canPlaceCivic(obj_id player, obj_id deed, location position, String template)
    {
    ...
    public boolean canPlaceUnique(obj_id player, obj_id deed, location position, String template)
    {
        int city_id = getCityAtLocation(position, 0);
        if (!cityExists(city_id))
        {
    ...
    public boolean confirmDestroyTarget(obj_id structure, obj_id target)
    {
        obj_id self = getSelf();
        if (!isIdValid(target))
        {
    ...
    public boolean isFactionBaseEmpty(obj_id base, obj_id player)
    {
    ...
    public boolean removeVendorVars(obj_id self)
    {
    ...
    public boolean handleVendorTypeSelect(obj_id self)
    {
        if (!isValidId(self) || !exists(self))
        {
            return false;
    ...
    public boolean validateVendorPlacement(obj_id self)
    {
        if (!isValidId(self) || !exists(self))
        {
            return false;
    ...
    public String[] getSpecialVendors(obj_id self, int hireMod)
    {
        if (!isValidId(self) || !exists(self))
        {
            return null;
