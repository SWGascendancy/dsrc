...
public class player_money extends script.base_script
{
    ...
    public int handlePayDeposit(obj_id self, dictionary params)
    {
    ...
    public int handlePayPass(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handlePayFail(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public int acctToPass(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public int withdrawPass(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleCovertDepositReturn(obj_id self, dictionary params)
    {
    ...
    public int finishClear(obj_id self, dictionary params)
    {
        return SCRIPT_CONTINUE;
    }
    public int handleDepositWithdraw(obj_id self, dictionary params)
    {
    ...
    public int handleBankUnknownError(obj_id self, dictionary params)
    {
        money.bankError(self);
        return SCRIPT_CONTINUE;
    }
    public int handleBankWithdrawError(obj_id self, dictionary params)
    {
        money.bankWithdrawError(self);
        return SCRIPT_CONTINUE;
    }
    public int handleBankDepositError(obj_id self, dictionary params)
    {
    ...
    public int handleCashTransferError(obj_id self, dictionary params)
    {
        money.cashTransferError(self);
        return SCRIPT_CONTINUE;
    }
    public int handleCovertTransactionPass(obj_id self, dictionary params)
    {
    ...
    public int handleCovertTransactionFail(obj_id self, dictionary params)
    {
    ...
    public int handlePaymentRequest(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
