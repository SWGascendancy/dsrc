...
public class player_guild extends script.base_script
{
    ...
    public int cmdGuildNotify(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int toggleGuildNotifyMessage(obj_id self, dictionary params)
    {
    ...
    public int cmdGuildremove(obj_id self, obj_id target, String params, float defaultTime)
    {
        int guildId = getGuildId(self);
    ...
    public int cmdGuildstatus(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdGuildShow(obj_id self, obj_id target, String params, float defaultTime)
    {
        int guildId = getGuildId(self);
    ...
    public int cmdGuildShowAlpha(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (guild.hasWindowPid(self))
        {
            int pid = guild.getWindowPid(self);
    ...
    public int cmdGuildShowTitle(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (guild.hasWindowPid(self))
        {
            int pid = guild.getWindowPid(self);
    ...
    public int cmdGuildShowPermission(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (guild.hasWindowPid(self))
        {
            int pid = guild.getWindowPid(self);
    ...
    public int cmdGuildShowName(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (guild.hasWindowPid(self))
        {
            int pid = guild.getWindowPid(self);
    ...
    public int cmdGuildInfo(obj_id self, obj_id target, String params, float defaultTime)
    {
        int guildId = getGuildId(self);
        if (guildId != 0)
        {
    ...
    public int cmdGuildSponsor(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (guild.hasWindowPid(self))
        {
            int pid = guild.getWindowPid(self);
    ...
    public int cmdGuildChangeName(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (guild.hasWindowPid(self))
        {
            int pid = guild.getWindowPid(self);
    ...
    public int cmdGuildDisband(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (guild.hasWindowPid(self))
        {
            int pid = guild.getWindowPid(self);
    ...
    public int startGuildSponsorSui(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int guildSponsorSuiDone(obj_id self, dictionary params)
    {
        obj_id target = self;
    ...
    public int onGuildSponsorVerifyResponseProse(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int onGuildSponsorVerifyResponse(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int onGuildPermissionsResponse(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
        ...
        if (bp == sui.BP_OK)
        {
            if (row >= 0 && row <= 10 && guildGetLeader(guildId) == player)
            {
                ...
                {
                    guild.togglePermission(guildId, player, target, guild.GUILD_PERMISSION_WAR_EXCLUSION_GROUND);
                }
                else if (row == 10)
                {
                    guild.togglePermission(guildId, player, target, guild.GUILD_PERMISSION_WAR_INCLUSION_GROUND);
                }
            ...
            else 
            {
                if (row == 0)
                {
                    guild.togglePersonalPermission(guildId, player, target, guild.GUILD_PERMISSION_WAR_EXCLUSION_GROUND);
                }
            }
        }
    ...
    public int selectPermissionsMessage(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        ...
        if (leader == player || isGod(player))
        {
            ...
            if (guild.hasGuildPermission(guildId, target, guild.GUILD_PERMISSION_WAR_EXCLUSION_GROUND))
            {
                perms[9] = "+ " + localize(guild.SID_GUILD_PERMISSION_WAR_EXCLUDE_GROUND);
            }
            else 
            {
                perms[9] = "- " + localize(guild.SID_GUILD_PERMISSION_WAR_EXCLUDE_GROUND);
            }
            if (guild.hasGuildPermission(guildId, target, guild.GUILD_PERMISSION_WAR_INCLUSION_GROUND))
            {
                perms[10] = "+ " + localize(guild.SID_GUILD_PERMISSION_WAR_INCLUDE_GROUND);
            }
            else 
            {
                perms[10] = "- " + localize(guild.SID_GUILD_PERMISSION_WAR_INCLUDE_GROUND);
        ...
        else 
        {
            if (player == target)
            {
                ...
                if (guild.hasGuildPermission(guildId, target, guild.GUILD_PERMISSION_WAR_EXCLUSION_GROUND))
                {
                    perms[0] = "+ " + localize(guild.SID_GUILD_PERMISSION_WAR_EXCLUDE_GROUND);
                }
                else 
                {
                    perms[0] = "- " + localize(guild.SID_GUILD_PERMISSION_WAR_EXCLUDE_GROUND);
    ...
    public int onGuildMembersResponse(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        if (!guild.hasWindowPid(player))
        {
    ...
    public int onGuildMemberOptionsResponse(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        ...
        if (sui.getIntButtonPressed(params) == sui.BP_OK)
        {
            ...
            if (row >= 0 && row < entries.length)
            {
                ...
                else if (entries[row].equals(guild.STR_GUILD_WAR_EXCLUDE_TOGGLE))
                {
                    ...
                    params.put("warExclusion", guild.hasGuildPermission(guildId, target, guild.GUILD_PERMISSION_WAR_EXCLUSION_GROUND));
                ...
                else if (entries[row].equals(guild.STR_GUILD_WAR_INCLUDE_TOGGLE))
                {
                    ...
                    params.put("warInclusion", guild.hasGuildPermission(guildId, target, guild.GUILD_PERMISSION_WAR_INCLUSION_GROUND));
                    params.put("player", player);
                    params.put("guildMemberName", name);
                    params.put("guildId", guildId);
                    params.put("counter", 0);
    ...
    public int delayWarExcludeConsistencyCheck(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        ...
        if (guild.hasGuildPermission(guildId, memberId, guild.GUILD_PERMISSION_WAR_EXCLUSION_GROUND) == warExclusion && counter < 10)
        {
            counter++;
    ...
    public int delayWarIncludeConsistencyCheck(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        String name = params.getString("guildMemberName");
        int guildId = params.getInt("guildId");
        ...
        if (guild.hasGuildPermission(guildId, memberId, guild.GUILD_PERMISSION_WAR_INCLUSION_GROUND) == warInclusion && counter < 10)
        {
            counter++;
            params.put("counter", counter);
            messageTo(self, "delayWarIncludeConsistencyCheck", params, 1, false);
    ...
    public int onGuildRankSummaryResponse(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        int guildId = utils.getIntScriptVar(self, "guildId");
        if (!guild.hasWindowPid(self))
    ...
    public int onGuildRankListResponse(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        int guildId = utils.getIntScriptVar(self, "guildId");
    ...
    public int onRankOptionsResponse(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        String name = utils.getStringScriptVar(self, "guildMemberName");
        int guildId = utils.getIntScriptVar(self, "guildId");
    ...
    public int delayRankConsistencyCheck(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        String name = params.getString("guildMemberName");
        int guildId = params.getInt("guildId");
    ...
    public int selectRankMessage(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        String name = params.getString("guildMemberName");
        int guildId = params.getInt("guildId");
    ...
    public int onGuildPermissionListResponse(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        int guildId = utils.getIntScriptVar(self, "guildId");
        obj_id[] members = utils.getObjIdArrayScriptVar(player, "guild.memberIds");
    ...
    public int onGuildVotingResponse(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        int guildId = utils.getIntScriptVar(self, "guildId");
    ...
    public int votingConsistencyCheck(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        int guildId = params.getInt("guildId");
    ...
    public int permissionsChangeSuiHandler(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int onGuildKickResponse(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        String name = "";
        if (!guild.hasWindowPid(player))
    ...
    public int onGuildTitleResponse(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
    ...
    public int onGuildMembersFilter(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int onGuildMembersPermissionsResponse(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int onGuildMembersTitlesResponse(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int onGuildMemberNameResponse(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int onGuildEnemiesResponse(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        if (!guild.hasWindowPid(player))
        {
    ...
    public int onGuildWarEnemyNameResponse(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        if (!guild.hasWindowPid(player))
        {
    ...
    public int showGuildEnemiesMessage(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int showGuildSponsoredMessage(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        if (guild.hasWindowPid(player))
        {
    ...
    public int onGuildSponsoredResponse(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        if (!guild.hasWindowPid(player))
        {
    ...
    public int onGuildSponsoredOptionsResponse(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        if (!guild.hasWindowPid(player))
        {
    ...
    public int onGuildNamechangeNameResponse(obj_id self, dictionary params)
    {
        if (!guild.hasWindowPid(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int onGuildNamechangeAbbrevResponse(obj_id self, dictionary params)
    {
        if (!guild.hasWindowPid(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int onGuildSponsorResponse(obj_id self, dictionary params)
    {
        if (!guild.hasWindowPid(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int onGuildDisbandResponse(obj_id self, dictionary params)
    {
        if (!guild.hasWindowPid(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int onMasterGuildWarTableDictionaryResponse(obj_id self, dictionary params)
    {
        guild.closedMasterGuildWarTableDictionary(self);
        return SCRIPT_CONTINUE;
    }
    public int onInactiveGuildWarTableDictionaryResponse(obj_id self, dictionary params)
    {
        guild.closedInactiveGuildWarTableDictionary(self);
        return SCRIPT_CONTINUE;
    }
    public int handleStatusUpdate(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleStatusNotification(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleGuildGcwRegionDefenderChoice(obj_id self, dictionary params)
    {
