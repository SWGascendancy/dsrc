...
public class player_slicing extends script.base_script
{
    ...
    public int handleSlicingCategory(obj_id self, dictionary params)
    {
    ...
    public int handleSlicingSelect(obj_id self, dictionary params)
    {
        int idx = sui.getListboxSelectedRow(params);
        if (idx < 0)
        {
    ...
    public int handleApplySlice(obj_id self, dictionary params)
    {
        int idx = sui.getListboxSelectedRow(params);
        if (idx < 0)
        {
