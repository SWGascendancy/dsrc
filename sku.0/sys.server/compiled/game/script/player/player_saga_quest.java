...
public class player_saga_quest extends script.base_script
{
    ...
    public int handleChroniclesTermsOfService(obj_id self, dictionary params)
    {
    ...
    public int handleChroniclesReserveReminder(obj_id self, dictionary params)
    {
    ...
    public int handleChronicleProfessionGranted(obj_id self, dictionary params)
    {
    ...
    public int checkForMissedRoadmapRewards(obj_id self, dictionary params)
    {
        String[] chronicleSkills = skill_template.getSkillTemplateSkillsByTemplateName(pgc_quests.PGC_CHRONICLES_XP_TYPE);
        if (chronicleSkills != null && chronicleSkills.length > 0)
        {
    ...
    public int OnCreateSaga(obj_id self, dictionary params)
    {
    ...
    public int handleSharedPgcHolocronOffer(obj_id self, dictionary params)
    {
        if (params != null && !params.isEmpty())
        {
    ...
    public int handleSharedChroniclesQuestResponse(obj_id self, dictionary params)
    {
        if (params != null && !params.isEmpty())
        {
    ...
    public void showSharedHolocronCreationCountdownUi(obj_id creator, obj_id sharedTo, dictionary taskDictionary, String menuString)
    {
    ...
    public int handleSharedPgcHolocronCreation(obj_id self, dictionary params)
    {
        if (params != null && !params.isEmpty())
        {
    ...
    public int handlePgcHolocronCreation(obj_id self, dictionary params)
    {
        if (params != null && !params.isEmpty())
        {
    ...
    public void showHolocronCreationCountdownUi(obj_id player, dictionary taskDictionary, String menuString)
    {
        boolean isRecipe = false;
        if (taskDictionary.containsKey("recipe"))
        {
    ...
    public int handlePgcHolocronCreationCountdownTimer(obj_id self, dictionary params)
    {
    ...
    public boolean createChronicleQuestObject(obj_id self, dictionary taskDictionary)
    {
        if (taskDictionary == null || taskDictionary.isEmpty())
        {
            return false;
    ...
    public int handleCheckForGainedChroniclesLevelDelay(obj_id self, dictionary params)
    {
    ...
    public int recivedGcwCreditForKill(obj_id self, dictionary params)
    {
        obj_id[] activeHolocrons = pgc_quests.getActivateQuestHolocrons(self);
        if (activeHolocrons != null && activeHolocrons.length > 0)
        {
    ...
    public int startPerform(obj_id self, dictionary params)
    {
        obj_id[] activeHolocrons = pgc_quests.getActivateQuestHolocrons(self);
        if (activeHolocrons != null && activeHolocrons.length > 0)
        {
    ...
    public int stopPerform(obj_id self, dictionary params)
    {
        obj_id[] activeHolocrons = pgc_quests.getActivateQuestHolocrons(self);
        if (activeHolocrons != null && activeHolocrons.length > 0)
        {
    ...
    public int OnCraftedPrototype(obj_id self, obj_id prototypeObject, draft_schematic manufacturingSchematic)
    {
        obj_id[] activeHolocrons = pgc_quests.getActivateQuestHolocrons(self);
        if (activeHolocrons != null && activeHolocrons.length > 0)
        {
    ...
    public int playerQuestSetLocationTarget(obj_id self, dictionary params)
    {
    ...
    public int playerQuestRemoveLocationTarget(obj_id self, dictionary params)
    {
