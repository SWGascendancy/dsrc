...
public class base_player extends script.base_script
{
    ...
    public int OnCustomizeFinished(obj_id self, obj_id object, String params)
    {
    ...
    public int OnSkillAboutToBeRevoked(obj_id self, String skill)
    {
    ...
    public int OnCombatLevelChanged(obj_id self, int oldCombatLevel, int newCombatLevel)
    {
    ...
    public int updateGCWStanding(obj_id self, dictionary params)
    {
        int intScore = params.getInt("intScore");
        gcw.checkAndUpdateGCWStanding(self, intScore);
        return SCRIPT_CONTINUE;
    }
    public int OnSkillRevoked(obj_id self, String strSkill)
    {
    ...
    public int OnInitialize(obj_id self)
    {
        ...
        if (hasSkill(self, "jedi_padawan_novice") && !isGod(self))
        {
        ...
        //givePublishGift(self); // finch commented out like method
    ...
    public int handleRetireWarning(obj_id self, dictionary params)
    {
    ...
    public int OnPvpRankingChanged(obj_id self, int oldRank, int newRank)
    {
        String faction = "";
    ...
    public int OnEnvironmentalDeath(obj_id self)
    {
    ...
    public int OnAboutToBeIncapacitated(obj_id self, obj_id killer)
    {
    ...
    public void clearAllAiEnemyFlags(obj_id self)
    {
    ...
    public int recapacitationDelay(obj_id self, dictionary params)
    {
    ...
    public int requestMissionLocations(obj_id self, dictionary params)
    {
    ...
    public int OnAddedToGroup(obj_id self, obj_id groupId)
    {
    ...
    public int OnRemovedFromGroup(obj_id self, obj_id groupId)
    {
    ...
    public int OnGroupLeaderChanged(obj_id self, obj_id groupId, obj_id newLeader, obj_id oldLeader)
    {
        return SCRIPT_CONTINUE;
    }
    ...
    public int OnMadeAuthoritative(obj_id self)
    {
    ...
    public int OnLogin(obj_id self)
    {
        if (!utils.hasScriptVar(self, "galaxyMessage.showmessage"))
        {
            ...
            if (!isIdNull(planetId))
            {
                ...
                {
                    String strGalaxyMessage = "\\#FF0000" + "Welcome to SWG Ascendancy" + "\\#FFFFFF";
                    sendConsoleMessage(self, strGalaxyMessage);
                }
            }
        }
    ...
    public int disconnectPlayerCtsCompletedOrInProgress(obj_id self, dictionary params)
    {
        setObjVar(self, "safeLogout", 1);
        disconnectPlayer(self);
        return SCRIPT_CONTINUE;
    }
    public int ctsCompletedForCharacter(obj_id self, dictionary params)
    {
    ...
    public int applyJediStance(obj_id self, dictionary params)
    {
    ...
    public int applySmugglingBonuses(obj_id self, dictionary params)
    {
        removeSmugglingBuffs(self);
        messageTo(self, "addSmugglingBuffs", null, 1.0f, false);
        return SCRIPT_CONTINUE;
    }
    public int addSmugglingBuffs(obj_id self, dictionary params)
    {
    ...
    public int recalcWeaponRange(obj_id self, dictionary params)
    {
        obj_id tempWeapon = getObjectInSlot(self, "hold_r");
        if (isIdValid(tempWeapon))
        {
    ...
    public void removeSmugglingBuffs(obj_id who)
    {
    ...
    public int removeSmugglingBonuses(obj_id self, dictionary params)
    {
        removeSmugglingBuffs(self);
        return SCRIPT_CONTINUE;
    }
    public int handlerRemoveGroupBuffEffect(obj_id self, dictionary params)
    {
    ...
    public int OnCSCreateItem(obj_id self, obj_id container, String staticItemName)
    {
        gmlib.generateStaticItem(container, staticItemName);
        return SCRIPT_CONTINUE;
    }
    public int delayRespecInstructions(obj_id self, dictionary params)
    {
    ...
    public int OnRemovingFromWorld(obj_id self)
    {
        removeObjVar(self, "conversation");
        return SCRIPT_CONTINUE;
    }
    public int handleLoginLocResolved(obj_id self, dictionary params)
    {
    ...
    public int handleStatProfileSUI(obj_id self, dictionary params)
    {
    ...
    public int OnImmediateLogout(obj_id self)
    {
    ...
    public int OnTransferred(obj_id self, obj_id src, obj_id dest, obj_id transferer)
    {
    ...
    public int handleEjection(obj_id self, dictionary params)
    {
        obj_id sender = null;
        if (params == null || params.isEmpty())
        {
    ...
    public int cmdEject(obj_id self, obj_id target, String params, float defaultTime)
    {
        dictionary outparams = new dictionary();
    ...
    public int handleDelayedEjection(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public void ejectPlayerFromBuilding(obj_id player, obj_id building)
    {
    ...
    public int handleWatchRadialCmd(obj_id self, dictionary params)
    {
    ...
    public int handleListenRadialCmd(obj_id self, dictionary params)
    {
        obj_id target = params.getObjId("target");
        if (isIdValid(target))
        {
    ...
    public int handleSkillPurchase(obj_id self, dictionary params)
    {
    ...
    public int handleRequestCoinLoot(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleUnconsentMenu(obj_id self, dictionary params)
    {
    ...
    public int handleConsentToLogout(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_OVERRIDE;
    ...
    public int handleReceivedConsent(obj_id self, dictionary params)
    {
    ...
    public int handleReceivedUnconsent(obj_id self, dictionary params)
    {
        obj_id consenter = params.getObjId(pclib.DICT_CONSENTER_ID);
        Vector consentFrom = getResizeableObjIdArrayObjVar(self, pclib.VAR_CONSENT_FROM_ID);
        if (consentFrom != null)
    ...
    public int handleCorpseCoinLoot(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleCorpseCoinLootFailed(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleCorpseExpire(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_OVERRIDE;
    ...
    public int handleCorpseWaypointUpdate(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_OVERRIDE;
    ...
    public int handleCorpseCleanup(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_OVERRIDE;
    ...
    public int handleIncapCounterDeath(obj_id self, dictionary params)
    {
        int posture = getPosture(self);
    ...
    public int reportJediDeathCount(obj_id self, obj_id target, String params, float defaultTime)
    {
        return SCRIPT_CONTINUE;
    }
    public int handleJediDeathCount(obj_id self, dictionary params)
    {
        if (isJedi(self))
        {
    ...
    public int decayJediDeath(obj_id self, dictionary params)
    {
        int jediDeaths = getIntObjVar(self, jedi.VAR_JEDI_DEATHS);
        jediDeaths--;
        if (jediDeaths < 0)
    ...
    public int handleHealOverTimeTick(obj_id self, dictionary params)
    {
    ...
    public int handlePlayerDeath(obj_id self, dictionary params)
    {
        groundquests.sendSignal(self, "smugglerEnemyIncap");
    ...
    public int createCloningSui(obj_id player, Vector list)
    {
    ...
    public int handleCloneSuiUpdate(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public String buildCloningPrompt(obj_id player, int index)
    {
    ...
    public String distanceToString(float dist)
    {
        String text;
        if (dist < 0)
        {
    ...
    public int handleCloningDataUpdate(obj_id self, dictionary params)
    {
    ...
    public int clearRecentDeathScriptVar(obj_id self, dictionary params)
    {
    ...
    public int handleReviveExpirationMessage(obj_id self, dictionary params)
    {
        if (!utils.hasScriptVar(self, pclib.VAR_SUI_CLONE))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleInstanceClonePause(obj_id self, dictionary params)
    {
    ...
    public int handleInstanceCloneSelection(obj_id self, dictionary params)
    {
        int posture = getPosture(self);
        if (posture != POSTURE_DEAD)
        {
    ...
    public int showReviveSUI(obj_id self, dictionary params)
    {
    ...
    public int handleReviveSUITimeout(obj_id self, dictionary params)
    {
    ...
    public int handleReviveSUI(obj_id self, dictionary params)
    {
    ...
    public int handlePlayerRevive(obj_id self, dictionary params)
    {
        if (!utils.hasScriptVar(self, pclib.VAR_SUI_CLONE))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleDelayedClone(obj_id self, dictionary params)
    {
    ...
    public int handleDelayedCloneCancel(obj_id self, dictionary params)
    {
        if (!utils.hasScriptVar(self, "waiting_to_clone"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleCloneRespawn(obj_id self, dictionary params)
    {
        utils.removeScriptVar(self, pclib.VAR_SUI_CLONE);
    ...
    public int handlePlayerResuscitated(obj_id self, dictionary params)
    {
    ...
    public int handleReviveStand(obj_id self, dictionary params)
    {
        setPosture(self, POSTURE_UPRIGHT);
        return SCRIPT_CONTINUE;
    }
    public int handleInstanceRessurect(obj_id self, dictionary params)
    {
        pclib.resurrectPlayer(self, true);
        return SCRIPT_CONTINUE;
    }
    public int handleDecayReport(obj_id self, dictionary params)
    {
        utils.removeScriptVarTree(self, "decayReport");
        return SCRIPT_CONTINUE;
    }
    public int handleRepairItems(obj_id self, dictionary params)
    {
        obj_id[] repairList = params.getObjIdArray("items");
        cloninglib.repairItems(self, repairList);
        return SCRIPT_CONTINUE;
    }
    public int handleChatPersistentMessage(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_OVERRIDE;
    ...
    public int gmRevive(obj_id self, obj_id target, String params, float defaultTime)
    {
        target = self;
    ...
    public int cmdEat(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdUseSkillBuff(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdTip(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdTipFail(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int handleWireConfirm(obj_id self, dictionary params)
    {
        int bp = sui.getIntButtonPressed(params);
        if (bp == sui.BP_CANCEL)
        {
    ...
    public int handleTipSuccess(obj_id self, dictionary params)
    {
    ...
    public int handleTipEscrowRequest(obj_id self, dictionary params)
    {
        int amt = params.getInt("amt");
    ...
    public int handleTipEscrowPass(obj_id self, dictionary params)
    {
    ...
    public int handleTipEscrowFail(obj_id self, dictionary params)
    {
        obj_id actor = params.getObjId("actor");
        String actorName = params.getString("actorName");
        obj_id target = params.getObjId("target");
    ...
    public void refundEscrow(obj_id player, String playerName, obj_id target, String targetName, int amt)
    {
        dictionary params = new dictionary();
    ...
    public int handleTipRefundRequest(obj_id self, dictionary params)
    {
    ...
    public int handleTipRefundPass(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        String playerName = params.getString("playerName");
        obj_id target = params.getObjId("target");
    ...
    public int handleTipRefundFail(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        String playerName = params.getString("playerName");
        obj_id target = params.getObjId("target");
    ...
    public void notifyFailedRefund(obj_id player, String playerName, obj_id target, String targetName, int amt)
    {
    ...
    public int handleTipFail(obj_id self, dictionary params)
    {
    ...
    public void showTipSyntax(obj_id self)
    {
        sendSystemMessage(self, pclib.SID_TIP_SYNTAX);
    }
    public int cmdOpenFail(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isIdValid(target))
        {
            return SCRIPT_OVERRIDE;
    ...
    public int cmdLoot(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id player = self;
        if (!isIdValid(target))
        {
    ...
    public int cmdLootPlayer(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isIdValid(target))
        {
            return SCRIPT_OVERRIDE;
    ...
    public int cmdActivateClone(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdActivateCloneFail(obj_id self, obj_id target, String params, float defaultTime)
    {
        sendSystemMessageTestingOnly(self, "You may only use this command to activate the cloning options menu if you are dead.");
        return SCRIPT_CONTINUE;
    }
    public int cmdSetBind(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isIdValid(target))
        {
            return SCRIPT_CONTINUE;
    ...
    public boolean canDeathBlow(obj_id killer, obj_id victim)
    {
    ...
    public int cmdCoupDeGrace(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int handleCoupDeGrace(obj_id self, dictionary params)
    {
    ...
    public int cmdCorpse(obj_id self, obj_id target, String params, float defaultTime)
    {
        queueCommand(self, (-304150016), target, "", COMMAND_PRIORITY_DEFAULT);
        return SCRIPT_CONTINUE;
    }
    public int cmdConsent(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (params.equals(""))
        {
            target = getLookAtTarget(self);
    ...
    public int cmdUnconsent(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (params.equals(""))
        {
            target = getLookAtTarget(self);
    ...
    public int cmdHaveConsent(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (params.equals(""))
        {
            target = getLookAtTarget(self);
    ...
    public int startTraceLogging(obj_id self, obj_id target, String params, float defaultTime)
    {
        enableTraceLogging();
        return SCRIPT_CONTINUE;
    }
    public int stopTraceLogging(obj_id self, obj_id target, String params, float defaultTime)
    {
        disableTraceLogging();
        return SCRIPT_CONTINUE;
    }
    public int createCreature(obj_id self, obj_id target, String params, float defaultTime)
    {
        String strCreatureType = params;
        location locSpawnLocation = getLocation(self);
        return SCRIPT_CONTINUE;
    }
    public int createNPC(obj_id self, obj_id target, String params, float defaultTime)
    {
        String strNPCType = params;
        location locSpawnLocation = getLocation(self);
        return SCRIPT_CONTINUE;
    }
    public int cmdStartLogout(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int maskscent(obj_id self, obj_id target, String params, float defaultTime)
    {
        return SCRIPT_CONTINUE;
    }
    public int failMaskscent(obj_id self, obj_id target, String params, float defaultTime)
    {
        return SCRIPT_CONTINUE;
    }
    public int milkCreature(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int searchLair(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id intendedTarget = getIntendedTarget(self);
        obj_id lookAtTarget = getLookAtTarget(self);
    ...
    public int removeScentMask(obj_id self, dictionary params)
    {
    ...
    public int removeScentMaskNoNotify(obj_id self, dictionary params)
    {
        return SCRIPT_CONTINUE;
    }
    public int concealEnable(obj_id self, dictionary params)
    {
        return SCRIPT_CONTINUE;
    }
    public int failConceal(obj_id self, obj_id target, String params, float defaultTime)
    {
        return SCRIPT_CONTINUE;
    }
    public int removeConceal(obj_id self, dictionary params)
    {
        return SCRIPT_CONTINUE;
    }
    public boolean itemIsRare(obj_id self, int skillMod)
    {
        boolean rare = false;
        if (skillMod >= 65)
        {
    ...
    public int sysGroup(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int createOfficerGroupWaypoint(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int removeOfficerGroupWaypoint(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int OnSurveyDataReceived(obj_id self, float[] xVals, float[] zVals, float[] efficiencies)
    {
    ...
    public obj_id getSurveyWaypoint(obj_id self)
    {
    ...
    public int OnTargeted(obj_id self, obj_id attacker)
    {
        if (utils.hasScriptVar(self, "surveying.takingSamples"))
        {
            obj_id tool = utils.getObjIdScriptVar(self, "surveying.tool");
    ...
    public int cmdHarvestDNA(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isIdValid(target))
        {
            return SCRIPT_CONTINUE;
    ...
    public int cmdHarvestDNAFail(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isIdValid(target))
        {
    ...
    public int completeHarvestDNA(obj_id self, dictionary params)
    {
        bio_engineer.completeHarvest(self);
        return SCRIPT_CONTINUE;
    }
    public int cmdWaypoint(obj_id self, obj_id target, String params, float defaultTime)
    {
        String wpColor = null;
    ...
    public int cmdSpaceWaypoint(obj_id self, obj_id target, String params, float defaultTime)
    {
        String wpColor = null;
        float displayCoordX = 0.0f;
        float displayCoordZ = 0.0f;
    ...
    public int cmdClearQueue(obj_id self, obj_id target, String params, float defaultTime)
    {
        queueClear(self);
        return SCRIPT_CONTINUE;
    }
    public int getPrototype(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isIdValid(target))
        {
            return SCRIPT_CONTINUE;
    ...
    public int cmdCityban(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (target == self)
        {
            return SCRIPT_CONTINUE;
    ...
    public int cmdCitypardon(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (target == self)
        {
            return SCRIPT_CONTINUE;
    ...
    public int OnCityChanged(obj_id self, int oldCityId, int newCityId)
    {
    ...
    public int cmdGrantZoningRights(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (target == self)
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleZoningRightsSelect(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        int btn = sui.getIntButtonPressed(params);
        if (btn == sui.BP_CANCEL)
    ...
    public void handleCmdGrantZoningRights(obj_id player, obj_id target, int city_id)
    {
    ...
    public void handleStorytellerZoningRights(obj_id player, obj_id target, int city_id)
    {
        if (!isIdValid(player) || !isIdValid(target))
        {
            return;
    ...
    public int cmdGrantStorytellerZoningRights(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdInstallMissionTerminal(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int handleInstallMissionTerminal(obj_id self, dictionary params)
    {
        int idx = sui.getListboxSelectedRow(params);
        if (idx < 0)
        {
    ...
    public int handleMTFeeSuccess(obj_id self, dictionary params)
    {
    ...
    public int handleMTFeeFail(obj_id self, dictionary params)
    {
    ...
    public int handleSTFeeSuccess(obj_id self, dictionary params)
    {
        int city_id = params.getInt("city_id");
        int idx = params.getInt("idx");
    ...
    public int handleSTFeeFail(obj_id self, dictionary params)
    {
        int cost = params.getInt("cost");
        prose_package pp = prose.getPackage(SID_CITY_NO_MONEY, cost);
        sendSystemMessageProse(self, pp);
    ...
    public int cmdCityInfo(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int handleSelectPlanet(obj_id self, dictionary params)
    {
        int idx = sui.getListboxSelectedRow(params);
        if (idx < 0)
        {
    ...
    public int handleSelectCity(obj_id self, dictionary params)
    {
        int idx = sui.getListboxSelectedRow(params);
        if (idx < 0)
        {
    ...
    public int handleSelectCityInfo(obj_id self, dictionary params)
    {
        int idx = sui.getListboxSelectedRow(params);
        if (idx < 0)
        {
    ...
    public int handleSelectRunner(obj_id self, dictionary params)
    {
        int idx = sui.getListboxSelectedRow(params);
        if (idx < 0)
        {
    ...
    public int OnSkillGranted(obj_id self, String skillName)
    {
    ...
    public int handleStartJediKnightTrials(obj_id self, dictionary params)
    {
    ...
    public int OnStartCharacterUpload(obj_id self, byte[] results, modifiable_int resultSize, boolean w, boolean ao)
    {
    ...
    public boolean ctsCheckAndLogUniqueStaticItemAlreadyExists(obj_id container, dictionary itemDictionary)
    {
    ...
    public boolean ctsHasExceededResourceTransferLimit(int crateCountLimit, int currentCrateCount, long unitCountLimit, long currentUnitCount)
    {
    ...
    public obj_id unpackWaypoint(dictionary waypointDictionary)
    {
        obj_id self = getSelf();
        if (!isIdValid(self))
        {
    ...
    public boolean itemIsAllowedToTransfer(obj_id item, obj_id player)
    {
    ...
    public dictionary packWaypoint(obj_id waypoint)
    {
        obj_id self = getSelf();
    ...
    public void doItemPrepack(obj_id item)
    {
        if (!isValidId(item))
        {
            return;
    ...
    public dictionary packItem(obj_id item, int objectType, boolean allowOverride, int resourceCrateCountLimit, int[] resourceCurrentCrateCount, long resourceUnitCountLimit, long[] resourceCurrentUnitCount)
    {
    ...
    public int OnUploadCharacter(obj_id self, dictionary characterData)
    {
    ...
    public void createStartingEquipment(obj_id objPlayer)
    {
        ...
        if (gender == GENDER_MALE)
        {
            if (species == SPECIES_HUMAN || species == SPECIES_ZABRAK || species == SPECIES_BOTHAN || species == SPECIES_MON_CALAMARI || species == SPECIES_RODIAN || species == SPECIES_TWILEK || species == SPECIES_CHISS)
            {
                idx = 0;
            }
        ...
        {
            if (species == SPECIES_HUMAN || species == SPECIES_ZABRAK || species == SPECIES_BOTHAN || species == SPECIES_RODIAN || species == SPECIES_TWILEK || species == SPECIES_CHISS)
            {
                idx = 1;
            }
    ...
    public int OnSkillModDone(obj_id self, String modName, boolean isDead)
    {
        if (modName == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int removeDelayedFoodEffect(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int removeDurationFoodEffect(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleSpiceDownerEffect(obj_id self, dictionary params)
    {
    ...
    public int handleGenericDownerEffect(obj_id self, dictionary params)
    {
    ...
    public int OnStomachUpdate(obj_id self)
    {
        player_stomach.getStomach(self, 0);
        player_stomach.getStomach(self, 1);
        return SCRIPT_CONTINUE;
    }
    public int grantUnmodifiedExperienceOnSelf(obj_id self, dictionary params)
    {
    ...
    public int grantSquadLeaderXpResult(obj_id self, dictionary params)
    {
    ...
    public int cmdSetExperienceResult(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
            int granted = params.getInt(xp.GRANT_XP_RESULT_VALUE);
    ...
    public int OnPerformEmote(obj_id self, String emote)
    {
    ...
    public int cmdGetVeteranRewardTime(obj_id self, obj_id target, String params, float defaultTime)
    {
        ...
        if (timeLeft > 0)
        {
            string_id message = new string_id("veteran", "timeLeft");
            prose_package pp = new prose_package();
            pp.stringId = message;
    ...
    public int cmdListVeteranRewards(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int handleVeteranMilestoneSelected(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
    ...
    public int handleVeteranRewardSelected(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            veteran_deprecated.cleanupPlayerData(self);
    ...
    public int handleVeteranRewardConfirmed(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            veteran_deprecated.cleanupPlayerData(self);
    ...
    public int cmdFlashSpeeder(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int msgFlashSpeederConfirmed(obj_id self, dictionary params)
    {
    ...
    public int msgFlashSpeederPaid(obj_id self, dictionary params)
    {
    ...
    public int OnEnterRegion(obj_id self, String planetName, String regionName)
    {
    ...
    public int OnExitRegion(obj_id self, String planetName, String regionName)
    {
    ...
    public boolean setupNovicePilotSkill(obj_id self, String skillName)
    {
    ...
    public boolean allowedBySpaceExpansion(obj_id self, String skillName)
    {
        return true;
    }
    public int gmForceCommand(obj_id self, obj_id target, String params, float defaultTime)
    {
        if ((params == null) || (params.equals("")))
        {
    ...
    public int doForcedGmCommand(obj_id self, dictionary params)
    {
    ...
    public int factionBaseLotRefund(obj_id self, dictionary params)
    {
    ...
    public int transferMoneyToNamedAccount(obj_id self, dictionary params)
    {
    ...
    public int transferMoneyToNamedAccount_successCallback(obj_id self, dictionary params)
    {
        messageTo(params.getObjId("replyTo"), params.getString("successCallback"), params, 0, false);
        return SCRIPT_CONTINUE;
    }
    public int transferMoneyToNamedAccount_failCallback(obj_id self, dictionary params)
    {
        messageTo(params.getObjId("replyTo"), params.getString("failCallback"), params, 0, false);
        return SCRIPT_CONTINUE;
    }
    public int sendSystemMessageProseAuthoritative(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
    ...
    public int handleInstanceTimeRemainingMessage(obj_id self, dictionary params)
    {
        String message = params.getString("message");
        sendSystemMessageTestingOnly(self, message);
        return SCRIPT_CONTINUE;
    }
    public int setRespecVersion(obj_id self, dictionary params)
    {
    ...
    public int HandleSetCoverCharge(obj_id self, dictionary params)
    {
        int bp = sui.getIntButtonPressed(params);
        if (bp == sui.BP_CANCEL)
        {
    ...
    public int HandleCoverCharge(obj_id self, dictionary params)
    {
        int bp = sui.getIntButtonPressed(params);
    ...
    public int messageUpdateMissionCriticalObjects(obj_id self, dictionary params)
    {
    ...
    public int messageSendQuestSystemMessage(obj_id self, dictionary params)
    {
    ...
    public int cmdShowLockout(obj_id self, obj_id target, String params, float defaultTime)
    {
        space_dungeon.displayAllDungeonLockoutTimers(self);
        return SCRIPT_CONTINUE;
    }
    public int OnPvpTypeChanged(obj_id self, int oldType, int newType)
    {
    ...
    public int OnQuestActivated(obj_id self, int questCrc)
    {
    ...
    public int OnQuestReceivedReward(obj_id self, int questCrc, String exclusiveItemChoice)
    {
    ...
    public int OnQuestCompleted(obj_id self, int questCrc)
    {
    ...
    public int OnQuestCleared(obj_id self, int questCrc)
    {
    ...
    public int OnRequestStaticItemData(obj_id self, String itemName)
    {
    ...
    public int handleClientLogin(obj_id self, obj_id target, String params, float defaultTime)
    {
        int[] quests = questGetAllActiveQuestIds(self);
        for (int i = 0; i < quests.length; ++i)
        {
    ...
    public int OnGetStaticItemsAttributes(obj_id self, String staticItemName, String[] names, String[] attribs)
    {
    ...
    public int handleSmugglerFenceAbility(obj_id self, obj_id target, String params, float defaultTime)
    {
        smuggler.showSellJunkSui(self, self, true, true);
        return SCRIPT_CONTINUE;
    }
    public int handleSellJunkSui(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        if (!isIdValid(player))
        {
    ...
    public int handleSoldJunk(obj_id self, dictionary params)
    {
    ...
    public int OnSkillModsChanged(obj_id self, String[] modNames, int[] modValues)
    {
        trial.bumpSession(self, "displayDefensiveMods");
        messageTo(self, "setDisplayOnlyDefensiveMods", trial.getSessionDict(self, "displayDefensiveMods"), 5, false);
    ...
    public int handlePlayerBountyEngagement(obj_id self, dictionary params)
    {
        obj_id target = params.getObjId("target");
    ...
    public int handlePlayerBountyTimeout(obj_id self, dictionary params)
    {
        obj_id target = params.getObjId("target");
        int id = params.getInt("id");
    ...
    public int handleAwardedBountyCheck(obj_id self, dictionary params)
    {
    ...
    public int handleAwardedPlayerBounty(obj_id self, dictionary params)
    {
        obj_id target = params.getObjId("target");
    ...
    public int handleSurveyToolbarSetup(obj_id self, dictionary params)
    {
        obj_id objInv = utils.getInventoryContainer(self);
    ...
    public int factionBaseUnitRefund(obj_id self, dictionary params)
    {
    ...
    public int OnSkillTemplateChanged(obj_id self, String skillTemplateName, boolean clientSelected)
    {
...
// finch start of comment block
// finch the following was removed by Ios
/*
    public void givePublishGift(obj_id self)
    {
...
*/
// finch end of comment block
    public void respecNewEntertainerSkills(obj_id self)
    {
    ...
    public void respecNewCrafterSkills(obj_id self)
    {
        String template = getSkillTemplate(self);
        if (template == null)
        {
    ...
    public String getCorrectTraderTemplate(String template)
    {
    ...
    public int finishEntertainerRespec(obj_id self, dictionary params)
    {
    ...
    public int handleSetBounty(obj_id self, dictionary params)
    {
        int bp = sui.getIntButtonPressed(params);
        if (bp == sui.BP_CANCEL)
        {
    ...
    public int handleSetBountyTransaction(obj_id self, dictionary params)
    {
    ...
    public int handleBountyMissionIncomplete(obj_id self, dictionary params)
    {
        obj_id target = params.getObjId("target");
    ...
    public int handleUpdateBountyMissionTime(obj_id self, dictionary params)
    {
    ...
    public int handleBountyMissionTimeout(obj_id self, dictionary params)
    {
        int gameTime = getGameTime();
        int lastMission = 0;
        if (hasObjVar(self, "bounty.lastMissionTime"))
    ...
    public boolean performCriticalHeal(obj_id self)
    {
    ...
    public int handleSendSmugglerBootstrapRequest(obj_id self, dictionary params)
    {
    ...
    public int handleSmugglerMissionFailureSignal(obj_id self, dictionary params)
    {
        groundquests.sendSignal(self, "smugglerEnemyIncap");
        return SCRIPT_CONTINUE;
    }
    public int OnClusterWideDataResponse(obj_id self, String manage_name, String data_name, int request_id, String[] element_name_list, dictionary[] dungeon_data, int lock_key)
    {
    ...
    public int removeIncubatorFromUser(obj_id self, dictionary params)
    {
        obj_id station = params.getObjId("station");
        incubator.forceRemoveIncubatorFromUser(station, self);
        return SCRIPT_CONTINUE;
    }
    public int handleStoryTellerAssistantRequest(obj_id self, dictionary params)
    {
    ...
    public int handleTellStorytellerIDeclinedAssistant(obj_id self, dictionary params)
    {
        obj_id storytellerPlayer = params.getObjId("storytellerPlayer");
        if (isIdValid(storytellerPlayer))
        {
    ...
    public int handleStoryTellerAssistantAccepted(obj_id self, dictionary params)
    {
        obj_id storytellerPlayer = params.getObjId("storytellerPlayer");
        String storytellerName = params.getString("storytellerName");
        if (isIdValid(storytellerPlayer))
    ...
    public int handleStoryTellerRemoveAssistant(obj_id self, dictionary params)
    {
        obj_id storytellerPlayer = params.getObjId("storytellerPlayer");
        String storytellerName = params.getString("storytellerName");
        if (isIdValid(storytellerPlayer))
    ...
    public int handleStoryTellerInviteRequest(obj_id self, dictionary params)
    {
        obj_id storytellerPlayer = params.getObjId("storytellerPlayer");
        String storytellerName = params.getString("storytellerName");
    ...
    public int handleTellStorytellerIDeclinedInvite(obj_id self, dictionary params)
    {
        obj_id storytellerPlayer = params.getObjId("storytellerPlayer");
        if (isIdValid(storytellerPlayer))
        {
    ...
    public int handleStoryTellerInviteAccepted(obj_id self, dictionary params)
    {
        obj_id storytellerPlayer = params.getObjId("storytellerPlayer");
        String storytellerName = params.getString("storytellerName");
        obj_id storytellerAssistant = params.getObjId("storytellerAssistant");
    ...
    public int handleStoryTellerRemovedFromStory(obj_id self, dictionary params)
    {
        obj_id storytellerPlayer = params.getObjId("storytellerPlayer");
        String storytellerName = params.getString("storytellerName");
        if (isIdValid(storytellerPlayer))
    ...
    public int cmdGetGalaxyMessage(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id planetId = getPlanetByName("tatooine");
        if (!isIdNull(planetId))
        {
    ...
    public int myCityMotdResponse(obj_id self, dictionary params)
    {
    ...
    public int stampDungeonArea(obj_id self, dictionary params)
    {
    ...
    public int removeDungeonArea(obj_id self, dictionary params)
    {
        String dungeon_area = params.getString("buildout_area");
        if (dungeon_area.equals("invalid"))
        {
    ...
    public int handleStopDanceMessage(obj_id self, dictionary params)
    {
        utils.removeScriptVar(self, "stopDanceMessage");
        return SCRIPT_CONTINUE;
    }
    public int onGuildCreateTerminalDataObject(obj_id self, dictionary params)
    {
    ...
    public int applyMountBuff(obj_id self, dictionary params)
    {
        obj_id playerCurrentMount = getMountId(self);
        if (isIdValid(playerCurrentMount))
        {
    ...
    public int handleDailyMissionReset(obj_id self, dictionary params)
    {
        missions.clearDailyObjVars(self);
        return SCRIPT_CONTINUE;
    }
    public int cmdMeditate(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdMeditateFail(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int msgCoupDeGraceAuthoritativeCheck(obj_id self, dictionary params)
    {
    ...
    public boolean lifeDayNewDay(obj_id player)
    {
    ...
    public boolean colorizeObject(obj_id self, obj_id object, obj_id tool, String params)
    {
    ...
    public boolean isPvpRelatedDeath(obj_id player)
    {
    ...
    public boolean needsBlackwingLightInfection(obj_id self)
    {
    ...
    public int death_troopers_apply_virus(obj_id self, dictionary params)
    {
    ...
    public int handleBuyBackSui(obj_id self, dictionary params)
    {
        if (params == null || params.equals(""))
        {
    ...
    public int handleTheBuyBack(obj_id self, dictionary params)
    {
        if (params == null || params.equals(""))
        {
            CustomerServiceLog("Junk_Dealer: ", "base_player.handleBuyBackSui() - Player: " + self + " attempted to get a list of buy back items but the message handler received not data.");
    ...
    public int handleFlagJunkSui(obj_id self, dictionary params)
    {
        if (params == null || params.equals(""))
        {
            CustomerServiceLog("Junk_Dealer: ", "base_player.handleBuyBackSui() - Player: " + self + " attempted to get a list of buy back items but the message handler received not data.");
    ...
    public boolean blog(String txt)
    {
        if (LOGGING_ON)
        {
            LOG(LOGNAME, txt);
