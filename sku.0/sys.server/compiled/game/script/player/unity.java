...
public class unity extends script.base_script
{
    ...
    public int handleProposedTo(obj_id self, dictionary params)
    {
    ...
    public int handleProposalSui(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
    ...
    public int handleRingSelectionSui(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            marriage.declineProposal(self);
    ...
    public int handleProposalExpire(obj_id self, dictionary params)
    {
        if (utils.hasScriptVar(self, marriage.VAR_PROPOSAL_TARGET))
        {
    ...
    public int handleAcceptFail(obj_id self, dictionary params)
    {
        if (utils.hasScriptVar(self, marriage.VAR_PROPOSAL_TARGET))
        {
            String proposee = utils.getStringScriptVar(self, marriage.VAR_PROPOSAL_NAME);
    ...
    public int handleProposalDeclined(obj_id self, dictionary params)
    {
        if (utils.hasScriptVar(self, marriage.VAR_PROPOSAL_TARGET))
        {
            String proposee = utils.getStringScriptVar(self, marriage.VAR_PROPOSAL_NAME);
    ...
    public int handleRingExchange(obj_id self, dictionary params)
    {
    ...
    public int handleRingSetup(obj_id self, dictionary params)
    {
