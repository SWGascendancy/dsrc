...
public class player_community_crafting extends script.base_script
{
    ...
    public int handleCleanupCommunityCrafting(obj_id self, dictionary params)
    {
        if (!hasObjVar(self, OBJVAR_REWARD_PRIZE))
        {
            cleanup(self);
    ...
    public int handleCommunityCraftingReward(obj_id self, dictionary params)
    {
    ...
    public int handleViewingNpcInventory(obj_id self, dictionary params)
    {
    ...
    public void cleanup(obj_id self)
    {
        if (!isIdValid(self))
        {
    ...
    public boolean givePlayerPrize(obj_id self, int prizeCrc, int slot, int type, String script)
    {
        if (!isIdValid(self))
        {
