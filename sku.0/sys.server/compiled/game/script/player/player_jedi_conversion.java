...
public class player_jedi_conversion extends script.base_script
{
    ...
    public int forceSensitiveSui(obj_id self, obj_id player, int test)
    {
    ...
    public int forceSensitiveSkillSelection(obj_id self, dictionary params)
    {
    ...
    public void addSkillBox(obj_id self, obj_id player, int idx)
    {
        String datatable = "datatables/jedi/force_sensitive_skills.iff";
        if (idx < 0)
        {
    ...
    public void checkForMasterBox(obj_id player)
    {
        obj_id self = player;
    ...
    public int jediSui(obj_id self, obj_id player, int test)
    {
    ...
    public int jediSkillSelection(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public void addJediSkillBox(obj_id self, obj_id player, int idx)
    {
        String datatable = "datatables/jedi/jedi_conversion.iff";
        if (idx < 0)
        {
    ...
    public int regularSkillSui(obj_id self, obj_id player, int test)
    {
    ...
    public String[] getMasterSkillList(obj_id player)
    {
    ...
    public String[] getTotalSkillList(obj_id player)
    {
    ...
    public String[] getLearnableSkillList(obj_id player)
    {
    ...
    public int regularSkillSelection(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public void addRegularSkillBox(obj_id self, obj_id player, int idx)
    {
        String datatable = "datatables/skill/skills.iff";
        if (idx < 0)
        {
    ...
    public void revokeSkills(obj_id objPlayer)
    {
    ...
    public void revokeForceSkill(obj_id player)
    {
        obj_id self = player;
    ...
    public void revokeJediSkill(obj_id player)
    {
    ...
    public void revokeRegularSkill(obj_id player)
    {
    ...
    public void completeTraining(obj_id self)
    {
