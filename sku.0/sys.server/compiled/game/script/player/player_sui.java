...
public class player_sui extends script.base_script
{
    ...
    public int handleCloseSui(obj_id self, dictionary params)
    {
    ...
    public int handleSetSuiAssociate(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleDecorTypeSelect(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleDecorSlotRemovalSelect(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public boolean removeDecorVars(obj_id player)
    {
        if (!isValidId(player) || !exists(player))
        {
            return false;
