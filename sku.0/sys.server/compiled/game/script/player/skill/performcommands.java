...
public class performcommands extends script.base_script
{
    ...
    public int cmdStartMusic(obj_id self, obj_id target, String params, float defaultTime)
    {
        performance.startMusic(self, params);
        return SCRIPT_CONTINUE;
    }
    public int cmdStartBand(obj_id self, obj_id target, String params, float defaultTime)
    {
        performance.startBand(self, params);
        return SCRIPT_CONTINUE;
    }
    public int cmdStopMusic(obj_id self, obj_id target, String params, float defaultTime)
    {
        performance.stopMusic(self);
        return SCRIPT_CONTINUE;
    }
    public int cmdStopBand(obj_id self, obj_id target, String params, float defaultTime)
    {
        performance.stopBand(self);
        return SCRIPT_CONTINUE;
    }
    public int cmdPauseMusic(obj_id self, obj_id target, String params, float defaultTime)
    {
        performance.specialFlourish(self, performance.SPECIAL_FLOURISH_PAUSE_MUSIC);
        return SCRIPT_CONTINUE;
    }
    public int cmdChangeMusic(obj_id self, obj_id target, String params, float defaultTime)
    {
        performance.changeMusic(self, params);
        return SCRIPT_CONTINUE;
    }
    public int cmdChangeBandMusic(obj_id self, obj_id target, String params, float defaultTime)
    {
        performance.changeBandMusic(self, params);
        return SCRIPT_CONTINUE;
    }
    public int cmdCoverCharge(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdStartDance(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdStopDance(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id[] members = performance.getDanceMembers(self);
        if (members == null || members.length <= 0 || hasObjVar(self, performance.VAR_PERFORM_NO_GROUP_DANCE))
        {
    ...
    public int cmdChangeDance(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id[] members = performance.getDanceMembers(self);
        if (members == null || members.length <= 0 || hasObjVar(self, performance.VAR_PERFORM_NO_GROUP_DANCE))
        {
    ...
    public int cmdPauseDance(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id[] members = performance.getDanceMembers(self);
        if (members == null || members.length <= 0 || hasObjVar(self, performance.VAR_PERFORM_NO_GROUP_DANCE))
        {
    ...
    public int failDance(obj_id self, obj_id target, String params, float defaultTime)
    {
        performance.performanceMessageToSelf(self, null, performance.SID_DANCE_FAIL);
        return SCRIPT_CONTINUE;
    }
    public int cmdGroupDance(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int failMusic(obj_id self, obj_id target, String params, float defaultTime)
    {
        performance.performanceMessageToSelf(self, null, performance.SID_MUSIC_FAIL);
        return SCRIPT_CONTINUE;
    }
    public int cmdFlourish(obj_id self, obj_id target, String params, float defaultTime)
    {
        int val = utils.stringToInt(params);
        if (val != -1)
        {
    ...
    public int cmdBandFlourish(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdBandPause(obj_id self, obj_id target, String params, float defaultTime)
    {
        java.util.StringTokenizer st = new java.util.StringTokenizer(params);
        if (st.countTokens() < 1)
        {
    ...
    public int cmdBandSolo(obj_id self, obj_id target, String params, float defaultTime)
    {
        java.util.StringTokenizer st = new java.util.StringTokenizer(params);
        if (st.countTokens() < 1)
        {
    ...
    public int cmdSpotLight(obj_id self, obj_id target, String params, float defaultTime)
    {
        int level = utils.stringToInt(params);
        performance.effect(self, performance.PERFORMANCE_EFFECT_SPOT_LIGHT, level);
        return SCRIPT_CONTINUE;
    }
    public int cmdColorLight(obj_id self, obj_id target, String params, float defaultTime)
    {
        int level = utils.stringToInt(params);
        performance.effect(self, performance.PERFORMANCE_EFFECT_COLOR_LIGHTS, level);
        return SCRIPT_CONTINUE;
    }
    public int cmdDazzle(obj_id self, obj_id target, String params, float defaultTime)
    {
        int level = utils.stringToInt(params);
        performance.effect(self, performance.PERFORMANCE_EFFECT_DAZZLE, level);
        return SCRIPT_CONTINUE;
    }
    public int cmdDistract(obj_id self, obj_id target, String params, float defaultTime)
    {
        int level = utils.stringToInt(params);
        performance.effect(self, performance.PERFORMANCE_EFFECT_DISTRACT, level);
        return SCRIPT_CONTINUE;
    }
    public int cmdSmokeBomb(obj_id self, obj_id target, String params, float defaultTime)
    {
        int level = utils.stringToInt(params);
        performance.effect(self, performance.PERFORMANCE_EFFECT_SMOKE_BOMB, level);
        return SCRIPT_CONTINUE;
    }
    public int cmdFireJet(obj_id self, obj_id target, String params, float defaultTime)
    {
        int level = utils.stringToInt(params);
        performance.effect(self, performance.PERFORMANCE_EFFECT_FIRE_JETS, level);
        return SCRIPT_CONTINUE;
    }
    public int cmdVentriloquism(obj_id self, obj_id target, String params, float defaultTime)
    {
        int level = utils.stringToInt(params);
        performance.effect(self, performance.PERFORMANCE_EFFECT_VENTRILOQUISM, level);
        return SCRIPT_CONTINUE;
    }
    public int cmdCenterStage(obj_id self, obj_id target, String params, float defaultTime)
    {
        performance.effect(self, performance.PERFORMANCE_EFFECT_CENTER_STAGE, 1);
        return SCRIPT_CONTINUE;
    }
    public int cmdColorSwirl(obj_id self, obj_id target, String params, float defaultTime)
    {
        performance.effect(self, performance.PERFORMANCE_EFFECT_COLOR_SWIRL, 1);
        return SCRIPT_CONTINUE;
    }
    public int cmdDanceFloor(obj_id self, obj_id target, String params, float defaultTime)
    {
        performance.effect(self, performance.PERFORMANCE_EFFECT_DANCE_FLOOR, 1);
        return SCRIPT_CONTINUE;
    }
    public int cmdFeaturedSolo(obj_id self, obj_id target, String params, float defaultTime)
    {
        performance.effect(self, performance.PERFORMANCE_EFFECT_FEATURED_SOLO, 1);
        return SCRIPT_CONTINUE;
    }
    public int cmdFireJet2(obj_id self, obj_id target, String params, float defaultTime)
    {
        performance.effect(self, performance.PERFORMANCE_EFFECT_FIRE_JETS2, 1);
        return SCRIPT_CONTINUE;
    }
    public int cmdLaserShow(obj_id self, obj_id target, String params, float defaultTime)
    {
        performance.effect(self, performance.PERFORMANCE_EFFECT_LASER_SHOW, 1);
        return SCRIPT_CONTINUE;
    }
    public int cmdListen(obj_id self, obj_id target, String params, float defaultTime)
    {
        performance.listen(self, target);
        return SCRIPT_CONTINUE;
    }
    public int cmdStopListening(obj_id self, obj_id target, String params, float defaultTime)
    {
        performance.listen(self, null);
        return SCRIPT_CONTINUE;
    }
    public int cmdWatch(obj_id self, obj_id target, String params, float defaultTime)
    {
        performance.watch(self, target);
        return SCRIPT_CONTINUE;
    }
    public int cmdStopWatching(obj_id self, obj_id target, String params, float defaultTime)
    {
        performance.watch(self, null);
        return SCRIPT_CONTINUE;
    }
    public int cmdDenyService(obj_id self, obj_id target, String params, float defaultTime)
    {
        performance.denyService(self, target);
        return SCRIPT_CONTINUE;
    }
    public int cmdSetPerformanceBuffTarget(obj_id self, obj_id target, String params, float defaultTime)
    {
        performance.performanceSetPerformanceBuffTarget(self, target);
        return SCRIPT_CONTINUE;
    }
    public int cmdStartJuggling(obj_id self, obj_id target, String params, float defaultTime)
    {
        performance.startJuggling(self, params);
        return SCRIPT_CONTINUE;
    }
    public int cmdStopJuggling(obj_id self, obj_id target, String params, float defaultTime)
    {
        performance.stopJuggling(self);
        return SCRIPT_CONTINUE;
    }
    public int cmdChangeJuggle(obj_id self, obj_id target, String params, float defaultTime)
    {
        performance.changeJuggle(self, params);
        return SCRIPT_CONTINUE;
    }
    public int cmdPauseJuggling(obj_id self, obj_id target, String params, float defaultTime)
    {
        performance.specialFlourish(self, performance.SPECIAL_FLOURISH_PAUSE_MUSIC);
        return SCRIPT_CONTINUE;
    }
    public int failJuggling(obj_id self, obj_id target, String params, float defaultTime)
    {
        performance.performanceMessageToSelf(self, null, performance.SID_JUGGLE_FAIL);
        return SCRIPT_CONTINUE;
    }
    public int cmdInspire(obj_id self, obj_id target, String params, float defaultTime)
    {
