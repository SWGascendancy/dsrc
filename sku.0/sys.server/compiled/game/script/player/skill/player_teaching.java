...
public class player_teaching extends script.base_script
{
    ...
    public int msgTeachSkillSelected(obj_id self, dictionary params)
    {
    ...
    public int msgTeachSkillConfirmed(obj_id self, dictionary params)
    {
    ...
    public int teach(obj_id self, obj_id target, String params, float defaultTime)
    {
