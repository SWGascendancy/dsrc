...
public class taming extends script.base_script
{
    ...
    public int cmdTellPet(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int tellPetAttack(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int tellPetFollow(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (callable.hasAnyCallable(self))
        {
            obj_id[] callableList = callable.getCallables(self);
    ...
    public int mount(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int battlefieldMount(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id mount = target;
    ...
    public int dismount(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int battlefieldDismount(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int dismountandstore(obj_id self, obj_id target, String params, float defaultTime)
    {
