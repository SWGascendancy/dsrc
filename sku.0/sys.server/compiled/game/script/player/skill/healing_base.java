...
public class healing_base extends script.base_script
{
    ...
    public obj_id validateEnhancer(String parms)
    {
    ...
    public int[] getActionCost(obj_id self, dictionary actionData)
    {
        int[] cost = new int[2];
        float healthCost;
        float actionCost;
    ...
    public String makeHealingPlaybackName(obj_id self, obj_id target, dictionary actionData)
    {
