...
public class teraskasi extends script.systems.combat.combat_base
{
    ...
    public int cmdForceOfWill(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdForceOfWillFail(obj_id self, obj_id target, String params, float defaultTime)
    {
        return SCRIPT_CONTINUE;
    }
    public int cmdPowerBoost(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isIdValid(self))
        {
    ...
    public int cmdPowerBoostFail(obj_id self, obj_id target, String params, float defaultTime)
    {
        combat.sendCombatSpamMessage(self, meditation.SID_POWERBOOST_FAIL);
        return SCRIPT_CONTINUE;
    }
