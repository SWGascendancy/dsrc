...
public class player_dispenser extends script.base_script
{
    ...
    public int msgMedicinePurchaseSelected(obj_id self, dictionary params)
    {
    ...
    public int msgMedicinePurchaseConfirmed(obj_id self, dictionary params)
    {
        detachScript(self, "player.player_dispenser");
    ...
    public int msgDispenserPurchaseSelected(obj_id self, dictionary params)
    {
        int row_selected = getSelection(self, params);
        if (row_selected == -1)
        {
    ...
    public int msgDispenserPurchaseConfirmed(obj_id self, dictionary params)
    {
    ...
    public int msgPurchaseFailed(obj_id self, dictionary params)
    {
        sendSystemMessage(self, SID_INSUFFICIENT_FUNDS);
        return SCRIPT_CONTINUE;
    }
    public int getSelection(obj_id player, dictionary params)
    {
