...
public class player_instance extends script.base_script
{
    ...
    public int movePlayerToInstance(obj_id self, dictionary params)
    {
    ...
    public int cmdShowInstanceInformation(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public String getShowInstanceInformationPrompt(obj_id self)
    {
    ...
    public String getUnflaggedInstancesString(obj_id player)
    {
    ...
    public String getRaidId(String time, String instance, String owner)
    {
    ...
    public String getPassedId(Vector listId, String instance_name)
    {
    ...
    public int handleAwardtoken(obj_id self, dictionary params)
    {
    ...
    public int instanceFailureMessage(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
    ...
    public int requestInstance(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int delayInstanceRequest(obj_id self, dictionary params)
    {
        String instance_name = params.getString("instance_name");
        instance.requestInstanceMovement(self, instance_name);
        return SCRIPT_CONTINUE;
    }
    public int clearInstanceScriptVar(obj_id self, dictionary params)
    {
