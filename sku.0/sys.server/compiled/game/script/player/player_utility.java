...
public class player_utility extends script.base_script
{
    ...
    public int OnWaypointDestroyed(obj_id self, obj_id waypoint)
    {
    ...
    public int OnAboutToBeTransferred(obj_id self, obj_id destination, obj_id transferer)
    {
    ...
    public void turnstileInform(obj_id self, obj_id building)
    {
    ...
    public int handleTurnstilePay(obj_id self, dictionary params)
    {
    ...
    public int attemptedPayment(obj_id self, dictionary params)
    {
    ...
    public int handleVendorDestroy(obj_id self, dictionary params)
    {
    ...
    public int handleHoloTimeout(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_OVERRIDE;
    ...
    public int handlePerformanceBreach(obj_id self, dictionary params)
    {
        if (!utils.hasScriptVar(self, "holoMessageTime"))
        {
            return SCRIPT_OVERRIDE;
    ...
    public int OnRequestAuctionFee(obj_id self, obj_id who, obj_id bazaar, obj_id item, boolean premium, modifiable_int amount)
    {
    ...
    public int handleSUI(obj_id self, dictionary params)
    {
        boolean doMsg = true;
    ...
    public int handleAttachScript(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_OVERRIDE;
    ...
    public int handleDetachScript(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_OVERRIDE;
    ...
    public int handleRemoveObjVar(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_OVERRIDE;
    ...
    public int handleGrantXp(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_OVERRIDE;
    ...
    public int bm_collect_dna(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int removeAppearanceItemEffect(obj_id self, dictionary params)
    {
    ...
    public int addAppearanceItemEffect(obj_id self, dictionary params)
    {
        obj_id allAppearanceItems[] = getAllItemsFromAppearanceInventory(self);
        if (allAppearanceItems == null || allAppearanceItems.length <= 0)
        {
    ...
    public int cmdPathToLocation(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdPathClear(obj_id self, obj_id target, String params, float defaultTime)
    {
        destroyClientPath(self);
        return SCRIPT_CONTINUE;
    }
    public int cmdFind(obj_id self, obj_id target, String params, float defaultTime)
    {
        if ((params == null) || (params.equals("")))
        {
    ...
    public void clearFindData(obj_id self)
    {
    ...
    public int handleFindSui(obj_id self, dictionary params)
    {
    ...
    public int handleDelayedSystemMessage(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleDelayedProseMessage(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleDivorce(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleWaypointDestroyRequest(obj_id self, dictionary params)
    {
    ...
    public int handleWaypointRenameRequest(obj_id self, dictionary params)
    {
        obj_id wp = params.getObjId("wp");
        if (!isIdValid(wp) || !exists(wp) || !wp.isLoaded())
        {
    ...
    public int handleVendorPayment(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int displayCityUpdateTime(obj_id self, dictionary params)
    {
    ...
    public int handleSurveyDroidReport(obj_id self, dictionary params)
    {
    ...
    public void createBuffs(obj_id player)
    {
    ...
    public void createNewBHResources(obj_id self)
    {
        if (!isIdValid(self))
        {
            return;
    ...
    public int handleTurnstilePayFail(obj_id self, dictionary params)
    {
        utils.removeScriptVar(self, "turnstile.queryTurnstile");
        sendSystemMessage(self, new string_id(STF_FILE, "not_enough_money"));
        return SCRIPT_CONTINUE;
    }
    public int handleGmGrantSkillOptions(obj_id self, dictionary params)
    {
    ...
    public void redisplayGrantSkillSui(obj_id self, obj_id target)
    {
    ...
    public void gmGrantSkillRoadmapChoice(obj_id self, obj_id target)
    {
    ...
    public int handleGmGrantSkillRoadmapSelect(obj_id self, dictionary params)
    {
        obj_id target = utils.getObjIdScriptVar(self, "gmGrantSkill.target");
        if (!isIdValid(target))
        {
    ...
    public void gmGrantSkillRoadmapProgression(obj_id self, obj_id target, String template)
    {
    ...
    public int handleGmGrantSkillSkillSelect(obj_id self, dictionary params)
    {
        obj_id target = utils.getObjIdScriptVar(self, "gmGrantSkill.target");
        if (!isIdValid(target))
        {
    ...
    public int handleGmGrantSkillLevelInput(obj_id self, dictionary params)
    {
        obj_id target = utils.getObjIdScriptVar(self, "gmGrantSkill.target");
        if (!isIdValid(target))
        {
    ...
    public int cmdAutoDeclineDuel(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int handleSmugglerGetLocationInfo(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleSmugglerDistanceCheck(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int residentLinkFalse(obj_id self, dictionary params)
    {
        setHouseId(self, obj_id.NULL_ID);
        return SCRIPT_CONTINUE;
    }
    public int handleTargetDummyCombatReport(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public int reimburseTcgItem(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
    ...
    public boolean applyCostume(obj_id self, String costumeCommand)
    {
    ...
    public int costume_loveday_ewok_cupid(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int costume_jawa(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int costume_gungan(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int costume_ewok(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int costume_gamorrean_guard(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int costume_battle_droid(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int costume_droideka(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int costume_monkey_lizard(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int costume_toydarian(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int costume_muftak(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int costume_dantari_m(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int costume_4lom(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int costume_dantari_f(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int costume_royal_guard(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int costume_droid_8t88(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int costume_darktrooper(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int costume_mustafarian_01(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int costume_chevin(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int costume_ig106(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int costume_super_battle_droid(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int costume_spider_droid(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int costume_undead_wookie(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int costume_burning_ewok(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int costume_chiss_01(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int costume_exar_kun_cultist(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int costume_lifeday_monkey_lizard(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int costume_axkva_min(obj_id self, obj_id target, String params, float defaultTime)
	{
    ...
    public int costume_blackwing_rancor(obj_id self, obj_id target, String params, float defaultTime)
	{
    ...
    public int costume_dug(obj_id self, obj_id target, String params, float defaultTime)
	{
    ...
    public int costume_esb_boba_fett(obj_id self, obj_id target, String params, float defaultTime)
	{
    ...
    public int costume_esb_darth_vader(obj_id self, obj_id target, String params, float defaultTime)
	{
    ...
    public int costume_esb_han_solo(obj_id self, obj_id target, String params, float defaultTime)
	{
    ...
    public int costume_esb_lando(obj_id self, obj_id target, String params, float defaultTime)
	{
    ...
    public int costume_esb_leia(obj_id self, obj_id target, String params, float defaultTime)
	{
    ...
    public int costume_esb_luke(obj_id self, obj_id target, String params, float defaultTime)
	{
    ...
    public int costume_esb_yoda(obj_id self, obj_id target, String params, float defaultTime)
	{
    ...
    public int costume_geonosian(obj_id self, obj_id target, String params, float defaultTime)
	{
    ...
    public int costume_hutt_female(obj_id self, obj_id target, String params, float defaultTime)
	{
    ...
    public int costume_meatlump_king(obj_id self, obj_id target, String params, float defaultTime)
	{
    ...
    public int costume_mutant_rancor(obj_id self, obj_id target, String params, float defaultTime)
	{
    ...
    public int costume_mynock(obj_id self, obj_id target, String params, float defaultTime)
	{
    ...
    public int costume_rancor(obj_id self, obj_id target, String params, float defaultTime)
	{
    ...
    public int costume_seven_obi_wan_ghost(obj_id self, obj_id target, String params, float defaultTime)
	{
    ...
    public int costume_skeleton(obj_id self, obj_id target, String params, float defaultTime)
	{
    ...
    public int costume_tauntaun(obj_id self, obj_id target, String params, float defaultTime)
	{
    ...
    public int costume_tusken_king(obj_id self, obj_id target, String params, float defaultTime)
	{
    ...
    public int costume_ughnaught(obj_id self, obj_id target, String params, float defaultTime)
	{
    ...
    public int costume_wampa(obj_id self, obj_id target, String params, float defaultTime)
	{
    ...
    public int costume_zozpheratu(obj_id self, obj_id target, String params, float defaultTime)
	{
    ...
    public int cmdShowHousePackUpData(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdRename(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int trigger_city_house_packup(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id player = self;
    ...
    public int handleRenameCharacterNameInput(obj_id self, dictionary params)
    {
        if (!utils.hasScriptVar(self, SCRIPTVAR_RENAME_CHARACTER_SUI_ID))
        {
            return SCRIPT_CONTINUE;
    ...
    public int renameCharacterNameValidationFail(obj_id self, dictionary params)
    {
        if (utils.hasScriptVar(self, SCRIPTVAR_RENAME_CHARACTER_SUI_ID))
        {
            return SCRIPT_CONTINUE;
    ...
    public int renameCharacterNameValidationSuccess(obj_id self, dictionary params)
    {
        if (utils.hasScriptVar(self, SCRIPTVAR_RENAME_CHARACTER_SUI_ID))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleRenameCharacterConfirmation(obj_id self, dictionary params)
    {
        if (!utils.hasScriptVar(self, SCRIPTVAR_RENAME_CHARACTER_SUI_ID))
        {
            return SCRIPT_CONTINUE;
    ...
    public void renameCharacterDisplayNameInput(obj_id self, String newName, String reason)
    {
    ...
    public int closeLeaderSui(obj_id self, dictionary params)
    {
    ...
    public int handlerCommunityBadgeGrant(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int recalculateCampDefenseUndeadArray(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
    ...
    public boolean removeGuardPostFlag(obj_id player)
    {
    ...
    public int handleEntertainingGcwTroops(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public boolean cleanUpGuardPostNpc(obj_id npc)
    {
    ...
    public int handleTraderRepairQuest(obj_id self, dictionary params)
    {
        if (params == null)
        {
    ...
    public int handleOpposingFactionScoutQuest(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleOpposingFactionDestroyQuest(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public boolean removeTraderRepairScriptVars(obj_id player)
    {
        if (!isValidId(player) || !exists(player))
        {
            return false;
    ...
    public int notifyPlayerOfGcwCityEventAnnouncement(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int onGcwFactionalPresenceTableDictionaryResponse(obj_id self, dictionary params)
    {
    ...
    public int onGcwPersonalContributionTableDictionaryResponse(obj_id self, dictionary params)
    {
    ...
    public int onGcwRegionDefenderTableDictionaryResponse(obj_id self, dictionary params)
    {
    ...
    public int onGcwRegionDefenderDetailsTableDictionaryResponse(obj_id self, dictionary params)
    {
        if (utils.hasScriptVar(self, "gcw.gcwRegionDefenderDetailsTablePid"))
        {
            utils.removeScriptVar(self, "gcw.gcwRegionDefenderDetailsTablePid");
    ...
    public int handleGcwCityHelpUi(obj_id self, dictionary params)
    {
    ...
    public int playIconicGCWWrapUpMessage(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleCityGcwRegionDefenderChoice(obj_id self, dictionary params)
    {
        final int bp = sui.getIntButtonPressed(params);
        if (bp != sui.BP_OK)
        {
