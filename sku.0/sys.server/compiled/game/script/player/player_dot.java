...
public class player_dot extends script.base_script
{
    ...
    public int OnAttribModDone(obj_id self, String modName, boolean isDead)
    {
        if (false)
        {
    ...
    public int OnBuffDotPulse(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int bleedingStopped(obj_id self, dictionary params)
    {
        return SCRIPT_CONTINUE;
    }
    public int OnDotGraceEnd(obj_id self, dictionary params)
    {
        if (utils.hasScriptVar(self, dot.SCRIPT_VAR_DOT_GRACE))
        {
            utils.removeScriptVar(self, dot.SCRIPT_VAR_DOT_GRACE);
