...
public class species_innate extends script.base_script
{
    ...
    public int cmdInnate(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdInnateFail(obj_id self, obj_id target, String params, float defaultTime)
    {
        return SCRIPT_CONTINUE;
    }
    public int cmdRegeneration(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdVitalize(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdEquilibrium(obj_id self, obj_id target, String params, float defaultTime)
    {
