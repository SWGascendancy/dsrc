...
public class player_travel extends script.base_script
{
    ...
    public static final int SHIP_TYPE_INSTANT_SNOWSPEEDER = 7;
    public static final int SHIP_TYPE_INSTANT_SLAVE1 = 8;
    ...
    public int OnAboutToTravelToGroupPickupPoint(obj_id self)
    {
    ...
    public int OnTravelToGroupPickupPoint(obj_id self, String planetName, String travelPointName)
    {
        travel.movePlayerToDestination(self, planetName, travelPointName, true);
        return SCRIPT_CONTINUE;
    }
    public int msgTicketPaymentFail(obj_id self, dictionary params)
    {
    ...
    public int msgUseTravelCouponSui(obj_id self, dictionary params)
    {
    ...
    public int msgTicketPaymentComplete(obj_id self, dictionary params)
    {
    ...
    public int msgTravelComplete(obj_id self, dictionary params)
    {
    ...
    public int msgBoardShuttle(obj_id self, dictionary params)
    {
    ...
    public int msgTravelToStarport(obj_id self, dictionary params)
    {
    ...
    public int msgSelectDungeonTicket(obj_id self, dictionary params)
    {
        String button = params.getString("buttonPressed");
        if (button.equals("Cancel") || button.equals("No"))
        {
    ...
    public int msgDungeonTravelComplete(obj_id self, dictionary params)
    {
    ...
    public int msgDungeonTravelConfirmed(obj_id self, dictionary params)
    {
    ...
    public int msgDungeonGroupTravelComplete(obj_id self, dictionary params)
    {
    ...
    public int msgCloseDungeonTravel(obj_id self, dictionary params)
    {
        if (utils.hasScriptVar(self, space_dungeon.SCRIPT_VAR_DUNGEON_PENDING) || utils.hasScriptVar(self, space_dungeon.SCRIPT_VAR_DUNGEON_ID_PENDING))
        {
    ...
    public int handleConfirmGcwTravelSurcharge(obj_id self, dictionary params)
    {
        if (!utils.hasScriptVar(self, SCRIPTVAR_ACCEPT_GCW_SURCHARGE_SUI_ID))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleConfirmGcwTravelRestrictionSkipShuttleWait(obj_id self, dictionary params)
    {
        if (!utils.hasScriptVar(self, SCRIPTVAR_ACCEPT_GCW_SURCHARGE_SUI_ID))
        {
            return SCRIPT_CONTINUE;
    ...
    public int boardShuttle(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public void debugLogging(String section, String message)
    {
    ...
    public int callForPickup(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (travel.isTravelBlocked(self, false))
        {
            return SCRIPT_CONTINUE;
    ...
    public int callForSnowspeederPickup(obj_id self, obj_id target, String params, float defaultTime)
    {
        debugLogging("//***// commandHandler : callForSnowspeeder", "////>>>> ENTERED");
        if (travel.isTravelBlocked(self, false))
        {
            return SCRIPT_CONTINUE;
        }
        if (canCallForPickup(self))
        {
            debugLogging("//***// commandHandler : callForSnowspeeder", "////>>>> player CAN call for pickup. Executing shuttle spawn sequence.");
            sendSystemMessage(self, SID_CALLING_FOR_PICKUP);
            spawnPickupCraft(self, SHIP_TYPE_INSTANT_SNOWSPEEDER);
        }
        return SCRIPT_CONTINUE;
    }
    public int callForSlave1Pickup(obj_id self, obj_id target, String params, float defaultTime)
    {
        debugLogging("//***// commandHandler : callForSlave1Pickup", "////>>>> ENTERED");
        if (travel.isTravelBlocked(self, false))
        {
            return SCRIPT_CONTINUE;
        }
        if (canCallForPickup(self))
        {
            debugLogging("//***// commandHandler : callForSlave1Pickup", "////>>>> player CAN call for pickup. Executing shuttle spawn sequence.");
            sendSystemMessage(self, SID_CALLING_FOR_PICKUP);
            spawnPickupCraft(self, SHIP_TYPE_INSTANT_SLAVE1);
        }
        return SCRIPT_CONTINUE;
    }
    public int callForPrivateerPickup(obj_id self, obj_id target, String params, float defaultTime)
    {
        debugLogging("//***// commandHandler : callForPrivateerPickup", "////>>>> ENTERED");
        if (travel.isTravelBlocked(self, false))
        {
            return SCRIPT_CONTINUE;
        }
        if (canCallForPickup(self))
        {
            debugLogging("//***// commandHandler : callForPrivateerPickup", "////>>>> player CAN call for pickup. Executing shuttle spawn sequence.");
            sendSystemMessage(self, SID_CALLING_FOR_PICKUP);
            spawnPickupCraft(self, SHIP_TYPE_INSTANT_PRIVATEER);
        }
        return SCRIPT_CONTINUE;
    }
    public int callForRattleTrapPickup(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int callForRoyalPickup(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int callForTcgHomePickup(obj_id self, obj_id target, String params, float defaultTime)
    {
        debugLogging("//***// commandHandler : callForPickup", "////>>>> ENTERED");
        if (travel.isTravelBlocked(self, false))
        {
    ...
    public int callForTcgLocationPickup(obj_id self, obj_id target, String params, float defaultTime)
    {
        debugLogging("//***// commandHandler : callForPickup", "////>>>> ENTERED");
        if (travel.isTravelBlocked(self, false))
        {
    ...
    public boolean canCallForPickup(obj_id player)
    {
    ...
    public boolean spawnPickupCraft(obj_id player, int type)
    {
        if (!isIdValid(player))
        {
            return false;
        ...
        else if (type == SHIP_TYPE_INSTANT_SNOWSPEEDER)
        {
            pickupCraftType = "object/tangible/terminal/terminal_travel_instant_snowspeeder.iff";
        }
        else if (type == SHIP_TYPE_INSTANT_SLAVE1)
        {
            pickupCraftType = "object/tangible/terminal/terminal_travel_instant_tcg_slave_1.iff";
        }
    ...
    public int groupMemberLocationRequestHandler(obj_id self, dictionary params)
    {
