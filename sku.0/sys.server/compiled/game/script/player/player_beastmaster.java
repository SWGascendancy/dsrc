...
public class player_beastmaster extends script.base_script
{
    ...
    public int OnSkillGranted(obj_id self, String skill)
    {
    ...
    public int OnSkillRevoked(obj_id self, String skill)
    {
        if (skill.equals("expertise_bm_attack_1"))
        {
            obj_id beast = beast_lib.getBeastOnPlayer(self);
    ...
    public void showBeastExperienceGain(obj_id self)
    {
        obj_id beast = beast_lib.getBeastOnPlayer(self);
        if (!beast_lib.isValidBeast(beast))
        {
    ...
    public void showHappiness(obj_id self)
    {
    ...
    public void setupHappinessMenu(obj_id self)
    {
        if (!isIdValid(self) || !exists(self) || !isGod(self))
        {
            return;
    ...
    public int handleFavoriteFoodMenu(obj_id self, dictionary params)
    {
        if (!isGod(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleHatedFoodMenu(obj_id self, dictionary params)
    {
        if (!isGod(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleFavoriteActivityMenu(obj_id self, dictionary params)
    {
        if (!isGod(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleHatedActivityMenu(obj_id self, dictionary params)
    {
        if (!isGod(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleFavoriteLocationMenu(obj_id self, dictionary params)
    {
        if (!isGod(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleHatedLocationMenu(obj_id self, dictionary params)
    {
        if (!isGod(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int channelRevivePet(obj_id self, dictionary params)
    {
    ...
    public int checkChannelRevivePet(obj_id self, dictionary params)
    {
        if (!utils.hasScriptVar(self, "bm_revive.suiPid"))
        {
    ...
    public void reviveBeast(obj_id self, obj_id beast)
    {
        obj_id bcd = beast_lib.getBeastBCD(beast);
    ...
    public int bm_follow_1(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id beast = beast_lib.getBeastOnPlayer(self);
    ...
    public int bm_stay_1(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id beast = beast_lib.getBeastOnPlayer(self);
        if (!isIdValid(beast) || !exists(beast))
        {
    ...
    public int bm_pet_attack_1(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id beast = beast_lib.getBeastOnPlayer(self);
        if (!isIdValid(beast) || !exists(beast))
        {
    ...
    public int bm_pet_trick_1(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id beast = beast_lib.getBeastOnPlayer(self);
        if (!isIdValid(beast) || !exists(beast))
        {
    ...
    public int bm_pet_trick_2(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id beast = beast_lib.getBeastOnPlayer(self);
        if (!isIdValid(beast) || !exists(beast))
        {
    ...
    public int bm_pet_trick_3(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id beast = beast_lib.getBeastOnPlayer(self);
        if (!isIdValid(beast) || !exists(beast))
        {
    ...
    public int performCreatureAbility(obj_id self, dictionary params)
    {
    ...
    public int cmdTrainPet(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id pet = beast_lib.getBeastOnPlayer(self);
    ...
    public void createTrainingSui(obj_id player, obj_id pet)
    {
    ...
    public int handlePetTrainingDialog(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
    ...
    public int handlePetTrainingUpdate(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            setPetTrainPid(self, -1);
    ...
    public String getPetAbilityDescription(String ability)
    {
        String desc = "";
        return desc;
    }
    public int bm_creature_knowledge(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int completeTheZipTimer(obj_id self, dictionary params)
    {
    ...
    public int bm_pig_forage(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id player = self;
    ...
    public int bm_helper_monkey_domestic(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id player = self;
    ...
    public int bm_helper_monkey_engineering(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id player = self;
    ...
    public int bm_helper_monkey_structure(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id player = self;
    ...
    public int bm_helper_monkey_munitions(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id player = self;
    ...
    public int bm_helper_monkey_jedi(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id player = self;
    ...
    public int bm_helper_monkey_shipwright(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id player = self;
    ...
    public int bm_dancing_cat(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id player = self;
    ...
    public int destroyHoloPets(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int bm_dancing_pet_entertainer(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int bm_survey_bonus(obj_id self, obj_id target, String params, float defaultTime)
    {
