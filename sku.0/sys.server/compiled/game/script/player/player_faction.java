...
public class player_faction extends script.base_script
{
    ...
    public int cmdPVP(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int OnEnterRegion(obj_id self, String planet, String name)
    {
    ...
    public int OnCreatureDamaged(obj_id self, obj_id attacker, obj_id wpn, int[] damage)
    {
    ...
    public int msgResignFromFaction(obj_id self, dictionary params)
    {
    ...
    public int msgGoCovert(obj_id self, dictionary params)
    {
    ...
    public int msgGoOnLeave(obj_id self, dictionary params)
    {
        if (hasScript(self, "force_rank_light_novice") || hasScript(self, "force_rank_dark_novice"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int msgGoOvert(obj_id self, dictionary params)
    {
        if (hasScript(self, "force_rank_light_novice") || hasScript(self, "force_rank_dark_novice"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int gcwStatus(obj_id self, obj_id target, String params, float defaultTime)
    {
        string_id strSpam = new string_id("gcw", "gcw_status_info");
        sendSystemMessage(self, strSpam);
        return SCRIPT_CONTINUE;
    }
    public int cmdDelegateFactionPoints(obj_id self, obj_id target, String params, float defaultTime)
    {
        factions.delegateFactionPoints(self, target, params);
        return SCRIPT_CONTINUE;
    }
    public int handleDelegateSui(obj_id self, dictionary params)
    {
    ...
    public int handleLeaveFactionSui(obj_id self, dictionary params)
    {
        LOG("gcw", "got mst");
    ...
    public int handleGoCovert(obj_id self, dictionary params)
    {
    ...
    public int handleGoOvert(obj_id self, dictionary params)
    {
        if (hasObjVar(self, "intChangingFactionStatus"))
        {
            LOG("gcw", "objvar");
    ...
    public int recievePvpRegionBonus(obj_id self, dictionary params)
    {
    ...
    public int cmdFactionalHelper(obj_id self, obj_id target, String params, float defaultTime)
    {
        factions.neutralMercenaryStatusMenu(self);
        return SCRIPT_CONTINUE;
    }
    public int handleFactionalHelperChoice(obj_id self, dictionary params)
    {
    ...
    public int executeFactionalHelperChoice(obj_id self, dictionary params)
    {
        if (0 != pvpGetAlignedFaction(self))
        {
            sendSystemMessage(self, "You must be a Civilian to be a factional helper.", "");
    ...
    public int cmdGcwScore(obj_id self, obj_id target, String params, float defaultTime)
    {
        showGcwScoreboard(self);
        return SCRIPT_CONTINUE;
    }
    public int cmdGcwSkirmishCityHelp(obj_id self, obj_id target, String params, float defaultTime)
    {
        gcw.gcwCityHelpText(self);
        return SCRIPT_CONTINUE;
    }
    public int displayGcwScoreSui(obj_id self, dictionary params)
    {
        showGcwScoreboard(self);
        return SCRIPT_CONTINUE;
    }
    public void showGcwScoreboard(obj_id self)
    {
