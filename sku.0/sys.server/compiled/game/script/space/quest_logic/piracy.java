...
public class piracy extends script.base_script
{
    ...
    public int startBeacon(obj_id self, dictionary params)
    {
        if (!isSpaceScene())
        {
    ...
    public int startPiracyEvent(obj_id self, dictionary params)
    {
    ...
    public void generateShipList(obj_id self)
    {
    ...
    public void warpInTargetShip(obj_id self, String targetShipType)
    {
        obj_id player = getObjIdObjVar(self, "player");
        if (!isIdValid(player) || !exists(player))
        {
    ...
    public void warpInEscortShips(obj_id self, String[] escortShips)
    {
        obj_id player = getObjIdObjVar(self, "player");
        if (!isIdValid(player) || !exists(player))
        {
    ...
    public int startMovement(obj_id self, dictionary params)
    {
    ...
    public int cleanupPiracyEvent(obj_id self, dictionary params)
    {
        obj_id targetShip = getObjIdObjVar(self, "targetShip");
        obj_id waypoint = getObjIdObjVar(self, "spacepiracy.waypoint");
        obj_id player = getObjIdObjVar(self, "player");
    ...
    public int eventTimer(obj_id self, dictionary params)
    {
        obj_id targetShip = getObjIdObjVar(self, "targetShip");
        if (!exists(targetShip) || !isIdValid(targetShip))
        {
