...
public class space_battle extends script.base_script
{
    ...
    public void findBattleLoc(obj_id self, obj_id player, String destNav)
    {
    ...
    public int armyArrives(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int shipArrived(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int convo(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int winMission(obj_id self, dictionary params)
    {
        obj_id player = getObjIdObjVar(self, space_quest.QUEST_OWNER);
        String questName = getStringObjVar(self, space_quest.QUEST_NAME);
        String questType = getStringObjVar(self, space_quest.QUEST_TYPE);
    ...
    public int loseMission(obj_id self, dictionary params)
    {
        questFailed(self);
        return SCRIPT_OVERRIDE;
    }
    ...
    public void warpOutShips(obj_id self)
    {
        obj_id[] allies = getObjIdArrayObjVar(self, "allies");
        if (allies != null)
        {
