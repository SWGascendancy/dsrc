...
public class escort_duty extends script.base_script
{
    ...
    public void buildRandomNavList(obj_id self)
    {
        obj_id player = getObjIdObjVar(self, space_quest.QUEST_OWNER);
        String[] escortPoints = getStringArrayObjVar(self, "escortPoints");
        if (escortPoints == null)
    ...
    public void registerEscortLocation(obj_id self, obj_id player, String destNav)
    {
    ...
    public int warpShipDelay(obj_id self, dictionary params)
    {
        String name = params.getString("name");
        obj_id player = params.getObjId("player");
        location loc = params.getLocation("loc");
    ...
    public obj_id warpInEscortShip(obj_id self)
    {
    ...
    public transform[] getEscortTransforms(obj_id self)
    {
    ...
    public int escortComplete(obj_id self, dictionary params)
    {
        if (params == null)
        {
    ...
    public int escortFailed(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_OVERRIDE;
    ...
    public void questFailed(obj_id self, boolean split)
    {
        clearMissionWaypoint(self);
        obj_id player = getObjIdObjVar(self, space_quest.QUEST_OWNER);
