...
public class inspect extends script.base_script
{
    ...
    public int notifyTargetWaypoints(obj_id self, dictionary params)
    {
        int added = params.getInt("added");
        space_quest.showQuestUpdate(self, SID_TARGET_WAYPOINTS, added);
        return SCRIPT_CONTINUE;
    }
    public int createdWaypointToSpawner(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public void clearTargetWaypoints(obj_id self)
    {
        obj_id player = getObjIdObjVar(self, space_quest.QUEST_OWNER);
        obj_id[] waypoints = getObjIdArrayObjVar(self, "target_waypoints");
        if (waypoints != null)
    ...
    public boolean checkSpecialEvent(obj_id self, obj_id player, int inspectCount)
    {
    ...
    public int inspectedShip(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int recoveredCargo(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
