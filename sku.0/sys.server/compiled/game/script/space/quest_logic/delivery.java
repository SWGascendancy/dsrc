...
public class delivery extends script.base_script
{
    ...
    public void registerQuestLocation(obj_id self, obj_id player, String destNav)
    {
    ...
    public int warpPickupShipDelay(obj_id self, dictionary params)
    {
        String name = params.getString("name");
        obj_id player = params.getObjId("player");
        location loc = params.getLocation("loc");
    ...
    public obj_id warpInShip(obj_id self, String var)
    {
        obj_id player = getObjIdObjVar(self, space_quest.QUEST_OWNER);
    ...
    public int warpDeliveryShipDelay(obj_id self, dictionary params)
    {
        String name = params.getString("name");
        obj_id player = params.getObjId("player");
        location loc = params.getLocation("loc");
    ...
    public int sayHello(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int dockingStarted(obj_id self, dictionary params)
    {
        obj_id player = getObjIdObjVar(self, space_quest.QUEST_OWNER);
        String questName = getStringObjVar(self, space_quest.QUEST_NAME);
        String questType = getStringObjVar(self, space_quest.QUEST_TYPE);
    ...
    public int dockingComplete(obj_id self, dictionary params)
    {
        obj_id player = getObjIdObjVar(self, space_quest.QUEST_OWNER);
        String questName = getStringObjVar(self, space_quest.QUEST_NAME);
        String questType = getStringObjVar(self, space_quest.QUEST_TYPE);
    ...
    public int findDeliveryPoint(obj_id self, dictionary params)
    {
        obj_id player = getObjIdObjVar(self, space_quest.QUEST_OWNER);
        dictionary outparams = new dictionary();
        outparams.put("player", player);
    ...
    public int finishQuest(obj_id self, dictionary params)
    {
        questCompleted(self);
        return SCRIPT_CONTINUE;
    }
    public void cleanUpTransports(obj_id self, boolean keepDelivery)
    {
        obj_id ship = getObjIdObjVar(self, "pickup_ship");
    ...
    public boolean checkSpecialEvent(obj_id self, obj_id player, int attackCount)
    {
    ...
    public int deliveryTargetDestroyed(obj_id self, dictionary params)
    {
