...
public class player_spacequest extends script.base_script
{
    ...
    public int handleAsteroidMined(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleShipSalvage(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int doSpecialEvent(obj_id self, dictionary params)
    {
    ...
    public void splitQuest(obj_id self, String triggerArg, int triggerOn, String questName, String questType, boolean failure)
    {
        if (failure)
        {
    ...
    public int registerDelayedQuest(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int assignDelayedQuest(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int cmdInspect(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (target == null)
        {
    ...
    public int finishInspection(obj_id self, dictionary params)
    {
        if (!utils.hasScriptVar(self, "inspecting"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int cmdDock(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (target == null)
        {
            sendQuestSystemMessage(self, SID_NO_TARGET);
    ...
    public int spaceUnitDocked(obj_id self, dictionary params)
    {
        sendQuestSystemMessage(self, SID_DOCK_ACHIEVED);
        return SCRIPT_CONTINUE;
    }
    public int spaceUnitUnDocked(obj_id self, dictionary params)
    {
    ...
    public boolean canTransferCargo(obj_id self, obj_id target)
    {
        if (!hasObjVar(target, "cargo"))
        {
            return false;
    ...
    public void finishTransfer(obj_id self, obj_id target)
    {
        String cargo = getStringObjVar(target, "cargo");
