...
public class escort_target extends script.base_script
{
    ...
    public int registerDestination(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int checkPlayerLocation(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int missionAbort(obj_id self, dictionary params)
    {
        destroyObjectHyperspace(self);
        return SCRIPT_CONTINUE;
    }
    public int OnShieldsDepleted(obj_id self, dictionary params)
    {
    ...
    public int OnHullNearlyDestroyed(obj_id self, dictionary params)
    {
