...
public class patrol extends script.base_script
{
    ...
    public void registerPatrolWaypoint(obj_id self, obj_id player, String destNav)
    {
    ...
    public boolean hasPendingSplit(obj_id self)
    {
    ...
    public void setPendingSplit(obj_id self, boolean state)
    {
        setObjVar(self, "pendingSplit", state);
    }
    public int handleDelayedQuestComplete(obj_id self, dictionary params)
    {
        if (hasPendingSplit(self))
        {
            messageTo(self, "handleDelayedQuestComplete", null, 10, false);
    ...
    public void clearPatrolWaypoints(obj_id self)
    {
        obj_id player = getObjIdObjVar(self, space_quest.QUEST_OWNER);
        obj_id waypoint = getObjIdObjVar(self, "patrol_waypoint");
        if (isIdValid(waypoint))
    ...
    public boolean checkSpecialEvent(obj_id self, obj_id player, int currentNav)
    {
