...
public class recovery extends script.base_script
{
    ...
    public void findTargetStart(obj_id self, obj_id player, String destNav)
    {
    ...
    public int warpInTarget(obj_id self, dictionary params)
    {
        obj_id player = getObjIdObjVar(self, space_quest.QUEST_OWNER);
        String questName = getStringObjVar(self, space_quest.QUEST_NAME);
        String questType = getStringObjVar(self, space_quest.QUEST_TYPE);
    ...
    public obj_id createTargetShip(obj_id self)
    {
    ...
    public transform[] getPathTransforms(obj_id self, boolean escort)
    {
    ...
    public int recoverShipDisabled(obj_id self, dictionary params)
    {
    ...
    public int recoverPhase1(obj_id self, dictionary params)
    {
        obj_id ship = getObjIdObjVar(self, "target");
        obj_id player = getObjIdObjVar(self, space_quest.QUEST_OWNER);
    ...
    public String getCapturePhrase1(obj_id self)
    {
        return "capture_phase_1";
    }
    public int recoverPhase2(obj_id self, dictionary params)
    {
        obj_id ship = getObjIdObjVar(self, "target");
        obj_id player = getObjIdObjVar(self, space_quest.QUEST_OWNER);
        String questName = getStringObjVar(self, space_quest.QUEST_NAME);
    ...
    public String getCapturePhrase2(obj_id self)
    {
        return "capture_phase_2";
    }
    public int startCapturedShipPathing(obj_id self, dictionary params)
    {
        obj_id ship = getObjIdObjVar(self, "target");
        obj_id player = getObjIdObjVar(self, space_quest.QUEST_OWNER);
    ...
    public int recoveryComplete(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public String getCompletePhrase(obj_id self)
    {
        return "complete";
    }
    public int recoveryFailed(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int updateTargetWaypoint(obj_id self, dictionary params)
    {
    ...
    public void clearMissionWaypoint(obj_id self)
    {
        if(isIdValid(self)) {
            obj_id player = getObjIdObjVar(self, space_quest.QUEST_OWNER);
            obj_id waypoint = getObjIdObjVar(self, "waypoint");
    ...
    public void questCompleted(obj_id self)
    {
        clearMissionWaypoint(self);
        obj_id player = getObjIdObjVar(self, space_quest.QUEST_OWNER);
        space_quest.setQuestWon(player, self);
    }
    public int completeQuestMsg(obj_id self, dictionary params)
    {
        questCompleted(self);
        return SCRIPT_CONTINUE;
    }
    public void questFailed(obj_id self)
    {
        clearMissionWaypoint(self);
        obj_id player = getObjIdObjVar(self, space_quest.QUEST_OWNER);
        space_quest.setQuestFailed(player, self);
    }
    public void questAborted(obj_id self)
    {
        clearMissionWaypoint(self);
        obj_id player = getObjIdObjVar(self, space_quest.QUEST_OWNER);
        space_quest.setQuestAborted(player, self);
    }
    public int removeQuest(obj_id self, dictionary params)
    {
        obj_id player = getObjIdObjVar(self, space_quest.QUEST_OWNER);
        String questName = getStringObjVar(self, space_quest.QUEST_NAME);
        String questType = getStringObjVar(self, space_quest.QUEST_TYPE);
    ...
    public int handleShipDestroyed(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int cleanupShipsMsg(obj_id self, dictionary params)
    {
        cleanupShips(self);
        return SCRIPT_CONTINUE;
    }
    public void questUpdate(obj_id self, string_id update_id)
    {
        obj_id player = getObjIdObjVar(self, space_quest.QUEST_OWNER);
        String questName = getStringObjVar(self, space_quest.QUEST_NAME);
        String questType = getStringObjVar(self, space_quest.QUEST_TYPE);
    ...
    public int launchAttack(obj_id self, dictionary params)
    {
    ...
    public int warpoutFailureRecovery(obj_id self, dictionary params)
    {
