...
public class spawner extends script.base_script
{
    ...
    public int getSpawnerData(obj_id self, dictionary params)
    {
    ...
    public boolean isSpawnerActivated(obj_id self)
    {
    ...
    public int startSpawning(obj_id self, dictionary params)
    {
    ...
    public int spawnNextWave(obj_id self, dictionary params)
    {
        if (!isSpawnerActivated(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int createSpawns(obj_id self, dictionary params)
    {
        if (!isSpawnerActivated(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int createAsteroidSpawn(obj_id self, dictionary params)
    {
        if (!isSpawnerActivated(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public void setupSpawnerSpawn(obj_id objShip, obj_id self)
    {
    ...
    public void setupSpawnerSpawn(Vector objMembers, obj_id self)
    {
    ...
    public int childDestroyed(obj_id self, dictionary params)
    {
        if (!isSpawnerActivated(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int respawnAsteroid(obj_id self, dictionary params)
    {
        if (!isSpawnerActivated(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int respawnShip(obj_id self, dictionary params)
    {
        if (!isSpawnerActivated(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public obj_id createGenericSpawn(obj_id objSpawner, String strShipType, float fltMinDistance, float fltMaxDistance, boolean boolRandomizeOrientation)
    {
        obj_id objShip = null;
    ...
    public obj_id createAsteroidSpawn(obj_id objSpawner, String strAsteroidType, int intMinResourcePool, int intMaxResourcePool, int intDangerLevel, int intDangerPct)
    {
    ...
    public int destroyableCreated(obj_id self, dictionary params)
    {
    ...
    public void addDestroyable(obj_id objParent, obj_id objDestroyable)
    {
        obj_id self = getSelf();
    ...
    public void RemoveDestroyable(obj_id objParent, obj_id objDestroyable)
    {
        obj_id self = getSelf();
        obj_id objMom = getObjIdObjVar(objParent, "objParent");
        dictionary dctParams = new dictionary();
    ...
    public boolean isSquad(String strSpawn)
    {
