...
public class interdiction_terminal extends script.base_script
{
    ...
    public void createWaypoint(obj_id self, obj_id player)
    {
        if (!isIdValid(player) || !isIdValid(self))
        {
            return;
    ...
    public boolean isRegionValid(obj_id self)
    {
        if (!isIdValid(self))
        {
            return false;
    ...
    public boolean atLocation(obj_id self, obj_id player)
    {
        if (!isIdValid(player) || !isIdValid(self))
        {
            return false;
    ...
    public void startEvent(obj_id self, obj_id player)
    {
        if (!isIdValid(player) || !isIdValid(self))
        {
            return;
