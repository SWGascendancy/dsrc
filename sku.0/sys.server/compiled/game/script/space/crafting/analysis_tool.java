...
public class analysis_tool extends script.base_script
{
    ...
    public boolean calculateFiresprayGrant(obj_id[] contents, obj_id player)
    {
        int numKuat = 0;
    ...
    public float getReverseEngineeringExpertiseBonus(obj_id player)
    {
    ...
    public obj_id createLegendaryLoot(obj_id player, obj_id tool, String category)
    {
    ...
    public obj_id reverseEngineerArmor(obj_id[] objComponents, obj_id player, int level)
    {
    ...
    public obj_id reverseEngineerBooster(obj_id[] objComponents, obj_id player, int level)
    {
    ...
    public obj_id reverseEngineerCapacitor(obj_id[] objComponents, obj_id player, int level)
    {
    ...
    public obj_id reverseEngineerDroidInterface(obj_id[] objComponents, obj_id player, int level)
    {
        int revSkill = getSkillStatisticModifier(player, "systems_reverse");
        if (level > revSkill)
        {
    ...
    public obj_id reverseEngineerEngine(obj_id[] objComponents, obj_id player, int level)
    {
        int revSkill = getSkillStatisticModifier(player, "propulsion_reverse");
        if (level > revSkill)
        {
    ...
    public obj_id reverseEngineerReactor(obj_id[] objComponents, obj_id player, int level)
    {
        int revSkill = getSkillStatisticModifier(player, "systems_reverse");
        if (level > revSkill)
        {
    ...
    public obj_id reverseEngineerShield(obj_id[] objComponents, obj_id player, int level)
    {
    ...
    public obj_id reverseEngineerWeapon(obj_id[] objComponents, obj_id player, int level)
    {
        int revSkill = getSkillStatisticModifier(player, "defense_reverse");
        if (level > revSkill)
        {
    ...
    public void finishReverseEngineering(obj_id newComponent, obj_id player, obj_id[] objComponents, String[] entries)
    {
