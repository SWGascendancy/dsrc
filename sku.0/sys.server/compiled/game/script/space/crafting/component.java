...
public class component extends script.base_script
{
    ...
    public int OnObjectMenuSelect(obj_id self, obj_id objPlayer, int item)
    {
    ...
    public int startCollectionReactorReplacement(obj_id self, dictionary params)
    {
        String objectName = getName(self);
    ...
    public int destroyDeprecatedCollectionReactor(obj_id self, dictionary params)
    {
        CustomerServiceLog("ShipComponents", "Component: (" + self + ") " + getName(self) + " is about to be destroyed. Good bye world!");
        destroyObject(self);
        return SCRIPT_CONTINUE;
    }
    public int handlerReInitialize(obj_id self, dictionary params)
    {
    ...
    public boolean getUsableContainer(obj_id self, obj_id container)
    {
        String objectName = getName(self);
    ...
    public boolean uninstallDeleteReplaceCollectionReactor(obj_id self, obj_id container)
    {
        String objectName = getName(self);
    ...
    public boolean uninstallDeleteReplaceCollectionReactor(obj_id self, obj_id container, location objLocation)
    {
        String objectName = getName(self);
