...
public class component_name_handler extends script.base_script
{
    ...
    public int handleComponentNameSui(obj_id self, dictionary params)
    {
    ...
    public int handleSetComponentName(obj_id self, dictionary params)
    {
        int intButton = sui.getIntButtonPressed(params);
        if (intButton == sui.BP_CANCEL)
        {
    ...
    public void showComponentNameSui(obj_id owner, obj_id target)
    {
