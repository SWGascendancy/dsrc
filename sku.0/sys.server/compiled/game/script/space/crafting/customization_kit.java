...
public class customization_kit extends script.base_script
{
    ...
    public int handleKitColorizeOne(obj_id self, dictionary params)
    {
    ...
    public int handleKitColorizeTwo(obj_id self, dictionary params)
    {
        int bp = sui.getIntButtonPressed(params);
        int idx = sui.getListboxSelectedRow(params);
        if (bp == sui.BP_CANCEL)
    ...
    public int handleFirstColorize(obj_id self, dictionary params)
    {
    ...
    public int handleSecondColorize(obj_id self, dictionary params)
    {
        int idx = sui.getColorPickerIndex(params);
        int bp = sui.getIntButtonPressed(params);
        obj_id player = sui.getPlayerId(params);
