...
public class ship_control_device extends script.base_script
{
    ...
    public int OnGetAttributes(obj_id self, obj_id objPlayer, String[] strNames, String[] strAttribs)
    {
    ...
    public int OnTransferred(obj_id self, obj_id source, obj_id destination, obj_id transferer)
    {
    ...
    public int forceCollectionReactorInit(obj_id self, dictionary params)
    {
        messageTo(self, "checkCollectionReactor", null, 2, false);
        return SCRIPT_CONTINUE;
    }
    public int checkCollectionReactor(obj_id self, dictionary params)
    {
    ...
    public int cargoList(obj_id self, dictionary params)
    {
        return SCRIPT_CONTINUE;
    }
    public int renameShip(obj_id self, dictionary params)
    {
    ...
    public obj_id packShipDeed(obj_id pcd, obj_id ship, obj_id player)
    {
        String type = getShipChassisType(ship);
    ...
    public void pobShipLotRefunder(obj_id pcd)
    {
    ...
    public boolean giveResourceReward(obj_id objResourceId, obj_id player, int intAmount, obj_id objShip)
    {
    ...
    public obj_id getResourceStack(obj_id objContainer, obj_id objResource)
    {
    ...
    public void gunshipCheck(obj_id objShip)
    {
        if (!isIdValid(objShip))
        {
            return;
    ...
    public boolean blog(String category, String msg)
    {
        return true;
    }
}
