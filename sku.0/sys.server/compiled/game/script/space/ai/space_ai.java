...
public class space_ai extends script.base_script
{
    ...
    public int OnShipBehaviorChanged(obj_id self, int oldBehavior, int newBehavior)
    {
        return SCRIPT_CONTINUE;
    }
    public void setupShip(obj_id ship)
    {
    ...
    public int OnSpaceUnitDocked(obj_id self, obj_id objStation)
    {
    ...
    public int handleUnitIncreaseHate(obj_id self, dictionary params)
    {
