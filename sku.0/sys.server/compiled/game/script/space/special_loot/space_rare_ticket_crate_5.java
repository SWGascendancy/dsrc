...
public class space_rare_ticket_crate_5 extends script.base_script
{
    public space_rare_ticket_crate_5()
    {
    }
    public static final string_id SID_OPEN_CRATE = new string_id("spam", "open_crate");
    public static final String LOOT_LIST = "datatables/space_loot/rare/tier5.iff";
