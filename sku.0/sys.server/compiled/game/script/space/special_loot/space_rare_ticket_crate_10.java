...
public class space_rare_ticket_crate_10 extends script.base_script
{
    public space_rare_ticket_crate_10()
    {
    }
    public static final string_id SID_OPEN_CRATE = new string_id("spam", "open_crate");
    public static final String LOOT_LIST = "datatables/space_loot/rare/tier10.iff";
