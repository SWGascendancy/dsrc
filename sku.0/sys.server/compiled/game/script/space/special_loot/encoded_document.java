...
public class encoded_document extends script.base_script
{
    ...
    public obj_id getWaypoint(obj_id self, obj_id player)
    {
    ...
    public void displayDialog(obj_id self, obj_id player)
    {
    ...
    public int createDialog(obj_id self, obj_id player, String text, String title)
    {
        if (player == null)
        {
            return -1;
    ...
    public void storeWaypoint(obj_id self, obj_id player)
    {
        dictionary eventEntry = dataTableGetRow(EVENT_TABLE, getIntObjVar(self, VAR_INDEX));
    ...
    public void doAction(obj_id self, obj_id player)
    {
        dictionary eventEntry = dataTableGetRow(EVENT_TABLE, getIntObjVar(self, VAR_INDEX));
        String entryName = eventEntry.getString("eventName");
        String scene = getCurrentSceneName();
    ...
    public int timerDone(obj_id self, dictionary params)
    {
        dictionary eventEntry = dataTableGetRow(EVENT_TABLE, getIntObjVar(self, VAR_INDEX));
        String entryName = eventEntry.getString("eventName");
        String scene = getCurrentSceneName();
    ...
    public transform[] getEnemyPatrolTransforms(obj_id self, String[] navPoints)
    {
