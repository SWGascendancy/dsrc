...
public class ship_interior extends script.base_script
{
    ...
    public int doInteriorBuildout(obj_id self, dictionary params)
    {
    ...
    public int componentDisabledByDamage(obj_id self, dictionary params)
    {
    ...
    public int checkAmmoStatus(obj_id self, dictionary params)
    {
        obj_id objShip = self;
        int intSlot = params.getInt("intSlot");
    ...
    public int componentEfficiencyChanged(obj_id self, dictionary params)
    {
        int intSlot = params.getInt("intSlot");
        obj_id objManager = utils.getObjIdScriptVar(self, "objInteriorManager" + intSlot);
    ...
    public int interiorDamageNotification(obj_id self, dictionary params)
    {
    ...
    public void playRandomInteriorClientEffects(obj_id objPlayer, transform[] trSparkers, obj_id[] objCells, String[] strEffects, int[] intDamageEffects, int intRolls, int intChance)
    {
    ...
    public void checkForAdditionalDamage(obj_id objShip, int intChance, int[] intSlots)
    {
    ...
    public int doHullBreach(obj_id self, dictionary params)
    {
