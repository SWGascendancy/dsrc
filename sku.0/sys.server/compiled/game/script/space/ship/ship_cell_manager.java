...
public class ship_cell_manager extends script.base_script
{
    ...
    public int incrementDotDamage(obj_id self, dictionary params)
    {
    ...
    public int decrementDotDamage(obj_id self, dictionary params)
    {
        int intSlot = params.getInt("intSlot");
        int intDamage = utils.getIntScriptVar(self, "intDamage");
        intDamage = intDamage - 100;
    ...
    public int OnReceivedItem(obj_id self, obj_id objDestContainer, obj_id objTransferer, obj_id objItem)
    {
        if (isPlayer(objItem))
        {
            int intDamage = utils.getIntScriptVar(self, "intDamage");
    ...
    public int OnLostItem(obj_id self, obj_id objDestContainer, obj_id objTransferer, obj_id objItem)
    {
        if (isPlayer(objItem))
        {
