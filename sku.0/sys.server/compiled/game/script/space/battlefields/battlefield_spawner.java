...
public class battlefield_spawner extends script.base_script
{
    ...
    public int setupAttackTarget(obj_id self, dictionary params)
    {
    ...
    public int singleAttackerSpawned(obj_id self, dictionary params)
    {
    ...
    public int squadAttackerSpawned(obj_id self, dictionary params)
    {
    ...
    public void setupPatrolPaths(obj_id self)
    {
    ...
    public transform[] getRandomPathsFromSpawner(obj_id objSpawner)
    {
