...
public class battlefield_station extends script.base_script
{
    ...
    public int setupFaction(obj_id self, dictionary params)
    {
    ...
    public int objectDocked(obj_id self, dictionary params)
    {
        LOG("space", "DOCKING");
    ...
    public int undockAndLeave(obj_id self, dictionary params)
    {
        obj_id objShip = params.getObjId("objShip");
