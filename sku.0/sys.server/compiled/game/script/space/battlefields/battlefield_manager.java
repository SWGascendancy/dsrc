...
public class battlefield_manager extends script.base_script
{
    ...
    public int bootStrapZone(obj_id self, dictionary params)
    {
        LOG("space", "preload compltede");
        return SCRIPT_CONTINUE;
    }
    public int shipHyperspacing(obj_id self, dictionary params)
    {
    ...
    public int nextPhase(obj_id self, dictionary params)
    {
        setObjVar(self, "intPhase", 2);
        space_battlefield.doDestroyerPhase(self);
        return SCRIPT_CONTINUE;
    }
    public int resetBattlefield(obj_id self, dictionary params)
    {
        LOG("space", "RESETTING");
