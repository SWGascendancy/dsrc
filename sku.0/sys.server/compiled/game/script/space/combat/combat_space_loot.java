...
public class combat_space_loot extends script.base_script
{
    ...
    public int OnAboutToLoseItem(obj_id self, obj_id objDestination, obj_id objPlayer, obj_id objItem)
    {
    ...
    public int OnLostItem(obj_id self, obj_id objDestination, obj_id objPlayer, obj_id objItem)
    {
    ...
    public int recheckContents(obj_id self, dictionary params)
    {
        obj_id[] objContents = getContents(self);
        if (objContents == null)
        {
