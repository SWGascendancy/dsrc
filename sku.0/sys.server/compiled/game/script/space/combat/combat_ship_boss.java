...
public class combat_ship_boss extends script.base_script
{
    ...
    public int OnShipWasHit(obj_id self, obj_id attacker, int weaponIndex, boolean isMissile, int missileType, int intSlot, boolean fromPlayerAutoTurret, float hitLocationX_o, float hitLocationY_o, float hitLocationZ_o)
    {
        checkForAbility(self, "onShipHit");
        return SCRIPT_CONTINUE;
    }
    public int OnShipIsHitting(obj_id self, obj_id target, int weaponIndex, int intSlot)
    {
    ...
    public int shieldDepleted(obj_id self, dictionary params)
    {
        utils.setScriptVar(self, "shieldDepleted", 1);
        checkForAbility(self, "onShieldDepleted");
        return SCRIPT_CONTINUE;
    }
    public int armorDepleted(obj_id self, dictionary params)
    {
        utils.setScriptVar(self, "armorDepleted", 1);
        checkForAbility(self, "onArmorDepleted");
        return SCRIPT_CONTINUE;
    }
    public int combatLoop(obj_id self, dictionary params)
    {
    ...
    public void checkForAbility(obj_id self, String trig)
    {
    ...
    public boolean isOnCooldown(obj_id self, String ability)
    {
    ...
    public void activateAbility(obj_id self, String ability)
    {
        if (!isIdValid(self) || ability == null || ability.length() <= 0)
        {
            return;
    ...
    public int clearDroidCommands(obj_id self, dictionary params)
    {
    ...
    public int stunEngine(obj_id self, dictionary params)
    {
        obj_id[] targetList = params.getObjIdArray("targetList");
        if (targetList == null || targetList.length <= 0)
        {
    ...
    public int stunWeapons(obj_id self, dictionary params)
    {
    ...
    public int missileSwarm(obj_id self, dictionary params)
    {
        if (!space_utils.isShip(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int leachShieldEnergy(obj_id self, dictionary params)
    {
        int duration = params.getInt("duration");
    ...
    public int removeShieldEnergy(obj_id self, dictionary params)
    {
        int duration = params.getInt("duration");
        float effect = (float)params.getInt("effect");
        if (!isIdValid(self) || !exists(self))
    ...
    public int restoreShieldEnergy(obj_id self, dictionary params)
    {
        int duration = params.getInt("duration");
        float effect = (float)params.getInt("effect");
        if (!isIdValid(self) || !exists(self))
    ...
    public int removeCapacitorEnergy(obj_id self, dictionary params)
    {
        int duration = params.getInt("duration");
        float effect = (float)params.getInt("effect");
        if (!isIdValid(self) || !exists(self))
    ...
    public int repairComponents(obj_id self, dictionary params)
    {
        int duration = params.getInt("duration");
        float effect = (float)params.getInt("effect");
        if (!isIdValid(self) || !exists(self))
    ...
    public int selfDestructExplosion(obj_id self, dictionary params)
    {
    ...
    public int capShipMineDrop(obj_id self, dictionary params)
    {
        int duration = params.getInt("duration");
        float effect = (float)params.getInt("effect");
        if (!isIdValid(self) || !exists(self))
    ...
    public int capShipMineExplosion(obj_id self, dictionary params)
    {
