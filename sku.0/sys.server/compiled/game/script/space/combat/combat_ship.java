...
public class combat_ship extends script.base_script
{
    ...
    public int setupRotationalVelocity(obj_id self, dictionary params)
    {
    ...
    public int OnShipHitByLightning(obj_id self, int frontBack, float damage)
    {
        if (damage > 0.f)
        {
    ...
    public int OnShipHitByEnvironment(obj_id self, int frontBack, float damage)
    {
        if (damage > 0.f)
        {
            notifyShipDamage(self, null, damage);
    ...
    public int OnShipWasHit(obj_id self, obj_id objAttacker, int intWeaponIndex, boolean isMissile, int missileType, int intTargetedComponent, boolean fromPlayerAutoTurret, float hitLocationX_o, float hitLocationY_o, float hitLocationZ_o)
    {
    ...
    public int killSpacePlayer(obj_id self, dictionary params)
    {
    ...
    public int OnSpaceUnitEnterCombat(obj_id self, obj_id objTarget)
    {
    ...
    public int objectDestroyed(obj_id self, dictionary params)
    {
    ...
    public int targetDisabled(obj_id self, dictionary params)
    {
    ...
    public int disableSelf(obj_id self, dictionary params)
    {
    ...
    public int megaDamage(obj_id self, dictionary params)
    {
        obj_id objAttacker = params.getObjId("objShip");
        if (space_utils.isPlayerControlledShip(objAttacker))
        {
    ...
    public int OnTryToEquipDroidControlDeviceInShip(obj_id self, obj_id objPlayer, obj_id objControlDevice)
    {
    ...
    public int OnShipComponentUninstalling(obj_id self, obj_id uninstallerId, int intSlot, obj_id targetContainer)
    {
    ...
    public int OnShipComponentUninstalled(obj_id self, obj_id uninstallerId, obj_id componentId, int slot, obj_id targetContainer)
    {
    ...
    public int OnDroppedItemOntoShipComponent(obj_id self, int intSlot, obj_id objItem, obj_id objPlayer)
    {
    ...
    public int notifyOnDestroy(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int OnShipDisabled(obj_id self, dictionary params)
    {
    ...
    public int selfDestruct(obj_id self, dictionary params)
    {
    ...
    public int reactorPumpPulseTimeout(obj_id self, dictionary params)
    {
    ...
    public int unScramReactor(obj_id self, dictionary params)
    {
        obj_id ship = params.getObjId("ship");
    ...
    public int OnShipComponentPowerSufficient(obj_id self, int intSlot, float fltPowerReceived)
    {
        obj_id objPilot = getPilotId(self);
    ...
    public int OnShipComponentPowerInsufficient(obj_id self, int intSlot, float fltPowerRequired, float fltPowerReceived)
    {
    ...
    public int OnShipComponentInstalling(obj_id self, obj_id installerId, obj_id componentId, int slot)
    {
    ...
    public int OnShipComponentInstalled(obj_id self, obj_id objInstaller, int intSlot)
    {
    ...
    public int OnShipFiredCountermeasure(obj_id self, int intWeaponIndex, obj_id objPlayer)
    {
    ...
    public int OnShipFiredMissile(obj_id self, int intMissileId, int intWeaponIndex, int intMissileType, obj_id objPilot, obj_id objDefender, int intTargetedSlot)
    {
        int intSlot = intWeaponIndex + ship_chassis_slot_type.SCST_weapon_first;
        if (isIdValid(objPilot))
        {
    ...
    public int getMissileDefenseRoll(int intMissileId)
    {
    ...
    public int flightDroidVocalize(obj_id self, dictionary params)
    {
        obj_id ship = params.getObjId("ship");
    ...
    public int emergencyPowerTimeout(obj_id self, dictionary params)
    {
        obj_id ship = params.getObjId("ship");
        obj_id pilot = params.getObjId("pilot");
    ...
    public void applyFiredWeaponsSkillMod(obj_id ship)
    {
    ...
    public int componentsStunned(obj_id self, dictionary params)
    {
    ...
    public int vRepairDamageCEFLoop(obj_id self, dictionary params)
    {
    ...
    public int OnSpaceUnitDocked(obj_id self, obj_id target)
    {
        obj_id objPilot = getPilotId(self);
        if (!space_utils.isPlayerControlledShip(self))
        {
    ...
    public int OnSpaceUnitUnDocked(obj_id self, obj_id target, boolean dockSuccessful)
    {
        obj_id objPilot = getPilotId(self);
    ...
    public int openComm(obj_id self, dictionary params)
    {
    ...
    public int checkSpacePVPStatus(obj_id self, dictionary params)
    {
        space_transition.updatePVPStatus(self);
        return SCRIPT_CONTINUE;
    }
    public int destroySelf(obj_id self, dictionary params)
    {
