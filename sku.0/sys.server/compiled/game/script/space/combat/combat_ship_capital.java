...
public class combat_ship_capital extends script.space.combat.combat_space_base
{
    ...
    public int[] makeComponentsTargetable(obj_id objShip, String[] strComponents)
    {
    ...
    public int[] makeComponentsUntargetable(obj_id objShip, String[] strComponents)
    {
        int[] intDamagePhaseComponents = new int[strComponents.length];
        for (int intI = 0; intI < strComponents.length; intI++)
        {
    ...
    public void setupCapitalShipComponents(obj_id objShip)
    {
    ...
    public void checkAndUpdateCapitalShipStatus(obj_id objShip, int intSlot)
    {
    ...
    public int componentDamageUpdate(obj_id self, dictionary params)
    {
        return SCRIPT_CONTINUE;
    }
    public int componentDisabled(obj_id self, dictionary params)
    {
    ...
    public void processDamagePhase(obj_id objShip)
    {
        String strCapitalShipType = getStringObjVar(objShip, "strCapitalShipType");
	if ((strCapitalShipType == null) || (strCapitalShipType.equals("")) || strCapitalShipType == "null")
        {
