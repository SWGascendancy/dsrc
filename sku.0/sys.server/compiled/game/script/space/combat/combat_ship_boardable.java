...
public class combat_ship_boardable extends script.base_script
{
    ...
    public location getLocationFromLocationList(obj_id objObject, String strLocationList)
    {
    ...
    public location getLocationFromLocationListRandom(obj_id objObject, String strLocationList, float fltRandomValue)
    {
    ...
    public int delayedSpawn(obj_id self, dictionary params)
    {
