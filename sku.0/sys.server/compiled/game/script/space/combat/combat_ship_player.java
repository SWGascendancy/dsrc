...
public class combat_ship_player extends script.base_script
{
    ...
    public int handleScriptAttachment(obj_id self, dictionary params)
    {
        newPlayerCheck(self);
        return SCRIPT_CONTINUE;
    }
    public void newPlayerCheck(obj_id self)
    {
        if (!hasObjVar(self, "jtlNewbie"))
        {
    ...
    public void createSwoop(obj_id self)
    {
    ...
    public int cmdPilotShip(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdLeaveStation(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdOpenWings(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdCloseWings(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id shipId = space_transition.getContainingShip(self);
        if (isIdValid(shipId))
        {
    ...
    public int droid(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public boolean canCreateShip(obj_id self)
    {
        if (isGod(self))
        {
    ...
    public int board(obj_id self, obj_id target, String params, float defaultTime)
    {
        return SCRIPT_CONTINUE;
    }
    public int evacuate(obj_id self, obj_id target, String params, float defaultTime)
    {
        return SCRIPT_CONTINUE;
    }
    ...
    public int abortHyperspace(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id objShip = space_transition.getContainingShip(self);
    ...
    public int hyperspaceToHyperspacePoint(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int doHyperspaceMessaging(obj_id self, dictionary params)
    {
        obj_id objShip = space_transition.getContainingShip(self);
        if (!isIdValid(objShip))
        {
    ...
    public int hyperspacePlayer(obj_id self, dictionary params)
    {
        obj_id objShip = space_transition.getContainingShip(self);
        if (!isIdValid(objShip))
        {
    ...
    public int OnHyperspaceToHomeLocation(obj_id self)
    {
        obj_id objShip = space_transition.getContainingShip(self);
        if (isIdValid(objShip))
        {
    ...
    public int openContainer(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int destroyTarget(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int disableTarget(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id objLookAtTarget = getLookAtTarget(self);
        if (!isIdValid(objLookAtTarget))
        {
    ...
    public int cmdLaunchMissile(obj_id self, obj_id target, String params, float defaultTime)
    {
        debugSpeakMsg(self, "got launch missile command");
        if (!isIdValid(target))
        {
    ...
    public int doDelayedSystemMessage(obj_id self, dictionary params)
    {
        string_id strSpam = params.getStringId("strSpam");
        sendSystemMessage(self, strSpam);
        return SCRIPT_CONTINUE;
    }
    public int cmdReactorPumpPulse(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdIffScramble(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int unIffScramble(obj_id self, dictionary params)
    {
    ...
    public int muteDroid(obj_id self, dictionary params)
    {
    ...
    public int zoneToKessel(obj_id self, dictionary params)
    {
    ...
    public int zoneToImperialDeepSpace(obj_id self, dictionary params)
    {
    ...
    public int zoneToRebelDeepSpace(obj_id self, dictionary params)
    {
    ...
    public int zoneTimer(obj_id self, dictionary params)
    {
        if (!utils.hasScriptVar(self, "space.zoneDestination"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int spacePvpRebel(obj_id self, dictionary params)
    {
        obj_id ship = space_transition.getContainingShip(self);
    ...
    public int spacePvpImperial(obj_id self, dictionary params)
    {
        obj_id ship = space_transition.getContainingShip(self);
        if (hasObjVar(ship, "spaceFaction.FactionOverride") && hasObjVar(ship, "spaceFaction.overt"))
        {
    ...
    public int spaceRebelHelper(obj_id self, dictionary params)
    {
        obj_id ship = space_transition.getContainingShip(self);
        if (hasObjVar(ship, "spaceFaction.FactionOverride") && hasObjVar(ship, "spaceFaction.overt"))
        {
    ...
    public int spaceImperialHelper(obj_id self, dictionary params)
    {
        obj_id ship = space_transition.getContainingShip(self);
        if (hasObjVar(ship, "spaceFaction.FactionOverride") && hasObjVar(ship, "spaceFaction.overt"))
        {
    ...
    public void zoneToCommand(obj_id self)
    {
    ...
    public int cmdEmergencyWeapons(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdEmergencyShields(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdEmergencyThrust(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdVampiricRepair(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdVampiricRepairOther(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdLightBomberStrike(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdMediumBomberStrike(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdHeavyBomberStrike(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int bomberStrikeUnitDestroyed(obj_id self, dictionary params)
    {
    ...
    public int bomberStrikeEscortUnitDestroyed(obj_id self, dictionary params)
    {
    ...
    public int bomberStrikeTargetDestroyed(obj_id self, dictionary params)
    {
    ...
    public int cmdPirateLure(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdPirateLureAdvanced(obj_id self, obj_id target, String params, float defaultTime)
    {
        debugServerConsoleMsg(null, "got Pirate Lure Command");
        if (!space_combat.commandTimePassed(self))
        {
    ...
    public void pirateCommandCleanup(obj_id self)
    {
    ...
    public int pirateUnitDestroyed(obj_id self, dictionary params)
    {
    ...
    public int cmdEnergyPulseOne(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdEnergyPulseTwo(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdEnergyPulseThree(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdNebulaBlast(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdJstartOne(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdJstartTwo(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdJstartThree(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdInSpaceRepair(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int escapePod(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!(params.equals("yes")))
        {
    ...
    public int requestSpaceTrainer(obj_id self, obj_id target, String params, float defaultTime)
    {
        queueCommand(self, (80588750), space_transition.getContainingShip(self), "0   ", COMMAND_PRIORITY_FRONT);
        return SCRIPT_CONTINUE;
    }
    public int cmdSpaceFaction(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id ship = space_transition.getContainingShip(self);
        if (!isIdValid(ship))
        {
    ...
    public int cmdSpacepvprebel(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id ship = space_transition.getContainingShip(self);
        if (!isIdValid(ship))
        {
    ...
    public int cmdSpacepvpimperial(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id ship = space_transition.getContainingShip(self);
        if (!isIdValid(ship))
        {
    ...
    public int cmdSpaceRebelHelper(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id ship = space_transition.getContainingShip(self);
        if (!isIdValid(ship))
        {
    ...
    public int cmdSpaceImperialHelper(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id ship = space_transition.getContainingShip(self);
        if (!isIdValid(ship))
        {
    ...
    public int cmdBattleStatus(obj_id self, obj_id target, String params, float defaultTime)
    {
        ...
        else if(paramsArray.length == 1 && paramsArray[0].length() >= 3)
        {
            sendSpaceBattleStatusMessage(self, paramsArray[0].toLowerCase());
        }
        else
        {
    ...
    public int ionizeArea(obj_id self, dictionary params)
    {
        int radius = 100;
    ...
    public int ionizeTarget(obj_id self, dictionary params)
    {
    ...
    public int spaceTaunt(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdInSpaceReload(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdInSpaceRepairAndReload(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int repairShipComponentInSlot(obj_id self, obj_id target, String params, float defaultTime)
    {
        String[] paramsArray = split(params, ' ');
    ...
    public int dumpZoneInformation(obj_id self, obj_id target, String params, float defaultTime)
    {
        String strFileName = "";
        if (!params.equals(""))
        {
    ...
    public int OnSpaceEjectPlayerFromShip(obj_id self)
    {
        obj_id ship = space_transition.getContainingShip(self);
    ...
    public int toggleCombatTaunts(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int OnCommitDroidProgramCommands(obj_id self, obj_id objControlDevice, String[] strCommands, obj_id[] objChipsToAdd, obj_id[] objChipsToRemove)
    {
    ...
    public int commandTimerTimeout(obj_id self, dictionary params)
    {
        string_id strSpam = new string_id("space/space_interaction", "pilot_command_timer_compelete");
        sendSystemMessage(self, strSpam);
        return SCRIPT_CONTINUE;
    }
    public int doDelayedPilot(obj_id self, dictionary params)
    {
        space_transition.handlePotentialSceneChange(self);
