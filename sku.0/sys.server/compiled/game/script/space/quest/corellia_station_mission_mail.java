...
public class corellia_station_mission_mail extends script.base_script
{
    ...
    public int mailMessageOne(obj_id self, dictionary params)
    {
    ...
    public int mailMessageTwo(obj_id self, dictionary params)
    {
        if (space_flags.isSpaceTrack(self, space_flags.PRIVATEER_CORELLIA))
        {
    ...
    public int sendMessageOne(obj_id self, dictionary params)
    {
    ...
    public int sendMessageTwo(obj_id self, dictionary params)
    {
