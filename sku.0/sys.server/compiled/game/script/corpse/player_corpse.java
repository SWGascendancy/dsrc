...
public class player_corpse extends script.base_script
{
    ...
    public int OnOpenedContainer(obj_id self, obj_id whoOpenedMe)
    {
    ...
    public int OnClosedContainer(obj_id self, obj_id whoClosedMe)
    {
    ...
    public int handleAddConsentedUser(obj_id self, dictionary params)
    {
        if (params != null)
        {
    ...
    public int handleRemoveConsentedUser(obj_id self, dictionary params)
    {
        if (params != null)
        {
            obj_id player = params.getObjId(corpse.DICT_PLAYER_ID);
    ...
    public int handleCorpseDepositSuccess(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_OVERRIDE;
    ...
    public int handleCorpseDepositFail(obj_id self, dictionary params)
    {
        destroyObject(self);
        return SCRIPT_CONTINUE;
    }
    public int handleAttemptCorpseCleanup(obj_id self, dictionary params)
    {
    ...
    public int handleRequestCorpseMove(obj_id self, dictionary params)
    {
    ...
    public int handleRequestLocation(obj_id self, dictionary params)
    {
        corpse.updateCorpseOwnerWaypoint(getOwner(self), self);
        return SCRIPT_CONTINUE;
    }
