...
public class ai_corpse extends script.base_script
{
    ...
    public int harvestCorpse(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleLootAddPass(obj_id self, dictionary params)
    {
    ...
    public int handleLootAddFail(obj_id self, dictionary params)
    {
        return SCRIPT_CONTINUE;
    }
    public int handleLootWithdrawPass(obj_id self, dictionary params)
    {
        if (params != null)
        {
    ...
    public int handleLootWithdrawFail(obj_id self, dictionary params)
    {
        return SCRIPT_CONTINUE;
    }
    ...
    public int handleCorpseEmpty(obj_id self, dictionary params)
    {
        obj_id inv = utils.getInventoryContainer(self);
        if (isIdValid(inv))
        {
    ...
    public int OnLootLotterySelected(obj_id self, obj_id player, obj_id[] selection_ids)
    {
    ...
    public int fireLotteryPulse(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
    ...
    public boolean canHarvest(obj_id self, obj_id player)
    {
