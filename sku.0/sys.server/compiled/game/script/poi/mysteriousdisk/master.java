...
public class master extends script.theme_park.poi.base
{
    ...
    public boolean createAntagonists(obj_id self)
    {
    ...
    public int startFight(obj_id self, dictionary params)
    {
    ...
    public int dieDieMyDarling(obj_id self, dictionary params)
    {
