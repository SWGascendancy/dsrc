...
public class mediator extends script.poi.base.scenario_actor
{
    ...
    public int runToTarget(obj_id self, dictionary params)
    {
    ...
    public int tryToGetHelp1(obj_id self, dictionary params)
    {
    ...
    public int tryToGetHelp2(obj_id self, dictionary params)
    {
        if (hasObjVar(self, "inChat"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int begForHelp(obj_id self, dictionary params)
    {
