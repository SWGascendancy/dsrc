...
public class imperial_lrg extends script.base_script
{
    ...
    public boolean setupTheater(obj_id self)
    {
    ...
    public boolean cleanupTheater(obj_id self)
    {
        if ((self == null) || (self == obj_id.NULL_ID))
        {
            self = getSelf();
    ...
    public obj_id spawn(obj_id self, String type, String sLoc, int default_behavior)
    {
        LOG("imperial_lrg", "******");
        if ((self == null) || (self == obj_id.NULL_ID))
        {
