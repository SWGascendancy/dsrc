...
public class mediator extends script.poi.base.scenario_actor
{
    ...
    public void guardChatter(obj_id self, String convo, obj_id speaker, obj_id poiMaster, boolean antagonistsDead, boolean speakerCredit, boolean leaderDead)
    {
        int progress = scenario.getPlayerProgress(speaker);
        int idx;
    ...
    public void minionChatter(obj_id self, String convo, obj_id speaker, obj_id poiMaster, boolean antagonistsDead, boolean speakerCredit, boolean leaderDead)
    {
        if (leaderDead)
        {
            if (!speakerCredit)
    ...
    public int finishScenario(obj_id self, dictionary params)
    {
        obj_id poiMaster = poi.getBaseObject(self);
    ...
    public int celebrateVictory(obj_id self, dictionary params)
    {
        stop(self);
    ...
    public int goPee(obj_id self, dictionary params)
    {
        obj_id poiMaster = poi.getBaseObject(self);
        if ((poiMaster == null) || (poiMaster == obj_id.NULL_ID))
        {
    ...
    public int handleMyDeath(obj_id self, dictionary params)
    {
        obj_id poiMaster = poi.getBaseObject(self);
        if ((poiMaster == null) || (poiMaster == obj_id.NULL_ID))
        {
    ...
    public int resetSpeakTimer(obj_id self, dictionary params)
    {
        obj_id poiMaster = poi.getBaseObject(self);
        if ((poiMaster == null) || (poiMaster == obj_id.NULL_ID))
        {
