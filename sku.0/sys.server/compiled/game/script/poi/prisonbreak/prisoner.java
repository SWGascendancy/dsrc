...
public class prisoner extends script.base_script
{
    ...
    public int emoteFrustration(obj_id self, dictionary params)
    {
    ...
    public int squatDown(obj_id self, dictionary params)
    {
    ...
    public int bombSet(obj_id self, dictionary params)
    {
    ...
    public int moveBack(obj_id self, dictionary params)
    {
        obj_id a = poi.findObject("antagonist_0");
        if ((a == null) || (a == obj_id.NULL_ID))
        {
    ...
    public int reportBombSet1(obj_id self, dictionary params)
    {
        queueCommand(self, (1780871594), null, "salute", COMMAND_PRIORITY_DEFAULT);
        messageTo(self, "reportBombSet2", null, 1, false);
        return SCRIPT_CONTINUE;
    }
    public int reportBombSet2(obj_id self, dictionary params)
    {
    ...
    public int restoreFaction(obj_id self, dictionary params)
    {
        obj_id poiMaster = poi.getBaseObject(self);
        if ((poiMaster == null) || (poiMaster == obj_id.NULL_ID))
        {
    ...
    public int dropBomb(obj_id self, dictionary params)
    {
        obj_id poiMaster = poi.getBaseObject(self);
        if ((poiMaster == null) || (poiMaster == obj_id.NULL_ID))
        {
