...
public class master extends script.theme_park.poi.base
{
    ...
    public int cleanupScenario(obj_id self, dictionary params)
    {
        scenario.cleanup(self);
        return SCRIPT_CONTINUE;
    }
    ...
    public int initScenario(obj_id self, dictionary params)
    {
    ...
    public boolean createTheater(obj_id self)
    {
    ...
    public void attachWallScripts(obj_id self, obj_id prison)
    {
    ...
    public boolean createAntagonist(obj_id self)
    {
    ...
    public boolean createAntagonistMinions(obj_id self)
    {
    ...
    public boolean createMediator(obj_id self)
    {
    ...
    public boolean createMediatorMinions(obj_id self)
    {
        location baseloc = getLocation(self);
        String type = getStringObjVar(self, MEDIATOR_TYPE);
        if (!type.equals(""))
    ...
    public int startAttack(obj_id self, dictionary params)
    {
    ...
    public int guardGone(obj_id self, dictionary params)
    {
    ...
    public int blowBomb(obj_id self, dictionary params)
    {
        location bombloc = getLocationObjVar(self, "weakwallLoc");
        bombloc.z += -1.5;
    ...
    public int blowDroppedBomb(obj_id self, dictionary params)
    {
    ...
    public int destroyBombedWall(obj_id self, dictionary params)
    {
    ...
    public int destroyBombedWallDeath(obj_id self, dictionary params)
    {
        obj_id bombedWall = getBombedWall(self);
        if ((bombedWall == null) || (bombedWall == obj_id.NULL_ID))
        {
    ...
    public int handleActorDeath(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public obj_id getBombedWall(obj_id self)
    {
    ...
    public int enableBombedWall(obj_id self, dictionary params)
    {
    ...
    public int wallDamaged(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
