...
public class interior_spawner extends script.base_script
{
    ...
    public void checkFactionalSpawners(obj_id self)
    {
    ...
    public int npcDied(obj_id self, dictionary params)
    {
    ...
    public int spawnNpcs(obj_id self, dictionary params)
    {
    ...
    public void npcScriptAttacher(obj_id creature, String scriptList)
    {
    ...
    public String getType(dictionary row, obj_id self)
    {
        if (row == null)
        {
            return "thug";
    ...
    public float getDelay(obj_id self)
    {
        location here = getLocation(self);
        String planet = here.area;
        String table = TABLE_BEGIN + planet + ".iff";
    ...
    public int getCurrentPop(obj_id self)
    {
        int current = 0;
        if (utils.hasScriptVar(self, SCRIPTVAR_CREATIONS))
        {
    ...
    public boolean isNpcSentinel(dictionary row, obj_id self)
    {
        int isSentinel = 0;
    ...
    public int getMaxPop(dictionary row, obj_id self)
    {
    ...
    public float getRadius(dictionary row, obj_id self, int max)
    {
        if (row == null)
        {
            return 1.5f;
    ...
    public String getScripts(dictionary row, obj_id self)
    {
        if (row == null)
        {
            return "";
    ...
    public boolean usePlanetLevel(dictionary row, obj_id self)
    {
        if (row == null)
        {
            return false;
    ...
    public obj_id spawnMob(obj_id spawner, int max, int level, location here, dictionary row)
    {
    ...
    public int getRandomPlanetCreatureLevel(obj_id spawner, String npcType, int lastLevel, location here, dictionary row)
    {
