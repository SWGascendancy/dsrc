...
public class antagonist extends script.poi.base.scenario_actor
{
    ...
    public int armWeapon(obj_id self, dictionary params)
    {
    ...
    public int firstInsult(obj_id self, dictionary params)
    {
        poi.quickSay(self, "a_insult1");
        messageTo(self, "firstInsultResponse", null, 7, false);
        return SCRIPT_CONTINUE;
    }
    public int firstInsultResponse(obj_id self, dictionary params)
    {
        obj_id m = poi.findObject("mediator_0");
        if ((m == null) || (m == obj_id.NULL_ID) || ai_lib.isInCombat(m))
        {
    ...
    public int secondInsult(obj_id self, dictionary params)
    {
    ...
    public int secondInsultResponse(obj_id self, dictionary params)
    {
        obj_id m = poi.findObject("mediator_0");
        if ((m == null) || (m == obj_id.NULL_ID) || ai_lib.isInCombat(m))
        {
    ...
    public int thirdInsult(obj_id self, dictionary params)
    {
        obj_id a = poi.findObject("antagonist_0");
        if ((a == null) || (a == obj_id.NULL_ID) || ai_lib.isInCombat(a))
        {
    ...
    public int thirdInsultSocial(obj_id self, dictionary params)
    {
    ...
    public int thirdInsultResponse(obj_id self, dictionary params)
    {
        obj_id m = poi.findObject("mediator_0");
        if ((m == null) || (m == obj_id.NULL_ID) || ai_lib.isInCombat(m))
        {
    ...
    public int thirdInsultResponseSocial(obj_id self, dictionary params)
    {
        obj_id m = poi.findObject("mediator_0");
        if ((m == null) || (m == obj_id.NULL_ID) || ai_lib.isInCombat(m))
        {
    ...
    public int lastInsult(obj_id self, dictionary params)
    {
        obj_id a = poi.findObject("antagonist_0");
        if ((a == null) || (a == obj_id.NULL_ID) || ai_lib.isInCombat(a))
        {
