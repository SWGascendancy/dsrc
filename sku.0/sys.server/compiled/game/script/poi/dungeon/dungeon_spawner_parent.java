...
public class dungeon_spawner_parent extends script.base_script
{
    ...
    public int startWaves(obj_id self, dictionary params)
    {
    ...
    public int spawnWave(obj_id self, dictionary params)
    {
        deltadictionary dctScriptVars = self.getScriptVars();
    ...
    public int continueSpawns(obj_id self, dictionary params)
    {
        deltadictionary dctScriptVars = self.getScriptVars();
        int intIndex = dctScriptVars.getInt("intIndex");
    ...
    public location getDungeonSpawnLocation(obj_id objParent)
    {
    ...
    public int elementDestroyed(obj_id self, dictionary params)
    {
        deltadictionary dctScriptVars = self.getScriptVars();
    ...
    public void resetWave(obj_id objParent)
    {
        deltadictionary dctScriptVars = objParent.getScriptVars();
        dctScriptVars.put("intIndex", 0);
    ...
    public obj_id[] getDungeonSpawners(obj_id objParent)
    {
