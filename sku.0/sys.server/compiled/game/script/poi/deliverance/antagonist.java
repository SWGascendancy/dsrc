...
public class antagonist extends script.theme_park.poi.base
{
    ...
    public int OnArrivedAtLocation(obj_id self, String locName)
    {
    ...
    public void groupAttack(obj_id self, obj_id target)
    {
    ...
    public void groupFace(obj_id self, obj_id target)
    {
        obj_id poiMaster = poi.getBaseObject(self);
        if ((poiMaster == null) || (poiMaster == obj_id.NULL_ID))
        {
    ...
    public int handleAddTargetLocation(obj_id self, dictionary params)
    {
    ...
    public int handleTimer(obj_id self, dictionary params)
    {
        if (ai_lib.isInCombat(self))
        {
            messageTo(self, HANDLER_TIMER, null, TIME_WAIT, false);
    ...
    public int handleMediatorDead(obj_id self, dictionary params)
    {
        obj_id poiMaster = poi.getBaseObject(self);
        if ((poiMaster == null) || (poiMaster == obj_id.NULL_ID))
        {
    ...
    public int handleMGreetA(obj_id self, dictionary params)
    {
    ...
    public int handleFaceCall(obj_id self, dictionary params)
    {
