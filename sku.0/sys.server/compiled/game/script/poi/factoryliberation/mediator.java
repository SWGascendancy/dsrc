...
public class mediator extends script.poi.base.scenario_actor
{
    ...
    public void minionChatter(obj_id self, String convo, obj_id speaker, obj_id poiMaster, boolean antagonistsDead, boolean speakerCredit, boolean someDead, boolean wallHasBeenDestroyed, boolean wallDamaged)
    {
        if (antagonistsDead)
        {
            if (!wallHasBeenDestroyed)
    ...
    public int celebrateWallLeader(obj_id self, dictionary params)
    {
        stop(self);
    ...
    public int celebrateWall(obj_id self, dictionary params)
    {
        stop(self);
    ...
    public void finishScenario(obj_id self, obj_id speaker)
    {
        obj_id poiMaster = poi.getBaseObject(self);
    ...
    public int runForFreedom(obj_id self, dictionary params)
    {
        obj_id poiMaster = poi.getBaseObject(self);
