...
public class antagonist extends script.poi.base.scenario_actor
{
    ...
    public int handleIncapacitation(obj_id self, dictionary params)
    {
        scenario.actorIncapacitated(self);
        return SCRIPT_CONTINUE;
    }
    public int handleCadence(obj_id self, dictionary params)
    {
        obj_id poiMaster = poi.getBaseObject(self);
        if ((poiMaster == null) || (poiMaster == obj_id.NULL_ID))
        {
    ...
    public int handleFollowTimer(obj_id self, dictionary params)
    {
    ...
    public int handlePrepTimer(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId(scenario.DICT_OBJID);
        if ((player == null) || (player == obj_id.NULL_ID))
        {
    ...
    public int handleAttackTimer(obj_id self, dictionary params)
    {
        if (ai_lib.isInCombat(self))
        {
    ...
    public int handleCharge(obj_id self, dictionary params)
    {
        obj_id poiMaster = poi.getBaseObject(self);
        if ((poiMaster == null) || (poiMaster == obj_id.NULL_ID))
        {
    ...
    public int handleEnemyAttack(obj_id self, dictionary params)
    {
        obj_id poiMaster = poi.getBaseObject(self);
        if ((poiMaster == null) || (poiMaster == obj_id.NULL_ID))
        {
    ...
    public int handleVictory(obj_id self, dictionary params)
    {
        obj_id poiMaster = poi.getBaseObject(self);
        if ((poiMaster == null) || (poiMaster == obj_id.NULL_ID))
        {
