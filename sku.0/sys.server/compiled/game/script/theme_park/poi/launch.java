...
public class launch extends script.theme_park.poi.base
{
    ...
    public int handle_Spawn_Setup_Complete(obj_id self, dictionary params)
    {
    ...
    public void launchPoi(obj_id self)
    {
    ...
    public int handleLairInRangeCheck(obj_id self, dictionary params)
    {
