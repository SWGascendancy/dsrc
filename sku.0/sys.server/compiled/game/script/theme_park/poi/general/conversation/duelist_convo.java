...
public class duelist_convo extends script.base_script
{
    ...
    public int OnNpcConversationResponse(obj_id self, String convoName, obj_id player, string_id response)
    {
    ...
    public int startDuel(obj_id self, dictionary params)
    {
    ...
    public int duelPlayer(obj_id self, dictionary params)
    {
        obj_id opponent = getObjIdObjVar(self, "opponent");
