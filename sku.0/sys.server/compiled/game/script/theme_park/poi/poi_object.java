...
public class poi_object extends script.theme_park.poi.base
{
    ...
    public int cleanUpRoutine(obj_id self, dictionary params)
    {
        if (isMob(self))
        {
    ...
    public int POIdeathMsgReceived(obj_id self, dictionary params)
    {
    ...
    public int OnIncapacitated(obj_id self, obj_id objKiller)
    {
    ...
    public int handleDelayedDestruction(obj_id self, dictionary params)
    {
        int sequenceNumber = getIntObjVar(self, "destructionSeqNumber");
    ...
    public void beginSleepMode(obj_id self)
    {
    ...
    public int doTriggerValidation(obj_id self, dictionary params)
    {
    ...
    public int handlePOIExpiration(obj_id self, dictionary params)
    {
        if (poiIsCompleted(self))
        {
            destroyObject(self);
    ...
    public void sendSleepModeMsg(obj_id self)
    {
        if (hasObjVar(self, "poi.sleepMode"))
        {
            return;
    ...
    public int handleBeginSleepMode(obj_id self, dictionary params)
    {
    ...
    public int proximityCleanup(obj_id self, dictionary params)
    {
        if (!poiIsCompleted())
        {
            poiComplete(POI_SUCCESS);
