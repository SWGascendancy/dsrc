...
public class poi_city_jawa_convo extends script.base_script
{
    ...
    public obj_id spawnGuyOne(obj_id baseObject)
    {
    ...
    public obj_id spawnGuyTwo(obj_id baseObject)
    {
        location here = getLocation(baseObject);
        here.x = here.x - 1;
    ...
    public obj_id spawnGuy3(obj_id baseObject)
    {
        location here = getLocation(baseObject);
        here.z = here.z - 1;
    ...
    public int handleDeadGuyOne(obj_id self, dictionary params)
    {
        spawnGuyOne(self);
        return SCRIPT_CONTINUE;
    }
    public int handleDeadGuyTwo(obj_id self, dictionary params)
    {
        spawnGuyTwo(self);
        return SCRIPT_CONTINUE;
    }
