...
public class npc_mission_create extends script.base_script
{
    ...
    public int handleGuyOneKilled(obj_id self, dictionary params)
    {
        spawnGuyOne(self);
        return SCRIPT_CONTINUE;
    }
    public int handleGuyTwoKilled(obj_id self, dictionary params)
    {
        spawnGuyTwo(self);
        return SCRIPT_CONTINUE;
    }
    public void spawnGuyOne(obj_id baseObject)
    {
    ...
    public void spawnGuyTwo(obj_id baseObject)
    {
    ...
    public String getMissionText(obj_id self)
    {
        String mission = "";
        int msnTxt = 1;
    ...
    public String getFriendText(obj_id self)
    {
        String mission = "";
        int msnTxt = 1;
        if (!hasObjVar(self, "missionText"))
