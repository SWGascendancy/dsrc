...
public class quest_rantok extends script.base_script
{
    ...
    public int finishRantokQuest(obj_id self, dictionary params)
    {
        String datatable = getStringObjVar(self, "quest_table");
        String gatingString = dataTableGetString(datatable, 1, "overall_objvar");
        int gating = getIntObjVar(self, gatingString);
    ...
    public void createGuards(obj_id bldg)
    {
    ...
    public void setUpNpc(obj_id newNpc)
    {
        return;
    }
    ...
    public int makeEnemyAttack(obj_id self, dictionary params)
    {
    ...
    public int removeJabbaQuestInfo(obj_id self, dictionary params)
    {
