...
public class stage_two_controller extends script.base_script
{
    ...
    public int beginSpawning(obj_id self, dictionary params)
    {
        clearEventArea(self);
    ...
    public int cleanupEvent(obj_id self, dictionary params)
    {
        clearEventArea(self);
        return SCRIPT_CONTINUE;
    }
    public void clearEventArea(obj_id self)
    {
    ...
    public int spawnNextStage(obj_id self, dictionary params)
    {
    ...
    public void spawnActors(obj_id controller, int stage)
    {
        spawnActors(controller, stage, null);
    }
    public void spawnActors(obj_id controller, int stage, String override)
    {
    ...
    public void addToWaypointData(obj_id controller, obj_id waypointObject)
    {
    ...
    public void transferWaypointData(obj_id controller, obj_id receiver)
    {
        if (!utils.hasScriptVar(controller, restuss_event.MASTER_PATROL_ARRAY))
        {
    ...
    public int OnClusterWideDataResponse(obj_id self, String manage_name, String dungeon_name, int request_id, String[] element_name_list, dictionary[] dungeon_data, int lock_key)
    {
