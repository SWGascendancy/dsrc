...
public class stage_two_crier extends script.base_script
{
    ...
    public boolean canSpawnHerald(obj_id self)
    {
    ...
    public void setCWData(obj_id self)
    {
    ...
    public int beginMessage(obj_id self, dictionary params)
    {
    ...
    public int warningLoop(obj_id self, dictionary params)
    {
        obj_id herald = utils.getObjIdScriptVar(self, HERALD_ID);
    ...
    public int destroySpawn(obj_id self, dictionary params)
    {
