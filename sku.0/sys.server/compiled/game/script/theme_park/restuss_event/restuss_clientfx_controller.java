...
public class restuss_clientfx_controller extends script.base_script
{
    ...
    public int handleFX(obj_id self, dictionary params)
    {
    ...
    public String getEffectType(String name)
    {
    ...
    public void doAdditionalEffects(obj_id self)
    {
    ...
    public int handle_cleanup(obj_id self, dictionary params)
    {
