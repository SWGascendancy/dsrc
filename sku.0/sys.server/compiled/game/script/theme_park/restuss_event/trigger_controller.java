...
public class trigger_controller extends script.base_script
{
    ...
    public int triggerSetup(obj_id self, dictionary params)
    {
    ...
    public boolean isDesiredTargetType(obj_id target)
    {
    ...
    public boolean canTriggerFire(obj_id self)
    {
    ...
    public void executeTrigger(obj_id self, obj_id perp)
    {
