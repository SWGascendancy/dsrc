...
public class restuss_herald_crier extends script.base_script
{
    ...
    public int startCheck(obj_id self, dictionary params)
    {
    ...
    public int handleHeraldST(obj_id self, dictionary params)
    {
    ...
    public int handleHeraldReb(obj_id self, dictionary params)
    {
        int chatChoice = rand(1, 3);
        if (chatChoice == 1)
        {
    ...
    public int handleHeraldGuy(obj_id self, dictionary params)
    {
        int chatChoice = rand(1, 3);
        if (chatChoice == 1)
        {
