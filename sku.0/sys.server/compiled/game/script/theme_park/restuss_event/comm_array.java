...
public class comm_array extends script.base_script
{
    ...
    public int checkForIncap(obj_id self, dictionary params)
    {
    ...
    public int hackComplete(obj_id self, dictionary params)
    {
    ...
    public int hackAvailable(obj_id self, dictionary params)
    {
        utils.removeScriptVar(self, "cantHack");
        return SCRIPT_CONTINUE;
    }
    public int changeFactionImperial(obj_id self, dictionary params)
    {
    ...
    public int changeFactionRebel(obj_id self, dictionary params)
    {
        location loc = getLocation(self);
    ...
    public int beginSpawnImperial(obj_id self, dictionary params)
    {
    ...
    public int beginSpawnRebel(obj_id self, dictionary params)
    {
    ...
    public int checkFactionInitial(obj_id self, dictionary params)
    {
