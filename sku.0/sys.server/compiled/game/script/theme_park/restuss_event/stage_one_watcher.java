...
public class stage_one_watcher extends script.base_script
{
    ...
    public int updateStageData(obj_id self, dictionary params)
    {
    ...
    public int setWinningFaction(obj_id self)
    {
    ...
    public void sendStartNotification(obj_id self)
    {
    ...
    public int beginEventNotification(obj_id self, dictionary params)
    {
    ...
    public int OnClusterWideDataResponse(obj_id self, String manage_name, String name, int request_id, String[] element_name_list, dictionary[] dungeon_data, int lock_key)
    {
