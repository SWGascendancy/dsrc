...
public class rebel_general_speech_manager extends script.base_script
{
    ...
    public int speechOne(obj_id self, dictionary params)
    {
    ...
    public int speechTwo(obj_id self, dictionary params)
    {
    ...
    public int speechThree(obj_id self, dictionary params)
    {
    ...
    public int speechFour(obj_id self, dictionary params)
    {
    ...
    public int speechFive(obj_id self, dictionary params)
    {
    ...
    public int speechSix(obj_id self, dictionary params)
    {
