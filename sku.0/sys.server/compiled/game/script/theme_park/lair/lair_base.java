...
public class lair_base extends script.theme_park.poi.base
{
    ...
    public void spawnAllCreatures(obj_id lair)
    {
    ...
    public int respawnCreature(obj_id self, dictionary params)
    {
    ...
    public void spawnWave(obj_id lair, int wave)
    {
    ...
    public void spawnBossMob(obj_id lair, obj_id killer)
    {
