...
public class mini_bloodrazor_bunker extends script.base_script
{
    ...
    public int mainframeFailed(obj_id self, dictionary params)
    {
    ...
    public int openLocks(obj_id self, dictionary params)
    {
        obj_id lockedRoom = getCellId(self, "pantry");
    ...
    public int jackUpIntensity(obj_id self, dictionary params)
    {
    ...
    public int intensifyExplosions(obj_id self, dictionary params)
    {
