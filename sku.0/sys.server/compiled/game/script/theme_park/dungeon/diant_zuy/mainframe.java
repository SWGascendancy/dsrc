...
public class mainframe extends script.base_script
{
    ...
    public int showMainframe(obj_id pcd, obj_id player)
    {
    ...
    public int handleMainframe(obj_id self, dictionary params)
    {
        obj_id top = getTopMostContainer(self);
    ...
    public int tamperWithMainframe(obj_id self, dictionary params)
    {
