...
public class keypad_handler extends script.base_script
{
    ...
    public boolean hasKeyCard(obj_id player)
    {
    ...
    public boolean hasSlicingSkill(obj_id player)
    {
        boolean hadIt = false;
    ...
    public obj_id keyCardObjId(obj_id objPlayer, String strTemplate)
    {
    ...
    public int finishedSlicingKeypad(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
