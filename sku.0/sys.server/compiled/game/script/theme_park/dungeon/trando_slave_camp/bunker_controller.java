...
public class bunker_controller extends script.base_script
{
    ...
    public void resetBunker(obj_id bunker)
    {
    ...
    public void setEventLocks(obj_id bunker)
    {
    ...
    public void validateScripts(obj_id bunker)
    {
    ...
    public obj_id[] getCellObjIds(obj_id bunker)
    {
    ...
    public void clearDungeon(obj_id bunker, obj_id[] cellIds)
    {
    ...
    public void spawnMobs(obj_id bunker)
    {
