...
public class foreman_spawner extends script.base_script
{
    ...
    public int foremanDied(obj_id self, dictionary params)
    {
    ...
    public void spawnEventMobs(obj_id self)
    {
    ...
    public int guardDied(obj_id self, dictionary params)
    {
        int deadGuards = 0;
    ...
    public void validateEvent(obj_id self)
    {
