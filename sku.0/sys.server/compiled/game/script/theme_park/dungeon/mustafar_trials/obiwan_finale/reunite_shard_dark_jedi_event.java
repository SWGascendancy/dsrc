...
public class reunite_shard_dark_jedi_event extends script.base_script
{
    ...
    public void launchObjectTriggerVolumeInitializer(obj_id self)
    {
    ...
    public obj_id callInquisitor(obj_id self, obj_id landmark)
    {
    ...
    public obj_id callDark_trooper_1(obj_id self, obj_id landmark)
    {
    ...
    public obj_id callDark_trooper_2(obj_id self, obj_id landmark)
    {
    ...
    public boolean canCallEnemies(obj_id self)
    {
    ...
    public boolean enemiesAlreadyPresent(obj_id self)
    {
    ...
    public void spawnEnemies(obj_id self, obj_id landmark)
    {
    ...
    public int noHate(obj_id self, dictionary params)
    {
    ...
    public int inquisitorAttack(obj_id self, dictionary params)
    {
        obj_id inquisitor = params.getObjId("inquisitor");
        obj_id dark_trooper_1 = params.getObjId("dark_trooper_1");
        obj_id dark_trooper_2 = params.getObjId("dark_trooper_2");
    ...
    public int dontRespawn(obj_id self, dictionary params)
    {
