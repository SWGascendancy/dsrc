...
public class bug_spawner extends script.base_script
{
    ...
    public int beginRepair(obj_id self, dictionary params)
    {
    ...
    public int spawnNewBug(obj_id self, dictionary params)
    {
    ...
    public int incrementBugCount(obj_id self)
    {
        int count = 0;
    ...
    public int decrementBugCount(obj_id self)
    {
        int count = 0;
        if (utils.hasScriptVar(self, BUG_COUNT))
        {
    ...
    public boolean canSpawnMoreBugs(obj_id self)
    {
        if (!utils.hasScriptVar(self, BUG_COUNT))
        {
    ...
    public int droneDied(obj_id self, dictionary params)
    {
