...
public class event_five_boss extends script.base_script
{
    ...
    public int eventMobDied(obj_id self, dictionary params)
    {
    ...
    public void resumeAttack(obj_id self)
    {
        setInvulnerable(self, false);
    ...
    public void spawnTrioAdd(obj_id self, int value)
    {
    ...
    public void spawnMidGuard(obj_id self)
    {
    ...
    public int spawnTrioAdd(obj_id self, dictionary params)
    {
    ...
    public int spawnMidGuard(obj_id self, dictionary params)
    {
    ...
    public int doAEBurst(obj_id self, dictionary params)
    {
        if (!trial.verifySession(self, params))
        {
            return SCRIPT_CONTINUE;
