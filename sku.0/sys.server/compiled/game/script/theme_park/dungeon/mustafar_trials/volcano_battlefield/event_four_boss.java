...
public class event_four_boss extends script.base_script
{
    ...
    public void startAddCycle(obj_id self)
    {
        messageTo(self, "spawnAdd", trial.getSessionDict(self), 6, false);
    }
    public boolean isEventActive(obj_id self)
    {
        return getBooleanObjVar(self, "eventActive");
    }
    public int spawnAdd(obj_id self, dictionary params)
    {
    ...
    public location[] getValidSpawnLocations(obj_id self)
    {
    ...
    public int doPoisonAE(obj_id self, dictionary params)
    {
        if (!trial.verifySession(self, params))
        {
            return SCRIPT_CONTINUE;
    ...
    public int doDiseaseAE(obj_id self, dictionary params)
    {
        if (!trial.verifySession(self, params))
        {
            return SCRIPT_CONTINUE;
    ...
    public int doForceDrainAE(obj_id self, dictionary params)
    {
        if (!trial.verifySession(self, params))
        {
            return SCRIPT_CONTINUE;
