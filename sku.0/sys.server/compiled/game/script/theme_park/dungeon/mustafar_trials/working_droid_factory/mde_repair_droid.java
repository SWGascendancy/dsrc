...
public class mde_repair_droid extends script.base_script
{
    ...
    public int path(obj_id self, dictionary params)
    {
    ...
    public int findCorpse(obj_id self, dictionary params)
    {
        if (!trial.verifySession(self, params))
        {
            return SCRIPT_CONTINUE;
    ...
    public int performRez(obj_id self, dictionary params)
    {
        if (!trial.verifySession(self, params))
        {
            return SCRIPT_CONTINUE;
    ...
    public int formFixerOne(obj_id self, dictionary params)
    {
    ...
    public int getNum(obj_id self)
    {
        return utils.getIntScriptVar(self, "fixerNum");
    }
    public int continueForm(obj_id self, dictionary params)
    {
        int num = getNum(self);
        if (num == 0)
        {
    ...
    public int anim1(obj_id self, dictionary params)
    {
        int num = getNum(self);
        if (num == 1)
        {
    ...
    public int anim2(obj_id self, dictionary params)
    {
        int num = getNum(self);
        if (num == 2)
        {
    ...
    public int anim3(obj_id self, dictionary params)
    {
        int num = getNum(self);
    ...
    public int anim4(obj_id self, dictionary params)
    {
        int num = getNum(self);
        if (num == 0)
        {
    ...
    public int formOfFixer(obj_id self, dictionary params)
    {
        obj_id mde = utils.getObjIdScriptVar(self, "swarming");
        location mdeLoc = getLocation(mde);
        ai_lib.aiPathTo(self, mdeLoc);
    ...
    public int completeTranx(obj_id self, dictionary params)
    {
