...
public class code_terminal_master extends script.base_script
{
    ...
    public void showCodeEntrySui(obj_id terminal, obj_id player)
    {
    ...
    public int handleCodeEntry(obj_id self, dictionary params)
    {
    ...
    public int handleResetTimer(obj_id self, dictionary params)
    {
