...
public class mining_squad_leader extends script.base_script
{
    ...
    public int autoDeploy(obj_id self, dictionary params)
    {
    ...
    public int troopEngaged(obj_id self, dictionary params)
    {
        utils.setScriptVar(self, "engaged", true);
        return SCRIPT_CONTINUE;
    }
    public int deployForces(obj_id self, dictionary params)
    {
    ...
    public int unDeployForces(obj_id self, dictionary params)
    {
