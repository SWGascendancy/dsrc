...
public class observation_droid extends script.base_script
{
    ...
    public int OnTriggerVolumeEntered(obj_id self, String volumeName, obj_id breecher)
    {
        doLogging("xx", "otve");
    ...
    public int locatePatrolPoints(obj_id self, dictionary params)
    {
    ...
    public void handlePatrolTypeReset(obj_id self, location[] patrolPoints)
    {
