...
public class obiwan_dynamic_timeout extends script.base_script
{
    ...
    public void obiwanTriggerVolumeInitializer(obj_id self)
    {
    ...
    public int obiwanTimeoutDelay(obj_id self, dictionary params)
    {
    ...
    public int despawnObiwanDelay(obj_id self, dictionary params)
    {
