...
public class bug_spawner_tracker extends script.base_script
{
    ...
    public int checkForStuck(obj_id self, dictionary params)
    {
        location here = getLocation(self);
    ...
    public void checkForRelayPoint(obj_id self)
    {
    ...
    public int destroyRelayObject(obj_id self, dictionary params)
    {
