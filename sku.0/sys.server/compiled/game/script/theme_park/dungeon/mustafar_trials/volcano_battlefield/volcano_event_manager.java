...
public class volcano_event_manager extends script.base_script
{
    ...
    public obj_id getWaypointId(obj_id dungeon, String wpName)
    {
    ...
    public int eventDefeated(obj_id self, dictionary params)
    {
        int idx = 1;
        if (utils.hasScriptVar(self, "idx"))
        {
    ...
    public int landYt(obj_id self, dictionary params)
    {
    ...
    public int playSmoke(obj_id self, dictionary params)
    {
    ...
    public int replacePlaceholder(obj_id self, dictionary params)
    {
        obj_id oldYt = utils.getObjIdScriptVar(self, "yt");
    ...
    public int destroyOld(obj_id self, dictionary params)
    {
        obj_id yt = params.getObjId("yt");
        destroyObject(yt);
        return SCRIPT_CONTINUE;
    }
    public int destroyYt(obj_id self, dictionary params)
    {
    ...
    public int hkDefeated(obj_id self, dictionary params)
    {
