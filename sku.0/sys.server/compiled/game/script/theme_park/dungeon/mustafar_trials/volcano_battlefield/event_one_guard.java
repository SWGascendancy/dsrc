...
public class event_one_guard extends script.base_script
{
    ...
    public int stopAttack(obj_id self, dictionary params)
    {
    ...
    public int activateShield(obj_id self, dictionary params)
    {
        playClientEffectObj(self, trial.PRT_INVULN_SHIELD, self, "", null, SHIELD);
        return SCRIPT_CONTINUE;
    }
    public int healBoss(obj_id self, dictionary params)
    {
