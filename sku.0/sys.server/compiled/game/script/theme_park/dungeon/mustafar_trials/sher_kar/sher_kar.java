...
public class sher_kar extends script.base_script
{
    ...
    public int doEnrage(obj_id self, dictionary params)
    {
    ...
    public int enrageWarning(obj_id self, dictionary params)
    {
    ...
    public int enrageBuff(obj_id self, dictionary params)
    {
        if (!trial.verifySession(self, params))
        {
            return SCRIPT_CONTINUE;
    ...
    public int performAe(obj_id self, dictionary params)
    {
        if (!trial.verifySession(self, params))
        {
            return SCRIPT_CONTINUE;
    ...
    public void verifyHealth(obj_id self)
    {
    ...
    public void doHealthEvent(obj_id self, int value)
    {
