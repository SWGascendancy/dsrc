...
public class event_one extends script.base_script
{
    ...
    public int beginGuardCycle(obj_id self, dictionary params)
    {
        obj_id[] guardList = utils.getObjIdArrayScriptVar(self, "currentGuardList");
    ...
    public int doGuardAttack(obj_id self, dictionary params)
    {
    ...
    public obj_id getCurrentAttacker(obj_id self)
    {
    ...
    public obj_id chooseNewAttacker(obj_id self)
    {
    ...
    public void winEvent(obj_id self)
    {
