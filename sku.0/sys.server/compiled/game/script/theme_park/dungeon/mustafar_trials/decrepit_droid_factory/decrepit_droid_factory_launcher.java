...
public class decrepit_droid_factory_launcher extends script.base_script
{
    ...
    public boolean hasCorrectQuests(obj_id player)
    {
    ...
    public boolean canEnterDecrepit(obj_id player)
    {
    ...
    public boolean canEnterWorking(obj_id player)
    {
    ...
    public void doBackflagging(obj_id player)
    {
        if (canEnterDecrepit(player))
        {
