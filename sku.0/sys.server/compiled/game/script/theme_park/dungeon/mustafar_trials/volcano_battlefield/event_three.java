...
public class event_three extends script.base_script
{
    ...
    public int activateEvent(obj_id self, dictionary params)
    {
    ...
    public int doGuardAttackCycle(obj_id self, dictionary params)
    {
    ...
    public void winEncounter(obj_id self)
    {
    ...
    public void placeGuardCorpse(obj_id self)
    {
        String[] offSet = 
        {
            "7:4",
    ...
    public void activateBoss(obj_id self)
    {
    ...
    public int doResEffect(obj_id self, dictionary params)
    {
        if (!trial.verifySession(self, params))
        {
            return SCRIPT_CONTINUE;
    ...
    public void performRez(obj_id self, obj_id[] bossList, obj_id[] corpseList)
    {
    ...
    public void checkForLastBoss(obj_id self)
    {
        obj_id[] boss = trial.getObjectsInRangeWithScriptVar(self, trial.VOLCANO_THREE_IS_BOSS, 400.0f);
        obj_id[] corpseList = trial.getObjectsInRangeWithScriptVar(self, trial.VOLCANO_THREE_IS_CORPSE, 400.0f);
    ...
    public void performSoloCorpseRez(obj_id self, obj_id corpse)
    {
