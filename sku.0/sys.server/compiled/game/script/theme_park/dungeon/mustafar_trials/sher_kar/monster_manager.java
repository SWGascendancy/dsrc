...
public class monster_manager extends script.base_script
{
    ...
    public int prepareEventArea(obj_id self, dictionary params)
    {
        spawnSherKar(self);
        spawnGuards(self);
        return SCRIPT_CONTINUE;
    }
    public void spawnSherKar(obj_id self)
    {
    ...
    public int doMidEvent(obj_id self, dictionary params)
    {
    ...
    public int doEndEvent(obj_id self, dictionary params)
    {
        obj_id[] players = trial.getValidTargetsInDungeon(self);
        if (players == null || players.length == 0)
        {
    ...
    public int sherKarDied(obj_id self, dictionary params)
    {
