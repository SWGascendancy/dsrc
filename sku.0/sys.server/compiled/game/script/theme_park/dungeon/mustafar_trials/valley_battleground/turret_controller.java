...
public class turret_controller extends script.base_script
{
    ...
    public boolean isTurretActive(obj_id self)
    {
    ...
    public obj_id getTurret(obj_id player, obj_id controller)
    {
    ...
    public boolean isTurretDisabled(obj_id controller)
    {
    ...
    public int turretDisabled(obj_id self, dictionary params)
    {
        setObjVar(self, "turretDisabled", true);
        return SCRIPT_CONTINUE;
    }
    public int builtTurret(obj_id self, dictionary params)
    {
    ...
    public void regenerateInPlayerInventory(obj_id player, obj_id self)
    {
    ...
    public void fireTurret(obj_id player, obj_id controller)
    {
    ...
    public void presentAssembleSUI(obj_id player, obj_id self)
    {
    ...
    public int handleAssembleTurret(obj_id self, dictionary params)
    {
    ...
    public obj_id getConstructionDroid(obj_id controller)
    {
    ...
    public void presentTargetingSUI(obj_id player, obj_id controller)
    {
        obj_id turret = getTurret(player, controller);
        if (isTurretDisabled(controller))
        {
    ...
    public int handleChooseTarget(obj_id self, dictionary params)
    {
        int idx = sui.getListboxSelectedRow(params);
        obj_id player = sui.getPlayerId(params);
