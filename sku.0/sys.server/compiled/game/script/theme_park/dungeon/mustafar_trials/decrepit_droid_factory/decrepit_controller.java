...
public class decrepit_controller extends script.base_script
{
    ...
    public void spawnOr5(obj_id self)
    {
    ...
    public int codeResetOccured(obj_id self, dictionary params)
    {
    ...
    public int colonelDied(obj_id self, dictionary params)
    {
    ...
    public void deactivateTrap(obj_id self)
    {
