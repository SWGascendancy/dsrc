...
public class link_event_manager extends script.base_script
{
    ...
    public int beginEvent(obj_id self, dictionary params)
    {
        spawnActors(self, 2);
        return SCRIPT_CONTINUE;
    }
    ...
    public int validateRelays(obj_id self, dictionary params)
    {
    ...
    public void deactivateDroid(obj_id self)
    {
        obj_id cell = getCellId(self, trial.UPLINK_ROOM);
        obj_id[] contents = getContents(cell);
        if (contents == null || contents.length == 0)
    ...
    public void stopRandomSoldiers(obj_id self)
    {
        obj_id cell = getCellId(self, trial.UPLINK_ROOM);
        obj_id[] contents = getContents(cell);
        if (contents == null || contents.length == 0)
    ...
    public void stopForemanDrones(obj_id self)
    {
        obj_id cell = getCellId(self, trial.UPLINK_ROOM);
        obj_id[] contents = getContents(cell);
        if (contents == null || contents.length == 0)
    ...
    public int linkEventWon(obj_id self, dictionary params)
    {
