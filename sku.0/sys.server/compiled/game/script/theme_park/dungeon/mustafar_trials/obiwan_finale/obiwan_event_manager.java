...
public class obiwan_event_manager extends script.base_script
{
    ...
    public void clearEventArea(obj_id dungeon)
    {
    ...
    public void cleanupDungeonScriptvars()
    {
        obj_id self = getSelf();
    ...
    public int dungeonCleanup(obj_id self, dictionary params)
    {
        clearEventArea(self);
        return SCRIPT_CONTINUE;
    }
    ...
    public int obiwanSpeechDelay(obj_id self, dictionary params)
    {
        obj_id player = utils.getObjIdScriptVar(self, "player");
    ...
    public int obiwanSpeechContinued(obj_id self, dictionary params)
    {
        obj_id player = utils.getObjIdScriptVar(self, "player");
        obj_id obiwan = utils.getObjIdScriptVar(self, "obiwan");
        faceTo(obiwan, player);
    ...
    public int lightsCameraAction(obj_id self, dictionary params)
    {
        obj_id player = utils.getObjIdScriptVar(self, "player");
        obj_id obiwan = utils.getObjIdScriptVar(self, "obiwan");
    ...
    public int spawnBossDelay(obj_id self, dictionary params)
    {
        obj_id player = utils.getObjIdScriptVar(self, "player");
        obj_id darkJedi = utils.getObjIdScriptVar(self, "darkJedi");
    ...
    public int darkJediThrowsDownPartOne(obj_id self, dictionary params)
    {
        obj_id player = utils.getObjIdScriptVar(self, "player");
        obj_id darkJedi = utils.getObjIdScriptVar(self, "darkJedi");
    ...
    public int obiSaysBeCareful(obj_id self, dictionary params)
    {
        obj_id player = utils.getObjIdScriptVar(self, "player");
        obj_id obiwan = utils.getObjIdScriptVar(self, "obiwan");
        faceTo(obiwan, player);
    ...
    public int obiSaysBeCareful2(obj_id self, dictionary params)
    {
        obj_id player = utils.getObjIdScriptVar(self, "player");
        obj_id obiwan = utils.getObjIdScriptVar(self, "obiwan");
        faceTo(obiwan, player);
    ...
    public int obiwanWarnsOfSpecialAttack(obj_id self, dictionary params)
    {
    ...
    public int obiwanCongratsSpecialAttackBlock(obj_id self, dictionary params)
    {
    ...
    public int darkJediThrowsDownPartTwo(obj_id self, dictionary params)
    {
        obj_id player = utils.getObjIdScriptVar(self, "player");
        obj_id darkJedi = utils.getObjIdScriptVar(self, "darkJedi");
    ...
    public int minionWaveLaunch(obj_id self, dictionary params)
    {
    ...
    public int minionDied(obj_id self, dictionary params)
    {
    ...
    public int obiScoldsPlayer(obj_id self, dictionary params)
    {
        obj_id player = utils.getObjIdScriptVar(self, "player");
        obj_id obiwan = utils.getObjIdScriptVar(self, "obiwan");
    ...
    public int playerGetsCrystal(obj_id self, dictionary params)
    {
        obj_id crystal = utils.getObjIdScriptVar(self, "crystal");
        obj_id player = utils.getObjIdScriptVar(self, "player");
        obj_id obiwan = utils.getObjIdScriptVar(self, "obiwan");
    ...
    public int obiCongratulatesPlayer(obj_id self, dictionary params)
    {
        obj_id player = utils.getObjIdScriptVar(self, "player");
        obj_id obiwan = utils.getObjIdScriptVar(self, "obiwan");
        obj_id crystal = utils.getObjIdScriptVar(self, "crystal");
    ...
    public int obiLeaves(obj_id self, dictionary params)
    {
        obj_id player = utils.getObjIdScriptVar(self, "player");
        obj_id obiwan = utils.getObjIdScriptVar(self, "obiwan");
        faceTo(obiwan, player);
    ...
    public int moveBossToPostureLoc(obj_id self, dictionary params)
    {
        obj_id darkJedi = utils.getObjIdScriptVar(self, "darkJedi");
    ...
    public int moveBossToHomeLoc(obj_id self, dictionary params)
    {
        obj_id darkJedi = utils.getObjIdScriptVar(self, "darkJedi");
        obj_id destination = getCellId(self, "mainroom");
        setMovementRun(darkJedi);
    ...
    public int obiSaysDestroyCrystal(obj_id self, dictionary params)
    {
        obj_id player = utils.getObjIdScriptVar(self, "player");
        obj_id obiwan = utils.getObjIdScriptVar(self, "obiwan");
        faceTo(obiwan, player);
    ...
    public int obiRepeatsDestroyCrystal(obj_id self, dictionary params)
    {
        obj_id obiwan = utils.getObjIdScriptVar(self, "obiwan");
        if (!isIdValid(obiwan))
        {
    ...
    public int moveMinionIntoRoom(obj_id self, dictionary params)
    {
    ...
    public int moveObiwanToPostureLocation(obj_id self, dictionary params)
    {
        obj_id obiwan = utils.getObjIdScriptVar(self, "obiwan");
        obj_id destination = getCellId(self, "mainroom");
    ...
    public int moveObiwanOuttaTheWay(obj_id self, dictionary params)
    {
        obj_id obiwan = utils.getObjIdScriptVar(self, "obiwan");
        obj_id destination = getCellId(self, "mainroom");
        setMovementRun(obiwan);
    ...
    public int moveObiwanForCrystalComment(obj_id self, dictionary params)
    {
        obj_id obiwan = utils.getObjIdScriptVar(self, "obiwan");
        obj_id destination = getCellId(self, "mainroom");
        setMovementRun(obiwan);
    ...
    public int moveObiwanHomeAfterCommenting(obj_id self, dictionary params)
    {
        obj_id obiwan = utils.getObjIdScriptVar(self, "obiwan");
        obj_id destination = getCellId(self, "mainroom");
        setMovementRun(obiwan);
    ...
    public int cleanupScriptVars(obj_id self, dictionary params)
    {
        cleanupDungeonScriptvars();
        return SCRIPT_CONTINUE;
    }
    public int moveObiwanToCrystalSuckLocation(obj_id self, dictionary params)
    {
        obj_id obiwan = utils.getObjIdScriptVar(self, "obiwan");
        obj_id destination = getCellId(self, "mainroom");
        setMovementRun(obiwan);
    ...
    public int blowUpCrystal(obj_id self, dictionary params)
    {
        obj_id crystal = utils.getObjIdScriptVar(self, "crystal");
        destroyObject(crystal);
        return SCRIPT_CONTINUE;
