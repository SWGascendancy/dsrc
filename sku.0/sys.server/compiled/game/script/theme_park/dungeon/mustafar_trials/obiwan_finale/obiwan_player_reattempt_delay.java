...
public class obiwan_player_reattempt_delay extends script.base_script
{
    ...
    public void initializeTimeDelay(obj_id player)
    {
    ...
    public void mustafarReattemptDelayCheck(obj_id player)
    {
    ...
    public int mustafarReattemptTimeoutExpire(obj_id self, dictionary params)
    {
        mustafarReattemptDelayCheck(self);
        return SCRIPT_CONTINUE;
    }
