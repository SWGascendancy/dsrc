...
public class obiwan_lair_boss extends script.base_script
{
    ...
    public int OnAttackerCombatAction(obj_id self, obj_id weapon, obj_id defender)
    {
    ...
    public void stopFighting(obj_id self, obj_id dungeon)
    {
        utils.removeScriptVar(self, "inCombat");
        utils.setScriptVar(self, "ignoreTaunt", 1);
        utils.setScriptVar(self, "ignoreForcePowerAttack", 1);
    ...
    public int startFighting(obj_id self, dictionary params)
    {
        obj_id dungeon = getTopMostContainer(self);
        if (!isIdValid(dungeon))
        {
    ...
    public int randomTaunter(obj_id self, dictionary params)
    {
        if (utils.hasScriptVar(self, "inCombat"))
        {
    ...
    public int randomPraiser(obj_id self, dictionary params)
    {
        if (utils.hasScriptVar(self, "inCombat"))
        {
            if (!utils.hasScriptVar(self, "ignoreTaunt"))
    ...
    public int specialForcePowerAttackWindup(obj_id self, dictionary params)
    {
    ...
    public int specialForcePowerAttackExecute(obj_id self, dictionary params)
    {
