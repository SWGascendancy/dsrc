...
public class demolition_generator extends script.base_script
{
    ...
    public void placeDetonationCharge(obj_id player)
    {
    ...
    public obj_id createCharge(location spawnPoint, obj_id player)
    {
    ...
    public int getCommandoModifyLevel(obj_id player)
    {
        int level = 0;
    ...
    public void generateDetonationDevice(obj_id player, obj_id charge)
    {
