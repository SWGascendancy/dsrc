...
public class obiwan_crystal_object extends script.base_script
{
    ...
    public void theBigCrystalBuff(obj_id player, obj_id terminal)
    {
    ...
    public void destroyTheCrystal(obj_id player, obj_id crystal)
    {
    ...
    public void takeTheCrystal(obj_id player, obj_id crystal)
    {
        utils.removeScriptVar(player, "dealWithCrystal");
        obj_id self = getSelf();
        obj_id dungeon = getTopMostContainer(self);
    ...
    public void drainedCrystalBuff(obj_id player, obj_id crystal)
    {
        buff.applyBuff(player, "crystal_buff_drained");
        playClientEffectObj(player, "clienteffect/mustafar/som_force_crystal_buff.cef", player, "");
        return;
    }
    public int crystalTest1(obj_id self, dictionary params)
    {
        obj_id dungeon = getTopMostContainer(self);
        if (!isIdValid(dungeon))
        {
    ...
    public int crystalTest2(obj_id self, dictionary params)
    {
        obj_id dungeon = getTopMostContainer(self);
        if (!isIdValid(dungeon))
        {
