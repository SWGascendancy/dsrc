...
public class valley_event_manager extends script.base_script
{
    ...
    public void spawnActors(obj_id dungeon, int stage)
    {
    ...
    public void setSpawnScriptVar(obj_id subject, String spawnScriptVar)
    {
    ...
    public void debuffDroidArmy(obj_id self)
    {
        obj_id[] objects = getObjectsInRange(self, 400);
        if (objects == null || objects.length == 0)
        {
    ...
    public void debufMiners(obj_id self)
    {
        obj_id[] objects = getObjectsInRange(self, 400);
        if (objects == null || objects.length == 0)
        {
    ...
    public int generatorDestroyed(obj_id self, dictionary params)
    {
    ...
    public int handleDebufMiners(obj_id self, dictionary params)
    {
        debufMiners(self);
        return SCRIPT_CONTINUE;
    }
    public void redirectArmy(obj_id self)
    {
    ...
    public int commanderDied(obj_id self, dictionary params)
    {
    ...
    public int winTrial(obj_id self, dictionary params)
    {
    ...
    public int loseTrial(obj_id self, dictionary params)
    {
        instance.closeInstance(self);
        return SCRIPT_CONTINUE;
    }
    public int validateDungeon(obj_id self, dictionary params)
    {
        if (!trial.verifySession(self, params, "da_control"))
        {
