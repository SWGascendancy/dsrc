...
public class obiwan_quest_monitor extends script.base_script
{
    ...
    public int OnQuestCompleted(obj_id self, int questNameCrc)
    {
    ...
    public int OnSomeTaskActivated(obj_id self, int questCrc, int taskId)
    {
    ...
    public int recallObiwanDelay(obj_id self, dictionary params)
    {
    ...
    public int callObiWanNow(obj_id self, dictionary params)
    {
        mustafar.callObiwan(self, true, 1);
        return SCRIPT_CONTINUE;
    }
    public int removeMonitor(obj_id self, dictionary params)
    {
        removeObjVar(self, "waitingOnObiwan");
