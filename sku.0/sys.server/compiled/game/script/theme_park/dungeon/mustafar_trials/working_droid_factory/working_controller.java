...
public class working_controller extends script.base_script
{
    ...
    public int remoteCommand(obj_id self, dictionary params)
    {
        String command = "null";
    ...
    public int spawnGuardians(obj_id self, dictionary params)
    {
    ...
    public int spawnDevistator(obj_id self, dictionary params)
    {
    ...
    public int spawnDroidEngineer(obj_id self, dictionary params)
    {
    ...
    public int spawnDoomBringer(obj_id self, dictionary params)
    {
        obj_id[] bossWp = trial.getObjectsInDungeonWithObjVar(self, "boss_wp");
        if (bossWp == null || bossWp.length == 0)
        {
    ...
    public int spawnDoomGuards(obj_id self, dictionary params)
    {
        obj_id[] bossWp = trial.getObjectsInDungeonWithObjVar(self, "boss_wp");
        if (bossWp == null || bossWp.length == 0)
        {
    ...
    public void setEventLocks(obj_id dungeon)
    {
    ...
    public void removeEventLocks(obj_id dungeon)
    {
        for (int i = 0; i < LOCKED_ROOMS.length; i++)
        {
    ...
    public void setEventStates(obj_id dungeon)
    {
    ...
    public int validateAurekBeshKill(obj_id self, dictionary params)
    {
    ...
    public void respawnAurek(obj_id dungeon)
    {
        trial.setAurekKilled(dungeon, false);
    ...
    public void respawnBesh(obj_id dungeon)
    {
        trial.setBeshKilled(dungeon, false);
        obj_id[] bossWp = trial.getObjectsInDungeonWithObjVar(dungeon, "boss_wp");
        if (bossWp == null || bossWp.length == 0)
    ...
    public void guardiansDefeated(obj_id dungeon)
    {
    ...
    public int devistatorKilled(obj_id self, dictionary params)
    {
    ...
    public int mdeKilled(obj_id self, dictionary params)
    {
    ...
    public int fixerOneKilled(obj_id self, dictionary params)
    {
    ...
    public void removeEventStates(obj_id dungeon)
    {
    }
    public int doomBringerKilled(obj_id self, dictionary params)
    {
    ...
    public int doomTargetDestroyed(obj_id self, dictionary params)
    {
    ...
    public int handlePlayerForceRevive(obj_id self, dictionary params)
    {
        obj_id[] players = trial.getPlayersInDungeon(trial.getTop(self));
        if (players == null || players.length == 0)
        {
    ...
    public void lockCell(obj_id dungeon, dictionary params)
    {
        String cell = params.getString("cell");
        trial.makeCellPrivate(dungeon, cell);
    }
    public int spawnHK(obj_id self, dictionary params)
    {
    ...
    public int detonateHK(obj_id self, dictionary params)
    {
        if (!trial.verifySession(self, params, "spawn_hk"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int doExplosionTwo(obj_id self, dictionary params)
    {
    ...
    public int doExplosionThree(obj_id self, dictionary params)
    {
        location[] wp = utils.getLocationArrayScriptVar(self, "wps");
        obj_id viewer = utils.getObjIdScriptVar(self, "viewer");
    ...
    public int doHkTaunt(obj_id self, dictionary params)
    {
    ...
    public int startDuality(obj_id self, dictionary params)
    {
        messageTo(self, "performDuality", trial.getSessionDict(self, "duality"), 12.0f, false);
        return SCRIPT_CONTINUE;
    }
    public int performDuality(obj_id self, dictionary params)
    {
