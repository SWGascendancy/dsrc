...
public class event_two_boss extends script.base_script
{
    ...
    public void startAECycle(obj_id self)
    {
        messageTo(self, "doAEBurst", trial.getSessionDict(self), 0, false);
    }
    public void endAECycle(obj_id self)
    {
        trial.bumpSession(self);
    }
    ...
    public int doConePreBurst(obj_id self, dictionary params)
    {
        if (!trial.verifySession(self, params))
        {
            return SCRIPT_CONTINUE;
    ...
    public int doConeBurst(obj_id self, dictionary params)
    {
        if (!trial.verifySession(self, params))
        {
            return SCRIPT_CONTINUE;
