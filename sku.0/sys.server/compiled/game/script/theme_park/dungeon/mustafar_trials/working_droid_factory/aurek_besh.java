...
public class aurek_besh extends script.base_script
{
    ...
    public int removeInvulnerable(obj_id self, dictionary params)
    {
    ...
    public int aurek_diminish(obj_id self, dictionary params)
    {
    ...
    public int besh_diminish(obj_id self, dictionary params)
    {
    ...
    public int performHealthCheck(obj_id self, dictionary params)
    {
