...
public class obiwan_launch_instance_object extends script.base_script
{
    ...
    public boolean readyForLair(obj_id player)
    {
    ...
    public void confirmLaunch(obj_id player, obj_id terminal)
    {
    ...
    public void confirmEject(obj_id player, obj_id terminal)
    {
    ...
    public void spawnObi(obj_id player, obj_id landmark)
    {
