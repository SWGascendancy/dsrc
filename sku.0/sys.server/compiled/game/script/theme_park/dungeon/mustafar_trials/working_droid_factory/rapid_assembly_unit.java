...
public class rapid_assembly_unit extends script.base_script
{
    ...
    public int triggerEvent(obj_id self, dictionary params)
    {
    ...
    public int doEventSpawn(obj_id self, dictionary params)
    {
    ...
    public void deactivateTerminal(obj_id self)
    {
        restoreTerminal(self);
        setInvulnerable(self, true);
        trial.bumpSession(self);
    }
    public void restoreTerminal(obj_id self)
    {
        if (isDisabled(self))
        {
    ...
    public int fix(obj_id self, dictionary params)
    {
        restoreTerminal(self);
        return SCRIPT_CONTINUE;
    }
