...
public class hk_final_boss extends script.base_script
{
    ...
    public int OnLostTarget(obj_id self, obj_id oldTarget)
    {
        messageTo(self, "applyDistraction", trial.getSessionDict(self), 3, false);
        return SCRIPT_CONTINUE;
    }
    public void startEventActions(obj_id self)
    {
    ...
    public void endEventActions(obj_id self)
    {
        trial.bumpSession(self);
    }
    public int activate(obj_id self, dictionary params)
    {
    ...
    public void verifyHealthReset(obj_id self)
    {
    ...
    public void callYT(obj_id self)
    {
    ...
    public dictionary getAddType(obj_id self, int level)
    {
        dictionary dict = new dictionary();
        if (level == 80)
        {
    ...
    public void summonAdd(obj_id self, int value)
    {
    ...
    public int summonAdd(obj_id self, dictionary params)
    {
    ...
    public location[] getAddSpawnLocations(obj_id self, float range, String type)
    {
    ...
    public int raiseGuard(obj_id self, dictionary params)
    {
    ...
    public void performRez(obj_id self, obj_id[] corpseList)
    {
    ...
    public int performGuardHeal(obj_id self, dictionary params)
    {
    ...
    public int startAECycle(obj_id self, dictionary params)
    {
    ...
    public int performDebuffAe(obj_id self, dictionary params)
    {
        if (!trial.verifySession(self, params))
        {
            return SCRIPT_CONTINUE;
    ...
    public String[] getDebuffEffects(obj_id self)
    {
        String[] hamTypes = 
        {
            "torpor",
    ...
    public String getAEType(obj_id self, String tracking, String[] choices)
    {
        int idx = 0;
    ...
    public void applyAEDebuffs(obj_id self, String[] effects)
    {
    ...
    public int performDamageAe(obj_id self, dictionary params)
    {
        if (!trial.verifySession(self, params))
        {
            return SCRIPT_CONTINUE;
    ...
    public int doWavePreBurst(obj_id self, dictionary params)
    {
        if (!trial.verifySession(self, params))
        {
            return SCRIPT_CONTINUE;
    ...
    public int doWaveBurst(obj_id self, dictionary params)
    {
        if (!trial.verifySession(self, params))
        {
            return SCRIPT_CONTINUE;
    ...
    public int doAirfallPreBurst(obj_id self, dictionary params)
    {
        if (!trial.verifySession(self, params))
        {
            return SCRIPT_CONTINUE;
    ...
    public int doAirfallBurst(obj_id self, dictionary params)
    {
        if (!trial.verifySession(self, params))
        {
            return SCRIPT_CONTINUE;
    ...
    public void cycleNextAE(obj_id self)
    {
        messageTo(self, "performDamageAe", trial.getSessionDict(self), AE_NUKE_RECAST, false);
    }
    public int performPoisonAe(obj_id self, dictionary params)
    {
        if (!trial.verifySession(self, params))
        {
            return SCRIPT_CONTINUE;
    ...
    public int performDiseaseAe(obj_id self, dictionary params)
    {
        if (!trial.verifySession(self, params))
        {
            return SCRIPT_CONTINUE;
    ...
    public int performForceDrainAe(obj_id self, dictionary params)
    {
        if (!trial.verifySession(self, params))
        {
            return SCRIPT_CONTINUE;
    ...
    public int switchTarget(obj_id self, dictionary params)
    {
        if (!trial.verifySession(self, params))
        {
            return SCRIPT_CONTINUE;
    ...
    public int applyDistraction(obj_id self, dictionary params)
    {
        if (!trial.verifySession(self, params))
        {
            return SCRIPT_CONTINUE;
