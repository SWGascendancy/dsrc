...
public class hyperdrive extends script.base_script
{
    ...
    public int showEngineSettings(obj_id pcd, obj_id player)
    {
    ...
    public int CorvetteEngine(obj_id self, dictionary params)
    {
    ...
    public void checkForDestroy(obj_id player, obj_id top, int hyper)
    {
        int fuel = getIntObjVar(top, "fuel");
        if (fuel > hyper)
        {
