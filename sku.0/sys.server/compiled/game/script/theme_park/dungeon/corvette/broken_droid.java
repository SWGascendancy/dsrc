...
public class broken_droid extends script.base_script
{
    ...
    public int clearTrap(obj_id self, dictionary params)
    {
        location here = getLocation(self);
        here.x = here.x + 1;
        here.z = here.z + 1;
    ...
    public int create3p0(obj_id self, dictionary params)
    {
        location here = getLocation(self);
        String planet = here.area;
        obj_id ship = getTopMostContainer(self);
    ...
    public int fixProblem(obj_id self, dictionary params)
    {
        location here = getLocation(self);
        String planet = here.area;
        obj_id ship = getTopMostContainer(self);
