...
public class timer extends script.base_script
{
    ...
    public int fiveMinuteTimer(obj_id self, dictionary params)
    {
    ...
    public int dungeonEnds(obj_id self, dictionary params)
    {
    ...
    public int setUpDungeon(obj_id self, dictionary params)
    {
        obj_id top = space_dungeon.getDungeonIdForPlayer(self);
    ...
    public int youWin(obj_id self, dictionary params)
    {
    ...
    public void groupSetObjVar(obj_id player, String objVarName)
    {
    ...
    public int rewardTime(obj_id self, dictionary params)
    {
    ...
    public int removeMe(obj_id self, dictionary params)
    {
        return SCRIPT_CONTINUE;
    }
    ...
    public void giveBadge(obj_id self)
    {
    ...
    public location pickLandingLocation()
    {
    ...
    public void destroyExtras(obj_id self)
    {
    ...
    public int recheckDungeonType(obj_id self, dictionary params)
    {
        obj_id top = space_dungeon.getDungeonIdForPlayer(self);
        String dungeonType = getStringObjVar(top, "space_dungeon.name");
        if (dungeonType == null || dungeonType.equals(""))
