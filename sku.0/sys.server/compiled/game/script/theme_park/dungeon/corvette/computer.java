...
public class computer extends script.terminal.base.base_terminal
{
    ...
    public int checkForSlicing(obj_id player)
    {
        int slicability = 0;
    ...
    public void setGroupObjVar(obj_id player, String objvarName, int code)
    {
    ...
    public void spawnEnemies(obj_id self, obj_id player)
    {
