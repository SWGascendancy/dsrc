...
public class junk_compactor extends script.base_script
{
    ...
    public obj_id[] getAllJunkItems(obj_id player)
    {
        if (!isIdValid(player))
        {
            return null;
    ...
    public void showSellJunkSui(obj_id player, obj_id target)
    {
    ...
    public void sellJunkItem(obj_id player, obj_id item, boolean reshowSui)
    {
    ...
    public void sellJunkItem(obj_id player, obj_id item)
    {
    ...
    public void sellAllJunk(obj_id player, obj_id target)
    {
        if (!isIdValid(player) || !isIdValid(target))
        {
            return;
    ...
    public int handleSoldAllJunk(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
