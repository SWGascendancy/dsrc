...
public class grievous_ai extends script.base_script
{
    ...
    public int handleGrievousAiLoop(obj_id self, dictionary params)
    {
    ...
    public obj_id lookForPowerCells(obj_id self)
    {
    ...
    public int handleAbsorbPowerCell(obj_id self, dictionary params)
    {
    ...
    public int handleAbsorb5(obj_id self, dictionary params)
    {
    ...
    public int handleAbsorb4(obj_id self, dictionary params)
    {
        if (utils.getBooleanScriptVar(self, "grievous.absorbing") == true)
        {
    ...
    public int handleAbsorb3(obj_id self, dictionary params)
    {
        if (utils.getBooleanScriptVar(self, "grievous.absorbing") == true)
        {
    ...
    public int handleAbsorb2(obj_id self, dictionary params)
    {
        if (utils.getBooleanScriptVar(self, "grievous.absorbing") == true)
        {
    ...
    public int handleAbsorb1(obj_id self, dictionary params)
    {
        if (utils.getBooleanScriptVar(self, "grievous.absorbing") == true)
        {
    ...
    public int handleAbsorb0(obj_id self, dictionary params)
    {
        if (utils.getBooleanScriptVar(self, "grievous.absorbing") == true)
        {
            obj_id powerCell = params.getObjId("powerCell");
