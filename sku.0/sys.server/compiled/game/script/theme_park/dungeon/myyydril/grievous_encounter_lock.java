...
public class grievous_encounter_lock extends script.base_script
{
    ...
    public void clearEncounterCells(obj_id dungeon)
    {
    ...
    public obj_id[] getPlayersInEncounterArea(obj_id dungeon)
    {
        obj_id[] cellIds = getEncounterCellIds(dungeon);
    ...
    public obj_id[] getEventPlayersInDungeon(obj_id dungeon)
    {
    ...
    public obj_id[] getEncounterCellIds(obj_id dungeon)
    {
    ...
    public void ejectPlayersFromEncounter(obj_id player, obj_id dungeon)
    {
    ...
    public void moveSinglePlayerIntoEncounter(obj_id player, obj_id dungeon, int sessionId)
    {
        int x = -280;
        int y = -108;
        int z = -18;
    ...
    public void moveGroupIntoEncounter(obj_id player, obj_id dungeon, int sessionId)
    {
    ...
    public boolean isSessionAvailable(obj_id dungeon, boolean godOverride)
    {
        if (godOverride)
        {
    ...
    public boolean validateEncounterSession(obj_id dungeon)
    {
    ...
    public int getSessionId(obj_id target)
    {
    ...
    public boolean validatePlayerSessionId(obj_id player, obj_id dungeon)
    {
    ...
    public int setSessionIds(obj_id dungeon)
    {
        int sessionId = 0;
    ...
    public void startEventTimer(obj_id dungeon, int sessionId)
    {
    ...
    public String getDungeonRemainingTimeString(obj_id dungeon)
    {
        int currentTime = getGameTime();
    ...
    public int calculateNextMessage(obj_id dungeon)
    {
        int currentTime = getGameTime();
        int sessionEnd = utils.getIntScriptVar(dungeon, encounter_end);
        int sessionTimeRemaining = sessionEnd - currentTime;
    ...
    public void devalidateEventPlayersInDungeon(obj_id dungeon)
    {
    ...
    public int OnReceivedItem(obj_id self, obj_id container, obj_id transferer, obj_id item)
    {
        if (!isPlayer(item))
        {
            return SCRIPT_CONTINUE;
    ...
    public int resetEncounterLocks(obj_id self, dictionary params)
    {
    ...
    public int beginEncounter(obj_id self, dictionary params)
    {
    ...
    public int handleSessionTimerUpdate(obj_id self, dictionary params)
    {
    ...
    public int validatePlayersInEvent(obj_id self, dictionary params)
    {
        obj_id[] players = getPlayersInEncounterArea(self);
        if (players != null && players.length > 0)
        {
