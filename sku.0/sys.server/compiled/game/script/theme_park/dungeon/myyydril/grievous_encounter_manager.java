...
public class grievous_encounter_manager extends script.base_script
{
    ...
    public int handleBeginEncounter(obj_id self, dictionary params)
    {
    ...
    public int handleEndEncounter(obj_id self, dictionary params)
    {
        obj_id top = getTopMostContainer(self);
        obj_id cell = getCellId(top, "hall57");
    ...
    public int handlePowerCellDestroyed(obj_id self, dictionary params)
    {
        obj_id top = getTopMostContainer(self);
        obj_id cell = getCellId(top, "hall57");
        String powerTable = "datatables/dungeon/myyydril/power_cell_locations.iff";
    ...
    public int handleSpawnSpeedFast(obj_id self, dictionary params)
    {
        setObjVar(self, "grievous_encounter.powerSpawn", 20.0f);
        return SCRIPT_CONTINUE;
    }
    public int handleSpawnSpeedMed(obj_id self, dictionary params)
    {
        setObjVar(self, "grievous_encounter.powerSpawn", 40.0f);
        return SCRIPT_CONTINUE;
    }
    public int handleSpawnSpeedSlow(obj_id self, dictionary params)
    {
        setObjVar(self, "grievous_encounter.powerSpawn", 60.0f);
        return SCRIPT_CONTINUE;
    }
    public int handleSpawnSpeedReallySlow(obj_id self, dictionary params)
    {
        setObjVar(self, "grievous_encounter.powerSpawn", 80.0f);
        return SCRIPT_CONTINUE;
    }
    public int handleNpcDeath(obj_id self, dictionary params)
    {
