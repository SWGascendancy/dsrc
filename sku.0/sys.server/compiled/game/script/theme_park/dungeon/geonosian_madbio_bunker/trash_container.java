...
public class trash_container extends script.base_script
{
    ...
    public int OnAboutToOpenContainer(obj_id self, obj_id opener)
    {
        if (!hasObjVar(self, "trap_off"))
        {
            return SCRIPT_OVERRIDE;
    ...
    public void makeShutOffSwitch(obj_id self)
    {
    ...
    public int trapShutOff(obj_id self, dictionary params)
    {
    ...
    public int turntrapOn(obj_id self, dictionary params)
    {
        if (hasObjVar(self, "trap_off"))
        {
    ...
    public int showTrap(obj_id self, dictionary params)
    {
        if (!hasObjVar(self, "trap_off"))
        {
    ...
    public int resetTrash(obj_id self, dictionary params)
    {
        setObjVar(self, "present", 1);
        return SCRIPT_CONTINUE;
    }
