...
public class chemical_poison_shutoff extends script.base_script
{
    ...
    public void shutoffTrap(obj_id trap, obj_id player)
    {
    ...
    public int OnAboutToReceiveItem(obj_id self, obj_id srcContainer, obj_id giver, obj_id item)
    {
        obj_id trap = getObjIdObjVar(self, "trap");
    ...
    public int destroyPoisonStabilizer(obj_id self, dictionary params)
    {
