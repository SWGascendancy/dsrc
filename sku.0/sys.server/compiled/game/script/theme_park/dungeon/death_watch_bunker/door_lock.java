...
public class door_lock extends script.base_script
{
    ...
    public int addToList(obj_id self, dictionary params)
    {
    ...
    public int removeFromList(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        if (!isIdValid(player) || !isPlayer(player))
        {
    ...
    public boolean convertAccessList(obj_id room)
    {
        if (!isIdValid(room))
        {
            return false;
    ...
    public obj_id[] nameListToObjId(String[] name_list)
    {
