...
public class mandalorian_crafting extends script.base_script
{
    ...
    public int OnDeath(obj_id self, obj_id killer, obj_id corpse_id)
    {
        detachScript(self, "theme_park.dungeon.death_watch_bunker.mandalorian_crafting");
        return SCRIPT_CONTINUE;
    }
    public int secondTime(obj_id self, dictionary params)
    {
    ...
    public int firstBox(obj_id self, dictionary params)
    {
        string_id terminal = new string_id(MSGS, "use_terminal");
        sendSystemMessage(self, terminal);
    ...
    public int testSui(obj_id self, obj_id player)
    {
    ...
    public int finishSui(obj_id self, obj_id player)
    {
    ...
    public int readableText(obj_id self, dictionary params)
    {
    ...
    public int notYet(obj_id self, obj_id player)
    {
        string_id notready = new string_id(MSGS, "crafting_not_yet");
        sendSystemMessage(player, notready);
        return 0;
    }
    public int completeText(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
    ...
    public int thirtySecondsLeft(obj_id self, dictionary params)
    {
    ...
    public void finishCraftingSession(obj_id self, obj_id player, obj_id droid)
    {
    ...
    public int finalTenSeconds(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
