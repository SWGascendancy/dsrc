...
public class hall_door_terminal extends script.base_script
{
    ...
    public void checkAuthorization(obj_id structure, obj_id player)
    {
    ...
    public void spawnWave(obj_id player)
    {
        obj_id self = getSelf();
    ...
    public void unlockDoors(obj_id structure, obj_id player)
    {
    ...
    public int handleLockDown(obj_id self, dictionary params)
    {
        utils.removeScriptVar(self, "terminal_lock_out");
        return SCRIPT_CONTINUE;
    }
    public int handleCallSupport1(obj_id self, dictionary params)
    {
        obj_id structure = getTopMostContainer(self);
        int defenderCreatures = dataTableGetNumRows(TBL_HALL_WAVE);
        int x = 0;
    ...
    public int handleCallSupport2(obj_id self, dictionary params)
    {
        obj_id structure = getTopMostContainer(self);
        int defenderCreatures = dataTableGetNumRows(TBL_HALL_WAVE);
        int x = 0;
