...
public class locked_crafting_room extends script.base_script
{
    ...
    public int unlockYourself(obj_id self, dictionary params)
    {
    ...
    public void addPartyToList(obj_id player)
    {
        obj_id self = getSelf();
    ...
    public void removeAll(obj_id self)
    {
    ...
    public int addTailorDroid(obj_id self, dictionary params)
    {
        obj_id droid = params.getObjId("droid");
        setObjVar(self, "tailorDroid", droid);
        return SCRIPT_CONTINUE;
    }
    public int addEngineerDroid(obj_id self, dictionary params)
    {
        obj_id droid = params.getObjId("droid");
        setObjVar(self, "engineerDroid", droid);
        return SCRIPT_CONTINUE;
    }
    public int addArmorDroid(obj_id self, dictionary params)
    {
        obj_id droid = params.getObjId("droid");
        setObjVar(self, "armorDroid", droid);
        return SCRIPT_CONTINUE;
    }
    public int addJetPackDroid(obj_id self, dictionary params)
    {
        obj_id droid = params.getObjId("droid");
        setObjVar(self, "jetPackDroid", droid);
        return SCRIPT_CONTINUE;
    }
    public int cleanOutRoom(obj_id self, dictionary params)
    {
        obj_id droid = null;
