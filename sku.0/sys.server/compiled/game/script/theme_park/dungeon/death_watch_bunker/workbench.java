...
public class workbench extends script.base_script
{
    ...
    public boolean checkForGasMask(obj_id player)
    {
    ...
    public boolean checkForFilter(obj_id player)
    {
        obj_id[] objContents = utils.getContents(player, true);
        if (objContents != null)
        {
    ...
    public boolean checkForEnhancedFilter(obj_id player)
    {
        obj_id[] objContents = utils.getContents(player, true);
        if (objContents != null)
        {
    ...
    public boolean checkForGelPacket(obj_id player)
    {
        obj_id[] objContents = utils.getContents(player, true);
        if (objContents != null)
        {
    ...
    public void combineGasMask(obj_id player)
    {
        obj_id[] objContents = utils.getContents(player, true);
        if (objContents != null)
        {
    ...
    public void combineFilter(obj_id player)
    {
        if (!isIdValid(player))
        {
            return;
