...
public class death_watch_poison_player extends script.base_script
{
    ...
    public boolean checkForGasMask(obj_id self)
    {
    ...
    public void poisonAirLogIn(obj_id self)
    {
        messageTo(self, "handlePoisonAir", null, 30f, false);
        return;
    }
    public void poisonAir(obj_id self)
    {
        messageTo(self, "handlePoisonAir", null, 10f, false);
        return;
    }
    public boolean validateRoom(obj_id self)
    {
    ...
    public int handlePoisonAir(obj_id self, dictionary params)
    {
        obj_id structure = player_structure.getStructure(self);
        if (!isIdValid(structure))
        {
