...
public class craft_droidengineer_droid extends script.base_script
{
    ...
    public void checkForComplete(obj_id self, obj_id player)
    {
    ...
    public int craftItem(obj_id self, dictionary params)
    {
    ...
    public void ingredientMessages(obj_id self, obj_id player)
    {
    ...
    public void createTerminal(obj_id self)
    {
        location here = getLocation(self);
        here.x = here.x + 1;
    ...
    public void makeArmorPiece(String type, obj_id player)
    {
        obj_id playerInv = utils.getInventoryContainer(player);
    ...
    public int roomReset(obj_id self, dictionary params)
    {
    ...
    public int removePlayer(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
