...
public class rc_mouse extends script.base_script
{
    ...
    public int moveLeft(obj_id self, dictionary params)
    {
    ...
    public int moveRight(obj_id self, dictionary params)
    {
        location here = getLocation(self);
        int dist = params.getInt("distance");
        if (dist == 0)
    ...
    public int moveForward(obj_id self, dictionary params)
    {
        location here = getLocation(self);
        int dist = params.getInt("distance");
        if (dist == 0)
    ...
    public int moveBackward(obj_id self, dictionary params)
    {
        location here = getLocation(self);
        int dist = params.getInt("distance");
        if (dist == 0)
