...
public class crazed_miner extends script.base_script
{
    ...
    public int handleCrazedCleanup(obj_id self, dictionary params)
    {
        obj_id structure = getTopMostContainer(self);
    ...
    public int handleCrazedAttack(obj_id self, dictionary params)
    {
    ...
    public int handleHaldoTimeOut(obj_id self, dictionary params)
    {
        obj_id structure = getTopMostContainer(self);
        obj_id player = getObjIdObjVar(structure, "death_watch.haldo_player");
        if (isIdValid(player))
    ...
    public int makeCrazedMinerInvulnerable(obj_id self, dictionary params)
    {
