...
public class repair_droid extends script.base_script
{
    ...
    public void spawnAttackWaveOne(obj_id droid)
    {
    ...
    public void spawnAttackWaveTwo(obj_id droid)
    {
    ...
    public int handleGetTools(obj_id self, dictionary params)
    {
        obj_id structure = getTopMostContainer(self);
        if (!isIdValid(structure))
        {
    ...
    public int handleGoVentilation(obj_id self, dictionary params)
    {
        obj_id structure = getTopMostContainer(self);
        if (!isIdValid(structure))
        {
    ...
    public int handleFix(obj_id self, dictionary params)
    {
        if (isIncapacitated(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleAttackDroid(obj_id self, dictionary params)
    {
