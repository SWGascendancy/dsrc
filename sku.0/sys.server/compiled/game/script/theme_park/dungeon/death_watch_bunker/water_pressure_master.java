...
public class water_pressure_master extends script.base_script
{
    ...
    public void loadWaterTerminals(obj_id self)
    {
    ...
    public void loadWaterLights(obj_id self)
    {
    ...
    public void flipSwitchOne(obj_id terminal, obj_id player)
    {
    ...
    public void flipSwitchTwo(obj_id terminal, obj_id player)
    {
        obj_id structure = player_structure.getStructure(terminal);
        if (!isIdValid(structure))
        {
    ...
    public void flipSwitchThree(obj_id terminal, obj_id player)
    {
        obj_id structure = player_structure.getStructure(terminal);
        if (!isIdValid(structure))
        {
    ...
    public void flipSwitchFour(obj_id terminal, obj_id player)
    {
        obj_id structure = player_structure.getStructure(terminal);
        if (!isIdValid(structure))
        {
    ...
    public void checkForSuccess(obj_id structure, obj_id player)
    {
        if (!isIdValid(player))
        {
            return;
    ...
    public int handleTerminalSwitch(obj_id self, dictionary params)
    {
    ...
    public int handleWaterPumpReset(obj_id self, dictionary params)
    {
    ...
    public int handleWaterPumpTimeOut(obj_id self, dictionary params)
    {
        if (!hasObjVar(self, "death_watch.water_pressure_mission"))
        {
            return SCRIPT_CONTINUE;
