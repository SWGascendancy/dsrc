...
public class space_dungeon_controller extends script.base_script
{
    ...
    public int OnBuildoutObjectRegisterWithController(obj_id self, obj_id registeringObject)
    {
    ...
    public int msgSetSessionId(obj_id self, dictionary params)
    {
    ...
    public int handleLockoutTimerUpdate(obj_id self, dictionary params)
    {
        space_dungeon.setDungeonLockoutTimer(self);
        return SCRIPT_CONTINUE;
    }
    public int msgManualDungeonReset(obj_id self, dictionary params)
    {
    ...
    public int addPlayerToParticipantIdList(obj_id self, dictionary params)
    {
    ...
    public int removePlayerFromParticipantIdList(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId(space_dungeon.PLAYER_ID);
