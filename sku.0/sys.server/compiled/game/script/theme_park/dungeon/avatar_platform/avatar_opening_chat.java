...
public class avatar_opening_chat extends script.base_script
{
    ...
    public int handleStartChatting(obj_id self, dictionary params)
    {
        obj_id structure = getTopMostContainer(self);
    ...
    public int handleResponse(obj_id self, dictionary params)
    {
        obj_id structure = getTopMostContainer(self);
    ...
    public int handleMoreExplosions(obj_id self, dictionary params)
    {
