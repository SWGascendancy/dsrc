...
public class avatar_destruction_player extends script.base_script
{
    ...
    public int handleExplosionEffect(obj_id self, dictionary params)
    {
        obj_id structure = getTopMostContainer(self);
        location here = getLocation(self);
        String planet = here.area;
    ...
    public int handleAvatarDestructionPlayer(obj_id self, dictionary params)
    {
        obj_id structure = getTopMostContainer(self);
        location here = getLocation(self);
        String planet = here.area;
    ...
    public void killPlayer(obj_id player, obj_id killer)
    {
    ...
    public void ejectPlayerFromAvatar(obj_id player)
    {
