...
public class avatar_jawa_attack extends script.base_script
{
    ...
    public int handleSummonJawa(obj_id self, dictionary params)
    {
        obj_id structure = getTopMostContainer(self);
    ...
    public int handleJawaDeath(obj_id self, dictionary params)
    {
    ...
    public int handleReturnHome(obj_id self, dictionary params)
    {
        setInvulnerable(self, true);
        obj_id structure = getTopMostContainer(self);
