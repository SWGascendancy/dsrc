...
public class avatar_boss_fight_spawn extends script.base_script
{
    ...
    public void spawnBossFight(obj_id commanddeck, obj_id player)
    {
        obj_id self = getSelf();
        obj_id structure = getTopMostContainer(self);
    ...
    public void beginTaunt(obj_id self, obj_id player)
    {
        obj_id structure = getTopMostContainer(self);
    ...
    public int handleOpenDoor(obj_id self, dictionary params)
    {
        obj_id structure = getTopMostContainer(self);
        obj_id commanddeck = getCellId(structure, "commanddeck");
