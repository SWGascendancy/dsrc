...
public class avatar_entrance_explosion extends script.base_script
{
    ...
    public int OnReceivedItem(obj_id self, obj_id destinationCell, obj_id transferrer, obj_id item)
    {
        if (!isPlayer(item))
        {
    ...
    public void startExplosionFinal(obj_id player, obj_id self)
    {
        obj_id structure = getTopMostContainer(self);
    ...
    public void startExplosionSequence(obj_id player, obj_id self)
    {
        obj_id structure = getTopMostContainer(self);
    ...
    public int handleMoreExplosion01(obj_id self, dictionary params)
    {
    ...
    public int handleMoreExplosion02(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        obj_id structure = getTopMostContainer(self);
        obj_id entrance = getCellId(structure, "entrance");
    ...
    public int handleMoreExplosion03(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        obj_id structure = getTopMostContainer(self);
        obj_id entrance = getCellId(structure, "entrance");
    ...
    public int handleMoreExplosion04(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        obj_id structure = getTopMostContainer(self);
        obj_id entrance = getCellId(structure, "entrance");
    ...
    public int handleMoreExplosion05(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        obj_id structure = getTopMostContainer(self);
        obj_id entrance = getCellId(structure, "entrance");
    ...
    public int handleMoreExplosion06(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        obj_id structure = getTopMostContainer(self);
        obj_id entrance = getCellId(structure, "entrance");
    ...
    public int handleMoreExplosion07(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        obj_id structure = getTopMostContainer(self);
        obj_id entrance = getCellId(structure, "entrance");
    ...
    public int handlePlayerCheck(obj_id self, dictionary params)
    {
        obj_id structure = getTopMostContainer(self);
        obj_id[] items = getContents(self);
        if (items != null && items.length > 0)
