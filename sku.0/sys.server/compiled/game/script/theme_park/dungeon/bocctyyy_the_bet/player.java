...
public class player extends script.base_script
{
    ...
    public int arrivedAtBocctyyyTaskComplete(obj_id self, dictionary params)
    {
    ...
    public int msgDungeonEjectConfirmed(obj_id self, dictionary params)
    {
    ...
    public int msgDungeonLaunchConfirmed(obj_id self, dictionary params)
    {
