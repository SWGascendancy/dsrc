...
public class empire_day_interior_npc_spawner extends script.base_script
{
    ...
    public int beginEmpireDaySpawning(obj_id self, dictionary params)
    {
    ...
    public int randomCreatureDied(obj_id self, dictionary params)
    {
        return SCRIPT_CONTINUE;
    }
    ...
    public int animatedMood(obj_id self, dictionary params)
    {
    ...
    public boolean isEmpireDayRunning()
    {
