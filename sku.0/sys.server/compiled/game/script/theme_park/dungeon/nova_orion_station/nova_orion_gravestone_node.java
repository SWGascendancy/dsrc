...
public class nova_orion_gravestone_node extends script.base_script
{
    ...
    public int startNoFinaleEvent(obj_id self, dictionary params)
    {
    ...
    public int safeResetNoFinaleEvent(obj_id self, dictionary params)
    {
    ...
    public int cleanupNoFinaleEvent(obj_id self, dictionary params)
    {
        if (utils.hasScriptVar(self, "graveEventInProgress"))
        {
            utils.removeScriptVar(self, "graveEventInProgress");
