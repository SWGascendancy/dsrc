...
public class cantina extends script.base_script
{
    ...
    public obj_id spawnHan(obj_id self)
    {
    ...
    public obj_id spawnChewie(obj_id self)
    {
        obj_id room = getCellId(self, "private_room2");
    ...
    public obj_id spawnPadawanTrialsNpc(obj_id self)
    {
    ...
    public obj_id spawnNien(obj_id self)
    {
    ...
    public obj_id spawnGamblor(obj_id self)
    {
    ...
    public obj_id spawnEngineer(obj_id self)
    {
    ...
    public obj_id spawnRetired(obj_id self)
    {
