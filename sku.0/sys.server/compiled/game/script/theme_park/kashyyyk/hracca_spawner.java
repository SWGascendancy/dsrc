...
public class hracca_spawner extends script.base_script
{
    ...
    public int doHraccaSpawnEvent(obj_id self, dictionary params)
    {
        if (params == null)
        {
    ...
    public void createMob(String whatToSpawn, location here, obj_id self)
    {
    ...
    public String getSpawnType(String spawnType)
    {
    ...
    public int handleDeleteChissFog(obj_id self, dictionary params)
    {
        obj_id fogParticleObj = getObjIdObjVar(self, "fogParticleObj");
        if (isIdValid(fogParticleObj))
        {
    ...
    public int doCleanupEvent(obj_id self, dictionary params)
    {
        if (!hasObjVar(self, "myCreations"))
        {
            return SCRIPT_CONTINUE;
