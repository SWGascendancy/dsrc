...
public class hracca_controller extends script.base_script
{
    ...
    public int registerChissPoacher(obj_id self, dictionary params)
    {
    ...
    public int handleChissPoacherDestroyed(obj_id self, dictionary params)
    {
    ...
    public void sendChissCountUpdateMessage(obj_id controller, string_id message)
    {
    ...
    public int msgSpaceDungeonCleanup(obj_id self, dictionary params)
    {
        obj_id[] spawners = space_dungeon.getRegisteredObjects(self);
        if (spawners != null && spawners.length > 0)
        {
    ...
    public int testWeatherStateChange(obj_id self, dictionary params)
    {
        return SCRIPT_CONTINUE;
    }
}
