...
public class bocctyyy_bet_spawner extends script.base_script
{
    ...
    public int doBocctyyySpawnEvent(obj_id self, dictionary params)
    {
    ...
    public void createMob(String questName, location here, float radius, obj_id self)
    {
    ...
    public String getSpawnType(String questName)
    {
        String spawnType = "";
