...
public class etyyy_broodmaster_hsskas_spawner extends script.base_script
{
    ...
    public boolean canSpawnHsskas(obj_id player)
    {
        return groundquests.isTaskActive(player, "ep3_gursan_slay_hsskas", "taskApproachHsskas");
    }
    public void generateEscapePod(obj_id self, obj_id player)
    {
    ...
    public void triggerEvent(obj_id player)
    {
    ...
    public boolean isHsskasAvailable(obj_id self)
    {
    ...
    public int destroyEscapePod(obj_id self, dictionary params)
    {
        handlePlayerDepart(self);
        return SCRIPT_CONTINUE;
    }
