...
public class rodian_shuttle_spawner extends script.base_script
{
    ...
    public int doShuttleSpawnEvent(obj_id self, dictionary params)
    {
        int maxPop = 1;
    ...
    public int shuttleDestroyed(obj_id self, dictionary params)
    {
    ...
    public void destroySpawnedShuttles(obj_id self)
    {
        obj_id shuttle = utils.getObjIdScriptVar(self, "myCreation");
        if (isIdValid(shuttle))
        {
