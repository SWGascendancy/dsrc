...
public class robe_collection_wave_controller extends script.base_script
{
    ...
    public boolean isEligibleForJediEvent(obj_id self, obj_id player)
    {
    ...
    public dictionary getJediEventData(obj_id self)
    {
    ...
    public boolean hasJediEventFailedBuff(obj_id self, obj_id player)
    {
        dictionary eventData = getJediEventData(self);
        if (eventData != null)
        {
    ...
    public void jediEventBegin(obj_id self, obj_id player)
    {
        if (!hasObjVar(self, OBJVAR_EVENT_NAME))
        {
            return;
    ...
    public int handleStartJediEvent(obj_id self, dictionary params)
    {
        if (!hasObjVar(self, OBJVAR_EVENT_NAME))
        {
            return SCRIPT_CONTINUE;
    ...
    public int jediEventChildDestroyed(obj_id self, dictionary params)
    {
