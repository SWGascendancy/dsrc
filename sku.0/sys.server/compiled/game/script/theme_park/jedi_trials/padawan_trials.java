...
public class padawan_trials extends script.base_script
{
    ...
    public int handleOnAttach(obj_id self, dictionary params)
    {
    ...
    public int handleScriptInitialized(obj_id self, dictionary params)
    {
    ...
    public int handleDoPadawanTrialsSetup(obj_id self, dictionary params)
    {
        jedi_trials.doPadawanTrialsSetup(self);
        return SCRIPT_CONTINUE;
    }
    public int handleForceShrineTrialMessage(obj_id self, dictionary params)
    {
    ...
    public int handleSetBeginLoc(obj_id self, dictionary params)
    {
        int[] questList = getIntArrayObjVar(self, jedi_trials.PADAWAN_QUESTLIST_OBJVAR);
        if (questList == null || questList.length < 1)
        {
    ...
    public int tryToRequestLocation(obj_id self, dictionary params)
    {
    ...
    public int OnLocationReceived(obj_id self, String locationId, obj_id locationObject, location locationLocation, float locationRadius)
    {
        if (locationId == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleSetSecondLoc(obj_id self, dictionary params)
    {
        int[] questList = getIntArrayObjVar(self, jedi_trials.PADAWAN_QUESTLIST_OBJVAR);
        if (questList == null || questList.length < 1)
        {
    ...
    public int handleSetThirdLoc(obj_id self, dictionary params)
    {
        int[] questList = getIntArrayObjVar(self, jedi_trials.PADAWAN_QUESTLIST_OBJVAR);
        if (questList == null || questList.length < 1)
        {
    ...
    public int OnArrivedAtLocation(obj_id self, String locationName)
    {
        int[] questList = getIntArrayObjVar(self, jedi_trials.PADAWAN_QUESTLIST_OBJVAR);
        if (questList == null || questList.length < 1)
        {
    ...
    public int handlerTrialNpcKilled(obj_id self, dictionary params)
    {
        int[] questList = getIntArrayObjVar(self, jedi_trials.PADAWAN_QUESTLIST_OBJVAR);
        if (questList == null || questList.length < 1)
        {
    ...
    public int handleTrialComplete(obj_id self, dictionary params)
    {
        if (hasObjVar(self, jedi_trials.JEDI_TRIALS_CUR_TRIAL_TOTAL_OBJVAR))
        {
    ...
    public int handleJediPadawanTrialsComplete(obj_id self, dictionary params)
    {
    ...
    public int handleQuestFailure(obj_id self, dictionary params)
    {
    ...
    public int jediTrialsRestartCurrentTrial(obj_id self, dictionary params)
    {
        if (hasObjVar(self, jedi_trials.PADAWAN_WAYPOINT_OBJVAR))
        {
            obj_id oldWaypoint = getObjIdObjVar(self, jedi_trials.PADAWAN_WAYPOINT_OBJVAR);
    ...
    public int jediTrialsFailedCleanup(obj_id self, dictionary params)
    {
        if (hasSkill(self, jedi_trials.PADAWAN_INITIATE_SKBOX))
        {
            utils.setScriptVar(self, "jedi_trials.PadawanTrialsRevoke", true);
    ...
    public int jediTrialsCleanup(obj_id self, dictionary params)
    {
        if (hasObjVar(self, jedi_trials.PADAWAN_WAYPOINT_OBJVAR))
        {
            obj_id oldWaypoint = getObjIdObjVar(self, jedi_trials.PADAWAN_WAYPOINT_OBJVAR);
    ...
    public int handleTellAboutRestart(obj_id self, dictionary params)
    {
        sendSystemMessage(self, jedi_trials.SID_PADAWAN_TELL_ABOUT_RESTART);
        return SCRIPT_CONTINUE;
    }
    public int handleRestartOrAbortPadawanTrialsChoice(obj_id self, dictionary params)
    {
    ...
    public int handleRestartCurrentPadawanTrial(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleAbortPadawanTrials(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public int[] getDatatableRowsForStringsInColumn(String datatable, String column, String targetString)
    {
