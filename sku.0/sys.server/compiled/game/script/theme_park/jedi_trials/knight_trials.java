...
public class knight_trials extends script.base_script
{
    ...
    public int jediTrialsTurnedOff(obj_id self, dictionary params)
    {
    ...
    public int initializeKnightTrials(obj_id self, dictionary params)
    {
    ...
    public int handleForceShrineWrongShrineMessage(obj_id self, dictionary params)
    {
        sendSystemMessage(self, jedi_trials.SID_FORCE_SHRINE_WRONG);
        return SCRIPT_CONTINUE;
    }
    public int handleForceShrineWrongPlanetMessage(obj_id self, dictionary params)
    {
    ...
    public int handleKnightTrialsCouncilChoice(obj_id self, dictionary params)
    {
    ...
    public int handleJediKnightTrialsComplete(obj_id self, dictionary params)
    {
    ...
    public boolean isOpposedFaction(obj_id player, int jediCouncil)
    {
    ...
    public void giveOpposedFactionWarning(obj_id player, int jediCouncil)
    {
        string_id closeButton = jedi_trials.SID_CLOSE_BUTTON;
        string_id title = jedi_trials.SID_KNIGHT_TRIALS_TITLE;
        String str_message = "";
