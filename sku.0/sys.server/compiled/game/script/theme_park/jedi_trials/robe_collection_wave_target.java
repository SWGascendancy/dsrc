...
public class robe_collection_wave_target extends script.base_script
{
    ...
    public int jediEventInitializeNpc(obj_id self, dictionary params)
    {
    ...
    public int jediEventLightJediHandler(obj_id self, dictionary params)
    {
        obj_id parent = trial.getParent(self);
    ...
    public int jediEventDistanceCheck(obj_id self, dictionary params)
    {
    ...
    public int jediEventCombatCheck(obj_id self, dictionary params)
    {
    ...
    public int makeJediEventStopCombat(obj_id self, dictionary params)
    {
    ...
    public String buffListForCSLog(obj_id player)
    {
    ...
    public int handleJediEventExit(obj_id self, dictionary params)
    {
        setState(self, STATE_GLOWING_JEDI, true);
        messageTo(self, "handleJediEventDestroySelf", null, 1.0f, false);
        return SCRIPT_CONTINUE;
    }
    public int handleJediEventDestroySelf(obj_id self, dictionary params)
    {
        obj_id player = utils.getObjIdScriptVar(self, SCRIPTVAR_EVENT_PLAYER);
        obj_id parent = trial.getParent(self);
        dictionary webster = new dictionary();
    ...
    public void setJediEventFailed(obj_id self, obj_id player)
    {
    ...
    public boolean hasFailedJediEvent(obj_id self)
    {
    ...
    public void jediEventEnded(obj_id self, obj_id player)
    {
        int maxHealth = getUnmodifiedMaxAttrib(self, HEALTH);
