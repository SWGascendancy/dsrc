...
public class marauderbase_spawner extends script.base_script
{
    ...
    public void spawnKingTerak(obj_id self)
    {
    ...
    public void spawnCharal(obj_id self)
    {
    ...
    public void spawnFightmasterJorak(obj_id self)
    {
    ...
    public void spawnScholarSzingo(obj_id self)
    {
