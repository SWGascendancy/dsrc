...
public class palace_masterspawner extends script.base_script
{
    ...
    public int handleDelayedImperialSpawn(obj_id self, dictionary params)
    {
    ...
    public void spawnWarrenImperial(obj_id bldg)
    {
    ...
    public void spawnLibrarian(obj_id self)
    {
    ...
    public void spawnQueen(obj_id self)
    {
    ...
    public void spawnComputer(obj_id self)
    {
