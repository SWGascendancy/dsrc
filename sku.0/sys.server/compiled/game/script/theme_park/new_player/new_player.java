...
public class new_player extends script.base_script
{
    ...
    public int OnSkillRevoked(obj_id self, String skillName)
    {
    ...
    public int handleHelperDroidCheck(obj_id self, dictionary params)
    {
        if (!newPlayerQuestsEnabled() || isJedi(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int setupHelperDroid(obj_id self, dictionary params)
    {
        if (!newPlayerQuestsEnabled() || isJedi(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleNewProfessionGreetingResponse(obj_id self, dictionary params)
    {
    ...
    public int handleGiveQuestHelp(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleShowHolocronGeneralInfo(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleDelayedAcceptingQuest(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleRefusedQuestHelp(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleBrawlerWeaponChoice(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleMarksmanWeaponChoice(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleStartingRecommendation(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleHelperDroidDestroyed(obj_id self, dictionary params)
    {
        if (isSpaceScene())
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleGiveNewProfessionQuestPrompt(obj_id self, dictionary params)
    {
        String droidName = getDroidName(self);
        String profession = getStringObjVar(self, CURRENT_PROFESSION_OBJVAR);
    ...
    public int handleGiveProfessionAddedMessage(obj_id self, dictionary params)
    {
        giveProfessionAddedMessage(self);
        return SCRIPT_CONTINUE;
    }
    public int handleGiveQuestMessage(obj_id self, dictionary params)
    {
        obj_id helperDroidPcd = getHelperDroidPcd(self);
        if (!isIdValid(helperDroidPcd))
        {
    ...
    public int handleDoQuestComplete(obj_id self, dictionary params)
    {
    ...
    public int handlePlayerCombatKill(obj_id self, dictionary params)
    {
    ...
    public int handleNewPlayerScoutAction(obj_id self, dictionary params)
    {
        if (hasObjVar(self, SCOUT_QUEST_OBJVAR))
        {
    ...
    public int handleQuestCraftingAction(obj_id self, dictionary params)
    {
    ...
    public int handleNewPlayerArtisanAction(obj_id self, dictionary params)
    {
        String xpReward = "";
        int xpAmount = 0;
        int creditsReward = 0;
    ...
    public int handleImageDesignerSkipped(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleNewPlayerEntertainerAction(obj_id self, dictionary params)
    {
        if (hasObjVar(self, ENTERTAINER_QUEST_OBJVAR))
        {
    ...
    public int handleNewPlayerMedicAction(obj_id self, dictionary params)
    {
        if (hasObjVar(self, MEDIC_QUEST_OBJVAR))
        {
    ...
    public int handleSetupPeriodicProgressCheck(obj_id self, dictionary params)
    {
        if (isSpaceScene())
        {
            return SCRIPT_CONTINUE;
    ...
    public int handlePeriodicProgressCheck(obj_id self, dictionary params)
    {
        if (isSpaceScene())
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleDroidGreeting(obj_id self, dictionary params)
    {
    ...
    public void giveQuestMessage(obj_id player)
    {
    ...
    public void skipImageDesign(obj_id player)
    {
        int species = getSpecies(player);
        String speciesName = utils.getPlayerSpeciesName(species);
    ...
    public void showDelayedAcceptingQuestMessage(obj_id player)
    {
        String droidName = getDroidName(player);
    ...
    public void giveBrawlerWeaponChoice(obj_id player)
    {
    ...
    public void giveMarksmanWeaponChoice(obj_id player)
    {
    ...
    public void giveStartingRecommendation(obj_id player)
    {
        String profession = getStringObjVar(player, CURRENT_PROFESSION_OBJVAR);
    ...
    public void giveProfessionAddedMessage(obj_id player)
    {
    ...
    public void giveInventoryFullMessage(obj_id player)
    {
        String droidName = getDroidName(player);
    ...
    public void giveQuestCompleteSui(obj_id player)
    {
        String droidName = getDroidName(player);
    ...
    public void giveFinalQuestMessage(obj_id player, int questNum)
    {
        String profession = getStringObjVar(player, CURRENT_PROFESSION_OBJVAR);
        String droidName = getDroidName(player);
        int numAchieved = 0;
    ...
    public void giveEntertainerFinal(obj_id player)
    {
        String droidName = getDroidName(player);
    ...
    public void giveMedicFinal(obj_id player)
    {
        String droidName = getDroidName(player);
        int numHealed = 0;
    ...
    public boolean newPlayerQuestsEnabled()
    {
        return false;
    }
    public boolean isOnTutorial(obj_id player)
    {
    ...
    public void unpackHelperDroid(obj_id player)
    {
        if (isSpaceScene())
        {
            return;
    ...
    public obj_id getHelperDroidPcd(obj_id player)
    {
    ...
    public void removeCurrentProfessionObjVar(obj_id player, String profession)
    {
        if (hasObjVar(player, CURRENT_PROFESSION_OBJVAR))
        {
    ...
    public String getDroidName(obj_id player)
    {
        obj_id pcd = getHelperDroidPcd(player);
    ...
    public String getQuestProfession(obj_id self, String noviceSkill)
    {
    ...
    public void checkForSpecialReward(obj_id player, boolean finalCompleted)
    {
    ...
    public void giveStimpackResources(obj_id player)
    {
    ...
    public void checkForProfessionEquipmentNeeded(obj_id player)
    {
        if (!hasObjVar(player, CURRENT_PROFESSION_OBJVAR))
        {
            return;
    ...
    public void giveTaskCompleteRewardMessage(obj_id player, string_id profession, int credits)
    {
        String droidName = getDroidName(player);
    ...
    public void giveTaskCompleteNoRewardMessage(obj_id player, string_id profession)
    {
        String droidName = getDroidName(player);
    ...
    public int oneButtonSui(obj_id controller, obj_id player, String handler, string_id title, string_id textMsg, string_id okButton)
    {
        String newTitle = utils.packStringId(title);
        return oneButtonSui(controller, player, handler, newTitle, textMsg, okButton);
    }
    public int oneButtonSui(obj_id controller, obj_id player, String handler, String title, string_id textMsg, string_id okButton)
    {
    ...
    public int twoButtonSui(obj_id controller, obj_id player, String handler, String title, string_id textMsg, string_id okButton, string_id cancelButton)
    {
        String TEXT_MSG = utils.packStringId(textMsg);
        return twoButtonSui(controller, player, handler, title, TEXT_MSG, okButton, cancelButton);
    }
    public int twoButtonSui(obj_id controller, obj_id player, String handler, String title, String textMsg, string_id okButton, string_id cancelButton)
    {
        if (utils.hasScriptVar(player, "new_player.openSui"))
        {
            int oldSui = utils.getIntScriptVar(player, "new_player.openSui");
    ...
    public int threeButtonSui(obj_id controller, obj_id player, String handler, string_id title, string_id textMsg, string_id okButton, string_id cancelButton, string_id revertButton)
    {
        String newTitle = utils.packStringId(title);
        return threeButtonSui(controller, player, handler, newTitle, textMsg, okButton, cancelButton, revertButton);
    }
    public int threeButtonSui(obj_id controller, obj_id player, String handler, String title, string_id textMsg, string_id okButton, string_id cancelButton, string_id revertButton)
    {
        if (utils.hasScriptVar(player, "new_player.openSui"))
        {
            int oldSui = utils.getIntScriptVar(player, "new_player.openSui");
    ...
    public void showProfessionsListbox(obj_id player, string_id greetingEnd)
    {
        if (utils.hasScriptVar(player, "new_player.openSui"))
        {
            int oldSui = utils.getIntScriptVar(player, "new_player.openSui");
    ...
    public int getNumProfessionQuests(obj_id player)
    {
        int num = 0;
        if (hasObjVar(player, BRAWLER_QUEST_OBJVAR))
        {
    ...
    public void setInitialProfessionProgress(obj_id player, String profession)
    {
    ...
    public boolean getProfessionProgress(obj_id player, String profession)
    {
        String objvarName = QUEST_OBJVAR_BASE + profession;
        String scriptvarName = NEW_PLAYER_OBJVAR_BASE + profession + "Progress";
    ...
    public void getProfessionQuestHelp(obj_id player)
    {
        if (!hasObjVar(player, CURRENT_PROFESSION_OBJVAR))
        {
            return;
    ...
    public void showSpaceListbox(obj_id player, string_id sid_msg, boolean useGreeting)
    {
        if (utils.hasScriptVar(player, "new_player.openSui"))
        {
            int oldSui = utils.getIntScriptVar(player, "new_player.openSui");
    ...
    public String chooseDroidVocals()
    {
        int choice = rand(1, 3);
    ...
    public int handleSpaceIntro(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        int idx = sui.getListboxSelectedRow(params);
        int bp = sui.getIntButtonPressed(params);
    ...
    public int handleSpaceIntroBegin(obj_id self, dictionary params)
    {
        string_id sid_msg = new string_id("new_player", "space_greeting");
