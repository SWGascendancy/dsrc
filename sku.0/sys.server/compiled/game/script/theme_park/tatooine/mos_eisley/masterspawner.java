...
public class masterspawner extends script.base_script
{
    ...
    public void spawnHanandChewie(obj_id self)
    {
    ...
    public void spawnPadawanTrialsNpc(obj_id self)
    {
    ...
    public void spawnChadraFans(obj_id self)
    {
        obj_id room = getCellId(self, "cantina");
    ...
    public void spawnFoyer(obj_id self)
    {
    ...
    public void spawnOffice(obj_id self) {
        ...
        setName(vendor, "A Mysterious Droid");
    }
    public void spawnClosePatrons(obj_id self)
    {
        obj_id room = getCellId(self, "cantina");
    ...
    public void spawnStandingConvoGroup(obj_id self)
    {
        obj_id room = getCellId(self, "cantina");
    ...
    public void spawnAudience(obj_id self)
    {
        obj_id room = getCellId(self, "cantina");
    ...
    public void spawnBarPatronsRight(obj_id self)
    {
        obj_id room = getCellId(self, "cantina");
    ...
    public void spawnSittingPatrons(obj_id self)
    {
        obj_id room = getCellId(self, "cantina");
    ...
    public void spawnWuher(obj_id self)
    {
    ...
    public void spawnBithBand(obj_id self)
    {
    ...
    public int peopleDied(obj_id self, dictionary params)
    {
        spawnEveryone(self);
        return SCRIPT_CONTINUE;
    }
    public int wuherDied(obj_id self, dictionary params)
    {
        spawnWuher(self);
        return SCRIPT_CONTINUE;
    }
    ...
    public void spawnCheatedGambler(obj_id self)
    {
    ...
    public void spawnJunkDealer(obj_id self)
    {
