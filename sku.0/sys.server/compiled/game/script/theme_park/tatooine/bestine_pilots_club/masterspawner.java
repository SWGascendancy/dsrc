...
public class masterspawner extends script.base_script
{
    ...
    public obj_id spawnPilot1(obj_id self)
    {
    ...
    public obj_id spawnWoman1(obj_id self, obj_id pilot1)
    {
        obj_id mainhall = getCellId(self, "mainhall");
    ...
    public obj_id spawnAtPilot1(obj_id self, obj_id woman1)
    {
        obj_id mainhall = getCellId(self, "mainhall");
    ...
    public obj_id spawnTrooperLeader1(obj_id self)
    {
        obj_id mainhall = getCellId(self, "mainhall");
    ...
    public void spawnTrooper1(obj_id self, obj_id trooperLeader1)
    {
        obj_id mainhall = getCellId(self, "mainhall");
    ...
    public void spawnTrooper2(obj_id self, obj_id trooperLeader1)
    {
        obj_id mainhall = getCellId(self, "mainhall");
    ...
    public obj_id spawnPilot2(obj_id self)
    {
        obj_id mainhall = getCellId(self, "mainhall");
    ...
    public obj_id spawnPilot3(obj_id self, obj_id pilot2)
    {
        obj_id mainhall = getCellId(self, "mainhall");
    ...
    public void spawnPilot4(obj_id self, obj_id pilot2)
    {
        obj_id mainhall = getCellId(self, "mainhall");
    ...
    public void spawnPilot5(obj_id self, obj_id pilot3)
    {
        obj_id mainhall = getCellId(self, "mainhall");
    ...
    public void spawnPilot6(obj_id self, obj_id pilot3)
    {
        obj_id mainhall = getCellId(self, "mainhall");
    ...
    public int pilot1Died(obj_id self, dictionary params)
    {
        spawnPilot1(self);
        return SCRIPT_CONTINUE;
    }
    public int woman1Died(obj_id self, dictionary params)
    {
        obj_id pilot1 = getObjIdObjVar(self, "ClubInhabitants.pilot1");
        spawnWoman1(self, pilot1);
        return SCRIPT_CONTINUE;
    }
    public int atPilot1Died(obj_id self, dictionary params)
    {
        obj_id woman1 = getObjIdObjVar(self, "ClubInhabitants.woman1");
        spawnAtPilot1(self, woman1);
        return SCRIPT_CONTINUE;
    }
    public int trooperLeader1Died(obj_id self, dictionary params)
    {
        spawnTrooperLeader1(self);
        return SCRIPT_CONTINUE;
    }
    public int trooper1Died(obj_id self, dictionary params)
    {
        obj_id trooperLeader1 = getObjIdObjVar(self, "ClubInhabitants.trooperleader1");
        spawnTrooper1(self, trooperLeader1);
        return SCRIPT_CONTINUE;
    }
    public int trooper2Died(obj_id self, dictionary params)
    {
        obj_id trooperLeader1 = getObjIdObjVar(self, "ClubInhabitants.trooperleader1");
        spawnTrooper2(self, trooperLeader1);
        return SCRIPT_CONTINUE;
    }
    public int pilot2Died(obj_id self, dictionary params)
    {
        spawnPilot2(self);
        return SCRIPT_CONTINUE;
    }
    public int pilot3Died(obj_id self, dictionary params)
    {
        obj_id pilot2 = getObjIdObjVar(self, "ClubInhabitants.pilot2");
        spawnPilot3(self, pilot2);
        return SCRIPT_CONTINUE;
    }
    public int pilot4Died(obj_id self, dictionary params)
    {
        obj_id pilot2 = getObjIdObjVar(self, "ClubInhabitants.pilot2");
        spawnPilot4(self, pilot2);
        return SCRIPT_CONTINUE;
    }
    public int pilot5Died(obj_id self, dictionary params)
    {
        obj_id pilot3 = getObjIdObjVar(self, "ClubInhabitants.pilot3");
        spawnPilot5(self, pilot3);
        return SCRIPT_CONTINUE;
    }
    public int pilot6Died(obj_id self, dictionary params)
    {
        obj_id pilot3 = getObjIdObjVar(self, "ClubInhabitants.pilot3");
        spawnPilot6(self, pilot3);
        return SCRIPT_CONTINUE;
