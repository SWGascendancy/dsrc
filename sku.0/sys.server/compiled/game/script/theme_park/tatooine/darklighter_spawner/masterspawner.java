...
public class masterspawner extends script.base_script
{
	...
	public void spawnCourtyardPeeps()
	{
	...
	public void spawnHuff(obj_id self)
	{
		spawn("huff_darklighter", 0f, 1.0f, 4.2f, 0, getCellId(self, "lobby"), "npc_imperial");
	}
	public void spawnConversations(obj_id self){
	...
	public void spawnGuardPatrol(obj_id self){
	...
	public int spawnMoreGuards(obj_id self, dictionary params){
