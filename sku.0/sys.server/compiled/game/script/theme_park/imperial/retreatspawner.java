...
public class retreatspawner extends script.base_script
{
    ...
    public void spawnExtras(obj_id self)
    {
        spawnThrawn(self);
        spawnVeers(self);
    ...
    public void spawnKaja(obj_id self)
    {
    ...
    public void spawnRecordKeeper(obj_id self)
    {
    ...
    public void spawnRequisitionTerminal(obj_id self)
    {
    ...
    public void spawnSpysTerminal(obj_id self)
    {
    ...
    public void spawnLoam(obj_id self)
    {
    ...
    public void spawnHethrir(obj_id self)
    {
    ...
    public void spawnDarth(obj_id self)
    {
    ...
    public void spawnEmperor(obj_id self)
    {
    ...
    public void spawnCrimson1(obj_id self)
    {
    ...
    public void spawnCrimson2(obj_id self)
    {
        obj_id mainhall = getCellId(self, "mainhall");
    ...
    public void spawnCrimson3(obj_id self)
    {
        obj_id emperor = getCellId(self, "emperor");
    ...
    public void spawnCrimson4(obj_id self)
    {
        obj_id emperor = getCellId(self, "emperor");
    ...
    public obj_id spawnStormtrooper1(obj_id self)
    {
        obj_id mainhall = getCellId(self, "mainhall");
    ...
    public void spawnStormtrooper2(obj_id self, obj_id st1)
    {
        obj_id mainhall = getCellId(self, "mainhall");
    ...
    public void spawnVelso(obj_id self)
    {
        obj_id mainhall = getCellId(self, "mainhall");
    ...
    public void spawnStormtrooper3(obj_id self)
    {
        obj_id vader = getCellId(self, "vader");
    ...
    public void spawnStormtrooper4(obj_id self)
    {
        obj_id vader = getCellId(self, "vader");
    ...
    public void spawnMouse1(obj_id self)
    {
        obj_id mainhall = getCellId(self, "mainhall");
    ...
    public void spawnMouse2(obj_id self)
    {
    ...
    public void spawnMouse3(obj_id self)
    {
        obj_id library = getCellId(self, "library");
    ...
    public void spawnRa7(obj_id self)
    {
        obj_id library = getCellId(self, "library");
    ...
    public void spawnThrawn(obj_id self)
    {
    ...
    public void spawnVeers(obj_id self)
    {
    ...
    public void spawnShuttlePilot(obj_id self)
    {
    ...
    public void spawnShuttlePilot2(obj_id self)
    {
    ...
    public int spawnTheGuards(obj_id self, dictionary params)
    {
        spawnGuards(self);
        setObjVar(self, "people", 1);
        return SCRIPT_CONTINUE;
    }
    public int doFacing(obj_id self, dictionary params)
    {
    ...
    public void killExtras(obj_id self)
    {
