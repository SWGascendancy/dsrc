...
public class quest_player extends script.base_script
{
    ...
    public int finishImpQuest(obj_id self, dictionary params)
    {
        String datatable = getStringObjVar(self, "quest_table");
        String file = "theme_park_imperial/quest_details";
        String questID = dataTableGetString(datatable, 1, "temp_objvar");
    ...
    public void spawnExtras(obj_id self, location spawn, String questID)
    {
        String datatable = getStringObjVar(self, "quest_table");
    ...
    public int removeImperialQuestInfo(obj_id self, dictionary params)
    {
