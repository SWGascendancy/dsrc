...
public class player extends script.base_script
{
    ...
    public int finishDroidQuest(obj_id self, dictionary params)
    {
    ...
    public int finishGasQuest(obj_id self, dictionary params)
    {
    ...
    public int gotImggcu(obj_id self, dictionary params)
    {
    ...
    public int gotHarddrive(obj_id self, dictionary params)
    {
    ...
    public int goSeeGuy(obj_id self, dictionary params)
    {
    ...
    public int goToCave(obj_id self, dictionary params)
    {
    ...
    public int goSeeImperial(obj_id self, dictionary params)
    {
    ...
    public int goGetGas(obj_id self, dictionary params)
    {
    ...
    public int goSeeRetired(obj_id self, dictionary params)
    {
    ...
    public int goResearchLab(obj_id self, dictionary params)
    {
