...
public class boss_nyms_themepark extends script.base_script
{
    ...
    public int handleBossDistanceCheck(obj_id self, dictionary params)
    {
    ...
    public boolean getRandomCombatTarget(obj_id self, obj_id parent)
    {
    ...
    public int moveCreatureToWaypoint(obj_id self, dictionary params)
    {
        if (!isValidId(self) || !exists(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int checkCombatStatus(obj_id self, dictionary params)
    {
        if (!isValidId(self) || !exists(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int willDespawn(obj_id self, dictionary params)
    {
        if (!isValidId(self) || !exists(self))
        {
            return SCRIPT_CONTINUE;
