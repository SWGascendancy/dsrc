...
public class mining_cave extends script.base_script
{
    ...
    public int spawnQuestObjects(obj_id self, dictionary params)
    {
    ...
    public int handleSpawns(obj_id self, dictionary params)
    {
        if (!isValidId(self) || !exists(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public boolean doSpawn(int spawn_num, String planet, obj_id self)
    {
        if (spawn_num < 0)
        {
            return false;
