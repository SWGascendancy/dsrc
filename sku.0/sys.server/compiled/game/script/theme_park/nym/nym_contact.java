...
public class nym_contact extends script.base_script
{
    ...
    public int OnNpcConversationResponse(obj_id self, String convo, obj_id speaker, string_id response)
    {
    ...
    public void pickCard(obj_id self)
    {
    ...
    public void winner(obj_id self, obj_id speaker, int amt)
    {
    ...
    public void tieGame(obj_id self, obj_id speaker, int amt)
    {
    ...
    public void loser(obj_id self, obj_id speaker, int amt)
    {
