...
public class race_coordinator extends script.base_script
{
    ...
    public int resetDailyTime(obj_id self, dictionary params)
    {
        float topRecord = 2885.0f;
        setObjVar(self, "racing.lok.topRecord", topRecord);
        String topRecordName = "Ben Quadinaros";
    ...
    public int messageWhatsMyTime(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
    ...
    public int messageErasePersonalBest(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
