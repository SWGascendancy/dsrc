...
public class sentry2_path extends script.base_script
{
    ...
    public int startPatrol(obj_id self, dictionary params)
    {
    ...
    public int spot2(obj_id self, dictionary params)
    {
        obj_id stronghold = getTopMostContainer(self);
    ...
    public int spot3(obj_id self, dictionary params)
    {
        obj_id stronghold = getTopMostContainer(self);
    ...
    public int spot4(obj_id self, dictionary params)
    {
        obj_id stronghold = getTopMostContainer(self);
    ...
    public int spot5(obj_id self, dictionary params)
    {
        obj_id stronghold = getTopMostContainer(self);
    ...
    public String pickOverlyElaborateAnimationActionFromList()
    {
