...
public class slicing_minigame extends script.base_script
{
    ...
    public boolean createSafeSui(obj_id collectionItem, obj_id player)
    {
    ...
    public boolean applyPuzzleDebuff(obj_id collectionItem, obj_id player)
    {
        if (!isValidId(collectionItem) || !isValidId(player))
        {
            return false;
    ...
    public boolean incrementWrongAnswer(obj_id collectionItem, obj_id player)
    {
    ...
    public boolean getRandomPassword(obj_id collectionItem, obj_id player)
    {
    ...
    public boolean rerollPuzzleNeeded(obj_id collectionItem, obj_id player)
    {
        if (!isValidId(collectionItem) || !exists(collectionItem))
        {
            return false;
    ...
    public boolean checkGuessList(obj_id collectionItem, obj_id player, String anagram)
    {
        blog("checkGuessList");
        if (!isValidId(collectionItem) || !isValidId(player))
        {
    ...
    public boolean givePoints(obj_id collectionItem, obj_id player, String anagram)
    {
        if (!isValidId(collectionItem) || !isValidId(player))
        {
            return false;
    ...
    public boolean rewardPlayer(obj_id collectionItem, obj_id player)
    {
    ...
    public void removePlayerNonImperativeVars(obj_id player)
    {
        utils.removeScriptVarTree(player, NONIMPERATIVE_VAR_PREFIX);
        utils.removeObjVar(player, NONIMPERATIVE_VAR_PREFIX);
    }
    public void removePlayerImperativeVars(obj_id player)
    {
