...
public class disarm_bomb_puzzle extends script.base_script
{
    ...
    public boolean createBombUI(obj_id collectionItem, obj_id player)
    {
    ...
    public boolean initializePlayer(obj_id collectionItem, obj_id player)
    {
        if (!isValidId(collectionItem) || !isValidId(player))
        {
            return false;
    ...
    public String getBombData(obj_id collectionItem, obj_id player)
    {
        if (!isValidId(collectionItem) || !isValidId(player))
        {
            return null;
    ...
    public boolean blowUpBomb(obj_id collectionItem, obj_id player)
    {
        if (!isIdValid(player) || !exists(player))
        {
            return false;
    ...
    public int refreshSuiBombTimerData(obj_id self, dictionary params)
    {
    ...
    public int removeDefuseVar(obj_id self, dictionary params)
    {
