...
public class code_break_minigame extends script.base_script
{
    ...
    public boolean createSui(obj_id collectionItem, obj_id player)
    {
    ...
    public boolean getRandomNumberCombinations(obj_id collectionItem, obj_id player)
    {
        if (!isValidId(collectionItem) || !isValidId(player))
        {
            return false;
    ...
    public boolean calculateThreshold(obj_id collectionItem, obj_id player, int guessPosition)
    {
        if (!isValidId(collectionItem) || !isValidId(player))
        {
            return false;
    ...
    public boolean completeNumberGuess(obj_id collectionItem, obj_id player, int guessPosition)
    {
        if (!isValidId(collectionItem) || !isValidId(player))
        {
            return false;
