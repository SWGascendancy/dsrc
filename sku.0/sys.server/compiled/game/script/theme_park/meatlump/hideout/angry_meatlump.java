...
public class angry_meatlump extends script.base_script
{
    ...
    public void setAngryMealumpRequiredEmote(obj_id self)
    {
    ...
    public void becomeHappyMeatlump(obj_id self, obj_id player)
    {
    ...
    public int OnIncapacitated(obj_id self, obj_id objAttacker)
    {
        obj_id hideout = getObjIdObjVar(self, HIDEOUT_ID_OBJVAR);
        if (isIdValid(hideout))
        {
