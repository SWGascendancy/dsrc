...
public class meatlump_king extends script.base_script
{
    ...
    public void determineKingReaction(obj_id self, obj_id player, int row)
    {
    ...
    public void processKingReaction(obj_id self, obj_id player, int reactionType, String reaction)
    {
        faceTo(self, player);
        switch (reactionType)
        {
