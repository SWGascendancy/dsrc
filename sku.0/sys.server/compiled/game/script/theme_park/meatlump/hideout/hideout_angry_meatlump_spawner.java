...
public class hideout_angry_meatlump_spawner extends script.base_script
{
    ...
    public int handleInitializeAngryMeatlumps(obj_id self, dictionary params)
    {
    ...
    public int makeNewAngryMeatlump(obj_id self, dictionary params)
    {
        Vector angryMeatlumps = new Vector();
        angryMeatlumps.setSize(0);
    ...
    public Vector findEligibleMeatlumps(obj_id hideout)
    {
