...
public class quest_shuttle_comlink extends script.base_script
{
    ...
    public void destroySelf(obj_id self)
    {
        detachScript(self, "item.special.nodestroy");
        destroyObject(self);
    }
    public boolean wildLocation(obj_id player)
    {
        if (!isIdValid(player) || !exists(player))
        {
            return false;
    ...
    public boolean spawnEvent(obj_id self, obj_id player)
    {
    ...
    public boolean spawnShuttle(obj_id self, obj_id player)
    {
    ...
    public boolean spawnRagTags(obj_id self, obj_id player)
    {
    ...
    public location getRandomLocationAroundPlayer(obj_id self, obj_id player)
    {
    ...
    public boolean checkScene(obj_id self, obj_id player)
    {
        if (!isValidId(player) || !exists(player))
        {
            return false;
