...
public class force_storm extends script.base_script
{
    ...
    public int acquireTarget(obj_id self, dictionary params)
    {
    ...
    public int forceStormPulse(obj_id self, dictionary params)
    {
    ...
    public int endLifeCycle(obj_id self, dictionary params)
    {
