...
public class axkva extends script.base_script
{
    ...
    public int contagion_bomb(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        queueCommand(self, (-1658679050), player, "", COMMAND_PRIORITY_DEFAULT);
        return SCRIPT_CONTINUE;
    }
    public int do_victory_warp(obj_id self, dictionary params)
    {
    ...
    public int attack_nearest(obj_id self, dictionary params)
    {
    ...
    public int axkva_dictate(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int axkva_force_whirl(obj_id self, obj_id target, String params, float defaultTime)
    {
