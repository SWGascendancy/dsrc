...
public class medic extends script.base_script
{
    ...
    public int findSquad(obj_id self, dictionary params)
    {
    ...
    public int followMySquad(obj_id self, dictionary params)
    {
    ...
    public int performHeal(obj_id self, dictionary params)
    {
    ...
    public boolean isValidTarget(obj_id self, obj_id target)
    {
    ...
    public void sendGodMessage(Vector gods, String message)
    {
