...
public class ig88_controller extends script.base_script
{
    ...
    public int ig88Died(obj_id self, dictionary params)
    {
        if (!isIdValid(self))
        {
    ...
    public int killNPC(obj_id self, dictionary params)
    {
        if (!isIdValid(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int ig88_failed(obj_id self, dictionary params)
    {
        if (!isIdValid(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int ig88_failure_check(obj_id self, dictionary params)
    {
        if (!isIdValid(self))
        {
            return SCRIPT_CONTINUE;
