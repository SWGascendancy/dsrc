...
public class ig88 extends script.base_script
{
    ...
    public void shoutRandom(obj_id self, String msg)
    {
        msg = msg + rand(1, 10);
    ...
    public int waypoint1(obj_id self, dictionary params)
    {
        if (!isIdValid(self))
        {
    ...
    public int waypoint2(obj_id self, dictionary params)
    {
        if (!isIdValid(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int shoutRegret(obj_id self, dictionary params)
    {
        if (!isIdValid(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int shoutBombDroids(obj_id self, dictionary params)
    {
        if (!isIdValid(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int shoutDroidekas(obj_id self, dictionary params)
    {
        if (!isIdValid(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int shoutSuperDroids(obj_id self, dictionary params)
    {
        if (!isIdValid(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int shoutAssassination(obj_id self, dictionary params)
    {
        if (!isIdValid(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int shoutBombIntermission(obj_id self, dictionary params)
    {
        if (!isIdValid(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int shoutFailed(obj_id self, dictionary params)
    {
        if (!isIdValid(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public void findNextTarget(obj_id self)
    {
    ...
    public int findTarget(obj_id self, dictionary params)
    {
        if (!isIdValid(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int colorize(obj_id self, dictionary params)
    {
        if (!isIdValid(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int nextWeaponPhase(obj_id self, dictionary params)
    {
    ...
    public int nextComboPhase(obj_id self, dictionary params)
    {
        if (!isIdValid(self) || ai_lib.isDead(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int OnDeath(obj_id self, obj_id killer, obj_id corpse)
    {
