...
public class ct_executioner extends script.base_script
{
    ...
    public int kill_prisoner(obj_id self, dictionary params)
    {
        setInvulnerable(self, true);
        messageTo(self, "handleDelayedExecute", null, 3.0f, false);
        return SCRIPT_CONTINUE;
    }
    public int handleDelayedExecute(obj_id self, dictionary params)
    {
    ...
    public void failExecute(obj_id self)
    {
