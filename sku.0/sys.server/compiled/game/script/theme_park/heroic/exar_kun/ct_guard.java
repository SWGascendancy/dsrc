...
public class ct_guard extends script.base_script
{
    ...
    public int start_boss_buff(obj_id self, dictionary params)
    {
        messageTo(self, "buff_boss", trial.getSessionDict(self, "buff"), 0.0f, false);
        buff.applyBuff(self, "caretaker_guard_buff");
        return SCRIPT_CONTINUE;
    }
    public int buff_boss(obj_id self, dictionary params)
    {
    ...
    public int activateGuard(obj_id self, dictionary params)
    {
