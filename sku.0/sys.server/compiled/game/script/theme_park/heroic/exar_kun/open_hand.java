...
public class open_hand extends script.base_script
{
    ...
    public int summonNextAdd(obj_id self, dictionary params)
    {
    ...
    public obj_id getNextCultist(obj_id[] allSpawn)
    {
    ...
    public String getCultistString(obj_id self)
    {
    ...
    public void incrementAddsKilled(obj_id self)
    {
        int killed = getNumberAddsKilled(self);
        killed++;
        utils.setScriptVar(self, "killed", killed);
    }
    public int getNumberAddsKilled(obj_id self)
    {
        return utils.hasScriptVar(self, "killed") ? utils.getIntScriptVar(self, "killed") : 0;
    }
    public int sharePain(obj_id self, dictionary params)
    {
        if (isDead(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int finalBuff(obj_id self, dictionary params)
    {
    ...
    public int teslaZap(obj_id self, dictionary params)
    {
        if (isDead(self))
        {
            return SCRIPT_CONTINUE;
