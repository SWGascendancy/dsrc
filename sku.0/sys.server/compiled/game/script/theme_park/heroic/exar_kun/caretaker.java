...
public class caretaker extends script.base_script
{
    ...
    public int lightning(obj_id self, dictionary params)
    {
    ...
    public int start_phase_2(obj_id self, dictionary params)
    {
    ...
    public int drain(obj_id self, dictionary params)
    {
        if (isDead(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int vapor(obj_id self, dictionary params)
    {
        if (isDead(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int execute(obj_id self, dictionary params)
    {
