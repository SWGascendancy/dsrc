...
public class exar_wordbringer extends script.base_script
{
    ...
    public int left_zap(obj_id self, dictionary params)
    {
    ...
    public int right_zap(obj_id self, dictionary params)
    {
        if (!trial.verifySession(self, params, "tesla"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int execute_blast(obj_id self, dictionary params)
    {
        if (!trial.verifySession(self, params, "tesla"))
        {
            return SCRIPT_CONTINUE;
    ...
    public obj_id getRandomHateTarget(obj_id subject)
    {
    ...
    public int handle_death(obj_id self, dictionary params)
    {
        stop(self);
