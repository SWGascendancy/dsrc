...
public class exar_observer extends script.base_script
{
    ...
    public int start_observation(obj_id self, dictionary params)
    {
        trial.bumpSession(self, "reset");
        messageTo(self, "observe_loop", trial.getSessionDict(self, "reset"), 1.0f, false);
        return SCRIPT_CONTINUE;
    }
    public int observe_loop(obj_id self, dictionary params)
    {
    ...
    public int hate_link(obj_id self, dictionary params)
    {
