...
public class wampa_boss extends script.base_script
{
    ...
    public int handleUncleJoeDistanceCheck(obj_id self, dictionary params)
    {
    ...
    public int handleUncleJoePutsYouBackIntoCombat(obj_id self, dictionary params)
    {
    ...
    public int handleUncleJoeHateTesting(obj_id self, dictionary params)
    {
        reportHateListTesting(self, "handleUncleJoeHateTesting");
        messageTo(self, "handleUncleJoeHateTesting", null, 19, false);
        return SCRIPT_CONTINUE;
    }
    public void reportHateListTesting(obj_id self, String from)
    {
    ...
    public int summon_adds(obj_id self, dictionary params)
    {
        if (isDead(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int wampaBossLinkAgro(obj_id self, dictionary params)
    {
        if (isDead(self))
        {
            return SCRIPT_CONTINUE;
