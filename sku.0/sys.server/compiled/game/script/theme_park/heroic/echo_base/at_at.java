...
public class at_at extends script.base_script
{
    ...
    public int atatGeneratorShoot(obj_id self, dictionary params)
    {
    ...
    public int findVehicleTarget(obj_id self, dictionary params)
    {
        if (isInvulnerable(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int ATATforceCheck(obj_id self, dictionary params)
    {
        String atatNumber = "";
        int maxDeathCount = 5;
        int checkpoint = 0;
    ...
    public int ATATnumDeadIncrement(obj_id self, dictionary params)
    {
