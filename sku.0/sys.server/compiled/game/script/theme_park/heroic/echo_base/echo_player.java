...
public class echo_player extends script.base_script
{
    ...
    public int handleEchoPlayerInitialSetup(obj_id self, dictionary params)
    {
    ...
    public void checkForBattlefieldVehicleAllowedZones(obj_id self)
    {
    ...
    public int checkForActiveHothTrackerQuest(obj_id self, dictionary params)
    {
        location here = getLocation(self);
        if (here.area.equals("adventure2"))
        {
    ...
    public int checkForHothMusic(obj_id self, dictionary params)
    {
    ...
    public int update_quest(obj_id self, dictionary params)
    {
        if (utils.hasScriptVar(self, "echoBaseDeath"))
        {
            utils.removeScriptVar(self, "echoBaseDeath");
    ...
    public void clearCurrentEchoQuest(obj_id self)
    {
        for (int i = 0; i < QUEST_TO_CLEAR.length; ++i)
        {
            if (groundquests.isQuestActive(self, QUEST_TO_CLEAR[i]))
    ...
    public void grantPlanetHothBadge(obj_id player)
    {
    ...
    public int delayGrantPlanetHothBadge(obj_id self, dictionary params)
    {
    ...
    public int dismountHothPlayer(obj_id self, dictionary params)
    {
