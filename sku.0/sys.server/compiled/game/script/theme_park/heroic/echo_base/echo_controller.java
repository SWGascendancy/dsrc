...
public class echo_controller extends script.base_script
{
    ...
    public int updateCloneLocation(obj_id self, dictionary params)
    {
    ...
    public int createClientPath(obj_id self, dictionary params)
    {
    ...
    public int buff_atat(obj_id self, dictionary params)
    {
    ...
    public int p1_end(obj_id self, dictionary params)
    {
        utils.setScriptVar(self, "quest_tracker.p1_ended", 1);
        return SCRIPT_CONTINUE;
    }
    public int rebel_p1_update(obj_id self, dictionary params)
    {
    ...
    public int imperial_p1_update(obj_id self, dictionary params)
    {
        if (utils.hasScriptVar(self, "quest_tracker.p1_ended"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int p2_end(obj_id self, dictionary params)
    {
        utils.setScriptVar(self, "quest_tracker.p2_ended", 1);
        return SCRIPT_CONTINUE;
    }
    public int rebel_p2_update(obj_id self, dictionary params)
    {
    ...
    public int imperial_p2_update(obj_id self, dictionary params)
    {
        if (utils.hasScriptVar(self, "quest_tracker.p2_ended"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int rebel_p3_update(obj_id self, dictionary params)
    {
        String thisUpdate = params.getString("objective");
        utils.setScriptVar(self, "quest_tracker.rebel." + thisUpdate, 1);
        return SCRIPT_CONTINUE;
    }
    public int imperial_p3_update(obj_id self, dictionary params)
    {
        String thisUpdate = params.getString("objective");
        utils.setScriptVar(self, "quest_tracker.imperial." + thisUpdate, 1);
        return SCRIPT_CONTINUE;
    }
    public int wampa_boss_died(obj_id self, dictionary params)
    {
        utils.setScriptVar(self, "quest_tracker.wampa_boss_dead", 1);
        return SCRIPT_CONTINUE;
    }
    public int conclude_rebel_p3(obj_id self, dictionary params)
    {
    ...
    public int conclude_imperial_p3(obj_id self, dictionary params)
    {
    ...
    public void winSuiDisplay(obj_id[] players, String version)
    {
    ...
    public int ping(obj_id self, dictionary params)
    {
    ...
    public void resendPingToPlayer(obj_id player, String message)
    {
        dictionary dict = new dictionary();
        dict.put("message", message);
        messageTo(player, "instance_ping_response", dict, 0.0f, false);
    }
    public int getRebelTokenCountByVictory()
    {
        obj_id self = getSelf();
        int p1_eval = 0;
        int p2_eval = 0;
    ...
    public int getImperialTokenCountByVictory()
    {
        obj_id self = getSelf();
        int p1_eval = 0;
        int p2_eval = 0;
    ...
    public int grantP2Waypoint(obj_id self, dictionary params)
    {
    ...
    public int make_p3_end_wp(obj_id self, dictionary params)
    {
        location myLoc = getLocation(self);
        myLoc.x += -466;
        myLoc.y += 93;
    ...
    public int crateTaken(obj_id self, dictionary params)
    {
