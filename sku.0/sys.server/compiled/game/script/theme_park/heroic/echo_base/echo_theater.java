...
public class echo_theater extends script.base_script
{
    ...
    public int r1_st_death(obj_id self, dictionary params)
    {
    ...
    public int r2_st_death(obj_id self, dictionary params)
    {
    ...
    public int suicide(obj_id self, dictionary params)
    {
        kill(self);
        messageTo(self, "handleDelayedCleanup", null, 5.0f, false);
        return SCRIPT_CONTINUE;
    }
    public int r1_st_show(obj_id self, dictionary params)
    {
        obj_id[] cannon = trial.getObjectsInCellWithObjVar(trial.getTop(self), "r1", "cannon_1");
        obj_id[] players = trial.getPlayersInCell(trial.getTop(self), "r1");
        if (players == null || players.length == 0)
    ...
    public int r2_st_show(obj_id self, dictionary params)
    {
        obj_id[] cannon = trial.getObjectsInCellWithObjVar(trial.getTop(self), "r1", "cannon_2");
        obj_id[] players = trial.getPlayersInCell(trial.getTop(self), "r1");
        if (players == null || players.length == 0)
    ...
    public int kill_scott(obj_id self, dictionary params)
    {
    ...
    public int kill_downey(obj_id self, dictionary params)
    {
    ...
    public void setNpcPosture(obj_id npc)
    {
        String posture = "";
    ...
    public int startRunning(obj_id self, dictionary params)
    {
        float rate = 1.0f;
    ...
    public int startWalking(obj_id self, dictionary params)
    {
