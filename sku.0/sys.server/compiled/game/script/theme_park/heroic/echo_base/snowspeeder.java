...
public class snowspeeder extends script.base_script
{
    ...
    public int snowspeederHeight(obj_id self, dictionary params)
    {
        if (!exists(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public void destroySnowSpeeder(obj_id disabledSnowspeeder)
    {
    ...
    public int deleteDisabledSnowspeeder(obj_id self, dictionary params)
    {
        obj_id disabledHothSpeeder = params.getObjId("disabledHothSpeeder");
        destroyObject(disabledHothSpeeder);
        return SCRIPT_CONTINUE;
    }
    public void monitorAtatProgress(obj_id snowspeeder)
    {
