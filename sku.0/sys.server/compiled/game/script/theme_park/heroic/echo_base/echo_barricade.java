...
public class echo_barricade extends script.base_script
{
    ...
    public int handleHothRebelBarricade(obj_id self, dictionary params)
    {
    ...
    public int destroyHothBarricade(obj_id self, dictionary params)
    {
        trial.cleanupObject(self);
        return SCRIPT_CONTINUE;
    }
    public boolean isValidBarricadeLocation(obj_id self)
    {
    ...
    public int OnObjectMenuSelect(obj_id self, obj_id player, int menuItem)
    {
        if (!isValidBarricadeLocation(self))
        {
            messageTo(self, "destroyHothBarricade", null, 1.0f, false);
