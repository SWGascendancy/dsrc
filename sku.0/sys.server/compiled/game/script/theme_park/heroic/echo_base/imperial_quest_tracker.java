...
public class imperial_quest_tracker extends script.base_script
{
    ...
    public boolean hasCompletedPhaseOne()
    {
        if (getPhase() != 1)
        {
            return false;
    ...
    public boolean hasCompletedPhaseTwo()
    {
        if (getPhase() != 2)
        {
            return false;
    ...
    public boolean hasCompletedPhaseThree()
    {
        if (getPhase() != 3)
        {
            return false;
    ...
    public void handleCitizenDeath(obj_id self, obj_id[] players, boolean doBroadcast)
    {
