...
public class echo_quest_tracker extends script.base_script
{
    ...
    public void questReset(obj_id self)
    {
    ...
    public int questReset(obj_id self, dictionary params)
    {
        questReset(self);
        return SCRIPT_CONTINUE;
    }
    public void questRemoval(obj_id player)
    {
    ...
    public int questUpdate(obj_id self, dictionary params)
    {
    ...
    public int checkForFailedTask(obj_id self, dictionary params)
    {
    ...
    public void handleFailCase(obj_id self, obj_id[] players, String questName, String failTask)
    {
        setObjVar(self, failTask, 1);
        failEchoTask(players, questName, failTask, true);
        return;
    }
    public void failEchoTask(obj_id[] players, String questName, String failTask, boolean showMessage)
    {
        if (players != null && players.length > 0)
        {
    ...
    public void failEchoTask(obj_id player, String questName, String failTask, boolean showMessage)
    {
        obj_id self = getSelf();
    ...
    public void updatePlayerQuests(obj_id player)
    {
        obj_id self = getSelf();
        int isRebel = getIntObjVar(self, "isRebel");
        int phase = getPhase();
    ...
    public int phaseOneVoiceOvers(obj_id self, dictionary params)
    {
        obj_id[] players = utils.getPlayersInBuildoutRow(self);
        int isRebel = getIntObjVar(self, "isRebel");
        int deadAtats = getIntObjVar(self, P1_DEAD_AT);
    ...
    public int requestUpdatePlayer(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        updatePlayerQuests(player);
        return SCRIPT_CONTINUE;
    }
    public void handleGenericTaskCompletion(obj_id self, obj_id[] players, boolean doBroadcast, String task, String creatureName)
    {
