...
public class grenadier extends script.base_script
{
    ...
    public int doThrow(obj_id self, dictionary params)
    {
    ...
    public int grenadier_throw_random(obj_id self, obj_id target, String params, float defaultTime)
    {
        String[] abilityList = 
        {
            "grenadier_cold",
    ...
    public int resetHate(obj_id self, dictionary params)
    {
        if (isDead(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public float getThrowSpeed(obj_id self)
    {
        return getFloatObjVar(self, "throw_speed");
    }
    public void setThrowSpeed(obj_id self, float speed)
    {
        setObjVar(self, "throw_speed", speed);
    }
    public float hastenThrowSpeed(obj_id self, float delta)
    {
    ...
    public int hastenThrow(obj_id self, dictionary params)
    {
