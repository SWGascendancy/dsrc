...
public class krix extends script.base_script
{
    ...
    public obj_id[] getGuardsFromList(obj_id[] allSpawn)
    {
    ...
    public void startAttackCycle(obj_id self)
    {
    ...
    public int executeBurn(obj_id self, dictionary params)
    {
    ...
    public int executeFocus(obj_id self, dictionary params)
    {
        if (!trial.verifySession(self, params, "special") || isDead(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public void phaseTwo(obj_id self)
    {
    ...
    public String getBurnLocation(obj_id self)
    {
    ...
    public int megaBurn(obj_id self, dictionary params)
    {
        if (!trial.verifySession(self, params, "special") || isDead(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int getHealthTrigger(obj_id self, float ratio)
    {
    ...
    public void validateCombat(obj_id self)
    {
        obj_id[] players = trial.getValidTargetsInCell(trial.getTop(self), "secondaryhangar");
        if (players == null || players.length == 0)
        {
