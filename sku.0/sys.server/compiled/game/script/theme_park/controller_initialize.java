...
public class controller_initialize extends script.base_script
{
    ...
    public int createController(obj_id self, dictionary params)
    {
        createController(self);
        return SCRIPT_CONTINUE;
    }
    public void createController(obj_id self)
    {
    ...
    public void setScriptString(obj_id subject, String scriptString)
    {
    ...
    public void setObjVarString(obj_id newObject, String objVarString)
    {
