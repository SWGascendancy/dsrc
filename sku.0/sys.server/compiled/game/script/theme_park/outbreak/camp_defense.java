...
public class camp_defense extends script.base_script
{
    ...
    public int updatePlayerDefense(obj_id self, dictionary params)
    {
    ...
    public int failPlayerDefense(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
    ...
    public int triggerVolFailsafe(obj_id self, dictionary params)
    {
    ...
    public int findPathNodes(obj_id self, dictionary params)
    {
        if (!hasObjVar(self, "questObject"))
        {
