...
public class beast_pathing extends script.base_script
{
    ...
    public int blowUp(obj_id self, dictionary params)
    {
    ...
    public int startBeastDeliveryPathing(obj_id self, dictionary params)
    {
        if (!isValidId(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int cleanUpDeliveryBeast(obj_id self, dictionary params)
    {
    ...
    public boolean failBeastDeliveryQuest(obj_id self)
    {
        if (!hasObjVar(self, "owner"))
        {
            return false;
    ...
    public boolean spawnUndead(obj_id self, location wayptLoc)
    {
    ...
    public int getLocationPosition(location[] list, location key)
    {
