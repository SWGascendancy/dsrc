...
public class survivor_pathing extends script.base_script
{
    ...
    public int startSurvivorPathing(obj_id self, dictionary params)
    {
    ...
    public int creditPlayerRescue(obj_id self, dictionary params)
    {
    ...
    public int cleanUpNpcTimer(obj_id self, dictionary params)
    {
    ...
    public boolean playerFailedQuest(obj_id self)
    {
        obj_id player = getObjIdObjVar(self, "myEscort");
        if (!isValidId(player))
        {
    ...
    public boolean playerSuccessQuest(obj_id self)
    {
