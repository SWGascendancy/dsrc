...
public class boss_fight_functionality extends script.base_script
{
    ...
    public boolean moveCreatureToWaypoint(obj_id creature)
    {
    ...
    public int warnPlayerTimerBegin(obj_id self, dictionary params)
    {
        if (!isValidId(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int warnPlayerTimerEnd(obj_id self, dictionary params)
    {
        if (!isValidId(self))
        {
            return SCRIPT_CONTINUE;
