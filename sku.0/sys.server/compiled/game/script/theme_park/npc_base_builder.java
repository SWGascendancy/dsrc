...
public class npc_base_builder extends script.base_script
{
    ...
    public int initializePhase(obj_id self, dictionary params)
    {
    ...
    public void cleanupChildren(obj_id self)
    {
    ...
    public void doSpawning(obj_id self, String dataTable, int phase)
    {
        doSpawning(self, dataTable, phase, -1);
    }
    public void doSpawning(obj_id self, String dataTable, int phase, int lineNumber)
    {
    ...
    public int handleEntityRespawn(obj_id self, dictionary params)
    {
        if (!trial.verifySession(self, params))
        {
            return SCRIPT_CONTINUE;
    ...
    public boolean validatePhase(int phase, String spawnPhase)
    {
    ...
    public void attachSpawnScript(obj_id newObject, String scriptString, String respawn)
    {
        if (!respawn.equals("-1"))
        {
    ...
    public int incrimentPhase(obj_id self, dictionary params)
    {
        incrimentPhase(self);
        return SCRIPT_CONTINUE;
    }
    public void incrimentPhase(obj_id self)
    {
    ...
    public boolean canIncrimentPhase(obj_id self)
    {
        int phase = 0;
        if (hasObjVar(self, CURRENT_PHASE))
        {
    ...
    public int decrimentPhase(obj_id self, dictionary params)
    {
        decrimentPhase(self);
        return SCRIPT_CONTINUE;
    }
    public void decrimentPhase(obj_id self)
    {
    ...
    public int getCurrentPhase(obj_id self)
    {
        if (!hasObjVar(self, CURRENT_PHASE))
        {
