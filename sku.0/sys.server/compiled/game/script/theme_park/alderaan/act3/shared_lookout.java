...
public class shared_lookout extends script.base_script
{
    ...
    public int handleStartCaravanMission(obj_id self, dictionary params)
    {
    ...
    public int handleAbortCaravanMission(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        messageTo(player, "handleAbortMission", params, 0, false);
        return SCRIPT_CONTINUE;
    }
    public int handleAttackPlayer(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
    ...
    public void giveRepairKit(obj_id player)
    {
