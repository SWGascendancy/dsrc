...
public class imperial_mission extends script.base_script
{
    ...
    public location getDeliveryLoc(obj_id player, int minDistance, int maxDistance)
    {
    ...
    public int handleRestartMission(obj_id self, dictionary params)
    {
        setObjVar(self, "coa3.imperial.success", 1);
        removeMissionWaypoint(self);
        startImperialMission(self);
    ...
    public int handleAbortMission(obj_id self, dictionary params)
    {
    ...
    public int createReturnMission(obj_id self, dictionary params)
    {
    ...
    public void startImperialMission(obj_id player)
    {
    ...
    public void abortImperialMission(obj_id player, int mission, boolean returnHome)
    {
    ...
    public void revertMissionProgress(obj_id player, int mission)
    {
        switch (mission)
        {
            case 1:
    ...
    public obj_id createMissionWaypoint(obj_id player, location loc, float radius, String waypointName, String volumeName)
    {
    ...
    public void removeMissionWaypoint(obj_id player)
    {
    ...
    public int OnWaypointGetAttributes(obj_id self, obj_id waypoint, obj_id player, String[] names, String[] attribs)
    {
    ...
    public int handleFloraCheck(obj_id self, dictionary params)
    {
