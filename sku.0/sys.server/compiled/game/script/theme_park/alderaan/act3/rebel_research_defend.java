...
public class rebel_research_defend extends script.base_script
{
    ...
    public int spawnNextObject(obj_id self, dictionary params)
    {
    ...
    public int guardKilled(obj_id self, dictionary params)
    {
    ...
    public void explodeFacility(obj_id self, obj_id player)
    {
    ...
    public int assaultWave(obj_id self, dictionary params)
    {
    ...
    public int attackerKilled(obj_id self, dictionary params)
    {
    ...
    public void spawnNewWave(obj_id self, Vector enemyList, int waveNum)
    {
        int enemyWeakCount[] = 
        {
            3,
    ...
    public location getSpawnLoc(obj_id self)
    {
