...
public class axkva_nightsister_shards extends script.base_script
{
    ...
    public int getQuestPlayerName(obj_id self, dictionary params)
    {
    ...
    public int checkForActiveShardTasks(obj_id self, dictionary params)
    {
    ...
    public int shardCleanup(obj_id self, dictionary params)
    {
        if (params != null)
        {
    ...
    public int handleEndShardQuest(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        if (isIdValid(player))
        {
