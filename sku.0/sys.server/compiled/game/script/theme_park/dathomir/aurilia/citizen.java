...
public class citizen extends script.base_script
{
    ...
    public int initializeSocialVolume(obj_id self, dictionary params)
    {
    ...
    public void npcUtterance(obj_id npc, obj_id player)
    {
    ...
    public String chooseHeroicString(obj_id player)
    {
        String heroicChoice = "";
    ...
    public String getGenderString(obj_id player)
    {
