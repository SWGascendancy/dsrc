...
public class dantooine_rebel_base_spawner extends script.base_script
{
    ...
    public void spawnLieutenant(obj_id self)
    {
    ...
    public void spawnAckbar(obj_id self)
    {
    ...
    public void spawnMothma(obj_id self)
    {
    ...
    public void spawnGeneral(obj_id self)
    {
        obj_id room = getCellId(self, "hall2");
    ...
    public void spawnCaptain(obj_id self)
    {
        obj_id room = getCellId(self, "hall2");
