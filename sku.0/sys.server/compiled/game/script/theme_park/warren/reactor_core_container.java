...
public class reactor_core_container extends script.base_script
{
    ...
    public void checkForReactorShutDown(obj_id self)
    {
    ...
    public void checkForReactorShutDown(obj_id self, obj_id player)
    {
        obj_id bldg = getTopMostContainer(self);
    ...
    public void shutDownCore(obj_id self, obj_id bldg)
    {
    ...
    public int handleReactivateCore(obj_id self, dictionary params)
    {
        obj_id bldg = getTopMostContainer(self);
        if (!isIdValid(bldg))
        {
    ...
    public int OnOpenedContainer(obj_id self, obj_id player)
    {
        location here = getLocation(player);
        location term = getLocation(self);
        float range = getDistance(here, term);
    ...
    public void moveCoreRodFromPlayerToContainer(obj_id coreRod, obj_id container)
    {
