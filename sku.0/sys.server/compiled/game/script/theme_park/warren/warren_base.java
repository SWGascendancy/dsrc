...
public class warren_base extends script.base_script
{
    ...
    public int handleDelayedSetup(obj_id self, dictionary params)
    {
    ...
    public void spawnTurret(obj_id bldg)
    {
    ...
    public void intializeWarren(obj_id bldg, obj_id god)
    {
    ...
    public void resetTurretCodeSequence(obj_id bldg)
    {
    ...
    public void spawnEscapee(obj_id bldg)
    {
    ...
    public void spawnCellGuard(obj_id bldg)
    {
    ...
    public int handleCellGuardDied(obj_id self, dictionary params)
    {
        spawnCellGuard(self);
        return SCRIPT_CONTINUE;
    }
    public void spawnKnag(obj_id bldg)
    {
        location spawnLoc = getLocation(bldg);
        spawnLoc.x = 77.47f;
        spawnLoc.y = -68.0f;
    ...
    public int handleKnagDied(obj_id self, dictionary params)
    {
        spawnKnag(self);
        return SCRIPT_CONTINUE;
    }
    public void spawnMirla(obj_id bldg)
    {
        location spawnLoc = getLocation(bldg);
        spawnLoc.x = -58.56f;
        spawnLoc.y = -76f;
    ...
    public int handleMirlaDied(obj_id self, dictionary params)
    {
        spawnMirla(self);
        return SCRIPT_CONTINUE;
    }
    public void spawnEscapedWorker(obj_id bldg)
    {
        location spawnLoc = getLocation(bldg);
        spawnLoc.x = -7.47f;
        spawnLoc.y = -20.0f;
    ...
    public void spawnCloneRelicsBox(obj_id self)
    {
    ...
    public void spawnElevator(obj_id bldg)
    {
    ...
    public void spawnDyingLoyalist(obj_id bldg)
    {
        location spawnLoc = getLocation(bldg);
        spawnLoc.x = -57.54f;
        spawnLoc.y = -28.0f;
    ...
    public void spawnPanickedResearcher(obj_id bldg)
    {
        location spawnLoc = getLocation(bldg);
        spawnLoc.x = 29.68f;
        spawnLoc.y = -54.0f;
    ...
    public int handleLoyalistDied(obj_id self, dictionary params)
    {
        spawnDyingLoyalist(self);
        return SCRIPT_CONTINUE;
    }
    public int handleEscapeeDied(obj_id self, dictionary params)
    {
        spawnEscapee(self);
        return SCRIPT_CONTINUE;
    }
    public int handleEscapedWorkerDied(obj_id self, dictionary params)
    {
        spawnEscapedWorker(self);
        return SCRIPT_CONTINUE;
    }
    public int handleResearcherDied(obj_id self, dictionary params)
    {
        spawnPanickedResearcher(self);
        return SCRIPT_CONTINUE;
    }
    public void spawnDebris(obj_id bldg)
    {
    ...
    public int handleRespawnDebris(obj_id self, dictionary params)
    {
    ...
    public void addAllowed(obj_id bldg, obj_id player)
    {
    ...
    public void removeAllAllowed(obj_id bldg)
    {
        removeObjVar(bldg, "allowedList");
        resetTurretCodeSequence(bldg);
    }
    public boolean isAllowed(obj_id bldg, obj_id player)
    {
    ...
    public void lockReactorCoreRoom(obj_id bldg)
    {
    ...
    public void lockCell(obj_id bldg)
    {
    ...
    public void attachCommandWarning(obj_id bldg)
    {
    ...
    public int handlePlayerLogin(obj_id self, dictionary params)
    {
