...
public class gcw_spawner extends script.base_script
{
    ...
    public int OnHearSpeech(obj_id self, obj_id speaker, String strText)
    {
    ...
    public int beginSetup(obj_id self, dictionary params)
    {
    ...
    public boolean setTable(obj_id self, int intDtbRowNum, String dtbMasterList)
    {
    ...
    public obj_id spawnActor(String datatable, int x, boolean hard)
    {
        obj_id self = getSelf();
    ...
    public dictionary getSpawnFactionData(obj_id self)
    {
    ...
    public int destroyChildren(obj_id self, dictionary params)
    {
        obj_id[] spawned = utils.getObjIdArrayScriptVar(self, "spawnList");
        if (spawned == null || spawned.length <= 0)
        {
