...
public class combat_explainer extends script.theme_park.newbie_tutorial.tutorial_base
{
    ...
    public int handlePlayerArrival(obj_id self, dictionary params)
    {
    ...
    public int handleGreetPlayer(obj_id self, dictionary params)
    {
        obj_id player = getPlayer(self);
    ...
    public void giveWeapon(obj_id npc, obj_id player)
    {
    ...
    public int handleGiveWeapon(obj_id self, dictionary params)
    {
