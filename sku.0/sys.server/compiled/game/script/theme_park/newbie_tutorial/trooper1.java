...
public class trooper1 extends script.theme_park.newbie_tutorial.tutorial_base
{
    ...
    public int equipWeapon(obj_id self, dictionary params)
    {
        aiEquipPrimaryWeapon(self);
        return SCRIPT_CONTINUE;
    }
    ...
    public void paceInRoom(obj_id trooper, int destination)
    {
    ...
    public int handleNextPacingEvent(obj_id self, dictionary params)
    {
