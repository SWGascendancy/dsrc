...
public class pirate extends script.theme_park.newbie_tutorial.tutorial_base
{
    ...
    public int handlePlayerInRoom(obj_id self, dictionary params)
    {
    ...
    public int handleTauntTwo(obj_id self, dictionary params)
    {
        if (ai_lib.isAiDead(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleTauntThree(obj_id self, dictionary params)
    {
        if (ai_lib.isAiDead(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleTauntFour(obj_id self, dictionary params)
    {
        if (ai_lib.isAiDead(self))
        {
            return SCRIPT_CONTINUE;
