...
public class box_item extends script.theme_park.newbie_tutorial.tutorial_base
{
    ...
    public int OnTransferred(obj_id self, obj_id sourceContainer, obj_id destContainer, obj_id player)
    {
        if (!hasObjVar(player, "newbie"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int OnAboutToBeTransferred(obj_id self, obj_id destContainer, obj_id player)
    {
        if (!hasObjVar(player, "newbie"))
        {
            return SCRIPT_CONTINUE;
