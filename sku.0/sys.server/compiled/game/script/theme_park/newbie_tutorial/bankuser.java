...
public class bankuser extends script.theme_park.newbie_tutorial.tutorial_base
{
    ...
    public int handleUseBank(obj_id self, dictionary params)
    {
    ...
    public int handleStormtrooper(obj_id self, dictionary params)
    {
    ...
    public int handleDenial(obj_id self, dictionary params)
    {
