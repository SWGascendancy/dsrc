...
public class newbie extends script.theme_park.newbie_tutorial.tutorial_base
{
    ...
    public void beginTutorial(obj_id self)
    {
        obj_id bldg = getTopMostContainer(self);
    ...
    public int handleWelcome(obj_id self, dictionary params)
    {
        obj_id bldg = getTopMostContainer(self);
    ...
    public int handleMoveKeys(obj_id self, dictionary params)
    {
        if (!isInRoom(self, "r1"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleMoveMouse(obj_id self, dictionary params)
    {
        if (!isInRoom(self, "r1"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleMouseWheel(obj_id self, dictionary params)
    {
        if (!isInRoom(self, "r1"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleNoMouseWheelOrKeypad(obj_id self, dictionary params)
    {
        if (!isInRoom(self, "r1"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handlePromptForCameraZoom(obj_id self, dictionary params)
    {
        if (!isInRoom(self, "r1"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleChatWindow(obj_id self, dictionary params)
    {
        if (!isInRoom(self, "r1"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleRepeatChatPrompt(obj_id self, dictionary params)
    {
        if (!isInRoom(self, "r1"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleOpencharacterSheetWindow(obj_id self, dictionary params)
    {
        if (!isInRoom(self, "r1"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleRepeatOpencharacterSheet(obj_id self, dictionary params)
    {
        if (!isInRoom(self, "r1"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleRepeatClosecharacterSheet(obj_id self, dictionary params)
    {
        if (!isInRoom(self, "r1"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleStatusScreenInfo(obj_id self, dictionary params)
    {
        if (!isInRoom(self, "r1"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleMoveToItemRoomPrompt(obj_id self, dictionary params)
    {
        if (!isInRoom(self, "r1"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleRepeatItemRoomPrompt(obj_id self, dictionary params)
    {
        if (!isInRoom(self, "r1"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleExplainFreemouse(obj_id self, dictionary params)
    {
        if (!isInRoom(self, "r2"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleExplainInventory(obj_id self, dictionary params)
    {
        if (!isInRoom(self, "r2"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleOpenInventory(obj_id self, dictionary params)
    {
        if (!utils.hasScriptVar(self, "newbie.waitingForInventoryOpen"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleToolbarPrompt(obj_id self, dictionary params)
    {
        if (!isInRoom(self, "r2"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleReadyItemPrompt(obj_id self, dictionary params)
    {
        if (!isInRoom(self, "r2"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleUseToolbarPrompt(obj_id self, dictionary params)
    {
        if (!isInRoom(self, "r2"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handlePromptToCloseInventory(obj_id self, dictionary params)
    {
        if (!isInRoom(self, "r2"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleInventoryAlreadyClosed(obj_id self, dictionary params)
    {
        if (utils.hasScriptVar(self, "newbie.waitingForInventoryClose"))
        {
            utils.removeScriptVar(self, "newbie.waitingForInventoryClose");
    ...
    public int handlePromptToCommerceRoom(obj_id self, dictionary params)
    {
        if (!isInRoom(self, "r2"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleRepeatPromptToCommerceRoom(obj_id self, dictionary params)
    {
        if (!isInRoom(self, "r2"))
        {
            return SCRIPT_CONTINUE;
    ...
    public void initiateCommerceRoom(obj_id player)
    {
    ...
    public int handleBankAndBazaarFlyText(obj_id self, dictionary params)
    {
        if (isInRoom(self, "r3"))
        {
    ...
    public int handleBankInfoSpam(obj_id self, dictionary params)
    {
    ...
    public int handleBazaarInfoSpam(obj_id self, dictionary params)
    {
    ...
    public int handleCloneAndInsureFlyText(obj_id self, dictionary params)
    {
        if (isInRoom(self, "r5"))
        {
            obj_id bldg = getBuilding(self);
    ...
    public int handlePromptToInsure(obj_id self, dictionary params)
    {
    ...
    public int handleCloneInfoSpam(obj_id self, dictionary params)
    {
    ...
    public int handleInsuranceInfoSpam(obj_id self, dictionary params)
    {
        removeStaticWaypoint(self);
    ...
    public void doRoomSixPrompt(obj_id player)
    {
    ...
    public int handleSeeWhatIsGoingOn(obj_id self, dictionary params)
    {
        return SCRIPT_CONTINUE;
    }
    public void initiatePromptForCombat(obj_id player)
    {
    ...
    public int handleExplainCombatToolbar(obj_id self, dictionary params)
    {
        return SCRIPT_CONTINUE;
    }
    public void handlePromptToNextRoom(obj_id self)
    {
        if (!hasObjVar(self, "newbie.killedPirate"))
        {
    ...
    public int handleRadar(obj_id self, dictionary params)
    {
        if (!isInRoom(self, "r8"))
        {
    ...
    public int handleRadarMore(obj_id self, dictionary params)
    {
        if (isInRoom(self, "r8"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleZoomMap(obj_id self, dictionary params)
    {
        if (isInRoom(self, "r8"))
        {
            return SCRIPT_CONTINUE;
    ...
    public void initiatePirateAttack(obj_id player, obj_id bldg)
    {
    ...
    public int handleAttackingDescription(obj_id self, dictionary params)
    {
        return SCRIPT_CONTINUE;
    }
    public int handleCongrats(obj_id self, dictionary params)
    {
        return SCRIPT_CONTINUE;
    }
    public void initiateTrainerExplanation(obj_id player)
    {
        obj_id bldg = getTopMostContainer(player);
    ...
    public int handleShowCharSheet(obj_id self, dictionary params)
    {
        messageTo(self, "handlePromptToMissionRoom", null, VERY_LONG_DELAY, false);
        return SCRIPT_CONTINUE;
    }
    public int handlePromptToMissionRoom(obj_id self, dictionary params)
    {
        return SCRIPT_CONTINUE;
    }
    public int handleTrainerDoneTalking(obj_id self, dictionary params)
    {
        utils.removeScriptVar(self, "newbie.trainerIsTalking");
        return SCRIPT_CONTINUE;
    }
    public void initiateMissionExplanation(obj_id player)
    {
    ...
    public int handleMissionExplaination(obj_id self, dictionary params)
    {
        if (!isInRoom(self, "r10"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleExplainNpcMissions(obj_id self, dictionary params)
    {
        if (!isInRoom(self, "r10"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleGetTravelWaypoint(obj_id self, dictionary params)
    {
        if (hasObjVar(self, "newbie.hasReleaseDocuments"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleExplainWaypoint(obj_id self, dictionary params)
    {
        return SCRIPT_CONTINUE;
    }
    public void initiateTravelExplanation(obj_id player)
    {
    ...
    public int handleStartOath(obj_id self, dictionary params)
    {
        utils.setScriptVar(self, "newbie.takingOath", true);
        messageTo(self, "handlePromptForPromise", null, SHORT_DELAY, false);
        return SCRIPT_CONTINUE;
    }
    public int handlePromptForPromise(obj_id self, dictionary params)
    {
    ...
    public int handleRePromptForPromise(obj_id self, dictionary params)
    {
        if (!isInRoom(self, "r11"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int xferFailed(obj_id self, dictionary params)
    {
        grantNewbieStartingMoney(self);
        return SCRIPT_CONTINUE;
    }
    public int timeToWithdraw(obj_id self, dictionary params)
    {
    ...
    public int cashReceived(obj_id self, dictionary params)
    {
        return SCRIPT_CONTINUE;
    }
    public int handleEndTutorial(obj_id self, dictionary params)
    {
    ...
    public int newbieRequestStartingLocations(obj_id self, obj_id target, String params, float defaultTime)
    {
        newbieTutorialSendStartingLocationsToPlayer(self, null);
        return SCRIPT_CONTINUE;
    }
    public int newbieSelectStartingLocation(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int moveOnToNextRoom(obj_id self, dictionary params)
    {
        return SCRIPT_CONTINUE;
    }
}
