...
public class tutorial_base extends script.base_script
{
    ...
    public void sysMessageToPlayer(obj_id box, String text)
    {
    }
    public obj_id getPlayer(obj_id box)
    {
    ...
    public void sysMessage(obj_id player, String text)
    {
    }
    public void flyText(obj_id item, String text, float size, color flyTextColor)
    {
        showFlyText(item, new string_id(NEWBIE_STRING_FILE, text), size, flyTextColor);
    }
    public obj_id getBuilding(obj_id item)
    {
        return getTopMostContainer(item);
    }
    public boolean isInRoom(obj_id player, String roomName)
    {
    ...
    public void flagRoomComplete(obj_id player, String roomName)
    {
        utils.setScriptVar(player, "newbie.roomComplete." + roomName, true);
    }
    public boolean hasCompletedRoom(obj_id player, String roomName)
    {
        return (utils.hasScriptVar(player, "newbie.roomComplete." + roomName));
    }
    public boolean detachNewbieTutorialScript(obj_id player)
    {
    ...
    public String getProfessionName(obj_id player)
    {
    ...
    public String getTrainerType(obj_id player)
    {
    ...
    public void fillbank(obj_id player)
    {
    ...
    public void transferBankToInventory(obj_id player)
    {
    ...
    public void grantNewbieStartingMoney(obj_id player)
    {
    ...
    public void sendStartingMessage(obj_id player)
    {
    ...
    public void sendStartingMessageToPlayer(obj_id player)
    {
    ...
    public void deleteInventory(obj_id player)
    {
    ...
    public void makeStaticWaypoint(obj_id object)
    {
        if (!isIdValid(object))
        {
            return;
    ...
    public void removeStaticWaypoint(obj_id object)
    {
        if (!isIdValid(object))
        {
            return;
    ...
    public void givePlayerSpaceTrainerWaypoints(obj_id player)
    {
    ...
    public void sendToStartLocation(obj_id self, String name)
    {
    ...
    public void sendThoseStartLocs(obj_id player)
    {
    ...
    public void grantAllNoviceSkills(obj_id player)
    {
