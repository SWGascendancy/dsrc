...
public class panic_guy extends script.theme_park.newbie_tutorial.tutorial_base
{
    ...
    public int initiatePanic(obj_id self, dictionary params)
    {
    ...
    public int handleNextYell(obj_id self, dictionary params)
    {
        setMovementRun(self);
    ...
    public int handleWarnTroopers(obj_id self, dictionary params)
    {
