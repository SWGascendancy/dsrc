...
public class greeter_one extends script.theme_park.newbie_tutorial.tutorial_base
{
    ...
    public int handleNewArrival(obj_id self, dictionary params)
    {
    ...
    public int handleOne(obj_id self, dictionary params)
    {
    ...
    public int handleTwo(obj_id self, dictionary params)
    {
        faceToBehavior(self, getPlayer(self));
    ...
    public int handleThree(obj_id self, dictionary params)
    {
        faceToBehavior(self, getPlayer(self));
    ...
    public int handlePathToNextRoom(obj_id self, dictionary params)
    {
    ...
    public int handlePathHome(obj_id self, dictionary params)
    {
