...
public class jtl_newbie extends script.theme_park.newbie_tutorial.tutorial_base
{
    ...
    public void sendJtLemails(obj_id self)
    {
    ...
    public int sendNewbieMails(obj_id self, dictionary params)
    {
    ...
    public boolean isInTutorial(obj_id self)
    {
    ...
    public int handleDetachJtlNewbie(obj_id self, dictionary params)
    {
        setObjVar(self, "jtlNewbie", 4);
        detachScript(self, "theme_park.newbie_tutorial.jtl_newbie");
        return SCRIPT_CONTINUE;
