...
public class trooper4 extends script.theme_park.newbie_tutorial.tutorial_base
{
    ...
    public int setMeUp(obj_id self, dictionary params)
    {
    ...
    public int handleWaveOn(obj_id self, dictionary params)
    {
    ...
    public int handleResumeGuarding(obj_id self, dictionary params)
    {
        obj_id[] refugees = getObjIdArrayObjVar(self, "newbie.refugees");
        faceToBehavior(self, refugees[0]);
        return SCRIPT_CONTINUE;
    }
    public void makeRefugees(obj_id trooper)
    {
    ...
    public int makeWithTheTalking(obj_id self, dictionary params)
    {
