...
public class box_of_stuff extends script.theme_park.newbie_tutorial.tutorial_base
{
    ...
    public int handlePromptToOpen(obj_id self, dictionary params)
    {
    ...
    public int handleRepeatBoxOpenPrompt(obj_id self, dictionary params)
    {
        obj_id player = getPlayer(self);
    ...
    public int handleOpenMeFlyText(obj_id self, dictionary params)
    {
    ...
    public int handleExplainTakeItem(obj_id self, dictionary params)
    {
        obj_id player = getPlayer(self);
