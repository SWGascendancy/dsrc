...
public class banker extends script.theme_park.newbie_tutorial.tutorial_base
{
    ...
    public int handleInitiateConvo(obj_id self, dictionary params)
    {
    ...
    public int explainConvoAgain(obj_id self, dictionary params)
    {
    ...
    public int handleInitiateClonePrompt(obj_id self, dictionary params)
    {
    ...
    public int handleCorrectFacing(obj_id self, dictionary params)
    {
        if (!isInRoom(getPlayer(self), "r5"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleExplainTerminalOne(obj_id self, dictionary params)
    {
        if (!isInRoom(getPlayer(self), "r5"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleExplainTerminalTwo(obj_id self, dictionary params)
    {
        if (!isInRoom(getPlayer(self), "r5"))
        {
            return SCRIPT_CONTINUE;
