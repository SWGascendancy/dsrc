...
public class newbie_hall extends script.theme_park.newbie_tutorial.tutorial_base
{
    ...
    public int handleHallSetup(obj_id self, dictionary params)
    {
    ...
    public void spawnGreeters(obj_id bldg)
    {
    ...
    public void spawnRoomTwoCrate(obj_id bldg)
    {
    ...
    public void spawnBazaarTerminal(obj_id bldg)
    {
    ...
    public void spawnBankTerminal(obj_id bldg)
    {
    ...
    public void spawnBanker(obj_id bldg)
    {
    ...
    public void spawnTroopers(obj_id bldg)
    {
    ...
    public void spawnCommoners(obj_id bldg)
    {
    ...
    public void spawnCloneTerminal(obj_id bldg)
    {
    ...
    public void spawnInsuranceTerminal(obj_id bldg)
    {
    ...
    public void spawnInsuranceUser(obj_id bldg)
    {
    ...
    public void spawnCloneNpc(obj_id bldg)
    {
    ...
    public void spawnMouseDroid(obj_id bldg)
    {
    ...
    public void spawnCombatExplainer(obj_id bldg)
    {
    ...
    public void spawnPanicGuy(obj_id bldg)
    {
        obj_id player = getPlayer(bldg);
        if (hasObjVar(player, "newbie.killedPirate"))
        {
    ...
    public void spawnPirate(obj_id bldg)
    {
        obj_id player = getPlayer(bldg);
        if (hasObjVar(player, "newbie.killedPirate"))
        {
    ...
    public void spawnMissionTerminal(obj_id bldg)
    {
    ...
    public void spawnMissionNpc(obj_id bldg)
    {
        return;
    }
    public void spawnTravelTerminal(obj_id bldg)
    {
    ...
    public void spawnTravelNpc(obj_id bldg)
    {
    ...
    public void spawnPilotNpc(obj_id bldg)
    {
