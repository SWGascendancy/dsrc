...
public class patrol_controller extends script.base_script {
    ...
    public int spawnGuardPatrol(obj_id self, dictionary params){
    ...
    private void spawnPatrolMember(obj_id self, int currentSize, location spawnStart){
        obj_id patrolMember;
    ...
    private boolean needsLeader(obj_id self) {
    ...
    public void patrolMemberDied(obj_id self, dictionary params){
    ...
    private void tellSquadAboutNewLeader(){
        for(int i = 1; i < formationSlots.length; i++){
