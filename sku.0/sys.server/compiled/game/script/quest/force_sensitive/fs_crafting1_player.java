...
public class fs_crafting1_player extends script.base_script
{
    ...
    public int msgQuestAbortPhaseChange(obj_id self, dictionary params)
    {
    ...
    public int handleAccessTerminal(obj_id self, dictionary params)
    {
        if (utils.hasScriptVar(self, SUI_OBJVAR + ".pid"))
        {
    ...
    public int handleAccessTerminalCallback(obj_id self, dictionary params)
    {
        utils.removeScriptVar(self, SUI_OBJVAR + ".pid");
    ...
    public int handleUseAnalyzer(obj_id self, dictionary params)
    {
        if (utils.hasScriptVar(self, SUI_OBJVAR + ".pid"))
        {
            sendSystemMessage(self, MSG_CANT_OPEN_SUI);
    ...
    public int handleUseAnalyzerCallback(obj_id self, dictionary params)
    {
        utils.removeScriptVar(self, SUI_OBJVAR + ".pid");
        int btn = sui.getIntButtonPressed(params);
        int idx = sui.getListboxSelectedRow(params);
    ...
    public int handleAnalyzeCompCallback(obj_id self, dictionary params)
    {
        utils.removeScriptVar(self, SUI_OBJVAR + ".pid");
    ...
    public int handleAccessSchematicCallback(obj_id self, dictionary params)
    {
        utils.removeScriptVar(self, SUI_OBJVAR + ".pid");
        String[] data = utils.getStringArrayScriptVar(self, DATA_OBJVAR);
        if (data == null || data.length == 0)
    ...
    public int handleUseCalibrator(obj_id self, dictionary params)
    {
        if (utils.hasScriptVar(self, SUI_OBJVAR + ".pid"))
        {
            sendSystemMessage(self, MSG_CANT_OPEN_SUI);
    ...
    public int handleUseCalibratorCallback(obj_id self, dictionary params)
    {
        utils.removeScriptVar(self, SUI_OBJVAR + ".pid");
        obj_id calibrator = obj_id.NULL_ID;
        if (utils.hasScriptVar(self, CALIBRATOR_OBJVAR))
    ...
    public int configProcessorPuzzleCallback(obj_id self, dictionary params)
    {
    ...
    public int gyroReceiverPuzzleCallback(obj_id self, dictionary params)
    {
        String widgetName = params.getString("eventWidgetName");
        int pid = utils.getIntScriptVar(self, SUI_OBJVAR + ".pid");
    ...
    public int signalAmpPuzzleCallback(obj_id self, dictionary params)
    {
        String widgetName = params.getString("eventWidgetName");
        int pid = utils.getIntScriptVar(self, SUI_OBJVAR + ".pid");
    ...
    public int solidStateArrayPuzzleCallback(obj_id self, dictionary params)
    {
        String widgetName = params.getString("eventWidgetName");
    ...
    public void refreshTerminalSUI(obj_id self)
    {
        messageTo(self, "handleAccessTerminal", null, 0.0f, false);
    }
    public void retrieveComponent(obj_id self, int row)
    {
    ...
    public void replaceComponent(obj_id self, int row)
    {
        if (row >= COMPONENTS.length)
        {
            return;
    ...
    public void analyzeComponent(obj_id self, boolean callback)
    {
        if (utils.hasScriptVar(self, SUI_OBJVAR + ".pid"))
        {
            sendSystemMessage(self, MSG_CANT_OPEN_SUI);
    ...
    public void accessSchematic(obj_id self, boolean callback)
    {
        if (utils.hasScriptVar(self, SUI_OBJVAR + ".pid"))
        {
            sendSystemMessage(self, MSG_CANT_OPEN_SUI);
    ...
    public void configProcessorPuzzle(obj_id self, obj_id calibrator)
    {
    ...
    public int[] toggleButton(int[] config, int button)
    {
        int secondary1 = -1;
        int secondary2 = -1;
        switch (button)
    ...
    public void gyroReceiverPuzzle(obj_id self, obj_id calibrator)
    {
    ...
    public void signalAmpPuzzle(obj_id self, obj_id calibrator)
    {
    ...
    public void solidStateArrayPuzzle(obj_id self, obj_id calibrator)
    {
