...
public class fs_craft_village_defenses extends script.base_script
{
    ...
    public int handleRetryGetVillagePhase(obj_id self, dictionary params)
    {
        requestVillagePhase(self);
        return SCRIPT_CONTINUE;
    }
    ...
    public int handleGetVillagePhase(obj_id self, dictionary params)
    {
        boolean rslt = false;
        String key = "";
        if (params.containsKey("key"))
    ...
    public void requestVillagePhase(obj_id self)
    {
    ...
    public void checkVillagePhase(obj_id self)
    {
    ...
    public void testAbortQuest(obj_id self)
    {
        int questIdMain = quests.getQuestId(QUEST_MAIN);
        int questId01 = quests.getQuestId(QUEST_STEP_01);
        int questId02 = quests.getQuestId(QUEST_STEP_02);
    ...
    public int handleVerifyQuestStatus(obj_id self, dictionary params)
    {
