...
public class fs_xp_convert extends script.base_script
{
    ...
    public int msgFSXPConvertSelected(obj_id self, dictionary params)
    {
    ...
    public int msgFSXPConvertCommit(obj_id self, dictionary params)
    {
        detachScript(self, "quest.force_sensitive.fs_xp_convert");
    ...
    public int msgBranchSelected(obj_id self, dictionary params)
    {
        detachScript(self, "quest.force_sensitive.fs_xp_convert");
    ...
    public int getConversionRatio(String fs_type, String xp_type)
    {
        if (fs_type == null)
        {
