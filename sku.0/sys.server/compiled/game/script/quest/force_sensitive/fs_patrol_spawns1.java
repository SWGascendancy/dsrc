...
public class fs_patrol_spawns1 extends script.base_script
{
    ...
    public int handleDontKillPatrolFSNpc(obj_id self, dictionary params)
    {
    ...
    public int handleKillPatrolFSNpc(obj_id self, dictionary params)
    {
    ...
    public void spawnStuff(int numberOfEnemies, location startLocation, String questName, obj_id player)
    {
    ...
    public void cleanUpStuff(obj_id player)
    {
