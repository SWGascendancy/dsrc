...
public class fs_crafting4_player extends script.base_script
{
    ...
    public int handleSetLocationTarget(obj_id self, dictionary params)
    {
    ...
    public int handleRemoveTrackingObjVars(obj_id self, dictionary params)
    {
    ...
    public int handlePurchaseTrackingData(obj_id self, dictionary params)
    {
    ...
    public int handleTrackingDataPurchaseMsg02(obj_id self, dictionary params)
    {
        sendSystemMessage(self, SID_PURCHASE_MSG_02);
        messageTo(self, "handleTrackingDataPurchaseMsg03", null, rand(1, 2), false);
        return SCRIPT_CONTINUE;
    }
    public int handleTrackingDataPurchaseMsg03(obj_id self, dictionary params)
    {
    ...
    public void deactivateCrafting4Quest(obj_id self)
    {
