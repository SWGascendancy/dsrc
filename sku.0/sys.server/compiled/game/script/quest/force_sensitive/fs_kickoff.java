...
public class fs_kickoff extends script.base_script
{
    ...
    public int OnPlayerTheaterFail(obj_id self, String datatable, String name)
    {
        int quest_id = 0;
    ...
    public int OnSkillAboutToBeRevoked(obj_id self, String strSkill)
    {
    ...
    public int meetOldMan(obj_id self, dictionary params)
    {
    ...
    public int meetOldManExit(obj_id self, dictionary params)
    {
        String planet = getCurrentSceneName();
        if (planet.equals("mustafar"))
        {
    ...
    public int twoMilitaryEncounter(obj_id self, dictionary params)
    {
        String planet = getCurrentSceneName();
        if (planet.equals("mustafar"))
        {
    ...
    public void startMeetOldMan(obj_id player)
    {
        String planet = getCurrentSceneName();
        if (planet.equals("mustafar"))
        {
    ...
    public void startTwoMilitary(obj_id player)
    {
        String planet = getCurrentSceneName();
        if (planet.equals("mustafar"))
        {
    ...
    public void startMeetOldManExit(obj_id player)
    {
        String planet = getCurrentSceneName();
        if (planet.equals("mustafar"))
        {
    ...
    public int tryAgain(obj_id self, dictionary params)
    {
        startMeetOldMan(self);
        return SCRIPT_CONTINUE;
    }
    public int finalCleanup(obj_id self, dictionary params)
    {
        obj_id theater = getLastSpawnedTheater(self);
        if (isIdValid(theater))
        {
    ...
    public int msgForceComplete(obj_id self, dictionary params)
    {
    ...
    public int msgForceFail(obj_id self, dictionary params)
    {
    ...
    public int recreateTheaterOne(obj_id self, dictionary params)
    {
        obj_id theater = getLastSpawnedTheater(self);
        if (isIdValid(theater))
        {
    ...
    public int recreateTheaterTwo(obj_id self, dictionary params)
    {
        obj_id theater = getLastSpawnedTheater(self);
        if (isIdValid(theater))
        {
    ...
    public int addQuestLootToCorpse(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public void completeStuckWaitForTasks(obj_id self)
    {
    ...
    public void grantStuckBranchUnlocks(obj_id self)
    {
        if (quests.isComplete("fs_defend_01", self) && quests.isComplete("fs_defend_02", self))
        {
    ...
    public void resetStaleWaitForTasks(obj_id self)
    {
