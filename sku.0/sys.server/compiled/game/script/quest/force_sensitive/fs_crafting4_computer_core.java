...
public class fs_crafting4_computer_core extends script.base_script
{
    ...
    public int handlePuzzleSetup(obj_id self, dictionary params)
    {
        resetTheFlightRecorder(self);
        return SCRIPT_CONTINUE;
    }
    public int handleSetConnection(obj_id self, dictionary params)
    {
    ...
    public int cleanUpSelf(obj_id self, dictionary params)
    {
    ...
    public boolean isConfigured(obj_id self)
    {
        return hasObjVar(self, PUZZLE_CONFIGURED_OBJVAR);
    }
    public void resetTheFlightRecorder(obj_id self)
    {
    ...
    public void setConnection(obj_id self, obj_id player, int connectionNum)
    {
        string_id sid_message = SID_COMPUTER_CORE_ERROR;
        switch (connectionNum)
        {
    ...
    public string_id getWireSid(obj_id self, String objvarName, int connectionNum)
    {
        string_id sid_wire = SID_COMPUTER_CORE_ERROR;
    ...
    public void checkPuzzleSolutionAttempt(obj_id self, obj_id player)
    {
        int[] puzzleGuess = getIntArrayObjVar(self, PUZZLE_GUESS_OBJVAR);
        if (puzzleGuess == null || puzzleGuess.length == 0)
        {
    ...
    public string_id getConnectionMenuName(obj_id self, int connectionNum)
    {
    ...
    public int oneButtonMsgBox(obj_id controller, obj_id player, String handler, String textMsg)
    {
        if (utils.hasScriptVar(player, "crafting4.openSui"))
        {
            int oldSui = utils.getIntScriptVar(player, "crafting4.openSui");
    ...
    public void printBooleanArray(boolean[] stuff, obj_id player, String msg)
    {
    ...
    public void printIntArray(int[] stuff, obj_id player, String msg)
    {
        for (int i = 0; i < stuff.length; i++)
        {
            int one = stuff[i];
