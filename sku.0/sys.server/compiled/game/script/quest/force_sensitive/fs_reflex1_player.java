...
public class fs_reflex1_player extends script.base_script
{
    ...
    public void continueQuest(obj_id self, String questName, int rescued)
    {
        int left = (5 - rescued);
    ...
    public void finishQuest(obj_id self, String questName)
    {
    ...
    public void resetQuest(obj_id self)
    {
        for (int i = 0; i <= 7; i++)
        {
    ...
    public int handleReactivateFailedTask(obj_id self, dictionary params)
    {
