...
public class fs_survey_npc_convo extends script.base_script
{
    ...
    public boolean isRequiredResource(String name)
    {
    ...
    public int doWinnerCircleForSurveyQuests(obj_id self, dictionary params)
    {
        obj_id master = getObjIdObjVar(self, "fs_dyn_village.OBJVAR_MY_MASTER_OBJECT");
    ...
    public String hasOneOfMyQuests(obj_id player)
    {
        String what = "none";
