...
public class lava_beetle_nest_destroy extends script.base_script
{
    ...
    public int handleFlyTextTimer(obj_id self, dictionary params)
    {
    ...
    public int handleDestroyNest(obj_id self, dictionary params)
    {
    ...
    public int handleDamageTarget(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("target");
    ...
    public obj_id[] getValidPlayersInRadius(obj_id self, float range)
    {
