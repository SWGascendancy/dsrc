...
public class encounter_multi extends script.base_script
{
    ...
    public int encounterMultiSpawnEvent(obj_id self, dictionary params)
    {
        if (params != null)
        {
    ...
    public void failTasks(obj_id self)
    {
    ...
    public int deathNotification(obj_id self, dictionary params)
    {
        if (params != null)
        {
