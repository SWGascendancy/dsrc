...
public class quest_holocron extends script.base_script
{
    ...
    public int handleCheckCompletedHolocron(obj_id self, dictionary params)
    {
    ...
    public int OnObjectMenuSelect(obj_id self, obj_id player, int menu_item)
    {
        obj_id playerInventory = utils.getInventoryContainer(player);
        if (utils.isNestedWithin(self, playerInventory))
        {
    ...
    public boolean hasRewardItems(obj_id questHolocron)
    {
    ...
    public boolean openQuestHolocron(obj_id questHolocron, obj_id player)
    {
    ...
    public void areaDebugMessaging(obj_id self, String message)
    {
    ...
    public int handleQuestHolocronActivated(obj_id self, dictionary params)
    {
        pgc_quests.handlePhaseActived(self, 0);
        return SCRIPT_CONTINUE;
    }
    public int handleQuestHolocronInitializeTaskStatus(obj_id self, dictionary params)
    {
        int numTasks = getIntObjVar(self, pgc_quests.PCG_QUEST_NUM_TASKS_OBJVAR);
        pgc_quests.initializeQuestTasksStatus(self, numTasks);
        return SCRIPT_CONTINUE;
    }
    public int handleQuestHolocronAbandoned(obj_id self, dictionary params)
    {
    ...
    public int handleHolocronSharedSuccess(obj_id self, dictionary params)
    {
    ...
    public int handleCommMessageTaskCompletion(obj_id self, dictionary params)
    {
    ...
    public int ChroniclesMessageBoxCompleted(obj_id self, dictionary params)
    {
    ...
    public int CheckPerformanceComplete(obj_id self, dictionary params)
    {
        String phaseString = params.getString("phaseString");
        String taskString = params.getString("taskString");
    ...
    public int performGetTime(obj_id player)
    {
        return getPlayerPlayedTime(player);
    }
    public void sendCheckPerformanceComplete(obj_id questHolocron, String phaseString, String taskString, int delay)
    {
    ...
    public void clearPerformScriptVars(obj_id questHolocron, String phaseString, String taskString)
    {
        String baseObjVar = pgc_quests.getPgcBaseObjVar(phaseString, taskString);
    ...
    public int OnCraftedPrototype(obj_id self, dictionary params)
    {
        obj_id player = pgc_quests.getQuestPlayer(self);
        if (!isIdValid(player))
        {
    ...
    public int pqOnArrivedAtLocation(obj_id self, dictionary params)
    {
        obj_id player = pgc_quests.getQuestPlayer(self);
        if (!isIdValid(player))
        {
