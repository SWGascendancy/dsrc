...
public class perform extends script.quest.task.ground.base_task
{
    ...
    public void clearPerformObjVars(obj_id player, int questCrc, int taskId)
    {
    ...
    public void playerStoppedPerforming(obj_id player, boolean updateQuestTimer)
    {
    ...
    public void sendCheckPerformanceComplete(obj_id player, int questCrc, int taskId, int delay)
    {
    ...
    public void cleanup(obj_id player, int questCrc, int taskId)
    {
