...
public class spawn extends script.quest.task.ground.base_task
{
    ...
    public int messageStartQuestSpawn(obj_id self, dictionary params)
    {
    ...
    public void startGroundQuestSpawn(obj_id player, int questCrc, int taskId)
    {
    ...
    public void startSpaceQuestSpawn(obj_id player, int questCrc, int taskId)
    {
