...
public class defend extends script.quest.task.ground.base_task
{
    ...
    public int destroyNotification(obj_id self, dictionary params)
    {
    ...
    public int messageDefendCheckDistance(obj_id self, dictionary params)
    {
    ...
    public boolean isDefenseObjectNearby(int questCrc, int taskId, obj_id player, obj_id defendTarget)
    {
    ...
    public void failDefenseDistanceCheck(obj_id player, int questCrc, int taskId, obj_id defenseTarget)
    {
