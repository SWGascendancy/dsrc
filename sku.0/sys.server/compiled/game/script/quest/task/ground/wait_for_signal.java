...
public class wait_for_signal extends script.quest.task.ground.base_task
{
    ...
    public int questSignal(obj_id self, dictionary params)
    {
    ...
    public void createMarker(obj_id player, int questCrc, int taskId)
    {
    ...
    public void destroyMarker(obj_id player, int questCrc, int taskId)
    {
        String baseObjVar = groundquests.getBaseObjVar(player, taskType, questGetQuestName(questCrc), taskId);
    ...
    public void updateAllMarkers(obj_id player, boolean create)
    {
