...
public class wave_event_controller_npc extends script.base_script
{
    ...
    public int waveEventControllerNPCStart(obj_id self, dictionary params)
    {
    ...
    public void waveEventBegin(obj_id self, obj_id player, int playerLevel)
    {
        int wave = 1;
    ...
    public dictionary getwaveEventQuestData(obj_id self, obj_id player)
    {
    ...
    public float waveEventGetWaveDelay(obj_id self, obj_id player, int wave)
    {
        int delay = -1;
    ...
    public int waveEventSpawnNextWave(obj_id self, dictionary params)
    {
    ...
    public int waveEventChildDestroyed(obj_id self, dictionary params)
    {
    ...
    public void spoutChildrenListScriptVar(obj_id self, obj_id player)
    {
        if (isGod(player))
        {
    ...
    public int defaultEventReset(obj_id self, dictionary params)
    {
        if (!trial.verifySession(self, params))
        {
            return SCRIPT_CONTINUE;
    ...
    public int waveEventControllerNPCForceReset(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        if (isIdValid(player))
        {
    ...
    public void clearEventArea(obj_id self, obj_id player, boolean taskCompleted)
    {
