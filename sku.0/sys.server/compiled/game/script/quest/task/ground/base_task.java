...
public class base_task extends script.base.remote_object_requester
{
    ...
    public int QuestBaseTaskTimerTaskCompleted(obj_id self, dictionary params)
    {
    ...
    public void baseCleanup(obj_id player, int questCrc, int taskId)
    {
    ...
    public void sendTaskSignals(obj_id player, int questCrc, int taskId, String dataTableColumnName)
    {
