...
public class remote_encounter extends script.quest.task.ground.base_task
{
    ...
    public int OnTaskActivated(obj_id self, int questCrc, int taskId)
    {
    ...
    public int OnTaskCompleted(obj_id self, int questCrc, int taskId)
    {
        cleanup(self, questCrc, taskId);
        groundquests.questOutputDebugInfo(self, questCrc, taskId, taskType, "OnTaskCompleted", taskType + " task completed.");
        return super.OnTaskCompleted(self, questCrc, taskId);
    }
    public int OnTaskFailed(obj_id self, int questCrc, int taskId)
    {
        cleanup(self, questCrc, taskId);
        groundquests.questOutputDebugInfo(self, questCrc, taskId, taskType, "OnTaskFailed", taskType + " task failed.");
        return super.OnTaskFailed(self, questCrc, taskId);
    }
    public int OnTaskCleared(obj_id self, int questCrc, int taskId)
    {
        cleanup(self, questCrc, taskId);
    ...
    public int remoteEncounterFailsafeTimeout(obj_id self, dictionary params)
    {
    ...
    public int questItemUsed(obj_id self, dictionary params)
    {
        log("questItemUsed");
        int questCrc = params.getInt(QUEST_CRC);
        int taskId = params.getInt(TASK_ID);
    ...
    public int createRemoteObjectResponse(obj_id self, dictionary params)
    {
        int questCrc = params.getInt(QUEST_CRC);
        int taskId = params.getInt(TASK_ID);
        if (questIsTaskActive(questCrc, taskId, self))
    ...
    public int remoteEncounterCreatureDied(obj_id self, dictionary params)
    {
        int questCrc = params.getInt(QUEST_CRC);
        int taskId = params.getInt(TASK_ID);
        if (questIsTaskActive(questCrc, taskId, self))
    ...
    public int remoteEncounterCreatureEscaped(obj_id self, dictionary params)
    {
        int questCrc = params.getInt(QUEST_CRC);
        int taskId = params.getInt(TASK_ID);
        if (questIsTaskActive(questCrc, taskId, self))
    ...
    public String getQuestCrcVarName(int id)
    {
        return taskType + "." + QUEST_CRC + "." + id;
    }
    public String getTaskIdVarName(int id)
    {
        return taskType + "." + TASK_ID + "." + id;
    }
    public String getRemoteObjectVarName(int questCrc, int taskId)
    {
        return taskType + "." + REMOTE_OBJECT_ID + "." + questCrc + "." + taskId;
    }
    public int getQuestCrcScriptVar(obj_id self, int id)
    {
        return utils.getIntScriptVar(self, getQuestCrcVarName(id));
    }
    public int getTaskIdScriptVar(obj_id self, int id)
    {
        return utils.getIntScriptVar(self, getTaskIdVarName(id));
    }
    public obj_id getRemoteObjectScriptVar(obj_id self, int questCrc, int taskId)
    {
        return utils.getObjIdScriptVar(self, getRemoteObjectVarName(questCrc, taskId));
    }
    public void setQuestCrcScriptVar(obj_id self, int id, int questCrc)
    {
        utils.setScriptVar(self, getQuestCrcVarName(id), questCrc);
    }
    public void setTaskIdScriptVar(obj_id self, int id, int taskId)
    {
        utils.setScriptVar(self, getTaskIdVarName(id), taskId);
    }
    public void setRemoteObjectScriptVar(obj_id self, int questCrc, int taskId, obj_id objectId)
    {
        utils.setScriptVar(self, getRemoteObjectVarName(questCrc, taskId), objectId);
    }
    public boolean hasValidScriptVars(obj_id self, int id)
    {
        return utils.hasScriptVar(self, getQuestCrcVarName(id)) && utils.hasScriptVar(self, getTaskIdVarName(id));
    }
    public void cleanup(obj_id self, int questCrc, int taskId)
    {
    ...
    public void messageToRemote(obj_id self, int questCrc, int taskId, String message)
    {
        obj_id remoteObject = getRemoteObjectScriptVar(self, questCrc, taskId);
        if (isValidId(remoteObject))
        {
    ...
    public dictionary getRemoteCreateParams(obj_id self, int requestId)
    {
    ...
    public void removeRemoteCreateScriptVars(obj_id self, int requestId)
    {
    ...
    public boolean hasValidCreateScriptVars(obj_id self, int requestId)
    {
        int questCrc = getQuestCrcScriptVar(self, requestId);
        int taskId = getTaskIdScriptVar(self, requestId);
        if (!questIsTaskActive(questCrc, taskId, self))
    ...
    public obj_id getRemoteObjectCreator(obj_id self, int requestId, String[] elementNameList, dictionary[] dictionaryList)
    {
        int questCrc = getQuestCrcScriptVar(self, requestId);
        int taskId = getTaskIdScriptVar(self, requestId);
    ...
    public void setRemoteObjectAsMissionCriticalToGroup(obj_id self, obj_id remoteObject)
    {
        dictionary params = new dictionary();
    ...
    public void removeRemoteObjectFromMissionCriticalToGroup(obj_id self, obj_id remoteObject)
    {
        dictionary params = new dictionary();
    ...
    public void sendEncounterWhereMessageToGroup(obj_id self, int questCrc, int taskId, String sceneName)
    {
    ...
    public void sendMessageToGroup(obj_id self, dictionary params, String message)
    {
    ...
    public boolean isRemoteEncounter(int questCrc, int taskId)
    {
