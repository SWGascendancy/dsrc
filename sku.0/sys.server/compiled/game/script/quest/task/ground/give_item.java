...
public class give_item extends script.quest.task.ground.base_task
{
    ...
    public int itemGivenToNpc(obj_id self, dictionary params)
    {
    ...
    public void failIfFailOnLogout(obj_id player)
    {
    ...
    public String getCounterText(int textType)
    {
        switch (textType)
        {
            case textDeliver:
    ...
    public String getMultipleSuccessTextKey(int textType)
    {
        switch (textType)
        {
            case textDeliver:
