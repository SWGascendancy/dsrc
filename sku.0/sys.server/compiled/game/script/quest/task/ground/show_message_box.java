...
public class show_message_box extends script.quest.task.ground.base_task
{
    ...
    public String getQuestCrcVarName(int pageId)
    {
        return taskType + ".questCrc." + pageId;
    }
    public String getTaskIdVarName(int pageId)
    {
        return taskType + ".taskId." + pageId;
    }
    public void displayMessageBox(obj_id player, int questCrc, int taskId)
    {
    ...
    public int QuestShowMessageBoxCompleted(obj_id self, dictionary params)
    {
