...
public class grant_space_quest extends script.quest.task.ground.base_task
{
    ...
    public int groundSpaceWinner(obj_id self, dictionary params)
    {
        handleSpaceQuestMessaging(self, params, winner);
        return SCRIPT_CONTINUE;
    }
    public int groundSpaceSplit(obj_id self, dictionary params)
    {
        handleSpaceQuestMessaging(self, params, split);
        return SCRIPT_CONTINUE;
    }
    public int groundSpaceFailed(obj_id self, dictionary params)
    {
    ...
    public void handleSpaceQuestMessaging(obj_id self, dictionary params, int spaceQuestValue)
    {
