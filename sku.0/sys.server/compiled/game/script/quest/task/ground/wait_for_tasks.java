...
public class wait_for_tasks extends script.quest.task.ground.base_task
{
    ...
    public int checkForAlreadyCompletedTasks(obj_id self, dictionary params)
    {
    ...
    public int OnSomeTaskCompleted(obj_id self, int questCrc, int taskId)
    {
        handleSomeTaskFinished(self, questCrc, taskId);
        return SCRIPT_CONTINUE;
    }
    public int OnSomeTaskFailed(obj_id self, int questCrc, int taskId)
    {
        handleSomeTaskFinished(self, questCrc, taskId);
        return SCRIPT_CONTINUE;
    }
    public void handleSomeTaskFinished(obj_id player, int finishedTaskQuestCrc, int finishedTaskTaskId)
    {
