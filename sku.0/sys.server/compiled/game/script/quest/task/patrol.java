...
public class patrol extends script.base_script
{
    ...
    public int handleDestroyWaypoint(obj_id self, dictionary params)
    {
    ...
    public void waypointCleanUp(String questName, obj_id player)
    {
        for (int i = 0; i < 8; i++)
        {
    ...
    public void setupPatrolWaypoint(obj_id self, int questRow)
    {
    ...
    public location getPatrolLocation(obj_id self, int questRow)
    {
