...
public class basic_task extends script.base_script
{
    ...
    public void completeTask(obj_id self, String questName, boolean succeeded)
    {
    ...
    public void setupTheater(obj_id self, int questRow)
    {
    ...
    public void setupGeiger(obj_id self, int questRow, location loc)
    {
    ...
    public void setupWaypoint(obj_id self, int questRow, location loc)
    {
        String questName = quests.getDataEntry(questRow, "NAME");
    ...
    public int theaterFailed(obj_id self, dictionary params)
    {
    ...
    public int OnCreatedKillableObject(obj_id self, dictionary params)
    {
    ...
    public int OnIncapacitatedKillableObject(obj_id self, dictionary params)
    {
