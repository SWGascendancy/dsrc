...
public class altruism_control extends script.base_script
{
    ...
    public int handleAltruismResetCheck(obj_id self, dictionary params)
    {
    ...
    public int handleExplosion(obj_id self, dictionary params)
    {
    ...
    public int handleQuestFail(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
    ...
    public int handleValidateContent(obj_id self, dictionary params)
    {
        if (!hasObjVar(self, ALTRUISM_ACTIVE))
        {
            return SCRIPT_CONTINUE;
    ...
    public int resetContent(obj_id self, dictionary params)
    {
        cleanupObjects(self);
        return SCRIPT_CONTINUE;
    }
    public int setupContent(obj_id self, dictionary params)
    {
        cleanupObjects(self);
        spawnQuestObjects(self);
        return SCRIPT_CONTINUE;
    }
    public boolean caveHasQuestPlayers(obj_id self)
    {
    ...
    public void spawnQuestObjects(obj_id self)
    {
        if (hasObjVar(self, ALTRUISM_LAST_SUCCESS))
        {
    ...
    public void succeedQuest(obj_id control, obj_id npc)
    {
    ...
    public void destroyWaypoint(obj_id player)
    {
    ...
    public void cleanupObjects(obj_id self)
    {
