...
public class intellect_spawner extends script.base_script
{
    ...
    public int handleValidate(obj_id self, dictionary params)
    {
    ...
    public int handleSpawn(obj_id self, dictionary params)
    {
        obj_id controller = params.getObjId("controller");
        int number = params.getInt("number");
        dictionary d = new dictionary();
    ...
    public int handleComplete(obj_id self, dictionary params)
    {
        if (!hasObjVar(self, SPAWNER_NUMBER) || !hasObjVar(self, SPAWNER_CONTROLLER))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleLocationRequest(obj_id self, dictionary params)
    {
    ...
    public boolean spawnObjects(obj_id self, obj_id controller, int number)
    {
    ...
    public boolean validateActiveSpawn(obj_id self)
    {
    ...
    public void destroySpawnedObjects(obj_id self)
    {
        obj_id[] liars = getObjIdArrayObjVar(self, SPAWNER_LIARS);
        obj_id bh = getObjIdObjVar(self, SPAWNER_BH);
    ...
    public void cleanupStaleObjects(obj_id self)
    {
    ...
    public Vector shuffleList(Vector list)
    {
    ...
    public void namePirates(Vector pirates)
    {
        string_id[] names = 
        {
