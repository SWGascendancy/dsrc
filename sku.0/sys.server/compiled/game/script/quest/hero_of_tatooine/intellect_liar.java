...
public class intellect_liar extends script.base_script
{
    ...
    public int OnNpcConversationResponse(obj_id self, String conversation, obj_id speaker, string_id response)
    {
    ...
    public int handleSetYaw(obj_id self, dictionary params)
    {
    ...
    public int handleResetYaw(obj_id self, dictionary params)
    {
    ...
    public String getLiarName(obj_id self, int number)
    {
