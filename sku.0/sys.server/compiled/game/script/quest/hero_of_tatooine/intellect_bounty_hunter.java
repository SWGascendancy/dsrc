...
public class intellect_bounty_hunter extends script.base_script
{
    ...
    public int handleImplicationSui(obj_id self, dictionary params)
    {
    ...
    public void puzzleSuccess(obj_id self, obj_id player)
    {
    ...
    public void puzzleFailure(obj_id self, obj_id player)
    {
        removeObjVar(player, INTELLECT_OBJVAR);
