...
public class ranch_house extends script.base_script
{
    ...
    public int spawnDudes(obj_id self, dictionary params)
    {
    ...
    public int piratesEscape(obj_id self, dictionary params)
    {
    ...
    public int piratesLose(obj_id self, dictionary params)
    {
    ...
    public int piratesCaptured(obj_id self, dictionary params)
    {
        location pirate01Location = new location(-9.03f, -3.97f, -8.63f, "tatooine", getCellId(self, "stair1"));
        obj_id pirate01 = create.object("fugitive", pirate01Location);
    ...
    public int failed(obj_id self, dictionary params)
    {
    ...
    public int success(obj_id self, dictionary params)
    {
        obj_id player01 = getObjIdObjVar(self, "quest.hero_of_tatooine.progress");
    ...
    public int restart(obj_id self, dictionary params)
    {
    ...
    public int reset(obj_id self, dictionary params)
    {
        obj_id wife = getObjIdObjVar(self, "wife");
        destroyObject(wife);
        removeObjVar(self, "wife");
