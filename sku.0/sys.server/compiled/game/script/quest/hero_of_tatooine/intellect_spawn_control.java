...
public class intellect_spawn_control extends script.base_script
{
    ...
    public int handleValidation(obj_id self, dictionary params)
    {
    ...
    public int handleSingleValidationCheck(obj_id self, dictionary params)
    {
    ...
    public int handleAllValidationCheck(obj_id self, dictionary params)
    {
        if (countActiveSpawns(self) == 0)
        {
    ...
    public int handleSpawnValidation(obj_id self, dictionary params)
    {
    ...
    public int handleCompletion(obj_id self, dictionary params)
    {
        int number = params.getInt("number");
        int[] status = getIntArrayObjVar(self, SPAWNER_STATUS);
        if (status == null || status.length == 0)
    ...
    public int handleLocationResponse(obj_id self, dictionary params)
    {
    ...
    public int handleForcedValidation(obj_id self, dictionary params)
    {
    ...
    public void setupSpawnerObjVars(obj_id self)
    {
    ...
    public void validateSpawners(obj_id self)
    {
        if (countActiveSpawns(self) == 0)
        {
            validateAllSpawners(self);
    ...
    public void validateAllSpawners(obj_id self)
    {
        obj_id[] ids = getObjIdArrayObjVar(self, SPAWNER_IDS);
        int[] status = getIntArrayObjVar(self, SPAWNER_STATUS);
        dictionary d = new dictionary();
    ...
    public void startSpawnSequence(obj_id self, float time, boolean override)
    {
    ...
    public void startSpawnSequence(obj_id self, float time)
    {
        startSpawnSequence(self, time, false);
    }
    public void findSpawned(obj_id self, obj_id speaker)
    {
        obj_id[] ids = getObjIdArrayObjVar(self, SPAWNER_IDS);
        int[] status = getIntArrayObjVar(self, SPAWNER_STATUS);
        dictionary d = new dictionary();
    ...
    public int countActiveSpawns(obj_id self)
    {
        int[] status = getIntArrayObjVar(self, SPAWNER_STATUS);
        if (status == null || status.length == 0)
        {
