...
public class control_performance extends script.base_script
{
    ...
    public int handlePrePerformanceCountdown(obj_id self, dictionary params)
    {
    ...
    public int handleBeginPerformance(obj_id self, dictionary params)
    {
        int level = utils.getIntScriptVar(self, LEVEL_OBJVAR);
        obj_id player = utils.getObjIdScriptVar(self, PLAYER_OBJVAR);
    ...
    public int handlePerformanceHeartbeat(obj_id self, dictionary params)
    {
        if (!utils.hasScriptVar(self, IN_PROGRESS_OBJVAR))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleEndPerformance(obj_id self, dictionary params)
    {
        int level = utils.getIntScriptVar(self, LEVEL_OBJVAR);
        obj_id player = utils.getObjIdScriptVar(self, PLAYER_OBJVAR);
        int threshold = 0;
    ...
    public int handleSpawnAudienceMembers(obj_id self, dictionary params)
    {
    ...
    public boolean isOccupied(int seat, Vector list)
    {
    ...
    public void succeedPerformance(obj_id self, obj_id player)
    {
        int level = utils.getIntScriptVar(self, LEVEL_OBJVAR);
        obj_id control = utils.getObjIdScriptVar(self, CONTROL_OBJVAR);
    ...
    public void failPerformance(obj_id self, obj_id player)
    {
        int level = utils.getIntScriptVar(self, LEVEL_OBJVAR);
        obj_id control = utils.getObjIdScriptVar(self, CONTROL_OBJVAR);
        removeTriggerVolume(VOLUME_NAME);
    ...
    public void spawnAudience(obj_id self, obj_id player, int level)
    {
        int members = 0;
        switch (level)
        {
    ...
    public void performAudienceReaction(obj_id self, obj_id player, int satisfaction)
    {
        int level = utils.getIntScriptVar(self, LEVEL_OBJVAR);
        int threshold = 0;
        switch (level)
    ...
    public void performFinalAudienceReaction(obj_id self, obj_id player, int satisfaction)
    {
        int level = utils.getIntScriptVar(self, LEVEL_OBJVAR);
        int threshold = 0;
        switch (level)
    ...
    public void cleanupAudienceMembers(obj_id self)
    {
        location loc = getLocation(self);
