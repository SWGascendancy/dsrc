...
public class control_audition extends script.base_script
{
    ...
    public int handleBeginAudition(obj_id self, dictionary params)
    {
        obj_id player = utils.getObjIdScriptVar(self, PLAYER_OBJVAR);
    ...
    public int handleObservedFlourish(obj_id self, dictionary params)
    {
    ...
    public int handleReceivePlayerFail(obj_id self, dictionary params)
    {
        obj_id player = utils.getObjIdScriptVar(self, PLAYER_OBJVAR);
        failAudition(self, player);
        messageTo(self, "handleCleanup", null, 20.0f, false);
    ...
    public int handleAuditionStepOne(obj_id self, dictionary params)
    {
        obj_id player = utils.getObjIdScriptVar(self, PLAYER_OBJVAR);
    ...
    public int handleAuditionStepTwo(obj_id self, dictionary params)
    {
        obj_id player = utils.getObjIdScriptVar(self, PLAYER_OBJVAR);
    ...
    public int handleAuditionStepThree(obj_id self, dictionary params)
    {
        obj_id player = utils.getObjIdScriptVar(self, PLAYER_OBJVAR);
    ...
    public int handleAuditionStepFour(obj_id self, dictionary params)
    {
        obj_id player = utils.getObjIdScriptVar(self, PLAYER_OBJVAR);
        int satisfied = utils.getIntScriptVar(self, SATISFACTION_OBJVAR);
        if (satisfied == 0)
    ...
    public int handleAuditionStepFive(obj_id self, dictionary params)
    {
        obj_id player = utils.getObjIdScriptVar(self, PLAYER_OBJVAR);
        String expected = utils.getStringScriptVar(self, EXPECTATION_OBJVAR);
        if (!isPerformanceCorrect(player, expected))
    ...
    public int handleAuditionStepSix(obj_id self, dictionary params)
    {
        obj_id player = utils.getObjIdScriptVar(self, PLAYER_OBJVAR);
        int satisfied = utils.getIntScriptVar(self, SATISFACTION_OBJVAR);
        if (satisfied == 0)
    ...
    public int handleAuditionFinish(obj_id self, dictionary params)
    {
        obj_id player = utils.getObjIdScriptVar(self, PLAYER_OBJVAR);
        int satisfied = utils.getIntScriptVar(self, SATISFACTION_OBJVAR);
        if (satisfied == 0)
    ...
    public void succeedAudition(obj_id self, obj_id player)
    {
        obj_id control = utils.getObjIdScriptVar(self, CONTROL_OBJVAR);
    ...
    public void failAudition(obj_id self, obj_id player)
    {
        obj_id control = utils.getObjIdScriptVar(self, CONTROL_OBJVAR);
        removeTriggerVolume(VOLUME_NAME);
        detachScript(player, PLAYER_SCRIPT);
    ...
    public void spawnJudges(obj_id self)
    {
    ...
    public void cleanupJudges(obj_id self)
    {
    ...
    public boolean isPerformanceCorrect(obj_id player, String expected)
    {
    ...
    public obj_id getRandomJudge(obj_id self)
    {
        obj_id[] judges = utils.getObjIdArrayScriptVar(self, JUDGES_OBJVAR);
        if (judges == null || judges.length == 0)
        {
