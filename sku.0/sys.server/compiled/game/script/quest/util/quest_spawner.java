...
public class quest_spawner extends script.base_script
{
    ...
    public int msgQuestSpawnerPulse(obj_id self, dictionary params)
    {
        if (createSpawn(self))
        {
    ...
    public int msgQuestDestroySpawner(obj_id self, dictionary params)
    {
    ...
    public dictionary getSpawnerData(String spawner_name, String datatable)
    {
    ...
    public boolean createSpawn(obj_id spawner)
    {
