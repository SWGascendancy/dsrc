...
public class qaweapon extends script.base_script
{
    ...
    public int handleWeaponTypeOptions(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
    ...
    public int handleWeaponLevelOptions(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
            obj_id player = sui.getPlayerId(params);
    ...
    public int handleWeaponElementalOptions(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
            obj_id player = sui.getPlayerId(params);
    ...
    public int handleWeaponElementalDamage(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
            obj_id player = sui.getPlayerId(params);
    ...
    public void weaponTypeMenu(obj_id player)
    {
    ...
    public void weaponDamageMenu(obj_id player)
    {
    ...
    public void elementalTypeMenu(obj_id player)
    {
    ...
    public void elementalDamageMenu(obj_id player)
    {
    ...
    public void checkInventory(obj_id player)
    {
    ...
    public void createQAWeapon(obj_id player)
    {
