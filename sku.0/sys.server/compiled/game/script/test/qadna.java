...
public class qadna extends script.base_script
{
    ...
    public int handlePetOptionsTool(obj_id self, dictionary params)
    {
        if (!isGod(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleDnaOptions(obj_id self, dictionary params)
    {
        if (!isGod(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public void toolMainMenu(obj_id self, String[] dnaCreatureArray)
    {
    ...
    public void getCreatureList(obj_id self)
    {
    ...
    public String getDisplayName(String creatureName)
    {
    ...
    public void setUpDnaWithDummyData(obj_id self, String creatureTemplate, String creature)
    {
