...
public class qa_jtl_tools extends script.base_script
{
    ...
    public int mainMenuOptions(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
    ...
    public int pilotQuestRoadmaps(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
            if (utils.hasScriptVar(self, SCRIPTVAR + ".pid"))
    ...
    public int handleWaypointOptions(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
            if (utils.hasScriptVar(self, SCRIPTVAR + ".pid"))
    ...
    public int predefinedShips(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
            if (utils.hasScriptVar(self, SCRIPTVAR + ".pid"))
    ...
    public int handleMiningComponents(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
            if (utils.hasScriptVar(self, SCRIPTVAR + ".pid"))
    ...
    public int godShipMenuOptions(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
            if (utils.hasScriptVar(self, SCRIPTVAR + ".pid"))
    ...
    public int validChassisMenuOptions(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
            if (utils.hasScriptVar(self, SCRIPTVAR + ".pid"))
    ...
    public int handleShipOptions(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
            if (utils.hasScriptVar(self, SCRIPTVAR + ".pid"))
    ...
    public int handleChassisOptions(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
            if (utils.hasScriptVar(self, SCRIPTVAR + ".pid"))
    ...
    public int handleLootCategories(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
            if (utils.hasScriptVar(self, SCRIPTVAR + ".pid"))
    ...
    public int spawnLootItem(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
            if (utils.hasScriptVar(self, SCRIPTVAR + ".pid"))
    ...
    public int spaceDeedHandler(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
            if (utils.hasScriptVar(self, SCRIPTVAR + ".pid"))
    ...
    public void grantShip(obj_id player, String shipName, int weaponSlots, boolean godShip)
    {
    ...
    public String[] createLootCategroies(obj_id player, String categoryString)
    {
    ...
    public String[] returnListOfCellsInTable(obj_id player, int totalCols, String datatableName)
    {
    ...
    public String[] getWaypointNames(obj_id self)
    {
    ...
    public boolean foundWaypointName(obj_id self, String waypointSearchName)
    {
    ...
    public boolean getWaypoint(obj_id self, String groupName)
    {
        String waypName = "";
