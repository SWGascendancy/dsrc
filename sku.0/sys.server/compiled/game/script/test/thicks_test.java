...
public class thicks_test extends script.base_script
{
    ...
    public void listScripts(obj_id self)
    {
    ...
    public void clearScript(obj_id self)
    {
        obj_id target = getLookAtTarget(self);
        String[] scriptList = getScriptList(target);
    }
    public void clearAllScripts(obj_id self)
    {
        obj_id target = getLookAtTarget(self);
        detachAllScripts(target);
        sendSystemMessageTestingOnly(self, "ALL SCRIPTS REMOVED");
    }
    public int handleClearScript(obj_id self, dictionary params)
    {
    ...
    public void runDoClientEffect(obj_id self, String[] parse)
    {
    ...
    public int clearEffect(obj_id self, dictionary params)
    {
        stopClientEffectObjByLabel(self, "tag");
        return SCRIPT_CONTINUE;
    }
    public void runSpawnCreature(obj_id self, String[] parse)
    {
    ...
    public void showGodWindow(obj_id user)
    {
        int pid = sui.listbox(user, user, "Select GM Option", OPTIONS, "handleSelectGMCommand");
    }
    public int handleSelectGMCommand(obj_id self, dictionary params)
    {
    ...
    public void doScriptListSUI(obj_id player)
    {
    ...
    public void runFind(obj_id self, String[] parse)
    {
    ...
    public void runWarpToFind(obj_id self, String[] parse)
    {
    ...
    public void runEnterFind(obj_id self, String[] parse)
    {
    ...
    public void runInteriorWarp(obj_id self, String[] parse)
    {
    ...
    public void runShowTime(obj_id self, String[] parse)
    {
        String time = utils.formatTime(getGameTime());
        sendSystemMessageTestingOnly(self, time);
    }
    public void runIsScentMasked(obj_id self, String[] parse)
    {
    ...
    public void runValidateConceal(obj_id self, String[] parse)
    {
    ...
    public void runGetBuildingScripts(obj_id self, String[] parse)
    {
    ...
    public void runGetBuildingObjVars(obj_id player, String[] parse)
    {
        obj_id target = getTopMostContainer(player);
        String[] scriptList = getScriptList(target);
        int pid = sui.listbox(player, player, "SCRIPTS ON TARGET", scriptList, "handleRecievedScriptList");
    }
    public void runTargetLocation(obj_id self, String[] parse)
    {
    ...
    public void runBuildoutLoc(obj_id self, String[] parse)
    {
    ...
    public void sendMessageTo(obj_id self, String[] parse)
    {
        obj_id target = getTarget(self);
        if (!isIdValid(target))
        {
    ...
    public void broadcastMessageTo(obj_id self, String[] parse)
    {
    ...
    public void runDestroyAndRecreate(obj_id self, String[] parse)
    {
    ...
    public void runMessageToBuilding(obj_id self, String[] parse)
    {
        obj_id top = getTopMostContainer(self);
        String message = parse[1];
        if (parse.length > 2)
    ...
    public void runDeathTouch(obj_id self, String[] parse)
    {
        obj_id target = getTarget(self);
        if (!isIdValid(target))
        {
    ...
    public void runBuffMe(obj_id self, String[] parse)
    {
        buff.applyBuff(self, parse[1]);
    }
    public void runBuffYou(obj_id self, String[] parse)
    {
        obj_id target = getIntendedTarget(self);
        buff.applyBuff(target, parse[1]);
    }
    public void runSetRecordObject(obj_id self, String[] parse)
    {
        obj_id target = getTarget(self);
        if (isIdValid(target))
        {
    ...
    public void runSetRecordObjectFromFind(obj_id self, String[] parse)
    {
    ...
    public void runRecordTo(obj_id self, String[] parse)
    {
    ...
    public void runGetCellId(obj_id self, String[] parse)
    {
        obj_id container = getContainedBy(self);
        sendSystemMessageTestingOnly(self, "I am contained by (" + container + ")");
    }
    public void runClearAllLockoutTimers(obj_id self, String[] parse)
    {
        space_dungeon.clearAllDungeonLockoutTimers(self);
    }
    public void runApplyBuff(obj_id self, String[] parse)
    {
        obj_id target = getTarget(self);
        if (!isIdValid(target))
        {
    ...
    public void runDoAnim(obj_id self, String[] parse)
    {
        obj_id target = getLookAtTarget(self);
        if (!isIdValid(target))
        {
    ...
    public void runDoRecordBuildoutLoc(obj_id self, String[] parse)
    {
        if (!hasObjVar(self, "record_table"))
        {
            sendSystemMessageTestingOnly(self, "You do not have the record_table objvar defined");
    ...
    public void runSpawnAkPrime(obj_id self, String[] parse)
    {
    ...
    public void runGetTopMostContainer(obj_id self, String[] parse)
    {
        obj_id top = getTopMostContainer(self);
        sendSystemMessageTestingOnly(self, "Top most container is(" + top + ")");
    }
    public void runBadgeOperation(obj_id self, String[] parse)
    {
        if (parse.length < 3)
        {
            return;
    ...
    public void runSetFollowInFormation(obj_id self, String[] parse)
    {
        if (parse.length < 2)
        {
            return;
    ...
    public void runDeleteObject(obj_id self, String[] parse)
    {
    ...
    public void runRoriConversion(obj_id self, String[] parse)
    {
        if (!hasObjVar(self, "record_table"))
        {
            sendSystemMessageTestingOnly(self, "You do not have the record_table objvar defined");
    ...
    public void getModLoc(obj_id self)
    {
        if (!utils.hasScriptVar(self, "messageTo.recordObject"))
        {
            sendSystemMessageTestingOnly(self, "You do not have a record object");
    ...
    public void calculateWarp(obj_id self, String[] parse)
    {
    ...
    public void calculateDistance(obj_id self, String[] parse)
    {
    ...
    public void deleteRegion(obj_id self, String[] parse)
    {
        region r = getRegion(getLocation(self).area, parse[1]);
        deleteRegion(r);
        sendSystemMessageTestingOnly(self, "Deleted Region: " + r);
    }
    public void get3dSpaceLoc(obj_id self, String[] parse)
    {
        obj_id target = getTarget(self);
    ...
    public void runQuery(obj_id self, String[] parse)
    {
    ...
    public void populateListbox(obj_id self, String[] data, String handler)
    {
    ...
    public String[] convertCreatureQueryToStringArray(dictionary creatureDict)
    {
    ...
    public int creatureLookup(obj_id self, dictionary params)
    {
    ...
    public void getBaseCount(obj_id self, String[] parse)
    {
    ...
    public void calculateGameTime(obj_id self, String[] parse)
    {
        if (parse.length == 1)
        {
    ...
    public void runTestBatch(obj_id self, String[] parse)
    {
        if (parse.length < 2)
        {
            return;
    ...
    public void runMakeSpaceOvert(obj_id self, String[] parse)
    {
    ...
    public void runGetPlanetObject(obj_id self, String[] parse)
    {
        sendSystemMessageTestingOnly(self, "" + getPlanetByName(getLocation(self).area));
    }
    public void runRespec(obj_id self, String[] parse)
    {
        if (parse.length < 3)
        {
    ...
    public void runGetSkillTemplate(obj_id self, String[] parse)
    {
        sendSystemMessageTestingOnly(self, getSkillTemplate(self));
    }
    public void runQueueCommand(obj_id self, String[] parse)
    {
        obj_id target = getIntendedTarget(self);
        queueCommand(self, getStringCrc(parse[1].toLowerCase()), target, "", COMMAND_PRIORITY_DEFAULT);
    }
    public void runSetCooldown(obj_id self, String[] parse)
    {
    ...
    public void runGetWeapon(obj_id self, String[] parse)
    {
        obj_id weapon = getCurrentWeapon(self);
        sendSystemMessageTestingOnly(self, "Current weapon is: " + weapon);
    }
    public void runVerifySession(obj_id self, String[] parse)
    {
        space_dungeon.verifyPlayerSession(self);
    }
    public void runGetHateList(obj_id self, String[] parse)
    {
    ...
    public void runGetRespect(obj_id self, String[] parse)
    {
        obj_id subject = getTarget(self);
    ...
    public void runMakeDecoy(obj_id self, String[] parse)
    {
    ...
    public void runCommLink(obj_id self, String[] parse)
    {
        if (parse.length < 3)
        {
            return;
    ...
    public void runPrepCave(obj_id self, String[] parse)
    {
    ...
    public void runSwarmTarget(obj_id self, String[] parse)
    {
        obj_id target = getIntendedTarget(self);
    ...
    public void runSetMaster(obj_id self, String[] parse)
    {
        obj_id target = getIntendedTarget(self);
        setMaster(self, null);
        setMaster(target, self);
    }
    public void runConvert(obj_id self, String[] parse)
    {
    ...
    public void dumpToTable(obj_id self, String[] parse)
    {
        if (!hasObjVar(self, "record_table"))
        {
            sendSystemMessageTestingOnly(self, "You do not have the record_table objvar defined");
    ...
    public void recreateTable(obj_id self, String[] parse)
    {
        if (!hasObjVar(self, "record_table"))
        {
            sendSystemMessageTestingOnly(self, "You do not have the record_table objvar defined");
    ...
    public void runGetCommmandList(obj_id self, String[] parse)
    {
    ...
    public void runGetCellList(obj_id self, String[] parse)
    {
    ...
    public void runEnterCell(obj_id self, String[] parse)
    {
        obj_id pob = utils.stringToObjId(parse[1]);
    ...
    public void runIt(obj_id self, String[] parse)
    {
    ...
    public void runGetBell(obj_id self, String[] parse)
    {
    ...
    public float distributedRand(float min, float max, int level)
    {
    ...
    public void runSetHover(obj_id self, String[] parse)
    {
        float height = utils.stringToFloat(parse[1]);
        vehicle.setHoverHeight(getIntendedTarget(self), height);
    }
    public void runTestSlope(obj_id self, String[] parse)
    {
        obj_id target = getIntendedTarget(self);
        addSlowDownEffect(self, target, 10.0f, 180.0f, 85.0f, 10.0f);
    }
    public void runAlterHeight(obj_id self, String[] parse)
    {
        obj_id target = getIntendedTarget(self);
    ...
    public void runTestBool(obj_id self, String[] parse)
    {
    ...
    public void runAddAttrib(obj_id self, String[] parse)
    {
    ...
    public void runLit3(obj_id self, String[] parse)
    {
        obj_id recordObject = utils.getObjIdScriptVar(self, "messageTo.recordObject");
        obj_id target = getIntendedTarget(self);
        chat.chat(self, "Can See: " + canSee(recordObject, target));
    }
    public void runShieldMe(obj_id self, String[] parse)
    {
        for (int i = 0; i < 9; i++)
        {
    ...
    public void clearStunEffects(obj_id self, String[] parse)
    {
        setState(self, STATE_STUNNED, false);
        setState(self, STATE_FROZEN, false);
    }
    public void makeMeAGod(obj_id self, String[] parse)
    {
    ...
    public void runSetSlope(obj_id self, String[] parse)
    {
        obj_id target = getIntendedTarget(self);
        addSlowDownEffect(self, target, 50.0f, 0.01f, 75.0f, 10.0f);
    }
    public void runSetKillMeter(obj_id self, String[] parse)
    {
        int value = utils.stringToInt(parse[1]);
        combat.setKillMeter(self, value);
    }
    public void runSetMind(obj_id self, String[] parse)
    {
        setMind(self, utils.stringToInt(parse[1]));
    }
    public void runGetMind(obj_id self, String[] parse)
    {
        int current = getMind(self);
        int max = getMaxMind(self);
        debugSpeakMsg(self, "Mind = " + current + " of " + max);
    }
    public void runSetupSnowspeeder(obj_id self, String[] parse)
    {
    ...
    public void runTestShoot(obj_id self, String[] parse)
    {
        obj_id target = getIntendedTarget(self);
    ...
    public void runSetLoc(obj_id self, String[] parse)
    {
    ...
    public void runSetDda(obj_id self, String[] parse)
    {
    ...
    public void runGetDda(obj_id self, String[] parse)
    {
    ...
    public void runStaticItemParse(obj_id self, String[] parse)
    {
    ...
    public void runStaticItemFind(obj_id self, String[] parse)
    {
    ...
    public void runStaticItemCreate(obj_id self, String[] parse)
    {
        if (parse.length < 2)
        {
            sendSystemMessage(self, "Syntax: staticItem create [list index or static item name]", "");
    ...
    public void runStaticItemShowList(obj_id self)
    {
    ...
    public void runStaticItemClearList(obj_id self)
    {
        if (utils.hasScriptVar(self, "idiot_matchingStaticItems"))
        {
    ...
    public void runPlaySound(obj_id self, String[] parse)
    {
        debugSpeakMsg(self, "attempting to play: " + parse[1]);
        play2dNonLoopingSound(self, "sound/" + parse[1] + ".snd");
    }
    public int instance_ping_response(obj_id self, dictionary params)
    {
        String message = params.getString("message");
        sendConsoleMessage(self, message);
        return SCRIPT_CONTINUE;
    }
    public void runFireTrigger(obj_id self, String[] parse)
    {
        trial.sendSequenceTrigger(parse[1]);
    }
    public void runSetCellLabel(obj_id self, String[] parse)
    {
        obj_id top = trial.getTop(self);
        obj_id cellId = getCellId(top, parse[1]);
        setCellLabel(cellId, parse[2]);
    }
    public void runClearWaypoints(obj_id self, String[] parse)
    {
    ...
    public void runSetIdOnInstance(obj_id self, String[] parse)
    {
        obj_id instance_id = instance.getAreaInstanceController(self);
        instance.addToPlayerIdList(instance_id, self);
    }
    public void runHideFromClient(obj_id self, String[] parse)
    {
        obj_id target = getIntendedTarget(self);
