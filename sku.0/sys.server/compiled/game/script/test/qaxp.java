...
public class qaxp extends script.base_script
{
    ...
    public int handleXpOptions(obj_id self, dictionary params)
    {
    ...
    public int handleXpAmountAdd(obj_id self, dictionary params)
    {
    ...
    public int handleXpAmountRevoke(obj_id self, dictionary params)
    {
        obj_id player = qa.findTarget(self);
        int btn = sui.getIntButtonPressed(params);
        int amt = sui.getTransferInputTo(params);
    ...
    public void validateTemplateThenConstructTransferUI(obj_id player, String choice, String template)
    {
    ...
    public void revokeGroungXp(obj_id player)
    {
