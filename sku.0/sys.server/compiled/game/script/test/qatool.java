...
public class qatool extends script.base_script
{
    ...
    public int vetRewardOptionHandler(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
    ...
    public int cmdQaTool(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (isGod(self))
        {
            ...
            else if (command.equals("namecheck"))
            {
                if (st.hasMoreTokens())
                {
                    ...
                    //utils.isAppropriateName(name);
                    sendSystemMessageTestingOnly(self, name);
                    return SCRIPT_CONTINUE;
                }
            }
            ...
            else if (command.equals("battlefield"))
            {
                if (st.hasMoreTokens())
                {
                    ...
                    obj_id battlefieldTerminal = createObject("object/tangible/terminal/terminal_console_command.iff", battlefieldOrigin);
    ...
    public int oldItemMenuHandler(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
    ...
    public int msgHandleWeatherSelection(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
    ...
    public int npcFinderHandler(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
    ...
    public int objectFinderHandler(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
    ...
    public int qaLootThem(obj_id self, dictionary params)
    {
    ...
    public int qaSaveData(obj_id self, dictionary params)
    {
    ...
    public int qaDestroyMob(obj_id self, dictionary params)
    {
        obj_id myMob = params.getObjId("myMob");
        obj_id testerInventoryId = params.getObjId("testerInventoryId");
        destroyObject(myMob);
    ...
    public int qaDestroyObject(obj_id self, dictionary params)
    {
        obj_id myMob = params.getObjId("object");
        destroyObject(myMob);
        return SCRIPT_CONTINUE;
    }
    public int cleanAllScriptVars(obj_id self, dictionary params)
    {
        cleanAllScriptVars(self);
        return SCRIPT_CONTINUE;
    }
    public int groundMobSearchOptions(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
    ...
    public int spaceMobSearchOptions(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
    ...
    public int toolMainMenu(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
    ...
    public int handleItemSearchOptions(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
    ...
    public int exportFile(obj_id self, dictionary params)
    {
        int btn = sui.getIntButtonPressed(params);
        if (btn == 0)
        {
    ...
    public int animateForceDestruction(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
    ...
    public int runLootLoggerIncrement(obj_id self, dictionary params)
    {
    ...
    public void cleanAllScriptVars(obj_id player)
    {
    ...
    public void parseThenWarpTester(obj_id self, String previousSelection)
    {
    ...
    public void initializeXpTool(obj_id self)
    {
    ...
    public void setXpTypesScriptVar(obj_id self, String[] varData)
    {
    ...
    public void spawnGroundMob(obj_id player, String stringIndex)
    {
    ...
    public String getCharacterScriptsPrompt(obj_id player)
    {
        String strScripts = "";
    ...
    public String[] filterCharacterScripts(obj_id player)
    {
        String strScripts = "";
    ...
    public void searchStaticLoot(obj_id self, String argumentString, String searchType)
    {
    ...
    public obj_id[] filterOIDsForMob(obj_id self, obj_id[] allOIDs)
    {
        if (allOIDs.length > -1)
        {
    ...
    public obj_id[] getMobList(obj_id self, location testerLoc, float range)
    {
    ...
    public String[] getMobMenu(obj_id self, obj_id[] allMobOIDs, String searchString)
    {
    ...
    public String parseArgumentRetrieveString(obj_id self, String argString)
    {
    ...
    public void mitigationToolFunction(obj_id self, obj_id lookAtTarget)
    {
    ...
    public void npcFinderFunction(obj_id self, StringTokenizer st)
    {
        if (isSpaceScene())
        {
            sendSystemMessageTestingOnly(self, "You have to be on the ground to use this tool.");
    ...
    public void targetDataToolFunction(obj_id self, StringTokenizer st)
    {
    ...
    public void lootLoggerTool(obj_id self, StringTokenizer st, String scriptString)
    {
        String myName = null;
        if (st.hasMoreTokens())
        {
    ...
    public int lootLoggerMain(obj_id self, int iteration, String creatureSpawned, String scriptString)
    {
        int returnInt = 0;
        if (iteration > 0)
        {
    ...
    public String[] retrieveMobileContents(obj_id self, String mobContentsByRow)
    {
    ...
    public boolean exportTextBagContents(obj_id self, obj_id myBag, String exportString, String mobContentsByRow)
    {
        if (isIdValid(myBag))
        {
    ...
    public void makeHelper(obj_id self, StringTokenizer st)
    {
        if (st.hasMoreTokens())
        {
            String argumentString = st.nextToken();
    ...
    public void toolWarpMenu(obj_id self)
    {
    ...
    public void objectFinderFunction(obj_id self, StringTokenizer st)
    {
        if (isSpaceScene())
        {
            sendSystemMessageTestingOnly(self, "You have to be on the ground to use this tool.");
    ...
    public void listObjectsFound(obj_id self, String attributeString, String searchType)
    {
    ...
    public String[] getObjMenu(obj_id self, obj_id[] allObjOIDs)
    {
    ...
    public boolean specTester(obj_id self, StringTokenizer st)
    {
        if (isSpaceScene())
        {
            sendSystemMessageTestingOnly(self, "You have to be on the ground to use this tool.");
    ...
    public boolean spawnItems(obj_id self, String searchString, String[][] arrayOfArrays, String datatableName)
    {
    ...
    public boolean attainCorrectFactionStatus(obj_id self, String factionStr)
    {
    ...
    public boolean attainCorrectFaction(obj_id self, String factionStr)
    {
        if (!factionStr.equals(""))
        {
    ...
    public String validateProfession(obj_id self, String professionStr, String[] roadmapList)
    {
    ...
    public boolean earnProfessionLevel(obj_id self)
    {
    ...
    public boolean mulipleStaticSpawn(obj_id self, String spawnString, String intNumber, boolean silent)
    {
    ...
    public void getAllSkillMods(obj_id self)
    {
    ...
    public void saveAllCurrentQuestData(obj_id self)
    {
        try
        {
            String allQuestData = "";
    ...
    public void emailSpamFunction(obj_id self, StringTokenizer st)
    {
        int spamAmount = 0;
        if (st.hasMoreTokens())
        {
    ...
    public void checkMobContents(obj_id self, obj_id mobile)
    {
    ...
    public void qaFishing(obj_id self, StringTokenizer st, String scriptString)
    {
        String myName = null;
    ...
    public void qaEnableCollectionClickBypass(obj_id self, StringTokenizer st, String scriptString)
    {
    ...
    public int qaSetScriptVar(obj_id self, StringTokenizer st)
    {
        if (st.hasMoreTokens())
        {
    ...
    public void qaExportBackpackContents(obj_id self)
    {
        obj_id testerInventoryId = utils.getInventoryContainer(self);
        obj_id[] testerInventoryContents = getContents(testerInventoryId);
        obj_id myBag = getObjectInSlot(self, "back");
    ...
    public int commandKill(obj_id self, obj_id target)
    {
    ...
    public int commandKillShip(obj_id self, obj_id target)
    {
        if (!isIdValid(self) || !isIdValid(target) || !exists(target))
        {
    ...
    public int commandKillMob(obj_id self, obj_id target)
    {
        if (!isIdValid(self) || !isIdValid(target) || !exists(target))
        {
            sendSystemMessageTestingOnly(self, "Kill command failed.");
    ...
    public obj_id qaGetTarget(obj_id self, String override)
    {
    ...
    public obj_id qaGetTarget(obj_id self)
    {
        obj_id target = qaGetTarget(self, null);
        return target;
    }
    public boolean createEnzyme(obj_id self, StringTokenizer st)
    {
        if (isSpaceScene())
        {
            sendSystemMessageTestingOnly(self, "You have to be on the ground to use this tool.");
    ...
    public boolean createLyase(obj_id self)
    {
        if (isSpaceScene())
        {
            sendSystemMessageTestingOnly(self, "You have to be on the ground to use this tool.");
    ...
    public int makeLyase(obj_id self, dictionary params)
    {
    ...
    public boolean clearHeroicTimer(obj_id self)
    {
    ...
    public boolean createIsomerase(obj_id self)
    {
        if (isSpaceScene())
        {
            sendSystemMessageTestingOnly(self, "You have to be on the ground to use this tool.");
    ...
    public int makeIso(obj_id self, dictionary params)
    {
        float quality = 90;
    ...
    public void qaTCGMenu(obj_id self)
    {
    ...
    public int handleTCGMenu(obj_id self, dictionary params)
    {
        if (!isGod(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public String[] tcgClusterInfo(String type)
    {
    ...
    public void qaTCGCardClusterInfo(obj_id self)
    {
    ...
    public void qaTCGBoosterClusterInfo(obj_id self)
    {
    ...
    public void qaTCGReinit(obj_id self)
    {
    ...
    public int handleTCGPromotionMenu(obj_id self, dictionary params)
    {
        if (!isGod(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleTCGPromotionItems(obj_id self, dictionary params)
    {
        qaTCGMenu(self);
        return SCRIPT_CONTINUE;
    }
