...
public class qaspace extends script.base_script
{
    ...
    public int runSpaceLootIteration(obj_id self, dictionary params)
    {
    ...
    public void spaceLoot(obj_id self, String victimName, int victimCount)
    {
    ...
    public void spaceLootIteration(obj_id self, String victimName, int victimCount)
    {
        if (victimCount < 1)
        {
            return;
