...
public class swyckoff_test_conversation extends script.base_script
{
    ...
    public boolean swyckoff_test_condition__defaultCondition(obj_id player, obj_id npc)
    {
        return true;
    }
    public boolean swyckoff_test_condition_false1(obj_id player, obj_id npc)
    {
        return false;
    }
    public boolean swyckoff_test_condition_false2(obj_id player, obj_id npc)
    {
        return false;
    }
    public int swyckoff_test_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int swyckoff_test_handleBranch2(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int swyckoff_test_handleBranch4(obj_id player, obj_id npc, string_id response)
    {
    ...
    public int swyckoff_test_handleBranch6(obj_id player, obj_id npc, string_id response)
    {
