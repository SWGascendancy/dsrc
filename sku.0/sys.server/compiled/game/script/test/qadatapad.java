...
public class qadatapad extends script.base_script
{
    ...
    public int handleWarpScriptOptions(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
    ...
    public void goWarpLocation(obj_id player, location selectedLocation)
    {
    ...
    public boolean createWaypoint(obj_id self, String planetArea, float locationX, float locationY, float locationZ, String waypointName)
    {
    ...
    public void testWaypointLocations(obj_id self)
    {
    ...
    public boolean deleteAllWaypoints(obj_id self)
    {
    ...
    public boolean addOnSelection(obj_id self, String previousSelection)
    {
