...
public class qa_cybernetic extends script.base_script
{
    ...
    public int handleChoice(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
    ...
    public int handleInstallOptions(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
            obj_id player = sui.getPlayerId(params);
    ...
    public int handleUninstallRepairChoice(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
            obj_id player = sui.getPlayerId(params);
    ...
    public void toolCyberMainMenu(obj_id player)
    {
    ...
    public void installChoiceMenu(obj_id player)
    {
    ...
    public void uninstallChoices(obj_id player, String[] list)
    {
    ...
    public void repairChoices(obj_id player, String[] list)
    {
    ...
    public void installCyber(obj_id player)
    {
    ...
    public void getAttachedCybers(obj_id player)
    {
    ...
    public void removeCyber(obj_id player, obj_id idxObj_id)
    {
        cybernetic.unInstallCyberneticItem(player, player, idxObj_id);
        qa.removePlayer(player, SCRIPTVAR, "");
    }
    public void repairCyber(obj_id player, obj_id idxObj_id)
    {
