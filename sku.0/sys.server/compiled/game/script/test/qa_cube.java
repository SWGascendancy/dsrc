...
public class qa_cube extends script.base_script
{
    ...
    public int handleChuGonOptions(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
    ...
    public void ChuGonMainMenu(obj_id player)
    {
    ...
    public void checkForCube(obj_id player)
    {
    ...
    public void spawnBaseItems(obj_id player, String itemToSpawnFor, int idx)
    {
        checkForCube(player);
