...
public class jwatson_sui_test extends script.base_script
{
    ...
    public void spawnSuiTargetInfo(obj_id player)
    {
    ...
    public int updateSuiTargetInfo(obj_id self, dictionary params)
    {
    ...
    public int suiTargetInfoCallbackClosedCancel(obj_id self, dictionary params)
    {
    ...
    public void spawnSuiTargetViewer(obj_id player)
    {
    ...
    public int updateSuiTargetViewer(obj_id self, dictionary params)
    {
        obj_id target = getLookAtTarget(self);
        if (target == null)
        {
    ...
    public int suiTargetViewerCallbackClosedCancel(obj_id self, dictionary params)
    {
