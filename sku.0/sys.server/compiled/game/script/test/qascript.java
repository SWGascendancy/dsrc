...
public class qascript extends script.base_script
{
    ...
    public int handleAttachScriptOptions(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
            if (utils.hasScriptVar(self, SCRIPTVAR + ".pid"))
    ...
    public int handleDetachScriptOptions(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
            if (utils.hasScriptVar(self, SCRIPTVAR + ".pid"))
    ...
    public void toolAttachMenu(obj_id player)
    {
    ...
    public void toolDetachMenu(obj_id player)
    {
    ...
    public String[] getCharacterScripts(obj_id player)
    {
        HashSet theSet = new HashSet();
        String[] scriptArray = filterCharacterScripts(player);
        if (scriptArray.length > -1)
    ...
    public String[] getAttachableCharacterScripts(obj_id player)
    {
        HashSet theSet = new HashSet();
    ...
    public boolean findAttached(obj_id player, String scriptAttached)
    {
    ...
    public void removePlayer(obj_id player, String err)
    {
