...
public class mitigation extends script.base_script
{
    ...
    public int handleAttackLocationOptions(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
    ...
    public int handleDamageOptions(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
            if (utils.hasScriptVar(self, PID_SCRIPTVAR + ".pid"))
    ...
    public int mitigationReport(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
            if (utils.hasScriptVar(self, PID_SCRIPTVAR + ".pid"))
