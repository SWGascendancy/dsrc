...
public class instance_test extends script.base_script
{
    ...
    public int cmdActivateInstance(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int handleSelectInstance(obj_id self, dictionary params)
    {
    ...
    public int handleSelectType(obj_id self, dictionary params)
    {
