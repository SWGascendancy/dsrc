...
public class dwhite_test extends script.base_script
{
    ...
    public int createCloneWarpSui(obj_id player)
    {
    ...
    public int handleCloneWarp(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public void testTune(int level)
    {
    ...
    public float round(float num, int decimal)
    {
