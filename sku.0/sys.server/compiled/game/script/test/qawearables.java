...
public class qawearables extends script.base_script
{
    ...
    public String[] populateArray(obj_id player, String datatableName, String choice, String column1, String column2, boolean filtered, boolean allFunction)
    {
    ...
    public String[] populateArray(obj_id player, String datatableName, String column)
    {
        String[] errorZeroLengthArray = 
        {
            "The Array was empty, could be that you passed the wrong type"
    ...
    public void constructSUI(obj_id player, String prompt, String title, String[] menuArray, String nextHandler, String scriptVarName, boolean backButton)
    {
        if (!backButton)
        {
    ...
    public int wearableTypeOptionSelect(obj_id self, dictionary params)
    {
    ...
    public int wearablesOptionSelect(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        if (isGod(player))
        {
    ...
    public int wearablesTemplateSelect(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        if (isGod(player))
        {
