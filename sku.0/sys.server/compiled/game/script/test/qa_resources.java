...
public class qa_resources extends script.base_script
{
    ...
    public int startingMenuOptions(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
    ...
    public int recycledMenuOptions(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
            if (utils.hasScriptVar(self, "resource.pid"))
    ...
    public int allRecycledMenuOptions(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
            if (utils.hasScriptVar(self, "resource.pid"))
    ...
    public int spaceResourceHandler(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
            if (utils.hasScriptVar(self, "resource.pid"))
    ...
    public void createResourceInInventory(obj_id player, String resourceTypeName)
    {
