...
public class qaham extends script.base_script
{
    ...
    public void restoreActionRegenRate(obj_id player)
    {
        if (!isIdValid(player))
        {
            return;
    ...
    public void stopActionRegenRate(obj_id player)
    {
        if (!isIdValid(player))
        {
            return;
    ...
    public void setActionRegenRate(obj_id player, float rate)
    {
        if (!isIdValid(player))
        {
            return;
    ...
    public void helpMessage(obj_id player)
    {
        if (!isIdValid(player))
        {
            return;
