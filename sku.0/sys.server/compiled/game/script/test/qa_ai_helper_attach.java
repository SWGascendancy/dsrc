...
public class qa_ai_helper_attach extends script.base_script
{
    ...
    public int OnObjectMenuRequest(obj_id self, obj_id tester, menu_info mi)
    {
    ...
    public int OnObjectMenuSelect(obj_id self, obj_id tester, int menu)
    {
        if (isGod(tester))
        {
    ...
    public int OnAiCombatFrame(obj_id self)
    {
        obj_id tester = utils.getObjIdScriptVar(self, "spawnedBy");
    ...
    public int handleMainMenuOptions(obj_id self, dictionary params)
    {
        obj_id tester = utils.getObjIdScriptVar(self, "spawnedBy");
        if (isGod(tester))
        {
    ...
    public int attackMenuOptions(obj_id self, dictionary params)
    {
        obj_id tester = utils.getObjIdScriptVar(self, "spawnedBy");
        if (isGod(tester))
        {
    ...
    public int programMenuOptions(obj_id self, dictionary params)
    {
        obj_id tester = utils.getObjIdScriptVar(self, "spawnedBy");
        if (isGod(tester))
        {
    ...
    public int animationMenuOptions(obj_id self, dictionary params)
    {
        obj_id tester = utils.getObjIdScriptVar(self, "spawnedBy");
        if (isGod(tester))
        {
    ...
    public int handleMoveToOptions(obj_id self, dictionary params)
    {
        obj_id tester = utils.getObjIdScriptVar(self, "spawnedBy");
        if (isGod(tester))
        {
    ...
    public int msgFlourishSelected(obj_id self, dictionary params)
    {
        obj_id tester = utils.getObjIdScriptVar(self, "spawnedBy");
        if (isGod(tester))
        {
    ...
    public int msgPostureSelected(obj_id self, dictionary params)
    {
        obj_id tester = utils.getObjIdScriptVar(self, "spawnedBy");
        if (isGod(tester))
        {
    ...
    public int msgExpressionSelected(obj_id self, dictionary params)
    {
        obj_id tester = utils.getObjIdScriptVar(self, "spawnedBy");
        if (isGod(tester))
        {
    ...
    public void removeScriptVarData(obj_id self, obj_id tester, String err)
    {
    ...
    public void startLazyMenuFunction(obj_id tester, obj_id self)
    {
        if (isGod(tester))
        {
            String creaturePrompt = getCreaturePrompt(self, tester);
    ...
    public void stopFollowingTester(obj_id self, obj_id tester)
    {
        revertRunSpeed(self);
    ...
    public void killHelper(obj_id self, obj_id tester)
    {
    ...
    public void attachNoDeathScript(obj_id self, obj_id tester)
    {
        if (hasScript(self, "player.yavin_e3"))
        {
    ...
    public void removeNoDeathScript(obj_id self, obj_id tester)
    {
        if (hasScript(self, "player.yavin_e3"))
        {
            detachScript(self, "player.yavin_e3");
    ...
    public void freezeMob(obj_id self, obj_id tester)
    {
        ai_lib.aiStopFollowing(self);
    ...
    public String getCreaturePrompt(obj_id creature, obj_id tester)
    {
    ...
    public boolean checkFaction(obj_id self, obj_id tester)
    {
    ...
    public void attackTester(obj_id self, obj_id tester)
    {
    ...
    public void toolMovementMenu(obj_id self, obj_id tester)
    {
    ...
    public void recordDamage(obj_id self, obj_id tester)
    {
    ...
    public void exportDamageData(obj_id self, obj_id tester)
    {
    ...
    public void callAttackSUI(obj_id self, obj_id tester)
    {
        String creaturePrompt = getCreaturePrompt(self, tester);
    ...
    public void callProgramOptions(obj_id self, obj_id tester)
    {
        String creaturePrompt = getCreaturePrompt(self, tester);
    ...
    public void dataStorageCapacityReached(obj_id self, obj_id tester)
    {
    ...
    public void storeCurrentHealth(obj_id self, obj_id tester)
    {
        giveFullHealth(self);
    ...
    public void giveFullHealth(obj_id recipient)
    {
        healShockWound(recipient, getShockWound(recipient));
        setAttrib(recipient, HEALTH, getMaxAttrib(recipient, HEALTH));
    }
    public int calculateActionCost(obj_id tester, int testerMaxAction)
    {
    ...
    public void setRegenRate(obj_id tester, float regenRate)
    {
        getActionRegenRate(tester, regenRate);
    }
    public void removeActionRegen(obj_id tester)
    {
    ...
    public void restoreActionRegenRate(obj_id tester)
    {
        float oldRegen = getFloatObjVar(tester, "QARegen");
        setRegenRate(tester, oldRegen);
        removeObjVar(tester, "QARegen");
    }
    public boolean getEntertainerSkills(obj_id self, obj_id tester)
    {
    ...
    public void startTheDancing(obj_id self, obj_id tester, String danceName)
    {
    ...
    public boolean displayAvailableDanceMenu(obj_id self, obj_id tester, boolean changeDance)
    {
        if (!isIdValid(self))
        {
            return false;
    ...
    public void createFlourishSUI(obj_id self, obj_id tester)
    {
    ...
    public void createDanceSUI(obj_id self, obj_id tester)
    {
    ...
    public void createAnimationSUI(obj_id self, obj_id tester)
    {
    ...
    public void createPostureSUI(obj_id self, obj_id tester)
    {
    ...
    public void createExpressionSUI(obj_id self, obj_id tester)
    {
