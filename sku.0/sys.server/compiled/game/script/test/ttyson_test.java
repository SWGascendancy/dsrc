...
public class ttyson_test extends script.base.remote_object_requester
{
    ...
    public int logLocationHeading(obj_id self, dictionary params)
    {
    ...
    public void enableLogLocationHeading(obj_id target)
    {
    ...
    public void giveNewbieEquipment(obj_id player)
    {
    ...
    public void giveNewbieSkills(obj_id player)
    {
