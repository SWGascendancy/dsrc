...
public class qa_dynamic extends script.base_script
{
    ...
    public int handleMainOptions(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
    ...
    public int handleLevelSelect(obj_id self, dictionary params)
    {
    ...
    public int handleDynamicSpawn(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
            obj_id player = sui.getPlayerId(params);
    ...
    public void columnNamesDisplay(obj_id player, String[] dataTableNames)
    {
    ...
    public void getColumnToDisplay(obj_id player)
    {
    ...
    public void createStatics(obj_id player, String spawnNameChoice)
    {
