...
public class test_sui extends script.base_script
{
    ...
    public void outputPageCallbackDictionary(obj_id self, dictionary params)
    {
    ...
    public int handleMsgBox(obj_id self, dictionary params)
    {
        debugServerConsoleMsg(self, "callback handleMsgBox: triggered!");
        outputPageCallbackDictionary(self, params);
        return SCRIPT_CONTINUE;
    }
    public int handleInputBox(obj_id self, dictionary params)
    {
        debugServerConsoleMsg(self, "callback handleInputBox: triggered!");
        outputPageCallbackDictionary(self, params);
        return SCRIPT_CONTINUE;
    }
    public int handleListBox(obj_id self, dictionary params)
    {
    ...
    public int handleBankTest(obj_id self, dictionary params)
    {
    ...
    public int testForceClose(obj_id self, dictionary params)
    {
