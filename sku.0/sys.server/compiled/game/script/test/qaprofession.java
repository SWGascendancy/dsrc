...
public class qaprofession extends script.base_script
{
    ...
    public int handleExportProfession(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
            if (utils.hasScriptVar(self, SCRIPTVAR + ".pid"))
    ...
    public int handleExportTrader(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
            if (utils.hasScriptVar(self, SCRIPTVAR + ".pid"))
    ...
    public int handleAbilitySelection(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
            if (utils.hasScriptVar(self, SCRIPTVAR + ".pid"))
    ...
    public int handleProfessionOptions(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
            if (utils.hasScriptVar(self, SCRIPTVAR + ".pid"))
    ...
    public int handleProfessionSkillNameList(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
            if (utils.hasScriptVar(self, SCRIPTVAR + ".pid"))
    ...
    public int handleProfessionDetails(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
            if (utils.hasScriptVar(self, SCRIPTVAR + ".pid"))
    ...
    public int handleTraderSelection(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
            if (utils.hasScriptVar(self, SCRIPTVAR + ".pid"))
    ...
    public void toolMainMenu(obj_id self)
    {
    ...
    public void removePlayer(obj_id self, String err)
    {
        sendSystemMessageTestingOnly(self, err);
        qa.removeScriptVars(self, SCRIPTVAR);
        utils.removeScriptVarTree(self, SCRIPTVAR);
    }
    public String[] buildProfessionSkillMenu(obj_id self, String professionCodeSelection)
    {
        String[] professionSkillCodes = getProfessionSkillCodes(self, professionCodeSelection);
        utils.setScriptVar(self, SCRIPTVAR + ".professionSkillCodes", professionSkillCodes);
    ...
    public String[] getProfessionSkillCodes(obj_id self, String strTemplate)
    {
    ...
    public String[] getProfessionSkillMenu(obj_id self, String[] arrayOfSkills)
    {
    ...
    public String[] getProfessionMenuStrings(obj_id self, String[] professionCodes)
    {
    ...
    public String[] getAbilityStrings(obj_id self, String[] abilityCodes)
    {
    ...
    public String getSkillXPCodeData(obj_id self, dictionary skillRow)
    {
    ...
    public String getSkillXPCodeData(obj_id self, dictionary skillRow, int skillLevel)
    {
    ...
    public String[] getSkillMods(obj_id self, dictionary skillRow)
    {
    ...
    public String getRoadMapString(obj_id self, String skillSelection)
    {
        String stringId = "";
    ...
    public String getRoadMapSpawnStrings(obj_id self, String skillSelection)
    {
        String roadmapData = "";
        int rowNum = dataTableSearchColumnForString(skillSelection, "roadmapSkillName", ROADMAP_TABLE);
        if (rowNum > -1)
    ...
    public String getAbilityData(obj_id self, String abilityCode)
    {
        String abilityData = "";
    ...
    public void saveDataToClient(obj_id self, String fileTitle, String stringData, String fileExtension)
    {
    ...
    public String[] getAllAbilityCodeStrings(obj_id self, String[] professionMenuCodeStrings)
    {
    ...
    public dictionary getEntireSkillRow(obj_id self, String skillSelection)
    {
    ...
    public String[] getAbilityCodes(obj_id self, dictionary skillRow)
    {
    ...
    public String[] combineAndSortAbilities(obj_id self, String[] allAbilityStrings, String[] allAbilityCodeStrings)
    {
    ...
    public String getSkillWithAbility(obj_id self, String abilitySelection)
    {
    ...
    public String getProfessionWithSkill(obj_id self, String skillCode)
    {
        if (!skillCode.equals(""))
        {
            int rowNum = -1;
    ...
    public String[] getProfessionTemplateNames(obj_id self, String[] professionMenuCodeStrings)
    {
        int professionMenuLength = professionMenuCodeStrings.length;
        if (professionMenuLength > 0)
        {
    ...
    public String getTemplateCodeString(obj_id self, String professionCodeSelection, String[] professionSkillCodes, String[] professionTemplateNames)
    {
        int arrayLength = professionSkillCodes.length;
    ...
    public String buildPrompt(obj_id self, String skillSelectionCode, String skillSelectionString, int skillLevel)
    {
        if (!skillSelectionCode.equals(""))
        {
            String professionStringSelection = utils.getStringScriptVar(self, SCRIPTVAR + ".professionStringSelection");
    ...
    public String prepareDataForExport(obj_id self, String professionCodeSelection)
    {
