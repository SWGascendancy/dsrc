...
public class qasetup extends script.base_script
{
    ...
    public void handleProfessionLevelToNinety(obj_id player, String roadmap)
    {
    ...
    public void revokeAllSkills(obj_id player)
    {
    ...
    public void setTemplate(obj_id player, String[] skillList, String baseClass)
    {
    ...
    public void issueAssaultArmorSet(obj_id player, String[] armorPieces, String modType, String specialModType)
    {
    ...
    public void issueBattleArmorSet(obj_id player, String[] armorPieces, String modType, String specialModType)
    {
        obj_id pInv = utils.getInventoryContainer(player);
        for (int j = 0; j < armorPieces.length; ++j)
        {
    ...
    public void issueReconArmorSet(obj_id player, String[] armorPieces, String modType, String specialModType)
    {
        obj_id pInv = utils.getInventoryContainer(player);
        for (int j = 0; j < armorPieces.length; ++j)
        {
    ...
    public void issueClothes(obj_id player, String[] clothesPieces, String modType, String specialModType)
    {
        obj_id pInv = utils.getInventoryContainer(player);
    ...
    public void attachMods(obj_id item, String template)
    {
    ...
    public void createPup(obj_id player, String mod, String[] pup_items, int r)
    {
        obj_id pInv = utils.getInventoryContainer(player);
    ...
    public void addEntBuff(obj_id recipientId)
    {
