...
public class jwatson_test extends script.base_script
{
    ...
    public void maxStats(obj_id objPlayer)
    {
    ...
    public boolean sendStartingLocations(obj_id player)
    {
    ...
    public int OnApplyPowerup(obj_id self, obj_id playerId, obj_id targetId)
    {
        chat.chat(playerId, "OnApplyPowerup " + self.toString() + " -> " + targetId.toString());
        return SCRIPT_CONTINUE;
    }
    public int OnGetAttributes(obj_id self, obj_id playerId, String[] names, String[] attribs)
    {
    ...
    public int TestSUICallback(obj_id self, dictionary params)
    {
    ...
    public int OnSpaceMiningSellResource(obj_id self, obj_id player, obj_id ship, obj_id station, obj_id resourceId, int amount)
    {
