...
public class esebesta_test extends script.base_script
{
    ...
    public void colorize(obj_id player, obj_id target, String customizationVar)
    {
    ...
    public void transfer(obj_id player, int from, int to, float conversionRatio)
    {
    ...
    public void keypad(obj_id player)
    {
    ...
    public int OnPermissionListModify(obj_id self, obj_id actor, String playerName, String list, String action)
    {
        if (isGod(self))
        {
    ...
    public int TestMessage(obj_id self, dictionary params)
    {
        debugSpeakMsg(self, "TestMessage messageHandler hit");
        return SCRIPT_CONTINUE;
    }
    public int ColorizeCallback(obj_id self, dictionary params)
    {
        return SCRIPT_CONTINUE;
    }
    public int TransferCallback(obj_id self, dictionary params)
    {
    ...
    public int KeypadCallback(obj_id self, dictionary params)
    {
    ...
    public int OnShipWasHit(obj_id self, obj_id attacker, int weaponIndex, boolean isMissile, int missileType, int componentSlot, boolean fromPlayerAutoTurret, float hitLocationX_o, float hitLocationY_o, float hitLocationZ_o)
    {
    ...
    public int OnFormCreateObject(obj_id self, String templateName, float xLoc, float yLoc, float zLoc, obj_id cell, String[] keys, String[] values)
    {
    ...
    public int OnFormEditObject(obj_id self, obj_id editObject, String[] keys, String[] values)
    {
    ...
    public int OnFormRequestEditObject(obj_id self, obj_id objectToEdit, String[] keys)
    {
    ...
    public int OnDroppedItemOntoShipComponent(obj_id self, int slot, obj_id droppedItem, obj_id dropper)
    {
    ...
    public int OnTryToEquipDroidControlDeviceInShip(obj_id self, obj_id actor, obj_id droidControlDevice)
    {
        associateDroidControlDeviceWithShip(self, droidControlDevice);
        return SCRIPT_CONTINUE;
    }
    public int OnCommitDroidProgramCommands(obj_id self, obj_id droidControlDevice, String[] commands, obj_id[] chipsToAdd, obj_id[] chipsToRemove)
    {
