...
public class qabackpack extends script.base_script
{
    ...
    public int OnContainerChildGainItem(obj_id self, obj_id item, obj_id source, obj_id transferer)
    {
        putInQaBackpack(item, self, source);
        return SCRIPT_CONTINUE;
    }
    public void putInQaBackpack(obj_id item, obj_id player, obj_id source)
    {
