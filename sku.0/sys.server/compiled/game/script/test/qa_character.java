...
public class qa_character extends script.base_script
{
    ...
    public void quickBuff(obj_id self)
    {
    ...
    public int handleSetProfession(obj_id self, dictionary params)
    {
    ...
    public void setTemplate(obj_id self, String[] skillList, String baseClass)
    {
    ...
    public int handleMod(obj_id self, dictionary params)
    {
