...
public class qange extends script.base_script
{
    ...
    public int handleGiveRespecItem(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
    ...
    public int handleDeletionQuestion(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
    ...
    public int handleDeletionResponse(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
            int bp = sui.getIntButtonPressed(params);
    ...
    public void spawnRespecItem(obj_id self, int combatLevel)
    {
        obj_id respecDevice = utils.getStaticItemInBankOrInventory(self, "item_respec_token_01_01");
    ...
    public void resetTester(obj_id self)
    {
