...
public class qaitem extends script.base_script
{
    ...
    public int handleEquipementOptions(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
            if (utils.hasScriptVar(self, SCRIPTVAR + ".pid"))
    ...
    public int handleCategorySelection(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
            if (utils.hasScriptVar(self, SCRIPTVAR + ".pid"))
    ...
    public int handleStaticItemSpawn(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
            if (utils.hasScriptVar(self, SCRIPTVAR + ".pid"))
    ...
    public int handleArmorOptions(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
            obj_id player = sui.getPlayerId(params);
    ...
    public int handleLevelOptions(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
            obj_id player = sui.getPlayerId(params);
    ...
    public int handleSpawnOptions(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
            obj_id player = sui.getPlayerId(params);
    ...
    public int handleMandalorianColorOptions(obj_id self, dictionary params)
    {
        if (isGod(self))
        {
            obj_id player = sui.getPlayerId(params);
    ...
    public void toolMainMenu(obj_id player)
    {
    ...
    public void getRoadmapItems(obj_id self, String previousSelection)
    {
    ...
    public String[] getProfessionList(obj_id self)
    {
    ...
    public void getEquipment(obj_id self, int searchInt)
    {
    ...
    public void rebuildTheSUI(obj_id self, String[] comboArray, String[] codeStrings)
    {
    ...
    public void buildTheSUI(obj_id self, dictionary[] allRows)
    {
    ...
    public dictionary[] searchForSpeciesArmor(obj_id self, dictionary[] allRows, String speciesSearch)
    {
        Vector foundRows = new Vector();
    ...
    public dictionary[] searchForProfessionArmorType(obj_id self, dictionary[] allRows, String armorType)
    {
        Vector foundRows = new Vector();
        String armorCodeString = "";
        for (int i = 0; i < allRows.length; i++)
    ...
    public String getSpeciesSearchString(obj_id self)
    {
    ...
    public dictionary[] getAllEquipmentOfProfession(obj_id self, dictionary[] allRows, String classTemplate)
    {
        Vector foundRows = new Vector();
    ...
    public dictionary[] getAllEquipmentOfType(obj_id self, int searchInt)
    {
        if (searchInt == 4)
        {
            searchInt = 2;
    ...
    public dictionary[] getAllEquipmentOfCombatLevelOrBelow(obj_id self, dictionary[] allRows, int combatLevel)
    {
        Vector foundRows = new Vector();
        int reqLevel = 0;
        for (int i = 0; i < allRows.length; i++)
    ...
    public dictionary[] getHighestTierItems(obj_id self, dictionary[] listOfItems)
    {
        Vector foundRows = new Vector();
        int getHighest = 0;
        int tempTier = 0;
    ...
    public String[] getAllStaticItemCategories(obj_id self)
    {
    ...
    public String[] getSelectedCategory(obj_id self, String searchString)
    {
    ...
    public void filterSelection(obj_id self, String searchString)
    {
    ...
    public void toolArmorMainMenu(obj_id player)
    {
        utils.setScriptVar(player, SCRIPTVAR + ".armorChoice", "main");
        qa.refreshMenu(player, "Select an Armor Class", "Armor Tool", ARMOR_CLASSES, "handleArmorOptions", SCRIPTVAR + ".armorType.pid", SCRIPTVAR + ".armorTypeMenu", sui.OK_CANCEL_REFRESH);
    }
    public void armorLevelMenu(obj_id player, String[] displayArray)
    {
    ...
    public void listArmorChoiceStats(obj_id player, String[] displayArray)
    {
    ...
    public void mandalorianColor(obj_id player)
    {
    ...
    public void getArmorList(obj_id player, int level)
    {
    ...
    public void listSelectedArmor(obj_id player, String[] ArmorArray, String armorType)
    {
    ...
    public void spawnItems(obj_id player, String idxString)
    {
        String armorChoice = utils.getStringScriptVar(player, SCRIPTVAR + ".armorChoice");
    ...
    public void getLevelsToDisplay(obj_id player, String armorChoice)
    {
