...
public class npe_instance_transfer_terminal extends script.base_script
{
    ...
    public void startTerminal(obj_id player, obj_id self)
    {
    ...
    public void inputPlayer(obj_id player)
    {
        obj_id self = getSelf();
    ...
    public int inputPlayerNameOk(obj_id self, dictionary params)
    {
    ...
    public void selectDestinationPlayer(obj_id player)
    {
        obj_id self = getSelf();
        closeOldWindowPid(player);
    ...
    public int selectDestinationPlayerOk(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public void displayMessage(obj_id player, String message)
    {
        obj_id self = getSelf();
        closeOldWindowPid(player);
    ...
    public int displayMessageOk(obj_id self, dictionary params)
    {
        return SCRIPT_CONTINUE;
    }
    ...
    public void closeOldWindowPid(obj_id player)
    {
