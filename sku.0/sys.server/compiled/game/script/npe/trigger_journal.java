...
public class trigger_journal extends script.base_script
{
    ...
    public int makeUiElementAnimate(obj_id self, dictionary params)
    {
    ...
    public int doDelayed3POMessage(obj_id self, dictionary params)
    {
    ...
    public int groupPopUp1(obj_id self, dictionary params)
    {
    ...
    public int groupPopUp2(obj_id self, dictionary params)
    {
    ...
    public int npeGammaTransfer(obj_id self, dictionary params)
    {
        int btn = sui.getIntButtonPressed(params);
        obj_id player = sui.getPlayerId(params);
    ...
    public int npeStationTransfer(obj_id self, dictionary params)
    {
        int btn = sui.getIntButtonPressed(params);
        obj_id player = sui.getPlayerId(params);
        location terminalLoc = utils.getLocationScriptVar(player, "npe.gamma_travel.term_loc");
