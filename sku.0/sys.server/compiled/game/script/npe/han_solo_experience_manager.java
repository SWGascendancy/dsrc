...
public class han_solo_experience_manager extends script.base_script
{
    ...
    public boolean containsPlayer(obj_id bldg)
    {
    ...
    public int checkForDestroy(obj_id self, dictionary params)
    {
    ...
    public int setupArea(obj_id self, dictionary params)
    {
    ...
    public int setuphan(obj_id self, dictionary params)
    {
        obj_id player = utils.getObjIdScriptVar(self, "npe.player");
    ...
    public int setuphuttwave1(obj_id self, dictionary params)
    {
        obj_id player = utils.getObjIdScriptVar(self, "npe.player");
    ...
    public int setuphanpath(obj_id self, dictionary params)
    {
        obj_id han1 = sequencer.getSequenceObject("han1");
        obj_id player = utils.getObjIdScriptVar(self, "npe.player");
    ...
    public int showJournal(obj_id self, dictionary params)
    {
        obj_id player = utils.getObjIdScriptVar(self, "npe.player");
        newbieTutorialHighlightUIElement(player, "/GroundHUD.Quest", 7.0f);
        return SCRIPT_CONTINUE;
    }
    public int showHelper(obj_id self, dictionary params)
    {
        obj_id player = utils.getObjIdScriptVar(self, "npe.player");
    ...
    public int makehuttwave1attack(obj_id self, dictionary params)
    {
    ...
    public int setuphuttwave2(obj_id self, dictionary params)
    {
        obj_id player = utils.getObjIdScriptVar(self, "npe.player");
    ...
    public int endEncounter(obj_id self, dictionary params)
    {
        obj_id player = utils.getObjIdScriptVar(self, "npe.player");
    ...
    public int huttMinionDied(obj_id self, dictionary params)
    {
    ...
    public int droidconverse1(obj_id self, dictionary params)
    {
        obj_id droid = sequencer.getSequenceObject("droid");
        attachScript(droid, "conversation.npe_tutorial_droid_1");
        return SCRIPT_CONTINUE;
    }
    public int conversed1(obj_id self, dictionary params)
    {
        obj_id droid = sequencer.getSequenceObject("droid");
    ...
    public int giveterminalquest(obj_id self, dictionary params)
    {
        obj_id player = utils.getObjIdScriptVar(self, "npe.player");
    ...
    public int allMinionsDead(obj_id self, dictionary params)
    {
        obj_id player = utils.getObjIdScriptVar(self, "npe.player");
        utils.removeScriptVar(self, "huttMinionsDead");
    ...
    public int checkmovement(obj_id self, dictionary params)
    {
        obj_id player = utils.getObjIdScriptVar(self, "npe.player");
    ...
    public int finishedtutorial(obj_id self, dictionary params)
    {
        obj_id player = utils.getObjIdScriptVar(self, "npe.player");
    ...
    public int setuptrigger(obj_id self, dictionary params)
    {
        obj_id triggerObj = sequencer.getSequenceObject("playerStart");
        messageTo(triggerObj, "setupTriggerVolume", null, 0, false);
        return SCRIPT_CONTINUE;
    }
    public int setupdroidconversation(obj_id self, dictionary params)
    {
    ...
    public int setupwalktrigger(obj_id self, dictionary params)
    {
    ...
    public int setupcabinet(obj_id self, dictionary params)
    {
    ...
    public int setupinv(obj_id self, dictionary params)
    {
        obj_id player = sequencer.getSequenceObject("player");
    ...
    public int setuppistol(obj_id self, dictionary params)
    {
        obj_id player = sequencer.getSequenceObject("player");
        utils.setScriptVar(player, "npe.pistolReady", true);
        return SCRIPT_CONTINUE;
    }
    public int setupterminal(obj_id self, dictionary params)
    {
    ...
    public int setupcrates(obj_id self, dictionary params)
    {
    ...
    public int crateDestroyed(obj_id self, dictionary params)
    {
        obj_id player = sequencer.getSequenceObject("player");
    ...
    public int terminalDestroyed(obj_id self, dictionary params)
    {
        obj_id hallwayCell = getCellId(self, "hall4");
