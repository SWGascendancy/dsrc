...
public class npe_drunk_sequence extends script.base_script
{
    ...
    public int getglass(obj_id self, dictionary params)
    {
    ...
    public int removeglass(obj_id self, dictionary params)
    {
    ...
    public int npeaddconvo(obj_id self, dictionary params)
    {
        attachScript(self, "conversation.npe_drunk");
        return SCRIPT_CONTINUE;
    }
    public int nperemoveconvo(obj_id self, dictionary params)
    {
