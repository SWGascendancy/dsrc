...
public class npe_npc_blurts extends script.base_script
{
    ...
    public string_id blurtChosenStatement(obj_id npc, obj_id player, String roomName, String npcName)
    {
        string_id message = randomizeChat(roomName, npcName);
        chat.chat(npc, player, message, chat.ChatFlag_targetOnly);
        return message;
    }
    public string_id randomizeChat(String roomName, String npcName)
    {
