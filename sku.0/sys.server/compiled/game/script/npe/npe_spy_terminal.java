...
public class npe_spy_terminal extends script.base_script
{
    ...
    public void playWarningAndSpawn(obj_id player, obj_id self, String toSpawn)
    {
    ...
    public void doWarning(obj_id self)
    {
    ...
    public int turnAlarmsOff(obj_id self, dictionary params)
    {
        obj_id building = getTopMostContainer(self);
        Vector alarms = utils.getResizeableObjIdArrayScriptVar(building, "objAlarms");
        for (int i = 0; i < alarms.size(); i++)
