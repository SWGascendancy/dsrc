...
public class npe_droid_trigger_volumes extends script.base_script
{
    ...
    public int OnCreatureDamaged(obj_id self, obj_id player, obj_id weapon, int[] damage)
    {
    ...
    public void playExplosionEffect(obj_id player, obj_id self, int damageAmount)
    {
    ...
    public int getRidOfMe(obj_id self, dictionary params)
    {
        destroyObject(self);
        return SCRIPT_CONTINUE;
    }
