...
public class millennium_falcon_manager extends script.base_script
{
    ...
    public obj_id containsPlayer(obj_id bldg)
    {
    ...
    public int playerTimeoutAdvanceToStation(obj_id self, dictionary params)
    {
    ...
    public int phaseTwo(obj_id self, dictionary params)
    {
    ...
    public int makehanconverse(obj_id self, dictionary params)
    {
        obj_id hanSolo = utils.getObjIdScriptVar(self, "objHanSolo");
        attachScript(hanSolo, "conversation.npe_han_solo_falcon");
        return SCRIPT_CONTINUE;
    }
    public int makehanconverse2(obj_id self, dictionary params)
    {
        obj_id hanSolo = utils.getObjIdScriptVar(self, "objHanSolo");
        attachScript(hanSolo, "conversation.npe_han_solo_falcon2");
        return SCRIPT_CONTINUE;
    }
    public int makejolkaconverse(obj_id self, dictionary params)
    {
        return SCRIPT_CONTINUE;
    }
    public int setupturretpath(obj_id self, dictionary params)
    {
        obj_id player = utils.getObjIdScriptVar(self, "npe.player");
        obj_id han = sequencer.getSequenceObject("hanTurret3");
        return SCRIPT_CONTINUE;
    }
    public int setupcockpitpath(obj_id self, dictionary params)
    {
        obj_id player = utils.getObjIdScriptVar(self, "npe.player");
        obj_id loc = sequencer.getSequenceObject("hanEnd");
        return SCRIPT_CONTINUE;
    }
    public int playerTalkedToHan(obj_id self, dictionary params)
    {
        obj_id hanSolo = utils.getObjIdScriptVar(self, "objHanSolo");
        obj_id player = utils.getObjIdScriptVar(self, "npe.player");
    ...
    public int playerTalkedToHan2(obj_id self, dictionary params)
    {
        obj_id hanSolo = utils.getObjIdScriptVar(self, "objHanSolo");
        obj_id player = utils.getObjIdScriptVar(self, "npe.player");
    ...
    public int cleanOutDungeon(obj_id self, dictionary params)
    {
        obj_id[] contents = getBuildingContents(self);
        if (contents != null)
        {
    ...
    public int spawnShips(obj_id self, dictionary params)
    {
    ...
    public int shipDied(obj_id self, dictionary params)
    {
    ...
    public int finishedturret(obj_id self, dictionary params)
    {
        obj_id player = utils.getObjIdScriptVar(self, "npe.player");
        utils.setScriptVar(player, "npe.finishedTurret", true);
        return SCRIPT_CONTINUE;
    }
    public int transitionSequence(obj_id self, dictionary params)
    {
        obj_id player = utils.getObjIdScriptVar(self, "npe.player");
        obj_id hanSolo = sequencer.getSequenceObject(self, "hanSolo");
        String stf = getStringObjVar(self, "strSequenceTable");
    ...
    public int hyperspaceFalcon(obj_id self, dictionary params)
    {
        obj_id player = utils.getObjIdScriptVar(self, "npe.player");
        if (checkGod(player))
        {
    ...
    public int movePlayerToStation(obj_id self, dictionary params)
    {
        obj_id player = utils.getObjIdScriptVar(self, "npe.player");
    ...
    public boolean checkGod(obj_id self)
    {
        if (isGod(self))
        {
    ...
    public int clearhate(obj_id self, dictionary params)
    {
