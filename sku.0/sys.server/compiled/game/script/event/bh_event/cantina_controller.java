...
public class cantina_controller extends script.base_script
{
    ...
    public int handleBosskEventInitiation(obj_id self, dictionary params)
    {
    ...
    public int startBosskEvent(obj_id self, dictionary params)
    {
    ...
    public int bosskEventEnd(obj_id self, dictionary params)
    {
        if (utils.hasScriptVar(self, "bhcelebs.beingDestroyed"))
        {
            return SCRIPT_CONTINUE;
