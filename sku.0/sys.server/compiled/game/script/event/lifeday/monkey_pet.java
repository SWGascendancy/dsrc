...
public class monkey_pet extends script.base_script
{
    ...
    public int animationOne(obj_id self, dictionary params)
    {
    ...
    public int animationTwo(obj_id self, dictionary params)
    {
        int idx = params.getInt("idx");
        obj_id monkey = params.getObjId("monkey");
        switch (idx)
    ...
    public int getMoving(obj_id self, dictionary params)
    {
