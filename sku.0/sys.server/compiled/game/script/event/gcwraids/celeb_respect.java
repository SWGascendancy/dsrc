...
public class celeb_respect extends script.base_script
{
    ...
    public int forceChokeThisGuy(obj_id self, dictionary params)
    {
    ...
    public int finishHim(obj_id self, dictionary params)
    {
        obj_id emoteSayer = params.getObjId("emoteSayer");
        faceTo(self, emoteSayer);
    ...
    private int getEmoteBeligerence(String emote)
    {
    ...
    private void playKnockdown(obj_id victim, obj_id attacker)
    {
