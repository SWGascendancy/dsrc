...
public class cheerleader extends script.base_script
{
    ...
    public int startCheerleaderEvent(obj_id self, dictionary params)
    {
    ...
    public int createShuttle(obj_id self, dictionary params)
    {
    ...
    public int landShuttle(obj_id self, dictionary params)
    {
    ...
    public int spawnEscortsAndCeleb(obj_id self, dictionary params)
    {
        int type = getIntObjVar(self, "event.gcwraids.cheerleader_type");
    ...
    public int walkForwardCeleb(obj_id self, dictionary params)
    {
    ...
    public int engageInJingoisticRhetoric(obj_id self, dictionary params)
    {
        obj_id celeb = getObjIdObjVar(self, "event.gcwraids.celeb");
    ...
    public int celebStartGivingQuests(obj_id self, dictionary params)
    {
        int type = getIntObjVar(self, "event.gcwraids.cheerleader_type");
        obj_id celeb = getObjIdObjVar(self, "event.gcwraids.celeb");
    ...
    public int everyoneWalkBack(obj_id self, dictionary params)
    {
        location here = getLocation(self);
        obj_id celeb = getObjIdObjVar(self, "event.gcwraids.celeb");
    ...
    public int endEvent(obj_id self, dictionary params)
    {
        int type = getIntObjVar(self, "event.gcwraids.cheerleader_type");
        obj_id shuttle = getObjIdObjVar(self, "event.gcwraids.shuttle");
        obj_id celeb = getObjIdObjVar(self, "event.gcwraids.celeb");
    ...
    public int cleanupShuttleAndStuff(obj_id self, dictionary params)
    {
    ...
    public int escortDied(obj_id self, dictionary params)
    {
