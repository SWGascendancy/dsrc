...
public class stolen_fighter extends script.base_script
{
    ...
    public int setCoreTemplate(obj_id self, dictionary params)
    {
    ...
    public int checkTimeLimit(obj_id self, dictionary params)
    {
    ...
    public int resetAmbushTimerTrigger(obj_id self, dictionary params)
    {
