...
public class spawner extends script.base_script
{
    ...
    public int startupValidateFighter(obj_id self, dictionary params)
    {
    ...
    public int fighterRequestsDeletion(obj_id self, dictionary params)
    {
        obj_id fighter = params.getObjId("fighter");
        messageTo(fighter, "goDie", null, 1, false);
        return SCRIPT_CONTINUE;
    }
    public int fighterDeletedTimeOut(obj_id self, dictionary params)
    {
        obj_id fighter = params.getObjId("fighter");
        if (exists(fighter))
        {
    ...
    public int fighterStillAlive(obj_id self, dictionary params)
    {
    ...
    public int spawnNextFighter(obj_id self, dictionary params)
    {
        location here = getLocation(self);
    ...
    public void setCurrentSpawnRect(obj_id self)
    {
        location here = getLocation(self);
        String type = getStringObjVar(self, "event.lost_squadron.type");
