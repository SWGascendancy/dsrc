...
public class generic_raid extends script.base_script
{
    ...
    public int startInvasion(obj_id self, dictionary params)
    {
        if (!hasObjVar(self, "auto_invasion.reference_number"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int launchWave(obj_id self, dictionary params)
    {
    ...
    public int invaderDied(obj_id self, dictionary params)
    {
    ...
    public int waveTimeLimitCheck(obj_id self, dictionary params)
    {
    ...
    public int endInvasion(obj_id self, dictionary params)
    {
        setObjVar(self, "auto_invasion.invasion_active", 0);
        obj_id spawn;
        for (int i = 1; i <= 20; i++)
    ...
    private void announceStatusToPlayers(obj_id self, String messageId)
    {
