...
public class sarlacc_furniture_terminal extends script.base_script
{
    ...
    public boolean setUpFirstTime(obj_id self)
    {
        if ((getTemplateName(self)).indexOf("mini_s01.iff") > 0)
        {
            return false;
    ...
    public int handleSarlaccEatSui(obj_id self, dictionary params)
    {
        if ((getTemplateName(self)).indexOf("mini_s01.iff") > 0)
        {
            return SCRIPT_CONTINUE;
    ...
    public int verifySarlaccEatSui(obj_id self, dictionary params)
    {
    ...
    public int growlAnimation(obj_id self, dictionary params)
    {
        if (!isValidId(self) || !exists(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int playBurp(obj_id self, dictionary params)
    {
        if (!isValidId(self) || !exists(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int playCute(obj_id self, dictionary params)
    {
        if (!isValidId(self) || !exists(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int checkTriggerVolume(obj_id self, dictionary params)
    {
        if (!isValidId(self) || !exists(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int removeRepeatAvoidanceScriptVar(obj_id self, dictionary params)
    {
        CustomerServiceLog("sarlacc_minigame: ", "Sarlacc - removeRepeatAvoidanceScriptVar removing lockout scriptvar");
        utils.removeScriptVar(self, house_pet.SARLACC_AVOID_REPEATED_UPDATES);
        return SCRIPT_CONTINUE;
    }
    public boolean updateSarlaccPet(obj_id sarlacc)
    {
    ...
    public boolean getEdibleContents(obj_id player, obj_id sarlacc)
    {
    ...
    public boolean eatJunkItem(obj_id self, obj_id player, obj_id item)
    {
    ...
    public boolean validateItemForSarlacc(obj_id player, obj_id item)
    {
    ...
    public String getSarlaccCollectionColumn(obj_id self)
    {
    ...
    public boolean getPlayerReward(obj_id owner, obj_id self)
    {
    ...
    public boolean checkPlayerInventoryForSarlaccFood(obj_id player)
    {
        if (!isValidId(player) || !exists(player))
        {
            return false;
    ...
    public boolean setSarlaccStarvingOrDead(obj_id sarlacc, int currentPhase)
    {
        if (!isValidId(sarlacc) || !exists(sarlacc))
        {
            return false;
    ...
    public void cleanupSui(obj_id player)
    {
    ...
    public boolean customerSvcLogVerbose(obj_id sarlacc, String msg)
    {
        if (!isValidId(sarlacc) || !exists(sarlacc))
        {
            return false;
    ...
    public String getListOfFoodItems(obj_id sarlacc)
    {
