...
public class sarlacc_mini_game extends script.base_script
{
    ...
    public int updateSarlaccPet(obj_id self, dictionary params)
    {
        if (!isValidId(self) || !exists(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public boolean getEdibleContents(obj_id player, obj_id controller, obj_id sarlacc)
    {
    ...
    public String getSarlaccCollectionColumn(obj_id controller)
    {
    ...
    public boolean getPlayerReward(obj_id owner, obj_id controller)
    {
