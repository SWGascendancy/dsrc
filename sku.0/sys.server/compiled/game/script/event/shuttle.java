...
public class shuttle extends script.base_script
{
    ...
    private int showUI(obj_id self, obj_id player)
    {
    ...
    public int handleUIdata(obj_id self, dictionary params)
    {
    ...
    public int storeLastDataObjVar(obj_id self, dictionary params)
    {
    ...
    public int continueCollectingData(obj_id self, dictionary params)
    {
        showUI(self, self);
        return SCRIPT_CONTINUE;
    }
    public int spawnShuttle(obj_id self, dictionary params)
    {
        int numSpawns = getIntObjVar(self, "event.shuttle.numSpawns");
    ...
    public int doFlyBy(obj_id self, dictionary params)
    {
        messageTo(getObjIdObjVar(self, "event.shuttle.shuttle"), "performFlyBy", null, 0, false);
        return SCRIPT_CONTINUE;
    }
    public int getRidOfOwner(obj_id self, dictionary params)
    {
