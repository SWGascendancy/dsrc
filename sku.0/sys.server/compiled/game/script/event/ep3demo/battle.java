...
public class battle extends script.base_script
{
    ...
    public static final String[] VICTIM11 = 
    {
        "som_volcano_three_hk77",
        "som_volcano_three_hk77",
        "som_volcano_three_hk77",
        "som_volcano_three_hk77",
        "som_volcano_three_hk77",
    ...
    public static final String[] AGGRESSOR11 = 
    {
        "som_volcano_three_forward_commander",
        "som_volcano_three_forward_commander"
    };
    public static final String[] VICTIM12 = 
    {
        "som_volcano_three_hk77",
        "som_volcano_three_hk77"
    };
    public static final String[] AGGRESSOR12 = 
    {
        "som_working_hand_of_doom",
        "som_working_hand_of_doom",
        "som_working_hand_of_doom",
        "som_working_hand_of_doom",
        "som_working_hand_of_doom",
        "som_working_hand_of_doom",
        "som_working_doom_bringer"
    };
    ...
    public int allowMoreBattles(obj_id self, dictionary params)
    {
        utils.removeScriptVar(self, "ep3demoSanityChecker");
        return SCRIPT_CONTINUE;
    }
    public void startBattle(obj_id self, int battleIndex)
    {
        ...
        if (battleIndex == 11)
        {
            setObjVar(battleSpawner, "ep3demo.aggressorTemplate", AGGRESSOR11);
            setObjVar(battleSpawner, "ep3demo.victimTemplate", VICTIM11);
            setObjVar(battleSpawner, "ep3demo.aggressorNumber", 4);
            setObjVar(battleSpawner, "ep3demo.victimNumber", 1);
        }
        if (battleIndex == 12)
        {
            setObjVar(battleSpawner, "ep3demo.aggressorTemplate", AGGRESSOR12);
            setObjVar(battleSpawner, "ep3demo.victimTemplate", VICTIM12);
            setObjVar(battleSpawner, "ep3demo.aggressorNumber", 4);
            setObjVar(battleSpawner, "ep3demo.victimNumber", 1);
        }
