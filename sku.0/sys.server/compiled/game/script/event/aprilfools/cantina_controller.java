...
public class cantina_controller extends script.base_script
{
    ...
    public int invasionTimerPing(obj_id self, dictionary params)
    {
        float rightNow = getGameTime();
    ...
    public void announceStatusToPlayers(obj_id self, String messageId)
    {
    ...
    public obj_id spawnNpc(obj_id self, String type, location startLocation, String role, float pointX, float pointZ, obj_id cell, dictionary params, boolean moveTo){
    ...
    public int startRobberyEvent(obj_id self, dictionary params)
    {
    ...
    public int robberyEventSegment1(obj_id self, dictionary params)
    {
    ...
    public int robberyEventSegment(obj_id self, dictionary params)
    {
    ...
    public int robberyEventCycle(obj_id self, dictionary params)
    {
        obj_id ewok1 = getObjIdObjVar(self, "aprilfools.ewok1");
    ...
    public int concludeRobberyEvent(obj_id self, dictionary params)
    {
        setObjVar(self, "aprilfools.invasion_active", 0);
        obj_id ewok2 = getObjIdObjVar(self, "aprilfools.ewok2");
        obj_id ewok3 = getObjIdObjVar(self, "aprilfools.ewok3");
    ...
    public int startBartenderEvent(obj_id self, dictionary params)
    {
        location loc = getLocation(self);
    ...
    public int moveAllExtrasToRandomLocation(obj_id self, dictionary params)
    {
        obj_id ewok2 = getObjIdObjVar(self, "aprilfools.ewok2");
        obj_id ewok3 = getObjIdObjVar(self, "aprilfools.ewok3");
        obj_id ewok4 = getObjIdObjVar(self, "aprilfools.ewok4");
    ...
    public int startBartenderEventSegments(obj_id self, dictionary params)
    {
        obj_id ewok1 = getObjIdObjVar(self, "aprilfools.ewok1");
    ...
    public int bartenderEventSegment(obj_id self, dictionary params)
    {
        int segment = params.getInt("segment");
    ...
    public int bartenderEventCycle(obj_id self, dictionary params)
    {
        obj_id ewok1 = getObjIdObjVar(self, "aprilfools.ewok1");
        int cycle = getIntObjVar(self, "aprilfools.robbery_cycle");
        if (!isIdValid(ewok1))
