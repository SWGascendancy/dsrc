...
public class cantina_actor extends script.base_script
{
    ...
    public int faceNorth(obj_id self, dictionary params)
    {
        setYaw(self, 90);
        return SCRIPT_CONTINUE;
    }
    public int faceSouth(obj_id self, dictionary params)
    {
        setYaw(self, -89);
        return SCRIPT_CONTINUE;
    }
    public int faceEast(obj_id self, dictionary params)
    {
        setYaw(self, 179);
        return SCRIPT_CONTINUE;
    }
    public int faceWest(obj_id self, dictionary params)
    {
        setYaw(self, 0);
        return SCRIPT_CONTINUE;
    }
    public int sayYourLine(obj_id self, dictionary params)
    {
    ...
    public int becomeVulnerable(obj_id self, dictionary params)
    {
        setInvulnerable(self, false);
        return SCRIPT_CONTINUE;
    }
    public int becomeInvulnerable(obj_id self, dictionary params)
    {
        setInvulnerable(self, true);
        return SCRIPT_CONTINUE;
    }
    public int moveToRandomLocation(obj_id self, dictionary params)
    {
    ...
    public int moveToMainActorPosition(obj_id self, dictionary params)
    {
    ...
    public int goDie(obj_id self, dictionary params)
    {
        destroyObject(self);
        return SCRIPT_CONTINUE;
    }
    public int runAwayAndPoof(obj_id self, dictionary params)
    {
        setInvulnerable(self, false);
