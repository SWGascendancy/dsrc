...
public class event_tool extends script.base_script
{
    ...
    public int handlerCommunityBadgeGrantedToPlayer(obj_id self, dictionary params)
    {
    ...
    public int eventVaderChoke(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int eventClearStates(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int eventBuff(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int eventBuffTarget(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id myTarget = getLookAtTarget(self);
    ...
    public int eventBuffArea(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (params == null || params.equals(""))
        {
    ...
    public int eventTefArea(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (params == null || params.equals(""))
        {
    ...
    public int eventTefTarget(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id myTarget = getLookAtTarget(self);
        if (!isIdValid(myTarget) || myTarget == self || !isPlayer(myTarget) || myTarget == null)
        {
    ...
    public int eventTefClear(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int grantBadgeArea(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (params == null || params.equals(""))
        {
    ...
    public int maxForcePower(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int eventDamage(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id myTarget = getLookAtTarget(self);
    ...
    public int eventMoveToMe(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id myTarget = getLookAtTarget(self);
    ...
    public int eventUndoMoveToMe(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int eventWeapon(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (params == null || params.equals(""))
        {
    ...
    public int eventStorePet(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id myTarget = getLookAtTarget(self);
    ...
    public int killTargetPlayer(obj_id self, dictionary params)
    {
    ...
    public int eventShuttleDrop(obj_id self, obj_id target, String params, float defaultTime)
    {
        return SCRIPT_CONTINUE;
    }
}
