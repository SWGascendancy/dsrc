...
public class emperor_statue extends script.base_script
{
    ...
    public int shuttleAdjust(obj_id self, dictionary params)
    {
    ...
    public int spawnDarkTroopers1(obj_id self, dictionary params)
    {
    ...
    public int spawnDarkTroopers2(obj_id self, dictionary params)
    {
        obj_id[] squad = new obj_id[4];
    ...
    public int spawnVader(obj_id self, dictionary params)
    {
    ...
    public int moveParade(obj_id self, dictionary params)
    {
    ...
    public int launchRandomTieFighterFlyBy(obj_id self, dictionary params)
    {
    ...
    public int vaderLeaving(obj_id self, dictionary params)
    {
    ...
    public int darth1(obj_id self, dictionary params)
    {
        obj_id vader = getObjIdObjVar(self, holiday.SPAWNER_PREFIX_OBJVAR + "vader");
        if (isIdValid(vader) || exists(vader))
        {
    ...
    public int darth2(obj_id self, dictionary params)
    {
        obj_id vader = getObjIdObjVar(self, holiday.SPAWNER_PREFIX_OBJVAR + "vader");
        if (isIdValid(vader) || exists(vader))
        {
    ...
    public int darth3(obj_id self, dictionary params)
    {
        obj_id vader = getObjIdObjVar(self, holiday.SPAWNER_PREFIX_OBJVAR + "vader");
        if (isIdValid(vader) || exists(vader))
        {
    ...
    public int darth4(obj_id self, dictionary params)
    {
        obj_id vader = getObjIdObjVar(self, holiday.SPAWNER_PREFIX_OBJVAR + "vader");
        if (isIdValid(vader) || exists(vader))
        {
    ...
    public int darth5(obj_id self, dictionary params)
    {
        obj_id vader = getObjIdObjVar(self, holiday.SPAWNER_PREFIX_OBJVAR + "vader");
        if (isIdValid(vader) || exists(vader))
        {
    ...
    public int darth6(obj_id self, dictionary params)
    {
    ...
    public boolean playTieFighterPair(obj_id self, obj_id playOnObject)
    {
    ...
    public boolean playTieFighterGroup(obj_id self, obj_id playOnObject)
    {
    ...
    public boolean createLambdaDropship(obj_id self, location loc)
    {
