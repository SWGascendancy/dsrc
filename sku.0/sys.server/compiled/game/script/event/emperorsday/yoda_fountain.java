...
public class yoda_fountain extends script.base_script
{
    ...
    public int npcTypeList(obj_id self, dictionary params)
    {
    ...
    public int prepareParade(obj_id self, dictionary params)
    {
    ...
    public int parade(obj_id self, dictionary params)
    {
    ...
    public int spawnLeia(obj_id self, dictionary params)
    {
    ...
    public int moveLeia(obj_id self, dictionary params)
    {
    ...
    public int spawnChewie(obj_id self, dictionary params)
    {
    ...
    public int moveChewie(obj_id self, dictionary params)
    {
    ...
    public int spawnHan(obj_id self, dictionary params)
    {
    ...
    public int moveHan(obj_id self, dictionary params)
    {
        CustomerServiceLog("holidayEvent", "yoda_fountain.moveChewie: Moving Chewie to his spot now.");
    ...
    public int startConversation(obj_id self, dictionary params)
    {
    ...
    public int leia1(obj_id self, dictionary params)
    {
        obj_id leia = getObjIdObjVar(self, holiday.SPAWNER_PREFIX_OBJVAR + "leia");
        if (!isIdValid(leia) || !exists(leia))
        {
    ...
    public int vendor2(obj_id self, dictionary params)
    {
        obj_id vendor = getObjIdObjVar(self, holiday.SPAWNER_PREFIX_OBJVAR + "vendor");
        if (!isIdValid(vendor) || !exists(vendor))
        {
    ...
    public int leia2(obj_id self, dictionary params)
    {
        obj_id leia = getObjIdObjVar(self, holiday.SPAWNER_PREFIX_OBJVAR + "leia");
        if (!isIdValid(leia) || !exists(leia))
        {
    ...
    public int leia3(obj_id self, dictionary params)
    {
        obj_id leia = getObjIdObjVar(self, holiday.SPAWNER_PREFIX_OBJVAR + "leia");
        if (!isIdValid(leia) || !exists(leia))
        {
    ...
    public int leia4(obj_id self, dictionary params)
    {
        obj_id leia = getObjIdObjVar(self, holiday.SPAWNER_PREFIX_OBJVAR + "leia");
        if (!isIdValid(leia) || !exists(leia))
        {
    ...
    public int leia5(obj_id self, dictionary params)
    {
        obj_id leia = getObjIdObjVar(self, holiday.SPAWNER_PREFIX_OBJVAR + "leia");
        if (!isIdValid(leia) || !exists(leia))
        {
    ...
    public int leia6(obj_id self, dictionary params)
    {
    ...
    public int hanAngry(obj_id self, dictionary params)
    {
    ...
    public int hanHappy(obj_id self, dictionary params)
    {
        obj_id han = getObjIdObjVar(self, holiday.SPAWNER_PREFIX_OBJVAR + "han");
        if (isIdValid(han) && exists(han))
        {
    ...
    public int vendor3(obj_id self, dictionary params)
    {
    ...
    public int waitingHalf(obj_id self, dictionary params)
    {
    ...
    public int vendorReplyAnnoyed(obj_id self, dictionary params)
    {
        obj_id vendor = getObjIdObjVar(self, holiday.SPAWNER_PREFIX_OBJVAR + "vendor");
        if (!isIdValid(vendor) || !exists(vendor))
        {
    ...
    public int waitingDone(obj_id self, dictionary params)
    {
    ...
    public int vendorReplyWaiting(obj_id self, dictionary params)
    {
        obj_id vendor = getObjIdObjVar(self, holiday.SPAWNER_PREFIX_OBJVAR + "vendor");
        if (!isIdValid(vendor) || !exists(vendor))
        {
    ...
    public int launchRandomNonFactionalFirework(obj_id self, dictionary params)
    {
    ...
    public int launchFactionalFirework(obj_id self, dictionary params)
    {
        location statue = getLocation(self);
        location here = (location)statue.clone();
        here.z = statue.z - 30;
    ...
    public int leiaLeaving(obj_id self, dictionary params)
    {
        if (utils.hasScriptVar(self, "soldier"))
        {
            Vector npc = utils.getResizeableObjIdArrayScriptVar(self, "soldier");
    ...
    public int finalMarch(obj_id self, dictionary params)
    {
    ...
    public int destroyParade(obj_id self, dictionary params)
    {
        obj_id vendor = getObjIdObjVar(self, holiday.SPAWNER_PREFIX_OBJVAR + "vendor");
        if (!isIdValid(vendor) || !exists(vendor))
        {
    ...
    public int normalMusic(obj_id self, dictionary params)
    {
        if (!utils.hasScriptVar(self, "musicObject"))
        {
    ...
    public int launchRandomRebelShipFlyBy(obj_id self, dictionary params)
    {
    ...
    public boolean playRebelFlyBy(obj_id self, obj_id playOnObject, int sequence)
    {
    ...
    public boolean createFalconDropship(obj_id fountain, location loc)
    {
        if (loc == null)
        {
            return false;
