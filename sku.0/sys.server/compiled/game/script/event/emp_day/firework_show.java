...
public class firework_show extends script.base_script
{
    ...
    public int fireworksTimerReset(obj_id self, dictionary params)
    {
        float rightNow = getGameTime();
        float nextShowTime = rightNow + 3600;
        setObjVar(self, "event.next_show_time", nextShowTime);
    ...
    public int fireworksTimerPing(obj_id self, dictionary params)
    {
    ...
    public int broadcastFireworkAnnouncement(obj_id self, dictionary params)
    {
    ...
    public int startHugeFireworkDisplay(obj_id self, dictionary params)
    {
        for (int i = 0; i < 150; i++)
        {
    ...
    public int launchRandomFirework(obj_id self, dictionary params)
    {
