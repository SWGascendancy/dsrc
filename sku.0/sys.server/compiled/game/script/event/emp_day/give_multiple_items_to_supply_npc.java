...
public class give_multiple_items_to_supply_npc extends script.base_script
{
    ...
    public boolean isOpposingFaction(obj_id player, int npcFaction) {
    ...
    public boolean isCrateItem(obj_id player, String itemName, int faction)
    {
    ...
    public boolean hasEmpireDayQuest(obj_id player, int faction)
    {
        if (!isValidId(player) || !exists(player))
        {
            return false;
    ...
    public String getEmpireDayCrateForQuestName(obj_id player, int faction)
    {
        if (!isValidId(player) || !exists(player))
        {
            return null;
    ...
    public String getEmpireDayQuestName(obj_id player, int faction)
    {
        if (!isValidId(player) || !exists(player))
        {
            return null;
    ...
    public boolean incrementCollection(obj_id npc, obj_id player, int faction)
    {
