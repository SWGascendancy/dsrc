...
public class invasion_target extends script.base_script
{
    ...
    public int launchEvent(obj_id self, dictionary params)
    {
    ...
    public int startNextWave(obj_id self, dictionary params)
    {
    ...
    public int spawnNextCreature(obj_id self, dictionary params)
    {
    ...
    public int playAreaBroadcast(obj_id self, dictionary params)
    {
    ...
    public int spawnKeyObject(obj_id self, dictionary params)
    {
