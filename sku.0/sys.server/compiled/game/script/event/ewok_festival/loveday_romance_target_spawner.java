...
public class loveday_romance_target_spawner extends script.base_script
{
    ...
    public int spawnRomanceTargetNpcs(obj_id self, dictionary params)
    {
    ...
    public void spawnRomanceTargets(String datatable, obj_id self, String planet, String spawnName)
    {
