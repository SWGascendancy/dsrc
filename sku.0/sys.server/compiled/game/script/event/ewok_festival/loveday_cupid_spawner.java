...
public class loveday_cupid_spawner extends script.base_script
{
    ...
    public int registerLovedayCupidSpawner(obj_id self, dictionary params)
    {
        registerCupidSpawner(self);
        return SCRIPT_CONTINUE;
    }
    public void registerCupidSpawner(obj_id self)
    {
    ...
    public int spawnHourlyCupidNPCs(obj_id self, dictionary params)
    {
        if (hasObjVar(self, holiday.LOVEDAY_CUPID_SPAWNER_CITY_VAR))
        {
    ...
    public int despawnHourlyCupidNPCs(obj_id self, dictionary params)
    {
        if (utils.hasScriptVar(self, "cupidSpawned"))
        {
