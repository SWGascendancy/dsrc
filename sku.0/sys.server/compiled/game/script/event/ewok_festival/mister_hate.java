...
public class mister_hate extends script.base_script
{
    ...
    public int handleFarlesFaceTo(obj_id self, dictionary params)
    {
    ...
    public int OnSawEmote(obj_id self, obj_id emoteSayer, String emoteSeen)
    {
    ...
    public void checkForTheLove(obj_id self, obj_id player, String text)
    {
    ...
    public int makeNpcStopCombat(obj_id self, dictionary params)
    {
