...
public class loveday_cupid_spawner_manager extends script.base_script
{
    ...
    public int initializeCupidSpawnerManager(obj_id self, dictionary params)
    {
        createHourlyAlarmClock(self, "triggerHourlyCupidNPCs", null, 0, 0);
        return SCRIPT_CONTINUE;
    }
    public int triggerHourlyCupidNPCs(obj_id self, dictionary params)
    {
        getLovedayCupidSpawnerIds(self);
        createHourlyAlarmClock(self, "triggerHourlyCupidNPCs", null, 0, 0);
        return SCRIPT_CONTINUE;
    }
    public void getLovedayCupidSpawnerIds(obj_id self)
    {
