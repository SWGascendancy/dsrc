...
public class holiday_controller extends script.base_script
{
    ...
    private void startHolidayEvent(obj_id speaker, String holidayName, String holidayRunning, int holidayStatus)
    {
    ...
    private void startHolidayEventForReals(obj_id speaker, String holidayName, String holidayRunning)
    {
        if (holidayRunning == null)
        {
            sendSystemMessageTestingOnly(speaker, "Server config is not marked as " + holidayName + " running");
    ...
    private void stopHolidayEvent(obj_id speaker, String holidayName, String holidayRunning, int holidayStatus)
    {
        if (holidayRunning.equals("true") || holidayRunning.equals("1"))
        {
    ...
    private void stopHolidayEventForReals(obj_id speaker, String holidayName)
    {
        sendSystemMessageTestingOnly(speaker, holidayName + " stopped.");
        stopUniverseWideEvent(holidayName);
    }
    public int halloweenServerStart(obj_id self, dictionary params)
    {
    ...
    public int lifedayServerStart(obj_id self, dictionary params)
    {
    ...
    public int lovedayServerStart(obj_id self, dictionary params)
    {
    ...
    public int empiredayServerStart(obj_id self, dictionary params)
    {
