...
public class cwdm_test extends script.base_script
{
    ...
    public int OnClusterWideDataResponse(obj_id self, String strManagerName, String strElementNameRegex, int requestID, String[] elementNameList, dictionary[] dictionaryList, int lockKey)
    {
    ...
    public int huyTestMessageTo(obj_id self, dictionary params)
    {
    ...
    public int huyTestMessageTo2(obj_id self, dictionary params)
    {
        int messageNumber = params.getInt("messageNumber");
        LOG("***HUY***", "huyTestMessageTo2 processing message with messageNumber=" + messageNumber);
        return SCRIPT_CONTINUE;
    }
    public int huyTestMessageTo3(obj_id self, dictionary params)
    {
        int count = params.getInt("count");
        sendSystemMessageTestingOnly(self, "huyTestMessageTo3 count=" + count);
        return SCRIPT_CONTINUE;
    }
    public int huyTestXP(obj_id self, dictionary params)
    {
        LOG("***HUY***", "in huyTestXP messageHandler");
        xp.grant(self, "combat_general", 10);
        return SCRIPT_CONTINUE;
    }
    public int huyTestPersistedMessageTo(obj_id self, dictionary params)
    {
        sendSystemMessageTestingOnly(self, "huyTestPersistedMessageTo() params is " + params.toString());
        return SCRIPT_CONTINUE;
    }
    public int huyTestPersistedMessageTo2(obj_id self, dictionary params)
    {
        sendSystemMessageTestingOnly(self, "huyTestPersistedMessageTo2() params is " + params.toString());
        return SCRIPT_CONTINUE;
    }
    public boolean initializeStarport(obj_id self, obj_id structure, String travel_point, int travel_cost, boolean civic)
    {
    ...
    public int huyRequestJediBountySuccess(obj_id self, dictionary params)
    {
        sendSystemMessageTestingOnly(self, "huyRequestJediBountySuccess() params is " + params.toString());
        return SCRIPT_CONTINUE;
    }
    public int huyRequestJediBountyFailure(obj_id self, dictionary params)
    {
        sendSystemMessageTestingOnly(self, "huyRequestJediBountyFailure() params is " + params.toString());
        return SCRIPT_CONTINUE;
    }
    public int huyTestSUIProgressBar(obj_id self, dictionary params)
    {
    ...
    public int progressBar(obj_id player)
    {
    ...
    public int ProgressBarCallback(obj_id self, dictionary params)
    {
        sendSystemMessageTestingOnly(self, "ProgressBarCallback");
        return SCRIPT_CONTINUE;
    }
    public int countdownTimerBar(obj_id player)
    {
    ...
    public int CountdownTimerBarCallback(obj_id self, dictionary params)
    {
    ...
    public int huyHourlyAlarmClock(obj_id self, dictionary params)
    {
        int now = params.getInt("gameTime");
        sendSystemMessageTestingOnly(self, "huyHourlyAlarmClock now=" + now);
        return SCRIPT_CONTINUE;
    }
    public int huyDailyAlarmClock(obj_id self, dictionary params)
    {
        int now = params.getInt("gameTime");
        sendSystemMessageTestingOnly(self, "huyDailyAlarmClock now=" + now);
        return SCRIPT_CONTINUE;
    }
    public int huyWeeklyAlarmClock(obj_id self, dictionary params)
    {
        int now = params.getInt("gameTime");
        sendSystemMessageTestingOnly(self, "huyWeeklyAlarmClock now=" + now);
        return SCRIPT_CONTINUE;
    }
    public int huyMonthlyAlarmClock(obj_id self, dictionary params)
    {
        int now = params.getInt("gameTime");
        sendSystemMessageTestingOnly(self, "huyMonthlyAlarmClock now=" + now);
        return SCRIPT_CONTINUE;
    }
    public int huyYearlyAlarmClock(obj_id self, dictionary params)
    {
        int now = params.getInt("gameTime");
        sendSystemMessageTestingOnly(self, "huyYearlyAlarmClock now=" + now);
        return SCRIPT_CONTINUE;
    }
    public int testSuiHandler(obj_id self, dictionary params)
    {
    ...
    public void testIntegerLongReferenceParam(int[] i, long[] l)
    {
        i[0] = i[0] + 1;
        l[0] = l[0] + 1L;
    }
