...
public class online_jedi_test extends script.base_script
{
    ...
    public int hnguyencrbtConfirmed(obj_id self, dictionary params)
    {
    ...
    public int hnguyencrbtFailed(obj_id self, dictionary params)
    {
        obj_id bhId = params.getObjId("hunter");
        obj_id jediId = params.getObjId("jedi");
        int bounties = params.getInt("bounties");
    ...
    public String getFactionString(int iTefFac)
    {
