...
public class saarlac_wheel extends script.gambling.base.wheel
{
    ...
    public int handleWheelSpinning(obj_id self, dictionary params)
    {
    ...
    public int handleBetPlaced(obj_id self, dictionary params)
    {
    ...
    public int handleBetVerified(obj_id self, dictionary params)
    {
    ...
    public int handleBetVerifiedFailed(obj_id self, dictionary params)
    {
    ...
    public int tableTransferSuccess(obj_id self, dictionary params)
    {
        LOG("LOG_CHANNEL", "saarlac_wheel::tableTransferSuccess");
        startWheelGame(self);
        return SCRIPT_CONTINUE;
    }
    public int tableTransferFailed(obj_id self, dictionary params)
    {
        LOG("LOG_CHANNEL", "saarlac_wheel::tableTransferFailed");
        sendTableMessage(self, SID_INSUFFICIENT_FUNDS_START, null);
        return SCRIPT_CONTINUE;
    }
    public int msgSetJabbaMinimum(obj_id self, dictionary params)
    {
    ...
    public int msgSetOasisMinimum(obj_id self, dictionary params)
    {
    ...
    public int msgSetSaarlacMinimum(obj_id self, dictionary params)
    {
    ...
    public String wheelRollToName(int roll)
    {
        int low_roll = 0;
    ...
    private int wheelRollToIndex(int roll)
    {
        int low_roll = 0;
        for (int i = 0; i < WHEEL_PROBABILITIES.length; i++)
        {
    ...
    private String wheelIndexToName(int idx)
    {
    ...
    private int wheelNameToIndex(String name)
    {
        if (name == null)
        {
            return -1;
    ...
    private boolean sendTableMessage(obj_id table, prose_package pp, obj_id ommit_player)
    {
        if (!isIdValid(table))
        {
            return false;
    ...
    private boolean sendTableMessage(obj_id table, prose_package pp)
    {
        return sendTableMessage(table, pp, null);
    }
    private boolean sendTableMessage(obj_id table, string_id message, obj_id ommit_player)
    {
        return sendTableMessage(table, prose.getPackage(message, table), ommit_player);
    }
    private int getJabbaPool(obj_id table)
    {
        if (!isIdValid(table))
        {
            return -1;
    ...
    private int getOasisPool(obj_id table)
    {
        if (!isIdValid(table))
        {
            return -1;
    ...
    private int getSaarlacPool(obj_id table)
    {
        if (!isIdValid(table))
        {
            return -1;
    ...
    private int adjustJabbaPool(obj_id table, int amt)
    {
        if (!isIdValid(table))
        {
            return -1;
    ...
    private int adjustOasisPool(obj_id table, int amt)
    {
        if (!isIdValid(table))
        {
            return -1;
    ...
    private int adjustSaarlacPool(obj_id table, int amt)
    {
        if (!isIdValid(table))
        {
            return -1;
    ...
    private boolean resetJabbaPool(obj_id table)
    {
        if (!isIdValid(table))
        {
            return false;
    ...
    private boolean resetOasisPool(obj_id table)
    {
        if (!isIdValid(table))
        {
            return false;
    ...
    private boolean resetSaarlacPool(obj_id table)
    {
        if (!isIdValid(table))
        {
            return false;
    ...
    private int getTotalBetAmount(obj_id table)
    {
        if (!isIdValid(table))
        {
            return -1;
    ...
    private boolean hasBetBeenPlaced(obj_id table, int wheel_index)
    {
        if (!isIdValid(table))
        {
            return false;
    ...
    private String[] getPlayerBets(obj_id table, int player_index)
    {
    ...
    private Vector getPlayerBetIndices(obj_id table, int player_index)
    {
    ...
    private int validateBet(obj_id table, int wheel_index, int amt, obj_id player)
    {
        String wheel_name = wheelIndexToName(wheel_index);
        if (wheel_name == null)
        {
    ...
    private boolean completeBet(obj_id table, int bet_index, int amt, obj_id player)
    {
    ...
    private boolean resolveSpin(obj_id table, int wheel_index)
    {
        if (!isIdValid(table))
        {
            return false;
    ...
    private boolean setBet(obj_id table, int bet_index, int player_index, int amt)
    {
        if (!isIdValid(table))
        {
            return false;
    ...
    private boolean removeBet(obj_id table, int bet_index, int player_index)
    {
        if (!isIdValid(table))
        {
            return false;
    ...
    private boolean payBet(obj_id table, int bet_index, obj_id player)
    {
        if (!isIdValid(table))
        {
            return false;
    ...
    private boolean payPoolBet(obj_id table, int bet_index, obj_id player)
    {
        if (!isIdValid(table))
        {
            return false;
    ...
    private boolean loseBet(obj_id table, int bet_index, obj_id player)
    {
    ...
    private boolean pushBet(obj_id table, int bet_index, obj_id player)
    {
        if (!isIdValid(table))
        {
            return false;
    ...
    public void showBetUi(obj_id self, obj_id player)
    {
    ...
    public void startWheelGame(obj_id self)
    {
    ...
    public void stopWheelGame(obj_id self)
    {
        obj_id structure = player_structure.getStructure(self);
