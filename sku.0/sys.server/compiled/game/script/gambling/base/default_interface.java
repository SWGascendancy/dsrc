...
public class default_interface extends script.terminal.base.base_terminal
{
    ...
    public int cmdJoinGame(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isIdValid(target))
        {
            return SCRIPT_CONTINUE;
    ...
    public int cmdLeaveGame(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isIdValid(target))
        {
            return SCRIPT_CONTINUE;
    ...
    public int cmdPlaceBet(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isIdValid(target))
        {
            return SCRIPT_CONTINUE;
    ...
    public int cmdBetFailed(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isIdValid(target))
        {
            return SCRIPT_CONTINUE;
