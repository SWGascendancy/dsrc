...
public class slot extends script.gambling.base.default_interface
{
    ...
    public int handleSlotUi(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleReelsSpinning(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleParseResults(obj_id self, dictionary params)
    {
        int slotBalance = getBankBalance(self);
        transferBankCreditsToNamedAccount(self, money.ACCT_SLOT_STANDARD, slotBalance, "noHandler", "noHandler", new dictionary());
        if (params == null || params.isEmpty())
    ...
    public int handleGamblingPayout(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleDelayedRestart(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    private void startSlotGame(obj_id self, obj_id player)
    {
    ...
    private void showSlotUi(obj_id self, obj_id player)
    {
        if (!isIdValid(self) || !isIdValid(player))
        {
            return;
    ...
    private void spinReels(obj_id self, obj_id player, int amt)
    {
    ...
    private void showPayoutSchedule(obj_id self, obj_id player)
    {
        String gameType = getStringObjVar(self, gambling.VAR_TABLE_TYPE);
        if (gameType == null || gameType.equals(""))
        {
