...
public class quest_armorsmith extends script.base_script
{
    ...
    public int OnNpcConversationResponse(obj_id self, String convoName, obj_id speaker, string_id response)
    {
        string_id[] valid_responses = new string_id[0];
        prose_package[] prose_responses = new prose_package[0];
        int stage = getArmorsmithQuestStage(speaker);
    ...
    public int armorsmithQuestPayment(obj_id self, dictionary params)
    {
    ...
    public int getArmorsmithQuestStage(obj_id player)
    {
        if (!isIdValid(player))
        {
            return -1;
    ...
    public String getArmorsmithQuestItem(int stage)
    {
        if (stage < 0)
        {
            return null;
    ...
    public String getArmorsmithQuestItemName(int stage)
    {
        if (stage < 0)
        {
            return null;
    ...
    public obj_id verifyQuestItem(obj_id player)
    {
        if (!isIdValid(player))
        {
            return null;
    ...
    public void bootSchematicConversion(obj_id speaker)
    {
