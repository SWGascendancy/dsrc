...
public class quest_player extends script.base_script
{
    ...
    public int finishStaticQuest(obj_id self, dictionary params)
    {
        String datatable = getStringObjVar(self, "quest_table");
        String questID = dataTableGetString(datatable, 1, "temp_objvar");
        int questNum = getIntObjVar(self, questID + ".questNum");
    ...
    public int finishStaticGoQuest(obj_id self, dictionary params)
    {
        String datatable = getStringObjVar(self, "quest_table");
        String questID = dataTableGetString(datatable, 1, "temp_objvar");
        obj_id waypoint = getObjIdObjVar(self, questID + ".waypoint");
    ...
    private void spawnExtraNpc(obj_id self, int questNum, location spawnLoc, String datatable, int index){
    ...
    public int removeQuestInfo(obj_id self, dictionary params)
    {
