...
public class quest_convo extends script.base_script
{
    ...
    public int handleStaticQuestNpcAttach(obj_id self, dictionary params)
    {
    ...
    public boolean checkForGatingItem(obj_id inv, obj_id player, int questNum, String datatable)
    {
