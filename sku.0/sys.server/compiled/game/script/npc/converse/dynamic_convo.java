...
public class dynamic_convo extends script.base_script
{
    ...
    public void executeAction(dictionary entry, obj_id player, obj_id npc)
    {
    ...
    public void startNewConvoBranch(obj_id npc, obj_id player, String dialogEntry)
    {
    ...
    public string_id getResponseEntry(obj_id npc, String responseEntry)
    {
        String datatable = getStringObjVar(npc, "convo_table");
        datatable = "datatables/convo/" + datatable + ".iff";
        String[] convoEntry = dataTableGetStringColumn(datatable, "convoEntry");
    ...
    public boolean isGated(dictionary entry, obj_id player)
    {
        boolean gated = false;
    ...
    public int getPvpFactionId(String pvpFaction)
    {
    ...
    public boolean hasItem(obj_id player, String template, boolean destroyItem)
    {
