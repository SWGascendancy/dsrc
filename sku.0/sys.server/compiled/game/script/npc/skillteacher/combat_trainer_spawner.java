...
public class combat_trainer_spawner extends script.base_script
{
    ...
    public void spawnMarksman(obj_id self)
    {
    ...
    public void spawnScout(obj_id self)
    {
    ...
    public void spawnBrawler(obj_id self)
    {
    ...
    public void spawnDeliverMission(obj_id self)
    {
        obj_id room = getCellId(self, "meetingd");
    ...
    public void spawnDestroyMission(obj_id self)
    {
        obj_id room = getCellId(self, "meetinge");
    ...
    public int scoutDied(obj_id self, dictionary params)
    {
        spawnScout(self);
        return SCRIPT_CONTINUE;
    }
    public int dealerDied(obj_id self, dictionary params)
    {
        spawnJunkdealer(self);
        return SCRIPT_CONTINUE;
    }
    public int marksmanDied(obj_id self, dictionary params)
    {
        spawnMarksman(self);
        return SCRIPT_CONTINUE;
    }
    public int brawlerDied(obj_id self, dictionary params)
    {
        spawnBrawler(self);
        return SCRIPT_CONTINUE;
    }
    public int delivererDied(obj_id self, dictionary params)
    {
        spawnDeliverMission(self);
        return SCRIPT_CONTINUE;
    }
    public int destroyerDied(obj_id self, dictionary params)
    {
        spawnDestroyMission(self);
        return SCRIPT_CONTINUE;
    }
