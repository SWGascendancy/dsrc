...
public class commerce_trainer_spawner extends script.base_script
{
    ...
    public void spawnArtisan(obj_id self)
    {
    ...
    public void spawnSurveyMission(obj_id self)
    {
        obj_id room = getCellId(self, "meetingd");
    ...
    public void spawnFoodStation(obj_id self)
    {
    ...
    public void spawnCraftingContractor(obj_id self)
    {
    ...
    public int artisanDied(obj_id self, dictionary params)
    {
        spawnArtisan(self);
        return SCRIPT_CONTINUE;
    }
    public int surveyorDied(obj_id self, dictionary params)
    {
        spawnSurveyMission(self);
        return SCRIPT_CONTINUE;
    }
    public int foodStationDied(obj_id self, dictionary params)
    {
        spawnFoodStation(self);
        return SCRIPT_CONTINUE;
    }
    ...
    public int contractorDied(obj_id self, dictionary params)
    {
        spawnCraftingContractor(self);
        return SCRIPT_CONTINUE;
    }
