...
public class skillteacher extends script.base_script
{
    ...
    public int OnNpcConversationResponse(obj_id self, String convoName, obj_id speaker, string_id sid_response)
    {
    ...
    public boolean completeSkillPurchase(obj_id player, String skillName)
    {
        if (!isIdValid(player) || (!isPlayer(player)))
        {
            return false;
    ...
    public String[] getSkillData(String skillName, obj_id player)
    {
        if (skillName.equals(""))
        {
            return null;
    ...
    public boolean checkSkillStatus(obj_id trainer, obj_id player)
    {
    ...
    public boolean hasSurpassedTrainer(obj_id trainer, obj_id player)
    {
    ...
    public String getJediConvoFile(obj_id player)
    {
