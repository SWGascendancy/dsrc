...
public class hospital_trainer_spawner extends script.base_script
{
    ...
    public void spawnCombatMedic(obj_id self)
    {
    ...
    public void spawnMedic(obj_id self)
    {
        obj_id room = getCellId(self, "rooma");
    ...
    public void spawnDoctor(obj_id self)
    {
        if (utils.checkConfigFlag("ScriptFlags", "noEliteTrainers"))
        {
            return;
    ...
    public void spawnCombatMedic2(obj_id self)
    {
        if (utils.checkConfigFlag("ScriptFlags", "noEliteTrainers"))
        {
            return;
    ...
    public void spawnMedic2(obj_id self)
    {
        obj_id room = getCellId(self, "roomb");
    ...
    public void spawnDoctor2(obj_id self)
    {
        if (utils.checkConfigFlag("ScriptFlags", "noEliteTrainers"))
        {
            return;
    ...
    public int combatmedicDied(obj_id self, dictionary params)
    {
        spawnCombatMedic(self);
        return SCRIPT_CONTINUE;
    }
    public int medicDied(obj_id self, dictionary params)
    {
        spawnMedic(self);
        return SCRIPT_CONTINUE;
    }
    public int doctorDied(obj_id self, dictionary params)
    {
        spawnDoctor(self);
        return SCRIPT_CONTINUE;
    }
    public int combatmedic2Died(obj_id self, dictionary params)
    {
        spawnCombatMedic2(self);
        return SCRIPT_CONTINUE;
    }
    public int medic2Died(obj_id self, dictionary params)
    {
        spawnMedic2(self);
        return SCRIPT_CONTINUE;
    }
    public int doctor2Died(obj_id self, dictionary params)
    {
        spawnDoctor2(self);
        return SCRIPT_CONTINUE;
    }
