...
public class university_trainer_spawner extends script.base_script
{
    ...
    public void spawnMerchant(obj_id self)
    {
    ...
    public void spawnArchitect(obj_id self)
    {
        if (utils.checkConfigFlag("ScriptFlags", "noEliteTrainers"))
        {
            return;
    ...
    public void spawnWeaponsmith(obj_id self)
    {
        if (utils.checkConfigFlag("ScriptFlags", "noEliteTrainers"))
        {
            return;
    ...
    public void spawnDroidEngineer(obj_id self)
    {
        if (utils.checkConfigFlag("ScriptFlags", "noEliteTrainers"))
        {
            return;
    ...
    public void spawnArmorsmith(obj_id self)
    {
        if (utils.checkConfigFlag("ScriptFlags", "noEliteTrainers"))
        {
            return;
    ...
    public void spawnWeaponStation(obj_id self)
    {
        obj_id room = getCellId(self, "meetingd");
    ...
    public void spawnDroidStation(obj_id self)
    {
        obj_id room = getCellId(self, "meetinge");
    ...
    public void spawnClothingStation(obj_id self)
    {
        obj_id room = getCellId(self, "meetingb");
    ...
    public void spawnStructureStation(obj_id self)
    {
        obj_id room = getCellId(self, "meetingc");
    ...
    public int spawnThings(obj_id self, dictionary params)
    {
        spawnEveryone(self);
        return SCRIPT_CONTINUE;
    }
    public int merchantDied(obj_id self, dictionary params)
    {
        spawnMerchant(self);
        return SCRIPT_CONTINUE;
    }
    public int architectDied(obj_id self, dictionary params)
    {
        spawnArchitect(self);
        return SCRIPT_CONTINUE;
    }
    public int weaponsmithDied(obj_id self, dictionary params)
    {
        spawnWeaponsmith(self);
        return SCRIPT_CONTINUE;
    }
    public int engineerDied(obj_id self, dictionary params)
    {
        spawnDroidEngineer(self);
        return SCRIPT_CONTINUE;
    }
    public int armorsmithDied(obj_id self, dictionary params)
    {
        spawnArmorsmith(self);
        return SCRIPT_CONTINUE;
    }
    public int weaponStationDied(obj_id self, dictionary params)
    {
        spawnWeaponStation(self);
        return SCRIPT_CONTINUE;
    }
    public int droidStationDied(obj_id self, dictionary params)
    {
        spawnDroidStation(self);
        return SCRIPT_CONTINUE;
    }
    public int clothingStationDied(obj_id self, dictionary params)
    {
        spawnClothingStation(self);
        return SCRIPT_CONTINUE;
    }
    public int structureStationDied(obj_id self, dictionary params)
    {
        spawnStructureStation(self);
        return SCRIPT_CONTINUE;
    }
