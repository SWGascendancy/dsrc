...
public class theater_trainer_spawner extends script.base_script
{
    ...
    public void spawnStorytellerVendor(obj_id self)
    {
    ...
    public void spawnDanceMission(obj_id self)
    {
    ...
    public void spawnMusicMission(obj_id self)
    {
    ...
    public void spawnEntertainer(obj_id self)
    {
    ...
    public void spawnDancer(obj_id self)
    {
    ...
    public void spawnMusician(obj_id self)
    {
        if (utils.checkConfigFlag("ScriptFlags", "noEliteTrainers"))
        {
            return;
    ...
    public void spawnImageDesigner(obj_id self)
    {
        if (utils.checkConfigFlag("ScriptFlags", "noEliteTrainers"))
        {
            return;
    ...
    public void spawnTheaterManager(obj_id self)
    {
        obj_id greenroom = getCellId(self, "backstage");
    ...
    public void spawnChoreographer(obj_id self)
    {
        if (utils.checkConfigFlag("ScriptFlags", "noEliteTrainers"))
        {
            return;
    ...
    public int entertainerDied(obj_id self, dictionary params)
    {
        spawnEntertainer(self);
        return SCRIPT_CONTINUE;
    }
    public int danceDied(obj_id self, dictionary params)
    {
        spawnDancer(self);
        return SCRIPT_CONTINUE;
    }
    public int musicianDied(obj_id self, dictionary params)
    {
        spawnMusician(self);
        return SCRIPT_CONTINUE;
    }
    public int imagedesignerDied(obj_id self, dictionary params)
    {
        spawnImageDesigner(self);
        return SCRIPT_CONTINUE;
    }
    public int managerDied(obj_id self, dictionary params)
    {
        spawnTheaterManager(self);
        return SCRIPT_CONTINUE;
    }
    public int choreographerDied(obj_id self, dictionary params)
    {
        spawnChoreographer(self);
        return SCRIPT_CONTINUE;
    }
    public int storytellerVendorDied(obj_id self, dictionary params)
    {
        spawnStorytellerVendor(self);
        return SCRIPT_CONTINUE;
    }
