...
public class base extends script.base_script
{
    ...
    public int OnNpcConversationResponse(obj_id self, String convo, obj_id speaker, string_id sid_response)
    {
    ...
    public int handleTick(obj_id self, dictionary params)
    {
    ...
    public int handleListen(obj_id self, dictionary params)
    {
        if (!hasScript(self, SCRIPT_LISTEN))
        {
            attachScript(self, SCRIPT_LISTEN);
    ...
    public int handleNewRumor(obj_id self, dictionary params)
    {
    ...
    public int handlePlayAnimation(obj_id self, dictionary params)
    {
    ...
    public void playBarAnimation(obj_id self)
    {
        if (!isIdValid(self))
        {
            return;
    ...
    public boolean bartenderMove(obj_id self)
    {
        if (!isIdValid(self))
        {
            return false;
    ...
    public void updateDestination(obj_id self)
    {
        cleanDestinations(self);
        bartenderMove(self);
    }
    public void cleanDestinations(obj_id self)
    {
    ...
    public int showBuySui(obj_id target)
    {
        obj_id self = getSelf();
    ...
    public int handleBuySui(obj_id self, dictionary params)
    {
    ...
    public int handlePayReturn(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleDestroyObject(obj_id self, dictionary params)
    {
