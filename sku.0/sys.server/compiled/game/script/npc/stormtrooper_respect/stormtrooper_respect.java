...
public class stormtrooper_respect extends script.base_script
{
    ...
    public int getEmoteBeligerence(String emote)
    {
    ...
    public prose_package getTroopQuip(obj_id target, int quipRow)
    {
    ...
    public void playKnockdown(obj_id victim, obj_id attacker)
    {
    ...
    public int getImpRank(obj_id object)
    {
        int final_rank = 0;
    ...
    public void returnToDuties(obj_id troop)
    {
    ...
    public void paySTFines(obj_id payer, obj_id payee, int amount, int Quip)
    {
    ...
    public int handleFine(obj_id self, dictionary params)
    {
    ...
    public int stFilterHandler(obj_id self, dictionary params)
    {
    ...
    public int OnSawEmote(obj_id self, obj_id emoteSayer, String emotein)
    {
        int fine_debt = 0;
    ...
    public int OnHearSpeech(obj_id self, obj_id speaker, String speech)
    {
