...
public class faction_recruiter extends script.base_script
{
    ...
    public int payBribe(obj_id self, dictionary params)
    {
        int rec_faction_id = pvpGetAlignedFaction(self);
    ...
    public prose_package createProsePackage(string_id sid, obj_id actor, obj_id target, String str, int number)
    {
    ...
    public int getFactionId(String faction)
    {
        if (faction == null)
        {
            return -1;
    ...
    public String getProgressObjVarName(obj_id player)
    {
        if (!isIdValid(player))
        {
            return null;
    ...
    public string_id[] getConversationResponses(obj_id player, obj_id npc, int progress)
    {
    ...
    public prose_package[] getProseConversationResponses(obj_id player, obj_id npc, String prose_string, int prose_digit, int progress)
    {
    ...
    public prose_package[] assemblePackageArray(prose_package[] array, prose_package element)
    {
        if (element == null)
        {
    ...
    public int[] convertSecondsTime(int time)
    {
        if (time < 1)
        {
            return null;
    ...
    public void invalidResponse(obj_id player)
    {
        if (!isIdValid(player))
        {
    ...
    public boolean displayTrainingSUI(obj_id player)
    {
        if (!isIdValid(player))
        {
    ...
    public int msgFactionItemPurchaseSelected(obj_id self, dictionary params)
    {
    ...
    public int msgFactionItemRankSelected(obj_id self, dictionary params)
    {
    ...
    public int xferFail(obj_id self, dictionary params)
    {
        return SCRIPT_CONTINUE;
    }
    public int fromAccountPass(obj_id self, dictionary params)
    {
    ...
    public int xferPass(obj_id self, dictionary params)
    {
    ...
    public int gaveReward(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int msgFactionTrainingTypeSelected(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        if (!isIdValid(player))
        {
    ...
    public int msgFactionTrainingAmountSelected(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        if (!isIdValid(player))
        {
    ...
    public int msgFactionTrainingAmountSelectedXpResult(obj_id self, dictionary params)
    {
