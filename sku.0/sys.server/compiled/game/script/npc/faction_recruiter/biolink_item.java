...
public class biolink_item extends script.base_script
{
    ...
    public int handleEquipBioLinkSui(obj_id self, dictionary params)
    {
    ...
    public int handleSpendFactionPointsSui(obj_id self, dictionary params)
    {
        int bp = sui.getIntButtonPressed(params);
        if (bp != sui.BP_CANCEL)
        {
    ...
    public boolean _bioLinkItem(obj_id self, obj_id player, boolean equipAfterLink, boolean queryPlayer)
    {
