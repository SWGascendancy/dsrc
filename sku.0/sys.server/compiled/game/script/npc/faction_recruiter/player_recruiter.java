...
public class player_recruiter extends script.base_script
{
    ...
    public int msgFactionTrainingAmountConfirm(obj_id self, dictionary params)
    {
    ...
    public int msgFactionTrainingAmountConfirmXpResult(obj_id self, dictionary params)
    {
