...
public class wod_sm_vendor extends script.base_script {
    private static final String c_stringFile = "conversation/wod_sm_vendor";
    private static final String branchObjVar = "conversation.wod_sm_vendor.branchId";
    ...
    public int OnStartNpcConversation(obj_id self, obj_id player) {
        ...
        responses[1] = new string_id(c_stringFile, "s_10");
        npcStartConversation(player, self, "wod_sm_vendor", new string_id(c_stringFile, "s_4"), responses);
        return SCRIPT_CONTINUE;
    }
    ...
    private int wod_sm_vendor_handleBranch1(obj_id player, obj_id npc, string_id response)
    {
        switch (response.getAsciiId())
        {
            case "s_6":
                vendor_action_showResourceVendorUI(player, npc);
                chat.chat(npc, player, new string_id(c_stringFile, "s_8"));
                break;
            case "s_10":
                chat.chat(npc, player, new string_id(c_stringFile, "s_12"));
                break;
        }
    ...
    public int OnNpcConversationResponse(obj_id npc, String conversationId, obj_id player, string_id response) {
        ...
        {
            case 1:
                return wod_sm_vendor_handleBranch1(player, npc, response);
        }
