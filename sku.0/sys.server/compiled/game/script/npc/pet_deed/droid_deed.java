...
public class droid_deed extends script.base_script
{
    ...
    public int getStorageSlotsByRating(int rating)
    {
        int slots = 0;
    ...
    public int getDataSlotsByRating(int rating)
    {
        int slots = 0;
        if (rating > 0 && rating <= 2)
        {
    ...
    public obj_id createCraftedCreatureDevice(obj_id player, obj_id deed)
    {
    ...
    public void initDroidCraftedInventoryPCD(obj_id petControlDevice, obj_id player)
    {
    ...
    public void initDroidCraftedDatapadPCD(obj_id petControlDevice, obj_id player)
    {
    ...
    public void initDroidModuleData(obj_id pet, obj_id petControlDevice)
    {
