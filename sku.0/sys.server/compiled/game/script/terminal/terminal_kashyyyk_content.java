...
public class terminal_kashyyyk_content extends script.base_script
{
    ...
    public boolean checkConfigSetting(String configString)
    {
    ...
    public void startCharacterBuilder(obj_id player)
    {
        obj_id self = getSelf();
    ...
    public void cleanScriptVars(obj_id player)
    {
        obj_id self = getSelf();
    ...
    public void setWindowPid(obj_id player, int pid)
    {
        if (pid > -1)
        {
    ...
    public void handleKachirhoOption(obj_id player)
    {
        obj_id self = getSelf();
    ...
    public int handleKachirhoSelect(obj_id self, dictionary params)
    {
        int idx = sui.getListboxSelectedRow(params);
        obj_id player = sui.getPlayerId(params);
        int btn = sui.getIntButtonPressed(params);
    ...
    public void handleDeadForestOption(obj_id player)
    {
        obj_id self = getSelf();
        String prompt = "Select the desired testing option";
        String title = "Kashyyyk Content Terminal";
    ...
    public int handleDeadForestSelect(obj_id self, dictionary params)
    {
        int idx = sui.getListboxSelectedRow(params);
        obj_id player = sui.getPlayerId(params);
        int btn = sui.getIntButtonPressed(params);
    ...
    public void handleMyyydrilOption(obj_id player)
    {
        obj_id self = getSelf();
        String prompt = "Select the desired testing option";
        String title = "Kashyyyk Content Terminal";
    ...
    public int handleMyyydrilSelect(obj_id self, dictionary params)
    {
        int idx = sui.getListboxSelectedRow(params);
        obj_id player = sui.getPlayerId(params);
        int btn = sui.getIntButtonPressed(params);
    ...
    public void handleHuntingGroundsOption(obj_id player)
    {
        obj_id self = getSelf();
        String prompt = "Select the desired testing option";
        String title = "Kashyyyk Content Terminal";
    ...
    public int handleHuntingGroundsSelect(obj_id self, dictionary params)
    {
        int idx = sui.getListboxSelectedRow(params);
        obj_id player = sui.getPlayerId(params);
        int btn = sui.getIntButtonPressed(params);
    ...
    public void handleBocctyyyOption(obj_id player)
    {
    }
    public void handleHraccaOption(obj_id player)
    {
        obj_id self = getSelf();
        String prompt = "Select the desired testing option";
        String title = "Kashyyyk Content Terminal";
    ...
    public int handleHraccaSelect(obj_id self, dictionary params)
    {
        int idx = sui.getListboxSelectedRow(params);
        obj_id player = sui.getPlayerId(params);
        int btn = sui.getIntButtonPressed(params);
    ...
    public void handleRryattOption(obj_id player)
    {
        obj_id self = getSelf();
        String prompt = "Select the desired testing option";
        String title = "Kashyyyk Content Terminal";
    ...
    public int handleRryattSelect(obj_id self, dictionary params)
    {
        int idx = sui.getListboxSelectedRow(params);
        obj_id player = sui.getPlayerId(params);
        int btn = sui.getIntButtonPressed(params);
    ...
    public void handleBlackscaleOption(obj_id player)
    {
        obj_id self = getSelf();
        String prompt = "Select the desired testing option";
        String title = "Kashyyyk Content Terminal";
    ...
    public int handleBlackscaleSelect(obj_id self, dictionary params)
    {
        int idx = sui.getListboxSelectedRow(params);
        obj_id player = sui.getPlayerId(params);
        int btn = sui.getIntButtonPressed(params);
    ...
    public void handleAvatarOption(obj_id player)
    {
        obj_id self = getSelf();
        String prompt = "Select the desired testing option";
        String title = "Kashyyyk Content Terminal";
    ...
    public int handleAvatarSelect(obj_id self, dictionary params)
    {
        int idx = sui.getListboxSelectedRow(params);
        obj_id player = sui.getPlayerId(params);
        int btn = sui.getIntButtonPressed(params);
    ...
    public void handleSpaceMiningOption(obj_id player)
    {
        obj_id self = getSelf();
        String prompt = "Select the desired testing option";
        String title = "Kashyyyk Content Terminal";
    ...
    public int handleSpaceMiningSelect(obj_id self, dictionary params)
    {
        int idx = sui.getListboxSelectedRow(params);
        obj_id player = sui.getPlayerId(params);
        int btn = sui.getIntButtonPressed(params);
    ...
    public void handleSpaceMissionOption(obj_id player)
    {
        obj_id self = getSelf();
        String prompt = "Select the desired testing option";
        String title = "Kashyyyk Content Terminal";
    ...
    public int handleSpaceMissionSelect(obj_id self, dictionary params)
    {
        int idx = sui.getListboxSelectedRow(params);
        obj_id player = sui.getPlayerId(params);
        int btn = sui.getIntButtonPressed(params);
    ...
    public void nukeInventory(obj_id player)
    {
    ...
    public void nukeSelectedInventory(obj_id player)
    {
        obj_id[] contents = getInventoryAndEquipment(player);
        if (contents != null)
        {
    ...
    public void flagForDestruction(obj_id item)
    {
        setObjVar(item, "frog.item", 1);
    }
    public void issueReconArmorSet(obj_id player, String[] armorPieces)
    {
        obj_id pInv = utils.getInventoryContainer(player);
    ...
    public void issueBattleArmorSet(obj_id player, String[] armorPieces)
    {
        obj_id pInv = utils.getInventoryContainer(player);
        for (int j = 0; j < armorPieces.length; ++j)
        {
    ...
    public void issueAssaultArmorSet(obj_id player, String[] armorPieces)
    {
        obj_id pInv = utils.getInventoryContainer(player);
        for (int j = 0; j < armorPieces.length; ++j)
        {
    ...
    public void handleRevokeAllSkills(obj_id player)
    {
        if (exists(player))
        {
    ...
    public int getNextStartIndex(Vector shipStartLocations, int lastStartIndex)
    {
    ...
    public boolean groupMemberApproved(obj_id[] membersApprovedByShipOwner, obj_id memberToTest)
    {
    ...
    public void handleCyberneticsOption(obj_id player)
    {
