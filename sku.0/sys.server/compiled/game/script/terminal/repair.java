...
public class repair extends script.terminal.base.base_terminal
{
    ...
    public int handleConfirmRepairAll(obj_id self, dictionary params)
    {
    ...
    public void confirmRepairAll(obj_id player)
    {
        closeOldRepairSui(player);
    ...
    public void openRepairSui(obj_id player)
    {
        closeOldRepairSui(player);
        obj_id[] repairList = cloninglib.getAllRepairItems(player);
    ...
    public int handleRepairSuiUpdate(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleRepairSuiSelect(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public String buildRepairEntry(obj_id item, int cost)
    {
        String entry = getEncodedName(item);
        entry += " \\%070( @terminal_ui:repair_prompt_cost " + cost + ")";
        return entry;
    }
    public String buildRepairPrompt(obj_id player, int index)
    {
        int totalCost = utils.getIntScriptVar(player, "repair.totalCost");
    ...
    public void closeOldRepairSui(obj_id player)
    {
    ...
    public int handlePayRepairSuccess(obj_id self, dictionary params)
    {
