...
public class npc_vendor extends script.base_script
{
    ...
    public int handleVendorAnimSelect(obj_id self, dictionary params)
    {
    ...
    public int handleVendorMoodSelect(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        int idx = sui.getListboxSelectedRow(params);
        if (idx < 0)
    ...
    public int handleVendorStrCatSelect(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        int idx = sui.getListboxSelectedRow(params);
        if (idx < 0)
    ...
    public int handleSetCustomBark(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        if (!isIdValid(player))
        {
    ...
    public int checkNakedSlots(obj_id self, dictionary params)
    {
        String templateName = getTemplateName(self);
        if (templateName == null || templateName.equals(""))
        {
