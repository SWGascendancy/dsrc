...
public class ballot_box extends script.base_script
{
    ...
    public void editBallot(obj_id player, obj_id terminal)
    {
    ...
    public void makeResultsSecret(obj_id owner, obj_id terminal)
    {
    ...
    public void makeResultsPublic(obj_id owner, obj_id terminal)
    {
    ...
    public void removeSelectionItem(obj_id owner, obj_id terminal)
    {
    ...
    public void addSelectionItem(obj_id owner, obj_id terminal)
    {
        if ((getStringObjVar(terminal, VAR_BALLOT_STATE_TEXT)).equals(getString(SID_OPEN_STATE_TEXT)))
        {
    ...
    public void ownerViewBallot(obj_id owner, obj_id terminal)
    {
        String title = getStringObjVar(terminal, VAR_BALLOT_TITLE);
    ...
    public void viewBallot(obj_id owner, obj_id terminal)
    {
    ...
    public String getBallotViewData(obj_id terminal)
    {
        String title = getStringObjVar(terminal, VAR_BALLOT_TITLE);
    ...
    public void editBallotTitle(obj_id owner, obj_id terminal)
    {
        if ((getStringObjVar(terminal, VAR_BALLOT_STATE_TEXT)).equals(getString(SID_OPEN_STATE_TEXT)))
        {
            sendSystemMessage(owner, SID_MUST_STOP_VOTE_MSG);
    ...
    public void editBallotText(obj_id owner, obj_id terminal)
    {
        if ((getStringObjVar(terminal, VAR_BALLOT_STATE_TEXT)).equals(getString(SID_OPEN_STATE_TEXT)))
        {
            sendSystemMessage(owner, SID_MUST_STOP_VOTE_MSG);
    ...
    public void startVote(obj_id player, obj_id terminal)
    {
    ...
    public void stopVote(obj_id player, obj_id terminal)
    {
    ...
    public void logResults(obj_id player, obj_id terminal)
    {
    ...
    public void removeLogResults(obj_id owner, obj_id terminal, boolean displayMessage)
    {
    ...
    public void vote(obj_id player, obj_id terminal)
    {
    ...
    public void viewResults(obj_id player, obj_id terminal)
    {
    ...
    public int configureBallot(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int editText(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int editTitle(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int voteTracker(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int addItem(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int sendPersistantResultsMessage(obj_id self, dictionary params)
    {
    ...
    public int removeItem(obj_id self, dictionary params)
    {
        int listItem = sui.getListboxSelectedRow(params);
        obj_id player = sui.getPlayerId(params);
        if (listItem == -1)
