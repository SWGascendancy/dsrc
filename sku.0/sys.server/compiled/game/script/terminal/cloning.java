...
public class cloning extends script.terminal.base.base_terminal
{
    ...
    public int handleCloneCouponConfirm(obj_id self, dictionary params)
    {
    ...
    public int handleCloneConfirm(obj_id self, dictionary params)
    {
        int btnPressed = sui.getIntButtonPressed(params);
        switch (btnPressed)
        {
    ...
    public int handleRequestedClone(obj_id self, dictionary params)
    {
