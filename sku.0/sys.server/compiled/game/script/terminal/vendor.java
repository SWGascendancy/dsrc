...
public class vendor extends script.terminal.base.base_terminal
{
    ...
    public void registerVendorOnMap(obj_id self)
    {
        requestVendorItemCount(self);
    }
    public void destroyVendor(obj_id self)
    {
    ...
    public void doMapRegistration(obj_id self)
    {
    ...
    public int vendorItemRetry(obj_id self, dictionary params)
    {
        registerVendorOnMap(self);
        return SCRIPT_CONTINUE;
    }
    public int OnVendorItemCountReply(obj_id self, int count, int search_enabled)
    {
    ...
    public int OnVendorStatusChange(obj_id self, int newStatus)
    {
    ...
    public int handleDestroyVendor(obj_id self, dictionary params)
    {
        if (sui.hasPid(self, DESTROY_PID))
        {
            forceCloseSUIPage(sui.getPid(self, DESTROY_PID));
    ...
    public int handleDeleteVendorConfirmed(obj_id self, dictionary params)
    {
        if (sui.hasPid(self, DESTROY_PID))
        {
            forceCloseSUIPage(sui.getPid(self, DESTROY_PID));
    ...
    public void clearVendorDestroyData(obj_id vendor)
    {
        if (!isIdValid(vendor))
        {
            return;
    ...
    public int msgVendorWithdrawSuccess(obj_id self, dictionary params)
    {
        if (params != null)
        {
    ...
    public int msgVendorWithdrawFail(obj_id self, dictionary params)
    {
        if (params != null)
        {
            int amt = params.getInt("amount");
    ...
    public int handleMapCatSelect(obj_id self, dictionary params)
    {
    ...
    public int msgGiveMaintenanceToVendor(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
    ...
    public int msgTakeMaintenanceFromVendor(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        String amount_str = sui.getInputBoxText(params);
        int btn = sui.getIntButtonPressed(params);
    ...
    public void updateSalesTax(obj_id self)
    {
    ...
    public void displayStatus(obj_id self, obj_id player, int itemCount, int search_enabled)
    {
        obj_id ownerId = getObjIdObjVar(self, "vendor_owner");
        if ((player != ownerId) && !isGod(player))
        {
    ...
    public int OnAboutToOpenContainer(obj_id self, obj_id whoIsOpeningMe)
    {
    ...
    public void updateAccessFee(obj_id self)
    {
        obj_id structure = player_structure.getStructure(self);
        if (turnstile.hasTurnstile(structure))
        {
