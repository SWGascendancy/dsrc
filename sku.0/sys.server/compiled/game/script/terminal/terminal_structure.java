...
public class terminal_structure extends script.base_script
{
    ...
    public int handleStorageRedeedChoice(obj_id self, dictionary params)
    {
    ...
    public int handleSetAccessFee(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        String accessFee = sui.getInputBoxText(params);
        int btn = sui.getIntButtonPressed(params);
    ...
    public int handleSetAccessLength(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
    ...
    public void moveFirstItem(obj_id self, obj_id player, obj_id structure)
    {
    ...
    public int handleMoveFirstItem(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        int btn = sui.getIntButtonPressed(params);
        if (btn == sui.BP_CANCEL)
    ...
    public void deleteAllItems(obj_id self, obj_id player, obj_id structure)
    {
    ...
    public int handleDeleteSecondConfirm(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        int btn = sui.getIntButtonPressed(params);
        if (btn == sui.BP_CANCEL)
    ...
    public int handleDeleteAllItemsCodeConfirm(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
    ...
    public int handleDeleteAllItemsConfirmed(obj_id self, dictionary params)
    {
    ...
    public int clearCollectionMeatlumpCamera(obj_id self, dictionary params)
    {
        obj_id target = params.getObjId("target");
        utils.removeScriptVar(target, "collection.picture_taken");
        return SCRIPT_CONTINUE;
    }
    public int handlePlayerStructureFindItemsListResponse(obj_id self, dictionary params)
    {
        player_structure.handleFindItemsListResponse(self, params);
        return SCRIPT_CONTINUE;
    }
    public int handlePlayerStructureFindItemsPageResponse(obj_id self, dictionary params)
    {
        player_structure.handleFindItemsChangePageResponse(self, params);
        return SCRIPT_CONTINUE;
    }
    public int handlePlayerStructureSearchItemsGetKeyword(obj_id self, dictionary params)
    {
        player_structure.handleSearchItemsGetKeyword(self, params);
        return SCRIPT_CONTINUE;
    }
    public int handlePlayerStructureSearchItemsSelectedResponse(obj_id self, dictionary params)
    {
        player_structure.handleSearchItemsSelectedResponse(self, params);
        return SCRIPT_CONTINUE;
    }
    public boolean getSpecialSignManagementMenu(obj_id player, obj_id structure)
    {
