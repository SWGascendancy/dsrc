...
public class terminal_hangar_structure extends script.base_script
{
    ...
    public void placeShipDecoration(obj_id player, obj_id hangarControls, obj_id playerHangar)
    {
    ...
    public boolean callSuiOfShipsToStore(obj_id player, obj_id terminal, obj_id hangar)
    {
    ...
    public boolean callSuiOfStoredShips(obj_id player, obj_id terminal, obj_id hangar)
    {
        if (!isIdValid(player) || !exists(player))
        {
            return false;
    ...
    public int onShipDecorationResponse(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        obj_id playerHangar = utils.getPlayerHangar(player);
    ...
    public int onShipListResponse(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
    ...
    public int handlerConfirmShipMove(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            utils.removeScriptVar(self, SCRIPT_VAR_RESTORING_SHIP);
