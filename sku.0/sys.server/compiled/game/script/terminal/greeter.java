...
public class greeter extends script.terminal.base.base_terminal
{
    ...
    public int OnGiveItem(obj_id self, obj_id item, obj_id player)
    {
        return SCRIPT_CONTINUE;
    }
    ...
    public int OnAboutToBeTransferred(obj_id self, obj_id dest, obj_id transferer)
    {
    ...
    public int handleDelayedMainControlMenu(obj_id self, dictionary params)
    {
    ...
    public int handlePlayerProgramSelect(obj_id self, dictionary params)
    {
    ...
    public int handleCallGreeterUpdate(obj_id self, dictionary params)
    {
    ...
    public int handleCallVolumeToggleOnInitialized(obj_id self, dictionary params)
    {
        toggleTriggerVolume(self);
        return SCRIPT_CONTINUE;
    }
    public int handleCallVolumeToggleNoLife(obj_id self, dictionary params)
    {
        toggleTriggerVolume(self, false);
        return SCRIPT_CONTINUE;
    }
    public int colorGreeter(obj_id self, dictionary params)
    {
        obj_id controller = getObjIdObjVar(self, vendor_lib.CNTRLR_GREETER_NONVENDOR_ID_OBJVAR);
        if (!isValidId(controller) || !exists(controller))
        {
    ...
    public int handleConverseWithOtherGreeterAfterGreetDelay(obj_id self, dictionary params)
    {
        obj_id controller = getObjIdObjVar(self, vendor_lib.CNTRLR_GREETER_NONVENDOR_ID_OBJVAR);
        if (!isValidId(controller) || !exists(controller))
        {
    ...
    public int handleConverseWithOtherGreeter(obj_id self, dictionary params)
    {
    ...
    public int handleSetSaveName(obj_id self, dictionary params)
    {
    ...
    public int handlePlayerGreetingSelect(obj_id self, dictionary params)
    {
    ...
    public int handlePlayerGreetingMaintenanceSelect(obj_id self, dictionary params)
    {
    ...
    public int handlePlayerLoadGreetingSelect(obj_id self, dictionary params)
    {
    ...
    public int changeTriggerRadius(obj_id self, dictionary params)
    {
    ...
    public int changeGreeterDelay(obj_id self, dictionary params)
    {
    ...
    public int handleDestroyGreeter(obj_id self, dictionary params)
    {
    ...
    public int handleGreeterInitialize(obj_id self, dictionary params)
    {
        if (!hasObjVar(self, vendor_lib.CNTRLR_GREETER_NONVENDOR_ID_OBJVAR))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handlePlayerGreeterAnimCategorySelect(obj_id self, dictionary params)
    {
    ...
    public int handlePlayerGreeterAnimSelect(obj_id self, dictionary params)
    {
    ...
    public int handlePlayerGreeterMoodCategorySelect(obj_id self, dictionary params)
    {
    ...
    public int handlePlayerGreeterMoodSelect(obj_id self, dictionary params)
    {
    ...
    public int handlePlayerEffectSelection(obj_id self, dictionary params)
    {
    ...
    public int handlePlayerStatementSelection(obj_id self, dictionary params)
    {
    ...
    public int resetBarkTimer(obj_id self, dictionary params)
    {
        utils.removeScriptVar(self, vendor_lib.GREETER_ALREADY_BARKED_SCRVAR);
        return SCRIPT_CONTINUE;
    }
    public boolean getGreeterAnimCategorySelect(obj_id self, obj_id controller, obj_id player)
    {
    ...
    public boolean getGreeterMoodCategorySelect(obj_id self, obj_id controller, obj_id player)
    {
    ...
    public boolean getGreeterSoundVoiceList(obj_id self, obj_id controller, obj_id player, String effectType)
    {
    ...
    public boolean getGreeterStatementSelection(obj_id self, obj_id controller, obj_id player)
    {
    ...
    public boolean destroyGreeter(obj_id self)
    {
        if (!isValidId(self) || !exists(self))
        {
            return false;
    ...
    public boolean toggleTriggerVolume(obj_id self)
    {
        return toggleTriggerVolume(self, true);
    }
    public boolean toggleTriggerVolume(obj_id self, boolean giveLife)
    {
    ...
    public boolean validateAllImperativeGreeterVars(obj_id self, obj_id player)
    {
        if (!isValidId(self) || !exists(self))
        {
            return false;
    ...
    public boolean bringGreeterToLife(obj_id self)
    {
        if (!isValidId(self) || !exists(self))
        {
            return false;
    ...
    public boolean bringGreeterToLife(obj_id self, obj_id controller, obj_id player)
    {
    ...
    public boolean deleteGreeting(obj_id self, obj_id player, obj_id controller, String saveName)
    {
    ...
    public boolean getSavedGreetings(obj_id self, obj_id player, obj_id controller)
    {
    ...
    public boolean saveGreeting(obj_id self, obj_id player, obj_id controller, String saveName)
    {
    ...
    public boolean getMainProgramUIListOptions(obj_id self, obj_id player, obj_id controller)
    {
        if (!isValidId(self) || !exists(self))
        {
            return false;
    ...
    public boolean buildMainControlMenu(obj_id self, obj_id player)
    {
        if (!isValidId(self) || !exists(self))
        {
            return false;
    ...
    public boolean loadSavedData(obj_id self, obj_id player, obj_id controller, String selection)
    {
    ...
    public boolean getRandomGreeting(obj_id self, obj_id controller)
    {
    ...
    public boolean conversableGreeterInRange(obj_id self)
    {
    ...
    public obj_id getConversableGreeter(obj_id self, obj_id player, obj_id controller)
    {
