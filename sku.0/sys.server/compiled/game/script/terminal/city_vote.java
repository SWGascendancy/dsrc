...
public class city_vote extends script.terminal.base.base_terminal
{
    ...
    public void showStandings(obj_id self, obj_id player)
    {
        obj_id city_hall = getTopMostContainer(self);
        int city_id = findCityByCityHall(city_hall);
        obj_id mayor = cityGetLeader(city_id);
    ...
    public void placeVote(obj_id self, obj_id player)
    {
        obj_id city_hall = getTopMostContainer(self);
        int city_id = findCityByCityHall(city_hall);
        obj_id mayor = cityGetLeader(city_id);
    ...
    public int handlePlaceVote(obj_id self, dictionary params)
    {
    ...
    public boolean isRegisteredToRun(obj_id player, obj_id self)
    {
        obj_id city_hall = getTopMostContainer(self);
        obj_id[] candidates = getObjIdArrayObjVar(city_hall, "candidate_list");
        if (candidates == null)
    ...
    public void cleanCandidates(obj_id self, obj_id player)
    {
        obj_id city_hall = getTopMostContainer(self);
        int city_id = findCityByCityHall(city_hall);
        obj_id[] candidates = getObjIdArrayObjVar(city_hall, "candidate_list");
    ...
    public String getNumVotes(obj_id candidate, Vector vote_ids, Vector vote_counts)
    {
    ...
    public boolean isOldEnough(obj_id player)
    {
    ...
    public String convertInterval(int currentInterval)
    {
