...
public class terminal_city extends script.base_script
{
    ...
    public void forceUpdate(obj_id player, obj_id self, int city_id)
    {
    ...
    public int handleForceUpdateElection(obj_id self, dictionary params)
    {
    ...
    public int handleForceUpdateConfirmed(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        int btn = sui.getIntButtonPressed(params);
        if (btn == sui.BP_CANCEL)
    ...
    public int handleForceUpdateNow(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        obj_id structure = getTopMostContainer(self);
        int city_id = findCityByCityHall(structure);
    ...
    public void forceRank(obj_id player, obj_id self, int city_id, int rank)
    {
    ...
    public int handleForceRankConfirmed(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        int btn = sui.getIntButtonPressed(params);
        if (btn == sui.BP_CANCEL)
    ...
    public void makeMayor(obj_id player, obj_id self, int city_id)
    {
    ...
    public int handleMakeMayor(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public void resetCloneData(obj_id player, obj_id self, int city_id)
    {
    ...
    public int handleResetCloneData(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        int btn = sui.getIntButtonPressed(params);
        if (btn == sui.BP_CANCEL)
    ...
    public void resetShuttleData(obj_id player, obj_id self, int city_id)
    {
    ...
    public int handleResetShuttleData(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        int btn = sui.getIntButtonPressed(params);
        if (btn == sui.BP_CANCEL)
    ...
    public void clearStructureScriptVars(obj_id player, obj_id self, int city_id)
    {
    ...
    public void modifyStructureList(obj_id player, obj_id self, int city_id)
    {
    ...
    public int handleCityObjectRemove(obj_id self, dictionary params)
    {
        int idx = sui.getListboxSelectedRow(params);
        if (idx < 0)
        {
    ...
    public int handleConfirmObjectRemove(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        int btn = sui.getIntButtonPressed(params);
        if (btn == sui.BP_CANCEL)
    ...
    public int handleRevokeCitizenship(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        int btn = sui.getIntButtonPressed(params);
        if (btn == sui.BP_CANCEL)
    ...
    public void showCityInfo(obj_id player, obj_id self, int city_id)
    {
        if (!isIdValid(player) || !isIdValid(self))
        {
            sendSystemMessage(player, new string_id(STF, "city_network_error"));
    ...
    public void showCitizensList(obj_id player, obj_id self, int city_id)
    {
        if (!isIdValid(player) || !isIdValid(self))
        {
            sendSystemMessage(player, new string_id(STF, "city_network_error"));
    ...
    public int DisplayCitizenList(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleCitizenSelect(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        int btn = sui.getIntButtonPressed(params);
    ...
    public void showCitizenshipListSui(obj_id self, obj_id player, String[][] displayData)
    {
        String[] colTitles = 
        {
    ...
    public void showStructuresList(obj_id player, obj_id self, int city_id)
    {
        if (!isIdValid(player) || !isIdValid(self))
        {
            sendSystemMessage(player, new string_id(STF, "city_network_error"));
    ...
    public void getCityStructuresInfo(obj_id player, obj_id self, int city_id)
    {
        if (!isIdValid(player) || !isIdValid(self))
        {
            sendSystemMessage(player, new string_id(STF, "city_network_error"));
    ...
    public void LoadedCityStructuresInfo(obj_id self, obj_id player, int city_id, obj_id[] loadedStructures)
    {
    ...
    public void messageUnloadedCityStructures(obj_id self, obj_id player, int city_id, obj_id[] unloadedStructures)
    {
    ...
    public int DisplayCityStructuresList(obj_id self, dictionary params)
    {
    ...
    public void showCityStructuresSuiFromScriptVars(obj_id self, obj_id player)
    {
        if (!utils.hasScriptVar(self, "loadedStructuresIds") && !utils.hasScriptVar(self, "loadedStructuresNames") && !utils.hasScriptVar(self, "loadedStructuresLocations"))
        {
            sendSystemMessage(player, new string_id(STF, "no_available_waypoint"));
    ...
    public void showCityStructuresSui(obj_id self, obj_id player, String[][] displayData)
    {
        String[] colTitles = 
        {
            "Structure Name",
    ...
    public String getStructureDisplayLocation(location loc)
    {
        String returnString = "" + Math.round(loc.x) + ", " + Math.round(loc.y) + ", " + Math.round(loc.z);
        return returnString;
    }
    public int RecievedUnloadedStructureResponse(obj_id self, dictionary params)
    {
    ...
    public int handleStructureWaypointSelect(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        int btn = sui.getIntButtonPressed(params);
        String eventType = sui.getEventType(params);
    ...
    public void showAdvancementInfo(obj_id player, obj_id self, int city_id)
    {
        if (!isIdValid(player) || !isIdValid(self))
        {
            sendSystemMessage(player, new string_id(STF, "city_network_error"));
    ...
    public void showMaintInfo(obj_id player, obj_id self, int city_id)
    {
        if (!isIdValid(player) || !isIdValid(self))
        {
            sendSystemMessage(player, new string_id(STF, "city_network_error"));
    ...
    public void changeCityName(obj_id player, obj_id self, int city_id)
    {
        if (!isIdValid(player) || !isIdValid(self))
        {
            sendSystemMessage(player, new string_id(STF, "city_network_error"));
    ...
    public int handleSetCityName(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
    ...
    public void modifyMilitia(obj_id player, obj_id self, int city_id)
    {
        if (!isIdValid(player) || !isIdValid(self))
        {
            sendSystemMessage(player, new string_id(STF, "city_network_error"));
    ...
    public int handleRemoveMilitia(obj_id self, dictionary params)
    {
        int idx = sui.getListboxSelectedRow(params);
        if (idx < 0)
        {
    ...
    public int handleAddMilitia(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
    ...
    public int handleRemoveMilitiaConfirmed(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        int btn = sui.getIntButtonPressed(params);
        if (btn == sui.BP_CANCEL)
    ...
    public void showTreasuryInfo(obj_id player, obj_id self, int city_id)
    {
        if (!isIdValid(player) || !isIdValid(self))
        {
            sendSystemMessage(player, new string_id(STF, "city_network_error"));
    ...
    public void makeTreasuryDeposit(obj_id player, obj_id self, int city_id)
    {
        if (!isIdValid(player) || !isIdValid(self))
        {
            sendSystemMessage(player, new string_id(STF, "city_network_error"));
    ...
    public int depositTreasury(obj_id self, dictionary params)
    {
        obj_id structure = getTopMostContainer(self);
        obj_id player = sui.getPlayerId(params);
    ...
    public void makeTreasuryWithdraw(obj_id player, obj_id self, int city_id)
    {
        if (!isIdValid(player) || !isIdValid(self))
        {
            sendSystemMessage(player, new string_id(STF, "city_network_error"));
    ...
    public int handleWithdrawReason(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
    ...
    public int withdrawTreasury(obj_id self, dictionary params)
    {
        obj_id structure = getTopMostContainer(self);
        int city_id = findCityByCityHall(structure);
        obj_id player = sui.getPlayerId(params);
    ...
    public int handleWithdrawSuccess(obj_id self, dictionary params)
    {
        int city_id = params.getInt("city_id");
    ...
    public int handleWithdrawFail(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        sendSystemMessage(player, new string_id(STF, "withdraw_treasury_error"));
        return SCRIPT_CONTINUE;
    }
    public void adjustTaxes(obj_id player, obj_id self, int city_id)
    {
        if (!isIdValid(player) || !isIdValid(self))
        {
            sendSystemMessage(player, new string_id(STF, "city_network_error"));
    ...
    public int handleTaxInfoSelect(obj_id self, dictionary params)
    {
        int idx = sui.getListboxSelectedRow(params);
        if (idx < 0)
        {
    ...
    public int handleSetTax(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
    ...
    public int handleRegisterCity(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleUnregisterCity(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public void changeSpecialization(obj_id player, obj_id self, int city_id)
    {
        if (!isIdValid(player) || !isIdValid(self))
        {
            sendSystemMessage(player, new string_id(STF, "city_network_error"));
    ...
    public int handleCitySpecInfo(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleSetCitySpec(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public void changeZoning(obj_id player, obj_id self, int city_id)
    {
        if (!isIdValid(player) || !isIdValid(self))
        {
            sendSystemMessage(player, new string_id(STF, "city_network_error"));
    ...
    public int handleSetCityZoning(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public void sendNewMayorMail(int city_id, obj_id mayor)
    {
    ...
    public boolean destroyCitySkillTrainers(obj_id mayor, int city_id)
    {
    ...
    public boolean citySkillTrainersExist(int city_id)
    {
        if (!cityExists(city_id))
        {
            return false;
    ...
    public int handleCityVisitorMessage(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleCityCitizenMessage(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int getStructureCitizenInformationReturn(obj_id self, dictionary params)
    {
    ...
    public void showSafeHouseCitizenList(obj_id player, obj_id self, int city_id)
    {
        if (!isIdValid(player) || !isIdValid(self))
        {
            sendSystemMessage(player, new string_id(STF, "city_network_error"));
    ...
    public int handleSafeHouseCitizenSelect(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int updateSafeHouseCitizenList(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
