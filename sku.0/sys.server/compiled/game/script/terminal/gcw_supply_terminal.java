...
public class gcw_supply_terminal extends script.base_script
{
    ...
    public void initiateSlicing(obj_id player)
    {
    ...
    public void makeSliceSequence(obj_id player)
    {
        if (!isIdValid(player) || !exists(player))
        {
            return;
    ...
    public int startSlicing(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public void correctChoice(obj_id self, obj_id player)
    {
    ...
    public void applyFatigue(obj_id player)
    {
        if (!isIdValid(player) || !exists(player))
        {
            return;
    ...
    public int slicingChoice(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleSlicingAttemptResults(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public String getText(obj_id self, obj_id player)
    {
        if (!isIdValid(player) || !exists(player) || !isIdValid(self) || !exists(self))
        {
    ...
    public int decreaseSliced(obj_id self, dictionary params)
    {
        int sliced = 0;
    ...
    public boolean hasQuest(obj_id player)
    {
