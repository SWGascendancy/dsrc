...
public class bazaar extends script.terminal.base.base_terminal
{
    ...
    public int OnRequestAuctionFee(obj_id self, obj_id who, obj_id location, obj_id item, boolean premium, modifiable_int amount)
    {
    ...
    {
        //persistObject(self); // finch we should not be persisting this by default
        setOwner(self, self);
