...
public class terminal_guild_registry extends script.base_script
{
    ...
    public int onGuildCreateNameResponse(obj_id self, dictionary params)
    {
    ...
    public int onGuildCreateAbbrevResponse(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
    ...
    public String getMenuContextString(obj_id self, obj_id player, String varName)
    {
        deltadictionary dd = self.getScriptVars();
        return dd.getString("guildMenu." + player + "." + varName);
    }
    public void setMenuContextString(obj_id self, obj_id player, String varName, String value)
    {
        deltadictionary dd = self.getScriptVars();
        dd.put("guildMenu." + player + "." + varName, value);
    }
    public void removeMenuContextVar(obj_id self, obj_id player, String varName)
    {
        deltadictionary dd = self.getScriptVars();
