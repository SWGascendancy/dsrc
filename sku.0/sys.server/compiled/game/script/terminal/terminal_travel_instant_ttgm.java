...
public class terminal_travel_instant_ttgm extends script.base_script
{
    ...
    public dictionary getMyItemData(obj_id self)
    {
    ...
    public void showGroupMemberMenu(obj_id self, obj_id player)
    {
    ...
    public int teleportToGroupMemberChoiceHandler(obj_id self, dictionary params)
    {
    ...
    public int groupMemberLocationResponseHandler(obj_id self, dictionary params)
    {
    ...
    public int handleConfirmTravel(obj_id self, dictionary params)
    {
    ...
    public boolean isValidTravelLocation(obj_id player, location travelLoc, String[] groupieRegions)
    {
    ...
    public boolean terminalIsInRangeOfPlayer(obj_id terminal, obj_id player)
    {
