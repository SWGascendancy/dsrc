...
public class mini_vehicle_terminal extends script.base_script
{
    ...
    public int destroyVehicle(obj_id self, dictionary params)
    {
        obj_id terminal = self;
        if (!isValidId(terminal))
        {
    ...
    public boolean setVehicleVars(obj_id terminal, obj_id vehicle)
    {
    ...
    public boolean createVehicle(obj_id terminal, obj_id player)
    {
        if (!isValidId(terminal) || !exists(terminal))
        {
            return false;
    ...
    public boolean recreateVehicle(obj_id terminal)
    {
        obj_id anotherVehicle = getObjIdObjVar(terminal, VEHICLE_ID);
        if (isValidId(anotherVehicle) && exists(anotherVehicle))
        {
    ...
    public boolean validLocationList(obj_id terminal, location[] patrolLocations)
    {
