...
public class terminal_structure_vehicle_garage extends script.base_script
{
    ...
    public void placeDisplayVehicle(obj_id player, obj_id garageControls, obj_id playerHangarSlot)
    {
    ...
    public boolean callSuiOfVehiclesToStore(obj_id player, obj_id terminal, obj_id hangar)
    {
        if (!isIdValid(player) || !exists(player))
        {
            return false;
    ...
    public boolean callSuiOfStoredVehicles(obj_id player, obj_id terminal, obj_id hangar)
    {
        if (!isIdValid(player) || !exists(player))
        {
            return false;
    ...
    public int handleHangarInitialize(obj_id self, dictionary params)
    {
    ...
    public int onDisplayVehicleResponse(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        obj_id playerHangar = utils.getPlayerHangar(player);
        if (!isIdValid(player) || !exists(player))
    ...
    public int onVehicleListResponse(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
    ...
    public int handlerConfirmVehicleMove(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            utils.removeScriptVar(self, SCRIPT_VAR_RESTORING_VEHICLE);
