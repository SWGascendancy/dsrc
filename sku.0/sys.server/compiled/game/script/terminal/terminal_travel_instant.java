...
public class terminal_travel_instant extends script.base_script
{
    ...
    public int OnObjectMenuSelect(obj_id self, obj_id player, int item)
    {
        ...
        if (hasObjVar(self, "tcg_itv_home"))
        {
        ...
        else if (hasObjVar(self, "itv_max_locations"))
        {
    ...
    public void pickupObjectTriggerVolumeInitializer(obj_id self)
    {
    ...
    public obj_id playerCheck(obj_id self, String section)
    {
    ...
    public void LocationItvOptions(obj_id ship, obj_id player)
    {
        ...
        String[] main_options = new String[getIntObjVar(ship, "itv_max_locations") + 1];
    ...
    public void sendPlayerToLocation(obj_id player, int idx)
    {
        if (!isIdValid(player))
        {
            return;
    ...
    public boolean canMarkAtLocation(obj_id player)
    {
    ...
    public int timeOutSelfExpire(obj_id self, dictionary params)
    {
        if (!utils.hasScriptVar(self, "playerOwner"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int initializeInstaTravelShip(obj_id self, dictionary params)
    {
        debugLogging("//***// OnInitialize: ", "////>>>> ENTERED. ");
    ...
    public int cleanupShip(obj_id self, dictionary params)
    {
        obj_id player = utils.getObjIdScriptVar(self, "playerOwner");
        if (isIdValid(player))
        {
    ...
    public int ownerResidenceLocationResponse(obj_id self, dictionary params)
    {
    ...
    public int sendPlayerToHomeLocation(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            messageTo(self, "cleanupShip", null, 0, false);
    ...
    public int handleLocationItvOptions(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        if (sui.hasPid(player, PID_VAR))
        {
    ...
    public int handleManageLocationItvOptions(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        if (!isIdValid(player))
        {
    ...
    public int handleSetItvLocation(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            messageTo(self, "cleanupShip", null, 0, false);
