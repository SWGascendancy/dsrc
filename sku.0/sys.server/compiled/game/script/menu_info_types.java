...
public class menu_info_types
{
	...
	public static final int COLLECTIONS                          = index++; // finch might need to be SHOW_COLLECTIONS
	...
	public static final int ITEM_WP_MAKE_CITY_WAYPOINT           = index++;
	public static final int ITEM_WP_MAKE_GUILD_WAYPOINT          = index++;
	public static final int ATMOSPHERIC_FLIGHT_FLY               = index++;
	public static final int ATMOSPHERIC_FLIGHT_LAND              = index++;
	...
	*/
	...
	public static final int REMOVE_NO_TRADE							= index++;
	public static final int CITY_FURNITURE_PLACE					= index++;
	public static final int CITY_FURNITURE_REMOVE					= index++;
	public static final int CITY_FURNITURE_ALIGN					= index++;
	public static final int CITY_FURNITURE_ALIGN_NORTH				= index++;
	public static final int CITY_FURNITURE_ALIGN_SOUTH				= index++;
	public static final int CITY_FURNITURE_ALIGN_EAST				= index++;
	public static final int CITY_FURNITURE_ALIGN_WEST				= index++;
	public static final int FISHING_RETRIEVE_FISH					= index++;
