...
public class crafting_structure_guildhall_generic extends script.base_script
{
    public crafting_structure_guildhall_generic()
    {
    }
    ...
    public static final String PLAYER_GUILDHALL_GENERIC_STYLE_01 = "player_guildhall_generic_style_01";
    public int OnInitialize(obj_id self)
    {
        ...
        if (buildingTemplate.indexOf(PLAYER_GUILDHALL_GENERIC_STYLE_01) > 0)
        {
