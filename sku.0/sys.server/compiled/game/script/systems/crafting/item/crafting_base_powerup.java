...
public class crafting_base_powerup extends script.systems.crafting.crafting_base
{
    ...
    public void calculateBonusAndPenalty(obj_id weapon, float effectVal, float maxBonus, String bonusObjVarName, float efficiencyVal, float maxPenalty, String penaltyObjVarName)
    {
        float bonus = 0;
        float penalty = 0;
        if (effectVal > 0)
