...
public class base_tool extends script.base_script
{
    ...
    public int determineCraftingLevel(obj_id tool, obj_id player)
    {
        int craftingLevel = 0;
    ...
    public int OnRequestDraftSchematics(obj_id self, obj_id player, int[] schematics, float[] complexities)
    {
    ...
    public int OnAboutToOpenContainer(obj_id self, obj_id whoOpenedMe)
    {
    ...
    public int OnCraftingAddResource(obj_id self, obj_id player, obj_id resource, draft_schematic.slot ingredientSlot, modifiable_int[] resourceAmount)
    {
    ...
    public int OnCraftingDone(obj_id self, obj_id player, String schematicName, int craftingStage, boolean normalExit)
    {
    ...
    public int prototypeDone(obj_id self, dictionary params)
    {
    ...
    public obj_id getFirstParentInWorldOrPlayer(obj_id obj)
    {
        obj_id firstParent = getFirstParentInWorld(obj);
        while (obj != firstParent && !isPlayer(obj))obj = getContainedBy(obj);
        return obj;
    }
    public int getPrototype(obj_id self, dictionary params)
    {
        obj_id crafter = params.getObjId("crafter");
