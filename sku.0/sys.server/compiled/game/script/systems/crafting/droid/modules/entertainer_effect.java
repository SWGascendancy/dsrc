...
public class entertainer_effect extends script.base_script
{
    ...
    public int msgEntertainerDroidEffectChange(obj_id self, dictionary params)
    {
        obj_id master = getMaster(self);
        if (!isIdValid(master))
        {
    ...
    public int msgEntertainerDroidEffectSlot(obj_id self, dictionary params)
    {
        obj_id master = getMaster(self);
        if (!isIdValid(master))
        {
    ...
    public int msgEntertainerDroidEffectDelay(obj_id self, dictionary params)
    {
        obj_id master = getMaster(self);
        if (!isIdValid(master))
        {
    ...
    public int msgNextEntertainerDroidEffect(obj_id self, dictionary params)
    {
    ...
    public String[] getAvailableEffects(obj_id droid)
    {
        if (!isIdValid(droid))
        {
            return null;
    ...
    public void displayCurrentEffects(obj_id droid)
    {
        if (!isIdValid(droid))
        {
            return;
    ...
    public void closeAllEffectSUI(obj_id player)
    {
        if (!isIdValid(player))
        {
            return;
    ...
    public void closeEffectSelectSUI(obj_id player)
    {
        if (!isIdValid(player))
        {
            return;
    ...
    public void closeEffectDelaySUI(obj_id player)
    {
        if (!isIdValid(player))
        {
            return;
    ...
    public String[] getProgrammedEffects(obj_id droid)
    {
        if (!isIdValid(droid))
        {
            return null;
    ...
    public int[] getProgrammedDelays(obj_id droid)
    {
        if (!isIdValid(droid))
        {
            return null;
    ...
    public void playEntertainerEffect(obj_id droid, String effect)
    {
        if (!isIdValid(droid))
        {
            return;
