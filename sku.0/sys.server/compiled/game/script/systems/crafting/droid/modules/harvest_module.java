...
public class harvest_module extends script.base_script
{
    ...
    public int doTargetHarvest(obj_id self, dictionary params)
    {
    ...
    public int runHarvestRoutineOverride(obj_id self, dictionary params)
    {
        setOnHarvestRun(self, false);
        messageTo(self, "runHarvestRoutine", null, 1.0f, false);
        return SCRIPT_CONTINUE;
    }
    public int runHarvestRoutine(obj_id self, dictionary params)
    {
    ...
    public void setHarvestInterest(obj_id self, obj_id player)
    {
    ...
    public int handleSetHarvestInterest(obj_id self, dictionary params)
    {
    ...
    public void toggleAutoHarvest(obj_id droid)
    {
    ...
    public boolean autoHarvestEnabled(obj_id self)
    {
        return hasObjVar(self, AUTO_HARVEST) ? getBooleanObjVar(self, AUTO_HARVEST) : false;
    }
    public boolean harvestRandom(obj_id droid, obj_id player, obj_id corpse, int interest, int[] hasResource)
    {
    ...
    public boolean harvestCreature(obj_id droid, obj_id player, obj_id target, int interest)
    {
        if (!isIdValid(player) || !isIdValid(target))
        {
            setOnHarvestRun(droid, false);
    ...
    public int calculateDroidBonus(int droidSkillMod)
    {
        double remainder = 0;
