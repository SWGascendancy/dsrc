...
public class droid_bomb extends script.base_script
{
    ...
    public int msgDetonationCountdown(obj_id self, dictionary params)
    {
    ...
    public int msgDetonationWarmup(obj_id self, dictionary params)
    {
        utils.removeScriptVar(self, "module_data.detonation_warmup");
        return SCRIPT_CONTINUE;
    }
    public void detonateDroid(obj_id droid)
    {
        if (!isIdValid(droid))
        {
