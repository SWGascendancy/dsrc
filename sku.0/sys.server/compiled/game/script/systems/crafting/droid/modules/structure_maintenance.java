...
public class structure_maintenance extends script.base_script
{
    ...
    public String getCurrentMaintList()
    {
        obj_id self = getSelf();
    ...
    public int currentMaintListCount()
    {
        obj_id self = getSelf();
        Vector maintListNames = utils.getResizeableStringArrayScriptVar(self, "maintList.name");
    ...
    public boolean isInMaintList(obj_id structure)
    {
        obj_id self = getSelf();
        Vector maintListIds = utils.getResizeableObjIdArrayScriptVar(self, "maintList.id");
    ...
    public int handleMaintenanceListDialog(obj_id self, dictionary params)
    {
    ...
    public void addStructureForMaintenance(obj_id self, obj_id player, int idx)
    {
        if (idx < 0)
        {
    ...
    public int handleMaintenanceAmountDialog(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public boolean validateMaintenanceCost(obj_id player, int amount)
    {
        obj_id self = getSelf();
        int travelCost = 0;
    ...
    public int getStoredBankBalance(obj_id structure)
    {
        obj_id self = getSelf();
        obj_id[] struct_list = getObjIdArrayObjVar(self, "module_data.maint_list.ids");
    ...
    public int getTravelCost(obj_id player, String structPlanet)
    {
    ...
    public int getPlanetIdx(String planet)
    {
    ...
    public void startMaintenanceRun(obj_id self, obj_id player)
    {
        Vector maintListIds = utils.getResizeableObjIdArrayScriptVar(self, "maintList.id");
        Vector maintListLocs = utils.getResizeableLocationArrayScriptVar(self, "maintList.loc");
        Vector maintListAmounts = utils.getResizeableIntArrayScriptVar(self, "maintList.amount");
    ...
    public int getMaintRunTime(obj_id player, obj_id structure, location structLoc)
    {
        float distance = 0;
        int planetHops = 0;
    ...
    public int countPlanetHops(obj_id player, String structPlanet)
    {
        String startPlanet = getLocation(player).area;
        String destPlanet = structPlanet;
    ...
    public void editMaintenanceList()
    {
        obj_id self = getSelf();
        obj_id player = utils.getObjIdScriptVar(self, "player");
        obj_id[] struct_list = getObjIdArrayObjVar(self, "module_data.maint_list.ids");
    ...
    public int handleEditMaintListDialog(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public boolean isSamePlanet(obj_id player, String structPlanet)
    {
        location playerLoc = getLocation(player);
        return (playerLoc.area.equals(structPlanet));
    }
    public int returnRequestedBankBalance(obj_id self, dictionary params)
    {
    ...
    public int returnRequestedName(obj_id self, dictionary params)
    {
    ...
    public void executeMaintenanceCommand()
    {
        obj_id self = getSelf();
