...
public class merchant_barker extends script.base_script
{
    ...
    public int OnHearSpeech(obj_id self, obj_id player, String message)
    {
    ...
    public int msgMerchantBark(obj_id self, dictionary params)
    {
        if (ai_lib.isAiDead(self))
        {
            utils.removeScriptVar(self, SCRIPT_VAR_BARKING_ON);
    ...
    public int msgResetCanBark(obj_id self, dictionary params)
    {
        utils.setScriptVar(self, pet.CAN_BARK, true);
        return SCRIPT_CONTINUE;
    }
    public int msgDroidWaypointSelected(obj_id self, dictionary params)
    {
        if (ai_lib.isAiDead(self))
        {
            return SCRIPT_CONTINUE;
