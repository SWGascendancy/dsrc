...
public class trap_thrower extends script.base_script
{
    ...
    public int doRadialTrapAdd(obj_id self, dictionary params)
    {
    ...
    public int doPetThrowTrap(obj_id self, dictionary params)
    {
    ...
    public void doTrapCombatResults(obj_id self, obj_id target, obj_id trap, obj_id player)
    {
    ...
    public int doDelayedFire(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
    ...
    public void transferDataFromTrapToDroid(obj_id player, obj_id trap)
    {
        obj_id self = getSelf();
    ...
    public boolean isCurrentTrap(obj_id droid, obj_id item)
    {
    ...
    public int getAdditiveTrapCount(obj_id droid, obj_id trap, obj_id player)
    {
        if (hasObjVar(droid, DROID_TRAP))
        {
    ...
    public boolean isAtTrapLoadMax(obj_id droid, int checkNum)
    {
