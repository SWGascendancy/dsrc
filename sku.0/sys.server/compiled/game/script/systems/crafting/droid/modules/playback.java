...
public class playback extends script.base_script
{
    ...
    public int handleModuleAccess(obj_id self, dictionary params)
    {
    ...
    public int handleRecordTimeout(obj_id self, dictionary params)
    {
        int recStatus = -1;
    ...
    public int handlePerformerStartPerforming(obj_id self, dictionary params)
    {
        obj_id master = getMaster(self);
    ...
    public int handleRecordFinished(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        if (!hasObjVar(self, MODULE_OBJVAR + ".recording"))
        {
    ...
    public int handleDeleteConfirm(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        if (!isIdValid(player))
        {
    ...
    public void accessPlaybackModule(obj_id self, obj_id player)
    {
        int modules = getIntObjVar(self, MODULE_OBJVAR + ".modules");
        int[] tracks = getIntArrayObjVar(self, MODULE_OBJVAR + ".tracks");
        if (tracks == null || tracks.length == 0)
    ...
    public void startRecording(obj_id self, obj_id player, int idx)
    {
        int[] tracks = getIntArrayObjVar(self, MODULE_OBJVAR + ".tracks");
        if (tracks[idx] != 0)
        {
    ...
    public void stopRecording(obj_id self)
    {
    ...
    public void confirmDeleteTrack(obj_id self, obj_id player, int idx)
    {
        int[] tracks = getIntArrayObjVar(self, MODULE_OBJVAR + ".tracks");
        if (tracks[idx] == 0)
        {
    ...
    public void playTrack(obj_id self, obj_id player, int idx)
    {
        if (idx == 0)
        {
            return;
    ...
    public dictionary getPerformanceData(int index)
    {
        index--;
    ...
    public String parseTrackName(int index)
    {
