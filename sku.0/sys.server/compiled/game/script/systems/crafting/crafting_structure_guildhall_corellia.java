...
public class crafting_structure_guildhall_corellia extends script.base_script
{
    public crafting_structure_guildhall_corellia()
    {
    }
    ...
    public static final String PLAYER_GUILDHALL_CORELLIA_STYLE_01 = "player_guildhall_corellia_style_01";
    public int OnInitialize(obj_id self)
    {
        ...
        if (buildingTemplate.indexOf(PLAYER_GUILDHALL_CORELLIA_STYLE_01) > 0)
        {
