...
public class crafting_base_dna_template extends script.systems.crafting.crafting_base
{
    ...
    public float calcResourceQualitySkillMod(dictionary craftingValuesDictionary)
    {
    ...
    public float getAttributeResourceMod(float averagedAttributeSum)
    {
    ...
    public float computeComponentWeightedAverage(dictionary craftingValuesDictionary, resource_weight.weight[] weights)
    {
        float total = 0;
        int count = 0;
    ...
    public int calcSkillDesignAssemblyCheck(obj_id player, dictionary craftingValuesDictionary, String[] skills)
    {
    ...
    public void calcCraftingDesignStageIngredientAttribAverageValues(dictionary craftingValuesDictionary, draft_schematic.slot[] ingredientSlots, resource_weight[] slotWeights)
    {
    ...
    public void calcResourceMaxItemAttributes(dictionary craftingValuesDictionary, draft_schematic.attribute[] itemAttributes, resource_weight[] weights)
    {
        calcResourceMaxItemAttributes(null, craftingValuesDictionary, itemAttributes, weights);
    }
    public void calcResourceMaxItemAttributes(obj_id player, dictionary craftingValuesDictionary, draft_schematic.attribute[] itemAttributes, resource_weight[] weights)
    {
    ...
    public void calcPostAssemblyResourceSetAttribValues(dictionary craftingValuesDictionary, draft_schematic.attribute[] itemAttributes, resource_weight[] weights)
    {
        float[] averageResourceValues = craftingValuesDictionary.getFloatArray(craftinglib.RESOURCE_AVERAGE_DICTIONARY_NAME);
    ...
    public int calcAssemblyPhaseAttributes(obj_id player, draft_schematic.slot[] itemIngredients, draft_schematic.attribute[] itemAttributes, dictionary craftingValuesDictionary, String[] playerSkillMods, resource_weight[] maxResourceAttribWeights, resource_weight[] resourceAttribWeights)
    {
    ...
    public int OnManufacturingSchematicCreation(obj_id self, obj_id player, obj_id prototype, draft_schematic schematic, modifiable_int assemblyResult, modifiable_int experimentPoints)
    {
