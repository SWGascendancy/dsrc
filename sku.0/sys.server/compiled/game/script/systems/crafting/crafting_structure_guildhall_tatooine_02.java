...
public class crafting_structure_guildhall_tatooine_02 extends script.base_script
{
    public crafting_structure_guildhall_tatooine_02()
    {
    }
    ...
    public static final String PLAYER_GUILDHALL_TATOOINE_STYLE_02 = "player_guildhall_tatooine_style_02";
    public int OnInitialize(obj_id self)
    {
        ...
        if (buildingTemplate.indexOf(PLAYER_GUILDHALL_TATOOINE_STYLE_02) > 0)
        {
