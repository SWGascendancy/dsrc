...
public class crafting_structure_merchant_tent extends script.base_script
{
    public crafting_structure_merchant_tent()
    {
    }
    ...
    public static final String PLAYER_PGC_MERCHANT_TENT_S01 = "player_pgc_merchant_tent_s01";
    public int OnInitialize(obj_id self)
    {
        ...
        if (buildingTemplate.indexOf(PLAYER_PGC_MERCHANT_TENT_S01) > 0)
        {
            spawnInvCraftingStation(self, craftinglib.STATION_TYPE_MERCHANT_TENT);
        }
        return SCRIPT_CONTINUE;
    }
