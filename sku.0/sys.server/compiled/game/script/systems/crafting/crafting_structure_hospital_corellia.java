...
public class crafting_structure_hospital_corellia extends script.base_script
{
    public crafting_structure_hospital_corellia()
    {
    }
    ...
    public static final String HOSPITAL_CORELLIA = "hospital_corellia";
    public int OnInitialize(obj_id self)
    {
        ...
        if (buildingTemplate.indexOf(HOSPITAL_CORELLIA) > 0)
        {
