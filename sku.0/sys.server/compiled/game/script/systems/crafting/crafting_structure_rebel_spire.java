...
public class crafting_structure_rebel_spire extends script.base_script
{
    public crafting_structure_rebel_spire()
    {
    }
    ...
    public static final String PLAYER_HOUSE_TCG_REBEL_SPIRE = "player_house_tcg_rebel_spire";
    public int OnInitialize(obj_id self)
    {
        ...
        if (buildingTemplate.indexOf(PLAYER_HOUSE_TCG_REBEL_SPIRE) > 0)
        {
