...
public class analysis_tool extends script.base_script
{
    ...
    public void showComponentSui(obj_id target, obj_id player, obj_id[] items)
    {
    ...
    public void cleanupComponentSui(obj_id player)
    {
        utils.removeScriptVar(player, SCRIPTVAR_ANALYZE_SUI);
        utils.removeBatchScriptVar(player, SCRIPTVAR_ANALYZE_IDS);
    }
    public int handleAnalyzeComponent(obj_id self, dictionary params)
    {
    ...
    public void grantSchematic(obj_id player, obj_id item)
    {
