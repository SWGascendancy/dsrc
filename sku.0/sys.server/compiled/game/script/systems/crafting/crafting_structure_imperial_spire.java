...
public class crafting_structure_imperial_spire extends script.base_script
{
    public crafting_structure_imperial_spire()
    {
    }
    ...
    public static final String PLAYER_HOUSE_TCG_EMPERORS_SPIRE = "player_house_tcg_emperors_spire";
    public int OnInitialize(obj_id self)
    {
        ...
        if (buildingTemplate.indexOf(PLAYER_HOUSE_TCG_EMPERORS_SPIRE) > 0)
        {
            spawnInvCraftingStation(self, craftinglib.STATION_TYPE_SPIRE);
        }
        return SCRIPT_CONTINUE;
    }
