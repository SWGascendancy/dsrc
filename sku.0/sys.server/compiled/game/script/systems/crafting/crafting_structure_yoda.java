...
public class crafting_structure_yoda extends script.base_script
{
    public crafting_structure_yoda()
    {
    }
    ...
    public static final String PLAYER_HOUSE_TCG_8_YODA_HOUSE = "player_house_tcg_8_yoda_house";
    public int OnInitialize(obj_id self)
    {
        ...
        if (buildingTemplate.indexOf(PLAYER_HOUSE_TCG_8_YODA_HOUSE) > 0)
        {
            spawnInvCraftingStation(self, craftinglib.STATION_TYPE_YODA);
        }
        return SCRIPT_CONTINUE;
    }
