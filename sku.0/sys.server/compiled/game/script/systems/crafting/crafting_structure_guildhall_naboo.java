...
public class crafting_structure_guildhall_naboo extends script.base_script
{
    public crafting_structure_guildhall_naboo()
    {
    }
    ...
    public static final String PLAYER_GUILDHALL_NABOO_STYLE_01 = "player_guildhall_naboo_style_01";
    public int OnInitialize(obj_id self)
    {
        ...
        if (buildingTemplate.indexOf(PLAYER_GUILDHALL_NABOO_STYLE_01) > 0)
        {
