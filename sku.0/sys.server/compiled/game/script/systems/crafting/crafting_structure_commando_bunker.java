...
public class crafting_structure_commando_bunker extends script.base_script
{
    public crafting_structure_commando_bunker()
    {
    }
    ...
    public static final String PLAYER_HOUSE_TCG_COMMANDO_BUNKER = "player_house_tcg_commando_bunker";
    public int OnInitialize(obj_id self)
    {
        ...
        if (buildingTemplate.indexOf(PLAYER_HOUSE_TCG_COMMANDO_BUNKER) > 0)
        {
            spawnInvCraftingStation(self, craftinglib.STATION_TYPE_COMMANDO_BUNKER);
        }
        return SCRIPT_CONTINUE;
    }
