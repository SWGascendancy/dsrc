...
public class crafting_structure_guildhall_tatooine_01 extends script.base_script
{
    public crafting_structure_guildhall_tatooine_01()
    {
    }
    ...
    public static final String PLAYER_GUILDHALL_TATOOINE_STYLE_01 = "player_guildhall_tatooine_style_01";
    public int OnInitialize(obj_id self)
    {
        ...
        if (buildingTemplate.indexOf(PLAYER_GUILDHALL_TATOOINE_STYLE_01) > 0)
        {
            spawnInvCraftingStation(self, craftinglib.STATION_TYPE_GUILDHALL);
        }
        return SCRIPT_CONTINUE;
    }
