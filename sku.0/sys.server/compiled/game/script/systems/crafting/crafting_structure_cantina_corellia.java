...
public class crafting_structure_cantina_corellia extends script.base_script
{
    public crafting_structure_cantina_corellia()
    {
    }
    ...
    public static final String CANTINA_CORELLIA = "cantina_corellia";
    public int OnInitialize(obj_id self)
    {
        ...
        if (buildingTemplate.indexOf(CANTINA_CORELLIA) > 0)
        {
