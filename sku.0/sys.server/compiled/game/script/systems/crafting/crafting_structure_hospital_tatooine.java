...
public class crafting_structure_hospital_tatooine extends script.base_script
{
    public crafting_structure_hospital_tatooine()
    {
    }
    ...
    public static final String HOSPITAL_TATOOINE = "hospital_tatooine";
    public int OnInitialize(obj_id self)
    {
        ...
        if (buildingTemplate.indexOf(HOSPITAL_TATOOINE) > 0)
        {
            spawnInvCraftingStation(self, craftinglib.STATION_TYPE_HOSPITAL);
        }
        return SCRIPT_CONTINUE;
    }
