...
public class crafting_structure_barn extends script.base_script
{
    public crafting_structure_barn()
    {
    }
    ...
    public static final String BARN_NO_PLANET_RESTRICTION = "barn_no_planet_restriction";
    public int OnInitialize(obj_id self)
    {
        ...
        if (buildingTemplate.indexOf(BARN_NO_PLANET_RESTRICTION) > 0)
        {
            spawnInvCraftingStation(self, craftinglib.STATION_TYPE_BARN);
        }
        return SCRIPT_CONTINUE;
    }
