...
public class crafting_base extends script.base_script
{
    ...
    public boolean calcAndSetPrototypeProperty(obj_id prototype, draft_schematic.attribute itemAttribute)
    {
    ...
    public void grantExperience(obj_id player, draft_schematic.slot[] slots)
    {
        if (slots == null)
        {
            return;
    ...
    public int OnCraftingExperiment(obj_id self, obj_id player, obj_id prototype, string_id[] attributeNames, int[] experimentPoints, int totalPoints, modifiable_int experimentResult, int coreLevel)
    {
    ...
    public int doCraftingExperiment(obj_id self, obj_id player, obj_id prototype, string_id[] attributeNames, int[] experimentPoints, int totalPoints, modifiable_int experimentResult, int coreLevel)
    {
    ...
    public int OnFinalizeSchematic(obj_id self, obj_id player, obj_id prototype, draft_schematic schematic)
    {
        int myDraftSchematic = getDraftSchematicCrc(self);
    ...
    public int getInspirationBuffXpBonus(obj_id self, int category, int amt)
    {
    ...
    public int OnMakeCraftedItem(obj_id self, obj_id prototype, draft_schematic schematic, float qualityPercent)
    {
        draft_schematic.attribute[] objectAttribs = schematic.getAttribs();
    ...
    public int OnRequestResourceWeights(obj_id self, obj_id player, String[] desiredAttribs, String[] attribs, int[] slots, int[] counts, int[] data)
    {
        int attribIndex = 0;
        int dataIndex = 0;
