...
public class crafting_structure_cantina_naboo extends script.base_script
{
    public crafting_structure_cantina_naboo()
    {
    }
    ...
    public static final String CANTINA_NABOO = "cantina_naboo";
    public int OnInitialize(obj_id self)
    {
        ...
        if (buildingTemplate.indexOf(CANTINA_NABOO) > 0)
        {
