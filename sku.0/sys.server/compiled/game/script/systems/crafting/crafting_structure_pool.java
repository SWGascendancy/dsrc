...
public class crafting_structure_pool extends script.base_script
{
    public crafting_structure_pool()
    {
    }
    ...
    public static final String PLAYER_HOUSE_TCG_RELAXATION_POOL = "player_house_tcg_relaxation_pool";
    public int OnInitialize(obj_id self)
    {
        ...
        if (buildingTemplate.indexOf(PLAYER_HOUSE_TCG_RELAXATION_POOL) > 0)
        {
