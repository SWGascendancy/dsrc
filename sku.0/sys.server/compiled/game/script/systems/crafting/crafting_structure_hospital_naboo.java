...
public class crafting_structure_hospital_naboo extends script.base_script
{
    public crafting_structure_hospital_naboo()
    {
    }
    ...
    public static final String HOSPITAL_NABOO = "hospital_naboo";
    public int OnInitialize(obj_id self)
    {
        ...
        if (buildingTemplate.indexOf(HOSPITAL_NABOO) > 0)
        {
