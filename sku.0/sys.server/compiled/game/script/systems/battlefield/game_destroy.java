...
public class game_destroy extends script.base_script
{
    ...
    public int msgGameScriptPulse(obj_id self, dictionary params)
    {
        return SCRIPT_CONTINUE;
    }
    ...
    public int msgEliminateFaction(obj_id self, dictionary params)
    {
    ...
    public int msgTimeExpired(obj_id self, dictionary params)
    {
    ...
    public int msgGameStats(obj_id self, dictionary params)
    {
    ...
    public void declareWinner(obj_id master_object, String faction)
    {
