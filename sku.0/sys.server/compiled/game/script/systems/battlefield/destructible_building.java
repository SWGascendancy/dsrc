...
public class destructible_building extends script.base_script
{
    ...
    public int msgRefreshSmoke(obj_id self, dictionary params)
    {
        int smoke_level = 0;
    ...
    public int msgConstructionComplete(obj_id self, dictionary params)
    {
    ...
    public int msgRepairPulse(obj_id self, dictionary params)
    {
    ...
    public int battlefieldObjectDestroyed(obj_id self, dictionary params)
    {
        battlefield.removeBattlefieldObject(self);
        return SCRIPT_CONTINUE;
    }
