...
public class battlefield_region extends script.base_script
{
    ...
    public int OnTriggerVolumeEntered(obj_id self, String triggerVolumeName, obj_id breacher)
    {
    ...
    public int msgInitializeRegion(obj_id self, dictionary params)
    {
    ...
    public int msgStartGame(obj_id self, dictionary params)
    {
        LOG("LOG_CHANNEL", "battlefield_region::msgStartGame");
        battlefield.startBattlefield(self);
        return SCRIPT_CONTINUE;
    }
    public int msgGameTimePulse(obj_id self, dictionary params)
    {
    ...
    public int msgAddPlayerToBattlefield(obj_id self, dictionary params)
    {
    ...
    public int msgBattlefieldKill(obj_id self, dictionary params)
    {
        return SCRIPT_CONTINUE;
    }
    public int msgCreateBattlefieldChat(obj_id self, dictionary params)
    {
        String chat_room_all = battlefield.getChatRoomNameAllFactions(self);
        String name = battlefield.getBattlefieldName(self);
        LOG("LOG_CHANNEL", "battlefield_region::msgInitializeRegion -- creating chatroom " + chat_room_all);
    ...
    public int msgGameStatHistory(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
