...
public class consume_loot extends script.base_script
{
    ...
    public int handlerSuiAddToCollection(obj_id self, dictionary params)
    {
        obj_id collectionItem = self;
    ...
    public int onCollectionListResponse(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public boolean getUiConsumeMessageBox(obj_id self, obj_id player)
    {
