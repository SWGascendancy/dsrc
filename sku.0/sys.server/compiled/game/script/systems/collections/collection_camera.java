...
public class collection_camera extends script.base_script
{
    ...
    public boolean checkValidCreature(obj_id player, obj_id target)
    {
    ...
    public void tagTheCreature(obj_id player, obj_id photoTarget)
    {
    ...
    public void photoSlotComplete(obj_id player)
    {
