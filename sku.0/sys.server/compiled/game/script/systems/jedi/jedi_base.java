...
public class jedi_base extends script.base_script
{
    ...
    public void doJediHealingSpam(int intStat, int intDamageType, int intAmount, obj_id objPlayer, obj_id objTarget)
    {
    ...
    public dictionary modifyJediHealDataFromAlignment(obj_id objPlayer, dictionary dctJediInfo)
    {
    ...
    public int performJediHealCommand(obj_id player, obj_id target, dictionary actionData)
    {
    ...
    public boolean doJediHealCommand(obj_id self, obj_id target, String strCommand)
    {
        ...
        // To whover did this, "weapon_data" is not found, please fix this -Iosnowore
        ...
        {
            //combat.drainCombatActionAttributes(self, actionCost); // Iosnowore
    ...
    public void findNewSkillTrainer(obj_id self)
    {
