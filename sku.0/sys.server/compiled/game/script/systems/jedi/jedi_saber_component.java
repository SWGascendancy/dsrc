...
public class jedi_saber_component extends script.base_script
{
    ...
    public int setCrystalLevel(obj_id self, dictionary params)
    {
    ...
    public void verifyTune(obj_id player)
    {
        obj_id self = getSelf();
    ...
    public int handleVerifyTune(obj_id self, dictionary params)
    {
    ...
    public void tuneCrystal(obj_id player)
    {
        obj_id self = getSelf();
    ...
    public int distributedRand(int min, int max, int level)
    {
    ...
    public void csLogCrystal(obj_id crystal, String state)
    {
