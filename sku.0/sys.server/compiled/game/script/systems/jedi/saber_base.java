...
public class saber_base extends script.base_script
{
    ...
    public void openSaber(obj_id player)
    {
        obj_id self = getSelf();
        obj_id inv = getObjectInSlot(self, "saber_inv");
        utils.requestContainerOpen(player, inv);
    }
    public int handleResetSaberStats(obj_id self, dictionary params)
    {
        jedi.resetSaberStats(self);
        return SCRIPT_CONTINUE;
    }
    public int decaySaberCrystal(obj_id self, dictionary params)
    {
    ...
    public void dismantleSaber(obj_id player)
    {
        obj_id self = getSelf();
