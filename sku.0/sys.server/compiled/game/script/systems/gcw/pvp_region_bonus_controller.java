...
public class pvp_region_bonus_controller extends script.base_script
{
    ...
    public boolean isCycleActive(obj_id self)
    {
    ...
    public void setCycleActiveState(obj_id self, boolean state)
    {
        if (state)
        {
    ...
    public int itterateCycle(obj_id self)
    {
    ...
    public int cycleUpdate(obj_id self, dictionary params)
    {
