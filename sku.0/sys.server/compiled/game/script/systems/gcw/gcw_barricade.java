...
public class gcw_barricade extends script.base_script
{
    ...
    public int handleGCWBarricade(obj_id self, dictionary params)
    {
    ...
    public int handleQuestCallBack(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int destroyGCWBarricade(obj_id self, dictionary params)
    {
    ...
    public void handleDestroyBarricade(obj_id self, obj_id killer)
    {
