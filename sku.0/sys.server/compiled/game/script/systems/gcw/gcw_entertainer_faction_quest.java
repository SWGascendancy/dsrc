...
public class gcw_entertainer_faction_quest extends script.base_script
{
    ...
    public int readyToTalk(obj_id self, dictionary params)
    {
        if (!isValidId(self) || !exists(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int lostInterest(obj_id self, dictionary params)
    {
    ...
    public int convinced(obj_id self, dictionary params)
    {
    ...
    public int notConvinced(obj_id self, dictionary params)
    {
