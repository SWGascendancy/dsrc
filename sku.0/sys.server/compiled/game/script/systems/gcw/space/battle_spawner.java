...
public class battle_spawner extends script.base_class {
    ...
    public static float BATTLE_TIME_PREPATORY = 300.0f;  // 900 == 15 minutes
    public static float BATTLE_TIME_LENGTH = 3600.0f;  // 3600 == 60 minutes
    public static int MAX_SUPPORT_CRAFT = 20;
    public static int MAX_SUPPORT_SPAWN = 40;
    public static final float HERO_SPAWN_CHANCE = 0.2f;  // 0.20d == 20% chance a hero will spawn
    public static final float PVP_POINT_MULTIPLIER = 2.0f;
    public static final float PVE_POINT_MULTIPLIER = 1.0f;
    public static final float PVP_TOKEN_MULTIPLIER = 2.0f;
    public static final float PVE_TOKEN_MULTIPLIER = 1.0f;
    public static final float WIN_POINT_MULTIPLIER = 2.0f;
    public static final float LOSS_POINT_MULTIPLIER = 1.0f;
    public static final float WIN_TOKEN_MULTIPLIER = 2.0f;
    public static final float LOSS_TOKEN_MULTIPLIER = 1.0f;
    public static final int POB_PLAYER_CEILING = 6;
    public static final int GUNSHIP_PLAYER_CEILING = 12;
    public static final int TOKEN_AWARD = 25;
    public static final int POINT_AWARD = 750;  // adjusted because normal bonus gcw is set at 5x
    ...
    public int registerWithController(obj_id self, dictionary params) {
    ...
    public int startSpaceGCWBattle(obj_id self, dictionary params) {
        ...
        //spaceLog( "In startSpaceGCWBattle... starting battle in " + BATTLE_TIME_PREPATORY / 60.0f + " minutes.");
    ...
    public int spawnSupportCraft(obj_id self, dictionary params) {
    ...
    public static Vector spawnSupportShips(obj_id motherShip){
        ...
        for (int i = shipList.size(); i < MAX_SUPPORT_SPAWN; i++) {
    ...
    private static obj_id spawnStandardShip(obj_id motherShip){
    ...
    private static obj_id spawnAcePilot(obj_id motherShip) {
        int totalSpawnedThisFight = 0;
        if(hasObjVar(motherShip, "totalSpawnedSupportCraft")){
            totalSpawnedThisFight = getIntObjVar(motherShip, "totalSpawnedSupportCraft");
            if(totalSpawnedThisFight >= MAX_SUPPORT_SPAWN)
    ...
    public static obj_id createUnit(obj_id centralObject, String unitName, float radius)
    {
    ...
    public int endBattle(obj_id self, dictionary params) {
    ...
    public void distributeAwards(obj_id self, dictionary params) {
    ...
    public List<obj_id> processShip(obj_var_list qualifiedShips, int playerCeiling, obj_id self, List<obj_id> pointAwardedPlayers, String attackingFaction, boolean imperialsWon, String shipType, String battleType, String battleId){
    ...
    public void handlePlayerAwards(obj_id player, String attackingFaction, boolean imperialsWon, String shipType, String battleType, String battleId, float pointAdjustmentValue) {
    ...
    public boolean awardGcwTokens(obj_id player, int quantity, String factionType){
    ...
    public int calculateAwardedPoints(boolean wonBattle, String battleType) {
        if(!wonBattle){
            if(battleType.equals(BATTLE_TYPE_PVE)){
                return new Float(POINT_AWARD * PVE_POINT_MULTIPLIER * LOSS_POINT_MULTIPLIER).intValue();
            }
            else {
                return new Float(POINT_AWARD * PVP_POINT_MULTIPLIER * LOSS_POINT_MULTIPLIER).intValue();
            }
        }
        else{
            if(battleType.equals(BATTLE_TYPE_PVE)){
                return new Float(POINT_AWARD * PVE_POINT_MULTIPLIER * WIN_POINT_MULTIPLIER).intValue();
            }
            else {
                return new Float(POINT_AWARD * PVP_POINT_MULTIPLIER * WIN_POINT_MULTIPLIER).intValue();
            }
        }
    ...
    public int calculateAwardedTokens(boolean wonBattle, String battleType, String faction) {
        if(!wonBattle){
            if(battleType.equals(BATTLE_TYPE_PVE)){
                return new Float(TOKEN_AWARD * PVE_TOKEN_MULTIPLIER * LOSS_POINT_MULTIPLIER).intValue();
            }
            else{
                return new Float(TOKEN_AWARD * PVP_TOKEN_MULTIPLIER * LOSS_POINT_MULTIPLIER).intValue();
            }
        }
        else {
            if(battleType.equals(BATTLE_TYPE_PVE)){
                return new Float(TOKEN_AWARD * PVE_TOKEN_MULTIPLIER * WIN_POINT_MULTIPLIER).intValue();
            }
            else{
                return new Float(TOKEN_AWARD * PVP_TOKEN_MULTIPLIER * WIN_POINT_MULTIPLIER).intValue();
            }
        }

    }
    public void cleanup(dictionary params) {
    ...
    public static void spaceLog(String message){
        ...
        //System.out.println("space_gcw: Zone " + zone + ": " + message);
    }
}
