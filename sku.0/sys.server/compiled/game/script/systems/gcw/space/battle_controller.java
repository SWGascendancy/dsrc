...
public class battle_controller extends script.base_script {
    ...
    public final int TATOOINE_DELAY = 3;
    public final int CORELLIA_DELAY = 3;
    public final int DANTOOINE_DELAY = 3;
    public final int LOK_DELAY = 3;
    public final int NABOO_DELAY = 3;

    public final int TATOOINE_STAGGER = 0;
    public final int CORELLIA_STAGGER = 2;
    public final int DANTOOINE_STAGGER = 0;
    public final int LOK_STAGGER = 2;
    public final int NABOO_STAGGER = 4;
    ...
    public static final boolean tatooineActive = true;
    public static final boolean corelliaActive = true;
    public static final boolean dantooineActive = true;
    public static final boolean lokActive = true;
    public static final boolean nabooActive = true;
    ...
    private void handlePendingBattleWarning(obj_id spawner, String scene) {
        ...
        if(msg != null) {
            chatSendToRoom("SWG." + getGalaxyName() + ".Pilot", msg, null);
        }
    }
    ...
    * Stagger is the amount of time (in hours) to stagger the battles.
    ...
    private static void log(String title, String sum) {
