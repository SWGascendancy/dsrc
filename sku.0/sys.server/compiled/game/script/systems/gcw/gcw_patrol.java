...
public class gcw_patrol extends script.base_script
{
    ...
    public int getConstructionQuestsCompleted(obj_id pylon)
    {
        int completed = 0;
    ...
    public int handleGCWPatrol(obj_id self, dictionary params)
    {
        int faction = -1;
        if (utils.hasScriptVar(self, "faction"))
        {
    ...
    public int getSchedulerNPCs(obj_id kit, String npcID)
    {
        if (!isIdValid(kit) || !exists(kit))
        {
            return -1;
    ...
    public int destroyGCWPatrol(obj_id self, dictionary params)
    {
        trial.cleanupObject(self);
        return SCRIPT_CONTINUE;
    }
    public int handleOffensiveEntertainedNpcCleanUp(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int flagGCWPatrolEntertained(obj_id self, dictionary params)
    {
        obj_id kit = utils.getObjIdScriptVar(self, "creator");
        if (!isValidId(kit))
        {
    ...
    public int removeGCWPatrolEntertained(obj_id self, dictionary params)
    {
    ...
    public void handleDestroyPatrol(obj_id self, obj_id killer)
    {
