...
public class objective_terminal_override extends script.faction_perk.hq.objective_object
{
    ...
    public String[] constructDNAStrand(obj_id self)
    {
    ...
    public void startDNASequencing(obj_id self, obj_id player)
    {
    ...
    public void doSequencing(obj_id self, obj_id player)
    {
