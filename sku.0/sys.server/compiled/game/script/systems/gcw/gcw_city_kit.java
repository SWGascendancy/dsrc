...
public class gcw_city_kit extends script.base_script
{
    ...
    public void destroyKitObj(obj_id self)
    {
    ...
    public boolean hasConstructionQuests()
    {
        return true;
    }
    ...
    public int beginConstruction(obj_id self, dictionary params)
    {
        if (!isIdValid(self) || !exists(self))
        {
            return SCRIPT_CONTINUE;
