...
public class objective_power_regulator extends script.faction_perk.hq.objective_object
{
    ...
    public void setForOverload(obj_id self, obj_id player)
    {
    ...
    public void randomizeSwitches(obj_id self)
    {
    ...
    public boolean[] flipSwitch(boolean[] states, int[] rules, int idx)
    {
        if (states == null || states.length == 0)
        {
            return null;
