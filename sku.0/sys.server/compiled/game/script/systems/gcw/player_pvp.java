...
public class player_pvp extends script.base_script
{
    ...
    public static final int BF_TOKEN_BONUS = utils.getIntConfigSetting("GameServer", "bfTokenBonus");
    ...
    public obj_id getBattlefieldController(obj_id self)
    {
    ...
    public int receiveLeaveGroup(obj_id self, dictionary params)
    {
        group.leaveGroup(self);
        sendSystemMessage(self, SID_BATTLEFIELD_OPPOSITE_FACTION_GROUP);
        return SCRIPT_CONTINUE;
    }
    public int cmdBattlefield(obj_id self, obj_id target, String params, float defaultTime)
    {
        battlefieldCommandSui(self);
        return SCRIPT_CONTINUE;
    }
    public int displayBattlefieldSui(obj_id self, dictionary params)
    {
        battlefieldCommandSui(self);
        return SCRIPT_CONTINUE;
    }
    public void battlefieldCommandSui(obj_id self)
    {
        if (!isIdValid(self))
        {
            return;
    ...
    public void requestBattlefieldStatus(obj_id self)
    {
    ...
    public int receiveBattlefieldStatus(obj_id self, dictionary params)
    {
    ...
    public int onBattlefieldCommandResponse(obj_id self, dictionary params)
    {
    ...
    public String formatBattlefieldCountdown(int seconds)
    {
        if (seconds < 0)
        {
            return "0 seconds";
    ...
    public void showBattlefieldScoreboard(obj_id self)
    {
        if (utils.hasScriptVar(self, "battlefield.pid"))
        {
            int pid = utils.getIntScriptVar(self, "battlefield.pid");
    ...
    public boolean canReceiveReward(obj_id self)
    {
    ...
    public void showBattlefieldFinalScoreboard(obj_id self, String battlefieldName)
    {
        if (utils.hasScriptVar(self, "battlefield.pid"))
        {
            int pid = utils.getIntScriptVar(self, "battlefield.pid");
    ...
    public int receiveBattlefieldFinale(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int receiveBattlefieldTerminalCapture(obj_id self, dictionary params)
    {
    ...
    public int receiveBattlefieldQueueAcceptance(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int receiveBattlefieldInvitation(obj_id self, dictionary params)
    {
    ...
    public int receiveBattlefieldOver(obj_id self, dictionary params)
    {
    ...
    public int onBattlefieldInvitationAccept(obj_id self, dictionary params)
    {
    ...
    public int receiveBattlefieldSetupWarp(obj_id self, dictionary params)
    {
        if (!utils.hasScriptVar(self, "battlefield.invited"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int onBattlefieldInvitationExpire(obj_id self, dictionary params)
    {
    ...
    public int receiveBattlefieldQueueRemoval(obj_id self, dictionary params)
    {
        if (!utils.hasScriptVar(self, "battlefield.queue"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int receiveBattlefieldRefusePlayers(obj_id self, dictionary params)
    {
        if (utils.hasScriptVar(self, "battlefield.invitation.pid"))
        {
            int pid = utils.getIntScriptVar(self, "battlefield.invitation.pid");
    ...
    public int receiveBattlefieldPlayParticlePickup(obj_id self, dictionary params)
    {
    ...
    public int receiveBattlefieldWarpLocation(obj_id self, dictionary params)
    {
        utils.removeBatchObjVar(self, gcw.LIST_DAILY_KILL_VALUES);
        messageTo(self, "battlefieldWarp", params, 1.0f, false);
        return SCRIPT_CONTINUE;
    }
    public int battlefieldWarp(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
    ...
    public int receiveBattlefieldAnnouncement(obj_id self, dictionary params)
    {
    ...
    public void cleanupOldSystemObjVar(obj_id self)
    {
    ...
    public int invalidBattlefieldPlayer(obj_id self, dictionary params)
    {
    ...
    public int createBattlefieldWaypoint(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int destroyBattlefieldWaypoint(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
