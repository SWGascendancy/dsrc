...
public class gcw_city extends script.base_script
{
    ...
    */
    ...
    public void qaInstabuild(obj_id[] kits)
    {
    ...
    public void qaInstaclear(obj_id[] kits)
    {
        for (obj_id kit : kits) {
    ...
    public int checkForInvasion(obj_id self, dictionary params)
    {
    ...
    phase starts.
    */
    public int beginInvasion(obj_id self, dictionary params)
    {
    ...
    public void setAnnouncementLocation(obj_id self, String cityName)
    {
    ...
    public int beginInvasionNotifyFactions(obj_id self, dictionary params)
    {
    ...
    */
    public int constructionEndsSoon(obj_id self, dictionary params)
    {
    ...
    about to end.
    */
    public int invasionEndsSoon(obj_id self, dictionary params)
    {
    ...
    public int defenseGeneralUnderSustainedAttack(obj_id self, dictionary params)
    {
    ...
    public int startFactionDefense(obj_id self, dictionary params)
    {
        if (!isIdValid(self) && !exists(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int endConstruction(obj_id self, dictionary params)
    {
    ...
    public void sendSequenceTrigger(obj_id self, String trig)
    {
        dictionary dict = trial.getSessionDict(self);
    ...
    public int invasionHalfWayPoint(obj_id self, dictionary params)
    {
    ...
    */
    public int defendersEvacuate(obj_id self, dictionary params)
    {
    ...
    */
    public int cityAttackUnsuccessful(obj_id self, dictionary params)
    {
    ...
    public int cleanupInvasion(obj_id self, dictionary params)
    {
        if (!isIdValid(self) || !exists(self))
        {
            return SCRIPT_CONTINUE;
    ...
    */
    public int updateGcwMapData(obj_id self, dictionary params)
    {
	...
	*/
    ...
    public boolean verifyCurrentOccupyFaction(obj_id cityObject)
    {
    ...
    public int checkGeneral(obj_id self, dictionary params)
    {
