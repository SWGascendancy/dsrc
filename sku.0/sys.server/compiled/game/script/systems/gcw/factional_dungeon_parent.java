...
public class factional_dungeon_parent extends script.base_script
{
    ...
    public int resetDungeon(obj_id self, dictionary params)
    {
    ...
    public void setupTerminals(obj_id self)
    {
    ...
    public int objectiveCompleted(obj_id self, dictionary params)
    {
    ...
    public int respawnObjective(obj_id self, dictionary params)
    {
    ...
    public obj_id[] getFactionalDungeonSpawners(obj_id objParent)
    {
    ...
    public void swapMobs(obj_id objSpawner, String strFaction)
    {
    ...
    public void changeMobs(obj_id objSpawner, String strFaction)
    {
        String strType = getStringObjVar(objSpawner, "type");
        String strImperial = factions.FACTION_IMPERIAL;
        String strRebel = factions.FACTION_REBEL;
    ...
    public void validateMobs(obj_id objSpawner, String strType, String strFaction)
    {
        String strImperial = factions.FACTION_IMPERIAL;
        String strRebel = factions.FACTION_REBEL;
        if (strFaction.equals(strImperial))
    ...
    public int checkSpawner(obj_id self, dictionary params)
    {
    ...
    public int checkBanner(obj_id self, dictionary params)
    {
        obj_id objSpawner = params.getObjId("objSpawner");
        String strType = getStringObjVar(objSpawner, "type");
        String strFaction = getStringObjVar(self, "strFaction");
