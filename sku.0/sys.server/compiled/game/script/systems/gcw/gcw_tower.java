...
public class gcw_tower extends script.base_script
{
    ...
    public int destroyGCWTower(obj_id self, dictionary params)
    {
    ...
    public void handleDestroyTower(obj_id self, obj_id killer)
    {
    ...
    public int handleGCWTower(obj_id self, dictionary params)
    {
