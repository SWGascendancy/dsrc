...
public class gcw_city_pylon extends script.base_script
{
    ...
    public void updatePylonName(obj_id self)
    {
    ...
    public int handleSetup(obj_id self, dictionary params)
    {
    ...
    public int handleUpdateName(obj_id self, dictionary params)
    {
        updatePylonName(self);
        return SCRIPT_CONTINUE;
    }
    ...
    public int getMaximumQuests(obj_id self)
    {
    ...
    public boolean hasConstructionResources(obj_id player)
    {
        return false;
    }
    public boolean consumeConstructionResources(obj_id player)
    {
        return false;
    }
    ...
    public void startConstructionAttempt(obj_id self, obj_id player)
    {
    ...
    public int handleConstructionAttemptResults(obj_id self, dictionary params)
    {
