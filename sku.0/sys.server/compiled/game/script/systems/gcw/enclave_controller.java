...
public class enclave_controller extends script.base_script
{
    ...
    public int OnClusterWideDataResponse(obj_id self, String manage_name, String enclave_name, int request_id, String[] element_name_list, dictionary[] enclave_data, int lock_key)
    {
    ...
    public int PEFSynchRequest(obj_id self, dictionary params)
    {
    ...
    public int msgVictimizedJediDeath(obj_id self, dictionary params)
    {
        if (params != null)
        {
    ...
    public int XPDeathValidateRequest(obj_id self, dictionary params)
    {
    ...
    public int msgRequestExperienceDebt(obj_id self, dictionary params)
    {
    ...
    public int msgForceEnclaveUpdate(obj_id self, dictionary params)
    {
    ...
    public int msgEnclavePulse(obj_id self, dictionary params)
    {
    ...
    public int msgFRSUpdateClusterData(obj_id self, dictionary params)
    {
