...
public class player_force_rank extends script.base_script
{
    ...
    public int msgResynchFRSData(obj_id self, dictionary params)
    {
        force_rank.validateFRSPlayerData(self);
        return SCRIPT_CONTINUE;
    }
    public int msgMoveToCommonSpot(obj_id self, dictionary params)
    {
        force_rank.moveEnclavedPlayerToNeutralCell(self);
        return SCRIPT_CONTINUE;
    }
    public int PEFSynchResponse(obj_id self, dictionary params)
    {
    ...
    public int msgPvPActionStart(obj_id self, dictionary params)
    {
    ...
    public int msgPvPActionEnd(obj_id self, dictionary params)
    {
        obj_id killer = null;
    ...
    public int XPDeathValidateResponse(obj_id self, dictionary params)
    {
    ...
    public int msgForceRankPromotePlayer(obj_id self, dictionary params)
    {
    ...
    public int msgForceRankDemotePlayer(obj_id self, dictionary params)
    {
        if (params.containsKey("success"))
        {
            boolean success = params.getBoolean("success");
    ...
    public int msgFRSCHallengeViewScores(obj_id self, dictionary params)
    {
    ...
    public int msgFRSChallengeViewChallenges(obj_id self, dictionary params)
    {
    ...
    public int msgFRSChallengeDoneLooking(obj_id self, dictionary params)
    {
        utils.removeScriptVar(self, arena.SCRIPT_VAR_SUI_CH_PID);
        utils.removeScriptVar(self, arena.SCRIPT_VAR_CH_TERMINAL);
        return SCRIPT_CONTINUE;
    }
    public int msgFRSChallengeConfirmAcceptChallenge(obj_id self, dictionary params)
    {
        obj_id terminal = utils.getObjIdScriptVar(self, arena.SCRIPT_VAR_CH_TERMINAL);
        utils.removeScriptVar(self, arena.SCRIPT_VAR_SUI_CH_PID);
        utils.removeScriptVar(self, arena.SCRIPT_VAR_CH_TERMINAL);
    ...
    public int msgFRSChallengeConfirmAcceptChallengeFinal(obj_id self, dictionary params)
    {
        obj_id terminal = utils.getObjIdScriptVar(self, arena.SCRIPT_VAR_CH_TERMINAL);
    ...
    public int msgFRSChallengeConfirmIssueChallenge(obj_id self, dictionary params)
    {
        obj_id terminal = utils.getObjIdScriptVar(self, arena.SCRIPT_VAR_CH_TERMINAL);
        utils.removeScriptVar(self, arena.SCRIPT_VAR_SUI_CH_PID);
        utils.removeScriptVar(self, arena.SCRIPT_VAR_CH_TERMINAL);
    ...
    public int msgFRSVoteStatusSelect(obj_id self, dictionary params)
    {
    ...
    public int msgFRSVoteStatusClosed(obj_id self, dictionary params)
    {
        utils.removeScriptVar(self, SCRIPT_VAR_SUI_PID);
        return SCRIPT_CONTINUE;
    }
    public int msgFRSVoteRecordSelect(obj_id self, dictionary params)
    {
        obj_id terminal = utils.getObjIdScriptVar(self, SCRIPT_VAR_TERMINAL);
        utils.removeScriptVar(self, SCRIPT_VAR_SUI_PID);
        if (!isIdValid(terminal))
    ...
    public int msgFRSVoteRecordPlayer(obj_id self, dictionary params)
    {
        obj_id terminal = utils.getObjIdScriptVar(self, SCRIPT_VAR_TERMINAL);
    ...
    public int msgFRSVotePromotionSelect(obj_id self, dictionary params)
    {
        obj_id terminal = utils.getObjIdScriptVar(self, SCRIPT_VAR_TERMINAL);
        utils.removeScriptVar(self, SCRIPT_VAR_SUI_PID);
        utils.removeScriptVar(self, SCRIPT_VAR_TERMINAL);
    ...
    public int msgFRSVotePetitionSelect(obj_id self, dictionary params)
    {
        obj_id terminal = utils.getObjIdScriptVar(self, SCRIPT_VAR_TERMINAL);
        utils.removeScriptVar(self, SCRIPT_VAR_SUI_PID);
        utils.removeScriptVar(self, SCRIPT_VAR_TERMINAL);
    ...
    public int msgFRSDemoteSelect(obj_id self, dictionary params)
    {
        utils.removeScriptVar(self, SCRIPT_VAR_SUI_PID);
        obj_id enclave = getTopMostContainer(self);
        if (!isIdValid(enclave))
    ...
    public int msgFRSDemotePlayerSelected(obj_id self, dictionary params)
    {
    ...
    public int msgForceRankRenamePlayer(obj_id self, dictionary params)
    {
    ...
    public int msgFRSChalVoteStatusSelect(obj_id self, dictionary params)
    {
    ...
    public int msgFRSChalVoteRecordSelect(obj_id self, dictionary params)
    {
        String[] names = utils.getStringArrayScriptVar(self, SCRIPT_VAR_NAMES);
        obj_id terminal = utils.getObjIdScriptVar(self, SCRIPT_VAR_CHAL_TERMINAL);
        utils.removeScriptVar(self, SCRIPT_VAR_SUI_PID);
    ...
    public int msgFRSChalVoteRecordVote(obj_id self, dictionary params)
    {
        obj_id terminal = utils.getObjIdScriptVar(self, SCRIPT_VAR_CHAL_TERMINAL);
    ...
    public int msgFRSVoteChalSelectRank(obj_id self, dictionary params)
    {
        obj_id terminal = utils.getObjIdScriptVar(self, SCRIPT_VAR_CHAL_TERMINAL);
        utils.removeScriptVar(self, SCRIPT_VAR_CHAL_TERMINAL);
        if (!isIdValid(terminal))
    ...
    public int msgFRSChalSelectConfirm(obj_id self, dictionary params)
    {
        obj_id terminal = utils.getObjIdScriptVar(self, SCRIPT_VAR_CHAL_TERMINAL);
        String[] rank_list = utils.getStringArrayScriptVar(self, SCRIPT_VAR_RANK_LIST);
        utils.removeScriptVar(self, SCRIPT_VAR_SUI_PID);
    ...
    public int handleForceRank(obj_id self, dictionary params)
    {
    ...
    public int handlePlayersInForceRankSelected(obj_id self, dictionary params)
    {
    ...
    public int enclaveIdResponse(obj_id self, dictionary params)
    {
    ...
    public int msgApplyExperienceDebt(obj_id self, dictionary params)
    {
    ...
    public int msgValidateFRSPlayerData(obj_id self, dictionary params)
    {
        if (params == null)
        {
    ...
    public int cmdShowCouncilRank(obj_id self, obj_id target, String params, float defaultTime)
    {
        return SCRIPT_CONTINUE;
    }
}
