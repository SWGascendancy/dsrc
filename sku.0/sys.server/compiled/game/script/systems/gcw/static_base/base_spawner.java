...
public class base_spawner extends script.base_script
{
    ...
    public int handleBeginSpawnRequest(obj_id self, dictionary params)
    {
    ...
    public int handleBaseCleanupRequest(obj_id self, dictionary params)
    {
    ...
    public void spawn(int x, String datatable, obj_id self)
    {
        if (!hasObjVar(self, VAR_BASE_STATUS))
        {
            return;
    ...
    public void setObjectObjVars(obj_id obj, String objVarList)
    {
        if (objVarList == null || objVarList.equals(""))
        {
            return;
