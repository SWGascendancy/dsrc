...
public class base_master extends script.base_script
{
    ...
    public obj_id findMasterObject(obj_id self)
    {
    ...
    public void initializeBase(obj_id self, obj_id master)
    {
        if (isIdValid(master))
        {
    ...
    public void beginTerminalSpawnSequence(obj_id self)
    {
    ...
    public void validateTerminals(obj_id self)
    {
        if (!hasObjVar(self, VAR_TERMINAL_IDS))
        {
            return;
    ...
    public void destroyTerminals(obj_id self)
    {
        if (!hasObjVar(self, VAR_TERMINAL_IDS))
        {
            return;
    ...
    public void testBaseStatusChange(obj_id self)
    {
    ...
    public void beginBaseFactionSwitcheroo(obj_id self, int status)
    {
        setObjVar(self, VAR_BASE_STATUS, status);
    ...
    public int handleBaseInitializationRetry(obj_id self, dictionary params)
    {
    ...
    public int handleTerminalSetup(obj_id self, dictionary params)
    {
        if (!hasObjVar(self, VAR_TERMINAL_IDS))
        {
    ...
    public int handleTerminalSpawnRequest(obj_id self, dictionary params)
    {
        int status = NO_CONTROL;
        if (hasObjVar(self, VAR_BASE_STATUS))
        {
    ...
    public int handleTerminalValidationResponse(obj_id self, dictionary params)
    {
    ...
    public int handleTerminalValidation(obj_id self, dictionary params)
    {
        int[] validate = utils.getIntArrayScriptVar(self, SCRIPT_VAR_VALIDATION);
        if (validate == null || validate.length == 0)
        {
    ...
    public int handleControlUpdate(obj_id self, dictionary params)
    {
        int id = params.getInt("id");
    ...
    public boolean setPlanetaryTerminalStatus(obj_id object, int[] terminalStatus)
    {
        if (!isValidId(object))
        {
            return false;
    ...
    public boolean setPlanetaryBaseStatus(obj_id object, int baseStatus)
    {
        if (!isValidId(object))
        {
            return false;
    ...
    public boolean setPlanetaryCaptureTime(obj_id object)
    {
        if (!isValidId(object))
        {
            return false;
