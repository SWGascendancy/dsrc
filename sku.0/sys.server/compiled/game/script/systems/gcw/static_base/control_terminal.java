...
public class control_terminal extends script.base_script
{
    ...
    public void startControlAttempt(obj_id self, obj_id player)
    {
        int gameTime = getGameTime();
    ...
    public void registerTerminalWithMap(obj_id self)
    {
        int terminalFaction = pvpGetAlignedFaction(self);
        String color = "";
    ...
    public int handleTerminalInitialization(obj_id self, dictionary params)
    {
    ...
    public int handleTerminalValidationRequest(obj_id self, dictionary params)
    {
        obj_id master = params.getObjId("master");
        if (!isIdValid(master))
        {
    ...
    public int handleTerminalDestructionRequest(obj_id self, dictionary params)
    {
        destroyObject(self);
        return SCRIPT_CONTINUE;
    }
