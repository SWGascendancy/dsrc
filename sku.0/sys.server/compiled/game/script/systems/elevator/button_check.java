...
public class button_check extends script.base_script
{
    ...
    public int emperorsRetreat(obj_id self, dictionary params)
    {
    ...
    public int tatSmallPlayer(obj_id self, dictionary params)
    {
        obj_id home = params.getObjId("home");
        obj_id item = params.getObjId("item");
        obj_id elevator = getObjIdObjVar(home, "terminal1");
    ...
    public int luckyDespot(obj_id self, dictionary params)
    {
        obj_id home = params.getObjId("home");
        obj_id item = params.getObjId("item");
        obj_id elevator = getObjIdObjVar(home, "terminal1");
    ...
    public int hospital(obj_id self, dictionary params)
    {
        obj_id home = params.getObjId("home");
        obj_id item = params.getObjId("item");
        obj_id elevator = getObjIdObjVar(home, "terminal1");
    ...
    public int guildhall(obj_id self, dictionary params)
    {
        obj_id home = params.getObjId("home");
        obj_id item = params.getObjId("item");
        obj_id elevator = getObjIdObjVar(home, "terminal1");
