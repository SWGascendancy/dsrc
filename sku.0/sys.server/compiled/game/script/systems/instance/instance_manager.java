...
public class instance_manager extends script.base_script
{
    ...
    public int requestEnterPlayer(obj_id self, dictionary params)
    {
    ...
    public int debugMovePlayerToInstanceHandler(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
    ...
    public int startNewInstance(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
    ...
    public int endInstanceSession(obj_id self, dictionary params)
    {
    ...
    public int removePlayerFromList(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player_id");
        return SCRIPT_CONTINUE;
    }
    public int startClock(obj_id self, dictionary params)
    {
    ...
    public int clockOverride(obj_id self, dictionary params)
    {
    ...
    public int handleClockTic(obj_id self, dictionary params)
    {
        ...
        // Why is players null after patch 0.3.0?
        if (players != null && players.length > 0) {
    ...
    public int validatePlayer(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
