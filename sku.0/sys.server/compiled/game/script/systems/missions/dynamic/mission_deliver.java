...
public class mission_deliver extends script.systems.missions.base.mission_dynamic_base
{
    ...
    public int deliverSuccess(obj_id self, dictionary params)
    {
    ...
    public int deliverFail(obj_id self, dictionary params)
    {
        obj_id objPlayer = getMissionHolder(self);
    ...
    public int deliverIncomplete(obj_id self, dictionary params)
    {
        obj_id objPlayer = getMissionHolder(self);
