...
public class bounty_probe_droid extends script.systems.missions.base.mission_dynamic_base
{
    ...
    public int droid_Probot_Start(obj_id self, dictionary params)
    {
    ...
    public int probe_Droid_Countdown(obj_id self, dictionary params)
    {
    ...
    public int probe_Droid_Spawn(obj_id self, dictionary params)
    {
        location locSpawnLocation = getLocationObjVar(self, "locSpawnLocation");
