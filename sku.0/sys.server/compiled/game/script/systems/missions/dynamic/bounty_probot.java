...
public class bounty_probot extends script.systems.missions.base.mission_dynamic_base
{
    ...
    public int setup_Droid(obj_id self, dictionary params)
    {
    ...
    public int delete_Self(obj_id self, dictionary params)
    {
    ...
    public int take_Off(obj_id self, dictionary params)
    {
