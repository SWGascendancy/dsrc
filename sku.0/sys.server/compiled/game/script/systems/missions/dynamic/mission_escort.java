...
public class mission_escort extends script.systems.missions.base.mission_dynamic_base
{
    ...
    public int escort_Pickup(obj_id self, dictionary params)
    {
        obj_id objMissionData = getMissionData(self);
    ...
    public int escortIncomplete(obj_id self, dictionary params)
    {
    ...
    public int escortFailure(obj_id self, dictionary params)
    {
        obj_id objPlayer = getMissionHolder(self);
    ...
    public int escortSuccess(obj_id self, dictionary params)
    {
