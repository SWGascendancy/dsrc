...
public class mission_destruction extends script.systems.missions.base.mission_dynamic_base
{
    ...
    public int destructionIncomplete(obj_id self, dictionary params)
    {
        obj_id objPlayer = getMissionHolder(self);
    ...
    public int destructionFailure(obj_id self, dictionary params)
    {
        obj_id objPlayer = getMissionHolder(self);
    ...
    public int destructionSuccess(obj_id self, dictionary params)
    {
