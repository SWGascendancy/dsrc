...
public class mission_crafting extends script.systems.missions.base.mission_dynamic_base
{
    ...
    public int craftingSuccess(obj_id self, dictionary params)
    {
    ...
    public int craftingFail(obj_id self, dictionary params)
    {
        obj_id objPlayer = getMissionHolder(self);
    ...
    public int craftingIncomplete(obj_id self, dictionary params)
    {
        obj_id objPlayer = getMissionHolder(self);
    ...
    public int pickup_event(obj_id self, dictionary params)
    {
