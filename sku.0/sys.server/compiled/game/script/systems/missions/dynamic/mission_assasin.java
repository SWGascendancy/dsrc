...
public class mission_assasin extends script.systems.missions.base.mission_dynamic_base
{
    ...
    public int assassinIncomplete(obj_id self, dictionary params)
    {
        obj_id objPlayer = getMissionHolder(self);
    ...
    public int assassinFailure(obj_id self, dictionary params)
    {
        obj_id objPlayer = getMissionHolder(self);
    ...
    public int assassinSuccess(obj_id self, dictionary params)
    {
