...
public class mission_hunting extends script.systems.missions.base.mission_dynamic_base
{
    ...
    public int huntingIncomplete(obj_id self, dictionary params)
    {
    ...
    public int huntingFailure(obj_id self, dictionary params)
    {
        obj_id objPlayer = getMissionHolder(self);
    ...
    public int huntingSuccess(obj_id self, dictionary params)
    {
