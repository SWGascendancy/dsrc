...
public class mission_bounty extends script.systems.missions.base.mission_dynamic_base
{
    ...
    public int onArrivedAtLocation(obj_id self, dictionary params)
    {
    ...
    public int timedOutMission(obj_id self, dictionary params)
    {
        obj_id target = getObjIdObjVar(self, "objTarget");
        obj_id owner = getMissionHolder(self);
        if (isIdValid(target) && isIdValid(owner))
    ...
    public int bountyTimedOut(obj_id self, dictionary params)
    {
        obj_id objPlayer = getMissionHolder(self);
    ...
    public int targetInWater(obj_id self, dictionary params)
    {
        dictionary dctParams = new dictionary();
        obj_id objPlayer = getMissionHolder(self);
    ...
    public int probe_Droid_Find_Fail(obj_id self, dictionary params)
    {
    ...
    public int probe_Droid_Track_Lost(obj_id self, dictionary params)
    {
        string_id strSpam = new string_id("mission/mission_generic", "target_track_lost");
        sendSystemMessage(getMissionHolder(self), strSpam);
        return SCRIPT_CONTINUE;
    }
    public int probe_Droid_Response(obj_id self, dictionary params)
    {
        dictionary dctParams = new dictionary();
        obj_id objMissionData = getMissionData(self);
        obj_id objPlayer = getMissionHolder(self);
    ...
    public int foundObject(obj_id self, dictionary params)
    {
    ...
    public int moveTarget(obj_id self, dictionary params)
    {
    ...
    public int stopTracking(obj_id self, dictionary params)
    {
        utils.removeScriptVar(self, "intTracking");
        return SCRIPT_CONTINUE;
    }
    public int halfwayNotification(obj_id self, dictionary params)
    {
