...
public class mission_bounty_droid_terminal extends script.systems.missions.base.mission_dynamic_base
{
    ...
    public int buyDroid(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int finalize_Purchase(obj_id self, dictionary params)
    {
    ...
    public int droid_Purchase_Success(obj_id self, dictionary params)
    {
    ...
    public int droid_Purchase_Fail(obj_id self, dictionary params)
    {
        obj_id objPlayer = params.getObjId("objPlayer");
