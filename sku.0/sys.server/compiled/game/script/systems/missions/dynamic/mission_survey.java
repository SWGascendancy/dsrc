...
public class mission_survey extends script.systems.missions.base.mission_dynamic_base
{
    ...
    public int surveySuccess(obj_id self, dictionary params)
    {
    ...
    public int surveyFail(obj_id self, dictionary params)
    {
        endMission(self);
        return SCRIPT_CONTINUE;
    }
    public int surveyIncomplete(obj_id self, dictionary params)
    {
        endMission(self);
        return SCRIPT_CONTINUE;
    }
    ...
    public int surveyEvent(obj_id self, dictionary params)
    {
        return SCRIPT_CONTINUE;
    }
}
