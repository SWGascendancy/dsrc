...
public class mission_recon extends script.systems.missions.base.mission_dynamic_base
{
    ...
    public int reconIncomplete(obj_id self, dictionary params)
    {
        obj_id objPlayer = getMissionHolder(self);
    ...
    public int reconFailure(obj_id self, dictionary params)
    {
        obj_id objPlayer = getMissionHolder(self);
    ...
    public int reconSuccess(obj_id self, dictionary params)
    {
