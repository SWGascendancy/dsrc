...
public class mission_dynamic_base extends script.systems.missions.base.mission_base
{
    ...
    public obj_id createMissionDataInContainer(obj_id objCreator, float fltEffeciencyRequirement, int intExpireTime, obj_id objCreatorToken, String strMissionType, String strScript)
    {
        obj_id objContainer;
    ...
    public obj_id getMissionData(obj_id objMission)
    {
        return objMission;
    }
    public obj_id createDestructionMissionDataFromLocation(obj_id objMissionData, obj_id objCreator, location locMissionStart, int intDifficulty, String strPlanet, String strFaction, float fltRewardModifier)
    {
    ...
    public obj_id createDeliverMissionFromLocation(obj_id objMissionData, obj_id objCreator, location locMissionStart, int intDifficulty, String strPlanet, String strFaction, float fltRewardModifier)
    {
    ...
    public location getGoodBountyDestination(String strPlanet)
    {
    ...
    public obj_id createDynamicBountyMission(obj_id objMissionData, obj_id objCreator, int intBountyDifficulty, int intDifficulty, String strStartPlanet, String strFaction)
    {
    ...
    public obj_id createJediBountyMission(obj_id objMissionData, obj_id objCreator, String strFaction, int hunterLevel, obj_id bountyHunterId)
    {
        return createJediBountyMission(objMissionData, objCreator, strFaction, hunterLevel, bountyHunterId, missions.BOUNTY_FLAG_NONE);
    }
    public obj_id createJediBountyMission(obj_id objMissionData, obj_id objCreator, String strFaction, int hunterLevel, obj_id bountyHunterId, int flag)
    {
        setMissionRootScriptName(objMissionData, "systems.missions.dynamic.mission_bounty");
        setMissionType(objMissionData, "bounty");
        int bhMin = 20;
    ...
    public obj_id createBountyTarget(obj_id objMission)
    {
    ...
    public boolean transferDeliveryItem(obj_id objItem, obj_id objTarget)
    {
    ...
    public void missionArrival(obj_id objMission)
    {
        dictionary dctParams = new dictionary();
        messageTo(objMission, "onArrivedAtLocation", dctParams, 0, true);
        return;
    }
    public void cleanupLocationTargets(obj_id objMission)
    {
        dictionary dctParams = new dictionary();
    ...
    public void setupSpawn(obj_id objMission, location locSpawnLocation)
    {
        obj_id objPlayer = getMissionHolder(objMission);
        dictionary dctParams = new dictionary();
    ...
    public void setupUnloadedSpawn(obj_id objMission, obj_id objMissionHolder, location locSpawnLocation)
    {
        dictionary dctParams = new dictionary();
        dctParams.put("objMission", objMission);
        dctParams.put("locSpawnLocation", locSpawnLocation);
    ...
    public location getGoodMissionLocation(obj_id objMission, obj_id objPlayer)
    {
    ...
    public boolean setupDestructionMissionObject(obj_id objMission)
    {
        return true;
    }
    public void sendMissionStartMovementSpam(obj_id objMission)
    {
        obj_id objPlayer = getMissionHolder(objMission);
        sendSystemMessage(objPlayer, SID_MISSION_TARGET_UPDATED);
    }
    public void moveMissionStartLocation(obj_id objMission)
    {
        location locSpawnLocation = getMissionStartLocation(objMission);
    ...
    public boolean createDestructionTarget(obj_id objMission, obj_id objPlayer)
    {
        int intAttempts = 0;
    ...
    public void sendDestructionFail(obj_id objMission)
    {
        dictionary dctParams = new dictionary();
        messageTo(objMission, "destructionFail", dctParams, 0, true);
    }
    public void sendDestructionSuccess(obj_id objMission)
    {
        dictionary dctParams = new dictionary();
        messageTo(objMission, "destructionSuccess", dctParams, 0, false);
    }
    public void sendDestructionIncomplete(obj_id objMission)
    {
        dictionary dctParams = new dictionary();
        messageTo(objMission, "destructionIncomplete", dctParams, 0, true);
    }
    public void sendEscortFail(obj_id objMission)
    {
        dictionary dctParams = new dictionary();
        messageTo(objMission, "escortFail", dctParams, 0, true);
    }
    public void sendEscortSuccess(obj_id objMission)
    {
        dictionary dctParams = new dictionary();
        messageTo(objMission, "escortSuccess", dctParams, 0, true);
    }
    public void sendEscortIncomplete(obj_id objMission)
    {
        dictionary dctParams = new dictionary();
        messageTo(objMission, "escortIncomplete", dctParams, 0, true);
    }
    public boolean createEscortTarget(obj_id objMission)
    {
        obj_id objMissionData = getMissionData(objMission);
    ...
    public void escortFail(obj_id objMission)
    {
        dictionary dctParams = new dictionary();
        messageTo(objMission, "escortFailure", dctParams, 0, true);
    }
    public void escortSuccess(obj_id objMission)
    {
        dictionary dctParams = new dictionary();
        messageTo(objMission, "escortSuccess", dctParams, 0, true);
    }
    public void escortIncomplete(obj_id objMission)
    {
        dictionary dctParams = new dictionary();
        messageTo(objMission, "escortIncomplete", dctParams, 0, true);
    }
    public boolean setupFetchMissionObject(obj_id objMission)
    {
        obj_id objMissionData = getMissionData(objMission);
    ...
    public boolean createFetchPickupNPC(obj_id objMission)
    {
        return true;
    }
    public boolean createFetchDropoffNPC(obj_id objMission)
    {
        obj_id objMissionData = getMissionData(objMission);
        location locDropoffLocation = getMissionEndLocation(objMissionData);
    ...
    public void sendDeliverFail(obj_id objMission)
    {
        dictionary dctParams = new dictionary();
        setObjVar(objMission, "intState", missions.STATE_MISSION_COMPLETE);
        messageTo(objMission, "deliverFailure", dctParams, 0, true);
    }
    public void sendDeliverSuccess(obj_id objMission)
    {
        dictionary dctParams = new dictionary();
        setObjVar(objMission, "intState", missions.STATE_MISSION_COMPLETE);
        messageTo(objMission, "deliverSuccess", dctParams, 0, true);
    }
    public void sendDeliverIncomplete(obj_id objMission)
    {
        dictionary dctParams = new dictionary();
        setObjVar(objMission, "intState", missions.STATE_MISSION_COMPLETE);
        messageTo(objMission, "deliverIncomplete", dctParams, 0, true);
    }
    public boolean createDeliverPickupNPC(obj_id objMission)
    {
        obj_id objPlayer = getMissionHolder(objMission);
        obj_id objMissionData = getMissionData(objMission);
    ...
    public boolean createDeliverDropoffNPC(obj_id objMission)
    {
        obj_id objMissionData = getMissionData(objMission);
        String strDropoffNPC = getStringObjVar(objMissionData, "strDropoffNPC");
    ...
    public dictionary getDestructionMissionSpawnList(obj_id objCreator, int intDifficulty, String strPlanet, String strSpawnType, String strFaction)
    {
        strFaction = toLower(strFaction);
        String strFileName;
        if (strFaction.equals(""))
    ...
    public String getOverloadTemplate(int intDifficulty, String strFaction, int intFaction)
    {
    ...
    public void setupContextualizationStrings(obj_id objMissionData, int intMissionDifficulty, obj_id objCreator, String strMissionFaction)
    {
        setupContextualizationStrings(objMissionData, intMissionDifficulty, objCreator, strMissionFaction, missions.BOUNTY_FLAG_NONE);
    }
    public void setupContextualizationStrings(obj_id objMissionData, int intMissionDifficulty, obj_id objCreator, String strMissionFaction, int flag)
    {
    ...
    public void sendMissionPersistentMessage(obj_id objMission, String strType)
    {
        return;
    }
    public void createDeliverInterestNPC(obj_id objMission)
    {
        obj_id objMissionData = getMissionData(objMission);
        obj_id objPlayer = getMissionHolder(objMission);
        location locGoodLocation = new location();
    ...
    public void cleanUpInterestNPC(obj_id objNPC)
    {
        obj_id objMission = getObjIdObjVar(objNPC, "objMission");
        destroyObject(objNPC);
        return;
    }
    public void removeSpawnedTemplateElement(obj_id objMissionData, obj_id objTemplate)
    {
        int intI = 0;
    ...
    public String getRandomMissionCreatorName()
    {
    ...
    public String getRandomSpeciesName(String strSpecies)
    {
        String strTemplate = "";
    ...
    public void preLoadDestructionDataTables(obj_id objMissionBoard, String strPlanet)
    {
        return;
    }
    public void registerBountyInformant(obj_id objInformant)
    {
    ...
    public void removeBountyInformant(obj_id objInformant)
    {
        location locCurrentLocation = getMissionLocation(objInformant);
        obj_id objPlanetObject = getPlanetByName(locCurrentLocation.area);
        int intInformantLevel = getIntObjVar(objInformant, "intInformantLevel");
    ...
    public void setupInvisibleWaypoint(obj_id objMission)
    {
    ...
    public boolean updateMissionWaypoint(obj_id objMission, location locSpawnLocation)
    {
    ...
    public void activateMissionWaypoint(obj_id objMission)
    {
        if (hasObjVar(objMission, "objTargetWaypoint"))
        {
    ...
    public obj_id generateNPCMissions(obj_id objNPC)
    {
    ...
    public void cleanUpMissions(obj_id objNPC)
    {
        int intI = 0;
        String[] strMissionTypes = getStringArrayObjVar(objNPC, "mission.strMissionTypes");
        while (intI < strMissionTypes.length)
    ...
    public boolean hasMissionFromNPC(obj_id objPlayer, obj_id objNPC)
    {
    ...
    public obj_id getMissionObjectFromNPC(obj_id objNPC, int intPlayerDifficulty)
    {
    ...
    public void removeMissionObjectFromNPC(obj_id objNPC, obj_id objMissionData)
    {
        int intI = 0;
        String[] strMissionTypes = getStringArrayObjVar(objNPC, "mission.strMissionTypes");
        while (intI < strMissionTypes.length)
    ...
    public void assignNPCMissionToPlayer(obj_id objNPC, obj_id objMissionData, obj_id objPlayer)
    {
        assignMission(objMissionData, objPlayer);
        removeMissionObjectFromNPC(objNPC, objMissionData);
        return;
    }
    public obj_id getAssignedNPCMission(obj_id objNPC, obj_id objPlayer)
    {
        obj_id[] objMissionArray = getMissionObjects(objPlayer);
        int intI = 0;
        if (objMissionArray == null)
    ...
    public string_id sendNPCMissionSuccess(obj_id objMission, obj_id objNPC)
    {
        obj_id objMissionData = getMissionData(objMission);
        String strMissionType = getMissionType(objMissionData);
        if (strMissionType.equals("destroy"))
    ...
    public string_id getNPCMissionSuccessId(obj_id objMissionData)
    {
    ...
    public string_id getNPCEscortPickupId(obj_id objMissionData)
    {
        int intStringId = getIntObjVar(objMissionData, "intStringId");
        String strIdFileName = getStringObjVar(objMissionData, "strIdFileName");
    ...
    public string_id getNPCEscortDropoffId(obj_id objMissionData)
    {
        int intStringId = getIntObjVar(objMissionData, "intStringId");
        String strIdFileName = getStringObjVar(objMissionData, "strIdFileName");
    ...
    public string_id getNPCMissionDescriptionId(obj_id objMissionData)
    {
        int intStringId = getIntObjVar(objMissionData, "intStringId");
        String strIdFileName = getStringObjVar(objMissionData, "strIdFileName");
    ...
    public obj_id createReconMission(obj_id objMissionData, obj_id objCreator, location locMissionStart, int intDifficulty, String strPlanet, String strFaction)
    {
    ...
    public dictionary getReconSpawnList(obj_id objMissionData, location locMissionLocation, int intPlayerDifficulty)
    {
    ...
    public void sendReconFail(obj_id objMission)
    {
        dictionary dctParams = new dictionary();
        messageTo(objMission, "reconFail", dctParams, 0, true);
    }
    public void sendReconSuccess(obj_id objMission)
    {
        dictionary dctParams = new dictionary();
        messageTo(objMission, "reconSuccess", dctParams, 0, true);
    }
    public void sendReconIncomplete(obj_id objMission)
    {
        dictionary dctParams = new dictionary();
        messageTo(objMission, "reconIncomplete", dctParams, 0, true);
    }
    public void setupArrivedAtLocation(obj_id objTarget, obj_id objMission, location locTargetLocation, float fltDistance)
    {
        dictionary dctParams = new dictionary();
    ...
    public boolean createReconTarget(obj_id objMission, obj_id objPlayer)
    {
        obj_id objMissionData = getMissionData(objMission);
    ...
    public obj_id createEscortToCreatorMission(obj_id objMissionData, obj_id objCreator, location locMissionStart, int intDifficulty, String strPlanet, String strFaction)
    {
    ...
    public obj_id createEscortTargetMission(obj_id objMissionData, obj_id objCreator, location locMissionStart, int intDifficulty, String strPlanet, String strFaction)
    {
    ...
    public int getDeliverReward(location locStartLocation, location locEndLocation, float fltDistanceModifier, float fltRewardModifier)
    {
        float fltReward = 0;
        float fltDistance = 0;
    ...
    public int getDestroyReward(int intMinReward, int intMaxReward, float fltDistance)
    {
    ...
    public void persistAndRegisterObject(obj_id objObject, obj_id objMission)
    {
    ...
    public void cleanupObjects(obj_id objMission)
    {
    ...
    public location getGoodTheaterLocation(obj_id objMissionData, location locSpawnLocation)
    {
        int intSize = getIntObjVar(objMissionData, "intSize");
    ...
    public obj_id createSurveyMission(obj_id objMissionData, obj_id objCreator, int intDifficulty, String strFaction)
    {
    ...
    public void sendSurveyFail(obj_id objMission)
    {
        dictionary dctParams = new dictionary();
        setObjVar(objMission, "intState", missions.STATE_MISSION_COMPLETE);
        messageTo(objMission, "surveyFailure", dctParams, 0, true);
    }
    public void sendSurveySuccess(obj_id objMission)
    {
        dictionary dctParams = new dictionary();
        setObjVar(objMission, "intState", missions.STATE_MISSION_COMPLETE);
        messageTo(objMission, "surveySuccess", dctParams, 0, true);
    }
    public void sendSurveyIncomplete(obj_id objMission)
    {
        dictionary dctParams = new dictionary();
        setObjVar(objMission, "intState", missions.STATE_MISSION_COMPLETE);
        messageTo(objMission, "surveyIncomplete", dctParams, 0, true);
    }
    public obj_id createDancerMission(obj_id objMissionData, obj_id objCreator, int intDifficulty, String strFaction)
    {
    ...
    public obj_id createMusicianMission(obj_id objMissionData, obj_id objCreator, int intDifficulty, String strFaction)
    {
        setMissionRootScriptName(objMissionData, "systems.missions.dynamic.mission_entertainer");
    ...
    public boolean setupEntertainerMissionTarget(obj_id objMissionData, String strPlanet)
    {
        setMissionRootScriptName(objMissionData, "systems.missions.dynamic.mission_entertainer");
    ...
    public void sendEntertainerFail(obj_id objMission)
    {
        dictionary dctParams = new dictionary();
        setObjVar(objMission, "intState", missions.STATE_MISSION_COMPLETE);
        messageTo(objMission, "entertainerFailure", dctParams, 0, true);
    }
    public void sendEntertainerSuccess(obj_id objMission)
    {
        dictionary dctParams = new dictionary();
        setObjVar(objMission, "intState", missions.STATE_MISSION_COMPLETE);
        messageTo(objMission, "entertainerSuccess", dctParams, 0, true);
    }
    public void sendEntertainerIncomplete(obj_id objMission)
    {
        dictionary dctParams = new dictionary();
        setObjVar(objMission, "intState", missions.STATE_MISSION_COMPLETE);
        messageTo(objMission, "entertainerIncomplete", dctParams, 0, true);
    }
    public obj_id createCraftingMission(obj_id objMissionData, obj_id objCreator, location locMissionStart, int intDifficulty, String strFaction)
    {
    ...
    public void sendCraftingFail(obj_id objMission)
    {
        dictionary dctParams = new dictionary();
        setObjVar(objMission, "intState", missions.STATE_MISSION_COMPLETE);
        messageTo(objMission, "craftingFailure", dctParams, 0, true);
    }
    public void sendCraftingSuccess(obj_id objMission)
    {
        dictionary dctParams = new dictionary();
        setObjVar(objMission, "intState", missions.STATE_MISSION_COMPLETE);
        messageTo(objMission, "craftingSuccess", dctParams, 0, true);
    }
    public void sendCraftingIncomplete(obj_id objMission)
    {
        dictionary dctParams = new dictionary();
        setObjVar(objMission, "intState", missions.STATE_MISSION_COMPLETE);
        messageTo(objMission, "craftingIncomplete", dctParams, 0, true);
    }
    public boolean createCraftingPickupNPC(obj_id objMission)
    {
        obj_id objPlayer = getMissionHolder(objMission);
        obj_id objMissionData = getMissionData(objMission);
        String strPickupNPC = getStringObjVar(objMissionData, "strPickupNPC");
    ...
    public boolean createCraftingDropoffNPC(obj_id objMission)
    {
        obj_id objMissionData = getMissionData(objMission);
        String strDropoffNPC = getStringObjVar(objMissionData, "strDropoffNPC");
        location locSpawnLocation = getMissionEndLocation(objMissionData);
    ...
    public void grantMissionSchematic(obj_id objPlayer, obj_id objMission)
    {
        obj_id objMissionData = getMissionData(objMission);
    ...
    public void revokeMissionSchematic(obj_id objPlayer, obj_id objMission)
    {
    ...
    public void reContextualizationTerminalToNPCMission(obj_id objMissionData, obj_id objCreator)
    {
        String strIdFileName = getStringObjVar(objMissionData, "strIdFileName");
    ...
    public obj_id dynamicDestroyToThemePark(obj_id objMissionData, obj_id objCreator)
    {
    ...
    public obj_id dynamicDeliverToThemePark(obj_id objMissionData, obj_id objCreator)
    {
        String strNPCType = getStringObjVar(objCreator, "mission.strNPCName");
    ...
    public void convertDynamicContextualizationToThemePark(obj_id objMissionData, String strFileName, int intId)
    {
        setObjVar(objMissionData, "intStringId", intId);
    ...
    public obj_id dynamicEscortToCreatorToThemePark(obj_id objMissionData, obj_id objCreator)
    {
        String strNPCType = getStringObjVar(objCreator, "mission.strNPCName");
    ...
    public location getMissionLocation(obj_id objTarget)
    {
    ...
    public boolean areMissionsAllowed(location locTest)
    {
    ...
    public void doIncorrectPlayerBlurb(obj_id objNPC, obj_id player)
    {
    ...
    public boolean validateNPCMissionForPlayer(obj_id objNPC, obj_id objMissionData, obj_id objPlayer)
    {
        if (!isIdValid(objMissionData))
        {
            return false;
    ...
    public boolean hasStarPort(location locTestLocation)
    {
    ...
    public int getFactionReward(int intReward)
    {
        int intBaseReward = 5 + intReward / FACTION_REWARD_VALUE;
        return intBaseReward;
    }
    public obj_id getBountyMission(obj_id objPlayer)
    {
    ...
    public boolean hasCraftingMissionItem(obj_id objPlayer, String strTemplate)
    {
    ...
    public void sendHuntingFail(obj_id objMission)
    {
        dictionary dctParams = new dictionary();
        setObjVar(objMission, "intState", missions.STATE_MISSION_COMPLETE);
        messageTo(objMission, "huntingFailure", dctParams, 0, true);
    }
    public void sendHuntingSuccess(obj_id objMission)
    {
        dictionary dctParams = new dictionary();
        setObjVar(objMission, "intState", missions.STATE_MISSION_COMPLETE);
        messageTo(objMission, "huntingSuccess", dctParams, 0, true);
    }
    public void sendHuntingIncomplete(obj_id objMission)
    {
        dictionary dctParams = new dictionary();
        setObjVar(objMission, "intState", missions.STATE_MISSION_COMPLETE);
        messageTo(objMission, "huntingIncomplete", dctParams, 0, true);
    }
    public obj_id createHuntingMission(obj_id objMissionData, obj_id objCreator, int intDifficulty, String strFaction)
    {
    ...
    public void sendAssassinFail(obj_id objMission)
    {
        dictionary dctParams = new dictionary();
        setObjVar(objMission, "intState", missions.STATE_MISSION_COMPLETE);
        messageTo(objMission, "assassinFailure", dctParams, 0, true);
    }
    public void sendAssassinSuccess(obj_id objMission)
    {
        dictionary dctParams = new dictionary();
        setObjVar(objMission, "intState", missions.STATE_MISSION_COMPLETE);
        messageTo(objMission, "assassinSuccess", dctParams, 0, true);
    }
    public void sendAssassinIncomplete(obj_id objMission)
    {
        dictionary dctParams = new dictionary();
        setObjVar(objMission, "intState", missions.STATE_MISSION_COMPLETE);
        messageTo(objMission, "assassinIncomplete", dctParams, 0, true);
    }
    public obj_id createAssassinMission(obj_id objMissionData, obj_id objCreator, int intDifficulty, String strFaction)
    {
    ...
    public location[] getAssassinMissionLocation()
    {
    ...
    public boolean createAssassinTarget(obj_id objMission)
    {
    ...
    public obj_id getAssassinMission(obj_id objPlayer)
    {
        if (isIdValid(objPlayer))
        {
            obj_id[] objMissionArray = getMissionObjects(objPlayer);
    ...
    public boolean isPlanetHuntingViable(obj_id player, String area)
    {
    ...
    public void msgWrongHuntingPlanet(obj_id player)
    {
        int playerLevel = getLevel(player);
