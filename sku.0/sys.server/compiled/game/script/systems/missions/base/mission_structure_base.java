...
public class mission_structure_base extends script.systems.missions.base.mission_dynamic_base
{
    ...
    public void playerDestructionIncomplete(obj_id objMission)
    {
        dictionary dctParams = new dictionary();
    ...
    public void playerDestructionFail(obj_id objMission)
    {
        dictionary dctParams = new dictionary();
        obj_id objPlayer = getMissionHolder(objMission);
    ...
    public void playerDestructionSuccess(obj_id objMission)
    {
        dictionary dctParams = new dictionary();
        obj_id objPlayer = getMissionHolder(objMission);
    ...
    public void returnAllCredits(obj_id objMission)
    {
    }
    public void addBountyHunterTrackingInformation(obj_id objPlayer, obj_id objBountyHunter, obj_id objMission)
    {
    ...
    public void removeBountyHunterTrackingInformation(obj_id objPlayer, obj_id objBountyHunter, obj_id objMission)
    {
        if (hasObjVar(objPlayer, "bountyInfo." + objBountyHunter.toString()))
        {
    ...
    public void notifyBountyHunterFailure(obj_id objPlayer, obj_id objTarget)
    {
        int intI;
        intI = 1;
    ...
    public void notifyBountyHunterSuccess(obj_id objPlayer, obj_id objTarget)
    {
        int intI;
        intI = 1;
        int intMissionCount = getIntObjVar(objPlayer, "bountyInfo." + objTarget.toString() + ".intMissionCount");
