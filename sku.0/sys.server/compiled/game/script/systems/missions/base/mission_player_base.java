...
public class mission_player_base extends script.systems.missions.base.mission_dynamic_base
{
    ...
    public void playerDeliverSuccess(obj_id objMission)
    {
        dictionary dctParams = new dictionary();
        obj_id objPlayer = getMissionHolder(objMission);
    ...
    public void playerDeliverFail(obj_id objMission)
    {
        dictionary dctParams = new dictionary();
        obj_id objPlayer = getMissionHolder(objMission);
        debugSpeakMsg(objPlayer, "MISSION IS FAILED!!");
    ...
    public void playerDeliverIncomplete(obj_id objMission)
    {
        dictionary dctParams = new dictionary();
        obj_id objPlayer = getMissionHolder(objMission);
        debugSpeakMsg(objPlayer, "MISSION IS Incomplete!");
    ...
    public void playerFetchSuccess(obj_id objMission)
    {
        dictionary dctParams = new dictionary();
        obj_id objPlayer = getMissionHolder(objMission);
        debugSpeakMsg(objPlayer, "MISSION IS SUCCESFUL!");
    ...
    public void playerFetchFail(obj_id objMission)
    {
        dictionary dctParams = new dictionary();
        obj_id objPlayer = getMissionHolder(objMission);
        debugSpeakMsg(objPlayer, "MISSION IS FAILED!!");
    ...
    public void playerFetchIncomplete(obj_id objMission)
    {
        dictionary dctParams = new dictionary();
        obj_id objPlayer = getMissionHolder(objMission);
        debugSpeakMsg(objPlayer, "MISSION IS Incomplete!");
    ...
    public void setupDeliverObjects(obj_id objMission)
    {
        return;
    }
    public void cleanupDeliverObjects(obj_id objMission)
    {
        return;
    }
}
