...
public class mission_base extends script.base_script
{
    ...
    public location findRandomLocation(location locCenter, int intVariance)
    {
        int intMin;
        int intMax;
    ...
    public void addListener(obj_id objListener, obj_id objTarget)
    {
        return;
    }
    public int getMissionBondAmount(obj_id objMission)
    {
    ...
    public void removeListener(obj_id objListener, obj_id objTarget)
    {
        return;
    }
    public void messageListeners(obj_id objOwner, String strMessageName, dictionary dctParams)
    {
        return;
    }
    public void deliverReward(obj_id objMission)
    {
    ...
    public obj_id getValidPayTarget(obj_id player, int money)
    {
    ...
    public void setupBountyMissionObject(obj_id objMission)
    {
        return;
    }
    public void cleanupBountyMission(obj_id objMission)
    {
        return;
    }
    public void returnReward(obj_id objMission)
    {
        return;
    }
    public int getBountyDifficulty(obj_id objPlayer)
    {
    ...
    public obj_id cleanMissionObject(obj_id objMissionObject)
    {
