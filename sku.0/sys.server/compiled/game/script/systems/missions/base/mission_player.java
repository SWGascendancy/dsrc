...
public class mission_player extends script.systems.missions.base.mission_player_base
{
    ...
    public int OnPlayerRequestMissionBoard(obj_id self, obj_id objPlayer, obj_id objMissionTerminal, obj_id[] objMissionData)
    {
    ...
    public int OnMissionAssigned(obj_id self, dictionary params)
    {
    ...
    public int OnAssignMission(obj_id self, dictionary params)
    {
    ...
    public int bondTransferSuccess(obj_id self, dictionary params)
    {
    ...
    public int bondTransferFailure(obj_id self, dictionary params)
    {
        debugServerConsoleMsg(self, "You need more bond money to take this mission");
        return SCRIPT_CONTINUE;
    }
    public int msgJediMissionStartConfirmed(obj_id self, dictionary params)
    {
    ...
    public int msgJediMissionStartFailed(obj_id self, dictionary params)
    {
    ...
    public int setupSpawn(obj_id self, dictionary params)
    {
    ...
    public int OnArrivedAtLocation(obj_id self, String strName)
    {
    ...
    public int cleanupLocationTarget(obj_id self, dictionary params)
    {
    ...
    public int setupArrivedAtLocation(obj_id self, dictionary params)
    {
    ...
    public int bountyIncomplete(obj_id self, dictionary params)
    {
    ...
    public int bountyFailure(obj_id self, dictionary params)
    {
        obj_id target = params.getObjId("target");
        if (isIdValid(target))
        {
    ...
    public int bountySuccess(obj_id self, dictionary params)
    {
        obj_id target = params.getObjId("target");
        if (isIdValid(target))
        {
    ...
    public int destruction_Arrival(obj_id self, dictionary params)
    {
        obj_id objMission = params.getObjId("objMission");
    ...
    public int assassin_Arrival(obj_id self, dictionary params)
    {
        obj_id objMission = params.getObjId("objMission");
    ...
    public int recon_Arrival(obj_id self, dictionary params)
    {
    ...
    public int deliver_Arrival(obj_id self, dictionary params)
    {
        obj_id objMission = params.getObjId("objMission");
    ...
    public int crafting_Arrival(obj_id self, dictionary params)
    {
        obj_id objMission = params.getObjId("objMission");
        int intState = getIntObjVar(objMission, "intState");
        debugServerConsoleMsg(self, "Arrived Location state is " + intState);
    ...
    public int fetch_Arrival(obj_id self, dictionary params)
    {
        obj_id objMission = params.getObjId("objMission");
    ...
    public int escort_Arrival(obj_id self, dictionary params)
    {
        obj_id objMission = params.getObjId("objMission");
    ...
    public int bounty_Arrival(obj_id self, dictionary params)
    {
        obj_id objMission = params.getObjId("objMission");
    ...
    public int setup_Spawn_Overload(obj_id self, dictionary params)
    {
    ...
    public int informantComm(obj_id self, dictionary params)
    {
        obj_id player = self;
    ...
    public int addListener(obj_id self, dictionary params)
    {
    ...
    public int removeListener(obj_id self, dictionary params)
    {
        obj_id objListener = params.getObjId("objListener");
        if (objListener == null)
        {
    ...
    public int findAssassinTarget(obj_id self, obj_id target, String params, float defaultTime)
    {
