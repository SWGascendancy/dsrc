...
public class npc_lair extends script.theme_park.poi.base
{
    ...
    public void initializePoi(obj_id poiBaseObject)
    {
        obj_id self = getSelf();
    ...
    public int doTheater(obj_id self, dictionary params)
    {
    ...
    public int makeSomeMobiles(obj_id self, dictionary params)
    {
        String lairType = params.getString("lairType");
    ...
    public void flagCreatureLairs(obj_id poiBaseObject)
    {
    ...
    public int handleTargetDestroyed(obj_id self, dictionary params)
    {
        poiComplete(POI_SUCCESS);
        return SCRIPT_CONTINUE;
    }
    public int handleTheaterComplete(obj_id self, dictionary params)
    {
    ...
    public void createTheater(obj_id poiBaseObject, String lairType, String diff)
    {
    ...
    public int handleBuildingDestruction(obj_id self, dictionary params)
    {
        setObjVar(self, "npc_lair.buildingType", "none");
        poiComplete(POI_SUCCESS);
        return SCRIPT_CONTINUE;
    }
    public float getAverageDifficulty(float[] fltDifficulties)
    {
        float fltAverage = 0;
    ...
    public float getMaxDifficulty(float[] fltDifficulties)
    {
    ...
    public void spawnNpcLairMobiles(obj_id poiBaseObject, String lairType, int lairLevel, int groupSize)
    {
    ...
    public int handleDelayedTargetSetup(obj_id self, dictionary params)
    {
    ...
    public int[] getSpawnLimit(String lairDatatable, String[] creatureList)
    {
        if (creatureList == null)
        {
            return null;
    ...
    public float[] getDifficultyList(dictionary[] dctCreatureInfo)
    {
    ...
    public float getLowestLevel(obj_id poiBaseObj, float[] difficultyList, int[] spawnLimit, int[] numSpawned)
    {
    ...
    public int spawnCreatures(obj_id self, dictionary params)
    {
    ...
    public void respawnAllMobiles(obj_id poiBaseObject)
    {
        obj_id self = getSelf();
    ...
    public int handleSpawnWaveOfDefenders(obj_id self, dictionary params)
    {
        params.put("mobileNumber", 0);
        messageTo(self, "handleSpawnNextDefender", params, rand(1, 10), false);
        return SCRIPT_CONTINUE;
    }
    public int handleSpawnNextDefender(obj_id self, dictionary params)
    {
        int mobileNumber = params.getInt("mobileNumber");
        obj_id poiBaseObject = self;
        obj_id target = getObjIdObjVar(poiBaseObject, "npc_lair.target");
    ...
    public int handleSpawnBossMonster(obj_id self, dictionary params)
    {
    ...
    public int handleCreatureDeath(obj_id self, dictionary params)
    {
        int numRespawned = getIntObjVar(self, "npc_lair.numRespawned");
        numRespawned++;
    ...
    public int handleRespawnCreature(obj_id self, dictionary params)
    {
    ...
    public obj_id spawnMobile(String name, obj_id target)
    {
        return spawnMobile(name, target, -1);
    }
    public obj_id spawnMobile(String name, obj_id target, int level)
    {
        return spawnMobile(name, target, level, true);
    }
    public obj_id spawnMobile(String name, obj_id target, boolean randomLoc)
    {
        return spawnMobile(name, target, -1, randomLoc);
    }
    public obj_id spawnMobile(String name, obj_id target, int level, boolean randomLoc)
    {
    ...
    public int handleNpcLairDecay(obj_id self, dictionary params)
    {
        poiComplete(POI_INCOMPLETE);
        messageTo(self, "handlePoiTimeOutDestruction", null, 14400f, false);
        return SCRIPT_CONTINUE;
    }
    public int handlePoiTimeOutDestruction(obj_id self, dictionary params)
    {
        destroyObject(self);
        return SCRIPT_CONTINUE;
    }
    public void makeBaby(obj_id mobile)
    {
    ...
    public int handleNpcAiManagement(obj_id self, dictionary params)
    {
        if (hasObjVar(self, "npc_lair.isCreatureLair"))
        {
    ...
    public void attachNPCLairAiScript(obj_id mobile, int mobileNumber)
    {
    ...
    public int handleScoutAlarm(obj_id self, dictionary params)
    {
        params.put("job", JOB_DEFEND);
        broadcastMessage("handleNpcLairCustomAi", params);
        return SCRIPT_CONTINUE;
    }
    public int handleCallForHealing(obj_id self, dictionary params)
    {
        if (!hasObjVar(self, "npc_lair.isCreatureLair"))
        {
            return SCRIPT_CONTINUE;
    ...
    public void doCreatureLairAiManagement(obj_id poiBaseObject)
    {
    ...
    public void doNPCLairAiManagement(obj_id poiBaseObject)
    {
        int numMobiles = getIntObjVar(poiBaseObject, "npc_lair.numberOfMobiles");
        if (numMobiles < 2 || numMobiles > 20)
        {
    ...
    public void setHpAndXpValues(obj_id poiBaseObject, obj_id target)
    {
    ...
    public boolean canOfferMission(obj_id mobile)
    {
        if (rand(1, 10) > 5)
        {
            return false;
