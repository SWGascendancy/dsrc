...
public class npc_lair_ai extends script.theme_park.poi.base
{
    ...
    public int handleDestruction(obj_id self, dictionary params)
    {
        destroyObject(self);
        return SCRIPT_CONTINUE;
    }
    ...
    public int handleDetachment(obj_id self, dictionary params)
    {
        detachScript(self, "systems.npc_lair.npc_lair_ai");
        return SCRIPT_CONTINUE;
    }
    ...
    public void doImmediateCommand(obj_id mobile, int job, dictionary params)
    {
        switch (job)
        {
            case JOB_DEFEND:
    ...
    public void respondToScoutAlarm(obj_id mobile, obj_id target)
    {
    ...
    public int handleNpcLairCustomAi(obj_id self, dictionary params)
    {
    ...
    public int OnMovePathBlocked(obj_id self)
    {
        if (utils.hasScriptVar(self, "pathingToHealLair"))
        {
            utils.removeScriptVar(self, "pathingToHealLair");
    ...
    public void setHomeLocationNearLair(obj_id mobile, obj_id baseObj)
    {
        if (!isIdValid(baseObj))
        {
            return;
    ...
    public void doLairHealing(obj_id mobile, dictionary params)
    {
    ...
    public int handleRecoverFromHealingLair(obj_id self, dictionary params)
    {
    ...
    public void pathToWithinTwoMetersOf(obj_id mobile, location destLoc)
    {
    ...
    public int handleRequestToConverse(obj_id self, dictionary params)
    {
