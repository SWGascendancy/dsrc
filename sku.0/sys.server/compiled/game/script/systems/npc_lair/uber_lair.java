...
public class uber_lair extends script.theme_park.poi.base
{
    ...
    public void createTheater(obj_id poiBaseObject, String lairType)
    {
    ...
    public int mobDestroyed(obj_id self, dictionary params)
    {
    ...
    public int spawnMobiles(obj_id self, dictionary params)
    {
    ...
    public int spawnFormations(obj_id self, dictionary params)
    {
