...
public class spawn_base extends script.base_script
{
    ...
    public int[] getValidSpawn(dictionary dctPlayerStats)
    {
    ...
    public boolean checkDifficulty(int intMinTemplateDifficulty, int intMaxTemplateDifficulty, dictionary dctPlayerStats)
    {
        return true;
    }
    public int getPlayerSpawnDiffibculty(obj_id objPlayer)
    {
    ...
    public obj_id createTemplate(location locSpawnLocation, dictionary params, obj_id objPlayer)
    {
    ...
    public dictionary chooseWeightedSpawnTemplate(int[] intDataIndex, String strRegionName, String strPlanetName, region rgnRegion)
    {
        String strFileName;
    ...
    public void sendSpawnSpam(obj_id objPlayer, boolean boolLogFailures, boolean boolVerboseMode, String strSpam)
    {
    ...
    public boolean getVerboseMode(obj_id objPlayer)
    {
        return hasObjVar(objPlayer, "spawning.verboseMode");
    }
    public boolean checkTemplatesInRange(obj_id objPlayer, location locHome, boolean boolCheckForTheaters, String strObjectType)
    {
        return true;
    }
    public boolean canSpawn(obj_id objPlayer, location locSpawnLocation, boolean boolCheckForTheaters, String strObjectType)
    {
    ...
    public region getSpawnRegion(obj_id objPlayer)
    {
    ...
    public void preLoadSpawnDataTables(obj_id objMasterSpawner)
    {
    }
    public boolean checkSpawnLogFailures() {
        String strConfigSetting = getConfigSetting("GameServer", "fastSpawn");
        return strConfigSetting != null && strConfigSetting.equals("true");
    }
    public boolean isSpawningAllowed(location locTest)
    {
    ...
    public String getFictionalRegionFileName(String strPlanet, String strFullName)
    {
        try {
    ...
    public String getOverLoadRegionFileName(String strRegionName)
    {
    ...
    public void doSpawnEvent(dictionary params)
    {
        if (params == null)
        {
            return;
    ...
    public void doSpawnTemplate(obj_id self, dictionary params)
    {
        String strLairType = params.getString("strLairType");
        dictionary dctParams = new dictionary();
    ...
    public int OnLocationReceived(obj_id self, String strId, obj_id objObject, location locSpawnLocation, float fltRadius)
    {
    ...
    public float getLocationSize(float fltLocation)
    {
        if (fltLocation < 32f)
        {
            return 32f;
    ...
    public boolean isGalaticCivilWarWinner(int faction, int threshold, int imperialScore)
    {
    ...
    public boolean checkGalacticCivilWarStandings(int gcwFaction, int gcwThreshold, int gcwScoreType, String gcwSpecificRegion, location loc)
    {
