...
public class spawn_player extends script.systems.spawning.spawn_base
{
    ...
    public int showSpawnRegion(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int secretSpawnSpam(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int createSpawningElement(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (params.equals(""))
        {
    ...
    public int createSpawningElementWithDifficulty(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (params.equals(""))
        {
    ...
    public int startSpawner(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int spawn_Trigger(obj_id self, dictionary params)
    {
        if (!isIdValid(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int specifyGroundSpawnerName(obj_id self, dictionary params)
    {
    ...
    public int duplicateLastSpawner(obj_id self, dictionary params)
    {
        int intButton = sui.getIntButtonPressed(params);
    ...
    public int specifyGroundSpawnerType(obj_id self, dictionary params)
    {
        int intButton = sui.getIntButtonPressed(params);
        if (intButton == sui.BP_CANCEL)
        {
    ...
    public int specifyGroundSpawnerSpawns(obj_id self, dictionary params)
    {
        int intButton = sui.getIntButtonPressed(params);
        if (intButton == sui.BP_CANCEL)
        {
    ...
    public int specifyGroundSpawnerDefaultBehavior(obj_id self, dictionary params)
    {
        int intButton = sui.getIntButtonPressed(params);
        if (intButton == sui.BP_CANCEL)
        {
    ...
    public int isValidBehavior(String strBehavior)
    {
    ...
    public int specifyGroundSpawnerGoodLocationType(obj_id self, dictionary params)
    {
        int intButton = sui.getIntButtonPressed(params);
        if (intButton == sui.BP_CANCEL)
        {
    ...
    public int specifyGroundSpawnerLocations(obj_id self, dictionary params)
    {
        int intButton = sui.getIntButtonPressed(params);
        if (intButton == sui.BP_CANCEL)
        {
    ...
    public int specifyGroundSpawnerRadius(obj_id self, dictionary params)
    {
        int intButton = sui.getIntButtonPressed(params);
        if (intButton == sui.BP_CANCEL)
        {
    ...
    public int specifyGroundSpawnerSpawnCount(obj_id self, dictionary params)
    {
        int intButton = sui.getIntButtonPressed(params);
        if (intButton == sui.BP_CANCEL)
        {
    ...
    public int specifyGroundSpawnerMinSpawnTime(obj_id self, dictionary params)
    {
        int intButton = sui.getIntButtonPressed(params);
        if (intButton == sui.BP_CANCEL)
        {
    ...
    public int specifyGroundSpawnerMaxSpawnTime(obj_id self, dictionary params)
    {
        int intButton = sui.getIntButtonPressed(params);
        if (intButton == sui.BP_CANCEL)
        {
    ...
    public int handlePatrolPathType(obj_id self, dictionary params)
    {
        int intButton = sui.getIntButtonPressed(params);
        if (intButton == sui.BP_CANCEL)
        {
    ...
    public int handlePlaceNewPatrolPoint(obj_id self, dictionary params)
    {
        int intButton = sui.getIntButtonPressed(params);
    ...
    public boolean canDuplicateLastSpawner(obj_id self)
    {
    ...
    public void handleMineFieldCreation()
    {
    ...
    public int handleSelectMineType(obj_id self, dictionary params)
    {
    ...
    public int handleSetFieldRadius(obj_id self, dictionary params)
    {
    ...
    public int handleSetMineCount(obj_id self, dictionary params)
    {
        int button = sui.getIntButtonPressed(params);
        if (button == sui.BP_CANCEL)
        {
    ...
    public int handleSetMineRespawn(obj_id self, dictionary params)
    {
        int button = sui.getIntButtonPressed(params);
        if (button == sui.BP_CANCEL)
        {
    ...
    public void clearMineScriptVar(obj_id player)
    {
    ...
    public int checkStationCells(obj_id self, dictionary params)
    {
