...
public class fs_datahandler extends script.base_script
{
    ...
    public int OnClusterWideDataResponse(obj_id self, String manager_name, String dataset_name, int request_id, String[] element_name_list, dictionary[] cluster_data, int lock_key)
    {
