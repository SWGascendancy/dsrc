...
public class fs_village_master extends script.base_script
{
    ...
    public int msgEnemySpawnPulse(obj_id self, dictionary params)
    {
    ...
    public int msgRequestTheatreRegistration(obj_id self, dictionary params)
    {
    ...
    public int msgNotifyTheatreDestroyed(obj_id self, dictionary params)
    {
    ...
    public int msgIntRegisteredUID(obj_id self, dictionary params)
    {
        boolean rslt = false;
        if (params.containsKey("success"))
        {
    ...
    public int msgIntRegisteredPhase(obj_id self, dictionary params)
    {
        boolean rslt = false;
        if (params.containsKey("success"))
        {
