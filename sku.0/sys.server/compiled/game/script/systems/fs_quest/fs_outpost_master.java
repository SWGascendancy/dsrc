...
public class fs_outpost_master extends script.base_script
{
    ...
    public void requestRegistration(obj_id self)
    {
    ...
    public int msgCheckForMasterAgain(obj_id self, dictionary params)
    {
        fs_dyn_village.getRegisteredObjIdFromClusterWideData(fs_dyn_village.CLUSTER_OBJID_KEY_MASTER, "msgGotMasterIdResponse", self);
        return SCRIPT_CONTINUE;
    }
    public int msgGotMasterIdResponse(obj_id self, dictionary params)
    {
        boolean rslt = false;
        String key = "";
    ...
    public int msgDoLootSpawn(obj_id self, dictionary params)
    {
        fs_counterstrike.doCampLootSpawn(self);
        return SCRIPT_CONTINUE;
    }
    public int msgReplyTheatreRegistration(obj_id self, dictionary params)
    {
        if (!params.containsKey("success"))
        {
    ...
    public int msgSurveillandeDroidDied(obj_id self, dictionary params)
    {
    ...
    public int msgPowerDownShield(obj_id self, dictionary params)
    {
    ...
    public int msgDoCampDefenseSpawn(obj_id self, dictionary params)
    {
        fs_counterstrike.doCampDefenseSpawn(self, true);
        return SCRIPT_CONTINUE;
    }
    public int msgResetCamp(obj_id self, dictionary params)
    {
        fs_counterstrike.resetCamp(self, true);
        return SCRIPT_CONTINUE;
    }
    public int OnTheaterCreated(obj_id self, obj_id[] objects, obj_id player, obj_id creator)
    {
