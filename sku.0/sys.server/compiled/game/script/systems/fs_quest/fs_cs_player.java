...
public class fs_cs_player extends script.base_script
{
    ...
    public int msgShieldPowerup(obj_id self, dictionary params)
    {
        fs_counterstrike.resetPlayerToStart(self, null);
    ...
    public int msgCommanderDied(obj_id self, dictionary params)
    {
        obj_id questGiver = null;
        obj_id sender = null;
    ...
    public int msgCommanderFree(obj_id self, dictionary params)
    {
    ...
    public void giveCrystal(obj_id player)
    {
    ...
    public int msgQuestComplete(obj_id self, dictionary params)
    {
    ...
    public int msgCommanderCaptured(obj_id self, dictionary params)
    {
    ...
    public void givePlayerCommanderWaypoint(obj_id player)
    {
        location loc = null;
    ...
    public void makePlayerEscort(obj_id player, obj_id commander)
    {
