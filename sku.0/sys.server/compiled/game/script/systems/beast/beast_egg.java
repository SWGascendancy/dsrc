...
public class beast_egg extends script.base_script
{
    ...
    public int rename_egg(obj_id self, dictionary params)
    {
    ...
    public int handleInitializeValues(obj_id self, dictionary params)
    {
        LOG("beast", "beast_egg: handleInitializeValues()");
        incubator.initializeEgg(self);
        return SCRIPT_CONTINUE;
    }
    public int handleStampEggAsMount(obj_id self, dictionary params)
    {
    ...
    public int handleConvertEggToHolobeast(obj_id self, dictionary params)
    {
        int bp = sui.getIntButtonPressed(params);
        if (bp == sui.BP_CANCEL)
        {
