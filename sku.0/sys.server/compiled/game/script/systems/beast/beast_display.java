...
public class beast_display extends script.base_script
{
    ...
    public void turnOff(obj_id source)
    {
    ...
    public void displayBeast(obj_id source)
    {
    ...
    public int beast_display(obj_id self, dictionary params)
    {
        displayBeast(self);
        return SCRIPT_CONTINUE;
    }
    public int furniture_rotated(obj_id self, dictionary params)
    {
    ...
    public int furniture_moved(obj_id self, dictionary params)
    {
        obj_id beastDisplayed = getObjIdObjVar(self, "displayed");
        if (!isIdValid(beastDisplayed))
        {
