...
public class base_incubator extends script.base_script
{
    ...
    public int OnTriggerVolumeEntered(obj_id self, String volName, obj_id breecher)
    {
    ...
    public int handleActivateSui(obj_id self, dictionary params)
    {
    ...
    public int handleCleanseSui(obj_id self, dictionary params)
    {
        int bp = sui.getIntButtonPressed(params);
        if (bp == sui.BP_CANCEL)
        {
    ...
    public int handleHomeOwnerCleanseSui(obj_id self, dictionary params)
    {
        int bp = sui.getIntButtonPressed(params);
        if (bp == sui.BP_CANCEL)
        {
    ...
    public int cleanseOldIncubator(obj_id self, dictionary params)
    {
        incubator.incubatorTotalCleanse(self);
        return SCRIPT_CONTINUE;
    }
    public int handlerIncubatorSessionUpdate(obj_id self, dictionary params)
    {
...
// finch            float exoticMutationBonus = unmodifiedExoticDpsArmorBonus * 0.075f;
    ...
    public int refreshCurrentParticle(obj_id self, dictionary params)
    {
        obj_id station = self;
