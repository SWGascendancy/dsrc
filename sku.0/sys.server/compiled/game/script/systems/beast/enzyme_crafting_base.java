...
public class enzyme_crafting_base extends script.base_script
{
    ...
    public void completeAnyOperations()
    {
    ...
    public boolean isInValidOperatingLocation()
    {
    ...
    public String getTimeToFinishString()
    {
        return utils.formatTimeVerbose(getTimeToFinishInt());
    }
    public boolean isValidComponentForMachine(obj_id passedItem)
    {
    ...
    public boolean validateCentrifugeOperation()
    {
    ...
    public boolean validateProcessorOperation()
    {
        obj_id[] contents = getContents(getSelf());
    ...
    public boolean validateCombinerOperation()
    {
        obj_id[] contents = getContents(getSelf());
    ...
    public int startProcess(obj_id player)
    {
        return startProcess(player, -1);
    }
    public int startProcess(obj_id player, int time)
    {
        int machineType = getMachineType();
        switch (machineType)
        {
    ...
    public int startCentrifuge(obj_id player, int time)
    {
    ...
    public int startProcessor(obj_id player, int time)
    {
    ...
    public int startCombiner(obj_id player, int time)
    {
    ...
    public float averagePurityFromElements()
    {
        float total = 0.0f;
        for (int i = 0; i < ENZYME_ELEMENT_LIST.length; i++)
        {
    ...
    public float averageMutagenFromElements()
    {
        float total = 0.0f;
        for (int i = 0; i < ENZYME_ELEMENT_LIST.length; i++)
        {
    ...
    public obj_id getObjIdByTemplate(String template)
    {
        obj_id[] contents = getContents(getSelf());
        if (contents == null || contents.length == 0)
        {
    ...
    public void colorElement(obj_id element)
    {
