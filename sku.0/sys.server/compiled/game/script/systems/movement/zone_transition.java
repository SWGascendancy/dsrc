...
public class zone_transition extends script.base_script
{
    ...
    public void handleListBoxZoneSelect(obj_id self, String[] parsedList, Vector building_ids, Vector zone_population)
    {
        obj_id player = utils.getObjIdScriptVar(self, "playerId");
    ...
    public String getColorCodedPopIndex(obj_id controller, int population)
    {
        if (population < HEAVY)
        {
    ...
    public int handleSelectDestinationZone(obj_id self, dictionary params)
    {
    ...
    public int recievedTargetCoordinates(obj_id self, dictionary params)
    {
    ...
    public int handleZoneTransitionRequest(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
