...
public class paired_object_movement extends script.base_script
{
    ...
    public obj_id[] getPairedObjects(obj_id self)
    {
    ...
    public boolean wasValidSelection(int selection)
    {
    ...
    public obj_id getObjectSelected(obj_id[] selections, int menu_item)
    {
        for (int i = 0; i < MULTI_MENU.length; i++)
        {
    ...
    public void doPairedTransition(obj_id player, obj_id warpToObject)
    {
