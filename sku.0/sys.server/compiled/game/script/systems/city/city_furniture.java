...
public class city_furniture extends script.base_script
{
    ...
    public int requestDestroy(obj_id self, dictionary params)
    {
        if (hasObjVar(self, "returnObjectToOwner"))
        {
            obj_id decorationOwner = getOwner(self);
    ...
    public void placeDecoration(int city_id, obj_id player, obj_id self)
    {
        String command = null;
    ...
    public void removalCleanup(obj_id object, obj_id player, boolean spam)
    {
    ...
    public boolean moveCityDecorationToOwnerInventory(obj_id player, obj_id item)
    {
