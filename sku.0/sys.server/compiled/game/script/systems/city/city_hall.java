...
public class city_hall extends script.base_script
{
    ...
    public int updateCityLocation(obj_id self, dictionary params)
    {
        int city_id = findCityByCityHall(self);
        city.updateLocation(city_id, getLocation(self));
        return SCRIPT_CONTINUE;
    }
    public int initializeNewCity(obj_id self, dictionary params)
    {
    ...
    public int addNewCityStructures(obj_id self, dictionary params)
    {
    ...
    public int validateCity(obj_id self, dictionary params)
    {
        int city_id = findCityByCityHall(self);
    ...
    public int registerVoteTerminal(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int resetVoteTerminal(obj_id self, dictionary params)
    {
    ...
    public int expandCity(obj_id self, dictionary params)
    {
    ...
    public int contractCity(obj_id self, dictionary params)
    {
        int rank = params.getInt("rank") + 1;
        int radius = params.getInt("radius");
        int city_id = findCityByCityHall(self);
    ...
    public int checkCivicCap(obj_id self, dictionary params)
    {
        int city_id = findCityByCityHall(self);
        obj_id mayor = cityGetLeader(city_id);
        String mayor_name = cityGetCitizenName(city_id, mayor);
    ...
    public int payMaintenance(obj_id self, dictionary params)
    {
        int city_id = findCityByCityHall(self);
    ...
    public int reportTotalPaid(obj_id self, dictionary params)
    {
        int city_id = findCityByCityHall(self);
    ...
    public void payStructureMaint(obj_id self, int city_id, obj_id structure, boolean spec)
    {
    ...
    public int handleMaintSuccess(obj_id self, dictionary params)
    {
    ...
    public int handleMaintFail(obj_id self, dictionary params)
    {
        int city_id = params.getInt("city_id");
        int cost = params.getInt("cost");
        obj_id structure = params.getObjId("structure");
    ...
    public void damageCityStructure(obj_id self, obj_id structure, int cost)
    {
        int city_id = findCityByCityHall(self);
        obj_id mayor = cityGetLeader(city_id);
        String mayor_name = cityGetCitizenName(city_id, mayor);
    ...
    public void paySpecialMaint(obj_id self, int city_id, obj_id structure)
    {
        int cost = city.getStructureCost(city_id, structure);
        if (cost == 0)
        {
    ...
    public int handleSpecMaintSuccess(obj_id self, dictionary params)
    {
        int cost = params.getInt("cost");
        int total_paid = utils.getIntScriptVar(self, "maint.paid");
        total_paid += cost;
    ...
    public int handleSpecMaintFail(obj_id self, dictionary params)
    {
        int city_id = params.getInt("city_id");
        obj_id city_hall = cityGetCityHall(city_id);
        String city_name = cityGetName(city_id);
    ...
    public int setVoteInterval(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int msgCheckMyCityMotd(obj_id self, dictionary params)
    {
    ...
    public int st_citySpecBonusCheck(obj_id self, dictionary params)
    {
    ...
    public void validateSafeCitizenCount(obj_id city_hall, int city_id)
    {
    ...
    public void forceRemoveSafeCitizen(int city_id, int numCitizensToRemove, obj_id city_hall)
    {
        if (!cityExists(city_id))
        {
    ...
    public int handleMultipleSafeHouseCitizenRemoval(obj_id self, dictionary params)
    {
        int city_id = params.getInt("city_id");
    ...
    public int QaTestSafeHouseOverload(obj_id self, dictionary params)
    {
        int city_id = getCityAtLocation(getLocation(self), 0);
        obj_id city_hall = cityGetCityHall(city_id);
    ...
    public int retryDepersistCityFactionalAlignment(obj_id self, dictionary params)
    {
    ...
    public int retryDepersistCityGcwRegionDefender(obj_id self, dictionary params)
    {
        int numberOfRetry = params.getInt("number_of_retry");
        if (numberOfRetry >= 5)
        {
