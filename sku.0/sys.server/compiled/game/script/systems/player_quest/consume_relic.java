...
public class consume_relic extends script.base_script
{
    ...
    public boolean getUiConsumeMessageBox(obj_id self, obj_id player, String prompt, String title, String handler)
    {
    ...
    public int handlerSuiAddToQuestBuilder(obj_id self, dictionary params)
    {
    ...
    public int handlerSuiRelicDeconstruct(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
    ...
    public void deconstructRelic(obj_id player, obj_id self, boolean deconstructEntireStack)
    {
        if (!utils.isNestedWithin(self, player))
        {
            return;
