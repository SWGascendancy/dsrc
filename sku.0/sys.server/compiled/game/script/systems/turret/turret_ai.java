...
public class turret_ai extends script.systems.combat.combat_base_old
{
    ...
    public void setTurretAttributes(obj_id self, int turretFaction)
    {
    ...
    public obj_id getGoodTurretTarget()
    {
        obj_id self = getSelf();
    ...
    public obj_id[] cullInvalidTargets(obj_id self, obj_id[] old_targets)
    {
        if (old_targets == null || old_targets.length == 0)
        {
            return null;
    ...
    public obj_id[] removeIncapacitatedTargets(obj_id self, obj_id[] targets)
    {
    ...
    public void explodeTurret(obj_id turretid, obj_id killer)
    {
    ...
    public float doAttack(obj_id target)
    {
        obj_id self = getSelf();
        obj_id base = getObjIdObjVar(self, hq.VAR_DEFENSE_PARENT);
    ...
    public int handleTurretAttack(obj_id self, dictionary params)
    {
    ...
    public int effectManager(obj_id self, dictionary params)
    {
        utils.removeScriptVar(self, "playingEffect");
        return SCRIPT_CONTINUE;
    }
    public int expireLair(obj_id self, dictionary params)
    {
        destroyObject(self);
        return SCRIPT_CONTINUE;
    }
    public int enemyDecloaked(obj_id self, dictionary params)
    {
    ...
    public int handleDestroyTurret(obj_id self, dictionary params)
    {
        destroyObject(self);
        return SCRIPT_CONTINUE;
    }
