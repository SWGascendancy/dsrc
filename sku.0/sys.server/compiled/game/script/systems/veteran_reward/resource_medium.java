...
public class resource_medium extends script.base_script
{
    public resource_medium()
    {
    }
    public static final int RESOURCE_AMOUNT = 15000;
    ...
    public int handleChooseResourceClass(obj_id self, dictionary params)
    {
    ...
    public int handleChooseResourceType(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            cleanup();
    ...
    public int handleChooseResourceTypeStats(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            cleanup();
    ...
    public int handleCreateChosenResourceConfirm(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            cleanup();
    ...
    public void showResourceStats(obj_id player, obj_id resource)
    {
        if (!isIdValid(player))
        {
            cleanup();
    ...
    public void chooseResourceClass(obj_id player, String parentClass)
    {
        chooseResourceClass(player, parentClass, false);
    }
    public void chooseResourceClass(obj_id player, String parentClass, boolean topLevel)
    {
    ...
    public void chooseResourceType(obj_id player, String parentClass)
    {
        if (!utils.hasScriptVar(getSelf(), SCRIPTVAR_INUSE))
        {
            cleanup();
    ...
    public String[] filterTopLevelResourceList(String parentClass)
    {
        String[] resourceClasses = null;
