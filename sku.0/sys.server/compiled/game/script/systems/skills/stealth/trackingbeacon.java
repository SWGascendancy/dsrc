...
public class trackingbeacon extends script.base_script
{
    ...
    public int msgDecaySample(obj_id self, dictionary params)
    {
    ...
    public int msgTrackingBeaconLocationReply(obj_id self, dictionary params)
    {
    ...
    public int msgTrackingBeaconUpdate(obj_id self, dictionary params)
    {
