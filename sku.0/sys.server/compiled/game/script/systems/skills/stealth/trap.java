...
public class trap extends script.systems.combat.combat_base
{
    ...
    public int msgSelfDestructTimeout(obj_id self, dictionary params)
    {
        stealth.playSelfDestruct(self);
        destroyObject(self);
        return SCRIPT_CONTINUE;
    }
    public int msgTryDetonateTimer(obj_id self, dictionary params)
    {
    ...
    public int msgTryRemoteDetonate(obj_id self, dictionary params)
    {
    ...
    public int msgArmProximity(obj_id self, dictionary params)
    {
    ...
    public int msgSetArmed(obj_id self, dictionary params)
    {
    ...
    public int msgProximitySetup(obj_id self, dictionary params)
    {
        int triggerType = getIntObjVar(self, stealth.TRIGGER_TYPE);
    ...
    public int msgTimerSetup(obj_id self, dictionary params)
    {
        int triggerType = getIntObjVar(self, stealth.TRIGGER_TYPE);
    ...
    public int co_mine_hx2(obj_id self, dictionary params)
    {
