...
public class player_stealth extends script.systems.combat.combat_base
{
    ...
    public int smokeBombTimerExpired(obj_id self, dictionary params)
    {
    ...
    public int withoutTraceTimerExpired(obj_id self, dictionary params)
    {
    ...
    public int msgMotionSensorTripped(obj_id self, dictionary params)
    {
    ...
    public int msgTrackingBeaconLocationRequest(obj_id self, dictionary params)
    {
    ...
    public int invisibilityUpkeep(obj_id self, dictionary params)
    {
    ...
    public int handleStealCashSuccess(obj_id self, dictionary params)
    {
        int amt = params.getInt(money.DICT_AMOUNT);
        withdrawCashFromBank(self, amt, "handleStealCashFinal", "handleStealCashFail", params);
        return SCRIPT_CONTINUE;
    }
    public int handleStealCashFail(obj_id self, dictionary params)
    {
        int amt = params.getInt(money.DICT_AMOUNT);
        CustomerServiceLog("stealing", "%TU failed to steal " + amt + " credits.", self);
        return SCRIPT_CONTINUE;
    }
    public int handleStealCashFinal(obj_id self, dictionary params)
    {
        int amt = params.getInt(money.DICT_AMOUNT);
