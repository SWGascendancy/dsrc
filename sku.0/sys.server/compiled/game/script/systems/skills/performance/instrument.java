...
public class instrument extends script.base_script
{
    ...
    public boolean isActiveInstrument(obj_id player)
    {
        obj_id self = getSelf();
    ...
    public int checkLocation(obj_id self, dictionary params)
    {
    ...
    public int checkInstrumentCleanup(obj_id self, dictionary params)
    {
        if (hasObjVar(self, "instrument.owner"))
        {
            obj_id owner = getObjIdObjVar(self, "instrument.owner");
