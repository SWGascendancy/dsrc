...
public class select_performance extends script.base_script
{
    ...
    public int msgSongSelected(obj_id self, dictionary params)
    {
    ...
    public int msgDanceSelected(obj_id self, dictionary params)
    {
    ...
    public int msgJuggleSelected(obj_id self, dictionary params)
    {
