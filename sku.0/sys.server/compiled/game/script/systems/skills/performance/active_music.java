...
public class active_music extends script.base_script
{
    ...
    public int OnSawEmote(obj_id self, obj_id actor, String emote)
    {
    ...
    public int OnPulse(obj_id self, dictionary params)
    {
        if (!pet_lib.isDroidPet(self))
        {
    ...
    public int OnFlourish(obj_id self, dictionary params)
    {
    ...
    public int OnSpecialFlourish(obj_id self, dictionary params)
    {
        int flourishIndex = params.getInt("flourishIndex");
        sendMusicFlourish(self, flourishIndex);
        return SCRIPT_CONTINUE;
    }
    public int OnClearFlourish(obj_id self, dictionary params)
    {
        setObjVar(self, performance.VAR_PERFORM_FLOURISH, 0);
        return SCRIPT_CONTINUE;
    }
    public int OnEffect(obj_id self, dictionary params)
    {
    ...
    public int OnClearEffect(obj_id self, dictionary params)
    {
        setObjVar(self, performance.VAR_PERFORM_EFFECT, 0);
        return SCRIPT_CONTINUE;
    }
    public int OnPerformanceEnd(obj_id self, dictionary params)
    {
        detachScript(self, performance.MUSIC_HEARTBEAT_SCRIPT);
        return SCRIPT_CONTINUE;
    }
    public int handleInspireMenu(obj_id self, dictionary params)
    {
