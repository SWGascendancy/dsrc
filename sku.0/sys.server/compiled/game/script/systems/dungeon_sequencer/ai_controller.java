...
public class ai_controller extends script.base_script
{
    ...
    public int OnAiTetherStart(obj_id self)
    {
        messageTo(self, "tether_delay", null, 3.0f, false);
        return SCRIPT_CONTINUE;
    }
    public int tether_delay(obj_id self, dictionary params)
    {
    ...
    public void resetSequenceMovement()
    {
        obj_id self = getSelf();
        if (!isIdValid(self) || !exists(self))
        {
    ...
    public int doPathAction(obj_id self, dictionary params)
    {
    ...
    public int wsDoAnimation(obj_id self, dictionary params)
    {
        String anim = params.getString("animation");
        doAnimationAction(self, anim);
        return SCRIPT_CONTINUE;
    }
    public int wsPlayEmote(obj_id self, dictionary params)
    {
        return SCRIPT_CONTINUE;
    }
    public int wsSignalMaster(obj_id self, dictionary params)
    {
        return SCRIPT_CONTINUE;
    }
    public int wsDespawn(obj_id self, dictionary params)
    {
        messageTo(self, "destroySelf", null, 5.0f, false);
        return SCRIPT_CONTINUE;
    }
    public int wsToggleInvulnerability(obj_id self, dictionary params)
    {
    ...
    public int customSignal(obj_id self, dictionary params)
    {
    ...
    public void handleDeathTrigger(obj_id self, obj_id killer)
    {
    ...
    public int OnArrivedAtLocation(obj_id self, String location)
    {
    ...
    public int handleDelayedCleanup(obj_id self, dictionary params)
    {
        trial.cleanupObject(self);
        return SCRIPT_CONTINUE;
    }
    public void executeTriggerData(obj_id self, String triggerData)
    {
        executeTriggerData(self, triggerData, false);
    }
    public int handleTriggerData(obj_id self, dictionary params)
    {
    ...
    public void executeTriggerData(obj_id self, String triggerData, boolean suspend)
    {
    ...
    public void executeEmoteTrigger(obj_id self, String[] parse)
    {
        String chatType = parse[1];
        String chatMessage = parse[2];
        chat.chat(self, chatType, new string_id("sequencer_spam", chatMessage));
    }
    public void executeSignalCompleteMessage(obj_id self, String[] parse)
    {
    ...
    public void executeSignalMasterTrigger(obj_id self, String[] parse)
    {
    ...
    public void executeAnimationTrigger(obj_id self, String[] parse)
    {
    ...
    public void executeFacingTrigger(obj_id self, String[] parse)
    {
    ...
    public void executeMessageSelfTrigger(obj_id self, String[] parse)
    {
        String handlerName = parse[1];
        dictionary dict = new dictionary();
        if (!parse[2].equals("none"))
    ...
    public void executeIdTrigger(obj_id self, String[] parse)
    {
        dictionary dict = trial.getSessionDict(trial.getParent(self));
    ...
    public int resumeMovement(obj_id self, dictionary params)
    {
    ...
    public void pathToPoint(obj_id self, String pointName)
    {
        location toPoint = getPointLocation(pointName);
        pathTo(self, toPoint);
        return;
    }
    public void calculatePathPoint(obj_id self, String pointName)
    {
    }
    public void beginPathRoutine(obj_id self, String pathName)
    {
    ...
    public String[] filterRandomPoints(String patrolListString)
    {
    ...
    public location[] getLocationListFromPointList(String[] pointList)
    {
    ...
    public location[] getPatrolPathData(String patrolData)
    {
        debugSpeakMsg(getSelf(), patrolData);
        return null;
    }
    public void initiatePatrol(obj_id self, String patrolType, location[] patrolPoints)
    {
    ...
    public int setLocationTarget(obj_id self, dictionary params)
    {
    ...
    public void reportDeath(obj_id self, obj_id killer)
    {
    ...
    public obj_id getSpawnIdFromList(obj_id[] list, String spawn)
    {
    ...
    public location getPointLocation(String pointName)
    {
        obj_id self = getSelf();
    ...
    public location[] getPplForNpc(obj_id sender, String patrolType, location[] patrolPoints)
    {
        int idx = getNearestPatrolPointIndex(sender, patrolPoints);
        patrolPoints = trial.shuffleByIndex(patrolType, patrolPoints, idx);
        return patrolPoints;
    }
    public int getNearestPatrolPointIndex(obj_id sender, location[] patrolLoc)
    {
