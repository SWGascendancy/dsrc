...
public class sequence_controller extends script.base_script
{
    ...
    public boolean isController(obj_id object)
    {
        return hasScript(object, "systems.dungeon_sequencer.sequence_controller");
    }
    public void cacheInstanceTable()
    {
    ...
    public dictionary getTriggerKeyList(dictionary dict, String[] triggerId)
    {
    ...
    public dictionary cachedDataGetRow(int row)
    {
        if (!isController(getSelf()))
        {
            return null;
    ...
    public int beginSpawn(obj_id self, dictionary params)
    {
        handleCleanup(self);
        cacheInstanceTable();
    ...
    public int delaySpawnActors(obj_id self, dictionary params)
    {
    ...
    public int cleanupSpawn(obj_id self, dictionary params)
    {
        handleCleanup(self);
        return SCRIPT_CONTINUE;
    }
    ...
    public void handleCleanup(obj_id self)
    {
    ...
    public int handleDelayCleanup(obj_id self, dictionary params)
    {
        destroyObject(self);
        return SCRIPT_CONTINUE;
    }
    public int restartSpawn(obj_id self, dictionary params)
    {
        messageTo(self, "cleanupSpawn", null, 0.0f, false);
        messageTo(self, "beginSpawn", null, 5.0f, false);
        return SCRIPT_CONTINUE;
    }
    public obj_id[] getSpawnedChildren(obj_id self)
    {
    ...
    public void removeSpawnChild(obj_id object, String spawn_id)
    {
    ...
    public void spawnActors(obj_id self, String triggerId)
    {
    ...
    public void spawnActorRow(int row)
    {
    ...
    public void spawnActorRow(dictionary dict)
    {
    ...
    public void attachSpawnScripts(obj_id subject, String spawnScripts)
    {
        attachSpawnScripts(subject, spawnScripts, -1);
    }
    public void attachSpawnScripts(obj_id subject, String spawnScripts, int type)
    {
        if (type > -1)
        {
            switch (type)
    ...
    public void setSpawnObjVar(obj_id newObject, String objvarString)
    {
    ...
    public dictionary parseTriggerData(String data)
    {
    ...
    public void setClientEffectData(obj_id object, String passedString)
    {
    ...
    public void setTriggerEventData(obj_id object, String passedEventData)
    {
    ...
    public int triggerFired(obj_id self, dictionary params)
    {
    ...
    public void doMessageTo(String message)
    {
        int SPAWN_ID = 1;
    ...
    public void doMessgeTo(obj_id target, String message)
    {
        _doMessageTo(target, split(message, ';'));
    }
    public void _doMessageTo(obj_id target, String[] completeParse)
    {
        int HANDLER_NAME = 2;
        int PARAMS = 3;
    ...
    public void signalMaster(String message)
    {
        int HANDLER_NAME = 1;
        int PARAMS = 2;
        String[] completeParse = split(message, ';');
    ...
    public void doPlayMusicInArea(String message)
    {
    ...
    public void doPlayEffectOnPlayers(String message, location spawnLoc)
    {
        String[] parse = split(message, ':');
        if (parse == null || parse.length == 0)
        {
    ...
    public void doPlayEffectInAreaWithLabel(String message, location spawnLoc)
    {
        String[] parse = split(message, ':');
        if (parse == null || parse.length == 0)
        {
    ...
    public void storeTriggerEvents(obj_id object, String event)
    {
    ...
    public void storeDeathTrigger(obj_id object, String event)
    {
    ...
    public void storeEnterCombatTrigger(obj_id object, String event)
    {
        String[] parse = split(event, ':');
    ...
    public void storeExitCombatTrigger(obj_id object, String event)
    {
        String[] parse = split(event, ':');
    ...
    public void storeArrivedLocationTrigger(obj_id object, String event)
    {
    ...
    public void storeCustomSignal(obj_id object, String event)
    {
        String[] parse = split(event, ':');
    ...
    public void doDeleteSpawn(String deleteString)
    {
    ...
    public int handleDelayedDeleteSpawn(obj_id self, dictionary params)
    {
        if (!trial.verifySession(self, params))
        {
            return SCRIPT_CONTINUE;
    ...
    public void storeSpawnedChild(obj_id self, obj_id child, String spawn_id)
    {
    ...
    public void sendDelayedSpawnActors(String triggerId)
    {
    ...
    public int doDelayedSpawnActors(obj_id self, dictionary params)
    {
        if (!trial.verifySession(self, params))
        {
            return SCRIPT_CONTINUE;
    ...
    public void setUpWaitTree(String object)
    {
        obj_id self = getSelf();
    ...
    public void sendTaskCompleteSignal(String object)
    {
        obj_id self = getSelf();
        String[] parse = split(object, ':');
        if (parse.length < 2)
    ...
    public int waitForComplete(obj_id self, dictionary params)
    {
    ...
    public void completeTaskId(String signal)
    {
    ...
    public void handleCheckForComplete(String masterList, String signal)
    {
    ...
    public obj_id establishPatrolPoint(String ppData, location spawnLoc, boolean isIndoor)
    {
    ...
    public obj_id[] getObjectsInSpawnedListWithObjVar(obj_id self, String objvar)
    {
        obj_id[] children = getSpawnedChildren(self);
        return trial.getObjectsInListWithObjVar(children, objvar);
    }
    public void queueDelayAction(String object)
    {
        String[] parse = split(object, ':');
    ...
    public void setWayPointLinks(obj_id self)
    {
        if (true)
        {
            return;
    ...
    public void establishConnectionData(obj_id point, obj_id[] ppl)
    {
    ...
    public int terminationCallback(obj_id self, dictionary params)
    {
        if (!trial.verifySession(self, params))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleDelayedSpawnRow(obj_id self, dictionary params)
    {
        if (!trial.verifySession(self, params))
        {
            return SCRIPT_CONTINUE;
    ...
    public obj_id doRandomSpawn(String[] list, location spawnLoc)
    {
    ...
    public void executeRandomTrigger(String object)
    {
        String[] parse = split(object, ':');
    ...
    public void sendInstanceMessage(String object)
    {
        String[] parse = split(object, ':');
        String sid = parse[1];
    ...
    public void performTheaterAction(obj_id self, String object)
    {
        String[] parse = split(object, ':');
    ...
    public void performFacingAction(obj_id self, obj_id actor, String object)
    {
        String[] parse = split(object, ':');
    ...
    public void performChatAction(obj_id self, obj_id actor, String object)
    {
        String[] parse = split(object, ':');
    ...
    public void performAnimation(obj_id self, obj_id actor, String object)
    {
        String[] parse = split(object, ':');
        String action = parse[3];
        doAnimationAction(actor, action);
    }
    public void doObjVarAction(obj_id self, String object)
    {
        String[] parse = split(object, ':');
        String id = parse[1];
        String action = parse[2];
    ...
    public void doScriptAction(obj_id self, String object)
    {
        String[] parse = split(object, ':');
        String id = parse[1];
        String action = parse[2];
    ...
    public void setBuffHandler(obj_id self, String object)
    {
        String[] parse = split(object, ':');
        String action = parse[1];
    ...
    public void setCellPermission(obj_id self, String object)
    {
        String[] parse = split(object, ':');
    ...
    public int sendProxySignal(obj_id self, dictionary params)
    {
        if (!trial.verifySession(self, params))
        {
            return SCRIPT_CONTINUE;
    ...
    public void setFullPathData(obj_id object)
    {
        obj_id self = getSelf();
    ...
    public String[] getFullPathData(obj_id instance)
    {
        obj_id self = getSelf();
    ...
    public int[] fillRowArray(int num_rows)
    {
    ...
    public String[] getPathPointLocationArrayKeyList(String[] object, String[] room, float[] loc_x, float[] loc_y, float[] loc_z)
    {
    ...
    public int view(obj_id self, dictionary params)
    {
    ...
    public void setFullPathDataDictionary(String[] pp_location, String[] path_data)
    {
        dictionary dict = new dictionary();
    ...
    public dictionary getPpLocDict(dictionary dict, String[] pp_location)
    {
    ...
    public location[] getLocArrayFromLocString(String[] locationString)
    {
    ...
    public dictionary fillPathKeyList(dictionary dict, String[] path_data, String[] points, location[] locs)
    {
    ...
    public void handleSetCellLabel(obj_id self, String object)
    {
        String[] parse = split(object, ':');
        String cellName = parse[1];
    ...
    public int registerObjectWithSequencer(obj_id self, dictionary params)
    {
        obj_id object = params.getObjId("object");
    ...
    public int unregisterObjectWithSequencer(obj_id self, dictionary params)
    {
        obj_id object = params.getObjId("object");
        String spawn_id = params.getString("spawn_id");
    ...
    public void setPlayerListOnObject(obj_id sequencer, obj_id object)
    {
