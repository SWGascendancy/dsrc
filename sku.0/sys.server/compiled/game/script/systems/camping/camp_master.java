...
public class camp_master extends script.base_script
{
    ...
    public int theaterFinished(obj_id self, dictionary params)
    {
        notifyChildren(self, "handleCampPrep");
        return SCRIPT_CONTINUE;
    }
    public void notifyChildren(obj_id self, String msg)
    {
    ...
    public void addCampMember(obj_id self, obj_id owner, obj_id who)
    {
        if (who == owner)
        {
            setObjVar(self, camping.VAR_OWNER_NEAR, true);
    ...
    public int OnHealingLoop(obj_id self, dictionary params)
    {
        int campPower = getIntObjVar(self, camping.VAR_CAMP_POWER);
        obj_id[] players = getPlayerCreaturesInRange(getLocation(self), camping.getCampSize(self));
        if (players != null)
    ...
    public int handleSetStatus(obj_id self, dictionary params)
    {
    ...
    public void setCampfire(obj_id self, String tpf)
    {
        obj_id item = getObjIdObjVar(self, VAR_CAMP_CAMPFIRE);
        if ((item == null) || (item == obj_id.NULL_ID))
        {
    ...
    public int handleCampCreationHeartbeat(obj_id self, dictionary params)
    {
    ...
    public int handleCampComplete(obj_id self, dictionary params)
    {
        if (!hasObjVar(self, camping.VAR_OWNER))
        {
            camping.nukeCamp(self);
    ...
    public int handleCampMaintenanceHeartbeat(obj_id self, dictionary params)
    {
        if (!hasObjVar(self, camping.VAR_OWNER))
        {
    ...
    public int handleCampRestoreHeartbeat(obj_id self, dictionary params)
    {
        if (!hasObjVar(self, camping.VAR_OWNER))
        {
            camping.nukeCamp(self);
    ...
    public int handleNuke(obj_id self, dictionary params)
    {
        camping.nukeCamp(self);
        return SCRIPT_CONTINUE;
    }
