...
public class volleytarget extends script.base_script
{
    ...
    public void notifyVolleyTargetDone()
    {
        obj_id self = getSelf();
    ...
    public void notifyVolleyTargetDone(obj_id group)
    {
    ...
    public int msgMarkedByGroup(obj_id self, dictionary params)
    {
    ...
    public int msgUnmarkedByGroup(obj_id self, dictionary params)
    {
        obj_id group = params.getObjId("objGroup");
        if (!isIdValid(group))
        {
