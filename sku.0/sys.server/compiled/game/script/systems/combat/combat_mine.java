...
public class combat_mine extends script.base_script
{
    ...
    public void doCommandoDeactivateAction(obj_id player)
    {
    ...
    public void doSmugglerFlagSwitchAction(obj_id player)
    {
    ...
    public int showStatusFlyText(obj_id self, dictionary params)
    {
    ...
    public void verifyMine(obj_id landMine)
    {
    ...
    public void setDetonateVolumeByType(obj_id landMine)
    {
        String mineType = getStringObjVar(landMine, "mineType");
    ...
    public obj_id[] getTargetsInBlastRadius()
    {
    ...
    public void applyMineEffects(obj_id[] targets)
    {
        obj_id landMine = getSelf();
    ...
    public int getDamageTypeFromString(String damageType)
    {
    ...
    public boolean isValidTargetTypeByMineFlag(obj_id subject)
    {
    ...
    public boolean willTriggerMineBlast(obj_id breacher)
    {
