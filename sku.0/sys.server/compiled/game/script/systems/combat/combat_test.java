...
public class combat_test extends script.base_script
{
    ...
    public int OnHearSpeech(obj_id self, obj_id speaker, String message)
    {
    ...
    public int OnWeaponCombatAction(obj_id self, obj_id attacker, obj_id defender)
    {
        return SCRIPT_CONTINUE;
    }
    public int OnDefenderCombatAction(obj_id self, obj_id attacker, obj_id weapon, int where)
    {
        return SCRIPT_CONTINUE;
    }
    public String returnDamType(int attribute)
    {
        String damType;
        switch (attribute)
        {
    ...
    public String victimReportDamage(obj_id self, obj_id attacker, attrib_mod[] attackEffects)
    {
        int effectsLength = 0;
    ...
    public String getHitLocationName(obj_id self, int hitLocation)
    {
    ...
    public int doStateCheck(obj_id self, int hitLocation, obj_id weapon, attrib_mod[] attackEffects)
    {
        String hitLocationName;
        int hit;
        switch (hitLocation)
    ...
    public String reportAttribs(obj_id target)
    {
        String reportsum = "";
        String element = "";
        String attribname = "";
