...
public class combat_base extends script.base_script
{
    ...
    public boolean combatStandardAction(String actionName, obj_id self, obj_id target, String params, String successHandler, String failHandler)
    {
        return combatStandardAction(actionName, self, target, getCurrentWeapon(self), params, null, false, false, 0);
    }
    public boolean combatStandardAction(String actionName, obj_id self, obj_id target, String params, String successHandler, String failHandler, int overloadDamage)
    {
        return combatStandardAction(actionName, self, target, getCurrentWeapon(self), params, null, false, false, overloadDamage);
    }
    public boolean combatStandardAction(String actionName, obj_id self, obj_id target, String params, String successHandler, String failHandler, boolean testPetBar)
    {
        return combatStandardAction(actionName, self, target, getCurrentWeapon(self), params, null, false, testPetBar, 0);
    }
    public boolean combatStandardAction(String actionName, obj_id self, obj_id target, String params)
    {
        return combatStandardAction(actionName, self, target, getCurrentWeapon(self), params, null, false, false, 0);
    }
    public void sendPerformSpam(obj_id actor, obj_id target, string_id message, String actionName, int spam_type)
    {
    ...
    public boolean combatStandardAction(String actionName, obj_id self, obj_id target, obj_id objWeapon, String params, combat_data actionData, boolean isTangibleAttacking)
    {
    ...
    public void startDelayedAttack(obj_id attacker, obj_id target, obj_id objWeapon, String attackName, combat_data actionData, boolean instantHit, boolean isAutoAimed)
    {
    ...
    public void doStandardDelayedAction(obj_id objEgg, obj_id target, String attackName, combat_data actionData, boolean instantHit)
    {
    ...
    public void doDelayedParticle(obj_id objEgg, String strEffect, float fltDelay, boolean boolCleanup)
    {
    ...
    public void doDelayedAttack(obj_id objEgg, String strAttack, obj_id objTarget, float fltDelay, String strEffect, boolean boolCleanup)
    {
        dictionary dctParams = new dictionary();
    ...
    public obj_id getCorrectCombatTarget(obj_id self, obj_id curTarget, boolean verbose)
    {
        return getCorrectCombatTarget(self, curTarget, "", new combat_data(), verbose);
    }
    public obj_id getCorrectCombatTarget(obj_id self, obj_id curTarget, combat_data actionData, boolean verbose)
    {
        return getCorrectCombatTarget(self, curTarget, "", actionData, verbose);
    }
    public obj_id getCorrectCombatTarget(obj_id self, obj_id curTarget, String params, combat_data actionData, boolean verbose)
    {
    ...
    public boolean isInAttackRange(obj_id attacker, obj_id target, String actionName, boolean verbose)
    {
    ...
    public boolean isInAttackRange(obj_id attacker, obj_id target, combat_data actionData, weapon_data weaponData, boolean verbose)
    {
    ...
    public boolean doCombatPreCheck(combat_data actionData, attacker_data attackerData, weapon_data weaponData, defender_data[] defenderData, boolean verbose)
    {
        verbose = false;
    ...
    public obj_id getNextHatedTarget(obj_id self, obj_id[] tempDefenders, obj_id currentTarget)
    {
    ...
    public obj_id[] getCombatDefenders(obj_id self, obj_id target, weapon_data weaponData, combat_data actionData, boolean isSpecialAttack)
    {
        int validTargetType = actionData.validTarget;
    ...
    public hit_result[] runHitEngine(attacker_data attackerData, weapon_data weaponData, defender_data[] defenderData, attacker_results attackerResults, defender_results[] defenderResults, combat_data actionData, boolean isTangibleAttacking)
    {
    ...
    private boolean usesFlawlessBead(String actionName)
    {
        return actionName.startsWith("bh_dm_") || actionName.startsWith("bh_taunt_") || actionName.startsWith("bh_dread_") || actionName.startsWith("bh_fumble_") || actionName.startsWith("bh_intimidate_") || actionName.startsWith("bh_sniper_");
    }
    ...
    public int getDefenderResult(attacker_data attackerData, defender_data defenderData, combat_data actionData, boolean autoAim)
    {
    ...
    public int getAttackerResult(attacker_data attackerData, defender_data defenderData, combat_data actionData, boolean autoAim)
    {
        if (combat.isAreaAttack(actionData.attackType))
        {
    ...
    public int getAreaDefenderResult(attacker_data attackerData, defender_data defenderData, combat_data actionData, boolean autoAim)
    {
    ...
    public int getAreaAttackResult(attacker_data attackerData, defender_data defenderData, combat_data actionData, boolean autoAim)
    {
        obj_id attacker = attackerData.id;
        obj_id defender = defenderData.id;
    ...
    public int getSingleTargetDefenderResult(attacker_data attackerData, defender_data defenderData, combat_data actionData, boolean autoAim)
    {
        obj_id attacker = attackerData.id;
        obj_id defender = defenderData.id;
        int loaded_dice = getEnhancedSkillStatisticModifierUncapped(defenderData.id, "hit_table_add_defender_position");
    ...
    public int getSingleTargetAttackResult(attacker_data attackerData, defender_data defenderData, combat_data actionData, boolean autoAim)
    {
        obj_id attacker = attackerData.id;
        obj_id defender = defenderData.id;
        ...
        if (actionData.actionName.equals("bh_flawless_strike"))
        {
            actionData.reduceParry += 10000;
            actionData.reduceDodge += 10000;
            actionData.reduceBlock += 10000;
            actionData.reduceGlancing += 10000;
            missChance -= 10000;
        }
        else if ((buff.hasBuff(attackerData.id, "flawless_bead_1") || buff.hasBuff(attackerData.id, "flawless_bead_2") || buff.hasBuff(attackerData.id, "flawless_bead_3")) && usesFlawlessBead(actionData.actionName))
        {
            actionData.reduceParry += 10000;
            actionData.reduceDodge += 10000;
            actionData.reduceBlock += 10000;
            ...
            for (int i = 1; i < 4; i++)
            {
                if (buff.hasBuff(attackerData.id, "set_bonus_bh_utility_a_" + i))
                {
                    buff.removeBuff(attackerData.id, "flawless_bead_" + i);
                }
            }
        }
    ...
    public void displayHitTable(obj_id attacker, obj_id defender, int[] defTable, int[] atkTable, int defResult, int atkResult)
    {
    ...
    public String getHitResultByName(int hitResult)
    {
        String hitType = "None";
        switch (hitResult)
        {
    ...
    public hit_result applyDamage(obj_id attacker, obj_id defender, weapon_data weaponData, hit_result hitData, combat_data actionData, boolean primaryTarget)
    {
        return applyDamage(attacker, defender, weaponData, hitData, actionData, primaryTarget, 0);
    }
    public hit_result applyDamage(obj_id attacker, obj_id defender, weapon_data weaponData, hit_result hitData, combat_data actionData, boolean primaryTarget, int overloadDamage)
    {
        doWrappedDamage(attacker, defender, weaponData, hitData, actionData, overloadDamage);
        return hitData;
    }
    public weapon_data getOverloadedWeaponData(obj_id self, obj_id objWeapon, combat_data actionData)
    {
        if (!isIdValid(self))
        {
            return null;
    ...
    public dictionary getRawDamage(obj_id attacker, weapon_data weaponData, combat_data actionData, hit_result hitData, float minDamage, float maxDamage, int numTargets)
    {
    ...
    public void doWrappedDamage(obj_id attacker, obj_id defender, weapon_data weaponData, hit_result hitData, combat_data actionData)
    {
    ...
    public obj_id[] truncateTargetArray(obj_id[] array, obj_id target, int size)
    {
    ...
    public void sortDefendersByPlayer(obj_id[] defenders)
    {
    ...
    public obj_id[] validateDefenders(obj_id attacker, obj_id target, obj_id[] defenders, obj_id source, int maxDefenders, int validTargetType, boolean isOffensiveAction, obj_id losSourceObj, boolean isHeavyWeapon, boolean isSpecialAttack, boolean ignoreLOS, int pvpOnly, combat_data actionData)
    {
    ...
    public obj_id[] validateDefenders(obj_id attacker, obj_id target, obj_id[] defenders, obj_id source, int maxDefenders, int validTargetType, boolean isOffensiveAction, obj_id losSourceObj, boolean isHeavyWeapon, boolean isSpecialAttack)
    {
    ...
    public obj_id[] validateDefenders(obj_id attacker, obj_id target, obj_id[] defenders, obj_id source, int maxDefenders, int validTargetType, boolean isOffensiveAction)
    {
    ...
    public defender_results[] createDefenderResultsArray(int size)
    {
    ...
    public hit_result[] createHitResultsArray(int size)
    {
    ...
    public attacker_results[] createAttackerResultsArray(int size)
    {
    ...
    public boolean shouldPlayAnimation(obj_id objAttacker, combat_data actionData)
    {
        return true;
    }
    public void doMultiDefenderCombatResults(String[] playbackNames, attacker_results attackerResults, defender_results[] defenderResults, weapon_data weaponData, combat_data actionData, hit_result[] cbtHitData)
    {
    ...
    public void doBasicGrenadeCombatResults(String[] playbackNames, attacker_results attackerResults, defender_results[] defenderResults, weapon_data weaponData, combat_data actionData, hit_result[] hitData)
    {
    ...
    public boolean checkPosture(obj_id objAttacker, obj_id objDefender)
    {
    ...
    public boolean didHit(hit_result[] cbtHitData)
    {
        int intI = 0;
    ...
    public void finalizeMineDamage(obj_id objAttacker, weapon_data cbtWeaponData, defender_data[] cbtDefenderData, hit_result[] cbtHitData, defender_results[] cbtDefenderResults)
    {
    ...
    public color getHitColor(int intHitLocation)
    {
    ...
    public void doCombatFlyText(defender_data[] defenderData, obj_id attacker, hit_result[] hitData, defender_results[] defenderResults)
    {
        float textSize = 1.5f;
    ...
    public String getHitSpam(hit_result cbtHitData)
    {
    ...
    public boolean checkForFumbles(hit_result[] hitData)
    {
        return false;
    }
    public void doFumble(attacker_data cbtAttackerData, weapon_data cbtWeaponData, int intAttackerPosture, String strAnimationAction)
    {
        string_id strSpam = new string_id("cbt_spam", "fumble");
        int intFumbleDamage = rand(cbtWeaponData.minDamage, cbtWeaponData.maxDamage);
        return;
    }
    public boolean isImmuneToStateChange(obj_id target)
    {
    ...
    public void doWarcryCombatResults(String strAnimationAction, attacker_results cbtAttackerResults, defender_results[] cbtDefenderResults)
    {
    ...
    public void doSuppressionFireResults(String strPlaybackName, attacker_results cbtAttackerResults, defender_results[] cbtDefenderResults, combat_data dctCombatInfo)
    {
    ...
    public void doChargeResults(String strPlaybackName, attacker_results cbtAttackerResults, defender_results[] cbtDefenderResults)
    {
        if (cbtDefenderResults.length > 1)
        {
            int intI = 1;
    ...
    public String getPlaybackIntensity(String strPlaybackName, hit_result[] cbtHitData, weapon_data cbtWeaponData)
    {
    ...
    public String getThrownWeaponStringType(obj_id objWeapon)
    {
        String strType = "";
    ...
    public String getHeavyWeaponStringType(obj_id objWeapon)
    {
    ...
    public String[] makeStringArray(int intLength)
    {
        int intI = 0;
    ...
    public boolean checkWeaponData(obj_id objPlayer, obj_id objTarget, int intAttackCategory, weapon_data cbtWeaponData, String strCommand, String strWeaponType)
    {
    ...
    public boolean checkCommands(obj_id objPlayer, String strCommand, String strWeaponType)
    {
        if (!strCommand.equals(""))
        {
            String strAbility = strWeaponType + strCommand;
    ...
    public boolean checkForCombatActions(obj_id objPlayer)
    {
    ...
    public String getGrenadeType(obj_id objGrenade)
    {
    ...
    public String getHeavyWeaponType(obj_id objHeavyWeapon)
    {
    ...
    public void clearQueue(obj_id objPlayer)
    {
    ...
    public boolean callSupplyDrop(obj_id self, int supplyId)
    {
    ...
    public boolean canCallSupplyDrop(obj_id self)
    {
        location loc = getLocation(self);
        if (isIdValid(loc.cell))
        {
    ...
    public boolean callFavor(obj_id self, int which)
    {
        location loc = getLocation(self);
    ...
    public boolean doHealingPreCheck(combat_data actionData, attacker_data attackerData, defender_data[] defenderData, boolean verbose)
    {
    ...
    public boolean hasFullActionPool(obj_id target)
    {
    ...
    public boolean healthToActionConversion(obj_id target, int healthCost, int actionGain)
    {
    ...
    public void doMedicEvasion(obj_id medic)
    {
    ...
    public combat_data modifyActionDataByExpertise(obj_id self, combat_data actionData)
    {
    ...
    public void runHitSimulator(obj_id self, int[] atkTable, int[] defTable)
    {
