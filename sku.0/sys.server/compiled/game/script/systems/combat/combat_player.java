...
public class combat_player extends script.systems.combat.combat_base
{
    ...
    public int combatModeCheck(obj_id self, obj_id target, String params, float defaultTime)
    {
        return SCRIPT_CONTINUE;
    }
    public int OnDefenderCombatAction(obj_id self, obj_id objAttacker, obj_id objWeapon, int intCombatResult)
    {
        if (vehicle.isRidingVehicle(self))
        {
    ...
    public int OnAboutToReceiveItem(obj_id self, obj_id objContainer, obj_id objTransferer, obj_id objItem)
    {
        if (isWeapon(objItem))
        {
    ...
    public int OnReceivedItem(obj_id self, obj_id objSrcContainer, obj_id objTransferer, obj_id objItem)
    {
        if (isWeapon(objItem))
        {
    ...
    public int target(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (isIdValid(target))
        {
