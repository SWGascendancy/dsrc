...
public class combat_base_old extends script.base_script
{
    ...
    public obj_id[] validateDefenders(obj_id attacker, obj_id[] objDefenders)
    {
    ...
    public boolean checkTargets(obj_id objAttacker, obj_id objDefender)
    {
    ...
    public int doCombatPreCheck(obj_id objPlayer, obj_id objTarget, int intCommand)
    {
        return doCombatPreCheck(objPlayer, objTarget, intCommand, true);
    }
    public int doCombatPreCheck(obj_id objPlayer, obj_id objTarget, int intCommand, boolean changeCombatTarget)
    {
    ...
    public boolean drainCombatActionAttributes(obj_id objPlayer, int intHealthCost, int intActionCost, int intMindCost, int intAction, float fltDelay)
    {
    ...
    public boolean drainAttributesFastRegen(obj_id objPlayer, int intHealthCost, int intActionCost, int intMindCost)
    {
    ...
    public boolean checkAttributeCost(obj_id objTarget, dictionary dctCost)
    {
    ...
    public dictionary getRawActionCost(obj_id objPlayer, String strWeaponType, String[] strCostMods, int intRawHealth, int intRawAction, int intRawMind, float fltHealthModifier, float fltActionModifier, float fltMindModifier)
    {
    ...
    public float getSkillModifiers(obj_id objPlayer, String strAdditiveString, String[] strSkillMods)
    {
        int intI = 0;
        float fltSkillMod = 0;
    ...
    public float calculateTime(obj_id objPlayer, String strWeaponType, float fltDefaultTime, String[] strTimeMods)
    {
    ...
    public weapon_data getRawDamage(obj_id objPlayer, weapon_data cbtWeaponData, float fltDamageModifier, String[] strDamageMods, boolean boolDontIgnoreCerts)
    {
    ...
    public int getHitMod(obj_id objPlayer, String strWeaponType, String[] strToHitMods)
    {
        return getHitMod(objPlayer, strWeaponType, strToHitMods, null);
    }
    public int getHitMod(obj_id objPlayer, String strWeaponType, String[] strToHitMods, dictionary dctCombatInfo)
    {
        int intToHitBonus = 0;
        float fltToHitMod = 0;
        float fltStateMod = 0;
    ...
    public hit_result[] runHitEngine(attacker_data cbtAttackerData, weapon_data cbtWeaponData, defender_data[] cbtDefenderData)
    {
        return runHitEngine(cbtAttackerData, cbtWeaponData, cbtDefenderData, false);
    }
    public hit_result[] runHitEngine(attacker_data cbtAttackerData, weapon_data cbtWeaponData, defender_data[] cbtDefenderData, boolean boolAllowHitSelf)
    {
    ...
    public void finalizeDamage(obj_id objAttacker, weapon_data cbtWeaponData, defender_data[] cbtDefenderData, hit_result[] cbtHitData, defender_results[] cbtDefenderResults, dictionary dctCombatInfo)
    {
    ...
    public void doWrappedDamage(obj_id objAttacker, obj_id objDefender, obj_id objWeapon, hit_result cbtHitData, dictionary dctCombatInfo)
    {
    ...
    public void doCombatFlyText(defender_data[] cbtDefenderData, obj_id objAttacker, hit_result[] cbtHitData, defender_results[] cbtDefenderResults)
    {
        for (int intI = 0; intI < cbtHitData.length; intI++)
        {
    ...
    public int getCombatAttitude(obj_id objPlayer, int intWeaponType)
    {
    ...
    public void applyPostures(attacker_data cbtAttackerData, attacker_results cbtAttackerResults, hit_result[] cbtHitData, defender_data[] cbtDefenderData, defender_results[] cbtDefenderResults, int intAttackerEndPosture, int intDefenderEndPosture, weapon_data cbtWeaponData)
    {
        int intState = 0;
    ...
    public void doCounterAttack(obj_id objAttacker, obj_id objDefender)
    {
        if (isPlayer(objAttacker))
        {
    ...
    public boolean runDizzyCheck(obj_id objPlayer)
    {
        int intState = 0;
        if (intState > 0)
        {
    ...
    public int getLowerPosture(int intPosture)
    {
    ...
    public int getHigherPosture(int intPosture)
    {
        if (intPosture == POSTURE_CROUCHED)
        {
    ...
    public defender_results[] createDefenderResultsArray(int intSize)
    {
        int intI = 0;
    ...
    public hit_result[] createHitResultsArray(int intSize)
    {
        int intI = 0;
    ...
    public attacker_results[] createAttackerResultsArray(int intSize)
    {
        int intI = 0;
    ...
    public void doMultiDefenderCombatResults(String[] strPlaybackNames, attacker_results cbtAttackerResults, defender_results[] cbtDefenderResults, dictionary dctCombatInfo)
    {
    ...
    public String getActionName(String strActionName, int intAttackNumber, hit_result[] cbtHitData, weapon_data cbtWeaponData)
    {
    ...
    public String[] makePlaybackNames(String strAnimationName, hit_result[] cbtHitData, weapon_data cbtWeaponData)
    {
    ...
    public String[] makePlaybackNames(String strAnimationName, hit_result[] cbtHitData, weapon_data cbtWeaponData, defender_results[] cbtDefenderResults)
    {
        String[] strPlaybackNames = new String[cbtHitData.length];
        int intDamage = 0;
        int intMidpoint = (cbtWeaponData.minDamage + cbtWeaponData.maxDamage) / 2;
    ...
    public void doSuppressionFireResults(String strPlaybackName, attacker_results cbtAttackerResults, defender_results[] cbtDefenderResults, dictionary dctCombatInfo)
    {
        int intLeftFoot = dctCombatInfo.getInt("intLeftFoot");
        int intRightFoot = dctCombatInfo.getInt("intRightFoot");
        int intWeapon = dctCombatInfo.getInt("intWeapon");
    ...
    public String getWeaponStringType(int intWeaponType)
    {
        switch (intWeaponType)
        {
            case WEAPON_TYPE_RIFLE:
    ...
    public obj_id getCorrectCombatTarget(obj_id objPlayer, obj_id objTarget, int intAction)
    {
        obj_id objActualTarget = getCorrectCombatTarget(objPlayer, objTarget, intAction, "");
        return objActualTarget;
    }
    public obj_id getCorrectCombatTarget(obj_id objPlayer, obj_id objTarget, int intAction, String strParams)
    {
    ...
    public void doBasicGrenadeCombatResults(attacker_results cbtAttackerResults, defender_results[] cbtDefenderResults, hit_result[] cbtHitData, obj_id objTarget, weapon_data cbtWeaponData)
    {
    ...
    public void doMineFieldResults(String strParticle, attacker_results cbtAttackerResults, defender_results[] cbtDefenderResults, hit_result[] cbtHitData, obj_id objTarget, weapon_data cbtWeaponData)
    {
    ...
    public void yellText(obj_id objSpeaker, String strText)
    {
    ...
    public obj_id[] truncateTargetArray(obj_id[] objArray, obj_id objTarget, int intLength)
    {
    ...
    public void clearFeignIncapacitation(obj_id objPlayer, int intPosture)
    {
    ...
    public void setTurretTarget(obj_id objTurret, obj_id objTarget)
    {
    ...
    public void startTurretAttack(obj_id objTurret, obj_id objTarget)
    {
        dictionary dctParams = new dictionary();
        dctParams.put("objTarget", objTarget);
        messageTo(objTurret, "startAttack", dctParams, 0, true);
    }
    public void applyWound(hit_result cbtHitData, defender_data cbtDefenderData, attacker_data cbtAttackerData)
    {
        return;
    }
    public String getStatName(int intStat)
    {
        switch (intStat)
        {
            case HEALTH:
    ...
    public int getMobHitMod(obj_id objMob)
    {
        int intToHitChance = getSkillStatMod(objMob, "toHitChance");
        return intToHitChance;
    }
    public int checkTrapMod(int mod, String modName, obj_id checkId)
    {
        if (isIdValid(checkId) && utils.hasScriptVar(checkId, "trapmod.enable"))
        {
    ...
    public int[] getCombatEffectsFromDataTable(dictionary dctCombatInfo)
    {
    ...
    public float[] getCombatEffectDurationsFromDataTable(dictionary dctCombatInfo, int[] intEffects)
    {
    ...
    public obj_id[] getCombatDefenders(obj_id objPlayer, obj_id objTarget, dictionary dctCombatInfo)
    {
    ...
    public float getDamageBonus(int intWeaponType)
    {
        switch (intWeaponType)
        {
            case WEAPON_TYPE_RIFLE:
    ...
    public boolean isMeleeWeapon(obj_id objWeapon)
    {
    ...
    public float getLungeRange(weapon_data cbtWeaponData)
    {
    ...
    public boolean damageWeapon(obj_id owner, obj_id weaponid, int amount)
    {
        if (!isPlayer(owner))
        {
            return false;
    ...
    public boolean canChangeTargetPosture(obj_id objAttacker, obj_id objDefender, int intChangeType)
    {
    ...
    public boolean applyCombatEffectDelay(obj_id objAttacker, obj_id objTarget, float fltDelay, boolean showAttackerSuccessMessage, boolean showDefenderSuccessMessage, String appliedDelay)
    {
    ...
    public void doCombatAnimationResults(String strPlaybackName, attacker_results cbtAttackerResults, hit_result[] cbtHitData, weapon_data cbtWeaponData, defender_results[] cbtDefenderResults, dictionary dctCombatInfo)
    {
    ...
    public weapon_data getOverloadedWeaponData(weapon_data cbtWeaponData, dictionary dctCombatInfo)
    {
        int intOverloadWeapon = dctCombatInfo.getInt("intOverloadWeapon");
        if (intOverloadWeapon > 0)
        {
    ...
    public void doForceChokeSpam(obj_id objTarget)
    {
    ...
    public void doForceWeaken(obj_id objTarget, obj_id objAttacker, float fltMultiplier)
    {
    ...
    public weapon_data calculateDamageMitigation(obj_id objDefender, String strDefenderCommand, weapon_data cbtWeaponData, int intMinDamage, int intMaxDamage)
    {
    ...
    public float getHitBonus(int intWeaponCategory, obj_id objDefender)
    {
    ...
    public void combatLog(obj_id attacker, obj_id defender, String logName, String logMsg)
    {
        
    }
    public String listArrayContents(obj_id[] array)
    {
        String output = "";
