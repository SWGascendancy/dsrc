...
public class combat_mine_spawner extends script.base_script
{
    ...
    public int handleSpawnMines(obj_id self, dictionary params)
    {
    ...
    public boolean canSpawnNewMine(obj_id self)
    {
        return (getCurrentMineCount(self) < getIntObjVar(self, "mineField.mineCount"));
    }
    public int getRespawn(obj_id self)
    {
        return getIntObjVar(self, "mineField.mineRespawn");
    }
    public obj_id createMine(String mineType, location spawnPoint)
    {
    ...
    public int getCurrentMineCount(obj_id self)
    {
    ...
    public int incrimentMineCount(obj_id self)
    {
    ...
    public int decrimentMineCount(obj_id self)
    {
        int current = getCurrentMineCount(self);
        if (current > 0)
        {
    ...
    public int handleMineRespawn(obj_id self, dictionary params)
    {
