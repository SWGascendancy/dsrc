...
public class combat_weapon extends script.base_script
{
    ...
    public void expertiseRangeModify(obj_id self)
    {
        if (!isIdValid(self))
        {
            return;
    ...
    public int weaponConversion(obj_id self, dictionary params)
    {
    ...
    public void setDamageSkillMods(obj_id player, obj_id weapon)
    {
    ...
    public obj_id getContainingMobile(obj_id item)
    {
    ...
    public int handleConvertSchemSui(obj_id self, dictionary params)
    {
