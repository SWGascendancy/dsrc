...
public class buff_handler extends script.base_script
{
    ...
    public int attribAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int attribRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int attribPercentAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        int attribute = ATTRIB_ERROR;
        if (subtype.equals("health"))
        {
    ...
    public int attribPercentRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        if (hasAttribModifier(self, effectName))
        {
            removeAttribOrSkillModModifier(self, effectName);
    ...
    public int skillRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int armorBreakAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        long stack = buff.getBuffStackCount(self, buffName) > 1 ? buff.getBuffStackCount(self, buffName) : 1;
        value *= (int)stack;
        ...
        if (subtype.equals("player") && isPlayer(self))
        {
            ...
            {
                int times = hasSkill(caster, "expertise_bh_amb_dam_cool") ? 2 : 1;
        ...
        else if (subtype.equals("mob") && !isPlayer(self))
        {
            ...
            if (utils.isProfession(caster, utils.BOUNTY_HUNTER))
            {
                ...
                for (int i = 0; i < times; i++)
                    buff.applyBuff(self, caster, "bh_crit_hit_vuln");
                sendSystemMessageTestingOnly(caster, "Total: " + times);
            }
        }
        messageTo(self, "recalcArmor", null, 1, false);
        trial.bumpSession(self, "displayDefensiveMods");
    ...
    public int armorBreakRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        if (hasSkillModModifier(self, effectName))
        {
            removeAttribOrSkillModModifier(self, effectName);
    ...
    public int skillPercentAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int skillPercentRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        if (hasSkillModModifier(self, effectName))
        {
            removeAttribOrSkillModModifier(self, effectName);
    ...
    public int check_movement_immunity(obj_id self, dictionary params)
    {
        movement.updateMovementImmunity(self);
        return SCRIPT_CONTINUE;
    }
    public int recalcPools(obj_id self, dictionary params)
    {
    ...
    public int recalcArmor(obj_id self, dictionary params)
    {
        if (beast_lib.isBeast(self))
        {
            beast_lib.initializeBeastStats(beast_lib.getBeastBCD(self), self);
    ...
    public int movementAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        effectName = effectName.substring(0, (effectName.lastIndexOf("_")));
        if (value == 0)
        {
    ...
    public int movementRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        effectName = effectName.substring(0, (effectName.lastIndexOf("_")));
        stopClientEffectObjByLabel(self, effectName);
        if (movement.hasMovementModifier(self, effectName))
    ...
    public int exclusiveProxyAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int exclusiveProxyRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    public int excludeSelfAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        int[] buffs = buff.getAllBuffs(self);
        for (int i = 0; i < buffs.length; i++)
        {
    ...
    public int excludeSelfRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    public int delayAttackAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        utils.setScriptVar(self, buff.DEBUFF_STATE_PARALYZED + "." + effectName, duration);
        return SCRIPT_CONTINUE;
    }
    public int delayAttackRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int suppressionAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    public int suppressionRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int scriptVarAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        effectName = effectName.substring(0, (effectName.lastIndexOf("_")));
        utils.setScriptVar(self, "buff." + effectName + ".value", value);
        return SCRIPT_CONTINUE;
    }
    public int scriptVarRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        effectName = effectName.substring(0, (effectName.lastIndexOf("_")));
    ...
    public int xpBonusAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    public int xpBonusRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int xpBonusGeneralAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int xpBonusGeneralRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        utils.removeScriptVarTree(self, "buff.xpBonusGeneral");
        return SCRIPT_CONTINUE;
    }
    public int xpGrantedGeneralAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        int playerLevel = getLevel(self);
        if (playerLevel < 90)
        {
    ...
    public int xpGrantedGeneralRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    public int craftBonusAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        float mod = 0.02f;
    ...
    public int craftBonusRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int forcePowerAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int forcePowerRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        if (hasSkillModModifier(self, effectName))
        {
            removeAttribOrSkillModModifier(self, effectName);
    ...
    public int saberInterceptAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        utils.setScriptVar(self, combat.DAMAGE_REDIRECT, caster);
        return SCRIPT_CONTINUE;
    }
    public int saberInterceptRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        utils.removeScriptVar(self, combat.DAMAGE_REDIRECT);
        return SCRIPT_CONTINUE;
    }
    public void procBuffAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        effectName = effectName.substring(0, (effectName.lastIndexOf("_")));
    ...
    public void procBuffRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        effectName = effectName.substring(0, (effectName.lastIndexOf("_")));
        if (utils.hasScriptVar(self, "procBuffEffects"))
        {
    ...
    public void reactiveBuffAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        effectName = effectName.substring(0, (effectName.lastIndexOf("_")));
    ...
    public void reactiveBuffRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        effectName = effectName.substring(0, (effectName.lastIndexOf("_")));
        if (utils.hasScriptVar(self, "reacBuffEffects"))
        {
    ...
    public int stanceAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int stanceRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        if (hasSkillModModifier(self, effectName))
        {
            removeAttribOrSkillModModifier(self, effectName);
    ...
    public int dancePartyAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        String[] danceList = 
        {
            "poplock",
    ...
    public int dancePartyRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    public int missByLuckAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int missByLuckRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        removeAttribOrSkillModModifier(self, "missByLuck");
        return SCRIPT_CONTINUE;
    }
    public int hitByLuckAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int hitByLuckRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        removeAttribOrSkillModModifier(self, "hitByLuck");
        removeAttribOrSkillModModifier(self, "increaseHitByLuck");
        return SCRIPT_CONTINUE;
    }
    public int pistolWhipAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int pistolWhipRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        movementRemoveBuffHandler(self, effectName, subtype, duration, value, buffName, caster);
        return SCRIPT_CONTINUE;
    }
    public int slyLieAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int slyLieRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        if (hasSkillModModifier(self, effectName))
        {
            removeAttribOrSkillModModifier(self, effectName);
    ...
    public int fastTalkAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int fastTalkRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        if (hasSkillModModifier(self, effectName))
        {
            removeAttribOrSkillModModifier(self, effectName);
    ...
    public int pvpAuraBuffSelfAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        attachScript(self, "player.gcw.pvp_aura_buff_controller");
        return SCRIPT_CONTINUE;
    }
    public int pvpAuraBuffSelfRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        detachScript(self, "player.gcw.pvp_aura_buff_controller");
        removeObjVar(self, "pvp_aura_buff.faction");
        return SCRIPT_CONTINUE;
    }
    public int nextHitCritAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        utils.setScriptVar(self, "nextCritHit", 1);
        return SCRIPT_CONTINUE;
    }
    public int nextHitCritRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        utils.removeScriptVarTree(self, "nextCritHit");
        return SCRIPT_CONTINUE;
    }
    public int critDoubleDamageAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        utils.setScriptVar(self, "critDoubleDamage", 1);
        return SCRIPT_CONTINUE;
    }
    public int critDoubleDamageRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        utils.removeScriptVarTree(self, "critDoubleDamage");
        return SCRIPT_CONTINUE;
    }
    public int critRootAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        utils.setScriptVar(self, "critRoot", 1);
        return SCRIPT_CONTINUE;
    }
    public int critRootRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        utils.removeScriptVarTree(self, "critRoot");
        return SCRIPT_CONTINUE;
    }
    public int critOnceAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int critOnceRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        Vector effectNames = new Vector();
        effectName = effectName.substring(0, (effectName.lastIndexOf("_")));
        if (utils.hasScriptVar(self, "critRemoveBuffNames"))
    ...
    public int junkDealerAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int junkDealerRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        removeAttribOrSkillModModifier(self, "junkDealerPrecision");
        removeAttribOrSkillModModifier(self, "junkDealerDamageDecrease");
        return SCRIPT_CONTINUE;
    }
    public int commandoSnareBonusAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        if (!isIdValid(self))
        {
            return SCRIPT_OVERRIDE;
    ...
    public int commandoSnareBonusRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        removeAttribOrSkillModModifier(self, "commandoInnateArmorBonus");
        messageTo(self, "recalcArmor", null, .25f, false);
        return SCRIPT_CONTINUE;
    }
    public int commandoFlashBangAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        effectName = effectName.substring(0, (effectName.lastIndexOf("_")));
    ...
    public int commandoFlashBangRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        removeAttribOrSkillModModifier(self, "commandoFlashBang");
        return SCRIPT_CONTINUE;
    }
    public int commandoMuscleSpasmAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        effectName = effectName.substring(0, (effectName.lastIndexOf("_")));
        obj_id owner = utils.getObjIdScriptVar(self, "buffOwner." + getStringCrc(effectName.toLowerCase()));
        if (!isIdValid(owner))
    ...
    public int commandoMuscleSpasmRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        removeAttribOrSkillModModifier(self, "commandoMuscleSpasm");
        return SCRIPT_CONTINUE;
    }
    public int commandoRiddleArmorAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int commandoRiddleArmorRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        removeAttribOrSkillModModifier(self, effectName);
        messageTo(self, "recalcArmor", null, 1.0f, false);
        return SCRIPT_CONTINUE;
    }
    public int radarInvisAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        setVisibleOnMapAndRadar(self, false);
        return SCRIPT_CONTINUE;
    }
    public int radarInvisRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        setVisibleOnMapAndRadar(self, true);
        return SCRIPT_CONTINUE;
    }
    public int onTargetAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int onTargetRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        if (hasSkillModModifier(self, effectName))
        {
            removeAttribOrSkillModModifier(self, effectName);
    ...
    public int dotReductionRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    ...
    public int dotDivisorRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    public int immunityRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        String prefixBuilder = "";
        int wholeValue = (int)value;
        if (subtype.equals("dot_immunity"))
    ...
    public int expertiseImmunityAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int expertiseImmunityRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        return immunityRemoveBuffHandler(self, effectName, subtype, duration, value, "", null);
    }
    public int expertiseChannelActionHealAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int expertiseChannelActionHealRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int onIncapHealAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        utils.setScriptVar(self, "buff_handler." + subtype, value);
        return SCRIPT_CONTINUE;
    }
    public int onIncapHealRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        utils.removeScriptVar(self, "buff_handler." + subtype);
        return SCRIPT_CONTINUE;
    }
    public int healEffectAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int healEffectRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    public int buildabuffAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int buildabuffRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int meDoomAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int meDoomRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        obj_id doomOwner = utils.getObjIdScriptVar(self, "me_doom.doom_owner");
        int doomStage = utils.getIntScriptVar(self, "me_doom.doom_stage");
        if (!isIdValid(doomOwner))
    ...
    public int cacheExpertiseProcReacList(obj_id self, dictionary params)
    {
    ...
    public void healAttribPercent(obj_id who, int stat, int percent)
    {
    ...
    public int channelForsakeFear(obj_id player, String buffName, boolean finishChannel)
    {
    ...
    public int checkChannelForsakeFear(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        String buffName = params.getString("buffName");
        if (utils.hasScriptVar(player, "buff_handler.channelForsakeFearCancelled") || utils.hasScriptVar(player, "buff_handler.channelForsakeFearSuccessful"))
        {
            return SCRIPT_CONTINUE;
        }
    ...
    public int actionDrainAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int actionDrainRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    public int actionBurnAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        utils.setScriptVar(self, "buff.action_burn.value", value);
        return SCRIPT_CONTINUE;
    }
    public int actionBurnRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        utils.removeScriptVar(self, "buff.action_burn.value");
        return SCRIPT_CONTINUE;
    }
    public int actionRegenAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int actionRegenRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    ...
    public int bodyguardDefenderAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int bodyguardDefenderRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        if (subtype.equals("shield_master_pet"))
        {
            obj_id master = getMaster(self);
    ...
    public int cooldownModifyAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int cooldownModifyRemoveBuffHandler(obj_id self, String effectName, String subType, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    public int vulnerabilityAddBuffHandler(obj_id self, String effectName, String subType, float duration, float value, String buffName, obj_id caster)
    {
        String type = "heat";
    ...
    public int vulnerabilityRemoveBuffHandler(obj_id self, String effectName, String subType, float duration, float value, String buffName, obj_id caster)
    {
        String type = "heat";
        if (subType.endsWith("acid"))
        {
    ...
    public int removeIncapWeakenAddBuffHandler(obj_id self, String effectName, String subType, float duartion, float value, String buffName, obj_id caster)
    {
        buff.removeBuff(self, "incapWeaken");
        return SCRIPT_CONTINUE;
    }
    public int removeIncapWeakenRemoveBuffHandler(obj_id self, String effectName, String subType, float duartion, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    public int axkvaContagionAddBuffHandler(obj_id self, String effectName, String subType, float duartion, float value, String buffName, obj_id caster)
    {
    ...
    public int axkvaContagionRemoveBuffHandler(obj_id self, String effectName, String subType, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int bodyguardMasterAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    public int bodyguardMasterRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    public int onNextAttackAddBuffHandler(obj_id self, String effectName, String subType, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int onNextAttackRemoveBuffHandler(obj_id self, String effectName, String subType, float duration, float value, String buffName, obj_id caster)
    {
        utils.removeScriptVar(self, "bm_preperation");
        return SCRIPT_CONTINUE;
    }
    public int damageDealtModAddBuffHandler(obj_id self, String effectName, String subType, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int damageDealtModRemoveBuffHandler(obj_id self, String effectName, String subType, float druation, float value, String buffName, obj_id caster)
    {
    ...
    public int weaponSpeedModAddBuffHandler(obj_id self, String effectName, String subType, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int weaponSpeedModRemoveBuffHandler(obj_id self, String effectName, String subType, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int commandGrantAddBuffHandler(obj_id self, String effectName, String subType, float duration, float value, String buffName, obj_id caster)
    {
        if (subType == null || subType.equals(""))
        {
            return SCRIPT_CONTINUE;
    ...
    public int commandGrantRemoveBuffHandler(obj_id self, String effectName, String subType, float duration, float value, String buffName, obj_id caster)
    {
        if (subType == null || subType.equals(""))
        {
            return SCRIPT_CONTINUE;
    ...
    public int OnGroupMembersChanged(obj_id self, obj_id gid, obj_id[] groupMembers, obj_id[] addedMembers, obj_id[] removedMembers)
    {
    ...
    public int OnGroupDisbanded(obj_id self, obj_id group)
    {
    ...
    public int OnRemovedFromGroup(obj_id self, obj_id group)
    {
        int[] buffList = buff.getGroupBuffEffects(self);
        if (buffList != null && buffList.length > 0)
        {
    ...
    public int setGroupBuffs(obj_id self, dictionary params)
    {
    ...
    public int groupAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        effectName = effectName.substring(0, (effectName.lastIndexOf("_")));
    ...
    public int groupRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public void invisBuffRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        effectName = effectName.substring(0, (effectName.lastIndexOf("_")));
        stealth.invisBuffRemoved(self, effectName);
    }
    public void invisBuffAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public void noBreakInvisRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int messageDetrimentalRemoved(obj_id self, dictionary params)
    {
    ...
    public void messageDetrimentalRemoved(obj_id self, String detriment, string_id msgId)
    {
    ...
    public boolean removeAllModifiersOfType(obj_id target, int type)
    {
    ...
    public void channelHealAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public void channelHealRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        int pid = utils.getIntScriptVar(self, "channelHeal.suiPid");
        forceCloseSUIPage(pid);
        utils.removeScriptVarTree(self, "channelHeal");
    }
    public int getAttributeType(String subtype)
    {
        int attribute = 0;
        if (subtype.equals("health"))
        {
    ...
    public void bmBeastFamilyAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        if (!isPlayer(self))
        {
            obj_id master = getMaster(self);
    ...
    public void bmBeastFamilyRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        if (!isPlayer(self))
        {
            buff.removeBuff(self, buffName);
    ...
    public String getInitialBuffName(String effectName)
    {
    ...
    public void bmBeastXpBuffAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        return;
    }
    public void bmBeastXpBuffRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        utils.removeScriptVarTree(self, "beastBuff");
        return;
    }
    public int combatStunAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int combatStunRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        utils.removeScriptVar(self, "axkva_crystal");
        return SCRIPT_CONTINUE;
    }
    public int krixResonanceAddBuffHandler(obj_id self, String effectName, String subType, float duartion, float value, String buffName, obj_id caster)
    {
        playClientEffectObj(self, "appearance/pt_contagion_debuff.prt", self, "", null, "resonance");
        return SCRIPT_CONTINUE;
    }
    public int krixResonanceRemoveBuffHandler(obj_id self, String effectName, String subType, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int delayedAddBuff(obj_id self, dictionary params)
    {
        String buffName = params.getString("buffName");
    ...
    public int lureshContagionAddBuffHandler(obj_id self, String effectName, String subType, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    public int lureshContagionRemoveBuffHandler(obj_id self, String effectName, String subType, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int razorBurstHandlerAddBuffHandler(obj_id self, String effectName, String subType, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int razorBurstHandlerRemoveBuffHandler(obj_id self, String effectName, String subType, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    public int caretakerHandlerAddBuffHandler(obj_id self, String effectName, String subType, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int caretakerHandlerRemoveBuffHandler(obj_id self, String effectName, String subType, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    public int closedFistBurnHandlerAddBuffHandler(obj_id self, String effectName, String subType, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int handle_closed_fist_burn(obj_id self, dictionary params)
    {
    ...
    public int closedFistBurnHandlerRemoveBuffHandler(obj_id self, String effectName, String subType, float duration, float value, String buffName, obj_id caster)
    {
        stopClientEffectObjByLabel(self, "closed_fist_burn");
        return SCRIPT_CONTINUE;
    }
    public int closedFistBurnDebuffAddBuffHandler(obj_id self, String effectName, String subType, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int closedFistBurnDebuffRemoveBuffHandler(obj_id self, String effectName, String subType, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    public int kunChaosHandlerAddBuffHandler(obj_id self, String effectName, String subType, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int kunChaosHandlerRemoveBuffHandler(obj_id self, String effectName, String subType, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    public int kunOrderHandlerAddBuffHandler(obj_id self, String effectName, String subType, float duration, float value, String buffName, obj_id caster)
    {
        int orderDebuffCrc = buff.getBuffOnTargetFromGroup(self, "kun_order_debuff");
        int chaosDebuffCrc = buff.getBuffOnTargetFromGroup(self, "kun_chaos_debuff");
        if (chaosDebuffCrc == 0)
    ...
    public int kunOrderHandlerRemoveBuffHandler(obj_id self, String effectName, String subType, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    public int setSpecialTypeAddBuffHandler(obj_id self, String effectName, String subType, float duration, float value, String buffName, obj_id caster)
    {
        String special_type_name = subType.substring(15, subType.length());
        setObjVar(self, "specialNicheType", special_type_name);
        return SCRIPT_CONTINUE;
    }
    public int setSpecialTypeRemoveBuffHandler(obj_id self, String effectName, String subType, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int kunOpenSparkAddBuffHandler(obj_id self, String effectName, String subType, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int openSparkHandler(obj_id self, dictionary params)
    {
    ...
    public int kunOpenSparkRemoveBuffHandler(obj_id self, String effectName, String subType, float duration, float value, String buffName, obj_id caster)
    {
        stopClientEffectObjByLabel(self, "kun_spark");
        return SCRIPT_CONTINUE;
    }
    public int callPickupCraftAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    public int callPickupCraftRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int fs_choke_handlerAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        ...
        if (imp_choke > 0)
        {
            buff.applyBuff(self, self, "fs_imp_choke_" + (imp_choke == 10 ? 1 : 2));
        }
        return SCRIPT_CONTINUE;
    }
    public int fs_choke_handlerRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    public int jediStatueLightDebuffAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int jediStatueLightDebuffRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    public int jediStatueDarkDebuffAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int jediStatueDarkDebuffRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    public int fs_flurry_procAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int fs_flurry_procRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        String[] buffList = 
        {
    ...
    public int forceThrowAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        int buffCrc = getStringCrc(subtype.toLowerCase());
        obj_id owner = utils.getObjIdScriptVar(self, "buffOwner." + buffCrc);
    ...
    public int forceThrowRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    public int aggroChannelAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int aggroChannelRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        if (!exists(caster) || !isIdValid(caster))
        {
            return SCRIPT_CONTINUE;
    ...
    public int dotAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        long stack = buff.getBuffStackCount(self, buffName) > 1 ? buff.getBuffStackCount(self, buffName) : 1;
        dot.applyBuffDotEffect(self, caster, subtype, buffName + "_" + subtype, stack, HEALTH, 100, (int)value, (int)duration, true, buffName);
        return SCRIPT_CONTINUE;
    }
    public int dotRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        dot.removeBuffDotEffect(self, subtype, true);
        return SCRIPT_CONTINUE;
    }
    public int expertiseDamageDecreaseAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int expertiseDamageDecreaseRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        if (effectName.lastIndexOf("_") > 0)
        {
            effectName = effectName.substring(0, (effectName.lastIndexOf("_")));
    ...
    public int onAttackRemoveAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int onAttackRemoveRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        Vector removeBuffs = new Vector();
        removeBuffs.setSize(0);
        if (utils.hasScriptVar(self, buff.ON_ATTACK_REMOVE))
    ...
    public int supression_handlerAddBuffHandler(obj_id self, String effectName, String subytype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int supression_handlerRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    public int movementSupressingEffectAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int movementSupressingEffectRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    ...
    public int damageImmuneRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        removeAttribOrSkillModModifier(self, "damageImmuneDotResistAll");
        removeAttribOrSkillModModifier(self, "damageImmuneDamageImmune");
        return SCRIPT_CONTINUE;
    }
    public int bhFlawlessAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        buff.applyBuff(self, "bh_flawless_proc_chance_1");
        return SCRIPT_CONTINUE;
    }
    public int bhFlawlessRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        buff.removeBuff(self, "bh_flawless_proc_chance_1");
        return SCRIPT_CONTINUE;
    }
    public int mtpMeatlumpAngryAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int mtpMeatlumpAngryRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    public int mtpMeatlumpHappyAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int mtpMeatlumpHappyRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    public int eventParticleAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int eventParticleReload(obj_id self, dictionary params)
    {
    ...
    public int eventParticleRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        if (effectName.lastIndexOf("_") > 0)
        {
            effectName = effectName.substring(0, (effectName.lastIndexOf("_")));
    ...
    public int costumeAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int costumeRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int costumeBurningEffectAddBuffHandler(obj_id self, String effectName, String subType, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int costumeBurningEffectRemoveBuffHandler(obj_id self, String effectName, String subType, float duration, float value, String buffName, obj_id caster)
    {
        stopClientEffectObjByLabel(self, "costume_burning_effect");
        return SCRIPT_CONTINUE;
    }
    public void checkToRefreshCostumeBurningEffect(obj_id self)
    {
    ...
    public int handleCostumeBurningBuffEffect(obj_id self, dictionary params)
    {
        checkToRefreshCostumeBurningEffect(self);
        return SCRIPT_CONTINUE;
    }
    public int lovedayHeartsEffectAddBuffHandler(obj_id self, String effectName, String subType, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int lovedayHeartsEffectRemoveBuffHandler(obj_id self, String effectName, String subType, float duration, float value, String buffName, obj_id caster)
    {
        stopClientEffectObjByLabel(self, "loveday_hearts_effect");
        return SCRIPT_CONTINUE;
    }
    public void checkToRefreshLovedayHeartsEffect(obj_id self)
    {
    ...
    public int handleLovedayHeartsEffect(obj_id self, dictionary params)
    {
    ...
    public int halloweenCooldownAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int halloweenCooldownRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int halloweenCoinLimitAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int halloweenCoinLimitRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        if (hasObjVar(self, event_perk.COUNTER_TIMESTAMP))
        {
            int now = getCalendarTime();
    ...
    public int lifedayCompetitiveBuffRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int scoreBoardCheck(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public void updateScore(obj_id self, String playerName, int playerScore, String playerFaction, String position, String scoreBoardEmpty)
    {
        obj_id tatooine = getPlanetByName("tatooine");
        int oneScore = 0;
        String oneName = "";
    ...
    public void checkLifeDayData(obj_id planet)
    {
    ...
    public boolean newLifeDayDay(obj_id planet)
    {
        if (hasObjVar(planet, "lifeday.time_stamp"))
        {
            int now = getCalendarTime();
    ...
    public void newLifeDayTimeStamp(obj_id planet)
    {
        int now = getCalendarTime();
        int secondsUntil = secondsUntilNextDailyTime(10, 0, 0);
        int then = now + secondsUntil;
    ...
    public int procResistAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    public int procResistRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    public int wampaBossIceThrowPrepAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        sendWampaBossWarning(self, "wampa_boss_ice_throw_prep");
        return SCRIPT_CONTINUE;
    }
    public int wampaBossIceThrowPrepRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int wampaBossTauntaunThrowPrepAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        sendWampaBossWarning(self, "wampa_boss_tauntaun_throw_prep");
        return SCRIPT_CONTINUE;
    }
    public int wampaBossTauntaunThrowPrepRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public void sendWampaBossWarning(obj_id target, String messageId)
    {
    ...
    public int iceblockEffectAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int handleDoIceblock(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int iceblockEffectRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int barricadeDefenderAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        utils.setScriptVar(self, combat.DAMAGE_REDIRECT, caster);
        return SCRIPT_CONTINUE;
    }
    public int barricadeDefenderRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        utils.removeScriptVar(self, combat.DAMAGE_REDIRECT);
        return SCRIPT_CONTINUE;
    }
    public int snowspeederInstructionsAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int snowspeederInstructionsRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        buff.applyBuff(self, "snowspeeder_instructions_block");
        return SCRIPT_CONTINUE;
    }
    public int radarHueAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int radarHueRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        clearOverrideMapColor(self);
        return SCRIPT_CONTINUE;
    }
    public int bhShieldsChargedAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    public int bhShieldsChargedRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    public int bhShieldsAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int bhShieldsRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    public int sp_covert_masteryAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    public int sp_covert_masteryRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    public int randomCollectionItemAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        obj_id collectionItem = collection.grantRandomCollectionItem(self, "datatables/loot/loot_items/collectible/magseal_loot.iff", "collections");
        buff.removeBuff(self, buffName);
        return SCRIPT_CONTINUE;
    }
    public int randomCollectionItemRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    public int gcwBonusGeneralAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int gcwBonusGeneralRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        utils.removeScriptVarTree(self, "buff.gcwBonusGeneral");
        return SCRIPT_CONTINUE;
    }
    public int battlefieldCommuncationsGlowAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int battlefieldCommuncationsGlowRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        if (effectName.lastIndexOf("_") > 0)
        {
            effectName = effectName.substring(0, (effectName.lastIndexOf("_")));
    ...
    public int empireDayImperialRecruitmentAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    public int empireDayImperialRecruitmentRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int empireDayRebelResistanceAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    public int empireDayRebelResistanceRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int empireDayImperialPropagandaAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    public int empireDayImperialPropagandaRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int empireDayRebelVandalAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    public int empireDayRebelVandalRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public boolean updateEmpireDayLeaderBoard(obj_id player, int faction)
    {
    ...
    public int deathTroopersAfflictedTossAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        messageTo(self, "createAfflicted", null, 1.0f, false);
        return SCRIPT_CONTINUE;
    }
    public int createAfflicted(obj_id self, dictionary params)
    {
    ...
    public int outbreakStackingInfectionAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int outbreakStackingInfectionRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        trial.bumpSession(self, "outbreak_stacking_infection");
        return SCRIPT_CONTINUE;
    }
    public int handleOutbreakStackingInfection(obj_id self, dictionary params)
    {
    ...
    public int killPlayerAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        if (!isDead(self))
        {
    ...
    public int beastScaleChangeAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        if (beast_lib.isBeast(self))
        {
    ...
    public int beastScaleChangeRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        setScale(self, beast_lib.getBeastScaleByLevel(self));
        setYaw(self, rand(0.0f, 360.0f));
        return SCRIPT_CONTINUE;
    }
    public int beastAutoFeederAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int beastAutoFeederBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
    ...
    public int gcwSpyDestroyPatrolExplosivesAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    public int gcwSpyDestroyPatrolExplosivesRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    public int gcwGeneralResistanceStackAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    public int gcwGeneralResistanceStackRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
    public int gcwFatigueDecay(obj_id self, dictionary params)
    {
    ...
    public int gcwMiniTurretAddBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        obj_id turret = null;
        location loc = getLocation(self);
    ...
    public int gcwMiniTurretRemoveBuffHandler(obj_id self, String effectName, String subtype, float duration, float value, String buffName, obj_id caster)
    {
        return SCRIPT_CONTINUE;
    }
}
