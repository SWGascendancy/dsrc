...
public class race_droid extends script.base_script
{
    ...
    public int initializeRaceDroid(obj_id self, dictionary params)
    {
    ...
    public int messageStartMission(obj_id self, dictionary params)
    {
    ...
    public int messageRegisterBest(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
    ...
    public int messageDisplayLeader(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        float topRecord = getFloatObjVar(self, "event_perk.racing.topRecord");
    ...
    public int continueCollectingRaceData(obj_id self, dictionary params)
    {
    ...
    public int showRaceSetupUI(obj_id self, obj_id player)
    {
    ...
    public int handleRaceUIdata(obj_id self, dictionary params)
    {
    ...
    public int storeLastRaceDataObjVar(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        int setupStep = getIntObjVar(self, "event_perk.racing.setupStep");
    ...
    public int showStoredPlayerWaypointRaceData(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        int maxWaypoints = getIntObjVar(self, "event_perk.racing.maxWaypoints");
