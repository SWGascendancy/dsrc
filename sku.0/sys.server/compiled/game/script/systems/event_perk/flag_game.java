...
public class flag_game extends script.base_script
{
    ...
    public void startGame(obj_id self)
    {
    ...
    public int showTimeTillExpiration(obj_id self, dictionary params)
    {
    ...
    public int tryRedeeding(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
    ...
    public int spawnFlag(obj_id self, dictionary params)
    {
    ...
    public int setTimeLimit(obj_id self, dictionary params)
    {
    ...
    public int startGame(obj_id self, dictionary params)
    {
    ...
    public int tryToSwapFlags(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        obj_id flag = getObjIdObjVar(self, "event_perk.current_flag");
        int gameState = utils.getIntScriptVar(self, "event_perk.game_state");
    ...
    public int advanceGamePulse(obj_id self, dictionary params)
    {
    ...
    public int gameOver(obj_id self, dictionary params)
    {
        int rebelScore = getIntObjVar(self, "event_perk.rebel_score");
        int imperialScore = getIntObjVar(self, "event_perk.imperial_score");
    ...
    public int showScores(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        int rebelScore = getIntObjVar(self, "event_perk.rebel_score");
        int imperialScore = getIntObjVar(self, "event_perk.imperial_score");
    ...
    public void playVictoryEffects(obj_id self, String faction)
    {
        obj_id[] objPlayers = getPlayerCreaturesInRange(self, 256.0f);
        if (objPlayers != null && objPlayers.length > 0)
        {
