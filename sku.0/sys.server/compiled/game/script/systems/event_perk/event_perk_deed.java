...
public class event_perk_deed extends script.base_script
{
    ...
    public void useEventPerk(obj_id self, obj_id player)
    {
    ...
    public void spawnEventPerk(obj_id self, obj_id player, location here)
    {
        if (!hasObjVar(self, "event_perk.timeStamp"))
        {
    ...
    public void checkTimeLimit(obj_id self, obj_id player)
    {
        if (hasObjVar(self, "event_perk.timeStamp"))
        {
            float lifeSpan = getFloatObjVar(self, "event_perk.lifeSpan");
    ...
    public void createNpcActor(obj_id self, obj_id player, location here)
    {
        String[] randomOnly = 
        {
    ...
    public int destroyYourself(obj_id self, dictionary params)
    {
        destroyObject(self);
        return SCRIPT_CONTINUE;
    }
    public int handleNpcActorRaceSelect(obj_id self, dictionary params)
    {
    ...
    public int handleNpcActorGenderSelect(obj_id self, dictionary params)
    {
        int idx = sui.getListboxSelectedRow(params);
        if (idx < 0)
        {
    ...
    public int handleSetNpcActorName(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
    ...
    public int buildNpcActor(obj_id self, dictionary params)
    {
        int deedNumber = getIntObjVar(self, "event_perk.deedNumber");
        String type = dataTableGetString(DATATABLE, deedNumber, "TYPE");
        String spawn = dataTableGetString(DATATABLE, deedNumber, "SPAWN");
