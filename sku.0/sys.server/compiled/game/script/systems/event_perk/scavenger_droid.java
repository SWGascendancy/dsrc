...
public class scavenger_droid extends script.base_script
{
    ...
    public int updateMasterScoreCard(obj_id self, dictionary params)
    {
    ...
    public string_id parseNameToStringId(String itemName, obj_id player)
    {
    ...
    public int showSetupInstructions(obj_id pcd, obj_id player)
    {
    ...
    public int showGameInstructions(obj_id pcd, obj_id player)
    {
    ...
    public void resetList(obj_id self, obj_id player)
    {
        setObjVar(self, "event_perk.scavenger.item_count", 1);
        String[] itemTemplateList = 
        {
