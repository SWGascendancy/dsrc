...
public class jukebox extends script.base_script
{
    ...
    public int initializeJukebox(obj_id self, dictionary params)
    {
    ...
    public boolean allowedToUse(obj_id self, obj_id player)
    {
    ...
    public boolean allowedToListen(obj_id self, obj_id player)
    {
        obj_id storyteller = getObjIdObjVar(self, "storytellerid");
        if (isIdValid(storyteller))
        {
    ...
    public void showMusicSelection(obj_id self, obj_id player)
    {
    ...
    public String[] getAlphabetizedSongList(String[] songList)
    {
    ...
    public void startListeningToMusic(obj_id self, obj_id player)
    {
        if (hasObjVar(self, JUKBOX_SONG_OBJVAR))
        {
            String song = getStringObjVar(self, JUKBOX_SONG_OBJVAR);
    ...
    public int selectMusic(obj_id self, dictionary params)
    {
    ...
    public int stopMusic(obj_id self, dictionary params)
    {
        setObjVar(self, JUKBOX_SONG_OBJVAR, "none");
        stopPlayingMusic(self);
        return SCRIPT_CONTINUE;
    }
    public void stopPlayingMusic(obj_id self)
    {
    ...
    public int prepareToPlaySelectedSong(obj_id self, dictionary params)
    {
        obj_id storyteller = getObjIdObjVar(self, "storytellerid");
        if (!isIdValid(storyteller))
        {
    ...
    public int playSelectedSong(obj_id self, dictionary params)
    {
        String song = getStringObjVar(self, JUKBOX_SONG_OBJVAR);
        if (!song.equals("none"))
        {
    ...
    public int cleanUpJukebox(obj_id self, dictionary params)
    {
        cleanUpRoom(self);
        messageTo(self, "destroyJukebox", null, 1, false);
        return SCRIPT_CONTINUE;
    }
    public int destroyJukebox(obj_id self, dictionary params)
    {
        destroyObject(self);
        return SCRIPT_CONTINUE;
    }
    ...
    public void cleanUpRoom(obj_id self)
    {
        if (isIdValid(self))
        {
            location here = getLocation(self);
