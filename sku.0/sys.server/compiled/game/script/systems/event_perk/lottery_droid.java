...
public class lottery_droid extends script.base_script
{
    ...
    public int selectDuration(obj_id self, dictionary params)
    {
    ...
    public int selectPayout(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        int idx = sui.getListboxSelectedRow(params);
        if (idx < 0)
    ...
    public int handleTicketCost(obj_id self, dictionary params)
    {
    ...
    public int handleShowTicketCostSUIAgain(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("theGuy");
        showTicketCostSUI(self, player);
        return SCRIPT_CONTINUE;
    }
    public int handleAddCredits(obj_id self, dictionary params)
    {
        int bp = sui.getIntButtonPressed(params);
        String text = sui.getInputBoxText(params);
        obj_id player = sui.getPlayerId(params);
    ...
    public int handlePurchaseRegistration(obj_id self, dictionary params)
    {
        int bp = sui.getIntButtonPressed(params);
        obj_id player = sui.getPlayerId(params);
        int totalMoney = getTotalMoney(player);
    ...
    public int handleShowCreditsConfirm(obj_id self, dictionary params)
    {
        int bp = sui.getIntButtonPressed(params);
    ...
    public int handleShowAddCreditsSUIAgain(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("theGuy");
        showAddCreditsToPot(self, player);
        return SCRIPT_CONTINUE;
    }
    public int lotteryTimerPing(obj_id self, dictionary params)
    {
        int initialized = getIntObjVar(self, "event_perk.lottery.initialized");
        checkTimeLimit(self);
        if (initialized == 1 || initialized == 2)
    ...
    public int transferWinningsToWinner(obj_id self, dictionary params)
    {
        obj_id winner = getObjIdObjVar(self, "event_perk.lottery.winner_OID");
    ...
    public int transferTakeToOwner(obj_id self, dictionary params)
    {
        obj_id owner = getObjIdObjVar(self, "storytellerid");
        int myMoney = getTotalMoney(self);
    ...
    public void performLotteryDrawing(obj_id self)
    {
        obj_id[] playerOIDList = getObjIdArrayObjVar(self, "event_perk.lottery.player_OID_list");
        String[] playerNameList = getStringArrayObjVar(self, "event_perk.lottery.player_name_list");
    ...
    public void checkTimeLimit(obj_id self)
    {
        int initialized = getIntObjVar(self, "event_perk.lottery.initialized");
        if (initialized == 1)
        {
    ...
    public void initializeLottery(obj_id self, obj_id player)
    {
        int duration = getIntObjVar(self, "event_perk.lottery.game_duration");
        float payoutPercent = getFloatObjVar(self, "event_perk.lottery.payout_percent");
        int ticketCost = getIntObjVar(self, "event_perk.lottery.ticket_price");
    ...
    public void showDurationList(obj_id self, obj_id player)
    {
    ...
    public void showPayoutPercentList(obj_id self, obj_id player)
    {
    ...
    public int showTicketCostSUI(obj_id self, obj_id player)
    {
    ...
    public int showAddCreditsToPot(obj_id self, obj_id player)
    {
    ...
    public int showLotteryInfo(obj_id self, obj_id player)
    {
        int initialized = getIntObjVar(self, "event_perk.lottery.initialized");
        int duration = getIntObjVar(self, "event_perk.lottery.game_duration");
        float payoutPercent = getFloatObjVar(self, "event_perk.lottery.payout_percent");
    ...
    public int showLotteryInstructions(obj_id self, obj_id player)
    {
    ...
    public int showAddCreditsConfirm(obj_id self, obj_id player)
    {
        int creditsToAdd = getIntObjVar(self, "event_perk.lottery.creditsToAdd");
    ...
    public int showPurchaseRegistration(obj_id self, obj_id player)
    {
    ...
    public String estimateTime(float remaining)
    {
