...
public class jukebox_room extends script.base_script
{
    ...
    public int OnAboutToLoseItem(obj_id self, obj_id destinationCell, obj_id transferrer, obj_id item)
    {
        if (isPlayer(item))
        {
    ...
    public String getMyJukeboxSong(obj_id room)
    {
        String song = "none";
    ...
    public int stopSong(obj_id self, dictionary params)
    {
        obj_id[] contents = getContents(self);
        for (int i = 0; i < contents.length; i++)
        {
    ...
    public int stopAndCleanUp(obj_id self, dictionary params)
    {
        obj_id[] contents = getContents(self);
        for (int i = 0; i < contents.length; i++)
        {
