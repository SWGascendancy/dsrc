...
public class shuttle_beacon extends script.base_script
{
    ...
    public int handleCallShuttle(obj_id self, dictionary params)
    {
    ...
    public void dismissShuttle(obj_id self, obj_id player)
    {
        messageTo(self, "handleDismissShuttle", null, 0, false);
        return;
    }
    public int handleDismissShuttle(obj_id self, dictionary params)
    {
        obj_id shuttle = getObjIdObjVar(self, "event_perk.shuttle.shuttle");
    ...
    public int toggleShuttleStatus(obj_id self, dictionary params)
    {
        int shuttleStatus = getIntObjVar(self, "event_perk.shuttleStatus");
        if (shuttleStatus == 0)
        {
    ...
    public int getRidOfShuttle(obj_id self, dictionary params)
    {
