...
public class treasure_map extends script.base_script
{
    ...
    public obj_id getWaypoint(obj_id map, obj_id player)
    {
        if (!isIdValid(map))
        {
    ...
    public void displayDialog(obj_id map, obj_id player)
    {
    ...
    public int createDialog(obj_id map, obj_id player, String text, String title)
    {
        if (!isIdValid(player))
        {
    ...
    public int handleDialogInput(obj_id self, dictionary params)
    {
        obj_id map = self;
    ...
    public boolean storeWaypoint(obj_id map, obj_id player)
    {
        if (!isIdValid(player))
        {
    ...
    public void searchArea(obj_id map, obj_id player)
    {
        if (!isIdValid(player))
        {
    ...
    public int finishSearchArea(obj_id self, dictionary params)
    {
        obj_id map = self;
        if (params == null)
        {
    ...
    public void extractTreasure(obj_id map, obj_id player)
    {
        if (!isIdValid(player))
        {
    ...
    public int spawnTreasure(obj_id self, dictionary params)
    {
        obj_id map = self;
        if ((params == null) || (params.isEmpty()))
        {
    ...
    public boolean getTreasureParams(obj_id map, obj_id player)
    {
        if (!isIdValid(player))
        {
    ...
    public boolean setPlayerGroupLevel(obj_id map, obj_id player)
    {
        if (!isIdValid(player))
        {
    ...
    public int findAmbushNearBy(obj_id map, obj_id player, int intPlayerLevel, location ownerLocation)
    {
        if (!isIdValid(player))
        {
            return 0;
    ...
    public int getEnemyReCount(obj_id player, obj_id map, int intCurrentCount)
    {
        if (!isIdValid(player))
        {
    ...
    public location getMapLocation(obj_id map, obj_id player)
    {
        if (!isIdValid(player))
        {
            CustomerServiceLog("treasureMap", "a treasure map failed to recount the enemies before treasure extraction because the player OID was not received. [ getEnemyReCount() ]");
    ...
    public boolean createMapWaypointAtLocation(obj_id map, obj_id player, location locationMapLocation)
    {
        if (!isIdValid(player))
        {
    ...
    public int getMobLevel(obj_id map, obj_id player, int playerLevel, int intMaxLevel, int intMinLevel, int mobLevelModifier)
    {
        if (!isIdValid(player))
        {
    ...
    public int getMapTreasurePlanet(obj_id self, dictionary params)
    {
        obj_id map = self;
        int intMaxLevel = getIntObjVar(map, "max");
        if (intMaxLevel <= 0)
    ...
    public String checkForBossMobSpawn(obj_id player, int mobLevel, int groupModifier, int dataTableIdx, String loot_table)
    {
    ...
    public boolean verifyVariablesNotNull(String loot_table, String type, int mobLevel, int groupModifier, int count, int datTableIdx)
    {
    ...
    public boolean checkState(obj_id player)
    {
    ...
    public boolean checkScene(obj_id player, obj_id map)
    {
        String req_planet = getStringObjVar(map, "planet");
        String scene = getCurrentSceneName();
    ...
    public void doDebugLogging(String section, String message)
    {
        LOG(section, message);
    }
}
