...
public class dummy_treasure_drum extends script.base_script
{
    ...
    public int setupChest(obj_id self, dictionary params)
    {
        obj_id fake_chest = self;
    ...
    public int cleanUpFakeChest(obj_id self, dictionary params)
    {
        obj_id fake_chest = self;
        if (!isValidId(fake_chest) || !exists(fake_chest))
        {
    ...
    public int spawnTreasureGuards(obj_id self, dictionary params)
    {
        obj_id fake_chest = self;
        if (params == null)
        {
    ...
    public int recalculateGuardArray(obj_id self, dictionary params)
    {
        obj_id fake_chest = self;
        obj_id player = getObjIdObjVar(fake_chest, "owner");
        if (!isValidId(player) || !exists(player))
    ...
    public boolean fillTreasureChestWithLoot(obj_id player, obj_id treasureChest, int groupModifier, String loot_table, int treasureLevel)
    {
    ...
    public boolean eightParticipantBonusLootItem(obj_id treasureChest, int treasureLevel, int randomNumber)
    {
    ...
    public boolean fourParticipantBonusLootItem(obj_id treasureChest, int treasureLevel, int randomNumber)
    {
