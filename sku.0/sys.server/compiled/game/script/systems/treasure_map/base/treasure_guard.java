...
public class treasure_guard extends script.base_script
{
    ...
    public int cleanUpGuard(obj_id self, dictionary params)
    {
        destroyObject(self);
        return SCRIPT_CONTINUE;
    }
    public int attackThief(obj_id self, dictionary params)
    {
    ...
    public int glow(obj_id self, dictionary params)
    {
    ...
    public int expression_fist(obj_id self, dictionary params)
    {
        obj_id glowingMob = getObjIdObjVar(self, "glowing_mob");
        if (!isValidId(glowingMob) || !exists(glowingMob))
        {
    ...
    public int expression_disappear(obj_id self, dictionary params)
    {
        obj_id glowingMob = getObjIdObjVar(self, "glowing_mob");
        if (!isValidId(glowingMob) || !exists(glowingMob))
        {
    ...
    public int cleanUpGlowie(obj_id self, dictionary params)
    {
        obj_id glowingMob = getObjIdObjVar(self, "glowing_mob");
        if (!isValidId(glowingMob) || !exists(glowingMob))
        {
    ...
    public boolean getRandomGroupMember(obj_id self, obj_id player, obj_id[] members)
    {
        if (!isValidId(player) || !exists(player))
        {
            return false;
    ...
    public boolean isWookiee(obj_id playerOrMob)
    {
    ...
    public int barkAttack(obj_id self, dictionary params)
    {
        obj_id guard = self;
        if (params == null)
        {
