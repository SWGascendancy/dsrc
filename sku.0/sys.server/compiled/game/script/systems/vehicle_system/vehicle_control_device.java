...
public class vehicle_control_device extends script.base_script
{
    ...
    public obj_id createVehicle(obj_id player, obj_id petControlDevice)
    {
    ...
    public void customizationFadeToWhite(obj_id pet, float percent)
    {
    ...
    public int handleRemoveCurrentVehicle(obj_id self, dictionary params)
    {
    ...
    public int handleStoreVehicleDamage(obj_id self, dictionary params)
    {
    ...
    public boolean updateTcgVehicleMaxHealth(obj_id tcgVehiclePcd)
    {
    ...
    public int modifyPaletteIndex(int idx)
    {
