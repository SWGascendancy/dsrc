...
public class vehicle_garage extends script.base_script
{
    ...
    public void enterRepairZone(obj_id ride)
    {
    ...
    public int handleRepairConfirm(obj_id self, dictionary params)
    {
    ...
    public int handleRepairPayment(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public boolean isGarageInRange(obj_id vehicle)
    {
