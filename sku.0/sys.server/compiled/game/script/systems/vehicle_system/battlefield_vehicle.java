...
public class battlefield_vehicle extends script.base_script
{
    ...
    public void establishFaction(obj_id self)
    {
    ...
    public void removePlayersFromVehicleAndDestroySelf(obj_id self, float delay)
    {
    ...
    public void removePlayersFromVehicle(obj_id self)
    {
    ...
    public int handleCheckForAllowedZones(obj_id self, dictionary params)
    {
        checkForAllowedZones(self);
    ...
    public void debugMessaging(obj_id self, String message)
    {
    ...
    public void checkForAllowedZones(obj_id self)
    {
    ...
    public int OnReceivedItem(obj_id self, obj_id srcContainer, obj_id transferer, obj_id player)
    {
        checkForAllowedZones(self);
    ...
    public int OnLostItem(obj_id self, obj_id destContainer, obj_id transferer, obj_id player)
    {
    ...
    public void checkForPassengers(obj_id self)
    {
        int numPlayers = 0;
    ...
    public String getOverrideAttack(dictionary dict, boolean isDriver)
    {
        if (isDriver)
        {
    ...
    public String[] getVehicleCommands(dictionary dict, boolean isDriver)
    {
    ...
    public String getVehicleType(obj_id vehicle)
    {
