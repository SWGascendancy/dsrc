...
public class vehicle_base extends script.base_script
{
    ...
    public int revertVehicleMod(obj_id self, dictionary params)
    {
    ...
    public int checkForJetpack(obj_id self, dictionary params)
    {
    ...
    public int handleVehicleDecay(obj_id self, dictionary params)
    {
        return SCRIPT_CONTINUE;
    }
    ...
    public boolean isMountedOnCreatureQueried(obj_id pet, obj_id player)
    {
        if (!isIdValid(pet))
        {
            return false;
    ...
    public boolean canTrainAsMount(obj_id pet, obj_id player)
    {
        if (!isIdValid(pet))
        {
    ...
    public boolean trainMount(obj_id pet, obj_id player)
    {
    ...
    public boolean makePetAMount(obj_id pet, obj_id player)
    {
        if (!isIdValid(pet) || !isIdValid(player))
        {
            return false;
    ...
    public int handleDisabledPackRequest(obj_id self, dictionary params)
    {
        if (isDisabled(self))
        {
    ...
    public int destroyNow(obj_id self, dictionary params)
    {
