...
public class vehicle_ping extends script.base_script
{
    ...
    public int vehiclePingCallback(obj_id self, dictionary params)
    {
    ...
    public int handlePositiveAcknowledgementFromVcd(obj_id self, dictionary params)
    {
        if (debug)
        {
    ...
    public int handleNegativeAcknowledgementFromVcd(obj_id self, dictionary params)
    {
        if (debug)
        {
    ...
    public boolean doPingBasedKill(obj_id vehicle, String reason)
    {
        if (debug)
        {
    ...
    public void ensureVcdHasSisterScript(obj_id vehicle)
    {
