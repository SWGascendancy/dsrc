...
public class vcd_ping_response extends script.base_script
{
    ...
    public int handleVehiclePing(obj_id self, dictionary params)
    {
    ...
    public dictionary createResponseDictionary(obj_id vcdId, int messageNumber)
    {
    ...
    public void sendPositiveAcknowledgement(obj_id vcdId, obj_id vehicleId, int messageNumber)
    {
    ...
    public void sendNegativeAcknowledgement(obj_id vcdId, obj_id vehicleId, int messageNumber, String reason)
    {
        dictionary messageData = createResponseDictionary(vcdId, messageNumber);
    ...
    public boolean isRiderOkayForVcd(obj_id vcdId, obj_id riderId)
    {
