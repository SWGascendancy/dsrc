...
public class dynamic_region_master extends script.base_script
{
    ...
    public int heartbeat(obj_id self, dictionary params)
    {
    ...
    public int OnDynamicSpawnRegionCreated(obj_id self, obj_id regionObject, String spawnDatatable, float x, float y, float z)
    {
