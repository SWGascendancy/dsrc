...
public class buff_builder_response extends script.base_script
{
    ...
    public static final float BUFF_BUILDER_RANGE = 20.0f;
    ...
    public int OnBuffBuilderValidate(obj_id self, obj_id bufferId, obj_id recipientId, int startingTime, int bufferRequiredCredits, int recipientPaidCredits, boolean accepted, String[] buffComponentKeys, int[] buffComponentValues)
    {
        if (!accepted)
        {
            detachScript(self, SCRIPT_BUFF_BUILDER_RESPONSE);
    ...
    public int OnBuffBuilderCompleted(obj_id self, obj_id bufferId, obj_id recipientId, int startingTime, int bufferRequiredCredits, int recipientPaidCredits, boolean accepted, String[] buffComponentKeys, int[] buffComponentValues)
    {
    ...
    public int OnBuffBuilderCanceled(obj_id self)
    {
        detachScript(self, SCRIPT_BUFF_BUILDER_RESPONSE);
        return SCRIPT_CONTINUE;
    }
