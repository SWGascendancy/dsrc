...
public class holoemote extends script.base_script
{
    ...
    public int holoHelpOff(obj_id self, dictionary params)
    {
    ...
    public int cmdHoloEmote(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public String getHoloEmotePath(String holoEmote)
    {
