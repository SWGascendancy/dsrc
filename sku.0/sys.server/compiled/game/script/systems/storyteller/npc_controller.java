...
public class npc_controller extends script.base_script
{
    ...
    public int handleStorytellerPropInitialize(obj_id self, dictionary params)
    {
    ...
    public int handleRemoveStorytellerPersistedEffect(obj_id self, dictionary params)
    {
        storyteller.removeStorytellerPersistedEffect(self);
        return SCRIPT_CONTINUE;
    }
    public int handleStorytellerNpcLevelSelect(obj_id self, dictionary params)
    {
    ...
    public void master_storyteller_npc_inventory(obj_id player, obj_id npc)
    {
    ...
    public int handleEditingNpcInventory(obj_id self, dictionary params)
    {
    ...
    public void npcSetup(obj_id self)
    {
    ...
    public void clearNpcInventoryOwnership(obj_id self)
    {
    ...
    public boolean equipWeapon(obj_id self)
    {
        if (aiHasPrimaryWeapon(self))
        {
            aiEquipPrimaryWeapon(self);
    ...
    public int cleanupProp(obj_id self, dictionary params)
    {
        trial.cleanupObject(self);
        return SCRIPT_CONTINUE;
    }
    public int prepCleanupProp(obj_id self, dictionary params)
    {
    ...
    public int handleBlueprintElevation(obj_id self, dictionary params)
    {
    ...
    public void checkBonusCleanupTime(obj_id prop_controller)
    {
        storyteller.calculateNpcBonusExistTime(prop_controller);
    }
    public int st_receivedCityResponse(obj_id self, dictionary params)
    {
