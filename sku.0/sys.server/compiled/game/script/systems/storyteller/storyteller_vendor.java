...
public class storyteller_vendor extends script.base_script
{
    ...
    public int handlSpecialName(obj_id self, dictionary params)
    {
        if (rand(0, 5) == 1)
        {
    ...
    public void attachStorytellerVendorConvo(obj_id vendor)
    {
    ...
    public int msgStorytellerTokenTypeSelected(obj_id self, dictionary params)
    {
    ...
    public int msgStorytellerTokenPurchaseSelected(obj_id self, dictionary params)
    {
        storyteller.storytellerTokenPurchased(params, self);
        return SCRIPT_CONTINUE;
    }
    public int msgStorytellerChargesSelected(obj_id self, dictionary params)
    {
