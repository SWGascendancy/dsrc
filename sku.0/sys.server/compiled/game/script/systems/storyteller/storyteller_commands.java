...
public class storyteller_commands extends script.base_script
{
    ...
    public int storytellerMode(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public String[] getHelpTypeArray()
    {
    ...
    public int msgStorytellerHelpOptionSelected(obj_id self, dictionary params)
    {
    ...
    public int storyAutoDeclineInvites(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int makeStoryAssistant(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int handleStorytellerAlreadyAnAssistant(obj_id self, dictionary params)
    {
    ...
    public int handleStorytellerAssistantDeclined(obj_id self, dictionary params)
    {
        String targetName = params.getString("targetName");
    ...
    public int storyAssistantHandler(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        int btn = sui.getIntButtonPressed(params);
        if (!isIdValid(player))
    ...
    public int handleStorytellerAssistantHasBeenAdded(obj_id self, dictionary params)
    {
    ...
    public int quitStoryAssistant(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (utils.hasScriptVar(self, "storytellerAssistant"))
        {
    ...
    public int removeStoryAssistant(obj_id self, obj_id target, String params, float defaultTime)
    {
        target = null;
        java.util.StringTokenizer st = new java.util.StringTokenizer(params);
        if (st.countTokens() > 0)
    ...
    public int handleStorytellerRemovePlayerNotAssistant(obj_id self, dictionary params)
    {
        String targetName = params.getString("targetName");
    ...
    public int handleStorytellerAssistantHasBeenRemoved(obj_id self, dictionary params)
    {
    ...
    public int inviteToStory(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id storytellerId = self;
    ...
    public int handleStorytellerInviteDeclined(obj_id self, dictionary params)
    {
        String targetName = params.getString("targetName");
    ...
    public int handleStorytellerInviteAlreadyInAStory(obj_id self, dictionary params)
    {
    ...
    public int storyInviteHandler(obj_id self, dictionary params)
    {
        obj_id storytellerId = self;
        String storytellerName = getName(self);
        obj_id storytellerAssistant = null;
    ...
    public int handleStorytellerPlayerHasBeenAdded(obj_id self, dictionary params)
    {
    ...
    public int leaveStory(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int removeFromStory(obj_id self, obj_id target, String params, float defaultTime)
    {
        target = null;
        java.util.StringTokenizer st = new java.util.StringTokenizer(params);
        if (st.countTokens() > 0)
    ...
    public int handleStorytellerRemovePlayerNotInStory(obj_id self, dictionary params)
    {
        String targetName = params.getString("targetName");
    ...
    public int handleStorytellerPlayerHasBeenRemoved(obj_id self, dictionary params)
    {
        String removedPlayerName = params.getString("removedPlayerName");
        if (removedPlayerName != null && removedPlayerName.length() > 0)
        {
    ...
    public int storytellerDestroyNpcs(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isGod(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int storytellerDestroyProps(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isGod(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int storytellerDestroyParticles(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isGod(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int storytellerDestroyAllObjects(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isGod(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public dictionary getDestroyStorytellerObjectParams(String params)
    {
        dictionary webster = new dictionary();
        obj_id storytellerId = obj_id.NULL_ID;
    ...
    public Vector getElligibleStorytellerObjectsInRange(obj_id self, obj_id storytellerId, String storytellerName)
    {
    ...
    public int chroniclerVentriloquism(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int chroniclerGetRating(obj_id self, obj_id target, String params, float defaultTime)
    {
        java.util.StringTokenizer st = new java.util.StringTokenizer(params);
        if (st.countTokens() > 0)
        {
    ...
    public int chroniclerGetStoredXp(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int handleChroniclerGetStoredXp(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int chroniclesLootToggle(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int handleChroniclesLootToggleConfirmation(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
