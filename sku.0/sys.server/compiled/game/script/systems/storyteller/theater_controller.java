...
public class theater_controller extends script.base_script
{
    ...
    public boolean isInBuildoutMode(obj_id theater)
    {
        return getBooleanObjVar(theater, storyteller.THEATER_MODE);
    }
    public String[] recoverTheater(obj_id theater, obj_id player)
    {
    ...
    public float getTheaterBuildoutRange(String item)
    {
        return dataTableGetFloat(storyteller.STORYTELLER_DATATABLE, item, "buildout_radius");
    }
    public obj_id[] getStorytellerObjectsFromArray(Vector allObjects)
    {
    ...
    public String[] getStorytellerItemListFromArray(obj_id[] objectList)
    {
    ...
    public void clearTheaterArea(obj_id theater)
    {
        float range = getTheaterBuildoutRange(getStaticItemName(theater));
