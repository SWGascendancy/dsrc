...
public class figrin_dan_band_spawner extends script.base_script
{
    ...
    public location rotateXZ(location locOrigin, location locPoint, float fltAngle)
    {
    ...
    public void destroyTheBand(obj_id self)
    {
        if (!hasObjVar(self, DATATABLE_OBJVAR))
        {
            return;
    ...
    public int spawnFigrinDanBand(obj_id self, dictionary params)
    {
    ...
    public int setOriginalMood(obj_id self, dictionary params)
    {
