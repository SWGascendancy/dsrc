...
public class effect_controller extends script.base_script
{
    ...
    public int handlePlayEffect(obj_id self, dictionary params)
    {
        playEffect(self);
        return SCRIPT_CONTINUE;
    }
    public void playEffect(obj_id self)
    {
    ...
    public int handlePlayNewStorytellerEffect(obj_id self, dictionary params)
    {
    ...
    public float getStandardCleanupTime(obj_id effect_controller)
    {
        return 30.0f;
    }
    public int cleanupEffectController(obj_id self, dictionary params)
    {
        trial.cleanupObject(self);
        return SCRIPT_CONTINUE;
    }
    public obj_id[] getPlayersInRangeInStory(obj_id self, location here)
    {
