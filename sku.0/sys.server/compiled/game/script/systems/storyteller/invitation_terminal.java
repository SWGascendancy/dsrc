...
public class invitation_terminal extends script.base_script
{
    ...
    public int initializeStorytellerInvitationTerminal(obj_id self, dictionary params)
    {
    ...
    public int terminalStoryInviteSui(obj_id storytellerPlayer, String storytellerName, obj_id player, obj_id terminal)
    {
    ...
    public int terminalStoryInviteHandler(obj_id self, dictionary params)
    {
