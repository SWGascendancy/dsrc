...
public class st_object_movement extends script.base_script
{
    ...
    public int rotateStorytellerObject(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int moveStorytellerObject(obj_id self, obj_id target, String params, float defaultTime)
    {
        java.util.StringTokenizer st = new java.util.StringTokenizer(params);
        if (st.countTokens() == 0)
        {
    ...
    public int storytellerItemRotateRight(obj_id self, obj_id target, String params, float defaultTime)
    {
        queueCommand(self, (-933756769), target, "left 90 " + target, COMMAND_PRIORITY_DEFAULT);
        return SCRIPT_CONTINUE;
    }
    public int storytellerItemRotateLeft(obj_id self, obj_id target, String params, float defaultTime)
    {
        queueCommand(self, (-933756769), target, "right 90 " + target, COMMAND_PRIORITY_DEFAULT);
        return SCRIPT_CONTINUE;
    }
    public int storytellerItemMoveForward(obj_id self, obj_id target, String params, float defaultTime)
    {
        queueCommand(self, (-918547884), target, "forward 10 " + target, COMMAND_PRIORITY_DEFAULT);
        return SCRIPT_CONTINUE;
    }
    public int storytellerItemMoveBack(obj_id self, obj_id target, String params, float defaultTime)
    {
        queueCommand(self, (-918547884), target, "back 10 " + target, COMMAND_PRIORITY_DEFAULT);
        return SCRIPT_CONTINUE;
    }
    public int storytellerItemMoveUp(obj_id self, obj_id target, String params, float defaultTime)
    {
        queueCommand(self, (-918547884), target, "up 1 " + target, COMMAND_PRIORITY_DEFAULT);
        return SCRIPT_CONTINUE;
    }
    public int storytellerItemMoveDown(obj_id self, obj_id target, String params, float defaultTime)
    {
        queueCommand(self, (-918547884), target, "down 1 " + target, COMMAND_PRIORITY_DEFAULT);
        return SCRIPT_CONTINUE;
    }
    public boolean isStorytellerMoveCommandValidation(obj_id player, obj_id target)
    {
