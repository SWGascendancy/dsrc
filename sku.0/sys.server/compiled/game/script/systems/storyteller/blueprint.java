...
public class blueprint extends script.base_script
{
    ...
    public int handleStorytellerBlueprintInitialize(obj_id self, dictionary params)
    {
        initializeBlueprint(self);
        return SCRIPT_CONTINUE;
    }
    public void initializeBlueprint(obj_id self)
    {
    ...
    public int confirmSaveNewBlueprintData(obj_id self, dictionary params)
    {
    ...
    public void showBlueprintDescriptionSetSui(obj_id self, obj_id player)
    {
    ...
    public int handleBlueprintDescriptionSet(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public int OnGroundTargetLoc(obj_id self, obj_id player, int menuItem, float x, float y, float z)
    {
        if (!utils.isNestedWithin(self, player))
        {
            sendSystemMessage(player, new string_id("storyteller", "blueprint_from_inventory_only"));
    ...
    public boolean hasBlueprintData(obj_id blueprint)
    {
        return utils.hasStringBatchObjVar(blueprint, storyteller.BLUEPRINT_OBJECTS_OBJVAR);
    }
    public boolean createBlueprint(obj_id blueprint, obj_id player)
    {
        if (!isIdValid(player))
        {
            return false;
    ...
    public void reconstructBlueprintScene(obj_id blueprint, obj_id player, location targetLoc, float targetYaw)
    {
    ...
    public String getBlueprintAttributes(obj_id self)
    {
