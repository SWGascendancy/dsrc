...
public class effect_token extends script.base_script
{
    ...
    public int storytellerEffectTokenDailyAlarm(obj_id self, dictionary params)
    {
        storyteller.resetTokenDailyCount(self);
        return SCRIPT_CONTINUE;
    }
    ...
    public obj_id getStorytellerEffectTarget(obj_id player)
    {
        obj_id target = null;
    ...
    public boolean playEffectOnTarget(obj_id token, obj_id target, obj_id player)
    {
    ...
    public boolean playEffectAtLocation(obj_id token, obj_id player, location here)
    {
    ...
    public boolean isTargetMyStorytellerObject(obj_id player, obj_id target)
    {
