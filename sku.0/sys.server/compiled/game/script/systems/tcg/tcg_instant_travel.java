...
public class tcg_instant_travel extends script.base_script
{
    ...
    public void markItvLocations(obj_id itv, obj_id player)
    {
    ...
    public int handlePlayerNameSetLocation(obj_id self, dictionary params)
    {
    ...
    public int handleSetItvLocations(obj_id self, dictionary params)
    {
    ...
    public void retrieveLocationsList(obj_id itv, obj_id player)
    {
    ...
    public int handleSendPlayerToLocation(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleConfirmStationaryTravel(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public boolean isOwner(obj_id object, obj_id player)
    {
        return getOwner(object) == player;
    }
    public String getDisplayLocation(location loc)
    {
        String returnString = "" + Math.round(loc.x) + ", " + Math.round(loc.y) + ", " + Math.round(loc.z);
        return returnString;
    }
    public boolean itvIsInRangeOfPlayer(obj_id itv, obj_id player)
    {
        if (!isIdValid(itv) || !isIdValid(player))
        {
            return false;
