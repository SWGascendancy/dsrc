...
public class tcg_tauntaun_ride extends script.base_script
{
    ...
    public int TauntaunAnimationLockout(obj_id self, dictionary params)
    {
        if (utils.hasScriptVar(self, LOCKOUT))
        {
    ...
    public int transferTauntaunEarnings(obj_id self, dictionary params)
    {
    ...
    public void activateTauntaunRide(obj_id player, obj_id ride)
    {
    ...
    public int handlePayForTauntaunRide(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        int btn = sui.getIntButtonPressed(params);
        if (btn == sui.BP_CANCEL)
