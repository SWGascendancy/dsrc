...
public class tcg_pet_controller extends script.base_script
{
    ...
    public boolean spawnPetSomewhere(obj_id controller)
    {
    ...
    public boolean spawnPetByOwner(obj_id controller, obj_id owner)
    {
    ...
    public boolean spawnFoodAtLocation(obj_id controller, location foodLoc)
    {
    ...
    public boolean spawnSnackAtLocation(obj_id controller, location foodLoc)
    {
