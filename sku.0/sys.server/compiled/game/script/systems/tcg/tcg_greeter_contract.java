...
public class tcg_greeter_contract extends script.base_script
{
    ...
    public int handleGreeterAppearanceSelection(obj_id self, dictionary params)
    {
    ...
    public int handleSetGreeterName(obj_id self, dictionary params)
    {
    ...
    public boolean getGreeterData(obj_id self, obj_id player)
    {
        if (sui.hasPid(player, GREETER_APPEARANCE_PID))
        {
    ...
    public boolean outOfRange(obj_id self, obj_id player)
    {
        if (!isValidId(self) || !exists(self))
        {
            return true;
