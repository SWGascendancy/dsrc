...
public class tcg_vendor_contract extends script.base_script
{
    ...
    public int msgConfirmNonTraderVendorUse(obj_id self, dictionary params)
    {
    ...
    public int handleNonVendorAppearanceSelection(obj_id self, dictionary params)
    {
    ...
    public int handleSetNonVendorName(obj_id self, dictionary params)
    {
    ...
    public boolean getNonVendorData(obj_id self, obj_id player)
    {
    ...
    public boolean giveTcgTraderSkillMod(obj_id self, obj_id player)
    {
        if (!isValidId(player) || !exists(player))
        {
            return false;
    ...
    public boolean removeVars(obj_id self, obj_id player)
    {
        if (!isValidId(player) || !exists(player))
        {
            return false;
