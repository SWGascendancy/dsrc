...
public class tcg_combine_tcg_items extends script.base_script
{
    ...
    public boolean getCorrectCombination(obj_id[] combinableObjects, obj_id owner)
    {
    ...
    public boolean combineTheCombinableObjects(obj_id[] combinableList, obj_id owner)
    {
