...
public class target_creature extends script.base_script
{
    ...
    public int handleTargetCreatureSetUp(obj_id self, dictionary params)
    {
    ...
    public int OnObjectMenuSelect(obj_id self, obj_id player, int menu)
    {
    ...
    public int confirmClearYourCombatData(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public int confirmClearAllCombatData(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleTargetDummyLevelSelect(obj_id self, dictionary params)
    {
    ...
    public int handleTargetDummyDifficultySelect(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int targetDummyDefenseTypeSelected(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleTargetDummyDefensiveSkillModSet(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleTargetDummyCombatTick(obj_id self, dictionary params)
    {
        ...
        if (enemies != null && enemies.length > 0)
        {
            ...
            for (int i = 0; i < enemies.length; i++)
            {
                ...
                if (isIdValid(enemy))
                {
                    ...
                    if ((there.cell != null && here.cell != null) && (there.cell != here.cell || utils.getDistance2D(here, there) > 60))
                    {
    ...
    public int faceThePlayer(obj_id self, dictionary params)
    {
        obj_id owner = getObjIdObjVar(self, target_dummy.OWNER_OBJVAR);
    ...
    public int waveThePlayer(obj_id self, dictionary params)
    {
        obj_id owner = getObjIdObjVar(self, target_dummy.OWNER_OBJVAR);
        if (!isValidId(owner) || !exists(owner))
        {
    ...
    public int removeSoundDelay(obj_id self, dictionary params)
    {
        utils.removeScriptVar(self, target_dummy.TARGET_DUMMY_SOUND_DELAY);
        return SCRIPT_CONTINUE;
    }
    public int checkCurrentLocation(obj_id self, dictionary params)
    {
    ...
    public boolean playTargetDummySound(obj_id dummy, obj_id attacker)
    {
