...
public class tcg_video_game_series4 extends script.base_script
{
    ...
    public int clientMinigameResult(obj_id self, dictionary params)
    {
    ...
    public boolean playGame(obj_id table, obj_id player)
    {
    ...
    public boolean setupInitialScores(obj_id table)
    {
        if (!isValidId(table) || !exists(table))
        {
            return false;
    ...
    public boolean setUpLayOutScores(obj_id table, String layout, float modifier)
    {
        if (!isValidId(table) || !exists(table))
        {
            return false;
    ...
    public boolean checkScore(obj_id table, int newScore, String gameData, String layout)
    {
        if (!isValidId(table) || !exists(table))
        {
            return false;
    ...
    public String getHighScores(obj_id table, String layout)
    {
        if (!isValidId(table) || !exists(table))
        {
            return null;
    ...
    public String verifyLayOut(obj_id self, String layout)
    {
        if (layout == null || layout.equals(""))
        {
            return null;
    ...
    public boolean inHouse(obj_id device)
    {
