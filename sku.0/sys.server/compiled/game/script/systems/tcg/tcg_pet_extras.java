...
public class tcg_pet_extras extends script.base_script
{
    ...
    public void placeRottenEgg(obj_id player, obj_id rottenEgg)
    {
        if (!isIdValid(player) || !isIdValid(rottenEgg))
        {
            return;
    ...
    public int handleRottenEggPulseUpdate(obj_id self, dictionary params)
    {
    ...
    public int handleDestroyDeadFlowerUpdate(obj_id self, dictionary params)
    {
        destroyObject(self);
        return SCRIPT_CONTINUE;
    }
