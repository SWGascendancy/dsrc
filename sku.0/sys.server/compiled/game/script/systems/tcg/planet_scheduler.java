...
public class planet_scheduler extends script.base_script
{
    ...
    public int clearPromotions(obj_id self, dictionary params)
    {
    ...
    public int setPromotion(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
    ...
    public int reducePromotion(obj_id self, dictionary params)
    {
        if (params == null)
        {
            return SCRIPT_CONTINUE;
