...
public class tcg_massif_creature extends script.base_script
{
    ...
    public boolean processSpeech(obj_id pet, obj_id speaker, String text)
    {
        if (!isIdValid(pet))
        {
            return false;
    ...
    public boolean initiateMassiffAction(obj_id pet, obj_id speaker, String petCommand)
    {
        return initiateMassiffAction(pet, speaker, petCommand, true);
    }
    public boolean initiateMassiffAction(obj_id pet, obj_id speaker, String petCommand, boolean showCantHearOwner)
    {
    ...
    public int findRandomMassiffPetActivity(obj_id self, dictionary params)
    {
    ...
    public int layNunaEggs(obj_id self, dictionary params)
    {
    ...
    public int handleSetPetName(obj_id self, dictionary params)
    {
    ...
    public int findOwner(obj_id self, dictionary params)
    {
        blog("findOwner - Init");
        obj_id owner = getOwner(self);
    ...
    public int feedingTime(obj_id self, dictionary params)
    {
    ...
    public int eatTheFood(obj_id self, dictionary params)
    {
    ...
    public boolean updateMassiffPet(obj_id pet)
    {
    ...
    public boolean canSeeOwner(obj_id owner, obj_id pet)
    {
        if (!isValidId(owner) || !exists(owner))
        {
            return false;
    ...
    public int startWhining(obj_id self, dictionary params)
    {
        obj_id controller = getObjIdObjVar(self, house_pet.PARENT_OBJ_ID);
        if (!isValidId(controller) || !exists(controller))
        {
    ...
    public int makeHappySounds(obj_id self, dictionary params)
    {
    ...
    public int handlePetColorize(obj_id self, dictionary params)
    {
    ...
    public int resetVariablesOnMassiff(obj_id self, dictionary params)
    {
    ...
    public int startLoitering(obj_id self, dictionary params)
    {
    ...
    public int OnPack(obj_id self, dictionary params)
    {
        destroyObject(self);
        return SCRIPT_CONTINUE;
    }
    public int resumeStanding(obj_id self, dictionary params)
    {
        ai_lib.aiSetPosture(self, POSTURE_UPRIGHT);
        return SCRIPT_CONTINUE;
    }
    ...
    public int snackTime(obj_id self, dictionary params)
    {
    ...
    public int eatTheSnack(obj_id self, dictionary params)
    {
    ...
    public void scurrierPetEatingSurprise(obj_id controller, obj_id creature)
    {
        if (!isValidId(controller) || !exists(controller))
        {
            return;
