...
public class tcg_armor_kit extends script.base_script
{
    ...
    public boolean shouldBeInKit(obj_id item, obj_id player, obj_id armorKit)
    {
    ...
    public dictionary getArmorKitData(obj_id armorKit, obj_id player)
    {
    ...
    public boolean checkForMatchingArmorAppearance(String targetArmorAppearances, String itemAppearanceName, obj_id player)
    {
    ...
    public void activateArmorKit(obj_id armorKit, obj_id player)
    {
    ...
    public void flushArmorKit(obj_id armorKit, obj_id player)
    {
