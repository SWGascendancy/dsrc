...
public class barn_lite_device extends script.base_script
{
    ...
    public int setupBarnLiteDevice(obj_id self, dictionary params)
    {
    ...
    public int OnUnPack(obj_id self, dictionary params)
    {
        messageTo(self, "setupBarnLiteDevice", null, 1, false);
        return SCRIPT_CONTINUE;
    }
    public int OnShipUnpack(obj_id self, dictionary params)
    {
        messageTo(self, "setupBarnLiteDevice", null, 1, false);
        return SCRIPT_CONTINUE;
    }
    ...
    public boolean canUseInActiveBarnLite(obj_id self, obj_id player)
    {
        if (!utils.isNestedWithinAPlayer(self))
        {
            obj_id building = getTopMostContainer(self);
    ...
    public boolean canUseActiveBarnLite(obj_id self, obj_id player)
    {
    ...
    public int handleBarnBeastStorage(obj_id self, dictionary params)
    {
    ...
    public int handleBarnBeastReclaim(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleBarnBeastDisplay(obj_id self, dictionary params)
    {
        if ((params == null) || (params.isEmpty()))
        {
            return SCRIPT_CONTINUE;
    ...
    public void storeDisplayedBeast(obj_id self, obj_id player, String bcdSlot)
    {
    ...
    public String getPetNameForDisplayMessage(obj_id self, String bcdSlot)
    {
        String petName = "Unknown";
    ...
    public int showRoamingBeastsSoon(obj_id self, dictionary params)
    {
