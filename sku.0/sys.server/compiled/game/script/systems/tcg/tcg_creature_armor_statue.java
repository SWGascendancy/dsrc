...
public class tcg_creature_armor_statue extends script.base_script
{
    ...
    public boolean checkLocation(obj_id item, obj_id player)
    {
        if (!isIdValid(item))
        {
            return false;
    ...
    public obj_id[] getCreatureMountList(obj_id self, obj_id player)
    {
    ...
    public String[] getEligibleBeastsList(obj_id self)
    {
    ...
    public String getArmoredMountName(obj_id self)
    {
        if (hasObjVar(self, "armored_creature_type"))
        {
            String datatable = "datatables/tcg/armored_creature_swap.iff";
    ...
    public String getMountName(obj_id bcd, obj_id player)
    {
    ...
    public void startArmorSwap(obj_id self, obj_id player, obj_id[] playerEligibleMounts)
    {
    ...
    public int mountChoice(obj_id self, dictionary params)
    {
