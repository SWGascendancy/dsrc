...
public class perforce extends script.base_script
{
    ...
    public static String getIdOptions()
    {
        obj_id self = getSelf();
        if (!isGod(self))
        {
    ...
    public static boolean isPerforceConfigured()
    {
    ...
    public static String whoLocked(String fileName)
    {
        if (!isGod(getSelf()))
        {
            return null;
    ...
    public static boolean openExistingFileForExclusiveEdit(String fileName)
    {
        boolean result = false;
        obj_id self = getSelf();
        if (!isGod(self))
    ...
    public static void setupPerforce()
    {
        obj_id self = getSelf();
        if (!isGod(self))
        {
    ...
    public static String change(int changeList)
    {
        obj_id self = getSelf();
        if (!isGod(self))
        {
    ...
    public static String where(String fileLocation)
    {
        return system_process.runAndGetOutput("p4 " + getIdOptions() + " where " + fileLocation);
    }
    public static boolean submit(String changeDescription, Vector resultText)
    {
        if (!isGod(getSelf()))
        {
            return false;
    ...
    public static String diff(String fileSpec)
    {
        if (!isGod(getSelf()))
        {
            return null;
