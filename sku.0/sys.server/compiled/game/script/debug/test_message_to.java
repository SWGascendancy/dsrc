...
public class test_message_to extends script.base_script
{
    ...
    public boolean runTest(obj_id self, obj_id target, int test)
    {
        deltadictionary scriptVars = self.getScriptVars();
    ...
    public int testHandler(obj_id self, dictionary params)
    {
    ...
    public int nextTestHandler(obj_id self, dictionary params)
    {
        deltadictionary scriptVars = self.getScriptVars();
        boolean spam = scriptVars.getBoolean("messagetestspam");
        if (spam)
