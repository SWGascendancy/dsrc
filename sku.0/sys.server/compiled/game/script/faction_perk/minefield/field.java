...
public class field extends script.systems.combat.combat_base_old
{
    ...
    public int OnTriggerVolumeExited(obj_id self, String volumeName, obj_id who)
    {
        if (volumeName.equals(VOL_MINEFIELD))
        {
            int myFac = pvpGetAlignedFaction(self);
    ...
    public int handleMinefieldTick(obj_id self, dictionary params)
    {
    ...
    public int handleBlastCleanup(obj_id self, dictionary params)
    {
    ...
    public int handleMinefieldEmpty(obj_id self, dictionary params)
    {
        if (!hasObjVar(self, VAR_EMPTY_BASE))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleMineDonation(obj_id self, dictionary params)
    {
    ...
    public boolean addMinefieldTarget(obj_id self, obj_id target)
    {
    ...
    public boolean removeMinefieldTarget(obj_id self, obj_id target)
    {
        if (!isIdValid(target) || !isIdValid(self))
        {
            return false;
    ...
    public boolean createMinefieldVolume()
    {
        obj_id self = getSelf();
        if (!isIdValid(self))
        {
    ...
    public void removeMinefieldVolume()
    {
        obj_id self = getSelf();
        if (!isIdValid(self))
        {
    ...
    public void notifyMinefieldNear(obj_id target)
    {
    ...
    public void notifyMinefieldExited(obj_id target)
    {
        if (!isIdValid(target))
        {
            return;
    ...
    public void explodeMine(obj_id minefield, obj_id mine, obj_id target, location detonation)
    {
    ...
    public obj_id getRandomMine(obj_id minefield)
    {
    ...
    public boolean detonateMine(obj_id minefield, obj_id target)
    {
    ...
    public location getRandomLocationInMinefield(obj_id minefield)
    {
        if (!isIdValid(minefield))
        {
            return null;
    ...
    public void setMinefieldEmpty(obj_id minefield)
    {
        if (!isIdValid(minefield))
        {
            return;
    ...
    public void updateMinefieldExtents()
    {
        obj_id self = getSelf();
    ...
    public boolean isInMinefield(location here, float minx, float minz, float maxx, float maxz)
    {
        if (here == null)
        {
            return false;
    ...
    public boolean isInMinefield(obj_id target, obj_id minefield)
    {
    ...
    public void doMineDamage(obj_id minefield, obj_id mine, obj_id target, obj_id[] combatTargets)
    {
        if (!isIdValid(minefield) || !isIdValid(mine) || !isIdValid(target))
        {
            return;
    ...
    public int cmdDefuseMinefield(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isIdValid(target))
        {
            return SCRIPT_CONTINUE;
    ...
    public int cmdDefuseMinefieldFail(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isIdValid(target))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleMineDefuse(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public void defuseLocateMineFail(obj_id target)
    {
        sendSystemMessage(target, SID_NO_LOCATE_MINE);
    }
    public void defuseMineFail(obj_id minefield, obj_id target)
    {
