...
public class advanced_minefield extends script.systems.combat.combat_base
{
    ...
    public int OnTriggerVolumeEntered(obj_id self, String name, obj_id who)
    {
    ...
    public int OnTriggerVolumeExited(obj_id self, String name, obj_id who)
    {
        if (!name.startsWith("hq_minefield"))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleInitializeMinefield(obj_id self, dictionary params)
    {
    ...
    public void checkMineDetonation(obj_id self, obj_id who)
    {
        if (!isIdValid(who))
        {
            return;
    ...
    public void executeMineAttack(obj_id self, obj_id structure, obj_id who)
    {
    ...
    public int handleMineDeathBlow(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        pclib.coupDeGrace(player, self, false, false);
        return SCRIPT_CONTINUE;
    }
    public int handleAccidentalMineDetonation(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
