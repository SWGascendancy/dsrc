...
public class loader extends script.base_script
{
    ...
    public int handleDelayedRefundChecker(obj_id self, dictionary params)
    {
        hq.refundFactionBaseLots(self);
        return SCRIPT_CONTINUE;
    }
    public int handleHqDetonation(obj_id self, dictionary params)
    {
    ...
    public int handleHqExplosions(obj_id self, dictionary params)
    {
    ...
    private int getHqLevel(obj_id self)
    {
    ...
    private void setCWData(obj_id self)
    {
