...
public class objective_terminal_uplink extends script.faction_perk.hq.objective_object
{
    ...
    private void playJammingGame(obj_id self, obj_id player)
    {
    ...
    public int handleJammingGame(obj_id self, dictionary params)
    {
    ...
    public int handleJammingGameDelay(obj_id self, dictionary params)
    {
    ...
    public int handleObjectiveDisabled(obj_id self, dictionary params)
    {
        return SCRIPT_CONTINUE;
    }
    public int handleStartDelay(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        if (!isIdValid(player))
        {
    ...
    public int handleJammingInProgress(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
        if (!isIdValid(player))
        {
