...
public class spawn_egg extends script.base_script
{
    ...
    public int handleSpawnRequest(obj_id self, dictionary params)
    {
    ...
    public int handleLeaderIncapacitated(obj_id self, dictionary params)
    {
    ...
    public int handleChildDestroyed(obj_id self, dictionary params)
    {
        if (hasObjVar(self, VAR_CLEANING_UP))
        {
            return SCRIPT_CONTINUE;
    ...
    private obj_id[] loadSpawns(obj_id self)
    {
    ...
    private obj_id createSpawn(String type, location there)
    {
    ...
    private void createPatrolPathPoints(obj_id self)
    {
        if (getTopMostContainer(self) != self)
        {
            return;
    ...
    public int handleParentCleanup(obj_id self, dictionary params)
    {
        if (!hasObjVar(self, hq.VAR_SPAWN_CHILDREN))
        {
            destroyObject(self);
