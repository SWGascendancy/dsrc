...
public class turret_control extends script.terminal.base.base_terminal
{
    ...
    public int handleSetControl(obj_id self, dictionary params)
    {
    ...
    public int handleTurretAssignment(obj_id self, dictionary params)
    {
        obj_id structure = player_structure.getStructure(self);
    ...
    public int handleTargetSelection(obj_id self, dictionary params)
    {
    ...
    private void showTurretControl(obj_id terminal, obj_id player)
    {
