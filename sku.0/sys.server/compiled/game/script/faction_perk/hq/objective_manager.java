...
public class objective_manager extends script.base_script
{
    ...
    public int handlePveVulnerability(obj_id self, dictionary params)
    {
        hq.loadFullTimeVulnerability(self);
        return SCRIPT_CONTINUE;
    }
    public int handleLoadVulnerability(obj_id self, dictionary params)
    {
        hq.loadVulnerability(self);
        return SCRIPT_CONTINUE;
    }
    public int handleUnloadVulnerability(obj_id self, dictionary params)
    {
        hq.unloadVulnerability(self);
        return SCRIPT_CONTINUE;
    }
    public int handleFlagVulnerabilityChange(obj_id self, dictionary params)
    {
