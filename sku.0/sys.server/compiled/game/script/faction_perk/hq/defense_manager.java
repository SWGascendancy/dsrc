...
public class defense_manager extends script.base_script
{
    ...
    public int handleCreateMinefield(obj_id self, dictionary params)
    {
    ...
    public int handleRepairDefenses(obj_id self, dictionary params)
    {
    ...
    public int handleAddDefense(obj_id self, dictionary params)
    {
    ...
    public int handleRemoveDefense(obj_id self, dictionary params)
    {
        if (params == null || params.isEmpty())
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleDefenseValidation(obj_id self, dictionary params)
    {
        hq.validateDefenseTracking(self);
        return SCRIPT_CONTINUE;
    }
    public int handleMinefieldValidation(obj_id self, dictionary params)
    {
    ...
    public int handleTurretControl(obj_id self, dictionary params)
    {
    ...
    public int handleResetTurretControl(obj_id self, dictionary params)
    {
    ...
    public int handleSpawnSecurityRover(obj_id self, dictionary params)
    {
    ...
    private boolean addMine(obj_id self, int mineType)
    {
        if (mineType == -1)
        {
            return false;
