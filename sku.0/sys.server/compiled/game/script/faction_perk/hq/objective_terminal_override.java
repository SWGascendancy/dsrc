...
public class objective_terminal_override extends script.faction_perk.hq.objective_object
{
    ...
    private String[] constructDNAStrand(obj_id self)
    {
    ...
    private void startDNASequencing(obj_id self, obj_id player)
    {
    ...
    private void doSequencing(obj_id self, obj_id player)
    {
    ...
    public int handleSequencing(obj_id self, dictionary params)
    {
    ...
    public int handleSequenceDelay(obj_id self, dictionary params)
    {
