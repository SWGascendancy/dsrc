...
public class terminal extends script.terminal.base.base_terminal
{
    ...
    private void shutdownFacility(obj_id self)
    {
    ...
    private void startCountdown(obj_id self, obj_id player)
    {
    ...
    private void abortCountdown(obj_id self)
    {
    ...
    public int handleFacilityReboot(obj_id self, dictionary params)
    {
        detachScript(self, hq.SCRIPT_TERMINAL_DISABLE);
        obj_id structure = player_structure.getStructure(self);
        if (isIdValid(structure))
    ...
    public int handleCountdown(obj_id self, dictionary params)
    {
        if (!utils.hasScriptVar(self, SCRIPTVAR_COUNTDOWN))
        {
            return SCRIPT_CONTINUE;
    ...
    public int handleDonateDeed(obj_id self, dictionary params)
    {
    ...
    public int handleDonateResourceType(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        if (stealth.hasInvisibleBuff(player))
        {
    ...
    public int handleDonateResourceAmt(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        if (stealth.hasInvisibleBuff(player))
        {
    ...
    public int handleRequestDonation(obj_id self, dictionary params)
    {
        int bp = sui.getIntButtonPressed(params);
        if (bp == sui.BP_CANCEL)
        {
    ...
    public int handleCreditDonation(obj_id self, dictionary params)
    {
    ...
    public int handleDefenseSelection(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        if (!isIdValid(player))
        {
    ...
    public int handleDefenseRemoveConfirm(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        if (!isIdValid(player))
        {
    ...
    public void showResourceDonationUI(obj_id terminal, obj_id player)
    {
    ...
    private void showDeedDonationUI(obj_id terminal, obj_id player)
    {
        if (!isIdValid(terminal) || !isIdValid(player))
        {
            return;
    ...
    private void showDefenseStatusUI(obj_id terminal, obj_id player)
    {
        if (!isIdValid(terminal) || !isIdValid(player))
        {
            return;
    ...
    private void facilityShutdownDelay(obj_id terminal, obj_id player)
    {
        if (!isIdValid(terminal) || !isIdValid(player))
        {
            return;
    ...
    public int handleShutdownCountdownComplete(obj_id self, dictionary params)
    {
        obj_id player = params.getObjId("player");
    ...
    public int handleShutdownConfirm(obj_id self, dictionary params)
    {
        obj_id player = sui.getPlayerId(params);
        if (!isIdValid(player))
        {
    ...
    public int handleAlarmMute(obj_id self, dictionary params)
    {
        obj_id structure = player_structure.getStructure(self);
        if (isIdValid(structure))
        {
