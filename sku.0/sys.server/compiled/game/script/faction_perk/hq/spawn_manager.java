...
public class spawn_manager extends script.base_script
{
    ...
    public int clearSpawn(obj_id self, dictionary params)
    {
        hq.cleanupHqSpawns(self);
        return SCRIPT_CONTINUE;
    }
    public int doSpawn(obj_id self, dictionary params)
    {
        hq.loadInteriorHqSpawns(self);
        return SCRIPT_CONTINUE;
    }
    ...
    public int handleDefenderRespawn(obj_id self, dictionary params)
    {
