...
public class jedi_reset extends script.base_script
{
    ...
    public void resetJedi(obj_id self, obj_id target, int numSkills)
    {
        boolean result = true;
        if (result)
        {
    ...
    public void showWarningSui(obj_id self, obj_id target, int numSkills, String msg)
    {
    ...
    public int handleWarningSui(obj_id self, dictionary params)
    {
    ...
    public void removeOldJediData(obj_id target)
    {
    ...
    public void setNewSkillReq(obj_id target, int numSkills)
    {
