...
public class trigtest extends script.base_script
{
    ...
    public int OnSkillAboutToBeGranted(obj_id self, String name)
    {
    ...
    public int OnSkillAboutToBeRevoked(obj_id self, String name)
    {
    ...
    public int OnSkillGranted(obj_id self, String name)
    {
    ...
    public int OnSkillRevoked(obj_id self, String name)
    {
