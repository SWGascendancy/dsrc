...
public class new_ship_launch extends script.base_script
{
    ...
    public void beginLaunch(obj_id player, obj_id ship, location destination)
    {
    ...
    public int inviteForPobShipLaunch(obj_id self, dictionary params)
    {
    ...
    public void confirmLaunch(obj_id player)
    {
    ...
    public int confirmForPobShipLaunch(obj_id self, dictionary params)
    {
    ...
    public void finishLaunch(obj_id player)
    {
    ...
    public void launch(Vector players, Vector playerStartIndex, obj_id ship, location destination, location groundLoc)
    {
    ...
    public void launch(obj_id player, int playerStartIndex, obj_id ship, location destination, location groundLoc)
    {
