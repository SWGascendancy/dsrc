...
public class msg_test_sender extends script.base_script
{
    ...
    public int messageForMe(obj_id self, dictionary params)
    {
        String message = params.getString("message");
        debugSpeakMsg(self, message);
        return SCRIPT_CONTINUE;
    }
    public int gotImmediate(obj_id self, dictionary params)
    {
        debugSpeakMsg(self, "Instant Message Went Through");
        return SCRIPT_CONTINUE;
    }
    public int gotDelayed(obj_id self, dictionary params)
    {
