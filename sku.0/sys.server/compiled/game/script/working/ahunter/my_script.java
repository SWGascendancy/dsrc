...
public class my_script extends script.base_script
{
    ...
    public void whackamoleRandomize(obj_id self, int pid)
    {
        int button = rand(0, 2);
    ...
    public int whackamoleTimerCallback(obj_id self, dictionary params)
    {
    ...
    public int whackamoleCallback(obj_id self, dictionary params)
    {
