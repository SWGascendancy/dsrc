...
public class dantest extends script.base_script
{
    ...
    public String getLevelString(int intLevel)
    {
        if (intLevel <= 10)
        {
            return "1_10";
    ...
    public int checkDifficulty(obj_id self, dictionary params)
    {
    ...
    public void setupJediTrainer(obj_id self)
    {
    ...
    public location getGoodMissionLocation(location locSpawnLocation, obj_id objPlayer)
    {
        int intSize = 72;
    ...
    public void sendSpawnSpam(obj_id self, boolean boolLogFailures, boolean boolVerboseMode, String strSpam)
    {
    ...
    public int gmCreateSpecificResource(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int gmCreateClassResource(obj_id self, obj_id target, String params, float defaultTime)
    {
        String strClass = params;
        if ((strClass == null) || (strClass.equals("")))
        {
    ...
    public int OnShipWasHit(obj_id self, obj_id objAttacker, int weaponIndex, boolean isMissile, int missileType, int intTargetedComponent, boolean fromPlayerAutoTurret, float hitLocationX_o, float hitLocationY_o, float hitLocationZ_o)
    {
    ...
    public int checkEngineValue(obj_id self, dictionary params)
    {
    ...
    public String getDumpString(obj_id objTest, String strName)
    {
        String strTest = "";
    ...
    public int pingResponse(obj_id self, dictionary params)
    {
