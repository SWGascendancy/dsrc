...
public class util extends script.base_script
{
    ...
    public boolean createResource(obj_id self, String createStr)
    {
    ...
    public boolean createCreature(obj_id self, String createStr)
    {
        if (self == null || !isIdValid(self))
        {
            return false;
    ...
    public boolean createItem(obj_id self, String createStr)
    {
        if (self == null || !isIdValid(self))
        {
            return false;
