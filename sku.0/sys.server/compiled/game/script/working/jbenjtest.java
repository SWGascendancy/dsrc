...
public class jbenjtest extends script.base_script
{
    ...
    public int testSuiCountDown(obj_id self, dictionary params)
    {
        debugSpeakMsg(self, "params is " + params);
        return SCRIPT_CONTINUE;
    }
    public int onHateListSuiUpdate(obj_id self, dictionary params)
    {
    ...
    public int refreshSuiHateList(obj_id self, dictionary params)
    {
        if (sui.hasPid(self, PID_NAME))
        {
    ...
    public String generateStringHateList(obj_id target)
    {
