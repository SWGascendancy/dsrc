...
public class myscript extends script.base_script
{
    ...
    public int handleWarningShotTest(obj_id self, dictionary params)
    {
        obj_id target = getLookAtTarget(self);
        if (!isIdValid(target))
        {
    ...
    public int handleTestLos(obj_id self, dictionary params)
    {
        obj_id target = getLookAtTarget(self);
        if (isValidId(target))
        {
    ...
    public int testdietheater(obj_id self, dictionary params)
    {
        obj_id theater = getLastSpawnedTheater(self);
        if (isIdValid(theater))
        {
    ...
    public int handleTestScriptVars(obj_id self, dictionary params)
    {
    ...
    public int startSpeedTest(obj_id self, dictionary params)
    {
        location myPos = getLocation(self);
    ...
    public int stopSpeedTest(obj_id self, dictionary params)
    {
        location myPos = getLocation(self);
    ...
    public int handleTheaterCreated(obj_id self, dictionary params)
    {
    ...
    public int destroyTheater(obj_id self, dictionary params)
    {
        obj_id theater = params.getObjId("theater");
        if (isIdValid(theater))
        {
    ...
    public int abortSkillModMod(obj_id self, dictionary params)
    {
        removeAttribOrSkillModModifier(self, "themodmodmod");
        return SCRIPT_CONTINUE;
    }
    public void listObjvars(obj_id self, obj_id object)
    {
    ...
    public dictionary myOtherFunc()
    {
        return null;
    }
    public int myMessageHandler(obj_id self, dictionary params)
    {
