...
public class veteran_npc extends script.base_script
{
    ...
    public int OnStartNpcConversation(obj_id self, obj_id conversant)
    {
    ...
    public int OnNpcConversationResponse(obj_id self, String conversation, obj_id conversant, string_id response)
    {
