...
public class cmd extends script.base_script
{
    ...
    public int cmdGetPlayerId(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdAiIgnore(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdForceCommand(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdMoney(obj_id self, obj_id target, String params, float defaultTime)
    {
        ...
        if (st.hasMoreTokens())
        {
            ...
            if (arg.equalsIgnoreCase("cash"))
            {
                ...
                {
                    String targetStr = utils.getStringName(target);
                    String selfStr = utils.getStringName(target);
                    LOG("STAFF_COMMANDS", selfStr  + " (" + self + ") gave " + targetStr + " (" + target + ") " + sAmt + " credits (cash)");
            ...
            else if (arg.equalsIgnoreCase("bank"))
            {
                if (gm.setBalance(target, money.MT_BANK, sAmt))
                {
                    String targetStr = utils.getStringName(target);
                    String selfStr = utils.getStringName(target);
                    LOG("STAFF_COMMANDS", selfStr  + " (" + self + ") gave " + targetStr + " (" + target + ") " + sAmt + " credits (bank)");
    ...
    public void showMoneySyntax(obj_id self)
    {
    ...
    public int cmdBroadcast(obj_id self, obj_id target, String params, float defaultTime)
    {
        queueCommand(self, (-351572629), target, params, COMMAND_PRIORITY_DEFAULT);
        return SCRIPT_CONTINUE;
    }
    public int cmdBroadcastPlanet(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (params != null && !params.equalsIgnoreCase(""))
        {
    ...
    public int cmdBroadcastGalaxy(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (params != null && !params.equalsIgnoreCase(""))
        {
    ...
    public int cmdBroadcastArea(obj_id self, obj_id target, String params, float defaultTime)
    {
        ...
        for (int i = 0; i < players.length; i++)
        {
            ...
            {
                sendSystemMessageTestingOnly(players[i], "[" + getFirstName(self) + "] " + message);
            }
        }
        return SCRIPT_CONTINUE;
    }
    public dictionary parseRange(String params)
    {
        final String KEYWORD_RANGE = "-range:";
    ...
    public int cmdKill(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdKillPlayer(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdFreezePlayer(obj_id self, obj_id target, String params, float defaultTime)
    {
        ...
        {
            LOG("STAFF_COMMANDS", getFirstName(self) + " (" + self + ") froze " + getFirstName(target) + "(" + target + ")");
    ...
    public int cmdUnfreezePlayer(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (params.indexOf(gm.KEYWORD_ID) > -1)
        {
            dictionary ret = gm.parseObjId(params);
        ...
        if (isIdValid(target) && isPlayer(target))
        {
            LOG("STAFF_COMMANDS", getFirstName(self) + " (" + self + ") unfroze " + getFirstName(target) + "(" + target + ")");
    ...
    public int cmdShowFactionInformation(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isIdValid(target))
        {
    ...
    public int cmdSetFaction(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isIdValid(target))
        {
            target = self;
    ...
    public int cmdSetFactionStanding(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isIdValid(target))
        {
            target = self;
    ...
    public int cmdGetRank(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isIdValid(target) || !isPlayer(target))
        {
            target = self;
    ...
    public int cmdSetRank(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdGrantSkill(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isIdValid(target))
        {
            target = self;
    ...
    public int cmdRevokeSkill(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isIdValid(target))
        {
            target = self;
    ...
    public void listSkills(obj_id self, String[] skills)
    {
        Vector entries = new Vector();
        entries.setSize(0);
    ...
    public int cmdSearchCorpse(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdSetSpeed(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isIdValid(target))
        {
            target = self;
    ...
    public int cmdSetName(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isIdValid(target))
        {
            target = self;
    ...
    public int cmdSetFirstName(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isIdValid(target))
        {
            target = self;
    ...
    public int cmdSetLastName(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isIdValid(target))
        {
            target = self;
    ...
    public int cmdGrantBadge(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isIdValid(target))
        {
            target = self;
    ...
    public int cmdRevokeBadge(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isIdValid(target))
        {
            target = self;
    ...
    public int cmdShowExperience(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isIdValid(target))
        {
            target = self;
    ...
    public int cmdSetExperience(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isIdValid(target))
        {
            target = self;
    ...
    public void showSetExperienceSyntax(obj_id self)
    {
    ...
    public int cmdFindObject(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdFindObjectByTemplate(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdFindPlayer(obj_id self, obj_id target, String params, float defaultTime)
    {
        java.util.StringTokenizer st = new java.util.StringTokenizer(params);
        if (st.countTokens() != 1)
        {
    ...
    public int cmdFindWarden(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdFindCreature(obj_id self, obj_id target, String params, float defaultTime)
    {
        java.util.StringTokenizer st = new java.util.StringTokenizer(params);
        if (st.countTokens() != 1)
        {
    ...
    public int cmdWipeItems(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isIdValid(target))
        {
            target = self;
    ...
    public int cmdAdjustLotCount(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isIdValid(target))
        {
    ...
    public int cmdEditBankAccount(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdSetHue(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public void showSetHueSyntax(obj_id self)
    {
    ...
    public int cmdGoto(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int onObjectLocateResponseForCmdGoto(obj_id self, dictionary params)
    {
    ...
    public int cmdSetPlayerState(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isIdValid(target) || !isPlayer(target) || params == null || params.equalsIgnoreCase(""))
        {
    ...
    public int cmdUnCityBan(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isIdValid(target))
        {
            if (params.indexOf(gm.KEYWORD_ID) > -1)
    ...
    public int cmdInvulnerable(obj_id self, obj_id target, String params, float defaultTime)
    {
        obj_id ship = getPilotedShip(self);
    ...
    public int cmdSetTef(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isIdValid(target))
        {
    ...
    public int cmdInitializeComponent(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdGmWeapon(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdGMFsVillage(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdGMForceRank(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int msgGotIntResponse(obj_id self, dictionary params)
    {
        boolean rslt = false;
        String key = "";
    ...
    public int msgGetDurationInfo(obj_id self, dictionary params)
    {
    ...
    public int msgGetCampInfo(obj_id self, dictionary params)
    {
        if (!params.containsKey(fs_dyn_village.CLUSTER_OBJID_KEY_MASTER))
        {
            sendSystemMessageTestingOnly(self, "Couldn't find the master objid in the cluster data.");
    ...
    public int msgActivatePhase(obj_id self, dictionary params)
    {
    ...
    public int msgGotIdResponse(obj_id self, dictionary params)
    {
        boolean rslt = false;
        String key = "";
        if (params.containsKey("key"))
    ...
    public int msgIdRegistered(obj_id self, dictionary params)
    {
        if (!params.containsKey("success"))
        {
    ...
    public int msgResetFSTask(obj_id self, dictionary params)
    {
    ...
    public int msgCSUnlockBranch(obj_id self, dictionary params)
    {
    ...
    public int cmdEnclaveIdForPulse(obj_id self, dictionary params)
    {
    ...
    public int cmdHasVeteranReward(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdSetVeteranReward(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (isGod(self) && veteran_deprecated.checkVeteranTarget(target))
        {
            if (params == null || params.length() == 0)
    ...
    public int cmdClearVeteranReward(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (isGod(self) && veteran_deprecated.checkVeteranTarget(target))
        {
            if (params == null || params.length() == 0)
    ...
    public int cmdOverrideActiveMonths(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (isGod(self))
        {
            if (params == null || params.length() == 0)
    ...
    public int parseMilestone(String params)
    {
        String milestone;
        java.util.StringTokenizer st = new java.util.StringTokenizer(params);
    ...
    public int cmdResetJedi(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isIdValid(target) || !isPlayer(target) || params == null || params.equalsIgnoreCase(""))
        {
    ...
    public int cmdDeactivateQuest(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isIdValid(target) || !isPlayer(target) || params == null || params.equalsIgnoreCase(""))
        {
    ...
    public int cmdActivateQuest(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isIdValid(target) || !isPlayer(target) || params == null || params.equalsIgnoreCase(""))
        {
    ...
    public int cmdListActiveQuests(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isIdValid(target) || !isPlayer(target))
        {
    ...
    public int cmdClearCompletedQuest(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdCompleteQuest(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isIdValid(target) || !isPlayer(target) || params == null || params.equalsIgnoreCase(""))
        {
            sendSystemMessageTestingOnly(self, "[syntax] /deactivateQuest <questName>");
    ...
    public int cmdListCompletedQuests(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isIdValid(target) || !isPlayer(target))
        {
            sendSystemMessageTestingOnly(self, "[syntax] /listActiveQuests");
    ...
    public int cmdGrantPadawanTrialsEligibility(obj_id self, obj_id target, String params, float defaultTime)
    {
        String[] fs_skills = 
        {
    ...
    public int cmdGetGameTime(obj_id self, obj_id target, String params, float defaultTime)
    {
        sendSystemMessage(self, "The time is " + getGameTime(), null);
        return SCRIPT_CONTINUE;
    }
    public int gmJediState(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (params == null || params.length() < 1)
        {
    ...
    public int cmdSetGroupXPBonus(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isGod(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int cmdCreateStaticItem(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (params == null || params.length() < 1)
        {
        ...
        else
        {
            ...
            if (isIdValid(staticItemId))
            {
                if (canAutoStack && count > 0)
                {
                    ...
                    LOG("STAFF_COMMANDS", getFirstName(self) + " (" + self + ") created " + itemName + "(" + staticItemId + ") [x" + count + "]");
                }
                else
                {
                    sendSystemMessageTestingOnly(self, "Static Item " + itemName + " created in your inventory.");
                    LOG("STAFF_COMMANDS", getFirstName(self) + " (" + self + ") created " + itemName + " (" + staticItemId + ")");
                }
            }
            else
            {
    ...
    public int cmdDumpTargetInformation(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdDumpObjectInformation(obj_id self, obj_id target, String params, float defaultTime)
    {
        java.util.StringTokenizer st = new java.util.StringTokenizer(params);
    ...
    public int cmdNpeGotoMedicalBay(obj_id self, obj_id target, String params, float defaultTime)
    {
        sendSystemMessageTestingOnly(self, "Sending you to a medical bay instance");
        sendPlayerToTutorial(self);
        return SCRIPT_CONTINUE;
    }
    public int cmdNpeGotoMilleniumFalcon(obj_id self, obj_id target, String params, float defaultTime)
    {
        sendSystemMessageTestingOnly(self, "Sending you to a millenium falcon instance");
        npe.movePlayerFromHangarToFalcon(self);
        return SCRIPT_CONTINUE;
    }
    public int cmdNpeGotoTansariiStation(obj_id self, obj_id target, String params, float defaultTime)
    {
        java.util.StringTokenizer st = new java.util.StringTokenizer(params);
        int instanceId = 0;
        if (st.hasMoreTokens())
    ...
    public int cmdNpeGotoStationGamma(obj_id self, obj_id target, String params, float defaultTime)
    {
        java.util.StringTokenizer st = new java.util.StringTokenizer(params);
        int instanceId = 0;
        if (st.hasMoreTokens())
    ...
    public int cmdStartRestussStageTwo(obj_id self, obj_id target, String params, float defaultTime)
    {
        attachScript(self, "systems.cw_data.cluster_wide_response_manager");
        getClusterWideData("event", "restuss_event", true, self);
        return SCRIPT_CONTINUE;
    }
    public int cmdCompleteRestussStageOne(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdGmShowQuest(obj_id self, obj_id target, String params, float defaultTime)
    {
    ...
    public int cmdGmClearQuest(obj_id self, obj_id target, String params, float defaultTime)
    {
        StringTokenizer st = new java.util.StringTokenizer(params);
        String playerOid = "";
        String questVar = "";
    ...
    public int cmdGmGrantQuest(obj_id self, obj_id target, String params, float defaultTime)
    {
        ...
        if (!playerOid.equals("") && !questVar.equals(""))
        {
            ...
            if (!isIdNull(targetOid))
            {
                gm.forceGrantQuest(targetOid, questVar);
                CustomerServiceLog("gmQuest", "CSR: (" + self + ") " + getName(self) + " has granted (or attempted to grant) quest (" + questVar + ") from (" + targetOid + ") " + utils.getStringName(targetOid));
            }
            else
            {
                sendSystemMessageTestingOnly(self, "Please check the OID and try again");
        ...
        {
            sendSystemMessageTestingOnly(self, "[Syntax] /gmgrantquest <player OID> <quest/code_string>");
        }
        return SCRIPT_CONTINUE;
    }
    public int cmdGmRegrantQuest(obj_id self, obj_id target, String params, float defaultTime)
    {
        StringTokenizer st = new java.util.StringTokenizer(params);
        String playerOid = "";
        String questVar = "";
    ...
    public int cmdSetInstanceAuthorized(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isGod(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int cmdCombatDataRecord(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isGod(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int cmdCombatDataClear(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isGod(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int cmdCombatDataReport(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isGod(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int cmdCombatDataStop(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (!isGod(self))
        {
            return SCRIPT_CONTINUE;
    ...
    public int cmdCsDumpTarget(obj_id self, obj_id target, String params, float defaultTime)
    {
        StringTokenizer st = new java.util.StringTokenizer(params);
        String strObjectOid = "";
        if (st.hasMoreTokens())
    ...
    public void createDumpFile(obj_id self, obj_id targetObject)
    {
    ...
    public int cmdSetGalaxyMessage(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (getGodLevel(self) < 10)
        {
    ...
    public int cmdSetWardenGalaxyMessage(obj_id self, obj_id target, String params, float defaultTime)
    {
        if (getGodLevel(self) < 10)
        {
            sendSystemMessage(self, "You do not have the appropriate access level to use this command.", null);
