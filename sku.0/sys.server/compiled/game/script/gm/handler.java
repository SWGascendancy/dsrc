...
public class handler extends script.base_script
{
    ...
    public int confirmWipeItems(obj_id self, dictionary params)
    {
    ...
    public int handleHueVarUI(obj_id self, dictionary params)
    {
        gm.decrementMessageCount(self);
        int bp = sui.getIntButtonPressed(params);
        if (bp == sui.BP_CANCEL)
    ...
    public int handleHueColorUI(obj_id self, dictionary params)
    {
        gm.decrementMessageCount(self);
        int bp = sui.getIntButtonPressed(params);
        if (bp == sui.BP_CANCEL)
    ...
    public int cleanupShowFaction(obj_id self, dictionary params)
    {
        utils.removeScriptVar(self, gm.SCRIPTVAR_SHOWFACTION_PID);
        gm.decrementMessageCount(self);
        return SCRIPT_CONTINUE;
    }
    public int cleanupMoneyStatus(obj_id self, dictionary params)
    {
        utils.removeScriptVar(self, gm.SCRIPTVAR_MONEY_PID);
        gm.decrementMessageCount(self);
        return SCRIPT_CONTINUE;
    }
    public int handleMoneyPass(obj_id self, dictionary params)
    {
    ...
    public int handleMoneyFail(obj_id self, dictionary params)
    {
        gm.decrementMessageCount(self);
        obj_id player = params.getObjId(money.DICT_PLAYER_ID);
        if (!isIdValid(player))
    ...
    public int handleSearchCorpseSui(obj_id self, dictionary params)
    {
        gm.decrementMessageCount(self);
    ...
    public int handleSetPlayerStateUI(obj_id self, dictionary params)
    {
        int idx = sui.getListboxSelectedRow(params);
    ...
    public int handleSetRankSelection(obj_id self, dictionary params)
    {
        int idx = sui.getListboxSelectedRow(params);
        int btn = sui.getIntButtonPressed(params);
